...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 ((2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*(-((-2 + d)^2*mm^8*s) + 
     mm^6*(8*psq^2 + (8 - 6*d + d^2)*s^2 + 2*psq*((-2 + d)^2*s - 8*t) + 
       8*s*t + 8*t^2) - mm^4*s*((16 - 4*d + d^2)*psq^2 + 
       2*(6 - 5*d + d^2)*psq*s + (10 - 3*d)*s^2 - 24*psq*t + 12*s*t + 
       12*t^2) + mm^2*s^2*((12 - 6*d + d^2)*psq^2 + (-4 + d)*s^2 + 4*s*t + 
       4*t^2 - 4*psq*((-4 + d)*s + 2*t)))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((8 - 4*d + d^2)*mm^4*s - 
     2*mm^2*(4*psq^2 + (2 - 4*d + d^2)*psq*s - (-4 + d)*s^2 - 8*psq*t + 
       4*s*t + 4*t^2) + s*((8 - 4*d + d^2)*psq^2 + (-5 + 2*d)*s^2 + 4*s*t + 
       4*t^2 - 2*psq*((-7 + 3*d)*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^4 + 4*mm^2*(psq - s) - 
     (-3 + d)*(2*psq - s)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (mm^4*(8*psq - (4 + d^2)*s - 8*t) + 
     mm^2*s*((-20 + d^2)*psq + (2 + 3*d)*s + 16*t) + 
     s*(8*psq^2 + (26 - 7*d)*psq*s + 2*(-9 + 2*d)*s^2 - 16*psq*t + 4*s*t + 
       8*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (mm^4*(8*psq + (4 - 8*d + d^2)*s - 8*t) - 
     2*mm^2*((20 - 8*d + d^2)*psq*s - (-2 + d)*s^2 - 4*psq*t + 4*t^2) + 
     s*((20 - 8*d + d^2)*psq^2 - 2*s^2 + 6*s*t + 4*t^2 - 
       2*psq*((-7 + d)*s + 6*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (4*mm^4 + 4*mm^2*(psq - s) - (-3 + d)*(2*psq - s)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (mm^2*s*((12 + d^2)*psq + (-14 + 3*d)*s - 16*t) + 
     mm^4*(-8*psq - (-4 + d^2)*s + 8*t) + 
     s*(8*psq^2 + (18 - 7*d)*psq*s + 2*(-7 + 2*d)*s^2 - 16*psq*t + 12*s*t + 
       8*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (mm^4*(-8*psq + (12 - 8*d + d^2)*s + 8*t) - 
     2*mm^2*(8*psq^2 + (8 - 8*d + d^2)*psq*s - (-6 + d)*s^2 - 12*psq*t + 
       8*s*t + 4*t^2) + s*((12 - 8*d + d^2)*psq^2 - 4*s^2 + 2*s*t + 4*t^2 - 
       2*psq*((-11 + d)*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ((8 - 4*d + d^2)*mm^4 + s*((8 - 6*d + d^2)*psq - 2*(-5 + d)*s) - 
     mm^2*((-2 + d)^2*psq + (16 - 6*d + d^2)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^4 + 4*mm^2*(psq - s) - 
     (-3 + d)*(2*psq - s)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (Pi^(2*d)*s) + (EL^8*gAl^4*gAu^2*gXll^2*(2*(8 - 6*d + d^2)*mm^6*s - 
     (-2 + d)*mm^2*s*(4*psq^2 + (-6 + d)*s^2 + 4*s*t + 4*t^2 - 
       2*psq*((-6 + d)*s + 4*t)) + mm^4*(4*(-2 + d)*psq^2 + 
       (-48 + 26*d - 3*d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2 - 
       2*(-2 + d)*psq*((-4 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-4*(-2 + d)*mm^4 + 8*psq^2 + 
     (30 - 13*d + d^2)*psq*s - 6*s^2 + 2*d*s^2 + 
     mm^2*(4*(-2 + d)*psq - (22 - 9*d + d^2)*s) - 16*psq*t + 8*s*t + 8*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((8 - 6*d + d^2)*mm^4*s - 
     2*mm^2*(4*psq^2 + (8 - 6*d + d^2)*psq*s - (-4 + d)*s^2 - 8*psq*t + 
       4*s*t + 4*t^2) + s*((12 - 6*d + d^2)*psq^2 + (-4 + d)*s^2 + 4*s*t + 
       4*t^2 - 4*psq*((-4 + d)*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 4*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*mm^2 + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^4 - 4*psq^2 + 
     4*(-3 + d)*psq*s + 7*s^2 - 2*d*s^2 + 8*psq*t - 4*s*t - 4*t^2 - 
     2*mm^2*((-4 + d)*psq + (-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^4 + 
     2*(-2 + d)*psq^2 - 6*psq*s - s*(s + 2*t) + 
     mm^2*(-4*(-1 + d)*psq + 10*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*mm^2 + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^4 - 4*psq^2 + 
     4*(-3 + d)*psq*s + 7*s^2 - 2*d*s^2 + 8*psq*t - 4*s*t - 4*t^2 - 
     2*mm^2*(d*(psq + s) - 2*(2*s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^4 + 
     2*(-2 + d)*psq^2 - 10*psq*s + mm^2*(-4*(-3 + d)*psq + 6*s - 4*t) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-2 + d)*psq^2 + 
     2*(8 - 8*d + d^2)*mm^2*s + 38*s^2 - 17*d*s^2 + 2*d^2*s^2 - 8*s*t + 
     4*d*s*t - 8*t^2 + 4*d*t^2 - 2*(-2 + d)*psq*((-4 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*mm^2 + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-6 + d)*psq - 
     4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*(-2*psq + 3*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (2 + d)*psq + 
     4*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*d*mm^2 - 30*s + 11*d*s - 
     d^2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (-(s*(2*(-6 + d)*psq + (-4 + d)*((-8 + d)*s - 4*t))) + 
     2*(-2 + d)*mm^2*(psq + (-6 + d)*s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((2 + d)*psq^2 + 
     (12 - 10*d + d^2)*psq*s + 6*s^2 - (6 + d)*psq*t + 8*s*t + 4*t^2 - 
     mm^2*((-6 + d)*psq + (-4 + d)^2*s - (-6 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-6 + d)*psq - 
     4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-2 + d)*mm^4 - 
     s*(-6*(-2 + d)*psq + (20 - 8*d + d^2)*s) + 
     mm^2*(-4*(-2 + d)*psq + (42 - 21*d + 2*d^2)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-2 + d)*mm^4 + (-6 + d)*psq^2 - 
     4*(s + t)^2 - psq*((20 - 10*d + d^2)*s + (-10 + d)*t) + 
     mm^2*((6 - 5*d)*psq + (24 - 8*d + d^2)*s + (2 + d)*t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-6 + d)*psq - 
     4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(6*(-2 + d)*mm^2 + d^2*s + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*(-2*psq + 3*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-2 + d)*mm^4 - (2 + d)*psq^2 - 
     (30 - 11*d + d^2)*psq*s + (6 + d)*psq*t - 4*t^2 + 
     mm^2*((10 - 3*d)*psq + (22 - 9*d + d^2)*s - (2 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^4 + 
     2*(-2 + d)*psq^2 - 8*psq*s + s^2 + mm^2*(-4*(-2 + d)*psq + 6*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (s*((12 - 8*d + d^2)*psq - 2*(-8 + d)*s) + 
     mm^2*(8*psq - (24 - 8*d + d^2)*s - 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*(-2*psq + 3*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(d^2*(mm^2 - psq)*s - 
     2*(2*psq^2 - 8*mm^2*s + 5*psq*s + 5*s^2 - 4*psq*t + 5*s*t + 2*t^2) + 
     d*(2*psq^2 + 9*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2 + 
       mm^2*(-4*psq - 6*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*(-2 + d)*psq^2 + 2*s^2 + 
     (-2 + d)*psq*(s + 2*t) + mm^2*(2*(2 + d)*psq - (6 + d)*s - 2*(2 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (2 + d)*psq + 
     4*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*d*mm^2 - 30*s + 11*d*s - 
     d^2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((20 - 6*d)*psq*s - 
     2*(-2 + d)*mm^2*(-psq + (-5 + d)*s + t) + (-4 + d)*s*((-4 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-((-6 + d)*psq^2) + 
     (18 - 9*d + d^2)*psq*s + (-10 + d)*psq*t + 
     mm^2*((-6 + d)*psq - (10 - 7*d + d^2)*s - (-6 + d)*t) + 2*(s^2 + 2*t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2*(2*psq + s - 2*t) + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (s*(-((12 - 8*d + d^2)*psq) + 2*(-8 + d)*s) + 
     mm^2*(8*psq + (-4 + d)^2*s - 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*(2*psq + s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(d^2*(mm^2 - psq)*s + 
     2*(-2*psq^2 + 8*mm^2*s - 11*psq*s - 2*s^2 + 4*psq*t + s*t - 2*t^2) + 
     d*(2*psq^2 + 11*psq*s + 2*mm^2*(2*psq - 5*s - 2*t) - 4*psq*t + s*t + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-mm^2 + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(24 - 10*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((12 - 6*d + d^2)*mm^2 - 
     (8 - 6*d + d^2)*psq + 2*(-5 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*d*mm^2 - 30*s + 11*d*s - 
     d^2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
  ((-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*psq^2 + 2*(-6 + d)*mm^2*s - 
  ...
  (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
  ...
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ((-2 + d)*mm^2 + (-6 + d)*psq - 2*(-4 + d)*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(3*(-2 + d)*mm^2 - 3*(-2 + d)*psq + 
     (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*psq + 
     (32 - 14*d + d^2)*s - 2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (2*(-2 + d)*psq - (28 - 12*d + d^2)*s - 2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^2 - 6*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q1, q2]])/
   (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], SP[q1, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(-4 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p1, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*(28 - 10*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
  ...
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    gXll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], SP[q1, q1]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(-4 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    gXll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[q1, q2]])/
   (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ((-2 + d)*mm^2 - (2 + d)*psq + 4*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-4 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(28 - 10*d + d^2)*EL^8*gAl^4*
    gAu^2*gXll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-6 + d)*psq - 
     4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(28 - 10*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-2 + d)*psq - 
     (24 - 8*d + d^2)*s - 4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    gXll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    gXll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q1, q2]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq - 3*s - 2*t)*
  ...
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^2 - 4*psq + s)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq + s - 2*t)*
   ...
   (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq - t)*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    gXll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q2]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq - t)*
