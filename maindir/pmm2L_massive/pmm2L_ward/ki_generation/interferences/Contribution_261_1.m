...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
    ...
    (I*4^(1 - d)*aa*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    (I*4^(1 - d)*bb*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      s*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
    (I*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    ...
    (I*2^(3 - 2*d)*bb*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
      (mm^2 - psq)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
