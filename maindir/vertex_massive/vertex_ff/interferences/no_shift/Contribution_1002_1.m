...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl^3*gAu*ggmgmA^2*mm^2*(psq^3 + psq^2*(4*s - 2*t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*ggmgmA^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*ggmgmA^2*(mm^2 - psq)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*ggmgmA^2*(psq*s + mm^2*(-4*psq + s + 4*t))*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*ggmgmA^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*ggmgmA^2*(mm^2*(psq - t) + psq*(-psq + s + t))*
    ...
    Pi^(2*d) + (4^(2 - d)*EL^6*gAl^3*gAu*ggmgmA^2*(mm^2 - psq)*(psq - t)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*ggmgmA^2*(psq - t)*(-psq + s + t)*
    ...
    Pi^(2*d) + (4^(2 - d)*EL^6*gAl^3*gAu*ggmgmA^2*(psq - t)^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*ggmgmA^2*(psq - t)*\[Mu]^(8 - 2*d)*
