...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (((-I)*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(mm^2 - psq)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(3*aa*psq*(psq - s - t) + 
      aa*mm^2*(psq + s - t) + 3*bb*psq*(-psq + t) + bb*mm^2*(-psq + 2*s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(mm^2 + psq)*(psq - s - t)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(mm^2 + psq)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/(2*Pi)^(2*d) - 
   (I*4^(1 - d)*(aa + bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(mm^2 - psq)*s*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
      SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
     (bb*(3*mm^2 - 2*psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
