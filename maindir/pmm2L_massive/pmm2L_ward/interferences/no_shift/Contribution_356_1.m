...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (((-I)*2^(1 - 4*d)*EL^5*gAl^3*mm^2*s*
   ...
   (I*EL^5*gAl^3*mm^2*s*(bb*(-4*(4 - 5*d + d^2)*gZlL*gZlR*(2*psq - s - 2*t) + 
        gZlL^2*((8 - 6*d + d^2)*mm^2 - (32 - 14*d + d^2)*psq - 
          4*(-3 + d)*(s + 2*t)) + gZlR^2*((8 - 6*d + d^2)*mm^2 - 
          (32 - 14*d + d^2)*psq - 4*(-3 + d)*(s + 2*t))) + 
      aa*(4*(4 - 5*d + d^2)*gZlL*gZlR*(2*psq - s - 2*t) + 
        gZlL^2*((8 - 6*d + d^2)*mm^2 - (-16 + 2*d + d^2)*psq + 
          4*(-3 + d)*(s + 2*t)) + gZlR^2*((8 - 6*d + d^2)*mm^2 - 
          (-16 + 2*d + d^2)*psq + 4*(-3 + d)*(s + 2*t))))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl^3*
     (aa*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*((8 - 7*d + d^2)*psq - d*s - 
      ...
      bb*(2^(1 + 2*d)*d*Pi^(2*d)*(gZlL^2*(mm^4 + 5*psq*s + 
         ...
         (2*gZlL*gZlR*mm^2*(mm^2 + psq - 2*t) + 
          gZlL^2*(-3*psq*s + mm^2*(-psq + 4*s + t)) + 
          gZlR^2*(-3*psq*s + mm^2*(-psq + 4*s + t)))))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl^3*
     (bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*((8 - 7*d + d^2)*psq - 
          (8 - 8*d + d^2)*s - (8 - 7*d + d^2)*t) + gZlL^2*(2*Pi)^(2*d)*
         (-((16 - 10*d + d^2)*mm^4) + (24 - 10*d + d^2)*psq*s + 
          mm^2*(-4*(-2 + d)*psq - (24 - 12*d + d^2)*s + (8 - 6*d + d^2)*t)) + 
        gZlR^2*(2*Pi)^(2*d)*(-((16 - 10*d + d^2)*mm^4) + (24 - 10*d + d^2)*
           psq*s + mm^2*(-4*(-2 + d)*psq - (24 - 12*d + d^2)*s + 
            (8 - 6*d + d^2)*t))) + 
      aa*(-(d^2*(2*Pi)^(2*d)*(-4*gZlL*gZlR*mm^2*(mm^2 - 2*psq + s + t) + 
           gZlL^2*(mm^4 + psq*s + mm^2*(-2*psq - s + t)) + 
           gZlR^2*(mm^4 + psq*s + mm^2*(-2*psq - s + t)))) + 
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*mm^2*
    ...
    Pi^(2*d) + 
   (I*EL^5*gAl^3*(bb*(4*gZlL*gZlR*mm^2*((4 - 6*d + d^2)*psq + 4*s - 
      ...
      aa*(-4*gZlL*gZlR*mm^2*((4 - 6*d + d^2)*psq + 4*s - (4 - 6*d + d^2)*t) + 
        ...
        gZlR^2*(-((16 - 10*d + d^2)*psq^2) + (-8 - 4*d + d^2)*psq*s + 
          (16 - 10*d + d^2)*psq*t - 2*(-4 + d)*s*(s + t) + 
          (-2 + d)*mm^2*((4 + d)*psq - 4*t - d*(s + t)))))*\[Mu]^(8 - 2*d)*
