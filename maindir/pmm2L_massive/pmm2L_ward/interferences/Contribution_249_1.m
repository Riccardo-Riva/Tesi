...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((I*4^(-1 - d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s^2*
    (aa*(s + t) - bb*(3*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s^2*
    (aa*(3*mm^2 - psq - t) + bb*(-2*psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*4^(-1 - d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s^2*
    (bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) - (I*(aa + bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*
    gWNl*(mm^2 - psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (-(aa*(psq*(psq - 2*s - t) + mm^2*(psq + s - t))) + 
     bb*(mm^2*(psq - 2*s - t) + psq*(psq + s - t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (aa*(psq - 4*(s + t)) + bb*(10*mm^2 - 11*psq + 4*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (10*aa*mm^2 - 3*aa*psq - 7*bb*psq - 4*aa*t + 4*bb*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) + 
  ((3*I)*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (-(bb*(6*mm^2 - 8*psq + s + 2*t)) + aa*(-6*mm^2 + 4*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (aa*(2*psq^2 + 2*mm^2*(psq + 2*s - t) - 2*psq*(2*s + t) - s*(s + 2*t)) + 
     bb*(-2*psq^2 - 6*psq*s + s^2 + 2*psq*t + 2*s*t + 
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*(-2*psq + s + 2*t)*
  ...
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (bb*(3*mm^2 - 2*psq + s + t) - aa*(psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (aa*(psq - s - t) + bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (3*aa*mm^2 - 3*bb*psq - aa*t + bb*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (aa*(psq^2 + mm^2*(psq + s - t) - psq*(s + t) - s*(s + t)) + 
     bb*(-psq^2 + psq*(-4*s + t) + s*(s + t) + mm^2*(-psq + 4*s + t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (bb*(2*psq - t) + aa*(-3*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (bb*(psq - t) + aa*(-mm^2 + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    s*(bb*(mm^2 - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*(aa*(4*mm^2 - 3*psq - t) + 
     bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (bb*(-psq^2 + s*t + psq*(-2*s + t) + mm^2*(-psq + 2*s + t)) + 
     aa*(psq^2 + mm^2*(psq + 3*s - t) - s*t - psq*(3*s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*
    gWlN*gWNl*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(psq - 2*(s + t)) + 
     bb*(4*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(4*aa*mm^2 - aa*psq - 
     3*bb*psq - 2*aa*t + 2*bb*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(bb*(mm^2 + psq - s - 2*t) + 
     aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(psq - s - t) + 
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[q1, q2]])/Pi^(2*d) - (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (aa*(psq - 2*(s + t)) + bb*(4*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(psq - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(bb*(4*mm^2 - 3*psq + 2*(s + t)) - 
     aa*(psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*
    gWNl*(aa*(psq - s - t) + bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(4*mm^2 + psq - 2*t) + 
     bb*(-5*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p2, q1]])/(2*Pi)^(2*d) - (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
  ...
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*psq - s - 2*t)*
   ...
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
     SP[q1, q2]])/Pi^(2*d) - (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (4*aa*mm^2 - aa*psq - 3*bb*psq - 2*aa*t + 2*bb*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) - (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
  ...
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(mm^2 - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[q1, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (aa*(psq - s - t) + bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*psq*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(mm^2 - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q2]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*
    gWNl*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(mm^2 - t) + bb*(-psq + t))*
   ...
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*
