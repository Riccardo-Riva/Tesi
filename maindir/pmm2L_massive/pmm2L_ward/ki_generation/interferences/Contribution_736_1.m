...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
   ...
   (((-I)*2^(1 - 2*d)*d*EL^5*gAl^5*mm^2*(mm^2 - psq)*s*
     ...
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^5*mm^2*
      (-((-4 + d)*psq^2) - 4*psq*s + (-4 + d)*psq*t + 2*s*(s + 2*t) + 
       mm^2*((4 + d)*psq - 4*s - (4 + d)*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gAl^5*
      ...
      SPList[SP[p1, q2]])/Pi^(4*d) + (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^5*mm^2*
      (-((-4 + d)*psq^2) + (-8 + d)*psq*s + (-4 + d)*psq*t + 2*s*(s + 2*t) + 
       mm^2*((4 + d)*psq - 4*t - d*(s + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gAl^5*
      (aa*(-((-4 + d^2)*mm^4*(2*Pi)^(2*d)*(psq - t)) - (-2 + d)*(2*Pi)^(2*d)*
          psq*((-2 + d)*psq^2 + 2*psq*s - (-2 + d)*psq*t + 2*s*t) + 
         2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(d*psq*(psq - t) + 
           s*(psq + t))) - bb*(-2 + d)*
      ...
      SPList[SP[p2, q2]])/Pi^(4*d) + (I*4^(1 - d)*d*EL^5*gAl^5*mm^2*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^5*
      (mm^2 - psq)*s*(-(aa*(-2 + d)*mm^2) - bb*(-2 + d)*mm^2 + 
       aa*(-6 + d)*psq + bb*(2 + d)*psq + 2*aa*(s + 2*t) - 2*bb*(s + 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*d*EL^5*gAl^5*mm^2*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(2 - d)*d*EL^5*gAl^5*mm^2*(aa*((-2 + d)*mm^2 + 3*psq - d*psq - t) + 
       bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
     Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^5*
      (aa*((-2 + d)*mm^4 + (-2 + d)*psq^2 - 3*psq*s - 
         2*mm^2*((-3 + d)*psq + t) + s*(s + t)) - 
       bb*(2*mm^2*(psq - t) + s*(-3*psq + s + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
    (I*4^(2 - d)*d*EL^5*gAl^5*mm^2*(aa*((-2 + d)*mm^2 + 4*psq - d*psq - s - 
         2*t) + bb*((-2 + d)*mm^2 - d*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*d*EL^5*gAl^5*mm^2*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(-((-2 + d)*psq^2) - 2*psq*s + 
       (-2 + d)*psq*t + 2*s*(s + 2*t) + mm^2*((6 + d)*psq - 6*s - (6 + d)*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^5*mm^2*(2*s + d*(psq - s - t))*
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^5*
      (bb*(4*psq^2 + psq*(6*s - 4*t) + d*(mm^2 - psq)*(2*psq - s - 2*t) - 
         2*s*(2*mm^2 + s + t)) + aa*(-4*psq^2 - d*(mm^2 - psq)*
          (2*psq + s - 2*t) + 2*s*(4*mm^2 + s + t) + 2*psq*(-5*s + 2*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^5*
      (bb*((-2 + d)*psq^2 - (2 + d)*mm^2*(psq - s - t) + 2*s*(s + t) - 
         psq*((4 + d)*s + (-2 + d)*t)) + aa*(-((-2 + d)*psq^2) - 
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^5*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa + bb)*(-2 + d)^2*EL^5*gAl^5*(mm^2 - psq)*s*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*((-2 + d)*mm^2 - 
       (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p2, q2]])/Pi^(2*d) - (I*4^(2 - d)*(aa + bb)*(-2 + d)^2*EL^5*gAl^5*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)^2*EL^5*gAl^5*
    ...
    (I*4^(1 - d)*(-2 + d)^2*EL^5*gAl^5*(bb*(2*mm^2 - psq - t) + 
