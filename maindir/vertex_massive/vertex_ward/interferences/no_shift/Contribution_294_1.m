...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (((-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*mm^2*s*
    ...
    (2*Pi)^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gZNL*
     (aa*((-2 + d)*gZlR*mm^2*((10 + d)*psq - 4*s)*s + 
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
    ...
    Pi^(2*d) - (2^(1 - 4*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
     (-2*bb*mm^2 - aa*(-6 + d)*mm^2 + 2*aa*psq + bb*(-6 + d)*psq)*s*
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (4^(2 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
