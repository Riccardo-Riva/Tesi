  ...
  ((2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*
     ...
     (-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(psq^2 - 2*psq*t + t*(s + t))*
        (-(d*psq*s) + 2*d*mm^2*(psq - t) - 2*s*(2*mm^2 - 4*psq + s + 2*t))) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(psq^2 - 2*psq*t + t*(s + t))*
     ((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
       (2*psq - s - 2*t) + gZlL*gZlR*(mm^2*(-2*(4 + d)*psq + 8*s + 
          2*(4 + d)*t) + s*((-8 + d)*psq + 2*(s + 2*t))))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (gZlL^2*mm^2*(psq - s - t)*((-2 + d)*mm^2 - 2*(-2 + d)*psq - 3*s + d*s - 
        2*t + d*t) + gZlR^2*mm^2*(psq - s - t)*((-2 + d)*mm^2 - 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (gZlL^2*mm^2*(-((-2 + d)*psq^2) - 2*psq*s + (-2 + d)*mm^2*(psq - t) + 
      ...
      2*gZlL*gZlR*(-6*psq^3 + psq^2*s + psq*s^2 + d*mm^2*(mm^2 - psq)*
        ...
        6*s*t^2 + 4*t^3 + mm^2*(2*psq^2 - 5*psq*s + 2*s^2 - 4*psq*t + 7*s*t + 
   ...
   (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
     ...
     (psq - t)*(gZlL^2*mm^2*(-((-2 + d)*psq) + s + (-2 + d)*t) + 
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(4*psq^2 - 6*psq*(s + t) + 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(2*(psq - t)*(psq - s - t) + 
   ...
   (4^(3 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     (-psq^2 + mm^2*(psq + s - t) + psq*(-3*s + t) + s*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(2*psq^2 + psq*(s - 4*t) + 
      2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     ((-2 + d)*psq - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p2, q2]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(-4*psq^2 + (-6 + d)*psq*s + 
   ...
   (4^(3 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
   ...
   (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
