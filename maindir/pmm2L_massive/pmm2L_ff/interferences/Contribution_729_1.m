...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   (-((4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*psq*(2*mm^2 - 3*psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(-2*psq^3 - 
    ...
    (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(psq - t)*
      ...
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       ...
       SP[p3, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*
      (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*
