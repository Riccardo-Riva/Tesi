  ...
  (-((4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2 - psq)*
   ...
   (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
     (mm^2 - psq)^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
     (mm^2 - psq)*(psq^2 + mm^2*s - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(4*psq - (-2 + d)*s - 4*t)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*(2*psq - s - 2*t)*
