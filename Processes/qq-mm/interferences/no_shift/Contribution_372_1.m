   ...
   ((I*EL^6*gAl*gAu*gFZW^2*(gZlR*gZuL*(2^(2 + d)*mmv^4*Pi^d + 
    ...
    (I*EL^6*gAl*gAu*gFZW^2*(gZlR*gZuL*(2^(1 + d)*mm^2*Pi^d + 
       ...
       gZlR*gZuR*(2^(1 + d)*mm^2*Pi^d - 2^(1 + d)*(-2 + d)*mmv^2*Pi^d - 
         ...
         2^(1 + d)*d*Pi^d*t))*SPList[SP[q1, q1]])/(mw^2*(2*Pi)^(2*d)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gFZW^2*(gZlL + gZlR)*(gZuL + gZuR)*
      SPList[SP[p3, q1], SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*sw^2)) + 
  PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
   ...
   ((I*EL^6*gAl*gAu*gFZW^2*(gZlR*gZuL*(2^(1 + d)*mm^2*Pi^d + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gFZW^2*
      (gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
       ...
       SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) + 
    (I*2^(2 - d)*EL^6*gAl*gAu*gFZW^2*(gZlL + gZlR)*(gZuL + gZuR)*
      SPList[SP[p3, q1], SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*sw^2)))/4
