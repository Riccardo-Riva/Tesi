...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((EL^6*gAl^2*gFll^2*gXll^2*mm^6*((-2 + d)*mm^2 - 2*(-3 + d)*psq)*s*
  ...
  (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gXll^2*mm^6*(mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/Pi^(2*d) + (2^(-1 - 2*d)*EL^6*gAl^2*gFll^2*gXll^2*
    mm^4*((-6 + 4*d)*mm^4 + s*(2*(-3 + d)*psq + (-4 + d)*s) - 
     mm^2*(6*(-3 + d)*psq + (2 + d)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (EL^6*gAl^2*gFll^2*gXll^2*mm^6*((-2 + d)*mm^2 - 2*(-3 + d)*psq)*
  ...
  (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gXll^2*mm^6*(mm^2 - s)*\[Mu]^(8 - 2*d)*
    ...
    mm^4*(-2*(1 + d)*mm^4 + s*(-2*(-5 + d)*psq + (-4 + d)*s) + 
     mm^2*(2*(-1 + d)*psq + (-10 + 3*d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) + (2^(-1 - 2*d)*EL^6*gAl^2*gFll^2*gXll^2*
    mm^4*(-2*(1 + d)*mm^4 + s*(2*(-5 + d)*psq - (-4 + d)*s) + 
