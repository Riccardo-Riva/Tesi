...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 (((-I)*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*s*
   ...
   Pi^(2*d) + (I*EL^5*gAl^3*gXll^2*mm^4*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl^3*gXll^2*mm^2*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^4*(bb*psq*((-4 + d)*psq - (-2 + d)*s - 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^4*s*(aa*((-2 + d)*mm^2 - (-6 + d)*psq - 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*((aa + bb)*(-2 + d)*(mm^2 - psq)*s + 
  ...
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(aa*(2*mm^2 - psq - t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*psq*(-((-2 + d)*psq) - (-4 + d)*s + 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*s*(aa*((-2 + d)*mm^2 - (-6 + d)*psq - 
       2*(s + 2*t)) + bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*((-2 + d)*mm^2 - 2*s + 2*t - d*t) + 
     bb*((-2 + d)*mm^2 + 4*psq - 2*d*psq + 2*s - 2*t + d*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*((-2 + d)*psq - 2*s - (-2 + d)*t)*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*((-2 + d)*mm^2 + 4*s - d*s + 2*t - d*t) + 
     bb*((-2 + d)*mm^2 + 4*psq - 2*d*psq - 4*s + d*s - 2*t + d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*
    ((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*((-2 + d)*psq - (-4 + d)*s - 
  ...
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
     SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
