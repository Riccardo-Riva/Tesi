...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWAZ*gZlR*mm^2*
     (-4*(-1 + d)*psq + (4 - 2*d + d^2)*s + 4*(-1 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWAZ*gZlL*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWAZ*gZlL*
     (2*(-2 + d)*mm^2 + (18 - 7*d)*psq - 8*s + 3*d*s - 14*t + 5*d*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWAZ*gZlL*
     (-2*(-2 + d)*mm^2 + (10 - 3*d)*psq - 6*s + 2*d*s - 14*t + 5*d*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWAZ*gZlL*
     (4*(-2 + d)*psq - (6 - 4*d + d^2)*s - 4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
