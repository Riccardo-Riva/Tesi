...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (((-I)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 + 2*psq - s)*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    s*sw*(3*aa*(2*psq - s - 2*t) + bb*(2*mm^2 - 8*psq + 3*s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (2*mm^2*(psq - t) + (2*psq - s)*(psq - s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*s*sw*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
    (aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 3*bb*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(-1 - d)*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    ((2*psq - s)*(psq - t) + 2*mm^2*(psq - s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFZW*
    gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*s*sw*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    sw*(aa*(12*psq - 7*s - 12*t) + bb*(4*mm^2 - 16*psq + 7*s + 12*t))*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    sw*(aa*(4*mm^2 + 8*psq - 5*s - 12*t) + bb*(-12*psq + 5*s + 12*t))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   Pi^(2*d) - (I*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
