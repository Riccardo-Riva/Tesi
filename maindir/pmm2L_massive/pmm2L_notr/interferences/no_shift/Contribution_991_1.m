...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
     mm^2*(6*psq^2 + 4*mm^2*(psq - t) + 2*t*(s + 2*t) - 
      psq*((-4 + d)*s + 10*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
     mm^2*(2*psq^2 + 2*mm^2*(psq - t) + t*(s + 2*t) - psq*((-3 + d)*s + 4*t))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
     mm^2*(-4*psq^2 + 4*mm^2*s - 4*psq*s + 10*s^2 - 3*d*s^2 + 8*psq*t - 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(psq - t)*
