...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 (((-I)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*s*(psq + s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*s*(-psq + 2*s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*(psq + 2*s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*(psq - 3*s - t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*
    mm^2*(psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*
    mm^2*(psq + 3*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*
    mh^2*mm^2*(psq - 2*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*
   ...
   (4^d*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/
   Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFF*gHFW*gWNl*mh^2*mm^2*
