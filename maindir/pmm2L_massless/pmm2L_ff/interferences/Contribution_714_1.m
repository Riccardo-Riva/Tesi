...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(-6*d*gZlL*gZlR*mm^2 + 
       gZlL^2*(3*(-2 + d)*mm^2 + 4*s) + gZlR^2*(3*(-2 + d)*mm^2 + 4*s))*t*
      (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) - 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(d*gZlL*gZlR*(3*mm^2 + 2*t)*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*t*
    ...
    (Pi^(4*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(s + 2*t)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*(-8*d*gZlL*gZlR*mm^2 + 
      gZlL^2*(3*(-2 + d)*mm^2 + 4*s) + gZlR^2*(3*(-2 + d)*mm^2 + 4*s))*t*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(-2*d*gZlL*gZlR*mm^2*(s + 2*t)^2 + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*t*(-2*(gZlL^2 + gZlR^2)*t + 
      d*(gZlL^2*t + gZlR^2*t - gZlL*gZlR*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*t*(-2*d*gZlL*gZlR*mm^2*(s + 2*t) + 
      gZlL^2*(4*(s + t)^2 + (-2 + d)*mm^2*(s + 2*t)) + 
      gZlR^2*(4*(s + t)^2 + (-2 + d)*mm^2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(-4*(gZlL^2 + gZlR^2)*t^2 + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(-2*d*gZlL*gZlR*(s + 2*t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(s + 2*t)*(-4*d*gZlL*gZlR*mm^2*s + 
      (-2 + d)*gZlL^2*(mm^2*s + t*(s + t)) + (-2 + d)*gZlR^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^4*(s + 2*t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*t*
