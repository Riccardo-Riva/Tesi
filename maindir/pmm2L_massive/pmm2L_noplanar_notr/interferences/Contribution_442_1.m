...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   KiraPropagator[q2, mw]]*((4^(1 - d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWZZ*
     mm^2*(-4*(-4 + d)*gZlL*gZlR*s^2 + gZlL^2*(4*psq^2 + 2*(-2 + d)*mm^2*s - 
   ...
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^2*gAu^2*gWWZZ*
   ...
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^2*gAu^2*gWWZZ*(18*(gZlL^2 + gZlR^2)*s + 
   ...
   (2^(5 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWZZ*(gZlL^2 + gZlR^2)*
