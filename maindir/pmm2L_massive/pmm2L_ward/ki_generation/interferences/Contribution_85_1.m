...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   ((I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)^2*s*
      ...
      SPList[SP[p1, q1]])/Pi^(2*d) + (I*4^(1 - d)*aa*EL^5*gAl*gHll^2*gXll^2*
      mm^4*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*
      (aa*(psq - s - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*bb*EL^5*gAl*gHll^2*gXll^2*
      mm^4*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(psq - s - t) + 
       ...
       SP[p1, q1]])/Pi^(2*d) - (I*4^(2 - d)*aa*EL^5*gAl*gHll^2*gXll^2*mm^6*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
      (-(bb*s) + aa*(4*mm^2 + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*
      mm^6*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
     Pi^(2*d) + (I*2^(3 - 2*d)*aa*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*s*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
      (-(aa*s) + bb*(4*mm^2 + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*
      gXll^2*mm^4*(mm^2 - psq)^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*aa*EL^5*gAl*gHll^2*gXll^2*mm^4*
