...
PropList[KiraPropagator[-q1, mb], KiraPropagator[q2, 0], 
  KiraPropagator[q2, 0], KiraPropagator[p3 + q2, 0], 
  KiraPropagator[-p1 - p2 + p3 + q2, 0], KiraPropagator[q1 + q2, mb]]*
 ((3*4^(1 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*mb^2*
    ((-4 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*mb^2*((22 - 13*d + 2*d^2)*s^2 + 
  ...
  (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-8 + 3*d)*s^2 + 6*s*t + 8*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*
    (-2*mb^2*(s + t)*((-6 + d)*s + 2*(-2 + d)*t) + 
     s*((-8 + 3*d)*s^2 + 6*s*t + 8*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*mb^2*
    ((18 - 9*d + d^2)*s^2 - (2 + d)*s*t - 2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*(3*(-2 + d)*s^2 + 10*s*t + 8*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
  (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*(3*(-2 + d)*s^3 + 10*s^2*t - 
     2*s*((2 + d)*mb^2 - 4*t)*t - 4*(-2 + d)*mb^2*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(1 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*mb^2*
   ...
   (Pi^(2*d)*s) + (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*
    (-(s*((-12 + 5*d)*s^2 + 12*s*t + 12*t^2)) + 
     2*mb^2*((-10 + 3*d)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*((20 - 8*d + d^2)*s^2 + 
     4*(-4 + d)*s*t + 4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (Pi^(2*d)*s) - (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*
    ((26 - 7*d + d^2)*s^2 + 4*(-3 + d)*s*t + 4*(-3 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
  (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*
    ((-2 + d)*mb^2*((-4 + d)*s^2 + 4*s*t + 4*t^2) - 
     s*((6 + d)*s^2 + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*mb^2*
   ...
   (Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*
    (d*s^2 + 4*t*(2*s + t) - (-2 + d)*mb^2*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*mb^2*(3*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s^2 + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s^2 + 4*t^2 + 
     (-2 + d)*mb^2*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(s + 2*t)^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(-4*(-2 + d)*mb^2*s + (s + 2*t)^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((40 - 17*d + 2*d^2)*s^2 + 
     4*(-4 + d)*s*t + 4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((54 - 19*d + 2*d^2)*s^2 + 
     4*(-4 + d)*s*t + 4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*(-7 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) - 
  (9*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*mb^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(2*s*(s + 2*t) - 
     (-2 + d)*mb^2*(5*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) - (21*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*
    gAu^2*mb^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s) - 
  (3*4^(3 - d)*EL^8*gAd^2*gAl^4*gAu^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s) - 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(2*s^2 - (-2 + d)*mb^2*t + 4*s*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(2*(-2 + d)*s^2 + 5*s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(2*(-2 + d)*s^2 + 5*s*t + 2*t^2 + 
     (-2 + d)*mb^2*(7*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*
    ((32 - 12*d + d^2)*s^2 + (16 - 3*d)*s*t - 2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((42 - 15*d + d^2)*s^2 - 
     3*(-6 + d)*s*t - 2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-10 + 3*d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-6 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-20 + 3*d)*s - 14*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
  (3*4^(3 - d)*EL^8*gAd^2*gAl^4*gAu^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(3*d*s + 10*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-3 + d)*s^2 + s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-16 + 3*d)*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-26 + 5*d)*s^2 - 8*s*t - 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-1 + d)*s^2 - 5*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s*((-8 + d)*s - 6*t) - 
     2*(-2 + d)*mb^2*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*
    (-((-2 + d)*mb^2*(s + t)) + 2*s*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-10 + 3*d)*s - 10*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-2 + d)*mb^2 + (-1 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-3 + d)*s^2 + s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-12 + d)*s^2 - 11*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(-((-18 + d)*s^2) + 18*s*t + 8*t^2 + 
     2*(-2 + d)*mb^2*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s^2 + (-16 + 3*d)*s*t + 
     2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*t*
    ((-14 + 3*d)*s + 2*(-4 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (9*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*mb^2*(s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1]])/(Pi^(2*d)*s) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-2 + d)*mb^2*(s - 4*t) + 
     2*s*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*
    ((-7 + 2*d)*s^2 - s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-7 + 2*d)*s^2 + 
     (-2 + d)*mb^2*(5*s - 2*t) - s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((24 - 11*d + d^2)*s^2 - d*s*t - 
     2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q1]])/
   (Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*
    ((32 - 14*d + d^2)*s^2 - (2 + d)*s*t - 2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-8 + 3*d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-2 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(3*(-2 + d)*s + 14*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-2 + d)*s^2 + 3*s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-10 + 3*d)*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-22 + 5*d)*s^2 - 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(d*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((2 + d)*s^2 + s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-2 + d)*s^2 + 2*(-2 + d)*mb^2*t + 
     6*s*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-2 + d)*s^2 + 3*s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-3 + d)*s^2 + 7*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(-((-8 + d)*s^2) + 
     2*(-2 + d)*mb^2*(s - 2*t) - 2*s*t + 8*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(4*s^2 + d*s*t + 2*(-4 + d)*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s + t)*((-6 + d)*s - 2*(-4 + d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*t*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-5 + 2*d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*((28 - 8*d + d^2)*s^2 + 
     4*(-4 + d)*s*t + 4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[q2, q2]])/Pi^(2*d) + 
  (3*2^(5 - 2*d)*(-5 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-15 + 2*d)*s^2 - 4*s*t - 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-3 + 2*d)*s^2 - 4*s*t - 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(2*(-2 + d)*mb^2*s + 5*s^2 + 4*s*t + 
     4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-8 + 3*d)*s^2 + 4*(-4 + d)*s*t + 
     4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*
    ((-2 + d)*s^2 + 4*(-4 + d)*s*t + 4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s + 2*t)^2*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(1 - d)*EL^8*gAd^2*gAl^4*gAu^2*((12 - 8*d + d^2)*s^2 + 
     4*(-4 + d)*s*t + 4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(3 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-19 + 3*d)*s - 4*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(5*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-8 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(4 - d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (3*2^(9 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(3 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (3*4^(3 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (9*4^(2 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (9*4^(2 - d)*(-6 + d)*EL^8*gAd^2*gAl^4*gAu^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (9*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + 3*d)*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(3*(-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-22 + 3*d)*s - 10*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(3 - d)*EL^8*gAd^2*gAl^4*gAu^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (9*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-14 + 3*d)*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-14 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*(5*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-22 + 5*d)*s + 4*(-5 + d)*t)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(7*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-12 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(2*s - (-8 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(7 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (9*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(5*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(5*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*(7*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-26 + 7*d)*s + 2*(-2 + d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, p3]])/
   (Pi^(2*d)*s) - (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, p3]])/
   (Pi^(2*d)*s^2) + (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + 3*d)*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/
   (Pi^(2*d)*s^2) - (3*4^(3 - d)*EL^8*gAd^2*gAl^4*gAu^2*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, p3]])/
   (Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(3 - d)*EL^8*gAd^2*gAl^4*gAu^2*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, p3]])/
   (Pi^(2*d)*s^2) - (3*4^(3 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q1]])/
   (Pi^(2*d)*s) - (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(3*(-4 + d)*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p3, p3]])/
   (Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s + 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-16 + 3*d)*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (3*4^(3 - d)*EL^8*gAd^2*gAl^4*gAu^2*t*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(d*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-6 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(5*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(3 - d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-10 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-6 + d)*s + (-8 + d)*t)*
   ...
   (Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-6 + d)*s - 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(d*s + 6*t)*
  ...
  (3*2^(5 - 2*d)*(-3 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (3*4^(2 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (3*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(7*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (9*4^(2 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*(s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (9*4^(2 - d)*(-6 + d)*EL^8*gAd^2*gAl^4*gAu^2*(s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (9*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s - t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*((-6 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(3*(-4 + d)*s + 10*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-8 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*(s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*((-2 + d)*s - 4*(-5 + d)*t)*
   ...
   (Pi^(2*d)*s^2) - (3*4^(3 - d)*EL^8*gAd^2*gAl^4*gAu^2*(s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(5*s - 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (3*2^(7 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (9*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(3*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*EL^8*gAd^2*gAl^4*gAu^2*(3*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (3*4^(2 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*(5*s - 2*t)*
  ...
  (3*4^(2 - d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAd^2*gAl^4*gAu^2*(s - 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*(-2 + d)*EL^8*gAd^2*gAl^4*gAu^2*(s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*(-4 + d)*EL^8*gAd^2*gAl^4*gAu^2*\[Mu]^(8 - 2*d)*
