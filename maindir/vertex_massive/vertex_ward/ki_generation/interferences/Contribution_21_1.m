...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[-q1, mm], 
 ...
 (-(((aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*(mm^2 - s)*s*
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
  (EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*(mm^4*(8*psq - 2*s) + psq*s^2 + 
       3*mm^2*s*(-2*psq + s)) - aa*(mm^4*(8*psq - 4*s) + psq*s^2 + 
       mm^2*s*(-4*psq + 3*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2*Pi)^(2*d) - (EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(mm^4*(8*psq - 2*s) + psq*s^2 + 3*mm^2*s*(-2*psq + s)) - 
     bb*(mm^4*(8*psq - 4*s) + psq*s^2 + mm^2*s*(-4*psq + 3*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*(mm^2 + psq + s)*
  ...
  (EL^5*gAl*gHll^2*gXll^2*mm^4*s*(bb*mm^2*(8*psq - 3*s) + aa*psq*s - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
   ...
   Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (-(bb*(3*mm^2 + psq)*s) + aa*(4*mm^4 + psq*s + mm^2*(-4*psq + 3*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 + psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (4*mm^4 - psq*s + mm^2*(4*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(8*psq - 5*s) - 
