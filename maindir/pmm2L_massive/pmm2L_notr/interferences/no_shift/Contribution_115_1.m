...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
     (gZlL^2*(-((-2 + d)^2*mm^4*(2*Pi)^(2*d)*s) + 2^(1 + 2*d)*(-2 + d)*mm^2*
         Pi^(2*d)*(-2*psq^2 + (-2 + d)*psq*s - (-2 + d)*s^2 + 4*psq*t - 
          2*s*t - 2*t^2) - (2*Pi)^(2*d)*s*((16 - 4*d + d^2)*psq^2 + 
          (28 - 16*d + d^2)*psq*s + 3*(-2 + d)*s^2 - 24*psq*t + 12*s*t + 
          12*t^2)) + gZlR^2*(-((-2 + d)^2*mm^4*(2*Pi)^(2*d)*s) + 
        2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(-2*psq^2 + (-2 + d)*psq*s - 
          (-2 + d)*s^2 + 4*psq*t - 2*s*t - 2*t^2) - (2*Pi)^(2*d)*s*
         ((16 - 4*d + d^2)*psq^2 + (28 - 16*d + d^2)*psq*s + 3*(-2 + d)*s^2 - 
          24*psq*t + 12*s*t + 12*t^2)) + 2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
       (-6*d*psq*s^2 + d^2*(2*mm^2 + psq)*s^2 + 
        4*d*mm^2*(psq^2 - 3*s^2 - 2*psq*t + s*t + t^2) + 
        8*s*(psq^2 + 2*mm^2*s + psq*(s - 2*t) + t*(s + t))))*\[Mu]^(8 - 2*d))/
    (Pi^(4*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
     (gZlL^2*(-(s*((-12 - 2*d + d^2)*psq + (-8 + d)*((-4 + d)*s - 2*t))) + 
        (-2 + d)*mm^2*(4*psq + (-6 + d)*s - 4*t)) + 
      gZlR^2*(-(s*((-12 - 2*d + d^2)*psq + (-8 + d)*((-4 + d)*s - 2*t))) + 
        (-2 + d)*mm^2*(4*psq + (-6 + d)*s - 4*t)) + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-4*d*gZlL*gZlR*mm^2*(4*psq^2 + s^2 + 2*mm^2*(psq - s - t) + 3*s*t + 
        2*t^2 - 3*psq*(s + 2*t)) + 
      gZlL^2*((-2 + d)*mm^4*(4*psq + (-6 + d)*s - 4*t) + 
        2*mm^2*(4*(-2 + d)*psq^2 + (4 + d - d^2)*psq*s + 2*(-3 + d)*s^2 - 
          6*(-2 + d)*psq*t + (-8 + 3*d)*s*t + 2*(-2 + d)*t^2) + 
        s*((12 - 4*d + d^2)*psq^2 - 2*psq*(s + d*s + 6*t) + 
          2*(s^2 + 3*s*t + 2*t^2))) + 
      gZlR^2*((-2 + d)*mm^4*(4*psq + (-6 + d)*s - 4*t) + 
        2*mm^2*(4*(-2 + d)*psq^2 + (4 + d - d^2)*psq*s + 2*(-3 + d)*s^2 - 
          6*(-2 + d)*psq*t + (-8 + 3*d)*s*t + 2*(-2 + d)*t^2) + 
        s*((12 - 4*d + d^2)*psq^2 - 2*psq*(s + d*s + 6*t) + 
          2*(s^2 + 3*s*t + 2*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
     (-2*gZlL*gZlR*(d^2*s^2 + 8*s*(2*psq + s - 2*t) + 4*d*mm^2*(psq - t) - 
        2*d*s*(psq + 3*s - t)) + gZlL^2*((20 - 6*d + d^2)*psq*s + 
        (-2 + d)*mm^2*(4*psq - (-2 + d)*s - 4*t) + 
        (-8 + d)*s*((-2 + d)*s + 2*t)) + gZlR^2*((20 - 6*d + d^2)*psq*s + 
        (-2 + d)*mm^2*(4*psq - (-2 + d)*s - 4*t) + 
        (-8 + d)*s*((-2 + d)*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (4*d*gZlL*gZlR*mm^2*(-(psq*(s - 2*t)) + 2*mm^2*(psq - t) - 
        t*(s + 2*t)) + gZlL^2*((-2 + d)*mm^4*(-4*psq + (-2 + d)*s + 4*t) - 
        2*mm^2*((8 - 5*d + d^2)*psq*s - (-2 + d)*s^2 + 2*(-2 + d)*psq*t - 
          d*s*t - 2*(-2 + d)*t^2) + s*((-2 + d)^2*psq^2 + 2*t*(s + 2*t) - 
          2*psq*((-3 + d)*s + 2*t))) + 
      gZlR^2*((-2 + d)*mm^4*(-4*psq + (-2 + d)*s + 4*t) - 
        2*mm^2*((8 - 5*d + d^2)*psq*s - (-2 + d)*s^2 + 2*(-2 + d)*psq*t - 
          d*s*t - 2*(-2 + d)*t^2) + s*((-2 + d)^2*psq^2 + 2*t*(s + 2*t) - 
          2*psq*((-3 + d)*s + 2*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
     (2*gZlL*gZlR*(2*d*mm^2 + 16*s - 7*d*s + d^2*s) + 
      gZlL^2*((8 - 6*d + d^2)*mm^2 - (-2 + d)^2*psq - (24 - 11*d + d^2)*s) + 
      gZlR^2*((8 - 6*d + d^2)*mm^2 - (-2 + d)^2*psq - (24 - 11*d + d^2)*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-2*gZlL*gZlR*mm^2*(d*(2*mm^2 + 2*psq - 7*s) + 8*s + d^2*s) + 
   ...
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*(4*(-4 + d)^2*gZlL*gZlR*s^2 + 
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-4*(8 - 6*d + d^2)*gZlL*gZlR*mm^2*s + 
      gZlL^2*(4*(-2 + d)*mm^4 + 8*psq^2 + (30 - 13*d + d^2)*psq*s - 6*s^2 + 
        2*d*s^2 + (-2 + d)*mm^2*(-4*psq + (-1 + d)*s) - 16*psq*t + 8*s*t + 
        8*t^2) + gZlR^2*(4*(-2 + d)*mm^4 + 8*psq^2 + (30 - 13*d + d^2)*psq*
         s - 6*s^2 + 2*d*s^2 + (-2 + d)*mm^2*(-4*psq + (-1 + d)*s) - 
        16*psq*t + 8*s*t + 8*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s) - (4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-2*gZlL*gZlR*mm^2*(8*s + d^2*s + 2*d*(psq - 4*s - t)) + 
      gZlL^2*((2 + d)*psq^2 + (10 - 9*d + d^2)*psq*s + 
        (-2 + d)*mm^2*(psq - s - t) - (6 + d)*psq*t + 4*(s + t)^2) + 
      gZlR^2*((2 + d)*psq^2 + (10 - 9*d + d^2)*psq*s + 
        (-2 + d)*mm^2*(psq - s - t) - (6 + d)*psq*t + 4*(s + t)^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*(-4*(-4 + d)^2*gZlL*gZlR*s + 
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-2*gZlL*gZlR*mm^2*(8*s + d^2*s + d*(-6*psq - 4*s + 6*t)) + 
      gZlL^2*(4*(-2 + d)*mm^4 - (-6 + d)*psq^2 + (18 - 9*d + d^2)*psq*s - 
        (-2 + d)*mm^2*(9*psq - 3*s - 5*t) + (-10 + d)*psq*t + 
        2*(s^2 + 4*s*t + 2*t^2)) + gZlR^2*(4*(-2 + d)*mm^4 - (-6 + d)*psq^2 + 
        (18 - 9*d + d^2)*psq*s - (-2 + d)*mm^2*(9*psq - 3*s - 5*t) + 
        (-10 + d)*psq*t + 2*(s^2 + 4*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-8*d*gZlL*gZlR*mm^2 + gZlL^2*(3*(-2 + d)*mm^2 + (2 + d)*psq - 
        4*(s + t)) + gZlR^2*(3*(-2 + d)*mm^2 + (2 + d)*psq - 4*(s + t)))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-2*gZlL*gZlR*mm^2*(8*s + d^2*s + 2*d*(3*psq - 5*s - 3*t)) + 
      gZlL^2*(4*(-2 + d)*mm^4 + (2 + d)*psq^2 + (28 - 10*d + d^2)*psq*s - 
        2*s^2 + (-2 + d)*mm^2*(psq - 2*s - 5*t) - (6 + d)*psq*t + 4*t^2) + 
      gZlR^2*(4*(-2 + d)*mm^4 + (2 + d)*psq^2 + (28 - 10*d + d^2)*psq*s - 
        2*s^2 + (-2 + d)*mm^2*(psq - 2*s - 5*t) - (6 + d)*psq*t + 4*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(-2*(-8 + d)*gZlL*gZlR*mm^2*s + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (4*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
      gZlL^2*(s*((-2 + d)^2*psq - 2*(-4 + d)*s) - (-2 + d)*mm^2*
         (-4*psq + d*s + 4*t)) + gZlR^2*(s*((-2 + d)^2*psq - 2*(-4 + d)*s) - 
        (-2 + d)*mm^2*(-4*psq + d*s + 4*t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(-2*d*gZlL*gZlR*mm^2 + 
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     ...
     gHll^2*mm^4*(2*(-4 + d)*gZlL*gZlR*s + gZlL^2*(psq - t) + 
      gZlR^2*(psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (2*gZlL*gZlR*mm^2*(8*s + d^2*s - 2*d*(psq + 3*s - t)) + 
      gZlL^2*((-6 + d)*psq^2 + (-2 + d)*mm^2*(psq - t) - 4*t^2 - 
        psq*((-4 + d)^2*s + (-10 + d)*t)) + 
      gZlR^2*((-6 + d)*psq^2 + (-2 + d)*mm^2*(psq - t) - 4*t^2 - 
        psq*((-4 + d)^2*s + (-10 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-8*d*gZlL*gZlR*mm^2 + gZlL^2*(3*(-2 + d)*mm^2 + (-6 + d)*psq + 4*t) + 
      gZlR^2*(3*(-2 + d)*mm^2 + (-6 + d)*psq + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
     (2*(-2 + d)*mm^2 - 4*(-4 + d)*psq + 16*s - 8*d*s + d^2*s - 12*t + 2*d*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(8*d*gZlL*gZlR*mm^2*(psq - t) + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (gZlL^2*(s*(-((-2 + d)^2*psq) + 2*(-4 + d)*s) + 
        (-2 + d)*mm^2*(4*psq + (-4 + d)*s - 4*t)) + 
      gZlR^2*(s*(-((-2 + d)^2*psq) + 2*(-4 + d)*s) + 
        (-2 + d)*mm^2*(4*psq + (-4 + d)*s - 4*t)) + 4*d*gZlL*gZlR*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(8*d*gZlL*gZlR*mm^2*(-psq + t) + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(-2*d*gZlL*gZlR*mm^2 + 
      gZlL^2*((-2 + d)*mm^2 - s) + gZlR^2*((-2 + d)*mm^2 - s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(24 - 10*d + d^2)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(4*d*gZlL*gZlR*mm^2 + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (4^(2 - d)*(28 - 10*d + d^2)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
     (2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
     (gZlL^2 + gZlR^2)*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-4 + d)^2*EL^8*gAl^2*gAu^2*gHll^2*
     (gZlL^2 + gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
