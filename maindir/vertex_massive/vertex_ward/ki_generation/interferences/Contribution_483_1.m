...
PropList[KiraPropagator[-q1, mw], KiraPropagator[-q1 - q2, mz], 
 ...
 ((2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gXFAW*gXFW*(mm^2 + psq)*(psq - s)*s*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - ((aa - bb)*EL^5*gWlN*gWNl*gXFAW*gXFW*
    (mm^2 + psq)*(psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) + 
  (EL^5*gWlN*gWNl*gXFAW*gXFW*(-(bb*(psq*(2*psq - s) + mm^2*(2*psq + s))) + 
  ...
  (EL^5*gWlN*gWNl*gXFAW*gXFW*(aa*psq*(mm^2 + psq + s) - 
   ...
   (2*Pi)^(2*d) + (EL^5*gWlN*gWNl*gXFAW*gXFW*(aa*(3*mm^2 + psq) - 
     bb*(mm^2 + 3*psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  (EL^5*gWlN*gWNl*gXFAW*gXFW*(aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*s*
