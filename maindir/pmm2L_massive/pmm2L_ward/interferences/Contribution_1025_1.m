...
PropList[KiraPropagator[q1, mw], KiraPropagator[q2, 0], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*s*
    (bb*(mm^4*(5*(-2 + d)*psq - 5*(-2 + d)*s + (-6 + d)*t) + 
     ...
     aa*(mm^4*((-22 + 7*d)*psq + 16*s - 6*d*s + 6*t - d*t) + 
       ...
       mm^2*((22 + 3*d)*psq^2 - psq*(-12*s + 17*d*s + 6*t + 9*d*t) + 
         s*(-22*s + 12*d*s - 6*t + 11*d*t))))*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*2^(-1 - 4*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2^(1 + 2*d)*mm^4*Pi^(2*d)*(2*(-6 + d)*psq + (26 - 11*d)*s - 
         2*(-6 + d)*t) + mm^2*(2*Pi)^(2*d)*(12*(2 + 3*d)*psq^2 - 
         4*psq*(20*d*s + 6*t + 9*d*t) + s*(-86*s + 61*d*s - 36*t + 86*d*t)) + 
       (2*Pi)^(2*d)*(-40*(-2 + d)*psq^3 + 5*(-2 + d)*s^2*(s + 2*t) + 
         8*psq^2*(2*(-17 + 7*d)*s + 5*(-2 + d)*t) - 
         4*psq*s*((-49 + 19*d)*s + 6*(-9 + 4*d)*t))) + 
     bb*(-(2^(1 + 2*d)*mm^4*Pi^(2*d)*(2*(-6 + d)*psq + (-14 + 9*d)*s - 
          2*(-6 + d)*t)) + (2*Pi)^(2*d)*(40*(-2 + d)*psq^3 - 
         40*(-2 + d)*psq^2*(3*s + t) - 5*(-2 + d)*s^2*(s + 2*t) + 
         4*psq*s*(5*(-3 + 2*d)*s + 6*(-9 + 4*d)*t)) - 
       mm^2*(2*Pi)^(2*d)*(12*(2 + 3*d)*psq^2 - 4*psq*(4*(-3 + 8*d)*s + 
  ...
  (I*2^(-1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2^(1 + 2*d)*(3 + d)*mm^4*Pi^(2*d)*(psq - t) + 
       (2*Pi)^(2*d)*(20*(-2 + d)*psq^3 - (-13 + 7*d)*s^2*(s + t) + 
         psq^2*((50 - 22*d)*s - 20*(-2 + d)*t) + 
         psq*s*(-23*s + 15*d*s - 50*t + 22*d*t)) - mm^2*(2*Pi)^(2*d)*
        ((6 + 22*d)*psq^2 - psq*(23*s + 15*d*s + 6*t + 22*d*t) + 
         s*((23 + d)*s + 3*(t + 5*d*t)))) + 
     bb*(-(2^(1 + 2*d)*(3 + d)*mm^4*Pi^(2*d)*(psq - 2*s - t)) + 
       (2*Pi)^(2*d)*(-20*(-2 + d)*psq^3 + (-13 + 7*d)*s^2*(s + t) + 
         2*psq^2*((-55 + 29*d)*s + 10*(-2 + d)*t) + 
         psq*s*((89 - 43*d)*s + 50*t - 22*d*t)) + mm^2*(2*Pi)^(2*d)*
        ((6 + 22*d)*psq^2 - psq*(-25*s + 55*d*s + 6*t + 22*d*t) + 
         s*((-43 + 29*d)*s + 3*(t + 5*d*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(4*d) + (I*2^(-1 - 4*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2^(1 + 2*d)*mm^4*Pi^(2*d)*((-6 + d)*psq - 5*(-2 + d)*s - 
         (-6 + d)*t) + (2*Pi)^(2*d)*(-20*(-2 + d)*psq^3 + 
         5*(-2 + d)*s^2*(s + 3*t) + psq*s*((78 - 33*d)*s + 4*(29 - 14*d)*t) + 
         4*psq^2*(3*(-9 + 4*d)*s + 5*(-2 + d)*t)) + mm^2*(2*Pi)^(2*d)*
        (6*(2 + 3*d)*psq^2 - psq*((42 + 23*d)*s + 6*(2 + 3*d)*t) + 
         s*((2 + 13*d)*s + (-6 + 41*d)*t))) - 
     bb*(2^(1 + 2*d)*mm^4*Pi^(2*d)*((-6 + d)*psq + 5*(-2 + d)*s - 
         (-6 + d)*t) + (2*Pi)^(2*d)*(-20*(-2 + d)*psq^3 + 
         5*(-2 + d)*s^2*(s + 3*t) + psq*s*((74 - 39*d)*s + 4*(29 - 14*d)*t) + 
         4*psq^2*((-39 + 19*d)*s + 5*(-2 + d)*t)) + mm^2*(2*Pi)^(2*d)*
        (6*(2 + 3*d)*psq^2 - psq*((-46 + 71*d)*s + 6*(2 + 3*d)*t) + 
         s*((6 + 19*d)*s + (-6 + 41*d)*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/Pi^(4*d) - (I*2^(-1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*
    gWWA^2*(bb*(2*mm^4*(-psq + s + t) + mm^2*(2*psq^2 + psq*s - 4*s^2 - 
         2*psq*t - 3*s*t) + s*(-2*psq^2 + 3*psq*s + 2*psq*t + s*t)) + 
     aa*(2*mm^4*(psq + s - t) - s*(-6*psq^2 + psq*s + 2*psq*t + s*t) + 
       mm^2*(-2*psq^2 - 9*psq*s + 2*s^2 + 2*psq*t + 3*s*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(-1 - 4*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2^(1 + 2*d)*(3 + d)*mm^4*Pi^(2*d)*(psq + s - t) - 
       mm^2*(2*Pi)^(2*d)*((6 + 22*d)*psq^2 + (-37 + 3*d)*psq*s + 
         (46 - 14*d)*s^2 - 2*(3 + 11*d)*psq*t + 3*s*(t + 5*d*t)) + 
       (2*Pi)^(2*d)*(20*(-2 + d)*psq^3 + (13 - 7*d)*s^2*t + 
         psq^2*(-6*(-5 + d)*s - 20*(-2 + d)*t) + 
         psq*s*(13*s - 7*d*s - 50*t + 22*d*t))) + 
     bb*(-(2^(1 + 2*d)*(3 + d)*mm^4*Pi^(2*d)*(psq - s - t)) + 
       (2*Pi)^(2*d)*(-20*(-2 + d)*psq^3 + (-13 + 7*d)*s^2*t + 
         psq^2*(6*(-15 + 7*d)*s + 20*(-2 + d)*t) + 
         psq*s*((53 - 21*d)*s + 50*t - 22*d*t)) + mm^2*(2*Pi)^(2*d)*
        ((6 + 22*d)*psq^2 - psq*(-11*s + 37*d*s + 6*t + 22*d*t) + 
         s*(2*(-10 + 7*d)*s + 3*(t + 5*d*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(4*d) - (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*s*
    (bb*(2*(-8 + 3*d)*mm^4 + psq*(5*(-2 + d)*psq - 22*s + 7*d*s + 26*t - 
         11*d*t) + mm^2*((6 - 11*d)*psq + 32*s - 7*d*s - 6*t + 11*d*t)) + 
     aa*(2*(-8 + 3*d)*mm^4 + mm^2*((-6 + 11*d)*psq + (38 - 18*d)*s + 
         (6 - 11*d)*t) + psq*((42 - 17*d)*psq + 6*(-8 + 3*d)*s + 
         (-26 + 11*d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*s*
    (bb*(-2*psq^2 + s*(mm^2 - s - 2*t) + 2*psq*(s + t)) + 
     aa*(2*psq^2 - 2*psq*(2*s + t) + s*(mm^2 + s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*s*
    (bb*(2*(-8 + 3*d)*mm^4 + psq*((-16 + 9*d)*psq + (-16 + 3*d)*s + 
         (32 - 15*d)*t) + mm^2*(-3*(-4 + 5*d)*psq + (26 - 3*d)*s + 
         3*(-4 + 5*d)*t)) + aa*(2*(-8 + 3*d)*mm^4 + 
       mm^2*(3*(-4 + 5*d)*psq + (38 - 18*d)*s + 3*(4 - 5*d)*t) + 
       psq*((48 - 21*d)*psq + 6*(-8 + 3*d)*s + (-32 + 15*d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
  ...
  (I*EL^5*gAl^3*gWWA^2*(bb*(6*(-6 + d)*mm^4 - 24*(-11 + 6*d)*psq^2 - 
       10*(-2 + d)*s*(5*s + 8*t) + 4*psq*((-111 + 56*d)*s + 30*(-2 + d)*t) + 
       mm^2*(2*(6 + 49*d)*psq + 154*s - 119*d*s - 80*d*t)) + 
     aa*(2*(-6 + d)*mm^4 + 8*(-29 + 14*d)*psq^2 + 10*(-2 + d)*s*(5*s + 8*t) - 
       4*psq*((-51 + 26*d)*s + 30*(-2 + d)*t) + 
       mm^2*((4 - 74*d)*psq + 86*s - d*s + 80*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(2*d) + 
  (I*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
  ...
  (I*EL^5*gAl^3*gWWA^2*(aa*(2*(3 + d)*mm^4 + (112 - 52*d)*psq^2 + 
       4*(-19 + 12*d)*psq*s + (56 - 29*d)*s^2 + 60*(-2 + d)*psq*t - 
       30*(-2 + d)*s*t + mm^2*((2 + 30*d)*psq - (57 + d)*s - 40*d*t)) + 
  ...
  (I*EL^5*gAl^3*gWWA^2*(bb*(2*(-6 + d)*mm^4 - 8*(-31 + 16*d)*psq^2 - 
       10*(-2 + d)*s*(3*s + 8*t) + 4*psq*((-89 + 44*d)*s + 30*(-2 + d)*t) + 
       mm^2*((4 + 86*d)*psq + 86*s - 81*d*s - 80*d*t)) + 
     aa*(6*(-6 + d)*mm^4 + mm^2*((12 - 62*d)*psq + 154*s - 39*d*s + 80*d*t) + 
       2*(12*(-9 + 4*d)*psq^2 + (58 - 28*d)*psq*s - 60*(-2 + d)*psq*t + 
         5*(-2 + d)*s*(3*s + 8*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*gWWA^2*(aa*(6*(3 + d)*mm^4 + (72 - 20*d)*psq^2 - 
       12*(-2 + d)*psq*(2*s - 5*t) + s*(-((-4 + d)*s) - 30*(-2 + d)*t) + 
       mm^2*(-6*(-5 + d)*psq - 155*s + 57*d*s - 40*d*t)) + 
     bb*(2*(3 + d)*mm^4 + 4*(-32 + 17*d)*psq^2 - 
       4*psq*((-41 + 18*d)*s + 15*(-2 + d)*t) + 
       s*((-4 + d)*s + 30*(-2 + d)*t) + mm^2*((2 - 50*d)*psq - 57*s + 
         39*d*s + 40*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*
  ...
  (I*EL^5*gAl^3*gWWA^2*(aa*(4*(-7 + 6*d)*psq^2 + (-49 + 26*d)*s*(s + 2*t) + 
  ...
  (I*EL^5*gAl^3*gWWA^2*(2*aa*mm^2*(12*(-1 + d)*psq + s - 3*d*s - 
       12*(-1 + d)*t) + bb*mm^2*(-24*(-1 + d)*psq + 2*(-11 + 9*d)*s + 
       24*(-1 + d)*t) + bb*(-5 + 3*d)*(8*psq^2 - 8*psq*(s + t) + 
       s*(s + 2*t)) - aa*(-5 + 3*d)*(8*psq^2 - 4*psq*(s + 2*t) + 
       s*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl^3*gWWA^2*
    (bb*((52 - 32*d)*psq^2 + 8*(-8 + 5*d)*psq*s + 4*(-13 + 8*d)*psq*t - 
       (-8 + 5*d)*s*(s + 2*t) + mm^2*(4*(-9 + 8*d)*psq + (40 - 30*d)*s + 
         4*(9 - 8*d)*t)) + aa*(4*(-13 + 8*d)*psq^2 + (-8 + 5*d)*s*(s + 2*t) - 
       4*psq*((-5 + 3*d)*s + (-13 + 8*d)*t) + 
  ...
  (I*EL^5*gAl^3*gWWA^2*(bb*(2*(-6 + d)*mm^4 + (72 - 42*d)*psq^2 + 
       80*(-2 + d)*psq*s + 2*(-32 + 17*d)*psq*t - 10*(-2 + d)*s*(2*s + 3*t) + 
       mm^2*(5*(2 + 5*d)*psq + 60*s - 40*d*s - 6*t - 19*d*t)) + 
     aa*((-64 + 34*d)*psq^2 + 10*(-2 + d)*s*(2*s + 3*t) + 
       psq*(68*s - 38*d*s + 64*t - 34*d*t) + mm^2*(-((6 + 19*d)*psq) + 32*s - 
         2*d*s + 6*t + 19*d*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*gWWA^2*(bb*(4*(3 + d)*mm^4 + 6*(-17 + 11*d)*psq^2 + 
  ...
  (I*EL^5*gAl^3*gWWA^2*(aa*(2*(-6 + d)*mm^4 + 60*(-2 + d)*psq^2 + 
       30*(-2 + d)*s*(s + 2*t) + psq*(92*s - 52*d*s + 128*t - 68*d*t) + 
  ...
  (I*EL^5*gAl^3*gWWA^2*(aa*(2*(3 + d)*mm^4 + (54 - 26*d)*psq^2 + 
  ...
  (I*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(-2*aa*psq^2 + 2*bb*psq^2 + 
   ...
   (2*Pi)^(2*d) + (I*EL^5*gAl^3*gWWA^2*
    (bb*(2*(-7 + 6*d)*psq^2 + (73 - 34*d)*psq*s + 10*(-2 + d)*s^2 + 
     ...
     aa*(-2*(-7 + 6*d)*psq^2 + (-7 + 6*d)*psq*(3*s + 2*t) + 
       s*(-10*(-2 + d)*s + (43 - 22*d)*t) + 
       mm^2*(-2*(-6 + d)*psq + (-35 + 11*d)*s + 2*(-6 + d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gWWA^2*(2*bb*mm^2*(6*(-1 + d)*psq + (13 - 9*d)*s - 
       6*(-1 + d)*t) - 4*aa*mm^2*(3*(-1 + d)*psq - s - 3*(-1 + d)*t) - 
     bb*(-5 + 3*d)*(4*psq^2 - 9*psq*s + 2*s^2 - 4*psq*t + 3*s*t) + 
     aa*(-5 + 3*d)*(4*psq^2 - 3*psq*s + 2*s^2 - 4*psq*t + 3*s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(aa*((26 - 16*d)*psq^2 + 3*(-8 + 5*d)*psq*s + 
       2*(-13 + 8*d)*psq*t - (-8 + 5*d)*s*(2*s + 3*t) + 
       2*mm^2*((-9 + 8*d)*psq - 2*s + 9*t - 8*d*t)) + 
     bb*(2*(-13 + 8*d)*psq^2 + (-8 + 5*d)*s*(2*s + 3*t) + 
       psq*(66*s - 41*d*s + 26*t - 16*d*t) - 2*mm^2*((-9 + 8*d)*psq + 19*s - 
         13*d*s + 9*t - 8*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*((-64 + 30*d)*psq^2 + (-16 + 9*d)*s*(2*s + 3*t) + 
  ...
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(mm^2 - 2*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (I*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*mm^2 + 2*psq - 7*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
   ...
   Pi^(2*d) + (I*EL^5*gAl^3*gWWA^2*((-6 + d)*mm^2 + 2*(-5 + 4*d)*psq + 
     (19 - 11*d)*s)*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(aa*(2*(3 + d)*mm^4 + (66 - 34*d)*psq^2 + 
     ...
     bb*(2*(3 + d)*mm^4 + (-94 + 58*d)*psq^2 + 
       ...
       s*(15*(-2 + d)*s + (-38 + 17*d)*t) + 
       mm^2*((14 - 44*d)*psq + 26*(-3*s + 2*d*s + d*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*gWWA^2*((-6 + d)*mm^2 + 2*(-5 + 4*d)*psq + (19 - 11*d)*s)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (bb*(2*(-23 + 9*d)*psq^2 + (-13 + 7*d)*s*(s + t) + 
       ...
       (-13 + 7*d)*s*(s + t) + 2*mm^2*((-3 + 9*d)*psq - 10*s + 3*t - 9*d*t) + 
       psq*(-13*s + 7*d*s - 46*t + 18*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, p3]])/Pi^(2*d) - 
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq^2 - 13*psq*s + 6*s^2 + 
     mm^2*(4*psq - s - 4*t) - 2*psq*t + 11*s*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(aa*(4*(-5 + 4*d)*psq^2 + (51 - 32*d)*psq*s + 
       (-22 + 13*d)*s^2 + (-6 + d)*mm^2*(2*psq - s - 2*t) + 
       4*(5 - 4*d)*psq*t + (-41 + 24*d)*s*t) - 
     bb*(4*(-5 + 4*d)*psq^2 + (57 - 36*d)*psq*s + (-22 + 13*d)*s^2 + 
       4*(5 - 4*d)*psq*t + (-41 + 24*d)*s*t + 
       mm^2*(2*(-6 + d)*psq + 3*d*s + 12*t - 2*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gWWA^2*(2*bb*mm^2*(6*(-1 + d)*psq + (13 - 9*d)*s - 
       6*(-1 + d)*t) - 4*aa*mm^2*(3*(-1 + d)*psq - s - 3*(-1 + d)*t) + 
     aa*(-5 + 3*d)*(4*psq^2 + s*(s + t) - psq*(s + 4*t)) - 
     bb*(-5 + 3*d)*(4*psq^2 + s*(s + t) - psq*(7*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(aa*((26 - 16*d)*psq^2 + (-2 + d)*psq*s + 
       2*(-13 + 8*d)*psq*t - (-2 + d)*s*(s + t) + 
       2*mm^2*((-9 + 8*d)*psq - 2*s + 9*t - 8*d*t)) + 
     bb*(2*(-13 + 8*d)*psq^2 + (-2 + d)*s*(s + t) + 
       psq*(32*s - 19*d*s + 26*t - 16*d*t) - 2*mm^2*((-9 + 8*d)*psq + 13*s - 
         9*d*s + 9*t - 8*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[q1, q2]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (bb*((-58 + 26*d)*psq^2 + (-7 + 3*d)*s*(s + t) + 
       psq*(79*s - 35*d*s + 58*t - 26*d*t) - 2*mm^2*((-9 + 13*d)*psq + 26*s - 
         16*d*s + 9*t - 13*d*t)) + aa*((58 - 26*d)*psq^2 - 
       (-7 + 3*d)*s*(s + t) + 2*mm^2*((-9 + 13*d)*psq - 10*s + 9*t - 
         13*d*t) + psq*(-7*s + 3*d*s - 58*t + 26*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*gWWA^2*(bb*((64 - 34*d)*psq^2 - 10*(-2 + d)*s*(s + 3*t) + 
  ...
  (I*EL^5*gAl^3*gWWA^2*(aa*(2*(-7 + 6*d)*psq^2 + (27 - 22*d)*psq*s + 
       (-23 + 12*d)*s^2 + 2*(7 - 6*d)*psq*t + (-43 + 22*d)*s*t + 
       mm^2*(2*(-6 + d)*psq + (29 - 7*d)*s - 2*(-6 + d)*t)) + 
     bb*(-2*(-7 + 6*d)*psq^2 + (-79 + 38*d)*psq*s + (23 - 12*d)*s^2 + 
       2*(-7 + 6*d)*psq*t + (43 - 22*d)*s*t + 
       mm^2*(-2*(-6 + d)*psq + (23 - 9*d)*s + 2*(-6 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(2*aa*mm^2*(6*(-1 + d)*psq + (-7 + 3*d)*s - 
       6*(-1 + d)*t) - 4*bb*mm^2*(3*(-1 + d)*psq + (4 - 3*d)*s - 
       3*(-1 + d)*t) + bb*(-5 + 3*d)*(4*psq^2 - 7*psq*s + s^2 - 4*psq*t + 
       3*s*t) - aa*(-5 + 3*d)*(4*psq^2 + s*(s + 3*t) - psq*(s + 4*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(bb*(2*(-13 + 8*d)*psq^2 + (-8 + 5*d)*s*(s + 3*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (bb*((64 - 30*d)*psq^2 - (-16 + 9*d)*s*(s + 3*t) + 
     ...
     aa*((-64 + 30*d)*psq^2 + (-16 + 9*d)*s*(s + 3*t) + 
       psq*((48 - 21*d)*s + (64 - 30*d)*t) + 
       mm^2*(-6*(-4 + 5*d)*psq + (20 - 6*d)*s + 6*(-4 + 5*d)*t)))*
  ...
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*s*(5*psq - 2*s - 5*t) + 
  ...
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq^2 - 11*psq*s + 5*s^2 + 
     mm^2*(4*psq - 3*s - 4*t) - 2*psq*t + 11*s*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(-(bb*(4*(-5 + 4*d)*psq^2 + (51 - 32*d)*psq*s + 
        (-19 + 11*d)*s^2 + (-6 + d)*mm^2*(2*psq - s - 2*t) + 
        4*(5 - 4*d)*psq*t + (-41 + 24*d)*s*t)) + 
     aa*(4*(-5 + 4*d)*psq^2 + (45 - 28*d)*psq*s + (-19 + 11*d)*s^2 + 
       4*(5 - 4*d)*psq*t + (-41 + 24*d)*s*t + 
       mm^2*(2*(-6 + d)*psq + (12 - 5*d)*s - 2*(-6 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(2*aa*mm^2*(6*(-1 + d)*psq + (-7 + 3*d)*s - 
       6*(-1 + d)*t) - 4*bb*mm^2*(3*(-1 + d)*psq + (4 - 3*d)*s - 
       3*(-1 + d)*t) - aa*(-5 + 3*d)*(4*psq^2 + psq*(s - 4*t) + s*t) + 
     bb*(-5 + 3*d)*(4*psq^2 - 5*psq*s - 4*psq*t + s*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(bb*(2*(-13 + 8*d)*psq^2 + (-2 + d)*s*t + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (bb*((-58 + 26*d)*psq^2 + (-7 + 3*d)*s*t + 
       psq*(65*s - 29*d*s + 58*t - 26*d*t) - 2*mm^2*((-9 + 13*d)*psq + 19*s - 
         13*d*s + 9*t - 13*d*t)) + aa*((58 - 26*d)*psq^2 + (7 - 3*d)*s*t + 
       2*mm^2*((-9 + 13*d)*psq - 17*s + 3*d*s + 9*t - 13*d*t) + 
       psq*(7*s - 3*d*s - 58*t + 26*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*(aa + bb)*(-8 + 3*d)*EL^5*gAl^3*gWWA^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*s*(-2*psq + s + 2*t)*
  ...
  (I*(aa + bb)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[q1, q1]])/(4^d*Pi^(2*d)) + 
  (I*(aa + bb)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(aa + bb)*(-8 + 3*d)*EL^5*gAl^3*gWWA^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
  ((3*I)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
  ((3*I)*2^(-1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
   Pi^(2*d) + (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*s*(2*(aa + bb)*(mm^2 - psq) - 
     (aa - bb)*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gWWA^2*s*(aa*(2*(-5 + 3*d)*mm^2 + (6 - 4*d)*psq - 
       (-2 + d)*(s + 2*t)) + bb*(2*(-5 + 3*d)*mm^2 + (14 - 8*d)*psq + 
       (-2 + d)*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gWWA^2*s*
  ...
  (I*4^(1 - d)*EL^5*gAl^3*gWWA^2*
    (aa*((-66 + 34*d)*mm^2 + 26*psq - 14*d*psq + 7*s - 3*d*s + 40*t - 
       ...
       40*t + 20*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p2, q2]])/Pi^(2*d) - ((5*I)*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p3, p3]])/Pi^(2*d) - 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 + 6*psq - 7*s - 8*t) + 
     bb*(14*mm^2 - 22*psq + 7*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) + 
  (I*4^(1 - d)*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*((-48 + 22*d)*mm^2 - 66*psq + 34*d*psq + 76*s - 39*d*s + 114*t - 
       ...
       39*d*s - 114*t + 56*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, p3]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*gWWA^2*(aa*(2*(-7 + 3*d)*mm^2 - 26*psq + 14*d*psq + 33*s - 
       17*d*s + 40*t - 20*d*t) + bb*((-66 + 34*d)*mm^2 + 106*psq - 54*d*psq - 
       33*s + 17*d*s - 40*t + 20*d*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 + 2*psq - 3*s - 4*t) + bb*(6*mm^2 - 10*psq + 3*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*(-8 + 5*d)*mm^2 + 2*(-2 + d)*psq + 12*s - 7*d*s + 20*t - 12*d*t) + 
     bb*(2*(-12 + 7*d)*mm^2 + (44 - 26*d)*psq - 12*s + 7*d*s - 20*t + 
       12*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[q1, q2]])/
   Pi^(2*d) + (I*EL^5*gAl^3*gWWA^2*
    (aa*(2*(-13 + 7*d)*mm^2 - 14*psq + 6*d*psq + 27*s - 13*d*s + 40*t - 
     ...
     SP[q2, q2]])/(2*Pi)^(2*d) + ((5*I)*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*
    gWWA^2*(aa*(10*mm^2 + 4*psq - 5*s - 14*t) + 
     bb*(2*mm^2 - 16*psq + 5*s + 14*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p2, p3]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - s - t) + 
  ...
  (I*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
     bb*(2*mm^2 - 10*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q1]])/Pi^(2*d) + (I*4^(2 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(10*mm^2 - 3*s - 10*t) + 
     bb*(2*mm^2 - 12*psq + 3*s + 10*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q1, q2]])/Pi^(2*d) - (I*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(14*mm^2 - 6*psq - s - 8*t) + bb*(2*mm^2 - 10*psq + s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) + (I*4^(1 - d)*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*gWWA^2*(aa*((-66 + 34*d)*mm^2 + 26*psq - 14*d*psq + 7*s - 
       3*d*s + 40*t - 20*d*t) + bb*(2*(-7 + 3*d)*mm^2 + 54*psq - 26*d*psq - 
       7*s + 3*d*s - 40*t + 20*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[p3, p3]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (2*mm^2 + 10*psq - 5*s - 12*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^3*gWWA^2*
    (aa*((-6 + 4*d)*mm^2 + (-29 + 16*d)*psq + 16*s - 9*d*s + 35*t - 20*d*t) + 
     bb*(-5*(-7 + 4*d)*psq + (-16 + 9*d)*s + 5*(-7 + 4*d)*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*(-12 + 7*d)*mm^2 + 4*psq - 2*d*psq + 8*s - 5*d*s + 20*t - 
     ...
     SP[q1, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*gWWA^2*(aa*((-54 + 26*d)*mm^2 + 14*psq - 6*d*psq + 13*s - 
       7*d*s + 40*t - 20*d*t) + bb*(2*(-13 + 7*d)*mm^2 + 66*psq - 34*d*psq - 
       13*s + 7*d*s - 40*t + 20*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*(-13 + 7*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
  ((3*I)*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
  ((3*I)*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], SP[p3, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*(-7 + 3*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], SP[q2, q2]])/Pi^(2*d) - 
  ((5*I)*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gWWA^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p1, p3]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
   ...
   Pi^(2*d) - ((5*I)*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 + 7*psq - 5*s - 9*t) + bb*(4*mm^2 - 13*psq + 5*s + 9*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
  ...
  (I*2^(1 - 2*d)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-8 + 5*d)*EL^5*gAl^3*gWWA^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(5*psq - 4*s - 5*t) + 
     bb*(6*mm^2 - 11*psq + 4*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (I*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(6*psq - 5*s - 6*t) + 
     bb*(8*mm^2 - 14*psq + 5*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*(-13 + 7*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(10*(-2 + d)*mm^2 - 66*psq + 34*d*psq + 56*s - 29*d*s + 86*t - 
       44*d*t) + bb*((-72 + 38*d)*mm^2 + 158*psq - 82*d*psq - 56*s + 29*d*s - 
       86*t + 44*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p2, p3]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-13 + 7*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(aa*(2*(-17 + 8*d)*psq + 27*s - 13*d*s + 34*t - 
       16*d*t) + bb*(20*(-2 + d)*mm^2 + 74*psq - 36*d*psq - 27*s + 13*d*s - 
       34*t + 16*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p3, p3]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*((-29 + 16*d)*psq + 16*s - 9*d*s + 29*t - 16*d*t) + 
     bb*((-6 + 4*d)*mm^2 + 35*psq - 20*d*psq - 16*s + 9*d*s - 29*t + 16*d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - psq - t) + 
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
     bb*(2*mm^2 - 8*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*
    gWWA^2*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p3, p3]])/Pi^(2*d) - 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(4*mm^2 + psq - 2*s - 5*t) + bb*(2*mm^2 - 7*psq + 2*s + 5*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(3*mm^2 - s - 3*t) + bb*(mm^2 - 4*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-13 + 7*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[p2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*mm^2 - 2*psq + s)*
  ...
  (I*4^(1 - d)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*((-7 + 3*d)*mm^2 - 16*psq + 9*d*psq + 13*s - 7*d*s + 23*t - 12*d*t) + 
     bb*((-13 + 7*d)*mm^2 + 36*psq - 19*d*psq - 13*s + 7*d*s - 23*t + 
       12*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[q2, q2]])/
   Pi^(2*d) + (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], SP[p3, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*(-13 + 7*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*
    gAl^3*gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[q2, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[q1, q2]])/Pi^(2*d) + (I*(aa - bb)*(-7 + 3*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[q2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(mm^2 - t)*
  ...
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[p3, p3]])/Pi^(2*d) - 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
  ...
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[p3, q2]])/Pi^(2*d) + (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[q2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-13 + 7*d)*EL^5*gAl^3*gWWA^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[p3, p3]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
  ((5*I)*(-2 + d)*EL^5*gAl^3*gWWA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(10*(-2 + d)*mm^2 - 23*psq + 12*d*psq + 23*s - 12*d*s + 43*t - 
       22*d*t) + bb*(2*(-13 + 7*d)*mm^2 + 69*psq - 36*d*psq - 23*s + 12*d*s - 
       43*t + 22*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p2, p3]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[q1, q2]])/Pi^(2*d) + (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) - (I*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[p3, p3]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
  ((5*I)*(-2 + d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q2, q2]])/(2*Pi)^(2*d) + 
  ((3*I)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], 
     SP[p3, q2]])/(2*Pi)^(2*d) - (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) - (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*
    gAl^3*gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], SP[q1, q2]])/Pi^(2*d) + 
  ((5*I)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], SP[q2, q2]])/
   (2*Pi)^(2*d) - ((5*I)*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
  ...
  ((5*I)*(-2 + d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[p3, p3]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-8 + 5*d)*EL^5*gAl^3*gWWA^2*
    (aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[q2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
  ...
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
    ...
    SPList[SP[p2, p3], SP[p2, q1], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(-13 + 7*d)*EL^5*gAl^3*gWWA^2*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*gWWA^2*(bb*(2*(-17 + 8*d)*psq + 7*s - 3*d*s + 34*t - 
       16*d*t) + aa*(-20*(-2 + d)*mm^2 - 6*psq + 4*d*psq - 7*s + 3*d*s - 
       34*t + 16*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[p3, p3]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*((-6 + 4*d)*mm^2 - 23*psq + 12*d*psq + 13*s - 7*d*s + 29*t - 
       16*d*t) + bb*((29 - 16*d)*psq - 13*s + 7*d*s - 29*t + 16*d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(aa*(4*mm^2 - s - 4*t) + 
     bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*gWWA^2*
    (aa*(4*(-5 + 3*d)*mm^2 - 6*psq + 4*d*psq + 8*s - 5*d*s + 26*t - 16*d*t) + 
     bb*((26 - 16*d)*psq - 8*s + 5*d*s - 26*t + 16*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gWWA^2*(aa*(20*(-2 + d)*mm^2 - 6*psq + 4*d*psq + 13*s - 
       7*d*s + 46*t - 24*d*t) + bb*((46 - 24*d)*psq - 13*s + 7*d*s - 46*t + 
       24*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], SP[q2, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
  ...
  ((3*I)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
     SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*
    gWWA^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
     SP[q1, q2]])/Pi^(2*d) + (I*(aa - bb)*(-7 + 3*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
  ...
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
     ...
     SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[p3, p3]])/Pi^(2*d) - (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[p3, p3]])/
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(-5 + 3*d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gWWA^2*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
  ((5*I)*(-2 + d)*EL^5*gAl^3*gWWA^2*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[q2, q2]])/
   (2*Pi)^(2*d) + ((3*I)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*(aa - bb)*(-16 + 9*d)*EL^5*gAl^3*gWWA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3], 
     SP[p3, q2]])/(2*Pi)^(2*d) - (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^3*
