...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
      (aa*((-2 + d)*mm^4 + d*psq*s - mm^2*((6 + d)*psq + (-2 + d)*s)) + 
       bb*((-2 + d)*mm^4 + d*psq*s - mm^2*((-10 + d)*psq + (2 + d)*s)))*
      \[Mu]^(8 - 2*d))/Pi^(2*d)) + (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*
     (2*aa*(psq - s)*s + bb*d*(psq - s)*s + bb*d*mm^2*(-4*psq + s) + 
      2*bb*s*(mm^2 - 2*psq + s) + aa*d*(4*mm^2*psq + s*(-2*psq + s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*(aa*(-2 + d)*mm^2*(4*psq - s) - 
      bb*d*s*(-2*psq + s) - 4*bb*mm^2*((-2 + d)*psq + s) + 
      aa*s*(-((-2 + d)*psq) + d*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    Pi^(2*d) - (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*s*
     (mm^2 + psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*s*
     ((2 + d)*mm^2 + (2 + d)*psq + d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*s*
     (aa*(mm^2 + 3*psq - s) + bb*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*
     mm^2*s*(bb*mm^2*(8*psq - 3*s) + aa*psq*s + bb*psq*s + 
      aa*mm^2*(-8*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
     (aa*((-2 + d)*mm^2 + 2*psq + 3*d*psq - d*s) + 
      bb*((-2 + d)*mm^2 + 2*psq - 5*d*psq + d*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[q2, q2]])/Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*
     mm^4*(aa*(psq - s) + bb*(mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^4*(-(aa*s) + bb*(2*mm^2 - 2*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 + psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*(2*(mm^2 + psq)*s + 
      d*(4*mm^4 - psq*s + mm^2*(4*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*mm^2*(4*psq - s) - 
