...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
      (2*(-2 + d)*mm^4*s + (-2 + d)*psq*s^2 + 
       mm^2*(8*psq^2 + 5*(-2 + d)*s^2 + 8*s*t + 8*t^2 - 
         2*psq*((-2 + d)*s + 8*t)))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2)) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (6*psq^2 + mm^2*(6*psq + (-8 + d)*s - 6*t) - psq*((2 + d)*s + 10*t) + 
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (2*psq^2 + 2*t*(s + 2*t) - psq*((-4 + d)*s + 6*t) + 
      mm^2*(-6*psq + (-2 + d)*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (2*psq^2 - 2*s^2 + d*s^2 + psq*(s - d*s - 4*t) + 
      2*mm^2*(psq + (-2 + d)*s - t) + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (3*mm^2 + psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (psq + (-3 + d)*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (2*mm^2 + psq - 5*s + d*s - 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*(-2*psq + 3*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*(-2*psq + s + 2*t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*
     mh^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*
     mh^2*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHHH*gHll^3*mh^2*mm^4*\[Mu]^(8 - 2*d)*
