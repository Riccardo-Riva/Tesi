  ...
  ((4^(1 - 2*d)*EL^6*gAl^3*gAu*mm^2*(d^2*(gZlL - gZlR)^2*mm^2*(2*Pi)^(2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (gZlL^2*(-(d^2*(2*Pi)^(2*d)*psq*s*(3*psq - s - 3*t)) + 
        (-4 + d^2)*mm^2*(2*Pi)^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
          ...
          psq*((-10 + d)*s^2 + 2*(-13 + 3*d)*s*t + (-20 + 8*d + d^2)*t^2))) + 
      gZlR^2*(-(d^2*(2*Pi)^(2*d)*psq*s*(3*psq - s - 3*t)) + 
        (-4 + d^2)*mm^2*(2*Pi)^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
          3*s*t + 2*t^2) + 2^(1 + 2*d)*Pi^(2*d)*((-4 + d^2)*psq^3 + 
          2*psq^2*((3 + d)*s - (-8 + 2*d + d^2)*t) - 
          ((-4 + d)*s + 2*(-2 + d)*t)*(s^2 + 3*s*t + 2*t^2) + 
          psq*((-10 + d)*s^2 + 2*(-13 + 3*d)*s*t + (-20 + 8*d + d^2)*t^2))) - 
      4*gZlL*gZlR*(d*(2*Pi)^(2*d)*psq*(s*(9*psq - 5*s - 13*t) + 
          d*(psq^2 + s^2 + t^2)) - 2^(1 + 2*d)*Pi^(2*d)*((2 + 4*d)*psq^3 - 
          4*t*(s + t)^2 + psq^2*((2 + d^2)*s + (-8 - 8*d + d^2)*t) + 
   ...
   (4^(1 - 2*d)*EL^6*gAl^3*gAu*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
       (psq - s - t)*(2*(4 - 6*d + d^2)*psq - (8 - 7*d + d^2)*s - 
        ...
        mm^2*(2*Pi)^(2*d)*(5*(8 - 6*d + d^2)*psq^2 + 2*(10 - 7*d + d^2)*s^2 + 
   ...
   (4^(1 - 2*d)*EL^6*gAl^3*gAu*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - t)*
        (2*(4 - 6*d + d^2)*psq - 8*t - d^2*(s + 2*t) + d*(5*s + 12*t))) + 
      gZlL^2*(d^2*(2*Pi)^(2*d)*psq*(psq^2 + t^2) + 2^(1 + 2*d)*Pi^(2*d)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
     ...
     (2^(1 + 2*d)*(4 - 6*d + d^2)*gZlL*gZlR*mm^2*Pi^(2*d)*s*
       (-2*psq + s + 2*t) + gZlL^2*(-(d^2*(2*Pi)^(2*d)*psq*s^2) + 
        2^(1 + 2*d)*Pi^(2*d)*(2*(8 - 6*d + d^2)*psq^3 - (8 - 6*d + d^2)*psq^2*
           (s + 6*t) - mm^2*s*((14 - 7*d + d^2)*s + (-2 + d)^2*t) - 
          (8 - 6*d + d^2)*t*(s^2 + 3*s*t + 2*t^2) + 
          psq*((-2 + d)^2*mm^2*s + (12 - 5*d + d^2)*s^2 + 4*(8 - 6*d + d^2)*s*
             t + 6*(8 - 6*d + d^2)*t^2))) + 
