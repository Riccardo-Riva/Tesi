...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (-((4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(s^2 + 6*s*t + 5*t^2)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s)) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(4*s^2 + 9*s*t + 5*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(s^2 + 3*s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^4*(s + t)*
     (gZlR*(2*s + t) + gZlL*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(s^2 + 3*s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(s^2 + 6*s*t + 5*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*t*(s + 5*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(s + 5*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(s^2 + 4*s*t + t^2)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*t*(4*s + 5*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*t*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^4*t*(gZlR*(2*s + t) + 
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(4*s + 5*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(2*s^2 + 2*s*t - t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^4*t*(gZlR*(2*s + t) + 
      gZlL*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*t*
     (s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^4*(gZlR*(2*s + t) + 
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^4*(gZlR*(2*s + t) + 
      gZlL*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
    Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2 - 2*gZlR*(mm^2 + s))*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - 2*t)*(s + t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(s + t)*
     (2*mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2 - 2*gZlR*(mm^2 + s))*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(s + t)*(2*mm^2 + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(s + t)*
     (2*mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2 - 2*gZlR*(mm^2 + s))*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*s^2 + mm^2*t + 4*s*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^4*t*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2*s - 
      2*gZlR*(mm^2*s + 2*s^2 + 2*s*t + t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2*s + 
      gZlR*mm^2*(-2*s + t) - 2*gZlR*(s^2 + t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*(2*mm^2 + s + t)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     (mm^2 - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/
    Pi^(2*d) - (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*mm^2 + s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - 2*t)*(s + t)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(s + t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*(2*mm^2 + s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(s^2 + 3*s*t + 2*t^2)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     ...
     mm^2*t*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*
     mm^2*t^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[q2, q2]])/
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*(s + t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2], SP[p3, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*(s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t*(s + 2*t)*
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*t^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], SP[q1, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(s + 2*t)*
