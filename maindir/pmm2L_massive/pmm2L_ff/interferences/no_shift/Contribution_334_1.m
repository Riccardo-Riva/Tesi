  ...
  (-((2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
       ...
       gZlL^2*((2*Pi)^(2*d)*s*(psq^2 - 2*psq*t + t*(s + t))*
          ...
          Pi^(2*d)*(psq^3 + 3*psq*t*(s + t) - t*(s + t)^2 - 
           psq^2*(s + 3*t))) + gZlR^2*((2*Pi)^(2*d)*s*(psq^2 - 2*psq*t + 
           t*(s + t))*((-10 + 3*d)*psq - (-4 + d)*(s + 2*t)) + 
         2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(psq^3 + 3*psq*t*(s + t) - 
           t*(s + t)^2 - psq^2*(s + 3*t))))*\[Mu]^(8 - 2*d))/(Pi^(4*d)*s)) - 
    ...
    (Pi^(2*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*
     (2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
      ...
      gZlL^2*(-(2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(psq - t)*(psq - s - t)) - 
        d*(2*Pi)^(2*d)*s*(psq^2 - 7*psq*t + s*(s + 3*t)) + 
        2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + 2*s^3 + 4*s^2*t - 
          3*(-2 + d)*s*t^2 - 2*(-2 + d)*t^3 + psq^2*(s - 6*(-2 + d)*t) + 
          psq*((-5 + d)*s^2 - 7*s*t + 6*(-2 + d)*t^2))) + 
      gZlR^2*(-(2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(psq - t)*(psq - s - t)) - 
        d*(2*Pi)^(2*d)*s*(psq^2 - 7*psq*t + s*(s + 3*t)) + 
        2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + 2*s^3 + 4*s^2*t - 
          3*(-2 + d)*s*t^2 - 2*(-2 + d)*t^3 + psq^2*(s - 6*(-2 + d)*t) + 
          psq*((-5 + d)*s^2 - 7*s*t + 6*(-2 + d)*t^2))))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
       (-((-8 + d)*psq^3) + 2*((-4 + d)*s - 2*t)*t*(s + t) + 
        ...
        2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + 3*psq^2*(s - 2*(-2 + d)*t) + 
          t*(4*s^2 - 3*(-2 + d)*s*t - 2*(-2 + d)*t^2) + 
          psq*(2*s^2 - 9*s*t + 6*(-2 + d)*t^2))) + 
      gZlR^2*(2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(psq - t)^2 - 
        d*(2*Pi)^(2*d)*s*(3*psq^2 + psq*(s - 9*t) + 3*s*t) + 
        2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + 3*psq^2*(s - 2*(-2 + d)*t) + 
          t*(4*s^2 - 3*(-2 + d)*s*t - 2*(-2 + d)*t^2) + 
          psq*(2*s^2 - 9*s*t + 6*(-2 + d)*t^2))))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
     (-6*gZlL^2*mm^2*s^2 - 6*gZlR^2*mm^2*s^2 + 
      4*gZlL*gZlR*(2*psq^3 + 2*mm^4*s - 2*s^3 - 7*s^2*t - 7*s*t^2 - 2*t^3 + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^4*((-2 + d)*gZlL^2*(psq - t) + 
      (-2 + d)*gZlR^2*(psq - t) - (-4 + d)*gZlL*gZlR*(psq - s - t))*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^4*(psq - t)*(gZlL^2*s + gZlR^2*s + 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^4*(2*psq - s - 2*t)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*(2*psq*(psq - s - t) + 
      mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
     (d*(gZlL^2*mm^2*s + gZlR^2*mm^2*s + gZlL*gZlR*(4*psq^2 - 3*psq*s + s^2 - 
          mm^2*(psq + s - t) - 7*psq*t + 2*s*t + 3*t^2)) - 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
