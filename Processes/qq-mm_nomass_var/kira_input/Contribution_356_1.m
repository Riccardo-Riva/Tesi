...
((3*I)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*(gZlL + gZlR)*(gZuL + gZuR)*
   userIntegral[A4, {mb}, -2, 1, 1, 0])/((2*Pi)^d*(mz^2 - s)^2) + 
 ((3*I)*2^(-1 - 2*d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
   ...
   userIntegral[A4, {mb}, -1, 0, 1, 0])/(Pi^(2*d)*(mz^2 - s)^2*s) + 
 ((3*I)*2^(-1 - 2*d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
   ...
   userIntegral[A4, {mb}, -1, 1, 0, 0])/(Pi^(2*d)*(mz^2 - s)^2*s) + 
 ((3*I)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*(gZlL*gZuL*((-4 + d)*s - 2*t) + 
    gZlR*gZuR*((-4 + d)*s - 2*t) - gZlR*gZuL*((-2 + d)*s + 2*t) - 
    gZlL*gZuR*((-2 + d)*s + 2*t))*userIntegral[A4, {mb}, -1, 1, 1, -1])/
   ...
   (gZdR^2*(-(gZlR*gZuL*(2^(1 + d)*mb^2*Pi^d*((-4 + d)*s + 2*t) + 
      ...
      gZlL*(gZuL*(2^(1 + d)*mb^2*Pi^d*((-2 + d)*s - 2*t) + 
          s*(-(d^2*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*(-1 + d)*s - 
              (-4 + d)*t))) - gZuR*(2^(1 + d)*mb^2*Pi^d*((-4 + d)*s + 2*t) + 
          s*(-(d^2*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s + 
              (-4 + d)*t))))) + 
    gZdL^2*(-(gZlR*(-(2^(1 + d)*gZuR*mb^2*Pi^d*((-2 + d)*s - 2*t)) + 
 ...
 ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
   ((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - (-4 + d)*gZlL*gZuR + 
    (-2 + d)*gZlR*gZuR)*t*userIntegral[A4, {mb}, 0, 1, -1, 0])/
  (Pi^d*(mz^2 - s)^2*s) - ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
   ...
   userIntegral[A4, {mb}, 0, 1, 0, -1])/(Pi^d*(mz^2 - s)^2*s) + 
 (((3*I)/4)*EL^6*gAl*gAu*
   (-((2^(2 - d)*(gZdL^2 + gZdR^2)*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
        (-4 + d)*gZlL*gZuR + (-2 + d)*gZlR*gZuR)*mb^2*t)/Pi^d) + 
    (2^(2 - d)*(gZdL^2 + gZdR^2)*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
    ...
    (gZdR^2*(gZlR*gZuR*((8 - 6*d + d^2)*s^2 - 2*(14 - 7*d + d^2)*s*t - 
     ...
     (2*Pi)^d)*userIntegral[A4, {mb}, 0, 1, 0, 0])/((mz^2 - s)^2*s) + 
 ((3*I)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*(gZlL + gZlR)*(gZuL + gZuR)*
   userIntegral[A4, {mb}, 0, 1, 1, -2])/((2*Pi)^d*(mz^2 - s)^2) - 
 ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*(4*(gZdL^2 + gZdR^2)*(gZlL + gZlR)*
     (gZuL + gZuR)*mb^2 - (gZdL^2 + gZdR^2)*(gZlL*gZuL*((-2 + d)*s - 2*t) + 
      gZlR*gZuR*((-2 + d)*s - 2*t) - gZlR*gZuL*((-4 + d)*s + 2*t) - 
      gZlL*gZuR*((-4 + d)*s + 2*t)) + 
    ...
    ((gZdL^2 + gZdR^2)*mb^2*(d*gZlR*(gZuL - gZuR)*s + 
       gZlL*(6*gZuL*s - d*gZuL*s + d*gZuR*s + 2*gZuL*t + 2*gZuR*t) + 
       2*gZlR*(gZuL*t + gZuR*(3*s + t))))/s)*userIntegral[A4, {mb}, 0, 1, 1, 
   ...
   (4*gZdL*gZdR*mb^2*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
        ...
        2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
          2*t^2))) + 
    gZdR^2*(-(gZlR*(gZuL*(d^2*(2*Pi)^d*s^3 + 2^(2 + d)*mb^4*Pi^d*
    ...
    gZdL^2*(gZlL*(-(gZuR*(d^2*(2*Pi)^d*s^3 + 2^(2 + d)*mb^4*Pi^d*
        ...
        gZuL*(-(d^2*(2*Pi)^d*s^3) + 2^(2 + d)*mb^4*Pi^d*((-2 + d)*s - 2*t) + 
          2^(1 + d)*mb^2*Pi^d*((8 - 6*d + d^2)*s^2 - 2*(18 - 9*d + d^2)*s*t - 
            4*t^2) + 2^(1 + d)*Pi^d*s*((-4 + 3*d)*s^2 + (-4 + d)^2*s*t + 
            2*t^2))) - gZlR*(gZuL*(d^2*(2*Pi)^d*s^3 + 2^(2 + d)*mb^4*Pi^d*
           ((-4 + d)*s + 2*t) - 2^(1 + d)*mb^2*Pi^d*((8 - 6*d + d^2)*s^2 + 
            2*(12 - 7*d + d^2)*s*t - 4*t^2) + 2^(1 + d)*Pi^d*s*
           ((4 - 3*d)*s^2 + (8 - 6*d + d^2)*s*t - 2*t^2)) + 
        gZuR*(-3*d^2*(2*Pi)^d*s^3 - 2^(2 + d)*mb^4*Pi^d*((-2 + d)*s - 2*t) + 
          2^(1 + d)*Pi^d*s*((-8 + 7*d)*s^2 - (-2 + d)^2*s*t - 2*t^2) + 
          2^(1 + d)*mb^2*Pi^d*((16 - 14*d + 3*d^2)*s^2 + 2*(6 - 5*d + d^2)*s*
             t + 4*t^2)))))*userIntegral[A4, {mb}, 0, 1, 1, 0])/
  (Pi^(2*d)*(mz^2 - s)^2*s)
