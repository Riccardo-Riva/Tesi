...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((2^(1 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^4*t*
   ...
   (2^(1 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^4*t^2*
   ...
   (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*
   ...
   (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^4*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*
     (mm^2*s + (s + t)^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
    (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*
