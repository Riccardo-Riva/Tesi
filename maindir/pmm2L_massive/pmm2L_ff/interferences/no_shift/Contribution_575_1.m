  ...
  ((4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq^2 - 2*psq*t + t*(s + t))*
     ...
     (-((4 + 3*d)*psq^3) + 4*t*(s + t)^2 + (2 + d)*psq^2*(s + 6*t) + 
      psq*(s + t)*(2*s - 3*(4 + d)*t) + mm^2*((4 + 3*d)*psq^2 + 
        (4 + 3*d)*t*(s + t) - psq*(4*s + d*s + 8*t + 6*d*t)))*\[Mu]^(8 - 2*d)*
     ...
     (mm^2*(psq - s - t)*(4*(1 + d)*psq - (4 + d)*s - 4*(1 + d)*t) + 
      2*(2*psq^3 + psq^2*((-4 + d)*s - (4 + d)*t) + 
        (s + t)*(s^2 - 2*s*t - d*t^2) + psq*(-3*s^2 + 6*s*t + 
          2*(1 + d)*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)*(-((-4 + d)*psq^2) - 
      2*psq*s + (4 + d)*mm^2*(psq - t) + (-8 + d)*psq*t + 4*t*(s + t))*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(8*psq^3 - 
      psq^2*((4 + d)*s + 24*t) + psq*((4 + d)*mm^2*s - 2*s^2 + (16 + d)*s*t + 
        24*t^2) - t*((4 + d)*mm^2*s + 4*(s^2 + 3*s*t + 2*t^2)))*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (8*psq^3 + psq^2*((-8 + d)*s - 20*t) + (4 + d)*mm^4*(psq - t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-4*psq^3 + 
      (-4 + 3*d)*mm^4*(psq - t) + 4*t^2*(s + t) + psq^2*((-6 + d)*s + 12*t) + 
      2*psq*(s^2 - s*t - 6*t^2) + mm^2*((14 - 5*d)*psq^2 + 
        psq*(8*s + (-24 + 7*d)*t) - 2*(s^2 + d*s*t + (-5 + d)*t^2)))*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (-(s*(psq - t)*((-6 + d)*psq + 2*(s + t))) + 
      mm^2*((-4 + d)*psq^2 + 2*s^2 + 6*s*t + (-4 + d)*t^2 - 
        2*psq*(3*s + (-4 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)*(8*psq^2 - 2*mm^2*s + 
      d*(mm^2 - psq)*(psq - t) - 12*psq*t + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*psq^3 + psq^2*(s - 6*t) - 
      mm^2*(2*psq - s - 2*t)*(psq - t) + 6*psq*t^2 + t*(s^2 - s*t - 2*t^2))*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-8*psq^3 + 
      ...
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-((-4 + d)*psq^2) - 
   ...
   (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-2*psq^2 - 2*psq*s + s^2 + 
      4*psq*t + 2*s*t - 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s) - (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (psq - t)*(psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(4*psq - (-2 + d)*s - 4*t)*(psq - t)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-4*psq^2 + (-6 + d)*psq*s + 2*s^2 + 
