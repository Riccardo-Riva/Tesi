...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
     ...
     ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
     (psq + (-2 + d)*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*
     (gZlL - gZlR)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ*
     gXgpgp*gXll*(gZlL - gZlR)*mm^2*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ*gXgpgp*gXll*
