...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (((-I)*2^(1 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(aa*mm^2*(psq - t) + 
      aa*psq*(psq - s - t) + bb*psq*(-psq + t) + bb*mm^2*(-psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(aa*mm^2*(psq - t) + 
      aa*psq*(psq - s - t) + bb*psq*(-psq + t) + bb*mm^2*(-psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*psq*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(bb*(mm^2 + psq - s - 2*t) + 
      aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(bb*(2*mm^2 - s - 2*t) + 
      aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(bb*(mm^2 - t) + aa*(-psq + t))*
   ...
   (I*2^(1 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*
