...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
     (-4*psq^3 + (-2 + d)^2*mm^4*s + psq^2*((12 - 4*d + d^2)*s + 8*t) + 
      2*s*((-2 + d)*s^2 + 4*s*t + 4*t^2) - psq*(7*(-2 + d)*s^2 + 20*s*t + 
        4*t^2) - mm^2*(12*psq^2 - 3*(-2 + d)*s^2 + 
        2*psq*((-2 + d)^2*s - 12*t) + 12*s*t + 12*t^2))*\[Mu]^(8 - 2*d))/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
     (-2*(-4 + d)*psq^2 + 2*(-6 + d)*s^2 - (-8 + d)*psq*(d*s - 2*t) + 8*t^2 + 
      mm^2*(2*(-8 + d)*psq + (24 - 8*d + d^2)*s - 2*(-8 + d)*t))*
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*(2*(4 + d)*psq^2 - 
      (16 - 6*d + d^2)*psq*s + 2*(-2 + d)*s^2 - 2*(8 + d)*psq*t + 16*s*t + 
      8*t^2 + mm^2*(-2*(-8 + d)*psq + (8 - 6*d + d^2)*s + 2*(-8 + d)*t))*
   ...
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
     (4*psq^2 + (12 - 5*d + d^2)*mm^2*s - 10*s^2 + 3*d*s^2 + 4*s*t + 4*t^2 - 
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
     (4*(-1 + d)*psq^2 + (12 - 8*d + d^2)*mm^2*s + 10*s^2 - 7*d*s^2 + 
   ...
   (2^(1 - 4*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     (2^(1 + 2*d)*(-2 + d)^2*d*mm^4*Pi^(2*d)*s + d^3*(2*Pi)^(2*d)*psq*s^2 + 
      2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)^2*psq^3 + (-2 + d)*psq^2*
         ((8 - 2*d + d^2)*s - 4*(-2 + d)*t) + 2*(-2 + d)*s*
         ((-2 + d)*s^2 + 4*s*t + 4*t^2) + 2*psq*((-20 + 21*d - 6*d^2)*s^2 + 
          (20 - 12*d + d^2)*s*t + (-2 + d)^2*t^2)) - 
      mm^2*(d^3*(2*Pi)^(2*d)*s^2 + 4^(1 + d)*Pi^(2*d)*
         ((-12 + 4*d + d^2)*psq^2 + (-12 + 13*d - 4*d^2)*s^2 + 
          (-12 + 4*d + d^2)*s*t + (-12 + 4*d + d^2)*t^2 + 
          (-2 + d)*psq*(d^2*s - 12*t - 2*d*(s + t)))))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/(Pi^(4*d)*s^2) + 
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*(4*psq + (4 - 6*d + d^2)*s - 
      4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     (-((-6 + d)*psq^2) + (8 - 3*d)*psq*s + 2*(-3 + d)*s^2 + 
      (-10 + d)*psq*t + 2*s*t + 4*t^2 + mm^2*((-6 + d)*psq + (2 + d)*s - 
        (-6 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
     (-4*(-2 + d)*mm^2 + 4*(-2 + d)*psq + (10 - 8*d + d^2)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     (2*(-2 + d)*mm^4 + 3*(-2 + d)*psq^2 - 8*s^2 + 2*d*s^2 - 2*s*t + 4*t^2 + 
      mm^2*((2 - 5*d)*psq + 3*d*s + 6*t + d*t) - 
      psq*((-18 + 5*d)*s + (2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*(-2*(-4 + d)*psq + 
      (-4 - 4*d + d^2)*s + 2*(-4 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     (-2*(-6 + d)*psq^2 - (-16 + 6*d + d^2)*psq*s + 4*(-5 + 2*d)*s^2 + 
      ...
      mm^2*(2*(2 + d)*psq + (-4 + 2*d + d^2)*s - 2*(2 + d)*t))*
   ...
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*(-4*psq + (8 - 6*d + d^2)*s + 
      4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     (2*(-2 + d)*psq^2 + 4*s*(s + 2*t) + mm^2*(-2*(-10 + d)*psq + 
        (12 - 10*d + d^2)*s + 2*(-10 + d)*t) - 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     (4*(-2 + d)*psq^2 + 16*s^2 - 10*d*s^2 + d^2*s^2 - 
   ...
   (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ...
     (gZlL^2 + gZlR^2)*((-2 + d)*mm^2 - 2*(-3 + d)*psq - 3*s + d*s - 4*t + 
      d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-40 + 40*d - 12*d^2 + d^3)*EL^8*gAl^4*
     gAu^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*
   ...
   (2^(3 - 2*d)*(-40 + 40*d - 12*d^2 + d^3)*EL^8*gAl^4*gAu^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ...
     (gZlL^2 + gZlR^2)*(-4*(-2 + d)*mm^2 + 4*(-8 + 3*d)*psq + 36*s - 16*d*s + 
      d^2*s + 24*t - 8*d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
     (gZlL^2 + gZlR^2)*(2*(-2 + d)*mm^2 + (10 - 3*d)*psq - 4*s + d*s - 6*t + 
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(2*psq + s - 2*t)*
