...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*EL^5*gAl*gHXZ^2*mm^2*s*(aa*(2*gZlL*gZlR*psq*(-2*psq + s + 2*t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*mm^2*
      (-(bb*(2*psq^2 + 2*mm^2*(psq - s - t) + s*(s + t) - psq*(s + 2*t))) + 
       aa*(2*psq^2 + 2*mm^2*(psq + s - t) + s*(s + t) - psq*(5*s + 2*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
    (I*EL^5*gAl*gHXZ^2*(aa*(4*gZlL*gZlR*mm^2*psq*(-2*psq + s + 2*t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*mm^2*s*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHXZ^2*s*(bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gHXZ^2*mm^2*s*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*mm^2*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*mm^2*
      (bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHXZ^2*(aa*(4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gHXZ^2*(bb*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       ...
       SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gHXZ^2*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*
     ...
     Pi^(2*d) + (I*(aa + bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q1], SP[q1, q1]])/(2*Pi)^(2*d) - 
    (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
    ...
    (I*4^(2 - d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*
      (gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*4^(2 - d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) + (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*
      (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*
      (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q1]])/Pi^(2*d) + (I*4^(2 - d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*
      (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gHXZ^2*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[p3, q1]])/Pi^(2*d) + (I*4^(2 - d)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*
      (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gHXZ^2*
      (gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
