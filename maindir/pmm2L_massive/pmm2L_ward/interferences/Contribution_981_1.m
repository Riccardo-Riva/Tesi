...
PropList[KiraPropagator[q1, mw], KiraPropagator[q2, mz], 
 ...
 ((I*4^(-1 - d)*EL^5*gAl*gFFZ^2*s*
   ...
   Pi^(2*d) - (I*4^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*4^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
    (aa*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s)*(2*psq - s - 2*t)) + 
       gZlL^2*(2*Pi)^(2*d)*(2*mm^4*(psq - t) + mm^2*(2*psq^2 - 11*psq*s + 
           s^2 - 2*psq*t + 9*s*t) + s*(3*psq^2 + psq*(5*s - 3*t) - 
           2*s*(s + t))) + gZlR^2*(2*Pi)^(2*d)*(2*mm^4*(psq - t) + 
         mm^2*(2*psq^2 - 11*psq*s + s^2 - 2*psq*t + 9*s*t) + 
         s*(3*psq^2 + psq*(5*s - 3*t) - 2*s*(s + t)))) + 
     bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4*(-2*psq + 4*s + 2*t) + 
         s*(3*psq^2 - 3*psq*(s - t) + 2*s*(s + t)) + 
         mm^2*(-2*psq^2 + psq*(s + 2*t) - 3*s*(s + 3*t))) - 
       gZlR^2*(2*Pi)^(2*d)*(2*mm^4*(psq - 2*s - t) - 
         s*(3*psq^2 - 3*psq*(s - t) + 2*s*(s + t)) + 
         mm^2*(2*psq^2 - psq*(s + 2*t) + 3*s*(s + 3*t)))))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
    (aa*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s)*(2*psq - s - 2*t)) + 
       gZlL^2*(2*Pi)^(2*d)*(2*mm^4*(psq + s - t) - 
         s*(-9*psq^2 + 2*psq*s + 3*psq*t + 2*s*t) + 
         mm^2*(2*psq^2 - 19*psq*s + 6*s^2 - 2*psq*t + 9*s*t)) + 
       gZlR^2*(2*Pi)^(2*d)*(2*mm^4*(psq + s - t) - 
         s*(-9*psq^2 + 2*psq*s + 3*psq*t + 2*s*t) + 
         mm^2*(2*psq^2 - 19*psq*s + 6*s^2 - 2*psq*t + 9*s*t))) + 
     bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(2*mm^4*(-psq + s + t) + 
         mm^2*(-2*psq^2 + 9*psq*s - 8*s^2 + 2*psq*t - 9*s*t) + 
         s*(-3*psq^2 + 4*psq*s + 3*psq*t + 2*s*t)) - gZlR^2*(2*Pi)^(2*d)*
        (2*mm^4*(psq - s - t) - s*(-3*psq^2 + 4*psq*s + 3*psq*t + 2*s*t) + 
         mm^2*(2*psq^2 - 9*psq*s + 8*s^2 - 2*psq*t + 9*s*t))))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*s*
    (bb*(-2*psq^2 + s*(mm^2 - s - 2*t) + 2*psq*(s + t)) + 
     aa*(2*psq^2 - 2*psq*(2*s + t) + s*(mm^2 + s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) - (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*s*
  ...
  (I*EL^5*gAl*gFFZ^2*s*((aa + bb)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s - 
  ...
  (I*EL^5*gAl*gFFZ^2*s*(bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
  ...
  (I*4^(-1 - d)*EL^5*gAl*gFFZ^2*s*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(mm^4 + psq*(4*psq - 2*s - 5*t) + mm^2*(-3*psq + s + 3*t)) + 
       gZlR^2*(mm^4 + psq*(4*psq - 2*s - 5*t) + mm^2*(-3*psq + s + 3*t))) + 
     aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(mm^4 + mm^2*(3*psq - 2*s - 3*t) + psq*(-6*psq + 3*s + 5*t)) + 
       gZlR^2*(mm^4 + mm^2*(3*psq - 2*s - 3*t) + psq*(-6*psq + 3*s + 5*t))))*
  ...
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gFFZ^2*
    (bb*(gZlL^2*(2*Pi)^(2*d)*(6*mm^4 + 10*psq^2 - 9*psq*s + 4*s^2 + 
         mm^2*(-8*psq + 3*s - 8*t)) + gZlR^2*(2*Pi)^(2*d)*
        (6*mm^4 + 10*psq^2 - 9*psq*s + 4*s^2 + mm^2*(-8*psq + 3*s - 8*t)) - 
       2^(3 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
     aa*(2^(3 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(2*mm^4 - 2*psq^2 + 13*psq*s - 4*s^2 + 
         mm^2*(-8*psq - 7*s + 8*t)) + gZlR^2*(2*Pi)^(2*d)*
        (2*mm^4 - 2*psq^2 + 13*psq*s - 4*s^2 + mm^2*(-8*psq - 7*s + 8*t))))*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gFFZ^2*
    (bb*(gZlL^2*(2*Pi)^(2*d)*(2*mm^4 - 2*psq^2 + 13*psq*s - 4*s^2 + 
         mm^2*(8*psq - 15*s - 8*t)) + gZlR^2*(2*Pi)^(2*d)*
        (2*mm^4 - 2*psq^2 + 13*psq*s - 4*s^2 + mm^2*(8*psq - 15*s - 8*t)) - 
       2^(3 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
     aa*(2^(3 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(6*mm^4 + 10*psq^2 - 9*psq*s + 4*s^2 + 
         mm^2*(-24*psq + 11*s + 8*t)) + gZlR^2*(2*Pi)^(2*d)*
        (6*mm^4 + 10*psq^2 - 9*psq*s + 4*s^2 + mm^2*(-24*psq + 11*s + 8*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/Pi^(4*d) - 
  (I*EL^5*gAl*gFFZ^2*(aa*(gZlL^2*(psq*(psq - 2*s - t) + mm^2*(psq + s - t)) + 
  ...
  (I*EL^5*gAl*gFFZ^2*(aa*(8*gZlL*gZlR*mm^2*(2*psq - s - 2*t) - 
  ...
  (I*EL^5*gAl*gFFZ^2*(bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(5*psq^2 - 7*psq*s + s^2 - 5*psq*t + 2*s*t + 
         mm^2*(-3*psq + 4*s + 3*t)) + gZlR^2*(5*psq^2 - 7*psq*s + s^2 - 
         5*psq*t + 2*s*t + mm^2*(-3*psq + 4*s + 3*t))) + 
     aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-5*psq^2 + mm^2*(3*psq + s - 3*t) - s*(s + 2*t) + 
         psq*(2*s + 5*t)) + gZlR^2*(-5*psq^2 + mm^2*(3*psq + s - 3*t) - 
         s*(s + 2*t) + psq*(2*s + 5*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gFFZ^2*
    (4^d*aa*Pi^(2*d)*(4*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - psq - 4*s) + 
       gZlR^2*(mm^2 - psq - 4*s))*(2*psq - s - 2*t) + 
     bb*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
       gZlL^2*(2*Pi)^(2*d)*(4*mm^4 + 6*psq^2 + psq*(5*s - 2*t) - 
         4*s*(s + 2*t) + mm^2*(-10*psq + 3*s + 2*t)) + 
       gZlR^2*(2*Pi)^(2*d)*(4*mm^4 + 6*psq^2 + psq*(5*s - 2*t) - 
         4*s*(s + 2*t) + mm^2*(-10*psq + 3*s + 2*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFFZ^2*
    (bb*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 + psq*(8*s - t) + mm^2*(-psq - 3*s + t) - 
         4*s*(s + t)) + gZlR^2*(2*Pi)^(2*d)*(mm^4 + psq*(8*s - t) + 
         mm^2*(-psq - 3*s + t) - 4*s*(s + t))) + 
     aa*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 + 2*psq^2 + psq*(-9*s + t) - 
         mm^2*(3*psq - 4*s + t) + 4*s*(s + t)) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 + 2*psq^2 + psq*(-9*s + t) - mm^2*(3*psq - 4*s + t) + 
         4*s*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
   (2*Pi)^(4*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
  ...
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*aa*psq^2 + 2*bb*psq^2 + 
     bb*psq*(s - 2*t) + bb*s*(-3*mm^2 + t) - aa*s*(mm^2 + t) + 
     aa*psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*EL^5*gAl*gFFZ^2*(2*(aa + bb)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s - 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
    (aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-5*psq^2 + 7*psq*s - 4*s^2 + 3*mm^2*(psq - t) + 5*psq*t - 
         6*s*t) + gZlR^2*(-5*psq^2 + 7*psq*s - 4*s^2 + 3*mm^2*(psq - t) + 
         5*psq*t - 6*s*t)) + bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(5*psq^2 - 14*psq*s + 4*s^2 - 5*psq*t + 6*s*t + 
         mm^2*(-3*psq + 7*s + 3*t)) + gZlR^2*(5*psq^2 - 14*psq*s + 4*s^2 - 
         5*psq*t + 6*s*t + mm^2*(-3*psq + 7*s + 3*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - 2*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 + 2*psq - 7*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 + 3*psq - 6*s)*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gFFZ^2*(aa*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
        (2*psq - s - 2*t) + gZlL^2*(2*Pi)^(2*d)*(mm^4 - 2*psq^2 + 
         mm^2*(psq - 4*s - t) + 4*s*t + psq*(s + t)) + 
       gZlR^2*(2*Pi)^(2*d)*(mm^4 - 2*psq^2 + mm^2*(psq - 4*s - t) + 4*s*t + 
         psq*(s + t))) + bb*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
         (2*psq - s - 2*t)) + gZlL^2*(2*Pi)^(2*d)*(mm^4 + 4*psq^2 - 4*s*t - 
         psq*(2*s + t) + mm^2*(-5*psq + 5*s + t)) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 + 4*psq^2 - 4*s*t - psq*(2*s + t) + mm^2*(-5*psq + 5*s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/(2*Pi)^(4*d) + 
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 + 3*psq - 6*s)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(-psq^2 + 3*mm^2*(psq - t) + psq*(-2*s + t) + s*(s + t)) + 
       gZlR^2*(-psq^2 + 3*mm^2*(psq - t) + psq*(-2*s + t) + s*(s + t))) + 
     aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(psq^2 + psq*(s - t) - s*(s + t) + mm^2*(-3*psq + s + 3*t)) + 
       gZlR^2*(psq^2 + psq*(s - t) - s*(s + t) + mm^2*(-3*psq + s + 3*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq^2 - 13*psq*s + 
     6*s^2 + mm^2*(4*psq - s - 4*t) - 2*psq*t + 11*s*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(6*psq^2 - 17*psq*s + 8*s^2 + mm^2*(2*psq - s - 2*t) - 6*psq*t + 
       14*s*t) - bb*(6*psq^2 - 21*psq*s + 8*s^2 + mm^2*(2*psq + 3*s - 2*t) - 
       6*psq*t + 14*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
   Pi^(2*d) - (I*EL^5*gAl*gFFZ^2*
    (aa*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) - 
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gFFZ^2*
    (aa*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(-3*psq^2 - psq*(s - 3*t) + mm^2*(psq + s - t) + 
         s*(s + t)) + gZlR^2*(2*Pi)^(2*d)*(-3*psq^2 - psq*(s - 3*t) + 
         mm^2*(psq + s - t) + s*(s + t))) - bb*(2*Pi)^(2*d)*
      (2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-3*psq^2 + mm^2*(psq - t) + 3*psq*t + s*(s + t)) + 
       gZlR^2*(-3*psq^2 + mm^2*(psq - t) + 3*psq*t + s*(s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/Pi^(4*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
    (aa*(4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
  ...
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(4*aa*mm^4 + 
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gFFZ^2*
    (-(4^d*bb*Pi^(2*d)*(4*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - psq - 4*s) + 
        gZlR^2*(mm^2 - psq - 4*s))*(2*psq - s - 2*t)) + 
     aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(4*mm^4 + 2*psq^2 + mm^2*(-6*psq + s - 2*t) + 
         psq*(-9*s + 2*t) + 4*s*(s + 2*t)) + gZlR^2*(2*Pi)^(2*d)*
        (4*mm^4 + 2*psq^2 + mm^2*(-6*psq + s - 2*t) + psq*(-9*s + 2*t) + 
         4*s*(s + 2*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/
   Pi^(4*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
    (aa*(gZlL^2*(mm^2*(psq - t) + psq*(psq - s - t)) + 
       gZlR^2*(mm^2*(psq - t) + psq*(psq - s - t)) + 
       2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t)) + 
     bb*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (bb*(-2*psq^2 - 2*s*(s + t) + mm^2*(-2*psq + s + 2*t) + 
       psq*(3*s + 2*t)) + aa*(2*psq^2 + mm^2*(2*psq + 3*s - 2*t) + 
       2*s*(s + t) - psq*(7*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gFFZ^2*(bb*(4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(5*psq^2 + 3*mm^2*(-psq + s + t) - 5*psq*(2*s + t) + 
         2*s*(s + 3*t)) + gZlR^2*(5*psq^2 + 3*mm^2*(-psq + s + t) - 
         5*psq*(2*s + t) + 2*s*(s + 3*t))) + 
     aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-5*psq^2 + mm^2*(3*psq + 4*s - 3*t) - 2*s*(s + 3*t) + 
         psq*(3*s + 5*t)) + gZlR^2*(-5*psq^2 + mm^2*(3*psq + 4*s - 3*t) - 
         2*s*(s + 3*t) + psq*(3*s + 5*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*
    (-(bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
        gZlL^2*(-psq^2 + mm^2*(3*psq - 2*s - 3*t) + psq*t + s*t) + 
        gZlR^2*(-psq^2 + mm^2*(3*psq - 2*s - 3*t) + psq*t + s*t))) + 
     aa*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(-psq^2 + 3*mm^2*(psq - s - t) + s*t + psq*(s + t)) + 
       gZlR^2*(-psq^2 + 3*mm^2*(psq - s - t) + s*t + psq*(s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq^2 - 11*psq*s + 
     5*s^2 + mm^2*(4*psq - 3*s - 4*t) - 2*psq*t + 11*s*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(6*psq^2 - 13*psq*s + 6*s^2 + mm^2*(2*psq - 5*s - 2*t) - 6*psq*t + 
       14*s*t) + bb*(-6*psq^2 + 17*psq*s - 6*s^2 + 6*psq*t - 14*s*t + 
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gFFZ^2*
    (-(bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
        gZlL^2*(2*Pi)^(2*d)*(-3*psq^2 + 2*psq*s + mm^2*(psq - 2*s - t) + 
          3*psq*t + s*t) + gZlR^2*(2*Pi)^(2*d)*(-3*psq^2 + 2*psq*s + 
          mm^2*(psq - 2*s - t) + 3*psq*t + s*t))) + 
     aa*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(-3*psq^2 + mm^2*(psq - s - t) + s*t + 
         psq*(s + 3*t)) + gZlR^2*(2*Pi)^(2*d)*(-3*psq^2 + 
         mm^2*(psq - s - t) + s*t + psq*(s + 3*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q2, q2]])/Pi^(4*d) + 
  (I*(aa + bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*
  ...
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
   Pi^(2*d) + ((3*I)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
   Pi^(2*d) + ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/
   (2*Pi)^(2*d) + (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*s*
  ...
  (I*(aa + bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p1, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p2, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - s - 2*t) + 
     aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p3, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p1, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*4^(2 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - psq + s - t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, p3]])/
   (4^d*Pi^(2*d)) - (I*2^(3 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 + 6*psq - 7*s - 8*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*mm^2 - 14*psq + 7*s + 12*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(5*psq - 3*s - 5*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*
   ...
   (2*Pi)^(2*d) + (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(bb*(psq - s - t) + 
  ...
  (I*4^(2 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(14*mm^2 - 6*psq - s - 8*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*mm^2 + 10*psq - 5*s - 12*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*
  ...
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + ((3*I)*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) + ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(3*psq - 2*s - 3*t) + 
  ...
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, p3]])/
   (4^d*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(6*psq - 5*s - 6*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(3*psq - 2*s - 3*t) + bb*(2*mm^2 - 5*psq + 2*s + 3*t))*
  ...
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
     SP[p2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p3, p3]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[p3, p3]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[q2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gFFZ^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - t)*
  ...
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*
   ...
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(3*psq - 2*s - 3*t) + bb*(2*mm^2 - 5*psq + 2*s + 3*t))*
  ...
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
  ...
  ((3*I)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
   ...
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], 
     SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
   ...
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*(8*mm^2 - 2*psq - s - 6*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
   ...
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
