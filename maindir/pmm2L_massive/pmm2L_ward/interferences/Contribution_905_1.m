...
PropList[KiraPropagator[q1, mw], KiraPropagator[q2, 0], 
  ...
  ((I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(mm^2 - psq)*s*
     (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
   (I*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
   ...
   (I*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*s*(5*psq - 4*s - 5*t) + 
      2*bb*mm^2*(psq - t) + 2*aa*mm^2*(-psq + s + t) + 
      bb*s*(-7*psq + 4*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
   ...
   (I*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(2*bb*mm^2*(psq - t) - 
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*s*(-2*psq + s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(4^d*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*s*(-2*psq + s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(4^d*Pi^(2*d)) - 
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(bb*(mm^2 + psq - s - 2*t) + 
      aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(bb*(3*mm^2 - psq - 2*t) + 
      aa*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p1, p3]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
     (mm^2 - 9*psq + 3*s + 8*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
     (mm^2 + 7*psq - 5*s - 8*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p2, q2]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/
    (4^d*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/
    Pi^(2*d) + ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
    ...
    Pi^(2*d) - (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
     (3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q2, q2]])/
    (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
     (aa*(psq - t) + bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(psq + s - t) + 
      bb*(2*mm^2 - 3*psq - s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, p3]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(psq + s - t) + 
      bb*(2*mm^2 - 3*psq - s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(-psq + s + t)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
      bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(3*psq - 2*s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/(2*Pi)^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(2*psq - s - 2*t)*
   ...
   (I*2^(1 - 2*d)*aa*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(2*mm^2 - psq - s - t) + 
      bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/Pi^(2*d) - 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(3*psq - s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/Pi^(2*d) - 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(3*psq - s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/(2*Pi)^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(2*mm^2 - psq - s - t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(mm^2 - s - t) + 
      bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
    Pi^(2*d) + (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(3*psq - s - 3*t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p3], SP[p1, q2]])/Pi^(2*d) + 
   ((3*I)*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (((-I)*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(mm^2 - psq)*s*
   ...
   (I*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
     (bb*(-psq^2 + s*(mm^2 - 2*t) + psq*(s + t)) + 
      aa*(psq^2 - psq*(3*s + t) + s*(mm^2 + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3]])/(4^d*Pi^(2*d)) + 
   (I*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(bb*s*(7*psq - 4*s - 5*t) - 
      2*bb*mm^2*(psq - t) + 2*aa*mm^2*(psq - s - t) + 
