...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  ((I*2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (aa*(4*(-2 + d)*mm^4 - mm^2*((-18 + 11*d)*psq + (-8 + d)*s + 
      ...
      bb*(-2*(-2 + d)*mm^4 + mm^2*((-2 + 3*d)*psq + (-8 + d)*s + 
          (-6 + d)*t) + psq*(-5*(-2 + d)*psq + (-4 + 3*d)*s + 3*(-2 + d)*t)))*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (bb*((-1 + d)*mm^2 + (-2 + d)*psq)*(psq - s - t) + 
      aa*(-((-2 + d)*psq*(3*psq - s - t)) + mm^2*((-3 + d)*psq + 
          (-1 + d)*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
   ...
   (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)*s*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*
     gWNl*gWWA*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^2*gWlN*
     gWNl*gWWA*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[p3, q2]])/
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^2*gWlN*
     gWNl*gWWA*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[p3, q2]])/
    Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*
