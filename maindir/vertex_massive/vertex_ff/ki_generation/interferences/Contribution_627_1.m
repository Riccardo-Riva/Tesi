...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   ((2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^2*(mm^2 - psq)*
      (2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 
         4*psq*t + 3*s*t + 2*t^2) - gZlL^2*(2*Pi)^(2*d)*
        (-((-6 + d)*psq^3) - 4*t^2*(s + t) - psq*t*((-6 + d)*s + 
           (-14 + d)*t) + psq^2*(-((-2 + d)*s) + 2*(-8 + d)*t) + 
         (-2 + d)*mm^2*(3*psq^2 + s^2 + 4*s*t + 3*t^2 - 2*psq*(s + 3*t))) - 
       gZlR^2*(2*Pi)^(2*d)*(-((-6 + d)*psq^3) - 4*t^2*(s + t) - 
         psq*t*((-6 + d)*s + (-14 + d)*t) + psq^2*(-((-2 + d)*s) + 
           2*(-8 + d)*t) + (-2 + d)*mm^2*(3*psq^2 + s^2 + 4*s*t + 3*t^2 - 
           2*psq*(s + 3*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
