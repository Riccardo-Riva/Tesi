...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  (-((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(mm^2 - psq)^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (12*psq^2 + 2*(-6 + d)*mm^2*s - 2*psq*((-6 + d)*s + 12*t) + 
      3*((-4 + d)*s^2 + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   ...
   (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(8*mm^2 - 8*psq + 3*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(4*psq + (-9 + d)*s - 4*t)*
   ...
   (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(4*psq - (-5 + d)*s - 4*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     ...
     gXll^2*mm^4*(4*psq^2 + (-4 + d)*s^2 - 8*psq*t + 4*s*t + 4*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*\[Mu]^(8 - 2*d)*
