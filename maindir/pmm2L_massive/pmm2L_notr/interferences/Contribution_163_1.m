...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((-3*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*(psq - t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*ggpgpA*gWNl*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*(psq - t)*
