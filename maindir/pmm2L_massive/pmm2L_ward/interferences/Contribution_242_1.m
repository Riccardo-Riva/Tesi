...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
 ...
 ((I*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*s*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*
    (gZlL + gZlR)*(bb*(psq^2 - mm^2*(psq + s - t) - psq*t + s*(s + t)) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*
   ...
   Pi^(2*d) + (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(bb*(psq - s - t) + 
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(bb*(mm^2 - t) + aa*(-psq + t))*
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(bb*(mm^2 + psq - s - 2*t) + 
     aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
    (bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(bb*(2*mm^2 - psq - t) + 
