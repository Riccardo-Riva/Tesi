...
(PropList[KiraPropagator[q1, mt], KiraPropagator[-p1 - p2 + q1, mt]]*
  ((((3*I)/4)*EL^6*gAl^2*gAu^2*(gZuL + gZuR)*
     ((gZuL + gZuR)*mt^2*(4*mm^4 + 2*(-2 + d)*mu^2*s - 2*s^2 + d*s^2 + 
   ...
   (((3*I)/4)*EL^6*gAl^2*gAu^2*(gZuL + gZuR)^2*(4*mm^4 + 2*(-2 + d)*mu^2*s - 
   ...
   (((3*I)/4)*EL^6*gAl^2*gAu^2*(gZuL + gZuR)^2*(4*mm^4 + 2*(-4 + d)*mu^2*s - 
   ...
   ((3*I)*EL^6*gAl^2*gAu^2*(gZuL + gZuR)^2*(2*mm^2 + 4*mu^2 + s - 2*t)*
     SPList[SP[p2, q1], SP[p3, q1]])/(Pi^4*s^2*(-mz^2 + s)) + 
   ((6*I)*EL^6*gAl^2*gAu^2*(gZuL + gZuR)^2*(2*mu^2 + s)*
