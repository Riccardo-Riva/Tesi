...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl^2*gAu^2*(gZlLC*(d^3*gZuLC*(2*Pi)^d*s*(s + 3*t) - 
     ...
     ((2*Pi)^(2*d)*(mzC^2 - s)) + (I*EL^6*gAl^2*gAu^2*t*
      (gZlRC*(d^3*gZuLC*(2*Pi)^d*s - d^3*gZuRC*(2*Pi)^d*s + 
         2^(1 + d)*gZuRC*Pi^d*(2*(-6 + d + d^2)*s - 
       ...
       gZlLC*(d^3*gZuRC*(2*Pi)^d*s - 2^(1 + d)*gZuRC*Pi^d*
         ...
         gZuLC*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*(-6 + d + d^2)*s - 
             (-12 + 20*d - 8*d^2 + d^3)*t))))*SPList[SP[p2, q1]])/
     ((2*Pi)^(2*d)*(mzC^2 - s)) + 
    ...
    (I*EL^6*gAl^2*gAu^2*(gZlRC*(-(d^3*gZuLC*(2*Pi)^d*s^2) + 
         ...
         d^3*gZuRC*(2*Pi)^d*s^2 + 2^(2 + d)*gZuLC*Pi^d*
          ...
          ((4 - 9*d + 4*d^2)*s^2 - 2*(40 - 22*d + 3*d^2)*s*t - 
           4*(10 - 6*d + d^2)*t^2)))*SPList[SP[q1, q1]])/
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
     ...
     (Pi^d*(mzC^2 - s)) + (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
      ((8 + 12*d - 8*d^2 + d^3)*gZlLC*gZuLC - (-8 + 18*d - 8*d^2 + d^3)*gZlRC*
        gZuLC - (-8 + 18*d - 8*d^2 + d^3)*gZlLC*gZuRC + 
       (8 + 12*d - 8*d^2 + d^3)*gZlRC*gZuRC)*t*SPList[SP[p2, q1], 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*EL^6*gAl^2*gAu^2*t*(s + t)*
     ...
     ((2*Pi)^(2*d)*(mzC^2 - s)) + (I*EL^6*gAl^2*gAu^2*t^2*
      (gZlRC*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*s + 
         2^(1 + d)*gZuRC*Pi^d*(-s + t) + 2^(1 + d)*gZuLC*Pi^d*(2*s + t)) + 
       gZlLC*(d*gZuLC*(2*Pi)^d*s - d*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuLC*Pi^d*
          (-s + t) + 2^(1 + d)*gZuRC*Pi^d*(2*s + t)) - 
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*((-2 + d)*gZlLC*gZuLC - 
     ...
     (Pi^d*(mzC^2 - s)) - (I*2^(2 - d)*EL^6*gAl^2*gAu^2*
      (gZlRC*gZuLC*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
       gZlLC*gZuRC*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
       gZlLC*gZuLC*((-2 + d)*s^2 + 4*s*t + 2*t^2) + 
       gZlRC*gZuRC*((-2 + d)*s^2 + 4*s*t + 2*t^2))*(-1 + GaugeXi[Q])^2*
      SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(Pi^d*(mzC^2 - s)) + 
    (I*EL^6*gAl^2*gAu^2*(-(gZlRC*(-(d*gZuLC*(2*Pi)^d*s*(3*s + 5*t)) + 
          d*gZuRC*(2*Pi)^d*s*(3*s + 5*t) + 2^(1 + d)*gZuRC*Pi^d*
           (-3*s^2 - 6*s*t + t^2) + 2^(1 + d)*gZuLC*Pi^d*(6*s^2 + 9*s*t + 
            t^2))) + gZlLC*(-(d*gZuLC*(2*Pi)^d*s*(3*s + 5*t)) + 
         d*gZuRC*(2*Pi)^d*s*(3*s + 5*t) + 2^(1 + d)*gZuLC*Pi^d*
          (3*s^2 + 6*s*t - t^2) - 2^(1 + d)*gZuRC*Pi^d*(6*s^2 + 9*s*t + 
           t^2)))*(-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], SP[q1, q1], 
       SP[q1, q1]])/((2*Pi)^(2*d)*(mzC^2 - s)) - 
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-2 + d)*gZlLC*gZuLC - 
       (-4 + d)*gZlRC*gZuLC - (-4 + d)*gZlLC*gZuRC + (-2 + d)*gZlRC*gZuRC)*
      t^2*(-1 + GaugeXi[Q])^2*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
     (Pi^d*(mzC^2 - s)) + (I*2^(3 - d)*EL^6*gAl^2*gAu^2*(gZlLC + gZlRC)*
      (gZuLC + gZuRC)*t^2*(-1 + GaugeXi[Q])^2*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q1, q1]])/(Pi^d*(mzC^2 - s)) + 
    (I*EL^6*gAl^2*gAu^2*t*(gZlLC*(-(d*gZuLC*(2*Pi)^d*s) + 
         d*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuRC*Pi^d*(-((-2 + d)*s) + t) + 
         2^(1 + d)*gZuLC*Pi^d*((-1 + d)*s + t)) + 
       gZlRC*(d*gZuLC*(2*Pi)^d*s - d*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuLC*Pi^d*
          (-((-2 + d)*s) + t) + 2^(1 + d)*gZuRC*Pi^d*((-1 + d)*s + t)) - 
       2^(1 + d)*Pi^d*(gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 
           2*gZuLC*t + 2*gZuRC*t) + gZlRC*(-((-4 + d)*gZuLC*s) + 
           (-2 + d)*gZuRC*s + 2*gZuLC*t + 2*gZuRC*t))*GaugeXi[Q] + 
       (gZlLC*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*s + 
     ...
     ((2*Pi)^(2*d)*(mzC^2 - s)) + (I*2^(1 - d)*EL^6*gAl^2*gAu^2*s*
      (gZlRC*gZuLC*(-((-4 + d)*s) + 4*t) + gZlLC*gZuRC*
       ...
       gZlRC*gZuRC*((-2 + d)*s + 4*t))*(-1 + GaugeXi[Q])^2*
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(gZlRC*(2*(-1 + d)*gZuLC*s - 
       ...
       gZlLC*(-2*(-5 + d)*gZuLC*s + 2*(-1 + d)*gZuRC*s - (-6 + d)*gZuLC*t + 
         d*gZuRC*t))*(-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p3, q1], SP[q1, q1]])/(Pi^d*(mzC^2 - s)) - 
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlLC*gZuLC - 
       (-2 + d)*gZlRC*gZuLC - (-2 + d)*gZlLC*gZuRC + (-4 + d)*gZlRC*gZuRC)*
      (s + t)*(-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q1], 
       SP[q1, q1]])/(Pi^d*(mzC^2 - s)) + 
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*((-2 + d)*gZlLC*gZuLC - 
       (-4 + d)*gZlRC*gZuLC - (-4 + d)*gZlLC*gZuRC + (-2 + d)*gZlRC*gZuRC)*t*
      (-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q1], 
       SP[q1, q1]])/(Pi^d*(mzC^2 - s)) - 
    (I*2^(3 - d)*EL^6*gAl^2*gAu^2*((-2 + d)*gZlLC*gZuLC - 
       (-4 + d)*gZlRC*gZuLC - (-4 + d)*gZlLC*gZuRC + (-2 + d)*gZlRC*gZuRC)*t*
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-2 + d)*gZlLC*gZuLC - 
      ...
      (-1 + GaugeXi[Q])^2*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1], 
       SP[q1, q1]])/(Pi^d*(mzC^2 - s)) - 
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
