...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
  ...
  ((2^(1 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(bb*(psq^2 + mm^2*(psq - s)) - 
   ...
   (2^(1 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(2*aa*mm^2 - 5*bb*mm^2 + 
      5*aa*psq - 2*bb*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*
     (2*bb*psq^2 + bb*mm^2*(2*psq - s) + aa*psq*(-2*mm^2 - 2*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*
   ...
   (4^(1 - d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(bb*(2*mm^2 + psq) - 
    ...
    Pi^(2*d) - (2^(1 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(bb*mm^2 - aa*psq)*s*
   ...
   (2^(3 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(2*aa*mm^2 - 3*bb*mm^2 + 
     ...
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q2, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p1, q2]])/Pi^(2*d) + (4^(1 - d)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
   ...
   (2^(3 - 2*d)*(aa - bb)*EL^5*ggagmW^2*gWlN*gWNl*gWWA*(mm^2 + psq)*
