...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   (((-I)*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
    ...
    (I*4^(1 - d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*
      ...
      SPList[SP[p1, q1]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*
    ...
    (I*2^(3 - 2*d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gXll^2*
      (gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*
