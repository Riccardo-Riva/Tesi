...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(1 - 4*d)*d*EL^8*gAl^4*gAu^2*mm^2*
     (-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(3*mm^2 + psq)*(8*s^2 + d^2*s^2 + 
      ...
      gZlR^2*(2^(1 + 2*d)*(-2 + d)^2*mm^4*Pi^(2*d)*s + d^2*(2*Pi)^(2*d)*psq*
        ...
        2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + psq^2*((12 - 4*d + d^2)*s - 
          ...
          2*psq*((9 - 5*d)*s^2 + (-10 + d)*s*t + (-2 + d)*t^2))))*
     \[Mu]^(8 - 2*d))/(Pi^(4*d)*s^2) + 
   (2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*mm^2*
     (gZlL*gZlR*(8*(-mm^2 + psq)*s + d^2*(-mm^2 + psq)*s - 
        2*d*(3*mm^2*(psq - 2*s - t) + psq*(psq + 2*s - t))) + 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(mm^2 - psq)*
   ...
   (2^(1 - 4*d)*d*EL^8*gAl^4*gAu^2*mm^2*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*
   ...
   (2^(1 - 4*d)*EL^8*gAl^4*gAu^2*(-(2^(3 + 2*d)*(-2 + d)*gZlL*gZlR*mm^2*
        Pi^(2*d)*(8*s^2 + d^2*s^2 + d*(4*psq^2 - 6*s^2 - 8*psq*t + 4*s*t + 
           4*t^2))) + gZlL^2*(2^(1 + 2*d)*(-2 + d)^2*d*mm^4*Pi^(2*d)*s + 
    ...
    (Pi^(4*d)*s^2) + (4^(2 - d)*(-2 + d)*d*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(2 - d)*(-2 + d)*d*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*mm^2*
     ...
     (-4*gZlL*gZlR*mm^2*(8*s + d^2*s + 2*d*(psq - 4*s - t)) + 
      gZlL^2*(2*(2 + d)*psq^2 + (44 - 20*d + d^2)*psq*s + 4*(-3 + d)*s^2 - 
        2*(6 + d)*psq*t + 4*s*t + 8*t^2 + mm^2*(2*(-2 + d)*psq + 
          (-8 + d^2)*s - 2*(-2 + d)*t)) + gZlR^2*(2*(2 + d)*psq^2 + 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*d*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(16*d*gZlL*gZlR*mm^2*(psq - t) + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(8*d*gZlL*gZlR*mm^2*(psq - t) + 
      gZlL^2*((-2 + d)*mm^2*(-4*psq + (-2 + d)*s + 4*t) + 
        s*(-((8 - 4*d + d^2)*psq) + 2*(-2 + d)*s + 4*t)) + 
      gZlR^2*((-2 + d)*mm^2*(-4*psq + (-2 + d)*s + 4*t) + 
        s*(-((8 - 4*d + d^2)*psq) + 2*(-2 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*
     ...
     (-4*gZlL*gZlR*mm^2*(8*s + d^2*s - 2*d*(psq + 3*s - t)) + 
      gZlL^2*(-2*(-6 + d)*psq^2 + (32 - 18*d + d^2)*psq*s + 4*(-2 + d)*s^2 + 
        2*(-10 + d)*psq*t + 12*s*t + 8*t^2 + mm^2*(-2*(-2 + d)*psq + 
          (-12 + 2*d + d^2)*s + 2*(-2 + d)*t)) + 
      gZlR^2*(-2*(-6 + d)*psq^2 + (32 - 18*d + d^2)*psq*s + 4*(-2 + d)*s^2 + 
        2*(-10 + d)*psq*t + 12*s*t + 8*t^2 + mm^2*(-2*(-2 + d)*psq + 
          (-12 + 2*d + d^2)*s + 2*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*((-2 + d)*gZlL^2 - d*gZlL*gZlR + 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(-16*d*gZlL*gZlR*mm^2*s + 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(-4*d*gZlL*gZlR*mm^2*s + 
