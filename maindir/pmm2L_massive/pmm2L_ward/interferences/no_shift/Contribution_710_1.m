...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)*s*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*
     ...
     SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(1 - 4*d)*EL^5*gAl^3*gHll^2*mm^2*
     ...
     SPList[SP[p1, q2]])/Pi^(4*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*
     mm^4*(-((-4 + d)*psq^2) + (-8 + d)*psq*s + (-4 + d)*psq*t + 
      2*s*(s + 2*t) + mm^2*((4 + d)*psq - 4*t - d*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 4*d)*EL^5*gAl^3*gHll^2*mm^2*
     ...
     SPList[SP[p2, q2]])/Pi^(4*d) - (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*s*
     (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
      bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    ...
    Pi^(2*d) + (I*4^(2 - d)*EL^5*gAl^3*gHll^2*mm^4*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*(-((-2 + d)*psq^2) - 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
     (bb*(-((-2 + d)*psq^2) + (4 + d)*psq*s + (2 + d)*mm^2*(psq - s - t) + 
        (-2 + d)*psq*t - 2*s*(s + t)) + aa*((-2 + d)*psq^2 + (-8 + d)*psq*s - 
   ...
   (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*s*
     (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
      bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*(-((-2 + d)*psq) + 2*s + 
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
   ...
   (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q1, q2]])/Pi^(2*d) + (I*4^(2 - d)*EL^5*gAl^3*gHll^2*mm^2*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*((-2 + d)*psq - 2*s - 
      (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q1]])/
    Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
     ((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*((-2 + d)*psq - (-4 + d)*s - 
