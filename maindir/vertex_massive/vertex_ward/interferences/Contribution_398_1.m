...
PropList[KiraPropagator[q2, mm], KiraPropagator[-p1 + q2, mm], 
 ...
 (-((2^(-1 - 2*d)*EL^5*gAl*gFFZZ*mm^2*s*
     ...
     \[Mu]^(8 - 2*d))/Pi^(2*d)) + 
  (EL^5*gAl*gFFZZ*(2*bb*(gZlL^2 + gZlR^2)*psq*s - 
   ...
   (2*Pi)^(2*d) + ((-aa + bb)*(-2 + d)*EL^5*gAl*gFFZZ*(gZlL^2 + gZlR^2)*
    (mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gFFZZ*(gZlL^2 + gZlR^2)*
    (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gFFZZ*(gZlL^2 + gZlR^2)*(aa*mm^2 - bb*psq)*
