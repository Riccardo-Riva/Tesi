...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((EL^5*gAl^3*gHll^2*mm^4*s*
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (-(aa*d*(3*mm^2*psq^2 + mm^4*(9*psq - 5*s) + psq^2*s)) + 
     2*aa*s*(-4*mm^4 + psq*s + mm^2*(-2*psq + s)) + 
     bb*(2*mm^2*(mm^2 + 5*psq - 2*s)*s + d*(mm^4*(9*psq - 3*s) + 
         mm^2*psq*(3*psq - 2*s) + psq^2*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
    (-(bb*(d*(psq - s)^2 + 2*(4*psq - s)*s + 
        mm^2*((4 + d)*psq - (-2 + d)*s))) + 
  ...
  (EL^5*gAl^3*gHll^2*mm^2*s*(aa*((-4 + d)*mm^4 + (20 - 3*d)*mm^2*psq + 
       2*psq*(d*psq - 2*s)) + bb*((-4 + d)*mm^4 + 
  ...
  (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*(-2 + d)*mm^4 + bb*d*psq^2 - 
     aa*mm^2*((4 + d)*psq - 2*s) + aa*psq*(-(d*psq) + 2*s) - 
     bb*mm^2*((-8 + d)*psq + 4*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(4*aa*mm^4 - aa*(-2 + d)*mm^2*
      (3*psq - 2*s) - bb*(-2 + d)*psq*s + 
     bb*mm^2*((-10 + 3*d)*psq - (-2 + d)*s))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*mm^2 - bb*psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(-2*bb*mm^2 + aa*(mm^2 + psq))*
    s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*mm^2 + bb*(-6 + d)*mm^2 - 
  ...
  (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(4 + d)*mm^2 + bb*d*psq - 
