...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  ((I*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*s*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
    ...
    Pi^(2*d) + (I*EL^5*gWlN*gWNl*gWWA*gWWZ*s*
     (2*aa*(-2 + d)*gZlL*mm^2*(psq - t) + 2*aa*(-1 + d)*gZlR*mm^2*(psq - t) - 
      2*bb*(-1 + d)*gZlR*mm^2*(psq - t) + aa*gZlL*s*((14 - 5*d)*psq - 
        (-6 + d)*t) + bb*gZlL*(-4*(-2 + d)*psq^2 + (-6 + d)*psq*s + 
        (-6 + d)*s*t + 2*(-2 + d)*mm^2*(psq + 2*s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
   ((3*I)*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*s*
   ...
   (I*2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*s*
     (2*aa*(-2 + d)*gZlL*(mm^2 - psq)*s + 2*bb*(-2 + d)*gZlL*(mm^2 - psq)*s - 
    ...
    Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*
     (-(2^(1 + 2*d)*aa*(-1 + d)*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
      ...
      bb*gZlL*(2*Pi)^(2*d)*(-2*(-2 + d)*psq^2 + (-22 + 5*d)*psq*s + 
        (-2 + 3*d)*s^2 + 2*(-2 + d)*mm^2*(psq - 3*s - t) + 2*(-2 + d)*psq*t + 
        (10 + d)*s*t) + aa*gZlL*(2*Pi)^(2*d)*(-2*(-2 + d)*psq^2 + 
        (10 - 11*d)*psq*s + (-2 + 3*d)*s^2 + 2*(-2 + d)*mm^2*
         (psq + 5*s - t) + 2*(-2 + d)*psq*t + (10 + d)*s*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
     ...
     (2*aa*(-1 + d)*gZlR*mm^2*(psq - t) - 2*bb*(-1 + d)*gZlR*mm^2*(psq - t) + 
      aa*gZlL*((18 - 7*d)*psq*s + 2*(-2 + d)*mm^2*(psq - t) + (2 + d)*s*t) + 
      bb*gZlL*(-4*(-2 + d)*psq^2 - (2 + d)*psq*s - (2 + d)*s*t + 
    ...
    Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*
     (-(2^(1 + 2*d)*aa*(-1 + d)*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
      ...
      bb*gZlL*(2*Pi)^(2*d)*(-2*(-2 + d)*psq^2 + (-34 + 11*d)*psq*s - 
        2*(-6 + d)*s^2 + 2*(-2 + d)*mm^2*(psq - 6*s - t) + 2*(-2 + d)*psq*t + 
        (10 + d)*s*t) + aa*gZlL*(2*Pi)^(2*d)*(-2*(-2 + d)*psq^2 - 
        (2 + 5*d)*psq*s + 2*(-2 + d)*mm^2*(psq + 2*s - t) + 
        2*(-2 + d)*psq*t + s*(-2*(-6 + d)*s + (10 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/Pi^(4*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
    Pi^(2*d) + (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ*
     (-(bb*((-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlL*s*
          (4*mm^2 - 3*psq - t))) + aa*((-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) - 
        (-2 + d)*gZlL*s*(2*mm^2 - 3*psq + t)))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ*(-2*aa*(-1 + d)*gZlR*mm^2 + 
      2*bb*(-1 + d)*gZlR*mm^2 + bb*gZlL*(2*(-2 + d)*mm^2 - 2*(-6 + d)*psq - 
        2*s - d*s + 8*t - 4*d*t) + aa*gZlL*(6*(-2 + d)*mm^2 + (4 - 6*d)*psq + 
        2*s + d*s - 8*t + 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
