...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
 ...
 ((4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*t*\[Mu]^(8 - 2*d)*
