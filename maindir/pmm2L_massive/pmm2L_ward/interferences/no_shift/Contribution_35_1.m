...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  ((I*(aa + bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     ...
     (bb*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(psq*(psq - t) + mm^2*(psq - s - t)) + 
      ...
      aa*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2*(psq - t) + 
         ...
         Pi^(2*d)*(2*(-mm^2 + psq)*s + d*mm^2*(3*psq - s - 3*t) + 
          d*psq*(-psq + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(4*d) - 
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(-4 + d)*mm^2 + 2*bb*psq + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q2, q2]])/Pi^(2*d) - (I*4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*
