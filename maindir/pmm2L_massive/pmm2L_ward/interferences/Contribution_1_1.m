...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 ((I*(aa + bb)*EL^5*gFFAZ*gFll^2*gZNL*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFAZ*gFll^2*gZNL*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFAZ*gFll^2*gZNL*mm^2*(aa*(mm^2 - s - t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFAZ*gFll^2*gZNL*mm^2*(aa*(2*mm^2 - psq - t) + 
