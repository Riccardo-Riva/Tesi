...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*s*
      (aa*(mm^4 + mm^2*(2*psq - 2*s - 3*t) + psq*(psq - t)) + 
       bb*(mm^4 + psq*(-psq + s + t) + mm^2*(-4*psq + s + 3*t)))*
      \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXX*
      gXll^2*mh^2*mm^4*(mm^2*(3*psq - s - 3*t) + (psq - s)*(psq - s - t))*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*
      ...
      gHXX*gXll^2*mh^2*mm^4*(mm^2*(3*psq - 2*s - 3*t) + (psq - s)*(psq - t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*
      (aa*s*(psq - t) + 2*bb*mm^2*(psq - 2*s - t) + bb*s*(psq + t) + 
       2*aa*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*s*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*
