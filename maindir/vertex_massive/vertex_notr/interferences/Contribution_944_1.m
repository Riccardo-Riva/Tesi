...
PropList[KiraPropagator[q1, mm], KiraPropagator[p1 - q2, mm], 
 ...
 (-((EL^6*gAl^2*gHll^2*gXll^2*mm^6*(2*(-1 + d)*mm^4 - 2*(-4 + d)*s^2 + 
      mm^2*(-2*(-3 + d)*psq - (-6 + d)*s))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
  (4^(1 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*(3*mm^2 - (-6 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) - 
  (EL^6*gAl^2*gHll^2*gXll^2*mm^6*(2*mm^2 + 2*(-3 + d)*psq - (-4 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*((-4 + d)*mm^2 - 
     2*(-3 + d)*psq + 2*(-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*
    (2*mm^2 - (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*(3*mm^2 - (-6 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (EL^6*gAl^2*gHll^2*gXll^2*mm^4*(2*(1 + d)*mm^4 - 2*(-4 + d)*s^2 + 
     mm^2*(-2*(-1 + d)*psq - 3*(-4 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2*Pi)^(2*d) + 
  (EL^6*gAl^2*gHll^2*gXll^2*mm^6*(2*(-5 + d)*mm^2 - 2*(-7 + d)*psq + 
     (-10 + 3*d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2*Pi)^(2*d) - 
  (4^(2 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*d*EL^6*gAl^2*gHll^2*gXll^2*mm^6*\[Mu]^(8 - 2*d)*
  ...
  (EL^6*gAl^2*gHll^2*gXll^2*mm^4*(2*(-3 + d)*mm^2 - 2*(-5 + d)*psq + 
   ...
   (2*Pi)^(2*d) + (4^(2 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
