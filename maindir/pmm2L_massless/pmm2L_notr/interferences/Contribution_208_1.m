...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (-((4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*
    (gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*
    (gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
