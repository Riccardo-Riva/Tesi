...
PropList[KiraPropagator[-p1 - q1, ml], KiraPropagator[q2, mw], 
 ...
 (-((EL^5*gFFA*gFll^4*ml^2*mm^2*s*(-2*bb*psq^2 + 
  ...
  (4^(1 - d)*EL^5*gFFA*gFll^4*ml^2*mm^2*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll^4*ml^2*mm^2*(mm^2 + psq)*
