...
PropList[KiraPropagator[-q1, mh], KiraPropagator[-q1 - q2, mz], 
 ...
 ((2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   ((2*Pi)^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq^2 - 3*s^2 + d*s^2 + psq*(s - d*s - 4*t) + s*t + 2*t^2 + 
     2*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   ((2*Pi)^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (-6*psq^2 + (6 + d)*psq*s + 4*mm^2*(psq - s - t) + 6*psq*t - 4*s*(s + t))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(psq - s)*
  ...
  (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)*s) + (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(-4*psq^2 + 4*mm^2*s - 8*psq*s + 10*s^2 - 3*d*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - (2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, p3]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*
    gXll*(gZlL - gZlR)*mm^2*(2*mm^2 - 4*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(2*mm^2 - 4*psq - d*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-3 + d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(1 + d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (-4*psq + (6 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p1, p3]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*
    gXll*(gZlL - gZlR)*mm^2*(psq - (-2 + d)*s - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
