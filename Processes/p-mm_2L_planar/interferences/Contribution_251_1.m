...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  ((3*4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (3*4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*
     (2*(-2 + d)*mu^2*s + (-2 + d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*
     (2*mu^2 + s)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
   (3*4^(1 - d)*(-1 + d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*
   ...
   (3*2^(3 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*(s + t)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (3*4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*
     (2*(-2 + d)*mu^2 + (-4 + d)*s)*SPList[SP[p1, q1], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*
     gWWA^2*mm^2*(s + t)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (3*2^(3 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*
     (2*mu^2 + s)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-1 + d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (3*2^(3 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*t*
   ...
   (4^(2 - d)*(-1 + d)*EL^8*gAl*gAu^2*gFAW*gFll*gWNl*gWWA^2*mm^2*(mu^2 - t)*
