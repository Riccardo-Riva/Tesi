...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*
     (aa*(3*psq^2 - 3*psq*s + s^2 + mm^2*(psq - s - 2*t) - 2*psq*t + 2*s*t) - 
      bb*(psq^2 - 3*psq*s + s^2 + mm^2*(3*psq - s - 2*t) - 2*psq*t + 2*s*t))*
     \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^2*(-(bb*((2*psq - s)*s*(psq - s - t) + 
         mm^4*(psq + s - t) + mm^2*(3*psq^2 - 5*psq*s - 3*psq*t + 4*s*t))) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     (gZlL - gZlR)*mm^4*(-psq^2 + mm^2*(psq - 2*s - t) + psq*t + 2*s*(s + t))*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (bb*s*(psq + s + t) + aa*(2*mm^4 - 2*mm^2*(psq + s) - s*(-psq + s + t)))*
