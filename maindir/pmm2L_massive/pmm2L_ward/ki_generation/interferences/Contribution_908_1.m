...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    ((I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*s*(aa*mm^2*(psq - t) + 
       ...
       \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gFFA*gHFF*gHll*
       mm^2*(bb*psq*(-psq + t) + aa*(psq^2 + 2*mm^2*s - psq*(2*s + t)))*
     ...
     (I*4^(1 - d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(2*mm^2 + s)*(psq - t) - 
       ...
       SPList[SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
       gFFA*gHFF*gHll*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
       SPList[SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*
       gHFF*gHll*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
       SPList[SP[q1, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*aa*EL^5*gAl^2*gFFA*gHFF*
       gHll*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
      Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
       (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
     (I*2^(3 - 2*d)*(aa + bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(mm^2 - psq)*
