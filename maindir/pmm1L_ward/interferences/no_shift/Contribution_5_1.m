...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (((aa + bb)*(-2 + d)*EL^3*gAl*(gZlL^2 + gZlR^2)*(mm^2 - psq)^2*s*
     \[Mu]^(4 - d))/(2*Pi)^d + 
   (2^(1 - d)*EL^3*gAl*
   ...
   (2^(1 - d)*EL^3*gAl*
     (bb*(-((-2 + d)*gZlL^2*(psq*(psq - t) + mm^2*(psq - s - t))) - 
      ...
      aa*((-2 + d)*gZlL^2*(mm^2*(psq - t) + psq*(psq - s - t)) + 
        (-2 + d)*gZlR^2*(mm^2*(psq - t) + psq*(psq - s - t)) + 
        2*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t)))*\[Mu]^(4 - d)*
     SPList[SP[p2, q1]])/Pi^d + (2^(1 - 2*d)*(aa + bb)*EL^3*gAl*
     (gZlL^2 + gZlR^2)*(2^(1 + d)*Pi^d - d*(2*Pi)^d)*(mm^2 - psq)*s*
     \[Mu]^(4 - d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
   ((aa + bb)*(-2 + d)*EL^3*gAl*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
     \[Mu]^(4 - d)*SPList[SP[q1, q1]])/(2*Pi)^d + 
   (2^(1 - d)*(-2 + d)*EL^3*gAl*(gZlL^2 + gZlR^2)*(bb*(psq - s - t) + 
   ...
   (2^(1 - d)*(-2 + d)*EL^3*gAl*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p2, q1]])/Pi^d + 
   (2^(1 - d)*(aa - bb)*(-2 + d)*EL^3*gAl*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
     \[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p3, q1]])/Pi^d))/4
