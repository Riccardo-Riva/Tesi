...
PropList[KiraPropagator[p1 + q1, mh], KiraPropagator[q2, mm], 
 ...
 (-((EL^5*gAl*gHHZZ*mm^2*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
  ...
  (2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*
    (mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  ((aa + bb)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
