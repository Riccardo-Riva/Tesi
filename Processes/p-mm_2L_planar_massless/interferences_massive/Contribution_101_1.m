...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^4*
     mu^2)/(Pi^(2*d)*s) + (3*2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ*gXgmgm*
     gXll*(gZlL - gZlR)*mm^4*mu^2*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (3*2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^4*
     mu^2*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
