...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gHll*gHZZ*mm^4*s*
  ...
  EL^5*gAl*gHll*gHZZ*mm^2*
   (((-aa + bb)*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
       2*d*gZlL*gZlR*(mm^2 + psq))*s)/(2*Pi)^(2*d) + 
    (2^(1 - 2*d)*(aa*psq*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
         d*gZlL*gZlR*s) - bb*mm^2*((-2 + d)*gZlL^2*psq + 
         (-2 + d)*gZlR^2*psq + d*gZlL*gZlR*s)))/Pi^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, q2]] + ((aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (2*Pi)^(2*d) + ((aa - bb)*EL^5*gAl*gHll*gHZZ*mm^2*
    ((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
     2*d*gZlL*gZlR*(mm^2 + psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (2*Pi)^(2*d) - (2^(-1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   Pi^(2*d) - (2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*(4*psq - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
