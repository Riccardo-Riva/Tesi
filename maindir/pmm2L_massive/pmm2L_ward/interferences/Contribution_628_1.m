...
PropList[KiraPropagator[-p3 + q1, mz], KiraPropagator[q2, mz], 
 ...
 (((-I)*EL^5*gAl*gXll^2*mm^4*(mm^2 - psq)*s*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + 
  (I*EL^5*gAl*gXll^2*mm^2*((aa - bb)*(mm^2 - psq)*
      (4*gZlL*gZlR*mm^2*(-2*s + d*(-psq + s + t)) + 
       gZlL^2*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - s - t) - 2*s*(s + t) - 
  ...
  (I*EL^5*gAl*gXll^2*mm^2*((aa - bb)*(mm^2 - psq)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
  ...
  (I*EL^5*gAl*gXll^2*mm^2*s*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
      (mm^2 - psq)^2 + mm^2*(bb*((-2 + d)*gZlL^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*(mm^2 - psq) + 4*gZlL*gZlR*(2*psq - s - 2*t)) + 
       aa*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
         4*gZlL*gZlR*(-2*psq + s + 2*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 + psq)*(bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gXll^2*mm^2*(2^(1 + 2*d)*(aa - bb)*mm^2*Pi^(2*d)*
  ...
  (I*4^(-1 - d)*EL^5*gAl*gXll^2*mm^2*
    (-(bb*(4*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
        gZlL^2*(3*(-2 + d)*psq^2 + (-8 + d)*psq*s + 3*(-2 + d)*mm^2*
           (psq - s - t) - 3*(-2 + d)*psq*t + 2*s*(s + t)) + 
        gZlR^2*(3*(-2 + d)*psq^2 + (-8 + d)*psq*s + 3*(-2 + d)*mm^2*
           (psq - s - t) - 3*(-2 + d)*psq*t + 2*s*(s + t)))) + 
     aa*(4*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(3*(-2 + d)*psq^2 + (-2 + d)*mm^2*(3*psq + s - 3*t) + 6*psq*t - 
         3*d*psq*(s + t) + 2*s*(s + t)) + gZlR^2*(3*(-2 + d)*psq^2 + 
         (-2 + d)*mm^2*(3*psq + s - 3*t) + 6*psq*t - 3*d*psq*(s + t) + 
         2*s*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*mm^2*(4*gZlL*gZlR*mm^2*(2*s + d*(-psq + t)) + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gXll^2*
    (gZlL^2 + gZlR^2)*mm^2*(mm^2 + psq)*(bb*(2*mm^2 - psq - t) + 
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gXll^2*mm^2*(2^(1 + 2*d)*(aa - bb)*Pi^(2*d)*
  ...
  (I*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (bb*((-2 + d)*mm^2 + 4*s - d*s + 2*t - d*t) + 
     aa*((-2 + d)*mm^2 + 4*psq - 2*d*psq - 4*s + d*s - 2*t + d*t))*
