...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   (-((4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(2*psq^2 + 4*mm^2*s - 
       9*psq*s + 3*s^2 - 4*psq*t + 5*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(2*psq^2 - 3*psq*s + s^2 - 
      ...
      mm^4*(mm^2 - psq)*(2*psq^2 + 3*psq*s - s^2 - 4*psq*t + s*t + 2*t^2)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
     ...
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(2*psq + s - 2*t)*(psq - t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(psq - t)*
     ...
     Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(-4*psq^3 + mm^2*psq*s + 
