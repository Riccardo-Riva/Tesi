...
PropList[KiraPropagator[p3 + q1, mu], KiraPropagator[-p1 - p2 + p3 + q1, mu]]*
 ((((3*I)/16)*EL^6*gAl^2*gAu^2*(gZuL + gZuR)*
  ...
  (((3*I)/4)*EL^6*gAl^2*gAu^2*(gZuL + gZuR)^2*(-2*mm^2 + 4*mu^2 + 3*s + 2*t)*
