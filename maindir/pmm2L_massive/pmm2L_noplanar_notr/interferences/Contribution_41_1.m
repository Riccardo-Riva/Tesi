...
(PropList[KiraPropagator[q1, mh], KiraPropagator[-p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ((-8 + d)*mm^4*s + psq*(4*psq^2 + (-8 + d)*psq*s + (-2 + d)*s^2 - 
        8*psq*t + 4*s*t + 4*t^2) + mm^2*(20*psq^2 + (-22 + 5*d)*s^2 + 
        20*s*t + 20*t^2 - 2*psq*((-8 + d)*s + 20*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (4*mm^4*s - mm^2*(12*psq^2 + (-14 + 3*d)*s^2 + 8*psq*(s - 3*t) + 
        12*s*t + 12*t^2) - psq*(4*psq^2 + (-2 + d)*s^2 + 4*s*t + 4*t^2 - 
        4*psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (6*mm^4 + 3*psq*(4*psq + 2*s - d*s - 2*t) - 
      mm^2*(10*psq - 14*s + 3*d*s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     gXll*(gZlL - gZlR)*mm^2*((-7 + 2*d)*psq*s + mm^2*(-4*psq + 5*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
      mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^2*(psq*(2*psq + 3*(-4 + d)*s - 2*t) + 
      mm^2*(-10*psq + (8 + d)*s + 10*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (psq*(2*psq + (-4 + d)*s - 2*t) + mm^2*(-2*psq + d*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (6*mm^4 - 3*(-4 + d)*psq*s + 6*psq*t + 
      mm^2*(-14*psq + 16*s - 3*d*s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (12*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 8*psq*(s + 2*t) + 
      ...
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^2*(psq*(psq + (-4 + d)*s - t) + 
      mm^2*(-3*psq + 4*s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^2*(-((-4 + d)*psq*s) + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 + psq)*
     ...
     gXll*(gZlL - gZlR)*mm^2*(4*psq^2 - 2*(-10 + d)*mm^2*s + 
