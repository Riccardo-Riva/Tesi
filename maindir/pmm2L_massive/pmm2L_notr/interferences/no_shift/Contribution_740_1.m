...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*((-4 + d)*d*mm^4*s - 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*(-2*(-2 + d)*psq^2 - 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*(4*(-2 + d)*psq^2 + 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*(4*(-1 + d)*psq^2 + 
      10*s^2 - 6*d*s^2 + d^2*s^2 + mm^2*(4*psq + (4 - 6*d + d^2)*s - 4*t) - 
      2*s*t + 4*d*s*t - 4*t^2 + 4*d*t^2 - 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*(4*(-2 + d)*psq^2 + 
      16*s^2 - 10*d*s^2 + d^2*s^2 - 4*mm^2*(4*psq + (-2 + d)*s - 4*t) - 
      16*s*t + 4*d*s*t - 8*t^2 + 4*d*t^2 + 4*psq*(d*(s - 2*t) + 4*t))*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*(4*(-1 + d)*psq^2 + 8*s^2 - 
   ...
   (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*
     ...
     gWlN*gWNl*((-2 + d)*mm^2 - 2*(-3 + d)*psq - 3*s + d*s - 4*t + d*t)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-40 + 40*d - 12*d^2 + d^3)*EL^8*gAl^4*
     ...
     gWNl*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
     gWlN*gWNl*((-2 + d)*mm^2 - 2*(-3 + d)*psq - 3*s + d*s - 4*t + d*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-40 + 40*d - 12*d^2 + d^3)*EL^8*gAl^4*
     gAu^2*gWlN*gWNl*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     ...
     gWlN*gWNl*((-2 + d)*mm^2 - 2*psq + s + 4*t - d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*(-4*(-2 + d)*mm^2 + 
      4*(-2 + d)*psq + (24 - 12*d + d^2)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*(4*mm^2 - 4*psq + s)*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*(2*psq - 3*s - 2*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*(-2*(-2 + d)*psq + 
   ...
   (2^(3 - 2*d)*(-40 + 40*d - 12*d^2 + d^3)*EL^8*gAl^4*gAu^2*gWlN*gWNl*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-40 + 40*d - 12*d^2 + d^3)*EL^8*gAl^4*
     gAu^2*gWlN*gWNl*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*
     gWlN*gWNl*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
     gWlN*gWNl*(2*(-2 + d)*psq + (24 - 12*d + d^2)*s - 2*(-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*
     gWNl*(-2*(-2 + d)*psq + (20 - 10*d + d^2)*s + 2*(-2 + d)*t)*
