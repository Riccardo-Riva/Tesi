   ...
   (((-I)*(aa - bb)*(2 + d)*EL^5*gWWAZ*gWWZ*gZlL*gZlR*mm^2*s*
    ...
    (I*2^(-1 - 4*d)*EL^5*gWWAZ*gWWZ*
      (-(bb*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(6*(-1 + d)*psq - 
             (2 + d)*s - 6*(-1 + d)*t)) + gZlL^2*(2*Pi)^(2*d)*
           ((-6 + 4*d)*psq^2 + 2*(-3 + 2*d)*mm^2*(psq + s - t) + 
            d*s*(s + t) + psq*(2*s - 5*d*s + 6*t - 4*d*t)) + 
          gZlR^2*(2*Pi)^(2*d)*((-6 + 4*d)*psq^2 + 2*(-3 + 2*d)*mm^2*
             (psq + s - t) + d*s*(s + t) + psq*(2*s - 5*d*s + 6*t - 
              4*d*t)))) + aa*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
           (6*(-1 + d)*psq - (2 + d)*s - 6*(-1 + d)*t)) + 
         gZlL^2*(2*Pi)^(2*d)*((-6 + 4*d)*psq^2 + d*s*(s + t) + 
           psq*((-6 + d)*s + 6*t - 4*d*t) + 2*mm^2*((-3 + 2*d)*psq + s - 
             d*s + 3*t - 2*d*t)) + gZlR^2*(2*Pi)^(2*d)*((-6 + 4*d)*psq^2 + 
           d*s*(s + t) + psq*((-6 + d)*s + 6*t - 4*d*t) + 
           2*mm^2*((-3 + 2*d)*psq + s - d*s + 3*t - 2*d*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/Pi^(4*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gWWAZ*gWWZ*
      gZlL*gZlR*mm^2*(6*(-1 + d)*psq - (2 + d)*s - 6*(-1 + d)*t)*
