 ...
 ((EL^5*gAl^2*gFFA^3*(2*bb*psq - aa*(mm^2 + psq))*s^3*\[Mu]^(8 - 2*d))/
  ...
  (4^(1 - d)*EL^5*gAl^2*gFFA^3*s*(2*aa*(psq^2 + mm^2*(-psq + s)) + 
    ...
    (bb*mm^2*(4*psq - 3*s) + aa*psq*(4*psq + s) - bb*psq*(4*psq + 5*s) + 
     aa*mm^2*(-4*psq + 7*s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (EL^5*gAl^2*gFFA^3*s*(2*bb*mm^2*(psq - s) + aa*psq*(2*psq + s) - 
     2*bb*psq*(psq + 2*s) + aa*mm^2*(-2*psq + 5*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2*Pi)^(2*d) - 
  (4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl^2*gFFA^3*(-2*bb*(mm^2 + 3*psq) + aa*(5*mm^2 + 3*psq))*s*
  ...
  (4^(1 - d)*EL^5*gAl^2*gFFA^3*(-4*bb*(mm^2 + 2*psq) + aa*(7*mm^2 + 5*psq))*s*
