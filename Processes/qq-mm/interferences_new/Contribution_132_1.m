PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 (((-I)*2^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*
  ...
  (I*EL^6*gAl*gAu*ggmgmZ^2*(gZlR*gZuL*(2*mm^2 + 2*(-4 + d)*mmv^2 + 4*s - 
  ...
  (I*2^(2 - d)*EL^6*gAl*gAu*ggmgmZ^2*((-2 + d)*gZlL*gZuL - 
     (-4 + d)*gZlR*gZuL - (-4 + d)*gZlL*gZuR + (-2 + d)*gZlR*gZuR)*
  ...
  (I*2^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*
   ...
   (Pi^d*(mz^2 - s)^2*s) - (I*2^(3 - d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL + gZlR)*
