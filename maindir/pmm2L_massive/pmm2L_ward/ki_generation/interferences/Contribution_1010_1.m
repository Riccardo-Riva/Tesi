...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
   ...
   ((I*(-2 + d)^2*EL^5*gWlN*gWNl*gWWA*gZNL^2*psq*s*(bb*(psq - s - t) + 
    ...
    (I*(-2 + d)^2*EL^5*gWlN*gWNl*gWWA*gZNL^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gWlN*gWNl*
      gWWA*gZNL^2*psq*(aa*(psq - t) + bb*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*(-2 + d)^2*EL^5*gWlN*gWNl*gWWA*gZNL^2*s*(bb*(2*mm^2 - psq - t) + 
     ...
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN*gWNl*gWWA*
      ...
      gZNL^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
       SP[q1, q1]])/(2*Pi)^(2*d) - (I*4^(1 - d)*(-2 + d)^2*EL^5*gWlN*gWNl*
      gWWA*gZNL^2*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
