...
(PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
  ...
  ((I*2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gZNL*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gZNL*
     ((-2 + d)*gZlR*mm^2 - (-4 + d)*gZlL*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*(4*bb*(-psq + s + t) + 
   ...
   (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gZNL*
     ((-2 + d)*gZlR*mm^2 - (-4 + d)*gZlL*psq)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(-4 + d)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*
   ...
   (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*(4*aa*(psq - t) + 
