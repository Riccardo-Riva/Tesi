...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  ((EL^5*gAl^3*mm^2*s*(2^(1 + 2*d)*aa*Pi^(2*d)*
       (-((-2 + d)*gZlL^2*(-((-2 + d)*psq^2) + mm^2*((2 + d)*psq - s))) - 
        (-2 + d)*gZlR^2*(-((-2 + d)*psq^2) + mm^2*((2 + d)*psq - s)) + 
        gZlL*gZlR*mm^2*((4 - 6*d + d^2)*mm^2 - (20 - 14*d + d^2)*psq - 
          2*(-2 + d)*s)) + bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
         ((4 - 6*d + d^2)*mm^2 - (-12 + 2*d + d^2)*psq + 2*(-2 + d)*s) + 
        (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq*(2*psq - s)) + 
          mm^2*(2*(2 + d)*psq - d*s)) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         (-((-2 + d)*psq*(2*psq - s)) + mm^2*(2*(2 + d)*psq - d*s))))*
     \[Mu]^(8 - 2*d))/(2*Pi)^(4*d) - 
   (2^(1 - 4*d)*EL^5*gAl^3*mm^2*
     (aa*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(2*mm^2*((2 + d)*psq - s) - 
          (-2 + d)*psq*(2*psq + s)) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         (2*mm^2*((2 + d)*psq - s) - (-2 + d)*psq*(2*psq + s)) - 
        2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*((-2 + d)*mm^2*(2*(-2 + d)*psq - 
            (-4 + d)*s) - 2*s*((4 - 3*d)*psq + (-2 + d)*s))) + 
      bb*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq*(2*psq - s)) + 
           2*mm^2*((2 + d)*psq + s - d*s))) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         (-((-2 + d)*psq*(2*psq - s)) + 2*mm^2*((2 + d)*psq + s - d*s)) + 
        2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*((-2 + d)*((2 + d)*psq - 2*s)*s + 
          2*mm^2*((-2 + d)^2*psq - (6 - 6*d + d^2)*s))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(4*d) + (2^(1 - 4*d)*EL^5*gAl^3*mm^2*
     (aa*(d^2*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(2*psq - s) + 
          gZlL^2*psq*(-mm^2 + psq + s) + gZlR^2*psq*(-mm^2 + psq + s)) + 
        2^(1 + 2*d)*d*Pi^(2*d)*(gZlL^2*psq*(mm^2 - 3*psq - s) + 
          gZlR^2*psq*(mm^2 - 3*psq - s) - 2*gZlL*gZlR*(mm^2*(4*psq - 3*s) + 
            psq*s)) + 2^(3 + 2*d)*Pi^(2*d)*(gZlL^2*psq^2 + gZlR^2*psq^2 + 
          gZlL*gZlR*(2*mm^2*(psq - s) + s*(-2*psq + s)))) - 
      bb*(2^(1 + 2*d)*d*Pi^(2*d)*(gZlL^2*psq*(mm^2 - 3*psq - s) + 
          gZlR^2*psq*(mm^2 - 3*psq - s) - 2*gZlL*gZlR*(mm^2*(4*psq - 5*s) + 
            3*psq*s)) + d^2*(2*Pi)^(2*d)*(2*gZlL*gZlR*(2*mm^2*(psq - s) + 
            psq*s) + gZlL^2*(psq^2 + mm^2*(-psq + s)) + 
          gZlR^2*(psq^2 + mm^2*(-psq + s))) + 4^(1 + d)*Pi^(2*d)*
         (gZlL^2*(2*psq^2 - mm^2*s + psq*s) + gZlR^2*(2*psq^2 - mm^2*s + 
            psq*s) + 2*gZlL*gZlR*(mm^2*(2*psq - 3*s) + s*(-psq + s)))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(4*d) - 
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*mm^2*s*((-2 + d)^2*gZlL^2*(mm^2 + psq) + 
      (-2 + d)^2*gZlR^2*(mm^2 + psq) + 2*gZlL*gZlR*(-2*(8 - 7*d + d^2)*mm^2 + 
        (4 - 2*d + d^2)*psq - 2*(-2 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 4*d)*EL^5*gAl^3*mm^2*s*
     (aa*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + d*psq)) - 
        (-2 + d)*gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + d*psq) + 
        2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(2*(8 - 6*d + d^2)*mm^2 - 
          (4 - 8*d + d^2)*psq - 4*s)) + 2^(1 + 2*d)*bb*Pi^(2*d)*
       ((-2 + d)*gZlL^2*(3*mm^2 + (-4 + d)*psq) + (-2 + d)*gZlR^2*
         (3*mm^2 + (-4 + d)*psq) + gZlL*gZlR*(-2*(8 - 6*d + d^2)*mm^2 + 
          (4 - 8*d + d^2)*psq + 4*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    Pi^(4*d) - (2^(1 - 2*d)*EL^5*gAl^3*gZlL*gZlR*mm^2*s*
   ...
   (EL^5*gAl^3*s*(aa*(4^(1 + d)*(4 - 5*d + d^2)*gZlL*gZlR*mm^2*Pi^(2*d)*
         (4*psq - s) + (-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-8 + d)*mm^4 + 
          2*(-4 + d)*psq^2 + mm^2*((8 - 3*d)*psq + 2*s)) + 
        (-2 + d)*gZlR^2*(2*Pi)^(2*d)*((-8 + d)*mm^4 + 2*(-4 + d)*psq^2 + 
          mm^2*((8 - 3*d)*psq + 2*s))) + 
      bb*(-(4^(1 + d)*(4 - 5*d + d^2)*gZlL*gZlR*mm^2*Pi^(2*d)*(4*psq - s)) + 
        (-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-8 + d)*mm^4 - (-4 + d)*psq*
           (2*psq - s) + mm^2*((8 + d)*psq - (-2 + d)*s)) + 
        (-2 + d)*gZlR^2*(2*Pi)^(2*d)*((-8 + d)*mm^4 - (-4 + d)*psq*
           (2*psq - s) + mm^2*((8 + d)*psq - (-2 + d)*s))))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^5*gAl^3*mm^2*
     (-(bb*((-2 + d)^2*gZlL^2*mm^2 - 2*(4 - 6*d + d^2)*gZlL*gZlR*mm^2 + 
         (-2 + d)^2*gZlR^2*mm^2 + 2*(-2 + d)*gZlL*gZlR*((2 + d)*psq - 
           2*s))) + aa*((-2 + d)^2*gZlL^2*psq + (-2 + d)^2*gZlR^2*psq + 
        4*gZlL*gZlR*(-4*psq + 3*d*psq + 2*s - d*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^5*gAl^3*(-(aa*(-2*gZlL*gZlR*mm^2*((4 + d)*psq - 2*s) + 
         (-2 + d)*gZlL^2*psq*((-3 + d)*mm^2 + s) + (-2 + d)*gZlR^2*psq*
          ((-3 + d)*mm^2 + s))) + bb*mm^2*
       ((-2 + d)*gZlL^2*((-3 + d)*mm^2 + s) + (-2 + d)*gZlR^2*
         ((-3 + d)*mm^2 + s) + gZlL*gZlR*(-((-2 + d)^2*mm^2) + 
          (-4 - 6*d + d^2)*psq + 4*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*EL^5*gAl^3*mm^2*((-2 + d)^2*gZlL^2*(mm^2 + psq) + 
      (-2 + d)^2*gZlR^2*(mm^2 + psq) - 2*gZlL*gZlR*((4 - 6*d + d^2)*mm^2 - 
        (4 - 2*d + d^2)*psq + 2*(-2 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (2^(1 - 4*d)*EL^5*gAl^3*(aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
         ((-2 + d)^2*mm^2 - (4 - 8*d + d^2)*psq - (4 + d)*s) - 
        (-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-8 + 3*d)*mm^4 + 4*psq*s + 
          mm^2*((-8 + 3*d)*psq + 2*s)) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
    ...
    Pi^(4*d) + (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gZlL*gZlR*mm^2*
    ...
    Pi^(2*d) - (2^(1 - 4*d)*EL^5*gAl^3*
     (bb*(d^2*(2*Pi)^(2*d)*(-(gZlL^2*(mm^2 - psq)*(2*psq - s)) - 
        ...
        2^(1 + 2*d)*Pi^(2*d)*(4*gZlL*gZlR*mm^2*(-4*psq + s) + 
          ...
          gZlR^2*(2*psq*(-3*psq + s) + mm^2*(2*psq + s)))))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 4*d)*EL^5*gAl^3*
     (aa*(4^(1 + d)*Pi^(2*d)*(gZlL^2*psq*(2*psq - 3*s) + 
          gZlR^2*psq*(2*psq - 3*s) + 4*gZlL*gZlR*mm^2*(psq - s)) - 
        d^2*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(-2*psq + s) + 
          gZlL^2*psq*(mm^2 - psq + s) + gZlR^2*psq*(mm^2 - psq + s)) + 
        2^(1 + 2*d)*d*Pi^(2*d)*(2*gZlL*gZlR*mm^2*(-4*psq + 3*s) + 
          gZlL^2*psq*(mm^2 - 3*psq + 4*s) + gZlR^2*psq*(mm^2 - 3*psq + 
            4*s))) + bb*(4^(1 + d)*Pi^(2*d)*(4*gZlL*gZlR*mm^2*(-psq + s) - 
          gZlL^2*(2*psq^2 - 4*mm^2*s + psq*s) - gZlR^2*(2*psq^2 - 4*mm^2*s + 
            psq*s)) + d^2*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(-2*psq + s) + 
          gZlL^2*(-psq^2 + mm^2*(psq + s)) + gZlR^2*(-psq^2 + 
            mm^2*(psq + s))) - 2^(1 + 2*d)*d*Pi^(2*d)*
         (2*gZlL*gZlR*mm^2*(-4*psq + 3*s) + gZlL^2*(-(psq*(3*psq + s)) + 
            mm^2*(psq + 5*s)) + gZlR^2*(-(psq*(3*psq + s)) + 
            mm^2*(psq + 5*s)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q1]])/Pi^(4*d) - (4^(1 - d)*(8 - 6*d + d^2)*EL^5*gAl^3*
     (gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 + psq)*
     s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*(12 - 8*d + d^2)*EL^5*gAl^3*gZlL*gZlR*mm^2*s*
