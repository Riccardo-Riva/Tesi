...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  (((-I)*2^(2 - d)*EL^6*gAl*gAu*ggpgpA^2*
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*ggpgpA^2*(d*gZlRC*(gZuLC - gZuRC)*s + 
