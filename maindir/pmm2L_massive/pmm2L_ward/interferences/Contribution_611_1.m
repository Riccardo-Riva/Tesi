...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2*(7*psq - 4*s - 7*t) + 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(-4*bb*mm^4 + aa*psq*(2*psq - s - 2*t) + 
     aa*mm^2*(2*psq + s - 2*t) + bb*psq*(-2*psq - 3*s + 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2*(7*psq - 4*s - 7*t) + 
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(2*mm^4 + psq*(2*psq + s - 2*t) - mm^2*(3*s + 2*t)) + 
     aa*(2*mm^4 - mm^2*(4*psq + s - 2*t) + psq*(-2*psq + 3*s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(mm^4 + psq*(psq + s) + mm^2*(2*psq - s - 4*t)) + 
     bb*(mm^4 + psq*(psq - s) + mm^2*(-6*psq + s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(-3*aa*psq*s + bb*s*(psq - 2*t) + 2*aa*s*t + 
     bb*mm^2*(-6*psq + 5*s + 6*t) + aa*mm^2*(6*psq - 3*(s + 2*t)))*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*((aa + bb)*(mm^2 - psq)*s + 
     2*(aa - bb)*(mm^2 + psq)*(psq - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*((aa + bb)*(mm^2 - psq)*s + 
     (aa - bb)*(3*mm^2 + psq)*(psq - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2*(7*psq - 3*s - 7*t) + 
     psq*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(4*aa*mm^4 + bb*mm^2*(2*psq - 3*s - 2*t) + 
     bb*psq*(2*psq - s - 2*t) - aa*mm^2*(6*psq + s - 2*t) + 
     aa*psq*(-2*psq + 5*s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(-3*aa*psq*s + aa*mm^2*(6*psq - s - 6*t) + 
     2*aa*s*(s + t) + bb*mm^2*(-6*psq + 3*s + 6*t) + bb*s*(psq - 2*(s + t)))*
  ...
  (I*(aa + 3*bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(3*mm^2 - psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*(3*aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(2*mm^2 + psq - 2*s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(4*mm^2 - psq - s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(mm^2 - psq - s) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*(mm^2 - psq - s) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(2*mm^2 - psq - t) + 
    ...
    mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
     SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*aa*EL^5*gAl*gHll^2*gXll^2*mm^4*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[q1, q1]])/(4^d*Pi^(2*d)))
