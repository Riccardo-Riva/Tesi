...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^5*gAl*gHll*gHZZ*mm^4*s*(bb*((-2 + d)*gZlL^2*(mm^2 - psq) + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHZZ*mm^2*
     (aa*(-2*(2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq)*s + 
        d*psq*(4*gZlL*gZlR*mm^2 + gZlL^2*s + gZlR^2*s)) - 
      bb*mm^2*(-2*(gZlL + gZlR)^2*s + d*(4*gZlL*gZlR*psq + gZlL^2*s + 
          gZlR^2*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   ...
   (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*(d*psq - s)*
