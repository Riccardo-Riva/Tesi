...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(psq - t)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*
     ...
     mh^2*mm^4*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
   (4^(2 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(-psq + s + t)*
