...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mz], 
 ...
 (((-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(2*(-4 + d)*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-6 + d)*s^2 - 8*s*t - 
     4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-2 + d)*s^2 - 4*t^2)*
  ...
  (EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-136 + 76*d - 14*d^2 + d^3)*s^2 + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + t)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(12 - 8*d + d^2)*EL^8*gAl^4*gAu^2*
    (gZlL^2 + gZlR^2)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(6 - 5*d + d^2)*EL^8*gAl^4*
