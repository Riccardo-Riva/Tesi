...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(4*psq - s)*
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     ...
     (gZlL - gZlR)*mm^2*(mm^4 + (7 - 2*d)*psq*s - mm^2*(psq - (-3 + d)*s))*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (3*(-2 + d)*mm^2 + (18 - 4*d)*psq + 2*(-4 + d)*s)*\[Mu]^(8 - 2*d)*
