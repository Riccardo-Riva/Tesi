...
PropList[KiraPropagator[-q1, mm], KiraPropagator[q2, 0], 
 ...
 ((I*2^(1 - 2*d)*EL^5*gAl^5*mm^2*s*
   ...
   Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^5*mm^2*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^5*
    (bb*(-2*mm^4*(psq + 2*d*psq + 2*s - 3*d*s - t - 2*d*t) + 
       s*(2*psq^2 - psq*(s - 2*t) + s*(s + t)) + 
       mm^2*((-6 + 4*d)*psq^2 + s*((-3 + d)*s + (-5 + d)*t) + 
         psq*((9 - 7*d)*s + 6*t - 4*d*t))) + 
     aa*(2*mm^4*(psq + 2*d*psq - 2*s - t - 2*d*t) - 
       s*(-2*psq^2 + s*(s + t) + psq*(-3*s + 2*t)) + 
       mm^2*((6 - 4*d)*psq^2 + s*(s - d*s + 5*t - d*t) + 
         psq*(-5*s + d*s - 6*t + 4*d*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^5*
    (bb*(-2*mm^4*(psq + 2*d*psq + s - 2*d*s - t - 2*d*t) + 
       s*(-2*psq^2 + 3*psq*s + 2*psq*t + s*t) + 
       mm^2*((-6 + 4*d)*psq^2 + s*(-4*s + (-5 + d)*t) + 
         psq*((11 - 5*d)*s + 6*t - 4*d*t))) + 
     aa*(2*mm^4*(psq + 2*d*psq + (-3 + d)*s - (1 + 2*d)*t) - 
       s*(-6*psq^2 + s*t + psq*(s + 2*t)) - 
       mm^2*((-6 + 4*d)*psq^2 + s*(-2*s + (-5 + d)*t) + 
         psq*((7 + d)*s + 6*t - 4*d*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^5*mm^2*(mm^2 - psq)*
    s*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^5*s*(bb*(-2*psq^2 + s*(mm^2 - s - 2*t) + 
       2*psq*(s + t)) + aa*(2*psq^2 - 2*psq*(2*s + t) + s*(mm^2 + s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^5*s*
    (-(bb*(2*(-2 + d)*mm^4 + 2*psq^2 - 2*psq*(s + t) + s*(s + 2*t) + 
        mm^2*(-4*(-2 + d)*psq + (-3 + d)*s + 2*(-2 + d)*t))) + 
     aa*(-2*(-2 + d)*mm^4 + 2*psq^2 - 2*psq*(2*s + t) + s*(s + 2*t) + 
       mm^2*((-1 + d)*s + 2*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^5*s*
    (bb*((-4 + d)*mm^4 + mm^2*((10 - 3*d)*psq + 2*(-3 + d)*t) + 
       2*psq*((-5 + d)*psq + s + 5*t - d*t)) + 
     aa*((-4 + d)*mm^4 + 2*psq*(-((-5 + d)*psq) + (-4 + d)*s + (-5 + d)*t) + 
       mm^2*((-2 + d)*psq - 2*(-3 + d)*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^5*(mm^2 - psq)*s*
    (aa*(-2 + d)*mm^2 + bb*(-2 + d)*mm^2 - 2*aa*psq + 2*bb*(psq - s - t) + 
     2*aa*t)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^5*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*4^(1 - d)*(-2 + d)*EL^5*gAl^5*mm^2*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
     bb*(6*mm^2 - 14*psq + 5*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(2*mm^4 + 2*(4*psq - s)*s - 
       mm^2*(2*psq + 7*s)) + bb*(6*mm^4 + mm^2*(-14*psq + 3*s) + 
       2*(4*psq^2 - 2*psq*s + s^2)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*
    (bb*(6*(-1 + d)*mm^4 + 2*(4*psq^2 - 2*psq*s + s^2) + 
       mm^2*((6 - 10*d)*psq + 3*(-1 + d)*s + 4*(-2 + d)*t)) + 
     aa*(2*(-1 + d)*mm^4 + 2*(4*psq - s)*s + 
       mm^2*(2*(-3 + d)*psq - s - 3*d*s + 8*t - 4*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*(-2 + d)*EL^5*gAl^5*mm^2*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
     bb*(2*mm^2 - 10*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(2*mm^4 + 2*(4*psq - s)*s - 
       mm^2*(2*psq + 7*s)) + aa*(6*mm^4 + mm^2*(-14*psq + 3*s) + 
       2*(4*psq^2 - 2*psq*s + s^2)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(2*(-1 + d)*mm^4 + 2*(4*psq - s)*s + 
       mm^2*((10 - 6*d)*psq + (-9 + d)*s + 4*(-2 + d)*t)) + 
     aa*(6*(-1 + d)*mm^4 + 2*(4*psq^2 - 2*psq*s + s^2) - 
       mm^2*(2*(5 + d)*psq + (-5 + d)*s + 4*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(-4*psq^2 + 4*mm^2*s + 4*psq*(s + t) - 
       3*s*(s + 2*t)) + aa*(4*psq^2 - 4*psq*(3*s + t) + 
       s*(4*mm^2 + 3*s + 6*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^5*
    (bb*(4*psq^2 - 4*psq*(s + t) + 3*s*(s + 2*t) + 
       mm^2*(-4*(-2 + d)*psq + 2*(-4 + d)*s + 4*(-2 + d)*t)) + 
     aa*(-4*psq^2 + 4*psq*(3*s + t) - 3*s*(s + 2*t) + 
       mm^2*(4*(-2 + d)*psq + 8*t - 2*d*(s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^5*(-2*bb*mm^2*(4*(-2 + d)*psq + (8 - 3*d)*s - 
       4*(-2 + d)*t) + bb*(-4 + d)*(8*psq^2 - 8*psq*(s + t) + s*(s + 2*t)) - 
     aa*(-4 + d)*(8*psq^2 - 4*psq*(s + 2*t) + s*(s + 2*t)) + 
     2*aa*mm^2*(4*(-2 + d)*psq + 8*t - d*(s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^5*(aa*(-8*(-5 + d)*psq^2 + 4*(-4 + d)*psq*s + 
       8*(-5 + d)*psq*t - (-6 + d)*s*(s + 2*t) + 
       mm^2*(8*(-3 + d)*psq - 2*(2 + d)*s - 8*(-3 + d)*t)) + 
     bb*(8*(-5 + d)*psq^2 + (-6 + d)*s*(s + 2*t) - 
       8*psq*((-6 + d)*s + (-5 + d)*t) + mm^2*(-8*(-3 + d)*psq + 
         (-28 + 6*d)*s + 8*(-3 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(-4*psq^2 + 2*mm^2*(2*psq + s - 2*t) + 
       4*psq*t - s*(s + 2*t)) + bb*(4*psq^2 - 4*psq*(2*s + t) + s*(s + 2*t) + 
       mm^2*(-4*psq + 6*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-2 + d)*EL^5*gAl^5*mm^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(-2*psq^2 + mm^2*(4*psq - 3*s - 4*t) + 
       2*psq*(-s + t) + 2*s*(s + 2*t)) + 
     bb*(4*mm^4 + 6*psq^2 + 2*psq*(s - t) - 2*s*(s + 2*t) + 
       mm^2*(-12*psq + 3*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(-2*psq^2 + (-1 + d)*mm^2*(4*psq - 3*s - 4*t) + 
       2*psq*(-s + t) + 2*s*(s + 2*t)) + bb*(4*(-1 + d)*mm^4 + 6*psq^2 + 
       2*psq*(s - t) - 2*s*(s + 2*t) + mm^2*((4 - 8*d)*psq + 
         (-1 + d)*(3*s + 4*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-2 + d)*EL^5*gAl^5*mm^2*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
     bb*(2*mm^2 - 8*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(bb*(mm^4 + psq^2 - mm^2*(3*psq + s - 2*t) + 
       psq*(4*s - t) - 2*s*(s + t)) + 
     aa*(mm^4 + psq^2 + mm^2*(-psq + s - 2*t) + psq*(-4*s + t) + 
       2*s*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/
   Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^5*
    (bb*((-1 + d)*mm^4 + psq^2 + psq*(4*s - t) - 2*s*(s + t) + 
       mm^2*(-3*(-1 + d)*psq + (-3 + d)*s + 2*(-1 + d)*t)) + 
     aa*((-1 + d)*mm^4 + psq^2 + psq*(-4*s + t) + 2*s*(s + t) + 
       mm^2*((-3 + d)*psq + 3*s - d*s + 2*t - 2*d*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(2*psq^2 + psq*s - 2*psq*t + s*t + 
       mm^2*(-2*(-2 + d)*psq + (-5 + d)*s + 2*(-2 + d)*t)) + 
     aa*(-2*psq^2 + 3*psq*s + 2*psq*t - s*t + 
       mm^2*(2*(-2 + d)*psq + s - d*s + 4*t - 2*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^5*(4*aa*mm^2*((-2 + d)*psq - s - (-2 + d)*t) + 
     bb*mm^2*(-4*(-2 + d)*psq + (-20 + 6*d)*s + 4*(-2 + d)*t) + 
     bb*(-4 + d)*(4*psq^2 - 9*psq*s + 2*s^2 - 4*psq*t + 3*s*t) - 
     aa*(-4 + d)*(4*psq^2 - 3*psq*s + 2*s^2 - 4*psq*t + 3*s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^5*(bb*(4*(-5 + d)*psq^2 + (50 - 9*d)*psq*s - 
       4*(-5 + d)*psq*t + (-6 + d)*s*(2*s + 3*t) - 
       2*mm^2*(2*(-3 + d)*psq + 14*s - 3*d*s + 6*t - 2*d*t)) + 
     aa*(-4*(-5 + d)*psq^2 + 3*(-6 + d)*psq*s + 4*(-5 + d)*psq*t - 
       (-6 + d)*s*(2*s + 3*t) + 4*mm^2*((-3 + d)*psq - s + 3*t - d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(-2*psq^2 + 3*psq*s - 2*s^2 + 
       2*mm^2*(psq - t) + 2*psq*t - 3*s*t) + 
     bb*(2*psq^2 - 7*psq*s + 2*s^2 - 2*psq*t + 3*s*t + 
       mm^2*(-2*psq + 4*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(mm^2 - 2*s)*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(2*mm^2 + 2*psq - 7*s)*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(mm^4 - psq^2 + mm^2*(psq - 3*s - 2*t) + 
       2*s*t + psq*(s + t)) + bb*(mm^4 + 3*psq^2 - 2*s*t - psq*(s + t) + 
       mm^2*(-5*psq + 3*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(mm^2 - 2*s)*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(2*mm^4 - 6*psq^2 + 19*psq*s - 5*s^2 + 
       2*psq*t - 7*s*t + mm^2*(-9*s + 2*t)) + 
     aa*(2*mm^4 + 2*psq^2 - 5*psq*s + 5*s^2 - 2*psq*t + 7*s*t - 
       mm^2*(5*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^5*(-2*psq^2 - psq*(s - 2*t) + 
     2*mm^2*(psq - t) + s*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*s*(5*psq - 3*s - 5*t) + 
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^5*s*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^5*(aa*(-2*psq^2 + 2*mm^2*(psq - t) - 3*s*(s + t) + 
       psq*(3*s + 2*t)) + bb*(2*psq^2 + 3*s*(s + t) + 
       mm^2*(-2*psq + 8*s + 2*t) - psq*(11*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^5*((-2 + d)*mm^2 - 2*psq + 3*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*((-1 + d)*mm^4 - psq^2 + psq*s + psq*t + 
       2*s*t + mm^2*((-1 + d)*psq - (1 + d)*s - 2*(-1 + d)*t)) + 
     bb*((-1 + d)*mm^4 + 3*psq^2 - 2*s*t - psq*(s + t) + 
       mm^2*(psq - 3*d*psq + s + d*s - 2*t + 2*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(2*mm^4 - 2*psq^2 + 3*psq*s + 2*s^2 + 
       mm^2*(4*psq - 11*s - 2*t) - 2*psq*t + 7*s*t) + 
     bb*(2*mm^4 - 2*psq^2 + 11*psq*s - 2*s^2 + 2*psq*t - 7*s*t + 
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*(2*psq^2 - 13*psq*s + 6*s^2 + 
     mm^2*(4*psq - s - 4*t) - 2*psq*t + 11*s*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(-4*psq^2 + 9*psq*s - 4*s^2 + 
       (-2 + d)*mm^2*(2*psq - s - 2*t) + 4*psq*t - 7*s*t) + 
     bb*(4*psq^2 - 11*psq*s + 4*s^2 - 4*psq*t + 7*s*t + 
       mm^2*(4*psq - 2*d*psq + d*s - 4*t + 2*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^5*(4*aa*mm^2*((-2 + d)*psq - s - (-2 + d)*t) + 
     bb*mm^2*(-4*(-2 + d)*psq + (-20 + 6*d)*s + 4*(-2 + d)*t) - 
     aa*(-4 + d)*(4*psq^2 + s*(s + t) - psq*(s + 4*t)) + 
     bb*(-4 + d)*(4*psq^2 + s*(s + t) - psq*(7*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^5*(bb*(4*(-5 + d)*psq^2 + (26 - 7*d)*psq*s - 
       4*(-5 + d)*psq*t + (-2 + d)*s*(s + t) - 
       2*mm^2*(2*(-3 + d)*psq + 10*s - 3*d*s + 6*t - 2*d*t)) + 
     aa*(-4*(-5 + d)*psq^2 + (-2 + d)*psq*s + 4*(-5 + d)*psq*t - 
       (-2 + d)*s*(s + t) + 4*mm^2*((-3 + d)*psq - s + 3*t - d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^5*(-2*psq^2 - psq*(s - 2*t) + 
     2*mm^2*(psq - t) + s*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-2 + d)*EL^5*gAl^5*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/
   Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^5*(4*aa*mm^4 + 
  ...
  (I*4^(1 - d)*EL^5*gAl^5*(4*aa*(-1 + d)*mm^4 - bb*(-1 + d)*mm^2*
      (4*psq - s - 4*t) + 2*bb*(psq^2 + psq*(2*s - t) - s*(s + 2*t)) + 
     2*aa*(psq^2 + psq*(-2*s + t) + s*(s + 2*t)) + 
     aa*mm^2*(-4*psq - (-1 + d)*(s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(-2*psq^2 - s*(-mm^2 + s + t) + 
       psq*(s + 2*t)) + aa*(2*psq^2 + s*(3*mm^2 + s + t) - psq*(5*s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(-2*psq^2 - s*(s + t) + psq*(s + 2*t) + 
       mm^2*(2*(-2 + d)*psq + 3*s - d*s + 4*t - 2*d*t)) + 
     aa*(2*psq^2 + s*(s + t) - psq*(5*s + 2*t) + 
       mm^2*(-2*(-2 + d)*psq + s + d*s - 4*t + 2*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^5*(2*aa*mm^2*(2*(-2 + d)*psq + (-6 + d)*s - 
       2*(-2 + d)*t) - 4*bb*mm^2*((-2 + d)*psq - (-3 + d)*s - (-2 + d)*t) + 
     bb*(-4 + d)*(4*psq^2 - 7*psq*s + s^2 - 4*psq*t + 3*s*t) - 
     aa*(-4 + d)*(4*psq^2 + s*(s + 3*t) - psq*(s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^5*(aa*(-4*(-5 + d)*psq^2 + (-6 + d)*psq*s + 
       4*(-5 + d)*psq*t - (-6 + d)*s*(s + 3*t) + 
       2*mm^2*(2*(-3 + d)*psq + (-8 + d)*s - 2*(-3 + d)*t)) + 
     bb*(4*(-5 + d)*psq^2 + (38 - 7*d)*psq*s - 4*(-5 + d)*psq*t + 
       (-6 + d)*s*(s + 3*t) - 4*mm^2*((-3 + d)*psq + 4*s - d*s + 3*t - d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(2*psq^2 - 5*psq*s + s^2 - 2*psq*t + 3*s*t + 
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^5*(mm^2 - 2*s)*(aa*(2*mm^2 - psq - t) + 
   ...
   Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl^5*(2*mm^2 + 2*psq - 7*s)*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^5*(-2*psq^2 + 2*mm^2*(psq - s - t) + 
     s*t + psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3]])/
   Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^5*(bb*s*(5*psq - 2*s - 5*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^5*(-2*psq^2 + 2*mm^2*(psq - s - t) + 
     s*t + psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/
   Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*(2*psq^2 - 11*psq*s + 5*s^2 + 
     mm^2*(4*psq - 3*s - 4*t) - 2*psq*t + 11*s*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(4*psq^2 - 9*psq*s + 3*s^2 - 
       (-2 + d)*mm^2*(2*psq - s - 2*t) - 4*psq*t + 7*s*t) + 
     aa*(-4*psq^2 + 7*psq*s - 3*s^2 + 4*psq*t - 7*s*t + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^5*(aa*(4*(-5 + d)*psq^2 + (-2 + d)*psq*s - 
       4*(-5 + d)*psq*t + (-2 + d)*s*t - 2*mm^2*(2*(-3 + d)*psq + 
         (-4 + d)*s - 2*(-3 + d)*t)) + 
     bb*(-4*(-5 + d)*psq^2 + (-22 + 5*d)*psq*s + 4*(-5 + d)*psq*t - 
       (-2 + d)*s*t + 4*mm^2*((-3 + d)*psq + 4*s - d*s + 3*t - d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^5*(-2*psq^2 + 2*mm^2*(psq - s - t) + 
     s*t + psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^5*s*(-2*psq + s + 2*t)*
  ...
  ((3*I)*4^(1 - d)*(aa - bb)*EL^5*gAl^5*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^5*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl^5*s*(2*(aa + bb)*(mm^2 - psq) - 
     (aa - bb)*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^5*s*
    (aa*(2*(-4 + d)*mm^2 + 4*psq - (-2 + d)*(s + 2*t)) + 
     bb*(2*(-4 + d)*mm^2 - 4*(-3 + d)*psq + (-2 + d)*(s + 2*t)))*
  ...
  (I*4^(2 - d)*EL^5*gAl^5*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*4^(2 - d)*EL^5*gAl^5*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(2 - d)*EL^5*gAl^5*(aa*(4*mm^2 - 5*psq + 2*s + t) - 
     bb*(2*mm^2 - 3*psq + 2*s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*4^(2 - d)*EL^5*gAl^5*(aa*(4*mm^2 - 5*psq + 2*s + t) - 
     bb*(2*mm^2 - 3*psq + 2*s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(-(bb*(6*mm^2 - 6*psq + s)) + 
     aa*(-2*mm^2 + 2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^5*
    (-(bb*(6*mm^2 - 6*psq + s)) + aa*(-2*mm^2 + 2*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p3, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-4 + d)*EL^5*gAl^5*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
     bb*(6*mm^2 - 14*psq + 5*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-6 + d)*EL^5*gAl^5*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
     bb*(6*mm^2 - 14*psq + 5*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
     bb*(6*mm^2 - 14*psq + 5*s + 8*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(2 - d)*EL^5*gAl^5*(aa*(2*mm^2 - psq + s - t) + 
  ...
  (I*2^(5 - 2*d)*EL^5*gAl^5*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(2*mm^2 + 8*psq - 7*s - 10*t) + 
  ...
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*(2*mm^2 - 14*psq + 7*s + 12*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*4^(2 - d)*EL^5*gAl^5*(aa*(5*psq - 3*s - 5*t) + 
  ...
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(2*(-6 + d)*mm^2 + 2*(-2 + d)*psq + 10*s - 
       3*d*s + 16*t - 4*d*t) + bb*((-20 + 6*d)*mm^2 + (36 - 10*d)*psq - 
       10*s + 3*d*s - 16*t + 4*d*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^5*(-(aa*(6*mm^2 - 6*psq + s)) + 
     bb*(-2*mm^2 + 2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^5*
    (-(aa*(6*mm^2 - 6*psq + s)) + bb*(-2*mm^2 + 2*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p3, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-4 + d)*EL^5*gAl^5*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
     bb*(2*mm^2 - 10*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*(-6 + d)*EL^5*gAl^5*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
     bb*(2*mm^2 - 10*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
     bb*(2*mm^2 - 10*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(5 - 2*d)*EL^5*gAl^5*(aa*(2*mm^2 + psq - s - 3*t) + 
  ...
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*(2*mm^2 + 10*psq - 5*s - 12*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*4^(2 - d)*EL^5*gAl^5*(aa*(2*mm^2 + 3*psq - 2*s - 5*t) + 
     bb*(-5*psq + 2*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*(-4 + d)*EL^5*gAl^5*
    (aa*(6*mm^2 - 2*psq - s - 4*t) + bb*(2*mm^2 - 6*psq + s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*((-20 + 6*d)*mm^2 + 4*psq - 2*d*psq + 6*s - 
       d*s + 16*t - 4*d*t) + bb*(2*(-6 + d)*mm^2 + 28*psq - 6*d*psq - 6*s + 
       d*s - 16*t + 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) - ((3*I)*4^(2 - d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) - ((3*I)*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
  ...
  (I*4^(1 - d)*(-4 + d)*EL^5*gAl^5*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*(-6 + d)*EL^5*gAl^5*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(5*psq - 4*s - 5*t) + 
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (I*4^(2 - d)*EL^5*gAl^5*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
  ...
  (I*4^(1 - d)*(-4 + d)*EL^5*gAl^5*(aa*(4*psq - 3*s - 4*t) + 
     bb*(4*mm^2 - 8*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(4*(-5 + d)*psq + (14 - 3*d)*s - 
       4*(-5 + d)*t) + bb*(4*(-4 + d)*mm^2 + (36 - 8*d)*psq - 14*s + 3*d*s - 
       20*t + 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q2, q2]])/Pi^(2*d) + (I*4^(2 - d)*EL^5*gAl^5*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(2 - d)*EL^5*gAl^5*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
  ...
  (I*4^(1 - d)*(-4 + d)*EL^5*gAl^5*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
     bb*(2*mm^2 - 8*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*(-6 + d)*EL^5*gAl^5*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
     bb*(2*mm^2 - 8*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
     bb*(2*mm^2 - 8*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(4*mm^2 + psq - 2*s - 5*t) + 
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(3*mm^2 - s - 3*t) + 
  ...
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-4 + d)*EL^5*gAl^5*
    (aa*(mm^2 + psq - s - 2*t) + bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*((-2 + d)*mm^2 + (-8 + d)*psq + 6*s - d*s + 
       10*t - 2*d*t) + bb*((-6 + d)*mm^2 + (16 - 3*d)*psq - 6*s + d*s - 
       10*t + 2*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*
    (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], 
     SP[p3, q2]])/Pi^(2*d) + (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + ((3*I)*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) + (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) + ((3*I)*4^(1 - d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^5*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*(mm^2 + 2*psq - 2*s - 3*t) + 
  ...
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
     bb*(6*mm^2 - 10*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(3 - 2*d)*(-4 + d)*EL^5*gAl^5*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*((-6 + d)*mm^2 + (-4 + d)*psq + 4*s - d*s + 
       10*t - 2*d*t) + bb*((-2 + d)*mm^2 - 3*(-4 + d)*psq - 4*s + d*s - 
       10*t + 2*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*(mm^2 - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^5*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*4^(1 - d)*(aa - bb)*EL^5*gAl^5*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*(-4 + d)*EL^5*gAl^5*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(-6 + d)*EL^5*gAl^5*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^5*(bb*(5*psq - s - 5*t) + 
     aa*(-6*mm^2 + psq + s + 5*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gAl^5*(bb*(-4*(-5 + d)*psq + (-6 + d)*s + 4*(-5 + d)*t) + 
     aa*(4*(-4 + d)*mm^2 - 4*psq + 6*s - d*s + 20*t - 4*d*t))*\[Mu]^(8 - 2*d)*
