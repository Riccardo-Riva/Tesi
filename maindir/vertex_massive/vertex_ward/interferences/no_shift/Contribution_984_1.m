...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*d*EL^5*gAl^5*mm^2*s*
   ...
   (4^(1 - d)*d*EL^5*gAl^5*mm^2*(aa*(d*mm^2*(6*psq - 2*s) + d*(5*psq - s)*s + 
        2*s*(-3*psq + s)) - bb*(d*(psq - s)*s + 2*s*(-4*mm^2 + psq + s) + 
        2*d*mm^2*(3*psq + s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(-2 + d)*EL^5*gAl^5*mm^2*
     (aa*(d*mm^2*(2*psq - s) + d*(3*psq - s)*s + 2*s*(-psq + s)) - 
      bb*(d*(psq - s)*s + 2*s*(-2*mm^2 + psq + s) + d*mm^2*(2*psq + s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*d*EL^5*gAl^5*mm^2*s*((-8 + 3*d)*mm^2 + 
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^5*s*
     ...
     SPList[SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*d*EL^5*gAl^5*mm^2*
     (aa*(-4*(-1 + d)*psq + (-2 + d)*s) + bb*(2*(-2 + d)*mm^2 + 2*d*psq + 
        2*s - d*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^5*mm^2*
   ...
   (4^(1 - d)*(aa - bb)*d*EL^5*gAl^5*mm^2*(2*d*psq + 2*s - d*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^5*gAl^5*(2*bb*(-3*mm^2 + psq)*s + 
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gAl^5*(4*bb*mm^2*s - 2*aa*psq*s - 2*bb*psq*s + 
