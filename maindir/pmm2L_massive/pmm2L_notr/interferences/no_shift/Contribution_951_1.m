...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (4^(1 - d)*EL^8*gAl^4*gAu^2*(2*gZlL*gZlR*(2*(12 - 6*d + d^2)*mm^4*s - 
         (-4 + d)*s*(4*psq^2 + (16 - 9*d + d^2)*psq*s + (-2 + d)*s^2 - 
           8*psq*t + 4*s*t + 4*t^2) + mm^2*(4*(-4 + d)*psq^2 - 
           (-6 + d)*(-2 + d)^2*s^2 + 4*(-4 + d)*s*t + 4*(-4 + d)*t^2 - 
    ...
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*
     ...
     (mz^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*
      (2*gZlL*gZlR*(-2*(8 - 6*d + d^2)*psq^2 + mm^2*(2*(8 - 7*d + d^2)*psq + 
           (-44 + 46*d - 12*d^2 + d^3)*s - 2*(8 - 7*d + d^2)*t) + 
         2*psq*((10 - 6*d + d^2)*s + 2*(8 - 6*d + d^2)*t) - 
         (-4 + d)*(2*(-3 + d)*s^2 + (-8 + 3*d)*s*t + 2*(-2 + d)*t^2)) + 
       gZlL^2*(mm^2*(-2*(4 - 3*d + d^2)*psq - (-64 + 50*d - 14*d^2 + d^3)*s + 
    ...
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*
     ...
     (mz^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*
      (-2*gZlL*gZlR*(2*(8 - 6*d + d^2)*psq^2 + mm^2*(2*(8 - 7*d + d^2)*psq - 
           (-28 + 32*d - 10*d^2 + d^3)*s - 2*(8 - 7*d + d^2)*t) - 
