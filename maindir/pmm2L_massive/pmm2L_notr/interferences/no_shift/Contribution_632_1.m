...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*
   ...
   (2^(5 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*(4*mm^2 - 4*psq + s)*
   ...
   (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*
     ...
     gHll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2*(18*psq + (-20 + d)*s - 18*t) + 
      psq*(-2*psq - (-4 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*(-2*psq + d*s + 2*t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*
   ...
   (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*(6*psq + d*s - 6*t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (3*2^(5 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
     ...
     gHll^2*(gZlL^2 + gZlR^2)*mm^2*(-2*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     gHll^2*(gZlL^2 + gZlR^2)*mm^2*(2*psq + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
