...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   (((-I)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*(4*psq - s)*s*
    ...
    (I*EL^5*gFll^2*gWWA*gXFW^2*mm^2*(4*psq - s)*s*(aa*(psq - t) + 
       bb*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*(4*psq - s)*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*s*(bb*(psq - s - t) + 
       ...
       SP[p1, q1]])/Pi^(2*d) - (I*EL^5*gFll^2*gWWA*gXFW^2*mm^2*(8*psq - 3*s)*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*EL^5*gFll^2*gWWA*gXFW^2*mm^2*(8*psq - 3*s)*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gFll^2*gWWA*gXFW^2*
    ...
    (I*4^(1 - d)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*s*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) - (I*EL^5*gFll^2*gWWA*gXFW^2*mm^2*s*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) + 
    (I*EL^5*gFll^2*gWWA*gXFW^2*mm^2*(8*psq - 3*s)*(aa*(psq - t) + 
       bb*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/(2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*
    ...
    (I*4^(1 - d)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*s*(bb*(2*mm^2 - psq - t) + 
     ...
     Pi^(2*d) + (I*(aa - bb)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
     (2*Pi)^(2*d) + (I*4^(1 - d)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*EL^5*gFll^2*gWWA*gXFW^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      gXFW^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
