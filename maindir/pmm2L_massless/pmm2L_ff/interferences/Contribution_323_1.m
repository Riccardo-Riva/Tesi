...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^6*t*(s + t)*
      \[Mu]^(8 - 2*d))/Pi^(2*d)) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*
     mh^2*mm^6*(s^2 - s*t - 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^6*
     (s - 2*t)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*t*(s + t)*
     (mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^6*(s - 2*t)*
