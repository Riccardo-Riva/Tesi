...
PropList[KiraPropagator[p1 + q1, mw], KiraPropagator[q2, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*s^2*
  ...
  (4^(1 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(aa*mm^2 - bb*psq)*s*
  ...
  (4^(1 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
    (aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(aa*(11 - 7*d)*mm^2 + 
     bb*(-8 + 5*d)*mm^2 + aa*(8 - 5*d)*psq + bb*(-11 + 7*d)*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(aa*mm^2 - bb*psq)*s*
  ...
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(-9*bb*(-2 + d)*mm^2 + 
  ...
  (2^(1 - 2*d)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
    (-2*bb*(psq^2 + mm^2*(psq - s)) + 2*aa*psq*(mm^2 + psq - s) + 
     ...
     SP[q1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
  ...
  (4^(1 - d)*(-8 + 5*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(aa*mm^2 - bb*psq)*
  ...
  (4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*(8 - 5*d)*mm^2 + 
  ...
  (4^(1 - d)*(-2 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(2*aa*(2 + d)*mm^2 - 
     bb*(-2 + 3*d)*mm^2 - 2*bb*(2 + d)*psq + aa*(-2 + 3*d)*psq)*
