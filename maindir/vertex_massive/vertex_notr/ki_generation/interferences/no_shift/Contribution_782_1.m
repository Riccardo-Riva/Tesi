...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAl^4*gHll^2*mm^4*((-1 + d)*psq*s + 
        mm^2*(4*psq + (-3 + 2*d)*s))*\[Mu]^(8 - 2*d))/(mh^2*Pi^(2*d))) + 
    (4^(2 - d)*EL^6*gAl^4*gHll^2*mm^4*(2*(-1 + d)*mm^2 - (-2 + d)*psq)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mh^2*Pi^(2*d)) + 
    (2^(5 - 2*d)*EL^6*gAl^4*gHll^2*mm^4*((-3 + 2*d)*mm^2 - (-3 + d)*psq)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(mh^2*Pi^(2*d)) - 
    (2^(5 - 2*d)*EL^6*gAl^4*gHll^2*mm^4*psq*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/(mh^2*Pi^(2*d)) + 
    (2^(5 - 2*d)*EL^6*gAl^4*gHll^2*mm^4*(2*mm^2 + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/(mh^2*Pi^(2*d)) + 
    (2^(3 - 2*d)*EL^6*gAl^4*gHll^2*mm^4*(4*mm^2 + (-4 + 3*d)*s)*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(mh^2*Pi^(2*d)) + 
    (2^(5 - 2*d)*EL^6*gAl^4*gHll^2*mm^4*(2*mm^2 - 2*psq + d*s)*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(mh^2*Pi^(2*d)) - 
    (2^(5 - 2*d)*EL^6*gAl^4*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1]])/(mh^2*Pi^(2*d)*s) - 
    (4^(3 - d)*EL^6*gAl^4*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    ...
    (2^(5 - 2*d)*(-4 + d)*EL^6*gAl^4*gHll^2*mm^4*\[Mu]^(8 - 2*d)*
