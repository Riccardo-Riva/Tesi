  ...
  (((-I)*EL^5*gAl^2*gFFA*gFll^2*mm^4*psq*s*(aa*(mm^2 + psq - s - 2*t) + 
   ...
   (I*EL^5*gAl^2*gFFA*gFll^2*mm^4*
     (aa*(mm^2*(3*psq - s - 3*t) + 3*(psq + s)*(psq - s - t)) + 
      bb*(-3*psq^2 + 3*s*(s + t) + 3*mm^2*(-psq + s + t) + psq*(-2*s + 3*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
   (I*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*bb*psq^2*s + 
      bb*mm^2*psq*(3*psq - 4*s - 3*t) + aa*mm^4*(psq - t) + 
   ...
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(3*psq^2 + 3*mm^2*(psq - s - t) - 
      3*psq*t - s*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
    (2*Pi)^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*bb*EL^5*gAl^2*gFFA*gFll^2*mm^2*(mm^2 - psq)*psq*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^4*(aa*(psq - t) + 
      bb*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
     (3*bb*psq*s + bb*mm^2*(5*psq - 6*s - 5*t) + 
      aa*mm^2*(-5*psq + 3*s + 5*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
     ...
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q2, q2]])/Pi^(2*d) + ((3*I)*4^(1 - d)*bb*EL^5*gAl^2*gFFA*gFll^2*mm^2*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
      SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
     mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
