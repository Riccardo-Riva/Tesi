...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq^2 - 2*psq*t + t*(s + t))*
      ...
      (4*(-1 + d)*psq^3 - mm^2*(8*psq + (-4 + d)*s - 8*t)*(psq - s - t) - 
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
      (-4*psq^2 + 4*mm^2*(psq - t) + (-2 + d)*s*(s + 2*t) + 
       ...
       SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*
      gXll^2*mm^2*(2*psq^3 + 2*psq^2*(s - 3*t) + mm^4*(psq - t) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)*
      (-2*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*
      gXll^2*mm^2*(psq - t)*(2*psq^2 + mm^2*(psq - t) - 4*psq*t + 
       t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
      (2*(-4 + d)*psq^2 + (-2 + d)*s^2 + 2*(-2 + d)*s*t + 2*(-4 + d)*t^2 - 
       2*psq*((-2 + d)*s + 2*(-4 + d)*t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^2*(-(psq*s) + 
       ...
       SP[q2, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
    ...
    (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(4*psq^2 - 3*psq*s + s^2 - 
       7*psq*t + 2*s*t + 3*t^2 + mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
