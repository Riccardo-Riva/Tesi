...
PropList[KiraPropagator[-q1, mw], KiraPropagator[p1 - q2, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHFW^2*mm^2*s*(bb*psq*(2*mm^2 + 2*psq + s) - 
     aa*(2*psq^2 + mm^2*(2*psq + s)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   Pi^(2*d) - (2^(1 - 2*d)*EL^5*gFFA*gFll^2*gHFW^2*mm^2*s*
  ...
  (2^(1 - 2*d)*EL^5*gFFA*gFll^2*gHFW^2*mm^2*(-(bb*psq*(mm^2 + psq + s)) + 
     aa*(psq^2 + mm^2*(psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (2^(3 - 2*d)*EL^5*gFFA*gFll^2*gHFW^2*mm^2*(-(bb*psq*(mm^2 + psq + s)) + 
     aa*(psq^2 + mm^2*(psq + s)))*\[Mu]^(8 - 2*d)*
