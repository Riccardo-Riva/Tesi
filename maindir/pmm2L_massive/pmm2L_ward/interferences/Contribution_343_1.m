...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 (((-I)*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
    (mm^2 + s)*(aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (3*aa*mm^2*(2*psq + s - 2*t) + bb*s*(s + 2*t) - aa*s*(-4*psq + s + 2*t) + 
     bb*mm^2*(-6*psq + 9*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(aa*mm^2*(3*psq + 2*s - 3*t) + aa*s*(-psq - 2*s + t) - 
     bb*s*(-3*psq + 2*s + t) + bb*mm^2*(-3*psq + 6*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(mm^4*(psq + 2*s - t) - mm^2*(psq + s)*
        (psq + 2*s - t) + s*(4*psq^2 - 4*psq*t + s*(s + t))) - 
     bb*(mm^4*(psq - 4*s - t) + mm^2*(-psq^2 + psq*(-3*s + t) + 
         s*(3*s + t)) + s*(10*psq^2 + s*(s + t) - psq*(5*s + 4*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (aa*(mm^2*(3*psq + s - 3*t) - s*(psq + s - t)) - 
     bb*(mm^2*(3*psq - 5*s - 3*t) + s*(-3*psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(bb*s*(psq - 3*s - t) + 
     3*aa*mm^2*(psq + s - t) + aa*s*(psq - s + t) + 
     bb*mm^2*(-3*psq + 5*s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(mm^4*(psq - 3*s - t) - mm^2*(psq + s)*(psq - 3*s - t) + 
       s*(4*psq^2 - 6*psq*s - 4*psq*t + s*t)) + 
     aa*(mm^4*(-psq - 3*s + t) + mm^2*(psq^2 + s*(2*s - t) - psq*(2*s + t)) + 
       s*(2*psq^2 - s*t + psq*(s + 4*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(aa*mm^2*(3*psq + 2*s - 3*t) + 
     bb*s*(psq - 2*s - t) + aa*s*(psq + t) + bb*mm^2*(-3*psq + 4*s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
    (bb*(2*mm^4 - 3*psq^2 + 3*psq*(2*s + t) - mm^2*(psq + 3*s + t) - 
       s*(s + 2*t)) + aa*(2*mm^4 + 3*psq^2 + mm^2*(-3*psq - 2*s + t) + 
       s*(s + 2*t) - psq*(s + 3*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*s*(bb*(mm^2 + 2*psq - 3*s - 2*t) + 
     aa*(mm^2 - 2*psq - s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
    ...
    (gZlL - gZlR)*mm^2*s*(bb*(mm^4 + psq*(3*psq - s - 3*t) - mm^2*(s + t)) + 
     aa*(mm^4 + mm^2*(-2*psq + t) + psq*(-3*psq + 2*s + 3*t)))*
  ...
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(bb*(6*mm^2 + 8*psq - s - 2*t) + aa*(2*mm^2 + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(-5*mm^4 + psq*(18*psq - 7*s - 6*t) + mm^2*(-9*psq + 9*s + 2*t)) + 
     aa*(mm^4 + mm^2*(psq - 7*s - 2*t) + psq*(-6*psq + 5*s + 6*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (bb*(6*mm^2 + 8*psq - s - 2*t) + aa*(2*mm^2 + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (bb*(2*mm^2 + 4*psq - s - 2*t) + aa*(6*mm^2 + 4*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(5*mm^4 + psq*(-6*psq + s - 6*t) + mm^2*(5*psq - 7*s + 2*t)) + 
     bb*(-mm^4 + mm^2*(3*psq + 5*s - 2*t) + psq*(-6*psq + s + 6*t)))*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(bb*(6*psq^2 - 4*mm^2*(psq - t) - 3*psq*(s + 2*t) + 
       s*(s + 2*t)) + aa*(-6*psq^2 + 4*mm^2*(psq - s - t) - s*(s + 2*t) + 
       psq*(7*s + 6*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*psq*(3*psq - s - 3*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(bb*(2*mm^2 + 3*psq - t) + 
     aa*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(aa*(-2*psq^2 + mm^2*(psq - 4*s - t) + 2*s*(s + t) + psq*(s + 2*t))) + 
     bb*(2*mm^4 - 8*psq^2 + mm^2*(5*psq - 4*s - t) + 2*s*(s + t) + 
       psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(bb*(4*mm^2 + 6*psq - s - 2*t) + aa*(-2*psq + 3*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (bb*(2*mm^2 + 4*psq + s - 2*t) + aa*(2*mm^2 + 3*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-3*mm^4 + 4*psq^2 + 2*s*t - mm^2*(2*psq - 8*s + t) + 
       2*psq*(-3*s + t)) + bb*(mm^4 + mm^2*(-2*psq - 8*s + t) + 
       2*(psq^2 + 3*psq*s - psq*t - s*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (bb*(mm^2 + 2*psq - t) + aa*(mm^2 + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (aa*(psq - 2*s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-3*psq^2 + 2*psq*s + 2*mm^2*(psq - s - t) + 3*psq*t + s*t) - 
     bb*(-3*psq^2 - 4*psq*s + 2*mm^2*(psq + 2*s - t) + 3*psq*t + s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (aa*(psq - 3*s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (gZlL - gZlR)*mm^2*(3*aa*psq*(psq - t) + aa*mm^2*(psq - 2*s - t) - 
     bb*mm^2*(psq + s - t) + 3*bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (aa*(psq - 2*s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - 2*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(2*mm^4 + 4*mm^2*psq - 8*psq^2 - psq*s + s^2 + 2*psq*t + s*t) + 
     aa*(2*psq^2 - 2*psq*(s + t) - s*(-3*mm^2 + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(3*mm^4 - 8*psq^2 + mm^2*(4*psq - 9*s - t) + 2*s*(s + t) + 
        2*psq*(2*s + t))) + aa*(mm^4 - 2*psq^2 + 2*s*(s + t) + 
       2*psq*(2*s + t) - mm^2*(9*s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - 2*s)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(3*mm^4 - 8*psq^2 + mm^2*(3*psq - 5*s) + 2*psq*(s + t) + 
        s*(s + t))) + aa*(mm^4 - 2*psq^2 - mm^2*(psq + 8*s) + s*(s + t) + 
       psq*(5*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(aa*(psq^2 + psq*(s - t) + mm^2*(-psq - 2*s + t) + s*(s + t))) + 
     bb*(psq^2 + s*(s + t) + mm^2*(-psq + 2*s + t) - psq*(3*s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*s*(5*psq - 3*s - 5*t) + 
     bb*mm^2*(2*psq + s - 2*t) + aa*mm^2*(-2*psq + s + 2*t) + 
     bb*s*(-7*psq + 3*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(-(aa*(psq^2 - 3*mm^2*s - psq*t + 2*s*(s + t))) + 
     bb*(psq^2 - psq*(s + t) + 2*s*(-mm^2 + s + t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^4 - 4*psq^2 + mm^2*(3*psq - 5*s) + 2*psq*s - 2*psq*t - s*t) + 
     bb*(-mm^4 - 2*psq^2 - 5*psq*s + mm^2*(psq + 8*s) + 2*psq*t + s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (bb*(2*mm^2 + 4*psq - s - 2*t) + aa*(2*mm^2 + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(-3*psq^2 + 2*psq*s + 2*mm^2*(psq - s - t) + 
       3*psq*t + s*t) - bb*(-3*psq^2 - 4*psq*s + 2*mm^2*(psq + 2*s - t) + 
       3*psq*t + s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (3*aa*psq*(psq - t) + aa*mm^2*(psq - 2*s - t) - bb*mm^2*(psq + s - t) + 
     3*bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[q2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (bb*(psq + s - t) + aa*(2*mm^2 + psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(-2*psq^2 - 3*psq*s + mm^2*(psq + 3*s - t) + 2*psq*t + 2*s*t) + 
     aa*(2*mm^4 - 4*psq^2 + 3*psq*s - 2*psq*t - 2*s*t + 
       mm^2*(3*psq - 3*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
     SP[p2, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(bb*(2*psq + s - 2*t) + 
     aa*(4*mm^2 + 2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (aa*(psq - s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(-3*psq^2 - psq*s + s^2 + 2*mm^2*(psq - t) + 3*psq*t + s*t)) + 
     aa*(-3*psq^2 + 5*psq*s + s^2 + 2*mm^2*(psq - 3*s - t) + 3*psq*t + s*t))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (3*aa*psq*(psq - t) + aa*mm^2*(psq - 2*s - t) - bb*mm^2*(psq + s - t) + 
     3*bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(-2*psq^2 + 3*mm^2*s - 2*psq*s + 2*psq*t + s*t) + 
     aa*(2*mm^4 + 4*mm^2*psq - 4*psq^2 - s*t - psq*(s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-psq^2 + mm^2*(psq + s - t) + psq*t - s*t) + 
     bb*(psq^2 + s*t + mm^2*(-psq + 3*s + t) - psq*(4*s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*s*(5*psq - 2*s - 5*t) + 
     aa*mm^2*(2*psq - 3*s - 2*t) + bb*mm^2*(-2*psq + s + 2*t) + 
     aa*s*(-3*psq + 2*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(-(aa*(psq^2 + 2*s*(mm^2 + t) - psq*(4*s + t))) + 
     bb*(psq^2 - psq*(5*s + t) + s*(3*mm^2 + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
   (4^d*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-psq^2 + mm^2*(psq + s - t) + psq*t - s*t) + 
     bb*(psq^2 + s*t + mm^2*(-psq + 3*s + t) - psq*(4*s + t)))*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(-(bb*(-3*psq^2 - psq*s + s^2 + 2*mm^2*(psq - t) + 
        3*psq*t + s*t)) + aa*(-3*psq^2 + 5*psq*s + s^2 + 
       2*mm^2*(psq - 3*s - t) + 3*psq*t + s*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (3*aa*psq*(psq - t) + aa*mm^2*(psq - 2*s - t) - bb*mm^2*(psq + s - t) + 
     3*bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*s*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
   (4^d*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    s*(aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p2, q1]])/Pi^(2*d) + ((3*I)*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(3*aa*mm^2 - 9*bb*mm^2 - 
     aa*psq + 7*bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p1, q1]])/(2*Pi)^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(17*aa*mm^2 - 11*bb*mm^2 - 11*aa*psq + 5*bb*psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(3*mm^2 - psq)*
   ...
   (2*Pi)^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (11*aa*mm^2 - 17*bb*mm^2 - 5*aa*psq + 11*bb*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(11*mm^2 - 5*psq)*
  ...
  (I*(aa + 5*bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (11*mm^2 - 5*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p2, q1]])/(2*Pi)^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(aa*(3*mm^2 - psq - s - 2*t) + bb*(9*mm^2 - 11*psq + s + 2*t))*
   ...
   (2*Pi)^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (9*aa*mm^2 - 3*bb*mm^2 - 7*aa*psq + bb*psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*(5*aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(psq - s - t) + bb*(3*mm^2 - 4*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(6*mm^2 - 3*psq - t) + 
     bb*(-3*mm^2 + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(aa*(psq - s - t) + bb*(3*mm^2 - 4*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(3*aa*mm^2 - 9*bb*mm^2 - 
     3*aa*psq + 9*bb*psq + 2*aa*(s + t) - 2*bb*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(6*mm^2 - 5*psq + s + t) - aa*(3*mm^2 - 2*psq + s + t))*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(3*bb*(mm^2 - psq) + 
     2*(aa - bb)*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p1, q1], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[q2, q2]])/
   Pi^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(9*mm^2 - 4*psq - t) + bb*(-6*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(9*mm^2 - 5*psq - 2*t) - 
     bb*(3*mm^2 + psq - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(aa*(3*mm^2 - psq - s - 2*t) + bb*(3*mm^2 - 5*psq + s + 2*t))*
   ...
   (4^d*Pi^(2*d)) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(6*mm^2 - 3*psq - t) + bb*(-3*mm^2 + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p3, p3]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(2*aa*(mm^2 - t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], SP[p3, q1]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (3*mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*
    gHXZ*gXll*(gZlL - gZlR)*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(6*mm^2 - 3*psq - t) + 
     bb*(-3*mm^2 + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(aa*(3*mm^2 - psq - s - 2*t) + bb*(3*mm^2 - 5*psq + s + 2*t))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], SP[p3, q1]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(3*mm^2 - 2*psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(3*mm^2 - psq - 2*t) + 
     2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], 
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], SP[q2, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^2 - 2*psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(4*mm^2 - s - 4*t) + 
     bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*
