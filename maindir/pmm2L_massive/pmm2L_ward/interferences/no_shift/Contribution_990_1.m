...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*EL^5*gAl*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
   ...
   (I*4^(1 - d)*aa*EL^5*gAl*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*sw*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gXFW*gXll*(gZlL - gZlR)*
     mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gXFW*
   ...
   (I*4^(1 - d)*bb*EL^5*gAl*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*sw*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gXFW*gXll*(gZlL - gZlR)*
     mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gXFW*
     gXll*(gZlL - gZlR)*mm^2*sw*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gXFW*gXll*(gZlL - gZlR)*
     mm^2*sw*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
