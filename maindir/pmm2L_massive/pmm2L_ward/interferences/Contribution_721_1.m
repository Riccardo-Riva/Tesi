 ...
 ((I*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*psq*s*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
    gXll^2*mm^2*(mm^2 - psq)*psq*(aa*(psq - t) + bb*(-psq + 2*s + t))*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*psq*
    ...
    SPList[SP[p2, q2]])/Pi^(2*d) - (I*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
    gXll^2*mm^2*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
    gXll^2*mm^2*(mm^2 - psq)*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (2*Pi)^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (2*Pi)^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
    (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[q2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*psq*(aa*(psq - s - t) + 
  ...
  (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*psq*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
    (aa*(psq - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(aa*mm^2*(psq - t) - 
     bb*(mm^2 - 2*psq)*(psq - s - t) + aa*psq*(-2*psq + s + 2*t))*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*(psq - t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
    gXll^2*mm^2*(mm^2 - psq)*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
  ...
  (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(bb*psq*(2*psq - s - 2*t) + 
     aa*(mm^2 - 2*psq)*(psq - t) + bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(aa*(mm^2 - s - t) + 
  ...
  (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
