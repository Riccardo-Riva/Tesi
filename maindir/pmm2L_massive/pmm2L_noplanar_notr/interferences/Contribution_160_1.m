...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*
     (gZlL - gZlR)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*
