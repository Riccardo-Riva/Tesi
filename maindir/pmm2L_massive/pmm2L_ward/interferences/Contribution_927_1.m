...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mh], 
  ...
  ((I*2^(-3 - 2*d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(bb*(-2*psq^2 - 2*s*(-mm^2 + s + 2*t) + 
        psq*(3*s + 2*t)) + aa*(2*psq^2 + 2*s*(mm^2 + s + 2*t) - 
        psq*(7*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(bb*(-psq^2 + s*(mm^2 - 2*t) + psq*(s + t)) + 
   ...
   (I*2^(-3 - 2*d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (aa*(2*psq^2 - 11*psq*s + 4*s^2 + 2*mm^2*(psq - t) - 2*psq*t + 9*s*t) + 
      bb*(-2*psq^2 + 9*psq*s - 4*s^2 + 2*psq*t - 9*s*t + 
        2*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(bb*(-psq^2 + psq*(2*s + t) + s*(mm^2 - 2*(s + t))) + 
   ...
   (I*2^(-3 - 2*d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (aa*(2*psq^2 - 11*psq*s + 5*s^2 + 2*mm^2*(psq - t) - 2*psq*t + 9*s*t) + 
      bb*(-2*psq^2 + 9*psq*s - 5*s^2 + 2*psq*t - 9*s*t + 
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     ...
     SPList[SP[p3, q1]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*2^(-3 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(-3 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*
     gHgpgp*gHll*(gZlL + gZlR)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[q2, q2]])/((mh^2 - mz^2)*Pi^(2*d)) - 
   (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ*gHgpgp*
     gHll*(gZlL + gZlR)*mm^2*(bb*(3*mm^2 - psq - 2*t) + 
      aa*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p1, p3]])/((mh^2 - mz^2)*Pi^(2*d)) - 
   (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (3*aa*(2*psq - s - 2*t) + bb*(4*mm^2 - 10*psq + 3*s + 6*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (bb*(2*mm^2 + 8*psq - 3*s - 10*t) + aa*(2*mm^2 - 12*psq + 3*s + 10*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (bb*(mm^2 + psq - 2*(s + t)) + aa*(3*mm^2 - 5*psq + 2*(s + t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*
     mm^2*(aa*(4*mm^2 + 2*psq - 3*s - 6*t) + 3*bb*(-2*psq + s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (bb*(2*mm^2 + 8*psq - 7*s - 10*t) + aa*(2*mm^2 - 12*psq + 7*s + 10*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p3, q1]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) + 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*
   ...
   (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(-1 - 2*d)*bb*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, p3]])/((mh^2 - mz^2)*Pi^(2*d)) + 
   (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (aa*(psq - t) + bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) - 
   (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*
     mm^2*(bb*(2*mm^2 - psq - 2*s - t) + aa*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*
     gHgpgp*gHll*(gZlL + gZlR)*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p3, q2]])/((mh^2 - mz^2)*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q2, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     ...
     SPList[SP[p1, q1], SP[p3, p3]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*
     mm^2*(bb*(psq + s - t) + aa*(2*mm^2 - 3*psq - s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, p3]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
   ...
   (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*
     gHll*(gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, p3]])/((mh^2 - mz^2)*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*aa*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(aa*(2*mm^2 - psq - s - t) + bb*(-psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*
     mm^2*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*
     gHgpgp*gHll*(gZlL + gZlR)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p3, q2]])/((mh^2 - mz^2)*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(aa*(2*mm^2 - psq - s - t) + bb*(-psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, p3]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q2, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
   ...
   ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*
     gHgpgp*gHll*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*
     gHgpgp*gHll*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
