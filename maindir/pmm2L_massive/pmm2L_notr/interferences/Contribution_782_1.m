...
PropList[KiraPropagator[-q1, mm], KiraPropagator[q2, mh], 
 ...
 ((4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(2*(-2 + d)*mm^4*s + 
     s*(4*psq^2 + 2*(-7 + 2*d)*psq*s - (-4 + d)*s^2 + 8*psq*t - 4*s*t - 
       4*t^2) + mm^2*(4*psq^2 + (2 + d)*s^2 + 4*s*t + 4*t^2 - 
       2*psq*((-6 + d)*s + 4*t)))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(4*psq^2 - 5*s^2 + 
     2*d*s*(mm^2 + s) + 4*s*t + 4*t^2 - 2*psq*((-6 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(6*psq^2 + 2*s^2 - d*s^2 + 
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*
    (-2*psq^2 - (3 + d)*psq*s + s^2 - d*s^2 + s*t + 2*t^2 + 
     mm^2*(-4*psq + (-10 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*
    (-2*psq^2 - (-5 + d)*psq*s - 2*s^2 + s*t + 2*t^2 + 
     mm^2*(-4*psq + (-6 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(2*(-2 + d)*mm^4*s + 
     s*(4*psq^2 + 2*(-7 + 2*d)*psq*s - (-4 + d)*s^2 + 8*psq*t - 4*s*t - 
       4*t^2) + mm^2*(4*psq^2 + (2 + d)*s^2 + 4*s*t + 4*t^2 - 
   ...
   (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(4*mm^2 - 2*psq - 5*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(-4*mm^2 + 2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(4*mm^2 - 6*psq - 3*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(4*mm^2 - 6*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(4*psq^2 - 5*s^2 + 
     2*d*s*(mm^2 + s) + 4*s*t + 4*t^2 - 2*psq*((-6 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(4*psq^2 - 5*s^2 + 
     2*d*s*(mm^2 + s) + 4*s*t + 4*t^2 - 2*psq*((-6 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(-4*psq + 5*s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(-4*mm^2 + 4*psq + 7*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(2*mm^2 - 3*psq + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(2*psq - 7*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(6*psq^2 + 2*s^2 - d*s^2 + 
     mm^2*(4*psq + (-14 + d)*s - 4*t) + 3*s*t + 2*t^2 - 
  ...
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(-2*mm^2 + psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(4*mm^2 - 4*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(6*psq^2 - s^2 + 
  ...
  (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(psq + s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(4*psq + s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^6*(2*psq + 5*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(-2*psq^2 - (3 + d)*psq*s + s^2 - 
     d*s^2 + s*t + 2*t^2 + mm^2*(-4*psq + (-10 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(-2*psq^2 - (-5 + d)*psq*s - 
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(4*psq^2 + 2*(-6 + d)*mm^2*s - 
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(4*mm^2 - 2*psq - 5*s - 2*t)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(-4*psq + 5*s + 4*t)*
   ...
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*
    ...
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*
    (psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(psq + s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(4*psq + s - 4*t)*
   ...
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^4*mm^4*(2*psq + s - 2*t)*
