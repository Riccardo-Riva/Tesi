...
{0, ((-I)*2^(-3 - d)*EL^6*gAl^2*gAu^2*((8 + 12*d - 8*d^2 + d^3)*gZlL*gZuL - 
 ...
 (I*2^(-2 - d)*EL^6*gAl^2*gAu^2*((8 + 12*d - 8*d^2 + d^3)*gZlL*gZuL - 
  ...
  (I*2^(-3 - 2*d)*(2 - d)*EL^6*gAl^2*gAu^2*
    ...
    (mz^2 - s)*s) - (I*2^(-3 - 2*d)*(2 - d)*EL^6*gAl^2*gAu^2*
  ...
  ((I/8)*(-2 + d)*EL^6*gAl^2*gAu^2*
    ((3*2^(1 - d)*(gZlL + gZlR)*(gZuL + gZuR)*(mz^2 + t)^2*(-1 + GaugeXi[Q]))/
      (mz^2*Pi^d) - (2^(1 - d)*(gZlR*gZuL*(-((-4 + d)*s) + 4*t) + 
 ...
 (I*2^(-1 - d)*EL^6*gAl^2*gAu^2*((-52 + 44*d - 12*d^2 + d^3)*gZlL*gZuL - 
  ...
  (I*2^(-2 - 2*d)*(-3 + d)*EL^6*gAl^2*gAu^2*
    ...
    s) - (I*2^(-2 - 2*d)*(-3 + d)*EL^6*gAl^2*gAu^2*
    (2^(2 + d)*((-52 + 44*d - 12*d^2 + d^3)*gZlL*gZuL - 
       (-56 + 46*d - 12*d^2 + d^3)*gZlR*gZuL - (-56 + 46*d - 12*d^2 + d^3)*
        gZlL*gZuR + (-52 + 44*d - 12*d^2 + d^3)*gZlR*gZuR)*mz^2*Pi^d*s + 
     2^(2 + d)*((-52 + 44*d - 12*d^2 + d^3)*gZlL*gZuL - 
 ...
 ((-I)*2^(-3 - d)*d*EL^6*gAl^2*gAu^2*(gZlL + gZlR)*(gZuL + gZuR)*
  ...
  (I*2^(-4 - d)*EL^6*gAl^2*gAu^2*(d*s + 2*t)*(gZlL*gZuL*((-4 + d)*s - 2*t) + 
     gZlR*gZuR*((-4 + d)*s - 2*t) - gZlR*gZuL*((-2 + d)*s + 2*t) - 
     gZlL*gZuR*((-2 + d)*s + 2*t))*(-1 + GaugeXi[Q]))/(mz^2*Pi^d*s^2) - 
  (I*2^(-3 - d)*(-2 + d)*EL^6*gAl^2*gAu^2*(gZlL*gZuL*((-2 + d)*s - 2*t) + 
     gZlR*gZuR*((-2 + d)*s - 2*t) - gZlR*gZuL*((-4 + d)*s + 2*t) - 
     gZlL*gZuR*((-4 + d)*s + 2*t))*(-1 + GaugeXi[Q])*(s - mz^2*GaugeXi[Q]))/
   (mz^2*Pi^d*s*(-2*s + 2*mz^2*GaugeXi[Q])) + 
 ...
 (I*EL^6*gAl^2*gAu^2*(gZlL*(-(d^2*gZuL*(2*Pi)^d*s^2) + 
  ...
  (I*2^(-4 - d)*EL^6*gAl^2*gAu^2*(gZlL*gZuL*((-2 + d)*s - 2*t) + 
     gZlR*gZuR*((-2 + d)*s - 2*t) - gZlR*gZuL*((-4 + d)*s + 2*t) - 
  ...
  (I*2^(-4 - 2*d)*EL^6*gAl^2*gAu^2*(-1 + GaugeXi[Q])*
