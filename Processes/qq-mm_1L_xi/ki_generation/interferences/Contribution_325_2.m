 ...
 (((-3*I)*EL^6*gAd^2*gAl*gAu*ms^2*
  ...
  ((3*I)*EL^6*gAd^2*gAl*gAu*
    (-(gZlRC*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) - 
     ...
     gZlLC*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
     gZlRC*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
    SPList[SP[p1, p2]])/((2*Pi)^d*(mzC^2 - s)*s^2) - 
  ((3*I)*EL^6*gAd^2*gAl*gAu*
    ...
    SPList[SP[p1, q1]])/((mzC^2 - s)*s^2) + 
  ((3*I)*EL^6*gAd^2*gAl*gAu*
    (-(gZlRC*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) - 
     gZlLC*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) + 
     gZlLC*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
     gZlRC*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
    SPList[SP[p2, q1]])/((2*Pi)^d*(mzC^2 - s)*s^2) + 
  ((3*I)*EL^6*gAd^2*gAl*gAu*
    ...
    SPList[SP[q1, q1]])/((2*Pi)^d*(mzC^2 - s)*s^2) - 
  ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*((-2 + d)*gZlLC*gZuLC - 
     (-4 + d)*gZlRC*gZuLC - (-4 + d)*gZlLC*gZuRC + (-2 + d)*gZlRC*gZuRC)*t*
    SPList[SP[p1, p2], SP[p1, p2]])/(Pi^d*s^2*(-mzC^2 + s)) - 
  ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
     gZlRC*gZuRC*((-2 + d)*s - 2*t) - gZlRC*gZuLC*((-4 + d)*s + 2*t) - 
     gZlLC*gZuRC*((-4 + d)*s + 2*t))*SPList[SP[p1, p2], SP[p1, p3]])/
   (Pi^d*s^2*(-mzC^2 + s)) + ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*
    (gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 2*(-3 + d)*gZuLC*t - 
       2*(-3 + d)*gZuRC*t) + gZlRC*(-((-4 + d)*gZuLC*s) + (-2 + d)*gZuRC*s - 
       2*(-3 + d)*gZuLC*t + 2*(-3 + d)*gZuRC*t))*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^d*s^2*(-mzC^2 + s)) + 
  ((3*I)*2^(3 - d)*EL^6*gAd^2*gAl*gAu*((-2 + d)*gZlLC*gZuLC - 
     (-4 + d)*gZlRC*gZuLC - (-4 + d)*gZlLC*gZuRC + (-2 + d)*gZlRC*gZuRC)*t*
    SPList[SP[p1, p2], SP[p2, q1]])/(Pi^d*s^2*(-mzC^2 + s)) + 
  ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
     gZlRC*gZuRC*((-2 + d)*s - 2*t) - gZlRC*gZuLC*((-4 + d)*s + 2*t) - 
     gZlLC*gZuRC*((-4 + d)*s + 2*t))*SPList[SP[p1, p2], SP[p3, q1]])/
   (Pi^d*s^2*(-mzC^2 + s)) + ((3*I)*2^(3 - d)*EL^6*gAd^2*gAl*gAu*
    (gZlLC + gZlRC)*(gZuLC + gZuRC)*SPList[SP[p1, p3], SP[p1, p3]])/
   (Pi^d*s*(-mzC^2 + s)) + ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*
  ...
  ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
   ...
   (Pi^d*s^2*(-mzC^2 + s)) - ((3*I)*2^(4 - d)*EL^6*gAd^2*gAl*gAu*
    (gZlLC + gZlRC)*(gZuLC + gZuRC)*SPList[SP[p1, p3], SP[p3, q1]])/
   (Pi^d*s*(-mzC^2 + s)) - ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*
  ...
  ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*(d*gZlRC*(gZuLC - gZuRC)*s + 
  ...
  ((3*I)*2^(3 - d)*EL^6*gAd^2*gAl*gAu*(gZlLC + gZlRC)*(gZuLC + gZuRC)*
