...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 ((2^(1 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
  ...
  (4^(1 - d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
   ...
   (4^d*Pi^(2*d)*s^2) - (2^(1 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
  ...
  (2^(3 - 2*d)*(-2 + d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
  ...
  (4^(1 - d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*(2*(-4 + d)*psq + 
     (20 - 10*d + d^2)*s - 2*(-4 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  ((-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(-2*(-2 + d)*psq^2 + 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    (2*psq^2 - 3*s^2 + d*s^2 + psq*(5*s - 2*d*s - 4*t) + s*t + 2*t^2 + 
     mm^2*(-2*psq + d*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*d*EL^8*gAl^4*gAu^2*
    gZlL*gZlR*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
  ...
  ((-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(2*(-6 + d)*psq^2 - 
     psq*((32 - 18*d + d^2)*s + 2*(-10 + d)*t) + 
  ...
  (2^(3 - 2*d)*(-4 + d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ((12 - 6*d + d^2)*mm^2 - (8 - 6*d + d^2)*psq + 2*(-3 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*d^2*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q1]])/(Pi^(2*d)*s) + 
  ((-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(4*(-2 + d)*psq^2 - 
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*
