   ...
   ((2^(1 - 2*d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*mm^4*
    ...
    (4^(1 - d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*mm^4*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^2*gHll^2*
      (gZlL + gZlR)^2*mm^4*((-1 + 2*d)*mm^2 - (-3 + d)*psq + (-2 + d)*s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/((mh^2 - mz^2)*Pi^(2*d)) - 
    (2^(3 - 2*d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*mm^4*(psq - s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/((mh^2 - mz^2)*Pi^(2*d)) + 
    (2^(3 - 2*d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*mm^4*(2*mm^2 + (-2 + d)*s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
    (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*mm^4*(4*mm^2 + (-2 + d)*s)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*mm^4*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^2*gHll^2*
      (gZlL + gZlR)^2*mm^4*(mm^2 - psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*mm^4*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*mm^4*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gHll^2*
