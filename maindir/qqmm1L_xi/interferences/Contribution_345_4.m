...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 - p2 + q1, 0]]*
  (((-I)*2^(1 - 2*d)*EL^6*gZNL^2*
     ...
     (gZlL*gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
      ...
      gZlR*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
        ...
        gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((8 - 7*d + d^2)*s^2 + 
            (2 - 3*d + d^2)*s*t + 2*t^2))))*\[Mu]^(4 - d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) + 
   ...
   (I*2^(3 - d)*EL^6*gZNL^2*(gZlR*gZlRC*((-2 + d)*gZuL*gZuLC - 
   ...
   (I*2^(3 - d)*EL^6*gZNL^2*(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
