...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   ((I*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*(d^2*gZuL*(2*Pi)^d*s^2 - 
      ...
      SPList[SP[q1, q1]])/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)) - 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*\[Mu]^(4 - d)*
      (12*gZuR*s^2 + gZuL*mw^2*((-6 + d)*s - 2*t) + 22*gZuR*s*t - 
       ...
       d*gZuR*s*(mw^2 + 3*s + 4*t) + (mw^2 - s)*((-6 + d)*gZuL*s - 2*gZuL*t - 
         gZuR*(d*s + 2*t))*GaugeXi[Q])*SPList[SP[p1, q1], SP[p3, q1], 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*\[Mu]^(4 - d)*
      ...
      GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*\[Mu]^(4 - d)*
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
      (gZuR*(-3*(-4 + d)*s^2 + (22 - 6*d)*s*t + 4*t^2) + 
       gZuL*(3*(-2 + d)*s^2 + 2*(-7 + 3*d)*s*t + 4*t^2))*\[Mu]^(4 - d)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*((-2 + d)*gZuL - (-4 + d)*gZuR)*
     ...
     (mw^4*Pi^d*s*(-mz^2 + s)*GaugeXi[Q]) - 
    (I*2^(2 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*((-2 + d)*gZuL*s - 
       (-4 + d)*gZuR*s - 2*(-1 + d)*gZuL*t + 2*(-5 + d)*gZuR*t)*\[Mu]^(4 - d)*
      SPList[SP[p2, q1], SP[p2, q1], SP[p3, q1], SP[q1, q1]])/
     (mw^4*Pi^d*(mz^2 - s)*s*GaugeXi[Q]) - 
    (I*2^(2 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*((-2 + d)*gZuL - (-4 + d)*gZuR)*
      t*\[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s*(-mz^2 + s)*GaugeXi[Q]) + 
    (I*2^(3 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*((-1 + d)*gZuL*s - 
       (-5 + d)*gZuR*s - 2*gZuL*t - 2*gZuR*t)*\[Mu]^(4 - d)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*((-2 + d)*gZuL*s - 
     ...
     (mw^4*Pi^d*(mz^2 - s)*s*GaugeXi[Q]) - 
    (I*2^(4 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*(gZuL + gZuR)*\[Mu]^(4 - d)*
      SPList[SP[p3, q1], SP[p3, q1], SP[p3, q1], SP[q1, q1]])/
     (mw^4*Pi^d*(mz^2 - s)*GaugeXi[Q]) - 
    (I*2^(3 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*(gZuL + gZuR)*\[Mu]^(4 - d)*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   ((I*2^(1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
      ...
      \[Mu]^(4 - d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s*(-mz^2 + s)) - 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
      (-(gZuR*((56 - 34*d + 5*d^2)*s^2 + 2*(46 - 31*d + 5*d^2)*s*t - 
         ...
         2*(38 - 27*d + 5*d^2)*s*t + 4*(-2 + d)*t^2))*\[Mu]^(4 - d)*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*\[Mu]^(4 - d)*
      ((-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
        ...
        (mw^2*(mz^2 - s)) + ((2*Pi)^d*(gZuR*((8 - 6*d + d^2)*s^2 + 
    ...
    (I*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*\[Mu]^(4 - d)*
     ...
     (Pi^d*(mz^2 - s)) + (I*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*\[Mu]^(4 - d)*
      ((s*GaugeXi[Q]*(d*gZuL*(2*Pi)^d*s^2 - d*gZuR*(2*Pi)^d*s^2 + 
          2^(1 + d)*gZuR*Pi^d*(2*s^2 - (-5 + d)*s*t + 2*t^2) - 
          2^(1 + d)*gZuL*Pi^d*(s^2 - 2*t^2 + s*(t - d*t)) + 
          2^(1 + d)*Pi^d*(s + 2*t)*(-((-2 + d)*gZuL*s) + (-4 + d)*gZuR*s - 
         ...
         (11*d*gZuR*(2*Pi)^d*s^2 - 2^(1 + d)*gZuR*Pi^d*((6 + d^2)*s^2 + 
            ...
            2^(1 + d)*Pi^d*((3 + d^2)*s^2 + (15 - 9*d + 2*d^2)*s*t + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 
    ...
    (I*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*t*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
       2*gZuL*t + 2*gZuR*t)*\[Mu]^(4 - d)*SPList[SP[p2, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^d*(mz^2 - s)) + (I*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
      \[Mu]^(4 - d)*(d*gZuL*(2*Pi)^d*s^2 - d*gZuR*(2*Pi)^d*s^2 + 
       2^(1 + d)*gZuR*Pi^d*(2*s^2 - (-5 + d)*s*t + 2*t^2) - 
       2^(1 + d)*gZuL*Pi^d*(s^2 - 2*t^2 + s*(t - d*t)) + 
       2^(1 + d)*Pi^d*(s + 2*t)*(-((-2 + d)*gZuL*s) + (-4 + d)*gZuR*s - 
      ...
      (-1 + GaugeXi[Q])^2) + (I*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*s*\[Mu]^(4 - d)*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*\[Mu]^(4 - d)*
      (d*gZuL*(2*Pi)^d*s^2 - d*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*
        (2*s^2 - (-5 + d)*s*t + 2*t^2) - 2^(1 + d)*gZuL*Pi^d*
        (s^2 - 2*t^2 + s*(t - d*t)) + s*(-(d*gZuL*(2*Pi)^d*s) + 
         d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(s - (-3 + d)*t) + 
         2^(1 + d)*gZuR*Pi^d*(-2*s + (-3 + d)*t))*GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*GaugeXi[Q]) - 
