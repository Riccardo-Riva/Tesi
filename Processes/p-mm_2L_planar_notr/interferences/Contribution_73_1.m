...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((-3*4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^4*
     mu^2)/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^4*mu^2*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^4*
     (-4*mu^2 + s + t)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^4*
     mu^2*SPList[SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^4*
     (4*mu^2 + t)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^4*
     (2*mu^2 + s)*SPList[SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     (2*mu^2 + s)*(mm^2 + 2*s)*SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     (mm^2 - 2*t)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*t*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*t*
