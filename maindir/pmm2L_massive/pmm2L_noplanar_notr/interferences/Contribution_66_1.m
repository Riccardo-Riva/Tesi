...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*mm^2*sw*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*mm^2*sw*
     (-4*gZlL*psq^2 - d*gZlR*(mm^2 + psq)*(psq - s - t) - 
      2*gZlL*s*(2*s + t) + 2*gZlL*psq*(3*s + 2*t) + 
      d*gZlL*(2*psq^2 + s^2 - 2*psq*(s + t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*mm^2*
     (d*gZlR*(mm^2 + psq) + gZlL*(4*psq - 6*s) + 2*d*gZlL*(-psq + s))*sw*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*mm^2*sw*
     (d*gZlR*s*(2*mm^2 - 2*psq + s) - gZlL*(4*(-2 + d)*psq^2 + 
        (18 - 9*d + d^2)*s^2 - 8*(-2 + d)*psq*t + 4*(-2 + d)*s*t + 
        4*(-2 + d)*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*mm^2*sw*
     (2*gZlL*(psq - 5*s - t) + d*gZlR*(2*mm^2 - 3*psq + s + t) + 
      d*gZlL*(-psq + 3*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*
     gWNl*mm^2*sw*(-(d*gZlR*s) + (-2 + d)*gZlL*(2*psq + (-5 + d)*s - 2*t))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*mm^2*sw*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*
     ((-2 + d)*gZlL - d*gZlR)*mm^2*sw*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*gZlL*mm^2*sw*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*mm^2*sw*
     (-(d*gZlR*s) + (-2 + d)*gZlL*(-2*psq + (-3 + d)*s + 2*t))*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*((-2 + d)*gZlL - d*gZlR)*mm^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*gZlL*mm^2*sw*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*gZlR*mm^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*gZlL*mm^2*sw*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWNl*gZlL*
