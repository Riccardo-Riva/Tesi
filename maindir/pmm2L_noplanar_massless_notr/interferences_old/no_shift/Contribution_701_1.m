(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
   ...
   ((2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
      ...
      SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
      ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*(s^2 + 3*s*t + 2*t^2)*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*((-4 + d)*s - 2*t)*
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
      ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
      ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*t*(s + 2*t)*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*((-2 + d)*s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
    (4^(2 - d)*(-5 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*((-4 + d)*s - 2*t)*
     ...
     (mz^2*Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
      (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
      (gZlL + gZlR)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (2^(5 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
    ...
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*(3*s + 2*t)*
     ...
     (mz^2*Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
      ...
      (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (2^(7 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*(s + t)*
    ...
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*((-2 + d)*s + 4*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/
     (mz^2*Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
      (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s^2) - (4^(3 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*((-2 + d)*s + 2*t)*
     ...
     (mz^2*Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
      (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
      (gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*(s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], SP[q2, q2]])/
     (mz^2*Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
      (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
      (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
    (2^(7 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
   ...
   (-((2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
       ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
      (mz^2*Pi^(2*d)*s)) + (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFZ*
