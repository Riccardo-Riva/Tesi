...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
   ...
   (((-3*I)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*s*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
    ((3*I)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*s*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
    (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*s*(-2*psq + s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(2*Pi)^(2*d) + 
    (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*s*(3*bb*mm^2*(psq - t) + 
       aa*psq*(psq - 2*s - t) - bb*psq*(psq + s - t) + 
       3*aa*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
     (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2*Pi)^(2*d) - 
    ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
      (2*psq*s + mm^2*(3*psq + s - 3*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(4*aa*mm^2*(psq - s - t) - 
    ...
    ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
     ...
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
      (-2*psq*s + mm^2*(3*psq - 4*s - 3*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
    ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
      (-3*bb*mm^2*(psq - t) + 3*aa*mm^2*(psq - s - t) + 
       bb*psq*(psq + s - t) + aa*psq*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/
     Pi^(2*d) + ((3*I)*2^(1 - 2*d)*(-aa + bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
      mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
      (bb*s*(psq - 2*t) + 2*bb*mm^2*(psq - t) + 2*aa*s*(-psq + t) + 
       aa*mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
      mm^2*(aa*(-psq^2 + 4*psq*s + 3*mm^2*(psq - s - t) + psq*t - 2*s*t) + 
       bb*(psq^2 + 3*psq*s - psq*t + 2*s*t + mm^2*(-3*psq - 4*s + 3*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
    (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(-4*bb*mm^2*(psq - t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*s*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
     ...
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*s*
     ...
     (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
      mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*
      gHll*gWNl*mm^2*(mm^2 + 2*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(2*bb*(psq - s - t) + 
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 + 2*psq)*
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(bb*(psq - s - t) + 
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(bb*(mm^2 + psq - 2*t) + 
       2*aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
      mm^2*(2*bb*(psq - s - t) + aa*(mm^2 - 3*psq + 2*(s + t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[q1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
       SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*
      gHll*gWNl*mm^2*(mm^2 + 2*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(bb*(mm^2 + psq - 2*t) + 
       ...
       SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
      mm^2*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(bb*(2*mm^2 - s - 2*t) + 
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[q1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*
      gHll*gWNl*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*
      gHll*gWNl*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
