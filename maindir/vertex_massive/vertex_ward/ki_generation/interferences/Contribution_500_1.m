...
PropList[KiraPropagator[-q1, mw], KiraPropagator[-q1 - q2, mw], 
 ...
 ((4^(-1 - d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*s*
  ...
  (2^(-1 - 2*d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
    (-2*bb*(psq*(5*psq - 3*d*psq + s) + mm^2*(-psq + 3*d*psq + 7*s - 
         3*d*s)) + aa*(mm^2*(-2*psq + 6*d*psq + 20*s - 9*d*s) + 
  ...
  (2^(-1 - 2*d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
    (2*aa*mm^2*((-1 + 3*d)*psq + (5 - 3*d)*s) + 
     2*aa*psq*((5 - 3*d)*psq + (3 - 2*d)*s) + 
     bb*psq*(2*(-5 + 3*d)*psq + (-2 + d)*s) + 
     bb*mm^2*((2 - 6*d)*psq + (-14 + 9*d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
    (bb*(-7 + 2*d)*mm^2 + aa*(1 + 2*d)*mm^2 + 9*bb*psq - 6*bb*d*psq + 
     aa*(-3 + 2*d)*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
    (aa*((-4 + 5*d)*mm^2 + (-8 + 5*d)*psq) - 
     bb*((2 + d)*mm^2 + (-14 + 9*d)*psq))*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + ((aa + bb)*(-3 + 2*d)*EL^5*gAl*gWWA*gWWAZ*
    (gZlL + gZlR)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2*Pi)^(2*d) + (2^(-1 - 2*d)*(aa + bb)*(-3 + 2*d)*EL^5*gAl*gWWA*gWWAZ*
    (gZlL + gZlR)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   Pi^(2*d) + ((-2 + d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
    (aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*(aa*(7 - 4*d)*mm^2 + 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
