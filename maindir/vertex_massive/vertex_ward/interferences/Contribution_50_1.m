...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
   ...
   ((I*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(mm^4 - psq^2)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2*Pi)^(2*d) - 
    (I*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(mm^4 - psq^2)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      (bb*(-mm^4 + psq*(-2*psq + s + t) + mm^2*(psq + s + t)) + 
       aa*(mm^4 + psq*(4*psq - s - t) - mm^2*(3*psq + s + t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^4*(psq - s - t)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      ...
      mm^2*(mm^2 - psq)*(aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      (bb*(-2*psq^2 + mm^2*s + 2*psq*t) + aa*(2*psq^2 + mm^2*s - 
     ...
     Pi^(2*d) - (I*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      (aa*psq*(psq - s - t) + aa*mm^2*(psq + s - t) - bb*psq*(psq + s - t) + 
       ...
       SP[q2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*
      gXll*mm^2*(aa*(mm^2 + psq)*(psq - t) + bb*mm^2*(-3*psq + t) + 
       bb*psq*(psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^4*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(aa*mm^2*(psq - s - t) - 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
     ...
     Pi^(2*d) - (I*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      (aa*mm^2*(psq - t) + aa*psq*(psq - 2*s - t) + bb*psq*(-psq + t) + 
       ...
       SP[q2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gFll*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(mm^2 - 2*psq)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(mm^2 - s - t)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      (mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*
      mm^2*(bb*(mm^2 - t) + aa*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(bb*(2*mm^2 - psq - t) + 
