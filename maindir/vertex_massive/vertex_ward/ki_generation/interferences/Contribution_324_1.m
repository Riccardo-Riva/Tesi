...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (((-I)*2^(1 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*s*
     ...
     Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*
      ...
      SPList[SP[p1, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*
      gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*
      mh^2*mm^4*(-2*bb*mm^2*(psq - t) + aa*s*(psq - t) + 
       2*aa*mm^2*(psq - s - t) + bb*s*(psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*
      gHXX*gXll^2*mh^2*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*
      gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*
      gHXX*gXll^2*mh^2*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*aa*EL^5*gAl*gHll*gHXX*
      gXll^2*mh^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(bb*(2*mm^2 - psq - t) + 
