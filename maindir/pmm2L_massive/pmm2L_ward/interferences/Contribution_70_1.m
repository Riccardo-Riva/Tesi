 ...
 (((-I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^4*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^4*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*
    (aa*mm^2*(5*psq - 2*s - 5*t) + aa*psq*(psq - s - t) + bb*psq*(-psq + t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^4*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(2*mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*
  ...
  (I*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(2*mm^2 - psq)*
  ...
  (I*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(bb*(psq - s - t) + 
  ...
  (I*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(bb*(mm^2 + psq - s - 2*t) + 
     aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(bb*(mm^2 - t) + aa*(-psq + t))*
