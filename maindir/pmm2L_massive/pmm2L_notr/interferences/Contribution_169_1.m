...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (-((EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(2*mm^2 - 2*psq + s)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*
    gHgpgp*gHll*mm^2*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*
   ...
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*
