...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   (-((4^(1 - d)*EL^6*gAu*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    ...
    (4^(1 - d)*EL^6*gAu*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
      ...
      SPList[SP[p3, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*ggpgpA*ggpgpZ*
      gXgpgp*gXll*(gZlL - gZlR)*mm^2*(mm^2 - 2*psq + s + t)*(-psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
     ...
     Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*
