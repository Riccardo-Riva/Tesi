...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-((EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*(aa*psq*(2*mm^2 + s) - 
     ...
     ((mh^2 - mz^2)*(2*Pi)^(2*d)) + (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*
      gHgpgp*gHll*(gZlL + gZlR)*mm^2*(4*psq - s)*s*\[Mu]^(8 - 2*d)*
    ...
    ((aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*(4*psq - s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
     ((mh^2 - mz^2)*(2*Pi)^(2*d)) + ((aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
      (gZlL + gZlR)*mm^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     ((mh^2 - mz^2)*(2*Pi)^(2*d)) + (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*
      gHgpgp*gHll*(gZlL + gZlR)*mm^2*psq*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) - 
    ((aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*s*
