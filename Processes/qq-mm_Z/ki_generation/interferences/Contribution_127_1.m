...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   ((I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*(s^2 + 3*s*t + 2*t^2)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[q1, q1]])/(mw^4*Pi^d*s) - 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   (((-I)*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*((-10 + 3*d)*s^2 + 
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*CKMC[1, 1]*
     ...
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(3 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWdu*
      gWud*gWWA*t*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1], SP[p2, q1]])/
     (Pi^d*s^2) - (I*2^(3 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      (s - 2*t)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1], SP[p3, q1]])/
     (Pi^d*s^2) - (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*
      CKMC[1, 1]*(-2*mw^2*((-2 + d)*s^2 + 5*s*t + 6*t^2) + 
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*CKMC[1, 1]*
      (-(mw^2*(s^2 + 3*s*t + 2*t^2)) + (s*(s^2 + 3*s*t + 2*t^2) + 
         mw^2*((-5 + 2*d)*s^2 + 5*s*t + 6*t^2))*GaugeXi[Q])*
   ...
   ((I*2^(1 - 2*d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*(-(d*(2*Pi)^d*s^2) + 
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*CKMC[1, 1]*
      (mw^2*((-3 + 2*d)*s^2 + 11*s*t + 10*t^2) + 
       (mw^2 - s)*(s^2 + 3*s*t + 2*t^2)*GaugeXi[Q])*SPList[SP[p1, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*s^2*GaugeXi[Q]) + 
    (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*CKMC[1, 1]*
      (-(mw^2*t*(s + 2*t)) + (s*t*(s + 2*t) + mw^2*(2*(-2 + d)*s^2 + 7*s*t + 
