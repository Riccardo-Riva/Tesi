...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*d*EL^8*gAl^6*gAu^2*mm^2*(-4*psq^3 + (-2 + d)^2*mm^4*s + 
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^6*gAu^2*mm^2*(-2*(-4 + d)*psq^2 + 2*(-6 + d)*s^2 - 
      (-8 + d)*psq*(d*s - 2*t) + 8*t^2 + 
      mm^2*(2*(-8 + d)*psq + (24 - 8*d + d^2)*s - 2*(-8 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(-4*psq^3 + 
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^6*gAu^2*mm^2*(2*(4 + d)*psq^2 - 
   ...
   (4^(2 - d)*d*EL^8*gAl^6*gAu^2*mm^2*(4*psq + (4 - 6*d + d^2)*s - 4*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*(-((-6 + d)*psq^2) + 
      (8 - 3*d)*psq*s + 2*(-3 + d)*s^2 + (-10 + d)*psq*t + 2*s*t + 4*t^2 + 
      mm^2*((-6 + d)*psq + (2 + d)*s - (-6 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*d*EL^8*gAl^6*gAu^2*mm^2*(-4*(-2 + d)*mm^2 + 4*(-2 + d)*psq + 
      (10 - 8*d + d^2)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
   ...
   (4^(2 - d)*d*EL^8*gAl^6*gAu^2*mm^2*(-2*(-4 + d)*psq + (-4 - 4*d + d^2)*s + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(4*(-1 + d)*psq^2 + 10*s^2 - 
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^6*gAu^2*mm^2*(8*s + d^2*s - 2*d*(psq + 3*s - t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(4*(-2 + d)*psq^2 + 16*s^2 - 
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*mm^2 - 2*(-3 + d)*psq - 
      3*s + d*s - 4*t + d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-40 + 40*d - 12*d^2 + d^3)*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*mm^2 - 2*psq + s + 4*t - 
      d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(2*(-2 + d)*psq + (-4 + d)^2*s - 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(3 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*
