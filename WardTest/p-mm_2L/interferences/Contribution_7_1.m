...
PropList[KiraPropagator[p1 + p2 - q1, mm], KiraPropagator[p3 - q1, 0], 
 ...
 ((2^(1 - 2*d)*d*EL^5*gAl^5*me^2*mm*(4*mm^2 - s)*s)/Pi^(2*d) - 
  (2^(3 - 2*d)*EL^5*gAl^5*mm*(2*mm^4 + d*me^2*(2*mm^2 - s) + me^2*s - mm^2*s)*
  ...
  (2^(1 - 2*d)*EL^5*gAl^5*mm*s*(4*(-2 + d)*me^2 + 4*(-1 + d)*mm^2 - 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^5*mm*(4*mm^2 - s)*s*SPList[SP[q2, q2]])/
   Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^5*me^2*mm*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (4^(2 - d)*EL^5*gAl^5*mm^3*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (4^(2 - d)*(-2 + d)*EL^5*gAl^5*me^2*mm*SPList[SP[p1, q1], SP[p2, q1]])/
   Pi^(2*d) + (4^(2 - d)*EL^5*gAl^5*mm^3*SPList[SP[p1, q1], SP[p2, q2]])/
   Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^5*mm*(2*me^2 + 2*mm^2 - s)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^5*me^2*mm*SPList[SP[p2, q1], SP[p2, q1]])/
