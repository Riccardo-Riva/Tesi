...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((EL^5*gAl*gFFZZ*mm^2*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFFZZ*(2*aa*(gZlL^2 + gZlR^2)*psq*s - 
    ...
    Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFFZZ*
     (gZlL^2 + gZlR^2)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) + ((aa + bb)*(-2 + d)*EL^5*gAl*gFFZZ*(gZlL^2 + gZlR^2)*
     (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2*Pi)^(2*d) - 
   (4^(1 - d)*(-2 + d)*EL^5*gAl*gFFZZ*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFFZZ*(gZlL^2 + gZlR^2)*
