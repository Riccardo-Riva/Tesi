...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
   ...
   (((-I)*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)^2*s*
      ...
      gAl^3*gHll^2*mm^4*(mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*((-4 + 3*d)*mm^2 + 
       (-4 + d)*psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*
      gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*(aa*d*(-psq + t) + 
    ...
    (I*2^(3 - 2*d)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(mm^2 - t) + 
       ...
       SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*d*EL^5*gAl^3*gHll^2*mm^2*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
