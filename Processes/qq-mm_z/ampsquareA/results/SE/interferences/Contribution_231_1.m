...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  (((-I)*2^(3 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*SPList[SP[q1, q1]])/
    (Pi^d*(mz^2 - s)) + (I*2^(4 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*
   ...
   (I*2^(4 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*t*
