...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (((-I)*EL^5*gAl^3*mm^2*s*
   ...
   (I*EL^5*gAl^3*mm^2*
     (bb*(-(4^(1 + d)*gZlL*gZlR*Pi^(2*d)*((-2 + d)*mm^2*((-2 + d)*psq - 2*s + 
             2*t - d*t) - s*((4 - 3*d)*psq + d*s - 4*t + 3*d*t))) + 
        (-2 + d)*gZlL^2*(-((-2 + d)*(2*Pi)^(2*d)*(2*psq + s)*(psq - s - t)) + 
          2^(1 + 2*d)*mm^2*Pi^(2*d)*((2 + d)*psq - 2*t - d*(s + t))) + 
        (-2 + d)*gZlR^2*(-((-2 + d)*(2*Pi)^(2*d)*(2*psq + s)*(psq - s - t)) + 
          2^(1 + 2*d)*mm^2*Pi^(2*d)*((2 + d)*psq - 2*t - d*(s + t)))) - 
      aa*((-2 + d)*gZlL^2*(2^(1 + 2*d)*mm^2*Pi^(2*d)*((2 + d)*psq + 
            (-4 + d)*s - (2 + d)*t) - (-2 + d)*(2*Pi)^(2*d)*
           (2*psq^2 + psq*(3*s - 2*t) - s*(s + t))) + 
        (-2 + d)*gZlR^2*(2^(1 + 2*d)*mm^2*Pi^(2*d)*((2 + d)*psq + 
            (-4 + d)*s - (2 + d)*t) - (-2 + d)*(2*Pi)^(2*d)*
           (2*psq^2 + psq*(3*s - 2*t) - s*(s + t))) - 4^(1 + d)*gZlL*gZlR*
         Pi^(2*d)*(mm^2*((-2 + d)^2*psq + (8 - 8*d + d^2)*s - (-2 + d)^2*t) - 
          s*((8 - 9*d + d^2)*psq - 4*t + d*(s + 3*t)))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(2*Pi)^(4*d) - 
   (I*EL^5*gAl^3*mm^2*(aa*(8*d*gZlL*gZlR*s*(-2*psq + s + 2*t) + 
   ...
   (I*EL^5*gAl^3*mm^2*
     (aa*(-(4^(1 + d)*gZlL*gZlR*Pi^(2*d)*(s*((-4 + 3*d)*psq + 4*s - 2*d*s + 
             4*t - 3*d*t) + (-2 + d)*mm^2*((-2 + d)*psq + 4*s - d*s + 2*t - 
             d*t))) + (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
         (-((-2 + d)*(2*psq + s)*(psq - t)) + 2*mm^2*((2 + d)*psq - 2*s - 
   ...
   (I*EL^5*gAl^3*s*
     (aa*(-((-2 + d)*gZlL^2*(4*psq^2 - 2*mm^2*s + d*(mm^2 - psq)*(psq - t) - 
           4*psq*t)) - (-2 + d)*gZlR^2*(4*psq^2 - 2*mm^2*s + 
          d*(mm^2 - psq)*(psq - t) - 4*psq*t) + 2*gZlL*gZlR*mm^2*
         ((4 - 6*d + d^2)*mm^2 - (12 - 10*d + d^2)*psq - 
          2*(-2 + d)*(s + 2*t))) + 
   ...
   (I*EL^5*gAl^3*s*(bb*(4*gZlL*gZlR*mm^2*((4 - 6*d + d^2)*mm^2 + 
          (4 + 4*d - d^2)*psq + (-4 + d)*(s + 2*t)) + 
        (-2 + d)*gZlL^2*((-8 + d)*mm^4 - (-4 + d)*psq*(psq - s - t) + 
   ...
   (I*2^(1 - 4*d)*EL^5*gAl^3*
     (aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(4*(psq - s - t) + 
          d*(2*mm^2 - 9*psq + 3*s + 7*t)) - gZlL^2*(2*Pi)^(2*d)*
         ((8 - 6*d + d^2)*mm^4 + mm^2*(-((12 - 8*d + d^2)*psq) + 
            (12 - 6*d + d^2)*s - 2*(-2 + d)*t) + 
          2*s*((10 - 3*d)*psq + (-4 + d)*s + (-2 + d)*t)) - 
        gZlR^2*(2*Pi)^(2*d)*((8 - 6*d + d^2)*mm^4 + 
   ...
   (I*4^(1 - d)*EL^5*gAl^3*(-2*aa*(gZlL^2 + gZlR^2)*s*(2*mm^2 - 5*psq + 2*s + 
        3*t) + 2*bb*(gZlL^2 + gZlR^2)*s*(-3*psq + 2*s + 3*t) + 
      bb*d*(gZlL^2*s*(3*psq - 2*s - 3*t) + gZlR^2*s*(3*psq - 2*s - 3*t) + 
   ...
   (I*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
     (bb*(8*psq^2 + 2*d*mm^2*(psq - 3*s - t) - d^2*(mm^2 - psq)*
         (psq - s - t) - 2*d*(3*psq + s)*(psq - s - t) + 8*psq*(s - t) - 
        8*s*(-mm^2 + s + t)) + aa*(d^2*(mm^2 - psq)*(psq + s - t) - 
        2*d*(-3*psq^2 - 8*psq*s + s^2 + mm^2*(psq + 7*s - t) + 3*psq*t + 
          s*t) + 8*(-psq^2 + psq*(-5*s + t) + s*(3*mm^2 + s + t))))*
   ...
   (I*EL^5*gAl^3*
     (bb*(d^2*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
          gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq + s)*(psq - s - t) + 
          gZlR^2*(2*Pi)^(2*d)*(mm^2 - psq + s)*(psq - s - t)) - 
        2^(1 + 2*d)*d*Pi^(2*d)*(-8*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
          gZlL^2*(mm^2 - 3*psq + 4*s)*(psq - s - t) + 
          gZlR^2*(mm^2 - 3*psq + 4*s)*(psq - s - t)) + 2^(3 + 2*d)*Pi^(2*d)*
         (2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) - gZlL^2*(psq^2 + 2*s*(s + t) - 
            psq*(4*s + t)) - gZlR^2*(psq^2 + 2*s*(s + t) - psq*(4*s + t)))) + 
   ...
   (I*2^(1 - 4*d)*EL^5*gAl^3*mm^2*
     (aa*((-2 + d)^2*gZlL^2*(2*Pi)^(2*d)*(2*mm^2 - 3*psq + s + t) + 
      ...
      4^d*bb*Pi^(2*d)*(-((-2 + d)^2*gZlL^2*(psq - s - t)) - 
        (-2 + d)^2*gZlR^2*(psq - s - t) - 4*gZlL*gZlR*((-4 + 3*d)*psq + 4*t - 
          d*(s + 3*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    Pi^(4*d) + (I*2^(1 - 4*d)*EL^5*gAl^3*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl^3*mm^2*
     (aa*((-2 + d)^2*gZlL^2*(2*Pi)^(2*d)*(2*mm^2 - 4*psq + s + 2*t) + 
      ...
      bb*((-2 + d)^2*gZlL^2*(2*Pi)^(2*d)*(2*mm^2 - s - 2*t) + 
        ...
        4^(1 + d)*gZlL*gZlR*Pi^(2*d)*((4 - 6*d + d^2)*mm^2 - (-4 + d^2)*psq + 
          (-4 + 3*d)*(s + 2*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    Pi^(2*d) + (I*(-2 + d)*EL^5*gAl^3*
     (aa*(8*gZlL*gZlR*mm^2*(psq + s - t) + 4*d*gZlL*gZlR*mm^2*(-psq + t) + 
        d*gZlL^2*(-2*psq^2 - 3*psq*s + s^2 + 2*mm^2*(psq + s - t) + 2*psq*t + 
          s*t) + d*gZlR^2*(-2*psq^2 - 3*psq*s + s^2 + 2*mm^2*(psq + s - t) + 
          2*psq*t + s*t) - 4*gZlL^2*(-2*psq^2 + s*(3*mm^2 + s + t) + 
          psq*(-3*s + 2*t)) - 4*gZlR^2*(-2*psq^2 + s*(3*mm^2 + s + t) + 
          psq*(-3*s + 2*t))) - bb*(d*gZlL^2*(2*mm^2 - 2*psq - s)*
         (psq - s - t) + d*gZlR^2*(2*mm^2 - 2*psq - s)*(psq - s - t) + 
        8*gZlL*gZlR*mm^2*(psq + s - t) + 4*d*gZlL*gZlR*mm^2*(-psq + t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     ...
     (aa*(-8*psq^2 + d^2*(mm^2 - psq)*(psq - t) + 2*d*(3*psq + s)*(psq - t) - 
        2*d*mm^2*(psq + 2*s - t) + 8*psq*t + 8*s*(mm^2 + t)) + 
   ...
   (I*EL^5*gAl^3*
     (bb*(-2*d*(-(2^(3 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
          gZlL^2*(2*Pi)^(2*d)*(-3*psq^2 - 6*psq*s + mm^2*(psq + 10*s - t) + 
            3*psq*t - 4*s*t) + gZlR^2*(2*Pi)^(2*d)*(-3*psq^2 - 6*psq*s + 
            mm^2*(psq + 10*s - t) + 3*psq*t - 4*s*t)) + 
      ...
      aa*(-(d^2*(2*Pi)^(2*d)*(gZlL^2*(mm^2 - psq + s)*(psq - t) + 
         ...
         (gZlL^2*(mm^2 - 3*psq + 4*s)*(psq - t) + gZlR^2*(mm^2 - 3*psq + 4*s)*
           (psq - t) + 8*gZlL*gZlR*mm^2*(-2*psq + s + 2*t)) + 
        2^(3 + 2*d)*Pi^(2*d)*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
          gZlL^2*(psq^2 + 2*s*t - psq*(s + t)) + gZlR^2*(psq^2 + 2*s*t - 
            psq*(s + t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    (2*Pi)^(4*d) + (I*2^(1 - 4*d)*EL^5*gAl^3*mm^2*
     (4^d*aa*Pi^(2*d)*(-((-2 + d)^2*gZlL^2*(psq - t)) - 
        (-2 + d)^2*gZlR^2*(psq - t) - 4*gZlL*gZlR*((-4 + 3*d)*psq + 4*s - 
         ...
         ((4 - 6*d + d^2)*mm^2 - d^2*psq - 4*(s + t) + 
          d*(3*psq + 2*s + 3*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/Pi^(4*d) - 
   (I*2^(1 - 2*d)*EL^5*gAl^3*(aa*(8*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
    ...
    Pi^(2*d) + (I*(-2 + d)*EL^5*gAl^3*
     (-(bb*(8*gZlL*gZlR*mm^2*(psq - 2*s - t) + 4*d*gZlL*gZlR*mm^2*
          (-psq + s + t) + 4*gZlL^2*(2*psq^2 + 3*mm^2*s - 3*psq*s - 2*psq*t - 
           s*t) + 4*gZlR^2*(2*psq^2 + 3*mm^2*s - 3*psq*s - 2*psq*t - s*t) + 
         d*gZlL^2*(-2*psq^2 + 3*psq*s + 2*mm^2*(psq - 2*s - t) + 2*psq*t + 
           s*t) + d*gZlR^2*(-2*psq^2 + 3*psq*s + 2*mm^2*(psq - 2*s - t) + 
           2*psq*t + s*t))) + aa*(d*(gZlL^2*(2*mm^2 - 2*psq - s)*(psq - t) + 
   ...
   (I*2^(1 - 4*d)*EL^5*gAl^3*(bb*(2*Pi)^(2*d)*
      ...
      aa*(2*d*(gZlL^2*(2*Pi)^(2*d)*(-((3*psq - s)*(psq - t)) + 
        ...
        4^(1 + d)*Pi^(2*d)*(4*gZlL*gZlR*mm^2*(-psq + 2*s + t) + 
          ...
          gZlR^2*(-2*psq^2 + s*(mm^2 - t) + psq*(s + 2*t)))))*\[Mu]^(8 - 2*d)*
