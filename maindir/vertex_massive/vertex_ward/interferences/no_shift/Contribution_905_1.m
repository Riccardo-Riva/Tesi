...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*s*
     (-2*bb*psq^2 + aa*psq*(2*mm^2 + 2*psq - s) + bb*mm^2*(-2*psq + s))*
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHXZ*gHZZ*gXll*
     (gZlL - gZlR)*mm^2*(aa*psq*(4*mm^2 + 2*psq - 3*s) - 
      bb*(2*mm^2 + psq)*(2*psq - s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
     (aa*psq*(2*mm^2 - s) + bb*mm^2*(-2*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (3*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*
     gHZZ*gXll*(gZlL - gZlR)*mm^2*psq*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
     mm^2*psq*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
   ((aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(4*psq - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2*Pi)^(2*d) + 
   ((-aa + bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(4*psq - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2*Pi)^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
     (-2*aa*psq + bb*(mm^2 + psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(bb*mm^2 - aa*psq)*
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
     mm^2*(2*mm^2 + 2*psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*psq*
