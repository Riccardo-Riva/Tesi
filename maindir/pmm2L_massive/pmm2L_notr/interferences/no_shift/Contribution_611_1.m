...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (mm^2 - psq)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(-2*psq + d*s + 2*t)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(2*psq + (-4 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(6*psq + d*s - 6*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     ...
     mm^4*((-2 + d)*psq*s + mm^2*(8*psq + 2*s - d*s - 8*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     ...
     gXll^2*mm^4*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
