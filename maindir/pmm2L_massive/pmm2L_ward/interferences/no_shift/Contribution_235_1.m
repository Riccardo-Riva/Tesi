...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  (((-I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA^3*(mm^2 - psq)*s*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA^3*mm^2*s*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(-aa + bb)*EL^5*gAl^2*ggpgpA^3*(mm^2 - psq)*s*(psq - t)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*ggpgpA^3*(mm^2 - psq)*s*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA^3*(mm^2 - psq)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA^3*(mm^2 - psq)*(psq - s - t)*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*ggpgpA^3*s*(bb*(2*mm^2 - psq - t) + 
      aa*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA^3*mm^2*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^2*ggpgpA^3*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
