...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(4*aa*mm^2 + bb*(-6 + d)*mm^2 - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*psq*(-(bb*(-3 + d)*mm^2) + 
     aa*(-5 + 2*d)*mm^2 + 2*aa*(-2 + d)*psq - 3*bb*(-2 + d)*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (EL^5*gAl*gWlN*gWNl*gWWA^2*s*(4*aa*(-2 + d)*psq*s + bb*(-2 + d)*psq*s + 
     bb*mm^2*(8*(-1 + d)*psq - 7*(-2 + d)*s) + 
     aa*mm^2*(-8*(-1 + d)*psq + 2*(-2 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (EL^5*gAl*gWlN*gWNl*gWWA^2*s*(2*aa*(-2 + d)*psq*s - 3*bb*(-2 + d)*psq*s + 
     bb*mm^2*(-4*(-1 + d)*psq + 2*s) + aa*mm^2*(4*(-1 + d)*psq + (-4 + d)*s))*
  ...
  (EL^5*gAl*gWlN*gWNl*gWWA^2*s*(4*bb*(-2 + d)*psq^2 - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(-2*aa*(-2 + d)*psq*(4*psq - 3*s) + 
     4*aa*mm^2*(3*psq - s) + bb*(-2 + d)*psq*(6*psq - s) + 
     bb*mm^2*(2*(-8 + d)*psq + (14 - 5*d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWA^2*psq*(aa*(5 - 2*d)*mm^2 + 
     bb*(-3 + d)*mm^2 - 2*aa*(-2 + d)*psq + 3*bb*(-2 + d)*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(-8*aa*(-2 + d)*psq*s + 
     bb*(-2 + d)*psq*s + 4*aa*mm^2*(2*(-1 + d)*psq - (-2 + d)*s) + 
     bb*mm^2*(-8*(-1 + d)*psq + 11*(-2 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(4*aa*(-2 + d)*psq*s - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(4*bb*(-2 + d)*psq^2 - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(aa*(5 - 2*d)*mm^2 + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(-(bb*(2*mm^2 + psq)) + 
     ...
     SP[p2, q1]])/Pi^(2*d) + (4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWA^2*
