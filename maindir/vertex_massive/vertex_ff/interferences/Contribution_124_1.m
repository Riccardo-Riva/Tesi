...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAu*gFFA*gFll^2*mm^2*
   ...
   (4^(1 - 2*d)*EL^6*gAu*gFFA*gFll^2*mm^2*
     ((-2 + d)*gZlR^2*(2*Pi)^(2*d)*(psq*(4*psq - s - 4*t) + 
        2*mm^2*(psq - s - t)) - 4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
       (2*psq - s - 2*t) + (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
       (2*psq - s - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    Pi^(4*d) - (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*mm^2*
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR^2*mm^2*(-((-2 + d)*psq^2) + 2*psq*s + 
      (-2 + d)*mm^2*(psq - t) + (-2 + d)*psq*t - s*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZlR^2*mm^2*(mm^2 - psq)*
