...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*mm^2*(s + t)*(-2*gZlL^3*gZlR*s*(s + 4*t) - 
       2*gZlL*gZlR^3*s*(s + 4*t) + gZlL^4*t*((12 - 5*d + d^2)*mm^2 + 
         2*(-2 + d)*(s + t)) + gZlR^4*t*((12 - 5*d + d^2)*mm^2 + 
         2*(-2 + d)*(s + t)) - 2*gZlL^2*gZlR^2*t*(-5*d*mm^2 + d^2*mm^2 - 
         8*(s + t) + 2*d*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   ...
   (4^(1 - d)*EL^6*gAl*gAu*mm^2*(2*gZlL^3*gZlR*s^2*(s + 2*t) + 
      2*gZlL*gZlR^3*s^2*(s + 2*t) - gZlR^4*t*(-((4 - 5*d + d^2)*mm^2*s) + 
        (-2 + d)^2*(s^2 + 3*s*t + 2*t^2)) + 2*gZlL^2*gZlR^2*t*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*mm^2*(s + t)*(-4*gZlL^3*gZlR*s - 
      4*gZlL*gZlR^3*s + 2*gZlL^2*gZlR^2*(4*mm^2 - (-6 + d)*s - 
        2*(-5 + d)*t) + gZlL^4*(4*mm^2 - 2*t + d*(s + 2*t)) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*(4*gZlL^3*gZlR*mm^2*((-3 + d)*s^2 + 
        3*(-2 + d)*s*t + 2*(-2 + d)*t^2) + 4*gZlL*gZlR^3*mm^2*
