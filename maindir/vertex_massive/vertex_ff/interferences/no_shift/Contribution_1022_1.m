...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(1 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    (4^(1 - d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(1 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gHll*
      gHWW*gWWZ*(gZlL + gZlR)*mm^2*(psq - s)*(2*psq - s - 2*t)*
    ...
    (4^(1 - d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gHll*
      gHWW*gWWZ*(gZlL + gZlR)*mm^2*(3*psq^2 - 4*psq*s + s^2 - 6*psq*t + 
       4*s*t + 3*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(1 - d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*
      gWWZ*(gZlL + gZlR)*mm^2*(2*mm^2 - 4*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
