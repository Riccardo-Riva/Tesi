...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mz], 
   ...
   (((-I)*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*s*(s + t)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
      (2*s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/
     Pi^(2*d) + (I*4^(2 - d)*(aa - bb)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
      ((-3 + d)*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
      (2*s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1]])/
     Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
      ((-2 + d)*s + d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(2*s + (-2 + d)*t)*
    ...
    (I*4^(2 - d)*(aa - bb)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(s + (-2 + d)*t)*
