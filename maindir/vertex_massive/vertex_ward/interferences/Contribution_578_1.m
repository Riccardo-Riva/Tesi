...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   (((-I)*(-2 + d)*EL^5*gAl*gXll^2*mm^4*s*
      ...
      (bb*(-((-2 + d)*gZlL^2*(mm^2*(2*psq - s - 2*t) + (psq - s)*
           ...
           psq*(2*s - 3*d*s + 4*t - d*t) + 2*s*(-s + d*s + t + d*t))) + 
       aa*((-2 + d)*gZlL^2*(mm^2*(2*psq - s - 2*t) + (psq - s)*
            (psq - s - t)) + (-2 + d)*gZlR^2*(mm^2*(2*psq - s - 2*t) + 
           (psq - s)*(psq - s - t)) + gZlL*gZlR*(-((-4 + d)*psq^2) + 
           psq*((-6 + 5*d)*s + (-4 + d)*t) + mm^2*((4 - 5*d)*psq + d*s - 
             4*t + 5*d*t) - 2*s*((-1 + d)*s + (1 + d)*t))))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*
      (bb*(-((-2 + d)*gZlL^2*(mm^2*(2*psq - s - 2*t) + (psq - s)*
             (psq - t))) - (-2 + d)*gZlR^2*(mm^2*(2*psq - s - 2*t) + 
           (psq - s)*(psq - t)) + gZlL*gZlR*((-4 + d)*psq^2 - 
           psq*(6*s + (-4 + d)*t) + mm^2*((-4 + 5*d)*psq + 4*s - 4*d*s + 
             4*t - 5*d*t) + 2*s*(2*s + t + d*t))) + 
       aa*((-2 + d)*gZlL^2*(mm^2*(2*psq - s - 2*t) + (psq - s)*(psq - t)) + 
         ...
         gZlL*gZlR*(-((-4 + d)*psq^2) + 2*(1 + d)*psq*s + (-4 + d)*psq*t - 
           2*s*(2*s + t + d*t) + mm^2*((4 - 5*d)*psq + 2*d*s - 4*t + 
             5*d*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*
      (bb*((-2 + d)*gZlL^2*(mm^2*(psq - t) + psq*(psq - s - t)) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*s*
      ...
      SPList[SP[p3, q2]])/Pi^(2*d) + (I*EL^5*gAl*gXll^2*mm^2*s*
      (aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       ...
       bb*((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - s - 2*t) + 
         ...
         2*gZlL*gZlR*(4*psq^2 + 2*mm^2*s + d*mm^2*(-psq + t) - 
           4*psq*(s + t) + d*psq*(-psq + s + t))))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^2*
      (bb*((-2 + d)*gZlL^2*mm^2*(mm^2 - t) + (-2 + d)*gZlR^2*mm^2*
          (mm^2 - t) - gZlL*gZlR*(2*mm^2*(5*psq - 4*s - 5*t) + 
           d*mm^2*(mm^2 + psq - s - 2*t) + 2*s*(psq + t))) + 
       aa*(-((-2 + d)*gZlL^2*mm^2*(psq - t)) - (-2 + d)*gZlR^2*mm^2*
          (psq - t) + gZlL*gZlR*((-4 + d)*mm^4 + 2*s*(-psq + t) + 
           mm^2*((14 + d)*psq - (4 + d)*s - 2*(5 + d)*t))))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
      (-(bb*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
           (2*psq - s - 2*t) - gZlL*gZlR*((-4 + d)*(2*psq + s)*
             (psq - s - t) + 4*mm^2*((-2 + d)*psq - s + 2*t - d*t)))) + 
       aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
    ...
    (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
     ...
     Pi^(2*d) + (I*4^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
      ...
      (bb*((-2 + d)*gZlL^2*mm^2*(mm^2 - t) + (-2 + d)*gZlR^2*mm^2*
          (mm^2 - t) - 2*gZlL*gZlR*(2*mm^4 + s*(psq + t) + 
           mm^2*((3 + d)*psq - 6*s - (5 + d)*t))) + 
       aa*(-((-2 + d)*gZlL^2*mm^2*(psq - t)) - (-2 + d)*gZlR^2*mm^2*
          (psq - t) + 2*gZlL*gZlR*(s*(-psq + t) + mm^2*((5 + d)*psq - 4*s - 
             (5 + d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     Pi^(2*d) - (I*4^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
      (aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) + 
         (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) - 
         2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(d*mm^2*(2*psq - s - 2*t) + 
    ...
    (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (aa*psq*(psq - t) + aa*mm^2*(psq - 2*s - t) - bb*(mm^2 + psq)*
