...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (((-I)*4^(-1 - d)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*4^(-1 - d)*(-2 + d)*EL^5*gHll*gHWW*gWlN*
    gWNl*gWWA*mm^2*s*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*
    gWNl*gWWA*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
    gWWA*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gHll*gHWW*gWlN*
    gWNl*gWWA*mm^2*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
    ...
    gWNl*gWWA*mm^2*(aa*(2*mm^2 - psq - s - t) + bb*(-psq + s + t))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
