...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA^3*mm^2*s^2*
  ...
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA^3*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggpgpA^3*(aa*(mm^2 - psq - 2*s)*(psq - s - t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggpgpA^3*(-(bb*(mm^2 - psq - 2*s)*(psq - t)) + 
  ...
  (I*EL^5*gAl^2*ggpgpA^3*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA^3*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/
   Pi^(2*d) - (I*EL^5*gAl^2*ggpgpA^3*s*(aa*(psq - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p1, q1]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggpgpA^3*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*gAl^2*ggpgpA^3*s*(bb*(psq - t) + aa*(-mm^2 + t))*
  ...
  (I*EL^5*gAl^2*ggpgpA^3*(aa*(mm^2 - psq - s)*(psq - s - t) - 
     bb*(-psq^2 + mm^2*(psq + 2*s - t) + psq*(-3*s + t) + s*(s + t)))*
  ...
  (I*EL^5*gAl^2*ggpgpA^3*(-(bb*(mm^2 - psq - s)*(psq - t)) + 
     aa*(-psq^2 + 2*psq*s + mm^2*(psq - 3*s - t) + psq*t + s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^2*ggpgpA^3*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^2*ggpgpA^3*s*(bb*(mm^2 - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^2*ggpgpA^3*s*(bb*(psq - t) + aa*(-mm^2 + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^2*ggpgpA^3*s*(bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA^3*s*(bb*(psq - t) + 
   ...
   Pi^(2*d) - (I*EL^5*gAl^2*ggpgpA^3*(-(bb*(mm^2 - psq - s)*(psq - t)) + 
     aa*(-psq^2 + 2*psq*s + mm^2*(psq - 3*s - t) + psq*t + s*t))*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^2*ggpgpA^3*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^2*ggpgpA^3*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^2*ggpgpA^3*(bb*(mm^2 + psq - s - 2*t) + 
  ...
  (I*4^(1 - d)*EL^5*gAl^2*ggpgpA^3*(aa*(mm^2 - t) + bb*(-psq + t))*
  ...
  (I*4^(1 - d)*EL^5*gAl^2*ggpgpA^3*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggpgpA^3*(aa*(mm^2 - t) + bb*(-psq + t))*
