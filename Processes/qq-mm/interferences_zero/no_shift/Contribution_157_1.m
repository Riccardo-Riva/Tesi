...
((-I/32)*EL^6*gAl*gAu*ggmgmZZ*
  (gZlR*gZuL*(4*mm^4 + 2*(-2 + d)*mu^2*s - 8*s^2 + 6*d*s^2 - d^2*s^2 + 
     ...
     6*d*s^2 - d^2*s^2 + 2*mm^2*(4*mu^2 + (6 - 5*d + d^2)*s - 4*t) - 8*s*t + 
     10*d*s*t - 2*d^2*s*t + 4*t^2) + gZlL*gZuL*(4*mm^4 + 2*(-2 + d)*mu^2*s + 
     4*s^2 - 4*d*s^2 + d^2*s^2 + 2*mm^2*(4*mu^2 - (6 - 5*d + d^2)*s - 4*t) + 
   ...
   gZlR*gZuR*(4*mm^4 + 2*(-2 + d)*mu^2*s + 4*s^2 - 4*d*s^2 + d^2*s^2 + 
     ...
     2*d^2*s*t + 4*t^2))*PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]]])/
 (Pi^4*(mz^2 - s)^2*s)
