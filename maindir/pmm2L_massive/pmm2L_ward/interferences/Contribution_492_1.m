...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*t*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*(s + t)*
