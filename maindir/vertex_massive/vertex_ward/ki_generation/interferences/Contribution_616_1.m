...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[q2, mw], 
 ...
 (-((EL^5*gFFA*gFll^4*mm^4*s*(-2*bb*psq^2 + aa*psq*(2*mm^2 + 2*psq - s) + 
      bb*mm^2*(-2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (2*Pi)^(2*d)) - (EL^5*gFFA*gFll^4*mm^4*s*(-2*bb*psq^2 + 
