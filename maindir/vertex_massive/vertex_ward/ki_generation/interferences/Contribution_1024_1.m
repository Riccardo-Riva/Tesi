...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    ((I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*s*
       (aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + bb*psq*(-psq + t) + 
        bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d))/((mh^2 - mz^2)*
       (2*Pi)^(2*d)) + (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*
       (gZlL + gZlR)*mm^2*(bb*psq*(-psq + t) + 
     ...
     (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
       gWWZ*(gZlL + gZlR)*mm^2*(-(bb*(psq^2 - 2*mm^2*s + psq*(s - t))) + 
        aa*psq*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
       gWWZ*(gZlL + gZlR)*mm^2*(aa*(2*mm^2 + s)*(psq - t) - 
     ...
     (I*4^(1 - d)*(aa + bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
       mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(1 - d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
       gWWZ*(gZlL + gZlR)*mm^2*(bb*(2*mm^2 - psq + s - t) - aa*(psq + s - t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*
       gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p3, q2]])/((mh^2 - mz^2)*Pi^(2*d)) - 
     (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
       mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*
       gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     ...
     (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*bb*(-1 + d)*EL^5*gAl*gHll*gHWW*
       gWWZ*(gZlL + gZlR)*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     ...
     (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*
       gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
     ...
     (I*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
       mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*
