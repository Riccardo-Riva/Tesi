...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, 0], 
  ...
  ((I*4^(-1 - d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (I*4^(-1 - d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*s*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - 2*s)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(-mm^2 + psq)*
    ...
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(-mm^2 + psq)*
    ...
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*(psq^2 + 2*mm^2*(psq - t) - psq*(8*s + t) + 
   ...
   ((3*I)*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(-mm^2 + psq)*
    ...
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*(psq^2 + 2*mm^2*(psq - s - t) - 
   ...
   (I*(aa + bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*s*
    ...
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) - (I*(aa + bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
    ...
    (mz^2*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    (mz^2*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
   ...
   (I*4^(-1 - d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
     (aa*(-2*mm^2 + s + 2*t) - bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa + bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*s*
    ...
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p2, q2]])/(mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*
   ...
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(bb*(3*mm^2 - psq - 2*t) + 
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (mm^2 - psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
      SP[p3, p3]])/(mz^2*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(mm^2 - 9*psq + 4*s + 8*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*aa*(2*psq - s - 2*t) + 
   ...
   (I*(3*aa - 2*bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/
    (mz^2*(2*Pi)^(2*d)) + (I*2^(1 - 2*d)*aa*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p1, q2], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(psq - t)*
   ...
   (I*(3*aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], SP[p2, q1]])/
    (mz^2*(2*Pi)^(2*d)) + (I*(3*aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p2, p3], SP[p2, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*(aa + bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], SP[p3, q1]])/
    (mz^2*(2*Pi)^(2*d)) + (I*(aa + bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(2*mm^2 - psq - t) + 
      bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
      SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*aa*(mm^2 - s - t) + 
      bb*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q1], SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(bb*(psq - t) + 
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) + (I*(2*aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[p2, q2]])/
    (mz^2*(2*Pi)^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(mm^2 - 2*psq + 2*s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2], SP[p3, p3]])/(mz^2*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - t)*
   ...
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(mm^2 + psq - s - 2*t) + 
      bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(3*psq - 2*s - 3*t) + 
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*psq - 2*s - 3*t)*
   ...
   (I*(aa - 2*bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
    ...
    (mz^2*(2*Pi)^(2*d)) - (I*(2*aa - 3*bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
   ...
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(mm^2 - s - t) + 
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)) - (I*(aa - 2*bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
   ...
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(2*mm^2 + psq - s - 3*t) + 
   ...
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(2*mm^2 - psq - t) + 
      ...
      SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(psq - t) + 
   ...
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(2*mm^2 - psq - t) + 
      ...
      SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(3*mm^2 - psq - s - 2*t) + 
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*psq - s - 3*t)*
   ...
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(2*mm^2 - psq - t) + 
      ...
      SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(mm^2 - t) + bb*(-psq + t))*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[p3, q2]])/
    (mz^2*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*
  ...
  (((-I)*4^(-1 - d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (bb*(mm^4 - 2*psq^2 + 11*psq*s - mm^2*(psq + 5*s - 2*t) - 4*s*(s + t)) + 
      aa*(mm^4 + 4*s*(-psq + s + t) + mm^2*(psq - 2*(s + t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*(psq - t)*
