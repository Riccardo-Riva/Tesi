(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((3*4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(2*mu^2 + s)*
     SPList[SP[q1, q1]])/(Pi^(2*d)*s) + 
   (3*4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(mu^2 + s)*
     SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
   (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(s + t)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(s + t)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(s + t)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(4*mu^2 + s - 2*t)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(7*mu^2 + 3*s)*
     SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(mu^2 + s + t)*
     SPList[SP[p1, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(4*mu^2 - 3*(s + t))*
     SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*mu^2*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*t*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(3*mu^2 + 2*(s + t))*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(3*mu^2 + 2*(s + t))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(4*mu^2 + 3*s + 2*t)*
     SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(7*mu^2 + 3*s)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(mu^2 - t)*
     SPList[SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(4*mu^2 + 3*t)*
     SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*mu^2*
     SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(3*mu^2 - 2*t)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(3*mu^2 - 2*t)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*t*
     SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(2*mu^2 + s)*
     SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(2*mu^2 + s)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^4*(2*mu^2 + s)*
     SPList[SP[p3, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mm^2 - s)*(2*mu^2 + s)*
     SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mu^2 + s)*(mm^2 + 2*s)*
     SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mu^2 + s)*
     (5*mm^2 + 2*s)*SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 + s)*(2*mu^2 + s)*
     SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 + s)*(2*mu^2 + s)*
     SPList[SP[q1, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 + s)*(2*mu^2 + s)*
     SPList[SP[q1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 + s)*(2*mu^2 + s)*
     SPList[SP[q1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 + s)*(2*mu^2 + s)*
     SPList[SP[q1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(s + t)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(s + t)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(s + t)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(s + t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mm^2 + s)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(4*mm^2 + s)*
     SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(4*mm^2 + s)*
     SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mm^2 - 2*t)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mm^2 + 2*(s + t))*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 - t)*
     SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 + s + t)*
     SPList[SP[p1, q1], SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 + s + t)*
     SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(4*mu^2 + 3*s + 2*t)*
     SPList[SP[p1, q1], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(4*mu^2 + 3*s + 2*t)*
     SPList[SP[p1, q1], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p1, q1], SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mu^2 + s + t)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 + s + t)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 - t)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mm^2 - t)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mm^2 + s)*
     SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(4*mm^2 + s)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p1, q2], SP[p3, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mu^2 + s + t)*
     SPList[SP[p1, q2], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mu^2 + s + t)*
     SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(4*mu^2 + 3*s + 2*t)*
     SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*t*
     SPList[SP[p2, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*t*
     SPList[SP[p2, q1], SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*t*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*t*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(4*mu^2 + s - 2*t)*
     SPList[SP[p2, q1], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(4*mu^2 + s - 2*t)*
     SPList[SP[p2, q1], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p2, q1], SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mu^2 - t)*
   ...
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mu^2 - t)*
     SPList[SP[p2, q2], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(mu^2 - t)*
     SPList[SP[p2, q2], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(4*mu^2 + s - 2*t)*
     SPList[SP[p2, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFll^2*mm^2*(2*mu^2 + s)*
