...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (8*bb*mm^2 + aa*(-14 + d)*mm^2 + aa*(-6 + d)*psq - 2*bb*(-6 + d)*psq)*
     s^3*\[Mu]^(8 - 2*d))/Pi^(2*d)) + 
  (EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(-(bb*(-14 + d)*mm^2) + 
  ...
  (2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    ...
    (bb*(1 - 2*d)*mm^2 + 4*aa*(-1 + d)*mm^2 + 9*bb*psq - 6*bb*d*psq + 
     2*aa*(-3 + 2*d)*psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
  ...
  (EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(bb*(29 - 3*d)*mm^2 + 
     aa*(-47 + 9*d)*mm^2 + bb*(43 - 11*d)*psq + 5*aa*(-5 + d)*psq)*s*
  ...
  (4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (-(bb*(-1 + d)*mm^2) + aa*(-7 + 5*d)*mm^2 + bb*(7 - 5*d)*psq + 
     ...
     SP[p1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
  ...
  (4^(1 - d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
