...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   ((I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
    ...
    (I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
      (-(mw^2*(19*d*gZlRC*(2*Pi)^d*s*t - 2^(1 + d)*gZlRC*Pi^d*
       ...
       t*(-(gZlRC*(mw^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-2 + d)*s - t)) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      s*GaugeXi[Q]) - (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
      \[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*(3*d*gZlLC*(2*Pi)^d*s*t - 
       3*d*gZlRC*(2*Pi)^d*s*t + 2^(1 + d)*gZlLC*Pi^d*((-2 + d)*s^2 - 3*s*t + 
         t^2) + 2^(1 + d)*gZlRC*Pi^d*(-((-4 + d)*s^2) + 6*s*t + t^2) - 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*t*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(gZlLC*(mw^2*(2^(1 + d)*Pi^d - d*(2*Pi)^d) - d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(s - t)) - 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(gZlLC*(s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
    ...
    (I*2^(2 - d)*EL^6*gAl*gWdu*gWud*gWWA*(gZlLC + gZlRC)*gZuLC*\[Mu]^(4 - d)*
      ...
      SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*(mzC^2 - s)*
      GaugeXi[Q]) + (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
      \[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*(d*gZlRC*(2*Pi)^d*s + 
       gZlLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) - 
       2^(1 + d)*gZlRC*Pi^d*(2*s + t) + 2^(1 + d)*Pi^d*((-2 + d)*gZlLC*s - 
         (-4 + d)*gZlRC*s + 2*gZlLC*t + 2*gZlRC*t)*GaugeXi[Q] + 
       (-(d*gZlLC*(2*Pi)^d*s) + d*gZlRC*(2*Pi)^d*s + 2^(1 + d)*gZlLC*Pi^d*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      ((-4 + d)*gZlLC - (-2 + d)*gZlRC)*gZuLC*(s + t)*\[Mu]^(4 - d)*CKM[1, 1]*
    ...
    (I*2^(2 - d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*((-6 + d)*gZlLC*s - 
       2*gZlLC*t - gZlRC*(d*s + 2*t))*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
    ...
    (I*2^(3 - d)*EL^6*gAl*gWdu*gWud*gWWA*(gZlLC + gZlRC)*gZuLC*\[Mu]^(4 - d)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gWdu*gWud*gWWA*((-2 + d)*gZlLC - (-4 + d)*gZlRC)*
      gZuLC*t*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1], 
       SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*s*(-mzC^2 + s)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gWdu*gWud*gWWA*((-2 + d)*gZlLC - (-4 + d)*gZlRC)*
      ...
      GaugeXi[Q]) - (I*2^(3 - d)*EL^6*gAl*gWdu*gWud*gWWA*(gZlLC + gZlRC)*
      gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1], SP[p3, q1], 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   ((I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*(s + t)*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(d*gZlRC*(2*Pi)^d*s + gZlLC*(-(d*(2*Pi)^d*s) + 
      ...
      (-1 + GaugeXi[Q])^2) + (I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*t*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(d*gZlLC*(2*Pi)^d*s - d*gZlRC*(2*Pi)^d*s + 
    ...
    (I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*s*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
      (d*gZlLC*(2*Pi)^d*s - d*gZlRC*(2*Pi)^d*s + 2^(1 + d)*gZlRC*Pi^d*
        ((-2 + d)*s - t) - 2^(1 + d)*gZlLC*Pi^d*((-1 + d)*s + t) + 
       (d*gZlLC*(2*Pi)^d*s - d*gZlRC*(2*Pi)^d*s + 2^(1 + d)*gZlLC*Pi^d*
          (-s + t) + 2^(1 + d)*gZlRC*Pi^d*(2*s + t))*GaugeXi[Q])*
      SPList[SP[p3, q1], SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*(mzC^2 - s)*
      (-1 + GaugeXi[Q])) + (I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*s*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(-(d*gZlLC*(2*Pi)^d*s) + d*gZlRC*(2*Pi)^d*s + 
       2^(1 + d)*gZlLC*Pi^d*(s - (-3 + d)*t) + 2^(1 + d)*gZlRC*Pi^d*
        (-2*s + (-3 + d)*t) + 2^(1 + d)*Pi^d*((-2 + d)*gZlLC*s - 
         (-4 + d)*gZlRC*s + 2*(-3 + d)*gZlLC*t - 2*(-3 + d)*gZlRC*t)*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*(s + t)*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(d*gZlLC*(2*Pi)^d*s - d*gZlRC*(2*Pi)^d*s + 
       2^(1 + d)*gZlLC*Pi^d*(-s + t) + 2^(1 + d)*gZlRC*Pi^d*(2*s + t) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(d*gZlLC*(2*Pi)^d*s^2 - d*gZlRC*(2*Pi)^d*s^2 + 
       2^(1 + d)*gZlRC*Pi^d*(2*s^2 - (-5 + d)*s*t + 2*t^2) - 
       2^(1 + d)*gZlLC*Pi^d*(s^2 - 2*t^2 + s*(t - d*t)) - 
     ...
     (mw^4*Pi^(2*d)*s*(-mzC^2 + s)*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(gZlLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      GaugeXi[Q]) - (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
      \[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*(d*gZlLC*(2*Pi)^d*s*(s + t) - 
      ...
      SPList[SP[p2, q1], SP[q1, q1], SP[q1, q1]])/
     (mw^4*Pi^(2*d)*s*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
    (I*2^(2 - d)*EL^6*gAl*gWdu*gWud*gWWA*(gZlLC + gZlRC)*gZuLC*s*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   ((I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
     ...
     (Pi^(2*d)*s*(-mzC^2 + s)) + (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
      (5*d^2*gZlLC*(2*Pi)^d*s*t - 5*d^2*gZlRC*(2*Pi)^d*s*t - 
       2^(1 + d)*gZlRC*Pi^d*((8 - 6*d + d^2)*s^2 - 5*(-4 + 3*d)*s*t - 
         (-2 + d)*t^2) + 2^(1 + d)*gZlLC*Pi^d*((-2 + d)^2*s^2 + 
         2*(11 - 7*d)*s*t + (-2 + d)*t^2))*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*(-(d^2*gZlLC*(2*Pi)^d*s) + 
     ...
     (Pi^(2*d)*(mzC^2 - s)) + (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
      ...
      gWWA*((-4 + d)*gZlLC - (-2 + d)*gZlRC)*gZuLC*(s + t)*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[p1, q1]])/
     (Pi^d*s*(-mzC^2 + s)) + (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gWdu*gWud*gWWA*
      gZuLC*((-2 + d)*gZlLC*s - (-4 + d)*gZlRC*s + 2*(-3 + d)*gZlLC*t - 
    ...
    (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
     ...
     (Pi^d*(mzC^2 - s)*s) + (I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(s*(s + t)*GaugeXi[Q]*(d*gZlRC*(2*Pi)^d*s + 
         gZlLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) - 
         2^(1 + d)*gZlRC*Pi^d*(2*s + t) + 2^(1 + d)*Pi^d*((-2 + d)*gZlLC*s - 
           (-4 + d)*gZlRC*s + 2*gZlLC*t + 2*gZlRC*t)*GaugeXi[Q] + 
         (-(d*gZlLC*(2*Pi)^d*s) + d*gZlRC*(2*Pi)^d*s + 2^(1 + d)*gZlLC*Pi^d*
    ...
    (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
     ...
     (Pi^d*(mzC^2 - s)*s) + (I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(-2*mw^2*(-(d*gZlLC*(2*Pi)^d*s*(d*s - 9*t)) + 
         d*gZlRC*(2*Pi)^d*s*(d*s - 9*t) + 2^(1 + d)*gZlRC*Pi^d*
          ((4 - 3*d)*s^2 + (2 + d^2)*s*t - 3*t^2) + 2^(1 + d)*gZlLC*Pi^d*
          (2*(-1 + d)*s^2 - (7 + d^2)*s*t - 3*t^2)) + 
       (gZlRC*(s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-2 + d)*s - t))*t + 
           2^(2 + d)*mw^2*Pi^d*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
             4*t^2)) - gZlLC*(2^(2 + d)*mw^2*Pi^d*((-2 + d)^2*s^2 + 
             2*(8 - 5*d + d^2)*s*t + 4*t^2) + s*t*(-(d*(2*Pi)^d*s) + 
             2^(1 + d)*Pi^d*((-1 + d)*s + t))))*GaugeXi[Q] + 
    ...
    (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gWdu*gWud*gWWA*(gZlLC + gZlRC)*gZuLC*
      \[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p3, q1], SP[p3, q1]])/
     (Pi^d*(mzC^2 - s)) + (I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(2^(1 + d)*mw^2*Pi^d*((-2 + d)*gZlLC*s - 
         (-4 + d)*gZlRC*s + 2*gZlLC*t + 2*gZlRC*t) - 
       s*(-(d*gZlLC*(2*Pi)^d*s) + d*gZlRC*(2*Pi)^d*s + 2^(1 + d)*gZlRC*Pi^d*
          (-((-2 + d)*s) + t) + 2^(1 + d)*gZlLC*Pi^d*((-1 + d)*s + t))*
        GaugeXi[Q] + (2^(1 + d)*gZlRC*mw^2*Pi^d*((-4 + d)*s - 2*t) - 
         2^(1 + d)*gZlLC*mw^2*Pi^d*((-2 + d)*s + 2*t) + 
         gZlLC*s*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZlRC*s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t)))*GaugeXi[Q]^2)*
      SPList[SP[p3, q1], SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*(mzC^2 - s)*
      (-1 + GaugeXi[Q])*GaugeXi[Q]) + (I*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*
      \[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
      ((s^2*(-(d*gZlLC*(2*Pi)^d*s) + d*gZlRC*(2*Pi)^d*s + 
          2^(1 + d)*gZlLC*Pi^d*(s - (-3 + d)*t) + 2^(1 + d)*gZlRC*Pi^d*
           (-2*s + (-3 + d)*t) + 2^(1 + d)*Pi^d*((-2 + d)*gZlLC*s - 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*(s + t)*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(gZlLC*(2^(1 + d)*(-4 + d)*mw^2*Pi^d + 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
     ...
     (mw^4*Pi^(2*d)*s*(-mzC^2 + s)*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(-(d*gZlRC*s*(2^(1 + d)*mw^2*Pi^d + (2*Pi)^d*s)) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
     ...
     (mw^4*Pi^(2*d)*s*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*t*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(-(gZlLC*(2^(1 + d)*(-2 + d)*mw^2*Pi^d + d*(2*Pi)^d*s + 
     ...
     (mw^4*Pi^(2*d)*s*(-mzC^2 + s)*(-1 + GaugeXi[Q])*GaugeXi[Q]) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gWdu*gWud*gWWA*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(gZlLC*(2^(1 + d)*mw^2*Pi^d*((-2 + d)*s - 2*t) + 
    ...
    (I*2^(3 - d)*EL^6*gAl*gWdu*gWud*gWWA*(gZlLC + gZlRC)*gZuLC*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*(mzC^2 - s)*GaugeXi[Q])))/4
