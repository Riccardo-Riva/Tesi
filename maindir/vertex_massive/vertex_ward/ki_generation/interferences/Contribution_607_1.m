...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
 ...
 ((3*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*s*
  ...
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*
    (bb*mm^2*(6*(-3 + 2*d)*gZlR*psq + (-2 + d)*gZlL*s - 3*(-2 + d)*gZlR*s) + 
     aa*(-((-2 + d)*gZlL*psq*s) - 3*gZlR*mm^2*((-6 + 4*d)*psq - (-2 + d)*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
    (4*(-1 + d)*psq - (-4 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*
    (bb*gZlR*mm^2*(-4*(-1 + d)*psq - 3*s) - bb*(-2 + d)*gZlL*(3*mm^2 + 2*psq)*
      s + aa*(-2 + d)*gZlL*(2*mm^2 + 3*psq)*s + 
     aa*gZlR*mm^2*(4*(-1 + d)*psq + 3*s))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*
    (-3*aa*(-1 + d)*gZlR*mm^2*(4*psq - s) + 3*bb*(-1 + d)*gZlR*mm^2*
      (4*psq - s) - bb*(-2 + d)*gZlL*(psq*(4*psq - s) + mm^2*(4*psq + s)) + 
     aa*(-2 + d)*gZlL*(mm^2*(4*psq - s) + psq*(4*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*(-((-1 + d)*gZlR*mm^2) + 
     (-2 + d)*gZlL*(mm^2 + psq))*(4*psq - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*(bb*mm^2 - aa*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*
    (aa*((-2 + d)*gZlL + (-1 + d)*gZlR)*mm^2 + 
     bb*(-((-1 + d)*gZlR*mm^2) - (-2 + d)*gZlL*psq))*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*(bb*mm^2 - aa*psq)*
  ...
  (4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ*(aa*((-2 + d)*gZlL + (-1 + d)*gZlR)*
