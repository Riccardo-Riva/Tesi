...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
    ...
    (((-I)*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*(s + t)*
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*(s + t)*
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*(s + 2*t)*
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(s + t)*
      ...
      (mz^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
       (gZlL + gZlR)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
        SP[q2, q2]])/(mz^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*
       gFFA*gFFZ*(gZlL + gZlR)*(s + t)*\[Mu]^(8 - 2*d)*
     ...
     (I*4^(2 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(s + t)*
      ...
      (mz^2*Pi^(2*d)) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
       (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
        SP[p3, q2]])/(mz^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*t*
      ...
      (mz^2*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
       (gZlL + gZlR)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
        SP[q1, q1]])/(mz^2*Pi^(2*d)) + (I*4^(2 - d)*(-aa + bb)*EL^5*gAl^2*
       gFFA*gFFZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(s + 2*t)*
      ...
      (mz^2*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
       (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(s + t)*
      ...
      (mz^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
       (gZlL + gZlR)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
        SP[p3, q1]])/(mz^2*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*
       gFFZ*(gZlL + gZlR)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
        SP[q1, q1]])/(mz^2*Pi^(2*d)) - (I*4^(2 - d)*(aa - bb)*EL^5*gAl^2*gFFA*
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*t*
      ...
      (mz^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
       (gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
        SP[q2, q2]])/(mz^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*
       gFFA*gFFZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
        SP[p2, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
     (I*4^(2 - d)*(-aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*t*
     ...
     (I*4^(2 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(s + 2*t)*
    ...
    ((I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*(s + t)*
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(s + 2*t)*
      ...
      (mz^2*Pi^(2*d)) - (I*4^(2 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
       (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
        SP[q1, q2]])/(mz^2*Pi^(2*d)) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*
       gFFA*gFFZ*(gZlL + gZlR)*(s + t)*\[Mu]^(8 - 2*d)*
