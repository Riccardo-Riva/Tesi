...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((EL^5*gAl^2*gWWA^3*(8*bb*mm^2 + aa*(-14 + d)*mm^2 + aa*(-6 + d)*psq - 
  ...
  (2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*(-2*aa*((-10 + d)*mm^2 + (-6 + d)*psq) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*(-4*aa*(-1 + d)*mm^2 + bb*(-1 + 2*d)*mm^2 + 
     6*aa*psq - 4*aa*d*psq + 3*bb*(-3 + 2*d)*psq)*s^2*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl^2*gWWA^3*s*(aa*mm^2*(4*(-1 + 3*d)*psq + (25 - 18*d)*s) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*(aa*(47 - 9*d)*mm^2 + bb*(-29 + 3*d)*mm^2 - 
  ...
  (4^(1 - d)*EL^5*gAl^2*gWWA^3*(aa*((7 - 5*d)*mm^2 + psq - d*psq) + 
     bb*((-1 + d)*mm^2 + (-7 + 5*d)*psq))*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*(aa*(2*mm^2 + psq) - 
    ...
    (aa*(17 - 11*d)*mm^2 + bb*(-11 + 7*d)*mm^2 + aa*(11 - 7*d)*psq + 
     bb*(-17 + 11*d)*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
