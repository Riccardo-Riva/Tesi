...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  ((4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*
     (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*(psq - t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*
