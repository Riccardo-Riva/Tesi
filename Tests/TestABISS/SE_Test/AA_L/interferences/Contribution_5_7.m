...
(EL^4*gAl^2*gAu^2*KiraPropagator[q1, MC]*KiraPropagator[q1, ML]*
  KiraPropagator[-p2 + q1, MC]*KiraPropagator[-p2 + q1, ML]*
  ...
  (SP[p2, {newLor2}]*SP[q1, {newLor1}] + SP[p2, {newLor1}]*
   ...
   MC^2*SP[{newLor1}, {newLor2}] - SP[p2, q1]*SP[{newLor1}, {newLor2}] + 
