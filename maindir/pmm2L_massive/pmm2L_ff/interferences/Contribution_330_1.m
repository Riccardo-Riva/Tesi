...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*
      (-(2^(1 + 2*d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(6*psq^3 - 
       ...
       d*(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(psq - s - t)*
          (2*psq^2 + mm^2*(4*psq - 3*s - 4*t) + psq*(s - 4*t) + 
           2*t*(s + t)) + gZlL^2*(2*Pi)^(2*d)*(6*psq^3 - 
           (s + t)*(s + 2*t)^2 - psq^2*(7*s + 16*t) + 
           psq*(4*s^2 + 15*s*t + 14*t^2)) + gZlR^2*(2*Pi)^(2*d)*
          (6*psq^3 - (s + t)*(s + 2*t)^2 - psq^2*(7*s + 16*t) + 
           psq*(4*s^2 + 15*s*t + 14*t^2))))*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*(2^(1 + 2*d)*(gZlL^2 + gZlR^2)*
     ...
     (Pi^(4*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*
      (-((-2 + d)*gZlL^2*(2*psq^3 + 2*mm^2*(psq - t)^2 - 2*t*(s + t)^2 - 
          3*psq^2*(s + 2*t) + psq*t*(7*s + 6*t))) - (-2 + d)*gZlR^2*
        (2*psq^3 + 2*mm^2*(psq - t)^2 - 2*t*(s + t)^2 - 3*psq^2*(s + 2*t) + 
         psq*t*(7*s + 6*t)) + (-4 + d)*gZlL*gZlR*(psq^3 + mm^2*(psq - t)^2 - 
         s^2*t - psq^2*(s + 2*t) + psq*(-s^2 + s*t + t^2)))*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*
     ...
     Pi^(4*d) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*
      ((-2 + d)*gZlL^2*s*(-(psq*s) + 2*mm^2*(psq - t)) + 
       ...
       gZlL*gZlR*(4*(-2 + d)*psq^3 + (-4 + d)*s^3 - 4*s^2*t - 
         4*(-2 + d)*t^3 + psq^2*((8 - 3*d)*s - 12*(-2 + d)*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*((-2 + d)*gZlL^2*mm^2*(psq - s - t)*
        ...
        (2*mm^2 - 3*psq + t) + (-4 + d)*gZlL*gZlR*(-4*psq^3 + 
         5*psq^2*(s + 2*t) + (s + t)^2*(s + 2*t) - 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*(-2*(gZlL^2 + gZlR^2)*s*
        (2*mm^2 - 4*psq + s + 2*t) + d*(gZlL^2*s*(2*mm^2 - 4*psq + s + 2*t) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*((-2 + d)*gZlL^2*mm^2*s*
        (-2*psq + s + 2*t) + (-2 + d)*gZlR^2*mm^2*s*(-2*psq + s + 2*t) + 
       gZlL*gZlR*(-4*(-2 + d)*psq^3 + psq^2*((-8 + 3*d)*s + 12*(-2 + d)*t) + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*mm^2*((-2 + d)*gZlL^2*mm^2*s + 
       (-2 + d)*gZlR^2*mm^2*s - (-4 + d)*gZlL*gZlR*(-4*psq^2 + 3*psq*s - 
         s^2 + mm^2*(psq + s - t) + 7*psq*t - 2*s*t - 3*t^2))*\[Mu]^(8 - 2*d)*
