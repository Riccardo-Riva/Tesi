   ...
   (((-I)*4^(1 - d)*(-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*
    ...
    (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(2*aa*(-2 + d)^2*mm^2 - 
      ...
      (aa*(2*(-4 + d)*mm^2 + (52 - 26*d + 3*d^2)*psq - 16*s + 8*d*s - d^2*s - 
         ...
         (12 - 6*d + d^2)*psq + 16*s - 8*d*s + d^2*s + 20*t - 10*d*t + 
         d^2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
    ...
    (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
      ...
      (bb*(4*(-3 + d)*psq + (20 - 10*d + d^2)*s - 4*(-3 + d)*t) + 
       aa*(2*(8 - 5*d + d^2)*mm^2 - 2*(2 - 3*d + d^2)*psq + 4*s - 4*d*s + 
         d^2*s - 12*t + 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
    ...
    (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
      (aa*(2*(8 - 5*d + d^2)*mm^2 + (28 - 14*d + d^2)*psq - 4*s + 2*d*s - 
         20*t + 10*d*t - d^2*t) + bb*(2*(-4 + d)*mm^2 + 
         (12 - 6*d + d^2)*psq + 4*s - 2*d*s + 20*t - 10*d*t + d^2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
      (bb*(4*(-3 + d)*psq + (20 - 10*d + d^2)*s - 4*(-3 + d)*t) + 
       aa*(2*(8 - 5*d + d^2)*mm^2 - 2*(2 - 3*d + d^2)*psq + 4*s - 4*d*s + 
         d^2*s - 12*t + 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (I*4^(1 - d)*(-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*(bb*(2*mm^2 - psq - t) + 
      ...
      (aa*(-4*(-3 + d)*psq + (8 - 6*d + d^2)*s + 4*(-3 + d)*t) + 
       bb*(2*(8 - 5*d + d^2)*mm^2 - 2*(14 - 7*d + d^2)*psq + 16*s - 8*d*s + 
         d^2*s + 12*t - 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(2*bb*(8 - 5*d + d^2)*mm^2 + 
       aa*(16 - 9*d + d^2)*(psq - t) + bb*(16 - 9*d + d^2)*(psq + t))*
