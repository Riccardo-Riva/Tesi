...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   ((4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(psq - s)*(psq - s - t)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*
      (psq - s)*(psq - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(psq - s)*(2*mm^2 - 3*psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(psq - t)*(psq - 2*s - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(psq - t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
    ...
    (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(2*psq^2 - 3*psq*s + s^2 - 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(psq - t)*(-3*psq + s + 3*t)*
     ...
     Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(psq - t)*(-2*psq + s + 2*t)*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(psq - t)*
      ...
      (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(2*psq - s - 2*t)*
