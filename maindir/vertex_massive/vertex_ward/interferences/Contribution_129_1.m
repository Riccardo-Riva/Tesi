 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*s*
    ...
    (aa*mm^2*(4*psq - 7*s) - aa*psq*(4*psq + s) + bb*mm^2*(-4*psq + 3*s) + 
     bb*psq*(4*psq + 5*s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*s*
    (aa*mm^2*(2*psq - 5*s) + 2*bb*mm^2*(-psq + s) - aa*psq*(2*psq + s) + 
     2*bb*psq*(psq + 2*s))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*(-5*aa*mm^2 + 2*bb*mm^2 - 
     3*aa*psq + 6*bb*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
  ...
  (2^(1 - 2*d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*(-7*aa*mm^2 + 4*bb*mm^2 - 
     5*aa*psq + 8*bb*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   Pi^(2*d) + (4^(1 - d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*
    (-2*aa*(psq^2 + mm^2*(-psq + s)) + 
     bb*(mm^2*(-2*psq + s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
