...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(3*mm^2 + psq - 2*s)*
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*((8 - 6*d)*psq^3 + 8*s*t*(s + t) + 
       psq^2*((20 - 3*d)*s + 4*(-4 + 3*d)*t) + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
      (-2*(-4 + d)*psq^3 + (4 + d)*mm^2*(2*psq - s - 2*t)*(psq - t) - 
       8*s*t*(s + t) + psq*t*(-((-20 + d)*s) - 2*(-4 + d)*t) + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (mm^4*s*((2 + d)*psq - 2*s - (2 + d)*t) + 
       s*((-10 + d)*psq^3 - 8*psq*t*(2*s + 3*t) + psq^2*(4*s - (-26 + d)*t) + 
         4*t*(s^2 + 3*s*t + 2*t^2)) + 2*mm^2*(8*psq^3 - 
         psq^2*((4 + d)*s + 24*t) - 4*t*(s^2 + 3*s*t + 2*t^2) + 
         psq*(s^2 + (16 + d)*s*t + 24*t^2)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (mm^2 - psq)*(psq - s - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2 - psq)*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
      ...
      (2*(-2 + d)*psq^3 - 4*s*t*(s + t) + psq^2*((-10 + 3*d)*s - 
         ...
         2*(-2 + d)*t^2) + mm^2*(-2*(-6 + d)*psq^2 - 3*(2 + d)*psq*s + 
         4*(-6 + d)*psq*t + (s + t)*((2 + d)*s - 2*(-6 + d)*t)))*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*(psq - t)^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((-2 + d)*psq^3 + 4*s*t*(s + t) + 
       psq^2*(-((-6 + d)*s) - 2*(-2 + d)*t) + 
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(4*psq^3 + 
       d*(mm^2 - psq)*(psq - t)^2 - 2*psq^2*(s + 5*t) + 
       psq*(-(mm^2*s) + 6*s*t + 8*t^2) + t*(mm^2*s - 2*(s + t)^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-((-6 + d)*psq^3) - 
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*(-4 + d)*psq^2 - 
