(PropList[KiraPropagator[q1, mh], KiraPropagator[-p1 - p2 + q1, mz]]*
   (((I/16)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(4*mm^4 - 8*s^2 + 6*d*s^2 - 
         ...
         2*mm^2*(-((6 - 5*d + d^2)*s) - 4*t) + 16*s*t - 10*d*s*t + 
         2*d^2*s*t + 4*t^2)))/(Pi^4*(mz^2 - s)^2*s) - 
    ((I/16)*EL^6*gAl*gAu*gHZZ^2*((gZlL + gZlR)*(gZuL + gZuR)*s - 
       ((-3 + d)*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - t)^2)/s + 
       ((-3 + d)*(gZlL - gZlR)*(gZuL - gZuR)*(-mm^2 + s + t)^2)/s)*
      SPList[SP[q1, q1]])/(Pi^4*(mz^3 - mz*s)^2) + 
    ...
    ((I/8)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2*mm^2 + 4*s - d*s - 2*t) + 
  ...
  PropList[KiraPropagator[q1, mh], KiraPropagator[-p1 - p2 + q1, 
   ...
   (((I/16)*EL^6*gAl*gAu*gHZZ^2*((gZlL + gZlR)*(gZuL + gZuR)*s - 
    ...
    ((I/8)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2*mm^2 + 4*s - d*s - 2*t) + 
       ...
       gZlR*gZuR*(2*mm^2 - 2*s + d*s - 2*t))*SPList[SP[p2, q1], SP[p3, q1]])/
     (Pi^4*s*(mz^3 - mz*s)^2) + ((I/4)*EL^6*gAl*gAu*gHZZ^2*(gZlL + gZlR)*
      (gZuL + gZuR)*SPList[SP[p3, q1], SP[p3, q1]])/(Pi^4*(mz^3 - mz*s)^2)))/4
