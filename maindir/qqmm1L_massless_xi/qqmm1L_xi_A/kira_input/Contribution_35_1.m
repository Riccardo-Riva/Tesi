...
(I*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*\[Mu]^(4 - d)*
   userIntegral[B21, {mz}, -2, 1, 1, 0])/(mz^4*Pi^d) + 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   ...
   userIntegral[B21, {mz}, -1, 0, 1, 0])/(mz^4*Pi^(2*d)*s*
   (-1 + GaugeXi[Q])^2) - (I*2^(-3 - d)*EL^6*gAl*gAu*
   (gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 2*gZuR^2*(3*s + t)) + 
    gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*
   userIntegral[B21, {mz}, -1, 1, 0, 0])/(mz^4*Pi^d*s) - 
 (I*2^(-2 - 3*d)*EL^6*gAl*gAu*
   ...
   \[Mu]^(4 - d)*((2*Pi)^(2*d) - 2^(1 + 2*d)*Pi^(2*d)*GaugeXi[Q] + 
    (2*Pi)^(2*d)*GaugeXi[Q]^2)*userIntegral[B21, {mz}, -1, 1, 1, -1])/
  (mz^4*Pi^(3*d)*s*(-1 + GaugeXi[Q])^2) - 
 (I*2^(-3 - d)*EL^6*gAl*gAu*(2*mz^2 - s)*
   (gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 2*gZuR^2*(3*s + t)) + 
    gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*
   userIntegral[B21, {mz}, -1, 1, 1, 0])/(mz^4*Pi^d*s) + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2*((-56 + 46*d - 12*d^2 + d^3)*gZuL^2 - 
      (-52 + 44*d - 12*d^2 + d^3)*gZuR^2) + 
    gZlR^2*(-((-52 + 44*d - 12*d^2 + d^3)*gZuL^2) + 
      (-56 + 46*d - 12*d^2 + d^3)*gZuR^2))*\[Mu]^(4 - d)*
   userIntegral[B21, {mz}, -1, 1, 1, 1])/Pi^d - 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*
   ...
   userIntegral[B21, {mz}, 0, -1, 1, 0])/(mz^4*Pi^(2*d)*s) + 
 (I*4^(-1 - d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (gZlL^2*(gZuR^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
      gZuL^2*(-3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s - t + 2*d*t))) + 
    gZlR^2*(gZuL^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
      gZuR^2*(-3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s - t + 2*d*t))) - 
    2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(2*s - (-4 + d)*t) + 
        gZuL^2*(2*s + (-2 + d)*t)) + gZlR^2*(gZuL^2*(2*s - (-4 + d)*t) + 
        gZuR^2*(2*s + (-2 + d)*t)))*GaugeXi[Q] + 
    (gZlL^2*(gZuR^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
        gZuL^2*(-3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s - t + 2*d*t))) + 
      gZlR^2*(gZuL^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
        gZuR^2*(-3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s - t + 2*d*t))))*
     GaugeXi[Q]^2)*userIntegral[B21, {mz}, 0, 0, 0, 0])/
 ...
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   ...
   userIntegral[B21, {mz}, 0, 0, 1, -1])/(mz^4*Pi^(2*d)*s*
   (-1 + GaugeXi[Q])^2) + (I*4^(-1 - d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (gZlR^2*(-(d*(gZuL^2 - gZuR^2)*s*(mz^2*(2^(1 + d)*Pi^d - 3*(2*Pi)^d) + 
    ...
    gZlL^2*(-(gZuR^2*(-(2^(1 + d)*Pi^d*(s^2 + mz^2*t + s*t)) + 
         d*s*(mz^2*(2^(1 + d)*Pi^d - 3*(2*Pi)^d) + 2^(1 + d)*Pi^d*(s + 4*t) - 
           (2*Pi)^d*(s + 7*t)))) + 
    ...
    (gZlR^2*(-(d*(gZuL^2 - gZuR^2)*s*(mz^2*(2^(1 + d)*Pi^d - 3*(2*Pi)^d) + 
      ...
      gZlL^2*(-(gZuR^2*(-(2^(1 + d)*Pi^d*(s^2 + mz^2*t + s*t)) + 
        ...
        gZuL^2*(mz^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((3 + d)*s + t)) + 
          s*(-(d*(2*Pi)^d*(s + 7*t)) + 2^(1 + d)*Pi^d*(-2*s + d*s - 2*t + 
              4*d*t)))))*GaugeXi[Q]^2)*userIntegral[B21, {mz}, 0, 0, 1, 0])/
  (mz^4*Pi^(2*d)*s*(-1 + GaugeXi[Q])^2) - 
 (I*2^(-3 - 4*d)*EL^6*gAl*gAu*
   ...
   ((2*Pi)^(3*d) - 2^(1 + 3*d)*Pi^(3*d)*GaugeXi[Q] + 
    (2*Pi)^(3*d)*GaugeXi[Q]^2)*userIntegral[B21, {mz}, 0, 0, 1, 1])/
  (Pi^(4*d)*s*(-1 + GaugeXi[Q])^2) + 
 (I*2^(-3 - d)*EL^6*gAl*gAu*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
    gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*(s + t)*\[Mu]^(4 - d)*
   userIntegral[B21, {mz}, 0, 1, -1, 0])/(mz^4*Pi^d*s) - 
 (I*EL^6*gAl*gAu*\[Mu]^(4 - d)*(3*2^(1 + 2*d)*(gZlL^2 + gZlR^2)*
    ...
    ((d*(gZlL^2 - gZlR^2)*(gZuL^2 - gZuR^2)*s - 
     ...
     (s*(-1 + GaugeXi[Q])^2))*userIntegral[B21, {mz}, 0, 1, 0, -1])/
  (2^(3*(1 + d))*mz^4*Pi^(3*d)) + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*
   ...
   \[Mu]^(4 - d)*userIntegral[B21, {mz}, 0, 1, 0, 0])/(mz^4*Pi^d*s) - 
 (I*8^(-1 - 2*d)*EL^6*gAl*gAu*
   ...
   ((2*Pi)^(5*d) - 2^(1 + 5*d)*Pi^(5*d)*GaugeXi[Q] + 
    (2*Pi)^(5*d)*GaugeXi[Q]^2)*userIntegral[B21, {mz}, 0, 1, 0, 1])/
  (Pi^(6*d)*s*(-1 + GaugeXi[Q])^2) + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*\[Mu]^(4 - d)*
   userIntegral[B21, {mz}, 0, 1, 1, -2])/(mz^4*Pi^d) - 
 (I*2^(-3 - d)*EL^6*gAl*gAu*(2*mz^2 - s)*
   (gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 2*gZuR^2*(3*s + t)) + 
    gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*
   userIntegral[B21, {mz}, 0, 1, 1, -1])/(mz^4*Pi^d*s) - 
 (I*8^(-1 - 2*d)*EL^6*gAl*gAu*
   (gZlL^2*(gZuR^2*(-((-2 + d)*(2*Pi)^(5*d)*s^2*(s + t)) + 
      ...
      gZuL^2*((-4 + d)*(2*Pi)^(5*d)*s^2*(s + t) - 2^(1 + 5*d)*mz^4*Pi^(5*d)*
        ...
        2^(2 + 5*d)*mz^2*Pi^(5*d)*((8 - 5*d + d^2)*s^2 + (20 - 11*d + 2*d^2)*
           s*t + 4*t^2))) + 
    gZlR^2*(gZuL^2*(-((-2 + d)*(2*Pi)^(5*d)*s^2*(s + t)) + 
      ...
      gZuR^2*((-4 + d)*(2*Pi)^(5*d)*s^2*(s + t) - 2^(1 + 5*d)*mz^4*Pi^(5*d)*
         ((-122 + 87*d - 18*d^2 + d^3)*s + 2*(-55 + 46*d - 12*d^2 + d^3)*t) + 
        2^(2 + 5*d)*mz^2*Pi^(5*d)*((8 - 5*d + d^2)*s^2 + (20 - 11*d + 2*d^2)*
           s*t + 4*t^2))))*\[Mu]^(4 - d)*userIntegral[B21, {mz}, 0, 1, 1, 0])/
  (mz^4*Pi^(6*d)*s) + 
 (((-I)*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*mz^2*
   ...
   ((3*I)*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*s^2*
     \[Mu]^(4 - d))/(mz^2*Pi^d) + (I*2^(-2 - d)*EL^6*gAl*gAu*
     (gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*s^3*\[Mu]^(4 - d))/(mz^4*Pi^d) + 
   ...
   (I*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*t^3*
     ...
     (-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d)) + 
         gZuL^2*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d))) + 
      gZlL^2*(gZuL^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d) - 
        gZuR^2*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d)))*(s + t)*
     \[Mu]^(4 - d))/Pi^(2*d) - 
   (I*EL^6*gAl*gAu*
   ...
   (I*2^(-3 - 2*d)*EL^6*gAl*gAu*mz^2*
     (-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d)) + 
      ...
      gZlL^2*(gZuL^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d) - 
        gZuR^2*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d)))*(s + t)*
     \[Mu]^(4 - d))/(Pi^(2*d)*s) + (I*2^(-3 - 2*d)*EL^6*gAl*gAu*mz^2*
     (gZlR^2*(-(gZuR^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d)) + 
        gZuL^2*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d)) + 
   ...
   (I*EL^6*gAl*gAu*
     (-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
           ...
           d^3*(2*Pi)^d))) + gZlL^2*
       (gZuL^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d) - 
        gZuR^2*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d)))*t*
     (s + t)*\[Mu]^(4 - d))/(2^(2*(1 + d))*Pi^(2*d)*s) - 
   (I*2^(-3 - 2*d)*EL^6*gAl*gAu*
     (-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d)) + 
         gZuL^2*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d))) + 
      gZlL^2*(gZuL^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d) - 
   ...
   (I*EL^6*gAl*gAu*s*
     (gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      gZlR^2*(gZuL^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
           (s^2 - (-2 + d)*s*t + t^2)) - gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
          2^(1 + d)*Pi^d*(2*s^2 - (-4 + d)*s*t + 2*t^2))))*\[Mu]^(4 - d))/
    (2^(2*(1 + d))*mz^4*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*t*
     (gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
          d*(2*Pi)^d*(s^2 + t^2)) + gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
          2^(1 + d)*Pi^d*(s^2 - (-2 + d)*s*t + t^2))) + 
      gZlR^2*(gZuL^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
   ...
   (I*2^(-2 - 3*d)*EL^6*gAl*gAu*t*(-(d*(gZlL^2 - gZlR^2)*(gZuL^2 - gZuR^2)*
   ...
   (I*4^(-1 - 2*d)*EL^6*gAl*gAu*(s + t)*
     (gZlR^2*(gZuR^2*((-2 + d)*s^2 + (-2 + d)*s*t - (-4 + d)*t^2) + 
      ...
      gZlL^2*(gZuL^2*((-2 + d)*s^2 + (-2 + d)*s*t - (-4 + d)*t^2) + 
        gZuR^2*(-((-4 + d)*s^2) - (-4 + d)*s*t + (-2 + d)*t^2)))*
     \[Mu]^(4 - d)*((2*Pi)^(3*d) - 2^(1 + 3*d)*Pi^(3*d)*GaugeXi[Q] + 
      (2*Pi)^(3*d)*GaugeXi[Q]^2))/(mz^2*Pi^(4*d)*s*(-1 + GaugeXi[Q])^2) - 
   (I*2^(-3 - 4*d)*EL^6*gAl*gAu*(s + t)^2*
     ...
     (gZlL^2*(gZuR^2*((2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*s*t + (2*Pi)^d*t^2) + 
      ...
      (gZlL^2*(gZuR^2*((2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*s*t + (2*Pi)^d*t^2) + 
          gZuL^2*((2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*s*t - 2^(1 + d)*Pi^d*t^2 + 
            ...
            2^(1 + d)*Pi^d*s*t + (2*Pi)^d*t^2) + 
          gZuR^2*((2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*s*t - 2^(1 + d)*Pi^d*t^2 + 
            3*(2*Pi)^d*t^2)))*GaugeXi[Q]^2))/(mz^4*Pi^(2*d)*
   ...
   (I*2^(-3 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
    ...
    (Pi^(2*d)*(-1 + GaugeXi[Q])^2) - (I*2^(-3 - 2*d)*EL^6*gAl*gAu*mz^2*
     \[Mu]^(4 - d)*
     (gZlL^2*(-(gZuR^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((2 + d)*s - 
             (-3 + d)*t))) + gZuL^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
           (s + d*s + 3*t - d*t))) - 
   ...
   (I*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
     ...
     \[Mu]^(4 - d)*(gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(7*s + 9*t)) + 
           2^(1 + d)*Pi^d*(s + 3*d*s + t + 4*d*t))) + 
        gZuL^2*(-(d*(2*Pi)^d*(7*s + 9*t)) + 2^(1 + d)*Pi^d*
           (2*s + 3*d*s + 2*t + 4*d*t))) - 
      ...
      (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*(9*s + 17*t)) + 2^(1 + d)*Pi^d*(-s + 
        ...
        gZlL^2*(gZuL^2*(-(d*(2*Pi)^d*(9*s + 17*t)) + 2^(1 + d)*Pi^d*
           ...
           (-(d*(2*Pi)^d*(9*s + 17*t)) + 2^(1 + d)*Pi^d*((-2 + 5*d)*s + 
              7*(1 + d)*t))))*GaugeXi[Q]^2))/(2^(2*(1 + d))*mz^2*Pi^(2*d)*s*
     (-1 + GaugeXi[Q])^2) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
     (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s + 3*t)) + 2^(1 + d)*Pi^d*
      ...
      (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s + 3*t)) + 2^(1 + d)*Pi^d*(
          ...
          gZuR^2*(-(d*(2*Pi)^d*(s + 3*t)) + 2^(1 + d)*Pi^d*((-1 + d)*s + 
              (-1 + 2*d)*t))))*GaugeXi[Q]^2))/
    (Pi^(2*d)*(-1 + GaugeXi[Q])^2) - (I*EL^6*gAl*gAu*mz^2*\[Mu]^(4 - d)*
     (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s + 3*t)) + 2^(1 + d)*Pi^d*
             ((-2 + d)*s + 2*(-1 + d)*t))) + 
         gZuL^2*(-(d*(2*Pi)^d*(s + 3*t)) + 2^(1 + d)*Pi^d*((-1 + d)*s + 
             (-1 + 2*d)*t)))) + 
   ...
   (I*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
    ...
    (2^(2*(1 + d))*mz^4*Pi^(2*d)) - (I*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
     (2^(1 + d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*Pi^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)*s) + (I*EL^6*gAl*gAu*t*(s + t)*\[Mu]^(4 - d)*
     (2^(1 + d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*Pi^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (mz^2*Pi^(2*d)) - (I*EL^6*gAl*gAu*\[Mu]^(4 - d)*
     ((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*
     \[Mu]^(4 - d)*((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
            d*(2*Pi)^d*(s^2 + t^2)) + gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (Pi^(2*d)*s) + (I*EL^6*gAl*gAu*s*\[Mu]^(4 - d)*
     ((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (mz^4*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*
     ((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (mz^2*Pi^(2*d)*s) - (I*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*
     ((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
   ...
   ((I/4)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
     ((2^(2 - d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*(s + t)^2)/Pi^d + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
        ...
        (-1 + GaugeXi[Q])^2)))/mz^2 + (((3*I)/8)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
     ((2^(2 - d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*(s + t)^2)/Pi^d + 
      (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*
                t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
           gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/s - ((I/4)*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*
     ((2^(2 - d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*(s + t)^2)/Pi^d + 
      (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*
                t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
           gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/s - ((I/8)*EL^6*gAl*gAu*s*\[Mu]^(4 - d)*
     ((2^(1 - d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
         gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*t*(s + t))/Pi^d - 
      (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*
                t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
       ...
       (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*
        ...
        (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*
          ...
          gZlL^2*(gZuL^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*(s^2 - 
              ...
              2^(1 + d)*Pi^d*(2*s^2 - (-3 + d)*s*t + t^2))))*GaugeXi[Q]^2))/
      (mz^4*Pi^(2*d)*s*(-1 + GaugeXi[Q])^2)) + (I/8)*EL^6*gAl*gAu*s*
    \[Mu]^(4 - d)*
    ((2^(1 - 2*d)*(-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
              d^3*(2*Pi)^d)) + gZuL^2*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - 
             d^3*(2*Pi)^d))) + gZlL^2*
       ...
       (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*
        ...
        (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*
          ...
          gZlL^2*(gZuL^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*(s^2 - 
                d*s*t - t^2)) - gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 
              2^(1 + d)*Pi^d*(2*s^2 - (-3 + d)*s*t + t^2))))*GaugeXi[Q]^2))/
      (mz^4*Pi^(2*d)*s*(-1 + GaugeXi[Q])^2)) + (I/8)*EL^6*gAl*gAu*t*
    \[Mu]^(4 - d)*
    ((2^(1 - 2*d)*(-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
              d^3*(2*Pi)^d)) + gZuL^2*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - 
             d^3*(2*Pi)^d))) + gZlL^2*
 ...
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
   (-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d)) + 
    ...
    (-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
       ...
       (gZuL^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d) - 
        gZuR^2*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d)))*
     GaugeXi[Q]^2)*userIntegral[B21, {mz}, 1, -1, 1, 1])/
  (Pi^(2*d)*s*(-1 + GaugeXi[Q])^2) + 
 (I*4^(-1 - 2*d)*EL^6*gAl*gAu*
   (gZlR^2*((-4 + d)*gZuR^2*(2*(14 - 8*d + d^2)*s + (-4 - 2*d + d^2)*t) - 
      gZuL^2*(2*(-52 + 44*d - 12*d^2 + d^3)*s + (8 + 6*d - 6*d^2 + d^3)*t)) + 
    gZlL^2*((-4 + d)*gZuL^2*(2*(14 - 8*d + d^2)*s + (-4 - 2*d + d^2)*t) - 
      gZuR^2*(2*(-52 + 44*d - 12*d^2 + d^3)*s + (8 + 6*d - 6*d^2 + d^3)*t)))*
   \[Mu]^(4 - d)*((2*Pi)^(3*d) - 2^(1 + 3*d)*Pi^(3*d)*GaugeXi[Q] + 
    (2*Pi)^(3*d)*GaugeXi[Q]^2)*userIntegral[B21, {mz}, 1, 0, 0, 1])/
  (Pi^(4*d)*s*(-1 + GaugeXi[Q])^2) - 
 (I*2^(-3 - 4*d)*EL^6*gAl*gAu*
   (gZlR^2*((-4 + d)*gZuR^2*(3*(20 - 10*d + d^2)*s + 2*(14 - 8*d + d^2)*t) + 
      gZuL^2*((216 - 170*d + 42*d^2 - 3*d^3)*s - 
    ...
    gZlL^2*((-4 + d)*gZuL^2*(3*(20 - 10*d + d^2)*s + 2*(14 - 8*d + d^2)*t) + 
      gZuR^2*((216 - 170*d + 42*d^2 - 3*d^3)*s - 
        2*(-52 + 44*d - 12*d^2 + d^3)*t)))*\[Mu]^(4 - d)*
   ((2*Pi)^(3*d) - 2^(1 + 3*d)*Pi^(3*d)*GaugeXi[Q] + 
    (2*Pi)^(3*d)*GaugeXi[Q]^2)*userIntegral[B21, {mz}, 1, 0, 1, 0])/
  (Pi^(4*d)*s*(-1 + GaugeXi[Q])^2) + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*
   (gZlR^2*((-4 + d)*gZuR^2*(-((s + t)*((36 - 16*d + d^2)*s - 
           4*(-2 + d)*t)) + mz^2*(3*(20 - 10*d + d^2)*s + 
          2*(14 - 8*d + d^2)*t)) + gZuL^2*((-144 + 98*d - 20*d^2 + d^3)*s^2 + 
        (-184 + 122*d - 24*d^2 + d^3)*s*t - 4*(10 - 6*d + d^2)*t^2 + 
        mz^2*((216 - 170*d + 42*d^2 - 3*d^3)*s - 2*(-52 + 44*d - 12*d^2 + 
            d^3)*t))) + 
    gZlL^2*((-4 + d)*gZuL^2*(-((s + t)*((36 - 16*d + d^2)*s - 
           4*(-2 + d)*t)) + mz^2*(3*(20 - 10*d + d^2)*s + 
          2*(14 - 8*d + d^2)*t)) + gZuR^2*((-144 + 98*d - 20*d^2 + d^3)*s^2 + 
        (-184 + 122*d - 24*d^2 + d^3)*s*t - 4*(10 - 6*d + d^2)*t^2 + 
        mz^2*((216 - 170*d + 42*d^2 - 3*d^3)*s - 2*(-52 + 44*d - 12*d^2 + 
            d^3)*t))))*\[Mu]^(4 - d)*userIntegral[B21, {mz}, 1, 0, 1, 1])/
  (Pi^d*s) + (I*2^(-3 - d)*EL^6*gAl*gAu*
   (gZlL^2*((-128 + 88*d - 18*d^2 + d^3)*gZuL^2 - 
      (-112 + 82*d - 18*d^2 + d^3)*gZuR^2) + 
    gZlR^2*(-((-112 + 82*d - 18*d^2 + d^3)*gZuL^2) + 
      (-128 + 88*d - 18*d^2 + d^3)*gZuR^2))*(s + t)*\[Mu]^(4 - d)*
   userIntegral[B21, {mz}, 1, 1, -1, 1])/(Pi^d*s) - 
 (I*8^(-1 - 2*d)*EL^6*gAl*gAu*
   (gZlR^2*((-4 + d)*gZuR^2*(3*(20 - 10*d + d^2)*s + 2*(14 - 8*d + d^2)*t) + 
      gZuL^2*((216 - 170*d + 42*d^2 - 3*d^3)*s - 
        2*(-52 + 44*d - 12*d^2 + d^3)*t)) + 
    gZlL^2*((-4 + d)*gZuL^2*(3*(20 - 10*d + d^2)*s + 2*(14 - 8*d + d^2)*t) + 
      gZuR^2*((216 - 170*d + 42*d^2 - 3*d^3)*s - 
        2*(-52 + 44*d - 12*d^2 + d^3)*t)))*\[Mu]^(4 - d)*
   ((2*Pi)^(5*d) - 2^(1 + 5*d)*Pi^(5*d)*GaugeXi[Q] + 
    (2*Pi)^(5*d)*GaugeXi[Q]^2)*userIntegral[B21, {mz}, 1, 1, 0, 0])/
  (Pi^(6*d)*s*(-1 + GaugeXi[Q])^2) + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*
   (gZlR^2*((-4 + d)*gZuR^2*(-((s + t)*((36 - 16*d + d^2)*s - 
           4*(-2 + d)*t)) + mz^2*(3*(20 - 10*d + d^2)*s + 
    ...
    gZlL^2*((-4 + d)*gZuL^2*(-((s + t)*((36 - 16*d + d^2)*s - 
        ...
        (-184 + 122*d - 24*d^2 + d^3)*s*t - 4*(10 - 6*d + d^2)*t^2 + 
        mz^2*((216 - 170*d + 42*d^2 - 3*d^3)*s - 2*(-52 + 44*d - 12*d^2 + 
            d^3)*t))))*\[Mu]^(4 - d)*userIntegral[B21, {mz}, 1, 1, 0, 1])/
  (Pi^d*s) + (I*2^(-2 - d)*EL^6*gAl*gAu*
    ...
    gZlL^2*(gZuL^2*((-256 + 188*d - 42*d^2 + 3*d^3)*s^2 + 
      ...
      gZuR^2*((248 - 178*d + 42*d^2 - 3*d^3)*s^2 - 
        ...
        2*mz^2*((-216 + 170*d - 42*d^2 + 3*d^3)*s + 
          2*(-52 + 44*d - 12*d^2 + d^3)*t))))*\[Mu]^(4 - d)*
   ((2*Pi)^(5*d) - 2^(1 + 5*d)*Pi^(5*d)*GaugeXi[Q] + 
    (2*Pi)^(5*d)*GaugeXi[Q]^2)*userIntegral[B21, {mz}, 1, 1, 1, 0])/
  (Pi^(6*d)*s*(-1 + GaugeXi[Q])^2) + 
 ((I*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*mz^2*(s + t)*
     \[Mu]^(4 - d))/Pi^d + (I*EL^6*gAl*gAu*mz^2*
     (-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
            d^3*(2*Pi)^d)) + gZuL^2*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - 
           d^3*(2*Pi)^d))) + gZlL^2*
       (gZuL^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d) - 
   ...
   (I*2^(-3 - 2*d)*EL^6*gAl*gAu*
     (-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
           ...
           d^3*(2*Pi)^d))) + gZlL^2*
       (gZuL^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d) - 
        gZuR^2*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d)))*s*
     (s + t)*\[Mu]^(4 - d))/Pi^(2*d) + 
   ((3*I)*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*s^2*
     (s + t)*\[Mu]^(4 - d))/(mz^2*Pi^d) - 
   ...
   (I*2^(-3 - 2*d)*EL^6*gAl*gAu*t^3*
    ...
    (mz^2*Pi^(2*d)*s) - (I*2^(-3 - 2*d)*EL^6*gAl*gAu*(s + t)^2*
     (gZlL^2*(gZuL^2*(2^(2 + d)*Pi^d*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*
      ...
      gZlR^2*(gZuL^2*(-(2^(2 + d)*Pi^d*((8 - 6*d + d^2)*s^2 + 
            ...
            2^(1 + d)*Pi^d*((28 - 19*d + 5*d^2)*s + (-116 + 108*d - 32*d^2 + 
                3*d^3)*t))) - gZuR^2*(-(2^(2 + d)*Pi^d*((-2 + d)^2*s^2 + 
             2*(8 - 5*d + d^2)*s*t + 4*t^2)) + mz^2*(-(d^3*(2*Pi)^d*s) + 
            2^(1 + d)*Pi^d*((8 - 14*d + 5*d^2)*s + (-136 + 114*d - 32*d^2 + 
                3*d^3)*t)))))*\[Mu]^(4 - d))/(mz^2*Pi^(2*d)*s) + 
   ...
   ((3*I)*4^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*
     (mz^2 - s)^2*t*(s + t)*\[Mu]^(4 - d)*((2*Pi)^d - 
      2^(1 + d)*Pi^d*GaugeXi[Q] + (2*Pi)^d*GaugeXi[Q]^2))/
    (mz^4*Pi^(2*d)*(-1 + GaugeXi[Q])^2) - 
   ((3*I)*4^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*
     (mz^2 - s)*t^2*(s + t)*\[Mu]^(4 - d)*((2*Pi)^d - 
      2^(1 + d)*Pi^d*GaugeXi[Q] + (2*Pi)^d*GaugeXi[Q]^2))/
    (mz^4*Pi^(2*d)*(-1 + GaugeXi[Q])^2) + 
   ...
   (I*2^(-3 - 2*d)*EL^6*gAl*gAu*(s + t)^2*\[Mu]^(4 - d)*
     (gZlL^2*(gZuL^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
      ...
      (gZlL^2*(gZuL^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
        ...
        gZlR^2*(gZuL^2*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
          gZuR^2*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d)))*GaugeXi[Q]^2))/
    (Pi^(2*d)*(-1 + GaugeXi[Q])^2) + (I*4^(-1 - d)*EL^6*gAl*gAu*(s + t)^2*
     \[Mu]^(4 - d)*(gZlL^2*(gZuL^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
      ...
      (gZlL^2*(gZuL^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
        ...
        gZlR^2*(gZuL^2*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
          gZuR^2*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d)))*GaugeXi[Q]^2))/
    (Pi^(2*d)*(-1 + GaugeXi[Q])^2) - (I*2^(-3 - 2*d)*EL^6*gAl*gAu*mz^2*
     (s + t)^2*\[Mu]^(4 - d)*(gZlL^2*(gZuL^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
        gZuR^2*(-(2^(1 + d)*Pi^d) + d*(2*Pi)^d)) - 
      gZlR^2*(gZuL^2*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        gZuR^2*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d)) + 
      2^(1 + d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
     ...
     (gZlR^2*(d*(gZuL^2 - gZuR^2)*(2^(3 + d)*Pi^d - 7*(2*Pi)^d)*s + 
      ...
      (gZlR^2*(d*(gZuL^2 - gZuR^2)*(2^(3 + d)*Pi^d - 7*(2*Pi)^d)*s + 
        ...
        gZlL^2*(gZuR^2*(d*(2^(3 + d)*Pi^d - 7*(2*Pi)^d)*s + 
            2^(1 + d)*Pi^d*t) + gZuL^2*(7*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
             (3*s - 4*d*s + t))))*GaugeXi[Q]^2))/
    (Pi^(2*d)*(-1 + GaugeXi[Q])^2) + (I*4^(-1 - d)*EL^6*gAl*gAu*(s + t)*
   ...
   (I*4^(-1 - d)*EL^6*gAl*gAu*(s + t)^2*\[Mu]^(4 - d)*
     (gZlR^2*(-(gZuR^2*(-7*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(2*s + 4*d*s - 
      ...
      (gZlR^2*(-(gZuR^2*(-7*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(2*s + 4*d*s - 
               t))) + gZuL^2*(-7*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
             (-5*s + 4*d*s + t))) + gZlL^2*
         (gZuL^2*(7*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s - 4*d*s + t)) + 
          gZuR^2*(-7*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-5*s + 4*d*s + t))))*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (mz^2*Pi^(2*d)) + (I*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
     (2^(1 + d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*Pi^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*Pi^(2*d)*s) + (I*EL^6*gAl*gAu*s*(s + t)*\[Mu]^(4 - d)*
     (2^(1 + d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*Pi^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^4*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*t*(s + t)*
     \[Mu]^(4 - d)*(2^(1 + d)*(gZlR^2*(-((-2 + d)*gZuL^2) + 
          (-4 + d)*gZuR^2) + gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*Pi^d*
       t*(s + t) - 2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*
       (s + t)^2 - 
      3*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
            d*(2*Pi)^d*(s^2 + t^2)) + gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
            2^(1 + d)*Pi^d*(s^2 - (-2 + d)*s*t + t^2))) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (mz^4*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^6*gAl*gAu*t*(s + t)*\[Mu]^(4 - d)*
     (2^(1 + d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*Pi^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (mz^2*Pi^(2*d)*s) + (I*EL^6*gAl*gAu*t^2*(s + t)*\[Mu]^(4 - d)*
     (2^(1 + d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*Pi^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (2*s + t))) + gZlL^2*(gZuL^2*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/Pi^(2*d) - 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*Pi^(2*d)*s) - (I*EL^6*gAl*gAu*s*\[Mu]^(4 - d)*
     ((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^6*gAl*gAu*t*
     \[Mu]^(4 - d)*((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*
     ((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (Pi^(2*d)*s) - (I*EL^6*gAl*gAu*t^2*\[Mu]^(4 - d)*
     ((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) - 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)*s) + (I/8)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
    ((2^(2 - d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*(s + t)^2)/Pi^d + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/s + ((I/8)*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*
     ((2^(2 - d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*(s + t)^2)/Pi^d + 
      (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*
                t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
           gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/s - ((3*I)/8)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
    ((2^(1 - d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
        gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*t*(s + t))/Pi^d - 
     (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 
              2*t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/s + (((3*I)/8)*EL^6*gAl*gAu*s*\[Mu]^(4 - d)*
     ((2^(1 - d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
         gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*t*(s + t))/Pi^d - 
      (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*
                t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/mz^2 - ((I/8)*EL^6*gAl*gAu*s^2*\[Mu]^(4 - d)*
     ((2^(1 - d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
         gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*t*(s + t))/Pi^d - 
      (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*
                t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/mz^4 + (((3*I)/4)*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*
     ((2^(1 - d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
         gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*t*(s + t))/Pi^d - 
      (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*
                t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/mz^2 - (((3*I)/8)*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*
     ((2^(1 - d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
         gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*t*(s + t))/Pi^d - 
      (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*
                t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/s - (((3*I)/8)*EL^6*gAl*gAu*s*t*\[Mu]^(4 - d)*
     ((2^(1 - d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
         gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*t*(s + t))/Pi^d - 
      (2^(1 - 2*d)*(gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*
                t^2) + d*(2*Pi)^d*(s^2 + t^2)) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/(mz^4*s) + (I/8)*EL^6*gAl*gAu*mz^4*
    \[Mu]^(4 - d)*
    ((2^(1 - 2*d)*(-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
              d^3*(2*Pi)^d)) + gZuL^2*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - 
             d^3*(2*Pi)^d))) + gZlL^2*
         ...
         (Pi^(2*d)*s) + (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - 3*t)) + 
          ...
          (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - 3*t)) + 2^(1 + d)*Pi^d*
              ...
              gZuR^2*(-(d*(2*Pi)^d*s*(s - 3*t)) + 2^(1 + d)*Pi^d*
                 ((-2 + d)*s^2 - (3 + d)*s*t - t^2))))*GaugeXi[Q]^2)/
         (2*Pi)^(2*d)))/(mz^4*(-1 + GaugeXi[Q])^2)))*
  userIntegral[B21, {mz}, 1, 1, 1, 1] + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*\[Mu]^(4 - d)*
   userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, -2, 1, 1, 0])/(mz^4*Pi^d) + 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (gZlL^2*(gZuL^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-3 + d)*s - t)) - 
      gZuR^2*(d*(2^(1 + d)*Pi^d - (2*Pi)^d)*s + 2^(1 + d)*Pi^d*t)) - 
    gZlR^2*(d*(gZuL^2 - gZuR^2)*(2^(1 + d)*Pi^d - (2*Pi)^d)*s + 
 ...
 (I*2^(-3 - d)*EL^6*gAl*gAu*(gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 
      2*gZuR^2*(3*s + t)) + gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + 
      gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*userIntegral[B21, 
    {mz*Sqrt[GaugeXi[Q]]}, -1, 1, 0, 0])/(mz^4*Pi^d*s) - 
 (I*2^(-2 - 3*d)*EL^6*gAl*gAu*
   (-(gZlR^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + gZuL^2*((-2 + d)*s + 2*t))) + 
    gZlL^2*(gZuL^2*((-4 + d)*s - 2*t) - gZuR^2*((-2 + d)*s + 2*t)))*
   \[Mu]^(4 - d)*((2*Pi)^(2*d) - 2^(1 + 2*d)*Pi^(2*d)*GaugeXi[Q] + 
    (2*Pi)^(2*d)*GaugeXi[Q]^2)*userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, -1, 
    1, 1, -1])/(mz^4*Pi^(3*d)*s*(-1 + GaugeXi[Q])^2) - 
 (I*2^(-3 - d)*EL^6*gAl*gAu*(gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 
      2*gZuR^2*(3*s + t)) + gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + 
      gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*(-s + 2*mz^2*GaugeXi[Q])*
   userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, -1, 1, 1, 0])/(mz^4*Pi^d*s) - 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*
   (-(gZlR^2*(-(gZuR^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d)) + 
       gZuL^2*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d))) + 
    gZlL^2*(gZuL^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d) - 
      gZuR^2*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d)))*(s + t)*\[Mu]^(4 - d)*
   userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, 0, -1, 1, 0])/(mz^4*Pi^(2*d)*s) + 
 (I*4^(-1 - d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (gZlL^2*(gZuR^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
      gZuL^2*(-3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s - t + 2*d*t))) + 
    gZlR^2*(gZuL^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
    ...
    (gZlL^2*(gZuR^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
      ...
      gZlR^2*(gZuL^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
        gZuR^2*(-3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s - t + 2*d*t))))*
     GaugeXi[Q]^2)*userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, 0, 0, 0, 0])/
  (mz^4*Pi^(2*d)*s*(-1 + GaugeXi[Q])^2) - 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (-(gZlR^2*(d*(gZuL^2 - gZuR^2)*(2^(1 + d)*Pi^d - 3*(2*Pi)^d)*s - 
       2^(1 + d)*Pi^d*(gZuL^2*t + gZuR^2*(3*s + t)))) + 
 ...
 (I*4^(-1 - d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (s*(-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s + 7*t)) + 2^(1 + d)*Pi^d*
             (-2*s + d*s - 2*t + 4*d*t))) + gZuL^2*(-(d*(2*Pi)^d*(s + 7*t)) + 
           2^(1 + d)*Pi^d*((-1 + d)*s + (-1 + 4*d)*t)))) + 
      gZlL^2*(gZuL^2*(-(d*(2*Pi)^d*(s + 7*t)) + 2^(1 + d)*Pi^d*
           (-2*s + d*s - 2*t + 4*d*t)) - gZuR^2*(-(d*(2*Pi)^d*(s + 7*t)) + 
          2^(1 + d)*Pi^d*((-1 + d)*s + (-1 + 4*d)*t)))) + 
    (gZlR^2*(d*(gZuL^2 - gZuR^2)*s*(mz^2*(-(2^(1 + d)*Pi^d) + 3*(2*Pi)^d) + 
          2^(1 + d)*Pi^d*(s + t)) + 2^(1 + d)*Pi^d*
         (gZuL^2*(-2*s^2 + mz^2*t - 2*s*t) + gZuR^2*(4*s*(s + t) + 
            mz^2*(3*s + t)))) + 
      gZlL^2*(-(gZuR^2*(2^(1 + d)*Pi^d*(2*s^2 - mz^2*t + 2*s*t) - 
           d*s*(mz^2*(-(2^(1 + d)*Pi^d) + 3*(2*Pi)^d) + 2^(1 + d)*Pi^d*
              (s + t)))) + gZuL^2*(-(2^(1 + d)*(-4 + d)*Pi^d*s*(s + t)) + 
 ...
 (I*2^(-3 - d)*EL^6*gAl*gAu*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
    gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*(s + t)*\[Mu]^(4 - d)*
   userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, 0, 1, -1, 0])/(mz^4*Pi^d*s) - 
 (I*EL^6*gAl*gAu*\[Mu]^(4 - d)*(3*2^(1 + 2*d)*(gZlL^2 + gZlR^2)*
     (gZuL^2 + gZuR^2)*Pi^(2*d) - 
    ((d*(gZlL^2 - gZlR^2)*(gZuL^2 - gZuR^2)*s - 
       2*(gZlR^2*(gZuR^2*t + gZuL^2*(-3*s + t)) + 
         gZlL^2*(gZuL^2*t + gZuR^2*(-3*s + t))))*((2*Pi)^(2*d) - 
       2^(1 + 2*d)*Pi^(2*d)*GaugeXi[Q] + (2*Pi)^(2*d)*GaugeXi[Q]^2))/
     (s*(-1 + GaugeXi[Q])^2))*userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, 0, 1, 
    0, -1])/(2^(3*(1 + d))*mz^4*Pi^(3*d)) - 
 (I*2^(-2 - d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (-((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
       gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*s*(s + t)) + 
    mz^2*(-(gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 
         2*gZuR^2*(3*s + t))) + gZlL^2*(gZuL^2*((-6 + d)*s - 2*t) - 
        gZuR^2*(d*s + 2*t)))*GaugeXi[Q])*userIntegral[B21, 
    {mz*Sqrt[GaugeXi[Q]]}, 0, 1, 0, 0])/(mz^4*Pi^d*s) + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*\[Mu]^(4 - d)*
   userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, 0, 1, 1, -2])/(mz^4*Pi^d) - 
 (I*2^(-3 - d)*EL^6*gAl*gAu*(gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 
      2*gZuR^2*(3*s + t)) + gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + 
      gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*(-s + 2*mz^2*GaugeXi[Q])*
   userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, 0, 1, 1, -1])/(mz^4*Pi^d*s) + 
 (I*8^(-1 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (-((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
       gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(2*Pi)^(5*d)*s^2*
      (s + t)) + 2^(1 + 5*d)*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
      gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*Pi^(5*d)*s*(2*mz^2 + s)*
     (s + t)*GaugeXi[Q] + 
    (gZlL^2*(2*Pi)^(5*d)*(gZuL^2*(-8*(-4 + d)*mz^2*s*(s + t) - 
     ...
     (gZlR^2*(d*(gZuL^2 - gZuR^2)*s*(mz^2 + s + t) - 
       ...
       (-(gZuL^2*(mz^2*((-6 + d)*s - 2*t) + (-4 + d)*s*(s + t))) + 
        gZuR^2*(d*s*(mz^2 + s + t) - 2*(s^2 - mz^2*t + s*t))))*GaugeXi[Q]^3 - 
    2^(1 + 5*d)*mz^4*Pi^(5*d)*
     (-(gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 2*gZuR^2*(3*s + t))) + 
      gZlL^2*(gZuL^2*((-6 + d)*s - 2*t) - gZuR^2*(d*s + 2*t)))*GaugeXi[Q]^4)*
   userIntegral[B21, {mz*Sqrt[GaugeXi[Q]]}, 0, 1, 1, 0])/
  (mz^4*Pi^(6*d)*s*(-1 + GaugeXi[Q])^2) - 
 (I*2^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*\[Mu]^(4 - d)*
   userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, -2, 1, 1, 0])/(mz^4*Pi^d) - 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
 ...
 (I*2^(-2 - d)*EL^6*gAl*gAu*(gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 
      2*gZuR^2*(3*s + t)) + gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + 
      gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*userIntegral[B22, 
    {mz, mz*Sqrt[GaugeXi[Q]]}, -1, 1, 0, 0])/(mz^4*Pi^d*s) + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*
   (-(gZlR^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + gZuL^2*((-2 + d)*s + 2*t))) + 
    gZlL^2*(gZuL^2*((-4 + d)*s - 2*t) - gZuR^2*((-2 + d)*s + 2*t)))*
   \[Mu]^(4 - d)*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, -1, 1, 1, -1])/
  (mz^4*Pi^d*s) + (I*2^(-2 - 3*d)*EL^6*gAl*gAu*
   (-(gZlR^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + gZuL^2*((-2 + d)*s + 2*t))) + 
    gZlL^2*(gZuL^2*((-4 + d)*s - 2*t) - gZuR^2*((-2 + d)*s + 2*t)))*
   \[Mu]^(4 - d)*((2*Pi)^(2*d) - 2^(1 + 2*d)*Pi^(2*d)*GaugeXi[Q] + 
    (2*Pi)^(2*d)*GaugeXi[Q]^2)*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 
    -1, 1, 1, -1])/(mz^4*Pi^(3*d)*s*(-1 + GaugeXi[Q])^2) + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*(gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 
      2*gZuR^2*(3*s + t)) + gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + 
      gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*(mz^2 - s + mz^2*GaugeXi[Q])*
   userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, -1, 1, 1, 0])/(mz^4*Pi^d*s) - 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*
   (gZlR^2*(-(gZuR^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d)) + 
      gZuL^2*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d)) + 
    gZlL^2*(gZuR^2*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d) + 
      gZuL^2*(-(2^(1 + d)*(-2 + d)*Pi^d) + d*(2*Pi)^d)))*(s + t)*
   \[Mu]^(4 - d)*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, -1, 1, 0])/
  (mz^4*Pi^(2*d)*s) - (I*2^(-3 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*(5*s - t)) + 2^(1 + d)*Pi^d*
    ...
    (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*(5*s - t)) + 2^(1 + d)*Pi^d*
      ...
      gZlL^2*(gZuL^2*(-(d*(2*Pi)^d*(5*s - t)) + 2^(1 + d)*Pi^d*
           (2*(1 + d)*s - (-2 + d)*t)) - gZuR^2*(-(d*(2*Pi)^d*(5*s - t)) + 
          2^(1 + d)*Pi^d*(s + 2*d*s + t - d*t))))*GaugeXi[Q]^2)*
   userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, -1, 1, 0])/
  (mz^4*Pi^(2*d)*s*(-1 + GaugeXi[Q])^2) - 
 (I*2^(-2 - 3*d)*EL^6*gAl*gAu*
   (gZlL^2*(gZuR^2*(2*s - (-4 + d)*t) + gZuL^2*(2*s + (-2 + d)*t)) + 
    gZlR^2*(gZuL^2*(2*s - (-4 + d)*t) + gZuR^2*(2*s + (-2 + d)*t)))*
   \[Mu]^(4 - d)*((2*Pi)^(2*d) - 2^(1 + 2*d)*Pi^(2*d)*GaugeXi[Q] + 
    (2*Pi)^(2*d)*GaugeXi[Q]^2)*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 
    0, 0, 0, 0])/(mz^4*Pi^(3*d)*s*(-1 + GaugeXi[Q])^2) - 
 (I*4^(-1 - d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (gZlL^2*(gZuR^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
      gZuL^2*(-3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s - t + 2*d*t))) + 
    gZlR^2*(gZuL^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
    ...
    (gZlL^2*(gZuR^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
      ...
      gZlR^2*(gZuL^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
        gZuR^2*(-3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s - t + 2*d*t))))*
     GaugeXi[Q]^2)*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 0, 0, 0])/
  (mz^4*Pi^(2*d)*s*(-1 + GaugeXi[Q])^2) + 
 (I*2^(-3 - d)*EL^6*gAl*gAu*(gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 
      2*gZuR^2*(3*s + t)) + gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + 
      gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*userIntegral[B22, 
    {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 0, 1, -1])/(mz^4*Pi^d*s) + 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (-(gZlR^2*(d*(gZuL^2 - gZuR^2)*(2^(1 + d)*Pi^d - 3*(2*Pi)^d)*s - 
       2^(1 + d)*Pi^d*(gZuL^2*t + gZuR^2*(3*s + t)))) + 
    gZlL^2*(-(gZuR^2*(d*(2^(1 + d)*Pi^d - 3*(2*Pi)^d)*s - 
 ...
 (I*2^(-2 - d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (-((gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
    ...
    mz^2*(gZlL^2*(gZuR^2*(2*s - (-4 + d)*t) + gZuL^2*(2*s + (-2 + d)*t)) + 
      gZlR^2*(gZuL^2*(2*s - (-4 + d)*t) + gZuR^2*(2*s + (-2 + d)*t)))*
     GaugeXi[Q])*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 0, 1, 0])/
  (mz^4*Pi^d*s) - (I*4^(-1 - d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (gZlR^2*(-(gZuR^2*(mz^2*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d)*(s + t) + 
    ...
    (gZlL^2*(-(gZuR^2*(-(2^(1 + d)*(-2 + d)*Pi^d*s*(s + t)) + 
      ...
      gZlR^2*(gZuL^2*(2^(1 + d)*(-2 + d)*Pi^d*s*(s + t) + 
          mz^2*(5*d*(2*Pi)^d*t - 2^(1 + d)*Pi^d*((-3 + d)*s + 
              4*(-1 + d)*t))) + gZuR^2*(-(2^(1 + d)*(-4 + d)*Pi^d*s*
            (s + t)) + mz^2*(-5*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*
             ((-3 + d)*s + (-5 + 4*d)*t)))))*GaugeXi[Q] + 
    (-(d*(gZlL^2 - gZlR^2)*(gZuL^2 - gZuR^2)*(-(2^(2 + d)*Pi^d*s*(s + 3*t)) + 
         (2*Pi)^d*s*(3*s + 11*t) + mz^2*(-((2*Pi)^d*(s + t)) + 
           2^(1 + d)*Pi^d*(s + 2*t)))) + 2^(1 + d)*Pi^d*
       (gZlR^2*(-2*gZuR^2*(s^2 - 2*mz^2*t + s*t) + 
    ...
    mz^2*(gZlL^2*(gZuR^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*
      ...
      gZlR^2*(gZuL^2*(3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s + 2*t - 2*d*t)) + 
        gZuR^2*(-3*d*(2*Pi)^d*t + 2^(1 + d)*Pi^d*(s - t + 2*d*t))))*
     GaugeXi[Q]^3)*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 0, 1, 0])/
  (mz^4*Pi^(2*d)*s*(-1 + GaugeXi[Q])^2) + 
 (I*2^(-3 - d)*EL^6*gAl*gAu*(gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
    gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*(s + t)*\[Mu]^(4 - d)*
   userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 1, -1, 0])/(mz^4*Pi^d*s) - 
 (I*EL^6*gAl*gAu*\[Mu]^(4 - d)*(3*2^(1 + 2*d)*(gZlL^2 + gZlR^2)*
     (gZuL^2 + gZuR^2)*Pi^(2*d) - 
    ...
    ((2*Pi)^d*(-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s - 3*t)) + 
       ...
       (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s - 3*t)) + 2^(1 + d)*Pi^d*
              ...
              2^(1 + d)*Pi^d*(2*s - (3 + d)*t)))) + 
         gZlL^2*(gZuL^2*(-(d*(2*Pi)^d*(s - 3*t)) + 2^(1 + d)*Pi^d*
              (s - d*t)) - gZuR^2*(-(d*(2*Pi)^d*(s - 3*t)) + 
             2^(1 + d)*Pi^d*(2*s - (3 + d)*t))))*GaugeXi[Q]^2))/
     (s*(-1 + GaugeXi[Q])^2))*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 
    1, -1, 0])/(2^(3*(1 + d))*mz^4*Pi^(3*d)) + 
 (I*2^(1 - 3*(1 + d))*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   (3*2^(1 + 2*d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^(2*d) - 
    ((d*(gZlL^2 - gZlR^2)*(gZuL^2 - gZuR^2)*s - 
       ...
       2^(1 + 2*d)*Pi^(2*d)*GaugeXi[Q] + (2*Pi)^(2*d)*GaugeXi[Q]^2))/
     (s*(-1 + GaugeXi[Q])^2))*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 
    1, 0, -1])/(mz^4*Pi^(3*d)) - (I*2^(-1 - d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   ...
   userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 1, 0, 0])/(mz^4*Pi^d*s) - 
 (I*2^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*\[Mu]^(4 - d)*
   userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 1, 1, -2])/(mz^4*Pi^d) + 
 (I*2^(-2 - d)*EL^6*gAl*gAu*(gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 
      2*gZuR^2*(3*s + t)) + gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + 
      gZuR^2*(d*s + 2*t)))*\[Mu]^(4 - d)*(mz^2 - s + mz^2*GaugeXi[Q])*
   userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 1, 1, -1])/(mz^4*Pi^d*s) + 
 (I*2^(-2 - 6*d)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
   ((2*Pi)^(5*d)*(gZlL^2*(-(gZuR^2*((-2 + d)*mz^4*(s + t) + 
    ...
    2^(1 + 5*d)*Pi^(5*d)*
     (gZlL^2*(-(gZuR^2*((-2 + d)*s^2*(s + t) + mz^4*((-4 + d)*s + 
      ...
      gZlR^2*(-(gZuL^2*((-2 + d)*s^2*(s + t) + mz^4*((-4 + d)*s + 
             2*(-3 + d)*t) + mz^2*((18 - 13*d + 2*d^2)*s^2 + 
             (18 - 21*d + 4*d^2)*s*t - 8*t^2))) + 
    ...
    (gZlR^2*(-((-2 + d)*gZuL^2) + (-4 + d)*gZuR^2) + 
     ...
     GaugeXi[Q]^4)*userIntegral[B22, {mz, mz*Sqrt[GaugeXi[Q]]}, 0, 1, 1, 0])/
  (mz^4*Pi^(6*d)*s*(-1 + GaugeXi[Q])^2) + 
 (((-I)*2^(-3 - d)*EL^6*gAl*gAu*s*(s + t)*
     (gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 2*gZuR^2*(3*s + t)) + 
     ...
     (gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 2*gZuR^2*(3*s + t)) + 
      gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + gZuR^2*(d*s + 2*t)))*
     \[Mu]^(4 - d))/(mz^4*Pi^d) + (I*2^(-3 - d)*EL^6*gAl*gAu*(s + t)^4*
     (gZlL^2*(gZuR^2*(2*(-5 + d)*s - (-12 + d)*t) + 
        gZuL^2*(-2*(-1 + d)*s + (6 + d)*t)) + 
      gZlR^2*(gZuL^2*(2*(-5 + d)*s - (-12 + d)*t) + 
        gZuR^2*(-2*(-1 + d)*s + (6 + d)*t)))*\[Mu]^(4 - d))/(mz^4*Pi^d*s) - 
   (I*2^(-2 - d)*EL^6*gAl*gAu*(s + t)*
     (gZlL^2*(-(gZuR^2*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
          ...
          2*(8 - 5*d + d^2)*s*t + 4*t^2)))*\[Mu]^(4 - d))/(mz^2*Pi^d) - 
   (I*2^(-2 - d)*EL^6*gAl*gAu*t*(s + t)*
     (gZlL^2*(-(gZuR^2*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
           4*t^2)) + gZuL^2*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
          4*t^2)) + gZlR^2*(-(gZuL^2*((8 - 6*d + d^2)*s^2 + 
           2*(4 - 5*d + d^2)*s*t - 4*t^2)) + gZuR^2*((-2 + d)^2*s^2 + 
          2*(8 - 5*d + d^2)*s*t + 4*t^2)))*\[Mu]^(4 - d))/(mz^2*Pi^d*s) + 
     ...
     (gZlL^2*(gZuR^2*((s + t)^2*((-4 + d)*s + 6*t) - 
      ...
      gZlR^2*(gZuL^2*((s + t)^2*((-4 + d)*s + 6*t) - 
        ...
        gZuR^2*(-(((-2 + d)*s - 6*t)*(s + t)^2) + 
          2*mz^2*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))))*
     \[Mu]^(4 - d))/(mz^4*Pi^d*s) + (I*2^(-1 - d)*(-3 + d)*EL^6*gAl*gAu*
     (gZlL^2 - gZlR^2)*(gZuL^2 - gZuR^2)*(s + t)^3*\[Mu]^(4 - d)*GaugeXi[Q])/
    (mz^2*Pi^d) - (I*2^(-1 - d)*(-3 + d)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)*
     (gZuL^2 - gZuR^2)*(s + t)^3*\[Mu]^(4 - d)*GaugeXi[Q])/(Pi^d*s) + 
   (I*2^(-1 - d)*(-3 + d)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)*(gZuL^2 - gZuR^2)*t*
     (s + t)^3*\[Mu]^(4 - d)*GaugeXi[Q])/(mz^2*Pi^d*s) + 
   (I*2^(-2 - d)*EL^6*gAl*gAu*(s + t)*
     (gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 2*gZuR^2*(3*s + t)) + 
      gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + gZuR^2*(d*s + 2*t)))*
     \[Mu]^(4 - d)*GaugeXi[Q])/Pi^d - (I*2^(-2 - d)*EL^6*gAl*gAu*s*(s + t)*
     (gZlR^2*(d*(gZuL^2 - gZuR^2)*s + 2*gZuL^2*t + 2*gZuR^2*(3*s + t)) + 
      gZlL^2*(gZuL^2*(-((-6 + d)*s) + 2*t) + gZuR^2*(d*s + 2*t)))*
   ...
   (I*2^(-3 - d)*EL^6*gAl*gAu*(s + t)*
     ...
     GaugeXi[Q])/(mz^2*Pi^d*s) - (I*2^(-3 - d)*EL^6*gAl*gAu*(s + t)^2*
     (gZlL^2*(gZuR^2*((-22 + 5*d)*s^2 + 3*d*s*t - 3*(-8 + d)*t^2) + 
        gZuL^2*((8 - 5*d)*s^2 - 3*(-6 + d)*s*t + 3*(2 + d)*t^2)) + 
      gZlR^2*(gZuL^2*((-22 + 5*d)*s^2 + 3*d*s*t - 3*(-8 + d)*t^2) + 
        gZuR^2*((8 - 5*d)*s^2 - 3*(-6 + d)*s*t + 3*(2 + d)*t^2)))*
   ...
   (I*2^(-3 - d)*EL^6*gAl*gAu*(s + t)*
     (gZlL^2*(gZuL^2*(3*(-2 + d)*s^2 + 5*(-4 + d)*s*t - 6*t^2) + 
      ...
      gZlR^2*(gZuR^2*(-3*(-2 + d)*s^2 - 5*(-4 + d)*s*t + 6*t^2) + 
        gZuL^2*(3*(-4 + d)*s^2 + 5*(-2 + d)*s*t + 6*t^2)))*\[Mu]^(4 - d)*
     GaugeXi[Q]^2)/(Pi^d*s) - (I*2^(-3 - d)*EL^6*gAl*gAu*
     (gZlL^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
      gZlR^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*mz^2*t*(s + t)*
     ...
     (-(gZlR^2*(d*(gZuL^2 - gZuR^2)*(3*2^(2 + d)*Pi^d - 13*(2*Pi)^d)*s - 
      ...
      (-(gZlR^2*(d*(gZuL^2 - gZuR^2)*(3*2^(2 + d)*Pi^d - 13*(2*Pi)^d)*s - 
        ...
        gZlL^2*(-(gZuR^2*(d*(3*2^(2 + d)*Pi^d - 13*(2*Pi)^d)*s - 
             2^(1 + d)*Pi^d*t)) + gZuL^2*(-13*d*(2*Pi)^d*s + 
            2^(1 + d)*Pi^d*(3*s + 6*d*s + t))))*GaugeXi[Q]^2))/
    (Pi^(2*d)*(-1 + GaugeXi[Q])^2) + (I*4^(-1 - d)*EL^6*gAl*gAu*s*(s + t)*
     \[Mu]^(4 - d)*GaugeXi[Q]*
     (-(gZlR^2*(d*(gZuL^2 - gZuR^2)*(3*2^(2 + d)*Pi^d - 13*(2*Pi)^d)*s - 
         2^(1 + d)*Pi^d*(gZuL^2*t + gZuR^2*(3*s + t)))) + 
      gZlL^2*(-(gZuR^2*(d*(3*2^(2 + d)*Pi^d - 13*(2*Pi)^d)*s - 
   ...
   ((I/8)*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
    ...
    (mz^4*(-1 + GaugeXi[Q])^2) + ((I/8)*EL^6*gAl*gAu*t*(s + t)*\[Mu]^(4 - d)*
     ((-3*2^(1 - 2*d)*mz^2*
        (-(gZlR^2*(-(gZuR^2*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
                (2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 2*t^2))) + 
            gZuL^2*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
      ...
      (2^(1 - 2*d)*(s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 
          ...
          GaugeXi[Q] - (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 
             ...
             gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*(2*s^2 - 
                 (-3 + d)*s*t + t^2))))*GaugeXi[Q]^2))/Pi^(2*d)))/
    (mz^4*s*(-1 + GaugeXi[Q])^2) - ((I/8)*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
     GaugeXi[Q]*((-3*2^(1 - 2*d)*mz^2*
        (-(gZlR^2*(-(gZuR^2*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
                (2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 2*t^2))) + 
            gZuL^2*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
                (4 - 5*d + d^2)*s*t + 2*t^2)))) + 
      ...
      (2^(1 - 2*d)*(s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 
          ...
          GaugeXi[Q] - (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 
             ...
             gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*(2*s^2 - 
                 (-3 + d)*s*t + t^2))))*GaugeXi[Q]^2))/Pi^(2*d)))/
    (mz^2*s*(-1 + GaugeXi[Q])^2) - ((I/8)*EL^6*gAl*gAu*s*\[Mu]^(4 - d)*
     (-((2^(1 - 2*d)*mz^2*(-(gZlR^2*(-(gZuR^2*(-(d^2*(2*Pi)^d*s^2) + 
                2^(1 + d)*Pi^d*(2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 
                  2*t^2))) + gZuL^2*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
                ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)))) + 
   ...
   (I/8)*EL^6*gAl*gAu*mz^2*\[Mu]^(4 - d)*GaugeXi[Q]^2*
    ((2^(1 - d)*(gZlL^2*(gZuL^2*((-2 + d)*s^2 - 2*t^2) - 
     ...
     (gZlL^2*(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 5*t - 2*d*t)) + 
       ...
       gZlR^2*(gZuL^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 5*t - 
             2*d*t)) - gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            (s + 7*t - 2*d*t))))/(2*Pi)^(2*d) + 
 ...
 ((I*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*s^3*(s + t)*
    ...
    (mz^2*Pi^(2*d)) + (I*4^(-1 - d)*EL^6*gAl*gAu*t*(s + t)*
     (gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      gZlR^2*(gZuL^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
           (s^2 - (-2 + d)*s*t + t^2)) - gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
          2^(1 + d)*Pi^d*(2*s^2 - (-4 + d)*s*t + 2*t^2))))*\[Mu]^(4 - d))/
    (mz^2*Pi^(2*d)*s) + (I*EL^6*gAl*gAu*s*
     (gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
          d*(2*Pi)^d*(s^2 + t^2)) + gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
          2^(1 + d)*Pi^d*(s^2 - (-2 + d)*s*t + t^2))) + 
      gZlR^2*(gZuL^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
   ...
   (I*EL^6*gAl*gAu*t*
     (gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      gZlR^2*(gZuL^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
           (s^2 - (-2 + d)*s*t + t^2)) - gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
          2^(1 + d)*Pi^d*(2*s^2 - (-4 + d)*s*t + 2*t^2))))*\[Mu]^(4 - d))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*4^(-1 - d)*EL^6*gAl*gAu*t*
     (gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
          d*(2*Pi)^d*(s^2 + t^2)) + gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
          2^(1 + d)*Pi^d*(s^2 - (-2 + d)*s*t + t^2))) + 
      gZlR^2*(gZuL^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
    ...
    (mz^4*Pi^(2*d)) + (I*2^(-3 - 2*d)*EL^6*gAl*gAu*t^2*(s + t)*
     (gZlL^2*(gZuL^2*(2^(1 + d)*Pi^d*(-2*s^2 + (-4 + d)*s*t - 2*t^2) + 
      ...
      gZlR^2*(gZuL^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
           (s^2 - (-2 + d)*s*t + t^2)) - gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
          2^(1 + d)*Pi^d*(2*s^2 - (-4 + d)*s*t + 2*t^2))))*\[Mu]^(4 - d))/
    (mz^4*Pi^(2*d)*s) + (I*2^(-1 - d)*(-3 + d)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)*
     (gZuL^2 - gZuR^2)*(s + t)^3*\[Mu]^(4 - d)*GaugeXi[Q])/(mz^2*Pi^d) - 
   ((3*I)*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*
     (s + t)^3*\[Mu]^(4 - d)*GaugeXi[Q])/(mz^2*Pi^d) - 
   (I*2^(-1 - d)*(-3 + d)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)*(gZuL^2 - gZuR^2)*
     (s + t)^3*\[Mu]^(4 - d)*GaugeXi[Q])/(Pi^d*s) + 
   (I*2^(-1 - d)*(-3 + d)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)*(gZuL^2 - gZuR^2)*t*
     (s + t)^3*\[Mu]^(4 - d)*GaugeXi[Q])/(mz^2*Pi^d*s) - 
   (I*2^(-3 - d)*EL^6*gAl*gAu*(s + t)^2*
     (gZlL^2*(gZuR^2*((-22 + 5*d)*s^2 + 3*d*s*t - 3*(-8 + d)*t^2) + 
   ...
   ((3*I)*4^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*
    ...
    (mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])^2) - 
   ((3*I)*4^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*
     (s + t)^2*\[Mu]^(4 - d)*GaugeXi[Q]^2*((2*Pi)^d - 
      2^(1 + d)*Pi^d*GaugeXi[Q] + (2*Pi)^d*GaugeXi[Q]^2))/
    (Pi^(2*d)*(-1 + GaugeXi[Q])^2) + 
   (I*4^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*mz^2*
     (s + t)*\[Mu]^(4 - d)*GaugeXi[Q]^3*((2*Pi)^d - 
      2^(1 + d)*Pi^d*GaugeXi[Q] + (2*Pi)^d*GaugeXi[Q]^2))/
    (Pi^(2*d)*(-1 + GaugeXi[Q])^2) - (I*2^(-3 - 4*d)*EL^6*gAl*gAu*s*(s + t)*
     (gZlL^2*(gZuR^2*(-2*(-7 + d)*s^2 + (10 - 3*d)*s*t - 6*t^2) + 
        gZuL^2*(2*(1 + d)*s^2 + (-8 + 3*d)*s*t - 6*t^2)) + 
      gZlR^2*(gZuL^2*(-2*(-7 + d)*s^2 + (10 - 3*d)*s*t - 6*t^2) + 
        gZuR^2*(2*(1 + d)*s^2 + (-8 + 3*d)*s*t - 6*t^2)))*\[Mu]^(4 - d)*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^6*gAl*gAu*s*\[Mu]^(4 - d)*GaugeXi[Q]*
     ((gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^6*gAl*gAu*t*
     \[Mu]^(4 - d)*GaugeXi[Q]*((gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
            (s^2 - (-2 + d)*s*t + t^2))) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (mz^2*Pi^(2*d)) + (I*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*GaugeXi[Q]*
     ((gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*Pi^(2*d)*s) - (I*EL^6*gAl*gAu*t^2*\[Mu]^(4 - d)*GaugeXi[Q]*
     ((gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)*s) + 
   (I*EL^6*gAl*gAu*\[Mu]^(4 - d)*GaugeXi[Q]^2*
     ((gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^6*gAl*gAu*mz^2*\[Mu]^(4 - d)*
     GaugeXi[Q]^2*((gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
            (s^2 - (-2 + d)*s*t + t^2))) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*Pi^(2*d)*s) + (I*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*GaugeXi[Q]^2*
     ((gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*(2*Pi)^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      2*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*Pi^(2*d)*s) - (I*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
     (2^(1 + d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*Pi^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*EL^6*gAl*gAu*s*(s + t)*\[Mu]^(4 - d)*
     (2^(1 + d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*Pi^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^4*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*t*(s + t)*
     \[Mu]^(4 - d)*(2^(1 + d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*Pi^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
            (s^2 - (-2 + d)*s*t + t^2))) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (mz^4*Pi^(2*d)) - (I*EL^6*gAl*gAu*t*(s + t)*\[Mu]^(4 - d)*
     (2^(1 + d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*Pi^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^4*Pi^(2*d)*s) - (I*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
     GaugeXi[Q]*(2^(1 + d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*Pi^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
            (s^2 - (-2 + d)*s*t + t^2))) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*EL^6*gAl*gAu*(s + t)*\[Mu]^(4 - d)*
     GaugeXi[Q]*(2^(1 + d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*Pi^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/(-1 + GaugeXi[Q])^2))/
    (2^(2*(1 + d))*Pi^(2*d)*s) - (I*EL^6*gAl*gAu*t*(s + t)*\[Mu]^(4 - d)*
     GaugeXi[Q]*(2^(1 + d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*Pi^d*t*(s + t) + 
      2^(1 + d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*Pi^d*(s + t)^2 - 
      3*gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/mz^4 + ((I/8)*EL^6*gAl*gAu*t^2*\[Mu]^(4 - d)*
     ((2^(1 - d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
         gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*t*(s + t))/Pi^d + 
      (2^(1 - 2*d)*(-(gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*
                Pi^d*(s^2 - (-2 + d)*s*t + t^2))) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/(mz^4*s) - (I/4)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
    GaugeXi[Q]*((2^(1 - d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*t*(s + t))/Pi^d + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/s + ((I/4)*EL^6*gAl*gAu*t^2*\[Mu]^(4 - d)*
     GaugeXi[Q]*((2^(1 - d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
         gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*t*(s + t))/Pi^d + 
      (2^(1 - 2*d)*(-(gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*
                Pi^d*(s^2 - (-2 + d)*s*t + t^2))) + 
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/(mz^2*s) - (I/8)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
    GaugeXi[Q]^2*((2^(1 - d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
        gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*t*(s + t))/Pi^d + 
     (2^(1 - 2*d)*(-(gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
              2^(1 + d)*Pi^d*(s^2 - (-2 + d)*s*t + t^2))) + 
           gZuL^2*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/s - (I/8)*EL^6*gAl*gAu*\[Mu]^(4 - d)*
    GaugeXi[Q]^2*((2^(2 - d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*(s + t)^2)/
      Pi^d + (2^(1 - 2*d)*
      ...
      ((s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
         ...
         2^(1 + d)*Pi^d*(gZlL^2*(gZuR^2*(-((-4 + d)*s) + 2*t) + 
          ...
          GaugeXi[Q] + (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ...
                (-s + t)) + gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + t))))*GaugeXi[Q]^2))/((2*Pi)^(2*d)*
        (-1 + GaugeXi[Q])^2)))/s - ((I/8)*EL^6*gAl*gAu*(s + t)^2*
     \[Mu]^(4 - d)*((2^(1 - d)*(gZlR^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
         gZlL^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*t*(s + t))/Pi^d + 
      (2^(2 - d)*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*(s + t)^2)/Pi^d + 
      ...
      2*((2^(1 - 2*d)*(gZlR^2*(-(gZuR^2*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
         ...
         Pi^(2*d) + (s*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - 3*t)) + 
           ...
           (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - 3*t)) + 2^(1 + d)*Pi^d*
                ...
                (-(d*(2*Pi)^d*s*(s - 3*t)) + 2^(1 + d)*Pi^d*((-2 + d)*s^2 - 
                   (3 + d)*s*t - t^2))))*GaugeXi[Q]^2))/(2*Pi)^(2*d))))/
    (mz^2*s*(-1 + GaugeXi[Q])^2))*userIntegral[B22, 
   {mz, mz*Sqrt[GaugeXi[Q]]}, 1, 1, 1, 1]
