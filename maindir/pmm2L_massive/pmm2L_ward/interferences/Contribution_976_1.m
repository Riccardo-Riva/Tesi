...
PropList[KiraPropagator[-q1, mm], KiraPropagator[-q1 - q2, mw], 
 ...
 ((I*4^(-1 - d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(psq - s)*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*4^(-1 - d)*(-2 + d)*EL^5*gFll^2*gWlN*
    gWNl*gWWA*mm^2*(psq - s)*s*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (I*4^(-1 - d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(psq - s)*
    s*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*s*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   Pi^(2*d) - (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(psq - 2*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(psq - 2*s)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(psq - 2*s)*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(psq - 2*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(psq - s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (psq - s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*
    gWWA*mm^2*(aa*(-2*psq^2 + 2*mm^2*(psq - t) - s*(s + t) + psq*(s + 2*t)) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (psq - s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*
    gWWA*mm^2*(aa*(-2*psq^2 - psq*s + 2*mm^2*(psq + s - t) + 2*psq*t - s*t) + 
  ...
  (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*
    gWWA*mm^2*(aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*
  ...
  (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p3, q1]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
   ...
   (2*Pi)^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[p3, p3]])/(2*Pi)^(2*d) + (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*
  ...
  (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[p2, q2]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*
