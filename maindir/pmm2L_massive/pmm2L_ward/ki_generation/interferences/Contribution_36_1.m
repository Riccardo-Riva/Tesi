   ...
   ((I*(aa + bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*mm^4*(mm^2 - psq)*
      ...
      (bb*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(psq*(psq - t) + 
          ...
          Pi^(2*d)*(2*(-mm^2 + psq)*s + d*mm^2*(psq - t) + 
           d*psq*(psq - s - t))) + 
     ...
     Pi^(4*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*mm^4*(mm^2 - psq)*
     ...
     Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gAl*gXll^2*mm^4*
      (bb*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(psq*(psq - t) + 
           mm^2*(psq - s - t)) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
          (psq*(psq - t) + mm^2*(psq - s - t)) - 2^(1 + 2*d)*gZlL*gZlR*
          Pi^(2*d)*(2*(mm^2 - psq)*s + d*psq*(psq - t) + 
           d*mm^2*(psq - s - t))) + aa*(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
          (2*(mm^2 - psq)*s + d*psq*(psq - t) + d*mm^2*(psq - s - t)) - 
         (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2*(psq - t) + psq*(psq - s - t)) - 
         (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2*(psq - t) + psq*(psq - s - t))))*
    ...
    (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
     ...
     Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^2*
      (bb*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + (-2 + d)*gZlR^2*mm^2*
          (mm^2 - psq) - gZlL*gZlR*(mm^2 + psq)*(d*mm^2 + 2*psq - d*psq - 
    ...
    (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*s*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gXll^2*mm^2*
     ...
     Pi^(4*d) + (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
     ...
     Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
    (I*4^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
      (-(2^(1 + 2*d)*aa*gZlL*gZlR*Pi^(2*d)*(mm^2 + psq)*(psq - t)) + 
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
     Pi^(2*d) - (I*4^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*mm^2*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
      (2*s + d*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
     Pi^(2*d) + (I*4^(1 - d)*(aa + bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q2]])/Pi^(2*d) - (I*4^(2 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(-4 + d)*mm^2 + 
    ...
    (I*4^(2 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    ...
    (I*4^(2 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[p3, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
    (I*4^(2 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
      gZlR*mm^2*(bb*(mm^2 - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) - 
    (I*4^(2 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gXll^2*gZlL*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
     ...
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*
      mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
      gZlR*mm^2*(bb*(mm^2 - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
     ...
     Pi^(2*d) - (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
