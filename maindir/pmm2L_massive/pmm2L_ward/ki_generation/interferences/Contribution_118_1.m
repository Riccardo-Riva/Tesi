   ...
   ((I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
    ...
    (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*
      (bb*((-2 + d)*psq^2 + (-2 + d)*mm^2*(3*psq - 2*s - 3*t) + 2*psq*t + 
       ...
       aa*((-2 + d)*psq^2 + 2*d*s*(s + t) + mm^2*(3*(-2 + d)*psq + 
           (2 + d)*s - 3*(-2 + d)*t) + psq*((2 - 5*d)*s - (-2 + d)*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
    (I*4^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
      (-(2^(1 + 2*d)*bb*mm^2*Pi^(2*d)*(-2*s*(-psq + s + t) + 
          d*(2*psq^2 + mm^2*(2*psq - s - 2*t) - 2*psq*(s + t) + 
            s*(s + t)))) + aa*(2*Pi)^(2*d)*
        (d*(psq^2*s + mm^4*(4*psq - s - 4*t) + 2*mm^2*(2*psq - s)*
            (psq - s - t)) - 2*s*(mm^4 + psq^2 + 2*mm^2*(-2*psq + s + t))))*
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[q2, q2]])/Pi^(2*d) + (I*4^(2 - d)*bb*(-2 + d)*EL^5*gAl^3*gHll^2*
