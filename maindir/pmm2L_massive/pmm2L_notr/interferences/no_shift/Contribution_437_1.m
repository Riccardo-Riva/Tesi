...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((EL^8*gAl^2*gAu^2*gXXZZ*mm^2*(4^(1 + d)*(8 - 6*d + d^2)*gZlL*gZlR*Pi^(2*d)*
    ...
    ((2*Pi)^(4*d)*s^2) - (2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gXXZZ*
   ...
   (2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gXXZZ*(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXXZZ*(18*(gZlL^2 + gZlR^2)*s + 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXXZZ*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXXZZ*
     (gZlL^2 + gZlR^2)*(-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXXZZ*(gZlL^2 + gZlR^2)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXXZZ*(gZlL^2 + gZlR^2)*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXXZZ*
