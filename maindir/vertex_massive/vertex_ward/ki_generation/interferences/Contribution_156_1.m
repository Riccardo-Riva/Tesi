...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   (((-I)*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*s*
    ...
    (I*2^(1 - 2*d)*aa*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
    ...
    (I*2^(1 - 2*d)*bb*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*
     ...
     (2*Pi)^(2*d) - (I*4^(1 - d)*aa*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*
    ...
    (I*4^(1 - d)*bb*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
