...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   ((4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*(-2*d*gZlL*gZlR*mm^2 + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
      (gZlL^2*((-2 + d)^2*mm^2*(4*psq^2 - 3*psq*s + s^2 - 8*psq*t + 5*s*t + 
         ...
         d*(4*psq^3 + s^3 + psq^2*(6*s - 4*t) + 7*s^2*t + 10*s*t^2 + 4*t^3 - 
           psq*(3*s^2 + 8*s*t + 4*t^2)) - 4*(s^3 + 5*s^2*t + 6*s*t^2 + 
           2*t^3 + 2*psq^2*(2*s + t) - psq*(3*s^2 + 8*s*t + 4*t^2))) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
      (gZlL^2*(psq - t)*(4*(-2 + d)*psq^2 + 2*(-4 + d)*psq*s + 4*s^2 - 
         d*s^2 + (-2 + d)^2*mm^2*(2*psq - s - 2*t) - 8*(-2 + d)*psq*t + 
         2*d*s*t - 8*t^2 + 4*d*t^2) + gZlR^2*(psq - t)*(4*(-2 + d)*psq^2 + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*(-4*gZlL^2*gZlR^2*mm^2*((8 + 6*d - d^2)*psq^2 + 
     ...
     (Pi^(2*d)*s) + (2^(3 - 4*d)*EL^6*gAl*gAu*
      (-((-2 + d)*gZlL^3*gZlR*mm^2*(2*Pi)^(2*d)*s^2) - 
       ...
       gZlL^4*(2^(1 + 2*d)*(-2 + d)*mm^4*Pi^(2*d)*s + (-2 + d)*mm^2*
          (2*Pi)^(2*d)*(6*psq^2 + 3*s^2 + 8*s*t + 6*t^2 - 
           4*psq*(2*s + 3*t)) + 
         2*(-(d*(2*Pi)^(2*d)*(5*psq^3 - s*t*(s + 3*t) + psq*(s^2 + 9*t^2))) + 
           2^(1 + 2*d)*Pi^(2*d)*(5*psq^3 + 2*(-2 + d)*psq^2*(s + 3*t) + 
             psq*(s^2 - 4*(-2 + d)*s*t + 9*t^2) + t*(-s^2 - 3*s*t + (-2 + d)*
                t^2)))) + gZlR^4*(2^(1 + 2*d)*(-2 + d)*mm^4*Pi^(2*d)*s + 
         (-2 + d)*mm^2*(2*Pi)^(2*d)*(6*psq^2 + 3*s^2 + 8*s*t + 6*t^2 - 
           4*psq*(2*s + 3*t)) + 
         2*(-(d*(2*Pi)^(2*d)*(5*psq^3 - s*t*(s + 3*t) + psq*(s^2 + 9*t^2))) + 
           2^(1 + 2*d)*Pi^(2*d)*(5*psq^3 + 2*(-2 + d)*psq^2*(s + 3*t) + 
             psq*(s^2 - 4*(-2 + d)*s*t + 9*t^2) + t*(-s^2 - 3*s*t + (-2 + d)*
                t^2)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
     (Pi^(4*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*
      (-2*d*(gZlL^3*gZlR*mm^2*(4*psq^2 - 4*mm^2*s - 3*s^2 + 2*psq*(s - 4*t) + 
         ...
         gZlR^4*(psq^3 + 3*mm^4*s - 4*psq^2*(s + t) + 
           mm^2*(psq^2 - 5*psq*s + 3*s^2 - 2*psq*t + 5*s*t + t^2) - 
           t*(s^2 + 3*s*t + 2*t^2) + psq*(s^2 + 4*s*t + 5*t^2))) + 
       4*(gZlL^3*gZlR*mm^2*(2*psq^2 - 2*mm^2*s - 3*s^2 + psq*(s - 4*t) + 
           s*t + 2*t^2) + gZlL*gZlR^3*mm^2*(2*psq^2 - 2*mm^2*s - 3*s^2 + 
         ...
         gZlR^4*(2*psq^3 + 2*mm^4*s - 2*psq^2*(2*s + 3*t) + 
           mm^2*s*(3*s + 5*t) - t*(s^2 + 3*s*t + 2*t^2) + 
           psq*(-5*mm^2*s + s^2 + 5*s*t + 6*t^2))) + 
       d^2*(gZlL^3*gZlR*mm^2*(2*psq^2 - 2*mm^2*s - s^2 + psq*(s - 4*t) + 
           s*t + 2*t^2) + gZlL*gZlR^3*mm^2*(2*psq^2 - 2*mm^2*s - s^2 + 
           psq*(s - 4*t) + s*t + 2*t^2) + 4*gZlL^2*gZlR^2*mm^2*
          (-psq^2 + mm^2*s + 2*psq*t - t*(s + t)) + 
         gZlL^4*(mm^4*s + mm^2*(-psq + s + t)^2 - psq*(psq^2 - 2*psq*t + 
             t*(s + t))) + gZlR^4*(mm^4*s + mm^2*(-psq + s + t)^2 - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*(psq - s - t)*
      ((4 - 6*d + d^2)*gZlL*gZlR*(2*mm^2 - 3*psq + s + t) + 
       gZlL^2*(-((-2 + d)^2*mm^2) + d^2*psq + 6*s + 4*t - 
         2*d*(psq + s + t)) + gZlR^2*(-((-2 + d)^2*mm^2) + d^2*psq + 6*s + 
         4*t - 2*d*(psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*
      (4*gZlL^2*gZlR^2*mm^2*(12*psq^2 + (2 - 7*d + d^2)*psq*s + 2*s^2 - 
         24*psq*t + (10 + d)*s*t + 12*t^2) + 2*gZlL^3*gZlR*mm^2*
        (6*(-2 + d)*psq^2 + (-16 + 11*d - 2*d^2)*psq*s + (-4 + d)*s^2 - 
         12*(-2 + d)*psq*t + (-8 + 5*d)*s*t + 6*(-2 + d)*t^2) + 
       2*gZlL*gZlR^3*mm^2*(6*(-2 + d)*psq^2 + (-16 + 11*d - 2*d^2)*psq*s + 
         (-4 + d)*s^2 - 12*(-2 + d)*psq*t + (-8 + 5*d)*s*t + 
         6*(-2 + d)*t^2) + gZlL^4*((16 - 10*d + d^2)*mm^4*(psq - t) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*(psq - t)*
      ((4 - 6*d + d^2)*gZlL*gZlR*(psq - t) + 2*gZlL^2*(-((-2 + d)*psq) + s + 
         (-2 + d)*t) + 2*gZlR^2*(-((-2 + d)*psq) + s + (-2 + d)*t))*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*(2*gZlL^2*gZlR^2*mm^2*(4*(4 - 6*d + d^2)*psq^2 + 
       ...
       4*gZlL*gZlR^3*mm^2*((-2 + d)^2*psq^2 + (-4 + d)*s^2 + 
         ...
         psq^2*(-8*s + 2*(20 - 12*d + d^2)*t) - 2*(-2 + d)*t*
          (s^2 + 3*s*t + 2*t^2) + psq*(4*s^2 + 2*(-2 + 3*d)*s*t - 
           (32 - 18*d + d^2)*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
    ...
    (4^(1 - 2*d)*EL^6*gAl*gAu*(-(2^(1 + 2*d)*(-2 + d)^2*gZlL^3*gZlR*mm^2*
       ...
       gZlR^4*((-4 + d)*mm^2*(2*Pi)^(2*d)*(psq - t)*((-2 + d)*psq - 2*s - 
         ...
         2^(1 + 2*d)*Pi^(2*d)*((-8 + 3*d)*psq^3 + psq*t*(4*(-2 + d)*s + 
             (-16 + 3*d)*t) + psq^2*((6 - 4*d)*s + (20 - 6*d + d^2)*t) + 
    ...
    (2^(1 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*(2*psq - s - 2*t)*
      (-((-2 + d)^2*gZlL^3*gZlR*mm^2*s) + 2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*
        mm^2*s - (-2 + d)^2*gZlL*gZlR^3*mm^2*s + 2*(-2 + d)*gZlL^4*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*(2*(14 - 7*d + d^2)*psq^2 - 
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*
      (-psq + s + t)*(-((16 - 10*d + d^2)*psq) + (24 - 10*d + d^2)*s + 
       ...
       SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*
      (gZlL^4 + gZlR^4)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*(psq - t)*
      ...
      (gZlL^4 + gZlR^4)*(psq - t)*((20 - 10*d + d^2)*psq + 4*s - 
    ...
    (4^(1 - d)*(8 - 6*d + d^2)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*(psq - t)^2*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*
      (psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[p3, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*
      (gZlL^4 + gZlR^4)*(psq - t)*((16 - 10*d + d^2)*psq + 8*s - 
       (16 - 10*d + d^2)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*
      (gZlL^4 + gZlR^4)*(psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
