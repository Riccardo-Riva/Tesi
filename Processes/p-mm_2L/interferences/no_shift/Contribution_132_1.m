...
(PropList[KiraPropagator[q1, ml], KiraPropagator[-p1 - p2 + q1, ml], 
  ...
  ((-3*EL^8*gAd^2*gAl^6*mb^2*ml^2*(4*mm^4 - 2*s^2 + d*s^2 + 
   ...
   (3*EL^8*gAd^2*gAl^6*ml^2*(-mm^2 + s + t)*SPList[SP[p1, q2], SP[p1, q2]])/
    (Pi^8*s^4) + (3*EL^8*gAd^2*gAl^6*(4*mm^4 - 2*s^2 + d*s^2 + 
      2*me^2*(4*mm^2 + (-2 + d)*s) + 6*s*t + 4*t^2 - 2*mm^2*(s + 4*t))*
     SPList[SP[p1, q2], SP[p2, q1]])/(4*Pi^8*s^4) + 
   (3*EL^8*gAd^2*gAl^6*ml^2*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^8*s^3) - 
   (3*EL^8*gAd^2*gAl^6*(me^2 - mm^2 + s + t)*SPList[SP[p1, q2], SP[p3, q1]])/
    (Pi^8*s^3) + (3*EL^8*gAd^2*gAl^6*ml^2*(4*me^2 - 2*mm^2 + 3*s + 2*t)*
   ...
   (3*EL^8*gAd^2*gAl^6*ml^2*(mm^2 - t)*SPList[SP[p2, q2], SP[p2, q2]])/
   ...
   (3*EL^8*gAd^2*gAl^6*(2*me^2 + s)*SPList[SP[p3, q1], SP[p3, q2]])/
    (Pi^8*s^3) - (6*EL^8*gAd^2*gAl^6*ml^2*(2*me^2 + s)*
