...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (-((2^(3 - 2*d)*d*EL^8*gAl^3*gAu^2*gFFA*gFFAA*mm^2*\[Mu]^(8 - 2*d))/
    Pi^(2*d)) + (2^(3 - 2*d)*d*EL^8*gAl^3*gAu^2*gFFA*gFFAA*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*d*EL^8*gAl^3*gAu^2*gFFA*gFFAA*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*(2*mm^2 - 2*psq + 3*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*d*EL^8*gAl^3*gAu^2*gFFA*gFFAA*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*d*EL^8*gAl^3*gAu^2*gFFA*gFFAA*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*(2*mm^2 - 2*psq + 3*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*d*EL^8*gAl^3*gAu^2*gFFA*gFFAA*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*d*EL^8*gAl^3*gAu^2*gFFA*gFFAA*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*(mm^2 - psq + s)*
