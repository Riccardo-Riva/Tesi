...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl^4*gHll^2*mm^4*(mm^2*(4*psq - 7*s) + 
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAl^4*gHll^2*mm^2*((8 - 7*d + 3*d^2)*mm^4 + 
      (-2 + d)*s*((-5 + d)*psq + 2*s) - mm^2*(6*s + d^2*(3*psq + s) - 
        d*(9*psq + 7*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^4*gHll^2*mm^4*((12 - 13*d + 3*d^2)*mm^2 + 
      (-12 + 11*d - 2*d^2)*psq - d^2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl^4*gHll^2*mm^2*((8 - d + d^2)*mm^4 + 
     ...
     SPList[SP[q2, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl^4*gHll^2*mm^2*
     (2*mm^4 + (2 - 5*d + d^2)*psq*s - mm^2*(2*psq + (2 - 3*d + d^2)*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^4*gHll^2*mm^2*(2*(-2 + d)*mm^4 - 
      s*((18 - 9*d + d^2)*psq + 2*(-2 + d)*s) + 
      mm^2*(-2*(-2 + d)*psq + (10 - 11*d + 2*d^2)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^4*gHll^2*mm^2*((10 - 3*d + d^2)*mm^2 + 
      (2 + 3*d - d^2)*psq + 2*d*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^4*gHll^2*mm^2*((-16 + 3*d)*mm^2 - 3*d*psq + 
      d^2*(psq - s) + 8*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl^4*gHll^2*mm^2*((4 - 3*d + d^2)*mm^2 - 
      (4 - 5*d + d^2)*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
    Pi^(2*d) + (4^(1 - d)*EL^6*gAl^4*gHll^2*mm^2*((24 - 13*d + 2*d^2)*mm^2 + 
      (-40 + 17*d - 2*d^2)*psq + (8 - 4*d + d^2)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*d*EL^6*gAl^4*gHll^2*mm^2*((1 + d)*mm^2 - (-3 + d)*psq + 
      (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl^4*gHll^2*mm^2*((4 - 13*d + 2*d^2)*mm^2 - 
      (4 - 5*d + d^2)*psq - (8 - 4*d + d^2)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl^4*gHll^2*mm^2*(2*(10 - 7*d + d^2)*mm^2 - 
   ...
   (2^(3 - 2*d)*d*EL^6*gAl^4*gHll^2*mm^2*(mm^2 - psq + (-4 + d)*s)*
   ...
   (2^(5 - 2*d)*(-6 + d)*EL^6*gAl^4*gHll^2*mm^2*\[Mu]^(8 - 2*d)*
