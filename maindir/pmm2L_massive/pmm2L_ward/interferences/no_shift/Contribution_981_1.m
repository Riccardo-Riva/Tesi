(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
  ...
  ((I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*s*(s + t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*s*(s + t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*s*(s + 2*t)*
   ...
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(s + 2*t)*
