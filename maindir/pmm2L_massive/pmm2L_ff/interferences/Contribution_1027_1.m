...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*(-10*(-2 + d)*psq^2 + 
       ...
       2*psq*((4 + d)*s + 5*(-2 + d)*t))*\[Mu]^(8 - 2*d))/(mz^2*Pi^(2*d)*s) + 
    ...
    (2^(1 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
     ...
     (mz^2*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
      ...
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(mz^2*Pi^(2*d)*s) + 
    (2^(1 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
      (-2*(-8 + 5*d)*psq^3 + mm^2*(psq - s - t)*((-6 + 8*d)*psq + s - 3*d*s + 
         6*t - 8*d*t) + t*(s + t)*((-11 + 4*d)*s + 2*(-5 + 3*d)*t) + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 - psq)*
    ...
    (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*psq*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/
     (mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
      (gZlL + gZlR)*(psq^2 + mm^2*s - 2*psq*(s + t) + t*(s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/
     (mz^2*Pi^(2*d)*s) - (2^(5 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
    ...
    (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)*
      ...
      gWWA*gWWZ*(gZlL + gZlR)*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)*
      ...
      gWWA*gWWZ*(gZlL + gZlR)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
    (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 - psq)*
    ...
    (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)*s) + (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
      ...
      SPList[SP[p1, q2], SP[p3, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)) - 
    (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
      (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (5*4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)^2*
    ...
    (5*4^(2 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)^2*
    ...
    (4^(2 - d)*(-5 + 3*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)^2*
    ...
    (5*2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[p3, q1]])/(mz^2*Pi^(2*d)) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*
      gWWA*gWWZ*(gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1], SP[p3, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)) - 
    (5*4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*
      gWWA*gWWZ*(gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
