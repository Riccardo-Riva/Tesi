...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/Pi^(2*d)) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(mm^2 - psq)*(-psq + s + t)*
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(mm^2 - psq)*(psq - t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(mm^2 - 2*psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*
   ...
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(2*mm^2 - 2*psq + s)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[q2, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(3 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*\[Mu]^(8 - 2*d)*
