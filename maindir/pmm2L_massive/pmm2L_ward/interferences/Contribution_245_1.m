...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*s^2*
  ...
  (I*4^(-1 - d)*EL^5*ggmgmA*ggmgmZ^2*s^2*
    (aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(s + t) + gZlR^2*(s + t)) - 
     bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*(3*mm^2 - 3*psq + s + t) + 
       gZlR^2*(3*mm^2 - 3*psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*s*
    (-3*psq + s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*ggmgmA*ggmgmZ^2*s^2*
    (aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(3*mm^2 - psq - t) + 
       gZlR^2*(3*mm^2 - psq - t)) + bb*(2*gZlL*gZlR*mm^2 + 
       gZlL^2*(-2*psq + t) + gZlR^2*(-2*psq + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*
    ggmgmZ^2*gZlL*gZlR*mm^2*s*(-3*psq + 2*s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) - (I*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
    s^2*((aa + bb)*(mm^2 - psq) + (aa - bb)*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa + bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*EL^5*ggmgmA*ggmgmZ^2*s*
    (-(aa*(gZlL^2*(psq*(psq - 2*s - t) + mm^2*(psq + s - t)) + 
  ...
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
    (aa*(6*gZlL*gZlR*mm^2 + gZlL^2*(psq - 4*(s + t)) + 
       gZlR^2*(psq - 4*(s + t))) + bb*(-6*gZlL*gZlR*mm^2 + 
       gZlL^2*(10*mm^2 - 11*psq + 4*(s + t)) + 
       gZlR^2*(10*mm^2 - 11*psq + 4*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*(4*psq - s - 4*t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
    (aa*(-6*gZlL*gZlR*mm^2 + gZlL^2*(10*mm^2 - 3*psq - 4*t) + 
       gZlR^2*(10*mm^2 - 3*psq - 4*t)) + 
     bb*(6*gZlL*gZlR*mm^2 + gZlL^2*(-7*psq + 4*t) + gZlR^2*(-7*psq + 4*t)))*
  ...
  ((3*I)*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*
    (-(bb*(6*mm^2 - 8*psq + s + 2*t)) + aa*(-6*mm^2 + 4*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
    (aa*(4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(2*psq^2 + 2*mm^2*(psq + 2*s - t) - 2*psq*(2*s + t) - 
         s*(s + 2*t)) + gZlR^2*(2*psq^2 + 2*mm^2*(psq + 2*s - t) - 
         2*psq*(2*s + t) - s*(s + 2*t))) + 
     bb*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-2*psq^2 - 6*psq*s + s^2 + 2*psq*t + 2*s*t + 
         mm^2*(-2*psq + 6*s + 2*t)) + gZlR^2*(-2*psq^2 - 6*psq*s + s^2 + 
         2*psq*t + 2*s*t + mm^2*(-2*psq + 6*s + 2*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
    (-(aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(s + t) + gZlR^2*(s + t))) + 
     bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*(3*mm^2 - 3*psq + s + t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
    (bb*(-4*gZlL*gZlR*mm^2 + gZlL^2*(3*mm^2 - 2*psq + s + t) + 
       gZlR^2*(3*mm^2 - 2*psq + s + t)) - 
     aa*(-4*gZlL*gZlR*mm^2 + gZlL^2*(psq + s + t) + gZlR^2*(psq + s + t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
    (aa*(-4*gZlL*gZlR*mm^2 + gZlL^2*(3*mm^2 - t) + gZlR^2*(3*mm^2 - t)) + 
     bb*(4*gZlL*gZlR*mm^2 + gZlL^2*(-3*psq + t) + gZlR^2*(-3*psq + t)))*
  ...
  (I*4^(-1 - d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*
    (-(bb*(4*mm^2 - 5*psq + s + t)) + aa*(-2*mm^2 + psq + s + t))*
  ...
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
    (aa*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
     ...
     bb*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-psq^2 + psq*(-4*s + t) + s*(s + t) + mm^2*(-psq + 4*s + t)) + 
       gZlR^2*(-psq^2 + psq*(-4*s + t) + s*(s + t) + mm^2*(-psq + 4*s + t))))*
  ...
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
    (bb*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
     ...
     aa*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(psq^2 + mm^2*(psq + 3*s - t) - s*t - psq*(3*s + t)) + 
       gZlR^2*(psq^2 + mm^2*(psq + 3*s - t) - s*t - psq*(3*s + t))))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*
   ...
   Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
    (aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(psq - 2*(s + t)) + 
       gZlR^2*(psq - 2*(s + t))) + bb*(-2*gZlL*gZlR*mm^2 + 
       gZlL^2*(4*mm^2 - 5*psq + 2*(s + t)) + 
       gZlR^2*(4*mm^2 - 5*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
    (aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 - psq - 2*t) + 
       gZlR^2*(4*mm^2 - psq - 2*t)) + 
  ...
  (I*EL^5*ggmgmA*ggmgmZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(psq - 2*(s + t)) + 
       gZlR^2*(psq - 2*(s + t))) + bb*(-2*gZlL*gZlR*mm^2 + 
       gZlL^2*(4*mm^2 - 5*psq + 2*(s + t)) + 
       gZlR^2*(4*mm^2 - 5*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggmgmA*ggmgmZ^2*
    (-(bb*(-6*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 - 3*psq + 2*(s + t)) + 
        gZlR^2*(4*mm^2 - 3*psq + 2*(s + t)))) + 
     aa*(-6*gZlL*gZlR*mm^2 + gZlL^2*(psq + 2*(s + t)) + 
       gZlR^2*(psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggmgmA*ggmgmZ^2*
    (aa*(-6*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 + psq - 2*t) + 
       gZlR^2*(4*mm^2 + psq - 2*t)) + 
     bb*(6*gZlL*gZlR*mm^2 + gZlL^2*(-5*psq + 2*t) + gZlR^2*(-5*psq + 2*t)))*
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
   ...
   (2*Pi)^(2*d) + (I*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
    (aa*(psq - s - t) + bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
     gZlR^2*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/
   (2*Pi)^(2*d) - (I*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
    (aa*(psq - s - t) + bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
