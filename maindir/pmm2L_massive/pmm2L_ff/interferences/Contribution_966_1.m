...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gZNL^2*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gZNL^2*mm^2*(-2*gZlL*gZlR*s^2*(-2*psq + s + 2*t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gZNL^2*(-2*gZlL*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
      gZlL^2*((4 - 5*d + d^2)*mm^4*(psq - t) + mm^2*(psq - t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gZNL^2*(-4*(-2 + d)*gZlL*gZlR*mm^2*
      ...
      gZlR^2*((-64 + 30*d - 4*d^2)*psq^3 - mm^2*(psq - s - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gZNL^2*(2*gZlL*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*gZNL^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gZNL^2*(2*gZlL*gZlR*mm^2*s^2 + 
      gZlL^2*(-((8 - 5*d + d^2)*mm^4*s) + mm^2*(2*(8 - 6*d + d^2)*psq^2 + 
          ...
          psq*((-4 + d)*s + (-2 + d)*t))) + 
      gZlR^2*((4 - 5*d + d^2)*mm^4*s + s*(-((6 - 5*d + d^2)*psq^2) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gZNL^2*(gZlL^2*((-56 + 31*d - 5*d^2)*psq^3 + 
        2*(s + t)*((-4 + d)*s^2 + (10 - 6*d + d^2)*s*t + 
          (18 - 8*d + d^2)*t^2) - psq*(10*(-4 + d)*s^2 + (72 - 49*d + 9*d^2)*
           s*t + (128 - 63*d + 9*d^2)*t^2) + psq^2*(148*t + 3*d^2*(s + 4*t) - 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gZNL^2*(-4*gZlL*gZlR*mm^2*s + 
      gZlR^2*(-((-4 + d)*psq*s) + 2*mm^2*(psq - t)) + 
      gZlL^2*((-2 + d)*psq*s + 2*mm^2*(psq - t)))*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gZNL^2*(4*gZlL*gZlR*mm^2*(2*(-2 + d)*psq^2 - s^2 + 
      ...
      gZlR^2*(-2*(8 - 6*d + d^2)*psq^3 - mm^2*(psq - t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gZNL^2*(-4*(-2 + d)*gZlL*gZlR*mm^2*
       (2*psq - s - 2*t)*(psq - t) + (-4 + d)*gZlL^2*
       (6*psq^3 + 2*(-4 + d)*t^2*(s + t) - 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gZNL^2*
     (gZlR^2*(-((8 - 6*d + d^2)*psq^2) - (s + t)*(2*s - (-4 + d)*t) + 
        psq*((8 - 5*d + d^2)*s + (12 - 7*d + d^2)*t) + 
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*gZNL^2*
     ...
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
     gZNL^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl*gAu*gZNL^2*psq*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gZNL^2*
     ((-4 + d)*gZlL^2*((-2 + d)*mm^2 + (-4 + d)*psq) - 
      gZlR^2*((-2 + d)^2*mm^2 + (20 - 10*d + d^2)*psq))*(psq - t)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*gZNL^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
     gZNL^2*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/
    Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gZNL^2*
     (gZlR^2*((-32 + 15*d - 2*d^2)*psq^2 - (-2 + d)*mm^2*s + (2 + d)*psq*s + 
        4*s^2 - d*s^2 + 2*(32 - 15*d + 2*d^2)*psq*t - 28*s*t + 14*d*s*t - 
        2*d^2*s*t - 32*t^2 + 15*d*t^2 - 2*d^2*t^2) + 
      gZlL^2*((30 - 15*d + 2*d^2)*psq^2 + (-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 
        26*s*t - 14*d*s*t + 2*d^2*s*t + 30*t^2 - 15*d*t^2 + 2*d^2*t^2 - 
        psq*((-2 + d)*s + 2*(30 - 15*d + 2*d^2)*t)))*\[Mu]^(8 - 2*d)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gZNL^2*
     (gZlL^2*(2*(-5 + d)*psq^2 + 2*psq*s - (4 - 5*d + d^2)*mm^2*(psq - t) - 
      ...
      gZlR^2*(-2*(-1 + d)*psq^2 + 2*psq*s + (8 - 5*d + d^2)*mm^2*(psq - t) + 
        (12 - 5*d + d^2)*psq*t - (14 - 7*d + d^2)*t*(s + t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*gZNL^2*(psq - t)*
     ...
     (gZlL^2*((-2 + d)^2*psq^2 + (-4 + d)*mm^2*s - 10*s^2 + 3*d*s^2 - 6*s*t - 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gZNL^2*((-4 + d)*gZlL^2*(psq^2 + (-2 + d)*mm^2*s + 
        (-6 + d)*psq*s - 2*psq*t + (s + t)^2) - 
      gZlR^2*((-8 + 3*d)*psq^2 + (-2 + d)^2*mm^2*s + (36 - 16*d + d^2)*psq*
         s + 2*(8 - 3*d)*psq*t + (-8 + 3*d)*(s + t)^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*gZNL^2*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gZNL^2*(gZlL^2*(-3*(10 - 6*d + d^2)*psq^2 + 
      ...
      gZlR^2*((28 - 18*d + 3*d^2)*psq^2 + (8 - 3*d)*psq*s - 8*s^2 + 2*d*s^2 - 
        (4 - 5*d + d^2)*mm^2*(psq - t) + (-52 + 31*d - 5*d^2)*psq*t + 
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*gZNL^2*(psq - t)*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
     gZNL^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[p3, q1]])/Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
     gZNL^2*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gZNL^2*(psq - t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
     ...
     (-((-2 + d)*gZlL^2*(psq - t)) + gZlR^2*((-4 + d)*psq + 2*s + 4*t - d*t))*
    ...
    Pi^(2*d) + (2^(3 - 2*d)*(18 - 9*d + d^2)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)*
     ...
     (gZlL^2*((-2 + d)^2*psq^2 + (-4 + d)*s^2 + 2*(-3 + d)*s*t + 
      ...
      gZlR^2*((8 - 6*d + d^2)*psq^2 + (-4 + d)*s^2 + 2*(-3 + d)*s*t + 
        (8 - 6*d + d^2)*t^2 - 2*psq*((-3 + d)*s + (8 - 6*d + d^2)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gZNL^2*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gZNL^2*(psq - t)*
    ...
    Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*gZNL^2*(psq - t)^2*
