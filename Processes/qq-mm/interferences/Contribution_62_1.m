...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[-p2 - q1, mm], 
 ...
 (((-I)*4^(-1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
    (gZlL*gZuL*(2^(1 + d)*(-2 + d)*mm^4*Pi^d*s + d^2*(2*Pi)^d*s^2*t - 
       2^(1 + d)*mmv^2*Pi^d*((-4 + d)^2*s - 4*t)*t - 2^(1 + d)*mmv^4*Pi^d*
        ((-6 + d)*s + 2*t) - 2^(1 + d)*Pi^d*t*(4*(-2 + d)*s^2 - 
         (10 - 7*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*mm^2*Pi^d*
        (8*mmv^4 + 2*(-2 + d)^2*s^2 + (36 - 21*d + 4*d^2)*s*t + 8*t^2 - 
         4*mmv^2*((8 - 5*d + d^2)*s + 4*t))) + 
     gZlR*gZuR*(2^(1 + d)*(-2 + d)*mm^4*Pi^d*s + d^2*(2*Pi)^d*s^2*t - 
       2^(1 + d)*mmv^2*Pi^d*((-4 + d)^2*s - 4*t)*t - 2^(1 + d)*mmv^4*Pi^d*
        ((-6 + d)*s + 2*t) - 2^(1 + d)*Pi^d*t*(4*(-2 + d)*s^2 - 
         (10 - 7*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*mm^2*Pi^d*
        (8*mmv^4 + 2*(-2 + d)^2*s^2 + (36 - 21*d + 4*d^2)*s*t + 8*t^2 - 
         4*mmv^2*((8 - 5*d + d^2)*s + 4*t))) + 
     gZlR*gZuL*(2^(1 + d)*(-2 + d)*mm^4*Pi^d*s - 2^(1 + d)*mmv^4*Pi^d*
        ((-6 + d)*s + 2*t) + 2^(1 + d)*mmv^2*Pi^d*t*((8 - 6*d + d^2)*s + 
         4*t) + 2^(1 + d)*mm^2*Pi^d*(8*mmv^4 - 2*(8 - 6*d + d^2)*s^2 + 
         4*mmv^2*((4 - 5*d + d^2)*s - 4*t) + (-12 + 19*d - 4*d^2)*s*t + 
         8*t^2) - t*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + 
           (14 - 7*d + d^2)*s*t + 2*t^2))) + 
     gZlL*gZuR*(2^(1 + d)*(-2 + d)*mm^4*Pi^d*s - 2^(1 + d)*mmv^4*Pi^d*
        ((-6 + d)*s + 2*t) + 2^(1 + d)*mmv^2*Pi^d*t*((8 - 6*d + d^2)*s + 
         4*t) + 2^(1 + d)*mm^2*Pi^d*(8*mmv^4 - 2*(8 - 6*d + d^2)*s^2 + 
         4*mmv^2*((4 - 5*d + d^2)*s - 4*t) + (-12 + 19*d - 4*d^2)*s*t + 
         8*t^2) - t*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + 
  ...
  (I*2^(-1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
    (gZlR*(gZuR*mm^2*(8*mmv^2 + (-16 + 14*d - 3*d^2)*s - 8*t) + 
       gZuL*mm^2*(8*mmv^2 + (20 - 16*d + 3*d^2)*s - 8*t) - 
       gZuR*mmv^2*(4*mmv^2 + (-4 + d)^2*s - 4*t) + 
       gZuL*mmv^2*(-4*mmv^2 + (8 - 6*d + d^2)*s + 4*t)) + 
     gZlL*(gZuL*mm^2*(8*mmv^2 + (-16 + 14*d - 3*d^2)*s - 8*t) + 
       gZuR*mm^2*(8*mmv^2 + (20 - 16*d + 3*d^2)*s - 8*t) - 
       gZuL*mmv^2*(4*mmv^2 + (-4 + d)^2*s - 4*t) + 
       gZuR*mmv^2*(-4*mmv^2 + (8 - 6*d + d^2)*s + 4*t)))*SPList[SP[p1, p2]])/
   (Pi^d*(mz^2 - s)*s) + (I*2^(-1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
    (gZlR*(gZuR*mm^2*(8*mmv^2 + (-40 + 18*d - 3*d^2)*s - 8*t) + 
       gZuL*mm^2*(8*mmv^2 + (-4 - 12*d + 3*d^2)*s - 8*t) + 
       gZuR*mmv^2*(-4*mmv^2 + (8 + 4*d - d^2)*s + 4*t) + 
       gZuL*mmv^2*(-4*mmv^2 + (32 - 10*d + d^2)*s + 4*t)) + 
     gZlL*(gZuL*mm^2*(8*mmv^2 + (-40 + 18*d - 3*d^2)*s - 8*t) + 
       gZuR*mm^2*(8*mmv^2 + (-4 - 12*d + 3*d^2)*s - 8*t) + 
       gZuL*mmv^2*(-4*mmv^2 + (8 + 4*d - d^2)*s + 4*t) + 
       gZuR*mmv^2*(-4*mmv^2 + (32 - 10*d + d^2)*s + 4*t)))*
    SPList[SP[p1, p3]])/(Pi^d*(mz^2 - s)*s) - 
  (I*2^(-1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
    (gZlL*gZuL*(8*mmv^4 - 16*s^2 + 8*d*s^2 - d^2*s^2 + 
       mmv^2*((36 - 22*d + 3*d^2)*s - 12*t) - 20*s*t + 14*d*s*t - 2*d^2*s*t + 
       4*t^2 + mm^2*(-8*mmv^2 + (20 - 14*d + 3*d^2)*s + 8*t)) + 
     gZlR*gZuR*(8*mmv^4 - 16*s^2 + 8*d*s^2 - d^2*s^2 + 
       mmv^2*((36 - 22*d + 3*d^2)*s - 12*t) - 20*s*t + 14*d*s*t - 2*d^2*s*t + 
       4*t^2 + mm^2*(-8*mmv^2 + (20 - 14*d + 3*d^2)*s + 8*t)) + 
     gZlR*gZuL*(8*mmv^4 + 8*s^2 - 6*d*s^2 + d^2*s^2 + 28*s*t - 14*d*s*t + 
       2*d^2*s*t + 4*t^2 + mm^2*(-8*mmv^2 + (-16 + 16*d - 3*d^2)*s + 8*t) - 
       mmv^2*((36 - 20*d + 3*d^2)*s + 12*t)) + 
     gZlL*gZuR*(8*mmv^4 + 8*s^2 - 6*d*s^2 + d^2*s^2 + 28*s*t - 14*d*s*t + 
       2*d^2*s*t + 4*t^2 + mm^2*(-8*mmv^2 + (-16 + 16*d - 3*d^2)*s + 8*t) - 
       mmv^2*((36 - 20*d + 3*d^2)*s + 12*t)))*SPList[SP[p1, q1]])/
   (Pi^d*(mz^2 - s)*s) + (I*2^(-1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
    (-(gZlR*gZuL*(mm^2*(8*mmv^2 + (20 - 16*d + 3*d^2)*s - 8*t) + 
        mmv^2*(-4*mmv^2 + (8 - 6*d + d^2)*s + 4*t))) - 
     gZlL*gZuR*(mm^2*(8*mmv^2 + (20 - 16*d + 3*d^2)*s - 8*t) + 
       mmv^2*(-4*mmv^2 + (8 - 6*d + d^2)*s + 4*t)) + 
     gZlL*gZuL*(mmv^2*(4*mmv^2 + (-4 + d)^2*s - 4*t) + 
       mm^2*(-8*mmv^2 + (16 - 14*d + 3*d^2)*s + 8*t)) + 
     gZlR*gZuR*(mmv^2*(4*mmv^2 + (-4 + d)^2*s - 4*t) + 
       mm^2*(-8*mmv^2 + (16 - 14*d + 3*d^2)*s + 8*t)))*SPList[SP[p2, p3]])/
   (Pi^d*(mz^2 - s)*s) + (I*2^(-1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
    (-(gZlR*gZuL*(mm^2*(8*mmv^2 + (20 - 16*d + 3*d^2)*s - 8*t) + 
        mmv^2*(-4*mmv^2 + (8 - 6*d + d^2)*s + 4*t))) - 
     gZlL*gZuR*(mm^2*(8*mmv^2 + (20 - 16*d + 3*d^2)*s - 8*t) + 
     ...
     gZlL*gZuL*(mmv^2*(4*mmv^2 + (-4 + d)^2*s - 4*t) + 
       mm^2*(-8*mmv^2 + (16 - 14*d + 3*d^2)*s + 8*t)) + 
     gZlR*gZuR*(mmv^2*(4*mmv^2 + (-4 + d)^2*s - 4*t) + 
       mm^2*(-8*mmv^2 + (16 - 14*d + 3*d^2)*s + 8*t)))*SPList[SP[p2, q1]])/
   (Pi^d*(mz^2 - s)*s) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*
   ...
   (Pi^(2*d)*(mz^2 - s)*s) + (I*EL^6*gAl*gAu*gHll^2*mm^2*
  ...
  (I*EL^6*gAl*gAu*gHll^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
  ...
  (I*EL^6*gAl*gAu*gHll^2*mm^2*(gZlL*gZuL*(4*mm^2 + 2*(-5 + d)*mmv^2 + 4*s - 
   ...
   ((2*Pi)^d*(mz^2 - s)*s) + (I*EL^6*gAl*gAu*gHll^2*mm^2*
  ...
  (I*EL^6*gAl*gAu*gHll^2*mm^2*((gZlR*gZuL*(2*mmv^2 + (-6 + d)*s - 2*t) + 
  ...
  (I*EL^6*gAl*gAu*gHll^2*mm^2*((2^(2 - d)*(gZlL + gZlR)*(gZuL + gZuR))/Pi^d + 
     (gZlR*gZuL*(-2*mmv^2 - (-6 + d)*s + 2*t) + 
       gZlL*gZuR*(-2*mmv^2 - (-6 + d)*s + 2*t) + 
       gZlL*gZuL*(-2*mmv^2 + d*s + 2*t) + gZlR*gZuR*(-2*mmv^2 + d*s + 2*t))/
      ((2*Pi)^d*s))*SPList[SP[p1, p3], SP[p3, q1]])/(mz^2 - s) + 
  (I*EL^6*gAl*gAu*gHll^2*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
  ...
  (I*EL^6*gAl*gAu*gHll^2*mm^2*(gZlL*gZuL*(4*mm^2 + 2*(-5 + d)*mmv^2 + 4*s - 
   ...
   ((2*Pi)^d*s*(-mz^2 + s)) - (I*EL^6*gAl*gAu*gHll^2*mm^2*
  ...
  (I*2^(1 - d)*EL^6*gAl*gAu*gHll^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
     (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*mm^2*(mmv^2 - t)*
    SPList[SP[p2, p3], SP[p2, q1]])/(Pi^d*s*(-mz^2 + s)) + 
  (I*EL^6*gAl*gAu*gHll^2*mm^2*(gZlL*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
     gZlR*gZuR*(2*mmv^2 - (-4 + d)*s - 2*t) + 
     gZlR*gZuL*(2*mmv^2 + (-2 + d)*s - 2*t) + 
  ...
  (I*EL^6*gAl*gAu*gHll^2*mm^2*(gZlL*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
   ...
   ((2*Pi)^d*(mz^2 - s)*s) - (I*2^(1 - d)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)*
