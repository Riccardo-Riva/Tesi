...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
  ...
  (-((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*(gZlL^2 + gZlR^2)*t*(s + 2*t)*
   ...
   (4^(1 - d)*(-5 + d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*(gZlL^2 + gZlR^2)*((-4 + d)*s - 2*t)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*(gZlL^2 + gZlR^2)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*(gZlL^2 + gZlR^2)*t*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*(gZlL^2 + gZlR^2)*
     ((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*
     (gZlL^2 + gZlR^2)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     ggmgmZ^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmZ^2*(gZlL^2 + gZlR^2)*t*\[Mu]^(8 - 2*d)*
