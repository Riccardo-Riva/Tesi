...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mz], 
 ...
 (((-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((28 - 12*d + d^2)*s - 
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ((52 - 18*d + d^2)*s^2 + 4*(3 - 2*d)*s*t - 4*(2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(3*(-4 + d)^2*s^2 + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((28 - 12*d + d^2)*s^2 - 
  ...
  (EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((8 + 20*d - 10*d^2 + d^3)*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((22 - 11*d + d^2)*s^2 - 
     (2 + d)*s*t - 2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
  ...
  ((-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((24 - 10*d + d^2)*s^2 + 
     (-22 + 3*d)*s*t + 2*(-6 + d)*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-160 + 100*d - 19*d^2 + d^3)*s^2 - 
  ...
  (4^(1 - d)*(16 - 10*d + d^2)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + t)*
   ...
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ((-3 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
  ...
  (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + 2*t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    (5*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q1]])/
  ...
  (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + 2*t)*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-124 + 80*d - 16*d^2 + d^3)*EL^8*gAl^4*gAu^2*
