...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, 0], 
  ...
  ((EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq^2 - 2*s^2 + d*s^2 - s*t + 
      2*t^2 + 2*mm^2*(-psq + d*s + t) - psq*((-7 + d)*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mh^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq^2 - 2*s^2 + d*s^2 - s*t + 
      2*t^2 + 2*mm^2*(-psq + d*s + t) - psq*((-7 + d)*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(mh^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq^2 + s^2 + d*s^2 + 
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
    ...
    (mh^2*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
    ...
    (4^d*mh^2*Pi^(2*d)*s) - (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*mm^2 + 2*psq + (-1 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    (4^d*mh^2*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(-2*psq + 3*s + 2*t)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq - (-2 + d)*s - 2*t)*
    ...
    (mh^2*(2*Pi)^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
 ...
 PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mh], 
   KiraPropagator[p3 + q2, mm], KiraPropagator[-p1 - p2 + p3 + q2, mm], 
   KiraPropagator[q1 + q2, mw]]*
  ((EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(-2*psq^2 + (-7 + d)*psq*s + 
