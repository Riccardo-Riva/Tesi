...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl^2*gAu*gFAW*gFll*gWlN*mm^2*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFAW*gFll*gWlN*mm^2*
    ...
    Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFAW*gFll*gWlN*mm^2*
     ((-4 + d)*psq*s + 2*mm^2*((-2 + d)*psq + 3*s - d*s + 2*t - d*t))*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFAW*gFll*gWlN*mm^2*(psq - t)^2*
