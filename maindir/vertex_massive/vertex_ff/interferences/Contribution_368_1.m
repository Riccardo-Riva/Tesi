...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  (-((2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/Pi^(2*d)) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (-psq^4 + s*t*(s + t)^2 + psq^3*(-2*s + 3*t) + 
      ...
      mm^2*(psq^3 - (s + t)^3 - psq^2*(2*s + 3*t) + 
        psq*(3*s^2 + 5*s*t + 3*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (-psq^4 + s*t^2*(s + t) + psq^3*(s + 3*t) - psq^2*t*(2*s + 3*t) + 
      psq*t*(s^2 + t^2) + mm^2*(psq^3 + psq^2*(s - 3*t) - t^3 - 
        psq*(s^2 + s*t - 3*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
     (psq - s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (psq^3 - psq^2*(s + 4*t) + psq*t*(3*s + 5*t) - t*(s^2 + 3*s*t + 2*t^2) + 
      mm^2*(psq^2 + s^2 + 3*s*t + t^2 - 2*psq*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^2*(mm^2 - psq)*(psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/Pi^(2*d) + (3*4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^4*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (9*psq^3 + 9*psq*(s + t)^2 - 2*(s + t)^3 - 2*psq^2*(7*s + 8*t) + 
      mm^2*(-5*psq^2 + 2*s^2 + s*t - t^2 + psq*(s + 6*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (3*4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (5*psq^3 - psq^2*(s + 12*t) - 2*t*(3*s^2 + 4*s*t + t^2) + 
      psq*(-2*s^2 + 13*s*t + 9*t^2) + mm^2*(3*psq^2 + 2*s^2 + 2*s*t + 3*t^2 - 
        6*psq*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s) + (3*4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
     (2*psq^2 + s^2 + 4*s*t + 2*t^2 - 4*psq*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (-4*psq^3 + mm^2*(4*psq - 7*s - 4*t)*(psq - t) + psq^2*(11*s + 8*t) + 
      2*s*(s^2 + 4*s*t + 3*t^2) - psq*(7*s^2 + 17*s*t + 4*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
     (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (-3*psq^3 + 3*mm^2*(psq - t)*(psq - s - t) + psq^2*(s + 8*t) + 
      psq*(s^2 - 4*s*t - 7*t^2) + t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (3*psq^3 - 6*psq^2*s + psq*(s^2 + 10*s*t - 5*t^2) + 
      2*t*(-2*s^2 - s*t + t^2) + mm^2*(psq^2 - 9*psq*s + 4*s^2 - 6*psq*t + 
        7*s*t + 5*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (-2*psq^3 + s^3 + s^2*t + 2*s*t^2 + 2*t^3 - mm^2*s*(s + 2*t) + 
      2*psq^2*(s + 3*t) - psq*(3*s^2 + 2*s*t + 6*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(2*psq - s - 2*t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     ...
     gWWA*mm^2*(3*psq^2 - 3*psq*(s + t) + s*(s + t) + 
   ...
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^2*(psq*(s - 2*t) + 2*t^2 + mm^2*(-psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^2*(2*psq^2 - 4*psq*t + t*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (2*psq^2 - 7*psq*s + 4*s^2 - 4*psq*t + 4*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (psq^2 + s^2 - 2*psq*t + t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(psq - t)*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^2*(-2*psq^2 + mm^2*s - s^2 - 5*s*t - 2*t^2 + 4*psq*(s + t))*
   ...
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     ...
     gWWA*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*
     mm^2*(-(psq*s) + mm^2*(psq - t) + 2*psq*t - 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (2*psq^2 - 4*psq*t + t*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (psq^2 + psq*(2*s + t) + mm^2*(-3*psq + s + 3*t) - 2*(s^2 + t^2))*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     ...
     mm^2*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
     ...
     gWWA*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^2*(2*psq^2 - 2*s^2 + psq*(s - 4*t) - s*t + 2*t^2)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(psq - 2*s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*s*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], SP[p3, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(2*psq - s - 2*t)*
