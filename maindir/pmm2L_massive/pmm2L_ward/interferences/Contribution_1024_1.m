...
PropList[KiraPropagator[q1, mw], KiraPropagator[q2, mh], 
  ...
  ((I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*s*
   ...
   (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
     gWWZ*(gZlL + gZlR)*mm^2*(2*aa*mm^2*(psq - t) - 2*bb*mm^2*(psq + s - t) - 
   ...
   (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*s*
    ...
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*
     gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*s*(-2*psq + s + 2*t)*
   ...
   (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) - (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*
     gWWZ*(gZlL + gZlR)*mm^2*(mm^2 - 5*psq + 4*(s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) + (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*
     (gZlL + gZlR)*mm^2*(aa*(4*mm^2 + 2*psq - s - 6*t) + 
      bb*(-6*psq + s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*
     gWWZ*(gZlL + gZlR)*mm^2*(mm^2 + 3*psq - 4*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     ...
     SPList[SP[p1, p3], SP[p2, q1]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) - 
   ...
   (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     (aa*(psq - 2*s - t) + bb*(2*mm^2 - 3*psq + 2*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) - 
   (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     (aa*(psq - 3*s - t) + bb*(2*mm^2 - 3*psq + 3*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, p3]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) - 
   (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     (aa*(psq - 3*s - t) + bb*(2*mm^2 - 3*psq + 3*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) - 
   (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(psq - t)*
   ...
   (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(psq - t)*
    ...
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) - (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*
     (gZlL + gZlR)*mm^2*(-(aa*s) + bb*(mm^2 - psq + s))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
     mm^2*(3*psq - s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/
   ...
   (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*
     gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*
     gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(3*psq - 2*s - 3*t)*
    ...
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) - (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*
     ...
     SPList[SP[p2, q1], SP[p3, p3]])/(4^d*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
     mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*
     (gZlL + gZlR)*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q2, q2]])/(4^d*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     (-(bb*s) + aa*(mm^2 - psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
     mm^2*(3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*
     gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*
     gHWW*gWWZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p1, p2], SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) + 
  ...
  (((-I)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*s*
   ...
   (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     (aa*(psq^2 - psq*t - s*t) + bb*(-psq^2 + s*(2*mm^2 + t) + 
        psq*(-2*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
     gWWZ*(gZlL + gZlR)*mm^2*(-2*aa*mm^2*(psq - t) + 
      2*bb*mm^2*(psq + s - t) + bb*s*(-7*psq + 2*s + 5*t) - 
      aa*s*(-5*psq + 2*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*
     gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(psq^2 + 2*mm^2*(psq - t) - 
      psq*(5*s + t) + 2*s*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
     gWWZ*(gZlL + gZlR)*mm^2*(bb*(-psq^2 + psq*(-s + t) + s*(s + t)) + 
      aa*(psq^2 - psq*(s + t) - s*(-2*mm^2 + s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3]])/((mh^2 - mz^2)*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     (bb*s*(5*psq - 3*s - 5*t) + 2*aa*mm^2*(psq - 2*s - t) + 
