...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mh], 
  ...
  ((EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(s*((-7 + d)*psq + 4*s) + 
      mm^2*(-4*psq + 9*s - 6*d*s))*\[Mu]^(8 - 2*d))/(mh^2*(2*Pi)^(2*d)) - 
   (2^(1 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(2*mm^2 - 2*psq + (4 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(mh^2*Pi^(2*d)) + 
   (2^(1 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*((-5 + 4*d)*mm^2 + 
      (5 - 2*d)*psq - (4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   ...
   (EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(8*mm^2 - 4*psq + (-6 + 7*d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(mh^2*(2*Pi)^(2*d)) + 
   (2^(1 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(2*mm^2 - 2*psq + (2 + d)*s)*
