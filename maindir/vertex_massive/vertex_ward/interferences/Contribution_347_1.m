...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*psq*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(aa*mm^2*(2*psq - s) - 
     2*bb*psq*(mm^2 + 2*psq - s) + aa*psq*(4*psq - s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(2*Pi)^(2*d) - 
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    (aa*(-2*psq^2 + 4*psq*s + (mm^2 - s)*s) + 
     bb*(2*psq^2 - 6*psq*s + s*(mm^2 + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(3*psq - s)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(aa*(mm^2 + 4*psq - s) + 
     bb*(mm^2 - 6*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^4 + 4*mm^2*psq) - bb*psq*s + bb*mm^2*(-5*psq + s))*
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
   ...
   Pi^(2*d) - (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(mm^4 + mm^2*(9*psq - s) + 3*psq*s)) + 
     aa*(mm^4 + psq*s + mm^2*(9*psq + s)))*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(-2*aa*psq^2 + 2*bb*psq^2 + 
     aa*mm^2*s + bb*mm^2*s - 2*bb*psq*s)*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*mm^2 + bb*(mm^2 - 2*psq))*s*
