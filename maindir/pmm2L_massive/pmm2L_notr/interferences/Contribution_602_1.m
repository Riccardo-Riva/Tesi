...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (-((4^(1 - d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
  ...
  (4^(1 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
  (d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(4^d*Pi^(2*d)*s) - 
  (EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
  ...
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
  ...
  (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(-psq + s + t)*
  ...
  (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(psq - t)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
