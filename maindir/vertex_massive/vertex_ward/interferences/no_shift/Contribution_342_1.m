...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(2*aa*mm^2*(5*psq - 2*s) + 
      bb*mm^2*(-10*psq + s) + 2*bb*psq*(-psq + s) + aa*psq*(2*psq + s))*
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*(2*aa*(psq^2 + mm^2*(3*psq - s) + 4*psq*s - s^2) - 
      bb*(2*psq^2 + 3*psq*s - 2*s^2 + 3*mm^2*(2*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*(bb*(-psq^2 - 3*psq*s + 2*s^2 + mm^2*(psq + s)) + 
      aa*(psq^2 + 4*psq*s - 2*s^2 - mm^2*(psq + 2*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^4*(2*mm^2 + 2*psq - s)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*s*(2*aa*(2*mm^2 + s) - bb*(3*mm^2 + psq + 2*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
   (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
     (2*bb*(mm^4 + 2*mm^2*psq + psq*(psq - s)) + 
      aa*(2*mm^4 - psq*(2*psq + s) + mm^2*(-8*psq + 3*s)))*\[Mu]^(8 - 2*d)*
   ...
   (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(bb*(mm^2 + 3*psq - s) + 
    ...
    (2*Pi)^(2*d) - (4^(1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (2*bb*mm^2 - 7*aa*psq + 5*bb*psq + 2*aa*s - 2*bb*s)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*bb*(2*mm^4 + 4*mm^2*s + psq*s) - aa*(4*mm^4 + 9*mm^2*s + psq*s))*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (-2*bb*(psq*(psq - s) + mm^2*(3*psq + 2*s)) + 
      aa*(mm^2*(6*psq - 3*s) + psq*(2*psq + 5*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (-4*bb*mm^2*psq + aa*mm^2*(4*psq - s) + aa*psq*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (-2*bb*(mm^4 + psq*s + mm^2*(psq + 2*s)) + 
      aa*(2*mm^4 + psq*s + mm^2*(2*psq + 5*s)))*\[Mu]^(8 - 2*d)*
