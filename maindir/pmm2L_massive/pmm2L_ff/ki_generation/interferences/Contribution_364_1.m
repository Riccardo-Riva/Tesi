...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
      ...
      \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*
      gHWW*gWlN*gWNl*mm^2*(psq - s - t)*(2*psq^2 + mm^2*(psq - s - t) - 
       3*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*(psq - t)*
      (mm^2 + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     (Pi^(2*d)*s) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
      ...
      SPList[SP[p3, q1]])/Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*
      gHWW*gWlN*gWNl*mm^2*(-(psq*s) + 2*mm^2*(psq - t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*
      mm^2*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*(psq - t)*
      (2*mm^2 - 5*psq + 2*s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
     ...
     Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
      (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
     ...
     Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
      ...
      gHWW*gWlN*gWNl*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
