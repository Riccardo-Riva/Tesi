...
(I*EL^6*gAl*gAu*ggpgpZ^2*(gZlL + gZlR)*(gZuL + gZuR)*(-2*mmv^2 + s)*
  ...
  ((2*Pi)^d*(mz^2 - s)^2*s) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*ggpgpZ^2*
   (gZlL*gZuL*(2^(1 + d)*mmv^2*Pi^d - 3*d*(2*Pi)^d*s + 
    ...
    {mw*Sqrt[GaugeXi[Q]]}, -1, 0, 1, 0])/(Pi^(2*d)*(mz^2 - s)^2*s) + 
 (I*2^(-1 - 2*d)*EL^6*gAl*gAu*ggpgpZ^2*
  ...
  (Pi^(2*d)*(mz^2 - s)^2*s) + 
 (I*EL^6*gAl*gAu*ggpgpZ^2*(gZlL*gZuL*(2*mmv^2 + (-4 + d)*s - 2*t) + 
 ...
 (I*2^(-1 - 2*d)*EL^6*gAl*gAu*ggpgpZ^2*
  ...
  (Pi^(2*d)*(mz^2 - s)^2*s) + 
 (I*EL^6*gAl*gAu*ggpgpZ^2*(gZlL*gZuL*(-((-2 + d)*mmv^2) + (-2 + d)*s + 
      (-4 + d)*t) + gZlR*gZuR*(-((-2 + d)*mmv^2) + (-2 + d)*s + (-4 + d)*t) + 
  ...
  ((2*Pi)^d*(mz^2 - s)^2*s) + (I*2^(-1 - d)*EL^6*gAl*gAu*ggpgpZ^2*
   (gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
    ...
    {mw*Sqrt[GaugeXi[Q]]}, 0, 0, 1, -1])/(Pi^d*(mz^2 - s)^2*s) - 
 ...
 (I*2^(-1 - d)*EL^6*gAl*gAu*ggpgpZ^2*((-2 + d)*gZlL*gZuL - 
  ...
  (Pi^d*(mz^2 - s)^2*s) + (I*2^(-1 - d)*EL^6*gAl*gAu*ggpgpZ^2*
   (gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
    ...
    gZlL*gZuL*(-2*mmv^2 - (-2 + d)*s + 2*t) + 
    gZlR*gZuR*(-2*mmv^2 - (-2 + d)*s + 2*t))*userIntegral[A4, 
    {mw*Sqrt[GaugeXi[Q]]}, 0, 1, 0, -1])/(Pi^d*(mz^2 - s)^2*s) + 
 (I*EL^6*gAl*gAu*ggpgpZ^2*
