...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*t*(s + t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*t^2*
     (-mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^4*t*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^4*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*t^2*
