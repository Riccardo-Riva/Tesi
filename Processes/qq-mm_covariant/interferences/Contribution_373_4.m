...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[W]]], 
 ...
 (((I/9)*2^(-5 - d)*EL^6*s*(cw^2 - sw^2)^2*
    ...
    SPList[SP[p1, q1]])/(cw^4*cwC^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*sw^4*
    swC^2) - ((I/9)*2^(-6 - d)*EL^6*s*(cw^2 - sw^2)^2*
    (s*(3*d*(3 + 8*sw^4 - 10*swC^2 + 8*swC^4 + 2*sw^2*(-5 + 8*swC^2)) + 
       2*(-9 + 30*swC^2 - 24*swC^4 + sw^2*(30 + 4*swC^2 - 80*swC^4) + 
         8*sw^4*(-3 - 10*swC^2 + 16*swC^4))) + 
     6*(-3 + d)*(3 + 8*sw^4 - 10*swC^2 + 8*swC^4 + 2*sw^2*(-5 + 8*swC^2))*t)*
    SPList[SP[q1, q1]])/(cw^4*cwC^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*sw^4*
    swC^2) + ((I/9)*2^(-5 - d)*EL^6*(cw^2 - sw^2)^2*
  ...
  ((I/9)*2^(-5 - d)*EL^6*(cw^2 - sw^2)^2*
    ...
    (-mzC^2 + s)*sw^4*swC^2) - ((I/9)*2^(-4 - d)*EL^6*(cw^2 - sw^2)^2*
    (3*d*(3 + 8*sw^4 - 10*swC^2 + 8*swC^4 + 2*sw^2*(-5 + 8*swC^2)) + 
     2*(-9 + 30*swC^2 - 24*swC^4 + sw^2*(30 + 4*swC^2 - 80*swC^4) + 
  ...
  ((I/9)*2^(-5 - d)*EL^6*(cw^2 - sw^2)^2*
   ...
   (cw^4*cwC^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*sw^4*swC^2) + 
  ((I/9)*2^(-3 - d)*EL^6*s*(cw^2 - sw^2)^2*(9 - 30*swC^2 + 24*swC^4 + 
     8*sw^4*(3 - 20*swC^2 + 32*swC^4) - 2*sw^2*(15 - 76*swC^2 + 80*swC^4))*
