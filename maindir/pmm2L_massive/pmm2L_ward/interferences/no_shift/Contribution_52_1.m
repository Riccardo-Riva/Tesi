...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*(psq - s - t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 + gZlR*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*aa*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*bb*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
     ...
     gZlR*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
