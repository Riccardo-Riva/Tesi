   ...
   ((2^(1 - 2*d)*d*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
      ...
      ((-2 + d)*d*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t)*(5*psq^2 + 4*t*(s + t) + 
        ...
        (2*psq - s - 2*t)*(5*psq^2 + 4*t*(s + t) + mm^2*(-psq + s + t) - 
         ...
         4*(-2 + d)*s*t*(s^2 + 3*s*t + 2*t^2) - (-2 + d)*psq^2*
          ((-6 + d)*s^2 - 36*s*t - (10 + d)*t^2) - 2*(-2 + d)*mm^2*
          (2*(-1 + d)*psq - (-2 + d)*s - 2*(-1 + d)*t)*(psq^2 - 2*psq*t + 
           t*(s + t))) + 2*(-2 + d)*gZlL^2*gZlR^2*mm^2*(-8*(-2 + d)*psq^3 + 
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*((-2 + d)*d*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t)*
       ...
       (-2 + d)*d*gZlL*gZlR^3*mm^2*(2*psq - s - 2*t)*
        (3*psq^2 + mm^2*(psq - t) - 7*psq*t + 4*t*(s + t)) - 
       2*(-2 + d)*gZlL^2*gZlR^2*mm^2*(4*(-2 + d)*psq^3 + 
       ...
       gZlL^4*((-4 + d^2)*psq^4 - (-2 + d)^2*mm^4*(psq - t)*(psq - s - t) - 
         ...
         2*(-2 + d)*mm^2*(psq^2 - 2*psq*t + t*(s + t))*(2*(-1 + d)*psq + 
           2*t - d*(s + 2*t))) + gZlR^4*((-4 + d^2)*psq^4 - 
         (-2 + d)^2*mm^4*(psq - t)*(psq - s - t) - (-2 + d)*psq^3*
          ((6 + d)*s + 2*(4 + d)*t) - 4*(-2 + d)*psq*t*(4*s^2 + 7*s*t + 
           t^2) + 4*(-2 + d)*s*t*(s^2 + 3*s*t + 2*t^2) + 
         (-2 + d)*psq^2*(4*s^2 + (26 + d)*s*t + (10 + d)*t^2) - 
         2*(-2 + d)*mm^2*(psq^2 - 2*psq*t + t*(s + t))*(2*(-1 + d)*psq + 
           2*t - d*(s + 2*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*(-2*(-2 + d)*gZlL^2*gZlR^2*mm^2*
       ...
       d*gZlL*gZlR^3*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
         ...
         3*psq^2*((-2 + d)*s + 2*(-4 + d)*t) + psq*(-((-2 + d)*s^2) + 
           (10 - 3*d)*s*t - 2*(-8 + d)*t^2) + (-2 + d)*mm^2*
          (5*psq^2 + s^2 + 4*s*t + 3*t^2 - 4*psq*(s + 2*t))) + 
       gZlR^4*(-4*(-3 + d)*psq^3 - 4*t^2*(s + t) + 
         3*psq^2*((-2 + d)*s + 2*(-4 + d)*t) + psq*(-((-2 + d)*s^2) + 
           (10 - 3*d)*s*t - 2*(-8 + d)*t^2) + (-2 + d)*mm^2*
          (5*psq^2 + s^2 + 4*s*t + 3*t^2 - 4*psq*(s + 2*t))))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*(-2*(-2 + d)^2*gZlL^2*gZlR^2*mm^2*(psq - t)*
       ...
       (-2 + d)*d*gZlL*gZlR^3*mm^2*(6*psq^2 - 5*psq*s + s^2 - 12*psq*t + 
         ...
         (-2 + d)*mm^2*((-2 + 3*d)*psq^2 + psq*(-((-2 + d)*s) + 4*t - 
             6*d*t) + t*(2*d*s - 2*t + 3*d*t))) + 
       gZlR^4*((20 - 12*d + d^2)*psq^3 + (-2 + d)^2*mm^4*(psq - t) - 
         (-2 + d)*psq^2*((-14 + 3*d)*s + (-26 + 3*d)*t) + 
         4*(-2 + d)*t*(2*s^2 + 3*s*t + t^2) + (-2 + d)*psq*
          ((-2 + d)*s^2 + 2*(-14 + d)*s*t + 2*(-10 + d)*t^2) + 
         (-2 + d)*mm^2*((-2 + 3*d)*psq^2 + psq*(-((-2 + d)*s) + 4*t - 
             6*d*t) + t*(2*d*s - 2*t + 3*d*t))))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 4*d)*d*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
      (2^(1 + 2*d)*(-2 + d)*gZlL^2*Pi^(2*d)*(psq - t)^2 + 
       ...
       d*gZlL*gZlR*(2*Pi)^(2*d)*(2*psq^2 - s^2 + psq*(s - 4*t) - s*t + 
         2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
     (Pi^(4*d)*s) + (4^(1 - 2*d)*EL^6*gAl*gAu*
      (-(2^(1 + 2*d)*(-2 + d)^2*gZlL^2*gZlR^2*mm^2*Pi^(2*d)*(2*psq - s - 2*t)*
         (psq - t)) + (-2 + d)*d*gZlL^3*gZlR*mm^2*(2*Pi)^(2*d)*
        (-2*psq + s + 2*t)^2 + (-2 + d)*d*gZlL*gZlR^3*mm^2*(2*Pi)^(2*d)*
        (-2*psq + s + 2*t)^2 + gZlL^4*(-((-2 + d)^2*mm^2*(2*Pi)^(2*d)*
           (psq - t)*(psq - s - t)) - d^2*(2*Pi)^(2*d)*psq*
          (psq^2 + s^2 + t^2) + 2^(1 + 2*d)*Pi^(2*d)*(2*(-1 + d)*psq^3 - 
           2*(-2 + d)*s*t*(s + t) + (-2 + d)*psq^2*((-4 + d)*s + 
             (-2 + d)*t) + psq*(2*(-1 + d)*s^2 - (12 - 8*d + d^2)*s*t + 
             2*(-1 + d)*t^2))) + gZlR^4*
        (-((-2 + d)^2*mm^2*(2*Pi)^(2*d)*(psq - t)*(psq - s - t)) - 
    ...
    (4^(1 - d)*d^2*EL^6*gAl*gAu*gZlL^2*gZlR^2*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) - (4^(1 - 2*d)*EL^6*gAl*gAu*
      (-(2^(1 + 2*d)*(-2 + d)*d*gZlL^3*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)*
        ...
        (2*psq - s - 2*t)*(psq - t) + gZlL^4*((-2 + d)^2*mm^2*(2*Pi)^(2*d)*
          (2*psq - s - 2*t)*(psq - t) - d^2*(2*Pi)^(2*d)*s*t*
          (-5*psq + s + 3*t) + 2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)^2*psq^3 - 
           (-2 + d)*psq^2*((-4 + d)*s + 5*(-2 + d)*t) + 
