...
PropList[KiraPropagator[p3 + q1, ml], KiraPropagator[-p1 - p2 + p3 + q1, ml]]*
 (((I/16)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)*(8*(gZlL + gZlR)*mm^4*(2*mu^2 + s) - 
     (gZlL + gZlR)*mm^2*(4*mm^4 + 2*(-4 + d)*mu^2*s - 4*s^2 + d*s^2 + 
       8*mm^2*(mu^2 - t) + 4*s*t + 4*t^2) + (gZlL + gZlR)*ml^2*
   ...
   (Pi^4*s^2*(-mz^2 + s)) + ((I/16)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)^2*
    (12*mm^4 + 2*(-2 + d)*mu^2*s - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
     4*mm^2*(2*mu^2 + 3*s + 4*t))*SPList[SP[p1, q1]])/
   (Pi^4*s^2*(-mz^2 + s)) + ((I/16)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)^2*
    (-4*mm^4 + 2*(-2 + d)*mu^2*s - 2*s^2 + d*s^2 - 4*mm^2*(2*mu^2 + s) + 
     4*s*t + 4*t^2)*SPList[SP[p2, p3]])/(Pi^4*s^2*(-mz^2 + s)) + 
  ((I/16)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)^2*(-4*mm^4 + 2*(-2 + d)*mu^2*s - 
     2*s^2 + d*s^2 - 4*mm^2*(2*mu^2 + s) + 4*s*t + 4*t^2)*SPList[SP[p2, q1]])/
   (Pi^4*s^2*(-mz^2 + s)) - ((I/8)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)^2*
