...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(2*aa*psq^2 - 2*bb*psq^2 - 
     3*aa*psq*s + 7*bb*psq*s + 2*aa*s*(-mm^2 + s) - 2*bb*s*(mm^2 + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2*Pi)^(2*d) - 
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    (aa*(5*mm^2*psq + psq^2 - 6*psq*s + 2*s^2) - 
     bb*(psq^2 + mm^2*(5*psq - s) - 5*psq*s + 2*s^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(psq - 2*s)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(aa*(2*mm^2 - 3*psq + 2*s) - 
     bb*(mm^2 - 2*psq + 2*s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
   ...
   Pi^(2*d) + (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^4 + mm^2*(7*psq - 9*s) - psq*s) + 
     bb*(-3*mm^4 + 2*psq*s + mm^2*(-7*psq + 8*s)))*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*mm^2*(6*psq - 3*s) - 
  ...
  (4^(1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(bb*mm^2 - aa*psq)*
  ...
  ((aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*psq*(5*mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*mm^2 - aa*psq)*s*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(3*aa*mm^2 - bb*(2*mm^2 + psq))*
