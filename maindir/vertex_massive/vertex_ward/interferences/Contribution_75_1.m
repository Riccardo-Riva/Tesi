...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)*
      ...
      (aa*(2*Pi)^(2*d)*(mm^2 - psq)*(2*(-2 + d)*psq^2 + 
       ...
       bb*(2^(1 + 2*d)*(-2 + d)*mm^4*Pi^(2*d)*(psq - s - t) + 
         mm^2*(2*Pi)^(2*d)*s*(psq + d*psq - s - t) - (2*Pi)^(2*d)*psq*
          (2*(-2 + d)*psq^2 - (-5 + d)*psq*s - 2*(-2 + d)*psq*t - 
           s*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(4*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)*
      (bb*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - 2*s - t) + s*t + 
         psq*(s + 2*t - d*t)) - aa*((-2 + d)*psq^2 + (-2 + d)*mm^2*
          (psq - t) + s*t + psq*(5*s - 2*d*s + 2*t - d*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (mm^2 - psq)*(bb*(-2*(-2 + d)*psq^2 - (-2 + d)*mm^2*(2*psq - s - 2*t) + 
         s*t + psq*(s + 2*(-2 + d)*t)) + aa*(2*(-2 + d)*psq^2 + 
         2*(-2 + d)*mm^2*(psq - t) - s*t + psq*(s - d*s + 4*t - 2*d*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)*s*
      ...
      SPList[SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa + bb)*(-2 + d)*EL^5*
      gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*
      gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWlN*
      gWNl*gWWA*(mm^2 - psq)*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)*
      (bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (aa*(4*(-2 + d)*mm^4 - mm^2*((-18 + 11*d)*psq + (-8 + d)*s + 
           (-6 + d)*t) + psq*(11*(-2 + d)*psq + (4 - 3*d)*s - 
           3*(-2 + d)*t)) + bb*(-2*(-2 + d)*mm^4 + 
         mm^2*((-2 + 3*d)*psq + (-8 + d)*s + (-6 + d)*t) + 
         psq*(-5*(-2 + d)*psq + (-4 + 3*d)*s + 3*(-2 + d)*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
     Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (-(bb*(2*(-2 + d)*psq^2 + s*(-mm^2 + s + t) - 
          2*psq*(s + (-2 + d)*t))) + aa*(2*(-2 + d)*psq^2 + 
         s*((-5 + 2*d)*mm^2 + s + t) - 2*psq*((-1 + d)*s + (-2 + d)*t)))*
    ...
    (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(bb*((-1 + d)*mm^2 + (-2 + d)*psq)*
    ...
    (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (aa*(-2 + d)*psq*(4*psq - s - 2*t) + bb*(-2 + d)*psq*(s + 2*t) + 
       aa*mm^2*(2*psq - (-1 + d)*(s + 2*t)) + 
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (6*psq^2 + d*mm^2*(psq - t) + s*(-mm^2 + s + t) + 
       d*psq*(-3*psq + 2*s + 3*t) - psq*(7*s + 6*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(aa*mm^2*(2*psq + s - d*s - 2*t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(aa*((-1 + d)*mm^2 + (-2 + d)*psq)*
        (psq - t) + bb*((-2 + d)*psq*(psq + t) + 
         mm^2*((5 - 3*d)*psq + (-1 + d)*t)))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (6*psq^2 + d*mm^2*(psq - s - t) + s*(mm^2 + t) + 
       d*psq*(-3*psq + s + 3*t) - psq*(s + 6*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*s*
    ...
    (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)*
      s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa + bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(mm^2 - psq)*s*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(psq - s - t)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*
    ...
    (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(bb*(-6 + d)*(psq - s - t) + 
       aa*(-2*(-2 + d)*mm^2 + (2 + d)*psq + (-6 + d)*(s + t)))*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^2*
      gWlN*gWNl*gWWA*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*
      gWlN*gWNl*gWWA*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*
      gWWA*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(psq - t)*
    ...
    (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(aa*(-6 + d)*(psq - t) + 
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^2*
      gWlN*gWNl*gWWA*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*
      gWlN*gWNl*gWWA*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
