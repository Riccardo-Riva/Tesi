...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((EL^5*gAl^3*gHll^2*mm^4*s*(aa*d*(mm^2 - psq)*(mm^2 - s) + 
     ...
     2*bb*(2*psq^2 - 3*psq*s + s^2))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
   ...
   (2*Pi)^(2*d) + (EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*s*
    (bb*d*(mm^2 - 2*psq) - 8*aa*psq + 8*bb*psq + aa*d*(mm^2 + 2*psq - s) + 
     4*aa*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2*Pi)^(2*d) + 
  (d*EL^5*gAl^3*gHll^2*mm^4*s*(bb*(mm^2 + 3*psq - s) + aa*(mm^2 - 5*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*bb*mm^4 + bb*(-4 + d)*psq^2 + 
     aa*mm^2*((-8 + d)*psq + 2*s) + bb*mm^2*(-((-6 + d)*psq) + 2*s) - 
     aa*psq*((-4 + d)*psq + 4*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*bb*(-2 + d)*mm^4 - 
     bb*(4 + 3*d)*mm^2*psq + aa*d*psq*s + aa*mm^2*((8 + d)*psq - d*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*(mm^4 + 3*mm^2*psq + 3*psq*s) - 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(2*bb*(-4 + d)*psq^2 + 
     aa*(-4 + d)*mm^2*(2*psq - s) + 2*bb*mm^2*(-((-4 + d)*psq) + 2*s) + 
     aa*psq*(-2*(-4 + d)*psq + (-8 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^2*(-4*bb*mm^2*psq + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(-(aa*psq*((-4 + d)*psq + 4*s)) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(bb*d*(mm^2 - psq) - 2*aa*psq + 
     2*bb*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
  (2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(-2 + d)*mm^2 - 
     2*bb*(-1 + d)*mm^2 + 2*aa*psq + bb*(-2 + d)*psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(2*mm^2 + psq) - aa*(mm^2 + 2*psq))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (4^(1 - d)*d*EL^5*gAl^3*gHll^2*mm^2*(-2*bb*mm^2 + aa*(mm^2 + psq))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (4^(2 - d)*EL^5*gAl^3*gHll^2*mm^2*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*d*EL^5*gAl^3*gHll^2*mm^2*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*bb*(2*mm^2 + d*psq) - 
     aa*(4*psq + d*(mm^2 + psq)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(bb*mm^2 - aa*psq)*
