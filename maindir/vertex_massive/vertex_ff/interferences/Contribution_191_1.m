  ...
  (-((4^(1 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^4*
   ...
   (4^(1 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
     ((-2 + d)*psq^2*(psq - t)^2 + mm^2*((-2 + d)*psq^3 + 2*s*t*(s + t) + 
        psq^2*(-((-4 + d)*s) - 2*(-2 + d)*t) + 
        psq*t*((-6 + d)*s + (-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
   ...
   (4^(1 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*(-psq + s + t)*
     (2*mm^2*((-2 + d)*psq + s) + psq*(-3*(-2 + d)*psq - 2*t + d*(s + t)))*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*psq*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (2*mm^2*((-2 + d)*psq^2 + (-1 + d)*s^2 + 2*(-2 + d)*s*t + (-2 + d)*t^2 - 
        2*(-2 + d)*psq*(s + t)) + psq*(4*(-2 + d)*psq^2 - 2*t*(5*s + 4*t) - 
        (-2 + d)*psq*(5*s + 8*t) + d*(s^2 + 5*s*t + 4*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (psq^2*s + mm^2*(psq^2 + (s + t)^2 - psq*(3*s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
     ((-2 + d)*psq^3 - 2*s*t*(s + t) + (-2 + d)*mm^2*(-psq + s + t)^2 + 
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^4*(psq - t)^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 + psq)*
     ...
     gWWA*mm^2*(psq*(4*psq - s - 4*t) + 2*mm^2*(psq - s - t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*(2*psq^2 + psq*(s - 4*t) + 
     ...
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p3, q2]])/Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*
     gWWA*mm^2*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (-3*(-2 + d)*psq^2 - 4*s^2 + 2*(-2 + d)*mm^2*(psq - t) - d*s*t + 2*t^2 - 
      d*t^2 + psq*(d*s - 8*t + 4*d*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*
     mm^2*(2*(-2 + d)*psq^2 - 2*t*(3*s + 2*t) - (-2 + d)*psq*(3*s + 4*t) + 
      d*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*
