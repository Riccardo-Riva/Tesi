  ...
  ((I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
     ...
     gHWW*gWlN*gWNl*mm^2*(aa*psq*(3*psq - 2*s - 3*t) + aa*mm^2*(psq - t) + 
      bb*mm^2*(-psq + s + t) + bb*psq*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*aa*(-2 + d)*EL^5*gAl*gHll*
     gHWW*gWlN*gWNl*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*aa*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*bb*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*(mm^2 - psq)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    ...
    Pi^(2*d) + (I*4^(1 - d)*bb*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
