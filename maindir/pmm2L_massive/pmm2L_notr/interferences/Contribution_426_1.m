...
PropList[KiraPropagator[-p3 + q1, mz], KiraPropagator[q2, mz], 
 ...
 ((2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
  ...
  (EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*(4*psq^2 + 2*(-4 + d)*mm^2*s - 
     5*s^2 + 2*d*s^2 + 4*s*t + 4*t^2 - 2*psq*((-6 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*(6*psq^2 + 2*s^2 - d*s^2 + 3*s*t + 
     2*t^2 + mm^2*(-4*psq + (2 + d)*s + 4*t) - psq*((9 + d)*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/((2*Pi)^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*(-6*psq^2 + s^2 + 
     mm^2*(4*psq + 2*s - d*s - 4*t) - 3*s*t - 2*t^2 + psq*(s + d*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*(-2*psq^2 - (3 + d)*psq*s + s^2 - 
     d*s^2 + mm^2*(4*psq + (-2 + d)*s - 4*t) + s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*(-2*psq^2 - (-5 + d)*psq*s - 
  ...
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
   ...
   (Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
  ...
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
    (-4*mm^2 + 2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*
    mh^2*mm^2*(4*mm^2 - 6*psq - 3*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*
    mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (3*2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*(-psq + 2*s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*(-4*psq + 5*s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
    (-4*mm^2 + 4*psq + 7*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
   ...
   (Pi^(2*d)*s^2) + (3*2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
