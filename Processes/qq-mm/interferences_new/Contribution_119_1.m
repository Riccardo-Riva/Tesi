 ...
 (((3*I)*EL^6*gAl*gAu*gZdL*gZdR*ms^2*
  ...
  ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*
    (gZdL^2*(gZlL*gZuL*(-4*mmv^4 + 2*(8 - 6*d + d^2)*mm^2*s + 8*s^2 - 
         ...
         2*(8 - 6*d + d^2)*mm^2*s + 8*s^2 - 6*d*s^2 + d^2*s^2 + 8*s*t - 
         10*d*s*t + 2*d^2*s*t - 4*t^2 + mmv^2*((-40 + 26*d - 4*d^2)*s + 
           8*t))))*SPList[SP[p1, p2]])/(Pi^d*(mz^2 - s)^2*s) + 
  ((3*I)*(-3 + d)*EL^6*gAl*gAu*(gZdL^2 - gZdR^2)*
   ...
   ((2*Pi)^d*(mz^2 - s)^2) + (((3*I)/2)*EL^6*gAl*gAu*
    ((2^(1 - d)*(gZdL^2 + gZdR^2)*(gZlR*gZuL*(4*mmv^4 + 2*(-4 + d)*mm^2*s - 
      ...
      Pi^d - (gZdL^2*(gZlR*gZuL*(4*mmv^4 + 2*(-2 + d)^2*mm^2*s + 16*s^2 - 
           8*d*s^2 + d^2*s^2 + mmv^2*((-20 + 6*d)*s - 8*t) + 4*s*t + 
           6*d*s*t - 2*d^2*s*t + 4*t^2) + gZlL*gZuR*(4*mmv^4 - 
           2*(8 - 6*d + d^2)*mm^2*s - 32*s^2 + 20*d*s^2 - 3*d^2*s^2 + 
           mmv^2*((52 - 30*d + 4*d^2)*s - 8*t) - 20*s*t + 14*d*s*t - 
           2*d^2*s*t + 4*t^2) + gZlR*gZuR*(4*mmv^4 - 2*(8 - 6*d + d^2)*mm^2*
            s + 4*s^2 - 4*d*s^2 + d^2*s^2 + 16*s*t - 10*d*s*t + 2*d^2*s*t + 
           4*t^2 - 2*mmv^2*((-8 + 3*d)*s + 4*t)) + 
         gZlL*gZuL*(4*mmv^4 + 2*(-2 + d)^2*mm^2*s + 4*s^2 - 4*d*s^2 + 
       ...
       gZdR^2*(gZlL*gZuR*(4*mmv^4 + 2*(-2 + d)^2*mm^2*s + 16*s^2 - 8*d*s^2 + 
           ...
           mmv^2*((52 - 30*d + 4*d^2)*s - 8*t) - 20*s*t + 14*d*s*t - 
           2*d^2*s*t + 4*t^2) + gZlL*gZuL*(4*mmv^4 - 2*(8 - 6*d + d^2)*mm^2*
            s + 4*s^2 - 4*d*s^2 + d^2*s^2 + 16*s*t - 10*d*s*t + 2*d^2*s*t + 
           4*t^2 - 2*mmv^2*((-8 + 3*d)*s + 4*t)) + 
         gZlR*gZuR*(4*mmv^4 + 2*(-2 + d)^2*mm^2*s + 4*s^2 - 4*d*s^2 + 
           d^2*s^2 + 16*s*t - 10*d*s*t + 2*d^2*s*t + 4*t^2 - 
  ...
  ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*
    (gZdL^2*(gZlL*gZuL*(-4*mmv^4 + 2*(8 - 6*d + d^2)*mm^2*s + 8*s^2 - 
         ...
         2*(8 - 6*d + d^2)*mm^2*s + 8*s^2 - 6*d*s^2 + d^2*s^2 + 8*s*t - 
         10*d*s*t + 2*d^2*s*t - 4*t^2 + mmv^2*((-40 + 26*d - 4*d^2)*s + 
           8*t))))*SPList[SP[p2, q1]])/(Pi^d*(mz^2 - s)^2*s) - 
  ((3*I)*(-3 + d)*EL^6*gAl*gAu*(gZdL^2 - gZdR^2)*
    (gZlL*(gZuR*(2*mmv^2 + (-4 + d)*s - 2*t) + 
       gZuL*(-2*mmv^2 + (-2 + d)*s + 2*t)) - 
     gZlR*(gZuL*(2*mmv^2 + (-4 + d)*s - 2*t) + 
       gZuR*(-2*mmv^2 + (-2 + d)*s + 2*t)))*SPList[SP[p3, q1]])/
   ((2*Pi)^d*(mz^2 - s)^2) - ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
  ...
  ((3*I)*2^(2 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
    ((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - (-4 + d)*gZlL*gZuR + 
     (-2 + d)*gZlR*gZuR)*(mmv^2 - t)*SPList[SP[p1, p2], SP[p2, q1]])/
   (Pi^d*(mz^2 - s)^2*s) + ((3*I)*2^(1 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
    (gZlR*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
     gZlL*gZuR*(2*mmv^2 - (-4 + d)*s - 2*t) + 
     gZlL*gZuL*(2*mmv^2 + (-2 + d)*s - 2*t) + 
   ...
   (Pi^d*(mz^2 - s)^2*s) + ((3*I)*2^(2 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
    (gZlL + gZlR)*(gZuL + gZuR)*SPList[SP[p1, p3], SP[p1, p3]])/
   (Pi^d*(mz^2 - s)^2) - ((3*I)*2^(1 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
  ...
  ((3*I)*2^(1 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
   ...
   (Pi^d*(mz^2 - s)^2*s) - ((3*I)*2^(3 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
    (gZlL + gZlR)*(gZuL + gZuR)*SPList[SP[p1, p3], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)^2) - ((3*I)*2^(1 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
