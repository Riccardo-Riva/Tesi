...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mz], 
 ...
 ((I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    (bb*s*(psq - 3*t) + aa*(2*mm^2 - 3*s)*(psq - t) + 
     2*bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    (bb*(2*mm^2 - 3*s)*(-psq + s + t) + aa*(-5*psq*s + 2*mm^2*(psq - t) + 
       3*s*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    (bb*(2*mm^2 - 3*s)*(-psq + s + t) + aa*(-5*psq*s + 2*mm^2*(psq - t) + 
       3*s*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  ...
  (I*(aa - bb)*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
   ...
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*
    mm^2*(aa*(psq - t) + bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*
