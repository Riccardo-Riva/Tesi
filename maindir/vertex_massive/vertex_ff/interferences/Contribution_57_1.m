...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (-((4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*(2*mm^2 - s)*
   ...
   (4^(2 - d)*d*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*(-7*psq^3 + 3*psq^2*(s + 6*t) - 
     ...
     (gZlL^2*(-(d^2*(2*Pi)^(2*d)*psq*s*(psq - t)) - (-4 + d^2)*mm^2*
      ...
      4*gZlL*gZlR*(-(mm^2*(2*Pi)^(2*d)*(psq - t)*((-2 + d)^2*psq - 
        ...
        2^(1 + 2*d)*Pi^(2*d)*((-2 + 4*d)*psq^3 + 
          psq^2*(-2*s + (4 - 10*d + d^2)*t) + t*(2*s^2 - 3*d*s*t - 2*d*t^2) + 
          2*psq*(s^2 + s*t + (-1 + 4*d)*t^2))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(4*d)*s) + 
   (4^(2 - d)*d*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*(-4*psq^3 + 3*psq^2*(s + 4*t) + 
      t*(mm^2*s + 2*s^2 + 6*s*t + 4*t^2) - psq*(mm^2*s + 3*t*(3*s + 4*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*(d^2*(2*Pi)^(2*d)*(mm^2 - psq)*s*
       (gZlL^2*(2*psq - s - 2*t) + gZlR^2*(2*psq - s - 2*t) + 
        4*gZlL*gZlR*(-psq + t)) - 4*s*(gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq)*
         (2*psq - s - 2*t) + gZlR^2*(2*Pi)^(2*d)*(mm^2 + psq)*
         (2*psq - s - 2*t) + 4^(1 + d)*gZlL*gZlR*Pi^(2*d)*
         (-psq^2 + mm^2*(psq + s - t) + psq*(-3*s + t) + s*(s + 2*t))) + 
      4^(1 + d)*d*Pi^(2*d)*(gZlL^2*psq*s*(2*psq - s - 2*t) + 
        gZlR^2*psq*s*(2*psq - s - 2*t) + gZlL*gZlR*(-4*psq^3 + s^3 - 
          2*psq^2*(s - 6*t) + mm^2*s*(s - 4*t) + 4*s^2*t + 6*s*t^2 + 4*t^3 + 
          psq*(4*mm^2*s - 3*s^2 - 4*s*t - 12*t^2))))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
     ...
     (-(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(mm^2 - psq)*
        (psq^2 + mm^2*s - 2*psq*t + t*(s + t))) - 4^(1 + d)*(gZlL^2 + gZlR^2)*
       Pi^(2*d)*(2*psq^3 + 2*mm^4*s - mm^2*s*(s - 2*t) - 
        2*psq^2*(2*s + 3*t) - t*(s^2 + 3*s*t + 2*t^2) + 
      ...
      2*d*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*psq^2 + 2*mm^2*s - 
         ...
         (psq^3 + 3*mm^4*s - 4*psq^2*(s + t) - t*(s^2 + 3*s*t + 2*t^2) + 
          ...
          psq*(s^2 + 4*s*t + 5*t^2) + mm^2*(psq^2 - s^2 + s*t + t^2 - 
            psq*(s + 2*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*(psq - t)*
     ((-2 + d)*gZlL^2*(mm^2 - psq)*(psq - s - t) + 
      (-2 + d)*gZlR^2*(mm^2 - psq)*(psq - s - t) + 2*d*gZlL*gZlR*mm^2*
         ...
         ((16 - 10*d + d^2)*psq^2 + 4*s^2 - 2*(16 - 10*d + d^2)*psq*t + 
          ...
          psq^2*(2*(-4 + d)*s + (-2 + d)^2*t) + (-2 + d)*t*
           (s^2 + 3*s*t + 2*t^2) - psq*((-4 + d)*s^2 + (-14 + 5*d)*s*t + 
            (-4 + d)*t^2))) + gZlR^2*(-(d^2*(2*Pi)^(2*d)*psq*(psq^2 + t^2)) + 
        mm^2*(2*Pi)^(2*d)*((16 - 10*d + d^2)*psq^2 + 4*s^2 - 
          2*(16 - 10*d + d^2)*psq*t + (16 - 10*d + d^2)*t^2) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*(psq - t)*((-2 + d)^2*gZlL^2*(psq - t) + 
    ...
    (Pi^(2*d)*s) + (4^(1 - 2*d)*EL^6*gAl^3*gAu*
     (4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(4*psq - 3*s - 4*t)*(psq - t) + 
      gZlL^2*(d^2*(2*Pi)^(2*d)*psq*(psq^2 + t^2) - (-4 + d)*mm^2*(2*Pi)^(2*d)*
         ((-2 + d)*psq^2 - 2*s^2 - 2*(-2 + d)*psq*t + (-2 + d)*t^2) + 
        2^(1 + 2*d)*Pi^(2*d)*((8 - 5*d)*psq^3 + 
          psq^2*(4*s - (20 - 12*d + d^2)*t) + (-2 + d)*t*(s^2 + 3*s*t + 
            2*t^2) + psq*(-2*s^2 + (2 - 3*d)*s*t + (16 - 9*d)*t^2))) + 
      gZlR^2*(d^2*(2*Pi)^(2*d)*psq*(psq^2 + t^2) - (-4 + d)*mm^2*(2*Pi)^(2*d)*
         ((-2 + d)*psq^2 - 2*s^2 - 2*(-2 + d)*psq*t + (-2 + d)*t^2) + 
        2^(1 + 2*d)*Pi^(2*d)*((8 - 5*d)*psq^3 + 
          psq^2*(4*s - (20 - 12*d + d^2)*t) + (-2 + d)*t*(s^2 + 3*s*t + 
            2*t^2) + psq*(-2*s^2 + (2 - 3*d)*s*t + (16 - 9*d)*t^2))))*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*(-4*d*gZlL*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
    ...
    Pi^(2*d) + (2^(1 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
     (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
      t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl^3*gAu*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*(psq - t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*(psq - t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
     ((16 - 10*d + d^2)*psq + 4*s - (16 - 10*d + d^2)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
     (gZlL^2 + gZlR^2)*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*(-psq + s + t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
     ((-4 + d)*psq^2 + (-8 + d)*mm^2*s + psq*(-3*(-6 + d)*s - 2*(-4 + d)*t) + 
