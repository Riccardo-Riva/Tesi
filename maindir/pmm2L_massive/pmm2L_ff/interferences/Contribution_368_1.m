   ...
   (-((2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
    ...
    (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
     ...
     Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
      (psq^3 - psq^2*(s + 4*t) + psq*t*(3*s + 5*t) - 
       t*(s^2 + 3*s*t + 2*t^2) + mm^2*(psq^2 + s^2 + 3*s*t + t^2 - 
         2*psq*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
    (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(mm^2 - psq)*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
     Pi^(2*d) + (3*4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
      (5*psq^3 - psq^2*(s + 12*t) - 2*t*(3*s^2 + 4*s*t + t^2) + 
       psq*(-2*s^2 + 13*s*t + 9*t^2) + mm^2*(3*psq^2 + 2*s^2 + 2*s*t + 
         3*t^2 - 6*psq*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) + (3*4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
      gWWA*mm^4*(2*psq^2 + s^2 + 4*s*t + 2*t^2 - 4*psq*(s + t))*
    ...
    (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
      ...
      gWWA*mm^2*(mm^2*(psq - t) + psq*(psq - s - t))*(psq - t)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
      (psq*(s - 2*t) + 2*t^2 + mm^2*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(mm^2 - psq)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
    (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
      (-(psq*s) + mm^2*(psq - t) + 2*psq*t - 2*t^2)*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[q1, q1]])/Pi^(2*d) - (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*
