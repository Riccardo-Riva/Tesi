...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((4^(2 - d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*(mm^2 + psq)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*(mm^2 - psq + s)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*(4*mm^2 - 4*psq + s)*
