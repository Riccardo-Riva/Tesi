...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(mm^2*(4*psq - s) + 
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (3*mm^2 + (5 - 2*d)*psq + (2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     ((-3 + 2*d)*mm^2 + (7 - 2*d)*psq - 4*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*(6*mm^2 + 2*psq + (10 - 3*d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*((-3 + d)*mm^2 - (-3 + d)*psq + 2*(-4 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
   (EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(8*mm^2 - 12*psq - 
      (-8 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2*Pi)^(2*d) + 
   (EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(4*(-2 + d)*mm^4 + 
      s*((23 - 5*d)*psq + 2*(-4 + d)*s) + 
   ...
   (EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(2*(-1 + d)*mm^2 - 
    ...
    (2*Pi)^(2*d) + (2^(3 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (mm^2 - psq - d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^4 + s*((-10 + 3*d)*psq - 2*(-2 + d)*s) - mm^2*(psq + (-10 + 3*d)*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (5*2^(3 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ((-5 + d)*mm^2 + (-3 + d)*psq - 2*d*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*d*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (11*mm^2 - 11*psq + 2*d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^2*((-3 + d)*mm^2 - (-3 + d)*psq + (-2 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ((-17 + 3*d)*mm^2 + psq - d*psq + 2*d*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (5*(-4 + d)*mm^2 + (24 - 5*d)*psq + 2*(-4 + d)*s)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 + psq - (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 - psq + 2*d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 - psq + 2*d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
