...
PropList[KiraPropagator[p1 - q1, mh], KiraPropagator[-p2 - q1, 
 ...
 ((I*2^(1 - 2*d)*EL^6*gHXZ^2*s*
  ...
  (I*2^(2 - d)*EL^6*gHXZ^2*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
       (-4 + d)*gZuR*gZuRC) + gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + 
  ...
  (I*2^(1 - d)*EL^6*gHXZ^2*(gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
   ...
   (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
  (I*2^(2 - d)*EL^6*gHXZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*s*\[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p1, p3]])/
   (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
  (I*2^(1 - d)*EL^6*gHXZ^2*(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
  ...
  (I*2^(1 - d)*EL^6*gHXZ^2*(gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
   ...
   (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
  (I*2^(3 - d)*EL^6*gHXZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*s*\[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
  (I*2^(1 - d)*EL^6*gHXZ^2*(gZlR*gZlRC*(-((-2 + d)*gZuL*gZuLC) + 
