...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
     ...
     (Pi^d*(mz^2 - s)) - (I*4^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      (gZlR*(2^(1 + d)*(-2 + d)*mm^2*Pi^d + 2^(1 + d)*(14 - 7*d + d^2)*mmv^2*
          Pi^d - 2^(4 + d)*Pi^d*s + 2^(3 + d)*d*Pi^d*s - d^2*(2*Pi)^d*s - 
         5*2^(2 + d)*Pi^d*t + 3*2^(2 + d)*d*Pi^d*t - 2^(1 + d)*d^2*Pi^d*t) + 
       gZlL*(2^(1 + d)*(-2 + d)*mm^2*Pi^d - 2^(1 + d)*(4 - 5*d + d^2)*mmv^2*
          Pi^d + 2^(3 + d)*Pi^d*s - 3*2^(1 + d)*d*Pi^d*s + d^2*(2*Pi)^d*s + 
         2^(4 + d)*Pi^d*t - 3*2^(2 + d)*d*Pi^d*t + 2^(1 + d)*d^2*Pi^d*t))*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1]])/(Pi^(2*d)*(mz^2 - s)) + 
    (I*4^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      (gZlR*(2^(1 + d)*(-2 + d)*mm^2*Pi^d + 2^(1 + d)*(12 - 7*d + d^2)*mmv^2*
          Pi^d - 2^(3 + d)*Pi^d*s + 3*2^(1 + d)*d*Pi^d*s - d^2*(2*Pi)^d*s - 
         2^(4 + d)*Pi^d*t + 3*2^(2 + d)*d*Pi^d*t - 2^(1 + d)*d^2*Pi^d*t) + 
       gZlL*(2^(1 + d)*(-2 + d)*mm^2*Pi^d - 2^(1 + d)*(6 - 5*d + d^2)*mmv^2*
          Pi^d + 2^(2 + d)*Pi^d*s - 2^(2 + d)*d*Pi^d*s + d^2*(2*Pi)^d*s + 
         5*2^(2 + d)*Pi^d*t - 3*2^(2 + d)*d*Pi^d*t + 2^(1 + d)*d^2*Pi^d*t))*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1]])/(Pi^(2*d)*(mz^2 - s)) + 
    (I*2^(3 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
    ...
    (I*EL^6*gAl*gAu*gWdu*gWud*gZdL*(gZlR*(2^(2 + d)*(-2 + d)*mmv^4*Pi^d + 
       ...
       gZlL*(2^(2 + d)*(-2 + d)*mmv^4*Pi^d + 2^(1 + d)*(8 - 6*d + d^2)*mm^2*
         ...
         2^(1 + d)*(-2 + d)*mmv^2*Pi^d*((8 - 6*d + d^2)*s + 4*t)))*CKM[1, 1]*
      CKMC[1, 1]*SPList[SP[q1, q1]])/((2*Pi)^(2*d)*(mz^2 - s)*s) - 
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
     ...
     (mw^2*Pi^d*(mz^2 - s)*s) + (I*4^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      ...
      SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s*(-mz^2 + s)) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      (gZlR*(2^(2 + d)*mmv^4*Pi^d + 2^(1 + d)*(-2 + d)*mm^2*Pi^d*s - 
         ...
         2^(3 + d)*Pi^d*s*t + 5*2^(1 + d)*d*Pi^d*s*t - 2^(1 + d)*d^2*Pi^d*s*
          t + 2^(2 + d)*Pi^d*t^2) + gZlL*(2^(2 + d)*mmv^4*Pi^d + 
     ...
     (mw^2*Pi^(2*d)*(mz^2 - s)*s) + (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWdu*
      gWud*gZdL*((-2 + d)*gZlL - (-4 + d)*gZlR)*(mmv^2 - t)*CKM[1, 1]*
    ...
    (I*4^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      ...
      SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s*(-mz^2 + s)) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      (gZlR*(2^(2 + d)*mmv^4*Pi^d + 2^(1 + d)*(-2 + d)*mm^2*Pi^d*s - 
         2^(3 + d)*Pi^d*s^2 + 3*2^(1 + d)*d*Pi^d*s^2 - d^2*(2*Pi)^d*s^2 + 
         2^(1 + d)*mmv^2*Pi^d*((8 - 6*d + d^2)*s - 4*t) - 
     ...
     (mw^2*Pi^(2*d)*(mz^2 - s)*s) - (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu*gWdu*
      gWud*gZdL*(gZlL + gZlR)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p3, q1], 
       SP[p3, q1]])/(Pi^d*(mz^2 - s)) - 
  ...
  PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
   ...
   (((-I)*2^(2 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      (gZlR*(4*mmv^4 + 2*(-2 + d)*mm^2*s - 8*s^2 + 6*d*s^2 - d^2*s^2 + 
         ...
         d^2*s^2 + 16*s*t - 10*d*s*t + 2*d^2*s*t + 4*t^2 - 
         2*mmv^2*((-2 + d)^2*s + 4*t)))*CKM[1, 1]*CKMC[1, 1]*
      SPList[SP[p1, q1], SP[p2, q1]])/(mw^2*Pi^d*(mz^2 - s)*s) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      (gZlR*(2^(2 + d)*mmv^4*Pi^d + 2^(1 + d)*(-2 + d)*mm^2*Pi^d*s - 
         2^(3 + d)*Pi^d*s^2 + 3*2^(1 + d)*d*Pi^d*s^2 - d^2*(2*Pi)^d*s^2 + 
         2^(1 + d)*mmv^2*Pi^d*((8 - 6*d + d^2)*s - 4*t) - 
         ...
         2^(2 + d)*Pi^d*t^2 - 2^(1 + d)*mmv^2*Pi^d*((-2 + d)^2*s + 4*t)))*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[q1, q1]])/
     (mw^2*Pi^(2*d)*(mz^2 - s)*s) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*
      gZdL*(gZlR*(2^(2 + d)*mmv^4*Pi^d + 2^(1 + d)*(-2 + d)*mm^2*Pi^d*s - 
         2^(3 + d)*Pi^d*s^2 + 3*2^(1 + d)*d*Pi^d*s^2 - d^2*(2*Pi)^d*s^2 + 
         2^(1 + d)*mmv^2*Pi^d*((8 - 6*d + d^2)*s - 4*t) - 
         2^(3 + d)*Pi^d*s*t + 5*2^(1 + d)*d*Pi^d*s*t - 2^(1 + d)*d^2*Pi^d*s*
          t + 2^(2 + d)*Pi^d*t^2) + gZlL*(2^(2 + d)*mmv^4*Pi^d + 
         ...
         2^(2 + d)*Pi^d*t^2 - 2^(1 + d)*mmv^2*Pi^d*((-2 + d)^2*s + 4*t)))*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1], SP[q1, q1]])/
     (mw^2*Pi^(2*d)*(mz^2 - s)*s) + (I*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      (gZlR*(2^(2 + d)*mmv^4*Pi^d + 2^(1 + d)*(-2 + d)*mm^2*Pi^d*s - 
         2^(3 + d)*Pi^d*s^2 + 3*2^(1 + d)*d*Pi^d*s^2 - d^2*(2*Pi)^d*s^2 + 
         2^(1 + d)*mmv^2*Pi^d*((8 - 6*d + d^2)*s - 4*t) - 
         2^(3 + d)*Pi^d*s*t + 5*2^(1 + d)*d*Pi^d*s*t - 2^(1 + d)*d^2*Pi^d*s*
