...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 (((-I)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*
    (aa*(2*mm^2*psq*(3*psq - 2*s - 3*t) + mm^4*(psq - t) + psq^2*(psq - t)) + 
     bb*(mm^4*(-psq + s + t) + psq^2*(-psq + s + t) + 
       2*mm^2*psq*(-3*psq + s + 3*t)))*\[Mu]^(8 - 2*d))/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (bb*(mm^4*(-2*psq + 3*s + 2*t) + psq^2*(-2*psq + 3*s + 2*t) - 
       2*mm^2*(6*psq^2 + psq*(s - 6*t) - s*(s + 2*t))) + 
     aa*(mm^4*(2*psq + s - 2*t) + psq^2*(2*psq + s - 2*t) + 
       2*mm^2*(6*psq^2 - 3*psq*(s + 2*t) - s*(s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^6*
    s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(4^d*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*
    (2*bb*mm^4 + aa*mm^2*(3*psq - 4*s - 3*t) + aa*psq*(psq - t) + 
     bb*psq*(-3*psq + 2*s + t) + bb*mm^2*(-3*psq + 2*s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (bb*(mm^4*(-psq + 2*s + t) + psq^2*(-psq + 2*s + t) + 
       2*mm^2*(-3*psq^2 - psq*s + s^2 + 3*psq*t + s*t)) + 
     aa*(mm^4*(psq - t) + psq^2*(psq - t) + mm^2*(6*psq^2 - 2*s*(s + t) - 
         2*psq*(s + 3*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^6*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/(4^d*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*
    (2*aa*mm^4 + aa*mm^2*(3*psq - s - 3*t) - bb*mm^2*(3*psq + s - 3*t) - 
     aa*psq*(psq - s + t) + bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*
    mm^4*(aa*(mm^4*(psq + s - t) + psq^2*(psq + s - t) + 
       mm^2*(6*psq^2 - 4*psq*s - 6*psq*t - 2*s*t)) + 
     bb*(mm^4*(-psq + s + t) + psq^2*(-psq + s + t) + 
       mm^2*(-6*psq^2 + 6*psq*t + 2*s*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(3*mm^2 + psq)*s*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (aa*(mm^4 + psq^2 + 2*mm^2*(psq - s - 2*t)) + 
     bb*(mm^4 + psq^2 + mm^2*(-6*psq + 2*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^6*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (4*bb*mm^4 + aa*mm^2*(6*psq - 9*s - 6*t) + aa*psq*(2*psq + s - 2*t) + 
     bb*psq*(-6*psq + 3*s + 2*t) + bb*mm^2*(-6*psq + 5*s + 6*t))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (4*aa*mm^4 + aa*mm^2*(6*psq - s - 6*t) + aa*psq*(-2*psq + s - 2*t) - 
     3*bb*mm^2*(2*psq + s - 2*t) + bb*psq*(-2*psq + 3*s + 2*t))*
  ...
  (I*4^(1 - d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(aa*mm^2*(3*psq - 2*s - 3*t) + 
  ...
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (aa*(4*psq^2 + 2*mm^2*(10*psq - 7*s - 10*t) - 4*psq*t + s*(s + 2*t)) - 
     bb*(4*psq^2 + mm^2*(20*psq - 6*s - 20*t) - 4*psq*(2*s + t) + 
       s*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(3*mm^2 + psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*bb*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^6*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/Pi^(2*d) + 
  (I*aa*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^6*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (2*bb*mm^4 + aa*mm^2*(3*psq - 4*s - 3*t) + aa*psq*(psq - t) + 
     bb*psq*(-3*psq + 2*s + t) + bb*mm^2*(-3*psq + 2*s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*bb*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (2*bb*mm^4 + aa*mm^2*(3*psq - 5*s - 3*t) + aa*psq*(psq + s - t) + 
     bb*psq*(-3*psq + s + t) + 3*bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*bb*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*(2*aa*mm^2*(psq - s - t) + 
     bb*(mm^4 + psq^2 + 2*mm^2*(-2*psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^6*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (2*aa*mm^4 + 3*aa*mm^2*(psq - t) - aa*psq*(psq + t) + 
  ...
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (aa*(2*psq^2 + 2*mm^2*(5*psq - 3*s - 5*t) + s*(s + t) - psq*(s + 2*t)) - 
     bb*(2*psq^2 + 2*mm^2*(5*psq - s - 5*t) + s*(s + t) - psq*(5*s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(3*mm^2 + psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   Pi^(2*d) + (I*aa*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
   Pi^(2*d) + (I*aa*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*(2*bb*mm^2*(-psq + t) + 
  ...
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (aa*(2*psq^2 + psq*s + 2*mm^2*(5*psq - 4*s - 5*t) - 2*psq*t + s*t) + 
     bb*(-2*psq^2 + 3*psq*s + 2*psq*t - s*t + mm^2*(-10*psq + 4*s + 10*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(3*mm^2 + psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*
    gHll^2*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*
    gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*
    mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa + bb)*EL^5*gFFA*gFll^2*gHll^2*
    mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p3, q1]])/Pi^(2*d) + (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*4^(1 - d)*bb*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*aa*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*4^(1 - d)*bb*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  ((3*I)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*bb*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa + 3*bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*
  ...
  (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(aa*(2*mm^2 - psq - t) + 
   ...
   Pi^(2*d) - (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(3*aa + bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*
  ...
  (I*2^(1 - 2*d)*bb*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*bb*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*aa*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*aa*EL^5*gFFA*gFll^2*gHll^2*mm^4*
  ...
  (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa + bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*
