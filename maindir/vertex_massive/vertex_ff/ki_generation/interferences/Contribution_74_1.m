   ...
   (-((4^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZNL*
       (gZlR*mm^2*(-(d^2*(2*Pi)^(2*d)*s*(psq^2 + t*(s + 3*t))) + 
        ...
        gZlL*(-((-4 + d)*mm^2*(2*Pi)^(2*d)*((-2 + d)*psq - 2*s - (-2 + d)*t)*
          ...
          2^(1 + 2*d)*Pi^(2*d)*((-4 + 3*d)*psq^4 + psq^3*((6 - 4*d)*s + 
              3*(4 - 3*d)*t) + s*t*(s^2 + 3*s*t + 2*t^2) + 
    ...
    (2^(3 - 4*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZNL*
      ((-2 + d)*gZlR*mm^2*(2*Pi)^(2*d)*s*(-2*psq + s + 2*t) + 
       gZlL*(-(mm^2*(2*Pi)^(2*d)*((16 - 10*d + d^2)*psq^2 - 4*s^2 + 
         ...
         2^(1 + 2*d)*Pi^(2*d)*((-8 + 5*d)*psq^3 + s*t*(s + t) + 
           ...
           d*(psq^2 + t*(s + t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q2]])/(Pi^(4*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*
      gWWA*gZlL*gZNL*(-4*psq^3 + s*t*(s + t) + 2*psq^2*(s + 4*t) - 
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlL*gZNL*
      ...
      (gZlR*mm^2*s*(-psq + s + t) + 2*gZlL*psq*(psq^2 - 2*psq*t + 
         t*(s + t)) - gZlL*mm^2*(2*psq^2 + s^2 + 3*s*t + 2*t^2 - 
    ...
    (4^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gZNL*(-(gZlR*mm^2*s^2) + 
       gZlL*(-3*(-2 + d)*psq^3 + t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
         psq^2*((-3 + d)*s + 7*(-2 + d)*t) - psq*(s^2 + (-13 + 5*d)*s*t + 
           5*(-2 + d)*t^2) + mm^2*(2*(-2 + d)*psq^2 + 2*s^2 + 
           (-3 + 2*d)*s*t + 2*(-2 + d)*t^2 - psq*(s + 4*(-2 + d)*t))))*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlL*gZNL*
      ...
      (-((-2 + d)^2*gZlR*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
          2*t^2)) + gZlL*((-24 + 6*d + d^2)*psq^3 - 4*t*(s + t)*
          ((-5 + d)*s + (-4 + d)*t) + psq*((12 - 6*d + d^2)*s^2 + 
           2*(-26 + 4*d + d^2)*s*t + (-56 + 14*d + d^2)*t^2) - 
         2*psq^2*(-4*d*(s - 2*t) - 32*t + d^2*(s + t)) + 
         mm^2*((24 - 14*d + d^2)*psq^2 - 4*s^2 + (20 - 14*d + d^2)*s*t + 
           (24 - 14*d + d^2)*t^2 - psq*((4 - 6*d + d^2)*s + 
             2*(24 - 14*d + d^2)*t))))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZNL*
      (-((-2 + d)*gZlR*mm^2*(2*psq - s - 2*t)) + 
       gZlL*((-4 + d)*psq^2 + (-2 + d)*mm^2*(psq - t) - 
         (-2 + d)*psq*(s + t) + 2*t*(s + t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*(8 - 6*d + d^2)*EL^6*gAu*gWlN*gWNl*gWWA*gZlL*gZNL*(psq - t)*
      ...
      gWWA*gZlL*gZNL*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlL*gZNL*((16 - 10*d + d^2)*mm^2 - 
       (8 - 10*d + d^2)*psq - 8*(s + t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlL*gZNL*(d^2*psq*(psq - s - t) + 
       mm^2*(-((8 - 6*d + d^2)*psq) + (4 - 6*d + d^2)*s + 
         (8 - 6*d + d^2)*t) + 2*d*(-2*psq^2 + psq*(s + t) + (s + t)^2) - 
    ...
    (2^(5 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlL*gZNL*(psq - t)*(psq + s - t)*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*(8 - 6*d + d^2)*EL^6*gAu*gWlN*gWNl*gWWA*gZlL*
      gZNL*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[q2, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*
      gWWA*gZlL*gZNL*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
    ...
    (2^(5 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlL*gZNL*(psq - t)*
