...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (((3*I)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*s*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  ((3*I)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*s*(psq - t)*
  ...
  ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*(psq - s - t)*
  ...
  ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (gZlR*(mm^2 - 2*psq)*s + gZlL*mm^2*(3*psq - 4*s - 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*(2*psq - s - 2*t)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (bb*gZlL*mm^2*(2*psq - s - 2*t) + aa*gZlL*mm^2*(-2*psq + s + 2*t) + 
     aa*gZlR*(-psq^2 + psq*(s + t) - 2*s*(s + t) + mm^2*(-psq + 2*s + t)) + 
     bb*gZlR*(psq^2 + mm^2*(psq + 5*s - t) + 2*s*(s + t) - psq*(8*s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (-(gZlR*(mm^2 - 2*psq)*s) + gZlL*mm^2*(3*psq + s - 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (aa*gZlL*mm^2*(2*psq - s - 2*t) - 2*aa*gZlR*s*(-psq + s + t) + 
     bb*gZlL*mm^2*(-2*psq + s + 2*t) + bb*gZlR*s*(mm^2 - 3*psq + 2*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (2*aa*gZlL*mm^2*(2*psq - s - 2*t) + bb*gZlR*s*(2*mm^2 - 3*psq + s + t) - 
     aa*gZlR*s*(-psq + s + t) + 2*bb*gZlL*mm^2*(-2*psq + s + 2*t))*
  ...
  ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*(psq - t)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (aa*gZlL*mm^2*(2*psq - s - 2*t) + bb*gZlL*mm^2*(-2*psq + s + 2*t) + 
     aa*gZlR*(psq^2 + 3*psq*s + mm^2*(psq - 6*s - t) - psq*t + 2*s*t) - 
     bb*gZlR*(psq^2 + mm^2*(psq + s - t) + 2*s*t - psq*(4*s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
  (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*s*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (aa*gZlR*s*(mm^2 + psq - 2*t) + aa*gZlL*mm^2*(2*psq - s - 2*t) + 
     2*bb*gZlR*s*(-psq + t) + bb*gZlL*mm^2*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (2*aa*gZlL*mm^2*(2*psq - s - 2*t) + aa*gZlR*s*(2*mm^2 - psq - t) + 
     bb*gZlR*s*(-psq + t) + 2*bb*gZlL*mm^2*(-2*psq + s + 2*t))*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*
    gZlR*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 - gZlR*mm^2 + 
     2*gZlR*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*
    (2*aa*(psq - s - t) + bb*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(aa*(psq - s - t) + 
  ...
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 - gZlR*mm^2 + 
     2*gZlR*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*
    (aa*(mm^2 + 3*psq - 2*s - 4*t) + bb*(mm^2 - 5*psq + 2*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 - gZlR*mm^2 + 
     2*gZlR*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*
    (aa*(mm^2 + psq - 2*t) + 2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*psq - s - 2*t)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (gZlL*mm^2 - gZlR*mm^2 + 2*gZlR*psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 - gZlR*mm^2 + 
     2*gZlR*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*mm^2*
    (gZlL*mm^2 - gZlR*mm^2 + 2*gZlR*psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(aa*(mm^2 + psq - 2*t) + 
     2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) + (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[q1, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(aa*(mm^2 + 3*psq - 2*s - 4*t) + 
     bb*(mm^2 - 5*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(aa*(mm^2 + psq - 2*t) + 
     2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) + (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*
    (aa*(mm^2 + psq - 2*t) + 2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*
  ...
  (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*
