...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(4*mm^2 - 4*psq + s)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*
     mm^2*(mm^2 - psq)*(-4*psq^2 - s^2 + 2*mm^2*(psq - s - t) - 3*s*t - 
      2*t^2 + 3*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*d*EL^6*gAl*gAu*gXll^2*gZlL*
     gZlR*mm^4*(4*psq^2 - 4*mm^2*(psq - t) - 2*psq*(s + 2*t) + s*(s + 2*t))*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
     (mm^2 - psq)*(3*psq^2 + mm^2*s + s^2 + 4*s*t + 3*t^2 - psq*(s + 6*t))*
   ...
   (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*
     mm^2*(mm^2 - psq)*(mm^2 - 3*psq + s)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(psq - t)*
   ...
   (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(psq - t)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*
     mm^2*(-2*psq + s + 2*t)*(-2*psq^2 + mm^2*(psq - t) + 3*psq*t - 
      t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*
     mm^2*(mm^2 - psq)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
     (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/
    Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
     (d*(2*Pi)^(2*d)*s*(-(psq*(psq + s - 7*t)) + mm^2*(-psq + s + t)) + 
