...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((I*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
     ...
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*
      mm^2*s*sw*(bb*(3*psq - s - 3*t) + aa*(mm^2 - 4*psq + s + 3*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
    (I*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
      (aa*(2*psq^2 + psq*(5*s - 2*t) + 2*mm^2*(psq - 3*s - t) - s*(s + t)) + 
       bb*(-2*psq^2 - 2*mm^2*(psq + s - t) + s*(s + t) + psq*(3*s + 2*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
      (bb*(mm^2 + 2*psq - 2*s - 3*t) + aa*(-3*psq + 2*s + 3*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
    (I*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
      (aa*(2*psq^2 + 3*psq*s + 2*mm^2*(psq - 2*s - t) - 2*psq*t - s*t) + 
       bb*(-2*psq^2 + 5*psq*s - 2*mm^2*(psq + 2*s - t) + 2*psq*t + s*t))*
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
      (bb*(3*psq - s - 3*t) + aa*(mm^2 - 4*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
      (bb*(6*psq - s - 6*t) + aa*(2*mm^2 - 8*psq + s + 6*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
      (bb*(2*mm^2 + 4*psq - 5*s - 6*t) + aa*(-6*psq + 5*s + 6*t))*
