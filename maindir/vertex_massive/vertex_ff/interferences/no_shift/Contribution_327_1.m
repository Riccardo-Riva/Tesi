  ...
  (-((4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(psq - t)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
     ...
     mh^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
    Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
    ...
    Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*
     mh^2*mm^4*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*
