...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p2 + q1, mh], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl^2*gFFAA*gHFF*gHll*mh^2*mm^2*
      (2*(-1 + d)*mm^2 - 2*(-3 + d)*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d))/
     Pi^(2*d)) + (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gFFAA*gHFF*gHll*mh^2*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAl^2*gFFAA*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
