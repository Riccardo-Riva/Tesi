...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
  ...
  (-((2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*psq*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*s*
     (-2*bb*psq^2 + aa*psq*(2*mm^2 + 2*psq - s) + bb*mm^2*(-2*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*psq*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (bb*(psq^2 + mm^2*(psq - 2*s)) - aa*psq*(mm^2 + psq - 2*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (-(bb*(psq^2 + mm^2*(psq - s))) + aa*psq*(mm^2 + psq - s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(bb*mm^2 - aa*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(bb*mm^2 - aa*psq)*s*
   ...
   (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    ...
    Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q2]])/Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*
     gWWA*mm^2*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
