...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
   ...
   ((2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*mm^2*
    ...
    (2^(1 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*gWlN^2*gWNl^2*mm^2*
     ...
     Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*
      ((-2 + d)*mm^2 + 2*s)*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
       psq^2*(s + 6*t) + t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*
      ((-2 + d)*mm^2*(2*(-2 + d)*psq^2 + psq*(-((-4 + d)*s) - 4*(-2 + d)*t) + 
         (s + t)*((-4 + d)*s + 2*(-2 + d)*t)) - 
       2*((-8 - 2*d + d^2)*psq^3 + psq^2*((28 - 6*d)*s + 2*(14 + d - d^2)*
            t) - (s + t)*((-6 + d)*s^2 + (-14 + 3*d)*s*t + 2*(-6 + d)*t^2) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*((-2 + d)^2*mm^2*(psq - t) + 
       (psq - s - t)*((-20 + d^2)*psq - 2*(-6 + d)*(s + 2*t)))*
    ...
    (4^(1 - d)*(-6 + d)^2*EL^6*gAl*gAu*gWlN^2*gWNl^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN^2*
      gWNl^2*(-2*(-2 + d)*psq^3 + 4*s*t*(s + t) + 
       psq^2*((10 - 3*d)*s + 4*(-2 + d)*t) + 
       psq*((-2 + d)*s^2 - (6 + d)*s*t - 2*(-2 + d)*t^2) + 
       (-2 + d)*mm^2*(6*psq^2 + s^2 + 7*s*t + 6*t^2 - 3*psq*(s + 4*t)))*
    ...
    (4^(1 - d)*(-6 + d)^2*EL^6*gAl*gAu*gWlN^2*gWNl^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN^2*
      gWNl^2*(2*(-2 + d)*psq^3 + (-2 + d)*mm^2*(2*psq - s - 2*t)*(psq - t) + 
       4*s*t*(s + t) + psq^2*(-((-6 + d)*s) - 4*(-2 + d)*t) + 
       psq*t*((-10 + d)*s + 2*(-2 + d)*t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*(-2 + d)^2*EL^6*gAl*gAu*gWlN^2*gWNl^2*(mm^2 + psq)*
      ...
      gWNl^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[p3, q1]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*s*
      ((-2 + d)^2*mm^2 - (-20 + d^2)*psq + 2*(-6 + d)*(s + 2*t))*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*((-2 + d)*mm^2 - 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*((-2 + d)*mm^2 - 
      ...
      gWNl^2*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*((-2 + d)^2*psq^2 + 
       2*(-4 + d)*s^2 + (12 - 6*d + d^2)*s*t + (-2 + d)^2*t^2 - 
       psq*((12 - 6*d + d^2)*s + 2*(-2 + d)^2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*((-2 + d)*mm^2 - d*psq + 
       4*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/
     Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*gWlN^2*gWNl^2*(psq - t)*
      ...
      gWNl^2*((-2 + d)*psq^2 - (-2 + d)*mm^2*(psq - t) + s*(s + 2*t) - 
       ...
       SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*
      gWlN^2*gWNl^2*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN^2*gWNl^2*((-2 + d)*mm^2 - 
       ...
       SP[p3, q2]])/Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*gWlN^2*
      gWNl^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[q1, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*gWlN^2*gWNl^2*
      (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*gWlN^2*gWNl^2*(psq - t)*
      ...
      gWlN^2*gWNl^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*(-2 + d)^2*EL^6*gAl*gAu*gWlN^2*gWNl^2*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
    (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*gWlN^2*gWNl^2*(2*psq - s - 2*t)*
