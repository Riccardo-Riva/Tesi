...
PropList[KiraPropagator[-q1, mw], KiraPropagator[-q1 - q2, mz], 
 ...
 ((2^(-1 - 2*d)*EL^5*gFll^2*gXFAW*gXFW*mm^2*s*(-(bb*psq*(mm^2 + psq + s)) + 
     aa*(psq^2 + mm^2*(psq + s)))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gFll^2*gXFAW*gXFW*mm^2*(bb*mm^2*(2*psq + s) - 
  ...
  (2^(-1 - 2*d)*(aa - bb)*EL^5*gFll^2*gXFAW*gXFW*mm^2*(mm^2 + psq)*s*
