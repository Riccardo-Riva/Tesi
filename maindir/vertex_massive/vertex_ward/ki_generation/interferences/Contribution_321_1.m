   ...
   (((-I)*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
      (bb*(-2*psq^2 + 2*mm^2*s - psq*s + 2*psq*t + s*t) + 
       aa*(2*psq^2 - s*t - psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*
      mm^6*(psq^2 + mm^2*(psq - t) - psq*t - 2*s*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*
      mm^6*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*s*
