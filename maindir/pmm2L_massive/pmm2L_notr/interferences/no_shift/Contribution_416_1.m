...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((2^(5 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFFZZ*gZlL*gZlR*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFFZZ*gZlL*gZlR*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFFZZ*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*(gZlL^2 + gZlR^2)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*
     (gZlL^2 + gZlR^2)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*
     gFFZZ*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s)))/4
