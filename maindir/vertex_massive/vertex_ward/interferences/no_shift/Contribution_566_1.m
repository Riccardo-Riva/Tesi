...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
     ...
     (2*bb*psq*(2*mm^2 + psq - s) + aa*mm^2*(-4*psq + s) + 
      aa*psq*(-2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(aa*psq*(psq - 3*s) + 
      aa*mm^2*(5*psq - s) + bb*psq*(-psq + s) + bb*mm^2*(-5*psq + 3*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - 2*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(aa*mm^2 - 2*bb*mm^2 + 4*aa*psq - 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*s*
     ...
     SPList[SP[q2, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
     gXll^2*mm^6*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (-2*aa*psq + bb*(mm^2 + psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
   (4^(2 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*psq*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(-3*bb*mm^4 + 
      aa*(3*mm^4 + 7*mm^2*psq) + bb*psq*s - bb*mm^2*(7*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*psq*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(2*aa*(psq^2 + mm^2*(3*psq - s)) + 
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*psq^2 + bb*mm^2*(5*psq - 2*s) + 
      aa*mm^2*(-5*psq + s) + aa*psq*(-psq + s))*\[Mu]^(8 - 2*d)*
