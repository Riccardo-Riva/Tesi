(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 - p2 + q1, 0]]*
  ((I*2^(1 - 2*d)*EL^6*(gZdL^2*(gZlR*gZlRC*(3*d^2*gZuL*gZuLC*(2*Pi)^d*s^2 + 
   ...
   ((3*I)*2^(4 - d)*EL^6*(gZdL^2 + gZdR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
