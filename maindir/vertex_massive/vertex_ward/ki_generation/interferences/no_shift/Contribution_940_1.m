...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   ((EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
      (aa*psq*(-4*(-1 + d)*mm^2 - 4*(1 + 4*d)*psq + 5*d*s) + 
       bb*(2*(-1 + d)*psq*(14*psq - 3*s) + mm^2*((28 - 8*d)*psq + 
           (-6 + d)*s)))*\[Mu]^(8 - 2*d))/(mz^2*(2*Pi)^(2*d)) - 
    (4^(1 - d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (bb*mm^2*(-((-6 + d)*mm^2*(psq - s)) + psq*(-6*psq + 11*d*psq + 11*s - 
           6*d*s)) + aa*psq*((-6 + d)*mm^4 + (-8 + 3*d)*psq*s + 
    ...
    (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
    ...
    (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
     ...
     (mz^2*Pi^(2*d)) + (4^(1 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*
      (gZlL + gZlR)*(-(bb*mm^2*(mm^2 + psq - s)) + 
       aa*(mm^4 + mm^2*psq - psq*s))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/(mz^2*Pi^(2*d)) + 
    (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)) - (5*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*
      (gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q1]])/(mz^2*Pi^(2*d)) - (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*
      gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
    (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(aa*(-6 + d)*mm^2 + 
       bb*(-26 + 11*d)*mm^2 + aa*(26 - 11*d)*psq - bb*(-6 + d)*psq)*s*
    ...
    (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)) + (4^(1 - d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl^2*gWWA*gWWZ*
      ...
      (gZlL + gZlR)*(bb*(-2 + d)*mm^2 + aa*(-8 + 5*d)*mm^2 + 
    ...
    (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)) + (2^(1 - 2*d)*(aa + bb)*(-8 + 3*d)*EL^5*gAl^2*gWWA*gWWZ*
      (gZlL + gZlR)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)) + (2^(1 - 2*d)*(aa + bb)*(-5 + 3*d)*EL^5*
      gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
    (2^(1 - 2*d)*(aa + bb)*(-5 + 3*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], SP[q2, q2]])/
     (mz^2*Pi^(2*d)) + (5*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*
      (gZlL + gZlR)*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)) + 
    (2^(3 - 2*d)*(-5 + 3*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p2, q2]])/(mz^2*Pi^(2*d)) - (5*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWWA*
      gWWZ*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)) - 
    (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(-5 + 3*d)*EL^5*gAl^2*gWWA*
      gWWZ*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)) - 
    (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q1]])/(mz^2*Pi^(2*d)) + (4^(2 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*
      gWWZ*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
    (5*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p2, q1]])/(mz^2*Pi^(2*d)) + (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*
      gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
    (5*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*
      gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)) - 
    (2^(3 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[q2, q2]])/(mz^2*Pi^(2*d)) + (4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*
      gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)) + 
    (4^(2 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*
      gWWZ*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*
      gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-((EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
    ...
    (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
      (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     (mz^2*Pi^(2*d)) + (4^(1 - d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (bb*((-6 + d)*mm^4 - 4*(-1 + d)*psq^2 + mm^2*((22 - 27*d)*psq + 
           10*(-1 + d)*s)) + aa*(-((-6 + d)*mm^4) + 4*(-1 + d)*psq*
          (psq - s) + mm^2*(-22*psq + 27*d*psq + 6*s - 6*d*s)))*
    ...
    (4^(1 - d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)) - (4^(1 - d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (bb*(-6 + d)*psq^2 + aa*mm^2*((-6 + 11*d)*psq - 3*(-1 + d)*s) + 
       aa*psq*(-((-6 + d)*psq) - 2*(-1 + d)*s) + 
       bb*mm^2*((6 - 11*d)*psq + 5*(-1 + d)*s))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)) - 
    (4^(1 - d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(2*bb*(-3 + 2*d)*psq^2 + 
    ...
    (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
      (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
     (mz^2*Pi^(2*d)) + (4^(1 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*
      (gZlL + gZlR)*(bb*mm^2*(mm^2 + psq - s) - aa*(mm^4 + mm^2*psq - psq*s))*
    ...
    (4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
      (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)) + (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*
      gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/(mz^2*Pi^(2*d))))/2
