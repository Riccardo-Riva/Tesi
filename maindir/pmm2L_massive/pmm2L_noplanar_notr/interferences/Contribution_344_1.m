...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
      ((-2 + d)*psq*(2*psq - 3*s)*s + mm^2*(8*psq^2 + (-2 + d)*s^2 + 8*s*t + 
         8*t^2 - 2*psq*((-2 + d)*s + 8*t)))*\[Mu]^(8 - 2*d))/
     (Pi^(2*d)*s^2)) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^2*(-((-2 + d)*psq^2*s) + 
      mm^4*(6*psq + (-8 + d)*s - 6*t) - 
      2*mm^2*(psq^2 - psq*((-3 + d)*s + 5*t) + 2*(s^2 + 3*s*t + 2*t^2)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (-6*psq^2 - 7*s^2 + d*s^2 + 2*mm^2*(5*psq + (-7 + d)*s - 5*t) - 11*s*t - 
      6*t^2 + psq*((3 + d)*s + 12*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*((-2 + d)*psq^2*s + mm^4*(6*psq + 2*s - d*s - 6*t) + 
      2*mm^2*(7*psq^2 + 2*t*(s + 2*t) - psq*((-4 + d)*s + 11*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (6*psq^2 + 2*s^2 - d*s^2 + 2*mm^2*(5*psq - (-2 + d)*s - 5*t) + s*t + 
      6*t^2 - psq*((-7 + d)*s + 12*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^4*((-8 + d)*mm^2 - (4 + d)*psq + 4*(-3 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     ((-16 + 3*d)*mm^2 - 3*(-2 + d)*psq + 5*(-3 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (4*mm^4*s + psq*s*(-2*(-4 + d)*psq - (-2 + d)*s) - 
    ...
    (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^2*(2*(-8 + d)*mm^4*s + (-8 + 3*d)*psq*s^2 + 
      2*mm^2*(2*psq^2 + (-19 + 5*d)*s^2 + 2*s*t + 2*t^2 - 
        psq*((-8 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(-2*psq^2 + 3*s^2 - d*s^2 + mm^2*(10*psq - 22*s + 3*d*s - 10*t) - 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(2*psq^2 - 3*psq*s - 2*s^2 + d*s^2 + 
      mm^2*(10*psq - 3*(-4 + d)*s - 10*t) - 4*psq*t + 3*s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*mm^2 - 4*psq - 2*s + d*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (3*2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (d*(mm^2 - psq) + 4*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/
    (Pi^(2*d)*s) - (3*2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(4*mm^2 + (-5 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*((-22 + 3*d)*mm^2 - 3*(-4 + d)*psq - (-3 + d)*s)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (3*mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
