...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mz], 
 ...
 ((4^(1 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(3*s + 2*t)*
