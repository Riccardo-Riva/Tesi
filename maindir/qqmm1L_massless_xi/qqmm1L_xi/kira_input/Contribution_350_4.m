(I*EL^6*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   s*\[Mu]^(4 - d)*userIntegral[A3, {ml}, -2, 1, 1, 0])/
  ((2*Pi)^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*2^(-1 - 2*d)*EL^6*(gZlL^2 + gZlR^2)*
   (gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s - 
      ...
      2^(1 + d)*gZuR*gZuRC*Pi^d*(s + d*s + t)))*\[Mu]^(4 - d)*
   userIntegral[A3, {ml}, -1, 0, 1, 0])/(Pi^(2*d)*(mz^2 - s)^2*
   (-mzC^2 + s)) + (I*2^(-1 - 2*d)*EL^6*(gZlL^2 + gZlR^2)*
   ...
   userIntegral[A3, {ml}, -1, 1, 0, 0])/(Pi^(2*d)*(mz^2 - s)^2*
   (-mzC^2 + s)) - (I*EL^6*(gZlL^2 + gZlR^2)*
   (gZlR*gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + 
      gZuL*gZuLC*((-2 + d)*s + 2*t)) + 
    gZlL*gZlLC*(gZuL*gZuLC*(-((-4 + d)*s) + 2*t) + 
      gZuR*gZuRC*((-2 + d)*s + 2*t)))*\[Mu]^(4 - d)*
   userIntegral[A3, {ml}, -1, 1, 1, -1])/((2*Pi)^d*(mz^2 - s)^2*
   (-mzC^2 + s)) - 
 (I*2^(-1 - d)*EL^6*
   (gZlL^3*gZlLC*(gZuR*gZuRC*((-4 + d)*s*((-2 + d)*s - 2*t) - 
        2*ml^2*((-4 + d)*s + 2*t)) + gZuL*gZuLC*(2*ml^2*((-2 + d)*s - 2*t) + 
        (-2 + d)*s*((-4 + d)*s + 2*t))) + gZlR^3*gZlRC*
     (gZuL*gZuLC*((-4 + d)*s*((-2 + d)*s - 2*t) - 
        2*ml^2*((-4 + d)*s + 2*t)) + gZuR*gZuRC*(2*ml^2*((-2 + d)*s - 2*t) + 
        (-2 + d)*s*((-4 + d)*s + 2*t))) - gZlL^2*gZlR*gZlRC*
     (gZuR*gZuRC*(ml^2*(-2*(-2 + d)*s + 4*t) + 
        s*((-2 + d)^2*s + 2*(-4 + d)*t)) + gZuL*gZuLC*
       (2*ml^2*((-4 + d)*s + 2*t) + s*((-4 + d)^2*s - 2*(-2 + d)*t))) + 
    gZlL*gZlLC*gZlR^2*(gZuL*gZuLC*(2*ml^2*((-2 + d)*s - 2*t) - 
        s*((-2 + d)^2*s + 2*(-4 + d)*t)) - gZuR*gZuRC*
       (2*ml^2*((-4 + d)*s + 2*t) + s*((-4 + d)^2*s - 2*(-2 + d)*t))))*
   \[Mu]^(4 - d)*userIntegral[A3, {ml}, -1, 1, 1, 0])/
 ...
 (I*2^(-1 - 2*d)*EL^6*(gZlL^2 + gZlR^2)*
   ...
   userIntegral[A3, {ml}, 0, -1, 1, 0])/(Pi^(2*d)*(mz^2 - s)^2*
   (-mzC^2 + s)) + (I*EL^6*(gZlL^2 + gZlR^2)*
   (gZlR*gZlRC*(gZuR*gZuRC*((-2 + d)*s + (-4 + d)*t) - 
      gZuL*gZuLC*((-4 + d)*s + (-2 + d)*t)) + 
    gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s + (-4 + d)*t) - 
      gZuR*gZuRC*((-4 + d)*s + (-2 + d)*t)))*\[Mu]^(4 - d)*
   userIntegral[A3, {ml}, 0, 0, 0, 0])/((2*Pi)^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
 (I*2^(-1 - d)*EL^6*(gZlL^2 + gZlR^2)*
   (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
    gZlR*gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
      gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*\[Mu]^(4 - d)*
   userIntegral[A3, {ml}, 0, 0, 1, -1])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*2^(-2 - d)*EL^6*
   (-(gZlR^3*gZlRC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 
          4*ml^2*((-2 + d)*s - 2*t) - 2*(18 - 9*d + d^2)*s*t - 4*t^2)) + 
       gZuL*gZuLC*(-((8 - 6*d + d^2)*s^2) - 2*(12 - 7*d + d^2)*s*t + 4*t^2 + 
         4*ml^2*((-4 + d)*s + 2*t)))) + gZlL^3*gZlLC*
     (gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 4*ml^2*((-2 + d)*s - 2*t) - 
        2*(18 - 9*d + d^2)*s*t - 4*t^2) - gZuR*gZuRC*
       (-((8 - 6*d + d^2)*s^2) - 2*(12 - 7*d + d^2)*s*t + 4*t^2 + 
        4*ml^2*((-4 + d)*s + 2*t))) + gZlL*gZlLC*gZlR^2*
     (gZuL*gZuLC*((-16 + 14*d - 3*d^2)*s^2 + 4*ml^2*((-2 + d)*s - 2*t) - 
        2*(6 - 5*d + d^2)*s*t - 4*t^2) - gZuR*gZuRC*(-((8 - 6*d + d^2)*s^2) - 
        2*(12 - 7*d + d^2)*s*t + 4*t^2 + 4*ml^2*((-4 + d)*s + 2*t))) - 
    gZlL^2*gZlR*gZlRC*(gZuL*gZuLC*(-((8 - 6*d + d^2)*s^2) - 
        2*(12 - 7*d + d^2)*s*t + 4*t^2 + 4*ml^2*((-4 + d)*s + 2*t)) + 
      gZuR*gZuRC*((16 - 14*d + 3*d^2)*s^2 + 2*(6 - 5*d + d^2)*s*t + 4*t^2 + 
        ml^2*(-4*(-2 + d)*s + 8*t))))*\[Mu]^(4 - d)*
   userIntegral[A3, {ml}, 0, 0, 1, 0])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
 (I*2^(-1 - d)*EL^6*(gZlL^2 + gZlR^2)*
   (gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
    gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + (-2 + d)*gZuR*gZuRC))*t*
   \[Mu]^(4 - d)*userIntegral[A3, {ml}, 0, 1, -1, 0])/
  (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
 (I*2^(-1 - d)*EL^6*(gZlL^2 + gZlR^2)*
   (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
    gZlR*gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
      gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*\[Mu]^(4 - d)*
   userIntegral[A3, {ml}, 0, 1, 0, -1])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
 ((I/4)*EL^6*((2^(2 - d)*(gZlL^2 + gZlR^2)*
      (gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
       gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + (-2 + d)*gZuR*gZuRC))*ml^2*t)/
    ...
    (2^(1 - d)*(gZlL^2 + gZlR^2)*(s + t)*
      (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*
          ((-4 + d)*s + 2*t)) - gZlR*gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
         gZuR*gZuRC*(-((-2 + d)*s) + 2*t))))/Pi^d + 
    (2^(1 - d)*(gZlL^2 + gZlR^2)*t*
    ...
    (2^(1 - 2*d)*(gZlL^2 - gZlR^2)*s*
      (gZlL*gZlLC*(gZuL*gZuLC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            (3*s + (-3 + d)*t)) + gZuR*gZuRC*((-5 + d)*d*(2*Pi)^d*s - 
           2^(1 + d)*Pi^d*((-6 + d)*s + (-3 + d)*t))) + 
       gZlR*gZlRC*(-(gZuR*gZuRC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
             (3*s + (-3 + d)*t))) + gZuL*gZuLC*(-((-5 + d)*d*(2*Pi)^d*s) + 
           2^(1 + d)*Pi^d*((-6 + d)*s + (-3 + d)*t)))))/Pi^(2*d) + 
    ...
    (gZlL^3*gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
       ...
       (gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
        ...
        gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*(-1 + d)*s^2 - 
            (8 - 5*d + d^2)*s*t - 2*t^2))) + gZlL^2*gZlR*gZlRC*
       (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(4*(-2 + d)*s^2 + 
            (-2 - 3*d + d^2)*s*t - 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 
          2^(1 + d)*Pi^d*((2 - 2*d + d^2)*s^2 + (8 - 5*d + d^2)*s*t + 
            2*t^2))) - gZlL*gZlLC*gZlR^2*
       (gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*(4*(-2 + d)*s^2 + 
            (-2 - 3*d + d^2)*s*t - 2*t^2)) + gZuL*gZuLC*
         (-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((2 - 2*d + d^2)*s^2 + 
            (8 - 5*d + d^2)*s*t + 2*t^2))))/(2*Pi)^(2*d))*\[Mu]^(4 - d)*
   userIntegral[A3, {ml}, 0, 1, 0, 0])/((mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*EL^6*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
   (gZuL*gZuLC + gZuR*gZuRC)*s*\[Mu]^(4 - d)*userIntegral[A3, {ml}, 0, 1, 1, 
    -2])/((2*Pi)^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
 (I*2^(-1 - 2*d)*EL^6*(2^(2 + d)*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*ml^2*Pi^d*s + 2^(2 + d)*(gZlL^2 + gZlR^2)*
     (gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*Pi^d*s*t - 
    2^(2 + d)*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*Pi^d*s*(s + t) + (gZlL^2 + gZlR^2)*ml^2*
    ...
    (gZlL^2 + gZlR^2)*(2*Pi)^d*s*
     (-(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
         2*gZuR*gZuRC*(3*s + t))) + gZlL*gZlLC*
       (gZuL*gZuLC*((-6 + d)*s - 2*t) - gZuR*gZuRC*(d*s + 2*t))) - 
    (gZlL^2 - gZlR^2)*s*(gZlR*gZlRC*(gZuR*gZuRC*((-5 + d)*d*(2*Pi)^d*s + 
          2^(1 + d)*Pi^d*(3*s + (-3 + d)*t)) - gZuL*gZuLC*
         ((-7 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(6*s + 3*t - d*t))) + 
      gZlL*gZlLC*(-(gZuL*gZuLC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            (3*s + (-3 + d)*t))) + gZuR*gZuRC*((-7 + d)*d*(2*Pi)^d*s + 
          2^(1 + d)*Pi^d*(6*s + 3*t - d*t)))))*\[Mu]^(4 - d)*
   userIntegral[A3, {ml}, 0, 1, 1, -1])/(Pi^(2*d)*(mz^2 - s)^2*
   (-mzC^2 + s)) + (I*4^(-1 - 2*d)*EL^6*
   (-(gZlR^3*gZlRC*(gZuR*gZuRC*(-(2^(2 + 3*d)*ml^4*Pi^(3*d)*
           ((-2 + d)*s - 2*t)) + (2*Pi)^(3*d)*s*((8 - 6*d + d^2)*s^2 - 
           2*(-4 + d)^2*s*t - 4*t^2) - 2^(1 + 3*d)*ml^2*Pi^(3*d)*
          ((8 - 6*d + d^2)*s^2 - 2*(18 - 9*d + d^2)*s*t - 4*t^2)) + 
       gZuL*gZuLC*(2^(2 + 3*d)*ml^4*Pi^(3*d)*((-4 + d)*s + 2*t) - 
         2^(1 + 3*d)*ml^2*Pi^(3*d)*((8 - 6*d + d^2)*s^2 + 2*(12 - 7*d + d^2)*
            s*t - 4*t^2) + (2*Pi)^(3*d)*s*((8 - 6*d + d^2)*s^2 + 
           2*(8 - 6*d + d^2)*s*t - 4*t^2)))) + 
    gZlL^3*gZlLC*(-(gZuR*gZuRC*(2^(2 + 3*d)*ml^4*Pi^(3*d)*
          ((-4 + d)*s + 2*t) - 2^(1 + 3*d)*ml^2*Pi^(3*d)*
          ((8 - 6*d + d^2)*s^2 + 2*(12 - 7*d + d^2)*s*t - 4*t^2) + 
         (2*Pi)^(3*d)*s*((8 - 6*d + d^2)*s^2 + 2*(8 - 6*d + d^2)*s*t - 
           4*t^2))) + gZuL*gZuLC*(2^(2 + 3*d)*ml^4*Pi^(3*d)*
         ((-2 + d)*s - 2*t) + 2^(1 + 3*d)*ml^2*Pi^(3*d)*
         ((8 - 6*d + d^2)*s^2 - 2*(18 - 9*d + d^2)*s*t - 4*t^2) + 
        (2*Pi)^(3*d)*s*(-((8 - 6*d + d^2)*s^2) + 2*(-4 + d)^2*s*t + 
          4*t^2))) + gZlL*gZlR^2*(2^(2 + 3*d)*gZlRC*ml^2*Pi^(3*d)*
       (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) + 
        gZuR*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2)) + 
      gZlLC*(-(gZuR*gZuRC*(2^(2 + 3*d)*ml^4*Pi^(3*d)*((-4 + d)*s + 2*t) - 
