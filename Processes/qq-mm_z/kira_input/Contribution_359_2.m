...
(I*EL^6*gAl*gFFA*gFFZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
 ...
 (I*2^(-1 - 2*d)*EL^6*gAl*gFFA*gFFZ*
  ...
  (Pi^(2*d)*s*(-mz^2 + s)*(-mzC^2 + s)) - 
 (I*EL^6*gAl*gFFA*gFFZ*(-(gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + 
   ...
   (s*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
    ...
    2^(1 + d)*mw^2*Pi^d*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      ...
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*GaugeXi[Q])*userIntegral[A4, 
    {mw*Sqrt[GaugeXi[Q]]}, -1, 1, 1, 0])/(Pi^(2*d)*(mz^2 - s)*s*
   (-mzC^2 + s)) - (I*2^(-1 - 2*d)*EL^6*gAl*gFFA*gFFZ*
 ...
 (I*EL^6*gAl*gFFA*gFFZ*(gZlLC*gZuL*gZuLC*((-2 + d)*s + (-4 + d)*t) + 
    gZlRC*gZuR*gZuRC*((-2 + d)*s + (-4 + d)*t) - 
    gZlRC*gZuL*gZuLC*((-4 + d)*s + (-2 + d)*t) - 
    gZlLC*gZuR*gZuRC*((-4 + d)*s + (-2 + d)*t))*
 ...
 (I*2^(-1 - d)*EL^6*gAl*gFFA*gFFZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
    ...
    (-2 + d)*gZlRC*gZuR*gZuRC)*t*userIntegral[A4, {mw*Sqrt[GaugeXi[Q]]}, 0, 
    1, -1, 0])/(Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)) + 
 (I*2^(-1 - d)*EL^6*gAl*gFFA*gFFZ*
   (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
    gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*
