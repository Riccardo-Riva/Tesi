...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, mw]]*((4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*
    ...
    (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
      (2*mm^2 + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*
      ggmgmZ*(gZlL + gZlR)*mm^2*(-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(-psq + s + t)*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
      (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
      (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
       SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2], SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - 
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
      (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(-psq + s + t)*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(2 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
      (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(psq - t)*
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
      (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*
      ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
       SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*
    ...
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
