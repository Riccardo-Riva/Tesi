...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((I*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gFFA*gFZW*gHFW*gHll*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gFFA*gFZW*gHFW*gHll*
    (gZlL + gZlR)*mm^2*s*sw*(aa*(2*psq - 3*s - 2*t) + 
     bb*(2*mm^2 - 4*psq + 3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
  ...
  (I*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
    sw*(aa*(4*mm^2 + 3*s - 4*t) + bb*(-4*psq - 3*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
   ...
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    (aa*(2*psq - 3*s - 2*t) + bb*(2*mm^2 - 4*psq + 3*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
   ...
   Pi^(2*d) - (I*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
   ...
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*
   ...
   (4^d*Pi^(2*d)) - ((3*I)*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*
    mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/
   (4^d*Pi^(2*d)) + ((3*I)*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*
    mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
