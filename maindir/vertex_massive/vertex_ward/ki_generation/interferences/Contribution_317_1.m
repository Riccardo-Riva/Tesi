 ...
 ((2^(-1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*(-(aa*(2 + d)*gZlR*mm^2) + 
   ...
   Pi^(2*d) + (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*s*
    ...
    (aa*(-1 + d)*gZlR*mm^2 - bb*(-1 + d)*gZlR*mm^2 - 
     aa*(-2 + d)*gZlL*(3*mm^2 + 2*psq) + bb*(-2 + d)*gZlL*(2*mm^2 + 3*psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (EL^5*gWlN*gWNl*gWWA*gWWZ*s*(aa*(-2 + d)*gZlL*(mm^2 - 4*psq)*s + 
     bb*(-2 + d)*gZlL*(4*mm^2 - psq)*s + aa*gZlR*mm^2*
   ...
   (2*Pi)^(2*d) + (EL^5*gWlN*gWNl*gWWA*gWWZ*s*
    (2*aa*(-1 + d)*gZlR*mm^2*(2*psq - s) - 2*bb*(-1 + d)*gZlR*mm^2*
     ...
     bb*(-2 + d)*gZlL*(2*mm^2 + 3*psq)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
  ...
  (EL^5*gWlN*gWNl*gWWA*gWWZ*(-2*bb*(-2 + d)*gZlL*
      (2*psq^2 + mm^2*(2*psq - s)) + 2*aa*(-2 + d)*gZlL*psq*
  ...
  (4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ*psq*(-(aa*(-1 + d)*gZlR*mm^2) + 
     bb*(-1 + d)*gZlR*mm^2 + aa*(-2 + d)*gZlL*(3*mm^2 + 2*psq) - 
     bb*(-2 + d)*gZlL*(2*mm^2 + 3*psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*(bb*(-2 + d)*gZlL*(8*mm^2 + psq)*s - 
  ...
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*
    (aa*(-1 + d)*gZlR*mm^2*(4*psq - 3*s) - bb*(-1 + d)*gZlR*mm^2*
      (4*psq - 3*s) + 2*aa*(-2 + d)*gZlL*(3*mm^2 + 2*psq)*s - 
     2*bb*(-2 + d)*gZlL*(2*mm^2 + 3*psq)*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*(bb*mm^2 - aa*psq)*s*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*(bb*mm^2 - aa*psq)*
