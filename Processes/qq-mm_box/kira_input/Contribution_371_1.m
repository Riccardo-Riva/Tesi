...
(I*2^(-2 - d)*EL^6*gAl*gAu*gFZW^2*(gZlL + gZlR)*(gZuL + gZuR)*(-2*mmv^2 + s)*
 ...
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*gFZW^2*
   (gZlL*gZuL*(2^(1 + d)*mmv^2*Pi^d - 3*d*(2*Pi)^d*s + 
    ...
    {mw*Sqrt[GaugeXi[Q]]}, -1, 0, 1, 0])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*s*
   sw^2) + (I*2^(-3 - 2*d)*EL^6*gAl*gAu*gFZW^2*
 ...
 (I*2^(-2 - d)*EL^6*gAl*gAu*gFZW^2*(gZlL*gZuL*(2*mmv^2 + (-4 + d)*s - 2*t) + 
    gZlR*gZuR*(2*mmv^2 + (-4 + d)*s - 2*t) + 
    gZlR*gZuL*(2*mmv^2 - (-2 + d)*s - 2*t) + 
    gZlL*gZuR*(2*mmv^2 - (-2 + d)*s - 2*t))*userIntegral[A4, 
    {mw*Sqrt[GaugeXi[Q]]}, -1, 1, 1, -1])/(mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) - 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*gFZW^2*
   (gZlR*gZuL*(2^(1 + d)*mmv^2*Pi^d + d*(2*Pi)^d*s + 
      2^(1 + d)*Pi^d*(-2*s + t)) + gZlL*gZuR*(2^(1 + d)*mmv^2*Pi^d + 
      d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
    gZlL*gZuL*(2^(1 + d)*mmv^2*Pi^d - d*(2*Pi)^d*s + 
      2^(1 + d)*Pi^d*(s + t)) + gZlR*gZuR*(2^(1 + d)*mmv^2*Pi^d - 
      d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(s + t)))*(s - 2*mw^2*GaugeXi[Q])*
 ...
 (I*2^(-2 - d)*EL^6*gAl*gAu*gFZW^2*
  ...
  (mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) + 
 (I*2^(-3 - d)*EL^6*gAl*gAu*gFZW^2*(gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
    gZlL*gZuR*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
    gZlL*gZuL*(-2*mmv^2 - (-2 + d)*s + 2*t) + 
    gZlR*gZuR*(-2*mmv^2 - (-2 + d)*s + 2*t))*userIntegral[A4, 
    {mw*Sqrt[GaugeXi[Q]]}, 0, 0, 1, -1])/(mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) - 
   ...
   ((gZlL*(-(2^(1 + d)*gZuL*Pi^d) + 2^(2 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
    ...
    mw^2*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
        ...
        2^(1 + d)*gZuL*Pi^d*((-2 + d)*s + t) + 2^(1 + d)*gZuR*Pi^d*
         (s - d*s + t)))*GaugeXi[Q])*userIntegral[A4, {mw*Sqrt[GaugeXi[Q]]}, 
    0, 0, 1, 0])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*s*sw^2) + 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*gFZW^2*
   (gZlL*(-(2^(1 + d)*gZuL*Pi^d) + 2^(2 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
      d*gZuR*(2*Pi)^d) + gZlR*(2^(2 + d)*gZuL*Pi^d - 2^(1 + d)*gZuR*Pi^d - 
      d*gZuL*(2*Pi)^d + d*gZuR*(2*Pi)^d))*(mmv^2 - t)*
 ...
 (I*2^(-3 - d)*EL^6*gAl*gAu*gFZW^2*(gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
    ...
    gZlL*gZuL*(-2*mmv^2 - (-2 + d)*s + 2*t) + 
    gZlR*gZuR*(-2*mmv^2 - (-2 + d)*s + 2*t))*userIntegral[A4, 
    {mw*Sqrt[GaugeXi[Q]]}, 0, 1, 0, -1])/(mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) - 
 (I*4^(-1 - d)*EL^6*gAl*gAu*gFZW^2*
   ((gZlL*(-(2^(1 + d)*gZuL*Pi^d) + 2^(2 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
        d*gZuR*(2*Pi)^d) + gZlR*(2^(2 + d)*gZuL*Pi^d - 2^(1 + d)*gZuR*Pi^d - 
        d*gZuL*(2*Pi)^d + d*gZuR*(2*Pi)^d))*s*(mmv^2 - t) + 
 ...
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*gFZW^2*
   ((gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
    ...
    4*mw^2*(gZlL*(-(2^(1 + d)*gZuL*Pi^d) + 2^(2 + d)*gZuR*Pi^d + 
        d*gZuL*(2*Pi)^d - d*gZuR*(2*Pi)^d) + 
      gZlR*(2^(2 + d)*gZuL*Pi^d - 2^(1 + d)*gZuR*Pi^d - d*gZuL*(2*Pi)^d + 
        d*gZuR*(2*Pi)^d))*s*(mmv^2 - t)*GaugeXi[Q] - 
 ...
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*gFZW^2*
   (gZlL*gZuL*(2^(1 + d)*mmv^2*Pi^d - 3*d*(2*Pi)^d*s + 
    ...
    {mw, mw*Sqrt[GaugeXi[Q]]}, -1, 0, 1, 0])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*s*
   sw^2) - (I*2^(-3 - 2*d)*EL^6*gAl*gAu*gFZW^2*
   (gZlR*gZuL*(2^(1 + d)*mmv^2*Pi^d + d*(2*Pi)^d*s + 
      2^(1 + d)*Pi^d*(-2*s + t)) + gZlL*gZuR*(2^(1 + d)*mmv^2*Pi^d + 
      d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
 ...
 (I*2^(-2 - d)*EL^6*gAl*gAu*gFZW^2*(gZlL*gZuL*(-2*mmv^2 - (-4 + d)*s + 2*t) + 
    ...
    {mw, mw*Sqrt[GaugeXi[Q]]}, -1, 1, 1, -1])/(mw^2*Pi^d*(mz^2 - s)^2*s*
   sw^2) - (I*2^(-3 - 2*d)*EL^6*gAl*gAu*gFZW^2*
   ((mw^2 - s)*(gZlL*gZuL*(2^(1 + d)*mmv^2*Pi^d - 3*d*(2*Pi)^d*s + 
        2^(1 + d)*Pi^d*(s + d*s + t)) + gZlR*gZuR*(2^(1 + d)*mmv^2*Pi^d - 
        3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(s + d*s + t)) + 
      gZlR*gZuL*(2^(1 + d)*mmv^2*Pi^d + 3*d*(2*Pi)^d*s + 
        2^(1 + d)*Pi^d*(-((2 + d)*s) + t)) + 
 ...
 (I*2^(-3 - d)*EL^6*gAl*gAu*gFZW^2*(gZlR*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
    ...
    {mw, mw*Sqrt[GaugeXi[Q]]}, 0, 0, 1, -1])/(mw^2*Pi^d*(mz^2 - s)^2*s*
   sw^2) + (I*2^(-2 - d)*EL^6*gAl*gAu*gFZW^2*
   ((-((-2 + d)*gZlL*gZuL) + (-4 + d)*gZlR*gZuL + (-4 + d)*gZlL*gZuR - 
      (-2 + d)*gZlR*gZuR)*(mw^2 - s)*(mmv^2 - t) + 
    mw^2*(gZlL*gZuL*((-2 + d)*mmv^2 - (-2 + d)*s - (-4 + d)*t) + 
      gZlR*gZuR*((-2 + d)*mmv^2 - (-2 + d)*s - (-4 + d)*t) + 
      gZlR*gZuL*(-((-4 + d)*mmv^2) + (-4 + d)*s + (-2 + d)*t) + 
 ...
 (I*2^(-3 - d)*EL^6*gAl*gAu*gFZW^2*(gZlR*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
    ...
    gZlL*gZuL*(2*mmv^2 + (-2 + d)*s - 2*t) + 
    gZlR*gZuR*(2*mmv^2 + (-2 + d)*s - 2*t))*userIntegral[A5, 
    {mw, mw*Sqrt[GaugeXi[Q]]}, 0, 1, 0, -1])/(mw^2*Pi^d*(mz^2 - s)^2*s*
   ...
   (gZlR*gZuL*(mmv^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d)*(mw^2 + s) + 
    ...
    gZlL*gZuL*(-(mmv^2*(2^(1 + d)*Pi^d - d*(2*Pi)^d)*(mw^2 + s)) + 
      (2^(1 + d)*Pi^d - d*(2*Pi)^d)*s*t + mw^2*(-(d*(2*Pi)^d*(s + t)) + 
        2^(1 + d)*Pi^d*(s + 2*t))) + 
 ...
 ((I/8)*EL^6*gAl*gAu*gFZW^2*((2^(2 - d)*(gZlL + gZlR)*(gZuL + gZuR))/Pi^d + 
    (gZlL*gZuL*(2*mmv^2 + (-6 + d)*s - 2*t) + 
     ...
     ((2*Pi)^d*s) + (2^(2 - d)*(gZlL + gZlR)*(gZuL + gZuR)*t)/(mw^2*Pi^d) - 
    (2^(2 - d)*(gZlL + gZlR)*(gZuL + gZuR)*(s + t))/(mw^2*Pi^d) + 
    (gZlL*gZuL*(-2*mmv^2 - (-6 + d)*s + 2*t) + 
      gZlR*gZuR*(-2*mmv^2 - (-6 + d)*s + 2*t) + 
      gZlR*gZuL*(-2*mmv^2 + d*s + 2*t) + gZlL*gZuR*(-2*mmv^2 + d*s + 2*t))/
     (mw^2*(2*Pi)^d) + ((gZlR*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
       gZlL*gZuR*(2*mmv^2 - (-4 + d)*s - 2*t) + 
       gZlL*gZuL*(2*mmv^2 + (-2 + d)*s - 2*t) + 
       gZlR*gZuR*(2*mmv^2 + (-2 + d)*s - 2*t))*GaugeXi[Q])/((2*Pi)^d*s))*
   userIntegral[A5, {mw, mw*Sqrt[GaugeXi[Q]]}, 0, 1, 1, -1])/
  ((mz^2 - s)^2*sw^2) + (I*8^(-1 - d)*EL^6*gAl*gAu*gFZW^2*
   (gZlR*gZuL*(2^(3 + 2*d)*mmv^4*mw^2*Pi^(2*d) + mmv^2*(2*Pi)^(2*d)*
       ((-4 + d)*mw^4 + (-4 + d)*s^2 + 2*mw^2*((20 - 13*d + 2*d^2)*s - 
          8*t)) - (2*Pi)^(2*d)*((-4 + d)*mw^4*t + (-4 + d)*s^2*t + 
    ...
    (-((-2 + d)*gZlL*gZuL) + (-4 + d)*gZlR*gZuL + (-4 + d)*gZlL*gZuR - 
      (-2 + d)*gZlR*gZuR)*mw^4*(2*Pi)^(2*d)*(mmv^2 - t)*GaugeXi[Q]^2)*
   userIntegral[A5, {mw, mw*Sqrt[GaugeXi[Q]]}, 0, 1, 1, 0])/
