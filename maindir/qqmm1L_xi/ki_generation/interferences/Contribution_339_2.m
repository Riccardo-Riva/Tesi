...
PropList[KiraPropagator[p1 - q1, 0], KiraPropagator[-p2 - q1, 0]]*
 (((-I)*2^(-1 - 2*d)*EL^6*gAd*gAu*
  ...
  ((I/2)*EL^6*gAd*gAu*((3*2^(1 - 2*d)*(gZdL + gZdR)*
     ...
     (gZdL*gZlR*gZlRC*(d^2*gZuLC*(2*Pi)^d*s^2 + d^2*gZuRC*(2*Pi)^d*s^2 + 
         2^(1 + d)*gZuRC*Pi^d*((6 - 6*d + d^2)*s^2 + 3*(8 - 5*d + d^2)*s*t + 
           6*t^2) + 2^(1 + d)*gZuLC*Pi^d*((24 - 12*d + d^2)*s^2 - 
           3*(-2 - 3*d + d^2)*s*t + 6*t^2)) + gZdR*gZlL*gZlLC*
        (d^2*gZuLC*(2*Pi)^d*s^2 + d^2*gZuRC*(2*Pi)^d*s^2 + 
        ...
        (-(gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((48 - 30*d + 4*d^2)*s^
                2 + 3*(10 - 7*d + d^2)*s*t - 6*t^2))) + 
  ...
  ((3*I)*2^(-1 - 2*d)*EL^6*gAd*gAu*(gZdL + gZdR)*
    (-(gZlR*gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s^2) + d^2*gZuRC*(2*Pi)^d*s^2 + 
       ...
       2^(1 + d)*gZuRC*Pi^d*(4*(-2 + d)*s^2 - (10 - 7*d + d^2)*s*t + 2*t^2) + 
  ...
  ((3*I)*2^(2 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*
    (gZlL*gZlLC*((-2 + d)*gZuLC - (-4 + d)*gZuRC) + 
     gZlR*gZlRC*(-((-4 + d)*gZuLC) + (-2 + d)*gZuRC))*t*
  ...
  ((3*I)*2^(2 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuLC + gZuRC)*SPList[SP[p1, p3], SP[p1, p3]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) - 
  ((3*I)*2^(1 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*
  ...
  ((3*I)*2^(1 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*
   ...
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) + 
  ((3*I)*2^(3 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuLC + gZuRC)*SPList[SP[p1, p3], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) + 
  ((3*I)*2^(1 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*
