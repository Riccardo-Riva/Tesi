...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*
      ...
      mm^6*(aa*(mm^2*(4*psq - 2*s - 4*t) - (2*psq + s)*(psq - t)) - 
    ...
    (I*4^(1 - d)*aa*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*s*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(psq - s - t) + 
       ...
       SP[p1, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
      (aa*(3*mm^2 - 3*psq + s) - bb*(mm^2 - psq + s))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(4*mm^2 - 2*psq - s - 2*t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
      (-2*bb*mm^2*(2*psq - s - 2*t) + bb*(2*psq + s)*(psq - s - t) + 
       aa*(-2*psq^2 - 3*psq*s + s^2 + 2*mm^2*(2*psq + s - 2*t) + 2*psq*t + 
    ...
    (I*2^(3 - 2*d)*bb*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*
    ...
    (I*4^(1 - d)*bb*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*s*
