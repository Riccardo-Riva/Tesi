...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 (((-I)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)^2*s*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d))/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
    gXll^2*mm^2*(mm^2 - psq)^2*(aa*(2*psq + s - 2*t) + 
     bb*(-2*psq + 3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*s*
    (bb*(2*mm^2 + 3*psq - 2*s - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*
    gWWA*gXll^2*mm^2*(mm^2 - psq)^2*(aa*(psq - t) + bb*(-psq + 2*s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*s*
    (bb*(psq - s - t) + aa*(2*mm^2 + psq - s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*
    gWWA*gXll^2*mm^2*(mm^2 - psq)^2*(aa*(psq + s - t) + bb*(-psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*s*
    (aa*(4*psq - s - 4*t) + bb*(-4*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*s*
    (bb*mm^2*(3*psq - 2*s - 3*t) + aa*psq*(psq - t) + bb*psq*(-psq + s + t) + 
     aa*mm^2*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
    gXll^2*mm^2*(mm^2 - psq)*s*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    (bb*(4*mm^2 + 6*psq - 3*s - 2*t) - aa*(2*psq + s - 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*(aa + 3*bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    (bb*(2*psq - 3*s - 2*t) + aa*(4*mm^2 + 2*psq - s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*(3*aa + bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(-1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (aa*(-4*psq^2 + 2*mm^2*(6*psq - s - 6*t) + 4*psq*t - s*(s + 2*t)) + 
     bb*(4*psq^2 - 2*mm^2*(6*psq - 5*s - 6*t) - 4*psq*(2*s + t) + 
       s*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (I*bb*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/(4^d*Pi^(2*d)) + 
  (I*aa*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
    gXll^2*mm^2*(mm^2 - psq)*(bb*(2*mm^2 + 3*psq - 2*s - t) + aa*(-psq + t))*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*s*(-2*psq + s + 2*t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
    gXll^2*mm^2*(mm^2 - psq)*(bb*(psq - s - t) + aa*(2*mm^2 + psq - s + t))*
  ...
  (I*aa*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
   Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*
    gWNl*gWWA*gXll^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
   ...
   Pi^(2*d) + (I*4^(1 - d)*(aa + bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/
   Pi^(2*d) + (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*4^(1 - d)*bb*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*aa*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/
   (2*Pi)^(2*d) - (I*4^(1 - d)*bb*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/
   Pi^(2*d) - ((3*I)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*bb*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  ((3*I)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa + 3*bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
    gXll^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
    gXll^2*mm^2*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
  ...
  (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
    gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(3*aa + bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(2*psq - s - 2*t)*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*bb*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*bb*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*aa*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*aa*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
  ...
  (I*2^(1 - 2*d)*bb*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*aa*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*
    mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) - (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
    ...
    gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*aa*(-2 + d)*EL^5*gWlN*gWNl*
