...
PropList[KiraPropagator[-p3 + q1, mh], KiraPropagator[q2, mz], 
 ...
 ((I*EL^5*gAl*gHll^2*mm^4*(mm^2 - psq)*s*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*mm^2*(mm^2 - psq)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll^2*mm^2*((aa - bb)*(mm^2 - psq)*
      (4*gZlL*gZlR*mm^2*(-2*s + d*(-psq + s + t)) + 
       gZlL^2*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - s - t) - 2*s*(s + t) - 
         psq*((-8 + d)*s + (-2 + d)*t)) + gZlR^2*((-2 + d)*psq^2 + 
         (-2 + d)*mm^2*(psq - s - t) - 2*s*(s + t) - 
         psq*((-8 + d)*s + (-2 + d)*t))) + 
     4*mm^2*(bb*(gZlL*gZlR*(2*(mm^2 - psq)*s + d*mm^2*(3*psq - 2*s - 3*t) + 
  ...
  (I*EL^5*gAl*gHll^2*mm^2*((aa - bb)*(mm^2 - psq)*
      (4*gZlL*gZlR*mm^2*(2*s + d*(-psq + t)) + 
       gZlL^2*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - t) - 2*s*t - 
         psq*(2*s + (-2 + d)*t)) + gZlR^2*((-2 + d)*psq^2 + 
         (-2 + d)*mm^2*(psq - t) - 2*s*t - psq*(2*s + (-2 + d)*t))) + 
     4*mm^2*(-(bb*((-2 + d)*gZlL^2*(psq*(psq - t) + mm^2*(psq - s - t)) + 
       ...
       aa*((-2 + d)*gZlL^2*(mm^2*(psq - t) + psq*(psq - s - t)) + 
         (-2 + d)*gZlR^2*(mm^2*(psq - t) + psq*(psq - s - t)) + 
         gZlL*gZlR*(2*(mm^2 - psq)*s + d*psq*(-psq + s + t) + 
           d*mm^2*(-3*psq + s + 3*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*s*((gZlL^2 + gZlR^2)*(mm^2 - psq)*
     ...
     2*mm^2*(bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*
  ...
  (I*4^(-1 - d)*EL^5*gAl*gHll^2*mm^2*s*
    ...
    SPList[SP[q2, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (3*mm^2 - psq)*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (3*mm^2 - psq)*(bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^2*(2^(1 + 2*d)*(aa - bb)*mm^2*Pi^(2*d)*
      ((-2 + d)*gZlL^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*
        (2*psq - s - 2*t) + 2*gZlL*gZlR*(2*s + d*(-psq + t))) + 
     2^(1 + 2*d)*(aa - bb)*Pi^(2*d)*(4*gZlL*gZlR*mm^2*s - 
       d*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq)*(psq - s - t) + 
       gZlL^2*(2*psq^2 + s*(mm^2 + s + t) - 2*psq*(3*s + t)) + 
  ...
  (I*4^(-1 - d)*EL^5*gAl*gHll^2*mm^2*
    (-(bb*(gZlL^2*(3*(-2 + d)*psq^2 + (-8 + d)*psq*s + 3*(-2 + d)*mm^2*
           (psq - s - t) - 3*(-2 + d)*psq*t + 2*s*(s + t)) + 
        gZlR^2*(3*(-2 + d)*psq^2 + (-8 + d)*psq*s + 3*(-2 + d)*mm^2*
           (psq - s - t) - 3*(-2 + d)*psq*t + 2*s*(s + t)) + 
        4*gZlL*gZlR*mm^2*(4*s + d*(-4*psq + s + 4*t)))) + 
     aa*(gZlL^2*(3*(-2 + d)*psq^2 + (-2 + d)*mm^2*(3*psq + s - 3*t) + 
         6*psq*t - 3*d*psq*(s + t) + 2*s*(s + t)) + 
       gZlR^2*(3*(-2 + d)*psq^2 + (-2 + d)*mm^2*(3*psq + s - 3*t) + 6*psq*t - 
         3*d*psq*(s + t) + 2*s*(s + t)) + 4*gZlL*gZlR*mm^2*
        (4*s + d*(-4*psq + s + 4*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*mm^2*(4*gZlL*gZlR*mm^2*(2*s + d*(-psq + t)) + 
     gZlL^2*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - t) - 2*s*t - 
       psq*(2*s + (-2 + d)*t)) + gZlR^2*((-2 + d)*psq^2 + 
       (-2 + d)*mm^2*(psq - t) - 2*s*t - psq*(2*s + (-2 + d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*
    (gZlL^2 + gZlR^2)*mm^2*(3*mm^2 - psq)*(bb*(2*mm^2 - psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
   Pi^(2*d) - (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
    (bb*(-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^2*(2^(1 + 2*d)*(aa - bb)*Pi^(2*d)*
      (-4*gZlL*gZlR*mm^2*s - d*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq)*
        (psq - t) + gZlL^2*(2*psq^2 - mm^2*s + 2*psq*s - 2*psq*t + s*t) + 
       gZlR^2*(2*psq^2 - mm^2*s + 2*psq*s - 2*psq*t + s*t)) + 
     2^(1 + 2*d)*(aa - bb)*mm^2*Pi^(2*d)*((-2 + d)*gZlL^2*(2*psq - s - 2*t) + 
  ...
  (I*4^(-1 - d)*EL^5*gAl*gHll^2*mm^2*
    (-(bb*(4*gZlL*gZlR*mm^2*(-4*s + d*(-4*psq + 3*s + 4*t)) + 
        gZlL^2*(3*(-2 + d)*psq^2 + (-2 + d)*mm^2*(3*psq - 4*s - 3*t) + 
          2*s*t + psq*(2*s + 6*t - 3*d*t)) + gZlR^2*(3*(-2 + d)*psq^2 + 
          (-2 + d)*mm^2*(3*psq - 4*s - 3*t) + 2*s*t + 
          psq*(2*s + 6*t - 3*d*t)))) + 
     aa*(4*gZlL*gZlR*mm^2*(-4*s + d*(-4*psq + 3*s + 4*t)) + 
       gZlL^2*(3*(-2 + d)*psq^2 + 3*(-2 + d)*mm^2*(psq - t) + 2*s*t + 
         psq*(10*s - 4*d*s + 6*t - 3*d*t)) + 
       gZlR^2*(3*(-2 + d)*psq^2 + 3*(-2 + d)*mm^2*(psq - t) + 2*s*t + 
         psq*(10*s - 4*d*s + 6*t - 3*d*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(-1 - d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*s*
    (bb*(3*(-2 + d)*mm^2 + 10*psq - 3*d*psq - 2*s - 4*t) + 
     aa*(3*(-2 + d)*mm^2 + 2*psq - 3*d*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (bb*((-2 + d)*mm^2 + 4*s - d*s + 2*t - d*t) + 
     aa*((-2 + d)*mm^2 + 4*psq - 2*d*psq - 4*s + d*s - 2*t + d*t))*
