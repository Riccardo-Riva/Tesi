...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
     ...
     (mz^2*(2*Pi)^d*s) - (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
      (gZlL*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
         ...
         2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
           2*t^2)))*SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s) + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mz], 
   ...
   (((-I)*EL^6*gAl^2*gAu^2*(gZlR*(d^3*gZuL*(2*Pi)^d*s*(s - t) - 
         d^3*gZuR*(2*Pi)^d*s*(s - t) + 2^(1 + d)*gZuR*Pi^d*
          ((4 + 6*d - 4*d^2 + d^3)*s^2 + (-32 + 38*d - 14*d^2 + d^3)*s*t + 
           (-20 + 20*d - 8*d^2 + d^3)*t^2) - 2^(1 + d)*gZuL*Pi^d*
          ((-4 + 9*d - 4*d^2 + d^3)*s^2 + (-28 + 39*d - 14*d^2 + d^3)*s*t + 
           (-16 + 22*d - 8*d^2 + d^3)*t^2)) + 
       gZlL*(d^3*gZuR*(2*Pi)^d*s*(s - t) - 2^(1 + d)*gZuR*Pi^d*
          ((-4 + 9*d - 4*d^2 + d^3)*s^2 + (-28 + 39*d - 14*d^2 + d^3)*s*t + 
           (-16 + 22*d - 8*d^2 + d^3)*t^2) + 
         gZuL*(-(d^3*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*
            ((4 + 6*d - 4*d^2 + d^3)*s^2 + (-32 + 38*d - 14*d^2 + d^3)*s*t + 
             (-20 + 20*d - 8*d^2 + d^3)*t^2))))*SPList[SP[p1, q1]])/
     ((2*Pi)^(2*d)*s) - (I*EL^6*gAl^2*gAu^2*t*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   ((I*EL^6*gAl^2*gAu^2*t*(s + t)*(gZlR*gZuL*(-((-4 + d)*s) + 2*t) + 
    ...
    (I*EL^6*gAl^2*gAu^2*t*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
       ...
       SP[q1, q1]])/(mz^2*(2*Pi)^d) + (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*(s + t)*
      (gZlR*gZuR*(2^(1 + d)*Pi^d*(s - 3*t) - d*(2*Pi)^d*(s - t)) + 
       gZlR*gZuL*(-(2^(2 + d)*Pi^d*s) + d*(2*Pi)^d*(s - t)) + 
       gZlL*(-(2^(2 + d)*gZuR*Pi^d*s) + 2^(1 + d)*gZuL*Pi^d*(s - 3*t) - 
         d*gZuL*(2*Pi)^d*(s - t) + d*gZuR*(2*Pi)^d*(s - t)) + 
       2^(1 + d)*Pi^d*(gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s + 
           d*gZuL*t - (-6 + d)*gZuR*t) + gZlL*((-2 + d)*gZuL*s - 
           (-4 + d)*gZuR*s - (-6 + d)*gZuL*t + d*gZuR*t))*GaugeXi[Q] + 
       (gZlR*gZuR*(2^(1 + d)*Pi^d*(s - 3*t) - d*(2*Pi)^d*(s - t)) + 
         gZlR*gZuL*(-(2^(2 + d)*Pi^d*s) + d*(2*Pi)^d*(s - t)) + 
         gZlL*(-(2^(2 + d)*gZuR*Pi^d*s) + 2^(1 + d)*gZuL*Pi^d*(s - 3*t) - 
           d*gZuL*(2*Pi)^d*(s - t) + d*gZuR*(2*Pi)^d*(s - t)))*GaugeXi[Q]^2)*
      SPList[SP[p1, q1], SP[p1, q1], SP[q1, q1]])/
     (mz^2*Pi^(2*d)*s*(-1 + GaugeXi[Q])) - 
    (I*4^(1 - d)*EL^6*gAl^2*gAu^2*t*(s + t)*
     ...
     (mz^2*Pi^(2*d)*s*(-1 + GaugeXi[Q])) + 
    (I*4^(1 - d)*EL^6*gAl^2*gAu^2*(gZlR*(-(d*gZuL*(2*Pi)^d*s^2) + 
         d*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*(-s^2 + 2*s*t + t^2) + 
         2^(1 + d)*gZuL*Pi^d*(2*s^2 + 2*s*t + t^2)) + 
       gZlL*(d*gZuL*(2*Pi)^d*s^2 - d*gZuR*(2*Pi)^d*s^2 + 
         2^(1 + d)*gZuL*Pi^d*(-s^2 + 2*s*t + t^2) + 2^(1 + d)*gZuR*Pi^d*
          (2*s^2 + 2*s*t + t^2)))*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], 
       SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s) + 
    (I*EL^6*gAl^2*gAu^2*(-(gZlR*gZuL*(d*(2*Pi)^d*s*(s + t) + 
          2^(1 + d)*Pi^d*((-6 + d)*s^2 + (-9 + 2*d)*s*t - t^2))) + 
       gZlR*gZuR*(d*(2*Pi)^d*s*(s + t) + 2^(1 + d)*Pi^d*((-3 + d)*s^2 + 
           2*(-3 + d)*s*t + t^2)) + 
       gZlL*(-(gZuR*(d*(2*Pi)^d*s*(s + t) + 2^(1 + d)*Pi^d*((-6 + d)*s^2 + 
              (-9 + 2*d)*s*t - t^2))) + gZuL*(d*(2*Pi)^d*s*(s + t) + 
       ...
       2*(gZlR*(-(d*gZuL*(2*Pi)^d*s*(3*s + 5*t)) + d*gZuR*(2*Pi)^d*s*
         ...
         gZlL*(d*gZuL*(2*Pi)^d*s*(3*s + 5*t) - d*gZuR*(2*Pi)^d*s*
           ...
           2^(1 + d)*gZuR*Pi^d*(6*s^2 + 9*s*t + t^2)))*GaugeXi[Q] + 
       (-(gZlR*gZuL*(d*(2*Pi)^d*s*(s + t) + 2^(1 + d)*Pi^d*((-6 + d)*s^2 + 
              (-9 + 2*d)*s*t - t^2))) + gZlR*gZuR*(d*(2*Pi)^d*s*(s + t) + 
           2^(1 + d)*Pi^d*((-3 + d)*s^2 + 2*(-3 + d)*s*t + t^2)) + 
         gZlL*(-(gZuR*(d*(2*Pi)^d*s*(s + t) + 2^(1 + d)*Pi^d*((-6 + d)*s^2 + 
                (-9 + 2*d)*s*t - t^2))) + gZuL*(d*(2*Pi)^d*s*(s + t) + 
             2^(1 + d)*Pi^d*((-3 + d)*s^2 + 2*(-3 + d)*s*t + t^2))))*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*t^2*
     ...
     (mz^2*Pi^(2*d)*s*(-1 + GaugeXi[Q])) + 
    (I*2^(3 - 2*d)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)*(gZuL + gZuR)*t^2*
      (-(2*Pi)^d + 2^(1 + d)*Pi^d*GaugeXi[Q] - (2*Pi)^d*GaugeXi[Q]^2)*
      SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1]])/
     (mz^2*Pi^(2*d)*s*(-1 + GaugeXi[Q])) - 
    (I*EL^6*gAl^2*gAu^2*t*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
        ...
        GaugeXi[Q] + (gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           2^(1 + d)*gZuR*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZuL*Pi^d*
            ((-1 + d)*s + t)) + gZlR*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
           2^(1 + d)*gZuL*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZuR*Pi^d*
            ((-1 + d)*s + t)))*GaugeXi[Q]^2)*SPList[SP[p2, q1], SP[q1, q1], 
       SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*s*(-1 + GaugeXi[Q])) - 
    (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
    ...
    (I*EL^6*gAl^2*gAu^2*(gZlR*gZuL*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
          ((-6 + d)*s + (-7 + 2*d)*t)) + gZlL*gZuR*(d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*((-6 + d)*s + (-7 + 2*d)*t)) - 
       gZlL*gZuL*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((-3 + d)*s + 
           (-5 + 2*d)*t)) - gZlR*gZuR*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
          ((-3 + d)*s + (-5 + 2*d)*t)) + 
       2*(gZlL*(3*d*gZuL*(2*Pi)^d*s - 3*d*gZuR*(2*Pi)^d*s + 
           ...
           2^(1 + d)*gZuR*Pi^d*(-3*s + (-5 + 2*d)*t)))*GaugeXi[Q] + 
       (gZlR*gZuL*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((-6 + d)*s + 
             (-7 + 2*d)*t)) + gZlL*gZuR*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            ((-6 + d)*s + (-7 + 2*d)*t)) - gZlL*gZuL*(d*(2*Pi)^d*s + 
           2^(1 + d)*Pi^d*((-3 + d)*s + (-5 + 2*d)*t)) - 
         gZlR*gZuR*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((-3 + d)*s + 
             (-5 + 2*d)*t)))*GaugeXi[Q]^2)*SPList[SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*(-1 + GaugeXi[Q])) + 
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
         2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t) + 
       gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
         2*(-3 + d)*gZuR*t))*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p1, q1], 
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(gZlL*((-8 + d)*gZuL*s - (2 + d)*gZuR*s - 
         ...
         2*gZuL*t + 2*gZuR*t))*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], 
       ...
       (2^(1 - 2*d)*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
          ...
          gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
            2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 
              ...
              (8 - 5*d + d^2)*s*t + 2*t^2))))/Pi^(2*d))*(-1 + GaugeXi[Q])*
