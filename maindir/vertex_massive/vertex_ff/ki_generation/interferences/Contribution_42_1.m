...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
   ...
   (-((4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
       (2*gZlL*mm^2*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
          t*(s^2 + 3*s*t + 2*t^2)) + 
        gZlR*(mm^4*(3*psq^2 + 3*t*(s + t) - psq*(s + 6*t)) + 
          psq*(-7*psq^3 + 3*psq^2*(s + 6*t) - psq*t*(11*s + 15*t) + 
            2*t*(s^2 + 3*s*t + 2*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
      (Pi^(2*d)*s)) - (2^(1 - 4*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (-(2^(1 + 2*d)*gZlL*mm^2*Pi^(2*d)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
          psq^2*(s + 6*t) - t*(s^2 + 3*s*t + 2*t^2))) + 
       gZlR*(2*Pi)^(2*d)*(mm^4*(3*psq^2 + 3*t*(s + t) - psq*(s + 6*t)) + 
         psq*(-7*psq^3 + 3*psq^2*(s + 6*t) - psq*t*(11*s + 15*t) + 
           2*t*(s^2 + 3*s*t + 2*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (Pi^(4*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (2*gZlL*mm^2*(2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
         t*(s^2 + 3*s*t + 2*t^2)) + gZlR*(mm^4*(psq - t)^2 + 
         psq*(3*psq^3 - 2*psq^2*(s + 5*t) + psq*t*(8*s + 11*t) - 
           2*t*(s^2 + 3*s*t + 2*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     (Pi^(2*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (-(2^(1 + 2*d)*gZlL*mm^2*Pi^(2*d)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
          psq^2*(s + 6*t) - t*(s^2 + 3*s*t + 2*t^2))) - 
       gZlR*(2*Pi)^(2*d)*(mm^4*(psq - t)^2 + 
         psq*(3*psq^3 - 2*psq^2*(s + 5*t) + psq*t*(8*s + 11*t) - 
           2*t*(s^2 + 3*s*t + 2*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
     (Pi^(4*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (2*gZlL*mm^2*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
         t*(s^2 + 3*s*t + 2*t^2)) + gZlR*(-4*psq^4 - mm^4*psq*s + mm^4*s*t + 
         3*psq^3*(s + 4*t) - 3*psq^2*t*(3*s + 4*t) + 
         2*psq*t*(s^2 + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
     (Pi^(2*d)*s) + (2^(1 - 4*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (-(2^(1 + 2*d)*gZlL*mm^2*Pi^(2*d)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
          psq^2*(s + 6*t) - t*(s^2 + 3*s*t + 2*t^2))) - 
       gZlR*(2*Pi)^(2*d)*(4*psq^4 + mm^4*psq*s - mm^4*s*t - 
         3*psq^3*(s + 4*t) + 3*psq^2*t*(3*s + 4*t) - 
         2*psq*t*(s^2 + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
     (Pi^(4*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*(gZlL - gZlR)*mm^4*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2 - gZlR*(2*mm^2 + psq))*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
       psq^2*(s + 6*t) - t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(mm^2 + psq)*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*s*(-psq + s + t) + gZlR*(2*mm^4*(psq - s - t) - 
         mm^2*(7*psq^2 - 7*psq*s + 2*s^2 - 10*psq*t + 5*s*t + 3*t^2) + 
         psq*(5*psq^2 + s^2 + 4*s*t + 3*t^2 - 4*psq*(s + 2*t))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*(2*psq^2 - 5*psq*s + 3*s^2 - 4*psq*t + 5*s*t + 2*t^2) + 
       gZlR*(2*mm^4*(psq - s - t) - mm^2*(15*psq^2 - 13*psq*s + 4*s^2 - 
           22*psq*t + 11*s*t + 7*t^2) + 3*psq*(5*psq^2 + s^2 + 4*s*t + 
           3*t^2 - 4*psq*(s + 2*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*s*(-2*psq + s + 2*t) + gZlR*(2*mm^2 - s - 2*t)*
        (mm^2*(psq - t) + psq*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*(6*psq^2 - 5*psq*s + s^2 - 12*psq*t + 7*s*t + 6*t^2) + 
       gZlR*(mm^4*(psq - t) - mm^2*(3*psq - s - 3*t)*(psq + t) + 
         psq*(8*psq^2 - 2*psq*s - s^2 - 11*psq*t + 2*s*t + 3*t^2)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(-(gZlL*mm^2*s^2) + 
       gZlR*(2*mm^4*s + mm^2*(6*psq^2 + 3*s^2 + 8*s*t + 6*t^2 - 
           4*psq*(2*s + 3*t)) + 2*(-5*psq^3 + 4*psq^2*(s + 3*t) + 
           t*(s^2 + 3*s*t + 2*t^2) - psq*(s^2 + 8*s*t + 9*t^2))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(-3*gZlL*mm^2*s*(-psq + s + t) + 
       gZlR*(mm^4*s - psq*(psq^2 - 7*psq*s + 3*s^2 - 2*psq*t + 4*s*t + t^2) + 
         mm^2*(5*psq^2 - 11*psq*s + 4*s^2 - 10*psq*t + 7*s*t + 5*t^2)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(4*mm^2 - 6*psq + s + 
       2*t)*(psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(gZlL*mm^2*(-psq + s + t)^2 + 
       gZlR*psq*(5*psq^2 + s^2 + 4*s*t + 3*t^2 - 4*psq*(s + 2*t)) - 
       gZlR*mm^2*(4*psq^2 + s^2 + 3*s*t + 2*t^2 - 3*psq*(s + 2*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*(6*psq^2 - 3*psq*(s + 4*t) + t*(5*s + 6*t)) - 
       gZlR*(mm^4*(psq - t) + mm^2*(psq^2 + 2*psq*s - 4*psq*t + 2*s*t + 
           3*t^2) - psq*(8*psq^2 - 5*psq*s + 2*s^2 - 17*psq*t + 11*s*t + 
           9*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*
      (psq*(psq - s - t)*(s + 2*t) + mm^2*(psq*(s - 2*t) + t*(s + 2*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (-(gZlL*mm^2*(4*psq^2 - 5*psq*s + 2*s^2 - 8*psq*t + 5*s*t + 4*t^2)) + 
       gZlR*(-15*psq^3 + mm^4*s + psq^2*(11*s + 34*t) + 
         2*t*(s^2 + 3*s*t + 2*t^2) + mm^2*(7*psq^2 - 5*psq*s + 3*s^2 - 
           14*psq*t + 9*s*t + 7*t^2) - psq*(3*s^2 + 22*s*t + 23*t^2)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(2*gZlL*mm^2*(-psq + s + t)^2 - 
       gZlR*mm^2*(3*psq^2 - 4*psq*s + 2*s^2 - 6*psq*t + 4*s*t + 3*t^2) + 
       gZlR*psq*(3*psq^2 - 5*psq*s + 2*s^2 - 6*psq*t + 5*s*t + 3*t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlR*psq*(2*psq^2 + 3*psq*s - s^2 - 4*psq*t + s*t + 2*t^2) + 
       2*gZlL*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) - 
       gZlR*mm^2*(6*psq^2 + s^2 + 7*s*t + 6*t^2 - 3*psq*(s + 4*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
       gZlR*(-5*psq^3 + 6*psq^2*(s + 2*t) + t*(s^2 + 3*s*t + 2*t^2) - 
         mm^2*(3*psq^2 - 4*psq*s + s^2 - 6*psq*t + 4*s*t + 3*t^2) - 
         psq*(2*s^2 + 9*s*t + 9*t^2)))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(psq - t)*
      (gZlL*mm^2*(2*psq + s - 2*t) + 3*gZlR*psq*(psq - s - t) + 
       gZlR*mm^2*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*s^2 + gZlR*(-2*psq^3 - 2*mm^2*(psq - t)^2 + 
         2*psq^2*(s + 4*t) + 2*t*(s^2 + 3*s*t + 2*t^2) - 
         psq*(s^2 + 8*s*t + 10*t^2)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlR*mm^2*(3*psq - 2*s - 3*t)*(psq - t) + 3*gZlL*mm^2*s*(-psq + t) + 
       gZlR*psq*(psq^2 - 3*psq*s + 2*s^2 - 2*psq*t + 3*s*t + t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
      mm^2*(mm^2 + psq)*(2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(gZlL*mm^2*(psq - t) + 
       gZlR*psq*(psq - s - t))*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*(4*psq^2 - 3*psq*s + s^2 - 8*psq*t + 3*s*t + 4*t^2) - 
       gZlR*(-psq^3 + psq^2*(s - 2*t) + mm^2*(psq - t)^2 - 
         2*t*(s^2 + 3*s*t + 2*t^2) + psq*(s^2 + 5*s*t + 7*t^2)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(2*gZlL*mm^2*(psq - t)^2 + 
       gZlR*(psq - s - t)*(psq*(psq + s - t) + mm^2*(-psq + t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(2*gZlL*mm^2 - 
       gZlR*(mm^2 + psq))*(2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (-(gZlL*mm^2*(2*psq - s - 2*t)*(psq - t)) + 
       gZlR*(psq^3 - psq^2*s + mm^2*(3*psq - s - 3*t)*(psq - t) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(-2*psq + s + 2*t)*
      (2*psq^2 + mm^2*s + 2*t*(s + t) - psq*(s + 4*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (2*gZlL*mm^2*s*(-2*psq + s + 2*t) + gZlR*(4*psq^3 - 6*psq^2*(s + 2*t) - 
         mm^2*s*(3*s + 4*t) - 2*t*(s^2 + 3*s*t + 2*t^2) + 
         psq*(4*mm^2*s + 3*(s + 2*t)^2)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
      mm^2*(-2*psq + s + 2*t)*(2*psq^2 + mm^2*s + psq*(s - 4*t) + 
       2*t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*(2*psq - s - 2*t) - gZlR*(mm^2 - psq)*(psq - s - t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(2*gZlL*mm^2 - 
       gZlR*(mm^2 + psq))*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*s*(-2*psq + s + 2*t) + gZlR*(-2*psq^3 - mm^2*s*(s + 3*t) + 
         psq^2*(4*s + 6*t) + psq*(3*mm^2*s - 2*s^2 - 7*s*t - 6*t^2) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(3*psq^2 + t*(s + t) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL*mm^2*(-psq + s + t) + 3*gZlR*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(3*psq^2 + t*(s + t) - 
       2*psq*(s + 2*t) + mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(4*psq^2 + t*(s + t) + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(2*mm^2 - 3*psq + s + t)*
     ...
     Pi^(2*d) - (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
      mm^2*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(gZlL*mm^2*(psq - t) + 
       gZlR*psq*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[p2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(-(gZlL*mm^2*s) + 
       gZlR*(-psq^2 - 3*psq*s + 2*mm^2*(psq - t) + t*(s + t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(psq^2 + 2*mm^2*s + 
       t*(s + t) - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(-psq^2 + mm^2*s + 
      ...
      (gZlL*mm^2*(psq - s - t) + 3*gZlR*psq*(psq - s - t) + 
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*(-psq + s + t)*
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], SP[q2, q2]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[p3, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
      mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*
      (psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
      mm^2*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(2*psq - s - 2*t)*
