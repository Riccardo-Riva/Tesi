  ...
  ((2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*
     (-(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(psq - s - t)*
      ...
      gZlL^2*(-(2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 
           4*psq*t + 3*s*t + 2*t^2)) - d*(2*Pi)^(2*d)*s*(psq^2 - 5*psq*t + 
          s*(s + 5*t)) + 2^(1 + 2*d)*Pi^(2*d)*(-((-2 + d)*psq^3) + 
          psq^2*(s + 2*(-2 + d)*t) + s*(s^2 + 5*s*t - 2*(-2 + d)*t^2) + 
          psq*((-2 + d)*s^2 - 5*s*t - (-2 + d)*t^2))) + 
      gZlR^2*(-(2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 
           4*psq*t + 3*s*t + 2*t^2)) - d*(2*Pi)^(2*d)*s*(psq^2 - 5*psq*t + 
          s*(s + 5*t)) + 2^(1 + 2*d)*Pi^(2*d)*(-((-2 + d)*psq^3) + 
          psq^2*(s + 2*(-2 + d)*t) + s*(s^2 + 5*s*t - 2*(-2 + d)*t^2) + 
          psq*((-2 + d)*s^2 - 5*s*t - (-2 + d)*t^2))))*\[Mu]^(8 - 2*d)*
