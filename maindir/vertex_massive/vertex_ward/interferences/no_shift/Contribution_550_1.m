...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p2 + q1, mz], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl*ggpgpA*ggpgpAZ*(gZlL + gZlR)*(mm^2 - psq)*
     (aa*psq + bb*(-psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA*ggpgpAZ*(gZlL + gZlR)*mm^2*
     (2*psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*bb*EL^5*gAl*ggpgpA*ggpgpAZ*(gZlL + gZlR)*(mm^2 - psq)*s*
