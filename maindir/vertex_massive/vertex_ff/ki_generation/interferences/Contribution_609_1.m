...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*(3*mm^2 + psq)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(7*mm^2 + psq)*
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^6*
      (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^2 - psq)*(psq - s - t)*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^2 - psq)*
      (-2*psq^2 + mm^2*(psq - t) + 3*psq*t - t*(s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^4*s + psq*s*(4*psq - s - t) - 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(psq - t)^2*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^2 - psq)*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*(psq - t)*(-6*psq + s + 6*t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq - t)*(psq*(-psq + t) + 
       mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(-4*psq^3 + mm^2*s*(2*s + 3*t) + 
       psq^2*(s + 12*t) + 2*t*(s^2 + 3*s*t + 2*t^2) - 
       psq*(3*mm^2*s + t*(7*s + 12*t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*
      (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq^2 + mm^2*s + (s + t)^2 - 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(2*psq^2 - 3*psq*t + 
       mm^2*(-psq + t) + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(2*psq^2 - 3*psq*t + 
       mm^2*(-psq + t) + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq - t)^2*\[Mu]^(8 - 2*d)*
