...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q1]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
    ...
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
     (psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(psq - t)*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (mm^2 - psq)*(psq - 2*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(psq - t)^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(psq - t)^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], SP[q1, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q2, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*
     (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
