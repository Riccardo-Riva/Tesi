...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((I*4^(-1 - d)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*s*
    ...
    SPList[SP[p1, p2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*
  ...
  (I*4^(-1 - d)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*s*
    ...
    SPList[SP[p2, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*
    gXll*(gZlL - gZlR)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*(psq - t)*
