  ...
  ((2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (gZlL^2*mm^2*(d^2*(2*Pi)^(2*d)*s*(psq^2 + t*(s + 3*t)) + 
      ...
      2*gZlL*gZlR*(s*(d^2*(2*Pi)^(2*d)*psq*(psq^2 + t*(s + t)) + 
          2^(1 + 2*d)*Pi^(2*d)*((14 - 6*d)*psq^3 + 2*psq*t*((11 - 4*d)*s - 
              5*(-3 + d)*t) + psq^2*((-4 + d)*s - (36 - 14*d + d^2)*t) + 
            (-4 + d)*t*(s^2 + 3*s*t + 2*t^2))) - 
        2*mm^2*(2^(1 + 2*d)*Pi^(2*d)*((-2 + 3*d)*psq^3 + 
            psq^2*(4*s + 6*t - 9*d*t) + psq*t*(10*(-1 + d)*s + 
              3*(-2 + 3*d)*t) + t*(4*s^2 + (6 + d^2)*s*t + (2 - 3*d)*t^2)) - 
          d*(2*Pi)^(2*d)*(s*(7*psq^2 + t*(7*s + 13*t)) + 
            d*(psq^3 + 3*psq*t*(s + t) - psq^2*(s + 3*t) - t*(s^2 + t^2))))))*
     ...
     (2*gZlL*gZlR*(d^2*(2*Pi)^(2*d)*psq*s*(psq + s - 9*t) + 
      ...
      gZlR^2*(d^2*(2*Pi)^(2*d)*psq*(5*psq^2 - s^2 + 13*t^2) - 
        (-2 + d)*mm^2*(2*Pi)^(2*d)*((-12 + 7*d)*psq^2 + 
          ...
          (s + t)*((-2 + d)*s^2 - 2*(18 - 9*d + d^2)*s*t - 2*(8 - 5*d + d^2)*
             t^2) + psq*(6*d^2*s*t + 2*t*(43*s + 26*t) + 
            d*(s^2 - 45*s*t - 33*t^2)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (Pi^(4*d)*s) + (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (-4*gZlL*gZlR*(mm^2*(2*Pi)^(2*d)*(psq - s - t)*((-2 + d)^2*psq + 
      ...
      gZlL^2*((-4 + d^2)*mm^2*(2*Pi)^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 
          4*psq*t + 3*s*t + 2*t^2) + 
        2*(2^(1 + 2*d)*Pi^(2*d)*(2*(-1 + d)*psq^3 + s^3 + 11*s^2*t + 
            (12 - 7*d + d^2)*s*t^2 - 2*(-1 + d)*t^3 + 
            psq^2*(-5*(-2 + d)*s - 6*(-1 + d)*t) + 
            psq*(-3*s^2 + 2*(-11 + 6*d)*s*t + 6*(-1 + d)*t^2)) - 
          d*(2*Pi)^(2*d)*(s^2*(-3*psq + s + 11*t) + 
            d*(psq^3 + 3*psq*t*(s + t) - psq^2*(s + 3*t) - 
              t*(s^2 + t^2))))) + gZlR^2*((-4 + d^2)*mm^2*(2*Pi)^(2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (gZlL^2*(-((-2 + d)*mm^2*(2*Pi)^(2*d)*(psq - t)*((-4 + 5*d)*psq - 
         ...
         ((-20 + 13*d)*psq^3 + psq^2*(2*(-7 + 2*d)*s + (56 - 36*d + 7*d^2)*
             t) + psq*(-((-2 + d)*s^2) - 2*(-9 + d)*s*t + (-52 + 33*d)*t^2) + 
          t*((-18 + 7*d)*s^2 + 2*(-2 - d + d^2)*s*t + 2*(8 - 5*d + d^2)*
             t^2))) + gZlR^2*(-((-2 + d)*mm^2*(2*Pi)^(2*d)*(psq - t)*
          ((-4 + 5*d)*psq - 2*(1 + d)*s + (4 - 5*d)*t)) - 
        d^2*(2*Pi)^(2*d)*psq*(5*psq^2 - psq*s + t*(5*s + 13*t)) + 
        2^(1 + 2*d)*Pi^(2*d)*((-20 + 13*d)*psq^3 + 
          psq^2*(2*(-7 + 2*d)*s + (56 - 36*d + 7*d^2)*t) + 
          psq*(-((-2 + d)*s^2) - 2*(-9 + d)*s*t + (-52 + 33*d)*t^2) + 
          t*((-18 + 7*d)*s^2 + 2*(-2 - d + d^2)*s*t + 2*(8 - 5*d + d^2)*
             t^2))) + 2*gZlL*gZlR*(-(d^2*(2*Pi)^(2*d)*psq*s*(psq - 5*t)) + 
        2^(1 + 2*d)*mm^2*Pi^(2*d)*(psq - t)*(2*(-2 + d)^2*psq - 
          (4 - 3*d + d^2)*s - 2*(-2 + d)^2*t) + 2^(1 + 2*d)*Pi^(2*d)*
         ((20 - 16*d + 3*d^2)*psq^3 + psq^2*((22 - 5*d)*s - 
            4*(14 - 11*d + 2*d^2)*t) + t*((22 - 7*d)*s^2 - 2*(-4 - 2*d + d^2)*
             s*t - 2*(8 - 6*d + d^2)*t^2) + psq*((-2 + d)*s^2 + 
            (-30 + d)*s*t + (52 - 40*d + 7*d^2)*t^2))))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (4*gZlL*gZlR*(-(mm^2*(2*Pi)^(2*d)*(psq - t)*((-2 + d)^2*psq + 
        ...
        d*(2*Pi)^(2*d)*(psq*s*(13*psq - 33*t) + d*(3*psq^3 - s*t*(s + 3*t) + 
         ...
         (2*psq - s - 2*t)*(psq - t) + 
        2*(-(2^(1 + 2*d)*Pi^(2*d)*(2*(-1 + d)*psq^3 + 
             psq^2*((-8 + 3*d)*s - 6*(-1 + d)*t) + t*(-7*s^2 + (-6 + d)*s*
                t - 2*(-1 + d)*t^2) + psq*(s^2 + 2*(7 - 2*d)*s*t + 6*(-1 + d)*
                t^2))) + d*(2*Pi)^(2*d)*(s^2*(psq - 5*t) + 
            d*(psq - t)*(psq^2 - 2*psq*t + t*(s + t))))) + 
      gZlR^2*((-4 + d^2)*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t)*(psq - t) + 
        2*(-(2^(1 + 2*d)*Pi^(2*d)*(2*(-1 + d)*psq^3 + 
             psq^2*((-8 + 3*d)*s - 6*(-1 + d)*t) + t*(-7*s^2 + (-6 + d)*s*
                t - 2*(-1 + d)*t^2) + psq*(s^2 + 2*(7 - 2*d)*s*t + 6*(-1 + d)*
                t^2))) + d*(2*Pi)^(2*d)*(s^2*(psq - 5*t) + 
            d*(psq - t)*(psq^2 - 2*psq*t + t*(s + t))))))*\[Mu]^(8 - 2*d)*
      ...
      gZlL^2*(d^2*(2*Pi)^(2*d)*s*(5*mm^2*(psq - t) + psq*(psq - s - t)) + 
        2^(1 + 2*d)*Pi^(2*d)*(4*(-2 + d)*psq^3 + 
          psq^2*((8 - 5*d)*s - 12*(-2 + d)*t) + mm^2*s*((2 + d - d^2)*s + 
            ...
            (-20 + 11*d)*s*t + 12*(-2 + d)*t^2) + 
          (-2 + d)*(s^3 - 6*s*t^2 - 4*t^3))) + 
      gZlR^2*(d^2*(2*Pi)^(2*d)*s*(5*mm^2*(psq - t) + psq*(psq - s - t)) + 
        2^(1 + 2*d)*Pi^(2*d)*(4*(-2 + d)*psq^3 + 
          psq^2*((8 - 5*d)*s - 12*(-2 + d)*t) + mm^2*s*((2 + d - d^2)*s + 
            (-4 + 7*d)*t) + psq*((4 - 7*d)*mm^2*s + 2*(-1 + d)*s^2 + 
            (-20 + 11*d)*s*t + 12*(-2 + d)*t^2) + 
          (-2 + d)*(s^3 - 6*s*t^2 - 4*t^3))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/(Pi^(4*d)*s) + 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*((2 + d)*mm^2 - 2*s)*
        (-2*psq + s + 2*t)) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
       ((2 + d)*mm^2 - 2*s)*(-2*psq + s + 2*t) - 4^(1 + d)*gZlL*gZlR*Pi^(2*d)*
       (mm^2*((-2 + d)^2*psq + (4 - 3*d)*s - (-2 + d)^2*t) + 
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(-2*gZlL*gZlR*mm^2*
      ...
      gZlL^2*(-(s*(d^2*(2*Pi)^(2*d)*psq*(psq^2 + t*(s + t)) + 
        ...
        2*mm^2*(2^(1 + 2*d)*Pi^(2*d)*(-2*(-1 + d)*psq^3 + 
           ...
           (s*(-3*psq^2 + t*(-3*s + t)) + d*(psq - t)*(psq^2 - 2*psq*t + 
              t*(s + t))))) + 
      gZlR^2*(-(s*(d^2*(2*Pi)^(2*d)*psq*(psq^2 + t*(s + t)) + 
        ...
        2*mm^2*(2^(1 + 2*d)*Pi^(2*d)*(-2*(-1 + d)*psq^3 + 
            ...
            t*(5*s^2 + 3*s*t + 2*(-1 + d)*t^2)) + d*(2*Pi)^(2*d)*
           (s*(-3*psq^2 + t*(-3*s + t)) + d*(psq - t)*(psq^2 - 2*psq*t + 
              t*(s + t))))))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*(2*gZlL*gZlR*mm^2*(psq - s - t)*
       ((4 - 6*d + d^2)*mm^2 - 2*(2 - 6*d + d^2)*psq + 8*s - 7*d*s + d^2*s - 
        ...
        mm^2*(2*(-2 - 2*d + d^2)*psq^2 + psq*((-10 + 11*d - 3*d^2)*s + 
            ...
            (-8 + d^2)*t)) + 2*(-2*(-3 + d)*psq^3 + 
          t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
          psq^2*((-5 + d)*s + (-14 + 5*d)*t) + psq*(s^2 + (15 - 4*d)*s*t + 
            2*(5 - 2*d)*t^2))) + gZlR^2*(-((-2 + d)^2*mm^4*(psq - s - t)) + 
        mm^2*(2*(-2 - 2*d + d^2)*psq^2 + psq*((-10 + 11*d - 3*d^2)*s + 
            (12 + 4*d - 3*d^2)*t) + (s + t)*((6 - 5*d + d^2)*s + 
            (-8 + d^2)*t)) + 2*(-2*(-3 + d)*psq^3 + 
          t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
     ...
     (2*gZlL*gZlR*mm^2*(psq - s - t)*(2*(4 - 8*d + d^2)*mm^2 + 
        (-8 + 30*d - 4*d^2)*psq - 4*s - 6*d*s + d^2*s - 14*d*t + 2*d^2*t) + 
      gZlL^2*(-4*(-2 + d)*mm^4*(psq - s - t) + 
        mm^2*(2*(-18 + 5*d + d^2)*psq^2 + (s + t)*((-12 + 2*d + d^2)*s + 
            2*(-14 + 3*d + d^2)*t) - psq*((-32 + 8*d + 3*d^2)*s + 
            4*(-16 + 4*d + d^2)*t)) + 4*(-2*(-3 + d)*psq^3 + 
          t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
          psq^2*((-5 + d)*s + (-14 + 5*d)*t) + psq*(s^2 + (15 - 4*d)*s*t + 
            2*(5 - 2*d)*t^2))) + gZlR^2*(-4*(-2 + d)*mm^4*(psq - s - t) + 
        mm^2*(2*(-18 + 5*d + d^2)*psq^2 + (s + t)*((-12 + 2*d + d^2)*s + 
            2*(-14 + 3*d + d^2)*t) - psq*((-32 + 8*d + 3*d^2)*s + 
            4*(-16 + 4*d + d^2)*t)) + 4*(-2*(-3 + d)*psq^3 + 
          t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
     ...
     (-2*gZlL*gZlR*mm^2*(-((4 - 6*d + d^2)*psq^2) - 2*(-8 + d)*psq*s + 
        (4 - 6*d + d^2)*mm^2*(psq - t) + (4 - 6*d + d^2)*psq*t + 
        (-8 + d)*s*(s + 2*t)) + gZlL^2*((16 - 6*d)*psq^3 + 
        (-2 + d)^2*mm^4*(psq - t) + 2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) + 
        psq*((-2 + d)*s^2 + (20 - 9*d)*s*t + 2*(16 - 7*d)*t^2) + 
        mm^2*(-((12 - 6*d + d^2)*psq^2) + (12 - 5*d)*psq*s + 2*(-3 + d)*s^2 + 
          (20 - 8*d + d^2)*psq*t + (-20 + 7*d)*s*t + 2*(-4 + d)*t^2) + 
        psq^2*(-40*t + d*(s + 16*t))) + gZlR^2*((16 - 6*d)*psq^3 + 
        (-2 + d)^2*mm^4*(psq - t) + 2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) + 
        psq*((-2 + d)*s^2 + (20 - 9*d)*s*t + 2*(16 - 7*d)*t^2) + 
        mm^2*(-((12 - 6*d + d^2)*psq^2) + (12 - 5*d)*psq*s + 2*(-3 + d)*s^2 + 
          (20 - 8*d + d^2)*psq*t + (-20 + 7*d)*s*t + 2*(-4 + d)*t^2) + 
        psq^2*(-40*t + d*(s + 16*t))))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*
     (d^2*(-2*gZlL*gZlR*mm^2*(-3*psq*s + s^2 + 2*mm^2*(psq - t) - 2*psq*t + 
        ...
        gZlR^2*(-(psq^2*s) + mm^4*(psq - t) + mm^2*(3*psq^2 - 3*psq*s + s^2 - 
            7*psq*t + 5*s*t + 4*t^2))) - 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*(-2*(4 - 6*d + d^2)*gZlL*gZlR*mm^2*
      ...
      gZlL^2*(-2*((12 - 4*d + d^2)*psq^3 - t*(s + t)*((-8 + 3*d)*s + 
        ...
        mm^2*(4*(6 - 5*d + d^2)*psq^2 - psq*((8 - 12*d + 3*d^2)*s + 
            ...
            4*d*(s + 5*t)))) + 
      gZlR^2*(-2*((12 - 4*d + d^2)*psq^3 - t*(s + t)*((-8 + 3*d)*s + 
            2*(2 + d)*t) + psq^2*((10 - 3*d)*s - 2*(14 - 3*d + d^2)*t) + 
          psq*(-2*s^2 + (-6 + 2*d + d^2)*s*t + (20 + d^2)*t^2)) + 
        mm^2*(4*(6 - 5*d + d^2)*psq^2 - psq*((8 - 12*d + 3*d^2)*s + 
            8*(6 - 5*d + d^2)*t) + (s + t)*(24*t + d^2*(s + 4*t) - 
            4*d*(s + 5*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*(-2*gZlL*gZlR*mm^2*
      ...
      gZlR^2*(8*(-3 + d)*psq^3 + (8 - 6*d + d^2)*mm^4*(psq - t) - 
        ...
        mm^2*((52 - 24*d + 3*d^2)*psq^2 + 2*(-4 + d)*s^2 + 
          ...
          psq*((4 - 6*d + d^2)*s + (112 - 54*d + 7*d^2)*t))))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*
     (8*d*gZlL*gZlR*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t)) + 
      gZlL^2*(2*(-2 + d)^2*psq^2 + (-12 + 2*d + d^2)*s^2 + 
        4*(2 - 3*d + d^2)*s*t + 2*(-2 + d)^2*t^2 - 4*(-2 + d)*psq*
         ((-1 + d)*s + (-2 + d)*t)) + gZlR^2*(2*(-2 + d)^2*psq^2 + 
        (-12 + 2*d + d^2)*s^2 + 4*(2 - 3*d + d^2)*s*t + 2*(-2 + d)^2*t^2 - 
        4*(-2 + d)*psq*((-1 + d)*s + (-2 + d)*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*(-(d^2*(gZlL - gZlR)^2*mm^2*(psq - t)^2) - 
      2*(8*gZlL*gZlR*mm^2*s*(-psq + t) + gZlL^2*(-2*psq^3 + 3*mm^2*psq*s - 
          psq^2*(s - 6*t) - 3*mm^2*s*t - 2*s^2*t + psq*(s - 6*t)*t + 2*t^3) + 
        gZlR^2*(-2*psq^3 + 3*mm^2*psq*s - psq^2*(s - 6*t) - 3*mm^2*s*t - 
          2*s^2*t + psq*(s - 6*t)*t + 2*t^3)) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*(2*gZlL*gZlR*mm^2*(psq - t)*
      ...
      gZlL^2*(-4*(-2 + d)*psq^3 + 4*t*(s + t)*(2*s + (-2 + d)*t) + 
        ...
        2*psq*t*((2 + 3*d)*s + 6*(-2 + d)*t) - (-2 + d)*mm^2*(psq - t)*
         (2*(3 + d)*psq - 6*t - d*(s + 2*t))))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*(2*gZlL*gZlR*mm^2*(2*(4 - 6*d + d^2)*psq^2 - 
      ...
      gZlR^2*(-2*(-2 + d)*psq^3 + 6*psq^2*(s + (-2 + d)*t) + 
        2*t*(s + t)*(2*s + (-2 + d)*t) + psq*((-2 + d)*s^2 - 2*(3 + d)*s*t - 
          ...
          (-3 + d)*s^2 - 2*(-2 + d)^2*psq*t + (-2 + d)^2*t^2 + s*(t - d*t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - 2*d)*EL^6*gAl^3*gAu*(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
       (-(psq*s) + mm^2*(psq - t))*(psq - t) - 4^(1 + d)*Pi^(2*d)*s*
       (8*gZlL*gZlR*mm^2*(-psq + t) + gZlL^2*(6*psq^2 + 2*mm^2*s + 
          2*t*(s + t) - psq*(s + 8*t)) + gZlR^2*(6*psq^2 + 2*mm^2*s + 
          2*t*(s + t) - psq*(s + 8*t))) - 
    ...
    Pi^(2*d) - (2^(1 - 4*d)*EL^6*gAl^3*gAu*
     (-(2^(1 + 2*d)*(-2 + d)^2*gZlL*gZlR*mm^2*Pi^(2*d)*s*
      ...
      gZlR^2*(d^2*(2*Pi)^(2*d)*s*(psq*(-psq + t) + mm^2*(-psq + s + t)) + 
        2^(1 + 2*d)*Pi^(2*d)*(4*(-2 + d)*psq^3 + 
          psq^2*(d*(s - 12*t) + 24*t) - (s + t)*((-4 + 3*d)*mm^2*s + 
            2*(-2 + d)*t*(s + 2*t)) + psq*((-4 + 3*d)*mm^2*s + 
            t*((-12 + 5*d)*s + 12*(-2 + d)*t)))))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(2^(1 + 2*d)*(-2 + d)^2*gZlL*gZlR*mm^2*
      ...
      gZlR^2*(d^2*(2*Pi)^(2*d)*s*(5*mm^2*(psq - t) + psq*(psq - s - t)) + 
        2^(1 + 2*d)*Pi^(2*d)*(4*(-2 + d)*psq^3 + 
          psq^2*((8 - 5*d)*s - 12*(-2 + d)*t) + mm^2*s*((4 + 2*d - d^2)*s + 
            (-12 + 11*d)*t) - 2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) + 
          psq*((12 - 11*d)*mm^2*s + (-12 + 5*d)*s^2 + (-20 + 11*d)*s*t + 
            12*(-2 + d)*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
      SP[q2, q2]])/(Pi^(4*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*
    ...
    Pi^(2*d) + (2^(1 - 4*d)*EL^6*gAl^3*gAu*
     (-(4^(1 + d)*(-2 + d)^2*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
      gZlL^2*(2*Pi)^(2*d)*((-4 + d)*psq*(2*(-2 + d)*psq - (-6 + d)*s - 
          2*(-2 + d)*t) + mm^2*(4*(6 - 5*d + d^2)*psq + (4 + 6*d - 2*d^2)*s - 
     ...
     (4*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
      gZlL^2*(mm^2*((8 - 6*d + d^2)*psq - 4*(-3 + d)*s - (8 - 6*d + d^2)*t) + 
        psq*((8 - 6*d + d^2)*psq - (20 - 10*d + d^2)*s - 
          (8 - 6*d + d^2)*t)) + 
      gZlR^2*(mm^2*((8 - 6*d + d^2)*psq - 4*(-3 + d)*s - (8 - 6*d + d^2)*t) + 
