...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (-((EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s*\[Mu]^(8 - 2*d))/
    (4^d*Pi^(2*d))) - (4^(1 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*
  ...
  (EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq - s)*
  ...
  (EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(3*mm^2 - 3*psq + s)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(-mm^2 + s + t)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (mm^2 + psq - 2*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*
    ggmgmZ*(gZlL + gZlR)*(-mm^2 + psq + 2*s)*\[Mu]^(8 - 2*d)*
