...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 ((2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-4*psq^3 + (-2 + d)^2*mm^4*s + 
     psq^2*((12 - 4*d + d^2)*s + 8*t) + 2*s*((-2 + d)*s^2 + 4*s*t + 4*t^2) - 
     psq*(7*(-2 + d)*s^2 + 20*s*t + 4*t^2) - 
     mm^2*(12*psq^2 - 3*(-2 + d)*s^2 + 2*psq*((-2 + d)^2*s - 12*t) + 12*s*t + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    (-2*psq^2 + 3*s^2 - d*s^2 + mm^2*(2*psq - d*s - 2*t) - s*t - 2*t^2 + 
     psq*(-5*s + 2*d*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
  ...
  (EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-2 + d)*psq^3 + 2*(-2 + d)*d*mm^4*s + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(4*mm^2 - 4*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    (2*(-2 + d)*mm^2 - (2 + d)*psq + 2*s + 6*t - d*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(2*(-4 + d)*psq + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(8*s + d^2*s - 
     2*d*(psq + 2*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*(2 + d)*psq^2 + 
     mm^2*(2*(2 + d)*psq + (24 - 16*d + d^2)*s - 2*(2 + d)*t) + 
     psq*(-((44 - 20*d + d^2)*s) + 2*(6 + d)*t) - 
     4*((-3 + d)*s^2 + s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq^2 - 3*s^2 + d*s^2 + 
     psq*(5*s - 2*d*s - 4*t) + s*t + 2*t^2 + mm^2*(-2*psq + d*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(psq - t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*(-6 + d)*psq^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq^2 - 2*s^2 + d*s^2 + 
     psq*((3 - 2*d)*s - 4*t) + mm^2*(2*psq + (-2 + d)*s - 2*t) + 3*s*t + 
     2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^2 - 4*psq + s)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^2 - (2 + d)*psq + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^2 + (10 - 3*d)*psq - 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq + s - 2*t)*
  ...
  (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*\[Mu]^(8 - 2*d)*
