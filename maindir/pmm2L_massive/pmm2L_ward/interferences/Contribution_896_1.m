...
PropList[KiraPropagator[-q1, ml], KiraPropagator[q2, mz], 
 ...
 (((-I)*2^(-1 - 2*d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*s*
    ...
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
  ...
  (I*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
    (aa*(mm^2 + psq - s - 2*t) + bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*bb*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(mm^2 - psq)*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*aa*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(mm^2 - psq)*
