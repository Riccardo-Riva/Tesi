...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (-((4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*mm^2*mu^2*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*mm^2*(-8*gZlL*gZlR*(mu^2 + s + t) + 
      gZlL^2*(-4*mu^2 + 3*s + 2*t) + gZlR^2*(-4*mu^2 + 3*s + 2*t))*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*mm^2*(gZlL^2*(-4*mu^2 + s - 2*t) + 
      gZlR^2*(-4*mu^2 + s - 2*t) + 8*gZlL*gZlR*(-mu^2 + t))*
