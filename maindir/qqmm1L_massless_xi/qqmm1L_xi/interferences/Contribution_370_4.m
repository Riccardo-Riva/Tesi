...
PropList[KiraPropagator[p1 - q1, mh], KiraPropagator[-p2 - q1, mz]]*
  ((I*EL^6*gHZZ^2*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gHZZ^2*s*
     ...
     SPList[SP[p1, q1]])/(Pi^(2*d)*(-mzC^2 + s)*(mz^3 - mz*s)^2) + 
   (I*EL^6*gHZZ^2*s*(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
     ...
     (mz^3 - mz*s)^2) + (I*2^(-1 - d)*EL^6*gHZZ^2*
   ...
   (I*2^(-1 - d)*EL^6*gHZZ^2*(gZlL*gZlLC*(gZuR*gZuRC*((-4 + d)*s + 2*t) + 
   ...
   (I*2^(-1 - d)*EL^6*gHZZ^2*
     ...
     SPList[SP[p1, p2], SP[p1, q1]])/(Pi^d*(mzC^2 - s)*(mz^3 - mz*s)^2) + 
   (I*EL^6*gHZZ^2*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
      gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + (-2 + d)*gZuR*gZuRC))*t*
   ...
   (I*EL^6*gHZZ^2*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s*
    ...
    ((2*Pi)^d*(-mzC^2 + s)*(mz^3 - mz*s)^2) + 
   (I*2^(-1 - d)*EL^6*gHZZ^2*(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
   ...
   (I*2^(1 - d)*EL^6*gHZZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*s*\[Mu]^(4 - d)*SPList[SP[p1, p3], 
      SP[p3, q1]])/(Pi^d*(-mzC^2 + s)*(mz^3 - mz*s)^2) + 
   ...
   (I*2^(-1 - d)*EL^6*gHZZ^2*
     ...
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^d*(mzC^2 - s)*(mz^3 - mz*s)^2) - 
   (I*2^(-1 - d)*EL^6*gHZZ^2*(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)) + 
      gZlL*gZlLC*(gZuL*gZuLC*(-((-6 + d)*s) + 2*t) + gZuR*gZuRC*(d*s + 2*t)))*
     \[Mu]^(4 - d)*SPList[SP[p1, q1], SP[p3, q1]])/
    (Pi^d*(mzC^2 - s)*(mz^3 - mz*s)^2) + 
   (I*2^(-1 - d)*EL^6*gHZZ^2*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
   ...
   (I*4^(-1 - d)*EL^6*gHZZ^2*s*
     (-(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
      ...
      gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
           (-s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
          2^(1 + d)*Pi^d*(2*s + 3*t - d*t))))*\[Mu]^(4 - d)*
     SPList[SP[q1, q1]])/(Pi^(2*d)*(-mzC^2 + s)*(mz^3 - mz*s)^2) + 
   (I*2^(-1 - d)*EL^6*gHZZ^2*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
        (-4 + d)*gZuR*gZuRC) + gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + 
