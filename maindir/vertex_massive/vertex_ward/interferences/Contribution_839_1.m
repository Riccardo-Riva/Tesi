...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
  ...
  ((4^(-1 - d)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*s*
   ...
   (EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*(-4*bb*mm^2*psq - aa*s^2 + 
   ...
   (4^(-1 - d)*(aa - bb)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*
   ...
   ((aa - bb)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*(2*psq - s)*
   ...
   ((aa - bb)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*(3*psq - s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) - (2^(-1 - 2*d)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*
  ...
  ((EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*s*
   ...
   (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*s*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (2^(-1 - 2*d)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*
     (gZlL + gZlR)*mm^2*(2*aa*(mm^2*psq + psq^2 + 2*psq*s - s^2) + 
      bb*(-2*psq^2 - 5*psq*s + 2*s^2 + mm^2*(-2*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) + 
   (4^(-1 - d)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*
   ...
   (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*s*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ*gHgmgm*
     gHll*(gZlL + gZlR)*mm^2*(2*mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
   (4^(-1 - d)*(aa - bb)*EL^5*gAl*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*s*
