...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*
   ...
   (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(aa*mm^2*(5*psq - 3*s - 5*t) + 
    ...
    (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*(3*mm^2 + psq)*s*
   ...
   (I*4^(1 - d)*aa*EL^5*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
   (I*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(bb*(psq - s - t) + 
      aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHll^2*mm^4*s*(-2*psq + s + 2*t)*
