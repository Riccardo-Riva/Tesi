...
PropList[KiraPropagator[-q1, mw], KiraPropagator[-q1 - q2, mw], 
 ...
 ((2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA*ggpgpAZ*(gZlL + gZlR)*(mm^2 - psq)*
  ...
  ((aa - bb)*EL^5*gAl*ggpgpA*ggpgpAZ*(gZlL + gZlR)*(mm^2 - psq)*(psq - s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gAl*ggpgpA*ggpgpAZ*(gZlL + gZlR)*
  ...
  (2^(-1 - 2*d)*EL^5*gAl*ggpgpA*ggpgpAZ*(gZlL + gZlR)*
    ...
    SPList[SP[p2, q1]])/Pi^(2*d) - (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA*
    ggpgpAZ*(gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   Pi^(2*d) - (2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*ggpgpA*ggpgpAZ*(gZlL + gZlR)*
