...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, mw]]*((I*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
      ...
      (mh^2*(2*Pi)^(2*d)) + (I*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
     ...
     (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
      ...
      (mh^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
       gHll*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
        SP[q1, q2]])/(mh^2*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*
       gHgmgm*gHll*mm^2*(bb*(psq - 2*s - t) + aa*(2*mm^2 - 3*psq + 2*s + t))*
     ...
     (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
      ...
      (mh^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
       ...
       ggmgmA*gHgmgm*gHll*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
    ...
    (((-I)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(2*aa*mm^2*(psq - 2*s - t) - 
        aa*s*(-3*psq + s + t) + bb*(2*mm^2 + s)*(-psq + s + t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(mh^2*(2*Pi)^(2*d)) - 
     (I*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(aa*(2*mm^2 + s)*(psq - t) - 
