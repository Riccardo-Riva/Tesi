...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*(-2*d*gZlL*gZlR*mm^2 + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*
      ((-2 + d)*gZlL^2*(2*psq^3 - 6*psq^2*t - 
         (s + t)*(mm^2*s + t*(s + 2*t)) + psq*(mm^2*s + 3*t*(s + 2*t))) + 
       (-2 + d)*gZlR^2*(2*psq^3 - 6*psq^2*t - 
         (s + t)*(mm^2*s + t*(s + 2*t)) + psq*(mm^2*s + 3*t*(s + 2*t))) - 
       gZlL*gZlR*(2*psq - s - 2*t)*(2*s^2 + d*(2*psq^2 + 3*mm^2*s + 
           2*t*(s + t) - psq*(s + 4*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
      ((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 - 
       2*gZlL*gZlR*((-4 + d)*mm^2 + s))*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
       psq^2*(s + 6*t) + t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*((-2 + d)*gZlL^2*mm^2 + 
       (-2 + d)*gZlR^2*mm^2 - gZlL*gZlR*(2*(-2 + d)*mm^2 + s))*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
     (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHll^2*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
      ((-2 + d)*gZlL^2*mm^2*(-2*psq^2 + 2*mm^2*s - psq*s + s^2 + 4*psq*t - 
         ...
         3*d*mm^4*s + 2*psq^2*(4*s + (10 + d)*t) + 
         2*t*(s^2 + 3*s*t + 2*t^2) - psq*(2*s^2 + (14 + d)*s*t + 
           (16 + d)*t^2) + mm^2*(-((-4 + d)*psq^2) - 2*(3 + d)*psq*s + 
           2*(-4 + d)*psq*t + (s + t)*((2 + d)*s - (-4 + d)*t))))*
    ...
    (4^(1 - d)*d*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^4*(2*psq^2 - 3*psq*s + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gHll^2*mm^2*(psq - t)*
      (gZlL^2*mm^2*s + gZlR^2*mm^2*s - gZlL*gZlR*(3*mm^2*(psq - t) + 
         psq*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (gZlL^2*mm^2*s^2 + gZlR^2*mm^2*s^2 - 2*gZlL*gZlR*
        (2*psq^3 + 2*mm^2*(psq - t)^2 - 2*psq^2*(s + 4*t) - 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (-((-2 + d)*gZlL^2*mm^2*(2*psq - 3*s - 2*t)*(psq - t)) - 
       ...
       2*gZlL*gZlR*(-((psq - t)*(d*psq*(psq - t) - 2*(2*psq - s - 2*t)*
           ...
           (-4 + 3*d)*t^2 - psq*(2*s + 3*d*s - 8*t + 6*d*t))))*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (2*gZlL^2*mm^2*((-2 + d)*psq^2 + s^2 + (-2 + d)*s*t + (-2 + d)*t^2 - 
       ...
       gZlL*gZlR*(d*(psq - t)*(psq*(psq - t) + mm^2*(-5*psq + 4*s + 5*t)) + 
         2*(-2*psq^3 + 6*psq^2*t + mm^2*s*(-s + t) + 
           t*(s^2 + 3*s*t + 2*t^2) - psq*(mm^2*s + 3*t*(s + 2*t)))))*
    ...
    (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*(-psq + s + t)^2*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*
    ...
    (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*
