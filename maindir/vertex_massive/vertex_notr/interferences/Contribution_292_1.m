...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 2*d)*EL^6*gAl^4*mm^2*
  ...
  (2^(1 - 2*d)*EL^6*gAl^4*(4*d*gZlL*gZlR*mm^2*(-mm^2 + psq) + 
  ...
  (EL^6*gAl^4*(2^(1 + 2*d)*(-16 + 24*d - 10*d^2 + d^3)*gZlL*gZlR*mm^2*
      Pi^(2*d) - (-2 + d)*gZlL^2*(2*Pi)^(2*d)*((2 - 6*d + d^2)*mm^2 + 
       (26 - 4*d)*psq + 2*(-6 + d)*s) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
      ((2 - 6*d + d^2)*mm^2 + (26 - 4*d)*psq + 2*(-6 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/(2*Pi)^(4*d) + 
  (EL^6*gAl^4*(4^(2 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d) + 
  ...
  (4^(1 - d)*(-2 + d)*EL^6*gAl^4*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (Pi^(2*d)*s) + (EL^6*gAl^4*(4^(2 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d) + 
