...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (((-I)*2^(-1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWAA*
   ...
   (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWAA*(bb*(psq - s - t) + 
      aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*EL^5*gWlN*gWNl*gWWA*gWWAA*(aa*((10 - 6*d)*mm^2 + (-12 + 7*d)*psq - 
        (-2 + d)*(5*s + t)) + bb*((-6 + 4*d)*mm^2 + (8 - 5*d)*psq + 
   ...
   (I*EL^5*gWlN*gWNl*gWWA*gWWAA*(bb*((10 - 6*d)*mm^2 + (-8 + 5*d)*psq - 
        (-2 + d)*(4*s - t)) + aa*((-6 + 4*d)*mm^2 + (4 - 3*d)*psq + 
