...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (((-I)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*s^2*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) + 
  ((7*I)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*s*
  ...
  (I*4^(-1 - d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s^2*
    (aa*(-mm^2 + s + t) - bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpA^2*
    ggpgpZ*(gZlL + gZlR)*mm^2*s*(-3*psq + s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*
    (gZlL + gZlR)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*4^(-1 - d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s^2*
    (aa*(2*mm^2 - psq - t) + bb*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpA^2*
    ggpgpZ*(gZlL + gZlR)*mm^2*s*(-3*psq + 2*s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) - (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*
    ggpgpZ*(gZlL + gZlR)*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*
   ...
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*(3*mm^2 - psq - 2*t) + 
     bb*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*
    (gZlL + gZlR)*(aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) - (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*
  ...
  (I*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*(mm^2 - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(bb*(psq - t) + 
    ...
    ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
