...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
     ...
     gWNl*gXll^2*mm^2*(mm^2 - psq)*(psq - t)^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
     (psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
     (4*psq^3 - mm^2*psq*s + mm^2*s*t - psq^2*(s + 12*t) + 
      psq*t*(7*s + 12*t) - 2*t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*
     gWNl*gXll^2*mm^2*(mm^2*(psq - t) + t*(-psq + s + t))*\[Mu]^(8 - 2*d)*
