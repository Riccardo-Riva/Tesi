...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((4^(1 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^4*
     mu^2)/(Pi^(2*d)*s) + (3*4^(1 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gHgpgp*
     gHll*(gZlL + gZlR)*mm^4*mu^2*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (3*4^(1 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^4*
