...
PropList[KiraPropagator[-p1 + q1, mw]]*
  (((-I)*2^(-1 - d)*EL^6*gAl*gAu*gWWZZ*
     ...
     GaugeXi[Q]) - (I*EL^6*gAl*gAu*gWWZZ*\[Mu]^(4 - d)*
     (s*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 2*(-3 + d)*gZuL*t - 
      ...
      (-(gZlR*gZuL*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*t - 4*t^2)) - 
       ...
       GaugeXi[Q])*SPList[SP[p1, q1]])/(mw^2*(2*Pi)^d*(mz^2 - s)^2*s*
     ...
     GaugeXi[Q]) + (I*EL^6*gAl*gAu*gWWZZ*
     ...
     SPList[SP[p1, p2], SP[p1, p2]])/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s*
     GaugeXi[Q]) - (I*EL^6*gAl*gAu*gWWZZ*
    ...
    (mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s*GaugeXi[Q]) - 
   (I*EL^6*gAl*gAu*gWWZZ*(-(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
   ...
   (I*EL^6*gAl*gAu*gWWZZ*(gZlR*(3*d*gZuL*(2*Pi)^d*s - 3*d*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuR*Pi^d*(s + d*s + t) + 2^(1 + d)*gZuL*Pi^d*
         (-((2 + d)*s) + t)) + gZlL*(3*d*gZuR*(2*Pi)^d*s - 
        2^(1 + d)*gZuR*Pi^d*((2 + d)*s - t) + 
        gZuL*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(s + d*s + t))))*\[Mu]^(4 - d)*
    ...
    (mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s*GaugeXi[Q]) - 
   (I*2^(1 - d)*EL^6*gAl*gAu*gWWZZ*(gZlL + gZlR)*(gZuL + gZuR)*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p1, p3], SP[p1, p3]])/
    (mw^2*Pi^d*(mz^2 - s)^2*GaugeXi[Q]) + 
   (I*EL^6*gAl*gAu*gWWZZ*
   ...
   (I*EL^6*gAl*gAu*gWWZZ*(gZlR*(3*d*gZuL*(2*Pi)^d*s - 3*d*gZuR*(2*Pi)^d*s + 
    ...
    (mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s*GaugeXi[Q]) + 
   (I*2^(2 - d)*EL^6*gAl*gAu*gWWZZ*(gZlL + gZlR)*(gZuL + gZuR)*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p1, p3], SP[p3, q1]])/
    (mw^2*Pi^d*(mz^2 - s)^2*GaugeXi[Q]) + 
   (I*EL^6*gAl*gAu*gWWZZ*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
      (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p1, q1]])/
    (mw^2*(2*Pi)^d*(mz^2 - s)^2*s*GaugeXi[Q]) + 
   (I*EL^6*gAl*gAu*gWWZZ*(-(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
         2^(1 + d)*gZuR*Pi^d*(s - d*s - (-3 + d)*t) + 2^(1 + d)*gZuL*Pi^d*
          ((-2 + d)*s + (-3 + d)*t))) + gZlL*(-(d*gZuL*(2*Pi)^d*s) + 
        d*gZuR*(2*Pi)^d*s - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s + (-3 + d)*t) + 
   ...
   (I*EL^6*gAl*gAu*gWWZZ*
    ...
    (mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s*GaugeXi[Q]) + 
   (I*EL^6*gAl*gAu*gWWZZ*(gZlL*(-(2^(1 + d)*gZuL*Pi^d) + 
     ...
     SPList[SP[p2, q1], SP[p2, q1]])/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s*
     GaugeXi[Q]) - (I*EL^6*gAl*gAu*gWWZZ*
     (gZlR*(3*d*gZuL*(2*Pi)^d*s - 3*d*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuR*Pi^d*(s + d*s + t) + 2^(1 + d)*gZuL*Pi^d*
         (-((2 + d)*s) + t)) + gZlL*(3*d*gZuR*(2*Pi)^d*s - 
 ...
 PropList[KiraPropagator[-p1 + q1, mw*Sqrt[GaugeXi[Q]]]]*
  ((I*EL^6*gAl*gAu*gWWZZ*\[Mu]^(4 - d)*
   ...
   (I*EL^6*gAl*gAu*gWWZZ*
     ...
     \[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p3, q1]])/
    (mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s*GaugeXi[Q]) + 
   (I*EL^6*gAl*gAu*gWWZZ*(gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 
