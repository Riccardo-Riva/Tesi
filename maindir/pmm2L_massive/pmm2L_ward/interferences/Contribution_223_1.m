...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*s*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (aa*(4*psq^2 + 2*mm^2*(2*psq - 5*s - 2*t) + 4*psq*(s - t) + 
       s*(s + 2*t)) - bb*(4*psq^2 + mm^2*(4*psq + 6*s - 4*t) - 
       4*psq*(3*s + t) + s*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*s*
    (aa*(2*psq - 3*s - 2*t) + bb*(2*mm^2 - 4*psq + 3*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (aa*(2*psq^2 + psq*(s - 2*t) + 2*mm^2*(psq - 2*s - t) + s*(s + t)) - 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*s*
    ...
    gHll*mm^2*(-(aa*(2*psq^2 + 3*psq*s + 2*mm^2*(psq - 3*s - t) - 2*psq*t + 
        s*t)) + bb*(2*psq^2 - 5*psq*s + 2*mm^2*(psq + s - t) - 2*psq*t + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (aa*(4*psq - 7*s - 4*t) + bb*(4*mm^2 - 8*psq + 7*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
  ...
  (I*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (aa*(2*psq - 3*s - 2*t) + bb*(2*mm^2 - 4*psq + 3*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
    (aa*(psq - 2*s - t) + bb*(mm^2 - 2*psq + 2*s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*(aa*(psq - s - t) + 
  ...
  (I*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*(aa*(2*mm^2 + s - 2*t) - 
   ...
   (2*Pi)^(2*d) - (I*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
