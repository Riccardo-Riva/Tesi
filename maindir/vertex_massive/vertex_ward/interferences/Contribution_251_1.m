...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   ((I*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*(bb*psq*(psq - t) + 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*psq*s*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*(bb*(psq - s - t) + 
       aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q2]])/Pi^(2*d) + (I*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*
    ...
    (I*2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*(bb*(psq - s - t) + 
       ...
       SP[p3, q1]])/Pi^(2*d) - (I*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
     (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*
      (bb*(mm^2 - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*psq*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(bb*(psq - s - t) + 
       aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2], SP[p3, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2], SP[q2, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*psq*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(bb*(mm^2 - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(bb*(mm^2 + psq - s - 2*t) + 
       aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(2*psq - s - 2*t)*
    ...
    (I*4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(bb*(mm^2 - t) + 
       ...
       SP[p3, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
       SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*
