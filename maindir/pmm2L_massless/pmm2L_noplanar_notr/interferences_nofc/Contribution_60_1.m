...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(6 - 5*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gZlL*gZNL*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
     ((-128 + 72*d - 14*d^2 + d^3)*s^2 + 4*(16 - 10*d + d^2)*s*t + 
      4*(16 - 10*d + d^2)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     gWlN*gWNl*gZlL*gZNL*((20 - 8*d + d^2)*s^2 + 4*(-4 + d)*s*t + 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*(s + t)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(12 - 8*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gZlL*gZNL*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*(6 - 5*d + d^2)*EL^8*gAl^2*
     ...
     gWNl*gZlL*gZNL*(d*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*(s + t)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
     ...
     gZlL*gZNL*(2*d*(s - 5*t) + 36*t + d^2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*t*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
     (4*s + (20 - 8*d + d^2)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(36 - 14*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gZlL*gZNL*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*(s + t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
     ((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gZlL*gZNL*(2*(-2 + d)*s - (20 - 10*d + d^2)*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*t*
   ...
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*
     ...
     gWNl*gZlL*gZNL*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*(12 - 8*d + d^2)*EL^8*gAl^2*
