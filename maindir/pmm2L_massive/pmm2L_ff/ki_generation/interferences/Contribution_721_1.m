...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   ((2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
    ...
    (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
      (mm^2 - psq)*(-4*psq^2 - s^2 + 2*mm^2*(psq - s - t) - 3*s*t - 2*t^2 + 
       3*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
      (mm^2 - psq)*(-psq^2 + mm^2*(psq - t) - s*(s + t) + psq*(4*s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
     ...
     Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
      (2*psq - s - 2*t)*(psq^2 - mm^2*s + psq*(s - 2*t) + t*(s + t))*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq + s)*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
      ...
      gWNl*gXll^2*mm^2*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[q1, q1]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*
