...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(mm^2 - psq)*
     (-2*psq^2 + 3*s^2 - d*s^2 + mm^2*(2*psq - d*s - 2*t) - s*t - 2*t^2 + 
      psq*(-5*s + 2*d*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(2*psq^2 - 3*s^2 + d*s^2 + 
      psq*(5*s - 2*d*s - 4*t) + s*t + 2*t^2 + mm^2*(-2*psq + d*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(mm^2 - psq)*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(2*psq^2 - 2*s^2 + d*s^2 + 
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(4*mm^2 - 4*psq + s)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*
     (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*
     (2*(-2 + d)*mm^2 - (2 + d)*psq + 2*s + 6*t - d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(2*(-2 + d)*mm^2 - (2 + d)*psq + 
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(2*(-2 + d)*mm^2 + 
      (10 - 3*d)*psq - 4*s + d*s - 6*t + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(2*(-2 + d)*mm^2 + 
      (10 - 3*d)*psq - 4*s + d*s - 6*t + d*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*(psq - t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gFll^2*mm^2*\[Mu]^(8 - 2*d)*
