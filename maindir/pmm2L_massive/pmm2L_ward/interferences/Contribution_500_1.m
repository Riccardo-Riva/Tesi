...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((I*2^(-3 - 2*d)*(aa - bb)*(2 + d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*mm^2*
    (6*(-1 + d)*psq - (2 + d)*s - 6*(-1 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/Pi^(2*d) + (I*2^(-3 - 2*d)*EL^5*gAl*gWWA*gWWAZ*
    (gZlL + gZlR)*(-(aa*(-6*(-3 + 2*d)*psq^2 - 5*(-2 + d)*psq*s + 
        6*(-3 + 2*d)*psq*t + d*s*(s + t) + 2*mm^2*((-9 + 8*d)*psq + 
          (-5 + d)*s + (9 - 8*d)*t))) + 
     bb*(-6*(-3 + 2*d)*psq^2 + (2 + d)*psq*s + 6*(-3 + 2*d)*psq*t + 
       d*s*(s + t) + 2*mm^2*((-9 + 8*d)*psq - s - 2*d*s + 9*t - 8*d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*mm^2*
    (6*(-1 + d)*psq - (2 + d)*s - 6*(-1 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gWWA*
    gWWAZ*(gZlL + gZlR)*mm^2*(6*(-1 + d)*psq + (8 - 5*d)*s - 6*(-1 + d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-3 - 2*d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
    (-(bb*(-6*(-3 + 2*d)*psq^2 + (-28 + 15*d)*psq*s + 6*(-3 + 2*d)*psq*t + 
        d*s*t + 2*mm^2*((-9 + 8*d)*psq + 14*s - 9*d*s + 9*t - 8*d*t))) + 
     aa*(-6*(-3 + 2*d)*psq^2 + (-20 + 9*d)*psq*s + 6*(-3 + 2*d)*psq*t + 
       d*s*t + 2*mm^2*((-9 + 8*d)*psq + 10*s - 6*d*s + 9*t - 8*d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*mm^2*
    (6*(-1 + d)*psq + (8 - 5*d)*s - 6*(-1 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + (I*2^(-3 - 2*d)*EL^5*gAl*gWWA*gWWAZ*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa + bb)*(-3 + 2*d)*EL^5*gAl*
    gWWA*gWWAZ*(gZlL + gZlR)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWWA*
    gWWAZ*(gZlL + gZlR)*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
    (bb*((6 - 4*d)*mm^2 + (-4 + 3*d)*psq - (-2 + d)*(4*s - t)) + 
     aa*(2*(-5 + 3*d)*mm^2 + (8 - 5*d)*psq + (-2 + d)*(4*s - t)))*
  ...
  (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
    (aa*((6 - 4*d)*mm^2 + (-8 + 5*d)*psq - (-2 + d)*(5*s + t)) + 
     bb*(2*(-5 + 3*d)*mm^2 + (12 - 7*d)*psq + (-2 + d)*(5*s + t)))*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gWWA*gWWAZ*(gZlL + gZlR)*
