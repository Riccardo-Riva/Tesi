...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, mm]]*((I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
       (mm^2 - psq)*s*(aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d))/
      (mh^2*Pi^(2*d)) - (I*4^(2 - d)*EL^5*gAl^3*gHll^2*mm^4*
       (-(bb*(psq^2 - psq*(s + t) + s*(-mm^2 + s + t))) + 
        aa*(psq^2 + s*(mm^2 + s + t) - psq*(3*s + t)))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1]])/(mh^2*Pi^(2*d)) + 
     (I*4^(2 - d)*EL^5*gAl^3*gHll^2*mm^4*(2*bb*mm^2*(psq - t) + 
     ...
     (I*2^(5 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(bb*(psq - s - t) + 
        ...
        SP[p1, q1]])/(mh^2*Pi^(2*d)) + (I*2^(5 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
       (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)) - 
     (I*2^(5 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(bb*(mm^2 + psq - s - 2*t) + 
     ...
     (I*2^(5 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(bb*(psq - t) + 
        aa*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
        SP[p2, q1]])/(mh^2*Pi^(2*d)) + (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^3*
       gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
      (mh^2*Pi^(2*d)) - (I*2^(5 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
    ...
    (((-I)*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)*s*
