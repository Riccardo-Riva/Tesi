...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 (((-I)*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*
    (bb*(-((-2 + d)*mm^4*(psq - s - t)) - (-2 + d)*psq^2*(psq - s - t) + 
       2*mm^2*((2 + d)*psq^2 - (2 + d)*psq*(s + t) + s*(s + 2*t))) + 
     aa*((-2 + d)*mm^4*(psq - t) + (-2 + d)*psq^2*(psq - t) - 
       2*mm^2*((2 + d)*psq^2 + s*(s + 2*t) - psq*(4*s + (2 + d)*t))))*
    \[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (aa*(2*(-2 + d)*psq^3 + 2*psq*s^2 + (-2 + d)*psq^2*(s - 2*t) + 
       (-2 + d)*mm^4*(2*psq + s - 2*t) - s^2*(s + 2*t) - 
       2*mm^2*(2*(2 + d)*psq^2 + (-8 + d)*psq*s - 2*(2 + d)*psq*t + 
         s*(s + 2*t))) + bb*(-2*(-2 + d)*psq^3 - 2*psq*s^2 - 
       (-2 + d)*mm^4*(2*psq - 3*s - 2*t) + s^2*(s + 2*t) + 
       (-2 + d)*psq^2*(3*s + 2*t) + 2*mm^2*(2*(2 + d)*psq^2 + s*(s + 2*t) - 
         psq*(3*d*s + 4*t + 2*d*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (2*mm^2 - s)*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*
    (aa*((2 + d)*mm^2 - (-2 + d)*psq)*(psq - t) + 
     bb*(-2*(-2 + d)*mm^4 + (-2 + d)*psq*(3*psq - 2*s - t) + 
       mm^2*(-((2 + d)*psq) + 2*(-2 + d)*s + (2 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*
    mm^2*(bb*(-((-2 + d)*psq^3) - 3*psq*s^2 - (-2 + d)*mm^4*(psq - 2*s - t) + 
       s^2*(s + t) + (-2 + d)*psq^2*(2*s + t) + 
       2*mm^2*((2 + d)*psq^2 + s*(s + t) + psq*(s - 2*d*s - (2 + d)*t))) + 
     aa*((-2 + d)*psq^3 + 3*psq*s^2 + (-2 + d)*mm^4*(psq - t) - 
       (-2 + d)*psq^2*t - s^2*(s + t) - 2*mm^2*((2 + d)*psq^2 + s*(s + t) - 
         psq*(3*s + (2 + d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (2*mm^2 - s)*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*
    (bb*((2 + d)*mm^2 - (-2 + d)*psq)*(psq - s - t) + 
     aa*(2*(-2 + d)*mm^4 - (-2 + d)*psq*(psq - s + t) + 
       mm^2*(-((2 + d)*psq) - (-6 + d)*s + (2 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*
    mm^2*(aa*((-2 + d)*psq^3 - psq*s^2 + (-2 + d)*psq^2*(s - t) + 
       (-2 + d)*mm^4*(psq + s - t) - s^2*t - 
       2*mm^2*((2 + d)*psq^2 + (-5 + d)*psq*s - (2 + d)*psq*t + s*t)) + 
     bb*(-((-2 + d)*psq^3) + psq*s^2 - (-2 + d)*mm^4*(psq - s - t) + s^2*t + 
       (-2 + d)*psq^2*(s + t) + 2*mm^2*((2 + d)*psq^2 + s*t - 
         psq*(s + d*s + 2*t + d*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   Pi^(2*d) + (I*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*
    (bb*(-2 + d)*psq*(4*psq - 3*s - 4*t) - aa*(-2 + d)*psq*
      (4*psq - s - 4*t) + aa*mm^2*(4*(2 + d)*psq - (6 + d)*s - 4*(2 + d)*t) + 
     bb*mm^2*(-4*(2 + d)*psq + (2 + 3*d)*s + 4*(2 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*mm^2 - s)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*(aa*(-2 + d)*psq*(psq - t) - 
     bb*(-2 + d)*psq*(psq - s - t) + bb*mm^2*((2 + 3*d)*psq - 2*d*s - 2*t - 
       3*d*t) + aa*mm^2*(-((2 + 3*d)*psq) + (2 + d)*s + (2 + 3*d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*((2 + d)*mm^2 - (-2 + d)*psq)*s*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*mm^2 - s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (bb*(4*(-2 + d)*mm^4 - 6*(-2 + d)*psq^2 + 2*s^2 + 
       (-2 + d)*psq*(3*s + 2*t) + mm^2*(2*(2 + d)*psq - 3*(-2 + d)*s - 
         2*(2 + d)*t)) + aa*(2*(-2 + d)*psq^2 - 2*s^2 + 
       (-2 + d)*psq*(s - 2*t) + mm^2*(-2*(2 + d)*psq - (-2 + d)*s + 
         2*(2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
   Pi^(2*d) - (I*EL^5*gAl^2*gFFA*gFll^2*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*mm^2 - s)*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (bb*(-2*(-2 + d)*psq^2 - 2*s^2 + (-2 + d)*psq*(3*s + 2*t) + 
       mm^2*(2*(2 + d)*psq - (2 + 3*d)*s - 2*(2 + d)*t)) + 
     aa*(4*(-2 + d)*mm^4 - 2*(-2 + d)*psq^2 + 2*s^2 + 
       (-2 + d)*psq*(s - 2*t) + mm^2*(-2*(2 + d)*psq - (-10 + d)*s + 
  ...
  (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(-(aa*(-2 + d)*psq*(psq - t)) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*mm^2 - s)*
   ...
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (2*bb*mm^2*((4 + 6*d)*psq + (2 - 5*d)*s - 2*(2 + 3*d)*t) + 
     2*aa*mm^2*(-2*(2 + 3*d)*psq + (6 + d)*s + 2*(2 + 3*d)*t) + 
     aa*(-2 + d)*(4*psq^2 - 4*psq*t + s*(s + 2*t)) - 
     bb*(-2 + d)*(4*psq^2 - 4*psq*(2*s + t) + s*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*((2 + d)*mm^2 - (-2 + d)*psq)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (aa*(2*(-2 + d)*mm^4 - (-2 + d)*psq^2 + 2*s^2 - (-2 + d)*psq*t + 
       mm^2*(-((2 + d)*psq) + 4*s + (2 + d)*t)) + 
     bb*(-((-2 + d)*psq^2) - 2*s^2 + (-2 + d)*psq*(2*s + t) + 
       mm^2*((2 + d)*psq - 2*t - d*(2*s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (aa*(-4*(-2 + d)*psq^2 - 2*s^2 + (-2 + d)*psq*(s + 4*t) + 
       mm^2*(4*(2 + d)*psq - (6 + d)*s - 4*(2 + d)*t)) + 
     bb*(4*(-2 + d)*psq^2 + 2*s^2 - (-2 + d)*psq*(5*s + 4*t) + 
       mm^2*(-4*(2 + d)*psq + (-2 + 5*d)*s + 4*(2 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*mm^2 - s)*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (bb*mm^2*((4 + 6*d)*psq + (4 - 6*d)*s - 2*(2 + 3*d)*t) + 
     aa*mm^2*(-2*(2 + 3*d)*psq + 2*(2 + d)*s + 2*(2 + 3*d)*t) + 
     aa*(-2 + d)*(2*psq^2 + s*(s + t) - psq*(s + 2*t)) - 
     bb*(-2 + d)*(2*psq^2 + s*(s + t) - psq*(5*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
  ...
  (I*EL^5*gAl^2*gFFA*gFll^2*mm^2*(bb*(2*mm^2*(psq - s - t) + s*(psq + t)) + 
     aa*((-2 + d)*mm^4 + (-2 + d)*psq^2 - psq*s - s*t + 
       2*mm^2*(psq - d*psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (aa*(-4*(-2 + d)*psq^2 + 2*s^2 - (-2 + d)*psq*(s - 4*t) + 
       mm^2*(4*(2 + d)*psq + (-10 + d)*s - 4*(2 + d)*t)) + 
     bb*(4*(-2 + d)*psq^2 - 2*s^2 - (-2 + d)*psq*(3*s + 4*t) + 
       mm^2*(-4*(2 + d)*psq + (2 + 3*d)*s + 4*(2 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*mm^2 - s)*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (bb*mm^2*(4*psq + 6*d*psq - 4*d*s - 4*t - 6*d*t) + 
     aa*mm^2*(-2*(2 + 3*d)*psq + 8*s + 4*t + 6*d*t) + 
     aa*(-2 + d)*(2*psq^2 + psq*(s - 2*t) + s*t) - 
     bb*(-2 + d)*(2*psq^2 - 3*psq*s - 2*psq*t + s*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    ((2 + d)*mm^2 - (-2 + d)*psq)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
   Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*
    gFFA*gFll^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*
  ...
  (I*4^(1 - d)*(aa + bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/Pi^(2*d) + 
  (I*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  ((3*I)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*((-2 + d)*mm^2 - 
     (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^2*gFFA*
    gFll^2*mm^2*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  ((3*I)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*((-2 + d)*mm^2 - 
     (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
  ...
  (I*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^2*gFFA*
    gFll^2*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*
    gFFA*gFll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], SP[q1, q1]])/
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
   ...
   (2*Pi)^(2*d) - (I*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
    ...
    gAl^2*gFFA*gFll^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q1, q2]])/(4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*
    gAl^2*gFFA*gFll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*
    (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
