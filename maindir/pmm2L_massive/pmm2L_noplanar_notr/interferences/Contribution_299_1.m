...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((3*2^(1 - 2*d)*EL^8*gAl*gAu^2*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(5 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s^2) + (3*4^(2 - d)*(-4 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWWA*gWWZ*
     (gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    (Pi^(2*d)*s) - (4^(2 - d)*(-1 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWWA*gWWZ*
   ...
   (2^(5 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWWA*gWWZ*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-1 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWWA*gWWZ*
     (gZlL + gZlR)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-1 + d)*EL^8*gAl*gAu^2*gHll*
   ...
   (2^(5 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWWA*gWWZ*
     (gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gHll*
