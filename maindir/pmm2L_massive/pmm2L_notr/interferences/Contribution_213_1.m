...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
 ...
 ((4^(1 - d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*(mm^2 + psq)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*(mm^2 + psq)*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*(mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*(mm^2 - psq + s)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gHFW*gHll*mm^2*(mm^2 - t)*
