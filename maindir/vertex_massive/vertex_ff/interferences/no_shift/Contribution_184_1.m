...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*mm^2*(2*mm^2 - s)*
   ...
   (4^(1 - d)*EL^6*gAl^5*gAu*(d^2*(mm^2 - psq)^2*s*(psq - s - t) - 
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^5*gAu*mm^2*(2*(-2 + d)^2*psq^3 - 
      ...
      4*s*t*((-2 + d)*s + 2*(-3 + d)*t) - psq^2*((28 - 12*d + d^2)*s + 
        ...
        2*(-2 + d)^2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^5*gAu*(-(d^2*(mm^2 - psq)^2*s*(psq - t)) - 
   ...
   (4^(1 - d)*EL^6*gAl^5*gAu*(4*(mm^2 - psq)^2*s + d^2*(mm^2 - psq)^2*s - 
      4*d*(psq^2*s + 2*mm^4*(psq - t) + mm^2*(2*psq^2 - 5*psq*s + s^2 - 
          2*psq*t + 2*s*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)^2*EL^6*gAl^5*gAu*mm^2*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
      psq^2*(s + 6*t) - t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-6 + d)*EL^6*gAl^5*gAu*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
      psq^2*(s + 6*t) - t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*
   ...
   (2^(3 - 2*d)*EL^6*gAl^5*gAu*mm^2*(2*(-2 + d)^2*psq^2 + 
      2*(-2 + d)^2*mm^2*s - 8*s^2 + d^2*s^2 + 16*s*t - 16*d*s*t + 4*d^2*s*t + 
      8*t^2 - 8*d*t^2 + 2*d^2*t^2 - 2*(-2 + d)^2*psq*(3*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^5*gAu*(d^2*(mm^2 - psq)*(4*mm^2 - psq + s + t) + 
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^5*gAu*(-2*(-2 + d)*psq^3 + 4*s*t*(s + t) + 
   ...
   (4^(1 - d)*EL^6*gAl^5*gAu*(-(d^2*(psq - s - t)*(2*psq^2 + psq*(s - 4*t) + 
      ...
      4*d*(2*psq^3 - 3*psq^2*(s + 2*t) - psq*(mm^2*s + s^2 - 9*s*t - 6*t^2) + 
        (s + t)*(mm^2*s - 2*t*(2*s + t))) + 
      4*(-2*psq^3 + psq^2*(9*s + 6*t) + psq*(mm^2*s + s^2 - 21*s*t - 6*t^2) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl^5*gAu*mm^2*(psq - t)*(-((-2 + d)^2*psq) + 
      (-4 + d)^2*s + (-2 + d)^2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^5*gAu*(d^2*(mm^2 - psq)*s*(psq - t) - 
      2*d*(psq - t)*(2*psq^2 - 4*psq*(s + t) + t*(s + 2*t) + 
        mm^2*(-2*psq + 6*s + 2*t)) + 4*(6*psq^3 + 5*mm^2*psq*s + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*((2 + d)*mm^2 - (-2 + d)*psq)*
     (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^5*gAu*mm^2*
