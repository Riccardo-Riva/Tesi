...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   (((-I)*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
    ...
    (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
      (mm^2*(5*psq - 2*s - 5*t) + psq*(3*psq - 2*s - 3*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*gHll^2*
      (gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*(aa*mm^2*(3*psq - s - 3*t) - 
       bb*mm^2*(3*psq + s - 3*t) + aa*psq*(psq + s - t) + 
       bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (2*Pi)^(2*d) - (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
      (mm^2*(5*psq - 3*s - 5*t) + psq*(3*psq - s - 3*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*gHll^2*
      (gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*(aa*mm^2*(3*psq - 4*s - 3*t) + 
    ...
    (I*4^(2 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*(bb*(psq - s - t) + 
       ...
       SP[p1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gHll^2*
      (gZlL^2 + gZlR^2)*mm^2*(2*bb*mm^2*(psq - s - t) + 
       aa*(mm^4 + psq^2 + 2*mm^2*(-2*psq + s + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
    (I*4^(2 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
      (3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*
      (gZlL^2 + gZlR^2)*mm^2*(mm^2*(7*psq - 4*s - 7*t) + psq*(psq - t))*
