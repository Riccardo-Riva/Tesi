...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, mw]]*((4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
      (gZlL + gZlR)*mm^2*(s*(-((-4 + d)*psq) + (-4 + d)*s - 2*t) + 
       2*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (mz^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
      (gZlL + gZlR)*mm^2*(2*mm^2*(psq - t) + s*(-2*s + d*(-psq + s) + 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*
      ((-4 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
      (2*mm^2 + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*
      ggpgpZ*(gZlL + gZlR)*mm^2*(-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
      (2*mm^2*(psq - 2*s - t) + s*(-2*s + d*(-psq + s) + 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
      (2*psq^2 - 2*s^2 + d*s^2 + 2*mm^2*(psq + (-2 + d)*s - t) + 4*s*t + 
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*
     ...
     (mz^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
      (gZlL + gZlR)*(2*mm^2*(psq - t) + s*(-2*s + d*(-psq + s) + 2*t))*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
      (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*
    ...
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-psq + s + t)*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(2 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
      (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggpgpA*
      ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
       SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*
    ...
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
      (-2*(-4 + d)*mm^4*s + s*(4*psq^2 - 3*(-2 + d)*psq*s + (-2 + d)*s^2 - 
         8*psq*t + 4*s*t + 4*t^2) - 2*mm^2*(2*psq^2 - (-2 + d)*s^2 + 2*s*t + 
         2*t^2 - psq*((-4 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
