...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(-2*d*gZlL*gZlR*mm^2 + 
   ...
   (4^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(s + t)*
    ...
    (Pi^(4*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(s + t)*
     (2*gZlL^2*mm^2*t + 2*gZlR^2*mm^2*t - 2*gZlL*gZlR*(s + 2*t)^2 - 
      d*mm^2*(gZlL^2*t + gZlR^2*t - gZlL*gZlR*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*t*
     (gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^2*(s + t) + s*(3*s + 4*t)) + 
      gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2*(s + t) + s*(3*s + 4*t)) - 
      2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(-s^2 - 8*s*t - 8*t^2 + 
        mm^2*((-2 + d)*s + d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(4*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*t*
     (d*mm^2*(-(gZlL^2*t) - gZlR^2*t + gZlL*gZlR*(s + 2*t)) + 
      2*(gZlL^2*mm^2*t + gZlR^2*mm^2*t + gZlL*gZlR*(s + 2*t)^2))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s) + (4^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*
     (2^(1 + 2*d)*Pi^(2*d)*(gZlL*gZlR*s^2*(s + 2*t) + 
        gZlL^2*t*(-(mm^2*s) + s^2 + 3*s*t + 2*t^2) + 
        gZlR^2*t*(-(mm^2*s) + s^2 + 3*s*t + 2*t^2)) + 
      d*(2*Pi)^(2*d)*(-(gZlL^2*t*(-(mm^2*s) + s^2 + 3*s*t + 2*t^2)) - 
        gZlR^2*t*(-(mm^2*s) + s^2 + 3*s*t + 2*t^2) + gZlL*gZlR*(s + 2*t)*
         (-(mm^2*s) + 2*t*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    (Pi^(4*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*
     ((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 - 
      2*gZlL*gZlR*((-4 + d)*mm^2 + s))*t*(s^2 + 3*s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(4*mm^2 - s)*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*((-2 + d)*gZlL^2 - 4*d*gZlL*gZlR + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(s + t)*((-2 + d)*gZlL^2*mm^2 + 
      (-2 + d)*gZlR^2*mm^2 + 2*gZlL*gZlR*(-((-2 + d)*mm^2) + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(2*gZlL*gZlR*(2*mm^2 - s - 2*t)*t - 
      gZlL^2*s*(s + 2*t) - gZlR^2*s*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*((-2 + d)*gZlL^2*mm^2*t + 
      (-2 + d)*gZlR^2*mm^2*t - gZlL*gZlR*(2*s^2 + 12*s*t + 
        t*(d*mm^2 + 14*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-(gZlL^2*mm^2*s^2) - gZlR^2*mm^2*s^2 + 2*gZlL*gZlR*
       (2*mm^4*s + 2*t*(s^2 + 3*s*t + 2*t^2) + mm^2*(3*s^2 + 8*s*t + 6*t^2)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
       (2*mm^2*s - s^2 - 3*s*t - 2*t^2) + (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*
       (2*mm^2*s - s^2 - 3*s*t - 2*t^2) - 2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
       (d*mm^2*(mm^2*s - s^2 - 4*s*t - 3*t^2) - 2*(s + 2*t)*
         (mm^2*(-s + t) + t*(s + t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(4*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*(s + t)*(4*mm^2 + s + 2*t)*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
       ...
       (4*t*(s + t) + mm^2*((-2 + d)*s + 3*d*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(4*d)*s) - 
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(s + t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*
     (2*s^2 + 10*s*t + t*(-((-4 + d)*mm^2) + 10*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     ((-2 + d)*gZlL^2*mm^2*(s^2 + 3*s*t + 2*t^2) + (-2 + d)*gZlR^2*mm^2*
       (s^2 + 3*s*t + 2*t^2) + gZlL*gZlR*(-((-4 + d)*mm^4*s) + 
        2*t*(s^2 + 3*s*t + 2*t^2) + mm^2*(-2*(-2 + d)*s^2 - 7*(-2 + d)*s*t + 
          (8 - 5*d)*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*
     (s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/Pi^(2*d) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(s + t)*(4*t + d*(s + t))*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*(gZlL^2*mm^2*s^2 + gZlR^2*mm^2*s^2 + 
      4*gZlL*gZlR*t*(s^2 + 3*s*t + t*(-mm^2 + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*t*(s + 2*t)) - 
      (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*t*(s + 2*t) + 
      2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(s + t)*(-2*t*(s + 2*t) + 
        mm^2*(2*s + (4 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2]])/(Pi^(4*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*
     mm^2*t*(s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*t*
     ((-2 + d)*gZlL^2*mm^2*(s + 2*t) + (-2 + d)*gZlR^2*mm^2*(s + 2*t) - 
      4*gZlL*gZlR*(-4*t*(s + t) + mm^2*((-2 + d)*s + d*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-((-2 + d)*gZlL^2*mm^2*t*(s + 2*t)) - (-2 + d)*gZlR^2*mm^2*t*
       (s + 2*t) + gZlL*gZlR*(2*t*(s^2 + 3*s*t + 2*t^2) + 
        mm^2*(2*s^2 + 2*(1 + d)*s*t + 3*d*t^2)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*t*((-2 + d)*gZlL^2*mm^2*(s + 2*t) + 
     ...
     mm^4*t*(4*t + d*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(s + 2*t)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(s + 2*t)*
     ((-2 + d)*gZlL^2*mm^2*s - 2*(-2 + d)*gZlL*gZlR*mm^2*s + 
      (-2 + d)*gZlR^2*mm^2*s + 8*gZlL*gZlR*t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*(s^2 + 3*s*t + 2*t^2)*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*s*(s + 2*t)) - 
      ...
      4^(1 + d)*gZlL*gZlR*Pi^(2*d)*(mm^2*s*((-2 + d)*s + d*t) + 
        d*t*(s^2 + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(4*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*((-2 + d)*gZlL^2 - (-4 + d)*gZlL*gZlR + 
   ...
   (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(s + t)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(mm^2*s + (s + t)^2)*
    ...
    (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     (2*mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
   ...
   (3*2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*(s + t)*
   ...
   (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
    ...
    (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*(s + t)*
    ...
    (Pi^(2*d)*s) + (4^(3 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*(s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*(2*s - (-4 + d)*t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(s + 2*t)*
