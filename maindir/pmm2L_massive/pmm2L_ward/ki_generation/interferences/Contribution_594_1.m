...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   (((-I)*(-2 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*s*sw*
    ...
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gFZW*gWNl*mm^2*sw*(-(aa*(-4 + d)*gZlR*s) + 
       bb*(-4 + d)*gZlR*s + bb*(-2 + d)*gZlL*(2*mm^2 - psq - t) - 
       aa*(-2 + d)*gZlL*(psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
