...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(3*mm^2 + psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(6*psq^2 + 4*mm^2*s + 5*s^2 + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(3*mm^2 + psq)*
     (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(psq^2 + mm^2*s + (s + t)^2 - 
