...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((EL^8*gAl^3*gAu^2*ggmgmA*ggmgmAA*mm^2*(4*psq^2 + (-2 + d)*s^2 + 4*s*t + 
     4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d))/(4^d*Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmAA*mm^2*(-2*psq + d*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmAA*((-2 + d)*mm^2 - (-4 + d)*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmAA*mm^2*(-2*psq + d*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmAA*mm^2*
   ...
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmAA*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmAA*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmAA*(4*psq^2 + 2*(-2 + d)*mm^2*s - 2*s^2 + 
     d*s^2 + 4*s*t + 4*t^2 - 2*psq*((-2 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmAA*(-2*psq + s + 2*t)*
