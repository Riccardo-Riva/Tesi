...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((4^(1 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     ...
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*
     (gZlL + gZlR)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(psq - t)*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*
     ...
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(psq - t)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*
     ...
     (gZlL + gZlR)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     ...
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s)))/4
