...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p2 + q1, mz], 
  ...
  (-((4^(1 - d)*(-1 + d)*EL^6*gAl*gWWAZ*gWWZ*gZlL*gZlR*mm^2*
   ...
   (EL^6*gAl*gWWAZ*gWWZ*(-8*(4 - 5*d + d^2)*gZlL*gZlR*mm^2 + 
      (-2 + d)*gZlL^2*(mm^2 + (-9 + 4*d)*psq) + (-2 + d)*gZlR^2*
       (mm^2 + (-9 + 4*d)*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (2*Pi)^(2*d) - (4^(2 - d)*(4 - 5*d + d^2)*EL^6*gAl*gWWAZ*gWWZ*gZlL*gZlR*
