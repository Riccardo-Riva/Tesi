...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 4*d)*d*EL^6*gAl^3*gAu*mm^2*(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(2^(1 + 2*d)*(-2 + d)*d*gZlL*gZlR*mm^2*
      ...
      gZlR^2*(-((-2 + d)^2*mm^4*(2*Pi)^(2*d)*(3*psq^2 + s^2 + 4*s*t + 3*t^2 - 
           2*psq*(s + 3*t))) + psq*(-(d^2*(2*Pi)^(2*d)*psq*(psq^2 + psq*s + 
             t*(s + t))) + 2^(1 + 2*d)*Pi^(2*d)*((-6 + 4*d)*psq^3 - 
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(-4*d*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
       (psq - t) + gZlL^2*(2*(-2 + d)*psq^3 + (-2 + d)*mm^2*(2*psq - s - 2*t)*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*
     (d^2*(psq - t)*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       ...
       (4*psq^3 - 2*psq^2*(s + 5*t) + psq*(-(mm^2*s) + 6*s*t + 8*t^2) + 
        t*(mm^2*s - 2*(s + t)^2)) - 4*d*(gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
         (psq - t) + gZlL^2*(-3*psq^3 + mm^2*psq*s - mm^2*s*t + t*(s + t)^2 - 
