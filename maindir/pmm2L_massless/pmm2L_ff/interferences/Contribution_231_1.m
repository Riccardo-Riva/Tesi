...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (-((4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWlN*mm^2*sw*
      (s^2 + 6*s*t + 5*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     (Pi^(2*d)*s)) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWlN*mm^2*sw*t*
     (s + 5*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWlN*mm^2*sw*(s + 5*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWlN*mm^2*sw*
     (4*s^2 + 9*s*t + 5*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWlN*mm^2*sw*t*
     (4*s + 5*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWlN*mm^2*sw*
     (4*s + 5*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
