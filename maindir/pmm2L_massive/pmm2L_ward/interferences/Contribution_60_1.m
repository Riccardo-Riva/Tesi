...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (((-I)*(aa + bb)*(8 - 6*d + d^2)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(mm^2 - psq)^2*
    s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa + bb)*(8 - 6*d + d^2)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(mm^2 - psq)*
    (-(aa*((8 - 6*d + d^2)*mm^2 - (-2 + d)^2*psq + 2*(-4 + d)*s + 
        2*(-2 + d)*t)) + bb*((16 - 10*d + d^2)*mm^2 - (12 - 8*d + d^2)*psq + 
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
   ...
   Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa + bb)*(8 - 6*d + d^2)*EL^5*gAl*gWlN*gWNl*
    gZlL*gZNL*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa + bb)*(8 - 6*d + d^2)*EL^5*gAl*gWlN*gWNl*
    gZlL*gZNL*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*
  ...
  (I*(aa - bb)*(-6 + d)*EL^5*gAl*gWlN*gWNl*gZNL*((-2 + d)*gZlR*mm^2 - 
     ...
     SP[p2, q2]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
    gZlL*gZNL*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(bb*(20 - 10*d + d^2)*(psq - s - t) + 
  ...
  (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(8 - 6*d + d^2)*EL^5*gAl*gWlN*gWNl*gZlL*
    gZNL*(bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*
  ...
  (I*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(-(aa*(20 - 10*d + d^2)*(psq - t)) + 
     bb*((16 - 10*d + d^2)*mm^2 + 4*psq - (20 - 10*d + d^2)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
