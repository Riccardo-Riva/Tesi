...
PropList[KiraPropagator[q1, mw], KiraPropagator[q2, mz], 
 ...
 (-((2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(4*gZlL*gZlR*mm^2*(5*psq - 2*s)*s + 
  ...
  (EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*s*(-2*psq + (-2 + d)*s + 2*t) + 
  ...
  (EL^8*gAl^2*gAu^2*gFFZ^2*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
      (2*psq^2 - (-4 + d)*s^2 - 2*psq*(s + t)) - gZlL^2*(2*Pi)^(2*d)*
      (4*mm^4*(psq - t) + mm^2*s*((-22 + d)*psq + 16*s - d*s + 8*t) + 
       s*(-((-12 + d)*psq^2) + s*((-4 + d)*s - 2*t) - 
         2*psq*((-3 + d)*s + 3*t))) - gZlR^2*(2*Pi)^(2*d)*
      (4*mm^4*(psq - t) + mm^2*s*((-22 + d)*psq + 16*s - d*s + 8*t) + 
       s*(-((-12 + d)*psq^2) + s*((-4 + d)*s - 2*t) - 
         2*psq*((-3 + d)*s + 3*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   ((2*Pi)^(4*d)*s^2) + (EL^8*gAl^2*gAu^2*gFFZ^2*
    (-(2^(3 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq^2 - s*(s - 2*t) + 
        psq*(s - t))) + gZlL^2*(-(2^(1 + 2*d)*mm^4*Pi^(2*d)*
         (2*psq - (-2 + d)*s - 2*t)) + (2*Pi)^(2*d)*s*
        (-4*s^2 + d*(psq^2 - psq*s + 2*s^2) + 8*s*t + 8*t^2 - 
  ...
  (EL^8*gAl^2*gAu^2*gFFZ^2*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
       (2*psq^2 + (-4 + d)*s^2 - 2*psq*t)) + gZlL^2*(2*Pi)^(2*d)*
      (4*mm^4*(psq - s - t) + mm^2*s*(-((-6 + d)*psq) + (-8 + d)*s + 8*t) + 
       s*(d*(psq^2 + 2*psq*s - s^2) - 2*(s*(-s + t) + psq*(4*s + 3*t)))) + 
     gZlR^2*(2*Pi)^(2*d)*(4*mm^4*(psq - s - t) + 
       mm^2*s*(-((-6 + d)*psq) + (-8 + d)*s + 8*t) + 
       s*(d*(psq^2 + 2*psq*s - s^2) - 2*(s*(-s + t) + psq*(4*s + 3*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/((2*Pi)^(4*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gFFZ^2*
    ...
    SPList[SP[p3, p3]])/(2*s^2) + (EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
      (psq - s) + gZlL^2*(2*Pi)^(2*d)*(-((-4 + d)*psq^2) + (-3 + d)*s^2 + 
       mm^2*((-10 + d)*psq - (-11 + d)*s)) + gZlR^2*(2*Pi)^(2*d)*
      (-((-4 + d)*psq^2) + (-3 + d)*s^2 + mm^2*((-10 + d)*psq - 
         (-11 + d)*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(4*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
   ...
   (Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gFFZ^2*
    (-8*gZlL*gZlR*mm^2*s*(4*psq + (-4 + d)*s) + 
     gZlL^2*(4*(-4 + d)*mm^4*s + s*(28*psq^2 + (-70 + 8*d)*psq*s - 
         (-18 + d)*s^2 + 8*psq*t - 4*s*t - 4*t^2) + 
       2*mm^2*(4*psq^2 - (-17 + d)*s^2 + 4*s*t + 4*t^2 - 
         2*psq*(d*s + 4*t))) + gZlR^2*(4*(-4 + d)*mm^4*s + 
       s*(28*psq^2 + (-70 + 8*d)*psq*s - (-18 + d)*s^2 + 8*psq*t - 4*s*t - 
         4*t^2) + 2*mm^2*(4*psq^2 - (-17 + d)*s^2 + 4*s*t + 4*t^2 - 
         2*psq*(d*s + 4*t))))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   ((2*Pi)^(2*d)*s^2) + (2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*s*(4*psq + (-4 + d)*s)) + 
     gZlL^2*(2^(1 + 2*d)*(-4 + d)*mm^4*Pi^(2*d)*s - 
       (2*Pi)^(2*d)*s*(2*(-18 + d)*psq^2 + (66 - 7*d)*psq*s + (-18 + d)*s^2 - 
         8*psq*t + 4*s*t + 4*t^2) + mm^2*(2*Pi)^(2*d)*
        (8*psq^2 + (38 - 3*d)*s^2 + 8*s*t + 8*t^2 - 8*psq*(3*s + 2*t))) + 
     gZlR^2*(2^(1 + 2*d)*(-4 + d)*mm^4*Pi^(2*d)*s - 
       (2*Pi)^(2*d)*s*(2*(-18 + d)*psq^2 + (66 - 7*d)*psq*s + (-18 + d)*s^2 - 
         8*psq*t + 4*s*t + 4*t^2) + mm^2*(2*Pi)^(2*d)*
        (8*psq^2 + (38 - 3*d)*s^2 + 8*s*t + 8*t^2 - 8*psq*(3*s + 2*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(4*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(2*(-1 + d)*gZlL*gZlR*mm^2*s + 
     gZlL^2*(mm^4 + psq*(psq - s) - mm^2*(2*psq + (-2 + d)*s)) + 
     gZlR^2*(mm^4 + psq*(psq - s) - mm^2*(2*psq + (-2 + d)*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(8*(-3 + d)*gZlL*gZlR*mm^2*s + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (4*gZlL*gZlR*mm^2*(2*psq + (-5 + d)*s - 2*t) + 
     gZlL^2*(2*mm^4 + 4*psq^2 + 2*s*(s + 2*t) - psq*(s + d*s + 2*t) + 
       mm^2*(-8*psq + 10*s - d*s + 4*t)) + 
     gZlR^2*(2*mm^4 + 4*psq^2 + 2*s*(s + 2*t) - psq*(s + d*s + 2*t) + 
       mm^2*(-8*psq + 10*s - d*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(4*gZlL*gZlR*mm^2*(2*psq + d*s - 2*t) + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (4*gZlL*gZlR*mm^2*(2*psq - (-3 + d)*s - 2*t) + 
     gZlL^2*(-2*mm^4 + (-9 + d)*psq*s - 2*psq*t + 2*s*(s + 2*t) + 
       mm^2*((-6 + d)*s + 4*t)) + gZlR^2*(-2*mm^4 + (-9 + d)*psq*s - 
       2*psq*t + 2*s*(s + 2*t) + mm^2*((-6 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-4*gZlL*gZlR*mm^2*s + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2 + 
     gZlL^2*(2*(-6 + d)*mm^2 - 2*(-2 + d)*psq + (-3 + d)*s) + 
     gZlR^2*(2*(-6 + d)*mm^2 - 2*(-2 + d)*psq + (-3 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-8*gZlL*gZlR*mm^2*s + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-8*gZlL*gZlR*mm^2*s + 
     gZlL^2*(4*psq^2 + 2*(-8 + d)*mm^2*s - 16*s^2 + 3*d*s^2 + 4*s*t + 4*t^2 - 
       2*psq*((-14 + d)*s + 4*t)) + gZlR^2*(4*psq^2 + 2*(-8 + d)*mm^2*s - 
       16*s^2 + 3*d*s^2 + 4*s*t + 4*t^2 - 2*psq*((-14 + d)*s + 4*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-4*gZlL*gZlR*mm^2*s + 
     gZlL^2*(4*psq^2 + (-22 + 3*d)*mm^2*s + (32 - 3*d)*psq*s - 16*s^2 + 
       3*d*s^2 - 8*psq*t + 4*s*t + 4*t^2) + 
     gZlR^2*(4*psq^2 + (-22 + 3*d)*mm^2*s + (32 - 3*d)*psq*s - 16*s^2 + 
       3*d*s^2 - 8*psq*t + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(4*(-2 + d)*gZlL*gZlR*mm^2*s + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (4*gZlL*gZlR*mm^2*(2*psq + (-4 + d)*s - 2*t) + 
     gZlL^2*(-2*psq^2 - (6 + d)*psq*s + mm^2*(2*psq + 4*s - d*s - 2*t) + 
       2*psq*t + 4*s*(s + 2*t)) + gZlR^2*(-2*psq^2 - (6 + d)*psq*s + 
       mm^2*(2*psq + 4*s - d*s - 2*t) + 2*psq*t + 4*s*(s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(2*(2 + d)*gZlL*gZlR*mm^2*s + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-4*(-4 + d)*gZlL*gZlR*mm^2*s + 
     gZlL^2*(-4*mm^4 - 5*psq^2 + mm^2*(13*psq - 4*s - 5*t) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (4*gZlL*gZlR*mm^2*(2*psq - (-4 + d)*s - 2*t) + 
     gZlL^2*(-4*mm^4 - 6*psq^2 + (-18 + d)*psq*s + 
       mm^2*(14*psq + (-10 + d)*s - 6*t) + 2*psq*t + 8*s*(s + 2*t)) + 
     gZlR^2*(-4*mm^4 - 6*psq^2 + (-18 + d)*psq*s + 
       mm^2*(14*psq + (-10 + d)*s - 6*t) + 2*psq*t + 8*s*(s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(-psq + 2*s + t) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*s + 
     gZlL^2*(2*mm^2*(2*psq + (-3 + d)*s - 2*t) + 
       s*(-2*(1 + d)*psq + 3*(-2 + d)*s + 6*t)) + 
     gZlR^2*(2*mm^2*(2*psq + (-3 + d)*s - 2*t) + 
       s*(-2*(1 + d)*psq + 3*(-2 + d)*s + 6*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(-psq + 2*s + t) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(16*gZlL*gZlR*mm^2*(psq - 2*s - t) + 
     gZlL^2*(-16*psq^2 - 18*s^2 + 5*d*s^2 + 2*mm^2*(2*psq - (-7 + d)*s - 
         2*t) - 8*s*t - 4*t^2 + 2*psq*((15 + d)*s + 10*t)) + 
     gZlR^2*(-16*psq^2 - 18*s^2 + 5*d*s^2 + 2*mm^2*(2*psq - (-7 + d)*s - 
         2*t) - 8*s*t - 4*t^2 + 2*psq*((15 + d)*s + 10*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(-psq + 2*s + t) + 
     gZlL^2*(16*psq^2 + 18*s^2 - 5*d*s^2 + psq*((-42 + d)*s - 20*t) + 8*s*t + 
       4*t^2 + mm^2*(-8*psq - (-6 + d)*s + 8*t)) + 
     gZlR^2*(16*psq^2 + 18*s^2 - 5*d*s^2 + psq*((-42 + d)*s - 20*t) + 8*s*t + 
       4*t^2 + mm^2*(-8*psq - (-6 + d)*s + 8*t)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-8*(-2 + d)*gZlL*gZlR*mm^2*s + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (6*psq^2 - 3*psq*s - 3*s^2 + d*s^2 - 8*psq*t + s*t + 2*t^2 + 
     ...
     SP[p3, p3]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (6*mm^2 + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(-6*psq^2 + 3*psq*s - s^2 + d*s^2 + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-2*(-2 + d)*gZlL*gZlR*mm^2*s + 
     gZlL^2*(-4*psq^2 + (6 + d)*psq*s + s*(2*mm^2 + (-8 + d)*s - 6*t) + 
       4*psq*t) + gZlR^2*(-4*psq^2 + (6 + d)*psq*s + 
       s*(2*mm^2 + (-8 + d)*s - 6*t) + 4*psq*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (4*gZlL*gZlR*mm^2*(2*psq + (-6 + d)*s - 2*t) + 
     gZlL^2*(4*mm^4 + 2*psq^2 - (12 + d)*psq*s + 2*psq*t + 8*s*(s + 2*t) - 
       mm^2*(2*psq + (-4 + d)*s + 6*t)) + 
     gZlR^2*(4*mm^4 + 2*psq^2 - (12 + d)*psq*s + 2*psq*t + 8*s*(s + 2*t) - 
       mm^2*(2*psq + (-4 + d)*s + 6*t)))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(2*(-4 + d)*gZlL*gZlR*mm^2*s + 
     gZlL^2*(2*mm^4 - 6*psq^2 + 2*mm^2*(2*psq - 5*s) - (-16 + d)*psq*s - 
       (-1 + d)*s^2) + gZlR^2*(2*mm^4 - 6*psq^2 + 2*mm^2*(2*psq - 5*s) - 
       (-16 + d)*psq*s - (-1 + d)*s^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(-psq + s + t) + 
     gZlL^2*(-4*psq^2 + mm^2*(8*psq + (-14 + d)*s - 8*t) + 
       s*(-((-4 + d)*s) + 2*t) + psq*(-((-4 + d)*s) + 4*t)) + 
     gZlR^2*(-4*psq^2 + mm^2*(8*psq + (-14 + d)*s - 8*t) + 
       s*(-((-4 + d)*s) + 2*t) + psq*(-((-4 + d)*s) + 4*t)))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-4*psq^2 + 16*psq*s - 12*s^2 + d*s^2 + 6*psq*t - 11*s*t - 2*t^2 + 
     ...
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(-6*psq^2 + 3*mm^2*s + 12*psq*s - 10*s^2 + d*s^2 + 
     8*psq*t - 7*s*t - 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (-16*gZlL*gZlR*mm^2*(psq - s - t) + gZlL^2*(16*psq^2 + 2*psq*s - 
       2*d*psq*s - 6*s^2 + d*s^2 - 20*psq*t + 4*s*t + 4*t^2 + 
       2*mm^2*(-2*psq + (-5 + d)*s + 2*t)) + 
     gZlR^2*(16*psq^2 + 2*psq*s - 2*d*psq*s - 6*s^2 + d*s^2 - 20*psq*t + 
       4*s*t + 4*t^2 + 2*mm^2*(-2*psq + (-5 + d)*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(-psq + s + t) + 
     gZlL^2*(4*psq^2 + s*((-2 + d)*mm^2 + (-4 + d)*s - 2*t) - 
       psq*((-4 + d)*s + 4*t)) + 
     gZlR^2*(4*psq^2 + s*((-2 + d)*mm^2 + (-4 + d)*s - 2*t) - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (4*gZlL*gZlR*mm^2*(2*psq - (-2 + d)*s - 2*t) + 
     gZlL^2*(-2*psq^2 + (-8 + d)*psq*s + mm^2*(2*psq + (-6 + d)*s - 2*t) + 
       2*psq*t + 4*s*(s + 2*t)) + gZlR^2*(-2*psq^2 + (-8 + d)*psq*s + 
       mm^2*(2*psq + (-6 + d)*s - 2*t) + 2*psq*t + 4*s*(s + 2*t)))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-8*gZlL*gZlR*mm^2*s + 
     gZlL^2*(2*mm^2*(2*psq + s - d*s - 2*t) + 
       s*(2*(-5 + d)*psq - 3*(-4 + d)*s + 6*t)) + 
     gZlR^2*(2*mm^2*(2*psq + s - d*s - 2*t) + 
       s*(2*(-5 + d)*psq - 3*(-4 + d)*s + 6*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-8*gZlL*gZlR*mm^2*(psq + s - t) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(16*gZlL*gZlR*mm^2*(psq + s - t) + 
     gZlL^2*(-8*psq^2 - 2*(5 + d)*psq*s + 14*s^2 - 5*d*s^2 + 
       2*mm^2*(2*psq + (-9 + d)*s - 2*t) + 4*psq*t + 4*t^2) + 
     gZlR^2*(-8*psq^2 - 2*(5 + d)*psq*s + 14*s^2 - 5*d*s^2 + 
       2*mm^2*(2*psq + (-9 + d)*s - 2*t) + 4*psq*t + 4*t^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(psq + s - t) + 
     gZlL^2*(-8*psq^2 - 22*psq*s + d*psq*s + 14*s^2 - 5*d*s^2 + 
       mm^2*(8*psq - (2 + d)*s - 8*t) + 4*psq*t + 4*t^2) + 
     gZlR^2*(-8*psq^2 - 22*psq*s + d*psq*s + 14*s^2 - 5*d*s^2 + 
       mm^2*(8*psq - (2 + d)*s - 8*t) + 4*psq*t + 4*t^2))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-2*(-2 + d)*gZlL*gZlR*mm^2*s + 
     gZlL^2*(4*psq^2 + (-10 + d)*psq*s - 4*psq*t + 
       s*(2*mm^2 + (-2 + d)*s + 6*t)) + gZlR^2*(4*psq^2 + (-10 + d)*psq*s - 
       4*psq*t + s*(2*mm^2 + (-2 + d)*s + 6*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(-psq + t) + 
     gZlL^2*(-4*psq^2 + (-4 + d)*psq*s + (-2 + d)*s^2 + 
       mm^2*(8*psq + 6*s - d*s - 8*t) + 4*psq*t + 2*s*t) + 
     gZlR^2*(-4*psq^2 + (-4 + d)*psq*s + (-2 + d)*s^2 + 
       mm^2*(8*psq + 6*s - d*s - 8*t) + 4*psq*t + 2*s*t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(psq - t) + 
     gZlL^2*(-2*psq^2 + (-8 + d)*mm^2*s - (-7 + d)*psq*s - 2*s^2 + s*t + 
       2*t^2) + gZlR^2*(-2*psq^2 + (-8 + d)*mm^2*s - (-7 + d)*psq*s - 2*s^2 + 
       s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (16*gZlL*gZlR*mm^2*(psq - t) + gZlL^2*(-8*psq^2 + 14*psq*s - 2*d*psq*s - 
       6*s^2 + d*s^2 + 2*mm^2*(2*psq + (-7 + d)*s - 2*t) + 4*psq*t + 4*s*t + 
       4*t^2) + gZlR^2*(-8*psq^2 + 14*psq*s - 2*d*psq*s - 6*s^2 + d*s^2 + 
       2*mm^2*(2*psq + (-7 + d)*s - 2*t) + 4*psq*t + 4*s*t + 4*t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(psq - t) + 
     gZlL^2*(-4*psq^2 + s*((-2 + d)*mm^2 + (-2 + d)*s + 2*t) + 
       psq*(-((-4 + d)*s) + 4*t)) + 
     gZlR^2*(-4*psq^2 + s*((-2 + d)*mm^2 + (-2 + d)*s + 2*t) + 
       psq*(-((-4 + d)*s) + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q2, q2]])/((2*Pi)^(2*d)*s^2) - 
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (4*psq^2 + 2*(-2 + d)*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
     2*psq*((-2 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], 
     SP[p3, p3]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(4*psq^2 + 8*mm^2*s - 5*s^2 + 2*d*s^2 + 4*s*t + 4*t^2 - 
     4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (-4*gZlL*gZlR*mm^2 + gZlL^2*(-((-10 + d)*mm^2) + (-4 + d)*psq + 
       (-3 + d)*s) + gZlR^2*(-((-10 + d)*mm^2) + (-4 + d)*psq + (-3 + d)*s))*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (4*mm^2 + (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (4*psq^2 - 8*mm^2*s + 3*s^2 - 2*d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (4*psq^2 - 4*mm^2*s + 12*s^2 - d*s^2 + 4*s*t + 4*t^2 - 4*psq*(3*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(8*(gZlL^2 + gZlR^2)*psq*s + 
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*mm^2 - 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 + psq - 2*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p1, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(3*mm^2 + 5*psq - 8*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (3*mm^2 - 9*psq + d*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(3*mm^2 - 3*psq + s)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 + 3*psq - 4*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(3*mm^2 - 9*psq + d*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (13*mm^2 - 9*psq + 2*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(7*mm^2 - 7*psq + 2*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p3, p3]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*mm^2 + s + 2*t)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - 3*psq + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (3*mm^2 - 11*psq + 8*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - 5*psq + 4*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
   ...
   (Pi^(2*d)*s) - (2^(7 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q1, q2]])/
   (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/
   (Pi^(2*d)*s) - (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p1, q1]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
  ...
  (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-psq + 2*s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*mm^2 - 4*psq - 12*s + 3*d*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq + (-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(10*psq + (-22 + 3*d)*s - 10*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - 2*s - t)*
   ...
   (Pi^(2*d)*s^2) - (3*4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(-2*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-4*psq + 5*s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-2*mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (6*psq - 7*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(4*mm^2 - 2*psq - 12*s + d*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 3*psq + t)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-6*psq + 11*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + 5*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-2*psq + 5*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - 7*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-psq + s + t)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(-4*mm^2 + 2*psq - 12*s + 3*d*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 3*psq + t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (-4*mm^2 + 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(4*mm^2 - 4*psq + s)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq - 3*s - 2*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq - 3*s - 2*t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    ...
    (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*mm^2 + d*s + 2*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (6*psq + s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(4*mm^2 - 6*psq - 10*s + d*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*mm^2 + psq + t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(4*mm^2 - 4*psq + s)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (6*psq - 7*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*(psq + s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(psq + s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    (psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], 
     SP[p2, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(psq + s - t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(4*psq + s - 4*t)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(psq + s - t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq + 5*s - 2*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    ...
    (gZlL^2 + gZlR^2)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    ...
    (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q1], 
     SP[p3, q1]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
