...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-((2^(1 - 2*d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*(mm^2 - psq)*s*
       (2*aa*psq - 2*bb*psq - aa*s)*\[Mu]^(8 - 2*d))/
      ((mh^2 - mz^2)*Pi^(2*d))) - (4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
      mm^4*(aa*(2*psq^2 + mm^2*s - 3*psq*s) + bb*(-2*psq^2 + mm^2*s + psq*s))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) + 
    (2^(3 - 2*d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*
      (-2*bb*mm^2*psq + aa*mm^2*(2*psq - s) + aa*psq*s)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
    (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*(psq - s)*s*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/((mh^2 - mz^2)*Pi^(2*d)) - 
    (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*psq*s*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)) - 
    (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*(4*psq - s)*s*
    ...
    (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) + (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
      (gZlL + gZlR)^2*mm^4*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
