...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
 ...
 (((-I)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
    ...
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*
    (gZlL + gZlR)*mm^2*sw*(2*psq^2 + psq*(s - 2*t) + 2*mm^2*(psq - s - t) - 
     s*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFZW*gHFW*gHll*
    (gZlL + gZlR)*mm^2*s*sw*(bb*(mm^2 - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*
    (gZlL + gZlR)*mm^2*sw*(2*psq^2 + 2*mm^2*(psq - t) - s*t - psq*(s + 2*t))*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
    sw*(bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
