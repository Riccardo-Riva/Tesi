PropList[KiraPropagator[p1 - q1, ms], KiraPropagator[-p2 - q1, ms]]*
 (((3*I)*EL^6*gAd*gAl^2*gAu*(gZdL + gZdR)*(gZuL + gZuR)*ms^2*
    (-2*s^2 + d*s^2 + 4*s*t + 4*t^2))/((2*Pi)^d*s^2*(-mz^2 + s)) + 
  ((3*I)*EL^6*gAd*gAl^2*gAu*(gZdL*gZuL*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + gZdR*gZuR*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + gZdR*gZuL*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
       2*d*s*t + 4*t^2) + gZdL*gZuR*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
       2*d*s*t + 4*t^2))*SPList[SP[p1, p2]])/((2*Pi)^d*s^2*(-mz^2 + s)) + 
  ((3*I)*2^(1 - d)*(-3 + d)*EL^6*gAd*gAl^2*gAu*(gZdL - gZdR)*(gZuL - gZuR)*
    (s + 2*t)*SPList[SP[p1, p3]])/(Pi^d*s*(-mz^2 + s)) + 
  ((3*I)*EL^6*gAd*gAl^2*gAu*((2^(1 - d)*(gZdL + gZdR)*(gZuL + gZuR)*
       (-4*s^2 + d*s^2 + 4*s*t + 4*t^2))/Pi^d - 
     (gZdL*gZuL*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       gZdR*gZuR*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       gZdR*gZuL*(-14*s^2 + 8*d*s^2 - d^2*s^2 - 2*s*t + 2*d*s*t + 4*t^2) + 
       gZdL*gZuR*(-14*s^2 + 8*d*s^2 - d^2*s^2 - 2*s*t + 2*d*s*t + 4*t^2))/
      (2*Pi)^d)*SPList[SP[p1, q1]])/(s^2*(-mz^2 + s)) - 
  ((3*I)*EL^6*gAd*gAl^2*gAu*(gZdL*gZuL*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + gZdR*gZuR*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + gZdR*gZuL*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
       2*d*s*t + 4*t^2) + gZdL*gZuR*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
       2*d*s*t + 4*t^2))*SPList[SP[p2, q1]])/((2*Pi)^d*s^2*(-mz^2 + s)) - 
  ((3*I)*2^(1 - d)*(-3 + d)*EL^6*gAd*gAl^2*gAu*(gZdL - gZdR)*(gZuL - gZuR)*
    (s + 2*t)*SPList[SP[p3, q1]])/(Pi^d*s*(-mz^2 + s)) - 
  ((3*I)*EL^6*gAd*gAl^2*gAu*(gZdL + gZdR)*(gZuL + gZuR)*
    (-4*s^2 + d*s^2 + 4*s*t + 4*t^2)*SPList[SP[q1, q1]])/
