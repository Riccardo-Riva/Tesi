...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((2^(3 - 2*d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*
     ...
     \[Mu]^(8 - 2*d))/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*
     gWWA*mm^2*(-8*psq^3 + 6*psq^2*(s + 4*t) + 
      psq*(2*mm^2*s - s^2 - 22*s*t - 24*t^2) + 
      (s + t)*(-2*mm^2*s + s^2 + 8*s*t + 8*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*
     (-8*psq^3 + 2*psq^2*(s + 12*t) + psq*(-2*mm^2*s + s^2 - 10*s*t - 
        24*t^2) + t*(2*mm^2*s + s^2 + 8*s*t + 8*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*
     (-12*psq^2 + 9*psq*s - s^2 + 4*mm^2*(psq - t) + 20*psq*t - 9*s*t - 
      8*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*
     (2*mm^2 - 5*psq + 3*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*
     mm^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*(psq - t)*
     (-8*psq + 7*s + 8*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*(4*psq + s - 4*t)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
   (3*4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*(psq - t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*(psq - t)*
    ...
    Pi^(2*d) - (4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*
     mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/
    Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFAW*gHFW*gHll*gWWA*
