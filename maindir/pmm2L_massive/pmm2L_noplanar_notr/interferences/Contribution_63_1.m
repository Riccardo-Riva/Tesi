...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*mm^2*sw*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*mm^2*sw*
    ...
    (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*
     sw*(16*s^2 + d^2*s^2 + 4*d*(psq^2 - 2*s^2 - 2*psq*t + s*t + t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*((-2 + d)*gZlL + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*sw*
     (16*s + d^2*s + 2*d*(psq - 5*s - t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*sw*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*
     gZlR*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
    (Pi^(2*d)*s) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*mm^2*sw*
     (-2*gZlR*s + (-2 + d)*gZlL*(psq - s - t) + d*gZlR*(-psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*sw*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*sw*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*mm^2*sw*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*sw*
     (-4*s + d*(2*psq + s - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gFZW*
     gWlN*gZlR*mm^2*sw*(-4*s + d*(2*psq + s - 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*sw*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*mm^2*sw*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFll*gFZW*gWlN*gZlR*
