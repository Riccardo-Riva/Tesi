...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*(2*(2 - 3*d + d^2)*mm^4 + 
    ...
    Pi^(2*d) + (4^(1 - d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*
     ((4 - 2*d + d^2)*mm^2 - 2*(8 - 7*d + d^2)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^4*
     (gZlL^2 + gZlR^2)*mm^2*(d^2*(mm^2 - 2*psq) - 12*psq - 
   ...
   (2^(3 - 2*d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*(-2*(-2 + d)*mm^2 + 
   ...
   (4^(2 - d)*(-4 + d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^4*(gZlL^2 + gZlR^2)*
     ((16 - 14*d + d^2)*mm^2 - (16 - 10*d + d^2)*s)*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^4*(gZlL^2 + gZlR^2)*
     ((8 - 14*d + d^2)*mm^2 + (16 - 10*d + d^2)*s)*\[Mu]^(8 - 2*d)*
