...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(1 - 4*d)*d*EL^8*gAl^4*gAu^2*mm^2*
   ...
   (2^(1 - 4*d)*EL^8*gAl^4*gAu^2*(-(2^(3 + 2*d)*(-2 + d)*gZlL*gZlR*mm^2*
    ...
    (Pi^(4*d)*s^2) + (4^(2 - d)*d*EL^8*gAl^4*gAu^2*mm^2*
   ...
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*mm^2*(2*(8 - 7*d + d^2)*gZlL*gZlR*s - 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(16*d*gZlL*gZlR*mm^2*(psq - s - t) + 
      gZlL^2*(4*(-2 + d)*psq^2 + 4*(-4 + d)*psq*s + 24*s^2 - 10*d*s^2 + 
        d^2*s^2 - 4*(-2 + d)*mm^2*(2*psq - s - 2*t) - 8*(-2 + d)*psq*t + 
        4*d*s*t - 8*t^2 + 4*d*t^2) + gZlR^2*(4*(-2 + d)*psq^2 + 
