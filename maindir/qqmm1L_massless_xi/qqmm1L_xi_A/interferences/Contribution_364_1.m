...
PropList[KiraPropagator[-p1 + q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 ((I*2^(2 - d)*EL^6*gAl*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(4 - d)*
  ...
  (I*2^(3 - d)*EL^6*gAl*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
  ...
  (I*2^(3 - d)*EL^6*gAl*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(4 - d)*
  ...
  (I*2^(4 - d)*EL^6*gAl*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(4 - d)*
    SPList[SP[p2, p3], SP[p3, q1]])/(Pi^d*s*(-mz^2 + s)) + 
  (I*2^(2 - d)*EL^6*gAl*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*\[Mu]^(4 - d)*
