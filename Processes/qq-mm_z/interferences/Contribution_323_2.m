...
PropList[KiraPropagator[p1 - q1, mt], KiraPropagator[-p2 - q1, mt]]*
 (((-3*I)*EL^6*gAl*gAu^3*mt^2*
   ...
   ((2*Pi)^d*(mzC^2 - s)*s^2) - 
  ((3*I)*EL^6*gAl*gAu^3*(-(gZlRC*gZuLC*((8 - 6*d + d^2)*s^2 + 
  ...
  ((3*I)*2^(3 - d)*EL^6*gAl*gAu^3*((-2 + d)*gZlLC*gZuLC - 
     (-4 + d)*gZlRC*gZuLC - (-4 + d)*gZlLC*gZuRC + (-2 + d)*gZlRC*gZuRC)*t*
    SPList[SP[p1, p2], SP[p2, q1]])/(Pi^d*s^2*(-mzC^2 + s)) + 
  ((3*I)*2^(2 - d)*EL^6*gAl*gAu^3*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
     gZlRC*gZuRC*((-2 + d)*s - 2*t) - gZlRC*gZuLC*((-4 + d)*s + 2*t) - 
     gZlLC*gZuRC*((-4 + d)*s + 2*t))*SPList[SP[p1, p2], SP[p3, q1]])/
   (Pi^d*s^2*(-mzC^2 + s)) + ((3*I)*2^(3 - d)*EL^6*gAl*gAu^3*(gZlLC + gZlRC)*
    (gZuLC + gZuRC)*SPList[SP[p1, p3], SP[p1, p3]])/(Pi^d*s*(-mzC^2 + s)) + 
  ((3*I)*2^(2 - d)*EL^6*gAl*gAu^3*(d*gZlRC*(gZuLC - gZuRC)*s + 
  ...
  ((3*I)*2^(4 - d)*EL^6*gAl*gAu^3*(gZlLC + gZlRC)*(gZuLC + gZuRC)*
    SPList[SP[p1, p3], SP[p3, q1]])/(Pi^d*s*(-mzC^2 + s)) - 
  ((3*I)*2^(2 - d)*EL^6*gAl*gAu^3*((-4 + d)*gZlLC*gZuLC - 
  ...
  ((3*I)*2^(3 - d)*EL^6*gAl*gAu^3*(gZlLC + gZlRC)*(gZuLC + gZuRC)*
