...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^4*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
     ...
     Pi^(2*d) + (I*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      (aa*psq*(psq - s - t) + aa*mm^2*(psq + s - t) - bb*psq*(psq + s - t) + 
       ...
       SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*
      gXll*mm^2*(aa*(mm^2*(2*psq - s - 2*t) + (psq - s)*(psq - t)) + 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*s*
     ...
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(bb*(mm^2 - t) + 
       aa*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*
      gXll*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[q1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWNl*gXFW*gXll*
      mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWNl*
      gXFW*gXll*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*gXll*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*
      gXll*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWNl*gXFW*
      gXll*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[q1, q1]])/Pi^(2*d)))/4}
