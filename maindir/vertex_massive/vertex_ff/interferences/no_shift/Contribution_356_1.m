...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
      (gZlL^2*mm^2*(d^2*(2*Pi)^(2*d)*s*(psq^2 + t*(s + 3*t)) + 
       ...
       gZlR^2*mm^2*(d^2*(2*Pi)^(2*d)*s*(psq^2 + t*(s + 3*t)) + 
         2^(1 + 2*d)*Pi^(2*d)*(-((-2 + d)^2*psq^3) - (-2 + d)^2*psq*t*
            (2*s + 3*t) + psq^2*(-2*(-1 + d)*s + 3*(-2 + d)^2*t) + 
           t*(-2*(-1 + d)*s^2 - 6*(-1 + d)*s*t + (-2 + d)^2*t^2))) + 
       2*gZlL*gZlR*(s*(-(d^2*(2*Pi)^(2*d)*(3*psq^3 - psq^2*s - 
              s*t*(s + 3*t) + psq*t*(5*s + 7*t))) + 2^(1 + 2*d)*Pi^(2*d)*
         ...
         2*mm^2*(2^(1 + 2*d)*Pi^(2*d)*(2*(-1 + d)*psq^3 - 
             2*psq^2*(s + 3*(-1 + d)*t) + psq*t*((2 + d)*s + 6*(-1 + d)*t) - 
             2*t*(s^2 + (-1 + d)*t^2)) - d*(2*Pi)^(2*d)*
            (-(s*(psq^2 + (s - 3*t)*t)) + d*(psq - t)*(psq^2 - 2*psq*t + t*
                (s + t))))))*\[Mu]^(8 - 2*d))/(Pi^(4*d)*s)) - 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (gZlL^2*(-(d^2*(2*Pi)^(2*d)*s^2*(-3*psq + s + 5*t)) + 
        (-4 + d^2)*mm^2*(2*Pi)^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
          ...
          psq*((12 - 9*d)*s^2 + (44 - 28*d + 5*d^2)*s*t + 
            3*(-2 + d)^2*t^2))) + 
      gZlR^2*(-(d^2*(2*Pi)^(2*d)*s^2*(-3*psq + s + 5*t)) + 
        (-4 + d^2)*mm^2*(2*Pi)^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
          3*s*t + 2*t^2) + 2^(1 + 2*d)*Pi^(2*d)*((-2 + d)^2*psq^3 + 
          (-4 + 3*d)*s^3 + 3*(-8 + 5*d)*s^2*t + (-24 + 16*d - 3*d^2)*s*t^2 - 
          (-2 + d)^2*t^3 - psq^2*(2*(10 - 6*d + d^2)*s + 3*(-2 + d)^2*t) + 
          psq*((12 - 9*d)*s^2 + (44 - 28*d + 5*d^2)*s*t + 
            3*(-2 + d)^2*t^2))) + 4*gZlL*gZlR*
       (-(mm^2*(2*Pi)^(2*d)*(psq - s - t)*((4 - 6*d + d^2)*psq - 
           (8 - 5*d + d^2)*s - (4 - 6*d + d^2)*t)) + 2^(1 + 2*d)*Pi^(2*d)*
         (2*(-5 + 4*d)*psq^3 + psq^2*((2 + d^2)*s + (28 - 21*d + 4*d^2)*t) + 
     ...
     (-2*gZlL*gZlR*(2^(1 + 2*d)*mm^2*Pi^(2*d)*(psq - s - t)*
      ...
      gZlL^2*(-(d^2*(2*Pi)^(2*d)*psq*(7*psq^2 - 3*psq*s + t*(11*s + 15*t))) + 
        (-2 + d)*mm^2*(2*Pi)^(2*d)*((-4 + 3*d)*psq^2 + 
          (s + t)*(4*s + (-4 + 3*d)*t) - psq*((8 + d)*s + 2*(-4 + 3*d)*t)) + 
        2^(1 + 2*d)*Pi^(2*d)*((-44 + 27*d)*psq^3 + t*(s + t)*
           ((12 - 8*d + d^2)*s + 2*(14 - 8*d + d^2)*t) + 
          psq^2*((22 - 14*d)*s + (116 - 70*d + 9*d^2)*t) + 
          psq*((-2 + d)*s^2 + 2*(-35 + 22*d)*s*t + (-100 + 59*d)*t^2))) + 
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (-(gZlL^2*(d^2*(2*Pi)^(2*d)*s^2*(psq - t) + (-4 + d^2)*mm^2*(2*Pi)^(2*d)*
      ...
      4*gZlL*gZlR*(mm^2*(2*Pi)^(2*d)*(psq - t)*((4 - 6*d + d^2)*psq - 
        ...
        d*(2*Pi)^(2*d)*(psq*s*(5*psq - 21*t) + d*(psq^3 - psq^2*s + 
            5*psq*t^2 - s*t*(s + 3*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     ...
     (gZlL^2*(-((-2 + d)*mm^2*(2*Pi)^(2*d)*(psq - t)*((4 + d)*psq - 4*s - 
      ...
      gZlR^2*(-((-2 + d)*mm^2*(2*Pi)^(2*d)*(psq - t)*((4 + d)*psq - 4*s - 
        ...
        2^(1 + 2*d)*Pi^(2*d)*((-20 + 11*d)*psq^3 + 
          ...
          t*(s + t)*((-4 + d)^2*s + 2*(14 - 8*d + d^2)*t) + 
          psq^2*((14 - 7*d + d^2)*s + (68 - 38*d + 5*d^2)*t))) + 
      2*gZlL*gZlR*(psq - t)*(2^(1 + 2*d)*mm^2*Pi^(2*d)*((4 - 6*d + d^2)*psq + 
          4*s - (4 - 6*d + d^2)*t) + (2*Pi)^(2*d)*(-52*psq*s + 
          20*s*(s + 2*t) + d^2*s*(-3*psq + s + 2*t) + 
          2*d*(2*psq^2 + 13*psq*s - 5*s^2 - 4*psq*t - 8*s*t + 2*t^2))))*
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     ...
     (2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*s*
       (2*mm^2*((4 - 6*d + d^2)*psq + 4*s - (4 - 6*d + d^2)*t) + 
        s*((-52 + 26*d - 3*d^2)*psq + (20 - 10*d + d^2)*(s + 2*t))) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*
     (-8*d*gZlL*gZlR*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t)) + 
      gZlL^2*(2*(-2 + d)^2*psq^2 + (8 - 4*d + d^2)*s^2 + 2*(-2 + d)*d*s*t + 
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(4^(1 + d)*(-2 + d)^2*gZlL*gZlR*mm^2*Pi^(2*d)*
      ...
      gZlL^2*(d^2*(2*Pi)^(2*d)*s*(psq*(psq + s - 5*t) + mm^2*(psq - s - t)) + 
        2^(1 + 2*d)*Pi^(2*d)*(-((8 - 6*d + d^2)*psq^3) + 
          psq^2*((8 - 5*d)*s + 3*(8 - 6*d + d^2)*t) + 
          psq*((4 - 3*d)*mm^2*s + (4 - 3*d)*s^2 + (-28 + 19*d)*s*t - 
            3*(8 - 6*d + d^2)*t^2) + (s + t)*((-4 + 3*d)*mm^2*s + 
            (-2 + d)*t*((-6 + d)*s + (-4 + d)*t)))) + 
      gZlR^2*(d^2*(2*Pi)^(2*d)*s*(psq*(psq + s - 5*t) + mm^2*(psq - s - t)) + 
        2^(1 + 2*d)*Pi^(2*d)*(-((8 - 6*d + d^2)*psq^3) + 
          psq^2*((8 - 5*d)*s + 3*(8 - 6*d + d^2)*t) + 
          psq*((4 - 3*d)*mm^2*s + (4 - 3*d)*s^2 + (-28 + 19*d)*s*t - 
            3*(8 - 6*d + d^2)*t^2) + (s + t)*((-4 + 3*d)*mm^2*s + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*(psq - t)*(4*d*gZlL*gZlR*(-psq + t) + 
      gZlL^2*(-((12 - 8*d + d^2)*psq) + (-4 + d)^2*s + (12 - 8*d + d^2)*t) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*(psq - t)*
     (2*gZlL*gZlR*mm^2*(2*(8 - 7*d + d^2)*psq - (12 - 6*d + d^2)*s - 
        2*(8 - 7*d + d^2)*t) - (-4 + d)*gZlL^2*(-2*(-6 + d)*psq^2 - 2*psq*s + 
        4*(-6 + d)*psq*t - (-6 + d)*t*(s + 2*t) + 
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(-(4^(1 + d)*(-2 + d)^2*gZlL*gZlR*mm^2*
      ...
      gZlL^2*(d^2*(2*Pi)^(2*d)*s*(psq*(psq - 3*t) + mm^2*(-psq + t)) + 
        2^(1 + 2*d)*Pi^(2*d)*(-((8 - 6*d + d^2)*psq^3) + 
          ...
          mm^2*(-psq + t)) + 2^(1 + 2*d)*Pi^(2*d)*(-((8 - 6*d + d^2)*psq^3) + 
          psq^2*(24*t + 3*d^2*t - d*(s + 18*t)) + 
          t*((4 - 3*d)*mm^2*s + (-2 + d)*(s + t)*(2*s + (-4 + d)*t)) + 
          psq*((-4 + 3*d)*mm^2*s + t*((-4 + 5*d)*s - 3*(8 - 6*d + d^2)*t)))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(4*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*mm^2*(-2*gZlL*gZlR*s + 
   ...
   (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*(-4*(-1 + d)*gZlL*gZlR*mm^2*
       (2*psq - s - 2*t) + gZlL^2*(s*(-2*(-7 + d)*psq + (-6 + d)*(s + 2*t)) + 
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(-((8 - 6*d + d^2)*gZlL^2*(2*Pi)^(2*d)*
        (mm^2 - psq)*s) - (8 - 6*d + d^2)*gZlR^2*(2*Pi)^(2*d)*(mm^2 - psq)*
       s - 4^(1 + d)*(-2 + d)^2*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t))*
