...
PropList[KiraPropagator[p1 - q1, ms], KiraPropagator[-p2 - q1, ms]]*
 (((3*I)*2^(-1 - 2*d)*EL^6*gAd*gAl*(gZdL + gZdR)*ms^2*
  ...
  ((3*I)*(-3 + d)*EL^6*gAd*gAl*(gZdL - gZdR)*
  ...
  ((I/2)*EL^6*gAd*gAl*((3*2^(1 - 2*d)*(gZdL + gZdR)*
       (gZlRC*gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
     ...
     (gZdL*(-(gZlLC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
       ...
       gZdR*(-(gZlRC*(gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(
         ...
         gZlLC*(gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
              ((6 - 6*d + d^2)*s^2 + 3*(8 - 5*d + d^2)*s*t + 6*t^2)) + 
           gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((24 - 12*d + d^2)*
  ...
  ((3*I)*2^(2 - d)*EL^6*gAd*gAl*(gZdL + gZdR)*((-2 + d)*gZlLC*gZuL*gZuLC - 
     (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
  ...
  ((3*I)*2^(1 - d)*EL^6*gAd*gAl*(gZdL + gZdR)*
   ...
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) + 
  ((3*I)*2^(3 - d)*EL^6*gAd*gAl*(gZdL + gZdR)*(gZlLC + gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, p3], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) - 
  ((3*I)*2^(1 - d)*EL^6*gAd*gAl*(gZdL + gZdR)*((-4 + d)*gZlLC*gZuL*gZuLC - 
