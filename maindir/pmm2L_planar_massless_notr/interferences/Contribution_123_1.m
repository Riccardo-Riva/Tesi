...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (-((4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*s*
     SPList[SP[p1, q1]])/Pi^(2*d)) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*s*SPList[SP[p2, q1]])/
   Pi^(2*d) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*s*
    SPList[SP[p3, q1]])/Pi^(2*d) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*
    (gZlL + gZlR)*s*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*s*SPList[SP[q1, q2]])/
   Pi^(2*d) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*
