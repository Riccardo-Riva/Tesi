...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
   ...
   ((2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(3*mm^2 + psq - 2*s)*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*(-8 + 3*d)*psq^3 + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((2 + d)*psq^4 + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*(-8 + d)*psq^3 - 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(4*(-2 + d)*mm^2 - 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-((-2 + d)*psq^3) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-3*(-2 + d)*psq^3 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-((-10 + d)*psq^3) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)*(-4*psq + d*s + 4*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-2*psq^3 - mm^2*(2*psq - s - 2*t)*
        (psq - t) - 6*psq*t*(s + t) + 2*t*(s + t)^2 + 2*psq^2*(s + 3*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*(-4 + d)*psq^2 + 16*psq*t - 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-4*(-2 + d)*psq^3 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (d*(mm^2 - psq)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
       ...
       SP[p3, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*psq - s - 2*t)*
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((14 - 5*d)*psq^2 + 
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-10 + 3*d)*psq^2 - 2*s^2 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-4*psq^2 + 
