(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mz], 
  ...
  (((-I)*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*(s + t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*t*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*
    ...
    (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*
     s*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*(s + 2*t)*
   ...
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl*(gZlL^4 + gZlR^4)*
     ((-3 + d)*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*
   ...
   ((3*I)*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl*(gZlL^4 + gZlR^4)*(s + 2*t)*
   ...
   (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*t*
