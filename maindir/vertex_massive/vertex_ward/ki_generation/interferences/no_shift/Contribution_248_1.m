...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
     ...
     SPList[SP[p1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*
     (gZlL + gZlR)*(2*bb*mm^2 + aa*(-5 + 2*d)*mm^2 + aa*(3 - 2*d)*psq)*s^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (10*bb*mm^2 + aa*(-7 + d)*mm^2 - aa*(3 + d)*psq)*s^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*
     (gZlL + gZlR)*s*(2*aa*(5 - 3*d)*psq^2 + bb*(-5 + 3*d)*psq*(2*psq - s) + 
      2*aa*mm^2*((-1 + 3*d)*psq - s) + bb*mm^2*((2 - 6*d)*psq + 
   ...
   (4^(1 - d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*(1 - 2*d)*mm^2 + 
      2*bb*(-5 + 4*d)*mm^2 + 5*aa*(3 - 2*d)*psq + 2*bb*(-3 + 2*d)*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (bb*((3 + 11*d)*mm^2 + (-11 + 7*d)*psq) - 
      aa*((3 + 5*d)*mm^2 + (-11 + 13*d)*psq))*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(2*aa*(5 - 3*d)*psq^2 + 
   ...
   (4^(1 - d)*(2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*s*
   ...
   (4^(1 - d)*(-5 + 3*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
    Pi^(2*d) - (4^(1 - d)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
    Pi^(2*d) - (2^(3 - 2*d)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    ...
    Pi^(2*d) + (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*
     (gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p2, q1]])/Pi^(2*d) + (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*
   ...
   (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    ...
    Pi^(2*d) + (4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*
     (gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q2, q2]])/Pi^(2*d) + (4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl*gWWA^2*
     gWWZ*(gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    Pi^(2*d) - (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*
     (gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*
     gWWZ*(gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p1, q1]])/Pi^(2*d) - (4^(1 - d)*(-14 + 9*d)*EL^5*gAl*gWWA^2*gWWZ*
   ...
   (4^(1 - d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*(11 - 7*d)*mm^2 + 
      bb*(-17 + 11*d)*mm^2 + aa*(17 - 11*d)*psq + bb*(-11 + 7*d)*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(2 - d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*
     (gZlL + gZlR)*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*
   ...
   (2^(3 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (-8*bb*mm^2 + aa*(2 + d)*mm^2 + 8*aa*psq - bb*(2 + d)*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-5 + 3*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q1]])/Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*
     (gZlL + gZlR)*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
   (4^(2 - d)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/Pi^(2*d) + 
   (4^(2 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q1]])/
    Pi^(2*d) + (4^(2 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*
   ...
   (2^(3 - 2*d)*(aa - bb)*(-6 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/
    Pi^(2*d) - (2^(3 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl*gWWA^2*gWWZ*
     (gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
     (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q2]])/
    Pi^(2*d) - (4^(2 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*
     (gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2], SP[q2, q2]])/Pi^(2*d)))/2
