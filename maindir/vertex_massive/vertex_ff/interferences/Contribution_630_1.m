...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(3*mm^2 + psq)*
   ...
   (4^(1 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(7*mm^2 + psq)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*
     (psq - s - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
   (2^(5 - 2*d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(mm^2 - psq)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*
     (mm^2*(psq - t) + t*(-psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(6*psq^2 + 4*mm^2*s + 5*s^2 + 
      11*s*t + 6*t^2 - 3*psq*(5*s + 4*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)*(-6*psq + s + 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (mm^2*(7*psq - 3*s - 7*t) + psq*(psq - s - t))*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(3*mm^2 + psq)*
     ...
     mm^2*(psq - t)*(psq*(-psq + t) + mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(4*psq^3 + 3*mm^2*psq*s - 
      mm^2*s*(2*s + 3*t) - psq^2*(s + 12*t) + psq*t*(7*s + 12*t) - 
      2*t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*psq^2 - 3*psq*t + 
