PropList[KiraPropagator[p1 - q1, 0], KiraPropagator[-p2 - q1, 0]]*
 (((-I)*EL^6*gAl^2*gAu^2*(gZlL^2*(8*s^2 - 6*d*s^2 + d^2*s^2 - 10*s*t + 
       2*d*s*t - 4*t^2) + gZlR^2*(8*s^2 - 6*d*s^2 + d^2*s^2 - 10*s*t + 
       2*d*s*t - 4*t^2) - 2*gZlL*gZlR*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
