PropList[KiraPropagator[p1 - q1, mb], KiraPropagator[-p2 - q1, mb]]*
 (((3*I)*EL^6*gAd*gAl*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*mb^2*
  ...
  ((3*I)*EL^6*gAd*gAl*gAu^2*(gZdL*gZlL*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + gZdR*gZlR*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + gZdR*gZlL*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
       2*d*s*t + 4*t^2) + gZdL*gZlR*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
  ...
  ((3*I)*EL^6*gAd*gAl*gAu^2*((2^(1 - d)*(gZdL + gZdR)*(gZlL + gZlR)*
     ...
     (gZdR*gZlL*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       gZdL*gZlR*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       gZdL*gZlL*(-14*s^2 + 8*d*s^2 - d^2*s^2 - 2*s*t + 2*d*s*t + 4*t^2) + 
       gZdR*gZlR*(-14*s^2 + 8*d*s^2 - d^2*s^2 - 2*s*t + 2*d*s*t + 4*t^2))/
