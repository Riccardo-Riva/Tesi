...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  (-((4^(1 - d)*(-5 + 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(2*(-1 + d)*psq^4 - 
      2*s*t*(s + t)*(2*s + (-2 + d)*t) + psq^3*((9 - 2*d)*s - 6*(-1 + d)*t) - 
      2*psq^2*(2*s^2 + (9 - 2*d)*s*t - 3*(-1 + d)*t^2) + 
   ...
   (3*4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(-psq + s + t)*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
   ...
   (3*4^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(2*psq - s - 2*t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
     (mm^2*(2*(-19 + 9*d)*psq^2 + (6 - 11*d)*psq*s + 2*(1 + d)*s^2 + 
      ...
      2*(-2*(-7 + d)*psq^3 + t*(s + t)*((-14 + 3*d)*s + (-6 + d)*t) + 
        psq^2*((5 - 2*d)*s + (-34 + 5*d)*t) + 
        psq*((-10 + 3*d)*s^2 + (25 - 4*d)*s*t + 2*(13 - 2*d)*t^2)))*
   ...
   (3*4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(2*psq + (-4 + d)*s - 2*t)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(2*(-6 + d)*psq^3 + 
      (-6 + d)*psq*t*(5*s + 6*t) + 2*mm^2*(psq - t)*((-3 + 2*d)*psq + 
        (-2 + d)*s + (3 - 2*d)*t) + psq^2*((22 - 5*d)*s - 6*(-6 + d)*t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(4*psq^3 - psq^2*(7*s + 12*t) - 
      t*(2*mm^2*s + 5*s^2 + 9*s*t + 4*t^2) + 2*psq*(mm^2*s + 8*s*t + 6*t^2))*
   ...
   (3*2^(3 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
     (2*(-2*psq^2 + 5*mm^2*s + 2*psq*(4*s + t) - 6*s*(s + 2*t)) + 
      d*(2*psq^2 + mm^2*(2*psq - 7*s - 2*t) + psq*(s - 2*t) + 2*s*(s + 2*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
   (4^(2 - d)*(-1 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((-14 + 5*d)*psq*s + 
      mm^2*(4*(-1 + d)*psq + 16*s - 7*d*s + 4*t - 4*d*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
     (-4*(-2 + d)*psq^2 + (-6 + d)*psq*s + 2*(-3 + 2*d)*mm^2*(psq - t) + 
      2*(2 + d)*psq*t + 2*(-6 + d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(-6*(-2 + d)*psq^2 + 
      5*(-6 + d)*psq*s + 6*(-2 + d)*psq*t - 2*(-6 + d)*s*(s + 2*t) + 
      mm^2*(6*(-2 + d)*psq - (-6 + d)*s - 6*(-2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(mm^2 - psq)*(psq - t)*
    ...
    (Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
     ...
     gWWA^2*(2*psq^2 - 4*psq*t + t*(s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(3*(-6 + d)*psq^2 + 
      ...
      6*(-6 + d)*psq*t - 38*s*t + 9*d*s*t - 18*t^2 + 3*d*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(psq - t)*(-psq + s + t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
     ...
     (3*(-2 + d)*mm^2 - 4*(-1 + d)*psq - 4*s + 2*d*s + 2*t + d*t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
     ...
     gWWA^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
     (2*(-2 + d)*psq^2 + 2*mm^2*(psq - t) + 4*(-4 + d)*t^2 + 
      psq*((-6 + d)*s + 20*t - 6*d*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((-6 + d)*psq - 2*(-4 + d)*s - 
      (-6 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[p3, q1]])/
    Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*s*
