...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
 ...
 (-((2^(-1 - 2*d)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*s*
     (aa*(2*psq - s)*(mm^2 - psq + s) + bb*(-2*mm^2*psq + 2*psq^2 - 2*psq*s + 
        s^2))*\[Mu]^(8 - 2*d))/Pi^(2*d)) + 
  ((aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*(2*psq - s)*s*
  ...
  ((aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*s*(-2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*psq*s*
  ...
  ((aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
   ...
   (2*Pi)^(2*d) + ((aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*psq*
