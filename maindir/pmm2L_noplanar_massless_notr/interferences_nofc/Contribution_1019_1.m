...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
  ...
  ((4^(1 - d)*EL^8*gAl^2*gAu^2*gFZW^2*(gZlL^2 + gZlR^2)*sw^2*
   ...
   (4^(1 - d)*(18 - 9*d + d^2)*EL^8*gAl^2*gAu^2*gFZW^2*(gZlL^2 + gZlR^2)*sw^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFZW^2*(gZlL^2 + gZlR^2)*sw^2*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFZW^2*
     (gZlL^2 + gZlR^2)*sw^2*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFZW^2*
