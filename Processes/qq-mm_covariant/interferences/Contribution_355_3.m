...
PropList[KiraPropagator[p1 - q1, ms], KiraPropagator[-p2 - q1, ms]]*
 (((-I/27)*2^(-1 - d)*EL^6*ms^2*(9 - 36*sw^2 + 32*sw^4)*
  ...
  ((I/27)*2^(-1 - d)*EL^6*(s^2*(9*d^2 + d*(-54 + 36*sw^2 - 32*sw^4) + 
     ...
     4*(9 - 36*sw^2 + 32*sw^4)*t^2)*SPList[SP[p1, p2]])/
   (cw^2*Pi^d*(mz^2 - s)*s^2*sw^2) + 
  ((I/3)*(-3 + d)*EL^6*(s + 2*t)*SPList[SP[p1, p3]])/
   (cw^2*(2*Pi)^d*s*(-mz^2 + s)*sw^2) - 
  ((I/54)*EL^6*((2^(1 - d)*(9 - 36*sw^2 + 32*sw^4)*((-4 + d)*s^2 + 4*s*t + 
        4*t^2))/Pi^d + (s^2*(-90 - 9*d^2 - 72*sw^2 + 64*sw^4 + 
         d*(54 + 36*sw^2 - 32*sw^4)) + 2*s*(-45 + 9*d + 72*sw^2 - 64*sw^4)*
        t - 4*(9 - 36*sw^2 + 32*sw^4)*t^2)/(2*Pi)^d)*SPList[SP[p1, q1]])/
   (cw^2*(mz^2 - s)*s^2*sw^2) - 
  ((I/27)*2^(-1 - d)*EL^6*(s^2*(9*d^2 + d*(-54 + 36*sw^2 - 32*sw^4) + 
       8*(9 - 9*sw^2 + 8*sw^4)) + 2*s*(-45 + 9*d + 72*sw^2 - 64*sw^4)*t - 
     4*(9 - 36*sw^2 + 32*sw^4)*t^2)*SPList[SP[p2, q1]])/
   (cw^2*Pi^d*(mz^2 - s)*s^2*sw^2) - 
  ((I/3)*(-3 + d)*EL^6*(s + 2*t)*SPList[SP[p3, q1]])/
   (cw^2*(2*Pi)^d*s*(-mz^2 + s)*sw^2) + 
