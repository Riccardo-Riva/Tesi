...
PropList[KiraPropagator[p1 - q1, ml], KiraPropagator[-p2 - q1, ml]]*
 (((-I/9)*2^(-1 - d)*EL^6*ml^2*(3 - 20*sw^2 + 32*sw^4)*
  ...
  ((I/18)*EL^6*((2^(1 - d)*(3 - 20*sw^2 + 32*sw^4)*((-4 + d)*s^2 + 4*s*t + 
        4*t^2))/Pi^d - (s^2*(30 + 3*d^2 + 40*sw^2 - 64*sw^4 + 
         2*d*(-9 - 10*sw^2 + 16*sw^4)) + 2*s*(15 - 3*d - 40*sw^2 + 64*sw^4)*
        t + 4*(3 - 20*sw^2 + 32*sw^4)*t^2)/(2*Pi)^d)*SPList[SP[p1, q1]])/
  ...
  ((I/9)*2^(1 - d)*EL^6*(3 - 20*sw^2 + 32*sw^4)*SPList[SP[p1, p2], 
     SP[p1, q1]])/(cw^2*Pi^d*s*(-mz^2 + s)*sw^2) + 
  ((I/9)*2^(2 - d)*EL^6*(3 - 20*sw^2 + 32*sw^4)*t*
  ...
  ((I/9)*2^(1 - d)*EL^6*(3 - 20*sw^2 + 32*sw^4)*(3*s + 2*t)*
  ...
  ((I/9)*2^(1 - d)*EL^6*(3 - 20*sw^2 + 32*sw^4)*(s + t)*
    SPList[SP[p1, q1], SP[p1, q1]])/(cw^2*Pi^d*s^2*(-mz^2 + s)*sw^2) - 
  ((I/9)*2^(1 - d)*EL^6*(3 - 20*sw^2 + 32*sw^4)*SPList[SP[p1, q1], 
