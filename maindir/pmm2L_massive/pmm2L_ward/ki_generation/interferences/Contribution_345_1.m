   ...
   ((I*EL^5*gAl*gFFZ*gFll^2*mm^4*psq*s*(aa*gZlR*(mm^2 - psq) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*
      (aa*(2*gZlR*psq^2 + gZlL*mm^2*(2*psq - s - 2*t) + 
       ...
       bb*(2*gZlR*psq^2 - gZlR*mm^2*(s + 2*t) + gZlL*mm^2*
          (-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*
      (aa*gZlL*mm^2*(3*psq + s - 3*t) - bb*gZlL*mm^2*(3*psq + s - 3*t) + 
       bb*gZlR*(mm^4 + psq*s - mm^2*(3*s + t)) + 
       aa*gZlR*(mm^4 - psq*s + mm^2*(-2*psq + 3*s + t)))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^4*(bb*(psq - s - t) + 
       ...
       SP[p1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*
      (bb*gZlR*(mm^4 - psq*s + mm^2*(2*s - t)) + aa*gZlL*mm^2*
        (3*psq - 4*s - 3*t) + bb*gZlL*mm^2*(-3*psq + 4*s + 3*t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*
    ...
    (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(aa*psq*(psq - t) + 
       ...
       SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*
      (bb*(gZlR*psq*(3*psq - 2*s - 3*t) + gZlR*mm^2*(3*psq - s - 3*t) + 
         gZlL*mm^2*(-2*psq + s + 2*t)) + aa*(gZlL*mm^2*(2*psq - s - 2*t) + 
         gZlR*psq*(-3*psq + s + 3*t) + gZlR*mm^2*(-3*psq + 2*s + 3*t)))*
    ...
    (I*(aa + bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*s*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
     Pi^(2*d) - (I*(aa + bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*s*
