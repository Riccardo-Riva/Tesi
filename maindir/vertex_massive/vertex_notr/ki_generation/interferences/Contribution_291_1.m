...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((EL^6*gAl^4*mm^2*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*s*(3*(-1 + d)*mm^2 + 
  ...
  (EL^6*gAl^4*(-(2^(3 + 2*d)*(8 - 6*d + d^2)*gZlL*gZlR*mm^2*Pi^(2*d)) + 
  ...
  (EL^6*gAl^4*(4^(2 + d)*(-4 + 3*d)*gZlL*gZlR*mm^2*Pi^(2*d) + 
     gZlL^2*(2*Pi)^(2*d)*((-80 + 74*d - 21*d^2 + 2*d^3)*mm^2 - 
  ...
  (EL^6*gAl^4*(-(2^(1 + 2*d)*(-8 + 8*d - 6*d^2 + d^3)*gZlL*gZlR*mm^2*
       Pi^(2*d)) + gZlL^2*(2*Pi)^(2*d)*((-44 + 32*d - 5*d^2)*mm^2 + 
