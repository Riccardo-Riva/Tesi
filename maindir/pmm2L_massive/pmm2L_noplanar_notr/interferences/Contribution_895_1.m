  ...
  ((4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL - gZlR)^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL - gZlR)^2*mm^4*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL - gZlR)^2*
     mm^4*(6*psq^2 + 4*mm^2*(psq - t) + 2*t*(s + 2*t) - 
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL - gZlR)^2*mm^4*
     (-4*psq^2 + 4*mm^2*s - 4*psq*s + 10*s^2 - 3*d*s^2 + 8*psq*t - 4*s*t - 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL - gZlR)^2*mm^4*(-psq + s + t)*
   ...
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL - gZlR)^2*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL - gZlR)^2*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q1, q1]])/(Pi^(2*d)*s)))/4
