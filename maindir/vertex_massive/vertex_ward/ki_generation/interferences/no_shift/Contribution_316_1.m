...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
  ...
  (((-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(bb*(2*mm^2 + psq) - 
      aa*(mm^2 + 2*psq))*(4*psq - s)*s^2*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*psq*
     (3*aa*mm^2 - 2*bb*mm^2 + 2*aa*psq - 3*bb*psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
     gWWZ*gZNL*(aa*mm^2 + 4*bb*mm^2 - 4*aa*psq - bb*psq)*s^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
     gWWZ*gZNL*(3*aa*mm^2 - 2*bb*mm^2 + 2*aa*psq - 3*bb*psq)*s^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
    ...
    Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*psq*
