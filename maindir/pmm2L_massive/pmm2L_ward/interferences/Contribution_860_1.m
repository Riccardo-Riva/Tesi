...
PropList[KiraPropagator[-q1, ml], KiraPropagator[q2, mz], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(mm^2 - psq)*s*
    (bb*(3*psq - 2*s - 3*t) + aa*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) + (I*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
  ...
  (I*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
   ...
   (2*Pi)^(2*d) - (I*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*s*(-2*psq + s + 2*t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - s - t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - s - t)*
