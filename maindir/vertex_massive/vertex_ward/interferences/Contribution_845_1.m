...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, 0], 
  ...
  (-((2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*s*
   ...
   ((aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*s*(psq + s)*\[Mu]^(8 - 2*d)*
   ...
   ((aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*psq*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(mh^2*(2*Pi)^(2*d)) - 
   (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*s^2*
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(mm^2 + psq + s)*
   ...
   (EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(aa*(2*mm^2 + s) - bb*(2*psq + s))*
   ...
   ((aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(-2*psq + s)*\[Mu]^(8 - 2*d)*
