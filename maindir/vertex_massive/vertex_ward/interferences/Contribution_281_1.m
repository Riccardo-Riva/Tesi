...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*psq*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(2*aa*psq*(mm^2 + 2*psq - s) + 
     bb*psq*(-4*psq + s) + bb*mm^2*(-2*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(bb*(mm^2 + 4*psq - s) + 
     aa*(mm^2 - 6*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*mm^2 + aa*(mm^2 - 2*psq))*s*
