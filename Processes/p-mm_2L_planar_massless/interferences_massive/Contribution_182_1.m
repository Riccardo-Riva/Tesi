...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((3*4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^4*mu^2*
     sw)/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
     (4*mu^2 + 3*(s + t))*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
     (mm^2 - 4*mu^2 - s + 3*t)*SPList[SP[p1, q1], SP[p2, q2]])/
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
     (gZlL - gZlR)*mm^2*sw*(mm^2 - 4*mu^2 - 4*s - 3*t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
     (4*mu^2 - 3*t)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (3*4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
