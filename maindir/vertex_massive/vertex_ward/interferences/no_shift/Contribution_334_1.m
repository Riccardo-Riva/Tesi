...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*s*
      (aa*(4*psq^2 + d*(mm^2 - psq)*(mm^2 - s) + 6*psq*s - 2*s^2 + 
         mm^2*(-4*psq + 2*s)) + bb*(d*(mm^2 - psq)*(mm^2 - s) + 
         2*(2*mm^2*psq - 2*psq^2 - 4*psq*s + s^2)))*\[Mu]^(8 - 2*d))/
     Pi^(2*d)) + (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*
     (bb*((-4 + d)*psq^2*s + mm^4*((4 + d)*psq - (-2 + d)*s) - 
        mm^2*(d*psq^2 + 2*(6*psq - s)*s)) + 
      aa*(-(mm^4*((4 + d)*psq - 2*s)) + psq*s*(-((-4 + d)*psq) + 
          (-2 + d)*s) + mm^2*(8*psq*s + d*(psq^2 + psq*s - s^2))))*
   ...
   (2^(1 - 2*d)*d*EL^5*gAl^3*gXll^2*mm^4*s*(bb*(mm^2 + 3*psq - s) + 
   ...
   (2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(bb*mm^2*((4 + d)*psq + (-4 + d)*s) - 
      aa*(mm^2*((4 + d)*psq - 2*s) + (-2 + d)*psq*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(-2*aa*mm^4 + aa*(-4 + d)*psq*s - 
      aa*mm^2*(6*psq + (-6 + d)*s) + 2*bb*(mm^4 + 3*mm^2*psq - psq*s))*
   ...
   (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(2*aa*mm^2*((4 + d)*psq - 2*s) + 
      bb*(-4 + d)*psq*(2*psq - s) + 2*aa*psq*(-((-4 + d)*psq) + 2*s) + 
      bb*mm^2*(-2*(4 + d)*psq + (-4 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*d*EL^5*gAl^3*gXll^2*mm^2*(-4*bb*mm^2*psq + 
   ...
   (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(aa*d*(mm^2 - psq) + 2*aa*psq - 
   ...
   (2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(2*aa*((-4 + d)*mm^2 - 2*psq) - 
      bb*((-8 + d)*mm^2 + (-4 + d)*psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(5 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*d*EL^5*gAl^3*gXll^2*mm^2*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(4*aa*mm^2 + 2*aa*(-2 + d)*psq - 
