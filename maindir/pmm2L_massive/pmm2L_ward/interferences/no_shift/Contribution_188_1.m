...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
  ...
  (((-I)*(aa + bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*mm^2*(mm^2 - psq)*psq*s*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(mm^2 + psq)*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*mm^2*
   ...
   (I*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*s*(bb*(2*mm^2 - psq - t) + 
    ...
    (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*
     gWNl^2*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
