...
PropList[KiraPropagator[-p1 - p2 - q1, 0], KiraPropagator[-p3 - q1, mz], 
  ...
  KiraPropagator[p3 + q1 - q2, mz], KiraPropagator[-q2, mh]]*
 (((-I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s^2*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s^2*t*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s^2*(s + 2*t)*
  ...
  ((3*I)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(2*s + 3*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(4^d*Pi^(2*d)) - 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*(s + t)*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*t*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(3*s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(s + t)*
  ...
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(s + 2*t)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(s + t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*(s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*t*
  ...
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q1, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*t*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*(gZlL^2 + gZlR^2)*t*
