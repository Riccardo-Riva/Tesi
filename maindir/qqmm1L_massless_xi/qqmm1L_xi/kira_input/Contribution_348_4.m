(I*EL^6*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   s*\[Mu]^(4 - d)*userIntegral[A1, {0}, -2, 1, 1, 0])/
 ...
 (I*2^(-1 - 2*d)*EL^6*(gZlL^2 + gZlR^2)*
   ...
   userIntegral[A1, {0}, -1, 0, 1, 0])/(Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*2^(-1 - 2*d)*EL^6*(gZlL^2 + gZlR^2)*
 ...
 (I*EL^6*(gZlL^2 + gZlR^2)*(gZlR*gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + 
      gZuL*gZuLC*((-2 + d)*s + 2*t)) + 
    gZlL*gZlLC*(gZuL*gZuLC*(-((-4 + d)*s) + 2*t) + 
      gZuR*gZuRC*((-2 + d)*s + 2*t)))*\[Mu]^(4 - d)*
   userIntegral[A1, {0}, -1, 1, 1, -1])/((2*Pi)^d*(mz^2 - s)^2*
   (-mzC^2 + s)) - (I*2^(-1 - d)*EL^6*s*
   (gZlL*gZlLC*gZlR^2*((-4 + d)*gZuR*gZuRC*((-2 + d)*s - 2*t) - 
      gZuL*gZuLC*((-2 + d)^2*s + 2*(-4 + d)*t)) + 
    gZlL^2*gZlR*gZlRC*((-4 + d)*gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      gZuR*gZuRC*((-2 + d)^2*s + 2*(-4 + d)*t)) + 
    gZlR^3*gZlRC*((-2 + d)*gZuR*gZuRC*((-4 + d)*s + 2*t) - 
      gZuL*gZuLC*((-4 + d)^2*s - 2*(-2 + d)*t)) + 
    gZlL^3*gZlLC*((-2 + d)*gZuL*gZuLC*((-4 + d)*s + 2*t) - 
      gZuR*gZuRC*((-4 + d)^2*s - 2*(-2 + d)*t)))*\[Mu]^(4 - d)*
 ...
 (I*2^(-1 - d)*EL^6*(gZlL^2 + gZlR^2)*
   (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
    ...
    gZlR*gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
      gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*\[Mu]^(4 - d)*
   userIntegral[A1, {0}, 0, 1, 0, -1])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
 ...
 (I*EL^6*s*(2^(1 + d)*(gZlL^2 + gZlR^2)*
    ...
    gZlR^3*gZlRC*(gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
         ((4 - 3*d + d^2)*s^2 + (4 - 5*d + d^2)*s*t - 2*t^2)) + 
      gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 + 
          (14 - 7*d + d^2)*s*t + 2*t^2))) - gZlL*gZlLC*gZlR^2*
     (gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
          (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 
        2^(1 + d)*Pi^d*((8 - 7*d + d^2)*s^2 + (2 - 3*d + d^2)*s*t + 
          2*t^2))) - gZlL^2*gZlR*gZlRC*
     (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
          (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
        2^(1 + d)*Pi^d*((8 - 7*d + d^2)*s^2 + (2 - 3*d + d^2)*s*t + 2*t^2))))*
   \[Mu]^(4 - d)*userIntegral[A1, {0}, 0, 1, 1, 0])/
  (2^(2*(1 + d))*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s))
