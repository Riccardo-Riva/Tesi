  ...
  (((-I)*EL^6*(-2*gZlL^3*gZlLC*s*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
      ...
      t*(gZlL^3*gZlLC*(gZuR*gZuRC*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
         ...
         (gZuL*gZuLC*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
            ...
            2^(1 + d)*Pi^d*(2*(4 - 5*d + 2*d^2)*s^2 - (-28 + 28*d - 9*d^2 + 
                d^3)*s*t - 2*(-2 + d)*t^2)))))*\[Mu]^(4 - d))/
    (2^(2*(1 + d))*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)) - 
   (I*2^(-1 - 2*d)*EL^6*(gZlL^3*gZlLC*
       (-(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2*t) + 2^(1 + d)*(8 - 6*d + d^2)*mz^2*
            Pi^d*s*(s + 2*t) + 2^(1 + d)*Pi^d*t*((-4 + 3*d)*s^2 - 
             (4 - 5*d + d^2)*s*t + 2*t^2))) + gZuL*gZuLC*
         (2^(1 + d)*mz^2*Pi^d*s*((-2 + d)^2*s + 2*(10 - 6*d + d^2)*t) - 
          t*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
              (8 - 5*d + d^2)*s*t + 2*t^2)))) - 
      gZlR^3*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2*t) + 
          2^(1 + d)*(8 - 6*d + d^2)*mz^2*Pi^d*s*(s + 2*t) + 
          2^(1 + d)*Pi^d*t*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
        gZuR*gZuRC*(-(2^(1 + d)*mz^2*Pi^d*s*((-2 + d)^2*s + 
             2*(10 - 6*d + d^2)*t)) + t*(d^2*(2*Pi)^d*s^2 + 
            2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
              2*t^2)))))*\[Mu]^(4 - d)*SPList[SP[p1, p2]])/
    (mz^2*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)) + 
   (I*2^(-1 - 2*d)*EL^6*(gZlL^3*gZlLC*(gZuR*gZuRC*(3*d^2*(2*Pi)^d*s^2*t - 
          2^(1 + d)*mz^2*Pi^d*s*((40 - 22*d + 3*d^2)*s + 
            2*(28 - 18*d + 3*d^2)*t) - 3*2^(1 + d)*Pi^d*t*((-4 + 3*d)*s^2 - 
            (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuL*gZuLC*
         (2^(1 + d)*mz^2*Pi^d*s*((20 - 16*d + 3*d^2)*s + 
       ...
       (gZuL*gZuLC*(2^(1 + d)*mz^2*Pi^d*s*((40 - 22*d + 3*d^2)*s + 
        ...
        gZuR*gZuRC*(-(2^(1 + d)*mz^2*Pi^d*s*((20 - 16*d + 3*d^2)*s + 
             2*(26 - 18*d + 3*d^2)*t)) + 3*t*(d^2*(2*Pi)^d*s^2 + 
            2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
              2*t^2)))))*\[Mu]^(4 - d)*SPList[SP[p1, p3]])/
    (mz^2*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)) + 
   (I*2^(-1 - d)*EL^6*(gZlR^3*gZlRC*
       (gZuR*gZuRC*(-((-2 + d)*mz^2*((-4 + d)^2*s^2 + 2*(22 - 9*d + d^2)*s*
              t + 4*t^2)) + t*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
            4*t^2)) - gZuL*gZuLC*(t*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*
             s*t - 4*t^2) + mz^2*(-((-4 + d)^3*s^2) - 
            2*(-40 + 36*d - 11*d^2 + d^3)*s*t + 4*(-2 + d)*t^2))) + 
      gZlL^3*gZlLC*(gZuL*gZuLC*(-((-2 + d)*mz^2*((-4 + d)^2*s^2 + 
   ...
   (I*EL^6*(gZlL^3*gZlLC*(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 
     ...
     SPList[SP[p1, p2], SP[p1, q1]])/(mz^2*(2*Pi)^d*(mz^2 - s)*
   ...
   (I*EL^6*(gZlL^3*gZlLC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 
    ...
    (mz^2*(2*Pi)^(2*d)*(mz^2 - s)*(-mzC^2 + s)) + 
   (I*(-2 + d)*EL^6*(gZlR^3*gZlRC*(gZuR*gZuRC*(-((-10 + d)*s) + 2*t) + 
        gZuL*gZuLC*((4 + d)*s + 2*t)) + gZlL^3*gZlLC*
       (gZuL*gZuLC*(-((-10 + d)*s) + 2*t) + gZuR*gZuRC*((4 + d)*s + 2*t)))*
     \[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p3, q1]])/
    ((2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)) - 
   ((3*I)*2^(-1 - 2*d)*EL^6*
    ...
    (mz^2*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)) + 
   (I*(-2 + d)*EL^6*(gZlR^3*gZlRC*(-((-2 + d)*gZuL*gZuLC) + 
        (-4 + d)*gZuR*gZuRC) + gZlL^3*gZlLC*((-4 + d)*gZuL*gZuLC - 
   ...
   (I*EL^6*(gZlL^3*gZlLC*(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 
       ...
       (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2 + 
        ...
        gZuR*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2 + 
          (-2 + d)*mz^2*((-2 + d)*s + 2*(-3 + d)*t))))*\[Mu]^(4 - d)*
     SPList[SP[p1, q1], SP[p2, p3]])/(mz^2*(2*Pi)^d*(mz^2 - s)*
     (-mzC^2 + s)) - 
   (I*EL^6*(gZlL^3*gZlLC*(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 
          2*(4 - 5*d + d^2)*s*t - 4*t^2 + (-2 + d)*mz^2*((-4 + d)*s + 
            2*(-3 + d)*t)) - gZuL*gZuLC*((-2 + d)^2*s^2 + 
       ...
       (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2 + 
        ...
        gZuR*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2 + 
          (-2 + d)*mz^2*((-2 + d)*s + 2*(-3 + d)*t))))*\[Mu]^(4 - d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*(2*Pi)^d*(mz^2 - s)*
     (-mzC^2 + s)) + (I*(-2 + d)*EL^6*
   ...
   (I*2^(-1 - d)*EL^6*(gZlL^3*gZlLC*
      ...
      gZlR^3*gZlRC*(-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
           ...
           t + 4*t^2)))*\[Mu]^(4 - d)*SPList[SP[p1, q1], SP[q1, q1]])/
    (mz^2*Pi^d*(mz^2 - s)*(-mzC^2 + s)) - 
   (I*EL^6*(gZlL^3*gZlLC*(gZuL*gZuLC*(2^(2 + d)*(-1 + d)*Pi^d - 
          d^2*(2*Pi)^d) + gZuR*gZuRC*(2^(1 + d)*(4 - 3*d)*Pi^d + 
          d^2*(2*Pi)^d)) - gZlR^3*gZlRC*
 ...
 PropList[KiraPropagator[-p1 + q1, 0], KiraPropagator[p2 + q1, 0], 
  ...
  ((I*2^(-2 - d)*EL^6*t^2*
     (gZlL^3*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
       ...
       (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) + 
        gZuR*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2)))*
     \[Mu]^(4 - d))/(mz^2*Pi^d*(mz^2 - s)*(-mzC^2 + s)) - 
   (I*2^(-1 - 2*d)*EL^6*t*
     (gZlL^3*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
           ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
        gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
       ...
       (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
            (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
          2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
     \[Mu]^(4 - d)*SPList[SP[p1, p2]])/(mz^2*Pi^(2*d)*(mz^2 - s)*
     (-mzC^2 + s)) + ((3*I)*2^(-1 - 2*d)*EL^6*t*
     (gZlL^3*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
           ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
        gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
            (8 - 5*d + d^2)*s*t + 2*t^2))) + gZlR^3*gZlRC*
       (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
            (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
          2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
     \[Mu]^(4 - d)*SPList[SP[p1, p3]])/(mz^2*Pi^(2*d)*(mz^2 - s)*
     (-mzC^2 + s)) - (I*2^(-1 - d)*EL^6*t*
     (gZlL^3*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
            t - 4*t^2)) + gZuL*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*
           t + 4*t^2)) + gZlR^3*gZlRC*
       (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) + 
        gZuR*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2)))*
     \[Mu]^(4 - d)*SPList[SP[p1, q1]])/(mz^2*Pi^d*(mz^2 - s)*(-mzC^2 + s)) + 
   (I*2^(-1 - 2*d)*EL^6*t*
     (gZlL^3*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
           ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
        gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
       ...
       (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
            (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
          2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
     \[Mu]^(4 - d)*SPList[SP[p2, p3]])/(mz^2*Pi^(2*d)*(mz^2 - s)*
     (-mzC^2 + s)) + (I*2^(-1 - 2*d)*EL^6*t*
     (gZlL^3*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
           ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
        gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
            (8 - 5*d + d^2)*s*t + 2*t^2))) + gZlR^3*gZlRC*
       (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
            (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
          2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
     \[Mu]^(4 - d)*SPList[SP[p2, q1]])/(mz^2*Pi^(2*d)*(mz^2 - s)*
     (-mzC^2 + s)) + (I*2^(-1 - d)*EL^6*t*
     (gZlL^3*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
            t - 4*t^2)) + gZuL*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*
           t + 4*t^2)) + gZlR^3*gZlRC*
       (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) + 
        gZuR*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2)))*
     \[Mu]^(4 - d)*SPList[SP[q1, q1]])/(mz^2*Pi^d*(mz^2 - s)*(-mzC^2 + s)) + 
   (I*EL^6*
     ((3*(gZlL^3*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*
               s*t - 4*t^2)) + gZuL*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*
              s*t + 4*t^2)) + gZlR^3*gZlRC*
          (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
              4*t^2)) + gZuR*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
             4*t^2))))/(2*Pi)^d - 
      (4^(1 - d)*(gZlL^3*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
             2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
           gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
               (8 - 5*d + d^2)*s*t + 2*t^2))) + gZlR^3*gZlRC*
          (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
             ...
             2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*
                t^2)))))/Pi^(2*d))*\[Mu]^(4 - d)*SPList[SP[p1, p2], 
      SP[p1, p3]])/(mz^2*(mz^2 - s)*(-mzC^2 + s)) + 
   (I*EL^6*((2^(1 - d)*(gZlL^3*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 
              2*(4 - 5*d + d^2)*s*t - 4*t^2)) + gZuL*gZuLC*((-2 + d)^2*s^2 + 
             2*(8 - 5*d + d^2)*s*t + 4*t^2)) + gZlR^3*gZlRC*
          (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
              4*t^2)) + gZuR*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
     ...
     ((3*(gZlL^3*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*
      ...
      (4^(1 - d)*(gZlL^3*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
          ...
          (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
               (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
             2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*
                t^2)))))/Pi^(2*d))*\[Mu]^(4 - d)*SPList[SP[p1, p3], 
      SP[p2, p3]])/(mz^2*(mz^2 - s)*(-mzC^2 + s)) - 
   (I*EL^6*
     ((3*(gZlL^3*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*
               s*t - 4*t^2)) + gZuL*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*
              s*t + 4*t^2)) + gZlR^3*gZlRC*
