...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*(psq - t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*
    sw*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*\[Mu]^(8 - 2*d)*
