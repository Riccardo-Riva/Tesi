...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((4^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*mm^2*
     (-((-2 + d)^2*mm^4*(2*Pi)^(2*d)*s) + 2^(1 + 2*d)*mm^2*Pi^(2*d)*
      ...
      (2*Pi)^(2*d)*s*((8 - 4*d + d^2)*psq^2 + (-2 + d)*s^2 + 4*s*t + 4*t^2 - 
        4*psq*((-2 + d)*s + 2*t)))*\[Mu]^(8 - 2*d))/(Pi^(4*d)*s^2) + 
   (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*(6*psq^2 - 2*s^2 + d*s^2 + 
      4*s*t + 4*t^2 + mm^2*(-2*psq + d*s + 2*t) - psq*(d*s + 10*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^4*gAu^2*mm^2*
     (4*d*gZlL*gZlR*(6*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 + 
        mm^2*(-2*psq + d*s + 2*t) - psq*(d*s + 10*t)) + 
   ...
   (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*(2*psq^2 - 2*s^2 + d*s^2 + 
   ...
   (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*(4*psq^2 + 2*mm^2*s - 
      2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 2*psq*(s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*mm^2*(d^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s - 
      4*(gZlL^2 + gZlR^2)*(4*mm^2 - 2*psq - 3*s)*s + 
      2*d^2*s*(-(gZlL*gZlR*s) + gZlL^2*(-3*mm^2 + 3*psq + s) + 
        gZlR^2*(-3*mm^2 + 3*psq + s)) - 
      2*d*(gZlL^2*s*(-8*mm^2 + 6*psq + 5*s) + gZlR^2*s*(-8*mm^2 + 6*psq + 
          5*s) + 2*gZlL*gZlR*(2*psq^2 + mm^2*s - s^2 + 2*s*t + 2*t^2 - 
          psq*(s + 4*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    (Pi^(2*d)*s^2) - (4^(1 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(4*d)*s^2) - (4^(1 - 2*d)*EL^8*gAl^4*gAu^2*
     (4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(4*psq^2 + 2*mm^2*s - 2*s^2 + 
        d*s^2 + 4*s*t + 4*t^2 - 2*psq*(s + 4*t)) + 
      gZlL^2*(-((-24 + 24*d - 8*d^2 + d^3)*mm^4*(2*Pi)^(2*d)*s) + 
        2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(4*psq^2 + (12 - 6*d + d^2)*psq*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*((-2 + d)*gZlL^2*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
      mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^4*gAu^2*(-4*d*gZlL*gZlR*mm^2*(-2*psq + (-2 + d)*s + 
        2*t) + gZlL^2*(-2*(-8 - 2*d + d^2)*psq^2 - 8*(-4 + d)*s^2 + 
        4*(14 - 3*d)*s*t - 8*(-4 + d)*t^2 + (-4 + d)*mm^2*
         (2*(-2 + d)*psq + (24 - 12*d + d^2)*s - 2*(-2 + d)*t) - 
        (-4 + d)*psq*((24 - 12*d + d^2)*s - 2*(6 + d)*t)) + 
      gZlR^2*(-2*(-8 - 2*d + d^2)*psq^2 - 8*(-4 + d)*s^2 + 4*(14 - 3*d)*s*t - 
        8*(-4 + d)*t^2 + (-4 + d)*mm^2*(2*(-2 + d)*psq + (24 - 12*d + d^2)*
           s - 2*(-2 + d)*t) - (-4 + d)*psq*((24 - 12*d + d^2)*s - 
          2*(6 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*mm^2*
     (-((-2 + d)^2*gZlL^2*(psq - s - t)) - (-2 + d)^2*gZlR^2*(psq - s - t) + 
      4*gZlL*gZlR*((8 - 7*d + d^2)*psq - (4 - 5*d + d^2)*s - 
        (8 - 7*d + d^2)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*
     ((-2 + d)*gZlL^2*(mm^2 - psq)*(2*mm^2 - 2*psq + (-3 + d)*s) + 
      (-2 + d)*gZlR^2*(mm^2 - psq)*(2*mm^2 - 2*psq + (-3 + d)*s) - 
      2*d*gZlL*gZlR*mm^2*(2*mm^2 + 4*psq - 6*s + d*s - 6*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(8*d*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
      (-2 + d)*gZlL^2*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
        6*psq*(s + 2*t) + mm^2*(-4*psq + 6*s + 4*t)) + 
      (-2 + d)*gZlR^2*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
        6*psq*(s + 2*t) + mm^2*(-4*psq + 6*s + 4*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
     ...
     (gZlL^2 + gZlR^2)*(mm^2 - psq)*(2*psq - (-2 + d)*s - 2*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*mm^2*(-((-2 + d)^2*gZlL^2*(psq - t)) - 
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*mm^2*(-4*(4 - 6*d + d^2)*gZlL*gZlR*psq + 
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gZlL*gZlR*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*(-4*d*gZlL*gZlR*mm^2*s + 
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*((-2 + d)^2*gZlL^2 - 2*(4 - 6*d + d^2)*gZlL*
