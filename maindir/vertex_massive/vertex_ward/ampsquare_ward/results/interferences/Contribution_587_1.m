...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, 0], 
   ...
   (((-I)*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*s*(s + t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*s*(2*s + 3*t)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^5*s*(s + 2*t)*
    ...
    (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*(2*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
    (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*((-2 + d)*s + 2*(-3 + d)*t)*
