...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl*gAu*t*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
      ...
      \[Mu]^(4 - d)*SPList[SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*(mzC^2 - s)) - 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl*gAu*(gZlR*gZlRC*(gZuR*gZuRC*(d^3*(2*Pi)^d*s*(s + 3*t) + 
      ...
      (-(gZlR*gZlRC*(gZuR*gZuRC*(d^3*(2*Pi)^d*s + 2^(2 + d)*Pi^d*
       ...
       gZlL*gZlLC*(gZuL*gZuLC*(-(d^3*(2*Pi)^d*s) + 2^(2 + d)*Pi^d*
         ...
         gZuR*gZuRC*(d^3*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((-4 + 9*d - 4*d^2)*s + 
             4*(12 - 7*d + d^2)*t))))*\[Mu]^(4 - d)*SPList[SP[p1, q1], 
       SP[p2, q1]])/(Pi^(2*d)*(mzC^2 - s)) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*(gZlR*gZlRC*(-3*d^3*gZuL*gZuLC*(2*Pi)^d*s + 
         3*d^3*gZuR*gZuRC*(2*Pi)^d*s - 2^(1 + d)*gZuR*gZuRC*Pi^d*
          (2*(54 - 41*d + 10*d^2)*s - (-52 + 44*d - 12*d^2 + d^3)*t) + 
         2^(1 + d)*gZuL*gZuLC*Pi^d*((108 - 83*d + 20*d^2)*s - 
           (-56 + 46*d - 12*d^2 + d^3)*t)) + gZlL*gZlLC*
        (3*d^3*gZuL*gZuLC*(2*Pi)^d*s - 3*d^3*gZuR*gZuRC*(2*Pi)^d*s - 
         2^(1 + d)*gZuL*gZuLC*Pi^d*(2*(54 - 41*d + 10*d^2)*s - 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
        ...
        (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
           ...
           2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
      \[Mu]^(4 - d)*SPList[SP[p1, q1], SP[q1, q1]])/
     (mz^2*Pi^(2*d)*(mzC^2 - s)) + (I*2^(1 - d)*EL^6*gAl*gAu*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      ...
      \[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*(mzC^2 - s)) + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl*gAu*t*(gZlL*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 
        ...
        (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
           ...
           4*t^2)))*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[q1, q1]])/
     ((2*Pi)^d*(mzC^2 - s)) - (I*EL^6*gAl*gAu*\[Mu]^(4 - d)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
      ...
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/(mz^2*Pi^d*(mzC^2 - s)) + 
    (I*2^(2 - d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
       ...
       gZlR*gZlRC*(gZuL*gZuLC*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
         gZuR*gZuRC*((-2 + d)*s^2 + 4*s*t + 2*t^2)))*\[Mu]^(4 - d)*
    ...
    (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL*gZlLC + gZlR*gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*t^2*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*EL^6*gAl*gAu*t*(s + t)*\[Mu]^(4 - d)*
      ...
      (-1 + GaugeXi[Q])) + (I*EL^6*gAl*gAu*t^2*\[Mu]^(4 - d)*
      (gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))) + 
       gZlL*gZlLC*(gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))) - 
    ...
    (I*EL^6*gAl*gAu*s*t*\[Mu]^(4 - d)*
      (-(gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s - 
          2^(1 + d)*gZuR*gZuRC*Pi^d*(s + d*s - t) + 2^(1 + d)*gZuL*gZuLC*Pi^d*
           ((2 + d)*s + t))) + gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
