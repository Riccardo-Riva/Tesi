   ...
   (-((2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*mm^2 - s)*
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(4*(-5 + d)*psq^3 + 
       ...
       2*(s^3 + s^2*t + 4*s*t^2 + 4*t^3) + mm^2*(-4*(-5 + d)*psq^2 - 
         (8 + 5*d)*psq*s + 8*(-5 + d)*psq*t + (s + t)*((4 + d)*s - 
           4*(-5 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s) - 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(8*psq^3 - 4*psq^2*(d*s + 6*t) - 
       mm^2*s*((4 + d)*s + 4*(1 + d)*t) + psq*(4*(1 + d)*mm^2*s + 
         (4 + d)*s^2 + 4*(3 + d)*s*t + 24*t^2) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*mm^2 - s)*
     ...
     Pi^(2*d) + (4^(1 - d)*(-2 + 3*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(4*mm^2 - 6*psq + s + 2*t)*
      ...
      (-4*(2 + d)*psq^3 + 8*t*(s + t)^2 + psq^2*((4 + d)*s + 8*(3 + d)*t) - 
       psq*(s + t)*((-4 + d)*s + 4*(6 + d)*t) + 
       mm^2*(4*(-1 + d)*psq^2 + psq*(-((-10 + d)*s) - 8*(-1 + d)*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-12 + d)*psq^3 - 
       ...
       2*t*(s^2 + 3*s*t + 2*t^2) + psq*(-2*s^2 + (-18 + d)*s*t + 
         (-20 + d)*t^2) + mm^2*(-((-16 + d)*psq^2) + (-22 + d)*psq*s + 
         4*s^2 + 2*(-16 + d)*psq*t - (-22 + d)*s*t - (-16 + d)*t^2))*
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*(psq - t)*
    ...
    (3*2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)*(-psq + s + t)*
