...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   ((EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*
    ...
    (2^(1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
      (aa*psq*(2*psq - s) - bb*(2*psq^2 - 2*mm^2*s + psq*s))*sw*
    ...
    (4^(1 - d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) - (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*(2*mm^2 + 2*psq + s)*sw*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
    (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
      (2*psq - s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)) - (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*(4*psq - s)*sw*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) + (4^(1 - d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*psq*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
