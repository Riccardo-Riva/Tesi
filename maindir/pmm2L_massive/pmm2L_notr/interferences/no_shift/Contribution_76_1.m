...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (gZlR*mm^2*(4*(-4 + d)*psq^2 + d^2*s^2 - 4*t*(5*s + 4*t) + 
        4*psq*(s - 2*(-4 + d)*t) + 4*d*(-s^2 + s*t + t^2)) + 
      gZlL*(-2*(-2 + d)*mm^4*(psq - s - t) + 
        2*mm^2*(2*psq^2 + (7 - 6*d + d^2)*psq*s + s^2 - 4*psq*t + 3*s*t + 
          2*t^2) + psq*(2*(-8 + 3*d)*psq^2 + (10 - 6*d + d^2)*s^2 + 
          2*(-5 + 2*d)*s*t + 4*(-3 + d)*t^2 - 2*psq*((7 - 5*d + d^2)*s + 
            (-14 + 5*d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (gZlR*mm^2*(4*(-4 + d)*psq^2 + (-2 + d)^2*s^2 + 4*(-3 + d)*s*t + 
        4*(-4 + d)*t^2 - 4*psq*(s + 2*(-4 + d)*t)) + 
      gZlL*(2*(-2 + d)*mm^4*(psq - t) + 2*mm^2*(2*psq^2 + 
          psq*((-3 + d)^2*s - 4*t) + t*(s + 2*t)) + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-2*(-1 + d)*gZlR*mm^2*(4*psq^2 + (-4 + d)*s^2 - 8*psq*t + 4*s*t + 
        4*t^2) + gZlL*(-4*(-2 + d)*psq^3 + 2*(6 - 5*d + d^2)*mm^4*s + 
        2*psq^2*((6 - 3*d + d^2)*s + 4*(-2 + d)*t) + 
        2*s*((-2 + d)*s^2 + 4*s*t + 4*t^2) - psq*((-6 + 2*d + d^2)*s^2 + 
          4*(2 + d)*s*t + 4*(-2 + d)*t^2) + mm^2*(4*(-2 + d)*psq^2 + 
          (-2 - 2*d + d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2 - 
          4*(-2 + d)*psq*((-2 + d)*s + 2*t))))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-2*gZlR*mm^2*(4*(-1 + d)*psq^2 + (8 - 6*d + d^2)*s^2 - 
        8*(-1 + d)*psq*t + 4*(-1 + d)*s*t + 4*(-1 + d)*t^2) + 
      gZlL*(2*(6 - 5*d + d^2)*mm^4*s + s*(2*(8 - 5*d + d^2)*psq^2 + 
          (-2 + d)*s^2 + 4*s*t + 4*t^2 - 4*psq*((-2 + d)*s + 2*t)) + 
        2*(-2 + d)*mm^2*(4*psq^2 + (-3 + d)*s^2 + 4*s*t + 4*t^2 - 
          2*psq*((-3 + d)*s + 4*t))))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-2*gZlR*mm^2*(4*(-1 + d)*psq^2 + (12 - 7*d + d^2)*s^2 - 
        8*(-1 + d)*psq*t + 4*(-1 + d)*s*t + 4*(-1 + d)*t^2) + 
      gZlL*(2*(6 - 5*d + d^2)*mm^4*s + psq*(4*(-2 + d)*psq^2 + 
          (10 - 6*d + d^2)*s^2 + 2*(-2 + d)*psq*((-5 + d)*s - 4*t) + 
          4*(-2 + d)*s*t + 4*(-2 + d)*t^2) + mm^2*(12*(-2 + d)*psq^2 + 
          (26 - 18*d + 3*d^2)*s^2 + 12*(-2 + d)*s*t + 12*(-2 + d)*t^2 - 
          4*(-2 + d)*psq*((-4 + d)*s + 6*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*(-2*(-1 + d)*gZlR*mm^2*s^2 + 
      gZlL*(8*(-2 + d)*psq^3 + 4*psq^2*((-1 + d)*s - 4*(-2 + d)*t) + 
        s*((-2 + d)*s^2 + 4*s*t + 4*t^2) + psq*((34 - 19*d + 2*d^2)*s^2 + 
          8*(-3 + d)*s*t + 8*(-2 + d)*t^2) + mm^2*(8*(-2 + d)*psq^2 + 
          (22 - 13*d + 2*d^2)*s^2 + 8*(-2 + d)*s*t + 8*(-2 + d)*t^2 - 
          4*(-2 + d)*psq*(s + 4*t))))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-((-2 + d)*gZlR*mm^2*s) + gZlL*psq*(2*psq + (-4 + d)*s - 2*t) + 
      2*gZlL*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gWWZ*(gZlR*mm^2*(2*(-4 + d)*psq + (4 + 2*d - d^2)*s - 2*(-4 + d)*t) + 
      gZlL*(-2*(-5 + 2*d)*mm^2*(psq - s - t) + 
        psq*(2*(-7 + 3*d)*psq + (30 - 20*d + 3*d^2)*s + 2*(7 - 3*d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     ((-4 + d)*gZlR*mm^2*s + gZlL*(2*mm^4 + mm^2*(-4*psq + s) + 
        psq*(2*psq + 3*s - d*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gWWZ*((-4 + d)*gZlR*mm^2*(6*psq + (-6 + d)*s - 6*t) + 
      gZlL*(2*(-2 + d)*mm^4 + mm^2*((22 - 8*d)*psq + 2*(-4 + d)*s - 6*t) + 
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
      ...
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gWWZ*(-2*(-4 + d)*gZlR*mm^2*s + 
      gZlL*(2*psq^2 + (25 - 15*d + 2*d^2)*psq*s - 3*s^2 + d*s^2 - 4*psq*t + 
        s*t + 2*t^2 - mm^2*(2*(-2 + d)*psq + (16 - 9*d + d^2)*s - 
          2*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     gZlL*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
      mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gWWZ*(-2*(-1 + d)*gZlR*mm^2*s + gZlL*(-2*(1 + 2*d)*psq^2 + 
        (-47 + 27*d - 3*d^2)*psq*s - 9*s^2 + d*s^2 + 4*(3 + d)*psq*t - 
        17*s*t - 10*t^2 + mm^2*(6*(-2 + d)*psq + (34 - 19*d + 2*d^2)*s - 
          6*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-((-6 + d)*gZlL*mm^2*(psq - s - t)) - 2*(-1 + d)*gZlR*mm^2*
       (psq - s - t) + gZlL*psq*(-((2 + d)*psq) + (14 - 7*d + d^2)*s + 
        (2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     ((-4 + d)*gZlR*mm^2*(-6*psq + d*s + 6*t) + 
      gZlL*(2*(-2 + d)*mm^4 - 2*mm^2*((-5 + 4*d)*psq + s - d*s - 3*t) + 
        psq*(6*psq + (-34 + 20*d - 3*d^2)*s + 6*(-3 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*(2*(-1 + d)*gZlR*mm^2*s + 
      gZlL*mm^2*(8*(-2 + d)*psq + (-6 + d)*s) + 
      gZlL*psq*(-8*(-2 + d)*psq + (-46 + 21*d - 2*d^2)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (2*gZlR*mm^2*(-4*(-1 + d)*psq + 3*d*s - 4*t + 4*d*t) + 
      gZlL*(-12*(-2 + d)*psq^2 - (6 - 10*d + d^2)*psq*s - 20*s^2 + 8*d*s^2 - 
        d^2*s^2 + 16*(-2 + d)*psq*t - 4*d*s*t + 8*t^2 - 4*d*t^2 + 
        mm^2*(8*(-2 + d)*psq + (18 - 12*d + d^2)*s - 8*(-2 + d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-2*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
      gZlL*(4*(-1 + d)*psq^2 - 14*s^2 + 4*d*s^2 - 2*s*t + 4*t^2 + 
        mm^2*(4*(-2 + d)*psq + (34 - 21*d + 3*d^2)*s - 4*(-2 + d)*t) - 
        psq*((-8 + d + d^2)*s + 4*d*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     ((-2 + d)*gZlL*mm^2*(4*psq + (-7 + d)*s - 4*t) + 
      gZlL*s*(-((4 - 5*d + d^2)*psq) + (-4 + d)*s - 2*t) - 
      4*(-1 + d)*gZlR*mm^2*(psq - s - t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-4*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
      gZlL*(4*(-6 + d)*psq^2 + (-68 + 42*d - 6*d^2)*psq*s - 20*s^2 + 
        d^2*s^2 - 8*(-6 + d)*psq*t - 40*s*t + 4*d*s*t - 24*t^2 + 4*d*t^2 + 
        2*mm^2*(8*(-2 + d)*psq + (42 - 25*d + 3*d^2)*s - 8*(-2 + d)*t)))*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-((-2 + d)*gZlR*mm^2*s) + 2*gZlL*mm^2*(psq - t) + 
      gZlL*psq*(-2*psq + (-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-(gZlR*mm^2*(2*(-4 + d)*psq + (-2 + d)^2*s - 2*(-4 + d)*t)) + 
      gZlL*(2*(-5 + 2*d)*mm^2*(psq - t) + psq*((14 - 6*d)*psq + 
          (16 - 14*d + 3*d^2)*s + 2*(-7 + 3*d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     (-2*s^2 + d*s^2 + 2*mm^2*(2*psq + s - 2*t) + 4*s*t + 4*t^2 - 
      2*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-2*(-4 + d)*gZlR*mm^2*s + gZlL*(2*psq^2 + (23 - 15*d + 2*d^2)*psq*s - 
        2*s^2 + d*s^2 - 4*psq*t + 3*s*t + 2*t^2 + 
        mm^2*(2*(-2 + d)*psq - (12 - 7*d + d^2)*s - 2*(-2 + d)*t)))*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-2*(-1 + d)*gZlR*mm^2*s + gZlL*(2*(-9 + 2*d)*psq^2 + 
        (-53 + 23*d - 3*d^2)*psq*s - 2*s^2 + d*s^2 - 4*(-7 + d)*psq*t - 
        3*s*t - 10*t^2 + mm^2*(-6*(-2 + d)*psq + (22 - 13*d + 2*d^2)*s + 
          6*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     ((-6 + d)*gZlL*mm^2*(psq - t) + 2*(-1 + d)*gZlR*mm^2*(psq - t) + 
      gZlL*psq*((2 + d)*psq + (12 - 8*d + d^2)*s - (2 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (2*gZlR*mm^2*(-4*(-1 + d)*psq + (-4 + d)*s + 4*(-1 + d)*t) + 
      gZlL*(-4*(-2 + d)*psq^2 + (6 - 2*d + d^2)*psq*s + 12*s^2 - 8*d*s^2 + 
        d^2*s^2 - 16*s*t + 4*d*s*t - 8*t^2 + 4*d*t^2 + 
        mm^2*(8*(-2 + d)*psq - (2 - 4*d + d^2)*s - 8*(-2 + d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (2*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
      gZlL*(-4*(-3 + d)*psq^2 - (12 - 3*d + d^2)*psq*s - 8*s^2 + 4*d*s^2 + 
        4*(-4 + d)*psq*t + 10*s*t + 4*t^2 + mm^2*(-4*(-2 + d)*psq + 
          (26 - 17*d + 3*d^2)*s + 4*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     ((-2 + d)*gZlL*mm^2*(4*psq - (-3 + d)*s - 4*t) + 
      gZlL*s*((8 - 5*d + d^2)*psq - (-2 + d)*s - 2*t) - 
      4*(-1 + d)*gZlR*mm^2*(psq - t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     (-4*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
      gZlL*(-4*(-6 + d)*psq^2 + 2*(50 - 21*d + 3*d^2)*psq*s + 4*s^2 - 
        d^2*s^2 + 8*(-6 + d)*psq*t + 8*s*t - 4*d*s*t + 24*t^2 - 4*d*t^2 + 
        2*mm^2*(8*(-2 + d)*psq + (-26 + 17*d - 3*d^2)*s - 8*(-2 + d)*t)))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*(-8*(-1 + d)*gZlR*mm^2*s + 
      gZlL*(4*(-2 + d)*psq^2 - 4*(10 - 7*d + d^2)*mm^2*s + 22*s^2 - 
        10*d*s^2 + d^2*s^2 + 4*(-2 + d)*psq*((-4 + d)*s - 2*t) - 8*s*t + 
        4*d*s*t - 8*t^2 + 4*d*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     (4*psq^2 + 4*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(12*(-2 + d)*psq^2 - 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*(2*(-1 + d)*gZlR*mm^2 + 
      gZlL*((8 - 6*d + d^2)*mm^2 + 2*d*psq - d^2*psq - 9*s + 3*d*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*((10 - 7*d + d^2)*gZlL*mm^2 + 
      2*(-1 + d)*gZlR*mm^2 - (-3 + d)*gZlL*((-2 + d)*psq - s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*(-4*(-1 + d)*gZlR*mm^2*s + 
      gZlL*(4*(-2 + d)*psq^2 - 2*(12 - 8*d + d^2)*mm^2*s + 42*s^2 - 
        15*d*s^2 + d^2*s^2 + 2*(-2 + d)*psq*((-2 + d)*s - 4*t) - 8*s*t + 
        4*d*s*t - 8*t^2 + 4*d*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(-psq + s + t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(-psq + s + t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gWWZ*gZlL*(6*(-2 + d)*mm^2 + (22 - 9*d)*psq - 8*s + 3*d*s - 10*t + 
      3*d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*((-6 + d)*gZlL*mm^2 + 
   ...
   (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     (-2*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
   ...
   (4^(2 - d)*(22 - 8*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     gZlL*(2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(psq - t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(22 - 8*d + d^2)*EL^8*gAl^2*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     gWlN*gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
     gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
     gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (3*4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
     gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
