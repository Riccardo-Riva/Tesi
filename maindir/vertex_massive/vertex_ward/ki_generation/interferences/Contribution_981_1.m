...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 - q2, mw], 
 ...
 ((2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*s*
    (-6*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*s*
    (-6*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  ((aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(2*psq - s)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(2*psq - s)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(4*psq - s)*
    s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(4*psq - s)*
    s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  ((aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(6*psq - s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) - 
  ((aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(6*psq - s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(2*Pi)^(2*d) - 
  ((aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(4*psq - 3*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(2*psq - s)*
