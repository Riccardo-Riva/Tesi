   ...
   ((I*EL^5*gAl*gWlN*gWNl*gZNL*mm^2*
      (bb*((12 - 8*d + d^2)*gZlR*s*(-psq + s + t) + 
         gZlL*(-((16 - 10*d + d^2)*psq^2) - 2*(20 - 9*d + d^2)*psq*s - 
           ...
           (-4 + d)^2*s*(s + t))) - aa*((12 - 8*d + d^2)*gZlR*s*
          (-psq + s + t) + gZlL*(-((16 - 10*d + d^2)*psq^2) - 
           2*(16 - 7*d + d^2)*psq*s + (16 - 10*d + d^2)*psq*t + 
           (-4 + d)^2*s*(s + t) - (-2 + d)*mm^2*((-8 + d)*psq + 4*s - d*s + 
             8*t - d*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
    ...
    (I*EL^5*gAl*gWlN*gWNl*gZNL*mm^2*s*(aa*(-2 + d)^2*gZlR*(2*psq - s - 2*t) - 
       ...
       bb*(-4 + d)*gZlL*((-2 + d)*mm^2 + (10 - 3*d)*psq + 
         (-4 + d)*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
     (2*Pi)^(2*d) - (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*s*
      (aa*(-2 + d)*gZlR*mm^2*(2*psq - s - 2*t) - bb*(-2 + d)*gZlR*mm^2*
        (2*psq - s - 2*t) + aa*gZlL*((-4 + d)*mm^4 - (-8 + d)*psq*
          (psq - s - t) + mm^2*(-2*(-6 + d)*psq + (-8 + d)*t)) + 
       bb*gZlL*((-4 + d)*mm^4 + (-8 + d)*psq*(psq - t) - 
         mm^2*(4*psq + (-8 + d)*(s + t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/(2*Pi)^(2*d) - 
    (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*mm^2*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gZNL*
      (aa*(-2 + d)^2*gZlR*mm^2*(2*psq - s - 2*t) - bb*(-2 + d)^2*gZlR*mm^2*
        ...
        (mm^2*((-2 + d)*psq + (-4 + d)*s - (-2 + d)*t) + 
         s*(-(d*psq) + 2*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gZNL*
      (bb*(-((-2 + d)^2*gZlR*mm^2*(2*psq - s - 2*t)) + (16 - 10*d + d^2)*gZlL*
        ...
        ((-2 + d)*gZlR*mm^2*(2*psq - s - 2*t) - 
         gZlL*((-8 + d)*psq^2 - 2*s*(s + t) - psq*((-14 + d)*s + 
             (-8 + d)*t) + mm^2*((-8 + d)*psq - 4*s + 8*t - d*t))))*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gZNL*(aa*(12 - 8*d + d^2)*gZlR*mm^2*
        (psq - 2*s - t) - bb*(12 - 8*d + d^2)*gZlR*mm^2*(psq - 2*s - t) + 
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*mm^2*
     ...
     Pi^(2*d) - (I*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
      (bb*(-((16 - 10*d + d^2)*psq^2) - (16 - 10*d + d^2)*mm^2*
          (psq - s - t) - 2*(-4 + d)*s*(s + t) - (-8 + d)*psq*
          ((-4 + d)*s - (-2 + d)*t)) + aa*((16 - 10*d + d^2)*psq^2 + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(aa*(-4 + d)^2*s*(psq - t) + 
      ...
      gWNl*gZlL*gZNL*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*
      gWlN*gWNl*gZlL*gZNL*((-2 + d)*psq - 2*s - (-2 + d)*t)*\[Mu]^(8 - 2*d)*
