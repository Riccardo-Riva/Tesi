...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  ((I*2^(3 - d)*EL^6*gAl*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*\[Mu]^(4 - d)*
   ...
   (I*2^(4 - d)*EL^6*gAl*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(s + t)*
   ...
   (I*2^(4 - d)*EL^6*gAl*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(3*s + 2*t)*
     \[Mu]^(4 - d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^d*s^2*(-mz^2 + s)) + 
   (I*2^(4 - d)*EL^6*gAl*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*t*\[Mu]^(4 - d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^d*s^2*(-mz^2 + s)) + 
   (I*2^(4 - d)*EL^6*gAl*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(s - 2*t)*
     \[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^d*s^2*(-mz^2 + s)) - 
   (I*2^(5 - d)*EL^6*gAl*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*\[Mu]^(4 - d)*
