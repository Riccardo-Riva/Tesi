...
(PropList[KiraPropagator[q1, mw]]*
   (((-I/8)*EL^6*gAl*gAu*gWWZZ*(gZlR*gZuL*(4*mm^4 + 2*(-2 + d)*mu^2*s - 
       ...
       gZlR*gZuR*(4*mm^4 + 2*(-2 + d)*mu^2*s + 4*s^2 - 4*d*s^2 + d^2*s^2 + 
         ...
         2*d^2*s*t + 4*t^2))*(1 + (-1 + d)*GaugeXi[Q]))/
    ...
    ((I/8)*EL^6*gAl*gAu*gWWZZ*
      (s*(gZlR*gZuL*(2*(-3 + d)*mm^2 + 2*mu^2 + 4*s - d*s + 6*t - 2*d*t) + 
       ...
       (gZlR*gZuL*(4*mm^4 - 6*mu^2*s + 2*d*mu^2*s - 12*s^2 + 7*d*s^2 - 
           ...
           6*s^2 - 5*d*s^2 + d^2*s^2 + 2*mm^2*(4*mu^2 - (-3 + d)^2*s - 4*t) + 
         ...
         gZlR*gZuR*(4*mm^4 - 6*mu^2*s + 2*d*mu^2*s + 6*s^2 - 5*d*s^2 + 
           ...
           12*d*s*t + 2*d^2*s*t + 4*t^2))*GaugeXi[Q])*SPList[SP[q1, q1]])/
    ...
    ((I/4)*EL^6*gAl*gAu*gWWZZ*(gZlR*gZuL*(2*mm^2 + 4*mu^2 + 4*s - d*s - 
    ...
    ((I/2)*EL^6*gAl*gAu*gWWZZ*(gZlL + gZlR)*(gZuL + gZuR)*(2*mu^2 + s)*
  ...
  PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]]]*
   (((-I/8)*EL^6*gAl*gAu*gWWZZ*
    ...
    ((I/2)*EL^6*gAl*gAu*gWWZZ*(gZlL + gZlR)*(gZuL + gZuR)*(2*mu^2 + s)*
      (-1 + GaugeXi[Q])*SPList[SP[p3, q1], SP[p3, q1]])/
     (mw^2*Pi^4*(mz^2 - s)^2*s*GaugeXi[Q])))/4
