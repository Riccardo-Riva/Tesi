...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
 ...
 (-((EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*s^2*(bb*(mm^2 + 3*psq - s) + 
      aa*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) - 
  (2^(1 - 2*d)*aa*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*s*(bb*(mm^2 + 4*psq - s) + 
     aa*(-5*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  ...
  (4^(1 - d)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*(bb*(mm^2 + 3*psq - s) + 
     aa*(-4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
   Pi^(2*d) + (2^(3 - 2*d)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*
