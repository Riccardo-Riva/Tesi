...
PropList[KiraPropagator[-q1, mw], KiraPropagator[p1 - q2, mw], 
 ...
 ((2^(-1 - 2*d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*s^3*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-6 + d)*EL^5*gWlN*
    gWNl*gWWA^3*(mm^2 + psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) + ((-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2*Pi)^(2*d) + (EL^5*gWlN*gWNl*gWWA^3*(-9*bb*mm^2 + aa*(12 + d)*mm^2 + 
     9*aa*psq - bb*(12 + d)*psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (2*Pi)^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*
    (mm^2 + psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*(3 + d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  ((-5 + 3*d)*EL^5*gWlN*gWNl*gWWA^3*s*(2*aa*psq^2 + aa*mm^2*(2*psq + s) - 
     bb*psq*(2*mm^2 + 2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2*Pi)^(2*d) + (EL^5*gWlN*gWNl*gWWA^3*s*
    (aa*mm^2*((10 - 6*d)*psq + (8 - 5*d)*s) + 
     aa*psq*((10 - 6*d)*psq + (3 - 2*d)*s) + 
     bb*mm^2*(2*(-5 + 3*d)*psq + (-3 + 2*d)*s) + 
     bb*psq*(2*(-5 + 3*d)*psq + (-8 + 5*d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gWlN*gWNl*gWWA^3*s*
    (-(aa*(psq*(2*(-8 + 3*d)*psq + (3 + d)*s) + 
        mm^2*(2*(-8 + 3*d)*psq + (-5 + 4*d)*s))) + 
     bb*(mm^2*(2*(-8 + 3*d)*psq + (3 + d)*s) + 
       psq*(2*(-8 + 3*d)*psq + (-5 + 4*d)*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
   Pi^(2*d) - (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA^3*
    (18*aa*mm^2 + bb*(-15 + d)*mm^2 - 18*bb*psq - aa*(-15 + d)*psq)*s*
  ...
  (4^(1 - d)*(aa - bb)*(3 + d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*s*
  ...
  (2^(1 - 2*d)*(aa - bb)*(-8 + 5*d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*(-5 + 4*d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(bb*mm^2 - aa*psq)*s*
  ...
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA^3*(aa*((12 + d)*mm^2 + (3 + d)*psq) - 
     bb*((3 + d)*mm^2 + (12 + d)*psq))*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(bb*mm^2 - aa*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA^3*(18*aa*mm^2 - bb*(12 + d)*mm^2 - 
     18*bb*psq + aa*(12 + d)*psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA^3*(-(bb*psq*(mm^2 + psq + s)) + 
     aa*(psq^2 + mm^2*(psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA^3*(2*aa*(-5 + 3*d)*mm^2*(psq + s) - 
     2*bb*(-5 + 3*d)*psq*(psq + s) + bb*mm^2*((10 - 6*d)*psq + (3 - 2*d)*s) + 
     aa*psq*(2*(-5 + 3*d)*psq + (-3 + 2*d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA^3*
    (aa*(psq*(2*(-8 + 3*d)*psq + (3 + d)*s) + 
       mm^2*(2*(-8 + 3*d)*psq + (-7 + 6*d)*s)) - 
     bb*(mm^2*(2*(-8 + 3*d)*psq + (3 + d)*s) + 
       psq*(2*(-8 + 3*d)*psq + (-7 + 6*d)*s)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(aa - bb)*(3 + d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(aa - bb)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*(aa - bb)*(-8 + 5*d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(aa - bb)*(-5 + 4*d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*
  ...
  (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(aa*(2*mm^2 + psq) - 
     ...
     SP[p2, q1]])/Pi^(2*d) + (4^(1 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*
    (aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(-6 + d)*EL^5*gWlN*gWNl*gWWA^3*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[p2, q1]])/Pi^(2*d) + (4^(1 - d)*(-6 + d)*EL^5*gWlN*gWNl*gWWA^3*
    (aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA^3*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*(-1 + d)*EL^5*gWlN*gWNl*gWWA^3*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[q2, q2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*
  ...
  (4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*
  ...
  (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
  (2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA^3*(mm^2 + psq)*
