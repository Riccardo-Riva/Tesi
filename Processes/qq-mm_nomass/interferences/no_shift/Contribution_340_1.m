...
(PropList[KiraPropagator[q1, ms], KiraPropagator[-p1 - p2 + q1, ms]]*
  (((3*I)*2^(2 - d)*EL^6*gAd*gAl*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*ms^2*
   ...
   ((3*I)*2^(2 - d)*EL^6*gAd*gAl*gAu^2*
     (gZdL*gZlL*(4*mmv^4 + 2*(-2 + d)*mm^2*s - 8*s^2 + 6*d*s^2 - d^2*s^2 + 
        10*s*t - 2*d*s*t + 4*t^2 - 2*mmv^2*(s + 4*t)) + 
   ...
   ((3*I)*2^(3 - d)*(-3 + d)^2*EL^6*gAd*gAl*gAu^2*(gZdL - gZdR)*(gZlL - gZlR)*
