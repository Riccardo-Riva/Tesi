...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(mm^4 - psq^2)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*
     (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
      t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (5*mm^2 + psq)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (mm^4*(psq - t) + psq*(4*psq^2 - 5*psq*t + t*(s + t)) - 
      mm^2*(5*psq^2 - 6*psq*(s + t) + t*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (-2*psq^3 + 4*psq^2*(s + t) - psq*(5*mm^2*s + s^2 + 3*s*t + 2*t^2) + 
      mm^2*s*(mm^2 + 3*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*
     gWNl*mm^2*(mm^2*(5*psq^2 + s^2 - 10*psq*t + 6*s*t + 5*t^2) - 
      psq*(7*psq^2 - 3*psq*s + 2*s^2 - 14*psq*t + 9*s*t + 7*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
     (3*psq^2 - 4*psq*(s + t) + (s + t)^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (mm^4*(psq - t) + psq*(2*psq^2 - 3*psq*t + t*(s + t)) - 
      mm^2*(3*psq^2 + t*(s + t) - 2*psq*(3*s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*psq*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (mm^4*s + psq*(psq^2 - 2*psq*t + t*(s + t)) + 
      mm^2*(-5*psq^2 + s^2 - 4*s*t - 5*t^2 + 2*psq*(s + 5*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(-psq + s + t)*
     (psq*(3*psq - s - 3*t) + mm^2*(-5*psq + 2*s + 5*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*(psq - t)*
     (psq - 2*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(3*mm^2 + psq)*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (-2*psq^3 + 4*mm^2*psq*s + 3*psq^2*(s + 2*t) - mm^2*s*(s + 4*t) + 
      t*(s^2 + 3*s*t + 2*t^2) - 2*psq*(s^2 + 3*s*t + 3*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
      t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(-psq + s + t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 + 2*psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 + 2*psq)*
     ...
     gWNl*mm^2*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(2*mm^2 - 3*psq + s + t)*
     ...
     gWNl*mm^2*(mm^2 + 2*psq)*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (-(t*(s + t)) + mm^2*(-psq + s + t) + psq*(2*s + t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(psq - t)^2*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q2, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
