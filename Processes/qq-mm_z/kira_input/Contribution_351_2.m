...
((3*I)*EL^6*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL^2 + gZuR^2)*
 ...
 ((3*I)*2^(-1 - d)*EL^6*s*
   (gZlR*gZlRC*((-4 + d)*gZuL^3*gZuLC*((-2 + d)*s - 2*t) + 
      (-2 + d)*gZuR^3*gZuRC*((-4 + d)*s + 2*t) - gZuL^2*gZuR*gZuRC*
       ...
       ((-4 + d)^2*s - 2*(-2 + d)*t)) + 
    gZlL*gZlLC*((-4 + d)*gZuR^3*gZuRC*((-2 + d)*s - 2*t) + 
      (-2 + d)*gZuL^3*gZuLC*((-4 + d)*s + 2*t) - gZuL*gZuLC*gZuR^2*
       ((-2 + d)^2*s + 2*(-4 + d)*t) - gZuL^2*gZuR*gZuRC*
       ((-4 + d)^2*s - 2*(-2 + d)*t)))*userIntegral[A1, {0}, -1, 1, 1, 0])/
 ...
 ((3*I)*2^(-1 - d)*EL^6*(gZuL^2 + gZuR^2)*
  ...
  (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
 ((I/4)*EL^6*((3*2^(1 - d)*(gZuL^2 + gZuR^2)*s*
 ...
 ((I/4)*EL^6*((3*2^(2 - d)*(gZuL^2 + gZuR^2)*
  ...
  ((mz^2 - s)^2*(-mzC^2 + s)) + ((3*I)*EL^6*(gZlL*gZlLC + gZlR*gZlRC)*
   (gZuL^2 + gZuR^2)*(gZuL*gZuLC + gZuR*gZuRC)*s*userIntegral[A1, {0}, 0, 1, 
    1, -2])/((2*Pi)^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*2^(-1 - 2*d)*EL^6*s*(3*(gZuL^2 + gZuR^2)*(2*Pi)^d*
     (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
        gZuR*gZuRC*((-4 + d)*s + 2*t)) - gZlR*gZlRC*
       (gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 2*t))) - 
    (gZuL^2 - gZuR^2)*(gZlL*gZlLC*(gZuR*gZuRC*((-5 + d)*d*(2*Pi)^d*s + 
