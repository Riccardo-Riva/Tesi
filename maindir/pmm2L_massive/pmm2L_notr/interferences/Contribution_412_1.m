...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*(2*mm^2 - 2*psq + 3*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/((2*Pi)^(2*d)*s) + 
  (d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*(2*mm^2 - 2*psq + 3*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/((2*Pi)^(2*d)*s) - 
  (4^(1 - d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) + (d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (4^d*Pi^(2*d)*s) - (4^(1 - d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*
    (mm^2 - psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*
  ...
  (2^(1 - 2*d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*(-psq + s + t)*
  ...
  (2^(1 - 2*d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*(2*mm^2 - psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*d*EL^8*gAl*gAu^2*gFFWW*gFll^2*gWWA*mm^2*(psq - t)*
