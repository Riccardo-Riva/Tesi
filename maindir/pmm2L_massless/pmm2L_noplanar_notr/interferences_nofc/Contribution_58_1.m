...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, 0], 
  ...
  ((4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(2*(-4 + d)*s^2 + 
   ...
   (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(6 - 5*d + d^2)*EL^8*gAl^4*gAu^2*
     (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
    Pi^(2*d) - (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-4 + d)*s - 2*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + t)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(12 - 8*d + d^2)*EL^8*gAl^4*gAu^2*
     (gZlL^2 + gZlR^2)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*(6 - 5*d + d^2)*EL^8*gAl^4*
   ...
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + t)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ((-6 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(2*d*(s - 5*t) + 36*t + 
   ...
   (4^(2 - d)*(36 - 14*d + d^2)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
