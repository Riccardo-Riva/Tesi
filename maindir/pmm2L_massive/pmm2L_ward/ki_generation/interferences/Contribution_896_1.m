   ...
   (((-I)*2^(1 - 2*d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*s*
    ...
    (I*4^(1 - d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
      ...
      (gZlL - gZlR)^2*ml^2*mm^2*(bb*(psq - s - t) + 
       ...
       SP[p1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*
      ml^2*mm^2*(bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
     ...
     Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
