...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, ml]]*((4^(1 - d)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)^2*
       ml^2*mm^2*(psq^2 - 2*psq*t + t*(s + t))*(2*mm^2*(psq - t) + 
     ...
     (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(psq - s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     ...
     (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(3*psq^2 - 4*psq*s + s^2 - 6*psq*t + 4*s*t + 
        3*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(2*mm^2 - 4*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
     ...
     (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*(psq - t)*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(psq - t)*(2*mm^2 - 5*psq + 2*s + 3*t)*
     ...
     (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
     ...
     (4^(1 - d)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(-2*psq^3 - psq^2*(s - 6*t) + 
        ...
        psq*(s^2 - s*t - 6*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(2*psq^3 + psq^2*(s - 8*t) - t*(s + 2*t)^2 + 
        psq*(-s^2 + 3*s*t + 10*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(2*psq^3 + 2*mm^2*(psq - t)^2 - 
        2*t*(s + t)^2 - 3*psq^2*(s + 2*t) + psq*t*(7*s + 6*t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)*s) + 
     (4^(1 - d)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*(psq - s)*
       (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(-(psq*s) + 2*mm^2*(psq - t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
     (4^(1 - d)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
       (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
        t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(-psq + s + t)*(2*mm^2 - 4*psq + s + 2*t)*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(2*mm^2 - 3*psq + t)*(-psq + s + t)*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*
       (gZlL + gZlR)^2*ml^2*mm^2*(-2*psq^2 - 2*psq*s + s^2 + 
