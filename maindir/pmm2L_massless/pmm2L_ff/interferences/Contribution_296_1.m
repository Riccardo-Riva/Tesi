...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((-3*4^(1 - d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^2*(2*mm^2 - s - 2*t)*t*
     (s + t)*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
   ...
   (3*4^(1 - d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^2*t*
     (2*mm^2*s + 3*s^2 + 12*s*t + 8*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^4*
     (s - t)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
   (3*4^(1 - d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^2*s*(2*mm^2 + s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^4*(s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   (3*2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^2*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^2*t*
   ...
   (4^(2 - d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^2*(mm^2 + 2*(s + t))*
   ...
   (2^(5 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^4*t*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gHll*gHWW*gWWA^2*mm^2*t*\[Mu]^(8 - 2*d)*
