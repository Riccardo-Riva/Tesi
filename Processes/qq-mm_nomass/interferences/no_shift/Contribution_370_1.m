   ...
   ((I*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2^(2 + d)*mmv^4*Pi^d + 
    ...
    (I*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2^(1 + d)*mm^2*Pi^d + 
       ...
       gZlR*gZuR*(2^(1 + d)*mm^2*Pi^d - 2^(1 + d)*(-2 + d)*mmv^2*Pi^d - 
         ...
         2^(1 + d)*d*Pi^d*t))*SPList[SP[q1, q1]])/
     ((2*Pi)^(2*d)*(mz^3 - mz*s)^2) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*gHZZ^2*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gHZZ^2*(gZlL + gZlR)*(gZuL + gZuR)*
      SPList[SP[p3, q1], SP[p3, q1]])/(Pi^d*(mz^3 - mz*s)^2)) + 
   ...
   ((I*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2^(1 + d)*mm^2*Pi^d + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gHZZ^2*
      (gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
       ...
       SP[p3, q1]])/(Pi^d*s*(mz^3 - mz*s)^2) + 
    (I*2^(2 - d)*EL^6*gAl*gAu*gHZZ^2*(gZlL + gZlR)*(gZuL + gZuR)*
      SPList[SP[p3, q1], SP[p3, q1]])/(Pi^d*(mz^3 - mz*s)^2)))/4
