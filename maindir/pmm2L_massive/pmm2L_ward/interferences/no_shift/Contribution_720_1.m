...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*(mm^2 - psq)*
   ...
   (I*(aa + bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*(mm^2 - psq)^2*s*
   ...
   (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
     (aa*mm^2*(2*psq - s - 2*t) - bb*mm^2*(2*psq + s - 2*t) + 
      aa*psq*(2*psq + s - 2*t) + bb*psq*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
   (I*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*(aa*mm^2*(3*psq - s - 3*t) - 
      bb*mm^2*(3*psq + s - 3*t) + aa*psq*(psq + s - t) + 
      bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
    (2*Pi)^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
   ...
   (I*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*(aa*mm^2*(3*psq - 4*s - 3*t) + 
   ...
   (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*
    ...
    (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*
     mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gAl*gHll^2*gWlN*
     gWNl*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
    ...
    Pi^(2*d) + (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*(psq - t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[q1, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*bb*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*
