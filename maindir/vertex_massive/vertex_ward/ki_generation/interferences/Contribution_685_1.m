...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[q2, mw], 
 ...
 (-((EL^5*ggzgmW^2*gWlN*gWNl*gWWA*(-(aa*(psq^2 + mm^2*(psq - s))) + 
      bb*psq*(mm^2 + psq - s))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (2*Pi)^(2*d)) - (EL^5*ggzgmW^2*gWlN*gWNl*gWWA*
    (-(aa*(psq^2 + mm^2*(psq - s))) + bb*psq*(mm^2 + psq - s))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*ggzgmW^2*gWlN*gWNl*gWWA*(aa*mm^2 - bb*psq)*s^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(-1 - 2*d)*EL^5*ggzgmW^2*gWlN*gWNl*gWWA*s*(-2*bb*mm^2*(psq - s) + 
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*ggzgmW^2*gWlN*gWNl*gWWA*psq*(mm^2 + psq)*
  ...
  (2^(1 - 2*d)*EL^5*ggzgmW^2*gWlN*gWNl*gWWA*(aa*(2*mm^2 + psq) - 
   ...
   Pi^(2*d) + (EL^5*ggzgmW^2*gWlN*gWNl*gWWA*(3*aa*mm^2 - 2*bb*mm^2 + 
     2*aa*psq - 3*bb*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
  ...
  (2^(1 - 2*d)*EL^5*ggzgmW^2*gWlN*gWNl*gWWA*(aa*(psq^2 + mm^2*(psq - s)) - 
     bb*psq*(mm^2 + psq - s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
   Pi^(2*d) - (EL^5*ggzgmW^2*gWlN*gWNl*gWWA*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*EL^5*ggzgmW^2*gWlN*gWNl*gWWA*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (EL^5*ggzgmW^2*gWlN*gWNl*gWWA*(-(aa*(psq*(2*psq - s) + mm^2*(2*psq + s))) + 
     bb*(mm^2*(2*psq - s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (EL^5*ggzgmW^2*gWlN*gWNl*gWWA*(2*bb*mm^2*(psq - s) - 2*aa*psq*(psq - s) - 
