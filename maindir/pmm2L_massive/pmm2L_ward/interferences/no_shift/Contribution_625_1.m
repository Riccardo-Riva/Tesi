...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*s*
    ...
    Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^4*
     ...
     gXll^2*mm^2*(mm^4*(2*Pi)^(2*d)*((2 + d)*psq - (-2 + d)*s - (2 + d)*t) - 
      (2*Pi)^(2*d)*psq*(-((-2 + d)*psq^2) + (-8 + d)*psq*s + (-2 + d)*psq*t + 
        2*s*(s + t)) - 2^(1 + 2*d)*mm^2*Pi^(2*d)*(d*psq*(psq - s - t) - 
        s*(-5*psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(4*d) + 
   (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^4*
     ...
     gXll^2*mm^2*(mm^2 - psq)*(-((-2 + d)*psq^2) + 2*psq*s + (-2 + d)*psq*t + 
      2*s*t + mm^2*((2 + d)*psq - 4*s - (2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^4*s*
     (bb*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
      aa*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(bb*(2*mm^2 - s - 2*t) + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(-(bb*(-2 + d)*psq*(psq - t)) + 
   ...
   (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(bb*(2*mm^2 - psq - t) + 
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*(-((-2 + d)*psq^2) + 
      2*psq*s + (-2 + d)*psq*t + 2*s*t + mm^2*((2 + d)*psq - 4*s - 
        (2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*s*
     (bb*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
      aa*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*(-((-2 + d)*psq) + 2*s + 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*((-2 + d)*psq - (-4 + d)*s - 
   ...
   (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
      SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*
     (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*((-2 + d)*psq - (-4 + d)*s - 
    ...
    Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*
     (-((-2 + d)*psq) + 2*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*
