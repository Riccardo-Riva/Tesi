...
PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, 0], 
 ...
 ((2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-4 + d)*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
    (2*(-2 + d)*s^2 + (2 + d)*s*t + 2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*(10 - 7*d + d^2)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(18 - 9*d + d^2)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) - 
  ((-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-6 + d)*s^2 + 4*s*t + 
     4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/((2*Pi)^(2*d)*s) + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-4 + d)*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*(10 - 7*d + d^2)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(2*s^2 - 2*(-5 + d)*s*t - 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
    ((-2 + d)*s^2 - 4*(-5 + d)*s*t - 2*(-6 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(3*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-176 + 92*d - 16*d^2 + d^3)*s - 
  ...
  (EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((100 - 44*d + 5*d^2)*s^2 + 
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-2 + d)*s^2 + 2*s*t - 
     (-6 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
    (s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*t*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(4*(-4 + d)^2*s^2 + 
  ...
  (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*\[Mu]^(8 - 2*d)*
  ...
  ((-6 + d)^2*(-5 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(s + t)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*
    (gZlL^4 + gZlR^4)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(s + t)*
   ...
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-176 + 92*d - 16*d^2 + d^3)*EL^8*gAl^2*gAu^2*
    ...
    (gZlL^4 + gZlR^4)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p2, q2]])/(Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*
    (gZlL^4 + gZlR^4)*((-168 + 84*d - 14*d^2 + d^3)*s + 4*(-2 + d)^2*t)*
