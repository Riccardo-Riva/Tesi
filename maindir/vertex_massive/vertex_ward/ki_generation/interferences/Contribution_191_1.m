...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
   ...
   ((I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*psq*s*
    ...
    (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(2*aa*psq^2*(psq + s - t) + 
    ...
    (I*4^(1 - d)*aa*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*s*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
    (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*
      gWNl*gWWA*mm^2*s*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
      (-2*aa*psq^2 + aa*mm^2*(3*psq - s - t) + bb*mm^2*(-psq + s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
      (-(aa*psq^2) + bb*mm^2*(2*psq - s) + aa*mm^2*s + aa*psq*(-s + t) - 
       bb*psq*(psq - s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
      (-2*aa*psq^2 - 2*bb*psq^2 + aa*mm^2*(4*psq - s - 2*t) + 
       bb*mm^2*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
      (aa*psq*(4*psq + s - 4*t) - 2*bb*mm^2*(psq - t) + 
       2*aa*mm^2*(psq - 2*s - t) + bb*psq*(-4*psq + 3*s + 4*t))*
    ...
    (I*4^(1 - d)*bb*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*s*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
    (I*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*s*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*s*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*s*
     ...
     (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*
      gWWA*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
    (I*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
     (2*Pi)^(2*d) - (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*
      gWWA*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*
      gWWA*mm^2*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gFll^2*gWlN*
    ...
    (I*2^(3 - 2*d)*bb*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*
    ...
    (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*
      gWlN*gWNl*gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
