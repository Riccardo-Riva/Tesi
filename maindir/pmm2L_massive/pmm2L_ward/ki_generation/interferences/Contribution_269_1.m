...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*(mm^2 + psq)*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*s*sw*
      ...
      (gZlL + gZlR)*mm^2*sw*(aa*(4*mm^2*(psq - t) + (4*psq - s)*
          (psq - s - t)) - bb*(4*psq^2 - 3*psq*s + s^2 + 
         mm^2*(4*psq - 2*s - 4*t) - 4*psq*t + s*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*s*sw*
      (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/Pi^(2*d) + (I*EL^5*gFZW*gHFW*gHll*gWWA*
      (gZlL + gZlR)*mm^2*sw*(aa*(4*psq^2 - 3*psq*s + 
