...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((I*2^(-1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*s*
    (aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + bb*psq*(-psq + t) + 
     bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
   ...
   (2*Pi)^(2*d) - (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(4^d*Pi^(2*d)) - 
  (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*s*(aa*(2*psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (4^d*Pi^(2*d)) - (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
    (aa*(mm^2*(psq - t) + (psq + s)*(psq - s - t)) + 
     bb*(-psq^2 + psq*(-3*s + t) + s*(s + t) + mm^2*(-psq + 3*s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/(4^d*Pi^(2*d)) - 
  (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*s*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (4^d*Pi^(2*d)) - (I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*4^(1 - d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
  ...
  (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
   ...
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
   ...
   Pi^(2*d) + (I*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*
  ...
  (I*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
  ...
  ((3*I)*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWA^2*mm^2*
