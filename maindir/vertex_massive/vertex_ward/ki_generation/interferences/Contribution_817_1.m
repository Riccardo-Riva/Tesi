...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
   ...
   ((I*EL^5*gFFA*gFll^4*mm^4*psq*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (2*Pi)^(2*d) + (I*EL^5*gFFA*gFll^4*mm^4*psq*s*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
    (I*EL^5*gFFA*gFll^4*mm^4*s*(-(aa*psq*s) - bb*psq*s + 
       2*aa*mm^2*(psq - t) + 2*bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/(2*Pi)^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*s*(aa*mm^2*(psq - t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*psq*(bb*(psq - s - t) + 
       ...
       SP[p1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*psq*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*(-2*bb*mm^2*(psq - s - t) + 
       2*aa*mm^2*(psq + s - t) - bb*s*(s + t) + aa*s*(-4*psq + s + t))*
    ...
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*psq*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*s*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
    (I*EL^5*gFFA*gFll^4*mm^4*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*psq*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*(2*aa*mm^2*(psq - t) - 
       2*bb*mm^2*(psq - 2*s - t) + aa*s*(-2*psq + t) - bb*s*(2*psq + t))*
    ...
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*s*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
     Pi^(2*d) + (I*EL^5*gFFA*gFll^4*mm^4*s*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^4*mm^4*s*
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll^4*mm^4*(bb*(2*mm^2 - s - 2*t) + 
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll^4*mm^4*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFFA*gFll^4*mm^4*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
