...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*EL^5*gAl*gXll^2*mm^4*(mm^2 - psq)*s*
     ...
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - (I*2^(1 - 4*d)*(aa - bb)*EL^5*gAl*gXll^2*
     ...
     SPList[SP[p1, q1]])/Pi^(4*d) - (I*EL^5*gAl*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl*gXll^2*mm^4*
     ...
     SPList[SP[p2, q1]])/Pi^(4*d) - (I*EL^5*gAl*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (I*EL^5*gAl*gXll^2*mm^2*(aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
   ...
   (I*EL^5*gAl*gXll^2*mm^2*(bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
