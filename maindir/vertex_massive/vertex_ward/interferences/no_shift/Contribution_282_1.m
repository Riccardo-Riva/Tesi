...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-(((aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(2*mm^2 + psq)*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (aa*mm^2*(6*psq - 2*s) + 2*aa*psq*(2*psq - s) + bb*psq*(-4*psq + s) + 
      bb*mm^2*(-6*psq + 3*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (aa*(2*psq^2 + mm^2*(4*psq - s) + 2*psq*s - s^2) + 
      bb*(-2*psq^2 - 4*psq*s + s^2 + mm^2*(-4*psq + 3*s)))*\[Mu]^(8 - 2*d)*
     ...
     (gZlL - gZlR)*mm^4*s*(bb*(3*mm^2 - 4*psq + s) - aa*(mm^2 - 2*psq + s))*
   ...
   (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(aa*(mm^2 + 3*psq - s) + 
    ...
    Pi^(2*d) + (4^(1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (aa*mm^2*(3*psq - s) - aa*psq*s + bb*mm^2*(mm^2 - 4*psq + 2*s))*
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (aa*(mm^4 + 3*psq*s + mm^2*(-7*psq + 3*s)) - 
      bb*(mm^4 + psq*s + mm^2*(-7*psq + 5*s)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (-2*bb*psq^2 + 2*aa*psq*(psq - s) + aa*mm^2*(4*psq - s) + 
      bb*mm^2*(-4*psq + 3*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (-3*bb*mm^2 + aa*(mm^2 + 2*psq))*s*\[Mu]^(8 - 2*d)*
