...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (-((4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^4*
     (2*mu^2 + t)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^4*
