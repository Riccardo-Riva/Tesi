...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((-3*4^(1 - d)*(-1 + d)*EL^6*gAl^2*gAu*gWWA*gWWAA*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWAA*((13 - 9*d)*psq^3 + d*t*(s + t)^2 - 
      psq*(s + t)*(-3*s + 2*d*s - 13*t + 11*d*t) + 
      psq^2*(-6*s + 5*d*s - 26*t + 19*d*t) + 
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWAA*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWAA*((4 - 5*d)*psq^2 + 
