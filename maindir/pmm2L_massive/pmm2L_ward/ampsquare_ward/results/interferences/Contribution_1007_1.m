...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
     ...
     KiraPropagator[q2, mw]]*(((-I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*
     ...
     (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
      ...
      (mz^2*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*
       ...
       ggpgpA*ggpgpZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*t*
      ...
      (mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*
       ...
       ggpgpA*ggpgpZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(s + 2*t)*
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q2]])/
      (mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*
       (gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
        SP[q1, q1]])/(mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
       ggpgpA*ggpgpZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
