...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      (psq - t)*(mm^2*(psq - 2*s - t) + psq*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      ...
      (gZlL - gZlR)*mm^2*(mm^2 - psq)*(mm^2*(psq - 2*s - t) + psq*(-psq + t))*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      (7*psq^2 - 3*psq*s + 2*s^2 - 14*psq*t + 9*s*t + 7*t^2)*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      (-3*psq^2 + 2*mm^2*s + 4*psq*s - s^2 + 6*psq*t - 4*s*t - 3*t^2)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      (psq^2 - s^2 + 2*psq*(s - t) + t^2)*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
     ...
     Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (-4*psq^3 + mm^2*s*(2*s + t) + 3*psq^2*(s + 4*t) + 
       2*t*(s^2 + 3*s*t + 2*t^2) - psq*(mm^2*s + 2*s^2 + 9*s*t + 12*t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) + 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q2, q2]])/
     Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
