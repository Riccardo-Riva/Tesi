...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl^2*gAu*gFAW*gFll*gWNl*mm^2*(psq^2 - 2*psq*t + 
       t*(s + t))*(d*psq*s + 2*d*mm^2*(psq - s - t) + 
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gFAW*gFll*gWNl*mm^2*(-2*(-1 + d)*psq^3 - 
       ...
       t*(3*s^2 + (4 + d)*s*t + d*t^2) - psq*(s^2 + (8 + d)*s*t + 
         2*(-1 + 2*d)*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFAW*gFll*gWNl*mm^2*
    ...
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFAW*gFll*gWNl*mm^2*(2*(mm^2 - psq)*s + 
       d*psq*s + 2*d*mm^2*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    ...
    (4^(1 - d)*d*EL^6*gAl^2*gAu*gFAW*gFll*gWNl*mm^2*(2*psq^2 - 3*psq*s + 
       s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl^2*gAu*gFAW*gFll*gWNl*mm^2*(-((-6 + d)*psq^2) + 
       2*s^2 + 2*(-2 + d)*mm^2*(psq - t) + 6*s*t + 2*t^2 + d*t^2 - 
       2*psq*(3*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gAu*gFAW*gFll*gWNl*mm^2*
      (2*(-2 + d)*mm^2 - 2*(-3 + d)*psq - 4*s + d*s - 2*t)*\[Mu]^(8 - 2*d)*
