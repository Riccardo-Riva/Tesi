...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (((-I)*EL^5*gAl*gHll^2*mm^4*s*
      ...
      (2^(1 + 2*d)*bb*(gZlL^2 + gZlR^2)*Pi^(2*d)*(psq^2 - psq*(s + t) + 
        ...
        (psq^2 + s*(mm^2 + s + t) - psq*(3*s + t)) + aa*d*(2*Pi)^(2*d)*
        (gZlL*gZlR*(4*mm^2*(psq - s - t) - s*(-3*psq + s + t)) + 
         gZlL^2*(psq^2 + s*(mm^2 + s + t) - psq*(3*s + t)) + 
         gZlR^2*(psq^2 + s*(mm^2 + s + t) - psq*(3*s + t))) + 
       bb*d*(2*Pi)^(2*d)*(-(gZlL^2*(psq^2 - psq*(s + t) + 
            s*(-mm^2 + s + t))) - gZlR^2*(psq^2 - psq*(s + t) + 
           s*(-mm^2 + s + t)) + gZlL*gZlR*(s*(-psq + s + t) + 
           mm^2*(-4*psq + 2*s + 4*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     Pi^(4*d) - (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^4*
     ...
     Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
      (bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - (-2 + d)*gZlR^2*mm^2*
          (2*psq - s - 2*t) + gZlL*gZlR*((-4 + d)*psq^2 - 2*s*(s + t) + 
           ...
           psq*(2*s + 4*t - d*t))) + 
       aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
          (2*psq - s - 2*t) + gZlL*gZlR*(-((-4 + d)*psq^2) + 
           (-10 + d)*psq*s + (-4 + d)*psq*t + 2*s*(s + t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
      (bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - (-2 + d)*gZlR^2*mm^2*
          (2*psq - s - 2*t) + gZlL*gZlR*((-4 + d)*psq^2 - 2*s*t - 
           psq*(2*s + (-4 + d)*t) + mm^2*((-4 + 3*d)*psq + 8*s - 2*d*s + 
             4*t - 3*d*t))) + aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 
         (-2 + d)*gZlR^2*mm^2*(2*psq - s - 2*t) + 
         gZlL*gZlR*(-((-4 + d)*psq^2) + (-6 + d)*psq*s + (-4 + d)*psq*t + 
           2*s*t + mm^2*((4 - 3*d)*psq + d*s - 4*t + 3*d*t))))*
