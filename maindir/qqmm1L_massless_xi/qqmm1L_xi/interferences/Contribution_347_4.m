...
PropList[KiraPropagator[p1 - q1, 0], KiraPropagator[-p2 - q1, 0]]*
 ((I*2^(-1 - 2*d)*EL^6*gZNL^2*
    (gZlL*gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
     ...
     gZlR*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
       ...
       gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((8 - 7*d + d^2)*s^2 + 
           (2 - 3*d + d^2)*s*t + 2*t^2))))*\[Mu]^(4 - d)*SPList[SP[p1, p2]])/
  ...
  (I*2^(-1 - d)*EL^6*gZNL^2*
    (gZlR*gZlRC*(gZuL*gZuLC*(-3*(-4 + d)^2*s^2 - 2*(22 - 11*d + d^2)*s*t + 
         4*t^2) + gZuR*gZuRC*((12 - 8*d + d^2)*s^2 + 2*(20 - 9*d + d^2)*s*t + 
         4*t^2)) + gZlL*gZlLC*(gZuL*gZuLC*((12 - 8*d + d^2)*s^2 + 
         2*(20 - 9*d + d^2)*s*t + 4*t^2) + gZuR*gZuRC*(d^2*s*(s - 2*t) + 
         4*t*(-5*s + t) + 2*d*s*(-2*s + 7*t))))*\[Mu]^(4 - d)*
    SPList[SP[p1, q1]])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
  (I*2^(-1 - 2*d)*EL^6*gZNL^2*
    (gZlL*gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
          ((4 - 3*d + d^2)*s^2 + (4 - 5*d + d^2)*s*t - 2*t^2)) + 
       gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 + 
