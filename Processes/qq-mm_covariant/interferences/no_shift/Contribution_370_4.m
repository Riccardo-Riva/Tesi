...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[W]]], 
  ...
  (((-I/9)*2^(-1 - 2*d)*EL^6*(cw^2 - sw^2)*(-3*d*(2*Pi)^d*s + 
      2^(1 + d)*Pi^d*(s*(3 + (-2 + 3*d)*swC^2 - 8*swC^4 + 
          sw^2*(-6 + 3*d - 20*swC^2 + 32*swC^4)) + 
        3*(-3 + d)*(-1 + 2*sw^2 + 2*swC^2)*t))*SPList[SP[q1, q1]])/
    (cw^2*cwC^2*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*sw^2*swC^2) - 
   ((I/9)*EL^6*(cw^2 - sw^2)*(12 - 32*swC^2 + 16*swC^4 + 
     ...
     (-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
       (3*s*(3 + (-10 + d)*swC^2 + 8*swC^4 + sw^2*(-6 + d + 20*swC^2 - 
         ...
         t))*SPList[SP[p1, q1], SP[p3, q1]])/(cw^2*cwC^2*(2*Pi)^(2*d)*
     (mz^2 - s)*s*(-mzC^2 + s)*sw^2*swC^2) - 
   ((I/9)*EL^6*(cw^2 - sw^2)*(6 - 4*swC^2 - 16*swC^4 + 
     ...
     swC^2) - ((I/9)*2^(1 - d)*EL^6*(cw^2 - sw^2)*(-3 + 8*swC^2)*
