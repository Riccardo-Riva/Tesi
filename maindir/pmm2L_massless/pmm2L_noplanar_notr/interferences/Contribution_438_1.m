...
PropList[KiraPropagator[q2, mz], KiraPropagator[q2, mz], 
 ...
 ((2^(-1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(3*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(2*s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(5*s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (7*2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*t*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(7*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(s + t)*
  ...
  (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(s - 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(5*s - 2*t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*
