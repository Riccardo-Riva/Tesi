...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, mw]]*((I*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
     ...
     (I*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(2*bb*mm^2*(psq - t) + 
      ...
      (mh^2*Pi^(2*d)) - (I*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
       (-2*bb*mm^2*(psq - t) + aa*s*(psq - t) + 2*aa*mm^2*(psq - s - t) + 
        bb*s*(psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
      (mh^2*(2*Pi)^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s*
       (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
      (mh^2*(2*Pi)^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s*
       (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
      (mh^2*(2*Pi)^(2*d)) - (I*4^(1 - d)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
     ...
     (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
      ...
      (mh^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
       gHll*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
        SP[q1, q1]])/(mh^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
       ggmgmA*gHgmgm*gHll*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     ...
     (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
      ...
      (mh^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
       gHll*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
      (mh^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
       gHll*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
        SP[q1, q2]])/(mh^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
       ggmgmA*gHgmgm*gHll*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q2], SP[q1, q1]])/(mh^2*Pi^(2*d)) + 
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
