...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[q2, mz], 
 ...
 (-((2^(-1 - 2*d)*EL^5*ggmgmAZ*ggmgmZ*s*
     ...
     \[Mu]^(8 - 2*d))/Pi^(2*d)) - 
  (EL^5*ggmgmAZ*ggmgmZ*(aa*(gZlL^2*psq*(mm^2 + psq + s) + 
