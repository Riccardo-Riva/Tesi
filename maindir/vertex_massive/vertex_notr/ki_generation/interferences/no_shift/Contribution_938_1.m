...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-(((-1 + d)*EL^6*gAl^2*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
      ...
      ((mh^2 - mz^2)*(2*Pi)^(2*d))) + (2^(1 - 2*d)*(-1 + d)*EL^6*gAl^2*gHll*
      gHWW*gWWZ*(gZlL + gZlR)*mm^2*(2*(-1 + d)*mm^2 - (-2 + d)*psq)*
    ...
    (2^(1 - 2*d)*(-1 + d)*d*EL^6*gAl^2*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) - (4^(1 - d)*(4 - 5*d + d^2)*EL^6*gAl^2*gHll*
      gHWW*gWWZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) + 
    (4^(2 - d)*(-1 + d)*EL^6*gAl^2*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) - (2^(3 - 2*d)*(-1 + d)*EL^6*gAl^2*gHll*gHWW*
      gWWZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
