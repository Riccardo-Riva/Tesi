(PropList[KiraPropagator[q1, mw]]*
   (((-I)*2^(1 - 2*d)*EL^6*gWWZZ*
    ...
    (I*2^(2 - d)*EL^6*gWWZZ*(gZlR*gZlRC*(-((-2 + d)*gZuL*gZuLC) + 
      ...
      (-mzC^2 + s)*GaugeXi[Q]) + (I*4^(1 - d)*EL^6*gWWZZ*
    ...
    (I*2^(2 - d)*EL^6*gWWZZ*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
       ...
       SP[p2, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]) - 
    (I*4^(1 - d)*EL^6*gWWZZ*
      ...
      SPList[SP[p3, q1], SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*
