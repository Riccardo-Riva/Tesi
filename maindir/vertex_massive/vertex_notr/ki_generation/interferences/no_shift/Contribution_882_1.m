...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl^2*gZlL*gZlR*mm^4*(-4*(4 - 5*d + d^2)*gZlL*gZlR*s + 
       (-2 + d)*gZlL^2*(2*(-1 + d)*mm^2 - 2*(-3 + d)*psq + (-2 + d)*s) + 
       (-2 + d)*gZlR^2*(2*(-1 + d)*mm^2 - 2*(-3 + d)*psq + (-2 + d)*s))*
      \[Mu]^(8 - 2*d))/Pi^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^2*gZlL*gZlR*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl^2*mm^2*(2*gZlL^2*gZlR^2*
     ...
     SPList[SP[p1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl^2*gZlL*gZlR*mm^2*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^2*gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*
