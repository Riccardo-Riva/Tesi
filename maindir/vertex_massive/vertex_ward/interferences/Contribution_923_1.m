...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*s*
  ...
  (EL^5*gAl*ggpgpZ^2*(-(aa*(6*gZlL*gZlR*mm^2*(3*psq - s)*s + 
   ...
   (2*Pi)^(2*d) + (2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
  ...
  (2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*s*
    ...
    SPList[SP[q1, q2]])/Pi^(2*d) + (2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*s*
  ...
  (EL^5*gAl*ggpgpZ^2*(aa*(-2*gZlL*gZlR*mm^2*s + 
  ...
  (EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2*(10*psq - 3*s) + 
  ...
  (EL^5*gAl*ggpgpZ^2*(-(aa*(2*gZlL*gZlR*mm^2*(4*psq + s) + 
  ...
  (EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(psq^2 + mm^2*(psq - s)) - 
     aa*psq*(mm^2 + psq - s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
   (2*Pi)^(2*d) + (EL^5*gAl*ggpgpZ^2*
  ...
  (EL^5*gAl*ggpgpZ^2*(aa*(gZlL^2*(2*mm^2 + psq)*s + gZlR^2*(2*mm^2 + psq)*s + 
  ...
  (2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*mm^2*(aa*mm^2 - bb*psq)*
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*mm^2*
  ...
  ((aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*mm^2 - bb*psq)*
  ...
  (4^(1 - d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*mm^2 - bb*psq)*
