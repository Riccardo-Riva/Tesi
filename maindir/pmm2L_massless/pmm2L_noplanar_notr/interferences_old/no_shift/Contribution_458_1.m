(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
   KiraPropagator[-p1 - p2 + p3 + q1, 0], KiraPropagator[-p1 - p2 + p3 + q1, 
    0], KiraPropagator[q2, 0], KiraPropagator[-p1 - p2 + p3 + q1 + q2, 0]]*
  (-((4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-3 + d)*s + (-4 + d)*t)*
    ...
    (Pi^(2*d)*s^2) + (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*
     ((-3 + d)*s + (-4 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-40 + 40*d - 12*d^2 + d^3)*
     EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*
     (s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/
    (Pi^(2*d)*s^2) + (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*(s - (-4 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-48 + 48*d - 14*d^2 + d^3)*EL^8*gAl^6*
     gAu^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((36 - 16*d + d^2)*s - 8*(-3 + d)*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((24 - 12*d + d^2)*s - 
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*(2*s - (-6 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((20 - 10*d + d^2)*s + 2*(-2 + d)*t)*
   ...
   (4^(2 - d)*(-40 + 40*d - 12*d^2 + d^3)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((24 - 12*d + d^2)*s - 2*(-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*(s - 2*t)*
