...
(PropList[KiraPropagator[q1, ml], KiraPropagator[-p1 - p2 + q1, ml]]*
  (((-I)*2^(2 - d)*EL^6*gAl^3*gAu*ml^2*
     ...
     \[Mu]^(4 - d))/(Pi^d*(mzC^2 - s)*s^2) - 
   (I*2^(2 - d)*EL^6*gAl^3*gAu*
     (-(gZlRC*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) - 
      gZlLC*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) + 
      gZlLC*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
      gZlRC*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
     \[Mu]^(4 - d)*SPList[SP[p1, q1]])/(Pi^d*(mzC^2 - s)*s^2) - 
   (I*2^(2 - d)*EL^6*gAl^3*gAu*
     (-(gZlRC*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) - 
      gZlLC*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) + 
      gZlLC*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
      gZlRC*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
     \[Mu]^(4 - d)*SPList[SP[p2, q1]])/(Pi^d*(mzC^2 - s)*s^2) + 
   (I*2^(2 - d)*EL^6*gAl^3*gAu*
     ...
     \[Mu]^(4 - d)*SPList[SP[q1, q1]])/(Pi^d*(mzC^2 - s)*s^2) - 
   ...
   (I*2^(5 - d)*EL^6*gAl^3*gAu*(gZlLC + gZlRC)*(gZuLC + gZuRC)*\[Mu]^(4 - d)*
