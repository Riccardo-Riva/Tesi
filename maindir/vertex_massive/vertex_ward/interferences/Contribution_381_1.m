...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
 ...
 ((2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
    (aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*(4*psq - s)*s^2*\[Mu]^(8 - 2*d))/
   Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*s*
    (bb*psq*(8*psq - 3*s) + bb*mm^2*(5*psq - s) + aa*psq*(-5*psq + s) + 
     aa*mm^2*(-8*psq + 3*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*psq*
    (2*aa*mm^2 - 3*bb*mm^2 + 3*aa*psq - 2*bb*psq)*s*\[Mu]^(8 - 2*d)*
  ...
  ((-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(2*aa*mm^2 - 3*bb*mm^2 + 3*aa*psq - 
     2*bb*psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
    (-8*bb*psq^2 + aa*mm^2*(8*psq - 6*s) + aa*psq*(6*psq - s) + 6*bb*psq*s + 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
    (aa*(8*mm^2 + psq) - bb*(mm^2 + 8*psq))*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(aa*mm^2 - bb*psq)*s*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(aa*mm^2 - bb*psq)*
