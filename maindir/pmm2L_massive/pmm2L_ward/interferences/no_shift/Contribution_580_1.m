...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  (((-3*I)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*s*(-psq + s + t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*s*
    ...
    (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*s*
   ...
   (I*4^(1 - d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(bb*(mm^2 + psq - 2*t) + 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*psq - s - 2*t)*
