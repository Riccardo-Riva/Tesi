   ...
   (-((2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(2*psq^3 + psq^2*(s - 6*t) - 
       2*mm^2*(psq - t)*(psq - s - t) - 2*t^2*(s + t) + 
       psq*(-s^2 + s*t + 6*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(2*psq^3 + psq^2*(s - 8*t) - t*(s + 2*t)^2 + 
       psq*(-s^2 + 3*s*t + 10*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(2*psq^3 + 2*mm^2*(psq - t)^2 - 2*t*(s + t)^2 - 
       3*psq^2*(s + 2*t) + psq*t*(7*s + 6*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)*s) + 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*(psq - s)*sw*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(-psq + s + t)*(2*mm^2 - 4*psq + s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(2*mm^2 - 3*psq + t)*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(-2*psq^2 - 2*psq*s + s^2 + 2*mm^2*(psq - t) + 
       2*psq*t + 2*s*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(3*psq^2 - 4*psq*s + s^2 - 6*psq*t + 4*s*t + 
       3*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(2*mm^2 - 4*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*(psq - t)*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(psq - t)*(2*mm^2 - 5*psq + 2*s + 3*t)*
