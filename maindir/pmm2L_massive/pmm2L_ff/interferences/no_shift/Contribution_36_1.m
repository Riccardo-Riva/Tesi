  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(-2*d*gZlL*gZlR*mm^2 + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-((-2 + d)*gZlL^2*mm^2*(2*psq^2 - 2*mm^2*s + s^2 + 3*s*t + 2*t^2 - 
        ...
        3*s*t + 2*t^2 - psq*(s + 4*t)) - 2*gZlL*gZlR*
       ((8 + d)*psq^3 + d*mm^4*s - 2*psq^2*(4*s + (10 + d)*t) - 
        2*t*(s^2 + 3*s*t + 2*t^2) + psq*(2*s^2 + (14 + d)*s*t + 
          (16 + d)*t^2) - mm^2*((4 + 3*d)*psq^2 + (-2 + d)*s^2 + 
          2*(-1 + 2*d)*s*t + (4 + 3*d)*t^2 - 2*psq*((-1 + d)*s + 
            (4 + 3*d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*((-4 + d)*mm^4*(psq - t) - 
   ...
   (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
      ...
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (psq - t)*(gZlL^2*mm^2*s + gZlR^2*mm^2*s - 
      2*gZlL*gZlR*(mm^2*(psq - t) + psq*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(mm^2*(psq - t) + 
   ...
   (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(psq - t)^2*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
