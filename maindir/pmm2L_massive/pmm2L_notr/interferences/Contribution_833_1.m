...
PropList[KiraPropagator[-q1, ml], KiraPropagator[q2, 0], 
  ...
  ((4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
    ...
    (mh^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
     (-2*psq^2 + psq*(-((-14 + d)*s) + 2*t) - 
      2*s*(-((-4 + d)*mm^2) + (2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq^2 + 10*s^2 - 2*d*s^2 + 
      2*mm^2*(psq + (-4 + d)*s - t) + 5*s*t + 2*t^2 - psq*((3 + d)*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(6*psq^2 + 20*s^2 - 
      2*d*s^2 + 2*mm^2*(2*psq + (-4 + d)*s - 2*t) + 14*s*t + 4*t^2 - 
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq^2 - 7*s^2 + 2*d*s^2 + 
      2*mm^2*(psq - (-3 + d)*s - t) + s*t - 2*t^2 + psq*((-3 + d)*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq^2 + 10*s^2 - 
      2*d*s^2 - 6*s*t + 4*t^2 + mm^2*(-4*psq + 2*(-2 + d)*s + 4*t) - 
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
    ...
    (mh^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
     (-4*psq^2 + 4*mm^2*s + 14*psq*s - 18*s^2 + 3*d*s^2 + 8*psq*t - 4*s*t - 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*mm^2 + 2*psq + (-3 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(mh^2*Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-4*psq^2 + 4*mm^2*s - 
      10*s^2 + 3*d*s^2 - 4*s*t - 4*t^2 + 8*psq*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(mm^2 - psq + (-1 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*mm^2 - 4*psq + 2*s + 
      d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
     (2*mm^2 + (-11 + 2*d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(4*psq + (-11 + d)*s - 4*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*mm^2 + d*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*mm^2 - 4*psq - 9*s + 
      2*d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
     (-4*psq + (-7 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-1 + d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-11 + d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-9 + d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[q2, q2]])/(mh^2*Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-psq + 2*s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-psq + 2*s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*mm^2 + psq - 4*s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-3*psq + 4*s + 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq + (2 + d)*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(psq - 2*s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(6*psq + (-14 + d)*s - 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq - 5*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(6*psq + (-18 + d)*s - 6*t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*mm^2 + 5*psq + s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*mm^2 - 5*psq + s + 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq + (-6 + d)*s - 2*t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(3*psq + s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*mm^2 + psq - 2*s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*mm^2 + 2*psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(6*psq + (-12 + d)*s - 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq + d*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq - 3*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq + d*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(psq + s - t)*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-6*psq + (-8 + d)*s + 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq + 3*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-6*psq + (-12 + d)*s + 
      6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq - (-4 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(6*psq - (-6 + d)*s - 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq + (-2 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq + s - 2*t)*
   ...
   (3*4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*\[Mu]^(8 - 2*d)*
 ...
 PropList[KiraPropagator[-q1, ml], KiraPropagator[q2, mh], 
  ...
  ((4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
    ...
    (mh^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
     (-2*psq^2 + psq*(-((-14 + d)*s) + 2*t) - 
      2*s*(-((-4 + d)*mm^2) + (2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq^2 - 10*s^2 + 
      2*d*s^2 - 2*mm^2*(psq + (-4 + d)*s - t) - 5*s*t - 2*t^2 + 
      psq*((3 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
     (6*psq^2 + 20*s^2 - 2*d*s^2 + 2*mm^2*(2*psq + (-4 + d)*s - 2*t) + 
      14*s*t + 4*t^2 - psq*((18 + d)*s + 10*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq^2 - 7*s^2 + 2*d*s^2 + 
      2*mm^2*(psq - (-3 + d)*s - t) + s*t - 2*t^2 + psq*((-3 + d)*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq^2 - 4*psq*s + 
      d*psq*s - 10*s^2 + 2*d*s^2 + mm^2*(4*psq + 4*s - 2*d*s - 4*t) + 
      6*psq*t + 6*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
     (4*psq^2 + 4*mm^2*s - 2*s^2 + d*s^2 - 8*psq*t + 4*s*t + 4*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
