...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    ...
    (Pi^(4*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
     (-((-2 + d)*gZlL^2*(mm^2 + psq)*(psq - s - t)) - 
      ...
      gZlL*gZlR*(d^2*(-mm^2 + psq)*s + 2*d*(psq*(psq - 4*s - t) + 
          mm^2*(psq + 2*s - t)) + 4*(2*psq^2 - 2*mm^2*s + s^2 + 
          psq*(s - 4*t) + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
     ((-2 + d)*gZlL^2*(mm^2 + psq)*(psq - t) + (-2 + d)*gZlR^2*(mm^2 + psq)*
       (psq - t) + gZlL*gZlR*(d^2*(-mm^2 + psq)*s - 
        2*d*(mm^2*(psq - 3*s - t) + psq*(psq + 3*s - t)) + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
     ((-2 + d)*gZlL^2*(4*psq^2 + 2*(-3 + d)*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 
        4*t^2 - 2*psq*((-1 + d)*s + 4*t)) + (-2 + d)*gZlR^2*
       (4*psq^2 + 2*(-3 + d)*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
        2*psq*((-1 + d)*s + 4*t)) - 2*gZlL*gZlR*(12*s^2 + d^2*s^2 + 
        d*(4*psq^2 - 2*mm^2*s - 6*s^2 + 4*s*t + 4*t^2 - 2*psq*(s + 4*t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
     (-(gZlL^2*mm^2*(4*(-2 + d)*psq^2 + (-4 + d)^2*s^2 - 8*(-2 + d)*psq*t + 
         4*(-2 + d)*s*t + 4*(-2 + d)*t^2)) - gZlR^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
     ((-2 + d)*gZlL^2*mm^2*(mm^2 - psq)*s + (-2 + d)*gZlR^2*mm^2*(mm^2 - psq)*
       s + gZlL*gZlR*((12 - 8*d + d^2)*mm^4*s - 
        2*mm^2*(8*psq^2 + (12 - 7*d + d^2)*psq*s - 16*psq*t + 8*t*(s + t)) + 
    ...
    (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
     ((-2 + d)*gZlL^2*(4*psq^2 + 2*(-2 + d)*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 
        4*t^2 - 2*psq*((-2 + d)*s + 4*t)) + (-2 + d)*gZlR^2*
       (4*psq^2 + 2*(-2 + d)*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
        2*psq*((-2 + d)*s + 4*t)) - 4*gZlL*gZlR*(12*s^2 + d^2*s^2 + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*psq*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
     ((-4 + d)*gZlL^2*mm^2*s + (-4 + d)*gZlR^2*mm^2*s + 
      2*gZlL*gZlR*(2*mm^4 + mm^2*(-4*psq + s) + psq*(2*psq + 3*s - d*s)))*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
     ...
     ((-2 + d)*gZlL^2*mm^2*(2*psq + (-4 + d)*s - 2*t) + 
      ...
      2*gZlL*gZlR*(-8*psq^2 + 6*psq*s + 2*s^2 - d*s^2 + 12*psq*t - 4*s*t - 
        4*t^2 + mm^2*(2*(2 + d)*psq + (10 - 8*d + d^2)*s - 2*(2 + d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
      mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
     ((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq + (-4 + d)*s - 2*t) + 
      (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*(2*psq + (-4 + d)*s - 2*t) - 
      2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(d^2*(2*mm^2 - psq)*s - 
        4*(2*psq^2 - 6*mm^2*s + 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
        2*d*(mm^2*(2*psq - 9*s - 2*t) + psq*(-psq + 5*s + t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(4*d)*s^2) + 
   (4^(2 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
     ((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + (-2 + d)*gZlR^2*mm^2*(mm^2 - psq) + 
      2*gZlL*gZlR*(-((-2 + d)*mm^4) + psq*(2*psq + 3*s - d*s) + 
        mm^2*(-10*psq + d*psq + 3*s + 6*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
     (2*(-2 + d)*gZlL^2*mm^2*(psq - s - t) + 2*(-2 + d)*gZlR^2*mm^2*
       (psq - s - t) - gZlL*gZlR*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
        6*psq*(s + 2*t) + 2*mm^2*(2*(-1 + d)*psq + 5*s - 2*d*s + 2*t - 
          2*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(12 - 7*d + d^2)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*
     gZlR*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
     (-2*(-2 + d)*gZlL^2*mm^2*(psq - s - t) - 2*(-2 + d)*gZlR^2*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
     ((-4 + d)*psq*(psq - 2*s - t) + mm^2*(-((4 + d)*psq) + 2*d*s + 4*t + 
        d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*psq*
     ...
     gZlR*mm^2*(-2*s^2 + d*s^2 + 2*mm^2*(2*psq + s - 2*t) + 4*s*t + 4*t^2 - 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
     ((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - (-2 + d)*s - 2*t) + 
      ...
      2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(d^2*(2*mm^2 - psq)*s - 
        4*(2*psq^2 - 6*mm^2*s + 5*psq*s - 4*psq*t + s*t + 2*t^2) - 
        2*d*(mm^2*(2*psq + 7*s - 2*t) + psq*(-psq - 4*s + t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(4*d)*s^2) + 
   (4^(2 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
     (2*(-2 + d)*gZlL^2*mm^2*(psq - t) + 2*(-2 + d)*gZlR^2*mm^2*(psq - t) + 
      gZlL*gZlR*(-2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 2*psq*(s + 2*t) + 
        mm^2*(-4*(-1 + d)*psq + 6*s + 4*(-1 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(12 - 7*d + d^2)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*((-2 + d)*gZlL^2*mm^2*s + 
      (-2 + d)*gZlR^2*mm^2*s + 2*gZlL*gZlR*(4*psq^2 - (-4 + d)*mm^2*s - 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*(d^2*gZlL*gZlR*s^2 + 
      2*s*(gZlL^2*mm^2 + gZlR^2*mm^2 + 2*gZlL*gZlR*(2*mm^2 - 2*psq + 5*s)) - 
      d*(gZlL^2*mm^2*s + gZlR^2*mm^2*s - 2*gZlL*gZlR*(2*psq^2 + mm^2*s - 
          4*s^2 - 4*psq*t + 2*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*((-2 + d)*gZlL^2*mm^2 + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(4*mm^2 - 4*psq + s)*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(mm^2 - t)*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/
    (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[q1, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*
