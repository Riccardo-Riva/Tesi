...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 - p2 + q1, mm], 
  ...
  ((EL^8*gAl^8*mm^4*(me^2*(-8*(-2 + d)*mm^2 + 2*(4 - 6*d + d^2)*s) + 
    ...
    (16*Pi^8*s^3) + (EL^8*gAl^8*mm^2*(2*(2 + d)*mm^4 + 10*s^2 - 3*d*s^2 + 
   ...
   (EL^8*gAl^8*mm^2*(4*(-2 + d)*mm^4 - 12*s^2 + 12*d*s^2 - d^2*s^2 + 
    ...
    (16*Pi^8*s^3) - (EL^8*gAl^8*mm^2*((-4 + 6*d)*mm^4 - 4*s^2 + 2*d*s^2 + 
    ...
    (16*Pi^8*s^3) + (EL^8*gAl^8*mm^2*(-(d^2*s*(2*me^2 + s)) + 
   ...
   ((-2 + d)*EL^8*gAl^8*mm^2*(mm^2 - s - t)*SPList[SP[p1, q1], SP[p1, q1]])/
    ...
    (4*Pi^8*s^3) + ((-2 + d)*EL^8*gAl^8*mm^2*(4*me^2 - 2*mm^2 + 3*s + 2*t)*
   ...
   ((-2 + d)*EL^8*gAl^8*mm^2*(mm^2 - t)*SPList[SP[p2, q1], SP[p2, q1]])/
    ...
    (4*Pi^8*s^3) + ((-2 + d)*EL^8*gAl^8*mm^2*(4*me^2 + 2*mm^2 + s - 2*t)*
