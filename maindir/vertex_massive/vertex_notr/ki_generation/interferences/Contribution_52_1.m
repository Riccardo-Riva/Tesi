...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[-q1, mm], 
 ...
 ((2^(-1 - 2*d)*(16 - 10*d + d^2)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^4*s^2*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - ((-10 + d)*(-2 + d)*EL^6*gAl^2*gFll^2*gWlN*
    gWNl*mm^4*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) - 
  (2^(-1 - 2*d)*(12 - 8*d + d^2)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (2^(-1 - 2*d)*(-2 + d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*
    (2*(-1 + d)*mm^4 + (-6 + d)*s^2 - 2*mm^2*((-3 + d)*psq - (-6 + d)*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  ((20 - 12*d + d^2)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^4*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
  (2^(-1 - 2*d)*(28 - 12*d + d^2)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s*
    (2*(2 - 3*d + d^2)*mm^2 - 2*(6 - 5*d + d^2)*psq - (52 - 20*d + d^2)*s)*
  ...
  ((12 - 8*d + d^2)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  ((-2 + d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*(-4*mm^2 + (-6 + d)*s)*
  ...
  (2^(1 - 2*d)*(32 - 14*d + d^2)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) + 
  ((32 - 14*d + d^2)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*(-4 + d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  ((28 - 12*d + d^2)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*
  ...
  (EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*(2*(-2 + d)*mm^4 - 2*(-2 + d)*mm^2*psq + 
   ...
   ((2*Pi)^(2*d)*s) + ((-4 + d)*(-2 + d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s*
  ...
  (EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*(2*(-2 + d)*mm^2 - 2*(-2 + d)*psq - 
     (24 - 12*d + d^2)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   (2*Pi)^(2*d) - (2^(1 - 2*d)*(-10 + 3*d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*s*
  ...
  (4^(1 - d)*(-4 + d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(28 - 12*d + d^2)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s) + (4^(1 - d)*(-4 + d)*EL^6*gAl^2*gFll^2*gWlN*gWNl*mm^2*
