...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZNL*mm^2*
     ...
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll^2*gZNL*mm^2*
      (-((-2 + d)*gZlL*mm^2) + (-4 + d)*gZlR*psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*aa*(-4 + d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll^2*gZNL*mm^2*
      (-((-2 + d)*gZlL*mm^2) + (-4 + d)*gZlR*psq)*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(aa*d*(mm^2 - psq) + 
    ...
    (I*4^(1 - d)*bb*(-4 + d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFFA*
      gFll^2*gZlR*gZNL*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gFFA*gFll^2*
      gZlR*gZNL*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*bb*(-4 + d)*EL^5*gFFA*gFll^2*gZlR*
      gZNL*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-4 + d)*EL^5*gFFA*gFll^2*gZlR*
    ...
    (I*2^(3 - 2*d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*d*EL^5*gFFA*gFll^2*gZlR*gZNL*
      mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
       SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*
      gZNL*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q2], SP[p3, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*
      gZNL*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
