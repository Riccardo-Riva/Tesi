...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gFFZ^2*s*
  ...
  (EL^5*gAl*gFFZ^2*(bb*(gZlL^2*(4*mm^4 + mm^2*(3*psq - 4*s) + 
   ...
   (2*Pi)^(2*d) + (4^(1 - d)*EL^5*gAl*gFFZ^2*mm^2*
  ...
  (4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(mm^4 + mm^2*(psq - s) - 2*psq*s) - 
     bb*(mm^4 + mm^2*(psq - 2*s) - psq*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/Pi^(2*d) + 
  (EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(bb*(3*mm^2 + psq) - aa*(mm^2 + 3*psq))*
  ...
  (4^(1 - d)*EL^5*gAl*gFFZ^2*(aa*(4*gZlL*gZlR*mm^2*(4*psq - s) + 
  ...
  (4^(1 - d)*EL^5*gAl*gFFZ^2*(aa*(gZlL^2*(2*mm^2 + psq)*s + 
       gZlR^2*(2*mm^2 + psq)*s + 2*gZlL*gZlR*mm^2*(-4*psq + s)) - 
     bb*(gZlL^2*(mm^2 + 2*psq)*s + gZlR^2*(mm^2 + 2*psq)*s + 
       2*gZlL*gZlR*mm^2*(-4*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (aa*(mm^4 + mm^2*(psq - s) - 2*psq*s) - 
     bb*(mm^4 + mm^2*(psq - 2*s) - psq*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*
    (2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (2^(3 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(-(bb*(3*mm^2 + psq)) + 
     aa*(mm^2 + 3*psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
   (2*Pi)^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*s*
  ...
  (2^(3 - 2*d)*EL^5*gAl*gFFZ^2*(gZlL^2 + gZlR^2)*(aa*mm^2 - bb*psq)*
