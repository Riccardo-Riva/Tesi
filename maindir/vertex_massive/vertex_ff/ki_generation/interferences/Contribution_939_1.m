...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((4^(2 - d)*(-2 + d)*EL^6*gAl^5*gAu*ml^2*mm^2*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^5*gAu*ml^2*
    ...
    (4^(2 - d)*EL^6*gAl^5*gAu*mm^2*(4*psq^3 + 2*mm^2*(psq - t)^2 - 
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^5*gAu*ml^2*(2*(mm^2 - psq)*s + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^5*gAu*ml^2*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
    ...
    (4^(2 - d)*EL^6*gAl^5*gAu*((-4 + d)*mm^2 + s)*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*ml^2*
    ...
    (4^(3 - d)*(-2 + d)*EL^6*gAl^5*gAu*ml^2*(mm^2 - psq)*(psq - t)*
    ...
    (4^(3 - d)*(-2 + d)*EL^6*gAl^5*gAu*ml^2*(psq^2 + mm^2*s + (s + t)^2 - 
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*ml^2*(2*psq - s - 2*t)*
