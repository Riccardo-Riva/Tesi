...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(mm^2 - psq)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(mm^2 - psq)*(3*psq^2 + 3*t*(s + t) - 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(2*psq^2 + mm^2*s - 2*psq*(s + t))*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq - t)*
      ...
      (mm^2 - psq)*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*
      (psq - t)*(-3*psq^2 - 2*t*(s + t) + mm^2*(-3*psq + s + 3*t) + 
       psq*(s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*(psq - t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*
      (-(psq*s) + mm^2*(psq - t))*(psq - t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq - t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq - t)*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*psq*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - 2*psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(-3*psq^2 + mm^2*(psq - t) - 
       2*t*(s + t) + psq*(s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2*(psq - t) + t*(-psq + s + t))*
