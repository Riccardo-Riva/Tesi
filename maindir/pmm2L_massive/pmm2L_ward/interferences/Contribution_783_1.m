...
PropList[KiraPropagator[-q1, ml], KiraPropagator[q2, mh], 
 ...
 (((-I)*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*s*
    (aa*(mm^4 + 2*psq*(-psq + s + t) + mm^2*(-3*psq + 2*t)) + 
     bb*(mm^4 + 2*psq*(psq - t) + mm^2*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*
   ...
   Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*
    (bb*(4*psq^2 - 9*psq*s + 2*s^2 + 2*mm^2*(2*psq + s - 2*t) - 4*psq*t + 
       ...
       4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*ml^4*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*s*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^2*mm^2*s*
    (aa*(mm^4 + 2*psq*(-psq + s + t) + mm^2*(-3*psq + 2*t)) + 
     bb*(mm^4 + 2*psq*(psq - t) + mm^2*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^2*mm^2*s*
    (aa*(mm^4 + 2*psq*(-psq + s + t) + mm^2*(-3*psq + 2*t)) + 
     bb*(mm^4 + 2*psq*(psq - t) + mm^2*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*
    ml^4*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
     bb*(6*mm^2 - 14*psq + 5*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
     bb*(6*mm^2 - 10*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
     bb*(2*mm^2 - 10*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*ml^4*mm^2*(2*psq - s - 2*t)*
  ...
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(4*psq - 3*s - 4*t) + 
     bb*(4*mm^2 - 8*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
     bb*(2*mm^2 - 8*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*ml^4*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^2*mm^2*
    (bb*(4*psq^2 - 9*psq*s + 2*s^2 + 2*mm^2*(2*psq + s - 2*t) - 4*psq*t + 
       3*s*t) + aa*(-4*psq^2 + 3*psq*s - 2*s^2 + 4*psq*t - 3*s*t + 
       4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^2*mm^2*
    (bb*(4*psq^2 - 9*psq*s + 2*s^2 + 2*mm^2*(2*psq + s - 2*t) - 4*psq*t + 
       3*s*t) + aa*(-4*psq^2 + 3*psq*s - 2*s^2 + 4*psq*t - 3*s*t + 
       4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/
   Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*
  ...
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
   Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*ml^4*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*ml^2*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*ml^2*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*ml^2*mm^2*s*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^2*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^2*mm^2*
    (aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^2*mm^2*(aa*(4*mm^2 - s - 4*t) + 
  ...
  (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll^4*ml^2*mm^2*
