...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^4*sw*t*
       (s + t)^2*\[Mu]^(8 - 2*d))/((mh^2 - mz^2)*Pi^(2*d)*s)) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^4*sw*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*(mm^2 - t)*
      (s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^4*sw*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^4*s*sw*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*t*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^4*sw*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*(s + t)*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) + (3*4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*t*(s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^4*sw*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*t*(s + 2*t)*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[-p3 - q1 + q2, mw]]*
   ((4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^4*sw*t*(s + t)^2*
