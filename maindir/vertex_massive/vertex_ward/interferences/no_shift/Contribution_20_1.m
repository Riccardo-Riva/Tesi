...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (aa*(mm^2*(4*psq - 2*s) + (4*psq - s)*s) - 
      bb*((psq - s)*s + mm^2*(4*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (aa*mm^2*(4*psq - s) + aa*(5*psq - s)*s + bb*s*(-2*psq + s) - 
      2*bb*mm^2*(2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 + psq - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(3*mm^2 + 3*psq - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*(bb*(mm^2 + 3*psq - s) + 
      aa*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*s*(aa*mm^2*(8*psq - 3*s) + 
   ...
   (2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(2*mm^2 + 2*psq - s) + 
      aa*(-4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    Pi^(2*d) - (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (mm^2 + psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    Pi^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*
     (4*mm^4 + mm^2*(4*psq - s) + psq*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(8*psq - 3*s) + aa*psq*s + 
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(-4*bb*mm^2*psq + 
