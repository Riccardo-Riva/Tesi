...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
    (aa*((-2 + d)*mm^4 + (6 - 5*d)*psq^2 - 2*s*(s + 2*t) + 
       mm^2*(4*(-1 + d)*psq + 4*s - 3*d*s + 6*t - 5*d*t) + 
       psq*(3*d*s - 6*t + 5*d*t)) + bb*((-2 + d)*mm^4 + (-6 + 5*d)*psq^2 + 
       2*s*(s + 2*t) + mm^2*((8 - 6*d)*psq + 2*(-1 + d)*s + (-6 + 5*d)*t) - 
       psq*(2*(1 + d)*s + (-6 + 5*d)*t)))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
    (bb*(-4*(-6 + 5*d)*psq^2 + 10*(-4 + 3*d)*psq*s + 4*(-6 + 5*d)*psq*t - 
       (-8 + 7*d)*s*(s + 2*t) + 2*mm^2*((-4 + 8*d)*psq + 8*s - 7*d*s + 4*t - 
         8*d*t)) + aa*(4*(-6 + 5*d)*psq^2 + (-8 + 7*d)*s*(s + 2*t) + 
       2*mm^2*((4 - 8*d)*psq + 4*s + d*s - 4*t + 8*d*t) - 
       2*psq*((-8 + 9*d)*s + 2*(-6 + 5*d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
    (bb*(2*(-6 + 5*d)*psq^2 + (44 - 25*d)*psq*s + (-8 + 6*d)*s^2 + 
       2*(6 - 5*d)*psq*t + (-24 + 13*d)*s*t - 
       4*mm^2*((-1 + 2*d)*psq + 5*s - 3*d*s + t - 2*d*t)) + 
     aa*(-2*(-6 + 5*d)*psq^2 + 3*(-8 + 5*d)*psq*s + (8 - 6*d)*s^2 + 
       2*(-6 + 5*d)*psq*t + (24 - 13*d)*s*t + 
       mm^2*((-4 + 8*d)*psq + 4*t - 2*d*(s + 4*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (-(bb*d*(mm^2 - psq)*(mm^2*(psq - t) + 2*s*(-2*psq + 2*s + t))) + 
     aa*d*(mm^2 - psq)*(mm^2*(psq - t) + s*(-2*psq + s + 2*t)) + 
     2*aa*(s*(-2*psq^2 - psq*(s - 2*t) + s*(s + t)) + 
       mm^2*(2*psq^2 + s*(s + t) - psq*(s + 2*t))) - 
     2*bb*(4*mm^4*s + s*(-2*psq^2 + s*(s + t) + psq*(3*s + 2*t)) + 
       mm^2*(2*psq^2 + s*(-3*s + t) - psq*(5*s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
    (bb*(-2*(-6 + 5*d)*psq^2 + (-36 + 19*d)*psq*s + (4 - 3*d)*s^2 + 
       2*(-6 + 5*d)*psq*t + (16 - 7*d)*s*t + 4*mm^2*((-1 + 2*d)*psq + 5*s - 
         3*d*s + t - 2*d*t)) + aa*(2*(-6 + 5*d)*psq^2 + (16 - 9*d)*psq*s + 
       (-4 + 3*d)*s^2 + 2*(6 - 5*d)*psq*t + (-16 + 7*d)*s*t + 
       mm^2*((4 - 8*d)*psq + 2*d*s - 4*t + 8*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
    (aa*(-2*(-6 + 5*d)*psq^2 + (-16 + 11*d)*psq*s + (16 - 7*d)*s^2 + 
       2*(-6 + 5*d)*psq*t + (24 - 13*d)*s*t + 
       4*mm^2*((-1 + 2*d)*psq + (-4 + d)*s + t - 2*d*t)) + 
     bb*(2*(-6 + 5*d)*psq^2 + (36 - 21*d)*psq*s + (-16 + 7*d)*s^2 + 
       2*(6 - 5*d)*psq*t + (-24 + 13*d)*s*t + 
       mm^2*((4 - 8*d)*psq - 4*s + 6*d*s - 4*t + 8*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*d*(mm^2 - psq)*(mm^2*(psq - s - t) + 2*s*(-s + t)) - 
     bb*d*(mm^2 - psq)*(mm^2*(psq - s - t) + s*(-2*psq + s + 2*t)) + 
     2*aa*(-4*mm^4*s + s*(-2*psq^2 - 3*psq*s + 2*psq*t + s*t) + 
       mm^2*(2*psq^2 + psq*(s - 2*t) + s*(4*s + t))) - 
     2*bb*(mm^2*(2*psq^2 - 3*psq*s - 2*psq*t + s*t) + 
       s*(-2*psq^2 + s*t + psq*(s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
    (aa*(-2*(-6 + 5*d)*psq^2 + (-8 + 5*d)*psq*s - 4*(-3 + d)*s^2 + 
       2*(-6 + 5*d)*psq*t + (16 - 7*d)*s*t + 
       4*mm^2*((-1 + 2*d)*psq + (-4 + d)*s + t - 2*d*t)) + 
     bb*(2*(-6 + 5*d)*psq^2 + (28 - 15*d)*psq*s + 4*(-3 + d)*s^2 + 
       2*(6 - 5*d)*psq*t + (-16 + 7*d)*s*t + 
       mm^2*((4 - 8*d)*psq - 4*s + 6*d*s - 4*t + 8*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
    (bb*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     aa*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*s*
    (bb*(-4*psq^2 - d*(mm^2 - psq)*(3*psq - 2*s - 3*t) + 4*psq*t + 
       2*s*(-mm^2 + s + 2*t)) + 
     aa*(4*psq^2 + d*(mm^2 - psq)*(3*psq - s - 3*t) + 4*psq*(s - t) - 
       2*s*(mm^2 + s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
  (I/2)*EL^5*gAl^3*gHll^2*mm^4*s*(((aa - bb)*(-4 + 3*d)*(-2*psq + s + 2*t))/
     (2*Pi)^(2*d) - (2^(1 - 2*d)*(bb*((-2 + d)*mm^2 - (-6 + d)*psq - 
         2*(s + 2*t)) + aa*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))))/
     Pi^(2*d))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]] - 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*s*
    ...
    mm^2*(mm^2 - psq)*s*(aa*(mm^2 + psq - 2*s - t) + bb*(mm^2 - psq - s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
    (bb*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     aa*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
    (aa*(4*(-2 + d)*mm^2 + (-8 + 6*d)*psq - (-8 + 5*d)*(s + 2*t)) + 
     bb*(4*(-2 + d)*mm^2 + (24 - 14*d)*psq + (-8 + 5*d)*(s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*(4*(-2 + d)*mm^2 + 8*(-5 + 3*d)*psq + 24*s - 
       15*d*s + 48*t - 28*d*t) + bb*(12*(-2 + d)*mm^2 - 8*(-9 + 5*d)*psq - 
       24*s + 15*d*s - 48*t + 28*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^2*
    (aa*((-4 + d)*mm^4 - mm^2*((8 + d)*psq + (-20 + d)*s - 12*t) + 
       4*s*(psq - 2*(s + t)) + d*(2*psq^2 + 4*s*(s + t) - psq*(5*s + 2*t))) - 
     bb*((12 + d)*mm^4 + 28*psq*s - 8*s*(s + t) + 
       mm^2*(-((24 + 5*d)*psq) - 4*s + 9*d*s + 12*t) + 
       d*(6*psq^2 + 4*s*(s + t) - psq*(15*s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*(4*(-2 + d)*mm^2 + 12*(-2 + d)*psq + 16*s - 
       9*d*s + 32*t - 16*d*t) + bb*(12*(-2 + d)*mm^2 - 28*(-2 + d)*psq - 
       16*s + 9*d*s - 32*t + 16*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*(12*(-2 + d)*mm^2 + 8*(-3 + 2*d)*psq + 24*s - 
       13*d*s + 48*t - 28*d*t) + bb*(4*(-2 + d)*mm^2 - 8*(-7 + 4*d)*psq - 
       24*s + 13*d*s - 48*t + 28*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gHll^2*mm^2*(bb*(-((-4 + d)*mm^4) + 2*d*psq^2 + 12*psq*s - 
       5*d*psq*s - 2*d*psq*t - 8*s*t + 4*d*s*t + 
       mm^2*((-16 + d)*psq + (-8 + d)*s + 12*t)) + 
     aa*((12 + d)*mm^4 + 4*s*(3*psq + 2*t) - mm^2*(5*d*psq + 16*s - 9*d*s + 
         12*t) + d*(2*psq^2 - 5*psq*s + 2*psq*t - 4*s*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*(12*(-2 + d)*mm^2 + 4*(-2 + d)*psq + 16*s - 
       7*d*s + 32*t - 16*d*t) + bb*(4*(-2 + d)*mm^2 - 20*(-2 + d)*psq - 
       16*s + 7*d*s - 32*t + 16*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^4*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*((8 - 6*d)*psq^2 - (-4 + 3*d)*s*(s + 2*t) + 
       psq*(-4*s + 7*d*s - 8*t + 6*d*t) + 4*mm^2*((2 + d)*psq - 3*s - 
         (2 + d)*t)) + bb*((-8 + 6*d)*psq^2 + (-4 + 3*d)*s*(s + 2*t) + 
       psq*((20 - 11*d)*s + (8 - 6*d)*t) - 4*mm^2*((2 + d)*psq + s - d*s - 
         (2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*
  ...
  (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*
    (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^4*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*((-16 + 9*d)*psq - 6*(-2 + d)*s + 
       (16 - 9*d)*t) + bb*(4*(-2 + d)*mm^2 + (24 - 13*d)*psq - 12*s + 6*d*s - 
       16*t + 9*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl^3*gHll^2*mm^2*
    (bb*(8*mm^4 + 2*(2 + d)*psq^2 + psq*((20 - 9*d)*s - 4*t) + 
       4*(-3 + d)*s*(s + t) + mm^2*(-18*psq + (2 + 3*d)*s - 2*(-5 + d)*t)) + 
     aa*(-4*psq^2 - 4*(-3 + d)*s*(s + t) + psq*((-12 + 5*d)*s + 4*t) + 
       mm^2*(-2*(-5 + d)*psq + (-10 + d)*s + 2*(-5 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*(12*(-2 + d)*psq + (20 - 9*d)*s - 
       12*(-2 + d)*t) + bb*(8*(-2 + d)*mm^2 - 20*(-2 + d)*psq - 20*s + 
       9*d*s - 24*t + 12*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*(4*(-2 + d)*mm^2 + 2*(-12 + 7*d)*psq - 
       (-16 + 9*d)*(s + 2*t)) + bb*(4*(-2 + d)*mm^2 + (40 - 22*d)*psq + 
       (-16 + 9*d)*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^2*
    (-(bb*((-4 + d)*mm^4 - 4*(psq - (-3 + d)*s)*(psq - t) + 
        mm^2*((14 - 3*d)*psq + 8*s + 2*(-5 + d)*t))) + 
     aa*((4 + d)*mm^4 + 2*(-2 + d)*psq^2 - 4*psq*(s - t) - 4*(-3 + d)*s*t + 
       mm^2*(6*psq - 5*d*psq + 4*d*s - 10*t + 2*d*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*
    (aa*(2*mm^2 + 4*psq - 3*s - 6*t) + bb*(2*mm^2 - 8*psq + 3*s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*((4 - 3*d)*psq^2 + 6*(-2 + d)*psq*s - 
       2*(-2 + d)*s^2 + (2 + d)*mm^2*(2*psq - s - 2*t) + (-4 + 3*d)*psq*t + 
       (12 - 5*d)*s*t) + bb*((-4 + 3*d)*psq^2 + (20 - 8*d)*psq*s + 
       2*(-2 + d)*s^2 + (4 - 3*d)*psq*t + (-12 + 5*d)*s*t + 
       mm^2*(-2*(2 + d)*psq + 3*(-2 + d)*s + 2*(2 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(4*(-2 + d)*psq + (8 - 3*d)*s - 
     4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I/2)*EL^5*gAl^3*gHll^2*mm^2*
   ...
   SPList[SP[p1, p3], SP[q1, q1]] - 
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - 2*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*(-4*psq^2 + 3*(-2 + d)*psq*s + 4*psq*t - 
       2*(-3 + d)*s*(s + t) + mm^2*(-((-6 + d)*psq) - 6*s + (-6 + d)*t)) + 
     bb*(8*mm^4 - mm^2*((14 + d)*psq + (2 - 3*d)*s + (-6 + d)*t) + 
       2*((2 + d)*psq^2 + (7 - 3*d)*psq*s - 2*psq*t + (-3 + d)*s*(s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gHll^2*mm^2*
    (-(bb*((4 + d)*mm^4 + 2*(2 + d)*psq^2 + 4*(-3 + d)*s*(s + t) - 
        4*psq*(2*(-2 + d)*s + t) + mm^2*(-((14 + d)*psq) + 2*(5 + d)*s - 
          2*(-5 + d)*t))) + aa*((-4 + d)*mm^4 + 4*(psq - (-3 + d)*s)*
        (psq - s - t) + mm^2*((-6 + d)*psq - 2*((-9 + d)*s + (-5 + d)*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - 2*s)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^2*(bb*((4 + d)*mm^4 + 2*(2 + d)*psq^2 - 
       5*(-2 + d)*psq*s - 4*psq*t + 2*(-3 + d)*s*(s + t) + 
       mm^2*(-2*(5 + d)*psq + 2*(3 + d)*s - (-6 + d)*t)) + 
     aa*(-((-4 + d)*mm^4) - 2*(2*psq - (-3 + d)*s)*(psq - s - t) + 
       mm^2*(2*psq + (-14 + d)*s + (-6 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*(4*psq^2 + 2*psq*(s - 2*t) + d*(mm^2 - psq)*(psq - t) - 
       2*s*(s + t)) + bb*(-4*psq^2 - d*(mm^2 - psq)*(psq - 2*s - t) + 
       2*s*(-2*mm^2 + s + t) + 2*psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*s*(5*psq - 3*s - 5*t) + 
     bb*mm^2*(2*psq + s - 2*t) + aa*mm^2*(-2*psq + s + 2*t) + 
     bb*s*(-7*psq + 3*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*EL^5*gAl^3*gHll^2*mm^2*
    (-(bb*(-4 + d)*(psq + 2*s)*(psq - s - t)) + 
     2*bb*mm^2*((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t) + 
     aa*mm^2*(-2*(-2 + d)*psq + (-4 + d)*s + 2*(-2 + d)*t) + 
     aa*(-4 + d)*(psq^2 + psq*(2*s - t) - 2*s*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*s*(aa*(psq - s - t) + 
  ...
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*(-8 + 3*d)*(psq - s - t) + 
     bb*(4*(-2 + d)*mm^2 + (16 - 7*d)*psq + (-8 + 3*d)*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*
    (aa*(2*mm^2 + 4*psq - 3*s - 6*t) + bb*(2*mm^2 - 8*psq + 3*s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^2*
    (-(bb*((-4 + d)*mm^4 - 2*(2*psq - (-3 + d)*s)*(psq - t) + 
        mm^2*(-2*(-5 + d)*psq + 8*s + (-6 + d)*t))) + 
     aa*((4 + d)*mm^4 + 2*(-2 + d)*psq^2 - 2*(-3 + d)*s*t + 
       psq*(2*s - d*s + 4*t) + mm^2*((2 - 4*d)*psq + 3*d*s - 6*t + d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*(4*(-2 + d)*mm^2 + 2*(-4 + d)*psq - 
       (-8 + 3*d)*(s + 2*t)) + bb*(4*(-2 + d)*mm^2 + (24 - 10*d)*psq + 
       (-8 + 3*d)*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*s + d*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*((4 - 3*d)*psq^2 + 4*(-2 + d)*psq*s - 
       (-2 + d)*s^2 + (2 + d)*mm^2*(2*psq - s - 2*t) + (-4 + 3*d)*psq*t + 
       (8 - 3*d)*s*t) + bb*((-4 + 3*d)*psq^2 + (16 - 6*d)*psq*s + 
       (-2 + d)*s^2 + (4 - 3*d)*psq*t + (-8 + 3*d)*s*t + 
       mm^2*(-2*(2 + d)*psq + 3*(-2 + d)*s + 2*(2 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(4*(-2 + d)*psq + (8 - 3*d)*s - 
     4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I/2)*EL^5*gAl^3*gHll^2*mm^2*
   ((2^(1 - 2*d)*(aa + bb)*(-4 + d)*(mm^2 - psq)*s)/Pi^(2*d) - 
    (2^(1 - 2*d)*(aa - bb)*(-4 + d)*psq*(2*psq - s - 2*t))/Pi^(2*d) - 
    ...
    (2*aa*(-2 + d)*mm^2*(2*psq - s - 2*t) - aa*(-4 + d)*s*(psq - t) - 
      bb*(-4 + d)*s*(psq + t) - 4*bb*mm^2*((-2 + d)*psq - (-3 + d)*s - 
        (-2 + d)*t))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, q2], SP[q1, q1]] - 
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gHll^2*mm^4*(aa*(4*(-2 + d)*mm^2 - 8*psq + 5*d*psq + 4*s - 
       3*d*s + 16*t - 9*d*t) + bb*((16 - 9*d)*psq - 4*s + 3*d*s - 16*t + 
       9*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*(8*mm^4 + 2*(-2 + d)*psq^2 - 4*(-3 + d)*s*t + 
       psq*(-(d*s) + 4*t) + mm^2*((2 - 4*d)*psq + (-8 + 5*d)*s + 
         2*(-5 + d)*t)) + bb*(4*psq^2 + psq*((8 - 3*d)*s - 4*t) + 
       4*(-3 + d)*s*t + mm^2*(2*(-5 + d)*psq + 10*t - d*(s + 2*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gHll^2*mm^4*(bb*(-12*(-2 + d)*psq + (-4 + 3*d)*s + 
       12*(-2 + d)*t) + aa*(8*(-2 + d)*mm^2 + 4*(-2 + d)*psq + 4*s - 3*d*s + 
       24*t - 12*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*s + d*(psq - s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gHll^2*mm^2*
    (bb*((-4 + 3*d)*psq^2 - (2 + d)*mm^2*(2*psq - s - 2*t) + 
       psq*(16*s - 7*d*s + 4*t - 3*d*t) + s*(-8*s + 3*d*s - 12*t + 5*d*t)) + 
     aa*((4 - 3*d)*psq^2 + s*((8 - 3*d)*s + (12 - 5*d)*t) + 
       mm^2*(2*(2 + d)*psq + (-10 + d)*s - 2*(2 + d)*t) + 
       psq*((-8 + 5*d)*s + (-4 + 3*d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(-4*(-2 + d)*psq - 8*t + d*(s + 4*t))*
   ...
   ((2^(1 - 2*d)*(aa + bb)*(-4 + d)*(mm^2 - psq)*s)/Pi^(2*d) - 
    ...
    (2*bb*(-2 + d)*mm^2*(2*psq - s - 2*t) - aa*(-4 + d)*s*(-3*psq + s + t) + 
      bb*(-4 + d)*s*(-psq + s + t) + 4*aa*mm^2*(-((-2 + d)*psq) + s + 
        (-2 + d)*t))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p2, p3], SP[q1, q1]] - 
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*s + d*(psq - s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - 2*s)*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*(8*mm^4 + 2*(-2 + d)*psq^2 - 2*(-3 + d)*s*t + 
       psq*(-2*(-3 + d)*s + 4*t) + mm^2*(-((2 + 3*d)*psq) + 4*(-2 + d)*s + 
         (-6 + d)*t)) + bb*(4*psq^2 + 2*(-3 + d)*s*t - 
       psq*((-2 + d)*s + 4*t) + mm^2*((-6 + d)*psq + 6*t - d*(s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*(4*psq^2 + 2*psq*(s - 2*t) + d*(mm^2 - psq)*(psq + s - t) - 
       2*s*(2*mm^2 + t)) + bb*(-4*psq^2 - d*(mm^2 - psq)*(psq - s - t) + 
       2*s*t + 2*psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(bb*s*(5*psq - 2*s - 5*t) + 
     aa*mm^2*(2*psq - 3*s - 2*t) + bb*mm^2*(-2*psq + s + 2*t) + 
     aa*s*(-3*psq + 2*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p3, q1]])/Pi^(2*d) - (I*EL^5*gAl^3*gHll^2*mm^2*
    (-(aa*(-4 + d)*(psq + 2*s)*(psq - t)) + 
     2*aa*mm^2*((-2 + d)*psq - 2*s - (-2 + d)*t) + 
     bb*(-4 + d)*(psq^2 + psq*(s - t) - 2*s*t) + 
     bb*mm^2*(-2*(-2 + d)*psq - 4*t + d*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*s*(aa*(2*mm^2 - psq - t) + 
  ...
  (I*EL^5*gAl^3*gHll^2*mm^4*(-(bb*(-8 + 3*d)*(psq - t)) + 
     aa*(4*(-2 + d)*mm^2 + 8*t - d*(psq + 3*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*s + d*(psq - s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gHll^2*mm^2*(bb*((-4 + 3*d)*psq^2 + (12 - 5*d)*psq*s + 
       2*(-3 + d)*s^2 - (2 + d)*mm^2*(2*psq - s - 2*t) + (4 - 3*d)*psq*t + 
       (-8 + 3*d)*s*t) + aa*((4 - 3*d)*psq^2 + (-4 + 3*d)*psq*(s + t) + 
       s*(-2*(-3 + d)*s + (8 - 3*d)*t) + mm^2*(2*(2 + d)*psq + (-10 + d)*s - 
         2*(2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*
    (-4*(-2 + d)*psq - 8*t + d*(s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*s*(-2*psq + s + 2*t)*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*mm^2 - 2*bb*(-1 + d)*mm^2 - 
     aa*(-2 + d)*(psq - s - t) + bb*(-2 + d)*(3*psq - s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(2*bb*mm^2 - 2*aa*(-1 + d)*mm^2 + 
     bb*(-2 + d)*(psq - t) + aa*(-2 + d)*(psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (bb*((-8 + 7*d)*mm^2 + (20 - 11*d)*psq + 4*(-2 + d)*(s + t)) - 
     aa*(12*psq - 8*(s + t) + d*(mm^2 - 5*psq + 4*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (bb*((8 + d)*mm^2 - 4*psq + 3*d*psq + 8*t - 4*d*t) + 
     aa*(-4*(psq + 2*t) + d*(-7*mm^2 + 3*psq + 4*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (bb*((-8 + 5*d)*mm^2 + (16 - 7*d)*psq + 2*(-2 + d)*(s + t)) - 
     aa*(8*psq - 4*(s + t) + d*(mm^2 - 3*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*((8 + d)*mm^2 + (12 - 5*d)*psq + 4*(-2 + d)*(s + t)) + 
     bb*(-7*d*mm^2 - 20*psq + 11*d*psq + 8*s + 8*t - 4*d*(s + t)))*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*((8 + d)*mm^2 + (8 - 3*d)*psq + 2*(-2 + d)*(s + t)) + 
     bb*(-5*d*mm^2 + 7*d*psq - 2*d*(s + t) + 4*(-4*psq + s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*gHll^2*mm^2*(bb*((-4 + 3*d)*mm^2 + (8 - 5*d)*psq + 
       2*(-2 + d)*(s + t)) + aa*((-4 + d)*mm^2 + 4*(s + t) + 
       d*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p3, p3]])/(2*Pi)^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
  ...
  (I*EL^5*gAl^3*gHll^2*mm^2*(bb*((-4 + 3*d)*mm^2 + (8 - 5*d)*psq + 
       2*(-2 + d)*(s + t)) + aa*((-4 + d)*mm^2 + 4*(s + t) + 
       d*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (bb*((8 + d)*mm^2 + d*psq + 4*t - 2*d*t) + 
     aa*(-4*(2*psq + t) + d*(-5*mm^2 + 3*psq + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
     bb*(6*mm^2 - 10*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (bb*(-4*psq + d*(mm^2 + 3*psq - 4*t) + 8*t) + 
     aa*((8 - 7*d)*mm^2 + (-4 + 3*d)*psq + 4*(-2 + d)*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
     bb*(2*mm^2 - 10*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*(8 - 5*d)*mm^2 + aa*(-8 + 3*d)*psq + bb*d*(mm^2 + psq - 2*t) + 
     4*bb*t + 2*aa*(-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl^3*
  ...
  (I*EL^5*gAl^3*gHll^2*mm^2*(bb*((-4 + d)*mm^2 + (8 - 3*d)*psq + 
       2*(-2 + d)*t) + aa*((-4 + 3*d)*mm^2 + 4*t - d*(psq + 2*t)))*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(bb*d*(mm^2 - psq) + 
     2*aa*(psq - s - t) + 2*bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*(d*(mm^2 - psq) + 3*psq - t) + 
     bb*(-6*psq + d*(-mm^2 + psq) + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(bb*d*(mm^2 - psq) + 
     2*aa*(psq - s - t) + 2*bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*d*(mm^2 - psq) - 
     3*bb*d*(mm^2 - psq) + 4*aa*(s + t) - 4*bb*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (-2*bb*(d*(mm^2 - psq) + psq + s + t) + 
     aa*(d*(mm^2 - psq) + 2*(psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(-3 + d)*(psq - s - t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*(3*d*(mm^2 - psq) + 10*psq - 2*t) + 
     2*bb*(-5*psq + d*(-mm^2 + psq) + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (2*aa*(d*(mm^2 - psq) + 3*psq + s + t) - 
     bb*(3*d*(mm^2 - psq) + 2*(3*psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*(-4 + d)*mm^2 + aa*(-2 + d)*psq + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*(-4 + d)*mm^2 + 2*aa*psq + 
  ...
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*(-4 + d)*mm^2 + 2*aa*psq + 
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*
    gHll^2*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(-aa + bb)*EL^5*gAl^3*gHll^2*mm^2*
    (d*(mm^2 - psq) + 4*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*
  ...
  (I*EL^5*gAl^3*gHll^2*mm^2*(aa*(-2*psq + d*(mm^2 - t) + 2*t) + 
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*(d*mm^2 + 2*psq - d*psq - 2*t) + 2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(-(bb*(-3 + d)*(psq - t)) + 
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(4*mm^2 - s - 4*t) + 
     bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
    (-2*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*
    gHll^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
    ...
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
     SP[q1, q1]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[q2, q2]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
  ...
  (I*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
    (-2*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*
