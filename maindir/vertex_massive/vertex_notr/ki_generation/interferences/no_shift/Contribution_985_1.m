...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((d*EL^6*gAl^4*mm^2*(-(2^(3 + 2*d)*(4 - 5*d + d^2)*gZlL*gZlR*mm^2*Pi^(2*d)*
     ...
     \[Mu]^(8 - 2*d))/(2*Pi)^(4*d) + 
   (2^(1 - 2*d)*d*EL^6*gAl^4*mm^2*((12 - 8*d + d^2)*gZlL^2*s + 
      (12 - 8*d + d^2)*gZlR^2*s + 2*gZlL*gZlR*((4 - 8*d + d^2)*mm^2 - 
        (-2 + d)^2*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (2^(1 - 4*d)*(-2 + d)*EL^6*gAl^4*mm^2*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*
   ...
   (4^(1 - d)*d*EL^6*gAl^4*mm^2*(12*(gZlL^2 + gZlR^2)*s + 
      d^2*(gZlL^2 + gZlR^2)*s - 2*d*(4*gZlL^2*s + 4*gZlR^2*s + 
        gZlL*gZlR*(3*mm^2 + s)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*(mm^2 - s)*
   ...
   (2^(3 - 2*d)*(-2 + d)*d*EL^6*gAl^4*mm^2*(gZlL^2*(-mm^2 + psq) + 
      gZlR^2*(-mm^2 + psq) + (-2 + d)*gZlL*gZlR*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)^2*EL^6*gAl^4*(-2*(-2 + d)*gZlL*gZlR*mm^2*s + 
   ...
   (2^(1 - 4*d)*(-2 + d)*EL^6*gAl^4*(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d) - 
      (-4 + d)*(-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 - s) - 
      (-4 + d)*(-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 - s))*\[Mu]^(8 - 2*d)*
