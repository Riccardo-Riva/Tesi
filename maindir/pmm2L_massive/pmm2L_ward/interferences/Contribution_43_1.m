 ...
 (((-I)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*
    ...
    SPList[SP[p3, q2]])/Pi^(2*d) - (I*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*(mm^3 - mm*psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*
    gXll*(gZlL - gZlR)*(mm^3 - mm*psq)^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(bb*(3*mm^2 + psq)*(psq - s - t) + 
     aa*(2*mm^4 + psq*(-3*psq + s + t) + 3*mm^2*(-psq + s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(4*mm^4 + psq*(-psq + s + t) + mm^2*(-7*psq + 3*(s + t))) - 
     bb*(2*mm^4 + psq*(psq + s + t) + mm^2*(-7*psq + 3*(s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 + 3*psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(3*mm^2 + psq)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(3*mm^2 + psq)*(psq - s - t) + aa*(2*mm^4 + psq*(-3*psq + s + t) + 
     ...
     SP[p1, q2]])/(4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq*(3*psq - 2*s - 3*t) + mm^2*(psq - 2*s - t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (3*mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[p2, q1]])/(4^d*Pi^(2*d)) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*(mm^2 + psq - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*(3*mm^2 - psq - 2*t) + 
     2*aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
