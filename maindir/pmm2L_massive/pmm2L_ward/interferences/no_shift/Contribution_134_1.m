...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((I*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*s*
   ...
   (I*2^(1 - 2*d)*aa*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (I*4^(1 - d)*aa*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (I*4^(1 - d)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     (aa*(mm^2 - psq - s) + bb*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gFFA*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     (bb*(mm^2 - psq - s) + aa*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gFFA*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*(bb*(2*mm^2 - s - 2*t) + 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    ...
    Pi^(2*d) + (I*4^(1 - d)*bb*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*
     gHll*(gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
