...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
      (mm^2 - psq)^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s)) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
   ...
   (2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
     (4^(1 + d)*(-2 + d)*mm^4*Pi^(2*d)*s + (2*Pi)^(2*d)*psq*
       (4*psq^2 + 4*(-1 + d)*psq*s + (-4 + d)*s^2 - 8*psq*t + 4*s*t + 
        4*t^2) + mm^2*(2*Pi)^(2*d)*(4*psq^2 + (-4 + d)*s^2 + 4*s*t + 4*t^2 - 
        4*psq*((-3 + 2*d)*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(4*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 + psq)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 + psq)*
     (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*
     gXFW*gXll*mm^2*(2*mm^2 - psq)*(2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(2*mm^2 - psq)*
     ...
     gXFW*gXll*mm^2*(mm^2 + psq)*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - psq)*
     (2*psq + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*
     gXFW*gXll*mm^2*(-2*psq^2 + (-3 + d)*mm^2*s - psq*(s - 2*t))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
     ...
     gXFW*gXll*mm^2*(4*psq^2 + (-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(2*mm^2 - psq)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*
     gXFW*gXll*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(-psq + s + t)*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*
     gXFW*gXll*mm^2*(2*mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(3*mm^2 - psq - 2*t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(2*psq - 3*s - 2*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
     (2*psq - (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
     (2*psq + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*(2*psq + s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], SP[p3, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWlN*
   ...
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFll*gWlN*gXFW*gXll*mm^2*\[Mu]^(8 - 2*d)*
