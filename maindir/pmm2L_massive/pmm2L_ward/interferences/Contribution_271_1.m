...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (((-I)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 + psq)*s*
    sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gFZW*gWWA*gXFW*gXll*
    (gZlL - gZlR)*mm^2*s*(-(aa*s) + bb*(4*mm^2 - 4*psq + s))*sw*
  ...
  (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gFZW*gWWA*gXFW*gXll*
    (gZlL - gZlR)*mm^2*s*(-(bb*s) + aa*(4*mm^2 - 4*psq + s))*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (aa*(4*psq^2 - 3*psq*s + 4*mm^2*(psq - t) - 4*psq*t - s*t) + 
     bb*(-4*psq^2 + psq*s + 4*psq*t + s*t + mm^2*(-4*psq + 2*s + 4*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
  ...
  (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (-3*aa*s + bb*(8*mm^2 - 8*psq + 3*s))*sw*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (-3*bb*s + aa*(8*mm^2 - 8*psq + 3*s))*sw*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (-(aa*s) + bb*(4*mm^2 - 4*psq + s))*sw*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (aa*s - bb*(2*mm^2 - 2*psq + s))*sw*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   Pi^(2*d) - (I*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*s) + aa*(2*mm^2 - 2*psq + s))*sw*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*s) + aa*(4*mm^2 - 4*psq + s))*sw*\[Mu]^(8 - 2*d)*
