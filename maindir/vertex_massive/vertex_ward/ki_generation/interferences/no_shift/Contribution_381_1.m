...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
  ...
  (((-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(aa*(2*mm^2 + psq) - 
      bb*(mm^2 + 2*psq))*(4*psq - s)*s^2*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
   (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*s*
     (bb*mm^2*(10*psq - 3*s) + 2*bb*psq*(8*psq - s) + 
      2*aa*mm^2*(-8*psq + s) + aa*psq*(-10*psq + 3*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
     gWWZ*gZNL*(2*aa*mm^2 - 3*bb*mm^2 + 3*aa*psq - 2*bb*psq)*(2*psq - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (4*aa*mm^2 + bb*mm^2 - aa*psq - 4*bb*psq)*s^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
     gWWZ*gZNL*(2*aa*mm^2 - 3*bb*mm^2 + 3*aa*psq - 2*bb*psq)*s^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*s*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (-4*bb*psq^2 + aa*psq*(4*mm^2 + 3*psq - s) + bb*mm^2*(-3*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (aa*psq*(6*psq - 5*s) + aa*mm^2*(4*psq - 2*s) + 2*bb*psq*(-2*psq + s) + 
      bb*mm^2*(-6*psq + 5*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    Pi^(2*d) - (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (4*aa*mm^2 + 3*bb*mm^2 - 3*aa*psq - 4*bb*psq)*s*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(bb*mm^2 - aa*psq)*s*
   ...
   (4^(2 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (4^(2 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (4*aa*mm^2 - 5*bb*mm^2 + 5*aa*psq - 4*bb*psq)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
   ...
   (4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(mm^2 + psq)*
