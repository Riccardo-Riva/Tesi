...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*d*EL^6*gAl^3*gAu*mm^2*(-6*d*gZlL*gZlR*mm^2 + 
   ...
   (2^(3 - 2*d)*(-2 + d)*d*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*(s + t)*
   ...
   (2^(1 - 4*d)*(-2 + d)*EL^6*gAl^3*gAu*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*d*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*t^2*
   ...
   (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*mm^2*t*(4*(gZlL^2 + gZlR^2)*t + 
