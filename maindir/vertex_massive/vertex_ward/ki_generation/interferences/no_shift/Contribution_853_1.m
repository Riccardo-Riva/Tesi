...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*EL^5*gAl^5*ml^2*mm^2*s*
      (aa*((-2 + d)*mm^2 + 2*psq + 3*d*psq - d*s) + 
       bb*((-2 + d)*mm^2 + 2*psq - 5*d*psq + d*s))*\[Mu]^(8 - 2*d))/
     Pi^(2*d)) + (4^(2 - d)*EL^5*gAl^5*ml^2*(2*aa*psq*s - 
   ...
   (4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*ml^2*(mm^2 + psq)*s*
   ...
   (2^(3 - 2*d)*EL^5*gAl^5*mm^2*s*
     ...
     gAl^5*ml^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
