...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   (((-I)*(aa - bb)*EL^5*gFAW*gFFA^2*gFll*gWlN*mm^2*s*(-5*psq + s + 5*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2*Pi)^(2*d) - 
    (I*(aa - bb)*EL^5*gFAW*gFFA^2*gFll*gWlN*mm^2*s*(-5*psq + 4*s + 5*t)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFAW*gFFA^2*gFll*gWlN*mm^2*
     ...
     Pi^(2*d) + ((5*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gFAW*gFFA^2*gFll*gWlN*mm^2*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
    ((5*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gFAW*gFFA^2*gFll*gWlN*mm^2*
     ...
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFAW*gFFA^2*gFll*gWlN*mm^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*EL^5*gFAW*gFFA^2*gFll*gWlN*mm^2*\[Mu]^(8 - 2*d)*
