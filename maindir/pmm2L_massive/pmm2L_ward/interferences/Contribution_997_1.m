  ...
  (((-I)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(2*aa*mm^2*(psq - t) - 2*bb*mm^2*(psq + s - t) - 
   ...
   (I*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     (aa*(-2*psq^2 - 5*psq*s + 2*s^2 + 2*mm^2*(psq - t) + 2*psq*t + 7*s*t) - 
      bb*(-2*psq^2 - 11*psq*s + 2*s^2 + 2*mm^2*(psq + 3*s - t) + 2*psq*t + 
        7*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   ...
   (I*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    ...
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(aa*(6*psq - 5*s - 6*t) + 
   ...
   ((3*I)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    ...
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) - (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     ...
     SPList[SP[p1, p2], SP[q1, q2]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) - 
   ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
     sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
     sw*(aa*(psq - s - t) + bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     (aa*(5*psq - 6*s - 5*t) + bb*(6*mm^2 - 11*psq + 6*s + 5*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
     sw*(aa*(mm^2 + psq - s - 2*t) + bb*(mm^2 - 3*psq + s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(aa*(2*mm^2 - psq + 2*s - t) + 
      bb*(-psq - 2*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(aa*(4*mm^2 + psq - 5*t) + 
      bb*(2*mm^2 - 7*psq + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p3, q1]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) + 
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(aa*(3*psq - 4*s - 3*t) + 
      bb*(4*mm^2 - 7*psq + 4*s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/((mh^2 - mz^2)*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     (aa*(2*mm^2 + 3*psq - 5*(s + t)) + bb*(4*mm^2 - 9*psq + 5*(s + t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(aa*(2*mm^2 - psq + 2*s - t) + 
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*
     gHll*(gZlL + gZlR)*mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) - (I*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*
     mm^2*sw*(aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     SPList[SP[p2, p3], SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p3, q1]])/((mh^2 - mz^2)*(2*Pi)^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
   ...
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q2], SP[p1, q2]])/
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) - ((3*I)*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
   ...
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
    ...
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
      SP[p2, q2]])/(4^d*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q1], SP[p2, q2]])/
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
      SP[p2, q2]])/(4^d*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
   ...
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
    ...
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFZW*
     gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, p3]])/(4^d*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
      SP[p2, p3]])/(4^d*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, p3], SP[p2, q1]])/
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
      SP[p2, q2]])/(4^d*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/
  ...
  ((I*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     (aa*(psq^2 - psq*t - s*t) + bb*(-psq^2 + s*(2*mm^2 + t) + 
        psq*(-2*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*(aa*s*(5*psq - 2*s - 5*t) - 2*aa*mm^2*(psq - t) + 
      2*bb*mm^2*(psq + s - t) + bb*s*(-7*psq + 2*s + 5*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) - 
   (I*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     (aa*(-2*psq^2 - 5*psq*s + 2*s^2 + 2*mm^2*(psq - t) + 2*psq*t + 7*s*t) - 
      bb*(-2*psq^2 - 11*psq*s + 2*s^2 + 2*mm^2*(psq + 3*s - t) + 2*psq*t + 
   ...
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
    ...
    (4^d*(mh^2 - mz^2)*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*
     (gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
      SP[p2, q2]])/(4^d*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(4^d*(mh^2 - mz^2)*Pi^(2*d)))
