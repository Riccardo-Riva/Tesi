...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq^2 - 2*psq*t + t*(s + t))*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(4*(-3 + d)*psq^3 - 
      mm^2*(4*psq + (-4 + d)*s - 4*t)*(psq - s - t) + 2*(16 - 5*d)*psq^2*t + 
      (s + t)*((-2 + d)*s^2 + 2*(-2 + d)*s*t - 2*(-4 + d)*t^2) + 
      psq*(-3*(-2 + d)*s^2 - 4*s*t + 4*(-7 + 2*d)*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((-4 + d)*mm^4*s + 
      ...
      (2*psq - s - 2*t)*((-2 + d)*psq^2 + psq*(-((-4 + d)*s) - 
          2*(-2 + d)*t) + (s + t)*((-4 + d)*s + (-2 + d)*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-4*(-3 + d)*psq^3 + 
      ...
      psq^2*((-4 + d)*s + 2*(-16 + 5*d)*t) + 
      (-4 + d)*t*(s^2 + 3*s*t + 2*t^2) + mm^2*((26 - 6*d)*psq^2 + 
        (-18 + 5*d)*psq*s - (-4 + d)*s^2 + (-48 + 11*d)*psq*t + 
        (22 - 5*d)*s*t + (22 - 5*d)*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(-2*psq^2 - 2*psq*s + s^2 + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((16 - 7*d)*psq^3 + 
      psq*t*((24 - 11*d)*s + 5*(8 - 3*d)*t) + 
      2*t*(s + t)*((-2 + d)*s + 2*(-3 + d)*t) + 
      psq^2*((-8 + 3*d)*s + 2*(-22 + 9*d)*t) + 
      mm^2*((8 + d)*psq^2 + 2*psq*((-7 + d)*s - (8 + d)*t) - 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-4*(-2 + d)*psq^3 - 
      mm^2*s*((-6 + d)*s + (-8 + d)*t) + 
      psq^2*((-8 + 3*d)*s + 12*(-2 + d)*t) + 2*(-2 + d)*t*
       (s^2 + 3*s*t + 2*t^2) + psq*((-8 + d)*mm^2*s + 
        t*((20 - 9*d)*s - 12*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*psq*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((-10 + 3*d)*psq^2 + 
      2*(-4 + d)*mm^2*s - 8*s^2 + 2*d*s^2 - 14*s*t + 4*d*s*t - 10*t^2 + 
