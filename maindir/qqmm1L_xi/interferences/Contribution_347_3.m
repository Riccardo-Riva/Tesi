...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 - p2 + q1, 0]]*
  ((I*2^(1 - d)*EL^6*gAl*gAu*gZNL^2*
     (gZlL*gZuR*((-32 + 20*d - 3*d^2)*s^2 - 2*(10 - 7*d + d^2)*s*t + 4*t^2) + 
      gZlL*gZuL*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
      gZlR*gZuR*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
      gZlR*gZuL*((-4 + d)^2*s^2 - 2*(-2 - 3*d + d^2)*s*t + 4*t^2))*
     \[Mu]^(4 - d)*SPList[SP[p1, q1]])/(Pi^d*(mz^2 - s)^2*s) - 
   (I*2^(1 - d)*EL^6*gAl*gAu*gZNL^2*
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*gZNL^2*((-4 + d)*gZlL*gZuL - 
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*gZNL^2*(d*gZlR*(gZuL - gZuR)*s + 
