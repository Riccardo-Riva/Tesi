...
{0, (I*2^(-3 - 2*d)*EL^6*gAl*gAu*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(2^(1 + d)*(-4 + 9*d - 4*d^2 + d^3)*Pi^d - 
      ...
      (gZuL*gZuLC*(2^(1 + d)*(4 + 6*d - 4*d^2 + d^3)*Pi^d - d^3*(2*Pi)^d) + 
       gZuR*gZuRC*(-(2^(1 + d)*(-4 + 9*d - 4*d^2 + d^3)*Pi^d) + 
         d^3*(2*Pi)^d)))*(1 + (2*s)/t)*t)/(Pi^(2*d)*(mzC^2 - s)) + 
  (I*2^(-3 - d)*EL^6*gAl*gAu*
    (gZlR*gZlRC*(-((-8 + 18*d - 8*d^2 + d^3)*gZuL*gZuLC) + 
     ...
     gZlL*gZlLC*((8 + 12*d - 8*d^2 + d^3)*gZuL*gZuLC - 
       (-8 + 18*d - 8*d^2 + d^3)*gZuR*gZuRC))*(2*(-3 + d)*mz^2 - 2*s + 
     (-4 + d)*t))/((-4 + d)*Pi^d*(mzC^2 - s)) + 
  (I*2^(-1 - 2*d)*(-3 + d)*EL^6*gAl*gAu*
    (gZlL*gZlLC*(-(gZuR*gZuRC*(mz^2*(2^(1 + d)*(4 - 9*d + 4*d^2)*Pi^d - 
      ...
      (-(gZuL*gZuLC*(mz^2*(2^(1 + d)*(4 - 9*d + 4*d^2)*Pi^d - d^3*(2*Pi)^d) + 
        ...
        (mz^2*(2^(2 + d)*(-2 - 3*d + 2*d^2)*Pi^d - d^3*(2*Pi)^d) + 
         d^3*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((8 + 2*d - 3*d^2)*s + 
           2*(10 - 6*d + d^2)*t)))))/((-4 + d)*Pi^(2*d)*(mzC^2 - s)) - 
 ...
 ((-I)*2^(-2 - 2*d)*EL^6*gAl*gAu*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(2^(1 + d)*(-4 + 9*d - 4*d^2 + d^3)*Pi^d - 
      ...
      (gZuL*gZuLC*(2^(1 + d)*(4 + 6*d - 4*d^2 + d^3)*Pi^d - d^3*(2*Pi)^d) + 
       gZuR*gZuRC*(-(2^(1 + d)*(-4 + 9*d - 4*d^2 + d^3)*Pi^d) + 
         d^3*(2*Pi)^d)))*s)/(mz^2*Pi^(2*d)*(mzC^2 - s)) + 
  (I*2^(-1 - d)*EL^6*gAl*gAu*
    (gZlR*gZlRC*((-56 + 46*d - 12*d^2 + d^3)*gZuL*gZuLC - 
     ...
     gZlL*gZlLC*(-((-52 + 44*d - 12*d^2 + d^3)*gZuL*gZuLC) + 
       (-56 + 46*d - 12*d^2 + d^3)*gZuR*gZuRC))*t)/
   ((-4 + d)*mz^2*Pi^d*(mzC^2 - s)) + 
  (I*2^(1 - 2*(1 + d))*EL^6*gAl*gAu*
    (gZlL*gZlLC*(gZuL*gZuLC*(2^(2 + d)*(13 - 11*d + 3*d^2)*Pi^d - 
      ...
      (gZuL*gZuLC*(2^(1 + d)*(28 - 23*d + 6*d^2)*Pi^d - d^3*(2*Pi)^d) + 
       gZuR*gZuRC*(2^(2 + d)*(-13 + 11*d - 3*d^2)*Pi^d + d^3*(2*Pi)^d)))*t)/
   ((-4 + d)*mz^2*Pi^(2*d)*(mzC^2 - s)) - 
  (I*2^(-2 - 2*d)*EL^6*gAl*gAu*
    (gZlL*gZlLC*(gZuL*gZuLC*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
     ...
     gZlR*gZlRC*(gZuR*gZuRC*(d^3*(2*Pi)^d*s - 2^(1 + d)*Pi^d*
       ...
       gZuL*gZuLC*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((4 - 9*d + 4*d^2)*s + 
           (-56 + 46*d - 12*d^2 + d^3)*t)))))/(mz^2*Pi^(2*d)*(mzC^2 - s)) - 
  (I*2^(-3 - 2*d)*(2 - d)*EL^6*gAl*gAu*
     ...
     gZlL*gZlLC*(gZuL*gZuLC*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
       ...
       gZuR*gZuRC*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
          ((-4 + 9*d - 4*d^2)*s^2 - (-72 + 50*d - 12*d^2 + d^3)*s*t + 
           8*t^2) + mz^2*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            ((4 - 9*d + 4*d^2)*s + (-56 + 46*d - 12*d^2 + d^3)*t))))))/
   ((-4 + d)*mz^2*Pi^(2*d)*(mz^2 - s)*(mzC^2 - s)) + 
  (I*2^(-3 - 2*d)*(2 - d)*EL^6*gAl*gAu*
    (gZlR*gZlRC*(gZuR*gZuRC*(-(d^3*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
          ((-4 - 6*d + 4*d^2)*s^2 + (-60 + 48*d - 12*d^2 + d^3)*s*t + 
           8*t^2) + mz^2*(d^3*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
       ...
       gZuR*gZuRC*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
          ((-4 + 9*d - 4*d^2)*s^2 - (-72 + 50*d - 12*d^2 + d^3)*s*t + 
           8*t^2) + mz^2*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            ((4 - 9*d + 4*d^2)*s + (-56 + 46*d - 12*d^2 + d^3)*t))))))/
   ((-4 + d)*mz^2*Pi^(2*d)*(mz^2 - s)*(mzC^2 - s)) - 
  (I*2^(-3 - d)*d*EL^6*gAl*gAu*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*s*(-1 + GaugeXi[Q]))/(mz^2*Pi^d*(mzC^2 - s)) + 
  (I*2^(-3 - 2*d)*EL^6*gAl*gAu*t*
    (gZlL*gZlLC*(gZuL*gZuLC*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d) + 
     ...
     2^(1 + d)*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
      ...
      GaugeXi[Q] + (gZlL*gZlLC*(gZuL*gZuLC*(2^(1 + d)*(-1 + d)*Pi^d - 
           ...
           d*(2*Pi)^d)))*GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*
    (-1 + GaugeXi[Q])) - (I*2^(-4 - 2*d)*EL^6*gAl*gAu*
    (gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s - 
       ...
       3*d*gZuR*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuL*gZuLC*Pi^d*
        ((2 + d)*s - t) - 2^(1 + d)*gZuR*gZuRC*Pi^d*(s + d*s + t)) + 
      ...
      GaugeXi[Q] + (gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
       ...
       gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s + 
         2^(1 + d)*gZuL*gZuLC*Pi^d*((2 + d)*s - t) - 2^(1 + d)*gZuR*gZuRC*
          Pi^d*(s + d*s + t)))*GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*
    (-1 + GaugeXi[Q])) - (I*2^(-4 - 2*d)*EL^6*gAl*gAu*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) + 
  (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*(mz^2 - s)*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(2*mz^2 - 2*s)*(-mzC^2 + s)*
    (-1 + GaugeXi[Q])) + (I*4^(-2 - d)*EL^6*gAl*gAu*(d*s + 2*t)*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*s*(-1 + GaugeXi[Q])) + 
  (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*
    (gZlR*gZlRC*(gZuR*gZuRC*(mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            ...
            ((-2 + d)*s + t)))) + gZlL*gZlLC*
      (gZuL*gZuLC*(mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-1 + d)*s - t)) + 
     ...
     (gZlR*gZlRC*(gZuR*gZuRC*(mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
        ...
        (gZuL*gZuLC*(mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-1 + d)*s - 
         ...
         gZuR*gZuRC*(s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
           mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-2 + d)*s + t)))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(2*mz^2 - 2*s)*(mzC^2 - s)*
    (-1 + GaugeXi[Q])) + ((I/8)*(-2 + d)*EL^6*gAl*gAu*
    (((gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
     ...
     (s*t*(gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*
        ...
        2^(1 + d)*Pi^d*(gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + 
           ...
           (gZuL*gZuLC*(-((-4 + d)*s) + 2*t) + gZuR*gZuRC*((-2 + d)*s + 
              2*t)))*GaugeXi[Q] + (gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
            3*d*gZuR*gZuRC*(2*Pi)^d*s - 2^(1 + d)*gZuR*gZuRC*Pi^d*
     ...
     (2^(1 - 2*d)*s*t*(gZlL*gZlLC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
        ...
        2^(1 + d)*Pi^d*(gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) + 4*t) + 
           ...
           (gZuL*gZuLC*(-((-4 + d)*s) + 4*t) + gZuR*gZuRC*((-2 + d)*s + 
              4*t)))*GaugeXi[Q] + 
        (gZlL*gZlLC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
                2*t)) + gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(2 + d)*Pi^d*(s + t))) - 
          gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(s - 2*t)) + 
            gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(2 + d)*Pi^d*(s + t))))*
         GaugeXi[Q]^2))/(mz^2*Pi^(2*d))))/((mz^2 - s)^2*(mzC^2 - s)*
    (-1 + GaugeXi[Q])), 
 (I*2^(-2 - d)*EL^6*gAl*gAu*
    (gZlR*gZlRC*((-56 + 46*d - 12*d^2 + d^3)*gZuL*gZuLC - 
       (-52 + 44*d - 12*d^2 + d^3)*gZuR*gZuRC) + 
     gZlL*gZlLC*(-((-52 + 44*d - 12*d^2 + d^3)*gZuL*gZuLC) + 
       (-56 + 46*d - 12*d^2 + d^3)*gZuR*gZuRC))*s*(1 - (2*t)/((-4 + d)*s)))/
   (Pi^d*(mzC^2 - s)) + 
  (I*EL^6*gAl*gAu*
    (gZlL*gZlLC*(gZuL*gZuLC*(2^(2 + d)*(13 - 11*d + 3*d^2)*Pi^d - 
         d^3*(2*Pi)^d) + gZuR*gZuRC*(2^(1 + d)*(-28 + 23*d - 6*d^2)*Pi^d + 
    ...
    (1 - (2*t)/((-4 + d)*s)))/(2^(2*(1 + d))*Pi^(2*d)*(mzC^2 - s)) - 
  (I*4^(-1 - d)*EL^6*gAl*gAu*
    (gZlR*gZlRC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
      ...
      (gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
         ...
         mz^2*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((52 - 37*d + 8*d^2)*s - 
             (-56 + 46*d - 12*d^2 + d^3)*t))))))/
   (mz^2*Pi^(2*d)*(mzC^2 - s)) - (I*2^(-2 - 2*d)*(-3 + d)*EL^6*gAl*gAu*
    (-(gZlR*gZlRC*(gZuR*gZuRC*(-(d^3*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
           ((-4 - 6*d + 4*d^2)*s^2 + (-60 + 48*d - 12*d^2 + d^3)*s*t + 
            8*t^2) + mz^2*(d^3*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
             ((4 + 6*d - 4*d^2)*s - (-52 + 44*d - 12*d^2 + d^3)*t))) + 
     ...
     gZlL*gZlLC*(gZuL*gZuLC*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
       ...
       gZuR*gZuRC*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
          ((-4 + 9*d - 4*d^2)*s^2 - (-72 + 50*d - 12*d^2 + d^3)*s*t + 
           8*t^2) + mz^2*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            ((4 - 9*d + 4*d^2)*s + (-56 + 46*d - 12*d^2 + d^3)*t))))))/
   ((-4 + d)*Pi^(2*d)*(mz^2 - s)*(mzC^2 - s)) + 
  (I*2^(-2 - 2*d)*(-3 + d)*EL^6*gAl*gAu*
    (gZlR*gZlRC*(gZuR*gZuRC*(-(d^3*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
          ((-4 - 6*d + 4*d^2)*s^2 + (-60 + 48*d - 12*d^2 + d^3)*s*t + 
           8*t^2) + mz^2*(d^3*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            ((4 + 6*d - 4*d^2)*s - (-52 + 44*d - 12*d^2 + d^3)*t))) + 
  ...
  (I*2^(-3 - d)*EL^6*gAl*gAu*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*s*(-((-4 + d)*mz^2) - d*s)*(-1 + GaugeXi[Q]))/
     ...
     2^(1 + d)*Pi^d*(gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      ...
      GaugeXi[Q] + (gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
       ...
       gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s + 
         2^(1 + d)*gZuL*gZuLC*Pi^d*((2 + d)*s - t) - 2^(1 + d)*gZuR*gZuRC*
          Pi^d*(s + d*s + t)))*GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*
    (-1 + GaugeXi[Q])) - (I*2^(-4 - 2*d)*EL^6*gAl*gAu*(mz^2 - s)*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) + 
  (I*2^(-3 - 2*d)*EL^6*gAl*gAu*(mz^2 - s)*((4 - d)*mz^2 + (2 - d)*s)*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(2*mz^2 - 2*s)*(-mzC^2 + s)*
    (-1 + GaugeXi[Q])) - (I*4^(-2 - d)*EL^6*gAl*gAu*
    ...
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*s*(-1 + GaugeXi[Q])) + 
  (I*2^(-3 - 2*d)*EL^6*gAl*gAu*((4 - d)*mz^2 + (2 - d)*s)*
    (gZlR*gZlRC*(gZuR*gZuRC*(mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            ((-1 + d)*s - t)) + s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            (s + t))) - gZuL*gZuLC*(s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            (2*s - t)) + mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
     ...
     (gZlR*gZlRC*(gZuR*gZuRC*(mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
        ...
        (gZuL*gZuLC*(mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-1 + d)*s - 
         ...
         gZuR*gZuRC*(s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
           mz^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-2 + d)*s + t)))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(2*mz^2 - 2*s)*(mzC^2 - s)*
    (-1 + GaugeXi[Q])) - ((I/8)*(-3 + d)*EL^6*gAl*gAu*(mz^2 + s)*
    (((gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
        gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + (-2 + d)*gZuR*gZuRC))*mz^2*t*
       (-1 + GaugeXi[Q])^2)/(2*Pi)^d - (2^(2 - d)*(gZlL*gZlLC + gZlR*gZlRC)*
       (gZuL*gZuLC + gZuR*gZuRC)*t^2*(-1 + GaugeXi[Q])^2)/Pi^d - 
 ...
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(2^(1 + d)*(-4 + 9*d - 4*d^2 + d^3)*Pi^d - 
      ...
      (gZuL*gZuLC*(2^(1 + d)*(4 + 6*d - 4*d^2 + d^3)*Pi^d - d^3*(2*Pi)^d) + 
       gZuR*gZuRC*(-(2^(1 + d)*(-4 + 9*d - 4*d^2 + d^3)*Pi^d) + 
         d^3*(2*Pi)^d)))*t*(s + (mz^2*(2*s + t))/t))/(Pi^(2*d)*(mzC^2 - s)) + 
  (I*4^(-1 - d)*EL^6*gAl*gAu*
     ...
     gZlL*gZlLC*(gZuL*gZuLC*(d^3*(2*Pi)^d*s*t - 2^(1 + d)*Pi^d*t*
       ...
       gZuR*gZuRC*(t*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
         ...
         mz^2*(d^3*(2*Pi)^d*(s - t) + 2^(1 + d)*Pi^d*((-4 + 9*d - 4*d^2)*s + 
             (52 - 37*d + 8*d^2)*t))))))/(Pi^(2*d)*(mzC^2 - s)), 
 ((-I)*2^(-3 - 2*d)*EL^6*gAl*gAu*t*
 ...
 (I*2^(-3 - d)*d*EL^6*gAl*gAu*(gZlL*gZlLC + gZlR*gZlRC)*
    ...
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) - 
  (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*(s - mz^2*GaugeXi[Q])*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])*
    (-2*s + 2*mz^2*GaugeXi[Q])) - (I*4^(-2 - d)*EL^6*gAl*gAu*(d*s + 2*t)*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(2*s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))) + 
  ...
  (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*t*
   ...
   (mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])*(s - mz^2*GaugeXi[Q])) - 
  (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*
   ...
   (mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])*(-2*s + 2*mz^2*GaugeXi[Q])), 
 (I*EL^6*gAl*gAu*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
     ...
     gZlR*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
       ...
       gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
           (8 - 5*d + d^2)*s*t + 2*t^2)))))/(2^(2*(1 + d))*mz^2*Pi^(2*d)*
    (mzC^2 - s)) + (I*2^(-3 - d)*EL^6*gAl*gAu*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*s*(-1 + GaugeXi[Q])*
    (-(d*s) - (-4 + d)*mz^2*GaugeXi[Q]))/(mz^2*Pi^d*(mzC^2 - s)) + 
  (I*2^(-4 - 2*d)*EL^6*gAl*gAu*(-s + mz^2*GaugeXi[Q])*
    (gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s - 
       2^(1 + d)*gZuR*gZuRC*Pi^d*((2 + d)*s - t) + 2^(1 + d)*gZuL*gZuLC*Pi^d*
        (s + d*s + t)) - gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
       3*d*gZuR*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuL*gZuLC*Pi^d*
     ...
     2^(1 + d)*Pi^d*(gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      ...
      GaugeXi[Q] + (gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
       ...
       gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s + 
         2^(1 + d)*gZuL*gZuLC*Pi^d*((2 + d)*s - t) - 2^(1 + d)*gZuR*gZuRC*
          Pi^d*(s + d*s + t)))*GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*
    (-1 + GaugeXi[Q])) + (I*2^(-4 - 2*d)*EL^6*gAl*gAu*(-s + mz^2*GaugeXi[Q])*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) - 
  (I*2^(-4 - 2*d)*EL^6*gAl*gAu*((-2 + d)*s + (-4 + d)*mz^2*GaugeXi[Q])*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) + 
  (I*4^(-2 - d)*EL^6*gAl*gAu*(s*(d*s + 2*t) + mz^2*((-4 + d)*s + 2*t)*
      GaugeXi[Q])*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(2*s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*s*(-1 + GaugeXi[Q])) + 
  (I*2^(-3 - 2*d)*(-3 + d)*EL^6*gAl*gAu*t*(s + mz^2*GaugeXi[Q])*
    ((gZlL*gZlLC*(gZuL*gZuLC*(2^(1 + d)*(-1 + d)*Pi^d - d*(2*Pi)^d) + 
         gZuR*gZuRC*(-(2^(1 + d)*(-2 + d)*Pi^d) + d*(2*Pi)^d)) - 
       gZlR*gZlRC*(gZuL*gZuLC*(2^(1 + d)*(-2 + d)*Pi^d - d*(2*Pi)^d) + 
         gZuR*gZuRC*(-(2^(1 + d)*(-1 + d)*Pi^d) + d*(2*Pi)^d)))*s + 
  ...
  (I*4^(-1 - d)*EL^6*gAl*gAu*
    ((-(gZlR*gZlRC*(gZuL*gZuLC*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
     ...
     mz^2*(-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*(s + t)) + 
      ...
      GaugeXi[Q]^3))/(mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])), 0, 0, 0, 
