...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((4^(2 - d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
     ...
     (2*psq^2 + (-2 + d)*mm^2*s - 2*s^2 + d*s^2 + psq*(s - d*s - 4*t) + 
      3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(-psq + s + t)*
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
     (-8*s + d*(2*mm^2 - 3*psq + 3*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
     (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
     (-4*s + d*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*
     ...
     gFAW*gFll*gWlN*gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(2*psq + s - 2*t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*
