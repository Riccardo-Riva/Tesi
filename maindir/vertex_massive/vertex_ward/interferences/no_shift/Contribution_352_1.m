...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
  ...
  (((aa + bb)*EL^5*gFFA*gFFZ*gFll^2*gZNL*mm^2*(mm^2 - psq)*psq*s^2*
     ...
     mm^2*s*(3*aa*mm^2*psq - 3*bb*psq^2 + bb*mm^2*s - aa*psq*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZNL*mm^2*psq*
     (aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZNL*
     mm^2*(-(bb*(psq^2 + mm^2*(psq - s))) + aa*psq*(mm^2 + psq - s))*s*
   ...
   (EL^5*gFFA*gFFZ*gFll^2*gZNL*mm^2*s*(2*aa*psq^2 + aa*mm^2*(2*psq - s) + 
      bb*psq*(-2*mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    (2*Pi)^(2*d) + (4^(1 - d)*EL^5*gFFA*gFFZ*gFll^2*gZNL*mm^2*
     (-2*bb*psq^2 + aa*psq*(2*mm^2 + psq - s) + bb*mm^2*(-psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gFFA*gFFZ*gFll^2*gZNL*mm^2*(aa*psq*(2*mm^2 + psq + s) - 
      bb*(2*psq^2 + mm^2*(psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gFFA*gFFZ*gFll^2*gZNL*mm^2*(bb*(psq^2 + mm^2*(psq - s)) - 
   ...
   (4^(1 - d)*EL^5*gFFA*gFFZ*gFll^2*gZNL*mm^2*(-2*bb*psq^2 + 
      aa*psq*(2*mm^2 + 2*psq - s) + bb*mm^2*(-2*psq + s))*\[Mu]^(8 - 2*d)*
