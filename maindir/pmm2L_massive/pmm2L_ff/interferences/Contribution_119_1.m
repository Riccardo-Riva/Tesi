   ...
   (-((4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*(-6 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
     ...
     Pi^(2*d) + (2^(3 - 2*d)*(-6 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
      ...
      gXll^2*mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*
      mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
     Pi^(2*d) - (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
