...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
   ...
   ((4^(1 - d)*(-5 + 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
    ...
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (-2*(-1 + d)*gZlR*mm^2*(2*psq^3 - 3*psq^2*(s + 2*t) - 
       ...
       gZlL*(-2*(-1 + d)*psq^4 + 2*s*t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
         psq^3*((13 - 4*d)*s + 6*(-1 + d)*t) + psq^2*((-7 + 2*d)*s^2 + 
           2*(-15 + 4*d)*s*t - 6*(-1 + d)*t^2) + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
     ...
     Pi^(2*d) - (3*4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (-psq + s + t)*(-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (2*(-1 + d)*gZlR*mm^2*(psq^2 - 3*psq*s + 2*s^2 - 2*psq*t + 3*s*t + 
         t^2) + gZlL*mm^2*(4*(-5 + 2*d)*psq^2 + 
         psq*((14 - 5*d)*s + 4*(8 - 3*d)*t) - (s + t)*((2 + d)*s - 
           4*(-3 + d)*t)) - 2*gZlL*(2*(-7 + 2*d)*psq^3 + 
         psq^2*((23 - 6*d)*s + (30 - 7*d)*t) - (s + t)*((-6 + d)*s^2 + 
           2*(-4 + d)*s*t + (-6 + d)*t^2) + psq*((-23 + 4*d)*s^2 + 
           (-37 + 8*d)*s*t + 2*(-11 + 2*d)*t^2)))*\[Mu]^(8 - 2*d)*
    ...
    (3*4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (4*(-1 + d)*psq^2 + (8 - 6*d)*psq*s - 8*(-1 + d)*psq*t - 
    ...
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (-2*(-1 + d)*gZlR*mm^2*(2*psq^2 - 2*s^2 + psq*(s - 4*t) - s*t + 
         2*t^2) + gZlL*(-2*(-2 + d)*psq^3 - 4*psq^2*(s - (-2 + d)*t) + 
    ...
    (4^(2 - d)*(-1 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (2*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t)*(psq - t) + 
       gZlL*(-2*(-6 + d)*psq^3 + (14 - 5*d)*mm^2*psq*s + 
         (-28 + 6*d)*psq^2*s + 6*(-6 + d)*psq^2*t + (-14 + 5*d)*mm^2*s*t - 
         3*(-6 + d)*psq*t*(3*s + 2*t) + t*(s + t)*((-14 + d)*s + 
           2*(-6 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      ((-2 + d)*psq^3 + (-2 + d)*mm^2*(psq - t)^2 + s*t*(s + t) + 
       psq^2*(-((-3 + d)*s) - 2*(-2 + d)*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*((14 - 9*d)*psq^2 + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (2*(-1 + d)*gZlR*mm^2*(psq - s - t) + gZlL*mm^2*(4*(-4 + d)*psq + 
         (2 + d)*s - 4*(-4 + d)*t) - 2*gZlL*((-22 + 5*d)*psq^2 + 
         (-6 + d)*(s + t)^2 + psq*(-3*(-6 + d)*s + 28*t - 6*d*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/
     (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      (4*psq^2 + s^2 + 3*s*t + 2*t^2 - 3*psq*(s + 2*t) + 
       mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*((-6 + 5*d)*psq^2 - 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*(2*(-1 + d)*gZlR*mm^2*s + 
       gZlL*(3*(-6 + d)*psq^2 + (-10 + 3*d)*mm^2*s - 16*(-4 + d)*psq*s - 
         ...
         3*d*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[p3, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*
      gWWA*gWWZ*gZlL*(psq^2 + s^2 - 2*psq*t + t^2)*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*(2*(-1 + d)*gZlR*mm^2*s + 
       ...
       SP[p3, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*
      gWWA*gWWZ*gZlL*(-psq^2 - 3*psq*s + 2*s^2 + mm^2*(2*psq + s - 2*t) + 
       2*s*t + t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - t)*
      ...
      gWWA*gWWZ*gZlL*(mm^2 - 3*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      ...
      gWWZ*gZlL*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      gZlL*(psq - t)*((-2 + 3*d)*psq + (-6 + d)*s + (2 - 3*d)*t)*
