...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, 0], 
  ...
  ((EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*s^2 + 4*s*t + 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*s^2 + 4*s*t + 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*s^2 + 4*s*t + 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*s^2 + 4*s*t + 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*s^2 + 4*s*t + 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*s^2 + 4*s*t + 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-6 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    (mz^2*Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(mz^2*Pi^(2*d)) - 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    (mz^2*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(d*s^2 + 4*t*(2*s + t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*((-4 + d)*s^2 + 4*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-9 + 2*d)*s^2 + 4*s*t + 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*(-7 + d)*EL^8*gAl^3*gAu^2*ggmgmA*
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
    (mz^2*Pi^(2*d)) + (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     ...
     SPList[SP[p1, p3], SP[p1, q1]])/(mz^2*Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
    (mz^2*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*((-6 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q1]])/(mz^2*Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-4 + d)*s^2 - 3*s*t - 
      2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q2, q2]])/
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(d*s + 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(mz^2*Pi^(2*d)*s) + 
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(d*s + 4*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)*s) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, p3]])/(mz^2*Pi^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-16 + 3*d)*s - 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-6 + d)*s - 4*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(d*s + 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/(mz^2*Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-4 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (mz^2*Pi^(2*d)*s) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(-((-12 + d)*s) + 10*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-7 + d)*s^2 - 5*s*t - 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s^2 - 3*s*t - 2*t^2)*
   ...
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     ...
     SPList[SP[p2, p3], SP[p2, q1]])/(mz^2*Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-3 + d)*s^2 - s*t - 2*t^2)*
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-10 + 3*d)*s + 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (2*(-4 + d)*s^2 - s*t - 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(d*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q2]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (mz^2*(2*Pi)^(2*d)*s) + (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, p3]])/(mz^2*Pi^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*s + 10*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-4 + d)*s^2 + s*t - 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*s^2 - s*t - 2*t^2)*
   ...
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, p3], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*(-5 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*(-6 + d)*s^2 - 4*s*t - 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
    (mz^2*Pi^(2*d)) + (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(3*(-2 + d)*s^2 - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-8 + d)*s^2 - 4*s*t - 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (-s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-4 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-4 + d)*s^2 - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-6 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/
    (mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-6 + d)*s - 6*t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-8 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/
    (mz^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*((-11 + 2*d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 2*t)*
    ...
    (mz^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
      SP[p1, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(d*s + 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, p3]])/
    (mz^2*Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 2*t)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-9 + d)*s - 4*t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-4 + d)*s - 2*t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-4 + d)*s - 2*t)*
    ...
    (mz^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-9 + 2*d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 2*t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 2*t)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-5 + d)*s + 4*t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 2*t)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*ggmgmA*
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
   (2^(1 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], SP[p3, q2]])/
    (mz^2*Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
   (4^(1 - d)*(-11 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/
    (mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - 
   (2^(1 - 2*d)*(-7 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/
    (mz^2*Pi^(2*d)*s) - (4^(1 - d)*(-7 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
   ...
   (2^(1 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s) - (3*2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
   (3*4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) - (3*2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p1, q1]])/
    (mz^2*Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
      SP[p1, q2]])/(mz^2*Pi^(2*d)*s) - 
   (4^(1 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p2, q1]])/
    (mz^2*Pi^(2*d)*s) - (4^(1 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
      SP[p2, q2]])/(mz^2*Pi^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, p3]])/
    (4^d*mz^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*((-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((6 + d)*s + 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[q2, q2]])/
    (mz^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
      SP[p1, q2]])/(mz^2*Pi^(2*d)*s) - 
   (4^(1 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*s + 2*t)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(5*s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
   (3*4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
      SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) - 
   (7*2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], SP[q1, q1]])/
    (mz^2*Pi^(2*d)*s) - (7*4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-10 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
      SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) - 
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-10 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2], SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 3*t)*
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*s + 2*t)*
    ...
    (4^d*mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], 
      SP[p3, q2]])/(4^d*mz^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[p3, q1]])/
    (mz^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*((-14 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p3, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-18 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
      SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(7*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], SP[q1, q1]])/
    (mz^2*Pi^(2*d)*s^2) + (3*4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-4 + d)*s - 2*t)*
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (4^(1 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, p3], SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, p3], SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(d*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, p3], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, p3]])/(mz^2*Pi^(2*d)*s) + 
   (4^(1 - d)*(-3 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
    ...
    (mz^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-8 + d)*s - 2*t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-4 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q2, q2]])/
    (mz^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*
     ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, p3]])/(mz^2*Pi^(2*d)*s) - 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (4^(1 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
      SP[p2, q1]])/(mz^2*Pi^(2*d)*s) - 
   (4^(1 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, p3], SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[q1, q1]])/
    (mz^2*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(2*s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-4 + d)*s - 2*t)*
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*((4 + d)*s + 6*t)*
   ...
   (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(d*s - 6*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, q1], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) - 
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], SP[p2, q2]])/
    (mz^2*Pi^(2*d)*s) + (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
      SP[p3, p3]])/(4^d*mz^2*Pi^(2*d)*s^2) - 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-6 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s - 2*t)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (3*4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s - t)*
    ...
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-12 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], 
      SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-6 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(5*s - 2*t)*
