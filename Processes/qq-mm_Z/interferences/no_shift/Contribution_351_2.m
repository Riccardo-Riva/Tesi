(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 - p2 + q1, 0]]*
  ((I*2^(1 - 2*d)*EL^6*(gZlL*gZlLC*(-3*gZuL^2*gZuR*gZuRC*
         (d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((16 - 10*d + d^2)*s^2 + 
            (10 - 7*d + d^2)*s*t - 2*t^2)) - 3*gZuR^3*gZuRC*
         (-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(4*(-2 + d)*s^2 + 
            (-2 - 3*d + d^2)*s*t - 2*t^2)) + gZuL*gZuLC*gZuR^2*
         (d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((6 - 6*d + d^2)*s^2 + 
            3*(8 - 5*d + d^2)*s*t + 6*t^2)) + gZuL^3*gZuLC*
         (-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*(3 - 3*d + d^2)*s^2 + 
     ...
     SPList[SP[p1, q1]])/(Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) + 
   (I*2^(1 - 2*d)*EL^6*
   ...
   ((3*I)*2^(4 - d)*EL^6*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL^2 + gZuR^2)*
