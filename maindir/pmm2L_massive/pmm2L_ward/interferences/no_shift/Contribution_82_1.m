...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((I*2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
    ...
    Pi^(2*d) - (I*4^(2 - d)*(aa - bb)*(-4 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
    Pi^(2*d) + (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (bb*(-6 + d)*(psq - s - t) + aa*(-2*(-2 + d)*mm^2 + (2 + d)*psq + 
        (-6 + d)*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
     gWWZ*gZNL*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*(-4 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*psq*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(bb*(-6 + d)*(psq - s - t) + 
   ...
   (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(bb*(-10 + 3*d)*(psq - s - t) + 
   ...
   (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(aa*(-6 + d)*(psq - t) + 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     ...
     (aa*(-6 + d)*(psq - t) + bb*(2*(-2 + d)*mm^2 + (10 - 3*d)*psq + 
      ...
      SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
     gWWZ*gZNL*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2], SP[q2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(-(aa*(-10 + 3*d)*(psq - t)) + 
