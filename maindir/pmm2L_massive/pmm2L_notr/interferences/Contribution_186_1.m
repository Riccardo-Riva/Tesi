...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 ((EL^8*gAl^4*gAu^2*(-((-2 + d)*(gZlL^2 + gZlR^2)*s*
     ...
     mm^2*(4^(1 + d)*(8 - 6*d + d^2)*gZlL*gZlR*Pi^(2*d)*s^2*
        (mm^2 - 3*psq + s) + (-2 + d)*gZlL^2*
   ...
   ((2*Pi)^(4*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*
    (8*d*gZlL*gZlR*mm^2*(mm^2 + psq - s)*s + 
     gZlL^2*((-2 + d)^3*mm^4*s - 2*(-2 + d)*mm^2*(4*psq^2 - (-2 + d)*s^2 + 
         psq*((-2 + d)^2*s - 8*t) + 4*s*t + 4*t^2) + 
       s*((-16 + 16*d - 6*d^2 + d^3)*psq^2 + (22 - 13*d + 2*d^2)*s^2 + 
         4*(-2 + d)*s*t + 4*(-2 + d)*t^2 - 2*psq*((26 - 17*d + 3*d^2)*s + 
           4*(-2 + d)*t))) + gZlR^2*((-2 + d)^3*mm^4*s - 
       2*(-2 + d)*mm^2*(4*psq^2 - (-2 + d)*s^2 + psq*((-2 + d)^2*s - 8*t) + 
         4*s*t + 4*t^2) + s*((-16 + 16*d - 6*d^2 + d^3)*psq^2 + 
         (22 - 13*d + 2*d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2 - 
         2*psq*((26 - 17*d + 3*d^2)*s + 4*(-2 + d)*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(-18*(gZlL^2 + gZlR^2)*(2*psq - s)*s - 
     d^2*(gZlL^2 + gZlR^2)*(2*psq - s)*s + 
     d*(8*gZlL*gZlR*mm^2*(mm^2 + psq - s) + 9*gZlL^2*(2*psq - s)*s + 
       9*gZlR^2*(2*psq - s)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (Pi^(2*d)*s) + (EL^8*gAl^4*gAu^2*
    (-4*gZlL*gZlR*mm^2*s*(-8*psq + d^2*(2*mm^2 - 2*psq - s) + 8*t - 
       2*d*(2*mm^2 - 3*psq - 3*s + t)) + 
     gZlL^2*(-((-2 + d)*mm^4*(-8*psq + (12 - 4*d + d^2)*s + 8*t)) + 
       mm^2*s*((16 - 6*d^2 + d^3)*psq + (60 - 32*d + 5*d^2)*s + 
         12*(-2 + d)*t) + s*(8*(-6 + d)*psq^2 + (-172 + 92*d - 11*d^2)*psq*
          s + (60 - 34*d + 4*d^2)*s^2 - 16*(-6 + d)*psq*t + 4*(-10 + d)*s*t + 
         8*(-6 + d)*t^2)) + 
     gZlR^2*(-((-2 + d)*mm^4*(-8*psq + (12 - 4*d + d^2)*s + 8*t)) + 
       mm^2*s*((16 - 6*d^2 + d^3)*psq + (60 - 32*d + 5*d^2)*s + 
         12*(-2 + d)*t) + s*(8*(-6 + d)*psq^2 + (-172 + 92*d - 11*d^2)*psq*
          s + (60 - 34*d + 4*d^2)*s^2 - 16*(-6 + d)*psq*t + 4*(-10 + d)*s*t + 
         8*(-6 + d)*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   ((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^4*gAu^2*(-(2^(1 + 2*d)*Pi^(2*d)*s*
       (-18*(gZlL^2 + gZlR^2)*(2*psq - s)*s - d^2*(gZlL^2 + gZlR^2)*
         (2*psq - s)*s + d*(8*gZlL*gZlR*mm^2*(mm^2 + psq - s) + 
          9*gZlL^2*(2*psq - s)*s + 9*gZlR^2*(2*psq - s)*s))) - 
     2*(-2 + d)*(gZlL^2 + gZlR^2)*(-((-4 + d)*(-2 + d)*mm^4*(2*Pi)^(2*d)*s) + 
       2^(1 + 2*d)*mm^2*Pi^(2*d)*(4*psq^2 + (8 - 6*d + d^2)*psq*s - 
         (-4 + d)*s^2 - 8*psq*t + 4*s*t + 4*t^2) - (2*Pi)^(2*d)*s*
        ((12 - 6*d + d^2)*psq^2 + (-4 + d)*s^2 + 4*s*t + 4*t^2 - 
         4*psq*((-4 + d)*s + 2*t))) + (2*Pi)^(2*d)*
      (-(d^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)^2*s) + 2*d^2*(gZlL^2 + gZlR^2)*
        (mm^2 - psq)*(3*mm^2 - 3*psq - s)*s + 4*(gZlL^2 + gZlR^2)*
        (2*mm^4*s - 2*mm^2*(2*psq^2 + s^2 + 2*psq*(s - 2*t) + 2*s*t + 
           2*t^2) + s*(-2*psq^2 + 2*s^2 - s*t + 2*t^2 + psq*(s + 2*t))) - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(-18*(gZlL^2 + gZlR^2)*(2*psq - s)*s - 
     d^2*(gZlL^2 + gZlR^2)*(2*psq - s)*s + 
     d*(8*gZlL*gZlR*mm^2*(mm^2 + psq - s) + 9*gZlL^2*(2*psq - s)*s + 
       9*gZlR^2*(2*psq - s)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   (Pi^(2*d)*s) - (EL^8*gAl^4*gAu^2*
    (4*gZlL*gZlR*mm^2*s*(d^2*(2*mm^2 - 2*psq - s) + 8*(psq - s - t) + 
       2*d*(-2*mm^2 + psq + 4*s + t)) + 
     gZlL^2*((-2 + d)*mm^4*(8*psq + (-2 + d)^2*s - 8*t) - 
       mm^2*s*((-32 + 24*d - 6*d^2 + d^3)*psq + (84 - 44*d + 5*d^2)*s - 
         12*(-2 + d)*t) + s*(-8*(-6 + d)*psq^2 + (156 - 84*d + 11*d^2)*psq*
          s + (-52 + 30*d - 4*d^2)*s^2 + 16*(-6 + d)*psq*t + 
         4*(14 - 3*d)*s*t - 8*(-6 + d)*t^2)) + 
     gZlR^2*((-2 + d)*mm^4*(8*psq + (-2 + d)^2*s - 8*t) - 
       mm^2*s*((-32 + 24*d - 6*d^2 + d^3)*psq + (84 - 44*d + 5*d^2)*s - 
         12*(-2 + d)*t) + s*(-8*(-6 + d)*psq^2 + (156 - 84*d + 11*d^2)*psq*
          s + (-52 + 30*d - 4*d^2)*s^2 + 16*(-6 + d)*psq*t + 
         4*(14 - 3*d)*s*t - 8*(-6 + d)*t^2)))*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^4*gAu^2*(-(2^(1 + 2*d)*Pi^(2*d)*s*
     ...
     2*(-2 + d)*(gZlL^2 + gZlR^2)*(-((-4 + d)*(-2 + d)*mm^4*(2*Pi)^(2*d)*s) + 
      ...
      (-(d^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)^2*s) + 2*d^2*(gZlL^2 + gZlR^2)*
        (mm^2 - psq)*(3*mm^2 - 3*psq - s)*s + 4*(gZlL^2 + gZlR^2)*
        (2*mm^4*s - 2*mm^2*(2*psq^2 + s^2 + 2*psq*(s - 2*t) + 2*s*t + 
           2*t^2) + s*(10*psq^2 - 11*psq*s + 5*s^2 - 10*psq*t + 5*s*t + 
           2*t^2)) - 2*d*(8*gZlL*gZlR*mm^2*(mm^2 + psq - s)*(psq - s - t) + 
         gZlL^2*(6*mm^4*s - 4*mm^2*(psq^2 + 3*psq*s + s^2 - 2*psq*t + s*t + 
             t^2) + s*(10*psq^2 + 3*s^2 + 3*s*t + 2*t^2 - 3*psq*(s + 2*t))) + 
         gZlR^2*(6*mm^4*s - 4*mm^2*(psq^2 + 3*psq*s + s^2 - 2*psq*t + s*t + 
             t^2) + s*(10*psq^2 + 3*s^2 + 3*s*t + 2*t^2 - 
             3*psq*(s + 2*t))))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   ((2*Pi)^(4*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*
    (-((-2 + d)*(gZlL^2 + gZlR^2)*((12 - 6*d + d^2)*mm^2 - 
        (8 - 6*d + d^2)*psq + 2*(-5 + d)*s)) + 
     (mm^2*(-4*(4 - 5*d + d^2)*gZlL*gZlR*s + (-2 + d)*gZlL^2*
         ((8 - 4*d + d^2)*mm^2 - (-2 + d)^2*psq + 2*(-3 + d)*s) + 
        (-2 + d)*gZlR^2*((8 - 4*d + d^2)*mm^2 - (-2 + d)^2*psq + 
          2*(-3 + d)*s)))/s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(-18*(gZlL^2 + gZlR^2)*(2*psq - s)*s - 
     d^2*(gZlL^2 + gZlR^2)*(2*psq - s)*s + 
     d*(8*gZlL*gZlR*mm^2*(mm^2 + psq - s) + 9*gZlL^2*(2*psq - s)*s + 
    ...
    (-(d^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s) + 
     ...
     12*(gZlL^2 + gZlR^2)*(4*psq^2 - 9*mm^2*s + 15*psq*s - 3*s^2 - 8*psq*t + 
       ...
       gZlL^2*(-4*psq^2 + 36*mm^2*s - 54*psq*s + 9*s^2 + 8*psq*t - 4*s*t - 
         4*t^2) + gZlR^2*(-4*psq^2 + 36*mm^2*s - 54*psq*s + 9*s^2 + 8*psq*t - 
         4*s*t - 4*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (4^d*Pi^(2*d)*s) - ((-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    (-((-4 + d)*(-2 + d)*mm^4*(2*Pi)^(2*d)*s) + 2^(1 + 2*d)*mm^2*Pi^(2*d)*
      (4*psq^2 + (8 - 6*d + d^2)*psq*s - (-4 + d)*s^2 - 8*psq*t + 4*s*t + 
       4*t^2) - (2*Pi)^(2*d)*s*((12 - 6*d + d^2)*psq^2 + (-4 + d)*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*(2*d^2*(2*gZlL*gZlR*mm^2*(-mm^2 + psq) + 
       gZlL^2*s*(2*mm^2 - 3*psq + s) + gZlR^2*s*(2*mm^2 - 3*psq + s)) + 
     2*(gZlL^2 + gZlR^2)*(-12*psq^2 - 38*psq*s + 9*s^2 + 
       2*mm^2*(2*psq + 9*s - 2*t) + 24*psq*t - 16*s*t - 12*t^2) + 
     d*(8*gZlL*gZlR*mm^2*(mm^2 - psq - s) + gZlL^2*(4*psq^2 + 46*psq*s - 
         15*s^2 - 8*psq*t + 4*s*t + 4*t^2 + mm^2*(-4*psq - 22*s + 4*t)) + 
       gZlR^2*(4*psq^2 + 46*psq*s - 15*s^2 - 8*psq*t + 4*s*t + 4*t^2 + 
         mm^2*(-4*psq - 22*s + 4*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    (2*(-2 + d)*mm^4 + 2*(-2 + d)*psq^2 - 6*psq*s - s*(s + 2*t) + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*(2*d^2*(2*gZlL*gZlR*mm^2*(-mm^2 + psq) + 
       gZlL^2*s*(2*mm^2 - 3*psq + s) + gZlR^2*s*(2*mm^2 - 3*psq + s)) - 
     2*(gZlL^2 + gZlR^2)*(12*psq^2 + 46*psq*s - 13*s^2 + 
       mm^2*(4*psq - 22*s - 4*t) - 24*psq*t + 8*s*t + 12*t^2) + 
     d*(8*gZlL*gZlR*mm^2*(mm^2 - psq - s) + gZlL^2*(4*psq^2 + 46*psq*s - 
         15*s^2 + mm^2*(4*psq - 26*s - 4*t) - 8*psq*t + 4*s*t + 4*t^2) + 
       gZlR^2*(4*psq^2 + 46*psq*s - 15*s^2 + mm^2*(4*psq - 26*s - 4*t) - 
         8*psq*t + 4*s*t + 4*t^2)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    (2*(-2 + d)*mm^4 + 2*(-2 + d)*psq^2 - 10*psq*s + 
     mm^2*(-4*(-3 + d)*psq + 6*s - 4*t) + s*(s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(-2*mm^2 + s)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(8*d*gZlL*gZlR*mm^2 + 
   ...
   (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    (-2*mm^2 + s)*(-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(-2*mm^2 + s)*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(-6*(gZlL^2 + gZlR^2)*s + 
  ...
  (EL^8*gAl^4*gAu^2*(-180*(gZlL^2 + gZlR^2)*s + 96*d*(gZlL^2 + gZlR^2)*s + 
   ...
   (4^d*Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    (gZlL^2 + gZlR^2)*(-2*mm^2 + s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(8*d*gZlL*gZlR*mm^2*(-psq + s + t) + 
     gZlL^2*(-((-20 + d^2)*psq^2) - (-56 + 56*d - 14*d^2 + d^3)*psq*s + 
       12*s^2 - 2*d*s^2 + (-44 + 4*d + d^2)*psq*t + 40*s*t - 8*d*s*t + 
       24*t^2 - 4*d*t^2 + (-2 + d)*mm^2*((-2 + d)*psq + (24 - 10*d + d^2)*s - 
         (-2 + d)*t)) + gZlR^2*(-((-20 + d^2)*psq^2) - 
       (-56 + 56*d - 14*d^2 + d^3)*psq*s + 12*s^2 - 2*d*s^2 + 
       (-44 + 4*d + d^2)*psq*t + 40*s*t - 8*d*s*t + 24*t^2 - 4*d*t^2 + 
       (-2 + d)*mm^2*((-2 + d)*psq + (24 - 10*d + d^2)*s - (-2 + d)*t)))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(d^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s + 
     4*(gZlL^2 + gZlR^2)*(7*psq^2 + 28*psq*s + mm^2*(3*psq - 22*s - 3*t) - 
       13*psq*t + 10*s*t + 6*t^2) - 
     4*d*(2*gZlL*gZlR*mm^2*(2*mm^2 - 3*psq - s + t) + 
       gZlL^2*(2*psq^2 + 17*psq*s + mm^2*(psq - 14*s - t) - 3*psq*t + 2*s*t + 
         t^2) + gZlR^2*(2*psq^2 + 17*psq*s + mm^2*(psq - 14*s - t) - 
         3*psq*t + 2*s*t + t^2)) + d^2*(8*gZlL*gZlR*mm^2*(mm^2 - psq) + 
       gZlL^2*(psq*(psq + 14*s - t) + mm^2*(-psq - 12*s + t)) + 
       gZlR^2*(psq*(psq + 14*s - t) + mm^2*(-psq - 12*s + t))))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(d^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s - 
     4*(gZlL^2 + gZlR^2)*(-5*psq^2 - 37*psq*s + 4*s^2 + 
       mm^2*(3*psq + 19*s - 3*t) + 11*psq*t - 2*s*t - 6*t^2) + 
     4*d*(2*gZlL*gZlR*mm^2*(-2*mm^2 + psq + 2*s + t) + 
       gZlL^2*(-20*psq*s + s^2 + mm^2*(psq + 13*s - t) + psq*t - t^2) + 
       gZlR^2*(-20*psq*s + s^2 + mm^2*(psq + 13*s - t) + psq*t - t^2)) + 
     d^2*(8*gZlL*gZlR*mm^2*(mm^2 - psq) + gZlL^2*(mm^2*(psq - 13*s - t) + 
         psq*(-psq + 15*s + t)) + gZlR^2*(mm^2*(psq - 13*s - t) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(d^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s - 
     ...
     2*d^2*(gZlL^2 + gZlR^2)*(5*mm^2 - 5*psq - s)*s + 
     4*d*(gZlL^2*(8*mm^2 - 7*psq - 5*s)*s + gZlR^2*(8*mm^2 - 7*psq - 5*s)*s + 
       4*gZlL*gZlR*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(8*d*gZlL*gZlR*mm^2*(psq - t) + 
     gZlL^2*((28 - 8*d + d^2)*psq^2 - 4*s^2 + 2*d*s^2 + 8*s*t + 24*t^2 - 
       4*d*t^2 + (-2 + d)*mm^2*(-((-2 + d)*psq) + (22 - 9*d + d^2)*s + 
         (-2 + d)*t) - psq*((-84 + 60*d - 13*d^2 + d^3)*s + 
         (52 - 12*d + d^2)*t)) + gZlR^2*((28 - 8*d + d^2)*psq^2 - 4*s^2 + 
       2*d*s^2 + 8*s*t + 24*t^2 - 4*d*t^2 + (-2 + d)*mm^2*
        (-((-2 + d)*psq) + (22 - 9*d + d^2)*s + (-2 + d)*t) - 
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(2*mm^2 - s)*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*
    (d^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s - 8*(gZlL^2 + gZlR^2)*
      (4*mm^2 - 3*psq - 5*s)*s - 2*d^2*(gZlL^2 + gZlR^2)*(5*mm^2 - 5*psq - s)*
      s + 4*d*(gZlL^2*(8*mm^2 - 7*psq - 5*s)*s + 
       gZlR^2*(8*mm^2 - 7*psq - 5*s)*s + 4*gZlL*gZlR*mm^2*(psq - t)))*
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(-6*(gZlL^2 + gZlR^2)*s + 
     d*(-4*gZlL*gZlR*mm^2 + gZlL^2*s + gZlR^2*s))*\[Mu]^(8 - 2*d)*
