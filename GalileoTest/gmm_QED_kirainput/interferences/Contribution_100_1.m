...
(PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, 
  ...
  PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, 
   ...
   (((-I/16)*EL^6*gAl*gAu*gXll*gXuu*mm^2*mu^2*
    ...
    ((I/4)*EL^6*gAl*gAu*gXll*gXuu*(gZlL - gZlR)*(gZuL - gZuR)*mm^2*mu^2*
      (mm^2*(mu^2 - 4*mz^2 - s) + 2*mz^2*s - d*mz^2*s + s^2 + 
       mu^2*(-((-2 + d)*mz^2) + s - t) + 4*mz^2*t + s*t)*SPList[SP[p1, q1]])/
     (mz^2*Pi^4*s) + ((I/4)*EL^6*gAl*gAu*gXll*gXuu*mm^2*mu^2*
      ((-2 + d)*(-(gZlR*gZuL*(mu^2 + (7 - 2*d)*s)) - 
         gZlL*gZuR*(mu^2 + (7 - 2*d)*s) + gZlL*gZuL*(mu^2 + (-5 + 2*d)*s) + 
         gZlR*gZuR*(mu^2 + (-5 + 2*d)*s)) + ((gZlL - gZlR)*(gZuL - gZuR)*
         (mu^2 - s)*(mm^2 - t))/mz^2)*SPList[SP[p2, q1]])/(Pi^4*s) - 
