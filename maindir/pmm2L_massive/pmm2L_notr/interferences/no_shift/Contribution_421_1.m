...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (-((4^(3 - d)*(-1 + d)*d*EL^8*gAl*gAu^2*gWWA*gWWZZ*gZlL*gZlR*mm^2*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2)) - 
   (4^(3 - d)*(-1 + d)*d*EL^8*gAl*gAu^2*gWWA*gWWZZ*gZlL*gZlR*mm^2*(psq - t)*
   ...
   (4^(2 - d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*
   ...
   (4^(2 - d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*
   ...
   (4^(2 - d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*
     (gZlL^2 + gZlR^2)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl*
