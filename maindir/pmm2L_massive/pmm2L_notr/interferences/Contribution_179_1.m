...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^2 - 2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*
    gXgpgp*gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*
