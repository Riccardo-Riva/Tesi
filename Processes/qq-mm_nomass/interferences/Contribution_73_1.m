...
PropList[KiraPropagator[p1 - q1, 0], KiraPropagator[-p2 - q1, 0], 
  ...
  (((-I)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*t^2*(d^2*gZuL*(2*Pi)^d*s^2 - 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*t*(d^2*gZuL*(2*Pi)^d*s^2 - 
    ...
    (mw^2*Pi^(2*d)*s*(-mz^2 + s)) - ((3*I)*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*
     gWNl*gZNL*t*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
      2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2) + 
      2^(1 + d)*gZuL*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))*
     SPList[SP[p1, p3]])/(mw^2*Pi^(2*d)*s*(-mz^2 + s)) + 
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*t*(d^2*gZuL*(2*Pi)^d*s^2 - 
      d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - 
        (4 - 5*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZuL*Pi^d*
   ...
   (I*EL^6*gAl*gAu*gWlN*gWNl*gZNL*(d^2*gZuL*(2*Pi)^d*s^2 - 
      d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - 
        (4 - 5*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZuL*Pi^d*
       (-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))*
     SPList[SP[p1, p2], SP[p1, p3]])/(mw^2*(2*Pi)^(2*d)*s*(-mz^2 + s)) + 
   (I*EL^6*gAl*gAu*gWlN*gWNl*gZNL*(-(d^2*gZuL*(2*Pi)^d*s^2) + 
      d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*((4 - 3*d)*s^2 + 
        (4 - 5*d + d^2)*s*t - 2*t^2) + 2^(1 + d)*gZuL*Pi^d*
       (2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 2*t^2))*
   ...
   (I*EL^6*gAl*gAu*gWlN*gWNl*gZNL*(-(d^2*gZuL*(2*Pi)^d*s^2) + 
      d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*((4 - 3*d)*s^2 + 
        (4 - 5*d + d^2)*s*t - 2*t^2) + 2^(1 + d)*gZuL*Pi^d*
       (2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 2*t^2))*
     SPList[SP[p1, p3], SP[p2, p3]])/(mw^2*(2*Pi)^(2*d)*s*(-mz^2 + s)) + 
   (I*EL^6*gAl*gAu*gWlN*gWNl*gZNL*(-(d^2*gZuL*(2*Pi)^d*s^2) + 
      d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*((4 - 3*d)*s^2 + 
        (4 - 5*d + d^2)*s*t - 2*t^2) + 2^(1 + d)*gZuL*Pi^d*
       (2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 2*t^2))*
     SPList[SP[p1, p3], SP[p2, q1]])/(mw^2*(2*Pi)^(2*d)*s*(-mz^2 + s)) + 
   ((3*I)*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
  ...
  ((I*4^(-1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
    ...
    (mw^2*Pi^(2*d)*(mz^2 - s)*s) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*
     gZNL*(2^(1 + d)*gZuL*mw^2*Pi^d*s*((20 - 16*d + 3*d^2)*s + 
        2*(26 - 18*d + 3*d^2)*t) - 2^(1 + d)*gZuR*mw^2*Pi^d*s*
     ...
     SPList[SP[p1, p3]])/(mw^2*Pi^(2*d)*(mz^2 - s)*s) + 
   (I*2^(-1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*(d^2*gZuR*(2*Pi)^d*s^2*t - 
    ...
    (mw^2*Pi^(2*d)*(mz^2 - s)*s) + (I*2^(-1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
     (gZuR*((-80 + 60*d - 14*d^2 + d^3)*s^2 + 2*(-56 + 48*d - 13*d^2 + d^3)*s*
         t - 4*(-2 + d)*t^2) - gZuL*((-40 + 40*d - 12*d^2 + d^3)*s^2 + 
   ...
   (I*2^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
    ...
    (Pi^d*s*(-mz^2 + s)) + (I*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*(-(d^2*gZuL*(2*Pi)^d*s^2) + 
      d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*((4 - 3*d)*s^2 + 
       ...
       (2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 2*t^2))*
     SPList[SP[p1, p2], SP[q1, q1]])/(mw^2*Pi^(2*d)*s*(-mz^2 + s)) - 
   (I*EL^6*gAl*gAu*gWlN*gWNl*gZNL*(gZuL*((12 - 8*d + d^2)*mw^2*(2*s + t) - 
   ...
   (I*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*((-10 + d)*gZuL*s - 
    ...
    ((2*Pi)^d*s*(-mz^2 + s)) - ((3*I)*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*
     gZNL*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
      2^(1 + d)*gZuR*Pi^d*((4 - 3*d)*s^2 + (4 - 5*d + d^2)*s*t - 2*t^2) + 
      2^(1 + d)*gZuL*Pi^d*(2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 2*t^2))*
     SPList[SP[p1, p3], SP[q1, q1]])/(mw^2*Pi^(2*d)*s*(-mz^2 + s)) - 
