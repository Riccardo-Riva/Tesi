...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  ((I*2^(4 - d)*EL^6*gAl*gAu*gFFZ*gHFF*gHll*(gZuL + gZuR)*mm^2*
     (-mmv^2 + s + t)*(mh^2 + 2*mw^2*GaugeXi[Q])*SPList[SP[p1, q1]])/
    (Pi^d*(mh^2 - s)*s*(-mz^2 + s)) + 
   (I*2^(4 - d)*EL^6*gAl*gAu*gFFZ*gHFF*gHll*(gZuL + gZuR)*mm^2*(mmv^2 - t)*
