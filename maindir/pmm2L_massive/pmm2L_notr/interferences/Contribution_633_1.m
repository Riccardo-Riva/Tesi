...
PropList[KiraPropagator[-p3 + q1, mz], KiraPropagator[q2, mz], 
 ...
 ((2^(1 - 2*d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*
    (mm^2 - psq)^2*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*
    (mm^2 - psq)*(-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  ((-2 + d)^2*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(4^d*Pi^(2*d)*s) + 
  (EL^8*gAl^2*gAu^2*gXll^2*mm^2*(-4*(-3 + d)*d*gZlL*gZlR*mm^2 - 
     (-2 + d)^2*(gZlL^2 + gZlR^2)*(mm^2 - psq))*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/(4^d*Pi^(2*d)*s) + 
  (2^(-1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 - psq)*(4*psq^2 + d*s*(-2*mm^2 + s) + 2*psq*(d*s - 4*t) + 
     4*(-s^2 + s*t + t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
    (-4*d*gZlL*gZlR*mm^2*(4*psq^2 + (-6 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 
       4*t^2 - psq*((-6 + d)*s + 8*t)) + (-2 + d)*(gZlL^2 + gZlR^2)*
      (mm^2 - psq)*(4*psq^2 + d*s*(-2*mm^2 + s) + 2*psq*(d*s - 4*t) + 
  ...
  ((-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
    (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q2]])/(4^d*Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
    ((-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(psq - s - t) + 
     4*d*gZlL*gZlR*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^2*gAu^2*gXll^2*mm^2*(4*d*gZlL*gZlR*mm^2*(2*psq + (-6 + d)*s - 
       2*t) - (-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (2*psq + (-6 + d)*s - 2*t) - (-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (2*psq + (-4 + d)*s - 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
    (-((-2 + d)^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s) + 
     d*gZlL*gZlR*mm^2*(-2*psq + d*s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*(4*d*gZlL*gZlR*mm^2 - 
     (-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq))*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
    (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[p3, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gXll^2*mm^2*((-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (2*psq - (-4 + d)*s - 2*t) + (-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (2*psq - (-2 + d)*s - 2*t) + 4*d*gZlL*gZlR*mm^2*
      (-2*psq + (-4 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
    (-((-2 + d)^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s) + 
     d*gZlL*gZlR*mm^2*(2*psq + (-2 + d)*s - 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) + ((-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (4*psq^2 + (-6 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
     psq*((-6 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
   (4^d*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
    (4*d*gZlL*gZlR*mm^2 + (8 - 6*d + d^2)*(gZlL^2 + gZlR^2)*(mm^2 - psq))*
  ...
  (EL^8*gAl^2*gAu^2*gXll^2*mm^2*(-4*d*gZlL*gZlR*mm^2 + 
     3*(-2 + d)^2*gZlL^2*(mm^2 - psq) + 3*(-2 + d)^2*gZlR^2*(mm^2 - psq))*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    gXll^2*(gZlL^2 + gZlR^2)*mm^2*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + ((-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    gXll^2*(gZlL^2 + gZlR^2)*mm^2*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    gXll^2*(gZlL^2 + gZlR^2)*mm^2*(4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - ((-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*
    (gZlL^2 + gZlR^2)*mm^2*(-2*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*
