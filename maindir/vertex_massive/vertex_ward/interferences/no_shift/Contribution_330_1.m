...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^5*gAl*gHll^2*mm^4*s*(bb*(-8*d*gZlL*gZlR*(psq^2 + mm^2*(3*psq - s)) - 
        (-2 + d)*gZlL^2*(mm^2 - psq)*(mm^2 + s) - (-2 + d)*gZlR^2*
         (mm^2 - psq)*(mm^2 + s)) + 
      aa*(4*d*gZlL*gZlR*(psq*(2*psq - s) + mm^2*(6*psq - s)) - 
        (-2 + d)*gZlL^2*(mm^2 - psq)*(mm^2 + s) - (-2 + d)*gZlR^2*
         (mm^2 - psq)*(mm^2 + s)))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - 
   (2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*(2^(1 + 2*d)*bb*mm^2*Pi^(2*d)*
       (gZlL^2*(3*mm^2 + psq) + gZlR^2*(3*mm^2 + psq) + 
        4*gZlL*gZlR*(mm^2 - s))*s + 2^(1 + 2*d)*aa*Pi^(2*d)*
       (gZlR^2*mm^2*(mm^2 - 5*psq) + gZlL^2*(mm^4 - 5*mm^2*psq) - 
        2*gZlL*gZlR*(mm^2 + psq)*(mm^2 - s))*s - bb*d*(2*Pi)^(2*d)*
       (gZlL^2*mm^2*(3*mm^2 + psq)*s + gZlR^2*mm^2*(3*mm^2 + psq)*s + 
        2*gZlL*gZlR*(mm^4*(9*psq - 2*s) + psq^2*s + 
          mm^2*(3*psq^2 + 3*psq*s - 2*s^2))) + aa*d*(2*Pi)^(2*d)*
       (-(gZlL^2*mm^2*(mm^2 - 5*psq)*s) - gZlR^2*mm^2*(mm^2 - 5*psq)*s + 
        2*gZlL*gZlR*(mm^4*(9*psq - s) + psq*(psq - s)*s + 
          mm^2*(3*psq^2 + 2*psq*s - s^2))))*\[Mu]^(8 - 2*d)*
     ...
     (bb*(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(d*(psq^2 + mm^2*(3*psq - 2*s)) - 
      ...
      2^(1 + 2*d)*aa*Pi^(2*d)*((-2 + d)*gZlL^2*mm^2*psq + 
        (-2 + d)*gZlR^2*mm^2*psq + gZlL*gZlR*(-(d*psq*(3*mm^2 + psq - 2*s)) + 
          2*(mm^2 + psq)*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(4*d) + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^4*
     (-(aa*(-2*(4 + d)*gZlL*gZlR*(mm^2 + psq) + (-2 + d)*gZlL^2*(3*psq - s) + 
         (-2 + d)*gZlR^2*(3*psq - s))) + bb*(-4*gZlL*gZlR*(4*mm^2 + d*psq) + 
   ...
   (EL^5*gAl*gHll^2*mm^4*(-(aa*(-2*(-4 + d)*gZlL*gZlR*(mm^2 - psq) + 
    ...
    (2*Pi)^(2*d) - (2^(3 - 2*d)*EL^5*gAl*gHll^2*mm^2*
     (bb*((-2 + d)*gZlL^2*mm^2*(mm^2 + psq) + (-2 + d)*gZlR^2*mm^2*
         (mm^2 + psq) + gZlL*gZlR*(d*(psq^2 + mm^2*(3*psq - 2*s)) + 
          4*mm^2*s)) + aa*(-2*(-2 + d)*gZlL^2*mm^2*psq - 
        2*(-2 + d)*gZlR^2*mm^2*psq + gZlL*gZlR*(-2*(mm^2 + psq)*s + 
          d*mm^2*(-3*psq + s) + d*psq*(-psq + s))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*(2*aa*gZlL*gZlR*psq*
       ((2 + d)*mm^2 + (-2 + d)*s) + bb*mm^2*((-2 + d)*gZlL^2*(mm^2 - psq) + 
        (-2 + d)*gZlR^2*(mm^2 - psq) - 2*gZlL*gZlR*((2 + d)*mm^2 + 
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     (bb*d*(psq^2 + mm^2*(3*psq - 2*s)) + 4*bb*mm^2*s - 2*aa*(mm^2 + psq)*s + 
      aa*d*mm^2*(-3*psq + s) + aa*d*psq*(-psq + s))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (bb*((-2 + d)*gZlL^2*mm^2*psq + (-2 + d)*gZlR^2*mm^2*psq - 
      ...
      aa*((-2 + d)*gZlL^2*mm^2*psq + (-2 + d)*gZlR^2*mm^2*psq + 
        gZlL*gZlR*(-(d*psq*(3*mm^2 + psq)) + 2*(mm^2 + psq)*s)))*
