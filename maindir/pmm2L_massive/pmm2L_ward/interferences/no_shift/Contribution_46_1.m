...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (((-I)*(aa - bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(mm^4 - psq^2)*
   ...
   (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - psq)*s*
   ...
   (I*4^(1 - d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(bb*(mm^2 + psq - 2*t) + 
      ...
      SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*s*\[Mu]^(8 - 2*d)*
