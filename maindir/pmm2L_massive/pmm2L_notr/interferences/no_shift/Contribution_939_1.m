...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*mm^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(4*psq^2 + 2*(-4 + d)*mm^2*s - 
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(3 - d)*EL^8*gAl^6*gAu^2*(mm^2*(3*psq - 7*s + 2*d*s - 3*t) + 
      ...
      SP[p1, q2]])/(Pi^(2*d)*s^2) + (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(-2*psq + 3*s + 2*t)*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(2*psq + s - 2*t)*
