   ...
   ((I*EL^6*gAl*gAu*gFZW^2*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - 
       ...
       gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
         ...
         2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
           2*t^2))))/((2*Pi)^(2*d)*(mz^2 - s)^2*s*sw^2) + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gFZW^2*(d*gZlR*(gZuL - gZuR)*s + 
     ...
     (mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*gFZW^2*
      (gZlL*(-(2^(1 + d)*gZuL*Pi^d) + 2^(2 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
         d*gZuR*(2*Pi)^d) + gZlR*(2^(2 + d)*gZuL*Pi^d - 2^(1 + d)*gZuR*Pi^d - 
         d*gZuL*(2*Pi)^d + d*gZuR*(2*Pi)^d))*t*SPList[SP[p2, q1], 
       SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*s*sw^2) + 
    (I*2^(1 - d)*EL^6*gAl*gAu*gFZW^2*(gZlL*gZuL*((-2 + d)*s - 2*t) + 
     ...
     (mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) - (I*2^(2 - d)*EL^6*gAl*gAu*gFZW^2*
