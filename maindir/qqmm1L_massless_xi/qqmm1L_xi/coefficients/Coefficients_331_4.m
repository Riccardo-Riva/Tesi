...
{((-I)*d*EL^6*gAl^2*(gZlL + gZlR)*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
    s^2*\[Mu]^(4 - d))/((-4 + 4*d)*(2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)) + 
  (I*d*EL^6*gAl^2*(gZlL + gZlR)*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s^2*
    \[Mu]^(4 - d))/((-4 + 4*d)*(2*Pi)^d*(-mz^2 + s)*(-mzC^2 + s)) - 
  (I*2^(-2 - d)*EL^6*gAl^2*(gZlL + gZlR)*(d*s + 2*t)*
