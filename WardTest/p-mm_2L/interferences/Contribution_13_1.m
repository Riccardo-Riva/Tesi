...
PropList[KiraPropagator[p1 + p2 - q1, mm], KiraPropagator[p3 - q1, 0], 
  ...
  KiraPropagator[-q1 - q2, md], KiraPropagator[p3 + q2, md]]*
 ((3*2^(1 - 2*d)*d*EL^5*gAd^2*gAl^3*md^2*mm*(4*mm^2 - s)*s)/Pi^(2*d) - 
  (3*2^(3 - 2*d)*EL^5*gAd^2*gAl^3*mm*(2*mm^4 + d*md^2*(2*mm^2 - s) + md^2*s - 
  ...
  (3*4^(2 - d)*EL^5*gAd^2*gAl^3*mm*s*SPList[SP[p1, q2], SP[q1, q2]])/
   Pi^(2*d) - (3*2^(3 - 2*d)*(-2 + d)*EL^5*gAd^2*gAl^3*md^2*mm*
    SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
  (3*4^(2 - d)*EL^5*gAd^2*gAl^3*mm^3*SPList[SP[p2, q1], SP[p2, q2]])/
   Pi^(2*d) + (3*2^(3 - 2*d)*(-2 + d)*EL^5*gAd^2*gAl^3*mm*
    (2*md^2 + 2*mm^2 - s)*SPList[SP[p2, q1], SP[p3, q1]])/Pi^(2*d) + 
  (3*2^(3 - 2*d)*(-3 + d)*EL^5*gAd^2*gAl^3*mm*(2*mm^2 - s)*
