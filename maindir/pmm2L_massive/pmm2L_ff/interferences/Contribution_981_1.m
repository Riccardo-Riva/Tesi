...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(1 - 4*d)*EL^6*gAl*gAu*gFFZ^2*mm^2*
      ...
      (Pi^(4*d)*s)) - (2^(1 - 4*d)*EL^6*gAl*gAu*gFFZ^2*
      (-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(4*psq^3 - 2*psq^2*(s + 4*t) - 
          psq*(s^2 + 2*s*t - 4*t^2) + s*(s^2 + 5*s*t + 4*t^2))) + 
       gZlL^2*((2*Pi)^(2*d)*psq*s*(4*psq^2 - 3*psq*s + s^2 - 7*psq*t + 
           4*s*t + 3*t^2) + 2^(1 + 2*d)*mm^4*Pi^(2*d)*
          (3*psq^2 + 3*t*(s + t) - psq*(s + 6*t)) + mm^2*(2*Pi)^(2*d)*
          (-6*psq^3 - 2*psq^2*(s - 8*t) + psq*(2*s^2 - 9*s*t - 14*t^2) + 
           t*(3*s^2 + 7*s*t + 4*t^2))) + 
       gZlR^2*((2*Pi)^(2*d)*psq*s*(4*psq^2 - 3*psq*s + s^2 - 7*psq*t + 
           4*s*t + 3*t^2) + 2^(1 + 2*d)*mm^4*Pi^(2*d)*
          (3*psq^2 + 3*t*(s + t) - psq*(s + 6*t)) + mm^2*(2*Pi)^(2*d)*
          (-6*psq^3 - 2*psq^2*(s - 8*t) + psq*(2*s^2 - 9*s*t - 14*t^2) + 
           t*(3*s^2 + 7*s*t + 4*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     (Pi^(4*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*mm^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*mm^2*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFFZ^2*(2*gZlL*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(-2*gZlL*gZlR*mm^2*s*
        (-2*psq + s + 2*t) + gZlL^2*(-2*mm^4*(psq - t) + 
         mm^2*(4*psq - s - 2*t)*(psq - t) + 2*psq*(-psq + s + t)^2) + 
       gZlR^2*(-2*mm^4*(psq - t) + mm^2*(4*psq - s - 2*t)*(psq - t) + 
         2*psq*(-psq + s + t)^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFFZ^2*
      (-2*gZlL*gZlR*mm^2*(4*psq^2 - 6*psq*s + 3*s^2 - 8*psq*t + 6*s*t + 
         4*t^2) + gZlL^2*(2*mm^4*s + psq*s*(3*psq - s - t) + 
         mm^2*(4*psq^2 - 11*psq*s + 4*s^2 - 8*psq*t + 7*s*t + 4*t^2)) + 
       gZlR^2*(2*mm^4*s + psq*s*(3*psq - s - t) + 
         mm^2*(4*psq^2 - 11*psq*s + 4*s^2 - 8*psq*t + 7*s*t + 4*t^2)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(-2*gZlL*gZlR*mm^2*
        (4*psq^2 - 6*psq*s + 3*s^2 - 8*psq*t + 6*s*t + 4*t^2) + 
       gZlL^2*(2*mm^4*s + s*(psq^2 - 2*psq*t + t*(s + t)) + 
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*gFFZ^2*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(-2*psq + s + 2*t)*
      (4*gZlL*gZlR*mm^2*(psq - s - t) + 
       gZlL^2*(-((psq - t)*(2*psq - s - t)) + mm^2*(-psq + s + t)) + 
       gZlR^2*(-((psq - t)*(2*psq - s - t)) + mm^2*(-psq + s + t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(-psq + s + t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*mm^2*(-psq + s + t)*
      (-2*gZlL*gZlR*s + gZlL^2*(2*mm^2 - 3*psq + s + t) + 
       gZlR^2*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(2*gZlL*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*mm^2*(gZlL^2*(mm^2 - psq)*(psq - t) + 
       gZlR^2*(mm^2 - psq)*(psq - t) + gZlL*gZlR*s*(-2*psq + s + 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(-2*gZlL*gZlR*mm^2*s^2 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gFFZ^2*(psq - t)*
      (-2*gZlL*gZlR*mm^2*s + gZlL^2*(mm^2*(psq - t) + psq*(-psq + s + t)) + 
       gZlR^2*(mm^2*(psq - t) + psq*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(-4*gZlL*gZlR*mm^2*s + 
       gZlL^2*(psq*s + 2*mm^2*(psq - t)) + gZlR^2*(psq*s + 2*mm^2*(psq - t)))*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFZ^2*
      (gZlL^2*(mm^2*(4*psq - s - 4*t)*(psq - t) + psq*s*(-psq + s + t)) + 
       gZlR^2*(mm^2*(4*psq - s - 4*t)*(psq - t) + psq*s*(-psq + s + t)) - 
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(-2*psq + s + 2*t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(psq - t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*mm^2*(psq - t)*(2*gZlL*gZlR*s + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*
      (2*psq*(psq - s - t) + mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*
      (2*psq*(psq - s - t) + mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(-psq + s + t)*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - 2*psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*
      (gZlL^2 + gZlR^2)*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p2, q1]])/Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*
      (gZlL^2 + gZlR^2)*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p2, q2]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(psq - t)*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[q1, q2]])/Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)*(-psq + s + t)*
     ...
     Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)^2*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], SP[q1, q1]])/
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) - (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*
      (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1], SP[p3, q2], SP[q1, q2]])/Pi^(2*d) + 
    (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
