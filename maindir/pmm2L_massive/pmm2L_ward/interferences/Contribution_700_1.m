...
PropList[KiraPropagator[p3 - q1, 0], KiraPropagator[-p3 - q2, mm], 
 ...
 ((I*(aa + bb)*EL^5*gAl*gFll^2*gXll^2*mm^4*(mm^2 - psq)^2*psq*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gXll^2*mm^4*(mm^2 - psq)*psq*
    (aa*(psq - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gXll^2*mm^4*(mm^2 - psq)*psq*
    ...
    SPList[SP[p2, q2]])/Pi^(2*d) - (I*(aa + bb)*EL^5*gAl*gFll^2*gXll^2*mm^4*
    (mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa + bb)*EL^5*gAl*gFll^2*gXll^2*mm^4*
    (mm^2 - 3*psq)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa + bb)*EL^5*gAl*gFll^2*gXll^2*mm^4*
    (mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa + bb)*EL^5*gAl*gFll^2*gXll^2*mm^4*
  ...
  (I*EL^5*gAl*gFll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(psq - t) + 
   ...
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gXll^2*mm^4*psq*
  ...
  (I*EL^5*gAl*gFll^2*gXll^2*mm^4*(bb*psq*(2*psq - s - 2*t) + 
  ...
  (I*EL^5*gAl*gFll^2*gXll^2*mm^4*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gXll^2*mm^4*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gFll^2*gXll^2*mm^4*(aa*(mm^2 - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, q2], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gXll^2*mm^4*(aa*(mm^2 - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
  ...
  (I*EL^5*gAl*gFll^2*gXll^2*mm^4*(aa*(mm^2 - t) + bb*(mm^2 - 2*psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gXll^2*mm^4*
    (aa*(mm^2 - t) + bb*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFll^2*gXll^2*mm^4*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFll^2*gXll^2*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
  ...
  (I*EL^5*gAl*gFll^2*gXll^2*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (2*Pi)^(2*d) + (I*EL^5*gAl*gFll^2*gXll^2*mm^4*(aa*(2*mm^2 - psq - t) + 
