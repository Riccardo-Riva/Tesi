...
PropList[KiraPropagator[-p3 + q1, mz], KiraPropagator[-p3 - q2, mm], 
 ...
 ((2^(1 - 2*d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*(-4*d*gZlL*gZlR*mm^2 + 
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*
    (gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^2*gAu^2*gXll^2*mm^2*(-16*d*gZlL*gZlR*mm^2*s - 
     4*(8 - 6*d + d^2)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s + 
     4*d*gZlL*gZlR*mm^2*(2*psq + (-2 + d)*s - 2*t) + 
     (-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(-2*psq + (-4 + d)*s + 2*t) + 
     (-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(-2*psq + (-2 + d)*s + 2*t))*
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
    (d^2*(-(gZlL*gZlR*mm^2) + gZlL^2*(mm^2 - psq) + gZlR^2*(mm^2 - psq))*s + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*(-4*d*gZlL*gZlR*mm^2 + 
     (-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq))*(psq - t)*
  ...
  (EL^8*gAl^2*gAu^2*gXll^2*mm^2*(-16*d*gZlL*gZlR*mm^2*s - 
     4*(8 - 6*d + d^2)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s + 
     (-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(2*psq + (-6 + d)*s - 2*t) + 
     (-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(2*psq + (-4 + d)*s - 2*t) + 
     4*d*gZlL*gZlR*mm^2*(-2*psq + d*s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
    (d^2*(-(gZlL*gZlR*mm^2) + gZlL^2*(mm^2 - psq) + gZlR^2*(mm^2 - psq))*s + 
     4*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s + 
     d*(4*gZlL^2*(-mm^2 + psq)*s + 4*gZlR^2*(-mm^2 + psq)*s + 
       2*gZlL*gZlR*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
