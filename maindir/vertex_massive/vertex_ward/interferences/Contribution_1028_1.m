   ...
   (((-I)*EL^5*gAl*gWWZ^2*mm^2*s*
    ...
    (I*EL^5*gAl*gWWZ^2*s*(aa*(24*(-1 + d)*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
         ...
         gZlR^2*(4*(-8 + 3*d)*mm^4 + 2*psq*(5*(-2 + d)*psq - 2*(-1 + d)*s - 
             5*(-2 + d)*t) + mm^2*(-8*(-7 + 2*d)*psq + (-6 + d)*
              (s + 4*t)))) + bb*(-24*(-1 + d)*gZlL*gZlR*mm^2*
          (2*psq - s - 2*t) + gZlL^2*(4*(-8 + 3*d)*mm^4 + 
           2*psq*(-5*(-2 + d)*psq + (-8 + 3*d)*s + 5*(-2 + d)*t) + 
           mm^2*(-8*(-1 + d)*psq - (-6 + d)*(3*s + 4*t))) + 
         gZlR^2*(4*(-8 + 3*d)*mm^4 + 2*psq*(-5*(-2 + d)*psq + (-8 + 3*d)*s + 
             5*(-2 + d)*t) + mm^2*(-8*(-1 + d)*psq - (-6 + d)*(3*s + 4*t)))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2*Pi)^(2*d) - 
    (I*EL^5*gAl*gWWZ^2*mm^2*s*(bb*(3*4^(1 + d)*(-1 + d)*gZlL*gZlR*Pi^(2*d)*
          (2*psq - s - 2*t) - gZlR^2*(2*Pi)^(2*d)*(2*(-5 + 3*d)*mm^2 - 
           2*(-2 + d)*psq - (-3 + 2*d)*(s + 2*t)) + gZlL^2*(2*Pi)^(2*d)*
          ((10 - 6*d)*mm^2 + 2*(-2 + d)*psq + (-3 + 2*d)*(s + 2*t))) - 
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gWWZ^2*
      (bb*(3*2^(3 + 2*d)*(-1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) - 
       ...
       aa*(-3*2^(3 + 2*d)*(-1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
          (2*psq - s - 2*t) + gZlL^2*(2*Pi)^(2*d)*(-10*(-2 + d)*psq^2 + 
           (-34 + 19*d)*psq*s + 10*(-2 + d)*psq*t - 5*(-2 + d)*s*(s + t) + 
    ...
    (I*EL^5*gAl*gWWZ^2*(bb*(3*2^(3 + 2*d)*(-1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
       ...
       aa*(-3*2^(3 + 2*d)*(-1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
          (2*psq - s - 2*t) + gZlL^2*(2*Pi)^(2*d)*(2*(-6 + d)*psq^2 + 
           (-18 + 13*d)*psq*s - 2*(-6 + d)*psq*t - 5*(-2 + d)*s*(s + t) + 
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gWWZ^2*
      (aa*(-3*4^(1 + d)*(-1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
         gZlL^2*(2*Pi)^(2*d)*((-6 + 4*d)*psq^2 + 6*psq*t - 
           (-2 + d)*s*(s + t) - d*psq*(s + 4*t) + mm^2*((-6 + 4*d)*psq + 
             4*s - 2*d*s + 6*t - 4*d*t)) + gZlR^2*(2*Pi)^(2*d)*
          ((-6 + 4*d)*psq^2 + 6*psq*t - (-2 + d)*s*(s + t) - 
           d*psq*(s + 4*t) + mm^2*((-6 + 4*d)*psq + 4*s - 2*d*s + 6*t - 
             4*d*t))) + bb*(3*4^(1 + d)*(-1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
          (2*psq - s - 2*t) - gZlR^2*(2*Pi)^(2*d)*((-6 + 4*d)*psq^2 + 
           2*(-3 + 2*d)*mm^2*(psq - s - t) - (-2 + d)*s*(s + t) + 
           psq*((-2 + d)*s + 6*t - 4*d*t)) + gZlL^2*(2*Pi)^(2*d)*
          ((6 - 4*d)*psq^2 - 2*(-3 + 2*d)*mm^2*(psq - s - t) + 
           (-2 + d)*s*(s + t) + psq*(2*s - d*s - 6*t + 4*d*t))))*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gWWZ^2*(gZlL^2 + gZlR^2)*
     ...
     Pi^(2*d) - (I*4^(1 - d)*(-3 + 2*d)*EL^5*gAl*gWWZ^2*(gZlL^2 + gZlR^2)*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gWWZ^2*
      (aa*(-3*2^(3 + 2*d)*(-1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
          (2*psq - s - 2*t) + gZlL^2*(2*Pi)^(2*d)*(-10*(-2 + d)*psq^2 + 
           ...
           10*(-2 + d)*psq*t - 5*(-2 + d)*s*t) + gZlR^2*(2*Pi)^(2*d)*
          (-10*(-2 + d)*psq^2 + (-14 + 9*d)*psq*s + (-6 + d)*mm^2*
            (4*psq - s - 4*t) + 10*(-2 + d)*psq*t - 5*(-2 + d)*s*t)) + 
       bb*(3*2^(3 + 2*d)*(-1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) - 
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gWWZ^2*
      (aa*(-3*4^(1 + d)*(-1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
         gZlL^2*(2*Pi)^(2*d)*((-6 + 4*d)*psq^2 + 2*(-3 + 2*d)*mm^2*
            (psq - t) - (-2 + d)*s*t + psq*(4*s - 3*d*s + 6*t - 4*d*t)) + 
