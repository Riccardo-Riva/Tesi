...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(1 - 2*d)*d*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*(-((-2 + d)*d*gZlL^3*gZlR*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*d*EL^6*gAl*gAu*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*((-2 + d)*d*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t)*
      ...
      gZlL^4*(-((-2 + d)^2*mm^4*s*(psq - t)) - 2*(-2 + d)^2*mm^2*
         (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
          ...
          8*(-2 + d)*psq*t*(2*s + 3*t) + (-2 + d)*psq^2*(4*s - (-26 + d)*t) + 
          4*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2))) + 
   ...
   (2^(3 - 4*d)*d*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
     (-(d*gZlL*gZlR*(2*Pi)^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
         2*t^2)) + 2^(1 + 2*d)*(-2 + d)*gZlL^2*Pi^(2*d)*
   ...
   (4^(1 - d)*(-2 + d)^2*EL^6*gAl*gAu*(-2*gZlL^2*gZlR^2*mm^2 + gZlL^4*psq + 
      gZlR^4*psq)*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*d*EL^6*gAl*gAu*gZlL*gZlR*mm^2*(psq - t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*
     (-4*psq^2 + (-2 + d)*mm^2*(psq - t) - (-10 + d)*psq*t + 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 4*d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*
     ...
     SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/(Pi^(4*d)*s) - 
