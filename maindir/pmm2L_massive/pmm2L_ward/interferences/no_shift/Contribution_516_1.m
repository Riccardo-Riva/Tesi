...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gFFAA*gHFF*gHll*mh^2*mm^2*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d))/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFAA*gHFF*
     gHll*mh^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFAA*gHFF*gHll*mh^2*mm^2*(-psq + s + t)*
