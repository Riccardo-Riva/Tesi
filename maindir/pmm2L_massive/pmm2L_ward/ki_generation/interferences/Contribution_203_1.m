...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   (((-I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*psq*s*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA^3*s*(bb*(mm^2 - 2*psq)*(psq - s - t) + 
       2*aa*psq*(2*psq - s - t) + aa*mm^2*(-3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*
      mm^2*(2*psq^2 + psq*(s - 2*t) - 2*s*(s + t))*\[Mu]^(8 - 2*d)*
