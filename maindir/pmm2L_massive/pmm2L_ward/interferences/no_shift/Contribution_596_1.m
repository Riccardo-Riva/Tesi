...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  (((-I)*2^(1 - 2*d)*(aa - bb)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^4*s*
   ...
   (I*2^(1 - 2*d)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (4*bb*mm^2*(psq - t) + aa*s*(-4*psq + s + t) - bb*s*(-2*psq + s + t) + 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (4*aa*mm^2*(psq - s - t) - aa*s*t + bb*s*(2*psq + t) + 
      bb*mm^2*(-4*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(2*mm^2 + psq)*
    ...
    (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
    (2*Pi)^(2*d) - (I*4^(1 - d)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(bb*(3*psq - 2*s - 3*t) + 
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
   ...
   (I*4^(1 - d)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*
   ...
   (I*4^(1 - d)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (bb*(2*mm^2 + psq - s - 3*t) + aa*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
