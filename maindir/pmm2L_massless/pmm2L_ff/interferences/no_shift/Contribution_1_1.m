...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((2^(1 - 2*d)*EL^6*gAu*gFFAZ*gFll^2*gZNL*mm^2*t*(s + t)*(s + 2*t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFAZ*gFll^2*gZNL*mm^2*(s + t)*(2*mm^2 + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFAZ*gFll^2*gZNL*mm^2*t*(mm^2 + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFAZ*gFll^2*gZNL*mm^2*(mm^2*s + (s + t)^2)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFAZ*gFll^2*gZNL*mm^2*t^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFAZ*gFll^2*gZNL*mm^2*t^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFAZ*gFll^2*gZNL*mm^2*t^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFAZ*gFll^2*gZNL*mm^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
