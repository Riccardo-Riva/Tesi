...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gAl^5*mm^2*s*
      ...
      SPList[SP[p1, q1]])/Pi^(2*d) - (I*4^(1 - 2*d)*EL^5*gAl^5*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*((2 + d)*mm^2 - 
       (-2 + d)*psq)*s*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl^5*(mm^2 - psq)^2*
      s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(-2 + d)^2*EL^5*gAl^5*mm^2*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/Pi^(2*d) + (I*4^(2 - d)*d*EL^5*gAl^5*mm^2*
      (aa*((-2 + d)*mm^2 + 3*psq - d*psq - t) + bb*(-psq + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(-2 + d)^2*EL^5*gAl^5*mm^2*(bb*(2*mm^2 - s - 2*t) + 
    ...
    (I*2^(3 - 2*d)*EL^5*gAl^5*(bb*(d^2*(mm^2 - psq)*s + 
         2*(2*mm^2 - 2*psq - s)*s + d*s*(4*psq + s) - 
         2*d*mm^2*(2*psq + s - 2*t)) + aa*(2*s^2 - d*s^2 + 
    ...
    (I*4^(1 - d)*(-2 + d)^2*EL^5*gAl^5*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[q1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl^5*
