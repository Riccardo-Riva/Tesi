...
PropList[KiraPropagator[p1 - q1, 0], KiraPropagator[-p2 - q1, 0]]*
 (((-I)*2^(-1 - d)*EL^6*gAl*gAu*gZNL^2*
    ...
    \[Mu]^(4 - d)*SPList[SP[p1, p2]])/(Pi^d*(mz^2 - s)^2*s) + 
  ...
  ((I/2)*EL^6*gAl*gAu*gZNL^2*
    ((2^(1 - d)*(-(gZlR*gZuL*((-4 + d)^2*s^2 + 2*(10 - 7*d + d^2)*s*t - 
           4*t^2)) - gZlL*gZuR*((-4 + d)^2*s^2 + 2*(10 - 7*d + d^2)*s*t - 
          4*t^2) + gZlL*gZuL*((8 - 6*d + d^2)*s^2 + 2*(14 - 7*d + d^2)*s*t + 
          4*t^2) + gZlR*gZuR*((8 - 6*d + d^2)*s^2 + 2*(14 - 7*d + d^2)*s*t + 
          4*t^2)))/Pi^d - (gZlL*gZuR*((-32 + 20*d - 3*d^2)*s^2 - 
         ...
         2*(-2 - 3*d + d^2)*s*t + 4*t^2))/(2*Pi)^d)*\[Mu]^(4 - d)*
  ...
  (I*2^(-1 - d)*EL^6*gAl*gAu*gZNL^2*
    (gZlL*gZuL*((8 - 6*d + d^2)*s^2 - 2*(14 - 7*d + d^2)*s*t - 4*t^2) + 
     ...
     gZlL*gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) - 
     gZlR*gZuR*((16 - 14*d + 3*d^2)*s^2 + 2*(2 - 3*d + d^2)*s*t + 4*t^2))*
    \[Mu]^(4 - d)*SPList[SP[p2, q1]])/(Pi^d*(mz^2 - s)^2*s) - 
  (I*(-3 + d)*EL^6*gAl*gAu*gZNL^2*
    (gZlL*((-2 + d)*gZuL*s + (-4 + d)*gZuR*s + 2*gZuL*t - 2*gZuR*t) - 
     gZlR*((-4 + d)*gZuL*s + (-2 + d)*gZuR*s - 2*gZuL*t + 2*gZuR*t))*
  ...
  (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*gZNL^2*(gZuL + gZuR)*\[Mu]^(4 - d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^d*(mz^2 - s)^2) + 
  (I*2^(1 - d)*EL^6*gAl*gAu*gZNL^2*(d*gZlR*(gZuL - gZuR)*s + 
  ...
  (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*gZNL^2*(gZuL + gZuR)*\[Mu]^(4 - d)*
