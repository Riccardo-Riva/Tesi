...
PropList[KiraPropagator[q1, mh], KiraPropagator[-p3 + q1, mm], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
    (aa*mm^2*(2*psq - s - 2*t) + aa*psq*(psq - t) + bb*psq*(-psq + s + t) + 
     bb*mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^4*(10*psq - s - 10*t) + mm^2*(-10*psq^2 + 25*psq*s - 13*s^2 + 
         10*psq*t - 18*s*t) + psq*(-8*psq^2 + 4*psq*s + s^2 + 8*psq*t - 
         6*s*t)) + bb*(mm^4*(-10*psq + 9*s + 10*t) + 
       mm^2*(10*psq^2 - 21*psq*s + 5*s^2 - 10*psq*t + 18*s*t) + 
       psq*(8*psq^2 - 8*psq*(2*s + t) + s*(7*s + 6*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(bb*(mm^4*(-5*psq + 8*s + 5*t) + 
       psq*(4*psq^2 - 11*psq*s + 6*s^2 - 4*psq*t + 5*s*t) + 
       mm^2*(5*psq^2 - 17*psq*s + 2*s^2 - 5*psq*t + 15*s*t)) + 
     aa*(mm^4*(5*psq - 2*s - 5*t) + psq*(-4*psq^2 + 5*psq*s + 2*s^2 + 
         4*psq*t - 5*s*t) + mm^2*(-5*psq^2 - 5*s*(2*s + 3*t) + 
         psq*(17*s + 5*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*bb*psq*s*(-2*psq + s) + aa*mm^4*(4*psq - 3*s - 4*t) + 
     bb*mm^4*(-4*psq + 5*s + 4*t) + aa*mm^2*s*(-7*psq + 4*s + 6*t) - 
     3*bb*mm^2*s*(-3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^4*(5*psq - 3*s - 5*t) + mm^2*(-5*psq^2 + 12*psq*s - 5*s^2 + 
         5*psq*t - 9*s*t) + psq*(-4*psq^2 + 3*psq*s + s^2 + 4*psq*t - 
         3*s*t)) + bb*(mm^4*(-5*psq + 7*s + 5*t) + 
       psq*(4*psq^2 + 3*s*(s + t) - psq*(9*s + 4*t)) + 
       mm^2*(5*psq^2 - 5*psq*(2*s + t) + s*(s + 9*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(mm^4*(5*psq + 3*s - 5*t) + 
       mm^2*(-5*psq^2 + 18*psq*s - 13*s^2 + 5*psq*t - 15*s*t) + 
       psq*(-4*psq^2 + 3*psq*s + s^2 + 4*psq*t - 5*s*t)) + 
     bb*(mm^4*(-5*psq + 3*s + 5*t) + psq*(4*psq^2 - 9*psq*s + 7*s^2 - 
         4*psq*t + 5*s*t) + mm^2*(5*psq^2 + 5*s*(s + 3*t) - 
         psq*(18*s + 5*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*aa*psq*s*(-2*psq + s) + aa*mm^4*(4*psq + s - 4*t) - 
     3*aa*mm^2*s*(psq - 2*t) + bb*mm^4*(-4*psq + s + 4*t) + 
     bb*mm^2*s*(5*psq - 2*(s + 3*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^4*(5*psq + 2*s - 5*t) + mm^2*(-5*psq^2 + 13*psq*s - 8*s^2 + 
         5*psq*t - 9*s*t) + psq*(-4*psq^2 + psq*s + 4*psq*t - 3*s*t)) + 
     bb*(mm^4*(-5*psq + 2*s + 5*t) + psq*(4*psq^2 - 7*psq*s + 4*s^2 - 
         4*psq*t + 3*s*t) + mm^2*(5*psq^2 - 11*psq*s + 4*s^2 - 5*psq*t + 
         9*s*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
    (bb*(mm^2 + 2*psq - 2*s - 2*t) + aa*(mm^2 - 2*psq + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*s*(aa*(mm^4 + mm^2*(5*psq - 5*s - 6*t) + 
       psq*(2*psq + s - 2*t)) + bb*(mm^4 + psq*(-2*psq + 3*s + 2*t) + 
       mm^2*(-7*psq + s + 6*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
    ...
    SPList[SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(mm^4 + mm^2*(6*psq - 4*s - 6*t) + 
       psq*(psq - 2*t)) + bb*(mm^4 + mm^2*(-6*psq + 2*s + 6*t) + 
       psq*(-3*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 + mm^2*(30*psq - 19*s - 30*t) + psq*(8*psq - s - 10*t)) + 
     bb*(6*mm^4 + psq*(-16*psq + 9*s + 10*t) + mm^2*(-30*psq + 11*s + 30*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^4 - 6*psq*s + 4*s*(s + t) + mm^2*(-3*psq - 2*s + 2*t)) + 
     bb*(3*mm^4 - 8*psq^2 + 14*psq*s - 4*s*(s + t) + 
       mm^2*(7*psq - 2*(3*s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 + mm^2*(18*psq - 11*s - 18*t) + psq*(4*psq - s - 6*t)) + 
     bb*(6*mm^4 + psq*(-12*psq + 5*s + 6*t) + mm^2*(-18*psq + 7*s + 18*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(6*mm^4 + mm^2*(30*psq - 19*s - 30*t) + psq*(4*psq - s - 10*t)) + 
     bb*(2*mm^4 + psq*(-12*psq + 9*s + 10*t) + mm^2*(-30*psq + 11*s + 30*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(mm^4 + 2*s*(psq - 2*t) + mm^2*(psq - 4*s - 2*t)) + 
     aa*(3*mm^4 - 8*psq^2 + 6*psq*s + 4*s*t + mm^2*(3*psq - 4*s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(6*mm^4 + mm^2*(18*psq - 11*s - 18*t) - psq*(s + 6*t)) + 
     bb*(2*mm^4 + psq*(-8*psq + 5*s + 6*t) + mm^2*(-18*psq + 7*s + 18*t)))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - 2*psq + 3*s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^2 + psq)*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^4 + psq*(-5*psq + 2*s + 3*t) + mm^2*(-9*psq + 6*s + 9*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(mm^4 - 2*psq^2 + 5*psq*s - mm^2*(psq - 2*t) - 2*s*(s + t)) + 
     aa*(-3*psq*s + 2*mm^2*(psq - s - t) + 2*s*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^2 + psq)*(4*psq - 3*s - 4*t) + 
     bb*(4*mm^4 + psq*(-8*psq + 3*s + 4*t) + mm^2*(-12*psq + 9*s + 12*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 + psq*(4*psq - 3*s - 6*t) + 9*mm^2*(2*psq - s - 2*t)) + 
     bb*(2*mm^4 + 9*mm^2*(-2*psq + s + 2*t) + psq*(-8*psq + 3*s + 6*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^4 - 4*psq^2 + 2*psq*s + mm^2*(7*psq - 2*s - 4*t) + 4*s*t) + 
     bb*(mm^4 + 2*s*(psq - 2*t) + mm^2*(-5*psq - 2*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^4 + mm^2*(6*psq - 3*s - 6*t) + psq*(psq - s - 2*t)) + 
     bb*(mm^4 + psq*(-3*psq + s + 2*t) + mm^2*(-6*psq + 3*s + 6*t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(-2*psq^2 + 5*psq*s - 2*s^2 + mm^2*(psq - t) + 2*psq*t - 5*s*t) + 
     aa*(2*psq^2 - 7*psq*s + 2*s^2 - 2*psq*t + 5*s*t + 
       mm^2*(-psq + 2*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p3, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(mm^2*(3*psq - s - 3*t) + psq*(psq - 3*s - t)) - 
     bb*(mm^2*(3*psq - 5*s - 3*t) + psq*(psq + s - t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ((aa + bb)*(mm^2 - psq)*s - (aa - bb)*(mm^2 + psq)*(2*psq - s - 2*t))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^2*(psq - s - t) + 2*s*(-2*psq + s + t)) + 
     bb*(2*mm^4 - 4*psq^2 + 6*psq*s - 2*s*(s + t) + mm^2*(-psq + s + 3*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^4 - 6*psq*s + mm^2*(3*psq - 6*s - 4*t) + 4*s*(s + t)) + 
     bb*(mm^4 - 4*psq^2 + 10*psq*s - 4*s*(s + t) + mm^2*(-psq + 2*s + 4*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(mm^4 - 4*psq^2 + 6*psq*s + 3*mm^2*(s + t) - 2*s*(s + t)) + 
     aa*(mm^4 + mm^2*(2*psq - 5*s - 3*t) + 2*s*(-2*psq + s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(aa*psq*s) - bb*psq*s + aa*mm^2*(4*psq - 3*s - 4*t) + 
     bb*mm^2*(-4*psq + 5*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-3*psq*s + mm^2*(5*psq - 4*s - 5*t) + 2*s*(s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^2 + psq)*(psq - s - t) + bb*(2*mm^4 + psq*(-3*psq + s + t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^4 - 4*psq^2 + 2*psq*s + mm^2*(6*psq - 3*t) + 2*s*t) + 
     bb*(mm^4 - 2*s*t + mm^2*(-4*psq - 2*s + 3*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 + mm^2*(6*psq - 3*s - 6*t) - psq*(s + 2*t)) + 
     bb*(2*mm^4 + psq*(-4*psq + s + 2*t) + mm^2*(-6*psq + 3*s + 6*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*((aa + bb)*(mm^2 - psq)*s - 
     (aa - bb)*(3*mm^2 + psq)*(psq - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, p3]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*psq^2 - 5*psq*s + s^2 - 2*psq*t + 3*s*t + mm^2*(-psq + 2*s + t)) + 
     bb*(-2*psq^2 + mm^2*(psq - t) + psq*(3*s + 2*t) - s*(s + 3*t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 + mm^2*(9*psq - 3*s - 9*t) + psq*(psq - s - 3*t)) - 
     bb*(3*mm^2 + psq)*(3*psq - s - 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(s*(psq - 2*t) - 2*mm^2*(psq - t)) + 
     aa*(mm^4 - 2*psq^2 + psq*s + 2*s*t + mm^2*(3*psq - 2*(s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(3*mm^2 + psq)*(4*psq - s - 4*t)) + 
     aa*(4*mm^4 + 3*mm^2*(4*psq - s - 4*t) - psq*(s + 4*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(-2*psq^2 + 5*psq*s - 3*s^2 + mm^2*(psq + s - t) + 2*psq*t - 5*s*t) + 
     aa*(2*psq^2 - 7*psq*s + 3*s^2 - 2*psq*t + 5*s*t + mm^2*(-psq + s + t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(-3*mm^2*(psq - t) - 2*s*t) + aa*(2*mm^4 - 4*psq^2 + 2*psq*s + 
       mm^2*(5*psq - 2*s - 3*t) + 2*s*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(aa*psq*s) - bb*psq*s + aa*mm^2*(4*psq + s - 4*t) + 
     bb*mm^2*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2*(5*psq - s - 5*t) - s*(psq - 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(3*mm^2 + psq)*(psq - t)) + aa*(2*mm^4 + 3*mm^2*(psq - t) - 
       psq*(psq + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
   Pi^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ((aa + bb)*(mm^2 - psq)*s - (aa - bb)*(3*mm^2 + psq)*(psq - s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(-2*psq^2 + 5*psq*s - 2*s^2 + mm^2*(psq - s - t) + 
       2*psq*t - 3*s*t) + bb*(2*psq^2 - 3*psq*s + 2*s^2 - 
       mm^2*(psq + s - t) - 2*psq*t + 3*s*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(mm^2 + 3*psq - 2*(s + t)) + 
     bb*(3*mm^2 - 7*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^2 - 3*psq - 2*t) + bb*(mm^2 - psq + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^2 - 3*psq - t) + bb*(mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  ((3*I)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
     bb*(6*mm^2 - 10*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*aa*mm^2 - 3*aa*psq - bb*psq - 2*aa*t + 2*bb*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^2 - 2*psq - t) + bb*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*bb*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-3*psq + 2*s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(3*psq - 2*s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/
   Pi^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(psq - s - t) + bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^2 - 3*psq) + 2*bb*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(4*psq - 3*s - 4*t)*
  ...
  ((3*I)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - 3*psq + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(mm^2 + psq - 2*t) + bb*(mm^2 - 3*psq + 2*t))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[p3, q2]])/
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (gZlL - gZlR)*mm^2*(bb*(mm^2 - 2*psq) + aa*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*psq*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 + psq - 2*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(mm^2 + psq - 2*(s + t)) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - s - t)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - 2*psq + t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], SP[p3, q1]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*aa*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(-3*psq + s + 3*t)*
  ...
  (I*2^(1 - 2*d)*aa*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(4*psq - s - 4*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3], SP[p3, q1]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3], SP[p3, q1]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
