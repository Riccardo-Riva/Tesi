  ...
  PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, mz], 
   ...
   (((-I/16)*EL^6*gAl*gAu*gXll*gXuu*mm^2*mu^2*
    ...
    ((I/4)*EL^6*gAl*gAu*gXll*gXuu*mm^2*mu^2*
      ((-2 + d)*(gZlR*(-(gZuR*mu^2) + (-4 + d)*gZuR*s + 
           gZuL*(mu^2 + (-2 + d)*s)) + gZlL*(-(gZuL*mu^2) + (-4 + d)*gZuL*s + 
           gZuR*(mu^2 + (-2 + d)*s))) - ((gZlL - gZlR)*(gZuL - gZuR)*
         (mu^2 - s)*(-mm^2 + s + t))/mz^2)*SPList[SP[p1, q1]])/(Pi^4*s) + 
    ((I/4)*EL^6*gAl*gAu*gXll*gXuu*mm^2*mu^2*
      (gZlR*gZuL*(4*mm^2 - (-2 + d)*mu^2 + 4*s - 6*d*s + d^2*s - 4*t) + 
       gZlL*gZuR*(4*mm^2 - (-2 + d)*mu^2 + 4*s - 6*d*s + d^2*s - 4*t) + 
       gZlL*gZuL*(-4*mm^2 + (-2 + d)*mu^2 + 8*s - 4*d*s + d^2*s + 4*t) + 
       gZlR*gZuR*(-4*mm^2 + (-2 + d)*mu^2 + 8*s - 4*d*s + d^2*s + 4*t) + 
