...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*psq*s*
  ...
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*((-2 + d)*mm^2 + 2*s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*
    gWNl*mm^2*s*(bb*mm^2*(-2*psq + s) + bb*psq*(3*psq - 2*s - t) + 
     aa*(-psq^2 + mm^2*s + psq*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    ...
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*
    mm^2*s*((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
   ...
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    ...
    SPList[SP[p2, q2]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*
    mm^2*s*(bb*psq*(4*psq - 3*s - 4*t) + 2*bb*mm^2*(psq - t) + 
     2*aa*mm^2*(-psq + s + t) + aa*psq*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*((-2 + d)*mm^2 + 2*s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
    (aa*psq*(psq - t) + aa*mm^2*(psq - s - t) + bb*mm^2*(-psq + t) + 
     bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*
    gWNl*mm^2*(mm^2 + psq)*s*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*((-2 + d)*mm^2 + 2*s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(-6*aa*(-2 + d)*psq^2 + 
     bb*(-2 + d)*mm^2*(6*psq - s - 4*t) + 2*aa*s*(s + 4*t) + 
     aa*(-2 + d)*mm^2*(2*psq + s + 4*t) - 
     2*bb*((-2 + d)*psq^2 + s*(s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(aa*mm^2*(2*psq - 3*s - 2*t) - 
     bb*mm^2*(2*psq + s - 2*t) + 4*aa*psq*(psq - t) + 
     4*bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(mm^2 + psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) - (I*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    ((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/Pi^(2*d) - 
  (I*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*(-2*psq + s + 2*t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*
    gWNl*mm^2*(bb*mm^2*(2*psq - s) + bb*psq*(-3*psq + 2*s + t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    ((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    (aa*(2*(-2 + d)*mm^2*psq - (-2 + d)*psq^2 + 2*s^2 - (-2 + d)*psq*t) + 
     ...
     SP[p2, q1]])/Pi^(2*d) - (I/2)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*(-2*psq + s + 2*t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*
    gWNl*mm^2*(aa*(mm^2*(-2*psq + s) + psq*(psq - s + t)) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
   Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*
    gFll^2*gWlN*gWNl*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*
  ...
  (I*4^(1 - d)*(aa + bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
   ...
   Pi^(2*d) - (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(2*psq - s - 2*t)*
  ...
  ((3*I)*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(aa*(psq - s - t) + 
  ...
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(aa*(2*mm^2 - psq - t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*((-2 + d)*mm^2 - 
     (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*((-2 + d)*mm^2 - 
     ...
     SP[p2, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*
  ...
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(aa*(2*mm^2 - psq - t) + 
    ...
    gFFA*gFll^2*gWlN*gWNl*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[q1, q2]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*
    mm^2*(-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
