...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((d*EL^5*gAl*gFll^2*gZlR*gZNL*mm^4*s*(-2*aa*psq^2 + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZNL*mm^2*
     (bb*psq*(-2*(-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*(mm^2 - s)) + 
      aa*mm^2*(2*(-2 + d)*gZlL*psq + (-4 + d)*gZlR*(mm^2 - s)))*s*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZNL*mm^2*
     (aa*(d*gZlL*mm^2*(-4*psq + 3*s) + 2*mm^2*(4*gZlL*psq - 3*gZlL*s + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(aa*d*psq*(mm^2 + psq) - 
      bb*d*psq*(mm^2 + psq) - 2*aa*mm^2*s + 2*bb*psq*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZNL*mm^2*
     (aa*((-2 + d)*gZlL*mm^2*(4*psq - s) + 4*gZlR*(mm^2 - psq)*s + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
     (bb*psq*(d*(mm^2 + psq - s) + 2*s) - aa*(d*(psq^2 + mm^2*(psq - s)) + 
        2*mm^2*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*mm^2 - aa*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(aa*mm^2 - bb*psq)*s*
