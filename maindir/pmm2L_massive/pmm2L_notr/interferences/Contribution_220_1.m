...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (-((EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq + s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq + s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   (Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*
    mm^2*(-mm^2 + psq + 2*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q1]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*
    gXll*(gZlL - gZlR)*mm^2*sw*(4*mm^2 - 2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s) - 
  (3*4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (Pi^(2*d)*s) - (3*4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (-6*psq + 7*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   (Pi^(2*d)*s^2) - (3*4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/
   (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*(2*mm^2 - 8*psq - s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*(-psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (Pi^(2*d)*s) - (3*4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*
    gXll*(gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*
