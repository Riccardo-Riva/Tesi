...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 - q2, 0], 
 ...
 ((3*4^(1 - d)*EL^8*gAl^4*gAu^4*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-10 + 3*d)*s^2 + 4*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*t*(s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-2 + d)*s^2 + (-2 + d)*s*t + 
     2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-2 + d)*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*(3*(-2 + d)*s^2 + 8*s*t + 4*t^2)*
  ...
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-2 + d)*s^2 + (-2 + d)*s*t + 
   ...
   (Pi^(2*d)*s^2) + (3*2^(5 - 2*d)*(-3 + d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-5 + 2*d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-8 + 3*d)*s^2 + 4*(-4 + d)*s*t + 
   ...
   (Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*
    ((-6 + d)*s^2 + 4*(-4 + d)*s*t + 4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*((12 - 8*d + d^2)*s^2 + 4*(-4 + d)*s*t + 
   ...
   (Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^4*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*((-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(3 - d)*EL^8*gAl^4*gAu^4*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^4*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
  ...
  (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*((-6 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^4*t*\[Mu]^(8 - 2*d)*
