...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  ((EL^5*gAl*gHll^2*mm^4*s*
     ...
     (2*aa*s*(gZlL^2*(mm^2 - 2*psq) + gZlR^2*(mm^2 - 2*psq) + 
        2*gZlL*gZlR*s) - 2*bb*s*(gZlL^2*(-2*mm^2 + psq) + 
        gZlR^2*(-2*mm^2 + psq) + 2*gZlL*gZlR*s) - 
      aa*d*(gZlL^2*(mm^2 - 2*psq)*s + gZlR^2*(mm^2 - 2*psq)*s + 
        2*gZlL*gZlR*(mm^2*(-4*psq + s) + s*(-2*psq + s))) + 
      bb*d*(gZlL^2*(-2*mm^2 + psq)*s + gZlR^2*(-2*mm^2 + psq)*s + 
        2*gZlL*gZlR*(mm^2*(-4*psq + s) + s*(-2*psq + s))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^4*
     (2*aa*s*(3*gZlL^2*psq + 3*gZlR^2*psq - 2*gZlL*gZlR*s) + 
      2*bb*s*(-3*gZlL^2*mm^2 - 3*gZlR^2*mm^2 + 2*gZlL*gZlR*s) + 
      bb*d*(3*gZlL^2*mm^2*s + 3*gZlR^2*mm^2*s + 2*gZlL*gZlR*
         (mm^2*(4*psq - s) + (2*psq - s)*s)) - 
      aa*d*(3*gZlL^2*psq*s + 3*gZlR^2*psq*s + 2*gZlL*gZlR*
         (mm^2*(4*psq - s) + (2*psq - s)*s)))*\[Mu]^(8 - 2*d)*
   ...
   (EL^5*gAl*gHll^2*mm^4*s*(bb*((-2 + d)*gZlL^2*(mm^2 - psq) + 
    ...
    (2*Pi)^(2*d) + (EL^5*gAl*gHll^2*mm^4*s*
     (aa*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
     (-4*(-4 + d)*gZlL*gZlR*mm^2*s + (-2 + d)*gZlL^2*(mm^2 + psq)*
       (4*mm^2 + s) + (-2 + d)*gZlR^2*(mm^2 + psq)*(4*mm^2 + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*(2*aa*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s + 
