...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 ((I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^6*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*mm^2*(5*psq - 4*s - 5*t) + 3*aa*psq*(psq - t) + 
     bb*psq*(-3*psq + 2*s + 3*t) + bb*mm^2*(-5*psq + 2*s + 5*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*(3*mm^2 + psq)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^6*((aa + bb)*(mm^2 - psq)*s - 
     (aa - bb)*(mm^2*(5*psq - 2*s - 5*t) + psq*(3*psq - 2*s - 3*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(3*mm^4 - 2*mm^2*psq - 
     psq^2)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa + bb)*EL^5*gAl*gHll^4*mm^6*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*(aa*(mm^2 - t) + 
   ...
   Pi^(2*d) + (I*EL^5*gAl*gHll^4*mm^4*(aa*mm^2*(7*psq - 4*s - 7*t) + 
  ...
  (I*EL^5*gAl*gHll^4*mm^4*((aa + bb)*(mm^2 - psq)*s - 
     (aa - bb)*(3*mm^2 + psq)*(2*psq - s - 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*(aa*(mm^2 - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p2, q1]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*
    mm^4*(mm^2 + psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(3*mm^2 + psq)*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^6*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*
    (3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
   Pi^(2*d) - (I*EL^5*gAl*gHll^4*mm^4*((aa + bb)*(mm^2 - psq)*s - 
     (aa - bb)*(mm^2*(7*psq - 4*s - 7*t) + psq*(psq - t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 + psq)*(psq - t)*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 - t) + bb*(mm^2 - 2*psq + t))*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*
