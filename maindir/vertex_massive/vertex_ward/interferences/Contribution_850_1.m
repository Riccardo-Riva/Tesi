...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, mm]]*((I*2^(1 - 2*d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
       mm^4*(mm^2 - psq)*s*(aa*(psq - s - t) + bb*(-psq + t))*
     ...
     (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
       mm^4*(-2*bb*mm^2*(psq - t) + aa*s*(psq - t) + 
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*(psq - t)*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*
       (gZlL + gZlR)^2*mm^4*(bb*(mm^2 - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
