...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (-((4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(2*mu^2 + s)*
      SPList[SP[q1, q2]])/(Pi^(2*d)*s)) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(s + t)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(s + t)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(2*mu^2 + s)*
     SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(2*mu^2 + s)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*t*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(mu^2 + s + t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(mu^2 - t)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(mu^2 - t)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(4*mu^2 + s - 2*t)*
     SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(2*mu^2 + s)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(2*mu^2 + s)*
     SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(2*mu^2 + s)*
     SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*
