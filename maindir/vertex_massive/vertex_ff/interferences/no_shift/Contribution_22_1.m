...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(mm^2 - psq)*(psq - s - t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq - t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(-4*psq^3 + mm^2*s^2 + 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(-psq + s + t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - 2*psq + s + t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq^2 + mm^2*s + t*(s + t) - 
      psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*
     (-2*psq^2 + mm^2*(psq - t) + 3*psq*t - t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - 2*psq + s + t)*(-psq + s + t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2*(psq + s - t) - 
