...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(3*mm^2 + psq - 2*s)*
       (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
        t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*((16 - 6*d)*psq^3 + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((2 + d)*psq^4 + 
       2*psq^3*((-8 + d)*s - (4 + d)*t) - 4*psq*t*(5*s^2 + 8*s*t + t^2) + 
       4*s*t*(s^2 + 3*s*t + 2*t^2) + psq^2*(-((-6 + d)*s^2) + 36*s*t + 
         (10 + d)*t^2) + mm^4*((-6 + d)*psq^2 - (s + t)*(d*s + 6*t - d*t) + 
         2*psq*(s + d*s + 6*t - d*t)) - 2*mm^2*((-10 + d)*psq^3 + 
         psq^2*(s + 2*d*s - 2*(-13 + d)*t) + 2*t*(s^2 + 4*s*t + 3*t^2) + 
         psq*(-((-1 + d)*s^2) - 13*s*t + (-22 + d)*t^2)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(-2*(-8 + d)*psq^3 + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((2 + d)*psq^4 - 
       ...
       4*s*t*(s^2 + 3*s*t + 2*t^2) + psq^2*(4*s^2 + (26 + d)*s*t + 
         (10 + d)*t^2) + mm^4*(psq - t)*((2 + d)*psq - 2*t - d*(s + t)) - 
       2*mm^2*((-6 + d)*psq^3 + psq*t*((-15 + d)*s + (-18 + d)*t) + 
         psq^2*(-((-5 + d)*s) - 2*(-9 + d)*t) + 2*t*(2*s^2 + 5*s*t + 3*t^2)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(-2*psq + s + 2*t)*
      (4*psq^2 + (4 + d)*mm^2*s + 4*t*(s + t) - psq*((-4 + d)*s + 8*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (mm^4*s*(-((2 + d)*psq) + 2*t + d*(s + t)) + 
       s*(-((-10 + d)*psq^3) + 8*psq*t*(2*s + 3*t) + 
         psq^2*((-6 + d)*s + (-26 + d)*t) - 4*t*(s^2 + 3*s*t + 2*t^2)) - 
       2*mm^2*(8*psq^3 - psq^2*((4 + d)*s + 24*t) - 
         4*t*(s^2 + 3*s*t + 2*t^2) + psq*((-1 + d)*s^2 + (16 + d)*s*t + 
           24*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*(-1 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(4*(-2 + d)*mm^2 - 
       4*(-3 + d)*psq - 4*s + d*s - 4*t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(4*(-3 + d)*psq^3 + 
       2*(-2 + d)*mm^4*(psq - s - t) + 4*t^2*(s + t) - 
       3*psq^2*((-2 + d)*s + 2*(-4 + d)*t) + 
       psq*((-2 + d)*s^2 + (-10 + 3*d)*s*t + 2*(-8 + d)*t^2) - 
       mm^2*(2*psq - s - 2*t)*((-8 + 3*d)*psq - (-4 + d)*(s + t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(4*(-2 + d)*psq^2 - 
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (-((-2 + d)*psq^3) - (-2 + d)*mm^4*(psq - t) - 4*s^2*t + 4*t^3 + 
       psq^2*(4*(-3 + d)*s + (2 + d)*t) - psq*((-2 + d)*s^2 + (-10 + d)*s*t + 
         8*t^2) + mm^2*(2*(2 + d)*psq^2 + (2 + d)*s^2 + (8 + d)*s*t + 8*t^2 - 
         2*psq*((3 + 2*d)*s + (6 + d)*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*(-4 + d)*psq^2 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-3*(-2 + d)*psq^3 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)*(-4*psq + d*s + 4*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-2*psq^3 - mm^2*(2*psq - s - 2*t)*
        (psq - t) - 6*psq*t*(s + t) + 2*t*(s + t)^2 + 2*psq^2*(s + 3*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*(-4 + d)*psq^2 + 16*psq*t - 
       8*t^2 - d*psq*(s + 4*t) + d*(s^2 + s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-((-2 + d)*psq^3) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-4*(-2 + d)*psq^3 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (d*(mm^2 - psq)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
       2*(2*t^2*(s + t) + psq^2*(-3*s + 2*t) + mm^2*s*(-2*psq + s + 2*t) + 
         psq*(s^2 + s*t - 4*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      ((6 - 5*d)*psq^3 + psq*t*((14 - 9*d)*s + (14 - 13*d)*t) + 
       2*t*(s + t)*((-2 + d)*s + 2*(-1 + d)*t) + 
       psq^2*(3*(-2 + d)*s + 2*(-8 + 7*d)*t) + mm^2*(psq - t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-((-2 + d)*psq*(psq - s - t)) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*psq - s - 2*t)*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((14 - 5*d)*psq^2 + 
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((-10 + 3*d)*psq^2 - 2*s^2 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-4*psq^2 + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (-psq + s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      gXll^2*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      gXll^2*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*
      mm^2*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[p3, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      gXll^2*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*
