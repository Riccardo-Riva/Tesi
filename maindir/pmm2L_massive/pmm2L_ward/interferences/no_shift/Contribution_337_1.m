...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  (((-I)*EL^5*gFFA*gFll^2*gZNL*mm^2*s*
   ...
   (I*EL^5*gFFA*gFll^2*gZNL*mm^2*s*(4*aa*gZlR*(mm^2 - psq)*s + 
   ...
   (I*4^(1 - d)*EL^5*gFFA*gFll^2*gZNL*mm^2*
     (aa*(-2 + d)*gZlL*mm^2*(2*psq - s - 2*t) - bb*(-2 + d)*gZlL*mm^2*
       (2*psq - s - 2*t) + aa*gZlR*(-((2 + d)*psq^2) + 11*psq*s + 
        ...
        mm^2*((-2 + d)*psq - 2*s + 2*t - d*t) - psq*((3 + d)*s + (2 + d)*t)))*
   ...
   (I*4^(1 - d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(bb*(2*s + d*(psq - s - t)) + 
      aa*((-4 + d)*mm^2 + 4*psq - 2*d*psq - 2*s + d*s + d*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*d*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*psq - s - 2*t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFFA*
     gFll^2*gZlR*gZNL*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gFFA*gFll^2*gZNL*mm^2*(aa*(-2 + d)*gZlL*mm^2 - 
      bb*(-2 + d)*gZlL*mm^2 + bb*d*gZlR*mm^2 - 2*bb*gZlR*(psq + t) + 
      aa*gZlR*(-((-4 + d)*mm^2) - 2*psq + 2*t))*\[Mu]^(8 - 2*d)*
