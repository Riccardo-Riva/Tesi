...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*EL^5*gAl^3*mm^2*s*(bb*((-2 + d)*gZlL^2*mm^2*((-2 + d)*mm^2 + 
           (2 - 3*d)*psq + d*(s + 2*t)) + (-2 + d)*gZlR^2*mm^2*
          ((-2 + d)*mm^2 + (2 - 3*d)*psq + d*(s + 2*t)) + 
    ...
    (I*EL^5*gAl^3*mm^2*
      (aa*(4*(gZlL^2*(2*Pi)^(2*d)*s*(2*mm^2 - 3*psq + s + t) + 
          ...
          (gZlL*gZlR*(-6*psq^2 + 11*psq*s + s^2 - 2*mm^2*(5*psq + 4*s - 5*
                t) + 6*psq*t + s*t) + gZlL^2*(mm^2*(2*psq + s - 2*t) + 
     ...
     (2*Pi)^(4*d) + (I*EL^5*gAl^3*mm^2*
      (4^d*bb*Pi^(2*d)*(4*(gZlL^2*s*(2*mm^2 - psq - t) + 
         ...
         4*d*(gZlL*gZlR*(-6*psq^2 - 7*psq*s - 2*mm^2*(5*psq - 9*s - 5*t) + 
             ...
             s*(psq + t)) + gZlR^2*(mm^2*(2*psq - 3*s - 2*t) + 
             s*(psq + t))) - d^2*(-4*gZlL*gZlR*(mm^2*(2*psq - 3*s - 2*t) + 
             psq*(psq + s - t)) + gZlL^2*(4*mm^2*(psq - s - t) + 
             s*(psq + t)) + gZlR^2*(4*mm^2*(psq - s - t) + s*(psq + t)))) + 
    ...
    (I*EL^5*gAl^3*mm^2*(aa*(-(4^(1 + d)*d*gZlL*gZlR*Pi^(2*d)*(2*mm^2 + s)*
         ...
         gZlR^2*(2*Pi)^(2*d)*((16 - 10*d + d^2)*psq^2 + 4*(-3 + d)*psq*s + 
           ...
           2*(14 - 8*d + d^2)*s*t)) + bb*(4^(1 + d)*d*gZlL*gZlR*Pi^(2*d)*
          (2*mm^2*(psq + s - t) - s*(psq + t)) + gZlL^2*(2*Pi)^(2*d)*
          (-((16 - 10*d + d^2)*psq^2) + 4*psq*s + (16 - 10*d + d^2)*psq*t + 
           2*(14 - 8*d + d^2)*s*t - (-2 + d)*mm^2*((-8 + d)*psq + 4*s + 8*t - 
             d*t)) + gZlR^2*(2*Pi)^(2*d)*(-((16 - 10*d + d^2)*psq^2) + 
           4*psq*s + (16 - 10*d + d^2)*psq*t + 2*(14 - 8*d + d^2)*s*t - 
           (-2 + d)*mm^2*((-8 + d)*psq + 4*s + 8*t - d*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/(2*Pi)^(4*d) - 
    (I*(aa - bb)*EL^5*gAl^3*((-2 + d)^2*gZlL^2 - 4*(4 - 5*d + d^2)*gZlL*
        gZlR + (-2 + d)^2*gZlR^2)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*EL^5*gAl^3*mm^2*s*(aa*(4*d*gZlL*gZlR*(-2*psq + s + 2*t) + 
       ...
       bb*(4*d*gZlL*gZlR*(2*psq - s - 2*t) + gZlL^2*((8 - 6*d + d^2)*mm^2 + 
         ...
         gZlR^2*((8 - 6*d + d^2)*mm^2 + (-48 + 30*d - 5*d^2)*psq + 
           2*(10 - 6*d + d^2)*(s + 2*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/(2*Pi)^(2*d) - 
    (I*(-2 + d)*EL^5*gAl^3*mm^2*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
    ...
    (I*2^(1 - 4*d)*EL^5*gAl^3*
      (bb*(-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*mm^2 - psq + s - t)) + 
         gZlL^2*(2*Pi)^(2*d)*((8 - 6*d + d^2)*mm^4 - (24 - 10*d + d^2)*psq*
            s + mm^2*(2*(16 - 9*d + d^2)*s - (8 - 6*d + d^2)*t)) + 
         gZlR^2*(2*Pi)^(2*d)*((8 - 6*d + d^2)*mm^4 - (24 - 10*d + d^2)*psq*
            s + mm^2*(2*(16 - 9*d + d^2)*s - (8 - 6*d + d^2)*t))) + 
     ...
     Pi^(4*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*((-2 + d)^2*gZlL^2 - 
       4*(4 - 5*d + d^2)*gZlL*gZlR + (-2 + d)^2*gZlR^2)*mm^2*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl^3*(bb*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
          (psq - 2*s - t) + gZlL^2*(2*Pi)^(2*d)*((16 - 10*d + d^2)*mm^4 - 
           (24 - 10*d + d^2)*psq*s + mm^2*(-2*(12 - 8*d + d^2)*psq + 
             (40 - 24*d + 3*d^2)*s + (8 - 6*d + d^2)*t)) + 
         gZlR^2*(2*Pi)^(2*d)*((16 - 10*d + d^2)*mm^4 - (24 - 10*d + d^2)*psq*
       ...
       SP[p2, q1]])/Pi^(4*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl^3*mm^2*
      (-(4^d*aa*((-2 + d)^2*gZlL^2 - 4*(-4 + d)*gZlL*gZlR + 
          (-2 + d)^2*gZlR^2)*Pi^(2*d)*(psq - t)) + 
    ...
    (I*EL^5*gAl^3*(bb*(8*d*gZlL*gZlR*mm^2*(psq - t) + 
