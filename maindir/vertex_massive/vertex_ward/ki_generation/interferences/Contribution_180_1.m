...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
  ...
  (2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
    ...
    (-(bb*(2*gZlL*gZlR*mm^2*(-4*psq + s) + gZlL^2*psq*(2*mm^2 + 2*psq + 
          3*s) + gZlR^2*psq*(2*mm^2 + 2*psq + 3*s))) + 
     aa*(2*gZlL*gZlR*mm^2*(-4*psq + s) + 
       gZlL^2*(2*psq^2 + mm^2*(2*psq + 3*s)) + 
       gZlR^2*(2*psq^2 + mm^2*(2*psq + 3*s))))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
  ...
  (EL^5*ggmgmA*ggmgmZ^2*(aa*(gZlL^2*(2*psq^2 + mm^2*(2*psq - 5*s)) + 
  ...
  (EL^5*ggmgmA*ggmgmZ^2*(aa*(-6*gZlL*gZlR*mm^2 + gZlL^2*(7*mm^2 + 4*psq) + 
  ...
  (3*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(aa*mm^2 - bb*psq)*s*
