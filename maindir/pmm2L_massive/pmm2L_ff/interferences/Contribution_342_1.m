...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^6*
    ...
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^4*(psq^3 - 3*psq^2*s + 
       mm^2*(3*psq - 2*s - 3*t)*(psq - t) - 2*s^2*t + 3*psq*(s - t)*t + 
       2*t^3)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
      (mm^4*s + psq*s*(psq - s - t) + mm^2*(psq^2 - 3*s^2 + psq*(s - 2*t) - 
         2*s*t + t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^4*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq^2 - 2*psq*t + 
    ...
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq*(3*psq - 2*s - 3*t) + 
       mm^2*(3*psq - s - 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(-3*psq^2 + mm^2*(psq - t) - 
       2*t*(s + t) + psq*(s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)*
      ...
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) - (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
      (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) - (3*2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*
      mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[p3, q1]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
    ...
    (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq^2 + mm^2*s + (s + t)^2 - 
     ...
     Pi^(2*d) - (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)^2*
