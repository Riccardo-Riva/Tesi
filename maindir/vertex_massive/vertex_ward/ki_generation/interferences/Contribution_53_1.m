...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[-q1, mm], 
 ...
 (-((EL^5*gAl^3*gHll^2*mm^4*s*(bb*((-2 + d)*mm^4 + s*((4 + d)*psq + 2*s) - 
        mm^2*((6 + d)*psq + (-6 + d)*s)) + 
      aa*((-2 + d)*mm^4 + ((-4 + d)*psq - 2*s)*s - 
        mm^2*((-10 + d)*psq + (6 + d)*s)))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) - 
  (4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*s*(2*mm^2 + 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (EL^5*gAl^3*gHll^2*mm^2*(-2*bb*s*(2*mm^4 + 5*mm^2*s + psq*s) + 
     bb*d*(mm^4*(8*psq - 2*s) + psq*s^2 + 3*mm^2*s*(-2*psq + s)) - 
     aa*d*(mm^4*(8*psq - 4*s) + psq*s^2 + mm^2*s*(-4*psq + 3*s)) + 
     2*aa*s*(4*mm^4 + psq*s + mm^2*(-2*psq + 5*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(2*Pi)^(2*d) + 
  (EL^5*gAl^3*gHll^2*mm^2*(aa*(-8*(-2 + d)*mm^4*psq + 2*(-6 + d)*mm^4*s + 
       (-2 + 3*d)*mm^2*(2*psq - s)*s - (-2 + d)*psq*s^2) + 
     bb*(4*(-2 + d)*mm^4*(2*psq - s) + (-2 + d)*psq*s^2 + 
       mm^2*s*(8*psq - 4*d*psq - 2*s + 3*d*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*s*(mm^2 + psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*s*
    ((2 + d)*mm^2 + (2 + d)*psq + d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   Pi^(2*d) + ((-2 + d)*EL^5*gAl^3*gHll^2*mm^2*s*
    (bb*(mm^4 + mm^2*(3*psq - 2*s) - psq*s) + 
     aa*(mm^4 + psq*s + mm^2*(-5*psq + 2*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/(2*Pi)^(2*d) + 
  ((-2 + d)*EL^5*gAl^3*gHll^2*mm^2*s*(bb*mm^2*(8*psq - 3*s) + aa*psq*s - 
     3*bb*psq*s + aa*mm^2*(-8*psq + 5*s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*(2*(2 + d)*mm^4 - 
     (-2 + d)*psq*s + mm^2*(2*(2 + d)*psq - (-6 + d)*s))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
    (2*aa*mm^4 + bb*mm^2*(2*psq - 3*s) + aa*psq*s - bb*psq*s + 
     aa*mm^2*(-4*psq + 3*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
   Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(2 - 3*d)*mm^2*s - 
     bb*(-2 + d)*psq*s - 2*aa*(mm^2 + psq)*s + 
     aa*d*(4*mm^4 + psq*s + mm^2*(-4*psq + 3*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 + psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*(2*(mm^2 + psq)*s + 
     d*(4*mm^4 - psq*s + mm^2*(4*psq + s)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*mm^2*(4*psq - 3*s) - 
