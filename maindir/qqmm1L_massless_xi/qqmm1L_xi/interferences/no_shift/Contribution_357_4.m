...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  ((I*2^(2 - d)*EL^6*gAl*gAu*gFFA^2*
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*gFFA^2*((-4 + d)*gZlLC*gZuLC - 
      (-2 + d)*gZlRC*gZuLC - (-2 + d)*gZlLC*gZuRC + (-4 + d)*gZlRC*gZuRC)*
     (s + t)*\[Mu]^(4 - d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^d*s^2*(-mzC^2 + s)) + (I*2^(3 - d)*EL^6*gAl*gAu*gFFA^2*
     (gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 2*(-3 + d)*gZuLC*t - 
        2*(-3 + d)*gZuRC*t) + gZlRC*(-((-4 + d)*gZuLC*s) + (-2 + d)*gZuRC*s - 
        2*(-3 + d)*gZuLC*t + 2*(-3 + d)*gZuRC*t))*\[Mu]^(4 - d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^d*s^2*(-mzC^2 + s)) + 
   (I*2^(3 - d)*EL^6*gAl*gAu*gFFA^2*(d*gZlRC*(gZuLC - gZuRC)*s + 
