...
{((I/16)*EL^2*gFFAA*FeynAmpDenominator[PropagatorDenominator[
 ...
 -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW]]*
    ...
    ((-I)*EL^2*gWWAA*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 3]] - 
     I*EL^2*gWWAA*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
     (2*I)*EL^2*gWWAA*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])*
    PolarizationVector[V[1], FourMomentum[Incoming, 1], Index[Lorentz, 1]]*
    Conjugate[PolarizationVector][V[1], FourMomentum[Outgoing, 1], 
     Index[Lorentz, 2]])/(16*Pi^4), 
 ...
 ((-I/16)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   Conjugate[PolarizationVector][V[1], FourMomentum[Outgoing, 1], 
    Index[Lorentz, 2]])/Pi^4, 
 ((-I/16)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MU], PropagatorDenominator[FourMomentum[Internal, 1] - 
   ...
   MatrixTrace[NonCommutative[MU + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    I*EL*gAu*NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
       ...
       DiracMatrix[Index[Lorentz, 1]], ChiralityProjector[1]]]*
   PolarizationVector[V[1], FourMomentum[Incoming, 1], Index[Lorentz, 1]]*
   SumOver[Index[Colour, 3], 3]*Conjugate[PolarizationVector][V[1], 
    FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/Pi^4, 
 ((-I/16)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MC], PropagatorDenominator[FourMomentum[Internal, 1] - 
 ...
 ((-I/16)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   SumOver[Index[Colour, 3], 3]*Conjugate[PolarizationVector][V[1], 
    FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/Pi^4, 
 ((-I/16)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MD], PropagatorDenominator[FourMomentum[Internal, 1] - 
   ...
   SumOver[Index[Colour, 3], 3]*Conjugate[PolarizationVector][V[1], 
    FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/Pi^4, 
 ((-I/16)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MS], PropagatorDenominator[FourMomentum[Internal, 1] - 
 ...
 ((I/16)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (I*EL*gFFA*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
   ...
   ((-I)*EL*gFFA*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]] + 
    I*EL*gFFA*FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 
        1], Index[Lorentz, 2]])*PolarizationVector[V[1], 
    FourMomentum[Incoming, 1], Index[Lorentz, 1]]*
   Conjugate[PolarizationVector][V[1], FourMomentum[Outgoing, 1], 
    Index[Lorentz, 2]])/Pi^4, 
 ((I/16)*EL^2*ggmgmA^2*FeynAmpDenominator[PropagatorDenominator[
   ...
   FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
    ...
    Index[Lorentz, 1]]*Conjugate[PolarizationVector][V[1], 
    FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/Pi^4, 
 ((I/16)*EL^2*ggpgpA^2*FeynAmpDenominator[PropagatorDenominator[
     FourMomentum[Internal, 1], MW], PropagatorDenominator[
     FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MW]]*
   FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
   FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
    ...
    Index[Lorentz, 1]]*Conjugate[PolarizationVector][V[1], 
    FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/Pi^4, 
 ((I/16)*EL^2*gFAW^2*FeynAmpDenominator[PropagatorDenominator[
     FourMomentum[Internal, 1], MW], PropagatorDenominator[
     FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MW]]*
