 ...
 ((2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (gZlL^2*(2*(-2 + d)*psq^2 + (4 + 2*d - d^2)*psq*s + 2*(-4 + d)*s^2 + 
       (-2 + d)*mm^2*(6*psq + (-8 + d)*s - 6*t) - 2*(-2 + d)*psq*t - 4*s*t) + 
     gZlR^2*(2*(-2 + d)*psq^2 + (4 + 2*d - d^2)*psq*s + 2*(-4 + d)*s^2 + 
       (-2 + d)*mm^2*(6*psq + (-8 + d)*s - 6*t) - 2*(-2 + d)*psq*t - 4*s*t) - 
     8*gZlL*gZlR*(2*psq^2 + s^2 + d*(mm^2 + psq)*(psq - s - t) + 3*s*t + 
   ...
   (4^d*Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (8*gZlL*gZlR*(-2*psq^2 - psq*(s - 4*t) + d*(mm^2 + psq)*(psq - t) - 
     ...
     gZlR^2*(-2*(-2 + d)*psq^2 - (8 - 4*d + d^2)*psq*s + 2*(-2 + d)*psq*t + 
       2*s*((-2 + d)*s + 2*t) + (-2 + d)*mm^2*(-6*psq + (-2 + d)*s + 6*t)))*
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*(2*d^2*gZlL*gZlR*s^2 + 
   ...
   (4^d*Pi^(2*d)*s^2) + (2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
