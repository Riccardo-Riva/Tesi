...
s Alfa, Alfa2, Alfas, Alfas2, CA, CA2, CB, CB2, CBA, CBA2, CW, CW2, D,
  EL, gAl, gAu, gHll, gHuu, GS, gXll, gXuu, gZlL, gZlR, gZuL, gZuR,
  MA0, MA02, MA0tree, MA0tree2, MB, MB2, MC, MC2, MD, MD2, ME, ME2,
  MGl, MGl2, MH, Mh0, Mh02, Mh0tree, Mh0tree2, MH2, MHH, MHH2, MHHtree,
  MHHtree2, MHp, MHp2, MHptree, MHptree2, Mino3, Mino3C, ML, ML2, MM,
  MM2, MS, MS2, MT, MT2, MU, MU2, MW, MW2, MZ, MZ2, Pi, S, SA, SA2, SB,
  SB2, SBA, SBA2, SqrtEGl, SqrtEGlC, SW, SW2, T, TB, TB2, U, Xbg, XV20;
cf Conjugate, CT1, Den, dirM, dMf1, dZfL1, dZfR1, Hel, List, MASf,
  MASf2, MCha, MCha2, Mf, Mf2, MHiggs, MHiggs2, MHiggstree,
  MHiggstree2, MNeu, MNeu2, MSf, MSf2, S, V;
f Spinor;
d D;
i iM = 0, Lor1, Lor2, Lor3, Lor4;
t Pol;

#define LoopMomenta "Removed("q1"),Removed("q2")"
...
L T1G1P1 = -(Den(k3 + k4, MH^2)*Spinor(k2, MU, -1)*g_(100)*
   ((i_*EL*gHuu*MU*g6_(100))/2 + (i_*EL*gHuu*MU*g7_(100))/2)*
   Spinor(k1, MU, 1)*Spinor(k3, MM, 1)*g_(101)*
   ((i_*EL*gHll*g7_(101)*(MM*Conjugate(dZfR1(2, 2, 2)) + 
       2*dMf1(2, 2) + MM*dZfL1(2, 2, 2)))/4 + 
    (i_*EL*gHll*g6_(101)*(MM*Conjugate(dZfL1(2, 2, 2)) + 
       2*dMf1(2, 2) + MM*dZfR1(2, 2, 2)))/4)*Spinor(k4, MM, -1));

L T1G1P2 = -(Den(k3 + k4, MZ^2*Xbg)*Spinor(k2, MU, -1)*g_(100)*
   (-(EL*gXuu*MU*g6_(100))/2 + (EL*gXuu*MU*g7_(100))/2)*
   Spinor(k1, MU, 1)*Spinor(k3, MM, 1)*g_(101)*
   (-(EL*gXll*g7_(101)*(MM*Conjugate(dZfR1(2, 2, 2)) + 2*dMf1(2, 2) + 
        MM*dZfL1(2, 2, 2)))/4 + 
    (EL*gXll*g6_(101)*(MM*Conjugate(dZfL1(2, 2, 2)) + 2*dMf1(2, 2) + 
       MM*dZfR1(2, 2, 2)))/4)*Spinor(k4, MM, -1));

L T1G2P1 = (d_(Lor1, Lor2)*Den(k3 + k4, 0) + 
  (1 - Xbg)*Den(k3 + k4, 0, 2)*(-k3(Lor1) - k4(Lor1))*
 ...
 Spinor(k3, MM, 1)*g_(101)*
  ((i_*EL*gAl*(Conjugate(dZfR1(2, 2, 2)) + dZfR1(2, 2, 2))*
     g_(101, Lor2)*(g6_(101)/2))/2 + 
   (i_*EL*gAl*(Conjugate(dZfL1(2, 2, 2)) + dZfL1(2, 2, 2))*
     g_(101, Lor2)*(g7_(101)/2))/2)*Spinor(k4, MM, -1);

L T1G2P2 = (d_(Lor1, Lor2)*Den(k3 + k4, MZ^2) + 
  (1 - XV20)*Den(k3 + k4, MZ^2)*Den(k3 + k4, MZ^2*XV20)*
 ...
 Spinor(k3, MM, 1)*g_(101)*
  ((i_*EL*gZlR*(Conjugate(dZfR1(2, 2, 2)) + dZfR1(2, 2, 2))*
     g_(101, Lor2)*(g6_(101)/2))/2 + 
   (i_*EL*gZlL*(Conjugate(dZfL1(2, 2, 2)) + dZfL1(2, 2, 2))*
     g_(101, Lor2)*(g7_(101)/2))/2)*Spinor(k4, MM, -1);

L T2G1P1 = -(Den(k3 + k4, MH^2)*Spinor(k2, MU, -1)*g_(100)*
   ((i_*EL*gHuu*g7_(100)*(MU*Conjugate(dZfR1(3, 1, 1)) + 
       2*dMf1(3, 1) + MU*dZfL1(3, 1, 1)))/4 + 
    (i_*EL*gHuu*g6_(100)*(MU*Conjugate(dZfL1(3, 1, 1)) + 
       2*dMf1(3, 1) + MU*dZfR1(3, 1, 1)))/4)*Spinor(k1, MU, 1)*
  Spinor(k3, MM, 1)*g_(101)*((i_*EL*gHll*MM*g6_(101))/2 + 
    (i_*EL*gHll*MM*g7_(101))/2)*Spinor(k4, MM, -1));

L T2G1P2 = -(Den(k3 + k4, MZ^2*Xbg)*Spinor(k2, MU, -1)*g_(100)*
   ((EL*gXuu*g7_(100)*(MU*Conjugate(dZfR1(3, 1, 1)) + 2*dMf1(3, 1) + 
       MU*dZfL1(3, 1, 1)))/4 - (EL*gXuu*g6_(100)*
      (MU*Conjugate(dZfL1(3, 1, 1)) + 2*dMf1(3, 1) + MU*dZfR1(3, 1, 1)))/
     4)*Spinor(k1, MU, 1)*Spinor(k3, MM, 1)*g_(101)*
   ((EL*gXll*MM*g6_(101))/2 - (EL*gXll*MM*g7_(101))/2)*
   Spinor(k4, MM, -1));

L T2G2P1 = (d_(Lor1, Lor2)*Den(k3 + k4, 0) + 
  (1 - Xbg)*Den(k3 + k4, 0, 2)*(-k3(Lor1) - k4(Lor1))*
   (k3(Lor2) + k4(Lor2)))*Spinor(k2, MU, -1)*g_(100)*
  ((i_*EL*gAu*(Conjugate(dZfR1(3, 1, 1)) + dZfR1(3, 1, 1))*
     g_(100, Lor1)*(g6_(100)/2))/2 + 
   (i_*EL*gAu*(Conjugate(dZfL1(3, 1, 1)) + dZfL1(3, 1, 1))*
     g_(100, Lor1)*(g7_(100)/2))/2)*Spinor(k1, MU, 1)*
 Spinor(k3, MM, 1)*g_(101)*
  (i_*EL*gAl*g_(101, Lor2)*(g6_(101)/2) + 
   i_*EL*gAl*g_(101, Lor2)*(g7_(101)/2))*Spinor(k4, MM, -1);

L T2G2P2 = (d_(Lor1, Lor2)*Den(k3 + k4, MZ^2) + 
  (1 - XV20)*Den(k3 + k4, MZ^2)*Den(k3 + k4, MZ^2*XV20)*
   (-k3(Lor1) - k4(Lor1))*(k3(Lor2) + k4(Lor2)))*
 Spinor(k2, MU, -1)*g_(100)*
  ((i_*EL*gZuR*(Conjugate(dZfR1(3, 1, 1)) + dZfR1(3, 1, 1))*
     g_(100, Lor1)*(g6_(100)/2))/2 + 
   (i_*EL*gZuL*(Conjugate(dZfL1(3, 1, 1)) + dZfL1(3, 1, 1))*
     g_(100, Lor1)*(g7_(100)/2))/2)*Spinor(k1, MU, 1)*
 Spinor(k3, MM, 1)*g_(101)*
  (i_*EL*gZlR*g_(101, Lor2)*(g6_(101)/2) + 
   i_*EL*gZlL*g_(101, Lor2)*(g7_(101)/2))*Spinor(k4, MM, -1);

L T3G1P1 = CT1(S(10), S(10))*Den(-k3 - k4, MH^2)*
 Den(k3 + k4, MH^2)*Spinor(k2, MU, -1)*g_(100)*
  ((i_*EL*gHuu*MU*g6_(100))/2 + (i_*EL*gHuu*MU*g7_(100))/2)*
  Spinor(k1, MU, 1)*Spinor(k3, MM, 1)*g_(101)*
  ((i_*EL*gHll*MM*g6_(101))/2 + (i_*EL*gHll*MM*g7_(101))/2)*
  Spinor(k4, MM, -1);

L T3G1P2 = CT1(S(20), S(20))*Den(-k3 - k4, MZ^2*Xbg)*
 Den(k3 + k4, MZ^2*Xbg)*Spinor(k2, MU, -1)*g_(100)*
  (-(EL*gXuu*MU*g6_(100))/2 + (EL*gXuu*MU*g7_(100))/2)*
  Spinor(k1, MU, 1)*Spinor(k3, MM, 1)*g_(101)*
  ((EL*gXll*MM*g6_(101))/2 - (EL*gXll*MM*g7_(101))/2)*
  Spinor(k4, MM, -1);

L T3G2P1 = CT1(S(20), V(20))*(k3(Lor1) + k4(Lor1))*
 (d_(Lor1, Lor2)*Den(-k3 - k4, MZ^2*Xbg)*Den(k3 + k4, MZ^2) + 
  (1 - XV20)*Den(-k3 - k4, MZ^2*Xbg)*Den(k3 + k4, MZ^2)*
   Den(k3 + k4, MZ^2*XV20)*(-k3(Lor1) - k4(Lor1))*(k3(Lor2) + k4(Lor2)))*
...
L T3G3P1 = CT1(S(20), V(20))*(-k3(Lor1) - k4(Lor1))*
 (d_(Lor1, Lor2)*Den(-k3 - k4, MZ^2)*Den(k3 + k4, MZ^2*Xbg) + 
  (1 - XV20)*Den(-k3 - k4, MZ^2)*Den(-k3 - k4, MZ^2*XV20)*
   Den(k3 + k4, MZ^2*Xbg)*(k3(Lor1) + k4(Lor1))*(-k3(Lor2) - k4(Lor2)))*
 Spinor(k2, MU, -1)*g_(100)*
  (i_*EL*gZuR*g_(100, Lor2)*(g6_(100)/2) + 
   i_*EL*gZuL*g_(100, Lor2)*(g7_(100)/2))*Spinor(k1, MU, 1)*
 Spinor(k3, MM, 1)*g_(101)*((EL*gXll*MM*g6_(101))/2 - 
   (EL*gXll*MM*g7_(101))/2)*Spinor(k4, MM, -1);

L T3G4P1 = d_(Lor1, Lor3)*CT1(V(10), V(10))*
 (d_(Lor1, Lor2)*d_(Lor3, Lor4)*Den(-k3 - k4, 0)*Den(k3 + k4, 0) + 
  (1 - Xbg)*d_(Lor3, Lor4)*Den(k3 + k4, 0)*Den(-k3 - k4, 0, 2)*
   (k3(Lor1) + k4(Lor1))*(-k3(Lor2) - k4(Lor2)) + 
  (1 - Xbg)*d_(Lor1, Lor2)*Den(-k3 - k4, 0)*Den(k3 + k4, 0, 2)*
   (-k3(Lor3) - k4(Lor3))*(k3(Lor4) + k4(Lor4)) + 
  (1 - Xbg)^2*Den(-k3 - k4, 0, 2)*Den(k3 + k4, 0, 2)*
   (k3(Lor1) + k4(Lor1))*(-k3(Lor2) - k4(Lor2))*(-k3(Lor3) - k4(Lor3))*
   (k3(Lor4) + k4(Lor4)))*Spinor(k2, MU, -1)*g_(100)*
  (i_*EL*gAu*g_(100, Lor2)*(g6_(100)/2) + 
   i_*EL*gAu*g_(100, Lor2)*(g7_(100)/2))*Spinor(k1, MU, 1)*
 Spinor(k3, MM, 1)*g_(101)*
  (i_*EL*gAl*g_(101, Lor4)*(g6_(101)/2) + 
   i_*EL*gAl*g_(101, Lor4)*(g7_(101)/2))*Spinor(k4, MM, -1);

L T3G4P2 = d_(Lor1, Lor3)*CT1(V(10), V(20))*
 (d_(Lor1, Lor2)*d_(Lor3, Lor4)*Den(-k3 - k4, 0)*
   Den(k3 + k4, MZ^2) + (1 - Xbg)*d_(Lor3, Lor4)*Den(k3 + k4, MZ^2)*
   Den(-k3 - k4, 0, 2)*(k3(Lor1) + k4(Lor1))*(-k3(Lor2) - k4(Lor2)) + 
  (1 - XV20)*d_(Lor1, Lor2)*Den(-k3 - k4, 0)*Den(k3 + k4, MZ^2)*
   Den(k3 + k4, MZ^2*XV20)*(-k3(Lor3) - k4(Lor3))*
   (k3(Lor4) + k4(Lor4)) + (1 - Xbg)*(1 - XV20)*Den(k3 + k4, MZ^2)*
   Den(k3 + k4, MZ^2*XV20)*Den(-k3 - k4, 0, 2)*(k3(Lor1) + k4(Lor1))*
...
L T3G4P3 = d_(Lor1, Lor3)*CT1(V(10), V(20))*
 (d_(Lor1, Lor2)*d_(Lor3, Lor4)*Den(-k3 - k4, MZ^2)*
   Den(k3 + k4, 0) + (1 - XV20)*d_(Lor3, Lor4)*Den(-k3 - k4, MZ^2)*
   Den(-k3 - k4, MZ^2*XV20)*Den(k3 + k4, 0)*(k3(Lor1) + k4(Lor1))*
   (-k3(Lor2) - k4(Lor2)) + (1 - Xbg)*d_(Lor1, Lor2)*
   Den(-k3 - k4, MZ^2)*Den(k3 + k4, 0, 2)*(-k3(Lor3) - k4(Lor3))*
   (k3(Lor4) + k4(Lor4)) + (1 - Xbg)*(1 - XV20)*Den(-k3 - k4, MZ^2)*
   Den(-k3 - k4, MZ^2*XV20)*Den(k3 + k4, 0, 2)*(k3(Lor1) + k4(Lor1))*
   (-k3(Lor2) - k4(Lor2))*(-k3(Lor3) - k4(Lor3))*(k3(Lor4) + k4(Lor4)))*
 Spinor(k2, MU, -1)*g_(100)*
...
L T3G4P4 = d_(Lor1, Lor3)*CT1(V(20), V(20))*
 (d_(Lor1, Lor2)*d_(Lor3, Lor4)*Den(-k3 - k4, MZ^2)*
   Den(k3 + k4, MZ^2) + (1 - XV20)*d_(Lor3, Lor4)*Den(-k3 - k4, MZ^2)*
   Den(-k3 - k4, MZ^2*XV20)*Den(k3 + k4, MZ^2)*(k3(Lor1) + k4(Lor1))*
   (-k3(Lor2) - k4(Lor2)) + (1 - XV20)*d_(Lor1, Lor2)*
   Den(-k3 - k4, MZ^2)*Den(k3 + k4, MZ^2)*Den(k3 + k4, MZ^2*XV20)*
   (-k3(Lor3) - k4(Lor3))*(k3(Lor4) + k4(Lor4)) + 
  (1 - XV20)^2*Den(-k3 - k4, MZ^2)*Den(-k3 - k4, MZ^2*XV20)*
   Den(k3 + k4, MZ^2)*Den(k3 + k4, MZ^2*XV20)*(k3(Lor1) + k4(Lor1))*
   (-k3(Lor2) - k4(Lor2))*(-k3(Lor3) - k4(Lor3))*(k3(Lor4) + k4(Lor4)))*
 Spinor(k2, MU, -1)*g_(100)*
  (i_*EL*gZuR*g_(100, Lor2)*(g6_(100)/2) + 
   i_*EL*gZuL*g_(100, Lor2)*(g7_(100)/2))*Spinor(k1, MU, 1)*
...
id k1.k1 = MU^2;
id k1.k2 = -MU^2 + S/2;
id k1.k3 = MM^2/2 + MU^2/2 - T/2;
id k1.k4 = MM^2/2 + MU^2/2 - U/2;
id k2.k2 = MU^2;
id k2.k3 = MM^2/2 + MU^2/2 - U/2;
id k2.k4 = MM^2/2 + MU^2/2 - T/2;
id k3.k3 = MM^2;
id k3.k4 = -MM^2 + S/2;
id k4.k4 = MM^2;
#endprocedure
...
id `foo'(sM?) = `foo'(sM, sM*replace_(S, 2*MM^2 + 2*MU^2 - T - U));
#call Fewest(`foo')
id `foo'(sM?) = `foo'(sM, sM*replace_(T, 2*MM^2 + 2*MU^2 - S - U));
#call Fewest(`foo')
id `foo'(sM?) = `foo'(sM, sM*replace_(U, 2*MM^2 + 2*MU^2 - S - T));
#call Fewest(`foo')
#endprocedure

#procedure ConstBracket
ab Alfa, Alfa2, Alfas, Alfas2, CA, CA2, CB, CB2, CBA, CBA2, CT1, CW,
  CW2, dMf1, dZfL1, dZfR1, EL, gAl, gAu, gHll, gHuu, GS, gXll, gXuu,
  gZlL, gZlR, gZuL, gZuR, List, MA0, MA02, MA0tree, MA0tree2, MASf,
  MASf2, MB, MB2, MC, MC2, MCha, MCha2, MD, MD2, ME, ME2, Mf, Mf2, MGl,
  MGl2, MH, Mh0, Mh02, Mh0tree, Mh0tree2, MH2, MHH, MHH2, MHHtree,
  MHHtree2, MHiggs, MHiggs2, MHiggstree, MHiggstree2, MHp, MHp2,
  MHptree, MHptree2, Mino3, Mino3C, ML, ML2, MM, MM2, MNeu, MNeu2, MS,
  MS2, MSf, MSf2, MT, MT2, MU, MU2, MW, MW2, MZ, MZ2, Pi, SA, SA2, SB,
  SB2, SBA, SBA2, SqrtEGl, SqrtEGlC, SW, SW2, TB, TB2, Xbg, XV20;
#endprocedure
...
L Result = T1G1P1 + T1G1P2 + T1G2P1 + T1G2P2 + T2G1P1 + 
 T2G1P2 + T2G2P1 + T2G2P2 + T3G1P1 + T3G1P2 + T3G2P1 + 
 T3G3P1 + T3G4P1 + T3G4P2 + T3G4P3 + T3G4P4;
