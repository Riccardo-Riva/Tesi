...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gFAW*gFFA*gFZW*(gZlL + gZlR)*s*
    ...
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (EL^5*gAl*gFAW*gFFA*gFZW*(gZlL + gZlR)*
    (-2*aa*(-2 + d)*psq^2 + bb*(-2 + d)*psq*(2*psq - s) + 
     2*aa*mm^2*((2 + d)*psq - s) + bb*mm^2*(-2*(2 + d)*psq + d*s))*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2*Pi)^(2*d) - 
  ((-2 + d)*EL^5*gAl*gFAW*gFFA*gFZW*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*s*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  ((-aa + bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFZW*(gZlL + gZlR)*(mm^2 + psq)*s*
