...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((EL^5*ggmgmA*ggmgmZ^2*s*(bb*(gZlL^2*psq*(2*mm^2 + 2*psq - s) + 
   ...
   (4^(1 - d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*s*
   ...
   (2^(1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
     (bb*(2*gZlL*gZlR*mm^2*(-4*psq + s) + gZlL^2*(psq*(2*psq - s) + 
          2*mm^2*(psq + s)) + gZlR^2*(psq*(2*psq - s) + 2*mm^2*(psq + s))) - 
      aa*(2*gZlL*gZlR*mm^2*(-4*psq + s) + gZlL^2*(mm^2*(2*psq - s) + 
          2*psq*(psq + s)) + gZlR^2*(mm^2*(2*psq - s) + 2*psq*(psq + s))))*
