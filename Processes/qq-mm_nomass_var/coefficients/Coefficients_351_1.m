...
{((3*I)*2^(1 - d)*d*EL^6*gAl*gAu*(gZlL + gZlR)*(gZuL^3 + gZuL^2*gZuR + 
     gZuL*gZuR^2 + gZuR^3)*s^2)/((-4 + 4*d)*Pi^d*(mz^2 - s)^2) + 
  ((3*I)*2^(-2 - d)*EL^6*gAl*gAu*(gZuL^2 + gZuR^2)*(d*s + 2*t)*
   ...
   ((-1 + d)*Pi^d*(mz^2 - s)^2) + ((3*I)*2^(-2 - d)*EL^6*gAl*gAu*s*
    (gZlL*((-4 + d)*gZuR^3*((-2 + d)*s - 2*t) + (-2 + d)*gZuL^3*
     ...
     gZlR*((-4 + d)*gZuL^3*((-2 + d)*s - 2*t) + (-2 + d)*gZuR^3*
       ...
       gZuL*gZuR^2*((-4 + d)^2*s - 2*(-2 + d)*t))))/(Pi^d*(mz^2 - s)^2) - 
