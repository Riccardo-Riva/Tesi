...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*mm^2*((-2 + d)^2*mm^4*s - 
   ...
   (2^(5 - 2*d)*d*EL^8*gAl^6*gAu^2*mm^2*(6*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 
      4*t^2 + mm^2*(-2*psq + d*s + 2*t) - psq*(d*s + 10*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*mm^2*(-8*d^2*psq*s + d^3*psq*s - 
   ...
   (2^(5 - 2*d)*d*EL^8*gAl^6*gAu^2*mm^2*(2*psq^2 - 2*s^2 + d*s^2 + 
   ...
   (2^(5 - 2*d)*d*EL^8*gAl^6*gAu^2*mm^2*(4*psq^2 + 2*mm^2*s - 2*s^2 + d*s^2 + 
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*
     ((-24 + 20*d - 8*d^2 + d^3)*mm^4*s - 2*mm^2*(8*(-1 + d)*psq^2 + 
        (-24 + 22*d - 8*d^2 + d^3)*psq*s + 2*(-2 + d)*s^2 - 
        16*(-1 + d)*psq*t + 8*(-1 + d)*s*t + 8*(-1 + d)*t^2) + 
      (-2 + d)*s*((16 - 6*d + d^2)*psq^2 + (-2 + d)*s^2 + 4*s*t + 4*t^2 - 
        4*psq*((-2 + d)*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^6*gAu^2*mm^2*
     (4*(-2 + d)^2*psq^2 - 2*(-8 + 8*d - 6*d^2 + d^3)*mm^2*s + 
      2*(-8 + 8*d - 6*d^2 + d^3)*psq*s - 112*s^2 + 80*d*s^2 - 16*d^2*s^2 + 
      d^3*s^2 - 8*(-2 + d)^2*psq*t + 16*s*t - 16*d*s*t + 4*d^2*s*t + 16*t^2 - 
      16*d*t^2 + 4*d^2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(mm^2 - psq)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*
     (2*mm^2 + (-2 + d)*psq)*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*(mm^2 - psq)*
     (2*mm^2 - 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^4 + (-2 + d)*psq*
       (-2*psq + (-3 + d)*s) + mm^2*(-4*(2 + d)*psq - 6*s + 5*d*s + 6*d*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 
      4*t^2 - 6*psq*(s + 2*t) + mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^6*gAu^2*(2*mm^2*(4*(-1 + d)*psq + (6 + d - d^2)*s - 
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
      ...
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*
     (-2*(-8 - 2*d + d^2)*psq^2 - 8*(-4 + d)*s^2 + 4*(14 - 3*d)*s*t - 
   ...
   (4^(2 - d)*EL^8*gAl^6*gAu^2*mm^2*(-44*s - d^2*s + 
      2*d*(4*mm^2 - 4*psq + 9*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^6*gAu^2*(2*mm^2*(2*(2 + d)*psq + (-6 + d)*s - 
   ...
   (4^(2 - d)*EL^8*gAl^6*gAu^2*((8 - 10*d + d^2)*psq^2 - 
      4*(13 - 8*d + d^2)*psq*s + 2*(-6 + d)*s^2 - (-10 + d)*d*psq*t - 
      16*s*t - 8*t^2 + mm^2*(-((8 - 2*d + d^2)*psq) + 4*(10 - 6*d + d^2)*s + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(2*mm^2 + (-2 + d)*psq)*
   ...
   (4^(2 - d)*EL^8*gAl^6*gAu^2*(mm^2*(4*(2 + d)*psq + (4 - 6*d)*s - 
   ...
   (4^(2 - d)*EL^8*gAl^6*gAu^2*(-((24 - 10*d + d^2)*psq^2) + 
      (-52 + 22*d - 3*d^2)*psq*s - 4*s^2 + 2*d*s^2 + 
      (32 - 10*d + d^2)*psq*t - 8*t^2 + mm^2*((8 - 2*d + d^2)*psq + 
        (32 - 22*d + 3*d^2)*s - (8 - 2*d + d^2)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*mm^2*(2*psq + (-6 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(4*psq^2 + 4*mm^2*s - 2*s^2 + 
      d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*(-2 + d)*psq^2 + 2*(-4 + d)*mm^2*s - 
   ...
   (4^(3 - d)*d*EL^8*gAl^6*gAu^2*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((16 - 6*d + d^2)*mm^2 - 
      (12 - 6*d + d^2)*psq + 2*(-3 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(4*(16 - 10*d + d^2)*psq^2 + 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 4*psq + s)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*((16 - 10*d + d^2)*mm^2 - 
   ...
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*((16 - 10*d + d^2)*mm^2 - 
     ...
     ((20 - 10*d + d^2)*psq - (-4 + d)^2*s - (20 - 10*d + d^2)*t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-((16 - 10*d + d^2)*mm^2) - 20*psq + 
      2*d*s + 36*t - 10*d*t + d^2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(2*(16 - 10*d + d^2)*mm^2 - 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(-2*psq + (-2 + d)*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*((20 - 10*d + d^2)*psq + 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*((20 - 10*d + d^2)*psq + 2*(-2 + d)*s - 
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(2*(16 - 10*d + d^2)*psq - 
      (-104 + 64*d - 14*d^2 + d^3)*s - 2*(16 - 10*d + d^2)*t)*\[Mu]^(8 - 2*d)*
