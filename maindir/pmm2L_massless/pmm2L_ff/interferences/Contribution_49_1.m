...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^6*t*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s)) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^6*t*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^6*t^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
   (5*2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*(s^2 + 3*s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*(s + t)^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*(mm^2 + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*(mm^2 + 3*(s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*(s^2 + 6*s*t + 5*t^2)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*
     (mm^2*s + s^2 - 4*s*t - 5*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*(2*s^2 + 7*s*t + 5*t^2)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*
     (3*s^2 + 13*s*t + 10*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
     mm^4*(s^2 + 5*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (3*2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*
     gWNl*mm^4*t*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*(2*s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*(s - t)*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*(4*s + 5*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (3*4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (3*2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*(s + 4*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*(s + 3*t)*\[Mu]^(8 - 2*d)*
   ...
   (3*2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (mm^2*s*(s + 4*t) - t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q2, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*t*(s + t)*(s + 2*t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(s + t)^2*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(s + t)*
     ...
     gWNl*mm^4*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (mm^2 - t)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*t^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*t^2*\[Mu]^(8 - 2*d)*
