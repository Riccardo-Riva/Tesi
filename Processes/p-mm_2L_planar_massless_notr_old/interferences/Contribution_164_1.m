...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mz], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2*s + gZlR^2*s)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(3*s + 2*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(s - 2*t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*
