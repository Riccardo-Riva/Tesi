...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
 ...
 ((I*4^(-1 - d)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*s*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
    (aa*(-4*psq^2 + 2*mm^2*(2*psq + s - 2*t) + 4*psq*t - s*(s + 2*t)) + 
     bb*(4*psq^2 - 4*psq*(2*s + t) + s*(s + 2*t) + 
       mm^2*(-4*psq + 6*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
    gWWA*mm^2*(aa*(-2*psq^2 + 3*psq*s - 2*s^2 + 2*mm^2*(psq - t) + 2*psq*t - 
       3*s*t) + bb*(2*psq^2 - 7*psq*s + 2*s^2 - 2*psq*t + 3*s*t + 
       mm^2*(-2*psq + 4*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*s*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*s*(-psq + s + t)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
    gWWA*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) + (I*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
    gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[q1, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*
    gHWW*gWlN*gWNl*gWWA*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
    ...
    gWNl*gWWA*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
    gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
     SP[q1, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*
    gHWW*gWlN*gWNl*gWWA*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
    gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*
    gWlN*gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*
    gWlN*gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p2, q1]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
    gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/
   (4^d*Pi^(2*d)) + ((3*I)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*
    gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p2, q1]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*
    gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, q2]])/Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gHll*gHWW*gWlN*gWNl*
