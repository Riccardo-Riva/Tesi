...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(mm^2 - psq)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*
     mm^2*(mm^2 - psq)*(2*(-2 + d)*mm^2 - (2 + d)*psq + 2*s + 6*t - d*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(-16*d*gZlL*gZlR*mm^2*(psq - t) + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(16*d*gZlL*gZlR*mm^2*s + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(-4*d*gZlL*gZlR*mm^2*s + 
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
     (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*
     (gZlL^2 + gZlR^2)*mm^2*(-2*(-2 + d)*psq + (12 - 6*d + d^2)*s + 
      2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*
     (gZlL^2 + gZlR^2)*mm^2*(2*(-2 + d)*mm^2 + (10 - 3*d)*psq - 4*s + d*s - 
      6*t + d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*
