...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   (((-I)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(s + t)*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(d*gZlR*(2*Pi)^d*s + gZlL*(-(d*(2*Pi)^d*s) + 
    ...
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*t*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
      ...
      (-1 + GaugeXi[Q])) - (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*s*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(gZlL*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
     ...
     (mw^4*(2*Pi)^(2*d)*(mz^2 - s)*(-1 + GaugeXi[Q])^2) + 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*s*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
      (d*gZlL*(2*Pi)^d*s - d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlR*Pi^d*
     ...
     (mw^4*(2*Pi)^(2*d)*(-mz^2 + s)*(-1 + GaugeXi[Q])^2) - 
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(s + t)*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      GaugeXi[Q]) - (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*((s + 2*t)*((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 
         2*gZlL*t + 2*gZlR*t) + s*((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 
         2*(-3 + d)*gZlL*t - 2*(-3 + d)*gZlR*t)*GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*
      GaugeXi[Q]) + (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 2*gZlL*t + 
       2*gZlR*t + (6*gZlL*s - d*gZlL*s + d*gZlR*s + 2*gZlL*t + 2*gZlR*t)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*((-4 + d)*gZlL - (-2 + d)*gZlR)*
      (s + t)*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], 
       SP[p1, q1], SP[p1, q1], SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*((-4 + d)*gZlL - (-2 + d)*gZlR)*
      (s + t)*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], 
       SP[p1, q1], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*
      GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
      (gZlL*((-2 + d)*s + (-4 + d)*t) - gZlR*((-4 + d)*s + (-2 + d)*t))*
      \[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*GaugeXi[Q]) + 
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*((-2 + d)*gZlL*s - 
      ...
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*GaugeXi[Q]) + 
    (I*2^(3 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(gZlL + gZlR)*\[Mu]^(4 - d)*
   ...
   ((I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
      (d^2*gZlL*(2*Pi)^d*s*(3*s + 5*t) - d^2*gZlR*(2*Pi)^d*s*(3*s + 5*t) + 
       2^(1 + d)*gZlL*Pi^d*((10 - 8*d)*s^2 + (16 - 13*d)*s*t + 
         ...
         2*(-13 + 8*d)*s*t + (-2 + d)*t^2))*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*SPList[SP[p1, q1]])/(Pi^(2*d)*s*(-mz^2 + s)) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(5*d^2*gZlL*(2*Pi)^d*s*t - 
       5*d^2*gZlR*(2*Pi)^d*s*t - 2^(1 + d)*gZlR*Pi^d*((8 - 6*d + d^2)*s^2 - 
        ...
        ((-2 + d)^2*s^2 + 2*(11 - 7*d)*s*t + (-2 + d)*t^2))*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1]])/(Pi^(2*d)*s*(-mz^2 + s)) + 
    (I*2^(1 - d)*(-6 + d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
      ((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 2*gZlL*t + 2*gZlR*t)*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p3, q1]])/(Pi^d*(mz^2 - s)) - 
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(-(mw^2*(-(gZlR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
    ...
    (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
     ...
     (Pi^d*(mz^2 - s)*s) - (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(-2*mw^2*(-(d*gZlL*(2*Pi)^d*s*(d*s - 9*t)) + 
         d*gZlR*(2*Pi)^d*s*(d*s - 9*t) + 2^(1 + d)*gZlR*Pi^d*
          ((4 - 3*d)*s^2 + (2 + d^2)*s*t - 3*t^2) + 2^(1 + d)*gZlL*Pi^d*
          (2*(-1 + d)*s^2 - (7 + d^2)*s*t - 3*t^2)) + 
       (gZlR*(s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-2 + d)*s - t))*t + 
           2^(2 + d)*mw^2*Pi^d*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
             4*t^2)) - gZlL*(2^(2 + d)*mw^2*Pi^d*((-2 + d)^2*s^2 + 
    ...
    (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(gZlL + gZlR)*
      \[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p3, q1], SP[p3, q1]])/
     (Pi^d*(mz^2 - s)) - (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*((2^(1 - 2*d)*mw^2*(-(d*gZlL*(2*Pi)^d*s) + 
          d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*(s - t) - 
          2^(1 + d)*gZlR*Pi^d*(2*s + t))*(-1 + GaugeXi[Q])^2*
         (1 + GaugeXi[Q]))/(Pi^(2*d)*GaugeXi[Q]) + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(s + t)*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*
      GaugeXi[Q]) + (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(4*gZlR*s^2 - d*gZlR*s*(2*mw^2 + s) + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*t*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      GaugeXi[Q]) - (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(2*gZlL*mw^2*((-2 + d)*s - 2*t) + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   (((-I)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
      ...
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[q1, q1]])/(mw^2*(2*Pi)^d*(mz^2 - s)) + 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
      (s*(s + t)*GaugeXi[Q]*(d*gZlR*(2*Pi)^d*s + 
         gZlL*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) - 
         2^(1 + d)*gZlR*Pi^d*(2*s + t) + 2^(1 + d)*Pi^d*((-2 + d)*gZlL*s - 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(4*gZlR*s^2 - d*gZlR*s*(mw^2 + s) + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*t*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*
      GaugeXi[Q]) + (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(-(gZlR*(s*((-4 + d)*s - 2*t) + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   (((-I)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
    ...
    (I*2^(3 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(gZlL + gZlR)*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*GaugeXi[Q])))/4
