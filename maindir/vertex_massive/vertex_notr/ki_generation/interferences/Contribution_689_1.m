...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1 - q2, mz], 
 ...
 (((-2 + d)*EL^6*gAl*gFZW^2*gWlN*gWNl*gWWA*s*(-4*psq + s)*sw^2*
    \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - ((-2 + d)*EL^6*gAl*gFZW^2*gWlN*gWNl*gWWA*
    (mm^2 + psq - 2*s)*sw^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (2*Pi)^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gFZW^2*gWlN*gWNl*gWWA*
    (mm^2 + psq - 2*s)*sw^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
