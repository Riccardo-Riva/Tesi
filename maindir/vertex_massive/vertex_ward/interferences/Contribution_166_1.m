...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   ((I*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*s*(aa*mm^2*(psq - t) + 
      ...
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*aa*EL^5*gAl*ggmgmA^2*
      gHgmgm*gHll*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    ...
    (I*2^(1 - 2*d)*bb*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*(mm^2 - psq)*s*
    ...
    (I*4^(1 - d)*aa*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*(mm^2 - psq)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*
     ...
     Pi^(2*d) + (I*4^(1 - d)*bb*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*
