...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*gWWZ^2*mm^2*(psq^2 - 2*psq*t + t*(s + t))*
      ...
      \[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) - 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*
     (-2*gZlL*gZlR*mm^2*(24*(-1 + d)*psq^3 - 4*psq^2*((-3 + 8*d)*s + 
          12*(-1 + d)*t) + (-6 + d)*s*(s^2 + 5*s*t + 4*t^2) + 
        psq*((6 + 9*d)*s^2 + 4*(3 + 7*d)*s*t + 24*(-1 + d)*t^2)) + 
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*
     (-2*gZlL*gZlR*mm^2*(24*(-1 + d)*psq^3 + (-6 + d)*s*t*(3*s + 4*t) - 
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*
     (2*gZlL*gZlR*mm^2*s*(12*(-1 + d)*psq + (-6 + d)*s)*(2*psq - s - 2*t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWWZ^2*(-2*gZlL*gZlR*mm^2*(24*(-1 + d)*psq^2 + 
        (-6 + d)*s^2 + 12*(-1 + d)*s*t + 24*(-1 + d)*t^2 - 
        12*(-1 + d)*psq*(s + 4*t)) + gZlL^2*(-20*(-2 + d)*psq^3 + 
        2*mm^2*(psq - t)*(2*(-6 + d)*psq + (8 - 3*d)*s - 2*(-6 + d)*t) + 
        10*t*(s + t)*(2*s + (-2 + d)*t) + 2*psq^2*(2*(4 + d)*s + 
          25*(-2 + d)*t) + psq*((-6 + d)*s^2 - 2*(8 + 7*d)*s*t - 
          40*(-2 + d)*t^2)) + gZlR^2*(-20*(-2 + d)*psq^3 + 
        2*mm^2*(psq - t)*(2*(-6 + d)*psq + (8 - 3*d)*s - 2*(-6 + d)*t) + 
        10*t*(s + t)*(2*s + (-2 + d)*t) + 2*psq^2*(2*(4 + d)*s + 
          25*(-2 + d)*t) + psq*((-6 + d)*s^2 - 2*(8 + 7*d)*s*t - 
          40*(-2 + d)*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gWWZ^2*
     (-2*gZlL*gZlR*mm^2*(12*(-1 + d)*psq^2 + (-3 + 2*d)*s^2 + 
        6*(-1 + d)*s*t + 12*(-1 + d)*t^2 - 6*(-1 + d)*psq*(s + 4*t)) + 
      gZlL^2*(-2*(-2 + d)*psq^3 + t*(s + t)*(s + 2*d*s + 2*(-2 + d)*t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWWZ^2*(-12*(-1 + d)*gZlL*gZlR*mm^2*
     ...
     mm^2*(psq - t)*(2*gZlL*gZlR*s + gZlL^2*(-psq + t) + gZlR^2*(-psq + t))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWWZ^2*(-24*(-1 + d)*gZlL*gZlR*mm^2*
      ...
      gZlR^2*(-10*(-2 + d)*psq*(psq - s - t) + 
        mm^2*(4*(-6 + d)*psq + (22 - 7*d)*s - 4*(-6 + d)*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-3 + 2*d)*EL^6*gAl*gAu*gWWZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
     ...
     (gZlL^2 + gZlR^2)*(psq - t)*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-3 + 2*d)*EL^6*gAl*gAu*gWWZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gWWZ^2*(gZlL^2 + gZlR^2)*
