...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*psq*
     (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*psq*
     (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*psq*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (mm^2*(3*psq - s - t) + 2*psq*(-2*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*(-psq + s + t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - 2*psq)*(psq - t)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (-psq + s + t)*(-2*psq^2 - 2*mm^2*s + 3*psq*s + 2*psq*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (2*psq^2 - 5*psq*s + 3*s^2 - 4*psq*t + 5*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*
     (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - 2*psq)*
     (psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (mm^2 - 2*psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    Pi^(2*d) - (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (psq - t)*(2*psq^2 + 2*mm^2*s - 3*psq*s - 2*psq*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (2*psq - 3*s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*(psq - t)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (2*psq*s + mm^2*(2*psq - 3*s - 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (2*psq^2 + 2*mm^2*s - 3*psq*s - 2*psq*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
    Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q2, q2]])/
    Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*
     (gZlL + gZlR)*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*(psq - t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(psq - t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(2*mm^2 - 3*psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*
     (gZlL + gZlR)*(mm^2 - 2*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*
     (gZlL + gZlR)*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) + (4^(3 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*
     (gZlL + gZlR)*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(3 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(psq - t)^2*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(psq - t)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(psq - t)^2*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*
     (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2], SP[q2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFFA^2*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
