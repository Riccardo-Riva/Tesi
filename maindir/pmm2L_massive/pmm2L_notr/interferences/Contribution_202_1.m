...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*s*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*(psq + 4*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*(psq + 4*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(mm^2*(2*psq + 3*s) - 
     2*(psq^2 + psq*s - 2*s^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*
  ...
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(mm^2 - psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*
    (psq + 4*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*
    (mm^2*(-2*psq + 9*s) + 2*(psq^2 - 5*psq*s + 2*s^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/Pi^(2*d) - (2^(7 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/(Pi^(2*d)*s) + 
  (2^(7 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(-psq^2 - 10*psq*s + 4*s^2 + 
     mm^2*(psq + 10*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*
    (6*psq - 7*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (2^(7 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(-psq^2 - 10*psq*s + 4*s^2 + 
     mm^2*(psq + 10*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*(6*psq + s - 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(mm^2 + 4*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(7 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*psq*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/(Pi^(2*d)*s) - 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(5*mm^2 - 6*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(-2*psq^2 + mm^2*(psq - 3*s - t) + 
     2*psq*t + 4*s*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(5*mm^2 - 6*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(-4*psq^2 + mm^2*(3*psq + 9*s - t) + 
     2*psq*(-6*s + t) + 4*s*(s + t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(-4*s*t - 2*psq*(3*s + t) + 
     mm^2*(psq + 10*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(4*s*(-2*psq + 2*s + t) + 
     mm^2*(-psq + 5*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*psq^2 - 9*psq*s + 4*s^2 - 2*psq*t + 
     mm^2*(-2*psq + 9*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(-2*psq^2 - 6*psq*s + 
     mm^2*(psq + 2*s - t) + 2*psq*t + 4*s*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(4*s*(s - t) + mm^2*(psq + 4*s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(-psq^2 + 2*s*(2*mm^2 + s) + 
     psq*(-4*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*
    (-2*psq^2 - 7*psq*s + 4*s^2 + mm^2*(2*psq + 7*s - 2*t) + 2*psq*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(7*mm^2 - 3*psq - 4*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(-4*mm^2 + 2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(mm^2 - psq - 2*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA^3*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(mm^2 - 5*psq + 4*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*mm^2 + s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(4*mm^2 - 6*psq + s + 2*t)*
   ...
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA^3*
  ...
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA^3*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(mm^2 - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(-psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*(psq - t)*\[Mu]^(8 - 2*d)*
