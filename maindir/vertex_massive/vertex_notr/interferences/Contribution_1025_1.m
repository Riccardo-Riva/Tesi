...
PropList[KiraPropagator[-q1, mw], KiraPropagator[p1 - q2, mw], 
 ...
 (-(((-1 + d)*EL^6*gAl*gFAW*gFll*gWNl*gWWA^2*mm^2*s^2*\[Mu]^(8 - 2*d))/
    (2*Pi)^(2*d)) + (4^(1 - d)*(-1 + d)*EL^6*gAl*gFAW*gFll*gWNl*gWWA^2*mm^2*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-1 + d)*EL^6*gAl*gFAW*gFll*gWNl*gWWA^2*mm^2*
    (4*psq + (-1 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  ((-1 + d)*EL^6*gAl*gFAW*gFll*gWNl*gWWA^2*mm^2*(4*psq + (2 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*(-1 + d)*EL^6*gAl*gFAW*gFll*gWNl*gWWA^2*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*(-1 + d)*EL^6*gAl*gFAW*gFll*
  ...
  (4^(1 - d)*(2 - 3*d + d^2)*EL^6*gAl*gFAW*gFll*gWNl*gWWA^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-1 + d)*EL^6*gAl*gFAW*gFll*gWNl*gWWA^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-1 + d)*EL^6*gAl*gFAW*gFll*gWNl*gWWA^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(2 - 3*d + d^2)*EL^6*gAl*gFAW*gFll*gWNl*gWWA^2*mm^2*
