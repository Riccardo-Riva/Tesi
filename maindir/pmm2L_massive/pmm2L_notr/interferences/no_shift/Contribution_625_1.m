...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-4*psq^3 + (-2 + d)^2*mm^4*s + 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^2 - (2 + d)*psq + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^2 + 
      (10 - 3*d)*psq - 4*s + d*s - 6*t + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^2 + 
      (10 - 3*d)*psq - 4*s + d*s - 6*t + d*t)*\[Mu]^(8 - 2*d)*
