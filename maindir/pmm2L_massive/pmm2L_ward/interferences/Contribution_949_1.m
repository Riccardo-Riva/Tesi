  ...
  (((-I)*2^(-1 - 2*d)*EL^5*gAl^3*psq*s*
        ...
        2^(1 + 4*d)*gZlL*gZlR*Pi^(4*d)*(mm^4*((8 - 5*d + d^2)*psq - 4*s - 
          ...
          s*((4 + 13*d - 3*d^2)*psq^2 - (-4 + d)*s*((-4 + d)*s - 
              (-2 + d)*t) + psq*((20 - 15*d + 2*d^2)*s + (-4 - 13*d + 3*d^2)*
               t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mz^2*Pi^(6*d)) - 
   (I*2^(-1 - 4*d)*EL^5*gAl^3*((aa + bb)*(-4 + d)*(gZlL + gZlR)^2*
       (2*Pi)^(2*d)*(mm^2 - psq)*s^2 - 4^(1 + d)*(aa - bb)*(gZlL + gZlR)^2*
       mm^2*Pi^(2*d)*psq*(2*psq - s - 2*t) + 4^(1 + d)*(aa - bb)*
       (gZlL + gZlR)^2*Pi^(2*d)*psq*s*(2*psq - s - 2*t) - 
         ...
         ((8 - 5*d + d^2)*mm^4*(psq - s - t) + s*((4 + 13*d - 3*d^2)*psq^2 + 
            (-12 + d)*psq*s + (-4 - 13*d + 3*d^2)*psq*t + (8 - 6*d + d^2)*s*
             t) + mm^2*((16 - 9*d + d^2)*psq^2 - psq*((34 - 23*d + 4*d^2)*s + 
              ...
              (18 - 14*d + 3*d^2)*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   ...
   (I*EL^5*gAl^3*(aa*(gZlL^2*(2*Pi)^(4*d)*((4 - 5*d + d^2)*mm^4 + 
          2*(4 - 5*d + d^2)*psq^2 - psq*((28 - 17*d + 3*d^2)*s + 
            ...
            2*(6 - 5*d + d^2)*t) + mm^2*((-4 + 11*d - 3*d^2)*psq + 
            (-14 + 16*d - 3*d^2)*s + 4*(6 - 5*d + d^2)*t)) + 
        gZlR^2*(2*Pi)^(4*d)*((4 - 5*d + d^2)*mm^4 + 2*(4 - 5*d + d^2)*psq^2 - 
     ...
     SPList[SP[p1, p2], SP[p1, p3]])/(mz^2*(2*Pi)^(6*d)) + 
   (I*EL^5*gAl^3*(aa*(gZlL^2*((4 - 5*d + d^2)*mm^4*(2*Pi)^(4*d) + 
          mm^2*(2*Pi)^(4*d)*((-4 + 11*d - 3*d^2)*psq + (-14 + 16*d - 3*d^2)*
   ...
   (I*EL^5*gAl^3*(aa*(gZlL^2*(2*Pi)^(4*d)*((4 - 5*d + d^2)*mm^4 - 
          ...
          4*(6 - 5*d + d^2)*s*t + mm^2*((-4 + 11*d - 3*d^2)*psq + 
            (-14 + 16*d - 3*d^2)*s + 4*(6 - 5*d + d^2)*t)) + 
        gZlR^2*(2*Pi)^(4*d)*((4 - 5*d + d^2)*mm^4 - 2*(12 - 5*d + d^2)*
           psq^2 - 3*(12 - 7*d + d^2)*psq*s + 2*(16 - 11*d + 2*d^2)*s^2 + 
          2*(12 - 5*d + d^2)*psq*t + 4*(6 - 5*d + d^2)*s*t + 
          mm^2*((-4 + 11*d - 3*d^2)*psq + (-14 + 16*d - 3*d^2)*s + 
            4*(6 - 5*d + d^2)*t)) - 2^(1 + 4*d)*gZlL*gZlR*Pi^(4*d)*
         ((8 - 5*d + d^2)*mm^4 + 4*s*(-9*psq + 7*s + 6*t) + 
          mm^2*((-8 + 11*d - 3*d^2)*psq + (-28 + 16*d - 3*d^2)*s + 
            4*(6 - 5*d + d^2)*t) + d*(10*psq^2 + 21*psq*s - 22*s^2 - 
      ...
      bb*(gZlL^2*(2*Pi)^(4*d)*((12 - 5*d + d^2)*mm^4 - 2*(12 - 5*d + d^2)*
         ...
         ((12 - 5*d + d^2)*mm^4 - 2*(12 - 5*d + d^2)*psq^2 - 
          ...
          mm^2*((-12 + 11*d - 3*d^2)*psq + (42 - 34*d + 7*d^2)*s + 
            4*(6 - 5*d + d^2)*t)) - 2*gZlL*gZlR*
         (d^2*(2*Pi)^(4*d)*(mm^4 - 2*psq^2 - psq*s - 2*s^2 + 2*psq*t + 
            4*s*t + mm^2*(-3*psq + 7*s + 4*t)) + 4^(1 + 2*d)*Pi^(4*d)*
           (s*(11*psq - 11*s + 6*t) + mm^2*(9*s + 6*t)) - 
          d*(2*Pi)^(4*d)*(5*mm^4 - 10*psq^2 + 20*s*(-s + t) + 
            psq*(13*s + 10*t) + mm^2*(-11*psq + 34*s + 20*t)))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(mz^2*(2*Pi)^(6*d)) - 
   ...
   (I*EL^5*gAl^3*(bb*(gZlL^2*(2*Pi)^(4*d)*(-((4 - 5*d + d^2)*mm^4) - 
         ...
         (-((4 - 5*d + d^2)*mm^4) - 2*(12 - 5*d + d^2)*psq^2 - 
          3*(-4 - 3*d + d^2)*psq*s + 2*(-4 + d)*s^2 + 2*(12 - 5*d + d^2)*psq*
           t + 4*(6 - 5*d + d^2)*s*t + mm^2*((-44 + 29*d - 5*d^2)*psq + 
            (38 - 36*d + 7*d^2)*s + 4*(6 - 5*d + d^2)*t)) + 
        2^(1 + 4*d)*gZlL*gZlR*Pi^(4*d)*((8 - 5*d + d^2)*mm^4 + 
          4*s*(3*psq + s - 6*t) + mm^2*((40 - 29*d + 5*d^2)*psq + 
            (-52 + 36*d - 7*d^2)*s - 4*(6 - 5*d + d^2)*t) + 
          d^2*(2*psq^2 + 3*psq*s - 2*psq*t - 4*s*t) + 
          d*(-10*psq^2 - 9*psq*s - 2*s^2 + 10*psq*t + 20*s*t))) + 
      aa*(gZlL^2*(2*Pi)^(4*d)*((12 - 5*d + d^2)*mm^4 + 2*(12 - 5*d + d^2)*
           psq^2 + mm^2*((36 - 29*d + 5*d^2)*psq + (18 - 14*d + 3*d^2)*s - 
            4*(6 - 5*d + d^2)*t) - 2*s*((32 - 20*d + 3*d^2)*s + 
            2*(6 - 5*d + d^2)*t) + psq*((76 - 43*d + 5*d^2)*s - 
            2*(12 - 5*d + d^2)*t)) + gZlR^2*(2*Pi)^(4*d)*
         ((12 - 5*d + d^2)*mm^4 + 2*(12 - 5*d + d^2)*psq^2 + 
          mm^2*((36 - 29*d + 5*d^2)*psq + (18 - 14*d + 3*d^2)*s - 
            4*(6 - 5*d + d^2)*t) - 2*s*((32 - 20*d + 3*d^2)*s + 
            2*(6 - 5*d + d^2)*t) + psq*((76 - 43*d + 5*d^2)*s - 
            2*(12 - 5*d + d^2)*t)) - 2*gZlL*gZlR*
         (4^(1 + 2*d)*Pi^(4*d)*(s*(23*psq - 17*s - 6*t) + 
            3*mm^2*(4*psq + s - 2*t)) + d^2*(2*Pi)^(4*d)*(mm^4 + 2*psq^2 + 
            5*psq*s - 6*s^2 + mm^2*(5*psq + 3*s - 4*t) - 2*psq*t - 4*s*t) + 
          d*(2*Pi)^(4*d)*(-5*mm^4 - 10*psq^2 + 20*s*(2*s + t) + 
            psq*(-43*s + 10*t) + mm^2*(-29*psq - 14*s + 20*t)))))*
   ...
   (I*EL^5*gAl^3*(bb*(gZlL^2*(4^(1 + 3*d)*mm^4*Pi^(6*d) + 
          mm^2*(2*Pi)^(6*d)*((-8 - 3*d + d^2)*psq + (-18 + 9*d - 2*d^2)*s + 
   ...
   (I*EL^5*gAl^3*(aa*(gZlL^2*(64^d*(8 - 5*d + d^2)*mm^4*Pi^(6*d) - 
          mm^2*(2*Pi)^(6*d)*((-20 + 6*d)*psq + 2*(11 - 6*d + d^2)*s + 
          ...
          mm^2*(2*Pi)^(6*d)*((-20 + 6*d)*psq + 2*(11 - 6*d + d^2)*s + 
           ...
           Pi^(6*d) + mm^2*(2*Pi)^(6*d)*((16 - 6*d)*psq - 2*(7 - 6*d + d^2)*
             s + (4 - 3*d + d^2)*t) + (2*Pi)^(6*d)*(2*(4 - 5*d + d^2)*psq^2 - 
   ...
   (I*EL^5*gAl^3*(aa*(gZlL^2*(2*Pi)^(6*d)*((12 - 7*d + d^2)*psq^2 + 
        ...
        gZlR^2*(2*Pi)^(6*d)*((12 - 7*d + d^2)*psq^2 + (6 - 4*d + d^2)*psq*s + 
   ...
   (I*EL^5*gAl^3*(bb*(2^(1 + 6*d)*gZlL*gZlR*Pi^(6*d)*
         (4*mm^4 + mm^2*(-((12 - 5*d + d^2)*psq) + 3*(2 - 5*d + d^2)*s + 
            (8 - 5*d + d^2)*t) + s*(-((-36 + 2*d + d^2)*psq) + 
            (-16 + 3*d)*s + (-4 - 4*d + d^2)*t)) + gZlL^2*(2*Pi)^(6*d)*
         (4*mm^4 + mm^2*(-30*s - 5*d*(psq - 3*s - t) + d^2*(psq - 3*s - t) - 
            4*t) + s*((6 + 2*d + d^2)*psq + (2 - 3*d)*s - (10 - 4*d + d^2)*
             t)) + gZlR^2*(2*Pi)^(6*d)*(4*mm^4 + 
          mm^2*(-30*s - 5*d*(psq - 3*s - t) + d^2*(psq - 3*s - t) - 4*t) + 
          s*((6 + 2*d + d^2)*psq + (2 - 3*d)*s - (10 - 4*d + d^2)*t))) + 
      aa*(2^(1 + 6*d)*gZlL*gZlR*Pi^(6*d)*(mm^2*((8 - 5*d + d^2)*psq - 2*s - 
            (8 - 5*d + d^2)*t) + s*((-16 + 3*d)*psq - (-4 - 4*d + d^2)*
             (s + t))) - gZlR^2*(2*Pi)^(6*d)*
         (mm^2*((4 - 5*d + d^2)*psq + 2*s - (4 - 5*d + d^2)*t) - 
          s*((2 - 3*d)*psq + (10 - 4*d + d^2)*(s + t))) + 
        gZlL^2*(2*Pi)^(6*d)*(mm^2*(-((4 - 5*d + d^2)*psq) - 2*s + 
            (4 - 5*d + d^2)*t) + s*((2 - 3*d)*psq + (10 - 4*d + d^2)*
   ...
   (I*EL^5*gAl^3*(aa*(-2*gZlL*gZlR*(64^d*(8 - 5*d + d^2)*mm^4*Pi^(6*d) + 
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(mz^2*(2*Pi)^(8*d)) - 
   (I*EL^5*gAl^3*
   ...
   (I*EL^5*gAl^3*(-(bb*(-2*gZlL*gZlR*(64^d*(4 - 5*d + d^2)*mm^4*Pi^(6*d) + 
           mm^2*(2*Pi)^(6*d)*(2*(14 - 7*d + d^2)*psq + (-24 + 21*d - 4*d^2)*
              s - (8 - 5*d + d^2)*t) - (2*Pi)^(6*d)*s*(-((-20 + d^2)*psq) + 
             2*(-4 + d)*s + (-4 - 4*d + d^2)*t)) + 
         gZlL^2*(64^d*(8 - 5*d + d^2)*mm^4*Pi^(6*d) + mm^2*(2*Pi)^(6*d)*
            (2*(10 - 7*d + d^2)*psq + (-30 + 21*d - 4*d^2)*s - 
             (4 - 5*d + d^2)*t) + (2*Pi)^(6*d)*s*((2 + d^2)*psq - 
             2*(-2 + d)*s - (10 - 4*d + d^2)*t)) + 
         gZlR^2*(64^d*(8 - 5*d + d^2)*mm^4*Pi^(6*d) + mm^2*(2*Pi)^(6*d)*
            (2*(10 - 7*d + d^2)*psq + (-30 + 21*d - 4*d^2)*s - 
             (4 - 5*d + d^2)*t) + (2*Pi)^(6*d)*s*((2 + d^2)*psq - 
             2*(-2 + d)*s - (10 - 4*d + d^2)*t)))) + 
      aa*(gZlL^2*(64^d*(4 - 5*d + d^2)*mm^4*Pi^(6*d) + mm^2*(2*Pi)^(6*d)*
           (2*(12 - 7*d + d^2)*psq + (2 + 6*d - d^2)*s - (4 - 5*d + d^2)*t) - 
          (2*Pi)^(6*d)*s*(-((-6 + d)*psq) + (8 - 5*d + d^2)*s + 
            (10 - 4*d + d^2)*t)) + gZlR^2*(64^d*(4 - 5*d + d^2)*mm^4*
           Pi^(6*d) + mm^2*(2*Pi)^(6*d)*(2*(12 - 7*d + d^2)*psq + 
            (2 + 6*d - d^2)*s - (4 - 5*d + d^2)*t) - (2*Pi)^(6*d)*s*
           (-((-6 + d)*psq) + (8 - 5*d + d^2)*s + (10 - 4*d + d^2)*t)) - 
        2*gZlL*gZlR*(64^d*(8 - 5*d + d^2)*mm^4*Pi^(6*d) + 
          mm^2*(2*Pi)^(6*d)*(2*(12 - 7*d + d^2)*psq - (20 - 6*d + d^2)*s - 
            (8 - 5*d + d^2)*t) - 64^d*Pi^(6*d)*s*(4*(s - t) + d^2*(s + t) - 
            d*(psq + 5*s + 4*t)))))*\[Mu]^(8 - 2*d)*
   ...
   (I*EL^5*gAl^3*
     (-(bb*(-(2^(1 + 6*d)*gZlL*gZlR*Pi^(6*d)*((8 - 5*d + d^2)*mm^4 + 
            mm^2*(-4*(-2 + d)*psq + (-12 + d)*s + (8 - 5*d + d^2)*t) + 
            s*((8 + 9*d - 2*d^2)*psq + (-8 + d)*s + (-4 - 4*d + d^2)*t))) + 
         gZlL^2*(2*Pi)^(6*d)*((4 - 5*d + d^2)*mm^4 + 
           mm^2*(-4*(-4 + d)*psq + (6 + d)*s + (4 - 5*d + d^2)*t) + 
           s*((-26 + 9*d - 2*d^2)*psq + (2 + d)*s + (10 - 4*d + d^2)*t)) + 
         gZlR^2*(2*Pi)^(6*d)*((4 - 5*d + d^2)*mm^4 + 
           mm^2*(-4*(-4 + d)*psq + (6 + d)*s + (4 - 5*d + d^2)*t) + 
           s*((-26 + 9*d - 2*d^2)*psq + (2 + d)*s + (10 - 4*d + d^2)*t)))) + 
      aa*(-(2^(1 + 6*d)*gZlL*gZlR*Pi^(6*d)*((4 - 5*d + d^2)*mm^4 + 
           mm^2*(-4*(-3 + d)*psq + (-16 + 16*d - 3*d^2)*s + 
             (8 - 5*d + d^2)*t) + s*(-((12 - 8*d + d^2)*psq) + 
             (4 - 6*d + d^2)*s + (-4 - 4*d + d^2)*t))) + 
        gZlL^2*(2*Pi)^(6*d)*((8 - 5*d + d^2)*mm^4 + 
          mm^2*(-4*(-3 + d)*psq + (-26 + 16*d - 3*d^2)*s + 
            (4 - 5*d + d^2)*t) + s*(-((18 - 8*d + d^2)*psq) + 
   ...
   (I*EL^5*gAl^3*(aa*(2*gZlL*gZlR*(4^(1 + 3*d)*mm^4*Pi^(6*d) + 
          2^(1 + 6*d)*Pi^(6*d)*(-((4 - 5*d + d^2)*psq^2) - 2*(-3 + d)*psq*s + 
            (-2 + d)*s^2 + (4 - 5*d + d^2)*psq*t + (2 + d)*s*t) + 
          mm^2*(2*Pi)^(6*d)*(d^2*(psq + s - t) - 3*d*(psq + 2*s - t) - 
            4*(s + t))) + gZlL^2*(4^(1 + 3*d)*mm^4*Pi^(6*d) - 
   ...
   (I*EL^5*gAl^3*(bb*(gZlL^2*(2*Pi)^(6*d)*(-((12 - 7*d + d^2)*psq^2) - 
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(mz^2*(2*Pi)^(8*d)) - 
   (I*EL^5*gAl^3*(bb*(-(2^(1 + 6*d)*gZlL*gZlR*Pi^(6*d)*
          (s*((8 - 11*d + 2*d^2)*psq + (4 + 4*d - d^2)*t) + 
           mm^2*((8 - 5*d + d^2)*psq - (6 - 5*d + d^2)*s - (8 - 5*d + d^2)*
              t))) + gZlL^2*(2*Pi)^(6*d)*(mm^2*((4 - 5*d + d^2)*psq - 
            (6 - 5*d + d^2)*s - (4 - 5*d + d^2)*t) + 
          s*((22 - 11*d + 2*d^2)*psq - (10 - 4*d + d^2)*t)) + 
        gZlR^2*(2*Pi)^(6*d)*(mm^2*((4 - 5*d + d^2)*psq - (6 - 5*d + d^2)*s - 
            (4 - 5*d + d^2)*t) + s*((22 - 11*d + 2*d^2)*psq - 
            (10 - 4*d + d^2)*t))) + 
      aa*(2*gZlL*gZlR*(4^(1 + 3*d)*mm^4*Pi^(6*d) + mm^2*(2*Pi)^(6*d)*
           ((4 - 5*d + d^2)*psq + 2*(-1 - 5*d + d^2)*s - (8 - 5*d + d^2)*t) - 
          (2*Pi)^(6*d)*s*(-((28 - 10*d + d^2)*psq) + (12 - 7*d + d^2)*s + 
            (-4 - 4*d + d^2)*t)) + gZlL^2*(4^(1 + 3*d)*mm^4*Pi^(6*d) - 
          mm^2*(2*Pi)^(6*d)*((8 - 5*d + d^2)*psq + 2*(13 - 5*d + d^2)*s - 
            (4 - 5*d + d^2)*t) + (2*Pi)^(6*d)*s*(-((14 - 10*d + d^2)*psq) + 
            (12 - 7*d + d^2)*s + (10 - 4*d + d^2)*t)) + 
        gZlR^2*(4^(1 + 3*d)*mm^4*Pi^(6*d) - mm^2*(2*Pi)^(6*d)*
           ((8 - 5*d + d^2)*psq + 2*(13 - 5*d + d^2)*s - (4 - 5*d + d^2)*t) + 
          (2*Pi)^(6*d)*s*(-((14 - 10*d + d^2)*psq) + (12 - 7*d + d^2)*s + 
   ...
   (I*4^(2 - d)*(aa + bb)*(12 - 7*d + d^2)*EL^5*gAl^3*(gZlL - gZlR)^2*psq*
    ...
    (mz^2*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl^3*
     (bb*(-2*gZlL*gZlR*(2*(5 - 5*d + d^2)*mm^2 - 2*(8 - 9*d + 2*d^2)*psq - 
          10*s + 3*d*s + 12*t - 10*d*t + 2*d^2*t) + 
        gZlL^2*(2*(7 - 5*d + d^2)*mm^2 - 2*(10 - 9*d + 2*d^2)*psq - 8*s + 
          3*d*s + 12*t - 10*d*t + 2*d^2*t) + gZlR^2*(2*(7 - 5*d + d^2)*mm^2 - 
          2*(10 - 9*d + 2*d^2)*psq - 8*s + 3*d*s + 12*t - 10*d*t + 
          2*d^2*t)) + aa*(gZlL^2*(2*(5 - 5*d + d^2)*mm^2 + 2*(-2 + d)*psq - 
          16*s + 11*d*s - 2*d^2*s - 12*t + 10*d*t - 2*d^2*t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl^3*
     (bb*(-2*gZlL*gZlR*(2*(5 - 5*d + d^2)*mm^2 + (8 + 4*d - 2*d^2)*psq - 
          10*s + 3*d*s + 12*t - 10*d*t + 2*d^2*t) + 
        gZlL^2*(2*(7 - 5*d + d^2)*mm^2 + (4 + 4*d - 2*d^2)*psq - 8*s + 
          3*d*s + 12*t - 10*d*t + 2*d^2*t) + gZlR^2*(2*(7 - 5*d + d^2)*mm^2 + 
          (4 + 4*d - 2*d^2)*psq - 8*s + 3*d*s + 12*t - 10*d*t + 2*d^2*t)) + 
   ...
   (I*4^(1 - d)*EL^5*gAl^3*
     (aa*(gZlL^2*(2*(7 - 5*d + d^2)*mm^2 - 2*(-2 + d)*psq - 20*s + 13*d*s - 
          2*d^2*s - 12*t + 10*d*t - 2*d^2*t) + 
        gZlR^2*(2*(7 - 5*d + d^2)*mm^2 - 2*(-2 + d)*psq - 20*s + 13*d*s - 
          2*d^2*s - 12*t + 10*d*t - 2*d^2*t) + 2*gZlL*gZlR*
         (-2*(5 - 5*d + d^2)*mm^2 + 2*(-4 + d)*psq + 22*s - 13*d*s + 
          2*d^2*s + 12*t - 10*d*t + 2*d^2*t)) + 
     ...
     SPList[SP[p1, p2], SP[p1, p2], SP[p2, p3]])/(mz^2*Pi^(2*d)) + 
   (I*4^(1 - d)*EL^5*gAl^3*
   ...
   (I*4^(1 - d)*EL^5*gAl^3*
     (aa*(gZlL^2*(2*(7 - 5*d + d^2)*mm^2 + 2*(14 - 8*d + d^2)*psq - 20*s + 
          13*d*s - 2*d^2*s - 12*t + 10*d*t - 2*d^2*t) + 
        gZlR^2*(2*(7 - 5*d + d^2)*mm^2 + 2*(14 - 8*d + d^2)*psq - 20*s + 
          13*d*s - 2*d^2*s - 12*t + 10*d*t - 2*d^2*t) + 
        2*gZlL*gZlR*(-2*(5 - 5*d + d^2)*mm^2 - 2*(-4 + d)^2*psq + 22*s - 
          13*d*s + 2*d^2*s + 12*t - 10*d*t + 2*d^2*t)) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     (bb*(-2*gZlL*gZlR*((-6 - 5*d + d^2)*mm^2 + (-56 + 47*d - 7*d^2)*psq + 
        ...
        2*gZlL*gZlR*((6 - 5*d + d^2)*mm^2 + (-40 + 19*d - 3*d^2)*psq + 8*s + 
          4*t + 2*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     (aa*(-2*gZlL*gZlR*((6 - 5*d + d^2)*mm^2 + (-8 - 3*d + d^2)*psq - 
        ...
        gZlR^2*((6 - 5*d + d^2)*mm^2 + (8 - 3*d + d^2)*psq - 
          2*(10 - 5*d + d^2)*(s + t))) + 
      bb*(gZlL^2*((34 - 15*d + 3*d^2)*mm^2 + (-48 + 23*d - 5*d^2)*psq + 
          2*(10 - 5*d + d^2)*(s + t)) + gZlR^2*((34 - 15*d + 3*d^2)*mm^2 + 
          (-48 + 23*d - 5*d^2)*psq + 2*(10 - 5*d + d^2)*(s + t)) - 
        2*gZlL*gZlR*((2 - 15*d + 3*d^2)*mm^2 + 4*(s + t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     (aa*(-2*gZlL*gZlR*((18 - 5*d + d^2)*mm^2 + (8 - 7*d + d^2)*psq + 
          2*(-4 + d)*s + 2*(2 - 5*d + d^2)*t) + 
        gZlL^2*((-6 - 5*d + d^2)*mm^2 + (16 - 7*d + d^2)*psq + 2*(-2 + d)*s + 
          2*(10 - 5*d + d^2)*t) + gZlR^2*((-6 - 5*d + d^2)*mm^2 + 
          (16 - 7*d + d^2)*psq + 2*(-2 + d)*s + 2*(10 - 5*d + d^2)*t)) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     (bb*(gZlL^2*((6 + 5*d - d^2)*mm^2 + (-56 + 27*d - 5*d^2)*psq + 
          2*(12 - 6*d + d^2)*s + 2*(10 - 5*d + d^2)*t) + 
        gZlR^2*((6 + 5*d - d^2)*mm^2 + (-56 + 27*d - 5*d^2)*psq + 
          2*(12 - 6*d + d^2)*s + 2*(10 - 5*d + d^2)*t) + 
        2*gZlL*gZlR*((18 - 5*d + d^2)*mm^2 + (16 - 27*d + 5*d^2)*psq - 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     (aa*(-2*gZlL*gZlR*((2 - 15*d + 3*d^2)*mm^2 + (8 + 3*d - d^2)*psq - 
          2*(2 - 5*d + d^2)*t) + gZlL^2*((34 - 15*d + 3*d^2)*mm^2 - 
          (8 - 3*d + d^2)*psq - 2*(10 - 5*d + d^2)*t) + 
        gZlR^2*((34 - 15*d + 3*d^2)*mm^2 - (8 - 3*d + d^2)*psq - 
          2*(10 - 5*d + d^2)*t)) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     (bb*(gZlL^2*(2*mm^2 - 4*(-2 + d)*psq - 14*s + 8*d*s - d^2*s + 20*t - 
        ...
        2*gZlL*gZlR*(2*(5 - 5*d + d^2)*mm^2 + (-4 + d)*(6*(-3 + d)*psq + 
            14*s - 5*d*s + 4*t - 2*d*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, p3], SP[p2, q1]])/(mz^2*Pi^(2*d)) - 
   (I*2^(1 - 2*d)*EL^5*gAl^3*(bb*((10 - 6*d + d^2)*gZlL^2 - 
        2*(8 - 6*d + d^2)*gZlL*gZlR + (10 - 6*d + d^2)*gZlR^2)*(psq - t) + 
      aa*(2*(-4 + d)*gZlL*gZlR*((-1 + d)*mm^2 - psq + 6*s - 2*d*s + 2*t - 
          d*t) + gZlL^2*(-((8 - 5*d + d^2)*mm^2) + (-2 + d)*psq + 24*s - 
