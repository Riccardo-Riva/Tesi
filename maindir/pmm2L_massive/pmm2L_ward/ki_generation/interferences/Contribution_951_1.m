...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, ml]]*((I*2^(1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
       mm^2*s*(aa*((-2 + d)*mm^2 + (2 + d)*psq - d*(s + 2*t)) + 
        bb*((-2 + d)*mm^2 + (2 - 3*d)*psq + d*(s + 2*t)))*\[Mu]^(8 - 2*d))/
      (mz^2*Pi^(2*d)) + (I*2^(1 - 4*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
       ...
       SPList[SP[p1, q1]])/(mz^2*Pi^(4*d)) - 
     (I*2^(1 - 2*d)*EL^5*gAl^3*mm^2*
       (-(bb*((-4 + d)*gZlL^2*((-1 + d)*psq^2 + (-1 + d)*mm^2*(psq - s - t) + 
     ...
     (I*2^(1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
      ...
      (mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^3*mm^2*
     ...
     (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
       (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(mz^2*Pi^(2*d)) - 
     ...
     (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
       (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q1]])/(mz^2*Pi^(2*d)) + 
     (I*4^(1 - d)*EL^5*gAl^3*mm^2*
       (-(bb*((4 - 5*d + d^2)*gZlL^2 - 2*(8 - 5*d + d^2)*gZlL*gZlR + 
           (4 - 5*d + d^2)*gZlR^2)*(psq - s - t)) + 
        aa*(2*gZlL*gZlR*(4*mm^2 - (12 - 5*d + d^2)*psq + (8 - 5*d + d^2)*
             (s + t)) + gZlL^2*(4*mm^2 + d^2*(psq - s - t) - 4*(s + t) + 
            5*d*(-psq + s + t)) + gZlR^2*(4*mm^2 + d^2*(psq - s - t) - 
            4*(s + t) + 5*d*(-psq + s + t))))*\[Mu]^(8 - 2*d)*
     ...
     (I*4^(1 - d)*EL^5*gAl^3*
       (-(bb*(gZlL^2*((8 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
             mm^2*(-4*(-3 + d)*psq - (10 - 6*d + d^2)*s + (4 - 5*d + d^2)*
                t)) + gZlR^2*((8 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
             mm^2*(-4*(-3 + d)*psq - (10 - 6*d + d^2)*s + (4 - 5*d + d^2)*
                t)) - 2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*
              psq*s + mm^2*(-4*(-3 + d)*psq - (8 - 6*d + d^2)*s + 
               (8 - 5*d + d^2)*t)))) + 
        aa*(gZlL^2*((4 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
            mm^2*(-4*(-4 + d)*psq - (10 - 6*d + d^2)*s + (4 - 5*d + d^2)*
               t)) + gZlR^2*((4 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
            mm^2*(-4*(-4 + d)*psq - (10 - 6*d + d^2)*s + (4 - 5*d + d^2)*
               t)) - 2*gZlL*gZlR*((8 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*
             s + mm^2*(-4*(-2 + d)*psq - (8 - 6*d + d^2)*s + 
              (8 - 5*d + d^2)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
        SP[p2, q2]])/(mz^2*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*
       gAl^3*(gZlL + gZlR)^2*ml^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     ...
     (I*4^(1 - d)*EL^5*gAl^3*
       (-(bb*(gZlL^2*((4 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
             mm^2*(2*(12 - 7*d + d^2)*psq + (-14 + 11*d - 2*d^2)*s - 
               (4 - 5*d + d^2)*t)) + gZlR^2*((4 - 5*d + d^2)*mm^4 + 
             (12 - 7*d + d^2)*psq*s + mm^2*(2*(12 - 7*d + d^2)*psq + 
               (-14 + 11*d - 2*d^2)*s - (4 - 5*d + d^2)*t)) - 
           2*gZlL*gZlR*((8 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
             mm^2*(2*(12 - 7*d + d^2)*psq + (-16 + 11*d - 2*d^2)*s - 
               (8 - 5*d + d^2)*t)))) + 
        aa*(gZlL^2*((8 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
            mm^2*(2*(10 - 7*d + d^2)*psq + (-14 + 11*d - 2*d^2)*s - 
              (4 - 5*d + d^2)*t)) + gZlR^2*((8 - 5*d + d^2)*mm^4 + 
            (12 - 7*d + d^2)*psq*s + mm^2*(2*(10 - 7*d + d^2)*psq + 
              (-14 + 11*d - 2*d^2)*s - (4 - 5*d + d^2)*t)) - 
          2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
            mm^2*(2*(14 - 7*d + d^2)*psq + (-16 + 11*d - 2*d^2)*s - 
              (8 - 5*d + d^2)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
        SP[p2, q1]])/(mz^2*Pi^(2*d)) - (I*2^(3 - 2*d)*EL^5*gAl^3*
       (gZlL + gZlR)^2*mm^2*(bb*(2*mm^2 - s - 2*t) + 
        aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q2], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
     (I*4^(1 - 2*d)*EL^5*gAl^3*(bb*(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
     ...
     (I*2^(3 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*s*(bb*(psq - s - t) + 
        aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
        SP[q1, q2]])/(mz^2*Pi^(2*d)) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*
       (gZlL + gZlR)^2*ml^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)) + 
     (I*4^(1 - d)*EL^5*gAl^3*mm^2*(aa*((4 - 5*d + d^2)*gZlL^2 - 
          2*(8 - 5*d + d^2)*gZlL*gZlR + (4 - 5*d + d^2)*gZlR^2)*(psq - t) + 
        bb*(gZlL^2*(4*mm^2 - (8 - 5*d + d^2)*psq + (4 - 5*d + d^2)*t) + 
          gZlR^2*(4*mm^2 - (8 - 5*d + d^2)*psq + (4 - 5*d + d^2)*t) + 
          2*gZlL*gZlR*(4*mm^2 + (4 - 5*d + d^2)*psq - (8 - 5*d + d^2)*t)))*
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)) + 
     (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
       (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
      (mz^2*Pi^(2*d)) + (I*2^(1 - 4*d)*EL^5*gAl^3*
       (-(bb*(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(mm^2*(8*psq + 4*s - 2*d*s - 8*
                t) + (-4 + d)*s*((-2 + d)*psq - (-4 + d)*t)) + 
     ...
     (I*4^(1 - d)*(-4 + d)*EL^5*gAl^3*
       (bb*((-2 + d)*gZlL^2 - 2*(-4 + d)*gZlL*gZlR + (-2 + d)*gZlR^2)*
         (psq - s - t) + aa*(2*gZlL*gZlR*(2*mm^2 + (-6 + d)*psq - 
            ...
            d*(-psq + s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     ...
     (I*4^(1 - d)*(-3 + d)*EL^5*gAl^3*(gZlL - gZlR)^2*(2*aa*(-2 + d)*mm^2 - 
     ...
     (I*4^(1 - d)*(-4 + d)*EL^5*gAl^3*
      ...
      (mz^2*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl^3*
       (aa*((-4 + d)*gZlL^2*(2*(-2 + d)*mm^2 + (-4 + d)*(4*psq - s - 2*t)) + 
          ...
          2*gZlL*gZlR*(2*(-2 + d)^2*mm^2 + (20 - 10*d + d^2)*
             (4*psq - s - 2*t))) + bb*((-4 + d)*gZlL^2*(2*(-2 + d)*mm^2 + 
            (-4 + d)*(s + 2*t)) + (-4 + d)*gZlR^2*(2*(-2 + d)*mm^2 + 
            (-4 + d)*(s + 2*t)) - 2*gZlL*gZlR*(2*(-2 + d)^2*mm^2 + 
     ...
     (I*4^(1 - d)*EL^5*gAl^3*(-(bb*(-2 + d)*((-2 + d)*gZlL^2 - 
        ...
        aa*(-2*(-4 + d)*gZlL*gZlR*(2*(-2 + d)*psq + (-4 + d)*s - 
            ...
            2*(-2 + d)^2*t) + gZlR^2*(2*(-2 + d)^2*psq + (20 - 10*d + d^2)*
     ...
     (I*4^(1 - d)*EL^5*gAl^3*(bb*(-2*(-4 + d)*gZlL*gZlR*(2*psq + (-4 + d)*s - 
     ...
     (I*4^(1 - d)*EL^5*gAl^3*(aa*((-4 + d)^2*gZlL^2 - 2*(20 - 10*d + d^2)*
           gZlL*gZlR + (-4 + d)^2*gZlR^2)*(psq - t) + 
     ...
     (I*4^(1 - d)*(-3 + d)*EL^5*gAl^3*(gZlL - gZlR)^2*(2*bb*(-2 + d)*mm^2 + 
        aa*(-6 + d)*(psq - t) + bb*(-6 + d)*(psq + t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q1], SP[p2, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)) - 
     (I*4^(2 - d)*EL^5*gAl^3*(gZlL + gZlR)^2*(bb*(2*mm^2 - psq - t) + 
     ...
     (I*2^(3 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*(bb*(2*mm^2 - psq - t) + 
        ...
        SP[q1, q1]])/(mz^2*Pi^(2*d)) - (I*2^(3 - 2*d)*bb*(12 - 7*d + d^2)*
       EL^5*gAl^3*(gZlL - gZlR)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     ...
     (I*4^(2 - d)*(aa - bb)*(12 - 7*d + d^2)*EL^5*gAl^3*(gZlL - gZlR)^2*
       ...
       gAl^3*(gZlL - gZlR)^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
        SP[p3, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)) + 
     (I*4^(2 - d)*(aa - bb)*(12 - 7*d + d^2)*EL^5*gAl^3*(gZlL - gZlR)^2*
   ...
   PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, ml]]*(((-I)*2^(1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*
       ml^2*mm^2*s*(aa*((-2 + d)*mm^2 + (2 + d)*psq - d*(s + 2*t)) + 
        bb*((-2 + d)*mm^2 + (2 - 3*d)*psq + d*(s + 2*t)))*\[Mu]^(8 - 2*d))/
      (mz^2*Pi^(2*d)) - (I*2^(1 - 4*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
       (-(2^(1 + 2*d)*aa*Pi^(2*d)*s*(2*mm^2 - 3*psq + s + t)) + 
        2^(1 + 2*d)*bb*Pi^(2*d)*s*(-psq + s + t) + aa*d*(2*Pi)^(2*d)*
