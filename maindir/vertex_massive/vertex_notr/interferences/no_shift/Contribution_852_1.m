...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*EL^6*gAl^6*mm^4*(2*(2 - 3*d + d^2)*mm^2 - 
   ...
   (2^(3 - 2*d)*EL^6*gAl^6*mm^2*(2*(8 - 5*d + d^2)*mm^2 - 
     ...
     SPList[SP[q2, q2]])/Pi^(2*d) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^6*mm^2*
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl^6*(2*mm^4 - (-2 + d)*psq*s - 
      ...
      SP[p1, q2]])/(Pi^(2*d)*s) + (4^(3 - d)*(-2 + d)*EL^6*gAl^6*mm^2*
   ...
   (4^(3 - d)*(-2 + d)*EL^6*gAl^6*mm^2*\[Mu]^(8 - 2*d)*
