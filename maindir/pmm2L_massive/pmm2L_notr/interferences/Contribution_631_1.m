...
PropList[KiraPropagator[-p3 + q1, 0], KiraPropagator[q2, mz], 
  KiraPropagator[p3 + q2, mm], KiraPropagator[p3 + q2, mm], 
  KiraPropagator[-p1 - p2 + p3 + q2, mm], KiraPropagator[q1 + q2, mm]]*
 ((2^(1 - 2*d)*(-2 + d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(mm^2 - psq)^2*
    \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) + (2^(1 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*
    mm^4*(mm^2 - psq)*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(mm^2 - psq)*
    (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (mm^2 - psq)^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    ((4 - 10*d + 3*d^2)*mm^2 - (-2 + d)^2*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
  ((-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    (4*psq^2 + d*s*(-2*mm^2 + s) + 2*psq*(d*s - 4*t) + 4*(-s^2 + s*t + t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(4^d*Pi^(2*d)*s^2) + 
  (EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*d*mm^2*(4*psq^2 + (-6 + d)*mm^2*s - 
       4*s^2 + d*s^2 + 4*s*t + 4*t^2 - psq*((-6 + d)*s + 8*t)) + 
     (-2 + d)*(mm^2 - psq)*(4*psq^2 + d*s*(-2*mm^2 + s) + 2*psq*(d*s - 4*t) + 
       4*(-s^2 + s*t + t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   ((2*Pi)^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    gXll^2*mm^2*(mm^2 - psq)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (mm^2*(4*psq + (-10 + d)*s - 4*t) + (-2 + d)*psq*
      (2*psq + (-5 + d)*s - 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(d^2*(mm^2 - 2*psq)*s + 
     8*(mm^2 - psq)*s + 8*d*psq*s + 2*d*mm^2*(psq - 4*s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*(psq - t)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ((8 - 4*d + d^2)*mm^2 - (8 - 6*d + d^2)*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (4*psq^2 + d*s*(-2*mm^2 + s) + 2*psq*(d*s - 4*t) + 4*(-s^2 + s*t + t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((12 - 14*d + 3*d^2)*mm^2 - 
     3*(-2 + d)^2*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q2, q2]])/
  ...
  ((-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*psq^2 + 2*(-4 + d)*mm^2*s - 
     4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 2*psq*((-4 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2], SP[q2, q2]])/(4^d*Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-psq + s + t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - 3*psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - psq - t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*psq + 3*s + 2*t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq - t)*
