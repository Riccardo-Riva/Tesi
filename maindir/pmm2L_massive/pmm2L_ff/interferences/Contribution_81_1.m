...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(4*(-1 + d)*psq^3 - 
       2*psq^2*((-4 + d)*s + 6*(-1 + d)*t) + 
       (s + t)*((-4 + d)*s^2 - 2*(-4 + d)*s*t - 4*(-1 + d)*t^2) + 
       psq*(-3*(-4 + d)*s^2 + 4*(-5 + 2*d)*s*t + 12*(-1 + d)*t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(4*(-1 + d)*psq^3 - 
       2*psq^2*((2 + d)*s + 6*(-1 + d)*t) - t*((8 + d)*s^2 + 6*d*s*t + 
         4*(-1 + d)*t^2) + psq*((-4 + d)*s^2 + 12*(-1 + d)*t^2 + 
         4*s*(t + 2*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((-1 + d)*mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      ...
      gWWA^2*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      ...
      (-2*(-14 + 3*d)*psq*(psq - s - t) + mm^2*(2*(-7 + 2*d)*psq + 8*s - 
         3*d*s + 14*t - 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((14 - 5*d)*psq^2 + 
       2*psq*((-18 + 5*d)*s + 4*(-3 + d)*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(mm^2 - psq)*
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      ...
      (2*(-2 + d)*psq^2 + (-2 + d)*mm^2*s + 
       psq*((16 - 6*d)*s - 4*(-2 + d)*t) + (s + t)*((-10 + 3*d)*s + 
