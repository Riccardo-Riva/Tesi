...
PropList[KiraPropagator[q1, mh], KiraPropagator[q2, mh], 
 ...
 ((I*4^(-1 - d)*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*s*
  ...
  (I*4^(-1 - d)*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*
  ...
  (I*(aa + bb)*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*4^(-1 - d)*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*s*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/Pi^(2*d) - (I*(aa + bb)*EL^5*gAl*gHHH^2*gHll^2*mh^4*
    mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHHH^2*gHll^2*mh^4*mm^2*
