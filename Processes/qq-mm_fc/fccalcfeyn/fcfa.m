...
Export[NotebookDirectory[]<>"feynArts_amplitudes/BornAmplitudes.m",myAmpBorn];
Export[NotebookDirectory[]<>"feynArts_amplitudes/OneLoopTPAmplitudes.m",myAmp1LTP];
Export[NotebookDirectory[]<>"feynArts_amplitudes/OneLoopAmplitudes.m",myAmp1L];
