...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 ((EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(-2*(-2 + d)*mm^4*s + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
   ...
   (4^d*Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
    (2*(-4 + d)*mm^4*s + (-2 + d)*psq*s^2 + 
     2*mm^2*(6*psq^2 + (-2 + d)*s^2 + 6*s*t + 6*t^2 - 
       psq*((-4 + d)*s + 12*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (4^d*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
    (4*psq^2 + (-2 + d)*mm^2*s + (s + 2*t)^2 - psq*((-2 + d)*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(2*psq + (-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(2*mm^2 + 4*psq - 9*s + 
     2*d*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(psq*(psq - s - t) + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(psq + (-3 + d)*s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(2*mm^2 - 8*psq - 3*s + 
     2*d*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-7 + 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
    (-((-2 + d)*psq*s) + 2*mm^2*(7*psq + (-14 + d)*s - 7*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(-2*psq + 3*s + 2*t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(2*psq + (-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(2*psq + s - 2*t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(d*(mm^2 - psq) + 4*psq)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(10*mm^2 + (-3 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(2*mm^2 + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(4*psq^2 + 2*(-2 + d)*mm^2*s - 2*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(-2*psq + s + 2*t)*
   ...
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
    (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(-2*psq + d*s + 2*t)*
