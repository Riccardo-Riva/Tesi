...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mh], 
  ...
  ((2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
    ...
    (mh^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*psq^2 + psq*((-14 + d)*s - 2*t) + 2*s*(-((-4 + d)*mm^2) + (2 + d)*s + 
        2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(mh^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq^2 + 10*s^2 - 2*d*s^2 + 
      2*mm^2*(psq + (-4 + d)*s - t) + 5*s*t + 2*t^2 - psq*((3 + d)*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mh^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(4*psq^2 + 10*s^2 + 
      2*mm^2*(psq - t) + 9*s*t + 2*t^2 - 3*psq*(5*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(mh^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (-2*psq^2 + 2*s*(-((-4 + d)*mm^2) + d*s - 2*t) + psq*((-4 + d)*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/(mh^2*(2*Pi)^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(-2*psq^2 - 7*s^2 + 2*d*s^2 + 
      2*mm^2*(psq - (-3 + d)*s - t) + s*t - 2*t^2 + psq*((-3 + d)*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(mh^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(3*s^2 + psq*(s - 2*t) - 5*s*t + 
      2*t^2 + 2*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (mh^2*(2*Pi)^(2*d)*s^2) - (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*
     gHll*mm^2*(4*psq^2 + 4*mm^2*s - 2*s^2 + d*s^2 - 8*psq*t + 4*s*t + 4*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*mm^2 + 3*psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    (mh^2*Pi^(2*d)*s) + (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (-4*psq^2 + (-10 + d)*s^2 - 4*s*t - 4*t^2 + 8*psq*(s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(mh^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*mm^2 + 2*psq + (-3 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(4^d*mh^2*Pi^(2*d)*s) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (-4*psq^2 + (-4 + d)*s^2 - 4*s*t - 4*t^2 + 4*psq*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (mm^2 - psq + (-1 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p1, p2]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*mm^2 + d*s - 2*t)*
   ...
   (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(mh^2*Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p3, q1]])/(mh^2*Pi^(2*d)*s) - 
   (4^(1 - d)*(-7 + d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(mh^2*Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[q1, q2]])/(mh^2*Pi^(2*d)*s) - 
   (2^(1 - 2*d)*(-5 + d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/(mh^2*Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(-psq + 2*s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(-psq + 2*s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(mm^2 - psq)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*mm^2 - 5*psq + 4*s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(-2*psq + (2 + d)*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3]])/
    (mh^2*(2*Pi)^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*
     gHll*mm^2*(psq - 2*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p3, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq - 5*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq + (-8 + d)*s - 2*t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*mm^2 - 5*psq + s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq + (-6 + d)*s - 2*t)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq + (-6 + d)*s - 2*t)*
    ...
    (mh^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*
     gHll*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
     mm^2*(2*mm^2 + psq + s - 3*t)*\[Mu]^(8 - 2*d)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq + d*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/
    (mh^2*(2*Pi)^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*
     gHll*mm^2*(psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
     mm^2*(-2*psq + (-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq + 3*s - 2*t)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(-2*psq + (-6 + d)*s + 2*t)*
    ...
    (mh^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*psq - (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, p3]])/(mh^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq - (-4 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    (mh^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*
     gHll*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
     mm^2*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
     mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
     mm^2*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q1]])/(mh^2*Pi^(2*d)*s) - 
