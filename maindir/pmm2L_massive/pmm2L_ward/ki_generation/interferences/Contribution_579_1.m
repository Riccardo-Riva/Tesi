...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
   ...
   (((3*I)*(aa - bb)*EL^5*gAl*gFFA^2*gFll^2*mm^4*s*(-psq + s + t)*
    ...
    (I*EL^5*gAl*gFFA^2*gFll^2*mm^2*s*(3*aa*mm^2*(psq - t) + 
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*gFll^2*mm^2*
    ...
    (I*EL^5*gAl*gFFA^2*gFll^2*mm^2*s*(bb*(psq - s - t) + 
       ...
       SP[q2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*
      gFll^2*mm^2*(2*psq*s + 3*mm^2*(psq - t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl*gFFA^2*gFll^2*mm^2*(3*aa*psq*s + 
       2*aa*mm^2*(psq - s - t) - 2*aa*s*(s + t) + 2*bb*s*(-psq + s + t) + 
