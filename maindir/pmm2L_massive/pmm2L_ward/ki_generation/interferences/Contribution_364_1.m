...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*s*(aa*psq*(psq - t) + 
       aa*mm^2*(psq - s - t) + bb*mm^2*(-psq + t) + bb*psq*(-psq + s + t))*
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + (I*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
      gWNl*mm^2*(-(bb*(2*mm^2*(psq - t) + (2*psq + s)*(psq - s - t))) + 
    ...
    (I*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*(2*bb*mm^2*(psq - t) + 
     ...
     (2*Pi)^(2*d) + (I*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
