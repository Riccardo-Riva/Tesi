...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 ((I*(aa + bb)*(-2 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(mm^2 - psq)*(psq - t)*
  ...
  (I*2^(-1 - 4*d)*(-2 + d)*EL^5*gAl^3*mm^2*
    (bb*(-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(mm^2 - psq)*((-2 + d)*psq - 
       ...
       gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq*(psq - t)) + 
         mm^2*((2 + d)*psq - 2*s - (2 + d)*t))) + 
     aa*(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(mm^2 - psq)*((-2 + d)*psq - 
         (-4 + d)*s - (-2 + d)*t) - gZlL^2*(2*Pi)^(2*d)*
        (-((-2 + d)*psq*(psq - s - t)) + mm^2*((2 + d)*psq - 2*t - 
           d*(s + t))) - gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq*(psq - s - t)) + 
         mm^2*((2 + d)*psq - 2*t - d*(s + t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(4*d) + (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gZlL*
    gZlR*mm^2*(mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   Pi^(2*d) + (I*2^(-1 - 4*d)*(-2 + d)*EL^5*gAl^3*mm^2*
    (bb*(-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(mm^2 - psq)*((-2 + d)*psq - 2*s - 
          (-2 + d)*t)) + gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq*(psq - t)) + 
         mm^2*((2 + d)*psq - 2*s - (2 + d)*t)) + gZlR^2*(2*Pi)^(2*d)*
        (-((-2 + d)*psq*(psq - t)) + mm^2*((2 + d)*psq - 2*s - (2 + d)*t))) + 
  ...
  (I*(aa + bb)*(8 - 6*d + d^2)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)^2*s*
  ...
  (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl^3*(bb*(-4*d*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*(mm^2 - psq) + 
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl^3*
    (aa*(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(mm^2 - 2*psq + s + t) - 
       gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq)*((8 - 6*d + d^2)*mm^2 - 
         (-2 + d)^2*psq + 2*(-4 + d)*s + 2*(-2 + d)*t) - 
       gZlR^2*(2*Pi)^(2*d)*(mm^2 - psq)*((8 - 6*d + d^2)*mm^2 - 
         (-2 + d)^2*psq + 2*(-4 + d)*s + 2*(-2 + d)*t)) + 
     bb*(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s - t) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq)*((16 - 10*d + d^2)*mm^2 - 
         (12 - 8*d + d^2)*psq + 2*(-4 + d)*s + 2*(-2 + d)*t) + 
       gZlR^2*(2*Pi)^(2*d)*(mm^2 - psq)*((16 - 10*d + d^2)*mm^2 - 
         (12 - 8*d + d^2)*psq + 2*(-4 + d)*s + 2*(-2 + d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(4*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^3*
    (8*d*gZlL*gZlR*mm^2*(-psq + t) + gZlL^2*(mm^2 - psq)*
      ((16 - 10*d + d^2)*psq - (20 - 10*d + d^2)*s - (16 - 10*d + d^2)*t) + 
     gZlR^2*(mm^2 - psq)*((16 - 10*d + d^2)*psq - (20 - 10*d + d^2)*s - 
       (16 - 10*d + d^2)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 4*d)*EL^5*gAl^3*mm^2*
    (bb*((-2 + d)^2*gZlL^2 - 4*(8 - 7*d + d^2)*gZlL*gZlR + (-2 + d)^2*gZlR^2)*
      (2*Pi)^(2*d)*(psq - s - t) + 
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl^3*
    (aa*(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - t) - 
       gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq)*((16 - 10*d + d^2)*mm^2 - 
         (20 - 12*d + d^2)*psq - 4*s + 4*t - 2*d*t) - 
       gZlR^2*(2*Pi)^(2*d)*(mm^2 - psq)*((16 - 10*d + d^2)*mm^2 - 
         (20 - 12*d + d^2)*psq - 4*s + 4*t - 2*d*t)) + 
     bb*(-(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(mm^2 - t)) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq)*((8 - 6*d + d^2)*mm^2 - 
         (12 - 8*d + d^2)*psq - 4*s + 4*t - 2*d*t) + gZlR^2*(2*Pi)^(2*d)*
        (mm^2 - psq)*((8 - 6*d + d^2)*mm^2 - (12 - 8*d + d^2)*psq - 4*s + 
         4*t - 2*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   Pi^(4*d) + (I*2^(-1 - 4*d)*EL^5*gAl^3*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^3*
    (8*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + (-4 + d)*gZlL^2*(mm^2 - psq)*
      ((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t) + (-4 + d)*gZlR^2*(mm^2 - psq)*
  ...
  (I*2^(-1 - 4*d)*(aa - bb)*EL^5*gAl^3*mm^2*
    ((-2 + d)^2*gZlL^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) + 
     ...
     4^(1 + d)*gZlL*gZlR*Pi^(2*d)*((4 - 6*d + d^2)*psq - (8 - 7*d + d^2)*s - 
       (4 - 6*d + d^2)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
    ...
    (-(bb*(-(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(mm^2 - psq)*(psq - t)) + 
     ...
     aa*(-(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(mm^2 - psq)*(psq - s - t)) + 
       4^(1 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(2*psq^2 + mm^2*s - 
        ...
        (2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + gZlL^2*(mm^2*(psq - 2*s - t) + 
           3*psq*(-psq + s + t)) + gZlR^2*(mm^2*(psq - 2*s - t) + 
           3*psq*(-psq + s + t)))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*(-(aa*(-4*d*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*(mm^2 - psq) + 
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^3*
    (8*d*gZlL*gZlR*mm^2*(-psq + s + t) + gZlL^2*(mm^2 - psq)*
     ...
     gZlR^2*(mm^2 - psq)*((16 - 10*d + d^2)*psq + 4*s - (16 - 10*d + d^2)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(psq - s - t)*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl^3*mm^2*
   ...
   Pi^(4*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^3*
    (8*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + (-4 + d)*gZlL^2*(mm^2 - psq)*
  ...
  (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(bb*(psq - s - t) + 
  ...
  (I*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(bb*(20 - 10*d + d^2)*(psq - s - t) + 
  ...
  (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    (bb*((16 - 10*d + d^2)*mm^2 + 4*psq - 24*s + 10*d*s - d^2*s - 20*t + 
       10*d*t - d^2*t) + aa*(-((20 - 10*d + d^2)*psq) + (24 - 10*d + d^2)*s + 
       (20 - 10*d + d^2)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(8 - 6*d + d^2)*EL^5*gAl^3*
    (gZlL^2 + gZlR^2)*(bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*
  ...
  (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + 
     ...
     SP[q2, q2]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*
    (gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(-(aa*(20 - 10*d + d^2)*(psq - t)) + 
  ...
  (I*(aa - bb)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*((16 - 10*d + d^2)*psq + 4*s - 
     ...
     SP[p3, q2]])/(4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^3*
