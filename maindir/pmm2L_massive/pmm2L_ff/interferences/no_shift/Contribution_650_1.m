...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*d*EL^6*gAl^5*gAu*mm^2*(3*mm^2 + psq - 2*s)*
   ...
   (4^(1 - d)*d*EL^6*gAl^5*gAu*mm^2*((8 - 6*d)*psq^3 + 8*s*t*(s + t) + 
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^5*gAu*(mm^2 - psq)*(-((-6 + d)*psq^3) - 
      4*t^2*(s + t) - psq*t*((-6 + d)*s + (-14 + d)*t) + 
      psq^2*(-((-2 + d)*s) + 2*(-8 + d)*t) + 
      mm^2*((-6 + d)*psq^2 + psq*((4 + d)*s - 2*(-6 + d)*t) - 
        (s + t)*(2*s - (-6 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*d*EL^6*gAl^5*gAu*mm^2*
     (-2*(-4 + d)*psq^3 + (4 + d)*mm^2*(2*psq - s - 2*t)*(psq - t) - 
      8*s*t*(s + t) + psq*t*(-((-20 + d)*s) - 2*(-4 + d)*t) + 
      psq^2*((-12 + d)*s + 4*(-4 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl^5*gAu*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^6*gAl^5*gAu*((-2 + d)*mm^4*s*((2 + d)*psq - 2*s - 
        (2 + d)*t) + s*((20 - 12*d + d^2)*psq^3 - 8*(-2 + d)*psq*t*
         (2*s + 3*t) + (-2 + d)*psq^2*(4*s - (-26 + d)*t) + 
   ...
   (4^(2 - d)*(-2 + d)*d*EL^6*gAl^5*gAu*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^5*gAu*(mm^2 - psq)*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*d*EL^6*gAl^5*gAu*mm^2*(psq - t)*(2*(-4 + d)*psq + 
      d*(s - 2*t) + 8*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^5*gAu*(-((-6 + d)*psq^3) - 4*t*(s + t)^2 + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*((-2 + d)*psq*(psq - t) + 
   ...
   (2^(5 - 2*d)*(-2 + d)^2*EL^6*gAl^5*gAu*(mm^2 - psq)*(psq - t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^5*gAu*(2*(-4 + d)*psq^2 - 
