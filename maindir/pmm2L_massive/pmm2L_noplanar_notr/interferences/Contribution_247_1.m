...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((4^(1 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(-4*gZlL*gZlR*mm^2 + 
      gZlL^2*(mm^2 + psq) + gZlR^2*(mm^2 + psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*
     ggpgpZ^2*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL - gZlR)^2*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*
     (2*gZlL*gZlR*mm^2*(2*psq - 3*s - 2*t) + 
      gZlL^2*(psq*(-psq + s + t) + mm^2*(-psq + 2*s + t)) + 
      gZlR^2*(psq*(-psq + s + t) + mm^2*(-psq + 2*s + t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL - gZlR)^2*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*
     (gZlL^2 + gZlR^2)*(mm^2 - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
