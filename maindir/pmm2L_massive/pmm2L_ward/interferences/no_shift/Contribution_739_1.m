...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*d*EL^5*gAl*gZlL*gZlR*mm^2*(mm^2 - psq)*s*
     ...
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gZlL*
     gZlR*mm^2*((-2 + d)*gZlL^2*(mm^2 + psq)*(2*psq - s - 2*t) + 
    ...
    (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gZlL*gZlR*mm^2*
   ...
   (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl*gZlL^2*gZlR^2*mm^2*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*
     (bb*(2*gZlL^3*gZlR*mm^2*(2*s + d*(psq - s - t)) + 
        2*gZlL*gZlR^3*mm^2*(2*s + d*(psq - s - t)) - 2*(-2 + d)*gZlL^2*gZlR^2*
         mm^2*(psq - s - t) + gZlL^4*(-((-2 + d)*mm^4) - (-2 + d)*psq^2 + 
         ...
         (-2*s + d*(-psq + s + t)) + gZlL^4*((-2 + d)*mm^4 - (-2 + d)*psq^2 - 
          (-10 + d)*psq*s - 2*s*(s + t) + mm^2*((-2 + d)*psq - 2*s + 2*t - 
            d*t)) + gZlR^4*((-2 + d)*mm^4 - (-2 + d)*psq^2 - 
          (-10 + d)*psq*s - 2*s*(s + t) + mm^2*((-2 + d)*psq - 2*s + 2*t - 
            d*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    Pi^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*
   ...
   (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(-2 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*
