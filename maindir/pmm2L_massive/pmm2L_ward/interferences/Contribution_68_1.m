...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
 ...
 ((I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    ...
    gAl*gHll*gHWW*gWlN*gWNl*mm^2*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll*
    gHWW*gWlN*gWNl*mm^2*(aa*psq*(3*psq - 2*s - 3*t) + aa*mm^2*(psq - t) + 
     bb*mm^2*(-psq + s + t) + bb*psq*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + (I*aa*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
    gWNl*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   (4^d*Pi^(2*d)) + (I*aa*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*
    gWlN*gWNl*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (I*bb*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   Pi^(2*d) + (I*bb*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*(mm^2 - psq)*
