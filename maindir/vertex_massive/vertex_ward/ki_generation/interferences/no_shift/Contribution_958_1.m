...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
   ...
   (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*s*
     ...
     SPList[SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
     (aa*(-4*(-1 + d)*psq + (-2 + d)*s) + bb*(2*(-2 + d)*mm^2 + 2*d*psq + 
        2*s - d*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    Pi^(2*d) - (2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*d*psq + 2*s - d*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*bb*(-3*mm^2 + psq)*s + 
   ...
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(4*bb*mm^2*s - 2*aa*psq*s - 2*bb*psq*s + 
