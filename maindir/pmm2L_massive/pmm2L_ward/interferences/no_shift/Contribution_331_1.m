...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*EL^5*gAl*gXll^2*mm^4*s*(-2*bb*(gZlL^2 + gZlR^2)*
       (mm^2*(3*psq - 2*s - 3*t) + psq*(psq - t)) + 2*aa*(gZlL^2 + gZlR^2)*
       (mm^2*(3*psq - s - 3*t) + psq*(psq - s - t)) + 
      bb*d*(gZlL^2*(mm^2*(3*psq - 2*s - 3*t) + psq*(psq - t)) + 
        gZlR^2*(mm^2*(3*psq - 2*s - 3*t) + psq*(psq - t)) + 
        2*gZlL*gZlR*mm^2*(mm^2 - 3*psq + s + 2*t)) + 
      aa*d*(2*gZlL*gZlR*mm^2*(mm^2 + psq - s - 2*t) + 
        gZlL^2*(psq*(-psq + s + t) + mm^2*(-3*psq + s + 3*t)) + 
        gZlR^2*(psq*(-psq + s + t) + mm^2*(-3*psq + s + 3*t))))*
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - (I*2^(1 - 4*d)*EL^5*gAl*gXll^2*mm^4*
     (aa*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2*(2*psq + s - 2*t) + 
          psq*(psq - 2*s - t)) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         (mm^2*(2*psq + s - 2*t) + psq*(psq - 2*s - t)) - 
        4^d*d*gZlL*gZlR*Pi^(2*d)*(4*mm^2*(psq - t) + s*(-3*psq + s + t))) + 
      bb*(2*Pi)^(2*d)*(-((-2 + d)*gZlL^2*(mm^2*(2*psq - s - 2*t) + 
           psq*(psq - t))) - (-2 + d)*gZlR^2*(mm^2*(2*psq - s - 2*t) + 
          psq*(psq - t)) + d*gZlL*gZlR*(s*(-psq + s + t) + 
          mm^2*(4*psq - 2*(s + 2*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(4*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*
     mm^4*(psq^2 + mm^2*(psq - s - t) + psq*(3*s - t) - 2*s*(s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   (I*2^(1 - 4*d)*EL^5*gAl*gXll^2*mm^4*
     (bb*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2*(2*psq - 3*s - 2*t) + 
           psq*(psq + s - t))) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         (mm^2*(2*psq - 3*s - 2*t) + psq*(psq + s - t)) + 
        4^d*d*gZlL*gZlR*Pi^(2*d)*(4*mm^2*(psq - s - t) + s*(psq + t))) + 
      aa*(2*Pi)^(2*d)*((-2 + d)*gZlL^2*(mm^2*(2*psq - s - 2*t) + 
          psq*(psq - s - t)) + (-2 + d)*gZlR^2*(mm^2*(2*psq - s - 2*t) + 
          psq*(psq - s - t)) - d*gZlL*gZlR*(s*(-psq + t) + 
          mm^2*(4*psq - 2*(s + 2*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(4*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*
     mm^4*(psq^2 + mm^2*(psq - t) - psq*t - 2*s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*
     ((-2 + d)*gZlL^2 - d*gZlL*gZlR + (-2 + d)*gZlR^2)*mm^4*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*s*
     (aa*(-8*psq + 4*s + d*(mm^2 + 3*psq - 2*s - 4*t) + 8*t) + 
      bb*(8*psq - 4*s - 8*t + d*(mm^2 - 5*psq + 2*s + 4*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*
     gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
     (4^d*aa*Pi^(2*d)*(4*mm^2*(psq - t) + 4*psq*(psq - s - t) + 
        d*(mm^2 - psq)*(mm^2 + psq - s - t)) + bb*(2*Pi)^(2*d)*
       (4*psq*(-psq + t) + d*(mm^2 - psq)*(mm^2 - psq + t) + 
        4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    Pi^(4*d) - (I*2^(1 - 2*d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*s*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*((-2 + d)*gZlL^2 - d*gZlL*gZlR + 
      (-2 + d)*gZlR^2)*mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-(aa*(2 + d)*psq*s) + 
      aa*(-4 + 3*d)*mm^2*(psq - t) + 2*aa*s*(s + t) - 2*bb*s*(-psq + s + t) + 
   ...
   (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    ...
    Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^4*(aa*d*gZlL*gZlR*(psq - t) + 
      bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
   ...
   (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(-2 + d)*psq*s + 
   ...
   (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
     (bb*psq*(psq - t) + bb*mm^2*(psq - 2*s - t) + aa*mm^2*(-psq + t) + 
      aa*psq*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*
