...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*
       (mm^2*(psq - t) + psq*(psq - s - t))*(psq^2 - 2*psq*t + t*(s + t))*
       \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s)) + 
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*psq*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)*
      ...
      gZNL*mm^2*(mm^2*(psq - t) + psq*(psq - s - t))*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*
      ...
      mm^2*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       ...
       SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*
      gZNL*mm^2*(mm^2*(psq - t) + psq*(psq - s - t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2], SP[q1, q2]])/Pi^(2*d) + 
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*psq*(psq - s - t)*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*
      ...
      mm^2*psq*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[p2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*
      mm^2*(psq*(psq + s - t) + mm^2*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)*
      ...
      psq*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[p2, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*
     ...
     Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*
      mm^2*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(mm^2 - psq)*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)^2*
