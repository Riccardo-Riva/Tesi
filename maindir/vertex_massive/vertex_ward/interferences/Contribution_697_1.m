...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   (((-I)*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)^2*s*
      ...
      gXll^2*mm^6*(mm^2*(5*psq - 2*s - 5*t) + psq*(3*psq - 2*s - 3*t))*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
      ...
      gXll^2*mm^6*(mm^2*(5*psq - 3*s - 5*t) + psq*(3*psq - s - 3*t))*
    ...
    (I*4^(2 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(psq - s - t) + 
       ...
       SP[p1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(-3*psq + 2*s + 3*t)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(2*psq - s - 2*t) - 
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(-3*psq + s + 3*t)*
