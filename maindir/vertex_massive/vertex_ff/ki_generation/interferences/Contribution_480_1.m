...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*mm^2*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*(mm^2 - psq)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*(mm^2 - psq)*(psq - t)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*mm^2*(psq - t)*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*(mm^2 - psq)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*
      (mm^2*(psq - t) + psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFFA*gFFAZ*(gZlL + gZlR)*(psq - t)*
