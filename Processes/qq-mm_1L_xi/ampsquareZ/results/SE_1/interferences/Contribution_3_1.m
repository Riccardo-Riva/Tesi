...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
   ...
   ((I*EL^6*gFZW^2*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
     ...
     ((2*Pi)^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) + 
    (I*EL^6*gFZW^2*s*(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
     ...
     (mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) - 
    (I*2^(1 - 2*d)*EL^6*gFZW^2*
      ...
      (-(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
       ...
       SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) + 
    (I*2^(1 - 2*d)*EL^6*gFZW^2*
      ...
      SPList[SP[p1, q1], SP[p3, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*
      (-mzC^2 + s)*sw^2) + (I*2^(1 - 2*d)*EL^6*gFZW^2*
  ...
  PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
   ...
   (((-I)*EL^6*gFZW^2*s*(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
    ...
    (I*2^(2 - d)*EL^6*gFZW^2*(gZlL*gZlLC + gZlR*gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*s*SPList[SP[p3, q1], SP[p3, q1]])/
     (mw^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*sw^2)))/4
