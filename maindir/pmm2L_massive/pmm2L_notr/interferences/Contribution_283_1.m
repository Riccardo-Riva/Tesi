...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (-((2^(3 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFZW^2*gZlL*gZlR*mm^2*sw^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s)) + 
  (2^(3 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFZW^2*gZlL*gZlR*mm^2*sw^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(Pi^(2*d)*s) + 
  ((-2 + d)*EL^8*gAl*gAu^2*gFFA*gFZW^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*
    sw^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(4^d*Pi^(2*d)*s) - 
  (2^(3 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFZW^2*gZlL*gZlR*mm^2*sw^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFZW^2*gZlL*gZlR*mm^2*sw^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/(Pi^(2*d)*s) + 
  ((-2 + d)*EL^8*gAl*gAu^2*gFFA*gFZW^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*
    sw^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(4^d*Pi^(2*d)*s) - 
  (2^(3 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFZW^2*gZlL*gZlR*mm^2*sw^2*(psq - t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFZW^2*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFZW^2*
    (gZlL^2 + gZlR^2)*(-mm^2 + psq)*sw^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFZW^2*(gZlL^2 + gZlR^2)*sw^2*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFZW^2*(gZlL^2 + gZlR^2)*sw^2*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFZW^2*
