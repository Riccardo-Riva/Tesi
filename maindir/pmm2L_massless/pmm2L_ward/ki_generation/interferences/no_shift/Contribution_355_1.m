(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
  ...
  (((-I)*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*s*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^5*s*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^5*s*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*s*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*s*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl^5*s*(s + 2*t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^5*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(-aa + bb)*(-4 + d)^2*EL^5*gAl^5*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*((20 - 10*d + d^2)*s + 
      (12 - 8*d + d^2)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q1]])/Pi^(2*d) + (I*4^(2 - d)*(-aa + bb)*(-2 + d)*EL^5*gAl^5*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl^5*(s + 2*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*(2*(-4 + d)*s + (12 - 8*d + d^2)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*(4*s - (16 - 10*d + d^2)*t)*
