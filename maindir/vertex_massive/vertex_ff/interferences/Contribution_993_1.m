...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((4^(1 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*(2*psq^2 + 2*mm^2*s - 
     ...
     (mh^2*Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*
      (mm^2 - psq)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/(mh^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*
      gHll*mm^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*(mm^2 - 2*psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(mh^2*Pi^(2*d)) - 
    (4^(1 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*(2*psq^2 - 3*psq*s + s^2 - 
       4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q1]])/(mh^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*
      gHll*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     (mh^2*Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*
