...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
      ...
      mm^2*(-2*psq^2 + (-3 + d)*psq*s + 2*mm^2*(psq + 2*s - d*s - t) + 
       4*psq*t - t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
     (mh^2*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
      mm^2*(2*mm^2 + (-3 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
     (mh^2*Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     ...
     (mh^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
      mm^2*(2*mm^2 - 5*psq + 2*s + 3*t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(psq - t)*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, mw]]*((4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
      mm^2*(2*psq^2 + s^2 + psq*(s - d*s - 4*t) + 
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*
     ...
     (mh^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
      mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     (mh^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*
      mm^2*(2*mm^2 + psq - s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(-2*psq + s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) + 
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq - 3*s - 2*t)*
