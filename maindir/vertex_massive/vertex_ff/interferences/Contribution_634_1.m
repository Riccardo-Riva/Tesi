...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*gWlN*gWNl*mm^2*(mm^2 - psq)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*gWlN*gWNl*mm^2*
     (psq^2*s*(psq - t) + mm^4*s*(-3*psq + 2*s + 3*t) - 
      2*mm^2*(8*psq^3 - psq^2*(5*s + 24*t) - 4*t*(s^2 + 3*s*t + 2*t^2) + 
        psq*(s^2 + 17*s*t + 24*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*gWlN*gWNl*mm^2*(mm^2 - psq)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*gWlN*gWNl*mm^2*(3*mm^2 + psq)*
     (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*
     gWlN*gWNl*mm^2*(psq - t)*(psq*(-psq + t) + mm^2*(-psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*gWlN*gWNl*mm^2*(psq - t)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*gWlN*gWNl*mm^2*
     (4*psq^3 + 3*mm^2*psq*s - mm^2*s*(2*s + 3*t) - psq^2*(s + 12*t) + 
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*gWlN*gWNl*mm^2*(mm^2 - psq)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*gWlN*gWNl*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*
     gWlN*gWNl*mm^2*(mm^2*(psq - t) + t*(-psq + s + t))*\[Mu]^(8 - 2*d)*
