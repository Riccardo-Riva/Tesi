...
PropList[KiraPropagator[-q1, mh], KiraPropagator[-q1 - q2, mz], 
 ...
 ((I*EL^5*gAl*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*(mm^2 - psq)*s*
    (aa*(3*psq - s - 3*t) + bb*(-3*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d))/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHXX*gHXZ*gXll*
    (gZlL - gZlR)*mh^2*mm^2*(aa*(-6*psq^2 + 4*mm^2*(psq - t) - 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    ...
    (gZlL - gZlR)*mh^2*mm^2*(bb*((psq - s)*(3*psq - 2*s - 3*t) + 
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXX*gHXZ*gXll*(gZlL - gZlR)*
    mh^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXX*gHXZ*gXll*(gZlL - gZlR)*
    mh^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
  ...
  (I*EL^5*gAl*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    ...
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
