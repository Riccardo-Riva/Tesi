...
(PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, mh], 
   ...
   (((I/16)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
    ...
    ((I/8)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      ((2*(gZlL + gZlR)*(gZuL + gZuR)*((-2 + d)*mu^2 + (-2 + d)*s + 4*t))/s - 
       (d*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - t) + 
         (4*(gZlL + gZlR)*(gZuL + gZuR)*mu^2*(mm^2 - t))/s + 
         3*(gZlL - gZlR)*(gZuL - gZuR)*(-mm^2 + t) + 3*(gZlL - gZlR)*
          (gZuL - gZuR)*(-mm^2 + s + t) - d*(gZlL - gZlR)*(gZuL - gZuR)*
          (-mm^2 + s + t) - (2*(gZlL + gZlR)*(gZuL + gZuR)*mu^2*
           (-mm^2 + s + t))/s)/mz^2)*SPList[SP[p1, q1]])/Pi^4 + 
    ((I/8)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      (2*(gZlL + gZlR)*(gZuL + gZuR)*((-2 + d)*mu^2 + (-2 + d)*s + 4*t) + 
    ...
    ((I/8)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      ...
      ((-2 + d)*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
       ...
       (2*(gZlL + gZlR)*(gZuL + gZuR)*mu^2 + d*(gZlL - gZlR)*(gZuL - gZuR)*
          (mm^2 - t) + 3*(gZlL - gZlR)*(gZuL - gZuR)*(-mm^2 + t) + 
         3*(gZlL - gZlR)*(gZuL - gZuR)*(-mm^2 + s + t) - 
         d*(gZlL - gZlR)*(gZuL - gZuR)*(-mm^2 + s + t))/mz^2)*
    ...
    ((I/8)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      (d*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - t) + 
       ...
       3*(gZlL - gZlR)*(gZuL - gZuR)*(-mm^2 + t) + 3*(gZlL - gZlR)*
        (gZuL - gZuR)*(-mm^2 + s + t) - d*(gZlL - gZlR)*(gZuL - gZuR)*
        (-mm^2 + s + t) - (2*(gZlL + gZlR)*(gZuL + gZuR)*mu^2*
         (-mm^2 + s + t))/s)*SPList[SP[p1, q1]])/(mz^2*Pi^4) + 
    ((I/8)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      (gZlR*gZuL*(-((-3 + d)*s^2) + 2*mm^2*(mu^2 + (-3 + d)*s) - 2*mu^2*t - 
         2*(-3 + d)*s*t) + gZlL*gZuR*(-((-3 + d)*s^2) + 
         2*mm^2*(mu^2 + (-3 + d)*s) - 2*mu^2*t - 2*(-3 + d)*s*t) + 
