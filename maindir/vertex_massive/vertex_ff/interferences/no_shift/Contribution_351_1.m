...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  (-((4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*psq*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(3*psq - 2*s - 3*t)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(psq - t)*
     (-2*gZlR*psq*s + gZlR*mm^2*(2*psq + s - 2*t) + 
      gZlL*mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 + 
      gZlR*(mm^2 + 2*psq))*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2*s + 
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*
