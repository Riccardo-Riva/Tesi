(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
  ...
  (((-I)*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*(s + t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*s*(s + t)*
   ...
   (I*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*t*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*(s + t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl*(gZlL^4 + gZlR^4)*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(12 - 8*d + d^2)*EL^5*gAl*
     ...
     (gZlL^4 + gZlR^4)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl*(gZlL^4 + gZlR^4)*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*t*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*(s + t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*t*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*t*
