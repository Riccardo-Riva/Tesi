...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 4*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
     ((-2 + d)*gZlR*mm^2*(psq - s - t)*((-6 + d)*psq - (-8 + d)*s - 
        (-6 + d)*t) + gZlL*(-4*(20 - 9*d + d^2)*psq^3 - 
        4*(-2 + d)*mm^4*(psq - s - t) + (24 - 10*d + d^2)*(s + t)^2*
         (s + 2*t) - 4*(-4 + d)*psq*(s + t)*((-6 + d)*s + (-11 + 2*d)*t) + 
        (-4 + d)*psq^2*(5*(-6 + d)*s + 2*(-26 + 5*d)*t) + 
        mm^2*(2*(10 - 5*d + d^2)*psq^2 + (s + t)*((12 - 6*d + d^2)*s + 
            2*(14 - 7*d + d^2)*t) - psq*(48*t - 24*d*t + d^2*(s + 4*t)))))*
   ...
   (4^(1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
     (gZlR*mm^2*(2*Pi)^(2*d)*(2*(-2 + d)^2*psq^2 + (12 - 6*d + d^2)*s^2 + 
        2*(-2 + d)*d*s*t + 2*(-2 + d)^2*t^2 - 2*(-2 + d)*psq*
         (-4*t + d*(s + 2*t))) + 
      gZlL*(-((16 - 10*d + d^2)*mm^4*(2*Pi)^(2*d)*s) + 
        d^2*(2*Pi)^(2*d)*s*(3*psq^2 - 3*psq*s + s^2 + 5*t^2) + 
        mm^2*(2*Pi)^(2*d)*((8 - 6*d + d^2)*psq^2 + 4*s^2 + 4*(-2 + d)*s*t + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*(psq - t)*
     ((-2 + d)*gZlR*mm^2*((-6 + d)*psq - 2*s - (-6 + d)*t) + 
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
     (d^2*gZlL*(2*Pi)^(2*d)*s*(-(psq*(psq - 3*t)) + mm^2*(psq - t)) + 
      2^(1 + 2*d)*(-2 + d)^2*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)*(psq - t) + 
      2^(1 + 2*d)*gZlL*Pi^(2*d)*((8 - 6*d + d^2)*psq^3 + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
     ((-2 + d)^2*gZlR*mm^2*(2*psq - s - 2*t) + 
      4*gZlL*mm^2*((-2 + d)*psq - s - (-2 + d)*t) + 
      (-4 + d)*gZlL*s*(2*(-7 + d)*psq - (-6 + d)*(s + 2*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*(2*(12 - 7*d + d^2)*psq^2 + 
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*(psq - t)*
     ...
     gZlL*gZNL*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[p3, q1]])/Pi^(2*d) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*
     gZNL*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*(psq - t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*(psq - t)^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*
     ...
     gZNL*(psq - t)*((-4 + d)*psq - 2*s - (-4 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*(psq - t)^2*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*
     gZNL*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*
     gZNL*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*(8 - 6*d + d^2)*EL^6*gAl*gAu*gWlN*
   ...
   (4^(1 - d)*(12 - 8*d + d^2)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*
     ...
     gZNL*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*
