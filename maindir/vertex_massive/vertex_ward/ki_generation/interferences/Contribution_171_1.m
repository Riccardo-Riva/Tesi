...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (-2*bb*psq + aa*(mm^2 + psq))*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(2*d)) - (2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (-2*bb*psq + aa*(mm^2 + psq))*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   Pi^(2*d) + ((aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 + psq)*
    s^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 + psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (2*aa*(psq^2 + mm^2*(-psq + s)) - bb*(mm^2*(-2*psq + s) + 
       psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (2*bb*mm^2*(psq - s) - 2*bb*psq*(psq + s) + aa*psq*(2*psq + s) + 
     aa*mm^2*(-2*psq + 3*s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 + psq)*
    s^2*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(-2*bb*psq + aa*(mm^2 + psq))*s*
  ...
  ((aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 + psq)*s*
  ...
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(4*bb*psq - aa*(3*mm^2 + psq))*s*
  ...
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(-4*bb*(mm^2 + psq) + 
     aa*(5*mm^2 + 3*psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) - (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (-2*aa*(psq^2 + mm^2*(-psq + s)) + 
     bb*(mm^2*(-2*psq + s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*mm^2*(2*psq - 5*s) + 
     2*bb*mm^2*(-psq + s) - aa*psq*(2*psq + s) + 2*bb*psq*(psq + 2*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) + (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (-2*bb*psq + aa*(mm^2 + psq))*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*s*
  ...
  (4^(1 - d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 + psq)*
  ...
  (4^(1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
