...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (-((4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(5*psq^2 + s^2 + 6*s*t + 
     ...
     mm^4*(5*psq^2 - 9*psq*s + 4*s^2 - 10*psq*t + 9*s*t + 5*t^2)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(psq - t)*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2*(2*psq - s - 2*t) + gZlR*mm^2*(psq - 2*s - t) + 
      gZlR*psq*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2*(2*psq - s - 2*t) + gZlR*mm^2*(psq - 2*s - t) + 
      gZlR*psq*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(-(gZlL*mm^2*s) + 
      gZlR*(2*psq^2 + 2*mm^2*s - 7*psq*s + 4*s^2 - 4*psq*t + 4*s*t + 2*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
     (-(gZlL*mm^2*s) + gZlR*(psq^2 + mm^2*(psq + 2*s - t) - 3*psq*(s + t) + 
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*(-psq + s + t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*
     mm^2*(mm^2 + psq - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*
     ...
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*
