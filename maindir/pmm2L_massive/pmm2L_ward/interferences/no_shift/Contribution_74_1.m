  ...
  (((-I)*4^(2 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*(s + t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gWlN*gWNl*gWWA*gZlL*
     gZNL*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZlL*
     gZNL*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q2]])/
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*(s + 2*t)*
