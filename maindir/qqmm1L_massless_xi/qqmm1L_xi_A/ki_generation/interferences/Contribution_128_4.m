...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   (((-I)*EL^6*gWdu*gWud*gWWZ*gZuLC*s*
    ...
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(-(gZlL*gZlLC*(d*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
       ...
       gZlR*gZlRC*(d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*s^2 + (-5 + d)*s*t - 
           2*t^2) + mw^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            (2*s + 3*t - d*t))) + 2^(2 + d)*(gZlL*gZlLC + gZlR*gZlRC)*Pi^d*t*
        (s + t)*GaugeXi[Q] + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(gZlR*gZlRC*(d*(2*Pi)^d*s*(mw^2 + s) + 
         2^(1 + d)*Pi^d*(-2*s^2 + mw^2*t - s*t)) + 
     ...
     (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(-(gZlR*gZlRC*(3*d*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*
    ...
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*t*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      (-mzC^2 + s)*(-1 + GaugeXi[Q])*GaugeXi[Q]) + 
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(gZlL*gZlLC*(s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
    ...
    (I*4^(1 - d)*EL^6*gWdu*gWud*gWWZ*(gZlL*gZlLC + gZlR*gZlRC)*gZuLC*s*
      \[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*(mw^2*(2*Pi)^d + 
       (2^(1 + d)*Pi^d - 3*(2*Pi)^d)*(mw^2 + s)*GaugeXi[Q] + 
     ...
     (mw^4*Pi^(2*d)*(-mz^2 + s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
      GaugeXi[Q]) - (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*s*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(gZlL*gZlLC*(-(d*(2*Pi)^d*s) + 
         2^(1 + d)*Pi^d*(s - t)) + gZlR*gZlRC*(d*(2*Pi)^d*s - 
         2^(1 + d)*Pi^d*(2*s + t)) + 2^(1 + d)*Pi^d*
        (gZlR*gZlRC*(-((-4 + d)*s) + 2*t) + gZlL*gZlLC*((-2 + d)*s + 2*t))*
        GaugeXi[Q] + (gZlL*gZlLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
    ...
    (I*2^(2 - d)*EL^6*gWdu*gWud*gWWZ*((-4 + d)*gZlL*gZlLC - 
       (-2 + d)*gZlR*gZlRC)*gZuLC*(s + t)*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
    ...
    (I*2^(3 - d)*EL^6*gWdu*gWud*gWWZ*(gZlL*gZlLC + gZlR*gZlRC)*gZuLC*s*
      ...
      CKM[1, 1]*CKMC[1, 1]*(gZlR*gZlRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
       gZlL*gZlLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)) + 
       2^(1 + d)*Pi^d*(gZlL*gZlLC*((-6 + d)*s - 2*t) - 
         gZlR*gZlRC*(d*s + 2*t))*GaugeXi[Q] + 
       (gZlR*gZlRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
   ...
   ((I*EL^6*gWdu*gWud*gWWZ*gZuLC*s*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
      ...
      (-1 + GaugeXi[Q])^2) - (I*EL^6*gWdu*gWud*gWWZ*gZuLC*s*t*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*(gZlL*gZlLC*(d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(-s + t)) + gZlR*gZlRC*(-(d*(2*Pi)^d*s) + 
         2^(1 + d)*Pi^d*(2*s + t)) - 2^(1 + d)*Pi^d*
        (gZlR*gZlRC*(-((-4 + d)*s) + 2*t) + gZlL*gZlLC*((-2 + d)*s + 2*t))*
        ...
        GaugeXi[Q]^2)*SPList[SP[p2, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2) + 
    (I*EL^6*gWdu*gWud*gWWZ*gZuLC*s^2*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*
    ...
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(gZlR*gZlRC*(d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
          (-2*s^2 + (-5 + d)*s*t - 2*t^2)) + gZlL*gZlLC*
        (-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(s^2 + s*t - d*s*t - 2*t^2)) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*s*\[Mu]^(4 - d)*CKM[1, 1]*
    ...
    (I*4^(1 - d)*EL^6*gWdu*gWud*gWWZ*(gZlL*gZlLC + gZlR*gZlRC)*gZuLC*s^2*
      \[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*(2^(1 + d)*Pi^d - 3*(2*Pi)^d + 
   ...
   ((I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*
    ...
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*
      (-(gZlR*gZlRC*(5*d^2*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*
       ...
       gZlL*gZlLC*(5*d^2*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*((-2 + d)^2*s^2 + 
           2*(11 - 7*d)*s*t + (-2 + d)*t^2)))*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*SPList[SP[p2, q1]])/(Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)) + 
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*s*
      (gZlR*gZlRC*(d^2*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-((12 - 5*d + d^2)*s) + 
           (-6 + d)*t)) + gZlL*gZlLC*(-(d^2*(2*Pi)^d*s) + 
         2^(1 + d)*Pi^d*((6 - 4*d + d^2)*s + (-6 + d)*t)))*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p3, q1]])/(Pi^(2*d)*(mz^2 - s)*
      (-mzC^2 + s)) + (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*
      (mw^2*(gZlR*gZlRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + 
      ...
      (-mzC^2 + s)*GaugeXi[Q]) - (I*2^(2 - d)*(-2 + d)*EL^6*gWdu*gWud*gWWZ*
      ((-4 + d)*gZlL*gZlLC - (-2 + d)*gZlR*gZlRC)*gZuLC*(s + t)*\[Mu]^(4 - d)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[p1, q1]])/
     (Pi^d*(mz^2 - s)*(-mzC^2 + s)) + (I*4^(1 - d)*EL^6*gWdu*gWud*gWWZ*gZuLC*
    ...
    (I*4^(1 - d)*EL^6*gWdu*gWud*gWWZ*gZuLC*
      (gZlR*gZlRC*(-(d^2*(2*Pi)^d*s) + 2^(1 + d)*d*Pi^d*(s - t) + 
         ...
         2^(1 + d)*Pi^d*(6*s - 4*d*s + 2*t - d*t)))*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*(mz^2 - s)*
      (-mzC^2 + s)) + (I*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(-(mw^2*(-1 + GaugeXi[Q])*
         ((s + t)*(gZlL*gZlLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
            gZlR*gZlRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(2*s + t))) + 
          2*(gZlR*gZlRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*
                 s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + gZlL*gZlLC*
    ...
    (I*4^(1 - d)*EL^6*gWdu*gWud*gWWZ*gZuLC*
      ...
      (-mzC^2 + s)) - (I*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(-(mw^2*(-1 + GaugeXi[Q])*(19*d*gZlL*gZlLC*(2*Pi)^d*s*t - 
          19*d*gZlR*gZlRC*(2*Pi)^d*s*t + 2^(1 + d)*gZlR*gZlRC*Pi^d*
           ((8 - 6*d + d^2)*s^2 + 2*(3 + d^2)*s*t - 5*t^2) - 
          2^(1 + d)*gZlL*gZlLC*Pi^d*((-2 + d)^2*s^2 + (15 + 2*d^2)*s*t + 
            5*t^2) + 2*(gZlR*gZlRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(
    ...
    (I*2^(3 - d)*(-2 + d)*EL^6*gWdu*gWud*gWWZ*(gZlL*gZlLC + gZlR*gZlRC)*gZuLC*
      s*\[Mu]^(4 - d)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p3, q1], SP[p3, q1]])/
    ...
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
     ...
     (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(gZlL*gZlLC*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*mw^2*Pi^d*
     ...
     (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]) + 
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(gZlR*gZlRC*(d*s*(2^(1 + d)*mw^2*Pi^d + (2*Pi)^d*s) - 
    ...
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      ...
      (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*t*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(-(gZlL*gZlLC*(2^(1 + d)*(-2 + d)*mw^2*Pi^d + d*(2*Pi)^d*s + 
     ...
     (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gWdu*gWud*gWWZ*gZuLC*\[Mu]^(4 - d)*CKM[1, 1]*
      CKMC[1, 1]*(-(gZlL*gZlLC*(2^(1 + d)*mw^2*Pi^d*((-2 + d)*s - 2*t) + 
          s*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)))) + 
       gZlR*gZlRC*(2^(1 + d)*mw^2*Pi^d*((-4 + d)*s + 2*t) + 
         s*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(2*s + t))) + 
       2^(1 + d)*((-2 + d)*gZlL*gZlLC - (-4 + d)*gZlR*gZlRC)*Pi^d*s^2*
