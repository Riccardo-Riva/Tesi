...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   (((-I)*EL^5*gAl*gXll^2*mm^4*(mm^2 - psq)*s*
      ...
      gXll^2*mm^4*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq)*
     ...
     Pi^(4*d) - (I*EL^5*gAl*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (I*EL^5*gAl*gXll^2*mm^4*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
     ...
     (2*Pi)^(2*d) - (I*4^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*
    ...
    (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^4*
      (aa*(2*d*gZlL*gZlR*(2*psq - s - 2*t) + (-2 + d)*gZlL^2*
       ...
       SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 4*d)*EL^5*gAl*gXll^2*mm^2*
