...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*2^(1 - d)*EL^6*gAl*gAu^3*
      ...
      \[Mu]^(4 - d))/(Pi^d*(mzC^2 - s)) - 
    (I*4^(1 - d)*EL^6*gAl*gAu^3*(gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s) + 
         d^2*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuRC*Pi^d*((4 - 3*d)*s + 
           (8 - 6*d + d^2)*t) + 2^(1 + d)*gZuLC*Pi^d*(4*(-2 + d)*s - 
           (10 - 6*d + d^2)*t)) + gZlLC*(d^2*gZuLC*(2*Pi)^d*s - 
         d^2*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuLC*Pi^d*((4 - 3*d)*s + 
           (8 - 6*d + d^2)*t) + 2^(1 + d)*gZuRC*Pi^d*(4*(-2 + d)*s - 
           (10 - 6*d + d^2)*t)))*\[Mu]^(4 - d)*SPList[SP[p1, q1]])/
     (Pi^(2*d)*(mzC^2 - s)) - (I*4^(1 - d)*EL^6*gAl*gAu^3*
      ...
      \[Mu]^(4 - d)*SPList[SP[p2, q1]])/(Pi^(2*d)*(mzC^2 - s)) - 
    (I*2^(3 - d)*EL^6*gAl*gAu^3*(gZlRC*gZuLC*(-((-4 + d)*s) + 2*t) + 
       gZlLC*gZuRC*(-((-4 + d)*s) + 2*t) + gZlLC*gZuLC*((-2 + d)*s + 2*t) + 
       gZlRC*gZuRC*((-2 + d)*s + 2*t))*\[Mu]^(4 - d)*SPList[SP[p3, q1]])/
     (Pi^d*(mzC^2 - s)) + (I*EL^6*gAl*gAu^3*
      (gZlRC*(d^3*gZuLC*(2*Pi)^d*s^2 - d^3*gZuRC*(2*Pi)^d*s^2 + 
         2^(1 + d)*gZuLC*Pi^d*((-16 + 16*d - 5*d^2)*s^2 + (-5 + d)*(-2 + d)^2*
            s*t - 2*(-2 + d)*t^2) + 2^(1 + d)*gZuRC*Pi^d*
     ...
     ((2*Pi)^(2*d)*s*(-mzC^2 + s)) - (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gAu^3*
      ((-4 + d)*gZlLC*gZuLC - (-2 + d)*gZlRC*gZuLC - (-2 + d)*gZlLC*gZuRC + 
       (-4 + d)*gZlRC*gZuRC)*(s + t)*\[Mu]^(4 - d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/(Pi^d*s*(-mzC^2 + s)) + 
    (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gAu^3*
      ...
      \[Mu]^(4 - d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^d*(mzC^2 - s)*s) + 
    (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gAu^3*(d*gZlRC*(gZuLC - gZuRC)*s + 
    ...
    (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu^3*(gZlLC + gZlRC)*(gZuLC + gZuRC)*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[q1, 0], 
   ...
   ((I*2^(2 - d)*EL^6*gAl*gAu^3*
     ...
     (Pi^d*s*(-mzC^2 + s)) - (I*2^(1 - 2*d)*EL^6*gAl*gAu^3*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu^3*(gZlLC*(-(d^2*gZuLC*(2*Pi)^d*s^2) + 
    ...
    (I*EL^6*gAl*gAu^3*(gZlLC*(d^2*gZuLC*(2*Pi)^d*s^2 - d^2*gZuRC*(2*Pi)^d*
