...
((-I/16)*EL^2*gAu*(gZuL + gZuR)*SumOver[Index[Colour, 3], 3]*
 ...
 (EL^2*gAu*((-I)*(gZuL + gZuR)*pasq*(pasq - pzsq) + 
   ...
   SumOver[Index[Colour, 3], 3]*userIntegral[A0, {MC}, 1, 1])/(16*pasq*Pi^4)
