...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*
         ...
         3*(-2 + d)*mm^2*(2*Pi)^(2*d)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
          ...
          (-((-2 + d)*psq^4) + psq^3*(-5*s + 3*(-2 + d)*t) + 
           2*s*t*(s^2 + 3*s*t + 2*t^2) + psq^2*(2*s^2 - 2*(-8 + d)*s*t - 
             3*(-2 + d)*t^2) + psq*t*(-9*s^2 - 15*s*t + (-2 + d)*t^2))))*
      \[Mu]^(8 - 2*d))/(Pi^(4*d)*s)) + 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(d*gZlL*gZlR*(2*psq - s - 2*t)*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
       Pi^(2*d)*(2*psq - s - 2*t)*(5*psq^2 + 4*t*(s + t) + 
        mm^2*(-psq + s + t) - psq*(s + 9*t)) + 
      gZlL^2*((-2 + d)*mm^4*(2*Pi)^(2*d)*(3*psq^2 + 3*t*(s + t) - 
          psq*(s + 6*t)) + (2*Pi)^(2*d)*((2 + d)*psq^4 + 
          2*psq^3*((-8 + d)*s - (4 + d)*t) - 4*psq*t*(5*s^2 + 8*s*t + t^2) + 
          4*s*t*(s^2 + 3*s*t + 2*t^2) + psq^2*(-((-6 + d)*s^2) + 36*s*t + 
            (10 + d)*t^2)) + mm^2*(d*(2*Pi)^(2*d)*psq*s*(3*psq + s - 19*t) - 
          2^(1 + 2*d)*Pi^(2*d)*(2*(-5 + 3*d)*psq^3 + 
            psq^2*(s + 2*(13 - 8*d)*t) - 2*t*(s + t)*((-1 + d)*s + 
              (-3 + 2*d)*t) + psq*(s^2 - 13*s*t + 2*(-11 + 7*d)*t^2)))) + 
      gZlR^2*((-2 + d)*mm^4*(2*Pi)^(2*d)*(3*psq^2 + 3*t*(s + t) - 
          psq*(s + 6*t)) + (2*Pi)^(2*d)*((2 + d)*psq^4 + 
          2*psq^3*((-8 + d)*s - (4 + d)*t) - 4*psq*t*(5*s^2 + 8*s*t + t^2) + 
          4*s*t*(s^2 + 3*s*t + 2*t^2) + psq^2*(-((-6 + d)*s^2) + 36*s*t + 
            (10 + d)*t^2)) + mm^2*(d*(2*Pi)^(2*d)*psq*s*(3*psq + s - 19*t) - 
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
       Pi^(2*d)*(2*psq - s - 2*t)*(3*psq^2 + mm^2*(psq - t) - 7*psq*t + 
        4*t*(s + t)) + gZlL^2*(2*Pi)^(2*d)*((2 + d)*psq^4 - 
        (-2 + d)*mm^4*(psq - t)^2 - psq^3*((6 + d)*s + 2*(4 + d)*t) - 
        4*psq*t*(4*s^2 + 7*s*t + t^2) + 4*s*t*(s^2 + 3*s*t + 2*t^2) + 
        psq^2*(4*s^2 + (26 + d)*s*t + (10 + d)*t^2) + 
        mm^2*((12 - 8*d)*psq^3 + psq*t*((30 - 17*d)*s + 12*(3 - 2*d)*t) + 
          4*t*(s + t)*((-2 + d)*s + (-3 + 2*d)*t) + 
          psq^2*(5*(-2 + d)*s + 12*(-3 + 2*d)*t))) + 
      gZlR^2*(2*Pi)^(2*d)*((2 + d)*psq^4 - (-2 + d)*mm^4*(psq - t)^2 - 
        psq^3*((6 + d)*s + 2*(4 + d)*t) - 4*psq*t*(4*s^2 + 7*s*t + t^2) + 
        4*s*t*(s^2 + 3*s*t + 2*t^2) + psq^2*(4*s^2 + (26 + d)*s*t + 
          (10 + d)*t^2) + mm^2*((12 - 8*d)*psq^3 + 
          psq*t*((30 - 17*d)*s + 12*(3 - 2*d)*t) + 4*t*(s + t)*
           ((-2 + d)*s + (-3 + 2*d)*t) + psq^2*(5*(-2 + d)*s + 
            12*(-3 + 2*d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
       Pi^(2*d)*(2*psq - s - 2*t)*(4*psq^2 + mm^2*s + 4*t*(s + t) - 
        psq*(s + 8*t)) + gZlL^2*(-((-2 + d)*mm^4*(2*Pi)^(2*d)*s*(psq - t)) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(-2*(-2 + d)*gZlL^2*(mm^2 - psq)*
   ...
   (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
      ...
      gZlL^2*(2*Pi)^(2*d)*((-6 + 5*d)*psq^3 - 2*psq^2*(2*s + (-8 + 7*d)*t) + 
        psq*(-((-2 + d)*s^2) + 4*(-1 + 2*d)*s*t + (-14 + 13*d)*t^2) - 
        2*t*(s + t)*(-2*t + d*(s + 2*t)) - (-2 + d)*mm^2*
         (3*psq^2 + 3*t*(s + t) - psq*(s + 6*t))) + gZlR^2*(2*Pi)^(2*d)*
       ((-6 + 5*d)*psq^3 - 2*psq^2*(2*s + (-8 + 7*d)*t) + 
        psq*(-((-2 + d)*s^2) + 4*(-1 + 2*d)*s*t + (-14 + 13*d)*t^2) - 
        2*t*(s + t)*(-2*t + d*(s + 2*t)) - (-2 + d)*mm^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(2*(-2 + d)*gZlL^2*(psq - t)^2 + 
      2*(-2 + d)*gZlR^2*(psq - t)^2 + d*gZlL*gZlR*(-2*psq^2 - psq*s + s^2 + 
        4*psq*t + s*t - 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-2*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t)^2 + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (2*(gZlL^2 + gZlR^2)*(psq^2*(3*s - 2*t) - 2*t^2*(s + t) - 
        mm^2*s*(-2*psq + s + 2*t) - psq*(s^2 + s*t - 4*t^2)) - 
      d*(2*psq - s - 2*t)*(2*gZlL*gZlR*mm^2*(psq - 2*s - t) + 
        gZlL^2*(-psq^2 + mm^2*s + psq*(s + t)) + 
        gZlR^2*(-psq^2 + mm^2*s + psq*(s + t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
       Pi^(2*d)*(2*psq - s - 2*t)*(psq - t) + gZlL^2*(2*Pi)^(2*d)*
       ((6 - 5*d)*psq^3 - (-2 + d)*mm^2*(psq - t)^2 + 
        psq*t*((14 - 9*d)*s + (14 - 13*d)*t) + 2*t*(s + t)*
         ((-2 + d)*s + 2*(-1 + d)*t) + psq^2*(3*(-2 + d)*s + 
          2*(-8 + 7*d)*t)) + gZlR^2*(2*Pi)^(2*d)*((6 - 5*d)*psq^3 - 
        (-2 + d)*mm^2*(psq - t)^2 + psq*t*((14 - 9*d)*s + (14 - 13*d)*t) + 
        2*t*(s + t)*((-2 + d)*s + 2*(-1 + d)*t) + 
        psq^2*(3*(-2 + d)*s + 2*(-8 + 7*d)*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*s*(-2*psq + s + 2*t)) + 
      gZlL^2*(d*(2*Pi)^(2*d)*s*(psq*(psq + s - 7*t) + mm^2*(-psq + t)) - 
        2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + psq^2*(s - 6*(-2 + d)*t) + 
          psq*(-(mm^2*s) + s^2 - 7*s*t + 6*(-2 + d)*t^2) + 
          t*(mm^2*s - (-2 + d)*(s^2 + 3*s*t + 2*t^2)))) + 
      gZlR^2*(d*(2*Pi)^(2*d)*s*(psq*(psq + s - 7*t) + mm^2*(-psq + t)) - 
        2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + psq^2*(s - 6*(-2 + d)*t) + 
          psq*(-(mm^2*s) + s^2 - 7*s*t + 6*(-2 + d)*t^2) + 
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
     ...
     (gZlL^2 + gZlR^2)*mm^2*((-14 + 5*d)*psq^2 - 
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*
     (gZlL^2 + gZlR^2)*mm^2*((14 - 5*d)*psq^2 + 6*(-2 + d)*psq*s + 4*s^2 - 
      2*d*s^2 + (-2 + d)*mm^2*(psq - 2*s - t) + (-26 + 9*d)*psq*t + 14*s*t - 
      5*d*s*t + 12*t^2 - 4*d*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
     ...
     (gZlL^2 + gZlR^2)*mm^2*(psq^2 + mm^2*s + t^2 - psq*(s + 2*t))*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*
     mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*
     (gZlL^2 + gZlR^2)*mm^2*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*
