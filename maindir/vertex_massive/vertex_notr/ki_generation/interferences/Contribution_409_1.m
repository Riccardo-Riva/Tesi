...
PropList[KiraPropagator[p1 + q1, mh], KiraPropagator[q2, mw], 
 ...
 ((2^(-1 - 2*d)*(-2 + d)*EL^6*gAl*gHHWW*gWlN*gWNl*gWWA*s*(-4*psq + s)*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (2^(-1 - 2*d)*(-2 + d)*EL^6*gAl*gHHWW*gWlN*
    gWNl*gWWA*(mm^2 + psq - 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   Pi^(2*d) + ((-2 + d)*EL^6*gAl*gHHWW*gWlN*gWNl*gWWA*(mm^2 + psq - 2*s)*
