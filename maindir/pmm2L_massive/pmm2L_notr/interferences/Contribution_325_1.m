...
PropList[KiraPropagator[q1, mh], KiraPropagator[-p3 + q1, mm], 
 ...
 ((EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*(-2*(-2 + d)*mm^4*s + 
     s*(-4*psq^2 + (18 - 5*d)*psq*s + 2*(-4 + d)*s^2 - 16*psq*t + 8*s*t + 
       8*t^2) + mm^2*(-8*psq^2 + (-10 + 3*d)*s^2 - 8*s*t - 8*t^2 + 
       2*psq*((4 + d)*s + 8*t)))*\[Mu]^(8 - 2*d))/((2*Pi)^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (4*psq^2 + (-5 + d)*mm^2*s - 5*s^2 + 2*d*s^2 + 4*s*t + 4*t^2 - 
     psq*((-9 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (-10*psq^2 - 4*s^2 + 2*d*s^2 + mm^2*(6*psq - (6 + d)*s - 6*t) - 6*s*t - 
     4*t^2 + psq*((20 + d)*s + 14*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (-2*psq^2 + (-5 + d)*psq*s + 10*s^2 - 2*d*s^2 + 2*mm^2*(psq - t) + 
     4*psq*t - s*t - 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (-10*psq^2 + 6*psq*s + d*psq*s + 2*s^2 + mm^2*(6*psq - d*s - 6*t) + 
     14*psq*t - 6*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (2*psq^2 + (10 + d)*psq*s - 2*s^2 + 2*d*s^2 - mm^2*(6*psq + d*s - 6*t) + 
     2*psq*t - 2*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (-2*psq^2 + (-3 + d)*psq*s + 9*s^2 - 2*d*s^2 + 4*psq*t - 3*s*t - 2*t^2 + 
     2*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (2*psq^2 + 4*s^2 - 2*s*t - 4*t^2 + psq*((-4 + d)*s + 2*t) + 
     mm^2*(-6*psq - (-6 + d)*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (4*psq^2 + (-1 + d)*mm^2*s - s^2 + 4*s*t + 4*t^2 - psq*((3 + d)*s + 8*t))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
   ...
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (4*psq^2 + (-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (2*mm^2 - 4*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*
    gXll^2*mh^2*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/
  ...
  (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*(-psq + 2*s + t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    ...
    gXll^2*mh^2*mm^4*(mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    ...
    gXll^2*mh^2*mm^4*(2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*
    gXll^2*mh^2*mm^4*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*(-mm^2 + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    (2*mm^2 - 3*psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
   ...
   (Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    ...
    gXll^2*mh^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*
    gXll^2*mh^2*mm^4*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*(2*psq + s - 2*t)*
