...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  (-((4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(psq - t)*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (Pi^(2*d)*s)) + (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(mm^2 - psq)*
    ...
    Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (mm^2*(4*psq^2 + 5*psq*s - s^2 - 8*psq*t + 3*s*t + 4*t^2) + 
      4*(-3*psq^3 - 5*psq*t*(s + t) + t*(s + t)^2 + psq^2*(s + 7*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (8*psq^3 + 16*psq*t*(s + t) - 4*t*(s + t)^2 - 4*psq^2*(s + 5*t) + 
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (mm^2*(12*psq^2 - 5*psq*s + s^2 - 24*psq*t + 9*s*t + 12*t^2) - 
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(psq - t)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*
     (psq - t)*(-4*psq + s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^2*(-2*psq^3 + 3*mm^2*psq*s - 6*psq*t*(s + t) + 2*t*(s + t)^2 + 
      2*psq^2*(s + 3*t) - mm^2*s*(2*s + 3*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(2*psq - s - 2*t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(2*mm^2 - 3*psq + s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(mm^2 - psq + s)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (-7*psq^2 - s^2 + 2*mm^2*(psq + s - t) - 2*s*t - 5*t^2 + 
      3*psq*(s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^2*(-psq^2 + mm^2*s - t^2 + 2*psq*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(psq - t)*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[q1, q1]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(psq - t)^2*
    ...
    (Pi^(2*d)*s) - (3*2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
   ...
   (3*2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(psq - t)^2*
    ...
    Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(psq - t)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
