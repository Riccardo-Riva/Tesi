...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (s^2 + 3*s*t + 2*t^2 + mm^2*(mu^2 + 2*(s + t)))*SPList[SP[p1, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (mm^2*(mu^2 - 2*t) + t*(s + 2*t))*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (2*mm^2*(2*mu^2 + s) + (s + 2*t)^2)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(mm^2*mu^2 - s*(s + t))*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (mm^2*mu^2 - 2*s*(s + t))*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (s^2 + 2*mm^2*(mu^2 + 2*s))*SPList[SP[p1, q1], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (mm^2*(mu^2 + 4*s) + 2*s*(s + t))*SPList[SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (4*mm^2*mu^2 + s*(4*mu^2 + 3*s + 2*t))*SPList[SP[p1, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (2*mm^2*mu^2 + s*(2*mu^2 + s))*SPList[SP[p1, q1], SP[p3, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^4*mu^2*
     SPList[SP[p1, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mm^2 + 2*mu^2 + s)*
     SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^4*mu^2*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (mm^2*(mu^2 + 4*s) - 2*s*t)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (mu^2 + s + t)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(mm^2*mu^2 + s*t)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(mm^2*mu^2 + 2*s*t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     (2*mm^2*mu^2 + s*(2*mu^2 + s))*SPList[SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^4*mu^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(mu^2 - t)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mm^2 + s)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(s + t)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mm^2 + s + t)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(s + t)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(-2*mm^2 + s + 2*t)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^4*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(mu^2 + 3*(s + t))*
     SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + 5*s + 4*t)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(s + t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mm^2 + s + t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
     ...
     gXFW^2*mm^2*(2*mm^2 + s + t)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^4*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*t*
     SPList[SP[p2, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p2, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*t*
     SPList[SP[p2, q1], SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(mu^2 - 3*t)*
     SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + s - 4*t)*
     SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*t*
   ...
   (3*2^(5 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + s)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p2, q1], SP[p3, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(mu^2 - t)*
     SPList[SP[p2, q2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (2^(7 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(mu^2 - t)*
     SPList[SP[p2, q2], SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(6*mu^2 + s - 4*t)*
     SPList[SP[p2, q2], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(3 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(mu^2 - t)*
   ...
   (2^(7 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p3, q1], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(3 - d)*EL^8*gAl*gAu^2*gFll^2*gWWA*gXFW^2*mm^2*(2*mu^2 + s)*
