(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, 0], 
  ...
  (((-I)*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*(s + t)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*(s + t)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*(12 - 8*d + d^2)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*
     ...
     (gZlL^4 + gZlR^4)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p2, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(12 - 8*d + d^2)*EL^5*
     gAl*(gZlL^4 + gZlR^4)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
