...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(2*bb*mm^2*(5*psq - 2*s) + 
      aa*mm^2*(-10*psq + s) + 2*aa*psq*(-psq + s) + bb*psq*(2*psq + s))*
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*(6*bb*mm^2*(psq - s) + aa*mm^2*(-6*psq + s) + 
      aa*psq*(-2*psq + s) + 2*bb*psq*(psq + 2*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^4*(mm^2*(psq - 2*s) - psq*(psq + 4*s))*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*
     (-2*bb*(2*mm^2 + s) + aa*(3*mm^2 + psq + 2*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*s*(2*aa*(mm^4 + 2*mm^2*psq + psq*(psq - s)) + 
