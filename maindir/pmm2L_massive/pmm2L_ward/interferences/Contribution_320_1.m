...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 (((-I)*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
    (aa*(mm^4 + mm^2*(-2*psq - s + t) + 3*psq*(-psq + s + t)) + 
     bb*(mm^4 + 3*psq*(psq - t) - mm^2*(2*s + t)))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
    (bb*(12*psq^2 + mm^2*(8*psq - 6*s - 8*t) + 5*s*(s + 2*t) - 
       2*psq*(7*s + 6*t)) + aa*(-12*psq^2 - 5*s*(s + 2*t) + 
       6*psq*(3*s + 2*t) + mm^2*(-8*psq + 2*s + 8*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*
    mm^6*(bb*(-6*psq^2 + 11*psq*s - 2*s^2 - 4*mm^2*(psq - t) + 6*psq*t - 
       7*s*t) + aa*(6*psq^2 - 9*psq*s + 2*s^2 + mm^2*(4*psq - 2*s - 4*t) - 
       6*psq*t + 7*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(3*mm^4*(psq - t) + 2*psq*s*(-2*psq + 2*s + t) + 
       mm^2*(psq^2 - 8*psq*s + 4*s^2 - psq*t + 6*s*t)) - 
     aa*(mm^4*(3*psq - 4*s - 3*t) + psq*s*(-2*psq + s + 2*t) + 
       mm^2*(psq^2 - psq*(6*s + t) + s*(7*s + 6*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*
    mm^6*(aa*(6*psq^2 - 7*psq*s + s^2 + mm^2*(4*psq - 2*s - 4*t) - 6*psq*t + 
       5*s*t) - bb*(6*psq^2 - 9*psq*s + s^2 + 4*mm^2*(psq - t) - 6*psq*t + 
       5*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
    (bb*(6*psq^2 - 11*psq*s + 5*s^2 + mm^2*(4*psq - 2*s - 4*t) - 6*psq*t + 
       7*s*t) + aa*(-6*psq^2 + 9*psq*s - 5*s^2 + 6*psq*t - 7*s*t + 
       4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(mm^4*(3*psq + s - 3*t) + psq*s*(-2*psq + s + 2*t) + 
       mm^2*(psq^2 - s*(s - 6*t) - psq*(7*s + t))) + 
     aa*(2*psq*s*(s - t) + 3*mm^4*(-psq + s + t) - 
       mm^2*(psq^2 - psq*(5*s + t) + 2*s*(s + 3*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*
    mm^6*(aa*(6*psq^2 - 7*psq*s + 4*s^2 + 4*mm^2*(psq - s - t) - 6*psq*t + 
       5*s*t) + bb*(-6*psq^2 + 9*psq*s - 4*s^2 + 6*psq*t - 5*s*t + 
       mm^2*(-4*psq + 2*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*s*
    (bb*mm^2*(5*psq - 2*s - 5*t) + bb*psq*(3*psq - 2*s - 3*t) + 
     aa*psq*(-3*psq + s + 3*t) + aa*mm^2*(-5*psq + 3*s + 5*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*(aa*(2*mm^2 - s - 2*t) + 
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*s*
    ...
    mm^4*(mm^2 - psq)*s*(aa*(mm^2 + psq - 2*s - t) + bb*(mm^2 - psq - s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(12*psq - 5*s - 12*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(mm^4 + 2*psq^2 + mm^2*(7*psq - 9*s - 8*t) + 4*s*(s + t) - 
       psq*(5*s + 2*t)) + bb*(7*mm^4 - 6*psq^2 - mm^2*(11*psq + s - 8*t) - 
       4*s*(s + t) + psq*(15*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(8*psq - 3*s - 8*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(12*psq - 7*s - 12*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(mm^4 - 2*psq^2 + 5*psq*s - mm^2*(9*psq + s - 8*t) + 2*psq*t - 
       4*s*t) + aa*(7*mm^4 - 2*psq^2 + 5*psq*s + mm^2*(5*psq - 9*s - 8*t) - 
       2*psq*t + 4*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*
    (8*psq - 5*s - 8*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(6*psq^2 + 4*mm^2*(3*psq - 2*s - 3*t) + 3*s*(s + 2*t) - 
       psq*(7*s + 6*t)) + bb*(-6*psq^2 - 3*s*(s + 2*t) + 
       4*mm^2*(-3*psq + s + 3*t) + psq*(11*s + 6*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(3*psq - 2*s - 3*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(-5*psq*s + mm^2*(2*psq - s - 2*t) + 4*s*(s + t)) + 
     bb*(4*mm^4 - 2*psq^2 + 9*psq*s - 4*s*(s + t) + 
  ...
  ((3*I)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(3*mm^4 - 2*psq^2 + mm^2*(psq - 4*s - 2*t) + 4*s*t) + 
     bb*(mm^4 + 4*s*(psq - t) + mm^2*(-3*psq + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(-3*psq^2 + 8*psq*s - 2*s^2 + 3*psq*t - 5*s*t + 
       mm^2*(-6*psq + s + 6*t)) + aa*(3*psq^2 - 3*psq*(2*s + t) + 
       s*(2*s + 5*t) + mm^2*(6*psq - 3*(s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(4*psq^2 - 9*psq*s + 2*s^2 + 2*mm^2*(2*psq + s - 2*t) - 4*psq*t + 
     ...
     SP[q1, q1]])/Pi^(2*d) - (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(-3*psq*s + mm^2*(psq - t) + 2*s*(s + t)) + 
     bb*(4*mm^4 + mm^2*(-3*psq - 3*s + t) - 2*(psq^2 - 3*psq*s + s*(s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(3*mm^4 - 2*psq^2 + 8*psq*s - 4*s*(s + t) + 
       mm^2*(-3*psq - 2*s + 2*t)) + aa*(mm^4 + 4*s*(-psq + s + t) + 
       mm^2*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, p3]])/(2*Pi)^(2*d) + (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(3*mm^4 - 2*psq^2 + 5*psq*s + mm^2*(-2*psq - 2*s + t) - 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(-(bb*(2*mm^2 + psq + 2*s)*(psq - s - t)) + 
     aa*(psq^2 + mm^2*(2*psq - 3*s - 2*t) + psq*(2*s - t) - 2*s*(s + t)))*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(mm^4 + 2*s*(psq - t) + mm^2*(-2*psq + t)) + 
     aa*(3*mm^4 - 2*psq^2 + psq*s + 2*s*t - mm^2*(3*s + t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(-3*psq^2 + 3*psq*(2*s + t) - s*(s + 3*t) + 
       mm^2*(-6*psq + s + 6*t)) + aa*((psq - s)*(3*psq - s - 3*t) + 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(psq - t) + 
     bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(3*psq - s - 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (bb*(s*(3*psq - 4*t) + mm^2*(-2*psq + s + 2*t)) + 
     aa*(4*mm^4 - 2*psq^2 + psq*s + 4*s*t - mm^2*(5*s + 2*t)))*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(3*psq^2 - 5*psq*s + 3*s^2 + mm^2*(6*psq - 5*s - 6*t) - 3*psq*t + 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(psq - t) + 
     bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*(s*(psq - 2*t) + mm^2*(-psq + s + t)) + 
     aa*(4*mm^4 - 2*psq^2 + 2*psq*s + 2*s*t - mm^2*(psq + 4*s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(3*psq - s - 3*t) - 
     bb*mm^2*(3*psq + s - 3*t) + aa*psq*(psq + s - t) + 
     bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3]])/
   Pi^(2*d) + (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(2*mm^2 + psq + 2*s)*(psq - t) - 
     bb*(psq^2 + psq*s + mm^2*(2*psq + s - 2*t) - psq*t - 2*s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(3*psq - s - 3*t) - 
     bb*mm^2*(3*psq + s - 3*t) + aa*psq*(psq + s - t) + 
     bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(3*psq^2 + mm^2*(6*psq - 5*s - 6*t) - 3*psq*(s + t) + 
       s*(2*s + 3*t)) + bb*(-((psq - s)*(3*psq - 2*s - 3*t)) + 
       mm^2*(-6*psq + 3*s + 6*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(psq - t) + 
     bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(-psq + s + t)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*s*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(2*mm^2 - psq - t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(7*mm^2 - 3*psq - 4*t) - 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(5*mm^2 - 3*psq - 2*t) - 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(3*mm^2 - psq - 2*t) + 
     bb*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q2, q2]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
  ...
  (I*2^(1 - 2*d)*(2*aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(3*psq - 2*s - 3*t) + 
     bb*(mm^2 - 4*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(3*psq - 2*s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - 2*bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(2*aa*(psq - s - t) + 
     bb*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(psq - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(3*aa - 2*bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(mm^2 + 5*psq - 3*s - 6*t) + 
     bb*(mm^2 - 7*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(mm^2 + psq - 2*t) + 
     ...
     SP[p3, p3]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
  ...
  (I*2^(1 - 2*d)*(2*aa - 3*bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(mm^2 + psq - 2*(s + t)) + 
     bb*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(2*bb*(-psq + s + t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(mm^2 + 3*psq - 2*s - 4*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(mm^2 + 2*psq - s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(mm^2 + psq - 2*t) + 
     2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(2*mm^2 + 2*psq - s - 4*t) + 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(psq - t)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(-psq + s + t)*
