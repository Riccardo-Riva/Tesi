...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*(mm^3 - mm*psq)^2*
    (aa*(psq - s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*(mm^3 - mm*psq)^2*
    (aa*(psq - s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*(mm^3 - mm*psq)^2*(aa*(psq - 2*s - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*(mm^3 - mm*psq)^2*
    (aa*(psq - 2*s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*
    gXll*(gZlL - gZlR)*(mm^3 - mm*psq)^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) + (I*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*(mm^3 - mm*psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*
    gXll*(gZlL - gZlR)*(mm^3 - mm*psq)^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) - (I*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*(mm^3 - mm*psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(mm^2 - psq)*(aa*(psq - s - t) + bb*(-psq - 3*s + t))*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*mm^2*(3*psq - s - 3*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(mm^2 - psq)*(aa*(psq - 4*s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*(psq - s - t) + 
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*(mm^2 - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*(2*mm^2 - psq - t) + 
     aa*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*(3*mm^2 - 2*psq - t) + 
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(bb*(3*mm^2 - 2*psq - t) + 
     ...
     SP[p3, q1]])/(4^d*Pi^(2*d)) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
