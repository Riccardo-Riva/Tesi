...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((EL^5*gAl*gHHH*gHll^3*mh^2*mm^6*s*(bb*(mm^2 + 3*psq - s) + 
      aa*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
  (2^(1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(4*bb*mm^2*psq - aa*psq*s + 
     aa*mm^2*(-4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(-2*bb*mm^2*psq + 
  ...
  (4^(1 - d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(bb*mm^2 - aa*psq)*
