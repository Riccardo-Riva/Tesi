  ...
  ((2^(-1 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*
     mm^2*(2*(-2 + d)*mm^2 - (-4 + d)*psq - 2*(4 + d)*s)*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (2^(1 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*(2*mm^2 + d*s)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (2^(1 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (2^(1 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*(-mm^2 + psq + 4*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (d*EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*
     mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (2^(1 - 2*d)*(-4 + d)*EL^6*gAl^2*gFFZ*gHFF*
