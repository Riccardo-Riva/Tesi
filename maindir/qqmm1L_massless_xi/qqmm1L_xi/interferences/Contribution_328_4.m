...
PropList[KiraPropagator[p1 - q1, 0], KiraPropagator[-p2 - q1, 0]]*
 ((I*2^(-1 - 2*d)*EL^6*gAl*gAu*(gZlR^2*gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s^2) - 
     ...
     gZlL^2*gZlLC*(-(d^2*gZuLC*(2*Pi)^d*s^2) - d^2*gZuRC*(2*Pi)^d*s^2 + 
       2^(1 + d)*gZuLC*Pi^d*((-4 + 3*d)*s^2 + (14 - 7*d + d^2)*s*t + 2*t^2) + 
     ...
     gZlL*gZlR*(gZlLC*(d^2*gZuRC*(2*Pi)^d*s^2 - 2^(1 + d)*gZuRC*Pi^d*
       ...
       gZlRC*(d^2*gZuLC*(2*Pi)^d*s^2 - 2^(1 + d)*gZuLC*Pi^d*
         ...
         gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((8 - 7*d + d^2)*s^2 + 
             (2 - 3*d + d^2)*s*t + 2*t^2)))))*\[Mu]^(4 - d)*
    SPList[SP[p1, p2]])/(Pi^(2*d)*s*(-mz^2 + s)*(-mzC^2 + s)) - 
  (I*(-3 + d)*EL^6*gAl*gAu*(gZlL - gZlR)*
    (gZlL*gZlLC*((-2 + d)*gZuLC*s + (-4 + d)*gZuRC*s + 2*gZuLC*t - 
       2*gZuRC*t) - gZlR*gZlRC*((-4 + d)*gZuLC*s + (-2 + d)*gZuRC*s - 
       2*gZuLC*t + 2*gZuRC*t))*\[Mu]^(4 - d)*SPList[SP[p1, p3]])/
   ((2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)) - 
  ((I/2)*EL^6*gAl*gAu*((2^(1 - 2*d)*(gZlL + gZlR)*
       ...
       gZlL^2*gZlLC*(-(gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
        ...
        (-(gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((16 - 10*d + d^2)*s^2 + 
           ...
           2^(1 + d)*Pi^d*((2 - 2*d + d^2)*s^2 + (8 - 5*d + d^2)*s*t + 
             2*t^2))))/(2*Pi)^(2*d))*\[Mu]^(4 - d)*SPList[SP[p1, q1]])/
   (s*(-mz^2 + s)*(-mzC^2 + s)) - 
  (I*2^(-1 - 2*d)*EL^6*gAl*gAu*(gZlR^2*gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s^2) - 
       d^2*gZuRC*(2*Pi)^d*s^2 + 2^(1 + d)*gZuRC*Pi^d*((-4 + 3*d)*s^2 + 
         (14 - 7*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZuLC*Pi^d*
  ...
  (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuLC + gZuRC)*\[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p1, p3]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) + (I*2^(1 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*
  ...
  (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuLC + gZuRC)*\[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) - (I*2^(1 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*
