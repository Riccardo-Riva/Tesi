...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  ((EL^5*gAl*gXll^2*mm^4*s*
     (-(bb*(2*Pi)^(2*d)*((-2 + d)*gZlL^2*mm^2*(mm^2 + 3*psq - s) + 
         (-2 + d)*gZlR^2*mm^2*(mm^2 + 3*psq - s) + 2*d*gZlL*gZlR*psq*
          (-4*mm^2 + s))) + aa*(-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
          (mm^2 - 5*psq + s)) - (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*
         (mm^2 - 5*psq + s) - 2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*
         (mm^2*(4*psq - 2*s) + psq*s)))*\[Mu]^(8 - 2*d))/(2*Pi)^(4*d) - 
   (2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*(-2*bb*(gZlL^2 + gZlR^2)*
       (mm^2 + 2*psq - s)*s + 2*aa*(gZlL^2 + gZlR^2)*(3*psq - s)*s + 
      bb*d*(gZlL^2*(mm^2 + 2*psq - s)*s + gZlR^2*(mm^2 + 2*psq - s)*s + 
        2*gZlL*gZlR*psq*(-4*mm^2 + s)) + aa*d*(gZlL^2*s*(-3*psq + s) + 
        gZlR^2*s*(-3*psq + s) + 2*gZlL*gZlR*(mm^2*(4*psq - 2*s) + psq*s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
   (2^(1 - 4*d)*EL^5*gAl*gXll^2*mm^4*
     (-(2^(1 + 2*d)*bb*Pi^(2*d)*(2*(-2 + d)*gZlL^2*mm^2*psq + 
         2*(-2 + d)*gZlR^2*mm^2*psq + d*gZlL*gZlR*s*(-2*mm^2 - 2*psq + s))) + 
      aa*(2*Pi)^(2*d)*(2*d*gZlL*gZlR*s*(-4*psq + s) + 
        (-2 + d)*gZlL^2*(mm^2*(4*psq - s) + psq*s) + (-2 + d)*gZlR^2*
         (mm^2*(4*psq - s) + psq*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    Pi^(4*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*
     (gZlL^2 + gZlR^2)*mm^4*(mm^2 + psq - s)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*
     mm^4*s*((-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq) + 
      2*d*gZlL*gZlR*(-2*mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + 
   ((-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^4*s*
     (bb*(mm^2 + 3*psq - s) + aa*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/(2*Pi)^(2*d) - 
   ((-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*s*
   ...
   (EL^5*gAl*gXll^2*mm^4*s*(bb*((-2 + d)*gZlL^2*(mm^2 - psq) + 
    ...
    (2*Pi)^(2*d) - (4^(1 - d)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
