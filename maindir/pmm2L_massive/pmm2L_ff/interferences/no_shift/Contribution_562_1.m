...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((-3*4^(1 - d)*(-1 + d)*EL^6*gAu*gWWAZ*gWWZ*gZlL*gZlR*mm^2*
   ...
   (2^(1 - 2*d)*EL^6*gAu*gWWAZ*gWWZ*(6*(-1 + d)*gZlL*gZlR*mm^2*
      ...
      gZlL^2*((17 - 9*d)*psq^3 + psq*t*((21 - 11*d)*s + (25 - 11*d)*t) + 
        t*(s + t)*((-2 + d)*s + (-4 + d)*t) + 
        psq^2*((-5 + 3*d)*s + 19*(-2 + d)*t) + 
        mm^2*((-7 + 4*d)*psq^2 + 2*psq*(-3*s + 2*d*s + 7*t - 4*d*t) - 
          (s + t)*(-3*s + 2*d*s + 7*t - 4*d*t))) + 
      gZlR^2*((17 - 9*d)*psq^3 + psq*t*((21 - 11*d)*s + (25 - 11*d)*t) + 
        t*(s + t)*((-2 + d)*s + (-4 + d)*t) + 
        psq^2*((-5 + 3*d)*s + 19*(-2 + d)*t) + 
        mm^2*((-7 + 4*d)*psq^2 + 2*psq*(-3*s + 2*d*s + 7*t - 4*d*t) - 
          (s + t)*(-3*s + 2*d*s + 7*t - 4*d*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/(Pi^(2*d)*s) - 
   (3*2^(3 - 2*d)*(-1 + d)*EL^6*gAu*gWWAZ*gWWZ*gZlL*gZlR*mm^2*
     (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAu*gWWAZ*gWWZ*(-6*(-1 + d)*gZlL*gZlR*mm^2*
       (2*psq - s - 2*t)*(psq - t) + gZlL^2*((1 + d)*psq^3 + 
        (-3 + 2*d)*mm^2*(psq - t)*(psq - s - t) - 
        psq*t*((-8 + d)*s + (-9 + d)*t) + t*(s + t)*(-2*s + (-4 + d)*t) - 
        psq^2*(2*s + (6 + d)*t)) + gZlR^2*((1 + d)*psq^3 + 
        (-3 + 2*d)*mm^2*(psq - t)*(psq - s - t) - 
        psq*t*((-8 + d)*s + (-9 + d)*t) + t*(s + t)*(-2*s + (-4 + d)*t) - 
        psq^2*(2*s + (6 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s) - (3*2^(3 - 2*d)*(-1 + d)*EL^6*gAu*gWWAZ*gWWZ*gZlL*gZlR*mm^2*
     (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAu*gWWAZ*gWWZ*
     (-6*(-1 + d)*gZlL*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
      gZlL^2*(2*(-2 + d)*psq^3 + psq^2*((5 - 3*d)*s - 6*(-2 + d)*t) + 
        (s + t)*((-3 + 2*d)*mm^2*s - (-2 + d)*t*(s + 2*t)) + 
        psq*((3 - 2*d)*mm^2*s + t*((-11 + 6*d)*s + 6*(-2 + d)*t))) + 
