...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  ((2^(1 - 4*d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*mm^2*sw*
     ...
     \[Mu]^(8 - 2*d))/(Pi^(4*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*
     mm^2*sw*(-(gZlR*(d*(2*Pi)^(2*d)*(mm^2 - psq)*(2*psq^2 - 3*psq*s + s^2 - 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*mm^2*sw*
     ((-2 + d)*gZlL*(mm^2*(psq - t) + psq*(psq - s - t)) - 
      gZlR*(d*psq - s)*(2*psq - s - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*gZlR*mm^2*sw*(-2*s + d*(psq - t))*
