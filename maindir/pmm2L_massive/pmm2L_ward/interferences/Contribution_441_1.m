...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (((-I)*2^(1 - 2*d)*(-1 + d)*EL^5*gAl^2*gWWAZ*(gZlL + gZlR)*mm^2*s*
       (aa*((-2 + d)*mm^2 + (2 + d)*psq - d*(s + 2*t)) + 
        bb*((-2 + d)*mm^2 + (2 - 3*d)*psq + d*(s + 2*t)))*\[Mu]^(8 - 2*d))/
      (mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl^2*gWWAZ*
       (gZlL + gZlR)*(4*aa*d*mm^2*(psq - t) + aa*d*s*(-3*psq + s + t) - 
        2*aa*s*(2*mm^2 - 3*psq + s + t) + 2*bb*s*(-psq + s + t) - 
        bb*d*(s*(-psq + s + t) + mm^2*(4*psq - 2*(s + 2*t))))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1]])/(mz^2*Pi^(2*d)) - 
     (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl^2*gWWAZ*(gZlL + gZlR)*
      ...
      (mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*(2 - 3*d + d^2)*EL^5*gAl^2*
       gWWAZ*(gZlL + gZlR)*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
     ...
     KiraPropagator[q2, mw]]*((I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl^2*gWWAZ*
       (gZlL + gZlR)*mm^2*s*(aa*((-2 + d)*mm^2 + (2 + d)*psq - d*(s + 2*t)) + 
        bb*((-2 + d)*mm^2 + (2 - 3*d)*psq + d*(s + 2*t)))*\[Mu]^(8 - 2*d))/
      (mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl^2*gWWAZ*
       (gZlL + gZlR)*(4*aa*d*mm^2*(psq - t) + aa*d*s*(-3*psq + s + t) - 
        2*aa*s*(2*mm^2 - 3*psq + s + t) + 2*bb*s*(-psq + s + t) - 
