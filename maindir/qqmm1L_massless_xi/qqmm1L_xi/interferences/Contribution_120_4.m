...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
  ...
  (((-I)*2^(-1 - 2*d)*EL^6*gAu^2*s*
   ...
   (I*EL^6*gAu^2*s*
     ...
     (-mzC^2 + s)) - 
   (I*EL^6*gAu^2*s*(gZlL*gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s + 
   ...
   (I*2^(1 - d)*EL^6*gAu^2*s*(gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + 
   ...
   (I*EL^6*gAu^2*(gZlR*gZlRC*(-(d^2*(gZuL*gZuLC - gZuR*gZuRC)*(2*Pi)^d*s) + 
      ...
      gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s) + 2^(1 + d)*d*Pi^d*(s - t) + 
          ...
          2^(1 + d)*Pi^d*(6*s - 4*d*s + 2*t - d*t))))*\[Mu]^(4 - d)*
