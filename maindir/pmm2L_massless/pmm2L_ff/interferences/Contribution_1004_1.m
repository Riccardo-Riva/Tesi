...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(1 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*(s + t)*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*t*(mm^2 + 2*t)*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*(s + t)*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*(2*mm^2 + t)*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*
      (s^2 + 3*s*t + t*(-mm^2 + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*
      (2*t*(s + t) - mm^2*(s + 4*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*t*(s + t)*
    ...
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*t*(s + t)*
    ...
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*(s + 4*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)) + 
    (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*(s + 2*t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*t*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*
      (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*(s + 2*t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*
     ...
     (mz^2*Pi^(2*d)) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*
      (gZlL + gZlR)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*
      (gZlL + gZlR)*(mm^2*s - t*(s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*mm^2 + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*(s + t)*
     ...
     (mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*
      (gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*
      ggmgmZ*(gZlL + gZlR)*t^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*t^2*
     ...
     (mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*
      ...
      (gZlL + gZlR)*t*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*(s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*
      (gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
       SP[p3, q1]])/(mz^2*Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*
      (gZlL + gZlR)*t^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*(s + t)*
     ...
     (mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*
      (gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*
      ggmgmZ*(gZlL + gZlR)*t^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[q2, q2]])/
     (mz^2*Pi^(2*d)) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*
      (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)) - (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*(s + t)*
