...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  ((I*EL^5*gWlN*gWNl*gWWA*gZNL*s*
         ...
         (4*gZlR*mm^2*psq*(-2*psq + s + 2*t) + 
          gZlL*(2*psq^3 + 2*psq^2*(7*s - t) + s^2*(s + t) - 
            3*psq*s*(3*s + 2*t) + 2*mm^2*(psq^2 + s*(s - 2*t) - 
              psq*(3*s + t))))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(4*d) - (I*EL^5*gWlN*gWNl*gWWA*gZNL*s*
     (-(aa*(12 - 8*d + d^2)*gZlR*mm^2*(psq - s - t)) + 
      bb*(12 - 8*d + d^2)*gZlR*mm^2*(psq - s - t) + 
      bb*gZlL*(2*d*psq*(psq - 3*s - t) - (8 - 6*d + d^2)*mm^2*(psq - s - t) - 
        4*s*(-5*psq + s + t) + d^2*psq*(-psq + s + t)) + 
   ...
   (I*2^(1 - 4*d)*EL^5*gWlN*gWNl*gWWA*gZNL*
     ...
     (aa*(12 - 8*d + d^2)*gZlR*mm^2*(psq - t) - bb*(12 - 8*d + d^2)*gZlR*mm^2*
       (psq - t) + aa*gZlL*(-((8 - 6*d + d^2)*mm^2*(psq - t)) + 
        2*d*psq*(psq + 2*s - t) + d^2*psq*(-psq + t) - 4*s*(3*psq + t)) + 
      bb*gZlL*((16 - 10*d + d^2)*psq^2 + 4*psq*s - (-2 + d)*d*psq*t + 4*s*t + 
        (-2 + d)*mm^2*((4 + d)*psq - 4*s + 4*t - d*t)))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZNL*s*
     (-(aa*(-2 + d)*gZlR*mm^2*(2*psq - s - 2*t)) + bb*(-2 + d)*gZlR*mm^2*
       (2*psq - s - 2*t) + bb*gZlL*(-((2 + d)*psq^2) + 2*psq*t + 
        ...
        mm^2*((-2 + d)*psq + 4*s - d*s + 2*t - d*t) - psq*(6*s + (2 + d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
   (I*EL^5*gWlN*gWNl*gWWA*gZNL*s*
     (-(aa*(-2 + d)^2*gZlR*mm^2*(2*psq - s - 2*t)) + 
      bb*(-2 + d)^2*gZlR*mm^2*(2*psq - s - 2*t) + 
      aa*gZlL*(2*(-4 + d^2)*psq^2 + 4*s*(s + 2*t) + (-2 + d)*mm^2*
     ...
     (aa*(12 - 8*d + d^2)*gZlR*mm^2*(psq - 2*s - t) - 
      ...
      aa*gZlL*(-((-16 + 6*d + d^2)*psq^2) + (16 + d^2)*psq*s + 
        (-2 + d)*d*psq*t - (-2 + d)*mm^2*((-12 + d)*psq - 2*(-8 + d)*s - 
          (-4 + d)*t) - 2*s*(4*s + d*t)) + 
      bb*gZlL*(8*s*(-4*psq + s) + (8 - 6*d + d^2)*mm^2*(psq - 2*s - t) + 
        d^2*psq*(psq - s - t) + d*(-2*psq^2 + 8*psq*s + 2*psq*t + 2*s*t)))*
   ...
   (I*2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gZNL*
     (aa*(12 - 8*d + d^2)*gZlR*mm^2*(psq - t) - bb*(12 - 8*d + d^2)*gZlR*mm^2*
       (psq - t) + bb*gZlL*((16 - 10*d + d^2)*psq^2 + 2*d*s*t + 
   ...
   (I*4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gZNL*(-(aa*(12 - 8*d + d^2)*gZlR*mm^2) + 
      bb*(12 - 8*d + d^2)*gZlR*mm^2 - bb*gZlL*((8 - 6*d + d^2)*mm^2 + 8*psq - 
        2*d*s + 8*t - 4*d*t) + aa*gZlL*((24 - 14*d + d^2)*mm^2 + 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*
     ...
     (-(aa*(12 - 8*d + d^2)*gZlR*mm^2) + bb*(12 - 8*d + d^2)*gZlR*mm^2 + 
      ...
      bb*gZlL*(-((8 - 6*d + d^2)*mm^2) + 2*(-6 + d)*psq + 4*s - 4*t + 2*d*t))*
