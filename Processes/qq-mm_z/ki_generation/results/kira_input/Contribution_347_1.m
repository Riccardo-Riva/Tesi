...
(I*EL^6*gAl*gAu*(gZlL + gZlR)*gZNL^2*(gZuL + gZuR)*
 ...
 (I*EL^6*gAl*gAu*gZNL^2*(gZlL*gZuL*((-4 + d)*s - 2*t) + 
  ...
  ((2*Pi)^d*(mz^2 - s)^2*s) - (I*2^(-1 - d)*EL^6*gAl*gAu*gZNL^2*
   (-((-4 + d)^2*gZlL*gZuR*s) + (-4 + d)*gZlR*gZuL*((-2 + d)*s - 2*t) + 
    2*(-2 + d)*gZlL*gZuR*t + (-2 + d)*gZlL*gZuL*((-4 + d)*s + 2*t) - 
    gZlR*gZuR*((-2 + d)^2*s + 2*(-4 + d)*t))*userIntegral[A1, {0}, -1, 1, 1, 
    0])/(Pi^d*(mz^2 - s)^2) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gZNL^2*
 ...
 (I*4^(-1 - d)*EL^6*gAl*gAu*gZNL^2*
   (gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) - d^2*gZuR*(2*Pi)^d*s^2 + 
      ...
      gZuL*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 + 
          (18 - 9*d + d^2)*s*t + 2*t^2))))*userIntegral[A1, {0}, 0, 0, 1, 0])/
  (Pi^(2*d)*(mz^2 - s)^2*s) - (I*2^(-1 - d)*EL^6*gAl*gAu*gZNL^2*
   ((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - (-4 + d)*gZlL*gZuR + 
    (-2 + d)*gZlR*gZuR)*t*userIntegral[A1, {0}, 0, 1, -1, 0])/
 ...
 (I*2^(-1 - d)*EL^6*gAl*gAu*gZNL^2*
   (gZlR*((-4 + d)^2*gZuL*s + (-2 + d)^2*gZuR*s - 2*(-2 + d)*gZuL*t + 
      ...
      (-2 + d)*gZuL*((-4 + d)*s + 2*t)))*userIntegral[A1, {0}, 0, 1, 1, -1])/
