...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((I*2^(-3 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWAA*
    (aa*(-38*psq*s + 2*(-6 + d)*mm^2*(psq - s - t) - 
       d*(6*psq - 5*s)*(psq - s - t) + 18*s*(s + t)) + 
     bb*(58*psq*s - 18*s*(s + t) - 2*mm^2*((-6 + d)*psq + 16*s - 6*d*s + 
         6*t - d*t) + d*(6*psq^2 + 5*s*(s + t) - 3*psq*(7*s + 2*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-3 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWAA*
    (bb*(2*(-6 + d)*mm^2*(psq - t) - d*(6*psq - 5*s)*(psq - t) + 
       2*s*(psq + 9*t)) + aa*(6*d*psq^2 - 22*psq*s + 5*d*psq*s - 6*d*psq*t - 
       18*s*t + 5*d*s*t - 2*mm^2*((-6 + d)*psq + 5*(-2 + d)*s - (-6 + d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-3 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWAA*s*
    (bb*(2*(3 + d)*mm^2 + (-42 + 8*d)*psq - (-18 + 5*d)*(s + 2*t)) + 
     aa*(2*(3 + d)*mm^2 - 6*(-5 + 2*d)*psq + (-18 + 5*d)*(s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
  (I*(aa + bb)*(3 + d)*EL^5*gWlN*gWNl*gWWA*gWWAA*(mm^2 - psq)*s*
  ...
  (I*4^(-1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWAA*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gWlN*gWNl*gWWA*gWWAA*
    (bb*((-6 + 4*d)*mm^2 + 4*psq - 3*d*psq + 2*s + 2*t - d*t) + 
     aa*((10 - 6*d)*mm^2 - 8*psq + 5*d*psq - 2*s - 2*t + d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWAA*(2*(-5 + 3*d)*psq - 5*(-2 + d)*s + 
     2*(5 - 3*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWAA*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWAA*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWAA*(2*psq - s - 2*t)*
