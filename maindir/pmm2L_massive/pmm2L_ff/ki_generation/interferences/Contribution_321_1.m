...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(mm^2 - 3*psq + s + 2*t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(-2*psq^3 - 2*psq^2*(s - 3*t) + 
       ...
       t*(s^2 + 3*s*t + 2*t^2) + mm^2*(8*psq^2 - 4*psq*s + s^2 - 15*psq*t + 
         6*s*t + 7*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*
      (2*psq^2 + s^2 + 2*s*t + 2*t^2 - 2*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(2*psq^3 + mm^4*s - 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(-7*psq^3 + 3*psq^2*(s + 6*t) - 
      ...
      (psq - t)*(2*psq^2 + mm^2*(psq - t) - 4*psq*t + t*(s + 2*t))*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(-3*psq^3 + 
       mm^2*(psq - t)*(psq - s - t) + 2*psq^2*(s + 5*t) - 
       psq*t*(8*s + 11*t) + 2*t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 + s)*(-2*psq + s + 2*t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq - t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq^2 + mm^2*s + (s + t)^2 - 
       psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*
      (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq^2 + mm^2*(psq - t) - 3*psq*t + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - 3*psq + s + 2*t)*
