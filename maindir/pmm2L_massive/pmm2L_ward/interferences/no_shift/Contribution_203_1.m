...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  (((-I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*psq*s*(2*psq - s - 2*t)*
   ...
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*(aa*mm^2*(psq - 2*s - t) - 
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*(aa*(mm^2 - 2*psq)*(psq - t) - 2*bb*psq*t + 
      bb*mm^2*(psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    Pi^(2*d) - (I*4^(2 - d)*EL^5*gAl^2*gFFA^3*s*(bb*(mm^2 - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA^3*s*(bb*(2*mm^2 - psq - t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*(6*aa*psq*s + aa*mm^2*(2*psq - 3*s - 2*t) - 
      4*aa*s*t + 2*bb*s*(psq + 2*t) + bb*mm^2*(-2*psq - 5*s + 2*t))*
