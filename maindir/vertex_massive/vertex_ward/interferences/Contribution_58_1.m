...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*(2*aa*(-2 + d)*mm^4 + 
  ...
  ((aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^4*s*((-2 + d)*mm^2 + (-2 + d)*psq - 
     (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  ((aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^4*s*((-2 + d)*mm^2 + (-2 + d)*psq - 
     (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
  (2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*s*
  ...
  ((aa - bb)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(mm^2 + psq)*s*
  ...
  (EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*aa*(-2 + d)*mm^4 + aa*(-2 + d)*psq*s - 
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFll^2*mm^4*
    ((-2 + d)*mm^2 + (-2 + d)*psq - (-4 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  ((-aa + bb)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(2*(-2 + d)*mm^4 - (-2 + d)*psq*s + 
     mm^2*(2*(-2 + d)*psq + (10 - 3*d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*d*psq*s - 2*aa*(3*mm^2 + psq)*s + 
     2*bb*(mm^2 + 3*psq)*s + aa*d*mm^2*(8*psq + s) + 
     bb*d*(-3*psq*s + mm^2*(-8*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*d*psq*s - 2*aa*(4*mm^2 + psq)*s + 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  ((-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*mm^2 - bb*psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gAl^2*gFFA*gFll^2*mm^2*(aa*mm^2 - bb*psq)*
