...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)^2*s*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^6*(2*aa*(mm^2*(psq - t) + psq*(psq - s - t)) - 
     bb*(mm^2 + psq)*(2*psq - s - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*
    (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^6*(aa*(mm^2 + psq)*(2*psq - s - 2*t) + 
  ...
  (I*4^(1 - d)*aa*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(bb*(mm^2 - psq) + 
     aa*(3*mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(3*mm^2 + psq)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(mm^2 - psq) + 
     bb*(3*mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(psq - s - t) + 
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*4^(1 - d)*bb*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(3*mm^2 + psq)*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(psq - t)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2*(7*psq - 4*s - 7*t) + 
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(psq - s - t) + 
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(-psq + s + t)*
