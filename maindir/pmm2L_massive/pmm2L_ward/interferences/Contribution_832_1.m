...
PropList[KiraPropagator[-q1, mm], KiraPropagator[q2, mh], 
  ...
  ((I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)*s*
   ...
   (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*(aa*s*(5*psq - 4*s - 5*t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*(2*bb*mm^2*(psq - t) - 
   ...
   (I*4^(2 - d)*EL^5*gAl^3*gHll^2*mm^4*(bb*(mm^2 + psq - s - 2*t) + 
      aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p2]])/(mh^2*Pi^(2*d)) + 
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(bb*(3*mm^2 - psq - 2*t) + 
      aa*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p1, p3]])/(mh^2*Pi^(2*d)) - (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
     (3*aa*(2*psq - s - 2*t) + bb*(4*mm^2 - 10*psq + 3*s + 6*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(mh^2*Pi^(2*d)) + 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - 9*psq + 3*s + 8*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(mh^2*Pi^(2*d)) + 
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(bb*(mm^2 + psq - 2*(s + t)) + 
      aa*(3*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p2, p3]])/(mh^2*Pi^(2*d)) - 
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(aa*(4*mm^2 + 2*psq - 3*s - 6*t) + 
      3*bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p2, q1]])/(mh^2*Pi^(2*d)) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*
     gHll^2*mm^4*(mm^2 + 7*psq - 5*s - 8*t)*\[Mu]^(8 - 2*d)*
   ...
   ((3*I)*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*psq - s - 2*t)*
   ...
   ((3*I)*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/(mh^2*Pi^(2*d)) - 
   (I*2^(3 - 2*d)*bb*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, p3]])/(mh^2*Pi^(2*d)) + 
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(aa*(psq - t) + 
      bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p1, q1]])/(mh^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*
     gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - 2*s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(mh^2*Pi^(2*d)) + 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p3, p3]])/(mh^2*Pi^(2*d)) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/(mh^2*Pi^(2*d)) - 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(3*psq - 2*s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/(mh^2*Pi^(2*d)) - 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/(mh^2*Pi^(2*d)) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(3*psq - 2*s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q2, q2]])/(mh^2*Pi^(2*d)) + 
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(aa*(psq - t) + 
      bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(aa*(psq + s - t) + 
   ...
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(-psq + s + t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2]])/(mh^2*Pi^(2*d)) - 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(mh^2*Pi^(2*d)) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q2, q2]])/(mh^2*Pi^(2*d)) - 
   (I*2^(3 - 2*d)*aa*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, p3]])/(mh^2*Pi^(2*d)) + 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(mh^2*Pi^(2*d)) + 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q2, q2]])/(mh^2*Pi^(2*d)) + 
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(aa*(mm^2 - s - t) + 
    ...
    (mh^2*Pi^(2*d)) + ((3*I)*4^(2 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*
  ...
  (((-I)*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)*s*
   ...
   (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*
     (bb*(-psq^2 + s*(mm^2 - 2*t) + psq*(s + t)) + 
      aa*(psq^2 - psq*(3*s + t) + s*(mm^2 + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3]])/(mh^2*Pi^(2*d)) + 
   (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*(bb*s*(7*psq - 4*s - 5*t) - 
      2*bb*mm^2*(psq - t) + 2*aa*mm^2*(psq - s - t) + 
