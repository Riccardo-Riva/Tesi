...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((4^(1 - d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*gZlL*gZlR*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*
     (-2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq)*(2*psq + (-4 + d)*s - 2*t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*gZlL*gZlR*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*
     (-2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq)*(2*psq - (-2 + d)*s - 2*t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*(gZlL^2 + gZlR^2)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*
