...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((EL^5*gAl^3*mm^2*s*(aa*((-2 + d)*gZlL^2*((-2 + d)*mm^4 - 
   ...
   (2^(1 - 4*d)*EL^5*gAl^3*
     (aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*(-2 + d)^2*psq^2 + 
           2*(12 - 11*d + 2*d^2)*psq*s - (8 - 6*d + d^2)*s^2 + 
           mm^2*(4*(-2 + d)^2*psq - (-4 + d)*d*s))) + gZlL^2*(2*Pi)^(2*d)*
         ((8 - 6*d + d^2)*psq*(psq - s)*s + (-2 + d)*mm^4*((-4 + 5*d)*psq - 
            d*s) + (-2 + d)*mm^2*((-4 + d)*psq^2 + (-22 + 3*d)*psq*s + 
            2*s^2)) + gZlR^2*(2*Pi)^(2*d)*((8 - 6*d + d^2)*psq*(psq - s)*s + 
      ...
      bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*(-2 + d)^2*psq^2 + 
        ...
        (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^4*((-4 + 5*d)*psq - 4*s) + 
          (-4 + d)*psq^2*s + mm^2*((-4 + d)*psq^2 + 2*(-9 + d)*psq*s - 
            (-6 + d)*s^2)) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         (mm^4*((-4 + 5*d)*psq - 4*s) + (-4 + d)*psq^2*s + 
          mm^2*((-4 + d)*psq^2 + 2*(-9 + d)*psq*s - (-6 + d)*s^2))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(4*d) + 
   (2^(1 - 4*d)*EL^5*gAl^3*mm^2*
     (aa*(4^(1 + d)*d*gZlL*gZlR*Pi^(2*d)*(mm^2*(2*psq - s) - psq*s) - 
        (-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-4 + d)*psq^2 - 2*(1 + d)*psq*s + 
          2*s^2 + mm^2*((-4 + d)*psq + 2*s)) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         ((-4 + d)*psq^2 - 2*(1 + d)*psq*s + 2*s^2 + 
          mm^2*((-4 + d)*psq + 2*s))) + 
      bb*(-(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s)) + 
        (-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-4 + d)*psq^2 - d*psq*s + 2*s^2 + 
          mm^2*((-4 + d)*psq - d*s)) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
   ...
   (4^(1 - 2*d)*EL^5*gAl^3*(aa*((8 - 6*d + d^2)*gZlL^2*(2*Pi)^(2*d)*psq*
      ...
      bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*((4 - 6*d + d^2)*mm^2 + 
        ...
        (-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + (-4 + d)*psq^2 + 
         ...
         ((-2 + d)*mm^4 + (-4 + d)*psq^2 + mm^2*(2*(-5 + d)*psq - 
            (-4 + d)*s))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    Pi^(4*d) + (4^(1 - d)*EL^5*gAl^3*
     (bb*mm^2*(-4*d*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*(2*mm^2 + (2 + d)*psq + 
          (-6 + d)*s) + (-2 + d)*gZlR^2*(2*mm^2 + (2 + d)*psq + 
          (-6 + d)*s)) - aa*(-4*d*gZlL*gZlR*mm^2*psq + 
        (-2 + d)*gZlL^2*(mm^2*((4 + d)*psq - 2*s) + (-4 + d)*psq*s) + 
        (-2 + d)*gZlR^2*(mm^2*((4 + d)*psq - 2*s) + (-4 + d)*psq*s)))*
   ...
   (2^(1 - 4*d)*EL^5*gAl^3*(aa*mm^2*(4^(1 + d)*d*gZlL*gZlR*Pi^(2*d)*
         (2*mm^2 + 2*psq + s) - (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
         ((-4 + d)*mm^2 + (4 - 3*d)*psq + 2*(-9 + 2*d)*s) - 
        (-2 + d)*gZlR^2*(2*Pi)^(2*d)*((-4 + d)*mm^2 + (4 - 3*d)*psq + 
          2*(-9 + 2*d)*s)) + bb*(-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
          (2*mm^2 + 2*psq + s)) + (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
         ((-4 + d)*mm^4 + (-4 + d)*psq*s + mm^2*((4 - 3*d)*psq + 
            (-14 + 3*d)*s)) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         ((-4 + d)*mm^4 + (-4 + d)*psq*s + mm^2*((4 - 3*d)*psq + 
            (-14 + 3*d)*s))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    Pi^(4*d) + (2^(1 - 4*d)*(-2 + d)*EL^5*gAl^3*
     (aa*(-(gZlL^2*(2*Pi)^(2*d)*psq*((-4 + d)*mm^2 + (-4 + d)*psq - 
           (-6 + d)*s)) - gZlR^2*(2*Pi)^(2*d)*psq*((-4 + d)*mm^2 + 
          (-4 + d)*psq - (-6 + d)*s) + 2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
         (2*(-2 + d)*psq - (-4 + d)*s)) + 
      bb*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*(-2 + d)*psq - 
           (-4 + d)*s)) + gZlL^2*(2*Pi)^(2*d)*((-4 + d)*psq^2 + 
          mm^2*((-4 + d)*psq - (-6 + d)*s)) + gZlR^2*(2*Pi)^(2*d)*
         ((-4 + d)*psq^2 + mm^2*((-4 + d)*psq - (-6 + d)*s))))*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ...
    Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*mm^2*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    Pi^(2*d) + (2^(1 - 4*d)*EL^5*gAl^3*
     (aa*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*s - (-2 + d)*gZlL^2*
         (2*Pi)^(2*d)*((-8 + d)*mm^4 + mm^2*((-8 + d)*psq - 2*s) - 
          2*(-6 + d)*psq*s) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         ((-8 + d)*mm^4 + mm^2*((-8 + d)*psq - 2*s) - 2*(-6 + d)*psq*s)) + 
    ...
    Pi^(2*d) - (2^(1 - 4*d)*EL^5*gAl^3*
     (aa*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s) - 
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*
     (bb*(-2*(-6 + d)*gZlL*gZlR*mm^2 + gZlL^2*((-6 + d)*mm^2 - 2*psq) + 
        gZlR^2*((-6 + d)*mm^2 - 2*psq)) + aa*(2*(-6 + d)*gZlL*gZlR*mm^2 + 
        gZlL^2*(2*mm^2 + 6*psq - d*psq) + gZlR^2*(2*mm^2 + 6*psq - d*psq)))*s*
   ...
   (2^(1 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl^3*
     (bb*(4*d*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*((-6 + d)*mm^2 - 2*psq) + 
