...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
     ...
     (Pi^(2*d)*s^2)) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXX*gHXZ*gXll*
     (gZlL - gZlR)*mh^2*mm^2*(-2*psq^2 + (-4 + d)*psq*s - 2*(-4 + d)*s^2 + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*
     mh^2*mm^2*(2*psq^2 + psq*((2 + d)*s - 2*t) + 4*mm^2*(psq - t) - 
      2*s*((-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXX*gHXZ*gXll*
     (gZlL - gZlR)*mh^2*mm^2*(2*psq^2 - 2*s^2 + d*s^2 + psq*(s - d*s - 4*t) - 
      2*mm^2*(psq - t) + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXX*gHXZ*gXll*
     (gZlL - gZlR)*mh^2*mm^2*(2*mm^2 + psq - (-4 + d)*s)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*
     mh^2*mm^2*(2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
