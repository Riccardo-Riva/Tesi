...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((EL^5*gAl^3*gFll^2*mm^4*(-2*bb*d*mm^2*(psq - s) - 3*bb*d*psq*s + 
  ...
  (EL^5*gAl^3*gFll^2*mm^2*(aa*d*mm^2*(8*psq - s) - 2*aa*(mm^2 - 3*psq)*s - 
     3*aa*d*psq*s + 2*bb*(-3*mm^2 + psq)*s - 
  ...
  (EL^5*gAl^3*gFll^2*mm^2*(bb*(2*d*mm^2*(psq - s) + 4*mm^2*s - 2*psq*s + 
