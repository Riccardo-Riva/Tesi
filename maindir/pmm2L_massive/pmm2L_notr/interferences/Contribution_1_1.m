...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (-((2^(-1 - 2*d)*EL^8*gAl*gAu^2*gFFAZ*gFll^2*gZNL*mm^2*
  ...
  (EL^8*gAl*gAu^2*gFFAZ*gFll^2*gZNL*mm^2*(-2*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl*gAu^2*gFFAZ*gFll^2*gZNL*mm^2*(-2*psq + (-4 + d)*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (EL^8*gAl*gAu^2*gFFAZ*gFll^2*gZNL*mm^2*(2*psq + (-2 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFAZ*gFll^2*gZNL*mm^2*\[Mu]^(8 - 2*d)*
