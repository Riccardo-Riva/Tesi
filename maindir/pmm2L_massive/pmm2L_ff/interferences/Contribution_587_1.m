...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
   ...
   (-((4^(1 - d)*EL^6*gAl^5*gAu*mm^2*(psq^2 - 2*psq*t + t*(s + t))*
    ...
    (4^(1 - d)*EL^6*gAl^5*gAu*mm^2*(mm^2*(psq - t)*(8*(-2 + d)*psq - 
         (4 - 6*d + d^2)*s - 8*(-2 + d)*t) + 
    ...
    (4^(1 - d)*EL^6*gAl^5*gAu*mm^2*
      (mm^2*(8*(-2 + d)*psq - (4 - 6*d + d^2)*s - 8*(-2 + d)*t) + 
       2*(-((-2 + d)^2*psq^2) + (12 - 9*d + d^2)*psq*s + (-2 + d)^2*psq*t + 
         (-2 + d)*s*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl^5*gAu*(psq^2 - 2*psq*t + t*(s + t))*
    ...
    (2^(5 - 2*d)*EL^6*gAl^5*gAu*((psq - 2*s - t)*(2*psq^2 + mm^2*s + 
         2*t*(s + t) - psq*(s + 4*t)) + d*(-psq^3 + mm^4*s - 
    ...
    (4^(2 - d)*EL^6*gAl^5*gAu*(-((12 - 4*d + d^2)*psq^3) + 
       ...
       mm^2*((8 - 4*d + d^2)*psq^2 + psq*((2 - 3*d)*s - 2*(8 - 4*d + d^2)*
            t) + (s + t)*((-2 + d)*s + (8 - 4*d + d^2)*t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl^5*gAu*((-56 + 22*d - 3*d^2)*psq^3 - 
       ...
       psq*((24 - 10*d + d^2)*s^2 - 2*(72 - 26*d + 3*d^2)*s*t + 
         ...
         2*psq*((2 - 7*d + 2*d^2)*s + (32 - 26*d + 5*d^2)*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl^5*gAu*(-8*(-3 + d)*psq^3 - (8 - 10*d + d^2)*mm^4*
        ...
        ((-2 + d)*s + 2*(5 - 2*d)*t) + psq^2*((20 - 10*d + d^2)*s + 
         ...
         2*(4 + d)*s^2 - 3*(16 - 10*d + d^2)*psq*t + 2*(12 - 12*d + d^2)*s*
          t + 2*(14 - 10*d + d^2)*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^5*gAu*mm^2*(12*s*(-2*psq + s + 2*t) + 
       d^2*s*(-2*psq + s + 2*t) + 2*d*(-2*psq^2 + 2*mm^2*(psq - t) + 
         2*psq*(3*s + t) - 3*s*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^5*gAu*(4*(-2 + d)*psq^3 + (8 - 10*d + d^2)*mm^4*s + 
       ...
       mm^2*((8 - 14*d + d^2)*psq^2 - 8*(-1 + d)*s^2 + (20 - 24*d + d^2)*s*
          t + (8 - 14*d + d^2)*t^2 - 2*psq*((14 - 17*d + d^2)*s + 
    ...
    (4^(1 - d)*EL^6*gAl^5*gAu*(2*mm^2*(psq - t)*(2*(-2 + d)*psq + 
         (-6 + d)*s - 2*(-2 + d)*t) + (-4 + d)*(-4*(-4 + d)*psq^3 + 
         2*t*(s + t)*((-8 + d)*s + (-6 + d)*t) + 
         psq*t*((50 - 7*d)*s - 8*(-5 + d)*t) + psq^2*((-22 + 3*d)*s + 
           2*(-22 + 5*d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^5*gAu*((-48 + 26*d - 3*d^2)*psq^3 - 
    ...
    (4^(1 - d)*EL^6*gAl^5*gAu*(-8*(-2 + d)*psq^3 - (-2 + d)*psq^2*
        ((-8 + d)*s - 24*t) + mm^2*s*((-12 + d^2)*s + (16 - 14*d + 3*d^2)*
          t) + 4*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) + 
       psq*((-16 + 14*d - 3*d^2)*mm^2*s + (24 - 10*d + d^2)*s^2 + 
         (40 - 22*d + d^2)*s*t - 24*(-2 + d)*t^2))*\[Mu]^(8 - 2*d)*
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl^5*
      gAu*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p1, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl^5*gAu*
      (-2*(-8 + d)*psq^2 - 2*(4 + d)*psq*s + 2*(-10 + d)*psq*t + 
       4*(s + t)^2 + mm^2*(2*(-3 + d)*psq + (-2 + d)*s - 2*(-3 + d)*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^5*gAu*
      (mm^2*(2*(14 - 8*d + d^2)*psq - (20 - 12*d + d^2)*s - 
         2*(14 - 8*d + d^2)*t) + 2*(-((12 - 6*d + d^2)*psq^2) + 
         (24 - 10*d + d^2)*psq*s + (-2 + d)^2*psq*t - 2*(-4 + d)*t*(s + t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^5*gAu*(-((48 - 24*d + d^2)*psq^2) + 
      ...
      ((8 - 4*d + d^2)*psq^2 + 16*s^2 - 6*d*s^2 + d^2*s^2 + 16*s*t - 
       4*d*s*t + d^2*s*t + 2*d*t^2 + mm^2*(-((8 - 6*d + d^2)*psq) + 
    ...
    (2^(5 - 2*d)*EL^6*gAl^5*gAu*(-4*(-2 + d)*psq^2 + (-4 + d)*psq*s + 
       2*(-3 + 2*d)*mm^2*(psq - t) + 4*(-1 + d)*psq*t - 4*t^2)*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^5*gAu*(-((8 - 6*d + d^2)*psq^2) - 
       2*(8 + d)*psq*s + (8 - 6*d + d^2)*psq*t + 8*s*(s + 2*t) + 
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(2*psq^2 + 2*mm^2*s + 3*s^2 + 
       6*s*t + 2*t^2 - 4*psq*(2*s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl^5*gAu*(4*(-2 + d)*psq^2 + d^2*mm^2*s - 
       psq*((-16 + 10*d + d^2)*s + 8*(-2 + d)*t) - 8*(2*s^2 + 2*s*t + t^2) + 
    ...
    (4^(2 - d)*EL^6*gAl^5*gAu*((28 - 14*d + d^2)*psq^2 + 28*s^2 - 12*d*s^2 + 
       ...
       SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl^5*
      gAu*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAl^5*gAu*(-4*(-6 + d)*psq^2 + (-4 + d)^2*psq*s + 
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^5*gAu*(2*(16 - 7*d + d^2)*psq^2 + 
       (12 - 8*d + d^2)*mm^2*s + 2*(s + t)*(2*(-2 + d)*s + 
         ...
         4*(16 - 7*d + d^2)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (4^(2 - d)*(16 - 10*d + d^2)*EL^6*gAl^5*gAu*(psq^2 + mm^2*s + (s + t)^2 - 
       ...
       SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl^5*
      gAu*(psq^2 - mm^2*s - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAl^5*gAu*((16 - 6*d + d^2)*psq - 2*(-2 + d)*s - 
      ...
      (psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*(16 - 10*d + d^2)*EL^6*gAl^5*
      gAu*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl^5*
      gAu*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl^5*gAu*(psq - t)*(4*(-3 + d)*psq - (-4 + d)^2*s - 
       4*(-3 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
       SP[p3, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl^5*
      gAu*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     ...
     (Pi^(2*d)*s) + (4^(3 - d)*EL^6*gAl^5*gAu*(-((-2 + d)*psq^2) - 
       ...
       (-2 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
