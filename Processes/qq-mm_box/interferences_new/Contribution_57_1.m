PropList[KiraPropagator[p1 - q1, ml], KiraPropagator[-p2 - q1, ml]]*
 ((I*EL^6*gAl^3*gAu*(gZlL + gZlR)*(gZuL + gZuR)*ml^2*
  ...
  (I*EL^6*gAl^3*gAu*(gZlL*gZuL*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
  ...
  (I*2^(1 - d)*(-3 + d)*EL^6*gAl^3*gAu*(gZlL - gZlR)*(gZuL - gZuR)*(s + 2*t)*
    SPList[SP[p1, p3]])/(Pi^d*s*(-mz^2 + s)) + 
  (I*EL^6*gAl^3*gAu*((2^(1 - d)*(gZlL + gZlR)*(gZuL + gZuR)*
       (-4*s^2 + d*s^2 + 4*s*t + 4*t^2))/Pi^d - 
     (gZlL*gZuL*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       gZlR*gZuR*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       gZlR*gZuL*(-14*s^2 + 8*d*s^2 - d^2*s^2 - 2*s*t + 2*d*s*t + 4*t^2) + 
       gZlL*gZuR*(-14*s^2 + 8*d*s^2 - d^2*s^2 - 2*s*t + 2*d*s*t + 4*t^2))/
  ...
  (I*EL^6*gAl^3*gAu*(gZlL + gZlR)*(gZuL + gZuR)*(-4*s^2 + d*s^2 + 4*s*t + 
     4*t^2)*SPList[SP[q1, q1]])/((2*Pi)^d*s^2*(-mz^2 + s)) - 
