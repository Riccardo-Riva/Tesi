...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 ((I*2^(2 - d)*EL^6*gAl*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*SPList[SP[p1, q1]])/
   (Pi^d*(mz^2 - s)) - (I*2^(1 - d)*EL^6*gAl*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
    SPList[SP[q1, q1]])/(Pi^d*(mz^2 - s)) - 
  (I*2^(2 - d)*EL^6*gAl*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*t*
    SPList[SP[p1, p2], SP[p1, p2]])/(Pi^d*s^2*(-mz^2 + s)) - 
  (I*2^(2 - d)*EL^6*gAl*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*(s - 2*t)*
    SPList[SP[p1, p2], SP[p1, p3]])/(Pi^d*s^2*(-mz^2 + s)) + 
  (I*2^(2 - d)*EL^6*gAl*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^d*s*(-mz^2 + s)) + 
  (I*2^(3 - d)*EL^6*gAl*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*t*
  ...
  (I*2^(2 - d)*EL^6*gAl*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*(3*s + 2*t)*
  ...
  (I*2^(2 - d)*EL^6*gAl*gAu^2*gFFA*gFFZ*(gZlL + gZlR)*(s + t)*
