...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I/4)*EL^6*gAl*gAu*gHll^2*mm^4*
   ...
   ((I/16)*EL^6*gAl*gAu*gHll^2*mm^2*
     (gZlR*gZuL*(-16*mm^4 + (12 - 7*d + d^2)*s*(s + 2*t) + 
        2*mm^2*(8*mu^2 + (-28 + 27*d - 5*d^2)*s + 8*t)) + 
      gZlL*gZuR*(-16*mm^4 + (12 - 7*d + d^2)*s*(s + 2*t) + 
        2*mm^2*(8*mu^2 + (-28 + 27*d - 5*d^2)*s + 8*t)) + 
      gZlL*gZuL*(-16*mm^4 - (12 - 7*d + d^2)*s*(s + 2*t) + 
        2*mm^2*(8*mu^2 + (44 - 27*d + 5*d^2)*s + 8*t)) + 
      gZlR*gZuR*(-16*mm^4 - (12 - 7*d + d^2)*s*(s + 2*t) + 
        2*mm^2*(8*mu^2 + (44 - 27*d + 5*d^2)*s + 8*t)))*SPList[SP[p1, q1]])/
    (Pi^4*(mz^2 - s)*s) + ((I/16)*EL^6*gAl*gAu*gHll^2*mm^2*
     (gZlL*gZuL*(16*mm^4 + 2*mm^2*(8*mu^2 + (-12 + 13*d - 3*d^2)*s - 8*t) - 
        (12 - 7*d + d^2)*s*(s + 2*t)) + gZlR*gZuR*
       (16*mm^4 + 2*mm^2*(8*mu^2 + (-12 + 13*d - 3*d^2)*s - 8*t) - 
        (12 - 7*d + d^2)*s*(s + 2*t)) + gZlR*gZuL*
       (16*mm^4 + 2*mm^2*(8*mu^2 + (12 - 13*d + 3*d^2)*s - 8*t) + 
        (12 - 7*d + d^2)*s*(s + 2*t)) + gZlL*gZuR*
       (16*mm^4 + 2*mm^2*(8*mu^2 + (12 - 13*d + 3*d^2)*s - 8*t) + 
        (12 - 7*d + d^2)*s*(s + 2*t)))*SPList[SP[p2, q1]])/
    (Pi^4*(mz^2 - s)*s) - ((I/16)*EL^6*gAl*gAu*gHll^2*mm^2*
     (gZlR*(2*gZuL*mm^2*(16*mu^2 - (4 - 7*d + d^2)*s) + 
        2*gZuR*mm^2*(16*mu^2 + (20 - 7*d + d^2)*s) + (12 - 7*d + d^2)*gZuL*s*
         (s + 2*t) - (12 - 7*d + d^2)*gZuR*s*(s + 2*t)) + 
      gZlL*(2*gZuR*mm^2*(16*mu^2 - (4 - 7*d + d^2)*s) + 
        2*gZuL*mm^2*(16*mu^2 + (20 - 7*d + d^2)*s) - (12 - 7*d + d^2)*gZuL*s*
         (s + 2*t) + (12 - 7*d + d^2)*gZuR*s*(s + 2*t)))*SPList[SP[p3, q1]])/
    (Pi^4*(mz^2 - s)*s) - ((I/16)*(12 - 7*d + d^2)*EL^6*gAl*gAu*gHll^2*
     (gZlL - gZlR)*(gZuL - gZuR)*mm^2*(2*mm^2 - s - 2*t)*SPList[SP[p4, q1]])/
    (Pi^4*(mz^2 - s)) + ((I/16)*EL^6*gAl*gAu*gHll^2*mm^2*
   ...
   ((I/2)*EL^6*gAl*gAu*gHll^2*(gZlL + gZlR)*(gZuL + gZuR)*mm^2*(2*mu^2 + s)*
