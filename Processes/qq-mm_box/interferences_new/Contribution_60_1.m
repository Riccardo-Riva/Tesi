PropList[KiraPropagator[p1 - q1, mt], KiraPropagator[-p2 - q1, mt]]*
 (((3*I)*EL^6*gAl*gAu^3*(gZlL + gZlR)*(gZuL + gZuR)*mt^2*
  ...
  ((3*I)*EL^6*gAl*gAu^3*(gZlL*gZuL*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + gZlR*gZuR*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + gZlR*gZuL*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
       2*d*s*t + 4*t^2) + gZlL*gZuR*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
  ...
  ((3*I)*EL^6*gAl*gAu^3*((2^(1 - d)*(gZlL + gZlR)*(gZuL + gZuR)*
     ...
     (gZlR*gZuL*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       gZlL*gZuR*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       gZlL*gZuL*(-14*s^2 + 8*d*s^2 - d^2*s^2 - 2*s*t + 2*d*s*t + 4*t^2) + 
       gZlR*gZuR*(-14*s^2 + 8*d*s^2 - d^2*s^2 - 2*s*t + 2*d*s*t + 4*t^2))/
