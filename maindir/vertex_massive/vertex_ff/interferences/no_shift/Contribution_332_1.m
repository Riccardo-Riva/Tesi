...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq^2 - 2*psq*t + t*(s + t))*
     (mm^2*(-4*(-1 + d)*psq + (-4 + 3*d)*s + 4*(-1 + d)*t) + 
      s*((10 - 3*d)*psq + (-4 + d)*(s + 2*t)))*\[Mu]^(8 - 2*d))/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (-4*psq^3 + mm^2*(psq - s - t)*((-4 + 8*d)*psq - 3*d*s + 4*t - 8*d*t) + 
      2*psq^2*((-6 + d)*s + (4 + d)*t) + (s + t)*((-2 + d)*s^2 + 
        2*(-10 + 3*d)*s*t + 2*d*t^2) - 
      psq*((-2 + d)*s^2 + 2*(-16 + 5*d)*s*t + 4*(1 + d)*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(8*psq^3 - 2*psq^2*(9*s + 10*t) + 
      2*psq*(2*mm^2*s + 9*s^2 + 15*s*t + 8*t^2) - 
      4*(s + t)*(mm^2*s + (s + t)^2) + d*(-7*psq^3 + (s + t)*(s + 2*t)^2 + 
        6*psq^2*(s + 3*t) - psq*(4*s^2 + 16*s*t + 15*t^2) + 
        mm^2*(psq^2 + psq*(s - 2*t) + t*(s + t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(4*(-1 + d)*psq^3 + 
      2*psq^2*((-8 + d)*s + (4 - 5*d)*t) + mm^2*(psq - t)*
       ((-4 + 8*d)*psq - 3*d*s + 4*t - 8*d*t) + 
      t*(3*(-6 + d)*s^2 + 2*(-10 + d)*s*t - 2*d*t^2) + 
      psq*(-((-2 + d)*s^2) - 4*(-9 + d)*s*t + 4*(-1 + 2*d)*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (d*(-3*psq^3 - psq^2*(s - 10*t) + mm^2*(psq - t)^2 + t*(s + 2*t)^2 + 
        psq*(s^2 - 3*s*t - 11*t^2)) - 2*(2*mm^2*s*(psq - t) + 2*t^3 + 
        psq^2*(-5*s + 2*t) + psq*(2*s^2 + 5*s*t - 4*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (mm^2*((-4 + 8*d)*psq - 3*d*s + 4*t - 8*d*t) + 
      (-2 + d)*(2*psq^2 - 2*psq*t - s*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (-4*(-2 + d)*psq^3 + psq^2*((-8 + 3*d)*s + 12*(-2 + d)*t) - 
      mm^2*s*(4*s + d*t) + (s + 2*t)*((-4 + d)*s^2 + 2*(-2 + d)*s*t + 
        2*(-2 + d)*t^2) + psq*(d*mm^2*s + 14*s^2 + 20*s*t + 24*t^2 - 
        3*d*(s^2 + 3*s*t + 4*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*(-1 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
   ...
   (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
      t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(-psq + s + t)*
     (4*(-2 + d)*mm^2 + (8 - 5*d)*psq - 4*s + 2*d*s + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(4*(-3 + d)*psq^3 + 
      8*mm^4*(psq - s - t) - (-4 + d)*(s + t)^2*(s + 2*t) + 
      psq^2*(-5*(-4 + d)*s + 2*(16 - 5*d)*t) + 4*psq*(s + t)*
       ((-4 + d)*s + (-7 + 2*d)*t) + mm^2*(-3*(2 + d)*psq^2 + 
        psq*(8*s + 3*d*s + 4*t + 6*d*t) - (s + t)*(2*(-1 + d)*s + 
          (-2 + 3*d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (-4*(-2 + d)*psq^2 + 2*(-4 + d)*psq*s + 4*(-2 + d)*mm^2*(psq - t) + 
      4*(-2 + d)*psq*t - (-4 + d)*s*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*(-4 + d)*psq^3 + 
      (-4 + d)*mm^4*(psq - t) + 2*psq^2*((-5 + d)*s - 3*(-4 + d)*t) - 
      (-4 + d)*t*(s^2 + 3*s*t + 2*t^2) + 
      psq*(-((-6 + d)*s^2) + 2*(-3 + d)*s*t + 6*(-4 + d)*t^2) + 
      mm^2*((18 - 8*d)*psq^2 - (-2 + d)*s^2 + (8 - 6*d)*s*t - 
        7*(-2 + d)*t^2 + psq*(4*d*s - 32*t + 15*d*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*((-8 + 6*d)*psq^2 + 
      4*(-2 + d)*mm^2*s - 8*s^2 + 5*d*s^2 - 12*s*t + 10*d*s*t - 8*t^2 + 
      6*d*t^2 - 2*psq*(-10*s + 7*d*s - 8*t + 6*d*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (2*(-2*psq^3 - 2*mm^4*s + 2*s^3 + mm^2*s*(s - 3*t) + 7*s^2*t + 7*s*t^2 + 
        2*t^3 + psq^2*(5*s + 6*t) + psq*(5*mm^2*s - 6*(s + t)^2)) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-2*(-4 + d)*psq^3 + 
      2*t*(s + t)*((-6 + d)*s + (-4 + d)*t) + 
      psq^2*((-8 + d)*s + 6*(-4 + d)*t) + 
      psq*((-4 + d)*s^2 + (28 - 5*d)*s*t - 6*(-4 + d)*t^2) + 
      mm^2*(psq - s - t)*(4*(-2 + d)*psq + 8*t - d*(s + 4*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*mm^2 - 3*psq + t)*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(4*(-3 + d)*psq^3 - 
      (4 + d)*mm^4*(psq - t) + psq^2*(-((-4 + d)*s) + 2*(16 - 5*d)*t) + 
      psq*t*((-16 + 5*d)*s + 4*(-7 + 2*d)*t) - 
      (-4 + d)*t*(s^2 + 3*s*t + 2*t^2) + mm^2*(6*(-1 + d)*psq^2 + 
        (6 - 5*d)*psq*s + (-4 + d)*s^2 + (16 - 11*d)*psq*t + 5*(-2 + d)*s*t + 
        5*(-2 + d)*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((4 + d)*mm^4*s + 
      mm^2*(-((-4 + d)*psq^2) - 3*(2 + d)*psq*s + 2*(1 + d)*s^2 + 
        2*(-4 + d)*psq*t + 2*(1 + d)*s*t - (-4 + d)*t^2) + 
      s*((-6 + d)*psq^2 + psq*(-3*(-4 + d)*s - 2*(-6 + d)*t) + 
        (s + t)*((-4 + d)*s + (-6 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*psq^2 + 2*mm^2*s - 6*psq*s + 
      s^2 - 4*psq*t + 4*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (d*(-7*psq^3 + 3*psq^2*(s + 6*t) - psq*t*(11*s + 15*t) + 
        mm^2*(psq^2 - s^2 + 2*psq*(s - t) + t^2) + 
        2*t*(s^2 + 3*s*t + 2*t^2)) - 2*(-8*psq^3 + psq^2*(4*s + 22*t) + 
        (s + t)*(-(mm^2*s) + 2*t*(s + 3*t)) + 
        psq*(mm^2*s - 4*t*(3*s + 5*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq^2 - 2*psq*t + t*(s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(-4*s + d*(psq + s - t))*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)*
     (2*(-4 + d)*psq^2 + (-4 + d)*t*(s + 2*t) + 2*psq*(s - 2*(-4 + d)*t) + 
      mm^2*((2 + d)*psq - 2*s - (2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*((-8 + 6*d)*psq^2 + (-4 + d)*s^2 + 
      2*(-2 + d)*s*t + 2*(-4 + 3*d)*t^2 - 
      2*psq*((-2 + d)*s + 2*(-4 + 3*d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (-2*(2*psq^3 + psq^2*(s - 6*t) + mm^2*s*(2*s + t) - 
        psq*(mm^2*s + 2*(s - 3*t)*t) + t*(s^2 + s*t - 2*t^2)) + 
      d*(mm^2*(3*psq^2 + s^2 + 3*s*t + 3*t^2 - 3*psq*(s + 2*t)) + 
        (psq - t)*(2*psq^2 - 4*psq*t + t*(s + 2*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)*(-2*psq + s + 2*t)*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (psq^3 + mm^2*(psq - t)^2 - psq^2*(s + 4*t) + psq*t*(4*s + 5*t) - 
      ...
      SP[q1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)*(-psq + s + t)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(-2*psq^2 + s^2 + 4*psq*t - 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(8*psq^3 + 2*mm^2*psq*s - 
      4*psq^2*(2*s + 7*t) + 4*psq*t*(7*s + 8*t) - 
      2*t*(mm^2*s + 4*s^2 + 10*s*t + 6*t^2) + 
      d*(-3*psq^3 + mm^2*(psq - t)*(psq - s - t) + 2*psq^2*(s + 5*t) - 
        psq*t*(8*s + 11*t) + 2*t*(s^2 + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq^2 - 2*psq*t + t*(s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-4 + 3*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((2 + d)*mm^2 + (-4 + d)*s)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    Pi^(2*d) - (4^(1 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*psq - s - 2*t)*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-((-4 + d)*psq*s) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-4*(-2 + d)*psq^3 + 
      psq^2*((-8 + 3*d)*s + 12*(-2 + d)*t) - mm^2*s*((-2 + d)*s + d*t) + 
      2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) + 
      psq*(d*mm^2*s - 3*d*t*(3*s + 4*t) + 4*t*(5*s + 6*t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*
   ...
   (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*psq*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-10 + 3*d)*psq^2 + 
      2*(-2 + d)*mm^2*s - 8*s^2 + 2*d*s^2 - 14*s*t + 4*d*s*t - 10*t^2 + 
      3*d*t^2 + psq*((22 - 6*d)*s + 20*t - 6*d*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*psq^2 - 3*psq*s + s^2 - 
      4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (2*psq*(psq - s - t) + mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - 2*psq + s + t)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (d*(4*psq^2 - 3*psq*s + s^2 - 7*psq*t + 2*s*t + 3*t^2 + 
        mm^2*(-psq + s + t)) - 2*(5*psq^2 + 2*s^2 + 3*s*t + 5*t^2 - 
        5*psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (2*psq^2 + mm^2*s + 2*t*(s + t) - psq*(3*s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-6*psq^2 + d*mm^2*(psq - t) - 
      6*t*(s + t) + d*t*(-psq + s + t) + 2*psq*(s + 6*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-4 + d)*psq^2 + d*mm^2*s - 
      ...
      2*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)*(2*s + d*(-psq + t))*
    ...
    Pi^(2*d) - (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)^2*
