...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
   ...
   (((-I)*4^(1 - d)*(aa - bb)*(-5 + 2*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*mm^2*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-5 + 2*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*
     ...
     Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWA^2*
      (-2*bb*(-2 + d)*psq*(psq - t) + 2*aa*(-2 + d)*psq*(psq - s - t) + 
       aa*mm^2*((-6 + 4*d)*psq + s - d*s + 6*t - 4*d*t) + 
       bb*mm^2*((6 - 4*d)*psq - 5*s + 3*d*s - 6*t + 4*d*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(bb*(-6 + d)*(psq - s - t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(bb*(-10 + 3*d)*(psq - s - t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(aa*(-6 + d)*(psq - t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(-(aa*(-10 + 3*d)*(psq - t)) + 
