  ...
  ((4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*
   ...
   (4^(2 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(2*mm^2 - 3*psq + s + t)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*
     mm^2*(mm^2 - psq)*(psq - s - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
     ...
     (gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*(2*psq^2 + 3*psq*s - s^2 - 4*psq*t + 
      s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*
     ...
     (gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*(psq - t)*(psq - s - t)*
