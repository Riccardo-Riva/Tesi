...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  (((-I)*EL^5*gAl*ggmgmAA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (I*EL^5*gAl*ggmgmAA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
    ...
    (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmAA*ggmgmZ*
     (gZlL + gZlR)*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    Pi^(2*d) + (I*(aa + bb)*EL^5*gAl*ggmgmAA*ggmgmZ*(gZlL + gZlR)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmAA*ggmgmZ*(gZlL + gZlR)*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmAA*ggmgmZ*(gZlL + gZlR)*
