...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(mm^2 - psq)*
     ...
     (gZlL - gZlR)*mm^2*(mm^2 - psq)*(-2*psq^3 + 6*psq^2*t - 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*psq^3 + mm^4*s - (s + t)^2*(s + 2*t) - 2*psq^2*(2*s + 3*t) + 
      psq*(4*s^2 + 9*s*t + 6*t^2) + mm^2*(psq^2 - 2*psq*(s + t) + t*(s + t)))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (-(mm^2*(psq^2 - s^2 + 2*psq*(s - t) - 2*s*t + t^2)) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(3*psq^2 + (s + t)^2 + mm^2*(-2*psq + 3*s + 2*t) - psq*(5*s + 4*t))*
