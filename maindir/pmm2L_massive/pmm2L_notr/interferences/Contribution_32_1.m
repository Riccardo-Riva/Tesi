...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 (-((2^(1 - 2*d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*
  ...
  (2^(1 - 2*d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (mm^2 - psq)^2*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (mm^2 - psq)^2*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (-((-2 + d)*gZlL^2*(4*psq^2 - 2*mm^2*s - 4*s^2 + d*s^2 + 
        2*psq*(s - 4*t) + 4*s*t + 4*t^2)) - (-2 + d)*gZlR^2*
      (4*psq^2 - 2*mm^2*s - 4*s^2 + d*s^2 + 2*psq*(s - 4*t) + 4*s*t + 
       4*t^2) + d*gZlL*gZlR*(4*psq^2 + 2*(-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 
  ...
  (2^(1 - 2*d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
    ((-4 + d)*psq - 4*(-3 + d)*s - (-4 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  ((-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
   ...
   (4^d*Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*
    gZlR*mm^2*(mm^2 - psq)*(-2*psq + (-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
    ((-4 + d)*psq + (-8 + 3*d)*s - (-4 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*((-2 + d)*gZlL^2 - 2*d*gZlL*gZlR + 
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*
    mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (4*(-4 + d)*psq^2 + d^2*s*(2*mm^2 + s) + 
     psq*(-2*d^2*s + 4*d*(s - 2*t) + 32*t) + 16*(s^2 - s*t - t^2) + 
     4*d*(-(mm^2*s) - 2*s^2 + s*t + t^2))*\[Mu]^(8 - 2*d)*
