...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s^2*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) - 
  ((7*I)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s*
  ...
  (I*4^(-1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s^2*
    (aa*(mm^2 - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggmgmA^2*
    ggmgmZ*(gZlL + gZlR)*mm^2*s*(-3*psq + s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*
    (gZlL + gZlR)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s^2*
    (aa*(2*mm^2 - psq - t) + bb*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggmgmA^2*
    ggmgmZ*(gZlL + gZlR)*mm^2*s*(-3*psq + 2*s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    s^2*((aa + bb)*(mm^2 - psq) + (aa - bb)*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa + bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*
    (gZlL + gZlR)*(mm^2 - psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (mm^2 - psq)*s*(aa*(psq - 2*s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - ((3*I)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*
    (gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (aa*(3*mm^2 + psq - 4*(s + t)) + bb*(7*mm^2 - 11*psq + 4*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
    (4*psq - s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (aa*(7*mm^2 - 3*psq - 4*t) + bb*(3*mm^2 - 7*psq + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
    (4*psq - 3*s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
   Pi^(2*d) - ((3*I)*2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (-(bb*(6*mm^2 - 8*psq + s + 2*t)) + aa*(-6*mm^2 + 4*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (-(bb*(mm^2 - 2*psq + s + t)) + aa*(-2*mm^2 + psq + s + t))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (aa*(mm^2 - t) + bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (aa*(-psq^2 + 3*psq*s + mm^2*(psq - 4*s - t) + psq*t + s*t) - 
     bb*(-psq^2 - 2*psq*s + mm^2*(psq + s - t) + psq*t + s*t))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
  ...
  (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*(3*mm^2 - psq - 2*t) + 
     bb*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*
    (gZlL + gZlR)*(bb*(psq - t) + aa*(-mm^2 + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) + (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
  ...
  (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*
  ...
  (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
  ...
  (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*
    ggmgmZ*(gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(bb*(psq - t) + aa*(-mm^2 + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*(mm^2 - t) + bb*(-psq + t))*
  ...
  (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(bb*(psq - t) + 
    ...
    ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
