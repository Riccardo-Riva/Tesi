 ...
 (-(((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4^(1 + d)*(-3 + d)*mm^4*Pi^(2*d)*s + (2*Pi)^(2*d)*psq*
     ...
     mm^2*(2*Pi)^(2*d)*(12*psq^2 - 8*psq*((-2 + d)*s + 3*t) + 
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(psq*(2*psq - 3*s - 2*t) + 
     mm^2*(2*psq - 9*s + 2*d*s - 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2*(5*psq + 2*(-6 + d)*s - 5*t) + psq*(-psq - 2*(-3 + d)*s + t))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq*(psq + 5*s - 2*d*s - t) + mm^2*(-5*psq - 7*s + 2*d*s + 5*t))*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gHll*
