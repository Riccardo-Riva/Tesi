...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (-((4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*(2*mu^2 + s)*sw*
      SPList[SP[q1, q2]])/(Pi^(2*d)*s)) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*(s + t)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*(s + t)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*(2*mu^2 + s)*sw*
     SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*(2*mu^2 + s)*sw*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*t*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*(mu^2 + s + t)*
