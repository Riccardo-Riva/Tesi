...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(2*(-2 + d)*mm^4*s + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (-3*psq*s + 9*s^2 - 2*d*s^2 - 2*psq*t + 7*s*t + 2*t^2 + 
      mm^2*(-8*psq + (6 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (4*psq^2 + 5*psq*s + 4*s^2 - 2*d*s^2 + mm^2*(8*psq + (-2 + d)*s - 8*t) - 
      6*psq*t - 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (-2*psq^2 + (-4 + d)*psq*s + 6*psq*t - 2*t*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (8*mm^2 + 2*psq + (11 - 3*d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (2*(-2 + d)*mm^4*s - s*(4*psq^2 - 3*(-4 + d)*psq*s + (-4 + d)*s^2 - 
        8*psq*t + 4*s*t + 4*t^2) + mm^2*(4*psq^2 - 2*(-4 + d)*s^2 + 4*s*t + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (2*mm^2*(psq + 5*s - d*s - t) + s*((-4 + d)*psq + 6*s - d*s + 2*t))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     ...
     mm^6*(psq + (-2 + d)*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*
     mm^4*(psq^2 + 2*mm^2*(psq - t) + 2*t^2 - psq*((-4 + d)*s + 3*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(6*psq + s - 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (-4*psq^2 - 4*s^2 + d*s^2 - 4*t^2 + mm^2*(-6*psq - 2*(-4 + d)*s + 6*t) + 
      psq*((-4 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (2*psq^2 + (-6 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*
     gXll^2*mm^6*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (2*mm^2 - (-5 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (4*psq^2 + (-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
      psq*((-2 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
