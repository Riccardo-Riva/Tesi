...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
   ...
   ((I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*psq*s*
    ...
    (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
    ...
    (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*(aa*psq*(psq - t) + 
       aa*mm^2*(psq - s - t) + bb*mm^2*(-psq + t) + bb*psq*(-psq + s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2*Pi)^(2*d) + 
    (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*(mm^2 + psq)*s*
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
    ...
    (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*(bb*(psq - s - t) + 
      ...
      gWlN*gWNl*mm^2*s*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
      (aa*(2*(-2 + d)*psq^2 - 6*psq*s - (-2 + d)*mm^2*(3*psq - s - t) + 
         2*s*(s + t)) + bb*((-2 + d)*mm^2*(psq - s - t) - 
         2*s*(-3*psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
      (aa*(-((-2 + d)*psq^2) + s*((-2 + d)*mm^2 + 2*s) - 
    ...
    (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
    ...
    (I*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*(bb*(2*mm^2 - psq - t) + 
     ...
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
     (2*Pi)^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
      ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(-2 + d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
      (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll^2*gWlN*gWNl*mm^2*
      ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
