...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mz], 
   ...
   (((-I)*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*(s + t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-10 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*(s + t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*t*
    ...
    (I*4^(1 - d)*(aa - bb)*(-10 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*t*
