  ...
  (((-I)*4^(1 - d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*s*(s + t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
     ((-3 + d)*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWZ*
   ...
   (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(s + 2*t)*
