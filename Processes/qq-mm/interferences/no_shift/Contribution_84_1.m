...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*2^(1 - d)*EL^6*gAl*gAu^3*(gZlR*gZuL*(4*mmv^4 + 2*(-2 + d)*mm^2*s - 
     ...
     (Pi^(2*d)*(mz^2 - s)) + (I*4^(1 - d)*EL^6*gAl*gAu^3*
      (gZlR*gZuL*(2^(1 + d)*(-2 + d)*mm^2*Pi^d + 2^(1 + d)*(12 - 7*d + d^2)*
          mmv^2*Pi^d - 2^(3 + d)*Pi^d*s + 3*2^(1 + d)*d*Pi^d*s - 
         d^2*(2*Pi)^d*s - 2^(4 + d)*Pi^d*t + 3*2^(2 + d)*d*Pi^d*t - 
         2^(1 + d)*d^2*Pi^d*t) + gZlL*gZuR*(2^(1 + d)*(-2 + d)*mm^2*Pi^d + 
         ...
         3*2^(1 + d)*d*Pi^d*s - d^2*(2*Pi)^d*s - 2^(4 + d)*Pi^d*t + 
         3*2^(2 + d)*d*Pi^d*t - 2^(1 + d)*d^2*Pi^d*t) + 
       gZlL*gZuL*(2^(1 + d)*(-2 + d)*mm^2*Pi^d - 2^(1 + d)*(6 - 5*d + d^2)*
     ...
     (Pi^(2*d)*(mz^2 - s)) + (I*2^(3 - 2*d)*EL^6*gAl*gAu^3*
      (gZlL*gZuL*(2^(1 + d)*mmv^2*Pi^d - d*(2*Pi)^d*s + 
       ...
       gZlR*gZuL*(2^(1 + d)*mmv^2*Pi^d + d*(2*Pi)^d*s - 
         ...
         d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(2*s + t)))*SPList[SP[p3, q1]])/
     (Pi^(2*d)*(mz^2 - s)) + 
    (I*EL^6*gAl*gAu^3*(gZlR*gZuL*(2^(2 + d)*(-2 + d)*mmv^4*Pi^d + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[q1, 0], 
   ...
   (((-I)*2^(2 - d)*EL^6*gAl*gAu^3*(gZlR*gZuL*(4*mmv^4 + 2*(-2 + d)*mm^2*s - 
         8*s^2 + 6*d*s^2 - d^2*s^2 + 2*mmv^2*((8 - 6*d + d^2)*s - 4*t) - 
         8*s*t + 10*d*s*t - 2*d^2*s*t + 4*t^2) + 
       gZlL*gZuR*(4*mmv^4 + 2*(-2 + d)*mm^2*s - 8*s^2 + 6*d*s^2 - d^2*s^2 + 
         2*mmv^2*((8 - 6*d + d^2)*s - 4*t) - 8*s*t + 10*d*s*t - 2*d^2*s*t + 
        ...
        (4*mmv^4 + 2*(-2 + d)*mm^2*s + 4*s^2 - 4*d*s^2 + d^2*s^2 + 16*s*t - 
         10*d*s*t + 2*d^2*s*t + 4*t^2 - 2*mmv^2*((-2 + d)^2*s + 4*t)))*
      (-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^d*(mz^2 - s)*s) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu^3*(gZlR*gZuL*(2^(2 + d)*mmv^4*Pi^d + 
     ...
     (Pi^(2*d)*(mz^2 - s)*s) + (I*2^(1 - 2*d)*EL^6*gAl*gAu^3*
      (gZlR*gZuL*(2^(2 + d)*mmv^4*Pi^d + 2^(1 + d)*(-2 + d)*mm^2*Pi^d*s - 
       ...
       gZlR*gZuR*(2^(2 + d)*mmv^4*Pi^d + 2^(1 + d)*(-2 + d)*mm^2*Pi^d*s + 
         ...
         2^(4 + d)*Pi^d*s*t - 5*2^(1 + d)*d*Pi^d*s*t + 2^(1 + d)*d^2*Pi^d*s*
          t + 2^(2 + d)*Pi^d*t^2 - 2^(1 + d)*mmv^2*Pi^d*((-2 + d)^2*s + 
           4*t)))*(-1 + GaugeXi[Q])*SPList[SP[p2, q1], SP[q1, q1]])/
     (Pi^(2*d)*(mz^2 - s)*s) + 
    (I*EL^6*gAl*gAu^3*(gZlR*gZuL*(2^(2 + d)*mmv^4*Pi^d + 
         2^(1 + d)*(-2 + d)*mm^2*Pi^d*s - 2^(3 + d)*Pi^d*s^2 + 
         3*2^(1 + d)*d*Pi^d*s^2 - d^2*(2*Pi)^d*s^2 + 2^(1 + d)*mmv^2*Pi^d*
          ((8 - 6*d + d^2)*s - 4*t) - 2^(3 + d)*Pi^d*s*t + 
         5*2^(1 + d)*d*Pi^d*s*t - 2^(1 + d)*d^2*Pi^d*s*t + 
