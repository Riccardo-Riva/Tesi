...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   ((I*2^(1 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*(mw^2*s + (s + 2*t)^2 + 
       (mw^2 - s)*s*GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (-3*s^2 - 10*s*t - 8*t^2 + mw^2*(3*s + 2*t) + (mw^2 - s)*(3*s + 2*t)*
        GaugeXi[Q])*SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (2*s^2 + 3*s*t + 2*t^2)*SPList[SP[p1, q1], SP[q1, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      t*(mw^2 + s + 2*t + (mw^2 - s)*GaugeXi[Q])*SPList[SP[p2, q1], 
       SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*s^2*GaugeXi[Q]) - 
    (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*(-s^2 + mw^2*(s - 2*t) - 
       6*s*t - 8*t^2 + (mw^2 - s)*(s - 2*t)*GaugeXi[Q])*
      SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (s^2 + s*t + 2*t^2)*SPList[SP[p2, q1], SP[q1, q1], SP[q1, q1]])/
     ...
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (3*s^2 + 4*s*t + 4*t^2)*SPList[SP[p3, q1], SP[q1, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      SPList[SP[q1, q1], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*GaugeXi[Q]) + 
    (I*2^(3 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*(s + t)*
      SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(3 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      t*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(3 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (5*s + 4*t)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(3 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
   ...
   ((I*2^(1 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*(-(mw^2*t*(s + 2*t)) + 
   ...
   ((I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*((-10 + 3*d)*s^2 + 
       (-10 + 3*d)*s*t + 2*(-2 + d)*t^2)*SPList[SP[p1, q1]])/(Pi^d*s^2) + 
    (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*(2*(-2 + d)*s^2 + 
       (2 + d)*s*t + 2*(-2 + d)*t^2)*SPList[SP[p2, q1]])/(Pi^d*s^2) - 
    (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*((-14 + 5*d)*s^2 + 
       4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*SPList[SP[p3, q1]])/(Pi^d*s^2) - 
    (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
     ...
     (mw^2*Pi^d*s^2*GaugeXi[Q]) - (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu^2*gWlN*
      gWNl*gWWA*(s + t)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^d*s^2) + 
    (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
     ...
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu^2*gWlN*
      gWNl*gWWA*t*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^d*s^2) + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      ...
      SPList[SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*s^2*GaugeXi[Q]) - 
    (I*2^(4 - d)*(-2 + d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*(s + t)*
     ...
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (2*mw^2*s + (s + 2*t)^2 + (2*mw^2 - s)*s*GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (-3*s^2 - 10*s*t - 8*t^2 + mw^2*(6*s + 4*t) + (2*mw^2 - s)*(3*s + 2*t)*
        GaugeXi[Q])*SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (2*s^2 + 3*s*t + 2*t^2)*SPList[SP[p1, q1], SP[q1, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      t*(2*mw^2 + s + 2*t + (2*mw^2 - s)*GaugeXi[Q])*
      SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (-s^2 + 2*mw^2*(s - 2*t) - 6*s*t - 8*t^2 + (2*mw^2 - s)*(s - 2*t)*
    ...
    KiraPropagator[p3 + q1, mw*Sqrt[GaugeXi[Q]]], 
    KiraPropagator[-p1 - p2 + p3 + q1, mw*Sqrt[GaugeXi[Q]]]]*
   (((-I)*2^(1 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*(s^2 + 3*s*t + 2*t^2)*
      SPList[SP[p1, q1], SP[q1, q1]])/(mw^4*Pi^d*s) - 
    (I*2^(1 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*t*(s + 2*t)*
      SPList[SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*s) + 
    (I*2^(1 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*(s + 2*t)^2*
      SPList[SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*s) + 
    (I*2^(1 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*s*SPList[SP[q1, q1], 
       SP[q1, q1]])/(mw^4*Pi^d) + (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (s + t)*(s + 2*t + s*GaugeXi[Q])*SPList[SP[p1, q1], SP[p1, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*s^2*GaugeXi[Q]) - 
    (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*(-(s + 2*t)^2 + 
       s^2*GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
     ...
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (2*s^2 + 3*s*t + 2*t^2)*SPList[SP[p1, q1], SP[q1, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      t*(s + 2*t - s*GaugeXi[Q])*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (s^2 + 6*s*t + 8*t^2 + s*(s - 2*t)*GaugeXi[Q])*
      SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
      (s^2 + s*t + 2*t^2)*SPList[SP[p2, q1], SP[q1, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(3 - d)*EL^6*gAl*gAu^2*gWlN*gWNl*gWWA*
