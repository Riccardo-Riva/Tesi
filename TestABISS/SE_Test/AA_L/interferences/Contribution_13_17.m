...
-(EL^4*ggmgmA^2*gWWA^2*KiraPropagator[q1, MW]^2*KiraPropagator[-p2 + q1, MW]^
    2*PolarizationVector[V[1], p1, {Lor1}]*PolarizationVector[V[1], p1, 
   ...
   (3*SP[p1, {newLor2}]*SP[p2, {newLor1}] - 3*SP[p2, {newLor2}]*
    ...
    2*SP[q1, q1]*SP[{newLor1}, {newLor2}])*Conjugate[PolarizationVector][
