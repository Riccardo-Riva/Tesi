...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((3*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*(gZlL^2 + gZlR^2)*(s + t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*(gZlL^2 + gZlR^2)*(s + t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFZZ*(gZlL^2 + gZlR^2)*t*
