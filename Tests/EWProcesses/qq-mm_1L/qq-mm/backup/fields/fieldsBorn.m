TopologyList[Process -> {F[2, {1}], -F[2, {1}]} -> {F[2, {2}], -F[2, {2}]}, 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[2, {1}], 
     ...
     Field[5] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[2, {1}], Field[2] -> -F[2, {1}], Field[3] -> -F[2, {2}], 
      Field[4] -> F[2, {2}], Field[5] -> S[10]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> F[2, {1}], 
      Field[2] -> -F[2, {1}], Field[3] -> -F[2, {2}], Field[4] -> F[2, {2}], 
      Field[5] -> S[20]]], FeynmanGraph[1, Generic == 2][
     Field[1] -> F[2, {1}], Field[2] -> -F[2, {1}], Field[3] -> -F[2, {2}], 
     Field[4] -> F[2, {2}], Field[5] -> V] -> Insertions[Particles][
     FeynmanGraph[1, Particles == 1][Field[1] -> F[2, {1}], 
      Field[2] -> -F[2, {1}], Field[3] -> -F[2, {2}], Field[4] -> F[2, {2}], 
      Field[5] -> V[10]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[2, {1}], Field[2] -> -F[2, {1}], Field[3] -> -F[2, {2}], 
