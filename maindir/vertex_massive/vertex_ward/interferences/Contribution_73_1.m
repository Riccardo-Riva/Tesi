...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(1 - 2*d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*s*(2*aa*psq*(3*mm^2 + psq) - 
     bb*(mm^2*(6*psq - s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*
    s*(2*aa*psq*(3*mm^2 + psq) - bb*(mm^2*(6*psq - s) + psq*(2*psq + s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (EL^5*gFFA*gHFW^2*gHll^2*mm^2*s*(2*aa*psq*(3*mm^2 + psq) - 
     bb*(mm^2*(6*psq - s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(2*aa*psq*(3*mm^2 + psq) - 
     bb*(mm^2*(6*psq - s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(2*aa*psq^2 + 
     bb*mm^2*(-6*psq + s) - 2*bb*psq*(psq + s) + aa*mm^2*(6*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(2*aa*psq*(3*mm^2 + psq) - 
     bb*(mm^2*(6*psq - s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(aa - bb)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(aa*mm^2 - bb*psq)*s*
  ...
  (4^(1 - d)*(aa - bb)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(mm^2 + psq)*
  ...
  (2^(3 - 2*d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(aa*mm^2 - bb*psq)*
  ...
  (4^(1 - d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
