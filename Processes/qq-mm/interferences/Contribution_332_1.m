...
(PropList[KiraPropagator[q1, ml], KiraPropagator[-p1 - p2 + q1, ml]]*
  (((I/4)*EL^6*gAl^3*gAu*(gZuL + gZuR)*
     ((gZlL + gZlR)*ml^2*(4*mm^4 + 2*(-2 + d)*mu^2*s - 2*s^2 + d*s^2 + 
   ...
   (I*EL^6*gAl^3*gAu*(gZlL + gZlR)*(gZuL + gZuR)*(2*mm^2 + 4*mu^2 + s - 2*t)*
     SPList[SP[p2, q1], SP[p3, q1]])/(Pi^4*s^2*(-mz^2 + s)) + 
   ((2*I)*EL^6*gAl^3*gAu*(gZlL + gZlR)*(gZuL + gZuR)*(2*mu^2 + s)*
