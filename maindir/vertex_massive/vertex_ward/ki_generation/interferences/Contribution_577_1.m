 ...
 ((2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^4*s*
  ...
  (EL^5*gAl*gHll^2*mm^2*s*(aa*(-((-2 + d)*gZlL^2*mm^2*(4*psq - s)) - 
       (-2 + d)*gZlR^2*mm^2*(4*psq - s) + gZlL*gZlR*((-4 + d)*mm^4 + 
         2*(-4 + d)*psq^2 + mm^2*(-4*psq - 3*d*psq + 4*s))) + 
   ...
   (2*Pi)^(2*d) + (2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^4*
   ...
   Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
    (aa*(-((-2 + d)*gZlL^2*psq) - (-2 + d)*gZlR^2*psq + 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (-4*aa*gZlL*gZlR*psq*((-1 + d)*mm^2 + s) + 
     bb*mm^2*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
       4*gZlL*gZlR*((-1 + d)*mm^2 + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*mm^4*((-2 + d)*gZlL^2*(mm^2 + psq) + 
     (-2 + d)*gZlR^2*(mm^2 + psq) + 2*gZlL*gZlR*(-(d*psq) + s))*
  ...
  (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*(d*psq - s)*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*(bb*mm^2 - aa*psq)*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*mm^2 - aa*psq)*s*
