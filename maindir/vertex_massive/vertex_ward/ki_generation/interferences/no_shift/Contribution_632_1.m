...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*s*
   ...
   (4^(1 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     ...
     SPList[SP[p1, q2]])/Pi^(2*d) - (4^(1 - d)*(aa - bb)*d*EL^5*gAl*gHll^2*
     gZlL*gZlR*mm^4*s*(mm^2 + 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*
     (gZlL^2 + gZlR^2)*mm^4*(mm^2 - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    Pi^(2*d) - (2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
   ...
   (4^(2 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*(-2*aa*psq + bb*(mm^2 + psq))*
   ...
   (2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*psq*
