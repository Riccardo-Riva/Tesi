(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  (((-I)*2^(2 - d)*EL^6*gAl*gAu*gFFZ^2*
   ...
   (I*2^(4 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL + gZlR)*(gZuL + gZuR)*
