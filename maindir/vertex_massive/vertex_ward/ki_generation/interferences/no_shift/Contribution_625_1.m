...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*s*
   ...
   (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^4*(-2*bb*d*mm^2*(psq - s) - 3*bb*d*psq*s + 
   ...
   (2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*s*
     ...
     SPList[SP[q1, q2]])/Pi^(2*d) + (4^(2 - d)*EL^5*gAl^3*gXll^2*mm^4*
     (aa*(2*psq - s) + bb*((-2 + d)*mm^2 - d*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*(bb*(-2 + d)*mm^2 - 2*bb*d*psq + 
   ...
   (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(aa*d*mm^2*(8*psq - s) - 
