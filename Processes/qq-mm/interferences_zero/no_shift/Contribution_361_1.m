...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  (((-I/4)*EL^6*gAl*gAu*gFFZ^2*(gZlR*gZuL*(2*(-3 + d)*mm^2 + 2*mu^2 + 4*s - 
   ...
   ((I/2)*EL^6*gAl*gAu*gFFZ^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
      (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*(-mm^2 + s + t)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^4*(mz^2 - s)^2*s) + 
   ((I/2)*EL^6*gAl*gAu*gFFZ^2*(gZlR*gZuL*(2*(-3 + d)*mm^2 - (-4 + d)*s - 
    ...
    (Pi^4*(mz^2 - s)^2*s) + ((I/2)*EL^6*gAl*gAu*gFFZ^2*
   ...
   ((I/2)*EL^6*gAl*gAu*gFFZ^2*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
      (-4 + d)*gZlL*gZuR + (-2 + d)*gZlR*gZuR)*(mm^2 - t)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^4*(mz^2 - s)^2*s) + 
   ((I/2)*EL^6*gAl*gAu*gFFZ^2*(gZlR*gZuL*(2*mm^2 + 4*mu^2 + 4*s - d*s - 
   ...
   (I*EL^6*gAl*gAu*gFFZ^2*(gZlL + gZlR)*(gZuL + gZuR)*(2*mu^2 + s)*
