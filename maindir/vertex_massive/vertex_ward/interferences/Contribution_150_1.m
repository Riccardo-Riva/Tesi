...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
   ...
   ((I*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*s*(aa*mm^2*(psq - t) + 
      ...
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*ggpgpA^2*gHgpgp*
    ...
    (I*4^(1 - d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*(bb*(psq - s - t) + 
       aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
     ...
     Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
