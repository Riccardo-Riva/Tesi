...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   (((-I)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s*
    ...
    (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     ...
     (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
      s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
    ...
    (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*(bb*(psq - s - t) + 
       ...
       SP[q2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*
      ggmgmZ*(gZlL + gZlR)*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
    ...
    (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*(bb*(2*mm^2 - psq - t) + 
     ...
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*
      ...
      (gZlL + gZlR)*s*(bb*(mm^2 - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
     ...
     (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*
      (gZlL + gZlR)*(bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*
      (gZlL + gZlR)*(bb*(mm^2 - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
