...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl^2*gAu^2*t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
    ...
    (I*EL^6*gAl^2*gAu^2*t*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
       ...
       SP[q1, q1]])/(mz^2*(2*Pi)^d) - (I*2^(1 - d)*EL^6*gAl^2*gAu^2*(s + t)*
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
       (-4 + d)*gZlL*gZuR + (-2 + d)*gZlR*gZuR)*t*(s + t)*(-1 + GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/(mz^2*Pi^d*s) + 
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(gZlR*gZuL*(-((-4 + d)*s^2) + 4*s*t + 
         2*t^2) + gZlL*gZuR*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
       gZlL*gZuL*((-2 + d)*s^2 + 4*s*t + 2*t^2) + 
       gZlR*gZuR*((-2 + d)*s^2 + 4*s*t + 2*t^2))*(-1 + GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^d*s) - 
    (I*EL^6*gAl^2*gAu^2*(-(gZlR*(-(d*gZuL*(2*Pi)^d*s*(3*s + 5*t)) + 
         ...
         d*gZuR*(2*Pi)^d*s*(3*s + 5*t) + 2^(1 + d)*gZuL*Pi^d*
          (3*s^2 + 6*s*t - t^2) - 2^(1 + d)*gZuR*Pi^d*(6*s^2 + 9*s*t + t^2)))*
     ...
     (mz^2*(2*Pi)^(2*d)*s) + (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
      ((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - (-4 + d)*gZlL*gZuR + 
       (-2 + d)*gZlR*gZuR)*t^2*(-1 + GaugeXi[Q])*SPList[SP[p2, q1], 
    ...
    (I*2^(3 - d)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)*(gZuL + gZuR)*t^2*
     ...
     (mz^2*Pi^d*s) - (I*EL^6*gAl^2*gAu^2*t*
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*(gZlR*gZuL*(-((-4 + d)*s) + 4*t) + 
       ...
       gZlR*gZuR*((-2 + d)*s + 4*t))*(-1 + GaugeXi[Q])*
    ...
    (I*EL^6*gAl^2*gAu^2*(gZlL*(-3*d*gZuL*(2*Pi)^d*s + 3*d*gZuR*(2*Pi)^d*s + 
         ...
         2^(1 + d)*gZuR*Pi^d*(-3*s + (-5 + 2*d)*t)))*(-1 + GaugeXi[Q])*
   ...
   (((-I)*EL^6*gAl^2*gAu^2*t*(-(gZlR*gZuL*((8 - 6*d + d^2)*s^2 + 
    ...
    (I*EL^6*gAl^2*gAu^2*
      (-((2^(1 - 2*d)*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
       ...
       SP[q1, q1]])/s + (I*EL^6*gAl^2*gAu^2*t^2*
      (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*Pi^d*
          (-s + t) + 2^(1 + d)*gZuL*Pi^d*(2*s + t)) + 
       gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
          (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)) - 
