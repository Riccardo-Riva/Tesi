    ...
    ((2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
       (gZlL + gZlR)*mm^2*sw*(psq - t)*(2*psq^2 + 2*mm^2*s - 3*psq*s - 
        2*psq*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
       (gZlL + gZlR)*mm^2*sw*(psq - t)*(2*psq^2 + 2*t*(s + t) + 
     ...
     (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*(mm^2 - psq)*
     ...
     (3*4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*(psq - t)*
       (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
       (gZlL + gZlR)*mm^2*(mm^2 - psq)*sw*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p3, q1]])/((mh^2 - mz^2)*Pi^(2*d)) + 
     (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*(psq - t)*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
       (gZlL + gZlR)*mm^2*sw*(psq - t)*(2*mm^2 - 5*psq + 3*(s + t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
       (gZlL + gZlR)*mm^2*sw*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q2], SP[p3, q1]])/((mh^2 - mz^2)*Pi^(2*d)) - 
     (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
       (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q2], SP[q1, q1]])/((mh^2 - mz^2)*Pi^(2*d)*s) - 
     (4^(1 - d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*(psq - t)^2*
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
       (gZlL + gZlR)*mm^2*sw*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     ...
     (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
       (gZlL + gZlR)*mm^2*sw*(psq - t)*(2*psq^2 + 2*mm^2*s - 3*psq*s - 
        2*psq*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
       (gZlL + gZlR)*mm^2*sw*(psq - t)*(-2*psq^2 + 2*mm^2*(psq - s - t) - 
        2*t*(s + t) + psq*(s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gHFW*gHll*
       (gZlL + gZlR)*mm^2*sw*(2*psq^2 + 2*mm^2*s - 3*psq*s - 2*psq*t)*
