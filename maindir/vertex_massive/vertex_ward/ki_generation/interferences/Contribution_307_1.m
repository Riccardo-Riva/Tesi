...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gFFA*gFll*gFZW*gWNl*mm^2*s*
    ...
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (2^(1 - 2*d)*EL^5*gFFA*gFll*gFZW*gWNl*mm^2*
    ...
    gWNl*gZlL*mm^2*psq*s*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (2*Pi)^(2*d) + ((-aa + bb)*EL^5*gFFA*gFll*gFZW*gWNl*mm^2*
    (4*gZlL*psq - 2*d*gZlL*psq + d*gZlR*(mm^2 + psq))*s*sw*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*psq*s*sw*
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gFZW*gWNl*mm^2*
  ...
  ((-aa + bb)*(-2 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*s*sw*
