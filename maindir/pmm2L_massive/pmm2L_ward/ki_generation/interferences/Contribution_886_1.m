...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, mm]]*((I*2^(1 - 2*d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
       mm^4*s*(aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + bb*psq*(-psq + t) + 
        bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d))/((mh^2 - mz^2)*Pi^(2*d)) + 
     ...
     (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
       mm^4*(-(bb*(psq^2 - 2*mm^2*s + psq*(s - t))) + aa*psq*(psq - s - t))*
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*s*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(3 - 2*d)*aa*EL^5*gAl*gHll^2*
     ...
     (I*2^(3 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*
       (gZlL + gZlR)^2*mm^4*(bb*(2*mm^2 - psq + s - t) - aa*(psq + s - t))*
   ...
   PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, mm]]*(((-I)*2^(1 - 2*d)*EL^5*gAl*gHll^2*
       (gZlL + gZlR)^2*mm^4*s*(aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + 
        bb*psq*(-psq + t) + bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d))/
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
       mm^4*(bb*psq*(-psq + t) + aa*(psq^2 + 2*mm^2*s - psq*(2*s + t)))*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) - 
     (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*mm^4*
       (2*aa*mm^2*(psq - 2*s - t) - aa*s*(-3*psq + s + t) + 
        bb*(2*mm^2 + s)*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
