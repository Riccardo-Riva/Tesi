...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(-psq + s + t)*
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*((-2 + d)*mm^4*(psq - t) + 
      (-2 + d)*psq^2*(psq - t) - 2*mm^2*((2 + d)*psq^2 + s*(s + 2*t) - 
        psq*(4*s + (2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(-psq + s + t)*
     (2*(-2 + d)*mm^4 - (-2 + d)*psq*(3*psq - s - t) + 
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(2*(-2 + d)*mm^4 - 
      (-2 + d)*psq*(3*psq - s - t) + mm^2*((2 + d)*psq - (-2 + d)*s - 
        (2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(-psq + s + t)*
     ((-2 + d)*mm^4 + (-2 + d)*psq^2 - 3*psq*s - 2*mm^2*((-3 + d)*psq + t) + 
      s*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(-psq + s + t)*
     ((-2 + d)*psq*(psq - t) + mm^2*(-((2 + d)*psq) + 4*s + (2 + d)*t))*
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(-psq + s + t)*
     ((-2 + d)*psq*(4*psq - s - 4*t) + mm^2*(-4*(2 + d)*psq + (6 + d)*s + 
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(-psq + s + t)*
     ((-2 + d)*psq*(psq - t) + mm^2*(-((2 + 3*d)*psq) + (2 + d)*s + 
        (2 + 3*d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)*
     ((-2 + d)*psq*(psq - t) + mm^2*(-((2 + d)*psq) + 4*s + (2 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(-((-2 + d)*psq*(psq - t)) + 
      mm^2*((2 + d)*psq - 4*s - (2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)*
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)*
     ((-2 + d)*psq*(psq - t) + mm^2*(-((2 + 3*d)*psq) + (2 + d)*s + 
        (2 + 3*d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
    ...
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(2*mm^2 - s)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*((-2 + d)*mm^2 - 
   ...
   (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
      s)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*
     gFll^2*mm^2*(psq - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*
   ...
   (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
      ...
      SP[p3, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*
     gFll^2*mm^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*
     gFll^2*mm^2*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(-((-2 + d)*psq^2) + 2*psq*s + 
      (-2 + d)*mm^2*(psq - t) + (-2 + d)*psq*t - s*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(mm^2 - psq)*
   ...
   (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
    ...
    Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
     (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)^2*
    ...
    Pi^(2*d) - (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*s*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*
     gFll^2*mm^2*(psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(2*psq - s - 2*t)*
