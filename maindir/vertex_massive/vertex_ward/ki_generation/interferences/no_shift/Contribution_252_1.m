...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((EL^5*gWlN*gWNl*gWWA*gWWZ^2*s*(2*aa*psq*((-5 + 3*d)*psq + (3 - 2*d)*s) + 
   ...
   (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*s*
     ...
     gWWA*gWWZ^2*(-(bb*mm^2) + aa*psq)*s^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) - (2^(1 - 2*d)*(3 + d)*EL^5*gWlN*gWNl*gWWA*
     gWWZ^2*(bb*mm^2 - aa*psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    Pi^(2*d) + (2^(1 - 2*d)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*s*
     (2*aa*psq^2 + aa*mm^2*(2*psq - s) + bb*psq*(-2*mm^2 - 2*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
   (EL^5*gWlN*gWNl*gWWA*gWWZ^2*s*(aa*mm^2*(4*(-5 + 3*d)*psq + (13 - 8*d)*s) + 
   ...
   (2^(1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*(11 - 13*d)*mm^2 + 
      aa*(-11 + 7*d)*mm^2 + bb*(11 - 7*d)*psq + aa*(-11 + 13*d)*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
     (2*aa*psq^2 + aa*mm^2*(2*psq - s) + bb*psq*(-2*mm^2 - 2*psq + s))*
   ...
   (4^(1 - d)*(2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
     (-(bb*(3*mm^2 + psq)) + aa*(mm^2 + 3*psq))*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(8*bb*mm^2 - aa*(2 + d)*mm^2 - 
      8*aa*psq + bb*(2 + d)*psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(-1 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*s*
   ...
   (4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(mm^2 + psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(aa - bb)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(mm^2 + psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(mm^2 + psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(mm^2 + psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/Pi^(2*d) + 
   (4^(2 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(-14 + 9*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (4^(2 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
     (-(bb*(2*mm^2 + psq)) + aa*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*(17 - 11*d)*mm^2 + 
      aa*(-11 + 7*d)*mm^2 + bb*(11 - 7*d)*psq + aa*(-17 + 11*d)*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
     (-(bb*(3*mm^2 + psq)) + aa*(mm^2 + 3*psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(8*bb*mm^2 - aa*(2 + d)*mm^2 - 
      8*aa*psq + bb*(2 + d)*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
   (4^(2 - d)*(-1 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(mm^2 + psq)*
   ...
   (2^(3 - 2*d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(mm^2 + psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(mm^2 + psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(mm^2 + psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
   (4^(2 - d)*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(mm^2 + psq)*
