(PropList[KiraPropagator[q1, mc], KiraPropagator[-p1 - p2 + q1, mc]]*
  (((3*I)*2^(2 - d)*EL^6*gAl*gAu*gZuL*gZuR*mc^2*
   ...
   ((3*I)*2^(3 - d)*EL^6*gAl*gAu*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
      (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*(gZuL^2 + gZuR^2)*(s + t)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^d*(mz^2 - s)^2*s) - 
   ((3*I)*2^(3 - d)*EL^6*gAl*gAu*(gZuL^2 + gZuR^2)*
