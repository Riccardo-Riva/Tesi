...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (-2*aa*psq^2 + bb*psq*(2*psq - 3*s) + bb*mm^2*(-2*psq + s) + 
     2*aa*mm^2*(psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (-2*aa*psq^2 + bb*psq*(2*psq - 3*s) + bb*mm^2*(-2*psq + s) + 
     2*aa*mm^2*(psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(-2*bb*psq + aa*(mm^2 + psq))*s^2*
  ...
  (2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (-2*aa*psq^2 + 2*aa*mm^2*(psq - 2*s) + bb*mm^2*(-2*psq + s) + 
     bb*psq*(2*psq + 3*s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2*Pi)^(2*d) - 
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(2*aa*mm^2 - bb*(mm^2 + psq))*s*
  ...
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(-2*aa*psq^2 + 
     bb*psq*(2*psq - 5*s) + bb*mm^2*(-2*psq + s) + 2*aa*mm^2*(psq + 2*s))*
  ...
  (2^(1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (aa*(3*mm^2 + 2*psq) - bb*(mm^2 + 4*psq))*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(4*aa*(mm^2 + psq) - 
     bb*(mm^2 + 7*psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
  ...
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(-2*aa*psq^2 + 
     2*aa*mm^2*(psq - 3*s) + bb*mm^2*(-2*psq + s) + bb*psq*(2*psq + 5*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (3*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*s*
