...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s) - (3*4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    ...
    (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
     (gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
     (mm^2 + 2*psq - 4*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*
     gXFW*gXll*(gZlL - gZlR)*mm^2*(4*mm^2 - 4*psq + s)*sw*\[Mu]^(8 - 2*d)*
   ...
   (3*4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
     (gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*
