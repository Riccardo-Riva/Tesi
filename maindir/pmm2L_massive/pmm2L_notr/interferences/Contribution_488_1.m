...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
 ...
 ((2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpAA*ggpgpZ*(gZlL + gZlR)*mm^2*
    ...
    \[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*ggpgpAA*ggpgpZ*(gZlL + gZlR)*mm^2*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (4^d*Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*ggpgpAA*ggpgpZ*(gZlL + gZlR)*mm^2*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (4^d*Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*ggpgpAA*ggpgpZ*(gZlL + gZlR)*mm^2*
    (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   (4^d*Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*ggpgpAA*ggpgpZ*(gZlL + gZlR)*mm^2*
    (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (4^d*Pi^(2*d)*s^2) + (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpAA*ggpgpZ*
  ...
  (EL^8*gAl^2*gAu^2*ggpgpAA*ggpgpZ*(gZlL + gZlR)*(2*psq + (-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*ggpgpAA*ggpgpZ*(gZlL + gZlR)*(2*psq + (-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(4^d*Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*ggpgpAA*ggpgpZ*(gZlL + gZlR)*(-2*psq + (-2 + d)*s + 2*t)*
