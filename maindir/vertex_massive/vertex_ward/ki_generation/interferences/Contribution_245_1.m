...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (8*bb*mm^2 + aa*(-14 + d)*mm^2 + aa*(-6 + d)*psq - 2*bb*(-6 + d)*psq)*s^3*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (-2*aa*((-10 + d)*mm^2 + (-6 + d)*psq) + 
     bb*((-14 + d)*mm^2 + 3*(-6 + d)*psq))*s^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    ...
    SPList[SP[p1, q1]])/Pi^(2*d) + (2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*s*(aa*psq*((-22 + 6*d)*psq + 9*s) + 
     bb*mm^2*(2*(5 + 3*d)*psq - (13 + 2*d)*s) - 
     bb*psq*((-22 + 6*d)*psq + (13 + 8*d)*s) + 
     aa*mm^2*(-2*(5 + 3*d)*psq + (17 + 10*d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (-4*aa*(-1 + d)*mm^2 + bb*(-1 + 2*d)*mm^2 + 6*aa*psq - 4*aa*d*psq + 
     3*bb*(-3 + 2*d)*psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (2*Pi)^(2*d) - (EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (2*aa*((8 + d)*mm^2 + (3 + d)*psq) - bb*((13 + d)*mm^2 + 3*(3 + d)*psq))*
  ...
  (2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    ...
    (gZlL + gZlR)*s*(-(aa*mm^2*(4*(2 + 3*d)*psq + (13 - 15*d)*s)) + 
     bb*psq*(-4*(-8 + 3*d)*psq + (7 - 9*d)*s) + 
     bb*mm^2*(4*(2 + 3*d)*psq + (3 - 7*d)*s) + 
     aa*psq*(4*(-8 + 3*d)*psq + (3 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-6 + d)*EL^5*gAl*
    gWWA^2*gWWZ*(gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*(47 - 9*d)*mm^2 + 
     bb*(-29 + 3*d)*mm^2 - 5*aa*(-5 + d)*psq + bb*(-43 + 11*d)*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) - 
  (EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*((7 + 6*d)*mm^2 + psq + 4*d*psq) - 
  ...
  (4^(1 - d)*(aa - bb)*(3 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
  ...
  ((-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*(3*mm^2 + psq) - 
  ...
  (4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
  ...
  (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   Pi^(2*d) + (2^(3 - 2*d)*(aa - bb)*(3 + d)*EL^5*gAl*gWWA^2*gWWZ*
  ...
  (4^(1 - d)*(aa - bb)*(-8 + 5*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[q1, q2]])/
   Pi^(2*d) + (4^(1 - d)*(aa - bb)*(-5 + 4*d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[q2, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-14 + 9*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[p1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*(aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*(17 - 11*d)*mm^2 + 
     bb*(-11 + 7*d)*mm^2 + aa*(11 - 7*d)*psq + bb*(-17 + 11*d)*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
  ...
  (4^(1 - d)*(-5 + 3*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (2^(3 - 2*d)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
