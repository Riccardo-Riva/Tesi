...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*(3*mm^2 - 2*s)*t*
   ...
   (4^(1 - d)*d*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*t*((4 + d)*mm^2*(s + 2*t) - 
      4*(3*s^2 + 5*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*t*
     (2*mm^4*t + d*mm^4*(s + t) + 4*s*(s^2 + 3*s*t + 2*t^2) - 
      4*mm^2*(2*s^2 + 5*s*t + 3*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*d*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*(s + 2*t)*
    ...
    (Pi^(4*d)*s) + (2^(3 - 2*d)*(-1 + d)*d*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*t*
   ...
   (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*(4*(-2 + d)*mm^2 + 
      (-4 + d)*s - 4*t)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*
     (gZlL^2 + gZlR^2)*(s + t)*(2*(-2 + d)*mm^4 - 4*t^2 + 
      (-4 + d)*mm^2*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gZlL*gZlR*
     mm^2*(-8*mm^2*t + d*(s^2 + 4*mm^2*t + 2*s*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*d^2*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*(s + t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
     (4*t^2*(s + t) + mm^2*(s + 2*t)*((2 + d)*s + d*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*
     ((-4 + d)*s + (-6 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) + (4^(1 - d)*d^2*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*
