...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
   ...
   (-((4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(-psq + s + t)*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(mm^2*(psq - t) + 
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq*(3*psq - 4*s - 3*t) + 
       2*mm^2*(psq - t))*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*
      mm^2*(psq - t)*(2*psq^2 + 2*mm^2*s - 3*psq*s - 2*psq*t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(mm^2*(psq - t) + 
       ...
       SP[q2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*
      mm^2*(psq*(3*psq - 4*s - 3*t) + 2*mm^2*(psq - t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(2*psq^2 + 2*mm^2*s - 
       3*psq*s - 2*psq*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(mm^2*(psq - t) + 
     ...
     Pi^(2*d) - (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*
      (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(mm^2 - 3*psq + s + t)*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*
      mm^2*(mm^2*(psq + s - t) + 2*psq*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*
      ...
      mm^2*(mm^2 - 2*psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(mm^2 - psq)*(psq - t)*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*
      ...
      gZNL*mm^2*(3*psq^2 + 2*mm^2*s - 11*psq*s + 4*s^2 - 6*psq*t + 7*s*t + 
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)*
      ...
      gZNL*mm^2*(2*psq^2 + 2*mm^2*s - 7*psq*s + 3*s^2 - 4*psq*t + 5*s*t + 
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)*(mm^2 - psq + t)*
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)^2*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*
      gZNL*mm^2*(3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1], SP[p3, q1]])/Pi^(2*d) - 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1], SP[q1, q1]])/Pi^(2*d) - 
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZNL*mm^2*(2*psq - s - 2*t)*
