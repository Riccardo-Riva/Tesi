...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (-((4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*psq*(2*mm^2 - 3*psq + s + t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(mm^2 - psq)*psq*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*(-2*psq^3 + t*(s + t)^2 + 
   ...
   (4^(1 - d)*EL^6*gAu*gFFA^3*gFll^2*mm^2*psq*(psq - t)^2*\[Mu]^(8 - 2*d)*
