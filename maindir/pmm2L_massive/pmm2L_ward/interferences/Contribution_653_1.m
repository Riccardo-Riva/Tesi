...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (((-I)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*(s + t)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*(2*s + 3*t)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*(s + 3*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*
    (2*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
    ...
    gAl*(gZlL^4 + gZlR^4)*(2*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*
    ...
    (gZlL^4 + gZlR^4)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*
  ...
  (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*(s + 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*(12 - 8*d + d^2)*EL^5*gAl*(gZlL^4 + gZlR^4)*
    s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*((-4 + d)*s + (-2 + d)*t)*
