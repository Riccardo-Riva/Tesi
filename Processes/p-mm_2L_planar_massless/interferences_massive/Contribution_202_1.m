...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*mu^2*
     SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*mu^2*
     SPList[SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*(mu^2 - s)*
     SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*(s + t)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*(s + t)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*(mu^2 + s)*
     SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*(mu^2 + s)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*t*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (3*2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*mu^2*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (3*2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*mu^2*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*mu^2 + s)*
     SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[q1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[q1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*mm^2*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(s + t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(mm^2 + s + t)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*mm^2 + s + t)*
     SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*mu^2 + s)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(mm^2 - t)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*mm^2 - t)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*mm^2 + s)*
     SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(4*mm^2 + s)*
     SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(4*mm^2 + s)*
     SPList[SP[p1, q2], SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*mu^2 + s)*
     SPList[SP[p1, q2], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(mu^2 + s + t)*
     SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(4*mu^2 + 3*s + 2*t)*
     SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(4*mu^2 + 3*s + 2*t)*
     SPList[SP[p1, q2], SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*t*
     SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*t*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(mu^2 - t)*
     SPList[SP[p2, q2], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(4*mu^2 + s - 2*t)*
     SPList[SP[p2, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(4*mu^2 + s - 2*t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggzgmW^2*gWlN*gWNl*(2*mu^2 + s)*
