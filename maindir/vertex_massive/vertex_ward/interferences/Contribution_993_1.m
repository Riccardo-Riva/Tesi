...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (((-I)*2^(1 - 2*d)*EL^5*gAl^2*gFAW*gHFW*gHll*mm^2*s*
     ...
     (I*4^(1 - d)*EL^5*gAl^2*gFAW*gHFW*gHll*mm^2*(bb*psq*(-psq + t) + 
     ...
     (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFAW*gHFW*gHll*mm^2*s*
      ...
      (mh^2*Pi^(2*d)) - (I*2^(3 - 2*d)*aa*EL^5*gAl^2*gFAW*gHFW*gHll*mm^2*
       (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
      (mh^2*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl^2*gFAW*gHFW*gHll*mm^2*
       (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)) - 
     (I*2^(3 - 2*d)*(aa + bb)*EL^5*gAl^2*gFAW*gHFW*gHll*mm^2*(mm^2 - psq)*
     ...
     (I*2^(3 - 2*d)*bb*EL^5*gAl^2*gFAW*gHFW*gHll*mm^2*(mm^2 - psq)*
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)) - 
     (I*4^(1 - d)*EL^5*gAl^2*gFAW*gHFW*gHll*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      (mh^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFAW*gHFW*gHll*
    ...
    ((I*2^(1 - 2*d)*EL^5*gAl^2*gFAW*gHFW*gHll*mm^2*s*(aa*mm^2*(psq - t) + 
