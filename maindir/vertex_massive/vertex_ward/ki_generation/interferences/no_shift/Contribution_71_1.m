...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  (-((2^(1 - 2*d)*EL^5*gFFA^3*gFll^2*mm^2*s*(-2*aa*psq^2 + 
   ...
   (4^(1 - d)*EL^5*gFFA^3*gFll^2*mm^2*(2*aa*psq^2 + aa*mm^2*(2*psq - s) + 
      bb*psq*(-2*mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gFFA^3*gFll^2*mm^2*(2*aa*psq^2 + aa*mm^2*(2*psq - s) + 
      bb*psq*(-2*mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gFFA^3*gFll^2*mm^2*(bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*EL^5*gFFA^3*gFll^2*mm^2*(mm^2 + psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gFFA^3*gFll^2*mm^2*(bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*
