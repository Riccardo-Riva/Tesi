...
PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
 ...
 ((2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*((-6 + d)*s - 2*t)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN^2*
    gWNl^2*((-10 + 3*d)*s^2 + (-10 + 3*d)*s*t + 2*(-2 + d)*t^2)*
    SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*((-4 + d)*s + 2*t)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN^2*
    gWNl^2*(2*(-2 + d)*s^2 + (2 + d)*s*t + 2*(-2 + d)*t^2)*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*(3*s + 2*t)*
    SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*(s + t)*
  ...
  (4^(1 - d)*(12 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*(s - 2*t)*
  ...
  (EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*(4*(-4 + d)^2*s^2 + (-28 + 4*d + d^2)*s*t + 
     2*(-2 + d)^2*t^2)*SPList[SP[p2, q2], SP[q1, q1]])/((2*Pi)^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*
