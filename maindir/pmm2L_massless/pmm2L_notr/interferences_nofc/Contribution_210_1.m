...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (-((2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gWlN*gWNl*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gWlN*gWNl*(3*s + 2*t)*
    ...
    (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gWlN*gWNl*t*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gWlN*gWNl*t*
    ...
    (Pi^(2*d)*s) + (4^(3 - d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gWlN*gWNl*t*
    ...
    (Pi^(2*d)*s) - (2^(7 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gWlN*gWNl*
