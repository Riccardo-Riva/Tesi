...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p2 + q1, mz], 
  ...
  ((2^(1 - 2*d)*EL^5*ggmgmAZ*ggmgmZ*
     (-(aa*(gZlL^2*(psq^2 + mm^2*(psq - s)) + 
    ...
    Pi^(2*d) - (4^(1 - d)*(aa - bb)*EL^5*ggmgmAZ*ggmgmZ*gZlL*gZlR*mm^2*
     (2*psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*ggmgmAZ*ggmgmZ*(-(aa*(gZlL - gZlR)^2*mm^2) + 
