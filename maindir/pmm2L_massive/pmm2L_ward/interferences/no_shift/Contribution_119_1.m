...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)^2*s*
     ...
     (mm^2 - psq)*(bb*(-2 + d)*(psq - t) + 
      aa*(-((-2 + d)*psq) + (-2 + 3*d)*s + (-2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (I*4^(1 - d)*aa*(-2 + d)*EL^5*gAl^3*
     gXll^2*mm^2*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*
     (aa*(-2 + d)*(psq - s - t) + bb*(-((-2 + d)*psq) - 2*d*s - 2*t + d*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*bb*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)^2*s*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*s*
    ...
    Pi^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (I*4^(2 - d)*aa*d*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(bb*(2*mm^2 - s - 2*t) + 
      aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
     (bb*(-2 + d)*s + aa*(4*d*mm^2 + 2*s - d*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*s*
   ...
   (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
     (aa*(-2 + d)*s + bb*(4*d*mm^2 + 2*s - d*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(4*aa*d*mm^2*(psq - t) + 
   ...
   (I*4^(2 - d)*bb*d*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*bb*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*s*
   ...
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*s*(bb*(2*mm^2 - psq - t) + 
    ...
    Pi^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
     (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*bb*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)^2*
   ...
   (I*4^(2 - d)*aa*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (I*4^(2 - d)*bb*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q2, q2]])/Pi^(2*d) + (I*4^(2 - d)*bb*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/
    Pi^(2*d) + (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*
     (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
