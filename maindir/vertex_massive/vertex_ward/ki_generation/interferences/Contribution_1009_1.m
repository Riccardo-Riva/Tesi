...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*EL^5*gAl*ggpgpZ^2*mm^2*
    ...
    (I*EL^5*gAl*ggpgpZ^2*mm^2*(aa*(gZlL^2*(mm^2 + psq - s) + 
    ...
    (I*EL^5*gAl*ggpgpZ^2*mm^2*s*(aa*(2*gZlL*gZlR*(2*psq - s - 2*t) + 
     ...
     (2*Pi)^(2*d) - (I*EL^5*gAl*ggpgpZ^2*s*
    ...
    (I*EL^5*gAl*ggpgpZ^2*mm^2*s*(aa*(gZlL^2*(mm^2 - psq) + 
         gZlR^2*(mm^2 - psq) + 2*gZlL*gZlR*(2*psq - s - 2*t)) + 
       bb*(gZlL^2*(mm^2 - psq) + gZlR^2*(mm^2 - psq) + 
         2*gZlL*gZlR*(-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*mm^2*
      (bb*(gZlL + gZlR)^2*(psq - s - t) + 
       aa*(gZlL^2*(2*mm^2 - 3*psq + s + t) + gZlR^2*(2*mm^2 - 3*psq + s + 
           t) + 2*gZlL*gZlR*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
    ...
    (I*EL^5*gAl*ggpgpZ^2*(aa*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*mm^2*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*
      (bb*(2*gZlL*gZlR*mm^2*(psq - 2*s - t) + gZlL^2*(mm^4 + psq*s - 
           mm^2*(s + t)) + gZlR^2*(mm^4 + psq*s - mm^2*(s + t))) + 
       aa*(2*gZlL*gZlR*mm^2*(-psq + 2*s + t) + gZlL^2*(mm^4 - psq*s + 
           mm^2*(-2*psq + s + t)) + gZlR^2*(mm^4 - psq*s + 
           mm^2*(-2*psq + s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
     Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
     (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*mm^2*
    ...
    (I*EL^5*gAl*ggpgpZ^2*(bb*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       ...
       SP[q2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(-2*gZlL*gZlR*mm^2 + 
    ...
    (I*4^(1 - d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(2*mm^2 - psq - t) + 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
      (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
      (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*
