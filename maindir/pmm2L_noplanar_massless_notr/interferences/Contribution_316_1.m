...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(3*(-2 + d)*s^2 + 
     (-19 + 3*d)*s*t + 2*(-6 + d)*t^2)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((1 + 2*d)*s^2 + 
     (-5 + d)*s*t + 2*(-6 + d)*t^2)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-23 + 10*d)*s^2 + 
     4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-9 + 5*d)*s^2 + 8*s*t + 
     8*t^2)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-13 + 5*d)*s^2 + 10*s*t + 
     10*t^2)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-20 + 9*d)*s^2 - 22*s*t - 
     12*t^2)*SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-10 + 9*d)*s^2 - 2*s*t - 
     12*t^2)*SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(10 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (2^(5 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*SPList[SP[p1, p2], 
     SP[q1, q1]])/Pi^(2*d) - (2^(1 - 2*d)*(-18 + 11*d)*EL^8*gAl*gAu^2*gWlN*
    gWNl*gWWA^3*SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) - 
  ...
  (4^(1 - d)*(-2 + 5*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p1, p3], SP[p3, q1]])/Pi^(2*d) + 
  (2^(5 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*SPList[SP[p1, p3], 
     SP[q1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*(-8 + 5*d)*EL^8*gAl*gAu^2*gWlN*gWNl*
    gWWA^3*SPList[SP[p1, p3], SP[q1, q2]])/Pi^(2*d) - 
  ...
  (7*4^(1 - d)*(-4 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-82 + 25*d)*s + 
     4*(-3 + d)*t)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((4 + d)*s + 2*t)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(3*(-2 + d)*s - 2*t)*
    SPList[SP[p1, q1], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(3*(-6 + d)*s - 4*t)*
    SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-9 + 4*d)*s - 2*t)*
    SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-22 + 7*d)*s^2 + 2*(5 + 3*d)*s*t + 
     12*t^2)*SPList[SP[p1, q2], SP[p2, q1]])/((2*Pi)^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(-13*s + 16*d*s + 2*t + 6*d*t)*
    SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(1 + 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  ((-22 + 15*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*SPList[SP[p1, q2], 
     SP[q1, q2]])/(2*Pi)^(2*d) - (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    ((2 + d)*s - 2*t)*SPList[SP[p2, p3], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + 5*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p2, p3], SP[p3, q1]])/Pi^(2*d) + 
  (2^(5 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*SPList[SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*(-8 + 5*d)*EL^8*gAl*gAu^2*gWlN*gWNl*
    gWWA^3*SPList[SP[p2, p3], SP[q1, q2]])/Pi^(2*d) - 
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(7*(-10 + 3*d)*s - 
     4*(-3 + d)*t)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((2 + d)*s - 2*t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(5*(-3 + 2*d)*s - 
     2*(t + 3*d*t))*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(1 + 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
  ((-22 + 15*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*SPList[SP[p2, q2], 
     SP[q1, q2]])/(2*Pi)^(2*d) - (2^(3 - 2*d)*(-5 + 2*d)*EL^8*gAl*gAu^2*gWlN*
    gWNl*gWWA^3*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
  (4^(1 - d)*(-2 + 5*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(-3 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p3, q1], SP[q1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-38 + 9*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
  (3*4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p3, q1], SP[q2, q2]])/Pi^(2*d) + 
  (2^(5 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*SPList[SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*(-8 + 5*d)*EL^8*gAl*gAu^2*gWlN*gWNl*
    gWWA^3*SPList[SP[p3, q2], SP[q1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-1 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-16 + 13*d)*s + 
     2*(-12 + 7*d)*t)*SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-3 + 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    (s + 2*t)*SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  ...
  (5*2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p1, p2], SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(2 - d)*(-7 + 4*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (4^(2 - d)*(-1 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
  ...
  (2^(3 - 2*d)*(-5 + 3*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
  ...
  (4^(1 - d)*(-8 + 5*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
  ...
  (4^(1 - d)*(-3 + 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(3*s + 2*t)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-3 + 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(3*s + 2*t)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-8 + 5*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    SPList[SP[p1, p3], SP[p2, p3], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
  ...
  (9*4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
  ...
  (2^(3 - 2*d)*(-10 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(s + t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-20 + 11*d)*s + 
     2*(-8 + 5*d)*t)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((6 + d)*s + 9*(-2 + d)*t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(s + t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(3*(-4 + 3*d)*s + 
     2*(-8 + 5*d)*t)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (9*4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(2*t + d*(s + t))*
    SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-50 + 13*d)*s + 9*(-2 + d)*t)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(3*(-4 + 3*d)*s + 
     2*(-8 + 5*d)*t)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*
    (s + t)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(s + t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(2*s + (2 + d)*t)*
    SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-11 + 6*d)*s + (-8 + 5*d)*t)*
  ...
  (2^(3 - 2*d)*(-10 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*t*
    SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(s + 2*t)*
    SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(4*(-8 + d)*s - 9*(-2 + d)*t)*
    SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-4 + d)*s + 2*(-8 + 5*d)*t)*
    SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-1 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*t*
  ...
  (4^(1 - d)*(-5 + 3*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*t*
  ...
  (5*2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(s + t)*
    SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-4 + 3*d)*s - 2*(-2 + d)*t)*
    SPList[SP[p1, q2], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*(-1 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(s + t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*t*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*(8*(-3 + d)*s + 9*(-2 + d)*t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA^3*((-3 + d)*s + (8 - 5*d)*t)*
