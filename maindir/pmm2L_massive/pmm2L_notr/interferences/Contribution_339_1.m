...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 ((EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^4*(-4*psq^2 + (2 + d)*s^2 + 8*psq*t - 4*s*t - 4*t^2) + 
     s*(-4*psq^3 + 2*psq^2*(s - 4*t) + psq*((10 - 3*d)*s^2 - 4*s*t + 4*t^2) + 
       s*((-4 + d)*s^2 + 4*s*t + 4*t^2)) + 
     mm^2*(-4*psq^3 + 8*psq^2*(s + t) + 2*s*((-3 + d)*s^2 + 4*s*t + 4*t^2) - 
       psq*((-4 + 3*d)*s^2 + 20*s*t + 4*t^2)))*\[Mu]^(8 - 2*d))/
   ((2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(4*psq^3 + 4*(-2 + d)*mm^4*s + 
     2*psq^2*((4 + d)*s - 4*t) + psq*((15 - 4*d)*s^2 - 4*s*t + 4*t^2) + 
     s*((-5 + 2*d)*s^2 + 4*s*t + 4*t^2) + 
     mm^2*(12*psq^2 - 2*psq*((-8 + d)*s + 12*t) - 3*(s^2 - 4*s*t - 4*t^2)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-6*psq^3 + (-10 + 3*d)*mm^4*s + psq^2*((7 + d)*s + 8*t) + 
     s*(2*s^2 - 7*s*t - 6*t^2) + psq*((1 + 2*d)*s^2 + 13*s*t - 2*t^2) + 
     mm^2*(6*psq^2 + (17 - 2*d)*psq*s - (-2 + d)*s^2 - 12*psq*t + 3*s*t + 
       6*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4^(1 + d)*mm^4*Pi^(2*d)*(psq + (-4 + d)*s - t) + 
     mm^2*(2*Pi)^(2*d)*(4*psq^2 + 2*(-6 + d)*psq*s + (32 - 9*d)*s^2 - 
       4*psq*t + 8*s*t) - (2*Pi)^(2*d)*s*(2*(8 + d)*psq^2 - 
       psq*(3*d*s + 44*t) + 4*((-4 + d)*s^2 + 4*s*t + 4*t^2)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(4*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-6*psq^3 + 2*(-4 + d)*mm^4*s + psq^2*((-5 + d)*s + 8*t) + 
     s*(s^2 - 3*s*t - 2*t^2) + psq*(-((-6 + d)*s^2) + 5*s*t - 2*t^2) + 
     mm^2*(2*psq^2 + (5 - 3*d)*s^2 - s*t + 2*t^2 - psq*((-11 + d)*s + 4*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq^3 + (-10 + 3*d)*mm^4*s + (9 + d)*psq^2*s + 
     s*(3*s^2 - 5*s*t - 6*t^2) + psq*(2*(-2 + d)*s^2 + 7*s*t - 2*t^2) + 
     mm^2*(6*psq^2 + (11 - 2*d)*psq*s - (-5 + d)*s^2 - 12*psq*t + 9*s*t + 
       6*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4^(1 + d)*mm^4*Pi^(2*d)*(psq - (-3 + d)*s - t) + 
     (2*Pi)^(2*d)*s*(2*(-4 + d)*psq^2 - 3*(-4 + d)*psq*s + 4*(-4 + d)*s^2 - 
       20*psq*t + 16*s*t + 16*t^2) + mm^2*(2*Pi)^(2*d)*
      (4*psq^2 - 2*psq*((4 + d)*s + 2*t) + s*(3*(-8 + 3*d)*s + 8*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(4*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq^3 + 2*(-4 + d)*mm^4*s + (-3 + d)*psq^2*s + 
     s*(2*s^2 - s*t - 2*t^2) - psq*((-1 + d)*s^2 + s*t + 2*t^2) + 
     mm^2*(2*psq^2 + (8 - 3*d)*s^2 + 5*s*t + 2*t^2 - psq*((-5 + d)*s + 4*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*psq^3 + 4*mm^4*s + 8*psq^2*(s - t) + 
     psq*(-((-4 + d)*s^2) - 4*s*t + 4*t^2) + 
     s*((-4 + d)*s^2 + 4*s*t + 4*t^2) + mm^2*(4*psq^2 + (-8 + 3*d)*s^2 - 
       8*psq*t + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/
   ((2*Pi)^(2*d)*s^2) - (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(2*(-6 + d)*mm^4 - 16*psq^2 + 12*psq*s + 3*d*psq*s + 
     8*s^2 - 2*d*s^2 + mm^2*(-2*(-2 + d)*psq + (20 - 3*d)*s) + 16*psq*t - 
     8*s*t - 8*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*psq^3 - 4*psq^2*(s + 2*t) + psq*((-6 + d)*mm^2*s + (9 - 4*d)*s^2 - 
       12*s*t + 4*t^2) + s*(-((-6 + d)*mm^4) + (-5 + d)*mm^2*s + 
       (-5 + d)*s^2 + 8*s*t + 8*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(2*(-2 + d)*mm^4*s + 
   ...
   (Pi^(2*d)*s^2) + (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(4*(-1 + d)*mm^4*s + psq*s*(24*psq + (-20 + 7*d)*s) + 
     mm^2*(8*psq^2 + (-8 + 7*d)*s^2 + 8*s*t + 8*t^2 - 
       4*psq*((-7 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*psq^3 + 4*mm^4*s + 8*psq^2*(s - t) + 
     psq*(-((-4 + d)*s^2) - 4*s*t + 4*t^2) + 
     s*((-4 + d)*s^2 + 4*s*t + 4*t^2) + mm^2*(4*psq^2 + (-8 + 3*d)*s^2 - 
       8*psq*t + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   ((2*Pi)^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^4 + psq*(psq + (-1 + d)*s) - 
     mm^2*(2*psq + s - d*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(4*mm^4 + 6*psq^2 + 2*d*s^2 + psq*(11*s + 2*d*s - 6*t) + 6*s*t + 
     4*t^2 + mm^2*(-14*psq + 7*s + 2*d*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^4 + 6*psq^2 - 4*s^2 + d*s^2 + mm^2*(3*psq + (-14 + 3*d)*s - 3*t) + 
     4*s*t + 4*t^2 - psq*((-5 + d)*s + 11*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4 + 2*psq^2 - mm^2*(14*psq + s - 2*d*s - 6*t) + s*(s + 2*t) + 
     psq*(-s + 2*d*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(4*mm^4 + 10*psq^2 + 13*psq*s + 2*d*psq*s - 2*s^2 + 2*d*s^2 + 
     mm^2*(-2*psq + s + 2*d*s - 6*t) - 10*psq*t + 2*s*t + 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^4 - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 + 
     mm^2*(-3*psq + (-11 + 3*d)*s + 3*t) - psq*((-8 + d)*s + 5*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4 + 6*psq^2 + psq*(s + 2*d*s - 2*t) - s*(s + 2*t) - 
     mm^2*(2*psq + 7*s - 2*d*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq + d*(mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/
   (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(4*psq^2 + (-13 + d)*mm^2*s - 7*s^2 + 4*d*s^2 + 4*s*t + 4*t^2 - 
     psq*((5 + 3*d)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(-4*psq^2 + 2*(-4 + d)*mm^2*s + 2*(-8 + d)*psq*s + s^2 - 2*d*s^2 + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (11*mm^2 + 5*psq + 2*(-1 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq + d*(mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/
   (Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(9*psq^2 - 4*s^2 - d*s^2 + mm^2*(psq + (-8 + d)*s - t) + 2*t^2 - 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (10*psq^2 + (-5 + d)*mm^2*s - 6*s^2 - s*t + 2*t^2 - 
     psq*((2 + d)*s + 12*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(4*mm^4 + 4*s^2 + 2*d*s^2 + mm^2*(-8*psq + (13 - 2*d)*s) - 4*s*t - 
     4*t^2 + psq*(23*s + 2*d*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4 - 8*psq^2 - 4*(-4 + d)*s^2 + psq*(24*s - d*s + 4*t) + 
     mm^2*(-8*psq - 16*s + 3*d*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/((2*Pi)^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4 + 8*psq^2 + 2*s^2 + psq*(s + d*s - 2*t) - 3*s*t - 2*t^2 - 
     mm^2*(6*psq + (-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-12*psq^2 + 6*s^2 + d*s^2 + mm^2*(2*psq + (11 - 3*d)*s - 2*t) - 5*s*t - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (11*psq^2 - 2*(7 + d)*psq*s + 4*s^2 - 2*d*s^2 + 
     mm^2*(5*psq + 2*(-11 + d)*s - 5*t) - 15*psq*t + 6*s*t + 4*t^2)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 + 5*psq - 4*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2]])/(Pi^(2*d)*s) - (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(4*mm^4 - 4*(-4 + d)*s^2 + 
     mm^2*(8*psq + 3*(-8 + d)*s - 8*t) - psq*((-20 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/((2*Pi)^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^4 + mm^2*(2*psq - 7*s - 2*t) + psq*(11*s - 2*t) - 4*s*(s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (6*psq^2 - 4*s^2 + d*s^2 + mm^2*(2*psq + (-10 + 3*d)*s - 2*t) + 4*s*t + 
     4*t^2 - psq*((-2 + d)*s + 10*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/((2*Pi)^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (12*psq^2 + (-10 + 3*d)*mm^2*s - 32*s^2 + 6*d*s^2 + 8*t^2 - 
     psq*((-6 + d)*s + 20*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4 - 4*psq^2 + 3*s^2 - s*t - 2*t^2 + 
     mm^2*(-10*psq - (-4 + d)*s + 2*t) + psq*((5 + d)*s + 10*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^4 - 4*psq^2 + 5*psq*s + 2*psq*t + 4*s*t + 
     mm^2*(-2*psq - 5*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(4*mm^4 + 4*psq^2 + 3*psq*s - s^2 - 
     mm^2*(8*psq + 3*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*((-2 + d)*psq*s + mm^2*(-4*psq + (2 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-10*psq^2 + (14 + d)*psq*s + 2*(1 - 2*d)*s^2 + 
     mm^2*(2*psq + d*s - 2*t) + 14*psq*t - 14*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/((2*Pi)^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-8*psq^2 + 4*psq*s + 4*s^2 + mm^2*(2*psq + 5*s - 2*d*s - 2*t) + 
     10*psq*t - s*t - 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (6*psq^2 - s^2 + mm^2*(4*psq + (-10 + d)*s - 4*t) + 3*s*t + 2*t^2 - 
     psq*(s + d*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   ((2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(11*psq^2 - 2*d*psq*s - 2*s^2 + 
     mm^2*(5*psq + 2*(-8 + d)*s - 5*t) - 15*psq*t + 6*s*t + 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ((-2 + d)*psq*s + mm^2*(-4*psq + (2 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (5*psq^2 + 2*s^2 + d*s^2 + psq*((9 + d)*s - 3*t) + 
     mm^2*(psq - (-7 + d)*s - t) - 4*s*t - 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2*(4*psq + 8*s - 3*d*s - 4*t) + s*((-20 + d)*psq + 4*(-4 + d)*s + 
       16*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/
   ((2*Pi)^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(-6*psq^2 + (-5 + d)*mm^2*s - 3*s^2 + 5*s*t + 2*t^2 + 
     psq*(-(d*s) + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(4*psq^2 - 4*s^2 + d*s^2 + 4*psq*(s - 2*t) + 
     2*mm^2*(2*psq + (-2 + d)*s - 2*t) + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq^2 + d*psq*s - 10*s^2 - 2*d*s^2 + 2*psq*t + 6*s*t - 4*t^2 + 
     mm^2*(-2*psq + (6 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q1]])/((2*Pi)^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-5*s^2 - d*s^2 + mm^2*(2*psq - 13*s + 3*d*s - 2*t) + 7*s*t + 6*t^2 - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (3*psq^2 - 2*s^2 + 2*d*s^2 + mm^2*(5*psq + 17*s - 2*d*s - 5*t) - 2*s*t - 
     4*t^2 + psq*(3*s + 2*d*s + t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - 3*psq + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
   (Pi^(2*d)*s) + (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq^2 + 4*s^2 - d*s^2 + mm^2*(2*psq + (8 - 3*d)*s - 2*t) - 4*s*t - 
     4*t^2 + psq*((-4 + d)*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, p3]])/((2*Pi)^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*psq^2 + (-10 + 3*d)*mm^2*s - 24*s^2 + 6*d*s^2 + 16*s*t + 8*t^2 - 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq - s)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*((-2 + d)*psq*s + 
     mm^2*(4*psq + (-2 + d)*s - 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq^2 + 12*s^2 - 4*d*s^2 + 6*s*t - 4*t^2 + psq*((-12 + d)*s + 2*t) + 
     mm^2*(-2*psq + (2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/((2*Pi)^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-4*psq^2 - 3*s^2 + mm^2*(2*psq - 7*s + 2*d*s - 2*t) + 2*psq*t + 3*s*t + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (3*psq^2 + 4*s^2 + mm^2*(5*psq + 11*s - 2*d*s - 5*t) - 2*s*t - 4*t^2 + 
     psq*(-11*s + 2*d*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*((-2 + d)*psq*s + mm^2*(4*psq + (-2 + d)*s - 4*t))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*psq^2 + (-2 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ((-4 + d)*mm^2 - (-4 + d)*psq + (-11 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ((-6 + d)*mm^2 - (2 + d)*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/((2*Pi)^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*psq^2 + (-4 + d)*mm^2*s - 3*s^2 + 4*s*t + 4*t^2 - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*psq^2 + 2*(-7 + d)*mm^2*s + 2*s^2 - d*s^2 + 4*s*t + 4*t^2 - 
  ...
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q2]])/
  ...
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(4*mm^2 - 2*psq - 5*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-mm^2 + psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(4*mm^2 - 5*psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(2*mm^2 + 4*psq - 13*s - 2*d*s - 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (7*mm^2 - 5*psq - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(2*mm^2 + 4*psq - s - 2*d*s - 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(2*mm^2 - 8*psq - 7*s - 2*d*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - 3*psq + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(2*mm^2 - 8*psq + 5*s - 2*d*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    gXll*(gZlL - gZlR)*mm^2*(4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-1 + d)*EL^8*gAl^2*gAu^2*gHll*
    gHXZ*gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, p3], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*(-7 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) - (4^(1 - d)*(-1 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s) + (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-4*psq + 5*s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(-4*mm^2 + psq + 13*s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*psq*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (3*4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (5*psq - 13*s - 5*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (3*2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(4*psq + (-8 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(-4*mm^2 - 2*psq + 7*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 + 3*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 + psq)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(4*mm^2 - 4*psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(psq - t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^2 - 8*psq - s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq + 9*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(2*psq - 7*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - 7*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 + psq)*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p3, p3]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    gXll*(gZlL - gZlR)*mm^2*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 + 3*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(4*mm^2 - 4*psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(4*mm^2 - 5*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 + psq)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p3, p3]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(3*mm^2 - psq - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(5*psq + 8*s - 5*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(psq - t)*
