...
((I*EL^6*gAl*gAu*gHWW*gHZZ*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - 
    ...
    PropagatorDenominator[0, mh]*PropList[KiraPropagator[q1, 
      mw*Sqrt[GaugeXi[Q]]]]*SPList[SP[q1, q1]])/
   (mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s) + PropList[KiraPropagator[q1, mw]]*
   ((I*d*EL^6*gAl*gAu*gHWW*gHZZ*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - 
         d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - 
           (4 - 5*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZuL*Pi^d*
          (-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2)) + 
       gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
         ...
         2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
           2*t^2)))*PropagatorDenominator[0, mh])/((2*Pi)^(2*d)*(mz^2 - s)^2*
      s) - (I*EL^6*gAl*gAu*gHWW*gHZZ*
      (gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
         ...
         2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2) + 
         2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
           2*t^2)))*PropagatorDenominator[0, mh]*SPList[SP[q1, q1]])/
     (mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s)))/4
