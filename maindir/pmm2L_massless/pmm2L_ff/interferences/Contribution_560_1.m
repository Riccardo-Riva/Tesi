...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((-3*2^(1 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*mm^2*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*(s + t)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*t*
     (2*s^2 + 6*s*t - d*t*(s + t) + t*(-3*mm^2 + 4*t) + d*mm^2*(s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
   (3*4^(1 - d)*(-1 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*mm^2*t*
   ...
   (3*4^(1 - d)*(-1 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*mm^2*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(-3 + 2*d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*(-3 + 2*d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*(s + t)*
     (2*mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*
     (s + t)*(2*mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*
     mm^2*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*t*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*t^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*t^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*t*
     (-8*s + 5*d*s - 6*t + 4*d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gWWAA*gWWZ*
     (gZlL + gZlR)*t*((-8 + 5*d)*s + 2*(-5 + 3*d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*(s + 2*t)*
