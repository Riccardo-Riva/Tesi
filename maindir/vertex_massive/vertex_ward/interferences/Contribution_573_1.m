...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   ((I*EL^5*gAl*gHll^2*mm^4*s*(aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
     ...
     Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^4*
      (bb*(-(4^(1 + d)*Pi^(2*d)*s*(-(gZlL*gZlR*(mm^2 + psq)) + 
          ...
          (2*gZlL^2*s*(mm^2 - t) + 2*gZlR^2*s*(mm^2 - t) + 
           gZlL*gZlR*(psq*(-3*psq + 2*s + 3*t) + mm^2*(-9*psq + 2*s + 9*
                t)))) - aa*(2*Pi)^(2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*((-2 + d)*gZlL^2 - d*gZlL*gZlR + 
      ...
      SPList[SP[p3, q2]])/Pi^(2*d) - (I*EL^5*gAl*gHll^2*mm^2*s*
      (bb*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + (-2 + d)*gZlR^2*mm^2*
          (mm^2 - psq) + 2*d*gZlL*gZlR*(mm^2*(3*psq - s - 3*t) + 
           psq*(psq - s - t))) + aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*mm^2*(mm^2 - psq) + 2*d*gZlL*gZlR*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*s*
      (bb*(-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(mm^2 - 3*psq + s + 2*t)) - 
         ...
         4^d*gZlL*gZlR*Pi^(2*d)*((-4 + d)*mm^4 + d*psq*(-psq + s + t) + 
           mm^2*(-4*(-1 + d)*psq + d*(s + 3*t)))) + aa*(2*Pi)^(2*d)*
      ...
      SPList[SP[q1, q2]])/Pi^(4*d) - (I*(-2 + d)*EL^5*gAl*gHll^2*
      (gZlL^2 + gZlR^2)*mm^4*s*(aa*(mm^2 + psq - s - 2*t) + 
       bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
     (2*Pi)^(2*d) + (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
      ...
      (gZlL^2 + gZlR^2)*mm^4*(bb*(mm^2 + psq - s - 2*t) + 
       ...
       SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
      (aa*(gZlL*gZlR*(-((-4 + d)*mm^2) + 3*(-2 + d)*psq + 12*s - 3*d*s + 
           2*t - 2*d*t) + (-2 + d)*gZlL^2*(2*mm^2 - 5*psq + 3*(s + t)) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
      (bb*((-2 + d)*gZlL^2*(mm^2 + psq - s - 2*t) + (-2 + d)*gZlR^2*
       ...
       aa*(-(d*gZlL*gZlR*(2*mm^2 - 4*psq + s + 2*t)) + (-2 + d)*gZlL^2*
          (mm^2 - 3*psq + s + 2*t) + (-2 + d)*gZlR^2*(mm^2 - 3*psq + s + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
      (aa*(-((-4 + d)*gZlL*gZlR*(-(psq*s) + mm^2*(psq + s - t))) + 
         2*(-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 2*(-2 + d)*gZlR^2*mm^2*
          (2*psq - s - 2*t)) + bb*mm^2*(-2*(-2 + d)*gZlL^2*
          (2*psq - s - 2*t) - 2*(-2 + d)*gZlR^2*(2*psq - s - 2*t) + 
         (-4 + d)*gZlL*gZlR*(psq - t)))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     ...
     Pi^(2*d) + (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*
      mm^4*(bb*(mm^2 - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
     ...
     Pi^(4*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*
      ((-2 + d)*gZlL^2 - d*gZlL*gZlR + (-2 + d)*gZlR^2)*mm^4*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
      (-(bb*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*
           (psq - t) + gZlL*gZlR*(2*s*(-2*mm^2 + psq + t) + 
            d*psq*(-psq + s + t) + d*mm^2*(-3*psq + s + 3*t)))) + 
    ...
    (I*2^(3 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*
      gZlR*mm^2*(bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*
    ...
    (I*2^(3 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     ...
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
      (2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*bb*(-4 + d)*EL^5*gAl*gHll^2*
      gZlL*gZlR*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
