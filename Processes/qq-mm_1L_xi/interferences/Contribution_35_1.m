...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mz], 
   ...
   (((-I)*EL^6*gAl*gAu*(s + t)*
     ...
     (mz^2*(2*Pi)^d*s) + (I*EL^6*gAl*gAu*(s + t)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL^2*(gZuL^2*((-2 + d)*s^2 - 2*t^2) - 
       ...
       gZlR^2*(gZuL^2*((-4 + d)*s^2 + 2*t^2) + gZuR^2*(-((-2 + d)*s^2) + 
           2*t^2)))*SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1]])/
    ...
    (I*EL^6*gAl*gAu*
      (gZlL^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 5*t - 
       ...
       gZlR^2*(gZuL^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 5*t - 
            ...
            (s + 7*t - 2*d*t))))*SPList[SP[p3, q1], SP[q1, q1], SP[q1, q1]])/
     (mz^4*(2*Pi)^(2*d)) + 
    (I*EL^6*gAl*gAu*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlR^2*(-((-2 + d)*gZuL^2) + 
      ...
      (s + t)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL^2*(gZuR^2*((-4 + d)*s - (-6 + d)*t) + 
       ...
       gZlR^2*(gZuL^2*((-4 + d)*s - (-6 + d)*t) + 
         gZuR^2*(-((-2 + d)*s) + d*t)))*SPList[SP[p2, q1], SP[p2, q1], 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   (((-I)*EL^6*gAl*gAu*(s + t)*
      (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*
       ...
       (-(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*
         ...
         gZlL^2*(gZuL^2*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*
             ...
             2^(1 + d)*Pi^d*(2*s^2 - (-3 + d)*s*t + t^2))))*GaugeXi[Q]^2)*
      SPList[SP[p1, q1], SP[q1, q1]])/(mz^4*(2*Pi)^(2*d)*s*
      (-1 + GaugeXi[Q])^2) - (I*EL^6*gAl*gAu*t*(s + t)*
      (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t))) + 
         gZuL^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))) + 
       gZlL^2*(gZuL^2*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))) - 
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlR^2*(-((-2 + d)*gZuL^2) + 
      ...
      (s + t)*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/(mz^4*Pi^d*s) + 
    (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*(s + t)^2*
      SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(mz^4*Pi^d*s) - 
    (I*EL^6*gAl*gAu*(s + t)*
      (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t))) + 
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlR^2*(-((-2 + d)*gZuL^2) + 
         (-4 + d)*gZuR^2) + gZlL^2*((-4 + d)*gZuL^2 - (-2 + d)*gZuR^2))*
      (s + t)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1], SP[q1, q1]])/
     (mz^4*Pi^d*s) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*(s + t)*
      (gZlL^2*(gZuL^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
         gZuR^2*(-(2^(1 + d)*Pi^d) + d*(2*Pi)^d)) - 
       gZlR^2*(gZuL^2*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
         gZuR^2*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d)) + 
