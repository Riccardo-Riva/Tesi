...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)^2*
     (psq^2 - s^2 + 2*psq*(s - t) + t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(mm^2 - psq)*
     (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*(4*mm^2 - 4*psq + s)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*(2*psq^2 + 4*mm^2*s - 7*psq*s + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*
     ...
     (mm^2 - psq)*(psq^2 + s^2 + mm^2*(psq - t) + 2*s*t + 2*t^2 - 
      3*psq*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*
     (mm^2 - 3*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(-5*psq^3 + 14*psq^2*t + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*(2*psq^2 + s^2 + s*t + 2*t^2 - 
      psq*(s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*
     (-psq + s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(psq - t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(-5*psq^3 + 
      mm^2*(psq - t)*(psq - s - t) - psq*t*(9*s + 13*t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(2*psq - s - 2*t)*
     (psq^2 - mm^2*s + psq*(s - 2*t) + t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(-4*psq^3 + psq^2*(s + 12*t) + 
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq - t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq^2 + mm^2*s + t^2 - psq*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(3*psq^2 - 3*psq*s + s^2 + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq^2 + mm^2*s + (s + t)^2 - 
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(-psq + s + t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq - t)^2*
