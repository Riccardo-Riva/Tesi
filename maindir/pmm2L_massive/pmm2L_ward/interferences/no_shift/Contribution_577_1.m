...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  ((I*EL^5*gAl*gHll^2*mm^4*s*
     ...
     (bb*(-((-2 + d)*gZlL^2*(mm^2*(2*psq - s - 2*t) + 
        ...
        gZlL*gZlR*((-4 + d)*psq^2 + psq*((10 + d)*s - (-4 + d)*t) + 
          mm^2*((-4 + 5*d)*psq + 4*s - 3*d*s + 4*t - 5*d*t) - 
          2*s*((1 + d)*s + (3 + d)*t))) + 
      aa*((-2 + d)*gZlL^2*(psq^2 + mm^2*(2*psq - 3*s - 2*t) + psq*(2*s - t) - 
          s*(s + t)) + (-2 + d)*gZlR^2*(psq^2 + mm^2*(2*psq - 3*s - 2*t) + 
          psq*(2*s - t) - s*(s + t)) + gZlL*gZlR*(-((-4 + d)*psq^2) + 
          psq*(-((14 + 3*d)*s) + (-4 + d)*t) + 2*s*((1 + d)*s + (3 + d)*t) + 
          mm^2*((4 - 5*d)*psq - 4*t + 5*d*(s + t)))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^4*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
     (-(aa*(-2 + d)*gZlL^2*mm^2*(psq - s - t)) + bb*(-2 + d)*gZlL^2*mm^2*
      ...
      aa*gZlL*gZlR*(-((-4 + d)*psq^2) + 2*(-5 + 2*d)*psq*s + (-4 + d)*psq*t - 
        (-2 + d)*s*(s + t) + mm^2*((4 + 3*d)*psq - 4*t - 3*d*(s + t))))*
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (bb*((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - 2*t) + (-2 + d)*gZlR^2*mm^2*
         (mm^2 + psq - 2*t) + gZlL*gZlR*(-(d*mm^2*(3*mm^2 + psq + s - 4*t)) + 
          2*s*(psq + t) + mm^2*(-6*psq + 8*s + 6*t))) + 
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (bb*((-2 + d)*gZlL^2*mm^2*(3*mm^2 - psq - 2*t) + (-2 + d)*gZlR^2*mm^2*
         (3*mm^2 - psq - 2*t) + 2*gZlL*gZlR*(-2*(-1 + d)*mm^4 + s*(psq + t) + 
          mm^2*(-5*psq + 2*s + 3*t + 2*d*t))) - 
      2*aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*(psq - t) + 
        gZlL*gZlR*(s*(-psq + t) + mm^2*(-3*psq - 2*d*psq + 4*s + 3*t + 
   ...
   (I*4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(4*mm^2 - psq - s - 3*t) + 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     (aa*((-4 + d)*mm^2 + 8*psq - d*psq - 2*s - 4*t) + 
      ...
      SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*
   ...
   (I*4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[p2, q1]])/Pi^(2*d) + (I*2^(5 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 + psq - s - 3*t) + 
      aa*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
      SP[p3, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     (bb*(d*mm^2 + 2*psq - d*psq - 2*t) + 2*aa*(-psq + t))*\[Mu]^(8 - 2*d)*
