...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*((-2 + d)^2*mm^4*s - 
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(6*psq^2 - 2*s^2 + d*s^2 + 
      4*s*t + 4*t^2 + mm^2*(-2*psq + d*s + 2*t) - psq*(d*s + 10*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (12*psq^2 + psq*(-6*d*s + d^2*s - 20*t) + 
      mm^2*(4*psq - (12 - 6*d + d^2)*s - 4*t) + 4*(s^2 + 3*s*t + 2*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(2*psq^2 - 2*s^2 + d*s^2 + 
      mm^2*(2*psq + (-2 + d)*s - 2*t) + 4*s*t + 4*t^2 - 
      psq*((-2 + d)*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (-4*psq^2 - (12 - 6*d + d^2)*psq*s + mm^2*(4*psq + (8 - 6*d + d^2)*s - 
        4*t) + 12*psq*t - 4*t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (4*psq^2 + 2*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 2*psq*(s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-4*psq^2 + 
      (6 - 4*d + d^2)*mm^2*s - (2 - 4*d + d^2)*psq*s - 4*s^2 + d*s^2 + 
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     ((8 - 6*d + d^2)*mm^4*s - 2*mm^2*(8*psq^2 + (10 - 6*d + d^2)*psq*s - 
        16*psq*t + 8*t*(s + t)) + s*((16 - 6*d + d^2)*psq^2 + (-2 + d)*s^2 + 
        4*s*t + 4*t^2 - 4*psq*((-2 + d)*s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(4*(2 + d)*psq^2 - 
      2*(-2 + d)^2*mm^2*s + 2*(-2 + d)^2*psq*s + 20*s^2 - 10*d*s^2 + 
      d^2*s^2 - 8*(2 + d)*psq*t + 8*s*t + 4*d*s*t + 8*t^2 + 4*d*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     psq*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     (2*mm^2 - 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq*(-2*psq + (-3 + d)*s) + 
      mm^2*(-4*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     ...
     (-8*psq^2 + 2*s^2 - d*s^2 + 2*mm^2*(4*psq + s - d*s - 4*t) - 4*s*t - 
      4*t^2 + 6*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
      mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-2*(4 + d)*psq^2 - (12 - 10*d + d^2)*psq*s + 2*(8 + d)*psq*t + 
      mm^2*(2*(2 + d)*psq + (16 - 12*d + d^2)*s - 2*(2 + d)*t) - 
      4*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*
     gXll^2*mm^4*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p1, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (psq*(-2*psq + (-3 + d)*s) + mm^2*(8*psq - 3*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(8*psq^2 - 2*s^2 + d*s^2 + 
      2*mm^2*(2*psq + s - 2*t) + 4*s*t + 4*t^2 - 6*psq*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(12 - 7*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-4 + d)*psq*(psq - 2*s - t) + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(8*s + d^2*s - 
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*s^2 + d*s^2 + 
      2*mm^2*(2*psq + s - 2*t) + 4*s*t + 4*t^2 - 2*psq*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*s^2 + d*s^2 + 
      2*mm^2*(4*psq + (-5 + d)*s - 4*t) + 4*s*t + 4*t^2 - 2*psq*(s + 2*t))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*(-4 + d)*psq^2 + 
      (20 - 8*d + d^2)*psq*s + 2*(-8 + d)*psq*t + 4*t*(s + 2*t) + 
      mm^2*(2*(2 + d)*psq - (20 - 10*d + d^2)*s - 2*(2 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*s^2 - d*s^2 + 
      mm^2*(4*psq - 6*s - 4*t) - 4*s*t - 4*t^2 + 2*psq*(s + 2*t))*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-((-4 + d)*psq*(psq + s - t)) + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*psq^2 + 2*mm^2*s - 2*s^2 + 
      d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*psq^2 + 4*mm^2*s - 2*s^2 + 
      d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (d^2*s^2 + 4*s*(3*mm^2 - 2*psq + 5*s) + 
      4*d*(psq^2 - 2*s^2 - 2*psq*t + s*t + t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((16 - 6*d + d^2)*mm^2 - 
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - 2*psq + s)*
   ...
   (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq + (-4 + d)*s - 2*t)*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-psq + s + t)*
    ...
    (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-psq + s + t)*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - 2*psq + s + t)*
   ...
   (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-4 + d)*psq + 
      (20 - 10*d + d^2)*s - 2*(-4 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - t)*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - 2*psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(8*s + d^2*s - 
      2*d*(psq + 2*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*
