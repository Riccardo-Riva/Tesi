...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*gZlL^2*gZlR^2*mm^2*(psq^2 - 2*psq*t + t*(s + t))*
    ...
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*mm^2*
     (4*(4*gZlR^4*(-4*psq^3 + 2*t*(s + t)^2 + 2*psq^2*(2*s + 5*t) + 
        ...
        gZlL^3*gZlR*(-12*psq^3 + 5*s^3 + 11*s^2*t + 18*s*t^2 + 12*t^3 + 
          ...
          2*mm^2*(psq^2 - s^2 - 2*psq*t + t^2) - 
          3*psq*(4*s^2 + 7*s*t + 12*t^2))) + 
      d^2*(-2*gZlL^2*gZlR^2*(-2*psq^3 - psq^2*(s - 6*t) + 
    ...
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*mm^2*
     (-(gZlL^4*(psq - t)*((16 - 6*d + d^2)*psq^2 + (16 - 10*d + d^2)*psq*s - 
       ...
       ((16 - 6*d + d^2)*psq^2 + (16 - 10*d + d^2)*psq*s - 
        (16 - 10*d + d^2)*mm^2*(psq - t) + (-48 + 22*d - 3*d^2)*psq*t + 
        2*(-4 + d)^2*t*(s + t)) + 2*gZlL^2*gZlR^2*(2*(12 - 6*d + d^2)*psq^3 + 
        2*mm^2*(psq - t)*((4 - 6*d + d^2)*psq + 4*s - (4 - 6*d + d^2)*t) - 
        2*t*(s + t)*((-4 + d)^2*s + (12 - 6*d + d^2)*t) - 
        psq^2*((44 - 22*d + 3*d^2)*s + 6*(12 - 6*d + d^2)*t) + 
        psq*t*((100 - 50*d + 7*d^2)*s + 6*(12 - 6*d + d^2)*t)) + 
      gZlL^3*gZlR*(-4*(12 - 8*d + d^2)*psq^3 - 2*(-2 + d)*mm^2*(psq - t)*
        ...
        t*((44 - 22*d + 3*d^2)*s^2 + 2*(36 - 22*d + 3*d^2)*s*t + 
          4*(12 - 8*d + d^2)*t^2)) + gZlL*gZlR^3*(-4*(12 - 8*d + d^2)*psq^3 - 
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
    ...
    Pi^(4*d) - (2^(1 - 2*d)*EL^6*gAl*gAu*mm^2*
     (2*gZlL^2*gZlR^2*s*(-((12 - 6*d + d^2)*psq*s) + 
      ...
      gZlL^4*(-4*(8 - 6*d + d^2)*psq^3 + (-2 + d)*psq^2*
        ...
        (-2 + d)*t*(-((-8 + d)*mm^2*s) + 2*(-4 + d)*(s^2 + 3*s*t + 2*t^2))) + 
      gZlR^4*(-4*(8 - 6*d + d^2)*psq^3 + (-2 + d)*psq^2*
         ((-16 + 3*d)*s + 12*(-4 + d)*t) + (-2 + d)*psq*((-8 + d)*mm^2*s - 
          (-8 + d)*s^2 + (40 - 9*d)*s*t - 12*(-4 + d)*t^2) + 
        (-2 + d)*t*(-((-8 + d)*mm^2*s) + 2*(-4 + d)*(s^2 + 3*s*t + 2*t^2))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*(-4 + d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*
     (psq^2 - 2*psq*t + t*(s + t))*(2*mm^2*((-2 + d)*psq - 2*s + 2*t - d*t) + 
    ...
    (Pi^(2*d)*s) + (4^(1 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*(psq - s - t)*
     (2^(1 + 2*d)*(4 - 6*d + d^2)*gZlL*gZlR*Pi^(2*d)*(2*mm^2 - 3*psq + s + 
      ...
      gZlR^2*(-(2^(1 + 2*d)*(-2 + d)^2*mm^2*Pi^(2*d)) + 
        (2*Pi)^(2*d)*(4*(6 - 5*d + d^2)*psq - (-4 + d)*
           (-4*t + d*(s + 2*t)))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(4*d)*s) + 
   (4^(1 - 2*d)*EL^6*gAl*gAu*(2^(1 + 2*d)*gZlL^2*gZlR^2*mm^2*Pi^(2*d)*
       (psq - s - t)*(2*(4 - 6*d + d^2)*mm^2 - 3*(4 - 6*d + d^2)*psq - 12*s + 
        2*d*s + 4*t - 6*d*t + d^2*t) - gZlL^3*gZlR*mm^2*(psq - s - t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*(gZlL^3*gZlR*mm^2*(-12*(-2 + d)*psq^2 + 
      ...
      gZlL^4*(-2*(28 - 10*d + d^2)*psq^3 - (16 - 10*d + d^2)*mm^4*(psq - t) - 
      ...
      gZlR^4*(-2*(28 - 10*d + d^2)*psq^3 - (16 - 10*d + d^2)*mm^4*(psq - t) - 
        2*psq^2*((22 - 11*d + d^2)*s + (-80 + 30*d - 3*d^2)*t) + 
        (24 - 10*d + d^2)*t*(s^2 + 3*s*t + 2*t^2) + 
        psq*((28 - 12*d + d^2)*s^2 - 2*(26 - 9*d + d^2)*s*t - 
          2*(76 - 30*d + 3*d^2)*t^2) + mm^2*((92 - 48*d + 5*d^2)*psq^2 + 
          t*((56 - 28*d + 3*d^2)*s + 2*(38 - 19*d + 2*d^2)*t) - 
          psq*((8 - 8*d + d^2)*s + (168 - 86*d + 9*d^2)*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
     (-4*(4 - 6*d + d^2)*gZlL*gZlR*(psq^2 + mm^2*s + (s + t)^2 - 
        psq*(3*s + 2*t)) + gZlL^2*s*(2*(-2 + d)^2*mm^2 - 
        4*(6 - 5*d + d^2)*psq + (-4 + d)*(d*s - 4*t + 2*d*t)) + 
      gZlR^2*s*(2*(-2 + d)^2*mm^2 - 4*(6 - 5*d + d^2)*psq + 
        (-4 + d)*(d*s - 4*t + 2*d*t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*(gZlL^3*gZlR*mm^2*s*(-4*(-2 + d)*psq + 
      ...
      gZlR^4*(-2*(8 - 6*d + d^2)*psq^3 - (16 - 10*d + d^2)*mm^4*s + 
        psq^2*((52 - 26*d + 3*d^2)*s + 6*(8 - 6*d + d^2)*t) + 
        (-4 + d)*(s + t)*((-6 + d)*s^2 + 3*(-4 + d)*s*t + 2*(-2 + d)*t^2) - 
        psq*((76 - 32*d + 3*d^2)*s^2 + 2*(58 - 31*d + 4*d^2)*s*t + 
          6*(8 - 6*d + d^2)*t^2) + mm^2*((8 - 6*d + d^2)*psq^2 + 4*s^2 + 
          4*(-2 + d)*s*t + (8 - 6*d + d^2)*t^2 + (-2 + d)*psq*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*(-2*(-2 + d)^2*gZlL^3*gZlR*mm^2*
      ...
      gZlL^4*((48 - 26*d + 3*d^2)*psq^3 - t*(s + t)*((4 - 6*d + d^2)*s + 
        ...
        psq*(56*t*(s + 2*t) + d^2*t*(5*s + 7*t) - 
          2*d*(s^2 + 20*s*t + 29*t^2))) + gZlR^4*((48 - 26*d + 3*d^2)*psq^3 - 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*(-(gZlL^3*gZlR*mm^2*(-2*(-8 + 2*d + d^2)*psq^2 - 
      ...
      gZlL*gZlR^3*mm^2*(-2*(-8 + 2*d + d^2)*psq^2 - (44 - 22*d + d^2)*psq*s + 
        28*s^2 - 12*d*s^2 + d^2*s^2 + 2*(-2 + d)^2*mm^2*(psq - t) + 
        ...
        2*(-2 - 5*d + d^2)*psq*s + 8*s^2 - 2*d*s^2 + 2*(4 - 6*d + d^2)*mm^2*
         (psq - t) + 8*(4 - 6*d + d^2)*psq*t + 4*s*t + 10*d*s*t - 2*d^2*s*t - 
        12*t^2 + 18*d*t^2 - 3*d^2*t^2) + gZlL^4*(-4*(18 - 9*d + d^2)*psq^3 + 
      ...
      gZlR^4*(-4*(18 - 9*d + d^2)*psq^3 + (8 - 6*d + d^2)*mm^4*(psq - t) + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*mm^2*(2*gZlL^4*(mm^2 - psq)*(psq - t) + 
      2*gZlR^4*(mm^2 - psq)*(psq - t) + gZlL^3*gZlR*s*(-2*psq + s + 2*t) + 
      gZlL*gZlR^3*s*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 4*d)*(-2 + d)*EL^6*gAl*gAu*mm^2*(-(gZlL^3*gZlR*(2*Pi)^(2*d)*s^2) - 
      gZlL*gZlR^3*(2*Pi)^(2*d)*s^2 + 2^(1 + 2*d)*gZlL^4*Pi^(2*d)*
       (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t)) + 
      2^(1 + 2*d)*gZlR^4*Pi^(2*d)*(psq^2 + mm^2*s + (s + t)^2 - 
    ...
    (Pi^(4*d)*s) - (2^(1 - 2*d)*EL^6*gAl*gAu*
     (d^2*(gZlL^3*gZlR*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
          ...
          2*t*(s^2 + 3*s*t + 2*t^2)) + gZlR^4*(-7*psq^3 + 3*psq^2*(s + 6*t) - 
          psq*t*(11*s + 15*t) + mm^2*(psq^2 - s^2 + 2*psq*(s - t) + t^2) + 
          2*t*(s^2 + 3*s*t + 2*t^2))) - 
   ...
   (4^(1 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*(psq - t)*
     (-(2^(1 + 2*d)*(4 - 6*d + d^2)*gZlL*gZlR*Pi^(2*d)*(psq - t)) + 
      (-4 + d)*gZlL^2*(2*Pi)^(2*d)*(2*(-2 + d)*psq - (-4 + d)*s - 
        2*(-2 + d)*t) + (-4 + d)*gZlR^2*(2*Pi)^(2*d)*(2*(-2 + d)*psq - 
        (-4 + d)*s - 2*(-2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(4*d)*s) + 
   (4^(1 - 2*d)*EL^6*gAl*gAu*(psq - t)*
     (-(gZlL^3*gZlR*mm^2*(2*Pi)^(2*d)*(4*(-2 + d)*psq - (20 - 10*d + d^2)*s - 
         4*(-2 + d)*t)) - gZlL*gZlR^3*mm^2*(2*Pi)^(2*d)*
   ...
   (2^(1 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*
     (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*(-2*(-2 + d)^2*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t)*
       (psq - t) + 2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*(2*psq - s - 2*t)*
       (psq - t) - 2*(-2 + d)^2*gZlL*gZlR^3*mm^2*(2*psq - s - 2*t)*
       (psq - t) + gZlL^4*(-((16 - 6*d + d^2)*psq^3) + 
        t*(s + t)*((28 - 10*d + d^2)*s + 2*(-4 + d)^2*t) + 
        mm^2*(psq - t)*((16 - 10*d + d^2)*psq - (-4 + d)^2*s - 
          (16 - 10*d + d^2)*t) + psq^2*((28 - 8*d + d^2)*s + 
          4*(16 - 7*d + d^2)*t) - psq*t*((88 - 34*d + 4*d^2)*s + 
          (80 - 38*d + 5*d^2)*t)) + gZlR^4*(-((16 - 6*d + d^2)*psq^3) + 
        t*(s + t)*((28 - 10*d + d^2)*s + 2*(-4 + d)^2*t) + 
        mm^2*(psq - t)*((16 - 10*d + d^2)*psq - (-4 + d)^2*s - 
          (16 - 10*d + d^2)*t) + psq^2*((28 - 8*d + d^2)*s + 
          4*(16 - 7*d + d^2)*t) - psq*t*((88 - 34*d + 4*d^2)*s + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*(2*gZlL^3*gZlR*mm^2*s*(4*(-2 + d)*psq - 
      ...
      2*gZlL^2*gZlR^2*mm^2*s*(-2*(4 - 6*d + d^2)*psq + (8 - 6*d + d^2)*s + 
        2*(4 - 6*d + d^2)*t) + 
      gZlL^4*(mm^2*(psq - t)*((16 - 10*d + d^2)*psq - (8 - 8*d + d^2)*s - 
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*(-((-2 + d)^2*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t)*
      ...
      gZlL^4*((-64 + 26*d - 3*d^2)*psq^3 + mm^2*(psq - t)*
         ((16 - 10*d + d^2)*psq - (24 - 10*d + d^2)*s - (16 - 10*d + d^2)*
           t) + 2*t*(s + t)*((28 - 10*d + d^2)*s + 2*(20 - 9*d + d^2)*t) + 
        2*psq^2*((32 - 10*d + d^2)*s + (104 - 44*d + 5*d^2)*t) - 
        psq*t*(4*(50 - 19*d + 2*d^2)*s + (224 - 98*d + 11*d^2)*t)) + 
      gZlR^4*((-64 + 26*d - 3*d^2)*psq^3 + mm^2*(psq - t)*
         ((16 - 10*d + d^2)*psq - (24 - 10*d + d^2)*s - (16 - 10*d + d^2)*
           t) + 2*t*(s + t)*((28 - 10*d + d^2)*s + 2*(20 - 9*d + d^2)*t) + 
        2*psq^2*((32 - 10*d + d^2)*s + (104 - 44*d + 5*d^2)*t) - 
        psq*t*(4*(50 - 19*d + 2*d^2)*s + (224 - 98*d + 11*d^2)*t)))*
   ...
   (2^(3 - 2*d)*(4 - 6*d + d^2)*EL^6*gAl*gAu*gZlL^2*gZlR^2*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
    Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*(2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*
   ...
   (2^(1 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*
     ...
     (2^(1 + 2*d)*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2*Pi^(2*d)*(psq - s - t) - 
      2^(1 + 2*d)*(12 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*Pi^(2*d)*
       (psq - s - t) + 2^(1 + 2*d)*(12 - 8*d + d^2)*gZlL*gZlR^3*mm^2*Pi^(2*d)*
       (psq - s - t) + gZlL^4*(2*Pi)^(2*d)*((-112 + 50*d - 5*d^2)*psq^2 + 
        4*(22 - 10*d + d^2)*psq*s + (20 - 10*d + d^2)*mm^2*
         (2*psq - s - 2*t) + (160 - 70*d + 7*d^2)*psq*t - 
        (24 - 10*d + d^2)*(s^2 + 3*s*t + 2*t^2)) + gZlR^4*(2*Pi)^(2*d)*
   ...
   (2^(3 - 4*d)*EL^6*gAl*gAu*(2^(1 + 2*d)*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2*
       ...
       mm^2*Pi^(2*d)*(psq - s - t) + 2^(1 + 2*d)*(12 - 8*d + d^2)*gZlL*gZlR^3*
       mm^2*Pi^(2*d)*(psq - s - t) + gZlL^4*(2*Pi)^(2*d)*
       ((-112 + 50*d - 5*d^2)*psq^2 + 4*(22 - 10*d + d^2)*psq*s + 
        (20 - 10*d + d^2)*mm^2*(2*psq - s - 2*t) + (160 - 70*d + 7*d^2)*psq*
   ...
   (2^(3 - 4*d)*EL^6*gAl*gAu*(2^(1 + 2*d)*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2*
       ...
       Pi^(2*d)*(psq - t) + gZlL^4*(2*Pi)^(2*d)*((24 - 10*d + d^2)*psq^2 + 
        ...
        4*psq*s - 3*(24 - 10*d + d^2)*psq*t + (24 - 10*d + d^2)*t*(s + 2*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/
    (Pi^(4*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*
     ((8 - 6*d + d^2)*psq^2 + (24 - 10*d + d^2)*s*(s + 2*t) + 
      mm^2*(-((8 - 6*d + d^2)*psq) + (20 - 10*d + d^2)*s + 
        (8 - 6*d + d^2)*t) - psq*((68 - 30*d + 3*d^2)*s + (8 - 6*d + d^2)*t))*
   ...
   (2^(3 - 4*d)*EL^6*gAl*gAu*(2^(1 + 2*d)*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2*
    ...
    (Pi^(4*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*psq*
