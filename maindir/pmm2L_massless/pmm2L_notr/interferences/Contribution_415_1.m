...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((3*(-2 + d)*EL^8*gAl^2*gAu^2*gFFA*gFFAZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFA*gFFAZ*(gZlL + gZlR)*(s + t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFA*gFFAZ*(gZlL + gZlR)*(s + t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFA*gFFAZ*(gZlL + gZlR)*t*
