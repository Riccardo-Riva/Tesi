...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
  ...
  (2^(-1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    ...
    SPList[SP[q1, q2]])/Pi^(2*d) + (2^(-1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*
    gWNl*gWWA*mm^2*(aa*(3*mm^2 + psq) - bb*(mm^2 + 3*psq))*s^2*
  ...
  ((-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(aa*(3*mm^2 + psq) - 
  ...
  ((-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*(aa*mm^2 - bb*psq)*s*
  ...
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^5*gFll^2*gWlN*gWNl*gWWA*mm^2*
    (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[q2, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll^2*gWlN*
