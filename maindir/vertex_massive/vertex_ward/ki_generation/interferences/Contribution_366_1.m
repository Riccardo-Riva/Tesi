...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((d*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^4*s*(aa*(mm^2 + 3*psq - s) + 
      bb*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
  (2^(1 - 2*d)*d*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*
    (4*aa*mm^2*psq - bb*psq*s + bb*mm^2*(-4*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + 
  ((-2 + d)*EL^5*gAl*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
    (2*aa*mm^2*psq - bb*psq*s + bb*mm^2*(-2*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  ((-aa + bb)*(-2 + d)*EL^5*gAl*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*psq*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  ((aa + bb)*d*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*(mm^2 - psq)*s*
  ...
  (4^(1 - d)*d*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*(aa*mm^2 - bb*psq)*
  ...
  ((aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (2*Pi)^(2*d) + ((aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHZZ*(gZlL^2 + gZlR^2)*
