...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*s*
   ...
   Pi^(2*d) + (2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
    ...
    SPList[SP[q1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(2*aa*(mm^2 + psq) - 
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(bb*psq*(2*psq - s) - 
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(-2*aa*psq + bb*(mm^2 + psq))*s*
