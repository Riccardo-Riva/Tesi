...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
   ...
   ((4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
      ...
      gZlR*gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*(psq^2 - 2*psq*t + t*(s + t))*
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*d*EL^6*gAu*gFFA*gFll^2*gZlR*
      gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*(psq^2 - 2*psq*t + t*(s + t))*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
      ((-2 + d)*gZlL*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
         ...
         2*psq^2*((-2 + d)*s + (10 + d)*t) + psq*(s + t)*
          ((-4 + d)*s + (16 + d)*t) + mm^2*((-12 + d)*psq^2 - 
           (-4 + d)*psq*s - 2*(-12 + d)*psq*t + (-12 + d)*t*(s + t))))*
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*d*EL^6*gAu*gFFA*gFll^2*gZlR*
      gZNL*mm^2*(psq - t)*(psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
      ...
      mm^2*(2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       ...
       SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*d*EL^6*gAu*gFFA*gFll^2*gZlR*
      gZNL*mm^2*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*
      mm^2*((-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*psq)*(psq - t)*\[Mu]^(8 - 2*d)*
