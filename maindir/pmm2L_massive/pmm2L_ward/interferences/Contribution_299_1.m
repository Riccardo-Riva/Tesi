...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
 ...
 (((-I)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*gWWA*
    gWWZ*(gZlL + gZlR)*mm^2*s*(2*bb*(psq - s - t) + 
     aa*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*
    mm^2*(-(bb*(psq^2 + mm^2*(psq - 2*s - t) - psq*t + s*(s + t))) + 
  ...
  (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
    ...
    (-(bb*(psq^2 + 2*psq*s + mm^2*(psq - 4*s - t) - psq*t + s*t)) + 
  ...
  (I*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*
    ...
    SPList[SP[q1, q2]])/Pi^(2*d) - (I*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*
    (gZlL + gZlR)*mm^2*(2*bb*(psq - s - t) + aa*(mm^2 - 3*psq + 2*(s + t)))*
  ...
  (I*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*
    gWWZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
