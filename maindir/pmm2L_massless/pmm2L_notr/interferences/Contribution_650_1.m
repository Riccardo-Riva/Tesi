...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
 ...
 ((4^(1 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((32 - 14*d + d^2)*s^2 + 
  ...
  ((-2 + d)^2*EL^8*gAl^6*gAu^2*((-4 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(-2*s + (-6 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*(-2*s + (-6 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((24 - 12*d + d^2)*s - 2*(-2 + d)*t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*\[Mu]^(8 - 2*d)*
