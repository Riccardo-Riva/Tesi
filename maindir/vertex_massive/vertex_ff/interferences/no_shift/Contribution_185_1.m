  ...
  ((4^(1 - 2*d)*EL^6*gAl^3*gAu*mm^2*
     (-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(d^2*mm^2 + 8*s - 2*d*(mm^2 + s))*
      ...
      gZlL^2*(-((-6 + d)*(2*Pi)^(2*d)*s*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
        ...
        mm^2*(d^2*(2*Pi)^(2*d)*s*(psq^2 + t*(s + 3*t)) + 2^(1 + 2*d)*Pi^(2*d)*
     ...
     (gZlL^2*(-(d^2*(2*Pi)^(2*d)*psq*s*(psq - s + 5*t)) + 
        (-2 + d)^2*mm^2*(2*Pi)^(2*d)*(6*psq^2 + s^2 + 7*s*t + 6*t^2 - 
          ...
          (20 - 8*d + d^2)*s*t*(s + t) + psq^2*(-2*(-7 + d)*s + 
            ...
            (-2 + d)^2*t^2))) + 
      gZlR^2*(-(d^2*(2*Pi)^(2*d)*psq*s*(psq - s + 5*t)) + 
        (-2 + d)^2*mm^2*(2*Pi)^(2*d)*(6*psq^2 + s^2 + 7*s*t + 6*t^2 - 
          3*psq*(s + 4*t)) + 2^(1 + 2*d)*Pi^(2*d)*(-((-2 + d)^2*psq^3) + 
          (20 - 8*d + d^2)*s*t*(s + t) + psq^2*(-2*(-7 + d)*s + 
            2*(-2 + d)^2*t) - psq*(2*(-1 + d)*s^2 - 6*(-7 + 3*d)*s*t + 
            (-2 + d)^2*t^2))) - 4*gZlL*gZlR*
       (2^(3 + 2*d)*Pi^(2*d)*s*(4*psq^2 - 3*psq*s + s^2 - 8*psq*t + 5*s*t + 
          4*t^2) + d^2*(2*Pi)^(2*d)*(mm^2*(2*psq^2 - 3*psq*s + s^2 - 
            4*psq*t + 3*s*t + 2*t^2) + s*(psq^2 - 2*psq*t + t*(s + t))) - 
        2^(1 + 2*d)*d*Pi^(2*d)*(mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
            3*s*t + 2*t^2) + s*(6*psq^2 + s^2 + 7*s*t + 6*t^2 - 
    ...
    (Pi^(4*d)*s) - (2^(1 - 4*d)*EL^6*gAl^3*gAu*
     (d^2*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s - t)*
      ...
      4*d*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq^3 - s^3 - 9*s^2*t - 
          ...
          3*psq*(s^2 + 6*s*t + 2*t^2)) + 
        gZlL^2*(2^(1 + 2*d)*mm^4*Pi^(2*d)*(psq - t)*(psq - s - t) - 
     ...
     (-(d^2*(psq - t)*(gZlL^2*(2*Pi)^(2*d)*(psq^2*s + 
        ...
        gZlR^2*(2*Pi)^(2*d)*(mm^4*s*(psq - t) + s*(5*psq^3 + 8*psq*s*t - 
          ...
          2*mm^2*(2*psq^3 + psq^2*(4*s - 6*t) + psq*t*(-7*s + 6*t) + 
            t*(5*s^2 + 3*s*t - 2*t^2)))) + 
      4*d*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq^3 + 6*psq^2*(s - t) - 
           psq*(s^2 + 10*s*t - 6*t^2) + t*(5*s^2 + 4*s*t - 2*t^2))) + 
        gZlL^2*(2*Pi)^(2*d)*(2*mm^4*(psq - t)^2 + 
          s*(psq^3 - 2*psq*t^2 + t^2*(s + t)) + mm^2*(6*psq^3 - 16*psq^2*t + 
            psq*t*(s + 14*t) - t*(-3*s^2 + s*t + 4*t^2))) + 
        gZlR^2*(2*Pi)^(2*d)*(2*mm^4*(psq - t)^2 + 
          s*(psq^3 - 2*psq*t^2 + t^2*(s + t)) + mm^2*(6*psq^3 - 16*psq^2*t + 
            psq*t*(s + 14*t) - t*(-3*s^2 + s*t + 4*t^2)))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(4*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*((-2 + d)^2*gZlL^2*(2*Pi)^(2*d)*
       (mm^2 + psq)*(2*psq - s - 2*t) + (-2 + d)^2*gZlR^2*(2*Pi)^(2*d)*
       (mm^2 + psq)*(2*psq - s - 2*t) + 4^(1 + d)*gZlL*gZlR*Pi^(2*d)*
       (d^2*mm^2 + 8*s - 2*d*(mm^2 + s))*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(4*d) - 
   ...
   (4^(1 - 2*d)*EL^6*gAl^3*gAu*(-(2^(1 + 2*d)*(-2 + d)*d*gZlL*gZlR*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*
     (d^2*(-2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*(psq - t) + 
        gZlL^2*(-2*psq^2*s + 4*mm^4*(psq - t) - mm^2*(2*psq - s - 2*t)*
           (psq + t)) + gZlR^2*(-2*psq^2*s + 4*mm^4*(psq - t) - 
          mm^2*(2*psq - s - 2*t)*(psq + t))) - 
      2*d*(2*gZlL*gZlR*mm^2*(-4*psq^2 - 3*psq*s + 4*s^2 + 8*psq*t + 3*s*t - 
          4*t^2) + gZlL^2*(2*psq^3 + 4*mm^4*(psq - t) - 2*psq^2*(2*s + 3*t) - 
          t*(3*s^2 + 5*s*t + 2*t^2) + mm^2*(2*psq^2 - s^2 + psq*(s - 8*t) + 
            3*s*t + 6*t^2) + psq*(-2*s^2 + 5*s*t + 6*t^2)) + 
        gZlR^2*(2*psq^3 + 4*mm^4*(psq - t) - 2*psq^2*(2*s + 3*t) - 
          t*(3*s^2 + 5*s*t + 2*t^2) + mm^2*(2*psq^2 - s^2 + psq*(s - 8*t) + 
            3*s*t + 6*t^2) + psq*(-2*s^2 + 5*s*t + 6*t^2))) + 
      4*(12*gZlL*gZlR*mm^2*s*(-psq + s + t) + 
        gZlL^2*(6*psq^3 - 2*psq^2*(s + 9*t) + mm^2*(4*psq^2 - s^2 - 8*psq*t + 
            2*s*t + 4*t^2) - t*(7*s^2 + 13*s*t + 6*t^2) + 
          psq*(-4*s^2 + 13*s*t + 18*t^2)) + 
        gZlR^2*(6*psq^3 - 2*psq^2*(s + 9*t) + mm^2*(4*psq^2 - s^2 - 8*psq*t + 
            2*s*t + 4*t^2) - t*(7*s^2 + 13*s*t + 6*t^2) + 
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(-(4^(1 + d)*(-2 + d)*d*gZlL*gZlR*mm^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*(2*d^2*(gZlL - gZlR)^2*mm^2*(-psq + s + t)^2 - 
      2*s*(12*gZlL*gZlR*mm^2*s + gZlL^2*(-10*psq*s + 
          mm^2*(2*psq - 3*s - 2*t) + 3*s*(s + t)) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*(d^2*(gZlL^2*(psq*s + 2*mm^2*(psq - t)) + 
        gZlR^2*(psq*s + 2*mm^2*(psq - t)) - 2*gZlL*gZlR*mm^2*
         (2*psq + s - 2*t))*(psq - t) - 2*d*(psq - t)*(-14*gZlL*gZlR*mm^2*s + 
        gZlL^2*(-2*psq^2 + mm^2*(2*psq + s - 2*t) + 4*psq*(s + t) - 
          t*(s + 2*t)) + gZlR^2*(-2*psq^2 + mm^2*(2*psq + s - 2*t) + 
          4*psq*(s + t) - t*(s + 2*t))) + 4*(-12*gZlL*gZlR*mm^2*s*(psq - t) + 
        gZlL^2*(-6*psq^3 + mm^2*psq*s - 6*psq*t*(2*s + 3*t) + 
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(-(4^(1 + d)*(-2 + d)*d*gZlL*gZlR*mm^2*
      ...
      gZlL^2*(-(d^2*(2*Pi)^(2*d)*psq*s*(psq - t)) + (-2 + d)^2*mm^2*
         (2*Pi)^(2*d)*(2*psq - s - 2*t)*(psq - t) + 2^(1 + 2*d)*Pi^(2*d)*
