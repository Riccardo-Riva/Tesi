...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (((-I)*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^8*s*(bb*(mm^2 + psq - s - 2*t) + 
   ...
   (I*4^(2 - d)*EL^5*gAl*gHll^4*mm^6*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*(-4*bb*mm^2*(psq - t) + 
      aa*s*(psq - t) + bb*s*(psq + t) + aa*mm^2*(4*psq - 2*(s + 2*t)))*
   ...
   (I*4^(2 - d)*EL^5*gAl*gHll^4*mm^4*(bb*(2*mm^2 - s - 2*t) + 
      aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(2*psq - s - 2*t)*
   ...
   (I*4^(2 - d)*EL^5*gAl*gHll^4*mm^4*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
