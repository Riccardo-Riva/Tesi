...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*2^(1 - 2*d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*mm^4*s*
    ...
    Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*mm^4*
     ...
     (gZlL - gZlR)^2*mm^4*(aa*(mm^2*(2*psq - s - 2*t) + psq*(psq - s - t)) - 
     ...
     SPList[SP[p3, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*aa*EL^5*gAl*gXll^2*
     (gZlL - gZlR)^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa + bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*mm^4*(mm^2 - psq)*
   ...
   (I*2^(3 - 2*d)*bb*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*mm^4*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*mm^4*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*(gZlL - gZlR)^2*mm^4*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d)))/4
