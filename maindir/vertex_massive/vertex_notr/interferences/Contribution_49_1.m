...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*(-2 + d)*EL^6*gAl^4*gXll^2*mm^4*(mm^2 - s)*
      (2*(-1 + d)*mm^2 - 2*(-3 + d)*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d))/
     Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^4*gXll^2*mm^4*((2 - d + d^2)*mm^2 - 
      (-2 + d)*((-3 + d)*psq + 2*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl^4*gXll^2*mm^4*((2 - 5*d + d^2)*mm^2 - 
      (-2 + d)*((-3 + d)*psq - d*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl^4*gXll^2*mm^4*(4*d*mm^2 + 12*s - 10*d*s + 
      d^2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl^4*gXll^2*mm^4*(4*d*mm^2 + 12*s - 10*d*s + d^2*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl^4*gXll^2*mm^4*(2*(6 - 5*d + d^2)*mm^2 - 
      2*(10 - 7*d + d^2)*psq - (-4 + d)^2*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^4*gXll^2*mm^2*
     (8*(-2 + d)*mm^4 + (-2 + d)*s*(2*(-3 + d)*psq - (-2 + d)*s) + 
      mm^2*(-8*(-2 + d)*psq + 2*(18 - 9*d + d^2)*s))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^4*gXll^2*mm^4*(2*mm^2 - 2*psq + (-6 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*(-1 + d)*EL^6*gAl^4*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^4*gXll^2*mm^2*(8*(-1 + d)*mm^2 - (12 - 8*d + d^2)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAl^4*gXll^2*mm^2*((-2 + 3*d)*mm^2 - (-2 + d)*psq + 
   ...
   (2^(3 - 2*d)*EL^6*gAl^4*gXll^2*mm^2*(-6*s + d*(4*mm^2 + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^4*gXll^2*mm^2*(24*s + d^2*s - 2*d*(2*mm^2 + 5*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
   (4^(2 - d)*(-2 + d)*EL^6*gAl^4*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^4*gXll^2*mm^2*(4*d*mm^2 - 24*s + 10*d*s - d^2*s)*
