...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
 ...
 ((I*4^(-1 - d)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*s*
    (bb*psq*(3*psq - 2*s - 3*t) + bb*mm^2*(psq - t) + 
     aa*mm^2*(-psq + s + t) + aa*psq*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) + (I*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (aa*(12*psq^2 + 4*mm^2*(psq - s - t) - 6*psq*(s + 2*t) + s*(s + 2*t)) - 
     bb*(12*psq^2 + 4*mm^2*(psq - t) + s*(s + 2*t) - 2*psq*(5*s + 6*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (bb*((2*psq - s)*(3*psq - 2*s - 3*t) + 2*mm^2*(psq - t)) + 
     aa*(-6*psq^2 + 5*psq*s - 2*s^2 + 6*psq*t - 3*s*t + 
       2*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (bb*s*(7*psq - 4*s - 5*t) - 2*bb*mm^2*(psq - t) + 
     2*aa*mm^2*(psq - s - t) + aa*s*(-5*psq + 4*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gFll^2*gHFF*gHll*
    mh^2*mm^4*(aa*(6*psq^2 + 2*mm^2*(psq - s - t) + s*(s + t) - 
       3*psq*(s + 2*t)) - bb*(6*psq^2 + 2*mm^2*(psq - t) + s*(s + t) - 
       psq*(5*s + 6*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (aa*((2*psq - s)*(3*psq - s - 3*t) + 2*mm^2*(psq - s - t)) - 
     bb*(6*psq^2 - 7*psq*s + s^2 + 2*mm^2*(psq - t) - 6*psq*t + 3*s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (-2*bb*mm^2*(psq - t) + 2*aa*mm^2*(psq - s - t) - 
     bb*s*(-5*psq + s + 5*t) + aa*s*(-3*psq + s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gFll^2*gHFF*gHll*
    mh^2*mm^4*(bb*(6*psq^2 - 5*psq*s + 2*mm^2*(psq - t) - 6*psq*t + s*t) + 
     aa*(-6*psq^2 + 3*psq*s + 6*psq*t - s*t + 2*mm^2*(-psq + s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*s*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (8*psq - 3*s - 8*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*
    mm^4*(3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (aa*(psq - t) + bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (4*psq - 3*s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   Pi^(2*d) + ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*(psq - s - t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*
    mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*
    mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
  ...
  (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/(4^d*Pi^(2*d)) - 
  ((3*I)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/(4^d*Pi^(2*d)) + 
  ((3*I)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/(4^d*Pi^(2*d)) + 
  ((3*I)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/(4^d*Pi^(2*d)) - 
  ((3*I)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, p3]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
