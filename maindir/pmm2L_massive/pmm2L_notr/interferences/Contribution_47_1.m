...
PropList[KiraPropagator[q1, mh], KiraPropagator[-p3 + q1, mm], 
 ...
 (-(((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 - psq)^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(4^d*Pi^(2*d)*s)) + 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)^2*
  ...
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*(-4 + d)*mm^4*s + psq*(4*psq^2 + (-4 + d)*s^2 + 2*psq*(d*s - 4*t) + 
       4*s*t + 4*t^2) + mm^2*(12*psq^2 - 4*psq*((-2 + d)*s + 6*t) + 
       3*((-4 + d)*s^2 + 4*s*t + 4*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(4*mm^4*s - psq*(4*psq^2 + (-4 + d)*s^2 + 
       4*psq*(s - 2*t) + 4*s*t + 4*t^2) - 
     3*mm^2*(4*psq^2 + (-4 + d)*s^2 - 8*psq*t + 4*s*t + 4*t^2))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*psq*
    ...
    gXll*(gZlL - gZlR)*mm^2*(3*mm^2 + psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^4 + 3*mm^2*(psq - t) - psq*(psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[p3, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (psq*(2*psq + 3*s - d*s - 2*t) + mm^2*(2*psq + 5*s - d*s - 2*t))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (d*(mm^2 - psq) + 4*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) - (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*psq^2 - (-2 + d)*mm^2*s + (-6 + d)*psq*s - 4*s^2 + d*s^2 - 8*psq*t + 
