...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   (((-I)*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)^2*s*
      \[Mu]^(8 - 2*d))/Pi^(2*d) - (I*4^(1 - d)*d*EL^5*gAl^3*gHll^2*mm^4*
      ...
      gAl^3*gHll^2*mm^2*(3*mm^4 - 2*mm^2*psq - psq^2)*(psq - s - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*d*EL^5*gAl^3*gHll^2*mm^4*(aa*mm^2*(5*psq - s - 5*t) + 
       3*aa*psq*(psq - s - t) + bb*psq*(-3*psq + s + 3*t) + 
       bb*mm^2*(-5*psq + 3*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    ...
    (I*2^(3 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^4*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/Pi^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
      (mm^2 - psq)*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^4*(bb*(2*mm^2 - s - 2*t) + 
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 + psq)*
     ...
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
      (3*mm^2 + psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^4*
    ...
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(mm^2 - t) + 
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
      ...
      gHll^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
      (bb*(mm^2 - s - t) + aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(mm^2 - s - t) + 
