...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
 ...
 ((4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-2 + d)*s^2 + 4*s*t + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
   ...
   (4^d*Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
    gZlL*((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ((-9 + d)*s^2 - 17*s*t - 10*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ((20 - 8*d + d^2)*s^2 + 4*d*s*t + 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-7 + 2*d)*s^2 - s*t + 
     2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-20 + d^2)*s^2 + 4*(-10 + d)*s*t + 
     4*(-6 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   (4^d*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-2 + d)*s^2 + 3*s*t + 
     2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ((-2 + d)*s^2 - 3*s*t - 10*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ((12 - 8*d + d^2)*s^2 + 4*(-4 + d)*s*t + 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(2*(-2 + d)*s^2 + 5*s*t + 
  ...
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-4 + d^2)*s^2 + 4*(-2 + d)*s*t + 
     4*(-6 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
   (4^d*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*t*
    (s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ((22 - 10*d + d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((26 - 10*d + d^2)*s^2 + 
     4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (3*4^(1 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) + 
  (2^(3 - 2*d)*(-3 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ((42 - 15*d + d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
  ...
  ((-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-3 + d)*s^2 + 4*s*t + 
   ...
   (4^d*Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
    gZlL*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
    ...
    gWNl*gWWZ*gZlL*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(s + t)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(6 - 5*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
    gWWZ*gZlL*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
  ...
  (2^(1 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(d*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
    gZlL*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
    gZlL*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ...
    gWWZ*gZlL*((8 - 8*d + d^2)*s + 8*(-6 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*t*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ...
    gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
    gWNl*gWWZ*gZlL*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
    ...
    gWNl*gWWZ*gZlL*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
    gWWZ*gZlL*((2 - 2*d + d^2)*s + 4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(22 - 8*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
