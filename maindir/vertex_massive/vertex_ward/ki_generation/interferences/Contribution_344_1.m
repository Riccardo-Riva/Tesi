...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^4*(aa*psq*(mm^2 + psq - 2*s) - 
      bb*(psq*(psq - 3*s) + mm^2*(psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(2*Pi)^(2*d)) + 
  (EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^4*(aa*(2*mm^2 + 3*psq - 2*s) - 
   ...
   (2*Pi)^(2*d) + (2^(-1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*s*
    ...
    gHFW*gHll*gWlN*mm^4*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   Pi^(2*d) - (EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*
    (aa*(2*mm^4 + mm^2*(6*psq - 4*s) + psq*s) - 
     bb*(2*mm^4 + mm^2*(6*psq - 5*s) + 2*psq*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(2*bb*psq*(psq - 3*s) - 
     aa*psq*(2*psq + s) + bb*mm^2*(-6*psq + 3*s) + aa*mm^2*(6*psq + 4*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(4*aa*mm^2*psq - bb*psq*s + 
     bb*mm^2*(-4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) + (EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*
    (aa*(2*mm^4 + 2*mm^2*psq + psq*s) + 
     bb*(-2*mm^4 - 2*psq*s + mm^2*(-2*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*
    (-(bb*(psq*(psq - 2*s) + mm^2*(psq + s))) + 
  ...
  (EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(bb*(mm^2 - 2*psq) + aa*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(bb*(mm^2 - 2*psq) + aa*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(aa*mm^2 - bb*psq)*
