...
(PropList[KiraPropagator[q1, mh], KiraPropagator[-p1 - p2 + q1, 
  ...
  (((-I)*2^(2 - d)*EL^6*gAl*gAu*gHXZ^2*
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*gHXZ^2*(gZlL*gZuL*(2*mmv^2 + (-6 + d)*s - 2*t) + 
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*gHXZ^2*(gZlR*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
      gZlL*gZuR*(2*mmv^2 - (-4 + d)*s - 2*t) + 
      gZlL*gZuL*(2*mmv^2 + (-2 + d)*s - 2*t) + 
      gZlR*gZuR*(2*mmv^2 + (-2 + d)*s - 2*t))*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^d*(mz^2 - s)^2*s) - (I*2^(4 - d)*EL^6*gAl*gAu*gHXZ^2*(gZlL + gZlR)*
