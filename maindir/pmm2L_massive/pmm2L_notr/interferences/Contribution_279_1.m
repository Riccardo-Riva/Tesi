...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*mm^2*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*mm^2*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(Pi^(2*d)*s) - 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*
    (2*mm^2 - 2*psq + s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (4^d*Pi^(2*d)*s) + (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*
    (gZlL + gZlR)*mm^2*sw*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*
    (gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/(Pi^(2*d)*s) - 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*
    (2*mm^2 - 2*psq + s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (4^d*Pi^(2*d)*s) + (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*
    (gZlL + gZlR)*mm^2*sw*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*
    (gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) - 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*
    (2*mm^2 - 2*psq + s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (4^d*Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*sw*
   ...
   (Pi^(2*d)*s) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFZW*
    ...
    gFAW*gFFA*gFZW*(gZlL + gZlR)*sw*\[Mu]^(8 - 2*d)*
