...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, 0], 
   ...
   ((I*2^(2 - d)*EL^6*gAl^2*gAu^2*(gZlL^2 + gZlR^2)*((-2 + d)*s^2 + 4*s*t + 
       4*t^2))/(Pi^d*s) + (I*2^(3 - d)*EL^6*gAl^2*gAu^2*(gZlL^2 + gZlR^2)*
      ((-4 + d)*s - 2*t)*SPList[SP[p1, q1]])/(Pi^d*s) + 
    (I*2^(3 - d)*EL^6*gAl^2*gAu^2*(gZlL^2 + gZlR^2)*((-2 + d)*s + 2*t)*
      SPList[SP[p2, q1]])/(Pi^d*s) - (I*2^(4 - d)*(-3 + d)*EL^6*gAl^2*gAu^2*
      (gZlL^2 + gZlR^2)*SPList[SP[p3, q1]])/Pi^d + 
    (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*(gZlL^2 + gZlR^2)*
     ...
     (Pi^(2*d)*s^2) + (I*2^(3 - d)*(-2 + d)*EL^6*gAl^2*gAu^2*
      (gZlL^2 + gZlR^2)*(s + t)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^d*s^2) - 
