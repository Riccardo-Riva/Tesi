...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*mm^2*sw*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*mm^2*sw*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*mm^2*sw*
     (-((-4 + d)*gZlR*(mm^2 - psq)*s) + (-2 + d)*gZlL*mm^2*(2*psq - s - 2*t))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*mm^2*sw*
     (-(d*gZlR*(psq - t)*(psq - s - t)) + 
      gZlL*(2*(-2 + d)*psq^2 + (8 - 3*d)*psq*s + (-2 + d)*s^2 - 
        4*(-2 + d)*psq*t + (-8 + 3*d)*s*t + 2*(-2 + d)*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*gZlL*mm^2*sw*
     (-psq + s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*mm^2*sw*
     (-2*gZlL*s*(-psq + 2*s + t) + d*(-psq + s + t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*mm^2*sw*
     (-(d*(gZlL*s + gZlR*(2*psq - s - 2*t))*(psq - t)) + 
      2*gZlL*s*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*gZlL*mm^2*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*gZlL*mm^2*sw*(psq - t)*
    ...
    Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*gZlL*mm^2*sw*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
    Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll*gFZW*gWlN*gZlL*mm^2*sw*
