...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
   ...
   ((4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^8*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(-4*psq^3 + 3*psq^2*(s + 4*t) - 
       psq*(mm^2*s + s^2 + 9*s*t + 12*t^2) + 
       (s + t)*(mm^2*s + 2*t*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^6*
      (-8*psq^3 + 4*psq^2*(s + 6*t) + mm^2*s*(5*s + 8*t) + 
       4*t*(s^2 + 3*s*t + 2*t^2) - psq*(8*mm^2*s + s^2 + 16*s*t + 24*t^2))*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^4*s - 7*mm^2*(psq - t)*
        (psq - s - t) - psq*(psq^2 - 2*psq*t + t*(s + t)))*\[Mu]^(8 - 2*d)*
