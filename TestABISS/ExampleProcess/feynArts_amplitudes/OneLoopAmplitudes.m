...
{((I/16)*FermionChain[NonCommutative[DiracSpinor[-FourMomentum[Incoming, 2], 
      0]], I*EL*gAd*NonCommutative[DiracMatrix[Index[Lorentz, 3]], 
   ...
   FermionChain[NonCommutative[DiracSpinor[FourMomentum[Outgoing, 1], 0]], 
    ...
    NonCommutative[DiracSpinor[-FourMomentum[Outgoing, 2], 0]]]*
 ...
 ((I/16)*FermionChain[NonCommutative[DiracSpinor[-FourMomentum[Incoming, 2], 
      0]], I*EL*gWdu*NonCommutative[DiracMatrix[Index[Lorentz, 3]], 
      ChiralityProjector[-1]], NonCommutative[
   ...
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])/Pi^4, 
 ((I/16)*FermionChain[NonCommutative[DiracSpinor[-FourMomentum[Incoming, 2], 
      0]], I*EL*gZdL*NonCommutative[DiracMatrix[Index[Lorentz, 3]], 
