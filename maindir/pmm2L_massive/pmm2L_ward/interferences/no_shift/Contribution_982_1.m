...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*s*
     (bb*mm^2*(3*psq - 2*s - 3*t) + bb*psq*(psq - t) + 
      aa*psq*(-psq + s + t) + aa*mm^2*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d))/
    (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
     (aa*mm^2*(2*psq + s - 2*t) + aa*psq*(psq - 2*s - t) + 
      bb*psq*(-psq + t) + bb*mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) - (I*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
     mm^2*(-2*bb*mm^2*(psq - t) + 2*aa*mm^2*(psq + s - t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     SPList[SP[p2, q1]])/Pi^(2*d) + (I*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
     mm^2*(aa*s*(psq - t) + 2*bb*mm^2*(psq - 2*s - t) + bb*s*(psq + t) + 
   ...
   (I*4^(1 - d)*bb*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
