...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gHHZZ*gHll^2*mm^4*
   ...
   (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gHHZZ*gHll^2*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gHHZZ*gHll^2*mm^2*
