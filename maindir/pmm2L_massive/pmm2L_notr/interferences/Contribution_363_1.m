 ...
 ((2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (2^(3 + 2*d)*((-2 + d)*gZlL^2 - 2*d*gZlL*gZlR + (-2 + d)*gZlR^2)*Pi^(2*d)*
      ...
      (-2*d*gZlL*gZlR*(4*mm^2 + (-3 + d)*s) + (-2 + d)*gZlL^2*
        ...
        (2*mm^2 + 2*psq + (-3 + d)*s)) - 2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
      Pi^(2*d)*(4*psq^2 + 2*(-2 + d)*mm^2*s - 6*s^2 + 3*d*s^2 + 4*s*t + 
       4*t^2 - 2*psq*((-2 + d)*s + 4*t)) + (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
      ((-2 + d)*psq*s^2 + 2*mm^2*(2*psq^2 + (-2 + d)*s^2 - 4*psq*t + 2*s*t + 
         2*t^2)) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*((-2 + d)*psq*s^2 + 
   ...
   (Pi^(4*d)*s^2) + (EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(-4*psq^2 + 2*(-6 + d)*psq*s + 5*s^2 - 
       2*d*s*(mm^2 + s) + 8*psq*t - 4*s*t - 4*t^2) + 
     (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(4*psq^2 + 2*mm^2*s + 10*psq*s - 5*s^2 + 
       2*d*s^2 - 8*psq*t + 4*s*t + 4*t^2) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
      (4*psq^2 + 2*mm^2*s + 10*psq*s - 5*s^2 + 2*d*s^2 - 8*psq*t + 4*s*t + 
       4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/((2*Pi)^(4*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    ((-2 + d)*gZlL^2*(8*psq^2 - 19*psq*s + 2*s^2 - d*s^2 + 
       2*mm^2*(psq - 2*s - t) - 10*psq*t + 3*s*t + 2*t^2) + 
     (-2 + d)*gZlR^2*(8*psq^2 - 19*psq*s + 2*s^2 - d*s^2 + 
       2*mm^2*(psq - 2*s - t) - 10*psq*t + 3*s*t + 2*t^2) - 
     2*d*gZlL*gZlR*(6*psq^2 + 2*s^2 - d*s^2 + 
       mm^2*(4*psq + (-14 + d)*s - 4*t) + 3*s*t + 2*t^2 - 
       psq*((9 + d)*s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   ((2*Pi)^(2*d)*s^2) - ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*(2*psq^2 + 10*s^2 - 2*d*s^2 + 
     2*mm^2*(psq + (-4 + d)*s - t) + 5*s*t + 2*t^2 - psq*((3 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    ((-2 + d)*gZlL^2*(8*psq^2 - 9*psq*s - s^2 + 2*mm^2*(psq - s - t) - 
       10*psq*t + 3*s*t + 2*t^2) + (-2 + d)*gZlR^2*(8*psq^2 - 9*psq*s - s^2 + 
       2*mm^2*(psq - s - t) - 10*psq*t + 3*s*t + 2*t^2) - 
     2*d*gZlL*gZlR*(6*psq^2 - s^2 + mm^2*(4*psq + (-10 + d)*s - 4*t) + 
       3*s*t + 2*t^2 - psq*(s + d*s + 8*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (-((-2 + d)*gZlL^2*(4*psq^2 + 11*psq*s - s^2 + d*s^2 + 
        2*mm^2*(psq + s - t) - 2*psq*t - s*t - 2*t^2)) - 
     (-2 + d)*gZlR^2*(4*psq^2 + 11*psq*s - s^2 + d*s^2 + 
       2*mm^2*(psq + s - t) - 2*psq*t - s*t - 2*t^2) - 
     2*d*gZlL*gZlR*(-2*psq^2 - (3 + d)*psq*s + s^2 - d*s^2 + s*t + 2*t^2 + 
  ...
  ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
   ...
   ((2*Pi)^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    ((-2 + d)*gZlL^2*(2*Pi)^(4*d)*(4*psq^2 + 2*s^2 + psq*(s - 2*t) + 
       2*mm^2*(psq - t) - s*t - 2*t^2) + (-2 + d)*gZlR^2*(2*Pi)^(4*d)*
      (4*psq^2 + 2*s^2 + psq*(s - 2*t) + 2*mm^2*(psq - t) - s*t - 2*t^2) + 
     2^(1 + 4*d)*d*gZlL*gZlR*Pi^(4*d)*(-2*psq^2 - (-5 + d)*psq*s - 2*s^2 + 
       s*t + 2*t^2 + mm^2*(-4*psq + (-6 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/((2*Pi)^(6*d)*s^2) - 
  (2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(-4*psq^2 - 2*(-4 + d)*mm^2*s + 
       2*(-4 + d)*psq*s + 4*s^2 - d*s^2 + 8*psq*t - 4*s*t - 4*t^2) + 
     (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(4*psq^2 + (-4 + d)*s^2 - 8*psq*t + 4*s*t + 
       4*t^2) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(4*psq^2 + (-4 + d)*s^2 - 
       8*psq*t + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/
   (Pi^(4*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*(2*mm^2 + 3*psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    ((2^(3 - 2*d)*((-2 + d)*gZlL^2 - 2*d*gZlL*gZlR + (-2 + d)*gZlR^2)*psq*s)/
      Pi^(2*d) + (s*(-2*d*gZlL*gZlR*(4*mm^2 + (-3 + d)*s) + 
        (-2 + d)*gZlL^2*(2*mm^2 + 2*psq + (-3 + d)*s) + 
        (-2 + d)*gZlR^2*(2*mm^2 + 2*psq + (-3 + d)*s)))/(2*Pi)^(2*d) - 
     (2^(1 - 2*d)*d*gZlL*gZlR*(-4*psq^2 - 2*(-4 + d)*mm^2*s + 
        2*(-4 + d)*psq*s + 4*s^2 - d*s^2 + 8*psq*t - 4*s*t - 4*t^2))/
      Pi^(2*d) - ((-2 + d)*gZlL^2*(4*psq^2 + (-4 + d)*s^2 - 8*psq*t + 4*s*t + 
        4*t^2))/(2*Pi)^(2*d) - ((-2 + d)*gZlR^2*(4*psq^2 + (-4 + d)*s^2 - 
        8*psq*t + 4*s*t + 4*t^2))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/s^2 - ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*(2*mm^2 + 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
   ...
   (Pi^(4*d)*s^2) + (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gHll*gHZZ*gZlL*gZlR*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (-2*(gZlL^2 + gZlR^2)*(2*psq - 5*s - 2*t) + 
     d*(gZlL^2*(2*psq - 5*s - 2*t) + gZlR^2*(2*psq - 5*s - 2*t) + 
       2*gZlL*gZlR*(-4*mm^2 + 2*psq + 5*s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t) + 
     d*(2*gZlL*gZlR*(4*mm^2 - 2*psq - s - 2*t) + gZlL^2*(-2*psq + s + 2*t) + 
       gZlR^2*(-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (-2*(gZlL^2 + gZlR^2)*(2*psq + 3*s - 2*t) + 
     d*(gZlL^2*(2*psq + 3*s - 2*t) + gZlR^2*(2*psq + 3*s - 2*t) + 
       2*gZlL*gZlR*(4*mm^2 - 6*psq - 3*s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t) + 
     d*(-2*gZlL*gZlR*(4*mm^2 - 6*psq + s + 2*t) + gZlL^2*(-2*psq + s + 2*t) + 
       gZlR^2*(-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (-14*(gZlL^2 + gZlR^2)*s + d*(2*gZlL*gZlR*(4*mm^2 - 4*psq - 7*s) + 
       7*gZlL^2*s + 7*gZlR^2*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
    (2*mm^2 + psq - 4*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    (-2*(gZlL^2 + gZlR^2)*(psq - t) + 
     d*(gZlL^2*(psq - t) + gZlR^2*(psq - t) + 2*gZlL*gZlR*
        (2*mm^2 - 3*psq + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*((-2 + d)*gZlL^2 - 2*d*gZlL*gZlR + 
     (-2 + d)*gZlR^2)*mm^2*(2*psq - 7*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
    (2*mm^2 - 5*psq - s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*(2*mm^2 - 5*psq + s + 3*t)*
  ...
  (3*2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*((-2 + d)*gZlL^2 - 
     2*d*gZlL*gZlR + (-2 + d)*gZlR^2)*mm^2*(psq + s - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*((-2 + d)*gZlL^2 - 2*d*gZlL*gZlR + 
     (-2 + d)*gZlR^2)*mm^2*(2*psq + 5*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*((-2 + d)*gZlL^2 - 2*d*gZlL*gZlR + 
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p1, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*
    gHZZ*(gZlL^2 + gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*
    gHZZ*(gZlL^2 + gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
