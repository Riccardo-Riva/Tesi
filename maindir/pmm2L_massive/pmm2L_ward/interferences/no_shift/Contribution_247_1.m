...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*(-4*gZlL*gZlR*mm^2 + 
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*(-4*gZlL*gZlR*mm^2 + 
      gZlL^2*(mm^2 + psq) + gZlR^2*(mm^2 + psq))*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*(psq - s - t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*(gZlL - gZlR)^2*mm^2*
