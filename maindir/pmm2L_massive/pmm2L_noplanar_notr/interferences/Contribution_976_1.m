...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*psq*
   ...
   (4^(1 - d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (-2*(-2 + d)*mm^2*psq + 2*(2 + d)*psq^2 - 9*(-2 + d)*psq*s - 4*s^2 + 
      2*d*s^2 - 16*psq*t + 8*s*t + 8*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*
     gWWA*mm^2*psq*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (s*(2*psq + (-4 + d)*s - 2*t) + (-2 + d)*mm^2*(psq - s - t))*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*psq*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*
     ...
     gWlN*gWNl*gWWA*mm^2*psq*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (s*(2*psq + 2*s - d*s - 2*t) + (-2 + d)*mm^2*(psq - t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*
     ...
     gWlN*gWNl*gWWA*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*
     (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFll^2*
     gWlN*gWNl*gWWA*mm^2*(4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*gWWA*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFll^2*gWlN*gWNl*
     ...
     gWlN*gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFll^2*
