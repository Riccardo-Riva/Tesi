...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*(aa - bb)*EL^5*gAl^3*gFll^2*mm^2*
   ...
   (I*4^(1 - d)*EL^5*gAl^3*gFll^2*mm^2*(-(bb*(-2 + d)*psq*(psq - t)) + 
   ...
   (I*(aa - bb)*EL^5*gAl^3*gFll^2*mm^2*(-((-2 + d)*psq^2) + 2*psq*s + 
   ...
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gFll^2*mm^2*(bb*(2*mm^2 - s - 2*t) + 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gFll^2*mm^2*((-2 + d)*psq - (-4 + d)*s - 
   ...
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gFll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[p3, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gFll^2*mm^2*
     (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
