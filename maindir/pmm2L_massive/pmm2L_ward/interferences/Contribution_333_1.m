...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*s*
    (bb*((-2 + d)*mm^4 - (2 + d)*psq^2 + 2*(1 + d)*psq*s + (2 + d)*psq*t - 
       2*s*(s + 2*t) - mm^2*(4*psq + 2*(-3 + d)*s + (-6 + d)*t)) + 
     aa*((-2 + d)*mm^4 + (2 + d)*psq^2 + (-8 + d)*psq*s - (2 + d)*psq*t + 
       2*s*(s + 2*t) + mm^2*(-2*(-4 + d)*psq - d*s - 6*t + d*t)))*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*
    (aa*(-4*(2 + d)*psq^2 - (-4 + 5*d)*s*(s + 2*t) + 
       mm^2*(-8*psq + 2*d*s + 8*t) + 2*psq*(5*d*s + 4*t + 2*d*t)) + 
     bb*(4*(2 + d)*psq^2 + 2*mm^2*(4*psq + (-4 + d)*s - 4*t) + 
       (-4 + 5*d)*s*(s + 2*t) - 2*psq*((-4 + 7*d)*s + 2*(2 + d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*
    (bb*(-2*(2 + d)*psq^2 + (-8 + 7*d)*psq*s + 2*(2 + d)*psq*t + 
       4*mm^2*(-psq + s + t) + s*(-2*d*s + 12*t - 7*d*t)) + 
     aa*(2*(2 + d)*psq^2 - 3*(-4 + 3*d)*psq*s + 
       2*mm^2*(2*psq + (-4 + d)*s - 2*t) - 2*(2 + d)*psq*t + 
       s*(2*d*s - 12*t + 7*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
    (-(bb*((-8 + d)*mm^4*(psq - t) + 2*s*(2*(-1 + d)*psq^2 + 
          (3 - 2*d)*psq*s - (-2 + d)*psq*t + s*(s + t)) + 
        mm^2*(-((-4 + d)*psq^2) + 2*s*((-7 + 2*d)*s + (-9 + d)*t) + 
          psq*((18 - 4*d)*s + (-4 + d)*t)))) + 
     aa*((-8 + d)*mm^4*(psq - t) + mm^2*(-((-4 + d)*psq^2) - 
         2*(-9 + d)*psq*s + (-6 + d)*s^2 + (-4 + d)*psq*t + 2*(-9 + d)*s*t) + 
       s*(2*(-2 + d)*psq^2 + 2*s*(s + t) - psq*((2 + d)*s + 2*(-2 + d)*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*
    (bb*(-2*(2 + d)*psq^2 + (-8 + 5*d)*psq*s + 2*(2 + d)*psq*t + 12*s*t + 
       4*mm^2*(-psq + s + t) - d*s*(s + 5*t)) + 
     aa*(2*(2 + d)*psq^2 - (-12 + 7*d)*psq*s + 
       2*mm^2*(2*psq + (-4 + d)*s - 2*t) - 2*(2 + d)*psq*t - 12*s*t + 
       d*s*(s + 5*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*
    (aa*(2*(2 + d)*psq^2 - 3*(-4 + 3*d)*psq*s + (-12 + 5*d)*s^2 + 
       4*mm^2*(psq - t) - 2*(2 + d)*psq*t + (-12 + 7*d)*s*t) + 
     bb*(-2*(2 + d)*psq^2 + (-8 + 7*d)*psq*s + (12 - 5*d)*s^2 + 
       2*(2 + d)*psq*t + (12 - 7*d)*s*t + mm^2*(-4*psq + 2*(-2 + d)*s + 
         4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
    (aa*((-8 + d)*mm^4*(psq - s - t) + 2*s*(-2*psq^2 + (-3 + d)*psq*s - 
         (-2 + d)*psq*t + s*t) + mm^2*(-((-4 + d)*psq^2) + (14 + d)*psq*s - 
         2*(2 + d)*s^2 + (-4 + d)*psq*t + 2*(-9 + d)*s*t)) + 
     bb*(-((-8 + d)*mm^4*(psq - s - t)) + mm^2*((-4 + d)*psq^2 + 
         (-14 + d)*psq*s - (-12 + d)*s^2 - (-4 + d)*psq*t - 2*(-9 + d)*s*t) + 
       s*(-2*(-2 + d)*psq^2 - 2*s*t + (-2 + d)*psq*(s + 2*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*
    (bb*(-2*(2 + d)*psq^2 + (-8 + 5*d)*psq*s - 4*(-3 + d)*s^2 + 
       2*(2 + d)*psq*t + (12 - 5*d)*s*t + mm^2*(-4*psq + 2*(-2 + d)*s + 
         4*t)) + aa*(2*(2 + d)*psq^2 + 4*mm^2*(psq - t) - 
       psq*((-12 + 7*d)*s + 2*(2 + d)*t) + s*(4*(-3 + d)*s + (-12 + 5*d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*s*
    (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*s*
    ...
    (bb*(2*(-2 + d)*mm^2 - 4*psq - (-4 + d)*(s + 2*t)) + 
     aa*(2*(-2 + d)*mm^2 - 4*(-3 + d)*psq + (-4 + d)*(s + 2*t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*s*
    ...
    SPList[SP[q1, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*s*
    (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + 3*d)*EL^5*
    gAl^3*gXll^2*mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(4*(-4 + 3*d)*psq + (4 - 5*d)*s + 
     4*(4 - 3*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   (2*Pi)^(2*d) + (I*EL^5*gAl^3*gXll^2*mm^2*
    (aa*(-((-4 + d)*mm^4) - 4*psq*s + 8*s*(s + t) + 
       mm^2*((-16 + d)*psq + d*s + 12*t) + d*(-2*psq^2 - 4*s*(s + t) + 
         psq*(5*s + 2*t))) + bb*((-4 + d)*mm^4 + 28*psq*s + 
       mm^2*(16*psq - 5*d*psq - 24*s + 9*d*s - 12*t) - 8*s*(s + t) + 
       d*(6*psq^2 + 4*s*(s + t) - psq*(15*s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(8*(-2 + d)*psq + (4 - 3*d)*s - 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*(-((-4 + d)*mm^4) + 2*d*psq^2 + 12*psq*s - 
       5*d*psq*s + mm^2*((8 + d)*psq + (-12 + d)*s - 12*t) - 2*d*psq*t - 
       8*s*t + 4*d*s*t) + aa*((-4 + d)*mm^4 + 4*s*(3*psq + 2*t) + 
       mm^2*(-8*psq - 5*d*psq - 12*s + 9*d*s + 12*t) + 
       d*(2*psq^2 - 5*psq*s + 2*psq*t - 4*s*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(8*(-2 + d)*psq + (12 - 5*d)*s - 
     8*(-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*d*EL^5*gAl^3*gXll^2*mm^4*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*((-8 + 6*d)*psq^2 + (-4 + 3*d)*s*(s + 2*t) + 
       psq*(20*s - 11*d*s + 8*t - 6*d*t) - 4*mm^2*((-6 + d)*psq + 5*s - d*s + 
         6*t - d*t)) + aa*((8 - 6*d)*psq^2 - (-4 + 3*d)*s*(s + 2*t) + 
       4*mm^2*((-6 + d)*psq + s + 6*t - d*t) + 
       psq*(-4*s + 7*d*s - 8*t + 6*d*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(-4 + d)*psq*(psq - t) - 
     aa*(-4 + d)*psq*(psq - s - t) + bb*mm^2*(-((4 + d)*psq) + 4*s + 
       (4 + d)*t) + aa*mm^2*((4 + d)*psq - 4*t - d*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*d*EL^5*gAl^3*gXll^2*mm^4*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*((-4 + 3*d)*psq - 2*(-2 + d)*s + 
     (4 - 3*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/
   (2*Pi)^(2*d) + (I*EL^5*gAl^3*gXll^2*mm^2*
    (bb*(-2*(2 + d)*psq^2 - 4*(-3 + d)*s*(s + t) + 
       psq*((-20 + 9*d)*s + 4*t) + mm^2*(6*psq - 3*(-2 + d)*s + 
         2*(-3 + d)*t)) + aa*(4*psq^2 + psq*(12*s - 5*d*s - 4*t) + 
       4*(-3 + d)*s*(s + t) + mm^2*(2*(-3 + d)*psq + 2*s - d*s + 6*t - 
         2*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*
    (4*(-2 + d)*psq + (8 - 3*d)*s - 4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*(-4 + 3*d)*EL^5*gAl^3*gXll^2*mm^4*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*
    (bb*((-4 + d)*mm^4 - 4*(psq - (-3 + d)*s)*(psq - t) + 
     ...
     aa*((-4 + d)*mm^4 + 2*(-2 + d)*psq^2 - 4*psq*(s - t) - 4*(-3 + d)*s*t + 
       mm^2*(-5*(-2 + d)*psq + 4*(-2 + d)*s + 2*(-3 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*((4 - 3*d)*psq^2 + 6*(-2 + d)*psq*s - 
       2*(-2 + d)*s^2 + (-6 + d)*mm^2*(2*psq - s - 2*t) + (-4 + 3*d)*psq*t + 
       (12 - 5*d)*s*t) + bb*((-4 + 3*d)*psq^2 + (20 - 8*d)*psq*s + 
       2*(-2 + d)*s^2 + (4 - 3*d)*psq*t + (-12 + 5*d)*s*t + 
       mm^2*(-2*(-6 + d)*psq + (-14 + 3*d)*s + 2*(-6 + d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I/2)*EL^5*gAl^3*gXll^2*mm^2*
   ...
   SPList[SP[p1, p3], SP[q1, q1]] - I*EL^5*gAl^3*gXll^2*mm^2*
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*(psq - s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*
    (bb*((-4 + d)*mm^4 - 2*(2*psq - (-3 + d)*s)*(psq - t) + 
     ...
     aa*((-4 + d)*mm^4 + 2*(-2 + d)*psq^2 - 2*(-3 + d)*s*t + 
       psq*(-((-2 + d)*s) + 4*t) + mm^2*((6 - 4*d)*psq + (-8 + 3*d)*s + 
         (-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(2*s + d*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*((4 - 3*d)*psq^2 + 4*(-2 + d)*psq*s - 
       (-2 + d)*s^2 + (-6 + d)*mm^2*(2*psq - s - 2*t) + (-4 + 3*d)*psq*t + 
  ...
  (I/2)*EL^5*gAl^3*gXll^2*mm^2*
   ((2^(1 - 2*d)*(aa + bb)*(-4 + d)*(mm^2 - psq)*s)/Pi^(2*d) - 
    ...
    (2*aa*(-2 + d)*mm^2*(2*psq - s - 2*t) - aa*(-4 + d)*s*(psq - t) - 
      bb*(-4 + d)*s*(psq + t) - 4*bb*mm^2*((-2 + d)*psq - (-3 + d)*s - 
        (-2 + d)*t))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, q2], SP[q1, q1]] - I*EL^5*gAl^3*gXll^2*mm^2*
   (((aa + bb)*(-4 + d)*(mm^2 - psq)*s)/(2*Pi)^(2*d) + 
    (bb*(-4 + d)*psq*(psq - t) - aa*(-4 + d)*psq*(psq - s - t) + 
      bb*mm^2*(-((4 + d)*psq) + 4*s + (4 + d)*t) + 
      aa*mm^2*((4 + d)*psq - 4*t - d*(s + t)))/(4^d*Pi^(2*d)))*
  ...
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*((-4 + 3*d)*psq + 4*t - d*(s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*(-4*psq^2 - 4*(-3 + d)*s*t + 
       psq*((-8 + 3*d)*s + 4*t) + mm^2*(-2*(-3 + d)*psq + (-4 + d)*s + 
         2*(-3 + d)*t)) + aa*(-2*(-2 + d)*psq^2 + psq*(d*s - 4*t) + 
       4*(-3 + d)*s*t + mm^2*((-6 + 4*d)*psq + 12*s - 5*d*s + 6*t - 2*d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(4*(-2 + d)*psq + 8*t - d*(s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(-2*s + d*(-psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gXll^2*mm^2*
    (bb*((-4 + 3*d)*psq^2 - (-6 + d)*mm^2*(2*psq - s - 2*t) + 
   ...
   ((2^(1 - 2*d)*(aa + bb)*(-4 + d)*(mm^2 - psq)*s)/Pi^(2*d) - 
    ...
    (2*bb*(-2 + d)*mm^2*(2*psq - s - 2*t) - aa*(-4 + d)*s*(-3*psq + s + t) + 
      bb*(-4 + d)*s*(-psq + s + t) + 4*aa*mm^2*(-((-2 + d)*psq) + s + 
        (-2 + d)*t))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p2, p3], SP[q1, q1]] - I*EL^5*gAl^3*gXll^2*mm^2*
   (((aa + bb)*(-4 + d)*(mm^2 - psq)*s)/(2*Pi)^(2*d) + 
    (bb*(-4 + d)*psq*(psq - t) - aa*(-4 + d)*psq*(psq - s - t) + 
      bb*mm^2*(-((4 + d)*psq) + 4*s + (4 + d)*t) + 
      aa*mm^2*((4 + d)*psq - 4*t - d*(s + t)))/(4^d*Pi^(2*d)))*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*(-4*psq^2 + (-2 + d)*psq*s + 4*psq*t - 
       2*(-3 + d)*s*t + mm^2*(-((-2 + d)*psq) + (-4 + d)*s + (-2 + d)*t)) - 
     aa*(2*(-2 + d)*psq^2 - 2*(-3 + d)*s*t + psq*(-2*(-3 + d)*s + 4*t) + 
       mm^2*((2 - 3*d)*psq + 4*(-3 + d)*s + (-2 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
    (aa*(-((-4 + d)*psq^2) - (-2 + d)*psq*s + (-4 + d)*psq*t - 2*s*t + 
       mm^2*((-8 + d)*psq + (4 + d)*s - (-8 + d)*t)) + 
     bb*((-4 + d)*psq^2 - (-8 + d)*mm^2*(psq - s - t) + 2*s*t - 
       psq*((-2 + d)*s + (-4 + d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(bb*s*(5*psq - 2*s - 5*t) + 
     aa*mm^2*(2*psq - 3*s - 2*t) + bb*mm^2*(-2*psq + s + 2*t) + 
     aa*s*(-3*psq + 2*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p3, q1]])/Pi^(2*d) - (I*EL^5*gAl^3*gXll^2*mm^2*
    (-(aa*(-4 + d)*(psq + 2*s)*(psq - t)) + 
     2*aa*mm^2*((-6 + d)*psq + 2*s - (-6 + d)*t) + 
     bb*mm^2*(-2*(-6 + d)*psq + (-8 + d)*s + 2*(-6 + d)*t) + 
     bb*(-4 + d)*(psq^2 + psq*(s - t) - 2*s*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*s*(aa*(2*mm^2 - psq - t) + 
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(-2*s + d*(-psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*((-4 + 3*d)*psq^2 + (12 - 5*d)*psq*s + 
       2*(-3 + d)*s^2 - (-6 + d)*mm^2*(2*psq - s - 2*t) + (4 - 3*d)*psq*t + 
       (-8 + 3*d)*s*t) + aa*((4 - 3*d)*psq^2 + (-4 + 3*d)*psq*(s + t) + 
       s*(-2*(-3 + d)*s + (8 - 3*d)*t) + mm^2*(2*(-6 + d)*psq + (-2 + d)*s - 
         2*(-6 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*s*
  ...
  (I/2)*EL^5*gAl^3*gXll^2*mm^2*
   ((2^(1 - 2*d)*(aa + bb)*(-4 + d)*(mm^2 - psq)*s)/Pi^(2*d) - 
    ...
    (2*bb*(-2 + d)*mm^2*(2*psq - s - 2*t) - aa*(-4 + d)*s*(-3*psq + s + t) + 
      bb*(-4 + d)*s*(-psq + s + t) + 4*aa*mm^2*(-((-2 + d)*psq) + s + 
        (-2 + d)*t))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p2, q2], SP[q1, q1]] - I*EL^5*gAl^3*gXll^2*mm^2*
   (((aa + bb)*(-4 + d)*(mm^2 - psq)*s)/(2*Pi)^(2*d) + 
    (bb*(-4 + d)*psq*(psq - t) - aa*(-4 + d)*psq*(psq - s - t) + 
      bb*mm^2*(-((4 + d)*psq) + 4*s + (4 + d)*t) + 
      aa*mm^2*((4 + d)*psq - 4*t - d*(s + t)))/(4^d*Pi^(2*d)))*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*s*(-2*psq + s + 2*t)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*((-4 + 3*d)*mm^2 + (8 - 5*d)*psq + 
       2*(-2 + d)*(s + t)) + aa*((-4 + d)*mm^2 + 4*(s + t) + 
       d*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p3, p3]])/(2*Pi)^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*((-4 + 3*d)*mm^2 + (8 - 5*d)*psq + 
       2*(-2 + d)*(s + t)) + aa*((-4 + d)*mm^2 + 4*(s + t) + 
       d*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
     bb*(2*mm^2 - 10*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
    (aa*((-12 + 5*d)*mm^2 + 8*psq - 3*d*psq + 4*t - 2*d*t) - 
     bb*((-4 + d)*mm^2 + d*psq + 4*t - 2*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*((-4 + d)*mm^2 + (8 - 3*d)*psq + 
       2*(-2 + d)*t) + aa*((-4 + 3*d)*mm^2 + 4*t - d*(psq + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p3, p3]])/
   (2*Pi)^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(bb*d*(mm^2 - psq) + 
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(3*psq - 2*s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(-3 + d)*(psq - s - t) + 
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*(-6*psq + d*(mm^2 + psq - 2*t) + 6*t) + 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*(-4 + d)*mm^2 + aa*(-2 + d)*psq + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*(-4 + d)*mm^2 + 2*aa*psq + 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*(-4 + d)*mm^2 + 2*aa*psq + 
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*
    gXll^2*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*(-2*psq + d*(mm^2 - t) + 2*t) + 
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
    (aa*(d*mm^2 + 2*psq - d*psq - 2*t) + 2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(-(bb*(-3 + d)*(psq - t)) + 
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(4*mm^2 - s - 4*t) + 
     bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*
    (-2*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gXll^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*
    gXll^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], 
    ...
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
     SP[q1, q1]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[q2, q2]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*
