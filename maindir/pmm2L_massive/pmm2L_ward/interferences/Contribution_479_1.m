...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
 ...
 ((I*(aa - bb)*EL^5*gAl*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(4^d*Pi^(2*d)) + 
  ((3*I)*(aa - bb)*EL^5*gAl*gFFAA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFFAA*gFFZ*(gZlL + gZlR)*
    mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/(4^d*Pi^(2*d)) + 
  ((3*I)*4^(-1 - d)*(aa - bb)*EL^5*gAl*gFFAA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gFFAA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gFFAA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*gFFAA*gFFZ*(gZlL + gZlR)*(psq - s - t)*
  ...
  (I*(aa - bb)*EL^5*gAl*gFFAA*gFFZ*(gZlL + gZlR)*(psq - t)*\[Mu]^(8 - 2*d)*
