...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*s^2*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  ((7*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA^3*s^2*(aa*(-mm^2 + s + t) - 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*s*
    (-3*psq + s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA^3*s^2*(aa*(2*mm^2 - psq - t) + 
     bb*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*s*(-3*psq + 2*s + 3*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA^3*s^2*(bb*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA^3*(mm^2 - psq)*s*
   ...
   Pi^(2*d) + ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   Pi^(2*d) - (I*EL^5*gAl^2*ggmgmA^3*s*(-(aa*(3*mm^2 + psq - 4*(s + t))) - 
     bb*(7*mm^2 - 11*psq + 4*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*(4*psq - s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/Pi^(2*d) + 
  (I*EL^5*gAl^2*ggmgmA^3*s*(aa*(7*mm^2 - 3*psq - 4*t) + 
     bb*(3*mm^2 - 7*psq + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*
    (4*psq - 3*s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
   (2*Pi)^(2*d) + ((3*I)*EL^5*gAl^2*ggmgmA^3*s*(bb*(mm^2 + psq - s - 2*t) + 
     aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA^3*s*(-(bb*(6*mm^2 - 8*psq + s + 2*t)) + 
     aa*(-6*mm^2 + 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl^2*ggmgmA^3*
    (-(aa*(-2*psq^2 + 4*psq*s + s^2 + 2*mm^2*(psq - 3*s - t) + 2*psq*t + 
        2*s*t)) + bb*(-2*psq^2 - 6*psq*s + s^2 + 2*mm^2*(psq + 2*s - t) + 
       2*psq*t + 2*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/
   Pi^(2*d) - (I*EL^5*gAl^2*ggmgmA^3*s*(aa*(psq - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p1, q1]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*gAl^2*ggmgmA^3*s*(bb*(psq - t) + aa*(-mm^2 + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^2*ggmgmA^3*s*(bb*(psq - t) + aa*(-mm^2 + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^2*ggmgmA^3*s*(aa*(2*mm^2 - psq - t) + bb*(mm^2 - 2*psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^2*ggmgmA^3*s*(bb*(psq - t) + aa*(-mm^2 + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA^3*s*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^2*ggmgmA^3*s*(bb*(mm^2 - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA^3*s*(aa*(4*mm^2 - 3*psq - t) + 
     bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
   Pi^(2*d) + (I*EL^5*gAl^2*ggmgmA^3*
    (bb*(-psq^2 + mm^2*(psq + s - t) + s*t + psq*(-2*s + t)) + 
     aa*(psq^2 - s*t - psq*(3*s + t) + mm^2*(-psq + 4*s + t)))*
  ...
  (I*4^(1 - d)*EL^5*gAl^2*ggmgmA^3*(aa*(mm^2 + psq - 2*(s + t)) + 
     bb*(3*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^2*ggmgmA^3*(-(bb*(mm^2 - 3*psq + 2*t)) + 
     aa*(-3*mm^2 + psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p2, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl^2*ggmgmA^3*
    (bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA^3*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl^2*ggmgmA^3*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^2*ggmgmA^3*(aa*(psq - s - t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*(2*psq - s - 2*t)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA^3*(-(bb*(mm^2 - 3*psq + 2*t)) + 
     aa*(-3*mm^2 + psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*ggmgmA^3*
    (aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA^3*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA^3*(bb*(mm^2 - psq - s) + 
     aa*(3*mm^2 - 3*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl^2*ggmgmA^3*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA^3*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA^3*(aa*(mm^2 - t) + bb*(-psq + t))*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*(-mm^2 + psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA^3*(aa*(psq - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^2*ggmgmA^3*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl^2*ggmgmA^3*
  ...
  (I*EL^5*gAl^2*ggmgmA^3*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*(mm^2 - psq)*
  ...
  (I*EL^5*gAl^2*ggmgmA^3*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
