...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*s*(mm^2 + psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d)) + 
  (2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*s*(mm^2 + psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*s*(mm^2 + psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*s*(mm^2 + psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*s*(mm^2 + psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*(mm^2 + psq + 2*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*(mm^2 + psq + 2*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*(mm^2 + psq + 2*s)*
  ...
  (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*(mm^2 + psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*(mm^2 + psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*(3*mm^2 - psq + 2*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*(mm^2 + psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*(mm^2 + psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*s*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*gFll^2*mm^2*\[Mu]^(8 - 2*d)*
