(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*(2*s + d*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
     (2*(-5 + 2*d)*s^2 - 3*(-7 + d)*s*t + 6*t^2)*SPList[SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
     (4*(-2 + d)*s^2 + 3*(-1 + d)*s*t + 6*t^2)*SPList[SP[p2, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*
     (gZlL + gZlR)*(s - (-3 + d)*t)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
