...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(mm^2 - 3*psq + s + 2*t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(-2*psq^3 - 2*psq^2*(s - 3*t) + 
      ...
      mm^2*(8*psq^2 + s^2 + 8*s*t + 7*t^2 - 3*psq*(2*s + 5*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*(2*psq^2 + 4*mm^2*s + 3*s^2 + 
      6*s*t + 2*t^2 - 2*psq*(5*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(2*psq^3 + mm^4*s - 
      3*psq^2*(s + 2*t) - (s + t)^2*(s + 2*t) + psq*(3*s^2 + 8*s*t + 6*t^2) + 
      mm^2*(-3*psq^2 + s^2 - 2*s*t - 3*t^2 + psq*(s + 6*t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*
     (3*psq^3 - 2*psq^2*(s + 4*t) + psq*t*(5*s + 7*t) - 
      t*(s^2 + 3*s*t + 2*t^2) + mm^2*(7*psq^2 - 11*psq*s + 4*s^2 - 14*psq*t + 
        11*s*t + 7*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq - t)*
     (2*psq^2 + mm^2*(psq - 2*s - t) - 4*psq*t + t*(s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(3*psq^2 - 2*mm^2*s + 2*s^2 + 4*s*t + 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(-4*psq^2 + 3*psq*s - s^2 + 
      mm^2*(psq + 3*s - t) + 7*psq*t - 2*s*t - 3*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(2*psq^2 + s^2 + 2*s*t + 2*t^2 - 
