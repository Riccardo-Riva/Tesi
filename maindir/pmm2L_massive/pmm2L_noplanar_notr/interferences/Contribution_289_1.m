...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*(gZlL + gZlR)*mm^2*sw*
     \[Mu]^(8 - 2*d))/Pi^(2*d) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*
     (gZlL + gZlR)*sw*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*(gZlL + gZlR)*sw*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*(gZlL + gZlR)*
     mm^2*sw*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*(gZlL + gZlR)*sw*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*(gZlL + gZlR)*sw*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*(gZlL + gZlR)*sw*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFZW*gWWA*
