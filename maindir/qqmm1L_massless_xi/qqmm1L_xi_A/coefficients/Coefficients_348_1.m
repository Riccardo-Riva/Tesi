...
{(I*2^(1 - d)*d*EL^6*gAl*gAu*(gZlL^3 + gZlL^2*gZlR + gZlL*gZlR^2 + gZlR^3)*
    (gZuL + gZuR)*s^2*\[Mu]^(4 - d))/((-4 + 4*d)*Pi^d*(mz^2 - s)^2) + 
  (I*2^(-2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(d*s + 2*t)*
  ...
  (I*2^(-2 - d)*EL^6*gAl*gAu*
    (gZlR^3*(gZuR*((8 - 6*d + d^2)*s^2 - 2*(-4 + d)^2*s*t - 4*t^2) + 
     ...
     gZlL*gZlR^2*(gZuR*((8 - 6*d + d^2)*s^2 + 2*(8 - 6*d + d^2)*s*t - 
         4*t^2) - gZuL*((16 - 14*d + 3*d^2)*s^2 + 2*(-2 + d)^2*s*t + 
         4*t^2)) + gZlL^2*gZlR*(gZuL*((8 - 6*d + d^2)*s^2 + 
         2*(8 - 6*d + d^2)*s*t - 4*t^2) - gZuR*((16 - 14*d + 3*d^2)*s^2 + 
         2*(-2 + d)^2*s*t + 4*t^2)))*\[Mu]^(4 - d))/(Pi^d*(mz^2 - s)^2), 0, 
