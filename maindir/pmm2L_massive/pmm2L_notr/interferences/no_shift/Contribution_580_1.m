...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((-3*4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlL*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/Pi^(2*d) - (3*4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
     gFll^2*gZlL*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
   (3*2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlL*mm^4*(-psq + s + t)*
   ...
   (3*2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlL*mm^4*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlL*mm^4*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*
     (-(gZlR*(mm^2 - 2*psq)*s) + gZlL*mm^2*(-4*psq + 5*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*
     (gZlR*mm^2*(-psq + t) + gZlR*psq*(-psq + 3*s + t) + 
      gZlL*mm^2*(-2*psq + 3*s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlL*mm^4*
     (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlL*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2*(2*psq - s - 2*t) + gZlR*psq*(psq - 2*s - t) + 
      gZlR*mm^2*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
     gFll^2*mm^2*(gZlL*mm^2 - gZlR*mm^2 + 2*gZlR*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlL*mm^4*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*
     (-(gZlR*(mm^2 - 2*psq)*s) + gZlL*mm^2*(4*psq + s - 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2*(2*psq + s - 2*t) + gZlR*mm^2*(psq - s - t) + 
      gZlR*psq*(psq + 2*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
     gFll^2*gZlL*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlL*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2 + gZlR*(psq - s))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
     gFll^2*gZlR*mm^2*(mm^2 - psq + 2*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*
     (4*gZlL*mm^2 + gZlR*(mm^2 - psq + 2*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2 + gZlR*(mm^2 + s))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 - gZlR*mm^2 + 
      2*gZlR*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2 - gZlR*mm^2 + 2*gZlR*psq)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*(-psq + s + t)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
     gFll^2*gZlR*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq + s)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 - gZlR*mm^2 + 
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     (mm^2 + psq - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
     gFll^2*gZlR*mm^2*(mm^2 - 3*psq + 2*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*mm^2 - psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
     gFll^2*gZlR*mm^2*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*psq - 3*s - 2*t)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     ...
     gFll^2*gZlR*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
     gFll^2*gZlR*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     (mm^2 - 3*psq + 2*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2 + psq - 2*t)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     ...
     gFll^2*gZlR*mm^2*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*mm^2 - psq - t)*
   ...
   (4^(3 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*(-psq + s + t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s) - (4^(3 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZlR*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
     gFll^2*gZlR*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*
