(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  ((4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-2 + d)*s^2 + 4*s*t + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-3 + d)*s^2 + s*t + 
      2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-7 + 2*d)*s^2 - s*t + 
      2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-4 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     ((-20 + d^2)*s^2 + 4*(-10 + d)*s*t + 4*(-6 + d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(s^2 + 3*s*t + 2*t^2)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-2 + d)*s^2 + 3*s*t + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(2*(-2 + d)*s^2 + 5*s*t + 
      2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*((-2 + d)*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     ((-4 + d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-6 + d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*t*(s + 2*t)*
   ...
   (3*4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     ((26 - 10*d + d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (3*4^(2 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) + 
   (2^(5 - 2*d)*(-3 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     ((42 - 15*d + d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(s + t)*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(6 - 5*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(s + 2*t)*
   ...
   (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*(d*s + 2*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*t*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     (2*s + (10 - 3*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(30 - 11*d + d^2)*EL^8*gAl^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
     ((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
     gWNl*gWWZ*gZlL*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*t*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*
     ...
     gWWZ*gZlL*((24 - 9*d + d^2)*s + 2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(22 - 8*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*
    ...
    (Pi^(2*d)*s) + (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*t*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (3*4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWZ*gZlL*\[Mu]^(8 - 2*d)*
