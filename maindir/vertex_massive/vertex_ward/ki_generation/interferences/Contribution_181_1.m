...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*
    ...
    SPList[SP[p1, q1]])/Pi^(2*d) + (2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*
    (-(aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 + psq) + 
        gZlR^2*(2*mm^2 + psq))) + bb*(-2*gZlL*gZlR*mm^2 + 
       gZlL^2*(mm^2 + 2*psq) + gZlR^2*(mm^2 + 2*psq)))*s^2*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*ggpgpA*ggpgpZ^2*(-(aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 + psq) + 
  ...
  (EL^5*ggpgpA*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 + 3*psq) + 
  ...
  (EL^5*ggpgpA*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2*(-4*psq + s) + 
  ...
  (EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) + (EL^5*ggpgpA*ggpgpZ^2*
