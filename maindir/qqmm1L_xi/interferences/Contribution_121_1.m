   ...
   ((I*2^(2 - d)*EL^6*gAl*gAu*(-(gZlR*gZuL^3*((8 - 6*d + d^2)*s^2 + 
     ...
     (mz^2*Pi^d*s*(-mz^2 + s)) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      (gZlR*gZuR^3*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*(-1 + d)*s^2 - 
           (8 - 5*d + d^2)*s*t - 2*t^2)) - gZlR*gZuL^3*(-(d^2*(2*Pi)^d*s^2) + 
  ...
  PropList[KiraPropagator[q1, mz], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*2^(1 - 2*d)*EL^6*gAl*gAu*(gZlR*gZuR^3*(-(d^2*(2*Pi)^d*s^2) + 
    ...
    (I*2^(3 - d)*EL^6*gAl*gAu*(gZlR*gZuL^3*(-((-4 + d)*s) + 2*t) + 
       ...
       gZlR*gZuR^3*((-2 + d)*s + 2*t))*\[Mu]^(4 - d)*SPList[SP[p3, q1]])/
     (Pi^d*(mz^2 - s)) + 
    (I*EL^6*gAl*gAu*(gZlR*gZuL^3*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
     ...
     ((2*Pi)^(2*d)*s*(-mz^2 + s)) - (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gAu*
      ((-4 + d)*gZlL*gZuL^3 - (-2 + d)*gZlR*gZuL^3 - (-2 + d)*gZlL*gZuR^3 + 
       (-4 + d)*gZlR*gZuR^3)*(s + t)*\[Mu]^(4 - d)*SPList[SP[p1, q1], 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*(gZlR*gZuR^3*(-(d^2*(2*Pi)^d*s^2) + 
     ...
     (mz^2*Pi^(2*d)*s*(-mz^2 + s)) + (I*4^(1 - d)*EL^6*gAl*gAu*
      ...
      SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s*(-mz^2 + s)) - 
    (I*4^(1 - d)*EL^6*gAl*gAu*(gZlR*gZuR^3*(-(d^2*(2*Pi)^d*s) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*(gZlR*gZuR^3*(-(d^2*(2*Pi)^d*s^2) + 
       ...
       gZlL*(gZuL^3*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*(-1 + d)*s^2 - 
           ...
           2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2))))*
      \[Mu]^(4 - d)*SPList[SP[p2, q1], SP[q1, q1]])/
     (mz^2*Pi^(2*d)*(mz^2 - s)*s) - (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu*
      (gZlL + gZlR)*(gZuL^3 + gZuR^3)*\[Mu]^(4 - d)*SPList[SP[p3, q1], 
