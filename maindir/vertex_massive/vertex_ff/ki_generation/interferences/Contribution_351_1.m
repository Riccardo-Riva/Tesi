...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
   ...
   (-((4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*psq*
       (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1]])/(Pi^(2*d)*s)) - 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*psq*(psq - t)*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*psq*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(-psq + s + t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(-psq + s + t)*
      (2*gZlR*psq*(-2*psq + s + t) + gZlL*mm^2*(-psq + s + t) + 
       gZlR*mm^2*(psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2 + gZlR*(mm^2 + 2*psq))*(psq - t)*(psq - s - t)*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(-psq + s + t)*
      (-2*gZlR*psq*s + gZlR*mm^2*(2*psq + s - 2*t) + 
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(-psq + s + t)*
      (gZlR*psq*(3*psq - 4*s - 3*t) + gZlR*mm^2*(3*psq + s - 3*t) + 
       gZlL*mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2*(psq - t) + 
       psq*(psq - s - t))*(-psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(psq - t)*
      (2*gZlR*psq*(-2*psq + s + t) + gZlL*mm^2*(-psq + s + t) + 
       gZlR*mm^2*(psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*(psq - s - t) - gZlR*(2*psq*(-2*psq + s + t) + 
         mm^2*(psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
     Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 + 
       gZlR*(mm^2 + 2*psq))*(psq - t)^2*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(3*psq - 2*s - 3*t)*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2*(psq - t) + 
       ...
       SP[q2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2 + gZlR*(mm^2 + 2*psq))*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
    (3*4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(-2*gZlR*psq*s + 
       gZlR*mm^2*(2*psq + s - 2*t) + gZlL*mm^2*(-2*psq + s + 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/Pi^(2*d) + 
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(gZlR*psq*(3*psq - 4*s - 3*t) + 
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2*(psq - t) + 
     ...
     Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*(gZlL + gZlR)*mm^4*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*
      gZlR*mm^2*(-psq + s + t)*(3*mm^2 - 5*psq + 2*(s + t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*(gZlL + gZlR)*mm^4*(-psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*mm^2 - 3*psq + s + t)*
      ...
      (gZlL + gZlR)*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (3*2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*(psq - t)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*(gZlL + gZlR)*mm^4*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*
      (gZlL*mm^2*s + gZlR*mm^2*(-3*psq + s + 3*t) + 
       gZlR*(psq - t)*(5*psq - 2*(s + t)))*\[Mu]^(8 - 2*d)*
