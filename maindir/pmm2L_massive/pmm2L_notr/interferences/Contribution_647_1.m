...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*psq*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s)) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*psq*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*
    (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagm*gFll*ggagmW*gWlN*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(-psq + s + t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*(psq - t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagm*gFll*ggagmW*gWlN*mm^2*\[Mu]^(8 - 2*d)*
