...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl^2*gXll^4*mm^6*(2*(-1 + d)*mm^4 + 
   ...
   (4^(1 - d)*EL^6*gAl^2*gXll^4*mm^6*(d*(mm^2 - 2*psq) + 6*psq - 2*s)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^2*gXll^4*mm^6*(-2*mm^2 + 2*psq + d*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^2*gXll^4*mm^4*(mm^4 - mm^2*(psq + 2*s) + 
      s*(-((-4 + d)*psq) + (-2 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
   (3*4^(2 - d)*EL^6*gAl^2*gXll^4*mm^6*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^2*gXll^4*mm^4*((-4 + d)*mm^2 - d*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*d*EL^6*gAl^2*gXll^4*mm^6*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^2*gXll^4*mm^4*(4*psq - d*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl^2*gXll^4*mm^4*((-12 + d)*mm^2 + d*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl^2*gXll^4*mm^4*((-4 + d)*mm^2 - 2*(-5 + d)*psq + 
   ...
   (2^(3 - 2*d)*d*EL^6*gAl^2*gXll^4*mm^4*\[Mu]^(8 - 2*d)*
