...
PropList[KiraPropagator[q1, mw], KiraPropagator[q2, mz], 
  ...
  (((-I)*4^(-1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     (aa*mm^2*(2*psq - s - t) + aa*s*(-3*psq + 2*s + t) + 
      bb*(-(psq*s) + s^2 + mm^2*t - s*t))*\[Mu]^(8 - 2*d))/(mz^2*Pi^(2*d)) + 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (bb*s*(5*s - 6*t) + bb*mm^2*(-4*psq + 2*s + 4*t) + 
      aa*s*(-12*psq + 11*s + 6*t) + aa*mm^2*(4*psq - 2*(s + 2*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2^(2*(1 + d))*mz^2*Pi^(2*d)) - 
   (I*4^(-1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (2*aa*mm^2*(psq - s - t) - 2*bb*mm^2*(psq - s - t) - 
      bb*s*(psq - 2*s + t) + aa*s*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3]])/(mz^2*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*aa*mm^4*(psq - t) - 
      2*bb*mm^4*(psq - 2*s - t) - aa*mm^2*(2*psq^2 + 5*psq*s + s^2 - 
        2*psq*t - 5*s*t) - bb*mm^2*(-2*psq^2 + 5*psq*s + s^2 + 2*psq*t + 
        5*s*t) + aa*s*(3*psq^2 + psq*(5*s - 3*t) - 2*s*(s + t)) + 
      bb*s*(3*psq^2 - 3*psq*(s - t) + 2*s*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(2^(2*(1 + d))*mz^2*Pi^(2*d)) - 
   (I*4^(-1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (2*aa*mm^2*(psq - t) - 2*bb*mm^2*(psq - t) + bb*s*(psq + s - t) + 
      aa*s*(-3*psq + 3*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
    (mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (bb*(2*mm^4*(-psq + s + t) + mm^2*(2*psq^2 + 3*psq*s - 6*s^2 - 2*psq*t - 
      ...
      aa*(2*mm^4*(psq + s - t) - s*(-9*psq^2 + 2*psq*s + 3*psq*t + 2*s*t) + 
        mm^2*(-2*psq^2 - 13*psq*s + 4*s^2 + 2*psq*t + 5*s*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2^(2*(1 + d))*mz^2*Pi^(2*d)) + 
   (I*4^(-1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     (aa*(mm^2 + 2*psq - 3*s - t) + bb*(mm^2 - 2*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, p3]])/(mz^2*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
     (bb*(-2*psq^2 + s*(mm^2 - s - 2*t) + 2*psq*(s + t)) + 
      aa*(2*psq^2 - 2*psq*(2*s + t) + s*(mm^2 + s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
     (aa*(-5*psq*s + 2*s^2 + mm^2*(4*psq - s - 2*t) - 2*psq*t + 4*s*t) + 
      bb*(-4*psq^2 + (mm^2 - 2*s)*(s + 2*t) + psq*(5*s + 2*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(2^(2*(1 + d))*mz^2*Pi^(2*d)) + 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     (aa*(mm^2 + 2*psq - 2*s - 2*t) + bb*(mm^2 - 2*psq + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(4^d*mz^2*Pi^(2*d)) + 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (bb*(2*mm^2 + s - 2*t) + aa*(2*mm^2 - 4*psq + 3*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/(mz^2*(2*Pi)^(2*d)) + 
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(2*mm^4 - 2*psq^2 - 11*mm^2*s + 13*psq*s - 4*s^2) + 
      bb*(6*mm^4 + 10*psq^2 - 9*psq*s + 4*s^2 + mm^2*(-16*psq + 7*s)))*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (bb*(2*mm^4 - 2*psq^2 - 11*mm^2*s + 13*psq*s - 4*s^2) + 
      aa*(6*mm^4 + 10*psq^2 - 9*psq*s + 4*s^2 + mm^2*(-16*psq + 7*s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (aa*(psq - 2*s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p3, p3]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     SPList[SP[p1, p2], SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (bb*(5*psq^2 - 7*psq*s + s^2 - 5*psq*t + 2*s*t + 
        5*mm^2*(-psq + s + t)) + aa*(-5*psq^2 + 5*mm^2*(psq - t) - 
        s*(s + 2*t) + psq*(2*s + 5*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (aa*(psq - 2*s - t) + bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     SPList[SP[p1, p3], SP[p1, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(3*mm^2 - psq - 4*s)*(2*psq - s - 2*t) + 
      bb*(4*mm^4 + 6*psq^2 + psq*(5*s - 2*t) - 4*s*(s + 2*t) + 
        mm^2*(-14*psq + 5*s + 6*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q2]])/(mz^2*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (aa*(2*mm^2 - 3*s - 2*t) + bb*(2*mm^2 - 4*psq - s + 2*t))*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(-5*psq^2 + 7*psq*s - 4*s^2 + mm^2*(5*psq - s - 5*t) + 5*psq*t - 
        6*s*t) + bb*(5*psq^2 - 14*psq*s + 4*s^2 - 5*psq*t + 6*s*t + 
        mm^2*(-5*psq + 8*s + 5*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[q2, q2]])/(mz^2*Pi^(2*d)) - 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - 2*s)*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(mz^2*Pi^(2*d)) - 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*mm^2 + 2*psq - 7*s)*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(mm^4 - 2*psq^2 + mm^2*(3*psq - 5*s - 3*t) + 4*s*t + psq*(s + t)) + 
      bb*(mm^4 + 4*psq^2 - 4*s*t - psq*(2*s + t) + 
        mm^2*(-7*psq + 6*s + 3*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, p3]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     SPList[SP[p1, q2], SP[p2, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 + 3*psq - 6*s)*
     (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (-(bb*(-psq^2 + mm^2*(psq + s - t) + psq*(-2*s + t) + s*(s + t))) + 
      aa*(-psq^2 + mm^2*(psq - t) + psq*(-s + t) + s*(s + t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/(mz^2*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq^2 - 13*psq*s + 
      6*s^2 + mm^2*(4*psq - s - 4*t) - 2*psq*t + 11*s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) + (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   ((3*I)*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(-3*psq^2 - psq*(s - 3*t) + 3*mm^2*(psq - t) + s*(s + t)) - 
      bb*(-3*psq^2 + mm^2*(3*psq - s - 3*t) + 3*psq*t + s*(s + t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/(mz^2*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (aa*(2*mm^2 - psq - s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, p3]])/(mz^2*Pi^(2*d)) + 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(4*aa*mm^4 + 
      bb*mm^2*(-4*psq + s + 4*t) - aa*mm^2*(4*psq + s + 4*t) + 
      2*bb*(psq^2 + psq*(2*s - t) - s*(s + 2*t)) + 
      2*aa*(psq^2 + psq*(-2*s + t) + s*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (-(bb*(3*mm^2 - psq - 4*s)*(2*psq - s - 2*t)) + 
      aa*(4*mm^4 + 2*psq^2 - 9*psq*s + 4*s^2 + 2*psq*t + 8*s*t - 
        mm^2*(2*psq + s + 6*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p2, q2]])/(mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(mm^2 - psq)*(aa*(psq - s - t) + bb*(-psq + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/(mz^2*Pi^(2*d)) + 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     SPList[SP[p2, p3], SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(-5*psq^2 + mm^2*(5*psq + 3*s - 5*t) - 2*s*(s + 3*t) + 
        psq*(3*s + 5*t)) + bb*(5*psq^2 - 5*psq*(2*s + t) + 2*s*(s + 3*t) + 
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     SPList[SP[p2, q1], SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
     (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(-psq^2 + mm^2*(psq - 2*s - t) + s*t + psq*(s + t)) + 
      bb*(psq^2 - psq*t - s*t + mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, p3]])/(mz^2*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq^2 - 11*psq*s + 
      5*s^2 + mm^2*(4*psq - 3*s - 4*t) - 2*psq*t + 11*s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(6*psq^2 - 13*psq*s + 6*s^2 + mm^2*(2*psq - 5*s - 2*t) - 6*psq*t + 
      ...
      SP[p3, q2]])/(mz^2*Pi^(2*d)) + (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(-3*psq^2 + psq*s + mm^2*(3*psq - 2*s - 3*t) + 3*psq*t + s*t) - 
      bb*(-3*psq^2 + 2*psq*s + 3*mm^2*(psq - s - t) + 3*psq*t + s*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/(mz^2*Pi^(2*d)) - 
   (I*(aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, p3]])/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*
     gFFZ*(gZlL + gZlR)*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, p3], SP[p3, q1]])/(mz^2*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
     (aa*(mm^2 + psq - s - 2*t) + bb*(mm^2 - 3*psq + s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q2]])/(mz^2*Pi^(2*d)) - 
   (I*(aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[q1, q1]])/(4^d*mz^2*Pi^(2*d)) - 
   (I*(aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[q1, q2]])/(4^d*mz^2*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     s*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[q2, q2]])/(mz^2*Pi^(2*d)) - 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
    (mz^2*Pi^(2*d)) - ((3*I)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
   ...
   ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
    ...
    (mz^2*(2*Pi)^(2*d)) + (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
     (aa*(-2*mm^2 + s + 2*t) - bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
   ...
   (I*(aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1], SP[q2, q2]])/(4^d*mz^2*Pi^(2*d)) - 
   (I*(aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2], SP[q2, q2]])/(4^d*mz^2*Pi^(2*d)) - 
   (I*(aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2], SP[q2, q2]])/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*
     gFFZ*(gZlL + gZlR)*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p2, q2]])/(mz^2*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/
    (mz^2*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p2], SP[p3, q2]])/(mz^2*Pi^(2*d)) + 
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(aa*(2*mm^2 - s - 2*t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
      SP[p1, q1]])/(mz^2*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*
   ...
   (I*4^(2 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(aa*(2*mm^2 + 6*psq - 7*s - 8*t) + 
   ...
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*mm^2 - 2*psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p3, p3]])/
    (4^d*mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(2*mm^2 - 14*psq + 7*s + 12*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(aa*(5*psq - 3*s - 5*t) + 
   ...
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*mm^2 - 2*psq + s)*
    ...
    (mz^2*(2*Pi)^(2*d)) - (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*4^(2 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(aa*(2*mm^2 - psq - t) + 
     ...
     SPList[SP[p1, p2], SP[p2, q1], SP[p3, p3]])/(4^d*mz^2*Pi^(2*d)) + 
   (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(aa*(14*mm^2 - 6*psq - s - 8*t) + 
   ...
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*mm^2 - 2*psq + s)*
    ...
    (4^d*mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(2*mm^2 + 10*psq - 5*s - 12*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, p3]])/
    (4^d*mz^2*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(aa*(6*psq - 5*s - 6*t) + 
      bb*(8*mm^2 - 14*psq + 5*s + 6*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q1], SP[q2, q2]])/(4^d*mz^2*Pi^(2*d)) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q2], SP[p1, q2]])/(mz^2*Pi^(2*d)) + 
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
    ...
    (4^d*mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(3*psq - 2*s - 3*t) + bb*(2*mm^2 - 5*psq + 2*s + 3*t))*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(aa*(2*mm^2 - psq - t) + 
      bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
      SP[p2, q1]])/(mz^2*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
      SP[p3, p3]])/(mz^2*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     SPList[SP[p1, p3], SP[p2, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
     ...
     SPList[SP[p1, p3], SP[p2, q2], SP[q2, q2]])/(mz^2*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)) + ((3*I)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - t)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2], SP[p3, p3]])/(mz^2*Pi^(2*d)) - 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   ((3*I)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
    ...
    (4^d*mz^2*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)) - 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
   ...
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(aa*(8*mm^2 - 2*psq - s - 6*t) + 
   ...
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
    ...
    (4^d*mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, q2], SP[p3, q2]])/(mz^2*Pi^(2*d)) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(4*mm^2 - s - 4*t) + bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)) + 
   (I*4^(1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
   ...
   ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p3, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   ((3*I)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
 ...
 PropList[KiraPropagator[q1, mw], KiraPropagator[q2, 0], 
  ...
  ((I*4^(-1 - d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*s*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p3, p3]])/(mz^2*Pi^(2*d)) + 
   (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(-2*aa*psq^2 + 2*bb*psq^2 + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     ...
     SPList[SP[p1, p3], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*
     (bb*(-5*psq^2 + 14*psq*s - 4*s^2 + mm^2*(5*psq - 8*s - 5*t) + 5*psq*t - 
        6*s*t) + aa*(5*psq^2 - 7*psq*s + 4*s^2 - 5*psq*t + 6*s*t + 
        mm^2*(-5*psq + s + 5*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*
     (gZlL + gZlR)*(mm^2 - 2*s)*(aa*(psq - s - t) + 
   ...
   ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
    ...
    (mz^2*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/
    (mz^2*(2*Pi)^(2*d)) + (I*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*s*
     (2*(aa + bb)*(mm^2 - psq) - (aa - bb)*(-2*psq + s + 2*t))*
