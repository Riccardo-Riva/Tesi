PropList[KiraPropagator[p1 - q1, mt], KiraPropagator[-p2 - q1, mt]]*
 (((3*I)*EL^6*gAl^2*gAu^2*(gZuL + gZuR)^2*mt^2*(-2*s^2 + d*s^2 + 4*s*t + 
     4*t^2))/((2*Pi)^d*s^2*(-mz^2 + s)) + 
  ((3*I)*EL^6*gAl^2*gAu^2*(gZuL^2*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + gZuR^2*(-8*s^2 + 6*d*s^2 - d^2*s^2 + 10*s*t - 
       2*d*s*t + 4*t^2) + 2*gZuL*gZuR*(4*s^2 - 4*d*s^2 + d^2*s^2 - 2*s*t + 
  ...
  ((3*I)*EL^6*gAl^2*gAu^2*((2^(1 - d)*(gZuL + gZuR)^2*
     ...
     (gZuL^2*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       gZuR^2*(10*s^2 - 6*d*s^2 + d^2*s^2 + 10*s*t - 2*d*s*t + 4*t^2) + 
       2*gZuL*gZuR*(-14*s^2 + 8*d*s^2 - d^2*s^2 - 2*s*t + 2*d*s*t + 4*t^2))/
  ...
  ((3*I)*EL^6*gAl^2*gAu^2*(gZuL + gZuR)^2*(-4*s^2 + d*s^2 + 4*s*t + 4*t^2)*
