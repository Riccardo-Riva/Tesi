 ...
 (((-I)*(aa + bb)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)^2*s*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
    (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
    (mm^2 - psq)*(aa*((-4 + d)*mm^2 + 6*psq - d*psq - 2*t) + 
     bb*(-2*psq + d*(-mm^2 + psq) + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
   ...
   Pi^(2*d) - (I*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*(bb*(2*mm^2 - psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
    (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(psq - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gFll^2*gZNL*mm^2*((-2 + d)*gZlL*mm^2 - 
     ...
     SP[p2, q2]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*
    mm^2*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(psq - s - t) + 
     aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2], SP[p3, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(psq - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
    (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - s - 2*t) + 
     aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - s - 2*t) + 
     aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(mm^2 - s - t) + 
     aa*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*
    mm^2*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(-4 + d)*mm^2 + 
     2*bb*psq + 2*aa*(psq - s - t) - bb*(-2 + d)*(s + t) + 
     aa*d*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(2*psq - s - 2*t)*
  ...
  (I*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(psq - t) + 
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(psq - s - t)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[q2, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(mm^2 - t) + aa*(-psq + t))*
