...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, 0], 
  ...
  (-((2^(-1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
      (bb*(mm^4*(-4*(-4 + 3*d)*psq + 3*(-2 + d)*s) + 
         ...
         psq*s*(4*(-1 + d)*psq + d*s) + mm^2*(4*(-10 + 9*d)*psq^2 + 
           (16 - 13*d)*psq*s + 2*d*s^2)))*\[Mu]^(8 - 2*d))/(mz^2*Pi^(2*d))) + 
   (EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
   ...
   (EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
   ...
   (EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
     (bb*((-14 + 9*d)*mm^4 - (-2 + d)*psq*s + mm^2*(-16*psq + 15*d*psq + 
          5*s - 4*d*s)) + aa*((4 - 3*d)*mm^4 + (-2 + d)*psq*s + 
        mm^2*(26*psq - 21*d*psq - 5*s + 4*d*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (2^(-1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
     (bb*(2*(-8 + 3*d)*mm^4 + mm^2*(10*(2 + d)*psq + (10 - 11*d)*s) + 
   ...
   (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/
    (mz^2*Pi^(2*d)) - (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (aa*((-3 + 2*d)*mm^4 + 2*(5 - 3*d)*psq*s + 
        mm^2*(-3*psq + 2*d*psq + 7*s - 4*d*s)) + 
      bb*((3 - 2*d)*mm^4 + (-7 + 4*d)*psq*s + mm^2*(3*psq - 2*d*psq - 10*s + 
          6*d*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
    (mz^2*Pi^(2*d)) + (4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*
     (gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p2, q1]])/(mz^2*Pi^(2*d)) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*
     gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
    (mz^2*Pi^(2*d)) - (2^(1 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl^2*gWWA*gWWZ*
     (gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)) - (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*
     (gZlL + gZlR)*(aa*(-6 + d)*mm^4 + aa*psq*((-6 + 4*d)*psq + 
        (8 - 5*d)*s) + bb*psq*(2*(-5 + d)*psq - (-2 + d)*s) + 
      aa*mm^2*(2*(-1 + 5*d)*psq + s - 2*d*s) + 
      bb*mm^2*((24 - 17*d)*psq + (-11 + 8*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(mz^2*Pi^(2*d)) - 
   (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(aa*(-6 + 4*d)*mm^4 + 
      2*aa*(5 - 3*d)*psq*s + bb*(-11 + 6*d)*psq*s + 
      aa*mm^2*(24*(-1 + d)*psq + (17 - 12*d)*s) - 
   ...
   (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(aa*(5 - 3*d)*psq*s + 
      2*bb*(-5 + 3*d)*psq*s + aa*mm^2*(12*(-1 + d)*psq + (13 - 9*d)*s) + 
      2*bb*mm^2*(-6*(-1 + d)*psq + (-4 + 3*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)) - 
   (4^(1 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    (mz^2*Pi^(2*d)) + (4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*
 ...
 PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
  ...
  ((2^(-1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
   ...
   (EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
     ...
     SPList[SP[p2, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
     (aa*((-4 + 3*d)*mm^4 - (-2 + d)*psq*s + mm^2*(-26*psq + 21*d*psq + 5*s - 
          4*d*s)) + bb*((14 - 9*d)*mm^4 + (-2 + d)*psq*s + 
        mm^2*(16*psq - 15*d*psq - 5*s + 4*d*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(mz^2*(2*Pi)^(2*d)) - 
   (2^(-1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
     (bb*(2*(-8 + 3*d)*mm^4 + mm^2*(10*(2 + d)*psq + (10 - 11*d)*s) + 
        4*psq*((-1 + d)*psq - 2*(-2 + d)*s)) + 
   ...
   (EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
     ...
     SPList[SP[q1, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*s*
     (aa*((5 - 3*d)*mm^4 + (5 - 3*d)*psq*s + mm^2*(-17*psq + 15*d*psq + 8*s - 
          6*d*s)) + bb*((5 - 3*d)*mm^4 + (-5 + 3*d)*psq*s + 
        mm^2*(7*psq - 9*d*psq - 8*s + 6*d*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/
    (mz^2*Pi^(2*d)) + (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)) + 
   (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (bb*((-3 + 2*d)*mm^4 + mm^2*(-15*psq + 14*d*psq - s) + psq*s) + 
      aa*((3 - 2*d)*mm^4 + (4 - 3*d)*psq*s + mm^2*(15*psq - 14*d*psq - 4*s + 
    ...
    (mz^2*Pi^(2*d)) - (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)) + 
   (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (bb*psq*((-6 + 4*d)*psq + s) + bb*mm^2*(2*(-9 + 8*d)*psq + 
        (11 - 8*d)*s) + aa*mm^2*(-2*(-9 + 8*d)*psq + (-4 + 3*d)*s) + 
      aa*psq*((6 - 4*d)*psq + (-8 + 5*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(2*bb*(5 - 3*d)*psq*s + 
      aa*(-5 + 3*d)*psq*s + 2*bb*mm^2*(6*(-1 + d)*psq + (4 - 3*d)*s) + 
      aa*mm^2*(-12*(-1 + d)*psq + (-13 + 9*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)) + 
   (4^(1 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
     (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    (mz^2*Pi^(2*d)) - (2^(1 - 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) - (2^(1 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl^2*gWWA*gWWZ*
     (gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)) + (EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (aa*(-2 + d)*mm^2 + bb*(-8 + 5*d)*mm^2 + aa*(8 - 5*d)*psq - 
      bb*(-2 + d)*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)) + (4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*
     gWWZ*(gZlL + gZlR)*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   ((aa + bb)*(-8 + 3*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 - psq)*s*
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (3*aa*mm^2 + bb*mm^2 - aa*psq - 3*bb*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)) + 
   (4^(1 - d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (bb*((6 - 4*d)*mm^2 + psq - d*psq) + 
      aa*((-1 + d)*mm^2 + 2*(-3 + 2*d)*psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
   (5*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)) - (4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWWA*gWWZ*
     (gZlL + gZlR)*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)) - 
   (4^(1 - d)*(-5 + 3*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)) + (4^(1 - d)*EL^5*gAl^2*gWWA*gWWZ*
     (gZlL + gZlR)*(aa*(7 - 4*d)*mm^2 + 2*bb*(-5 + 3*d)*mm^2 + 
      2*aa*(5 - 3*d)*psq + bb*(-7 + 4*d)*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/(mz^2*Pi^(2*d)) + 
   (2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)) - (4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*
   ...
   (2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*
     (gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)) - 
   (4^(1 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
     (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)) + (2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*
     gAl^2*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)) + 
   (4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA*gWWZ*(gZlL + gZlR)*
