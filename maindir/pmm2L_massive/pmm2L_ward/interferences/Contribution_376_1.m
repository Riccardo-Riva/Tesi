...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
 ...
 (((-I)*4^(-1 - d)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*(mm^2 - psq)*s*
  ...
  (I*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*
   ...
   Pi^(2*d) + (I*(aa - bb)*(-4 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*s*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*d*EL^5*gAl*gFAW*gFll*gWlN*gWWA*
    mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*d*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*
  ...
  (I*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/
   (4^d*Pi^(2*d)) + ((3*I)*(aa - bb)*(-4 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gFAW*gFll*gWlN*
