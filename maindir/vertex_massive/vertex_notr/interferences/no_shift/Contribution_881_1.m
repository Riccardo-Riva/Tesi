...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl^2*mm^2*(2*gZlL^2*gZlR^2*
     ...
     SPList[SP[p1, q2]])/Pi^(2*d) - (2^(1 - 4*d)*EL^6*gAl^2*mm^2*
    ...
    Pi^(4*d) + (2^(1 - 4*d)*EL^6*gAl^2*
     (-(4^(1 + d)*(10 - 7*d + d^2)*gZlL^3*gZlR*mm^2*Pi^(2*d)*s) - 
      4^(1 + d)*(10 - 7*d + d^2)*gZlL*gZlR^3*mm^2*Pi^(2*d)*s + 
      2^(1 + 2*d)*gZlL^2*gZlR^2*Pi^(2*d)*(2*(8 - 5*d + d^2)*mm^4 - 
