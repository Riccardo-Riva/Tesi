...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p2 + q1, mz], 
  ...
  (-((2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpAZ*ggpgpZ*psq*(-4*gZlL*gZlR*mm^2 + 
       gZlL^2*(mm^2 + psq) + gZlR^2*(mm^2 + psq))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/Pi^(2*d)) + 
   (2^(3 - 2*d)*(aa - bb)*EL^5*ggpgpAZ*ggpgpZ*gZlL*gZlR*mm^2*psq*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^5*ggpgpAZ*ggpgpZ*(bb*(gZlL - gZlR)^2*mm^2 - 
