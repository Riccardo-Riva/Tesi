...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (((-I)*EL^5*gAl*gHll*gHZZ*mm^2*s*
   ...
   (I*EL^5*gAl*gHll*gHZZ*mm^2*
     (aa*((-2 + d)*gZlL^2*(2*psq^2 + psq*(3*s - 2*t) + 
      ...
      bb*(-((-2 + d)*gZlL^2*(2*mm^2*(psq - t) + (2*psq + s)*(psq - s - t))) - 
        ...
        2*gZlL*gZlR*(4*s*(psq - t) - d*s*(-psq + s + t) + 
          d*mm^2*(4*psq - 2*(s + 2*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (2*Pi)^(2*d) + (I*EL^5*gAl*gHll*gHZZ*mm^2*
     (-2*aa*s*(4*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 3*psq + s + t) + 
        gZlR^2*(2*mm^2 - 3*psq + s + t)) + aa*d*(4*gZlL*gZlR*mm^2*(psq - t) + 
        gZlL^2*s*(2*mm^2 - 3*psq + s + t) + gZlR^2*s*(2*mm^2 - 3*psq + s + 
          t)) + 2*bb*s*(4*gZlL*gZlR*mm^2 + gZlL^2*(-psq + s + t) + 
   ...
   (I*EL^5*gAl*gHll*gHZZ*mm^2*
    ...
    (2*Pi)^(2*d) + (I*EL^5*gAl*gHll*gHZZ*mm^2*
     (2*aa*s*(4*gZlL*gZlR*mm^2 + gZlL^2*(psq - t) + gZlR^2*(psq - t)) + 
      aa*d*(4*gZlL*gZlR*mm^2*(psq - s - t) + gZlL^2*s*(-psq + t) + 
        gZlR^2*s*(-psq + t)) + 2*bb*s*(-4*gZlL*gZlR*mm^2 + 
        gZlL^2*(-2*mm^2 + psq + t) + gZlR^2*(-2*mm^2 + psq + t)) + 
      bb*d*(gZlL^2*s*(2*mm^2 - psq - t) + gZlR^2*s*(2*mm^2 - psq - t) + 
        4*gZlL*gZlR*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll*gHZZ*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHZZ*(gZlL^2 + gZlR^2)*
    ...
    Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*
     (-2*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll*
     gHZZ*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll*
     gHZZ*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll*
     gHZZ*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll*
     gHZZ*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p2, q1]])/Pi^(2*d)))/4
