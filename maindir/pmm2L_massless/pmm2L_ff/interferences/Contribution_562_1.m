...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((-3*4^(1 - d)*(-1 + d)*EL^6*gAu*gWWAZ*gWWZ*gZlL*gZlR*mm^2*t*
   ...
   (2^(1 - 4*d)*EL^6*gAu*gWWAZ*gWWZ*(3*2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
       (s^2 + 3*s*t + 2*t^2) + gZlL^2*(2*Pi)^(2*d)*(s + t)*
       (2*t*(s + 2*t) + mm^2*(-3*s + 7*t)) + gZlR^2*(2*Pi)^(2*d)*(s + t)*
       (2*t*(s + 2*t) + mm^2*(-3*s + 7*t)) + 
      d*(-3*2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(s^2 + 3*s*t + 2*t^2) - 
        gZlL^2*(2*Pi)^(2*d)*(s + t)*(-2*mm^2*(s - 2*t) + t*(s + t)) - 
        gZlR^2*(2*Pi)^(2*d)*(s + t)*(-2*mm^2*(s - 2*t) + t*(s + t))))*
   ...
   (2^(1 - 2*d)*EL^6*gAu*gWWAZ*gWWZ*t*(-6*(-1 + d)*gZlL*gZlR*mm^2*(s + 2*t) + 
      gZlL^2*(s + t)*((-3 + 2*d)*mm^2 - 2*s + (-4 + d)*t) + 
      gZlR^2*(s + t)*((-3 + 2*d)*mm^2 - 2*s + (-4 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
   (3*2^(3 - 2*d)*(-1 + d)*EL^6*gAu*gWWAZ*gWWZ*gZlL*gZlR*mm^2*t*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAu*gWWAZ*gWWZ*(-6*(-1 + d)*gZlL*gZlR*mm^2*s*(s + 2*t) + 
      gZlL^2*(s + t)*((-3 + 2*d)*mm^2*s - (-2 + d)*t*(s + 2*t)) + 
      gZlR^2*(s + t)*((-3 + 2*d)*mm^2*s - (-2 + d)*t*(s + 2*t)))*
