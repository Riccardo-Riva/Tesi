...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*mm^2*(psq^2 - 2*psq*t + 
       t*(s + t))*(2*(-2 + d)*psq^2 - 2*(-2 + d)*mm^2*(psq - 2*s - t) + 
       (-14 + 5*d)*s*(s + 2*t) - 2*psq*((-18 + 7*d)*s + (-2 + d)*t))*
      \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl^2*gAu*gWlN*gWNl*
      gWWA*(-2*(-2 + d)*psq^4 - 4*(-2 + d)*mm^4*s*(-2*psq + s + t) - 
       4*s*t*(s + t)*((-4 + d)*s + (-3 + d)*t) + 
       psq^3*((-30 + 7*d)*s + 6*(-2 + d)*t) + 
    ...
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*mm^2*((16 - 6*d)*psq^3 - 
       2*psq^2*((-4 + d)*s + 3*(8 - 3*d)*t) + 
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*
      ...
      (2*(-2 + d)*mm^4*s + 2*mm^2*((-2 + 4*d)*psq^2 + 6*s^2 + 
         (-6 + 7*d)*s*t + 2*(-1 + 2*d)*t^2 + psq*(-8*(-1 + d)*s + 4*t - 
           8*d*t)) + s*((16 - 6*d)*psq^2 - (s + t)*((-14 + 3*d)*s + 
           (-10 + 3*d)*t) + psq*(2*(-23 + 6*d)*s + (-26 + 9*d)*t)))*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*((36 - 10*d)*psq^3 + 
       ...
       2*psq*(2*s^2 + 2*(-13 + 3*d)*s*t + 3*(-14 + 3*d)*t^2) + 
       mm^2*((32 - 7*d)*psq^2 + 2*psq*((-14 + 5*d)*s + (-28 + 5*d)*t) - 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*
      (-4*(-6 + d)*psq^3 + psq*t*((26 + d)*s - 12*(-6 + d)*t) - 
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*
      (s*(2*(-8 + 3*d)*psq^2 + 4*psq*s + (26 - 9*d)*psq*t + 4*s*t + 
         ...
         4*(-4 + d)*s*t + 4*(1 - 2*d)*t^2 - 4*psq*((-4 + d)*s + 2*t - 
           4*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*
      ((-7 + 3*d)*psq^3 + (-2 + d)*mm^2*(psq - t)*(psq - s - t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*(-2*(-2 + d)*psq^3 + 
       ...
       psq^2*(-12*t + d*(s + 6*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWlN*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*
      (s*((22 - 4*d)*psq^2 + (-10 + d)*psq*s + (-40 + 7*d)*psq*t + 4*s*t - 
         ...
         2*(-7 + d)*s*t + 2*(-2 + d)*t^2 - 2*psq*((-7 + d)*s + 
           2*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*mm^2*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*mm^2*
     ...
     Pi^(2*d) + (4^(1 - d)*(-6 + d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*((-18 + 7*d)*psq^2 + 
       (s + t)*((-2 + d)*s + (-6 + d)*t) + 
       psq*((26 - 9*d)*s - 8*(-3 + d)*t) + mm^2*(-6*(-2 + d)*psq + 
         (-18 + 7*d)*s + 6*(-2 + d)*t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*(psq - t)*
      ...
      ((16 - 6*d)*psq^2 + 2*(-3 + d)*mm^2*(psq - t) + 
       t*((10 - 3*d)*s - 6*(-4 + d)*t) + 4*psq*(s + (-10 + 3*d)*t))*
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*(mm^2 - psq)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWlN*gWNl*gWWA*(psq - t)*
      ...
      gWNl*gWWA*(2*psq^2 + 2*mm^2*s + 3*s^2 + 6*s*t + 2*t^2 - 
       4*psq*(2*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
