...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^4*s*
  ...
  (EL^5*gAl*gHll^2*mm^2*(aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
       ...
       (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*(2*psq^2 - 2*psq*s - s^2 + 
         mm^2*(4*psq + s)) - 2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
        (psq*s*((-4 + d)*psq - (-2 + d)*s) + mm^4*((-4 + 5*d)*psq - d*s) + 
         mm^2*((-4 + d)*psq^2 - (-8 + d)*psq*s - 2*s^2))) - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^4*
    (bb*((-2 + d)*gZlL^2*(mm^2*(2*psq - s) + psq*s) + 
       (-2 + d)*gZlR^2*(mm^2*(2*psq - s) + psq*s) + 
       gZlL*gZlR*(-((-4 + d)*psq^2) - 4*(1 + d)*psq*s + d*s^2 + 
         mm^2*(-((-4 + d)*psq) + d*s))) + 
  ...
  (EL^5*gAl*gHll^2*mm^2*s*(aa*d*(2*Pi)^(2*d)*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(mm^2 + 3*psq) + (-2 + d)*gZlR^2*mm^2*
        (mm^2 + 3*psq) - 2*gZlL*gZlR*(-4*psq^2 + d*(mm^2 + psq)^2 + 
         2*mm^2*s)) + 2*bb*(-2*(-2 + d)*gZlL^2*mm^2*psq - 
  ...
  (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^4 + (-2 + d)*gZlR^2*mm^4 - 
       (4 + 3*d)*gZlL*gZlR*mm^2*psq) + bb*(-((-2 + d)*gZlL^2*mm^2*psq) - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(mm^2 + 3*psq + s)) - 
       ...
       2*gZlL*gZlR*(-2*(mm^2 - 3*psq)*s + d*mm^2*(mm^2 + 3*psq + s))) + 
     aa*((-2 + d)*gZlL^2*mm^2*(mm^2 + 3*psq + s) + (-2 + d)*gZlR^2*mm^2*
        (mm^2 + 3*psq + s) - 2*gZlL*gZlR*(4*mm^2*s + 
         d*(mm^4 + 3*mm^2*psq + psq*s))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
    (-(4^(1 + d)*(aa - bb)*gZlL*gZlR*Pi^(2*d)*(mm^2 + psq)*s) + 
     aa*(2*Pi)^(2*d)*((-2 + d)*gZlL^2*mm^2*(2*mm^2 + 2*psq - s) + 
       (-2 + d)*gZlR^2*mm^2*(2*mm^2 + 2*psq - s) + 
       gZlL*gZlR*(-((-4 + d)*mm^4) + 4*psq*s + 
         mm^2*((4 - 5*d)*psq + 2*(-2 + d)*s))) + 
     bb*(2*Pi)^(2*d)*(-((-2 + d)*gZlL^2*mm^2*(2*mm^2 + 2*psq - s)) - 
       (-2 + d)*gZlR^2*mm^2*(2*mm^2 + 2*psq - s) + 
       gZlL*gZlR*((-4 + d)*mm^4 + (-4 + d)*psq*s + 
         mm^2*(-4*psq + 5*d*psq + 4*s - 3*d*s))))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(4*aa*mm^2*psq - bb*psq*s + 
  ...
  (EL^5*gAl*gHll^2*mm^2*(bb*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
  ...
  (2^(3 - 2*d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[p2, q1]])/Pi^(2*d) + (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
    (aa*((-2 + d)*gZlL^2 + 4*gZlL*gZlR + (-2 + d)*gZlR^2)*mm^2 - 
     bb*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
       gZlL*gZlR*(-((-4 + d)*mm^2) + d*psq)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 - 
       2*d*gZlL*gZlR*(mm^2 + psq)) + bb*(-((-2 + d)*gZlL^2*mm^2) - 
