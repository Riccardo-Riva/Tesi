...
(PropList[KiraPropagator[q1, me], KiraPropagator[-p1 - p2 + q1, me]]*
  ((I*2^(2 - d)*EL^6*gAl*gAu*gZlL*gZlR*me^2*
     ...
     (gZlL*gZlR^2*(gZuR*(4*mmv^4 + 2*(-2 + d)^2*mm^2*s + 16*s^2 - 8*d*s^2 + 
      ...
      gZlR^3*(gZuL*(4*mmv^4 - 2*(8 - 6*d + d^2)*mm^2*s - 32*s^2 + 20*d*s^2 - 
        ...
        gZuR*(4*mmv^4 + 2*(-2 + d)^2*mm^2*s + 4*s^2 - 4*d*s^2 + d^2*s^2 + 
          16*s*t - 10*d*s*t + 2*d^2*s*t + 4*t^2 - 
          2*mmv^2*((16 - 11*d + 2*d^2)*s + 4*t))))*SPList[SP[p1, q1]])/
    (Pi^d*(mz^2 - s)^2*s) - (I*2^(1 - d)*EL^6*gAl*gAu*
     (gZlR^3*(gZuR*(-4*mmv^4 + 2*(8 - 6*d + d^2)*mm^2*s + 8*s^2 - 6*d*s^2 + 
          d^2*s^2 - 28*s*t + 14*d*s*t - 2*d^2*s*t - 4*t^2 + 
          2*mmv^2*((-2 + d)*s + 4*t)) + gZuL*(-4*mmv^4 - 2*(-2 + d)^2*mm^2*
           s + 8*s^2 - 6*d*s^2 + d^2*s^2 + 8*s*t - 10*d*s*t + 2*d^2*s*t - 
          4*t^2 + mmv^2*(-2*(-4 + d)*s + 8*t))) + 
      gZlL^3*(gZuL*(-4*mmv^4 + 2*(8 - 6*d + d^2)*mm^2*s + 8*s^2 - 6*d*s^2 + 
          d^2*s^2 - 28*s*t + 14*d*s*t - 2*d^2*s*t - 4*t^2 + 
          2*mmv^2*((-2 + d)*s + 4*t)) + gZuR*(-4*mmv^4 - 2*(-2 + d)^2*mm^2*
           s + 8*s^2 - 6*d*s^2 + d^2*s^2 + 8*s*t - 10*d*s*t + 2*d^2*s*t - 
          4*t^2 + mmv^2*(-2*(-4 + d)*s + 8*t))) + 
      gZlL^2*gZlR*(-(gZuR*(4*mmv^4 + 2*(-2 + d)^2*mm^2*s + 16*s^2 - 
      ...
      gZlL*gZlR^2*(-(gZuL*(4*mmv^4 + 2*(-2 + d)^2*mm^2*s + 16*s^2 - 
           14*d*s^2 + 3*d^2*s^2 + 4*s*t - 6*d*s*t + 2*d^2*s*t + 4*t^2 - 
           2*mmv^2*((10 - 9*d + 2*d^2)*s + 4*t))) + 
    ...
    (Pi^d*(mz^2 - s)^2*s) + (I*2^(2 - d)*(-3 + d)*EL^6*gAl*gAu*
     (gZlL^2 - gZlR^2)*(gZlL*(gZuR*(2*mmv^2 + (-4 + d)*s - 2*t) + 
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*((-2 + d)*gZlL*gZuL - 
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
    ...
    (Pi^d*(mz^2 - s)^2*s) + (I*2^(4 - d)*EL^6*gAl*gAu*
