...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^4*
      (mm^2 - psq)*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2]])/(Pi^(2*d)*s^2)) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^4*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*(mm^2 - psq)*
     (2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*
     mm^2*(mm^2*(18*psq + (-20 + d)*s - 18*t) + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^4*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     gHll^2*gWlN*gWNl*mm^2*((-8 + d)*mm^2 - (-4 + d)*psq)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
     ...
     gHll^2*gWlN*gWNl*mm^2*(-2*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*(psq - t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     gHll^2*gWlN*gWNl*mm^2*(2*psq + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
