...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   (((-I)*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*
      ...
      (bb*(-2*(-2 + d)*psq^2 + (-8 + d)*psq*s + 4*s^2 + 
         4*mm^2*(psq - s - t) + 2*(-2 + d)*psq*t + (4 + d)*s*t) + 
    ...
    (I*2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(2*aa*mm^4 - 
       aa*s*(-3*psq + s + t) + bb*s*(-psq + s + t) + aa*mm^2*(-6*psq + 4*t) + 
    ...
    (I*2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(2*bb*mm^4 + aa*s*(psq - t) + 
       ...
       2*bb*mm^2*(psq - 2*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*
      (bb*(-4 + d)*mm^4 + aa*mm^2*(7*psq - 4*s - 7*t) + aa*s*(-psq + t) - 
       bb*s*(psq + t) + bb*mm^2*(-((3 + d)*psq) + 6*s + 7*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(-(bb*(-4 + d)*psq*s) + 
       4*aa*mm^2*(psq - s - t) + bb*mm^2*(-4*psq + d*s + 4*t))*
    ...
    (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(2*aa*s*(-2*psq + s + 2*t) + 
       ...
       SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gXll^2*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*s*
     ...
     Pi^(2*d) + (I*4^(2 - d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(psq - s - t) + 
    ...
    (I*2^(3 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(2*aa*(2*psq - s - 2*t) + 
       bb*((-4 + d)*mm^2 - d*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
