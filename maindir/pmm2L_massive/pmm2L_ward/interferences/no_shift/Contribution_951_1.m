...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (I*4^(1 - d)*EL^5*gAl^3*
      (-(bb*(gZlL^2*((8 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
            ...
            mm^2*(-4*(-3 + d)*psq - (10 - 6*d + d^2)*s + (4 - 5*d + d^2)*
               t)) - 2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*
             s + mm^2*(-4*(-3 + d)*psq - (8 - 6*d + d^2)*s + 
              (8 - 5*d + d^2)*t)))) + 
       aa*(gZlL^2*((4 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
           mm^2*(-4*(-4 + d)*psq - (10 - 6*d + d^2)*s + (4 - 5*d + d^2)*t)) + 
         gZlR^2*((4 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
           mm^2*(-4*(-4 + d)*psq - (10 - 6*d + d^2)*s + (4 - 5*d + d^2)*t)) - 
         2*gZlL*gZlR*((8 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
           mm^2*(-4*(-2 + d)*psq - (8 - 6*d + d^2)*s + (8 - 5*d + d^2)*t))))*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*mm^2*(bb*(2*mm^2 - s - 2*t) + 
   ...
   (((-I)*2^(1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*mm^2*s*
