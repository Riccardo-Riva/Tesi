...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
 ...
 ((2^(-1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (s*(8*psq^2 + (-8 + 3*d)*psq*s - (-4 + d)*s^2 + 8*psq*t - 4*s*t - 
       4*t^2) + 2*mm^2*(2*psq^2 + (-2 + d)*s^2 + 2*psq*(s - 2*t) + 2*s*t + 
  ...
  ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (-8*psq^2 + 19*psq*s - 2*s^2 + d*s^2 + 10*psq*t - 3*s*t - 2*t^2 + 
   ...
   ((2*Pi)^(2*d)*s^2) - ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (-8*psq^2 + 9*psq*s + s^2 + 10*psq*t - 3*s*t - 2*t^2 + 
     2*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   ((2*Pi)^(2*d)*s^2) - ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (4*psq^2 + 11*psq*s - s^2 + d*s^2 + 2*mm^2*(psq + s - t) - 2*psq*t - 
     s*t - 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/((2*Pi)^(2*d)*s^2) + 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (Pi^(2*d)*s) + ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (-4*psq^2 + 2*mm^2*s + 10*psq*s + s^2 + 8*psq*t - 4*s*t - 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/((2*Pi)^(2*d)*s^2) - 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (2*mm^2 + 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (4^d*Pi^(2*d)*s) - (2^(-1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(4*psq^2 + (-4 + d)*s^2 - 8*psq*t + 4*s*t + 4*t^2)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
  ...
  (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(psq - 2*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(-4*psq + 5*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (7*2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(2*psq - 7*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (-2*psq + 5*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(2*mm^2 - 5*psq - s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (2*mm^2 - 5*psq + s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + ((-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*
    mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(2*mm^2 + psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*(4*psq + s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    gHll*gHWW*gWlN*gWNl*mm^2*(psq + s - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*(psq - t)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    ...
    gHll*gHWW*gWlN*gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q1]])/
   (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
    gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*
