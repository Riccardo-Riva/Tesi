...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll*gFZW*gWlN*gZNL*mm^2*sw*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll*gFZW*gWlN*gZNL*mm^2*sw*t*(s + t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll*gFZW*gWlN*gZNL*mm^2*sw*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll*gFZW*gWlN*gZNL*mm^2*
     sw*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll*gFZW*gWlN*gZNL*mm^2*sw*(s + t)*
