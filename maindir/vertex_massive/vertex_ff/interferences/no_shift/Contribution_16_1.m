...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWAZ*gZNL*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWAZ*gZNL*(2*psq - s - 2*t)*
