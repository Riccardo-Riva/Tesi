(PropList[KiraPropagator[q1, mz*Sqrt[GaugeXi[Q]]], 
  ...
  ((I*EL^6*gAl*gAu*gXll^2*mm^2*(gZlL*gZuL*(2^(2 + d)*mm^4*Pi^d - 
        d^2*(2*Pi)^d*s^2 + 2^(1 + d)*mm^2*Pi^d*((12 - 7*d + d^2)*s - 4*t) + 
        2^(1 + d)*Pi^d*(4*(-2 + d)*s^2 - (10 - 7*d + d^2)*s*t + 2*t^2)) + 
      gZlR*gZuR*(2^(2 + d)*mm^4*Pi^d - d^2*(2*Pi)^d*s^2 + 
        2^(1 + d)*mm^2*Pi^d*((12 - 7*d + d^2)*s - 4*t) + 
        2^(1 + d)*Pi^d*(4*(-2 + d)*s^2 - (10 - 7*d + d^2)*s*t + 2*t^2)) + 
