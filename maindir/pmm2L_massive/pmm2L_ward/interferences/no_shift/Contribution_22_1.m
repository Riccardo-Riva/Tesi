...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (((-I)*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)^2*s*
     \[Mu]^(8 - 2*d))/Pi^(2*d) - (I*4^(1 - d)*bb*EL^5*gAl*gXll^4*mm^6*
     (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*aa*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gXll^4*
     mm^6*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*s*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - s - t) + 
      ...
      SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(psq - t) + aa*(mm^2 - 2*psq + t))*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 + psq - s - 2*t) + 
