...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[q2, mw], 
  KiraPropagator[-p1 + q2, mw], KiraPropagator[-p1 + q2, mw], 
  KiraPropagator[-p1 + p2 + q2, 0], KiraPropagator[q1 + q2, 0]]*
 ((EL^5*gWlN^2*gWNl^2*gWWA*s*(-2*aa*mm^2*((-4 + d)*psq + 2*s) + 
     2*bb*psq*((-4 + d)*psq + 2*s) + bb*(-4 + d)*mm^2*(2*psq + (-2 + d)*s) - 
     aa*(-4 + d)*psq*(2*psq + (-2 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(2*Pi)^(2*d) + 
  (EL^5*gWlN^2*gWNl^2*gWWA*s*(-2*aa*mm^2*((-4 + d)*psq + 2*s) + 
     2*bb*psq*((-4 + d)*psq + 2*s) + bb*(-4 + d)*mm^2*(2*psq + (-2 + d)*s) - 
     aa*(-4 + d)*psq*(2*psq + (-2 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^5*gWlN^2*gWNl^2*gWWA*(2*aa*mm^2 - bb*(6 - 5*d + d^2)*mm^2 - 
     2*bb*psq + aa*(6 - 5*d + d^2)*psq)*s^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gWlN^2*gWNl^2*gWWA*
    (2*aa*mm^2 - bb*(6 - 5*d + d^2)*mm^2 - 2*bb*psq + aa*(6 - 5*d + d^2)*psq)*
    s^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  ((-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s*(2*bb*psq^2 + bb*mm^2*(2*psq - s) + 
     aa*psq*(-2*mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2*Pi)^(2*d) + ((-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s*
    (bb*(psq*(2*psq + (-1 + d)*s) + mm^2*(2*psq - d*s)) + 
     aa*(-2*psq^2 - 3*(-4 + d)*psq*s + (-3 + d)*s^2 + 
       mm^2*(-2*psq + s - d*s)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2*Pi)^(2*d) + ((-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s^2*
    (-(bb*(-1 + d)*(mm^2 - psq)) + aa*(-((-1 + d)*mm^2) + (11 - 3*d)*psq + 
  ...
  (2^(1 - 2*d)*EL^5*gWlN^2*gWNl^2*gWWA*
    (-(bb*((-4 + d)*mm^2*(2*psq + (-2 + d)*s) + 
        psq*(2*(-4 + d)*psq + (-2 + d)^2*s))) + 
     aa*(mm^2*(2*(-4 + d)*psq + (-2 + d)^2*s) + (-4 + d)*psq*
        (2*psq + (-8 + 3*d)*s)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^5*gWlN^2*gWNl^2*gWWA*(aa*(2*mm^2 + psq) - 
   ...
   Pi^(2*d) - (2^(1 - 2*d)*EL^5*gWlN^2*gWNl^2*gWWA*s*
    (aa*(-8 + d)*mm^2 + bb*(12 - 6*d + d^2)*mm^2 - bb*(-8 + d)*psq - 
  ...
  (2^(1 - 2*d)*EL^5*gWlN^2*gWNl^2*gWWA*
    (aa*((-4 + d)*psq*(2*psq + (-8 + 3*d)*s) + 
       mm^2*(2*(-4 + d)*psq + (8 - 4*d + d^2)*s)) - 
     bb*((-4 + d)*mm^2*(2*psq + (-2 + d)*s) + 
       psq*(2*(-4 + d)*psq + (8 - 4*d + d^2)*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gWlN^2*gWNl^2*gWWA*s*(-4*bb*(6 - 5*d + d^2)*mm^2 + 
     aa*(8 - 5*d + d^2)*mm^2 - bb*(8 - 5*d + d^2)*psq + 
     aa*(-3 + d)*(4*(-2 + d)*psq + (-4 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gWlN^2*gWNl^2*gWWA*s*
    (-(bb*((16 - 14*d + 3*d^2)*mm^2 + (8 - 4*d + d^2)*psq)) + 
     aa*((8 - 4*d + d^2)*mm^2 + (16 - 14*d + 3*d^2)*psq + 
       2*(12 - 7*d + d^2)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   Pi^(2*d) + (2^(1 - 2*d)*(-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*
    (-2*bb*(psq^2 + mm^2*(psq - s)) + 2*aa*psq*(mm^2 + psq - s) + 
     (aa - bb)*(mm^2 + psq)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gWlN^2*gWNl^2*gWWA*
    (bb*(-4 + d)*mm^2*(-2*psq + d*s) + bb*psq*(-2*(-4 + d)*psq + 
       (-8 + 9*d - 2*d^2)*s) + aa*mm^2*(2*(-4 + d)*psq + 
       (8 - 9*d + 2*d^2)*s) + aa*(-4 + d)*(2*psq^2 + (-18 + 5*d)*psq*s - 
       2*(-3 + d)*s^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   Pi^(2*d) + (2^(1 - 2*d)*(-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s*
    (bb*(-1 + d)*(mm^2 - psq) + aa*((-1 + d)*mm^2 - 11*psq + 3*d*psq + 3*s - 
       d*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/Pi^(2*d) - 
  ...
  (4^(1 - d)*aa*(12 - 7*d + d^2)*EL^5*gWlN^2*gWNl^2*gWWA*s^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*(-6*aa*psq - bb*d*psq + 
     aa*d*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p1, q2]])/Pi^(2*d) - (4^(2 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
    (aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(aa*(-8 + d)*mm^2 + 
     bb*(12 - 6*d + d^2)*mm^2 - bb*(-8 + d)*psq - aa*(12 - 6*d + d^2)*psq)*
  ...
  (4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(aa*(-2 + d)^2*mm^2 - 
     bb*(-2 + d)^2*psq + 2*aa*(12 - 7*d + d^2)*psq)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(aa*(4 - 5*d + d^2)*mm^2 - 
     ...
     2*aa*(-3 + d)*((-2 + d)*psq + (-4 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(-(bb*(-2 + d)^2*(mm^2 + psq)) + 
     aa*((-2 + d)^2*mm^2 + (-2 + d)^2*psq + 2*(12 - 7*d + d^2)*s))*
