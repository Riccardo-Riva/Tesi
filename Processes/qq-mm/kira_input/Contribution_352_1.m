...
((3*I)*EL^6*gAl*gAu*(gZlL + gZlR)*(gZuL^3 + gZuL^2*gZuR + gZuL*gZuR^2 + 
    gZuR^3)*(2*mm^2 - 2*mmv^2 + s)*userIntegral[A6, {mc}, -2, 1, 1, 0])/
  ((2*Pi)^d*(mz^2 - s)^2*s) + (((3*I)/2)*EL^6*gAl*gAu*(gZuL^2 + gZuR^2)*
   ((2^(1 - d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
    ...
    (gZlR*gZuL*(4*mm^2 + 2*(-5 + d)*mmv^2 + 4*s - d*s + 6*t - 2*d*t) + 
     ...
     (2*Pi)^d)*userIntegral[A6, {mc}, -1, 0, 1, 0])/((mz^2 - s)^2*s) - 
 ((3*I)*2^(-1 - 2*d)*EL^6*gAl*gAu*(gZuL^2 + gZuR^2)*
   ...
   userIntegral[A6, {mc}, -1, 1, 0, 0])/(Pi^(2*d)*(mz^2 - s)^2*s) - 
 ((3*I)*EL^6*gAl*gAu*(gZuL^2 + gZuR^2)*
   (gZlL*gZuL*(2*mmv^2 + (-4 + d)*s - 2*t) + 
    gZlR*gZuR*(2*mmv^2 + (-4 + d)*s - 2*t) + 
    gZlR*gZuL*(2*mmv^2 - (-2 + d)*s - 2*t) + 
    gZlL*gZuR*(2*mmv^2 - (-2 + d)*s - 2*t))*userIntegral[A6, {mc}, -1, 1, 1, 
    -1])/((2*Pi)^d*(mz^2 - s)^2*s) - 
 ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*
   (gZlR*(gZuR^3*(-4*mmv^4 - 2*mmv^2*((2 - 5*d + d^2)*s - 2*t) + 
        2*mc^2*(4*mm^2 - 6*mmv^2 + 6*s - d*s + 2*t) + 
        (-4 + d)*s*(2*(-1 + d)*mm^2 + d*s + 2*t)) + 
      gZuL^3*(-4*mmv^4 + 2*(4 - 5*d + d^2)*mm^2*s - 2*(14 - 9*d + d^2)*mmv^2*
         s + (-2 + d)*s*((-6 + d)*s - 2*t) + 4*mmv^2*t + 
        2*mc^2*(4*mm^2 - 6*mmv^2 + d*s + 2*t)) + 
      gZuL*gZuR^2*(-4*mmv^4 + 2*mc^2*(4*mm^2 - 6*mmv^2 + d*s + 2*t) + 
        2*mmv^2*((16 - 7*d + d^2)*s + 2*t) - s*(2*(8 - 5*d + d^2)*mm^2 + 
          (12 - 6*d + d^2)*s - 2*(-4 + d)*t)) + 
      gZuL^2*gZuR*(-4*mmv^4 + 2*mc^2*(4*mm^2 - 6*mmv^2 + 6*s - d*s + 2*t) + 
        2*mmv^2*((16 - 7*d + d^2)*s + 2*t) - s*(2*(8 - 5*d + d^2)*mm^2 + 
          (12 - 6*d + d^2)*s + 2*(-2 + d)*t))) + 
    gZlL*(gZuL^3*(-4*mmv^4 - 2*mmv^2*((2 - 5*d + d^2)*s - 2*t) + 
        2*mc^2*(4*mm^2 - 6*mmv^2 + 6*s - d*s + 2*t) + 
        (-4 + d)*s*(2*(-1 + d)*mm^2 + d*s + 2*t)) + 
      gZuR^3*(-4*mmv^4 + 2*(4 - 5*d + d^2)*mm^2*s - 2*(14 - 9*d + d^2)*mmv^2*
         s + (-2 + d)*s*((-6 + d)*s - 2*t) + 4*mmv^2*t + 
        2*mc^2*(4*mm^2 - 6*mmv^2 + d*s + 2*t)) + 
      gZuL^2*gZuR*(-4*mmv^4 + 2*mc^2*(4*mm^2 - 6*mmv^2 + d*s + 2*t) + 
        2*mmv^2*((16 - 7*d + d^2)*s + 2*t) - s*(2*(8 - 5*d + d^2)*mm^2 + 
          (12 - 6*d + d^2)*s - 2*(-4 + d)*t)) + 
      gZuL*gZuR^2*(-4*mmv^4 + 2*mc^2*(4*mm^2 - 6*mmv^2 + 6*s - d*s + 2*t) + 
        2*mmv^2*((16 - 7*d + d^2)*s + 2*t) - s*(2*(8 - 5*d + d^2)*mm^2 + 
          (12 - 6*d + d^2)*s + 2*(-2 + d)*t))))*userIntegral[A6, {mc}, -1, 1, 
    1, 0])/(Pi^d*(mz^2 - s)^2*s) - 
 ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
    (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*(gZuL^2 + gZuR^2)*
   (-mmv^2 + s + t)*userIntegral[A6, {mc}, 0, -1, 1, 0])/
  (Pi^d*(mz^2 - s)^2*s) + ((3*I)*EL^6*gAl*gAu*(gZuL^2 + gZuR^2)*
   ...
   userIntegral[A6, {mc}, 0, 0, 0, 0])/((2*Pi)^d*(mz^2 - s)^2*s) + 
 ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*(gZuL^2 + gZuR^2)*
   ...
   userIntegral[A6, {mc}, 0, 0, 1, -1])/(Pi^d*(mz^2 - s)^2*s) + 
 (((3*I)/4)*EL^6*gAl*gAu*
   (-((2^(1 - d)*(gZuL^2 + gZuR^2)*mc^2*
       (gZlL*gZuL*(2*mmv^2 + (-6 + d)*s - 2*t) + 
        gZlR*gZuR*(2*mmv^2 + (-6 + d)*s - 2*t) + 
        gZlR*gZuL*(2*mmv^2 - d*s - 2*t) + gZlL*gZuR*(2*mmv^2 - d*s - 2*t)))/
      Pi^d) - (2^(2 - d)*(gZuL^2 + gZuR^2)*mmv^2*
      (gZlL*gZuL*(2*mmv^2 + (-6 + d)*s - 2*t) + 
       gZlR*gZuR*(2*mmv^2 + (-6 + d)*s - 2*t) + 
       gZlR*gZuL*(2*mmv^2 - d*s - 2*t) + gZlL*gZuR*(2*mmv^2 - d*s - 2*t)))/
   ...
   userIntegral[A6, {mc}, 0, 0, 1, 0])/((mz^2 - s)^2*s) + 
 (((3*I)/2)*EL^6*gAl*gAu*
   ...
   userIntegral[A6, {mc}, 0, 1, -1, 0])/((mz^2 - s)^2*s) + 
 ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*(gZuL^2 + gZuR^2)*
   (gZlL*gZuL*(2*mmv^2 + (-6 + d)*s - 2*t) + 
    gZlR*gZuR*(2*mmv^2 + (-6 + d)*s - 2*t) + 
    gZlR*gZuL*(2*mmv^2 - d*s - 2*t) + gZlL*gZuR*(2*mmv^2 - d*s - 2*t))*
   userIntegral[A6, {mc}, 0, 1, 0, -1])/(Pi^d*(mz^2 - s)^2*s) + 
 ((3*I)*4^(-1 - d)*EL^6*gAl*gAu*
   (gZlR*(gZuR^3*(-(2^(3 + d)*mmv^4*Pi^d) + 2^(4 + d)*mm^2*Pi^d*s - 
        ...
        2^(2 + d)*mc^2*Pi^d*(2*mm^2 - 4*mmv^2 + 6*s - d*s + 2*t)) + 
      gZuL^3*(-(2^(3 + d)*mmv^4*Pi^d) + 2^(4 + d)*mm^2*Pi^d*s - 
        3*2^(2 + d)*d*mm^2*Pi^d*s + 2^(1 + d)*d^2*mm^2*Pi^d*s + 
        5*2^(3 + d)*Pi^d*s^2 - 3*2^(3 + d)*d*Pi^d*s^2 + 3*d^2*(2*Pi)^d*s^2 - 
        2^(2 + d)*mmv^2*Pi^d*((15 - 9*d + d^2)*s - 3*t) + 
        7*2^(2 + d)*Pi^d*s*t - 9*2^(1 + d)*d*Pi^d*s*t + 
        2^(1 + d)*d^2*Pi^d*s*t - 2^(2 + d)*Pi^d*t^2 + 2^(2 + d)*mc^2*Pi^d*
         (2*mm^2 - 4*mmv^2 + d*s + 2*t)) + gZuL*gZuR^2*
       (-(2^(3 + d)*mmv^4*Pi^d) - 2^(3 + d)*mm^2*Pi^d*s + 
        ...
        2^(2 + d)*Pi^d*s*t - 5*2^(1 + d)*d*Pi^d*s*t + 2^(1 + d)*d^2*Pi^d*s*
         t - 2^(2 + d)*Pi^d*t^2 + 3*2^(2 + d)*mmv^2*Pi^d*(s + t) + 
        2^(2 + d)*mc^2*Pi^d*(2*mm^2 - 4*mmv^2 + d*s + 2*t)) + 
      gZuL^2*gZuR*(-(2^(3 + d)*mmv^4*Pi^d) - 2^(3 + d)*mm^2*Pi^d*s + 
        2^(3 + d)*d*mm^2*Pi^d*s - 2^(1 + d)*d^2*mm^2*Pi^d*s - 
        5*2^(2 + d)*Pi^d*s^2 + 2^(3 + d)*d*Pi^d*s^2 - d^2*(2*Pi)^d*s^2 - 
        2^(5 + d)*Pi^d*s*t + 7*2^(1 + d)*d*Pi^d*s*t - 2^(1 + d)*d^2*Pi^d*s*
         t - 2^(2 + d)*Pi^d*t^2 + 2^(2 + d)*mc^2*Pi^d*(2*mm^2 - 4*mmv^2 + 
          6*s - d*s + 2*t) + 2^(2 + d)*mmv^2*Pi^d*((15 - 7*d + d^2)*s + 
          3*t))) + gZlL*(gZuL^3*(-(2^(3 + d)*mmv^4*Pi^d) + 
        ...
        2^(2 + d)*mc^2*Pi^d*(2*mm^2 - 4*mmv^2 + 6*s - d*s + 2*t)) + 
      gZuR^3*(-(2^(3 + d)*mmv^4*Pi^d) + 2^(4 + d)*mm^2*Pi^d*s - 
        3*2^(2 + d)*d*mm^2*Pi^d*s + 2^(1 + d)*d^2*mm^2*Pi^d*s + 
        5*2^(3 + d)*Pi^d*s^2 - 3*2^(3 + d)*d*Pi^d*s^2 + 3*d^2*(2*Pi)^d*s^2 - 
        2^(2 + d)*mmv^2*Pi^d*((15 - 9*d + d^2)*s - 3*t) + 
        7*2^(2 + d)*Pi^d*s*t - 9*2^(1 + d)*d*Pi^d*s*t + 
        2^(1 + d)*d^2*Pi^d*s*t - 2^(2 + d)*Pi^d*t^2 + 2^(2 + d)*mc^2*Pi^d*
         (2*mm^2 - 4*mmv^2 + d*s + 2*t)) + gZuL^2*gZuR*
       (-(2^(3 + d)*mmv^4*Pi^d) - 2^(3 + d)*mm^2*Pi^d*s + 
        2^(3 + d)*d*mm^2*Pi^d*s - 2^(1 + d)*d^2*mm^2*Pi^d*s - 
        2^(3 + d)*Pi^d*s^2 + 2^(2 + d)*d*Pi^d*s^2 - d^2*(2*Pi)^d*s^2 + 
        2^(2 + d)*Pi^d*s*t - 5*2^(1 + d)*d*Pi^d*s*t + 2^(1 + d)*d^2*Pi^d*s*
         t - 2^(2 + d)*Pi^d*t^2 + 3*2^(2 + d)*mmv^2*Pi^d*(s + t) + 
        2^(2 + d)*mc^2*Pi^d*(2*mm^2 - 4*mmv^2 + d*s + 2*t)) + 
      gZuL*gZuR^2*(-(2^(3 + d)*mmv^4*Pi^d) - 2^(3 + d)*mm^2*Pi^d*s + 
        2^(3 + d)*d*mm^2*Pi^d*s - 2^(1 + d)*d^2*mm^2*Pi^d*s - 
        5*2^(2 + d)*Pi^d*s^2 + 2^(3 + d)*d*Pi^d*s^2 - d^2*(2*Pi)^d*s^2 - 
        2^(5 + d)*Pi^d*s*t + 7*2^(1 + d)*d*Pi^d*s*t - 2^(1 + d)*d^2*Pi^d*s*
         t - 2^(2 + d)*Pi^d*t^2 + 2^(2 + d)*mc^2*Pi^d*(2*mm^2 - 4*mmv^2 + 
          6*s - d*s + 2*t) + 2^(2 + d)*mmv^2*Pi^d*((15 - 7*d + d^2)*s + 
          3*t))))*userIntegral[A6, {mc}, 0, 1, 0, 0])/
  (Pi^(2*d)*(mz^2 - s)^2*s) + ((3*I)*EL^6*gAl*gAu*(gZlL + gZlR)*
   (gZuL^3 + gZuL^2*gZuR + gZuL*gZuR^2 + gZuR^3)*userIntegral[A6, {mc}, 0, 1, 
    1, -2])/((2*Pi)^d*(mz^2 - s)^2) + 
 ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*
   (gZlR*(gZuR^3*(s*(12*s + d^2*s - 2*d*(mmv^2 + 3*s - t) - 4*t) + 
        2*mc^2*(2*mmv^2 + (-6 + d)*s - 2*t)) + 
      gZuL^2*gZuR*(2*(-6 + d)*mmv^2*s + 2*mc^2*(2*mmv^2 + (-6 + d)*s - 2*t) - 
        (-4 + d)*s*(d*s + 2*t)) + gZuL*gZuR^2*(mc^2*(4*mmv^2 - 2*d*s - 4*t) + 
        s*(2*(-6 + d)*mmv^2 + (12 - 6*d + d^2)*s - 2*(-4 + d)*t)) + 
      gZuL^3*(mc^2*(4*mmv^2 - 2*d*s - 4*t) - 
        s*(d^2*s + 2*d*(mmv^2 - 4*s - t) + 4*(3*s + t)))) + 
    gZlL*(gZuL^3*(s*(12*s + d^2*s - 2*d*(mmv^2 + 3*s - t) - 4*t) + 
        2*mc^2*(2*mmv^2 + (-6 + d)*s - 2*t)) + 
      gZuL*gZuR^2*(2*(-6 + d)*mmv^2*s + 2*mc^2*(2*mmv^2 + (-6 + d)*s - 2*t) - 
        (-4 + d)*s*(d*s + 2*t)) + gZuL^2*gZuR*(mc^2*(4*mmv^2 - 2*d*s - 4*t) + 
        s*(2*(-6 + d)*mmv^2 + (12 - 6*d + d^2)*s - 2*(-4 + d)*t)) + 
      gZuR^3*(mc^2*(4*mmv^2 - 2*d*s - 4*t) - 
        s*(d^2*s + 2*d*(mmv^2 - 4*s - t) + 4*(3*s + t)))))*
   userIntegral[A6, {mc}, 0, 1, 1, -1])/(Pi^d*(mz^2 - s)^2*s) + 
 ((3*I)*4^(-1 - d)*EL^6*gAl*gAu*
   (gZlR*(gZuL^2*gZuR*(2^(2 + d)*mc^4*Pi^d*(2*mm^2 - 4*mmv^2 + 6*s - d*s + 
          2*t) - 2^(1 + d)*mc^2*Pi^d*(2*(8 - 6*d + d^2)*mm^2*s + 36*s^2 - 
      ...
      gZuL*gZuR^2*(2^(2 + d)*mc^4*Pi^d*(2*mm^2 - 4*mmv^2 + d*s + 2*t) - 
        2^(1 + d)*mc^2*Pi^d*(2*(8 - 6*d + d^2)*mm^2*s + 4*d*s^2 - d^2*s^2 - 
          36*s*t + 30*d*s*t - 6*d^2*s*t - 4*t^2 + 
          4*mmv^2*(s - 4*d*s + d^2*s + t)) - 
        s*(2^(2 + d)*(-6 + d)*mmv^4*Pi^d - 2^(1 + d)*(-2 + d)^2*mm^2*Pi^d*s - 
          ...
          2^(2 + d)*Pi^d*t^2 + 2^(1 + d)*mmv^2*Pi^d*((20 - 8*d + d^2)*s - 
            2*(-6 + d)*t))) + gZuR^3*(2^(2 + d)*mc^4*Pi^d*
         (2*mm^2 - 4*mmv^2 + 6*s - d*s + 2*t) - 2^(1 + d)*mc^2*Pi^d*
         (8*mmv^4 - 2*(8 - 6*d + d^2)*mm^2*s + 20*s^2 - 8*d*s^2 + d^2*s^2 + 
          32*s*t - 14*d*s*t + 2*d^2*s*t + 4*t^2 - 12*mmv^2*(s + t)) - 
        s*(d^2*s*(2^(1 + d)*mm^2*Pi^d + 2^(1 + d)*mmv^2*Pi^d - (2*Pi)^d*s - 
            2^(1 + d)*Pi^d*t) + 2^(2 + d)*Pi^d*(4*mm^2*s + 4*mmv^2*s - 
            3*s^2 - 6*s*t - t^2) - 2^(1 + d)*d*Pi^d*(2*mmv^4 + 
            mmv^2*(4*s - 2*t) - 3*s*(-2*mm^2 + s + 2*t)))) + 
      gZuL^3*(2^(2 + d)*mc^4*Pi^d*(2*mm^2 - 4*mmv^2 + d*s + 2*t) - 
        2^(1 + d)*mc^2*Pi^d*(8*mmv^4 - 2*(8 - 6*d + d^2)*mm^2*s - 40*s^2 + 
        ...
        s*(-(d^2*s*(2^(1 + d)*mm^2*Pi^d - 3*2^(1 + d)*mmv^2*Pi^d + 
          ...
          2^(1 + d)*d*Pi^d*(2*mmv^4 - 2*mmv^2*(12*s + t) + 
            s*(6*mm^2 + 11*s + 8*t))))) + 
    gZlL*(gZuL*gZuR^2*(2^(2 + d)*mc^4*Pi^d*(2*mm^2 - 4*mmv^2 + 6*s - d*s + 
          2*t) - 2^(1 + d)*mc^2*Pi^d*(2*(8 - 6*d + d^2)*mm^2*s + 36*s^2 - 
          20*d*s^2 + 3*d^2*s^2 + 48*s*t - 34*d*s*t + 6*d^2*s*t - 4*t^2 + 
          mmv^2*((-92 + 52*d - 8*d^2)*s + 4*t)) + 
        s*(-(2^(2 + d)*(-6 + d)*mmv^4*Pi^d) + 2^(1 + d)*(-2 + d)^2*mm^2*Pi^d*
          ...
          2^(1 + d)*d^2*Pi^d*s*t + 2^(2 + d)*Pi^d*t^2 - 2^(1 + d)*mmv^2*Pi^d*
           ((20 - 8*d + d^2)*s - 2*(-6 + d)*t))) + 
      gZuL^2*gZuR*(2^(2 + d)*mc^4*Pi^d*(2*mm^2 - 4*mmv^2 + d*s + 2*t) - 
        2^(1 + d)*mc^2*Pi^d*(2*(8 - 6*d + d^2)*mm^2*s + 4*d*s^2 - d^2*s^2 - 
          36*s*t + 30*d*s*t - 6*d^2*s*t - 4*t^2 + 
          4*mmv^2*(s - 4*d*s + d^2*s + t)) - 
        s*(2^(2 + d)*(-6 + d)*mmv^4*Pi^d - 2^(1 + d)*(-2 + d)^2*mm^2*Pi^d*s - 
          ...
          2^(3 + d)*d*Pi^d*s*t + 2^(1 + d)*d^2*Pi^d*s*t - 
          2^(2 + d)*Pi^d*t^2 + 2^(1 + d)*mmv^2*Pi^d*((20 - 8*d + d^2)*s - 
            2*(-6 + d)*t))) + gZuL^3*(2^(2 + d)*mc^4*Pi^d*
         (2*mm^2 - 4*mmv^2 + 6*s - d*s + 2*t) - 2^(1 + d)*mc^2*Pi^d*
         (8*mmv^4 - 2*(8 - 6*d + d^2)*mm^2*s + 20*s^2 - 8*d*s^2 + d^2*s^2 + 
          32*s*t - 14*d*s*t + 2*d^2*s*t + 4*t^2 - 12*mmv^2*(s + t)) - 
        s*(d^2*s*(2^(1 + d)*mm^2*Pi^d + 2^(1 + d)*mmv^2*Pi^d - (2*Pi)^d*s - 
            ...
            3*s^2 - 6*s*t - t^2) - 2^(1 + d)*d*Pi^d*(2*mmv^4 + 
            mmv^2*(4*s - 2*t) - 3*s*(-2*mm^2 + s + 2*t)))) + 
      gZuR^3*(2^(2 + d)*mc^4*Pi^d*(2*mm^2 - 4*mmv^2 + d*s + 2*t) - 
        2^(1 + d)*mc^2*Pi^d*(8*mmv^4 - 2*(8 - 6*d + d^2)*mm^2*s - 40*s^2 + 
          24*d*s^2 - 3*d^2*s^2 + 4*mmv^2*((15 - 9*d + d^2)*s - 3*t) - 
          28*s*t + 18*d*s*t - 2*d^2*s*t + 4*t^2) + 
        s*(-(d^2*s*(2^(1 + d)*mm^2*Pi^d - 3*2^(1 + d)*mmv^2*Pi^d + 
           ...
           (-4*mm^2*s + 20*mmv^2*s - 9*s^2 - 6*s*t + t^2) + 
          2^(1 + d)*d*Pi^d*(2*mmv^4 - 2*mmv^2*(12*s + t) + 
            s*(6*mm^2 + 11*s + 8*t))))))*userIntegral[A6, {mc}, 0, 1, 1, 0])/
  (Pi^(2*d)*(mz^2 - s)^2*s)
