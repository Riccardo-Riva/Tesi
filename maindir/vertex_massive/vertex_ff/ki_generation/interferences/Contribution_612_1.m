   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq - s - t)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq^2 + psq*(s - 2*t) + 
       t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(psq - t)^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq - t)*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*
      ...
      (mm^2 - psq)*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^4*
      (mm^2 - psq)*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
     Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq - t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(2*psq^2 - 3*psq*t + 
       mm^2*(-psq + t) + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(2*psq^2 - 3*psq*t + 
       mm^2*(-psq + t) + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
