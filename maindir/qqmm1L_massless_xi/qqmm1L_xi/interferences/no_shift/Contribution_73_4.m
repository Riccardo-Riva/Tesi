...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
   ...
   (((-I)*2^(1 - d)*EL^6*gWlN*gWNl*gZlLC*gZNL*s*
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gZlLC*gZNL*
      ...
      \[Mu]^(4 - d)*SPList[SP[p1, q1], SP[q1, q1]])/
     (mw^2*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)) + 
    (I*2^(2 - d)*(-2 + d)*EL^6*gWlN*gWNl*gZlLC*gZNL*((-2 + d)*gZuL*gZuLC - 
