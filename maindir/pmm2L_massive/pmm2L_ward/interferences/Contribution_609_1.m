...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 ((I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)^2*s*(mm^2 + s)*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*
    mm^4*(3*mm^4 - 2*mm^2*psq - psq^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*
    mm^4*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (aa*(mm^4*(10*psq - 3*s - 10*t) + psq*s*(3*psq - 2*t) + 
       2*mm^2*(3*psq^2 + 4*psq*s - 4*s^2 - 3*psq*t - 7*s*t)) + 
     bb*(-(psq*s*(psq - 2*t)) + 5*mm^4*(-2*psq + s + 2*t) + 
       mm^2*(-6*psq^2 + 6*psq*(-2*s + t) + 2*s*(4*s + 7*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    ((aa + bb)*(mm^2 - psq)^2*s + (aa - bb)*(3*mm^4 - 2*mm^2*psq - psq^2)*
      (psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (aa*(5*mm^4*(2*psq - s - 2*t) + 2*mm^2*(3*psq^2 + 5*psq*s - 3*s^2 - 
         3*psq*t - 7*s*t) + psq*s*(3*psq - 2*(s + t))) + 
     bb*(mm^4*(-10*psq + 7*s + 10*t) + mm^2*(-6*psq^2 - 14*psq*s + 6*s^2 + 
         6*psq*t + 14*s*t) + psq*s*(-psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    ((aa + bb)*(mm^2 - psq)^2*s + (aa - bb)*(3*mm^4 - 2*mm^2*psq - psq^2)*
      (psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*s*(mm^2 + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*s*(mm^2 + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(bb*(3*mm^4 + psq*(5*psq - s - 2*t) - 
       3*mm^2*(s + 2*t)) + aa*(mm^4 + psq*(-psq + s + 2*t) + 
       mm^2*(-8*psq + 3*s + 6*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(bb*(mm^4 + mm^2*(4*psq - 3*s - 6*t) + 
       psq*(3*psq - s - 2*t)) + aa*(3*mm^4 + 3*mm^2*(-4*psq + s + 2*t) + 
       psq*(psq + s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 + psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(3*mm^2 + psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2*(7*psq - 4*s - 7*t) + 
     psq*(psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(4*bb*mm^4 + aa*mm^2*(10*psq - 7*s - 10*t) + 
     aa*psq*(2*psq - s - 2*t) + bb*psq*(-2*psq - 3*s + 2*t) + 
     bb*mm^2*(-14*psq + 11*s + 10*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2*(7*psq - 4*s - 7*t) + 
     psq*(psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (aa*(2*mm^4 + mm^2*(8*psq - 3*s - 10*t) + psq*(2*psq - 3*s - 2*t)) + 
     bb*(2*mm^4 - psq*(2*psq + s - 2*t) + mm^2*(-12*psq + 7*s + 10*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(mm^4 + psq*(psq + s) + 
       mm^2*(2*psq - s - 4*t)) + bb*(mm^4 + psq*(psq - s) + 
       mm^2*(-6*psq + s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*mm^2*(6*psq - 5*s - 6*t) - bb*s*(psq - 2*t) + 
     aa*s*(3*psq - 2*t) + bb*mm^2*(-6*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2*(7*psq - 4*s - 7*t) + 
     psq*(psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(mm^4 + psq*(psq - s) + 
       mm^2*(2*psq - 3*s - 4*t)) + bb*(mm^4 + psq*(psq + s) + 
       mm^2*(-6*psq + 3*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*((aa + bb)*(mm^2 - psq)*s + 
     2*(aa - bb)*(mm^2 + psq)*(psq - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*((aa + bb)*(mm^2 - psq)*s + 
     (aa - bb)*(3*mm^2 + psq)*(psq - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2*(7*psq - 3*s - 7*t) + 
     psq*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^4*(4*aa*mm^4 + aa*mm^2*(6*psq + s - 10*t) + 
     aa*psq*(2*psq - 5*s - 2*t) + bb*psq*(-2*psq + s + 2*t) + 
     bb*mm^2*(-10*psq + 3*s + 10*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(2*bb*mm^2*(-psq + t) + 
     aa*(mm^4 + psq^2 - 2*mm^2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^4*(-3*aa*psq*s + bb*mm^2*(6*psq - s - 6*t) + 
     2*aa*s*(s + t) + aa*mm^2*(-6*psq + 3*s + 6*t) + bb*s*(psq - 2*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2*(7*psq - 3*s - 7*t) + 
     psq*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (-3*bb*psq*s + aa*s*(psq - 2*t) + bb*mm^2*(2*psq + s - 2*t) + 2*bb*s*t + 
     aa*mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(3*mm^2 + psq)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*((aa + bb)*(mm^2 - psq)*s + 
     2*(aa - bb)*(mm^2 + psq)*(psq - s - t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa + 3*bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(3*mm^2 - psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*(3*aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[q1, q1]])/(4^d*Pi^(2*d)) - 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(2*mm^2 + psq - 2*s - 3*t) + 
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
   ...
   (4^d*Pi^(2*d)) - (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(4*mm^2 - psq - s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 - psq - s) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(bb*(mm^2 - psq - s) + 
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(-psq + s + t)*
