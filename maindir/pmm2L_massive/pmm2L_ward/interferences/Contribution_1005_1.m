...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mz], 
  ...
  (((-I)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s^2*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*(s + 2*t)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*(s + 2*t)*
    ...
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*s*(s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*(s + 2*t)*
    ...
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*s*(2*s + 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*(2*s + 3*t)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
    ...
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*s*(s + 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*(s + 3*t)*
    ...
    (mz^2*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*s*(2*s + 5*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)) - ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*s*t*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
    ...
    (mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     ...
     ggmgmA*ggmgmZ*(gZlL + gZlR)*s*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
    ...
    (mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     ...
     ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 2*t)*
    ...
    (mz^2*(2*Pi)^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/
    (mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
      SP[p1, q2]])/(mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/(mz^2*Pi^(2*d)) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q2]])/
    (mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
    ...
    (mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
      SP[p2, p3]])/(mz^2*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA*
     ggmgmZ*(gZlL + gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
    ...
    (mz^2*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)) + ((3*I)*(aa - bb)*EL^5*gAl^2*ggmgmA*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
    ...
    (mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     ...
     ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*s + 8*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1]])/(mz^2*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(3*s + 8*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q2]])/
    (mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
      SP[p3, p3]])/(mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 4*t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*t*
    ...
    (mz^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
      SP[p3, p3]])/(mz^2*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA*
     ggmgmZ*(gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
   ((3*I)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[p3, q2]])/
    (mz^2*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + t)*
    ...
    (mz^2*Pi^(2*d)) + ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)) + ((3*I)*(aa - bb)*EL^5*gAl^2*ggmgmA*
     ggmgmZ*(gZlL + gZlR)*(s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(s + 3*t)*
