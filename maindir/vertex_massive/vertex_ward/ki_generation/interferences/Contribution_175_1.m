...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
   ...
   Pi^(2*d) - ((aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 + psq)*
    s^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  ((aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 + psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
  (2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*
    (2*aa*(psq^2 + mm^2*(-psq + s)) - bb*(mm^2*(-2*psq + s) + 
       psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*
    (aa*mm^2*(2*psq - 3*s) + 2*bb*mm^2*(-psq + s) + 2*bb*psq*(psq + s) - 
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(-2*bb*psq + aa*(mm^2 + psq))*s*
  ...
  ((aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 + psq)*s*
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(-4*bb*psq + aa*(3*mm^2 + psq))*s*
  ...
  (4^(1 - d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
