...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((EL^5*gAl*gWlN*gWNl*gWWZ*mm^2*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*mm^2*(bb*mm^2 - aa*psq)*
  ...
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(4*bb*mm^2*(psq - s) - 
     4*aa*psq*(psq - s) - aa*mm^2*(4*psq + s) + bb*psq*(4*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(bb*mm^2 - aa*psq)*s*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(bb*mm^2 - aa*psq)*s*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(bb*mm^2 - aa*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*(aa*((-2 + d)*gZlL + (-1 + d)*gZlR)*
  ...
  (3*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(bb*mm^2 - aa*psq)*
