...
(I*EL^6*gAl*gAu*ggmgmZ^2*(gZlL + gZlR)*(gZuL + gZuR)*(-2*mmv^2 + s)*
 ...
 (I*2^(-1 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
  ...
  (Pi^(2*d)*(mz^2 - s)^2*s) + 
 (I*EL^6*gAl*gAu*ggmgmZ^2*(gZlL*gZuL*(2*mmv^2 + (-4 + d)*s - 2*t) + 
 ...
 (I*2^(-1 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
  ...
  (Pi^(2*d)*(mz^2 - s)^2*s) + 
 (I*EL^6*gAl*gAu*ggmgmZ^2*(gZlL*gZuL*(-((-2 + d)*mmv^2) + (-2 + d)*s + 
 ...
 (I*2^(-1 - d)*EL^6*gAl*gAu*ggmgmZ^2*((-2 + d)*gZlL*gZuL - 
   ...
   userIntegral[A4, {mw*Sqrt[GaugeXi[Q]]}, 0, 1, -1, 0])/
  (Pi^d*(mz^2 - s)^2*s) + (I*2^(-1 - d)*EL^6*gAl*gAu*ggmgmZ^2*
   (gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
    gZlL*gZuR*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
    gZlL*gZuL*(-2*mmv^2 - (-2 + d)*s + 2*t) + 
    gZlR*gZuR*(-2*mmv^2 - (-2 + d)*s + 2*t))*userIntegral[A4, 
 ...
 (I*EL^6*gAl*gAu*ggmgmZ^2*
  ...
  ((2*Pi)^(2*d)*(mz^2 - s)^2*s) + 
 (I*EL^6*gAl*gAu*ggmgmZ^2*(gZlL + gZlR)*(gZuL + gZuR)*
   userIntegral[A4, {mw*Sqrt[GaugeXi[Q]]}, 0, 1, 1, -2])/
  ((2*Pi)^d*(mz^2 - s)^2) + (I*2^(-1 - d)*EL^6*gAl*gAu*ggmgmZ^2*
   (gZlR*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
    gZlL*gZuR*(2*mmv^2 - (-4 + d)*s - 2*t) + 
    gZlL*gZuL*(2*mmv^2 + (-2 + d)*s - 2*t) + 
