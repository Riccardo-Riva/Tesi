...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   ((4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*sw*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*sw*
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAu*gFFA*gFll*gFZW*gWNl*gZlR*mm^2*sw*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAu*gFFA*gFll*
      gFZW*gWNl*gZlR*mm^2*sw*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAu*gFFA*gFll*gFZW*gWNl*gZlR*mm^2*sw*(psq - t)*
