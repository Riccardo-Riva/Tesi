...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*(mm^2 + psq)*s*sw*
   ...
   (I*2^(1 - 2*d)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*s*sw*
     ...
     SPList[SP[p1, q1]])/Pi^(2*d) + (I*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*
     mm^2*sw*(aa*(4*mm^2*(psq - t) + (4*psq - s)*(psq - s - t)) - 
   ...
   (I*2^(1 - 2*d)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*s*sw*
     ...
     SPList[SP[p2, q1]])/Pi^(2*d) + (I*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*
