...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
   ...
   ((I*(aa + bb)*EL^5*gFFAZ*gFll^2*gZNL*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*EL^5*gFFAZ*gFll^2*gZNL*mm^2*(bb*(psq - s - t) + 
       ...
       SP[p1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFAZ*gFll^2*gZNL*mm^2*
    ...
    (I*2^(1 - 2*d)*EL^5*gFFAZ*gFll^2*gZNL*mm^2*(bb*(mm^2 - t) + 
       aa*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFAZ*gFll^2*gZNL*mm^2*
