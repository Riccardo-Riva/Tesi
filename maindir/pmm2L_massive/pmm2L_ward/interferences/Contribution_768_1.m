...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[-p3 - q1, mw], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFFA*gFll*gWNl*gWWA*mm^2*
  ...
  (I*(aa - bb)*(-1 + d)*EL^5*gFAW*gFFA*gFll*gWNl*gWWA*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFFA*gFll*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFFA*gFll*gWNl*
    gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[q1, q1]])/Pi^(2*d) - (I*(aa - bb)*(-1 + d)*EL^5*gFAW*gFFA*gFll*gWNl*
    gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*
    gFAW*gFFA*gFll*gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*
