...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^5*gAl*gHll^2*mm^4*s*(aa*(-8*d*gZlL*gZlR*(psq^2 + mm^2*(3*psq - s)) - 
        (-2 + d)*gZlL^2*(mm^2 - psq)*(mm^2 + s) - (-2 + d)*gZlR^2*
         (mm^2 - psq)*(mm^2 + s)) + 
      bb*(4*d*gZlL*gZlR*(psq*(2*psq - s) + mm^2*(6*psq - s)) - 
        (-2 + d)*gZlL^2*(mm^2 - psq)*(mm^2 + s) - (-2 + d)*gZlR^2*
         (mm^2 - psq)*(mm^2 + s)))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - 
   (2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*(2^(1 + 2*d)*aa*mm^2*Pi^(2*d)*s*
       (gZlL^2*(mm^2 - 5*psq) + gZlR^2*(mm^2 - 5*psq) + 
        4*gZlL*gZlR*(-mm^2 + s)) - aa*d*(2*Pi)^(2*d)*
       (gZlL^2*mm^2*(mm^2 - 5*psq)*s + gZlR^2*mm^2*(mm^2 - 5*psq)*s + 
        2*gZlL*gZlR*(mm^4*(9*psq - 4*s) + psq^2*s + 3*mm^2*psq*(psq + s))) + 
      bb*(2^(1 + 2*d)*Pi^(2*d)*(gZlL^2*mm^2*(3*mm^2 + psq) + 
          gZlR^2*mm^2*(3*mm^2 + psq) + 2*gZlL*gZlR*(mm^2 + psq)*(mm^2 - s))*
         s - d*(2*Pi)^(2*d)*(gZlL^2*mm^2*(3*mm^2 + psq)*s + 
          gZlR^2*mm^2*(3*mm^2 + psq)*s - 2*gZlL*gZlR*(mm^4*(9*psq - 2*s) + 
            psq^2*s + mm^2*psq*(3*psq + s)))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(4*d) - (2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^4*
     (bb*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(2*mm^2*psq + (3*psq - s)*s)) - 
        (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(2*mm^2*psq + (3*psq - s)*s) + 
        2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(d*psq*(psq - s) + 2*(mm^2 + psq)*s + 
          d*mm^2*(3*psq + s))) + aa*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*
         (mm^2*(2*psq - s) + (4*psq - s)*s) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
         (mm^2*(2*psq - s) + (4*psq - s)*s) - 2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
         (d*mm^2*(3*psq - 2*s) + 4*mm^2*s + d*psq*(psq + 2*s))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(4*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (aa*mm^2*((-2 + d)*gZlL^2*(mm^2 + 3*psq) + (-2 + d)*gZlR^2*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^4*
     (-(bb*(-2*(4 + d)*gZlL*gZlR*(mm^2 + psq) + (-2 + d)*gZlL^2*(3*psq - s) + 
         (-2 + d)*gZlR^2*(3*psq - s))) + aa*(-4*gZlL*gZlR*(4*mm^2 + d*psq) + 
        (-2 + d)*gZlL^2*(3*psq - s) + (-2 + d)*gZlR^2*(3*psq - s)))*s*
   ...
   (EL^5*gAl*gHll^2*mm^4*(-(bb*(-2*(-4 + d)*gZlL*gZlR*(mm^2 - psq) + 
    ...
    (2*Pi)^(2*d) - (2^(3 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    ...
    Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (bb*mm^2*((-2 + d)*gZlL^2*(mm^2 + 3*psq - s) + (-2 + d)*gZlR^2*
   ...
   (4^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
     (bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(mm^2 + 3*psq - 2*s) + 
        (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*(mm^2 + 3*psq - 2*s) - 
        4^d*gZlL*gZlR*Pi^(2*d)*(mm^2 + psq)*(3*d*mm^2 + 4*s)) + 
      aa*(2*Pi)^(2*d)*(-((-2 + d)*gZlL^2*mm^2*(mm^2 + 3*psq - 2*s)) - 
        (-2 + d)*gZlR^2*mm^2*(mm^2 + 3*psq - 2*s) + 
        gZlL*gZlR*(8*mm^2*s + d*(3*mm^4 + mm^2*(3*psq - s) + psq*s))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(4*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(aa*d*psq*(3*mm^2 + psq) - 
      bb*d*psq*(3*mm^2 + psq) - 4*aa*mm^2*s + 2*bb*(mm^2 + psq)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (bb*(-((-2 + d)*gZlL^2*mm^2*(4*psq - s)) - (-2 + d)*gZlR^2*mm^2*
         (4*psq - s) + 2*gZlL*gZlR*(d*(psq^2 + mm^2*(3*psq - s)) + 
          2*(mm^2 - psq)*s)) + aa*((-2 + d)*gZlL^2*mm^2*(4*psq - s) + 
   ...
   (4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (bb*((-4 + d)*gZlL*gZlR*(mm^2 + psq)*(mm^2 - 2*s) + 
        (-2 + d)*gZlL^2*mm^2*s + (-2 + d)*gZlR^2*mm^2*s) - 
      aa*((-2 + d)*gZlL^2*mm^2*s + (-2 + d)*gZlR^2*mm^2*s + 
        (-4 + d)*gZlL*gZlR*(mm^4 + mm^2*(psq - 3*s) - psq*s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (4^(2 - d)*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*(mm^2 + psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
     (aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s) + (-2 + d)*gZlR^2*mm^2*
         (2*psq - s) - 2*gZlL*gZlR*(d*(psq^2 + mm^2*(3*psq - 2*s)) + 
          4*mm^2*s)) - bb*((-2 + d)*gZlL^2*mm^2*(2*psq - s) + 
        (-2 + d)*gZlR^2*mm^2*(2*psq - s) - 2*gZlL*gZlR*(d*psq*(psq - s) + 
          d*mm^2*(3*psq - s) + 2*(mm^2 + psq)*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
   (4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*mm^2 - aa*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
     (aa*((-2 + d)*gZlL^2 - 4*(-4 + d)*gZlL*gZlR + (-2 + d)*gZlR^2)*mm^2 - 
   ...
   (2^(1 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
    ...
    Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^5*gAl*gHll^2*mm^2*
     (bb*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*mm^2 - aa*psq)*
   ...
   (2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
    ...
    Pi^(2*d) + (2^(5 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q2]])/
    Pi^(2*d) - (4^(2 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*mm^2 - aa*psq)*
