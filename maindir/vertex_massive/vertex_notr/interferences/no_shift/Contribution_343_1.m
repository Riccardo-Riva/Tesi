...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     ((-5 + 4*d)*mm^2 + (9 - 2*d)*psq - (2 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*((-5 + 4*d)*mm^2 + (9 - 4*d)*psq + 4*(-1 + d)*s)*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     ...
     mm^4*(8*mm^2 - 4*psq + d*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   ...
   (EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(2*(-1 + d)*mm^2 - 
      2*(-3 + d)*psq + (-4 + 3*d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^4 - mm^2*(psq + (2 - 3*d)*s) + s*((10 - 3*d)*psq + 2*(-2 + d)*s))*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     (gZlL - gZlR)*mm^2*((1 + d)*mm^2 - (-3 + d)*psq + (-2 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ((7 + 3*d)*mm^2 + psq - d*psq + 2*d*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ((-12 + 5*d)*mm^2 + (24 - 5*d)*psq + 2*(-4 + d)*s)*\[Mu]^(8 - 2*d)*
