...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    ((2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
       (psq^2 - 2*psq*t + t*(s + t))*(-10*(-2 + d)*psq^2 + 
        2*(-6 + d)*mm^2*(psq - t) + (-6 + d)*s*(s + 2*t) + 
        2*psq*((4 + d)*s + 5*(-2 + d)*t))*\[Mu]^(8 - 2*d))/
      (mz^2*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*(-6 + d)*mm^4*s*(psq - t) + psq*s^2*((-22 + 7*d)*psq - 
          (-6 + d)*(s + t)) + mm^2*(-20*(-2 + d)*psq^3 - 
          4*psq^2*((2 + 3*d)*s - 15*(-2 + d)*t) + 
          psq*((22 + 3*d)*s^2 + 2*(34 - 9*d)*s*t - 60*(-2 + d)*t^2) + 
          (s + t)*((-6 + d)*s^2 + 10*(-2 + d)*s*t + 20*(-2 + d)*t^2)))*
       \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
     (2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
       (-4*(-2 + d)*psq^3 + (-3 + 2*d)*s^3 + 2*(-5 + 3*d)*s^2*t + 
        4*(-2 + d)*t^3 + 2*s*t*((3 - 2*d)*mm^2 + 3*(-2 + d)*t) + 
      ...
      (mz^2*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (psq^2 - 2*psq*t + t*(s + t))*(-10*(-2 + d)*psq^2 + 
        ...
        2*mm^2*((-22 + 7*d)*psq + 8*s - 3*d*s + 22*t - 7*d*t))*
       \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(mz^2*Pi^(2*d)*s) + 
     (2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       ((10 - 6*d)*mm^2 + (-3 + 2*d)*s)*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
        psq^2*(s + 6*t) + t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
       SPList[SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
     (4^(1 - d)*(-5 + 3*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
      ...
      (mz^2*Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*(-6 + d)*mm^4*(psq - s - t) + 2*psq*(10*(-3 + d)*psq^2 + 
        ...
        mm^2*((62 - 17*d)*psq^2 + 8*(-7 + 2*d)*psq*s + 20*(-4 + d)*psq*t - 
          (-6 + d)*(s^2 + 4*s*t + 3*t^2)))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q1]])/(mz^2*Pi^(2*d)*s) + 
     (4^(1 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 - psq)*
       (-10*(-2 + d)*psq^2 - (-6 + d)*psq*s + 2*(-6 + d)*mm^2*(psq - t) + 
        8*(-1 + d)*psq*t + (-6 + d)*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)*s) + 
     (4^(1 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*mm^4*(psq - t) - 2*psq*(-psq + s + t)^2 + 
        mm^2*(-4*psq^2 - psq*s + s^2 + 6*psq*t + s*t - 2*t^2))*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)*s) + 
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*(-3*mm^4*s + psq^2*(-12*s + 5*t) + psq*(9*s^2 - 11*s*t - 10*t^2) + 
          5*t*(2*s^2 + 3*s*t + t^2) + mm^2*s*(15*psq - 4*(s + t))) + 
        d*(mm^4*s + psq^2*(14*s - 5*t) - 5*t*(s + t)^2 + 
          psq*(-8*s^2 + 2*s*t + 10*t^2) - mm^2*(10*psq^2 - 5*psq*(s + 4*t) + 
            2*(s^2 + 6*s*t + 5*t^2))))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*(-2 + d)*psq^3 + 2*(-3 + 2*d)*mm^4*s + 
        psq^2*((3 + d)*s - 6*(-2 + d)*t) + t*(s + t)*(5*s - 2*(-2 + d)*t) + 
        psq*(-((-2 + d)*s^2) + (-12 + d)*s*t + 6*(-2 + d)*t^2) - 
        mm^2*((-6 + 8*d)*psq^2 + (2 + d)*s^2 + (2 + 5*d)*s*t + 
          2*(-3 + 4*d)*t^2 - psq*((8 + d)*s + 4*(-3 + 4*d)*t)))*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - 
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (-10*(-4 + d)*psq^3 + t*(s + t)*((-26 + 6*d)*s + (-22 + 7*d)*t) + 
     ...
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (-2*(-8 + 5*d)*psq^3 + mm^2*(psq - s - t)*((-6 + 8*d)*psq + s - 
          3*d*s + 6*t - 8*d*t) + t*(s + t)*((-11 + 4*d)*s + 2*(-5 + 3*d)*t) + 
        psq^2*(9*(-2 + d)*s + 2*(-21 + 13*d)*t) + 
        psq*(-((-1 + d)*s^2) + (39 - 19*d)*s*t + 2*(18 - 11*d)*t^2))*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - 
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       ((10 - 6*d)*psq^3 + mm^2*(psq - s - t)*(12*(-1 + d)*psq + s - 3*d*s - 
          12*(-1 + d)*t) + 2*t*(s + t)*((-7 + 3*d)*s + (-5 + 3*d)*t) + 
     ...
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)*
      ...
      (mz^2*Pi^(2*d)*s) - (4^(1 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       (gZlL + gZlR)*(psq*s + 2*mm^2*(psq - s - t))*(psq - t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)*s) + 
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (-2*(20*psq^3 + psq^2*(8*s - 50*t) + mm^2*s*(3*s - 2*t) + 
          10*t*(s^2 - t^2) + psq*(2*mm^2*s - 3*s^2 - 8*s*t + 40*t^2)) + 
        d*(20*psq^3 - 10*t^2*(s + t) - 2*psq^2*(2*s + 25*t) + 
          mm^2*(20*psq^2 - 6*psq*s + s^2 - 40*psq*t + 6*s*t + 20*t^2) + 
          psq*(-s^2 + 14*s*t + 40*t^2)))*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*(-2 + d)*psq^3 + psq^2*(-7*(-1 + d)*s - 6*(-2 + d)*t) - 
     ...
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       ((5 - 3*d)*psq*s + mm^2*(12*(-1 + d)*psq + s - 3*d*s - 12*(-1 + d)*t))*
     ...
     (4^(1 - d)*(-8 + 3*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
        t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
        SP[q1, q1]])/(mz^2*Pi^(2*d)*s) + (4^(1 - d)*(-5 + 3*d)*EL^6*gAl^2*gAu*
       gWWA*gWWZ*(gZlL + gZlR)*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
        psq^2*(s + 6*t) + t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
       SPList[SP[q1, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
     (4^(1 - d)*(-5 + 3*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
        t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
        SP[q2, q2]])/(mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*
       gAu*gWWA*gWWZ*(gZlL + gZlR)*(2*psq*(psq - s - t) + 
     ...
     (5*2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       ...
       SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) + 
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (5*4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s) - 
     (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
     (2^(3 - 2*d)*(-5 + 3*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     ...
     (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*psq*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/
      (mz^2*Pi^(2*d)) + (5*4^(2 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       (gZlL + gZlR)*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(mm^2 - psq)*
     ...
     (5*2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
        SP[q1, q1]])/(mz^2*Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAl^2*gAu*
       gWWA*gWWZ*(gZlL + gZlR)*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
     (4^(2 - d)*(-5 + 3*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
        SP[q2, q2]])/(mz^2*Pi^(2*d)*s) + (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*
       gWWA*gWWZ*(gZlL + gZlR)*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
        SP[p2, q2], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
     (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (psq^2 + mm^2*s - 2*psq*(s + t) + t*(s + t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
     (2^(5 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)*
       (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
        SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*
       gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)*(mm^2 - 2*psq + s + t)*
     ...
     (5*4^(2 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (4^(2 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p3, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - 
     (4^(2 - d)*(-5 + 3*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p3, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)*s) - 
     (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
        SP[p3, q2]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*
       gWWA*gWWZ*(gZlL + gZlR)*(psq^2 - mm^2*s - 2*psq*t + t*(s + t))*
      ...
      (mz^2*Pi^(2*d)*s) + (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       (gZlL + gZlR)*(2*psq*(psq - s - t) + mm^2*(-2*psq + s + 2*t))*
     ...
     (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*psq*
      ...
      (mz^2*Pi^(2*d)) - (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       (gZlL + gZlR)*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
        SP[p2, q2]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*
       gWWA*gWWZ*(gZlL + gZlR)*(psq - t)*(-2*mm^2 + psq + s + t)*
     ...
     (5*2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
        SP[p3, q1]])/(mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*gWWA*
       gWWZ*(gZlL + gZlR)*(psq - t)*((-5 + 3*d)*psq + (3 - 2*d)*s + 
        (5 - 3*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
        SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - (5*4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*
       gWWA*gWWZ*(gZlL + gZlR)*(psq - t)^2*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s) + 
     (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)^2*
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q2]])/
      (mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*(-5 + 3*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       (gZlL + gZlR)*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
        SP[p2, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)*s) + 
     (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)*
       (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
        SP[p3, q1]])/(mz^2*Pi^(2*d)*s) + (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*
       gWWA*gWWZ*(gZlL + gZlR)*(psq - t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/(mz^2*Pi^(2*d)) + 
     (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)^2*
     ...
     (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*(psq - t)^2*
      ...
      (mz^2*Pi^(2*d)*s) - (5*2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       ...
       SPList[SP[p3, q1], SP[p3, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
     (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
        SP[q1, q2]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(-5 + 3*d)*EL^6*gAl^2*gAu*
       gWWA*gWWZ*(gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p3, q1], SP[p3, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)) + 
     (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
        SP[q1, q2]])/(mz^2*Pi^(2*d)) - (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*gAu*
       gWWA*gWWZ*(gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (-((2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
        (psq^2 - 2*psq*t + t*(s + t))*(-10*(-2 + d)*psq^2 + 
         2*(-6 + d)*mm^2*(psq - t) + (-6 + d)*s*(s + 2*t) + 
         2*psq*((4 + d)*s + 5*(-2 + d)*t))*\[Mu]^(8 - 2*d))/
       (mz^2*Pi^(2*d)*s)) + (2^(1 - 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       (gZlL + gZlR)*(-2*(-6 + d)*mm^4*(3*psq^2 + 3*t*(s + t) - 
          psq*(s + 6*t)) + psq*(-10*(-2 + d)*psq^3 + 
          psq^2*((-6 + d)*s + 30*(-2 + d)*t) + 2*psq*(2*(-7 + 2*d)*s^2 + 
            3*(8 - 3*d)*s*t - 15*(-2 + d)*t^2) - (s + t)*((-6 + d)*s^2 + 
            (22 - 7*d)*s*t - 10*(-2 + d)*t^2)) + 
        mm^2*(30*(-2 + d)*psq^3 - psq^2*(5*(2 + 5*d)*s + 16*(-9 + 4*d)*t) + 
          2*psq*((14 + d)*s^2 + 16*(-1 + d)*s*t + (-54 + 19*d)*t^2) + 
          (-6 + d)*(s^3 + 2*s^2*t - 3*s*t^2 - 4*t^3)))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1]])/(mz^2*Pi^(2*d)*s) - 
     ...
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       ...
       SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s) + 
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (2*(-8 + 5*d)*psq^3 + psq^2*(-9*(-2 + d)*s + 42*t - 26*d*t) - 
        mm^2*(psq - s - t)*((-6 + 8*d)*psq + s - 3*d*s + 6*t - 8*d*t) - 
     ...
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       ...
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + 
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       ((16 - 6*d)*psq^3 + psq*t*((16 - 11*d)*s - 20*(-3 + d)*t) - 
        mm^2*(psq - t)*((-6 + 11*d)*psq - 2*s - 3*d*s + 6*t - 11*d*t) + 
        t*(s + t)*((4 + d)*s + (-22 + 7*d)*t) + 
        psq^2*((2 + 3*d)*s + (-54 + 19*d)*t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s) - 
     ...
     (5*4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       ...
       SPList[SP[p3, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (5*(mm^2 - psq)*s + 3*d*psq*s - d*mm^2*(4*psq + s - 4*t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)) - 
     (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (10*(-2 + d)*psq^3 + psq^2*(-4*(-1 + d)*s - 30*(-2 + d)*t) + 
        mm^2*s*(2*s + 3*d*s - 6*t + 11*d*t) - 5*(-2 + d)*t*
     ...
     (4^(1 - d)*(-5 + 3*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
       (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
        t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
        SP[q2, q2]])/(mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*(-3 + 2*d)*EL^6*gAl^2*
       gAu*gWWA*gWWZ*(gZlL + gZlR)*(mm^2*(2*psq - s - 2*t) + 
        2*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
        SP[p2, q2]])/(mz^2*Pi^(2*d)*s) - (5*2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*
       gAu*gWWA*gWWZ*(gZlL + gZlR)*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*
     ...
     (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*(gZlL + gZlR)*
      ...
      (mz^2*Pi^(2*d)*s) - (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       ...
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q1, q2]])/
      (mz^2*Pi^(2*d)*s) + (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       (gZlL + gZlR)*(mm^2*(2*psq - s - 2*t) + 2*psq*(-psq + s + t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/
      (mz^2*Pi^(2*d)*s) - (4^(2 - d)*(-3 + 2*d)*EL^6*gAl^2*gAu*gWWA*gWWZ*
       (gZlL + gZlR)*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)) - 
