...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2 - psq)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)^2*
     (psq^2 + psq*(s - 2*t) + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)^2*(psq - t)*
   ...
   (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
     ...
     mm^2*(mm^2 - psq)*(2*psq^2 + 3*psq*s - s^2 - 4*psq*t + s*t + 2*t^2)*
   ...
   (4^(2 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*psq + s - 2*t)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*(psq - t)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*(psq - t)^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(4*psq^3 - mm^2*psq*s + 
      mm^2*s*t - psq^2*(s + 12*t) + psq*t*(7*s + 12*t) - 
      2*t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*psq^2 - 3*psq*t + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)^2*
