...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (-((4^(1 - d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^4*
      mu^2)/(Pi^(2*d)*s)) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ*gXgmgm*
     gXll*(gZlL - gZlR)*mm^4*mu^2*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 + s)*(2*mu^2 + s)*SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*t*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*t*
