...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[-p3 - q1, mw], 
 ...
 (-((EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*
     (2*psq^2 + s^2 + psq*(s - 4*t) + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/((2*Pi)^(2*d)*s^2)) - 
  (EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*(2*psq^2 + psq*(3*s - 4*t) + 
     t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*(8*psq^2 + s^2 - 16*psq*t + 
     8*s*t + 8*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*(8*psq^2 + s^2 - 16*psq*t + 
     8*s*t + 8*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*(-psq + s + t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*(-psq + s + t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*(2*psq + s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*(2*psq + s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFW*gHWW*gWNl*mm^2*\[Mu]^(8 - 2*d)*
