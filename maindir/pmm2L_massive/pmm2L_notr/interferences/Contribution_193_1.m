 ...
 ((4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (-8*psq^2 + 8*psq*s - s^2 - 4*psq*t + 2*s*t + 4*t^2 + 
     mm^2*(4*psq - 2*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*
    (-4*psq + s)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (-4*psq^2 + 2*mm^2*s - (s + 2*t)^2 + 2*psq*(s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*(-4*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(4*psq - s)*
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
  (3*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(Pi^(2*d)*s) + 
  (5*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (-8*psq^2 - 4*psq*s + 3*s^2 + 8*mm^2*(psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*(6*psq - 7*s - 6*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*(6*psq + s - 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(8*mm^2 - 4*psq + s)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(2*mm^2 + 6*psq - 3*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/(Pi^(2*d)*s) - 
  (2^(5 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(8*mm^2 - 8*psq + 3*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*(-4*psq + 5*s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(3 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(8*mm^2 - 8*psq + 3*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*(4*psq + s - 4*t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (-8*psq^2 + 12*psq*s - 3*s^2 + 2*mm^2*(4*psq - 5*s - 4*t) + 8*psq*t - 
     2*s*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(8*mm^2 - 8*psq + 3*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (24*psq^2 + s*(s + 2*t) - 4*psq*(3*s + 2*t) + mm^2*(-24*psq + 2*s + 8*t))*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (-8*psq^2 + 2*mm^2*(4*psq + s - 4*t) + s*(s - 2*t) + 8*psq*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*(psq - t)*
  ...
  (3*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (-4*mm^2 + 4*psq + 3*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p1, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(-4*mm^2 + 4*psq + 3*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (5*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (mm^2 + 2*psq - 3*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(-4*mm^2 + 4*psq + 3*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(-4*mm^2 + 4*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (-4*mm^2 + 4*psq + 3*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(7*mm^2 - 4*psq - 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(-6*psq + 7*s + 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (-4*mm^2 + 4*psq + 3*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (5*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[p3, q1]])/
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (mm^2 - 4*psq + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(-4*mm^2 + 4*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(-4*mm^2 + 4*psq + 3*s)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (6*psq + s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) - (5*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(4*psq - 5*s - 4*t)*
   ...
   (Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (4*psq + s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(2*mm^2 - psq - t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(4*psq - 5*s - 4*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(3 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(-psq + s + t)*
   ...
   (Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (4*psq + s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(psq - t)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (4*psq + s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    ...
    gWWA*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
    gWWA*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*
