...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*s*
  ...
  (2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*s*
    (aa*(2*mm^2 + 6*psq - s) + bb*(-8*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + ((aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*
    mm^2*(mm^2 + 3*psq - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (2*Pi)^(2*d) + ((aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*
  ...
  (EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*(aa*(2*mm^2 + 6*psq - s) + 
     bb*(-8*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
   (2*Pi)^(2*d) - (EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*
    (aa*(2*mm^2 + 6*psq - s) + bb*(-8*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*
   ...
   Pi^(2*d) + ((aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*
    (2*mm^2 + 6*psq - 3*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) + ((aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*(4*psq - s)*
