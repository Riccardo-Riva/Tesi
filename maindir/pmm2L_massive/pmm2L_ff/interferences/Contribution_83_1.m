...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   (-((2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
    ...
    (2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (4*(-1 + d)*psq^3 - 2*psq^2*((2 + d)*s + 6*(-1 + d)*t) - 
       ...
       psq*((-4 + d)*s^2 + 12*(-1 + d)*t^2 + 4*s*(t + 2*d*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*(-2*psq + s + 2*t)*
      (-4*(-1 + d)*psq^2 + (-4 + d)*s^2 + 8*(-1 + d)*psq*t - 4*(-1 + d)*s*t - 
       4*(-1 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
    (2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*(psq^2 - 2*psq*t + t*(s + t))*
      (4*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL*(8*(-2 + d)*psq^2 - (-6 + d)*s*(s + 2*t) - 
         4*psq*((-1 + d)*s + 2*(-2 + d)*t) + 2*mm^2*(4*(-2 + d)*psq + 8*t - 
           d*(s + 4*t))))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
    ...
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (2*(-1 + d)*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
       gZlL*(-4*(-2 + d)*psq^3 + (-6 + d)*s*t*(s + t) + 
         psq^2*((-8 + d)*s + 8*(-2 + d)*t) + 2*psq*(s^2 + (11 - 3*d)*s*t - 
           2*(-2 + d)*t^2) + mm^2*(4*(-2 + d)*psq^2 - 6*psq*s - 
           (-8 + d)*s^2 - 8*(-2 + d)*psq*t + 2*(-1 + 2*d)*s*t + 
           4*(-2 + d)*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      ...
      gZlR*mm^2*(-psq + s + t)*((10 - 4*d)*psq + (-14 + 5*d)*s + 
       2*(-5 + 2*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (-2*(gZlR*mm^2*(2*psq^2 - 5*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
         gZlL*psq*(8*psq^2 + 4*mm^2*s + 3*psq*s + s^2 - 16*psq*t + 9*s*t + 
           8*t^2)) + d*(2*gZlR*mm^2*(2*psq^2 - 5*psq*s + s^2 - 4*psq*t + 
           3*s*t + 2*t^2) + gZlL*mm^2*(2*psq^2 + psq*(s - 4*t) + 
           t*(s + 2*t)) + gZlL*psq*(6*psq^2 + s^2 + 7*s*t + 6*t^2 - 
           psq*(s + 12*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     (Pi^(2*d)*s) - (4^(1 - d)*(-4 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*
      mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
     Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (-4*(-1 + d)*gZlR*mm^2*s*(-psq + s + t) + 
       gZlL*(-8*(-2 + d)*psq^3 + (-2 + d)*psq^2*(3*s + 20*t) + 
         t*(s + t)*((-10 + 3*d)*s + 4*(-2 + d)*t) - 
         2*psq*(2*s^2 + (-16 + 7*d)*s*t + 8*(-2 + d)*t^2) + 
    ...
    (4^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(2*(-2 + d)*mm^2 - 
    ...
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (2*(-1 + d)*gZlR*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
         2*t^2) + gZlL*((28 - 10*d)*psq^3 + t*(s + t)*(-22*s + 5*d*s - 20*t + 
           6*d*t) + psq^2*(-4*d*s - 76*t + 26*d*t) + 
         psq*((-14 + 5*d)*s^2 + (58 - 15*d)*s*t + 2*(34 - 11*d)*t^2) + 
         mm^2*(12*(-2 + d)*psq^2 + psq*((2 - 3*d)*s - 24*(-2 + d)*t) - 
           (s + t)*((-6 + d)*s - 12*(-2 + d)*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*(-1 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*((-1 + d)*gZlR*mm^2 - gZlL*psq)*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (2*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL*(2*psq*s + 2*mm^2*(psq - t) + d*(psq - t)*(psq - s - t) + 
         6*psq*t - 6*s*t - 6*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*
      gWWZ*gZlL*(2*psq^2 - 3*psq*t + mm^2*(-psq + t) + t*(s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(2*(-4 + d)*psq^3 - 
       2*mm^2*psq*s + 2*mm^2*s*t + 2*(-4 + d)*psq*t*(s + 3*t) + 
       psq^2*(s - 6*(-4 + d)*t) - t*(s + t)*(s + 2*(-4 + d)*t))*
    ...
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (-4*(-1 + d)*gZlR*mm^2*s*(psq - t) + gZlL*(4*(-2 + d)*psq^3 + 
         4*mm^2*s*t - t*(s + t)*((2 + d)*s + 4*(-2 + d)*t) - 
         psq^2*((6 + d)*s + 12*(-2 + d)*t) + psq*(-4*mm^2*s - 24*t^2 + 
           d*(s^2 + 6*s*t + 12*t^2))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (4*(-1 + d)*psq^2 + 2*(-4 + d)*psq*s + (-4 + d)*s^2 - 
       8*(-1 + d)*psq*t - 2*(-4 + d)*s*t + 4*(-1 + d)*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(-((-2 + d)*psq) + s + 
       (-2 + d)*t)*(psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (-2*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t)*(psq - t) + 
       gZlL*((28 - 10*d)*psq^3 + psq*t*((30 - 13*d)*s + (68 - 22*d)*t) - 
         mm^2*(psq - t)*(4*(-2 + d)*psq + (-6 + d)*s - 4*(-2 + d)*t) + 
    ...
    (4^(2 - d)*(-1 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      (4*(-2 + d)*psq^3 - mm^2*s^2 - 2*(-2 + d)*psq^2*(s + 6*t) - 
       2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) + psq*(s^2 + 8*(-2 + d)*s*t + 
         12*(-2 + d)*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      ...
      gZlL*(2*(-2 + d)*psq^3 - mm^2*s^2 - (-2 + d)*psq^2*(s + 6*t) - 
     ...
     Pi^(2*d) + (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      ...
      (-2*(-1 + d)*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
       gZlL*(8*(-2 + d)*psq^3 - 24*(-2 + d)*psq^2*t + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      ...
      gWWZ*gZlL*(2*psq*(psq - s - t) + mm^2*(-2*psq + s + 2*t))*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p3, q1]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*psq*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*(2*(-1 + d)*gZlR*mm^2*s + 
       gZlL*((-14 + d)*psq^2 + (34 - 7*d)*psq*s + 2*(-2 + d)*mm^2*(psq - t) - 
         4*(-8 + d)*psq*t + 3*(-6 + d)*t*(s + t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - t)*
      ...
      gWWA*gWWZ*gZlL*(psq - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - s - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
    (4^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*((-2 + d)*mm^2 - 4*psq - 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*((-14 + 5*d)*psq^2 + 
       psq*((36 - 10*d)*s - 8*(-3 + d)*t) + 
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - t)*
      ...
      (-2*(-1 + d)*gZlR*mm^2*s + gZlL*(-3*(-6 + d)*psq^2 + 
         psq*(8*(-5 + d)*s + 6*(-6 + d)*t) - (-6 + d)*
          (mm^2*s + 3*t*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(mm^2 - psq)*
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[q1, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*
      gWWA*gWWZ*gZlL*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q1], SP[p3, q1]])/Pi^(2*d) - 
    (4^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(2*(-2 + d)*psq^2 + 
    ...
    (2^(3 - 2*d)*(-6 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - t)*
      (psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[p3, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*
      gWWA*gWWZ*gZlL*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - t)^2*
     ...
     Pi^(2*d) - (4^(2 - d)*(-6 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
     ...
     Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - t)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - t)^2*
     ...
     Pi^(2*d) + (4^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - t)*
      (2*(-2 + d)*psq + (-6 + d)*s - 2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(psq - t)*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*
      gWWA*gWWZ*gZlL*(psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
