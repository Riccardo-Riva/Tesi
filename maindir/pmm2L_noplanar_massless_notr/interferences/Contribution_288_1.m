...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*((-10 + 3*d)*s - 4*t)*
     SPList[SP[p1, q1]])/(Pi^(2*d)*s)) - 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*(3*(-2 + d)*s + 4*t)*
    SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*SPList[SP[p3, q1]])/
   Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*
    SPList[SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*
    gFAW^2*gWWA*SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*
    SPList[SP[p1, p3], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*
    SPList[SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*
    SPList[SP[p1, p3], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*(s + t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*(s + t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW^2*gWWA*t*
