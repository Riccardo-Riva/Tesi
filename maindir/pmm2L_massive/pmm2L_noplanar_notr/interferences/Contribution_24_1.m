...
(PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
   ...
   (4^(2 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*(-psq + s + t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*
     gXll^2*mh^2*mm^4*(2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2 - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*
