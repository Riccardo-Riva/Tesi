...
PropList[KiraPropagator[q1, mh], KiraPropagator[-p3 + q1, mm], 
 ...
 (((-I)*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    mm^2*(mm^2 - psq)*(aa*mm^2*(3*psq - 2*s - 3*t) + aa*psq*(psq - 2*s - t) + 
     bb*psq*(-psq + t) + bb*mm^2*(-3*psq + 4*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    (mm^3 - mm*psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(aa*mm^2*(7*psq + s - 7*t) + aa*psq*(psq - s - t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(aa*mm^2*(7*psq - 4*s - 7*t) + aa*psq*(psq - 4*s - t) + 
