...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  ((I*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*psq*s*(2*psq - s - 2*t)*
   ...
   (I*EL^5*gFFA*gFFZ*gFll^2*mm^2*s*
    ...
    (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gFll^2*gZlL*mm^4*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
   (I*EL^5*gFFA*gFFZ*gFll^2*mm^2*s*
     (bb*(gZlR*mm^2*(3*psq - 4*s - 3*t) + gZlR*psq*(3*psq + s - 3*t) + 
        gZlL*mm^2*(-2*psq + s + 2*t)) + aa*(-(gZlR*mm^2*(3*psq + s - 3*t)) + 
        gZlL*mm^2*(2*psq - s - 2*t) + gZlR*psq*(-3*psq + 4*s + 3*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2*Pi)^(2*d) - 
   (I*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*s*(aa*mm^2*(psq - t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*mm^2*(aa*gZlL*mm^2*(psq - 2*s - t) + 
     ...
     s*(2*bb*(psq - s - t) + aa*(3*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
