  ...
  (-((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
     ((-3 + d)*s^2 + s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     (gZlL^4 + gZlR^4)*((-4 + d)*s^2 - s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(6 - 5*d + d^2)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(3*s + 2*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(-s + (-4 + d)*t)*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(s - 2*t)*
