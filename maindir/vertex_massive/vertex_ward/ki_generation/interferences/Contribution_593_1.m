...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
 ...
 (-(((-2 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*(bb*mm^2 - aa*psq)*s*sw*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2*Pi)^(2*d)) - 
  ((-2 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*(bb*mm^2 - aa*psq)*s*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  ((-aa + bb)*(-2 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*(mm^2 + psq)*s*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  ((-aa + bb)*(-2 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*(mm^2 + psq)*s*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*(aa - bb)*d*EL^5*gFFA*gFll*gFZW*gWNl*gZlR*mm^2*(4*psq - s)*s*
    sw*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*(aa - bb)*d*EL^5*gFFA*gFll*gFZW*gWNl*gZlR*mm^2*(4*psq - s)*s*
    sw*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*(bb*mm^2 - aa*psq)*
  ...
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlL*mm^2*
   ...
   Pi^(2*d) + ((-aa + bb)*EL^5*gFFA*gFll*gFZW*gWNl*mm^2*
    (2*(-2 + d)*gZlL*(mm^2 + psq) + (-4 + d)*gZlR*s)*sw*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  ((aa - bb)*d*EL^5*gFFA*gFll*gFZW*gWNl*gZlR*mm^2*(4*psq - s)*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) + 
  ((aa - bb)*d*EL^5*gFFA*gFll*gFZW*gWNl*gZlR*mm^2*(4*psq - s)*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) + 
  ((aa - bb)*(-4 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlR*mm^2*s*sw*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFFA*gFll*gFZW*gWNl*gZlR*mm^2*sw*
