...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     ((-2 + d)*mm^4 + (-2 + d)*psq^2 - 2*mm^2*((2 + d)*psq - 2*s))*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     ((-2 + d)*mm^4 + (-2 + d)*psq^2 - 2*mm^2*((2 + d)*psq - 2*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(2*(-2 + d)*mm^4 - 
      (-2 + d)*psq*(2*psq - s) - (-6 + d)*mm^2*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     ((-2 + d)*mm^4 + (-2 + d)*psq^2 - 4*psq*s + s^2 + 
      mm^2*(-2*(-2 + d)*psq + 2*s))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     ((2 + d)*mm^2 - (-2 + d)*psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(-2*(-2 + d)*mm^4 + 
      (-2 + d)*psq*(3*psq - s - t) + mm^2*(-((2 + d)*psq) + (-6 + d)*s + 
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(-2*mm^2 + s)*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(2*(-2 + d)*mm^4 - 
      (-2 + d)*psq*(psq + t) + mm^2*(-((2 + d)*psq) + 8*s + (2 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(2*(-2 + d)*mm^4 + 
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(2*mm^2 - s)*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     ((2 + 3*d)*mm^2 - (-2 + d)*psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(2*(-2 + d)*psq^2 - 2*s^2 - 
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(-2*mm^2 + s)*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(2*mm^2 - s)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     ((2 + 3*d)*mm^2 - (-2 + d)*psq)*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(-2*(-2 + d)*psq^2 - 
      2*s^2 + (-2 + d)*psq*(s + 2*t) + mm^2*(2*(2 + d)*psq - (-2 + d)*s - 
        2*(2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     ((2 + d)*mm^2 - (-2 + d)*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(-2*mm^2 + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     ((2 + 3*d)*mm^2 - (-2 + d)*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(-2*mm^2 + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(2*mm^2 - 2*psq + s)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(-psq + s + t)*
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*((-2 + d)*mm^2 - 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*((-2 + d)*mm^2 - 
     ...
     gFFA*gFll^2*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(2*mm^2 - psq - t)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     (2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(-psq + s + t)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     ...
     gFFA*gFll^2*mm^2*(-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*
     gFFA*gFll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*
     gFll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFA*gFll^2*mm^2*
