  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^4*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^4*
     (-5*psq^3 + 3*psq^2*(3*s + 4*t) - psq*(8*s^2 + 19*s*t + 9*t^2) + 
      2*(s^3 + 4*s^2*t + 4*s*t^2 + t^3) + mm^2*(psq^2 - 2*psq*t + (s + t)^2))*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^4*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*
     (psq^2*(7*s - 4*t) + (s - 2*t)*(s + t)^2 - 6*psq*(s^2 - t^2) + 
      mm^2*(-4*psq^2 + s^2 - 5*s*t - 6*t^2 + psq*(s + 10*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*
     (-8*psq^3 + 3*psq^2*(s + 6*t) + psq*(s^2 - 11*s*t - 14*t^2) + 
      2*t*(s^2 + 3*s*t + 2*t^2) + mm^2*(4*psq^2 - 7*psq*s + 2*s^2 - 6*psq*t + 
        9*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*
     (-2*psq^3 - 2*mm^4*(psq - t) + 2*t^2*(s + t) + psq^2*(-4*s + 6*t) + 
      psq*(s^2 + s*t - 6*t^2) + mm^2*(11*psq^2 + t*(5*s + 9*t) - 
        2*psq*(s + 10*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*
     (mm^2*(2*psq^2 - s^2 + 6*s*t + 2*t^2 - 4*psq*(s + t)) + 
      2*(psq^2*(-4*s + t) - (s - t)*(s + t)^2 + psq*(5*s^2 + 2*s*t - 2*t^2)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*
     (-psq^3 + mm^4*s - psq^2*(s - 3*t) - (s - t)*(s + t)^2 + 
      psq*(4*s^2 - 3*t^2) + mm^2*(2*psq^2 + 2*t*(2*s + t) - psq*(5*s + 4*t)))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*
     ...
     gXll*mm^2*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
      t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*
     (-3*psq^2 + mm^2*(3*psq + 2*s - 3*t) + 2*s*(s + 2*t) + psq*(-6*s + 3*t))*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*(psq - t)^2*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*mm^2*
     ...
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWNl*gXFW*gXll*
