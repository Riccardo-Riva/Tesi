...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA^3*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   Pi^(2*d) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) - (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA^3*
