...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  (((-I)*2^(-1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*s^2*
     ...
     (1 + GaugeXi[Q])^2*SPList[SP[p1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)^2*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gAu*gWWZ^2*s^2*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
         (s - (-3 + d)*t) + 2^(1 + d)*gZuR*Pi^d*(-2*s + (-3 + d)*t)) - 
      gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
         (2*s - (-3 + d)*t) + 2^(1 + d)*gZuR*Pi^d*(-s + (-3 + d)*t)))*
     (1 + GaugeXi[Q])^2*SPList[SP[q1, q1]])/(2^(2*(1 + d))*mw^4*Pi^(2*d)*
     (mz^2 - s)^2*GaugeXi[Q]^2) - (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*s*t*
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*s*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
     ...
     GaugeXi[Q]^2) - (I*EL^6*gAl*gAu*gWWZ^2*(gZlL + gZlR)*(gZuL + gZuR)*s^2*
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*s*
     (2^(3 + d)*Pi^d*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
      ...
      4*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*s*
     (-(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
         2^(1 + d)*(-3 + d)*gZuL*Pi^d*(2*s + 3*t) + 2^(1 + d)*gZuR*Pi^d*
          ((3 - 2*d)*s - 3*(-3 + d)*t))) + 
      gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s - 
        2^(1 + d)*(-3 + d)*gZuR*Pi^d*(2*s + 3*t) + 2^(1 + d)*gZuL*Pi^d*
         ((-3 + 2*d)*s + 3*(-3 + d)*t)))*(1 + GaugeXi[Q])*
     SPList[SP[p1, q1], SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*(mz^2 - s)^2*
     GaugeXi[Q]^2) - (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*s*t*
     (gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
        d*gZuR*(2*Pi)^d) + gZlL*(2^(1 + d)*gZuL*Pi^d - 2^(2 + d)*gZuR*Pi^d - 
        d*gZuL*(2*Pi)^d + d*gZuR*(2*Pi)^d) + 
      2^(1 + d)*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*s*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
        2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t) + 
      gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
        2*(-3 + d)*gZuR*t))*(1 + GaugeXi[Q])*SPList[SP[q1, q1], SP[q1, q1]])/
    (mw^4*(2*Pi)^d*(mz^2 - s)^2*GaugeXi[Q]^2) - 
 ...
 PropList[KiraPropagator[p1 - q1, mw], KiraPropagator[-p2 - q1, mw]]*
  (((-I)*EL^6*gAl*gAu*gWWZ^2*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*
     ...
     SPList[SP[p1, p2]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*s*GaugeXi[Q]^2) + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*
     (gZlL*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
      ...
      gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
        ...
        2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2)))*
     (mw^2 - 2*s - 2*(mw^2 + s)*GaugeXi[Q] + mw^2*GaugeXi[Q]^2)*
     SPList[SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*s*GaugeXi[Q]^2) - 
      ...
      (s^2*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*Pi^d*
          ...
          gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
            2^(1 + d)*gZuL*Pi^d*(2*s - (-3 + d)*t) + 2^(1 + d)*gZuR*Pi^d*
             (-s + (-3 + d)*t)))*(1 + GaugeXi[Q])^2 + 2^(1 + d)*mw^4*Pi^d*
         (gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 2*(-3 + d)*gZuL*t - 
            2*(-3 + d)*gZuR*t) + gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 
            2*(-3 + d)*gZuL*t + 2*(-3 + d)*gZuR*t))*(1 + 2*GaugeXi[Q] + 
          (-3 + 2*d)*GaugeXi[Q]^2) + 2*mw^2*(13*d*gZlL*gZuR*(2*Pi)^d*s^2 - 
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*(2^(1 + d)*((-2 + d)*gZlL*gZuL - 
     ...
     SPList[SP[p1, p2], SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)^2*s*
       ...
       (s*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
        ...
        (13*d*gZlL*gZuR*(2*Pi)^d*s^2 - 9*d*gZlR*gZuR*(2*Pi)^d*s^2 - 
          2^(1 + d)*gZlL*gZuR*Pi^d*((10 + d^2)*s^2 + (11 - 11*d + 2*d^2)*s*
           ...
           (-9*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((5 + d^2)*s^2 + 
              (19 - 11*d + 2*d^2)*s*t + 4*t^2)))*GaugeXi[Q]))*
     SPList[SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)^2*s*
     GaugeXi[Q]^2) - (I*EL^6*gAl*gAu*gWWZ^2*(gZlL + gZlR)*(gZuL + gZuR)*
     (2*mw^4 - 3*mw^2*s + s^2 + 2*(2*mw^4 - 3*mw^2*s + s^2)*GaugeXi[Q] + 
      ((-6 + 4*d)*mw^4 - 3*mw^2*s + s^2)*GaugeXi[Q]^2)*
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*(2^(3 + d)*Pi^d*
       (gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 2*(-3 + d)*gZuL*t - 
          2*(-3 + d)*gZuR*t) + gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 
          2*(-3 + d)*gZuL*t + 2*(-3 + d)*gZuR*t)) + 
      2^(1 + d)*Pi^d*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
 ...
 PropList[KiraPropagator[p1 - q1, mw], KiraPropagator[-p2 - q1, 
  ...
  (((-I)*EL^6*gAl*gAu*gWWZ^2*s*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - 
      ...
      gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
        2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2) + 
        2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2)))*
     (1 + GaugeXi[Q])^2)/(2^(2*(1 + d))*mw^2*Pi^(2*d)*(mz^2 - s)^2*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gAu*gWWZ^2*
     (gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
        2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2) + 
        ...
        2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2) + 
        2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2)))*
     (1 + GaugeXi[Q])*SPList[SP[p1, p2]])/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*
     GaugeXi[Q]^2) + ((I/2)*EL^6*gAl*gAu*gWWZ^2*
     (-((2^(1 - 2*d)*mw^2*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*
      ...
      ((-1 + GaugeXi[Q]^2)*((2^(1 - d)*mw^2*(-1 + GaugeXi[Q])*
           (-(gZlR*gZuL*((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*t - 4*
                t^2)) - gZlL*gZuR*((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*
               t - 4*t^2) + gZlL*gZuL*((2 - 3*d + d^2)*s^2 + 2*(5 - 4*d + 
                d^2)*s*t + 4*t^2) + gZlR*gZuR*((2 - 3*d + d^2)*s^2 + 
              2*(5 - 4*d + d^2)*s*t + 4*t^2) - 
            (-(gZlR*gZuL*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*t - 
                 4*t^2)) - gZlL*gZuR*((12 - 7*d + d^2)*s^2 + 
                2*(7 - 6*d + d^2)*s*t - 4*t^2) + gZlL*gZuL*((6 - 5*d + d^2)*
                 s^2 + 2*(11 - 6*d + d^2)*s*t + 4*t^2) + gZlR*gZuR*(
                (6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*t + 4*t^2))*
             GaugeXi[Q]))/Pi^d + 
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - 
      ...
      gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
        2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2) + 
        2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2)))*
     (1 + GaugeXi[Q])*SPList[SP[p2, q1]])/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*
     ...
     ((2^(1 - d)*mw^2*(-1 + GaugeXi[Q])*
        (-(gZlR*gZuL*((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*t - 4*t^2)) - 
         ...
         gZlR*gZuR*((2 - 3*d + d^2)*s^2 + 2*(5 - 4*d + d^2)*s*t + 4*t^2) - 
         (-(gZlR*gZuL*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*t - 
              4*t^2)) - gZlL*gZuR*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*
              t - 4*t^2) + gZlL*gZuL*((6 - 5*d + d^2)*s^2 + 
             2*(11 - 6*d + d^2)*s*t + 4*t^2) + gZlR*gZuR*
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*(-(mw^2*(-1 + GaugeXi[Q])^2*
        (gZlL*(d*gZuL*(2*Pi)^d*s*(d*s - 11*t) - d*gZuR*(2*Pi)^d*s*
            (d*s - 11*t) + 2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - 
             (6 + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZuL*Pi^d*(-2*(-1 + d)*s^2 + 
             (9 + d^2)*s*t + 2*t^2)) + 
         gZlR*(-(d*gZuL*(2*Pi)^d*s*(d*s - 11*t)) + d*gZuR*(2*Pi)^d*s*
      ...
      (s^2*t*(gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + 
         ...
         (gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + 
             d*gZuL*(2*Pi)^d - d*gZuR*(2*Pi)^d) + gZlL*(2^(1 + d)*gZuL*Pi^d - 
             2^(2 + d)*gZuR*Pi^d - d*gZuL*(2*Pi)^d + d*gZuR*(2*Pi)^d))*
          GaugeXi[Q]^4))/2)*SPList[SP[p1, p2], SP[p1, p2]])/
    (4^d*mw^4*Pi^(2*d)*(mz^2 - s)^2*s*(-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) + 
   (I*2^(-1 - d)*EL^6*gAl*gAu*gWWZ^2*(2*mw^2 - s)*
    ...
    (mw^4*Pi^d*(mz^2 - s)^2*GaugeXi[Q]^2) + 
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*
     (s*(gZlR*(3*2^(1 + d)*gZuL*mw^2*Pi^d*((-4 + d)*s + 2*(-3 + d)*t) - 
          3*2^(1 + d)*gZuR*mw^2*Pi^d*((-2 + d)*s + 2*(-3 + d)*t) - 
          5*gZuR*s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + 3*t - d*t)) + 
          5*gZuL*s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 3*t - d*t))) + 
        gZlL*(3*2^(1 + d)*gZuR*mw^2*Pi^d*((-4 + d)*s + 2*(-3 + d)*t) - 
          3*2^(1 + d)*gZuL*mw^2*Pi^d*((-2 + d)*s + 2*(-3 + d)*t) - 
          5*gZuL*s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + 3*t - d*t)) + 
          5*gZuR*s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 3*t - d*t)))) + 
      2*(gZlL*(-(2^(1 + d)*gZuR*mw^2*Pi^d*((-4 + d)^2*s^2 + 
             2*(10 - 7*d + d^2)*s*t - 4*t^2)) + 3*gZuR*s^2*
           (-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + 
          gZuL*(2^(1 + d)*mw^2*Pi^d*((8 - 6*d + d^2)*s^2 + 2*(14 - 7*d + d^2)*
               s*t + 4*t^2) - 3*s^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
                (-3 + d)*t)))) + gZlR*(-(2^(1 + d)*gZuL*mw^2*Pi^d*
            ((-4 + d)^2*s^2 + 2*(10 - 7*d + d^2)*s*t - 4*t^2)) + 
          3*gZuL*s^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + 
          gZuR*(2^(1 + d)*mw^2*Pi^d*((8 - 6*d + d^2)*s^2 + 2*(14 - 7*d + d^2)*
               s*t + 4*t^2) - 3*s^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 
                (-3 + d)*t)))))*GaugeXi[Q] + 
      s*(gZlL*(2^(1 + d)*gZuR*mw^2*Pi^d*((-4 + d)*s + 2*(-3 + d)*t) - 
          2^(1 + d)*gZuL*mw^2*Pi^d*((-2 + d)*s + 2*(-3 + d)*t) + 
          gZuL*s*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
          gZuR*s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 3*t - d*t))) + 
        gZlR*(-(gZuR*(2^(1 + d)*mw^2*Pi^d*((-2 + d)*s + 2*(-3 + d)*t) + 
             s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + 3*t - d*t)))) + 
          gZuL*(2^(1 + d)*mw^2*Pi^d*((-4 + d)*s + 2*(-3 + d)*t) + 
     ...
     (-(mw^2*(-1 + GaugeXi[Q])^2*(gZlL*(d*gZuL*(2*Pi)^d*s*(d*s - 11*t) - 
      ...
      (s^2*t*(gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + 
         ...
         (gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + 
             d*gZuL*(2*Pi)^d - d*gZuR*(2*Pi)^d) + gZlL*(2^(1 + d)*gZuL*Pi^d - 
             2^(2 + d)*gZuR*Pi^d - d*gZuL*(2*Pi)^d + d*gZuR*(2*Pi)^d))*
          GaugeXi[Q]^4))/2)*SPList[SP[p1, p2], SP[p2, q1]])/
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*
     (s^2*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
          ...
          d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(2*s - (-3 + d)*t) + 
          2^(1 + d)*gZuR*Pi^d*(-s + (-3 + d)*t)))*(1 + GaugeXi[Q]) - 
      mw^2*(2*Pi)^d*(gZlL*gZuR*((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*t - 
    ...
    (4^d*mw^4*Pi^(2*d)*(mz^2 - s)^2*s*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gAu*gWWZ^2*(gZlL + gZlR)*(gZuL + gZuR)*s*(-2*mw^2 + s)*
     (1 + GaugeXi[Q])^2*SPList[SP[p1, p3], SP[p1, p3]])/
    (mw^4*(2*Pi)^d*(mz^2 - s)^2*GaugeXi[Q]^2) - 
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*
     ((2^(2 - d)*s^2*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
      ...
      (2^(1 - 2*d)*(s^2*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
             2^(1 + d)*gZuL*Pi^d*(s - (-3 + d)*t) + 2^(1 + d)*gZuR*Pi^d*
              (-2*s + (-3 + d)*t)) - gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
             d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(2*s - (-3 + d)*t) + 
             2^(1 + d)*gZuR*Pi^d*(-s + (-3 + d)*t)))*(1 + GaugeXi[Q]) - 
         mw^2*(2*Pi)^d*(gZlL*gZuR*((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*
              ...
              s*t + 4*t^2) + gZlR*(gZuL*((4 - 5*d + d^2)*s^2 + 2*
                (1 - 4*d + d^2)*s*t - 4*t^2) - gZuR*((2 - 3*d + d^2)*s^2 + 2*
                (5 - 4*d + d^2)*s*t + 4*t^2)) + 
           (-(gZlR*gZuL*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*t - 
                4*t^2)) - gZlL*gZuR*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*
                s*t - 4*t^2) + gZlL*gZuL*((6 - 5*d + d^2)*s^2 + 2*
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*
     ((2^(2 - d)*s^2*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
      ...
      (s^2*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
        ...
        mw^2*(2*Pi)^d*(gZlL*gZuR*((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*
             t - 4*t^2) - gZlL*gZuL*((2 - 3*d + d^2)*s^2 + 2*(5 - 4*d + d^2)*
             s*t + 4*t^2) + gZlR*(gZuL*((4 - 5*d + d^2)*s^2 + 
              2*(1 - 4*d + d^2)*s*t - 4*t^2) - gZuR*((2 - 3*d + d^2)*s^2 + 
              2*(5 - 4*d + d^2)*s*t + 4*t^2)) + 
          (-(gZlR*gZuL*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*t - 4*
              ...
              2*(11 - 6*d + d^2)*s*t + 4*t^2))*GaugeXi[Q]))/(2*Pi)^(2*d))*
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*(-(mw^2*(-1 + GaugeXi[Q])^2*
      ...
      (s^2*t*(gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + 
         ...
         (gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + 
             d*gZuL*(2*Pi)^d - d*gZuR*(2*Pi)^d) + gZlL*(2^(1 + d)*gZuL*Pi^d - 
             2^(2 + d)*gZuR*Pi^d - d*gZuL*(2*Pi)^d + d*gZuR*(2*Pi)^d))*
          GaugeXi[Q]^4))/2)*SPList[SP[p2, q1], SP[p2, q1]])/
    (4^d*mw^4*Pi^(2*d)*(mz^2 - s)^2*s*(-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) + 
   (I*2^(-1 - d)*EL^6*gAl*gAu*gWWZ^2*(2*mw^2 - s)*
     (gZlL*gZuL*((-2 + d)*s - 2*t) + gZlR*gZuR*((-2 + d)*s - 2*t) - 
      gZlR*gZuL*((-4 + d)*s + 2*t) - gZlL*gZuR*((-4 + d)*s + 2*t))*
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*
     ((2^(3 - d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
        ...
        (gZlL*(2*(-3 + d)*gZuL*s - 2*(-3 + d)*gZuR*s + (-10 + 3*d)*gZuL*t + 
           (8 - 3*d)*gZuR*t) + gZlR*(-2*(-3 + d)*gZuL*s + 2*(-3 + d)*gZuR*s + 
           (8 - 3*d)*gZuL*t + (-10 + 3*d)*gZuR*t))*(1 + GaugeXi[Q]))/
       (Pi^d*s) + (2^(2 + d)*Pi^d*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
            2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t) + 
          gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
            2*(-3 + d)*gZuR*t))*GaugeXi[Q] + 
        (mw^2*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
             ...
             d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(2*s - (-3 + d)*t) + 
             2^(1 + d)*gZuR*Pi^d*(-s + (-3 + d)*t)))*(-3 - 2*GaugeXi[Q] + 
           GaugeXi[Q]^2))/s)/(2*Pi)^(2*d))*SPList[SP[p1, p2], SP[p1, q1], 
      SP[p1, q1]])/(mw^4*(mz^2 - s)^2*GaugeXi[Q]^2) - 
   (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*
   ...
   (I*EL^6*gAl*gAu*gWWZ^2*(1 + GaugeXi[Q])*
    ...
    (mw^4*(mz^2 - s)^2*GaugeXi[Q]^2) + 
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWWZ^2*
     (2^(4 + d)*Pi^d*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
          2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t) + 
        gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
          2*(-3 + d)*gZuR*t)) + 2^(2 + d)*Pi^d*
       (gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 2*(-3 + d)*gZuL*t - 
          2*(-3 + d)*gZuR*t) + gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 
     ...
     ((2^(3 - d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
       ...
       (Pi^d*s) + (2^(2 + d)*Pi^d*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
        ...
        (mw^2*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
             ...
             d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(2*s - (-3 + d)*t) + 
             2^(1 + d)*gZuR*Pi^d*(-s + (-3 + d)*t)))*(-3 - 2*GaugeXi[Q] + 
           GaugeXi[Q]^2))/s)/(2*Pi)^(2*d))*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q1]])/(mw^4*(mz^2 - s)^2*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gAu*gWWZ^2*(d*gZlR*(gZuL - gZuR)*s + 
      gZlL*(6*gZuL*s - d*gZuL*s + d*gZuR*s + 2*gZuL*t + 2*gZuR*t) + 
      2*gZlR*(gZuL*t + gZuR*(3*s + t)))*(1 + GaugeXi[Q])*
 ...
 PropList[KiraPropagator[-p1 + q1, mw], KiraPropagator[p2 + q1, 
   ...
   ((I/2)*EL^6*gAl*gAu*gWWZ^2*
     ((2^(1 - 2*d)*(2*s^2*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
      ...
      (-(mw^2*(-1 + GaugeXi[Q])^2*((gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*
                gZuR*Pi^d + d*gZuL*(2*Pi)^d - d*gZuR*(2*Pi)^d) + 
             gZlL*(2^(1 + d)*gZuL*Pi^d - 2^(2 + d)*gZuR*Pi^d - d*gZuL*
                (2*Pi)^d + d*gZuR*(2*Pi)^d))*s*t - 2^(1 + d)*
            ((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - (-4 + d)*gZlL*gZuR + 
             (-2 + d)*gZlR*gZuR)*Pi^d*s*t*GaugeXi[Q] + 
           (21*d*gZlL*gZuR*(2*Pi)^d*s*t - 21*d*gZlR*gZuR*(2*Pi)^d*s*t - 
             2^(1 + d)*gZlL*gZuR*Pi^d*((8 - 6*d + d^2)*s^2 + 2*(5 + d^2)*s*
                t - 4*t^2) + 2^(1 + d)*gZlR*gZuR*Pi^d*((-2 + d)^2*s^2 + 
               (17 + 2*d^2)*s*t + 4*t^2) - gZlR*gZuL*(-21*d*(2*Pi)^d*s*t + 
     ...
     ((2^(3 - d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
      ...
      (2^(2 + d)*Pi^d*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
        ...
        (mw^2*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
             ...
             d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(2*s - (-3 + d)*t) + 
             2^(1 + d)*gZuR*Pi^d*(-s + (-3 + d)*t)))*(-3 - 2*GaugeXi[Q] + 
           GaugeXi[Q]^2))/s)/(2*Pi)^(2*d))*SPList[SP[p1, p2], SP[p2, q1], 
      SP[p2, q1]])/(mw^4*(mz^2 - s)^2*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gAu*gWWZ^2*(1 + GaugeXi[Q])*
     ((2^(2 - d)*(gZlL + gZlR)*(gZuL + gZuR)*(-mw^2 + 2*s + mw^2*GaugeXi[Q]))/
       Pi^d - ((d*gZlR*(gZuL - gZuR)*s + gZlL*(6*gZuL*s - d*gZuL*s + 
