...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-4*psq^3 + (-2 + d)^2*mm^4*s + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
    ((d*psq - 4*s)*(-2*psq + (-2 + d)*s + 2*t) + 
     mm^2*(2*(-8 + d)*psq - d^2*s + 2*d*(s - t) + 16*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - psq)*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(4*mm^2 - 4*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - psq)*
    (2*(-2 + d)*mm^2 - (2 + d)*psq + 2*s + 6*t - d*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(2*(-4 + d)*psq + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*psq^2 - 3*s^2 + d*s^2 + 
     psq*(5*s - 2*d*s - 4*t) + s*t + 2*t^2 + mm^2*(-2*psq + d*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(psq - t)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*psq^2 - 2*s^2 + d*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*mm^2 - (2 + d)*psq + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*mm^2 + (10 - 3*d)*psq - 
