...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (((-I)*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*(2*bb*(mm^2 - psq)*(psq - t) - 
       2*aa*(mm^2 - psq)*(psq - s - t) + bb*d*(mm^4 + psq*(psq - t) - 
         mm^2*(s + t)) + aa*d*(mm^4 + mm^2*(-2*psq + t) + 
         psq*(-psq + s + t)))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
      ...
      (aa*(-((-4 + d)*psq^2) + 4*(-3 + d)*psq*s + (-4 + d)*psq*t - 
         2*(-2 + d)*s*t + mm^2*((-4 + 3*d)*psq + 8*s - 4*d*s + 4*t - 
           3*d*t)) + bb*((-4 + d)*psq^2 - (-4 + 3*d)*mm^2*(psq - t) + 
         2*(-2 + d)*s*t + psq*(4*s + 4*t - d*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl^3*
      gHll^2*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^4*s*
    ...
    (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*
      (bb*((-4 + d)*psq^2 - (-4 + d)*mm^2*(psq - t) - 2*s*(s + t) + 
         ...
         (-4 + d)*psq*t + 2*s*(s + t) + mm^2*((-4 + d)*psq + 8*s - d*s + 
           4*t - d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^2*
      (4*aa*mm^2*(psq - s - t) - aa*s*(-3*psq + s + t) + 
       bb*s*(-psq + s + t) + bb*mm^2*(-4*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*
      (bb*((-4 + d)*mm^4 - (-4 + d)*psq*s + mm^2*(2*(-2 + d)*psq + 4*s - 
           d*s + 8*t - 3*d*t)) + aa*((-4 + 3*d)*mm^4 + (-4 + d)*psq*s + 
    ...
    (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*s*(psq - t) + 
       bb*s*((-2 + d)*psq + 2*t) + aa*mm^2*((-4 + 5*d)*psq - 2*d*s + 4*t - 
         5*d*t) + bb*mm^2*((4 - 5*d)*psq - 4*t + d*(s + 5*t)))*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*s*
     ...
     Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*
      (d*(mm^2 - psq) + 4*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
