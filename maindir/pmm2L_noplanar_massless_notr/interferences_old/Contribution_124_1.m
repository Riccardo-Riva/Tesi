 ...
 ((EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-68 + 62*d - 15*d^2 + d^3)*s^2 + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(3*s - 2*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(12 - 8*d + d^2)*EL^8*gAl^2*gAu^2*
    ...
    (gZlL^4 + gZlR^4)*((-6 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(s + 2*t)*
   ...
   (Pi^(2*d)*s) + (4^(1 - d)*(-168 + 106*d - 19*d^2 + d^3)*EL^8*gAl^2*gAu^2*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-10 + d)*s - 6*t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-4 + d)*s + 6*t)*
  ...
  (EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-80 + 64*d - 14*d^2 + d^3)*s + 
   ...
   ((2*Pi)^(2*d)*s^2) + (2^(3 - 2*d)*(6 - 5*d + d^2)*EL^8*gAl^2*gAu^2*
    (gZlL^4 + gZlR^4)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    (gZlL^4 + gZlR^4)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    (gZlL^4 + gZlR^4)*(d*s + 6*t)*\[Mu]^(8 - 2*d)*
