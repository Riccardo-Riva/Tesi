...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
 ...
 (((-I)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*(2*psq - s - 2*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*
   ...
   Pi^(2*d) + (I*(-aa + bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*(psq - t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(mm^2 + 2*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*aa*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(mm^2 + 2*psq)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(mm^2 + 2*psq)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*bb*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*bb*EL^5*gFFA*gFll*gHFW*gHll*gWlN*
