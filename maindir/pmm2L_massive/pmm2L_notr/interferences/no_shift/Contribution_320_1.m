...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(2*(-2 + d)*mm^4*s - 
      s*(4*psq^2 - 3*(-2 + d)*psq*s + (-2 + d)*s^2 - 8*psq*t + 4*s*t + 
        4*t^2) + mm^2*(8*psq^2 + (-2 + d)*s^2 + 8*s*t + 8*t^2 - 
        2*psq*((-2 + d)*s + 8*t)))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (8*psq^2 + mm^2*(4*psq - 10*s + 3*d*s - 4*t) - psq*(s + 2*d*s + 14*t) + 
      3*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (-6*psq^2 + 4*mm^2*(psq + s - d*s - t) + psq*(3*(-2 + d)*s + 10*t) - 
      2*((-3 + d)*s^2 + s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (-4*psq^2 + mm^2*(4*psq + 6*s - 3*d*s - 4*t) - 3*t*(s + 2*t) + 
      psq*(-7*s + 2*d*s + 10*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (2*psq^2 - 4*s^2 + 2*d*s^2 + psq*((4 - 3*d)*s - 6*t) + 
      4*mm^2*(psq + (-2 + d)*s - t) + 6*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (4*mm^2 + 2*psq + (-5 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (4*psq^2 + (2 + d)*mm^2*s - 8*s^2 + 3*d*s^2 + 4*s*t + 4*t^2 - 
      psq*(d*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (4*psq^2 + (-2 + d)*mm^2*s - 3*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
      psq*((-2 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (2*(-6 + d)*mm^4*s - s*(4*psq^2 - 3*(-4 + d)*psq*s + (-4 + d)*s^2 - 
        8*psq*t + 4*s*t + 4*t^2) + 2*mm^2*(2*psq^2 - (-4 + d)*s^2 + 2*s*t + 
        2*t^2 - psq*((-6 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (3*psq^2 + 2*mm^2*(psq + (-3 + d)*s - t) + 2*(s + t)^2 - 
      psq*(s + d*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-7 + 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*
     mm^6*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (4*mm^4 + psq^2 + 2*mm^2*(psq + (-5 + d)*s - 3*t) + 2*t*(s + t) - 
      psq*((-5 + d)*s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (-4*psq^2 - 8*s^2 + d*s^2 - 2*mm^2*(5*psq + (-5 + d)*s - 5*t) - 8*s*t - 
      4*t^2 + psq*((4 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     ...
     gXll^2*mm^4*(6*psq^2 - 4*s^2 + d*s^2 - 2*mm^2*(psq + 3*s - d*s - t) + 
      4*s*t + 4*t^2 - 2*psq*((-3 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (4*mm^4 + 3*psq^2 + 2*t*(s + t) + 2*mm^2*(-5*psq + (-2 + d)*s + 3*t) - 
      psq*((-4 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (s*(-((-4 + d)*psq) + (-6 + d)*s - 2*t) + 2*mm^2*(-psq + (3 + d)*s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (6*psq^2 - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 + 
      mm^2*(-4*psq + 3*(-2 + d)*s + 4*t) - 2*psq*((-3 + d)*s + 5*t))*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (psq^2 - 2*mm^2*(psq - (-2 + d)*s - t) + 2*t^2 - psq*((-4 + d)*s + 3*t))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (-4*psq^2 + (-4 + d)*psq*s - 4*s^2 + d*s^2 + 
      2*mm^2*(5*psq - d*s - 5*t) + 8*psq*t - 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*
     gXll^2*mm^4*(2*psq^2 - 4*s^2 + d*s^2 + 2*mm^2*(psq + (-4 + d)*s - t) + 
      4*s*t + 4*t^2 - 2*psq*((-4 + d)*s + 3*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (2*psq^2 - 4*s^2 + d*s^2 + mm^2*(4*psq + (-10 + 3*d)*s - 4*t) + 4*s*t + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(6*mm^2 + (-5 + d)*s)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(4*mm^2 + (-3 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (4*psq^2 + d*s*(mm^2 + s) - psq*((-2 + d)*s + 8*t) + 
      4*(-s^2 + s*t + t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     ...
     mm^4*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(2*mm^2 - 3*psq + s + t)*
   ...
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(mm^2 - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(2*mm^2 - 8*psq - 2*s + 
      d*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*
     mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(-2*psq + s + 2*t)*
   ...
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
