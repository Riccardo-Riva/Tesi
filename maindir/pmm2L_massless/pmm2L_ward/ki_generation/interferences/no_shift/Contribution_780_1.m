(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (((-5*I)*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(s + t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
     ((-2 + d)*s + (-7 + 4*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   ((5*I)*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(s + 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
     ((-5 + 3*d)*s + 2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
   ((15*I)*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(s + 2*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
     ((-3 + 2*d)*s - (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
     ((-2 + d)*s + (-7 + 4*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
   ((5*I)*4^(1 - d)*(-aa + bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*t*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ^2*
     ((-3 + 2*d)*s + (-1 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
