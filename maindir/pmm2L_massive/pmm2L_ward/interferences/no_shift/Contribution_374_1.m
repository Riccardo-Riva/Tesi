...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*EL^5*gAl^2*gWlN*gWNl*gWWA*mm^2*s*
     (-(bb*((2 - 3*d)*psq^2 + (-4 + 5*d)*psq*s + (-2 + d)*mm^2*
      ...
      aa*((-6 + d)*psq^2 + (-2 + 4*d)*psq*s + (-2 + d)*mm^2*(psq - s - 3*t) + 
        (2 + d)*psq*t - 2*(-1 + d)*s*(s + 2*t)))*\[Mu]^(8 - 2*d))/
    (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (bb*(-((-2 + d)*mm^4*(2*psq - s - 2*t)) - 
     ...
     (aa*(4*(-2 + d)*psq^2 + (-5 + 2*d)*s*(s + t) + 
      ...
      bb*(-2*(-2 + d)*psq^2 + (-11 + 4*d)*psq*s + 2*(-2 + d)*psq*t - 
        (-5 + 2*d)*s*(s + t) + mm^2*((5 - 4*d)*psq - 3*s + 2*d*s - 5*t + 
          4*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(2*aa*(-2 + d)*mm^4 + 
      aa*(-2 + d)*s*(-3*psq + s + t) - bb*(-2 + d)*s*(-psq + s + t) + 
      aa*mm^2*((8 + d)*psq + (-4 + d)*s - (4 + 3*d)*t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (2*bb*(-1 + d)*mm^2*(2*psq - s - 2*t) - aa*(-2 + d)*s*(-3*psq + s + t) + 
      bb*(-2 + d)*s*(-psq + s + t) + 2*aa*mm^2*(-2*(-1 + d)*psq + s + 
        2*(-1 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
