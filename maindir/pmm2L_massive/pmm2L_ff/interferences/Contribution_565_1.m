...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(psq^2 - 2*psq*t + t*(s + t))*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(mm^2*(9*psq - 8*s - 9*t) + 
     ...
     Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^6*
      (mm^2*(8*psq - 5*s - 8*t) + 2*psq*(psq - t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*
      (psq*s + mm^2*(4*psq - 3*s - 4*t))*(psq^2 - 2*psq*t + t*(s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq*s + 2*mm^2*(5*psq - 3*s - 5*t))*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(-psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq*s + 7*mm^2*(psq - t))*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq - t)*(3*psq^2 + 2*t*(s + t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^2*(psq - t) + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^2 - 2*psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(-psq^2 + mm^2*s + 2*psq*t - 
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*
      (2*psq*(-psq + s + t) + mm^2*(-2*psq + 3*s + 2*t))*\[Mu]^(8 - 2*d)*
