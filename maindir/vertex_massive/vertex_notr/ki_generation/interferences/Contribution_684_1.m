...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[q2, mw], 
 ...
 (-((d*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*s*(mm^2 - 3*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*s*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*s*(3*mm^2 - psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*d*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(3*mm^2 + (-3 + d)*psq - 
     (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(d*(mm^2 - psq) + 4*psq - 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(2*mm^2 + 2*psq - d*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(2*(2 + d)*mm^2 + d*(-2*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(3*mm^2 - 2*psq + s)*
  ...
  (2^(1 - 2*d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(mm^2 + psq - d*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(3*mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*((-5 + 2*d)*mm^2 + (5 - 2*d)*psq + 
     (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (4^(1 - d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*s*
  ...
  (2^(1 - 2*d)*d*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(2*mm^2 - 2*psq + (-4 + d)*s)*
   ...
   (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^6*gAl*ggagmW^2*gWlN*gWNl*gWWA*(mm^2 - psq + (-2 + d)*s)*
