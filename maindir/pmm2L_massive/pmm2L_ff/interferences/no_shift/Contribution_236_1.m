...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(psq - t)^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(psq - t)*
    ...
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q2, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*
