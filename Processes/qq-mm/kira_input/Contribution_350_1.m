...
(I*EL^6*gAl*gAu*(gZlL^3 + gZlL^2*gZlR + gZlL*gZlR^2 + gZlR^3)*(gZuL + gZuR)*
  ...
  ((2*Pi)^d*(mz^2 - s)^2*s) + ((I/2)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
   ((2^(1 - d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
    ...
    (gZlR*gZuL*(4*mm^2 + 2*(-5 + d)*mmv^2 + 4*s - d*s + 6*t - 2*d*t) + 
     ...
     (2*Pi)^d)*userIntegral[A6, {ml}, -1, 0, 1, 0])/((mz^2 - s)^2*s) - 
 ...
 (I*2^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*((-4 + d)*gZlL*gZuL - 
  ...
  (Pi^d*(mz^2 - s)^2*s) + (I*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
   ...
   userIntegral[A6, {ml}, 0, 0, 0, 0])/((2*Pi)^d*(mz^2 - s)^2*s) + 
 (I*2^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
   ...
   userIntegral[A6, {ml}, 0, 0, 1, -1])/(Pi^d*(mz^2 - s)^2*s) + 
 ((I/4)*EL^6*gAl*gAu*
   ...
   userIntegral[A6, {ml}, 0, 0, 1, 0])/((mz^2 - s)^2*s) + 
 ((I/2)*EL^6*gAl*gAu*((2^(1 - d)*(gZlL^3 + gZlL^2*gZlR + gZlL*gZlR^2 + 
   ...
   userIntegral[A6, {ml}, 0, 1, -1, 0])/((mz^2 - s)^2*s) + 
 (I*2^(-1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*
   (gZlL*gZuL*(2*mmv^2 + (-6 + d)*s - 2*t) + 
    gZlR*gZuR*(2*mmv^2 + (-6 + d)*s - 2*t) + 
    gZlR*gZuL*(2*mmv^2 - d*s - 2*t) + gZlL*gZuR*(2*mmv^2 - d*s - 2*t))*
   userIntegral[A6, {ml}, 0, 1, 0, -1])/(Pi^d*(mz^2 - s)^2*s) + 
 (I*4^(-1 - d)*EL^6*gAl*gAu*
   (gZlR^3*(gZuR*(-(2^(3 + d)*mmv^4*Pi^d) + 2^(4 + d)*mm^2*Pi^d*s - 
    ...
    gZlL^2*gZlR*(gZuL*(-(2^(3 + d)*mmv^4*Pi^d) + 2^(4 + d)*mm^2*Pi^d*s - 
        ...
        2^(2 + d)*Pi^d*t^2 + 2^(2 + d)*ml^2*Pi^d*(2*mm^2 - 4*mmv^2 + 6*s - 
          d*s + 2*t) + 2^(2 + d)*mmv^2*Pi^d*((15 - 7*d + d^2)*s + 3*t))))*
   userIntegral[A6, {ml}, 0, 1, 0, 0])/(Pi^(2*d)*(mz^2 - s)^2*s) + 
 (I*EL^6*gAl*gAu*(gZlL^3 + gZlL^2*gZlR + gZlL*gZlR^2 + gZlR^3)*(gZuL + gZuR)*
   userIntegral[A6, {ml}, 0, 1, 1, -2])/((2*Pi)^d*(mz^2 - s)^2) + 
 (I*2^(-1 - d)*EL^6*gAl*gAu*(gZlR^3*(gZuL*ml^2*(4*mmv^2 - 2*d*s - 4*t) + 
    ...
    gZlL^2*gZlR*(2*(-6 + d)*gZuR*mmv^2*s + 
      gZuL*ml^2*(4*mmv^2 - 2*d*s - 4*t) + 2*gZuR*ml^2*(2*mmv^2 + (-6 + d)*s - 
        2*t) - (-4 + d)*gZuR*s*(d*s + 2*t) - 
      gZuL*s*(d^2*s + 2*d*(mmv^2 - 4*s - t) + 4*(3*s + t))) + 
    gZlL*gZlR^2*(2*(-6 + d)*gZuL*mmv^2*s + 
      gZuR*ml^2*(4*mmv^2 - 2*d*s - 4*t) + 2*gZuL*ml^2*(2*mmv^2 + (-6 + d)*s - 
        2*t) - (-4 + d)*gZuL*s*(d*s + 2*t) - 
      gZuR*s*(d^2*s + 2*d*(mmv^2 - 4*s - t) + 4*(3*s + t))))*
   userIntegral[A6, {ml}, 0, 1, 1, -1])/(Pi^d*(mz^2 - s)^2*s) + 
 (I*4^(-1 - d)*EL^6*gAl*gAu*
    ...
    gZlR^3*(gZuL*(2^(2 + d)*ml^4*Pi^d*(2*mm^2 - 4*mmv^2 + d*s + 2*t) - 
      ...
      gZuR*(2^(2 + d)*ml^4*Pi^d*(2*mm^2 - 4*mmv^2 + 6*s - d*s + 2*t) - 
        2^(1 + d)*ml^2*Pi^d*(8*mmv^4 - 2*(8 - 6*d + d^2)*mm^2*s + 20*s^2 - 
          ...
          2^(1 + d)*d*Pi^d*(2*mmv^4 + mmv^2*(4*s - 2*t) - 
            3*s*(-2*mm^2 + s + 2*t))))) + 
    gZlL^2*gZlR*(gZuR*(2^(2 + d)*ml^4*Pi^d*(2*mm^2 - 4*mmv^2 + 6*s - d*s + 
          2*t) - 2^(1 + d)*ml^2*Pi^d*(2*(8 - 6*d + d^2)*mm^2*s + 36*s^2 - 
      ...
      gZuL*(2^(2 + d)*ml^4*Pi^d*(2*mm^2 - 4*mmv^2 + d*s + 2*t) + 
        ...
        s*(-(d^2*s*(2^(1 + d)*mm^2*Pi^d - 3*2^(1 + d)*mmv^2*Pi^d + 
          ...
          2^(1 + d)*d*Pi^d*(2*mmv^4 - 2*mmv^2*(12*s + t) + 
            s*(6*mm^2 + 11*s + 8*t))))) + 
    gZlL*gZlR^2*(gZuL*(2^(2 + d)*ml^4*Pi^d*(2*mm^2 - 4*mmv^2 + 6*s - d*s + 
          2*t) - 2^(1 + d)*ml^2*Pi^d*(2*(8 - 6*d + d^2)*mm^2*s + 36*s^2 - 
          20*d*s^2 + 3*d^2*s^2 + 48*s*t - 34*d*s*t + 6*d^2*s*t - 4*t^2 + 
          mmv^2*((-92 + 52*d - 8*d^2)*s + 4*t)) + 
        s*(-(2^(2 + d)*(-6 + d)*mmv^4*Pi^d) + 2^(1 + d)*(-2 + d)^2*mm^2*Pi^d*
      ...
      gZuR*(2^(2 + d)*ml^4*Pi^d*(2*mm^2 - 4*mmv^2 + d*s + 2*t) + 
        ...
        s*(-(d^2*s*(2^(1 + d)*mm^2*Pi^d - 3*2^(1 + d)*mmv^2*Pi^d + 
           ...
           (-4*mm^2*s + 20*mmv^2*s - 9*s^2 - 6*s*t + t^2) + 
          2^(1 + d)*d*Pi^d*(2*mmv^4 - 2*mmv^2*(12*s + t) + 
            s*(6*mm^2 + 11*s + 8*t))))))*userIntegral[A6, {ml}, 0, 1, 1, 0])/
  (Pi^(2*d)*(mz^2 - s)^2*s)
