...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*s*
    (2*aa*mm^4 + aa*mm^2*(4*psq - s) + aa*psq*s - bb*psq*s + 
     bb*mm^2*(-6*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*s*
    (2*aa*mm^4 + aa*mm^2*(4*psq - s) + aa*psq*s - bb*psq*s + 
     bb*mm^2*(-6*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  ((aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^4*(mm^2 + psq - s)*s*
  ...
  ((aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) - 
  ((aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) + 
  ((-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (2*aa*mm^4 + aa*mm^2*(4*psq - s) + aa*psq*s - bb*psq*s + 
     bb*mm^2*(-6*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
   (2*Pi)^(2*d) + ((-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (2*aa*mm^4 + aa*mm^2*(4*psq - s) + aa*psq*s - bb*psq*s + 
     bb*mm^2*(-6*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   (2*Pi)^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*
    mm^4*(mm^2 + psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
   Pi^(2*d) + ((-aa + bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (2*mm^4 + mm^2*(2*psq - 3*s) - psq*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  ((-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*psq*s - 3*bb*psq*s + 
     bb*mm^2*(-8*psq + s) + aa*mm^2*(8*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) - 
  ((-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*psq*s - 4*bb*psq*s + 
     bb*mm^2*(-8*psq + s) + 2*aa*mm^2*(4*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) - 
  ((aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  ((-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*mm^2 - bb*psq)*s*
  ...
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
   ...
   Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/
   Pi^(2*d) + (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
   ...
   Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[q2, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*
    gWWA*gXll^2*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(aa*mm^2 - bb*psq)*
