...
PropList[KiraPropagator[q2, mm], KiraPropagator[-p1 + q2, mm], 
 ...
 (-((2^(-1 - 2*d)*d*EL^5*gAl*gXll^2*gXXZZ*mm^4*s*(aa*(mm^2 + 3*psq - s) + 
      bb*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d))/Pi^(2*d)) + 
  (d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(4*aa*mm^2*psq - bb*psq*s + 
  ...
  (2^(-1 - 2*d)*(aa + bb)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(mm^2 + psq)*
