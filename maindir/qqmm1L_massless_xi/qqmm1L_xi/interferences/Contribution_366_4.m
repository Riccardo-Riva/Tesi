...
PropList[KiraPropagator[-p1 + q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 ((I*2^(1 - d)*EL^6*gAu*ggpgpA*ggpgpZ*
    ...
    \[Mu]^(4 - d)*SPList[SP[p2, q1]])/(Pi^d*(mz^2 - s)*(-mzC^2 + s)) + 
  (I*EL^6*gAu*ggpgpA*ggpgpZ*(gZlL*gZlLC*((-2 + d)*gZuLC*s - 
  ...
  (I*2^(1 - d)*EL^6*gAu*ggpgpA*ggpgpZ*
   ...
   (Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)) + 
  (I*2^(2 - d)*EL^6*gAu*ggpgpA*ggpgpZ*(gZlL*gZlLC + gZlR*gZlRC)*
  ...
  (I*2^(1 - d)*EL^6*gAu*ggpgpA*ggpgpZ*
   ...
   (Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)) + 
  (I*2^(3 - d)*EL^6*gAu*ggpgpA*ggpgpZ*(gZlL*gZlLC + gZlR*gZlRC)*
