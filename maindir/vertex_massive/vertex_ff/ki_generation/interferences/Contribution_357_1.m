   ...
   (-((2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
       (gZlL^2*mm^2*(-(d^2*(2*Pi)^(2*d)*s*(psq^2 + t*(s + 3*t))) + 
        ...
        2*gZlL*gZlR*(s*(d^2*(2*Pi)^(2*d)*(3*psq^3 - psq^2*s - s*t*(s + 3*t) + 
              ...
              (-2 + d)*psq*t*(19*s + 27*t) + psq^2*(-4*(-2 + d)*s + 
                2*(30 - 15*d + 2*d^2)*t) + t*(-4*(-2 + d)*s^2 - 12*(-2 + d)*s*
             ...
             (s*(5*psq^2 + t*(5*s + 9*t)) + d*(psq^3 + 3*psq*t*(s + t) - 
                psq^2*(s + 3*t) - t*(s^2 + t^2))))))*\[Mu]^(8 - 2*d))/
      ...
      (d^2*(-(gZlL^2*(2*Pi)^(2*d)*(psq - s - t)*(2*psq^2 + psq*(s - 4*t) + 
       ...
       4*(-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(6*psq^3 + psq^2*(11*s - 16*t) + 
          ...
          (-2*psq^3 + 3*psq^2*(s + 2*t) + psq*(mm^2*s + s^2 - 9*s*t - 
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*(4^(1 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*
        (22*psq^3 - 5*s^3 - 21*s^2*t - 30*s*t^2 - 14*t^3 - 
         2*psq^2*(12*s + 29*t) + psq*(-4*mm^2*s + 19*s^2 + 58*s*t + 
           50*t^2)) - d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
        (-7*psq^3 + (s + t)*(s + 2*t)^2 + 6*psq^2*(s + 3*t) - 
         psq*(4*s^2 + 16*s*t + 15*t^2) + mm^2*(psq^2 + psq*(s - 2*t) + 
           t*(s + t))) + 2*d*(-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(psq - s - t)*
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*(4^(1 + d)*d*gZlL*gZlR*Pi^(2*d)*
        (psq - t)*(-2*psq^2 + 2*mm^2*(psq - s - t) - 2*t*(s + t) + 
         psq*(s + 4*t)) + gZlL^2*(-((16 - 10*d + d^2)*mm^2*(2*Pi)^(2*d)*
           (psq - t)^2) + d^2*(2*Pi)^(2*d)*(3*psq^3 + psq^2*s - s^2*t + 
           psq*(-s^2 + 3*s*t + 11*t^2)) - 2^(1 + 2*d)*Pi^(2*d)*
          ((-20 + 11*d)*psq^3 + psq^2*((-12 + 7*d)*s + (68 - 38*d + 5*d^2)*
              t) + psq*(-5*(-2 + d)*s^2 + (-12 + 7*d)*s*t + 
             (-76 + 43*d)*t^2) + t*(-3*(-2 + d)*s^2 + 2*(12 - 7*d + d^2)*s*
              t + 2*(14 - 8*d + d^2)*t^2))) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*mm^2*((-2 + d)^2*gZlL^2*(mm^2 - psq)*
       ...
       gZlL*gZlR*(2*(4 - 6*d + d^2)*psq^2 - 2*(4 - 6*d + d^2)*mm^2*
          (psq - t) + (-4 + d)^2*s*(s + 2*t) - 
         2*psq*((-4 + d)^2*s + (4 - 6*d + d^2)*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl^3*gAu*(-12*d*gZlL*gZlR*mm^2*(psq - t)*(psq - s - t) + 
       gZlL^2*(-2*(28 - 10*d + d^2)*psq^3 - (16 - 10*d + d^2)*mm^4*
       ...
       gZlR^2*(-2*(28 - 10*d + d^2)*psq^3 - (16 - 10*d + d^2)*mm^4*
          (psq - t) - 2*psq^2*((22 - 11*d + d^2)*s + (-80 + 30*d - 3*d^2)*
            t) + (24 - 10*d + d^2)*t*(s^2 + 3*s*t + 2*t^2) + 
         psq*((28 - 12*d + d^2)*s^2 - 2*(26 - 9*d + d^2)*s*t - 
           2*(76 - 30*d + 3*d^2)*t^2) + mm^2*(8*(16 - 9*d + d^2)*psq^2 + 
    ...
    (4^(1 - 2*d)*EL^6*gAl^3*gAu*(-(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
       ...
       gZlL^2*(-((16 - 10*d + d^2)*mm^4*(2*Pi)^(2*d)*s) + 
         ...
         mm^2*(2*Pi)^(2*d)*((16 - 14*d + 3*d^2)*psq^2 + (16 - 6*d + d^2)*
            s^2 + 2*(-4 + d^2)*s*t + (16 - 14*d + 3*d^2)*t^2 - 
           (-2 + d)*psq*((12 + d)*s + 2*(-8 + 3*d)*t)) + 
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
      (d^2*(2*Pi)^(2*d)*psq*s*(psq + s - 5*t) + (-2 + d)*mm^2*(2*Pi)^(2*d)*
       ...
       2^(1 + 2*d)*Pi^(2*d)*(-((8 - 6*d + d^2)*psq^3) + (-2 + d)*t*(s + t)*
          ((-6 + d)*s + (-4 + d)*t) + psq^2*((8 - 5*d)*s + 
           3*(8 - 6*d + d^2)*t) + psq*((4 - 3*d)*s^2 + (-28 + 19*d)*s*t - 
           3*(8 - 6*d + d^2)*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q2, q2]])/(Pi^(4*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      (gZlL^2 + gZlR^2)*mm^2*(2*mm^2 - 3*psq + t)*(-psq + s + t)*
        ...
        (-((8 - 6*d + d^2)*mm^4*s) + mm^2*((16 - 10*d + d^2)*psq^2 + 
           ...
           (16 - 10*d + d^2)*t^2) - s*((-6 + d)^2*psq^2 + (-4 + d)*(s + t)*
            ((-6 + d)*s + (-8 + d)*t) - psq*((76 - 30*d + 3*d^2)*s + 
             2*(34 - 12*d + d^2)*t))) + gZlR^2*(2*Pi)^(2*d)*
        (-((8 - 6*d + d^2)*mm^4*s) + mm^2*((16 - 10*d + d^2)*psq^2 + 
           (32 - 20*d + 3*d^2)*psq*s - 2*(10 - 7*d + d^2)*s^2 - 
           2*(16 - 10*d + d^2)*psq*t - 2*(12 - 7*d + d^2)*s*t + 
           (16 - 10*d + d^2)*t^2) - s*((-6 + d)^2*psq^2 + (-4 + d)*(s + t)*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*
      (-2*(-4 + d)*gZlL*gZlR*(2*psq + (-4 + d)*s - 2*t) + 
    ...
    (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*
      ...
      (gZlL^2 + gZlR^2)*(-(d^2*(2*Pi)^(2*d)*psq*s*(psq - 3*t)) + 
       (-2 + d)*mm^2*(2*Pi)^(2*d)*(psq - t)*(4*(-2 + d)*psq + 8*t - 
         d*(s + 4*t)) + 2^(1 + 2*d)*Pi^(2*d)*((8 - 6*d + d^2)*psq^3 - 
         (-2 + d)*t*(s + t)*(2*s + (-4 + d)*t) + 
         psq*t*((4 - 5*d)*s + 3*(8 - 6*d + d^2)*t) + 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) - (4^(1 - 2*d)*EL^6*gAl^3*gAu*
      (-(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*s*(psq - t)) + 
       gZlL^2*(2*Pi)^(2*d)*(-(mm^2*((16 - 10*d + d^2)*psq^2 + 
            (-4 + d)^2*s^2 + (32 - 24*d + 3*d^2)*s*t + (16 - 10*d + d^2)*
             t^2 - psq*((32 - 24*d + 3*d^2)*s + 2*(16 - 10*d + d^2)*t))) + 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
     ...
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl^3*gAu*
      (-(d^2*(gZlL^2 + gZlR^2)*(mm^2 + s)*(-2*psq + s + 2*t)) - 
       8*(gZlL^2 + gZlR^2)*s*(mm^2 - 7*psq + 3*s + 6*t) + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(4*d*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       ...
       SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      (gZlL^2 + gZlR^2)*(-((-4 + d)*psq*s) + 
