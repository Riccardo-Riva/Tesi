...
PropList[KiraPropagator[-p3 + q1, mz], KiraPropagator[-p3 - q2, mm], 
 ...
 (((-I)*EL^5*gAl*gXll^2*mm^4*(mm^2 - psq)*s*
  ...
  (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*gXll^2*mm^2*(mm^2 - psq)*
  ...
  (I*4^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    ...
    SPList[SP[p2, q2]])/Pi^(4*d) + (I*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 - psq)*s*(aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*EL^5*gAl*gXll^2*mm^2*s*((gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) + 
  ...
  (I*EL^5*gAl*gXll^2*mm^2*s*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
      (mm^2 - psq)^2 + mm^2*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*(mm^2 - psq) + 4*gZlL*gZlR*(2*psq - s - 2*t)) + 
       bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
         4*gZlL*gZlR*(-2*psq + s + 2*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 + psq)*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 + psq)*(aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 4*d)*EL^5*gAl*gXll^2*mm^2*((gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) + 
     (aa - bb)*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + (-8 + d)*psq*s + 
    ...
    SPList[SP[p1, q2], SP[p3, q1]])/Pi^(4*d) + (I/2)*EL^5*gAl*gXll^2*mm^2*
   ((2^(1 - 2*d)*(aa - bb)*mm^2*((-2 + d)*gZlL^2*(2*psq - s - 2*t) + 
       (-2 + d)*gZlR^2*(2*psq - s - 2*t) + 2*gZlL*gZlR*(2*s + d*(-psq + t))))/
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
   ...
   Pi^(2*d) + (I*4^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (2^(1 + 2*d)*(aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq)*
      ...
      (2*s + d*(-psq + t)) + bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*mm^2*(-4*gZlL*gZlR*mm^2*s - 
  ...
  (I*4^(-1 - d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*s*
  ...
  (I*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    (aa*((-2 + d)*mm^2 + 4*s - d*s + 2*t - d*t) + 
     bb*((-2 + d)*mm^2 + 4*psq - 2*d*psq - 4*s + d*s - 2*t + d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
