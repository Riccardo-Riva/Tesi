...
PropList[KiraPropagator[p1 - q1, mh], KiraPropagator[-p2 - q1, 
 ...
 ((I*2^(1 - d)*EL^6*gAl*gAu*gHXZ^2*
  ...
  (I*EL^6*gAl*gAu*gHXZ^2*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
   ...
   ((2*Pi)^d*(mz^2 - s)^2) + (I*2^(1 - d)*EL^6*gAl*gAu*gHXZ^2*
    ((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - (-4 + d)*gZlL*gZuR + 
     (-2 + d)*gZlR*gZuR)*t*\[Mu]^(4 - d)*SPList[SP[p1, p2], SP[p1, p2]])/
   (Pi^d*(mz^2 - s)^2*s) + (I*2^(1 - d)*EL^6*gAl*gAu*gHXZ^2*
    ...
    \[Mu]^(4 - d)*SPList[SP[p1, p2], SP[p1, p3]])/(Pi^d*(mz^2 - s)^2*s) - 
  (I*2^(1 - d)*EL^6*gAl*gAu*gHXZ^2*
    (gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 2*(-3 + d)*gZuL*t - 
       2*(-3 + d)*gZuR*t) + gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 
       2*(-3 + d)*gZuL*t + 2*(-3 + d)*gZuR*t))*\[Mu]^(4 - d)*
  ...
  (I*2^(1 - d)*EL^6*gAl*gAu*gHXZ^2*(gZlL*gZuL*((-2 + d)*s - 2*t) + 
     gZlR*gZuR*((-2 + d)*s - 2*t) - gZlR*gZuL*((-4 + d)*s + 2*t) - 
     gZlL*gZuR*((-4 + d)*s + 2*t))*\[Mu]^(4 - d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(Pi^d*(mz^2 - s)^2*s) - 
  (I*2^(2 - d)*EL^6*gAl*gAu*gHXZ^2*(gZlL + gZlR)*(gZuL + gZuR)*\[Mu]^(4 - d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^d*(mz^2 - s)^2) - 
  (I*2^(1 - d)*EL^6*gAl*gAu*gHXZ^2*(d*gZlR*(gZuL - gZuR)*s + 
  ...
  (I*2^(3 - d)*EL^6*gAl*gAu*gHXZ^2*(gZlL + gZlR)*(gZuL + gZuR)*\[Mu]^(4 - d)*
