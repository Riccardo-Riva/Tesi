...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (((-I)*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*(bb*d*gZlL*gZlR*(-psq + s + t) + 
   ...
   (I*4^(1 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(aa*mm^2*(3*psq - s - 3*t) + 
   ...
   (I*4^(1 - d)*(aa + bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*s*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*
