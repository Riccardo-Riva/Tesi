  ...
  ((4^(1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
     (gZlR*mm^2*(d^2*(2*Pi)^(2*d)*s*(psq^2 + t*(s + 3*t)) + 
      ...
      gZlL*(-((-2 + d)*(2*Pi)^(2*d)*s*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
        ...
        mm^2*(-(d^2*(2*Pi)^(2*d)*s*(psq^2 + t*(s + 3*t))) + 
          2^(1 + 2*d)*Pi^(2*d)*((8 - 6*d + d^2)*psq^3 + (8 - 6*d + d^2)*psq*t*
             (2*s + 3*t) + psq^2*((-4 + 3*d)*s - 3*(8 - 6*d + d^2)*t) - 
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*
     (-(d^2*(2*Pi)^(2*d)*psq*(4*psq^2 + s^2 + 5*s*t + 4*t^2 - 
      ...
      (-4 + d)*mm^2*(2*Pi)^(2*d)*(4*(-2 + d)*psq^2 + 
        psq*(-((-6 + d)*s) - 8*(-2 + d)*t) + 
        (s + t)*((-6 + d)*s + 4*(-2 + d)*t)) - 2^(3 + 2*d)*Pi^(2*d)*
       (2*psq^2*(s + 2*t) + psq*(3*s^2 - 7*s*t - 8*t^2) + 
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
     (2^(1 + 2*d)*(-2 + d)^2*gZlR*mm^2*Pi^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 
        4*psq*t + 3*s*t + 2*t^2) + 
      gZlL*(d^2*(2*Pi)^(2*d)*psq*s*(3*psq - s + t) - (8 - 6*d + d^2)*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
     (-((-2 + d)^2*gZlR*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
        ...
        mm^2*((-8 + 2*d + d^2)*psq^2 + (s + t)*(2*(-4 + d)*s + 
            (-8 + 2*d + d^2)*t) + psq*(4*d*(s - t) + 16*t - d^2*(s + 2*t)))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*(psq - t)*
     (-(gZlR*mm^2*s) + gZlL*mm^2*(psq - t) + gZlL*psq*(-psq + s + t))*
   ...
   (4^(1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
     (-(gZlR*mm^2*(2*Pi)^(2*d)*s*((12 - 8*d + d^2)*psq + 4*s - 
         (12 - 8*d + d^2)*t)) + 
      gZlL*(-((-2 + d)*mm^2*(2*Pi)^(2*d)*(psq - t)*((-8 + d)*psq - 
           (-6 + d)*s - (-8 + d)*t)) + d^2*(2*Pi)^(2*d)*psq*(psq^2 + t^2) + 
     ...
     (-((-2 + d)^2*gZlR*mm^2*(2*psq - s - 2*t)*(psq - t)) + 
      gZlL*((16 - 6*d + d^2)*psq^3 + (-4 + d)*mm^2*(psq - t)*
         ((-2 + d)*psq - 2*s - (-2 + d)*t) - psq^2*((12 - 8*d + d^2)*s + 
          2*(20 - 6*d + d^2)*t) + psq*t*((-4 + d)^2*s + (32 - 6*d + d^2)*t) + 
        4*t*(s^2 - s*t - 2*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*
     gWNl*gZlL*gZNL*(-2*psq + s + 2*t)*(-2*psq^2 - mm^2*s - 2*t*(s + t) + 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*
     gZlL*gZNL*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*(-psq + s + t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*
     gZNL*((-8 + d)*psq^2 + (-4 + d)*mm^2*s + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*(2*(18 - 10*d + d^2)*psq^2 + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gZNL*
    ...
    (Pi^(2*d)*s) + (3*4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*
     ...
     ((12 - 8*d + d^2)*gZlR*mm^2*s + 
      gZlL*(20*psq^2 + (36 - 10*d + d^2)*t*(s + t) + 
   ...
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*(psq - t)^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*
     gZNL*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*(12 - 8*d + d^2)*EL^6*gAl*gAu*gWlN*
     gWNl*gZlL*gZNL*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2], SP[q2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(8 - 6*d + d^2)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*gZNL*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gZlL*
     gZNL*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d)))/4
