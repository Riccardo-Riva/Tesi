...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   ((2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(3*mm^2 + psq)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(-10*psq^3 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(psq - t)*
      (-4*psq + s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(psq - t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(psq*(-psq + s + t)^2 + 
