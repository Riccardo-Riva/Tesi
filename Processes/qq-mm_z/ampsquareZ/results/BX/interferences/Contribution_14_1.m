...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl*gAu*t*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
      ...
      SPList[SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*(mzC^2 - s)) - 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl*gAu*(gZlR*gZlRC*(gZuR*gZuRC*(d^3*(2*Pi)^d*s*(s + 3*t) + 
           2^(1 + d)*Pi^d*((4 + 6*d - 4*d^2)*s^2 - 2*(16 - 19*d + 7*d^2)*s*
              t + (-20 + 20*d - 8*d^2 + d^3)*t^2)) + 
         gZuL*gZuLC*(-(d^3*(2*Pi)^d*s*(s + 3*t)) + 2^(1 + d)*Pi^d*
    ...
    (I*EL^6*gAl*gAu*t*(gZlR*gZlRC*(gZuR*gZuRC*(-(d^3*(2*Pi)^d*s) + 
     ...
     ((2*Pi)^(2*d)*(mzC^2 - s)) + 
    (I*EL^6*gAl*gAu*(gZlR*gZlRC*(gZuR*gZuRC*(-(d^3*(2*Pi)^d*s^2) + 
           2^(1 + d)*Pi^d*((-4 - 6*d + 4*d^2)*s^2 - (-44 + 40*d - 12*d^2 + d^
                3)*s*t + 8*t^2)) + gZuL*gZuLC*(d^3*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*((-4 + 9*d - 4*d^2)*s^2 + (-40 + 42*d - 12*d^2 + d^
                3)*s*t + 8*t^2))) + gZlL*gZlLC*
        (gZuL*gZuLC*(-(d^3*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
            ((-4 - 6*d + 4*d^2)*s^2 - (-44 + 40*d - 12*d^2 + d^3)*s*t + 
             8*t^2)) + gZuR*gZuRC*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
            ((-4 + 9*d - 4*d^2)*s^2 + (-40 + 42*d - 12*d^2 + d^3)*s*t + 
             8*t^2))))*SPList[SP[p3, q1]])/((2*Pi)^(2*d)*(mzC^2 - s)) - 
    (I*EL^6*gAl*gAu*(gZlR*gZlRC*(gZuR*gZuRC*(d^3*(2*Pi)^d*s^2 - 
           2^(2 + d)*Pi^d*((-2 - 3*d + 2*d^2)*s^2 + (-38 + 22*d - 3*d^2)*s*
              t - 2*(8 - 6*d + d^2)*t^2)) + gZuL*gZuLC*(-(d^3*(2*Pi)^d*s^2) + 
           2^(1 + d)*Pi^d*((4 - 9*d + 4*d^2)*s^2 - 2*(40 - 22*d + 3*d^2)*s*
              t - 4*(10 - 6*d + d^2)*t^2))) + gZlL*gZlLC*
        (gZuL*gZuLC*(d^3*(2*Pi)^d*s^2 - 2^(2 + d)*Pi^d*
            ((-2 - 3*d + 2*d^2)*s^2 + (-38 + 22*d - 3*d^2)*s*t - 
             2*(8 - 6*d + d^2)*t^2)) + gZuR*gZuRC*(-(d^3*(2*Pi)^d*s^2) + 
           2^(1 + d)*Pi^d*((4 - 9*d + 4*d^2)*s^2 - 2*(40 - 22*d + 3*d^2)*s*
              t - 4*(10 - 6*d + d^2)*t^2))) + 
       (t*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(
                (-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
            gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
                (8 - 5*d + d^2)*s*t + 2*t^2))) + gZlR*gZlRC*
           (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*
             ...
             (d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
                (8 - 5*d + d^2)*s*t + 2*t^2)))))/mz^2)*SPList[SP[q1, q1]])/
     ((2*Pi)^(2*d)*(mzC^2 - s)) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      ...
      (s + t)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*(mzC^2 - s)) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*
      (gZlR*gZlRC*(-((-8 + 18*d - 8*d^2 + d^3)*gZuL*gZuLC) + 
       ...
       gZlL*gZlLC*((8 + 12*d - 8*d^2 + d^3)*gZuL*gZuLC - 
         (-8 + 18*d - 8*d^2 + d^3)*gZuR*gZuRC))*t*SPList[SP[p2, q1], 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
    ...
    KiraPropagator[-p1 + p3 + q1, 0]]*
   ((I*EL^6*gAl*gAu*t*(gZlL*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 
        ...
        (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
           ...
           4*t^2)))*(-1 + GaugeXi[Q])*SPList[SP[q1, q1]])/
     ((2*Pi)^d*(mzC^2 - s)) - 
    (I*EL^6*gAl*gAu*
      ((2^(1 - 2*d)*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
       ...
       (t*(s + t)*(-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                ((-2 + d)*s - t)) + gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*
                ((-1 + d)*s + t)))) + gZlL*gZlLC*
          ...
          (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
             ...
             (gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-1 + d)*s + 
                 ...
                 (2*s - d*s + t))))*GaugeXi[Q]^2))/(mz^2*(2*Pi)^(2*d)*
         (-1 + GaugeXi[Q])))*SPList[SP[p1, q1], SP[q1, q1]])/(mzC^2 - s) - 
    (I*EL^6*gAl*gAu*t^2*(gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
      ...
      ((2^(1 - 2*d)*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
       ...
       (s*t*(gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*
          ...
          gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*
            ...
            2^(1 + d)*gZuR*gZuRC*Pi^d*((2 + d)*s + t)) - 
          2^(1 + d)*Pi^d*(gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + 
              gZuL*gZuLC*((-2 + d)*s + 2*t)) + gZlR*gZlRC*
             (gZuL*gZuLC*(-((-4 + d)*s) + 2*t) + gZuR*gZuRC*((-2 + d)*s + 
                2*t)))*GaugeXi[Q] + (gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
              3*d*gZuR*gZuRC*(2*Pi)^d*s - 2^(1 + d)*gZuR*gZuRC*Pi^d*(s + 
                d*s - t) + 2^(1 + d)*gZuL*gZuLC*Pi^d*((2 + d)*s + t)) - 
            gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^
                d*s + 2^(1 + d)*gZuL*gZuLC*Pi^d*(s + d*s - t) - 
    ...
    (I*EL^6*gAl*gAu*
     ...
     ((2*Pi)^(2*d)*(mzC^2 - s)) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(gZuL*gZuLC*(2^(1 + d)*Pi^d*(s - 3*t) - 
           d*(2*Pi)^d*(s - t)) + gZuR*gZuRC*(-(2^(2 + d)*Pi^d*s) + 
           d*(2*Pi)^d*(s - t))) - gZlR*gZlRC*
        (gZuL*gZuLC*(2^(2 + d)*Pi^d*s - d*(2*Pi)^d*(s - t)) + 
         gZuR*gZuRC*(-(2^(1 + d)*Pi^d*(s - 3*t)) + d*(2*Pi)^d*(s - t))))*
      (s + t)*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q1]])/
     ...
     (mz^2*Pi^d*(mzC^2 - s)) + (I*2^(2 - d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
         gZuL*gZuLC*((-2 + d)*s^2 + 4*s*t + 2*t^2)) + 
       gZlR*gZlRC*(gZuL*gZuLC*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
         gZuR*gZuRC*((-2 + d)*s^2 + 4*s*t + 2*t^2)))*(-1 + GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^d*(mzC^2 - s)) + 
    (I*EL^6*gAl*gAu*(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s*(s + t) + 
       ...
       2*(-(gZlL*gZlLC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s*(3*s + 5*t)) + 
             ...
             (d*(2*Pi)^d*s*(3*s + 5*t) - 2^(1 + d)*Pi^d*(6*s^2 + 9*s*t + 
                t^2)))) + gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s*(3*s + 5*t) + 
             2^(1 + d)*Pi^d*(-3*s^2 - 6*s*t + t^2)) + gZuL*gZuLC*
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
         ...
         (-2 + d)*gZuR*gZuRC))*t^2*(-1 + GaugeXi[Q])*
      SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mz^2*Pi^d*(mzC^2 - s)) - 
    (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL*gZlLC + gZlR*gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*t^2*(-1 + GaugeXi[Q])*
      SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^d*(mzC^2 - s)) - 
    (I*EL^6*gAl*gAu*t*(gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
           2^(1 + d)*Pi^d*(-s + t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
           2^(1 + d)*Pi^d*(2*s + t))) + gZlL*gZlLC*
        (gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))) - 
     ...
     (mz^2*(2*Pi)^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*s*
      (gZlL*gZlLC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 2*t)) + 
         gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(2 + d)*Pi^d*(s + t))) - 
    ...
    (I*EL^6*gAl*gAu*s*(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
           2^(1 + d)*Pi^d*((-6 + d)*s + (-7 + 2*d)*t)) - 
         gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((-3 + d)*s + 
             (-5 + 2*d)*t))) + gZlR*gZlRC*
        (gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((-6 + d)*s + 
             (-7 + 2*d)*t)) - gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            ((-3 + d)*s + (-5 + 2*d)*t))) + 
       2*(gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*
            s - 2^(1 + d)*gZuR*gZuRC*Pi^d*(3*s + (5 - 2*d)*t) + 
           2^(1 + d)*gZuL*gZuLC*Pi^d*(6*s + (7 - 2*d)*t)) - 
         gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s + 
           2^(1 + d)*gZuL*gZuLC*Pi^d*(3*s + (5 - 2*d)*t) - 
           2^(1 + d)*gZuR*gZuRC*Pi^d*(6*s + (7 - 2*d)*t)))*GaugeXi[Q] + 
       (gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
              ((-6 + d)*s + (-7 + 2*d)*t)) - gZuL*gZuLC*(d*(2*Pi)^d*s + 
             2^(1 + d)*Pi^d*((-3 + d)*s + (-5 + 2*d)*t))) + 
         gZlR*gZlRC*(gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
              ((-6 + d)*s + (-7 + 2*d)*t)) - gZuR*gZuRC*(d*(2*Pi)^d*s + 
    ...
    (I*4^(1 - d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(gZuL*gZuLC*(-(d*(2*Pi)^d*t) + 2^(1 + d)*Pi^d*
       ...
       2*(gZlL*gZlLC*(-(gZuR*gZuRC*(2^(1 + d)*(-1 + d)*Pi^d*s + 
              d*(2*Pi)^d*t)) + gZuL*gZuLC*(2^(1 + d)*Pi^d*((-5 + d)*s - 3*
                t) + d*(2*Pi)^d*t)) + gZlR*gZlRC*
        ...
        GaugeXi[Q] + (gZlL*gZlLC*(gZuL*gZuLC*(-(d*(2*Pi)^d*t) + 
         ...
         gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*t - 2^(1 + d)*Pi^d*
              ((-5 + d)*s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*t) + 
             2^(1 + d)*Pi^d*((-1 + d)*s + d*t))))*GaugeXi[Q]^2)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
         (-4 + d)*gZuR*gZuRC) + gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + 
         (-2 + d)*gZuR*gZuRC))*t*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mz^2*Pi^d*(mzC^2 - s)) + 
    (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
         (-4 + d)*gZuR*gZuRC) + gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + 
         (-2 + d)*gZuR*gZuRC))*t*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^d*(mzC^2 - s)) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
         (-4 + d)*gZuR*gZuRC) + gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + 
         (-2 + d)*gZuR*gZuRC))*t*(-1 + GaugeXi[Q])*SPList[SP[p2, q1], 
       SP[p2, q1], SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^d*(mzC^2 - s)) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
     ...
     (mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) - 
    (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL*gZlLC + gZlR*gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*s*(-1 + GaugeXi[Q])*SPList[SP[p3, q1], 
       SP[p3, q1], SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^d*(mzC^2 - s)) - 
    (I*4^(1 - d)*EL^6*gAl*gAu*(gZlL*gZlLC + gZlR*gZlRC)*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*EL^6*gAl*gAu*t*(s + t)*
      ...
      SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*(mzC^2 - s)*
      ...
      (gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
       ...
       2^(1 + d)*Pi^d*(gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + 
        ...
        GaugeXi[Q]^2)*SPList[SP[p2, q1], SP[q1, q1]])/
     (mz^2*(2*Pi)^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) - 
    (I*EL^6*gAl*gAu*s*t*(-(gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
        ...
        GaugeXi[Q] + (-(gZlR*gZlRC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
         ...
         gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s + 
           2^(1 + d)*gZuL*gZuLC*Pi^d*(s + d*s - t) - 2^(1 + d)*gZuR*gZuRC*
            Pi^d*((2 + d)*s + t)))*GaugeXi[Q]^2)*SPList[SP[p3, q1], 
       SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) + 
    (I*EL^6*gAl*gAu*s*t*(gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) - 
           2*(-3 + d)*t) + gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t)) + 
       gZlR*gZlRC*(gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)))*(-1 + GaugeXi[Q])*
      SPList[SP[q1, q1], SP[q1, q1]])/(mz^2*(2*Pi)^d*(mzC^2 - s)) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(gZuL*gZuLC*(2^(1 + d)*Pi^d*(s - 3*t) - 
           d*(2*Pi)^d*(s - t)) + gZuR*gZuRC*(-(2^(2 + d)*Pi^d*s) + 
           d*(2*Pi)^d*(s - t))) - gZlR*gZlRC*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*s*
      (gZlL*gZlLC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - 2*t)) + 
       ...
       2^(1 + d)*Pi^d*(gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) + 4*t) + 
        ...
        GaugeXi[Q]^2)*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1]])/
     (mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) + 
    (I*EL^6*gAl*gAu*s*(gZlL*gZlLC*
        (-(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((-6 + d)*s + 
              (-7 + 2*d)*t))) + gZuL*gZuLC*(d*(2*Pi)^d*s + 
           2^(1 + d)*Pi^d*((-3 + d)*s + (-5 + 2*d)*t))) + 
       gZlR*gZlRC*(-(gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
             ((-6 + d)*s + (-7 + 2*d)*t))) + gZuR*gZuRC*(d*(2*Pi)^d*s + 
           2^(1 + d)*Pi^d*((-3 + d)*s + (-5 + 2*d)*t))) + 
    ...
    (I*4^(1 - d)*EL^6*gAl*gAu*(gZlL*gZlLC + gZlR*gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*(2^(1 + d)*Pi^d - (2*Pi)^d)*s*
      (-1 + GaugeXi[Q])*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)*(mzC^2 - s))))/4
