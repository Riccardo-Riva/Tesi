(I*EL^6*gAl^2*(gZlL + gZlR)*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
 ...
 (I*2^(-1 - 2*d)*EL^6*gAl^2*(gZlL + gZlR)*
   ...
   (-mzC^2 + s)) + (I*2^(-1 - 2*d)*EL^6*gAl^2*(gZlL + gZlR)*
 ...
 (I*2^(-1 - d)*EL^6*gAl^2*
   (gZlR*((-4 + d)*gZlLC*gZuR*gZuRC*((-2 + d)*s - 2*t) + 
    ...
    gZlL*((-4 + d)*gZlRC*gZuL*gZuLC*((-2 + d)*s - 2*t) + 
      ...
      gZlLC*gZuR*gZuRC*((-4 + d)^2*s - 2*(-2 + d)*t)))*\[Mu]^(4 - d)*
 ...
 ((I/4)*EL^6*gAl^2*((2^(1 - d)*(gZlL + gZlR)*s*
    ...
    (2^(1 - d)*(gZlL + gZlR)*s*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
    ...
    (2^(1 - 2*d)*(gZlL + gZlR)*(gZlRC*gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 
    ...
    (gZlL*(-(gZlLC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
      ...
      gZlR*(-(gZlRC*gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
        ...
        gZlRC*gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
           ((2 - 2*d + d^2)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))/
     (2*Pi)^(2*d))*\[Mu]^(4 - d)*userIntegral[A1, {0}, 0, 0, 1, 0])/
  ((mz^2 - s)*s*(-mzC^2 + s)) - (I*2^(-1 - d)*EL^6*gAl^2*(gZlL + gZlR)*
 ...
 (I*2^(-1 - d)*EL^6*gAl^2*(gZlL + gZlR)*
   (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
    gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*
   \[Mu]^(4 - d)*userIntegral[A1, {0}, 0, 1, 0, -1])/
  (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) + 
 ((I/4)*EL^6*gAl^2*((2^(2 - d)*(gZlL + gZlR)*((-2 + d)*gZlLC*gZuL*gZuLC - 
    ...
    (gZlR*(gZlLC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
      ...
      gZlL*(gZlRC*gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
        ...
        gZlRC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
           ((8 - 7*d + d^2)*s^2 + (2 - 3*d + d^2)*s*t + 2*t^2))))/
     ((2*Pi)^(2*d)*s))*\[Mu]^(4 - d)*userIntegral[A1, {0}, 0, 1, 0, 0])/
  ((-mz^2 + s)*(-mzC^2 + s)) - (I*EL^6*gAl^2*(gZlL + gZlR)*(gZlLC + gZlRC)*
   (gZuL*gZuLC + gZuR*gZuRC)*\[Mu]^(4 - d)*userIntegral[A1, {0}, 0, 1, 1, 
 ...
 (I*2^(-1 - d)*EL^6*gAl^2*
   ((gZlL + gZlR)*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
     ...
     (gZlLC*(gZuR*gZuRC*((-4 + d)*s - 2*t) + gZuL*gZuLC*((-2 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s - 2*t) + gZuR*gZuRC*((-2 + d)*s + 2*t))))*
   \[Mu]^(4 - d)*userIntegral[A1, {0}, 0, 1, 1, -1])/
  (Pi^d*(mz^2 - s)*(-mzC^2 + s)) + 
 (I*4^(-1 - d)*EL^6*gAl^2*
   (gZlR*(gZlLC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
    ...
    gZlL*(gZlRC*gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
      ...
      gZlRC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
         ((8 - 7*d + d^2)*s^2 + (-2 + d)^2*s*t + 2*t^2)) + 
      gZlLC*gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
         ((-4 + 3*d)*s^2 - (8 - 6*d + d^2)*s*t + 2*t^2))))*\[Mu]^(4 - d)*
