...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
 ...
 ((I*2^(-1 - 2*d)*(aa + bb)*d*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (I*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*
    (2*aa*(psq - s - t) + bb*(-2*psq + 2*s - d*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*(aa*(2*psq - d*s - 2*t) + 
     2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(4^d*Pi^(2*d)) - 
  (I*(aa + bb)*d*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gXll^2*mm^4*(-(bb*(-4 + d)*(psq - s - t)) + 
     aa*(4*mm^2 + (-8 + d)*psq - (-4 + d)*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gXll^2*mm^4*(aa*(4*mm^2 + 2*(-6 + d)*psq - 
       (-4 + d)*(s + 2*t)) + bb*(4*mm^2 - 2*(-2 + d)*psq + 
       (-4 + d)*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*
    (4*psq + (-4 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) + (I*d*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
    (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(4^d*Pi^(2*d)) + 
  (I*d*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*(aa*(psq - s - t) + bb*(-psq + t))*
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gXll^2*mm^4*(aa*(-4 + d)*(psq - t) + 
  ...
  (I*(aa + bb)*d*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*d*EL^5*gAl^3*gXll^2*mm^2*(bb*(psq - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(mm^2 - t) + aa*(mm^2 - 2*psq + t))*
