...
PropList[KiraPropagator[p3 + q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 (((I/16)*EL^6*gAl*gAu*ggpgpZ^2*mm^2*
  ...
  ((I/8)*EL^6*gAl*gAu*ggpgpZ^2*mm^2*
   ...
   (Pi^4*(mz^2 - s)^2*s) + ((I/16)*EL^6*gAl*gAu*ggpgpZ^2*
  ...
  ((I/8)*EL^6*gAl*gAu*ggpgpZ^2*(gZlL*gZuL*(-2*mm^2 + 4*mu^2 + 6*s - d*s + 
  ...
  ((I/8)*EL^6*gAl*gAu*ggpgpZ^2*(gZlR*gZuL*(2*mm^2 + 4*mu^2 + 4*s - d*s - 
  ...
  ((I/4)*EL^6*gAl*gAu*ggpgpZ^2*(gZlL + gZlR)*(gZuL + gZuR)*(2*mu^2 + s)*
