(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
  ...
  (((-I)*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*s*(s + t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*s*(s + t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*s*t*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(s + t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
     t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(s + t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*t*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*t*
