...
PropList[KiraPropagator[-q1, mw], KiraPropagator[-q1 - q2, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gWWAZ*gWWZ*s*
    (bb*(-3*gZlL*gZlR*mm^2*(4*(-1 + d)*psq - 3*(-2 + d)*s) + 
       gZlL^2*(mm^2*(-5*psq + 3*d*psq + 3*s - 2*d*s) + 
         psq*(-5*psq + 3*d*psq + s - d*s)) + 
       gZlR^2*(mm^2*(-5*psq + 3*d*psq + 3*s - 2*d*s) + 
         psq*(-5*psq + 3*d*psq + s - d*s))) + 
     aa*(3*gZlL*gZlR*mm^2*(4*(-1 + d)*psq - 3*(-2 + d)*s) + 
       gZlL^2*(mm^2*((5 - 3*d)*psq + (-1 + d)*s) + 
         psq*((5 - 3*d)*psq + (-3 + 2*d)*s)) + 
       gZlR^2*(mm^2*((5 - 3*d)*psq + (-1 + d)*s) + 
         psq*((5 - 3*d)*psq + (-3 + 2*d)*s))))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (EL^5*gWWAZ*gWWZ*((2^(1 - 2*d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*psq*
     ...
     (3*2^(1 - 2*d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s)/
      ...
      Pi^(2*d) + (2^(1 - 2*d)*(bb*(4*(5 - 2*d)*gZlL*gZlR*mm^2 + 
      ...
      Pi^(2*d) + (aa*(gZlL^2*(2*Pi)^(2*d)*psq*((-6 + 4*d)*mm^2 + 
  ...
  EL^5*gWWAZ*gWWZ*(-((2^(1 - 2*d)*(aa - bb)*(-5 + 3*d)*(gZlL^2 + gZlR^2)*psq*
       (mm^2 + psq))/Pi^(2*d)) - (4^(1 - d)*(aa - bb)*(-5 + 2*d)*gZlL*gZlR*
      mm^2*s)/Pi^(2*d) + ((aa + bb)*(-3 + 2*d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      s)/(2*Pi)^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*(gZlL^2 + gZlR^2)*
      (mm^2 + psq)*s)/Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-5 + 3*d)*
      (gZlL^2 + gZlR^2)*(mm^2 + psq)*s)/Pi^(2*d) - 
    (2^(1 - 2*d)*(-2 + d)*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*s)/Pi^(2*d) + 
    (2^(1 - 2*d)*(aa - bb)*gZlL*gZlR*mm^2*(12*(-1 + d)*psq - (2 + d)*s))/
     Pi^(2*d))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]] + 
  (EL^5*gWWAZ*gWWZ*((2^(1 - 2*d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*psq*
       (mm^2 + psq))/Pi^(2*d) - (4^(1 - d)*(aa - bb)*(-5 + 3*d)*
       (gZlL^2 + gZlR^2)*psq*(mm^2 + psq))/Pi^(2*d) - 
     (2^(3 - 2*d)*(aa - bb)*(-5 + 2*d)*gZlL*gZlR*mm^2*s)/Pi^(2*d) + 
     (4^(1 - d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s)/
      Pi^(2*d) + (4^(1 - d)*(aa - bb)*(-3 + 2*d)*(gZlL^2 + gZlR^2)*
       (mm^2 + psq)*s)/Pi^(2*d) - (4^(1 - d)*(aa - bb)*(-5 + 3*d)*
       (gZlL^2 + gZlR^2)*(mm^2 + psq)*s)/Pi^(2*d) + 
     ((bb*(4*(5 - 2*d)*gZlL*gZlR*mm^2 + gZlL^2*((-8 + 5*d)*mm^2 + 
            (-2 + d)*psq) + gZlR^2*((-8 + 5*d)*mm^2 + (-2 + d)*psq)) - 
        aa*(4*(5 - 2*d)*gZlL*gZlR*mm^2 + gZlL^2*((-2 + d)*mm^2 + 
            (-8 + 5*d)*psq) + gZlR^2*((-2 + d)*mm^2 + (-8 + 5*d)*psq)))*s)/
      (2*Pi)^(2*d) + (4^(1 - d)*(aa - bb)*gZlL*gZlR*mm^2*
       (12*(-1 + d)*psq - (2 + d)*s))/Pi^(2*d) + 
     (aa*(gZlL^2*(2*Pi)^(2*d)*psq*((-6 + 4*d)*mm^2 + (-6 + 4*d)*psq + 
           (-2 + d)*s) + gZlR^2*(2*Pi)^(2*d)*psq*((-6 + 4*d)*mm^2 + 
           (-6 + 4*d)*psq + (-2 + d)*s) - 2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
          (12*(-1 + d)*psq - (2 + d)*s)) - 
       bb*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(12*(-1 + d)*psq - 
            (2 + d)*s)) + gZlL^2*(2*Pi)^(2*d)*(2*(-3 + 2*d)*psq^2 + 
           mm^2*((-6 + 4*d)*psq + (-2 + d)*s)) + gZlR^2*(2*Pi)^(2*d)*
          (2*(-3 + 2*d)*psq^2 + mm^2*((-6 + 4*d)*psq + (-2 + d)*s))))/
      (2*Pi)^(4*d))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/2 + 
  ...
  (2^(-1 - 2*d)*EL^5*gWWAZ*gWWZ*
    (aa*(4*(-5 + 2*d)*gZlL*gZlR*mm^2 + gZlL^2*((14 - 9*d)*mm^2 + 
         (8 - 5*d)*psq) + gZlR^2*((14 - 9*d)*mm^2 + (8 - 5*d)*psq)) + 
     bb*(4*(5 - 2*d)*gZlL*gZlR*mm^2 + gZlL^2*((-8 + 5*d)*mm^2 + 
         (-14 + 9*d)*psq) + gZlR^2*((-8 + 5*d)*mm^2 + (-14 + 9*d)*psq)))*s*
  ...
  ((-2 + d)*EL^5*gWWAZ*gWWZ*(gZlL^2 + gZlR^2)*(-(aa*(2*mm^2 + psq)) + 
   ...
   (2*Pi)^(2*d) + (2^(1 - 2*d)*EL^5*gWWAZ*gWWZ*(gZlL^2 + gZlR^2)*
    (bb*(5 - 3*d)*mm^2 + aa*(-7 + 4*d)*mm^2 + bb*(7 - 4*d)*psq + 
     aa*(-5 + 3*d)*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
