...
((3*I)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*(gZlL + gZlR)*(gZuL + gZuR)*
  ...
  ((2*Pi)^d*(mz^2 - s)^2*s) - ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*
   (gZdR^2*(-((-4 + d)^2*gZlR*gZuL*s) + (-4 + d)*gZlL*gZuR*
    ...
    gZdL^2*(-((-4 + d)^2*gZlL*gZuR*s) + (-4 + d)*gZlR*gZuL*
      ...
      gZlR*gZuR*((-2 + d)^2*s + 2*(-4 + d)*t)))*userIntegral[A1, {0}, -1, 1, 
    1, 0])/(Pi^d*(mz^2 - s)^2) + 
 ((3*I)*2^(-1 - 2*d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
 ...
 ((3*I)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*(gZlL*gZuL*((-2 + d)*s + (-4 + d)*t) + 
  ...
  (Pi^d*(mz^2 - s)^2*s) - (((3*I)/4)*EL^6*gAl*gAu*
   ((2^(1 - d)*(gZdL^2 + gZdR^2)*(gZlL*gZuL*((-2 + d)*s - 2*t) + 
       gZlR*gZuR*((-2 + d)*s - 2*t) - gZlR*gZuL*((-4 + d)*s + 2*t) - 
       gZlL*gZuR*((-4 + d)*s + 2*t)))/Pi^d - 
    (2^(1 - d)*(-3 + d)*(gZdL^2 - gZdR^2)*
    ...
    ((2^(1 - d)*(gZdL^2 + gZdR^2)*
       ...
       Pi^d - (gZdL^2*(gZlL*gZuR*((-32 + 20*d - 3*d^2)*s^2 - 
        ...
        gZdR^2*(gZlR*gZuL*((-32 + 20*d - 3*d^2)*s^2 - 2*(10 - 7*d + d^2)*s*
  ...
  (mz^2 - s)^2 - ((3*I)*2^(-1 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
