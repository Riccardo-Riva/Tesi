...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^4*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^4*
     ...
     (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
      (mm^4*(psq - t)*(psq - s - t) + psq*(psq - t)*(2*psq^2 - 4*psq*t + 
         ...
         psq*(s^2 + 7*s*t + t^2) + t*(3*s^2 + 5*s*t + 2*t^2)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^4*
      (-4*psq^3 + mm^2*(2*psq - s - 2*t)*(psq - t) + psq^2*(s + 14*t) + 
       psq*(s^2 - 9*s*t - 16*t^2) + t*(3*s^2 + 8*s*t + 6*t^2))*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*psq*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
      (-2*mm^2*(psq - t)*(2*psq - s - t) + psq*(4*psq^2 + s^2 + 3*s*t + 
       ...
       SP[p1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*
      gXll*mm^2*(-6*psq^3 + (s + t)^2*(s + 2*t) + 2*psq^2*(3*s + 7*t) - 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^4*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
      ...
      gXll*mm^2*(psq - t)*(-2*psq^2 - 2*t*(s + t) + psq*(s + 4*t) + 
       ...
       SP[q2, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*
      gXll*mm^2*(mm^2*(psq^2 + 2*s^2 + 2*s*t + t^2 - 2*psq*(s + t)) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 + psq)*
     ...
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*s*
      (mm^2 - 3*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*
      mm^2*(psq*(psq - t) + mm^2*(psq - s - t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1], SP[q1, q1]])/Pi^(2*d) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
      (-2*psq^2 + mm^2*s + 2*psq*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*
      mm^2*(-(psq*s) + mm^2*(4*psq - s - 4*t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - psq)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(2*mm^2 - 3*psq + s + t)*
