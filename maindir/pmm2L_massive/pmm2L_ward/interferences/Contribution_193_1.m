...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, mh], 
 ...
 ((I*2^(1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*psq*s*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(8*psq + 3*s)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(bb*mm^2*(6*psq - s - 2*t) + 
     2*aa*psq*(psq - s - t) + 2*bb*psq*(-3*psq + s + t) + 
     aa*mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*
    (8*psq + s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) + 
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(bb*mm^2*(2*psq - s - 2*t) + 
     2*bb*psq*(-psq + t) - 2*aa*psq*(psq + t) + aa*mm^2*(2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(8*psq + s)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(-8*mm^2 + 4*psq)*s*
  ...
  ((3*I)*4^(1 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) + 
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(-2*bb*mm^2*(12*psq + s - 4*t) - 
     aa*(8*psq + 3*s)*(psq - s - t) + bb*(8*psq + 3*s)*(3*psq - s - t) + 
  ...
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(-(bb*(8*psq + 3*s)*(psq - t)) - 
     aa*(8*psq + 3*s)*(psq + t) + 2*aa*mm^2*(4*psq + 5*s + 4*t) + 
     bb*mm^2*(8*psq - 4*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(16*mm^2 - 8*psq - 3*s)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/
   (2*Pi)^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/
   Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/
   Pi^(2*d) - (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (-2*bb*mm^2*(12*psq - s - 4*t) - aa*(8*psq + s)*(psq - s - t) + 
     bb*(8*psq + s)*(3*psq - s - t) + aa*mm^2*(8*psq - 4*(s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(aa*(6*psq - 5*s - 6*t) + 
  ...
  (I*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(4^d*Pi^(2*d)) - 
  (I*4^(1 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(-(bb*(8*psq + s)*(psq - t)) - 
     aa*(8*psq + s)*(psq + t) + aa*mm^2*(8*psq + 6*s + 8*t) + 
     bb*mm^2*(8*psq - 4*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (16*mm^2 - 8*psq - s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(aa*(2*mm^2 - psq - t) + 
   ...
   Pi^(2*d) - (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (-(bb*(8*psq + s)*(psq - t)) - aa*(8*psq + s)*(psq + t) + 
     aa*mm^2*(8*psq + 6*s + 8*t) + bb*mm^2*(8*psq - 4*(s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(aa*(8*mm^2 - 2*psq - s - 6*t) + 
     bb*(-6*psq + s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(aa*(2*mm^2 - psq - t) + 
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^4*(2*psq - s - 2*t)*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*s*(-2*psq + s + 2*t)*
  ...
  ((3*I)*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  ((3*I)*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p2, q1]])/Pi^(2*d) - ((3*I)*4^(1 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*
    gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p2, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(6*psq - 5*s - 6*t) + 
     bb*(8*mm^2 - 14*psq + 5*s + 6*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(3 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
    ...
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p3, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[p3, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(8*mm^2 - 2*psq - s - 6*t) + 
  ...
  (I*2^(3 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[p3, q1]])/Pi^(2*d) + (I*4^(2 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p1, q2]])/(4^d*Pi^(2*d)) - 
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(6*psq - 5*s - 6*t) + 
     bb*(8*mm^2 - 14*psq + 5*s + 6*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[q1, q2]])/Pi^(2*d) - (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(2*psq - s - 2*t)*
  ...
  (I*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*4^(1 - d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gHFW^2*gHll^2*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gHFW^2*gHll^2*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gHFW^2*gHll^2*gWWA*mm^2*
    (aa*(8*mm^2 - 2*psq - s - 6*t) + bb*(-6*psq + s + 6*t))*\[Mu]^(8 - 2*d)*
