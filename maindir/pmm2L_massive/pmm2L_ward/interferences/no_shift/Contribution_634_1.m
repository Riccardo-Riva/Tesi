...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  ((I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
   ...
   (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
     (bb*mm^2*(7*psq - 4*s - 7*t) + bb*psq*(psq - t) + 
      aa*psq*(-psq + 2*s + t) + aa*mm^2*(-7*psq + 2*s + 7*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*mm^2*
     (mm^2 + psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p3, q1]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*gWlN*gWNl*
