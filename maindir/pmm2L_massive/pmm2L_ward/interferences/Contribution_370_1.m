...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
 ...
 ((I*4^(-1 - d)*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*(mm^2 - psq)*s*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
    (aa*(-4*psq^2 + 2*mm^2*(2*psq + s - 2*t) + 4*psq*t - s*(s + 2*t)) + 
     bb*(4*psq^2 - 4*psq*(2*s + t) + s*(s + 2*t) + 
       mm^2*(-4*psq + 6*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*
    mm^2*(aa*(-2*psq^2 + 3*psq*s - 2*s^2 + 2*mm^2*(psq - t) + 2*psq*t - 
       3*s*t) + bb*(2*psq^2 - 7*psq*s + 2*s^2 - 2*psq*t + 3*s*t + 
       mm^2*(-2*psq + 4*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*s*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*s*(-psq + s + t)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
  ...
  (I*(aa - bb)*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   Pi^(2*d) + (I*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
    (aa*(mm^2 + psq - s - 2*t) + bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*
    mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
  ...
  (I*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/
   (4^d*Pi^(2*d)) - ((3*I)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*
