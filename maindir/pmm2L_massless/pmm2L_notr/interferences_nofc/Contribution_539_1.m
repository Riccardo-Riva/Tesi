...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
  ...
  (-((4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s^2)) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
