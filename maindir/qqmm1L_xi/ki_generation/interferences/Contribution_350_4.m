...
(PropList[KiraPropagator[q1, ml], KiraPropagator[-p1 - p2 + q1, ml]]*
  ((I*4^(1 - d)*EL^6*gZlL*gZlR*ml^2*
   ...
   (I*4^(1 - d)*EL^6*(gZlL^2 - gZlR^2)*s*
     ...
     SPList[SP[p3, q1]])/(Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) - 
   (I*2^(1 - 2*d)*EL^6*(gZlL^2 + gZlR^2)*
     (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
      ...
      gZlR*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
           (4*(-2 + d)*s^2 - (10 - 7*d + d^2)*s*t + 2*t^2)) + 
        gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + 
            (14 - 7*d + d^2)*s*t + 2*t^2))))*\[Mu]^(4 - d)*
     SPList[SP[q1, q1]])/(Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) - 
   (I*2^(3 - d)*EL^6*(gZlL^2 + gZlR^2)*
   ...
   (I*2^(3 - d)*EL^6*(gZlL^2 + gZlR^2)*
    ...
    (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
   (I*2^(4 - d)*EL^6*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*s*\[Mu]^(4 - d)*SPList[SP[p3, q1], 
      SP[p3, q1]])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s))))/4
