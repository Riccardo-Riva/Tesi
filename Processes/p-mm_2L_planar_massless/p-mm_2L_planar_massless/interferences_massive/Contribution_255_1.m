...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  (-((4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWWA^2*mm^2*
   ...
   (4^(2 - d)*(-1 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWWA^2*mm^4*
     (-2*mu^2 + s + t)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWWA^2*mm^2*
     (mm^2*(7*(-1 + d)*mu^2 + 3*(-2 + d)*s) + 
      3*(2*(-2 + d)*mu^2*s + (-2 + d)*s^2 + 4*s*t + 4*t^2))*
     SPList[SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-1 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWWA^2*mm^4*(2*mu^2 + t)*
   ...
   (3*2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWWA^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWWA^2*
     mm^4*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   ...
   (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWWA^2*mm^4*
   ...
   (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWWA^2*mm^2*(s + 2*t)*
