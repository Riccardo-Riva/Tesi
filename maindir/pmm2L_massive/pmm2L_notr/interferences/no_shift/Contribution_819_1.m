...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^4*
      (4*psq^2 + 2*(-2 + d)*mm^2*s - 6*s^2 + 3*d*s^2 + 4*s*t + 4*t^2 - 
       2*psq*((-2 + d)*s + 4*t))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2)) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
   ...
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
