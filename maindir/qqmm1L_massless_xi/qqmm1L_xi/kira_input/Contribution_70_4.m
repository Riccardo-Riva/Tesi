(I*2^(-1 - d)*(-2 + d)*EL^6*gAl*gAu*(gZlL^2*gZlLC + gZlR^2*gZlRC)*
   (gZuLC + gZuRC)*\[Mu]^(4 - d)*userIntegral[A5, {mz}, -2, 1, 1, 1])/
  (Pi^d*(-mzC^2 + s)) + (I*2^(-2 - 3*d)*(-2 + d)*EL^6*gAl*gAu*
 ...
 (I*4^(-1 - d)*EL^6*gAl*gAu*
   (-(gZlR^2*gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s) + d^2*gZuRC*(2*Pi)^d*s + 
    ...
    gZlL^2*gZlLC*(-(d^2*gZuLC*(2*Pi)^d*s) + d^2*gZuRC*(2*Pi)^d*s + 
      ...
      2^(1 + d)*gZuLC*Pi^d*(2*(-1 + d)*s + (-2 + d)*t)))*\[Mu]^(4 - d)*
   userIntegral[A5, {mz}, -1, 1, 0, 1])/(Pi^(2*d)*s*(-mzC^2 + s)) - 
 (I*2^(-1 - d)*(-2 + d)*EL^6*gAl*gAu*
   (gZlR^2*gZlRC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 2*gZuLC*t + 
      2*gZuRC*t) + gZlL^2*gZlLC*(-((-4 + d)*gZuLC*s) + (-2 + d)*gZuRC*s + 
      2*gZuLC*t + 2*gZuRC*t))*\[Mu]^(4 - d)*userIntegral[A5, {mz}, -1, 1, 1, 
    0])/(Pi^d*s*(-mzC^2 + s)) - 
 ...
 (I*4^(-1 - d)*EL^6*gAl*gAu*(gZlL^2*gZlLC*(2^(2 + d)*(-1 + d)*gZuLC*Pi^d + 
      ...
      d^2*gZuRC*(2*Pi)^d))*t*\[Mu]^(4 - d)*userIntegral[A5, {mz}, 0, -1, 1, 
    1])/(Pi^(2*d)*(mzC^2 - s)*s) - 
 (I*2^(-2 - d)*EL^6*gAl*gAu*
   ...
   userIntegral[A5, {mz}, 0, 0, 0, 1])/(mz^2*Pi^d*(mzC^2 - s)*s) - 
 ((I/4)*(-2 + d)*EL^6*gAl*gAu*
   ((2^(2 - d)*(gZlL^2*gZlLC + gZlR^2*gZlRC)*(gZuLC + gZuRC))/Pi^d - 
    (gZlL^2*gZlLC*(6*gZuLC*s - d*gZuLC*s + d*gZuRC*s + 2*gZuLC*t + 
        ...
        2*gZuRC*(3*s + t)))/((2*Pi)^d*s))*\[Mu]^(4 - d)*
   userIntegral[A5, {mz}, 0, 0, 1, 0])/(-mzC^2 + s) - 
 (I*2^(-2 - d)*EL^6*gAl*gAu*
 ...
 (I*2^(-2 - d)*EL^6*gAl*gAu*
   (gZlR^2*gZlRC*(-(gZuRC*(2*(-2 + d)^2*s^2 + (-2 + d)*mz^2*
    ...
    0, 1])/(Pi^d*(mzC^2 - s)*s) + 
 (I*2^(-1 - d)*(-2 + d)*EL^6*gAl*gAu*(gZlL^2*gZlLC + gZlR^2*gZlRC)*
   (gZuLC + gZuRC)*\[Mu]^(4 - d)*userIntegral[A5, {mz}, 0, 1, 1, -1])/
 ...
 ((I/4)*EL^6*gAl*gAu*
   ((2^(1 - 2*d)*(gZlL^2*gZlLC*(-(d^2*gZuLC*(2*Pi)^d*s^2) + 
