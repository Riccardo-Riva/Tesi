...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  ((4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
     (4*psq^3 - 4*psq^2*(s + 2*t) - s*((-2 + d)*s^2 + 4*s*t + 4*t^2) + 
      mm^2*(4*psq^2 - (-2 + d)*s^2 - 8*psq*t + 4*s*t + 4*t^2) + 
      psq*(3*(-2 + d)*s^2 + 12*s*t + 4*t^2))*\[Mu]^(8 - 2*d))/
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
     (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*
     mm^2*(2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
     (-2*psq + (-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*
     gFAW*gFll*gWNl*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*
     mm^2*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*d*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
