...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  KiraPropagator[-q2, 0]]*
 ((EL^6*gAl^2*gFFA*gFFAZ*(gZlL + gZlR)*s*(2*d*mm^2 + 4*psq - 2*d*psq + 2*s - 
     d*s)*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
  (EL^6*gAl^2*gFFA*gFFAZ*(gZlL + gZlR)*(-4*d*mm^2 - 8*psq + 4*d*psq - 10*s + 
     5*d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) + 
