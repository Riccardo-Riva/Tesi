   ...
   (((-I/9)*2^(-2 - d)*EL^6*(d*s*(-3 + 6*sw^2 + 6*swC^2) + 
    ...
    ((I/9)*2^(-1 - d)*EL^6*(12 - 32*swC^2 + 16*swC^4 + 
      ...
      (-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(s*(3 + (-2 + 3*d)*swC^2 - 8*swC^4 + 
       ...
       SP[p2, q1]])/(cw^2*cwC^2*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*swC^2) - 
    ((I/9)*2^(-1 - d)*EL^6*(3*s*(6 - 20*swC^2 + 16*swC^4 + 
      ...
      (-mzC^2 + s)*swC^2) - ((I/9)*2^(-1 - d)*EL^6*(6 - 4*swC^2 - 16*swC^4 + 
    ...
    ((I/9)*EL^6*(-3 + 8*swC^2)*(1 - 2*swC^2 + sw^2*(-2 + 8*swC^2))*
      SPList[SP[p3, q1], SP[p3, q1]])/(cw^2*cwC^2*(2*Pi)^d*(mz^2 - s)*
      (-mzC^2 + s)*swC^2)) + 
  PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[W]]], 
    KiraPropagator[-p1 - p2 + q1, mw]]*
   (((I/9)*4^(-1 - d)*EL^6*mw^2*(-3*d^2*(2*Pi)^d*s^2 + 
