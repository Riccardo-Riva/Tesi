...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
   ...
   ((I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*s*(-5*psq + s + 5*t)*
    ...
    (I*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*s*(3*aa*mm^2*(psq - t) + 
     ...
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*
    ...
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
      (aa*(-psq^2 + 3*mm^2*(psq - t) + 2*s*t + psq*(-3*s + t)) + 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*s*
     ...
     (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
      s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
      (3*psq - 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p2, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*
      mm^2*(aa*(mm^2 + psq - 2*t) + 2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(3*psq - 2*s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(3*psq - 2*s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(aa*(mm^2 + psq - 2*t) + 
       2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*
      mm^2*(aa*(mm^2 + psq - 2*t) + 2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(aa*(mm^2 + psq - 2*t) + 
       ...
       SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*
      mm^2*(2*aa*(psq - s - t) + bb*(mm^2 - 3*psq + 2*(s + t)))*
    ...
    (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*
      mm^2*(2*aa*(psq - s - t) + bb*(mm^2 - 3*psq + 2*(s + t)))*
