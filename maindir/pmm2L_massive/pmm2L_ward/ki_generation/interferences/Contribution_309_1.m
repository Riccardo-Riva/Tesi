...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   (((-I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gWWA^3*mm^2*s*
     ...
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gWWA^3*mm^2*
      ...
      SPList[SP[p1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*s*
      (bb*((19 - 5*d)*psq^2 + (-9 + 2*d)*s*t + mm^2*((-35 + 19*d)*psq + 
           18*s - 8*d*s + 3*t - 7*d*t) + psq*(-9*s + 2*d*s + 13*t - 7*d*t)) + 
       aa*((13 - 7*d)*psq^2 + (9 - 2*d)*s*t + psq*(s + 2*d*s - 13*t + 
           7*d*t) + mm^2*((3 - 7*d)*psq - 10*s + 4*d*s - 3*t + 7*d*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gWWA^3*mm^2*(24*(-1 + d)*psq^2 + 
       (26 - 14*d)*psq*s + 3*(-4 + d)*s^2 - 24*(-1 + d)*psq*t + 
    ...
    ((3*I)*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gWWA^3*mm^2*s*
    ...
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*
    ...
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*(bb*(2*mm^2 - s - 2*t) + 
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*(bb*(9*psq - 7*s - 9*t) + 
       aa*(10*mm^2 - 19*psq + 7*s + 9*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl^2*gWWA^3*s*
      (aa*((10 - 6*d)*mm^2 - 18*psq + 11*d*psq + 9*s - 5*d*s + 8*t - 5*d*t) + 
       bb*((8 - 5*d)*psq - 9*s + 5*d*s - 8*t + 5*d*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(-1 + d)*EL^5*gAl^2*gWWA^3*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*(-5 + 3*d)*EL^5*gAl^2*gWWA^3*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWWA^3*mm^2*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*
      (bb*(2*(-19 + 5*d)*psq^2 + (10 + d)*psq*s - 2*s^2 + 
       ...
       SP[p2, q1]])/Pi^(2*d) - ((3*I)*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*
      gAl^2*gWWA^3*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*
      (bb*(-20*(-2 + d)*psq^2 + 2*(-23 + 6*d)*psq*s + (2 + 5*d)*s^2 + 
         ...
         psq*((22 + 4*d)*s - 20*(-2 + d)*t) + mm^2*(4*(-6 + 11*d)*psq + 
           30*s - 34*d*s + 24*t - 44*d*t) - s*((2 + 5*d)*s + 2*(10 + d)*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
    ((3*I)*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gWWA^3*mm^2*
    ...
    (I*4^(1 - d)*EL^5*gAl^2*gWWA^3*(aa*mm^2*((-6 + 8*d)*psq + (21 - 16*d)*s + 
         6*t - 8*d*t) + bb*mm^2*((6 - 8*d)*psq + 3*s - 6*t + 8*d*t) + 
    ...
    ((3*I)*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gWWA^3*mm^2*
     ...
     Pi^(2*d) + (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*
    ...
    ((3*I)*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gWWA^3*mm^2*
     ...
     Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gWWA^3*
      (bb*d*(-2*psq^2 - 3*psq*s + mm^2*(10*psq + s - 10*t) + 2*psq*t - 
         2*s*t) + 3*bb*(4*psq^2 - 4*psq*t + s*(-3*mm^2 + t)) - 
       3*aa*(4*psq^2 + s*(mm^2 + t) - 4*psq*(s + t)) + 
       aa*d*(2*psq^2 - 5*psq*s - 2*psq*t + 2*s*t + 
         mm^2*(-10*psq + 7*s + 10*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gAl^2*gWWA^3*(aa*mm^2*((-6 + 8*d)*psq + (9 - 8*d)*s + 
         6*t - 8*d*t) + bb*mm^2*((6 - 8*d)*psq + 15*s - 8*d*s - 6*t + 
         8*d*t) - aa*(-3 + 2*d)*(2*psq^2 - 5*psq*s - 2*psq*t + 2*s*t) + 
       bb*(-3 + 2*d)*(2*psq^2 + 3*psq*s - 2*psq*t + 2*s*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
    ((3*I)*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gWWA^3*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
     Pi^(2*d) + ((5*I)*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
     Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gWWA^3*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl^2*gWWA^3*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
     Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
     Pi^(2*d) + (I*4^(2 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(2 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(2 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA^3*(bb*(9*psq - 7*s - 9*t) + 
       aa*(10*mm^2 - 19*psq + 7*s + 9*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl^2*gWWA^3*
     ...
     Pi^(2*d) - (I*4^(2 - d)*(-1 + d)*EL^5*gAl^2*gWWA^3*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA^3*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(-5 + 3*d)*EL^5*gAl^2*gWWA^3*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2], SP[q2, q2]])/Pi^(2*d) + 
    (I*4^(2 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gAl^2*gWWA^3*(aa*(2*(-5 + 3*d)*mm^2 + 12*psq - 
         7*d*psq + d*s - 2*t + d*t) - bb*((-6 + 4*d)*mm^2 + 8*psq - 5*d*psq + 
         d*s - 2*t + d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[p2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA^3*
    ...
    (I*4^(1 - d)*EL^5*gAl^2*gWWA^3*(aa*((-6 + 4*d)*mm^2 + 4*psq - 3*d*psq + 
         2*s + 2*t - d*t) + bb*((10 - 6*d)*mm^2 - 8*psq + 5*d*psq - 2*s - 
         2*t + d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gWWA^3*
     ...
     Pi^(2*d) + (I*2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*4^(2 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
    (I*4^(2 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p2, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^2*gWWA^3*
      (-(bb*((-7 + 4*d)*mm^2 + 5*psq - 3*d*psq + s + 2*t - d*t)) + 
       aa*((-3 + 2*d)*mm^2 + psq - d*psq + s + 2*t - d*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA^3*
    ...
    (I*4^(2 - d)*(-1 + d)*EL^5*gAl^2*gWWA^3*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA^3*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(-5 + 3*d)*EL^5*gAl^2*gWWA^3*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^2*gWWA^3*
    ...
    (I*2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*4^(2 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
    ((5*I)*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA^3*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA^3*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
    (I*4^(2 - d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gWWA^3*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[q1, q1]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWWA^3*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*gAl^2*gWWA^3*(2*psq - s - 2*t)*
    ...
    (I*4^(2 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], SP[q1, q2]])/Pi^(2*d) + 
    (I*4^(2 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[p2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
       SP[q1, q1]])/Pi^(2*d) + (I*4^(2 - d)*(-3 + 2*d)*EL^5*gAl^2*gWWA^3*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
