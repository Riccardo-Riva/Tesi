  ...
  ((EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*
     ml^2*mm^2*(2*d*mm^2 + 2*psq - d*psq + 6*s)*\[Mu]^(8 - 2*d)*
   ...
   (3*2^(3 - 2*d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - (4^(2 - d)*EL^6*gAl^2*gHll^2*(gZlL + gZlR)^2*
     ml^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    ((mh^2 - mz^2)*Pi^(2*d)) + (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gHll^2*
