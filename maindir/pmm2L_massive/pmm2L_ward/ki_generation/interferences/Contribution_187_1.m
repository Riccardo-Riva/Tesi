   ...
   ((I*EL^5*gAl*mm^2*s*(bb*(-((-2 + d)^2*gZlL^4*(mm^2 - psq)*psq) - 
         (-2 + d)^2*gZlR^4*(mm^2 - psq)*psq - (-2 + d)*d*gZlL^3*gZlR*
          ...
          ((-2 + d)^2*mm^4 + d*(d*psq - 2*s)*(2*psq - s - 2*t) + 
           mm^2*((-4 + 4*d + d^2)*psq - d^2*(s + 2*t)))) - 
       aa*((-2 + d)^2*gZlL^4*(mm^2 - psq)*psq + (-2 + d)^2*gZlR^4*
       ...
       aa*(4*s*(2*gZlL^3*gZlR*mm^2*s + 2*gZlL*gZlR^3*mm^2*s - 
         ...
         d^2*(2*gZlL^2*gZlR^2*mm^2*(4*psq^2 + psq*(s - 4*t) + 
           ...
           2*gZlL*gZlR^3*mm^2*(-2*psq^2 + 2*psq*t + s*(s + t) + 
             mm^2*(-2*psq + s + 2*t))) - 2*d*(-4*gZlL^2*gZlR^2*mm^2*s*
            (2*mm^2 - 5*psq + 2*s + 3*t) + 2*gZlL^3*gZlR*mm^2*
            (-2*psq^2 + 2*psq*t + s*(2*s + t) + mm^2*(-2*psq + s + 2*t)) + 
           2*gZlL*gZlR^3*mm^2*(-2*psq^2 + 2*psq*t + s*(2*s + t) + 
             mm^2*(-2*psq + s + 2*t)) + gZlL^4*s*(-4*psq^2 - 3*psq*s + 
             s*(s + t) + mm^2*(6*psq - 2*(s + t))) + 
           gZlR^4*s*(-4*psq^2 - 3*psq*s + s*(s + t) + 
             mm^2*(6*psq - 2*(s + t))))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*mm^2*
    ...
    (I*EL^5*gAl*(bb*(d^2*(2*gZlL^3*gZlR*mm^2*(2*psq^2 + 
             mm^2*(2*psq - s - 2*t) - 2*psq*t - s*t) + 2*gZlL*gZlR^3*mm^2*
            (2*psq^2 + mm^2*(2*psq - s - 2*t) - 2*psq*t - s*t) + 
           2*gZlL^2*gZlR^2*mm^2*(-4*psq^2 + 3*psq*s - 4*mm^2*(psq - t) + 
             4*psq*t + s*t) + gZlL^4*s*(-2*psq^2 + mm^2*(psq + t)) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*(aa*(4*(gZlL^4 + gZlR^4)*(mm^2 - psq - s)*s + 
         2*d*(-4*gZlL^2*gZlR^2*mm^2*s + gZlL^4*s*(-2*mm^2 + 2*psq + s) + 
           ...
           2*gZlL^3*gZlR*mm^2*(2*mm^2 - 3*psq + s + t) - 2*gZlL*gZlR^3*mm^2*
            (2*mm^2 - 3*psq + s + t) + 4*gZlL^2*gZlR^2*mm^2*
            (-psq + s + t))) + bb*(-4*(gZlL^4 + gZlR^4)*(mm^2 - psq - s)*s + 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*s*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl*
    ...
    (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gAl*
