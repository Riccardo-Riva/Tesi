...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
  ...
  (-((2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*(3*s + 2*t)*
     SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*(3*s + 2*t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*(s - 2*t)*
     SPList[SP[p2, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*(s - 2*t)*
   ...
   (2^(7 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*
