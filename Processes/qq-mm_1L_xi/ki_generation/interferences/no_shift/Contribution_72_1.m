   ...
   ((I*4^(1 - d)*EL^6*gAl*gAu*(gZlL^3*(-(d^2*gZuL*(2*Pi)^d*s^2) + 
       ...
       gZlR^3*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
         ...
         2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
           2*t^2)))*SPList[SP[p1, q1], SP[p3, q1]])/
     (mz^2*Pi^(2*d)*(mz^2 - s)*s) + (I*2^(1 - d)*EL^6*gAl*gAu*
      (gZlL^3*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
           ...
           4*t^2)))*SPList[SP[p1, q1], SP[q1, q1]])/
     (mz^2*Pi^d*s*(-mz^2 + s)) + (I*4^(1 - d)*EL^6*gAl*gAu*
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*
      (gZlL^3*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
           ...
           4*t^2)) + gZlR^3*(-(gZuL*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*
             s*t - 4*t^2)) + gZuR*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
           4*t^2)))*SPList[SP[p2, q1], SP[q1, q1]])/
     (mz^2*Pi^d*s*(-mz^2 + s)) + (I*2^(2 - d)*EL^6*gAl*gAu*
      (gZlL^3*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
            4*t^2)) + gZuL*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
           4*t^2)) + gZlR^3*(-(gZuL*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*
             s*t - 4*t^2)) + gZuR*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
           4*t^2)))*SPList[SP[p3, q1], SP[p3, q1]])/
    ...
    (I*EL^6*gAl*gAu*(gZlL^3*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
         ...
         d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - 
           (4 - 5*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZuR*Pi^d*
          (-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2)))*
      SPList[SP[q1, q1], SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*s*(-mz^2 + s))) + 
   ...
   (((-I)*2^(1 - d)*EL^6*gAl*gAu*
      (gZlL^3*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
           ...
           4*t^2)) + gZlR^3*(-(gZuL*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*
             s*t - 4*t^2)) + gZuR*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
           4*t^2))))/(Pi^d*(mz^2 - s)) - 
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlR^3*((8 - 6*d + d^2)*gZuR*(s + 2*t) - 
         gZuL*((-4 + d)^2*s + 2*(10 - 6*d + d^2)*t)) + 
       gZlL^3*((8 - 6*d + d^2)*gZuL*(s + 2*t) - 
         gZuR*((-4 + d)^2*s + 2*(10 - 6*d + d^2)*t)))*SPList[SP[p1, q1]])/
     (Pi^d*(mz^2 - s)) - (I*2^(2 - d)*EL^6*gAl*gAu*
      (gZlR^3*((-2 + d)^2*gZuR*s + 2*(10 - 6*d + d^2)*gZuR*t - 
         (8 - 6*d + d^2)*gZuL*(s + 2*t)) + gZlL^3*((-2 + d)^2*gZuL*s + 
         2*(10 - 6*d + d^2)*gZuL*t - (8 - 6*d + d^2)*gZuR*(s + 2*t)))*
      SPList[SP[p2, q1]])/(Pi^d*(mz^2 - s)) + 
    ...
    (I*4^(1 - d)*EL^6*gAl*gAu*(gZlL^3*(-(d^2*gZuL*(2*Pi)^d*s) + 
         d^2*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(2*(-1 + d)*s - 
           (6 - 5*d + d^2)*t) + 2^(1 + d)*gZuR*Pi^d*((4 - 3*d)*s + 
           (6 - 5*d + d^2)*t)) - gZlR^3*(-(d^2*gZuL*(2*Pi)^d*s) + 
         d^2*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s - 
           (6 - 5*d + d^2)*t) + 2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s + 
           (6 - 5*d + d^2)*t)))*SPList[SP[p1, q1], SP[p2, q1]])/
     (Pi^(2*d)*s*(-mz^2 + s)) + (I*4^(1 - d)*EL^6*gAl*gAu*
      (gZlR^3*(-(d^2*(gZuL - gZuR)*s*(-(mz^2*(2*Pi)^d) + (2*Pi)^d*s + 
            2^(1 + d)*Pi^d*t)) - 2^(1 + d)*d*Pi^d*(gZuL*mz^2*(s - t) - 
           gZuR*mz^2*(4*s + t) + gZuR*s*(2*s + 5*t) - gZuL*s*(3*s + 5*t)) + 
         2^(2 + d)*Pi^d*(gZuL*(-2*s^2 - 2*s*t + t*(-mz^2 + t)) + 
           gZuR*(s^2 + 4*s*t + t^2 - mz^2*(3*s + t)))) + 
       gZlL^3*(-(gZuR*(d^2*s*(-(mz^2*(2*Pi)^d) + (2*Pi)^d*s + 
              2^(1 + d)*Pi^d*t) + 2^(2 + d)*Pi^d*(2*s^2 + 2*s*t + 
              (mz^2 - t)*t) + 2^(1 + d)*d*Pi^d*(mz^2*(s - t) - 
              s*(3*s + 5*t)))) + gZuL*(d^2*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2) + 
           mz^2*(-(d^2*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-6 + 4*d)*s + (-2 + d)*
                t)))))*SPList[SP[p1, q1], SP[p3, q1]])/
     (mz^2*Pi^(2*d)*(mz^2 - s)*s) + (I*2^(1 - d)*EL^6*gAl*gAu*
      (gZlL^3*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
            4*t^2)) + gZuL*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
           4*t^2)) + gZlR^3*(-(gZuL*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*
             s*t - 4*t^2)) + gZuR*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
           4*t^2)))*SPList[SP[p1, q1], SP[q1, q1]])/
     (mz^2*Pi^d*(mz^2 - s)*s) - (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gAu*
      (gZlL^3*((-2 + d)*gZuL - (-4 + d)*gZuR) + 
       gZlR^3*(-((-4 + d)*gZuL) + (-2 + d)*gZuR))*t*SPList[SP[p2, q1], 
       SP[p2, q1]])/(Pi^d*s*(-mz^2 + s)) + 
    (I*4^(1 - d)*EL^6*gAl*gAu*
      (gZlR^3*(gZuR*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
             (8 - 5*d + d^2)*s*t + 2*t^2) + mz^2*(d^2*(2*Pi)^d*s - 
             2^(1 + d)*Pi^d*(2*(-1 + d)*s + (-2 + d)*t))) + 
         gZuL*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
             (4 - 5*d + d^2)*s*t + 2*t^2) + mz^2*(-(d^2*(2*Pi)^d*s) + 
             2^(1 + d)*Pi^d*(-4*s + 3*d*s + 2*t - d*t)))) + 
       gZlL^3*(gZuL*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
             (8 - 5*d + d^2)*s*t + 2*t^2) + mz^2*(d^2*(2*Pi)^d*s - 
             2^(1 + d)*Pi^d*(2*(-1 + d)*s + (-2 + d)*t))) + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*
      (gZlL^3*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
           ...
           4*t^2)) + gZlR^3*(-(gZuL*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*
             s*t - 4*t^2)) + gZuR*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
           4*t^2)))*SPList[SP[p2, q1], SP[q1, q1]])/
     (mz^2*Pi^d*(mz^2 - s)*s) - (I*2^(2 - d)*EL^6*gAl*gAu*
    ...
    (I*4^(1 - d)*EL^6*gAl*gAu*(gZlL^3*(-(d^2*gZuL*(2*Pi)^d*s^2) + 
       ...
       gZlR^3*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
         2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2) + 
         2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
           2*t^2)))*SPList[SP[p3, q1], SP[q1, q1]])/
