...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   (((-I)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
    ...
    (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
      (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
     ...
     (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      gXll^2*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
