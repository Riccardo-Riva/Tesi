...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   ((4^(1 - 2*d)*EL^5*gAl^3*mm^2*(aa*((4 - 5*d + d^2)*gZlL^2 - 
         2*(8 - 5*d + d^2)*gZlL*gZlR + (4 - 5*d + d^2)*gZlR^2)*(2*Pi)^(2*d)*
        psq*(mm^2 + psq - s) - bb*(gZlL^2*(2*Pi)^(2*d)*
    ...
    (4^(1 - d)*EL^5*gAl^3*(bb*mm^2*(2*gZlL*gZlR*((4 - 5*d + d^2)*mm^2 + 
           (12 - 9*d + d^2)*psq - 2*(-3 + d)^2*s) + 
         gZlL^2*(-((8 - 5*d + d^2)*mm^2) - (-1 + d)*(d*(psq - 2*s) + 6*s)) + 
