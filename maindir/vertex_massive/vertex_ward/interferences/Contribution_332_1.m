   ...
   ((I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
      (aa*((-2 + d)*mm^4 + (-2 + d)*psq*(psq - s - t) + 
       ...
       bb*((-2 + d)*mm^4 - (-2 + d)*psq*(psq - t) + 
         mm^2*(8*psq - 6*d*psq - 4*s + 3*d*s - 6*t + 5*d*t)))*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
      ...
      SPList[SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl^3*
      gHll^2*mm^2*(mm^2 - psq)*s*(aa*(mm^2 + psq - s - t) + 
       bb*(mm^2 - psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
    ...
    (I*4^(1 - d)*(aa - bb)*(-4 + 3*d)*EL^5*gAl^3*gHll^2*mm^4*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(bb*(psq - s - t) + 
    ...
    (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*
      (aa*d*(-psq + t) + bb*(4*(-2 + d)*mm^2 + 8*psq - 3*d*psq - d*t))*
