...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*
      (psq^2 - 2*psq*t + t*(s + t))*(-(psq*s) + mm^2*(-4*psq + 3*s + 4*t))*
      \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*
      gXll^2*mh^2*mm^4*(-psq + s + t)*(2*psq^2 + psq*(s - 6*t) + 
       4*t*(s + t) + mm^2*(-6*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*
      (2*psq^3 + psq^2*(s - 6*t) - 2*t^2*(s + t) + 2*mm^2*(-psq + s + t)^2 + 
       psq*(-s^2 + s*t + 6*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*
      (psq - t)*(6*psq^2 + 4*t*(s + t) - psq*(s + 10*t) + 
       mm^2*(6*psq - 3*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*
      (-2*psq^3 + 2*mm^2*(psq - t)*(psq - s - t) + 2*t*(s + t)^2 + 
       3*psq^2*(s + 2*t) - psq*t*(7*s + 6*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(3*mm^2 + psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(-psq + s + t)*
      (2*mm^2 - 3*psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*
      mh^2*mm^4*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(-psq + s + t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*
      (2*psq^2 + mm^2*s + 2*(s + t)^2 - psq*(5*s + 4*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(-psq + s + t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*
      (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(2*mm^2 - psq - t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(psq - t)^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(psq - t)*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*
      (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*
      mh^2*mm^4*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
