...
PropList[KiraPropagator[-q1, ml], KiraPropagator[q2, mz], 
  ...
  KiraPropagator[-p1 - p2 + p3 + q2, mm], KiraPropagator[q1 + q2, ml]]*
 (((-I)*EL^5*gAl*gZlL*gZlR*ml^2*s*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
   ...
   (4^d*Pi^(2*d)) + (I*EL^5*gAl*gZlL*gZlR*ml^2*
    (2*bb*(gZlL^2 + gZlR^2)*(8*psq^2 - 8*psq*(s + t) + 
       s*(2*mm^2 + s + 2*t)) - bb*d*(8*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(8*psq^2 - 8*psq*(s + t) + s*(2*mm^2 + s + 2*t)) + 
       gZlR^2*(8*psq^2 - 8*psq*(s + t) + s*(2*mm^2 + s + 2*t))) + 
     aa*(-2*(gZlL^2 + gZlR^2)*(8*psq^2 - 4*psq*(s + 2*t) + 
         s*(-2*mm^2 + s + 2*t)) + d*(8*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
         gZlL^2*(8*psq^2 - 4*psq*(s + 2*t) + s*(-2*mm^2 + s + 2*t)) + 
         gZlR^2*(8*psq^2 - 4*psq*(s + 2*t) + s*(-2*mm^2 + s + 2*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gZlL*gZlR*ml^2*(2*(aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*
   ...
   Pi^(4*d) + (I*2^(-1 - 4*d)*EL^5*gAl*(4^(1 + d)*(aa + bb)*(-2 + d)*gZlL*
     ...
     4^(1 + d)*(aa - bb)*(-2 + d)*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*Pi^(2*d)*
      ...
      (gZlL^2 + gZlR^2)*ml^2*Pi^(2*d)*s*(-2*psq + s + 2*t) + 
     (aa - bb)*(-2 + d)*((-2 + d)*gZlL^4 - 2*(-4 + d)*gZlL^2*gZlR^2 + 
       (-2 + d)*gZlR^4)*(2*Pi)^(2*d)*psq*s*(-2*psq + s + 2*t) - 
     2^(1 + 2*d)*gZlL*gZlR*ml^2*Pi^(2*d)*(2*bb*(gZlL^2 + gZlR^2)*s*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*
   ...
   Pi^(4*d) + (I*2^(-1 - 4*d)*EL^5*gAl*(4^(1 + d)*(aa + bb)*(-2 + d)*gZlL*
     ...
     (aa - bb)*(-2 + d)*((-2 + d)*gZlL^4 - 2*(-4 + d)*gZlL^2*gZlR^2 + 
       (-2 + d)*gZlR^4)*(2*Pi)^(2*d)*psq*s*(-2*psq + s + 2*t) + 
     2^(1 + 2*d)*gZlL*gZlR*ml^2*Pi^(2*d)*(-2*aa*(gZlL^2 + gZlR^2)*s*
  ...
  (I*(aa + bb)*(-2 + d)*EL^5*gAl*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*s*(4^(1 + d)*(aa + bb)*(-2 + d)*gZlL*gZlR*
      (gZlL^2 + gZlR^2)*ml^2*Pi^(2*d)*(mm^2 - psq) + 
     (aa + bb)*(-4 + d)*(gZlL^2 + gZlR^2)^2*(2*Pi)^(2*d)*(mm^2 - psq)*s - 
     2^(1 + 2*d)*(aa - bb)*(-2 + d)*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*Pi^(2*d)*
  ...
  (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*
  ...
  (I*EL^5*gAl*(aa*(-(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
         (2*mm^2 + 2*psq - 3*s - 4*t)) - 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*
        ml^2*Pi^(6*d)*(2*mm^2 + 2*psq - 3*s - 4*t) - 2^(1 + 6*d)*gZlL^2*
       ...
       gZlR^4*(2*Pi)^(6*d)*((4 - 5*d + d^2)*mm^4 + 
         ...
         d*(-6*psq^2 + 41*psq*s - 22*s^2 + 6*psq*t - 20*s*t) + 
         d^2*(2*psq^2 + 4*s*(s + t) - psq*(7*s + 2*t)))) + 
     bb*(-(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
         (6*mm^2 - 10*psq + 3*s + 4*t)) - 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*
        ml^2*Pi^(6*d)*(6*mm^2 - 10*psq + 3*s + 4*t) + 
  ...
  (I*EL^5*gAl*(bb*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
        (2*mm^2 - 6*psq + s + 4*t) + 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*
       ...
       gZlR^4*(2*Pi)^(6*d)*(-((4 - 5*d + d^2)*mm^4) + 
         ...
         d^2*(2*psq^2 - 3*psq*s - 2*psq*t + 4*s*t) + 
         d*(-6*psq^2 + 2*s*(s - 10*t) + psq*(5*s + 6*t)))) + 
     aa*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
        (6*mm^2 - 2*psq - s - 4*t) + 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*
  ...
  (I*EL^5*gAl*(bb*(d*(gZlL^2 - gZlR^2)^2*(2*Pi)^(6*d)*
     ...
     SP[p3, q1]])/(2*Pi)^(8*d) - 
  (I*EL^5*gAl*(aa*(-(4^(1 + 3*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
         (2*psq - s - 2*t)) - 4^(1 + 3*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*
        (2*psq - s - 2*t) - gZlL^4*(4^(1 + 3*d)*Pi^(6*d)*
          (2*psq^2 + 2*mm^2*s + 3*psq*s - 9*s^2 - 2*psq*t) + 
         d^2*(2*Pi)^(6*d)*(-2*psq^2 + mm^2*(2*psq + s - 2*t) - 
           2*s*(2*s + t) + psq*(3*s + 2*t)) + d*(2*Pi)^(6*d)*
          (2*psq^2 - 9*psq*s + 23*s^2 - 2*psq*t + 4*s*t + 
           mm^2*(-6*psq - 7*s + 6*t))) - 
       gZlR^4*(4^(1 + 3*d)*Pi^(6*d)*(2*psq^2 + 2*mm^2*s + 3*psq*s - 9*s^2 - 
           2*psq*t) + d^2*(2*Pi)^(6*d)*(-2*psq^2 + mm^2*(2*psq + s - 2*t) - 
           2*s*(2*s + t) + psq*(3*s + 2*t)) + d*(2*Pi)^(6*d)*
          (2*psq^2 - 9*psq*s + 23*s^2 - 2*psq*t + 4*s*t + 
           mm^2*(-6*psq - 7*s + 6*t))) + 2*gZlL^2*gZlR^2*
        (d^2*(2*Pi)^(6*d)*(-2*psq^2 + mm^2*(2*psq + s - 2*t) - 
           2*s*(2*s + t) + psq*(3*s + 2*t)) + 2^(1 + 6*d)*Pi^(6*d)*
          (8*psq^2 - 2*psq*(3*s + 4*t) + s*(8*mm^2 - 15*s + 6*t)) + 
         d*(2*Pi)^(6*d)*(2*psq^2 - 9*psq*s + 23*s^2 - 2*psq*t + 4*s*t + 
           mm^2*(-6*psq - 7*s + 6*t)))) - 
     bb*(-(4^(1 + 3*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
         (2*psq - s - 2*t)) - 4^(1 + 3*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*
        (2*psq - s - 2*t) + gZlL^4*(4^(1 + 3*d)*Pi^(6*d)*
          (-2*psq^2 + 2*mm^2*s + 5*psq*s - 9*s^2 + 2*psq*t) + 
         d*(2*Pi)^(6*d)*(-2*psq^2 + mm^2*(6*psq - 13*s - 6*t) + 
           s*(19*s - 4*t) + psq*(s + 2*t)) + d^2*(2*Pi)^(6*d)*
          (2*psq^2 + 2*s*(-s + t) - psq*(3*s + 2*t) + 
           mm^2*(-2*psq + 3*s + 2*t))) + 
       gZlR^4*(4^(1 + 3*d)*Pi^(6*d)*(-2*psq^2 + 2*mm^2*s + 5*psq*s - 9*s^2 + 
           2*psq*t) + d*(2*Pi)^(6*d)*(-2*psq^2 + mm^2*(6*psq - 13*s - 6*t) + 
           s*(19*s - 4*t) + psq*(s + 2*t)) + d^2*(2*Pi)^(6*d)*
          (2*psq^2 + 2*s*(-s + t) - psq*(3*s + 2*t) + 
           mm^2*(-2*psq + 3*s + 2*t))) + 2*gZlL^2*gZlR^2*
        (d^2*(2*Pi)^(6*d)*(-2*psq^2 + mm^2*(2*psq - 3*s - 2*t) + 
           2*s*(s - t) + psq*(3*s + 2*t)) + d*(2*Pi)^(6*d)*
          (2*psq^2 - psq*(s + 2*t) + s*(-19*s + 4*t) + 
           mm^2*(-6*psq + 13*s + 6*t)) + 2^(1 + 6*d)*Pi^(6*d)*
          (8*psq^2 - 2*psq*(7*s + 4*t) + s*(-8*mm^2 + 21*s + 6*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(2*Pi)^(8*d) - 
  ...
  (I*EL^5*gAl*(aa*(gZlL^4*(2*Pi)^(6*d)*(-2*(10 - 6*d + d^2)*psq^2 + 
   ...
   (2*Pi)^(8*d) + 
  (I*EL^5*gAl*(aa*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
        (4*psq - 3*s - 4*t) + 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*
       ...
       2^(1 + 6*d)*gZlL^2*gZlR^2*Pi^(6*d)*(2*(8 - 6*d + d^2)*psq^2 + 
         ...
         mm^2*(2*(-1 + d)*psq + 2*t - d*(s + 2*t)))) + 
     bb*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
        (4*mm^2 - 8*psq + 3*s + 4*t) + 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*
   ...
   (2*Pi)^(8*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gZlL*gZlR*
    (gZlL^2 + gZlR^2)*ml^2*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
  ...
  (I*EL^5*gAl*(-(bb*(-(4^(1 + 3*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
          (mm^2 - 3*psq + s + 2*t)) - 4^(1 + 3*d)*(-2 + d)*gZlL*gZlR^3*ml^2*
        ...
        2*gZlL^2*gZlR^2*((8 - 5*d + d^2)*mm^4*(2*Pi)^(6*d) - 
          ...
          mm^2*(2*Pi)^(6*d)*((18 - 11*d + d^2)*psq - 
            2*((10 - 6*d + d^2)*s + t - d*t))))) + 
     aa*(4^(1 + 3*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
        (mm^2 + psq - s - 2*t) + 4^(1 + 3*d)*(-2 + d)*gZlL*gZlR^3*ml^2*
  ...
  (I*EL^5*gAl*(bb*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
        (2*psq - s - 2*t) + 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*
        (2*psq - s - 2*t) + gZlL^4*(2^(1 + 6*d)*Pi^(6*d)*
          (2*psq^2 + s*(-3*mm^2 + 6*s - 2*t) - 2*psq*(s + t)) + 
         d^2*(2*Pi)^(6*d)*(-psq^2 + mm^2*(psq - 2*s - t) - 2*s*t + 
           psq*(3*s + t)) - d*(2*Pi)^(6*d)*(-psq^2 + s*(4*s - 7*t) + 
           3*mm^2*(psq - 3*s - t) + psq*(8*s + t))) + 
       gZlR^4*(2^(1 + 6*d)*Pi^(6*d)*(2*psq^2 + s*(-3*mm^2 + 6*s - 2*t) - 
           2*psq*(s + t)) + d^2*(2*Pi)^(6*d)*(-psq^2 + mm^2*(psq - 2*s - t) - 
     ...
     aa*(-(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
        ...
        (2*psq - s - 2*t) + gZlL^4*(d^2*(2*Pi)^(6*d)*
          ((psq - 2*s)*(psq - s - t) + mm^2*(-psq + t)) + 
         2^(1 + 6*d)*Pi^(6*d)*(-2*psq^2 + psq*(-6*s + 2*t) + 
           s*(-mm^2 + 6*s + 2*t)) + d*(2*Pi)^(6*d)*(-psq^2 + 
           mm^2*(3*psq + s - 3*t) + psq*(12*s + t) - s*(10*s + 7*t))) + 
       gZlR^4*(d^2*(2*Pi)^(6*d)*((psq - 2*s)*(psq - s - t) + 
           mm^2*(-psq + t)) + 2^(1 + 6*d)*Pi^(6*d)*(-2*psq^2 + 
           psq*(-6*s + 2*t) + s*(-mm^2 + 6*s + 2*t)) + 
         d*(2*Pi)^(6*d)*(-psq^2 + mm^2*(3*psq + s - 3*t) + psq*(12*s + t) - 
           s*(10*s + 7*t))) + 2*gZlL^2*gZlR^2*
        (d^2*(2*Pi)^(6*d)*(mm^2*(psq - t) - (psq - 2*s)*(psq - s - t)) + 
         2^(1 + 6*d)*Pi^(6*d)*(4*psq^2 + psq*(3*s - 4*t) - 
           s*(-2*mm^2 + 6*s + t)) + d*(2*Pi)^(6*d)*
          (psq^2 - mm^2*(3*psq + s - 3*t) - psq*(12*s + t) + 
           s*(10*s + 7*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/
  ...
  (I*EL^5*gAl*(aa*(-(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
         (psq - s - t)) - 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*
       ...
       gZlR^4*(2*Pi)^(6*d)*(2*(10 - 6*d + d^2)*psq^2 + (6 - 4*d + d^2)*s*
          (s + t) - psq*((14 - 9*d + 2*d^2)*s + 2*(10 - 6*d + d^2)*t))) + 
     bb*(-(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
         (2*mm^2 - 3*psq + s + t)) - 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*
  ...
  (I*EL^5*gAl*(bb*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
        (2*mm^2 - 4*psq + s + 2*t) + 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*
     ...
     aa*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*(2*mm^2 - s - 2*t) + 
       2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl*(bb*(-(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
         (4*psq - s - 4*t)) - 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*
       ...
       gZlL^4*(2*Pi)^(6*d)*(2*(10 - 6*d + d^2)*psq^2 + 
        ...
        (2*(10 - 6*d + d^2)*psq^2 + mm^2*(2*(-5 + d)*psq - (-4 + d)*s - 
           2*(-5 + d)*t) - psq*((8 - 13*d + 3*d^2)*s + 2*(10 - 6*d + d^2)*
            t) + 2*s*((-4 + d)*s + (-2 - 3*d + d^2)*t))) + 
     aa*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*(4*mm^2 - s - 4*t) + 
       2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*(4*mm^2 - s - 4*t) + 
       gZlL^4*(4^(1 + 3*d)*mm^4*Pi^(6*d) + mm^2*(2*Pi)^(6*d)*
          (-2*(5 - 4*d + d^2)*psq + (20 - 19*d + 4*d^2)*s + 2*(-5 + d)*t) + 
         (2*Pi)^(6*d)*((-52 + 30*d - 4*d^2)*psq^2 + 
           psq*((104 - 63*d + 9*d^2)*s + 2*(10 - 6*d + d^2)*t) - 
       ...
       gZlR^4*(d^2*(2*Pi)^(6*d)*(-((psq - 2*s)*(psq - t)) + 
        ...
        (d^2*(2*Pi)^(6*d)*(-((psq - 2*s)*(psq - t)) + mm^2*(psq - s - t)) + 
         2^(1 + 6*d)*Pi^(6*d)*(4*psq^2 + s*(-2*mm^2 + 5*s - t) - 
           ...
           mm^2*(-3*psq + 4*s + 3*t) + s*(-3*s + 7*t)))) - 
     aa*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*(2*psq - s - 2*t) + 
       2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*(2*psq - s - 2*t) + 
  ...
  (I*EL^5*gAl*(bb*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*(psq - t) + 
       2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*(psq - t) + 
     ...
     aa*(-(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
         (2*mm^2 - psq - t)) - 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*
  ...
  (I*EL^5*gAl*(bb*(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
     ...
     aa*(-(2^(1 + 6*d)*(-2 + d)*gZlL^3*gZlR*ml^2*Pi^(6*d)*
         (2*psq - s - 2*t)) - 2^(1 + 6*d)*(-2 + d)*gZlL*gZlR^3*ml^2*Pi^(6*d)*
        (2*psq - s - 2*t) - 2^(1 + 6*d)*(-4 + d)*gZlL^2*gZlR^2*Pi^(6*d)*
        (2*(-1 + d)*psq^2 + psq*((2 - 3*d)*s - 2*(-1 + d)*t) + 
         s*(-((-1 + d)*mm^2) + 3*s + (4 + d)*t)) + gZlL^4*(2*Pi)^(6*d)*
        (2*(8 - 5*d + d^2)*psq^2 + s*(-((8 - 5*d + d^2)*mm^2) + 
           3*(-2 + d)*s + (-2 + d^2)*t) - psq*((22 - 14*d + 3*d^2)*s + 
           2*(8 - 5*d + d^2)*t)) + gZlR^4*(2*Pi)^(6*d)*
        (2*(8 - 5*d + d^2)*psq^2 + s*(-((8 - 5*d + d^2)*mm^2) + 
           3*(-2 + d)*s + (-2 + d^2)*t) - psq*((22 - 14*d + 3*d^2)*s + 
