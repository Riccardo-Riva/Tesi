...
(PropList[KiraPropagator[q1, ms], KiraPropagator[-p1 - p2 + q1, ms]]*
  (((-3*I)*2^(1 - 2*d)*EL^6*gAd*gAu*(gZdL + gZdR)*ms^2*
   ...
   (I*2^(1 - 2*d)*EL^6*gAd*gAu*(gZdL*gZlR*gZlRC*(d^2*gZuLC*(2*Pi)^d*s^2 + 
        d^2*gZuRC*(2*Pi)^d*s^2 + 2^(1 + d)*gZuRC*Pi^d*((6 - 6*d + d^2)*s^2 + 
          3*(8 - 5*d + d^2)*s*t + 6*t^2) + 2^(1 + d)*gZuLC*Pi^d*
         ((24 - 12*d + d^2)*s^2 - 3*(-2 - 3*d + d^2)*s*t + 6*t^2)) + 
      gZdR*gZlL*gZlLC*(d^2*gZuLC*(2*Pi)^d*s^2 + d^2*gZuRC*(2*Pi)^d*s^2 + 
        2^(1 + d)*gZuLC*Pi^d*((6 - 6*d + d^2)*s^2 + 3*(8 - 5*d + d^2)*s*t + 
          6*t^2) + 2^(1 + d)*gZuRC*Pi^d*((24 - 12*d + d^2)*s^2 - 
          3*(-2 - 3*d + d^2)*s*t + 6*t^2)) - gZdR*gZlR*gZlRC*
       (d^2*gZuRC*(2*Pi)^d*s^2 - 2^(1 + d)*gZuRC*Pi^d*
         (2*(3 - 3*d + d^2)*s^2 + 3*(8 - 5*d + d^2)*s*t + 6*t^2) + 
        gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((48 - 30*d + 4*d^2)*s^2 + 
            3*(10 - 7*d + d^2)*s*t - 6*t^2))) + gZdL*gZlL*gZlLC*
       (-(gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((48 - 30*d + 4*d^2)*s^2 + 
             3*(10 - 7*d + d^2)*s*t - 6*t^2))) + 
        gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*(3 - 3*d + d^2)*s^2 + 
            3*(8 - 5*d + d^2)*s*t + 6*t^2))))*SPList[SP[p1, q1]])/
    (Pi^(2*d)*s*(-mz^2 + s)*(-mzC^2 + s)) - 
   (I*2^(1 - 2*d)*EL^6*gAd*gAu*(gZdR*gZlR*gZlRC*(d^2*gZuLC*(2*Pi)^d*s^2 + 
        d^2*gZuRC*(2*Pi)^d*s^2 + 2^(1 + d)*gZuRC*Pi^d*((12 - 9*d + d^2)*s^2 - 
          3*(14 - 7*d + d^2)*s*t - 6*t^2) + 2^(1 + d)*gZuLC*Pi^d*
         ((12 - 9*d + d^2)*s^2 + 3*(4 - 5*d + d^2)*s*t - 6*t^2)) + 
      gZdL*gZlL*gZlLC*(d^2*gZuLC*(2*Pi)^d*s^2 + d^2*gZuRC*(2*Pi)^d*s^2 + 
       ...
       (gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((12 - 9*d + 2*d^2)*s^2 + 
          ...
          2^(1 + d)*Pi^d*((24 - 21*d + 4*d^2)*s^2 + 3*(2 - 3*d + d^2)*s*t + 
            6*t^2))))*SPList[SP[p2, q1]])/(Pi^(2*d)*s*(-mz^2 + s)*
     (-mzC^2 + s)) - ((3*I)*2^(2 - d)*(-3 + d)*EL^6*gAd*gAu*(gZdL - gZdR)*
    ...
    (Pi^d*(mz^2 - s)*(-mzC^2 + s)) + ((3*I)*2^(1 - 2*d)*EL^6*gAd*gAu*
     (gZdL + gZdR)*(-(gZlR*gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s^2) + 
    ...
    (Pi^(2*d)*s*(-mz^2 + s)*(-mzC^2 + s)) + 
   ((3*I)*2^(3 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*
   ...
   ((3*I)*2^(3 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*
     (gZlL*gZlLC*(6*gZuLC*s - d*gZuLC*s + d*gZuRC*s + 2*gZuLC*t + 
        ...
        2*gZuRC*(3*s + t)))*SPList[SP[p1, q1], SP[p3, q1]])/
   ...
   ((3*I)*2^(3 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*
    ...
    (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
   ((3*I)*2^(4 - d)*EL^6*gAd*gAu*(gZdL + gZdR)*(gZlL*gZlLC + gZlR*gZlRC)*
