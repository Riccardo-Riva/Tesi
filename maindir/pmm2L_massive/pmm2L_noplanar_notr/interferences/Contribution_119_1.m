...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(mm^2 - psq)^2*
      \[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) - 
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     (4*d*mm^2 + 18*s - 9*d*s + d^2*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     (psq + (-5 + d)*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (4*(-2 + d)*mm^2 - 4*(-2 + d)*psq + (30 - 15*d + 2*d^2)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     (d^2*s + 2*(psq + 7*s - t) + d*(4*mm^2 - psq - 7*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-2*psq + 3*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*mm^2 - 8*psq + 
      28*s - 10*d*s + d^2*s + 12*t - 2*d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     (d^2*s + d*(4*mm^2 + psq - 8*s - t) + 2*(-psq + 8*s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(d^2*(mm^2 - psq)*s + 
      d*(2*psq^2 + 5*psq*s + 3*s^2 - 2*mm^2*(2*psq + s - 2*t) - 4*psq*t + 
        3*s*t + 2*t^2) - 2*(2*psq^2 - 4*mm^2*s + 7*s^2 + psq*(s - 4*t) + 
        5*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (mm^2 - psq)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-psq + (-4 + d)*s + t)*
   ...
   (4^(2 - d)*(8 - 6*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (2^(5 - 2*d)*(28 - 10*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     ...
     gXll^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (4*(-2 + d)*psq - (24 - 8*d + d^2)*s - 4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(7 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-psq + s + t)*
