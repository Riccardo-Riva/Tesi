...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  ((I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^6*(mm^2 - psq)^2*s*
     \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*
     (mm^2*(5*psq - 2*s - 5*t) + psq*(3*psq - 2*s - 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
     (mm^2 - psq)*(bb*mm^2*(3*psq + s - 3*t) + bb*psq*(psq - s - t) - 
      aa*psq*(psq + s - t) + aa*mm^2*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*
     mm^6*(mm^2*(5*psq - 3*s - 5*t) + psq*(3*psq - s - 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
     (mm^2 - psq)*(bb*mm^2*(3*psq - 2*s - 3*t) + bb*psq*(psq - 2*s - t) + 
      aa*psq*(-psq + t) + aa*mm^2*(-3*psq + 4*s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gHll^4*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(3*psq - 2*s - 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2*(7*psq - 4*s - 7*t) + 
      psq*(psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(-psq + s + t)*
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^4*(aa*mm^2*(2*psq - s - 2*t) - 
      bb*mm^2*(2*psq + s - 2*t) + aa*psq*(2*psq + s - 2*t) + 
      bb*psq*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(-3*psq + s + 3*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2*(7*psq - 3*s - 7*t) + 
      psq*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(psq - t)*
   ...
   (I*4^(2 - d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*(bb*(2*mm^2 - s - 2*t) + 
      aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*(bb*(mm^2 - psq - s) + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 - psq - s) + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q1, q2]])/Pi^(2*d) + (I*4^(2 - d)*bb*EL^5*gAl*gHll^4*mm^4*
