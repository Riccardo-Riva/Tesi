...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 ((I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)^2*
  ...
  (I*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    (bb*s*(4*psq - 3*s - 4*t) + 2*aa*mm^2*(psq - t) + 
     bb*mm^2*(-2*psq + 6*s + 2*t) + aa*s*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*(aa + 2*bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    ...
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*(2*aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*s*
    ...
    gXll^2*mm^4*(mm^2 - psq)*s*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    (bb*(8*mm^2 + 4*psq - 3*s - 4*t) + aa*(-4*psq + 3*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa + 3*bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(bb*(4*psq - s - 4*t) + 
     aa*(8*mm^2 - 4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(3*aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)^2*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*s + bb*(4*mm^2 + s))*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(2*bb*mm^2 + aa*s)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(psq - t) + 
     bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*bb*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (mm^2 - psq)^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(2*aa*mm^2 + bb*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa + 2*bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*s*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - 2*s)*(aa*(2*mm^2 - psq - t) + 
   ...
   (2*Pi)^(2*d) - (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    (bb*s + aa*(4*mm^2 + s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - 2*s)*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(psq - t) + 
     bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*aa*EL^5*gAl*gHll^2*gXll^2*mm^4*
    (mm^2 - psq)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(2*aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*s*
