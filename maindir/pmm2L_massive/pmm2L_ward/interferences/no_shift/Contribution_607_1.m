(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  (((-I)*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*s*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     ((-8 + 3*d)*s + 2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*(-10 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*(s + 2*t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     ((-3 + d)*s - (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*
     gZlL*(2*(-5 + 2*d)*s + (-18 + 7*d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-18 + 7*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*(s + 2*t)*
