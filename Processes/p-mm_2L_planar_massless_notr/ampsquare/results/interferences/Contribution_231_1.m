(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mz], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*
     ...
     (gZlL^2 + gZlR^2)*((-2 + d)*s^2 + (-1 + d)*s*t + 2*(-3 + d)*t^2)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*(2*s + d*t)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*
     ((1 + d)*s^2 - 3*(-5 + d)*s*t + 6*t^2)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-8 + 3*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*
     (gZlL^2 + gZlR^2)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*
     ((-25 + 7*d)*s^2 + 3*(-3 + d)*s*t + 6*t^2)*SPList[SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*
     (gZlL^2 + gZlR^2)*((-2 + d)*s + (-3 + d)*t)*SPList[SP[p1, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*
     (gZlL^2 + gZlR^2)*((-6 + d)*s - t)*SPList[SP[p1, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*
     ((-4 + d)*s - 2*t)*SPList[SP[p1, q1], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*((-5 + d)*s - t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*
     ...
     (gZlL^2 + gZlR^2)*(7*s + (22 - 6*d)*t)*SPList[SP[p1, q2], SP[p3, q1]])/
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*
     (4*(-2 + d)*s^2 + 3*(-1 + d)*s*t + 6*t^2)*SPList[SP[p2, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*
     (gZlL^2 + gZlR^2)*(s - (-3 + d)*t)*SPList[SP[p2, q1], SP[p3, q1]])/
   ...
   (2^(5 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*((-4 + d)*s + t)*
   ...
   (2^(7 - 2*d)*EL^8*gAl*gAu^2*gWWA*gWWZ^2*(gZlL^2 + gZlR^2)*
