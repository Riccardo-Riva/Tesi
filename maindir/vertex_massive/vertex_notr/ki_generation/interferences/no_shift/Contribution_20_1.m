...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*(2*(-1 + d)*mm^4 + 
    ...
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*
     ...
     (4*mm^2 - (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*(4*mm^2 + (8 - 3*d)*s)*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*(2*(-3 + d)*mm^2 - 
    ...
    (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*(3*mm^2 - psq + s)*
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*(12*mm^2 - (-2 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*((-5 + d)*mm^2 - (-5 + d)*psq + 
