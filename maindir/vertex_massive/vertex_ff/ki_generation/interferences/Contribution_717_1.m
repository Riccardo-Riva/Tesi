...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   ((4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2 - psq)*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)^2*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2 - psq)*
      (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (mm^2 - psq)^2*(psq - t)*(psq - s - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2 - psq)*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)^2*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
    (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*
    ...
    (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*psq^2 + 4*mm^2*s - 7*psq*s + 
    ...
    (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
      ...
      gXll^2*mm^2*(-4*psq^3 - 2*psq^2*(s - 5*t) + psq*(s^2 - 5*s*t - 8*t^2) + 
      ...
      gXll^2*mm^2*(mm^2 - psq)*(psq^2 + s^2 + mm^2*(psq - t) + 2*s*t + 
       2*t^2 - 3*psq*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (mm^2 - psq)*(mm^2 - 3*psq + s)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-5*psq^3 + 14*psq^2*t + 
       psq*(s^2 - 8*s*t - 13*t^2) + mm^2*(psq^2 - s^2 + 2*psq*(s - t) + 
         t^2) + 2*t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) - 
    (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*psq^2 + s^2 + s*t + 2*t^2 - 
       psq*(s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (mm^2 - psq)*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*
      (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      gXll^2*mm^2*(-2*psq + s + 2*t)*(-2*psq^2 + mm^2*(psq - t) + 3*psq*t - 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(5*psq^2 - 4*psq*s + s^2 - 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq^2 + mm^2*(psq - t) - 
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*(psq - t)*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (5*psq^2 - 6*psq*s + 2*s^2 - 9*psq*t + 5*s*t + 4*t^2 + 
       ...
       SP[p3, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      gXll^2*mm^2*(-2*psq^2 + mm^2*(psq - t) + 3*psq*t - t*(s + t))*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq^2 + mm^2*s + t^2 - 
       psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      gXll^2*mm^2*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*
