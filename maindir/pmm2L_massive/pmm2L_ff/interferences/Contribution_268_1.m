...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((2^(3 - 2*d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*
      mm^2*sw*(4*psq^3 + 2*mm^2*(-psq + s + t)^2 + 2*psq*t*(3*s + 4*t) - 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
      ...
      SPList[SP[p3, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gFZW*gHFW*gHll*
      gWWA*(gZlL + gZlR)*mm^2*sw*(psq - s - t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*
      mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q1]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*
      (gZlL + gZlR)*mm^2*sw*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*
    ...
    (4^(1 - d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
     ...
     Pi^(2*d) - (4^(2 - d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*
      mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFZW*gHFW*gHll*gWWA*
      (gZlL + gZlR)*mm^2*sw*(psq - t)^2*\[Mu]^(8 - 2*d)*
