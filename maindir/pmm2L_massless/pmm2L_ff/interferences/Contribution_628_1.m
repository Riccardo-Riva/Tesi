...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(-6*d*gZlL*gZlR*mm^2 + 
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*t*(-3*d*gZlL*gZlR*mm^2*(s + 2*t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(s + 2*t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^6*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^4*t*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*t*(4*(gZlL^2 + gZlR^2)*t + 
      d*(-2*gZlL^2*t - 2*gZlR^2*t + gZlL*gZlR*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*t*(-4*d*gZlL*gZlR*mm^2*(s + 2*t) + 
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(s + t)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*t*
     ((-2 + d)*mm^2 - (-6 + d)*(s + t))*\[Mu]^(8 - 2*d)*
