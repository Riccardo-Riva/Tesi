...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*s*
  ...
  ((aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^4*s*(mm^2 + psq + s)*
  ...
  ((aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 + psq)*s*
  ...
  ((-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
    (2*aa*mm^4 + bb*mm^2*(2*psq - 3*s) + aa*psq*s - bb*psq*s + 
     aa*mm^2*(-4*psq + 3*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
   (2*Pi)^(2*d) + ((-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
    (2*aa*mm^4 + bb*mm^2*(2*psq - 3*s) + aa*psq*s - bb*psq*s + 
     aa*mm^2*(-4*psq + 3*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   (2*Pi)^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*
    mm^4*(mm^2 + psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
   Pi^(2*d) + ((-aa + bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
    (2*mm^4 - psq*s + mm^2*(2*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  ((-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*(aa*mm^2*(8*psq - 5*s) - 
     aa*psq*s + 3*bb*psq*s + bb*mm^2*(-8*psq + 3*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) + 
  ((-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*(aa*mm^2*(8*psq - 6*s) - 
     aa*psq*s + 4*bb*psq*s + bb*mm^2*(-8*psq + 3*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) - 
  ((aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  ((-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*(aa*mm^2 - bb*psq)*s*
  ...
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
   ...
   Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
    (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[q2, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*
    gWNl*gWWA*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*(aa*mm^2 - bb*psq)*
