...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   ((I*EL^5*gAl*gHll^2*mm^4*(mm^2 - psq)*s*
      ...
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + (I*2^(1 - 4*d)*(aa - bb)*EL^5*gAl*
      gHll^2*mm^4*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq)*
        (2*psq - s - 2*t) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 + psq)*
        (2*psq - s - 2*t) - 2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
        (d*mm^2*(3*psq - s - 3*t) + d*psq*(psq - s - t) + 
         2*s*(-mm^2 - psq + s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     Pi^(4*d) - (I*EL^5*gAl*gHll^2*mm^2*(mm^2 - psq)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
      (aa*(2*d*gZlL*gZlR*(2*psq - s - 2*t) + (-2 + d)*gZlL^2*
         ...
         (-2 + d)*gZlR^2*(2*mm^2 - s - 2*t) + 2*d*gZlL*gZlR*
          (-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
      (aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*s + d*(-psq + s + t)) - 
         gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + (-2 + d)*psq^2 + 
           (-10 + d)*psq*s + 2*s*(s + t) + mm^2*(-4*(-2 + d)*psq + d*s - 
             4*t + 2*d*t)) - gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + 
           (-2 + d)*psq^2 + (-10 + d)*psq*s + 2*s*(s + t) + 
           mm^2*(-4*(-2 + d)*psq + d*s - 4*t + 2*d*t))) + 
