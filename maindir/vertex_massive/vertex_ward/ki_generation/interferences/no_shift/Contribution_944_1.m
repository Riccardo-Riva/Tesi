...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(aa*mm^2*(6*psq - 2*s) + 
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     ...
     SPList[SP[p1, q2]])/Pi^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*
     gXll^2*mm^6*(3*mm^2 + 2*psq - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - s)*s*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*s*
     ...
     SPList[SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (bb*(2*mm^2 + 2*psq - s) + aa*(-4*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(mm^2 + 2*psq - s) + 
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(2*psq - s)*
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(2*psq - s) + aa*psq*s + 
