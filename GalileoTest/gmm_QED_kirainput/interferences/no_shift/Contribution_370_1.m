...
(PropList[KiraPropagator[q1, mh], KiraPropagator[-p1 - p2 + q1, mz]]*
   (((I/16)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(4*mm^4 + 2*(-2 + d)*mu^2*s - 
    ...
    ((I/16)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2*(-3 + d)*mm^2 + 2*mu^2 + 4*s - 
         ...
         d*s - 6*t + 2*d*t))*SPList[SP[q1, q1]])/(Pi^4*(mz^3 - mz*s)^2) + 
    ...
    ((I/8)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2*mm^2 + 4*mu^2 + 4*s - d*s - 
         2*t) + gZlL*gZuR*(2*mm^2 + 4*mu^2 + 4*s - d*s - 2*t) + 
       gZlL*gZuL*(2*mm^2 + 4*mu^2 - 2*s + d*s - 2*t) + 
       gZlR*gZuR*(2*mm^2 + 4*mu^2 - 2*s + d*s - 2*t))*
      SPList[SP[p2, q1], SP[p3, q1]])/(Pi^4*s*(mz^3 - mz*s)^2) - 
    ((I/4)*EL^6*gAl*gAu*gHZZ^2*(gZlL + gZlR)*(gZuL + gZuR)*(2*mu^2 + s)*
      SPList[SP[p3, q1], SP[p3, q1]])/(Pi^4*s*(mz^3 - mz*s)^2)) + 
  PropList[KiraPropagator[q1, mh], KiraPropagator[-p1 - p2 + q1, 
   ...
   (((I/16)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2*(-3 + d)*mm^2 + 2*mu^2 + 4*s - 
    ...
    ((I/8)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2*mm^2 + 4*mu^2 + 4*s - d*s - 
      ...
      SPList[SP[p2, q1], SP[p3, q1]])/(Pi^4*s*(mz^3 - mz*s)^2) + 
    ((I/4)*EL^6*gAl*gAu*gHZZ^2*(gZlL + gZlR)*(gZuL + gZuR)*(2*mu^2 + s)*
      SPList[SP[p3, q1], SP[p3, q1]])/(Pi^4*s*(mz^3 - mz*s)^2)))/4
