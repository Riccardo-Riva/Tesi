...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   ((EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(mm^2 - psq)*s*
      (2*bb*psq + aa*(-2*psq + s))*\[Mu]^(8 - 2*d))/(mh^2*(2*Pi)^(2*d)) - 
    ...
    (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(psq - s)*s*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(mh^2*Pi^(2*d)) - 
    (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*psq*s*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(mh^2*Pi^(2*d)) + 
    ((-aa + bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(4*psq - s)*s*
    ...
    (4^(1 - d)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
      (-2*aa*psq + bb*(mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/(mh^2*Pi^(2*d)) + (4^(1 - d)*EL^5*gAl^2*ggmgmA*gHgmgm*
      gHll*mm^2*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(mh^2*Pi^(2*d)) + (4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA*
      gHgmgm*gHll*mm^2*(mm^2 - psq + s)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)) + 
    (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
      (2*mm^2 + 2*psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
     (mh^2*Pi^(2*d)) + (4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*
