PropList[KiraPropagator[p3 + q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 (((-I/16)*EL^6*gAl*gAu*gFFZ^2*mm^2*(4*(gZlL + gZlR)*(gZuL + gZuR)*mm^2 + 
     (gZlL + gZlR)*(gZuL + gZuR)*s - ((-3 + d)*(gZlL - gZlR)*(gZuL - gZuR)*
       (mm^2 - t)^2)/s + ((-3 + d)*(gZlL - gZlR)*(gZuL - gZuR)*
       (-mm^2 + s + t)^2)/s))/(Pi^4*(mz^2 - s)^2) + 
  ((I/8)*EL^6*gAl*gAu*gFFZ^2*mm^2*(gZlL*gZuL*(-2*mm^2 + 6*s - d*s + 2*t) + 
  ...
  ((I/8)*EL^6*gAl*gAu*gFFZ^2*mm^2*(gZlR*gZuL*(2*mm^2 + 4*s - d*s - 2*t) + 
  ...
  ((I/16)*EL^6*gAl*gAu*gFFZ^2*((gZlL + gZlR)*(gZuL + gZuR)*s - 
     ((-3 + d)*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - t)^2)/s + 
     ((-3 + d)*(gZlL - gZlR)*(gZuL - gZuR)*(-mm^2 + s + t)^2)/s)*
  ...
  ((I/8)*EL^6*gAl*gAu*gFFZ^2*(gZlL*gZuL*(-2*mm^2 + 6*s - d*s + 2*t) + 
     gZlR*gZuR*(-2*mm^2 + 6*s - d*s + 2*t) + 
     gZlR*gZuL*(-2*mm^2 + d*s + 2*t) + gZlL*gZuR*(-2*mm^2 + d*s + 2*t))*
  ...
  ((I/8)*EL^6*gAl*gAu*gFFZ^2*(gZlR*gZuL*(2*mm^2 + 4*s - d*s - 2*t) + 
     gZlL*gZuR*(2*mm^2 + 4*s - d*s - 2*t) + 
     gZlL*gZuL*(2*mm^2 - 2*s + d*s - 2*t) + 
   ...
   (Pi^4*(mz^2 - s)^2*s) - ((I/4)*EL^6*gAl*gAu*gFFZ^2*(gZlL + gZlR)*
