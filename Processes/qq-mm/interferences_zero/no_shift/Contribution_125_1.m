...
(PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, 0], 
   ...
   (((I/16)*EL^6*gAl^2*gAu^2*mu^2*
     ...
     (Pi^4*s) - ((I/16)*EL^6*gAl^2*gAu^2*
      (gZlR*gZuL*(-2*(-8 + 20*d - 8*d^2 + d^3)*mm^4 - 72*s^2 + 26*d*s^2 + 
         ...
         24*t^2 - 40*d*t^2 + 16*d^2*t^2 - 2*d^3*t^2 + 2*(-2 + d)*mu^2*
          ((20 - 8*d + d^2)*s + (12 - 6*d + d^2)*t) + 
         mm^2*(-2*(-144 + 172*d - 68*d^2 + 9*d^3)*mu^2 + 
           (8 + 54*d - 26*d^2 + 3*d^3)*s + 4*(-10 + 20*d - 8*d^2 + d^3)*t)) + 
       gZlL*gZuR*(-2*(-8 + 20*d - 8*d^2 + d^3)*mm^4 - 72*s^2 + 26*d*s^2 + 
         ...
         mm^2*(-2*(-144 + 172*d - 68*d^2 + 9*d^3)*mu^2 + 
           (8 + 54*d - 26*d^2 + 3*d^3)*s + 4*(-10 + 20*d - 8*d^2 + d^3)*t)) + 
       gZlL*gZuL*(2*(-28 + 22*d - 8*d^2 + d^3)*mm^4 - 2*(-2 + d)*mu^2*
          ((10 - 8*d + d^2)*s + (6 - 6*d + d^2)*t) + (-4 + d)*(s + t)*
          ((-12 + 2*d + d^2)*s + 2*(6 - 4*d + d^2)*t) + 
         mm^2*(2*(-132 + 166*d - 68*d^2 + 9*d^3)*mu^2 + 
           (56 - 64*d + 26*d^2 - 3*d^3)*s - 4*(-26 + 22*d - 8*d^2 + d^3)*
            t)) + gZlR*gZuR*(2*(-28 + 22*d - 8*d^2 + d^3)*mm^4 - 
         2*(-2 + d)*mu^2*((10 - 8*d + d^2)*s + (6 - 6*d + d^2)*t) + 
         (-4 + d)*(s + t)*((-12 + 2*d + d^2)*s + 2*(6 - 4*d + d^2)*t) + 
         mm^2*(2*(-132 + 166*d - 68*d^2 + 9*d^3)*mu^2 + 
           (56 - 64*d + 26*d^2 - 3*d^3)*s - 4*(-26 + 22*d - 8*d^2 + d^3)*
            t)) + (2*mu^2*(d^2*(gZlL - gZlR)*(gZuL - gZuR)*
           (mm^4 + 2*s^2 + 3*s*t + t^2 - mm^2*(7*s + 2*t)) + 
          d*(-(gZlL*gZuL*(5*mm^4 + 9*s^2 + 14*s*t + 5*t^2 - 2*mm^2*
                (17*s + 5*t))) - gZlR*gZuR*(5*mm^4 + 9*s^2 + 14*s*t + 5*t^2 - 
              2*mm^2*(17*s + 5*t)) + gZlR*gZuL*(5*mm^4 + 11*s^2 + 16*s*t + 
              5*t^2 - 2*mm^2*(18*s + 5*t)) + gZlL*gZuR*(5*mm^4 + 11*s^2 + 
              16*s*t + 5*t^2 - 2*mm^2*(18*s + 5*t))) - 
          4*(gZlL*gZuL*(-2*s^2 - 3*s*t - t^2 + mm^2*(8*s + t)) + 
            gZlR*gZuR*(-2*s^2 - 3*s*t - t^2 + mm^2*(8*s + t)) + 
            gZlR*gZuL*(3*mm^4 - mm^2*(13*s + 5*t) + 2*(2*s^2 + 3*s*t + 
                t^2)) + gZlL*gZuR*(3*mm^4 - mm^2*(13*s + 5*t) + 
              2*(2*s^2 + 3*s*t + t^2)))))/mz^2)*SPList[SP[p1, q1]])/
     (Pi^4*s) + ((I/16)*EL^6*gAl^2*gAu^2*
      (gZlR*gZuL*(-2*(-4 + d)*(-2 + d)^2*mm^4 - 4*(8 - 6*d + d^2)*s^2 - 
         (104 - 66*d + 6*d^2 + d^3)*s*t - 
         2*t*((-24 + 24*d - 8*d^2 + d^3)*mu^2 + (-20 + 20*d - 8*d^2 + d^3)*
            t) + mm^2*(2*(-64 + 88*d - 36*d^2 + 5*d^3)*mu^2 + 
           (120 - 66*d + 6*d^2 + d^3)*s + 4*(-18 + 20*d - 8*d^2 + d^3)*t)) + 
       gZlL*gZuR*(-2*(-4 + d)*(-2 + d)^2*mm^4 - 4*(8 - 6*d + d^2)*s^2 - 
         (104 - 66*d + 6*d^2 + d^3)*s*t - 
         2*t*((-24 + 24*d - 8*d^2 + d^3)*mu^2 + (-20 + 20*d - 8*d^2 + d^3)*
            t) + mm^2*(2*(-64 + 88*d - 36*d^2 + 5*d^3)*mu^2 + 
           (120 - 66*d + 6*d^2 + d^3)*s + 4*(-18 + 20*d - 8*d^2 + d^3)*t)) + 
       gZlL*gZuL*(2*(-20 + 22*d - 8*d^2 + d^3)*mm^4 + 4*(-2 + d)^2*s^2 + 
         (112 - 60*d + 6*d^2 + d^3)*s*t - 
         mm^2*(2*(-68 + 82*d - 36*d^2 + 5*d^3)*mu^2 + 
           (96 - 60*d + 6*d^2 + d^3)*s + 4*(-18 + 22*d - 8*d^2 + d^3)*t) + 
         2*t*((-12 + 18*d - 8*d^2 + d^3)*mu^2 + (-16 + 22*d - 8*d^2 + d^3)*
         ...
         2*t*((-12 + 18*d - 8*d^2 + d^3)*mu^2 + (-16 + 22*d - 8*d^2 + d^3)*
            t)) - (2*mu^2*(d^2*(gZlL - gZlR)*(gZuL - gZuR)*
           (mm^4 + 3*s^2 + mm^2*(s - 2*t) + 5*s*t + t^2) + 
          4*(gZlL*gZuL*s*(2*mm^2 + 5*s + 6*t) + gZlR*gZuR*s*
             (2*mm^2 + 5*s + 6*t) - gZlR*gZuL*(3*mm^4 + 4*s^2 + 
              mm^2*(s - 6*t) + 9*s*t + 3*t^2) - gZlL*gZuR*(3*mm^4 + 4*s^2 + 
              mm^2*(s - 6*t) + 9*s*t + 3*t^2)) + 
          d*(gZlR*gZuL*(5*mm^4 + 14*s^2 + 5*mm^2*(s - 2*t) + 25*s*t + 
              5*t^2) + gZlL*gZuR*(5*mm^4 + 14*s^2 + 5*mm^2*(s - 2*t) + 
              25*s*t + 5*t^2) - gZlL*gZuL*(5*mm^4 + 16*s^2 + 
              5*mm^2*(s - 2*t) + 25*s*t + 5*t^2) - gZlR*gZuR*
             (5*mm^4 + 16*s^2 + 5*mm^2*(s - 2*t) + 25*s*t + 5*t^2))))/mz^2)*
    ...
    ((I/8)*EL^6*gAl^2*gAu^2*((4*(6 - 5*d + d^2)*(gZlL - gZlR)*(gZuL - gZuR)*
    ...
    ((I/8)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL*(4*(9 - 9*d + 2*d^2)*mm^2 + 
       ...
       gZlL*gZuR*(-4*(-42 + 47*d - 17*d^2 + 2*d^3)*mm^2 + 
         (8 + 6*d - 6*d^2 + d^3)*s + 4*(30 - 19*d + 3*d^2)*t) + 
       (2*mu^2*(gZlL*gZuL*((36 - 25*d + 5*d^2)*mm^2 + (8 - 9*d + 2*d^2)*s + 
            (4 - 5*d + d^2)*t) + gZlR*gZuR*((36 - 25*d + 5*d^2)*mm^2 + 
            (8 - 9*d + 2*d^2)*s + (4 - 5*d + d^2)*t) - 
          gZlR*gZuL*((24 - 25*d + 5*d^2)*mm^2 + (16 - 11*d + 2*d^2)*s + 
            (8 - 5*d + d^2)*t) - gZlL*gZuR*((24 - 25*d + 5*d^2)*mm^2 + 
            (16 - 11*d + 2*d^2)*s + (8 - 5*d + d^2)*t)))/mz^2)*
    ...
    ((I/8)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL*(2*(14 - 8*d + d^2)*mm^2 + 
       ...
       gZlL*gZuR*(-2*(-52 + 44*d - 12*d^2 + d^3)*mm^2 - 
         4*(-20 + 22*d - 8*d^2 + d^3)*mu^2 - 216*s + 170*d*s - 42*d^2*s + 
         3*d^3*s - 104*t + 88*d*t - 24*d^2*t + 2*d^3*t) + 
       (2*mu^2*(d^2*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - 2*s - t) - 
          4*gZlL*(3*gZuR*mm^2 + gZuL*(2*s + t) - 2*gZuR*(2*s + t)) - 
          4*gZlR*(3*gZuL*mm^2 - 2*gZuL*(2*s + t) + gZuR*(2*s + t)) + 
          d*gZlL*(gZuR*(5*mm^2 - 11*s - 5*t) + gZuL*(-5*mm^2 + 9*s + 5*t)) + 
          d*gZlR*(gZuL*(5*mm^2 - 11*s - 5*t) + gZuR*(-5*mm^2 + 9*s + 5*t))))/
        mz^2)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^4*s) + 
    ((I/8)*EL^6*gAl^2*gAu^2*(-(d^2*(gZlL - gZlR)*(gZuL - gZuR)*
         (mm^2*(mu^2 - 2*s) - mu^2*(2*s + t))) + 
       4*(gZlL*(3*gZuR*mm^2*(mu^2 - s) + 3*gZuL*mm^2*s + 
           gZuL*mu^2*(2*s + t) - 2*gZuR*mu^2*(2*s + t)) + 
         gZlR*(3*gZuL*mm^2*(mu^2 - s) + 3*gZuR*mm^2*s - 
           2*gZuL*mu^2*(2*s + t) + gZuR*mu^2*(2*s + t))) + 
       d*(gZlR*(-5*gZuL*mm^2*(mu^2 - 2*s) + 5*gZuR*mm^2*(mu^2 - 2*s) - 
           gZuR*mu^2*(9*s + 5*t) + gZuL*mu^2*(11*s + 5*t)) + 
         gZlL*(5*gZuL*mm^2*(mu^2 - 2*s) - 5*gZuR*mm^2*(mu^2 - 2*s) - 
           gZuL*mu^2*(9*s + 5*t) + gZuR*mu^2*(11*s + 5*t))))*
    ...
    ((I/8)*EL^6*gAl^2*gAu^2*((-4 + d)*((-4 - 2*d + d^2)*gZlL*gZuL + 
       ...
       (2*mu^2*(gZlL*gZuL*((20 - 15*d + 3*d^2)*mm^2 + 2*(6 - 5*d + d^2)*s + 
            (4 - 5*d + d^2)*t) + gZlR*gZuR*((20 - 15*d + 3*d^2)*mm^2 + 
            2*(6 - 5*d + d^2)*s + (4 - 5*d + d^2)*t) - 
          gZlR*gZuL*((16 - 15*d + 3*d^2)*mm^2 + 2*(6 - 5*d + d^2)*s + 
            (8 - 5*d + d^2)*t) - gZlL*gZuR*((16 - 15*d + 3*d^2)*mm^2 + 
            2*(6 - 5*d + d^2)*s + (8 - 5*d + d^2)*t)))/mz^2)*
      SPList[SP[p2, q1], SP[p2, q1]])/(Pi^4*s) + 
    ((I/8)*EL^6*gAl^2*gAu^2*
      ((2*mu^2*(-4*(7*gZlL*gZuL*s + 7*gZlR*gZuR*s + gZlR*gZuL*
             (3*mm^2 - 8*s - 3*t) + gZlL*gZuR*(3*mm^2 - 8*s - 3*t)) - 
          5*d*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - 5*s - t) + 
          d^2*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - 5*s - t)))/mz^2 - 
       (-4 + d)*gZlL*gZuL*(2*(14 - 8*d + d^2)*mm^2 - 4*(-2 + d)^2*mu^2 - 
         4*s - 2*d*s + d^2*s - 28*t + 16*d*t - 2*d^2*t) - 
       (-4 + d)*gZlR*gZuR*(2*(14 - 8*d + d^2)*mm^2 - 4*(-2 + d)^2*mu^2 - 
         4*s - 2*d*s + d^2*s - 28*t + 16*d*t - 2*d^2*t) + 
       ...
       gZlL*gZuR*(2*(-52 + 44*d - 12*d^2 + d^3)*mm^2 - 
         4*(-20 + 22*d - 8*d^2 + d^3)*mu^2 + 8*s + 6*d*s - 6*d^2*s + d^3*s + 
         104*t - 88*d*t + 24*d^2*t - 2*d^3*t))*SPList[SP[p2, q1], 
       SP[p3, q1]])/(Pi^4*s) - ((I/8)*EL^6*gAl^2*gAu^2*
      (gZlL*gZuL*(4*mm^4 + 4*s^2 - 4*d*s^2 + d^2*s^2 + 
         mm^2*((12 - 5*d + d^2)*mu^2 - 8*t) + 16*s*t - 10*d*s*t + 2*d^2*s*t + 
         4*t^2 - (-4 + d)*mu^2*(2*(-2 + d)*s + (-1 + d)*t)) + 
       gZlR*gZuR*(4*mm^4 + 4*s^2 - 4*d*s^2 + d^2*s^2 + 
         mm^2*((12 - 5*d + d^2)*mu^2 - 8*t) + 16*s*t - 10*d*s*t + 2*d^2*s*t + 
         4*t^2 - (-4 + d)*mu^2*(2*(-2 + d)*s + (-1 + d)*t)) + 
       gZlR*gZuL*(4*mm^4 - 8*s^2 + 6*d*s^2 - d^2*s^2 - 8*s*t + 10*d*s*t - 
         2*d^2*s*t + 4*t^2 - mm^2*(-5*d*mu^2 + d^2*mu^2 + 8*t) + 
         mu^2*(2*(-2 + d)^2*s + (8 - 5*d + d^2)*t)) + 
  ...
  PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I/16)*EL^6*gAl^2*gAu^2*mu^2*
     ...
     (mz^2*Pi^4*s) + ((I/8)*EL^6*gAl^2*gAu^2*mu^2*
      (d^2*(gZlL - gZlR)*(gZuL - gZuR)*(mm^4 + 2*s^2 + 3*s*t + t^2 - 
         mm^2*(7*s + 2*t)) + 
       d*(-(gZlL*gZuL*(5*mm^4 + 9*s^2 + 14*s*t + 5*t^2 - 
            2*mm^2*(17*s + 5*t))) - gZlR*gZuR*(5*mm^4 + 9*s^2 + 14*s*t + 
           5*t^2 - 2*mm^2*(17*s + 5*t)) + gZlR*gZuL*(5*mm^4 + 11*s^2 + 
           16*s*t + 5*t^2 - 2*mm^2*(18*s + 5*t)) + 
         gZlL*gZuR*(5*mm^4 + 11*s^2 + 16*s*t + 5*t^2 - 
           2*mm^2*(18*s + 5*t))) - 
       4*(gZlL*gZuL*(-2*s^2 - 3*s*t - t^2 + mm^2*(8*s + t)) + 
         gZlR*gZuR*(-2*s^2 - 3*s*t - t^2 + mm^2*(8*s + t)) + 
         gZlR*gZuL*(3*mm^4 - mm^2*(13*s + 5*t) + 2*(2*s^2 + 3*s*t + t^2)) + 
         gZlL*gZuR*(3*mm^4 - mm^2*(13*s + 5*t) + 2*(2*s^2 + 3*s*t + t^2))))*
      SPList[SP[p1, q1]])/(mz^2*Pi^4*s) + 
    ((I/8)*EL^6*gAl^2*gAu^2*mu^2*(d^2*(gZlL - gZlR)*(gZuL - gZuR)*
        (mm^4 + 3*s^2 + mm^2*(s - 2*t) + 5*s*t + t^2) + 
       4*(gZlL*gZuL*s*(2*mm^2 + 5*s + 6*t) + gZlR*gZuR*s*
          (2*mm^2 + 5*s + 6*t) - gZlR*gZuL*(3*mm^4 + 4*s^2 + mm^2*(s - 6*t) + 
           9*s*t + 3*t^2) - gZlL*gZuR*(3*mm^4 + 4*s^2 + mm^2*(s - 6*t) + 
           9*s*t + 3*t^2)) + d*(gZlR*gZuL*(5*mm^4 + 14*s^2 + 
           5*mm^2*(s - 2*t) + 25*s*t + 5*t^2) + gZlL*gZuR*
          (5*mm^4 + 14*s^2 + 5*mm^2*(s - 2*t) + 25*s*t + 5*t^2) - 
         gZlL*gZuL*(5*mm^4 + 16*s^2 + 5*mm^2*(s - 2*t) + 25*s*t + 5*t^2) - 
         gZlR*gZuR*(5*mm^4 + 16*s^2 + 5*mm^2*(s - 2*t) + 25*s*t + 5*t^2)))*
    ...
    ((I/2)*(6 - 5*d + d^2)*EL^6*gAl^2*gAu^2*(gZlL - gZlR)*(gZuL - gZuR)*mm^2*
      mu^2*SPList[SP[p1, q1], SP[p1, q1]])/(mz^2*Pi^4*s) - 
    ((I/4)*EL^6*gAl^2*gAu^2*mu^2*(gZlL*gZuL*((36 - 25*d + 5*d^2)*mm^2 + 
         (8 - 9*d + 2*d^2)*s + (4 - 5*d + d^2)*t) + 
       gZlR*gZuR*((36 - 25*d + 5*d^2)*mm^2 + (8 - 9*d + 2*d^2)*s + 
         (4 - 5*d + d^2)*t) - gZlR*gZuL*((24 - 25*d + 5*d^2)*mm^2 + 
         (16 - 11*d + 2*d^2)*s + (8 - 5*d + d^2)*t) - 
       gZlL*gZuR*((24 - 25*d + 5*d^2)*mm^2 + (16 - 11*d + 2*d^2)*s + 
         (8 - 5*d + d^2)*t))*SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^4*s) + 
    ((I/4)*EL^6*gAl^2*gAu^2*mu^2*(-(d^2*(gZlL - gZlR)*(gZuL - gZuR)*
         (mm^2 - 2*s - t)) + 4*gZlL*(3*gZuR*mm^2 + gZuL*(2*s + t) - 
         2*gZuR*(2*s + t)) + 4*gZlR*(3*gZuL*mm^2 - 2*gZuL*(2*s + t) + 
         gZuR*(2*s + t)) + d*gZlR*(gZuR*(5*mm^2 - 9*s - 5*t) + 
         gZuL*(-5*mm^2 + 11*s + 5*t)) + d*gZlL*(gZuL*(5*mm^2 - 9*s - 5*t) + 
         gZuR*(-5*mm^2 + 11*s + 5*t)))*SPList[SP[p1, q1], SP[p3, q1]])/
     (mz^2*Pi^4*s) - ((I/8)*EL^6*gAl^2*gAu^2*
      (-(d^2*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2*(mu^2 - 2*s) - 
          mu^2*(2*s + t))) + 4*(gZlL*(3*gZuR*mm^2*(mu^2 - s) + 
           3*gZuL*mm^2*s + gZuL*mu^2*(2*s + t) - 2*gZuR*mu^2*(2*s + t)) + 
         gZlR*(3*gZuL*mm^2*(mu^2 - s) + 3*gZuR*mm^2*s - 
           2*gZuL*mu^2*(2*s + t) + gZuR*mu^2*(2*s + t))) + 
       d*(gZlR*(-5*gZuL*mm^2*(mu^2 - 2*s) + 5*gZuR*mm^2*(mu^2 - 2*s) - 
           gZuR*mu^2*(9*s + 5*t) + gZuL*mu^2*(11*s + 5*t)) + 
         gZlL*(5*gZuL*mm^2*(mu^2 - 2*s) - 5*gZuR*mm^2*(mu^2 - 2*s) - 
           gZuL*mu^2*(9*s + 5*t) + gZuR*mu^2*(11*s + 5*t))))*
      SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^4*s) - 
    ((I/4)*EL^6*gAl^2*gAu^2*mu^2*(gZlL*gZuL*((20 - 15*d + 3*d^2)*mm^2 + 
         2*(6 - 5*d + d^2)*s + (4 - 5*d + d^2)*t) + 
       gZlR*gZuR*((20 - 15*d + 3*d^2)*mm^2 + 2*(6 - 5*d + d^2)*s + 
         (4 - 5*d + d^2)*t) - gZlR*gZuL*((16 - 15*d + 3*d^2)*mm^2 + 
         2*(6 - 5*d + d^2)*s + (8 - 5*d + d^2)*t) - 
       gZlL*gZuR*((16 - 15*d + 3*d^2)*mm^2 + 2*(6 - 5*d + d^2)*s + 
         (8 - 5*d + d^2)*t))*SPList[SP[p2, q1], SP[p2, q1]])/(mz^2*Pi^4*s) + 
    ((I/4)*EL^6*gAl^2*gAu^2*mu^2*
      (4*gZlR*(7*gZuR*s + gZuL*(3*mm^2 - 8*s - 3*t)) + 
       4*gZlL*(7*gZuL*s + gZuR*(3*mm^2 - 8*s - 3*t)) + 
       5*d*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - 5*s - t) - 
       d^2*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - 5*s - t))*
  ...
  PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I/16)*EL^6*gAl^2*gAu^2*mu^2*(mm^2 - s - t)*
    ...
    ((I/16)*EL^6*gAl^2*gAu^2*mu^2*
      (gZlL*gZuL*(2*mm^2 + 2*(8 - 5*d + d^2)*mz^2 + 2*s - d*s - 2*t) + 
       gZlR*gZuR*(2*mm^2 + 2*(8 - 5*d + d^2)*mz^2 + 2*s - d*s - 2*t) + 
       gZlR*gZuL*(2*mm^2 - 2*(4 - 5*d + d^2)*mz^2 - 4*s + d*s - 2*t) + 
       gZlL*gZuR*(2*mm^2 - 2*(4 - 5*d + d^2)*mz^2 - 4*s + d*s - 2*t))*
      (-mm^2 + s + t)^2*(-1 + GaugeXi[Q])*SPList[SP[p1, q1]])/(mz^2*Pi^4*s) - 
    ((I/16)*EL^6*gAl^2*gAu^2*mu^2*
      (-(((gZlR*gZuL*(2*mm^2 + (-4 + d)*s - 2*t) + gZlL*gZuR*
            (2*mm^2 + (-4 + d)*s - 2*t) + gZlL*gZuL*(2*mm^2 - (-2 + d)*s - 
             2*t) + gZlR*gZuR*(2*mm^2 - (-2 + d)*s - 2*t))*(mm^2 - t)*
          (mm^2 - s - t))/mz^2) + 
       2*(-(gZlR*gZuL*((4 - 5*d + d^2)*mm^4 + 2*(8 - 6*d + d^2)*s^2 + 
            (20 - 21*d + 4*d^2)*s*t + (-5 + d)*d*t^2 - 
            mm^2*((28 - 21*d + 4*d^2)*s + 2*(2 - 5*d + d^2)*t))) - 
         gZlL*gZuR*((4 - 5*d + d^2)*mm^4 + 2*(8 - 6*d + d^2)*s^2 + 
           (20 - 21*d + 4*d^2)*s*t + (-5 + d)*d*t^2 - 
           mm^2*((28 - 21*d + 4*d^2)*s + 2*(2 - 5*d + d^2)*t)) + 
         gZlL*gZuL*((8 - 5*d + d^2)*mm^4 + 2*(-2 + d)^2*s^2 + 
           (28 - 19*d + 4*d^2)*s*t + (12 - 5*d + d^2)*t^2 - 
           mm^2*((20 - 19*d + 4*d^2)*s + 2*(10 - 5*d + d^2)*t)) + 
         gZlR*gZuR*((8 - 5*d + d^2)*mm^4 + 2*(-2 + d)^2*s^2 + 
           (28 - 19*d + 4*d^2)*s*t + (12 - 5*d + d^2)*t^2 - 
           mm^2*((20 - 19*d + 4*d^2)*s + 2*(10 - 5*d + d^2)*t))))*
    ...
    ((I/4)*EL^6*gAl^2*gAu^2*mu^2*(-mm^2 + s + t)*
      (gZlL*gZuL*(-((-4 + d)*mm^2) + (8 - 5*d + d^2)*mz^2 + (-4 + d)*t) + 
       gZlR*gZuR*(-((-4 + d)*mm^2) + (8 - 5*d + d^2)*mz^2 + (-4 + d)*t) + 
       gZlR*gZuL*((-2 + d)*mm^2 - (4 - 5*d + d^2)*mz^2 - (-2 + d)*t) + 
       gZlL*gZuR*((-2 + d)*mm^2 - (4 - 5*d + d^2)*mz^2 - (-2 + d)*t))*
      (-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^4*s) - 
    ((I/4)*EL^6*gAl^2*gAu^2*mu^2*((8 - 5*d + d^2)*gZlL*gZuL - 
       (4 - 5*d + d^2)*gZlR*gZuL - (4 - 5*d + d^2)*gZlL*gZuR + 
       (8 - 5*d + d^2)*gZlR*gZuR + (2*(gZlL + gZlR)*(gZuL + gZuR)*
         (mm^2 - s - t))/mz^2)*(-mm^2 + s + t)*(-1 + GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p3, q1]])/(Pi^4*s) - 
    ((I/16)*EL^6*gAl^2*gAu^2*(-mm^2 + s + t)*
      (gZlR*gZuL*(2*mm^4 + mm^2*(-4*mu^2 + (-6 + d)*s - 4*t) - 
         ((-4 + d)*s - 2*t)*(s + t) + mu^2*(2*(4 - 5*d + d^2)*mz^2 - 
           (-6 + d)*s + 4*t)) + gZlL*gZuR*(2*mm^4 + 
         mm^2*(-4*mu^2 + (-6 + d)*s - 4*t) - ((-4 + d)*s - 2*t)*(s + t) + 
         mu^2*(2*(4 - 5*d + d^2)*mz^2 - (-6 + d)*s + 4*t)) + 
       gZlL*gZuL*(2*mm^4 + (s + t)*((-2 + d)*s + 2*t) - 
         mm^2*(4*mu^2 + d*s + 4*t) + mu^2*(-2*(8 - 5*d + d^2)*mz^2 + d*s + 
           4*t)) + gZlR*gZuR*(2*mm^4 + (s + t)*((-2 + d)*s + 2*t) - 
         mm^2*(4*mu^2 + d*s + 4*t) + mu^2*(-2*(8 - 5*d + d^2)*mz^2 + d*s + 
           4*t)))*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[q1, q1]])/
     (mz^2*Pi^4*s) + ((I/8)*EL^6*gAl^2*gAu^2*mu^2*
      (((mm^2 - t)*(d*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - 2*s - t) + 
          gZlR*(6*gZuL*mm^2 - 8*gZuL*s + 4*gZuR*s - 6*gZuL*t) + 
          2*gZlL*(3*gZuR*mm^2 + 2*gZuL*s - 4*gZuR*s - 3*gZuR*t)))/mz^2 + 
       2*(gZlL*gZuL*(-((4 - 5*d + d^2)*mm^2) + (-2 + d)^2*s + 
           (8 - 5*d + d^2)*t) + gZlR*gZuR*(-((4 - 5*d + d^2)*mm^2) + 
           (-2 + d)^2*s + (8 - 5*d + d^2)*t) + gZlR*gZuL*
          ((8 - 5*d + d^2)*mm^2 - (-4 + d)*((-2 + d)*s + (-1 + d)*t)) + 
         gZlL*gZuR*((8 - 5*d + d^2)*mm^2 - (-4 + d)*((-2 + d)*s + 
             (-1 + d)*t))))*(-1 + GaugeXi[Q])*SPList[SP[p2, q1], SP[p2, q1]])/
     (Pi^4*s) - ((I/4)*EL^6*gAl^2*gAu^2*mu^2*
      (gZlR*gZuL*(2*mm^4 - 4*s^2 + d*s^2 + mm^2*((4 - 5*d + d^2)*mz^2 - 
           4*t) + 2*t^2 - mz^2*((12 - 11*d + 2*d^2)*s + (-5 + d)*d*t)) + 
       gZlL*gZuR*(2*mm^4 - 4*s^2 + d*s^2 + mm^2*((4 - 5*d + d^2)*mz^2 - 
           4*t) + 2*t^2 - mz^2*((12 - 11*d + 2*d^2)*s + (-5 + d)*d*t)) + 
       gZlL*gZuL*(2*mm^4 + 2*s^2 - d*s^2 + 2*t^2 - 
         mm^2*((8 - 5*d + d^2)*mz^2 + 4*t) + mz^2*((12 - 9*d + 2*d^2)*s + 
           (12 - 5*d + d^2)*t)) + gZlR*gZuR*(2*mm^4 + 2*s^2 - d*s^2 + 2*t^2 - 
         mm^2*((8 - 5*d + d^2)*mz^2 + 4*t) + mz^2*((12 - 9*d + 2*d^2)*s + 
           (12 - 5*d + d^2)*t)))*(-1 + GaugeXi[Q])*SPList[SP[p2, q1], 
       SP[p3, q1]])/(mz^2*Pi^4*s) + ((I/16)*EL^6*gAl^2*gAu^2*
      ((-(gZlR*gZuL*(2*mm^6 + mm^4*((-6 + d)*s - 6*t) + ((-4 + d)*s - 2*t)*t*
         ...
         gZlR*gZuR*(-2*mm^6 + t*(s + t)*((-2 + d)*s + 2*t) + 
           ...
           mm^2*((-16 + 5*d)*mu^2*s + (-2 + d)*s^2 + 2*d*s*t + 6*t^2)))/
        mz^2 + 2*(gZlR*gZuL*(4*mm^4 - 8*s^2 + 6*d*s^2 - d^2*s^2 + 
           mm^2*((16 - 5*d + d^2)*mu^2 + 2*(6 - 5*d + d^2)*s - 8*t) - 8*s*t + 
           10*d*s*t - 2*d^2*s*t + 4*t^2 - mu^2*((12 - 8*d + d^2)*s + 
             (4 - 5*d + d^2)*t)) + gZlL*gZuR*(4*mm^4 - 8*s^2 + 6*d*s^2 - 
           d^2*s^2 + mm^2*((16 - 5*d + d^2)*mu^2 + 2*(6 - 5*d + d^2)*s - 
             8*t) - 8*s*t + 10*d*s*t - 2*d^2*s*t + 4*t^2 - 
           mu^2*((12 - 8*d + d^2)*s + (4 - 5*d + d^2)*t)) + 
         gZlL*gZuL*(4*mm^4 - d*(mu^2 + 2*s)*(2*s + 5*t) - 
           mm^2*((-4 - 5*d + d^2)*mu^2 + 2*(6 - 5*d + d^2)*s + 8*t) + 
           4*(s^2 + 4*s*t + t*(2*mu^2 + t)) + d^2*(mu^2*(s + t) + 
             s*(s + 2*t))) + gZlR*gZuR*(4*mm^4 - d*(mu^2 + 2*s)*(2*s + 5*t) - 
           mm^2*((-4 - 5*d + d^2)*mu^2 + 2*(6 - 5*d + d^2)*s + 8*t) + 
           4*(s^2 + 4*s*t + t*(2*mu^2 + t)) + d^2*(mu^2*(s + t) + 
             s*(s + 2*t)))))*(-1 + GaugeXi[Q])*SPList[SP[p2, q1], 
       SP[q1, q1]])/(Pi^4*s) - ((I/8)*EL^6*gAl^2*gAu^2*mu^2*
      (gZlR*gZuL*(mm^2*(8*mz^2 - 4*s) + 2*mz^2*((4 - 5*d + d^2)*s - 4*t) + 
         s*(-((-6 + d)*s) + 4*t)) + gZlL*gZuR*(mm^2*(8*mz^2 - 4*s) + 
         2*mz^2*((4 - 5*d + d^2)*s - 4*t) + s*(-((-6 + d)*s) + 4*t)) + 
       gZlL*gZuL*(mm^2*(8*mz^2 - 4*s) + s*(d*s + 4*t) - 
         2*mz^2*((8 - 5*d + d^2)*s + 4*t)) + gZlR*gZuR*(mm^2*(8*mz^2 - 4*s) + 
         s*(d*s + 4*t) - 2*mz^2*((8 - 5*d + d^2)*s + 4*t)))*(-1 + GaugeXi[Q])*
      SPList[SP[p3, q1], SP[p3, q1]])/(mz^2*Pi^4*s) - 
    ((I/16)*EL^6*gAl^2*gAu^2*
