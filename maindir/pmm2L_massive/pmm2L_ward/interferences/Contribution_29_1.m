...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa + bb)*d*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)^2*s*
  ...
  (I*EL^5*gAl^3*gHll^2*mm^4*(2*aa*(-1 + d)*psq*(psq - s - t) + 
     bb*psq*(-2*(-1 + d)*psq + (-2 + d)*s + 2*(-1 + d)*t) + 
     2*aa*mm^2*((1 + d)*psq - s - (1 + d)*t) + 
     bb*mm^2*(-2*(1 + d)*psq + (2 + d)*s + 2*(1 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*gHll^2*mm^4*(2*bb*(-1 + d)*psq*(psq - t) + 
     2*bb*mm^2*((1 + d)*psq - t - d*(s + t)) + 
     aa*psq*(-2*(-1 + d)*psq - 2*t + d*(s + 2*t)) + 
     aa*mm^2*(-2*(1 + d)*psq + 2*t + d*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa + bb)*d*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*aa*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*(aa*(-4 + 3*d)*mm^2 + 
     bb*(-4 + d)*(mm^2 - psq) + aa*(-4 + d)*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*((-4 + 3*d)*mm^2 + (-4 + d)*psq)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gHll^2*mm^4*(bb*d*(psq - s - t) + 
     aa*(4*mm^2 - (4 + d)*psq + d*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*(bb*(-4 + 3*d)*mm^2 + 
     aa*(-4 + d)*(mm^2 - psq) + bb*(-4 + d)*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl^3*gHll^2*mm^4*(bb*(4*mm^2 + 2*(-2 + d)*psq - d*(s + 2*t)) + 
     aa*(4*mm^2 - 2*(2 + d)*psq + d*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl^3*gHll^2*mm^2*((-4 + d)*psq*(psq - s - t) + 
     mm^2*((-12 + 7*d)*psq + 4*s - 3*d*s + 12*t - 7*d*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa + bb)*d*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(mm^2 - t) + aa*(mm^2 - 2*psq + t))*
