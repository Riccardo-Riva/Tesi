...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
   ...
   (((-I)*d*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     (2*Pi)^(2*d) - (I*d*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*s*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
    (I*(aa - bb)*d*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*s*(-2*psq + s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2*Pi)^(2*d) + 
    (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2*Pi)^(2*d) + 
    (I*2^(1 - 2*d)*d*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*
      (-2*aa*s + 2*bb*s + bb*d*(psq - 2*s - t) + 
       aa*d*(2*mm^2 - 3*psq + 2*s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWNl*
      gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFAW*gFll*gWNl*gWWA*
      mm^2*(2*aa*s - 2*bb*s + bb*d*(2*mm^2 - psq + s - t) - 
       aa*d*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWNl*
      gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*d*EL^5*gAl*gFAW*gFll*gWNl*gWWA*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWNl*
      gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gFAW*gFll*
      gWNl*gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWNl*gWWA*mm^2*
