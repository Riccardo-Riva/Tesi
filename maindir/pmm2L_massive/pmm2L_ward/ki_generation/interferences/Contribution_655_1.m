...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   ((I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*(mm^2 - psq)*
    ...
    (I*2^(1 - 4*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      (bb*(2*Pi)^(2*d)*(-((-2 + d)*gZlR^2*mm^2*(2*mm^2 - psq - t)) + 
         gZlL^2*((-2 + d)*mm^4 + 2*mm^2*s - psq*(2*s + (-2 + d)*t))) + 
       aa*(4^d*(-2 + d)*gZlR^2*mm^2*Pi^(2*d)*(psq - t) - 
         gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + mm^2*(-2*(-2 + d)*psq + 2*s) + 
    ...
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      (aa*((-2 + d)*gZlR^2*mm^2*(2*psq - s - 2*t) + 2*d*gZlL*gZlR*mm^2*
          (-2*psq + s + 2*t) + gZlL^2*(mm^2*((-2 + d)*psq + (-4 + d)*s - 
             (-2 + d)*t) + psq*((-2 + d)*psq - 2*(-3 + d)*s - (-2 + d)*t))) + 
       bb*(2*d*gZlL*gZlR*mm^2*(2*psq - s - 2*t) - (-2 + d)*gZlR^2*mm^2*
          (2*psq - s - 2*t) + gZlL^2*(psq*(-((-2 + d)*psq) - 2*s + 
             (-2 + d)*t) + mm^2*(-((-2 + d)*psq) - 2*t + d*(s + t)))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*
      (-(bb*(-2 + d)*gZlL*(psq*(psq - t) + mm^2*(psq - s - t))) + 
       aa*(-2 + d)*gZlL*(mm^2*(psq - t) + psq*(psq - s - t)) + 
       bb*d*gZlR*mm^2*(2*psq - s - 2*t) + aa*d*gZlR*mm^2*(-2*psq + s + 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 4*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      (bb*(4^d*(-2 + d)*gZlR^2*mm^2*Pi^(2*d)*(psq - s - t) + 
         gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + mm^2*(-2*(-2 + d)*psq + 2*s) + 
           psq*((-4 + d)*s + (-2 + d)*t))) + aa*(2*Pi)^(2*d)*
        ((-2 + d)*gZlR^2*mm^2*(2*mm^2 - 3*psq + s + t) - 
         gZlL^2*((-2 + d)*mm^4 + 2*mm^2*s + psq*(-2*(-2 + d)*psq + 
    ...
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      (bb*(2*d*gZlL*gZlR*mm^2*(2*psq - s - 2*t) - (-2 + d)*gZlR^2*mm^2*
          (2*psq - s - 2*t) + gZlL^2*(psq*(-((-2 + d)*psq) - (-4 + d)*s + 
             (-2 + d)*t) + mm^2*(-((-2 + d)*psq) + 2*(-3 + d)*s + 
             (-2 + d)*t))) + aa*((-2 + d)*gZlR^2*mm^2*(2*psq - s - 2*t) + 
         2*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
         gZlL^2*(mm^2*((-2 + d)*psq + 2*s - (-2 + d)*t) + 
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*
      (-2*gZlR*mm^2*s + d*(gZlR*mm^2 - gZlL*psq)*(psq - t) + 
       gZlL*(2*psq^2 - mm^2*s + 2*psq*s - 2*psq*t + s*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
    (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*
      (2*gZlR*mm^2*(2*s + d*(-psq + t)) + gZlL*((-2 + d)*psq^2 + 
    ...
    (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl*gWlN*gWNl*gZlL^2*
      (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
     Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL^2*s*
      (bb*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       aa*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN*gWNl*gZlL^2*
      ...
      gWlN*gWNl*gZlL^2*((-2 + d)*psq - 2*s - (-2 + d)*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN*gWNl*gZlL^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*
      gWlN*gWNl*gZlL^2*((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t)*
