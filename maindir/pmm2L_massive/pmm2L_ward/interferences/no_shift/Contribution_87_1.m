...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)^2*s*
   ...
   (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*(aa*(psq - s - t) + 
      bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
    Pi^(2*d) + (I*2^(3 - 2*d)*aa*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)^2*
   ...
   (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^6*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(2*mm^2 - psq - t) + 
    ...
    Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(bb*(2*mm^2 - s - 2*t) + 
      aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
