...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((I*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpAA*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpAA*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpAA*(-psq + s + t)*\[Mu]^(8 - 2*d)*
