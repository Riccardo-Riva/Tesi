...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(3*mm^2 - 2*s)*t*
      (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(s + t)*(-4*(s - 2*t)*t + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*t*((4 + d)*mm^2*(s + 2*t) - 
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(s + 2*t)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-1 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((6 + d)*mm^2 - 4*s)*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(4*(-2 + d)*mm^2 + (-4 + d)*s - 
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-2 + d)*mm^4*s + 4*s*t*(s + t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-2 + d)*mm^4*s - 4*t*(s + t)^2 + 
      mm^2*((-4 + d)*s^2 - 2*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(s + t)*(d*mm^2*(s - t) + 
      2*t*(3*mm^2 + 2*t) - 2*d*t*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*t*(d*s + 4*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*t*(-2*(s + t)^2 + mm^2*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(-8*t^2 + d*(s^2 + s*t + 2*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-4*s*t*(s + t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*t*((2 + d)*mm^2*(s + 2*t) + 
      (s + t)*((-6 + d)*s + 2*(-2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(4*t^2*(s + t) + 
      mm^2*(s + 2*t)*((2 + d)*s + d*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*t*(-4*s^2 - 8*s*t + 
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-2 + d)*mm^2*(2*s + 3*t) + 
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(s + t)*(2*mm^2 + s + t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(s + 2*t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 + s)*(s + 2*t)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     (2*(-2 + d)*s^2 + (-14 + 5*d)*s*t + 4*(-3 + d)*t^2 + 
      ...
      SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*t*
     ((-2 + d)*mm^2 + (-6 + d)*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2*s + t^2)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-2 + d)*s^2 + 
