...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(-1 - 2*d)*(aa - bb)*EL^5*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*
     (2*psq - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d)) + 
  (2^(-1 - 2*d)*(aa - bb)*EL^5*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*s*
    (-2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*psq*s*
  ...
  ((aa - bb)*EL^5*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) - 
  ((aa - bb)*EL^5*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*(-2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(2*Pi)^(2*d) - 
  ((aa - bb)*EL^5*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*(2*psq - s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*(aa - bb)*EL^5*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*psq*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  ((aa - bb)*EL^5*gFgagp*gFll*ggagpW*ggpgpA*gWNl*mm^2*(4*psq + s)*
