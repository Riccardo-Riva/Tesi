...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^4*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^4*(aa*gZlR*(2*mm^2 + psq) - 
      bb*gZlR*(mm^2 + 2*psq) + 2*aa*gZlL*(psq - s) - 2*bb*gZlL*(psq - s))*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
   (EL^5*gAl*gFFZ*gFll^2*mm^2*s*(aa*gZlL*mm^2*(4*psq - s) + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^4*s*(bb*gZlR*(mm^2 - psq) + 
      bb*gZlL*(-4*psq + s) + aa*(gZlR*mm^2 + 4*gZlL*psq - gZlR*psq - gZlL*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gFFZ*gFll^2*mm^4*
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*psq*(mm^2 + psq)*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(aa*mm^2 - bb*psq)*s*
