...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((EL^5*gAl*gHll^2*gXll^2*mm^6*s*(bb*(mm^4 + mm^2*(7*psq - s) - psq*s) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(2*aa*mm^2*(psq - s) + 
     3*aa*psq*s - bb*psq*(2*mm^2 + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
  ...
  (EL^5*gAl*gHll^2*gXll^2*mm^4*s*(bb*(mm^4 + mm^2*(7*psq - s) - psq*s) + 
     aa*(mm^4 - psq*s + mm^2*(-9*psq + 3*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2*Pi)^(2*d) + 
  (2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(-2*aa*psq + bb*(mm^2 + psq))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(-3*aa*psq + bb*(mm^2 + 2*psq))*
