(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
  ...
  ((3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*mt^2*((-10 + 3*d)*s^2 + (-10 + 3*d)*s*t + 
      2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*mt^2*(2*(-2 + d)*s^2 + (2 + d)*s*t + 
      2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (3*2^(5 - 2*d)*(18 - 9*d + d^2)*EL^8*gAl^4*gAu^4*mt^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(2*d) + (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*
     mt^2*((-4 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    (Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-2 + d)*s^2 + 4*s*t + 
      4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
   (3*4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mt^2*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (3*4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mt^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (3*4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mt^2*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (3*4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mt^2*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (3*4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mt^2*(s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (3*2^(7 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^4*mt^2*\[Mu]^(8 - 2*d)*
