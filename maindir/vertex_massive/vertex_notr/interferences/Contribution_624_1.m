...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[-q1 - q2, mh], 
 ...
 (-((EL^6*gAl^4*gHll^2*mm^4*(2*(2 - 3*d + d^2)*mm^4 + 
      (-2 + d)*s*(-6*(-3 + d)*psq + (-2 + d)*s) + 
      mm^2*(-2*(6 - 5*d + d^2)*psq + (-8 + 10*d + d^2)*s))*\[Mu]^(8 - 2*d))/
    (2*Pi)^(2*d)) + (4^(1 - d)*d*EL^6*gAl^4*gHll^2*mm^4*(mm^2 - s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^6*gAl^4*gHll^2*mm^4*(d^2*(mm^2 - 2*psq) - 12*psq + 
     10*d*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (EL^6*gAl^4*gHll^2*mm^2*(2*(-2 + 5*d)*mm^4 + 
     (-2 + d)*s*(2*(-3 + d)*psq - 3*(-4 + d)*s) - 
     mm^2*(2*(6 - 5*d + d^2)*psq + (20 - 16*d + d^2)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*d*EL^6*gAl^4*gHll^2*mm^4*(mm^2 - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^4*gHll^2*mm^2*
    (-(d^2*s*(3*mm^2 + s)) - 8*s*(5*mm^2 + s) + 6*d*(mm^4 + 6*mm^2*s + s^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (EL^6*gAl^4*gHll^2*mm^2*(2*(-2 - d + d^2)*mm^4 + 
     (-2 + d)*s*(-2*(-5 + d)*psq + (-4 + d)*s) - 
     mm^2*(2*(2 - 3*d + d^2)*psq + (4 - 8*d + d^2)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2*Pi)^(2*d) + EL^6*gAl^4*gHll^2*mm^2*
   ((4^(1 - d)*d*mm^2*s)/Pi^(2*d) + 
    ((-2 + d)*mm^2*(2*(-5 + d)*mm^2 - 2*(-7 + d)*psq + (-6 + d)*s))/
     (2*Pi)^(2*d) + (2^(1 - 2*d)*(-2 + d)*s*((-4 + d)*mm^2 - 2*(-5 + d)*psq + 
       (-4 + d)*s))/Pi^(2*d))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]] - 
  (2^(1 - 2*d)*EL^6*gAl^4*gHll^2*mm^2*((8 - 10*d + d^2)*mm^2 - 
     (8 - 6*d + d^2)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
   Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^4*gHll^2*mm^2*(mm^2 - s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*d*EL^6*gAl^4*gHll^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-2 + d)*EL^6*gAl^4*gHll^2*mm^2*(-mm^4 + mm^2*psq + 
  ...
  ((2 - d)*EL^6*gAl^4*gHll^2*mm^2*(2*(-3 + d)*mm^2 - 2*(-5 + d)*psq + 
   ...
   (2*Pi)^(2*d) - (4^(1 - d)*(8 - 6*d + d^2)*EL^6*gAl^4*gHll^2*mm^2*
  ...
  (4^(1 - d)*(8 - 6*d + d^2)*EL^6*gAl^4*gHll^2*mm^2*\[Mu]^(8 - 2*d)*
