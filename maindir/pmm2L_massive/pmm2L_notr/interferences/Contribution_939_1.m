...
PropList[KiraPropagator[-q1, ml], KiraPropagator[q2, 0], 
 ...
 ((4^(1 - d)*EL^8*gAl^6*gAu^2*ml^2*(-2*(-2 + d)^2*mm^4*s + 
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*ml^2*
  ...
  (4^(1 - d)*EL^8*gAl^6*gAu^2*(8*mm^4*(psq - t) - 
  ...
  (4^(1 - d)*EL^8*gAl^6*gAu^2*(24*ml^2*psq^2 - 12*ml^2*psq*s + 24*psq^2*s + 
     2*d^2*ml^2*(-mm^2 + psq)*s + 12*ml^2*s^2 + 8*psq*s^2 - 8*s^3 + 
     d*s^2*(4*mm^2 - 6*psq + 3*s) + 8*mm^4*(psq - t) - 32*ml^2*psq*t + 
     20*ml^2*s*t - 28*psq*s*t + 6*s^2*t + 8*ml^2*t^2 + 8*s*t^2 + 
     2*d*ml^2*(-6*psq^2 - psq*s - s^2 + 4*mm^2*(psq + s - t) + 8*psq*t - 
       3*s*t - 2*t^2) - 2*mm^2*(6*psq^2 + 12*ml^2*s + 11*psq*s - 4*s^2 - 
       8*psq*t - 5*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*ml^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^6*gAu^2*(8*mm^4*(-psq + s + t) + 
     2*mm^2*(2*psq^2 - psq*s + (-3 + 2*d)*s^2 - 9*s*t - 2*t^2) + 
     s*(3*(-2 + d)*s^2 + 10*s*t + 8*t^2 - 2*psq*((-8 + 3*d)*s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^6*gAu^2*(8*ml^2*psq^2 + 2*d^2*ml^2*(mm^2 - psq)*s - 
     28*ml^2*psq*s - 16*psq*s^2 + d*(-4*mm^2 + 6*psq - 3*s)*s^2 + 6*s^3 + 
     8*mm^4*(psq - s - t) + 4*ml^2*s*t + 4*psq*s*t - 10*s^2*t - 8*ml^2*t^2 - 
     8*s*t^2 + 2*mm^2*(-2*psq^2 + 12*ml^2*s + psq*s + 3*s^2 + 9*s*t + 
       2*t^2) + 2*d*ml^2*(-2*psq^2 + 7*psq*s + 4*mm^2*(psq - 2*s - t) + 
       t*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(4*psq^2 + 2*(-4 + d)*mm^2*s - 
     4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 2*psq*((-4 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^6*gAu^2*(4*mm^2*(2*psq^2 - 5*s^2 + 2*psq*(s - 2*t) + 
       2*s*t + 2*t^2) - s*(12*psq^2 + (2 - 4*d)*psq*s + (-12 + 5*d)*s^2 - 
       24*psq*t + 12*s*t + 12*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^6*gAu^2*
    (4*mm^2*(2*psq^2 - 5*s^2 + 2*psq*(s - 2*t) + 2*s*t + 2*t^2) - 
     s*(12*psq^2 + (2 - 4*d)*psq*s + (-12 + 5*d)*s^2 - 24*psq*t + 12*s*t + 
       12*t^2) + 2*ml^2*(4*(-2 + d)*psq^2 + 2*(8 - 4*d + d^2)*mm^2*s - 
       10*s^2 + 3*d*s^2 - 8*s*t + 4*d*s*t - 8*t^2 + 4*d*t^2 - 
  ...
  (4^(1 - d)*EL^8*gAl^6*gAu^2*(2*(12 - 6*d + d^2)*mm^4*s + 
     mm^2*(4*(-4 + d)*psq^2 + (8 + 4*d - 2*d^2)*psq*s + 
       ...
       4*(-4 + d)*t^2) + s*(4*(-9 + d)*psq^2 + 2*(61 - 19*d + 2*d^2)*psq*s - 
       (26 - 7*d + d^2)*s^2 + 8*(-3 + d)*psq*t - 4*(-3 + d)*s*t - 
       4*(-3 + d)*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^6*gAu^2*
    (-(s*(20*psq^2 - 2*mm^2*(8*psq - 9*s) - 26*psq*s + 6*s^2 + d*s^2 - 
        8*psq*t + 4*s*t + 4*t^2)) + (-2 + d)*ml^2*
      (4*psq^2 + 2*(-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
       2*psq*((-4 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (4^(3 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(-4*mm^2 + 2*psq + 5*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^4 + 12*psq^2 + d*s^2 + 8*s*t + 4*t^2 + 
     mm^2*(-10*psq - 5*s + 4*d*s + 2*t) - 4*psq*((-1 + d)*s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^4 + 12*psq^2 + 4*psq*s - 4*d*psq*s + 
     d*s^2 + (-2 + d)*ml^2*(4*mm^2 - 2*psq - s - 2*t) - 12*psq*t + 8*s*t + 
     4*t^2 + mm^2*(-10*psq - 5*s + 4*d*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(-4*mm^2 + 6*psq + 3*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^4 + 4*psq^2 - 4*s^2 + d*s^2 + 4*t^2 - 
     4*psq*((-4 + d)*s + t) - mm^2*(6*psq + 7*s - 4*d*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^4 + 4*psq^2 + 16*psq*s - 4*d*psq*s - 
     4*s^2 + d*s^2 - 4*psq*t + 4*t^2 + (-2 + d)*ml^2*
      (4*mm^2 - 6*psq + s + 2*t) - mm^2*(6*psq + 7*s - 4*d*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*psq^2 + 4*mm^2*s - 8*psq*t + (s + 2*t)^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*psq^2 - 4*(-2 + d)*ml^2*s + 4*mm^2*s + s^2 - 
     8*psq*t + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*
    (4*(-4 + d)*psq^2 + 2*(-4 + d)^2*mm^2*s + 40*s^2 - 17*d*s^2 + 2*d^2*s^2 - 
     16*s*t + 4*d*s*t - 16*t^2 + 4*d*t^2 - 
  ...
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(4*(-4 + d)*psq^2 + 
     ...
     4*d*s*t - 16*t^2 + 4*d*t^2 - 2*psq*((40 - 10*d + d^2)*s + 4*(-4 + d)*t))*
  ...
  (3*4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(-psq + 2*s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-3*psq^2 + mm^2*(5*psq + 2*(-4 + d)*s - 5*t) + 
     2*s*(s + 2*t) + psq*((3 - 2*d)*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-3*psq^2 + 3*psq*s - 2*d*psq*s + 2*s^2 + 
     mm^2*(5*psq + 2*(-4 + d)*s - 5*t) + (-2 + d)*ml^2*(4*psq - 5*s - 4*t) + 
     3*psq*t + 4*s*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*
    (4*mm^2 - 4*psq - 7*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^4 + 5*psq^2 - 
     psq*(2*(-7 + d)*s + t) - 4*s*(s + 2*t) + 
     mm^2*(-13*psq + 2*(-2 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^4 + 5*psq^2 + 14*psq*s - 2*d*psq*s - 
     4*s^2 - psq*t - 8*s*t + 2*(-2 + d)*ml^2*(2*mm^2 - 3*psq + t) + 
     mm^2*(-13*psq + 2*(-2 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*psq^2 + 6*mm^2*s - 8*psq*s - 4*s^2 + 
     2*d*s^2 - 6*psq*t + 5*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*psq^2 + 6*mm^2*s - 8*psq*s - 4*s^2 + 
     2*d*s^2 - (-2 + d)*ml^2*(2*psq - 7*s - 2*t) - 6*psq*t + 5*s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-6*(-4 + d)*psq^2 + 32*s^2 - 12*d*s^2 + 
     d^2*s^2 + 16*s*t - 3*d*s*t + 8*t^2 - 2*d*t^2 + 
     (-4 + d)*psq*((9 + d)*s + 8*t) + 
     mm^2*(4*(-2 + d)*psq - (12 - 2*d + d^2)*s - 4*(-2 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*((28 - 6*d)*psq^2 + (-52 + 5*d + d^2)*psq*s + 
     42*s^2 - 15*d*s^2 + d^2*s^2 + 4*(-9 + 2*d)*psq*t + 18*s*t - 3*d*s*t + 
     8*t^2 - 2*d*t^2 + mm^2*(4*(-3 + d)*psq - (10 - 2*d + d^2)*s - 
       4*(-3 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*
    (-4*psq^2 + s*(-10*s + 3*d*s - 2*t) + 4*psq*(4*s + t) + 
     mm^2*(4*psq - 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(s*(2*(-1 + d)*psq + (-6 + d)*s - 4*t) - 
     2*mm^2*(psq + (-4 + d)*s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-6*psq^2 + s*((-20 + 3*d)*s - 14*t) - 
     2*mm^2*(psq + 2*(-4 + d)*s - t) + psq*((6 + 4*d)*s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^4 + 3*psq^2 + psq*(-s - 2*d*s + t) + 
     4*s*(s + 2*t) - mm^2*(3*psq + 9*s - 2*d*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-4*mm^4 + mm^2*(4*psq + (13 - 2*d)*s) + 
     s*(2*(-7 + d)*psq + (-2 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-8*mm^4 + 6*psq^2 + 
     mm^2*(6*psq + 34*s - 4*d*s - 6*t) + 2*psq*(-25*s + 2*d*s + t) + 
     s*(3*d*s + 10*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*
    (6*psq^2 - 3*psq*s - 3*s^2 + d*s^2 - 8*psq*t + s*t + 2*t^2 + 
     mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, p3]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^2*(psq - 3*s - t) + 
     s*(-8*psq + 16*s - 3*d*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-12*psq^2 - 26*s^2 + 5*d*s^2 + 
     4*mm^2*(psq + 3*s - t) - 8*s*t - 4*t^2 + 2*psq*(7*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2 + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-6*psq^2 + 3*psq*s - s^2 + d*s^2 + 
     mm^2*(4*psq + 6*s - 4*t) + 8*psq*t - 5*s*t - 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-6*psq^2 + 10*psq*s - 8*s^2 + d*s^2 + 
     2*mm^2*(psq - t) + 2*(-2 + d)*ml^2*(psq - s - t) + 6*psq*t - 6*s*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^4 + 3*psq^2 - psq*s - 2*d*psq*s + 4*s^2 + 
     2*(-2 + d)*ml^2*(2*mm^2 - psq - s - t) + psq*t + 8*s*t - 
     mm^2*(3*psq + 9*s - 2*d*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(8*mm^4 - 10*psq^2 - 4*(-8 + d)*psq*s + 
     (10 - 3*d)*s^2 + mm^2*(6*psq + 4*(-10 + d)*s - 6*t) + 2*psq*t + 10*s*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(8*psq^2 - 13*psq*s - s^2 + d*s^2 + 
     (-2 + d)*ml^2*(4*mm^2 - 4*psq + s) + mm^2*(-8*psq + 11*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(6*psq^2 - 3*psq*s - 3*s^2 + d*s^2 - 
     8*psq*t + s*t + 2*t^2 + mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*psq^2 + 12*s^2 - d*s^2 + 
     mm^2*(4*psq - 6*s - 4*t) + 11*s*t + 2*t^2 - 2*psq*(8*s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-20*psq^2 + 30*psq*s - 18*s^2 + d*s^2 + 
     2*(-2 + d)*ml^2*(2*psq - 3*s - 2*t) + 4*mm^2*(psq - t) + 28*psq*t - 
     18*s*t - 8*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(6*(-4 + d)*psq^2 - 4*s^2 + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*((-28 + 6*d)*psq^2 + (4 + 3*d - d^2)*psq*s + 
     4*(9 - 2*d)*psq*t + (-14 + 3*d)*s*t + 2*(-4 + d)*t^2 + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
     2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*ml^2*(psq + s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-3*psq^2 + 2*(-4 + d)*psq*s + 
     mm^2*(5*psq + 3*s - 2*d*s - 5*t) + 3*psq*t + 2*s*(s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-3*psq^2 - 8*psq*s + 2*d*psq*s + 2*s^2 + 
     mm^2*(5*psq + 3*s - 2*d*s - 5*t) + (-2 + d)*ml^2*(4*psq + s - 4*t) + 
     3*psq*t + 4*s*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2*s + (-7 + 2*d)*s^2 - 
     s*t + 2*t*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2*s - 7*s^2 + 2*d*s^2 + 
     (-2 + d)*ml^2*(2*psq + 5*s - 2*t) - 2*psq*t - s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-2*(-4 + d)*psq^2 + (4 + d - d^2)*psq*s - 
     24*s^2 + 11*d*s^2 - d^2*s^2 + d*s*t - 8*t^2 + 2*d*t^2 + 
     mm^2*(4*(-2 + d)*psq + (20 - 6*d + d^2)*s - 4*(-2 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-2*(-6 + d)*psq^2 + (12 + d - d^2)*psq*s - 
     32*s^2 + 14*d*s^2 - d^2*s^2 - 4*psq*t + 2*s*t + d*s*t - 8*t^2 + 
     2*d*t^2 + mm^2*(4*(-3 + d)*psq + (22 - 6*d + d^2)*s - 4*(-3 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(4*psq^2 + psq*(8*s - 4*t) + 
     s*(-8*s + 3*d*s + 2*t) + mm^2*(-4*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(6*psq^2 + 4*(-7 + d)*psq*s + 
     3*(-2 + d)*s^2 + 2*mm^2*(psq + 7*s - 2*d*s - t) - 6*psq*t + 14*s*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-2*psq^2 - psq*s - 2*s^2 + d*s^2 + 
     2*mm^2*(2*psq + s - 2*t) + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^2*(psq + 2*s - t) + 
     s*(-4*psq - 10*s + 3*d*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-4*psq^2 + 2*psq*s + 22*s^2 - 5*d*s^2 + 
     4*mm^2*(psq - 4*s - t) + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2 - 4*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(2*psq^2 - 7*psq*s + 2*s^2 + d*s^2 + s*t - 
     2*t^2 + mm^2*(-4*psq + 10*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(6*psq^2 - 8*psq*s - 2*s^2 + d*s^2 - 
     2*(-2 + d)*ml^2*(psq - t) - 6*psq*t + 6*s*t + 2*mm^2*(-psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-2*psq^2 - psq*s - 2*s^2 + d*s^2 + 
     2*mm^2*(2*psq + s - 2*t) + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-4*psq*s - 3*s^2 + d*s^2 + 
     2*mm^2*(2*psq + s - 2*t) + 2*psq*t + 7*s*t - 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(4*psq^2 - 2*psq*s - 8*s^2 + d*s^2 - 
     2*(-2 + d)*ml^2*(2*psq + s - 2*t) + 4*psq*t + 2*s*t - 8*t^2 + 
     4*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-2*(-6 + d)*psq^2 - 
     psq*((28 - 9*d + d^2)*s + 4*t) - (s + t)*((-6 + d)*s - 2*(-4 + d)*t) + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(4*psq^2 + 8*mm^2*s - 5*s^2 + 2*d*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^6*gAu^2*(4*(-4 + d)*psq^2 + 2*(28 - 8*d + d^2)*mm^2*s + 
     28*s^2 - 8*d*s^2 + d^2*s^2 - 16*s*t + 4*d*s*t - 16*t^2 + 4*d*t^2 - 
  ...
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 + 2*psq + (-5 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-4*psq^2 + 8*mm^2*s + 12*psq*s - 15*s^2 + 
     2*d*s^2 + 8*psq*t - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*(-4*psq^2 + 8*mm^2*s - 3*s^2 + 2*d*s^2 - 
     4*s*t - 4*t^2 + 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*psq^2 + 2*(-2 + d)*ml^2*s + 5*s^2 + 4*s*t + 
     4*t^2 - 8*psq*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*
    (-4*(-4 + d)*psq^2 - 2*(16 - 6*d + d^2)*mm^2*s + 2*(-2 + d)^2*psq*s + 
     8*s^2 - 3*d*s^2 + 8*(-4 + d)*psq*t + 16*s*t - 4*d*s*t + 16*t^2 - 
     4*d*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*
    (4*(-4 + d)*psq^2 + 2*(12 - 6*d + d^2)*mm^2*s - 2*s^2 + d*s^2 - 16*s*t + 
     4*d*s*t - 16*t^2 + 4*d*t^2 - 2*psq*((-2 + d)^2*s + 4*(-4 + d)*t))*
  ...
  (4^(3 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(3 - d)*(-6 + d)*EL^8*gAl^6*gAu^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 - 3*psq - 2*s + d*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 - 3*psq - 2*s + d*s + 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(3*mm^2 + 3*psq - 6*s + 
     d*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(3*mm^2 + 3*psq - 6*s + 
     d*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 6*psq - 5*s + 
     2*d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 6*psq - 5*s + 
     2*d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*
    (-4*mm^2 + 2*psq + 5*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*(-6 + d)*EL^8*gAl^6*gAu^2*(-4*mm^2 + 2*psq + 5*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-4*mm^2 + 2*psq + 5*s + 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^6*gAu^2*(mm^2 + psq - 2*(s + t))*
  ...
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(3*mm^2 - 9*psq + d*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(7 - 2*d)*EL^8*gAl^6*gAu^2*(3*mm^2 - 3*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(13*mm^2 - 17*psq + 6*s + 4*t)*
   ...
   (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^6*gAu^2*(2*mm^2 + (-8 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(6*mm^2 - 2*psq - 19*s + 
   ...
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 + 3*psq - 4*(s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(3*mm^2 - 9*psq + d*s + 
     6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, p3]])/
   ...
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(6*psq - 11*s - 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(2*mm^2 + 4*psq - 14*s + 
     d*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*
    (-4*mm^2 + 2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*(-4 + d)*mm^2 - 2*(-2 + d)*psq - 
     (-6 + d)*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 + psq - 4*s + d*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 + psq - 4*s + d*s - 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 2*psq - 7*s + 
     2*d*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 2*psq - 7*s + 
     2*d*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*
    (4*mm^2 - 6*psq - 3*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*(-6 + d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 6*psq - 3*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-4*mm^2 + 6*psq + 3*s - 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^6*gAu^2*(mm^2 - 3*psq + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(3*mm^2 - 11*psq + 8*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p3, p3]])/
   (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^6*gAu^2*(2*mm^2 - 4*psq - 6*s + d*s + 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(6*mm^2 - 10*psq - 15*s + 
     3*d*s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(7 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(8*mm^2 - 10*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 - 5*psq + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[p3, p3]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(6*psq + 5*s - 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(2*mm^2 - 8*psq - 8*s + 
     d*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*(-4 + d)*mm^2 + (28 - 6*d)*psq + 
     (-6 + d)*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(4 - d)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/(Pi^(2*d)*s) + (2^(9 - 2*d)*EL^8*gAl^6*gAu^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) + (2^(7 - 2*d)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(7 - 2*d)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (4^(4 - d)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s) + (4^(3 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2 - 8*psq - 2*s + d*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2 - 8*psq - 2*s + d*s + 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(2*psq + (-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(2*psq + (-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(-psq + 2*s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*(-6 + d)*EL^8*gAl^6*gAu^2*(-psq + 2*s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-psq + 2*s + t)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 + psq - 4*s + d*s - 2*t)*
   ...
   (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^6*gAu^2*(mm^2 - psq + (-4 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^6*gAu^2*(2*mm^2 - 4*psq - 12*s + 
     3*d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, p3]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(2*psq + (-8 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^6*gAu^2*(10*psq + (-22 + 3*d)*s - 
     10*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^6*gAu^2*(-psq + 2*s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl^6*gAu^2*(-2*psq + 3*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^6*gAu^2*(-2*psq + d*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 + psq - 4*s + d*s - 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, p3]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 6*psq + 14*s - 
     3*d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*psq + (-14 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(-4*psq + 5*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-4*(-5 + d)*psq + (-22 + 5*d)*s + 
     4*(-5 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 - 3*psq - 2*s + d*s + 2*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(mm^2 - 3*psq - 2*s + d*s + 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*
    (4*mm^2 - 4*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 4*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(-4*mm^2 + 4*psq + 7*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*(-6 + d)*EL^8*gAl^6*gAu^2*
    (-4*mm^2 + 4*psq + 7*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 4*psq - 7*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(2*mm^2 - 2*psq - (-2 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2 - 8*psq + 6*s - 3*d*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[p3, p3]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 + 2*psq - 10*s + 
     d*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^6*gAu^2*(12*mm^2 - 10*psq - 18*s + 
     3*d*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^6*gAu^2*(-2*mm^2 + psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-4*mm^2 + 4*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(2*mm^2 - 4*psq + 2*s - d*s + 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[p3, p3]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-6*psq + 7*s + 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 2*psq - 12*s + 
     d*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^6*gAu^2*
    (2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-2*(-4 + d)*mm^2 + (-16 + 3*d)*psq + 2*s + 
     8*t - d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2 - 4*psq + 4*s - 3*d*s - 2*t)*
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2 - 4*psq - 4*s + d*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, p3]])/
   (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^6*gAu^2*(mm^2 - psq + (-4 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 2*psq + 12*s - 
     3*d*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p3, p3]])/
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 10*psq - 4*s + 
     d*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^6*gAu^2*(12*mm^2 - 14*psq - 16*s + 
     3*d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^6*gAu^2*(2*mm^2 - 3*psq + t)*
  ...
  (4^(3 - d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 4*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(8*mm^2 - 10*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 10*psq + d*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^2 + 2*psq - 6*s + d*s - 6*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-2*psq + 3*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(-2*psq + 5*s + 2*t)*
  ...
  (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*mm^2 - 4*psq - 4*s + d*s - 2*t)*
   ...
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^6*gAu^2*(2*mm^2 + (-14 + 3*d)*s - 
     2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*
    (3*mm^2 - 3*psq - (-5 + d)*s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(6*psq + s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 6*psq - 10*s + d*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^6*gAu^2*
    (-2*mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-2*(-4 + d)*mm^2 - 6*s - 8*t + 
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(8*mm^2 - 6*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(4*mm^2 + 2*psq - 6*s + d*s - 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 10*psq + d*s + 6*t)*
  ...
  (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(-6*psq + 7*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(psq + s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*(-6 + d)*EL^8*gAl^6*gAu^2*(psq + s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(psq + s - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(2*psq - (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(10*psq - 3*(-4 + d)*s - 10*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(3 - d)*EL^8*gAl^6*gAu^2*(psq + s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^6*gAu^2*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*psq - (-8 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(4*psq + s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(4*(-5 + d)*psq + (-2 + d)*s - 4*(-5 + d)*t)*
   ...
   (Pi^(2*d)*s^2) - (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(2*psq + 5*s - 2*t)*
  ...
  (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(2*psq + 3*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^6*gAu^2*(6*psq + s - 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(3 - d)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q1], 
     SP[p3, q1]])/(Pi^(2*d)*s) - (2^(7 - 2*d)*EL^8*gAl^6*gAu^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) - (4^(3 - d)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (4^(3 - d)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s) + (2^(7 - 2*d)*EL^8*gAl^6*gAu^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], SP[q1, q2]])/
   (Pi^(2*d)*s) + (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*
