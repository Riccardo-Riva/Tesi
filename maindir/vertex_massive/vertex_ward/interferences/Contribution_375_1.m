...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (((-I)*EL^5*gAl*gWlN*gWNl*gWWZ*mm^2*s*
      ...
      (-(aa*(-1 + d)*gZlR*mm^2*(4*psq^2 - 9*psq*s + 4*s^2 - 4*psq*t + 
       ...
       aa*gZlL*((-2 + d)*mm^4*(2*psq - s - 2*t) + 
         mm^2*(2*(-2 + d)*psq^2 - (-3 + d)*psq*s - 2*(-2 + d)*psq*t - 
           ...
           psq*(s - d*s - 2*(-2 + d)*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/Pi^(2*d) - (I*EL^5*gAl*gWlN*gWNl*gWWZ*mm^2*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWZ*s*
      ...
      SPList[SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*
      mm^2*s*(aa*(-2 + d)*gZlL*(mm^2 - psq) + bb*(-2 + d)*gZlL*(mm^2 - psq) + 
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gWlN*gWNl*gWWZ*(aa*(-2 + d)*gZlL*(2*Pi)^(2*d)*
        (mm^2 + s)*(2*mm^2 - 3*psq + s + t) - bb*(-2 + d)*gZlL*(2*Pi)^(2*d)*
        (mm^2 + s)*(-psq + s + t) + 2^(1 + 2*d)*aa*gZlR*mm^2*Pi^(2*d)*
        (psq + 2*d*psq + s - d*s - (1 + 2*d)*t) - 2^(1 + 2*d)*bb*gZlR*mm^2*
        Pi^(2*d)*(psq + 2*d*psq + s - d*s - (1 + 2*d)*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/Pi^(4*d) + 
    (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*(-3*aa*(-1 + d)*gZlR*mm^2*
        (2*psq - s - 2*t) + 3*bb*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) - 
       aa*gZlL*(6*(-2 + d)*psq^2 + (22 - 10*d)*psq*s + 
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gWlN*gWNl*gWWZ*(-3*2^(1 + 2*d)*aa*(-1 + d)*gZlR*
        mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 3*2^(1 + 2*d)*bb*(-1 + d)*gZlR*mm^2*
        Pi^(2*d)*(2*psq - s - 2*t) + aa*gZlL*(2*Pi)^(2*d)*
        (mm^2*(4*(-2 + d)*psq + 12*s - 7*d*s + 8*t - 4*d*t) + 
         s*((-22 + 9*d)*psq + 8*s - 3*d*s + 10*t - 3*d*t)) + 
       bb*gZlL*(2*Pi)^(2*d)*(s*((10 - 3*d)*psq - 8*s + 3*d*s - 10*t + 
           3*d*t) + mm^2*(-4*(-2 + d)*psq + d*s - 8*t + 4*d*t)))*
    ...
    (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*(2*aa*(-1 + d)*gZlR*mm^2*
        (2*psq - s - 2*t) - 2*bb*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
       aa*(-2 + d)*gZlL*s*(2*mm^2 - 3*psq + s + t) - bb*(-2 + d)*gZlL*s*
        (-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*mm^2*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gWlN*gWNl*gWWZ*
      (aa*(2^(1 + 2*d)*(1 + 2*d)*gZlR*mm^2*Pi^(2*d)*(psq - t) + 
         gZlL*(2*Pi)^(2*d)*(4*(-2 + d)*mm^4 + s*((14 - 3*d)*psq - 2*s + 
             ...
             (-2 + d)*t))) - bb*(2*Pi)^(2*d)*(2*(1 + 2*d)*gZlR*mm^2*
          (psq - t) + gZlL*(2*(-2 + d)*mm^4 + s*(-((-10 + d)*psq) - 2*s + 
             (-2 + d)*t) + mm^2*(-3*(-2 + d)*psq - 2*t + d*(-s + t)))))*
    ...
    (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*
      (-(aa*(-1 + d)*gZlR*mm^2*(3*psq - 2*s - 3*t)) + bb*(-1 + d)*gZlR*mm^2*
        (3*psq - 2*s - 3*t) + aa*gZlL*(-2*(-2 + d)*psq^2 + (-3 + 2*d)*psq*s - 
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gWlN*gWNl*gWWZ*(3*2^(1 + 2*d)*bb*(-1 + d)*gZlR*
        mm^2*Pi^(2*d)*(2*psq - s - 2*t) - bb*gZlL*(2*Pi)^(2*d)*
        (mm^2*(4*(-2 + d)*psq - 4*s + 3*d*s + 8*t - 4*d*t) + 
         s*((2 - 3*d)*psq + 2*s + 10*t - 3*d*t)) + 
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*s*
     ...
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*
      gZlL*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], SP[q1, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
    ...
    (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*(2*bb*(-1 + d)*gZlR*mm^2 - 
       ...
       aa*(-2*(-1 + d)*gZlR*mm^2 + gZlL*(4*(-2 + d)*mm^2 - (6 + d)*psq + 
           d*s - 2*t + d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      gWWZ*gZlL*(bb*(3*psq - 2*s - 3*t) + aa*(2*mm^2 - 5*psq + 2*s + 3*t))*
    ...
    (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
      (aa*((-6 + d)*psq + d*s + 6*t - d*t) + bb*(-6*(-2 + d)*mm^2 - 6*psq + 
         5*d*psq - d*s - 6*t + d*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
