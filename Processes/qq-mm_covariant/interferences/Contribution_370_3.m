...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[W]]], 
 ...
 (((I/9)*2^(2 - d)*EL^6*(cw^2 - sw^2)*(-1 + 4*sw^2)*SPList[SP[p1, q1]])/
   (cw^2*Pi^d*(mz^2 - s)*sw^2) - ((I/9)*2^(1 - d)*EL^6*(cw^2 - sw^2)*
    (-1 + 4*sw^2)*SPList[SP[q1, q1]])/(cw^2*Pi^d*(mz^2 - s)*sw^2) - 
  ((I/9)*2^(2 - d)*EL^6*(cw^2 - sw^2)*(-1 + 4*sw^2)*t*
    SPList[SP[p1, p2], SP[p1, p2]])/(cw^2*Pi^d*s^2*(-mz^2 + s)*sw^2) - 
  ((I/9)*2^(2 - d)*EL^6*(cw^2 - sw^2)*(-1 + 4*sw^2)*(s - 2*t)*
