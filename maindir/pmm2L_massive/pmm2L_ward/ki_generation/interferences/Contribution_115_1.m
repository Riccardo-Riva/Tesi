...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   ((I*EL^5*gAl*gHll^2*mm^4*s*(bb*(-2*gZlL*gZlR*(d*(mm^2 + psq) - 2*s)*
          (2*psq - s - 2*t) + (-2 + d)*gZlL^2*(mm^4 + psq*(3*psq - s - 2*t) - 
           mm^2*(s + 2*t)) + (-2 + d)*gZlR^2*(mm^4 + psq*(3*psq - s - 2*t) - 
           mm^2*(s + 2*t))) + aa*(2*gZlL*gZlR*(d*(mm^2 + psq) - 2*s)*
          (2*psq - s - 2*t) + (-2 + d)*gZlL^2*(mm^4 + 
           mm^2*(-4*psq + s + 2*t) + psq*(-psq + s + 2*t)) + 
         (-2 + d)*gZlR^2*(mm^4 + mm^2*(-4*psq + s + 2*t) + 
           psq*(-psq + s + 2*t))))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
      (bb*(gZlL^2*(-((-2 + d)*mm^4*(2*psq - s - 2*t)) + 
           s^2*(-3*psq + s + t) - (-2 + d)*mm^2*(2*psq^2 - 2*psq*t - 
             s*(s + t))) + gZlR^2*(-((-2 + d)*mm^4*(2*psq - s - 2*t)) + 
           s^2*(-3*psq + s + t) - (-2 + d)*mm^2*(2*psq^2 - 2*psq*t - 
             s*(s + t))) + 2*gZlL*gZlR*mm^2*(4*s*(-psq + s + t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
     ...
     Pi^(2*d) + (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^4*s*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*s*(-2*d*gZlL*gZlR*mm^2 + 
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
      (aa*(gZlL^2*(2*Pi)^(2*d)*(4*(-2 + d)*mm^4 + s*(-((-2 + d)*psq) + 2*s) - 
           (-2 + d)*mm^2*(6*psq - 3*s - 2*t)) + gZlR^2*(2*Pi)^(2*d)*
          (4*(-2 + d)*mm^4 + s*(-((-2 + d)*psq) + 2*s) - (-2 + d)*mm^2*
            (6*psq - 3*s - 2*t)) + 4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
          (2*s + d*(psq - s - t))) + 
       bb*(gZlL^2*(2*Pi)^(2*d)*(((-2 + d)*psq - 2*s)*s + (-2 + d)*mm^2*
            (2*psq - 3*s - 2*t)) + gZlR^2*(2*Pi)^(2*d)*
          (((-2 + d)*psq - 2*s)*s + (-2 + d)*mm^2*(2*psq - 3*s - 2*t)) + 
         4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*s + d*(-psq + s + t))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(4*d) + 
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
     Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*s*
    ...
    (I*4^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
      (bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(psq - s - t)) + 
       ...
       aa*(-(gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + (-2 + d)*psq^2 - 3*psq*s - 
         ...
         gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + (-2 + d)*psq^2 - 3*psq*s - 
           (-2 + d)*mm^2*(3*psq - s - t) + s*(s + t)) + 2^(1 + 2*d)*gZlL*gZlR*
          mm^2*Pi^(2*d)*(-2*s + d*(-psq + s + t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2]])/Pi^(4*d) - 
    (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
      (-(aa*(gZlL^2*(2*Pi)^(2*d)*(s*(-((-2 + d)*psq) + 2*s) + 
            (-2 + d)*mm^2*(2*psq + s - 2*t)) + gZlR^2*(2*Pi)^(2*d)*
           (s*(-((-2 + d)*psq) + 2*s) + (-2 + d)*mm^2*(2*psq + s - 2*t)) + 
          4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(-psq + t)))) + 
       bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(-psq + t)) + 
         gZlL^2*(2*Pi)^(2*d)*(4*(-2 + d)*mm^4 + s*(-((-2 + d)*psq) + 2*s) - 
           (-2 + d)*mm^2*(2*psq - s + 2*t)) + gZlR^2*(2*Pi)^(2*d)*
          (4*(-2 + d)*mm^4 + s*(-((-2 + d)*psq) + 2*s) - (-2 + d)*mm^2*
            (2*psq - s + 2*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/Pi^(4*d) - (I*4^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    ...
    (I*EL^5*gAl*gHll^2*mm^2*(-2*aa*(gZlL^2 + gZlR^2)*s*(2*mm^2 - 3*psq + s + 
       ...
       bb*d*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) - gZlL^2*s*(-psq + s + t) - 
         ...
         gZlR^2*s*(2*mm^2 - 3*psq + s + t) + 4*gZlL*gZlR*mm^2*
          (-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
      (bb*((-2 + d)*gZlL^2*(2*mm^2 - psq - t) + (-2 + d)*gZlR^2*
          (2*mm^2 - psq - t) + 2*gZlL*gZlR*(2*s + d*(-psq + t))) - 
    ...
    (I*4^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
      (aa*(gZlL^2*(2*Pi)^(2*d)*(-s^2 + (-2 + d)*mm^2*(2*psq - s - 2*t)) + 
         gZlR^2*(2*Pi)^(2*d)*(-s^2 + (-2 + d)*mm^2*(2*psq - s - 2*t)) - 
         2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
    ...
    (I*EL^5*gAl*gHll^2*mm^2*(aa*d*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
         gZlL^2*s*(psq - t) + gZlR^2*s*(psq - t)) + 2*bb*(gZlL^2 + gZlR^2)*s*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*
      (gZlL^2 + gZlR^2)*mm^2*(-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + 
         s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[p3, q1]])/
