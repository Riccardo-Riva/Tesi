...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    s^2*(mm^2 - psq + s)*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  ((aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*s*
    (mm^2 - psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*s*
    (bb*(-2*mm^2 + 6*psq - 3*s) + aa*(4*mm^2 - 8*psq + 3*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ*
    gXgpgp*gXll*(gZlL - gZlR)*mm^2*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   Pi^(2*d) - ((aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*s*
  ...
  ((aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
   ...
   (2*Pi)^(2*d) + ((aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*
    mm^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
    (bb*(4*psq - s) + aa*(2*mm^2 - 6*psq + s))*\[Mu]^(8 - 2*d)*
