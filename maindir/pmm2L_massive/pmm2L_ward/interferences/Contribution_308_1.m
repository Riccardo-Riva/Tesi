...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gWWA^3*mm^2*s*
  ...
  (I*EL^5*gAl^2*gWWA^3*(bb*(20*(-2 + d)*psq^2 - (-14 + 15*d)*s*(s + 2*t) + 
       4*psq*(s + 3*d*s - 5*(-2 + d)*t) + 2*mm^2*(2*(-6 + 11*d)*psq - 7*d*s + 
         12*t - 22*d*t)) + aa*(-20*(-2 + d)*psq^2 - 4*(-5 + 7*d)*psq*s + 
       20*(-2 + d)*psq*t + (-14 + 15*d)*s*(s + 2*t) + 
       mm^2*((24 - 44*d)*psq + 6*(-4 + 5*d)*s + 4*(-6 + 11*d)*t)))*
  ...
  (I*EL^5*gAl^2*gWWA^3*s*(bb*((10 - 6*d)*mm^2 - 18*psq + 11*d*psq + 9*s - 
       5*d*s + 8*t - 5*d*t) + aa*((8 - 5*d)*psq - 9*s + 5*d*s - 8*t + 5*d*t))*
  ...
  (I*EL^5*gAl^2*gWWA^3*(bb*(2*(-5 + 3*d)*mm^2 + 12*psq - 7*d*psq + d*s - 
       2*t + d*t) - aa*((-6 + 4*d)*mm^2 + 8*psq - 5*d*psq + d*s - 2*t + d*t))*
