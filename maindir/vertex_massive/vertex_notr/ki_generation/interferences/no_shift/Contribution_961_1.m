...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((EL^6*gAl^2*gHll^2*mm^4*(-(2^(3 + 2*d)*(4 - 5*d + d^2)*gZlL*gZlR*mm^2*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*mm^4*((12 - 8*d + d^2)*gZlL^2*s + 
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll^2*mm^4*(-12*(gZlL^2 + gZlR^2)*s - 
      d^2*(gZlL^2 + gZlR^2)*s + 2*d*(4*gZlL^2*s + 4*gZlR^2*s + 
        gZlL*gZlR*(3*mm^2 + s)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) - (2^(3 - 2*d)*d*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^4*(mm^2 - s)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gHll^2*mm^2*(-2*(-2 + d)*gZlL*gZlR*mm^2*s + 
   ...
   (4^(1 - d)*(-2 + d)^2*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^4*\[Mu]^(8 - 2*d)*
