...
PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
 ...
 ((2^(-1 - 4*d)*EL^6*gAl^2*gHll^2*mm^4*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
      (4*d*(psq - 4*s) + 12*s + 3*d^2*s) - (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
      (2*(-1 + d)*mm^4 + s*((-9 + d)*psq + 2*s) + 
       mm^2*(-2*(-3 + d)*psq + (-3 + 2*d)*s)) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
      (2*(-1 + d)*mm^4 + s*((-9 + d)*psq + 2*s) + 
       mm^2*(-2*(-3 + d)*psq + (-3 + 2*d)*s)))*\[Mu]^(8 - 2*d))/Pi^(4*d) + 
  (EL^6*gAl^2*gHll^2*mm^4*(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
      ((4 - 2*d + d^2)*mm^2 - 2*d*psq + 4*s) - (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
      (mm^2 + psq + (-6 + d)*s) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
      (mm^2 + psq + (-6 + d)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2*Pi)^(4*d) - (EL^6*gAl^2*gHll^2*mm^4*
    (-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*((14 - 15*d + 3*d^2)*mm^2 - 
     ...
     (-2 + d)*gZlR^2*(2*Pi)^(2*d)*((-3 + 2*d)*mm^2 - (-5 + d)*psq + 
       (-2 + d)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(4*d) + 
  (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*mm^4*
    ((-2 + d)*gZlL^2*(mm^2 + psq + (-6 + d)*s) + 
     (-2 + d)*gZlR^2*(mm^2 + psq + (-6 + d)*s) - 
     gZlL*gZlR*(6*d*(mm^2 - s) + 12*s + d^2*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*mm^4*
  ...
  (2^(-1 - 4*d)*EL^6*gAl^2*gHll^2*mm^4*
    ((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(2*(-5 + d)*mm^2 - 2*(-7 + d)*psq + 
       (-6 + d)*s) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(2*(-5 + d)*mm^2 - 
       2*(-7 + d)*psq + (-6 + d)*s) + 2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
      (-4*d*psq + 12*s - 6*d*s + d^2*s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   Pi^(4*d) - (EL^6*gAl^2*gHll^2*mm^2*(2^(1 + 2*d)*(-2 + d)*gZlL^2*mm^2*
  ...
  (2^(3 - 2*d)*EL^6*gAl^2*gHll^2*((-2 + d)*gZlL^2 - (2 + d)*gZlL*gZlR + 
   ...
   Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*
    ((12 - 7*d + 2*d^2)*mm^2 - (8 - 5*d + d^2)*psq + 2*(-2 + d)*s)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gHll^2*mm^4*(2*gZlL*gZlR*(-mm^2 + psq) + 
  ...
  (EL^6*gAl^2*gHll^2*mm^2*((12 - 8*d + d^2)*gZlL^2*mm^2 + 
     (12 - 8*d + d^2)*gZlR^2*mm^2 - 2*gZlL*gZlR*((14 - 7*d + d^2)*mm^2 + 
       (18 - 9*d + d^2)*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   (2*Pi)^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*
    (2*(-2 + d)*mm^2 - 2*(-2 + d)*psq + (-4 + d)^2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*EL^6*gAl^2*gHll^2*((-2 + d)*gZlL^2 - d*gZlL*gZlR + 
  ...
  (4^(1 - d)*(18 - 9*d + d^2)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*s*
