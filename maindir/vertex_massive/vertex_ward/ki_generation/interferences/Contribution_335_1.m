...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*EL^5*gAl*gXll^2*mm^4*s*(bb*(4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
      ...
      (aa*(-((-2 + d)*gZlL^2*(mm^2*(psq - t) + psq*(psq - s - t))) - 
         ...
         gZlL*gZlR*(4*s*(mm^2 + psq - s - t) - d*(2*mm^2 - s)*
           ...
           4*s*(-mm^2 - psq + s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*
      (aa*(gZlL*gZlR*(-((-4 + d)*psq^2) + (2 + d)*psq*s + 
           (4 + d)*mm^2*(psq - s - t) + (-4 + d)*psq*t - 2*s*(s + t)) - 
         (-2 + d)*gZlL^2*(mm^2*(psq - s - t) - s*(-2*psq + s + t)) - 
         (-2 + d)*gZlR^2*(mm^2*(psq - s - t) - s*(-2*psq + s + t))) + 
       bb*((-2 + d)*gZlL^2*(mm^2*(psq - t) - s*(-psq + s + t)) + 
         (-2 + d)*gZlR^2*(mm^2*(psq - t) - s*(-psq + s + t)) - 
         gZlL*gZlR*(-((-4 + d)*psq^2) - (-6 + d)*psq*s + (-4 + d)*psq*t - 
           2*s*(s + t) + mm^2*((4 + d)*psq + (-8 + d)*s - (4 + d)*t))))*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*
      (bb*(-(gZlL*gZlR*(-((-4 + d)*psq^2) - 2*psq*s + (4 + d)*mm^2*
             (psq - t) + (-4 + d)*psq*t - 2*s*t)) + (-2 + d)*gZlL^2*
          (mm^2*(psq - t) - s*t) + (-2 + d)*gZlR^2*(mm^2*(psq - t) - s*t)) + 
       aa*(-((-2 + d)*gZlL^2*(s*(psq - t) + mm^2*(psq - s - t))) - 
         (-2 + d)*gZlR^2*(s*(psq - t) + mm^2*(psq - s - t)) + 
         gZlL*gZlR*(-((-4 + d)*psq^2) + 2*(-3 + d)*psq*s + (-4 + d)*psq*t - 
           2*s*t + mm^2*((4 + d)*psq - 2*(-2 + d)*s - (4 + d)*t))))*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*s*
      (-(aa*((-2 + d)*gZlL^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*
           (2*psq - s - 2*t) + gZlL*gZlR*((-4 + d)*mm^2 - d*psq + 2*s + 
            4*t))) + bb*((-2 + d)*gZlL^2*(2*psq - s - 2*t) + 
         (-2 + d)*gZlR^2*(2*psq - s - 2*t) + gZlL*gZlR*(-((-4 + d)*mm^2) - 
           8*psq + d*psq + 2*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
      (-(bb*((-4 + d)*mm^4 + (-4 + d)*psq*(psq - t) + 
       ...
       aa*(-((-4 + d)*mm^4) + (-4 + d)*psq*(psq - s - t) + 
         mm^2*(-8*psq + 4*t + d*(s + t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/Pi^(2*d) + (I*EL^5*gAl*gXll^2*mm^4*s*
    ...
    (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
     ...
     Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gXll^2*mm^4*
      (bb*(gZlL^2 - gZlL*gZlR + gZlR^2)*(psq - s - t) + 
       aa*(-(gZlL*gZlR*(2*mm^2 - 3*psq + s + t)) + 
     ...
     Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^2*
      (aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*(psq - t) + 
         gZlL*gZlR*((-4 + d)*mm^4 - (-4 + d)*psq*s + 
           mm^2*(-2*(-3 + d)*psq + 2*(-4 + d)*s + (-2 + d)*t))) + 
       bb*(-((-2 + d)*gZlL^2*mm^2*(mm^2 - t)) - (-2 + d)*gZlR^2*mm^2*
          (mm^2 - t) + gZlL*gZlR*(-4*psq*s + mm^2*(-2*psq + 8*s + 2*t) + 
           d*(mm^4 + psq*s - mm^2*(2*s + t)))))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
      (-2*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p1, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^2*
      (bb*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + (-2 + d)*gZlR^2*mm^2*
          (psq - s - t) + gZlL*gZlR*(-((-4 + d)*mm^4) + (-4 + d)*psq*s + 
           mm^2*(-2*psq - (-6 + d)*s + (-2 + d)*t))) + 
       aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - 2*psq + s + t) + 
         (-2 + d)*gZlR^2*mm^2*(mm^2 - 2*psq + s + t) - 
         gZlL*gZlR*(-4*psq*s + 2*mm^2*(psq + 3*s - t) + 
           d*(mm^4 + psq*s + mm^2*(-2*psq - s + t)))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(bb*(2*mm^2 - s - 2*t) + 
       aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*aa*(-1 + d)*psq*s - 
       bb*(-4 + d)*mm^2*(psq - t) - aa*(-2 + d)*s*(s + t) + 
       bb*(-2 + d)*s*(-psq + s + t) + aa*mm^2*((-4 + d)*psq + 4*t - 
         d*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
     Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
      (aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*(psq - t) + 
         gZlL*gZlR*((-4 + d)*psq^2 - (4 + d)*mm^2*(psq - s - t) + 
           2*s*(s + t) - psq*((2 + d)*s + (-4 + d)*t))) - 
       bb*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*(psq - t) + 
         gZlL*gZlR*((-4 + d)*psq^2 + (-6 + d)*psq*s - (-4 + d)*psq*t + 
           2*s*(s + t) + mm^2*(-((4 + d)*psq) - (-8 + d)*s + (4 + d)*t))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*
      gXll^2*gZlL*gZlR*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gXll^2*mm^4*
      (-(aa*(gZlL^2 - gZlL*gZlR + gZlR^2)*(psq - t)) + 
       bb*(gZlL^2*(mm^2 - t) + gZlR^2*(mm^2 - t) + 
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(bb*(2*mm^2 - psq - t) + 
     ...
     Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*
      mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      s*(bb*((-4 + d)*mm^2 + 8*psq - d*psq - 2*s - 4*t) + 
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
     ...
     Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*
      mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*aa*(-4 + d)*EL^5*gAl*gXll^2*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-(aa*(-2 + d)*(psq - t)) + 
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p2, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (2*aa*(psq - s - t) + bb*(-2 + d)*(psq - s - t) + 
       aa*d*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*
