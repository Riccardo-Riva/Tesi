...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  ((4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*
   ...
   (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*
     sw*(4*psq^2 - 8*psq*t + (s + 2*t)^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*
     sw*(psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*
     mm^2*sw*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*
     mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*
     ...
     gFll*gFZW*gWNl*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*
     mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*\[Mu]^(8 - 2*d)*
