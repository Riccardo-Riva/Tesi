...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*mm^2*(-2*gZlL^3*gZlR*s*(4*psq^2 - 3*psq*s + s^2 - 
        8*psq*t + 5*s*t + 4*t^2) - 2*gZlL*gZlR^3*s*(4*psq^2 - 3*psq*s + s^2 - 
        8*psq*t + 5*s*t + 4*t^2) + gZlL^4*((-16 + 13*d - 3*d^2)*psq^3 + 
        2*(-2 + d)*t*(s + t)^2 + 2*psq^2*((2 - 4*d + d^2)*s + 
          (14 - 12*d + 3*d^2)*t) - psq*(s + t)*((4 - 5*d + d^2)*s + 
          (8 - 9*d + 3*d^2)*t) + mm^2*((12 - 5*d + d^2)*psq^2 + 
          (4 - 5*d + d^2)*psq*s - 2*(12 - 5*d + d^2)*psq*t + 
          (12 - 5*d + d^2)*t*(s + t))) + gZlR^4*((-16 + 13*d - 3*d^2)*psq^3 + 
        2*(-2 + d)*t*(s + t)^2 + 2*psq^2*((2 - 4*d + d^2)*s + 
          (14 - 12*d + 3*d^2)*t) - psq*(s + t)*((4 - 5*d + d^2)*s + 
          (8 - 9*d + 3*d^2)*t) + mm^2*((12 - 5*d + d^2)*psq^2 + 
          (4 - 5*d + d^2)*psq*s - 2*(12 - 5*d + d^2)*psq*t + 
          (12 - 5*d + d^2)*t*(s + t))) - 2*gZlL^2*gZlR^2*
       (-8*(psq^3 - psq^2*(s + t) + t*(s + t)^2 - psq*(mm^2*s - s^2 + t^2)) + 
        d*(13*psq^3 + 2*t*(s + t)^2 - 8*psq^2*(s + 3*t) + 
          psq*(5*s^2 + 14*s*t + 9*t^2) - 5*mm^2*(psq^2 + psq*(s - 2*t) + 
            t*(s + t))) + d^2*(mm^2*(psq^2 + psq*(s - 2*t) + t*(s + t)) - 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*(-4*gZlL^3*gZlR*mm^2*s*(-psq + s + t) - 
      4*gZlL*gZlR^3*mm^2*s*(-psq + s + t) - 2*gZlL^2*gZlR^2*
       (4*mm^4*(psq - s - t) - 2*(-4 + d)*psq*(psq^2 - 2*psq*t + t*(s + t)) + 
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*
    ...
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*
     (2*gZlL^2*gZlR^2*((-4 + d)^2*psq*s + mm^2*(8*psq - (20 - 8*d + d^2)*s - 
          8*t)) + gZlL^4*(-((8 - 6*d + d^2)*psq*s) + 
        mm^2*(8*psq + (4 - 6*d + d^2)*s - 8*t)) + 
      gZlR^4*(-((8 - 6*d + d^2)*psq*s) + mm^2*(8*psq + (4 - 6*d + d^2)*s - 
          8*t)) + 4*(-2 + d)*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t) + 
      4*(-2 + d)*gZlL*gZlR^3*mm^2*(2*psq - s - 2*t))*\[Mu]^(8 - 2*d)*
