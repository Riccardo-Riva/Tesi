...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (-((4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-2*(-2 + d)^2*mm^4*s + 
       mm^2*(8*psq^2 - (8 - 6*d + d^2)*s^2 + 2*psq*((-2 + d)^2*s - 8*t) + 
         8*s*t + 8*t^2) + s*(8*psq^2 + (20 - 12*d + d^2)*psq*s + 
         2*(-2 + d)*s^2 - 16*psq*t + 8*s*t + 8*t^2))*\[Mu]^(8 - 2*d))/
     (Pi^(2*d)*s^2)) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (-((2 + d)*psq^2) + 3*psq*s - 5*s^2 + 2*d*s^2 + 
      (2 + d)*mm^2*(psq - s - t) + (4 + d)*psq*t - 3*s*t - 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (-4*psq^2 + (-20 + 11*d - 2*d^2)*psq*s + 12*s^2 - 5*d*s^2 + d^2*s^2 + 
      mm^2*(4*psq + (12 - 14*d + 3*d^2)*s - 4*t) - 2*(-6 + d)*psq*t + d*s*t - 
      8*t^2 + 2*d*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-((-2 + d)*psq^2) + 
      (-1 + d)*psq*s + 4*s^2 - 2*d*s^2 + (2 + d)*mm^2*(psq - t) + 
      (-4 + d)*psq*t + s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (4*(-3 + d)*psq^2 + 4*s^2 - 4*d*s^2 + d^2*s^2 - 16*s*t + 3*d*s*t - 
      8*t^2 + 2*d*t^2 + mm^2*(-4*psq + (16 - 14*d + 3*d^2)*s + 4*t) + 
      psq*(7*d*s - 2*d^2*s + 20*t - 6*d*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (-8*psq^2 + (4 - 8*d + d^2)*mm^2*s - (8 - 8*d + d^2)*psq*s - 10*s^2 + 
      4*d*s^2 + 16*psq*t - 8*s*t - 8*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (4*mm^2 - 2*(-2 + d)*psq - (16 - 7*d + d^2)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*(8 - 4*d + d^2)*mm^4*s + 
      mm^2*(8*psq^2 - (-4 + d)^2*s^2 + 2*psq*((8 - 4*d + d^2)*s - 8*t) + 
        8*s*t + 8*t^2) + s*(8*psq^2 + (28 - 14*d + d^2)*psq*s + 
        2*(-2 + d)*s^2 - 16*psq*t + 8*s*t + 8*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*(24 - 16*d + 3*d^2)*mm^4*s + 
      s*(8*psq^2 + (28 - 14*d + d^2)*psq*s + 2*(-2 + d)*s^2 - 16*psq*t + 
        8*s*t + 8*t^2) + mm^2*(-4*(-8 + d)*psq^2 + (48 - 32*d + 6*d^2)*psq*
         s - 2*(-2 + d)^2*s^2 + 8*(-8 + d)*psq*t - 4*(-8 + d)*s*t - 
        4*(-8 + d)*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-4*psq^2 + (-2 + d)^2*mm^2*s + 
      10*s^2 - 6*d*s^2 + d^2*s^2 - 4*s*t - 4*t^2 + 
      psq*(-((-2 + d)^2*s) + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (3*psq^2 + s^2 + 3*s*t + 2*t^2 - psq*(d*s + 5*t) + 
      mm^2*(-5*psq + (3 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(3*psq^2 + s^2 + 3*s*t + 2*t^2 - 
      psq*(d*s + 5*t) + mm^2*(-8*psq + (6 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^4 - 4*psq^2 + 
      mm^2*(-4*psq + s - 2*d*s) - (s + 2*t)^2 + psq*(-5*s + 2*d*s + 8*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-4 + d)*mm^4 + 
      mm^2*(-4*(-3 + d)*psq + (2 + 3*d)*s + 2*(-2 + d)*t) + 
      2*(3*psq^2 + s^2 + psq*(s - d*s - 5*t) + 3*s*t + 2*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq^2 + 4*s^2 - d*s^2 + 
      3*s*t + 2*t^2 - 2*psq*(s + 2*t) + mm^2*(-4*psq + 9*s + 4*t))*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(6*mm^2*s - 5*psq*s + s^2 + 
      d*mm^2*(psq - 2*s - t) + 2*psq*t - 3*s*t - 2*t^2 + 
      d*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-((4 + d)*psq^2) + (2 + d)*psq*s - 6*s^2 + d*s^2 + (8 + d)*psq*t - 
      8*s*t - 4*t^2 + mm^2*((4 + d)*psq + (2 - 3*d)*s - (4 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(d^2*(mm^2 - psq)*s + 
      2*(6*mm^2*s - 9*psq*s - s^2 + 2*psq*t - 3*s*t - 2*t^2) + 
      d*(2*psq^2 + 7*psq*s + s^2 - 2*mm^2*(2*psq + s - 2*t) - 4*psq*t + 
        3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     ((4 + d)*psq + (4 - 7*d + d^2)*s - (4 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-4 + d)*mm^4 + 
      mm^2*(4*psq + (6 + d)*s - 2*(-2 + d)*t) + 
      2*(psq^2 + t*(s + 2*t) - psq*((-4 + d)*s + 3*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(20 - 15*d + 2*d^2)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (8*psq^2 + (4 - 6*d + d^2)*psq*s + 8*s^2 - 2*d*s^2 - 16*psq*t + 8*s*t + 
      8*t^2 + 2*mm^2*((-8 + d)*psq + (6 + 6*d - d^2)*s - (-8 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(4*s + d*(-2*psq + 3*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(14 - 6*d + d^2)*mm^2*s + 
      28*s^2 - 9*d*s^2 + d^2*s^2 + d*s*t - 8*t^2 + 2*d*t^2 - 
      psq*((36 - 9*d + d^2)*s + 2*(-4 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*(-4 + d)*psq^2 + 
      2*(20 - 8*d + d^2)*psq*s - 12*s^2 + 6*d*s^2 - d^2*s^2 + 
      6*(-4 + d)*psq*t + 16*s*t - 4*d*s*t + 16*t^2 - 4*d*t^2 + 
      2*mm^2*((-4 + d)*psq - 2*(10 - 6*d + d^2)*s - (-4 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(8*s + d^2*s + 
      2*d*(psq - 4*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (psq^2 + mm^2*(5*psq + (-2 + d)*s - 5*t) + t*(s + 2*t) - 
      psq*((-3 + d)*s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (psq^2 + mm^2*(8*psq + (-2 + d)*s - 8*t) + t*(s + 2*t) - 
      psq*((-3 + d)*s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (2*psq^2 + 3*s^2 - d*s^2 + mm^2*(4*psq + 5*s - 4*t) - 4*psq*t + s*t + 
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*psq^2 - 6*mm^2*s + 5*psq*s - 
      2*s^2 + d*mm^2*(psq + s - t) - 6*psq*t + s*t + 2*t^2 + 
      d*psq*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-((-4 + d)*psq^2) + 6*psq*s + 2*s^2 - d*s^2 + (-8 + d)*psq*t + 4*t^2 + 
      mm^2*((4 + d)*psq + 2*(-3 + d)*s - (4 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(d^2*(mm^2 - psq)*s - 
      2*(4*psq^2 - 6*mm^2*s + 9*psq*s - 6*psq*t + s*t + 2*t^2) + 
      d*(2*psq^2 + 9*psq*s + mm^2*(4*psq - 6*s - 4*t) - 4*psq*t + s*t + 
        2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
     (-((4 + d)*psq) + (8 - 6*d + d^2)*s + (4 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-8*psq^2 - (4 - 6*d + d^2)*psq*s - 8*s^2 + 2*d*s^2 + 16*psq*t - 8*s*t - 
      8*t^2 + 2*mm^2*((-8 + d)*psq + (2 - 7*d + d^2)*s - (-8 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(4*s + d*(2*psq + s - 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-4 + d)*psq^2 + 
      2*(14 - 6*d + d^2)*mm^2*s + 20*s^2 - 8*d*s^2 + d^2*s^2 - 16*s*t + 
      3*d*s*t - 8*t^2 + 2*d*t^2 - psq*((12 - 5*d + d^2)*s + 6*(-4 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(6*(-4 + d)*psq^2 + 12*s^2 - 
      6*d*s^2 + d^2*s^2 - 16*s*t + 4*d*s*t - 16*t^2 + 4*d*t^2 + 
      2*mm^2*((-4 + d)*psq + (24 - 13*d + 2*d^2)*s - (-4 + d)*t) - 
      2*psq*((16 - 7*d + d^2)*s + 5*(-4 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(8*s + d^2*s - 
      2*d*(psq + 3*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-4*mm^2 + (-3 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-6*mm^2 + (-3 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-8*psq^2 + (-4 + d)^2*mm^2*s - (20 - 8*d + d^2)*psq*s + 16*psq*t + 
      2*(s^2 - 4*s*t - 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-8*psq^2 + (12 - 8*d + d^2)*mm^2*s - 8*s^2 + 2*d*s^2 - 8*s*t - 8*t^2 + 
      psq*(-((-4 + d)^2*s) + 16*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-8*psq^2 + (16 - 12*d + d^2)*mm^2*s - (12 - 8*d + d^2)*psq*s + 18*s^2 - 
      9*d*s^2 + d^2*s^2 + 16*psq*t - 8*s*t - 8*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*d*mm^2 - 8*psq + 32*s - 
      11*d*s + d^2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (2*(-2 + d)*mm^2 - 4*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
   ...
   (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^2 - 3*psq - t)*
    ...
    (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     ...
     (-3*psq + 4*s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     ...
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p1, q2]])/(Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (7*mm^2 - 7*psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-4*psq + (16 - 6*d + d^2)*s + 
      4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     ...
     (4*mm^2 - 5*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (7*mm^2 - 7*psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-4*mm^2 + 4*psq + 3*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-5*s + d*(-mm^2 + psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-8 + d)*mm^2 - (-6 + d)*psq + 
      12*s - d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     ...
     gXll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-8 + d)*mm^2 - (-6 + d)*psq + 
      2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-(d^2*s) + 
      2*d*(mm^2 + psq + 3*s - 2*t) - 12*(psq + s - t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^2 + 2*(-5 + d)*psq + 4*s - 
      d*s + 6*t - 2*d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - psq - t)*
   ...
   (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^2 - 4*psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (2*psq - 5*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (4*psq + (-12 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(16*s + d^2*s - 
      2*d*(psq + 3*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(8*s + d^2*s + 
      2*d*(psq - 4*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
   ...
   (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(3*psq + s - 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq + (-2 + d)*s - 2*t)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*psq + (12 - 6*d + d^2)*s - 4*t)*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(8*psq - (8 - 6*d + d^2)*s - 8*t)*
    ...
    (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     ...
     (-4*psq + (-8 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(16*s + d^2*s + 
      2*d*(psq - 4*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*
   ...
   (4^(4 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*\[Mu]^(8 - 2*d)*
