...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^6*s*
      ...
      (aa*(psq^2 + 3*mm^2*(psq - s - t) + psq*(3*s - t) - 2*s*(s + t)) + 
       bb*(-psq^2 + psq*(-2*s + t) + 2*s*(s + t) + 
         mm^2*(-3*psq + 2*s + 3*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     Pi^(2*d) - (I*4^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^6*(bb*(psq - s - t) + 
       ...
       SP[p1, q1]])/Pi^(2*d) - (I*4^(2 - d)*EL^5*gAl*gHll^4*mm^6*
      (bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^6*(bb*(2*mm^2 - s - 2*t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^4*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^4*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*(bb*(2*mm^2 - psq - t) + 
      ...
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^4*
