...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[q2, mz], 
 ...
 ((2^(-1 - 2*d)*EL^5*ggpgpAZ*ggpgpZ*s*
    ...
    \[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (EL^5*ggpgpAZ*ggpgpZ*(aa*(gZlL^2*psq*(mm^2 + psq + s) + 
  ...
  (3*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpAZ*ggpgpZ*(gZlL^2 + gZlR^2)*
