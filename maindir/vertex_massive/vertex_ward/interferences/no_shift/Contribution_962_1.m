  ...
  ((EL^5*gAl*gXll^2*mm^4*s*
     (aa*(-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(4*psq - s)) + 
      ...
      bb*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(4*psq - s) + 
        (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq)*(mm^2 + s) + 
        (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 - psq)*(mm^2 + s)))*
     \[Mu]^(8 - 2*d))/(2*Pi)^(4*d) + (2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*
     ...
     (2*aa*(gZlL^2*(-mm^2 + psq) + gZlR^2*(-mm^2 + psq) + 
      ...
      bb*d*(gZlL^2*(mm^2 - psq)*s + gZlR^2*(mm^2 - psq)*s + 
        2*gZlL*gZlR*(2*mm^2*psq + (2*psq - s)*s)) + 
      aa*d*(gZlL^2*(mm^2 - psq)*s + gZlR^2*(mm^2 - psq)*s + 
        2*gZlL*gZlR*(-2*mm^2*psq + s*(-2*psq + s))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*mm^4*
     ((-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq) + 
      (-4 + d)*gZlL*gZlR*(mm^2 - s))*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) + (4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
   ...
   (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*mm^4*
     ((-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq) - 
      (-4 + d)*gZlL*gZlR*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    Pi^(2*d) + (2^(1 - 4*d)*(aa - bb)*EL^5*gAl*gXll^2*mm^2*
     (-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq)*(mm^2 - s)) - 
      (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 + psq)*(mm^2 - s) + 
      4^(1 + d)*(-4 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(4*d) + 
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(2*d*psq + 2*s - d*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*(2*aa*(gZlL^2 + gZlR^2)*(mm^2 - 3*psq)*
   ...
   (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
     ...
     gZlL*gZlR*mm^4*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
   ...
   (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
