...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   ((I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*
      (d^2*gZuLC*(2*Pi)^d*s*(3*s + 5*t) - d^2*gZuRC*(2*Pi)^d*s*(3*s + 5*t) + 
       2^(1 + d)*gZuLC*Pi^d*((10 - 8*d)*s^2 + (16 - 13*d)*s*t + 
         ...
         2*(-13 + 8*d)*s*t + (-2 + d)*t^2))*SPList[SP[p1, q1]])/
     ...
     (Pi^(2*d)*s*(-mzC^2 + s)) + (I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*
      (5*d^2*gZuRC*(2*Pi)^d*s^2 - 2^(1 + d)*gZuRC*Pi^d*((-28 + 17*d)*s^2 + 
       ...
       gZuLC*(-5*d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(2*(-7 + 6*d)*s^2 + 
           (-38 + 27*d - 5*d^2)*s*t - 2*(-2 + d)*t^2)))*SPList[SP[p3, q1]])/
     (Pi^(2*d)*s*(-mzC^2 + s)) - (I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*
    ...
    (I*2^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*
     ...
     (Pi^d*s*(-mzC^2 + s)) - (I*2^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*
    ...
    (I*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*
     ...
     (mw^4*s*(-1 + GaugeXi[Q])^2) + (I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*
      gZlLC*(s + t)*(gZuLC*(2^(1 + d)*(-4 + d)*mw^2*Pi^d + d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(-s + t)) + gZuRC*(-(2^(1 + d)*(-2 + d)*mw^2*Pi^d) - 
         d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(2*s + t)) + 
       (2^(1 + d)*(-4 + d)*gZuLC*mw^2*Pi^d - 2^(1 + d)*(-2 + d)*gZuRC*mw^2*
          Pi^d - 2^(1 + d)*gZuRC*Pi^d*s + d*gZuRC*(2*Pi)^d*s + 
         gZuLC*(2^(2 + d)*Pi^d - d*(2*Pi)^d)*s)*GaugeXi[Q])*
    ...
    (I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*(3*d*gZuLC*(2*Pi)^d*s^2 - 
    ...
    (I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*(-(d*gZuLC*(2*Pi)^d*s) + 
      ...
      (-1 + GaugeXi[Q])^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*
      gZlLC*((-4 + d)*gZuLC - (-2 + d)*gZuRC)*(s + t)*
    ...
    (I*2^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*((-4 + d)*gZuLC - 
       (-2 + d)*gZuRC)*(s + t)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q1], 
    ...
    (I*2^(3 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*((-7 + d)*gZuLC*s - 
       2*gZuLC*t - gZuRC*(s + d*s + 2*t))*SPList[SP[p1, q1], SP[p3, q1], 
       SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*(mzC^2 - s)*s*GaugeXi[Q]) - 
    (I*2^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*((-6 + d)*gZuLC*s - 
       2*gZuLC*t - gZuRC*(d*s + 2*t))*SPList[SP[p1, q1], SP[p3, q1], 
    ...
    (I*2^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*((-2 + d)*gZuLC*s - 
     ...
     (mw^4*Pi^d*(mzC^2 - s)*s*GaugeXi[Q]) - 
    (I*2^(2 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*((-2 + d)*gZuLC - 
       (-4 + d)*gZuRC)*t*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*s*(-mzC^2 + s)*GaugeXi[Q]) + 
    (I*2^(3 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*((-1 + d)*gZuLC*s - 
       (-5 + d)*gZuRC*s - 2*gZuLC*t - 2*gZuRC*t)*SPList[SP[p2, q1], 
     ...
     (mw^4*Pi^d*(mzC^2 - s)*s*GaugeXi[Q]) - 
    (I*2^(4 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*(gZuLC + gZuRC)*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 
     ...
     mw*Sqrt[GaugeXi[Q]]]]*((I*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*(s + t)*
      ((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 2*gZuLC*t + 2*gZuRC*t)*
      SPList[SP[p1, q1], SP[q1, q1]])/(mw^4*(2*Pi)^d*(mzC^2 - s)) + 
    (I*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*t*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 
       2*gZuLC*t + 2*gZuRC*t)*SPList[SP[p2, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^d*(mzC^2 - s)) - (I*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*
      (d*gZuLC*(2*Pi)^d*s^2 - d*gZuRC*(2*Pi)^d*s^2 + 2^(1 + d)*gZuRC*Pi^d*
        ...
        (-((-2 + d)*gZuLC*s) + (-4 + d)*gZuRC*s - 2*gZuLC*t - 2*gZuRC*t)*
        GaugeXi[Q] + (d*gZuLC*(2*Pi)^d*s^2 - d*gZuRC*(2*Pi)^d*s^2 + 
         2^(1 + d)*gZuRC*Pi^d*(2*s^2 - (-5 + d)*s*t + 2*t^2) - 
         2^(1 + d)*gZuLC*Pi^d*(s^2 - 2*t^2 + s*(t - d*t)))*GaugeXi[Q]^2)*
      SPList[SP[p3, q1], SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*(mzC^2 - s)*
      (-1 + GaugeXi[Q])^2) + (I*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*s*
    ...
    (I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*(d*gZuLC*(2*Pi)^d*s^2 - 
    ...
    (I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*(3*d*gZuLC*(2*Pi)^d*s^2 - 
       3*d*gZuRC*(2*Pi)^d*s^2 + 2^(1 + d)*gZuRC*Pi^d*
        (6*s^2 + (11 - 2*d)*s*t + 4*t^2) + 2^(1 + d)*gZuLC*Pi^d*
        (-3*s^2 + (-1 + 2*d)*s*t + 4*t^2) + s*(-(d*gZuLC*(2*Pi)^d*s) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*t*(d*gZuLC*(2*Pi)^d*s - 
       ...
       2^(1 + d)*gZuRC*Pi^d*(2*s + t) + (2^(1 + d)*gZuLC*Pi^d - 
         2^(2 + d)*gZuRC*Pi^d - d*gZuLC*(2*Pi)^d + d*gZuRC*(2*Pi)^d)*s*
        GaugeXi[Q])*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^(2*d)*(mzC^2 - s)*s*GaugeXi[Q]) + 
    (I*2^(1 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*(d*gZuRC*(2*Pi)^d*s^2 - 
       2^(1 + d)*gZuRC*Pi^d*(2*s^2 + (9 - 2*d)*s*t + 4*t^2) + 
       gZuLC*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(s^2 + (3 - 2*d)*s*t - 
           4*t^2)) + s*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*s + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   (((-I)*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*(d^2*gZuLC*(2*Pi)^d*s^2 - 
       d^2*gZuRC*(2*Pi)^d*s^2 + 2^(1 + d)*gZuRC*Pi^d*((-4 + 3*d)*s^2 - 
         (4 - 5*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZuLC*Pi^d*
        (-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))*SPList[SP[q1, q1]])/
     (mw^2*(2*Pi)^(2*d)*(mzC^2 - s)) + (I*EL^6*gAu*gWlN*gWNl*gWWA*gZlLC*
