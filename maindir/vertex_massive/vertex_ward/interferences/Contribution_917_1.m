...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, 0], 
 ...
 (-((EL^5*gAl^3*ggpgpA^2*s*(bb*mm^2*(2*mm^2*psq + 2*psq^2 + 6*psq*s - 
        3*s^2) + aa*(-2*mm^4*psq + psq*s^2 - 2*mm^2*(psq^2 + 3*psq*s - s^2)))*
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
  (2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*s*(bb*mm^2*(mm^2 + 2*psq - 2*s) + 
  ...
  (EL^5*gAl^3*ggpgpA^2*(bb*(-(psq*s^2) + mm^4*(2*psq + s) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*s*(-(bb*mm^2*(mm^2 + 2*psq - 2*s)) + 
   ...
   Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*mm^2*
    (aa*mm^2 - 2*bb*mm^2 + 4*aa*psq - 3*bb*psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + (EL^5*gAl^3*ggpgpA^2*(bb*mm^2 - aa*psq)*
    s^2*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2*Pi)^(2*d) - 
  (EL^5*gAl^3*ggpgpA^2*s*(aa*(mm^4 - 7*mm^2*psq + 2*psq*(-psq + s)) + 
     bb*(mm^4 + mm^2*(5*psq - 3*s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2*Pi)^(2*d) - 
  (EL^5*gAl^3*ggpgpA^2*s*(bb*(mm^4 + mm^2*(3*psq - 2*s) - psq*s) + 
     aa*(mm^4 + psq*s + mm^2*(-5*psq + 2*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*EL^5*gAl^3*ggpgpA^2*(aa*mm^2*(2*psq - s) - aa*psq*s + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl^3*ggpgpA^2*(bb*psq^2 + bb*mm^2*(4*psq - 2*s) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(bb*(psq^2 + mm^2*(psq - s)) - 
     aa*psq*(mm^2 + psq - s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
   Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(2*aa*psq*(3*mm^2 + psq - s) - 
     bb*(mm^2*(6*psq - 3*s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*mm^2*(4*psq - 3*s) - aa*psq*s + 
     2*bb*psq*s + 2*bb*mm^2*(-2*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl^3*ggpgpA^2*mm^2*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(mm^2 + psq)*(mm^2 - 2*s) - 
     bb*(mm^4 + mm^2*(psq - 3*s) - psq*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  (4^(1 - d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  ((aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 + psq)*(2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (4^(1 - d)*EL^5*gAl^3*ggpgpA^2*(aa*mm^2 - bb*psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
  ((aa + bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1], SP[q1, q2]])/(2*Pi)^(2*d) + 
  ((aa + bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1], SP[q2, q2]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*EL^5*gAl^3*ggpgpA^2*(2*aa*(mm^2 + psq) - bb*(3*mm^2 + psq))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^5*gAl^3*ggpgpA^2*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl^3*ggpgpA^2*(2*aa*(mm^2 + psq) - bb*(3*mm^2 + psq))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (2^(3 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
  (2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
