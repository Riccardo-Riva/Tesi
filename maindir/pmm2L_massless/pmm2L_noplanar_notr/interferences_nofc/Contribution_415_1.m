...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mz], 
  ...
  (-((4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFA*gFFAZ*(gZlL + gZlR)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFA*gFFAZ*(gZlL + gZlR)*(s + t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFA*gFFAZ*(gZlL + gZlR)*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFA*gFFAZ*(gZlL + gZlR)*(s + t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFA*gFFAZ*(gZlL + gZlR)*t*
