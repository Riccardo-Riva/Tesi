...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^4*t*
       (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d))/(mz^2*Pi^(2*d)*s)) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*(s + t)*
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*t*
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^4*((2 + d)*s + 4*d*t)*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*t*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^4*t*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*t^2*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*t^2*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*(s + 2*t)*
