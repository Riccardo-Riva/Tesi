...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (((-I)*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)^2*s*
     \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
     gXll^2*mm^6*(mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (2*aa*(mm^2*(psq - t) + psq*(psq - s - t)) - bb*(mm^2 + psq)*
       (2*psq - s - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (aa*(mm^2 + psq)*(2*psq - s - 2*t) + 
      2*bb*(psq*(-psq + t) + mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gHll^2*
     gXll^2*mm^6*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(3*psq - s - 3*t) + 
   ...
   (I*4^(2 - d)*bb*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(3*mm^2 + psq)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(psq - t)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*(psq - t) + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*(mm^2 + psq - s - 2*t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*(2*mm^2 - psq - t) + 
     ...
     mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
