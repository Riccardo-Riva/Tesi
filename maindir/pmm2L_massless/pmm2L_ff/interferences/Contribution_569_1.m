...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  (-((4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(s + t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^6*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*t*(2*mm^2 + s + t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(2*mm^2 + s + t)*
