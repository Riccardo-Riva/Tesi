...
PropList[KiraPropagator[q1, mm], KiraPropagator[p1 - q2, mm], 
 ...
 ((d*EL^6*gAl^4*gZlL*gZlR*mm^2*(2*(2 - 3*d + d^2)*mm^4 - 
     2*(16 - 10*d + d^2)*s^2 - mm^2*(2*(6 - 5*d + d^2)*psq + 
       (4 - 12*d + d^2)*s))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
  (4^(1 - d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*(20*s + d^2*s - 3*d*(mm^2 + 4*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*(-2 + d)^2*EL^6*gAl^4*(gZlL^2 + gZlR^2)*mm^2*
    (2*mm^2 - 2*(-3 + d)*psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*
    (-12*(psq - 2*s) + d^2*(mm^2 - 2*psq + 2*s) - 2*d*(2*mm^2 - 5*psq + 8*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  ((-2 + d)*EL^6*gAl^4*(gZlL^2 + gZlR^2)*mm^2*(16*s + d^2*s - 
     2*d*(mm^2 + 5*s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (4^(1 - d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*(20*s + d^2*s - 3*d*(mm^2 + 4*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*(-2 + d)*EL^6*gAl^4*(gZlL^2 + gZlR^2)*
    (2*(-2 - d + d^2)*mm^4 - 2*(16 - 10*d + d^2)*s^2 - 
     mm^2*(2*(2 - 3*d + d^2)*psq + (16 - 26*d + 3*d^2)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + 
  (d*EL^6*gAl^4*gZlL*gZlR*mm^2*(-2*(10 - 7*d + d^2)*mm^2 + 
     2*(14 - 9*d + d^2)*psq + (-20 + 20*d - 3*d^2)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
  (4^(2 - d)*(-2 + d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^4*(gZlL^2 + gZlR^2)*
    (20*s + d^2*s - 4*d*(mm^2 + 3*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) - 
  (4^(1 - d)*d^2*EL^6*gAl^4*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*d*EL^6*gAl^4*gZlL*gZlR*mm^2*(mm^2 - psq)*
