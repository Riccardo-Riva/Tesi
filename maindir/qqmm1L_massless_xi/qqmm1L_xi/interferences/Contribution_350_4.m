...
PropList[KiraPropagator[-p1 + q1, ml], KiraPropagator[p2 + q1, ml]]*
 ((I*EL^6*gZlL*gZlR*ml^2*
    ...
    (gZlL^3*gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
     ...
     gZlL^2*gZlR*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 
      ...
      (gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*(4*(-2 + d)*s^2 + 
           (-2 - 3*d + d^2)*s*t - 2*t^2)) + gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 
         2^(1 + d)*Pi^d*((2 - 2*d + d^2)*s^2 + (8 - 5*d + d^2)*s*t + 
           2*t^2))))*\[Mu]^(4 - d)*SPList[SP[p1, q1]])/
   (Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) + 
  (I*EL^6*(gZlL^2 - gZlR^2)*s*
    (gZlR*gZlRC*(gZuR*gZuRC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
          (3*s + (-3 + d)*t)) - gZuL*gZuLC*((-7 + d)*d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(6*s + 3*t - d*t))) + 
     gZlL*gZlLC*(-(gZuL*gZuLC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
           (3*s + (-3 + d)*t))) + gZuR*gZuRC*((-7 + d)*d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(6*s + 3*t - d*t))))*\[Mu]^(4 - d)*
    SPList[SP[p2, p3]])/((2*Pi)^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) + 
  ((I/2)*EL^6*((2^(1 - 2*d)*(gZlL^2 - gZlR^2)*s*
       (gZlL*gZlLC*(gZuL*gZuLC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
    ...
    SPList[SP[p2, q1]])/((mz^2 - s)^2*(-mzC^2 + s)) + 
  (I*EL^6*(gZlL^2 - gZlR^2)*s*
    (gZlR*gZlRC*(gZuR*gZuRC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
          (3*s + (-3 + d)*t)) - gZuL*gZuLC*((-7 + d)*d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(6*s + 3*t - d*t))) + 
     gZlL*gZlLC*(-(gZuL*gZuLC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
           (3*s + (-3 + d)*t))) + gZuR*gZuRC*((-7 + d)*d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(6*s + 3*t - d*t))))*\[Mu]^(4 - d)*
    SPList[SP[p3, q1]])/((2*Pi)^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) - 
    ...
    (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
     ...
     gZlR*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
       ...
       gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + 
           (14 - 7*d + d^2)*s*t + 2*t^2))))*\[Mu]^(4 - d)*SPList[SP[q1, q1]])/
   (Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) - 
  ...
  (I*2^(1 - d)*EL^6*(gZlL^2 + gZlR^2)*
    ...
    SPList[SP[p1, p2], SP[p2, p3]])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
  (I*2^(1 - d)*EL^6*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(1 - d)*EL^6*(gZlL^2 + gZlR^2)*
    (-(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t))) + gZlL*gZlLC*
      (gZuL*gZuLC*((-6 + d)*s - 2*t) - gZuR*gZuRC*(d*s + 2*t)))*\[Mu]^(4 - d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
  (I*2^(1 - d)*EL^6*(gZlL^2 + gZlR^2)*
    (gZlR*gZlRC*(gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
       gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t)) + 
     gZlL*gZlLC*(gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
  ...
  (I*2^(2 - d)*EL^6*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
  ...
  (I*2^(1 - d)*EL^6*(gZlL^2 + gZlR^2)*
   ...
   (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
  (I*2^(3 - d)*EL^6*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
