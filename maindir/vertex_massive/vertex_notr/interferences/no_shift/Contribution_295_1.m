...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^6*gAl^2*gHll*gHZZ*mm^4*(-(4^(1 + d)*(4 - 5*d + d^2)*gZlL*gZlR*Pi^(2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl^2*gHll*gHZZ*mm^2*
     ...
     SPList[SP[p1, q1]])/Pi^(4*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gHll*
     gHZZ*mm^2*(-2*(-2 + d)*gZlL*gZlR*mm^2 + 
      gZlL^2*((-1 + d)*mm^2 - (-3 + d)*psq + (-4 + d)*s) + 
      gZlR^2*((-1 + d)*mm^2 - (-3 + d)*psq + (-4 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHZZ*mm^2*
     (12*(gZlL^2 + gZlR^2)*s + d^2*(gZlL^2 + gZlR^2)*s - 
      8*d*(gZlL*gZlR*mm^2 + gZlL^2*s + gZlR^2*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHZZ*mm^2*
     (12*(gZlL^2 + gZlR^2)*s + d^2*(gZlL^2 + gZlR^2)*s - 
      4*d*(gZlL*gZlR*mm^2 + 2*gZlL^2*s + 2*gZlR^2*s))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gHll*gHZZ*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll*gHZZ*((-2 + d)*gZlL^2 + 2*d*gZlL*gZlR + 
    ...
    Pi^(2*d) - (2^(5 - 2*d)*EL^6*gAl^2*gHll*gHZZ*gZlL*gZlR*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^2*gHll*gHZZ*((-2 + d)*gZlL^2 - 2*d*gZlL*gZlR + 
      (-2 + d)*gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    Pi^(2*d) + (4^(1 - d)*(12 - 6*d + d^2)*EL^6*gAl^2*gHll*gHZZ*gZlL*gZlR*
