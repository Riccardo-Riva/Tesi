...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[W]]], 
 ...
 (((-I/9)*2^(-3 - d)*EL^6*(d*s*(-3 + 6*sw^2 + 6*swC^2) + 
  ...
  ((I/9)*2^(-3 - 2*d)*EL^6*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
    ...
    SPList[SP[p1, p2], SP[p1, q1]])/(cwC^2*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*
    sw^2*swC^2) - ((I/9)*2^(-2 - d)*EL^6*(6 - 4*swC^2 - 16*swC^4 + 
     d*(-3 + 6*sw^2 + 6*swC^2) + 4*sw^2*(-3 - 10*swC^2 + 16*swC^4))*t*
  ...
  ((I/9)*2^(-2 - d)*EL^6*(-3 + 8*swC^2)*(1 - 2*swC^2 + sw^2*(-2 + 8*swC^2))*
    SPList[SP[p1, p3], SP[p1, p3]])/(cwC^2*Pi^d*(mz^2 - s)*(-mzC^2 + s)*sw^2*
  ...
  ((I/9)*2^(-3 - d)*EL^6*(s*(6 - 4*swC^2 - 16*swC^4 + 
    ...
    SPList[SP[p1, p3], SP[p2, q1]])/(cwC^2*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
    sw^2*swC^2) - ((I/9)*2^(-1 - d)*EL^6*(-3 + 8*swC^2)*
  ...
  ((I/9)*2^(-3 - d)*EL^6*(3*s*(6 - 20*swC^2 + 16*swC^4 + 
   ...
   (cwC^2*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*sw^2*swC^2) + 
  ((I/9)*2^(-2 - d)*EL^6*(-3 + 8*swC^2)*(1 - 2*swC^2 + sw^2*(-2 + 8*swC^2))*
    SPList[SP[p3, q1], SP[p3, q1]])/(cwC^2*Pi^d*(mz^2 - s)*(-mzC^2 + s)*sw^2*
    swC^2))
