...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 ((I*2^(1 - d)*EL^6*gAl*ggpgpA*ggpgpZ*
   ...
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) + 
  (I*EL^6*gAl*ggpgpA*ggpgpZ*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 
  ...
  (I*2^(2 - d)*EL^6*gAl*ggpgpA*ggpgpZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
     (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
  ...
  (I*2^(1 - d)*EL^6*gAl*ggpgpA*ggpgpZ*
   ...
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) + 
  (I*2^(2 - d)*EL^6*gAl*ggpgpA*ggpgpZ*(gZlLC + gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, p3], SP[p1, p3]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) - 
  (I*2^(1 - d)*EL^6*gAl*ggpgpA*ggpgpZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
  ...
  (I*2^(1 - d)*EL^6*gAl*ggpgpA*ggpgpZ*
   ...
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
  (I*2^(3 - d)*EL^6*gAl*ggpgpA*ggpgpZ*(gZlLC + gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, p3], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) + 
  (I*2^(1 - d)*EL^6*gAl*ggpgpA*ggpgpZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
