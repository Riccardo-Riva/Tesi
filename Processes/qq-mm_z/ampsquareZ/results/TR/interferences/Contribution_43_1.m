...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 
    ...
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*s*
     ...
     (mw^4*(2*Pi)^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2) + 
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*s^2*
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*t*
      ...
      (-mzC^2 + s)*GaugeXi[Q]) + (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (gZuR*gZuRC*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-2 + d)*s^2 + 
           (-9 + 2*d)*s*t - 4*t^2)) + gZuL*gZuLC*(d*(2*Pi)^d*s^2 - 
    ...
    (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      ...
      (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s^2 + 
       3*d*gZuR*gZuRC*(2*Pi)^d*s^2 + 2^(1 + d)*gZuL*gZuLC*Pi^d*
        ...
        (gZuR*gZuRC*(-3*(-4 + d)*s^2 + (22 - 6*d)*s*t + 4*t^2) + 
         gZuL*gZuLC*(3*(-2 + d)*s^2 + 2*(-7 + 3*d)*s*t + 4*t^2))*GaugeXi[Q] + 
    ...
    (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*((-4 + d)*gZuL*gZuLC - 
      ...
      (gZuR*gZuRC*(-2*(-3 + d)*s + (8 - 3*d)*t) + 
       gZuL*gZuLC*(2*(-3 + d)*s + (-10 + 3*d)*t))*SPList[SP[p1, q1], 
       SP[p1, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
    ...
    (I*2^(3 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(gZuL*gZuLC*((-7 + d)*s - 2*t) - 
       gZuR*gZuRC*(s + d*s + 2*t))*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]) - 
    (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
    ...
    (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*((-2 + d)*gZuL*gZuLC - 
       ...
       SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]) - 
    (I*2^(3 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(gZuL*gZuLC*((-1 + d)*s - 2*t) - 
       gZuR*gZuRC*((-5 + d)*s + 2*t))*SPList[SP[p2, q1], SP[p3, q1], 
       SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
      GaugeXi[Q]) + (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)) + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   (((-I)*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (-(gZuR*gZuRC*(5*d^2*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*
       ...
       gZuL*gZuLC*(5*d^2*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*((-2 + d)^2*s^2 + 
           2*(11 - 7*d)*s*t + (-2 + d)*t^2)))*SPList[SP[p2, q1]])/
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      ...
      gZlLC*((-4 + d)*gZuL*gZuLC - (-2 + d)*gZuR*gZuRC)*(s + t)*
    ...
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*(s*(s + t)*GaugeXi[Q]*
        (gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t)) - 
         2^(1 + d)*Pi^d*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + 
           gZuL*gZuLC*((-2 + d)*s + 2*t))*GaugeXi[Q] + 
    ...
    (I*2^(2 - d)*(-2 + d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*((-2 + d)*gZuL*gZuLC - 
       (-4 + d)*gZuR*gZuRC)*t*SPList[SP[p2, q1], SP[p2, q1]])/
    ...
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*
     ...
     (Pi^d*(-mz^2 + s)*(-mzC^2 + s)) + 
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*((2^(1 - 2*d)*mw^2*(-1 + GaugeXi[Q])^2*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 
   ...
   (((-I)*EL^6*gWlN*gWNl*gWWZ*gZlLC*s*
      ...
      SPList[SP[q1, q1]])/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)*(-mzC^2 + s)) + 
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(s + t)*
      ...
      (gZuR*gZuRC*(2^(1 + d)*Pi^d*(-6*s^2 - 11*s*t + (mw^2 - 4*t)*t) + 
       ...
       gZuL*gZuLC*(-(d*(2*Pi)^d*s^2) + mw^2*(-(d*(2*Pi)^d*s) + 
        ...
        GaugeXi[Q] + (gZuR*gZuRC*(d*s*(mw^2*(-(2^(1 + d)*Pi^d) + (2*Pi)^d) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*t*
      ...
      (-(gZuR*gZuRC*(-(d*(2*Pi)^d*s^2) + mw^2*(-(d*(2*Pi)^d*s) + 
            2^(1 + d)*Pi^d*(2*s - t)) + 2^(1 + d)*Pi^d*((-2 + d)*s^2 + 
            (-9 + 2*d)*s*t - 4*t^2))) + gZuL*gZuLC*(-(d*(2*Pi)^d*s^2) + 
         2^(1 + d)*Pi^d*((-1 + d)*s^2 + (-3 + 2*d)*s*t + 4*t^2) + 
         mw^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t))) - 
       2^(2 + d)*Pi^d*t*(gZuR*gZuRC*(-((-5 + d)*s) + 2*t) + 
         gZuL*gZuLC*((-1 + d)*s + 2*t))*GaugeXi[Q] + 
    ...
    (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*((-4 + d)*gZuL*gZuLC - 
      ...
      (gZuL*gZuLC*(-2*(-3 + d)*s + (10 - 3*d)*t) + 
       gZuR*gZuRC*(2*(-3 + d)*s + (-8 + 3*d)*t))*SPList[SP[p1, q1], 
       SP[p1, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
      (-mzC^2 + s)*GaugeXi[Q]) - (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s + 
       2^(1 + d)*gZuL*gZuLC*Pi^d*(7*s - (-5 + d)*t) - 
    ...
    (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*((-4 + d)*gZuL*gZuLC - 
      ...
      (gZuL*gZuLC*(-((-2 + d)*s) + (8 - 3*d)*t) + 
       gZuR*gZuRC*((-4 + d)*s + (-10 + 3*d)*t))*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
      (-mzC^2 + s)*GaugeXi[Q]) + (I*2^(3 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
       gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t))*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
      GaugeXi[Q]) - (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + (-3 + d)*t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + 3*t - d*t)) + 
