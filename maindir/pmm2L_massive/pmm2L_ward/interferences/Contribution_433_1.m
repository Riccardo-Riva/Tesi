...
PropList[KiraPropagator[q1, 0], KiraPropagator[q1, 0], 
 ...
 (((-I)*2^(-1 - 2*d)*EL^5*gAl^3*gFFAA*s*((aa + bb)*(-2 + d)*(mm^2 - psq)*s - 
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gFFAA*
    ...
    SPList[SP[p1, p2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*gFFAA*
