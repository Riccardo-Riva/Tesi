...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  ((4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*(2*(-1 + d)*psq^4 - 
   ...
   (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (mm^2*(4*(-7 + 2*d)*psq^2 + 4*s^2 + (-18 + 7*d)*s*t + 4*(-7 + 2*d)*t^2 - 
        psq*((2 + 3*d)*s + 8*(-7 + 2*d)*t)) + 
   ...
   (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*(-2*(-2 + d)*psq^3 + 
      ...
      mm^2*(2*(-2 + d)*psq^2 + 4*(-3 + d)*psq*s - 5*(-2 + d)*s^2 - 
        4*(-2 + d)*psq*t - 4*(-3 + d)*s*t + 2*(-2 + d)*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*
     ...
     gZNL*((-14 + 9*d)*psq^2 - 4*(-4 + 3*d)*psq*(s + t) + 
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*(psq - t)*
     ...
     gWWZ*gZNL*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*
     ...
     gWWZ*gZNL*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*
     (2*(-2 + d)*psq^2 - 2*(-2 + d)*mm^2*(psq - t) + 4*(-4 + d)*t^2 + 
   ...
   (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*(-3*(2 + d)*psq^2 + 
      (10 + d)*psq*s - 12*s^2 + 2*d*s^2 + 2*(-2 + d)*mm^2*(3*psq - s - 3*t) + 
      24*psq*t + 2*s*t - 3*d*s*t - 18*t^2 + 3*d*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*(psq - t)*
     ...
     gWWZ*gZNL*(mm^2 - 3*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*(2*mm^2 - 2*psq + s)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*(psq - t)^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*(psq - t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZNL*(psq - t)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*
     gWWZ*gZNL*(psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
