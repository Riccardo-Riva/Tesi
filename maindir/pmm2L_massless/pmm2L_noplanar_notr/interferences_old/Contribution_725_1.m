...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, 0], 
 ...
 ((2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s^2 - 3*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s^2 - 3*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s^2 - 3*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-6 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-6 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(d*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(d*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/(4^d*Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-16 + 3*d)*s - 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-9 + 2*d)*s^2 - 3*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s^2 - 8*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-6 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(d*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, p3]])/(4^d*Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-12 + d)*s - 10*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-7 + d)*s^2 - 5*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s^2 - 3*s*t - 2*t^2)*
  ...
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/((2*Pi)^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-3 + d)*s^2 - s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-3 + d)*s^2 - s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-3 + d)*s^2 - s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, p3]])/(4^d*Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-10 + 3*d)*s + 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(2*(-4 + d)*s^2 - s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(d*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((2 + d)*s^2 - 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, p3]])/(4^d*Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s + 10*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s^2 + s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(2*s^2 - s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s^2 + 4*s*t + 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((-10 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[q1, q2]])/((2*Pi)^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[q2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(-5 + d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(3*(-6 + d)*s^2 - 4*s*t - 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
  (EL^8*gAl^4*gAu^2*ggpgpA^2*(3*(-2 + d)*s^2 - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-8 + d)*s^2 - 4*s*t - 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s^2 - 4*s*t - 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s^2 + 4*s*t + 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s^2 - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(5*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(5*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(5*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(d*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, p3]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-11 + 2*d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(d*s + 6*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, p3]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*t*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-9 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-5 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(2*s + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((6 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(5*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (7*4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (7*2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-10 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + 3*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-14 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-18 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(7*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-4 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-3 + d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(2*s + 3*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((4 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s - t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-6 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*t*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-8 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-12 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-6 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
