...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*mm^2*t*
       (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d))/(mz^2*Pi^(2*d)*s)) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*(s + t)*
      (2*t*((-4 + d)*s + (-2 + d)*t) + mm^2*((2 + d)*s + 4*d*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mz^2*Pi^(2*d)*s) - 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*t*
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*mm^2*((2 + d)*s + 4*d*t)*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*t*
      (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
     (mz^2*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*t*(s + t)*
      (-2*(-4 + d)*gZlL*gZlR*(mm^2*((-4 + d)*s - 2*t) + s*(s + 2*t)) + 
    ...
    (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*t*
     ...
     (mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*
      ml^2*(s + t)*(2*mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*mm^2*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)*s) - 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*
     ...
     (mz^2*Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*
      (2*gZlL*gZlR*(2*(8 - 5*d + d^2)*mm^4*s - 2*(-4 + d)*t*(s + t)*
          ((-3 + d)*s + (-2 + d)*t) - mm^2*((4 - 6*d + d^2)*s^2 + 
           (40 - 34*d + 5*d^2)*s*t + 4*(10 - 7*d + d^2)*t^2)) + 
       gZlL^2*(-2*(4 - 5*d + d^2)*mm^4*s + 2*(-2 + d)*t*(s + t)*
          ((-3 + d)*s + (-2 + d)*t) + mm^2*((8 - 4*d + d^2)*s^2 + 
           (44 - 24*d + 5*d^2)*s*t + 4*(8 - 5*d + d^2)*t^2)) + 
       gZlR^2*(-2*(4 - 5*d + d^2)*mm^4*s + 2*(-2 + d)*t*(s + t)*
          ((-3 + d)*s + (-2 + d)*t) + mm^2*((8 - 4*d + d^2)*s^2 + 
           (44 - 24*d + 5*d^2)*s*t + 4*(8 - 5*d + d^2)*t^2)))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*t^2*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*t^2*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*(s + 2*t)*
