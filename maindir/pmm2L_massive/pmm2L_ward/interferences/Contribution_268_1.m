...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*(mm^2 + psq)*s*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
    (bb*(8*psq^2 + mm^2*(8*psq - 6*s - 8*t) - 8*psq*t - s*(s + 2*t)) + 
     aa*(-8*psq^2 + 4*psq*(s + 2*t) + s*(s + 2*t) + 
       mm^2*(-8*psq + 2*s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*s*sw*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gFZW*gHFW*gHll*gWWA*
    (gZlL + gZlR)*mm^2*s*sw*(aa*(4*psq - 3*s - 4*t) + 
     bb*(4*mm^2 - 8*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
  ...
  (I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*s*sw*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gFZW*gHFW*gHll*gWWA*
    (gZlL + gZlR)*mm^2*s*sw*(aa*(4*mm^2 - s - 4*t) + bb*(-4*psq + s + 4*t))*
  ...
  (I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*s*sw*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gHFW*gHll*
    gWWA*(gZlL + gZlR)*mm^2*s*sw*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*
    (gZlL + gZlR)*mm^2*s*sw*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*
    sw*(aa*(8*psq - 5*s - 8*t) + bb*(8*mm^2 - 16*psq + 5*s + 8*t))*
  ...
  (I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
   ...
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*
    sw*(aa*(8*mm^2 - 3*s - 8*t) + bb*(-8*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
   ...
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*
    (gZlL + gZlR)*mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/
   (4^d*Pi^(2*d)) + ((3*I)*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*
    mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gFZW*gHFW*gHll*gWWA*(gZlL + gZlR)*mm^2*
