 ...
 ((I*2^(-1 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl^3*gZlL*gZlR*mm^2*
  ...
  (I*2^(-1 - 4*d)*(aa - bb)*EL^5*gAl^3*mm^2*(mm^2 - psq)*
    (-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-2 + d)*psq - (-4 + d)*s - 
      ...
      Pi^(2*d)*((4 - 6*d + d^2)*psq - (8 - 6*d + d^2)*s - (4 - 6*d + d^2)*t))*
  ...
  (I*2^(-1 - 4*d)*(-2 + d)*EL^5*gAl^3*mm^2*
   ...
   Pi^(4*d) + (I*2^(-1 - 4*d)*(-2 + d)*EL^5*gAl^3*mm^2*
    ...
    SPList[SP[p2, q2]])/Pi^(4*d) - (I*(aa + bb)*(-2 + d)^2*EL^5*gAl^3*gZlL*
    gZlR*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*(aa + bb)*(8 - 6*d + d^2)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    (mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa + bb)*(8 - 6*d + d^2)*EL^5*gAl^3*
    (gZlL^2 + gZlR^2)*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl^3*
    gZlL*gZlR*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   Pi^(2*d) - (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*(bb*(8*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*(mm^2 + psq) + 
       (-2 + d)*gZlR^2*(mm^2 + psq))*(psq - s - t) + 
     aa*(-2*gZlL*gZlR*mm^2*((4 - 6*d + d^2)*mm^2 + 6*d*psq - d^2*psq - 
         4*(s + t)) + (-2 + d)*gZlL^2*((-4 + d)*mm^4 + psq*(-3*psq + s + t) + 
         mm^2*(-((-5 + d)*psq) + s + t)) + (-2 + d)*gZlR^2*
        ((-4 + d)*mm^4 + psq*(-3*psq + s + t) + mm^2*(-((-5 + d)*psq) + s + 
           t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   (4^d*Pi^(2*d)) - (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    ...
    (bb*(-(4^(2 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s - t)) - 
     ...
     aa*(-(4^d*d^2*Pi^(2*d)*(mm^2 - psq)*(-4*gZlL*gZlR*mm^2 + 
       ...
       4^(1 + d)*Pi^(2*d)*(4*gZlL*gZlR*mm^2*(mm^2 - s - t) + 
         ...
         gZlR^2*(mm^2*(-3*psq + t) + psq*(psq + 2*s + t)))))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^3*
    (-4*gZlL*gZlR*mm^2*((4 - 6*d + d^2)*psq - (8 - 6*d + d^2)*s - 
       (4 - 6*d + d^2)*t) + 
     gZlL^2*(psq*((16 - 10*d + d^2)*psq - (20 - 10*d + d^2)*s - 
         (16 - 10*d + d^2)*t) + mm^2*((-8 + 2*d + d^2)*psq + 
         (4 + 2*d - d^2)*s - (-8 + 2*d + d^2)*t)) + 
     gZlR^2*(psq*((16 - 10*d + d^2)*psq - (20 - 10*d + d^2)*s - 
         (16 - 10*d + d^2)*t) + mm^2*((-8 + 2*d + d^2)*psq + 
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl^3*
    (aa*(4^(2 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - t) - 
       gZlL^2*(2*Pi)^(2*d)*((16 - 10*d + d^2)*mm^4 - 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^3*(-4*(4 - 6*d + d^2)*gZlL*gZlR*mm^2*
     ...
     gZlR^2*((-4 + d)*psq*((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t) + 
       mm^2*((8 - 10*d + 3*d^2)*psq - (-8 + d^2)*s + (-8 + 10*d - 3*d^2)*t)))*
  ...
  (I*EL^5*gAl^3*(-(aa*(8*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*(mm^2 + psq) + 
