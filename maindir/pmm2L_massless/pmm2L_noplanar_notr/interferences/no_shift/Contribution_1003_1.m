(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
  ...
  (-((4^(1 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s^2 + 3*s*t + 2*t^2)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*t*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-5 + d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-3 + d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-6 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(3 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*((-2 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*ggpgpA^2*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*ggpgpA^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(3 - d)*EL^8*gAl^4*gAu^2*ggpgpA^2*t*\[Mu]^(8 - 2*d)*
