...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
 ...
 ((EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^4*(-2*psq + d*s + 2*t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^2*(2*mm^2 - psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^2*(-2*psq + d*s + 2*t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^2*\[Mu]^(8 - 2*d)*
