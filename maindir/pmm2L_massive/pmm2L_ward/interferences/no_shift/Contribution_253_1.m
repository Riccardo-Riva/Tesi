  ...
  (((-I)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*s*
    ...
    (2*Pi)^(2*d) - (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*s*
     (aa*(2*gZlL*gZlR*mm^2*(2*s + d*(psq - s - t)) + (-2 + d)*gZlR^2*mm^2*
         (2*mm^2 - 3*psq + s + t) + (-2 + d)*gZlL^2*psq*(2*mm^2 - 3*psq + s + 
          t)) + bb*(-4*gZlL*gZlR*mm^2*s + d*(-2*gZlL*gZlR*mm^2 + 
   ...
   (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZlL*
   ...
   (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gWlN*gWNl*gWWA*gZlL^2*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gWlN*gWNl*gWWA*gZlL^2*
