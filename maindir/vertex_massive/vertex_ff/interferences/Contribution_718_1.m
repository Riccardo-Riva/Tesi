  ...
  ((2^(3 - 2*d)*d*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^4*(3*mm^2 + psq)*
   ...
   (4^(1 - d)*d*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^4*
    ...
    (Pi^(2*d)*s) - (2^(1 - 4*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*
     (gZlL^2 + gZlR^2)*mm^2*
     (-((2*Pi)^(2*d)*psq^2*(psq^2 - s^2 + 2*psq*(s - t) + t^2)) - 
      mm^4*(2*Pi)^(2*d)*(5*psq^2 + s^2 + 6*s*t + 5*t^2 - 2*psq*(2*s + 5*t)) + 
      2^(1 + 2*d)*mm^2*Pi^(2*d)*(11*psq^3 - 5*psq^2*(s + 6*t) + 
        psq*t*(19*s + 27*t) - 4*t*(s^2 + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*d*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
     ...
     (gZlL^2 + gZlR^2)*mm^2*(-4*psq^3 - 2*psq^2*(s - 5*t) + 
