...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (-((EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*SPList[SP[p1, q1]])/
    (2*Pi)^(2*d)) - (EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*
    SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*
    SPList[SP[p3, q1]])/Pi^(2*d) + (EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*
    (gZlL + gZlR)*s*SPList[SP[q1, q1]])/(4^d*Pi^(2*d)) + 
  (EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*SPList[SP[q1, q2]])/
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*t*
