   ...
   ((2^(3 - 2*d)*d*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^4*(3*mm^2 + psq)*
    ...
    (2^(1 - 4*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
      (-((2*Pi)^(2*d)*psq^2*(psq^2 + psq*(s - 2*t) + t*(s + t))) - 
       mm^4*(2*Pi)^(2*d)*(5*psq^2 + 2*s^2 + 7*s*t + 5*t^2 - 
         5*psq*(s + 2*t)) + 2^(1 + 2*d)*mm^2*Pi^(2*d)*psq*
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
      ((-2 + d)*(2*Pi)^(2*d)*psq^2*s*(psq - t) + (-2 + d)*mm^4*(2*Pi)^(2*d)*s*
        (-3*psq + 2*s + 3*t) - 2*mm^2*
        (-(d*(2*Pi)^(2*d)*psq*s*(5*psq - s - 17*t)) + 2^(1 + 2*d)*Pi^(2*d)*
          (4*(-2 + d)*psq^3 + psq^2*(5*s - 12*(-2 + d)*t) - 
           2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) - psq*(s^2 + 17*s*t - 
             12*(-2 + d)*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
     (Pi^(4*d)*s) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*
      (gZlL^2 + gZlR^2)*mm^2*(7*mm^2 + psq)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
       psq^2*(s + 6*t) - t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*d*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^4*(2*mm^2 - 3*psq + s + t)*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
      (mm^2 - psq)*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*d*EL^6*gAl*gAu*gHll^2*gZlL*
      gZlR*mm^4*(psq - t)*(-6*psq + s + 6*t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
      (psq - t)*(psq*(-psq + t) + mm^2*(-3*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
