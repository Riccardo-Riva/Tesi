...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   ((4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^8*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(-2*psq^3 + 4*s*t*(s + t) + 
       psq^2*(s + 4*t) + psq*(s^2 - 9*s*t - 2*t^2) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(-psq + s + t)*
      (-(psq^2*s) + mm^4*(-8*psq + 3*s + 8*t) + 
       mm^2*(psq*(6*s - 8*t) + 8*t*(s + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(2*psq^3 + psq^2*(3*s - 4*t) + 
       3*mm^2*(2*psq - s - 2*t)*(psq - t) + 4*s*t*(s + t) + 
       psq*t*(-7*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(psq - t)*
      (psq^2*s + mm^4*(8*psq - 3*s - 8*t) + 2*mm^2*(8*psq^2 + 4*t*(s + t) - 
         3*psq*(s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(3*mm^2 + psq)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
      (psq^2*s + mm^4*(8*psq - 3*s - 8*t) + 2*mm^2*psq*(4*psq - 3*s - 4*t))*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(2*mm^4*(psq - s - t) + 
       psq*(psq^2 - 2*psq*t + t*(s + t)) - mm^2*(5*psq^2 + 3*(s + t)^2 - 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(-(psq^2*s) + 
       2*mm^4*(psq - t) + mm^2*t*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(2*psq^2 + 2*mm^2*s - 
       6*psq*s + 3*s^2 - 4*psq*t + 4*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
      (4*mm^4 + psq*(psq - s - t) + mm^2*(-5*psq + 3*s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(psq^2 - 2*psq*t + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(-psq + s + t)*
    ...
    (4^(3 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(-psq + s + t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^4*s + psq^2*s + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^2*(psq + s - t) + 
     ...
     Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
