...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
 ...
 (((-I)*(aa - bb)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*psq*s*
  ...
  (I*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*s*(bb*(mm^2 - 2*psq)*(psq - s - t) + 
     2*aa*psq*(2*psq - s - t) + aa*mm^2*(-3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*
    (2*psq^2 + psq*(s - 2*t) - 2*s*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*s*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*s*
    (-2*aa*psq*s - 2*bb*psq*s + bb*mm^2*(2*psq + s - 2*t) + 
     aa*mm^2*(-2*psq + 3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*
    mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*
    (bb*(mm^2 - 2*psq)*(psq - s - t) + 2*aa*psq*(2*psq - s - t) + 
     ...
     SP[p1, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gFFA^2*gFFZ*
    (gZlL + gZlR)*(2*bb*psq*(psq - t) - bb*mm^2*(psq + s - t) + 
     aa*mm^2*(3*psq + s - t) + 2*aa*psq*(-2*psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*
    (aa*mm^2*(psq - 2*s - t) - 2*bb*psq*(s + t) + 2*aa*psq*(-psq + s + t) + 
     bb*mm^2*(psq + 2*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
  ...
  (I*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*s*(bb*(2*mm^2 - psq - t) + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*s*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(-aa + bb)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*(psq - t)*
  ...
  (I*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*
    (bb*(-2*psq^2 - 3*psq*s + mm^2*(2*psq + 5*s - 2*t) + 2*psq*t - 2*s*t) + 
     aa*(2*psq^2 - 5*psq*s - 2*psq*t + 2*s*t + mm^2*(-2*psq + 3*s + 2*t)))*
  ...
  (I*4^(1 - d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*4^(1 - d)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*(bb*(2*mm^2 - psq - t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*gFFZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*gFFZ*
    (gZlL + gZlR)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
