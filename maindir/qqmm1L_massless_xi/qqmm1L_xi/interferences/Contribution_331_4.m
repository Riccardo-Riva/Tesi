 ...
 ((I*2^(-1 - 2*d)*EL^6*gAl^2*
    (gZlR*(gZlLC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
     ...
     gZlL*(gZlRC*gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
       ...
       gZlRC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
          ((8 - 7*d + d^2)*s^2 + (2 - 3*d + d^2)*s*t + 2*t^2))))*
    \[Mu]^(4 - d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s*(-mz^2 + s)*(-mzC^2 + s)) - 
  (I*(-3 + d)*EL^6*gAl^2*(gZlL - gZlR)*
    (gZlLC*(gZuR*gZuRC*((-4 + d)*s - 2*t) + gZuL*gZuLC*((-2 + d)*s + 2*t)) - 
     gZlRC*(gZuL*gZuLC*((-4 + d)*s - 2*t) + gZuR*gZuRC*((-2 + d)*s + 2*t)))*
    \[Mu]^(4 - d)*SPList[SP[p1, p3]])/((2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)) + 
  ((I/2)*EL^6*gAl^2*((2^(1 - 2*d)*(gZlL + gZlR)*
       (gZlRC*gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
  ...
  (I*2^(-1 - 2*d)*EL^6*gAl^2*
    (gZlR*(gZlLC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
     ...
     gZlL*(gZlRC*gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
       ...
       gZlRC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
          ((8 - 7*d + d^2)*s^2 + (2 - 3*d + d^2)*s*t + 2*t^2))))*
    \[Mu]^(4 - d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s*(-mz^2 + s)*(-mzC^2 + s)) + 
  (I*(-3 + d)*EL^6*gAl^2*(gZlL - gZlR)*
    (gZlLC*(gZuR*gZuRC*((-4 + d)*s - 2*t) + gZuL*gZuLC*((-2 + d)*s + 2*t)) - 
     gZlRC*(gZuL*gZuLC*((-4 + d)*s - 2*t) + gZuR*gZuRC*((-2 + d)*s + 2*t)))*
    \[Mu]^(4 - d)*SPList[SP[p3, q1]])/((2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)) - 
  (I*2^(-1 - 2*d)*EL^6*gAl^2*(gZlL + gZlR)*
    (gZlRC*gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
     ...
     gZlLC*gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
        ((4 - 3*d)*s^2 + (14 - 7*d + d^2)*s*t + 2*t^2)) + 
     gZlRC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
        ((4 - 3*d)*s^2 + (14 - 7*d + d^2)*s*t + 2*t^2)))*\[Mu]^(4 - d)*
  ...
  (I*2^(1 - d)*EL^6*gAl^2*(gZlL + gZlR)*((-2 + d)*gZlLC*gZuL*gZuLC - 
     ...
     (-2 + d)*gZlRC*gZuR*gZuRC)*t*\[Mu]^(4 - d)*SPList[SP[p1, p2], 
     SP[p1, p2]])/(Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)) + 
  (I*2^(1 - d)*EL^6*gAl^2*(gZlL + gZlR)*
    (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
     gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
        (-((-2 + d)*s) + 2*t)))*\[Mu]^(4 - d)*SPList[SP[p1, p2], SP[p1, p3]])/
  ...
  (I*2^(2 - d)*EL^6*gAl^2*(gZlL + gZlR)*((-2 + d)*gZlLC*gZuL*gZuLC - 
     (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
     (-2 + d)*gZlRC*gZuR*gZuRC)*t*\[Mu]^(4 - d)*SPList[SP[p1, p2], 
     SP[p2, q1]])/(Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)) - 
  (I*2^(1 - d)*EL^6*gAl^2*(gZlL + gZlR)*
    (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
     gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
        (-((-2 + d)*s) + 2*t)))*\[Mu]^(4 - d)*SPList[SP[p1, p2], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
  (I*2^(2 - d)*EL^6*gAl^2*(gZlL + gZlR)*(gZlLC + gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*\[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p1, p3]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) + (I*2^(1 - d)*EL^6*gAl^2*(gZlL + gZlR)*
    (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
     gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
       2*gZuR*gZuRC*(3*s + t)))*\[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p1, q1]])/
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
  (I*2^(1 - d)*EL^6*gAl^2*(gZlL + gZlR)*
    (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
     gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
        (-((-2 + d)*s) + 2*t)))*\[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p2, q1]])/
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) + 
  (I*2^(3 - d)*EL^6*gAl^2*(gZlL + gZlR)*(gZlLC + gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*\[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) - (I*2^(1 - d)*EL^6*gAl^2*(gZlL + gZlR)*
  ...
  (I*2^(1 - d)*EL^6*gAl^2*(gZlL + gZlR)*
    (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
     gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
       2*gZuR*gZuRC*(3*s + t)))*\[Mu]^(4 - d)*SPList[SP[p1, q1], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
  (I*2^(1 - d)*EL^6*gAl^2*(gZlL + gZlR)*((-2 + d)*gZlLC*gZuL*gZuLC - 
     (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
  ...
  (I*2^(1 - d)*EL^6*gAl^2*(gZlL + gZlR)*
    (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
     gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
        (-((-2 + d)*s) + 2*t)))*\[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
  (I*2^(2 - d)*EL^6*gAl^2*(gZlL + gZlR)*(gZlLC + gZlRC)*
    (gZuL*gZuLC + gZuR*gZuRC)*\[Mu]^(4 - d)*SPList[SP[p3, q1], SP[p3, q1]])/
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)))
