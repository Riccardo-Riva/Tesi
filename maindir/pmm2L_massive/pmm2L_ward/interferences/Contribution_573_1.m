...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 ((I*EL^5*gAl*gHll^2*mm^4*s*(aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^4*
   ...
   Pi^(4*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^4*
    (aa*(d*gZlL*gZlR*(2*psq^2 + psq*(3*s - 2*t) + 6*mm^2*(psq - s - t) - 
     ...
     bb*((-2 + d)*gZlL^2*(mm^2*(psq - t) - s*(-psq + s + t)) + 
       ...
       d*gZlL*gZlR*((2*psq + s)*(psq - s - t) + mm^2*(6*psq - 2*(s + 3*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^4*
    (bb*(-(4^(1 + d)*Pi^(2*d)*s*(-(gZlL*gZlR*(mm^2 + psq)) + 
          gZlL^2*(mm^2 - t) + gZlR^2*(mm^2 - t))) + 
       d*(2*Pi)^(2*d)*(2*gZlL^2*s*(mm^2 - t) + 2*gZlR^2*s*(mm^2 - t) + 
         gZlL*gZlR*(psq*(-3*psq + 2*s + 3*t) + mm^2*(-9*psq + 2*s + 9*t)))) - 
     aa*(2*Pi)^(2*d)*(4*s*(2*gZlL*gZlR*mm^2 + gZlL^2*(-psq + t) + 
         gZlR^2*(-psq + t)) + d*(2*gZlL^2*s*(psq - t) + 
         2*gZlR^2*s*(psq - t) + gZlL*gZlR*(3*psq*(-psq + t) + 
           mm^2*(-9*psq + 4*s + 9*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   Pi^(4*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^4*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*s*(bb*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^2*s*
  ...
  (I*EL^5*gAl*gHll^2*mm^4*(bb*(3*(-2 + d)*gZlL^2 - 2*(-1 + d)*gZlL*gZlR + 
       3*(-2 + d)*gZlR^2)*(psq - s - t) + 
     aa*(-2*(-1 + d)*gZlL*gZlR*(2*mm^2 - 3*psq + s + t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
   ...
   Pi^(2*d) + (I*EL^5*gAl*gHll^2*mm^2*
    (aa*(-(gZlL*gZlR*(6*mm^2*s - 4*psq*s + d*psq*s + 
          3*d*mm^2*(psq - s - t))) + (-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gAl*gHll^2*mm^2*
    ...
    SPList[SP[p1, q1], SP[q1, q2]])/(4^(2*d)*Pi^(4*d)) + 
  (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
    (bb*(2*Pi)^(2*d)*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - 
     ...
     aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) + 
       ...
       4^d*gZlL*gZlR*Pi^(2*d)*(-4*s*(mm^2 - 4*psq + s + t) + 
         d*(psq^2 + mm^2*(3*psq - s - 3*t) + s*(s + t) - psq*(4*s + t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(4*d) + 
  (I*EL^5*gAl*gHll^2*mm^4*(bb*((-2 + d)*gZlL^2 - d*gZlL*gZlR + 
       (-2 + d)*gZlR^2)*(psq - s - t) + 
  ...
  (I*EL^5*gAl*gHll^2*mm^4*
    (aa*(gZlL*gZlR*(d*(-3*mm^2 + 5*psq + s - 2*t) - 2*(psq + 5*s - t)) + 
       ...
       (-2 + d)*gZlR^2*(2*mm^2 + psq - 3*t) - 
       gZlL*gZlR*((-4 + d)*mm^2 + (2 + d)*psq - 10*s + d*s + 2*t - 2*d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll^2*mm^4*(bb*((-2 + d)*gZlL^2*(mm^2 + psq - s - 2*t) + 
       (-2 + d)*gZlR^2*(mm^2 + psq - s - 2*t) + d*gZlL*gZlR*
        (-2*mm^2 + s + 2*t)) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*((-2 + d)*gZlL^2 - d*gZlL*gZlR + 
  ...
  (I*EL^5*gAl*gHll^2*mm^4*(bb*(3*(-2 + d)*gZlL^2*(mm^2 - t) + 
       3*(-2 + d)*gZlR^2*(mm^2 - t) - 2*(-1 + d)*gZlL*gZlR*
        (2*mm^2 - psq - t)) - aa*(3*(-2 + d)*gZlL^2 - 2*(-1 + d)*gZlL*gZlR + 
       3*(-2 + d)*gZlR^2)*(psq - t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*(aa*mm^2*(2*Pi)^(2*d)*(2*(-4 + d)*gZlL*gZlR*s + 
       (-2 + d)*gZlL^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*
        (2*psq - s - 2*t)) + 
     bb*(-(4^d*(-4 + d)*gZlL*gZlR*Pi^(2*d)*(mm^2 + psq)*s) - 
       (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) - 
       (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q2]])/(4^(2*d)*Pi^(4*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*
   ...
   (4^(2*d)*Pi^(4*d)) + (I*(aa - bb)*EL^5*gAl*gHll^2*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*
    (-(bb*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*(psq - t) + 
        gZlL*gZlR*(2*s*(-2*mm^2 + psq + t) + d*psq*(-psq + s + t) + 
          d*mm^2*(-3*psq + s + 3*t)))) + aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + 
       (-2 + d)*gZlR^2*mm^2*(psq - t) + gZlL*gZlR*(d*psq*(-psq + t) + 
         2*s*(-psq + t) + d*mm^2*(-3*psq + 2*s + 3*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*s*
    (bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*s*
   ...
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*((-2 + d)*gZlL^2 - 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(psq - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(2*s + d*(psq - s - t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
    ((-2 + d)*gZlL^2 - 2*(-4 + d)*gZlL*gZlR + (-2 + d)*gZlR^2)*mm^4*
  ...
  (I*2^(1 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) - (I*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(psq - t)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*
    gZlR*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*
  ...
  (I*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
     ...
     SP[q2, q2]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*bb*(-4 + d)*EL^5*gAl*gHll^2*
    gZlL*gZlR*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
     ...
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*
    gZlR*mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[q2, q2]])/Pi^(2*d) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[q2, q2]])/(4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(2*s + d*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*bb*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[p3, q1]])/
   Pi^(2*d) - (I*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     SP[q1, q1]])/(4^d*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl*gHll^2*gZlL*gZlR*
