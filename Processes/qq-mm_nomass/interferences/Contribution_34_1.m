...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mz], 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mz], 
   ...
   (((-I)*EL^6*gAl^2*gAu^2*(s + t)*
    ...
    (I*EL^6*gAl^2*gAu^2*(s + t)^2*(gZlR*gZuL*(-((-4 + d)*s) + 2*t) + 
      ...
      (-(gZlR*(d*gZuR*(2*Pi)^d*(s^2 + t^2) - 2^(1 + d)*gZuR*Pi^d*
       ...
       gZlL*(d*gZuR*(2*Pi)^d*(s^2 + t^2) - 2^(1 + d)*gZuR*Pi^d*
          (s^2 - (-2 + d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
           2^(1 + d)*Pi^d*(2*s^2 - (-4 + d)*s*t + 2*t^2))))*(-1 + GaugeXi[Q])*
    ...
    (I*4^(1 - d)*EL^6*gAl^2*gAu^2*t*(s + t)*
      (gZlR*(-(2^(1 + d)*gZuL*Pi^d) + 2^(2 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
       ...
       2^(1 + d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
         (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*Pi^d*GaugeXi[Q] + 
    ...
    (I*2^(3 - 2*d)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)*(gZuL + gZuR)*
    ...
    (I*EL^6*gAl^2*gAu^2*(s + t)*
      ...
      (-1 + GaugeXi[Q])) - (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*t*
      (gZlR*gZuR*(2^(1 + d)*(-2 + d)*Pi^d*s + d*(2*Pi)^d*t) - 
       gZlR*gZuL*(2^(1 + d)*Pi^d*((-4 + d)*s - 3*t) + d*(2*Pi)^d*t) + 
       gZlL*(gZuL*(2^(1 + d)*(-2 + d)*Pi^d*s + d*(2*Pi)^d*t) - 
         gZuR*(2^(1 + d)*Pi^d*((-4 + d)*s - 3*t) + d*(2*Pi)^d*t)) - 
       2^(1 + d)*Pi^d*(gZlL*(2*(-2 + d)*gZuL*s - 2*(-4 + d)*gZuR*s + 
           d*gZuL*t - (-6 + d)*gZuR*t) + gZlR*(-2*(-4 + d)*gZuL*s + 
           2*(-2 + d)*gZuR*s - (-6 + d)*gZuL*t + d*gZuR*t))*GaugeXi[Q] + 
       (gZlR*gZuR*(2^(1 + d)*(-2 + d)*Pi^d*s + d*(2*Pi)^d*t) - 
         gZlR*gZuL*(2^(1 + d)*Pi^d*((-4 + d)*s - 3*t) + d*(2*Pi)^d*t) + 
         gZlL*(gZuL*(2^(1 + d)*(-2 + d)*Pi^d*s + d*(2*Pi)^d*t) - 
           gZuR*(2^(1 + d)*Pi^d*((-4 + d)*s - 3*t) + d*(2*Pi)^d*t)))*
     ...
     (mz^2*Pi^(2*d)*s*(-1 + GaugeXi[Q])) + 
    (I*4^(1 - d)*EL^6*gAl^2*gAu^2*(gZlL*(-(d*gZuL*(2*Pi)^d*s^2) + 
         d*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*(-2*s^2 + t^2) + 
         2^(1 + d)*gZuL*Pi^d*(s^2 + t^2)) + gZlR*(d*gZuL*(2*Pi)^d*s^2 - 
         d*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuL*Pi^d*(-2*s^2 + t^2) + 
         2^(1 + d)*gZuR*Pi^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
       ...
       (gZlL*(-(d*gZuL*(2*Pi)^d*s^2) + d*gZuR*(2*Pi)^d*s^2 + 
           ...
           2^(1 + d)*gZuL*Pi^d*(-2*s^2 + t^2) + 2^(1 + d)*gZuR*Pi^d*
            (s^2 + t^2)))*GaugeXi[Q]^2)*SPList[SP[p2, q1], SP[p3, q1], 
    ...
    (I*EL^6*gAl^2*gAu^2*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
         2^(1 + d)*gZuR*Pi^d*(s - d*s + (7 - 2*d)*t) + 2^(1 + d)*gZuL*Pi^d*
          ((-2 + d)*s + (-5 + 2*d)*t)) + gZlL*(d*gZuL*(2*Pi)^d*s - 
         d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(s - d*s + (7 - 2*d)*t) + 
         2^(1 + d)*gZuR*Pi^d*((-2 + d)*s + (-5 + 2*d)*t)) + 
       2*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*Pi^d*
        ...
        GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           2^(1 + d)*gZuR*Pi^d*(s - d*s + (7 - 2*d)*t) + 2^(1 + d)*gZuL*Pi^d*
            ((-2 + d)*s + (-5 + 2*d)*t)) + gZlL*(d*gZuL*(2*Pi)^d*s - 
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(s - d*s + (7 - 2*d)*t) + 
           2^(1 + d)*gZuR*Pi^d*((-2 + d)*s + (-5 + 2*d)*t)))*GaugeXi[Q]^2)*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   ((I*EL^6*gAl^2*gAu^2*(s + t)^2*(gZlR*gZuL*(-((-4 + d)*s) + 2*t) + 
    ...
    (I*EL^6*gAl^2*gAu^2*(s + t)*(gZlR*gZuL*(-((-4 + d)*s) + 2*t) + 
       gZlL*gZuR*(-((-4 + d)*s) + 2*t) + gZlL*gZuL*((-2 + d)*s + 2*t) + 
       gZlR*gZuR*((-2 + d)*s + 2*t))*(-1 + GaugeXi[Q])*
    ...
    (I*EL^6*gAl^2*gAu^2*(s + t)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
       ...
       SP[q1, q1]])/(mz^2*(2*Pi)^d) - (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
      (-(gZlR*(d*gZuR*(2*Pi)^d*(s^2 + t^2) - 2^(1 + d)*gZuR*Pi^d*
           (2*s^2 - (-4 + d)*s*t + 2*t^2) + gZuL*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
            2^(1 + d)*Pi^d*(s^2 - (-2 + d)*s*t + t^2)))) + 
       gZlL*(d*gZuR*(2*Pi)^d*(s^2 + t^2) - 2^(1 + d)*gZuR*Pi^d*
