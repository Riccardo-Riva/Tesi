...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (((-I)*4^(-1 - d)*(aa - bb)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*s*
    (6*(-1 + d)*psq + (-1 + 4*d)*s)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d))/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    mm^2*(12*(-1 + d)*psq + (-11 + 17*d)*s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/Pi^(2*d) - ((3*I)*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*
    EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    ...
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*gWWA^2*
    gWWZ*(gZlL + gZlR)*mm^2*(24*(-1 + d)*psq^2 - 
     2*psq*((-7 + d)*s + 12*(-1 + d)*t) - s*(3*(2 + d)*s + 2*(t + 5*d*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  ((3*I)*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    (bb*((-13 + 7*d)*psq^2 + (1 - 4*d)*s*t + 
       mm^2*((-3 + 7*d)*psq + 13*s - 6*d*s + 3*t - 7*d*t) + 
       psq*(-14*s + 6*d*s + 13*t - 7*d*t)) + 
     aa*((-19 + 5*d)*psq^2 + (-1 + 4*d)*s*t + 
       psq*(-4*s + 6*d*s - 13*t + 7*d*t) + mm^2*((35 - 19*d)*psq + 5*s - 
         6*d*s - 3*t + 7*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   Pi^(2*d) - (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*
    (24*(-1 + d)*psq^2 - 2*psq*((-7 + d)*s + 12*(-1 + d)*t) - 
     s*((-4 + 7*d)*s + 2*(t + 5*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
   ...
   Pi^(2*d) - ((3*I)*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/Pi^(2*d) + (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    (bb*(-12*psq^2 + 3*mm^2*s + d*psq*(2*psq + s - 2*t) + 3*psq*(s + 4*t) + 
       ...
       d*psq*(-2*psq + 3*s + 2*t) + 3*(4*psq^2 + mm^2*s - 3*psq*s - 
         4*psq*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
  ...
  ((9*I)*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
  ...
  ((3*I)*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*((38 - 10*d)*psq^2 + mm^2*((-70 + 38*d)*psq - 43*s + 32*d*s + 6*t - 
         14*d*t) + psq*(23*s - 21*d*s + 26*t - 14*d*t) - 
       s*(s - 20*t + 19*d*t)) + bb*((26 - 14*d)*psq^2 + 
       psq*(49*s - 25*d*s - 26*t + 14*d*t) + 
       mm^2*((6 - 14*d)*psq - 29*s + 14*d*s - 6*t + 14*d*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*(20*(-2 + d)*psq^2 - (-14 + 15*d)*s*(s + 2*t) + 
  ...
  ((3*I)*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
  ...
  ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
  ...
  ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
   ...
   (4^d*Pi^(2*d)) + (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    ...
    SPList[SP[p1, q1], SP[p1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    (bb*((10 - 6*d)*mm^2 - 18*psq + 11*d*psq + 9*s - 5*d*s + 8*t - 5*d*t) + 
     aa*((8 - 5*d)*psq - 9*s + 5*d*s - 8*t + 5*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/Pi^(2*d) + 
  (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*s*(aa*(9*psq - 7*s - 9*t) + 
  ...
  (I*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*((38 - 10*d)*psq^2 + 26*psq*t - 7*d*psq*(s + 2*t) + 
       2*mm^2*((-35 + 19*d)*psq + 3*d*s + 3*t - 7*d*t) - s*(2*s + 7*d*t)) + 
     bb*((26 - 14*d)*psq^2 - 2*mm^2*((-3 + 7*d)*psq - 8*(-2 + d)*s + 
         (3 - 7*d)*t) + s*(2*s + 7*d*t) + 
       psq*((32 - 15*d)*s + 2*(-13 + 7*d)*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I/4)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    ...
    (aa*(20*(-2 + d)*psq^2 + (34 - 4*d)*psq*s + 3*(-6 + d)*s^2 - 
      ...
      bb*(-20*(-2 + d)*psq^2 + (-58 + 20*d)*psq*s - 3*(-6 + d)*s^2 + 
        20*(-2 + d)*psq*t + 2*(10 + d)*s*t + mm^2*((24 - 44*d)*psq + 6*s + 
          10*d*s - 24*t + 44*d*t)))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, q2], SP[p3, q1]] - ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*
  ...
  (I*4^(-1 - d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*((38 - 10*d)*psq^2 - 7*d*s*t + psq*(6*s - 11*d*s + 26*t - 14*d*t) + 
       2*mm^2*((-35 + 19*d)*psq - 3*s + 5*d*s + 3*t - 7*d*t)) + 
     bb*((26 - 14*d)*psq^2 + 7*d*s*t - 2*mm^2*((-3 + 7*d)*psq + 13*s - 
         6*d*s + 3*t - 7*d*t) + psq*(26*s - 11*d*s - 26*t + 14*d*t)))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    SPList[SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - (I/4)*EL^5*gAl*gWWA^2*gWWZ*
   (gZlL + gZlR)*(-((2^(1 - 2*d)*(aa - bb)*(-2 + d)*s*(-2*psq + s + 2*t))/
      Pi^(2*d)) + (bb*(-20*(-2 + d)*psq^2 + 2*(-23 + 6*d)*psq*s + 
        (2 + 5*d)*s^2 + 20*(-2 + d)*psq*t + 2*(10 + d)*s*t + 
        mm^2*((24 - 44*d)*psq - 6*s + 18*d*s - 24*t + 44*d*t)) + 
      aa*(20*(-2 + d)*psq^2 + psq*((22 + 4*d)*s - 20*(-2 + d)*t) + 
        mm^2*(4*(-6 + 11*d)*psq + 30*s - 34*d*s + 24*t - 44*d*t) - 
        s*((2 + 5*d)*s + 2*(10 + d)*t)))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p2, q2], SP[p3, q1]] - ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*
    gWWZ*(gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)) - ((5*I)*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWWA^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
   ...
   Pi^(2*d) - (I*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
  ...
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*((-3 + 2*d)*mm^2 - 15*psq + 9*d*psq + 19*s - 11*d*s + 18*t - 
     ...
     SP[p1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*(aa*((-33 + 20*d)*mm^2 + 15*psq - 9*d*psq - s + 18*t - 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*
  ...
  (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*((-3 + 2*d)*mm^2 - 13*psq + 8*d*psq + 17*s - 10*d*s + 16*t - 
     ...
     SP[p1, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*(aa*((-8 + 5*d)*psq + 9*s - 5*d*s + 8*t - 5*d*t) + 
     bb*(2*(-5 + 3*d)*mm^2 + 18*psq - 11*d*psq - 9*s + 5*d*s - 8*t + 5*d*t))*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
  ...
  (I*4^(1 - d)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(-5 + 3*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
  ...
  (I*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*
  ...
  ((5*I)*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
  ...
  (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
  ...
  (I*4^(1 - d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q2]])/Pi^(2*d) + (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*((-8 + 5*d)*psq + 9*s - 5*d*s + 8*t - 5*d*t) + 
     bb*(2*(-5 + 3*d)*mm^2 + 18*psq - 11*d*psq - 9*s + 5*d*s - 8*t + 5*d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/
   (2*Pi)^(2*d) + (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*((-8 + 5*d)*psq + 9*s - 5*d*s + 8*t - 5*d*t) + 
     bb*(2*(-5 + 3*d)*mm^2 + 18*psq - 11*d*psq - 9*s + 5*d*s - 8*t + 5*d*t))*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (2*Pi)^(2*d) + (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*(9*psq - 7*s - 9*t) + bb*(10*mm^2 - 19*psq + 7*s + 9*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/
   (4^d*Pi^(2*d)) + (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*((-8 + 5*d)*psq + 9*s - 5*d*s + 8*t - 5*d*t) + 
     bb*(2*(-5 + 3*d)*mm^2 + 18*psq - 11*d*psq - 9*s + 5*d*s - 8*t + 5*d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*(-5 + 3*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(aa*(9*psq - 7*s - 9*t) + 
     bb*(10*mm^2 - 19*psq + 7*s + 9*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(bb*(9*psq - 2*s - 9*t) + 
  ...
  (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (2*Pi)^(2*d) - (I*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
  ((5*I)*(aa - bb)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
  ...
  (I*(aa - bb)*(-5 + 3*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
