...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*s*(-psq + s + t)*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*ggmgmA^3*s*(bb*(psq - s - t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl^2*ggmgmA^3*s*(bb*(psq - s - t) + 
      ...
      SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*mm^2*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA^3*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^2*ggmgmA^3*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
