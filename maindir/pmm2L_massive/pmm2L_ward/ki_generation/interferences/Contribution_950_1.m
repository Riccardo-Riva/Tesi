...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, mm]]*((I*2^(1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*mm^4*
       s*(aa*((-2 + d)*mm^2 + (2 + d)*psq - d*(s + 2*t)) + 
        bb*((-2 + d)*mm^2 + (2 - 3*d)*psq + d*(s + 2*t)))*\[Mu]^(8 - 2*d))/
      (mz^2*Pi^(2*d)) + (I*2^(1 - 4*d)*EL^5*gAl^3*(gZlL + gZlR)^2*mm^2*
     ...
     (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*mm^2*s*
     ...
     (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*mm^2*
     ...
     (I*4^(1 - d)*EL^5*gAl^3*
       ...
       gAl^3*(gZlL + gZlR)^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     ...
     (I*2^(3 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*s*(bb*(psq - s - t) + 
       ...
       (gZlL + gZlR)^2*mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
     ...
     (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*mm^2*
   ...
   PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, mm]]*(((-I)*2^(1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*
       mm^4*s*(aa*((-2 + d)*mm^2 + (2 + d)*psq - d*(s + 2*t)) + 
        bb*((-2 + d)*mm^2 + (2 - 3*d)*psq + d*(s + 2*t)))*\[Mu]^(8 - 2*d))/
      (mz^2*Pi^(2*d)) - (I*2^(1 - 4*d)*EL^5*gAl^3*(gZlL + gZlR)^2*mm^2*
       (-(2^(1 + 2*d)*aa*Pi^(2*d)*s*(2*mm^2 - 3*psq + s + t)) + 
        2^(1 + 2*d)*bb*Pi^(2*d)*s*(-psq + s + t) + aa*d*(2*Pi)^(2*d)*
