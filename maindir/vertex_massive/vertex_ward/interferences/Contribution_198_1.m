...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((I*2^(1 - 2*d)*(aa - bb)*EL^5*gWWA*gXFW^2*gXll^2*mm^4*(4*psq - s)*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gWWA*gXFW^2*gXll^2*mm^2*s*
      ...
      SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWWA*
      gXFW^2*gXll^2*mm^4*(8*psq - 3*s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWWA*gXFW^2*gXll^2*mm^2*
      (8*mm^2 + 4*psq - s)*s*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gWWA*
      gXFW^2*gXll^2*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gWWA*
      gXFW^2*gXll^2*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gWWA*
      gXFW^2*gXll^2*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWWA*
      gXFW^2*gXll^2*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gWWA*gXFW^2*gXll^2*
    ...
    (I*2^(3 - 2*d)*EL^5*gWWA*gXFW^2*gXll^2*mm^2*s*(bb*(psq - s - t) + 
       ...
       SP[p3, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gWWA*gXFW^2*gXll^2*mm^2*s*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*EL^5*gWWA*gXFW^2*gXll^2*mm^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gWWA*gXFW^2*gXll^2*mm^2*s*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gWWA*gXFW^2*gXll^2*mm^2*s*
      (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
     Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gWWA*gXFW^2*gXll^2*mm^2*s*
     ...
     Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gWWA*gXFW^2*gXll^2*mm^2*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
