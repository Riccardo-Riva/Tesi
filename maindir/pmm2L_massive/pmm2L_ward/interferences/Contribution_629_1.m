...
PropList[KiraPropagator[p3 - q1, 0], KiraPropagator[-q1 - q2, mw], 
 ...
 ((I*EL^5*gAl*gFll^2*gZlR^2*mm^2*(mm^2 - psq)*psq*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gFll^2*gZlR*mm^2*
    (mm^2 - psq)*(4*gZlL*mm^2*s + d*(2*gZlL*mm^2 - gZlR*(mm^2 + psq))*
      (psq - s - t) + 2*gZlR*(psq^2 + mm^2*(psq - s - t) + s*(s + t) - 
       psq*(4*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFll^2*gZlR*mm^2*
    (mm^2 - psq)*(4*gZlL*mm^2*s + d*(2*gZlL*mm^2 - gZlR*(mm^2 + psq))*
      (psq - s - t) + 2*gZlR*(psq^2 + mm^2*(psq - s - t) + s*(s + t) - 
       psq*(4*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*mm^2*psq*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*mm^2*
    (bb*(-2 + d)*gZlL^2*mm^2*(psq - s - t) + aa*(-2 + d)*gZlL^2*mm^2*
      (2*mm^2 - 3*psq + s + t) + bb*gZlR^2*((-2 + d)*mm^4 + 
       mm^2*(-2*(-2 + d)*psq + 2*s) + psq*((-4 + d)*s + (-2 + d)*t)) - 
     aa*gZlR^2*((-2 + d)*mm^4 + 2*mm^2*s + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFll^2*gZlR*mm^2*(4*gZlL*mm^2*s + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*mm^2*
    (gZlL^2*mm^2 - gZlR^2*psq)*(bb*(psq - s - t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFll^2*gZlR*mm^2*(4*gZlL*mm^2*s + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*psq*
    (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*mm^2*
    (bb*(-2 + d)*gZlL^2*mm^2*(2*mm^2 - psq - t) - aa*(-2 + d)*gZlL^2*mm^2*
      (psq - t) + bb*gZlR^2*(-((-2 + d)*mm^4) - 2*mm^2*s + 2*psq*s + 
       (-2 + d)*psq*t) + aa*gZlR^2*((-2 + d)*mm^4 + 
  ...
  (I*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*psq*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl*gFll^2*gZlR*mm^2*(2*bb*gZlR*(mm^2 + 2*psq)*(psq - s - t) + 
     aa*d*(gZlR*mm^2*(psq - t) + 2*gZlR*psq*(psq - s - t) + 
       gZlL*mm^2*(-2*psq + s + 2*t)) + bb*d*(gZlL*mm^2*(2*psq - s - 2*t) + 
       gZlR*mm^2*(-psq + s + t) + gZlR*psq*(-2*psq + s + 2*t)) + 
     2*aa*gZlR*(mm^2*(-psq + t) + psq*(-2*psq + 3*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gFll^2*gZlR*mm^2*
    (2*aa*gZlR*(mm^2*(psq - t) + psq*(psq - s - t)) + 
     2*bb*gZlR*(psq*(-psq + t) + mm^2*(-psq + s + t)) + 
     aa*d*(gZlL*mm^2*(2*psq - s - 2*t) + gZlR*mm^2*(-psq + t) + 
       gZlR*psq*(-psq + s + t)) + bb*d*(gZlR*psq*(psq - t) + 
       gZlR*mm^2*(psq - s - t) + gZlL*mm^2*(-2*psq + s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gZlR^2*mm^2*psq*
  ...
  (I*(aa - bb)*EL^5*gAl*gFll^2*gZlR*mm^2*(-4*gZlL*mm^2*s + 
     ...
     2*gZlR*(psq^2 + psq*s + mm^2*(psq - t) - psq*t + s*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*mm^2*(gZlL^2*mm^2 - gZlR^2*psq)*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*psq*(bb*(2*mm^2 - psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) + 2*d*gZlL*gZlR*mm^2*
        (2*psq - s - 2*t) + gZlR^2*(psq*(-((-2 + d)*psq) - (-4 + d)*s + 
           (-2 + d)*t) + mm^2*(-((-2 + d)*psq) + 2*(-3 + d)*s + 
           (-2 + d)*t))) + aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 
  ...
  (I*EL^5*gAl*gFll^2*gZlR*mm^2*(2*bb*gZlR*(psq*(2*psq + s - 2*t) + 
       mm^2*(psq - s - t)) - 2*aa*gZlR*(mm^2 + 2*psq)*(psq - t) + 
     bb*d*(gZlL*mm^2*(2*psq - s - 2*t) + 2*gZlR*psq*(-psq + t) + 
       gZlR*mm^2*(-psq + s + t)) + aa*d*(gZlR*psq*(2*psq - s - 2*t) + 
       gZlR*mm^2*(psq - t) + gZlL*mm^2*(-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFll^2*gZlR^2*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*
    (bb*((-2 + d)*mm^2 + 4*s - d*s + 2*t - d*t) + 
     aa*((-2 + d)*mm^2 + 4*psq - 2*d*psq - 4*s + d*s - 2*t + d*t))*
  ...
  (I*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*(bb*(psq - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFll^2*gZlR^2*mm^2*(bb*((-2 + d)*mm^2 - 2*s + 2*t - d*t) + 
     aa*((-2 + d)*mm^2 + 4*psq - 2*d*psq + 2*s - 2*t + d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, q2]])/(4^d*Pi^(2*d)) - 
  ...
  (I*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*(bb*(2*mm^2 - s - 2*t) + 
     aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*
    ...
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[p3, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*(bb*(2*mm^2 - psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*
    gZlR^2*mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*(bb*(2*mm^2 - psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) + (I*(-2 + d)*EL^5*gAl*gFll^2*gZlR^2*mm^2*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
