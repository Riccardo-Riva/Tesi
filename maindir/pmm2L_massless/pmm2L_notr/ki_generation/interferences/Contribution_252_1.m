...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-2 + d)*s^2 + 2*s*t + 2*t^2)*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (2^(3 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*gWlN*
    gWNl*gWWA*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/Pi^(2*d) + (4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
    ((-2 + d)*s^2 - 6*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
    ((-3 + d)*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/Pi^(2*d) + (4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
    (d*s^2 - 2*t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
    ((-2 + d)*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-7 + 3*d)*s^2 + 4*s*t + 
     4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/Pi^(2*d) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*
    gWWA*((2 - 3*d + d^2)*s^2 + 2*(2 + d)*s*t + 2*(2 + d)*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-3 + d)*s^2 + 4*s*t + 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*
    gWNl*gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(d*s^2 + 4*t*(3*s + 2*t))*
  ...
  (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/Pi^(2*d) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-4 + d)*s^2 + 4*s*t + 8*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(Pi^(2*d)*s) - 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(30 - 11*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
  ...
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-6 + d)*s - 4*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-2 + d)*s + 4*t)*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((18 - 7*d + d^2)*s^2 + 
     2*d*s*t + 2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
    ((-2 + 3*d)*s^2 + 12*s*t + 8*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-6 + d)*s - 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((18 - 8*d + d^2)*s^2 + 
     2*(-2 + d)*s*t + 2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(3*(-2 + d)*s^2 + 12*s*t + 
     8*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((4 - 8*d + d^2)*s - 
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((14 - 7*d + d^2)*s^2 + 
     2*(-4 + d)*s*t + 2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(3*(-2 + d)*s^2 + 4*s*t + 8*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-28 + d^2)*s + 8*(-4 + d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-2 + d)*s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((28 - 20*d + 3*d^2)*s + 4*(-6 + d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/((2*Pi)^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((40 - 22*d + 3*d^2)*s + 
  ...
  (2^(3 - 2*d)*(20 - 10*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
  (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(18 - 9*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(92 - 36*d + 3*d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
  ...
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*(-6 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*(-6 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*(24 - 10*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
   ...
   (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1]])/
   (Pi^(2*d)*s) - (4^(2 - d)*(-6 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*t*
   ...
   (Pi^(2*d)*s) + (4^(2 - d)*(24 - 10*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*
   ...
   (Pi^(2*d)*s) - (2^(3 - 2*d)*(18 - 9*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*
    gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p1, q1]])/
   (Pi^(2*d)*s) - (4^(2 - d)*(30 - 11*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*
   ...
   (Pi^(2*d)*s) + (4^(2 - d)*(-6 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(18 - 9*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*
    gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) - (4^(2 - d)*(-6 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s + t)*
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s + t)*
   ...
   (Pi^(2*d)*s^2) - (4^(2 - d)*(30 - 11*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s + t)*
   ...
   (Pi^(2*d)*s^2) - (4^(2 - d)*(-6 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*t*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*t*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*t*\[Mu]^(8 - 2*d)*
