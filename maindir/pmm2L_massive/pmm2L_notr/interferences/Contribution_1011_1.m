...
PropList[KiraPropagator[-q1, mm], KiraPropagator[-q1 - q2, mw], 
 ...
 (((-2 + d)*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(psq - s)*
  ...
  ((-2 + d)*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(-2*(2 + d)*psq^2 + 
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(psq - s)*
  ...
  ((-2 + d)*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(2*(-2 + d)*mm^2 + 4*psq - 
     10*s + 3*d*s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   ((2*Pi)^(2*d)*s) - (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*
    gWWA*(psq - s)*(-2*mm^2 + psq + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(psq - s)*
  ...
  ((-2 + d)*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(2*(-2 + d)*mm^2 - 4*psq - 
   ...
   ((2*Pi)^(2*d)*s) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (psq - s)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    ((-2 + d)*psq^2 - (-2 + d)*mm^2*(psq - 2*s - t) + 2*psq*t - 
     d*psq*(s + t) + 2*s*((-2 + d)*s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  ((-2 + d)*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(2*(-2 + d)*mm^2 + 
  ...
  (4^(2 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(-mm^2 + psq)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    ...
    gWlN^2*gWNl^2*gWWA*(-3*mm^2 + 2*psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (-2*psq + 5*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*(-4*mm^2 + 2*psq + 5*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (3*mm^2 - 4*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (-2*mm^2 + psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
  ...
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(psq - t)*
   ...
   (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], 
     SP[p3, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*
    gWNl^2*gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
   ...
   (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    ...
    gWlN^2*gWNl^2*gWWA*(-2*mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(psq - 2*s - t)*
  ...
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(-mm^2 + psq + s)*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    ...
    gWlN^2*gWNl^2*gWWA*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(-psq + 2*s + t)*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(psq - t)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (-2*mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p3, p3]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*(-2*mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(psq - 2*s - t)*
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(-psq + s + t)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*(2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
     SP[p3, q2]])/(Pi^(2*d)*s) - (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*
    gWNl^2*gWWA*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (-2*mm^2 + psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*(4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*(psq - t)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*gWNl^2*gWWA*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*
    gWlN^2*gWNl^2*gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN^2*
    gWNl^2*gWWA*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], SP[q2, q2]])/
