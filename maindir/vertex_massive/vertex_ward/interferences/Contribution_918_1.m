...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
  ...
  ((2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
   ...
   (EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*(bb*mm^2*(mm^2 + 2*psq - 2*s) + 
    ...
    (mz^2*(2*Pi)^(2*d)) - (EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*
   ...
   (EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*(mm^2 + psq)*(mm^2 - 2*s) - 
      bb*(mm^4 + mm^2*(psq - 3*s) - psq*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*s*
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*s*
   ...
   (2^(-1 - 2*d)*(aa + bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) - (2^(-1 - 2*d)*(aa + bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)) - (2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 + psq)*
    ...
    (mz^2*Pi^(2*d)) + ((aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/
    (mz^2*Pi^(2*d)) + (2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (2*aa*(mm^2 + psq) - bb*(3*mm^2 + psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/(mz^2*Pi^(2*d)) - 
   (4^(1 - d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
   ...
   ((aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 + psq)*
    ...
    (mz^2*(2*Pi)^(2*d)) + (4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*
    ...
    (mz^2*(2*Pi)^(2*d)) - (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmZ*
