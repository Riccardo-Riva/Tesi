...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-4*psq^3 + (-2 + d)^2*mm^4*s + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-2*(-4 + d)*psq^2 + 
      2*(-6 + d)*s^2 - (-8 + d)*psq*(d*s - 2*t) + 8*t^2 + 
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
   ...
   (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-2 + d)*psq^3 + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-1 + d)*psq^2 + 10*s^2 - 
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-4*psq + (8 - 6*d + d^2)*s + 4*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-((2 + d)*psq^2) + 
      (-6 + 4*d)*psq*s - 2*(-2 + d)*s^2 + (6 + d)*psq*t - 6*s*t - 4*t^2 + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(8*s + d^2*s - 
      2*d*(psq + 3*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-1 + d)*psq^2 + 8*s^2 - 
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (4*psq^2 + 2*(-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
      ...
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     ((-2 + d)*mm^2 - 2*(-3 + d)*psq - 3*s + d*s - 4*t + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(20 - 10*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-psq + s + t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*(-2 + d)*mm^2 - 
      4*(-2 + d)*psq - (24 - 12*d + d^2)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*mm^2 - 4*psq + s)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq - 3*s - 2*t)*
   ...
   (4^(3 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((-2 + d)*mm^2 - 2*psq + s + 4*t - 
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*(-2 + d)*psq + 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(20 - 10*d + d^2)*EL^8*gAl^4*gAu^2*gXll^2*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*psq + s - 2*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*(-2 + d)*psq + (-4 + d)^2*s - 
      2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(3 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
     gXll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q2]])/
