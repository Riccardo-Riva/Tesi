...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
 ...
 ((I*(aa + bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*(mm^2 - psq)*s^2*
    \[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*s*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*s*(bb*(2*mm^2 - psq - s - t) + 
     aa*(4*mm^2 - 5*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-aa + bb)*EL^5*gAl*ggmgmA^2*
    gHgmgm*gHll*mm^2*s*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   Pi^(2*d) + (I*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*s*
  ...
  (I*(aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*(psq - s - t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*
   ...
   Pi^(2*d) + (I*(-aa + bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*(psq - t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*ggmgmA^2*gHgmgm*gHll*mm^2*\[Mu]^(8 - 2*d)*
