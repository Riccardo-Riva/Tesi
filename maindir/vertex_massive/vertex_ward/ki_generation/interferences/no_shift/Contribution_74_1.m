...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((4^(1 - d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*s*
   ...
   (4^(1 - d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*
     ...
     SPList[SP[p1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*
     s*(2*aa*(psq^2 + mm^2*(3*psq - s)) + 
      bb*(mm^2*(-6*psq + s) + psq*(-2*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/Pi^(2*d) + (4^(1 - d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*
     (-2*aa*(psq^2 + mm^2*(3*psq - s)) + 
      bb*(psq*(2*psq - s) + mm^2*(6*psq - s)))*s*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gFFA*gHFW^2*gHll^2*mm^2*
     s*(2*aa*(psq^2 + mm^2*(3*psq - s)) + 
      bb*(mm^2*(-6*psq + s) + psq*(-2*psq + s)))*\[Mu]^(8 - 2*d)*
