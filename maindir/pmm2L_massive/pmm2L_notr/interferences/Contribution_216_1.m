...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (5*2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(-5*psq + 6*s + 5*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (5*2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(5*psq + 2*s - 5*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (5*2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(-5*psq + 7*s + 5*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(-psq + s + t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(5*psq + s - 5*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (5*2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(psq - t)*
