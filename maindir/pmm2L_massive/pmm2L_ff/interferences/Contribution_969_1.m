...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*mm^2*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*ml^2*
      (-(d*(psq - s - t)*(4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*mm^2*(-2*gZlL^3*gZlR*s*(4*psq^2 - 3*psq*s + s^2 - 
         8*psq*t + 5*s*t + 4*t^2) - 2*gZlL*gZlR^3*s*(4*psq^2 - 3*psq*s + 
         s^2 - 8*psq*t + 5*s*t + 4*t^2) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*ml^2*
      (2*(gZlL^2 + gZlR^2)*(2*psq^3 + mm^2*psq*s + psq^2*(s - 6*t) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*mm^2*(2*gZlL^3*gZlR*s*(4*psq^2 + t*(3*s + 4*t) - 
       ...
       gZlR^4*(psq - t)*((8 - 7*d + d^2)*psq^2 + (4 - 5*d + d^2)*mm^2*
        ...
        ((16 - 7*d + d^2)*psq^2 + (8 - 5*d + d^2)*mm^2*(psq - t) - 
         2*(-4 + d)*t*(s + t) - psq*((8 - 5*d + d^2)*s + (24 - 9*d + d^2)*
            t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*ml^2*
      ...
      (-2*gZlL^3*gZlR*s^2*(-2*psq + s + 2*t) - 2*gZlL*gZlR^3*s^2*
        (-2*psq + s + 2*t) + 2*gZlL^2*gZlR^2*(2*(8 - 6*d + d^2)*psq^3 + 
         (8 - 5*d + d^2)*mm^2*s*t - psq^2*((16 - 11*d + 2*d^2)*s + 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*(psq^2 - 2*psq*t + t*(s + t))*
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*
      (gZlL^2 + gZlR^2)*ml^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*(-4*gZlL^3*gZlR*mm^2*s*(-psq + s + t) - 
       4*gZlL*gZlR^3*mm^2*s*(-psq + s + t) - 2*gZlL^2*gZlR^2*
        (4*mm^4*(psq - s - t) - 2*(-4 + d)*psq*(psq^2 - 2*psq*t + 
           t*(s + t)) + mm^2*(2*(-7 + d)*psq^2 + psq*(-((-12 + d)*s) - 
             4*(-6 + d)*t) + (s + t)*((-6 + d)*s + 2*(-5 + d)*t))) + 
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*
      (-2*gZlL^3*gZlR*mm^2*s*(-2*psq + s + 2*t) - 2*gZlL*gZlR^3*mm^2*s*
        (-2*psq + s + 2*t) + gZlL^4*((4 - 5*d + d^2)*mm^4*(psq - t) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*(-4*(-2 + d)*gZlL^3*gZlR*mm^2*
       ...
       (-4 + d)*gZlR^4*(2*(-5 + 2*d)*psq^3 + psq^2*((2 - 5*d)*s + 
           ...
           2*(-13 + 4*d)*t^2)) - 2*gZlL^2*gZlR^2*((64 - 30*d + 4*d^2)*psq^3 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*(2*gZlL^3*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
      ...
      (gZlL^2 + gZlR^2)*mm^2*(gZlL^2*(mm^2 - psq)*(psq - t) + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*
      (psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*(-4*gZlL^3*gZlR*mm^2*s - 
       4*gZlL*gZlR^3*mm^2*s + 2*gZlL^2*gZlR^2*(-((-4 + d)*psq*s) + 
         2*mm^2*(psq - t)) + gZlL^4*((-2 + d)*psq*s + 2*mm^2*(psq - t)) + 
       gZlR^4*((-2 + d)*psq*s + 2*mm^2*(psq - t)))*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*
      (psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*
      (4*gZlL^3*gZlR*mm^2*(2*(-2 + d)*psq^2 - s^2 + (-2 + d)*s*t + 
         2*(-2 + d)*t^2 - (-2 + d)*psq*(s + 4*t)) + 4*gZlL*gZlR^3*mm^2*
        (2*(-2 + d)*psq^2 - s^2 + (-2 + d)*s*t + 2*(-2 + d)*t^2 - 
         (-2 + d)*psq*(s + 4*t)) + gZlL^4*(2*(-2 + d)^2*psq^3 + 
         mm^2*(psq - t)*(4*(-2 + d)*psq + (4 + 2*d - d^2)*s - 4*(-2 + d)*t) - 
         2*(-2 + d)*t*(s + t)*(s + (-2 + d)*t) + 
       ...
       SP[p3, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*
      (-4*(-2 + d)*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t)*(psq - t) - 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*mm^2*(-2*gZlL*gZlR*s + 
       gZlL^2*(psq - t) + gZlR^2*(psq - t))*(psq - t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*(gZlL^4*(-((32 - 11*d + d^2)*psq^3) + 
         ...
         psq*(2*(-4 + d)*s^2 - 2*(30 - 11*d + d^2)*s*t + 
           (-104 + 43*d - 5*d^2)*t^2)) + gZlR^4*(-((32 - 11*d + d^2)*psq^3) + 
         2*(18 - 8*d + d^2)*t^2*(s + t) + (-4 + d)*mm^2*(psq - t)*
          ((-1 + d)*psq + (-3 + d)*s + t - d*t) + 
         psq^2*(-6*(-4 + d)*s + 2*(50 - 19*d + 2*d^2)*t) + 
         psq*(2*(-4 + d)*s^2 - 2*(30 - 11*d + d^2)*s*t + 
           (-104 + 43*d - 5*d^2)*t^2)) - 2*gZlL^2*gZlR^2*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q2]])/Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*
      (gZlL^2 + gZlR^2)*ml^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*(2*gZlL^2*gZlR^2*((-4 + d)^2*psq*s + 
       ...
       gZlL^4*(-((8 - 6*d + d^2)*psq*s) + mm^2*(8*psq + (4 - 6*d + d^2)*s - 
         ...
         mm^2*(8*psq + (4 - 6*d + d^2)*s - 8*t)) + 4*(-2 + d)*gZlL^3*gZlR*
        mm^2*(2*psq - s - 2*t) + 4*(-2 + d)*gZlL*gZlR^3*mm^2*
        (2*psq - s - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*(-4*(-2 + d)*gZlL^3*gZlR*mm^2*
    ...
    (4^(1 - d)*(-4 + d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)^2*
      ...
      (gZlL^2 + gZlR^2)^2*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*
      (-((-4 + d)*gZlL^4*(mm^2*(2*psq - s - 2*t) + (-1 + d)*psq*
           (psq - s - t))) - (-4 + d)*gZlR^4*(mm^2*(2*psq - s - 2*t) + 
         (-1 + d)*psq*(psq - s - t)) + 2*gZlL^2*gZlR^2*
        ((-2 + d)*mm^2*(2*psq - s - 2*t) + (-5 + d)*d*psq*(psq - s - t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*
      (-2*gZlL^2*gZlR^2*((8 - 6*d + d^2)*psq^2 + 4*s^2 - 6*d*s^2 + d^2*s^2 + 
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)^2*(mm^2*(2*psq - s - 2*t) + 
       ...
       SP[p2, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*
      (-2*gZlL^2*gZlR^2*(-((8 - 6*d + d^2)*psq^2) - 
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*psq*
      ((-4 + d)*gZlL^4*((-3 + d)*psq + s - (-3 + d)*t) + 
       ...
       SP[p2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*
      ((-4 + d)*gZlL^4*(mm^2 + psq - s - 2*t)*(psq - s - t) + 
       (-4 + d)*gZlR^4*(mm^2 + psq - s - 2*t)*(psq - s - t) + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*((-4 + d)*gZlL^4*((-2 + d)*mm^2 + (-4 + d)*psq) + 
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)^2*(psq - t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*
      (gZlL^4*((-2 + d)^2*psq^2 + (-4 + d)*mm^2*s - 10*s^2 + 3*d*s^2 - 
         6*s*t - d*s*t + d^2*s*t + 4*t^2 - 4*d*t^2 + d^2*t^2 - 
         psq*((-10 + d^2)*s + 2*(-2 + d)^2*t)) + 
       gZlR^4*((-2 + d)^2*psq^2 + (-4 + d)*mm^2*s - 10*s^2 + 3*d*s^2 - 
         6*s*t - d*s*t + d^2*s*t + 4*t^2 - 4*d*t^2 + d^2*t^2 - 
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)^2*(2*psq*(psq - s - t) + 
       mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(5 - 2*d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)^2*(mm^2 - 2*psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
    (4^(2 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)^2*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*psq*
      ((-4 + d)*gZlL^4*((-3 + d)*psq + s - (-3 + d)*t) + 
       (-4 + d)*gZlR^4*((-3 + d)*psq + s - (-3 + d)*t) - 
       2*gZlL^2*gZlR^2*((12 - 7*d + d^2)*psq + (-6 + d)*s - 
    ...
    (2^(3 - 2*d)*(18 - 9*d + d^2)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)^2*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)^2*(2*(-3 + d)*psq - 
    ...
    (2^(5 - 2*d)*(12 - 7*d + d^2)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)^2*(psq - t)*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*(12 - 7*d + d^2)*EL^6*gAl*gAu*
      (gZlL^2 - gZlR^2)^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (2^(5 - 2*d)*(12 - 7*d + d^2)*EL^6*gAl*gAu*(gZlL^2 - gZlR^2)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1], SP[p3, q1]])/
     Pi^(2*d) - (2^(5 - 2*d)*(12 - 7*d + d^2)*EL^6*gAl*gAu*
      (gZlL^2 - gZlR^2)^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
