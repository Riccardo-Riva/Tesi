...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*d*EL^5*gAl^3*gXll^2*mm^4*s*
   ...
   (4^(1 - d)*d*EL^5*gAl^3*gXll^2*mm^4*(aa*mm^2*(6*psq - s) - aa*psq*s - 
      3*bb*psq*s + bb*mm^2*(-6*psq + 5*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^5*gAl^3*gXll^2*
     mm^4*(-2*bb*mm^2*(psq - s) - 3*bb*psq*s + aa*psq*(2*mm^2 + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gXll^2*mm^4*(3*mm^2 + 2*psq - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - s)*s*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*s*
     ...
     SPList[SP[q1, q2]])/Pi^(2*d) + (4^(2 - d)*bb*d*EL^5*gAl^3*gXll^2*mm^4*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(bb*(mm^2 - 2*psq) + aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gXll^2*mm^4*(2*mm^2 + 2*psq - s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*
     (mm^4 + mm^2*(psq - 3*s) - psq*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gXll^2*mm^4*psq*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(aa*psq*(2*mm^2 - s) - 
