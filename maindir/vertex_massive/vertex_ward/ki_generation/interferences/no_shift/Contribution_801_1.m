...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-((2^(1 - 2*d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*s*
    ...
    (2^(3 - 2*d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
    ...
    (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) + (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*
      (gZlL + gZlR)^2*ml^2*mm^2*(4*psq - s)*s*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/((mh^2 - mz^2)*Pi^(2*d)) - 
    (2^(3 - 2*d)*bb*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*(mm^2 - psq)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)) - (4^(2 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
      ml^2*mm^2*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
    ...
    (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*s*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) + (4^(2 - d)*(aa - bb)*EL^5*gAl*gHll^2*
      (gZlL + gZlR)^2*ml^2*mm^2*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
