...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   ((I*EL^6*gAl*gAu*t*(s + t)*\[Mu]^(4 - d)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*
      (gZlL^2*(gZuR^2*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
         gZuL^2*((-2 + d)*s^2 + 4*s*t + 2*t^2)) + 
       gZlR^2*(gZuL^2*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
         gZuR^2*((-2 + d)*s^2 + 4*s*t + 2*t^2)))*\[Mu]^(4 - d)*
      SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(mz^4*Pi^d*s) + 
    (I*EL^6*gAl*gAu*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(3*s + 5*t)) + 
       ...
       gZlL^2*(gZuL^2*(d*(2*Pi)^d*s*(3*s + 5*t) + 2^(1 + d)*Pi^d*
           ...
           2^(1 + d)*Pi^d*(6*s^2 + 9*s*t + t^2))))*\[Mu]^(4 - d)*
      SPList[SP[p1, q1], SP[q1, q1], SP[q1, q1]])/(mz^4*(2*Pi)^(2*d)*s) + 
    ...
    (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*t^2*
      \[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1]])/
     (mz^4*Pi^d*s) - (I*EL^6*gAl*gAu*t*\[Mu]^(4 - d)*
    ...
    (I*EL^6*gAl*gAu*
      (-(gZlR^2*(-(gZuR^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(3*s + 5*t - 2*d*
                t))) + gZuL^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
             (6*s + 7*t - 2*d*t)))) + 
       gZlL^2*(gZuL^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(3*s + 5*t - 
             2*d*t)) - gZuR^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            (6*s + 7*t - 2*d*t))))*\[Mu]^(4 - d)*SPList[SP[p3, q1], 
       SP[q1, q1], SP[q1, q1]])/(mz^4*(2*Pi)^(2*d)) + 
    (I*EL^6*gAl*gAu*
   ...
   (((-I)*EL^6*gAl*gAu*
    ...
    (I*EL^6*gAl*gAu*t*(gZlL^2*(gZuL^2*(-(d^3*(2*Pi)^d*s) + 
           2^(1 + d)*Pi^d*(2*(-6 + d + d^2)*s - (-12 + 20*d - 8*d^2 + d^3)*
              t)) - gZuR^2*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
    ...
    (I*EL^6*gAl*gAu*(gZlL^2*(gZuL^2*(d^3*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
           ...
           2^(1 + d)*Pi^d*((-4 - 6*d + 4*d^2)*s^2 - (-44 + 40*d - 12*d^2 + d^
                3)*s*t + 8*t^2))))*\[Mu]^(4 - d)*SPList[SP[p3, q1]])/
     ((2*Pi)^(2*d)*s) + (I*EL^6*gAl*gAu*
      ((2^(1 - d)*t*(gZlL^2*(-(gZuR^2*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + 
       ...
       (gZlR^2*(-(gZuR^2*(-(d^3*(2*Pi)^d*s^2) + 2^(2 + d)*Pi^d*(
        ...
        (2*Pi)^(2*d))*\[Mu]^(4 - d)*SPList[SP[q1, q1]])/s - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      (-(gZlR^2*(-(gZuR^2*(-(d^3*(2*Pi)^d*s) + 2^(2 + d)*Pi^d*
       ...
       SP[p2, q1]])/(Pi^(2*d)*s) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      ...
      ((4^(1 - d)*mz^2*(-(gZlR^2*(-(gZuR^2*(-(d^2*(2*Pi)^d*s^2) + 
        ...
        Pi^(2*d) + (t*(s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*
          ...
          (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t))) + 
            ...
            gZlL^2*(gZuL^2*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
              gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))))*
           GaugeXi[Q]^2))/(2*Pi)^(2*d))*SPList[SP[p1, q1], SP[q1, q1]])/
     (mz^4*s*(-1 + GaugeXi[Q])^2) - (I*2^(1 - d)*EL^6*gAl*gAu*
   ...
   (((-I)*EL^6*gAl*gAu*t*
     ...
     (mz^2*(2*Pi)^d*s) - (I*EL^6*gAl*gAu*\[Mu]^(4 - d)*
      ((2^(1 - 2*d)*mz^2*(-(gZlR^2*(-(gZuR^2*(-(d^2*(2*Pi)^d*s^2) + 
                2^(1 + d)*Pi^d*(2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 
                  2*t^2))) + gZuL^2*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
                ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)))) + 
        ...
        Pi^(2*d) + (t*(s + t)*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*
          ...
          (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t))) + 
            ...
            gZlL^2*(gZuL^2*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
              gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))))*
           GaugeXi[Q]^2))/(2*Pi)^(2*d))*SPList[SP[p1, q1], SP[q1, q1]])/
     (mz^4*s*(-1 + GaugeXi[Q])^2) + (I*EL^6*gAl*gAu*t^2*\[Mu]^(4 - d)*
      (gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t))) + 
         gZuL^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))) + 
       gZlL^2*(gZuL^2*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuR^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))) - 
    ...
    (I*EL^6*gAl*gAu*
      (gZlR^2*(-(gZuR^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(3*s + 5*t - 
            ...
            (6*s + 7*t - 2*d*t))) + 
       gZlL^2*(gZuR^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(6*s + 7*t - 
             2*d*t)) + gZuL^2*(3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            (-3*s - 5*t + 2*d*t))))*\[Mu]^(4 - d)*SPList[SP[p3, q1], 
       SP[q1, q1], SP[q1, q1]])/(mz^4*(2*Pi)^(2*d)) + 
    (I*EL^6*gAl*gAu*
