  ...
  ((I*EL^5*gAl*gHll^2*mm^4*s*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
     (aa*(gZlL^2*(2*Pi)^(2*d)*(4*(-2 + d)*mm^4 + s*(-((-2 + d)*psq) + 2*s) - 
         ...
         (4*(-2 + d)*mm^4 + s*(-((-2 + d)*psq) + 2*s) - 
          (-2 + d)*mm^2*(6*psq - 3*s - 2*t)) + 4^(1 + d)*gZlL*gZlR*mm^2*
         Pi^(2*d)*(2*s + d*(psq - s - t))) + 
      bb*(gZlL^2*(2*Pi)^(2*d)*(((-2 + d)*psq - 2*s)*s + 
          (-2 + d)*mm^2*(2*psq - 3*s - 2*t)) + gZlR^2*(2*Pi)^(2*d)*
   ...
   (I*EL^5*gAl*gHll^2*mm^2*(-2*aa*(gZlL^2 + gZlR^2)*s*(2*mm^2 - 3*psq + s + 
    ...
    (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
