...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
   ...
   (-((4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*(2*mm^2 - s)*
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*(-(4^(1 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*
         (mm^2 - psq)^2*s) - d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
        (mm^2 - psq)^2*s + 4*d*(gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq)^2*s + 
         gZlR^2*(2*Pi)^(2*d)*(mm^2 - psq)^2*s + 2^(1 + 2*d)*gZlL*gZlR*mm^2*
          Pi^(2*d)*(mm^2 + psq - s)*(2*psq - s - 2*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/Pi^(4*d) + (2^(1 - 4*d)*EL^6*gAl^3*gAu*
      (gZlL^2 + gZlR^2)*mm^2*(-(d^2*(2*Pi)^(2*d)*s*(psq^2 + t*(s + 3*t))) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*(d^2*(mm^2 - psq)*(gZlL^2*psq*s + 
       ...
       d*(-4*gZlL*gZlR*mm^2*(psq - t)*(2*mm^2 - 3*psq + t) + 
         gZlL^2*(-2*psq^3 + psq^2*(4*s + 6*t) + psq*(2*s^2 - 5*s*t - 6*t^2) + 
           t*(3*s^2 + 5*s*t + 2*t^2) - mm^2*(4*psq^2 + 3*s^2 + 6*s*t + 
             4*t^2 - 2*psq*(s + 4*t))) + gZlR^2*(-2*psq^3 + 
           psq^2*(4*s + 6*t) + psq*(2*s^2 - 5*s*t - 6*t^2) + 
           t*(3*s^2 + 5*s*t + 2*t^2) - mm^2*(4*psq^2 + 3*s^2 + 6*s*t + 
    ...
    (4^(1 - d)*(-6 + d)^2*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) + (2^(1 - 4*d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
