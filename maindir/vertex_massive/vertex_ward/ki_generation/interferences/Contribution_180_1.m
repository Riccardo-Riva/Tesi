...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   (((-I)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*s*
    ...
    (I*2^(1 - 2*d)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*s*
      (bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/Pi^(2*d) - (I*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*
     ...
     Pi^(2*d) + (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*
     ...
     (2*Pi)^(2*d) - (I*4^(1 - d)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*
