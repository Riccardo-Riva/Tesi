...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, mh], 
 ...
 ((2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gHll^2*mm^4*psq*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gHll^2*mm^2*
    (-psq^2 + s^2 + psq*(-s + t) + mm^2*(4*psq - 2*(s + 2*t)))*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gHll^2*mm^2*
    (3*psq^2 + s^2 - psq*(3*s + t) + mm^2*(-6*psq + 2*s + 4*t))*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gHll^2*mm^2*(2*mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gHll^2*mm^2*
    (s*(-2*psq + s) + mm^2*(4*psq - 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gHll^2*mm^2*(psq + s - t)*
   ...
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*gHll^2*mm^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFW^2*
    gHll^2*mm^2*(psq - 2*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
