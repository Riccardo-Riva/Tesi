...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (I*EL^5*gAl*gHll^2*gXll^2*mm^6*
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^6*((aa + bb)*(mm^2 - psq)*s - 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*
    ...
    SPList[SP[p2, q2]])/Pi^(2*d) + (I*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*
    (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(4^d*Pi^(2*d)) - 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(mm^2 - t) + 
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*
    (-3*psq + s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
   Pi^(2*d) - (I*EL^5*gAl*gHll^2*gXll^2*mm^4*((aa + bb)*(mm^2 - psq)*s - 
  ...
  (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(aa*(mm^2 - s - t) + 
     ...
     SP[p2, q1]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
   Pi^(2*d) - (I*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(3*psq - 2*s - 3*t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 + psq)*(psq - t)*
