...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*mm^2 - s)*
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(-4*psq^3 + 
       mm^2*(4*psq - d*s - 4*t)*(psq - t) + 2*t*(s + 2*t)^2 + 
       psq^2*((-4 + d)*s + 16*t) + psq*(2*s^2 - (4 + d)*s*t - 20*t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(4*psq^3 + mm^2*psq*s - 
       3*psq^2*(s + 4*t) + 3*psq*t*(3*s + 4*t) - 
       t*(mm^2*s + 2*s^2 + 6*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(-8*psq^3 - d*mm^2*s^2 + 
       8*psq^2*(s + 3*t) + psq*(4*mm^2*s + (-8 + d)*s^2 - 20*s*t - 24*t^2) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((-4 + d)*mm^4*(psq - t) - 
       2*mm^2*((-9 + d)*psq^2 + 4*psq*s - s^2 - (-16 + d)*psq*t - 6*s*t - 
         7*t^2) + psq*((-2 + d)*psq^2 - 2*t*(s + t) - 
         psq*(2*s + (-4 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      ...
      (-((8 + d)*psq^3) + (-4 + d)*mm^4*s + 2*psq^2*(4*s + (10 + d)*t) + 
       2*t*(s^2 + 3*s*t + 2*t^2) - psq*(2*s^2 + (14 + d)*s*t + 
         (16 + d)*t^2) + mm^2*((8 + d)*psq^2 + t*((4 + d)*s + (8 + d)*t) - 
         psq*(16*t + d*(s + 2*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-2*(-4 + d)*psq^3 + 
       4*s*t*(s + t) + psq^2*((16 - 3*d)*s + 4*(-4 + d)*t) + 
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)*(mm^2*(-psq + t) + 
       psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (-2*psq^3 + 2*psq^2*(s + 4*t) + mm^2*(-2*psq^2 + s^2 + 4*psq*t - 
         2*t^2) + 2*t*(s^2 + 3*s*t + 2*t^2) - psq*(s^2 + 8*s*t + 10*t^2))*
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      ...
      gXll^2*mm^4*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      ((-4 + d)*psq^3 - 2*(-6 + d)*psq^2*t + psq*t*(-6*s + (-12 + d)*t) + 
       2*t*(s^2 + 3*s*t + 2*t^2) + mm^2*(-((-8 + d)*psq^2) - 6*psq*s + 
         2*s^2 + 2*(-8 + d)*psq*t + 6*s*t - (-8 + d)*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)*
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)*
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*mm^2 - 3*psq + s + t)*
     ...
     Pi^(2*d) + (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
