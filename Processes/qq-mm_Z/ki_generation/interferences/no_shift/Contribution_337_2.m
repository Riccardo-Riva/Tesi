(PropList[KiraPropagator[q1, mc], KiraPropagator[-p1 - p2 + q1, mc]]*
  (((-3*I)*2^(1 - 2*d)*EL^6*gAl*gAu*(gZuL + gZuR)*mc^2*
     (gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
      ...
      gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
        ...
        gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
            (8 - 5*d + d^2)*s*t + 2*t^2)))))/(Pi^(2*d)*s*(-mz^2 + s)*
     (-mzC^2 + s)) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*
   ...
   (I*2^(1 - 2*d)*EL^6*gAl*gAu*
    ...
    (Pi^(2*d)*s*(-mz^2 + s)*(-mzC^2 + s)) - 
   ((3*I)*2^(2 - d)*(-3 + d)*EL^6*gAl*gAu*(gZuL - gZuR)*
   ...
   ((3*I)*2^(3 - d)*EL^6*gAl*gAu*(gZuL + gZuR)*((-2 + d)*gZlLC*gZuL*gZuLC - 
   ...
   ((3*I)*2^(3 - d)*EL^6*gAl*gAu*(gZuL + gZuR)*
    ...
    (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
   ((3*I)*2^(4 - d)*EL^6*gAl*gAu*(gZlLC + gZlRC)*(gZuL + gZuR)*
