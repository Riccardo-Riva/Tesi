...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
   ...
   ((I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(s + t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-10 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*(s + t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*t*
    ...
    (I*4^(1 - d)*(aa - bb)*(-10 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*
     ...
     Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*
      ...
      gWNl*gWWA*gWWZ*gZNL*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (I*4^(1 - d)*(aa - bb)*(-10 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZNL*t*
