  ...
  ((4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^8*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(-psq + s + t)*
     (psq^2*s + mm^4*(-8*psq + 5*s + 8*t) - 
      2*mm^2*(8*psq^2 + 4*t*(s + t) - psq*(s + 12*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^2 - psq)*(-psq + s + t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(2*psq^2 + mm^2*s + 2*t*(s + t) - 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq - t)*(2*mm^2 - 3*psq + s + t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq^2 + mm^2*s + (s + t)^2 - 
      ...
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[p3, q2]])/
    Pi^(2*d) - (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(2*mm^2 - 3*psq + s + t)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq - t)*(-psq + s + t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq - t)*(-psq + s + t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
