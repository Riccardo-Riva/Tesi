...
PropList[KiraPropagator[q1, mz], KiraPropagator[q2, mh], 
 ...
 (-((2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
  ...
  (EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*(4*psq^2 - 5*s^2 + 
     2*d*s*(mm^2 + s) + 4*s*t + 4*t^2 - 2*psq*((-6 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/((2*Pi)^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*(6*psq^2 + 2*s^2 - d*s^2 + 
  ...
  (EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*(2*psq^2 + (-5 + d)*psq*s + 
  ...
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
    ...
    gHXX^2*mh^4*mm^2*(-4*mm^2 + 6*psq + 3*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
    ...
    gHXX^2*mh^4*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   (Pi^(2*d)*s) - (3*2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
   ...
   (Pi^(2*d)*s^2) - (3*2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gHXX^2*mh^4*mm^2*
