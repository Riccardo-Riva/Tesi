...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
   ...
   ((I*EL^6*gWWZ^2*s^3*(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
      ...
      SPList[SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*
      GaugeXi[Q]^2) - (I*2^(1 - 2*d)*EL^6*gWWZ^2*s^2*(s + t)*
    ...
    (I*2^(1 - 2*d)*EL^6*gWWZ^2*s^2*
      (-(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
       ...
       gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            (-s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
           2^(1 + d)*Pi^d*(2*s + 3*t - d*t))))*(1 + GaugeXi[Q])^2*
      SPList[SP[p1, q1], SP[p2, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(1 - 2*d)*EL^6*gWWZ^2*s^2*
    ...
    (I*2^(1 - 2*d)*EL^6*gWWZ^2*s^2*
     ...
     (mw^4*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
      ...
      (gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s^3*
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*(gZlR*gZlRC*((-2 + d)*gZuL*gZuLC - 
         ...
         (-2 + d)*gZuR*gZuRC))*s*(s + t)*(1 + GaugeXi[Q])*
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*s*
      ...
      (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(5 - d)*EL^6*gWWZ^2*
      (gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s^2*
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*s*
      ...
      GaugeXi[Q]) + (I*2^(4 - d)*EL^6*gWWZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*s*(gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
     ...
     (mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2) + 
    (I*2^(2 - d)*EL^6*gWWZ^2*s*(gZlL*gZlLC*(gZuR*gZuRC*((-4 + d)*s + 2*t) + 
    ...
    (I*2^(4 - d)*EL^6*gWWZ^2*(gZlR*gZlRC*((-2 + d)*gZuL*gZuLC - 
      ...
      (gZlL*gZlLC*(gZuR*gZuRC*((10 - 3*d)*s - 6*(-3 + d)*t) + 
       ...
       gZlR*gZlRC*(gZuL*gZuLC*((10 - 3*d)*s - 6*(-3 + d)*t) + 
         gZuR*gZuRC*((-8 + 3*d)*s + 6*(-3 + d)*t)))*SPList[SP[p1, q1], 
       SP[p1, q1], SP[p2, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(3 - d)*EL^6*gWWZ^2*
    ...
    (I*2^(4 - d)*EL^6*gWWZ^2*
      (gZlR*gZlRC*(gZuR*gZuRC*(-2*(-3 + d)*s + (10 - 3*d)*t) + 
       ...
       SP[p1, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*
     ...
     (mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2) - 
    (I*2^(4 - d)*EL^6*gWWZ^2*(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
         2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)) + 
       gZlL*gZlLC*(gZuL*gZuLC*(-((-6 + d)*s) + 2*t) + 
         gZuR*gZuRC*(d*s + 2*t)))*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1], 
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*(gZlR*gZlRC*(-((-2 + d)*gZuL*gZuLC) + 
      ...
      (gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*(7 - 2*d)*t) + 
       ...
       gZlR*gZlRC*(gZuL*gZuLC*(-((-4 + d)*s) + 2*(7 - 2*d)*t) + 
         gZuR*gZuRC*((-2 + d)*s + 2*(-5 + 2*d)*t)))*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p2, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(3 - d)*EL^6*gWWZ^2*
      (gZlR*gZlRC*(gZuR*gZuRC*((2 + d)*s - 2*t) - gZuL*gZuLC*
          ((-8 + d)*s + 2*t)) + gZlL*gZlLC*(gZuL*gZuLC*((2 + d)*s - 2*t) - 
         gZuR*gZuRC*((-8 + d)*s + 2*t)))*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p2, q1], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*
      GaugeXi[Q]^2) + (I*2^(4 - d)*EL^6*gWWZ^2*
      (gZlR*gZlRC*(gZuR*gZuRC*(-((-2 + d)*s) + (8 - 3*d)*t) + 
         gZuL*gZuLC*((-4 + d)*s + (-10 + 3*d)*t)) + 
       gZlL*gZlLC*(gZuL*gZuLC*(-((-2 + d)*s) + (8 - 3*d)*t) + 
         gZuR*gZuRC*((-4 + d)*s + (-10 + 3*d)*t)))*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(5 - d)*EL^6*gWWZ^2*
      (gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s*
      SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1], SP[p3, q1]])/
     (mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2) - 
    (I*2^(6 - d)*EL^6*gWWZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
         2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)) + 
       gZlL*gZlLC*(gZuL*gZuLC*(-((-6 + d)*s) + 2*t) + 
         gZuR*gZuRC*(d*s + 2*t)))*SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2) + 
    ...
    (I*2^(4 - d)*EL^6*gWWZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*s*SPList[SP[p2, q1], SP[p2, q1], SP[p3, q1], 
       SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2) - 
    (I*2^(4 - d)*EL^6*gWWZ^2*(gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
         gZuR*gZuRC*((-4 + d)*s + 2*t)) - gZlR*gZlRC*
        (gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*
  ...
  PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 - p2 + q1, mw]]*
   (((-I)*EL^6*gWWZ^2*s*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWWZ^2*
      ...
      (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
        ...
        (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
           ...
           2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
      (mw^2 - 2*s - 2*(mw^2 + s)*GaugeXi[Q] + mw^2*GaugeXi[Q]^2)*
      SPList[SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*
    ...
    (I*2^(1 - 2*d)*EL^6*gWWZ^2*((2*gZlL*gZlLC*(-9*d*gZuL*gZuLC*(2*Pi)^d*s^2 + 
    ...
    (I*2^(2 - d)*EL^6*gWWZ^2*
      ...
      (-3*mw^2 + 2*s + mw^2*GaugeXi[Q])*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2) - 
    (I*4^(1 - d)*EL^6*gWWZ^2*(1 + GaugeXi[Q])*
    ...
    (I*2^(4 - d)*EL^6*gWWZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
     ...
     (mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2) + 
    (I*4^(1 - d)*EL^6*gWWZ^2*(2^(1 + d)*Pi^d*s*
        (gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
           gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t)) + 
         gZlR*gZlRC*(gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*s*
      ...
      (-mzC^2 + s)*GaugeXi[Q]^2) + (I*4^(1 - d)*EL^6*gWWZ^2*(1 + GaugeXi[Q])*
    ...
    (I*4^(1 - d)*EL^6*gWWZ^2*(2^(1 + d)*Pi^d*s*
      ...
      (gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
       ...
       gZlR*gZlRC*(gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)))*SPList[SP[p2, q1], 
       SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*
      GaugeXi[Q]^2) - (I*2^(3 - 2*d)*EL^6*gWWZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
  ...
  PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 - p2 + q1, 
   ...
   ((I*EL^6*gWWZ^2*s^2*(gZlL*gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
        ...
        (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
             (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
      (1 + GaugeXi[Q])^2)/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*
      GaugeXi[Q]^2) + (I*4^(1 - d)*EL^6*gWWZ^2*s*
      (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
            ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
         gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
             (8 - 5*d + d^2)*s*t + 2*t^2))) + gZlR*gZlRC*
        (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
             (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
      (1 + GaugeXi[Q])*SPList[SP[p1, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) + (I*4^(1 - d)*EL^6*gWWZ^2*s*
      (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
            ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
         gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
        ...
        (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
             (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
      (1 + GaugeXi[Q])*SPList[SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) - (I*EL^6*gWWZ^2*s*(-1 + GaugeXi[Q]^2)*
    ...
    (I*4^(1 - d)*EL^6*gWWZ^2*(-(mw^2*(-1 + GaugeXi[Q])^2*
         (gZlL*gZlLC*(-(gZuR*gZuRC*(d*(2*Pi)^d*s*((-7 + d)*s - 11*t) + 
               2^(1 + d)*Pi^d*(5*s^2 + (5 + d^2)*s*t - 2*t^2))) + 
            gZuL*gZuLC*(d*(2*Pi)^d*s*((-5 + d)*s - 11*t) + 2^(1 + d)*Pi^d*(
                4*s^2 + (10 + d^2)*s*t + 2*t^2))) + gZlR*gZlRC*
           (-(gZuL*gZuLC*(d*(2*Pi)^d*s*((-7 + d)*s - 11*t) + 2^(1 + d)*Pi^d*
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*(mw^2 - s)*
      (gZlR*gZlRC*(gZuR*gZuRC*(-2*(-3 + d)*s + (10 - 3*d)*t) + 
       ...
       gZlL*gZlLC*(gZuL*gZuLC*(-2*(-3 + d)*s + (10 - 3*d)*t) + 
         gZuR*gZuRC*(2*(-3 + d)*s + (-8 + 3*d)*t)))*(1 + GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(3 - d)*EL^6*gWWZ^2*(mw^2 - s)*
      (gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
         2*gZuR*gZuRC*(3*s + t)) + gZlL*gZlLC*
        (gZuL*gZuLC*(-((-6 + d)*s) + 2*t) + gZuR*gZuRC*(d*s + 2*t)))*
      (1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1]])/
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*(mw^2 - s)*
      ...
      SPList[SP[p1, q1], SP[p2, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(5 - d)*EL^6*gWWZ^2*
      (gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s*(-mw^2 + s)*
      (1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1]])/
     (mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2) - 
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*s*
      ...
      t*(1 + GaugeXi[Q])*SPList[SP[p2, q1], SP[p2, q1], SP[p2, q1]])/
     (mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2) - 
    (I*2^(3 - d)*EL^6*gWWZ^2*(mw^2 - s)*
      (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*
          ((-4 + d)*s + 2*t)) - gZlR*gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*(gZlR*gZlRC*((-2 + d)*gZuL*gZuLC - 
      ...
      (gZlR*gZlRC*(gZuR*gZuRC*(10*s - 3*d*s + 14*t - 4*d*t) + 
       ...
       gZlL*gZlLC*(gZuL*gZuLC*(10*s - 3*d*s + 14*t - 4*d*t) + 
         gZuR*gZuRC*(-8*s + 3*d*s - 10*t + 4*d*t)))*SPList[SP[p1, q1], 
       SP[p1, q1], SP[p1, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(3 - d)*EL^6*gWWZ^2*
      (gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
         2*gZuR*gZuRC*(3*s + t)) + gZlL*gZlLC*
        (gZuL*gZuLC*(-((-6 + d)*s) + 2*t) + gZuR*gZuRC*(d*s + 2*t)))*
    ...
    (I*2^(3 - d)*EL^6*gWWZ^2*(gZlR*gZlRC*((-2 + d)*gZuL*gZuLC - 
      ...
      (gZlR*gZlRC*(gZuR*gZuRC*(-((-2 + d)*s) + 2*(5 - 2*d)*t) + 
       ...
       gZlL*gZlLC*(gZuL*gZuLC*(-((-2 + d)*s) + 2*(5 - 2*d)*t) + 
         gZuR*gZuRC*((-4 + d)*s + 2*(-7 + 2*d)*t)))*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p2, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(3 - d)*EL^6*gWWZ^2*
      (gZlR*gZlRC*(gZuR*gZuRC*((2 + d)*s - 2*t) - gZuL*gZuLC*
          ((-8 + d)*s + 2*t)) + gZlL*gZlLC*(gZuL*gZuLC*((2 + d)*s - 2*t) - 
      ...
      (gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) + (10 - 3*d)*t) + 
       ...
       gZlR*gZlRC*(gZuL*gZuLC*(-((-4 + d)*s) + (10 - 3*d)*t) + 
         gZuR*gZuRC*((-2 + d)*s + (-8 + 3*d)*t)))*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*
      (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(5 - d)*EL^6*gWWZ^2*
      (gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s*
      SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1], SP[p3, q1]])/
   ...
   ((I*EL^6*gWWZ^2*(mw^2 - s)*s^2*
     ...
     (mw^4*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
      ...
      (-(mw^2*(-1 + GaugeXi[Q])^2*
       ...
       SP[p2, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*
      (-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) + 
    (I*2^(1 - 2*d)*EL^6*gWWZ^2*s*(-(mw^2*(-1 + GaugeXi[Q])^2*
         (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s - t)) + gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*
                (s + t)))) + gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
              2^(1 + d)*Pi^d*(-2*s + t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
    ...
    (I*2^(4 - d)*EL^6*gWWZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*s*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*GaugeXi[Q]^2)))/4
