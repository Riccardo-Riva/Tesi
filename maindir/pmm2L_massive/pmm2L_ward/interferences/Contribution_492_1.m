...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*psq*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*psq*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (I*(aa + bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa + bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa + bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*(mm^2 - psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*(psq - t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmAW*ggagmW*gWlN*gWNl*(psq - s - t)*
