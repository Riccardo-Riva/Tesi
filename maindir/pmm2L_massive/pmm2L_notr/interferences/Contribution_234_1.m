...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*mm^2*s*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*mm^2*\[Mu]^(8 - 2*d)*
    ...
    (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(7*mm^2 - 7*psq + 2*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(5*mm^2 - 5*psq + 2*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(-mm^2 + psq + s)*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(-psq^2 + mm^2*(psq + 2*s - t) + 
     psq*(-3*s + t) + s*(s + t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(psq^2 - s*t - psq*(2*s + t) + 
     mm^2*(-psq + 3*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(psq^2 + 2*s^2 - psq*(5*s + t) + 
     mm^2*(-psq + 5*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(-mm^2 + psq + s)*(psq - t)*
  ...
  (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(mm^2 - psq - 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(2*mm^2 - 3*psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(mm^2 - psq - 2*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(2*mm^2 - psq - t)*
  ...
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(-4*mm^2 + 2*psq + s + 2*t)*
  ...
  (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*(psq - t)*\[Mu]^(8 - 2*d)*
