...
((-I)*EL^6*gFFZ^2*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s*
 ...
 (I*EL^6*gFFZ^2*(-(gZlR*gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + 
    ...
    gZlL*gZlLC*(gZuL*gZuLC*((-4 + d)*s - 2*t) - 
      gZuR*gZuRC*((-2 + d)*s + 2*t)))*userIntegral[A4, {mw*Sqrt[GaugeXi[Q]]}, 
    -1, 1, 1, -1])/((2*Pi)^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*2^(-1 - 2*d)*EL^6*gFFZ^2*
   (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - t)) + 
       gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(s + t)))) + 
    gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
 ...
 (I*EL^6*gFFZ^2*(gZlR*gZlRC*(gZuR*gZuRC*((-2 + d)*s + (-4 + d)*t) - 
    ...
    gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s + (-4 + d)*t) - 
      gZuR*gZuRC*((-4 + d)*s + (-2 + d)*t)))*userIntegral[A4, 
    {mw*Sqrt[GaugeXi[Q]]}, 0, 0, 0, 0])/((2*Pi)^d*(mz^2 - s)^2*
   (-mzC^2 + s)) + (I*2^(-1 - d)*EL^6*gFFZ^2*
   (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
    gZlR*gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
      gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*userIntegral[A4, 
    {mw*Sqrt[GaugeXi[Q]]}, 0, 0, 1, -1])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*EL^6*gFFZ^2*((gZlL*gZlLC*(-((-2 + d)*gZuL*gZuLC) + (-4 + d)*gZuR*gZuRC) + 
 ...
 (I*2^(-1 - d)*EL^6*gFFZ^2*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
      ...
      (-2 + d)*gZuR*gZuRC))*t*userIntegral[A4, {mw*Sqrt[GaugeXi[Q]]}, 0, 1, 
    -1, 0])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*2^(-1 - d)*EL^6*gFFZ^2*(gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
    gZlR*gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
      gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*userIntegral[A4, 
    {mw*Sqrt[GaugeXi[Q]]}, 0, 1, 0, -1])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*EL^6*gFFZ^2*
