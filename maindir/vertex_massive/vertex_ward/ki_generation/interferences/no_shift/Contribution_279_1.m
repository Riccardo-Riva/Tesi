...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(2*bb*psq*(psq - s) - 
       aa*psq*(-6*mm^2 + 2*psq + s) + bb*mm^2*(-6*psq + 3*s))*
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (aa*(-2*psq^2 + 3*psq*s + 2*(mm^2 - s)*s) + 
      bb*(2*psq^2 - 7*psq*s + 2*s*(mm^2 + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*(aa*(3*mm^2*psq - psq^2 + 2*psq*s - 2*s^2) + 
      bb*(psq^2 - 3*mm^2*(psq - s) - 5*psq*s + 2*s^2))*\[Mu]^(8 - 2*d)*
     ...
     (gZlL - gZlR)*mm^4*s*(aa*(2*mm^2 + psq + 2*s) - bb*(mm^2 + 2*(psq + s)))*
   ...
   (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
     (bb*(mm^4 + mm^2*(9*psq - 4*s) + 2*psq*(-psq + s)) + 
      aa*(mm^4 + mm^2*(-11*psq + s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (2*aa*(psq - s) + bb*(3*mm^2 - 5*psq + 2*s))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    ...
    Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (aa*(5*mm^2 + psq)*(mm^2 + s) - bb*(5*mm^4 + 2*psq*s + 
        mm^2*(psq + 4*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^4*(2*psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
    Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*bb*mm^2*(5*psq - 2*s) + aa*mm^2*(-10*psq + s) + 2*bb*psq*(-psq + s) + 
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (3*mm^2 - psq)*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (aa*mm^2 + bb*(-2*mm^2 + psq))*s*\[Mu]^(8 - 2*d)*
