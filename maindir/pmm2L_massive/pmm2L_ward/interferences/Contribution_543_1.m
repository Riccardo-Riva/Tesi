...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((I*4^(-1 - d)*(aa - bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*(mm^2 - 3*psq)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*(mm^2 - 3*psq)*(psq - t)*
  ...
  (I*(aa - bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
