...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFgagp*gFll*ggagpW*gWNl*mm^2*psq*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s)) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFgagp*gFll*ggagpW*gWNl*mm^2*psq*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagp*gFll*ggagpW*gWNl*mm^2*
    (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagp*gFll*ggagpW*gWNl*
    mm^2*(psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagp*gFll*ggagpW*gWNl*
    mm^2*(psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagp*gFll*ggagpW*gWNl*mm^2*(-psq + s + t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagp*gFll*ggagpW*gWNl*mm^2*(psq - t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFgagp*gFll*ggagpW*gWNl*mm^2*\[Mu]^(8 - 2*d)*
