  ...
  (((-I)*(aa - bb)*(2 + d)*EL^5*gWWAZ*gWWZ*gZlL*gZlR*mm^2*s*
   ...
   (I*2^(-1 - 4*d)*EL^5*gWWAZ*gWWZ*
     (aa*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(6*(-1 + d)*psq + (8 - 5*d)*s - 
          ...
          d*s*(s + t) + psq*(6*s - d*s + 6*t - 4*d*t) + 
          2*mm^2*((-3 + 2*d)*psq + 5*s - 3*d*s + 3*t - 2*d*t)) + 
        gZlR^2*(2*Pi)^(2*d)*((-6 + 4*d)*psq^2 - d*s*(s + t) + 
          psq*(6*s - d*s + 6*t - 4*d*t) + 2*mm^2*((-3 + 2*d)*psq + 5*s - 
            3*d*s + 3*t - 2*d*t))) + 
      bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(6*(-1 + d)*psq + (8 - 5*d)*s - 
          6*(-1 + d)*t) - gZlR^2*(2*Pi)^(2*d)*((-6 + 4*d)*psq^2 + 
          2*(-3 + 2*d)*mm^2*(psq - s - t) - d*s*(s + t) + 
          psq*(10*s - 3*d*s + 6*t - 4*d*t)) + gZlL^2*(2*Pi)^(2*d)*
