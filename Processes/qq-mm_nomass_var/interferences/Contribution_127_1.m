...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   ((I*2^(1 - 2*d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*CKMC[1, 1]*
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*t*(s + 2*t)*CKM[1, 1]*
      CKMC[1, 1]*SPList[SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*s) - 
    (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*(s + 2*t)*CKM[1, 1]*CKMC[1, 1]*
      SPList[SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d) - 
    (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*s*CKM[1, 1]*CKMC[1, 1]*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   (((-I)*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*((-10 + 3*d)*s^2 + 
       (-10 + 3*d)*s*t + 2*(-2 + d)*t^2)*CKM[1, 1]*CKMC[1, 1]*
      SPList[SP[p1, q1]])/(Pi^d*s^2) + (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*
      gWWA*(2*(-2 + d)*s^2 + (2 + d)*s*t + 2*(-2 + d)*t^2)*CKM[1, 1]*
    ...
    (I*4^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*CKMC[1, 1]*
      (mw^2*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(s^2 - 2*s*t - 2*t^2)) + 
       (d*(2*Pi)^d*s^3 + 2^(1 + d)*Pi^d*s*(-s^2 + 2*s*t + 2*t^2) + 
         2^(1 + d)*mw^2*Pi^d*((-2 + d)*s^2 + 2*s*t + 2*t^2))*GaugeXi[Q])*
      SPList[SP[q1, q1]])/(mw^2*Pi^(2*d)*s^2*GaugeXi[Q]) + 
    ...
    (I*2^(3 - d)*(-2 + d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*t*CKM[1, 1]*
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*(s + 2*t)*CKM[1, 1]*CKMC[1, 1]*
     ...
     (mw^4*Pi^d*s*GaugeXi[Q]) - (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      CKM[1, 1]*CKMC[1, 1]*(-2*mw^2*((-1 + d)*s^2 + 4*s*t + 4*t^2) + 
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*(s + t)*CKM[1, 1]*CKMC[1, 1]*
     ...
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      CKM[1, 1]*CKMC[1, 1]*(2*mw^2*s - (s + 2*t)^2 + 
       (2*mw^2 - s)*s*GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      CKM[1, 1]*CKMC[1, 1]*(-(s*(s + 2*t)) + mw^2*(6*s + 4*t) + 
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*(2*s^2 + 3*s*t + 2*t^2)*
     ...
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      ...
      SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) - (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      CKM[1, 1]*CKMC[1, 1]*(2*mw^2*(s - 2*t) + s*(s + 2*t) + 
    ...
    KiraPropagator[-p1 + q1, mw], KiraPropagator[p2 + q1, 
     mw*Sqrt[GaugeXi[Q]]]]*((I*2^(1 - 2*d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      (-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(s^2 - 2*s*t - 2*t^2))*CKM[1, 1]*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*CKMC[1, 1]*
      ...
      GaugeXi[Q]) - (I*2^(1 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*(s + 2*t)*
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*CKMC[1, 1]*
      ...
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      CKM[1, 1]*CKMC[1, 1]*(-(s*(s + 2*t)) + mw^2*(3*s + 2*t) + 
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*(2*s^2 + 3*s*t + 2*t^2)*
     ...
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      ...
      SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s^2*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*
      CKM[1, 1]*CKMC[1, 1]*(mw^2*(s - 2*t) + s*(s + 2*t) + 
   ...
   ((I*2^(1 - 2*d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*(-(d*(2*Pi)^d*s^2) + 
       2^(1 + d)*Pi^d*(s^2 - 2*s*t - 2*t^2))*CKM[1, 1]*CKMC[1, 1]*
      SPList[SP[q1, q1]])/(mw^2*Pi^(2*d)*s) + 
    (I*2^(1 - 2*d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*CKMC[1, 1]*
      (-(mw^2*(-(2^(1 + d)*d*Pi^d*s^2) + 3*(2*Pi)^d*s^2 - 11*(2*Pi)^d*s*t - 
          5*2^(1 + d)*Pi^d*t^2)) - 
       (s*((2*Pi)^d*s^2 + 3*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*t^2) + 
         mw^2*(-((2*Pi)^d*s*(3*s - 11*t)) + 2^(1 + d)*Pi^d*(2*(-1 + d)*s^2 + 
             4*s*t + 9*t^2)))*GaugeXi[Q] + 
       (2^(1 + d)*Pi^d*s*(s^2 + 3*s*t + 2*t^2) + 
         mw^2*(-((2*Pi)^d*s*(s + 3*t)) + 2^(1 + d)*Pi^d*((-2 + d)*s^2 + 
             4*s*t + 3*t^2)))*GaugeXi[Q]^2 + (mw^2 - s)*
        ((2*Pi)^d*s^2 + 3*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*t^2)*GaugeXi[Q]^3)*
      SPList[SP[p1, q1], SP[q1, q1]])/(mw^4*Pi^(2*d)*s^2*(-1 + GaugeXi[Q])^2*
      GaugeXi[Q]) + (I*2^(1 - 2*d)*EL^6*gAl^2*gAu*gWdu*gWud*gWWA*CKM[1, 1]*
      CKMC[1, 1]*(mw^2*t*((2*Pi)^d*s + 2^(1 + d)*Pi^d*t) - 
       (s*t*((2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 2^(1 + d)*mw^2*Pi^d*
          ((-2 + d)*s^2 + 4*s*t + 4*t^2))*GaugeXi[Q] + 
