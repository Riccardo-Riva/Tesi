...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq^2 - 2*psq*t + t*(s + t))*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
      (-4*psq^3 + mm^2*(psq - s - t)*((-4 + 8*d)*psq - 3*d*s + 4*t - 8*d*t) + 
       2*psq^2*((-6 + d)*s + (4 + d)*t) + (s + t)*((-2 + d)*s^2 + 
         2*(-10 + 3*d)*s*t + 2*d*t^2) - psq*((-2 + d)*s^2 + 
         2*(-16 + 5*d)*s*t + 4*(1 + d)*t^2))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*(-4 + d)*psq^3 + 
       ...
       (-4 + d)*t*(s^2 + 3*s*t + 2*t^2) + psq*(-((-6 + d)*s^2) + 
         2*(-3 + d)*s*t + 6*(-4 + d)*t^2) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (2*(-2*psq^3 - 2*mm^4*s + 2*s^3 + mm^2*s*(s - 3*t) + 7*s^2*t + 
         7*s*t^2 + 2*t^3 + psq^2*(5*s + 6*t) + 
         psq*(5*mm^2*s - 6*(s + t)^2)) + d*(2*psq^3 + mm^4*s - 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(4*(-3 + d)*psq^3 - 
       ...
       (-4 + d)*t*(s^2 + 3*s*t + 2*t^2) + mm^2*(6*(-1 + d)*psq^2 + 
         (6 - 5*d)*psq*s + (-4 + d)*s^2 + (16 - 11*d)*psq*t + 
         5*(-2 + d)*s*t + 5*(-2 + d)*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(-2*psq^2 - 2*psq*s + s^2 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(-4*s + d*(psq + s - t))*
    ...
    (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*
    ...
    (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     ...
     Pi^(2*d) - (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      ((-10 + 3*d)*psq^2 + 2*(-2 + d)*mm^2*s - 8*s^2 + 2*d*s^2 - 14*s*t + 
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*psq*(psq - s - t) + 
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)*
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq^2 + mm^2*s + (s + t)^2 - 
       psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*
      gHll^2*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
     ...
     Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)^2*
