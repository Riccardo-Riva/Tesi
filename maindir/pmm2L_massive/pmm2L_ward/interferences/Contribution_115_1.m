...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 (((-I)*EL^5*gAl*gHll^2*mm^2*s*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
      (mm^2 - psq)^2*s - 
     mm^2*(bb*(-2*gZlL*gZlR*(d*(mm^2 + psq) - 2*s)*(2*psq - s - 2*t) + 
         (-2 + d)*gZlL^2*(mm^4 + psq*(3*psq - s - 2*t) - mm^2*(s + 2*t)) + 
         (-2 + d)*gZlR^2*(mm^4 + psq*(3*psq - s - 2*t) - mm^2*(s + 2*t))) + 
       aa*(2*gZlL*gZlR*(d*(mm^2 + psq) - 2*s)*(2*psq - s - 2*t) + 
         (-2 + d)*gZlL^2*(mm^4 + mm^2*(-4*psq + s + 2*t) + 
           psq*(-psq + s + 2*t)) + (-2 + d)*gZlR^2*
          (mm^4 + mm^2*(-4*psq + s + 2*t) + psq*(-psq + s + 2*t)))))*
    \[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I/2)*EL^5*gAl*gHll^2*mm^2*
   ((2^(1 - 2*d)*(aa - bb)*s*(-2*d*gZlL*gZlR*mm^2 + 
       gZlL^2*((-2 + d)*mm^2 + s) + gZlR^2*((-2 + d)*mm^2 + s))*
      (-2*psq + s + 2*t))/Pi^(2*d) + 
    (bb*(2*gZlL*gZlR*mm^2*(4*s*(-psq + t) + 
          d*(2*psq^2 + mm^2*(2*psq - s - 2*t) - 2*psq*t - s*t)) + 
        gZlL^2*(-2*(-2 + d)*mm^4*(psq - t) + s*(-((-2 + d)*psq^2) + psq*s + 
            s*t) - (-2 + d)*mm^2*(2*psq^2 - s*t - 2*psq*(s + t))) + 
        gZlR^2*(-2*(-2 + d)*mm^4*(psq - t) + s*(-((-2 + d)*psq^2) + psq*s + 
            s*t) - (-2 + d)*mm^2*(2*psq^2 - s*t - 2*psq*(s + t)))) + 
      aa*(gZlL^2*((-2 + d)*mm^4*(2*psq - s - 2*t) - s^2*(psq + t) + 
          (-2 + d)*mm^2*(2*psq^2 - 2*psq*t - s*t)) + 
        gZlR^2*((-2 + d)*mm^4*(2*psq - s - 2*t) - s^2*(psq + t) + 
          (-2 + d)*mm^2*(2*psq^2 - 2*psq*t - s*t)) + 2*gZlL*gZlR*mm^2*
         (4*s*(psq - t) + d*(-2*psq^2 + 2*psq*t + s*t + 
            mm^2*(-2*psq + s + 2*t)))))/(2*Pi)^(2*d) + 
    (bb*(gZlL^2*(-((-2 + d)*mm^4*(2*psq - s - 2*t)) + s^2*(-3*psq + s + t) - 
          (-2 + d)*mm^2*(2*psq^2 - 2*psq*t - s*(s + t))) + 
        gZlR^2*(-((-2 + d)*mm^4*(2*psq - s - 2*t)) + s^2*(-3*psq + s + t) - 
          (-2 + d)*mm^2*(2*psq^2 - 2*psq*t - s*(s + t))) + 
        2*gZlL*gZlR*mm^2*(4*s*(-psq + s + t) + 
          d*(2*psq^2 + mm^2*(2*psq - s - 2*t) - 2*psq*t - s*(s + t)))) + 
      aa*(gZlL^2*(2*(-2 + d)*mm^4*(psq - s - t) + (-2 + d)*mm^2*
           (2*psq^2 + 2*psq*(s - t) - s*(s + t)) - 
          s*((-2 + d)*psq^2 - 3*psq*s + s*(s + t))) + 
        gZlR^2*(2*(-2 + d)*mm^4*(psq - s - t) + (-2 + d)*mm^2*
           (2*psq^2 + 2*psq*(s - t) - s*(s + t)) - 
          s*((-2 + d)*psq^2 - 3*psq*s + s*(s + t))) + 2*gZlL*gZlR*mm^2*
         (-4*s*(-psq + s + t) + d*(-2*psq^2 + 2*psq*t + s*(s + t) + 
            mm^2*(-2*psq + s + 2*t)))))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, p2]] - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*s*
    (-2*d*gZlL*gZlR*mm^2 + gZlL^2*((-2 + d)*mm^2 + s) + 
     gZlR^2*((-2 + d)*mm^2 + s))*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/Pi^(2*d) - (I*4^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (2^(1 + 2*d)*(aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq)*
      s^2 - (aa - bb)*(2*Pi)^(2*d)*(-4*d*gZlL*gZlR*mm^2 + 
       (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*s*
      (2*psq - s - 2*t) + 2*mm^2*s*
      (aa*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq - s - 2*t)) - 
         (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 + psq - s - 2*t) + 
         2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(2*psq - s - 2*t)) + 
       bb*(-(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(2*psq - s - 2*t)) - 
         (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 - 3*psq + s + 2*t) - 
         (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 - 3*psq + s + 2*t))) - 
     2^(1 + 2*d)*Pi^(2*d)*s*
      (bb*(-((-2 + d)*gZlL^2*(psq*(psq - t) + mm^2*(psq - s - t))) - 
       ...
       aa*((-2 + d)*gZlL^2*(mm^2*(psq - t) + psq*(psq - s - t)) + 
         ...
         2*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t))) + 2^(1 + 2*d)*mm^2*Pi^(2*d)*
      (bb*(2*gZlL*gZlR*(-2*s^2 + d*mm^2*(2*psq - s - 2*t) + d*s*(psq - t)) - 
         (-2 + d)*gZlL^2*(psq^2 + mm^2*(psq + s - t) - s*t - psq*(s + t)) - 
         (-2 + d)*gZlR^2*(psq^2 + mm^2*(psq + s - t) - s*t - psq*(s + t))) + 
       aa*((-2 + d)*gZlL^2*(psq^2 + mm^2*(psq - t) - psq*t - s*t) + 
         (-2 + d)*gZlR^2*(psq^2 + mm^2*(psq - t) - psq*t - s*t) + 
         2*gZlL*gZlR*(2*s^2 + d*s*(-psq + t) + d*mm^2*(-2*psq + s + 2*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(4*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
      (mm^2 - psq)^2*s - (aa - bb)*s*(-2*d*gZlL*gZlR*mm^2 + 
       gZlL^2*((-2 + d)*mm^2 + s) + gZlR^2*((-2 + d)*mm^2 + s))*
      (-2*psq + s + 2*t) - bb*(2*gZlL*gZlR*mm^2*(4*s*(-psq + t) + 
         d*(2*psq^2 + mm^2*(2*psq - s - 2*t) - 2*psq*t - s*t)) + 
       gZlL^2*(-2*(-2 + d)*mm^4*(psq - t) + s*(-((-2 + d)*psq^2) + psq*s + 
           s*t) - (-2 + d)*mm^2*(2*psq^2 - s*t - 2*psq*(s + t))) + 
       gZlR^2*(-2*(-2 + d)*mm^4*(psq - t) + s*(-((-2 + d)*psq^2) + psq*s + 
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*s*
    (-2*d*gZlL*gZlR*mm^2 + gZlL^2*((-2 + d)*mm^2 + s) + 
     gZlR^2*((-2 + d)*mm^2 + s))*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/Pi^(2*d) - (I*4^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (2^(1 + 2*d)*(aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq)*
      s^2 - (aa - bb)*(2*Pi)^(2*d)*(-4*d*gZlL*gZlR*mm^2 + 
       (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*s*
      (2*psq - s - 2*t) + 2*mm^2*s*
     ...
     2^(1 + 2*d)*Pi^(2*d)*s*
      ...
      (bb*(-((-2 + d)*gZlL^2*(psq^2 + mm^2*(psq - s - t) + psq*(s - t) - 
            s*(s + t))) - (-2 + d)*gZlR^2*(psq^2 + mm^2*(psq - s - t) + 
           psq*(s - t) - s*(s + t)) + 2*gZlL*gZlR*
          (2*s^2 + d*mm^2*(2*psq - s - 2*t) - d*s*(-psq + s + t))) + 
       aa*((-2 + d)*gZlL^2*(psq^2 + mm^2*(psq - 2*s - t) + psq*(2*s - t) - 
           s*(s + t)) + (-2 + d)*gZlR^2*(psq^2 + mm^2*(psq - 2*s - t) + 
           psq*(2*s - t) - s*(s + t)) + 2*gZlL*gZlR*
          (-2*s^2 + d*s*(-psq + s + t) + d*mm^2*(-2*psq + s + 2*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(4*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (aa*(gZlL^2*((-2 + d)*mm^4*(2*psq - 3*s - 2*t) + 
         s*(-2*(-2 + d)*psq^2 + psq*s + s*t) + (-2 + d)*mm^2*
          (2*psq^2 + 2*psq*(s - t) + s*t)) + 
       gZlR^2*((-2 + d)*mm^4*(2*psq - 3*s - 2*t) + 
         s*(-2*(-2 + d)*psq^2 + psq*s + s*t) + (-2 + d)*mm^2*
          (2*psq^2 + 2*psq*(s - t) + s*t)) + 2*gZlL*gZlR*mm^2*
        (-4*s*(-psq + s + t) + d*(-2*psq^2 - s*t + 2*psq*(s + t) + 
           mm^2*(-2*psq + s + 2*t)))) - 
     bb*(gZlL^2*(2*(-2 + d)*mm^4*(psq - t) + s*((-2 + d)*psq^2 + psq*s + 
           s*t) + (-2 + d)*mm^2*(2*psq^2 + s*t - 2*psq*(2*s + t))) + 
       gZlR^2*(2*(-2 + d)*mm^4*(psq - t) + s*((-2 + d)*psq^2 + psq*s + s*t) + 
         (-2 + d)*mm^2*(2*psq^2 + s*t - 2*psq*(2*s + t))) + 
       2*gZlL*gZlR*mm^2*(-4*s*(-psq + s + t) + 
         d*(-2*psq^2 - s*t + 2*psq*(s + t) + mm^2*(-2*psq + s + 2*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^2*s*
    ((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(mm^2 - psq)*s + 
     mm^2*(aa*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq - s - 2*t)) - 
         (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 + psq - s - 2*t) + 
         2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(2*psq - s - 2*t)) + 
       bb*(-(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(2*psq - s - 2*t)) - 
         (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 - 3*psq + s + 2*t) - 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*s*
    (-2*d*gZlL*gZlR*mm^2 + gZlL^2*((-2 + d)*mm^2 + s) + 
     gZlR^2*((-2 + d)*mm^2 + s))*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*mm^2*(-4*d*gZlL*gZlR*mm^2 + 
     (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*s*
  ...
  (I*2^(1 - 4*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
  ...
  (I*2^(-1 - 8*d)*EL^5*gAl*gHll^2*mm^2*
    (aa*(8^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(6*d)*
        (-2*s + d*(-3*psq + 2*s + 3*t)) + gZlL^2*(2*Pi)^(6*d)*
        (4*(-2 + d)*psq^2 + 2*s^2 + (-2 + d)*mm^2*(8*psq - 5*s - 8*t) - 
         (-2 + d)*psq*(3*s + 4*t)) + gZlR^2*(2*Pi)^(6*d)*
        (4*(-2 + d)*psq^2 + 2*s^2 + (-2 + d)*mm^2*(8*psq - 5*s - 8*t) - 
         (-2 + d)*psq*(3*s + 4*t))) + 
     bb*(8^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(6*d)*(2*s + d*(3*psq - 2*s - 3*t)) + 
       gZlL^2*(2*Pi)^(6*d)*(8*(-2 + d)*mm^4 - 4*(-2 + d)*psq^2 - 2*s^2 - 
         (-2 + d)*mm^2*(16*psq - 5*s - 8*t) + (-2 + d)*psq*(3*s + 4*t)) + 
       gZlR^2*(2*Pi)^(6*d)*(8*(-2 + d)*mm^4 - 4*(-2 + d)*psq^2 - 2*s^2 - 
         (-2 + d)*mm^2*(16*psq - 5*s - 8*t) + (-2 + d)*psq*(3*s + 4*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/Pi^(8*d) + 
  ...
  (I*2^(-1 - 8*d)*EL^5*gAl*gHll^2*mm^2*
    (bb*(-(8^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(6*d)*
         (2*s + d*(-3*psq + s + 3*t))) - gZlR^2*(2*Pi)^(6*d)*
        (4*(-2 + d)*psq^2 - 2*s^2 + (-2 + d)*mm^2*(8*psq - 3*s - 8*t) - 
         (-2 + d)*psq*(s + 4*t)) + gZlL^2*(2*Pi)^(6*d)*(-4*(-2 + d)*psq^2 + 
         2*s^2 - (-2 + d)*mm^2*(8*psq - 3*s - 8*t) + (-2 + d)*psq*
          (s + 4*t))) + aa*(8^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(6*d)*
        (2*s + d*(-3*psq + s + 3*t)) + gZlL^2*(2*Pi)^(6*d)*
        (8*(-2 + d)*mm^4 + 4*(-2 + d)*psq^2 - 2*s^2 - 
         (-2 + d)*psq*(s + 4*t) - (-2 + d)*mm^2*(3*s + 8*t)) + 
       gZlR^2*(2*Pi)^(6*d)*(8*(-2 + d)*mm^4 + 4*(-2 + d)*psq^2 - 2*s^2 - 
         (-2 + d)*psq*(s + 4*t) - (-2 + d)*mm^2*(3*s + 8*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/Pi^(8*d) + 
  (I*EL^5*gAl*gHll^2*mm^2*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*
    (-(bb*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(psq*s + mm^2*(4*psq - 3*s - 4*t)) + 
        (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(psq*s + mm^2*(4*psq - 3*s - 4*t)) - 
        4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t))) + 
     aa*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(-(psq*s) + mm^2*(4*psq - s - 4*t)) + 
       (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(-(psq*s) + mm^2*(4*psq - s - 4*t)) - 
       4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/(2*Pi)^(4*d) - 
  (I*2^(1 - 4*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
    (-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) - 
     gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + s)*(-2*psq + s + 2*t) - 
     gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + s)*(-2*psq + s + 2*t))*
  ...
  (I*4^(-1 - d)*EL^5*gAl*gHll^2*mm^2*(2*aa*(gZlL^2 + gZlR^2)*s*
      (-2*mm^2 + s + 2*t) - 2*bb*(gZlL^2 + gZlR^2)*s*
      (2*mm^2 - 4*psq + s + 2*t) + bb*d*(8*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*mm^2*(-4*d*gZlL*gZlR*mm^2 + 
   ...
   (2*Pi)^(2*d) - (I*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*s*
  ...
  (I*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*s*
  ...
  (I*2^(-1 - 6*d)*EL^5*gAl*gHll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*(2*Pi)^(4*d)*(-(psq*s) + mm^2*(2*psq - s - 2*t)) + 
       (-2 + d)*gZlR^2*(2*Pi)^(4*d)*(-(psq*s) + mm^2*(2*psq - s - 2*t)) + 
       4^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(4*d)*(-2*s + d*(-psq + s + t))) + 
     bb*(4^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(4*d)*(2*s + d*(psq - s - t)) + 
       (-2 + d)*gZlL^2*(2*Pi)^(4*d)*(4*mm^4 - psq*s + 
         mm^2*(-6*psq + 3*s + 2*t)) + (-2 + d)*gZlR^2*(2*Pi)^(4*d)*
        (4*mm^4 - psq*s + mm^2*(-6*psq + 3*s + 2*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*
    (bb*(2^(1 + 4*d)*gZlL*gZlR*mm^2*Pi^(4*d)*(2*s + d*(psq - s - t)) + 
       gZlL^2*(2*Pi)^(4*d)*(2*(-2 + d)*mm^4 - s^2 - (-2 + d)*mm^2*
          (3*psq - s - t)) + gZlR^2*(2*Pi)^(4*d)*(2*(-2 + d)*mm^4 - s^2 - 
         (-2 + d)*mm^2*(3*psq - s - t))) + 
     aa*(gZlL^2*(2*Pi)^(4*d)*(s*(-((-2 + d)*psq) + s) + 
         (-2 + d)*mm^2*(psq - t)) + gZlR^2*(2*Pi)^(4*d)*
        (s*(-((-2 + d)*psq) + s) + (-2 + d)*mm^2*(psq - t)) + 
       2^(1 + 4*d)*gZlL*gZlR*mm^2*Pi^(4*d)*(-2*s + d*(-psq + s + t))))*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*
    (bb*(2^(1 + 4*d)*gZlL*gZlR*mm^2*Pi^(4*d)*(-2*s + d*(psq - t)) + 
       gZlL^2*(2*Pi)^(4*d)*(s*(-((-2 + d)*psq) + s) - (-2 + d)*mm^2*
          (psq - s - t)) + gZlR^2*(2*Pi)^(4*d)*(s*(-((-2 + d)*psq) + s) - 
         (-2 + d)*mm^2*(psq - s - t))) + 
     aa*(2^(1 + 4*d)*gZlL*gZlR*mm^2*Pi^(4*d)*(2*s + d*(-psq + t)) + 
       gZlL^2*(2*Pi)^(4*d)*(2*(-2 + d)*mm^4 - s^2 - (-2 + d)*mm^2*
          (psq + t)) + gZlR^2*(2*Pi)^(4*d)*(2*(-2 + d)*mm^4 - s^2 - 
         (-2 + d)*mm^2*(psq + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*
    (2*(aa - bb)*(-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
        ...
        (-2*psq + s + 2*t)) + aa*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
        (2*psq - s - 2*t) + gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + 
         (-2 + d)*psq^2 - 2*psq*s - (-2 + d)*mm^2*(4*psq - s - 2*t) + 
         s*(s + 2*t)) + gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + (-2 + d)*psq^2 - 
         2*psq*s - (-2 + d)*mm^2*(4*psq - s - 2*t) + s*(s + 2*t))) - 
     bb*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*mm^4) - (-2 + d)*psq^2 - 2*psq*s + 
         (-2 + d)*mm^2*(s + 2*t) + s*(s + 2*t)) + gZlR^2*(2*Pi)^(2*d)*
        (-((-2 + d)*mm^4) - (-2 + d)*psq^2 - 2*psq*s + 
         (-2 + d)*mm^2*(s + 2*t) + s*(s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/(2*Pi)^(4*d) + 
  (I*EL^5*gAl*gHll^2*mm^2*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
      (mm^2 - psq)*s + aa*(gZlL^2*(2*Pi)^(2*d)*
        (-s^2 + (-2 + d)*mm^2*(2*psq - s - 2*t)) + gZlR^2*(2*Pi)^(2*d)*
        (-s^2 + (-2 + d)*mm^2*(2*psq - s - 2*t)) - 2^(1 + 2*d)*d*gZlL*gZlR*
        mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
     bb*(gZlL^2*(2*Pi)^(2*d)*(s*(-((-2 + d)*psq) + s) - 
         2*(-2 + d)*mm^2*(psq - s - t)) - gZlR^2*(2*Pi)^(2*d)*
        (((-2 + d)*psq - s)*s + 2*(-2 + d)*mm^2*(psq - s - t)) + 
       2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(2*Pi)^(4*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
    (-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) - 
     gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + s)*(-2*psq + s + 2*t) - 
     gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + s)*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(4^(2*d)*Pi^(4*d)) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll^2*mm^2*(-2*bb*(gZlL^2 + gZlR^2)*s*
      (4*mm^2 - 5*psq + s + t) + 2*aa*(gZlL^2 + gZlR^2)*s*
      (-2*mm^2 + psq + s + t) + bb*d*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*s*
   ...
   Pi^(2*d) - (I*2^(-1 - 6*d)*EL^5*gAl*gHll^2*mm^2*
  ...
  (I*EL^5*gAl*gHll^2*mm^2*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
     ...
     aa*(gZlL^2*(2*Pi)^(2*d)*(s*(-((-2 + d)*psq) + s) + 
       ...
       2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(2*Pi)^(4*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
    (-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) - 
     gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + s)*(-2*psq + s + 2*t) - 
     gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + s)*(-2*psq + s + 2*t))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*(-4*d*gZlL*gZlR*mm^2 + 
     (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
  ...
  (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*
    mm^2*(-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*
    mm^2*(-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*
    mm^2*(-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*
    mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*
    mm^2*(-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
