...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (psq*(4*psq + (-6 + d)*s - 4*t) + mm^2*(4*psq - (2 + d)*s - 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(mm^2 - psq)*
     (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (psq*(4*psq - (-2 + d)*s - 4*t) + mm^2*(4*psq + (-2 + d)*s - 4*t))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
     ((-6 + d)*mm^2 - (-2 + d)*psq)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (12*psq^2 + 2*(-2 + d)*mm^2*s - 8*s^2 + 3*d*s^2 + 12*s*t + 12*t^2 - 
      2*psq*((-2 + d)*s + 12*t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     ...
     gXll^2*mm^4*(mm^2*(6*psq - 14*s + 3*d*s - 6*t) + 
   ...
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(mm^2 - psq)*
   ...
   (2^(7 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*
     gXll^2*mm^4*(psq*(2*psq + 4*s - d*s - 2*t) + 
      mm^2*(-6*psq - 8*s + 3*d*s + 6*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(7 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^6*
     ...
     mm^6*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gXll^2*mm^4*
     (4*psq^2 + 4*mm^2*s - 4*s^2 + d*s^2 - 8*psq*t + 4*s*t + 4*t^2)*
