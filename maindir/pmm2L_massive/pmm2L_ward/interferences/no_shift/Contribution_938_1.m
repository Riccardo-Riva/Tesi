...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*2^(3 - 2*d)*EL^5*gAl^5*mm^4*s*
     (aa*((-2 + d)*mm^2 + (2 + d)*psq - d*(s + 2*t)) + 
      bb*((-2 + d)*mm^2 + (2 - 3*d)*psq + d*(s + 2*t)))*\[Mu]^(8 - 2*d))/
    Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^5*mm^2*(4*aa*d*mm^2*(psq - t) + 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*mm^2*s*(-2*psq + s + 2*t)*
   ...
   (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^5*mm^2*(mm^2 - psq)*s*
   ...
   (I*4^(2 - d)*EL^5*gAl^5*(aa*mm^2*(2*psq + s - 2*t) + 
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*(2*psq^2 + psq*(s - 2*t) + 
      2*mm^2*(psq - s - t) - s*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
   (I*2^(5 - 2*d)*EL^5*gAl^5*s*(bb*(psq - s - t) + 
      aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
   (I*4^(2 - d)*(-2 + d)*EL^5*gAl^5*mm^2*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
    Pi^(2*d) + (I*2^(5 - 2*d)*EL^5*gAl^5*mm^2*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    Pi^(2*d) + (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl^5*
     (2*aa*(-1 + d)*mm^2*(2*psq - s - 2*t) - aa*(-4 + d)*s*(psq - t) - 
      bb*(-4 + d)*s*(psq + t) - 2*bb*mm^2*(2*(-1 + d)*psq + (5 - 2*d)*s - 
        2*(-1 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl^5*
     (bb*(4*psq^2 + (-2 + d)*psq*s + 4*(-1 + d)*mm^2*(psq - s - t) - 
        4*psq*t + (-2 + d)*s*t) + aa*(-4*psq^2 + (2 + d)*psq*s + 4*psq*t - 
        (-2 + d)*s*t + mm^2*(-4*(-1 + d)*psq + 2*(-2 + d)*s + 4*(-1 + d)*t)))*
   ...
   (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^5*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(5 - 2*d)*EL^5*gAl^5*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
