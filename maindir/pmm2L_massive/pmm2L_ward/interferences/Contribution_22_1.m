...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (I*bb*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(4^d*Pi^(2*d)) - 
  (I*aa*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa + bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*(psq - s - t)*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*(aa*(psq - s - t) + bb*(-psq + t))*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - s - t) + aa*(mm^2 - 2*psq + s + t))*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - t) + aa*(mm^2 - 2*psq + t))*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - t) + aa*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^4*mm^4*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
