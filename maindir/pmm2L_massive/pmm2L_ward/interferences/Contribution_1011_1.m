...
PropList[KiraPropagator[-q1, mm], KiraPropagator[-q1 - q2, mw], 
 ...
 ((I*4^(-1 - d)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(psq - s)*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*4^(-1 - d)*(-2 + d)^2*EL^5*gWlN^2*
    gWNl^2*gWWA*(psq - s)*s*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*s*(-psq + s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*
    gWWA*(mm^2 - psq)*s*(aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
    (psq - 2*s)*(-(bb*(2*mm^2 - 3*psq + s + t)) + aa*(-psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(psq - 2*s)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(psq - 2*s)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(psq - 2*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(psq - 2*s)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(psq - 2*s)*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(psq - s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(psq - s)*
  ...
  (I*4^(1 - d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(2*psq - s - 2*t)*
  ...
  (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
  ...
  (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(bb*(psq - t) + 
     ...
     SP[p3, p3]])/(2*Pi)^(2*d) - (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
   ...
   (2*Pi)^(2*d) - (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*
    gWWA*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
  ...
  (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*
    gWWA*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
  ...
  (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*
    gWWA*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
   ...
   (4^d*Pi^(2*d)) - (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*
  ...
  (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*
    gWWA*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*
  ...
  (I*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gWlN^2*
    gWNl^2*gWWA*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*
