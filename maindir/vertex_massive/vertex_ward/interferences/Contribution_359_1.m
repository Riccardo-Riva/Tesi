...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*mm^2*s*
  ...
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*(bb*gZlR*mm^2*((10 + d)*psq - 4*s)*s + 
     aa*gZlR*mm^2*s*(-((10 + d)*psq) + 4*s) - 
     bb*gZlL*((-4 + d)*mm^4*(psq - s) + psq*s*((-4 + d)*psq + 2*s) + 
       mm^2*((-4 + d)*psq^2 + (-2 + d)*psq*s - 2*s^2)) + 
     aa*gZlL*(psq*((-4 + d)*psq - 2*s)*s + mm^4*((-4 + d)*psq + 2*s) + 
       mm^2*((-4 + d)*psq^2 + 2*s^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2*Pi)^(2*d) - ((-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*mm^2*
    (aa*(gZlR*s*((2 - 3*d)*psq + (-2 + d)*s) + 
       gZlL*(psq*((-4 + d)*psq - (-2 + d)*s) + mm^2*((-4 + d)*psq + d*s))) - 
     bb*(gZlR*s*((2 - 3*d)*psq + (-2 + d)*s) + 
       gZlL*(mm^2*((-4 + d)*psq - (-2 + d)*s) + psq*((-4 + d)*psq + d*s))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*s*(2*bb*gZlR*mm^2*((-2 + d)*psq - s) + 
     2*aa*gZlR*mm^2*(-((-2 + d)*psq) + s) + 
     aa*gZlL*(2*mm^4 + (-6 + d)*psq*s + mm^2*(-((-6 + d)*psq) + 2*s)) + 
     bb*gZlL*((-6 + d)*mm^4 - 2*psq*s - mm^2*(2*psq + (-6 + d)*s)))*
  ...
  (2^(-1 - 4*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*s*
   ...
   Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
    (-(aa*gZlR*mm^2*((2 + d)*psq - 2*s)) + bb*gZlR*mm^2*((2 + d)*psq - 2*s) + 
     aa*gZlL*(psq*((-4 + d)*psq - 2*s) + mm^2*((-4 + d)*psq + 4*s)) - 
     bb*gZlL*(mm^2*((-4 + d)*psq - 2*s) + psq*((-4 + d)*psq + 4*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
    (aa*mm^2*(2*gZlL*mm^2 + (2 - 3*d)*gZlR*psq + (-2 + d)*gZlL*s + 
       (-2 + d)*gZlR*s) - bb*(gZlL*psq*(2*mm^2 + (-2 + d)*s) + 
       gZlR*mm^2*((2 - 3*d)*psq + (-2 + d)*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
    (2*aa*gZlR*mm^2*((-2 + d)*psq - s) + bb*gZlL*((-4 + d)*mm^2 + 6*psq)*s - 
     aa*gZlL*(6*mm^2 + (-4 + d)*psq)*s + 2*bb*gZlR*mm^2*
      (-((-2 + d)*psq) + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
   Pi^(2*d) + EL^5*gAl*gWlN*gWNl*gZNL*
   (-((4^(1 - d)*(aa - bb)*(-2 + d)*gZlL*(mm^2 + psq)*s)/Pi^(2*d)) + 
  ...
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
    (aa*((-4 + d)*psq^2 + mm^2*((-4 + d)*psq - 2*s)) + 
     bb*psq*(-((-4 + d)*mm^2) + 4*psq - d*psq + 2*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
   (-((4^(1 - d)*(aa - bb)*gZlL*(mm^2 + psq)*s)/Pi^(2*d)) + 
    (bb*(2*gZlL*mm^2*((-4 + d)*psq - 4*s) - (-2 + d)*gZlR*mm^2*(4*psq - s) + 
        gZlL*psq*(2*(-4 + d)*psq - (-8 + d)*s)) + 
      aa*((-2 + d)*gZlR*mm^2*(4*psq - s) + 2*gZlL*psq*(-((-4 + d)*psq) + 
          4*s) + gZlL*mm^2*(-2*(-4 + d)*psq + (-8 + d)*s)))/(2*Pi)^(2*d))*
   \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]] + 
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
    (aa*mm^2*((-2 + d)*gZlR*(4*psq - s) - (-4 + d)*gZlL*s) + 
     bb*(-((-2 + d)*gZlR*mm^2*(4*psq - s)) + (-4 + d)*gZlL*psq*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*(aa*(-6 + d)*gZlR*mm^2*s - 
     bb*(-6 + d)*gZlR*mm^2*s + bb*gZlL*(-((-8 + d)*mm^4) + d*psq*s + 
       mm^2*(-((-8 + d)*psq) + 2*(-4 + d)*s)) + 
     aa*gZlL*((-8 + d)*mm^4 - 2*(-4 + d)*psq*s + mm^2*((-8 + d)*psq - d*s)))*
  ...
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
    (-(bb*(psq*((-4 + d)*psq + 4*s) + mm^2*((-4 + d)*psq - (-2 + d)*s))) + 
     aa*(mm^2*((-4 + d)*psq + 4*s) + psq*((-4 + d)*psq - (-2 + d)*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(-2*aa*mm^2 - bb*(-6 + d)*mm^2 + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*(-2 + d)^2*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(aa*mm^2 - bb*psq)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZNL*
    (aa*(-6*gZlR*mm^2 + d*(gZlL + gZlR)*mm^2 + 4*gZlL*psq) - 
     bb*((-6 + d)*gZlR*mm^2 + gZlL*(4*mm^2 + d*psq)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(8 - 6*d + d^2)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
    ...
    (bb*(2*(-4 + d)*gZlL*mm^2 - (-6 + d)*gZlR*mm^2 + d*gZlL*psq) + 
     aa*(-6*gZlR*mm^2 + d*gZlR*mm^2 + 8*gZlL*psq - d*gZlL*(mm^2 + 2*psq)))*
  ...
  (2^(1 - 2*d)*(12 - 8*d + d^2)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
    ...
    gZNL*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
