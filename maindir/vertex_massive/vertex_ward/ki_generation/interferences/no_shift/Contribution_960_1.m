...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl^3*gFll^2*mm^4*
      (aa*(d*mm^2*(2*psq - s) + d*(3*psq - s)*s + 2*s*(-psq + s)) - 
       bb*(d*(psq - s)*s + 2*s*(-2*mm^2 + psq + s) + d*mm^2*(2*psq + s)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d)) + 
   (2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gFll^2*mm^4*(mm^2 - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
   (EL^5*gAl^3*gFll^2*mm^2*s*(aa*((-2 + d)*mm^4 - (-2 + d)*psq*s + 
        mm^2*(2*psq - 9*d*psq - 2*s + 3*d*s)) + 
      bb*((-2 + d)*mm^4 - (-2 + d)*psq*s + mm^2*((2 + 7*d)*psq - (2 + d)*s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2*Pi)^(2*d) - 
   (4^(1 - d)*EL^5*gAl^3*gFll^2*mm^4*(aa*((2 - 3*d)*psq + (-2 + d)*s) + 
   ...
   (2^(1 - 2*d)*EL^5*gAl^3*gFll^2*mm^2*(2*bb*(-3*mm^2 + psq)*s + 
   ...
   (2^(1 - 2*d)*EL^5*gAl^3*gFll^2*mm^2*(4*bb*mm^2*s - 2*aa*psq*s - 
