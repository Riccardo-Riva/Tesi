 ...
 (((-I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^4*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^4*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
    (aa*mm^2*(3*psq - 2*s - 3*t) + bb*psq*(psq - t) + aa*psq*(-psq + s + t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^4*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(2*mm^2 + psq)*
  ...
  (I*(aa - bb)*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(2*mm^2 + psq)*
  ...
  (I*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(bb*(mm^2 + psq - s - 2*t) + 
     aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(bb*(mm^2 - t) + aa*(-psq + t))*
