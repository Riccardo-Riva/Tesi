...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   ((-3*2^(1 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*mm^2*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*(psq - t)*
    ...
    (3*4^(1 - d)*(-1 + d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*mm^2*
     ...
     (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*
    ...
    (2^(1 - 2*d)*(-3 + 2*d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
    ...
    (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*(psq - t)*
      ((-6 + 4*d)*psq + (8 - 5*d)*s + 6*t - 4*d*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*(psq - t)*
      ((10 - 6*d)*psq + (-8 + 5*d)*s + 2*(-5 + 3*d)*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
     Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWWA*gWWAZ*(gZlL + gZlR)*
