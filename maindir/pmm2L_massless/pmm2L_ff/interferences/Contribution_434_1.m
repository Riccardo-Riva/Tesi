...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFAZ*(gZlL + gZlR)*mm^2*t*
       (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d))/(mz^2*Pi^(2*d)*s)) + 
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFFAZ*(gZlL + gZlR)*(s + t)*
      (2*t*((-4 + d)*s + (-2 + d)*t) + mm^2*((2 + d)*s + 4*d*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mz^2*Pi^(2*d)*s) + 
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFFAZ*(gZlL + gZlR)*t*
      (2*(s + t)*(2*s + (-2 + d)*t) - mm^2*((2 + d)*s + 4*d*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(mz^2*Pi^(2*d)*s) - 
    (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFFAZ*(gZlL + gZlR)*mm^2*((2 + d)*s + 4*d*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
    (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFAZ*(gZlL + gZlR)*t*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFAZ*(gZlL + gZlR)*mm^2*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)*s) + 
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFFAZ*(gZlL + gZlR)*
