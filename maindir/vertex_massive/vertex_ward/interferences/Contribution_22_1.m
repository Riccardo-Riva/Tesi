...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[-q1, mm], 
 ...
 (-(((aa + bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*(mm^2 - s)*s*
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
  (EL^5*gAl*gXll^4*mm^4*(bb*(2*mm^2 - s)*(-(psq*s) + mm^2*(-4*psq + s)) + 
     aa*(8*mm^4*psq - psq*s^2 + mm^2*s*(-4*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*gXll^4*mm^4*(aa*(2*mm^2 - s)*(mm^2*(4*psq - s) + psq*s) + 
     bb*(-8*mm^4*psq + mm^2*(4*psq - s)*s + psq*s^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 + psq - s)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 + psq - s)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (EL^5*gAl*gXll^4*mm^4*s*(bb*(mm^4 - 5*mm^2*psq - psq*s) + 
     aa*(mm^4 + 3*mm^2*psq + psq*s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2*Pi)^(2*d) + (EL^5*gAl*gXll^4*mm^4*s*(aa*psq*s - 3*bb*psq*s + 
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 + psq)*(2*mm^2 - s)*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(2*aa*mm^4 + aa*mm^2*(4*psq - s) + 
     aa*psq*s - bb*psq*s + bb*mm^2*(-6*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(4*aa*mm^4 + aa*mm^2*(4*psq - s) + 
     aa*psq*s - bb*psq*s + bb*mm^2*(-8*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 + psq - s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(4*mm^4 + mm^2*(4*psq - 3*s) - 
     psq*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*psq*s - 3*bb*psq*s + 
     bb*mm^2*(-8*psq + s) + aa*mm^2*(8*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*psq*s - 2*bb*psq*(2*mm^2 + s) + 
     aa*mm^2*(4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gXll^4*mm^6*(aa*mm^2 - bb*psq)*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*psq*s - 2*bb*psq*(2*mm^2 + s) + 
     aa*mm^2*(4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(aa*mm^2 - bb*psq)*s*
