...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   ((I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
      (aa*(psq + s - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
    (I*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
      (aa*(psq - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
    (I*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*s*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(2*Pi)^(2*d) - 
    (I*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*s*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2*Pi)^(2*d) - 
    (I*4^(1 - d)*aa*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*
    ...
    (I*4^(1 - d)*bb*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
      (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*
      gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*
      mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
     ...
     (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*
      mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      gXll^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      gXll^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      gXll^2*mm^2*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(psq - t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      gXll^2*mm^2*(aa*(mm^2 - psq - s) + bb*(mm^2 - psq + s))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
     ...
     Pi^(2*d) - (I*2^(3 - 2*d)*bb*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*
      gXll^2*mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*bb*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
     ...
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*
