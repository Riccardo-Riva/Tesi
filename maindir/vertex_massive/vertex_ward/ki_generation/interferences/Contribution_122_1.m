...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
   ...
   (((-I)*(aa + bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^4*(mm^2 - psq)*psq*
      s*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
    ...
    (I*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*s*
      (2*aa*psq^2 + bb*mm^2*(psq - s - t) + aa*mm^2*(-3*psq + s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^4*
      (aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + bb*psq*(-psq + t) + 
       bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
    (I*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*s*(-2*bb*psq^2 + 
    ...
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
      (aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + bb*psq*(-psq + t) + 
       ...
       SP[q2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*
      gWNl*mm^2*(-2*aa*psq^2 + aa*mm^2*(3*psq - s - t) + 
    ...
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
      (aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + bb*psq*(-psq + t) + 
       ...
       SP[q2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*
      gWNl*mm^2*(-2*bb*psq^2 + aa*mm^2*(psq - t) + bb*mm^2*(psq + t))*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gAl*gFll^2*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*bb*(-2 + d)*EL^5*gAl*gFll^2*
    ...
    (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
      ...
      gWNl*mm^2*(bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*bb*(-2 + d)*EL^5*gAl*gFll^2*
      gWlN*gWNl*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
