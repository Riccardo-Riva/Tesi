...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 (((-I)*(aa - bb)*(-1 + 4*d)*EL^5*gWlN*gWNl*gWWA^3*s^2*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa - bb)*(-1 + 4*d)*EL^5*gWlN*gWNl*gWWA^3*s^2*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*(-1 + 4*d)*EL^5*gWlN*gWNl*gWWA^3*s^2*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*s*
    ((-21 + 19*d)*s + (-20 + 19*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*s*(s + (-20 + 19*d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-14 + 15*d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + 2*t)*
  ...
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*s*
    ((-9 + 5*d)*s + (-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*s*(s + (-8 + 5*d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(2*Pi)^(2*d) + 
  ((7*I)*4^(-1 - d)*(aa - bb)*d*EL^5*gWlN*gWNl*gWWA^3*s*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*s*
    ((-9 + 5*d)*s + (-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/Pi^(2*d) + 
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*s*((-2 + 7*d)*s + 7*d*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*s*(7*s + 9*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*s*
    ((-9 + 5*d)*s + (-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*s*(2*s + 7*d*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*s*((-14 + d)*s - 6*(2 + d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*
    gWNl*gWWA^3*s*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   Pi^(2*d) + (I*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*s*(s + t)*
  ...
  (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*((-17 + 10*d)*s + 2*(-8 + 5*d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*
    ((-9 + 5*d)*s + (-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*((-19 + 10*d)*s + 2*(-8 + 5*d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*
    (7*s + 9*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*
    ((-9 + 5*d)*s + (-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + t)*
  ...
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*(3*s + 2*(-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(3*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(3*s + 4*t)*
  ...
  (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*(s + 2*(-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(2*s + 9*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*(s + (-8 + 5*d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA^3*t*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*((-9 + 5*d)*s + (-8 + 5*d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*
    ((-9 + 5*d)*s + (-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*(s + (-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p3, q1]])/(4^d*Pi^(2*d)) + 
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*((-9 + 5*d)*s + (-8 + 5*d)*t)*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*((-1 + d)*s + (-2 + d)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(7*s + 9*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*
    ((-9 + 5*d)*s + (-8 + 5*d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*(-5 + 3*d)*EL^5*gWlN*gWNl*gWWA^3*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*((-9 + 5*d)*s + (-8 + 5*d)*t)*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*
    (-2*t + d*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p2, q2]])/Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*(-2*s + (-2 + d)*t)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[p3, q1]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*(s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*(-16*t + d*(s + 10*t))*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-3 + 2*d)*EL^5*gWlN*gWNl*gWWA^3*t*\[Mu]^(8 - 2*d)*
