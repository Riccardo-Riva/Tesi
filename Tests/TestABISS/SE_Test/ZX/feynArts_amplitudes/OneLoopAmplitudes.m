...
{((-I/16)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   PolarizationVector[V[20], FourMomentum[Incoming, 1], Index[Lorentz, 1]])/
  Pi^4, ((-I/16)*FeynAmpDenominator[PropagatorDenominator[
  ...
  Pi^4, ((-I/16)*FeynAmpDenominator[PropagatorDenominator[
     ...
     FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], ML]]*
   MatrixTrace[NonCommutative[ML + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    I*EL*(gZlL*NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
        ...
        DiracMatrix[Index[Lorentz, 1]], ChiralityProjector[1]])]*
   PolarizationVector[V[20], FourMomentum[Incoming, 1], Index[Lorentz, 1]])/
  Pi^4, (((-3*I)/16)*FeynAmpDenominator[PropagatorDenominator[
  ...
  Pi^4, (((-3*I)/16)*FeynAmpDenominator[PropagatorDenominator[
   ...
   MatrixTrace[NonCommutative[MD + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    NonCommutative[MD + DiracSlash[-FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]]], 
    I*EL*(gZdL*NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
  ...
  Pi^4, (((-3*I)/16)*FeynAmpDenominator[PropagatorDenominator[
   ...
   MatrixTrace[NonCommutative[MB + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    I*EL*(gZdL*NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
        ...
        DiracMatrix[Index[Lorentz, 1]], ChiralityProjector[1]])]*
   PolarizationVector[V[20], FourMomentum[Incoming, 1], Index[Lorentz, 1]])/
  Pi^4, (EL^2*gHXX*gHXZ*FeynAmpDenominator[PropagatorDenominator[
     FourMomentum[Internal, 1], MH], PropagatorDenominator[
     FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MZ]]*
   (CW^2*MH^2*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] + 
    MW^2*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]] + 
    MW^2*FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      Index[Lorentz, 1]] + CW^2*MH^2*FourVector[-FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], Index[Lorentz, 1]])*
   PolarizationVector[V[20], FourMomentum[Incoming, 1], Index[Lorentz, 1]])/
  (16*CW^2*Pi^4), (EL^2*gHXZ*gHZZ*FeynAmpDenominator[
    PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MZ]]*FourVector[-FourMomentum[Outgoing, 1], 
    Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
   MetricTensor[Index[Lorentz, 2], Index[Lorentz, 3]]*
   PolarizationVector[V[20], FourMomentum[Incoming, 1], Index[Lorentz, 1]])/
  (8*Pi^4), (EL^2*gFZW*gXFW*FeynAmpDenominator[PropagatorDenominator[
   ...
   MetricTensor[Index[Lorentz, 2], Index[Lorentz, 3]]*
   PolarizationVector[V[20], FourMomentum[Incoming, 1], Index[Lorentz, 1]])/
  (8*Pi^4*SW), (EL^2*gFZW*gXFW*FeynAmpDenominator[
