...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  (((-I)*(-2 + d)*EL^5*gFFA*gFll*gFZW*gWlN*gZlL*mm^2*s*sw*
   ...
   (I*(aa - bb)*d*EL^5*gFFA*gFll*gFZW*gWlN*gZlR*mm^2*s*sw*(-2*psq + s + 2*t)*
   ...
   (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gFZW*gWlN*mm^2*sw*(aa*(-4 + d)*gZlR*s - 
   ...
   (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gFFA*gFll*gFZW*gWlN*gZlR*mm^2*sw*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gFFA*gFll*gFZW*gWlN*gZlR*
