...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 (((-I)*4^(-1 - d)*EL^5*gWlN*gWNl*gXFAW*gXFW*(bb*psq*(3*psq - s - 3*t) - 
     aa*psq*(3*psq + s - 3*t) + aa*mm^2*(psq + s - t) + 
     bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gWlN*gWNl*gXFAW*gXFW*(bb*psq*(3*psq - 4*s - 3*t) + 
     aa*mm^2*(psq - t) + bb*mm^2*(-psq + 2*s + t) + 
     aa*psq*(-3*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   Pi^(2*d) - (I*(aa + bb)*EL^5*gWlN*gWNl*gXFAW*gXFW*(mm^2 - psq)*s*
  ...
  (I*(aa - bb)*EL^5*gWlN*gWNl*gXFAW*gXFW*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gWlN*gWNl*gXFAW*gXFW*(-psq + s + t)*\[Mu]^(8 - 2*d)*
