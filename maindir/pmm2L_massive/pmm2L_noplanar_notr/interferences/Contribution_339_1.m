  ...
  ((4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (4*psq^3 - 2*psq^2*((-4 + d)*s + 4*t) + 
      mm^2*(-4*psq^2 + 2*(-2 + d)*psq*s + (-2 + d)*s^2 + 8*psq*t - 4*s*t - 
        4*t^2) + psq*(3*(-2 + d)*s^2 - 4*s*t + 4*t^2) + 
      s*(-((-2 + d)*s^2) + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ((-2 + d)*mm^4*s + mm^2*(-2*psq^2 + 5*psq*s + (3 - 2*d)*s^2 + s*t + 
        2*t^2) - (psq - s)*(2*psq^2 + s^2 + psq*(s - d*s - 4*t) + 3*s*t + 
        2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (mm^2 - psq - s)*(2*psq - d*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^2*((-2 + d)*mm^4*s - (psq - s)*(2*psq^2 + t*(s + 2*t) - 
        psq*((-3 + d)*s + 4*t)) + mm^2*(6*psq^2 - 2*(-2 + d)*s^2 + 3*s*t + 
        2*t^2 - psq*(s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^4*(mm^2 - psq - s)*(2*psq + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ((-2 + d)*mm^4*s + s^2*((5 - 2*d)*psq + (-3 + d)*s) + 
      mm^2*(4*psq^2 + (-5 + 3*d)*s^2 + 4*s*t + 4*t^2 - 
        psq*((2 + d)*s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^4*(4*psq^2 + (-8 + 3*d)*mm^2*s + (8 - 3*d)*psq*s - 8*s^2 + 5*d*s^2 - 
      8*psq*t + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(4*mm^4*s - (psq - s)*(4*psq^2 + (-4 + d)*s^2 + 4*s*t + 4*t^2 - 
        2*psq*((-4 + d)*s + 4*t)) + mm^2*(4*psq^2 + (-8 + 3*d)*s^2 + 4*s*t + 
        4*t^2 - 2*psq*((-2 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (4^(1 + d)*(-1 + d)*mm^4*Pi^(2*d)*s + (2*Pi)^(2*d)*s*
       (8*psq^2 - 5*(-4 + d)*psq*s + 2*(-4 + d)*s^2 - 16*psq*t + 8*s*t + 
        8*t^2) + mm^2*(2*Pi)^(2*d)*(8*psq^2 + (-24 + 11*d)*s^2 + 8*s*t + 
        8*t^2 - 4*psq*((-1 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(-psq^2 + (-3 + d)*psq*s + mm^2*(psq + (-3 + d)*s - t) + 3*psq*t - 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (4*mm^4 - 8*psq^2 + (-7 + 2*d)*mm^2*s + psq*(s + 2*d*s + 8*t) - 
      2*(s^2 + 2*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^2*(2*mm^4 + psq^2 - s^2 + s*t + 2*t^2 - 
      mm^2*(psq - (-3 + d)*s + t) - psq*((-8 + d)*s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (4*psq*s + s^2 - d*s^2 + mm^2*(2*psq - s - 2*t) - 2*psq*t + s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (4*psq^2 + mm^2*(12*psq + (-16 + d)*s - 12*t) + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     gXll*(gZlL - gZlR)*mm^2*(psq^2 + s*((-6 + d)*s - 2*t) + psq*(5*s - t) + 
      mm^2*(-5*psq + 3*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^2*(2*psq^2 + s^2 + 
      mm^2*(4*psq + (-6 + d)*s - 4*t) + psq*(s - d*s - 4*t) + 3*s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*mm^4 + 3*psq^2 + mm^2*(-3*psq + (-2 + d)*s + t) + t*(3*s + 2*t) - 
      psq*((-5 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(mm^2*(4*psq + 2*s - 3*d*s - 4*t) + s*((-6 + d)*psq + 6*s + 4*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (-6*psq^2 + 4*s^2 - d*s^2 + 2*mm^2*(psq + s - d*s - t) - 4*s*t - 4*t^2 + 
      2*psq*((-3 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^2*(3*psq^2 + mm^2*(psq + 2*s - d*s - t) + 
      2*t*(s + t) - psq*((-2 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (psq^2 + mm^2*(psq + (-2 + d)*s - t) + t*(-s + 2*t) - 
      psq*((-5 + d)*s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(4*psq^2 + 2*s^2 - d*s^2 - 6*psq*t + 3*s*t + 2*t^2 + 
      mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^2*(4*psq^2 - 8*s^2 + 2*d*s^2 + 
      psq*(-3*(-2 + d)*s - 8*t) + 6*s*t + 4*t^2 + 
      mm^2*(-12*psq + (-4 + d)*s + 12*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (4*psq^2 - 4*s^2 + d*s^2 + 4*mm^2*(psq - s - t) + 4*s*t + 4*t^2 - 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
     gXll*(gZlL - gZlR)*mm^2*(-psq^2 + mm^2*(5*psq - 2*s - 5*t) + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(-(s*((2 + d)*psq + 2*(s - 2*t))) + 
      mm^2*(4*psq + 3*(-2 + d)*s - 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*psq^2 - 4*s^2 + d*s^2 + 2*mm^2*(psq + (-2 + d)*s - t) + 4*s*t + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(3*mm^2 - psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*mm^2 - 7*psq + 3*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*mm^2 - psq - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
