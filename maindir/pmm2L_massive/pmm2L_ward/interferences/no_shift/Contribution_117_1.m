...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
  ...
  (((-I)*(aa + bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^4*(mm^2 - psq)*psq*s*
   ...
   (I*(aa - bb)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*s*((-2 + d)*mm^2 + 2*s)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
     (-((-2 + d)*mm^2) + (-2 + d)*psq - 2*s)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^4*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
    Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*s*
   ...
   (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
     (aa*(2*(-2 + d)*psq^2 - 6*psq*s - (-2 + d)*mm^2*(3*psq - s - t) + 
        2*s*(s + t)) + bb*((-2 + d)*mm^2*(psq - s - t) - 
        2*s*(-3*psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gWlN*
     gWNl*mm^2*s*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
     (aa*(-2*(-2 + d)*psq^2 + 4*psq*s + (-2 + d)*mm^2*(4*psq - s - 2*t) - 
        2*s*(s + 2*t)) + bb*(-2*(-2 + d)*psq^2 - 4*psq*s + 
        ((-2 + d)*mm^2 + 2*s)*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*s*
     (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
     ((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2]])/Pi^(2*d) - 
   (I*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*s*(bb*(psq - s - t) + 
   ...
   (I*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*s*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*
     gWNl*mm^2*(mm^2 + psq)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll^2*gWlN*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gFll^2*gWlN*gWNl*mm^2*
     (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
