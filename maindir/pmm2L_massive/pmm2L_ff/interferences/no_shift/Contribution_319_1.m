...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(psq^2 - 2*psq*t + t*(s + t))*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(6*psq^2 + 4*mm^2*s + 5*s^2 + 
      10*s*t + 6*t^2 - 2*psq*(7*s + 6*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(-7*psq^3 + 3*psq^2*(s + 6*t) - 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*
     mm^6*(psq - t)*(psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*
     mm^4*(psq - t)*(2*psq^2 + mm^2*(psq - t) - 4*psq*t + t*(s + 2*t))*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^2 + s)*(-2*psq + s + 2*t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(-4*psq^3 + 3*psq^2*(s + 4*t) + 
