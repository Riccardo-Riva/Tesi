...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (((-I)*(aa + bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(mm^2 - psq)*psq*
  ...
  (I*4^(-1 - d)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    ...
    SPList[SP[p1, q1]])/Pi^(2*d) + (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gWlN^2*
    gWNl^2*s*(bb*(-4*(-2 + d)*psq^2 + 6*psq*s + (-2 + d)*mm^2*
        (5*psq - s - t) - 2*s*(s + t)) + aa*(-2*(-2 + d)*psq^2 - 6*psq*s + 
       2*s*(s + t) + (-2 + d)*mm^2*(psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*
    gWNl^2*s*((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(-1 - d)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (bb*(2*mm^4*(psq - t) + psq*s*(-4*psq + 3*s + 4*t) + 
     ...
     aa*(2*mm^4*(psq - s - t) + psq*s*(-4*psq + s + 4*t) + 
       mm^2*(2*psq^2 - 2*psq*(2*s + t) + s*(3*s + 4*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gWlN^2*
    gWNl^2*s*(-(aa*(-4*(-2 + d)*psq^2 + 2*psq*s + 2*s*t + 
        (-2 + d)*mm^2*(3*psq + t))) + bb*(-((-2 + d)*mm^2*(3*psq - t)) + 
       2*((-2 + d)*psq^2 + psq*s + s*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s*((-2 + d)*mm^2 + 2*s)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa + bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (mm^2 - psq)*(mm^2 - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (mm^2 + psq)*s*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa + bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (mm^2 - psq)*psq*s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
    (bb*(-2*(-2 + d)*psq^2 + 4*psq*s + (-2 + d)*mm^2*(4*psq - s - 2*t) - 
       2*s*(s + 2*t)) + aa*(-2*(-2 + d)*psq^2 - 4*psq*s + 
       ((-2 + d)*mm^2 + 2*s)*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*((-2 + d)*mm^2 + 2*s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   (2*Pi)^(2*d) + (I/2)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
   (((aa - bb)*s*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s))/(2*Pi)^(2*d) + 
    (2^(1 - 2*d)*s*(bb*s - aa*((-2 + d)*mm^2 + 2*psq - d*psq + s)))/
     Pi^(2*d) + (2^(1 - 2*d)*s*(-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + 
         s)))/Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*(mm^2 + psq)*
      (2*psq - s - 2*t))/Pi^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, p2], SP[p1, q1]] + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN^2*
    gWNl^2*(aa*(2*(-2 + d)*psq^2 + 16*psq*s + (-2 + d)*mm^2*
        (2*psq - 3*s - 4*t) - 2*s*(3*s + 4*t)) + 
     bb*(6*(-2 + d)*psq^2 - 16*psq*s - (-2 + d)*mm^2*(10*psq - 3*s - 4*t) + 
       2*s*(3*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
   Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
    ((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I/2)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
   (((aa - bb)*s*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s))/(2*Pi)^(2*d) + 
    (2^(1 - 2*d)*s*(bb*s - aa*((-2 + d)*mm^2 + 2*psq - d*psq + s)))/
     Pi^(2*d) + (2^(1 - 2*d)*s*(-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + 
         s)))/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-2 + d)*(mm^2 + psq)*
      (2*psq - s - 2*t))/Pi^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, p2], SP[p2, q1]] - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN^2*
    gWNl^2*(-6*aa*(-2 + d)*psq^2 + bb*(-2 + d)*mm^2*(6*psq - s - 4*t) + 
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*((-2 + d)*mm^2 + 2*s)*
   ...
   (2*Pi)^(2*d) - (I*4^(-1 - d)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*s*
    (aa*(-2*mm^2 + s + 2*t) - bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(mm^2 + psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) - (I*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s*
  ...
  (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gAl*gWlN^2*
    gWNl^2*(mm^2 - 2*s)*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(mm^2 - 2*s)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s*
    (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(mm^2 - 2*s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
   Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s*
    (aa*((-2 + d)*mm^2 + 2*psq - d*psq - s) + 
     bb*(2*(-2 + d)*mm^2 + 4*psq - 2*d*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
    ((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/Pi^(2*d) - 
  (I*4^(-1 - d)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*s*
    (-(bb*(4*mm^2 - 5*psq + s + t)) + aa*(-2*mm^2 + psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(mm^2 + psq)*
  ...
  (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*s*(-2*psq + s + 2*t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gAl*gWlN^2*
    gWNl^2*(mm^2 - 2*s)*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
  ...
  (I*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s*
    (bb*((-2 + d)*mm^2 + 2*psq - d*psq - s) + 
     aa*(2*(-2 + d)*mm^2 + 4*psq - 2*d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(mm^2 + psq)*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*s*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*((-2 + d)*mm^2 - 
     (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p1, q2]])/(2*Pi)^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  ((3*I)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*((-2 + d)*mm^2 - 
     ...
     SP[p2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) + (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN^2*
    gWNl^2*(-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
    (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gAl*gWlN^2*
    gWNl^2*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*((-2 + d)*mm^2 - 
     ...
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN^2*
    gWNl^2*(-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/Pi^(2*d) + 
  (I*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(aa*(psq - s - t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*
    gWNl^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*
    (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gAl*gWlN^2*
    gWNl^2*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(bb*(psq - t) + 
     ...
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*
    gAl*gWlN^2*gWNl^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*
    gWNl^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d))
