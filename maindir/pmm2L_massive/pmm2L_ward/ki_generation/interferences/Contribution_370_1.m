...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
   ...
   ((I*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*s*(aa*mm^2*(psq - t) + 
       aa*psq*(psq - s - t) + bb*psq*(-psq + t) + bb*mm^2*(-psq + s + t))*
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + (I*d*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*
    ...
    (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFFA*gFll*gWNl*mm^2*s*(psq - t)*
