...
(I*EL^6*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   s*userIntegral[A4, {ml}, -2, 1, 1, 0])/((2*Pi)^d*(mz^2 - s)^2*
   ...
   (gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s - 
      ...
      2^(1 + d)*gZuR*gZuRC*Pi^d*(s + d*s + t)))*userIntegral[A4, {ml}, -1, 0, 
 ...
 (I*2^(-1 - 2*d)*EL^6*(gZlL^2 + gZlR^2)*
   ...
   userIntegral[A4, {ml}, 0, -1, 1, 0])/(Pi^(2*d)*(mz^2 - s)^2*
   (-mzC^2 + s)) + (I*EL^6*(gZlL^2 + gZlR^2)*
   (gZlR*gZlRC*(gZuR*gZuRC*((-2 + d)*s + (-4 + d)*t) - 
      gZuL*gZuLC*((-4 + d)*s + (-2 + d)*t)) + 
    gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s + (-4 + d)*t) - 
      gZuR*gZuRC*((-4 + d)*s + (-2 + d)*t)))*userIntegral[A4, {ml}, 0, 0, 0, 
 ...
 (I*2^(-1 - d)*EL^6*(gZlL^2 + gZlR^2)*
   (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
    ...
    gZlR*gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
      gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*userIntegral[A4, {ml}, 0, 0, 1, -1])/
  (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
 ((I/4)*EL^6*((2^(3 - d)*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*ml^2*s)/Pi^d - 
    (2^(2 - d)*(gZlL^2 + gZlR^2)*(gZlR*gZlRC*(-((-2 + d)*gZuL*gZuLC) + 
         (-4 + d)*gZuR*gZuRC) + gZlL*gZlLC*((-4 + d)*gZuL*gZuLC - 
         (-2 + d)*gZuR*gZuRC))*ml^2*(s + t))/Pi^d + 
   ...
   userIntegral[A4, {ml}, 0, 0, 1, 0])/((mz^2 - s)^2*(-mzC^2 + s)) - 
 (I*2^(-1 - d)*EL^6*(gZlL^2 + gZlR^2)*
   (gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
    gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + (-2 + d)*gZuR*gZuRC))*t*
   userIntegral[A4, {ml}, 0, 1, -1, 0])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
 (I*2^(-1 - d)*EL^6*(gZlL^2 + gZlR^2)*
   (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
    gZlR*gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
      gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*userIntegral[A4, {ml}, 0, 1, 0, -1])/
  (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
 ((I/4)*EL^6*((2^(2 - d)*(gZlL^2 + gZlR^2)*
      (gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
       gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + (-2 + d)*gZuR*gZuRC))*ml^2*t)/
     Pi^d - (2^(2 - d)*(gZlL^2 + gZlR^2)*
      (gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
    ...
    (gZlL^3*gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
        ...
        gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 + 
            (14 - 7*d + d^2)*s*t + 2*t^2))) + gZlR^3*gZlRC*
       (gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*((4 - 3*d + d^2)*s^2 + 
            (4 - 5*d + d^2)*s*t - 2*t^2)) + gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
          2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 + (14 - 7*d + d^2)*s*t + 2*t^2))) + 
      gZlL*gZlLC*gZlR^2*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
          2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
        gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((8 - 7*d + d^2)*s^2 + 
            (2 - 3*d + d^2)*s*t + 2*t^2))) + gZlL^2*gZlR*gZlRC*
       (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
            (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
          2^(1 + d)*Pi^d*((8 - 7*d + d^2)*s^2 + (2 - 3*d + d^2)*s*t + 
            2*t^2))))/(2*Pi)^(2*d))*userIntegral[A4, {ml}, 0, 1, 0, 0])/
  ((mz^2 - s)^2*(-mzC^2 + s)) + 
 (I*EL^6*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
   (gZuL*gZuLC + gZuR*gZuRC)*s*userIntegral[A4, {ml}, 0, 1, 1, -2])/
  ((2*Pi)^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
 (I*2^(-1 - 2*d)*EL^6*(2^(2 + d)*(gZlL^2 + gZlR^2)*(gZlL*gZlLC + gZlR*gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*ml^2*Pi^d*s + (gZlL^2 + gZlR^2)*ml^2*(2*Pi)^d*
     (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
        gZuR*gZuRC*((-4 + d)*s + 2*t)) - gZlR*gZlRC*
       (gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 2*t))) - 
    (gZlL^2 + gZlR^2)*(2*Pi)^d*s*(gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
        gZuR*gZuRC*((-4 + d)*s + 2*t)) - gZlR*gZlRC*
       (gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 2*t))) + 
    ...
    (gZlL^2 - gZlR^2)*s*(gZlL*gZlLC*(gZuL*gZuLC*((-5 + d)*d*(2*Pi)^d*s + 
       ...
       (-(gZuR*gZuRC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            (3*s + (-3 + d)*t))) + gZuL*gZuLC*(-((-5 + d)*d*(2*Pi)^d*s) + 
          2^(1 + d)*Pi^d*((-6 + d)*s + (-3 + d)*t)))))*
   userIntegral[A4, {ml}, 0, 1, 1, -1])/(Pi^(2*d)*(mz^2 - s)^2*
   ...
   userIntegral[A4, {ml}, 0, 1, 1, 0])/(Pi^(4*d)*(mz^2 - s)^2*(-mzC^2 + s))
