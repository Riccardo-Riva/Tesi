...
PropList[KiraPropagator[-p3 + q1, mh], KiraPropagator[-p3 - q2, mm], 
 ...
 ((I*EL^5*gAl*gHll^2*mm^4*(mm^2 - psq)*s*
       ...
       bb*(4*gZlL*gZlR*mm^2*(-2*s + d*(-psq + s + t)) + 
         gZlL^2*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - t) + 2*s*t + 
           ...
           (-2 + d)*mm^2*(psq - t) + 2*s*t + psq*(6*s - 2*d*s + 2*t - 
             d*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(4*d) - 
  (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*(mm^2 - psq)*
  ...
  (I*4^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*((gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
      (mm^2 - psq)*s*(aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) - 
     2^(1 + 2*d)*mm^2*Pi^(2*d)*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*(mm^2 - psq) + 4*gZlL*gZlR*(2*psq - s - 2*t)) + 
       bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
         4*gZlL*gZlR*(-2*psq + s + 2*t))) + 2*(aa - bb)*mm^2*
      ((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq)*(2*psq - s - 2*t) + 
       (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 + psq)*(2*psq - s - 2*t) - 
       2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(d*mm^2*(3*psq - s - 3*t) + 
         d*psq*(psq - s - t) + 2*s*(-mm^2 - psq + s + 2*t))) + 
     (2*Pi)^(2*d)*(mm^2 - psq)*(bb*(-4*gZlL*gZlR*mm^2*(2*s + d*(-psq + t)) + 
    ...
    SPList[SP[p2, q2]])/Pi^(4*d) + (I*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 - psq)*s*(aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll^2*mm^2*s*((gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) - 
     2*mm^2*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*
          (mm^2 - psq) + 4*gZlL*gZlR*(2*psq - s - 2*t)) + 
       bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
         4*gZlL*gZlR*(-2*psq + s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa + bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)^2*
    s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll^2*mm^2*s*
    (bb*(-((-2 + d)*gZlL^2*(mm^2 - psq)*psq) - (-2 + d)*gZlR^2*(mm^2 - psq)*
        psq + 4*gZlL*gZlR*mm^2*(2*psq - s - 2*t)) + 
     aa*(-((-2 + d)*gZlL^2*(mm^2 - psq)*psq) - (-2 + d)*gZlR^2*(mm^2 - psq)*
        psq + 4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/Pi^(2*d) - (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
    (-(bb*d*(2*Pi)^(2*d)*(4*gZlL*gZlR*mm^2*(-psq + s + t) + 
     ...
     (aa - bb)*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + (-8 + d)*psq*s + 
         (-2 + d)*psq*t + 2*s*(s + 2*t) + mm^2*(-3*(-2 + d)*psq + d*s - 6*t + 
           3*d*t)) + gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 
         (-8 + d)*psq*s + (-2 + d)*psq*t + 2*s*(s + 2*t) + 
         mm^2*(-3*(-2 + d)*psq + d*s - 6*t + 3*d*t))) - 
     2^(1 + 2*d)*Pi^(2*d)*(bb*(2*gZlL*gZlR*mm^2*(2*s + d*(-psq + t)) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
  ...
  (I*4^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(psq - s - t)) + 
       gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 2*(-3 + d)*psq*s - 
         (-2 + d)*mm^2*(psq - t) + (-2 + d)*psq*t - 2*s*t) + 
       gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 2*(-3 + d)*psq*s - 
         (-2 + d)*mm^2*(psq - t) + (-2 + d)*psq*t - 2*s*t)) + 
     (gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) + 
     aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*s + d*(-psq + s + t)) + 
       gZlL^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - 2*s - t) + 
         2*s*t + psq*(2*s + 2*t - d*t)) + gZlR^2*(2*Pi)^(2*d)*
        ((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - 2*s - t) + 2*s*t + 
         psq*(2*s + 2*t - d*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(4*d) + 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (3*mm^2 - psq)*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (3*mm^2 - psq)*(aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 4*d)*EL^5*gAl*gHll^2*mm^2*((gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) + 
     (aa - bb)*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + (-8 + d)*psq*s + 
         (-2 + d)*psq*t + 2*s*(s + 2*t) + mm^2*(-3*(-2 + d)*psq + d*s - 6*t + 
           3*d*t)) + gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 
         (-8 + d)*psq*s + (-2 + d)*psq*t + 2*s*(s + 2*t) + 
         mm^2*(-3*(-2 + d)*psq + d*s - 6*t + 3*d*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/Pi^(4*d) + (I/2)*EL^5*gAl*gHll^2*mm^2*
   (-((2^(1 - 2*d)*(aa - bb)*mm^2*((-2 + d)*gZlL^2*(2*psq - s - 2*t) + 
        (-2 + d)*gZlR^2*(2*psq - s - 2*t) + 2*gZlL*gZlR*
         (2*s + d*(-psq + t))))/Pi^(2*d)) + 
    (2^(1 - 2*d)*(gZlL^2 + gZlR^2)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
    ...
    ((aa - bb)*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + (-8 + d)*psq*s + 
         (-2 + d)*psq*t + 2*s*(s + 2*t) + mm^2*(-3*(-2 + d)*psq + d*s - 6*t + 
           3*d*t)) + gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 
         (-8 + d)*psq*s + (-2 + d)*psq*t + 2*s*(s + 2*t) + 
         mm^2*(-3*(-2 + d)*psq + d*s - 6*t + 3*d*t))))/(2*Pi)^(4*d) - 
    (bb*d*(2*Pi)^(2*d)*(4*gZlL*gZlR*mm^2*(-psq + s + t) + 
        gZlL^2*(2*psq^2 + mm^2*s - 3*psq*s - 2*psq*t) + 
        gZlR^2*(2*psq^2 + mm^2*s - 3*psq*s - 2*psq*t)) + 
      2^(1 + 2*d)*aa*Pi^(2*d)*(4*gZlL*gZlR*mm^2*s + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
   ...
   Pi^(2*d) + (I*4^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (2^(1 + 2*d)*(aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq)*
      s + 4^(1 + d)*(aa - bb)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*s + d*(psq - t)) - 
     2^(1 + 2*d)*(aa - bb)*Pi^(2*d)*(-4*d*gZlL*gZlR*mm^2 + 
       (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*
      (2*psq - s - 2*t) + bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
        (2*s + d*(psq - s - t)) + gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 
         2*(-3 + d)*psq*s - (-2 + d)*mm^2*(psq - t) + (-2 + d)*psq*t - 
         2*s*t) + gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 2*(-3 + d)*psq*s - 
         (-2 + d)*mm^2*(psq - t) + (-2 + d)*psq*t - 2*s*t)) + 
     (gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) + 
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (mm^2 - psq)*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^2*mm^2*(-4*gZlL*gZlR*mm^2*s - 
  ...
  (I*4^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(-psq + t)) + 
       ...
       gZlR^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + (-8 + d)*psq*s + 
         (-2 + d)*mm^2*(psq - s - t) - (-2 + d)*psq*t + 2*s*(s + t))) + 
     (gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) - 
     bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(-psq + t)) + 
       gZlL^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq + s - t) + 
         2*s*(s + t) - psq*((4 + d)*s + (-2 + d)*t)) + 
       gZlR^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq + s - t) + 
         2*s*(s + t) - psq*((4 + d)*s + (-2 + d)*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/Pi^(4*d) + 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (3*mm^2 - psq)*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
     ...
     (aa - bb)*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) - 2*psq*s + (-2 + d)*psq*t + 
         2*s*(s + 2*t) + mm^2*(-3*(-2 + d)*psq + 2*(-3 + d)*s + 
           3*(-2 + d)*t)) + gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) - 
         2*psq*s + (-2 + d)*psq*t + 2*s*(s + 2*t) + 
         mm^2*(-3*(-2 + d)*psq + 2*(-3 + d)*s + 3*(-2 + d)*t))))*
   ...
   (-((2^(1 - 2*d)*(aa - bb)*mm^2*((-2 + d)*gZlL^2*(2*psq - s - 2*t) + 
    ...
    ((aa - bb)*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) - 2*psq*s + (-2 + d)*psq*t + 
         ...
         mm^2*(-3*(-2 + d)*psq + 2*(-3 + d)*s + 3*(-2 + d)*t))))/
     (2*Pi)^(4*d) + 
    (aa*(d*(2*Pi)^(2*d)*(gZlL^2*(2*psq^2 - mm^2*s + psq*(s - 2*t)) + 
          gZlR^2*(2*psq^2 - mm^2*s + psq*(s - 2*t)) + 4*gZlL*gZlR*mm^2*
           (-psq + t)) + 2^(1 + 2*d)*Pi^(2*d)*(4*gZlL*gZlR*mm^2*s + 
          gZlL^2*(-2*psq^2 + s*(2*mm^2 + s + t) + psq*(-5*s + 2*t)) + 
          gZlR^2*(-2*psq^2 + s*(2*mm^2 + s + t) + psq*(-5*s + 2*t)))) - 
      bb*(2^(1 + 2*d)*Pi^(2*d)*(4*gZlL*gZlR*mm^2*s + 
          gZlL^2*(-2*psq^2 + s*(s + t) + psq*(-3*s + 2*t)) + 
          gZlR^2*(-2*psq^2 + s*(s + t) + psq*(-3*s + 2*t))) + 
        d*(2*Pi)^(2*d)*(4*gZlL*gZlR*mm^2*(-psq + t) + 
          gZlL^2*(2*psq^2 + mm^2*s - psq*(s + 2*t)) + 
          gZlR^2*(2*psq^2 + mm^2*s - psq*(s + 2*t)))))/(2*Pi)^(4*d))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
   ...
   Pi^(2*d) + (I*4^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^2*
    (2^(1 + 2*d)*(aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq)*
      s - 2^(1 + 2*d)*(aa - bb)*Pi^(2*d)*(-4*d*gZlL*gZlR*mm^2 + 
       (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*
      (2*psq - s - 2*t) - 4^(1 + d)*(aa - bb)*gZlL*gZlR*mm^2*Pi^(2*d)*
      (-2*s + d*(-psq + s + t)) + aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
        (2*s + d*(-psq + t)) + gZlL^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + 
         (-8 + d)*psq*s + (-2 + d)*mm^2*(psq - s - t) - (-2 + d)*psq*t + 
         2*s*(s + t)) + gZlR^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + 
         (-8 + d)*psq*s + (-2 + d)*mm^2*(psq - s - t) - (-2 + d)*psq*t + 
         2*s*(s + t))) + (gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) - 
     bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(-psq + t)) + 
       gZlL^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq + s - t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*s*
    (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
