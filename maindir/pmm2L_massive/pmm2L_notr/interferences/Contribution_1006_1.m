  ...
  ((2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*mm^4*(psq - t) + s*(2*(6 + d)*psq^2 + (10 - 7*d)*psq*s + 
        2*(-2 + d)*s^2 - 24*psq*t + 8*s*t + 8*t^2) - 
      2*mm^2*(4*psq^2 + (4 + d)*psq*s - 3*d*s^2 - 6*psq*t + 2*t*(-s + t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     ...
     SPList[SP[p2, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*mm^4*(-psq + s + t) - 2*mm^2*((-2 + d)*psq*s + (4 - 3*d)*s^2 - 
        2*psq*t + 6*s*t + 2*t^2) + s*(2*(-2 + d)*psq^2 + (18 - 7*d)*psq*s + 
        2*(-2 + d)*s^2 - 8*psq*t + 8*s*t + 8*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (mm^2*(4*psq^2 - 2*(4 + d)*s^2 + 4*psq*(s - 2*t) + 4*s*t + 4*t^2) - 
      s*(8*psq^2 + (2 - 3*d)*psq*s + 2*(-2 + d)*s^2 - 16*psq*t + 8*s*t + 
        8*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (mm^2*(4*psq^2 - 2*(4 + d)*s^2 + 4*psq*(s - 2*t) + 4*s*t + 4*t^2) - 
      s*(8*psq^2 + (2 - 3*d)*psq*s + 2*(-2 + d)*s^2 - 16*psq*t + 8*s*t + 
        8*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(2*(-4 + d)*mm^4*s + s*(16*psq^2 + (-34 + 3*d)*psq*s + 
        8*s^2) + mm^2*(4*psq^2 - 2*(-12 + d)*s^2 + 4*s*t + 4*t^2 - 
        2*psq*((4 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) - (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(12*psq^2 + 2*s^2 + d*s^2 + mm^2*(-8*psq + (8 + d)*s) + 
      4*s*t + 4*t^2 - psq*((12 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*mm^4 + 2*psq^2 - 4*s^2 + d*s^2 + psq*(15*s - 4*d*s - 4*t) + 4*t^2 - 
      2*mm^2*(psq + 3*s - 2*d*s + t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*psq^2 + d*(2*mm^2 - s)*s + psq*(s - d*s - 8*t) + 4*(s^2 + s*t + t^2))*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (9*mm^2 - 13*psq - (-7 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*psq^2 + 2*(3 + d)*mm^2*s + 5*s^2 + 4*s*t + 4*t^2 - 
      2*psq*((5 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq^2 - 3*(-2 + d)*psq*s + 2*(-2 + d)*s^2 + 
      2*mm^2*(2*psq + (-4 + d)*s - 2*t) + 2*psq*t + 4*s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq^2 - 3*(-2 + d)*psq*s + 2*(-2 + d)*s^2 + 
      2*mm^2*(2*psq + (-4 + d)*s - 2*t) + 2*psq*t + 4*s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(4*mm^4 + 2*psq^2 + 
      2*s*((-6 + d)*s - 6*t) + psq*((22 - 3*d)*s + 2*t) + 
      2*mm^2*(-6*psq + (-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(4*mm^4 + 2*psq^2 + 
      2*s*((-6 + d)*s - 6*t) + psq*((22 - 3*d)*s + 2*t) + 
      2*mm^2*(-6*psq + (-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq^2 + psq*((-10 + d)*s - 2*t) + 
      2*s*(-((-4 + d)*mm^2) + (-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq^2 + psq*((-10 + d)*s - 2*t) + 
      2*s*(-((-4 + d)*mm^2) + (-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-6*psq^2 + (7 + d)*psq*s - 
      4*s^2 + d*s^2 + mm^2*(4*psq - d*s - 4*t) + 8*psq*t - 3*s*t - 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(-5*psq^2 + (7 + d)*psq*s - 4*s^2 + d*s^2 + 
      mm^2*(3*psq - d*s - 3*t) + 7*psq*t - 3*s*t - 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-4*psq^2 + (7 + d)*psq*s - 
      4*s^2 + d*s^2 + mm^2*(2*psq - d*s - 2*t) + 6*psq*t - 3*s*t - 2*t^2)*
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(psq^2 + mm^2*(psq + (-4 + d)*s - t) - 
      psq*((2 + d)*s + t) + s*(-((-6 + d)*s) + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(4*mm^4 + 6*psq^2 - 
      2*mm^2*(2*psq + 4*s - d*s + 2*t) - psq*(4*s + 3*d*s + 2*t) + 
      2*s*(d*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(-4*mm^4 + mm^2*(4*psq + (13 - 2*d)*s) + 
      s*(2*(-7 + d)*psq + (-2 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*mm^4 + 3*psq^2 + psq*((-15 + d)*s - t) + 
      mm^2*(psq - (-9 + d)*s - t) + s*(d*s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 + 
      mm^2*(-4*psq + 2*(2 + d)*s + 4*t) - 2*psq*(d*s + 6*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, p3]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(4*mm^2*(psq - 3*s - t) + 
      s*(-8*psq + 16*s - 3*d*s + 6*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-8*psq^2 - 18*s^2 + 
      4*d*s^2 + 2*mm^2*(psq - (-4 + d)*s - t) - 6*s*t - 4*t^2 + 
      psq*((6 + d)*s + 12*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    (mz^2*(2*Pi)^(2*d)*s^2) - (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (6*mm^2 + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-8*psq^2 - 2*s^2 + d*s^2 + mm^2*(4*psq + 8*s - 2*d*s - 4*t) - 8*s*t - 
      4*t^2 + 2*psq*(d*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq^2 + s*((-6 + d)*s - 4*t) + 2*psq*(3*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(4*mm^4 + 6*psq^2 - 
      2*mm^2*(2*psq + 4*s - d*s + 2*t) - psq*(4*s + 3*d*s + 2*t) + 
      2*s*(d*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(-2*mm^4 + psq^2 + s*((-4 + d)*s - 4*t) + 
      psq*((-6 + d)*s + t) + mm^2*(-psq + 10*s - d*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*psq^2 - 7*psq*s + (-2 + d)*s^2 + mm^2*(-4*psq + 6*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 + 
      mm^2*(-4*psq + 2*(2 + d)*s + 4*t) - 2*psq*(d*s + 6*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, p3]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*psq^2 + (-18 + d)*psq*s - 
      (-12 + d)*s^2 - 2*psq*t + 10*s*t - 2*mm^2*(-2*psq + (2 + d)*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(5*psq^2 - 8*psq*s + 7*s^2 - d*s^2 - 7*psq*t + 5*s*t + 
      2*t^2 + mm^2*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-6*psq^2 + s^2 + 
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(3*s^2 - d*s^2 + 
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(psq^2 + (-7 + d)*psq*s + (-2 + d)*s^2 + 
      mm^2*(psq + 3*s - d*s - t) - psq*t + 4*s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*s^2 + d*s^2 + 2*mm^2*(2*psq + d*s - 2*t) + 4*s*t + 4*t^2 - 
      2*psq*((-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, p3]])/(mz^2*Pi^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(4*mm^2*(psq + 2*s - t) + 
      s*(-4*psq - 10*s + 3*d*s + 6*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(16*s^2 - 4*d*s^2 + 
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) - (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (6*mm^2 - 4*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q1, q2]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*(-6 + d)*psq*s + 2*s^2 + d*s^2 - 2*mm^2*(2*psq + (-6 + d)*s - 2*t) + 
      4*psq*t - 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq^2 - 2*psq*(2*s + t) + s*((-2 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-4*psq^2 + 8*mm^2*s + 
      12*psq*s - 18*s^2 + 3*d*s^2 + 8*psq*t - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*mm^2 + (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s) + (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(-4*psq^2 + 8*mm^2*s - 6*s^2 + 3*d*s^2 - 4*s*t - 4*t^2 + 
      4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-4*psq^2 + (-8 + d)*s^2 - 4*s*t - 4*t^2 + 8*psq*(s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*psq^2 + 2*(-2 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
      2*psq*((-2 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
      SP[q1, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-4*psq^2 + (-4 + d)*s^2 - 4*s*t - 4*t^2 + 4*psq*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*psq^2 + 2*(-6 + d)*mm^2*s - 6*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (mm^2 - psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/
    (mz^2*Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p1, p2], SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p1, q2]])/
    (mz^2*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(2*mm^2 - 8*psq + d*s + 6*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*mm^2 + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (mm^2 - 3*psq + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
      SP[p2, q1]])/(mz^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (mm^2 - 5*psq + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
      SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
   ...
   (2^(1 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s) - (2^(1 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p3, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
   (4^(1 - d)*(-11 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/
    (mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - 
   (2^(1 - 2*d)*(-7 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/
    (mz^2*Pi^(2*d)*s) - (4^(1 - d)*(-7 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
   ...
   (3*4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-psq + 2*s + t)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (mm^2 - psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
      SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-2*psq + (-2 + d)*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, p3]])/
    (4^d*mz^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-psq + 2*s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-6*psq + (6 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p1, q1], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) - 
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*psq - 5*s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
   (3*4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p1, q2], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (mm^2 - psq - (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
      SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(6*psq + (-6 + d)*s - 6*t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-8*mm^2 + 10*psq - 2*s + 
      d*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[q2, q2]])/
    (mz^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggpgpA*
     ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
      SP[p2, q2]])/(mz^2*Pi^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(6*psq + (-6 + d)*s - 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[p3, p3]])/
    (mz^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(6*psq + (-10 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-mm^2 + psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
      SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-2*psq + (-2 + d)*s + 2*t)*
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p3, p3], SP[p3, q1]])/(4^d*mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-2*psq + (-2 + d)*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], SP[p3, q2]])/
    (4^d*mz^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - 2*s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (6*psq + (-18 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p3, q1], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq + 7*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (3*4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p3, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*psq + (-4 + d)*s - 2*t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-psq + s + t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-psq + s + t)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-6*psq + d*s + 6*t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
      SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-8*mm^2 + 6*psq + d*s + 
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
      SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*psq + (-8 + d)*s - 2*t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-6*psq + d*s + 6*t)*
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(6*psq - (-4 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*mm^2 - psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, p3]])/
    (mz^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(4*mm^2 + 2*psq - 6*s + d*s - 6*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-6*psq + (4 + d)*s + 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], SP[p3, q1]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, p3], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-2*psq + s + 2*t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
   (3*2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq + s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/
    (mz^2*Pi^(2*d)*s^2) - (3*4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
   ...
   (3*2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq + s - t)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggpgpA*
     ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p2, q1], SP[p3, p3]])/(4^d*mz^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(6*psq + d*s - 6*t)*
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*ggpgpA*
     ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
      SP[p2, q2]])/(mz^2*Pi^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*psq + (-4 + d)*s - 2*t)*
   ...
   (3*4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p2, q2], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*psq + (-4 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3], SP[p3, q1]])/
    (4^d*mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p3, p3], SP[p3, q2]])/(4^d*mz^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*psq + s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], SP[p3, q1]])/
    (mz^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(-6*psq + (-8 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p3, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq + s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-6*psq + (-12 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p3, q1], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq + (-6 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p3, q2], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p2, q2], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, p3], SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*psq - (-6 + d)*s - 2*t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
    ...
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (6*psq + (-2 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, p3], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
 ...
 PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mz], 
  ...
  (-((2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*mm^4*(psq - s - t) + s*(-2*(-2 + d)*psq^2 + (-18 + 7*d)*psq*s - 
        2*(-2 + d)*s^2 + 8*psq*t - 8*s*t - 8*t^2) + 
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(4*mm^4 + 6*psq^2 - 
      ...
      2*s*(d*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(4*mm^4 + s*(-2*(-7 + d)*psq - (-2 + d)*s) + 
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-8*psq^2 - 18*s^2 + 4*d*s^2 + 2*mm^2*(psq - (-4 + d)*s - t) - 6*s*t - 
      4*t^2 + psq*((6 + d)*s + 12*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(6*mm^2 + (-2 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-8*psq^2 - 2*s^2 + d*s^2 + mm^2*(4*psq + 8*s - 2*d*s - 4*t) - 8*s*t - 
      4*t^2 + 2*psq*(d*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*psq^2 - 2*psq*(3*s + t) + 
      s*(-((-6 + d)*s) + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(4*mm^4 + 6*psq^2 - 
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     ...
     SPList[SP[p1, q2], SP[p2, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-4*psq^2 + mm^2*(4*psq - 6*s) + 7*psq*s - (-2 + d)*s^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 + 
      mm^2*(-4*psq + 2*(2 + d)*s + 4*t) - 2*psq*(d*s + 6*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, p3]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq^2 - (-18 + d)*psq*s + (-12 + d)*s^2 + 2*psq*t - 10*s*t + 
      mm^2*(-4*psq + 2*(2 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-5*psq^2 + 8*psq*s - 7*s^2 + d*s^2 + mm^2*(psq - t) + 7*psq*t - 5*s*t - 
   ...
   (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q2, q2]])/(mz^2*Pi^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq^2 + 3*(-4 + d)*psq*s - 2*(-4 + d)*s^2 + 
      mm^2*(4*psq + 4*s - 2*d*s - 4*t) + 2*psq*t + 4*s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq^2 + 3*(-4 + d)*psq*s - 2*(-4 + d)*s^2 + 
      mm^2*(4*psq + 4*s - 2*d*s - 4*t) + 2*psq*t + 4*s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p2, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq^2 + 2*s*((-4 + d)*mm^2 + 4*s - d*s + 2*t) - psq*(d*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (2*psq^2 + 2*s*((-4 + d)*mm^2 + 4*s - d*s + 2*t) - psq*(d*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     ...
     SPList[SP[p2, p3], SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-psq^2 + 3*s^2 - d*s^2 + mm^2*(3*psq + (-3 + d)*s - 3*t) + s*t + 
      2*t^2 - psq*((2 + d)*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(3*s^2 - d*s^2 + 
      mm^2*(2*psq + (-2 + d)*s - 2*t) + s*t + 2*t^2 - psq*((3 + d)*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-2*psq^2 - 4*s^2 + d*s^2 + 2*mm^2*(3*psq + (-4 + d)*s - 3*t) + 4*s*t + 
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     ...
     SPList[SP[p3, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(4*psq^2 - 8*mm^2*s + 
      18*s^2 - 3*d*s^2 + 4*s*t + 4*t^2 - 4*psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) - 
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (4*mm^2 + (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
    (mz^2*Pi^(2*d)*s) + (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
    ...
    (mz^2*Pi^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     ...
     SPList[SP[p3, q2], SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     ...
     SPList[SP[p1, p3], SP[p2, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     (-mm^2 + psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p2, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) - 
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(6*psq + (-6 + d)*s - 6*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[p3, p3]])/
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
   ...
   (EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(6*psq + (-6 + d)*s - 6*t)*
    ...
    (mz^2*(2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*(6*psq + (-10 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq - 2*s)*
