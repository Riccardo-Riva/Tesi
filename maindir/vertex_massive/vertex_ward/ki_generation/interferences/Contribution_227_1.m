...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((I*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
     ...
     (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*
      mm^2*s*sw*(aa*(mm^2 + psq - 2*t) + 2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/Pi^(2*d) - (I*EL^5*gFFA*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(aa*(2*psq^2 + psq*(5*s - 2*t) + 
         2*mm^2*(psq - 3*s - t) - s*(s + t)) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gFFA*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*s*sw*
      ...
      SPList[SP[p2, q1]])/Pi^(2*d) - (I*EL^5*gFFA*gFZW*gHFW*gHll*
      (gZlL + gZlR)*mm^2*sw*(aa*(2*psq^2 + 3*psq*s + 2*mm^2*(psq - 2*s - t) - 
         2*psq*t - s*t) + bb*(-2*psq^2 + 5*psq*s - 2*mm^2*(psq + 2*s - t) + 
         2*psq*t + s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
