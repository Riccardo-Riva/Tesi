...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 4*d)*EL^6*gAl*gAu*gFFZ^2*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFZ^2*(-2*gZlL*gZlR*mm^2*(4*psq^2 - 6*psq*s + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(-2*psq + s + 2*t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(-psq + s + t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFZ^2*(psq - t)*(-2*gZlL*gZlR*mm^2*s + 
      gZlL^2*(mm^2*(psq - t) + psq*(-psq + s + t)) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2*(mm^2*(4*psq - s - 4*t)*(psq - t) + 
      ...
      SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL - gZlR)^2*mm^2*(-2*psq + s + 2*t)*
   ...
   (4^(3 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)*(-psq + s + t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)*(-psq + s + t)*
    ...
    Pi^(2*d) - (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)^2*
