...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*
     mm^2*(2*(-2 + d)*psq + (24 - 12*d + d^2)*s - 2*(-2 + d)*t)*
