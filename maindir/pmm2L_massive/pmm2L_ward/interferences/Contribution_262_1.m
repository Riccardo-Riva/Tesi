...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (((-I)*2^(-1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
  ...
  (I*4^(-1 - d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (aa*(8*psq^2 + 2*mm^2*(4*psq + s - 4*t) - 8*psq*(s + t) - s*(s + 2*t)) + 
     bb*(-8*psq^2 - 4*psq*s + s^2 + 8*psq*t + 2*s*t + 
       mm^2*(-8*psq + 10*s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
    s*sw*(3*aa*(2*psq - s - 2*t) + bb*(4*mm^2 - 10*psq + 3*s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (aa*(4*mm^2*(psq - t) + (4*psq + s)*(psq - s - t)) + 
     bb*(-4*psq^2 - 3*psq*s + s^2 + 4*psq*t + s*t + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gFZW*gWWA*gXFW*gXll*
    (gZlL - gZlR)*mm^2*s*sw*(aa*(4*mm^2 + 2*psq - 3*s - 6*t) + 
     3*bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (aa*(4*psq^2 - 5*psq*s + 2*mm^2*(2*psq + s - 2*t) - 4*psq*t - s*t) + 
     bb*(-((4*psq + s)*(psq - t)) + 4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*
  ...
  (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*
    gXll*(gZlL - gZlR)*mm^2*s*sw*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*
    (gZlL - gZlR)*mm^2*s*sw*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
    sw*(aa*(12*psq - 5*s - 12*t) + bb*(8*mm^2 - 20*psq + 5*s + 12*t))*
  ...
  (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
    sw*(aa*(8*mm^2 + 4*psq - 7*s - 12*t) + bb*(-12*psq + 7*s + 12*t))*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (3*aa*(2*psq - s - 2*t) + bb*(4*mm^2 - 10*psq + 3*s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (aa*(3*psq - s - 3*t) + bb*(2*mm^2 - 5*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   Pi^(2*d) - (I*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    (aa*(2*mm^2 + psq - 2*s - 3*t) + bb*(-3*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - ((3*I)*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*
    mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*
