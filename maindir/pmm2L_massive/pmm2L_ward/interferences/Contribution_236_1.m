...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (((-I)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s^2*
  ...
  (I*4^(-1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
    (aa*(mm^2 - psq - s)*(psq - s - t) - bb*(-psq^2 + mm^2*(psq + 2*s - t) + 
       psq*(-3*s + t) + s*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    mm^2*s*(-3*psq + s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*
    (gZlL + gZlR)*s*(bb*(mm^2 - psq - s)*(psq - t) + 
     aa*(psq^2 - s*t - psq*(2*s + t) + mm^2*(-psq + 3*s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s*
    (-3*psq + 2*s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s^2*(-2*psq + s + 2*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
   ...
   Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
