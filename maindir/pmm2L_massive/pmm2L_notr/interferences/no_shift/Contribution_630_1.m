...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^4*((-2 + d)*mm^4*s + 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
     (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gHll^2*
     mm^4*(4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
     gHll^2*mm^2*(mm^2 - psq)*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-6*psq + (6 + d)*s + 6*t)*
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-2*psq + d*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
     (-((-2 + d)*psq*s) + mm^2*(8*psq + (-10 + d)*s - 8*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - psq)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (3*2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gHll^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*mm^2 - psq - t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*mm^2 - 3*psq + s + t)*
