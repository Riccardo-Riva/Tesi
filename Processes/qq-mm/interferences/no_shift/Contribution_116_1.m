...
(PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, mh], 
   ...
   (((I/8)*EL^6*gAl*gAu*gHll*gHuu*(gZlL + gZlR)*(gZuL + gZuR)*mm^2*mu^4*
      (2*mm^2 - s - 2*t)*(mm^2 - s - t))/(mz^2*Pi^4*s) + 
    ((I/4)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*(3*(gZlL - gZlR)*(gZuL - gZuR) - 
       d*(gZlL - gZlR)*(gZuL - gZuR) - ((gZlL + gZlR)*(gZuL + gZuR)*mu^2)/s)*
      (-mm^2 + s + t)*SPList[SP[p1, q1]])/(mz^2*Pi^4) + 
    ...
    ((I/2)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      ((gZlL + gZlR)*(gZuL + gZuR)*mu^2 - 3*(gZlL - gZlR)*(gZuL - gZuR)*
        (mm^2 - t) + d*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - t))*
  ...
  PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, mh], 
   ...
   (((I/16)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      ((-2*(gZlL + gZlR)*(gZuL + gZuR)*mu^2*(2*mm^2 - s - 2*t)*
         (mm^2 - s - t))/mz^2 + gZlR*gZuL*(8*mm^4 - 20*s^2 + 16*d*s^2 - 
         3*d^2*s^2 + 4*mm^2*(5*mu^2 + (6 - 5*d + d^2)*s - 4*t) + 
       ...
       gZlR*gZuR*(8*mm^4 + 16*s^2 - 14*d*s^2 + 3*d^2*s^2 + 
         4*mm^2*(5*mu^2 - (6 - 5*d + d^2)*s - 4*t) + 
         2*mu^2*((-4 + d)*s - 2*t) + 32*s*t - 20*d*s*t + 4*d^2*s*t + 8*t^2)))/
     (Pi^4*s) + ((I/4)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      (gZlL*gZuL*(4*mm^2 + d*(mu^2 - 4*s) + 4*s + d^2*s) + 
       gZlR*gZuR*(4*mm^2 + d*(mu^2 - 4*s) + 4*s + d^2*s) + 
       gZlR*gZuL*(4*mm^2 - 8*s - d^2*s + d*(mu^2 + 6*s)) + 
       gZlL*gZuR*(4*mm^2 - 8*s - d^2*s + d*(mu^2 + 6*s)) + 
    ...
    ((I/4)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      (gZlL*gZuL*(4*mm^2 + d*(mu^2 - 4*s) + 4*s + d^2*s) + 
       ...
       gZlR*gZuL*(4*mm^2 - 8*s - d^2*s + d*(mu^2 + 6*s)) + 
       gZlL*gZuR*(4*mm^2 - 8*s - d^2*s + d*(mu^2 + 6*s)) + 
       (gZlL*gZuL*(mm^2*(-3*mu^2 + (-3 + d)*s) - (-3 + d)*s*t + 
           mu^2*(2*s + 3*t)) + gZlR*gZuR*(mm^2*(-3*mu^2 + (-3 + d)*s) - 
           (-3 + d)*s*t + mu^2*(2*s + 3*t)) + gZlR*gZuL*
          (-(mm^2*(3*mu^2 + (-3 + d)*s)) + (-3 + d)*s*t + mu^2*(2*s + 3*t)) + 
         gZlL*gZuR*(-(mm^2*(3*mu^2 + (-3 + d)*s)) + (-3 + d)*s*t + 
           mu^2*(2*s + 3*t)))/mz^2)*SPList[SP[p2, q1]])/(Pi^4*s) - 
    ((I/4)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
    ...
    ((I/4)*EL^6*gAl*gAu*gHll*gHuu*mm^2*mu^2*
      ((-2 + d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
         (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR) + 
       (2*((gZlL + gZlR)*(gZuL + gZuR)*mu^2 - 3*(gZlL - gZlR)*(gZuL - gZuR)*
           (mm^2 - t) + d*(gZlL - gZlR)*(gZuL - gZuR)*(mm^2 - t)))/mz^2)*
