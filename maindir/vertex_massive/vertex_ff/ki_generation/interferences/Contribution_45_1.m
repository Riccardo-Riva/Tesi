   ...
   ((2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWlN*mm^2*(mm^4 - psq^2)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWlN*mm^2*
      (psq*(psq^2 - 7*psq*s + 2*s^2 - 2*psq*t + 3*s*t + t^2) + 
       mm^2*(5*psq^2 + s^2 + 6*s*t + 5*t^2 - 2*psq*(s + 5*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWlN*mm^2*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWlN*mm^4*
      (psq - t)*(-4*psq + 5*s + 4*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (3*2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWlN*mm^2*(psq - t)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWlN*mm^2*(3*mm^2 + psq)*
      (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*
      gWlN*mm^2*(psq - t)*(psq*(-3*psq + s + 3*t) + 
       mm^2*(-7*psq + 4*s + 7*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*
      gWlN*mm^2*(mm^2*(psq - t) + psq*(psq - s - t))*(psq - t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWlN*mm^2*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*
