...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((I*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*s*(-psq + s + t)*
    ...
    (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     ...
     (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*
    ...
    (I*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*(bb*(psq - s - t) + 
       ...
       SP[q2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
      (bb*(-psq^2 + mm^2*(psq + 2*s - t) - s*t + psq*(-s + t)) + 
       aa*(psq^2 + s*t + mm^2*(-psq + s + t) - psq*(2*s + t)))*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*ggpgpA^2*ggpgpZ*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*ggpgpA^2*ggpgpZ*
      (gZlL + gZlR)*(bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*
