...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(mm^2 + psq)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(mm^2 - psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(2*mm^2 - 2*psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(-psq + s + t)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(-psq + s + t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(2*psq + s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(2*psq + s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*
