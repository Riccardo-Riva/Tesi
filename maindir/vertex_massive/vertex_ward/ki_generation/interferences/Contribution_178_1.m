...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*s*
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(-2*bb*psq + aa*(mm^2 + psq))*s^2*
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(2*aa*mm^2 - bb*(mm^2 + psq))*s*
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(-2*aa*psq^2 + 
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(4*aa*(mm^2 + psq) - 
  ...
  (3*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*mm^2 - bb*psq)*s*
