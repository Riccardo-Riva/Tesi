...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((3*4^(1 - d)*(-1 + d)*EL^6*gAl^2*gAu*gWWA*gWWAA*mm^2*t*
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWAA*t*(2*s^2 + 6*s*t - d*t*(s + t) + 
      t*(-3*mm^2 + 4*t) + d*mm^2*(s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
   (3*2^(3 - 2*d)*(-1 + d)*EL^6*gAl^2*gAu*gWWA*gWWAA*mm^2*t*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^2*gAu*gWWA*gWWAA*(d*mm^2*s*(s + 4*t) + 
      d*t*(s^2 + 3*s*t + 2*t^2) - t*(3*mm^2*s + 2*s^2 + 6*s*t + 4*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) - 
   (3*2^(3 - 2*d)*(-1 + d)*EL^6*gAl^2*gAu*gWWA*gWWAA*mm^2*(s + 2*t)*
