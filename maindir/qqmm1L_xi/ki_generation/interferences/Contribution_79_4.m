...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 
     ...
     mw*Sqrt[GaugeXi[Q]]]]*(((-I)*EL^6*gWlN*gWNl*gWWZ*gZlLC*s*(s + t)*
    ...
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*s*t*\[Mu]^(4 - d)*
     ...
     (mw^4*(2*Pi)^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2) + 
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*s*\[Mu]^(4 - d)*
     ...
     (mw^4*(2*Pi)^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2) + 
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*s^2*\[Mu]^(4 - d)*
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(s + t)*\[Mu]^(4 - d)*
      ...
      \[Mu]^(4 - d)*(gZuL*gZuLC*(d*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
          (s^2 + s*t - d*s*t - 2*t^2)) + gZuR*gZuRC*(-(d*(2*Pi)^d*s^2) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (-(gZuR*gZuRC*(d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((-6 + d)*s^2 + 
            (-11 + 2*d)*s*t - 4*t^2))) + gZuL*gZuLC*(d*(2*Pi)^d*s^2 + 
         2^(1 + d)*Pi^d*((-3 + d)*s^2 + (-1 + 2*d)*s*t + 4*t^2)) + 
       s*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)))*GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*
      (-mzC^2 + s)*GaugeXi[Q]) - (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      \[Mu]^(4 - d)*(-(gZuR*gZuRC*(3*d*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*t*\[Mu]^(4 - d)*
      ...
      (-mzC^2 + s)*GaugeXi[Q]) + (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      \[Mu]^(4 - d)*(gZuR*gZuRC*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
          ((-2 + d)*s^2 + (-9 + 2*d)*s*t - 4*t^2)) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      ...
      (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) + 
    (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (gZuL*gZuLC*(d*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*(s^2 + s*t - d*s*t - 
           2*t^2)) + gZuR*gZuRC*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
          (2*s^2 - (-5 + d)*s*t + 2*t^2)) + 
       (gZuR*gZuRC*((2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((-4 + d)*s - 2*t)*
            (s + 2*t)) + gZuL*gZuLC*((2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*(s + 2*t)*
            ((-2 + d)*s + 2*t)))*GaugeXi[Q] + 
       (gZuR*gZuRC*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(s^2 - (-5 + d)*s*t + 
             2*t^2)) + gZuL*gZuLC*(d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
            (-2*s^2 + (-1 + d)*s*t + 2*t^2)))*GaugeXi[Q]^2 + 
       (gZuL*gZuLC + gZuR*gZuRC)*(2*Pi)^d*s^2*GaugeXi[Q]^3)*
    ...
    (I*2^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*s*
      ...
      (-mzC^2 + s)*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
    ...
    (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (gZuR*gZuRC*(-2*(-3 + d)*s + (8 - 3*d)*t) + 
       gZuL*gZuLC*(2*(-3 + d)*s + (-10 + 3*d)*t))*\[Mu]^(4 - d)*
      SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]) + 
    (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s + 
       2^(1 + d)*gZuL*gZuLC*Pi^d*(7*s - (-5 + d)*t) - 
       2^(1 + d)*gZuR*gZuRC*Pi^d*(2*s + t - d*t) + 2^(1 + d)*Pi^d*
        (gZuL*gZuLC*((-14 + 3*d)*s + 2*(-5 + d)*t) + 
         gZuR*gZuRC*((4 - 3*d)*s - 2*(-1 + d)*t))*GaugeXi[Q] + 
       (-3*d*gZuL*gZuLC*(2*Pi)^d*s + 3*d*gZuR*gZuRC*(2*Pi)^d*s + 
         2^(1 + d)*gZuL*gZuLC*Pi^d*(7*s - (-5 + d)*t) - 2^(1 + d)*gZuR*gZuRC*
          Pi^d*(2*s + t - d*t))*GaugeXi[Q]^2)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*
      (-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
    (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*((-4 + d)*gZuL*gZuLC - 
       (-2 + d)*gZuR*gZuRC)*(s + t)*\[Mu]^(4 - d)*SPList[SP[p1, q1], 
       SP[p1, q1], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
      (-mzC^2 + s)*GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (gZuR*gZuRC*(-((-4 + d)*s) + (10 - 3*d)*t) + 
       gZuL*gZuLC*((-2 + d)*s + (-8 + 3*d)*t))*\[Mu]^(4 - d)*
    ...
    (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
     ...
     (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) + 
    (I*2^(3 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(gZuL*gZuLC*((-7 + d)*s - 2*t) - 
       gZuR*gZuRC*(s + d*s + 2*t))*\[Mu]^(4 - d)*SPList[SP[p1, q1], 
       SP[p3, q1], SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
      (-mzC^2 + s)*GaugeXi[Q]) - (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      \[Mu]^(4 - d)*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
     ...
     (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) + 
    (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*((-2 + d)*gZuL*gZuLC - 
       (-4 + d)*gZuR*gZuRC)*t*\[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
      GaugeXi[Q]) + (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
    ...
    (I*2^(2 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*((-2 + d)*gZuL*gZuLC - 
      ...
      (gZuL*gZuLC*((-1 + d)*s - 2*t) - gZuR*gZuRC*((-5 + d)*s + 2*t))*
    ...
    (I*2^(4 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(gZuL*gZuLC + gZuR*gZuRC)*s*
     ...
     (mw^4*Pi^d*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]) - 
    (I*2^(3 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(gZuL*gZuLC + gZuR*gZuRC)*s*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   (((-I)*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (-(gZuR*gZuRC*(5*d^2*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*
           ((8 - 6*d + d^2)*s^2 - 5*(-4 + 3*d)*s*t - (-2 + d)*t^2))) + 
       gZuL*gZuLC*(5*d^2*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*((-2 + d)^2*s^2 + 
           2*(11 - 7*d)*s*t + (-2 + d)*t^2)))*\[Mu]^(4 - d)*
      SPList[SP[p2, q1]])/(Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)) + 
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (-5*d^2*gZuL*gZuLC*(2*Pi)^d*s^2 + 5*d^2*gZuR*gZuRC*(2*Pi)^d*s^2 + 
       2^(1 + d)*gZuL*gZuLC*Pi^d*(2*(-7 + 6*d)*s^2 + (-38 + 27*d - 5*d^2)*s*
          t - 2*(-2 + d)*t^2) - 2^(1 + d)*gZuR*gZuRC*Pi^d*
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (mw^2*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + 
       ...
       (-(gZuR*gZuRC*(d^2*(2*Pi)^d*s^3 + 2^(1 + d)*Pi^d*s*((4 - 3*d)*s^2 + 
        ...
        GaugeXi[Q])*SPList[SP[q1, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)*
      (-mzC^2 + s)*GaugeXi[Q]) + (I*2^(2 - d)*(-2 + d)*EL^6*gWlN*gWNl*gWWZ*
      gZlLC*((-4 + d)*gZuL*gZuLC - (-2 + d)*gZuR*gZuRC)*(s + t)*\[Mu]^(4 - d)*
    ...
    (I*2^(2 - d)*(-2 + d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*((-2 + d)*gZuL*gZuLC - 
       (-4 + d)*gZuR*gZuRC)*t*\[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p2, q1]])/
     (Pi^d*(mz^2 - s)*(-mzC^2 + s)) - (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (gZuR*gZuRC*(d^2*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((4 - 3*d)*s + 
         ...
         2^(1 + d)*Pi^d*(2*(-1 + d)*s + (-2 + d)*t)))*\[Mu]^(4 - d)*
    ...
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (2*mw^2*(gZuR*gZuRC*(d*(2*Pi)^d*s*(d*s - 9*t) + 2^(1 + d)*Pi^d*
       ...
       (-(gZuR*gZuRC*(s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-2 + d)*s - t))*
             t + 2^(1 + d)*mw^2*Pi^d*((8 - 6*d + d^2)*s^2 + (12 - 11*d + 
                2*d^2)*s*t - 2*t^2))) + gZuL*gZuLC*
          (2^(1 + d)*mw^2*Pi^d*((-2 + d)^2*s^2 + (18 - 11*d + 2*d^2)*s*t + 
             2*t^2) + s*t*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-1 + d)*s + 
               t))))*GaugeXi[Q]^3)*SPList[SP[p2, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
      GaugeXi[Q]) + (I*2^(3 - d)*(-2 + d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (gZuL*gZuLC + gZuR*gZuRC)*s*\[Mu]^(4 - d)*SPList[SP[p3, q1], 
       SP[p3, q1]])/(Pi^d*(-mz^2 + s)*(-mzC^2 + s)) + 
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
    ...
    (I*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      ((s^2*(gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
         ...
         (gZuR*gZuRC*(-((-1 + d)*d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
          ...
          2*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*
                 s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuL*gZuLC*
             (d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
                (8 - 5*d + d^2)*s*t + 2*t^2)))*GaugeXi[Q] + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (-(gZuR*gZuRC*(d*(2*Pi)^d*s^2 + 2^(1 + d)*mw^2*Pi^d*
           ...
           (-2*s^2 + (-5 + d)*s*t - 2*t^2))) + 
       gZuL*gZuLC*(d*(2*Pi)^d*s^2 + 2^(1 + d)*mw^2*Pi^d*
          ((-2 + d)*s + 2*(-3 + d)*t) - 2^(1 + d)*Pi^d*(s^2 + s*t - d*s*t - 
           2*t^2)) + (gZuL*gZuLC*(2^(1 + d)*mw^2*Pi^d*((-2 + d)*s + 
      ...
      (-mzC^2 + s)*GaugeXi[Q]) - (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      \[Mu]^(4 - d)*(-(gZuL*gZuLC*(d*(2*Pi)^d*s^2 + 2^(1 + d)*mw^2*Pi^d*
           ((-6 + d)*s - 2*t) + 2^(1 + d)*Pi^d*((-3 + d)*s^2 + 
            (-1 + 2*d)*s*t + 4*t^2))) + gZuR*gZuRC*
        (2^(1 + d)*Pi^d*(-6*s^2 - 11*s*t + 2*(mw^2 - 2*t)*t) + 
         d*s*(2^(1 + d)*mw^2*Pi^d + (2*Pi)^d*s + 2^(1 + d)*Pi^d*(s + 2*t))) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (gZuL*gZuLC*(d*(2*Pi)^d*s^2 + 2^(1 + d)*mw^2*Pi^d*((-2 + d)*s - 2*t) + 
         2^(1 + d)*Pi^d*(-((-1 + d)*s^2) + (3 - 2*d)*s*t - 4*t^2)) - 
      ...
      (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) + 
    (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (gZuR*gZuRC*(2^(1 + d)*mw^2*Pi^d*s + d*(2*Pi)^d*s^2 + 
         2^(1 + d)*Pi^d*(-2*s^2 + (-5 + d)*s*t - 2*t^2)) + 
       gZuL*gZuLC*(2^(1 + d)*mw^2*Pi^d*s - d*(2*Pi)^d*s^2 + 
         2^(1 + d)*Pi^d*(s^2 + s*t - d*s*t - 2*t^2)) - 
       (gZuR*gZuRC*(2^(1 + d)*mw^2*Pi^d*s + (2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*((-4 + d)*s - 2*t)*(s + 2*t)) + 
         gZuL*gZuLC*(2^(1 + d)*mw^2*Pi^d*s + (2*Pi)^d*s^2 - 
           2^(1 + d)*Pi^d*(s + 2*t)*((-2 + d)*s + 2*t)))*GaugeXi[Q] - 
       (gZuR*gZuRC*(2^(1 + d)*mw^2*Pi^d*s - d*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*(s^2 - (-5 + d)*s*t + 2*t^2)) + 
         gZuL*gZuLC*(2^(1 + d)*mw^2*Pi^d*s + d*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*(-2*s^2 + (-1 + d)*s*t + 2*t^2)))*GaugeXi[Q]^2 + 
     ...
     (mw^4*Pi^(2*d)*(-mz^2 + s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
      GaugeXi[Q]) - (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (-3*d*gZuL*gZuLC*(2*Pi)^d*s^2 + 3*d*gZuR*gZuRC*(2*Pi)^d*s^2 + 
       2^(1 + d)*gZuL*gZuLC*Pi^d*(3*s^2 + (7 - 3*d)*s*t - 2*t^2) - 
       2^(1 + d)*gZuR*gZuRC*Pi^d*(6*s^2 + (11 - 3*d)*s*t + 2*t^2) + 
       2^(1 + d)*Pi^d*(gZuR*gZuRC*(-3*(-4 + d)*s^2 + (22 - 6*d)*s*t + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 
   ...
   (((-I)*EL^6*gWlN*gWNl*gWWZ*gZlLC*s*
      ...
      \[Mu]^(4 - d)*SPList[SP[q1, q1]])/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)*
         ...
         (2*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + 
           ...
           (s*(-21*d*gZuL*gZuLC*(2*Pi)^d*s*t + 21*d*gZuR*gZuRC*(2*Pi)^d*s*t - 
              2^(1 + d)*gZuR*gZuRC*Pi^d*((8 - 6*d + d^2)*s^2 + 2*(5 + d^2)*s*
                ...
                (17 + 2*d^2)*s*t + 3*t^2)) + mz^2*(19*d*gZuL*gZuLC*(2*Pi)^
                d*s*t - 19*d*gZuR*gZuRC*(2*Pi)^d*s*t + 2^(1 + d)*gZuR*gZuRC*
               Pi^d*((8 - 6*d + d^2)*s^2 + (10 - d + 2*d^2)*s*t - 3*t^2) - 
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(s + t)*\[Mu]^(4 - d)*
      ...
      \[Mu]^(4 - d)*(gZuL*gZuLC*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
        ...
        (-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*s^2 - (-5 + d)*s*t + 2*t^2) + 
      ...
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*
      (-mzC^2 + s)*GaugeXi[Q]) + (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      \[Mu]^(4 - d)*(gZuR*gZuRC*(2^(1 + d)*Pi^d*(-6*s^2 - 11*s*t + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*t*\[Mu]^(4 - d)*
      ...
      SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*
      (-mzC^2 + s)*GaugeXi[Q]) - (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      \[Mu]^(4 - d)*(-(gZuR*gZuRC*(-(d*(2*Pi)^d*s^2) + 
    ...
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      ...
      (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
    (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (-(gZuR*gZuRC*(d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*s^2 + (-5 + d)*s*t - 
            2*t^2))) + gZuL*gZuLC*(d*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
          (s^2 - 2*t^2 + s*(t - d*t))) + 
       (gZuR*gZuRC*((2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((-4 + d)*s - 2*t)*
            (s + 2*t)) + gZuL*gZuLC*((2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*(s + 2*t)*
       ...
       (gZuL*gZuLC + gZuR*gZuRC)*mw^2*s*(-1 + GaugeXi[Q])^2*
        (-(2*Pi)^d + (-(2^(1 + d)*Pi^d) + (2*Pi)^d)*GaugeXi[Q]))*
      SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*
      (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) + 
    (I*2^(1 - 2*d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (-3*d*gZuL*gZuLC*(2*Pi)^d*s^2 + 3*d*gZuR*gZuRC*(2*Pi)^d*s^2 + 
    ...
    (I*2^(3 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*
      (gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
       gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t))*\[Mu]^(4 - d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1], SP[q1, q1]])/
     (mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]) - 
    (I*4^(1 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*\[Mu]^(4 - d)*
      (gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + (-3 + d)*t)) + 
   ...
   (((-I)*EL^6*gWlN*gWNl*gWWZ*gZlLC*s*
      ...
      (s*t*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-1 + d)*s + t)) + 
         ...
         (s*(19*d*gZuL*gZuLC*(2*Pi)^d*s*t - 19*d*gZuR*gZuRC*(2*Pi)^d*s*t + 
            2^(1 + d)*gZuR*gZuRC*Pi^d*((8 - 6*d + d^2)*s^2 + 
              2*(3 + d^2)*s*t - 5*t^2) - 2^(1 + d)*gZuL*gZuLC*Pi^d*
             ((-2 + d)^2*s^2 + (15 + 2*d^2)*s*t + 5*t^2)) + 
          mz^2*(-21*d*gZuL*gZuLC*(2*Pi)^d*s*t + 21*d*gZuR*gZuRC*(2*Pi)^d*s*
             t - 2^(1 + d)*gZuR*gZuRC*Pi^d*((8 - 6*d + d^2)*s^2 + 
              (6 + d + 2*d^2)*s*t - 5*t^2) + 2^(1 + d)*gZuL*gZuLC*Pi^d*
             ((-2 + d)^2*s^2 + (15 + d + 2*d^2)*s*t + 5*t^2))*
           GaugeXi[V[20]] - 2*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
              2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + (4 - 5*d + d^2)*s*t - 2*t^2)) + 
            gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*(-1 + d)*
                 s^2 - (8 - 5*d + d^2)*s*t - 2*t^2)))*GaugeXi[Q]*
    ...
    (I*2^(3 - d)*EL^6*gWlN*gWNl*gWWZ*gZlLC*(gZuL*gZuLC + gZuR*gZuRC)*s*
      \[Mu]^(4 - d)*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1], SP[q1, q1]])/
     (mw^4*Pi^d*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q])))/4
