...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(gZlL^2*((-2 + d)*mm^2 - s) + 
      gZlR^2*((-2 + d)*mm^2 - s) + gZlL*(-2*d*gZlR*mm^2 + 4*gZlR*s))*
     (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
      t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*
     (-(4^(1 + d)*gZlL*gZlR*Pi^(2*d)*(d*mm^2*(2*psq^2 - 3*psq*s + s^2 - 
           4*psq*t + 3*s*t + 2*t^2) - 2*s*(4*psq^2 - 3*psq*s + s^2 - 
           8*psq*t + 5*s*t + 4*t^2) + d*s*(psq^2 - 2*psq*t + t*(s + t)))) + 
      gZlL^2*(2*Pi)^(2*d)*(-2*(-2 + d)*psq^3 + 2*(-4 + d)*s*t*(s + t) - 
        psq^2*((2 + d)*s - 4*(-2 + d)*t) + psq*((-2 + d)*s^2 + 
          (18 - 5*d)*s*t - 2*(-2 + d)*t^2) + (-2 + d)*mm^2*
         (6*psq^2 + s^2 + 7*s*t + 6*t^2 - 3*psq*(s + 4*t))) + 
      gZlR^2*(2*Pi)^(2*d)*(-2*(-2 + d)*psq^3 + 2*(-4 + d)*s*t*(s + t) - 
        psq^2*((2 + d)*s - 4*(-2 + d)*t) + psq*((-2 + d)*s^2 + 
          (18 - 5*d)*s*t - 2*(-2 + d)*t^2) + (-2 + d)*mm^2*
         (6*psq^2 + s^2 + 7*s*t + 6*t^2 - 3*psq*(s + 4*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/(Pi^(4*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-4*gZlL*gZlR*mm^2*(-(2^(1 + 2*d)*Pi^(2*d)*s*(4*psq^2 - 3*psq*s + s^2 - 
           8*psq*t + 5*s*t + 4*t^2)) - d*(2*Pi)^(2*d)*(psq - s - t)*
         (psq*(s - 2*t) + 2*t*(s + t) + mm^2*(-2*psq + s + 2*t))) + 
      gZlL^2*((-2 + d)*mm^4*(2*Pi)^(2*d)*(4*psq^2 - 5*psq*s + s^2 - 8*psq*t + 
          5*s*t + 4*t^2) + (2*Pi)^(2*d)*s*((-10 + d)*psq^3 - 
          16*psq*t*(s + t) + 4*t*(s + t)^2 - psq^2*((-6 + d)*s + 
            (-22 + d)*t)) - 4^(1 + d)*mm^2*Pi^(2*d)*
         (psq^2*((-1 + d)*s - (-2 + d)*t) - t*(s + t)*((-3 + d)*s + 
            (-2 + d)*t) + psq*(-((-2 + d)*s^2) + (-4 + d)*s*t + 
            2*(-2 + d)*t^2))) + gZlR^2*((-2 + d)*mm^4*(2*Pi)^(2*d)*
         (4*psq^2 - 5*psq*s + s^2 - 8*psq*t + 5*s*t + 4*t^2) + 
        (2*Pi)^(2*d)*s*((-10 + d)*psq^3 - 16*psq*t*(s + t) + 4*t*(s + t)^2 - 
          psq^2*((-6 + d)*s + (-22 + d)*t)) - 4^(1 + d)*mm^2*Pi^(2*d)*
         (psq^2*((-1 + d)*s - (-2 + d)*t) - t*(s + t)*((-3 + d)*s + 
            (-2 + d)*t) + psq*(-((-2 + d)*s^2) + (-4 + d)*s*t + 
            2*(-2 + d)*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(4*d)*s) + (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*
     (gZlL^2*(2*Pi)^(2*d)*(2*(-2 + d)*psq^3 + (-2 + d)*mm^2*(2*psq - s - 2*t)*
         (psq - t) + 2*(-4 + d)*s*t*(s + t) + 
        psq^2*((-6 + d)*s - 4*(-2 + d)*t) + psq*t*((14 - 3*d)*s + 
          2*(-2 + d)*t)) + gZlR^2*(2*Pi)^(2*d)*(2*(-2 + d)*psq^3 + 
        (-2 + d)*mm^2*(2*psq - s - 2*t)*(psq - t) + 2*(-4 + d)*s*t*(s + t) + 
        psq^2*((-6 + d)*s - 4*(-2 + d)*t) + psq*t*((14 - 3*d)*s + 
          2*(-2 + d)*t)) - 4^(1 + d)*gZlL*gZlR*Pi^(2*d)*
       (-8*psq^2*s + d*mm^2*(2*psq - s - 2*t)*(psq - t) - 2*s*t*(3*s + 4*t) + 
        2*psq*s*(s + 8*t) + d*s*(psq^2 - 2*psq*t + t*(s + t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(4*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (4*gZlL*gZlR*mm^2*(d*(2*Pi)^(2*d)*(psq - t)*(4*psq^2 + 
          mm^2*(2*psq - s - 2*t) + 2*t*(s + t) - psq*(s + 6*t)) + 
        2^(1 + 2*d)*Pi^(2*d)*s*(-4*psq^2 - t*(3*s + 4*t) + psq*(s + 8*t))) + 
      gZlL^2*(-((-2 + d)*mm^4*(2*Pi)^(2*d)*(4*psq - s - 4*t)*(psq - t)) + 
        (2*Pi)^(2*d)*s*(-((-2 + d)*psq^3) + (2 + d)*psq^2*t - 8*psq*t^2 + 
          4*t^2*(s + t)) - 4^(1 + d)*mm^2*Pi^(2*d)*(2*(-2 + d)*psq^3 + 
          psq^2*(s - d*s - 5*(-2 + d)*t) - t*(s + t)*(s + (-2 + d)*t) + 
          2*psq*t*((-1 + d)*s + 2*(-2 + d)*t))) + 
      gZlR^2*(-((-2 + d)*mm^4*(2*Pi)^(2*d)*(4*psq - s - 4*t)*(psq - t)) + 
        (2*Pi)^(2*d)*s*(-((-2 + d)*psq^3) + (2 + d)*psq^2*t - 8*psq*t^2 + 
          4*t^2*(s + t)) - 4^(1 + d)*mm^2*Pi^(2*d)*(2*(-2 + d)*psq^3 + 
          psq^2*(s - d*s - 5*(-2 + d)*t) - t*(s + t)*(s + (-2 + d)*t) + 
          2*psq*t*((-1 + d)*s + 2*(-2 + d)*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(4*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*
       (mm^2 + psq)*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
       (mm^2 + psq)*(2*psq - s - 2*t) + 4^(1 + d)*gZlL*gZlR*Pi^(2*d)*
       (d*mm^2 - 2*s)*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    Pi^(4*d) - (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     ((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(psq^2*s + mm^4*(4*psq - s - 4*t) + 
        4*mm^2*psq*(psq - s - t)) + (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
       (psq^2*s + mm^4*(4*psq - s - 4*t) + 4*mm^2*psq*(psq - s - t)) - 
      4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(d*(mm^2 + psq) - 2*s)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(-2*d*gZlL*gZlR*mm^2 + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(-2*gZlL*gZlR*mm^2*(-psq + s + t)*
       (-8*s + d*(-2*psq + 3*s + 2*t)) + 
      gZlL^2*(-4*(-2 + d)*mm^4*(psq - s - t) + (-2 + d)*mm^2*
         (8*psq^2 + 3*s^2 + 7*s*t + 4*t^2 - 3*psq*(3*s + 4*t)) + 
        2*(-4*psq*(s + t)^2 + (s + t)^2*(s + 2*t) + psq^2*(5*s + 2*t) - 
          d*psq*(psq^2 - 2*psq*t + t*(s + t)))) + 
      gZlR^2*(-4*(-2 + d)*mm^4*(psq - s - t) + (-2 + d)*mm^2*
         (8*psq^2 + 3*s^2 + 7*s*t + 4*t^2 - 3*psq*(3*s + 4*t)) + 
        2*(-4*psq*(s + t)^2 + (s + t)^2*(s + 2*t) + psq^2*(5*s + 2*t) - 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(-2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t)*
       (4*s + d*(-psq + t)) + gZlL^2*(4*(-2 + d)*mm^4*(psq - t) - 
        (-2 + d)*mm^2*(2*psq - s - 2*t)*(psq + t) + 
        2*(-2*psq^3 + psq^2*(3*s - d*s + 6*t) + psq*(s^2 - 6*s*t - 6*t^2) + 
          t*(3*s^2 + 5*s*t + 2*t^2))) + gZlR^2*(4*(-2 + d)*mm^4*(psq - t) - 
        (-2 + d)*mm^2*(2*psq - s - 2*t)*(psq + t) + 
        2*(-2*psq^3 + psq^2*(3*s - d*s + 6*t) + psq*(s^2 - 6*s*t - 6*t^2) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(-2*(-4 + d)*gZlL*gZlR*mm^2*s + 
      gZlL^2*(4*(-2 + d)*mm^4 - (-2 + d)*mm^2*(5*psq - 2*s - t) + 
        (psq - s - t)*((2 + d)*psq - 2*(s + 2*t))) + 
      gZlR^2*(4*(-2 + d)*mm^4 - (-2 + d)*mm^2*(5*psq - 2*s - t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (8*gZlL*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
      d*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq)*
       (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
      2*gZlL^2*(psq^2*(6*s - 2*t) + t*(s^2 - s*t - 2*t^2) + 
        psq*(-2*s^2 - 5*s*t + 4*t^2)) + 2*gZlR^2*(psq^2*(6*s - 2*t) + 
        t*(s^2 - s*t - 2*t^2) + psq*(-2*s^2 - 5*s*t + 4*t^2)))*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-4*gZlL*gZlR*mm^2*(-s^2 + d*(-psq + s + t)^2) + 
      gZlL^2*(s^2*(-3*psq + s + t) + 2*(-2 + d)*mm^2*(-psq + s + t)^2) + 
      gZlR^2*(s^2*(-3*psq + s + t) + 2*(-2 + d)*mm^2*(-psq + s + t)^2))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(-4*d*gZlL*gZlR*mm^2 + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(psq - t)*
     (-2*gZlL*gZlR*mm^2*(-8*s + d*(2*psq + s - 2*t)) + 
      gZlL^2*(4*psq^2 + (-4 + d)*psq*s + 2*(-2 + d)*mm^2*(psq - t) - 
        8*psq*t + 2*t*(s + 2*t)) + gZlR^2*(4*psq^2 + (-4 + d)*psq*s + 
        2*(-2 + d)*mm^2*(psq - t) - 8*psq*t + 2*t*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(-((-4 + d)*gZlL*gZlR*s^2) + 
      (-2 + d)*gZlL^2*(psq - t)^2 + (-2 + d)*gZlR^2*(psq - t)^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*(-2*(-4 + d)*gZlL*gZlR*mm^2*s + 
      gZlL^2*(-((-6 + d)*psq^2) + (-4 + d)*psq*s + (-2 + d)*mm^2*(psq - t) + 
        (-10 + d)*psq*t + 2*t*(s + 2*t)) + 
      gZlR^2*(-((-6 + d)*psq^2) + (-4 + d)*psq*s + (-2 + d)*mm^2*(psq - t) + 
        (-10 + d)*psq*t + 2*t*(s + 2*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)*(psq - t)) + 
      gZlL^2*(2*Pi)^(2*d)*(2*(-2 + d)*psq^3 + (-2 + d)*mm^2*(2*psq - s - 2*t)*
         (psq - t) + 4*s*t*(s + t) + psq^2*(-((-6 + d)*s) - 4*(-2 + d)*t) + 
        psq*t*((-10 + d)*s + 2*(-2 + d)*t)) + gZlR^2*(2*Pi)^(2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
     (4*gZlL*gZlR*mm^2*(-s^2 + d*(psq - t)^2) + 
      gZlL^2*(-((-2 + d)*mm^2*(2*psq - s - 2*t)*(psq - t)) + 
        s*(-((-2 + d)*psq^2) + s*t + psq*(s + (-2 + d)*t))) + 
      gZlR^2*(-((-2 + d)*mm^2*(2*psq - s - 2*t)*(psq - t)) + 
        s*(-((-2 + d)*psq^2) + s*t + psq*(s + (-2 + d)*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*mm^2*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*
     (gZlL^2 + gZlR^2)*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*(psq - t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(psq - t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*
     (gZlL^2 + gZlR^2)*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gXll^2*
     (gZlL^2 + gZlR^2)*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + s)*(-psq + s + t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gXll^2*
     (gZlL^2 + gZlR^2)*mm^2*(-((-2 + d)*psq^2) + 2*psq*s + 
      (-2 + d)*mm^2*(psq - t) + (-2 + d)*psq*t - s*(s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(psq - t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(psq - t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*s*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^2*s*\[Mu]^(8 - 2*d)*
