...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 ((I*2^(1 - d)*EL^6*gAl*gAu*gFFZ^2*
    ...
    SPList[SP[p1, q1]])/(Pi^d*(mz^2 - s)^2) - 
  (I*EL^6*gAl*gAu*gFFZ^2*(gZlR*gZuL*(2*mm^2 + 2*(-4 + d)*mmv^2 + 4*s - d*s + 
       ...
       6*t + 2*d*t))*SPList[SP[q1, q1]])/((2*Pi)^d*(mz^2 - s)^2) - 
  ...
  (I*2^(2 - d)*EL^6*gAl*gAu*gFFZ^2*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
     (-4 + d)*gZlL*gZuR + (-2 + d)*gZlR*gZuR)*(mmv^2 - t)*
  ...
  (I*2^(1 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL*gZuL*(2*mmv^2 + (-6 + d)*s - 2*t) + 
  ...
  (I*2^(1 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
   ...
   (Pi^d*(mz^2 - s)^2*s) + (I*2^(3 - d)*EL^6*gAl*gAu*gFFZ^2*(gZlL + gZlR)*
