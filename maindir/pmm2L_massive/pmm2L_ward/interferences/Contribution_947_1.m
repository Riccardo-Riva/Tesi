...
PropList[KiraPropagator[-q1, mm], KiraPropagator[q2, 0], 
  ...
  (((-I)*2^(-1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*mm^2*s*
   ...
   (I*EL^5*gAl^3*(-(bb*(gZlL^2*((4 - 5*d + d^2)*mm^4*(2*Pi)^(6*d) + 
    ...
    (mz^2*(2*Pi)^(8*d)) - 
   (I*EL^5*gAl^3*(-(bb*(gZlL^2*(2*Pi)^(6*d)*((8 - 7*d + d^2)*mm^4 + 
   ...
   (I*EL^5*gAl^3*(bb*(-(gZlL^2*((4 - 3*d + d^2)*mm^4*(2*Pi)^(6*d) - 
        ...
        gZlR^2*((4 - 3*d + d^2)*mm^4*(2*Pi)^(6*d) - mm^2*(2*Pi)^(6*d)*
          ...
          2^(1 + 6*d)*Pi^(6*d)*(3*(-2 + d)*psq^2 + (32 - 14*d + d^2)*psq*s + 
            2*(-3 + d)*s^2 - (10 - 6*d + d^2)*psq*t + (-2 - 3*d + d^2)*s*
             t)) + 2^(1 + 6*d)*gZlL*gZlR*Pi^(6*d)*((8 - 7*d + d^2)*mm^4 + 
          mm^2*(4*(1 + d)*psq + (16 - 17*d + 3*d^2)*s - (-4 + d + d^2)*t) + 
          2*(3*(-4 + d)*psq^2 + (34 - 14*d + d^2)*psq*s + 2*(-3 + d)*s^2 - 
