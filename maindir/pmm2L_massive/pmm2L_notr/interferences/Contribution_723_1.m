...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[-p3 - q1, mw], 
 ...
 ((4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*psq*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*psq*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*
    (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*(-2*psq + 3*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*(-psq + s + t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*(psq - t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gWlN*gWNl*mm^4*\[Mu]^(8 - 2*d)*
