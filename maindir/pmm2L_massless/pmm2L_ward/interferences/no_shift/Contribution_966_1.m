(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
  ...
  ((I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*((-2 + d)*gZlL^2 - 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*((-2 + d)*gZlL^2 - (-4 + d)*gZlR^2)*gZNL^2*
     s*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*(-((14 - 8*d + d^2)*gZlL^2) + 
      (-4 + d)^2*gZlR^2)*gZNL^2*s*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*((-2 + d)*gZlL^2 - (-4 + d)*gZlR^2)*gZNL^2*
     s*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*(-((14 - 8*d + d^2)*gZlL^2) + 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*((-4 + d)*gZlL^2 - (-2 + d)*gZlR^2)*gZNL^2*
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*(gZlL^2 + gZlR^2)*gZNL^2*
     (s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/
    Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*
