...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gZNL*
  ...
  (I*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gZNL*((-2 + d)*gZlR*mm^2 - 
     ...
     SP[p2, q2]])/(4^d*Pi^(2*d)) + (I*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*
  ...
  (I*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gZNL*((-2 + d)*gZlR*mm^2 - 
     ...
     SP[p2, q1]])/(4^d*Pi^(2*d)) + (I*(-4 + d)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*
  ...
  (I*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*(4*aa*(psq - t) + 
     bb*((16 - 10*d + d^2)*mm^2 - (20 - 10*d + d^2)*psq + 4*t))*
