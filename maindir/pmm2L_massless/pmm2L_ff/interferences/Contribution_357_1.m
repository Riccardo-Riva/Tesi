...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*t*
      (-((-2 + d)^2*gZlL^2*mm^2*(2*Pi)^(2*d)*(s^2 + 3*s*t + 2*t^2)) - 
       (-2 + d)^2*gZlR^2*mm^2*(2*Pi)^(2*d)*(s^2 + 3*s*t + 2*t^2) + 
       2*gZlL*gZlR*(2^(1 + 2*d)*mm^2*Pi^(2*d)*(s + t)*((8 - 5*d + d^2)*s + 
           (-2 + d)^2*t) + (-4 + d)^2*(2*Pi)^(2*d)*s*(s^2 + 3*s*t + 2*t^2)))*
      \[Mu]^(8 - 2*d))/(Pi^(4*d)*s)) + 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*(s + t)*
     (-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(2*t*((-4 + d)*s + (-2 + d)*t) + 
         mm^2*((2 + d)*s + 4*d*t))) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
       (2*t*((-4 + d)*s + (-2 + d)*t) + mm^2*((2 + d)*s + 4*d*t)) + 
      2*gZlL*gZlR*(2^(1 + 2*d)*mm^2*Pi^(2*d)*((8 - 5*d + d^2)*s + 
          2*(4 - 5*d + d^2)*t) + (-4 + d)*(2*Pi)^(2*d)*((-2 + d)*s^2 + 
          4*(-3 + d)*s*t + 4*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (Pi^(4*d)*s) + (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (4^(1 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(5*s^3 + 21*s^2*t + 30*s*t^2 + 
        14*t^3) + d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(s + t)*
       (s^2 + 4*s*t + t*(mm^2 + 4*t)) - 2*d*(s + t)*
       (-(4^(1 + d)*gZlL*gZlR*Pi^(2*d)*(mm^2 - t)*(s + t)) + 
        gZlL^2*(2*Pi)^(2*d)*(5*s^2 + 18*s*t + t*(mm^2 + 16*t)) + 
        gZlR^2*(2*Pi)^(2*d)*(5*s^2 + 18*s*t + t*(mm^2 + 16*t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(4*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*t*
     (-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(-2*(s + t)*(2*s + (-2 + d)*t) + 
         mm^2*((2 + d)*s + 4*d*t))) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
       (-2*(s + t)*(2*s + (-2 + d)*t) + mm^2*((2 + d)*s + 4*d*t)) + 
      2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
       (2*mm^2*((8 - 5*d + d^2)*s + 2*(4 - 5*d + d^2)*t) + 
        (-4 + d)*((-14 + 3*d)*s^2 + 4*(-5 + d)*s*t - 4*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/(Pi^(4*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAl^3*gAu*mm^2*t*
     (d^2*(gZlL^2 + gZlR^2)*(s^2 + 4*s*t + t*(mm^2 + 4*t)) + 
      4*(gZlL^2 + gZlR^2)*(3*s^2 + 12*s*t + 2*t*(2*mm^2 + 7*t)) - 
      2*d*(4*gZlL*gZlR*(mm^2 + t)*(s + t) + gZlL^2*(3*s^2 + 14*s*t + 
          t*(5*mm^2 + 16*t)) + gZlR^2*(3*s^2 + 14*s*t + t*(5*mm^2 + 16*t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*((2 + d)*s + 4*d*t)) - 
      (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*((2 + d)*s + 4*d*t) + 
      2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*((8 - 6*d + d^2)*s*(s + 2*t) + 
        2*mm^2*((8 - 5*d + d^2)*s + 2*(4 - 5*d + d^2)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(4*d) - (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (4^(1 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(5*s^3 + 14*s^2*t - 
        4*s*(mm^2 - 3*t)*t + 8*t^3) + d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
       (s^3 + 4*s^2*t + 4*t^3 + s*t*(-mm^2 + 6*t)) + 
      2^(1 + 2*d)*d*Pi^(2*d)*(4*gZlL*gZlR*mm^2*s*(s + t) - 
        gZlL^2*(5*s^3 + 16*s^2*t + 12*t^3 + s*t*(-5*mm^2 + 18*t)) - 
        gZlR^2*(5*s^3 + 16*s^2*t + 12*t^3 + s*t*(-5*mm^2 + 18*t))))*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*(s + t)*(-4*d*gZlL*gZlR*mm^2*(2*mm^2 + s + t) + 
      gZlL^2*(4*(-2 + d)*mm^4 + mm^2*(2*(14 - 8*d + d^2)*s + 
          (40 - 22*d + 3*d^2)*t) + (24 - 10*d + d^2)*(s^2 + 3*s*t + 2*t^2)) + 
      gZlR^2*(4*(-2 + d)*mm^4 + mm^2*(2*(14 - 8*d + d^2)*s + 
          (40 - 22*d + 3*d^2)*t) + (24 - 10*d + d^2)*(s^2 + 3*s*t + 2*t^2)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*mm^2*(-((-2 + d)^2*gZlL^2*mm^2*t) - 
      (-2 + d)^2*gZlR^2*mm^2*t + gZlL*gZlR*((-4 + d)^2*s^2 + 
        2*(4 - 6*d + d^2)*mm^2*t + 2*(-4 + d)^2*s*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*(-12*d*gZlL*gZlR*mm^2*t*(s + t) + 
      gZlL^2*((16 - 10*d + d^2)*mm^4*t + (24 - 10*d + d^2)*t*
         (s^2 + 3*s*t + 2*t^2) + mm^2*((-4 + d)^2*s^2 + 2*(44 - 25*d + 3*d^2)*
           s*t + (112 - 62*d + 7*d^2)*t^2)) + 
      gZlR^2*((16 - 10*d + d^2)*mm^4*t + (24 - 10*d + d^2)*t*
         (s^2 + 3*s*t + 2*t^2) + mm^2*((-4 + d)^2*s^2 + 2*(44 - 25*d + 3*d^2)*
           s*t + (112 - 62*d + 7*d^2)*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*mm^2*((-2 + d)^2*gZlL^2*(mm^2*s + (s + t)^2) + 
      (-2 + d)^2*gZlR^2*(mm^2*s + (s + t)^2) - 
      gZlL*gZlR*(2*(4 - 6*d + d^2)*mm^2*s + (-4 + d)*((-4 + 3*d)*s^2 + 
          2*(-2 + 3*d)*s*t + 4*(-1 + d)*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*(-8*d*gZlL*gZlR*mm^2*t*(s + t) + 
      gZlL^2*(-((16 - 10*d + d^2)*mm^4*s) + (-4 + d)*(s + t)*
         ((-6 + d)*s^2 + 3*(-4 + d)*s*t + 2*(-2 + d)*t^2) + 
        mm^2*((16 - 6*d + d^2)*s^2 + 2*(-4 + d^2)*s*t + (16 - 14*d + 3*d^2)*
           t^2)) + gZlR^2*(-((16 - 10*d + d^2)*mm^4*s) + 
        (-4 + d)*(s + t)*((-6 + d)*s^2 + 3*(-4 + d)*s*t + 2*(-2 + d)*t^2) + 
        mm^2*((16 - 6*d + d^2)*s^2 + 2*(-4 + d^2)*s*t + (16 - 14*d + 3*d^2)*
           t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*(2*mm^2 + t)*
     (s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*(-4*d*gZlL*gZlR*mm^2*t*(2*mm^2 + 3*(s + t)) + 
      gZlL^2*((8 - 6*d + d^2)*mm^4*t - (24 - 10*d + d^2)*t*
         (s^2 + 3*s*t + 2*t^2) + mm^2*((20 - 10*d + d^2)*s^2 + 
          (80 - 46*d + 5*d^2)*s*t + (80 - 46*d + 5*d^2)*t^2)) + 
      gZlR^2*((8 - 6*d + d^2)*mm^4*t - (24 - 10*d + d^2)*t*
         (s^2 + 3*s*t + 2*t^2) + mm^2*((20 - 10*d + d^2)*s^2 + 
          (80 - 46*d + 5*d^2)*s*t + (80 - 46*d + 5*d^2)*t^2)))*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*
     (-8*d*gZlL*gZlR*mm^2*s*(mm^2 + s + t) + 
      gZlL^2*((8 - 6*d + d^2)*mm^4*s + (-4 + d)*s*(s + t)*
         ((-6 + d)*s + (-8 + d)*t) + mm^2*(2*(10 - 7*d + d^2)*s^2 + 
          2*(12 - 7*d + d^2)*s*t - (16 - 10*d + d^2)*t^2)) + 
      gZlR^2*((8 - 6*d + d^2)*mm^4*s + (-4 + d)*s*(s + t)*
         ((-6 + d)*s + (-8 + d)*t) + mm^2*(2*(10 - 7*d + d^2)*s^2 + 
          2*(12 - 7*d + d^2)*s*t - (16 - 10*d + d^2)*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*
     (2*mm^2*s + s^2 + 4*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(s + t)*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
       (s + 2*t) + gZlL^2*(2*Pi)^(2*d)*
       (mm^2*(-((24 - 10*d + d^2)*s) + (-2 + d)*d*t) + 
        2*t*((12 - 8*d + d^2)*s + 2*(20 - 9*d + d^2)*t)) + 
      gZlR^2*(2*Pi)^(2*d)*(mm^2*(-((24 - 10*d + d^2)*s) + (-2 + d)*d*t) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*t*(2*(-4 + d)*gZlL*gZlR*
       ((-4 + d)*s - 2*t) + (-2 + d)^2*gZlL^2*t + (-2 + d)^2*gZlR^2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*t*(4*d*gZlL*gZlR*mm^2*t + 
      gZlL^2*((24 - 10*d + d^2)*t*(s + 2*t) - (-2 + d)*mm^2*
         (2*s + (-4 + d)*t)) + gZlR^2*((24 - 10*d + d^2)*t*(s + 2*t) - 
        (-2 + d)*mm^2*(2*s + (-4 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*mm^2*((-2 + d)^2*gZlL^2*t^2 + 
      (-2 + d)^2*gZlR^2*t^2 - (-4 + d)*gZlL*gZlR*((-4 + d)*s^2 + 
        2*(-2 + d)*s*t + 4*(-1 + d)*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*(-8*d*gZlL*gZlR*mm^2*t*(s + t) + 
      gZlL^2*(-((-4 + d)*t*(2*s^2 + (4 + d)*s*t + 2*(-2 + d)*t^2)) + 
        mm^2*((20 - 10*d + d^2)*s^2 + (32 - 22*d + 3*d^2)*s*t + 
          (16 - 14*d + 3*d^2)*t^2)) + 
      gZlR^2*(-((-4 + d)*t*(2*s^2 + (4 + d)*s*t + 2*(-2 + d)*t^2)) + 
        mm^2*((20 - 10*d + d^2)*s^2 + (32 - 22*d + 3*d^2)*s*t + 
          (16 - 14*d + 3*d^2)*t^2)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*t*
     (4*s^2 - 4*s*t + 8*(mm^2 - t)*t + 2*d*t*(s + t) - d*mm^2*(s + 4*t))*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*(-8*d*gZlL*gZlR*mm^2*s*t + 
      gZlL^2*((-4 + d)*s*t*(2*s - (-8 + d)*t) + 
        mm^2*((-4 + d)^2*s^2 + (32 - 24*d + 3*d^2)*s*t + (16 - 10*d + d^2)*
           t^2)) + gZlR^2*((-4 + d)*s*t*(2*s - (-8 + d)*t) + 
        mm^2*((-4 + d)^2*s^2 + (32 - 24*d + 3*d^2)*s*t + (16 - 10*d + d^2)*
           t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
    ...
    (Pi^(2*d)*s) - (2^(1 - 4*d)*EL^6*gAl^3*gAu*t*
     (-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(s + 2*t)) + 
      gZlL^2*(2*Pi)^(2*d)*(mm^2*((24 - 10*d + d^2)*s + (16 - 10*d + d^2)*t) + 
        2*(s + t)*((28 - 10*d + d^2)*s + 2*(20 - 9*d + d^2)*t)) + 
      gZlR^2*(2*Pi)^(2*d)*(mm^2*((24 - 10*d + d^2)*s + (16 - 10*d + d^2)*t) + 
        2*(s + t)*((28 - 10*d + d^2)*s + 2*(20 - 9*d + d^2)*t)))*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*(-4*d*gZlL*gZlR*mm^2*(s + 2*t) + 
      gZlL^2*((24 - 10*d + d^2)*s*(s + 2*t) + mm^2*((8 - 4*d + d^2)*s + 
          2*(-2 + d)*d*t)) + gZlR^2*((24 - 10*d + d^2)*s*(s + 2*t) + 
        mm^2*((8 - 4*d + d^2)*s + 2*(-2 + d)*d*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*
     (-8*t + d*(s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
    Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*
     (s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) + 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*s*
       (s + 2*t) + gZlL^2*(2*Pi)^(2*d)*
       (-(mm^2*s*((24 - 10*d + d^2)*s + (16 - 10*d + d^2)*t)) + 
        2*(8 - 6*d + d^2)*t*(s^2 + 3*s*t + 2*t^2)) + 
      gZlR^2*(2*Pi)^(2*d)*(-(mm^2*s*((24 - 10*d + d^2)*s + 
           (16 - 10*d + d^2)*t)) + 2*(8 - 6*d + d^2)*t*
