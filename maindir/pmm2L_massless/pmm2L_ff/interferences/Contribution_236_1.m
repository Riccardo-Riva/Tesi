  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(s + t)^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
     t^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*t*(s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*(s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*t*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(s + t)*
     ...
     (gZlL + gZlR)*mm^2*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*
     (gZlL + gZlR)*(mm^2*s + t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*t*(s + t)*
