...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   (-((4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFFAA*mm^2*(-2*psq^3 - 
    ...
    (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFAA*(-3*psq^2 + mm^2*(psq - t) - 
       ...
       SP[p2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFAA*
      (psq^2 - mm^2*s - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFAA*(-3*psq^2 + mm^2*(psq - t) - 
       2*t*(s + t) + psq*(s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFAA*
      (psq^2 - mm^2*s - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFAA*(psq - t)*(-psq + s + t)*
