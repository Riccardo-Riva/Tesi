...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 ((EL^8*gAl^2*gAu^2*gXll^2*mm^4*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
   ...
   (4^(2*d)*Pi^(4*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (-((-2 + d)*gZlL^2*(mm^2 + psq)*(psq - s - t)) - 
     ...
     gZlL*gZlR*(d^2*(-mm^2 + psq)*s + 2*d*(psq*(psq - 4*s - t) + 
         ...
         psq*(s - 4*t) + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
   ...
   (Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gXll^2*mm^4*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*psq*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
     ...
     SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
  ...
  (EL^8*gAl^2*gAu^2*gXll^2*mm^2*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
      ...
      (d^2*(2*mm^2 - psq)*s - 4*(2*psq^2 - 6*mm^2*s + 3*psq*s + s^2 - 
         4*psq*t + 3*s*t + 2*t^2) + 2*d*(mm^2*(2*psq - 9*s - 2*t) + 
         psq*(-psq + 5*s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*(12 - 7*d + d^2)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*psq*
    (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*(2*(-2 + d)*gZlL^2*mm^2*(psq - t) + 
     2*(-2 + d)*gZlR^2*mm^2*(psq - t) + gZlL*gZlR*(-2*s^2 + d*s^2 + 4*s*t + 
       4*t^2 - 2*psq*(s + 2*t) + mm^2*(-4*(-1 + d)*psq + 6*s + 
         4*(-1 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(12 - 7*d + d^2)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*
    gZlR*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^2*((-2 + d)*gZlL^2*mm^2 + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(-2*psq + 3*s + 2*t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(psq - t)*
