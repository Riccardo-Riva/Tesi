...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 
   ...
   (((-I)*2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHZZ*(gZlL + gZlR)*(gZuL + gZuR)*mm^2*
      (mm^2 + mmv^2)*(-(mmv^4*(2*Pi)^d) + 2^(1 + d)*mmv^2*Pi^d*t - 
       (2*Pi)^d*t*(s + t)))/(mz^2*Pi^(2*d)*(mz^2 - s)*s) - 
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((I*EL^6*gAl*gAu*gHll*gHZZ*mm^2*((2^(1 - 2*d)*(gZlL + gZlR)*(gZuL + gZuR)*
         (mm^2 + mmv^2)*(-(mmv^4*(2*Pi)^d) + 2^(1 + d)*mmv^2*Pi^d*t - 
          (2*Pi)^d*t*(s + t)))/(mz^2*Pi^(2*d)) + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
     ...
     (Pi^d*(mz^2 - s)*s) + (I*2^(1 - d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
      (gZlR*gZuL*(2*mmv^2 + (-2 + d)^2*s - 2*t) + 
       gZlL*gZuR*(2*mmv^2 + (-2 + d)^2*s - 2*t) + 
       gZlL*gZuL*(2*mmv^2 - (8 - 6*d + d^2)*s - 2*t) + 
       gZlR*gZuR*(2*mmv^2 - (8 - 6*d + d^2)*s - 2*t) + 
       (gZlL*(2*gZuL*mm^2*(mmv^2 - t) + 2*gZuR*mm^2*(mmv^2 - t) + 
           (-3 + d)*gZuL*s*(mmv^2 + t) - (-3 + d)*gZuR*s*(mmv^2 + t)) + 
         gZlR*(2*gZuL*mm^2*(mmv^2 - t) + 2*gZuR*mm^2*(mmv^2 - t) - 
