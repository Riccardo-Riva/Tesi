...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[q2, 0], 
 ...
 ((EL^5*gAl^2*ggmgmA*ggmgmAA*(mm^2 - psq)*s*(bb*(-3*psq + s) + 
     aa*(3*psq + s))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*ggmgmAA*(mm^2 - psq)*
    (-(bb*psq) + aa*(psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (EL^5*gAl^2*ggmgmA*ggmgmAA*(mm^2 - psq)*(bb*(-2*psq + s) + aa*(2*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2*Pi)^(2*d) + 
  ((aa + bb)*EL^5*gAl^2*ggmgmA*ggmgmAA*(-mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gAl^2*ggmgmA*ggmgmAA*(3*bb*(mm^2 + psq) - aa*(5*mm^2 + psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (3*(aa - bb)*EL^5*gAl^2*ggmgmA*ggmgmAA*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
