...
PropList[KiraPropagator[q1, mh], KiraPropagator[-p3 + q1, mm], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*s*
    (bb*(mm^4 + psq*(5*psq - 2*s - 5*t) + mm^2*(2*psq - 2*s - 3*t)) + 
     aa*(mm^4 + mm^2*(-4*psq + s + 3*t) + psq*(-5*psq + 3*s + 5*t)))*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*
    (aa*(10*psq^2 + mm^2*(6*psq - 5*s - 6*t) - 5*psq*(s + 2*t) + 
       s*(s + 2*t)) + bb*(-10*psq^2 - s*(s + 2*t) + mm^2*(-6*psq + s + 6*t) + 
       psq*(9*s + 10*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*
    (bb*(5*psq^2 - 8*psq*s + 2*s^2 + mm^2*(3*psq + s - 3*t) - 5*psq*t + 
       3*s*t) + aa*(-5*psq^2 + 4*psq*s - 2*s^2 + 5*psq*t - 3*s*t + 
       3*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*
    (bb*s*(7*psq - 4*s - 5*t) - 2*bb*mm^2*(psq - t) + 
     2*aa*mm^2*(psq - s - t) + aa*s*(-5*psq + 4*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*
    (bb*(mm^2*(3*psq + s - 3*t) + (5*psq - s)*(psq - s - t)) - 
     aa*(5*psq^2 - 2*psq*s + s^2 + 3*mm^2*(psq - s - t) - 5*psq*t + s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*
    (aa*(5*psq^2 - 3*psq*s + s^2 + mm^2*(3*psq - 4*s - 3*t) - 5*psq*t + 
       3*s*t) - bb*(5*psq^2 - 7*psq*s + s^2 + 3*mm^2*(psq - t) - 5*psq*t + 
       3*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(-2*bb*mm^2*(psq - t) + 
     2*aa*mm^2*(psq - s - t) - bb*s*(-5*psq + s + 5*t) + 
     aa*s*(-3*psq + s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*
    (aa*(mm^2*(3*psq - 4*s - 3*t) + (5*psq - s)*(psq - t)) + 
     bb*(-5*psq^2 - 3*mm^2*(psq - t) - s*t + 5*psq*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*s*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*
    (aa*(mm^2 + 7*psq - 5*s - 8*t) + bb*(3*mm^2 - 11*psq + 5*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(3*aa*(2*psq - s - 2*t) + 
  ...
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(aa*(4*mm^2 + 2*psq - 3*s - 6*t) + 
     3*bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(aa*(3*psq - 2*s - 3*t) + 
     bb*(mm^2 - 4*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(aa*(psq - t) + bb*(2*mm^2 - 3*psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(aa*(2*mm^2 - psq - 2*s - t) + 
  ...
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(aa*(2*mm^2 - psq - s - t) + 
  ...
  (I*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(aa*(2*mm^2 - psq - s - t) + 
   ...
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*\[Mu]^(8 - 2*d)*
