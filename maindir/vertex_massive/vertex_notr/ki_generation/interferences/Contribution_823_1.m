...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
 ...
 (-((2^(-1 - 2*d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
     (mm^2*(4*psq - s) + s*((-7 + d)*psq - (-4 + d)*s))*\[Mu]^(8 - 2*d))/
  ...
  (EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    ((-6 + d)*psq - 2*(-3 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2*Pi)^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*
    mm^2*(mm^2 + (-3 + d)*psq - (-2 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHXX*gHXZ*gXll*
    (gZlL - gZlR)*mh^2*mm^2*(psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    (2*mm^2 - d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    (4*mm^2 + (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    (2*mm^2 - 2*psq - (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   Pi^(2*d) - (4^(1 - d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
  ...
  (2^(1 - 2*d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    (-mm^2 + psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gHXX*gHXZ*gXll*
  ...
  ((-2 + d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
