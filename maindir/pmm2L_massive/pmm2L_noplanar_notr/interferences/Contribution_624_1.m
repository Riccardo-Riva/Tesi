...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - psq)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - psq)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*psq^2 - 3*s^2 + d*s^2 + 
      psq*(5*s - 2*d*s - 4*t) + s*t + 2*t^2 + mm^2*(-2*psq + d*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - psq)*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*psq^2 - 2*s^2 + d*s^2 + 
   ...
   (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*mm^2 - (2 + d)*psq + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*mm^2 + 
