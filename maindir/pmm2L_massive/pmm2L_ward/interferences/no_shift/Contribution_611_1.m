...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(mm^2 - psq)^2*s*
     ...
     SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
     gXll^2*mm^4*(3*mm^4 - 2*mm^2*psq - psq^2)*(psq - s - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(psq - s - t) + 
      aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(2*mm^2 - s - 2*t) + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(2*mm^2 - psq - t) + 
