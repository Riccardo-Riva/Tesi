...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
   KiraPropagator[-p1 - p2 + p3 + q1, 0], KiraPropagator[-p1 - p2 + p3 + q1, 
    0], KiraPropagator[q2, 0], KiraPropagator[-p1 - p2 + p3 + q1 + q2, mz]]*
  (-((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ((-3 + d)*s^2 + s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
     (gZlL^2 + gZlR^2)*((-4 + d)*s^2 - s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(6 - 5*d + d^2)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(3*s + 2*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(-s + (-4 + d)*t)*
   ...
   (2^(3 - 2*d)*(-40 + 40*d - 12*d^2 + d^3)*EL^8*gAl^4*gAu^2*
     ...
     (gZlL^2 + gZlR^2)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-40 + 40*d - 12*d^2 + d^3)*
     EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s - 2*t)*
