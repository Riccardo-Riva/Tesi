...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   (((-I)*d*EL^5*gAl*gZlL*gZlR*mm^2*(mm^2 - psq)*s*
      ...
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*
      gZlL*gZlR*mm^2*((-2 + d)*gZlL^2*(mm^2 + psq)*(2*psq - s - 2*t) + 
       (-2 + d)*gZlR^2*(mm^2 + psq)*(2*psq - s - 2*t) + 
       2*gZlL*gZlR*(2*s*(mm^2 + psq - s - 2*t) + d*psq*(-psq + s + t) + 
         d*mm^2*(-3*psq + s + 3*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*(mm^2 - psq)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gZlL*gZlR*mm^2*
      ((-2 + d)*gZlL^2*(mm^2 + psq)*(2*psq - s - 2*t) + 
       (-2 + d)*gZlR^2*(mm^2 + psq)*(2*psq - s - 2*t) - 
       2*gZlL*gZlR*(d*mm^2*(3*psq - 2*s - 3*t) + d*psq*(psq - t) + 
         2*s*(mm^2 - 3*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*(mm^2 - psq)*
    ...
    (I*2^(1 - 2*d)*d*EL^5*gAl*gZlL*gZlR*mm^2*s*
      (aa*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
         4*gZlL*gZlR*(2*psq - s - 2*t)) + bb*((-2 + d)*gZlL^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*(mm^2 - psq) + 4*gZlL*gZlR*(-2*psq + s + 2*t)))*
    ...
    (I*d*EL^5*gAl*gZlL*gZlR*mm^2*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*(mm^2 - psq) + 4*gZlL*gZlR*(2*psq - s - 2*t)) + 
    ...
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*
      (bb*(2*gZlL^3*gZlR*mm^2*(2*s + d*(psq - s - t)) + 2*gZlL*gZlR^3*mm^2*
          (2*s + d*(psq - s - t)) - 2*(-2 + d)*gZlL^2*gZlR^2*mm^2*
          (psq - s - t) + gZlL^4*(-((-2 + d)*mm^2*(psq - s - t)) + 
    ...
    (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl*gZlL^2*gZlR^2*mm^2*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*
      (bb*(2*gZlL^3*gZlR*mm^2*(2*s + d*(psq - s - t)) + 2*gZlL*gZlR^3*mm^2*
          (2*s + d*(psq - s - t)) - 2*(-2 + d)*gZlL^2*gZlR^2*mm^2*
          (psq - s - t) + gZlL^4*(-((-2 + d)*mm^4) - (-2 + d)*psq^2 + 
           (-10 + d)*psq*s + 2*s*(s + t) + mm^2*((-2 + d)*psq + 2*s + 
             (-2 + d)*t)) + gZlR^4*(-((-2 + d)*mm^4) - (-2 + d)*psq^2 + 
           (-10 + d)*psq*s + 2*s*(s + t) + mm^2*((-2 + d)*psq + 2*s + 
             (-2 + d)*t))) + aa*(-2*(-2 + d)*gZlL^2*gZlR^2*mm^2*
          (2*mm^2 - 3*psq + s + t) + 2*gZlL^3*gZlR*mm^2*
          (-2*s + d*(-psq + s + t)) + 2*gZlL*gZlR^3*mm^2*
          (-2*s + d*(-psq + s + t)) + gZlL^4*((-2 + d)*mm^4 - 
           (-2 + d)*psq^2 - (-10 + d)*psq*s - 2*s*(s + t) + 
           mm^2*((-2 + d)*psq - 2*s + 2*t - d*t)) + 
         gZlR^4*((-2 + d)*mm^4 - (-2 + d)*psq^2 - (-10 + d)*psq*s - 
           2*s*(s + t) + mm^2*((-2 + d)*psq - 2*s + 2*t - d*t))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*
      (aa*d*(2*gZlL^3*gZlR*mm^2*(psq - t) + 2*gZlL*gZlR^3*mm^2*(psq - t) + 
         gZlL^4*(-2*psq^2 + mm^2*s - psq*s + 2*psq*t) + 
       ...
       bb*d*(2*gZlL^3*gZlR*mm^2*(-psq + t) + 2*gZlL*gZlR^3*mm^2*(-psq + t) + 
         ...
         gZlR^4*(2*psq^2 + mm^2*s - psq*(s + 2*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) + 
    (I*(-2 + d)*EL^5*gAl*(aa*(2*gZlL^3*gZlR*mm^2*(2*s + d*(-psq + t)) + 
    ...
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*
      (aa*(4*gZlL^3*gZlR*mm^2*s + 4*gZlL*gZlR^3*mm^2*s + 
    ...
    (I*(-2 + d)*EL^5*gAl*(aa*(2*gZlL^3*gZlR*mm^2*(-2*s + d*(-psq + s + t)) + 
         2*gZlL*gZlR^3*mm^2*(-2*s + d*(-psq + s + t)) + 
         gZlL^4*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - 2*s - t) + 2*s*t + 
           psq*(2*s + 2*t - d*t)) + gZlR^4*((-2 + d)*psq^2 + 
           (-2 + d)*mm^2*(psq - 2*s - t) + 2*s*t + psq*(2*s + 2*t - d*t))) - 
    ...
    (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl*(gZlL^4 + gZlR^4)*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)^2*EL^5*gAl*
      (gZlL^4 + gZlR^4)*(bb*(2*mm^2 - s - 2*t) + 
