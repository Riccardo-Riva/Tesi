...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
     ...
     \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl*gAu*gFZW*gXFW*gXll*
     (gZlL - gZlR)*mm^2*sw*(-psq + s + t)*(-2*psq^2 - 3*psq*(s - 2*t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
     ...
     (gZlL - gZlR)*mm^2*sw*(2*psq^2 + mm^2*s + 2*(s + t)^2 - psq*(5*s + 4*t))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl*gAu*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*(psq - t)^2*
