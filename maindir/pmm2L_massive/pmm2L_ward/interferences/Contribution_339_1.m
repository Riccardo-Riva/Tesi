...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 (((-I)*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
    (bb*(mm^4*(2*psq - s - 2*t) + 2*psq*(-psq^2 + psq*t + s*t) + 
       mm^2*s*(-3*psq + 2*(s + t))) + aa*(mm^2*s*(psq - 2*t) + 
       mm^4*(-2*psq + s + 2*t) + 2*psq*(psq^2 + psq*(s - t) - s*(s + t))))*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(-8*psq^3 + mm^4*(2*psq - 5*s - 2*t) - 
       4*psq^2*(s - 2*t) - s^2*(s + 2*t) + psq*s*(5*s + 2*t) + 
       mm^2*(-2*psq^2 + 13*psq*s - 3*s^2 + 2*psq*t - 2*s*t)) - 
     bb*(-8*psq^3 + mm^4*(2*psq + 3*s - 2*t) + 8*psq^2*(s + t) + 
       psq*s*(s + 2*t) - s^2*(s + 2*t) + mm^2*(-2*psq^2 - 7*psq*s + s^2 + 
         2*psq*t - 2*s*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(4*psq^3 + mm^4*(-psq - 2*s + t) + s^2*(2*s + 3*t) - 
       psq^2*(11*s + 4*t) + psq*s*(-3*s + 5*t) + 
       mm^2*(psq^2 + 5*psq*s - psq*t + 3*s*t)) + 
     aa*(-4*psq^3 + psq*s*(s - 5*t) + mm^4*(psq - 4*s - t) - 
       s^2*(2*s + 3*t) + psq^2*(5*s + 4*t) + mm^2*(-psq^2 + s*(2*s - 3*t) + 
         psq*(7*s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(2*psq*s*(4*psq - 5*s - 3*t) + mm^4*(-psq + s + t) + 
       mm^2*(-3*psq^2 + psq*s + 2*s^2 + 3*psq*t)) + 
     aa*(mm^4*(psq - 3*s - t) + 3*psq*s*(-2*psq + s + 2*t) + 
       mm^2*(3*psq^2 + 5*s^2 - psq*(s + 3*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(bb*(-4*psq^3 + mm^4*(psq + s - t) - s^2*(s + t) + 
       psq*s*(4*s + t) + psq^2*(5*s + 4*t) + 
       mm^2*(-psq^2 + s*(s - t) + psq*(-6*s + t))) + 
     aa*(4*psq^3 + psq^2*(s - 4*t) + s^2*(s + t) - psq*s*(2*s + t) + 
       mm^4*(-psq + 3*s + t) + mm^2*(psq^2 + s*(-3*s + t) - psq*(4*s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 4*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*Pi)^(2*d)*(-4*psq^3 + mm^4*(psq - 3*s - t) - s^2*(s + 3*t) + 
       psq^2*(3*s + 4*t) - psq*s*(2*s + 5*t) - 
       mm^2*(psq^2 + 3*s*(s + t) - psq*(12*s + t))) - 
     4^d*bb*Pi^(2*d)*(-4*psq^3 + mm^4*(psq + 3*s - t) - 5*psq*s*t - 
       s^2*(s + 3*t) + psq^2*(9*s + 4*t) - 
       mm^2*(psq^2 - psq*t + s*(5*s + 3*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/Pi^(4*d) + (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(-2*psq*s*(2*psq + 2*s - 3*t) + mm^4*(psq - t) + 
       mm^2*(3*psq^2 - 2*psq*s + 2*s^2 - 3*psq*t)) + 
     bb*(3*psq*s*(2*psq - s - 2*t) + mm^4*(-psq - 2*s + t) + 
       mm^2*(-3*psq^2 + 2*psq*s + 5*s^2 + 3*psq*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(bb*(-4*psq^3 + mm^4*(psq + 2*s - t) - s^2*t + 
       psq*s*(s + t) + psq^2*(3*s + 4*t) - mm^2*(psq^2 + psq*(s - t) + 
         s*(4*s + t))) + aa*(4*psq^3 + psq^2*(3*s - 4*t) + psq*s*(s - t) + 
       s^2*t + mm^4*(-psq + 2*s + t) + mm^2*(psq^2 + s*(2*s + t) - 
         psq*(9*s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
   ...
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
    (aa*(mm^4 + 2*psq*(-psq + s + t) + mm^2*(-3*psq + 2*t)) + 
     bb*(mm^4 + 2*psq*(psq - t) + mm^2*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*s*(bb*(2*mm^4 + psq*(7*psq - 3*s - 7*t) + 
       mm^2*(3*psq - 3*s - 5*t)) + aa*(2*mm^4 + mm^2*(-7*psq + 2*s + 5*t) + 
       psq*(-7*psq + 4*s + 7*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(mm^2 - psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(2*mm^4 + 6*psq^2 - 4*psq*t - 2*mm^2*(s + 2*t) - s*(s + 2*t)) + 
     aa*(2*mm^4 - 2*psq^2 + 4*psq*t + s*(s + 2*t) + 
       mm^2*(-8*psq + 2*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(6*mm^4 + 24*psq^2 + mm^2*(-6*psq + s - 6*t) - 2*s*(2*s + 3*t) - 
       3*psq*(s + 6*t)) + aa*(2*mm^4 - 16*psq^2 - psq*s + 4*s^2 + 18*psq*t + 
       6*s*t + mm^2*(-10*psq + 3*s + 6*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 + 6*psq^2 + 8*s*(s + t) - 3*psq*(3*s + 2*t) - 
       mm^2*(13*s + 2*t)) + bb*(2*mm^4 - 10*psq^2 - 8*s*(s + t) + 
       mm^2*(-9*s + 2*t) + psq*(31*s + 6*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 - 4*psq^2 - psq*s + 3*s^2 + 6*psq*t + 4*s*t + 
       mm^2*(-6*psq - 3*s + 2*t)) + bb*(6*mm^4 + 12*psq^2 + 5*psq*s - 3*s^2 - 
       6*psq*t - 4*s*t - mm^2*(10*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(6*mm^4 - 12*psq^2 + 2*s*(s + 3*t) + 3*psq*(s + 6*t) + 
       mm^2*(-18*psq + 7*s + 6*t)) + bb*(2*mm^4 + 20*psq^2 - 2*s*(s + 3*t) - 
       psq*(7*s + 18*t) + mm^2*(2*psq - 3*(s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 + 2*psq^2 + 9*psq*s + mm^2*(4*psq - 11*s - 2*t) - 6*psq*t + 
       8*s*t) + bb*(2*mm^4 - 6*psq^2 + 13*psq*s + 6*psq*t - 8*s*t + 
       mm^2*(-4*psq - 11*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(2*mm^4 + 8*psq^2 + psq*(s - 6*t) - mm^2*(2*psq + 5*s + 2*t) - 
       s*(s + 4*t)) + aa*(6*mm^4 + 3*psq*(s + 2*t) + 
       mm^2*(-14*psq + s + 2*t) + s*(s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*mm^2*(6*psq - 5*s - 6*t) + aa*psq*(2*psq + s - 2*t) + 
     bb*psq*(-2*psq + 3*s + 2*t) + bb*mm^2*(-6*psq + s + 6*t))*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(-10*psq^2 + mm^2*(2*psq - 3*s - 2*t) + 5*psq*(s + 2*t) + 
        s*(s + 2*t))) + aa*(-10*psq^2 + mm^2*(2*psq + s - 2*t) + 
       s*(s + 2*t) + psq*(s + 10*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(7*psq^2 - 2*psq*s + s^2 + mm^2*(5*psq - 6*s - 5*t) - 7*psq*t + 
       2*s*t) - bb*(7*psq^2 - 9*psq*s + s^2 + mm^2*(5*psq + s - 5*t) - 
       7*psq*t + 2*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*mm^2*(6*psq - 5*s - 6*t) + aa*psq*(2*psq + s - 2*t) + 
     bb*psq*(-2*psq + 3*s + 2*t) + bb*mm^2*(-6*psq + s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*bb*mm^4 + bb*psq*(9*psq - 6*s - 7*t) - bb*mm^2*(3*psq - 2*s + t) + 
     aa*mm^2*(-psq + 2*s + t) + aa*psq*(-7*psq + 2*s + 7*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-9*psq*s + mm^2*(2*psq - 3*s - 2*t) + 8*s*(s + t)) + 
     bb*(2*mm^4 - 2*psq^2 + 17*psq*s - 8*s*(s + t) + 
       mm^2*(-2*psq - 5*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-8*psq^2 + 8*psq*t + s*(mm^2 + 2*s + 3*t)) + 
     bb*(4*mm^4 + 12*psq^2 + mm^2*(-8*psq + s) - s*(2*s + 3*t) - 
       2*psq*(s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(2*mm^4 + psq*(16*psq - 11*s - 14*t) + mm^2*(-2*psq + 3*s - 2*t)) + 
     aa*(2*mm^4 + mm^2*(-6*psq + 5*s + 2*t) + psq*(-12*psq + 3*s + 14*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(mm^4 + s*(5*psq - 4*t) + mm^2*(-2*psq - 3*s + t)) - 
     aa*(psq^2 + psq*s - 4*s*t + mm^2*(-2*psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 - 6*psq^2 - psq*s + 2*s^2 + mm^2*(-4*psq + 2*s) + 8*psq*t + 
       3*s*t) + bb*(2*mm^4 - 4*mm^2*psq + 10*psq^2 - s*(2*s + 3*t) - 
       psq*(s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(3*mm^2 + psq)*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (aa*(-5*psq^2 + 4*psq*s - 2*s^2 + mm^2*(psq + 3*s - t) + 5*psq*t - 
       3*s*t) + bb*(5*psq^2 - 5*psq*(2*s + t) + mm^2*(-psq + 3*s + t) + 
   ...
   (2*Pi)^(2*d) - (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(4*psq^2 - 9*psq*s + 2*s^2 + 2*mm^2*(2*psq + s - 2*t) - 4*psq*t + 
     ...
     SP[q1, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(bb*(7*psq^2 - 17*psq*s + 4*s^2 + 
       5*mm^2*(psq + s - t) - 7*psq*t + 6*s*t) + 
     aa*(-7*psq^2 + 6*psq*s - 4*s^2 + 7*psq*t - 6*s*t + 
       mm^2*(-5*psq + 6*s + 5*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (3*mm^2 + psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q2, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*s*(-mm^2 - 5*psq + 4*(s + t)) + 2*bb*(mm^4 - psq^2 - 3*mm^2*s + 
       6*psq*s - 2*s*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2]])/Pi^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(psq^2 - 7*psq*s + 4*s^2 - mm^2*t + 4*s*t)) + 
     aa*(mm^4 - 3*psq*s + 4*s*(s + t) - mm^2*(4*s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*aa*(mm^4 - psq*s - mm^2*(psq + 3*s) + 2*s*(s + t)) - 
     bb*(2*psq^2 - 9*psq*s + mm^2*(-2*psq + s) + 4*s*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*psq*(3*psq - s - 3*t) + aa*mm^2*(psq - 3*s - t) - 
     bb*mm^2*(psq + s - t) + bb*psq*(-3*psq + 5*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-3*psq^2 - 3*psq*(s - t) + mm^2*(psq + s - t) + 4*s*(s + t)) + 
     bb*(3*psq^2 - 3*psq*t - 4*s*(s + t) + mm^2*(-psq + 2*s + t)))*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 - 4*mm^2*psq - 6*psq^2 + s*(s + 3*t) + psq*(s + 8*t)) + 
     bb*(2*mm^4 + 10*psq^2 + mm^2*(-4*psq + 2*s) - s*(s + 3*t) - 
       psq*(3*s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*bb*(mm^4 - mm^2*(psq + 3*s) + s*(3*psq - 2*t)) + 
     aa*(-2*psq^2 + mm^2*(2*psq - s) + psq*s + 4*s*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(-5*psq^2 + mm^2*(psq - 2*s - t) + s*t + 5*psq*(s + t))) + 
     aa*(-5*psq^2 + mm^2*(psq + 2*s - t) + s*t + psq*(s + 5*t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-7*psq^2 - 2*s*(s + t) + mm^2*(-5*psq + 6*s + 5*t) + 
       psq*(2*s + 7*t)) + bb*(7*psq^2 + 5*mm^2*(psq + s - t) + 2*s*(s + t) - 
       psq*(13*s + 7*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*mm^2*(3*psq - s - 3*t) - bb*mm^2*(3*psq + s - 3*t) + 
     aa*psq*(psq + s - t) + bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*aa*mm^4 + bb*psq*(7*psq - 5*s - 7*t) + bb*mm^2*(psq + s - t) + 
     aa*mm^2*(-5*psq + 3*s + t) + aa*psq*(-5*psq + s + 7*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^4 - 2*psq^2 + psq*s + mm^2*(2*psq - 7*s - 2*t) + 8*s*t) - 
     bb*(-7*psq*s + mm^2*(2*psq + s - 2*t) + 8*s*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(4*mm^4 - 4*psq^2 + s^2 + mm^2*(-8*psq + s) + 8*psq*t + 3*s*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(5*psq^2 - 7*psq*s + s^2 - 5*psq*t + 3*s*t + mm^2*(-psq + 4*s + t)) + 
     aa*(-5*psq^2 + mm^2*(psq + 2*s - t) - s*(s + 3*t) + psq*(s + 5*t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-7*psq^2 - 5*mm^2*(psq - 2*s - t) - 2*s*(s + 3*t) + 
       psq*(2*s + 7*t)) + bb*(7*psq^2 + mm^2*(5*psq + s - 5*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*s*(mm^2 - 3*psq + 4*t)) + 2*aa*(mm^4 - psq^2 - 3*mm^2*s + 2*psq*s + 
       2*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*psq*(3*psq + 2*s - 3*t) + aa*mm^2*(psq - 2*s - t) + 
     bb*mm^2*(-psq - 2*s + t) + bb*psq*(-3*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(-3*psq^2 - 5*psq*s + mm^2*(psq + s - t) + 3*psq*t + 4*s*t) + 
     bb*(3*psq^2 + 2*psq*s - 3*psq*t - 4*s*t + mm^2*(-psq + 2*s + t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(-5*psq^2 + 2*psq*s + s^2 + mm^2*(psq - 3*s - t) + 5*psq*t + 
        s*t)) + aa*(-5*psq^2 - 2*psq*s + s^2 + mm^2*(psq + s - t) + 5*psq*t + 
       s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (bb*(-4*psq^2 + 5*psq*s - 4*mm^2*(psq - t) + 4*psq*t - s*t) + 
     aa*(4*psq^2 + psq*s + mm^2*(4*psq - 6*s - 4*t) - 4*psq*t + s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-(bb*(7*psq^2 - 9*psq*s + mm^2*(5*psq + s - 5*t) - 7*psq*t + 2*s*t)) + 
     aa*(7*psq^2 + 2*psq*s + 5*mm^2*(psq - 2*s - t) - 7*psq*t + 2*s*t))*
  ...
  (I*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*
  ...
  (I*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
  ...
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*(aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^2 + 3*psq - 4*(s + t)) + bb*(5*mm^2 - 11*psq + 4*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(5*mm^2 - 3*psq - 4*t) + bb*(3*mm^2 - 5*psq + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^2 + 9*psq - 8*(s + t)) + bb*(9*mm^2 - 19*psq + 8*(s + t)))*
  ...
  (I*4^(2 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^2 + psq - s - 2*t) + bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p2, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(3*mm^2 - psq - 8*t) + 
     bb*(7*mm^2 - 9*psq + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, p3], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(6*mm^2 - 2*psq - s - 4*t) + bb*(2*mm^2 - 6*psq + s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^2 + 11*psq - 5*s - 12*t) + bb*(3*mm^2 - 15*psq + 5*s + 12*t))*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^2 + 5*psq - 4*(s + t)) + bb*(7*mm^2 - 13*psq + 4*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(7*mm^2 + 7*psq - 8*(s + t)) + bb*(3*mm^2 - 17*psq + 8*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(7*mm^2 + 3*psq - 4*(s + t)) + bb*(mm^2 - 11*psq + 4*(s + t)))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa + 2*bb)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^2 + psq - 2*(s + t)) + bb*(3*mm^2 - 5*psq + 2*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^2 + 2*psq - 3*s - 4*t) + bb*(6*mm^2 - 10*psq + 3*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(mm^2 - 3*psq - 4*t) + 
     bb*(7*mm^2 - 5*psq + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^2 + 7*psq - 3*s - 8*t) + bb*(3*mm^2 - 11*psq + 3*s + 8*t))*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(9*mm^2 - 3*psq - 8*t) + 
     bb*(mm^2 - 7*psq + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(3*mm^2 + 9*psq - 7*s - 12*t) + bb*(mm^2 - 13*psq + 7*s + 12*t))*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(7*mm^2 - 5*psq - 4*t) + 
     bb*(mm^2 - 3*psq + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) - (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(aa*(3*mm^2 - psq - 2*t) + bb*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*(2*aa + bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], SP[p3, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q2, q2]])/(4^d*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*
  ...
  (I*bb*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(-2*aa*psq + bb*(mm^2 + psq))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p2, q1]])/
   (2*Pi)^(2*d) - (I*4^(1 - d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(mm^2 + psq - s - 2*t) + bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(3*psq - 2*s - 3*t) + 
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(-2*bb*(mm^2 + psq) + 
     aa*(mm^2 + 3*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p2, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(mm^2 - 3*psq) + 
     bb*(mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(mm^2 + psq - 2*t) + 
     bb*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[q2, q2]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*aa*(mm^2 + psq - 2*(s + t)) + bb*(mm^2 - 5*psq + 4*(s + t)))*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(2*aa*(mm^2 - s - t) + 
     bb*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(mm^2 - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, q2], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(psq - s - t)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(mm^2 + psq - 2*t) + 
     ...
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(aa*(mm^2 - t) + bb*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*aa*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(3*mm^2 + psq - 4*t) + 
     4*bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1], 
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
  ...
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[p3, p3]])/(4^d*Pi^(2*d)) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(aa*(3*mm^2 - psq - 2*t) + 2*bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[q2, q2]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
