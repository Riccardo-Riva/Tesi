...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*s*
     (bb*(mm^4 + mm^2*(7*psq - s) - psq*s) + 
      aa*(mm^4 - psq*s + mm^2*(-9*psq + 3*s)))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
   (4^(1 - d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(aa*mm^2*(6*psq - 2*s) + 
      aa*(5*psq - s)*s + bb*s*(-psq + s) - 2*bb*mm^2*(3*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
     (aa*(mm^2*(2*psq - s) + (3*psq - s)*s) - 
      bb*((psq - s)*s + mm^2*(2*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (4^(1 - d)*(aa - bb)*d*EL^5*gAl*gXll^2*
     gZlL*gZlR*mm^4*(3*mm^2 + 2*psq - s)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*
     gXll^2*(gZlL^2 + gZlR^2)*mm^4*(mm^2 - s)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gXll^2*
     gZlL*gZlR*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    Pi^(2*d) + ((2 - d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*s*
     (bb*(mm^4 + mm^2*(7*psq - s) - psq*s) + 
      aa*(mm^4 - psq*s + mm^2*(-9*psq + 3*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/(2*Pi)^(2*d) + 
   (2^(3 - 2*d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(bb*(2*mm^2 + 2*psq - s) + 
      aa*(-4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    Pi^(2*d) - (4^(1 - d)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
     (bb*(mm^2 + 2*psq - s) + aa*(-3*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
     (2*mm^2 + 2*psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*
     (gZlL^2 + gZlR^2)*mm^2*(mm^4 + mm^2*(psq - 3*s) - psq*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(aa - bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(2*psq - s)*
   ...
   (4^(1 - d)*(aa - bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*s*\[Mu]^(8 - 2*d)*
