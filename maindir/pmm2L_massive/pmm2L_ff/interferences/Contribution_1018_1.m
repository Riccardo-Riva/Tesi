...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFAW*gFZW*(gZlL + gZlR)*mm^2*sw*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFAW*gFZW*(gZlL + gZlR)*(mm^2 - psq)*
      sw*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
     (mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFAW*gFZW*
      (gZlL + gZlR)*sw*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu*gFAW*gFZW*(gZlL + gZlR)*sw*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)*s) + 
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu*gFAW*gFZW*(gZlL + gZlR)*sw*
