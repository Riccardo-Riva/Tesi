...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*
     ...
     Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*
     ((2 + d)*mm^2 - (-2 + d)*psq)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*
     (2*mm^2 - 2*psq + s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*(mm^2 - psq)*
     sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*sw*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*sw*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gFAW*gFFA*gFZW*(gZlL + gZlR)*sw*
