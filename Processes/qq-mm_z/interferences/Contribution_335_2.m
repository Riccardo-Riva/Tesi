...
PropList[KiraPropagator[p1 - q1, mt], KiraPropagator[-p2 - q1, mt]]*
 (((-3*I)*2^(-1 - 2*d)*EL^6*gAu^2*(gZuL + gZuR)*mt^2*
  ...
  ((I/2)*EL^6*gAu^2*((3*2^(1 - 2*d)*(gZuL + gZuR)*
       (-(gZlR*gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s^2) + d^2*gZuRC*(2*Pi)^d*s^2 + 
     ...
     (gZlR*gZlRC*(gZuL*(d^2*gZuLC*(2*Pi)^d*s^2 + d^2*gZuRC*(2*Pi)^d*s^2 + 
           2^(1 + d)*gZuRC*Pi^d*((6 - 6*d + d^2)*s^2 + 3*(8 - 5*d + d^2)*s*
              t + 6*t^2) + 2^(1 + d)*gZuLC*Pi^d*((24 - 12*d + d^2)*s^2 - 
             3*(-2 - 3*d + d^2)*s*t + 6*t^2)) - 
         gZuR*(d^2*gZuRC*(2*Pi)^d*s^2 - 2^(1 + d)*gZuRC*Pi^d*
            (2*(3 - 3*d + d^2)*s^2 + 3*(8 - 5*d + d^2)*s*t + 6*t^2) + 
           gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((48 - 30*d + 4*d^2)*
                s^2 + 3*(10 - 7*d + d^2)*s*t - 6*t^2)))) + 
       gZlL*gZlLC*(gZuR*(d^2*gZuLC*(2*Pi)^d*s^2 + d^2*gZuRC*(2*Pi)^d*s^2 + 
           2^(1 + d)*gZuLC*Pi^d*((6 - 6*d + d^2)*s^2 + 3*(8 - 5*d + d^2)*s*
              t + 6*t^2) + 2^(1 + d)*gZuRC*Pi^d*((24 - 12*d + d^2)*s^2 - 
             3*(-2 - 3*d + d^2)*s*t + 6*t^2)) + 
         gZuL*(-(gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(
                (48 - 30*d + 4*d^2)*s^2 + 3*(10 - 7*d + d^2)*s*t - 6*t^2))) + 
           gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*(3 - 3*d + d^2)*
                s^2 + 3*(8 - 5*d + d^2)*s*t + 6*t^2)))))/(2*Pi)^(2*d))*
  ...
  ((3*I)*2^(2 - d)*EL^6*gAu^2*(gZuL + gZuR)*
    (gZlL*gZlLC*((-2 + d)*gZuLC - (-4 + d)*gZuRC) + 
     gZlR*gZlRC*(-((-4 + d)*gZuLC) + (-2 + d)*gZuRC))*t*
  ...
  ((3*I)*2^(2 - d)*EL^6*gAu^2*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL + gZuR)*
   ...
   (Pi^d*(mz^2 - s)*(-mzC^2 + s)) - ((3*I)*2^(1 - d)*EL^6*gAu^2*(gZuL + gZuR)*
  ...
  ((3*I)*2^(1 - d)*EL^6*gAu^2*(gZuL + gZuR)*
   ...
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) + 
  ((3*I)*2^(3 - d)*EL^6*gAu^2*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL + gZuR)*
