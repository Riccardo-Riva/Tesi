...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
   ...
   ((3*4^(1 - d)*EL^6*gAu*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(-psq + s + t)^2*
    ...
    (3*4^(1 - d)*EL^6*gAu*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(psq - t)*
     ...
     Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
      (psq^2 - s^2 - 2*psq*t + t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFFA*gFll*gHFW*gHll*
      gWNl*mm^2*(-psq + s + t)*(psq*(psq - 2*s - t) + 3*mm^2*(-psq + s + t))*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(psq - t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
