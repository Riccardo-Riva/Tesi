...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   ((2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
      (-(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(mm^2 - psq)*s*
         (psq^2 - 2*psq*t + t*(s + t))) - 4^(1 + d)*(gZlL^2 + gZlR^2)*
        Pi^(2*d)*s*(3*mm^2 - 7*psq + 2*s + 4*t)*(psq^2 - 2*psq*t + 
         t*(s + t)) + 2*d*(gZlL^2*(2*Pi)^(2*d)*s*(4*mm^2 - 6*psq + s + 2*t)*
     ...
     (Pi^(4*d)*s) + (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
      (-(4^(1 + d)*(-4 + d)*gZlL*gZlR*Pi^(2*d)*(mm^2 - psq)*s*
         (psq - s - t)) + gZlL^2*(-(d^2*(2*Pi)^(2*d)*psq*(3*psq^2 - psq*s + 
            3*t*(s + t))) + (-2 + d)*mm^2*(2*Pi)^(2*d)*((-4 + 3*d)*psq^2 + 
     ...
     (Pi^(4*d)*s) - (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
      (2*gZlL*gZlR*(-(d^2*(2*Pi)^(2*d)*psq*s*(psq - s - t)) + 
         2^(1 + 2*d)*mm^2*Pi^(2*d)*(psq - s - t)*((-2 + d)^2*psq - d*s - 
           4*t + 4*d*t - d^2*t) - 4^(1 + d)*Pi^(2*d)*s*(psq^2 + s*(s + t) - 
       ...
       gZlL^2*(-(d^2*(2*Pi)^(2*d)*psq*s*(3*psq - s - t)) - 
         (-2 + d)*mm^2*(2*Pi)^(2*d)*(psq - s - t)*(2*(2 + d)*psq - 
          ...
          (4*(-2 + d)*psq^3 + psq^2*(2*(-9 + 5*d)*s + (28 - 16*d + d^2)*t) + 
           ...
           2*psq*((-3 + 2*d)*s^2 + (-7 + 2*d)*s*t + (16 - 10*d + d^2)*
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
      (gZlL^2*(d^2*(2*Pi)^(2*d)*psq*s*(3*psq - 7*t) + (-2 + d)*mm^2*
          (2*Pi)^(2*d)*(psq - t)*(2*(2 + d)*psq - (-2 + d)*s - 2*(2 + d)*t) + 
       ...
       gZlR^2*(d^2*(2*Pi)^(2*d)*psq*s*(3*psq - 7*t) + (-2 + d)*mm^2*
          (2*Pi)^(2*d)*(psq - t)*(2*(2 + d)*psq - (-2 + d)*s - 2*(2 + d)*t) + 
         2^(1 + 2*d)*Pi^(2*d)*(-2*(8 - 6*d + d^2)*psq^3 + 
           t*(s + t)*((20 - 10*d + d^2)*s + (12 - 8*d + d^2)*t) - 
           2*psq*t*((29 - 16*d)*s + 2*(10 - 7*d + d^2)*t) + 
       ...
       2*gZlL*gZlR*(2^(1 + 2*d)*mm^2*Pi^(2*d)*(psq - t)*((-2 + d)^2*psq - 
           ...
           2*d*(psq - t)*(2*psq^2 - 5*psq*s + s^2 - 4*psq*t + 4*s*t + 
             2*t^2) + 4*s*(-psq^2 + s*t + psq*(s + t)))))*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*
       ...
       2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(2*mm^2*((-2 + d)^2*psq - d*s - 4*t + 
           4*d*t - d^2*t) - s*((12 - 10*d + d^2)*psq + 
           2*(-2 + d)*(s + 2*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
     Pi^(4*d) - (2^(1 - 4*d)*EL^6*gAl^3*gAu*
      (-(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(mm^2 - psq)*s*
         (psq^2 - 2*psq*t + t*(s + t))) - 2^(3 + 2*d)*(gZlL^2 + gZlR^2)*
        Pi^(2*d)*s*(3*mm^2 - 5*psq + s + 2*t)*(psq^2 - 2*psq*t + t*(s + t)) + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(-4*gZlL*gZlR*mm^2*
       ...
       gZlL^2*((8 - 6*d + d^2)*mm^4*(psq - t) - 
         ...
         mm^2*((44 - 24*d + 3*d^2)*psq^2 - 2*(-2 + d)*s^2 + 
           ...
           2*(18 - 9*d + d^2)*t^2) + (-2 + d)*(4*psq^3 + 
           psq^2*((-10 + d)*s - 12*t) - 4*t*(s + t)^2 + 
           2*psq*t*(7*s + 6*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^3*gAu*
      (-((gZlL^2 + gZlR^2)*(psq - 2*s - t)*(2*psq^2 + mm^2*s + 2*t*(s + t) - 
          psq*(s + 4*t))) + d*(-2*gZlL*gZlR*mm^2*(2*psq^2 + mm^2*s - 
           6*psq*s + 2*s^2 - 4*psq*t + 5*s*t + 2*t^2) + 
         gZlL^2*(psq^3 + 3*psq*t*(s + t) - t*(s + t)^2 - psq^2*(s + 3*t)) + 
         gZlR^2*(psq^3 + 3*psq*t*(s + t) - t*(s + t)^2 - psq^2*(s + 3*t))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - 2*d)*EL^6*gAl^3*gAu*(d^2*(gZlL^2 + gZlR^2)*mm^2*(2*Pi)^(2*d)*
        (psq^2 - mm^2*s - 2*psq*t + t*(s + t)) - 
       4*s*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*(2*d*gZlL*gZlR*mm^2*(2*psq^2 - 3*psq*s + 
         s^2 - 4*psq*t + 3*s*t + 2*t^2) + gZlL^2*(-((12 - 4*d + d^2)*psq^3) + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(d^2*(-4*gZlL*gZlR*mm^2*(mm^2 - psq)*
          (psq - t) + gZlL^2*(psq^2*s + mm^4*(psq - t) - 
           mm^2*(3*psq^2 - 5*psq*t + 2*t*(s + t))) + 
         gZlR^2*(psq^2*s + mm^4*(psq - t) - mm^2*(3*psq^2 - 5*psq*t + 
             2*t*(s + t)))) - 2*d*(-2*gZlL*gZlR*mm^2*(-7*psq^2 - 3*psq*s + 
           s^2 + 6*mm^2*(psq - t) + 8*psq*t + 3*s*t - t^2) + 
         gZlL^2*(4*psq^3 + 5*psq^2*(s - 2*t) + mm^4*(psq - t) - 
    ...
    (4^(1 - 2*d)*EL^6*gAl^3*gAu*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
       ...
       gZlL^2*(-((-2 + d)*d*mm^4*(2*Pi)^(2*d)*s) + mm^2*(2*Pi)^(2*d)*
         ...
         2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + 
           ...
           t*(s + t)*((-4 + d)*s + 2*(-2 + d)*t))) + 
       gZlR^2*(-((-2 + d)*d*mm^4*(2*Pi)^(2*d)*s) + mm^2*(2*Pi)^(2*d)*
          ((8 - 6*d + d^2)*psq^2 - 2*(-4 + d)*s^2 + (-2 + d)^2*s*t + 
           (8 - 6*d + d^2)*t^2 + 2*(-2 + d)*psq*(s - (-4 + d)*t)) + 
         2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + 
           2*psq^2*(s - 3*(-2 + d)*t) - psq*(s + 2*t)*(2*s - 3*(-2 + d)*t) - 
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*(2^(3 + 2*d)*Pi^(2*d)*
        (gZlL*gZlR*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
         ...
         gZlL^2*(2*Pi)^(2*d)*(2*t^2*(s + t) + psq^2*(-3*s + 2*t) + 
           psq*(s^2 + s*t - 4*t^2) - mm^2*(2*psq^2 - 3*psq*s + s^2 - 
             4*psq*t + 3*s*t + 2*t^2)) - gZlR^2*(2*Pi)^(2*d)*
          (psq^2*(3*s - 2*t) - 2*t^2*(s + t) - psq*(s^2 + s*t - 4*t^2) + 
    ...
    (4^(1 - 2*d)*EL^6*gAl^3*gAu*(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(psq - t)*
       ...
       4*s*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s - t) + 
         gZlL^2*(2*Pi)^(2*d)*(-6*psq^2 + 2*mm^2*(psq - t) - 2*t*(s + t) + 
           psq*(s + 8*t)) + gZlR^2*(2*Pi)^(2*d)*(-6*psq^2 + 
           2*mm^2*(psq - t) - 2*t*(s + t) + psq*(s + 8*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(4*d)*s) - 
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
      (-(d^2*(2*Pi)^(2*d)*(mm^2 - psq)*(psq - t)^2) + 2^(1 + 2*d)*d*Pi^(2*d)*
        (psq - t)*(-5*psq^2 + mm^2*(psq + s - t) + 7*psq*t - 2*t*(s + t)) + 
       4^(1 + d)*Pi^(2*d)*(2*psq^3 + 2*psq^2*(s - 2*t) - 
         psq*(mm^2*s + 4*s*t - 2*t^2) + s*t*(mm^2 + 2*(s + t))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/(Pi^(4*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*(2*(gZlL^2 + gZlR^2)*(2*psq^3 + mm^2*psq*s + 
         3*psq*t*(5*s + 2*t) - psq^2*(7*s + 6*t) - 
         t*(mm^2*s + 6*s^2 + 8*s*t + 2*t^2)) + 
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*
      (d^2*(psq - t)*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
           (2*psq - s - 2*t)) + gZlL^2*(2*Pi)^(2*d)*(-3*psq^2 + 
           mm^2*(psq - s - t) - 2*t*(s + t) + psq*(s + 5*t)) + 
         gZlR^2*(2*Pi)^(2*d)*(-3*psq^2 + mm^2*(psq - s - t) - 2*t*(s + t) + 
           psq*(s + 5*t))) - 2*d*(-(2^(3 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
           (2*psq - s - 2*t)*(psq - t)) + gZlL^2*(2*Pi)^(2*d)*
          (-11*psq^3 + mm^2*(psq - t)*(psq - 4*s - t) - 9*psq*t*(s + 3*t) + 
           3*psq^2*(s + 10*t) + 2*t*(-s^2 + 3*s*t + 4*t^2)) + 
         gZlR^2*(2*Pi)^(2*d)*(-11*psq^3 + mm^2*(psq - t)*(psq - 4*s - t) - 
           9*psq*t*(s + 3*t) + 3*psq^2*(s + 10*t) + 
           2*t*(-s^2 + 3*s*t + 4*t^2))) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*mm^2*((-2 + d)^2*gZlL^2*(psq - t)^2 + 
     ...
     (Pi^(2*d)*s) + (2^(1 - 4*d)*EL^6*gAl^3*gAu*
      (d^2*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)*
           (psq - t)) + gZlL^2*(2*Pi)^(2*d)*(-4*psq^3 + 
           mm^2*(2*psq - s - 2*t)*(psq - t) + 2*t*(s + t)^2 - 
           psq*t*(7*s + 8*t) + psq^2*(3*s + 10*t)) + gZlR^2*(2*Pi)^(2*d)*
          (-4*psq^3 + mm^2*(2*psq - s - 2*t)*(psq - t) + 2*t*(s + t)^2 - 
       ...
       2^(3 + 2*d)*Pi^(2*d)*(gZlL*gZlR*mm^2*(2*psq - s - 2*t)*(psq - t) + 
         ...
         gZlR^2*(8*psq^3 + 2*mm^2*psq*s - 11*psq^2*(s + 2*t) + 
           5*psq*t*(5*s + 4*t) - 2*t*(mm^2*s + 4*s^2 + 7*s*t + 3*t^2))) - 
       2*d*(-(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)*
           (psq - t)) + gZlL^2*(2*Pi)^(2*d)*(-16*psq^3 + 
           mm^2*(2*psq - 3*s - 2*t)*(psq - t) - 3*psq*t*(13*s + 12*t) + 
           psq^2*(17*s + 42*t) + 2*t*(6*s^2 + 11*s*t + 5*t^2)) + 
         gZlR^2*(2*Pi)^(2*d)*(-16*psq^3 + mm^2*(2*psq - 3*s - 2*t)*
            (psq - t) - 3*psq*t*(13*s + 12*t) + psq^2*(17*s + 42*t) + 
           2*t*(6*s^2 + 11*s*t + 5*t^2))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(4*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*(d^2*(-2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
          (psq - t) + gZlL^2*(-3*psq^3 + mm^2*(psq - t)*(psq - s - t) + 
           2*psq^2*(s + 4*t) - psq*t*(5*s + 7*t) + t*(s^2 + 3*s*t + 2*t^2)) + 
         gZlR^2*(-3*psq^3 + mm^2*(psq - t)*(psq - s - t) + 
           2*psq^2*(s + 4*t) - psq*t*(5*s + 7*t) + 
           t*(s^2 + 3*s*t + 2*t^2))) - 
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*(-(4^(1 + d)*(-2 + d)^2*gZlL*gZlR*mm^2*
       ...
       gZlL^2*(-(d^2*(2*Pi)^(2*d)*(mm^2 - psq)*s*(psq - s - t)) + 
         2^(1 + 2*d)*Pi^(2*d)*(4*(-2 + d)*psq^3 + 
           ...
           psq*(-4*(3*s^2 + 5*s*t + 6*t^2) + d*(mm^2*s + 5*s^2 + 11*s*t + 12*
                t^2)))) + gZlR^2*(-(d^2*(2*Pi)^(2*d)*(mm^2 - psq)*s*
