...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   KiraPropagator[q2, mw]]*((2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFFZZ*
    ...
    (Pi^(2*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gFFZZ*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gFFZZ*(2^(1 + 2*d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gFFZZ*(gZlL^2 + gZlR^2)*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFFZZ*(gZlL^2 + gZlR^2)*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gFFZZ*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
