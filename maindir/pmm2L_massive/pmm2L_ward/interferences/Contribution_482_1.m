...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((I*4^(-1 - d)*EL^5*gHFAW*gHFW*gWlN*gWNl*(bb*psq*(3*psq - s - 3*t) - 
     aa*psq*(3*psq + s - 3*t) + aa*mm^2*(psq + s - t) + 
     bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gHFAW*gHFW*gWlN*gWNl*(bb*psq*(3*psq - 4*s - 3*t) + 
     aa*mm^2*(psq - t) + bb*mm^2*(-psq + 2*s + t) + 
     aa*psq*(-3*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   Pi^(2*d) + (I*(aa + bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa + bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*(mm^2 - psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*(-psq + s + t)*\[Mu]^(8 - 2*d)*
