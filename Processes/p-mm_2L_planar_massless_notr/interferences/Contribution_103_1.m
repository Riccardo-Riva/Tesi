...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
  ...
  ((4^(1 - d)*EL^8*gAl^4*gAu^2*(2*gZlL^2*s*((-10 + 3*d)*s^2 + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(18*(gZlL^2 + gZlR^2)*s^3 + 
      d^2*(gZlL^2 + gZlR^2)*s^3 - d*(9*gZlL^2*s^3 + 9*gZlR^2*s^3))*
     SPList[SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^4*gAu^2*(d^2*(2*gZlL^2*s^3 + 2*gZlR^2*s^3) + 
      12*(gZlL^2 + gZlR^2)*s*(3*s^2 - 4*s*t - 4*t^2) - 
      2*d*(gZlL^2*s*(9*s^2 - 4*s*t - 4*t^2) + gZlR^2*s*(9*s^2 - 4*s*t - 
          4*t^2)))*SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ((-4 + d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2*(8*s^2 + 40*s*t - 8*d*s*t + 24*t^2 - 
        4*d*t^2) + gZlR^2*(8*s^2 + 40*s*t - 8*d*s*t + 24*t^2 - 4*d*t^2))*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(-4*(gZlL^2 + gZlR^2)*
       (s^2 - 10*s*t - 6*t^2) + 2*d*(gZlL^2*(s^2 - 4*s*t - 2*t^2) + 
        gZlR^2*(s^2 - 4*s*t - 2*t^2)))*SPList[SP[p1, q1], SP[p2, q2]])/
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ((-6 + d)*s - 2*t)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + t)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(-4*(gZlL^2 + gZlR^2)*
       (5*s^2 - 2*s*t - 6*t^2) + 2*d*(gZlL^2*(3*s^2 - 2*t^2) + 
        gZlR^2*(3*s^2 - 2*t^2)))*SPList[SP[p1, q2], SP[p2, q1]])/
   ...
   (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2*(100*s^2 - 44*d*s^2 + 5*d^2*s^2 + 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(4 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
     (gZlL^2 + gZlR^2)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2*(4*(-2 + d)*s^2 + 8*s*t - 
        4*(-6 + d)*t^2) + gZlR^2*(4*(-2 + d)*s^2 + 8*s*t - 4*(-6 + d)*t^2))*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ((-4 + d)*s + 2*t)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*t*
     SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(2*(12 - 6*d + d^2)*gZlL^2*s^2 + 
      2*(12 - 6*d + d^2)*gZlR^2*s^2)*SPList[SP[p2, q2], SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     (s - 2*t)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2*(64*s^2 - 32*d*s^2 + 4*d^2*s^2 - 
    ...
    (Pi^(2*d)*s^2) + (2^(4 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*(-6*(gZlL^2 + gZlR^2)*s + 
      d*(gZlL^2*s + gZlR^2*s))*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-6 + d)^2*(-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
   (2^(4 - 2*d)*(-5 + d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
