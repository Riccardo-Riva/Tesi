...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   (-((4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq^2 - 2*psq*t + t*(s + t))*
      ...
      (-((4 + 3*d)*psq^3) + 4*t*(s + t)^2 + psq^2*((6 + d)*s + 6*(2 + d)*t) - 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2*(4*psq - d*s - 4*t)*
        (psq - t) + 2*(-2*(-3 + d)*psq^3 + psq^2*(2*(-4 + d)*s + 
           (-16 + 5*d)*t) + psq*(s^2 + 2*(9 - 2*d)*s*t + 2*(7 - 2*d)*t^2) + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(8*psq^3 - 
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*(2*mm^2*((-8 + d)*psq + 6*s - d*s + 8*t - 
         d*t) + s*((-8 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-2*psq^3 - 4*psq*t*(s + t) + 
       t*(s + t)^2 + mm^4*(-psq + s + t) + psq^2*(s + 5*t) + 
       mm^2*(4*psq^2 - 4*psq*s + s^2 - 7*psq*t + 4*s*t + 3*t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((-4 + d)*mm^4*(psq - s - t) + 
       2*(-2*psq^3 - 4*psq*t*(s + t) + t*(s + t)^2 + psq^2*(s + 5*t)) + 
       mm^2*(-((-13 + d)*psq^2) + (-14 + d)*psq*s + (-22 + d)*psq*t + 
         3*(s^2 + 4*s*t + 3*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      ...
      (-6*psq^3 + 2*mm^4*(psq - t) + psq^2*(s + 16*t) + 
       ...
       mm^2*(-3*psq*s + s^2 - 2*psq*t + 5*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-8*psq^3 - 
       (-4 + d)*mm^4*(psq - t) - 16*psq*t*(s + t) + 4*t*(s + t)^2 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(4*psq^3 + 
       (-4 + d)*mm^4*(psq - t) - 4*t^2*(s + t) - psq^2*((-6 + d)*s + 12*t) - 
       2*psq*(s^2 - s*t - 6*t^2) + mm^2*((-2 + d)*psq^2 + 4*psq*s - 2*s^2 + 
         (8 - 3*d)*psq*t + 2*(-6 + d)*s*t + 2*(-3 + d)*t^2))*\[Mu]^(8 - 2*d)*
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*psq^2 + psq*(s - 4*t) + 2*t^2)*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      ((-2 + d)*psq - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p2, q2]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      ((-4 + d)*mm^2 - (-6 + d)*psq + 6*s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*(-3 + d)*psq^2 + 
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(4*psq - (-2 + d)*s - 4*t)*
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-4*psq^2 + (-6 + d)*psq*s + 
    ...
    (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
    (4^(3 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
