...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (((-I)*2^(1 - 2*d)*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*s*sw*
   ...
   (I*4^(1 - d)*aa*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
   ...
   (I*4^(1 - d)*bb*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
   ...
   (I*2^(3 - 2*d)*aa*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (I*2^(3 - 2*d)*bb*EL^5*gFZW*gWWA*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
