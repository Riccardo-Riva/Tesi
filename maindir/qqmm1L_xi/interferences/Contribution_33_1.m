...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl^2*gAu^2*(s + t)*(gZlR*(d^3*gZuL*(2*Pi)^d*s - 
    ...
    (I*EL^6*gAl^2*gAu^2*(gZlR*(d^3*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*
          (2*(-2 + d)^2*s^2 + (56 - 30*d + 3*d^2 + d^3)*s*t + 
           (-16 + 22*d - 8*d^2 + d^3)*t^2) + gZuL*(-(d^3*(2*Pi)^d*s*t) + 
           2^(1 + d)*Pi^d*(2*(8 - 6*d + d^2)*s^2 + (52 - 33*d + 3*d^2 + d^3)*
              s*t + (-20 + 20*d - 8*d^2 + d^3)*t^2))) + 
       gZlL*(d^3*gZuL*(2*Pi)^d*s*t - 2^(1 + d)*gZuL*Pi^d*(2*(-2 + d)^2*s^2 + 
           (56 - 30*d + 3*d^2 + d^3)*s*t + (-16 + 22*d - 8*d^2 + d^3)*t^2) + 
         gZuR*(-(d^3*(2*Pi)^d*s*t) + 2^(1 + d)*Pi^d*(2*(8 - 6*d + d^2)*s^2 + 
             (52 - 33*d + 3*d^2 + d^3)*s*t + (-20 + 20*d - 8*d^2 + d^3)*
              t^2))))*\[Mu]^(4 - d)*SPList[SP[p2, q1]])/((2*Pi)^(2*d)*s) - 
    (I*EL^6*gAl^2*gAu^2*(gZlR*(d^3*gZuL*(2*Pi)^d*s^2 - d^3*gZuR*(2*Pi)^d*
          s^2 + 2^(1 + d)*gZuL*Pi^d*(-((-20 + d + 3*d^2)*s^2) + 
       ...
       gZlL*(d^3*gZuL*(2*Pi)^d*s^2 - d^3*gZuR*(2*Pi)^d*s^2 + 
         ...
         2^(1 + d)*gZuR*Pi^d*((-16 + 6*d + d^2)*s^2 - 2*(60 - 37*d + 6*d^2)*s*
           ...
           2^(1 + d)*Pi^d*((-20 + 9*d + d^2)*s^2 - 2*(54 - 37*d + 6*d^2)*s*
              t - 4*(8 - 6*d + d^2)*t^2))))*\[Mu]^(4 - d)*SPList[SP[q1, q1]])/
    ...
    (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
     ...
     (mz^2*Pi^(2*d)*s) + (I*2^(2 - d)*EL^6*gAl^2*gAu^2*
      ((-56 + 46*d - 12*d^2 + d^3)*gZlL*gZuL - (-52 + 44*d - 12*d^2 + d^3)*
        gZlR*gZuL - (-52 + 44*d - 12*d^2 + d^3)*gZlL*gZuR + 
   ...
   (((-I)*EL^6*gAl^2*gAu^2*(s + t)*
      ...
      \[Mu]^(4 - d)*SPList[SP[q1, q1]])/(mz^2*(2*Pi)^d*s) - 
    (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
      (gZlL*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
         2^(1 + d)*gZuR*Pi^d*((4 - 3*d)*s^2 + (4 - 5*d + d^2)*s*t - 2*t^2) + 
         2^(1 + d)*gZuL*Pi^d*(2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 
   ...
   (((-I)*EL^6*gAl^2*gAu^2*(s + t)*
      (-(gZlR*gZuL*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) - 
       ...
       gZlL*gZuL*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
       gZlR*gZuR*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
      \[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[q1, q1]])/((2*Pi)^d*s) + 
    (I*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
      ...
      (-((2^(1 - 2*d)*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
       ...
       SP[q1, q1]])/s + I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((2^(1 - 2*d)*(gZlL*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
    ...
    (I*EL^6*gAl^2*gAu^2*
     ...
     (2*Pi)^(2*d) - (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - 
       (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*
      (s + t)^2*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], 
       SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^d*s) - 
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
     ...
     (mz^2*Pi^d*s) - (I*2^(3 - d)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)*
      (gZuL + gZuR)*(s + t)^2*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^d*s) - 
    (I*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(gZlL*gZuL*((-2 + d)*s^2 - 2*t^2) + 
       ...
       gZlL*gZuR*((-4 + d)*s^2 + 2*t^2))*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*(6*gZlR*gZuL*s + d*(gZlL - gZlR)*
       ...
       4*gZlL*gZuR*t + 4*gZlR*gZuR*t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
      ...
      (d*(gZlL - gZlR)*(gZuL - gZuR)*s - 2*(gZlL*gZuL*t + gZlR*gZuR*t + 
         gZlR*gZuL*(-3*s + t) + gZlL*gZuR*(-3*s + t)))*\[Mu]^(4 - d)*
   ...
   (((-I)*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
       ...
       (-(gZlR*(-(d*gZuL*(2*Pi)^d*s*(s - t)) + d*gZuR*(2*Pi)^d*s*(s - t) + 
         ...
         gZlL*(d*gZuR*(2*Pi)^d*s*(s - t) - 2^(1 + d)*gZuR*Pi^d*
            (2*s^2 - (-3 + d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*(s - t)) + 
             2^(1 + d)*Pi^d*(s^2 - d*s*t - t^2))))*GaugeXi[Q]^2)*
      SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*s*
      (-1 + GaugeXi[Q])) - (I*EL^6*gAl^2*gAu^2*t*(s + t)*\[Mu]^(4 - d)*
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
     ...
     (mz^2*Pi^d*s) + (I*2^(2 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - 
       (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*t*
      (s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, q1], 
       SP[q1, q1]])/(mz^2*Pi^d*s) + (I*2^(3 - d)*EL^6*gAl^2*gAu^2*
