PropList[KiraPropagator[-p1 + q1, mw], KiraPropagator[p2 + q1, 
    mw*Sqrt[GaugeXi[Q]]]]*
  ((I*EL^6*gAl*gAu*gFZW^2*(gZlR*gZuL*(2^(2 + d)*mmv^4*Pi^d + 
      ...
      gZlR*gZuR*(2^(2 + d)*mmv^4*Pi^d + 2^(1 + d)*(-2 + d)*mm^2*Pi^d*s + 
        ...
        2^(4 + d)*Pi^d*s*t - 5*2^(1 + d)*d*Pi^d*s*t + 2^(1 + d)*d^2*Pi^d*s*
         t + 2^(2 + d)*Pi^d*t^2 - 2^(1 + d)*mmv^2*Pi^d*((-2 + d)^2*s + 
          4*t))))/(2^(2*(1 + d))*Pi^(2*d)*(mz^2 - s)^2*s*sw^2) - 
   ...
   (I*EL^6*gAl*gAu*gFZW^2*(gZlR*gZuL*(2^(1 + d)*mm^2*Pi^d + 
        2^(1 + d)*(-4 + d)*mmv^2*Pi^d + 2^(2 + d)*Pi^d*s - d*(2*Pi)^d*s + 
        3*2^(1 + d)*Pi^d*t - 2^(1 + d)*d*Pi^d*t) + 
   ...
   (I*EL^6*gAl*gAu*gFZW^2*(gZlL*(-(2^(2 + d)*gZuL*Pi^d) + 
      ...
      gZlR*(2^(1 + d)*gZuL*Pi^d - 2^(2 + d)*gZuR*Pi^d - d*gZuL*(2*Pi)^d + 
        d*gZuR*(2*Pi)^d))*(-mmv^2 + s + t)*SPList[SP[p1, p2], SP[p1, q1]])/
   ...
   (I*EL^6*gAl*gAu*gFZW^2*(gZlL + gZlR)*(gZuL + gZuR)*
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gFZW^2*
     ...
     SPList[SP[p2, q1], SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*s*sw^2) + 
   (I*2^(-1 - d)*EL^6*gAl*gAu*gFZW^2*
     (gZlR*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
      gZlL*gZuR*(2*mmv^2 - (-4 + d)*s - 2*t) + 
      gZlL*gZuL*(2*mmv^2 + (-2 + d)*s - 2*t) + 
  ...
  (((-I)*2^(-1 - 2*d)*EL^6*gAl*gAu*gFZW^2*
   ...
   (I*2^(-1 - d)*EL^6*gAl*gAu*gFZW^2*
     (gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
      gZlL*gZuR*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
      gZlL*gZuL*(-2*mmv^2 - (-2 + d)*s + 2*t) + 
      gZlR*gZuR*(-2*mmv^2 - (-2 + d)*s + 2*t))*SPList[SP[p1, p2], 
      SP[p1, p3]])/(mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) + 
   (I*2^(-1 - d)*EL^6*gAl*gAu*gFZW^2*
     (gZlR*gZuL*(4*mm^2 + 2*(-5 + d)*mmv^2 + 4*s - d*s + 6*t - 2*d*t) + 
      gZlL*gZuR*(4*mm^2 + 2*(-5 + d)*mmv^2 + 4*s - d*s + 6*t - 2*d*t) + 
      gZlL*gZuL*(4*mm^2 - 2*(-1 + d)*mmv^2 - 2*s + d*s - 6*t + 2*d*t) + 
      gZlR*gZuR*(4*mm^2 - 2*(-1 + d)*mmv^2 - 2*s + d*s - 6*t + 2*d*t))*
     SPList[SP[p1, p2], SP[p1, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) + 
   (I*EL^6*gAl*gAu*gFZW^2*(gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 
        2^(1 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - d*gZuR*(2*Pi)^d) + 
      gZlL*(2^(1 + d)*gZuL*Pi^d - 2^(2 + d)*gZuR*Pi^d - d*gZuL*(2*Pi)^d + 
        d*gZuR*(2*Pi)^d))*(mmv^2 - t)*SPList[SP[p1, p2], SP[p2, q1]])/
    (mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*s*sw^2) + 
   (I*2^(-1 - d)*EL^6*gAl*gAu*gFZW^2*
     (gZlR*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
      gZlL*gZuR*(2*mmv^2 - (-4 + d)*s - 2*t) + 
   ...
   (I*2^(-1 - d)*EL^6*gAl*gAu*gFZW^2*
     (gZlL*gZuL*(2*mmv^2 + (-6 + d)*s - 2*t) + 
      gZlR*gZuR*(2*mmv^2 + (-6 + d)*s - 2*t) + 
      gZlR*gZuL*(2*mmv^2 - d*s - 2*t) + gZlL*gZuR*(2*mmv^2 - d*s - 2*t))*
     SPList[SP[p1, p3], SP[p1, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) + 
   (I*2^(-1 - d)*EL^6*gAl*gAu*gFZW^2*
     (gZlR*gZuL*(2*mmv^2 - (-4 + d)*s - 2*t) + 
      gZlL*gZuR*(2*mmv^2 - (-4 + d)*s - 2*t) + 
      gZlL*gZuL*(2*mmv^2 + (-2 + d)*s - 2*t) + 
   ...
   (I*2^(-1 - d)*EL^6*gAl*gAu*gFZW^2*
     (gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 2*t) + 
      ...
      SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*s*sw^2) + 
   (I*EL^6*gAl*gAu*gFZW^2*(gZlL + gZlR)*(gZuL + gZuR)*
     SPList[SP[p3, q1], SP[p3, q1]])/(mw^2*(2*Pi)^d*(mz^2 - s)^2*sw^2))
