...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*SPList[SP[p1, q1]])/
   (2*Pi)^(2*d) + (EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    SPList[SP[p3, q1]])/Pi^(2*d) - 
  (EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*SPList[SP[q1, q1]])/
   (4^d*Pi^(2*d)) - (EL^8*gAl*gAu^2*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
