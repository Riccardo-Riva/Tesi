...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((I*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*s*(aa*mm^2*(psq - t) + 
     aa*psq*(psq - s - t) + bb*psq*(-psq + t) + bb*mm^2*(-psq + s + t))*
    \[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*4^(-1 - d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
   ...
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*
    mm^2*s*(aa*(2*psq - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*
  ...
  (I*4^(-1 - d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*
    mm^2*s*(aa*(2*mm^2 - s - 2*t) + bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*ggpgpA^2*gHgpgp*
    gHll*mm^2*(aa*(2*psq^2 - 3*psq*s + 2*mm^2*(psq + s - t) - 2*psq*t - 
       s*t) + bb*(-((2*psq + s)*(psq - t)) + 2*mm^2*(-psq + s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
    (aa*(2*psq - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*(aa*(psq - t) + 
     bb*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/
   Pi^(2*d) + (I*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*(aa - bb)*EL^5*gAl*ggpgpA^2*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*
