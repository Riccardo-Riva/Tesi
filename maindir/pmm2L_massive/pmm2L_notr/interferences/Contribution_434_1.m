...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*
   ...
   (EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*(d^2*(mm^2 - psq)*s + 
      2*(-6*psq^2 + 6*mm^2*s + 3*psq*s - 3*s^2 + 8*psq*t - 5*s*t - 2*t^2) + 
      d*(6*psq^2 + psq*s + s^2 - 4*mm^2*(psq + s - t) - 8*psq*t + 3*s*t + 
        2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mz^2*(2*Pi)^(2*d)*s^2) + 
   (EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*(d^2*(mm^2 - psq - s)*s + 
   ...
   (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFAZ*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFAZ*
     (gZlL + gZlR)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)*s^2) + (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFFAZ*
  ...
  ((2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*
   ...
   (EL^8*gAl^3*gAu^2*gFFAZ*(gZlL + gZlR)*(d^2*s*(-mm^2 + psq + s) - 
      2*(2*psq^2 + 6*mm^2*s + psq*s - 9*s^2 + s*t - 2*t^2) + 
