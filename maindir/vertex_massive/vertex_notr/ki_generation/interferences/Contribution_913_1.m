...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
 ...
 ((2^(-1 - 2*d)*EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (mm^2*(4*psq - 7*s) + s*((11 - 5*d)*psq + (-8 + 5*d)*s))*sw*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (6*mm^2 + 2*psq - (2 + 3*d)*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   (2*Pi)^(2*d) + (EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (3*mm^2 + (-3 + 2*d)*(psq - 2*s))*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2*Pi)^(2*d) + (EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 + (-3 + d)*psq - (-2 + d)*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (2*Pi)^(2*d) - (EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (6*mm^2 + 2*psq - (2 + 3*d)*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (2*Pi)^(2*d) + (EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (-2*mm^2 + d*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (8*mm^2 - 12*psq - (-4 + d)*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
  ...
  ((-2 + d)*EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
