(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, 0], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*(18 - 9*d + d^2)*EL^8*gAl^2*gAu^2*
     (gZlL^4 + gZlR^4)*s*SPList[SP[p3, q2]])/Pi^(2*d) + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(2*s^2 - 2*(-5 + d)*s*t - 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(4*(-4 + d)^2*s^2 + 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     (gZlL^4 + gZlR^4)*SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
   (2^(5 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
