...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (-((EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq - 2*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq - 2*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (-mm^2 + psq + s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
    (-2*mm^2 + 2*psq + s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
    (gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFZW*gXFW*gXll*
