...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-((EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
      ...
      (gZlL + gZlR)*mh^2*mm^2*(2*(-1 + d)*mm^2 - (-2 + d)*psq)*
    ...
    (4^(1 - d)*EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) - (4^(1 - d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
      (gZlL + gZlR)*mh^2*mm^2*psq*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
      (gZlL + gZlR)*mh^2*mm^2*(2*mm^2 + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*(mm^2 - psq)*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
      (gZlL + gZlR)*mh^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/((mh^2 - mz^2)*Pi^(2*d)*s) - 
    (2^(1 - 2*d)*d*EL^6*gAl^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) - (4^(1 - d)*(-4 + d)*EL^6*gAl^2*gFFZ*gHFF*gHll*
