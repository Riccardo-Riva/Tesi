...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(-1 - 2*d)*EL^5*gAl*gHHZZ*mm^2*s*
      ...
      \[Mu]^(8 - 2*d))/Pi^(2*d)) + 
   (EL^5*gAl*gHHZZ*(2*aa*(gZlL^2 + gZlR^2)*psq*s - 
    ...
    (2*Pi)^(2*d) + ((aa - bb)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*
