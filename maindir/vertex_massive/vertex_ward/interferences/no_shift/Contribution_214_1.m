...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((EL^5*gFFA*gFZW^2*s*(aa*((-2 + d)*gZlL^2*(2*psq^2 + mm^2*(2*psq - s)) + 
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gFFA*gFZW^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gFFA*gFZW^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*
     sw^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFZW^2*(gZlL^2 + gZlR^2)*
