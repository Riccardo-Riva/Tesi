...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[W]]], 
  ...
  (((-I/9)*2^(-2 - d)*EL^6*(cw^2 - sw^2)*
   ...
   ((I/9)*2^(-1 - d)*EL^6*(cw^2 - sw^2)*(3*d*(-3 + 4*sw^2 + 4*swC^2) + 
     ...
     (-mzC^2 + s)*sw^2*swC^2) - ((I/9)*2^(-1 - d)*EL^6*(cw^2 - sw^2)*
   ...
   ((I/9)*2^(-1 - d)*EL^6*(cw^2 - sw^2)*(18 + 12*swC^2 - 48*swC^4 + 
     ...
     (s*(18 + 12*swC^2 - 48*swC^4 + 3*d*(-3 + 4*sw^2 + 4*swC^2) + 
      ...
      SP[p3, q1]])/(cw^2*cwC^2*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*sw^2*swC^2) - 
   ((I/9)*EL^6*(cw^2 - sw^2)*(-1 + 4*swC^2)*(9 - 12*swC^2 + 
