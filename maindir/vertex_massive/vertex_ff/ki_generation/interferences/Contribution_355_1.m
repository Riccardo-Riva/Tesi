...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(1 - d)*EL^6*gAl^5*gAu*mm^2*(psq^2 - 2*psq*t + t*(s + t))*
    ...
    (4^(1 - d)*EL^6*gAl^5*gAu*mm^2*(4*(-22*psq^3 + 5*s^3 + 21*s^2*t + 
         30*s*t^2 + 14*t^3 + psq^2*(24*s + 58*t) + 
         psq*(4*mm^2*s - 19*s^2 - 58*s*t - 50*t^2)) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^5*gAu*(-4*(20 - 9*d + d^2)*psq^3 + 
       ...
       mm^2*((32 - 24*d + 3*d^2)*psq^2 - psq*((28 - 26*d + 3*d^2)*s + 
           ...
           (40 - 24*d + 3*d^2)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^5*gAu*mm^2*
      (16*s*(-2*psq + s + 2*t) + d^2*s*(-2*psq + s + 2*t) + 
       4*d*(-psq^2 + mm^2*(psq - t) + psq*(4*s + t) - 2*s*(s + 2*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl^5*gAu*(-2*(28 - 10*d + d^2)*psq^3 - 
       (16 - 10*d + d^2)*mm^4*(psq - t) - 2*psq^2*((22 - 11*d + d^2)*s + 
        ...
        (s^2 + 3*s*t + 2*t^2) + psq*((28 - 12*d + d^2)*s^2 - 
         2*(26 - 9*d + d^2)*s*t - 2*(76 - 30*d + 3*d^2)*t^2) + 
       mm^2*(2*(64 - 39*d + 4*d^2)*psq^2 + (-4 + d)^2*s^2 + 
         2*(44 - 28*d + 3*d^2)*s*t + (112 - 68*d + 7*d^2)*t^2 - 
         psq*(4*(10 - 9*d + d^2)*s + (240 - 146*d + 15*d^2)*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl^5*gAu*(-2*(8 - 6*d + d^2)*psq^3 - 
       ...
       mm^2*((16 - 18*d + 3*d^2)*psq^2 + (16 - 6*d + d^2)*s^2 + 
         ...
         psq*((-24 + 6*d + d^2)*s + 2*(16 - 18*d + 3*d^2)*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl^5*gAu*(psq - t)*
      (mm^2*((8 - 8*d + d^2)*psq - 2*(-2 + d)*s - (8 - 8*d + d^2)*t) + 
       (-4 + d)*(2*(-6 + d)*psq^2 + (-6 + d)*t*(s + 2*t) + 
         2*psq*(s - 2*(-6 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^5*gAu*mm^2*
      (2*(4 - 6*d + d^2)*psq^2 + (-4 + d)^2*s^2 + 2*(8 - 6*d + d^2)*s*t + 
       2*(4 - 6*d + d^2)*t^2 - 2*psq*((8 - 6*d + d^2)*s + 
         2*(4 - 6*d + d^2)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^5*gAu*
      (2*(8 - 6*d + d^2)*psq^3 + psq^2*(-4*(-5 + d)*s - 
         6*(8 - 6*d + d^2)*t) - (-4 + d)*t*(2*s^2 + (4 + d)*s*t + 
         2*(-2 + d)*t^2) + psq*(-4*s^2 + (-36 + 4*d + d^2)*s*t + 
         6*(8 - 6*d + d^2)*t^2) + mm^2*((16 - 18*d + 3*d^2)*psq^2 + 
         (20 - 10*d + d^2)*s^2 + (32 - 26*d + 3*d^2)*s*t + 
         (16 - 18*d + 3*d^2)*t^2 - psq*((32 - 26*d + 3*d^2)*s + 
           2*(16 - 18*d + 3*d^2)*t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^5*gAu*mm^2*(-2*psq^2 + s^2 + 4*psq*t - 
    ...
    (4^(1 - d)*EL^6*gAl^5*gAu*((-64 + 26*d - 3*d^2)*psq^3 + 
      ...
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(4 - 6*d + d^2)*EL^6*gAl^5*gAu*
      mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
     Pi^(2*d) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^5*gAu*
      (-(d*(mm^2 + s)*(-2*psq + s + 2*t)) + 2*s*(mm^2 - 7*psq + 3*s + 6*t))*
    ...
    (4^(3 - d)*(-2 + d)*EL^6*gAl^5*gAu*(psq - t)*(-psq + s + t)*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(psq - t)*
      ...
      (2*(8 - 6*d + d^2)*psq^2 + (8 - 6*d + d^2)*mm^2*s + 4*s^2 - 4*d*s^2 + 
       d^2*s^2 - 4*s*t - 6*d*s*t + 2*d^2*s*t + 16*t^2 - 12*d*t^2 + 
    ...
    (4^(2 - d)*(8 - 6*d + d^2)*EL^6*gAl^5*gAu*(psq^2 + mm^2*s + (s + t)^2 - 
      ...
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[p3, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*
      ((-4 + d)*psq^2 + (-8 + d)*mm^2*s + 
       psq*(-3*(-6 + d)*s - 2*(-4 + d)*t) + 
       (s + t)*((-6 + d)*s + (-4 + d)*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^5*gAu*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^5*gAu*
      ((24 - 10*d + d^2)*psq^2 + 4*psq*s + (12 - 10*d + d^2)*mm^2*(psq - t) - 
       3*(24 - 10*d + d^2)*psq*t + (24 - 10*d + d^2)*t*(s + 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/
     (Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*psq*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
    (4^(2 - d)*EL^6*gAl^5*gAu*((64 - 34*d + 4*d^2)*psq^2 + 24*s^2 - 
       10*d*s^2 + d^2*s^2 + 32*s*t - 18*d*s*t + 2*d^2*s*t + 56*t^2 - 
       28*d*t^2 + 3*d^2*t^2 + mm^2*(-((8 - 6*d + d^2)*psq) + 
         (12 - 10*d + d^2)*s + (8 - 6*d + d^2)*t) - 
       psq*((56 - 28*d + 3*d^2)*s + (120 - 62*d + 7*d^2)*t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(psq^2 + mm^2*s + (s + t)^2 - 
       psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl^5*gAu*(psq - t)*
    ...
    (4^(2 - d)*EL^6*gAl^5*gAu*(psq - t)*((-4 + d)^2*psq - 4*s - (-4 + d)^2*t)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^5*gAu*(psq - t)^2*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(psq - t)*((-8 + d)*psq + 2*s - 
       (-8 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[q1, q1]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[q1, q2]])/
     Pi^(2*d) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], SP[q1, q1]])/
     (Pi^(2*d)*s) + (4^(2 - d)*(8 - 6*d + d^2)*EL^6*gAl^5*gAu*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl^5*gAu*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(12 - 8*d + d^2)*EL^6*gAl^5*gAu*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAl^5*gAu*
