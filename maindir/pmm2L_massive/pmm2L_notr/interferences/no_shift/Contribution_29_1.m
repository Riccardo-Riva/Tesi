...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
  ...
  ((2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^4*((-2 + d)*mm^4*s + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
     ...
     gHll^2*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
     (4*(-4 + d)*psq^2 + 4*(-2 + d)*mm^2*s - 8*(-4 + d)*psq*t + 
   ...
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((-6 + d)*mm^2 - (-2 + d)*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-4 + d)*psq^2 + 
      psq*(-2*d^2*s + 4*d*(s - 2*t) + 32*t) + 
      (-4 + d)*(2*(2 + d)*mm^2*s + (-4 + d)*s^2 + 4*s*t + 4*t^2))*
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(d*(mm^2 - psq) + 4*psq)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(d*(mm^2 - psq) + 4*psq)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
     ...
     (d*(mm^2 - psq) + 4*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*
     gHll^2*mm^2*(mm^2 - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*
     gHll^2*mm^2*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*mm^2 - 2*psq + s)*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*psq + d*s + 2*t)*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
     (-2*psq + (-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(psq - t)*
   ...
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*psq + s - 2*t)*
    ...
    (Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*
     gHll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], SP[q2, q2]])/
    (Pi^(2*d)*s) + (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
