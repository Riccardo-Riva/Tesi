  ...
  (-((2^(1 - 4*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
   ...
   (2^(1 - 4*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
    ...
    (Pi^(4*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
     (gZlL^2*(2*Pi)^(2*d)*(4*(-2 + d)*psq^3 + (-2 + d)*mm^2*(4*psq - s - 4*t)*
         (psq - t) + 4*s*t*(s + t) + psq^2*((10 - 3*d)*s - 8*(-2 + d)*t) + 
        psq*t*((-14 + 3*d)*s + 4*(-2 + d)*t)) + gZlR^2*(2*Pi)^(2*d)*
       (4*(-2 + d)*psq^3 + (-2 + d)*mm^2*(4*psq - s - 4*t)*(psq - t) + 
        4*s*t*(s + t) + psq^2*((10 - 3*d)*s - 8*(-2 + d)*t) + 
        psq*t*((-14 + 3*d)*s + 4*(-2 + d)*t)) - 
      4*gZlL*gZlR*(d*(2*Pi)^(2*d)*(mm^2 + psq)*(2*psq - s - 2*t)*(psq - t) + 
        4^d*Pi^(2*d)*(-4*psq^3 + 12*psq^2*t + t*(s + 2*t)^2 + 
          psq*(s^2 - 4*s*t - 12*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(4*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
   ...
   (4^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
     (-(2^(1 + 2*d)*Pi^(2*d)*s*(gZlL^2*(2*mm^2 - 3*psq + s + t) + 
         gZlR^2*(2*mm^2 - 3*psq + s + t) + 2*gZlL*gZlR*(-2*psq + s + 2*t))) + 
      d*(2*Pi)^(2*d)*(gZlL^2*s*(2*mm^2 - 3*psq + s + t) + 
