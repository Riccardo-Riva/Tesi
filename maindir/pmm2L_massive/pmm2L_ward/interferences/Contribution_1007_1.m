...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     (I*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*s*
       (aa*(mm^2 + psq - s - 2*t) + bb*(mm^2 - 3*psq + s + 2*t))*
       \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)) - 
     (I*4^(1 - d)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*
     ...
     (I*2^(1 - 2*d)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*
     ...
     (I*2^(1 - 2*d)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*
       (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q1], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
     (I*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*(aa*s*(psq - t) + 
     ...
     (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*
     ...
     (I*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*s*(-2*psq + s + 2*t)*
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
       (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
        SP[p2, q2]])/(mz^2*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl^2*ggpgpA*ggpgpZ*
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
       (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
        SP[p2, q1]])/(mz^2*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl^2*ggpgpA*ggpgpZ*
       (gZlL + gZlR)*(bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*
     ...
     (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
       (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
        SP[q1, q1]])/(mz^2*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl^2*ggpgpA*ggpgpZ*
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
       (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
        SP[q1, q2]])/(mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^2*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*
       (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
        SP[q1, q2]])/(mz^2*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^2*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
   ...
   PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, mw]]*((I*EL^5*gAl^2*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*
