...
{0, 0, 0, (I*2^(-2 - 2*d)*EL^6*gAl*gAu*
    (gZlL*gZlLC*(gZuL*gZuLC*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
      ...
      (gZuL*gZuLC*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d) + 
       gZuR*gZuRC*(2^(1 + d)*(-64 + 44*d - 9*d^2)*Pi^d + d^3*(2*Pi)^d)))*s)/
   (mz^2*Pi^(2*d)*(mzC^2 - s)) + 
  (I*2^(-1 - d)*EL^6*gAl*gAu*
    (gZlL*gZlLC*((-56 + 46*d - 12*d^2 + d^3)*gZuL*gZuLC - 
     ...
     gZlR*gZlRC*(-((-52 + 44*d - 12*d^2 + d^3)*gZuL*gZuLC) + 
       (-56 + 46*d - 12*d^2 + d^3)*gZuR*gZuRC))*(s + t))/
  ...
  (I*2^(1 - 2*(1 + d))*EL^6*gAl*gAu*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(2^(2 + d)*(13 - 11*d + 3*d^2)*Pi^d - 
      ...
      (gZuL*gZuLC*(2^(1 + d)*(28 - 23*d + 6*d^2)*Pi^d - d^3*(2*Pi)^d) + 
       gZuR*gZuRC*(2^(2 + d)*(-13 + 11*d - 3*d^2)*Pi^d + d^3*(2*Pi)^d)))*
    (s + t))/((-4 + d)*mz^2*Pi^(2*d)*(mzC^2 - s)) - 
  (I*2^(-2 - 2*d)*EL^6*gAl*gAu*(gZlL*gZlLC*(-3*d^3*gZuL*gZuLC*(2*Pi)^d*s + 
   ...
   (mz^2*Pi^(2*d)*(mzC^2 - s)) - (I*2^(-2 - 2*d)*(2 - d)*EL^6*gAl*gAu*
    ...
    (gZlL*gZlLC*(2^(2 + d)*gZuL*gZuLC*Pi^d - 2^(1 + d)*gZuR*gZuRC*Pi^d - 
     ...
     2^(1 + d)*(gZlR*gZlRC*(-((-2 + d)*gZuL*gZuLC) + (-4 + d)*gZuR*gZuRC) + 
      ...
      GaugeXi[Q] + (gZlL*gZlLC*(2^(2 + d)*gZuL*gZuLC*Pi^d - 
         ...
         d*gZuR*gZuRC*(2*Pi)^d))*GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*
    (-1 + GaugeXi[Q])) + (I*4^(-2 - d)*EL^6*gAl*gAu*((-2 + d)*s - 2*t)*
  ...
  (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*(mz^2 - s)*
    ...
    (-1 + GaugeXi[Q])) - (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*
    ...
    ((-3*2^(1 - d)*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
       (mz^2 - s)^2*s*(-1 + GaugeXi[Q])^2)/(mz^2*Pi^d) + 
     (3*2^(2 - d)*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
       (mz^2 - s)*s*t*(-1 + GaugeXi[Q])^2)/(mz^2*Pi^d) - 
     ...
     (2^(1 - 2*d)*mz^2*(-(gZlL*gZlLC*(gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 
        ...
        (-(gZlL*gZlLC*(gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (3*s - t)) + gZuL*gZuLC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*t))) + 
 ...
 ((-I)*2^(-2 - d)*EL^6*gAl*gAu*
    (gZlL*gZlLC*((-56 + 46*d - 12*d^2 + d^3)*gZuL*gZuLC - 
       (-52 + 44*d - 12*d^2 + d^3)*gZuR*gZuRC) + 
     gZlR*gZlRC*(-((-52 + 44*d - 12*d^2 + d^3)*gZuL*gZuLC) + 
       (-56 + 46*d - 12*d^2 + d^3)*gZuR*gZuRC))*((-2 + d)*s + 2*t))/
   ((-4 + d)*Pi^d*(mzC^2 - s)) + 
  (I*EL^6*gAl*gAu*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(2^(2 + d)*(13 - 11*d + 3*d^2)*Pi^d - 
          d^3*(2*Pi)^d) + gZuR*gZuRC*(2^(1 + d)*(-28 + 23*d - 6*d^2)*Pi^d + 
      ...
      (gZuL*gZuLC*(2^(1 + d)*(28 - 23*d + 6*d^2)*Pi^d - d^3*(2*Pi)^d) + 
       gZuR*gZuRC*(2^(2 + d)*(-13 + 11*d - 3*d^2)*Pi^d + d^3*(2*Pi)^d)))*
    ((-2 + d)*s + 2*t))/(2^(2*(1 + d))*(-4 + d)*Pi^(2*d)*(mzC^2 - s)) - 
    ...
    (gZlL*gZlLC*(-(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
      ...
      (-(gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + 
            ...
            2^(1 + d)*Pi^d*((56 - 41*d + 9*d^2)*s - (-52 + 44*d - 12*d^2 + 
                d^3)*t)))) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
         2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2) + 
  ...
  (I*4^(-2 - d)*EL^6*gAl*gAu*(mz^2*(-((-6 + d)*s) + 2*t) + 
     s*(-((-2 + d)*s) + 2*t))*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(2*s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
    ...
    (gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
     ...
     (gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
       ...
       gZlR*gZlRC*(gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])*
    (-2*s + 2*mz^2*GaugeXi[Q])) + (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*
  ...
  (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*
    ((gZlL*gZlLC*(gZuL*gZuLC*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
     ...
     (gZlL*gZlLC*(gZuR*gZuRC*(mz^4*(-(d*(2*Pi)^d*(s - t)) + 
             2^(1 + d)*Pi^d*((-1 + d)*s - t)) + 2^(2 + d)*(-2 + d)*mz^2*Pi^d*
            s*(s + t) - (2^(1 + d)*Pi^d - d*(2*Pi)^d)*s^2*(s + t)) - 
   ...
   (mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])*(s - mz^2*GaugeXi[Q])^2), 
 ((-I)*EL^6*gAl*gAu*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
  ...
  (I*4^(-2 - d)*EL^6*gAl*gAu*(s*(-((-2 + d)*s) + 2*t) + 
     mz^2*(-((-6 + d)*s) + 2*t)*GaugeXi[Q])*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
        gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(2*s + t)))) + 
     gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))) + 
     ...
     (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s - t)) + 
       ...
       gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t)) + 
         gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + t))))*
      GaugeXi[Q]^2))/(mz^2*Pi^(2*d)*(mzC^2 - s)*s*(-1 + GaugeXi[Q])) + 
  (I*2^(-3 - 2*d)*EL^6*gAl*gAu*(-s + mz^2*GaugeXi[Q])*
    (gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
       gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t))) + 
     gZlR*gZlRC*(gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
       gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t))) + 
  ...
  (I*4^(-1 - d)*EL^6*gAl*gAu*
    (-((gZlL*gZlLC*(gZuL*gZuLC*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
     ...
     mz^2*(gZlR*gZlRC*(gZuR*gZuRC*(2^(1 + d)*Pi^d*(s - t) + d*(2*Pi)^d*t) + 
      ...
      GaugeXi[Q]^3))/(mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])) + 
  (I*2^(-3 - 2*d)*(-3 + d)*EL^6*gAl*gAu*(s + mz^2*GaugeXi[Q])*
    ((gZlL*gZlLC*(gZuL*gZuLC*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
         gZuR*gZuRC*(-(2^(1 + d)*Pi^d) + d*(2*Pi)^d)) - 
       gZlR*gZlRC*(gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
         gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d)))*s^2*(s + t) - 
     ...
     mz^4*(-(gZlL*gZlLC*(gZuL*gZuLC*(2^(1 + d)*Pi^d*((-2 + d)*s - 2*t) - 
        ...
        (gZuL*gZuLC*(-(d*(2*Pi)^d*(s - t)) + 2^(1 + d)*Pi^d*
            ((-1 + d)*s - t)) + gZuR*gZuRC*(d*(2*Pi)^d*(s - t) + 
           2^(1 + d)*Pi^d*(2*s - d*s + 2*t))))*GaugeXi[Q]^4))/
   (mz^2*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])*(s - mz^2*GaugeXi[Q])^2), 0, 
 0, 0, 0, 0, 0, 0, 0, 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*
    (gZlL*gZlLC*(gZuL*gZuLC*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
         d^3*(2*Pi)^d) + gZuR*gZuRC*(2^(1 + d)*(-56 + 41*d - 9*d^2)*Pi^d + 
    ...
    (gZlR*gZlRC*(gZuR*gZuRC*(d^3*(2*Pi)^d*t + 2^(1 + d)*Pi^d*
     ...
     gZlL*gZlLC*(gZuL*gZuLC*(d^3*(2*Pi)^d*t + 2^(1 + d)*Pi^d*
       ...
       gZuR*gZuRC*(d^3*(2*Pi)^d*t + 2^(1 + d)*Pi^d*
          ((-52 + 44*d - 12*d^2 + d^3)*s + (4 + 3*d - 3*d^2)*t)))))/
   (Pi^(2*d)*(mzC^2 - s)) + (I*2^(-1 - 2*d)*(-3 + d)*EL^6*gAl*gAu*
    (gZlR*gZlRC*(gZuR*gZuRC*(mz^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
      ...
      (gZuL*gZuLC*(mz^2*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d) + 
        ...
        (mz^2*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d) + 
         d^3*(2*Pi)^d*s - 2^(1 + d)*Pi^d*((72 - 49*d + 10*d^2)*s + 
           2*(10 - 6*d + d^2)*t)))))/((-4 + d)*Pi^(2*d)*(mzC^2 - s)), 0, 
 (I*2^(-3 - 2*d)*EL^6*gAl*gAu*
    (gZlL*gZlLC*(gZuL*gZuLC*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - 
         d^3*(2*Pi)^d) + gZuR*gZuRC*(2^(1 + d)*(-56 + 41*d - 9*d^2)*Pi^d + 
         d^3*(2*Pi)^d)) - gZlR*gZlRC*
      (gZuL*gZuLC*(2^(1 + d)*(56 - 41*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d) + 
       gZuR*gZuRC*(2^(1 + d)*(-64 + 44*d - 9*d^2)*Pi^d + d^3*(2*Pi)^d)))*
    (s + t)*(s + (mz^2*(-s + t))/(s + t)))/(Pi^(2*d)*(mzC^2 - s)) - 
  (I*4^(-1 - d)*EL^6*gAl*gAu*
       ...
       (-(mz^4*(2^(1 + d)*(64 - 44*d + 9*d^2)*Pi^d - d^3*(2*Pi)^d)*(s + t)) + 
        d^3*(2*Pi)^d*s^2*(s + 3*t) - 2^(1 + d)*(-4 + d)*mz^2*Pi^d*(s + t)*
         ...
         ((-72 + 48*d - 9*d^2)*s^3 - (72 - 52*d + 9*d^2 + d^3)*s^2*t + 
          4*(2 + d)*s*t^2 + 8*t^3)))))/(Pi^(2*d)*(mzC^2 - s)), 0, 0, 0, 0, 0, 
