...
PropList[KiraPropagator[-q1, mw], KiraPropagator[-q1 - q2, 0], 
 ...
 ((2^(-1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWAA*s*
    (bb*mm^2*(2*(-8 + 3*d)*psq - (-6 + d)*s) + 
     aa*psq*((16 - 6*d)*psq + (-6 + d)*s) + 
     aa*mm^2*((16 - 6*d)*psq - 4*(-1 + d)*s) + 
     2*bb*psq*((-8 + 3*d)*psq + 2*(-1 + d)*s))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gWlN*gWNl*gWWA*gWWAA*
    (-(bb*mm^2*(4*(-8 + 3*d)*psq + (2 + 3*d)*s)) + 
     aa*psq*(4*(-8 + 3*d)*psq + (2 + 3*d)*s) + 
     2*aa*mm^2*(2*(-8 + 3*d)*psq + (-14 + 9*d)*s) - 
     2*bb*psq*(2*(-8 + 3*d)*psq + (-14 + 9*d)*s))*\[Mu]^(8 - 2*d)*
    ...
    (bb*psq*((22 - 6*d)*psq + (17 - 13*d)*s) + 
     aa*psq*((-22 + 6*d)*psq + (3 - 2*d)*s) + 
     bb*mm^2*((22 - 6*d)*psq + (-3 + 2*d)*s) + 
     aa*mm^2*((-22 + 6*d)*psq + (-17 + 13*d)*s))*\[Mu]^(8 - 2*d)*
    ...
    (aa*(7 - 9*d)*mm^2 + bb*(-13 + 7*d)*mm^2 + aa*(13 - 7*d)*psq + 
     bb*(-7 + 9*d)*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
