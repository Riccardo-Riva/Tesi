...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*(mm^2 + psq)*
    s*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*
    (bb*(-8*psq^2 + 8*psq*t + s*(s + 2*t) + mm^2*(-8*psq + 6*s + 8*t)) + 
     aa*(8*psq^2 - 4*psq*(s + 2*t) - s*(s + 2*t) + 
       mm^2*(8*psq - 2*(s + 4*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*s*
    (aa*(4*psq - 3*s - 4*t) + bb*(4*mm^2 - 8*psq + 3*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*
    (bb*(4*psq^2 + psq*(s - 4*t) + 4*mm^2*(psq - s - t) - s*(s + t)) + 
     aa*(-4*psq^2 + s*(s + t) + psq*(s + 4*t) + mm^2*(-4*psq + 2*s + 4*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*s*
    (aa*(4*mm^2 - s - 4*t) + bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gHFW*gHll*
    gWWA*mm^2*(aa*(4*psq^2 - 3*psq*s + 4*mm^2*(psq - t) - 4*psq*t - s*t) + 
     bb*(-4*psq^2 + psq*s + 4*psq*t + s*t + mm^2*(-4*psq + 2*s + 4*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*s*(-2*psq + s + 2*t)*
  ...
  (I*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
   (4^d*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gHFW*gHll*gWWA*mm^2*
