...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-((EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*mm^2*s*
       (aa*((-2 + d)*mm^2 + 2*psq + 3*d*psq - d*s) + 
        bb*((-2 + d)*mm^2 + 2*psq - 5*d*psq + d*s))*\[Mu]^(8 - 2*d))/
      (mz^2*(2*Pi)^(2*d))) + (2^(1 - 2*d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)) + ((aa + bb)*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*
      (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
     (mz^2*(2*Pi)^(2*d)) - (4^(1 - d)*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*
      (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
     (mz^2*Pi^(2*d)) - (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFAZ*
