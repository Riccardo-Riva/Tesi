...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  (((-I)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*s*(aa*mm^2*(psq - t) + 
      aa*psq*(psq - s - t) + bb*psq*(-psq + t) + bb*mm^2*(-psq + s + t))*
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - (I*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   (I*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*s*(psq - t)*
