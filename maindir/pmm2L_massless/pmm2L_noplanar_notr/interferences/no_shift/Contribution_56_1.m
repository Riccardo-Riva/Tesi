(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, 0], 
  ...
  ((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 - 4*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(6 - 5*d + d^2)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*((-4 + d)^2*s + (20 - 10*d + d^2)*t)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(12 - 8*d + d^2)*EL^8*gAl^6*gAu^2*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (4^(3 - d)*(6 - 5*d + d^2)*EL^8*gAl^6*gAu^2*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(d*s + 6*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*((-4 + d)^2*s + (20 - 10*d + d^2)*t)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*
     ((-6 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*
     (2*d*(s - 5*t) + 36*t + d^2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(36 - 14*d + d^2)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^6*gAu^2*((-136 + 84*d - 16*d^2 + d^3)*s - 
      ...
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (2^(7 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^6*gAu^2*(2*(-2 + d)*s - (20 - 10*d + d^2)*t)*
   ...
   (4^(2 - d)*EL^8*gAl^6*gAu^2*((-104 + 64*d - 14*d^2 + d^3)*s + 
      ...
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(7 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*t*
