...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(1 - 4*d)*d*EL^8*gAl^2*gAu^2*gZlL*gZlR*mm^2*
     (-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(3*mm^2 + psq)*(8*s^2 + d^2*s^2 + 
      ...
      gZlR^2*(2^(1 + 2*d)*(-2 + d)^2*mm^4*Pi^(2*d)*s + d^2*(2*Pi)^(2*d)*psq*
        ...
        2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + psq^2*((12 - 4*d + d^2)*s - 
          ...
          2*psq*((9 - 5*d)*s^2 + (-10 + d)*s*t + (-2 + d)*t^2))))*
     \[Mu]^(8 - 2*d))/(Pi^(4*d)*s^2) + 
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gZlL*gZlR*mm^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*(d^2*gZlL*(gZlL - gZlR)^2*gZlR*mm^2*
       (mm^2 - psq)*s + 2*d*(gZlL^4*psq*s*(2*mm^2 - 2*psq + s) + 
   ...
   (4^(2 - d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*
     (-2*gZlL^2*gZlR^2*mm^2 + gZlL^4*psq + gZlR^4*psq)*(psq - s - t)*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     (-(2^(3 + 2*d)*d*gZlL^3*gZlR*mm^2*Pi^(2*d)*(psq - s - t)) + 
      ...
      gZlR^4*(2*Pi)^(2*d)*(-2*(-2 + d)*psq^2 + (12 + 2*d - d^2)*psq*s + 
        4*(-4 + d)*s^2 + 2*(-2 + d)*psq*t - 8*s*t + 
        mm^2*(6*(-2 + d)*psq + (4 - 6*d + d^2)*s - 6*(-2 + d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(4*d)*s^2) + 
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gZlL^2*gZlR^2*mm^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*d*EL^8*gAl^2*gAu^2*gZlL*gZlR*
     (gZlL^2 + gZlR^2)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(-2*gZlL^2*gZlR^2*mm^2 + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*(4*d*gZlL^3*gZlR*mm^2*(psq - t) + 
      ...
      2^(1 + 2*d)*gZlL^3*gZlR*mm^2*Pi^(2*d)*(8*s + d^2*s - 
       ...
       (-2*(-6 + d)*psq^2 + (32 - 18*d + d^2)*psq*s + 4*(-2 + d)*s^2 + 
        2*(-10 + d)*psq*t + 12*s*t + 8*t^2 + mm^2*(-2*(-2 + d)*psq + 
          (-8 + d^2)*s + 2*(-2 + d)*t)) + gZlR^4*(2*Pi)^(2*d)*
       (-2*(-6 + d)*psq^2 + (32 - 18*d + d^2)*psq*s + 4*(-2 + d)*s^2 + 
        2*(-10 + d)*psq*t + 12*s*t + 8*t^2 + mm^2*(-2*(-2 + d)*psq + 
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*
     ...
     (gZlL^4 + gZlR^4)*(-2*(-2 + d)*psq + (12 - 6*d + d^2)*s + 2*(-2 + d)*t)*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(psq - t)*
