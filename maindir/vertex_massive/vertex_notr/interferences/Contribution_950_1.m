...
PropList[KiraPropagator[q1, mm], KiraPropagator[p1 - q2, mw], 
 ...
 (-((2^(1 - 2*d)*EL^6*gAl*gFFA*gFll^4*mm^4*s*(mm^2 + psq + s)*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/Pi^(2*d)) - 
  (2^(1 - 2*d)*EL^6*gAl*gFFA*gFll^4*mm^4*s*(mm^2 + psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gFFA*gFll^4*mm^4*
    (mm^2 + psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gFFA*gFll^4*mm^4*(mm^2 + psq + 2*s)*
