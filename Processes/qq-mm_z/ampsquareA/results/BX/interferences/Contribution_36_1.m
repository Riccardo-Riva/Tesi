...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   (((-I)*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*(s + t)*((-2 + d)^2*s^2 + 
    ...
    (I*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*(s + t)*CKM[1, 1]*CKMC[1, 1]*
      (d*(2*Pi)^d*s*(s - t) + 2^(1 + d)*Pi^d*(-s^2 + d*s*t + t^2) - 
    ...
    (I*2^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*(s + t)^2*
     ...
     (mw^4*Pi^d*s) - (I*2^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*t*
      (s + t)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[p2, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*s) - (I*2^(3 - d)*EL^6*gAl*gAu*gWdu*gWlN*gWNl*
      gWud*(s + t)^2*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[p3, q1], 
       SP[q1, q1]])/(mw^4*Pi^d*s) + (I*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*
      (s + t)*CKM[1, 1]*CKMC[1, 1]*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t) - 
       2^(1 + d)*Pi^d*((-2 + d)*s + 2*t)*GaugeXi[Q] + 
       (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t))*GaugeXi[Q]^2)*
      SPList[SP[p1, q1], SP[q1, q1], SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*s*
      (-1 + GaugeXi[Q])^2) - (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*t*
      (2*(-2 + d)*s + d*t)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1], 
    ...
    (I*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*CKM[1, 1]*CKMC[1, 1]*
      (d*(2*Pi)^d*s - 2^(1 + d)*Pi^d*(s + 7*t - 2*d*t) - 
   ...
   ((I*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*(s + t)*CKM[1, 1]*CKMC[1, 1]*
      (d*(2*Pi)^d*s*(s - t) + 2^(1 + d)*Pi^d*(-s^2 + d*s*t + t^2) - 
       ...
       (d*(2*Pi)^d*s*(s - t) + 2^(1 + d)*Pi^d*(-s^2 + d*s*t + t^2))*
        GaugeXi[Q]^2)*SPList[SP[p1, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^(2*d)*s*(-1 + GaugeXi[Q])^2) - 
    (I*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*t*(s + t)*CKM[1, 1]*CKMC[1, 1]*
      (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t) - 2^(1 + d)*Pi^d*
        ((-2 + d)*s + 2*t)*GaugeXi[Q] + 
       (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + t))*GaugeXi[Q]^2)*
      SPList[SP[p2, q1], SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*s*
      (-1 + GaugeXi[Q])^2) + (I*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*CKM[1, 1]*
      CKMC[1, 1]*(d*(2*Pi)^d*s*(s - 3*t) - 2^(1 + d)*Pi^d*(s - t)*
        ((-1 + d)*s - t) + 2^(1 + d)*Pi^d*(s + t)*((-2 + d)*s + 2*t)*
        GaugeXi[Q] + (d*(2*Pi)^d*s*(s - 3*t) - 2^(1 + d)*Pi^d*(s - t)*
          ((-1 + d)*s - t))*GaugeXi[Q]^2)*SPList[SP[p3, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^(2*d)*(-1 + GaugeXi[Q])^2) - 
    (I*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*(s + t)*((-2 + d)*s + 2*(-3 + d)*t)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[q1, q1], SP[q1, q1]])/(mw^4*(2*Pi)^d) + 
    (I*2^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*(s + t)^2*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q1]])/
     (mw^4*Pi^d*s) + (I*2^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*t*
      (s + t)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[p2, q1], 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   ((I*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*(s + t)*(-(d^3*(2*Pi)^d*s) + 
    ...
    (I*2^(1 - d)*(16 + 4*d - 6*d^2 + d^3)*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*t*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^d*s) - 
    (I*2^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*
    ...
    (I*EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*CKM[1, 1]*CKMC[1, 1]*
     ...
     (mw^4*s*(-1 + GaugeXi[Q])^2) + (I*2^(2 - d)*(-56 + 46*d - 12*d^2 + d^3)*
      EL^6*gAl*gAu*gWdu*gWlN*gWNl*gWud*CKM[1, 1]*CKMC[1, 1]*
