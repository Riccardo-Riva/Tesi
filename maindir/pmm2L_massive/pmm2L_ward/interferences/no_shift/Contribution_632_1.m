...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
   ...
   (I*4^(1 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*(aa*mm^2*(5*psq - s - 5*t) + 
