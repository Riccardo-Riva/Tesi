...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*s^3*\[Mu]^(8 - 2*d))/
    (2*Pi)^(2*d)) + (3*2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (EL^6*gAl*gFFA*gFFZ^2*(-8*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 + 2*psq - 5*s) + 
     gZlR^2*(2*mm^2 + 2*psq - 5*s))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2*Pi)^(2*d) + (EL^6*gAl*gFFA*gFFZ^2*(-4*gZlL*gZlR*mm^2 + 
     gZlL^2*(mm^2 + psq - s) + gZlR^2*(mm^2 + psq - s))*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (5*2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*s^2*\[Mu]^(8 - 2*d)*
