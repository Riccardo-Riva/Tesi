...
(I*EL^6*gAl*gAu*ggpgpZ^2*(gZlL + gZlR)*(gZuL + gZuR)*
 ...
 (I*2^(-1 - 2*d)*EL^6*gAl*gAu*ggpgpZ^2*
   (gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
    ...
    {mw*Sqrt[GaugeXi[Q]]}, 0, -1, 1, 0])/(Pi^(2*d)*(mz^2 - s)^2*s) + 
 (I*EL^6*gAl*gAu*ggpgpZ^2*(gZlL*gZuL*((-2 + d)*s + (-4 + d)*t) + 
    ...
    {mw*Sqrt[GaugeXi[Q]]}, 0, 0, 0, 0])/((2*Pi)^d*(mz^2 - s)^2*s) - 
 ...
 (I*EL^6*gAl*gAu*ggpgpZ^2*(gZlL + gZlR)*(gZuL + gZuR)*
  ...
  ((2*Pi)^d*(mz^2 - s)^2) + (I*2^(-1 - d)*EL^6*gAl*gAu*ggpgpZ^2*
   (gZlL*gZuL*((-2 + d)*s - 2*t) + gZlR*gZuR*((-2 + d)*s - 2*t) - 
    gZlR*gZuL*((-4 + d)*s + 2*t) - gZlL*gZuR*((-4 + d)*s + 2*t))*
   (s - 2*mw^2*GaugeXi[Q])*userIntegral[A4, {mw*Sqrt[GaugeXi[Q]]}, 0, 1, 1, 
    -1])/(Pi^d*(mz^2 - s)^2*s) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*ggpgpZ^2*
   ((gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
        d*gZuR*(2*Pi)^d) + gZlL*(2^(1 + d)*gZuL*Pi^d - 2^(2 + d)*gZuR*Pi^d - 
