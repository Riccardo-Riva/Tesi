...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl^2*ggmgmA^3*(mm^2 - psq)*s*
    ...
    Pi^(2*d) - (2^(3 - 2*d)*EL^5*gAl^2*ggmgmA^3*(bb*mm^2 - aa*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^5*gAl^2*ggmgmA^3*(bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl^2*ggmgmA^3*(bb*(2*mm^2 + psq) - aa*(mm^2 + 2*psq))*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl^2*ggmgmA^3*(2*aa*(mm^2 + psq) - bb*(3*mm^2 + psq))*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl^2*ggmgmA^3*(mm^2 - psq)*(2*aa*psq + bb*(-2*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl^2*ggmgmA^3*(bb*psq*(2*psq - s) - 
      2*aa*psq*(-mm^2 + psq + s) + bb*mm^2*(-2*psq + 3*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl^2*ggmgmA^3*(bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl^2*ggmgmA^3*(-2*aa*psq + bb*(mm^2 + psq))*s*
   ...
   (2^(3 - 2*d)*EL^5*gAl^2*ggmgmA^3*(2*aa*(mm^2 + psq) - bb*(3*mm^2 + psq))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(2 - d)*EL^5*gAl^2*ggmgmA^3*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl^2*ggmgmA^3*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl^2*ggmgmA^3*(-2*aa*psq + bb*(mm^2 + psq))*
