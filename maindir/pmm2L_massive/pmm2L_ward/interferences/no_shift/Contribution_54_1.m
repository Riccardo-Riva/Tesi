...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  (((-I)*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
    Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^4*
    ...
    Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
     (mm^2 + 2*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*aa*EL^5*gFFA*gFll*gHFW*gHll*gWlN*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(mm^2 + 2*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*aa*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(mm^2 - psq)*
   ...
   (I*2^(3 - 2*d)*bb*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*(mm^2 - psq)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWlN*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*bb*EL^5*gFFA*gFll*gHFW*gHll*gWlN*
