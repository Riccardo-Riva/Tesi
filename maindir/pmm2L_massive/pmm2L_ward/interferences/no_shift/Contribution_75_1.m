(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  ((I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*s*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*s*t*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*s*(s + 2*t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(s + t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     ...
     gWlN*gWNl*gWWA*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*
     gWWA*((-8 + 3*d)*s + 3*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*
     ((-3 + d)*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*
     gWWA*((-3 + d)*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2], SP[q2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(s + t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*(s + (-4 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*(2*s + 3*(-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(s + 2*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*s*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gWlN*gWNl*gWWA*(s + (-2 + d)*t)*
   ...
   (I*4^(1 - d)*(-aa + bb)*(-6 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*t*
