...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
    KiraPropagator[-p2 + q1, mz], KiraPropagator[q2, ml], 
    KiraPropagator[-p2 + q1 + q2, ml]]*
   (-((2^(1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*mm^2*s*
       (aa*((-2 + d)*mm^2 + 2*psq + 3*d*psq - d*s) + 
        bb*((-2 + d)*mm^2 + 2*psq - 5*d*psq + d*s))*\[Mu]^(8 - 2*d))/
      (mz^2*Pi^(2*d))) + (4^(1 - d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
      (2*aa*psq*s - 2*bb*mm^2*(2*d*psq + s - d*s) - 
       aa*d*(psq*s + mm^2*(-4*psq + s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     (mz^2*Pi^(2*d)) + (4^(1 - 2*d)*EL^5*gAl^3*mm^2*
      (aa*psq*(-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*((8 - 5*d + d^2)*mm^2 + 
            (8 - 5*d + d^2)*psq + (4 - 5*d + d^2)*s)) + gZlL^2*(2*Pi)^(2*d)*
          ((4 - 5*d + d^2)*mm^2 + (4 - 5*d + d^2)*psq + (8 - 5*d + d^2)*s) + 
         gZlR^2*(2*Pi)^(2*d)*((4 - 5*d + d^2)*mm^2 + (4 - 5*d + d^2)*psq + 
           (8 - 5*d + d^2)*s)) - bb*(gZlL^2*(2*Pi)^(2*d)*
          (mm^2*((4 - 5*d + d^2)*psq + 2*s) + psq*((4 - 5*d + d^2)*psq + 
             (6 - 5*d + d^2)*s)) + gZlR^2*(2*Pi)^(2*d)*
          (mm^2*((4 - 5*d + d^2)*psq + 2*s) + psq*((4 - 5*d + d^2)*psq + 
             (6 - 5*d + d^2)*s)) - 2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
          (mm^2*((8 - 5*d + d^2)*psq - 2*s) + psq*((8 - 5*d + d^2)*psq + 
             (6 - 5*d + d^2)*s))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (mz^2*Pi^(4*d)) + (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*
      (gZlL + gZlR)^2*ml^2*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     (mz^2*Pi^(2*d)) - (2^(1 - 2*d)*EL^5*gAl^3*mm^2*s*
      (aa*(-2*gZlL*gZlR*((8 - 6*d + d^2)*mm^2 + (8 - 8*d + d^2)*psq + 
           (-2 + d)^2*s) + gZlL^2*((-2 + d)^2*mm^2 + (4 - 2*d + d^2)*psq + 
           (8 - 6*d + d^2)*s) + gZlR^2*((-2 + d)^2*mm^2 + 
           (4 - 2*d + d^2)*psq + (8 - 6*d + d^2)*s)) - 
       bb*(-2*gZlL*gZlR*(d^2*(mm^2 + psq + s) + 4*(4*psq + s) - 
           2*d*(2*mm^2 + 5*psq + 2*s)) + gZlL^2*((12 - 6*d + d^2)*mm^2 + 
           (-2 + d)*((2 + d)*psq + (-4 + d)*s)) + 
         gZlR^2*((12 - 6*d + d^2)*mm^2 + (-2 + d)*((2 + d)*psq + 
             (-4 + d)*s))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
     (mz^2*Pi^(2*d)) + (2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^3*
      (gZlL + gZlR)^2*ml^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*(bb*mm^2 - aa*psq)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(mz^2*Pi^(2*d)) + 
    (2^(3 - 2*d)*EL^5*gAl^3*mm^2*
      (-(aa*((8 - 5*d + d^2)*gZlL^2 - 2*(4 - 5*d + d^2)*gZlL*gZlR + 
          (8 - 5*d + d^2)*gZlR^2)*psq) + 
       bb*(2*gZlL*gZlR*(2*mm^2 - (6 - 5*d + d^2)*psq) + 
         gZlL^2*(2*mm^2 + (6 - 5*d + d^2)*psq) + 
         gZlR^2*(2*mm^2 + (6 - 5*d + d^2)*psq)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/(mz^2*Pi^(2*d)) - 
    (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
      (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
     (mz^2*Pi^(2*d)) + (4^(1 - d)*EL^5*gAl^3*
      (-(bb*mm^2*(-2*gZlL*gZlR*((4 - 5*d + d^2)*mm^2 + (12 - 9*d + d^2)*psq + 
            2*(3 - 4*d + d^2)*s) + gZlL^2*((8 - 5*d + d^2)*mm^2 + 18*s + 
            d^2*(psq + 2*s) - d*(psq + 12*s)) + 
          gZlR^2*((8 - 5*d + d^2)*mm^2 + 18*s + d^2*(psq + 2*s) - 
            d*(psq + 12*s)))) + aa*(-2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4 + 
           (-4 + d)*psq*s + mm^2*((12 - 9*d + d^2)*psq + (10 - 9*d + 2*d^2)*
              s)) + gZlL^2*((8 - 5*d + d^2)*mm^4 - (-4 + d)*psq*s + 
           mm^2*(14*s + d^2*(psq + 2*s) - d*(psq + 11*s))) + 
         gZlR^2*((8 - 5*d + d^2)*mm^4 - (-4 + d)*psq*s + 
           mm^2*(14*s + d^2*(psq + 2*s) - d*(psq + 11*s)))))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^5*gAl^3*
      (-(bb*mm^2*(-2*gZlL*gZlR*((8 - 5*d + d^2)*mm^2 + (8 - 5*d + d^2)*psq + 
            2*(5 - 5*d + d^2)*s) + gZlL^2*((4 - 5*d + d^2)*mm^2 + 
            (4 - 5*d + d^2)*psq + 2*(7 - 5*d + d^2)*s) + 
          gZlR^2*((4 - 5*d + d^2)*mm^2 + (4 - 5*d + d^2)*psq + 
            2*(7 - 5*d + d^2)*s))) + 
       aa*(gZlL^2*((4 - 5*d + d^2)*mm^4 + (8 - 5*d + d^2)*psq*s + 
    ...
    (2^(3 - 2*d)*EL^5*gAl^3*(bb*((10 - 6*d + d^2)*gZlL^2 - 
         2*(2 - 4*d + d^2)*gZlL*gZlR + (10 - 6*d + d^2)*gZlR^2)*mm^2 + 
       aa*(gZlL^2*(-((6 - 5*d + d^2)*mm^2) + (-4 + d)*psq) + 
         gZlR^2*(-((6 - 5*d + d^2)*mm^2) + (-4 + d)*psq) + 
         2*gZlL*gZlR*((6 - 5*d + d^2)*mm^2 + (-4 + d)*psq)))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*(bb*mm^2 - aa*psq)*
     ...
     (mz^2*Pi^(2*d)) + (2^(3 - 2*d)*EL^5*gAl^3*
      (-2*bb*((7 - 5*d + d^2)*gZlL^2 - 2*(5 - 5*d + d^2)*gZlL*gZlR + 
   ...
   ((2^(1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*mm^2*s*
    ...
    (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
     ...
     (mz^2*Pi^(2*d)) + (4^(1 - d)*EL^5*gAl^3*
      (bb*mm^2*(-2*gZlL*gZlR*((4 - 5*d + d^2)*mm^2 + (12 - 9*d + d^2)*psq + 
           2*(3 - 4*d + d^2)*s) + gZlL^2*((8 - 5*d + d^2)*mm^2 + 18*s + 
           d^2*(psq + 2*s) - d*(psq + 12*s)) + gZlR^2*((8 - 5*d + d^2)*mm^2 + 
           18*s + d^2*(psq + 2*s) - d*(psq + 12*s))) + 
       aa*(2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4 + (-4 + d)*psq*s + 
           mm^2*((12 - 9*d + d^2)*psq + (10 - 9*d + 2*d^2)*s)) - 
         gZlL^2*((8 - 5*d + d^2)*mm^4 - (-4 + d)*psq*s + 
           mm^2*(14*s + d^2*(psq + 2*s) - d*(psq + 11*s))) - 
         gZlR^2*((8 - 5*d + d^2)*mm^4 - (-4 + d)*psq*s + 
           mm^2*(14*s + d^2*(psq + 2*s) - d*(psq + 11*s)))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
