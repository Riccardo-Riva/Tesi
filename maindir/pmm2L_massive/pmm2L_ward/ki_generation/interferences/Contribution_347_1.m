...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*
      ...
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
    (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(-2*aa*psq^2*s + 
       aa*mm^2*psq*(7*psq - 3*s - 7*t) + aa*mm^4*(5*psq + s - 5*t) + 
       bb*mm^4*(-5*psq + s + 5*t) + bb*mm^2*psq*(-7*psq + 3*s + 7*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2*Pi)^(2*d) - 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
      (2*mm^2 + psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
    (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(-2*bb*psq^2*s + 
       aa*mm^2*psq*(7*psq - 4*s - 7*t) + aa*mm^4*(5*psq - 4*s - 5*t) + 
       bb*mm^4*(-5*psq + 6*s + 5*t) + bb*mm^2*psq*(-7*psq + 4*s + 7*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
      (2*mm^2 + psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
     Pi^(2*d) + (I*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*s*
      (aa*(mm^4 + mm^2*(5*psq - 4*s - 6*t) + 2*psq*(psq - t)) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
      (gZlL - gZlR)*mm^2*(2*mm^2 + psq)*(psq - t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      ...
      gXll*(gZlL - gZlR)*mm^2*(2*mm^2 + psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
