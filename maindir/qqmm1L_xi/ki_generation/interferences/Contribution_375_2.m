...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  ((I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s^2*
     ...
     (1 + GaugeXi[Q])^2*SPList[SP[p1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*s^2*
     (gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + (-3 + d)*t)) + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s*t*
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s*
    ...
    (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     GaugeXi[Q]^2) + (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s*
     (gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + (-3 + d)*t)) + 
        gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + 3*t - d*t))) - 
      gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
        gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 3*t - d*t))))*
     (1 + GaugeXi[Q])*(5 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, q1]])/
    (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*s*t*
     (gZlRC*(gZuR*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        gZuL*gZuLC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d)) + 
      gZlLC*(gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d)) + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s*
    ...
    (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*s*
     (gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
         (2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 
        2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + gZlLC*gZuL*gZuLC*
       (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s^2*
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s*
    ...
    (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     ...
     (gZuL*gZuLC + gZuR*gZuRC)*s^2*(1 + GaugeXi[Q])^2*
     SPList[SP[p1, p3], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s*
     (2^(3 + d)*Pi^d*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
        gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
        gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
        gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t))*(1 + GaugeXi[Q]) + 
      4*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
           (2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 
          2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + gZlLC*gZuL*gZuLC*
         (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
        gZlRC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)))*
       (1 + GaugeXi[Q]) - 
      ((s + t)*(gZlRC*(gZuR*gZuRC*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s*
     (gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
       ...
       (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
      gZlRC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)))*
     (1 + GaugeXi[Q])*(5 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, q1]])/
    (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s*
     (gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
      gZlLC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
    ...
    (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*s*
     (gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s - 2^(1 + d)*(-3 + d)*Pi^d*
           (2*s + 3*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
           ((-3 + 2*d)*s + 3*(-3 + d)*t))) - 
      gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*(-3 + d)*Pi^d*
           (2*s + 3*t)) + gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
           (3*s - 2*d*s + 9*t - 3*d*t))))*(1 + GaugeXi[Q])*
     SPList[SP[p1, q1], SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*(mz^2 - s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*s*t*
     (gZlRC*(gZuR*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        gZuL*gZuLC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d)) + 
      gZlLC*(gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d)) + 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s^2*
    ...
    (mw^4*(2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*s*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
      gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t))*(1 + GaugeXi[Q])*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*(1 + GaugeXi[Q])*SPList[SP[p1, p2], 
      SP[p1, p2], SP[p1, p3]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*(-2*(-4 + d)*s + (8 - 3*d)*t) + 
      gZlLC*gZuR*gZuRC*(-2*(-4 + d)*s + (8 - 3*d)*t) + 
    ...
    (mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*(1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*(1 + GaugeXi[Q])*SPList[SP[p1, p2], 
      SP[p1, p2], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*t) + gZlLC*gZuR*gZuRC*
       ((-4 + d)*s + 2*t) + gZlLC*gZuL*gZuLC*(-((-2 + d)*s) + 2*t) + 
      gZlRC*gZuR*gZuRC*(-((-2 + d)*s) + 2*t) + 
     ...
     (gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s*(1 + GaugeXi[Q])*
     ...
     (gZuL*gZuLC + gZuR*gZuRC)*s*(1 + GaugeXi[Q])*SPList[SP[p1, p2], 
     ...
     GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*(-2*(-5 + d)*s + (16 - 5*d)*t) + 
      gZlLC*gZuR*gZuRC*(-2*(-5 + d)*s + (16 - 5*d)*t) + 
      gZlLC*gZuL*gZuLC*(2*(-1 + d)*s + (-14 + 5*d)*t) + 
      gZlRC*gZuR*gZuRC*(2*(-1 + d)*s + (-14 + 5*d)*t) + 
      (gZlRC*gZuL*gZuLC*(2*s - (-4 + d)*t) + gZlLC*gZuR*gZuRC*
         (2*s - (-4 + d)*t) + gZlLC*gZuL*gZuLC*(2*s + (-2 + d)*t) + 
        gZlRC*gZuR*gZuRC*(2*s + (-2 + d)*t))*GaugeXi[Q])*
      ...
      (-(gZlLC*gZuL*gZuLC*((-2 + d)*s + (-4 + d)*t)) - 
        gZlRC*gZuR*gZuRC*((-2 + d)*s + (-4 + d)*t) + gZlRC*gZuL*gZuLC*
         ((-4 + d)*s + (-2 + d)*t) + gZlLC*gZuR*gZuRC*((-4 + d)*s + 
          (-2 + d)*t))*GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, q1], 
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     ...
     (gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
      gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t))*(4 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) - ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     ((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
      (-4 + d)*gZlLC*gZuR*gZuRC + (-2 + d)*gZlRC*gZuR*gZuRC)*t*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     ...
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*(1 + GaugeXi[Q])*SPList[SP[p1, p3], 
     ...
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*(1 + GaugeXi[Q])*SPList[SP[p1, p3], 
      SP[p2, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*s*(1 + GaugeXi[Q])*SPList[SP[p1, p3], 
      SP[p2, q1], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     ...
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*(1 + GaugeXi[Q])*SPList[SP[p1, q1], 
      SP[p1, q1], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
         (s - 2*d*s + (11 - 4*d)*t)) + gZlRC*gZuR*gZuRC*
       (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(s - 2*d*s + (11 - 4*d)*t)) + 
      gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
         (2*(-4 + d)*s + (-13 + 4*d)*t)) + gZlLC*gZuR*gZuRC*
       (-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*(-4 + d)*s + (-13 + 4*d)*t)) + 
      2*(gZlRC*gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        gZlLC*gZuR*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        gZlLC*gZuL*gZuLC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d) + 
        gZlRC*gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d))*(s + t)*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     ...
     (gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
      gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t))*(4 + GaugeXi[Q])*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*(1 + GaugeXi[Q])*SPList[SP[p2, q1], 
      SP[p2, q1], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*t) + gZlLC*gZuR*gZuRC*
       ((-4 + d)*s + 2*t) + gZlLC*gZuL*gZuLC*(-((-2 + d)*s) + 2*t) + 
     ...
     (-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
      gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t))*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p1, p2], SP[p1, p2], 
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p1, p2], SP[p1, p2], SP[p1, p2], 
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p1, p2], SP[p1, p2], SP[p1, p2], 
      SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     SPList[SP[p1, p2], SP[p1, p2], SP[p1, p3], SP[p1, p3]])/
    (mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((10 - 3*d)*s + 6*t) + 
   ...
   ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p1, p2], SP[p1, p3], 
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(-6*gZlLC*gZuL*gZuLC*t - 
      6*gZlRC*gZuR*gZuRC*t + 6*gZlRC*gZuL*gZuLC*(s + t) + 
      6*gZlLC*gZuR*gZuRC*(s + t) + d*(gZlLC - gZlRC)*
       (gZuL*gZuLC - gZuR*gZuRC)*(s + 2*t))*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p1, q1], SP[p1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) - ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((10 - 3*d)*s + 6*t) + 
      gZlRC*gZuR*gZuRC*((10 - 3*d)*s + 6*t) + gZlRC*gZuL*gZuLC*
       ((-8 + 3*d)*s + 6*t) + gZlLC*gZuR*gZuRC*((-8 + 3*d)*s + 6*t))*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-2 + d)*s + (-4 + d)*t) + gZlRC*gZuR*gZuRC*
       ...
       ((-4 + d)*s + (-2 + d)*t))*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   ((3*I)*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1], 
      SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   ((3*I)*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1], 
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
    ...
    (mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((14 - 3*d)*s + 6*t) + 
    ...
    (mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((10 - 3*d)*s + 6*t) + 
      gZlRC*gZuR*gZuRC*((10 - 3*d)*s + 6*t) + gZlRC*gZuL*gZuLC*
       ((-8 + 3*d)*s + 6*t) + gZlLC*gZuR*gZuRC*((-8 + 3*d)*s + 6*t))*
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*
     (-(gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + gZuL*gZuLC*
          ((-2 + d)*s + 2*t))) + gZlLC*(gZuL*gZuLC*((-4 + d)*s - 2*t) - 
        gZuR*gZuRC*((-2 + d)*s + 2*t)))*SPList[SP[p1, p2], SP[p1, p3], 
      SP[p1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) + ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(4 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], 
      SP[p1, q1], SP[p1, q1], SP[p1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (-6*gZlLC*gZuL*gZuLC*t - 6*gZlRC*gZuR*gZuRC*t + 
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((14 - 3*d)*s + 6*t) + 
    ...
    (mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlRC*gZuL*gZuLC*(2*s - (-4 + d)*t) + 
      gZlLC*gZuR*gZuRC*(2*s - (-4 + d)*t) + gZlLC*gZuL*gZuLC*
       (2*s + (-2 + d)*t) + gZlRC*gZuR*gZuRC*(2*s + (-2 + d)*t))*
     SPList[SP[p1, p2], SP[p1, q1], SP[p1, q1], SP[q1, q1]])/
    (mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((10 - 3*d)*s + 6*t) + 
      gZlRC*gZuR*gZuRC*((10 - 3*d)*s + 6*t) + gZlRC*gZuL*gZuLC*
       ((-8 + 3*d)*s + 6*t) + gZlLC*gZuR*gZuRC*((-8 + 3*d)*s + 6*t))*
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-2 + d)*s + (-4 + d)*t) + gZlRC*gZuR*gZuRC*
       ((-2 + d)*s + (-4 + d)*t) - gZlRC*gZuL*gZuLC*
       ((-4 + d)*s + (-2 + d)*t) - gZlLC*gZuR*gZuRC*
       ((-4 + d)*s + (-2 + d)*t))*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*
     (-(gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + gZuL*gZuLC*
          ((-2 + d)*s + 2*t))) + gZlLC*(gZuL*gZuLC*((-4 + d)*s - 2*t) - 
        gZuR*gZuRC*((-2 + d)*s + 2*t)))*SPList[SP[p1, p2], SP[p1, q1], 
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q1], 
      SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   ((3*I)*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q1], 
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p1, p2], SP[p2, q1], SP[q1, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p3, q1], SP[q1, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p3], 
      SP[p1, q1], SP[p1, q1], SP[p1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((14 - 3*d)*s + 6*t) + gZlRC*gZuR*gZuRC*
       ((14 - 3*d)*s + 6*t) + gZlRC*gZuL*gZuLC*((-4 + 3*d)*s + 6*t) + 
      gZlLC*gZuR*gZuRC*((-4 + 3*d)*s + 6*t))*SPList[SP[p1, p3], SP[p1, q1], 
      SP[p1, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, p3], SP[p1, q1], SP[p1, q1], 
      SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p3], 
      SP[p1, q1], SP[p1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((10 - 3*d)*s + 6*t) + gZlRC*gZuR*gZuRC*
       ((10 - 3*d)*s + 6*t) + gZlRC*gZuL*gZuLC*((-8 + 3*d)*s + 6*t) + 
      gZlLC*gZuR*gZuRC*((-8 + 3*d)*s + 6*t))*SPList[SP[p1, p3], SP[p1, q1], 
      SP[p2, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(4 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, p3], SP[p1, q1], SP[p2, q1], 
      SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*
     (-(gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + gZuL*gZuLC*
          ((-2 + d)*s + 2*t))) + gZlLC*(gZuL*gZuLC*((-4 + d)*s - 2*t) - 
        gZuR*gZuRC*((-2 + d)*s + 2*t)))*SPList[SP[p1, p3], SP[p1, q1], 
      SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(4 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p3], 
      SP[p1, q1], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p3], SP[p2, q1], SP[p2, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p3], SP[p2, q1], SP[q1, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     SPList[SP[p1, p3], SP[p3, q1], SP[q1, q1], SP[q1, q1]])/
    (mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
     ...
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, q1], 
      SP[p1, q1], SP[p1, q1], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     ((-4 + d)*gZlLC*gZuL*gZuLC - (-2 + d)*gZlRC*gZuL*gZuLC - 
      (-2 + d)*gZlLC*gZuR*gZuRC + (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(-6*gZlLC*gZuL*gZuLC*t - 
      6*gZlRC*gZuR*gZuRC*t + 6*gZlRC*gZuL*gZuLC*(s + t) + 
      6*gZlLC*gZuR*gZuRC*(s + t) + d*(gZlLC - gZlRC)*
       (gZuL*gZuLC - gZuR*gZuRC)*(s + 2*t))*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q1], SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((14 - 3*d)*s + 6*t) + gZlRC*gZuR*gZuRC*
       ((14 - 3*d)*s + 6*t) + gZlRC*gZuL*gZuLC*((-4 + 3*d)*s + 6*t) + 
      gZlLC*gZuR*gZuRC*((-4 + 3*d)*s + 6*t))*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q1], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*(2*s - (-4 + d)*t) + gZlLC*gZuR*gZuRC*
       (2*s - (-4 + d)*t) + gZlLC*gZuL*gZuLC*(2*s + (-2 + d)*t) + 
      gZlRC*gZuR*gZuRC*(2*s + (-2 + d)*t))*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1], 
      SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, q1], 
      SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     ((-4 + d)*gZlLC*gZuL*gZuLC - (-2 + d)*gZlRC*gZuL*gZuLC - 
      (-2 + d)*gZlLC*gZuR*gZuRC + (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((10 - 3*d)*s + 6*t) + 
      gZlRC*gZuR*gZuRC*((10 - 3*d)*s + 6*t) + gZlRC*gZuL*gZuLC*
       ((-8 + 3*d)*s + 6*t) + gZlLC*gZuR*gZuRC*((-8 + 3*d)*s + 6*t))*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-2 + d)*s + (-4 + d)*t) + gZlRC*gZuR*gZuRC*
       ((-2 + d)*s + (-4 + d)*t) - gZlRC*gZuL*gZuLC*
       ((-4 + d)*s + (-2 + d)*t) - gZlLC*gZuR*gZuRC*
       ((-4 + d)*s + (-2 + d)*t))*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*
     (-(gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + gZuL*gZuLC*
          ((-2 + d)*s + 2*t))) + gZlLC*(gZuL*gZuLC*((-4 + d)*s - 2*t) - 
        gZuR*gZuRC*((-2 + d)*s + 2*t)))*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p2, q1], SP[p2, q1], SP[p2, q1], 
      SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p2, q1], SP[p2, q1], SP[p2, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p2, q1], SP[p2, q1], SP[p3, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
 ...
 PropList[KiraPropagator[p1 - q1, mw], KiraPropagator[-p2 - q1, mw]]*
  (((-I)*EL^6*gAl*gWWA*gWWZ*(gZlRC*gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 
    ...
    (2^(2*(1 + d))*mw^2*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     ...
     GaugeXi[Q]^2) + ((I/2)*EL^6*gAl*gWWA*gWWZ*
     ((mw^2*(gZlRC*gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
            ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
         gZlLC*gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
            ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
         gZlLC*gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
        ...
        (mw^2 - 2*s - 2*(mw^2 + s)*GaugeXi[Q] + mw^2*GaugeXi[Q]^2))/
       ((2*Pi)^(2*d)*(-mz^2 + s)) + 
      ((mw^2*s^2*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
                (-2*s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
               2^(1 + d)*Pi^d*(s + 3*t - d*t))) - 
           gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + 
                 (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + 3*t - d*t))))*(-1 + GaugeXi[Q])^2*(1 + GaugeXi[Q])^2)/
         (2*Pi)^(2*d) + (2^(1 - 2*d)*mw^2*s*(-1 + GaugeXi[Q])*
          (gZlRC*gZuL*gZuLC*(-((-1 + d)*d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
           ...
           gZlRC*gZuR*gZuRC*(d*(1 + d)*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
              ((1 - 2*d)*s^2 + (5 - 4*d + d^2)*s*t + 2*t^2)) + 
           (gZlLC*(gZuR*gZuRC*((-1 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
                  (-3*(-2 + d)*s^2 + (7 - 6*d + d^2)*s*t - 2*t^2)) + gZuL*
                gZuLC*(-(d*(1 + d)*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
                  (3*(-1 + d)*s^2 - (11 - 6*d + d^2)*s*t - 2*t^2))) - 
             gZlRC*(gZuL*gZuLC*(-((-1 + d)*d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
                  (3*(-2 + d)*s^2 - (7 - 6*d + d^2)*s*t + 2*t^2)) + gZuR*
                gZuRC*(d*(1 + d)*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
                  (-3*(-1 + d)*s^2 + (11 - 6*d + d^2)*s*t + 2*t^2))))*
        ...
        (2^(1 - 2*d)*mw^4*(-1 + GaugeXi[Q])^2*
          (gZlLC*(gZuR*gZuRC*((-1 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
           ...
           (gZlLC*(gZuL*gZuLC*(-(d*(1 + 3*d)*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
                  ((-5 + 6*d)*s^2 + (-17 + 14*d - 3*d^2)*s*t - 2*t^2)) + gZuR*
                gZuRC*(d*(-1 + 3*d)*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
                  (2*(-5 + 4*d)*s^2 + (-13 + 14*d - 3*d^2)*s*t + 2*t^2))) - 
             gZlRC*(gZuR*gZuRC*(d*(1 + 3*d)*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
                  ((-5 + 6*d)*s^2 + (-17 + 14*d - 3*d^2)*s*t - 2*t^2)) + gZuL*
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     ...
     GaugeXi[Q]^2) - ((I/4)*EL^6*gAl*gWWA*gWWZ*
     ((mw^2*s^2*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
              (-2*s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
             2^(1 + d)*Pi^d*(s + 3*t - d*t))) - 
         gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*
         ...
         (gZlLC*(gZuR*gZuRC*((-1 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
           ...
           gZlRC*(gZuL*gZuLC*(-((-1 + d)*d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
             ...
             gZuR*gZuRC*(d*(1 + d)*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
                (-3*(-1 + d)*s^2 + (11 - 6*d + d^2)*s*t + 2*t^2))))*
          GaugeXi[Q])*(1 - GaugeXi[Q]^2))/Pi^(2*d) - 
      (s^3*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + (-3 + d)*
                t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
              (s + 3*t - d*t))) - gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
             2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + gZuL*gZuLC*
            (-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 3*t - d*t))))*
        ...
        2^(1 + d)*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
         ...
         GaugeXi[Q] + (gZlLC*(-21*d*gZuL*gZuLC*(2*Pi)^d*s*t + 
            ...
            2^(1 + d)*gZuL*gZuLC*Pi^d*((-2 + d)^2*s^2 + (17 + 2*d^2)*s*t + 
              4*t^2)) + gZlRC*(21*d*gZuL*gZuLC*(2*Pi)^d*s*t - 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
        ...
        (-2*s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
         ...
         2^(1 + d)*mw^2*Pi^d*(-1 + GaugeXi[Q])*
          (gZlLC*gZuR*gZuRC*((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*t - 
           ...
           gZlRC*(gZuL*gZuLC*((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*t - 4*
             ...
             gZlLC*gZuL*gZuLC*((6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*
                t + 4*t^2) + gZlRC*gZuR*gZuRC*((6 - 5*d + d^2)*s^2 + 2*
                (11 - 6*d + d^2)*s*t + 4*t^2))*GaugeXi[Q]) + 
         mw^2*(1 - GaugeXi[Q])*(-1 + GaugeXi[Q])*
          (gZlLC*s*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + 
                 (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (s + 3*t - d*t))) - gZlRC*s*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
               2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + gZuL*gZuLC*
              (-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 3*t - d*t))) + 
           gZlLC*(-9*d*gZuL*gZuLC*(2*Pi)^d*s^2 + 13*d*gZuR*gZuRC*(2*Pi)^d*
              s^2 - 2^(1 + d)*gZuR*gZuRC*Pi^d*((10 + d^2)*s^2 + (11 - 11*d + 
                 2*d^2)*s*t - 4*t^2) + 2^(1 + d)*gZuL*gZuLC*Pi^d*
              ((5 + d^2)*s^2 + (19 - 11*d + 2*d^2)*s*t + 4*t^2))*GaugeXi[Q] + 
           gZlRC*(13*d*gZuL*gZuLC*(2*Pi)^d*s^2 - 9*d*gZuR*gZuRC*(2*Pi)^d*
         ...
         (s*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + 
          ...
          2*s*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + 
           ...
           GaugeXi[Q] + (gZlLC*(-17*d*gZuL*gZuLC*(2*Pi)^d*s^2 + 
              ...
              2^(1 + d)*gZuL*gZuLC*Pi^d*((9 + 2*d^2)*s^2 + 
                (35 - 21*d + 4*d^2)*s*t + 8*t^2)) + 
            gZlRC*(25*d*gZuL*gZuLC*(2*Pi)^d*s^2 - 17*d*gZuR*gZuRC*(2*Pi)^d*s^
                2 - 2^(1 + d)*gZuL*gZuLC*Pi^d*(2*(9 + d^2)*s^2 + 
    ...
    (mw^4*(mz^2 - s)*s*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(-(2^(1 + d)*((-2 + d)*gZlLC*gZuL*gZuLC - 
         (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      ...
      s^2*t*(gZlRC*(gZuR*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        ...
        2^(1 + d)*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
         ...
         GaugeXi[Q]^2 + (gZlLC*gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
          ...
          gZlRC*gZuL*gZuLC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d) + 
          gZlLC*gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d))*GaugeXi[Q]^4))*
     SPList[SP[p1, p2], SP[p2, q1]])/(mw^4*(2*Pi)^(2*d)*(mz^2 - s)*s*
     (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) - 
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (((gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZlLC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
     ...
     (-2*s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
      ...
      mw^2*(1 - GaugeXi[Q])*(-1 + GaugeXi[Q])*
       (gZlLC*s*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
             (-2*s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
            2^(1 + d)*Pi^d*(s + 3*t - d*t))) - 
        gZlRC*s*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     ...
     GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*(2*mw^4 - 3*mw^2*s + s^2 + 
     ...
     ((2^(1 - 2*d)*(-1 + GaugeXi[Q])*
        ...
        (-(2^(1 + d)*Pi^d*s^2*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 
              2*(-3 + d)*t) + gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 
              2*(-3 + d)*t) + gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
            gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t))*(1 - GaugeXi[Q])*
           (1 + GaugeXi[Q])) + mw^2*(-1 + GaugeXi[Q])*
          (gZlLC*gZuL*gZuLC*((-1 + d)*d*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
              (s^2 + (1 + 2*d - d^2)*s*t - 2*t^2)) + gZlRC*gZuR*gZuRC*
            ((-1 + d)*d*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*(s^2 + (1 + 2*d - d^2)*
                s*t - 2*t^2)) + gZlRC*gZuL*gZuLC*
            (-((-3 + d)*d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*s^2 + 
               (5 + 2*d - d^2)*s*t + 2*t^2)) + gZlLC*gZuR*gZuRC*
            (-((-3 + d)*d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*s^2 + 
               (5 + 2*d - d^2)*s*t + 2*t^2)) - 
           2*(-(gZlRC*gZuL*gZuLC*((-7 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
                 (6*s^2 + (7 - 6*d + d^2)*s*t - 2*t^2))) - gZlLC*gZuR*gZuRC*
      ...
      (2^(1 + d)*((-4 + d)*gZlLC*gZuL*gZuLC - (-2 + d)*gZlRC*gZuL*gZuLC - 
         ...
         (-1 + GaugeXi[Q])*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s*((-7 + d)*s - 
              11*t) + 2^(1 + d)*Pi^d*(5*s^2 + (5 + d^2)*s*t - 2*t^2)) + 
          gZlLC*gZuR*gZuRC*(d*(2*Pi)^d*s*((-7 + d)*s - 11*t) + 
            2^(1 + d)*Pi^d*(5*s^2 + (5 + d^2)*s*t - 2*t^2)) - 
          gZlLC*gZuL*gZuLC*(d*(2*Pi)^d*s*((-5 + d)*s - 11*t) + 
            2^(1 + d)*Pi^d*(4*s^2 + (10 + d^2)*s*t + 2*t^2)) - 
          gZlRC*gZuR*gZuRC*(d*(2*Pi)^d*s*((-5 + d)*s - 11*t) + 
            2^(1 + d)*Pi^d*(4*s^2 + (10 + d^2)*s*t + 2*t^2)) - 
    ...
    (mw^4*(mz^2 - s)*s*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) + 
   ((I/2)*EL^6*gAl*gWWA*gWWZ*((2^(1 - 2*d)*(-1 + GaugeXi[Q])*
        (-2*s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
              (2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 
             2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + gZlLC*gZuL*gZuLC*
            (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     ...
     GaugeXi[Q]^2) - (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(3*2^(1 + d)*gZuR*gZuRC*Pi^d*s^2*((-4 + d)*s + 2*(-3 + d)*t) - 
        3*2^(1 + d)*gZuL*gZuLC*Pi^d*s^2*((-2 + d)*s + 2*(-3 + d)*t) - 
        gZuR*gZuRC*mw^2*(-13*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
           ((-10 + 5*d + d^2)*s^2 + (-19 - d + 2*d^2)*s*t - 4*t^2)) + 
        gZuL*gZuLC*mw^2*(-5*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
           ((-5 + 3*d + d^2)*s^2 + (-11 - d + 2*d^2)*s*t + 4*t^2))) + 
      gZlRC*(3*2^(1 + d)*gZuL*gZuLC*Pi^d*s^2*((-4 + d)*s + 2*(-3 + d)*t) - 
        3*2^(1 + d)*gZuR*gZuRC*Pi^d*s^2*((-2 + d)*s + 2*(-3 + d)*t) - 
        gZuL*gZuLC*mw^2*(-13*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
           ((-10 + 5*d + d^2)*s^2 + (-19 - d + 2*d^2)*s*t - 4*t^2)) + 
        gZuR*gZuRC*mw^2*(-5*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
           ((-5 + 3*d + d^2)*s^2 + (-11 - d + 2*d^2)*s*t + 4*t^2))) - 
      2*(gZlLC*(-3*gZuL*gZuLC*s^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
             (s - (-3 + d)*t)) + 3*gZuR*gZuRC*s^2*(-(d*(2*Pi)^d*s) + 
            2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) - gZuR*gZuRC*mw^2*
           (-15*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((14 + d^2)*s^2 + 
              (17 - 13*d + 2*d^2)*s*t - 4*t^2)) + gZuL*gZuLC*mw^2*
           (-11*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((7 + d^2)*s^2 + 
              (25 - 13*d + 2*d^2)*s*t + 4*t^2))) + 
        gZlRC*(-3*gZuR*gZuRC*s^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
      ...
      mw^2*(gZlLC*(-11*d*gZuL*gZuLC*(2*Pi)^d*s^2 + 15*d*gZuR*gZuRC*(2*Pi)^d*
           s^2 - 2^(1 + d)*gZuR*gZuRC*Pi^d*((14 + d^2)*s^2 + 
            (17 - 13*d + 2*d^2)*s*t - 4*t^2) + 2^(1 + d)*gZuL*gZuLC*Pi^d*
           ((7 + d^2)*s^2 + (25 - 13*d + 2*d^2)*s*t + 4*t^2)) + 
        gZlRC*(15*d*gZuL*gZuLC*(2*Pi)^d*s^2 - 11*d*gZuR*gZuRC*(2*Pi)^d*s^2 - 
          2^(1 + d)*gZuL*gZuLC*Pi^d*((14 + d^2)*s^2 + (17 - 13*d + 2*d^2)*s*
             t - 4*t^2) + 2^(1 + d)*gZuR*gZuRC*Pi^d*((7 + d^2)*s^2 + 
      ...
      s^2*t*(gZlRC*(gZuR*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        ...
        2^(1 + d)*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
         ...
         GaugeXi[Q]^2 + (gZlLC*gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
          ...
          gZlRC*gZuL*gZuLC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d) + 
          gZlLC*gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d))*GaugeXi[Q]^4))*
     SPList[SP[p2, q1], SP[p2, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*
     (-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) + 
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (((gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZlLC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     ...
     GaugeXi[Q]^2) + (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (-(2^(1 + d)*Pi^d*s^2*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
         gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t))*(1 - GaugeXi[Q])*
        (1 + GaugeXi[Q])) + mw^2*(-1 + GaugeXi[Q])*
   ...
   ((3*I)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*t*(1 + GaugeXi[Q])*
     (-3*mw^2 + 2*s + mw^2*GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, p2], 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(-((2*Pi)^d*s*(gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*t) + 
         gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*t) + gZlLC*gZuL*gZuLC*
          (-((-2 + d)*s) + 2*t) + gZlRC*gZuR*gZuRC*(-((-2 + d)*s) + 2*t) + 
         2*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
           (-4 + d)*gZlLC*gZuR*gZuRC + (-2 + d)*gZlRC*gZuR*gZuRC)*t*
      ...
      SP[q1, q1]])/(4^d*mw^4*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*(1 + GaugeXi[Q])*(-3*mw^2 + 2*s + 
      mw^2*GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, p3], SP[p1, p3]])/
    (mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (-(2^(1 + d)*Pi^d*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
           gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
         gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 
             2*t)))*(1 + GaugeXi[Q])) + 2^(1 + d)*(gZlLC + gZlRC)*
       (gZuL*gZuLC + gZuR*gZuRC)*Pi^d*(1 + GaugeXi[Q])*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     ...
     (-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(2^(1 + d)*Pi^d*
   ...
   (I*EL^6*gAl*gWWA*gWWZ*
     ((2^(3 - d)*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
         gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)))/Pi^d + 
      ((gZlLC*gZuL*gZuLC*(-2*(-3 + d)*s + (10 - 3*d)*t) + 
         gZlRC*gZuR*gZuRC*(-2*(-3 + d)*s + (10 - 3*d)*t) + 
         gZlRC*gZuL*gZuLC*(2*(-3 + d)*s + (-8 + 3*d)*t) + 
         gZlLC*gZuR*gZuRC*(2*(-3 + d)*s + (-8 + 3*d)*t))*(1 + GaugeXi[Q])*
        (-3*mw^2 + 2*s + mw^2*GaugeXi[Q]))/((2*Pi)^d*s) + 
      (2^(1 - 2*d)*(2^(1 + d)*Pi^d*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 
             2*(-3 + d)*t) + gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 
             2*(-3 + d)*t) + gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
           gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t))*GaugeXi[Q] - 
         (mw^2*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
                 (-2*s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
                2^(1 + d)*Pi^d*(s + 3*t - d*t))) - 
            gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + 
                  (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                 (2*s + 3*t - d*t))))*(-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))/s))/
       Pi^(2*d))*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q1]])/
    (mw^4*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*4^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (2^(-1 + d)*Pi^d*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) + (8 - 3*d)*t) + 
        gZlRC*gZuR*gZuRC*(-((-2 + d)*s) + (8 - 3*d)*t) + 
        gZlRC*gZuL*gZuLC*((-4 + d)*s + (-10 + 3*d)*t) + 
        gZlLC*gZuR*gZuRC*((-4 + d)*s + (-10 + 3*d)*t))*(1 + GaugeXi[Q])*
       (-3*mw^2 + 2*s + mw^2*GaugeXi[Q]) + (2*Pi)^d*s*
       (gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*t) + gZlLC*gZuR*gZuRC*
        ...
        2*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
          (-4 + d)*gZlLC*gZuR*gZuRC + (-2 + d)*gZlRC*gZuR*gZuRC)*t*
         GaugeXi[Q]) - mw^2*(gZlLC*gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        gZlRC*gZuR*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
        gZlRC*gZuL*gZuLC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d) + 
        gZlLC*gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d))*t*
       (-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))*SPList[SP[p1, p2], SP[p1, q1], 
      SP[p2, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (-(2^(1 + d)*Pi^d*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
           gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
         gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(2^(3 + d)*Pi^d*
       (gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
        gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)) + 
      2^(1 + d)*Pi^d*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
        gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t))*GaugeXi[Q] - 
      (mw^2*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     ...
     SPList[SP[p1, p2], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*(1 + GaugeXi[Q])*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     ...
     (-3*mw^2 + 2*s + mw^2*GaugeXi[Q])*SPList[SP[p1, p3], SP[p1, p3], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(((gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
         gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*
      ...
      (2^(1 - 2*d)*(-(2^(1 + d)*Pi^d*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
          ...
          s))/Pi^(2*d))*SPList[SP[p1, p3], SP[p1, q1], SP[p1, q1]])/
    (mw^4*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (-(2^(1 + d)*Pi^d*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
           gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(2^(1 + d)*Pi^d*
       (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
        gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
          2*gZuR*gZuRC*(3*s + t)))*(1 + GaugeXi[Q]) - 
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     ...
     (-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*EL^6*gAl*gWWA*gWWZ*
     ((2^(3 - d)*s*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
         gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t)))/Pi^d + 
      (2^(3 - d)*s*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
         gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)))/Pi^d + 
      (((-4 + d)*gZlLC*gZuL*gZuLC - (-2 + d)*gZlRC*gZuL*gZuLC - 
      ...
      (2^(1 - 2*d)*(-((2*Pi)^d*s*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
            gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*
               s + 2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)) + 
     ...
     s*GaugeXi[Q]^2) - (I*EL^6*gAl*gWWA*gWWZ*
     ((2^(3 - d)*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
         gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)))/Pi^d + 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(((gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      ...
      (2^(1 - 2*d)*(-(2^(1 + d)*Pi^d*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
           ...
           (1 + GaugeXi[Q])) + (mw^2*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 
              ...
              2^(1 + d)*Pi^d*(3*s + t)) + gZlRC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 
              2^(1 + d)*Pi^d*(3*s + t)))*(-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))/
          s))/Pi^(2*d))*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1]])/
    (mw^4*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(3*2^(2 + d)*Pi^d*
       (gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
        gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
        gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
        gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t)) + 
      2^(3 + d)*Pi^d*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
        gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)) + 
      (2*Pi)^d*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*
      ...
      SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*EL^6*gAl*gWWA*gWWZ*(((gZlLC*gZuL*gZuLC*(-((-2 + d)*s) + (8 - 3*d)*t) + 
         gZlRC*gZuR*gZuRC*(-((-2 + d)*s) + (8 - 3*d)*t) + 
         gZlRC*gZuL*gZuLC*((-4 + d)*s + (-10 + 3*d)*t) + 
         gZlLC*gZuR*gZuRC*((-4 + d)*s + (-10 + 3*d)*t))*(1 + GaugeXi[Q])*
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(2^(1 + d)*Pi^d*
      ...
      (mw^2*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         ...
         gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)) + 
         gZlRC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)))*
        (-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))/s)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[q1, q1]])/(4^d*mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
 ...
 PropList[KiraPropagator[p1 - q1, mw], KiraPropagator[-p2 - q1, 
    mw*Sqrt[GaugeXi[Q]]]]*(((-I)*4^(-1 - d)*EL^6*gAl*gWWA*gWWZ*s*
     (gZlRC*gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
         ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
      gZlLC*gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
         ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
     ...
     GaugeXi[Q]^2) - (I*2^(-1 - d)*EL^6*gAl*gWWA*gWWZ*(1 + GaugeXi[Q])*
     ((2*mw^2 - s)*s*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
        gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
        gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
        gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t)) + 
      (-(gZlRC*gZuL*gZuLC*(s^2*((-4 + d)*s + 2*(-3 + d)*t) + 
           2*mw^2*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*t - 4*t^2))) - 
        gZlLC*gZuR*gZuRC*(s^2*((-4 + d)*s + 2*(-3 + d)*t) + 
          2*mw^2*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*t - 4*t^2)) + 
        gZlLC*gZuL*gZuLC*(s^2*((-2 + d)*s + 2*(-3 + d)*t) + 
          2*mw^2*((6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*t + 4*t^2)) + 
        gZlRC*gZuR*gZuRC*(s^2*((-2 + d)*s + 2*(-3 + d)*t) + 
          2*mw^2*((6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*t + 4*t^2)))*
       GaugeXi[Q])*SPList[SP[p1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
         ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
      gZlLC*gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
      ...
      gZlRC*gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
         (-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2)))*(1 + GaugeXi[Q])*
     SPList[SP[p2, q1]])/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) - ((I/4)*EL^6*gAl*gWWA*gWWZ*(-1 + GaugeXi[Q]^2)*
         ...
         (gZlLC*(gZuR*gZuRC*((-1 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
           ...
           gZlRC*(gZuL*gZuLC*(-((-1 + d)*d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
             ...
             gZuR*gZuRC*(d*(1 + d)*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
                (-3*(-1 + d)*s^2 + (11 - 6*d + d^2)*s*t + 2*t^2))))*
          GaugeXi[Q]))/Pi^(2*d) + 
      (s^2*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + (-3 + d)*
                t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
              (s + 3*t - d*t))) - gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
             2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + gZuL*gZuLC*
            (-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s + 3*t - d*t))))*
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(-(mw^2*(-1 + GaugeXi[Q])^2*
        (gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s*(d*s - 11*t)) + 
           2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - (6 + d^2)*s*t + 2*t^2)) + 
         gZlLC*gZuR*gZuRC*(-(d*(2*Pi)^d*s*(d*s - 11*t)) + 
           2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - (6 + d^2)*s*t + 2*t^2)) + 
      ...
      (s^2*t*(gZlRC*(gZuR*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
         ...
         2^(1 + d)*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
          ...
          GaugeXi[Q]^2 + (gZlLC*gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
           ...
           gZlRC*gZuL*gZuLC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d) + 
           gZlLC*gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d))*GaugeXi[Q]^4))/
       2)*SPList[SP[p1, p2], SP[p1, p2]])/(4^d*mw^4*Pi^(2*d)*(mz^2 - s)*s*
     (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(mw^2*(2*Pi)^d*
       (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*
           ((-4 + d)*s + 2*t)) - gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
      ...
      (s*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         ...
         (gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
           ...
           gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)) + 
           gZlRC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)))*
          GaugeXi[Q]^4))/2)*SPList[SP[p1, p2], SP[p1, p3]])/
     ...
     ((gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
       ...
       (-1 + GaugeXi[Q])*(gZlRC*gZuL*gZuLC*((-20 + 13*d - 2*d^2)*s^2 - 
        ...
        s*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
          gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
          gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
          gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t))*GaugeXi[Q]^2) + 
      4*(-1 + GaugeXi[Q])*
       (-(s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
           ...
           gZlRC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*
                t)))*(1 - GaugeXi[Q])*(1 + GaugeXi[Q])) + 
        mw^2*(2*Pi)^d*(-1 + GaugeXi[Q])*(gZlLC*gZuR*gZuRC*
           ((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*t - 4*t^2) - 
          gZlLC*gZuL*gZuLC*((2 - 3*d + d^2)*s^2 + 2*(5 - 4*d + d^2)*s*t + 
            4*t^2) + gZlRC*(gZuL*gZuLC*((4 - 5*d + d^2)*s^2 + 
              2*(1 - 4*d + d^2)*s*t - 4*t^2) - gZuR*gZuRC*
             ((2 - 3*d + d^2)*s^2 + 2*(5 - 4*d + d^2)*s*t + 4*t^2)) + 
          (-(gZlRC*gZuL*gZuLC*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*
                t - 4*t^2)) - gZlLC*gZuR*gZuRC*((12 - 7*d + d^2)*s^2 + 
              2*(7 - 6*d + d^2)*s*t - 4*t^2) + gZlLC*gZuL*gZuLC*
             ((6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*t + 4*t^2) + 
            gZlRC*gZuR*gZuRC*((6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*t + 
              4*t^2))*GaugeXi[Q])))*SPList[SP[p1, p2], SP[p1, q1]])/
    (mw^4*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     ...
     (-(mw^2*(-1 + GaugeXi[Q])^2*(gZlRC*gZuL*gZuLC*
          ...
          (d*(2*Pi)^d*s*(d*s - 11*t) + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
             (9 + d^2)*s*t + 2*t^2)) - 2^(1 + d)*((-2 + d)*gZlLC*gZuL*gZuLC - 
           (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      ...
      (s^2*t*(gZlRC*(gZuR*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
         ...
         2^(1 + d)*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
          ...
          GaugeXi[Q]^2 + (gZlLC*gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
           ...
           gZlRC*gZuL*gZuLC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d) + 
           gZlLC*gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d))*GaugeXi[Q]^4))/
       2)*SPList[SP[p1, p2], SP[p2, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*s*
     (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) - 
   (I*EL^6*gAl*gWWA*gWWZ*(mw^2*(2*Pi)^d*
       (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*
           ((-4 + d)*s + 2*t)) - gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
      ...
      (s*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         ...
         (gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
           ...
           gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)) + 
           gZlRC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)))*
          GaugeXi[Q]^4))/2)*SPList[SP[p1, p2], SP[p3, q1]])/
    (4^d*mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     GaugeXi[Q]^2) - (I*EL^6*gAl*gWWA*gWWZ*
     (-(s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            (2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s*
     (-2*mw^2 + s)*(1 + GaugeXi[Q])^2*SPList[SP[p1, p3], SP[p1, p3]])/
    (mw^4*(2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(mw^2*(2*Pi)^d*
       (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
        gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
          2*gZuR*gZuRC*(3*s + t)))*(-1 + GaugeXi[Q])^2*(1 + GaugeXi[Q])^2 + 
      (s*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         gZlLC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)) + 
         gZlRC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)) + 
     ...
     (mw^2*(2*Pi)^d*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
      ...
      (s*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         ...
         (gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
           ...
           gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)) + 
           gZlRC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)))*
          GaugeXi[Q]^4))/2)*SPList[SP[p1, p3], SP[p2, q1]])/
    (4^d*mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*s*(-2*mw^2 + s)*(1 + GaugeXi[Q])^2*
     SPList[SP[p1, p3], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*
     ((2^(2 - d)*s^2*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
         gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t))*(1 + GaugeXi[Q]))/
       Pi^d - (mw^2*(gZlLC*gZuL*gZuLC*((-1 + d)*d*(2*Pi)^d*s^2 - 
         ...
         (-(gZlRC*gZuL*gZuLC*((-7 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(
            ...
            ((-5 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(3*s^2 + (11 - 6*d + 
                 d^2)*s*t + 2*t^2)) + gZlRC*gZuR*gZuRC*
            ((-5 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(3*s^2 + (11 - 6*d + 
                 d^2)*s*t + 2*t^2)))*GaugeXi[Q]^2))/(2*Pi)^(2*d) - 
      (2^(1 - 2*d)*(-(s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
              2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*
             (-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + 
            gZlLC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + 
                (-3 + d)*t)) + gZlRC*gZuR*gZuRC*(d*(2*Pi)^d*s + 
              2^(1 + d)*Pi^d*(-s + (-3 + d)*t)))*(1 - GaugeXi[Q])*
      ...
      (-(mw^2*(-1 + GaugeXi[Q])^2*(-(gZlRC*gZuL*gZuLC*
             (d*(2*Pi)^d*s*((-7 + d)*s - 11*t) + 2^(1 + d)*Pi^d*(5*s^2 + 
                (5 + d^2)*s*t - 2*t^2))) - gZlLC*gZuR*gZuRC*
       ...
       (-(s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
        ...
        mw^2*(2*Pi)^d*(-1 + GaugeXi[Q])*(gZlLC*gZuR*gZuRC*
          ...
          (-(gZlRC*gZuL*gZuLC*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*
             ...
             ((6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*t + 4*t^2) + 
            gZlRC*gZuR*gZuRC*((6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*t + 
              4*t^2))*GaugeXi[Q])))*SPList[SP[p1, q1], SP[p2, q1]])/
    (mw^4*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     GaugeXi[Q]^2) - (I*EL^6*gAl*gWWA*gWWZ*
    ...
    (4^d*mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     ...
     ((2^(2 - d)*s^2*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      ...
      (s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
           ...
           (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
          gZlRC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)))*
         (1 + GaugeXi[Q]) + mw^2*(2*Pi)^d*(gZlLC*gZuR*gZuRC*
           ((4 - 5*d + d^2)*s^2 + 2*(1 - 4*d + d^2)*s*t - 4*t^2) - 
          gZlLC*gZuL*gZuLC*((2 - 3*d + d^2)*s^2 + 2*(5 - 4*d + d^2)*s*t + 
            4*t^2) + gZlRC*(gZuL*gZuLC*((4 - 5*d + d^2)*s^2 + 
              2*(1 - 4*d + d^2)*s*t - 4*t^2) - gZuR*gZuRC*
          ...
          (-(gZlRC*gZuL*gZuLC*((12 - 7*d + d^2)*s^2 + 2*(7 - 6*d + d^2)*s*
             ...
             ((6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*t + 4*t^2) + 
            gZlRC*gZuR*gZuRC*((6 - 5*d + d^2)*s^2 + 2*(11 - 6*d + d^2)*s*t + 
              4*t^2))*GaugeXi[Q]))/(2*Pi)^(2*d))*SPList[SP[p1, q1], 
      SP[q1, q1]])/(mw^4*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(-(mw^2*(-1 + GaugeXi[Q])^2*
        (gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s*(d*s - 11*t)) + 
           2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - (6 + d^2)*s*t + 2*t^2)) + 
         gZlLC*gZuR*gZuRC*(-(d*(2*Pi)^d*s*(d*s - 11*t)) + 
      ...
      (s^2*t*(gZlRC*(gZuR*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
         ...
         2^(1 + d)*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
          ...
          GaugeXi[Q]^2 + (gZlLC*gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
           ...
           gZlRC*gZuL*gZuLC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d) + 
           gZlLC*gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d))*GaugeXi[Q]^4))/
       2)*SPList[SP[p2, q1], SP[p2, q1]])/(4^d*mw^4*Pi^(2*d)*(mz^2 - s)*s*
     (-mzC^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(mw^2*(2*Pi)^d*
       (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*
           ((-4 + d)*s + 2*t)) - gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
   ...
   ((I/4)*EL^6*gAl*gWWA*gWWZ*
     ...
     (1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, p2], SP[p1, p2]])/
    (mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(mw^2 - s)*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*(1 + GaugeXi[Q])*SPList[SP[p1, p2], 
      SP[p1, p2], SP[p1, p3]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*EL^6*gAl*gWWA*gWWZ*
     ((2^(1 - d)*(mw^2 - s)*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) + (8 - 3*d)*t) + 
         gZlRC*gZuR*gZuRC*(-((-2 + d)*s) + (8 - 3*d)*t) + 
         gZlRC*gZuL*gZuLC*((-4 + d)*s + (-10 + 3*d)*t) + 
         gZlLC*gZuR*gZuRC*((-4 + d)*s + (-10 + 3*d)*t))*(1 + GaugeXi[Q]))/
   ...
   ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
      (-2 + d)*gZlRC*gZuR*gZuRC)*(mw^2 - s)*t*(1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(mw^2 - s)*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*(1 + GaugeXi[Q])*SPList[SP[p1, p2], 
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
    ...
    (mw^4*Pi^d*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*((2^(3 - d)*(gZlLC + gZlRC)*
    ...
    (mw^4*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(mw^2 - s)*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*(1 + GaugeXi[Q])*SPList[SP[p1, p2], 
      SP[p1, p3], SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*(mw^2 - s)*(1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, p3], SP[p3, q1]])/(mw^4*Pi^d*(-mz^2 + s)*
   ...
   (I*EL^6*gAl*gWWA*gWWZ*
     ((2^(3 - d)*s*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         ...
         gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
         gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t)))/Pi^d + 
      (2^(1 - d)*(mw^2 - s)*(gZlLC*gZuL*gZuLC*(-2*(-3 + d)*s + 
           (10 - 3*d)*t) + gZlRC*gZuR*gZuRC*(-2*(-3 + d)*s + (10 - 3*d)*t) + 
         gZlRC*gZuL*gZuLC*(2*(-3 + d)*s + (-8 + 3*d)*t) + 
         gZlLC*gZuR*gZuRC*(2*(-3 + d)*s + (-8 + 3*d)*t))*(1 + GaugeXi[Q]))/
       Pi^d - (2^(2 + d)*Pi^d*s*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 
    ...
    (mw^4*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (-(2^(1 + d)*Pi^d*(mw^2 - s)*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) + 
           (10 - 3*d)*t) + gZlLC*gZuR*gZuRC*(-((-4 + d)*s) + (10 - 3*d)*t) + 
         gZlLC*gZuL*gZuLC*((-2 + d)*s + (-8 + 3*d)*t) + 
         gZlRC*gZuR*gZuRC*((-2 + d)*s + (-8 + 3*d)*t))*(1 + GaugeXi[Q])) - 
      2^(1 + d)*Pi^d*s*(gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*t) + 
        gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*t) + gZlLC*gZuL*gZuLC*
         (-((-2 + d)*s) + 2*t) + gZlRC*gZuR*gZuRC*(-((-2 + d)*s) + 2*t) + 
        2*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*((2^(3 - d)*(gZlLC + gZlRC)*
    ...
    (mw^4*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (2^(4 + d)*Pi^d*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
        gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
        gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
        gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t)) - 
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(mw^2 - s)*
     ...
     (-(2^(1 + d)*Pi^d*s*(gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*t) + 
        ...
        gZlLC*gZuR*gZuRC*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d))*t*
       (-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))*SPList[SP[p1, p2], SP[p2, q1], 
      SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*(mw^2 - s)*(1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p3, q1], SP[p3, q1]])/(mw^4*Pi^d*(-mz^2 + s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
   ...
   (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     ...
     (-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*((2^(1 - d)*(mw^2 - s)*
        (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
         gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (2^(4 + d)*Pi^d*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
        ...
        gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
        gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t)) + 
      3*2^(3 + d)*Pi^d*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
        gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)) + 
      2^(1 + d)*Pi^d*(-(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t)) + 
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      ...
      gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t))*
     SPList[SP[p2, q1], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*(1 + GaugeXi[Q])*(-3*mw^2 + 4*s + 
      mw^2*GaugeXi[Q])*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1]])/
    (mw^4*(2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
      gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t))*
     SPList[SP[q1, q1], SP[q1, q1], SP[q1, q1]])/(mw^4*(2*Pi)^d*(mz^2 - s)*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
    ...
    (mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2)) + 
 PropList[KiraPropagator[-p1 + q1, mw], KiraPropagator[p2 + q1, 
    mw*Sqrt[GaugeXi[Q]]]]*((I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*(mw^2 - s)*s*
     (gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
         (2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 
        2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + gZlLC*gZuL*gZuLC*
       (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
     ...
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*4^(-1 - d)*EL^6*gAl*gWWA*gWWZ*(mw^2 - s)*
     s*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
         (2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 
        2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + gZlLC*gZuL*gZuLC*
       (d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)) + 
      gZlRC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)))*
     ...
     SPList[SP[p1, p2], SP[p1, p2]])/(mw^4*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*
     (-1 + GaugeXi[Q])^2*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(mw^2*(1 - GaugeXi[Q])*(-1 + GaugeXi[Q])*
       ((gZlLC*gZuL*gZuLC*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
          gZlRC*gZuR*gZuRC*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
          gZlRC*gZuL*gZuLC*(-(2^(1 + d)*Pi^d) + d*(2*Pi)^d) + 
          gZlLC*gZuR*gZuRC*(-(2^(1 + d)*Pi^d) + d*(2*Pi)^d))*s*(s + t) + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
    ...
    (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     GaugeXi[Q]^2) - ((I/2)*EL^6*gAl*gWWA*gWWZ*
     ((2^(1 - 2*d)*(2*s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
             2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*
            (-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + 
           gZlLC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*
                t)) + gZlRC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
     ...
     SPList[SP[p1, p2], SP[p2, q1]])/(mw^4*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (-(mw^2*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         gZlLC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)) + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
          ...
          2*s*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + 
           ...
           GaugeXi[Q] + (gZlLC*(-17*d*gZuL*gZuLC*(2*Pi)^d*s^2 + 
            ...
            gZlRC*(25*d*gZuL*gZuLC*(2*Pi)^d*s^2 - 17*d*gZuR*gZuRC*(2*Pi)^d*s^
                ...
                (9 + 2*d^2)*s^2 + (35 - 21*d + 4*d^2)*s*t + 8*t^2)))*
           GaugeXi[Q]^2))/((2*Pi)^(2*d)*(-1 + GaugeXi[Q])^2))*
     SPList[SP[p1, q1], SP[p2, q1]])/(mw^4*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (-(mw^2*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         gZlLC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)) + 
       ...
       (gZlLC*s*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
        ...
        gZlRC*(13*d*gZuL*gZuLC*(2*Pi)^d*s^2 - 9*d*gZuR*gZuRC*(2*Pi)^d*s^2 - 
          2^(1 + d)*gZuL*gZuLC*Pi^d*((10 + d^2)*s^2 + (11 - 11*d + 2*d^2)*s*
            ...
            (19 - 11*d + 2*d^2)*s*t + 4*t^2))*GaugeXi[Q]))*
     SPList[SP[p1, q1], SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*(mw^2 - s)*s*(1 + GaugeXi[Q])^2*
    ...
    (mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*(-1 + GaugeXi[Q])^2*
     GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*(mw^2 - s)*s*(1 + GaugeXi[Q])^2*
     SPList[SP[p2, p3], SP[p3, q1]])/(mw^4*Pi^d*(-mz^2 + s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) - ((I/2)*EL^6*gAl*gWWA*gWWZ*
     ((2^(1 - 2*d)*(2*s^2*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
             2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*
            (-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + 
          ...
          (gZlLC*s*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + 
           ...
           gZlRC*(13*d*gZuL*gZuLC*(2*Pi)^d*s^2 - 9*d*gZuR*gZuRC*(2*Pi)^d*
              ...
              ((5 + d^2)*s^2 + (19 - 11*d + 2*d^2)*s*t + 4*t^2))*
            GaugeXi[Q])))/Pi^(2*d) + 
      2*((2^(2 - d)*s^2*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
           gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
           gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + gZlLC*gZuR*gZuRC*
            ((-4 + d)*s + 2*(-3 + d)*t))*(1 + GaugeXi[Q]))/Pi^d + 
        (mw^2*(gZlLC*gZuL*gZuLC*((-1 + d)*d*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
              (s^2 + (1 + 2*d - d^2)*s*t - 2*t^2)) + gZlRC*gZuR*gZuRC*
            ((-1 + d)*d*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*(s^2 + (1 + 2*d - d^2)*
                s*t - 2*t^2)) + gZlRC*gZuL*gZuLC*
            (-((-3 + d)*d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*(2*s^2 + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
    ...
    (mw^4*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*(mw^2 - s)*
       ...
       Pi^d + (mw^2*(gZlLC*gZuL*gZuLC*((-1 + d)*d*(2*Pi)^d*s^2 - 
         ...
         (-(gZlRC*gZuL*gZuLC*((-7 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(
            ...
            ((-5 + d)*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(3*s^2 + (11 - 6*d + 
                 d^2)*s*t + 2*t^2)))*GaugeXi[Q]^2))/(2*Pi)^(2*d))*
     SPList[SP[q1, q1], SP[q1, q1]])/(mw^4*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
      (-2 + d)*gZlRC*gZuL*gZuLC - (-2 + d)*gZlLC*gZuR*gZuRC + 
      (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*(1 + GaugeXi[Q])*
     (-mw^2 + 2*s + mw^2*GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p1, p2]])/(mw^4*(2*Pi)^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   ((3*I)*EL^6*gAl*gWWA*gWWZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
      (-2 + d)*gZlRC*gZuL*gZuLC - (-2 + d)*gZlLC*gZuR*gZuRC + 
      (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*(1 + GaugeXi[Q])*
     (-mw^2 + 2*s + mw^2*GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, p2], 
   ...
   (I*EL^6*gAl*gWWA*gWWZ*
     ((2*Pi)^d*(gZlRC*gZuL*gZuLC*(-2*(-3 + d)*s + (8 - 3*d)*t) + 
        gZlLC*gZuR*gZuRC*(-2*(-3 + d)*s + (8 - 3*d)*t) + 
        gZlLC*gZuL*gZuLC*(2*(-3 + d)*s + (-10 + 3*d)*t) + 
        gZlRC*gZuR*gZuRC*(2*(-3 + d)*s + (-10 + 3*d)*t))*(1 + GaugeXi[Q])*
      ...
      mw^2*(gZlLC*gZuL*gZuLC*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
        ...
        gZlLC*gZuR*gZuRC*(-(2^(1 + d)*Pi^d) + d*(2*Pi)^d))*(s + t)*
       (-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p2, q1]])/(mw^4*(2*Pi)^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*(1 + GaugeXi[Q])*
   ...
   (I*EL^6*gAl*gWWA*gWWZ*
     (-(2^(1 + d)*Pi^d*s*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      ...
      SP[q1, q1]])/(mw^4*(2*Pi)^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*(1 + GaugeXi[Q])*
     (-mw^2 + 2*s + mw^2*GaugeXi[Q])*SPList[SP[p1, p2], SP[p2, p3], 
      SP[p2, p3]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*((2^(2 - d)*(gZlLC + gZlRC)*
        (gZuL*gZuLC + gZuR*gZuRC)*(1 + GaugeXi[Q])*(-mw^2 + 2*s + 
         mw^2*GaugeXi[Q]))/Pi^d + 
      (2^(2 + d)*Pi^d*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
          gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*
             s + 2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*(1 + GaugeXi[Q]) - 
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     ...
     (2^(2 + d)*Pi^d*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      ...
      (mw^2*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         ...
         gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)) + 
         gZlRC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)))*
        (-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))/s)*SPList[SP[p1, p2], SP[p2, p3], 
      SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*
     ((2^(3 - d)*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*(-3 + d)*t) + 
         gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*(-3 + d)*t)))/Pi^d + 
      ((gZlRC*gZuL*gZuLC*(-((-4 + d)*s) + (10 - 3*d)*t) + 
         ...
         gZlLC*gZuL*gZuLC*((-2 + d)*s + (-8 + 3*d)*t) + 
         gZlRC*gZuR*gZuRC*((-2 + d)*s + (-8 + 3*d)*t))*(1 + GaugeXi[Q])*
        (-mw^2 + 2*s + mw^2*GaugeXi[Q]))/((2*Pi)^d*s) + 
      (-(2^(2 + d)*Pi^d*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
           gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
           gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + gZlRC*gZuR*gZuRC*
            ((-2 + d)*s + 2*(-3 + d)*t))*GaugeXi[Q]) + 
        (mw^2*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
           ...
           gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + 
                 (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
                (2*s + 3*t - d*t))))*(-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))/s)/
       (2*Pi)^(2*d))*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q1]])/
    (mw^4*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*((2^(2 - d)*(gZlLC + gZlRC)*
        (gZuL*gZuLC + gZuR*gZuRC)*(1 + GaugeXi[Q])*(-mw^2 + 2*s + 
         mw^2*GaugeXi[Q]))/Pi^d + 
     ...
     (2^(4 + d)*Pi^d*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      ...
      (mw^2*(gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
         ...
         gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*
                t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
              (2*s + 3*t - d*t))))*(-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))/s)*
     SPList[SP[p1, p2], SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*(1 + GaugeXi[Q])*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     ...
     SPList[SP[p1, p2], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
      (-2 + d)*gZlRC*gZuL*gZuLC - (-2 + d)*gZlLC*gZuR*gZuRC + 
      (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*(1 + GaugeXi[Q])*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     ...
     (2^(2 + d)*Pi^d*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      ...
      (mw^2*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 
         ...
         gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)) + 
         gZlRC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(3*s + t)))*
        (-3 - 2*GaugeXi[Q] + GaugeXi[Q]^2))/s)*SPList[SP[p1, q1], SP[p2, p3], 
      SP[q1, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*
     ((2^(3 - d)*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     ...
     SPList[SP[p1, q1], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*(mw^2 - s)*(1 + GaugeXi[Q])*
     SPList[SP[p2, p3], SP[p2, p3], SP[p2, q1]])/(mw^4*Pi^d*(-mz^2 + s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*(1 + GaugeXi[Q])*(-3*mw^2 + 4*s + 
      mw^2*GaugeXi[Q])*SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/
    (mw^4*(2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*
     (-(2^(2 + d)*Pi^d*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
           gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
         gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 
             2*t)))*(1 + GaugeXi[Q])) + 
      ((2*Pi)^d*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
           gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
         gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 
             2*t)))*(1 + GaugeXi[Q])*(-mw^2 + 2*s + mw^2*GaugeXi[Q]))/s + 
      (mw^2*(gZlRC*gZuL*gZuLC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZlLC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-2*s + t)) + 
         gZlLC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)) + 
         gZlRC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)))*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     ...
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*(s^2 + mw^2*t + s*t)) + 
        2^(1 + d)*Pi^d*(2*s^2 + 2*mw^2*t + s*t)) + gZlLC*gZuR*gZuRC*
       (-(d*(2*Pi)^d*(s^2 + mw^2*t + s*t)) + 2^(1 + d)*Pi^d*
         (2*s^2 + 2*mw^2*t + s*t)) + gZlLC*gZuL*gZuLC*
       (d*(2*Pi)^d*(s^2 + mw^2*t + s*t) - 2^(1 + d)*Pi^d*
         (s^2 + mw^2*t + 2*s*t)) + gZlRC*gZuR*gZuRC*
       (d*(2*Pi)^d*(s^2 + mw^2*t + s*t) - 2^(1 + d)*Pi^d*
         (s^2 + mw^2*t + 2*s*t)) + 
      (gZlRC*gZuL*gZuLC*(mw^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
          2^(1 + d)*(-2 + d)*Pi^d*s - d*(2*Pi)^d*s) + gZlLC*gZuR*gZuRC*
         (mw^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 2^(1 + d)*(-2 + d)*Pi^d*s - 
          d*(2*Pi)^d*s) - gZlLC*gZuL*gZuLC*
         (mw^2*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 2^(1 + d)*(-1 + d)*Pi^d*s - 
          d*(2*Pi)^d*s) - gZlRC*gZuR*gZuRC*
         (mw^2*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 2^(1 + d)*(-1 + d)*Pi^d*s - 
          d*(2*Pi)^d*s))*t*GaugeXi[Q])*SPList[SP[p2, q1], SP[p2, q1], 
      SP[p2, q1]])/(mw^4*Pi^(2*d)*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*EL^6*gAl*gWWA*gWWZ*
     (-(2^(2 + d)*Pi^d*(gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
           gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl*gWWA*gWWZ*
     (2^(4 + d)*Pi^d*(gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      ...
      3*2^(3 + d)*Pi^d*(gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        ...
        gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
        gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)) - 
      2^(1 + d)*Pi^d*(gZlRC*gZuL*gZuLC*((-4 + d)*s + 2*t) + 
        gZlLC*gZuR*gZuRC*((-4 + d)*s + 2*t) + gZlLC*gZuL*gZuLC*
         (-((-2 + d)*s) + 2*t) + gZlRC*gZuR*gZuRC*(-((-2 + d)*s) + 2*t) + 
        2*((-2 + d)*gZlLC*gZuL*gZuLC - (-4 + d)*gZlRC*gZuL*gZuLC - 
          (-4 + d)*gZlLC*gZuR*gZuRC + (-2 + d)*gZlRC*gZuR*gZuRC)*t*
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
      (-2 + d)*gZlRC*gZuL*gZuLC - (-2 + d)*gZlLC*gZuR*gZuRC + 
      (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p1, p2], SP[p1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], SP[p1, p2], SP[p1, p2], 
      SP[p2, p3]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], 
      SP[p1, p2], SP[p1, p2], SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], SP[p1, p2], SP[p1, p2], 
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
      (-2 + d)*gZlRC*gZuL*gZuLC - (-2 + d)*gZlLC*gZuR*gZuRC + 
      (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p1, p2], SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + ((3*I)*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     ((-4 + d)*gZlLC*gZuL*gZuLC - (-2 + d)*gZlRC*gZuL*gZuLC - 
      (-2 + d)*gZlLC*gZuR*gZuRC + (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*
     SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1], SP[p1, q1]])/
    (mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], 
      SP[p1, p2], SP[p1, q1], SP[p2, p3]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], 
      SP[p1, p2], SP[p1, q1], SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - ((3*I)*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     ((-4 + d)*gZlLC*gZuL*gZuLC - (-2 + d)*gZlRC*gZuL*gZuLC - 
      (-2 + d)*gZlLC*gZuR*gZuRC + (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], 
      SP[p1, p2], SP[p2, p3], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (-6*gZlLC*gZuL*gZuLC*t - 6*gZlRC*gZuR*gZuRC*t + 
      6*gZlRC*gZuL*gZuLC*(s + t) + 6*gZlLC*gZuR*gZuRC*(s + t) + 
      d*(gZlLC - gZlRC)*(gZuL*gZuLC - gZuR*gZuRC)*(s + 2*t))*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], 
      SP[p1, p2], SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     ((-4 + d)*gZlLC*gZuL*gZuLC - (-2 + d)*gZlRC*gZuL*gZuLC - 
      (-2 + d)*gZlLC*gZuR*gZuRC + (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
      (-2 + d)*gZlRC*gZuL*gZuLC - (-2 + d)*gZlLC*gZuR*gZuRC + 
      (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*SPList[SP[p1, p2], SP[p1, q1], 
      SP[p1, q1], SP[p1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q1], 
      SP[p2, p3]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], 
      SP[p1, q1], SP[p1, q1], SP[p2, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*
     (-mzC^2 + s)*GaugeXi[Q]^2) + ((3*I)*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], SP[p1, q1], SP[p1, q1], 
      SP[p3, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   ((3*I)*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
      (-2 + d)*gZlRC*gZuL*gZuLC - (-2 + d)*gZlLC*gZuR*gZuRC + 
      (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*SPList[SP[p1, p2], SP[p1, q1], 
      SP[p1, q1], SP[q1, q1]])/(mw^4*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3], 
      SP[p2, p3]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((14 - 3*d)*s + 6*t) + 
      gZlRC*gZuR*gZuRC*((14 - 3*d)*s + 6*t) + gZlRC*gZuL*gZuLC*
       ((-4 + 3*d)*s + 6*t) + gZlLC*gZuR*gZuRC*((-4 + 3*d)*s + 6*t))*
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], 
      SP[p1, q1], SP[p2, p3], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (-6*gZlLC*gZuL*gZuLC*t - 6*gZlRC*gZuR*gZuRC*t + 
      6*gZlRC*gZuL*gZuLC*(s + t) + 6*gZlLC*gZuR*gZuRC*(s + t) + 
      d*(gZlLC - gZlRC)*(gZuL*gZuLC - gZuR*gZuRC)*(s + 2*t))*
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((14 - 3*d)*s + 6*t) + 
     ...
     SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1], SP[p3, q1]])/
    (mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlRC*gZuL*gZuLC*(2*s - (-4 + d)*t) + 
      gZlLC*gZuR*gZuRC*(2*s - (-4 + d)*t) + gZlLC*gZuL*gZuLC*
       (2*s + (-2 + d)*t) + gZlRC*gZuR*gZuRC*(2*s + (-2 + d)*t))*
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*
     (-(gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + gZuL*gZuLC*
          ((-2 + d)*s + 2*t))) + gZlLC*(gZuL*gZuLC*((-4 + d)*s - 2*t) - 
        gZuR*gZuRC*((-2 + d)*s + 2*t)))*SPList[SP[p1, p2], SP[p2, p3], 
      SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(4 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, p2], SP[p2, p3], SP[p3, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, p2], 
      SP[p2, p3], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q1], 
   ...
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-2 + d)*s + (-4 + d)*t) + gZlRC*gZuR*gZuRC*
       ((-2 + d)*s + (-4 + d)*t) - gZlRC*gZuL*gZuLC*
       ((-4 + d)*s + (-2 + d)*t) - gZlLC*gZuR*gZuRC*
       ((-4 + d)*s + (-2 + d)*t))*SPList[SP[p1, p2], SP[p2, q1], SP[p2, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) - 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1], SP[p3, q1]])/
    (mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*
     (-(gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + gZuL*gZuLC*
          ((-2 + d)*s + 2*t))) + gZlLC*(gZuL*gZuLC*((-4 + d)*s - 2*t) - 
        gZuR*gZuRC*((-2 + d)*s + 2*t)))*SPList[SP[p1, p2], SP[p2, q1], 
      SP[p3, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
      gZlRC*gZuR*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, q1], 
      SP[p1, q1], SP[p1, q1], SP[p2, p3]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) - (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - gZlLC*gZuR*gZuRC*(d*s + 2*t) - 
      gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1], 
   ...
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*
     (-(gZlRC*(gZuR*gZuRC*(-((-4 + d)*s) + 2*t) + gZuL*gZuLC*
          ((-2 + d)*s + 2*t))) + gZlLC*(gZuL*gZuLC*((-4 + d)*s - 2*t) - 
        gZuR*gZuRC*((-2 + d)*s + 2*t)))*SPList[SP[p1, q1], SP[p2, p3], 
      SP[p2, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
     GaugeXi[Q]^2) - (I*2^(4 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p1, q1], SP[p2, p3], SP[p3, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      gZlLC*gZuR*gZuRC*(d*s + 2*t) - gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
        2*gZuL*gZuLC*t + 2*gZuR*gZuRC*(3*s + t)))*SPList[SP[p1, q1], 
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
      ...
      SP[p3, q1], SP[q1, q1], SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*
     (-mzC^2 + s)*GaugeXi[Q]^2) + (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p2, p3], SP[p2, p3], 
      SP[p2, q1], SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*
     GaugeXi[Q]^2) + (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*SPList[SP[p2, p3], SP[p2, p3], SP[p2, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(2 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p2, p3], SP[p2, q1], SP[p2, q1], 
      SP[p2, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
   ...
   (I*2^(1 - d)*EL^6*gAl*gWWA*gWWZ*
     (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*((-4 + d)*s + 2*t)) - 
      gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*
         (-((-2 + d)*s) + 2*t)))*SPList[SP[p2, p3], SP[p2, q1], SP[q1, q1], 
      SP[q1, q1]])/(mw^4*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*GaugeXi[Q]^2) + 
   (I*2^(3 - d)*EL^6*gAl*gWWA*gWWZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
