...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (aa*psq*(3*psq - 2*s - 3*t) + aa*mm^2*(psq - t) + 
     bb*mm^2*(-psq + s + t) + bb*psq*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*
    gHFF*gHll*mh^2*mm^4*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gFll^2*gHFF*gHll*
    mh^2*mm^4*(aa*psq*(3*psq - 2*s - 3*t) + aa*mm^2*(psq - t) + 
     bb*mm^2*(-psq + s + t) + bb*psq*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) - (I*aa*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   (4^d*Pi^(2*d)) - (I*aa*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*(mm^2 - psq)*
  ...
  (I*bb*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*
   ...
   Pi^(2*d) - (I*bb*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFll^2*gHFF*gHll*mh^2*mm^4*
