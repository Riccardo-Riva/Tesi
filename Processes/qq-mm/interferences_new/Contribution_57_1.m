(PropList[KiraPropagator[q1, mw]]*
   (((-I)*2^(1 - d)*EL^6*gAl*gAu*gWWZZ*
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gWWZZ*
      (s*(gZlR*gZuL*(2*mm^2 + 2*(-4 + d)*mmv^2 + 4*s - d*s + 6*t - 2*d*t) + 
       ...
       (gZlR*gZuL*(4*mmv^4 + 2*(-3 + d)*mm^2*s - 12*s^2 + 7*d*s^2 - d^2*s^2 + 
           2*mmv^2*((12 - 7*d + d^2)*s - 4*t) - 14*s*t + 12*d*s*t - 
           2*d^2*s*t + 4*t^2) + gZlL*gZuR*(4*mmv^4 + 2*(-3 + d)*mm^2*s - 
           12*s^2 + 7*d*s^2 - d^2*s^2 + 2*mmv^2*((12 - 7*d + d^2)*s - 4*t) - 
           14*s*t + 12*d*s*t - 2*d^2*s*t + 4*t^2) + 
         gZlL*gZuL*(4*mmv^4 + 2*(-3 + d)*mm^2*s + 6*s^2 - 5*d*s^2 + d^2*s^2 + 
           22*s*t - 12*d*s*t + 2*d^2*s*t + 4*t^2 - 
           2*mmv^2*((6 - 5*d + d^2)*s + 4*t)) + gZlR*gZuR*
          (4*mmv^4 + 2*(-3 + d)*mm^2*s + 6*s^2 - 5*d*s^2 + d^2*s^2 + 22*s*t - 
           12*d*s*t + 2*d^2*s*t + 4*t^2 - 2*mmv^2*((6 - 5*d + d^2)*s + 4*t)))*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gWWZZ*(gZlR*gZuL*(4*mm^2 + 2*(-5 + d)*mmv^2 + 
  ...
  PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]]]*
   (((-I)*2^(1 - d)*EL^6*gAl*gAu*gWWZZ*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gWWZZ*((-2 + d)*gZlL*gZuL - 
      ...
      (mmv^2 - t)*(-1 + GaugeXi[Q])*SPList[SP[p2, q1], SP[p2, q1]])/
     (mw^2*Pi^d*(mz^2 - s)^2*s*GaugeXi[Q]) + 
    (I*2^(2 - d)*EL^6*gAl*gAu*gWWZZ*(gZlR*gZuL*(-2*mmv^2 + (-4 + d)*s + 
