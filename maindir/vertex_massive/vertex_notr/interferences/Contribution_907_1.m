...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mh], 
  ...
  (-((EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(mm^2*(4*psq + 3*s - 6*d*s) + 
       s*((-11 + 5*d)*psq - 3*d*s))*\[Mu]^(8 - 2*d))/(mh^2*(2*Pi)^(2*d))) - 
   (2^(1 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(2*mm^2 - 2*psq + (6 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(mh^2*Pi^(2*d)) - 
   (2^(1 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*((-3 + 4*d)*mm^2 + 
      (7 - 2*d)*psq + 6*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   ...
   (2^(1 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(2*mm^2 + d*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(mh^2*Pi^(2*d)) + 
   (EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(8*mm^2 - 4*psq + (4 + d)*s)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p2]])/(mh^2*Pi^(2*d)) + 
   (3*2^(3 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q1]])/(mh^2*Pi^(2*d)) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q2]])/(mh^2*Pi^(2*d)) - 
   (4^(2 - d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(mm^2 - psq + (-2 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(mh^2*Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*(mm^2 - psq + (-2 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)*s) - 
   (3*2^(3 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/(mh^2*Pi^(2*d)) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(mh^2*Pi^(2*d)) + 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
