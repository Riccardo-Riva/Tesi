...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(1 - 4*d)*EL^5*gAl^3*mm^2*s*
      (aa*(2*Pi)^(2*d)*((-2 + d)*gZlL^2*(mm^2 - psq)*(2*psq - s) + 
   ...
   (2^(1 - 4*d)*EL^5*gAl^3*
     (aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*s*((4 - 6*d + d^2)*mm^2 - 
           (20 - 22*d + d^2)*psq - 4*(-1 + d)*s)) + (-2 + d)*gZlL^2*
         (2*Pi)^(2*d)*(mm^4*((4 + d)*psq - 2*s) + 
      ...
      bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*s*((4 - 8*d + d^2)*mm^2 - 
          (-12 + 8*d + d^2)*psq + 4*(-1 + d)*s) + (-2 + d)*gZlL^2*
         (2*Pi)^(2*d)*(mm^4*((4 + d)*psq - 2*s) + psq*((-4 + d)*psq - 2*s)*
           s - mm^2*(d*psq*(psq + s) - 2*s*(psq + 2*s))) + 
        (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^4*((4 + d)*psq - 2*s) + 
      ...
      aa*(d^2*(2*Pi)^(2*d)*(gZlL^2*psq*(-mm^2 + psq) + 
        ...
        4^(1 + d)*Pi^(2*d)*(gZlL^2*(2*psq^2 + mm^2*s - psq*s) + 
         ...
         (gZlL^2*(mm^2*(psq - s) + psq*(-3*psq + s)) + 
          ...
          2*gZlL*gZlR*((psq - 2*s)*s + mm^2*(-6*psq + 3*s)))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(4*d) + 
   (2^(1 - 4*d)*EL^5*gAl^3*s*(-(2^(1 + 2*d)*aa*Pi^(2*d)*
   ...
   (2^(1 - 4*d)*EL^5*gAl^3*mm^2*s*(2^(1 + 2*d)*aa*Pi^(2*d)*
       ((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
        gZlL*gZlR*(8*mm^2 + (4 - 2*d + d^2)*psq - (8 - 6*d + d^2)*s)) + 
      bb*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-6 + d)*mm^2 - (-4 + d)*psq) + 
   ...
   (2^(1 - 4*d)*EL^5*gAl^3*s*
     (bb*(4^d*gZlL*gZlR*mm^2*Pi^(2*d)*((-2 + d)^2*mm^2 + 
   ...
   (EL^5*gAl^3*mm^2*(bb*((8 - 6*d + d^2)*gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq) + 
   ...
   (4^(1 - d)*EL^5*gAl^3*(aa*(d^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*psq - 
        8*(gZlL^2 + gZlR^2)*psq*(psq - s) - 
        2*d*(2*gZlL*gZlR*mm^2*(-4*psq + s) + gZlL^2*psq*(mm^2 - 3*psq + 
            2*s) + gZlR^2*psq*(mm^2 - 3*psq + 2*s))) + 
   ...
   (4^(1 - d)*EL^5*gAl^3*
     (aa*(-((-2 + d)*gZlL^2*psq*((-4 + d)*mm^2 - (-2 + d)*s)) - 
      ...
      bb*mm^2*((-2 + d)*gZlL^2*((-4 + d)*mm^2 - (-2 + d)*s) + 
        ...
        2*gZlL*gZlR*((4 - 6*d + d^2)*mm^2 - (-2 + d)*(-2*psq + 3*d*psq + 
            2*s - d*s))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    Pi^(2*d) + (4^(1 - d)*EL^5*gAl^3*(bb*d^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
       s + 8*bb*(gZlL^2 + gZlR^2)*(3*mm^2 - psq)*s - 
      4*aa*(gZlL^2 + gZlR^2)*(mm^2 + 3*psq)*s - 
      2*bb*d*(-2*gZlL*gZlR*mm^2*(mm^2 + 3*psq - s) + gZlL^2*(7*mm^2 - 3*psq)*
         s + gZlR^2*(7*mm^2 - 3*psq)*s) + 
      2*aa*d*(-2*gZlL*gZlR*mm^2*(mm^2 + 3*psq - s) + gZlL^2*(mm^2 + 3*psq)*
         s + gZlR^2*(mm^2 + 3*psq)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (2^(1 - 4*d)*EL^5*gAl^3*(aa*(2*Pi)^(2*d)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
     (bb*psq*(-4*psq + d*(-mm^2 + psq)) + aa*(d*(mm^2 - psq)*psq + 4*psq^2 - 
        2*mm^2*s + 2*psq*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
     (bb*(-4 + d)*mm^2 - 2*aa*psq - bb*(-6 + d)*psq)*s*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ...
    Pi^(2*d) + (2^(1 - 4*d)*EL^5*gAl^3*(2^(1 + 2*d)*aa*Pi^(2*d)*
       (-((12 - 6*d + d^2)*gZlL*gZlR*mm^2) + (-2 + d)*gZlL^2*psq + 
        (-2 + d)*gZlR^2*psq) - bb*(2*Pi)^(2*d)*
