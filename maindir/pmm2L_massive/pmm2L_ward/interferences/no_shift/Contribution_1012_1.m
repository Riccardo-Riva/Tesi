...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*EL^5*gAl*gHZZ^2*mm^2*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
   ...
   (I*EL^5*gAl*gHZZ^2*(-2*aa*(gZlL^2 + gZlR^2)*s*(2*mm^2 - 3*psq + s + t) + 
   ...
   (I*EL^5*gAl*gHZZ^2*(2*bb*(gZlL^2 + gZlR^2)*s*(2*mm^2 - psq - t) - 
    ...
    (2*Pi)^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHZZ^2*(gZlL^2 + gZlR^2)*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2*Pi)^(2*d) - 
   (I*(aa + bb)*(-2 + d)*EL^5*gAl*gHZZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
