...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mz], 
 ...
 ((I*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*s*
    (aa*(3*psq - s - 3*t) + bb*(-3*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d))/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
    (-2*bb*mm^2*(psq - t) + 2*aa*mm^2*(psq + s - t) + 
     aa*s*(-5*psq + s + 3*t) - bb*s*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*s*
  ...
  (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
  ...
  (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*(psq - s - t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*(psq - t)*
  ...
  (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q2]])/(4^d*Pi^(2*d)) + 
  ((3*I)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + ((3*I)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p2, q2]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p1, q2]])/(4^d*Pi^(2*d)) - ((3*I)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*
    gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, p3]])/(4^d*Pi^(2*d)) - ((3*I)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*
    gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, q2]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
    ...
    gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p2, p3]])/(4^d*Pi^(2*d)) + ((3*I)*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*
    gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p2, q1]])/(4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
    ...
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, p3]])/(4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, q2]])/(4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggmgmZ*gXgmgm*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p2, p3]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ*
