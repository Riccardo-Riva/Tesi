...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*d*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^4*
     (2*(-1 + d)*mm^4 + s*(-2*(-3 + d)*psq + (-2 + d)*s) + 
      mm^2*(-2*(-3 + d)*psq + (-8 + 7*d)*s))*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
   (4^(1 - d)*d*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^4*((-4 + d)*mm^2 - 
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     ...
     SPList[SP[p1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*d*EL^6*gAl^2*gHll^2*gZlL*
     gZlR*mm^4*(3*mm^2 + (-1 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   ...
   (2^(3 - 2*d)*d*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^4*(2*mm^2 - 2*psq + d*s)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    Pi^(2*d) + (4^(1 - d)*d^2*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^4*
   ...
   (2^(5 - 2*d)*d*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^4*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAl^2*gHll^2*(gZlL^2 + gZlR^2)*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/
    Pi^(2*d) + (4^(2 - d)*(-2 + d)*EL^6*gAl^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*(-2 + d)*d*EL^6*gAl^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
