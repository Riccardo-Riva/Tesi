...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*psq*
       (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
      Pi^(2*d)) + (2^(3 - 2*d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*psq*
     ...
     Pi^(2*d) - (4^(1 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*psq*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*psq*(psq - t)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*
      mm^2*(2*(-2 + d)*mm^2*psq + (10 - 3*d)*psq^2 + (-2 + d)*psq*s + 
       (-10 + d)*psq*t + 4*t*(s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
    (2^(3 - 2*d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q1]])/Pi^(2*d) - (4^(1 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*
      gWWA*mm^2*psq*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*
      mm^2*(2*(-2 + d)*mm^2*(psq - t)^2 + s*(-((-6 + d)*psq^2) + 
         (-10 + d)*psq*t + 4*t*(s + t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*((2 + d)*psq^2 - 
       (6 + d)*psq*t + 4*t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
      ...
      gWNl*gWWA*mm^2*(mm^2*(psq - t) + psq*(psq - s - t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*(psq - t)^2*
     ...
     Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAu*gFll^2*gWlN*gWNl*gWWA*mm^2*
