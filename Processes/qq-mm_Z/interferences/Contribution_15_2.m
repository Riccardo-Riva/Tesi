...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   ((I*EL^6*gAl*gAu*t*(gZlL*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 
        ...
        (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
           ...
           4*t^2)))*SPList[SP[q1, q1]])/(mz^2*(2*Pi)^d*(mzC^2 - s)) - 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mz], 
   ...
   ((I*EL^6*gAl*gAu*(gZlR*gZlRC*(gZuR*gZuRC*(d^3*(2*Pi)^d*s*(s + 3*t) + 
    ...
    (I*EL^6*gAl*gAu*
      (((2*Pi)^d*t*(gZlL*gZlLC*(-(gZuR*gZuRC*((8 - 6*d + d^2)*s^2 + 2*
           ...
           (-(gZuL*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*
              ...
              4*t^2))))/mz^2 + gZlR*gZlRC*
        (gZuR*gZuRC*(d^3*(2*Pi)^d*s^2 - 2^(2 + d)*Pi^d*
            ((-2 - 3*d + 2*d^2)*s^2 + (-38 + 22*d - 3*d^2)*s*t - 
             2*(8 - 6*d + d^2)*t^2)) + gZuL*gZuLC*(-(d^3*(2*Pi)^d*s^2) + 
        ...
        (gZuL*gZuLC*(d^3*(2*Pi)^d*s^2 - 2^(2 + d)*Pi^d*
           ...
           2^(1 + d)*Pi^d*((4 - 9*d + 4*d^2)*s^2 - 2*(40 - 22*d + 3*d^2)*s*
              t - 4*(10 - 6*d + d^2)*t^2))))*SPList[SP[q1, q1]])/
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mz], 
   ...
   ((I*EL^6*gAl*gAu*t*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
        ...
        (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
             (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
      (-1 + GaugeXi[Q])*SPList[SP[q1, q1]])/((2*Pi)^(2*d)*(mzC^2 - s)) - 
    (I*EL^6*gAl*gAu*
