...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
 ...
 (((aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZlR*gZNL*mm^2*(4*psq - s)*s^2*
    \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + ((-aa + bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*
    gZlR*gZNL*mm^2*((10 + d)*psq - 4*s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (2*Pi)^(2*d) + ((-2 + d)*EL^5*gWlN*gWNl*gWWA*gZNL*
  ...
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZlR*gZNL*mm^2*
   ...
   Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZNL*
    (bb*((-6 + d)*gZlR*mm^2*psq + (-4 + d)*gZlL*(psq^2 + mm^2*(psq - 2*s))) - 
     aa*psq*((-6 + d)*gZlR*mm^2 + (-4 + d)*gZlL*(mm^2 + psq - 2*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZlR*gZNL*mm^2*
    (2*(-2 + d)*psq - (-4 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  ((-2 + d)*EL^5*gWlN*gWNl*gWWA*gZNL*(bb*gZlL*(4*(-6 + d)*mm^2 + d*psq)*s - 
     aa*gZlL*(-24*psq + d*(mm^2 + 4*psq))*s + 
  ...
  ((2 - d)*EL^5*gWlN*gWNl*gWWA*gZNL*(aa*((-4 + d)*gZlL + (-6 + d)*gZlR)*
      mm^2 - bb*((-6 + d)*gZlR*mm^2 + (-4 + d)*gZlL*psq))*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*(bb*mm^2 - aa*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  ((8 - 6*d + d^2)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*(bb*mm^2 - aa*psq)*s*
  ...
  (4^(1 - d)*(8 - 6*d + d^2)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*(bb*mm^2 - aa*psq)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gZlL*gZNL*(bb*mm^2 - aa*psq)*
