...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((-3*2^(1 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*(gZlL + gZlR)*
  ...
  (4^(1 - d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*(gZlL + gZlR)*t*
  ...
  (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*(gZlL + gZlR)*t*
