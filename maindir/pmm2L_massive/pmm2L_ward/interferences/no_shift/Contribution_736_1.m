...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*2^(1 - 2*d)*d*EL^5*gAl^5*mm^2*(mm^2 - psq)*s*
     ...
     (aa*(-2 + d)*(-(mm^4*(2*Pi)^(2*d)*((2 + d)*psq + (-6 + d)*s - 
      ...
      bb*((-4 + d^2)*mm^4*(2*Pi)^(2*d)*(psq - s - t) - 2^(1 + 2*d)*(-2 + d)*
        ...
        (-2 + d)*(2*Pi)^(2*d)*psq*((-2 + d)*psq^2 + 2*s*(s + t) - 
          psq*((4 + d)*s + (-2 + d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    Pi^(4*d) + (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^5*mm^2*
     (-((-4 + d)*psq^2) + (-8 + d)*psq*s + (-4 + d)*psq*t + 2*s*(s + 2*t) + 
      mm^2*((4 + d)*psq - 4*t - d*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) - 
   (I*2^(1 - 4*d)*EL^5*gAl^5*(aa*(-((-4 + d^2)*mm^4*(2*Pi)^(2*d)*(psq - t)) - 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*((-2 + d)*mm^2 - 
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)^2*EL^5*gAl^5*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*((-2 + d)*psq - 2*s - 
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl^5*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*((-2 + d)*psq - (-4 + d)*s - 
      (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl^5*
