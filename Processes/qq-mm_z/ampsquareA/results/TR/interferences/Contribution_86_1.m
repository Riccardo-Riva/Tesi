...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
   ...
   ((I*2^(2 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*(3*d^2*gZlL*(2*Pi)^d*s^2 - 
       3*d^2*gZlR*(2*Pi)^d*s^2 + 2^(1 + d)*gZlR*Pi^d*((-4 + 3*d + d^2)*s^2 - 
         (4 - 5*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZlL*Pi^d*
        (-((-2 + 2*d + d^2)*s^2) + (8 - 5*d + d^2)*s*t + 2*t^2))*CKM[1, 1]*
      CKMC[1, 1]*SPList[SP[p2, q1], SP[q1, q1]])/(mw^2*Pi^(2*d)*s*
      (-mz^2 + s)) - (I*EL^6*gAl*gAu*gWdu*gWud*gZdL*(d^2*gZlL*(2*Pi)^d*s^2 - 
       d^2*gZlR*(2*Pi)^d*s^2 + 2^(1 + d)*gZlR*Pi^d*((-4 + 3*d)*s^2 - 
         (4 - 5*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZlL*Pi^d*
        (-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))*CKM[1, 1]*CKMC[1, 1]*
  ...
  PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
      ...
      gZdL*((8 - 6*d + d^2)*gZlL*(s + 2*t) - 
       gZlR*((-4 + d)^2*s + 2*(10 - 6*d + d^2)*t))*CKM[1, 1]*CKMC[1, 1]*
      SPList[SP[p1, q1]])/(Pi^d*(mz^2 - s)) + 
    (I*2^(2 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*((-2 + d)^2*gZlL*s + 
       2*(10 - 6*d + d^2)*gZlL*t - (8 - 6*d + d^2)*gZlR*(s + 2*t))*CKM[1, 1]*
      CKMC[1, 1]*SPList[SP[p2, q1]])/(Pi^d*(mz^2 - s)) - 
    (I*2^(3 - d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*((-2 + d)*gZlL*s - 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*(3*d^2*gZlL*(2*Pi)^d*s^2 - 
       3*d^2*gZlR*(2*Pi)^d*s^2 + 2^(1 + d)*gZlR*Pi^d*((-4 + 3*d + d^2)*s^2 - 
        ...
        (-((-2 + 2*d + d^2)*s^2) + (8 - 5*d + d^2)*s*t + 2*t^2))*CKM[1, 1]*
      CKMC[1, 1]*SPList[SP[p2, q1], SP[q1, q1]])/(mw^2*Pi^(2*d)*s*
      (-mz^2 + s)) - (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu*gWdu*gWud*gZdL*
