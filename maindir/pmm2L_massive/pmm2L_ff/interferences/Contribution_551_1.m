...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((4^(1 - d)*EL^6*gAu*ggmgmAZ*ggmgmZ*gZlL*gZlR*mm^2*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s) + 
    (2^(1 - 2*d)*EL^6*gAu*ggmgmAZ*ggmgmZ*
    ...
    (2^(1 - 2*d)*EL^6*gAu*ggmgmAZ*ggmgmZ*
     ...
     Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAu*ggmgmAZ*ggmgmZ*(gZlL^2 + gZlR^2)*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
     (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAu*ggmgmAZ*ggmgmZ*(gZlL^2 + gZlR^2)*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
    ...
    (4^(1 - d)*EL^6*gAu*ggmgmAZ*ggmgmZ*(gZlL^2 + gZlR^2)*(psq - t)*
