...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((2^(1 - 2*d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^4*(4*psq - s)*s*
   ...
   ((aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*psq*(4*psq - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2*Pi)^(2*d) - 
   ((aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(mm^2 - psq)*(4*psq - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
   (4^(1 - d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(bb*mm^2 - aa*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(aa*psq*(8*mm^2 + 3*s) - 
      bb*(psq*s + 2*mm^2*(4*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*psq*(4*psq - s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(aa*mm^2*(4*psq - s) + 
   ...
   (4^(1 - d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(-(bb*(3*mm^2 + psq)) + 
    ...
    Pi^(2*d) + (2^(3 - 2*d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*
     ...
     (-(bb*(4*mm^2 + psq)) + aa*(2*mm^2 + 3*psq))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*(-(bb*(3*mm^2 + psq)) + 
      aa*(mm^2 + 3*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q2]])/Pi^(2*d) + (4^(1 - d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^5*gFll*gWNl*gWWA*gXFW*gXll*mm^2*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q2, q2]])/Pi^(2*d) - (4^(2 - d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*
     gXll*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p2, q2]])/Pi^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*
     gXll*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q2, q2]])/Pi^(2*d) - (4^(2 - d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*
     gXll*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p2, q2]])/Pi^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*
     gXll*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q1]])/Pi^(2*d) + (2^(3 - 2*d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*
     gXll*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(aa - bb)*EL^5*gFll*gWNl*gWWA*gXFW*
     gXll*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q2, q2]])/Pi^(2*d)))/2
