...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
   ...
   (((-I)*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*(mm^4 - psq^2)*
    ...
    (I*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*(mm^4 - psq^2)*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
    (I*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*(mm^4 - psq^2)*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
    (I*(aa + bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*(mm^3 - mm*psq)^2*s*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^4*(psq - s - t)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
      (aa*(psq - t) + bb*(psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*
      gWNl*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
     Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 + psq)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 + 2*psq)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - s - t)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*
      (mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWNl*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWNl*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*(psq - t)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWNl*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      gHll*gWNl*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
