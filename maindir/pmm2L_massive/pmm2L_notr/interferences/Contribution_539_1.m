...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((EL^8*gAl^3*gAu^2*gFFA*gFFAA*mm^2*(4*psq^2 + (-2 + d)*s^2 + 4*s*t + 4*t^2 - 
     8*psq*(s + t))*\[Mu]^(8 - 2*d))/((2*Pi)^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*mm^2*(2*psq + (-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFFA*gFFAA*(mm^2 - psq)*
