...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mh], 
  ...
  (-((2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s*
      (aa*(4*mm^2*psq + s^2) - bb*(mm^2*(4*psq - 2*s) + s*(2*psq + s)))*
      \[Mu]^(8 - 2*d))/(mh^2*Pi^(2*d))) + 
   ((aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s*(psq + s)*\[Mu]^(8 - 2*d)*
   ...
   ((aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*psq*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(mh^2*(2*Pi)^(2*d)) - 
   (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s^2*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(mh^2*Pi^(2*d)) - 
   (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(4*psq - s)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(mh^2*Pi^(2*d)) - 
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(mm^2 + psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(mh^2*Pi^(2*d)) - 
   ((aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q2]])/(mh^2*(2*Pi)^(2*d)) + 
   ((aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[q1, q1]])/(mh^2*(2*Pi)^(2*d)) - 
   (2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
     (-3*bb*psq + aa*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(mh^2*Pi^(2*d)) - 
   (EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(aa*(2*mm^2 + s) - bb*(2*psq + s))*
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*psq*
   ...
   ((aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(-2*psq + s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(mh^2*(2*Pi)^(2*d)) + 
   ((-aa + bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q1]])/(mh^2*(2*Pi)^(2*d)) + 
   ((-aa + bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s*\[Mu]^(8 - 2*d)*
