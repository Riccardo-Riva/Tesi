...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p2 + q1, mh], 
  ...
  (-((EL^6*gAl*gFZW*gHFAW*gHll*(gZlL + gZlR)*mm^2*(2*(-1 + d)*mm^2 - 
       2*(-3 + d)*psq + (-2 + d)*s)*sw*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gFZW*gHFAW*gHll*(gZlL + gZlR)*mm^2*sw*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl*gFZW*gHFAW*gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*
