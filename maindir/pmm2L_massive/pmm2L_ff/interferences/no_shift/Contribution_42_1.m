...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
     (gZlL*mm^2*(2*psq^2 - 5*psq*s + 3*s^2 - 4*psq*t + 5*s*t + 2*t^2) + 
      gZlR*(2*mm^4*(psq - s - t) - mm^2*(15*psq^2 - 13*psq*s + 4*s^2 - 
          22*psq*t + 11*s*t + 7*t^2) + 3*psq*(5*psq^2 + s^2 + 4*s*t + 3*t^2 - 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(4*mm^2 - 6*psq + s + 2*t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(2*gZlL*mm^2 - gZlR*(mm^2 + psq))*
     (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(gZlL*mm^2*(psq - t) + 
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
     (-(gZlL*mm^2*s) + gZlR*(-psq^2 - 3*psq*s + 2*mm^2*(psq - t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(mm^2*(psq - t) + 
      ...
      SP[q2, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(-psq^2 + mm^2*s + 2*psq*t - 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(2*psq^2 - 3*psq*s + s^2 - 
     ...
     mm^2*(-psq^2 + mm^2*s + 2*psq*t - t*(s + t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*(-2*psq + s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
     ...
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*
