...
{0, 0, 0, (I*2^(-2 - d)*EL^6*gAl^2*gAu^2*
  ...
  (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu^2*
   ...
   (mz^2*Pi^(2*d)*(2*mz^2 - 2*s)*s) - 
  ((I/8)*(-2 + d)*EL^6*gAl^2*gAu^2*
    ((3*2^(1 - d)*(gZlL + gZlR)*(gZuL + gZuR)*(mz^2 - s)^2*(-1 + GaugeXi[Q]))/
      (mz^2*Pi^d) - (3*2^(2 - d)*(gZlL + gZlR)*(gZuL + gZuR)*(mz^2 - s)*t*
     ...
     (2^(1 - 2*d)*(gZlL*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
          ...
          2^(1 + d)*gZuL*Pi^d*(2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 
           ...
           s^2 + 2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 
            ...
            (8 - 5*d + d^2)*s*t + 2*t^2)))*(-1 + GaugeXi[Q]))/(Pi^(2*d)*s) + 
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
         ...
         gZlR*(d*gZuR*(2*Pi)^d*s*(s - 3*t) - 2^(1 + d)*gZuR*Pi^d*(s - t)*
            ((-1 + d)*s - t) + gZuL*(-(d*(2*Pi)^d*s*(s - 3*t)) + 
             2^(1 + d)*Pi^d*((-2 + d)*s^2 - (3 + d)*s*t - t^2))))*
        GaugeXi[Q]^2)/(mz^2*(2*Pi)^(2*d)*(-1 + GaugeXi[Q]))))/(mz^2 - s)^2, 
       ...
       (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
         ...
         gZlR*(d*gZuR*(2*Pi)^d*s*(s - 3*t) - 2^(1 + d)*gZuR*Pi^d*(s - t)*
            ((-1 + d)*s - t) + gZuL*(-(d*(2*Pi)^d*s*(s - 3*t)) + 
             2^(1 + d)*Pi^d*((-2 + d)*s^2 - (3 + d)*s*t - t^2))))*
        GaugeXi[Q]^2)/(mz^2*(2*Pi)^(2*d)*(-1 + GaugeXi[Q]))))/(mz^2 - s)^2, 
 0, 0, (I*2^(-3 - d)*d*EL^6*gAl^2*gAu^2*(gZlL + gZlR)*(gZuL + gZuR)*
    (-1 + GaugeXi[Q]))/(mz^2*Pi^d) - 
  (I*2^(-3 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
     (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*(s + t)*(-1 + GaugeXi[Q]))/
   (mz^2*Pi^d*s) - (I*2^(-4 - d)*EL^6*gAl^2*gAu^2*((-2 + d)*s - 2*t)*
  ...
  (I*2^(-3 - 2*d)*(-2 + d)*EL^6*gAl^2*gAu^2*(-1 + GaugeXi[Q])*
 ...
 ((-I)*EL^6*gAl^2*gAu^2*(gZlL*(-(d^2*gZuL*(2*Pi)^d*s^2) + 
  ...
  (I*2^(-4 - d)*EL^6*gAl^2*gAu^2*(gZlL*gZuL*((-4 + d)*s - 2*t) + 
   ...
   (mz^2*Pi^d*s^2) + (I*2^(-2 - d)*EL^6*gAl^2*gAu^2*(-1 + GaugeXi[Q])*
    (((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
     ...
     mz^2*(gZlL*(2*gZuL*s + 2*gZuR*s + (-2 + d)*gZuL*t - (-4 + d)*gZuR*t) + 
      ...
      GaugeXi[Q]))/(mz^2*Pi^d*s) - (I*2^(-4 - 2*d)*EL^6*gAl^2*gAu^2*
