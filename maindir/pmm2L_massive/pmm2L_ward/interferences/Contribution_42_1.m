...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*
  ...
  (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*(aa*mm^2*(psq - t) + 
  ...
  (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*(bb*(psq - s - t) + 
  ...
  (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(aa*mm^2*(3*psq + s - 3*t) + 
     aa*psq*(psq - s - t) + bb*psq*(-psq - 3*s + t) + 
     3*bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*
    (aa*psq*(psq - s - t) + aa*mm^2*(psq + s - t) - bb*psq*(psq + s - t) + 
     bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*
    (aa*gZlL*mm^2*(psq - s - t) - bb*(gZlL*mm^2 + gZlR*psq)*(psq - s - t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 + psq)*(psq - s - t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*
    (bb*gZlR*(mm^2 - 3*psq)*(2*mm^2 - psq - t) + 
     ...
     SP[p2, q2]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 + psq)*(psq - t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa + bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(bb*(psq - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*mm^2*(gZlL*mm^2 + gZlR*psq)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(bb*(2*mm^2 - s - 2*t) + 
     aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(bb*(2*mm^2 - s - 2*t) + 
     aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(bb*(mm^2 - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[p3, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q2, q2]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*mm^2*(gZlL*mm^2 + gZlR*psq)*
  ...
  (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
     aa*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*gZlR*
    mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(bb*(3*mm^2 - psq - s - 2*t) + 
     aa*(3*mm^2 - 5*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(bb*(3*mm^2 - 2*psq - t) + aa*(-psq + t))*
  ...
  (I*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(2*psq - s - 2*t)*
   ...
   Pi^(2*d) - (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(bb*(3*mm^2 - 2*psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) + (I*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
