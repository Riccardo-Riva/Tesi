...
(PropList[KiraPropagator[q1, mz*Sqrt[GaugeXi[Q]]], 
   ...
   ((I*2^(2 - d)*EL^6*gAl*gAu*(-(gZlRC*gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 
      ...
      SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^d*s*(-mzC^2 + s)) + 
    (I*2^(1 - d)*EL^6*gAl*gAu*(-(gZlRC*gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 
          2*(4 - 5*d + d^2)*s*t - 4*t^2)) - gZlLC*gZuR^2*gZuRC*
        ((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) + 
       gZlLC*gZuL^2*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
       gZlRC*gZuR^2*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
      SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^d*s*(-mzC^2 + s)) - 
    (I*2^(1 - d)*EL^6*gAl*gAu*(-(gZlRC*gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 
          2*(4 - 5*d + d^2)*s*t - 4*t^2)) - gZlLC*gZuR^2*gZuRC*
        ((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) + 
       gZlLC*gZuL^2*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
    ...
    (I*EL^6*gAl*gAu*(-(gZlRC*gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 
       ...
       gZlLC*gZuL^2*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
       gZlRC*gZuR^2*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
      SPList[SP[q1, q1], SP[q1, q1]])/(mz^2*(2*Pi)^d*s*(-mzC^2 + s))) + 
  PropList[KiraPropagator[q1, mz], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*2^(1 - d)*EL^6*gAl*gAu*
      (-(gZlRC*gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
       ...
       gZlRC*gZuR^2*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2)))/
     (Pi^d*(mzC^2 - s)) - (I*2^(2 - d)*EL^6*gAl*gAu*
      ((8 - 6*d + d^2)*gZlLC*gZuL^2*gZuLC*(s + 2*t) + (8 - 6*d + d^2)*gZlRC*
        gZuR^2*gZuRC*(s + 2*t) - gZlRC*gZuL^2*gZuLC*((-4 + d)^2*s + 
         ...
         2*(10 - 6*d + d^2)*t))*SPList[SP[p1, q1]])/(Pi^d*(mzC^2 - s)) + 
    ...
    (I*(-2 + d)*EL^6*gAl*gAu*(-(gZlRC*gZuL^2*gZuLC*((-4 + d)^2*s^2 + 
       ...
       gZlLC*gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(14 - 7*d + d^2)*s*t + 
         ...
         2*(14 - 7*d + d^2)*s*t + 4*t^2))*SPList[SP[q1, q1]])/
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*(-(gZlRC*gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 
       ...
       gZlRC*gZuR^2*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
      SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*Pi^d*s*(-mzC^2 + s)) - 
    (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gAu*((-2 + d)*gZlLC*gZuL^2*gZuLC - 
       (-4 + d)*gZlRC*gZuL^2*gZuLC - (-4 + d)*gZlLC*gZuR^2*gZuRC + 
       (-2 + d)*gZlRC*gZuR^2*gZuRC)*t*SPList[SP[p2, q1], SP[p2, q1]])/
     (Pi^d*s*(-mzC^2 + s)) + (I*2^(2 - d)*(-2 + d)*EL^6*gAl*gAu*
      (gZlLC*(gZuL^2*gZuLC*((-2 + d)*s - 2*t) - gZuR^2*gZuRC*
          ((-4 + d)*s + 2*t)) - gZlRC*(gZuL^2*gZuLC*((-4 + d)*s + 2*t) + 
         gZuR^2*gZuRC*(-((-2 + d)*s) + 2*t)))*SPList[SP[p2, q1], SP[p3, q1]])/
     (Pi^d*(mzC^2 - s)*s) + (I*2^(1 - d)*EL^6*gAl*gAu*
      (-(gZlRC*gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 
          4*t^2)) - gZlLC*gZuR^2*gZuRC*((8 - 6*d + d^2)*s^2 + 
         2*(4 - 5*d + d^2)*s*t - 4*t^2) + gZlLC*gZuL^2*gZuLC*
        ((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
       gZlRC*gZuR^2*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
      SPList[SP[p2, q1], SP[q1, q1]])/(mz^2*Pi^d*s*(-mzC^2 + s)) - 
    (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu*(gZlLC + gZlRC)*
      (gZuL^2*gZuLC + gZuR^2*gZuRC)*SPList[SP[p3, q1], SP[p3, q1]])/
     (Pi^d*(mzC^2 - s)) + 
    (I*EL^6*gAl*gAu*(-(gZlRC*gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 
          2*(4 - 5*d + d^2)*s*t - 4*t^2)) - gZlLC*gZuR^2*gZuRC*
        ((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) + 
       gZlLC*gZuL^2*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
       gZlRC*gZuR^2*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
      SPList[SP[q1, q1], SP[q1, q1]])/(mz^2*(2*Pi)^d*s*(-mzC^2 + s))))/4
