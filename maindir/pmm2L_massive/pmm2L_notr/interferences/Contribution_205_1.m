...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
 ...
 (-((4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*psq*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*psq*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*psq*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2*(2*psq - s) + 
     2*psq*(-psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(4^d*Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*
    (gZlL + gZlR)*(mm^2 - 2*psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*
    (2*psq*(2*psq - s - t) + mm^2*(-3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - 2*psq)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*
    (-2*psq*t + mm^2*(psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*psq*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*(mm^2 - 2*psq)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gFFZ*(gZlL + gZlR)*
    (mm^2 - 2*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
