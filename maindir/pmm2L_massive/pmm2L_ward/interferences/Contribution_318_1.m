...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^6*s*
    (bb*(mm^4 + mm^2*(2*psq - 2*s - 3*t) + psq*(psq - t)) + 
     aa*(mm^4 + psq*(-psq + s + t) + mm^2*(-4*psq + s + 3*t)))*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^6*
    (aa*(4*psq^2 + 2*mm^2*(4*psq - 5*s - 4*t) + 2*psq*(5*s - 2*t) - 
       3*s*(s + 2*t)) + bb*(-4*psq^2 - 2*mm^2*(4*psq + s - 4*t) + 
       2*psq*(s + 2*t) + 3*s*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^6*
    (aa*(2*psq^2 + 3*psq*s + 2*s^2 + mm^2*(4*psq - 6*s - 4*t) - 2*psq*t - 
       s*t) + bb*(-2*psq^2 + 7*psq*s - 2*s^2 - 4*mm^2*(psq + s - t) + 
       2*psq*t + s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (aa*(mm^4*(5*psq - 4*s - 5*t) + psq*s*(2*psq - s - 2*t) + 
       mm^2*(-psq^2 - 14*psq*s + 9*s^2 + psq*t + 14*s*t)) + 
     bb*(-5*mm^4*(psq - t) + 2*psq*s*(-2*psq + 2*s + t) + 
       mm^2*(psq^2 + psq*(20*s - t) - 2*s*(6*s + 7*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^6*
    (aa*(2*psq^2 + 5*psq*s + s^2 + mm^2*(4*psq - 6*s - 4*t) - 2*psq*t - 
       3*s*t) - bb*(2*psq^2 - 5*psq*s + s^2 + 4*mm^2*(psq + s - t) - 
       2*psq*t - 3*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^6*
    (aa*(2*psq^2 + psq*(7*s - 2*t) + 4*mm^2*(psq - 2*s - t) - s*(3*s + t)) + 
     bb*(-2*psq^2 - 2*mm^2*(2*psq + s - 2*t) + s*(3*s + t) + 
       psq*(3*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (bb*(psq*s*(-2*psq + s + 2*t) + mm^4*(-5*psq + s + 5*t) + 
       mm^2*(psq^2 + 13*psq*s - 5*s^2 - psq*t - 14*s*t)) + 
     aa*(5*mm^4*(psq - s - t) + 2*psq*s*(s - t) + 
       mm^2*(-psq^2 + psq*(-7*s + t) + 2*s*(s + 7*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^6*
    (aa*(2*psq^2 + 9*psq*s - 4*s^2 + 4*mm^2*(psq - 2*s - t) - 2*psq*t - 
       3*s*t) + bb*(-2*psq^2 + psq*s + 4*s^2 - 2*mm^2*(2*psq + s - 2*t) + 
       2*psq*t + 3*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^6*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*s*(aa*mm^2*(11*psq - 5*s - 11*t) + 
     bb*psq*(3*psq - 2*s - 3*t) + aa*psq*(-3*psq + s + 3*t) + 
     bb*mm^2*(-11*psq + 6*s + 11*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^6*s*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*s*
    (aa*(mm^4 + 2*psq*(-psq + s + t) + mm^2*(-3*psq + 2*t)) + 
     bb*(mm^4 + 2*psq*(psq - t) + mm^2*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*s*
    (bb*(mm^4 + mm^2*(6*psq - 5*s - 7*t) + psq*(psq + s - t)) + 
     aa*(mm^4 + psq*(-psq + 2*s + t) + mm^2*(-8*psq + 2*s + 7*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^6*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^6*(bb*(4*mm^2 - 2*psq - s - 2*t) + 
     aa*(4*mm^2 - 6*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(4*mm^2 - 5*s - 4*t) + 
     bb*(12*mm^2 - 16*psq + 5*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(mm^4 + 2*psq^2 + 4*s*(s + t) - 
       psq*(5*s + 2*t) + mm^2*(-17*psq + 3*s + 16*t)) - 
     bb*(9*mm^4 + 6*psq^2 + 4*s*(s + t) - psq*(15*s + 2*t) + 
       mm^2*(-29*psq + 13*s + 16*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(4*mm^2 - 4*psq - 3*s) + 
     3*bb*(4*mm^2 - 4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(12*mm^2 - 8*psq + s - 4*t) + 
     bb*(4*mm^2 - 8*psq - s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^4*(bb*(mm^4 - 2*psq^2 + 5*psq*s + 
       mm^2*(15*psq - 13*s - 16*t) + 2*psq*t - 4*s*t) + 
     aa*(-9*mm^4 - 2*psq^2 + 5*psq*s - 2*psq*t + 4*s*t + 
       mm^2*(-3*psq + 3*s + 16*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^6*(bb*(4*mm^2 - 4*psq - 3*s) + 
     3*aa*(4*mm^2 - 4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/
   (4^d*Pi^(2*d)) + (I*EL^5*gAl*gHll^4*mm^4*
    (aa*(-6*psq^2 + 4*mm^2*(5*psq - 2*s - 5*t) - 3*s*(s + 2*t) + 
       psq*(7*s + 6*t)) + bb*(6*psq^2 - 4*mm^2*(5*psq - 3*s - 5*t) + 
       3*s*(s + 2*t) - psq*(11*s + 6*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(2*Pi)^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(2*psq - s - 2*t)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*mm^2*(7*psq - 3*s - 7*t) + 
     aa*psq*(psq - s - t) + bb*psq*(-psq + t) + bb*mm^2*(-7*psq + 4*s + 7*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(3*psq - 2*s - 3*t) + 
     bb*(4*mm^2 - 7*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(5*psq*s + mm^2*(2*psq + s - 2*t) - 
       4*s*(s + t)) + bb*(4*mm^4 + 2*psq^2 - 9*psq*s + 4*s*(s + t) + 
       mm^2*(-8*psq + 3*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(4*psq - 3*s - 4*t) + 
     bb*(8*mm^2 - 12*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(4*mm^2 + 2*psq - 3*s - 6*t) + 
     bb*(4*mm^2 - 10*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(bb*(mm^4 + mm^2*(psq - 8*s - 2*t) + 
       4*s*(psq - t)) + aa*(-5*mm^4 - 2*psq^2 + 4*s*t + 
       mm^2*(5*psq + 4*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^6*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(-3*psq^2 + 6*psq*s - 2*s^2 + 
       5*mm^2*(2*psq - s - 2*t) + 3*psq*t - 5*s*t) + 
     bb*(3*psq^2 - 8*psq*s + 2*s^2 - 3*psq*t + 5*s*t + 
       mm^2*(-10*psq + 7*s + 10*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(4*psq - s - 4*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (bb*(4*psq^2 - 9*psq*s + 2*s^2 + 2*mm^2*(2*psq + s - 2*t) - 4*psq*t + 
     ...
     SP[q1, q1]])/Pi^(2*d) - (I*EL^5*gAl*gHll^4*mm^4*
    (aa*mm^2*(7*psq - 4*s - 7*t) + aa*psq*(psq - t) + bb*psq*(-psq + s + t) + 
     bb*mm^2*(-7*psq + 3*s + 7*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(3*psq*s + 3*mm^2*(psq - t) - 2*s*(s + t)) + 
     bb*(4*mm^4 + 3*mm^2*(-3*psq + s + t) + 2*(psq^2 - 3*psq*s + s*(s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(mm^4 + 4*s*(-psq + s + t) + 
       mm^2*(-3*psq - 6*s + 2*t)) - bb*(5*mm^4 + 2*psq^2 - 8*psq*s + 
       4*s*(s + t) + mm^2*(-9*psq - 2*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(mm^4 + 2*s*(-psq + s + t) + 
       mm^2*(-4*psq - 5*s + 3*t)) - bb*(5*mm^4 + 2*psq^2 - 5*psq*s + 
       2*s*(s + t) + mm^2*(-10*psq - 2*s + 3*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*mm^2*(5*psq - 4*s - 5*t) + 
     bb*psq*(psq - 2*s - t) + aa*psq*(-psq + t) + 
     bb*mm^2*(-5*psq + 6*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^4*(-(bb*(6*mm^2 - psq - 2*s)*(psq - s - t)) + 
     aa*(-psq^2 + mm^2*(6*psq - 5*s - 6*t) + psq*(-2*s + t) + 2*s*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*mm^2*(5*psq - 4*s - 5*t) + 
     bb*psq*(psq - 2*s - t) + aa*psq*(-psq + t) + 
     bb*mm^2*(-5*psq + 6*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(psq - s - t) + bb*(4*mm^2 - 5*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^6*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(bb*(mm^4 + mm^2*(2*psq - 8*s - 3*t) + 
       2*s*(psq - t)) + aa*(-5*mm^4 - 2*psq^2 + psq*s + 2*s*t + 
       mm^2*(4*psq + 5*s + 3*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(4*mm^2 - 2*psq - s - 2*t) + 
     bb*(4*mm^2 - 6*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(-((psq - s)*(3*psq - s - 3*t)) + 
       5*mm^2*(2*psq - s - 2*t)) + bb*(3*psq^2 - 3*psq*(2*s + t) + 
       s*(s + 3*t) + mm^2*(-10*psq + 7*s + 10*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*mm^2*(7*psq - 4*s - 7*t) + aa*psq*(psq - t) + 
     bb*psq*(-psq + s + t) + bb*mm^2*(-7*psq + 3*s + 7*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(4*mm^2 - psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/
   (2*Pi)^(2*d) + (I*EL^5*gAl*gHll^4*mm^4*
    (aa*(4*mm^4 + 2*psq^2 - psq*s + mm^2*(-4*psq + s - 2*t) - 4*s*t) + 
     bb*(-3*psq*s + 4*s*t + mm^2*(-2*psq + 3*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(8*mm^2 - 4*psq - s - 4*t) + 
     bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(-3*psq^2 + 5*psq*s - 3*s^2 + 
       mm^2*(10*psq - 3*s - 10*t) + 3*psq*t - 5*s*t) + 
     bb*(3*psq^2 - 7*psq*s + 3*s^2 - 3*psq*t + 5*s*t + 
       5*mm^2*(-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(4*psq - 3*s - 4*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(4*aa*mm^4 - bb*s*(psq - 2*t) - 
     3*aa*mm^2*(psq + t) + 3*bb*mm^2*(-psq + s + t) + 
     2*aa*(psq^2 - psq*s - s*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*mm^2*(5*psq + s - 5*t) + 
     bb*psq*(psq - s - t) - aa*psq*(psq + s - t) + 
     bb*mm^2*(-5*psq + s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(6*mm^2 - psq - 2*s)*(psq - t) + 
     bb*(psq^2 + psq*s - psq*t - 2*s*t + mm^2*(-6*psq + s + 6*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*mm^2*(5*psq + s - 5*t) + 
     bb*psq*(psq - s - t) - aa*psq*(psq + s - t) + 
     bb*mm^2*(-5*psq + s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^6*(aa*(4*mm^2 - 3*psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl*gHll^4*mm^4*(bb*((psq - s)*(3*psq - 2*s - 3*t) + 
       5*mm^2*(-2*psq + s + 2*t)) + 
     aa*(-3*psq^2 + mm^2*(10*psq - 3*s - 10*t) + 3*psq*(s + t) - 
       s*(2*s + 3*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(4*psq - 3*s - 4*t)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll^4*mm^4*s*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(2*mm^2 + psq - s - t) + 
     bb*(-3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (bb*(2*mm^2 - psq + t) - aa*(psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 + 3*psq - 2*s - 4*t) + 
     bb*(mm^2 - 5*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(3*mm^2 + 5*psq - 4*(s + t)) + 
     bb*(3*mm^2 - 11*psq + 4*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(bb*(-11*mm^2 + 3*psq - 4*t) + 
     aa*(5*mm^2 + 3*psq + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 + 9*psq - 5*(s + 2*t)) + 
     bb*(3*mm^2 - 13*psq + 5*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
     bb*(6*mm^2 - 14*psq + 5*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(3*mm^2 + 3*psq - 2*(s + t)) + 
     bb*(mm^2 - 7*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(11*mm^2 + 5*psq - 4*(s + t)) + 
     bb*(-5*mm^2 - 11*psq + 4*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(11*mm^2 + 3*psq - 2*(s + t)) + 
     bb*(-7*mm^2 - 7*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(bb*(-11*mm^2 + psq - 2*t) + 
     aa*(7*mm^2 + 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 + 5*psq - 3*s - 6*t) + 
     3*bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
     bb*(6*mm^2 - 10*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(3*mm^2 - 3*psq - 4*t) + 
     bb*(3*mm^2 - 3*psq + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p2, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(3*mm^2 + 7*psq - 5*(s + 2*t)) + 
     bb*(mm^2 - 11*psq + 5*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
     bb*(2*mm^2 - 10*psq + 3*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 - 3*psq - 2*t) + 
     bb*(3*mm^2 - psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(3*mm^2 - psq - 2*t) + bb*(mm^2 - 3*psq + 2*t))*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(2*psq - s - 2*t)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(2*aa*(mm^2 + psq) - bb*(3*mm^2 + psq))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(3*psq - 2*s - 3*t) + 
     bb*(mm^2 - 4*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p3, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*bb*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(3*mm^2 + psq) - bb*(mm^2 + 3*psq))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(-2*bb*(mm^2 + psq) + 
     aa*(3*mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(2*aa*(psq - s - t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(-5*aa*mm^2 + 6*bb*mm^2 - 3*aa*psq + 
     2*bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(psq - s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(-2*bb*(mm^2 + psq) + 
     aa*(3*mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, p3]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (-2*bb*(mm^2 + psq) + aa*(3*mm^2 + psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(6*aa*mm^2 - 5*bb*mm^2 + 2*aa*psq - 
     3*bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/
   Pi^(2*d) + (I*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 + psq - 2*(s + t)) + 
     bb*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(2*bb*(-psq + s + t) + 
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 - s - t) + bb*(mm^2 - 2*psq + s + t))*
   ...
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(-psq + s + t)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 + 3*psq - 2*s - 4*t) + 
     bb*(mm^2 - 5*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 - t) + bb*(mm^2 - 2*psq + t))*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 + 2*psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*EL^5*gAl*gHll^4*mm^4*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(mm^2 + psq - 2*t) + 
     ...
     SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
    (aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*(aa*(2*mm^2 + 2*psq - s - 4*t) + 
     bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[p3, q1]])/Pi^(2*d) + (I*EL^5*gAl*gHll^4*mm^4*
  ...
  (I*EL^5*gAl*gHll^4*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(psq - t)*
