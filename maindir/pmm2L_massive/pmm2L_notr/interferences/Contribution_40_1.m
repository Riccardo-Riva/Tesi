...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(6*psq^2 - 2*s^2 + d*s^2 + 2*mm^2*(psq - s - t) + 4*s*t + 
     4*t^2 - 2*psq*((-1 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(6*psq^2 - 2*s^2 + d*s^2 + 2*mm^2*(psq - s - t) + 4*s*t + 
     4*t^2 - 2*psq*((-1 + d)*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (4^d*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(-2*psq^2 + 2*(-2 + d)*psq*s + 2*s^2 - 
     d*s^2 + 2*mm^2*(psq - t) + 6*psq*t - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (-2*psq^2 + 2*(-2 + d)*psq*s + 2*s^2 - d*s^2 + 2*mm^2*(psq - t) + 
     6*psq*t - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (4^d*Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(4*psq^2 + (-4 + d)*mm^2*s - 2*s^2 + 
     d*s^2 + 4*s*t + 4*t^2 - psq*(d*s + 8*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (4*psq^2 + (-4 + d)*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
     psq*(d*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (4^d*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*((-4 + d)*mm^4*s + (-4 + d)*psq^2*s + 
     2*mm^2*(4*psq^2 + (-4 + d)*s^2 + 4*s*t + 4*t^2 - 
       psq*((-4 + d)*s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (d*mm^4*s + psq*(4*psq^2 + (-8 + d)*psq*s + (-2 + d)*s^2 - 8*psq*t + 
       4*s*t + 4*t^2) + mm^2*(4*psq^2 + (-6 + d)*s^2 + 4*s*t + 4*t^2 - 
       2*psq*((-4 + d)*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (4^d*Pi^(2*d)*s^2) + (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(-4*psq^2 + 4*mm^2*s + 2*s^2 - d*s^2 - 
     4*s*t - 4*t^2 + 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(psq*(2*psq + (-4 + d)*s - 2*t) + mm^2*(-2*psq + d*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2*(6*psq + (-8 + d)*s - 6*t) - 3*psq*(2*psq + (-4 + d)*s - 2*t))*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (gZlL - gZlR)*mm^2*((-9 + 2*d)*mm^2 + (7 - 2*d)*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
     mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2*(2*psq + (-16 + 3*d)*s - 2*t) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^4 + 3*(-4 + d)*psq*s - 6*psq*t + 
     mm^2*(-10*psq - (-8 + d)*s + 14*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (12*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 8*psq*(s + 2*t) + 
     mm^2*(-8*psq + 4*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(psq + (-4 + d)*s - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*psq^2 - 2*(-6 + d)*mm^2*s + 2*(-6 + d)*psq*s - 2*s^2 + d*s^2 - 
   ...
   (4^d*Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
