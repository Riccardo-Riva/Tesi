...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
 ...
 ((EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*s*((2 + d)*gZlR*mm^2*(-4*psq + d*s) + 
  ...
  EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*
   ((2^(1 - 2*d)*(4*(-4 + d)*gZlR*mm^2 + (-2 + d)*gZlL*
        ((-5 + d)*mm^2 + 13*psq - d*psq - 5*s))*s)/Pi^(2*d) - 
    (gZlR*mm^2*(-4*(2 + d)*psq + (-20 + 8*d + 3*d^2)*s) + 
      (-2 + d)*gZlL*(-2*(-7 + d)*psq^2 - 2*s^2 - psq*(s + 2*d*s) + 
        mm^2*(2*(-5 + d)*psq - (1 + d)*s)))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, q1]] + (2^(1 - 2*d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*
  ...
  (2^(1 - 2*d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*(6*(-1 + d)*gZlR*mm^2 + 
     gZlL*(-((8 - 6*d + d^2)*mm^2) + (20 - 12*d + d^2)*psq + (4 + d^2)*s))*
