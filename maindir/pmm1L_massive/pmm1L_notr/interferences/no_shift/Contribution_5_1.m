...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*4^(1 - d)*EL^6*gAl^2*gAu^2*(2^(1 + d)*gZlL*gZlR*mm^2*Pi^d*
    ...
    (Pi^(2*d)*s^2) + (I*2^(2 - d)*EL^6*gAl^2*gAu^2*
   ...
   (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(8*d*gZlL*gZlR*mm^2*(psq - t) + 
   ...
   (I*2^(1 - d)*(-2 + d)*EL^6*gAl^2*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^d*s^2) + (I*2^(3 - d)*(-2 + d)*EL^6*gAl^2*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (I*2^(3 - d)*(-2 + d)*EL^6*gAl^2*gAu^2*(gZlL^2 + gZlR^2)*(2*psq + s - 2*t)*
     \[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^d*s^2) + 
   (I*2^(4 - d)*(-2 + d)*EL^6*gAl^2*gAu^2*(gZlL^2 + gZlR^2)*\[Mu]^(4 - d)*
