...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 ((I*4^(-1 - d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*(mm^2 - psq)*s*sw*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
    (aa*(-4*psq^2 + 2*mm^2*(2*psq + s - 2*t) + 4*psq*t - s*(s + 2*t)) + 
     bb*(4*psq^2 - 4*psq*(2*s + t) + s*(s + 2*t) + 
       mm^2*(-4*psq + 6*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*
    gZlL*mm^2*sw*(aa*(-2*psq^2 + 3*psq*s - 2*s^2 + 2*mm^2*(psq - t) + 
       2*psq*t - 3*s*t) + bb*(2*psq^2 - 7*psq*s + 2*s^2 - 2*psq*t + 3*s*t + 
       mm^2*(-2*psq + 4*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   Pi^(2*d) - (I*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*s*sw*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*s*sw*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*
    gZlL*mm^2*sw*(aa*(-2*psq^2 - psq*s + 2*mm^2*(psq + s - t) + 2*psq*t - 
       s*t) + bb*(2*psq^2 - 3*psq*s - 2*psq*t + s*t + 2*mm^2*(-psq + s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*s*sw*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa - bb)*d*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*
    mm^2*s*sw*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*
    sw*(aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
    (aa*(2*mm^2 + 6*psq - 5*s - 8*t) + bb*(6*mm^2 - 14*psq + 5*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*sw*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*sw*
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
    (aa*(6*mm^2 - 2*psq - s - 4*t) + bb*(2*mm^2 - 6*psq + s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*d*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*
    sw*(aa*(3*psq - 2*s - 3*t) + bb*(2*mm^2 - 5*psq + 2*s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*sw*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*sw*
    (psq - 2*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/
   Pi^(2*d) + (I*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
    (aa*(mm^2 + psq - s - 2*t) + bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*
    sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*
    gZlR*mm^2*sw*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*
    gZlR*mm^2*sw*(psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, p3]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*
    gFZW*gWlN*gWWA*gZlR*mm^2*sw*(psq + s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*sw*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*
    sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*
    gZlR*mm^2*sw*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gFll*gFZW*gWlN*
    gWWA*gZlL*mm^2*sw*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlL*mm^2*sw*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*
    sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*
    mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*
    mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/
   Pi^(2*d) + (I*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*sw*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/
   (4^d*Pi^(2*d)) - ((3*I)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*
    mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*gZlR*mm^2*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*
    gWWA*gZlR*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p2, q1]])/Pi^(2*d) + (I*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*
    gWWA*gZlR*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, q2]])/Pi^(2*d) - (I*(aa - bb)*(-4 + d)*EL^5*gFll*gFZW*gWlN*gWWA*
