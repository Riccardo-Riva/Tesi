   ...
   (-((2^(1 - 4*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
      ...
      (4^(1 + d)*gZlL*gZlR*Pi^(2*d)*(s*(4*psq^2 - 3*psq*s + s^2 - 8*psq*t + 
          ...
          (-2*(-2 + d)*psq^3 - 5*psq^2*(s - (-2 + d)*t) + 
           t*(s + t)*((-4 + d)*s + (-2 + d)*t) - psq*(s^2 - 11*s*t + 
             4*(-2 + d)*t^2))) + gZlR^2*(d*(2*Pi)^(2*d)*psq*s*
          (3*psq + s - 7*t) - (-2 + d)*mm^2*(2*Pi)^(2*d)*(2*psq^2 - 5*psq*s + 
           3*s^2 - 4*psq*t + 5*s*t + 2*t^2) + 2^(1 + 2*d)*Pi^(2*d)*
          (-2*(-2 + d)*psq^3 - 5*psq^2*(s - (-2 + d)*t) + 
           t*(s + t)*((-4 + d)*s + (-2 + d)*t) - psq*(s^2 - 11*s*t + 
             4*(-2 + d)*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     (Pi^(4*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
      (-(2^(1 + 2*d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(2*psq^3 + 
          3*psq^2*(s - 2*t) + (s + t)*(mm^2*s + 2*(s - t)*t) - 
          psq*(mm^2*s + s^2 + 3*s*t - 6*t^2))) + 
       d*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 
           4*psq*t + 3*s*t + 2*t^2) + gZlL^2*(2*Pi)^(2*d)*
          (2*psq^3 + psq^2*(s - 6*t) - psq*(mm^2*s + s^2 - s*t - 6*t^2) + 
           (s + t)*(mm^2*s - 2*t^2)) + gZlR^2*(2*Pi)^(2*d)*
          (2*psq^3 + psq^2*(s - 6*t) - psq*(mm^2*s + s^2 - s*t - 6*t^2) + 
     ...
     (Pi^(4*d)*s) + (2^(1 - 4*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
      (gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^2*(2*psq - 3*s - 2*t)*(psq - t) + 
        ...
        (-(d*(psq - t)*(psq^2 - 2*psq*t + t*(s + t) + 
           ...
           psq*(s + 8*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     (Pi^(4*d)*s) + (2^(1 - 4*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
    ...
    (4^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
      ((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(psq - t)*(2*mm^2 - 3*psq + s + t) + 
       ...
       2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(-2*psq + s + 2*t)*
        (2*s + d*(-psq + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     (Pi^(4*d)*s) - (4^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHZZ*mm^2*
