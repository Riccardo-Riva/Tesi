...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)^2*s*
    ...
    Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^4*(aa*psq*(2*psq + (-4 + d)*s - 2*t) + 
      aa*mm^2*(2*psq - (-2 + d)*s - 2*t) + 2*bb*mm^2*(-psq + t) + 
      2*bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
