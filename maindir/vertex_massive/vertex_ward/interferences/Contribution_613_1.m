...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   ((I*(aa - bb)*EL^5*gAl*gFll^2*gHll^2*mm^4*(3*mm^4 - 2*mm^2*psq - psq^2)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gHll^2*mm^4*(mm^2 - psq)*
      (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gHll^2*mm^4*(mm^2 - psq)*
      (bb*(mm^2 - t) + aa*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gHll^2*mm^4*(aa*mm^2*(7*psq - 2*s - 7*t) + 
       aa*psq*(psq - 2*s - t) + bb*psq*(-psq + t) + 
       bb*mm^2*(-7*psq + 4*s + 7*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gFll^2*gHll^2*mm^4*(aa*mm^2*(3*psq - s - 3*t) + 
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll^2*gHll^2*mm^4*(mm^2 + psq)*
     ...
     Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gFll^2*gHll^2*mm^4*(3*mm^2 + psq)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
     (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gHll^2*mm^4*(mm^2 - psq)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll^2*gHll^2*mm^4*(mm^2 + psq)*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
    (I*(aa - bb)*EL^5*gAl*gFll^2*gHll^2*mm^4*(3*mm^2 + psq)*(psq - t)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gFll^2*gHll^2*mm^4*(bb*(mm^2 - t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gFll^2*gHll^2*mm^4*(bb*(mm^2 - s - t) + 
       aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gHll^2*mm^4*(bb*(mm^2 - s - t) + 
       aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (I*4^(1 - d)*EL^5*gAl*gFll^2*gHll^2*mm^4*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gFll^2*gHll^2*mm^4*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
