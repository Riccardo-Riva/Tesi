(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((2^(1 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-16 + 2*d + d^2)*s^2 + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-28 + 4*d + d^2)*s^2 + 
      16*(-4 + d)*s*t + 4*(-10 + 3*d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-2 + d)*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-2 + d)*s + 2*t)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-4 + d^2)*s^2 + 
      2*(-2 + 3*d)*s*t + 8*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-2 + d)*s^2 + d*s*t + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-14 + 5*d)*s^2 + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-10 + 3*d)*s^2 + 
   ...
   (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(d*s + 2*t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
     ((-2 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(s + t)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
     ((-6 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*
     gWlN*gWNl*gWWA^2*((-2 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(34 - 13*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(s + t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
     ...
     gWlN*gWNl*gWWA^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*
