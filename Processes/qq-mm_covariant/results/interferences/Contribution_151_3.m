...
(PropList[KiraPropagator[q1, mw]]*
   (((I/9)*2^(2 - d)*(-1 + d)*EL^6*(-3 + 8*sw^2)*((-2 + d)*s^2 + 4*s*t + 
       4*t^2))/(Pi^d*(mz^2 - s)*s^2*sw^2) - 
    ((I/9)*2^(2 - d)*EL^6*(-3 + 8*sw^2)*((-3 + d)*s^2 + 4*s*t + 4*t^2)*
    ...
    ((I/9)*2^(3 - d)*EL^6*(-3 + 8*sw^2)*SPList[SP[p1, q1], SP[p2, q1]])/
     (mw^2*Pi^d*s*(-mz^2 + s)*sw^2) + ((I/9)*2^(3 - d)*EL^6*(-3 + 8*sw^2)*
      (3*s + 2*t)*SPList[SP[p1, q1], SP[p3, q1]])/(mw^2*Pi^d*s^2*(-mz^2 + s)*
      sw^2) + ((I/9)*2^(3 - d)*EL^6*(-3 + 8*sw^2)*t*SPList[SP[p2, q1], 
