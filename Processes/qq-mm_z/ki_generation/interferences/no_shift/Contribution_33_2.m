(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*EL^6*gAl*gAu*(gZlL*gZlLC*(gZuR*gZuRC*(d^3*(2*Pi)^d*s*(s + 3*t) - 
       ...
       gZlR*gZlRC*(gZuL*gZuLC*(d^3*(2*Pi)^d*s*(s + 3*t) - 
          ...
          (-(d^3*(2*Pi)^d*s*(s + 3*t)) + 2^(1 + d)*Pi^d*
            ((-24 + 10*d + d^2)*s^2 + 3*d*(-4 + 3*d)*s*t - 
             (-24 + 22*d - 8*d^2 + d^3)*t^2))))*SPList[SP[p1, q1]])/
     ((2*Pi)^(2*d)*(mzC^2 - s)) - 
    ...
    (I*EL^6*gAl*gAu*(gZlL*gZlLC*(gZuR*gZuRC*(d^3*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*(-((-20 + 9*d + d^2)*s^2) + 2*(54 - 37*d + 6*d^2)*s*
              t + 4*(8 - 6*d + d^2)*t^2)) + gZuL*gZuLC*(-(d^3*(2*Pi)^d*s^2) + 
       ...
       (gZlL*gZlLC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2*(s + 3*t)) + 
            ...
            (d^2*(2*Pi)^d*s^2*(s + 3*t) - 2^(1 + d)*Pi^d*((-4 + 3*d)*s^3 + 8*
                (-1 + d)*s^2*t - (2 - 5*d + d^2)*s*t^2 + 2*t^3))) - 
         gZlR*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2*(s + 3*t)) + 
             2^(1 + d)*Pi^d*((-4 + 3*d)*s^3 + 8*(-1 + d)*s^2*t - (2 - 5*d + 
                 d^2)*s*t^2 + 2*t^3)) + gZuR*gZuRC*
            (d^2*(2*Pi)^d*s^2*(s + 3*t) + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^3 + 
               (10 - 7*d)*s^2*t + (10 - 5*d + d^2)*s*t^2 + 2*t^3))))/mz^2)*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
     ...
     (Pi^(2*d)*(mzC^2 - s)) - (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(-3*d^3*gZuL*gZuLC*(2*Pi)^d*s + 3*d^3*gZuR*gZuRC*(2*Pi)^d*
          s - 2^(1 + d)*gZuR*gZuRC*Pi^d*((108 - 85*d + 21*d^2)*s - 
       ...
       gZlR*gZlRC*(3*d^3*gZuL*gZuLC*(2*Pi)^d*s - 3*d^3*gZuR*gZuRC*(2*Pi)^d*
          s - 2^(1 + d)*gZuL*gZuLC*Pi^d*((108 - 85*d + 21*d^2)*s - 
    ...
    (I*2^(1 - d)*(-4 + d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*((-4 - 2*d + d^2)*gZuL*gZuLC + (2 + 2*d - d^2)*gZuR*
         ...
         (-4 - 2*d + d^2)*gZuR*gZuRC))*t*SPList[SP[p2, q1], SP[p2, q1]])/
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*EL^6*gAl*gAu*
    ...
    (I*EL^6*gAl*gAu*t*(gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s*(3*s + 5*t) + 
      ...
      (-1 + GaugeXi[Q])) + (I*EL^6*gAl*gAu*s*(s + t)*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*(s^2 + t^2) - 2^(1 + d)*Pi^d*
         ...
         gZuR*gZuRC*(-(d*(2*Pi)^d*(s^2 + t^2)) + 2^(1 + d)*Pi^d*
            (2*s^2 - (-4 + d)*s*t + 2*t^2))))*(-1 + GaugeXi[Q])*
     ...
     (mz^2*Pi^d*(mzC^2 - s)) - (I*2^(3 - d)*EL^6*gAl*gAu*
      (gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*(s + t)^2*
      (-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/
     (mz^2*Pi^d*(mzC^2 - s)) + (I*EL^6*gAl*gAu*(s + t)*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*t*
      ...
      (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s^2 - 2*t^2) - 
        ...
        (gZuL*gZuLC*((-4 + d)*s^2 + 2*t^2) + gZuR*gZuRC*(-((-2 + d)*s^2) + 
           2*t^2)))*(-1 + GaugeXi[Q])*SPList[SP[p2, q1], SP[p3, q1], 
    ...
    (I*EL^6*gAl*gAu*s*(-(gZlL*gZlLC*(-3*d*gZuL*gZuLC*(2*Pi)^d*s + 
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlR*gZlRC*(-((-2 + d)*gZuL*gZuLC) + 
     ...
     (mz^2*Pi^d*(mzC^2 - s)) + (I*4^(1 - d)*EL^6*gAl*gAu*(s + t)*
      ...
      (2^(1 + d)*Pi^d - (2*Pi)^d)*(s + t)*(-1 + GaugeXi[Q])*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*
      (gZlL*gZlLC*(gZuR*gZuRC*((-4 + d)*s - (-6 + d)*t) + 
        ...
        (gZuL*gZuLC*((-4 + d)*s - (-6 + d)*t) + gZuR*gZuRC*
          (-((-2 + d)*s) + d*t)))*(-1 + GaugeXi[Q])*SPList[SP[p2, q1], 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl*gAu*(s + t)*
     ...
     ((2*Pi)^d*(mzC^2 - s)) + 
    (I*EL^6*gAl*gAu*(gZlL*gZlLC*(gZuR*gZuRC*(-(d*(2*Pi)^d*s*(s^2 - 3*t^2)) + 
           2^(1 + d)*Pi^d*(2*s^3 - (-5 + d)*s^2*t - 2*(-2 + d)*s*t^2 + 
             t^3)) + gZuL*gZuLC*(d*(2*Pi)^d*s*(s^2 - 3*t^2) + 
           2^(1 + d)*Pi^d*(-s^3 + (-1 + d)*s^2*t + (1 + 2*d)*s*t^2 + t^3))) + 
       gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s*(s^2 - 3*t^2)) + 
