...
PropList[KiraPropagator[-q1, mc], KiraPropagator[q2, 0], 
  ...
  KiraPropagator[-p1 - p2 + p3 + q2, 0], KiraPropagator[q1 + q2, mc]]*
 ((3*4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mc^2*((-4 + d)*s^2 + 4*s*t + 4*t^2)*
    \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*mc^2*((22 - 13*d + 2*d^2)*s^2 + 
  ...
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*((-8 + 3*d)*s^2 + 6*s*t + 8*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*
    (-2*mc^2*(s + t)*((-6 + d)*s + 2*(-2 + d)*t) + 
     s*((-8 + 3*d)*s^2 + 6*s*t + 8*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*mc^2*
    ((18 - 9*d + d^2)*s^2 - (2 + d)*s*t - 2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*(3*(-2 + d)*s^2 + 10*s*t + 8*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*(3*(-2 + d)*s^3 + 10*s^2*t - 
     2*s*((2 + d)*mc^2 - 4*t)*t - 4*(-2 + d)*mc^2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mc^2*((-4 + d)*s^2 + 4*s*t + 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*((-12 + 5*d)*s^2 + 12*s*t + 12*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s) - 
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*(s*((-12 + 5*d)*s^2 + 12*s*t + 12*t^2) - 
     2*mc^2*((-10 + 3*d)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*((20 - 8*d + d^2)*s^2 + 4*(-4 + d)*s*t + 
     4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*((26 - 7*d + d^2)*s^2 + 4*(-3 + d)*s*t + 
     4*(-3 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
  (3*4^(1 - d)*EL^8*gAl^4*gAu^4*
    (-((-2 + d)*mc^2*((-4 + d)*s^2 + 4*s*t + 4*t^2)) + 
     s*((6 + d)*s^2 + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mc^2*(5*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(d*s^2 + 4*t*(2*s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(d*s^2 + 4*t*(2*s + t) - 
     (-2 + d)*mc^2*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mc^2*(3*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-4 + d)*s^2 + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-4 + d)*s^2 + 4*t^2 + 
     (-2 + d)*mc^2*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(s + 2*t)^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(-4*(-2 + d)*mc^2*s + (s + 2*t)^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((40 - 17*d + 2*d^2)*s^2 + 4*(-4 + d)*s*t + 
     4*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*
    ((54 - 19*d + 2*d^2)*s^2 + 4*(-4 + d)*s*t + 4*(-4 + d)*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*(-7 + d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) - 
  (9*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mc^2*(2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(2*s*(s + 2*t) - (-2 + d)*mc^2*(5*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (21*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mc^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s) - 
  (3*4^(3 - d)*EL^8*gAl^4*gAu^4*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s) - 
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*(2*s^2 - (-2 + d)*mc^2*t + 4*s*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(2*(-2 + d)*s^2 + 5*s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(2*(-2 + d)*s^2 + 5*s*t + 2*t^2 + 
     (-2 + d)*mc^2*(7*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((32 - 12*d + d^2)*s^2 + (16 - 3*d)*s*t - 
     2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/
   (Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*
    ((42 - 15*d + d^2)*s^2 - 3*(-6 + d)*s*t - 2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-10 + 3*d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-6 + d)*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-20 + 3*d)*s - 14*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
  (3*4^(3 - d)*EL^8*gAl^4*gAu^4*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*(3*d*s + 10*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-3 + d)*s^2 + s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-16 + 3*d)*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-26 + 5*d)*s^2 - 8*s*t - 4*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-1 + d)*s^2 - 5*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*(s*((-8 + d)*s - 6*t) - 
     2*(-2 + d)*mc^2*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*
    (-((-2 + d)*mc^2*(s + t)) + 2*s*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-10 + 3*d)*s - 10*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-2 + d)*mc^2 + (-1 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-3 + d)*s^2 + s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-12 + d)*s^2 - 11*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*(-((-18 + d)*s^2) + 18*s*t + 8*t^2 + 
     2*(-2 + d)*mc^2*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-4 + d)*s^2 + (-16 + 3*d)*s*t + 
     2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*t*
    ((-14 + 3*d)*s + 2*(-4 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*(s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (9*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mc^2*(s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*(s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1]])/(Pi^(2*d)*s) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-2 + d)*mc^2*(s - 4*t) + 2*s*(s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-7 + 2*d)*s^2 - s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-7 + 2*d)*s^2 + (-2 + d)*mc^2*(5*s - 2*t) - 
     s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*
    ((24 - 11*d + d^2)*s^2 - d*s*t - 2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((32 - 14*d + d^2)*s^2 - (2 + d)*s*t - 
     2*(-4 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-8 + 3*d)*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-2 + d)*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*(3*(-2 + d)*s + 14*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-2 + d)*s^2 + 3*s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-10 + 3*d)*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-22 + 5*d)*s^2 - 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(d*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((2 + d)*s^2 + s*t - 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-2 + d)*s^2 + 2*(-2 + d)*mc^2*t + 6*s*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-2 + d)*s^2 + 3*s*t + 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-3 + d)*s^2 + 7*s*t - 2*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*(-((-8 + d)*s^2) + 
     2*(-2 + d)*mc^2*(s - 2*t) - 2*s*t + 8*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*(4*s^2 + d*s*t + 2*(-4 + d)*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*(s + t)*((-6 + d)*s - 2*(-4 + d)*t)*
  ...
  (3*2^(3 - 2*d)*EL^8*gAl^4*gAu^4*((-5 + 2*d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (3*4^(3 - d)*EL^8*gAl^4*gAu^4*((-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*((-19 + 3*d)*s - 4*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*(5*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*((-8 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(4 - d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (3*2^(9 - 2*d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-14 + 3*d)*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-14 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^4*(5*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-22 + 5*d)*s + 4*(-5 + d)*t)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*(7*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-12 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^4*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*(2*s - (-8 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*((-4 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-16 + 3*d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(3 - d)*EL^8*gAl^4*gAu^4*t*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(5*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(3 - d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
  ...
  (3*4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^4*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*(s - 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-10 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^4*(s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*((-6 + d)*s + (-8 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(d*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(7*s + 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (9*4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^4*(s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (9*4^(2 - d)*(-6 + d)*EL^8*gAl^4*gAu^4*(s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (9*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*(s - t)*\[Mu]^(8 - 2*d)*
  ...
  (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*((-6 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(3*(-4 + d)*s + 10*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-8 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^4*(s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-2 + d)*s - 4*(-5 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*((-22 + 5*d)*s - 2*(-2 + d)*t)*
  ...
  (3*4^(3 - d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^4*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^4*gAu^4*(s - 6*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*(s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (3*4^(3 - d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], 
     SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (3*2^(7 - 2*d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (3*4^(3 - d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3], 
     SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (3*4^(3 - d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
     SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (3*2^(7 - 2*d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (3*2^(5 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^4*\[Mu]^(8 - 2*d)*
