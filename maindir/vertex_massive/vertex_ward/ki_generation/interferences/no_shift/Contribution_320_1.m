...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
     ...
     (bb*(psq^2*s + mm^4*(9*psq + s) + mm^2*(3*psq^2 + 4*psq*s - 2*s^2)) + 
      aa*(psq*s*(-psq + s) + mm^4*(-9*psq + 2*s) + 
    ...
    Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     ...
     (2*bb*mm^2*(-2*mm^2 - 3*psq + s) + aa*(3*mm^4 + mm^2*(7*psq - s) - 
        psq*s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*(bb*(psq - s) + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
     ...
     (bb*(2*mm^4 + psq^2 + mm^2*(5*psq - 2*s)) + 
      aa*(mm^2*(-7*psq + s) + psq*(-psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*psq*(mm^2 + s) - 
      bb*mm^2*(psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
     (2*bb*mm^2*(mm^2 + 3*psq - s) + aa*(-2*mm^4 + psq*s + 
        mm^2*(-6*psq + s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    Pi^(2*d) + (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
     (aa*mm^2*(mm^2 - 3*psq + 4*s) - bb*(mm^4 - 3*mm^2*(psq - s) + psq*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*psq^2 + bb*mm^2*(3*psq - 2*s) + 
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*psq*(mm^2 + psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(-2*bb*mm^2 + aa*(mm^2 + psq))*s*
