...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 (((-I)*2^(-1 - 2*d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(mm^2 - psq)*s*
    (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) + (I*d*EL^5*gAl^3*gZlL*gZlR*mm^2*
  ...
  (I*4^(-1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    ...
    SPList[SP[p2, q2]])/Pi^(2*d) + (I*d*EL^5*gAl^3*gZlL*gZlR*mm^2*s*
    (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*s*
    (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) - (I*(aa + bb)*(-2 + d)^2*EL^5*gAl^3*
    (gZlL^2 + gZlR^2)*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(1 - 2*d)*(-2 + d)*d*EL^5*gAl^3*gZlL*gZlR*
    mm^2*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 4*d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ((aa - bb)*(-2 + d)*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + (-8 + d)*psq*s + 
       (-2 + d)*psq*t + 2*s*(s + 2*t) + mm^2*((6 + d)*psq - 6*t - 
         d*(s + t))) - aa*(d^2*(2*Pi)^(2*d)*(mm^2 - psq)*(2*psq - s - 2*t) + 
       4^(1 + d)*Pi^(2*d)*(-2*psq^2 - 2*mm^2*s + 3*psq*s + 2*psq*t + s*t) - 
       2^(1 + 2*d)*d*Pi^(2*d)*(-4*psq^2 + mm^2*(2*psq - 3*s - 2*t) + s*t + 
         4*psq*(s + t))) - 2^(1 + 2*d)*(-2 + d)*Pi^(2*d)*
      (aa*(2*mm^2*(psq - s - t) + s*(psq + t)) + 
       bb*((-2 + d)*mm^4 + (-2 + d)*psq^2 - psq*s - s*t + 
         2*mm^2*(psq - d*psq + s + t))) - 
     bb*(-(d^2*(2*Pi)^(2*d)*(mm^2 - psq)*(2*psq - 3*s - 2*t)) + 
       4^(1 + d)*Pi^(2*d)*(2*psq^2 + 4*mm^2*s - 5*psq*s - 2*psq*t - s*t) + 
       2^(1 + 2*d)*d*Pi^(2*d)*(-4*psq^2 + mm^2*(2*psq - 7*s - 2*t) + s*t + 
         4*psq*(2*s + t))) + (-2 + d)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(4*d) - 
  (I*2^(1 - 2*d)*(-2 + d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(psq - s - t)*
  ...
  (I*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(-2*s + d*(psq - t))*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
   ...
   (2*Pi)^(2*d) + (I*4^(-1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*
    (gZlL^2 + gZlR^2)*(-((-2 + d)*psq^2) + (-8 + d)*psq*s + (-2 + d)*psq*t + 
     2*s*(s + t) + mm^2*((2 + d)*psq - (-2 + d)*s - (2 + d)*t))*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(psq - t)*
  ...
  (I*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(-2*s + d*(-psq + s + t))*
  ...
  (I*(aa + bb)*(-2 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(-2 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
