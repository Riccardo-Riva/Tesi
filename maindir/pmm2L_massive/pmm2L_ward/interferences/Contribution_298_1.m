...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((I*4^(-1 - d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*s*
    (psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (I*4^(-1 - d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*s*
    (-psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*(psq + 2*s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*(-psq + 3*s + t)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*
   ...
   Pi^(2*d) + (I*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*
    gWWA^2*mm^2*(psq - 2*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*
   ...
   (4^d*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*
    gWWA^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/
  ...
  ((3*I)*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*
