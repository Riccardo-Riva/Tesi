...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(3*mm^2 + psq)*(psq - t)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(-psq + s + t)*
     (psq*(-4*psq + s + 4*t) + mm^2*(-12*psq + 7*s + 12*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(mm^4*s + psq^2*s + 
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(3*mm^2 + psq)*
     (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*(-psq + s + t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*
     (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*(psq - t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(psq - t)*(-2*psq + s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHll^2*mm^4*(2*psq - s - 2*t)*
