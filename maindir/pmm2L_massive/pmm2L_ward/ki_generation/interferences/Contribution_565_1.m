...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^6*s*
    ...
    (I*4^(2 - d)*EL^5*gAl*gHll^4*mm^6*(bb*(mm^2 + psq - s - 2*t) + 
       ...
       SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^6*
      (bb*(5*mm^2 + 3*psq - 9*s - 8*t) + aa*(5*mm^2 - 13*psq + 9*s + 8*t))*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*
      (aa*(2*psq^2 + mm^2*(4*psq - 6*s - 4*t) + psq*(3*s - 2*t) - 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll^4*mm^4*s*(bb*(mm^2 + psq - s - 2*t) + 
       ...
       SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*
      s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*s*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*(bb*(mm^2 - t) + 
      ...
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^4*
