...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, mw]]*((2^(1 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*mm^2*
     ...
     (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*mm^2*(psq - s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(mh^2*Pi^(2*d)*s) + 
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*mm^2*(2*mm^2 + (-3 + d)*s)*
    ...
    (4^(1 - d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*mm^2*
     ...
     (mh^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*mm^2*
     ...
     (mh^2*Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggmgmA*gHgmgm*gHll*mm^2*(-2*psq + s + 2*t)*
