...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*s*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*
     (aa*(-2*(-2 + d)*psq^2 + (-8 + d)*psq*s + 
        mm^2*(8*psq + 4*s - 2*d*s - 8*t) + 2*(-2 + d)*psq*t + d*s*(s + t)) + 
   ...
   (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(bb*psq*(psq - t) + 
      bb*mm^2*(psq - 2*s - t) + aa*mm^2*(-psq + t) + aa*psq*(-psq + 2*s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gXll^2*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
