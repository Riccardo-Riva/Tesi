...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
  ...
  ((4^(2 - d)*EL^8*gAl^6*gAu^2*((-10 + 3*d)*s^2 + (-10 + 3*d)*s*t + 
   ...
   (4^(2 - d)*(18 - 9*d + d^2)*EL^8*gAl^6*gAu^2*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/Pi^(2*d) + (4^(2 - d)*(-6 + d)*EL^8*gAl^6*gAu^2*
   ...
   (4^(3 - d)*(-6 + d)*EL^8*gAl^6*gAu^2*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^6*gAu^2*((-104 + 68*d - 14*d^2 + d^3)*s + 
      2*(-6 + d)^2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-4 + d)*s + 2*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(4 - d)*(-4 + d)*EL^8*gAl^6*gAu^2*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*(-176 + 92*d - 16*d^2 + d^3)*EL^8*gAl^6*gAu^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^6*gAu^2*((-168 + 84*d - 14*d^2 + d^3)*s + 
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^6*gAu^2*((-184 + 100*d - 18*d^2 + d^3)*s - 
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*\[Mu]^(8 - 2*d)*
   ...
   (4^(3 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(3 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*\[Mu]^(8 - 2*d)*
