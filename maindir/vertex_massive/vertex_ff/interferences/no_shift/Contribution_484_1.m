...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  (-((4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmAA*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmAA*mm^2*(2*psq^2 - 3*psq*s + s^2 - 
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmAA*mm^2*(psq - t)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmAA*(mm^2 - psq)*(psq - s - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggmgmA*ggmgmAA*(mm^2*(psq - t) + 
