...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^4*
  ...
  (EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^4*s*(aa*(mm^2 + 3*psq - s) + 
   ...
   (2*Pi)^(2*d) - (2^(-1 - 2*d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*s*
    ...
    SPList[SP[q2, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*
    mm^2*(aa*mm^2*(4*psq - s) - aa*psq*s + 2*bb*mm^2*(-2*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*
    (aa*(mm^4 + mm^2*(9*psq - 2*s) - 3*psq*s) + 
     bb*(-mm^4 + psq*s + mm^2*(-9*psq + 4*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  ((-aa + bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*psq*(4*psq - s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(aa*mm^2*(4*psq - s) - aa*psq*s + 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(bb*mm^2 - aa*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(-2*aa*mm^2 + 4*bb*mm^2 - 
     3*aa*psq + bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*
    (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) + (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWlN*gXFW*
    gXll*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWlN*gXFW*
    gXll*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[q2, q2]])/Pi^(2*d) + ((-aa + bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*
    (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/
   (2*Pi)^(2*d) + ((-aa + bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 + psq)*
