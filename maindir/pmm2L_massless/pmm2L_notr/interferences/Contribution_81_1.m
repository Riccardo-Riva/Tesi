...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, 0], 
 ...
 (-((2^(-1 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    ...
    (Pi^(2*d)*s)) + ((-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    ((-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   (4^d*Pi^(2*d)*s) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
  ...
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-16 + 2*d + d^2)*s^2 + 
  ...
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-28 + 4*d + d^2)*s^2 + 
  ...
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-4 + d^2)*s^2 + 2*(-2 + 3*d)*s*t + 
     8*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
  ...
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-4 + d^2)*s^2 + 8*(-2 + d)*s*t + 
  ...
  (4^(1 - d)*(34 - 13*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
