...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-((4^(1 - d)*EL^6*gAl^4*mm^2*
       (2*gZlL*gZlR*(2*mm^2 - (-38 + 36*d - 11*d^2 + d^3)*psq + 
          ...
          2*(-2 + d)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     ...
     (mz^2*Pi^(2*d)) - (2^(1 - 2*d)*EL^6*gAl^4*
      (gZlL^2*(2*(8 - 5*d + d^2)*mm^4 + s*((-32 + 37*d - 12*d^2 + d^3)*psq + 
           ...
           (-36 + 39*d - 11*d^2 + d^3)*s)) + gZlR^2*(2*(8 - 5*d + d^2)*mm^4 + 
         s*((-32 + 37*d - 12*d^2 + d^3)*psq + (-2 + d)^2*s) + 
         mm^2*(-2*(16 - 7*d + d^2)*psq + (-36 + 39*d - 11*d^2 + d^3)*s)) + 
       2*gZlL*gZlR*(2*(8 - 5*d + d^2)*mm^4 - (-4 + d)*s*
          ((13 - 8*d + d^2)*psq + (-2 + d)*s) - 
         mm^2*(2*(16 - 7*d + d^2)*psq + (-24 + 23*d - 9*d^2 + d^3)*s)))*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   ((4^(1 - d)*EL^6*gAl^4*mm^2*
    ...
    (2^(1 - 2*d)*EL^6*gAl^4*mm^2*(2*gZlL*gZlR*(2*(8 - 5*d + d^2)*mm^2 - 
         2*(8 - 7*d + d^2)*psq - (-6 + d)*(-2 + d)^2*s) + 
       gZlL^2*(2*(8 - 5*d + d^2)*mm^2 - 2*(8 - 7*d + d^2)*psq + 
         (-48 + 44*d - 12*d^2 + d^3)*s) + gZlR^2*(2*(8 - 5*d + d^2)*mm^2 - 
         2*(8 - 7*d + d^2)*psq + (-48 + 44*d - 12*d^2 + d^3)*s))*
