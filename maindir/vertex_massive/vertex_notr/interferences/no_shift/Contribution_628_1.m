...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^6*gAl^2*gXll^2*mm^4*(-(2^(3 + 2*d)*(4 - 5*d + d^2)*gZlL*gZlR*mm^2*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gXll^2*mm^4*(-2*(4 - 2*d + d^2)*gZlL*gZlR*mm^2 + 
      (12 - 8*d + d^2)*gZlL^2*s + 2*(4 - 6*d + d^2)*gZlL*gZlR*s + 
      (12 - 8*d + d^2)*gZlR^2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(2*d) + (2^(1 - 4*d)*EL^6*gAl^2*gXll^2*mm^4*
     ...
     SPList[SP[p2, q1]])/Pi^(2*d) + (2^(3 - 2*d)*d*EL^6*gAl^2*gXll^2*gZlL*
   ...
   (2^(3 - 2*d)*EL^6*gAl^2*gXll^2*mm^4*(-((-2 + d)*gZlL^2*(mm^2 - psq)) - 
      (-2 + d)*gZlR^2*(mm^2 - psq) + (4 - 6*d + d^2)*gZlL*gZlR*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^2*gXll^2*mm^2*(-2*(4 - 6*d + d^2)*gZlL*gZlR*mm^2*s + 
   ...
   (2^(1 - 4*d)*(-2 + d)*EL^6*gAl^2*gXll^2*mm^2*
