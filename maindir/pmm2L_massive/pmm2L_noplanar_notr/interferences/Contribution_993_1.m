...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      (-2*psq^2 + (-3 + d)*psq*s + 2*mm^2*(psq + 2*s - d*s - t) + 4*psq*t - 
       t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*psq*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1]])/(mh^2*Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*mm^2 + (-3 + d)*s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(mh^2*Pi^(2*d)*s) + 
    (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(4*psq^2 + 4*mm^2*s - 
       6*s^2 + 3*d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      (2*mm^2 - 2*psq + (-1 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
     (mh^2*Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     (mh^2*Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
     (mh^2*Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      (-2*mm^2 - psq + s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + s + 2*t)*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + 3*s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(mh^2*Pi^(2*d)*s^2) - 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*mm^2 - 5*psq + 2*s + 
       3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     (mh^2*Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[-p3 - q1 + q2, mw]]*
   ((4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*((-2 + d)*psq*s^2 + 
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     ...
     (mh^2*Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      psq*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(mh^2*Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*mm^2 + (-3 + d)*s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(mh^2*Pi^(2*d)*s) - 
    (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(4*psq^2 + 4*mm^2*s - 
       6*s^2 + 3*d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
