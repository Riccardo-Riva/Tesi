...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 ((I*2^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*
   ...
   (Pi^d*(mzC^2 - s)*s) - (I*EL^6*gAl*gAu*ggmgmA^2*
    (gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 2*(-3 + d)*gZuLC*t - 
       2*(-3 + d)*gZuRC*t) + gZlRC*(-((-4 + d)*gZuLC*s) + (-2 + d)*gZuRC*s - 
   ...
   ((2*Pi)^d*(mzC^2 - s)*s) - (I*2^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*
    ((-2 + d)*gZlLC*gZuLC - (-4 + d)*gZlRC*gZuLC - (-4 + d)*gZlLC*gZuRC + 
     (-2 + d)*gZlRC*gZuRC)*t*SPList[SP[p1, p2], SP[p1, p2]])/
  ...
  (I*2^(2 - d)*EL^6*gAl*gAu*ggmgmA^2*((-2 + d)*gZlLC*gZuLC - 
  ...
  (I*2^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
   ...
   (Pi^d*s^2*(-mzC^2 + s)) + (I*2^(2 - d)*EL^6*gAl*gAu*ggmgmA^2*
    (gZlLC + gZlRC)*(gZuLC + gZuRC)*SPList[SP[p1, p3], SP[p1, p3]])/
   (Pi^d*s*(-mzC^2 + s)) + (I*2^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*
  ...
  (I*2^(1 - d)*EL^6*gAl*gAu*ggmgmA^2*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
   ...
   (Pi^d*s^2*(-mzC^2 + s)) - (I*2^(3 - d)*EL^6*gAl*gAu*ggmgmA^2*
