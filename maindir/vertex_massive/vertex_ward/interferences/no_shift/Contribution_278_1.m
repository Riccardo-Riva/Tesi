...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(2*bb*psq*(psq - s) - 
    ...
    (2*Pi)^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (2*aa*psq^2 - 2*bb*psq^2 - 3*aa*psq*s + 7*bb*psq*s + 
      2*aa*s*(-mm^2 + s) - 2*bb*s*(mm^2 + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*(aa*(5*mm^2*psq + psq^2 - 6*psq*s + 2*s^2) - 
     ...
     (gZlL - gZlR)*mm^4*s*(aa*(2*mm^2 - 3*psq + 2*s) - 
      bb*(mm^2 - 2*psq + 2*s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*
     ...
     (gZlL - gZlR)*mm^4*(aa*(4*psq - 2*s) + bb*(mm^2 - 5*psq + 2*s))*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (aa*mm^2*(6*psq - 3*s) - 2*bb*psq*(3*mm^2 + psq - s) + 
      aa*psq*(2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*psq*
     (5*mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (3*aa*mm^2 - bb*(2*mm^2 + psq))*s*\[Mu]^(8 - 2*d)*
