...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((I*EL^5*gAl*ggpgpZ^2*mm^2*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*mm^2*(bb*(gZlL + gZlR)^2*(psq - s - t) + 
   ...
   (I*EL^5*gAl*ggpgpZ^2*(bb*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
    ...
    (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
      gZlR^2*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
    Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*ggpgpZ^2*
