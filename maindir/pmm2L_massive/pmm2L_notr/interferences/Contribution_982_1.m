...
PropList[KiraPropagator[-q1, mh], KiraPropagator[-q1 - q2, mz], 
 ...
 ((2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (10*psq^2 + 8*s^2 + 10*s*t + 4*t^2 + 4*mm^2*(-psq + s + t) - 
     psq*((24 + d)*s + 14*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   ((2*Pi)^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq^2 + (-5 + d)*psq*s + 10*s^2 - 2*d*s^2 + 2*mm^2*(psq - t) + 
   ...
   ((2*Pi)^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq^2 + 4*mm^2*(psq - t) - psq*((6 + d)*s + 2*t) + 
   ...
   ((2*Pi)^(2*d)*s^2) + (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(-4*psq^2 + 4*mm^2*s - 8*psq*s + 6*s^2 - d*s^2 + 
     8*psq*t - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(psq - 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (Pi^(2*d)*s) + (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (-4*psq^2 + (-4 + d)*s^2 - 4*s*t - 4*t^2 + psq*(6*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*mm^2 + 6*psq + (-5 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (4^d*Pi^(2*d)*s) + (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(-4*psq^2 + 4*mm^2*s - 8*psq*s + 6*s^2 - d*s^2 + 
     8*psq*t - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(-mm^2 + psq + (-1 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 + 2*psq - 7*s - d*s - 4*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(-7 + d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (3*4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
    mm^2*(-2*mm^2 + 2*psq + 7*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - 3*psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*
    gXll*(gZlL - gZlR)*mm^2*(mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq + (-12 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - 3*psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(-2*psq + d*s + 2*t)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(psq - t)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    ...
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*
    gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHXZ*gHZZ*gXll*
