...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mh], 
  ...
  (-((4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*s*
   ...
   (4^(2 - d)*EL^5*gAl^3*gHll^2*mm^4*(-4*bb*psq + aa*(mm^2 + 3*psq))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(mh^2*Pi^(2*d)) - 
   (4^(2 - d)*EL^5*gAl^3*gHll^2*mm^4*(aa*(2*mm^2 + s) - bb*(2*psq + s))*
   ...
   (4^(2 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*psq*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*(2*psq - s)*\[Mu]^(8 - 2*d)*
