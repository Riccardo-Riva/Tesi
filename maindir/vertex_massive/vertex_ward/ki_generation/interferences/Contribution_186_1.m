...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(-1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*(2*mm^2 + psq) - 
      bb*(mm^2 + 2*psq))*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d)) - 
  (2^(-1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  ((aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(mm^2 + psq)*s^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(mm^2 + psq)*s^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*
    (2*aa*psq^2 + aa*mm^2*(2*psq + s) - bb*psq*(2*mm^2 + 2*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*s*(2*aa*mm^2*(psq + s) - 
     2*bb*psq*(psq + s) - bb*mm^2*(2*psq + s) + aa*psq*(2*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(mm^2 + psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  (EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/Pi^(2*d) - 
  ((aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) - 
  ((aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*(4*mm^2 + psq) - bb*(mm^2 + 4*psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(2*Pi)^(2*d) - 
  (EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*(4*mm^2 + psq) - bb*(mm^2 + 4*psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(3*aa*mm^2 - 2*bb*mm^2 + 
     2*aa*psq - 3*bb*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
   Pi^(2*d) + (EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(4*aa*mm^2 - 3*bb*mm^2 + 
     3*aa*psq - 4*bb*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) + (EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*
    (2*aa*psq^2 + aa*mm^2*(2*psq + s) - bb*psq*(2*mm^2 + 2*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(-(bb*mm^2*(2*psq + s)) + 
  ...
  (EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*mm^2 - bb*psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*
    (aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^5*ggpgpA*ggzgpW^2*gWlN*gWNl*
    (aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) - (4^(1 - d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*
    gWNl*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[p2, q1]])/Pi^(2*d) - (4^(1 - d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*
    gWNl*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) - (4^(1 - d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*
    gWNl*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[q1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*
    gWNl*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[q2, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggzgpW^2*gWlN*
