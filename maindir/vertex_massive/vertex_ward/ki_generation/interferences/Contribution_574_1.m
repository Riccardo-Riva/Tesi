...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   (((-I)*EL^5*gAl*gXll^2*mm^4*(mm^2 - psq)*s*
     ...
     (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
      (mm^2 - psq)*(-4*aa*s + aa*d*(psq + s - t) + bb*d*(-psq + s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^4*
      (-(aa*(-2 + d)*gZlL^2*(-(psq*s) + mm^2*(psq + s - t))) - 
       aa*(-2 + d)*gZlR^2*(-(psq*s) + mm^2*(psq + s - t)) + 
       bb*(-2 + d)*gZlL^2*mm^2*(psq - t) + bb*(-2 + d)*gZlR^2*mm^2*
        (psq - t) - bb*d*gZlL*gZlR*(2*mm^2 - 2*psq - s)*(psq - s - t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*(mm^2 - psq)*s*
      ...
      SPList[SP[q1, q2]])/Pi^(2*d) + (I*(-2 + d)*EL^5*gAl*gXll^2*
      (gZlL^2 + gZlR^2)*mm^4*s*(bb*(mm^2 + psq - s - 2*t) + 
       aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
     (2*Pi)^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^4*
      (2*bb*gZlL*gZlR*(-psq + s + t) + aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*(mm^2 - psq) - 2*gZlL*gZlR*(2*mm^2 - 3*psq + s + 
           t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^4*
      (aa*gZlL*gZlR*((-4 + d)*mm^2 + 6*psq - d*psq - 4*s + d*s - 2*t) + 
       bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
         gZlL*gZlR*(-2*psq + 4*s - d*(mm^2 - psq + s) + 2*t)))*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gXll^2*mm^2*
      (-(bb*(2*Pi)^(2*d)*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 
          (-2 + d)*gZlR^2*mm^2*(2*psq - s - 2*t) + gZlL*gZlR*
           (-4*s + d*(mm^2 - psq + s))*(-psq + s + t))) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
      (-(aa*(-2 + d)*gZlL^2*mm^2*(psq - t)) + bb*(-2 + d)*gZlL^2*mm^2*
       ...
       bb*(-2 + d)*gZlR^2*mm^2*(psq - t) - bb*d*gZlL*gZlR*
        (2*mm^2 - 2*psq - s)*(psq - s - t) + aa*d*gZlL*gZlR*
        (-2*psq^2 + 2*mm^2*(psq + s - t) + s*(s + t) + psq*(-3*s + 2*t)))*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
     ...
     Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^4*(2*aa*gZlL*gZlR*(psq - t) + 
       bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
     ...
     Pi^(2*d) - (I*2^(3 - 2*d)*aa*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
      gZlR*mm^2*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
    ...
    (I*2^(3 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
     ...
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*bb*(-4 + d)*EL^5*gAl*gXll^2*
