...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq^2 + s^2 + 
       psq*(s - d*s - 4*t) + 2*mm^2*(psq + (-3 + d)*s - t) + 3*s*t + 2*t^2)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(mh^2*Pi^(2*d)*s^2) + 
    (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
      (2*psq^2 + 2*(-2 + d)*mm^2*s - psq*((-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq^2 + (-3 + d)*psq*s + 
       2*mm^2*(psq + 2*s - d*s - t) + 4*psq*t - t*(s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
    (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*psq*\[Mu]^(8 - 2*d)*
    ...
    (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*mm^2 - 2*psq + 
       (-1 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(mh^2*Pi^(2*d)*s) + 
    (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)*s^2) + 
    (4^(4 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) - 
    (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*mm^2 + psq - s - 3*t)*
    ...
    (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq + d*s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(-2*psq + 3*s + 2*t)*
    ...
    (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*(2*psq + (-6 + d)*s - 2*t)*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*((-2 + d)*psq*s^2 + 
    ...
    (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
      (2*psq^2 + 2*(-2 + d)*mm^2*s - psq*((-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*
      (2*psq^2 - 2*mm^2*(psq + 2*s - d*s - t) + t*(s + 2*t) - 
       psq*((-3 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
     (mh^2*Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*ml^2*mm^2*psq*
