...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (mm^4*(5*psq - 3*s - 5*t)*(psq - t) - (psq - t)*
        (2*psq^3 - 4*psq^2*(s + t) - 2*s*t*(s + t) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
      mm^2*(psq^2 - 2*psq*t + t*(s + t))*(5*psq*s + 
       mm^2*(4*psq - 3*s - 4*t) - 2*s*(s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
      mm^2*(-2*psq^3 - 4*psq*(s + t)^2 + (s + t)^3 + mm^4*(-psq + s + t) + 
       psq^2*(4*s + 5*t) + mm^2*(2*psq^2 - 4*psq*s + 3*s^2 - 3*psq*t + 
         4*s*t + t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
      mm^2*(8*psq^3 + 2*mm^4*(psq - t) - 3*psq^2*(s + 6*t) - 
       2*t*(s^2 + 3*s*t + 2*t^2) - mm^2*(6*psq^2 - 9*psq*s + 3*s^2 - 
         8*psq*t + 11*s*t + 2*t^2) + psq*(-s^2 + 11*s*t + 14*t^2))*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      ...
      (gZlL - gZlR)*mm^2*(-4*psq^3 + 4*mm^4*(psq - t) + 2*t*(s + t)^2 - 
       2*psq*t*(3*s + 4*t) + psq^2*(s + 10*t) - 
       mm^2*(10*psq^2 - 9*psq*s + 2*s^2 - 16*psq*t + 10*s*t + 6*t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (2*mm^4*s - mm^2*(psq^2 - 2*s^2 + 2*psq*(s - t) + t^2) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (-4*psq^3 + 2*t^2*(2*s + t) + 2*psq^2*(s + 5*t) + 
       psq*(s^2 - 6*s*t - 8*t^2) + mm^2*(2*psq^2 - 6*psq*s + 3*s^2 - 
         4*psq*t + 6*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*
      (gZlL - gZlR)*mm^2*(mm^2*(2*psq^2 + 3*psq*s - 2*s^2 - 4*psq*t - 3*s*t + 
         2*t^2) + (psq - t)*(2*psq^2 + 2*t*(2*s + t) - psq*(3*s + 4*t)))*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      ...
      (gZlL - gZlR)*mm^2*(-2*psq^2 + 2*mm^2*(psq - s - t) + 2*psq*(2*s + t) - 
       s*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
