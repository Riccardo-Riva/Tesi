...
PropList[KiraPropagator[-q1, mh], KiraPropagator[-q1 - q2, mz], 
 ...
 ((2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHZZ^2*(-8*(-2 + d)*(gZlL^2 + gZlR^2)*psq^2*
      s - 2*psq*s*(18*(gZlL^2 + gZlR^2)*s + d^2*(gZlL^2 + gZlR^2)*s - 
    ...
    \[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHZZ^2*(-8*d*gZlL*gZlR*mm^2*s + 
  ...
  (EL^8*gAl^2*gAu^2*gHZZ^2*(-(d^2*(gZlL^2 + gZlR^2)*(mm^2 - psq - s)*s) + 
   ...
   ((2*Pi)^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*gHZZ^2*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHZZ^2*(gZlL^2 + gZlR^2)*
    ...
    gHZZ^2*(gZlL^2 + gZlR^2)*(-4*mm^2 + 6*psq + 3*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHZZ^2*(gZlL^2 + gZlR^2)*
    ...
    gHZZ^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   (Pi^(2*d)*s) - (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHZZ^2*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHZZ^2*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHZZ^2*
  ...
  (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHZZ^2*(gZlL^2 + gZlR^2)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHZZ^2*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHZZ^2*
    ...
    gHZZ^2*(gZlL^2 + gZlR^2)*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
