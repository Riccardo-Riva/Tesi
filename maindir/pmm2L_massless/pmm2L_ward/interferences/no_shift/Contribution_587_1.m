(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, 0], 
  ...
  (((-I)*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*s*(s + t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*s*((-4 + d)*s + (-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*s*(2*s + 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*s*((-2 + d)*s + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*s*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*s*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^5*s*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*s*(2*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*s*((-2 + d)*s + 2*(-3 + d)*t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*s*(s + 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*s*(2*s + d*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*s*((-4 + d)*s + 2*(-3 + d)*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*s*(s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(5 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(2*s + 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^5*((-3 + d)*s + (-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(2*s + 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*((-2 + d)*s + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl^5*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
   (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
   (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^5*((-1 + d)*s + 2*(-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^5*((-3 + d)*s + (-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*(3*(-2 + d)*s + (-12 + 5*d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*((-2 + d)*s + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(16 - 10*d + d^2)*EL^5*gAl^5*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
   (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(s + 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
   (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^5*((-3 + d)*s + 2*(-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
   ((3*I)*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*d*EL^5*gAl^5*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl^5*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*((-4 + d)*s + (-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*((-8 + 3*d)*s + (-12 + 5*d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*((-2 + d)*s + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^5*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*((20 - 10*d + d^2)*s + 
      (16 - 10*d + d^2)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*s*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*(2*s + (-2 + d)*t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*((20 - 10*d + d^2)*s + 
     ...
     (2*s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, q1]])/Pi^(2*d) - (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*
   ...
   (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^5*(s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
   (I*2^(5 - 2*d)*(aa - bb)*EL^5*gAl^5*(s + (-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*(2*(-2 + d)*s + (-12 + 5*d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*(2*s + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(-4 + d)^2*EL^5*gAl^5*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*(4*s - (16 - 10*d + d^2)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
   (I*2^(5 - 2*d)*(aa - bb)*(-3 + d)*EL^5*gAl^5*(s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^5*((-4 + d)*s + (-2 + d)*t)*
   ...
   (I*2^(5 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*t*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(-aa + bb)*(8 - 6*d + d^2)*EL^5*gAl^5*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
   (I*4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*(2*(-3 + d)*s + (-12 + 5*d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*(2*s + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(16 - 10*d + d^2)*EL^5*gAl^5*t*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(2 - d)*(aa - bb)*EL^5*gAl^5*((-4 + d)*s + 2*(-3 + d)*t)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^5*((20 - 10*d + d^2)*s + 
     ...
     gAl^5*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
