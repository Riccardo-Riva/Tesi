...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, ml]]*((4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*t*
      (s + t)*(s^2 - 2*mm^2*t + 2*s*t)*\[Mu]^(8 - 2*d))/(mh^2*Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*(s + t)*(s + 2*t)^2*
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*t*(s + 2*t)^2*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/(mh^2*Pi^(2*d)*s) - 
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*t*(s^2 + 2*s*t + 
       t*(-mm^2 + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(mh^2*Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*s*(s + 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*(s + t)*(2*mm^2 + s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(mh^2*Pi^(2*d)*s) - 
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*(2*mm^2 + t)*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)*s) + 
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*(s^2 - 2*mm^2*t + 2*s*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)*s) - 
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*(s^2 + 4*s*t + 3*t^2)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(mh^2*Pi^(2*d)*s) - 
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*(2*mm^2 + s + 2*t)*
    ...
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*t*(2*mm^2 + 2*s + 3*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(mh^2*Pi^(2*d)*s) + 
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*(2*mm^2 + s + 2*t)*
    ...
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*t*(s + t)*\[Mu]^(8 - 2*d)*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*ml^2*mm^2*t*(s + t)*
