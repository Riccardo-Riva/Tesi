...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*s*
   ...
   (4^(1 - d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*((12 - 4*d + d^2)*gZlR*mm^2*s + 
      (-2 + d)*gZlL*(-2*psq^2 - psq*s + 4*s^2 + mm^2*(2*psq + s - d*s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*(-2*(2 - 3*d + d^2)*gZlR*mm^2*s + 
      2*(-2 + d)*gZlL*mm^2*(psq + (-1 + d)*s) + 
      gZlL*psq*(-2*(-2 + d)*psq + (28 - 8*d + d^2)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*(-2*(2 + d)*gZlR*mm^2 + 
      (-2 + d)*gZlL*((-1 + d)*mm^2 + 15*psq - d*psq - 16*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*(-((8 - 6*d + d^2)*gZlL*mm^2) + 
   ...
   (2^(1 - 2*d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*(-8*(-1 + d)*gZlR*mm^2 + 
   ...
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*gZlL*psq*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*gZlL*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*gZlL*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*gZlL*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) - (4^(3 - d)*(-2 + d)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*gZlL*
   ...
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*gZlL*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (2^(5 - 2*d)*d*EL^6*gAl*gWlN*gWNl*gWWA*gWWZ*gZlL*\[Mu]^(8 - 2*d)*
