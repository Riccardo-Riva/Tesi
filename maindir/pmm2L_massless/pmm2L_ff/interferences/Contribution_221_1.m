...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  ((4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*(s + t)^2*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*t*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*(s + t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll*gFZW*gWNl*mm^2*sw*t*\[Mu]^(8 - 2*d)*
