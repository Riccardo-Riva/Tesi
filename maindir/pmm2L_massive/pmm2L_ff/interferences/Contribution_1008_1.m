...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(1 - 4*d)*EL^6*gAl*gAu*ggmgmZ^2*mm^2*
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*ggmgmZ^2*mm^2*(psq - t)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*mm^2*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*mm^2*(-psq + s + t)*
      (2*gZlL*gZlR*(-psq + t) + gZlL^2*(2*mm^2 - 3*psq + s + t) + 
       gZlR^2*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(2*gZlL*gZlR*mm^2*(psq - t)^2 + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(-2*gZlL*gZlR*mm^2*
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*ggmgmZ^2*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
        (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) - 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*mm^2*(-psq + s + t)*
      (-2*gZlL*gZlR*s + gZlL^2*(2*mm^2 - 3*psq + s + t) + 
       gZlR^2*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(2*gZlL*gZlR*mm^2*(-psq + s + t)^2 + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*mm^2*(gZlL^2*(mm^2 - psq)*(psq - t) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*mm^2*
      (psq - t)*(gZlL^2*(-psq + t) + gZlR^2*(-psq + t) + 
       2*gZlL*gZlR*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*ggmgmZ^2*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*mm^2*(-2*gZlL*gZlR*s + 
       gZlL^2*(psq - t) + gZlR^2*(psq - t))*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2*(mm^2 - psq)*s + 
       gZlR^2*(mm^2 - psq)*s + 4*gZlL*gZlR*mm^2*(2*psq - s - 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/Pi^(2*d) + 
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*mm^2*(2*psq - s - 2*t)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       ...
       SP[q1, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
      (gZlL^2 + gZlR^2)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
      (2*gZlL*gZlR*mm^2*(-psq + s + t) + gZlL^2*(mm^2*(2*psq - s - 2*t) + 
       ...
       SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*
      (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p3, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
      (gZlL^2 + gZlR^2)*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
      (gZlL^2 + gZlR^2)*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*psq*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[p3, q1]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*(psq - t)^2*
     ...
     Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*(psq - t)^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*(psq - t)^2*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*ggmgmZ^2*(gZlL^2 + gZlR^2)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*ggmgmZ^2*
