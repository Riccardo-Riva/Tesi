...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(1 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
      ...
      SPList[SP[p3, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*
      (gZlL - gZlR)*mm^2*(psq*s + 2*mm^2*(psq - s - t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(-psq + s + t)*
      (2*mm^2 - 3*psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*
      (gZlL - gZlR)*mm^2*(-2*psq^2 + 2*mm^2*(psq - t) + 2*psq*(s + t) - 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
      (2*mm^2 - psq - t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(psq - t)^2*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
      (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*
      (gZlL - gZlR)*mm^2*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
     Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
      (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
     Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
     Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*
      (gZlL - gZlR)*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(psq - t)*
