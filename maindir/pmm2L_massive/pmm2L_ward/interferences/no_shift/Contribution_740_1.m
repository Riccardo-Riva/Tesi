...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*EL^5*gAl^3*gWlN*gWNl*
    ...
    (2*Pi)^(4*d) + (I*EL^5*gAl^3*gWlN*gWNl*
     (aa*((-4 + d^2)*mm^4*(2*Pi)^(2*d)*(psq - t) + (-2 + d)*(2*Pi)^(2*d)*psq*
      ...
      bb*(-2 + d)*(-(mm^4*(2*Pi)^(2*d)*((2 + d)*psq - 2*(-2 + d)*s - 
           (2 + d)*t)) - (2*Pi)^(2*d)*psq*((-2 + d)*psq^2 - 
          2*(-3 + d)*psq*s - (-2 + d)*psq*t + 2*s*t) + 
        2^(1 + 2*d)*mm^2*Pi^(2*d)*(d*psq*(psq - 2*s - t) + s*(5*psq + t))))*
   ...
   (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gAl^3*gWlN*gWNl*(bb*(2*mm^2 - psq - t) + 
     ...
     gWNl*((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t)*\[Mu]^(8 - 2*d)*
