...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl*ggmgmZ^2*mm^2*
     ...
     SPList[SP[p1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*ggmgmZ^2*mm^2*s*
     (bb*(gZlL^2*mm^2 + gZlR^2*mm^2 + 2*gZlL*gZlR*(-2*psq + s)) - 
      aa*(gZlL^2*psq + gZlR^2*psq + 2*gZlL*gZlR*(-2*psq + s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
   (EL^5*gAl*ggmgmZ^2*s*(bb*(gZlL^2*(mm^4 + 2*psq^2 + mm^2*(psq - s)) + 
   ...
   (EL^5*gAl*ggmgmZ^2*mm^2*s*(aa*(gZlL^2*(mm^2 - psq) + gZlR^2*(mm^2 - psq) + 
        gZlL*gZlR*(8*psq - 2*s)) + bb*(gZlL^2*(mm^2 - psq) + 
        gZlR^2*(mm^2 - psq) + 2*gZlL*gZlR*(-4*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
   (4^(1 - d)*EL^5*gAl*ggmgmZ^2*mm^2*(-(aa*(gZlL + gZlR)^2*psq) + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*ggmgmZ^2*(aa*(gZlL^2*psq*(2*mm^2 + 2*psq - s) + 
   ...
   (4^(1 - d)*EL^5*gAl*ggmgmZ^2*(gZlL^2 + gZlR^2)*mm^2*(bb*mm^2 - aa*psq)*
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*ggmgmZ^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 + psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ^2*(gZlL^2 + gZlR^2)*psq*
     (mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl*ggmgmZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*s*
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s*
   ...
   (4^(1 - d)*EL^5*gAl*ggmgmZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl*ggmgmZ^2*(bb*(gZlL + gZlR)^2*mm^2 - 
      aa*(2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl*ggmgmZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*
   ...
   (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*
