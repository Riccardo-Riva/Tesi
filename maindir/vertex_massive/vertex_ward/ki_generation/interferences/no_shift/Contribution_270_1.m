...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^5*gAl*gHll^2*mm^4*s*
     ...
     (aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(mm^2*(4*psq - 3*s) + 
          psq*(2*psq + 5*s)) + (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*
         (mm^2*(4*psq - 3*s) + psq*(2*psq + 5*s)) - 2^(1 + 2*d)*gZlL*gZlR*
         Pi^(2*d)*(psq*s*((-4 + d)*psq + 2*s) + mm^4*((-4 + 5*d)*psq - 
            2*(-1 + d)*s) + mm^2*((-4 + d)*psq^2 + (10 + 3*d)*psq*s - 
            4*s^2))) + bb*(-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
          (psq*(2*psq + s) + mm^2*(4*psq + s))) - (-2 + d)*gZlR^2*mm^2*
         (2*Pi)^(2*d)*(psq*(2*psq + s) + mm^2*(4*psq + s)) + 
        2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*((-4 + d)*psq^2*s + 
          mm^4*((-4 + 5*d)*psq + 2*s) + mm^2*((-4 + d)*psq^2 + 
            (10 + d)*psq*s - 2*s^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(4*d) - (4^(1 - 2*d)*EL^5*gAl*gHll^2*mm^4*
    ...
    Pi^(4*d) + (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*s*
   ...
   (2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*s*
     (bb*d*(2*Pi)^(2*d)*(gZlL*gZlR*(mm^4 + 2*psq^2 + mm^2*(5*psq - 2*s)) + 
   ...
   (2^(1 - 2*d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*s*(bb*(mm^2 + 3*psq - s) + 
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (bb*mm^2*((-2 + d)*gZlL^2*(2*mm^2 + 2*psq - s) + 
        (-2 + d)*gZlR^2*(2*mm^2 + 2*psq - s) + gZlL*gZlR*
         (-((-4 + d)*mm^2) + (4 - 5*d)*psq + 2*(-4 + d)*s)) + 
   ...
   (4^(1 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(-4*bb*mm^2*psq + 
   ...
   (4^(2 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(5 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 + psq) - 
      aa*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^5*gAl*gHll^2*mm^2*
