...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
 ...
 ((EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(-(bb*(psq^2 + mm^2*(3*psq - s))) + 
     aa*psq*(mm^2 + 3*psq - s))*s^2*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*mm^2*(aa*gZlL*mm^2*psq - 
     bb*gZlL*mm^2*psq + 3*bb*gZlR*(psq^2 + mm^2*(2*psq - s)) - 
     3*aa*gZlR*psq*(mm^2 + 2*psq - s))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
  ...
  (EL^5*gFFA*gFFZ*gFll^2*mm^2*s*(2*aa*gZlR*psq^2 + aa*gZlR*mm^2*(2*psq - s) + 
     bb*gZlL*mm^2*(4*psq - s) + aa*gZlL*mm^2*(-4*psq + s) + 
     bb*gZlR*psq*(-2*mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2*Pi)^(2*d) + (2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*mm^2*s*
    (2*aa*gZlR*psq*(3*psq - 2*s) + bb*gZlL*mm^2*(4*psq - s) + 
     aa*gZlL*mm^2*(-4*psq + s) + aa*gZlR*mm^2*(6*psq + s) - 
     bb*gZlR*(mm^2*(6*psq - 4*s) + psq*(6*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*
    mm^2*s*(-2*bb*psq^2 + aa*psq*(2*mm^2 + 2*psq - s) + bb*mm^2*(-2*psq + s))*
  ...
  (2^(3 - 2*d)*EL^5*gFFA*gFFZ*gFll^2*gZlR*mm^2*(bb*(2*mm^2 + psq) - 
