...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*(mm^2 - psq)*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*(4*mm^2 - 4*psq + s)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gWlN*gWNl*(2*(-2 + d)*mm^2 + 
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*(psq - t)*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*gWlN*gWNl*(2*psq + s - 2*t)*
