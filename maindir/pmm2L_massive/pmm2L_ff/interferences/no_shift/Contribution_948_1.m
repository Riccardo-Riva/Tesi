...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*mm^2*
    ...
    (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*
     ...
     (mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*
      ml^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*(psq - t)^2*
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*(-2*psq^2 + s^2 + 
     ...
     (mz^2*Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      (gZlL + gZlR)^2*ml^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
