...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (((-I)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*s*
   ...
   (I*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(2*aa*mm^2*(psq - t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     mm^2*(aa*(2*mm^2 - s)*(psq - t) - bb*(2*mm^2*(psq - s - t) + 
        s*(psq + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*s*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
     mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
    Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
