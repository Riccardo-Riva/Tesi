...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*mm^2*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*ml^2*(s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*ml^2*t*
     (-4*d*gZlL*gZlR*mm^2*(s + 2*t) + gZlL^2*((-2 + d)*mm^2*s + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*ml^2*mm^2*((-2 + d)*gZlL^2*s + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*t*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*(s + t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*mm^2*t*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*t^2*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*t^2*
