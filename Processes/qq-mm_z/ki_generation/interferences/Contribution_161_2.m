...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]]]*
   ((I*2^(1 - 2*d)*EL^6*gAl*gWWAZ*
      (s*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
         ...
         gZlRC*gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            (-s + (-3 + d)*t))) + 
    ...
    (I*2^(2 - d)*EL^6*gAl*gWWAZ*((-4 + d)*gZlLC*gZuL*gZuLC - 
       (-2 + d)*gZlRC*gZuL*gZuLC - (-2 + d)*gZlLC*gZuR*gZuRC + 
       (-4 + d)*gZlRC*gZuR*gZuRC)*(s + t)*(-1 + GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p1, q1]])/(mw^2*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
      GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gWWAZ*
    ...
    (I*2^(2 - d)*EL^6*gAl*gWWAZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
       (-4 + d)*gZlRC*gZuL*gZuLC - (-4 + d)*gZlLC*gZuR*gZuRC + 
       (-2 + d)*gZlRC*gZuR*gZuRC)*t*(-1 + GaugeXi[Q])*
      SPList[SP[p2, q1], SP[p2, q1]])/(mw^2*Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)*
      GaugeXi[Q]) + (I*2^(2 - d)*EL^6*gAl*gWWAZ*
      (gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - gZuR*gZuRC*
          ((-4 + d)*s + 2*t)) - gZlRC*(gZuL*gZuLC*((-4 + d)*s + 2*t) + 
         gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*(-1 + GaugeXi[Q])*
      SPList[SP[p2, q1], SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)*s*(-mzC^2 + s)*
      GaugeXi[Q]) - (I*2^(3 - d)*EL^6*gAl*gWWAZ*(gZlLC + gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*(-1 + GaugeXi[Q])*SPList[SP[p3, q1], 
       SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q])) + 
  PropList[KiraPropagator[q1, mw]]*
   ((I*2^(1 - 2*d)*EL^6*gAl*gWWAZ*
      (gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
       ...
       gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
         ...
         gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
             (8 - 5*d + d^2)*s*t + 2*t^2))) + 
       ((-1 + d)*gZlRC*gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
            ((4 - 3*d)*s^2 + (4 - 5*d + d^2)*s*t - 2*t^2)) - 
         gZlRC*gZuR*gZuRC*(d^2*(1 + d)*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
            ((-2 + 4*d - 3*d^2)*s^2 + (-8 + 13*d - 6*d^2 + d^3)*s*t + 
             2*(-1 + d)*t^2)) + gZlLC*((-1 + d)*gZuR*gZuRC*
            (d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((4 - 3*d)*s^2 + (4 - 5*d + 
                 d^2)*s*t - 2*t^2)) + gZuL*gZuLC*
            (-(d^2*(1 + d)*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((2 - 4*d + 3*d^2)*
                s^2 - (-8 + 13*d - 6*d^2 + d^3)*s*t - 2*(-1 + d)*t^2))))*
        GaugeXi[Q]))/(Pi^(2*d)*s*(-mz^2 + s)*(-mzC^2 + s)*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gWWAZ*
      (s*(gZlRC*gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            (2*s - (-3 + d)*t)) + gZlLC*gZuR*gZuRC*(-(d*(2*Pi)^d*s) + 
           2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + gZlLC*gZuL*gZuLC*
    ...
    (I*2^(2 - d)*EL^6*gAl*gWWAZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
      ...
      GaugeXi[Q]) + (I*2^(3 - d)*EL^6*gAl*gWWAZ*(gZlLC + gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*(-1 + GaugeXi[Q])*SPList[SP[p3, q1], 
       SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)*(-mzC^2 + s)*GaugeXi[Q])))/4
