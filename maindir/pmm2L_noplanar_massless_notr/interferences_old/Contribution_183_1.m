...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 (((-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*(s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (3*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/(2*Pi)^(2*d) + 
  ((-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(4^d*Pi^(2*d)) - 
  ((-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*(s + 3*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(Pi^(2*d)*s) - 
  (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*t*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (3*2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*(s + t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gFFA*gFFWW*gWlN*gWNl*(s + t)*
