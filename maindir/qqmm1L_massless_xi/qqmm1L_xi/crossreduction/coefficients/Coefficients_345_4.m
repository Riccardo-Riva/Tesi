...
{(I*2^(1 - d)*d*EL^6*(gZlL*gZlLC + gZlR*gZlRC)*gZNL^2*
    (gZuL*gZuLC + gZuR*gZuRC)*s^3*\[Mu]^(4 - d))/
   ((-4 + 4*d)*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) + 
  (I*2^(-2 - d)*EL^6*gZNL^2*s*(d*s + 2*t)*
  ...
  (I*2^(-2 - 2*d)*EL^6*gZNL^2*s^2*
    (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s) + 2^(1 + d)*(-2 + d)*Pi^d*
           (4*s + t)) + gZuR*gZuRC*(-(d^2*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
           (2*(-1 + d)*s - (-4 + d)*t)))) + 
  ...
  (I*4^(-1 - d)*EL^6*gZNL^2*s*
    ...
    \[Mu]^(4 - d))/(Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)), 0, 0, 0, 0, 0, 0, 0, 
