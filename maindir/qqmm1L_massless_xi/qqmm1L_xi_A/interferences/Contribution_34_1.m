...
PropList[KiraPropagator[p1 - q1, 0], KiraPropagator[-p2 - q1, mz], 
  ...
  ((I*4^(-1 - d)*EL^6*gAl^2*gAu^2*(gZlR*(d^3*gZuL*(2*Pi)^d*s*(s - t) - 
        d^3*gZuR*(2*Pi)^d*s*(s - t) + 2^(1 + d)*gZuL*Pi^d*
         (-((-36 + 13*d + d^2)*s^2) + (24 + 7*d - 9*d^2 + 2*d^3)*s*t + 
          (-12 + 20*d - 8*d^2 + d^3)*t^2) + 2^(1 + d)*gZuR*Pi^d*
         ((-24 + 10*d + d^2)*s^2 + d*(-12 + 9*d - 2*d^2)*s*t - 
          (-24 + 22*d - 8*d^2 + d^3)*t^2)) + 
      gZlL*(d^3*gZuR*(2*Pi)^d*s*(s - t) - 2^(1 + d)*gZuR*Pi^d*
         ((-36 + 13*d + d^2)*s^2 - (24 + 7*d - 9*d^2 + 2*d^3)*s*t - 
          (-12 + 20*d - 8*d^2 + d^3)*t^2) + gZuL*(-(d^3*(2*Pi)^d*s*(s - t)) + 
          2^(1 + d)*Pi^d*((-24 + 10*d + d^2)*s^2 + d*(-12 + 9*d - 2*d^2)*s*
             t - (-24 + 22*d - 8*d^2 + d^3)*t^2))))*\[Mu]^(4 - d)*
   ...
   (I*4^(-1 - d)*EL^6*gAl^2*gAu^2*(s + t)*
     (gZlL*(-(2^(1 + d)*gZuR*Pi^d*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
            t - 4*t^2)) + 2^(1 + d)*gZuL*Pi^d*((-2 + d)^2*s^2 + 
          2*(8 - 5*d + d^2)*s*t + 4*t^2) + gZuL*mz^2*(d^3*(2*Pi)^d*s + 
          2^(1 + d)*Pi^d*((-8 + 14*d - 5*d^2)*s + (136 - 114*d + 32*d^2 - 
              3*d^3)*t)) + gZuR*mz^2*(-(d^3*(2*Pi)^d*s) + 
          2^(1 + d)*Pi^d*((28 - 19*d + 5*d^2)*s + (-116 + 108*d - 32*d^2 + 
              3*d^3)*t))) + gZlR*(2^(1 + d)*gZuR*Pi^d*((-2 + d)^2*s^2 + 
          2*(8 - 5*d + d^2)*s*t + 4*t^2) - gZuR*mz^2*(-(d^3*(2*Pi)^d*s) + 
          2^(1 + d)*Pi^d*((8 - 14*d + 5*d^2)*s + (-136 + 114*d - 32*d^2 + 
              3*d^3)*t)) + gZuL*(-(2^(1 + d)*Pi^d*((8 - 6*d + d^2)*s^2 + 
             2*(4 - 5*d + d^2)*s*t - 4*t^2)) + mz^2*(-(d^3*(2*Pi)^d*s) + 
            2^(1 + d)*Pi^d*((28 - 19*d + 5*d^2)*s + (-116 + 108*d - 32*d^2 + 
                3*d^3)*t)))))*\[Mu]^(4 - d)*SPList[SP[p2, p3]])/
    (mz^2*Pi^(2*d)*s) + (I*EL^6*gAl^2*gAu^2*
     (gZlR*(d^3*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*(2*(-2 + d)^2*s^2 + 
      ...
      2*(((2*Pi)^d*(s + t)*(-(gZlR*gZuL*((8 - 6*d + d^2)*s^2 + 
         ...
         mz^2 + gZlL*(d^3*gZuL*(2*Pi)^d*s^2 - d^3*gZuR*(2*Pi)^d*s^2 + 
          2^(1 + d)*gZuR*Pi^d*((-20 + 9*d + d^2)*s^2 - 2*(54 - 37*d + 6*d^2)*
             s*t - 4*(8 - 6*d + d^2)*t^2) + 2^(1 + d)*gZuL*Pi^d*
           (-((-16 + 6*d + d^2)*s^2) + 2*(60 - 37*d + 6*d^2)*s*t + 
            4*(10 - 6*d + d^2)*t^2)) + gZlR*(d^3*gZuR*(2*Pi)^d*s^2 - 
          2^(1 + d)*gZuR*Pi^d*((-16 + 6*d + d^2)*s^2 - 2*(60 - 37*d + 6*d^2)*
             s*t - 4*(10 - 6*d + d^2)*t^2) + gZuL*(-(d^3*(2*Pi)^d*s^2) + 
            2^(1 + d)*Pi^d*((-20 + 9*d + d^2)*s^2 - 2*(54 - 37*d + 6*d^2)*s*
               t - 4*(8 - 6*d + d^2)*t^2)))))*\[Mu]^(4 - d)*
     SPList[SP[p2, q1]])/(2^(2*(1 + d))*Pi^(2*d)*s) + 
   ...
   (I*EL^6*gAl^2*gAu^2*
    ...
    (2^(2*(1 + d))*Pi^(2*d)*s) + (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlL*(d^3*gZuL*(2*Pi)^d*(s - t) - 
        d^3*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuR*Pi^d*
         ((-56 + 41*d - 9*d^2 + d^3)*s + (-56 + 41*d - 9*d^2)*t) + 
        2^(1 + d)*gZuL*Pi^d*(-((-64 + 44*d - 9*d^2 + d^3)*s) + 
          (64 - 44*d + 9*d^2)*t)) + gZlR*(d^3*gZuR*(2*Pi)^d*(s - t) - 
        2^(1 + d)*gZuR*Pi^d*((-64 + 44*d - 9*d^2 + d^3)*s + 
          (-64 + 44*d - 9*d^2)*t) + gZuL*(-(d^3*(2*Pi)^d*(s - t)) + 
          2^(1 + d)*Pi^d*((-56 + 41*d - 9*d^2 + d^3)*s + (-56 + 41*d - 9*d^2)*
             t))))*\[Mu]^(4 - d)*SPList[SP[p1, p2], SP[p1, p3]])/
    ((2*Pi)^(2*d)*s) - (I*EL^6*gAl^2*gAu^2*
     (gZlL*(d^3*gZuL*(2*Pi)^d*(s - t) - d^3*gZuR*(2*Pi)^d*(s - t) + 
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlL*(d^3*gZuL*(2*Pi)^d*(s - t) - 
        ...
        2^(1 + d)*gZuR*Pi^d*((-64 + 44*d - 9*d^2 + d^3)*s + 
          (-64 + 44*d - 9*d^2)*t) + gZuL*(-(d^3*(2*Pi)^d*(s - t)) + 
          2^(1 + d)*Pi^d*((-56 + 41*d - 9*d^2 + d^3)*s + (-56 + 41*d - 9*d^2)*
             t))))*\[Mu]^(4 - d)*SPList[SP[p1, p2], SP[p2, p3]])/
    ((2*Pi)^(2*d)*s) - ((I/2)*EL^6*gAl^2*gAu^2*
     ((2^(1 - d)*(-4 + d)*((-4 - 2*d + d^2)*gZlL*gZuL + (2 + 2*d - d^2)*gZlR*
          gZuL + (2 + 2*d - d^2)*gZlL*gZuR + (-4 - 2*d + d^2)*gZlR*gZuR)*t)/
       Pi^d + (gZlL*(-((8 + 6*d - 6*d^2 + d^3)*gZuR*s) + 
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*
     (gZlR*(3*d^3*gZuL*(2*Pi)^d*s - 3*d^3*gZuR*(2*Pi)^d*s + 
      ...
      gZlL*(3*d^3*gZuR*(2*Pi)^d*s - 2^(1 + d)*gZuR*Pi^d*
        ...
        gZuL*(-3*d^3*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(3*(40 - 30*d + 7*d^2)*s - 
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlL*(d^3*gZuL*(2*Pi)^d*(s - t) - 
        ...
        2^(1 + d)*gZuR*Pi^d*((-64 + 44*d - 9*d^2 + d^3)*s + 
          (-64 + 44*d - 9*d^2)*t) + gZuL*(-(d^3*(2*Pi)^d*(s - t)) + 
          2^(1 + d)*Pi^d*((-56 + 41*d - 9*d^2 + d^3)*s + (-56 + 41*d - 9*d^2)*
             t))))*\[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p1, q1]])/
    ((2*Pi)^(2*d)*s) - (I*EL^6*gAl^2*gAu^2*
     (gZlL*(d^3*gZuL*(2*Pi)^d*(s - t) - d^3*gZuR*(2*Pi)^d*(s - t) + 
        2^(1 + d)*gZuR*Pi^d*((-56 + 41*d - 9*d^2 + d^3)*s + 
          (-56 + 41*d - 9*d^2)*t) + 2^(1 + d)*gZuL*Pi^d*
      ...
      gZlR*(d^3*gZuR*(2*Pi)^d*(s - t) - 2^(1 + d)*gZuR*Pi^d*
        ...
        gZuL*(-(d^3*(2*Pi)^d*(s - t)) + 2^(1 + d)*Pi^d*
           ((-56 + 41*d - 9*d^2 + d^3)*s + (-56 + 41*d - 9*d^2)*t))))*
     \[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p2, p3]])/((2*Pi)^(2*d)*s) + 
   ((I/2)*EL^6*gAl^2*gAu^2*((2^(1 - d)*(-4 + d)*((-4 - 2*d + d^2)*gZlL*gZuL + 
         (2 + 2*d - d^2)*gZlR*gZuL + (2 + 2*d - d^2)*gZlL*gZuR + 
         (-4 - 2*d + d^2)*gZlR*gZuR)*t)/Pi^d + 
      (gZlL*(-((8 + 6*d - 6*d^2 + d^3)*gZuR*s) + 2*(-52 + 44*d - 12*d^2 + 
            d^3)*gZuR*t + (-4 + d)*gZuL*((-4 - 2*d + d^2)*s - 
            2*(14 - 8*d + d^2)*t)) + 
        gZlR*(-((8 + 6*d - 6*d^2 + d^3)*gZuL*s) + 
          2*(-52 + 44*d - 12*d^2 + d^3)*gZuL*t + (-4 + d)*gZuR*
           ((-4 - 2*d + d^2)*s - 2*(14 - 8*d + d^2)*t)))/(2*Pi)^d)*
     \[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p2, q1]])/s + 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*
     (gZlL*(3*d^3*gZuL*(2*Pi)^d*s - 3*d^3*gZuR*(2*Pi)^d*s + 
      ...
      gZlR*(3*d^3*gZuR*(2*Pi)^d*s - 2^(1 + d)*gZuR*Pi^d*
         (3*(40 - 30*d + 7*d^2)*s - (-56 + 46*d - 12*d^2 + d^3)*t) + 
        gZuL*(-3*d^3*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((108 - 85*d + 21*d^2)*s - 
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlL*(d^3*gZuL*(2*Pi)^d*(s - t) - 
        ...
        2^(1 + d)*gZuR*Pi^d*((-64 + 44*d - 9*d^2 + d^3)*s + 
          (-64 + 44*d - 9*d^2)*t) + gZuL*(-(d^3*(2*Pi)^d*(s - t)) + 
          2^(1 + d)*Pi^d*((-56 + 41*d - 9*d^2 + d^3)*s + (-56 + 41*d - 9*d^2)*
             t))))*\[Mu]^(4 - d)*SPList[SP[p1, q1], SP[p2, p3]])/
    ((2*Pi)^(2*d)*s) - ((I/2)*EL^6*gAl^2*gAu^2*
     ((2^(1 - d)*(-4 + d)*((-4 - 2*d + d^2)*gZlL*gZuL + (2 + 2*d - d^2)*gZlR*
          gZuL + (2 + 2*d - d^2)*gZlL*gZuR + (-4 - 2*d + d^2)*gZlR*gZuR)*t)/
       Pi^d + (gZlL*(-((8 + 6*d - 6*d^2 + d^3)*gZuR*s) + 
        ...
        gZlR*(-((8 + 6*d - 6*d^2 + d^3)*gZuL*s) + 
          2*(-52 + 44*d - 12*d^2 + d^3)*gZuL*t + (-4 + d)*gZuR*
           ((-4 - 2*d + d^2)*s - 2*(14 - 8*d + d^2)*t)))/(2*Pi)^d)*
     \[Mu]^(4 - d)*SPList[SP[p1, q1], SP[p2, q1]])/s + 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*
     (gZlR*(3*d^3*gZuL*(2*Pi)^d*s - 3*d^3*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuL*Pi^d*((-108 + 85*d - 21*d^2)*s + 
          (-52 + 44*d - 12*d^2 + d^3)*t) + 2^(1 + d)*gZuR*Pi^d*
   ...
   ((I/2)*EL^6*gAl^2*gAu^2*((2^(2 - d)*(-4 + d)*((-4 - 2*d + d^2)*gZlL*gZuL + 
      ...
      (2^(1 - 2*d)*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
       ...
       (mz^2*Pi^(2*d)))*\[Mu]^(4 - d)*SPList[SP[p2, p3], SP[p2, p3]])/s + 
   ((I/2)*EL^6*gAl^2*gAu^2*((2^(2 - d)*(-4 + d)*((-4 - 2*d + d^2)*gZlL*gZuL + 
         (2 + 2*d - d^2)*gZlR*gZuL + (2 + 2*d - d^2)*gZlL*gZuR + 
         (-4 - 2*d + d^2)*gZlR*gZuR)*t)/Pi^d + 
      (-((-4 + d)*gZlL*gZuL*((-4 - 2*d + d^2)*s + 12*(-3 + d)*t)) - 
       ...
       (2*Pi)^d - (2^(1 - 2*d)*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - 
         ...
         gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
           2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 
             ...
             (8 - 5*d + d^2)*s*t + 2*t^2))))/(mz^2*Pi^(2*d)))*\[Mu]^(4 - d)*
     SPList[SP[p2, p3], SP[p2, q1]])/s - 
   ((I/2)*EL^6*gAl^2*gAu^2*((2^(2 - d)*(-4 + d)*((-4 - 2*d + d^2)*gZlL*gZuL + 
         (2 + 2*d - d^2)*gZlR*gZuL + (2 + 2*d - d^2)*gZlL*gZuR + 
         (-4 - 2*d + d^2)*gZlR*gZuR)*t)/Pi^d - 
      ...
      (3*((-4 + d)*gZlL*gZuL*((-4 - 2*d + d^2)*s + 12*(-3 + d)*t) + 
         (-4 + d)*gZlR*gZuR*((-4 - 2*d + d^2)*s + 12*(-3 + d)*t) - 
         gZlR*gZuL*((8 + 6*d - 6*d^2 + d^3)*s + 4*(30 - 19*d + 3*d^2)*t) - 
         gZlL*gZuR*((8 + 6*d - 6*d^2 + d^3)*s + 4*(30 - 19*d + 3*d^2)*t)))/
       (2*Pi)^d - (2^(1 - 2*d)*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - 
         ...
         gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
           2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 
             2*t^2) + 2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + 
             (8 - 5*d + d^2)*s*t + 2*t^2))))/(mz^2*Pi^(2*d)))*\[Mu]^(4 - d)*
     SPList[SP[p2, p3], SP[p3, q1]])/s - 
   (I*2^(-1 - d)*(-4 + d)*EL^6*gAl^2*gAu^2*((-4 - 2*d + d^2)*gZlL*gZuL + 
      (2 + 2*d - d^2)*gZlR*gZuL + (2 + 2*d - d^2)*gZlL*gZuR + 
      (-4 - 2*d + d^2)*gZlR*gZuR)*t*\[Mu]^(4 - d)*SPList[SP[p2, q1], 
      SP[p2, q1]])/(Pi^d*s) - (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*
     (gZlL*(d^3*gZuL*(2*Pi)^d*s - d^3*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuR*Pi^d*((-4 - 3*d + 3*d^2)*s + 
          (-52 + 44*d - 12*d^2 + d^3)*t) + 2^(1 + d)*gZuL*Pi^d*
         ((8 + 2*d - 3*d^2)*s - (-56 + 46*d - 12*d^2 + d^3)*t)) + 
      gZlR*(-(d^3*gZuL*(2*Pi)^d*s) + d^3*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuL*Pi^d*((-4 - 3*d + 3*d^2)*s + 
          (-52 + 44*d - 12*d^2 + d^3)*t) + 2^(1 + d)*gZuR*Pi^d*
         ((8 + 2*d - 3*d^2)*s - (-56 + 46*d - 12*d^2 + d^3)*t)))*
     \[Mu]^(4 - d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*
  ...
  ((I*2^(-1 - d)*EL^6*gAl^2*gAu^2*(s + t)*
   ...
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - t)) + d*gZuR*(2*Pi)^d*s*(s - t) + 
        2^(1 + d)*gZuL*Pi^d*((-1 + d)*s^2 + t^2) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + 3*s*t + t^2)) - 
      gZlR*(d*gZuR*(2*Pi)^d*s*(s - t) - 2^(1 + d)*gZuR*Pi^d*
         ((-1 + d)*s^2 + t^2) + gZuL*(-(d*(2*Pi)^d*s*(s - t)) + 
   ...
   (I*2^(-1 - d)*EL^6*gAl^2*gAu^2*
     (gZlR*(-(gZuR*((-2 + d)*s - 6*t)*(s + t)^2) + gZuL*(s + t)^2*
         ((-4 + d)*s + 6*t) - 2*gZuL*mz^2*((8 - 6*d + d^2)*s^2 + 
          2*(4 - 5*d + d^2)*s*t - 4*t^2) + 2*gZuR*mz^2*((-2 + d)^2*s^2 + 
          2*(8 - 5*d + d^2)*s*t + 4*t^2)) + 
      gZlL*(gZuR*(s + t)^2*((-4 + d)*s + 6*t) - 2*gZuR*mz^2*
         ((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) + 
        gZuL*(-(((-2 + d)*s - 6*t)*(s + t)^2) + 2*mz^2*((-2 + d)^2*s^2 + 
   ...
   ((I/2)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (-((4^(1 - d)*((2*Pi)^d*s*(s + t)*(gZlL*((-2 + d)*gZuL*s - 
        ...
        Pi^(2*d)) + ((s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s*(s - t)) + 
       ...
       (2*Pi)^(2*d) + 
      3*((2^(1 - 2*d)*mz^2*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*
    ...
    (mz^2*(s - s*GaugeXi[Q])) - (I*2^(-2 - d)*EL^6*gAl^2*gAu^2*(s + t)*
     ...
     (-1 + GaugeXi[Q])*SPList[SP[p2, p3], SP[q1, q1]])/(mz^2*Pi^d*s) + 
   (I/2)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
    ((2^(1 - 2*d)*(((2*Pi)^d*(s + t)*(gZlL*((-2 + d)*gZuL*s - 
             (-4 + d)*gZuR*s + 2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t) + 
           gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
             2*(-3 + d)*gZuR*t)))/mz^2 + 
        (gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
     ...
     ((2^(1 - 2*d)*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
       ...
       (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
        ...
        (mz^2*(2*Pi)^(2*d)*(-1 + GaugeXi[Q])))/s)*
    SPList[SP[p2, q1], SP[p2, q1]] - (I*2^(-1 - d)*EL^6*gAl^2*gAu^2*(s + t)*
     (gZlL*(gZuL*(3*(-2 + d)*s^2 + 5*(-4 + d)*s*t - 6*t^2) + 
        gZuR*(-3*(-4 + d)*s^2 - 5*(-2 + d)*s*t - 6*t^2)) - 
      gZlR*(gZuR*(-3*(-2 + d)*s^2 - 5*(-4 + d)*s*t + 6*t^2) + 
        gZuL*(3*(-4 + d)*s^2 + 5*(-2 + d)*s*t + 6*t^2)))*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p2, q1], SP[p3, q1]])/(mz^2*Pi^d*s) + 
       ...
       (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
          ...
          (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*Pi^
            ...
            gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^
                d*(-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/
        (mz^2*(2*Pi)^(2*d)*(-1 + GaugeXi[Q])))/s)*
    SPList[SP[p2, q1], SP[q1, q1]] + ((I/2)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
   ...
   (I*EL^6*gAl^2*gAu^2*
    ...
    (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^6*gAl^2*gAu^2*(s + t)*
     (gZlL*(2^(1 + d)*gZuL*Pi^d*((-2 + d)*s - 2*t) - d*gZuL*(2*Pi)^d*
         (s - t) + d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuR*Pi^d*
         (s - d*s + t)) - gZlR*(-(d*gZuL*(2*Pi)^d*(s - t)) + 
        d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuL*Pi^d*((-1 + d)*s - t) + 
        2^(1 + d)*gZuR*Pi^d*(-((-2 + d)*s) + 2*t)))*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, p2], SP[p2, p3]])/
    (mz^2*(2*Pi)^(2*d)*s) - (I*EL^6*gAl^2*gAu^2*(s + t)*
     (gZlL*(2^(1 + d)*gZuL*Pi^d*((-2 + d)*s - 2*t) - d*gZuL*(2*Pi)^d*
         (s - t) + d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuR*Pi^d*
         (s - d*s + t)) - gZlR*(-(d*gZuL*(2*Pi)^d*(s - t)) + 
        d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuL*Pi^d*((-1 + d)*s - t) + 
    ...
    (mz^2*(2*Pi)^(2*d)*s) - (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*(s + t)*
     (gZlL*(2^(1 + d)*gZuL*Pi^d*((-2 + d)*s - 2*t) - d*gZuL*(2*Pi)^d*
         (s - t) + d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuR*Pi^d*
         (s - d*s + t)) - gZlR*(-(d*gZuL*(2*Pi)^d*(s - t)) + 
        d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuL*Pi^d*((-1 + d)*s - t) + 
   ...
   (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
    ...
    (mz^2*Pi^d*s) - (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - 
     ...
     \[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, p3], 
      SP[p3, q1]])/(mz^2*Pi^d*s) + (I*EL^6*gAl^2*gAu^2*(s + t)*
     (gZlL*(2^(1 + d)*gZuL*Pi^d*((-2 + d)*s - 2*t) - d*gZuL*(2*Pi)^d*
         (s - t) + d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuR*Pi^d*
         (s - d*s + t)) - gZlR*(-(d*gZuL*(2*Pi)^d*(s - t)) + 
        d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuL*Pi^d*((-1 + d)*s - t) + 
    ...
    (mz^2*(2*Pi)^(2*d)*s) + (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((2^(1 - d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
      ...
      (2^(2 - d)*(gZlL*gZuL*((-2 + d)*s^2 - 2*t^2) + 
       ...
       (2*Pi)^(2*d) + (gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
      ...
      SP[p2, p3]])/(mz^2*s*(-1 + GaugeXi[Q])) + 
   (I*2^(2 - d)*(-3 + d)*EL^6*gAl^2*gAu^2*(gZlL - gZlR)*(gZuL - gZuR)*
     (s + t)^2*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p2, p3], 
      SP[p2, q1]])/(mz^2*Pi^d*s) + (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
     \[Mu]^(4 - d)*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
        2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + (8 - 3*d)*s*t + t^2) + 
        2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2)) - 
      gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
          (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 
          2^(1 + d)*Pi^d*((-4 + d)*s^2 + (-8 + 3*d)*s*t - t^2))) + 
      2^(1 + d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
        (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*Pi^d*t*(s + t)*
       (-1 + GaugeXi[Q])^2 + 2^(2 + d)*(gZlL + gZlR)*(gZuL + gZuR)*Pi^d*
       (s + t)^2*(-1 + GaugeXi[Q])^2 - 3*(2*Pi)^d*t*
       (gZlL*(2*(-2 + d)*gZuL*s - 2*(-4 + d)*gZuR*s + d*gZuL*t - 
          (-6 + d)*gZuR*t) + gZlR*(-2*(-4 + d)*gZuL*s + 2*(-2 + d)*gZuR*s - 
          (-6 + d)*gZuL*t + d*gZuR*t))*(-1 + GaugeXi[Q])^2 - 
      3*(2*Pi)^d*(gZlL*gZuL*((-2 + d)*s^2 - 2*t^2) + 
        gZlR*gZuR*((-2 + d)*s^2 - 2*t^2) - gZlR*gZuL*((-4 + d)*s^2 + 2*t^2) - 
        gZlL*gZuR*((-4 + d)*s^2 + 2*t^2))*(-1 + GaugeXi[Q])^2 - 
   ...
   (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
      ...
      (2^(1 - d)*(gZlL + gZlR)*(gZuL + gZuR)*(s + t)^2*(-1 + GaugeXi[Q])^2)/
       Pi^d - (2^(1 - d)*t*(gZlL*(2*(-2 + d)*gZuL*s - 2*(-4 + d)*gZuR*s + 
           d*gZuL*t - (-6 + d)*gZuR*t) + gZlR*(-2*(-4 + d)*gZuL*s + 
           2*(-2 + d)*gZuR*s - (-6 + d)*gZuL*t + d*gZuR*t))*
        (-1 + GaugeXi[Q])^2)/Pi^d - 
   ...
   (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((2^(1 - d)*t*(gZlL*(2*(-2 + d)*gZuL*s - 2*(-4 + d)*gZuR*s + d*gZuL*t - 
           (-6 + d)*gZuR*t) + gZlR*(-2*(-4 + d)*gZuL*s + 2*(-2 + d)*gZuR*s - 
           (-6 + d)*gZuL*t + d*gZuR*t))*(-1 + GaugeXi[Q])^2)/Pi^d + 
      (2^(1 - d)*(gZlL*gZuL*((-2 + d)*s^2 - 2*t^2) + 
         gZlR*gZuR*((-2 + d)*s^2 - 2*t^2) - gZlR*gZuL*((-4 + d)*s^2 + 
           2*t^2) - gZlL*gZuR*((-4 + d)*s^2 + 2*t^2))*(-1 + GaugeXi[Q])^2)/
       Pi^d + (s*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
   ...
   (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
     (-(gZlR*(d*gZuR*(2*Pi)^d*(s^2 + t^2) - 2^(1 + d)*gZuR*Pi^d*
          (2*s^2 - (-4 + d)*s*t + 2*t^2) + gZuL*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
           2^(1 + d)*Pi^d*(s^2 - (-2 + d)*s*t + t^2)))) + 
      gZlL*(d*gZuR*(2*Pi)^d*(s^2 + t^2) - 2^(1 + d)*gZuR*Pi^d*
         (s^2 - (-2 + d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*(s^2 + t^2)) + 
          2^(1 + d)*Pi^d*(2*s^2 - (-4 + d)*s*t + 2*t^2))))*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p2, q1], SP[p3, q1]])/
    (mz^2*Pi^(2*d)*s) + (I*EL^6*gAl^2*gAu^2*t*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*(3*s + t)) + d*gZuR*(2*Pi)^d*(3*s + t) - 
        2^(1 + d)*gZuR*Pi^d*(s + d*s + t) + 2^(1 + d)*gZuL*Pi^d*
         ((2 + d)*s + 2*t)) - gZlR*(d*gZuR*(2*Pi)^d*(3*s + t) - 
        2^(1 + d)*gZuR*Pi^d*((2 + d)*s + 2*t) + 
        gZuL*(-(d*(2*Pi)^d*(3*s + t)) + 2^(1 + d)*Pi^d*(s + d*s + t))) + 
      2^(1 + d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
        (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*Pi^d*(s + t)*GaugeXi[Q] + 
      (gZlL*(-(d*gZuL*(2*Pi)^d*(3*s + t)) + d*gZuR*(2*Pi)^d*(3*s + t) - 
          2^(1 + d)*gZuR*Pi^d*(s + d*s + t) + 2^(1 + d)*gZuL*Pi^d*
           ((2 + d)*s + 2*t)) - gZlR*(d*gZuR*(2*Pi)^d*(3*s + t) - 
          2^(1 + d)*gZuR*Pi^d*((2 + d)*s + 2*t) + 
   ...
   (I*EL^6*gAl^2*gAu^2*(s + t)*(d*gZlR*(gZuL - gZuR)*s + 
   ...
   (I*2^(1 - d)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)*(gZuL + gZuR)*(s + t)^2*
     \[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p3, q1], 
      SP[q1, q1]])/(mz^2*Pi^d*s) + (I*4^(-1 - d)*EL^6*gAl^2*gAu^2*(s + t)*
     \[Mu]^(4 - d)*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
       ...
       GaugeXi[Q] + (gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
          2^(1 + d)*gZuR*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZuL*Pi^d*
           ((-1 + d)*s + t)) + gZlR*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
          2^(1 + d)*gZuL*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZuR*Pi^d*
           ((-1 + d)*s + t)))*GaugeXi[Q]^2)*SPList[SP[p1, p2], SP[q1, q1], 
   ...
   (I*EL^6*gAl^2*gAu^2*(s + t)*
    ...
    (mz^2*Pi^(2*d)*s) - (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
     ((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
      (-4 + d)*gZlR*gZuR)*(s + t)^2*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p3], SP[p1, q1], SP[p2, p3]])/(mz^2*Pi^d*s) + 
   (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
      (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*(s + t)^2*\[Mu]^(4 - d)*
        ...
        2*(-(gZlR*(5*d*gZuL*(2*Pi)^d*s*t - 5*d*gZuR*(2*Pi)^d*s*t + 
         ...
         GaugeXi[Q] + (gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
          ...
          gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
              (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 
              2^(1 + d)*Pi^d*((-4 + d)*s^2 + (-8 + 3*d)*s*t - t^2))))*
         GaugeXi[Q]^2)/(2*Pi)^(2*d))*SPList[SP[p1, p3], SP[p2, p3], 
      SP[p2, p3]])/(mz^2*s*(-1 + GaugeXi[Q])) - 
   (I*2^(2 - d)*(-3 + d)*EL^6*gAl^2*gAu^2*(gZlL - gZlR)*(gZuL - gZuR)*
     (s + t)^2*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p1, p3], SP[p2, p3], 
      SP[p2, q1]])/(mz^2*Pi^d*s) - (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
     \[Mu]^(4 - d)*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
        2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + (8 - 3*d)*s*t + t^2) + 
        2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
        ...
        gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
            (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 
            2^(1 + d)*Pi^d*((-4 + d)*s^2 + (-8 + 3*d)*s*t - t^2))))*
       GaugeXi[Q]^2)*SPList[SP[p1, p3], SP[p2, p3], SP[p3, q1]])/
    (mz^2*Pi^(2*d)*s*(-1 + GaugeXi[Q])) + 
   (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
         (-4 + d)*gZlR*gZuR)*t*(s + t)*(-1 + GaugeXi[Q])^2)/(2*Pi)^d + 
     ...
     \[Mu]^(4 - d)*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
       ...
       GaugeXi[Q] + (gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
          2^(1 + d)*gZuR*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZuL*Pi^d*
           ((-1 + d)*s + t)) + gZlR*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
          2^(1 + d)*gZuL*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZuR*Pi^d*
           ((-1 + d)*s + t)))*GaugeXi[Q]^2)*SPList[SP[p1, p3], SP[q1, q1], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s*(-1 + GaugeXi[Q])) + 
   (I*EL^6*gAl^2*gAu^2*(s + t)*
     (gZlL*(2^(1 + d)*gZuL*Pi^d*((-2 + d)*s - 2*t) - d*gZuL*(2*Pi)^d*
         (s - t) + d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuR*Pi^d*
    ...
    (mz^2*Pi^(2*d)*s) + (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((2^(1 - d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
         (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*t*(s + t)*
        (-1 + GaugeXi[Q])^2)/Pi^d + (2^(2 - d)*(gZlL + gZlR)*(gZuL + gZuR)*
        (s + t)^2*(-1 + GaugeXi[Q])^2)/Pi^d - 
      ...
      SP[p2, p3]])/(mz^2*s*(-1 + GaugeXi[Q])) + 
   (I*2^(2 - d)*(-3 + d)*EL^6*gAl^2*gAu^2*(gZlL - gZlR)*(gZuL - gZuR)*
     (s + t)^2*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, p3], 
      SP[p2, q1]])/(mz^2*Pi^d*s) + (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
     \[Mu]^(4 - d)*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
        2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + (8 - 3*d)*s*t + t^2) + 
        2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2)) - 
     ...
     \[Mu]^(4 - d)*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
       ...
       GaugeXi[Q] + (gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
          2^(1 + d)*gZuR*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZuL*Pi^d*
           ((-1 + d)*s + t)) + gZlR*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
          2^(1 + d)*gZuL*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZuR*Pi^d*
           ((-1 + d)*s + t)))*GaugeXi[Q]^2)*SPList[SP[p1, q1], SP[q1, q1], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s*(-1 + GaugeXi[Q])) + 
   (I*EL^6*gAl^2*gAu^2*(gZlR*(d*gZuL*(2*Pi)^d*(s - t)*t - 
        d*gZuR*(2*Pi)^d*(s - t)*t + 2^(1 + d)*gZuR*Pi^d*(-((-1 + d)*s^2) + 
          4*s*t + 3*t^2) + 2^(1 + d)*gZuL*Pi^d*((-5 + d)*s^2 + s*t + 
          6*t^2)) + gZlL*(-(d*gZuL*(2*Pi)^d*(s - t)*t) + 
        d*gZuR*(2*Pi)^d*(s - t)*t + 2^(1 + d)*gZuL*Pi^d*(-((-1 + d)*s^2) + 
          4*s*t + 3*t^2) + 2^(1 + d)*gZuR*Pi^d*((-5 + d)*s^2 + s*t + 6*t^2)))*
     \[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p2, p3], SP[p2, p3], 
      SP[p2, p3]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((3*2^(1 - d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
      ...
      (2^(3 - d)*t*(gZlL*(2*(-2 + d)*gZuL*s - 2*(-4 + d)*gZuR*s + d*gZuL*t - 
           (-6 + d)*gZuR*t) + gZlR*(-2*(-4 + d)*gZuL*s + 2*(-2 + d)*gZuR*s - 
           (-6 + d)*gZuL*t + d*gZuR*t))*(-1 + GaugeXi[Q])^2)/Pi^d + 
      (3*2^(1 - 2*d)*s*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
       ...
       Pi^(2*d) + (2^(1 - 2*d)*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*Pi^d*(-s + t) + 
           2^(1 + d)*gZuL*Pi^d*(2*s + t)) + gZlL*(d*gZuL*(2*Pi)^d*s - 
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(-s + t) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/
       Pi^(2*d) + (5*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
           2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + (8 - 3*d)*s*t + t^2) + 
           2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2)) - 
         gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
             (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 
         ...
         2*(-(gZlR*(5*d*gZuL*(2*Pi)^d*s*t - 5*d*gZuR*(2*Pi)^d*s*t + 
          ...
          GaugeXi[Q] + (gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
             ...
             2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2)) - 
           gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
               (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 2^(1 + d)*
                Pi^d*((-4 + d)*s^2 + (-8 + 3*d)*s*t - t^2))))*GaugeXi[Q]^2))/
       (2*Pi)^(2*d))*SPList[SP[p2, p3], SP[p2, p3], SP[p2, q1]])/
    (mz^2*s*(-1 + GaugeXi[Q])) - (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((5*2^(1 - d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
         (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*t*(s + t)*
        (-1 + GaugeXi[Q])^2)/Pi^d - 
      ...
      (3*2^(1 - 2*d)*s*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(2*s - (-3 + d)*t) + 
           2^(1 + d)*gZuR*Pi^d*(-s + (-3 + d)*t)))*(-1 + GaugeXi[Q])^2)/
       Pi^(2*d) - (3*(s + t)*(-(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
            d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*Pi^d*(-s + t) + 
            2^(1 + d)*gZuL*Pi^d*(2*s + t))) + gZlL*(-(d*gZuL*(2*Pi)^d*s) + 
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(s - t) - 
           2^(1 + d)*gZuR*Pi^d*(2*s + t)) + 2^(1 + d)*Pi^d*
      ...
      (5*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
           2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + (8 - 3*d)*s*t + t^2) + 
           2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2)) - 
         gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
             (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 
    ...
    (mz^2*s*(-1 + GaugeXi[Q])) + ((I/2)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
      ...
      (3*2^(1 - 2*d)*s*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
       ...
       Pi^(2*d) + (2^(1 - 2*d)*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/
       Pi^(2*d) + (4^(1 - d)*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + 
           d*gZuR*(2*Pi)^d*s*t + 2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + 
             (8 - 3*d)*s*t + t^2) + 2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + 
             (-7 + 3*d)*s*t + t^2)) - gZlR*(d*gZuR*(2*Pi)^d*s*t - 
           2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2) + 
           gZuL*(-(d*(2*Pi)^d*s*t) + 2^(1 + d)*Pi^d*((-4 + d)*s^2 + 
               (-8 + 3*d)*s*t - t^2))) - 
         2*(-(gZlR*(5*d*gZuL*(2*Pi)^d*s*t - 5*d*gZuR*(2*Pi)^d*s*t + 
              2^(1 + d)*gZuL*Pi^d*((-4 + d)*s^2 - 8*s*t - t^2) - 
              2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 - 7*s*t + t^2))) + 
          ...
          GaugeXi[Q] + (gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
           ...
           gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
               (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 2^(1 + d)*
                Pi^d*((-4 + d)*s^2 + (-8 + 3*d)*s*t - t^2))))*GaugeXi[Q]^2))/
       Pi^(2*d))*SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/
    (mz^2*s*(-1 + GaugeXi[Q])) - (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((2^(1 - d)*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
         (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*t*(s + t)*
        (-1 + GaugeXi[Q])^2)/Pi^d - 
      (5*t*(gZlL*(2*(-2 + d)*gZuL*s - 2*(-4 + d)*gZuR*s + d*gZuL*t - 
           (-6 + d)*gZuR*t) + gZlR*(-2*(-4 + d)*gZuL*s + 2*(-2 + d)*gZuR*s - 
           (-6 + d)*gZuL*t + d*gZuR*t))*(-1 + GaugeXi[Q])^2)/(2*Pi)^d + 
      (3*2^(1 - 2*d)*s*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           2^(1 + d)*gZuL*Pi^d*(s - (-3 + d)*t) + 2^(1 + d)*gZuR*Pi^d*
            (-2*s + (-3 + d)*t)) - gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(2*s - (-3 + d)*t) + 
           2^(1 + d)*gZuR*Pi^d*(-s + (-3 + d)*t)))*(-1 + GaugeXi[Q])^2)/
       Pi^(2*d) - ((s + t)*(-(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
            d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*Pi^d*(-s + t) + 
            2^(1 + d)*gZuL*Pi^d*(2*s + t))) + gZlL*(-(d*gZuL*(2*Pi)^d*s) + 
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(s - t) - 
           2^(1 + d)*gZuR*Pi^d*(2*s + t)) + 2^(1 + d)*Pi^d*
          ...
          GaugeXi[Q] + (-(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
             ...
             2^(1 + d)*gZuL*Pi^d*(s - t) - 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*
          GaugeXi[Q]^2))/(2*Pi)^(2*d) + 
      (4^(1 - d)*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
           2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + (8 - 3*d)*s*t + t^2) + 
           2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2)) - 
         gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
             (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 
         ...
         2*(-(gZlR*(5*d*gZuL*(2*Pi)^d*s*t - 5*d*gZuR*(2*Pi)^d*s*t + 
          ...
          GaugeXi[Q] + (gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
           ...
           gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
               (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 2^(1 + d)*
                Pi^d*((-4 + d)*s^2 + (-8 + 3*d)*s*t - t^2))))*GaugeXi[Q]^2))/
       Pi^(2*d))*SPList[SP[p2, p3], SP[p2, q1], SP[p2, q1]])/
    (mz^2*s*(-1 + GaugeXi[Q])) - (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*
     \[Mu]^(4 - d)*(gZlL*(-(2^(1 + d)*gZuR*Pi^d*((7 + 2*d)*s^2 + 
           (3 + d)*s*t - 5*t^2)) + d*gZuR*(2*Pi)^d*(7*s^2 + 5*s*t - t^2) + 
        gZuL*(-(d*(2*Pi)^d*(7*s^2 + 5*s*t - t^2)) + 2^(1 + d)*Pi^d*
           (2*(1 + d)*s^2 + (6 + d)*s*t + 2*t^2))) + 
      gZlR*(-(2^(1 + d)*gZuL*Pi^d*((7 + 2*d)*s^2 + (3 + d)*s*t - 5*t^2)) + 
        d*gZuL*(2*Pi)^d*(7*s^2 + 5*s*t - t^2) + 
        gZuR*(-(d*(2*Pi)^d*(7*s^2 + 5*s*t - t^2)) + 2^(1 + d)*Pi^d*
           (2*(1 + d)*s^2 + (6 + d)*s*t + 2*t^2))) - 
      2*(gZlL*(-(2^(1 + d)*gZuR*Pi^d*(7*s^2 + 3*s*t - 5*t^2)) - 
       ...
       GaugeXi[Q] + 
      (gZlL*(-(2^(1 + d)*gZuR*Pi^d*((7 + 2*d)*s^2 + (3 + d)*s*t - 5*t^2)) + 
          d*gZuR*(2*Pi)^d*(7*s^2 + 5*s*t - t^2) + 
          gZuL*(-(d*(2*Pi)^d*(7*s^2 + 5*s*t - t^2)) + 2^(1 + d)*Pi^d*
             (2*(1 + d)*s^2 + (6 + d)*s*t + 2*t^2))) + 
        gZlR*(-(2^(1 + d)*gZuL*Pi^d*((7 + 2*d)*s^2 + (3 + d)*s*t - 5*t^2)) + 
          d*gZuL*(2*Pi)^d*(7*s^2 + 5*s*t - t^2) + 
          gZuR*(-(d*(2*Pi)^d*(7*s^2 + 5*s*t - t^2)) + 2^(1 + d)*Pi^d*
             (2*(1 + d)*s^2 + (6 + d)*s*t + 2*t^2))))*GaugeXi[Q]^2)*
   ...
   (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
      ...
      (3*2^(1 - 2*d)*s*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
       ...
       Pi^(2*d) - ((s + t)*(-(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (-(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
             ...
             2^(1 + d)*gZuL*Pi^d*(s - t) - 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*
          GaugeXi[Q]^2))/(2*Pi)^(2*d) + 
      (3*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
           2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + (8 - 3*d)*s*t + t^2) + 
           2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2)) - 
         gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
             (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 
    ...
    (mz^2*s*(-1 + GaugeXi[Q])) + 
   (I*EL^6*gAl^2*gAu^2*(gZlR*(3*d*gZuL*(2*Pi)^d*s*t - 3*d*gZuR*(2*Pi)^d*s*t - 
        2^(1 + d)*gZuR*Pi^d*((1 + d)*s^2 - 4*s*t - 3*t^2) + 
        2^(1 + d)*gZuL*Pi^d*((-7 + d)*s^2 - 5*s*t + 3*t^2)) + 
      gZlL*(-3*d*gZuL*(2*Pi)^d*s*t + 3*d*gZuR*(2*Pi)^d*s*t - 
        2^(1 + d)*gZuL*Pi^d*((1 + d)*s^2 - 4*s*t - 3*t^2) + 
        2^(1 + d)*gZuR*Pi^d*((-7 + d)*s^2 - 5*s*t + 3*t^2)))*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p2, p3], SP[p3, q1], SP[p3, q1]])/
    (mz^2*(2*Pi)^(2*d)*s) + (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (d*(gZlL - gZlR)*(gZuL - gZuR)*s*(-((2*Pi)^d*s) + 
        2^(1 + d)*Pi^d*(s + t)) + 2^(1 + d)*Pi^d*(gZlL*gZuL*t*(-s + t) + 
        gZlR*gZuR*t*(-s + t) + gZlR*gZuL*(3*s^2 + 5*s*t + t^2) + 
        gZlL*gZuR*(3*s^2 + 5*s*t + t^2)) - 
      2*(gZlR*(-(d*gZuL*(2*Pi)^d*s^2) - 2^(1 + d)*gZuR*Pi^d*(s - t)*t + 
          d*gZuR*s*((2*Pi)^d*s + 2^(1 + d)*Pi^d*t) + 2^(1 + d)*gZuL*Pi^d*
           (3*s^2 - (-5 + d)*s*t + t^2)) + gZlL*(-(d*gZuR*(2*Pi)^d*s^2) - 
          2^(1 + d)*gZuL*Pi^d*(s - t)*t + d*gZuL*s*((2*Pi)^d*s + 
            2^(1 + d)*Pi^d*t) + 2^(1 + d)*gZuR*Pi^d*(3*s^2 - (-5 + d)*s*t + 
            t^2)))*GaugeXi[Q] + (d*(gZlL - gZlR)*(gZuL - gZuR)*s*
         (-((2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + t)) + 2^(1 + d)*Pi^d*
         (gZlL*gZuL*t*(-s + t) + gZlR*gZuR*t*(-s + t) + 
          gZlR*gZuL*(3*s^2 + 5*s*t + t^2) + gZlL*gZuR*(3*s^2 + 5*s*t + t^2)))*
       GaugeXi[Q]^2)*SPList[SP[p2, p3], SP[p3, q1], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)*s*(-1 + GaugeXi[Q])) - 
   (I*4^(-1 - d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(5*s + t)) + d*gZuR*(2*Pi)^d*s*(5*s + t) + 
        2^(1 + d)*gZuR*Pi^d*(-2*(1 + d)*s^2 + s*t + 3*t^2) + 
        2^(1 + d)*gZuL*Pi^d*((1 + 2*d)*s^2 + 4*s*t + 3*t^2)) - 
      gZlR*(d*gZuR*(2*Pi)^d*s*(5*s + t) - 2^(1 + d)*gZuR*Pi^d*
         ((1 + 2*d)*s^2 + 4*s*t + 3*t^2) + gZuL*(-(d*(2*Pi)^d*s*(5*s + t)) + 
          2^(1 + d)*Pi^d*(2*(1 + d)*s^2 - s*t - 3*t^2))) - 
      2*(s + t)*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
          2^(1 + d)*gZuR*Pi^d*(-2*s + 3*t) + 2^(1 + d)*gZuL*Pi^d*(s + 3*t)) + 
        gZlR*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(5*s + t)) + d*gZuR*(2*Pi)^d*s*(5*s + t) + 
          ...
          2^(1 + d)*gZuL*Pi^d*((1 + 2*d)*s^2 + 4*s*t + 3*t^2)) - 
        gZlR*(d*gZuR*(2*Pi)^d*s*(5*s + t) - 2^(1 + d)*gZuR*Pi^d*
           ((1 + 2*d)*s^2 + 4*s*t + 3*t^2) + 
          gZuL*(-(d*(2*Pi)^d*s*(5*s + t)) + 2^(1 + d)*Pi^d*(2*(1 + d)*s^2 - 
              s*t - 3*t^2))))*GaugeXi[Q]^2)*SPList[SP[p2, p3], SP[q1, q1], 
      SP[q1, q1]])/(mz^2*Pi^(2*d)*s*(-1 + GaugeXi[Q])) + 
   ...
   (I*EL^6*gAl^2*gAu^2*(s + t)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s - 
    ...
    (mz^2*(2*Pi)^d*s) - ((I/2)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((t*(gZlL*(2*(-2 + d)*gZuL*s - 2*(-4 + d)*gZuR*s + d*gZuL*t - 
           (-6 + d)*gZuR*t) + gZlR*(-2*(-4 + d)*gZuL*s + 2*(-2 + d)*gZuR*s - 
           (-6 + d)*gZuL*t + d*gZuR*t))*(-1 + GaugeXi[Q])^2)/((2*Pi)^d*s) + 
      (3*2^(1 - 2*d)*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
           2^(1 + d)*gZuR*Pi^d*(2*s - (-3 + d)*t) + 2^(1 + d)*gZuL*Pi^d*
            (-s + (-3 + d)*t)) + gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(2*s - (-3 + d)*t) + 
           2^(1 + d)*gZuR*Pi^d*(-s + (-3 + d)*t)))*(-1 + GaugeXi[Q])^2)/
       Pi^(2*d) - (2^(1 - 2*d)*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + 
           d*gZuR*(2*Pi)^d*s*t + 2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + 
             (8 - 3*d)*s*t + t^2) + 2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 + 
             (-7 + 3*d)*s*t + t^2)) - gZlR*(d*gZuR*(2*Pi)^d*s*t - 
           2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2) + 
         ...
         2*(-(gZlR*(5*d*gZuL*(2*Pi)^d*s*t - 5*d*gZuR*(2*Pi)^d*s*t + 
          ...
          GaugeXi[Q] + (gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
           ...
           gZlR*(d*gZuR*(2*Pi)^d*s*t - 2^(1 + d)*gZuR*Pi^d*((-2 + d)*s^2 + 
               (-7 + 3*d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*t) + 2^(1 + d)*
                Pi^d*((-4 + d)*s^2 + (-8 + 3*d)*s*t - t^2))))*GaugeXi[Q]^2))/
       (Pi^(2*d)*s))*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
    (mz^2*(-1 + GaugeXi[Q])) + (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (d*(gZlL - gZlR)*(gZuL - gZuR)*s*(2^(1 + d)*Pi^d*(s + 2*t) - 
        (2*Pi)^d*(s + 3*t)) + 2^(1 + d)*Pi^d*(s + t)*
       (gZlR*(3*gZuL*s - gZuL*t - gZuR*t) + gZlL*(3*gZuR*s - gZuL*t - 
          gZuR*t)) - 2*(s + t)*(gZlL*(-(d*gZuR*(2*Pi)^d*s) + 
          2^(1 + d)*gZuR*Pi^d*(3*s - t) + gZuL*(d*(2*Pi)^d*s - 
            2^(1 + d)*Pi^d*t)) + gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          2^(1 + d)*gZuL*Pi^d*(3*s - t) + gZuR*(d*(2*Pi)^d*s - 
            2^(1 + d)*Pi^d*t)))*GaugeXi[Q] + 
      (d*(gZlL - gZlR)*(gZuL - gZuR)*s*(2^(1 + d)*Pi^d*(s + 2*t) - 
          (2*Pi)^d*(s + 3*t)) + 2^(1 + d)*Pi^d*(s + t)*
         (gZlR*(3*gZuL*s - gZuL*t - gZuR*t) + gZlL*(3*gZuR*s - gZuL*t - 
            gZuR*t)))*GaugeXi[Q]^2)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)*s*(-1 + GaugeXi[Q])) + 
   (I*EL^6*gAl^2*gAu^2*
   ...
   (I*4^(-1 - d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlR*gZuR*(d*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*(2*(-2 + d)*s^2 + 
          (-11 + 3*d)*s*t - t^2)) - gZlR*gZuL*(d*(2*Pi)^d*s*t + 
        2^(1 + d)*Pi^d*(2*(-4 + d)*s^2 + (-10 + 3*d)*s*t + t^2)) + 
      gZlL*(gZuL*(d*(2*Pi)^d*s*t + 2^(1 + d)*Pi^d*(2*(-2 + d)*s^2 + 
            (-11 + 3*d)*s*t - t^2)) - gZuR*(d*(2*Pi)^d*s*t + 
          2^(1 + d)*Pi^d*(2*(-4 + d)*s^2 + (-10 + 3*d)*s*t + t^2))) - 
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlL*(d*gZuL*(2*Pi)^d*(s - 3*t) - 
        d*gZuR*(2*Pi)^d*(s - 3*t) + 2^(1 + d)*gZuR*Pi^d*(s + t - 2*d*t) - 
        2^(2 + d)*gZuL*Pi^d*(s + t - d*t)) + 
      gZlR*(-(d*gZuL*(2*Pi)^d*(s - 3*t)) + d*gZuR*(2*Pi)^d*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s + t - 2*d*t) - 2^(2 + d)*gZuR*Pi^d*
         (s + t - d*t)))*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)*s) + (I*EL^6*gAl^2*gAu^2*
     (gZlL*(-(d*gZuL*(2*Pi)^d*(3*s - t)) + d*gZuR*(2*Pi)^d*(3*s - t) + 
        2^(1 + d)*gZuL*Pi^d*((2 + d)*s - (-2 + d)*t) - 2^(1 + d)*gZuR*Pi^d*
         (s + d*s + t - d*t)) - gZlR*(d*gZuR*(2*Pi)^d*(3*s - t) - 
        2^(1 + d)*gZuR*Pi^d*((2 + d)*s - (-2 + d)*t) + 
        gZuL*(-(d*(2*Pi)^d*(3*s - t)) + 2^(1 + d)*Pi^d*(s + d*s + t - d*t))))*
   ...
   (I*2^(2 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
     ...
     ((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
      (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, p3], SP[p2, p3], SP[p2, q1]])/(mz^2*Pi^d*s) + 
   (I*2^(2 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
      (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, p3], SP[p2, p3], 
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlR*(-(2^(1 + d)*gZuL*Pi^d) + 2^(2 + d)*gZuR*Pi^d + 
        d*gZuL*(2*Pi)^d - d*gZuR*(2*Pi)^d) + 
      gZlL*(2^(2 + d)*gZuL*Pi^d - 2^(1 + d)*gZuR*Pi^d - d*gZuL*(2*Pi)^d + 
        d*gZuR*(2*Pi)^d))*(s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)*s) - (I*2^(2 - d)*EL^6*gAl^2*gAu^2*
     ((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
      (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3], SP[p2, p3]])/(mz^2*Pi^d*s) + 
   (I*2^(2 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
      (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*
     ...
     ((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
      (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3], SP[p3, q1]])/(mz^2*Pi^d*s) + 
   (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
      (-2 + d)*gZlL*gZuR + (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1], 
     ...
     ((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
      (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^d*s) - 
   (I*EL^6*gAl^2*gAu^2*(gZlR*(-(2^(1 + d)*gZuL*Pi^d) + 2^(2 + d)*gZuR*Pi^d + 
        d*gZuL*(2*Pi)^d - d*gZuR*(2*Pi)^d) + 
      gZlL*(2^(2 + d)*gZuL*Pi^d - 2^(1 + d)*gZuR*Pi^d - d*gZuL*(2*Pi)^d + 
        d*gZuR*(2*Pi)^d))*(s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
    ...
    (mz^2*(2*Pi)^(2*d)*s) + (I*2^(2 - d)*EL^6*gAl^2*gAu^2*
     ((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
      (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p2, p3], SP[p2, p3], SP[p2, p3]])/(mz^2*Pi^d*s) + 
   ...
   (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
     ...
     (-1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p2, p3], SP[p3, q1], 
      SP[q1, q1]])/(mz^2*Pi^d*s) + 
   (I*EL^6*gAl^2*gAu^2*(gZlL*(-(d*gZuL*(2*Pi)^d*(s - t)) + 
        d*gZuR*(2*Pi)^d*(s - t) + 2^(1 + d)*gZuL*Pi^d*(2*s - (-2 + d)*t) - 
        2^(1 + d)*gZuR*Pi^d*(s + t - d*t)) - 
      gZlR*(d*gZuR*(2*Pi)^d*(s - t) - 2^(1 + d)*gZuR*Pi^d*
         (2*s - (-2 + d)*t) + gZuL*(-(d*(2*Pi)^d*(s - t)) + 
          2^(1 + d)*Pi^d*(s + t - d*t))))*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)*s) + (I*EL^6*gAl^2*gAu^2*(2^(1 + d)*Pi^d - (2*Pi)^d)*
     (gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 2*(-3 + d)*gZuL*t - 
        2*(-3 + d)*gZuR*t) + gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 
        2*(-3 + d)*gZuL*t + 2*(-3 + d)*gZuR*t))*\[Mu]^(4 - d)*
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlR*(-(2^(1 + d)*gZuL*Pi^d) + 2^(2 + d)*gZuR*Pi^d + 
    ...
    (mz^2*(2*Pi)^(2*d)*s) - (I*2^(2 - d)*EL^6*gAl^2*gAu^2*
     ((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
      (-4 + d)*gZlR*gZuR)*(s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p1, p3], SP[p2, p3], SP[p2, p3], SP[p2, p3]])/(mz^2*Pi^d*s) + 
   ...
   (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
     ...
     (-1 + GaugeXi[Q])*SPList[SP[p1, p3], SP[p2, p3], SP[p3, q1], 
      SP[q1, q1]])/(mz^2*Pi^d*s) + 
   (I*EL^6*gAl^2*gAu^2*(gZlR*(d*gZuR*(2*Pi)^d*(s - t) - 
    ...
    (mz^2*(2*Pi)^(2*d)*s) + (I*EL^6*gAl^2*gAu^2*(-(2^(1 + d)*Pi^d) + 
      (2*Pi)^d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
        2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t) + 
      gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
   ...
   (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
     ...
     (-1 + GaugeXi[Q])*SPList[SP[p2, p3], SP[p2, p3], SP[p2, q1], 
      SP[p3, q1]])/(mz^2*Pi^d*s) - 
   (I*EL^6*gAl^2*gAu^2*(gZlR*(d*gZuR*(2*Pi)^d*s + 
        d*gZuR*(-(2^(1 + d)*Pi^d) + (2*Pi)^d)*t - d*gZuL*(2*Pi)^d*(s + t) + 
        2^(1 + d)*gZuL*Pi^d*(3*s + (-3 + d)*t)) + 
      gZlL*(d*gZuL*(2*Pi)^d*s + d*gZuL*(-(2^(1 + d)*Pi^d) + (2*Pi)^d)*t - 
        d*gZuR*(2*Pi)^d*(s + t) + 2^(1 + d)*gZuR*Pi^d*(3*s + (-3 + d)*t)))*
     \[Mu]^(4 - d)*(-1 + GaugeXi[Q])*SPList[SP[p2, p3], SP[p2, p3], 
   ...
   (I*EL^6*gAl^2*gAu^2*(-3*2^(1 + d)*(gZlR*gZuL + gZlL*gZuR)*Pi^d*(s - t) + 
      d*(gZlL - gZlR)*(gZuL - gZuR)*(-5*(2*Pi)^d*(s + t) + 
        2^(1 + d)*Pi^d*(2*s + 3*t)))*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p2, p3], SP[p2, p3], SP[p3, q1], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)*s) - (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*
     (3*2^(1 + d)*(gZlR*gZuL + gZlL*gZuR)*Pi^d*(s - t) + 
      d*(gZlL - gZlR)*(gZuL - gZuR)*(2^(1 + d)*Pi^d*(s + 2*t) - 
        (2*Pi)^d*(s + 5*t)))*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1], SP[q1, q1]])/
    (mz^2*Pi^(2*d)*s) + (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
     ((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - (-4 + d)*gZlL*gZuR + 
      (-2 + d)*gZlR*gZuR)*t*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
     SPList[SP[p2, p3], SP[p2, q1], SP[p2, q1], SP[p2, q1]])/(mz^2*Pi^d*s) + 
   ...
   (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(gZlL + gZlR)*(gZuL + gZuR)*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p2, p3], SP[p3, q1], SP[p3, q1], 
      SP[p3, q1]])/(mz^2*Pi^d) + 
   (I*EL^6*gAl^2*gAu^2*(gZlL*(-5*d*gZuL*(2*Pi)^d*s + 5*d*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuL*Pi^d*(s + 3*d*s - t) - 2^(1 + d)*gZuR*Pi^d*
         ((-4 + 3*d)*s + t)) - gZlR*(-5*d*gZuL*(2*Pi)^d*s + 
        5*d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s + t) + 
        2^(1 + d)*gZuR*Pi^d*(-((1 + 3*d)*s) + t)))*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p2, p3], SP[p3, q1], SP[p3, q1], 
      SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*(3*d*gZlL*gZuR*(2*Pi)^d*s - 
      3*d*gZlR*gZuR*(2*Pi)^d*s - gZlR*gZuL*(-3*d*(2*Pi)^d*s + 
        2^(1 + d)*Pi^d*((4 + d)*s - t)) - 2^(1 + d)*gZlL*gZuR*Pi^d*
       ((4 + d)*s - t) + 2^(1 + d)*gZlR*gZuR*Pi^d*((-1 + d)*s + t) + 
      gZlL*gZuL*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((-1 + d)*s + t)))*
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlR*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuR*Pi^d*t + 2^(1 + d)*gZuL*Pi^d*(-3*s + t)) + 
      gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
         t + 2^(1 + d)*gZuR*Pi^d*(-3*s + t)))*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])*
  ...
  (((-I)*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        ...
        gZlR*(d*gZuR*(2*Pi)^d*s*(s - 3*t) - 2^(1 + d)*gZuR*Pi^d*(s - t)*
           ((-1 + d)*s - t) + gZuL*(-(d*(2*Pi)^d*s*(s - 3*t)) + 
            2^(1 + d)*Pi^d*((-2 + d)*s^2 - (3 + d)*s*t - t^2))))*
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*Pi^d*(-s + t) + 
           2^(1 + d)*gZuL*Pi^d*(2*s + t)) + gZlL*(d*gZuL*(2*Pi)^d*s - 
           d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(-s + t) + 
           2^(1 + d)*gZuR*Pi^d*(2*s + t)) - 2^(1 + d)*Pi^d*
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
             2^(1 + d)*gZuR*Pi^d*(-s + t) + 2^(1 + d)*gZuL*Pi^d*(2*s + t)) + 
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, p2], SP[p2, p3]])/(mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])) + 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, p2], SP[p2, q1]])/(mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])) - 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, p2], SP[p3, q1]])/(mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])) + 
   (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
     ...
     (-1 + GaugeXi[Q])) + (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      gZlR*(d*gZuR*(2*Pi)^d*s*(s - 3*t) - 2^(1 + d)*gZuR*Pi^d*(s - t)*
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, p3], SP[p2, p3]])/(mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])) - 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, p3], SP[p2, q1]])/(mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])) + 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, p3], SP[p3, q1]])/(mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])) - 
   (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, p3], SP[q1, q1]])/(2^(2*(1 + d))*mz^2*Pi^(2*d)*
     (-1 + GaugeXi[Q])) - (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, q1], SP[p2, p3]])/(mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])) + 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])) - 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*(-1 + GaugeXi[Q])) + 
   (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
        2^(1 + d)*gZuL*Pi^d*(s - t)*((-1 + d)*s - t) + 2^(1 + d)*gZuR*Pi^d*
         (-((-2 + d)*s^2) + (3 + d)*s*t + t^2)) - 
      ...
      (gZlL*(-(d*gZuL*(2*Pi)^d*s*(s - 3*t)) + d*gZuR*(2*Pi)^d*s*(s - 3*t) + 
       ...
       GaugeXi[Q]^2 + (t*(s + t)*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
          ...
          GaugeXi[Q] + (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/s)*
     SPList[SP[p1, q1], SP[q1, q1]])/(2^(2*(1 + d))*mz^2*Pi^(2*d)*
     (-1 + GaugeXi[Q])) - ((I/2)*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
     ((2^(1 - d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
      ...
      (2^(1 - 2*d)*t*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
         ...
         (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/
       (Pi^(2*d)*s) + (-(gZlR*(-(d*gZuL*(2*Pi)^d*s*(s - t)) + 
           d*gZuR*(2*Pi)^d*s*(s - t) + 2^(1 + d)*gZuL*Pi^d*
            (2*s^2 - (-3 + d)*s*t + t^2) + 2^(1 + d)*gZuR*Pi^d*
            (-s^2 + d*s*t + t^2))) + gZlL*(d*gZuR*(2*Pi)^d*s*(s - t) - 
          2^(1 + d)*gZuR*Pi^d*(2*s^2 - (-3 + d)*s*t + t^2) + 
          gZuL*(-(d*(2*Pi)^d*s*(s - t)) + 2^(1 + d)*Pi^d*(s^2 - d*s*t - 
              t^2))) - 2*(s + t)*(-(gZlR*(-(d*gZuL*(2*Pi)^d*s) + 
             d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*Pi^d*(-s + t) + 
             2^(1 + d)*gZuL*Pi^d*(2*s + t))) + gZlL*(-(d*gZuL*(2*Pi)^d*s) + 
            d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*(s - t) - 
            2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q] + 
        (-(gZlR*(-(d*gZuL*(2*Pi)^d*s*(s - t)) + d*gZuR*(2*Pi)^d*s*(s - t) + 
          ...
          gZlL*(d*gZuR*(2*Pi)^d*s*(s - t) - 2^(1 + d)*gZuR*Pi^d*
             (2*s^2 - (-3 + d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*(s - t)) + 
              2^(1 + d)*Pi^d*(s^2 - d*s*t - t^2))))*GaugeXi[Q]^2)/
       ((2*Pi)^(2*d)*s))*SPList[SP[p2, p3], SP[p2, p3]])/
    (mz^2*(-1 + GaugeXi[Q])) - (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*(s + t)*
     \[Mu]^(4 - d)*(gZlR*(-(d*gZuL*(2*Pi)^d*s^2) + d*gZuR*(2*Pi)^d*s^2 + 
        2^(1 + d)*gZuR*Pi^d*((3 - 2*d)*s^2 + (9 - 2*d)*s*t + 4*t^2) + 
        2^(1 + d)*gZuL*Pi^d*(2*(-3 + d)*s^2 + (-3 + 2*d)*s*t + 4*t^2)) + 
      gZlL*(d*gZuL*(2*Pi)^d*s^2 - d*gZuR*(2*Pi)^d*s^2 + 
        2^(1 + d)*gZuL*Pi^d*((3 - 2*d)*s^2 + (9 - 2*d)*s*t + 4*t^2) + 
        2^(1 + d)*gZuR*Pi^d*(2*(-3 + d)*s^2 + (-3 + 2*d)*s*t + 4*t^2)) - 
      2*(gZlL*(-3*d*gZuL*(2*Pi)^d*s^2 + 3*d*gZuR*(2*Pi)^d*s^2 + 
          2^(1 + d)*gZuL*Pi^d*(3*s^2 + (9 - 2*d)*s*t + 4*t^2) + 
          2^(1 + d)*gZuR*Pi^d*(-6*s^2 + (-3 + 2*d)*s*t + 4*t^2)) - 
        gZlR*(3*d*gZuR*(2*Pi)^d*s^2 - 2^(1 + d)*gZuR*Pi^d*
           (3*s^2 + (9 - 2*d)*s*t + 4*t^2) + gZuL*(-3*d*(2*Pi)^d*s^2 + 
            2^(1 + d)*Pi^d*(6*s^2 + (3 - 2*d)*s*t - 4*t^2))))*GaugeXi[Q] + 
   ...
   ((I/2)*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
     ((2^(2 - d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
         ...
         gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
           2*(-3 + d)*gZuR*t))*(-1 + GaugeXi[Q])^2)/Pi^d - 
      (3*t*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
           2^(1 + d)*gZuR*Pi^d*(-s + t) + 2^(1 + d)*gZuL*Pi^d*(2*s + t)) + 
         gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
            (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)) - 
         2^(1 + d)*Pi^d*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 2*gZuL*t + 
         ...
         (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/
       ((2*Pi)^(2*d)*s) + 
      (2^(1 - 2*d)*(-(gZlR*(-(d*gZuL*(2*Pi)^d*s*(s - t)) + d*gZuR*(2*Pi)^d*s*
     ...
     ((2^(1 - d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
      ...
      (t*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
         ...
         (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/
       ((2*Pi)^(2*d)*s))*SPList[SP[p2, q1], SP[p2, q1]])/
    (mz^2*(-1 + GaugeXi[Q])) + ((I/2)*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
     ((2^(2 - d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
           2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t) + 
         gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
           2*(-3 + d)*gZuR*t))*(-1 + GaugeXi[Q])^2)/Pi^d - 
       ...
       (Pi^(2*d)*s) + (-(gZlR*(-(d*gZuL*(2*Pi)^d*s*(s - t)) + 
        ...
        (-(gZlR*(-(d*gZuL*(2*Pi)^d*s*(s - t)) + d*gZuR*(2*Pi)^d*s*(s - t) + 
          ...
          gZlL*(d*gZuR*(2*Pi)^d*s*(s - t) - 2^(1 + d)*gZuR*Pi^d*
             (2*s^2 - (-3 + d)*s*t + t^2) + gZuL*(-(d*(2*Pi)^d*s*(s - t)) + 
              2^(1 + d)*Pi^d*(s^2 - d*s*t - t^2))))*GaugeXi[Q]^2)/
       ((2*Pi)^(2*d)*s))*SPList[SP[p2, q1], SP[p3, q1]])/
    (mz^2*(-1 + GaugeXi[Q])) - ((I/4)*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
     ((2^(2 - d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
           2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t) + 
         gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
           2*(-3 + d)*gZuR*t))*(-1 + GaugeXi[Q])^2)/Pi^d - 
      (t*(gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
         ...
         (gZlR*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuR*
           ...
           gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
              (-s + t) + 2^(1 + d)*gZuR*Pi^d*(2*s + t)))*GaugeXi[Q]^2))/
       ((2*Pi)^(2*d)*s))*SPList[SP[p2, q1], SP[q1, q1]])/
    (mz^2*(-1 + GaugeXi[Q])) - ((I/2)*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
     ((2^(1 - d)*(gZlL*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
           2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t) + 
         gZlR*(-((-4 + d)*gZuL*s) + (-2 + d)*gZuR*s - 2*(-3 + d)*gZuL*t + 
   ...
   (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ((((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - (-2 + d)*gZlL*gZuR + 
      ...
      (3*(gZlL*(-(d*gZuL*(2*Pi)^d*s*t) + d*gZuR*(2*Pi)^d*s*t + 
       ...
       (2*Pi)^(2*d))*SPList[SP[p2, p3], SP[p2, q1], SP[q1, q1]])/
    (mz^2*s*(-1 + GaugeXi[Q])) + 
   (I*EL^6*gAl^2*gAu^2*(-(gZlR*(3*d*gZuL*(2*Pi)^d*s*t - 3*d*gZuR*(2*Pi)^d*s*
          t - 2^(1 + d)*gZuR*Pi^d*((1 + d)*s^2 - 4*s*t - 3*t^2) + 
         2^(1 + d)*gZuL*Pi^d*((-7 + d)*s^2 - 5*s*t + 3*t^2))) + 
      gZlL*(3*d*gZuL*(2*Pi)^d*s*t - 3*d*gZuR*(2*Pi)^d*s*t + 
        2^(1 + d)*gZuL*Pi^d*((1 + d)*s^2 - 4*s*t - 3*t^2) - 
        2^(1 + d)*gZuR*Pi^d*((-7 + d)*s^2 - 5*s*t + 3*t^2)))*\[Mu]^(4 - d)*
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlL*(-(d*gZuL*(2*Pi)^d*(s - 3*t)) + 
    ...
    (mz^2*(2*Pi)^(2*d)*s) + (I*EL^6*gAl^2*gAu^2*
     (gZlR*(d*gZuR*(2*Pi)^d*(3*s - t) - 2^(1 + d)*gZuR*Pi^d*
      ...
      gZlL*(d*gZuL*(2*Pi)^d*(3*s - t) - 2^(1 + d)*gZuL*Pi^d*
         ((2 + d)*s - (-2 + d)*t) + gZuR*(-(d*(2*Pi)^d*(3*s - t)) + 
          2^(1 + d)*Pi^d*(s + d*s + t - d*t))))*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1], 
      SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlL*(5*d*gZuL*(2*Pi)^d*s - 5*d*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s + t) + 2^(1 + d)*gZuL*Pi^d*
         (-((1 + 3*d)*s) + t)) + gZlR*(-5*d*gZuL*(2*Pi)^d*s + 
        5*d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*((-4 + 3*d)*s + t) + 
        2^(1 + d)*gZuR*Pi^d*(-((1 + 3*d)*s) + t)))*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])*SPList[SP[p2, p3], SP[p3, q1], SP[p3, q1], 
      SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)*s) + 
   (I*2^(-1 - 2*d)*EL^6*gAl^2*gAu^2*
     (gZlL*(3*d*gZuL*(2*Pi)^d*s - 3*d*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuR*Pi^d*((4 + d)*s - t) - 2^(1 + d)*gZuL*Pi^d*
         ((-1 + d)*s + t)) + gZlR*(3*d*gZuR*(2*Pi)^d*s + 
        gZuL*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((4 + d)*s - t)) - 
