...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(2*bb*(5 - 4*d)*mm^2 + 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(bb*(17 - 11*d)*mm^2 + 
  ...
  (4^(1 - d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (8*bb*mm^2 - aa*(2 + d)*mm^2 - 8*aa*psq + bb*(2 + d)*psq)*\[Mu]^(8 - 2*d)*
