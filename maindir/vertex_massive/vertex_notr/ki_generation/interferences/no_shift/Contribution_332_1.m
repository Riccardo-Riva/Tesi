...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^6*gAl^2*gFll^2*gZNL*mm^4*s*((4 - 5*d + d^2)*gZlR*(mm^2 + psq) - 
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gZNL*mm^2*(2*(-2 + d)*gZlL*mm^2*(psq + s) + 
      gZlR*(2*mm^4 + (6 - 5*d + d^2)*psq*s + mm^2*(-((6 - 6*d + d^2)*psq) + 
          (-2 + d)*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gZNL*mm^4*((2 - 5*d + d^2)*gZlR*mm^2 + 
      (-6 + d)*gZlR*psq - (-2 + d)*gZlL*(2*psq + d*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gZNL*mm^2*
   ...
   (EL^6*gAl^2*gFll^2*gZNL*mm^4*(-2*(10 - 7*d + d^2)*gZlL*s + 
    ...
    (2*Pi)^(2*d) - (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gFll^2*gZlR*gZNL*mm^2*
     (mm^2 + (-3 + d)*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl^2*gFll^2*gZNL*mm^2*
     (2*(-2 + d)*gZlL*mm^2*s + gZlR*(2*mm^4 + (10 - 7*d + d^2)*psq*s + 
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gZlR*gZNL*mm^2*
     ((4 + d)*mm^2 - (8 - 7*d + d^2)*psq + (-2 + d)^2*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gFll^2*gZlR*gZNL*mm^2*
     (mm^2 + (-3 + d)*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
    Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gZNL*mm^2*
     (4*(-2 + d)*gZlL*mm^2 - gZlR*((16 - 13*d + 2*d^2)*mm^2 + 
        (-40 + 21*d - 2*d^2)*psq + (12 - 8*d + d^2)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gZNL*mm^2*(2*(-2 + d)*gZlL*mm^2 - 
      gZlR*((8 - 5*d + d^2)*mm^2 - (16 - 7*d + d^2)*psq + (-4 + d)^2*s))*
   ...
   (2^(3 - 2*d)*EL^6*gAl^2*gFll^2*gZNL*mm^4*(gZlR*(mm^2 - psq) + 
    ...
    (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gZlR*gZNL*mm^2*
     ((20 - 13*d + 2*d^2)*mm^2 - (8 - 5*d + d^2)*psq - (12 - 8*d + d^2)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (4^(2 - d)*EL^6*gAl^2*gFll^2*gZlR*gZNL*mm^4*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl^2*gFll^2*gZNL*mm^2*(2*(-2 + d)*gZlL*mm^2 - 
      2*gZlR*mm^2 + (14 - 8*d + d^2)*gZlR*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl^2*gFll^2*gZlR*gZNL*mm^2*(2*mm^2 - 2*psq - (-4 + d)*s)*
