...
PropList[KiraPropagator[-p3 + q1, mz], KiraPropagator[q2, mz], 
 ...
 ((I*4^(-1 - d)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(mm^2 - psq)*s*
  ...
  (I*4^(-1 - d)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*
  ...
  (I*4^(-1 - d)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*s*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   Pi^(2*d) - (I*(aa + bb)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*
  ...
  (I*(aa - bb)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*d*EL^5*gAl*gXll^2*gXXZZ*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
