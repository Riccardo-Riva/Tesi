...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^4*(psq - t) - psq*(2*psq^2 + s^2 + 3*s*t + 2*t^2 - 4*psq*(s + t)) - 
      mm^2*(3*psq^2 + s^2 + 3*s*t + 2*t^2 - psq*(s + 5*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(-psq + s + t)*
     ...
     (gZlL - gZlR)*mm^2*(3*psq^2*s + 3*mm^4*(psq - t) - 
      mm^2*(7*psq^2 + psq*(2*s - 11*t) + 2*t*(s + 2*t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (3*mm^4*s + psq*s*(-psq + s + t) - mm^2*(psq^2 + 3*s^2 + psq*(s - 2*t) + 
        2*s*t + t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^4*(2*psq^2 + 2*mm^2*s - 6*psq*s + 3*s^2 - 4*psq*t + 4*s*t + 2*t^2)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (psq - t)*(mm^2*(-psq + s + t) + psq*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
