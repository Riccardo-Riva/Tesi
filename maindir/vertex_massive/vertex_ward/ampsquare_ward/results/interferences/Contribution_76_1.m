...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
   ...
   (((-I)*4^(1 - d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*s*(s + t)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*s*t*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*s*(s + 2*t)*
    ...
    ((3*I)*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
      (s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/
     Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*
    ...
    (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q2]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(s + t)*
    ...
    (I*2^(3 - 2*d)*(-aa + bb)*(-4 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*t*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(s + (-2 + d)*t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*(-aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*t*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
      ((-8 + 3*d)*s + 4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
