...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   ((I*(aa - bb)*(2 + d)*EL^5*gAl^2*gWWA*gWWAA*mm^2*s*(-2*psq + s + 2*t)*
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) - 
    (I*EL^5*gAl^2*gWWA*gWWAA*(aa*((6 - 4*d)*psq^2 + d*s*(s + t) + 
         mm^2*((-6 + 8*d)*psq + 6*s - 4*d*s + 6*t - 8*d*t) + 
         psq*(-6*s + d*s - 6*t + 4*d*t)) - 
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gWWA*gWWAA*((-3 + 2*d)*psq - 
       2*(-2 + d)*s + (3 - 2*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gWWA*gWWAA*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gWWA*gWWAA*((3 - 2*d)*psq + s + 
     ...
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWWA*gWWAA*
