...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
  ...
  (-((EL^5*gFFA^3*gFll^2*mm^2*s^2*(-2*aa*psq^2 + 
     ...
     SPList[SP[p1, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gFFA^3*gFll^2*mm^2*s*
     (-2*aa*psq^2 + bb*psq*(2*mm^2 + 2*psq - s) + aa*mm^2*(-2*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(aa - bb)*EL^5*gFFA^3*gFll^2*mm^2*(mm^2 + psq)*s^2*
   ...
   (2^(3 - 2*d)*(aa - bb)*EL^5*gFFA^3*gFll^2*mm^2*(mm^2 + psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gFFA^3*gFll^2*mm^2*
     (bb*(psq*(2*psq - s) + mm^2*(2*psq + s)) - 
      aa*(mm^2*(2*psq - s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gFFA^3*gFll^2*mm^2*
     (bb*(psq*(2*psq - s) + mm^2*(2*psq + s)) - 
      aa*(mm^2*(2*psq - s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
