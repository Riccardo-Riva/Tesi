...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 2*d)*EL^6*gAl^2*gHll^2*mm^4*
    ...
    \[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (EL^6*gAl^2*gHll^2*mm^2*(d^2*mm^2*(2*Pi)^(4*d)*(gZlL^2*(2*mm^2 - psq) + 
       gZlR^2*(2*mm^2 - psq) - 2*gZlL*gZlR*psq) - 4^(1 + 2*d)*Pi^(4*d)*
      (gZlL^2*mm^2*psq + gZlR^2*mm^2*psq - gZlL*gZlR*(mm^2 + 3*psq)*s) - 
     4^(1 + 2*d)*d*Pi^(4*d)*(gZlR^2*mm^2*(mm^2 - psq) + 
       gZlL^2*(mm^4 - mm^2*psq) + gZlL*gZlR*(mm^4 - 2*mm^2*(psq - s) + 
         psq*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2*Pi)^(6*d) + 
  (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*mm^4*
