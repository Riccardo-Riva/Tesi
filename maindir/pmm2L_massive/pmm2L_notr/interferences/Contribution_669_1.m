...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*psq*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*
    (2*psq + (-5 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*
    ggagpW*gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*
    (2*psq - (-3 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, p3]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-4 + d)*EL^8*gAl*gAu^2*gFgagp*
    gFll*ggagpW*gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, q1]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*
    ggagpW*gWNl*gWWA*mm^2*(2*psq - (-3 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*(-psq + s + t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*(psq - t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*
