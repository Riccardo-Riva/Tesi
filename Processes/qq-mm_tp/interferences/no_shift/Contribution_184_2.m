...
((I*2^(-1 - 2*d)*EL^6*gHZZ^2*
    ...
    PropList[KiraPropagator[q1, mz*Sqrt[GaugeXi[Q]]]]*SPList[SP[q1, q1]])/
   (Pi^(2*d)*(-mzC^2 + s)*(mz^3 - mz*s)^2) + PropList[KiraPropagator[q1, mz]]*
   ((I*2^(-1 - 2*d)*d*EL^6*gHZZ^2*
      (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
            ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
         gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
      ...
      PropagatorDenominator[0, mh])/(Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)) + 
    (I*2^(-1 - 2*d)*EL^6*gHZZ^2*
      (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
            ((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2)) + 
         gZuL*gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
        ...
        (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
             (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))))*
      PropagatorDenominator[0, mh]*SPList[SP[q1, q1]])/
     (Pi^(2*d)*(mzC^2 - s)*(mz^3 - mz*s)^2)))/4
