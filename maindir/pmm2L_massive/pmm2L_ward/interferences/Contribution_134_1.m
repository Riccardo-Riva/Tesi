...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((I*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*s*
    (aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + bb*psq*(-psq + t) + 
     bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    (aa*(2*psq^2 + 2*mm^2*(psq + s - t) - 2*psq*(s + t) - s*(s + 2*t)) + 
     bb*(-2*psq^2 - 4*psq*s + s^2 + 2*psq*t + 2*s*t + 
       mm^2*(-2*psq + 4*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*
    (gZlL + gZlR)*mh^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gHFF*gHll*
    (gZlL + gZlR)*mh^2*mm^2*s*(aa*(2*psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*
    mm^2*(aa*(mm^2*(psq - t) + (psq + s)*(psq - s - t)) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*s*
    (aa*(mm^2 + psq - s - 2*t) + bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ*gHFF*gHll*
    (gZlL + gZlR)*mh^2*mm^2*(bb*(-((psq + s)*(psq - t)) + 
       mm^2*(-psq + s + t)) + aa*(psq^2 + mm^2*(psq + 2*s - t) - s*t - 
       psq*(2*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*
    gHll*(gZlL + gZlR)*mh^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gFFA*gFFZ*gHFF*gHll*
    (gZlL + gZlR)*mh^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    (aa*(4*psq - s - 4*t) + bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    (aa*(2*mm^2 + 2*psq - 3*s - 4*t) + bb*(-4*psq + 3*s + 4*t))*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*
    (gZlL + gZlR)*mh^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*
    (gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p1, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*
    (gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*
    gHll*(gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/
   Pi^(2*d) + ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ*gHFF*gHll*
