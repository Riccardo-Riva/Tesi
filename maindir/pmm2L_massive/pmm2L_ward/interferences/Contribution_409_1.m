...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((I*4^(-1 - d)*EL^5*gFFA*gFFFF*gFll^2*mh^2*mm^2*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(mw^2*Pi^(2*d)) + 
  (I*EL^5*gFFA*gFFFF*gFll^2*mh^2*mm^2*s*(aa*(2*mm^2 - psq - t) + 
   ...
   (2^(2*(1 + d))*mw^2*Pi^(2*d)) - (I*EL^5*gFFA*gFFFF*gFll^2*mh^2*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(mw^2*(2*Pi)^(2*d)) - 
  (I*EL^5*gFFA*gFFFF*gFll^2*mh^2*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(mw^2*(2*Pi)^(2*d)) + 
  (I*(aa - bb)*EL^5*gFFA*gFFFF*gFll^2*mh^2*mm^2*(2*psq - s - 2*t)*
