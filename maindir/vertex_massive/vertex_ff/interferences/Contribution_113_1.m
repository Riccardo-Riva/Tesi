...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*mm^2 - s)*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*(-2 + d)*psq^3 - 
      ...
      (-2 + d)*psq^2*(s + 4*t) + psq*(4*s^2 + (-2 + d)*s*t + 2*(-2 + d)*t^2))*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^4*(8*psq + (-6 + d)*s - 8*t)*
       (psq - t) - s*(-((-2 + d)*psq^3) + (2 + d)*psq^2*t - 8*psq*t^2 + 
        4*t^2*(s + t)) + mm^2*(-2*psq^2*((2 + d)*s - 4*t) + 4*t^2*(s + 2*t) + 
        2*psq*(2*s^2 + d*s*t - 8*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     ((2 + d)*mm^2 - (-2 + d)*psq + 4*s)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
     ((-2 + d)*psq^2*s + mm^4*(8*psq + (-6 + d)*s - 8*t) + 
      mm^2*(8*psq^2 + 4*s*(s + 2*t) - 2*psq*((4 + d)*s + 4*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-2*(-2 + d)*psq^3 + 
   ...
   (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[p3, q2]])/Pi^(2*d) - 
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*mm^2 - 3*psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q1, q2]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-2 + d)*mm^2 - d*psq + 4*s + 2*t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*psq^2 - 3*psq*s + s^2 - 
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq - t)*
     ...
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
