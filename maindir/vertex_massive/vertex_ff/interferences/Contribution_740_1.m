...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl^3*gAu*gWlN*gWNl*((-4 + d^2)*psq^4 + 
      2*(-2 + d)*psq^3*((-8 + d)*s - (4 + d)*t) - 4*(-2 + d)*psq*t*
       (5*s^2 + 8*s*t + t^2) + 4*(-2 + d)*s*t*(s^2 + 3*s*t + 2*t^2) - 
      (-2 + d)*psq^2*((-6 + d)*s^2 - 36*s*t - (10 + d)*t^2) + 
      (-2 + d)*mm^4*((-6 + d)*psq^2 - (s + t)*(d*(s - t) + 6*t) + 
   ...
   (2^(1 - 2*d)*EL^6*gAl^3*gAu*gWlN*gWNl*((-4 + d^2)*psq^4 - 
      ...
      (-2 + d)*mm^4*(psq - t)*((2 + d)*psq - 2*t - d*(s + t)) - 
      2*mm^2*((12 - 8*d + d^2)*psq^3 + (-2 + d)*psq*t*((-15 + d)*s + 
          (-18 + d)*t) - (-2 + d)*psq^2*((-5 + d)*s + 2*(-9 + d)*t) + 
        2*(-2 + d)*t*(2*s^2 + 5*s*t + 3*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*EL^6*gAl^3*gAu*gWlN*gWNl*
     ((-2 + d)*mm^4*s*((2 + d)*psq - 2*t - d*(s + t)) + 
      s*((20 - 12*d + d^2)*psq^3 - 8*(-2 + d)*psq*t*(2*s + 3*t) - 
        (-2 + d)*psq^2*((-6 + d)*s + (-26 + d)*t) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gWlN*gWNl*(4*(6 - 5*d + d^2)*psq^3 + 
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(-((-2 + d)*psq^3) - 
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(-3*(-2 + d)*psq^3 + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gWlN*gWNl*((20 - 12*d + d^2)*psq^3 - 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gWlN*gWNl*(2*d*mm^2*(2*psq - s - 2*t)*
       (psq - t) + 8*t^2*(s + t) + 4*psq^2*(-3*s + 2*t) + 
      4*mm^2*s*(-2*psq + s + 2*t) + 4*psq*(s^2 + s*t - 4*t^2) - 
      d^2*(mm^2 - psq)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) - 
      4*d*(psq^3 + t^2*(s + t) - psq^2*(3*s + t) + psq*(s^2 + 2*s*t - t^2)))*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(-2*psq + s + 2*t)*
     ((-2 + d)*psq^2 - (2 + d)*mm^2*s + (-2 + d)*psq*(s - 2*t) + 
      (-2 + d)*t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*
   ...
   (2^(1 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*
     ...
     gWNl*((-14 + 5*d)*psq^2 - (-2 + d)*mm^2*(3*psq - 2*s - 3*t) + 
      psq*(-4*(-2 + d)*s + (22 - 7*d)*t) + 
      (s + t)*((-2 + d)*s + 2*(-4 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*((14 - 5*d)*psq^2 + 
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq + s)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*((14 - 5*d)*psq^2 + 
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*
     ...
     gWNl*(psq^2 + mm^2*s + t^2 - psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*((-10 + 3*d)*psq^2 - 
      2*s^2 + d*s^2 + (-2 + d)*mm^2*(psq + s - t) - 10*s*t + 3*d*s*t - 
      12*t^2 + 4*d*t^2 + psq*(6*s - 3*d*s + 22*t - 7*d*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*
     (-psq + s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*
