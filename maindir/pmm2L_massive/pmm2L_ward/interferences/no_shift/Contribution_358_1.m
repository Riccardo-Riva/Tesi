  ...
  ((I*EL^5*gAl*gZlL*gZlR*mm^2*s*
   ...
   (I*EL^5*gAl*mm^2*(bb*(2*(-2 + d)*gZlL^3*gZlR*(-(s*((-4 + d)*psq + 2*t)) + 
      ...
      aa*(-2*(-2 + d)*gZlL^3*gZlR*(2*s*(psq - t) + 
        ...
        2*gZlL^2*gZlR^2*((4 - 6*d + d^2)*s*(psq - t) + 
    ...
    Pi^(2*d) - (I*EL^5*gAl*mm^2*s*
     (aa*(2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*(2*psq - s - 2*t) + 
        (-4 + d)*gZlL^4*((-2 + d)*mm^2 + (-6 + d)*psq - (-4 + d)*(s + 2*t)) + 
        (-4 + d)*gZlR^4*((-2 + d)*mm^2 + (-6 + d)*psq - 
          (-4 + d)*(s + 2*t))) + bb*(-2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*
         (2*psq - s - 2*t) + (-4 + d)*gZlL^4*((-2 + d)*mm^2 + 
          (10 - 3*d)*psq + (-4 + d)*(s + 2*t)) + (-4 + d)*gZlR^4*
   ...
   (I*4^(1 - d)*EL^5*gAl*mm^2*(bb*((-2 + d)*gZlL^4 - 2*(-2 + d)*gZlL^3*gZlR + 
        (4 - 6*d + d^2)*gZlL^2*gZlR^2 - 2*(-2 + d)*gZlL*gZlR^3 + 
        (-2 + d)*gZlR^4)*(psq - s - t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*
     (aa*(2*(-2 + d)*gZlL^3*gZlR*mm^2*(-2*psq + (-6 + d)*s + 2*t) + 
        2*(-2 + d)*gZlL*gZlR^3*mm^2*(-2*psq + (-6 + d)*s + 2*t) + 
        2*gZlL^2*gZlR^2*mm^2*((4 - 6*d + d^2)*psq - (12 - 6*d + d^2)*s - 
          (4 - 6*d + d^2)*t) + gZlL^4*((16 - 10*d + d^2)*mm^4 - 
        ...
        gZlR^4*((16 - 10*d + d^2)*mm^4 - (24 - 10*d + d^2)*psq*s + 
          mm^2*(-((20 - 12*d + d^2)*psq) + (20 - 10*d + d^2)*s - 
            2*(-2 + d)*t))) + bb*(2*(-2 + d)*gZlL^3*gZlR*mm^2*
         ((-2 + d)*mm^2 - (-4 + d)*psq + 6*s - d*s - 2*t) + 
        2*(-2 + d)*gZlL*gZlR^3*mm^2*((-2 + d)*mm^2 - (-4 + d)*psq + 6*s - 
          d*s - 2*t) - 2*gZlL^2*gZlR^2*mm^2*(2*(4 - 6*d + d^2)*mm^2 - 
          (4 - 6*d + d^2)*psq - 12*s + 6*d*s - d^2*s - 4*t + 6*d*t - d^2*t) + 
        gZlL^4*(-((8 - 6*d + d^2)*mm^4) + (24 - 10*d + d^2)*psq*s + 
          mm^2*((12 - 8*d + d^2)*psq - (20 - 10*d + d^2)*s + 2*(-2 + d)*t)) + 
   ...
   (I*(-2 + d)*EL^5*gAl*(aa*(2*(-2 + d)*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t) + 
        2*(-2 + d)*gZlL*gZlR^3*mm^2*(2*psq - s - 2*t) + 
        (-4 + d)*gZlL^4*s*(2*mm^2 - 3*psq + s + t) + (-4 + d)*gZlR^4*s*
         (2*mm^2 - 3*psq + s + t)) + 
      bb*(-2*(-2 + d)*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t) - 
        2*(-2 + d)*gZlL*gZlR^3*mm^2*(2*psq - s - 2*t) - 
        (-4 + d)*gZlL^4*s*(-psq + s + t) - (-4 + d)*gZlR^4*s*(-psq + s + t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) - 
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*mm^2*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*EL^5*gAl*
     (bb*(-2*(-2 + d)*gZlL^3*gZlR*mm^2*(2*psq + (-8 + d)*s - 2*t) - 
        2*(-2 + d)*gZlL*gZlR^3*mm^2*(2*psq + (-8 + d)*s - 2*t) + 
        2*gZlL^2*gZlR^2*mm^2*((4 - 6*d + d^2)*psq + 8*s - 
          (4 - 6*d + d^2)*t) + gZlL^4*(-((16 - 10*d + d^2)*mm^4) + 
      ...
      aa*(2*gZlL^2*gZlR^2*mm^2*(2*(4 - 6*d + d^2)*mm^2 - 3*(4 - 6*d + d^2)*
         ...
         ((-2 + d)*mm^2 - d*(psq + s) + 2*(4*s + t)) - 2*(-2 + d)*gZlL*gZlR^3*
         mm^2*((-2 + d)*mm^2 - d*(psq + s) + 2*(4*s + t)) + 
        gZlL^4*((8 - 6*d + d^2)*mm^4 - (24 - 10*d + d^2)*psq*s + 
   ...
   (I*(-2 + d)*EL^5*gAl*(bb*(2*(-2 + d)*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t) + 
        2*(-2 + d)*gZlL*gZlR^3*mm^2*(2*psq - s - 2*t) - 
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*
    ...
    (2*Pi)^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*
     (-2*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2 + 2*(12 - 6*d + d^2)*gZlL^2*gZlR^2*
       ...
       psq + (24 - 10*d + d^2)*gZlR^4*psq)*\[Mu]^(8 - 2*d)*
