...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
  ...
  (((-I)*2^(-1 - d)*EL^6*gAl*gAu^3*
     ...
     \[Mu]^(4 - d))/(Pi^d*(mzC^2 - s)) - 
   (I*EL^6*gAl*gAu^3*(gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s) + d^2*gZuRC*(2*Pi)^d*s + 
     ...
     \[Mu]^(4 - d)*SPList[SP[p1, q1]])/((2*Pi)^(2*d)*(mzC^2 - s)) - 
   (I*EL^6*gAl*gAu^3*(gZlLC*(-(d^2*gZuLC*(2*Pi)^d*s) + d^2*gZuRC*(2*Pi)^d*s + 
        2^(1 + d)*gZuRC*Pi^d*((4 - 3*d)*s + (8 - 6*d + d^2)*t) + 
   ...
   (I*2^(1 - d)*EL^6*gAl*gAu^3*(gZlRC*gZuLC*(-((-4 + d)*s) + 2*t) + 
      gZlLC*gZuRC*(-((-4 + d)*s) + 2*t) + gZlLC*gZuLC*((-2 + d)*s + 2*t) + 
      gZlRC*gZuRC*((-2 + d)*s + 2*t))*\[Mu]^(4 - d)*SPList[SP[p3, q1]])/
    (Pi^d*(mzC^2 - s)) + 
   (I*EL^6*gAl*gAu^3*(gZlRC*(d^3*gZuLC*(2*Pi)^d*s^2 - d^3*gZuRC*(2*Pi)^d*
   ...
   (I*(-2 + d)*EL^6*gAl*gAu^3*((-2 + d)*gZlLC*gZuLC - (-4 + d)*gZlRC*gZuLC - 
      (-4 + d)*gZlLC*gZuRC + (-2 + d)*gZlRC*gZuRC)*t*\[Mu]^(4 - d)*
     SPList[SP[p2, q1], SP[p2, q1]])/((2*Pi)^d*s*(-mzC^2 + s)) + 
   (I*(-2 + d)*EL^6*gAl*gAu^3*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
 ...
 PropList[KiraPropagator[q1, 0], KiraPropagator[q1, 0], 
  ...
  ((I*EL^6*gAl*gAu^3*(-(gZlRC*gZuLC*((8 - 6*d + d^2)*s^2 + 
    ...
    (Pi^(2*d)*s*(-mzC^2 + s)) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu^3*
     (gZlLC*(-(d^2*gZuLC*(2*Pi)^d*s^2) + d^2*gZuRC*(2*Pi)^d*s^2 + 
        2^(1 + d)*gZuRC*Pi^d*((4 - 3*d)*s^2 + (4 - 5*d + d^2)*s*t - 2*t^2) + 
        2^(1 + d)*gZuLC*Pi^d*(2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 
          2*t^2)) - gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s^2) + 
