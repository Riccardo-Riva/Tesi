...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (((-I)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^4*s*(aa*mm^2*(-2*psq + s + t) + 
      ...
      (-2*aa*psq^2*s + aa*mm^2*psq*(5*psq + s - 5*t) + 
       aa*mm^4*(psq - s - t) - bb*mm^4*(psq + s - t) + 
       bb*mm^2*psq*(-5*psq + 3*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     (2*Pi)^(2*d) - (I*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^4*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*
     ...
     Pi^(2*d) + (I*4^(1 - d)*bb*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*
      (mm^2 - psq)*psq*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
     Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*
      (aa*psq*(psq - t) + aa*mm^2*(psq - s - t) + bb*mm^2*(-psq + t) + 
       bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^4*
     ...
     (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*
      mm^2*psq*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(bb*mm^2*(psq + s - t) + 
       aa*s*(-psq + t) - bb*s*(psq + t) + aa*mm^2*(-psq + s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 + psq)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(bb*(2*mm^2 - psq - t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gFll*gWlN*gXFW*gXll*mm^2*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[q1, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll*gWlN*gXFW*
