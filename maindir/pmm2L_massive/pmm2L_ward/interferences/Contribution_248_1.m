...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((I*4^(-1 - d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*s^2*
  ...
  ((3*I)*2^(-1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*s*
    (bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*4^(-1 - d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*s*
    (-(bb*(6*mm^2 - 8*psq + s + 2*t)) + aa*(-6*mm^2 + 4*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
  ...
  (I*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*s*(-2*psq + s + 2*t)*
  ...
  (I*4^(-1 - d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*s*(aa*(psq - s - t) + 
  ...
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*s*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    s*(bb*(mm^2 - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*s*(aa*(4*mm^2 - 3*psq - t) + 
     bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
  ...
  (I*2^(1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(psq - 2*(s + t)) + 
     bb*(4*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(4*aa*mm^2 - aa*psq - 
     3*bb*psq - 2*aa*t + 2*bb*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(bb*(mm^2 + psq - s - 2*t) + 
     aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(psq - s - t) + 
  ...
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
  ...
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) - (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
  ...
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggagmW^2*
    ggmgmA*gWlN*gWNl*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(mm^2 - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    (aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], SP[q1, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    (aa*(psq - s - t) + bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*psq*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(mm^2 - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q2]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*
  ...
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(aa*(mm^2 - t) + bb*(-psq + t))*
   ...
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmW^2*ggmgmA*gWlN*gWNl*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggagmW^2*ggmgmA*
