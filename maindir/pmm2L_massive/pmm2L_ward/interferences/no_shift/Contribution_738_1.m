...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*2^(1 - 2*d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(mm^2 - psq)*s*
    ...
    Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*
     (-((-4 + d)*psq^2) - 4*psq*s + (-4 + d)*psq*t + 2*s*(s + 2*t) + 
      mm^2*((4 + d)*psq - 4*s - (4 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
     (mm^2 - psq)*(bb*((-2 + d)*psq^2 - (2 + d)*mm^2*(psq - s - t) + 
   ...
   (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*
     ...
     SPList[SP[p2, q1]])/Pi^(2*d) + (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
     (mm^2 - psq)*(aa*(-((-2 + d)*psq^2) - 2*psq*s + (2 + d)*mm^2*(psq - t) + 
        (-2 + d)*psq*t - 2*s*t) + bb*((-2 + d)*psq^2 + 2*s*t + 
        psq*(-2*(-3 + d)*s - (-2 + d)*t) + mm^2*(-((2 + d)*psq) + 
          2*(-2 + d)*s + (2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (2*Pi)^(2*d) + (I*4^(1 - d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*s*
     (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
      bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
   ...
   (I*2^(1 - 2*d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*s*
    ...
    (2*Pi)^(2*d) - (I*4^(2 - d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*
   ...
   (I*2^(1 - 4*d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(psq - t)*
   ...
   (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(2*s + d*(psq - s - t))*
     ...
     (bb*(-(d^2*(2*Pi)^(2*d)*(mm^2 - psq)*(2*psq - s - 2*t)) + 
      ...
      aa*(d^2*(2*Pi)^(2*d)*(mm^2 - psq)*(2*psq + s - 2*t) + 
        4^(1 + d)*Pi^(2*d)*(-2*psq^2 + s*(4*mm^2 + s + t) + 
          psq*(-5*s + 2*t)) - 2^(1 + 2*d)*d*Pi^(2*d)*
         (-4*psq^2 + mm^2*(2*psq + 5*s - 2*t) + s*(s + t) + 
          psq*(-6*s + 4*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
    Pi^(4*d) + (I*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
     (aa*(-2 + d)*(2*Pi)^(2*d)*((-2 + d)*psq^2 + (-8 + d)*psq*s - 
        (-2 + d)*psq*t + 2*s*(s + t) + mm^2*(-((2 + d)*psq) - (-6 + d)*s + 
          (2 + d)*t)) + bb*(4^d*(-4 + d^2)*mm^2*Pi^(2*d)*(psq - s - t) - 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
   ...
   (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ...
    (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*s*
     (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
      bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(-2 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
