...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*mm^2*(-4*(-4 + d)*gZlL*gZlR*s + 
      gZlL^2*(2*(-4 + d)*mm^2 - 2*(-2 + d)*psq + (-3 + d)*s) + 
      gZlR^2*(2*(-4 + d)*mm^2 - 2*(-2 + d)*psq + (-3 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-4*(-4 + d)*gZlL*gZlR*mm^2*s^2 + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*mm^2*(-4*(-4 + d)*gZlL*gZlR*s^2 + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-2*(-2 + d)*gZlL*gZlR*mm^2*s + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
     (8*gZlL*gZlR*mm^2*(-psq + s + t) + gZlL^2*(8*psq^2 + (-2 + d)*mm^2*s - 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(-psq + s + t) + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*mm^2*(-2*(-2 + d)*gZlL*gZlR*s + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*mm^2*(4*(-4 + d)*gZlL*gZlR*s + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(16*gZlL*gZlR*mm^2*(psq - t) + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(8*gZlL*gZlR*mm^2*(psq - t) + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL - gZlR)^2*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL - gZlR)^2*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-4*gZlL*gZlR*mm^2 + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(-8*gZlL*gZlR*mm^2 + 
      (-5 + d)*gZlL^2*s + (-5 + d)*gZlR^2*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
     (4*psq^2 + 2*(-6 + d)*mm^2*s - 6*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
      ...
      SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
    ...
    (Pi^(2*d)*s^2) + (2^(7 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
     (gZlL^2 + gZlR^2)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
     (gZlL^2 + gZlR^2)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
    ...
    (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
     ...
     gFFZ^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
   ...
   (2^(7 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*(-2*psq + s + 2*t)*
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*(gZlL^2 + gZlR^2)*
     ...
     (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) - (2^(7 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ^2*
     (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFZ^2*
