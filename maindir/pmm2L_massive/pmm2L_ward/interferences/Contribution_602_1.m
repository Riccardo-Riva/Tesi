...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (((-I)*4^(-1 - d)*d*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*d*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*s*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*d*EL^5*gAl*gFAW*gFll*gWlN*gWWA*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*d*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gFAW*gFll*gWlN*gWWA*mm^2*
