...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*
    (gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*
    (gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) - (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*
    (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
   Pi^(2*d) - (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*
  ...
  (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*(2*s + t)*
  ...
  (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*(s + t)*
   ...
   (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*t*
   ...
   (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*t*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*
    t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*t*
