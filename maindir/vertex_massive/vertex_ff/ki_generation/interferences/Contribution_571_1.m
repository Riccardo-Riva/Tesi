...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
   ...
   (-((4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq^2 - 2*psq*t + t*(s + t))*
      ...
      ((24 - 7*d)*psq^3 + 8*t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
      (-(mm^2*(psq - t)*(4*(1 + d)*psq - (8 + d)*s - 4*(1 + d)*t)) + 
       2*(-4*(-2 + d)*psq^3 + psq*t*((11 - 6*d)*s + 2*(12 - 5*d)*t) + 
         psq^2*((-3 + 2*d)*s + (-24 + 11*d)*t) + t*(s + t)*
          (-8*t + d*(s + 3*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(-psq + s + t)*
      ((-4 + d)*mm^2 - 3*(-3 + d)*psq - s + d*s - 5*t + 2*d*t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-((-8 + d)*psq^3) - 
       psq^2*((2 + d)*s - 4*(-6 + d)*t) + t*(s + t)*((-6 + d)*s + 
         2*(-4 + d)*t) + mm^2*(psq - s - t)*((4 + d)*psq - 6*s - (4 + d)*t) + 
       psq*((-4 + d)*s^2 - 2*(-8 + d)*s*t + (24 - 5*d)*t^2))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
       ...
       SP[q2, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
      gHll^2*mm^4*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)*
    ...
    (4^(2 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*(psq - t)*
