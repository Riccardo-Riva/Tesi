...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
 ...
 (-((2^(3 - 2*d)*(-1 + d)*d*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*(gZlL + gZlR)*mm^2*
  ...
  (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*(gZlL + gZlR)*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*
    (gZlL + gZlR)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl^2*
    gAu^2*gWWA*gWWAZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*(gZlL + gZlR)*
  ...
  (4^(1 - d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*(gZlL + gZlR)*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*
  ...
  (4^(1 - d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*(gZlL + gZlR)*
   ...
   (Pi^(2*d)*s) - (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gWWA*gWWAZ*
