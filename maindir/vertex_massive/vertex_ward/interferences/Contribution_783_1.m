...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (((-I)*2^(3 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^4*s*
      (bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*
      \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*
      (4*aa*mm^2*(psq - s - t) - aa*s*(-3*psq + s + t) + 
       bb*s*(-psq + s + t) + bb*mm^2*(-4*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*ml^4*mm^2*
    ...
    (I*4^(2 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*(bb*(psq - s - t) + 
       ...
       SP[p1, q1]])/Pi^(2*d) - (I*4^(2 - d)*EL^5*gAl*gHll^4*ml^4*mm^2*
