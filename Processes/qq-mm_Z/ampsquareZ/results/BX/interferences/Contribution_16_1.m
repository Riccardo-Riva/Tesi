...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mz], 
   ...
   ((I*EL^6*t*(gZlL^2*gZlLC*(-(gZuR^2*gZuRC*((8 - 6*d + d^2)*s^2 + 
    ...
    (I*EL^6*((t*(s + t)*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) + 2*t) + 
      ...
      SPList[SP[p1, q1], SP[q1, q1]])/(mz^4*(mzC^2 - s)) - 
    (I*EL^6*t^2*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) + 2*t) + 
         gZuL^2*gZuLC*((-2 + d)*s + 2*t)) + gZlR^2*gZlRC*
        (gZuL^2*gZuLC*(-((-4 + d)*s) + 2*t) + gZuR^2*gZuRC*
          ((-2 + d)*s + 2*t)))*SPList[SP[p2, q1], SP[q1, q1]])/
     (mz^4*(2*Pi)^d*(mzC^2 - s)) - 
    ...
    (I*EL^6*(s*t*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
    ...
    (I*2^(1 - d)*EL^6*(s + t)*
      (gZlR^2*gZlRC*(gZuR^2*gZuRC*((-2 + d)*s - (-6 + d)*t) + 
         gZuL^2*gZuLC*(-((-4 + d)*s) + d*t)) + gZlL^2*gZlLC*
        (gZuL^2*gZuLC*((-2 + d)*s - (-6 + d)*t) + gZuR^2*gZuRC*
          (-((-4 + d)*s) + d*t)))*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q1]])/
     (mz^4*Pi^d*(mzC^2 - s)) + 
    (I*2^(2 - d)*EL^6*(gZlL^2*gZlLC*((-2 + d)*gZuL^2*gZuLC - 
         (-4 + d)*gZuR^2*gZuRC) + gZlR^2*gZlRC*(-((-4 + d)*gZuL^2*gZuLC) + 
         (-2 + d)*gZuR^2*gZuRC))*t*(s + t)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) + 
    (I*2^(2 - d)*EL^6*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s^2) + 4*s*t + 
           2*t^2) + gZuL^2*gZuLC*((-2 + d)*s^2 + 4*s*t + 2*t^2)) + 
       gZlR^2*gZlRC*(gZuL^2*gZuLC*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
         gZuR^2*gZuRC*((-2 + d)*s^2 + 4*s*t + 2*t^2)))*
      SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) + 
    (I*EL^6*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-3*(-4 + d)*s^2 + (18 - 5*d)*s*t + 
           2*t^2) + gZuL^2*gZuLC*(3*(-2 + d)*s^2 + (-12 + 5*d)*s*t + 
           2*t^2)) + gZlR^2*gZlRC*(gZuL^2*gZuLC*(-3*(-4 + d)*s^2 + 
           (18 - 5*d)*s*t + 2*t^2) + gZuR^2*gZuRC*(3*(-2 + d)*s^2 + 
           (-12 + 5*d)*s*t + 2*t^2)))*SPList[SP[p1, q1], SP[q1, q1], 
       SP[q1, q1]])/(mz^4*(2*Pi)^d*(mzC^2 - s)) + 
    (I*2^(1 - d)*EL^6*(gZlL^2*gZlLC*((-2 + d)*gZuL^2*gZuLC - 
         (-4 + d)*gZuR^2*gZuRC) + gZlR^2*gZlRC*(-((-4 + d)*gZuL^2*gZuLC) + 
         (-2 + d)*gZuR^2*gZuRC))*t^2*SPList[SP[p2, q1], SP[p2, q1], 
       SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) - 
    (I*2^(3 - d)*EL^6*(gZlL^2*gZlLC + gZlR^2*gZlRC)*
      (gZuL^2*gZuLC + gZuR^2*gZuRC)*t^2*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) - 
    (I*EL^6*t*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) + 2*t) + 
         gZuL^2*gZuLC*((-2 + d)*s + 2*t)) + gZlR^2*gZlRC*
        (gZuL^2*gZuLC*(-((-4 + d)*s) + 2*t) + gZuR^2*gZuRC*
          ((-2 + d)*s + 2*t)))*SPList[SP[p2, q1], SP[q1, q1], SP[q1, q1]])/
     (mz^4*(2*Pi)^d*(mzC^2 - s)) - 
    (I*2^(1 - d)*EL^6*s*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) + 4*t) + 
         gZuL^2*gZuLC*((-2 + d)*s + 4*t)) + gZlR^2*gZlRC*
        (gZuL^2*gZuLC*(-((-4 + d)*s) + 4*t) + gZuR^2*gZuRC*
          ((-2 + d)*s + 4*t)))*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1]])/
     (mz^4*Pi^d*(mzC^2 - s)) + 
    (I*EL^6*s*(gZlR^2*gZlRC*(gZuR^2*gZuRC*(-3*(-2 + d)*s + 2*(5 - 2*d)*t) + 
         gZuL^2*gZuLC*(3*(-4 + d)*s + 2*(-7 + 2*d)*t)) + 
       gZlL^2*gZlLC*(gZuL^2*gZuLC*(-3*(-2 + d)*s + 2*(5 - 2*d)*t) + 
         gZuR^2*gZuRC*(3*(-4 + d)*s + 2*(-7 + 2*d)*t)))*
    ...
    (I*EL^6*s*(gZlR^2*gZlRC*(gZuR^2*gZuRC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
       ...
       gZlL^2*gZlLC*(gZuL^2*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         gZuR^2*gZuRC*((-4 + d)*s + 2*(-3 + d)*t)))*SPList[SP[q1, q1], 
    ...
    (I*2^(2 - d)*EL^6*(gZlR^2*gZlRC*((-2 + d)*gZuL^2*gZuLC - 
         ...
         (-2 + d)*gZuR^2*gZuRC))*(s + t)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p1, q1], SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) + 
    (I*4^(1 - d)*EL^6*
      (-(gZlR^2*gZlRC*(-(gZuR^2*gZuRC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
       ...
       gZlL^2*gZlLC*(gZuL^2*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
           ...
           2^(1 + d)*Pi^d*(2*s + 3*t - d*t))))*SPList[SP[p1, q1], SP[p1, q1], 
       SP[p2, q1], SP[q1, q1]])/(mz^4*Pi^(2*d)*(mzC^2 - s)) + 
    (I*4^(1 - d)*EL^6*(gZlL^2*gZlLC*
        (-(gZuR^2*gZuRC*(2^(1 + d)*(-1 + d)*Pi^d*s + d*(2*Pi)^d*t)) + 
         gZuL^2*gZuLC*(2^(1 + d)*Pi^d*((-5 + d)*s - 3*t) + d*(2*Pi)^d*t)) - 
       gZlR^2*gZlRC*(gZuL^2*gZuLC*(2^(1 + d)*(-1 + d)*Pi^d*s + 
           d*(2*Pi)^d*t) - gZuR^2*gZuRC*(2^(1 + d)*Pi^d*((-5 + d)*s - 3*t) + 
           d*(2*Pi)^d*t)))*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q1], 
       SP[q1, q1]])/(mz^4*Pi^(2*d)*(mzC^2 - s)) + 
    (I*2^(1 - d)*EL^6*(gZlR^2*gZlRC*(-((-2 + d)*gZuL^2*gZuLC) + 
         (-4 + d)*gZuR^2*gZuRC) + gZlL^2*gZlLC*((-4 + d)*gZuL^2*gZuLC - 
         (-2 + d)*gZuR^2*gZuRC))*(s + t)*SPList[SP[p1, q1], SP[p1, q1], 
       SP[q1, q1], SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) + 
    (I*4^(1 - d)*EL^6*t*(gZlL^2*gZlLC*(gZuL^2*gZuLC*(2^(1 + d)*Pi^d - 
    ...
    (I*2^(3 - d)*EL^6*(gZlL^2*gZlLC*((-2 + d)*gZuL^2*gZuLC - 
         (-4 + d)*gZuR^2*gZuRC) + gZlR^2*gZlRC*(-((-4 + d)*gZuL^2*gZuLC) + 
         (-2 + d)*gZuR^2*gZuRC))*t*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1], 
       SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) + 
    (I*2^(1 - d)*EL^6*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) - 
           2*(-3 + d)*t) + gZuL^2*gZuLC*((-2 + d)*s + 2*(-3 + d)*t)) + 
       gZlR^2*gZlRC*(gZuL^2*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZuR^2*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)))*SPList[SP[p1, q1], 
       SP[p2, q1], SP[q1, q1], SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) + 
    (I*4^(1 - d)*EL^6*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(d*(2*Pi)^d*s + 
    ...
    (I*2^(1 - d)*EL^6*(gZlR^2*gZlRC*(d*(gZuL^2*gZuLC - gZuR^2*gZuRC)*s + 
       ...
       gZlL^2*gZlLC*(gZuL^2*gZuLC*(-((-6 + d)*s) + 2*t) + 
         gZuR^2*gZuRC*(d*s + 2*t)))*SPList[SP[p1, q1], SP[p3, q1], 
       SP[q1, q1], SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) - 
    (I*4^(1 - d)*EL^6*t*(gZlL^2*gZlLC*(gZuL^2*gZuLC*(2^(1 + d)*Pi^d - 
           d*(2*Pi)^d) - gZuR^2*gZuRC*(2^(2 + d)*Pi^d - d*(2*Pi)^d)) + 
       gZlR^2*gZlRC*(gZuR^2*gZuRC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
    ...
    (I*2^(1 - d)*EL^6*(gZlL^2*gZlLC*(gZuL^2*gZuLC*((-2 + d)*s - 2*t) - 
         gZuR^2*gZuRC*((-4 + d)*s + 2*t)) - gZlR^2*gZlRC*
        (gZuL^2*gZuLC*((-4 + d)*s + 2*t) + gZuR^2*gZuRC*(-((-2 + d)*s) + 
           2*t)))*SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1], SP[q1, q1]])/
     (mz^4*Pi^d*(mzC^2 - s)) - 
    (I*2^(3 - d)*EL^6*(gZlL^2*gZlLC + gZlR^2*gZlRC)*
      (gZuL^2*gZuLC + gZuR^2*gZuRC)*s*SPList[SP[p3, q1], SP[p3, q1], 
       SP[p3, q1], SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) + 
    (I*4^(1 - d)*EL^6*(gZlL^2*gZlLC + gZlR^2*gZlRC)*
      (gZuL^2*gZuLC + gZuR^2*gZuRC)*s*(-(2*Pi)^d + 2^(1 + d)*Pi^d*
        GaugeXi[Q] - (2*Pi)^d*GaugeXi[Q]^2)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q1, q1], SP[q1, q1]])/(mz^4*Pi^(2*d)*(mzC^2 - s)*
      (-1 + GaugeXi[Q])^2)) + PropList[KiraPropagator[q1, 0], 
   ...
   (((-I)*EL^6*t*(s + t)*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) + 2*t) + 
         gZuL^2*gZuLC*((-2 + d)*s + 2*t)) + gZlR^2*gZlRC*
        (gZuL^2*gZuLC*(-((-4 + d)*s) + 2*t) + gZuR^2*gZuRC*
          ((-2 + d)*s + 2*t)))*SPList[SP[p1, q1], SP[q1, q1]])/
     (mz^4*(2*Pi)^d*(mzC^2 - s)) + 
    (I*EL^6*t^2*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) + 2*t) + 
         gZuL^2*gZuLC*((-2 + d)*s + 2*t)) + gZlR^2*gZlRC*
        (gZuL^2*gZuLC*(-((-4 + d)*s) + 2*t) + gZuR^2*gZuRC*
    ...
    (I*EL^6*s*t*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) + 2*t) + 
         gZuL^2*gZuLC*((-2 + d)*s + 2*t)) + gZlR^2*gZlRC*
        (gZuL^2*gZuLC*(-((-4 + d)*s) + 2*t) + gZuR^2*gZuRC*
          ((-2 + d)*s + 2*t)))*SPList[SP[p3, q1], SP[q1, q1]])/
     (mz^4*(2*Pi)^d*(mzC^2 - s)) + 
    (I*EL^6*s*t*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZuL^2*gZuLC*((-2 + d)*s + 2*(-3 + d)*t)) + 
       gZlR^2*gZlRC*(gZuL^2*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
         gZuR^2*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)))*SPList[SP[q1, q1], 
       SP[q1, q1]])/(mz^4*(2*Pi)^d*(mzC^2 - s)) + 
    (I*2^(1 - d)*EL^6*(s + t)*
      (gZlR^2*gZlRC*(gZuR^2*gZuRC*((-2 + d)*s - (-6 + d)*t) + 
         gZuL^2*gZuLC*(-((-4 + d)*s) + d*t)) + gZlL^2*gZlLC*
    ...
    (I*2^(1 - d)*EL^6*s*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) + 4*t) + 
        ...
        (gZuL^2*gZuLC*(-((-4 + d)*s) + 4*t) + gZuR^2*gZuRC*
          ((-2 + d)*s + 4*t)))*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1]])/
     (mz^4*Pi^d*(mzC^2 - s)) + 
    (I*EL^6*s*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-3*(-4 + d)*s + 2*(7 - 2*d)*t) + 
         gZuL^2*gZuLC*(3*(-2 + d)*s + 2*(-5 + 2*d)*t)) + 
       gZlR^2*gZlRC*(gZuL^2*gZuLC*(-3*(-4 + d)*s + 2*(7 - 2*d)*t) + 
         gZuR^2*gZuRC*(3*(-2 + d)*s + 2*(-5 + 2*d)*t)))*
      SPList[SP[p3, q1], SP[q1, q1], SP[q1, q1]])/
     (mz^4*(2*Pi)^d*(mzC^2 - s)) + 
    ...
    (I*2^(1 - d)*EL^6*(gZlR^2*gZlRC*(gZuR^2*gZuRC*(-((-2 + d)*s) - 
       ...
       gZlL^2*gZlLC*(gZuL^2*gZuLC*(-((-2 + d)*s) - 2*(-3 + d)*t) + 
         gZuR^2*gZuRC*((-4 + d)*s + 2*(-3 + d)*t)))*SPList[SP[p1, q1], 
       SP[p2, q1], SP[q1, q1], SP[q1, q1]])/(mz^4*Pi^d*(mzC^2 - s)) - 
    (I*4^(1 - d)*EL^6*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(d*(2*Pi)^d*s + 
           2^(1 + d)*Pi^d*(s + t)) + gZuL^2*gZuLC*(-(d*(2*Pi)^d*s) + 
           2^(1 + d)*Pi^d*(4*s + t))) + gZlR^2*gZlRC*
    ...
    (I*4^(1 - d)*EL^6*(gZlL^2*gZlLC + gZlR^2*gZlRC)*
      (gZuL^2*gZuLC + gZuR^2*gZuRC)*s*((2*Pi)^d - 2^(1 + d)*Pi^d*GaugeXi[Q] + 
       ...
       SP[q1, q1]])/(mz^4*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])^2)) + 
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mz], 
    KiraPropagator[p2 + q1, mz], KiraPropagator[-p1 + p3 + q1, 0]]*
   ((I*EL^6*(gZlR^2*gZlRC*(gZuR^2*gZuRC*((8 + 12*d - 8*d^2 + d^3)*s^2 + 
           (-2 + d)^2*(-16 + 3*d)*s*t + 2*(-20 + 20*d - 8*d^2 + d^3)*t^2) + 
         gZuL^2*gZuLC*(-((-8 + 18*d - 8*d^2 + d^3)*s^2) + 
           (56 - 78*d + 28*d^2 - 3*d^3)*s*t - 2*(-16 + 22*d - 8*d^2 + d^3)*
            t^2)) + gZlL^2*gZlLC*(gZuL^2*gZuLC*((8 + 12*d - 8*d^2 + d^3)*
            s^2 + (-2 + d)^2*(-16 + 3*d)*s*t + 2*(-20 + 20*d - 8*d^2 + d^3)*
            t^2) + gZuR^2*gZuRC*(-((-8 + 18*d - 8*d^2 + d^3)*s^2) + 
           (56 - 78*d + 28*d^2 - 3*d^3)*s*t - 2*(-16 + 22*d - 8*d^2 + d^3)*
            t^2)))*SPList[SP[p1, q1]])/((2*Pi)^d*(mzC^2 - s)) - 
    (I*EL^6*t*(gZlL^2*gZlLC*(-((-4 + d)*gZuR^2*gZuRC*((-6 + d^2)*s + 
            2*(6 - 4*d + d^2)*t)) + gZuL^2*gZuLC*((24 - 4*d - 4*d^2 + d^3)*
            s + 2*(-12 + 20*d - 8*d^2 + d^3)*t)) + 
       gZlR^2*gZlRC*(-((-4 + d)*gZuL^2*gZuLC*((-6 + d^2)*s + 
            2*(6 - 4*d + d^2)*t)) + gZuR^2*gZuRC*((24 - 4*d - 4*d^2 + d^3)*
            s + 2*(-12 + 20*d - 8*d^2 + d^3)*t)))*SPList[SP[p2, q1]])/
     ((2*Pi)^d*(mzC^2 - s)) - 
    (I*EL^6*(gZlR^2*gZlRC*(gZuR^2*gZuRC*((8 + 12*d - 8*d^2 + d^3)*s^2 + 
       ...
       gZlL^2*gZlLC*(gZuL^2*gZuLC*((8 + 12*d - 8*d^2 + d^3)*s^2 + 
         ...
         gZuR^2*gZuRC*((-8 + 18*d - 8*d^2 + d^3)*s^2 + 
           2*(-40 + 42*d - 12*d^2 + d^3)*s*t + 16*t^2)))*SPList[SP[p3, q1]])/
     ((2*Pi)^d*(mzC^2 - s)) - 
    (I*EL^6*((2^(1 - d)*t*(gZlL^2*gZlLC*(-(gZuR^2*gZuRC*((8 - 6*d + d^2)*
                s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) + gZuL^2*gZuLC*
             ((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2)) + 
          gZlR^2*gZlRC*(-(gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + 
                 d^2)*s*t - 4*t^2)) + gZuR^2*gZuRC*((-2 + d)^2*s^2 + 
              2*(8 - 5*d + d^2)*s*t + 4*t^2))))/(mz^2*Pi^d) + 
       (gZlR^2*gZlRC*(gZuR^2*gZuRC*((8 + 12*d - 8*d^2 + d^3)*s^2 + 
             4*(38 - 22*d + 3*d^2)*s*t + 8*(8 - 6*d + d^2)*t^2) - 
           gZuL^2*gZuLC*((-8 + 18*d - 8*d^2 + d^3)*s^2 + 
             4*(40 - 22*d + 3*d^2)*s*t + 8*(10 - 6*d + d^2)*t^2)) + 
         gZlL^2*gZlLC*(gZuL^2*gZuLC*((8 + 12*d - 8*d^2 + d^3)*s^2 + 
             4*(38 - 22*d + 3*d^2)*s*t + 8*(8 - 6*d + d^2)*t^2) - 
           gZuR^2*gZuRC*((-8 + 18*d - 8*d^2 + d^3)*s^2 + 
             4*(40 - 22*d + 3*d^2)*s*t + 8*(10 - 6*d + d^2)*t^2)))/(2*Pi)^d)*
      SPList[SP[q1, q1]])/(mzC^2 - s) - 
    (I*2^(1 - d)*(-4 + d)*EL^6*
      (gZlL^2*gZlLC*((28 - 12*d + d^2)*gZuL^2*gZuLC - (26 - 12*d + d^2)*
          gZuR^2*gZuRC) + gZlR^2*gZlRC*(-((26 - 12*d + d^2)*gZuL^2*gZuLC) + 
         (28 - 12*d + d^2)*gZuR^2*gZuRC))*(s + t)*SPList[SP[p1, q1], 
    ...
    (I*2^(1 - d)*EL^6*(gZlL^2*gZlLC*(-((-4 + d)*gZuR^2*gZuRC*
       ...
       gZlR^2*gZlRC*(-((-4 + d)*gZuL^2*gZuLC*((2 - 4*d + d^2)*s + 
           ...
           8*(15 - 8*d + d^2)*t)))*SPList[SP[p1, q1], SP[p2, q1]])/
     (Pi^d*(mzC^2 - s)) + (I*2^(1 - d)*EL^6*
    ...
    (I*2^(1 - 2*d)*EL^6*
      (-(gZlR^2*gZlRC*(-(gZuR^2*gZuRC*(2^(2 + d)*(-2 - 3*d + 2*d^2)*Pi^d - 
             d^3*(2*Pi)^d)) + gZuL^2*gZuLC*(2^(1 + d)*(4 - 9*d + 4*d^2)*
    ...
    (I*2^(1 - d)*EL^6*(gZlL^2*gZlLC*(-((-4 + d)*gZuR^2*gZuRC*
        ...
        (-((-4 + d)*gZuL^2*gZuLC*((2 - 4*d + d^2)*s - 2*(14 - 8*d + d^2)*
             t)) + gZuR^2*gZuRC*((8 + 12*d - 8*d^2 + d^3)*s - 
    ...
    (I*4^(1 - d)*EL^6*
      ...
      SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*(mzC^2 - s)) + 
    (I*EL^6*((s*t*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) + 2*t) + 
            gZuL^2*gZuLC*((-2 + d)*s + 2*t)) + gZlR^2*gZlRC*
           (gZuL^2*gZuLC*(-((-4 + d)*s) + 2*t) + gZuR^2*gZuRC*
             ((-2 + d)*s + 2*t))))/(2*Pi)^d - 
       (2^(2 - d)*mz^2*(gZlL^2*gZlLC*(-(gZuR^2*gZuRC*((8 - 6*d + d^2)*s^2 + 2*
          ...
          gZlR^2*gZlRC*(-(gZuL^2*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + 
              ...
              2*(8 - 5*d + d^2)*s*t + 4*t^2))))/Pi^d)*
      SPList[SP[p3, q1], SP[q1, q1]])/(mz^4*(mzC^2 - s)) + 
    (I*EL^6*((s*t*(gZlL^2*gZlLC*(gZuR^2*gZuRC*(-((-4 + d)*s) - 
              2*(-3 + d)*t) + gZuL^2*gZuLC*((-2 + d)*s + 2*(-3 + d)*t)) + 
          gZlR^2*gZlRC*(gZuL^2*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
    ...
    (I*4^(1 - d)*EL^6*(gZlL^2*gZlLC + gZlR^2*gZlRC)*
      (gZuL^2*gZuLC + gZuR^2*gZuRC)*s*((2*Pi)^d - 2^(1 + d)*Pi^d*GaugeXi[Q] + 
       (2*Pi)^d*GaugeXi[Q]^2)*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(mz^4*Pi^(2*d)*(mzC^2 - s)*(-1 + GaugeXi[Q])^2)))/4
