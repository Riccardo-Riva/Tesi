...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^4*
   ...
   (4^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*
     ...
     (gZlL*mm^2*(2*(-2 + d)*psq^2 + (-4 + d)*s^2 + 2*(-2 + d)*s*t + 
      ...
      gZlR*(d*(-2*psq^3 - mm^4*s + 3*psq^2*(s + 2*t) + (s + t)^2*(s + 2*t) + 
          mm^2*(psq^2 + psq*(s - 2*t) + t^2) - psq*(3*s^2 + 8*s*t + 6*t^2)) + 
        2*(2*psq^3 + 2*mm^4*s - 2*s^3 - 7*s^2*t - 7*s*t^2 - 2*t^3 + 
          mm^2*s*(s + 3*t) - psq^2*(5*s + 6*t) + 
       ...
       (gZlL*mm^2*(3*psq^2 - 4*psq*s + 2*s^2 - 6*psq*t + 4*s*t + 3*t^2) + 
        gZlR*(6*psq^3 + 2*psq*t*(4*s + 7*t) - 2*psq^2*(s + 8*t) - 
          2*t*(s^2 + 3*s*t + 2*t^2) + mm^2*(5*psq^2 - 2*psq*(s + 5*t) + 
            t*(4*s + 5*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(4*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^4*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
     ((16 - 7*d)*psq^3 + psq*t*((24 - 11*d)*s + 5*(8 - 3*d)*t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^4*(psq - t)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
     ((8 - 3*d)*psq^3 + (-4 + d)*mm^2*(psq - t)*(psq - s - t) + 
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*((-4 + d)*gZlR*(mm^2 - psq)*s + 
      2*(-2 + d)*gZlL*mm^2*(2*psq - s - 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(2*psq*(psq - s - t) + 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*((-4 + d)*psq^2 + d*mm^2*s - 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(2*psq - s - 2*t)*
