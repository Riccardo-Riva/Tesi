...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
   ...
   (-((2^(1 - 2*d)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(aa*psq*(2*mm^2 + s) - 
     ...
     (mh^2*Pi^(2*d)) + ((aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
      (4*psq - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(mh^2*(2*Pi)^(2*d)) - 
    (4^(1 - d)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(bb*mm^2 - aa*psq)*
