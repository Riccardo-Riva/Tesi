...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
   ...
   ((2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
     ...
     (Pi^(4*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*
      (2*gZlL*gZlR*(-(d*(2*Pi)^(2*d)*psq*(3*psq^2 - s^2 + 11*t^2)) - 
       ...
       gZlL^2*(-(d*(2*Pi)^(2*d)*psq*s*(5*psq + s - 13*t)) + 
         ...
         2^(1 + 2*d)*Pi^(2*d)*(3*(-2 + d)*psq^3 + 
           psq^2*(9*s - 8*(-2 + d)*t) - psq*(2*s^2 + 21*s*t - 
             7*(-2 + d)*t^2) + (s + t)*(s^2 - 2*(-4 + d)*s*t - 
             2*(-2 + d)*t^2))) + gZlR^2*
        (-(d*(2*Pi)^(2*d)*psq*s*(5*psq + s - 13*t)) + 4^(1 + d)*(-2 + d)*mm^2*
          Pi^(2*d)*(-psq + s + t)^2 + 2^(1 + 2*d)*Pi^(2*d)*
          (3*(-2 + d)*psq^3 + psq^2*(9*s - 8*(-2 + d)*t) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*(gZlL^2*mm^2*(psq - s - t)*
        (-((-2 + d)*mm^2) + 2*(-2 + d)*psq + s - d*s + 2*t - d*t) + 
       gZlR^2*mm^2*(psq - s - t)*(-((-2 + d)*mm^2) + 2*(-2 + d)*psq + s - 
         d*s + 2*t - d*t) + 2*gZlL*gZlR*(-4*psq^3 + d*mm^2*(psq - s - t)*
          (mm^2 - 2*psq + s + t) + 2*psq^2*(s + 5*t) + 
         psq*(3*mm^2*s - 8*t*(s + t)) + (s + t)*(-(mm^2*s) + 2*t*(s + t))))*
     ...
     (Pi^(2*d)*s) + (4^(1 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*
      ...
      (gZlL^2*mm^2*(2*(-2 + d)*psq^2 + (-2 + d)*mm^2*s - 3*s^2 + 2*d*s^2 - 
       ...
       gZlR^2*mm^2*(2*(-2 + d)*psq^2 + (-2 + d)*mm^2*s - 3*s^2 + 2*d*s^2 - 
         8*s*t + 4*d*s*t - 4*t^2 + 2*d*t^2 - (-2 + d)*psq*(5*s + 4*t)) - 
       2*gZlL*gZlR*(2*psq^3 - 2*mm^2*psq*s + mm^2*s^2 + 2*mm^2*s*t - 
         2*s^2*t - 4*s*t^2 - 2*t^3 + 6*psq*t*(s + t) - 2*psq^2*(s + 3*t) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
      ((-2 + d)*gZlL^2*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
         ...
         psq*(-3*d*mm^2*s + 2*d*t*(s + t) + 4*t*(4*s + 3*t))))*
    ...
    (4^(1 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*(gZlL^2*mm^2*(2*Pi)^(2*d)*
       ...
       gZlR^2*mm^2*(2*Pi)^(2*d)*(4*(-2 + d)*mm^2 - 4*(-2 + d)*psq - 
         (-6 + d)*s)*(psq - t) + 2*gZlL*gZlR*
        (-(4^d*(-4 + d)*mm^4*Pi^(2*d)*(psq - t)) + mm^2*(2*Pi)^(2*d)*
          (-((-6 + d)*psq^2) + (2 + d)*psq*s - 2*s^2 + (-16 + 3*d)*psq*t - 
           3*(-2 + d)*s*t - 2*(-5 + d)*t^2) + (2*Pi)^(2*d)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*mm^2*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + 
       (-2 + d)*gZlR^2*mm^2*(psq - s - t) - 2*gZlL*gZlR*mm^2*
        ((-2 + d)*psq + s - d*s - (-2 + d)*t) + 4*gZlL*gZlR*
    ...
    (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*
      ...
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*
      mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*d*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*
      mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
