...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 (-((2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 - psq)*((-2 + d)*s^2 + mm^2*(4*psq + (-6 + d)*s))*\[Mu]^(8 - 2*d))/
    (Pi^(2*d)*s)) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(mm^2 - (-2 + d)*psq - (-3 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (d*s*(psq + s) + mm^2*(2*psq - (-2 + d)*s - 2*t) - 2*s*(3*s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/((2*Pi)^(2*d)*s^2) + 
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4*(psq - 2*s - t) + s*(2*(2 + d)*psq^2 + (-14 + 3*d)*psq*s + 
       (-4 + d)*s^2 - 4*psq*t - 2*s*t) - 2*mm^2*(6*psq^2 + (-3 + d)*psq*s + 
       (-22 + 4*d)*s^2 - 10*psq*t + 3*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (d*psq*s + 2*mm^2*(psq + s - t) - 2*s*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (mm^2*(2*psq + (-4 + d)*s - 2*t) - s*((-4 + d)*psq + (-4 + d)*s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/((2*Pi)^(2*d)*s^2) - 
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4*(psq + s - t) - s*(2*(-2 + d)*psq^2 + (-14 + 3*d)*psq*s + 
       (-2 + d)*s^2 + 4*psq*t + 2*s*t) + 2*mm^2*(2*psq^2 + (-3 + d)*psq*s + 
       (-21 + 4*d)*s^2 - 6*psq*t + 5*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (2*mm^2*(psq - 2*s - t) - s*((-4 + d)*psq + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/((2*Pi)^(2*d)*s^2) + 
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(4*mm^2 - (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/
   (Pi^(2*d)*s) - (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(4*(-4 + d)*mm^4*s - 4*mm^2*(psq^2 + (-3 + d)*psq*s + (-8 + d)*s^2 - 
       2*psq*t + s*t + t^2) + s*(4*psq^2 + (-12 + d)*psq*s + (-8 + 3*d)*s^2 - 
       8*psq*t + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*((-4 + d)*mm^2 + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   ((2*Pi)^(2*d)*s) + (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   ((2*Pi)^(2*d)*s^2) + (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(2*d*mm^4*s - s*(4*psq^2 + (12 - 5*d)*psq*s + 
       (-2 + d)*s^2 - 8*psq*t + 4*s*t + 4*t^2) + 
     2*mm^2*(2*psq^2 - 5*s^2 + 2*s*t + 2*t^2 - psq*((-8 + d)*s + 4*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(4*mm^2 - (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(mm^4 - psq^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(mm^2 - psq)*(2*mm^2 + 2*psq - (-3 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^4 + psq*(-6*psq + s) + mm^2*(8*psq - 23*s + 4*d*s - 4*t))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^4 + psq*(-6*psq + s) + mm^2*((-19 + 4*d)*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-3 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(4*psq^2 + 2*(-2 + d)*mm^2*s - 9*s^2 + 2*d*s^2 + 4*s*t + 4*t^2 - 
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (10*psq^2 - 2*s^2 + d*s^2 + 2*mm^2*(psq + (-11 + d)*s - t) + 4*s*t + 
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-8*psq^2 + 2*mm^2*(2*psq + (-8 + d)*s - 2*t) + s*(-((-4 + d)*s) + 2*t) + 
     psq*((22 - 6*d)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2]])/((2*Pi)^(2*d)*s^2) - 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4 - 12*psq^2 + (-18 + 7*d)*psq*s + 2*s*((-4 + d)*s - 2*t) + 
     2*mm^2*(5*psq + 3*s - 2*d*s - t))*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4 - 12*psq^2 + 2*(-10 + 3*d)*psq*s + s*((-4 + d)*s - 2*t) + 
     2*mm^2*(6*psq + s - d*s - 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/((2*Pi)^(2*d)*s^2) - 
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-4*psq^2 + mm^2*(4*psq - 32*s + 6*d*s - 4*t) + s*(4*s - d*s + 2*t) + 
     psq*(22*s - 6*d*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, p3]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(s*(8*psq - 16*s + 3*d*s - 6*t) - 
     4*mm^2*(psq - 3*s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-4*psq^2 + mm^2*(6*psq - 36*s + 8*d*s - 6*t) + 2*s*(4*s - d*s + 2*t) + 
     psq*(20*s - 7*d*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q2]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (6*mm^2 + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s) - (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(-4*psq^2 + mm^2*(4*psq - 32*s + 6*d*s - 4*t) + 
     s*(4*s - d*s + 2*t) + psq*(22*s - 6*d*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (4*mm^4 - 12*psq^2 + 6*(-4 + d)*psq*s + s*((-2 + d)*s + 2*t) + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (psq + (-4 + d)*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(6*psq^2 - s^2 + psq*(s - d*s - 8*t) + 
     mm^2*(4*psq + (-12 + d)*s - 4*t) + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (10*psq^2 - 2*s^2 + d*s^2 + 2*mm^2*(psq + (-7 + d)*s - t) + 4*s*t + 
     4*t^2 - 2*psq*((-1 + d)*s + 7*t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-8*psq^2 + (-20 + 7*d)*psq*s + 2*(-2 + d)*s^2 + 
     2*mm^2*(3*psq + 7*s - 2*d*s - 3*t) + 8*psq*t + 4*s*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1]])/((2*Pi)^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(4*psq + (8 - 3*d)*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (mm^2 - psq)*(psq - (-3 + d)*s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, p3]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq^2 - 8*psq*s + d*psq*s - 6*s^2 + 2*d*s^2 + 4*mm^2*(psq + s - t) - 
     2*psq*t + 2*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/
   ((2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(2*psq + (10 - 3*d)*s - 2*t)*
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq^2 - 2*s^2 + d*s^2 - 2*mm^2*(psq + 10*s - d*s - t) + 4*s*t + 
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq^2 - 8*psq*s + d*psq*s - 6*s^2 + 2*d*s^2 + 4*mm^2*(psq + s - t) - 
     2*psq*t + 2*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
   ((2*Pi)^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*(psq - (-3 + d)*s - t)*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-2*psq^2 - 2*s^2 + d*s^2 - 2*mm^2*(psq + 6*s - d*s - t) + 4*s*t + 
     4*t^2 - 2*psq*((-4 + d)*s + t))*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[q2, q2]])/((2*Pi)^(2*d)*s^2) + 
  (2^(-1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-4*psq^2 + 4*(-6 + d)*mm^2*s - 4*(-5 + d)*psq*s + 8*s^2 - 3*d*s^2 + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (gZlL - gZlR)*mm^2*(4*psq^2 + 2*(-6 + d)*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 
     4*t^2 - 2*psq*((-2 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q2]])/((2*Pi)^(2*d)*s^2) + 
  ((-4 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
    mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    gXll*(gZlL - gZlR)*mm^2*(2*mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (7*mm^2 - 5*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(2*mm^2 + (-8 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (14*mm^2 - 12*psq - 2*s + d*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (22*mm^2 - 16*psq - 2*s + d*s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    gXll*(gZlL - gZlR)*mm^2*(8*mm^2 - 6*psq + 4*s - d*s + 2*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*
    gXll*(gZlL - gZlR)*mm^2*(2*mm^2 + 4*psq + 2*s - d*s - 2*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (2*mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
    (gZlL - gZlR)*mm^2*(4*mm^2 + 2*psq - 6*s + d*s - 6*t)*\[Mu]^(8 - 2*d)*
