...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  (-((4^(1 - d)*EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^4*(-2*psq + d*s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2)) - 
   (4^(1 - d)*EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^4*
     (2*psq + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^4*
   ...
   (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^2*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl*gAu^2*gFll*gHFAW*gHll*gWlN*mm^2*
     (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gFll*gHFAW*gHll*
