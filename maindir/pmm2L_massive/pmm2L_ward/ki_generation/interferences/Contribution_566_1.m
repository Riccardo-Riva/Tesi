...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
    ...
    (I*4^(2 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(psq - s - t) + 
       aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
      (2*bb*(psq - s - t) + aa*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(2 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(mm^2 + psq - s - 2*t) + 
       aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
      (aa*(3*mm^2 - 7*psq + 3*s + 4*t) - bb*(mm^2 - 5*psq + 3*s + 4*t))*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
      (aa*(2*psq^2 + mm^2*(8*psq - 6*s - 8*t) + psq*(3*s - 2*t) - 
         s*(s + t)) + bb*(-((2*psq + s)*(psq - s - t)) + 
         mm^2*(-8*psq + 2*s + 8*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(mm^2 + psq)*(psq - t) - 
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(mm^2 + psq - 2*t) + 
       2*aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     Pi^(2*d) + (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(-(bb*psq*s) + 
       4*aa*mm^2*(psq - t) + bb*mm^2*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*psq*(psq - t) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*s*(bb*(mm^2 + psq - s - 2*t) + 
       ...
       SP[q2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
    ...
    (I*2^(3 - 2*d)*bb*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*(2*mm^2 - psq - t) + 
      ...
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*bb*EL^5*gAl*gHll^2*gXll^2*mm^4*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
