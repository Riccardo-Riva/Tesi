...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(2*Pi)^(2*d) + 
  (EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(2*s + t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(3*s + 2*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*
    ...
    ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggmgmA^2*
    ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl^2*gAu^2*ggmgmA^2*ggmgmZ*
