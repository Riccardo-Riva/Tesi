...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((I*2^(1 - 2*d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*s*
   ...
   (I*4^(1 - d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*s*
     ...
     SPList[SP[p1, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*
     gFFA*gHFW*gHll*mm^2*(2*psq^2 + psq*(s - 2*t) + 2*mm^2*(psq - s - t) - 
      s*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*s*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
     ...
     gFFA*gHFW*gHll*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gFAW*gFFA*gHFW*
     gHll*mm^2*(bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*(bb*(2*psq - s - 2*t) + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFAW*gFFA*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
