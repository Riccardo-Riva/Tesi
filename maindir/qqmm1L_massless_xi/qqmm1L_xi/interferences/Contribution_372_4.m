...
PropList[KiraPropagator[-p1 + q1, mw], KiraPropagator[p2 + q1, 
  ...
  ((I*EL^6*gFZW^2*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
    ...
    (2^(2*(1 + d))*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) + 
   (I*2^(-1 - 2*d)*EL^6*gFZW^2*s*
     ...
     SPList[SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) + 
   (I*EL^6*gFZW^2*s*(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
      ...
      gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
           (-s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
          2^(1 + d)*Pi^d*(2*s + 3*t - d*t))))*\[Mu]^(4 - d)*
     SPList[SP[q1, q1]])/(2^(2*(1 + d))*mw^2*Pi^(2*d)*(mz^2 - s)^2*
     ...
     (-mzC^2 + s)*sw^2) + (I*2^(-1 - d)*EL^6*gFZW^2*
   ...
   (I*2^(-1 - d)*EL^6*gFZW^2*
     ...
     SPList[SP[p1, p2], SP[p2, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*
     sw^2) + (I*2^(-1 - d)*EL^6*gFZW^2*
     (gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)) + gZlL*gZlLC*
       (gZuL*gZuLC*(-((-6 + d)*s) + 2*t) + gZuR*gZuRC*(d*s + 2*t)))*
   ...
   (I*2^(-1 - d)*EL^6*gFZW^2*
     (gZlL*gZlLC*(gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      ...
      gZlR*gZlRC*(gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
        gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t)))*\[Mu]^(4 - d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*
     sw^2) + (I*2^(-1 - d)*EL^6*gFZW^2*
     (gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 2*gZuL*gZuLC*t + 
        2*gZuR*gZuRC*(3*s + t)) + gZlL*gZlLC*
       (gZuL*gZuLC*(-((-6 + d)*s) + 2*t) + gZuR*gZuRC*(d*s + 2*t)))*
    ...
    (mw^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) - 
   (I*EL^6*gFZW^2*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*s*
     \[Mu]^(4 - d)*SPList[SP[p2, p3], SP[p2, p3]])/
    (mw^2*(2*Pi)^d*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) - 
   (I*2^(-1 - d)*EL^6*gFZW^2*(gZlL*gZlLC*(gZuR*gZuRC*((-4 + d)*s + 2*t) + 
   ...
   (I*2^(1 - d)*EL^6*gFZW^2*(gZlL*gZlLC + gZlR*gZlRC)*
     (gZuL*gZuLC + gZuR*gZuRC)*s*\[Mu]^(4 - d)*SPList[SP[p2, p3], 
      SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) + 
   (I*2^(-1 - d)*EL^6*gFZW^2*(gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - 
   ...
   (I*4^(-1 - d)*EL^6*gFZW^2*s*
     (-(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
      ...
      gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
           (-s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
          2^(1 + d)*Pi^d*(2*s + 3*t - d*t))))*\[Mu]^(4 - d)*
     SPList[SP[q1, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) + 
   (I*2^(-1 - 2*d)*EL^6*gFZW^2*
     (gZlL*gZlLC*(gZuL*gZuLC*(2^(2 + d)*Pi^d - d*(2*Pi)^d) + 
        gZuR*gZuRC*(-(2^(1 + d)*Pi^d) + d*(2*Pi)^d)) - 
      gZlR*gZlRC*(gZuL*gZuLC*(2^(1 + d)*Pi^d - d*(2*Pi)^d) + 
