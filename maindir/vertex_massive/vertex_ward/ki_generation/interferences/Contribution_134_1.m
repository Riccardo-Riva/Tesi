...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gFFA*gFFZ^2*
  ...
  (EL^5*gFFA*gFFZ^2*s*(bb*(gZlL^2*(psq*(2*psq - 7*s) + 2*mm^2*(psq - s)) + 
       gZlR^2*(psq*(2*psq - 7*s) + 2*mm^2*(psq - s)) + 
       2*gZlL*gZlR*mm^2*(-4*psq + 3*s)) + 
     aa*(2*gZlL*gZlR*mm^2*(4*psq - 3*s) + gZlL^2*(2*psq*(-psq + s) + 
         mm^2*(-2*psq + 7*s)) + gZlR^2*(2*psq*(-psq + s) + 
         mm^2*(-2*psq + 7*s))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
  ...
  (4^(1 - d)*EL^5*gFFA*gFFZ^2*(bb*(2*gZlL*gZlR*mm^2*(-4*psq + s) + 
