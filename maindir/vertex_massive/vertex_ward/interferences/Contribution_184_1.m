...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (2*aa*psq^2 + aa*mm^2*(2*psq - 3*s) + bb*psq*(-2*mm^2 - 2*psq + 3*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*s*
    (2*aa*psq^2 + aa*mm^2*(2*psq - 3*s) + bb*psq*(-2*mm^2 - 2*psq + 3*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(2*mm^2 + psq) - bb*(mm^2 + 2*psq))*s^2*
  ...
  (EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*mm^2 - bb*psq)*s^2*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
  (EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*mm^2 - bb*psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(mm^2 + psq)*
  ...
  (4^(1 - d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*(aa*(2*mm^2 + psq) - 
     ...
     SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*ggmgmA*ggzgmW^2*gWlN*gWNl*
