...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mh], 
  ...
  ((I*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(mm^2 - psq)*s*
     (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d))/
    (2^(2*(1 + d))*mh^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl^2*ggmgmA*gHgmgm*
   ...
   (I*4^(-1 - d)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
    ...
    (mh^2*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (2^(2*(1 + d))*mh^2*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
   ...
   (I*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(bb*(3*mm^2 - psq - 2*t) + 
   ...
   (I*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(bb*(mm^2 + psq - 2*(s + t)) + 
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
    ...
    (mh^2*(2*Pi)^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
     gHll*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[q2, q2]])/(mh^2*Pi^(2*d)) - (I*bb*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
   ...
   (I*(aa + bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*(mm^2 - psq)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
    ...
    (mh^2*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
     gHll*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q2]])/(mh^2*Pi^(2*d)) - (I*aa*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*gHll*mm^2*
    ...
    (mh^2*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
     ...
     ggmgmA*gHgmgm*gHll*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     ...
     ggmgmA*gHgmgm*gHll*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p2, q2]])/(mh^2*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggmgmA*gHgmgm*
