...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (((-I)*EL^5*gFFAZ*gFFZ*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gFFAZ*gFFZ*gZlL*gZlR*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   (I*EL^5*gFFAZ*gFFZ*(aa*(gZlL^2*(psq*(psq - t) + mm^2*(psq - 2*s - t)) + 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gFFAZ*gFFZ*(gZlL^2 + gZlR^2)*(mm^2 - psq + s)*
