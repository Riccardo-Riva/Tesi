...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (2^(3 - 2*d)*(18 - 9*d + d^2)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*s*
   ...
   (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (2^(5 - 2*d)*(-6 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + t)*
   ...
   (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((100 - 44*d + 5*d^2)*s^2 + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-2 + d)*s^2 + 2*s*t - 
      (-6 + d)*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-6 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*t*
   ...
   (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(4*(-4 + d)^2*s^2 + 
      (-28 + 4*d + d^2)*s*t + 2*(-2 + d)^2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
   (2^(5 - 2*d)*(-6 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-6 + d)^2*(-5 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (2^(7 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + t)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-104 + 68*d - 14*d^2 + d^3)*EL^8*gAl^4*
     ...
     (gZlL^2 + gZlR^2)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(7 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s + t)*
    ...
    (Pi^(2*d)*s^2) + (2^(7 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-176 + 92*d - 16*d^2 + d^3)*EL^8*gAl^4*gAu^2*
     ...
     (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*t*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s - 2*t)*
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
