...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((4^(2 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-2 + d)*s^2 + 4*s*t + 
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-3 + d)*s^2 + s*t + 2*t^2)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-9 + d)*s^2 - 17*s*t - 
      10*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   ...
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-7 + 2*d)*s^2 - s*t + 2*t^2)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-20 + d^2)*s^2 + 
      4*(-10 + d)*s*t + 4*(-6 + d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s^2 + 3*s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
     ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-2 + d)*s^2 + 3*s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
     ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-2 + d)*s^2 - 3*s*t - 
      10*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
     ((12 - 8*d + d^2)*s^2 + 4*(-4 + d)*s*t + 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(2*(-2 + d)*s^2 + 5*s*t + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*t*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
     ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((22 - 10*d + d^2)*s^2 + 
      4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
     ((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (3*4^(1 - d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((26 - 10*d + d^2)*s^2 + 
      4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (3*4^(2 - d)*(-3 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) - 
   (2^(5 - 2*d)*(-3 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((42 - 15*d + d^2)*s^2 + 
      4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((-4 + d)*s - 2*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s + t)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(6 - 5*d + d^2)*EL^8*gAl^3*gAu^2*gWlN*gWNl*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*((20 - 11*d + d^2)*s - 
      2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^3*gAu^2*
     gWlN*gWNl*gWWA*(d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s + t)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*
     ((-6 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*
     gWWA*((8 - 8*d + d^2)*s + 8*(-6 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(2*s + (10 - 3*d)*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(3*s + 2*t)*
   ...
   (3*2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*t*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*(s + 2*t)*
    ...
    (Pi^(2*d)*s) - (4^(3 - d)*(-2 + d)*EL^8*gAl^3*gAu^2*gWlN*gWNl*gWWA*t*
