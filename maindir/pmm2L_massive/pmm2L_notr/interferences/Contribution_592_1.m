...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (((-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(2*mm^2 - 2*psq + s)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
    gWNl*mm^2*(4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
    gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    (-4*s + d*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(psq - t)*
  ...
  (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
