...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*EL^6*gAl^2*gAu^2*(s + t)*
      (gZlRC*(d^3*gZuLC*(2*Pi)^d*s - d^3*gZuRC*(2*Pi)^d*s + 
         2^(1 + d)*gZuLC*Pi^d*(-((-36 + 13*d + d^2)*s) + 
           (-12 + 20*d - 8*d^2 + d^3)*t) + 2^(1 + d)*gZuRC*Pi^d*
          ((-24 + 10*d + d^2)*s - (-24 + 22*d - 8*d^2 + d^3)*t)) + 
       gZlLC*(d^3*gZuRC*(2*Pi)^d*s - 2^(1 + d)*gZuRC*Pi^d*
          ((-36 + 13*d + d^2)*s - (-12 + 20*d - 8*d^2 + d^3)*t) + 
         gZuLC*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*((-24 + 10*d + d^2)*s - 
    ...
    (I*2^(1 - d)*(-4 + d)*EL^6*gAl^2*gAu^2*((-4 - 2*d + d^2)*gZlLC*gZuLC + 
       ...
       (-4 - 2*d + d^2)*gZlRC*gZuRC)*t*SPList[SP[p2, q1], SP[p2, q1]])/
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl^2*gAu^2*(s + t)*
      ...
      (-1 + GaugeXi[Q])*SPList[SP[q1, q1]])/((2*Pi)^d*(mzC^2 - s)) + 
    (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*(gZlLC*(-(d^2*gZuLC*(2*Pi)^d*s^2) + 
      ...
      SPList[SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*(mzC^2 - s)) - 
    (I*2^(1 - 2*d)*EL^6*gAl^2*gAu^2*(gZlLC*(-(d^2*gZuLC*(2*Pi)^d*s^2) + 
         d^2*gZuRC*(2*Pi)^d*s^2 + 2^(1 + d)*gZuRC*Pi^d*((4 - 3*d)*s^2 + 
           (4 - 5*d + d^2)*s*t - 2*t^2) + 2^(1 + d)*gZuLC*Pi^d*
          (2*(-1 + d)*s^2 - (8 - 5*d + d^2)*s*t - 2*t^2)) - 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl^2*gAu^2*(s + t)*
      (-(gZlRC*(-(d*gZuLC*(2*Pi)^d*s*(s - t)) + d*gZuRC*(2*Pi)^d*s*(s - t) + 
       ...
       gZlLC*(d*gZuRC*(2*Pi)^d*s*(s - t) - 2^(1 + d)*gZuRC*Pi^d*
          (2*s^2 - (-3 + d)*s*t + t^2) + gZuLC*(-(d*(2*Pi)^d*s*(s - t)) + 
           2^(1 + d)*Pi^d*(s^2 - d*s*t - t^2))) - 
       2*(s + t)*(-(gZlRC*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*s + 
            2^(1 + d)*gZuRC*Pi^d*(-s + t) + 2^(1 + d)*gZuLC*Pi^d*
             (2*s + t))) + gZlLC*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*
            s + 2^(1 + d)*gZuLC*Pi^d*(s - t) - 2^(1 + d)*gZuRC*Pi^d*
            (2*s + t)))*GaugeXi[Q] + 
       (-(gZlRC*(-(d*gZuLC*(2*Pi)^d*s*(s - t)) + d*gZuRC*(2*Pi)^d*s*(s - t) + 
            2^(1 + d)*gZuLC*Pi^d*(2*s^2 - (-3 + d)*s*t + t^2) + 
            2^(1 + d)*gZuRC*Pi^d*(-s^2 + d*s*t + t^2))) + 
      ...
      SPList[SP[p1, q1], SP[q1, q1]])/((2*Pi)^(2*d)*(mzC^2 - s)) + 
    (I*EL^6*gAl^2*gAu^2*t*(s + t)*(gZlRC*(-(d*gZuLC*(2*Pi)^d*s) + 
         d*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuRC*Pi^d*(-s + t) + 
         2^(1 + d)*gZuLC*Pi^d*(2*s + t)) + gZlLC*(d*gZuLC*(2*Pi)^d*s - 
         d*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuLC*Pi^d*(-s + t) + 
         2^(1 + d)*gZuRC*Pi^d*(2*s + t)) - 2^(1 + d)*Pi^d*
     ...
     ((2*Pi)^(2*d)*(mzC^2 - s)) + (I*EL^6*gAl^2*gAu^2*s*
      (gZlLC*(-(d*gZuLC*(2*Pi)^d*s*(s - 3*t)) + d*gZuRC*(2*Pi)^d*s*
          (s - 3*t) + 2^(1 + d)*gZuLC*Pi^d*(s - t)*((-1 + d)*s - t) + 
      ...
      (-(gZlRC*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*s + 
       ...
       (-(gZlRC*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*s + 
            2^(1 + d)*gZuRC*Pi^d*(-s + t) + 2^(1 + d)*gZuLC*Pi^d*
             (2*s + t))) + gZlLC*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*
            s + 2^(1 + d)*gZuLC*Pi^d*(s - t) - 2^(1 + d)*gZuRC*Pi^d*
            (2*s + t)))*GaugeXi[Q]^2)*SPList[SP[p1, q1], SP[q1, q1], 
       SP[q1, q1]])/((2*Pi)^(2*d)*(mzC^2 - s)) - 
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*t*
      (gZlLC*(2*(-2 + d)*gZuLC*s - 2*(-4 + d)*gZuRC*s + d*gZuLC*t - 
         (-6 + d)*gZuRC*t) + gZlRC*(-2*(-4 + d)*gZuLC*s + 
         2*(-2 + d)*gZuRC*s - (-6 + d)*gZuLC*t + d*gZuRC*t))*
      (-1 + GaugeXi[Q])^2*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
     (Pi^d*(mzC^2 - s)) - (I*2^(2 - d)*EL^6*gAl^2*gAu^2*
      (gZlLC*gZuLC*((-2 + d)*s^2 - 2*t^2) + gZlRC*gZuRC*
        ((-2 + d)*s^2 - 2*t^2) - gZlRC*gZuLC*((-4 + d)*s^2 + 2*t^2) - 
       gZlLC*gZuRC*((-4 + d)*s^2 + 2*t^2))*(-1 + GaugeXi[Q])^2*
      SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1]])/(Pi^d*(mzC^2 - s)) - 
    (I*EL^6*gAl^2*gAu^2*(gZlLC*(-(d*gZuLC*(2*Pi)^d*s*t) + 
         d*gZuRC*(2*Pi)^d*s*t + 2^(1 + d)*gZuRC*Pi^d*(-((-4 + d)*s^2) + 
           (8 - 3*d)*s*t + t^2) + 2^(1 + d)*gZuLC*Pi^d*((-2 + d)*s^2 + 
           (-7 + 3*d)*s*t + t^2)) - gZlRC*(d*gZuRC*(2*Pi)^d*s*t - 
         2^(1 + d)*gZuRC*Pi^d*((-2 + d)*s^2 + (-7 + 3*d)*s*t + t^2) + 
       ...
       2*(-(gZlRC*(5*d*gZuLC*(2*Pi)^d*s*t - 5*d*gZuRC*(2*Pi)^d*s*t + 
         ...
         gZlLC*(5*d*gZuLC*(2*Pi)^d*s*t - 5*d*gZuRC*(2*Pi)^d*s*t + 
           ...
           2^(1 + d)*gZuRC*Pi^d*(-((-4 + d)*s^2) + 8*s*t + t^2)))*
        GaugeXi[Q] + (gZlLC*(-(d*gZuLC*(2*Pi)^d*s*t) + d*gZuRC*(2*Pi)^d*s*t + 
     ...
     ((2*Pi)^(2*d)*(mzC^2 - s)) + (I*2^(1 - d)*EL^6*gAl^2*gAu^2*s*
      (6*gZlRC*gZuLC*s + d*(gZlLC - gZlRC)*(gZuLC - gZuRC)*s + 
       6*gZlLC*gZuRC*s + 4*gZlLC*gZuLC*t + 4*gZlRC*gZuLC*t + 
       4*gZlLC*gZuRC*t + 4*gZlRC*gZuRC*t)*(-1 + GaugeXi[Q])^2*
    ...
    (I*EL^6*gAl^2*gAu^2*s*(gZlLC*(d*gZuLC*(2*Pi)^d*s - d*gZuRC*(2*Pi)^d*s + 
         ...
         2^(1 + d)*gZuRC*Pi^d*(s + (7 - 2*d)*t)))*(-1 + GaugeXi[Q])^2*
    ...
    (I*2^(3 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlLC*gZuLC - 
      ...
      (s + t)*(-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q1], 
       SP[q1, q1]])/(Pi^d*(mzC^2 - s)) + 
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
      ...
      (-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1], 
       SP[q1, q1]])/(Pi^d*(mzC^2 - s)) - 
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(d*gZlRC*(gZuLC - gZuRC)*s + 
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*
      (gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s - d*gZuLC*t + 
         (-6 + d)*gZuRC*t) + gZlRC*(-((-4 + d)*gZuLC*s) + (-2 + d)*gZuRC*s + 
         (-6 + d)*gZuLC*t - d*gZuRC*t))*(-1 + GaugeXi[Q])^2*
      SPList[SP[p2, q1], SP[p2, q1], SP[p3, q1], SP[q1, q1]])/
     (Pi^d*(mzC^2 - s)) + (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
      ((-2 + d)*gZlLC*gZuLC - (-4 + d)*gZlRC*gZuLC - (-4 + d)*gZlLC*gZuRC + 
       (-2 + d)*gZlRC*gZuRC)*t*(-1 + GaugeXi[Q])^2*SPList[SP[p2, q1], 
       SP[p2, q1], SP[q1, q1], SP[q1, q1]])/(Pi^d*(mzC^2 - s)) - 
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(d*(gZlLC - gZlRC)*(gZuLC - gZuRC)*s - 
       2*(gZlLC*gZuLC*t + gZlRC*gZuRC*t + gZlRC*gZuLC*(-3*s + t) + 
         gZlLC*gZuRC*(-3*s + t)))*(-1 + GaugeXi[Q])^2*
     ...
     (Pi^d*(mzC^2 - s)) + (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
      ...
      (-1 + GaugeXi[Q])^2*SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(Pi^d*(mzC^2 - s)) - 
    (I*2^(3 - d)*EL^6*gAl^2*gAu^2*(gZlLC + gZlRC)*(gZuLC + gZuRC)*s*
