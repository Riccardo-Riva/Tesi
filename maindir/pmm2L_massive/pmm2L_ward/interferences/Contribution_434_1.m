...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((I*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*s*((aa + bb)*(-2 + d)*(mm^2 - psq)*s - 
      (aa - bb)*(-2 + d)*psq*(-2*psq + s + 2*t) - 
      mm^2*(aa*((-2 + d)*mm^2 + (2 + d)*psq - d*(s + 2*t)) + 
        bb*((-2 + d)*mm^2 + (2 - 3*d)*psq + d*(s + 2*t))))*\[Mu]^(8 - 2*d))/
    (2^(2*(1 + d))*mz^2*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gAl^2*gFFAZ*
     (gZlL + gZlR)*(2*aa*(8*psq^2 - 4*psq*(s + 2*t) + 
        s*(-2*mm^2 + s + 2*t)) - 2*bb*(8*psq^2 - 8*psq*(s + t) + 
        s*(2*mm^2 + s + 2*t)) + bb*d*(8*psq^2 - 8*psq*(s + t) + s*(s + 2*t) + 
        mm^2*(-8*psq + 6*s + 8*t)) + aa*d*(-8*psq^2 + 4*psq*(s + 2*t) - 
        s*(s + 2*t) + mm^2*(8*psq - 2*(s + 4*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2]])/(mz^2*Pi^(2*d)) - 
   (I*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*(2*(aa + bb)*(-2 + d)*(mm^2 - psq)*s - 
      2*(aa - bb)*(-2 + d)*psq*(2*psq - s - 2*t) - 2*(aa - bb)*(-2 + d)*s*
       (-2*psq + s + 2*t) - bb*(2*s*(2*mm^2 - psq - t) + 
        4*d*mm^2*(psq - s - t) + d*s*(psq + t)) + 
      aa*(2*s*(psq - t) + d*s*(-psq + t) + d*mm^2*(4*psq - 2*(s + 2*t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(2^(2*(1 + d))*mz^2*Pi^(2*d)) - 
   (I*4^(-1 - d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*
   ...
   (I*(aa + bb)*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/(2^(2*(1 + d))*mz^2*Pi^(2*d)) - 
   (I*4^(-1 - d)*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*s*
     (aa*(-2*mm^2 + s + 2*t) - bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/(mz^2*Pi^(2*d)) + 
   (I*(aa + bb)*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*(mm^2 - psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2^(2*(1 + d))*mz^2*Pi^(2*d)) - 
   (I*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*(aa*(2*mm^2 - s - 2*t) + 
   ...
   (I*(aa - bb)*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*
     (aa*(3*psq - 2*s - 3*t) + bb*(2*mm^2 - 5*psq + 2*s + 3*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/(mz^2*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*
   ...
   (I*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*(aa*(mm^2 + psq - s - 2*t) + 
   ...
   (I*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*(aa*(mm^2 + psq - s - 2*t) + 
      bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, p3]])/(mz^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl^2*gFFAZ*(gZlL + gZlR)*
     (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
