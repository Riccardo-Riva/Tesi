(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (((-5*I)*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*((-5 + 3*d)*s + 2*(-2 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
   ((15*I)*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA^3*(s + 2*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA^3*((-5 + 3*d)*s + (-7 + 4*d)*t)*
