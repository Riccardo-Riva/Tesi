...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gZNL*mm^2*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll^2*gZNL*mm^2*
  ...
  (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(bb*(d*mm^2 + 2*psq - d*psq - 2*t) + 
     2*aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZlR*gZNL*
    mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*d*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - psq - t) + 
     aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*
