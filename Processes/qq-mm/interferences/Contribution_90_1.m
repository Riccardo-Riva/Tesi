...
(PropList[KiraPropagator[q1, md], KiraPropagator[-p1 + q1, mw], 
   ...
   (((I/16)*EL^6*gAl*gAu*gFud*gFZW*gWdu*md^2*
    ...
    ((I/16)*EL^6*gAl*gAu*gFud*gFZW*gWdu*
      ((gZlL*mu^2*(2*mm^2 + (-4 + d)*s - 2*t) + gZlR*mu^2*
        ...
        (mm^2 - s - t) + 2*mu^2*mw^2*(gZlR*(6*mm^2 + (2 - 4*d + d^2)*s - 
           2*t) - gZlL*(-6*mm^2 + (10 - 6*d + d^2)*s + 2*t)))*CKM[1, 1]*
    ...
    ((I/16)*EL^6*gAl*gAu*gFud*gFZW*gWdu*
      (gZlL*md^2*(2*mm^2 + 4*mu^2 + 2*s - d*s - 2*t)*(mm^2 - t) + 
       ...
       gZlL*mu^2*(2*mm^4 + mm^2*(-12*mw^2 + (-4 + d)*s - 4*t) + 
         t*(-((-4 + d)*s) + 2*t) + 2*mw^2*((8 - 6*d + d^2)*s + 2*t)) + 
       gZlR*mu^2*(2*mm^4 + t*((-2 + d)*s + 2*t) - 
         mm^2*(12*mw^2 + (-2 + d)*s + 4*t) + mw^2*(-2*(-2 + d)^2*s + 4*t)))*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1]])/(mw^2*Pi^4*s*(-mz^2 + s)*sw) + 
    ((I/16)*EL^6*gAl*gAu*gFud*gFZW*gWdu*
    ...
    ((I/8)*EL^6*gAl*gAu*gFud*gFZW*gWdu*((-4 + d)*gZlL*md^2 - 
       (-2 + d)*gZlR*md^2 - (-2 + d)*gZlL*mu^2 + (-4 + d)*gZlR*mu^2)*
      (-mm^2 + s + t)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p1, q1], SP[p1, q1]])/
     (mw^2*Pi^4*(mz^2 - s)*s*sw) + ((I/8)*EL^6*gAl*gAu*gFud*gFZW*gWdu*
      ...
      sw) - ((I/8)*EL^6*gAl*gAu*gFud*gFZW*gWdu*
      ...
      sw) + ((I/4)*EL^6*gAl*gAu*gFud*gFZW*gWdu*(gZlL + gZlR)*mu^2*
    ...
    ((I/8)*EL^6*gAl*gAu*gFud*gFZW*gWdu*
    ...
    ((I/4)*EL^6*gAl*gAu*gFud*gFZW*gWdu*(gZlL + gZlR)*mu^2*(mm^2 - t)*
      CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1], SP[q1, q1]])/
     (mw^2*Pi^4*(mz^2 - s)*s*sw) - ((I/4)*EL^6*gAl*gAu*gFud*gFZW*gWdu*
      (gZlL + gZlR)*(mu^2*s + md^2*(2*mu^2 + s))*CKM[1, 1]*CKMC[1, 1]*
      SPList[SP[p3, q1], SP[p3, q1]])/(mw^2*Pi^4*(mz^2 - s)*s*sw) - 
    ((I/4)*EL^6*gAl*gAu*gFud*gFZW*gWdu*(gZlL + gZlR)*mu^2*(-2*mm^2 + s + 2*t)*
  ...
  PropList[KiraPropagator[q1, md], KiraPropagator[-p1 + q1, 
   ...
   (((I/8)*EL^6*gAl*gAu*gFud*gFZW*gWdu*(gZlL + gZlR)*md^2*mu^2*(mm^2 - t)*
      (-mm^2 + s + t)*CKM[1, 1]*CKMC[1, 1])/(mw^2*Pi^4*s*(-mz^2 + s)*sw) + 
    ((I/16)*EL^6*gAl*gAu*gFud*gFZW*gWdu*
      (gZlL*mu^2*(2*mm^2 + (-4 + d)*s - 2*t) + 
       gZlR*mu^2*(2*mm^2 - (-2 + d)*s - 2*t) + 
