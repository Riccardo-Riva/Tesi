...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
   ...
   ((2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^6*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^2*
      (-((-2 + d)*psq^2*s*(psq - s - t)) + mm^2*(2*(-2 + d)*psq^3 + 
         psq^2*(-((-6 + d)*s) - 6*(-2 + d)*t) - 2*t*(s + t)*
          ((-4 + d)*s + (-2 + d)*t) + psq*(-((-2 + d)*s^2) + 
           (-18 + 5*d)*s*t + 6*(-2 + d)*t^2)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^2*
      (-2*psq*((-2 + d)*psq^2 + (s + t)*(s + (-2 + d)*t) - 
         ...
         psq*(-((-4 + d)*s) - 4*(-2 + d)*t) + (s + t)*((-4 + d)*s + 
           2*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^4*
    ...
    (4^(1 - d)*(-6 + d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll^2*gWlN*
      gWNl*mm^2*(psq*(-2*psq^2 - 3*psq*s + s^2 + 4*psq*t - s*t - 2*t^2) + 
       mm^2*(6*psq^2 + s^2 + 7*s*t + 6*t^2 - 3*psq*(s + 4*t)))*
    ...
    (4^(1 - d)*(-6 + d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll^2*gWlN*
      gWNl*mm^2*(mm^2 + psq)*(2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^4*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^2*(-((-2 + d)*psq^2) + 
       mm^2*s + psq*(s + (-2 + d)*t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^2*(-2*(-2 + d)*psq^3 + 
       ...
       psq*((-2 + d)*mm^2*s + t*((2 + 3*d)*s + 6*(-2 + d)*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gWlN*gWNl*mm^2*(-((-2 + d)*psq) + 
