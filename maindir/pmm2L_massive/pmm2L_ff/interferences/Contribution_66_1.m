...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
   ...
   ((2^(1 - 4*d)*EL^6*gAl*gAu*gFll*gFZW*gWNl*mm^2*sw*
      ...
      gWNl*mm^2*sw*(gZlL*(2*Pi)^(2*d)*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*
    ...
    (4^(1 - 2*d)*EL^6*gAl*gAu*gFll*gFZW*gWNl*mm^2*sw*
     ...
     (Pi^(4*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gFZW*gWNl*mm^2*sw*
      (psq - t)*(gZlL*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*
        (2*psq - s - 2*t) - gZlR*(8*psq^2 - (-4 + d)*mm^2*s + 
         (-4 + d)*psq*s - 16*psq*t + 8*t*(s + t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - 2*d)*EL^6*gAl*gAu*gFll*gFZW*gWNl*mm^2*sw*
     ...
     (Pi^(4*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gFll*gFZW*gWNl*mm^2*sw*
      (-(gZlR*(2*Pi)^(2*d)*(4*(mm^2 - psq)*s^2 + d*(4*psq^3 - mm^2*s^2 - 
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gFll*gFZW*gWNl*gZlL*mm^2*sw*(psq - t)*
     ...
     Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll*gFZW*gWNl*gZlL*mm^2*
      sw*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
     ...
     Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gFll*gFZW*gWNl*gZlL*mm^2*
