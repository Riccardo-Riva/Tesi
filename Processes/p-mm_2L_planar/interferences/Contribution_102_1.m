...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((2^(1 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^4*
     mu^2)/(Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^4*mu^2*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*t*
   ...
   (4^(1 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*t*
