...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
    (aa*(3*mm^2*psq - psq^2 + 2*psq*s - 2*s^2) + 
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*(aa*(2*mm^2 + psq + 2*s) - 
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
   ...
   Pi^(2*d) - (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(5*mm^2 + psq)*(mm^2 + s) - bb*(5*mm^4 + 2*psq*s + mm^2*(psq + 4*s)))*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(2*bb*mm^2*(5*psq - 2*s) + 
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*(mm^2 + psq)*(mm^2 - s) - 
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*mm^2 + bb*(-2*mm^2 + psq))*
