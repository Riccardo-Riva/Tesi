...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*mm^2*
     ...
     mm^2*s*(aa*(4*(-2 + d)*mm^2 + (-8 + 6*d)*psq - (-4 + d)*s) + 
   ...
   (4^(1 - d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(aa*(-2 + d)*psq*(4*psq - 3*s) + 
      aa*(-3 + 2*d)*mm^2*(4*psq - s) - bb*(-2 + d)*psq*(4*psq - s) + 
      bb*mm^2*((12 - 8*d)*psq + (-7 + 4*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(-4*bb*mm^2*(psq - s) + 
   ...
   (2^(3 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(-(bb*(-1 + d)*mm^2) + 
   ...
   (2^(3 - 2*d)*EL^5*gAl^2*gWlN*gWNl*gWWA*(aa*(5 - 3*d)*mm^2 + 
