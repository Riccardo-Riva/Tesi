...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  ((4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
     (4^(1 + d)*(8 - 6*d + d^2)*gZlL*gZlR*Pi^(2*d)*(mm^2 + psq)*s^2 + 
      (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*mm^4*s) - (-2 + d)*psq^2*s - 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
     ((-2 + d)*gZlL^2*(-((-2 + d)*psq*s) + mm^2*(8*psq + (-10 + d)*s - 
          8*t)) + (-2 + d)*gZlR^2*(-((-2 + d)*psq*s) + 
        mm^2*(8*psq + (-10 + d)*s - 8*t)) + 4*(-4 + d)*gZlL*gZlR*s*
       (2*psq + (-4 + d)*s - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (d^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)^2*s + 4*(gZlL^2 + gZlR^2)*
       (mm^4*s + psq^2*s - 2*mm^2*(2*psq^2 + 5*s^2 + 5*s*t + 2*t^2 - 
          2*psq*(s + 2*t))) - 4*d*(4*gZlL*gZlR*mm^2*(mm^2 + psq)*
         (psq - s - t) + gZlL^2*(mm^4*s + psq^2*s - 
          mm^2*(2*psq^2 + psq*s + 3*s^2 - 4*psq*t + 3*s*t + 2*t^2)) + 
        gZlR^2*(mm^4*s + psq^2*s - mm^2*(2*psq^2 + psq*s + 3*s^2 - 4*psq*t + 
            3*s*t + 2*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
     ((-2 + d)*gZlL^2*((-2 + d)*psq*s + mm^2*(8*psq + 2*s - d*s - 8*t)) + 
      (-2 + d)*gZlR^2*((-2 + d)*psq*s + mm^2*(8*psq + 2*s - d*s - 8*t)) - 
      4*(-4 + d)*gZlL*gZlR*s*(-2*psq + (-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (d^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)^2*s + 4*(gZlL^2 + gZlR^2)*
       (mm^4*s + psq^2*s - 2*mm^2*(2*psq^2 + 2*s^2 + 4*psq*(s - t) - s*t + 
          2*t^2)) - 4*d*(-4*gZlL*gZlR*mm^2*(mm^2 + psq)*(psq - t) + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
     ((-2 + d)*gZlL^2*((-6 + d)*mm^2 - (-2 + d)*psq) + 
      (-2 + d)*gZlR^2*((-6 + d)*mm^2 - (-2 + d)*psq) + 
      4*(12 - 7*d + d^2)*gZlL*gZlR*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    (Pi^(2*d)*s) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
   ...
   (4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (8*d*gZlL*gZlR*mm^2*(-psq + s + t) + (-2 + d)*gZlL^2*
       (psq*(psq + (-5 + d)*s - t) + mm^2*(-psq + (-7 + d)*s + t)) + 
      (-2 + d)*gZlR^2*(psq*(psq + (-5 + d)*s - t) + 
        mm^2*(-psq + (-7 + d)*s + t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*(-4*(-4 + d)^2*gZlL*gZlR*s + 
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-(d^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s) - 2*(gZlL^2 + gZlR^2)*
       (mm^2*(7*psq + 13*s - 7*t) + psq*(psq + 7*s - t)) + 
      d*(gZlL^2*(mm^2*(7*psq + 9*s - 7*t) + psq*(psq + 7*s - t)) + 
        gZlR^2*(mm^2*(7*psq + 9*s - 7*t) + psq*(psq + 7*s - t)) + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-8*d*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*(3*mm^2 + psq) + 
      (-2 + d)*gZlR^2*(3*mm^2 + psq))*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (-(d^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s) + 2*(gZlL^2 + gZlR^2)*
       (mm^2*(7*psq - 20*s - 7*t) + psq*(psq - 8*s - t)) + 
      d*(8*gZlL*gZlR*mm^2*(mm^2 - t) + gZlL^2*(psq*(-psq + 8*s + t) + 
          mm^2*(-7*psq + 16*s + 7*t)) + gZlR^2*(psq*(-psq + 8*s + t) + 
          mm^2*(-7*psq + 16*s + 7*t))))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (d^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s + 4*(gZlL^2 + gZlR^2)*
       (3*mm^2 - psq)*s - 4*d*(gZlL^2*(2*mm^2 - psq)*s + 
        gZlR^2*(2*mm^2 - psq)*s + 4*gZlL*gZlR*mm^2*(-psq + s + t)))*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
     (gZlL^2 + gZlR^2)*mm^2*(psq*(-2*psq + s + 2*t) + 
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (8*d*gZlL*gZlR*mm^2*(psq - t) + (-2 + d)*gZlL^2*
       (mm^2*(psq + (-8 + d)*s - t) + psq*(-psq + (-4 + d)*s + t)) + 
      (-2 + d)*gZlR^2*(mm^2*(psq + (-8 + d)*s - t) + 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (d^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s + 4*(gZlL^2 + gZlR^2)*
       (3*mm^2 - psq)*s - 4*d*(gZlL^2*(2*mm^2 - psq)*s + 
        gZlR^2*(2*mm^2 - psq)*s + 4*gZlL*gZlR*mm^2*(psq - t)))*
   ...
   (2^(7 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(30*(gZlL^2 + gZlR^2)*s + 
    ...
    (Pi^(2*d)*s) - (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
