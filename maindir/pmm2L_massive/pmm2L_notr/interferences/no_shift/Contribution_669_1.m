...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*
      (2*psq^2 + s^2 - 4*psq*t + 2*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/(Pi^(2*d)*s^2)) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*
     (2*psq + (-5 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*
     ggagpW*gWNl*gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*
     mm^2*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl*gAu^2*gFgagp*gFll*ggagpW*gWNl*gWWA*
