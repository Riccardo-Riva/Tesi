...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  (-(((aa + bb)*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
   ...
   (2^(1 - 2*d)*(aa + 2*bb)*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^(1 - d)*bb*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
   ...
   (3*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ*gXgmgm*gXll*(gZlL - gZlR)*mm^2*
