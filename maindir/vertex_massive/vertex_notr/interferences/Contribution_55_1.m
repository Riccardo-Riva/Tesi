...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  (-((EL^6*gAl^2*gHll^2*mm^4*(-(2^(1 + 2*d)*(-4 + d)*gZlL*gZlR*Pi^(2*d)*s*
         (4*(-1 + d)*mm^2 - 2*(-3 + d)*psq + (-2 + d)*s)) + 
       (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*(-1 + d)*mm^2 - 2*(-3 + d)*psq + 
         (-4 + 3*d)*s) + (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*
     ...
     (-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)) + (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
       ((-1 + d)*mm^2 - (-3 + d)*psq + 2*(-2 + d)*s) + 
      (-2 + d)*gZlR^2*(2*Pi)^(2*d)*((-1 + d)*mm^2 - (-3 + d)*psq + 
        2*(-2 + d)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(4*d) + 
   (2^(1 - 4*d)*EL^6*gAl^2*gHll^2*mm^4*(4^(1 + d)*(4 - 5*d + d^2)*gZlL*gZlR*
       Pi^(2*d)*s - (-2 + d)*gZlL^2*(2*Pi)^(2*d)*((1 + d)*mm^2 - 
        (-3 + d)*psq + (-2 + d)*s) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
       ((1 + d)*mm^2 - (-3 + d)*psq + (-2 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(4*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*mm^4*
     (-8*(gZlL^2 + gZlR^2)*s - d^2*(gZlL^2 + gZlR^2)*s + 
      d*(8*gZlL*gZlR*mm^2 + 6*gZlL^2*s + 6*gZlR^2*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*mm^4*
     (-4*(4 - 5*d + d^2)*gZlL*gZlR*s + (-2 + d)*gZlL^2*
       (4*mm^2 + (-2 + d)*s) + (-2 + d)*gZlR^2*(4*mm^2 + (-2 + d)*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
   ((-2 + d)*EL^6*gAl^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     (2*(-3 + d)*mm^2 - 2*(-5 + d)*psq + (-10 + 3*d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/(2*Pi)^(2*d) + 
   (EL^6*gAl^2*gHll^2*mm^2*(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
       (6*mm^2 - 2*psq + s) + 4^(1 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*s*
       (17*mm^2 - 11*psq + 4*s) - 2^(1 + 2*d)*d*Pi^(2*d)*
       (8*gZlL*gZlR*mm^2*(mm^2 - psq + s) + gZlL^2*s*(23*mm^2 - 9*psq + 
          4*s) + gZlR^2*s*(23*mm^2 - 9*psq + 4*s)))*\[Mu]^(8 - 2*d)*
   ...
   (EL^6*gAl^2*gHll^2*mm^4*(4^(1 + d)*(12 - 7*d + d^2)*gZlL*gZlR*Pi^(2*d)*s + 
    ...
    (2*Pi)^(4*d) + (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gHll^2*(gZlL^2 + gZlR^2)*
     mm^4*(mm^2 - psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^2*gHll^2*mm^2*
     (d^2*(gZlL^2 + gZlR^2)*mm^2*s + 4*(gZlL^2 + gZlR^2)*s*
       (4*mm^2 - 2*psq + s) - 2*d*(2*gZlL*gZlR*mm^2*(mm^2 - psq + s) + 
        gZlL^2*s*(5*mm^2 - psq + s) + gZlR^2*s*(5*mm^2 - psq + s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*mm^2*(-8*d*gZlL*gZlR*mm^2 + 
   ...
   (4^(2 - d)*EL^6*gAl^2*gHll^2*mm^2*(2*d*gZlL*gZlR*mm^2 - 
