...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 (-((2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*gZlL*gZlR*mm^2*s*\[Mu]^(8 - 2*d))/
  ...
  (EL^8*gAl*gAu^2*gFFA*gFFZ^2*(-4*gZlL*gZlR*mm^2*s + 
     ...
     gZlR^2*(mm^2*(2*psq + 5*s) - 2*(psq^2 + psq*s - 2*s^2)))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(4*gZlL*gZlR*mm^2*(-psq + t) + 
     gZlL^2*(mm^2*(psq - 4*s - t) + 4*s*(-s + t)) + 
     gZlR^2*(mm^2*(psq - 4*s - t) + 4*s*(-s + t)))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(2*gZlL*gZlR*mm^2*(-psq + t) + 
     gZlL^2*(psq^2 + 4*psq*s - 2*s^2 + mm^2*(psq - 4*s - t) - psq*t) + 
     gZlR^2*(psq^2 + 4*psq*s - 2*s^2 + mm^2*(psq - 4*s - t) - psq*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ^2*(8*gZlL*gZlR*mm^2*(-psq + t) + 
     gZlL^2*(2*psq^2 + 7*psq*s - 4*s^2 + mm^2*(2*psq - 7*s - 2*t) - 
       2*psq*t) + gZlR^2*(2*psq^2 + 7*psq*s - 4*s^2 + 
       mm^2*(2*psq - 7*s - 2*t) - 2*psq*t))*\[Mu]^(8 - 2*d)*
