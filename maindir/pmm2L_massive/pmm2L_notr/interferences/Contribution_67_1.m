...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 ((EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq)*
      (4*psq^2 + (-2 + d)*s^2 - 8*psq*t + 4*s*t + 4*t^2) + 
     (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 + psq)*(4*psq^2 + (-2 + d)*s^2 - 
       8*psq*t + 4*s*t + 4*t^2) - 2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*
      ((-2 + d)*mm^4*s + (-2 + d)*psq^2*s + 2*mm^2*(4*psq^2 + (-2 + d)*s^2 + 
         4*s*t + 4*t^2 - psq*((-2 + d)*s + 8*t))))*\[Mu]^(8 - 2*d))/
   (4^(2*d)*Pi^(4*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*(2*psq + (-4 + d)*s - 2*t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    ((-2 + d)*gZlL^2*(mm^2 + 3*psq)*(psq - t) + (-2 + d)*gZlR^2*
      (mm^2 + 3*psq)*(psq - t) + d*gZlL*gZlR*(-((-2 + d)*psq*s) + 
       mm^2*(-8*psq + (-2 + d)*s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
    (gZlL^2 + gZlR^2)*mm^2*(4*psq^2 + 2*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 
