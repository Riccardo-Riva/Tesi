...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   ((2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*
       ...
       gZlR^2*(d*(2*Pi)^(2*d)*psq*s*(psq^2 + t*(s + 3*t)) - 
         3*(-2 + d)*mm^2*(2*Pi)^(2*d)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
          ...
          (-((-2 + d)*psq^4) + psq^3*(-5*s + 3*(-2 + d)*t) + 
           2*s*t*(s^2 + 3*s*t + 2*t^2) + psq^2*(2*s^2 - 2*(-8 + d)*s*t - 
             3*(-2 + d)*t^2) + psq*t*(-9*s^2 - 15*s*t + (-2 + d)*t^2))))*
      \[Mu]^(8 - 2*d))/(Pi^(4*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*
     ...
     (Pi^(2*d)*s) + (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)*
        (5*psq^2 + 4*t*(s + t) + mm^2*(-psq + s + t) - psq*(s + 9*t)) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*
      (-(d*gZlL*gZlR*(2*psq - s - 2*t)*(3*psq^2 + 3*mm^2*(psq - t) - 
          5*psq*t + 2*t*(s + t))) + gZlL^2*(4*(-2 + d)*psq^3 + 
         (-2 + d)*mm^2*(2*psq - s - 2*t)*(psq - t) - 
         t*(s + t)*((-6 + d)*s + 2*(-2 + d)*t) - 
         2*psq^2*((-4 + d)*s + 5*(-2 + d)*t) + psq*t*((-18 + 5*d)*s + 
           8*(-2 + d)*t)) + gZlR^2*(4*(-2 + d)*psq^3 + 
         (-2 + d)*mm^2*(2*psq - s - 2*t)*(psq - t) - 
         t*(s + t)*((-6 + d)*s + 2*(-2 + d)*t) - 
         2*psq^2*((-4 + d)*s + 5*(-2 + d)*t) + psq*t*((-18 + 5*d)*s + 
           8*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^2*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
     ...
     (Pi^(4*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*(2*psq - s - 2*t)*
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^2*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
        Pi^(2*d)*(2*psq - s - 2*t)*(4*psq^2 + mm^2*s + 4*t*(s + t) - 
         ...
         mm^2*(d*(2*Pi)^(2*d)*psq*s^2 + 2^(1 + 2*d)*Pi^(2*d)*
            (-4*(-2 + d)*psq^3 + 2*(-2 + d)*psq^2*(s + 6*t) + 
             2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) - psq*(s^2 + 8*(-2 + d)*s*
                t + 12*(-2 + d)*t^2)))) + 
       gZlR^2*(-((-2 + d)*mm^4*(2*Pi)^(2*d)*s*(psq - t)) + 
         ...
         mm^2*(d*(2*Pi)^(2*d)*psq*s^2 + 2^(1 + 2*d)*Pi^(2*d)*
            (-4*(-2 + d)*psq^3 + 2*(-2 + d)*psq^2*(s + 6*t) + 
             2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) - psq*(s^2 + 8*(-2 + d)*s*
                t + 12*(-2 + d)*t^2)))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (-4*d*gZlL*gZlR*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
         2*t^2) + gZlL^2*(-4*(-2 + d)*psq^3 - 2*psq^2*((-4 + d)*s - 
           5*(-2 + d)*t) + t*(s + t)*((2 + d)*s + 2*(-2 + d)*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^4*(2*(-2 + d)*gZlL^2*(psq - t)^2 + 
       ...
       SP[p3, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (-2*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t)^2 + 
    ...
    (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
      ...
      (gZlL^2 + gZlR^2)*mm^2*((-14 + 5*d)*psq^2 - (-2 + d)*mm^2*
