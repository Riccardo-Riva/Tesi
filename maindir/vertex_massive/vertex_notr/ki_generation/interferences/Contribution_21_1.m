...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[-q1, mm], 
 ...
 (-((EL^6*gAl^2*gHll^2*gXll^2*mm^6*(mm^2 - s)*(2*(-1 + d)*mm^2 - 
      2*(-3 + d)*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
  (EL^6*gAl^2*gHll^2*gXll^2*mm^4*(2*(-3 + d)*mm^4 - (-2 + d)*s^2 + 
     mm^2*(-2*(-3 + d)*psq + 4*(-1 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(2*Pi)^(2*d) - 
  (EL^6*gAl^2*gHll^2*gXll^2*mm^4*(2*(1 + d)*mm^4 + (-2 + d)*s^2 - 
     2*mm^2*((-3 + d)*psq + d*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (2*Pi)^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*(4*mm^2 - d*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*gXll^2*mm^6*(4*mm^2 - d*s)*\[Mu]^(8 - 2*d)*
  ...
  (EL^6*gAl^2*gHll^2*gXll^2*mm^4*(8*mm^4 + s*(2*(-3 + d)*psq + (-10 + d)*s) + 
     mm^2*(-8*psq + 26*s - 6*d*s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2*Pi)^(2*d) + (EL^6*gAl^2*gHll^2*gXll^2*mm^4*
    (2*(-3 + d)*mm^4 - (-6 + d)*s^2 + mm^2*(-2*(-5 + d)*psq + (-14 + 3*d)*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*(mm^4 - mm^2*(psq - 2*s) - s^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*(4*mm^4 + (-6 + d)*s^2 - 
     2*mm^2*(2*psq + (-4 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(-4 + d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^6*gAl^2*gHll^2*gXll^2*mm^4*(mm^2 + psq - 2*s)*\[Mu]^(8 - 2*d)*
