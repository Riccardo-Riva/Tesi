...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  ((4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
    ...
    (Pi^(4*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
     (gZlL*gZlR*(8*psq^2 - 8*mm^2*s + d^2*(-mm^2 + psq)*s + 
        4*psq*(3*s - 4*t) + 6*d*mm^2*(psq + s - t) - 
        2*d*psq*(psq + 3*s - t) + 4*t*(s + 2*t)) + 
      gZlL^2*((-2 + d)*psq^2 + 2*s*((-2 + d)*s + 2*t) + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^2*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
      ...
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     ((-2 + d)*gZlL^2*mm^2*(2*psq + (-4 + d)*s - 2*t) + 
      (-2 + d)*gZlR^2*mm^2*(2*psq + (-4 + d)*s - 2*t) - 
      2*gZlL*gZlR*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
        6*psq*(s + 2*t) + mm^2*(2*(-2 + d)*psq + (22 - 8*d + d^2)*s - 
          2*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^2*
     (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
      mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     ((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq + (-8 + d)*s - 2*t) + 
      ...
      2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(2*(4 + d)*psq^2 - 2*(-4 + d)*mm^2*s + 
        (12 - 10*d + d^2)*psq*s - 2*(8 + d)*psq*t + 4*(s^2 + 3*s*t + 2*t^2)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(4*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*((-2 + d)*gZlL^2 + (-4 + d)*gZlL*gZlR + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*((-4 + d)*gZlL*gZlR*s + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*((12 - 7*d + d^2)*gZlL*gZlR*s + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*
     (2*(-2 + d)*gZlL^2*mm^2*(psq - t) + 2*(-2 + d)*gZlR^2*mm^2*(psq - t) + 
      gZlL*gZlR*(2*psq*s + 2*s^2 - d*s^2 + 4*psq*t - 4*s*t - 4*t^2 + 
        2*mm^2*(-2*(1 + d)*psq + s + 2*(1 + d)*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^2*(-2*gZlL^2*mm^2*s + 
   ...
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^2*(4*mm^2 - 4*psq + s)*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^2*(mm^2 - t)*
   ...
   (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*
