...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
  ...
  ((EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*s*
   ...
   (EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*(aa*(4*mm^2*psq + s^2) - 
   ...
   (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*psq*
     s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)) + 
   ((aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*s^2*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(2^(2*(1 + d))*(mh^2 - mz^2)*
     Pi^(2*d)) + ((aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (4*psq - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   ((aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*(mm^2 + psq + s)*
   ...
   (2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*s*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*
