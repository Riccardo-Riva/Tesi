...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, mm]]*((4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
      (gZlL + gZlR)^2*mm^4*(-4*psq^2 - 2*(-2 + d)*mm^2*s + 2*(-2 + d)*psq*s - 
       6*s^2 + d*s^2 + 8*psq*t - 4*s*t - 4*t^2)*\[Mu]^(8 - 2*d))/
     (mz^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*mm^2*
    ...
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*mm^2*
     ...
     (mz^2*Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
      (gZlL + gZlR)^2*mm^2*(4*psq^2 + 2*(-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 
    ...
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*mm^2*(-psq + s + t)*
    ...
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*mm^2*
    ...
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*mm^2*(psq - t)*
    ...
    (4^(2 - d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*(2*mm^2 - 4*psq - 2*s + d*s + 
     ...
     (mz^2*Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
      (gZlL + gZlR)^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, mm]]*((4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
      (gZlL + gZlR)^2*mm^4*(4*psq^2 + 2*(-2 + d)*mm^2*s + 6*s^2 - d*s^2 + 
