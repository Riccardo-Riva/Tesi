...
PropList[KiraPropagator[p1 + q1, mw], KiraPropagator[q2, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gHFAW*gHFW*gWlN*gWNl*s*
  ...
  (EL^5*gHFAW*gHFW*gWlN*gWNl*(aa*psq*(mm^2 + psq + s) - 
   ...
   (2*Pi)^(2*d) + (EL^5*gHFAW*gHFW*gWlN*gWNl*
    (bb*(psq*(2*psq - s) + mm^2*(2*psq + s)) - 
     aa*(mm^2*(2*psq - s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(2*Pi)^(2*d) - 
  ((aa - bb)*EL^5*gHFAW*gHFW*gWlN*gWNl*psq*(mm^2 + psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) - 
  (EL^5*gHFAW*gHFW*gWlN*gWNl*(aa*(3*mm^2 + psq) - bb*(mm^2 + 3*psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (EL^5*gHFAW*gHFW*gWlN*gWNl*(3*aa*mm^2 - 2*bb*mm^2 + 2*aa*psq - 3*bb*psq)*s*
