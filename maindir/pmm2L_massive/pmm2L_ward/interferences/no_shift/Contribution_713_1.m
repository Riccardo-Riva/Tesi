...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((I*EL^5*gAl*gHll^2*mm^4*(mm^2 - psq)*s*
     ...
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + (I*2^(1 - 4*d)*(aa - bb)*EL^5*gAl*gHll^2*
     mm^4*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq)*(2*psq - s - 2*t) + 
     ...
     SPList[SP[p1, q1]])/Pi^(4*d) - (I*EL^5*gAl*gHll^2*mm^2*(mm^2 - psq)*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^4*
     ...
     SPList[SP[p2, q1]])/Pi^(4*d) - (I*EL^5*gAl*gHll^2*mm^2*(mm^2 - psq)*
   ...
   (I*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*s*
     (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
      bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/(2*Pi)^(2*d) - 
   (I*EL^5*gAl*gHll^2*mm^4*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
        (-2 + d)*gZlR^2*(mm^2 - psq) + 4*gZlL*gZlR*(2*psq - s - 2*t)) + 
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
     (aa*(2*d*gZlL*gZlR*(2*psq - s - 2*t) + (-2 + d)*gZlL^2*
         (2*mm^2 - 4*psq + s + 2*t) + (-2 + d)*gZlR^2*(2*mm^2 - 4*psq + s + 
          2*t)) + bb*((-2 + d)*gZlL^2*(2*mm^2 - s - 2*t) + 
        (-2 + d)*gZlR^2*(2*mm^2 - s - 2*t) + 2*d*gZlL*gZlR*
    ...
    Pi^(2*d) + (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
     (bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*s + d*(psq - t)) + 
      ...
      aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(-psq + t)) - 
        gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + (-2 + d)*psq^2 - 
          (-6 + d)*psq*s + 2*s*t + mm^2*(-4*(-2 + d)*psq + (-4 + d)*s + 
            2*(-2 + d)*t)) - gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + 
          (-2 + d)*psq^2 - (-6 + d)*psq*s + 2*s*t + 
          mm^2*(-4*(-2 + d)*psq + (-4 + d)*s + 2*(-2 + d)*t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(4*d) + 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*mm^4*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
     (-2*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl*gHll^2*mm^2*
     (aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*s + d*(-psq + s + t)) - 
        gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + (-2 + d)*psq^2 + 
          (-10 + d)*psq*s + 2*s*(s + t) + mm^2*(-4*(-2 + d)*psq + d*s - 4*t + 
            2*d*t)) - gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^4 + (-2 + d)*psq^2 + 
          (-10 + d)*psq*s + 2*s*(s + t) + mm^2*(-4*(-2 + d)*psq + d*s - 4*t + 
            2*d*t))) + bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
         (2*s + d*(psq - s - t)) + gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*mm^4) - 
          (-2 + d)*psq^2 + (-10 + d)*psq*s + 2*s*(s + t) + 
          mm^2*(-4*t + d*(s + 2*t))) + gZlR^2*(2*Pi)^(2*d)*
         (-((-2 + d)*mm^4) - (-2 + d)*psq^2 + (-10 + d)*psq*s + 2*s*(s + t) + 
          mm^2*(-4*t + d*(s + 2*t)))))*\[Mu]^(8 - 2*d)*
   ...
   (I*EL^5*gAl*gHll^2*mm^2*(aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
         ...
         (2*s + d*(-psq + t)) + gZlL^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + 
          ...
          psq*((4 + d)*s + (-2 + d)*t)) + gZlR^2*(2*Pi)^(2*d)*
         ((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq + s - t) + 2*s*(s + t) - 
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (bb*(2*gZlL*gZlR*mm^2*(2*s + d*(-psq + t)) + 
        gZlL^2*((-2 + d)*mm^4 + (-2 + d)*psq^2 - psq*s - s*t - 
          (-2 + d)*mm^2*(psq + t)) + gZlR^2*((-2 + d)*mm^4 + (-2 + d)*psq^2 - 
          psq*s - s*t - (-2 + d)*mm^2*(psq + t))) + 
     ...
     (4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
      gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + (-8 + d)*psq*s + 
        (-2 + d)*psq*t + 2*s*(s + 2*t) + mm^2*(-3*(-2 + d)*psq + d*s - 6*t + 
          3*d*t)) + gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + (-8 + d)*psq*s + 
        (-2 + d)*psq*t + 2*s*(s + 2*t) + mm^2*(-3*(-2 + d)*psq + d*s - 6*t + 
          3*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/Pi^(4*d) + 
   ...
   (I*EL^5*gAl*gHll^2*mm^2*(bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
         (2*s + d*(psq - s - t)) + gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 
          2*(-3 + d)*psq*s - (-2 + d)*mm^2*(psq - t) + (-2 + d)*psq*t - 
          2*s*t) + gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 
          2*(-3 + d)*psq*s - (-2 + d)*mm^2*(psq - t) + (-2 + d)*psq*t - 
          2*s*t)) + aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
         (-2*s + d*(-psq + s + t)) + gZlL^2*(2*Pi)^(2*d)*
   ...
   (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    Pi^(2*d) + (I*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*s*
     (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
      bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
