...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHZZ^2*(gZlL^2 + gZlR^2)*mm^2*t*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHZZ^2*(gZlL^2 + gZlR^2)*(s + t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHZZ^2*(gZlL^2 + gZlR^2)*t^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHZZ^2*(gZlL^2 + gZlR^2)*t^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHZZ^2*(gZlL^2 + gZlR^2)*(s + 2*t)*
