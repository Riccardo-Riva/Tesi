...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
 ...
 (-((d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
     (2*psq^2 - 2*mm^2*(psq - s) - 2*psq*s + s^2)*\[Mu]^(8 - 2*d))/
    ((2*Pi)^(2*d)*s)) + (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*
    mm^2*(mm^2 - 3*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    (-psq^2 + s^2 + mm^2*(psq - t) + psq*(3*s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/(Pi^(2*d)*s^2) - 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(2*psq - 3*s)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
    gWNl*mm^2*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*
    gFll*gWNl*mm^2*(2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
    gWNl*mm^2*(2*psq - 5*s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    (psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
    gWNl*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
    gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    (-2*mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
    gWNl*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
    gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
    gWNl*mm^2*(2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (3*2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(psq + s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(4*psq + s - 4*t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
