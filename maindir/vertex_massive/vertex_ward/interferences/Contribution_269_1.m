...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((EL^5*gAl^3*gXll^2*mm^4*s*(bb*(4*psq^2 + d*(mm^2 - psq)*(mm^2 - s) + 
        6*psq*s - 2*s^2 + mm^2*(-4*psq + 2*s)) + 
      aa*(d*(mm^2 - psq)*(mm^2 - s) + 2*(2*mm^2*psq - 2*psq^2 - 4*psq*s + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*s*
   ...
   (2*Pi)^(2*d) + (EL^5*gAl^3*gXll^2*mm^2*s*(-8*bb*psq^2 + 
     bb*d*(mm^4 - 3*mm^2*psq + 2*psq^2) + aa*d*(mm^2 - psq)*
      (mm^2 + 2*psq - s) + 4*aa*psq*(2*mm^2 + 2*psq - s) + 
     bb*mm^2*(-8*psq + 4*s))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2*Pi)^(2*d) + (d*EL^5*gAl^3*gXll^2*mm^4*s*(aa*(mm^2 + 3*psq - s) + 
     bb*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (2*Pi)^(2*d) - (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*
    (2*bb*mm^4 - bb*(-4 + d)*psq^2 + bb*mm^2*((6 + d)*psq - 6*s) - 
     aa*mm^2*((8 + d)*psq - 2*s) + aa*psq*((-4 + d)*psq + 4*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(bb*mm^2*((4 + 3*d)*psq - 2*d*s) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(-2*bb*(-4 + d)*psq^2 + 
     2*bb*mm^2*((4 + d)*psq - 4*s) + aa*psq*(2*(-4 + d)*psq - (-8 + d)*s) + 
     aa*mm^2*(-2*(4 + d)*psq + d*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*d*EL^5*gAl^3*gXll^2*mm^2*(aa*mm^2*(4*psq - s) - aa*psq*s + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(bb*mm^2*((-4 + d)*psq + 4*s) - 
  ...
  (4^(2 - d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(2*mm^2 + psq) - aa*(mm^2 + 2*psq))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(-4 + d)*mm^2 - 2*bb*(-2 + d)*mm^2 + 
     aa*d*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
   Pi^(2*d) + (4^(2 - d)*EL^5*gAl^3*gXll^2*mm^2*(bb*mm^2 - aa*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (4^(1 - d)*d*EL^5*gAl^3*gXll^2*mm^2*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(4 + d)*(mm^2 + psq) - 
