   ...
   ((I*EL^6*gAl*gAu*gHZZ^2*(gZlL*(d^2*gZuL*(2*Pi)^d*s^2 - 
       ...
       gZlR*(-(d^2*gZuL*(2*Pi)^d*s^2) + d^2*gZuR*(2*Pi)^d*s^2 + 
         ...
         2^(1 + d)*gZuR*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
           2*t^2)))*\[Mu]^(4 - d))/((2*Pi)^(2*d)*(mz^2 - s)^2*s) + 
    (I*EL^6*gAl*gAu*gHZZ^2*(gZlL*(-(d*gZuL*(2*Pi)^d*s) + d*gZuR*(2*Pi)^d*s + 
      ...
      SPList[SP[q1, q1]])/((2*Pi)^(2*d)*(mz^3 - mz*s)^2) + 
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*gHZZ^2*(gZlL + gZlR)*(gZuL + gZuR)*
      \[Mu]^(4 - d)*SPList[SP[p3, q1], SP[p3, q1]])/(Pi^d*(mz^3 - mz*s)^2)) + 
  PropList[KiraPropagator[q1, mh], KiraPropagator[-p1 - p2 + q1, 
   ...
   ((I*EL^6*gAl*gAu*gHZZ^2*(gZlL*(d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gHZZ^2*(gZlL*gZuL*((-2 + d)*s - 2*t) + 
       ...
       SP[p3, q1]])/(Pi^d*s*(mz^3 - mz*s)^2) + 
    (I*2^(2 - d)*EL^6*gAl*gAu*gHZZ^2*(gZlL + gZlR)*(gZuL + gZuR)*
      \[Mu]^(4 - d)*SPList[SP[p3, q1], SP[p3, q1]])/(Pi^d*(mz^3 - mz*s)^2)))/4
