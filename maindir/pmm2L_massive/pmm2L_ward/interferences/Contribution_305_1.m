 ...
 (((-I)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
  ...
  (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*
    ...
    SPList[SP[p1, p3]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*
    gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*(aa*(2*psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*
  ...
  (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
    (aa*(mm^2 + psq - s - 2*t) + bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*
    gWWA*gWWZ*(gZlL + gZlR)*mm^2*
  ...
  (I*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*
    gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*
    gWWA*gWWZ*(gZlL + gZlR)*mm^2*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*
  ...
  (I*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*
    (gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
  ...
  (I*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*
   ...
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*
    (gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*
    gWWA*gWWZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
