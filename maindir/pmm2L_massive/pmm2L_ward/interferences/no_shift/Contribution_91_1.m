...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
  ...
  ((I*EL^5*gFFA*gFll^4*mm^4*psq*s*(aa*psq*(psq - t) + aa*mm^2*(psq - s - t) + 
    ...
    (2*Pi)^(2*d) + (I*EL^5*gFFA*gFll^4*mm^4*psq*s*(bb*(psq - s - t) + 
      aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (2*Pi)^(2*d) + (I*EL^5*gFFA*gFll^4*mm^4*(2*aa*psq^2*(psq + s - t) + 
   ...
   (I*4^(1 - d)*aa*EL^5*gFFA*gFll^4*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
   ...
   (I*EL^5*gFFA*gFll^4*mm^4*(aa*((2*psq + s)*(psq - t) + 
        2*mm^2*(psq - s - t)) + bb*(-2*psq^2 + 3*psq*s - 
   ...
   (I*2^(3 - 2*d)*bb*EL^5*gFFA*gFll^4*mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(aa + bb)*EL^5*gFFA*gFll^4*mm^4*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*(bb*(2*mm^2 - s - 2*t) + 
