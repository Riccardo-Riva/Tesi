...
PropList[KiraPropagator[q1, mw], KiraPropagator[q2, mh], 
  ...
  ((I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*s*
   ...
   (I*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(bb*(psq^2 + psq*(s - t) - s*(s + t)) + 
      aa*(-psq^2 + psq*(s + t) + s*(-2*mm^2 + s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3]])/(2*Pi)^(2*d) + 
   (I*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(bb*s*(5*psq - 3*s - 5*t) + 
   ...
   (I*4^(1 - d)*(aa + bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(mm^2 - psq)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(6*psq - 5*s - 6*t) + 
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
    ...
    Pi^(2*d) + (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(2*psq - s - 2*t)*
   ...
   ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(psq - 2*s - t) + 
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*
    ...
    Pi^(2*d) + (I*(aa - bb)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(-psq + s + t)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(psq - 3*s - t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*(mm^2 - t) + 
 ...
 PropList[KiraPropagator[q1, mw], KiraPropagator[q2, 0], 
  ...
  (((-I)*2^(-1 - 2*d)*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*s*
   ...
   (I*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(bb*(psq^2 + psq*(s - t) - s*(s + t)) + 
      aa*(-psq^2 + psq*(s + t) + s*(-2*mm^2 + s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3]])/(2*Pi)^(2*d) + 
   (I*EL^5*gAl^2*gFFA*gHFF*gHll*mm^2*(aa*s*(3*psq - 3*s - 5*t) + 
