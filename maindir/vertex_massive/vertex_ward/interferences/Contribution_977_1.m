...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (((-I)*2^(1 - 2*d)*EL^5*gAl^3*gFFA^2*mm^2*(mm^2 - psq)*s*
    ...
    (I*4^(1 - d)*EL^5*gAl^3*gFFA^2*mm^2*
      (-(bb*(2*psq^2 + 2*mm^2*(psq - s - t) + s*(s + t) - psq*(s + 2*t))) + 
       aa*(2*psq^2 + 2*mm^2*(psq + s - t) + s*(s + t) - psq*(5*s + 2*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl^3*gFFA^2*(mm^2 - psq)*
      (aa*(2*mm^2 - s)*(psq - t) - bb*(2*mm^2*(psq - 2*s - t) + s*(psq + t)))*
    ...
    (I*4^(2 - d)*EL^5*gAl^3*gFFA^2*mm^2*(bb*(psq - s - t) + 
       ...
       SP[p1, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^3*gFFA^2*(mm^2 - psq)*
    ...
    (I*4^(2 - d)*EL^5*gAl^3*gFFA^2*mm^2*(bb*(psq - s - t) + 
       ...
       SP[p1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl^3*gFFA^2*mm^2*
      (bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(2 - d)*EL^5*gAl^3*gFFA^2*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^3*gFFA^2*(mm^2 - psq)*
    ...
    (I*4^(2 - d)*(aa - bb)*EL^5*gAl^3*gFFA^2*(2*psq - s - 2*t)*
