...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*
      \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d)) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ^2*(-2*gZlL*gZlR*mm^2 + 
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ^2*(-2*gZlL*gZlR*mm^2 + 
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(-psq + s + t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
     ...
     ggmgmZ^2*(gZlL^2 + gZlR^2)*(4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
     ...
     (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ^2*
     (gZlL^2 + gZlR^2)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
