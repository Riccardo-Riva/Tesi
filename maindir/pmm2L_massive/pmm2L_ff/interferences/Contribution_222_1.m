   ...
   (-((2^(3 - 2*d)*EL^6*gAl*gAu*gFAW*gFFA*gHFW*gHll*mm^2*(-psq + s + t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFAW*gFFA*gHFW*gHll*mm^2*(mm^2 + psq - 2*t)*
     ...
     (Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gFAW*gFFA*gHFW*gHll*mm^2*
      (mm^2 + psq - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
