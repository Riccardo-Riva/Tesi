...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*((-2 + d)^2*mm^8*s - 
      mm^6*(12*psq^2 + (6 + d - d^2)*s^2 + 2*psq*((-2 + d)^2*s - 12*t) + 
        12*s*t + 12*t^2) + mm^2*s^2*((12 - 4*d + d^2)*psq^2 + 
        2*(-2 + d)*s^2 + 8*s*t + 8*t^2 - 2*psq*((-5 + 3*d)*s + 8*t)) + 
      mm^4*(-4*psq^3 + psq^2*((-4 - 4*d + d^2)*s + 8*t) + 
        2*s*((-3 + 2*d)*s^2 - 4*s*t - 4*t^2) + 
        psq*((10 + d - 2*d^2)*s^2 + 12*s*t - 4*t^2)))*\[Mu]^(8 - 2*d))/
    (Pi^(2*d)*s^2)) - (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) + (EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (4*(-2 + d)*psq^3 - 4*mm^4*((-8 + d)*psq - 3*(-4 + d)*s - (-8 + d)*t) + 
     2*psq^2*((4 + d^2)*s - 4*(-2 + d)*t) + 
     psq*((72 - 46*d + 3*d^2)*s^2 - 32*s*t + 4*(-2 + d)*t^2) - 
     mm^2*(40*psq^2 + 2*(-20 + 6*d + d^2)*psq*s + (64 - 34*d + 3*d^2)*s^2 - 
       4*(20 + d)*psq*t + 64*s*t + 4*(10 + d)*t^2) + 
     4*s*(d*s^2 + 4*t*(2*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((-4 + d)*d*mm^4*s - 
  ...
  (EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-2 + d)*psq^3 + 
     4*mm^4*((-8 + d)*psq + 2*(-2 + d)*s - (-8 + d)*t) + 
     2*psq^2*((12 - 4*d + d^2)*s - 4*(-2 + d)*t) + 
     psq*(3*(32 - 14*d + d^2)*s^2 + 8*(-6 + d)*s*t + 4*(-2 + d)*t^2) - 
     mm^2*(8*(5 + d)*psq^2 + 2*(4 + d^2)*psq*s + (40 - 30*d + 3*d^2)*s^2 - 
       4*(20 + 3*d)*psq*t + 8*(2 + d)*s*t + 4*(10 + d)*t^2) + 
     4*((-4 + d)*s^3 + 4*s*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   ((2*Pi)^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((12 - 5*d + d^2)*mm^4*s + 
     s^2*(-((8 - 6*d + d^2)*psq) + 2*(-3 + d)*s) + 
     mm^2*(4*psq^2 + (2 - 3*d + d^2)*s^2 + 4*s*t + 4*t^2 - 
       psq*((4 - 5*d + d^2)*s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    ((-4 + d)*d*mm^4*s - 2*mm^2*(8*psq^2 + (2 - 4*d + d^2)*psq*s + s^2 - 
       d*s^2 - 16*psq*t + 8*s*t + 8*t^2) + 
     s*((12 - 4*d + d^2)*psq^2 + 2*(-2 + d)*s^2 + 8*s*t + 8*t^2 - 
       2*psq*((-5 + 3*d)*s + 8*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*
    ((12 - 8*d + d^2)*mm^6*s + mm^2*s*(4*(-2 + d)*psq^2 + 
       (14 - 8*d + d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2 - 
       (-2 + d)*psq*((-6 + d)*s + 8*t)) + 
     mm^4*(4*(-1 + d)*psq^2 + (18 - 15*d + 2*d^2)*s^2 + 4*(-1 + d)*s*t + 
       4*(-1 + d)*t^2 - psq*((12 - 8*d + d^2)*s + 8*(-1 + d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-2 + d)*psq^3 + 2*(-2 + d)*d*mm^4*s + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*(-2 + d)*mm^4 - 
     4*(-1 + d)*psq^2 - (42 - 20*d + d^2)*psq*s - 2*(-5 + 2*d)*s^2 + 
     2*(4 + d)*psq*t - 8*s*t - 8*t^2 + mm^2*(2*(-8 + 3*d)*psq + 
       (30 - 16*d + d^2)*s - 2*(-4 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*mm^4 + 12*psq^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (-8*psq^2 + (26 - 15*d + d^2)*mm^2*s - (38 - 19*d + d^2)*psq*s - 
     2*(-5 + 2*d)*s^2 + 16*psq*t - 8*s*t - 8*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*psq^2 + 2*(-1 + d)*mm^2*s - 
     5*s^2 + 2*d*s^2 + 4*s*t + 4*t^2 - 4*psq*((-2 + d)*s + 2*t))*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*psq^2 + 
     4*s*(s + 2*t) + mm^2*(-2*(-10 + d)*psq + (12 - 10*d + d^2)*s + 
       2*(-10 + d)*t) - psq*((28 - 10*d + d^2)*s + 2*(-2 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((12 - 6*d + d^2)*mm^2 - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-2 + d)*psq^2 + 
     4*(-4 + d)*psq*s + 64*s^2 - 30*d*s^2 + 3*d^2*s^2 + 
     2*mm^2*(12*psq - 8*d*s + d^2*s - 12*t) - 8*(-2 + d)*psq*t + 4*d*s*t - 
     8*t^2 + 4*d*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (-((-6 + d)*psq^2) + (8 - 3*d)*psq*s + 2*(-3 + d)*s^2 + (-10 + d)*psq*t + 
     2*s*t + 4*t^2 + mm^2*((-6 + d)*psq + (2 + d)*s - (-6 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*(-2 + d)*psq^2 - 
     (16 - 12*d + d^2)*psq*s + 2*(-2 + d)*psq*t - 4*s*(s + 2*t) + 
     mm^2*(2*(-10 + d)*psq + (32 - 12*d + d^2)*s - 2*(-10 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(8*(-2 + d)*mm^4 - 
     4*(-2 + d)*psq^2 - 68*s^2 + 34*d*s^2 - 3*d^2*s^2 - 
     2*mm^2*(4*(-2 + d)*psq + (18 - 14*d + d^2)*s) - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-2 + d)*psq^2 + 72*s^2 - 
     34*d*s^2 + 3*d^2*s^2 + 2*(-2 + d)*psq*((-2 + d)*s - 4*t) - 16*s*t + 
     8*d*s*t - 8*t^2 + 4*d*t^2 - 4*mm^2*((-4 + d)*psq + (6 + d)*s - 
       (-4 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
   ...
   (Pi^(2*d)*s^2) + (EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (d^2*s*(2*psq + s) + 2*d*(-2*psq^2 - 4*psq*s - 9*s^2 + 
       2*mm^2*(psq - s - t) + 4*psq*t - 4*s*t - 2*t^2) + 
     8*(psq^2 + 5*s^2 + psq*(s - 2*t) + 2*s*t + t^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-4*(-2 + d)*psq^2 - 
     4*(-4 + d)*psq*s - 24*s^2 + 10*d*s^2 - d^2*s^2 + 8*(-2 + d)*psq*t - 
     4*d*s*t + 8*t^2 - 4*d*t^2 + 4*mm^2*(-4*psq + (2 + d)*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*mm^4 + (6 + d)*psq^2 + 
     2*(-1 + d)*s^2 - 14*psq*t + 10*s*t + 4*t^2 + d*psq*(-4*s + t) - 
     mm^2*((-14 + 3*d)*psq - 2*(-3 + d)*s + (6 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*(-6 + d)*psq^2 - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-2 + d)*psq^2 + 56*s^2 - 
     30*d*s^2 + 3*d^2*s^2 - 16*s*t + 4*d*s*t - 8*t^2 + 4*d*t^2 + 
     4*psq*(d*(s - 2*t) + 4*t) + 2*mm^2*(-12*psq + (12 - 8*d + d^2)*s + 
       12*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (-((2 + d)*psq^2) + (-6 + 4*d)*psq*s - 2*(-2 + d)*s^2 + (6 + d)*psq*t - 
     6*s*t - 4*t^2 + mm^2*((-6 + d)*psq + 4*s - 2*d*s + 6*t - d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-2 + d)*psq^2 + 80*s^2 - 
     38*d*s^2 + 3*d^2*s^2 + 2*(-2 + d)*psq*((2 + d)*s - 4*t) - 8*t^2 + 
     4*d*t^2 + 4*mm^2*((-4 + d)*psq - 2*(1 + d)*s - (-4 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*psq^2 + 
     4*s*(s + 2*t) + mm^2*(-2*(-10 + d)*psq + (12 - 10*d + d^2)*s + 
       2*(-10 + d)*t) - psq*((28 - 10*d + d^2)*s + 2*(-2 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^4*gAu^2*gHll^2*mm^2*(d^2*s*(2*psq + s) + 
     8*(psq^2 + 3*psq*s + 4*s^2 - 2*psq*t + t^2) - 
     2*d*(2*psq^2 + 8*psq*s + 7*s^2 + 2*mm^2*(psq - t) - 4*psq*t + 2*t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-4*(-2 + d)*psq^2 - 16*s^2 + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(2 + d)*psq^2 + 
     8*(-3 + d)*s^2 + 4*s*t + 8*t^2 + mm^2*(-2*(2 + d)*psq + 4*d*s + d^2*s + 
       4*t + 2*d*t) - psq*((-28 + 8*d + d^2)*s + 2*(6 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-1 + d)*psq^2 + 8*s^2 - 
  ...
  (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((12 - 6*d + d^2)*mm^2 - 
     (8 - 6*d + d^2)*psq + 2*(-3 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-4*s + d*(mm^2 + 2*s))*
  ...
  ((-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*psq^2 + 2*(-4 + d)*mm^2*s - 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*(-2 + d)*mm^2 + 
     4*(-3 + d)*psq + 26*s - 12*d*s + d^2*s + 8*t - 2*d*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*mm^2 - 2*(-2 + d)*psq - 
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(22 - 11*d + d^2)*EL^8*gAl^4*gAu^2*gHll^2*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(22 - 11*d + d^2)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q1, q1]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(20 - 10*d + d^2)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
  ...
  (4^(1 - d)*(20 - 10*d + d^2)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(20 - 10*d + d^2)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, p3]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (4*mm^2 - 3*psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    ((-2 + d)*mm^2 - 2*(-3 + d)*psq - 3*s + d*s - 4*t + d*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*psq - 3*s - 2*t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-psq + s + t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*mm^2 - 5*psq + s + t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-2 + d)*mm^2 - 
     4*(-2 + d)*psq - (24 - 12*d + d^2)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*mm^2 - 4*psq + s)*
   ...
   (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
  ...
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((-2 + d)*mm^2 - 2*psq + s + 4*t - 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(psq - t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(20 - 10*d + d^2)*EL^8*gAl^4*
    gAu^2*gHll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    gHll^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(20 - 10*d + d^2)*EL^8*gAl^4*
    gAu^2*gHll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*
    mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    gHll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (2*(-2 + d)*psq + (24 - 12*d + d^2)*s - 2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*psq + s - 2*t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*psq + (-4 + d)^2*s - 
     ...
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
    gHll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q2]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
