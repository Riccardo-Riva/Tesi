  ...
  ((I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(mm^2 - psq)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(mm^2 - psq)*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(mm^2 - psq)*s*
     ...
     gWlN*gWNl*gWWZ*gZlL*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
     (mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(mm^2 - psq)*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
    Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
     (bb*((-2 + d)*psq^2 + (-5 + d)*psq*s + (-2 + d)*mm^2*(psq - s - t) - 
        (-2 + d)*psq*t + s*(s + t)) - aa*((-2 + d)*psq^2 + 
        (-2 + d)*mm^2*(psq + s - t) + s*(s + t) - psq*(s + d*s - 2*t + d*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*
     (bb*((-1 + d)*gZlR*mm^2 + (-2 + d)*gZlL*psq)*(psq - s - t) + 
      aa*(-((-1 + d)*gZlR*mm^2*(psq - s - t)) + (-2 + d)*gZlL*psq*
         (2*mm^2 - 3*psq + s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWZ*
     (-2*aa*(-4 + d)*gZlR*mm^2*(psq - t) + 2*bb*(-4 + d)*gZlR*mm^2*
       (psq - t) + bb*gZlL*(-4*(-2 + d)*mm^4 + 
        psq*(-5*(-2 + d)*psq + 2*s - 3*(-2 + d)*t) + 
        mm^2*(11*(-2 + d)*psq - 2*s + (-2 + d)*t)) + 
      aa*gZlL*(2*(-2 + d)*mm^4 - psq*((-2 + d)*psq + 2*s + 6*t - 3*d*t) + 
        mm^2*(-3*(-2 + d)*psq + 2*s + 2*t - d*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*
     (bb*(-2 + d)*gZlL*psq*(2*mm^2 - s - 2*t) - aa*(-1 + d)*gZlR*mm^2*
       (2*psq - s - 2*t) + bb*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
      aa*(-2 + d)*gZlL*psq*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWZ*
     (bb*((-2 + d)*gZlL*(mm^2 - 3*psq)*(2*mm^2 - psq - t) - 
        2*(-4 + d)*gZlR*mm^2*(psq - t)) + aa*(2*(-4 + d)*gZlR*mm^2 - 
        (-2 + d)*gZlL*(mm^2 - 3*psq))*(psq - t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*
     (aa*((-1 + d)*gZlR*mm^2 + (-2 + d)*gZlL*psq)*(psq - t) + 
      bb*(-((-1 + d)*gZlR*mm^2*(psq - t)) + (-2 + d)*gZlL*psq*
         (-2*mm^2 + psq + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p2, q2]])/Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gAl*gWlN*gWNl*gWWZ*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWZ*
     ((-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
      ...
      SP[p3, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gWlN*gWNl*gWWZ*
     (-(bb*(-2 + d)*gZlL*(psq*(psq - t) + mm^2*(psq - s - t))) + 
      aa*(-2 + d)*gZlL*(mm^2*(psq - t) + psq*(psq - s - t)) - 
      aa*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + bb*(-1 + d)*gZlR*mm^2*
   ...
   (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*s*
     (bb*(2*(-2 + d)*mm^2 + 6*psq - 2*d*psq - s - 2*t) + 
      aa*(2*(-2 + d)*mm^2 + 2*psq - 2*d*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*
   ...
   (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(bb*(-6 + d)*(psq - s - t) + 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gWlN*
     gWNl*gWWZ*gZlL*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(psq - t)*
   ...
   (I*4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*(aa*(-6 + d)*(psq - t) + 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWZ*gZlL*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gWlN*
     gWNl*gWWZ*gZlL*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*
     gWNl*gWWZ*gZlL*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
