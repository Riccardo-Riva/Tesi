...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl^5*mm^2*s*(bb*((-2 + d)^2*mm^4 + 4*(-2 + d)*psq^2 + 
      ...
      \[Mu]^(8 - 2*d))/Pi^(2*d)) + 
   (4^(1 - d)*EL^5*gAl^5*(aa*((-2 + d)*psq*s*((-4 + d)*psq + 2*s) + 
   ...
   (2^(3 - 2*d)*EL^5*gAl^5*(bb*(d^2*(mm^2 - psq)*psq - 
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gAl^5*(bb*(-4 + d)*mm^2 - 2*aa*psq - 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^5*gAl^5*(bb*(2*mm^2 + psq) - aa*(mm^2 + 2*psq))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^5*gAl^5*(aa*(4 - 6*d + d^2)*mm^2 - 
      2*bb*(6 - 6*d + d^2)*mm^2 - 4*bb*(-2 + d)*psq + aa*(-2 + d)*d*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(5 - 2*d)*(-2 + d)*EL^5*gAl^5*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^5*gAl^5*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^5*gAl^5*(aa*((4 - 2*d + d^2)*mm^2 + (-2 + d)*d*psq) - 
