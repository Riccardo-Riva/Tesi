...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((4^(1 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^4*
     mu^2)/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*
     gXll*(gZlL - gZlR)*mm^4*mu^2*SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*t*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*t*
