...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*mm^2 - s)*
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-((-2 + d)*psq^2*s) + 
     ...
     Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*mm^2 - s)*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
    ...
    (2^(3 - 2*d)*(-6 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
    ...
    (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-(s^2*(-3*psq + s + t)) + 
       2*mm^2*(2*psq^2 + s^2 + 4*s*t + 2*t^2 - 4*psq*(s + t)))*
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((2 + d)*mm^2 - (-2 + d)*psq)*
      ...
      gXll^2*mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((-2 + d)*psq^2 - 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq^2 + mm^2*s + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)^2*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*s*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)*
      ...
      gXll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
