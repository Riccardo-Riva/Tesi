...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (((-I)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*mm^2*(mm^2 - psq)*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*mm^2*
    ...
    (I*(aa + bb)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*(2*mm^2 - s)*
      s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(mz^2*(2*Pi)^(2*d)) + 
    (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA*gFFZ*(gZlL + gZlR)*mm^2*s*
