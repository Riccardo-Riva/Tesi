...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*s*
    (2*bb*psq*(mm^2 + 3*psq - s) + aa*psq*(-6*psq + s) + 
     aa*mm^2*(-2*psq + s))*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
    (bb*psq*(mm^2 + 3*psq - 2*s) + aa*psq*(-3*psq + s) + aa*mm^2*(-psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  ((aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*psq*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  ((aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(mm^2 + 3*psq)*s*
  ...
  (2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*psq*
  ...
  ((-aa + bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(4*psq - s)*
