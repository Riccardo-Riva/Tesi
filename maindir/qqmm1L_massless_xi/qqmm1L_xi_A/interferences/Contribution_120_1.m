...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
  ...
  (((-I)*2^(-1 - d)*EL^6*gAl*gAu^3*
     ...
     \[Mu]^(4 - d))/(Pi^d*(mz^2 - s)) - 
   (I*EL^6*gAl*gAu^3*(gZlR*(-(d^2*gZuL*(2*Pi)^d*s) + d^2*gZuR*(2*Pi)^d*s + 
     ...
     \[Mu]^(4 - d)*SPList[SP[p1, q1]])/((2*Pi)^(2*d)*(mz^2 - s)) - 
   (I*EL^6*gAl*gAu^3*(gZlL*(-(d^2*gZuL*(2*Pi)^d*s) + d^2*gZuR*(2*Pi)^d*s + 
        2^(1 + d)*gZuR*Pi^d*((4 - 3*d)*s + (8 - 6*d + d^2)*t) + 
   ...
   (I*(-2 + d)*EL^6*gAl*gAu^3*((-2 + d)*gZlL*gZuL - (-4 + d)*gZlR*gZuL - 
      (-4 + d)*gZlL*gZuR + (-2 + d)*gZlR*gZuR)*t*\[Mu]^(4 - d)*
     SPList[SP[p2, q1], SP[p2, q1]])/((2*Pi)^d*s*(-mz^2 + s)) + 
   (I*(-2 + d)*EL^6*gAl*gAu^3*(gZlL*gZuL*((-2 + d)*s - 2*t) + 
 ...
 PropList[KiraPropagator[q1, 0], KiraPropagator[q1, 0], 
  ...
  ((I*EL^6*gAl*gAu^3*(-(gZlR*gZuL*((8 - 6*d + d^2)*s^2 + 
