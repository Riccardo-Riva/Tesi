   ...
   (((-I)*EL^5*gAl*gZlL*gZlR*mm^2*s*
    ...
    (I*EL^5*gAl*mm^2*(bb*(gZlL^4*(-((8 - 6*d + d^2)*psq^2) + 
          ...
          ((-2 + d)*psq^2 + psq*(2*s - (-2 + d)*t) + 
           ...
           s*((-2 + d)*s + d*t)) - 4*gZlL^2*gZlR^2*(-4*s^2 + 
           d^2*(mm^2*(2*psq - s - 2*t) - s*(-psq + s + t)) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gZlL*gZlR*mm^2*
      (aa*((-2 + d)*gZlL^2*((-2 + d)*psq^2 + psq*(2*(-1 + d)*s - 
             (-2 + d)*t) + 2*mm^2*((-2 + d)*psq + s - d*s + 2*t - d*t) - 
    ...
    (I*EL^5*gAl*mm^2*(bb*(gZlL^4*(-((8 - 6*d + d^2)*psq^2) + 
           2*(-8 + 3*d)*psq*s + (8 - 6*d + d^2)*psq*t + 2*(-4 + d)*s*t - 
         ...
         2*(-2 + d)*gZlL*gZlR^3*((-2 + d)*psq^2 + mm^2*(2*(-2 + d)*psq + 
             (-4 + d)*s - 2*(-2 + d)*t) - psq*((-4 + d)*s + (-2 + d)*t) - 
           s*(2*s + d*t)) - 4*gZlL^2*gZlR^2*(4*s*(mm^2 - psq + s) + 
           d^2*(2*mm^2*(psq - t) - s*t) + d*(-4*mm^2*(psq + s - t) + 
             6*s*t))) + aa*(gZlL^4*((8 - 6*d + d^2)*psq^2 - 2*(-4 + d)*s*t + 
           (-2 + d)*mm^2*((-4 + d)*psq - 4*s + 4*t - d*t) + 
         ...
         2*(-2 + d)*gZlL*gZlR^3*((-2 + d)*psq^2 + psq*(d*(s - t) + 2*t) - 
           s*(2*s + d*t) + mm^2*(2*(-2 + d)*psq + 4*t - d*(s + 2*t))) + 
         4*gZlL^2*gZlR^2*(4*s^2 + d^2*(mm^2*(2*psq - s - 2*t) + 
             s*(psq - t)) + d*(6*s*(-psq + t) + mm^2*(-4*psq + 2*s + 4*t)))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl*gZlL*gZlR*mm^2*
      (bb*(-((-2 + d)*gZlL^2*((-2 + d)*psq^2 - psq*((-4 + d)*s + 
              (-2 + d)*t) + 2*mm^2*((-2 + d)*psq + s + 2*t - d*t) - 
            s*(2*s + d*t))) - (-2 + d)*gZlR^2*((-2 + d)*psq^2 - 
           psq*((-4 + d)*s + (-2 + d)*t) + 2*mm^2*((-2 + d)*psq + s + 2*t - 
             d*t) - s*(2*s + d*t)) + gZlL*gZlR*(4*s*(2*mm^2 - psq - t) + 
           d^2*(4*mm^2*(psq - t) - s*(psq + t)) + d*(-8*mm^2*(psq + s - t) + 
             6*s*(psq + t)))) + aa*((-2 + d)*gZlL^2*((-2 + d)*psq^2 + 
           2*mm^2*((-2 + d)*psq + 3*s - d*s + 2*t - d*t) + 
           psq*(d*s + 2*t - d*t) - s*(2*s + d*t)) + (-2 + d)*gZlR^2*
          ((-2 + d)*psq^2 + 2*mm^2*((-2 + d)*psq + 3*s - d*s + 2*t - d*t) + 
           psq*(d*s + 2*t - d*t) - s*(2*s + d*t)) + 
    ...
    (I*EL^5*gAl*mm^2*s*(aa*(-2*(-2 + d)^2*gZlL^3*gZlR*(2*psq - s - 2*t) + 
       ...
       bb*(2*(-2 + d)^2*gZlL^3*gZlR*(2*psq - s - 2*t) - 
         ...
         gZlL^4*((16 - 10*d + d^2)*mm^2 - d^2*psq - 8*(s + 2*t) + 
           2*d*(3*psq + s + 2*t)) + gZlR^4*((16 - 10*d + d^2)*mm^2 - 
           d^2*psq - 8*(s + 2*t) + 2*d*(3*psq + s + 2*t))))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*(aa*((-2 + d)*gZlL^4*s*(2*mm^2 - 3*psq + s + t) + 
       ...
       bb*(-(d^2*gZlL*(gZlL - gZlR)^2*gZlR*mm^2*(psq - s - t)) + 
         2*s*(2*gZlL^3*gZlR*mm^2 - 4*gZlL^2*gZlR^2*mm^2 + 
           2*gZlL*gZlR^3*mm^2 + gZlL^4*(-psq + s + t) + 
           gZlR^4*(-psq + s + t)) + d*(2*gZlL^3*gZlR*mm^2*(psq - 2*s - t) + 
           2*gZlL*gZlR^3*mm^2*(psq - 2*s - t) - 12*gZlL^2*gZlR^2*mm^2*
            (psq - s - t) - gZlL^4*s*(-psq + s + t) - 
           gZlR^4*s*(-psq + s + t))))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*(aa*((-2 + d)*gZlL^4*((-4 + d)*mm^2 + 2*s)*
         ...
         4*(-2 + d)*gZlL*gZlR^3*mm^2*((-2 + d)*mm^2 - 2*(-1 + d)*psq - 2*s + 
           ...
           (-20 + 42*d - 7*d^2)*psq + 12*s - 18*d*s + 3*d^2*s + 4*t - 
           18*d*t + 3*d^2*t)) + bb*(-((-2 + d)*gZlL^4*((-4 + d)*mm^2 + 2*s)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*(aa*(-2*(-2 + d)*gZlL^3*gZlR*mm^2*
         ...
         2*(-2 + d)*gZlL*gZlR^3*mm^2*((-2 + d)*mm^2 + 2*psq - 3*d*psq - 6*s + 
           2*d*s + 2*d*t) + 2*gZlL^2*gZlR^2*mm^2*(2*(4 - 6*d + d^2)*mm^2 + 
           (-12 + 30*d - 5*d^2)*psq + 20*s - 18*d*s + 3*d^2*s + 4*t - 
           18*d*t + 3*d^2*t) + gZlL^4*((8 - 6*d + d^2)*mm^4 - 
           (-4 + d)*mm^2*(2*(-2 + d)*psq - 2*(-3 + d)*s - (-2 + d)*t) + 
           2*s*((10 - 3*d)*psq + (-4 + d)*s + (-2 + d)*t)) + 
         gZlR^4*((8 - 6*d + d^2)*mm^4 - (-4 + d)*mm^2*(2*(-2 + d)*psq - 
             2*(-3 + d)*s - (-2 + d)*t) + 2*s*((10 - 3*d)*psq + (-4 + d)*s + 
             (-2 + d)*t))) + bb*(2*gZlL^2*gZlR^2*mm^2*
          (2*(4 - 6*d + d^2)*mm^2 + (-4 - 6*d + d^2)*psq - 20*s + 18*d*s - 
           3*d^2*s - 4*t + 18*d*t - 3*d^2*t) - 2*(-2 + d)*gZlL^3*gZlR*mm^2*
          ((-2 + d)*mm^2 + (2 + d)*psq - 2*((-3 + d)*s + d*t)) - 
         2*(-2 + d)*gZlL*gZlR^3*mm^2*((-2 + d)*mm^2 + (2 + d)*psq - 
           2*((-3 + d)*s + d*t)) + gZlL^4*((8 - 6*d + d^2)*mm^4 - 
    ...
    (I*4^(1 - d)*EL^5*gAl*(bb*((-2 + d)*gZlL^4*s*(3*psq - 2*s - 3*t) + 
         (-2 + d)*gZlR^4*s*(3*psq - 2*s - 3*t) - (-2 + d)^2*gZlL^3*gZlR*mm^2*
          ...
          (2*psq - s - 2*t)) + aa*((-2 + d)^2*gZlL^3*gZlR*mm^2*
          (2*psq - s - 2*t) - 2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*(bb*(2*(-2 + d)^2*gZlL^3*gZlR*mm^2*
          (2*psq - s - 2*t) - 2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*
          (2*psq - s - 2*t) + 2*(-2 + d)^2*gZlL*gZlR^3*mm^2*
          (2*psq - s - 2*t) + gZlL^4*(-((-4 + d)*mm^2*((-2 + d)*psq + 4*s - 
              d*s + 2*t - d*t)) + 2*s*(-2*s + d*(-psq + s + t))) + 
    ...
    (I*EL^5*gAl*(aa*(-2*(-2 + d)*gZlL^3*gZlR*mm^2*((-2 + d)*psq - 2*s - 
           ...
           (-2 + d)*t) + gZlL^4*((8 - 6*d + d^2)*psq^2 + (40 - 16*d + d^2)*
            psq*s - (8 - 6*d + d^2)*psq*t + 2*(-4 + d)*s*(s + t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl*gZlL*gZlR*mm^2*
      (aa*(-((4 - 6*d + d^2)*gZlL*gZlR*(2*mm^2 - 3*psq + s + t)) + 
         ...
         (-2 + d)*gZlR^2*((-2 + d)*mm^2 - 2*(-1 + d)*psq - 2*s + d*s + 
           d*t)) + bb*(-4*(gZlL^2*s + gZlR^2*s + gZlL*gZlR*(psq - s - t)) + 
         d^2*(gZlL^2 - gZlL*gZlR + gZlR^2)*(psq - s - t) + 
         d*(6*gZlL*gZlR*(psq - s - t) + 2*gZlR^2*(-psq + 2*s + t) + 
           gZlL^2*(-2*psq + 4*s + 2*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*
      (bb*(2*gZlL^2*gZlR^2*mm^2*(2*(4 - 6*d + d^2)*mm^2 + (-4 - 6*d + d^2)*
            psq + 16*s - 4*t + 18*d*t - 3*d^2*t) + 
         ...
         2*(-2 + d)*gZlL^3*gZlR*mm^2*((-2 + d)*mm^2 + (2 + d)*psq - 
           ...
           (2 + d)*psq - 2*(3*s + d*t))) + 
       aa*(-2*(-2 + d)*gZlL^3*gZlR*mm^2*((-2 + d)*mm^2 + (2 - 3*d)*psq + 
           6*s + 2*d*t) - 2*(-2 + d)*gZlL*gZlR^3*mm^2*((-2 + d)*mm^2 + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*(bb*(2*(-2 + d)^2*gZlL^3*gZlR*mm^2*
          ...
          (2*psq - s - 2*t) + 2*(-2 + d)^2*gZlL*gZlR^3*mm^2*
          (2*psq - s - 2*t) + gZlL^4*(2*s*(-2*(-3 + d)*psq + (-2 + d)*s + 
             2*(-3 + d)*t) - (-4 + d)*mm^2*((-2 + d)*psq - 2*s - 
             (-2 + d)*t)) + gZlR^4*(2*s*(-2*(-3 + d)*psq + (-2 + d)*s + 
             2*(-3 + d)*t) - (-4 + d)*mm^2*((-2 + d)*psq - 2*s - 
             (-2 + d)*t))) + aa*(-2*(-2 + d)^2*gZlL^3*gZlR*mm^2*
          (2*psq - s - 2*t) + 4*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*
          (2*psq - s - 2*t) - 2*(-2 + d)^2*gZlL*gZlR^3*mm^2*
          (2*psq - s - 2*t) + gZlL^4*(-(s*((28 - 14*d + d^2)*psq + 
              2*(-2 + d)*s + 4*(-3 + d)*t)) + mm^2*((8 - 6*d + d^2)*psq + 
             (24 - 12*d + d^2)*s - (8 - 6*d + d^2)*t)) + 
         gZlR^4*(-(s*((28 - 14*d + d^2)*psq + 2*(-2 + d)*s + 4*(-3 + d)*t)) + 
           mm^2*((8 - 6*d + d^2)*psq + (24 - 12*d + d^2)*s - 
             (8 - 6*d + d^2)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gZlL*gZlR*
      ((-2 + d)^2*gZlL^2 - (4 - 6*d + d^2)*gZlL*gZlR + (-2 + d)^2*gZlR^2)*
      mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
     Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*
      (bb*(-((-4 + d)*gZlL^4*(2*mm^2*(psq - t) + (2*psq + s)*
             (psq - s - t))) - (-4 + d)*gZlR^4*(2*mm^2*(psq - t) + 
           (2*psq + s)*(psq - s - t)) + 2*gZlL^3*gZlR*mm^2*
          ((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t) + 2*gZlL*gZlR^3*mm^2*
          ((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t)) + 
       aa*(2*gZlL^3*gZlR*mm^2*(-((-2 + d)*psq) + (-4 + d)*s + (-2 + d)*t) + 
         2*gZlL*gZlR^3*mm^2*(-((-2 + d)*psq) + (-4 + d)*s + (-2 + d)*t) + 
         (-4 + d)*gZlL^4*(2*psq^2 + psq*(3*s - 2*t) + 
           2*mm^2*(psq - 2*s - t) - s*(s + t)) + (-4 + d)*gZlR^4*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*(bb*((-2 + d)*gZlL^4*((-4 + d)*mm^2 + 2*s)*
         ...
         2*gZlL^2*gZlR^2*mm^2*((4 - 18*d + 3*d^2)*psq + 8*s + 
           (-4 + 18*d - 3*d^2)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p2, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*
      (-(bb*((-2 + d)*gZlL^4*s*(2*mm^2 + psq - s - 3*t) + 
       ...
       aa*(-((-2 + d)^2*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t)) + 
         ...
         (-2 + d)*gZlL^4*s*(-3*psq + s + 3*t) - (-2 + d)*gZlR^4*s*
          (-3*psq + s + 3*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      ...
      (bb*(2*(-2 + d)^2*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t) - 
       ...
       aa*(-2*(-2 + d)^2*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t) + 
         ...
         gZlL^4*((-4 + d)*mm^2*((-2 + d)*psq - 2*s + 2*t - d*t) - 
           2*s*(2*s + d*(-psq + t))) + gZlR^4*
          ((-4 + d)*mm^2*((-2 + d)*psq - 2*s + 2*t - d*t) - 
           2*s*(2*s + d*(-psq + t)))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
    (I*EL^5*gAl*(bb*(2*(-2 + d)*gZlL^3*gZlR*mm^2*((-2 + d)*psq - (-4 + d)*s - 
           (-2 + d)*t) + 2*(-2 + d)*gZlL*gZlR^3*mm^2*((-2 + d)*psq - 
           (-4 + d)*s - (-2 + d)*t) + gZlL^4*(-((8 - 6*d + d^2)*psq^2) + 
           2*(16 - 9*d + d^2)*psq*s + (8 - 6*d + d^2)*psq*t - 
           2*(-4 + d)*s*t - (-2 + d)*mm^2*((-4 + d)*psq - 4*s + 4*t - d*t)) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*
      (-(bb*(-2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*(2*psq - s - 2*t) + 
          ...
          gZlR^4*s*((20 - 10*d + d^2)*psq + 4*t) + 2*(-2 + d)*gZlL^3*gZlR*
           mm^2*((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t) + 
          2*(-2 + d)*gZlL*gZlR^3*mm^2*((-2 + d)*psq - (-4 + d)*s - 
            (-2 + d)*t))) + aa*(-2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*
          (2*psq - s - 2*t) + 2*(-2 + d)*gZlL^3*gZlR*mm^2*
          ((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t) + 2*(-2 + d)*gZlL*gZlR^3*
          mm^2*((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t) + 
         gZlL^4*s*((16 - 10*d + d^2)*mm^2 + 4*(psq + t)) + 
         gZlR^4*s*((16 - 10*d + d^2)*mm^2 + 4*(psq + t))))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*(aa*(-2*(-2 + d)^2*gZlL^3*gZlR*mm^2*
          (2*psq - s - 2*t) + 4*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*
          (2*psq - s - 2*t) - 2*(-2 + d)^2*gZlL*gZlR^3*mm^2*
          (2*psq - s - 2*t) + gZlL^4*(-2*s*(-2*(-3 + d)*psq + (-4 + d)*s + 
             2*(-3 + d)*t) + (-4 + d)*mm^2*((-2 + d)*psq - (-4 + d)*s - 
             (-2 + d)*t)) + gZlR^4*(-2*s*(-2*(-3 + d)*psq + (-4 + d)*s + 
             2*(-3 + d)*t) + (-4 + d)*mm^2*((-2 + d)*psq - (-4 + d)*s - 
             (-2 + d)*t))) - bb*(-2*(-2 + d)^2*gZlL^3*gZlR*mm^2*
          (2*psq - s - 2*t) + 4*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*
          (2*psq - s - 2*t) - 2*(-2 + d)^2*gZlL*gZlR^3*mm^2*
          (2*psq - s - 2*t) + gZlL^4*(s*((4 - 6*d + d^2)*psq - 2*(-4 + d)*s - 
             4*(-3 + d)*t) + mm^2*((8 - 6*d + d^2)*psq - 2*(16 - 9*d + d^2)*
              s - (8 - 6*d + d^2)*t)) + gZlR^4*
     ...
     Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*
      (aa*((-4 + d)*gZlL^4*((2*psq + s)*(psq - t) + 2*mm^2*(psq - s - t)) + 
       ...
       bb*(2*gZlL^3*gZlR*mm^2*((-2 + d)*psq - 2*s - (-2 + d)*t) + 
         2*gZlL*gZlR^3*mm^2*((-2 + d)*psq - 2*s - (-2 + d)*t) - 
         (-4 + d)*gZlL^4*(2*psq^2 - 3*psq*s + 2*mm^2*(psq + s - t) - 
           2*psq*t - s*t) - (-4 + d)*gZlR^4*(2*psq^2 - 3*psq*s + 
    ...
    (I*(aa - bb)*(8 - 6*d + d^2)*EL^5*gAl*(gZlL^4 + gZlR^4)*s*
     ...
     (2*Pi)^(2*d) - (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*
    ...
    (I*2^(1 - 2*d)*(aa + bb)*(16 - 10*d + d^2)*EL^5*gAl*(gZlL^4 + gZlR^4)*
     ...
     (2*Pi)^(2*d) + (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*
    ...
    (I*4^(1 - d)*EL^5*gAl*(aa*(-(d^2*(gZlL - gZlR)^2*(gZlL^2 + gZlR^2)*
           mm^2) - 4*(-6*gZlL^3*gZlR*mm^2 + 6*gZlL^2*gZlR^2*mm^2 - 
           6*gZlL*gZlR^3*mm^2 + gZlL^4*(10*psq - 3*s - 4*t) + 
           gZlR^4*(10*psq - 3*s - 4*t)) + 2*d*(-8*gZlL^3*gZlR*mm^2 + 
           6*gZlL^2*gZlR^2*mm^2 - 8*gZlL*gZlR^3*mm^2 + 
           gZlL^4*(mm^2 + 8*psq - 2*s - 4*t) + gZlR^4*(mm^2 + 8*psq - 2*s - 
             4*t))) + bb*(-2*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2 + 
         2*(12 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2 - 2*(12 - 8*d + d^2)*gZlL*
          gZlR^3*mm^2 + gZlL^4*((32 - 18*d + d^2)*mm^2 + 8*psq + 
           4*(-3 + d)*s + 8*(-2 + d)*t) + gZlR^4*((32 - 18*d + d^2)*mm^2 + 
           8*psq + 4*(-3 + d)*s + 8*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*(-(bb*(-2*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2 + 
       ...
       aa*(-2*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2 + 2*(12 - 6*d + d^2)*gZlL^2*
          gZlR^2*mm^2 - 2*(12 - 8*d + d^2)*gZlL*gZlR^3*mm^2 + 
         gZlL^4*((8 - 6*d + d^2)*mm^2 + 20*psq - 6*d*psq - 8*s + 2*d*s - 
           4*t + 2*d*t) + gZlR^4*((8 - 6*d + d^2)*mm^2 + 20*psq - 6*d*psq - 
           8*s + 2*d*s - 4*t + 2*d*t)))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*EL^5*gAl*(aa*(-2*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2 + 
         2*(12 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2 - 2*(12 - 8*d + d^2)*gZlL*
          gZlR^3*mm^2 + gZlL^4*((16 - 10*d + d^2)*mm^2 + 2*(2 + d)*psq - 
           4*s + 4*t - 2*d*t) + gZlR^4*((16 - 10*d + d^2)*mm^2 + 
           2*(2 + d)*psq - 4*s + 4*t - 2*d*t)) + 
       bb*(2*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2 - 2*(12 - 6*d + d^2)*gZlL^2*
          gZlR^2*mm^2 + 2*(12 - 8*d + d^2)*gZlL*gZlR^3*mm^2 + 
         gZlL^4*(-((8 - 6*d + d^2)*mm^2) + 2*(-6 + d)*psq + 4*s - 4*t + 
           2*d*t) + gZlR^4*(-((8 - 6*d + d^2)*mm^2) + 2*(-6 + d)*psq + 4*s - 
           4*t + 2*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*(gZlL^4 + gZlR^4)*
    ...
    (I*4^(1 - d)*EL^5*gAl*(aa*(-2*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2 + 
         2*(12 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2 - 2*(12 - 8*d + d^2)*gZlL*
          gZlR^3*mm^2 + gZlL^4*((16 - 10*d + d^2)*mm^2 + 4*d*psq - 4*s + 
           8*t - 4*d*t) + gZlR^4*((16 - 10*d + d^2)*mm^2 + 4*d*psq - 4*s + 
           8*t - 4*d*t)) + bb*(-(d^2*(gZlL - gZlR)^2*(gZlL^2 + gZlR^2)*
           mm^2) - 4*(-6*gZlL^3*gZlR*mm^2 + 6*gZlL^2*gZlR^2*mm^2 - 
           6*gZlL*gZlR^3*mm^2 + gZlL^4*(4*psq - s + 2*t) + 
           gZlR^4*(4*psq - s + 2*t)) + 2*d*(-8*gZlL^3*gZlR*mm^2 + 
           6*gZlL^2*gZlR^2*mm^2 - 8*gZlL*gZlR^3*mm^2 + 
           gZlL^4*(mm^2 + 2*(psq + t)) + gZlR^4*(mm^2 + 2*(psq + t)))))*
    ...
    (I*4^(1 - d)*EL^5*gAl*(gZlL^4 + gZlR^4)*(bb*(8 - 6*d + d^2)*mm^2 - 
      ...
      (gZlL^4 + gZlR^4)*((-2 + d)*mm^2 - (-2 + d)*psq + (-4 + d)*s)*
    ...
    (I*4^(2 - d)*(-2 + d)*EL^5*gAl*(gZlL^4 + gZlR^4)*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[p2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl*
      (gZlL^4 + gZlR^4)*(bb*(2*mm^2 + psq - s - 3*t) + aa*(-3*psq + s + 3*t))*
    ...
    (I*4^(1 - d)*EL^5*gAl*(gZlL^4 + gZlR^4)*(bb*(8 - 6*d + d^2)*mm^2 - 
       ...
       SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*(16 - 10*d + d^2)*EL^5*gAl*
      (gZlL^4 + gZlR^4)*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
