...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((EL^8*gAl*gAu^2*gFFAZ*gFFZ*(gZlL^2 + gZlR^2)*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (2^(-1 - 2*d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*(gZlL^2 + gZlR^2)*
   ...
   (4^d*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*
    (gZlL^2 + gZlR^2)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*
    (gZlL^2 + gZlR^2)*((-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFAZ*gFFZ*(gZlL^2 + gZlR^2)*(s + 2*t)*
