...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[-q1 - q2, mz], 
 ...
 ((EL^5*gAl^3*gXll^2*mm^4*(mm^2 - s)*s*
    (aa*((-2 + d)*mm^2 + (2 + 3*d)*psq - 2*(-2 + d)*s) + 
     bb*((-2 + d)*mm^2 + (2 - 5*d)*psq + 2*(-2 + d)*s))*\[Mu]^(8 - 2*d))/
   (2*Pi)^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*
    (mm^2 - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^4*
  ...
  (EL^5*gAl^3*gXll^2*mm^2*(bb*d*(mm^2*(11*psq - 5*s)*s + psq*s^2 + 
       3*mm^4*(-4*psq + s)) - 2*aa*s*(3*mm^4 + psq*s + mm^2*(-psq + s)) + 
     aa*d*(mm^4*(12*psq - s) + psq*s^2 + mm^2*s*(-13*psq + 3*s)) + 
     2*bb*s*(mm^4 - psq*s + mm^2*(psq + 3*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - s)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*(2*(-3 + d)*mm^2 + 
     (-2 + d)*psq)*(mm^2 - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   Pi^(2*d) + (EL^5*gAl^3*gXll^2*mm^2*s*
   ...
   (2*Pi)^(2*d) - (EL^5*gAl^3*gXll^2*mm^2*s*
    (bb*((-2 + d)*mm^4 + 2*(-2 + d)*psq*s + mm^2*(2*psq + 3*d*psq - 2*d*s)) + 
     aa*((-2 + d)*mm^4 + 2*(-2 + d)*psq*s + mm^2*(2*psq - 5*d*psq + 8*s - 
  ...
  (2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl^3*gXll^2*mm^4*(bb*((2 - 3*d)*psq + (-2 + d)*s) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(2*bb*psq*s + 2*aa*(-2*mm^2 + psq)*s + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(4*aa*(-2 + d)*mm^4 + 
     ...
     aa*mm^2*(-4*d*psq + 10*s - 3*d*s) + bb*mm^2*(8*psq - (2 + d)*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*
    ((-2 + d)*mm^4 - (-2 + d)*psq*s + mm^2*((-2 + d)*psq + (10 - 3*d)*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  (4^(1 - d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*(2*(-2 + d)*mm^4 - 
     2*(-2 + d)*psq*s + mm^2*(2*(-2 + d)*psq + (8 - 3*d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(2*aa*(-3*mm^2 + psq)*s + 
     aa*d*(-(psq*s) + mm^2*(8*psq + s)) + 
     bb*(-2*(mm^2 - 3*psq)*s - 3*d*psq*s + d*mm^2*(-8*psq + 3*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
  (EL^5*gAl^3*gXll^2*mm^2*(-6*bb*mm^2*s + 10*bb*psq*s + 
     2*aa*(-3*mm^2 + psq)*s + bb*d*(-5*psq*s + mm^2*(-4*psq + 3*s)) + 
     aa*d*(-(psq*s) + mm^2*(4*psq + 3*s)))*\[Mu]^(8 - 2*d)*
