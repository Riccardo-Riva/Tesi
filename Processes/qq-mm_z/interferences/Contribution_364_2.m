...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 (((-I)*2^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*
  ...
  (I*EL^6*gAu*ggmgmA*ggmgmZ*(gZlL*gZlLC*((-2 + d)*gZuLC*s - 
  ...
  (I*2^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*
   ...
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) + 
  (I*2^(2 - d)*EL^6*gAu*ggmgmA*ggmgmZ*(gZlL*gZlLC + gZlR*gZlRC)*
  ...
  (I*2^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*
   ...
   (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
  (I*2^(3 - d)*EL^6*gAu*ggmgmA*ggmgmZ*(gZlL*gZlLC + gZlR*gZlRC)*
