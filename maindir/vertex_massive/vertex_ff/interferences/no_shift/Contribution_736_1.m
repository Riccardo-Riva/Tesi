...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*d*EL^6*gAl^5*gAu*mm^2*(3*mm^2 + psq - 2*s)*
      ...
      4*(-2 + d)*s*t*(s^2 + 3*s*t + 2*t^2) + (-2 + d)*psq^2*
       ...
       ((2 + d)*psq - 2*t - d*(s + t)) - 2*mm^2*((12 - 8*d + d^2)*psq^3 + 
        (-2 + d)*psq*t*((-15 + d)*s + (-18 + d)*t) - (-2 + d)*psq^2*
         ((-5 + d)*s + 2*(-9 + d)*t) + 2*(-2 + d)*t*(2*s^2 + 5*s*t + 3*t^2)))*
   ...
   (2^(3 - 2*d)*d*EL^6*gAl^5*gAu*mm^2*(2*(-4 + d)*psq^2 + 4*(-2 + d)*mm^2*s + 
      (24 - 7*d)*psq*s - 8*s^2 + 2*d*s^2 - 4*(-4 + d)*psq*t - 16*s*t + 
      3*d*s*t - 8*t^2 + 2*d*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*d^2*EL^6*gAl^5*gAu*mm^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(-4*psq^2 + (-2 + d)*mm^2*(psq - t) - 
      (-10 + d)*psq*t + (-6 + d)*t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*(-2 + d)^2*EL^6*gAl^5*gAu*(psq^2 + mm^2*s + t^2 - 
   ...
   (4^(2 - d)*(-2 + d)^2*EL^6*gAl^5*gAu*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(5 - 2*d)*(-2 + d)^2*EL^6*gAl^5*gAu*(psq - t)^2*\[Mu]^(8 - 2*d)*
