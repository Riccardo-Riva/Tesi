...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (-((EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*((-2 + d)*gZlR*mm^2*(2*Pi)^(2*d)*
       (4*(-2 + d)*psq^2 + (-4 + d)^2*s^2 - 8*(-2 + d)*psq*t + 
        4*(-2 + d)*s*t + 4*(-2 + d)*t^2) + 
      gZlL*(-((-24 + 24*d - 8*d^2 + d^3)*mm^4*(2*Pi)^(2*d)*s) - 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
     ...
     SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    gWlN*gWNl*gZlL*gZNL*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
     mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*
    (-2*(12 - 8*d + d^2)*gZlR*mm^2*s + gZlL*(-2*(-8 - 2*d + d^2)*psq^2 - 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
     ...
     SP[p3, q1]])/(Pi^(2*d)*s^2) + ((-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*
    (gZlL*s*(-((8 - 6*d + d^2)*psq) + 2*(-4 + d)*s - 4*t) - 
     4*(-2 + d)*gZlR*mm^2*(psq - s - t) + 
     gZlL*mm^2*(4*(-4 + d)*psq + (28 - 10*d + d^2)*s - 4*(-4 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*
    (d^2*(gZlL*psq*(psq - 4*s - t) + gZlL*mm^2*(psq + s - t) + 
       gZlR*mm^2*(-2*psq + 3*s + 2*t)) - 2*d*(4*gZlR*mm^2*(-psq + 2*s + t) + 
       gZlL*(5*psq^2 - 16*psq*s - s^2 + mm^2*(psq + 5*s - t) - 5*psq*t)) + 
     4*(gZlR*mm^2*(-2*psq + 5*s + 2*t) + gZlL*(2*psq^2 + 5*mm^2*s - 
         13*psq*s - 3*s^2 - 4*s*t - 2*t^2)))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*
    gZNL*(-2*s^2 + d*s^2 + 2*mm^2*(2*psq + s - 2*t) + 4*s*t + 4*t^2 - 
   ...
   (Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*
    (2*(12 - 8*d + d^2)*gZlR*mm^2*s + gZlL*(-2*(24 - 10*d + d^2)*psq^2 + 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
   ...
   (Pi^(2*d)*s^2) + ((-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*
    (4*(-2 + d)*gZlR*mm^2*(psq - t) + gZlL*s*(-((16 - 6*d + d^2)*psq) + 
       2*(-2 + d)*s + 4*t) + gZlL*mm^2*(-4*(-4 + d)*psq + 
       (12 - 6*d + d^2)*s + 4*(-4 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*
    (4*gZlR*mm^2*(2*psq + 3*s - 2*t) - 4*gZlL*(6*psq^2 - 5*mm^2*s + 
       13*psq*s + s^2 - 8*psq*t + 2*t^2) + 
     d^2*(gZlR*mm^2*(2*psq + s - 2*t) + gZlL*psq*(-psq - 3*s + t) + 
       gZlL*mm^2*(-psq + 2*s + t)) + 2*d*(-4*gZlR*mm^2*(psq + s - t) + 
       gZlL*(5*psq^2 + 11*psq*s + s^2 + mm^2*(psq - 6*s - t) - 5*psq*t)))*
  ...
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*(4*(8 - 6*d + d^2)*psq^2 + 
     8*(-2 + d)*mm^2*s - 136*s^2 + 76*d*s^2 - 14*d^2*s^2 + d^3*s^2 + 32*s*t - 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*
    (2*(-2 + d)*gZlR*mm^2 + gZlL*((20 - 8*d + d^2)*mm^2 - 
       (12 - 6*d + d^2)*psq + 2*(-3 + d)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gZNL*(4*(-2 + d)^2*gZlR*mm^2*s + 
     gZlL*(4*(16 - 10*d + d^2)*psq^2 + 2*(-4 + d)^2*(-2 + d)*mm^2*s - 
       128*s^2 + 72*d*s^2 - 14*d^2*s^2 + d^3*s^2 + 64*s*t - 40*d*s*t + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*(mm^2 - psq)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    ...
    gZNL*(-((20 - 10*d + d^2)*psq) + (-4 + d)^2*s + (20 - 10*d + d^2)*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*
    gZNL*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*(12 - 8*d + d^2)*EL^8*gAl^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    (2*(12 - 8*d + d^2)*mm^2 + (-44 + 24*d - 3*d^2)*psq + 16*s - 8*d*s + 
     d^2*s + 20*t - 8*d*t + d^2*t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*
    ...
    gZlL*gZNL*(-2*(12 - 8*d + d^2)*mm^2 + (4 - 8*d + d^2)*psq + 4*s + 20*t - 
     8*d*t + d^2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*
    gZNL*(2*(16 - 10*d + d^2)*mm^2 - 2*(16 - 10*d + d^2)*psq + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*(psq - t)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*(2*psq + s - 2*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    (-2*(16 - 10*d + d^2)*psq + (-104 + 64*d - 14*d^2 + d^3)*s + 
     ...
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    gWlN*gWNl*gZlL*gZNL*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s) + (EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
  ...
  (2^(1 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*(psq - t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    (2*(16 - 10*d + d^2)*psq - (-104 + 64*d - 14*d^2 + d^3)*s - 
     ...
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
    gWNl*gZlL*gZNL*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
  ...
  (4^(1 - d)*(12 - 8*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*gZNL*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], SP[q2, q2]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL*
