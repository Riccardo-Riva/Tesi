  ...
  (-((2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*s*
     (2*aa*mm^2*(2*(-3 + d)*mm^2 + 3*(-2 + d)*psq - (-4 + d)*s) + 
      bb*((8 - 3*d)*mm^4 + (-4 + d)*psq*s + mm^2*((16 - 7*d)*psq + 
   ...
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*s*
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*s*
     (bb*((-4 + d)*mm^4 + (20 - 3*d)*mm^2*psq + 2*psq*(d*psq - 2*s)) + 
      aa*((-4 + d)*mm^4 + mm^2*((-12 + d)*psq - (-8 + d)*s) + 
    ...
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
     ...
     (2*bb*(-2 + d)*mm^4 + aa*d*psq^2 - bb*mm^2*((4 + d)*psq - 2*s) + 
      bb*psq*(-(d*psq) + 2*s) - aa*mm^2*((-8 + d)*psq + 4*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(4*bb*mm^4 - 
      bb*(-2 + d)*mm^2*(3*psq - 2*s) - aa*(-2 + d)*psq*s + 
   ...
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*
     (-(bb*((4 + d)*mm^4 + 4*psq*s + mm^2*(-3*(-4 + d)*psq + 
           4*(-1 + d)*s))) + aa*((4 + d)*mm^4 + d*psq*s + 
        mm^2*(-3*(-4 + d)*psq + 3*d*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(aa*d*psq*(3*mm^2 + psq) - 
   ...
   (4^(1 - d)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*mm^2 - bb*(mm^2 + psq))*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 + psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*bb*mm^2 + aa*(-6 + d)*mm^2 - 
   ...
   (2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(4 + d)*mm^2 + aa*d*psq - 
