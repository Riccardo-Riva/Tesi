...
PropList[KiraPropagator[q1, mh], KiraPropagator[-p3 + q1, mm], 
 ...
 ((I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(mm^2 - psq)^2*s*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(bb*(psq - s - t) + 
     aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p1, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*bb*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(bb*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(1 - 2*d)*bb*EL^5*gAl*gHHH*gHll^3*mh^2*mm^4*(mm^2 - psq)*
