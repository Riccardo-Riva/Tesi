...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*((-2 + d)^2*mm^4*s - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
    (12*psq^2 + mm^2*(-12*psq + (12 - 2*d + d^2)*s + 12*t) - 
     psq*(-2*d*s + d^2*s + 20*t) + 4*((-3 + d)*s^2 + s*t + 2*t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(2*psq^2 - 2*s^2 + d*s^2 + 
     mm^2*(2*psq + (-2 + d)*s - 2*t) + 4*s*t + 4*t^2 - 
     psq*((-2 + d)*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
    (4*psq^2 - (4 - 2*d + d^2)*psq*s + 4*(-2 + d)*s^2 + 
     mm^2*(12*psq - 2*d*s + d^2*s - 12*t) - 12*psq*t + 12*s*t + 8*t^2)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(4*psq^2 + 2*mm^2*s - 2*s^2 + 
     d*s^2 + 4*s*t + 4*t^2 - 2*psq*(s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
    (4*psq^2 + (10 - 4*d + d^2)*mm^2*s - 8*s^2 + 3*d*s^2 + 4*s*t + 4*t^2 - 
     psq*((6 - 4*d + d^2)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    ((16 - 6*d + d^2)*mm^4 + (16 - 6*d + d^2)*psq^2 - 2*s^2 + d*s^2 - 
     2*mm^2*((14 - 6*d + d^2)*psq - 2*(-2 + d)*s) + 4*s*t + 4*t^2 - 
     4*psq*((-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (Pi^(2*d)*s) + (EL^8*gAl^4*gAu^2*gHll^2*mm^4*(4*(-2 + 3*d)*psq^2 + 
     2*(12 - 8*d + d^2)*mm^2*s + 36*s^2 - 22*d*s^2 + 3*d^2*s^2 - 8*s*t + 
     12*d*s*t - 8*t^2 + 12*d*t^2 - 2*psq*((12 - 8*d + d^2)*s + 
       4*(-2 + 3*d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (4^d*Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (mm^2 - psq)*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*mm^2 - psq)*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (mm^2 - psq)*(2*mm^2 - 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (4*mm^4 + psq*(2*psq - (-3 + d)*s) + mm^2*(-12*psq - 3*s + 2*d*s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(8*psq^2 - 2*s^2 + d*s^2 + 
     4*s*t + 4*t^2 - 6*psq*(s + 2*t) + mm^2*(-4*psq + 6*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-8*psq^2 + 2*(-7 + d)*mm^2*s + 
     2*s^2 - d*s^2 - 4*s*t - 4*t^2 + 6*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*(4 + d)*psq^2 - 
     (12 - 10*d + d^2)*psq*s + 2*(8 + d)*psq*t + 
     mm^2*(2*(-2 + d)*psq + (8 - 8*d + d^2)*s - 2*(-2 + d)*t) - 
     4*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-8 + 3*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (4*mm^4 + psq*(2*psq - (-3 + d)*s) + mm^2*((-9 + 2*d)*s - 6*t))*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(8*(-2 + d)*mm^2 - 8*(-2 + d)*psq + 
   ...
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (8*psq^2 - 2*s^2 + d*s^2 - 2*mm^2*(6*psq - 5*s - 6*t) + 4*s*t + 4*t^2 - 
     6*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
    (4*(-2 + d)*psq + (24 - 13*d + d^2)*s - 4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(8*s + d^2*s - 
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - psq)*
    ...
    (2*mm^2 - psq)*(2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*s^2 + d*s^2 + 
     2*mm^2*(2*psq + s - 2*t) + 4*s*t + 4*t^2 - 2*psq*(s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-7 + d)*mm^2*s + 2*s^2 - 
     d*s^2 - 4*s*t - 4*t^2 + 2*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*s^2 + d*s^2 + 
     2*mm^2*(2*psq + s - 2*t) + 4*s*t + 4*t^2 - 2*psq*(s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*(-4 + d)*psq^2 + 
     (20 - 8*d + d^2)*psq*s + 2*(-8 + d)*psq*t + 4*t*(s + 2*t) + 
     mm^2*(2*(-2 + d)*psq - (4 - 6*d + d^2)*s - 2*(-2 + d)*t))*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*s^2 - d*s^2 - 4*s*t - 4*t^2 + 
     2*psq*(s + 2*t) + 2*mm^2*(-6*psq + s + 6*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*psq^2 + 6*mm^2*s - 2*s^2 + 
     d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*psq^2 + 4*mm^2*s - 2*s^2 + 
     d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (d^2*s^2 + 4*s*(mm^2 - 2*psq + 5*s) + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((16 - 6*d + d^2)*mm^2 - 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*psq + (-4 + d)*s - 2*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (d*(mm^2 - psq) + 4*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
  ...
  (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(mm^2 - 2*psq + s + t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*psq + (-2 + d)*s + 2*t)*
   ...
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*
