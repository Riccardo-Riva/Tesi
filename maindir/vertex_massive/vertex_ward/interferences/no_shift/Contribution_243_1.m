...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*s*
   ...
   (4^(1 - d)*EL^5*gAl^2*gWWA^3*(bb*mm^2*(2*(5 + 3*d)*psq + (4 - 13*d)*s) - 
      2*aa*mm^2*((5 + 3*d)*psq + (-6 + d)*s) + 
      2*bb*psq*((11 - 3*d)*psq + 2*(-2 + d)*s) + 
      aa*psq*((-22 + 6*d)*psq + (-8 + 11*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl^2*gWWA^3*(aa*(1 - 2*d)*mm^2 + 2*bb*(-5 + 4*d)*mm^2 + 
      5*aa*(3 - 2*d)*psq + 2*bb*(-3 + 2*d)*psq)*s*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^5*gAl^2*gWWA^3*(aa*(psq*(-4*(-8 + 3*d)*psq + (3 - 5*d)*s) + 
