...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((3*2^(3 - 2*d)*d*EL^5*gAl^3*gAu^2*mm*mu^2*(4*mm^2 - s)*s)/Pi^(2*d) + 
   (3*2^(5 - 2*d)*EL^5*gAl^3*gAu^2*mm*mu^2*(2*d*mm^2 + s - d*s)*
   ...
   (3*2^(5 - 2*d)*(-2 + d)*EL^5*gAl^3*gAu^2*mm*mu^2*s*SPList[SP[p3, q1]])/
   ...
   (3*2^(3 - 2*d)*d*EL^5*gAl^3*gAu^2*mm*(4*mm^2 - s)*s*SPList[SP[q1, q2]])/
    Pi^(2*d) - (3*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gAu^2*mm*(4*mm^2 - s)*s*
     ...
     mm*mu^2*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (3*4^(3 - d)*EL^5*gAl^3*gAu^2*mm^3*SPList[SP[p1, q1], SP[p1, q2]])/
    Pi^(2*d) - (3*4^(3 - d)*(-2 + d)*EL^5*gAl^3*gAu^2*mm*mu^2*
   ...
   (3*2^(5 - 2*d)*(-2 + d)*EL^5*gAl^3*gAu^2*mm*mu^2*
