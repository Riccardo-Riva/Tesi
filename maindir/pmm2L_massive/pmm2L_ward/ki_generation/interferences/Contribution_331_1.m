...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*EL^5*gAl*gXll^2*mm^4*s*(-2*bb*(gZlL^2 + gZlR^2)*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*s*
      ...
      gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gAl*gXll^2*gZlL*gZlR*
      mm^2*s*(4^d*aa*Pi^(2*d)*(4*mm^2*(psq - t) + 4*psq*(psq - s - t) + 
    ...
    (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
     ...
     Pi^(2*d) - (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (aa*psq*(psq - s - t) + aa*mm^2*(psq + s - t) - bb*psq*(psq + s - t) + 
       ...
       SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*mm^4*
    ...
    (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      ...
      gXll^2*gZlL*gZlR*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
      gZlR*mm^2*(bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*
