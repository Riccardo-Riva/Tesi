...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 (-((EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*(-6*psq^2 + s^2 - 7*s*t - 
      6*t^2 + psq*(s + 12*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
  ...
  (EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*(4*psq^2 - 8*psq*t + 
     (s + 2*t)^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(4^d*Pi^(2*d)*s^2) - 
  (EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*(4*psq^2 - 8*psq*t + 
     (s + 2*t)^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*
    (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*
    (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*(3*psq - 2*s - 3*t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*(-2*psq + 5*s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*(-psq + s + t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*(-3*psq + s + 3*t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*(psq - t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWlN*mm^2*\[Mu]^(8 - 2*d)*
