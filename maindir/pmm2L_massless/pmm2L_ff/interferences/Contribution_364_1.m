...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^4*t^2*(s + t)*
      \[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) - 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*(mm^2 - t)*
     (s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t*(mm^2 + t)*
     (s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t*(mm^2 + t)*
     (s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t*
     (s^2 + 2*s*t + t*(-mm^2 + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^4*
     (s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^4*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*(s + t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*(2*mm^2 + t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
     t*(2*mm^2 + 2*s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t*(s + 2*t)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*(s + t)*
    ...
    Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll*gHWW*gWlN*gWNl*mm^2*t*
