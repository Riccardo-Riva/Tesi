...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
 ...
 (((-I)*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*s*
    (bb*psq*(3*psq - 2*s - 3*t) + bb*mm^2*(psq - t) + 
     aa*mm^2*(-psq + s + t) + aa*psq*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
  ...
  (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    (bb*(-((2*psq - s)*(3*psq - 2*s - 3*t)) - 2*mm^2*(psq - t)) + 
     aa*(6*psq^2 - 5*psq*s + 2*s^2 + 2*mm^2*(psq - s - t) - 6*psq*t + 3*s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    (aa*s*(5*psq - 4*s - 5*t) + 2*bb*mm^2*(psq - t) + 
     2*aa*mm^2*(-psq + s + t) + bb*s*(-7*psq + 4*s + 5*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) + (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHll*gHWW*
    gWlN*gWNl*mm^2*(aa*(6*psq^2 + 2*mm^2*(psq - s - t) + s*(s + t) - 
  ...
  (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    ...
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHll*gHWW*
    gWlN*gWNl*mm^2*(bb*(-6*psq^2 + 5*psq*s - 2*mm^2*(psq - t) + 6*psq*t - 
       s*t) + aa*(6*psq^2 + 2*mm^2*(psq - s - t) + s*t - 3*psq*(s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*s*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
    gWNl*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
    gWNl*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, p2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*
    gHll*gHWW*gWlN*gWNl*mm^2*(8*psq - 5*s - 8*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
    gWNl*mm^2*(-3*psq + 2*s + 3*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   Pi^(2*d) - ((3*I)*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
    gWNl*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p2, p3]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
    gWNl*mm^2*(aa*(2*mm^2 - psq - 2*s - t) + bb*(-psq + 2*s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
    (aa*(psq - t) + bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*(psq - s - t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
    gWNl*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*
    gHWW*gWlN*gWNl*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*(psq - t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (4^d*Pi^(2*d)) + ((3*I)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHWW*gWlN*
