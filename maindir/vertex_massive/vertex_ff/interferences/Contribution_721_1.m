...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*
     ...
     gXll^2*mm^2*(mm^2 - psq)*(psq^2 + s^2 + mm^2*(psq - t) + 2*s*t + 2*t^2 - 
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(2*psq - s - 2*t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
     ...
     gWNl*gXll^2*mm^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
