...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
   ...
   ((2^(1 - 2*d)*EL^6*gAu*ggagmAW*ggagmW*gWlN*gWNl*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*ggagmAW*ggagmW*gWlN*gWNl*
      (mm^2*(psq - t) + psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAu*ggagmAW*ggagmW*gWlN*gWNl*(psq^2 - mm^2*s - 2*psq*t + 
    ...
    (4^(1 - d)*EL^6*gAu*ggagmAW*ggagmW*gWlN*gWNl*(psq^2 - mm^2*s - 2*psq*t + 
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*ggagmAW*ggagmW*gWlN*gWNl*(psq - t)*
