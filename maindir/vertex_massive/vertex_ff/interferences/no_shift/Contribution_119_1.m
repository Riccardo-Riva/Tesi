  ...
  (-((4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2 - psq)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
     (2*psq^2 - s^2 + psq*(s - 4*t) + s*t + 2*t^2 - 
      d*(psq^2 - 2*psq*t + t*(s + t) + 2*mm^2*(-psq + s + t)))*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(-2*(-2 + d)*psq^2 - 
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
     (d*psq*s + 2*d*mm^2*(psq - t) - s*(psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*(-2 + d)*psq^2 + 
     ...
     (mm^2 - psq)*(2*(psq - s - t) + d*(4*mm^2 - psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-6 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
     (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
     (2*psq^2 + 3*psq*s - s^2 - 4*psq*t + s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)^2*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
     (2*(-2 + d)*psq^2 + (8 - 3*d)*psq*s + (-2 + d)*s^2 - 4*(-2 + d)*psq*t + 
      (-8 + 3*d)*s*t + 2*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
     ...
     (mm^2 - psq)*((-2 + d)*psq - s - (-2 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
    ...
    Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
     s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((-2 + d)*mm^2 - 2*(-3 + d)*psq + 
      ...
      SP[p3, q1]])/Pi^(2*d) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[p3, q2]])/Pi^(2*d) - 
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*mm^2 - 3*psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q1, q2]])/Pi^(2*d) - 
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - psq)*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
