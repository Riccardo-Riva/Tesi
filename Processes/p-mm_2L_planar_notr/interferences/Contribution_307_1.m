(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl*gAu^2*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*(s + t)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
     (2*(-2 + d)*mm^2 + 4*(-2 + d)*mu^2 - 10*s + 3*d*s - 2*t + d*t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
     (s + 2*t)*SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*
     (2*mu^2 + s)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gHll*gHWW*gWlN*gWNl*gWWA*mm^2*t*
