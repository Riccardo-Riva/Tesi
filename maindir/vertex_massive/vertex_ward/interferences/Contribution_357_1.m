...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((EL^5*gAl^3*mm^2*s*(-(bb*(2*Pi)^(2*d)*((-2 + d)*gZlL^2*(mm^2 - psq)*
     ...
     aa*(2^(1 + 2*d)*(-2 + d)*gZlL^2*Pi^(2*d)*(mm^2 - psq)*psq + 
       ...
       gZlL*gZlR*(2*Pi)^(2*d)*((-2 + d)^2*mm^4 + 
         ...
         mm^2*((-12 - 4*d + d^2)*psq + (8 - 6*d + d^2)*s))))*\[Mu]^(8 - 2*d))/
   (2*Pi)^(4*d) + 
  (EL^5*gAl^3*(2^(1 + 2*d)*bb*Pi^(2*d)*s*(-2*(gZlL^2 + gZlR^2)*psq*
    ...
    (s*(-(2^(1 + 2*d)*bb*Pi^(2*d)*((-2 + d)*gZlL^2*mm^2 + 
       ...
       aa*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-6 + d)*mm^2 - (-4 + d)*psq)) - 
         ...
         2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(8*mm^2 + (4 - 2*d + d^2)*psq - 
           (8 - 6*d + d^2)*s))) - aa*(2*Pi)^(2*d)*
      (d^2*psq*(gZlL^2*(-mm^2 + psq) + gZlR^2*(-mm^2 + psq) + 
  ...
  (EL^5*gAl^3*s*(-(2^(1 + 2*d)*bb*Pi^(2*d)*(-2*(gZlL^2 + gZlR^2)*psq*
         (mm^2 + s) + d*(-2*gZlL*gZlR*mm^2*(mm^2 + 3*psq - s) + 
          gZlL^2*psq*(mm^2 + s) + gZlR^2*psq*(mm^2 + s)))) + 
  ...
  (EL^5*gAl^3*mm^2*s*(-(2^(1 + 2*d)*bb*Pi^(2*d)*((-2 + d)*gZlL^2*mm^2 + 
        (-2 + d)*gZlR^2*mm^2 + gZlL*gZlR*(8*mm^2 + (4 - 2*d + d^2)*psq - 
          (8 - 6*d + d^2)*s))) + 
     aa*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-6 + d)*mm^2 - (-4 + d)*psq)) - 
       (-2 + d)*gZlR^2*(2*Pi)^(2*d)*((-6 + d)*mm^2 - (-4 + d)*psq) + 
       2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(8*mm^2 + (4 - 2*d + d^2)*psq - 
         (8 - 6*d + d^2)*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (2*Pi)^(4*d) + 
  (EL^5*gAl^3*s*(aa*(4^d*gZlL*gZlR*mm^2*Pi^(2*d)*((-2 + d)^2*mm^2 + 
  ...
  (2^(1 - 8*d)*EL^5*gAl^3*
    (bb*(2^(1 + 6*d)*gZlL*gZlR*mm^2*Pi^(6*d)*(-2*d*(psq - 2*s) + 
         d^2*(2*psq - s) - 4*s) + (-2 + d)*gZlL^2*(2*Pi)^(6*d)*psq*
        ((-4 + d)*mm^2 - (-2 + d)*s) + (-2 + d)*gZlR^2*(2*Pi)^(6*d)*psq*
        ((-4 + d)*mm^2 - (-2 + d)*s)) + 
     aa*mm^2*(-((-2 + d)*gZlL^2*(2*Pi)^(6*d)*((-4 + d)*mm^2 - (-2 + d)*s)) - 
       (-2 + d)*gZlR^2*(2*Pi)^(6*d)*((-4 + d)*mm^2 - (-2 + d)*s) + 
       2^(1 + 6*d)*gZlL*gZlR*Pi^(6*d)*((4 - 6*d + d^2)*mm^2 - 
         (-2 + d)*((-2 + 3*d)*psq - (-2 + d)*s))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(8*d) + 
  (2^(1 - 2*d)*EL^5*gAl^3*(aa*d^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s + 
     8*aa*(gZlL^2 + gZlR^2)*(3*mm^2 - psq)*s - 4*bb*(gZlL^2 + gZlR^2)*
      (mm^2 + 3*psq)*s - 2*aa*d*(-2*gZlL*gZlR*mm^2*(mm^2 + 3*psq - s) + 
       gZlL^2*(7*mm^2 - 3*psq)*s + gZlR^2*(7*mm^2 - 3*psq)*s) + 
     2*bb*d*(-2*gZlL*gZlR*mm^2*(mm^2 + 3*psq - s) + gZlL^2*(mm^2 + 3*psq)*s + 
  ...
  EL^5*gAl^3*(-((4^(1 - d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 + psq)*
    ...
    (aa*mm^2*(-(d^2*(2*Pi)^(2*d)*(gZlL^2*(mm^2 + psq - 2*s) + 
       ...
       4^(1 + d)*Pi^(2*d)*(5*gZlL^2*s + 5*gZlR^2*s + 
         4*gZlL*gZlR*(mm^2 - psq + 2*s)) + 2^(1 + 2*d)*d*Pi^(2*d)*
        (gZlL^2*(mm^2 + psq - 7*s) + gZlR^2*(mm^2 + psq - 7*s) - 
         2*gZlL*gZlR*(6*mm^2 - 2*psq + 7*s))))/(2*Pi)^(4*d) + 
    (bb*(-(d^2*(gZlL^2*(mm^2 + psq)*(mm^2 - s) + gZlR^2*(mm^2 + psq)*
       ...
       2*d*(-2*gZlL*gZlR*mm^2*(6*mm^2 - 2*psq + 7*s) + 
         ...
         gZlR^2*(mm^4 + mm^2*(psq - 4*s) - 3*psq*s))))/(2*Pi)^(2*d))*
   \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]] + 
  ((-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(aa*psq*(d*(mm^2 - psq) + 4*psq) + 
  ...
  (EL^5*gAl^3*((-aa + bb)*(8 - 6*d + d^2)*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s + 
     (-2 + d)*(-(bb*mm^2*(2*(-2 + d)*gZlL*gZlR*(4*psq - s) + 
          (-4 + d)*gZlL^2*s + (-4 + d)*gZlR^2*s)) + 
       aa*(2*(-2 + d)*gZlL*gZlR*mm^2*(4*psq - s) + (-4 + d)*gZlL^2*psq*s + 
         (-4 + d)*gZlR^2*psq*s)))*\[Mu]^(8 - 2*d)*
  ...
  ((2 - d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(aa*(-4 + d)*mm^2 - 2*bb*psq - 
  ...
  (EL^5*gAl^3*(2^(1 + 2*d)*bb*Pi^(2*d)*(-((12 - 6*d + d^2)*gZlL*gZlR*mm^2) + 
       (-2 + d)*gZlL^2*psq + (-2 + d)*gZlR^2*psq) - 
     aa*(2*Pi)^(2*d)*(-2*(12 - 6*d + d^2)*gZlL*gZlR*mm^2 + 
