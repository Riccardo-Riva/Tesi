...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*(3*psq - s)*
   ...
   (2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*
     (2*psq - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*
   ...
   (2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gFAW*gFll*gWNl*gWWA^2*mm^2*(psq - s)*
