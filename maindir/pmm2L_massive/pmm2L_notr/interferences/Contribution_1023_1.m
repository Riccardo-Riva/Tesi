  ...
  (-(((-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
   ...
   (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
    ...
    (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*
     mm^2*(2*psq^2 - 2*s^2 + d*s^2 - s*t + 2*t^2 + 2*mm^2*(-psq + d*s + t) - 
      psq*((-7 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
     gWWA*mm^2*(2*psq^2 + (-16 + d)*psq*s + mm^2*(4*psq - 2*d*s - 4*t) - 
      2*psq*t + 2*s*(s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
     gWWA*mm^2*(2*psq^2 - (-2 + d)*psq*s - 2*s^2 + 2*d*s*(mm^2 + s) - 
      6*psq*t + 2*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
    (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*
     mm^2*(2*psq^2 + s^2 + d*s^2 + psq*(s - d*s - 4*t) + 
      2*mm^2*(psq + (-1 + d)*s - t) + 5*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
   ...
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
    ...
    (mh^2*Pi^(2*d)*s) - (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*
     mm^2*(-4*psq^2 + 4*mm^2*s + 14*psq*s - 8*s^2 + d*s^2 + 8*psq*t - 4*s*t - 
   ...
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (2*mm^2 - 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p2, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
   ...
   (4^(1 - d)*(3 - 4*d + d^2)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(mh^2*Pi^(2*d)*s) - 
   (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p3, q1]])/(mh^2*Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-1 + d^2)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
   ...
   (4^(1 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
      SP[p1, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (psq + (-6 + d)*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
     gWWA*mm^2*(psq + s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
     gWWA*mm^2*(2*mm^2 - 2*psq + (-5 + d)*s)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
    ...
    (mh^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
     gWWA*mm^2*(2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(4 - 5*d + d^2)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(mh^2*Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (-3*psq + s + 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
     gWWA*mm^2*(2*mm^2 + psq - 4*s + d*s - 3*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
    ...
    (mh^2*Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
     ...
     SPList[SP[p1, q2], SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
   ...
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
    ...
    (mh^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
     gWWA*mm^2*(psq - 2*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (-2*psq + (-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p3, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*(2*psq + s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (6*psq + (-2 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p3, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
     gWWA*mm^2*(6*psq + d*s - 6*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (-psq + (-3 + d)*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    (mh^2*Pi^(2*d)*s^2) - (4^(1 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*
     mm^2*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
   ...
   (4^(1 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*(4 - 5*d + d^2)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(mh^2*Pi^(2*d)*s) - 
   (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
  ...
  (((-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
   ...
   (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     (6*psq^2 - (4 + d)*psq*s + 2*d*s*(mm^2 + s) - 10*psq*t + 
      2*t*(3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
    (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*
     mm^2*(-2*psq^2 + (-7 + d)*psq*s + 2*s^2 - d*s^2 + 
      2*mm^2*(psq - d*s - t) + 4*psq*t + s*t - 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (2^(1 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
