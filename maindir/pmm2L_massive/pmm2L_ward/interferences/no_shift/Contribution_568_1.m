  ...
  ((I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*s*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*
     ...
     (aa*(-2*psq^2 + 2*mm^2*s - psq*s + 2*psq*t + s*t) + 
      bb*(2*psq^2 - s*t - psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    Pi^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*s*
   ...
   (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(bb*psq*s + bb*mm^2*(psq - 2*s - t) + 
      aa*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - t) + 
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa + bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*
