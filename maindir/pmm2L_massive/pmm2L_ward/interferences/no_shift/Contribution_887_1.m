...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, ml]]*((I*2^(1 - 2*d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
      ml^2*mm^2*s*(aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + 
       bb*psq*(-psq + t) + bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d))/
     ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
      ml^2*mm^2*(bb*psq*(-psq + t) + aa*(psq^2 + 2*mm^2*s - psq*(2*s + t)))*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
      ml^2*mm^2*(-(bb*(psq^2 - 2*mm^2*s + psq*(s - t))) + 
       aa*psq*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
      ml^2*mm^2*(aa*(2*mm^2 + s)*(psq - t) - 2*bb*mm^2*(psq + s - t) + 
    ...
    (I*2^(3 - 2*d)*aa*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*(mm^2 - psq)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*
      (gZlL + gZlR)^2*ml^2*mm^2*(bb*(psq - s - t) + 
    ...
    (I*2^(3 - 2*d)*(aa + bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*
      (gZlL + gZlR)^2*ml^2*mm^2*(bb*(2*mm^2 - psq + s - t) - 
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
      (gZlL + gZlR)^2*ml^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q2]])/((mh^2 - mz^2)*Pi^(2*d)) - 
    (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(3 - 2*d)*bb*EL^5*gAl*gHll^2*
    ...
    (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, ml]]*(((-I)*2^(1 - 2*d)*EL^5*gAl*gHll^2*
      (gZlL + gZlR)^2*ml^2*mm^2*s*(aa*mm^2*(psq - t) + aa*psq*(psq - s - t) + 
       bb*psq*(-psq + t) + bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d))/
     ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
      ml^2*mm^2*(bb*psq*(-psq + t) + aa*(psq^2 + 2*mm^2*s - psq*(2*s + t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/((mh^2 - mz^2)*Pi^(2*d)) - 
