...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mz], 
 ...
 ((I*4^(-1 - d)*EL^5*gAl*ggpgpZ^2*
    (aa*(2*gZlL*gZlR*mm^2*s*(-psq + t) + gZlL^2*(psq*s*(2*psq + s - 2*t) + 
         mm^4*(psq - t) - mm^2*(psq^2 + psq*s + s^2 - psq*t - s*t)) + 
       gZlR^2*(psq*s*(2*psq + s - 2*t) + mm^4*(psq - t) - 
         mm^2*(psq^2 + psq*s + s^2 - psq*t - s*t))) - 
     bb*(2*gZlL*gZlR*mm^2*s*(-psq + t) + gZlL^2*(mm^4*(psq - 2*s - t) - 
         2*psq*s*t + mm^2*(-psq^2 + 3*psq*s + psq*t + s*t)) + 
       gZlR^2*(mm^4*(psq - 2*s - t) - 2*psq*s*t + 
         mm^2*(-psq^2 + 3*psq*s + psq*t + s*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(-1 - d)*EL^5*gAl*ggpgpZ^2*
    (aa*(2*gZlL*gZlR*mm^2*s*(-psq + t) + gZlL^2*(psq*s*(2*psq + s - 2*t) + 
     ...
     bb*(2*gZlL*gZlR*mm^2*s*(-psq + t) + gZlL^2*(mm^4*(psq - 2*s - t) - 
       ...
       gZlR^2*(mm^4*(psq - 2*s - t) - 2*psq*s*t + 
         mm^2*(-psq^2 + 3*psq*s + psq*t + s*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (I*4^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (2^(1 + 2*d)*(aa - bb)*(gZlL^2 + gZlR^2)*Pi^(2*d)*psq*s*(psq - s - t) - 
     (aa - bb)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(mm^2 + psq)*s*(psq - s - t) - 
     2^(1 + 2*d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*psq*(aa*mm^2*(psq - t) + 
       aa*s*(-2*psq + s + t) + bb*(mm^2 - s)*(-psq + s + t)) - 
     mm^2*(2*Pi)^(2*d)*s*(aa*(2*gZlL*gZlR*(2*psq - s - 2*t) + 
         gZlL^2*(mm^2 - 3*psq + s + 2*t) + gZlR^2*(mm^2 - 3*psq + s + 2*t)) + 
       bb*(gZlL^2*(mm^2 + psq - s - 2*t) + gZlR^2*(mm^2 + psq - s - 2*t) + 
         2*gZlL*gZlR*(-2*psq + s + 2*t))) + (2*Pi)^(2*d)*s*
     ...
     mm^2*(-(bb*(gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq - s)*(psq - s - t) + 
  ...
  (I*4^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(2^(1 + 2*d)*(aa - bb)*(gZlL^2 + gZlR^2)*
      Pi^(2*d)*psq*s*(psq - s - t) - (aa - bb)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
      (mm^2 + psq)*s*(psq - s - t) - 2^(1 + 2*d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*
      psq*(aa*mm^2*(psq - t) + aa*s*(-2*psq + s + t) + 
       bb*(mm^2 - s)*(-psq + s + t)) - mm^2*(2*Pi)^(2*d)*s*
      (aa*(2*gZlL*gZlR*(2*psq - s - 2*t) + gZlL^2*(mm^2 - 3*psq + s + 2*t) + 
         gZlR^2*(mm^2 - 3*psq + s + 2*t)) + 
       bb*(gZlL^2*(mm^2 + psq - s - 2*t) + gZlR^2*(mm^2 + psq - s - 2*t) + 
         2*gZlL*gZlR*(-2*psq + s + 2*t))) + (2*Pi)^(2*d)*s*
      (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
         gZlL^2*(mm^4 + psq*(psq - t) - mm^2*(s + t)) + 
  ...
  (I*4^(-1 - d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
    (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    s*(aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   Pi^(2*d) - (I*EL^5*gAl*ggpgpZ^2*s*((aa + bb)*(gZlL^2 + gZlR^2)*
      (mm^2 - psq)*s - (aa - bb)*(gZlL^2 + gZlR^2)*psq*(-2*psq + s + 2*t) - 
  ...
  (I*4^(-1 - d)*EL^5*gAl*ggpgpZ^2*s*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(mm^4 + psq*(3*psq - s - 3*t) + mm^2*(-2*psq + t)) + 
       gZlR^2*(mm^4 + psq*(3*psq - s - 3*t) + mm^2*(-2*psq + t))) + 
     aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(mm^4 - mm^2*(s + t) + psq*(-3*psq + 2*s + 3*t)) + 
       gZlR^2*(mm^4 - mm^2*(s + t) + psq*(-3*psq + 2*s + 3*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   Pi^(2*d) - (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq + s - 2*t)) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 + 2*psq^2 + 5*psq*s - 2*s^2 - 
         mm^2*(psq + 3*s) - 2*psq*t) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 + 2*psq^2 + 5*psq*s - 2*s^2 - mm^2*(psq + 3*s) - 2*psq*t)) + 
     bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq + s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(3*mm^4 + 2*psq^2 - 3*psq*s + 2*s^2 + 
         mm^2*(-7*psq + s) + 2*psq*t) + gZlR^2*(2*Pi)^(2*d)*
        (3*mm^4 + 2*psq^2 - 3*psq*s + 2*s^2 + mm^2*(-7*psq + s) + 2*psq*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/Pi^(4*d) - 
  (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq + s - 2*t)) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 + 2*psq^2 + 5*psq*s - 2*s^2 - 
         mm^2*(psq + 3*s) - 2*psq*t) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 + 2*psq^2 + 5*psq*s - 2*s^2 - mm^2*(psq + 3*s) - 2*psq*t)) + 
     bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq + s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(3*mm^4 + 2*psq^2 - 3*psq*s + 2*s^2 + 
         mm^2*(-7*psq + s) + 2*psq*t) + gZlR^2*(2*Pi)^(2*d)*
        (3*mm^4 + 2*psq^2 - 3*psq*s + 2*s^2 + mm^2*(-7*psq + s) + 2*psq*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/Pi^(4*d) - 
  (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - 3*s - 2*t)) + 
       gZlL^2*(2*Pi)^(2*d)*(3*mm^4 + 6*psq^2 - 5*psq*s + 2*s^2 + 
         mm^2*(-7*psq + s) - 2*psq*t) + gZlR^2*(2*Pi)^(2*d)*
        (3*mm^4 + 6*psq^2 - 5*psq*s + 2*s^2 + mm^2*(-7*psq + s) - 2*psq*t)) + 
     bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - 3*s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 - 2*psq^2 + 7*psq*s - 2*s^2 - 
         mm^2*(psq + 3*s) + 2*psq*t) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 - 2*psq^2 + 7*psq*s - 2*s^2 - mm^2*(psq + 3*s) + 2*psq*t)))*
    ...
    (aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - 3*s - 2*t)) + 
     ...
     bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - 3*s - 2*t) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 - 2*psq^2 + 7*psq*s - 2*s^2 - 
         mm^2*(psq + 3*s) + 2*psq*t) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 - 2*psq^2 + 7*psq*s - 2*s^2 - mm^2*(psq + 3*s) + 2*psq*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/Pi^(4*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(aa*(8*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (bb*(4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(6*psq^2 - 8*psq*s + s^2 - 6*psq*t + 2*s*t + 
         mm^2*(-2*psq + 4*s + 2*t)) + gZlR^2*(6*psq^2 - 8*psq*s + s^2 - 
         6*psq*t + 2*s*t + mm^2*(-2*psq + 4*s + 2*t))) + 
     aa*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-6*psq^2 + 2*mm^2*(psq + s - t) - s*(s + 2*t) + 
         2*psq*(s + 3*t)) + gZlR^2*(-6*psq^2 + 2*mm^2*(psq + s - t) - 
         s*(s + 2*t) + 2*psq*(s + 3*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (aa*(-4*psq^2 + 2*mm^2*(2*psq + s - 2*t) + 4*psq*t - s*(s + 2*t)) + 
     bb*(4*psq^2 - 4*psq*(2*s + t) + s*(s + 2*t) + 
       mm^2*(-4*psq + 6*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(gZlL^2*(-(s*(psq - 2*t)) + mm^2*(2*psq - s - 2*t)) + 
       gZlR^2*(-(s*(psq - 2*t)) + mm^2*(2*psq - s - 2*t)) + 
       2*gZlL*gZlR*mm^2*(-psq + t)) + bb*(2*gZlL*gZlR*mm^2*(psq - t) + 
       gZlL^2*(2*mm^4 + 2*psq^2 + psq*s - 2*s*t + mm^2*(-6*psq + s + 2*t)) + 
       gZlR^2*(2*mm^4 + 2*psq^2 + psq*s - 2*s*t + mm^2*(-6*psq + s + 2*t))))*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (bb*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(psq - 2*s - t) + 
       gZlL^2*(mm^4 - 2*s*(-3*psq + 2*s + t) + mm^2*(-3*psq + 2*t)) + 
       gZlR^2*(mm^4 - 2*s*(-3*psq + 2*s + t) + mm^2*(-3*psq + 2*t))) + 
     aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - 2*s - t)) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 - mm^2*(psq + 2*t) + 
         2*(psq^2 - 3*psq*s + s*(2*s + t))) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 - mm^2*(psq + 2*t) + 2*(psq^2 - 3*psq*s + s*(2*s + t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/Pi^(4*d) + 
  (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (bb*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(psq - 2*s - t) + 
       gZlL^2*(mm^4 - 2*s*(-3*psq + 2*s + t) + mm^2*(-3*psq + 2*t)) + 
       gZlR^2*(mm^4 - 2*s*(-3*psq + 2*s + t) + mm^2*(-3*psq + 2*t))) + 
  ...
  (I*EL^5*gAl*ggpgpZ^2*(2*(aa + bb)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s - 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(3*psq^2 - 8*psq*s + 2*s^2 - 3*psq*t + 3*s*t + 
         mm^2*(-psq + 4*s + t)) + gZlR^2*(3*psq^2 - 8*psq*s + 2*s^2 - 
         3*psq*t + 3*s*t + mm^2*(-psq + 4*s + t))) + 
     aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-3*psq^2 + mm^2*(psq + s - t) + 3*psq*(s + t) - 
         s*(2*s + 3*t)) + gZlR^2*(-3*psq^2 + mm^2*(psq + s - t) + 
         3*psq*(s + t) - s*(2*s + 3*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - 2*s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(psq - t) + 
       gZlL^2*(-5*psq*s + mm^2*(psq - s - t) + 4*s*(s + t)) + 
       gZlR^2*(-5*psq*s + mm^2*(psq - s - t) + 4*s*(s + t))) + 
     bb*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - t)) + 
       gZlL^2*(2*Pi)^(2*d)*(2*mm^4 + mm^2*(-psq - 6*s + t) - 
         2*(psq^2 - 6*psq*s + 2*s*(s + t))) + gZlR^2*(2*Pi)^(2*d)*
        (2*mm^4 + mm^2*(-psq - 6*s + t) - 2*(psq^2 - 6*psq*s + 
           2*s*(s + t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   Pi^(4*d) + (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq + s - t)) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 + 2*s*(psq - s + t) + 
         mm^2*(psq - 2*(s + t))) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 + 2*s*(psq - s + t) + mm^2*(psq - 2*(s + t)))) + 
     bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq + s - t) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 + 2*(psq^2 - psq*s + s*(s - t)) + 
         mm^2*(-5*psq + 2*(s + t))) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 + 2*(psq^2 - psq*s + s*(s - t)) + mm^2*(-5*psq + 2*(s + t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/Pi^(4*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - 2*s)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (bb*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq + s - t)) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 - 2*psq^2 + 11*psq*s + mm^2*(-4*s + t) - 
         4*s*(s + t)) + gZlR^2*(2*Pi)^(2*d)*(mm^4 - 2*psq^2 + 11*psq*s + 
         mm^2*(-4*s + t) - 4*s*(s + t))) + aa*(2*Pi)^(2*d)*
      (2*gZlL*gZlR*mm^2*(psq + s - t) + gZlL^2*(mm^4 + 4*s*(-psq + s + t) - 
         mm^2*(3*s + t)) + gZlR^2*(mm^4 + 4*s*(-psq + s + t) - 
         mm^2*(3*s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   Pi^(4*d) + (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(-mm^2 + psq)*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(aa*s*(5*psq - 3*s - 5*t) + bb*mm^2*(2*psq + s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(2*gZlL*gZlR*mm^2*(-psq + t) + gZlL^2*s*(3*psq - 2*(s + t)) + 
       gZlR^2*s*(3*psq - 2*(s + t))) + bb*(2*gZlL*gZlR*mm^2*(psq - t) + 
       gZlL^2*(mm^2*(-2*psq + 3*s) + 2*(psq^2 - 3*psq*s + s*(s + t))) + 
       gZlR^2*(mm^2*(-2*psq + 3*s) + 2*(psq^2 - 3*psq*s + s*(s + t)))))*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - 2*s - t) + 
       gZlL^2*(2*Pi)^(2*d)*(mm^4 - 2*psq^2 + 3*psq*s + 
         mm^2*(2*psq - 5*s - t) + 4*s*t) + gZlR^2*(2*Pi)^(2*d)*
        (mm^4 - 2*psq^2 + 3*psq*s + mm^2*(2*psq - 5*s - t) + 4*s*t)) + 
     bb*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(-psq + 2*s + t) + 
       gZlL^2*(mm^4 + 4*s*(psq - t) + mm^2*(-2*psq - 2*s + t)) + 
       gZlR^2*(mm^4 + 4*s*(psq - t) + mm^2*(-2*psq - 2*s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(4*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(-2*psq^2 + mm^2*(2*psq - 3*s) + 7*psq*s - 2*s*(s + 2*t)) + 
       gZlR^2*(-2*psq^2 + mm^2*(2*psq - 3*s) + 7*psq*s - 2*s*(s + 2*t))) + 
     aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-2*psq^2 + mm^2*(2*psq - 3*s) - psq*s + 2*s*(s + 2*t)) + 
       gZlR^2*(-2*psq^2 + mm^2*(2*psq - 3*s) - psq*s + 2*s*(s + 2*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(-mm^2 + psq)*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(psq^2 + 2*mm^2*(psq - t) - psq*(8*s + t) + 
     s*(3*s + 7*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
     ...
     bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(3*psq*(psq - s - t) + mm^2*(-psq + 2*s + t)) + 
       gZlR^2*(3*psq*(psq - s - t) + mm^2*(-psq + 2*s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (-psq^2 + mm^2*(psq - t) + psq*(-s + t) + s*(s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (-(bb*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(-psq + s + t) + 
        gZlL^2*(-3*psq*s + mm^2*(2*psq - s - 2*t) + 2*s*(s + t)) + 
        gZlR^2*(-3*psq*s + mm^2*(2*psq - s - 2*t) + 2*s*(s + t)))) + 
     aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s - t)) + 
       gZlL^2*(2*Pi)^(2*d)*(2*mm^4 + 2*psq^2 - 3*psq*s + 2*s*(s + t) - 
         mm^2*(2*psq + s + 2*t)) + gZlR^2*(2*Pi)^(2*d)*(2*mm^4 + 2*psq^2 - 
         3*psq*s + 2*s*(s + t) - mm^2*(2*psq + s + 2*t))))*\[Mu]^(8 - 2*d)*
    ...
    (-(bb*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(-psq + s + t) + 
     ...
     aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s - t)) + 
       gZlL^2*(2*Pi)^(2*d)*(2*mm^4 + 2*psq^2 - 3*psq*s + 2*s*(s + t) - 
         mm^2*(2*psq + s + 2*t)) + gZlR^2*(2*Pi)^(2*d)*(2*mm^4 + 2*psq^2 - 
         3*psq*s + 2*s*(s + t) - mm^2*(2*psq + s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2]])/Pi^(4*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-3*psq^2 + mm^2*(psq + 3*s - t) + psq*(s + 3*t) - 
         s*(s + 3*t)) + gZlR^2*(-3*psq^2 + mm^2*(psq + 3*s - t) + 
         psq*(s + 3*t) - s*(s + 3*t))) + 
     bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(3*psq^2 - 3*psq*(2*s + t) + mm^2*(-psq + 2*s + t) + 
         s*(s + 3*t)) + gZlR^2*(3*psq^2 - 3*psq*(2*s + t) + 
         mm^2*(-psq + 2*s + t) + s*(s + 3*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl*ggpgpZ^2*
    (-(bb*(2*Pi)^(2*d)*(2*gZlL*gZlR*mm^2*(psq - s - t) + 
        gZlL^2*(-3*psq*s + mm^2*(psq - t) + 4*s*t) + 
        gZlR^2*(-3*psq*s + mm^2*(psq - t) + 4*s*t))) + 
     aa*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - s - t) + 
       gZlL^2*(2*Pi)^(2*d)*(2*mm^4 - 2*psq^2 + 4*psq*s + 
         mm^2*(psq - 7*s - t) + 4*s*t) + gZlR^2*(2*Pi)^(2*d)*
        (2*mm^4 - 2*psq^2 + 4*psq*s + mm^2*(psq - 7*s - t) + 4*s*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/Pi^(4*d) + 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(-mm^2 + psq)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(bb*s*(5*psq - 2*s - 5*t) + 
     aa*mm^2*(2*psq - 3*s - 2*t) + bb*mm^2*(-2*psq + s + 2*t) + 
     aa*s*(-3*psq + 2*s + 5*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(aa*(psq^2 - 2*mm^2*s + 3*s*t - psq*(s + t)) - 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (bb*(gZlL^2*s*(psq - 2*t) + gZlR^2*s*(psq - 2*t) + 
       2*gZlL*gZlR*mm^2*(-psq + s + t)) + 
     aa*(2*gZlL*gZlR*mm^2*(psq - s - t) + 
       gZlL^2*(-2*psq^2 + mm^2*(2*psq - 3*s) + 2*psq*s + 2*s*t) + 
       gZlR^2*(-2*psq^2 + mm^2*(2*psq - 3*s) + 2*psq*s + 2*s*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(-mm^2 + psq)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(psq^2 + 2*mm^2*(psq - s - t) - psq*(7*s + t) + 
     s*(4*s + 7*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*(aa + bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa + bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[q1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    (aa*(-2*mm^2 + s + 2*t) - bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*(-2*psq + s + 2*t)*
  ...
  (I*(aa + bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq + s) + 
     gZlR^2*(mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, p2], SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(2*gZlL*gZlR*mm^2 + 
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*EL^5*gAl*ggpgpZ^2*(bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - psq - 2*t) + 
       gZlR^2*(2*mm^2 - psq - 2*t)) - 
     aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(psq - 2*t) + gZlR^2*(psq - 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl*ggpgpZ^2*
    (bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - psq - 2*t) + 
       gZlR^2*(2*mm^2 - psq - 2*t)) - 
     aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(psq - 2*t) + gZlR^2*(psq - 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q2]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl*ggpgpZ^2*
    (aa*(6*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 - 9*psq + 4*s + 2*t) + 
       gZlR^2*(4*mm^2 - 9*psq + 4*s + 2*t)) - 
     bb*(6*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 7*psq + 4*s + 2*t) + 
       gZlR^2*(2*mm^2 - 7*psq + 4*s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*
    (aa*(6*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 - 9*psq + 4*s + 2*t) + 
     ...
     bb*(6*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 7*psq + 4*s + 2*t) + 
       gZlR^2*(2*mm^2 - 7*psq + 4*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(3*mm^2 - psq - 2*t) + 
     aa*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (bb*(3*mm^2 - psq - 2*t) + aa*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 + 6*psq - 5*s - 8*t) + bb*(6*mm^2 - 14*psq + 5*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
  ...
  (I*EL^5*gAl*ggpgpZ^2*(aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(5*psq - 4*(s + t)) + 
       gZlR^2*(5*psq - 4*(s + t))) + bb*(2*gZlL*gZlR*mm^2 + 
       gZlL^2*(8*mm^2 - 13*psq + 4*(s + t)) + 
       gZlR^2*(8*mm^2 - 13*psq + 4*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*
    (aa*(6*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 3*psq + 2*s - 2*t) + 
       gZlR^2*(2*mm^2 - 3*psq + 2*s - 2*t)) + 
     bb*(-6*gZlL*gZlR*mm^2 + gZlL^2*(-4*mm^2 + 5*psq - 2*s + 2*t) + 
       gZlR^2*(-4*mm^2 + 5*psq - 2*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(-6*gZlL*gZlR*mm^2 + 
       gZlL^2*(2*mm^2 + 5*psq - 4*(s + t)) + 
       gZlR^2*(2*mm^2 + 5*psq - 4*(s + t))) + 
     bb*(6*gZlL*gZlR*mm^2 + gZlL^2*(6*mm^2 - 13*psq + 4*(s + t)) + 
       gZlR^2*(6*mm^2 - 13*psq + 4*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p3, p3]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(mm^2 + 3*psq - 3*s - 4*t) + 
     bb*(5*mm^2 - 9*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(3*psq - 2*(s + t)) + 
       gZlR^2*(3*psq - 2*(s + t))) + bb*(2*gZlL*gZlR*mm^2 + 
       gZlL^2*(4*mm^2 - 7*psq + 2*(s + t)) + 
       gZlR^2*(4*mm^2 - 7*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*
    (aa*(6*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 3*psq + 2*s - 2*t) + 
       gZlR^2*(2*mm^2 - 3*psq + 2*s - 2*t)) + 
     bb*(-6*gZlL*gZlR*mm^2 + gZlL^2*(-4*mm^2 + 5*psq - 2*s + 2*t) + 
       gZlR^2*(-4*mm^2 + 5*psq - 2*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*
    (aa*(6*gZlL*gZlR*mm^2 + gZlL^2*(6*mm^2 - 5*psq - 4*t) + 
       gZlR^2*(6*mm^2 - 5*psq - 4*t)) + 
     bb*(-6*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 3*psq + 4*t) + 
       gZlR^2*(2*mm^2 - 3*psq + 4*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p3, p3]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - 9*psq + 4*s + 8*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (3*aa*(2*psq - s - 2*t) + bb*(2*mm^2 - 8*psq + 3*s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*
    (-(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 5*psq + 2*(s + t)) + 
        gZlR^2*(2*mm^2 - 5*psq + 2*(s + t)))) + 
     bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(-3*psq + 2*(s + t)) + 
       gZlR^2*(-3*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*
    (-(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 5*psq + 2*(s + t)) + 
     ...
     bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(-3*psq + 2*(s + t)) + 
       gZlR^2*(-3*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(mm^2 + psq - 2*(s + t)) + 
     aa*(3*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(mm^2 + psq - 2*(s + t)) + 
     aa*(3*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (aa*(6*mm^2 + 2*psq - 3*s - 8*t) + bb*(2*mm^2 - 10*psq + 3*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
  ...
  (I*EL^5*gAl*ggpgpZ^2*
    (aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(8*mm^2 - 5*psq - 4*t) + 
       gZlR^2*(8*mm^2 - 5*psq - 4*t)) + 
     bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*(-3*psq + 4*t) + gZlR^2*(-3*psq + 4*t)))*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(5*mm^2 - psq - s - 4*t) + 
  ...
  (I*EL^5*gAl*ggpgpZ^2*
    (aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 - 3*psq - 2*t) + 
       gZlR^2*(4*mm^2 - 3*psq - 2*t)) - 
     bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(psq - 2*t) + gZlR^2*(psq - 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(mm^2 - psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[p3, p3]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 + 7*psq - 4*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[p3, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
     3*bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[p3, q2]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) - ((3*I)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) - ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], SP[p3, q2]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*bb*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*bb*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*bb*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*bb*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 3*psq) + 
       gZlR^2*(2*mm^2 - 3*psq)) + aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p1, q1], SP[p3, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(2*psq - s - 2*t) + 
  ...
  (I*bb*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 3*psq) + 
       gZlR^2*(2*mm^2 - 3*psq)) + aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(4*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 3*psq) + 
       gZlR^2*(mm^2 - 3*psq)) + 2*bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(bb*(gZlL - gZlR)^2*mm^2 + 
  ...
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p3, q1]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 3*psq) + 
       gZlR^2*(2*mm^2 - 3*psq)) + bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 - 3*psq) + 
       gZlR^2*(2*mm^2 - 3*psq)) + bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*(aa + bb)*EL^5*gAl*ggpgpZ^2*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 + 4*psq - 3*s - 6*t) + bb*(2*mm^2 - 8*psq + 3*s + 6*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(mm^2 - 2*psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p3, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (2*aa*(mm^2 - s - t) + bb*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], 
     SP[q1, q2]])/(4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(aa*(3*mm^2 - 2*s - 3*t) + 
     bb*(mm^2 - 4*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(mm^2 - 2*psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, p3]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*bb*(-psq + s + t) + 
     aa*(mm^2 + psq - 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[q2, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p3, p3], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], SP[p3, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[p3, q1]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q1], SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, p3]])/(2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(psq - s - t) + 
     ...
     SP[p1, q2], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*ggpgpZ^2*(bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(bb*(4*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 3*psq) + 
       gZlR^2*(mm^2 - 3*psq)) + 2*aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, q2]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(mm^2 + psq - 2*t) + 
     2*bb*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p3, q2]])/(2*Pi)^(2*d) - (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
     gZlR^2*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(mm^2 - s - t) + 
  ...
  (I*EL^5*gAl*ggpgpZ^2*(bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[p2, p3]])/(2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (-2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + 
       gZlR^2*(mm^2 - 2*psq)) + bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(aa*(gZlL - gZlR)^2*mm^2 + 
     bb*(2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 2*psq) + gZlR^2*(mm^2 - 2*psq)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(mm^2 + s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, p3]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - 2*psq + s + t)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(mm^2 - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[q2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
     gZlR^2*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(psq - t) + 
    ...
    ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
   ...
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*
    ggpgpZ^2*(gZlL^2 + gZlR^2)*(psq - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q1]])/Pi^(2*d) + (I*aa*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[p2, q1]])/
   (2*Pi)^(2*d) + (I*aa*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 + psq - s - 3*t) + 
     ...
     SP[q1, q2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q2, q2]])/Pi^(2*d) + 
  (I*aa*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (3*psq - s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], 
     SP[q2, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(psq - t) + 
     ...
     SP[p3, p3]])/(2*Pi)^(2*d) - (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(mm^2 - t) + bb*(-psq + t))*
  ...
  (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
   ...
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*
    ggpgpZ^2*(gZlL^2 + gZlR^2)*(psq - t)*\[Mu]^(8 - 2*d)*
