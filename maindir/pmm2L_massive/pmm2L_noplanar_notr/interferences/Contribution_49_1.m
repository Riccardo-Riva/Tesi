  ...
  ((4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*
   ...
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*
     (2*(-2 + d)*mm^4*s + psq*(4*psq^2 + (-4 + d)*s^2 + 2*psq*(d*s - 4*t) + 
        4*s*t + 4*t^2) + mm^2*(20*psq^2 + (-8 + 5*d)*s^2 + 20*s*t + 20*t^2 - 
        4*psq*((-1 + d)*s + 10*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*
     (-2*psq*(2*psq + (-6 + d)*s - 2*t) + mm^2*(2*psq + (-2 + d)*s - 2*t))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*
     ...
     gHll*gWNl*mm^2*(mm^2*(10*psq + (-12 + d)*s - 10*t) + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*
     (2*psq*(2*psq + 4*s - d*s - 2*t) + mm^2*(-2*psq + d*s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*
     (psq*(2*psq - (-2 + d)*s - 2*t) + mm^2*(-10*psq + (-2 + d)*s + 10*t))*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*
     (4*psq^2 - (-4 + d)*mm^2*s + (-6 + d)*psq*s - 4*s^2 + d*s^2 - 8*psq*t + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 + 2*psq)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 + 2*psq)*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*
     ...
     gHll*gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gHFW*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*(-2*psq + d*s + 2*t)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*
     (-2*psq + (-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gHFW*gHll*gWNl*mm^2*(2*psq + s - 2*t)*
