...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 - q2, mw], 
 ...
 ((2^(-1 - 2*d)*(-2 + d)*EL^5*gFZW^2*gWlN*gWNl*gWWA*s*
    ...
    \[Mu]^(8 - 2*d))/Pi^(2*d) - ((aa - bb)*(-2 + d)*EL^5*gFZW^2*gWlN*gWNl*
    gWWA*(mm^2 + psq)*s*sw^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   (2*Pi)^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^5*gFZW^2*gWlN*gWNl*gWWA*
    (bb*psq*(mm^2 + psq + s) - aa*(psq^2 + mm^2*(psq + s)))*sw^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  ((aa - bb)*(-2 + d)*EL^5*gFZW^2*gWlN*gWNl*gWWA*(mm^2 + psq)*s*sw^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFZW^2*gWlN*gWNl*gWWA*(mm^2 + psq)*
    sw^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/Pi^(2*d) + 
