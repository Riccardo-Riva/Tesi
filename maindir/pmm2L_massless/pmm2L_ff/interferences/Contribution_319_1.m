  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*t*(s + t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*t*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*
     (s*(s + 2*t) + mm^2*(3*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*
     (s^3 + 4*s^2*t + 4*t^3 + s*t*(-mm^2 + 6*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*t*(s^2 + 3*s*t + 2*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*t*(s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(4*mm^2*s + 5*s^2 + 10*s*t + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*t*(s + t)*(mm^2 + s + 2*t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^4*s + s*(s + t)^2 + 
      mm^2*(2*s^2 + 2*s*t - t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
     (s + t)*(mm^2*(s - t) - 2*t*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(s - t)*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^2 - s - 2*t)*t^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(s^2 + 2*s*t + 6*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(-(t^2*(s + 2*t)) + 
      mm^2*(s^2 + 3*s*t + 3*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*
     t*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*t*
     (s^2 + 3*s*t + t*(-mm^2 + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*t*(-2*t*(s + t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*t*(s + t)*(mm^2 + 2*s + 4*t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^2 + s)*(s + 2*t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(s + 4*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(s + t)*
     (mm^2*s - 2*t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*t*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*((s + t)^2 + mm^2*(2*s + t))*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(s + t)*
     ...
     t*(-mm^2 + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(2*mm^2*s + 2*s^2 + 4*s*t + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*t*(-mm^2 + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
     (mm^2 + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(s + 2*t)*
