...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 (((-I)*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*s*
   ...
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*
    (aa*(psq - s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*
    ...
    SPList[SP[p1, q1]])/Pi^(2*d) + (I*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*
    (mm^2 - psq)*(aa*(psq - s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*
    (aa*(psq - 2*s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*s*(-2*psq + s + 2*t)*
  ...
  (I*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(3*aa*(2*psq - s - 2*t) + 
  ...
  (I*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(aa*(4*mm^2 + 2*psq - 3*s - 6*t) + 
     3*bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(3*aa + bb)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*
    mm^4*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
  ...
  (I*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(aa*(psq - t) + 
     bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/
   (2*Pi)^(2*d) - (I*4^(1 - d)*bb*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2 - psq)*
  ...
  (I*EL^5*gAl*gHll*gHXX*gXll^2*mh^2*mm^4*(aa*(psq + s - t) + 
