...
PropList[KiraPropagator[-q1, ml], KiraPropagator[q2, 0], 
  ...
  ((I*2^(-1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*s*
   ...
   (I*2^(-1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
   ...
   ((I/2)*EL^5*gAl^3*((2^(1 - 2*d)*(aa + bb)*(-2 + d)*(gZlL + gZlR)^2*ml^2*
      ...
      (mm^2*(aa*(gZlL^2*((4 - 5*d + d^2)*psq^2 + (12 - 6*d + d^2)*psq*s + 
            ...
            ((8 - 5*d + d^2)*psq^2 + (6 - 6*d + d^2)*psq*s + 
             ...
             (2 - 4*d + d^2)*s*t)) - bb*(gZlL^2*((4 - 5*d + d^2)*psq^2 - 
             (-2 + d)^2*s*t + (-4 + d)*psq*((-2 + d)*s + t - d*t) + 
             mm^2*((4 - 5*d + d^2)*psq + 4*s - (4 - 5*d + d^2)*t)) + 
           gZlR^2*((4 - 5*d + d^2)*psq^2 - (-2 + d)^2*s*t + 
             (-4 + d)*psq*((-2 + d)*s + t - d*t) + mm^2*((4 - 5*d + d^2)*
                psq + 4*s - (4 - 5*d + d^2)*t)) - 2*gZlL*gZlR*
            ((8 - 5*d + d^2)*psq^2 + (10 - 6*d + d^2)*psq*s - 
             (8 - 5*d + d^2)*psq*t - (2 - 4*d + d^2)*s*t + 
             mm^2*((8 - 5*d + d^2)*psq - 4*s - (8 - 5*d + d^2)*t)))))/
       (2*Pi)^(2*d) + 
      (s*(aa*(-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*((8 - 5*d + d^2)*psq^2 + 
   ...
   ((I/2)*EL^5*gAl^3*((2^(1 - 2*d)*(aa + bb)*(-2 + d)*(gZlL + gZlR)^2*ml^2*
      ...
      (mm^2*(bb*(gZlL^2*(-((4 - 5*d + d^2)*psq^2) + (8 - 3*d)*psq*s - 
         ...
         aa*(gZlL^2*((4 - 5*d + d^2)*psq^2 + (-4 + 3*d)*psq*s - 
             ...
             (4 - 5*d + d^2)*psq*t - (-2 + d)^2*s*(s + t) + 
             mm^2*((4 - 5*d + d^2)*psq - (8 - 5*d + d^2)*s - (4 - 5*d + d^2)*
                t)) - 2*gZlL*gZlR*((8 - 5*d + d^2)*psq^2 + (-14 + 3*d)*psq*
              s - (8 - 5*d + d^2)*psq*t - (2 - 4*d + d^2)*s*(s + t) + 
             mm^2*((8 - 5*d + d^2)*psq - (4 - 5*d + d^2)*s - (8 - 5*d + d^2)*
                t)))))/(2*Pi)^(2*d) + 
   ...
   ((I/2)*EL^5*gAl^3*s*((2^(1 - 2*d)*(aa + bb)*(-2 + d)*(gZlL + gZlR)^2*ml^2*
   ...
   (I*EL^5*gAl^3*(aa*(-(2^(1 + 4*d)*gZlL*gZlR*Pi^(4*d)*
          ((8 - 5*d + d^2)*mm^4 + mm^2*((16 - 9*d + d^2)*psq - 
             (16 - 6*d + d^2)*s) + 4*s*(-13*psq + 7*s + 6*t) + 
   ...
   (I*EL^5*gAl^3*(bb*(gZlL^2*(2*Pi)^(4*d)*((12 - 5*d + d^2)*mm^4 - 
          2*(32 - 15*d + d^2)*psq^2 + (116 - 49*d + 3*d^2)*psq*s - 
          2*(20 - 10*d + d^2)*s^2 + mm^2*((-20 + 11*d - 3*d^2)*psq + 
            (54 - 44*d + 9*d^2)*s) - 2*(-3 + d)*d*psq*t + 
          4*(6 - 5*d + d^2)*s*t + (-2 + d)*ml^2*(6*mm^2 - 10*psq + 3*s + 
            4*t)) + gZlR^2*(2*Pi)^(4*d)*((12 - 5*d + d^2)*mm^4 - 
          2*(32 - 15*d + d^2)*psq^2 + (116 - 49*d + 3*d^2)*psq*s - 
          2*(20 - 10*d + d^2)*s^2 + mm^2*((-20 + 11*d - 3*d^2)*psq + 
            (54 - 44*d + 9*d^2)*s) - 2*(-3 + d)*d*psq*t + 
          4*(6 - 5*d + d^2)*s*t + (-2 + d)*ml^2*(6*mm^2 - 10*psq + 3*s + 
            4*t)) + 2*gZlL*gZlR*(4^(1 + 2*d)*Pi^(4*d)*(20*psq^2 - 31*psq*s - 
            2*mm^2*(psq + 6*s) + s*(11*s - 6*t)) + (-2 + d)*ml^2*(2*Pi)^(4*d)*
           (6*mm^2 - 10*psq + 3*s + 4*t) - d^2*(2*Pi)^(4*d)*
           (mm^4 - 2*psq^2 - 3*mm^2*(psq - 3*s) + 3*psq*s - 2*s^2 - 2*psq*t + 
            4*s*t) + d*(2*Pi)^(4*d)*(5*mm^4 - 30*psq^2 - 
            11*mm^2*(psq - 4*s) + psq*(49*s - 6*t) + 20*s*(-s + t)))) + 
      aa*(2^(1 + 4*d)*gZlL*gZlR*Pi^(4*d)*((8 - 5*d + d^2)*mm^4 - 6*d*psq^2 + 
        ...
        gZlL^2*(2*Pi)^(4*d)*(-((4 - 5*d + d^2)*mm^4) + 
         ...
         (-((4 - 5*d + d^2)*mm^4) + mm^2*(-((20 - 9*d + d^2)*psq) + 
          ...
          4*s*(-17*psq + 8*s + 6*t) + d*(6*psq^2 - 41*psq*s + 22*s^2 - 
            6*psq*t + 20*s*t) + d^2*(-2*psq^2 - 4*s*(s + t) + 
            psq*(7*s + 2*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p1, q2]])/(mz^2*(2*Pi)^(6*d)) + 
   (I*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
   ...
   (I*EL^5*gAl^3*(bb*(gZlL^2*(2*Pi)^(4*d)*(-((4 - 5*d + d^2)*mm^4) + 
     ...
     SPList[SP[p1, p2], SP[p2, q1]])/(mz^2*(2*Pi)^(6*d)) + 
   (I*EL^5*gAl^3*(bb*(2^(1 + 4*d)*gZlL*gZlR*Pi^(4*d)*((8 - 5*d + d^2)*mm^4 + 
          6*d*psq^2 - 2*d^2*psq^2 - 4*psq*s - 5*d*psq*s + 3*d^2*psq*s + 
          4*s^2 - 2*d*s^2 + mm^2*((16 - 9*d + d^2)*psq - (16 - 6*d + d^2)*
             s) - 6*d*psq*t + 2*d^2*psq*t - 24*s*t + 20*d*s*t - 4*d^2*s*t + 
   ...
   (I*EL^5*gAl^3*
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(mz^2*(2*Pi)^(6*d)) + 
   ...
   (I*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*(aa*(3*psq - 2*s - 3*t) + 
   ...
   (I*EL^5*gAl^3*(aa*(gZlL^2*(2*Pi)^(6*d)*(-2*(10 - 6*d + d^2)*psq^2 + 
    ...
    (mz^2*(2*Pi)^(8*d)) - 
   (I*EL^5*gAl^3*(aa*(gZlL^2*(2*Pi)^(6*d)*(-20*psq^2 + 12*d*psq^2 - 
          2*d^2*psq^2 + 4*psq*s - 11*d*psq*s + 3*d^2*psq*s - 4*s^2 + 
          8*d*s^2 - 2*d^2*s^2 + (-2 + d)*ml^2*(4*psq - 3*s - 4*t) + 
          20*psq*t - 12*d*psq*t + 2*d^2*psq*t + 4*s*t + 6*d*s*t - 2*d^2*s*t + 
          mm^2*((4 + 3*d - d^2)*psq + (-6 + d)*s + (-4 - 3*d + d^2)*t)) + 
    ...
    (mz^2*(2*Pi)^(8*d)) - (I*(-2 + d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*
   ...
   (I*EL^5*gAl^3*(-(bb*(gZlL^2*((4 - 5*d + d^2)*mm^4*(2*Pi)^(6*d) + 
           ...
           mm^2*(2*Pi)^(6*d)*(-6*(-2 + d)*psq + 2*(-4 + d)*s + 
   ...
   (I*EL^5*gAl^3*(bb*(gZlL^2*(-((4 - 5*d + d^2)*mm^4*(2*Pi)^(6*d)) + 
      ...
      aa*(gZlL^2*((8 - 5*d + d^2)*mm^4*(2*Pi)^(6*d) + 2^(1 + 6*d)*(-2 + d)*
          ...
          mm^2*(2*Pi)^(6*d)*(2*(-4 - 2*d + d^2)*psq - 2*(8 - 9*d + 2*d^2)*s - 
           ...
           ((28 - 15*d + 2*d^2)*psq^2 - psq*((46 - 26*d + 4*d^2)*s + 
              (8 - 6*d + d^2)*t) + s*((8 - 5*d + d^2)*s + (2 - 3*d + d^2)*
               t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/
    (mz^2*(2*Pi)^(8*d)) - 
   ...
   (I*EL^5*gAl^3*(bb*(gZlL^2*(-4*psq^2 + 6*mm^2*s + 4*psq*s - 12*s^2 - 
     ...
     SPList[SP[p1, p3], SP[p3, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   ...
   (I*EL^5*gAl^3*(bb*(2*gZlL*gZlR*(4^(1 + 3*d)*mm^4*Pi^(6*d) - 
          mm^2*(2*Pi)^(6*d)*((8 - 5*d + d^2)*psq - 3*(2 - 5*d + d^2)*s + 
            (4 - 5*d + d^2)*t) + (2*Pi)^(6*d)*(6*(-4 + d)*psq^2 + 
            (68 - 18*d + d^2)*psq*s + (-16 + 3*d)*s^2 - 2*(8 - 6*d + d^2)*psq*
             t + (-4 - 4*d + d^2)*s*t)) + gZlL^2*(4^(1 + 3*d)*mm^4*Pi^(6*d) + 
          mm^2*(2*Pi)^(6*d)*((4 - 5*d + d^2)*psq - 3*(10 - 5*d + d^2)*s + 
            (8 - 5*d + d^2)*t) - (2*Pi)^(6*d)*(6*(-2 + d)*psq^2 + 
        ...
        gZlR^2*((8 - 5*d + d^2)*mm^4*(2*Pi)^(6*d) - mm^2*(2*Pi)^(6*d)*
          ...
          2^(1 + 6*d)*Pi^(6*d)*(3*(-2 + d)*psq^2 + (32 - 14*d + d^2)*psq*s + 
            2*(-3 + d)*s^2 - (10 - 6*d + d^2)*psq*t + (-2 - 3*d + d^2)*s*
             t)) + 2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4*(2*Pi)^(6*d) - 
          mm^2*(2*Pi)^(6*d)*(2*(-8 + d)*psq - 3*(4 - 5*d + d^2)*s + 
            (4 - 3*d + d^2)*t) + 2^(1 + 6*d)*Pi^(6*d)*(3*(-4 + d)*psq^2 + 
   ...
   (I*EL^5*gAl^3*(-(bb*(gZlL^2*(64^d*(4 - 5*d + d^2)*mm^4*Pi^(6*d) - 
           mm^2*(2*Pi)^(6*d)*(4*(-3 + d)*psq + (-18 + 9*d - 2*d^2)*s + 
             (8 - 5*d + d^2)*t) + (2*Pi)^(6*d)*(6*(-2 + d)*psq^2 + 
             (2 - 7*d)*psq*s + (2 + d)*s^2 - 2*(10 - 6*d + d^2)*psq*t + 
             (10 - 4*d + d^2)*s*t)) + gZlR^2*(64^d*(4 - 5*d + d^2)*mm^4*
            Pi^(6*d) - mm^2*(2*Pi)^(6*d)*(4*(-3 + d)*psq + 
             (-18 + 9*d - 2*d^2)*s + (8 - 5*d + d^2)*t) + 
   ...
   (I*EL^5*gAl^3*(-(aa*(gZlL^2*(2*Pi)^(6*d)*(20*psq^2 - 12*d*psq^2 + 
           2*d^2*psq^2 - 14*psq*s + 9*d*psq*s - 2*d^2*psq*s + 6*s^2 - 
           4*d*s^2 + d^2*s^2 + (6 - 5*d + d^2)*mm^2*(psq - t) - 
           (-2 + d)*ml^2*(psq - s - t) - 20*psq*t + 12*d*psq*t - 
           2*d^2*psq*t + 6*s*t - 4*d*s*t + d^2*s*t) + gZlR^2*(2*Pi)^(6*d)*
          (20*psq^2 - 12*d*psq^2 + 2*d^2*psq^2 - 14*psq*s + 9*d*psq*s - 
           2*d^2*psq*s + 6*s^2 - 4*d*s^2 + d^2*s^2 + (6 - 5*d + d^2)*mm^2*
            (psq - t) - (-2 + d)*ml^2*(psq - s - t) - 20*psq*t + 12*d*psq*t - 
           2*d^2*psq*t + 6*s*t - 4*d*s*t + d^2*s*t) + 2^(1 + 6*d)*gZlL*gZlR*
          Pi^(6*d)*(-((6 - 5*d + d^2)*mm^2*(psq - t)) - (-2 + d)*ml^2*
            (psq - s - t) - (-4 + d)*(2*(-2 + d)*psq^2 + d*s*(s + t) + 
             psq*(s - 2*d*s - 2*(-2 + d)*t))))) + 
        ...
        gZlR^2*(2*Pi)^(6*d)*(-12*psq^2 + 6*d*psq^2 + 34*psq*s - 18*d*psq*s + 
         ...
         ((-2 + d)*ml^2*(2*mm^2 - 3*psq + s + t) + 
          mm^2*((2 - 5*d + d^2)*psq - 3*(4 - 5*d + d^2)*s + 
            ...
            2*(-2 + d)*psq*t + s*(3*s + d*t)))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(mz^2*(2*Pi)^(8*d)) - 
   (I*EL^5*gAl^3*(bb*(gZlL^2*((8 - 5*d + d^2)*mm^4*(2*Pi)^(6*d) + 
          2^(1 + 6*d)*(-2 + d)*ml^2*Pi^(6*d)*(mm^2 - 3*psq + s + 2*t) - 
          mm^2*(2*Pi)^(6*d)*(2*(2 + d)*psq - 3*(8 - 5*d + d^2)*s + 
            (-4 - 3*d + d^2)*t) + 2^(1 + 6*d)*Pi^(6*d)*(3*(-2 + d)*psq^2 + 
   ...
   (I*EL^5*gAl^3*(bb*(2*gZlL*gZlR*((-2 + d)*ml^2*(2*Pi)^(6*d)*
           (2*mm^2 - 4*psq + s + 2*t) - 2^(1 + 6*d)*mm^2*Pi^(6*d)*
   ...
   (I*2^(-1 - 4*d)*EL^5*gAl^3*
     ...
     ml^2*(aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*
   ...
   (I*EL^5*gAl^3*(-(bb*(gZlL^2*(2*Pi)^(6*d)*(-20*psq^2 + 12*d*psq^2 - 
   ...
   (I*EL^5*gAl^3*(bb*(gZlL^2*(-4*psq^2 + 2*mm^2*s + 8*psq*s - 8*s^2 - 
          (-2 + d)*ml^2*(2*psq - s - 2*t) + 4*psq*t + 4*s*t + 
      ...
      aa*(2*gZlL*gZlR*((-2 + d)*ml^2*(2*psq - s - 2*t) + 
          ...
          d^2*(-psq^2 + mm^2*(psq + s - t) - 2*s*(s + t) + psq*(2*s + t)) + 
          d*(psq^2 - 3*mm^2*(psq + 2*s - t) - psq*(7*s + t) + 
            s*(11*s + 7*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
   ...
   (I*EL^5*gAl^3*(bb*(2^(1 + 6*d)*gZlL*gZlR*Pi^(6*d)*
         (2*(8 - 6*d + d^2)*psq^2 + (-4 - 4*d + d^2)*s*t - 
          psq*((8 - 11*d + 2*d^2)*s + 2*(8 - 6*d + d^2)*t) + 
          mm^2*((4 - 5*d + d^2)*psq - (6 - 5*d + d^2)*s - (4 - 5*d + d^2)*
             t)) + gZlL^2*(2*Pi)^(6*d)*(-2*(10 - 6*d + d^2)*psq^2 + 
          (22 - 11*d + 2*d^2)*psq*s + 2*(10 - 6*d + d^2)*psq*t - 
          (10 - 4*d + d^2)*s*t + mm^2*(-((8 - 5*d + d^2)*psq) + 
            (6 - 5*d + d^2)*s + (8 - 5*d + d^2)*t)) + gZlR^2*(2*Pi)^(6*d)*
   ...
   (I*EL^5*gAl^3*(bb*(gZlL^2*(2*Pi)^(6*d)*(20*psq^2 - 12*d*psq^2 + 
          2*d^2*psq^2 - 18*psq*s + 11*d*psq*s - 2*d^2*psq*s - 
          (-2 + d)*ml^2*(psq - t) + (6 - 5*d + d^2)*mm^2*(psq - s - t) - 
          20*psq*t + 12*d*psq*t - 2*d^2*psq*t + 6*s*t - 4*d*s*t + d^2*s*t) + 
        gZlR^2*(2*Pi)^(6*d)*(20*psq^2 - 12*d*psq^2 + 2*d^2*psq^2 - 18*psq*s + 
          11*d*psq*s - 2*d^2*psq*s - (-2 + d)*ml^2*(psq - t) + 
          (6 - 5*d + d^2)*mm^2*(psq - s - t) - 20*psq*t + 12*d*psq*t - 
          2*d^2*psq*t + 6*s*t - 4*d*s*t + d^2*s*t) + 2^(1 + 6*d)*gZlL*gZlR*
         Pi^(6*d)*(-((-2 + d)*ml^2*(psq - t)) - (6 - 5*d + d^2)*mm^2*
           (psq - s - t) - (-4 + d)*(2*(-2 + d)*psq^2 + (3 - 2*d)*psq*s - 
            2*(-2 + d)*psq*t + d*s*t))) + 
      aa*(gZlL^2*(2*Pi)^(6*d)*(-52*psq^2 + 30*d*psq^2 - 4*d^2*psq^2 + 
          66*psq*s - 38*d*psq*s + 5*d^2*psq*s - 12*s^2 + 7*d*s^2 - d^2*s^2 + 
          (-2 + d)*ml^2*(2*mm^2 - psq - t) + 20*psq*t - 12*d*psq*t + 
          2*d^2*psq*t - 6*s*t + 4*d*s*t - d^2*s*t + 
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(mz^2*(2*Pi)^(8*d)) - 
   (I*2^(-1 - 4*d)*EL^5*gAl^3*((aa + bb)*(-4 + d)*(gZlL + gZlR)^2*
       (2*Pi)^(2*d)*(mm^2 - psq)*s - 2^(1 + 2*d)*(aa - bb)*
       ((-4 + d)*gZlL^2 - 2*(-2 + d)*gZlL*gZlR + (-4 + d)*gZlR^2)*Pi^(2*d)*
       psq*(2*psq - s - 2*t) - (2*Pi)^(2*d)*s*
     ...
     (bb*(-2*gZlL*gZlR*((6 - 5*d + d^2)*mm^2 + (32 - 25*d + 5*d^2)*psq - 
      ...
      aa*(gZlL^2*((-46 + 35*d - 7*d^2)*mm^2 + (-180 + 107*d - 15*d^2)*psq + 
        ...
        2*gZlL*gZlR*((38 - 35*d + 7*d^2)*mm^2 + (192 - 107*d + 15*d^2)*psq - 
          2*((22 - 13*d + 2*d^2)*s + (10 - 9*d + 2*d^2)*t))))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     (-(bb*(gZlL^2*((6 - 5*d + d^2)*mm^2 + (28 - 17*d + 3*d^2)*psq - 
         ...
         2*gZlL*gZlR*((6 - 5*d + d^2)*mm^2 + (-4 + d)*((-5 + 3*d)*psq - 
             2*(-1 + d)*t)))) + 
      aa*(gZlL^2*((38 - 25*d + 5*d^2)*mm^2 + (92 - 53*d + 7*d^2)*psq - 
          2*(8 - 5*d + d^2)*t) + gZlR^2*((38 - 25*d + 5*d^2)*mm^2 + 
          (92 - 53*d + 7*d^2)*psq - 2*(8 - 5*d + d^2)*t) - 
        2*gZlL*gZlR*((22 - 25*d + 5*d^2)*mm^2 + (-4 + d)*((-25 + 7*d)*psq - 
            2*(-1 + d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     ...
     (aa*(gZlL^2*((6 - 5*d + d^2)*mm^2 - (-2 + d)*psq + (10 - 6*d + d^2)*
      ...
      bb*(gZlL^2*(2*(7 - 5*d + d^2)*mm^2 + 3*(14 - 8*d + d^2)*psq + 
        ...
        2*gZlL*gZlR*(2*(5 - 5*d + d^2)*mm^2 + (-4 + d)*(3*(-4 + d)*psq + 
            (-2 + d)*(s + t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     (bb*(gZlL^2*((6 - 5*d + d^2)*mm^2 + (22 - 13*d + 2*d^2)*psq - 
        ...
        gZlR^2*(-2*(7 - 5*d + d^2)*mm^2 + (-62 + 36*d - 5*d^2)*psq + 
          (10 - 6*d + d^2)*t) + 2*gZlL*gZlR*(2*(5 - 5*d + d^2)*mm^2 + 
          (-4 + d)*((-16 + 5*d)*psq - (-2 + d)*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
   (I*EL^5*gAl^3*(aa*(-2*gZlL*gZlR*((4 - 5*d + d^2)*mm^2 + 
          2*(11 - 6*d + d^2)*psq - 20*s + 12*d*s - 2*d^2*s - 2*t + 3*d*t - 
          d^2*t) + gZlL^2*((8 - 5*d + d^2)*mm^2 + 2*(7 - 6*d + d^2)*psq - 
          16*s + 12*d*s - 2*d^2*s + 2*t + 3*d*t - d^2*t) + 
    ...
    (mz^2*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl^3*
     (aa*(gZlL^2*((6 - 5*d + d^2)*mm^2 - (-2 + d)*psq + (10 - 6*d + d^2)*
      ...
      bb*(gZlL^2*(2*(7 - 5*d + d^2)*mm^2 + 3*(14 - 8*d + d^2)*psq + 
          ...
          3*(14 - 8*d + d^2)*psq + (10 - 6*d + d^2)*(s + t)) - 
        2*gZlL*gZlR*(2*(5 - 5*d + d^2)*mm^2 + (-4 + d)*(3*(-4 + d)*psq + 
            (-2 + d)*(s + t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p1, q2], SP[p2, p3]])/(mz^2*Pi^(2*d)) - 
   (I*2^(1 - 2*d)*(-3 + d)*EL^5*gAl^3*(gZlL - gZlR)^2*
     (-(bb*((-2 + d)*mm^2 + (-4 + d)*psq)) + 
   ...
   (I*EL^5*gAl^3*(aa*(-2*gZlL*gZlR*((8 - 5*d + d^2)*mm^2 + 2*(-3 + d)^2*psq - 
    ...
    (mz^2*(2*Pi)^(2*d)) + (I*2^(1 - 2*d)*(-3 + d)*EL^5*gAl^3*(gZlL - gZlR)^2*
     (bb*((-2 + d)*mm^2 + (-4 + d)*psq) - 
      aa*((-2 + d)*mm^2 + (-4 + d)*(psq + 2*s)))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*aa*(12 - 7*d + d^2)*EL^5*gAl^3*(gZlL - gZlR)^2*
    ...
    (mz^2*Pi^(2*d))) + PropList[KiraPropagator[-q1, ml], 
