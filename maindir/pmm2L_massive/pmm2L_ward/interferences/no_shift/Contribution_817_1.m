...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  ((I*EL^5*gFFA*gFll^4*mm^4*psq*s*(bb*(psq - s - t) + 
   ...
   (I*EL^5*gFFA*gFll^4*mm^4*s*(-(aa*psq*s) - bb*psq*s + 2*aa*mm^2*(psq - t) + 
      2*bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*s*
   ...
   (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*psq*(bb*(2*mm^2 - psq - t) + 
   ...
   (I*4^(1 - d)*EL^5*gFFA*gFll^4*mm^4*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll^4*mm^4*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^4*mm^4*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gFFA*gFll^4*mm^4*
