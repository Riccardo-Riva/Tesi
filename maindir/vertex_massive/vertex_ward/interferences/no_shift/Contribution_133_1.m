...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((4^(1 - d)*EL^5*gFFA*gFFZ^2*s*(bb*(gZlL^2*(psq^2 + mm^2*(psq - s)) + 
   ...
   (4^(1 - d)*EL^5*gFFA*gFFZ^2*(bb*(gZlL - gZlR)^2*mm^2 - 
   ...
   (4^(1 - d)*EL^5*gFFA*gFFZ^2*s*(bb*(gZlL^2*psq*(2*mm^2 + 2*psq - s) + 
   ...
   (2^(3 - 2*d)*EL^5*gFFA*gFFZ^2*(bb*(gZlL^2*(psq^2 + mm^2*(psq - 3*s)) + 
        gZlR^2*(psq^2 + mm^2*(psq - 3*s)) + 2*gZlL*gZlR*mm^2*(-2*psq + s)) - 
      aa*(gZlL^2*psq*(mm^2 + psq - 3*s) + gZlR^2*psq*(mm^2 + psq - 3*s) + 
        2*gZlL*gZlR*mm^2*(-2*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gFFA*gFFZ^2*(bb*(gZlL^2*(psq^2 + mm^2*(psq - 5*s)) + 
        gZlR^2*(psq^2 + mm^2*(psq - 5*s)) + 2*gZlL*gZlR*mm^2*(-2*psq + s)) - 
      aa*(gZlL^2*psq*(mm^2 + psq - 5*s) + gZlR^2*psq*(mm^2 + psq - 5*s) + 
        2*gZlL*gZlR*mm^2*(-2*psq + s)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^5*gFFA*gFFZ^2*(bb*(4*gZlL*gZlR*mm^2*(-4*psq + s) + 
        gZlL^2*(psq*(4*psq - 3*s) + mm^2*(4*psq + 5*s)) + 
        gZlR^2*(psq*(4*psq - 3*s) + mm^2*(4*psq + 5*s))) - 
      aa*(4*gZlL*gZlR*mm^2*(-4*psq + s) + gZlL^2*(mm^2*(4*psq - 3*s) + 
          psq*(4*psq + 5*s)) + gZlR^2*(mm^2*(4*psq - 3*s) + 
          psq*(4*psq + 5*s))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gFFA*gFFZ^2*
