...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    ((I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*gWWA*mm^2*s*
     ...
     (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*gWWA*mm^2*s*
      ...
      (mh^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gHll*
       gHWW*gWWA*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
       SPList[SP[q1, q1]])/(mh^2*Pi^(2*d)) - 
     (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*gWWA*mm^2*s*
      ...
      (mh^2*Pi^(2*d)) - (I*2^(3 - 2*d)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*gWWA*
     ...
     (I*2^(3 - 2*d)*(aa + bb)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*gWWA*mm^2*
      ...
      (mh^2*Pi^(2*d)) - (I*2^(3 - 2*d)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*gWWA*
       mm^2*(bb*(2*mm^2 - psq + s - t) - aa*(psq + s - t))*\[Mu]^(8 - 2*d)*
     ...
     (I*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*gWWA*mm^2*
      ...
      (mh^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gHll*
       gHWW*gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[q1, q2]])/(mh^2*Pi^(2*d)) - 
     (I*2^(3 - 2*d)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*gWWA*mm^2*
     ...
     (I*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*gWWA*mm^2*
      ...
      (mh^2*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl^2*gHll*gHWW*
       gWWA*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
        SP[q1, q1]])/(mh^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*(-1 + d)*EL^5*
       gAl^2*gHll*gHWW*gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
