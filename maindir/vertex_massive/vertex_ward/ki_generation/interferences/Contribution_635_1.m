...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-(((-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^4*s*(-2*bb*mm^2*(psq - s) - 
      3*bb*psq*s + aa*psq*(2*mm^2 + s))*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
  ...
  (2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*s*
    ...
    gXll^2*mm^2*s*(aa*(mm^4 + mm^2*(7*psq - s) - psq*s) + 
  ...
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
    (2*bb*mm^4 + aa*mm^2*(10*psq - s) - 3*aa*psq*s - bb*psq*s + 
     bb*mm^2*(-12*psq + 5*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
  ...
  (2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*
    (3*aa*mm^2*(4*psq - s) + aa*psq*s + bb*psq*s + bb*mm^2*(-12*psq + s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
  ((-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(aa*(mm^2*(8*psq - s) - 3*psq*s) - 
  ...
  ((2 - d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*(aa*psq*(2*mm^2 - s) - 
     bb*(2*mm^2*(psq - s) + psq*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  ((aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gXll^2*mm^2*psq*s*\[Mu]^(8 - 2*d)*
