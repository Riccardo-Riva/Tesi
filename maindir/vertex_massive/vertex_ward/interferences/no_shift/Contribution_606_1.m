...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((4^(1 - d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWA^2*mm^2*s*
     ((-7 + 4*d)*psq + s - d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    ...
    Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gWWA^2*
     ...
     SPList[SP[q2, q2]])/Pi^(2*d) + (4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWA^2*
   ...
   (4^(1 - d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(aa*(-3 + 2*d)*mm^2*(4*psq - s) - 
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(-(bb*(3*mm^2 + psq)) + 
    ...
    Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gWWA^2*
     ...
     (bb*(7 - 4*d)*mm^2 + aa*(-5 + 3*d)*mm^2 + 3*aa*(-2 + d)*psq - 
