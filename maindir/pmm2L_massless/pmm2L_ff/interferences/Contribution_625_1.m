...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(3*mm^2 - 2*s)*t*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*t*(-4*(s + t)^2 + 
      mm^2*(2*s + (2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*t*(d*(s - 2*t) + 8*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*t*(-4*s*(s + t) + 
      mm^2*((2 + d)*s + (6 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^4*t*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*t*(-4*s*(s + t) + 
      (2 + d)*mm^2*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*t*
     (-2*(s + t)^2 + mm^2*(s + d*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*t*(-4*(s + t)^2 + 
      mm^2*(2*s + (2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*s - (-6 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2*s*(2*s + (2 + d)*t) - 
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*t*((-2 + d)*mm^2 - 
      (-6 + d)*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
