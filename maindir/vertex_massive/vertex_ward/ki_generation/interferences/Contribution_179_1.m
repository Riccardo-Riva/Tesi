...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
    (aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 + psq) + gZlR^2*(2*mm^2 + psq)) - 
     bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 + 2*psq) + gZlR^2*(mm^2 + 2*psq)))*
    s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
    (aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 + psq) + gZlR^2*(2*mm^2 + psq)) - 
     bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 + 2*psq) + gZlR^2*(mm^2 + 2*psq)))*
    s^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  ((aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  ((aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  (2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
    ...
    SPList[SP[q1, q1]])/Pi^(2*d) + (2^(-1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
  ...
  ((aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s*
  ...
  (EL^5*ggmgmA*ggmgmZ^2*(aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 + psq) + 
       gZlR^2*(4*mm^2 + psq)) - bb*(-2*gZlL*gZlR*mm^2 + 
       gZlL^2*(mm^2 + 4*psq) + gZlR^2*(mm^2 + 4*psq)))*s*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*ggmgmA*ggmgmZ^2*(-(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(4*mm^2 + 3*psq) + 
        gZlR^2*(4*mm^2 + 3*psq))) + bb*(2*gZlL*gZlR*mm^2 + 
       gZlL^2*(3*mm^2 + 4*psq) + gZlR^2*(3*mm^2 + 4*psq)))*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (EL^5*ggmgmA*ggmgmZ^2*(bb*(2*gZlL*gZlR*mm^2*(-4*psq + s) + 
       gZlL^2*psq*(2*mm^2 + 2*psq + s) + gZlR^2*psq*(2*mm^2 + 2*psq + s)) - 
     aa*(2*gZlL*gZlR*mm^2*(-4*psq + s) + 
       gZlL^2*(2*psq^2 + mm^2*(2*psq + s)) + 
       gZlR^2*(2*psq^2 + mm^2*(2*psq + s))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (EL^5*ggmgmA*ggmgmZ^2*(-(aa*(2*gZlL*gZlR*mm^2*(-4*psq + s) + 
        gZlL^2*(psq*(2*psq + s) + 2*mm^2*(psq + 2*s)) + 
        gZlR^2*(psq*(2*psq + s) + 2*mm^2*(psq + 2*s)))) + 
     bb*(2*gZlL*gZlR*mm^2*(-4*psq + s) + gZlL^2*(mm^2*(2*psq + s) + 
         2*psq*(psq + 2*s)) + gZlR^2*(mm^2*(2*psq + s) + 2*psq*(psq + 2*s))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 + psq) - 
     bb*(mm^2 + 2*psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) + (EL^5*ggmgmA*ggmgmZ^2*
    (-(aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(2*mm^2 + psq) + 
        gZlR^2*(2*mm^2 + psq))) + bb*(-2*gZlL*gZlR*mm^2 + 
       gZlL^2*(mm^2 + 2*psq) + gZlR^2*(mm^2 + 2*psq)))*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(aa*mm^2 - bb*psq)*s*
  ...
  (4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*
