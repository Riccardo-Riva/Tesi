...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 2*d)*d*EL^5*gAl*gFll^2*gZlR*gZNL*mm^4*s*
    ...
    (-(aa*psq*(2*gZlL*mm^2*s - d*gZlL*mm^2*s + 2*gZlR*(mm^2 - s)*s + 
   ...
   (2*Pi)^(2*d) + (EL^5*gAl*gFll^2*gZNL*mm^4*
    (2*bb*s*(gZlR*mm^2 + 3*gZlL*psq - gZlL*s) + 
     2*aa*s*(-(gZlR*psq) + gZlL*(-3*psq + s)) - 
     aa*d*(gZlR*psq*(psq - s) + gZlL*s*(-3*psq + s) + gZlR*mm^2*(psq + s)) + 
     bb*d*(gZlR*mm^2*(psq - s) + gZlL*s*(-3*psq + s) + gZlR*psq*(psq + s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*gFll^2*gZNL*mm^2*(aa*psq*(-2*(-2 + d)*gZlL*mm^2 - 
       (-4 + d)*gZlR*(mm^2 - s)) + bb*mm^2*(2*(-2 + d)*gZlL*psq + 
   ...
   (2*Pi)^(2*d) + (2^(-1 - 2*d)*EL^5*gAl*gFll^2*gZNL*mm^2*s*
    (-(aa*(-2 + d)*gZlL*mm^2*(4*psq - s)) + bb*(-2 + d)*gZlL*mm^2*
      (4*psq - s) + aa*gZlR*((-4 + d)*mm^4 + 2*psq*(d*psq - 2*s) + 
       mm^2*((4 + d)*psq - (-4 + d)*s)) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZNL*mm^2*
    (aa*psq*((-2 + d)*gZlL*mm^2 - d*gZlR*(mm^2 + psq) + 2*gZlR*s) + 
     bb*(-((-2 + d)*gZlL*mm^2*psq) + d*gZlR*psq*(mm^2 + psq) - 
       2*gZlR*mm^2*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
   Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZNL*mm^2*
    (aa*mm^2*(2*gZlR*mm^2 - (-2 + d)*gZlL*(3*psq - s) + (-2 + d)*gZlR*s) + 
     bb*((-2 + d)*gZlL*mm^2*(3*psq - s) - gZlR*psq*(2*mm^2 + (-2 + d)*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZNL*mm^2*
    (aa*psq*(2*(-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*s) + 
     bb*mm^2*(-2*(-2 + d)*gZlL*psq + (-4 + d)*gZlR*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
  (EL^5*gAl*gFll^2*gZNL*mm^2*(bb*(d*gZlL*mm^2*(-4*psq + 3*s) + 
  ...
  (EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(-(aa*d*psq*(mm^2 + psq)) + 
     bb*d*psq*(mm^2 + psq) - 2*bb*mm^2*s + 2*aa*psq*s)*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl*gFll^2*gZNL*mm^2*(aa*mm^2*((-2 + d)*gZlL*(4*psq - s) - 
       (-4 + d)*gZlR*s) + bb*(-((-2 + d)*gZlL*mm^2*(4*psq - s)) + 
  ...
  (EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(aa*psq*(d*(mm^2 + psq - s) + 2*s) - 
     bb*(d*(psq^2 + mm^2*(psq - s)) + 2*mm^2*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(2*Pi)^(2*d) - 
  (4^(1 - d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
  ((-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*mm^2 - aa*psq)*s*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(aa*mm^2 - bb*psq)*
  ...
  (2^(1 - 2*d)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(aa*mm^2 - bb*psq)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  (2^(3 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(aa*mm^2 - bb*psq)*
  ...
  (4^(1 - d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(aa*mm^2 - bb*psq)*
