...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p2 + q1, 0], 
  ...
  (-((EL^6*gAl^2*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*(4*psq + (-2 + d)*s)*
      \[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) + 
   (2^(1 - 2*d)*EL^6*gAl^2*gFFAA*gFFZ*(gZlL + gZlR)*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*d*EL^6*gAl^2*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(-3 + d)*EL^6*gAl^2*gFFAA*
     gFFZ*(gZlL + gZlR)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl^2*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*
