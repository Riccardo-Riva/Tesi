...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   (-((4^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(-4*(gZlL^2 + gZlR^2)*s*
        (mm^2 - psq + s) + d*(gZlL^2*s*(2*mm^2 - 2*psq + s) + 
         gZlR^2*s*(2*mm^2 - 2*psq + s) - 4*gZlL*gZlR*(psq^2 + mm^2*s + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(2*psq*s - d*psq*s + 
      ...
      mm^2*(mm^2 - psq)*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q1]])/(Pi^(2*d)*s) - (4^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*
    ...
    (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
      ...
      mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*((10 - 3*d)*psq^2 + 
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) + (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(2*mm^2 - 3*psq + s + t)*
      ...
      mm^2*(4*psq^2 + 2*t*(s + 2*t) - psq*((-4 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
    (2^(3 - 2*d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(psq - t)^2*
