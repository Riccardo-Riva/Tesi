...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  ((4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*
     (4*psq^2 - 8*psq*t + (s + 2*t)^2)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*
     (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(-2*psq + s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*
     (-2*psq + 3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(-psq + s + t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(2*psq + s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*(psq - t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFAW*gFFA^2*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
