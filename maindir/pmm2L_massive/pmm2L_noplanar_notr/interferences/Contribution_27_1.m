...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*(mm^2 + psq)*
     ...
     (Pi^(2*d)*s^2)) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*
     mm^4*(mm^2 - psq)*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*(mm^2 + 3*psq)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*(mm^2 - psq)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*
     gHll*mh^2*mm^4*(2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*(-psq + s + t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*
     (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*
     gHll*mh^2*mm^4*(2*psq - (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gHFF*gHll*mh^2*mm^4*(2*psq + s - 2*t)*
