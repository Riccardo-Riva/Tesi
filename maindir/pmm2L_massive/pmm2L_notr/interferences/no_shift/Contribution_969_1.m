...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gZlL*gZlR*ml^2*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gZlL*gZlR*ml^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gZlL*gZlR*ml^2*(18*(gZlL^2 + gZlR^2)*s + 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*
     ...
     gZlL*gZlR*(gZlL^2 + gZlR^2)*ml^2*(2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*(gZlL^2 + gZlR^2)^2*(2*mm^2 - 4*psq - 2*s + 
    ...
    (Pi^(2*d)*s) - (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gZlL*gZlR*
     (gZlL^2 + gZlR^2)*ml^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
