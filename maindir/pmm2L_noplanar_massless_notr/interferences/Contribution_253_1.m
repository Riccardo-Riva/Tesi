...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((-2 + d)*s^2 + 2*s*t + 
     2*t^2))/Pi^(2*d) + (2^(3 - 2*d)*(-3 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*
    gZlL^2*s*SPList[SP[p1, p2]])/Pi^(2*d) - 
  (2^(3 - 2*d)*(-3 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*s*
    SPList[SP[p1, p3]])/Pi^(2*d) + (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*
    gZlL^2*((-2 + d)*s^2 - 6*s*t - 4*t^2)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((-3 + d)*s - t)*
    SPList[SP[p1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*(-3 + d)*EL^8*gAl*gAu^2*gWlN*
    gWNl*gWWA*gZlL^2*s*SPList[SP[p2, p3]])/Pi^(2*d) + 
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((-2 + d)*s + t)*
    SPList[SP[p2, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*
    gZlL^2*((-7 + 3*d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[p3, q1]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*(-3 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    s*SPList[SP[p3, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((2 - 3*d + d^2)*s^2 + 2*(2 + d)*s*t + 2*(2 + d)*t^2)*SPList[SP[q1, q1]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((-3 + d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*s*
    SPList[SP[q2, q2]])/Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*
    gWNl*gWWA*gZlL^2*SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) + 
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((-4 + d)*s^2 + 4*s*t + 8*t^2)*SPList[SP[p1, p2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((18 - 7*d + d^2)*s^2 + 
     2*d*s*t + 2*(-2 + d)*t^2)*SPList[SP[p1, q1], SP[p1, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((-2 + 3*d)*s^2 + 12*s*t + 8*t^2)*SPList[SP[p1, q1], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((-6 + d)*s - 4*t)*SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((18 - 8*d + d^2)*s^2 + 2*(-2 + d)*s*t + 2*(-2 + d)*t^2)*
    SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*(3*(-2 + d)*s^2 + 12*s*t + 
     8*t^2)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((4 - 8*d + d^2)*s - 8*(-4 + d)*t)*SPList[SP[p1, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((-6 + d)*s - 4*t)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((52 - 24*d + 3*d^2)*s - 
     4*(-6 + d)*t)*SPList[SP[p1, q1], SP[q1, q1]])/((2*Pi)^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((64 - 26*d + 3*d^2)*s - 4*(-6 + d)*t)*SPList[SP[p1, q1], SP[q1, q2]])/
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((-10 + 3*d)*s^2 + 4*s*t + 
     8*t^2)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((20 - 8*d + d^2)*s - (-6 + d)*t)*SPList[SP[p1, q2], SP[q1, q1]])/
   (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((14 - 7*d + d^2)*s^2 + 
     2*(-4 + d)*s*t + 2*(-2 + d)*t^2)*SPList[SP[p2, q1], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    (3*(-2 + d)*s^2 + 4*s*t + 8*t^2)*SPList[SP[p2, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((-28 + d^2)*s + 8*(-4 + d)*t)*SPList[SP[p2, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((-2 + d)*s + 4*t)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((28 - 20*d + 3*d^2)*s + 
     4*(-6 + d)*t)*SPList[SP[p2, q1], SP[q1, q1]])/((2*Pi)^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((40 - 22*d + 3*d^2)*s + 4*(-6 + d)*t)*SPList[SP[p2, q1], SP[q1, q2]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*t*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    ((14 - 7*d + d^2)*s + (-6 + d)*t)*SPList[SP[p2, q2], SP[q1, q1]])/
   (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (2^(5 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (4^(2 - d)*(-6 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*(24 - 10*d + d^2)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (4^(2 - d)*(-6 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*t*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (2^(3 - 2*d)*(18 - 9*d + d^2)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((40 - 22*d + 3*d^2)*s + 
     (-2 + d)^2*t)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*
    gZlL^2*(s + t)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*
    gZlL^2*(s + t)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*(30 - 11*d + d^2)*EL^8*gAl*gAu^2*gWlN*gWNl*
    gWWA*gZlL^2*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q1]])/(Pi^(2*d)*s) - 
  (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*((56 - 18*d + d^2)*s - 
     (-2 + d)^2*t)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*(s + t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*(2*(30 - 11*d + d^2)*s + 
     (-2 + d)^2*t)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*t*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*(2*(18 - 9*d + d^2)*s - 
     (-2 + d)^2*t)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*
    gZlL^2*t*SPList[SP[p2, q1], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl*gAu^2*gWlN*gWNl*gWWA*gZlL^2*t*
