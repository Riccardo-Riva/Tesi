...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl*gHll^2*gHXZ^2*mm^4*psq*s*(bb*(mm^2 + 3*psq - s) + 
      aa*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*psq*(-4*bb*mm^2*psq + 
      aa*mm^2*(4*psq - s) + aa*psq*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*s*
     (bb*(mm^4 - psq^2 + mm^2*(2*psq - s)) + 
      aa*(mm^4 + psq^2 + mm^2*(-4*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (4^(1 - d)*EL^5*gAl*gHll^2*gHXZ^2*mm^4*s*
     (bb*(mm^2 + 3*psq - s) + aa*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*
     s*(bb*(mm^4 + psq^2 + mm^2*(2*psq - s)) + 
      aa*(mm^4 + psq^2 + mm^2*(-6*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gHll^2*gHXZ^2*mm^4*s*
     (bb*(mm^2 + 3*psq - s) + aa*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll^2*gHXZ^2*mm^4*
     s*(bb*(mm^2 + 3*psq - s) + aa*(mm^2 - 5*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[q2, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*
     psq*(bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*
     (bb*(3*mm^2 - psq)*psq + aa*psq*(psq - s) + aa*mm^2*(-3*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*(-4*bb*mm^2*psq + 
      aa*mm^2*(4*psq - s) + aa*psq*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*(-4*bb*mm^2*psq + 
      aa*mm^2*(4*psq - s) + aa*psq*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*(4*bb*mm^2*psq - aa*psq*s + 
   ...
   (2^(3 - 2*d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*(bb*mm^2 - aa*psq)*s*
   ...
   (2^(3 - 2*d)*EL^5*gAl*gHll^2*gHXZ^2*mm^2*(bb*mm^2 - aa*psq)*
