...
PropList[KiraPropagator[p1 - q1, ml], KiraPropagator[-p2 - q1, ml]]*
 (((-I)*EL^6*gAl^3*gAu*ml^2*
  ...
  (I*EL^6*gAl^3*gAu*(-(gZlRC*gZuLC*((-4 + d)^2*s^2 + 2*(10 - 7*d + d^2)*s*t - 
       ...
       4*t^2))*SPList[SP[q1, q1]])/((2*Pi)^d*(mzC^2 - s)*s^2) - 
  ...
  (I*2^(3 - d)*EL^6*gAl^3*gAu*((-2 + d)*gZlLC*gZuLC - (-4 + d)*gZlRC*gZuLC - 
     (-4 + d)*gZlLC*gZuRC + (-2 + d)*gZlRC*gZuRC)*t*
    SPList[SP[p1, p2], SP[p2, q1]])/(Pi^d*s^2*(-mzC^2 + s)) + 
  (I*2^(2 - d)*EL^6*gAl^3*gAu*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
     gZlRC*gZuRC*((-2 + d)*s - 2*t) - gZlRC*gZuLC*((-4 + d)*s + 2*t) - 
     gZlLC*gZuRC*((-4 + d)*s + 2*t))*SPList[SP[p1, p2], SP[p3, q1]])/
   (Pi^d*s^2*(-mzC^2 + s)) + (I*2^(3 - d)*EL^6*gAl^3*gAu*(gZlLC + gZlRC)*
  ...
  (I*2^(4 - d)*EL^6*gAl^3*gAu*(gZlLC + gZlRC)*(gZuLC + gZuRC)*
  ...
  (I*2^(2 - d)*EL^6*gAl^3*gAu*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
   ...
   (Pi^d*s^2*(-mzC^2 + s)) + (I*2^(3 - d)*EL^6*gAl^3*gAu*(gZlLC + gZlRC)*
    (gZuLC + gZuRC)*SPList[SP[p3, q1], SP[p3, q1]])/(Pi^d*s*(-mzC^2 + s)))
