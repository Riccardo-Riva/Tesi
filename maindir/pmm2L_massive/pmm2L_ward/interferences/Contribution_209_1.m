...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFFZ^2*gZlL*gZlR*mm^2*s*(psq + 4*s)*
  ...
  (I*EL^5*gFFA*gFFZ^2*(aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-2*psq^2 + 3*psq*s + s^2 + 2*psq*t + 2*s*t + 
         mm^2*(-2*psq - 3*s + 2*t)) + gZlR^2*(-2*psq^2 + 3*psq*s + s^2 + 
         2*psq*t + 2*s*t + mm^2*(-2*psq - 3*s + 2*t))) + 
     bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(2*psq^2 + mm^2*(2*psq - 5*s - 2*t) + psq*(5*s - 2*t) - 
         s*(s + 2*t)) + gZlR^2*(2*psq^2 + mm^2*(2*psq - 5*s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ^2*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(2*psq^2 + mm^2*(2*psq - 7*s - 2*t) + psq*(7*s - 2*t) - 
         2*s*(s + t)) + gZlR^2*(2*psq^2 + mm^2*(2*psq - 7*s - 2*t) + 
         psq*(7*s - 2*t) - 2*s*(s + t))) + 
  ...
  (I*EL^5*gFFA*gFFZ^2*(bb*(4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(2*psq^2 + mm^2*(2*psq - 7*s - 2*t) + psq*(7*s - 2*t) - 
         2*s*(s + t)) + gZlR^2*(2*psq^2 + mm^2*(2*psq - 7*s - 2*t) + 
         psq*(7*s - 2*t) - 2*s*(s + t))) + 
     aa*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFFZ^2*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(2*psq^2 + 3*psq*s + mm^2*(2*psq - 3*s - 2*t) - 2*psq*t - 
         2*s*t) + gZlR^2*(2*psq^2 + 3*psq*s + mm^2*(2*psq - 3*s - 2*t) - 
         2*psq*t - 2*s*t)) + aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-2*psq^2 + 5*psq*s + 2*psq*t + 2*s*t + 
         mm^2*(-2*psq - 5*s + 2*t)) + gZlR^2*(-2*psq^2 + 5*psq*s + 2*psq*t + 
