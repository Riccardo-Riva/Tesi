...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (-((4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*
     mm^2*(mm^2*(5*psq - 9*s + 2*d*s - 5*t) + psq*(-psq + s + t))*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
     (4*psq^2 - 4*s^2 + d*s^2 - 4*mm^2*(4*psq - 3*s - 4*t) + 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
     (4*psq^2 - 4*s^2 + d*s^2 + 4*mm^2*(4*psq - s - 4*t) + 4*psq*(s - 2*t) + 
      4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*
     mm^2*(mm^2*(6*psq - 26*s + 5*d*s - 6*t) + psq*(2*psq + 2*s - d*s - 2*t))*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
    ...
    (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*
     ...
     gHll^2*gWlN*gWNl*mm^2*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
   ...
   (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*
     ...
     gHll^2*gWlN*gWNl*mm^2*(mm^2 - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
     ...
     gHll^2*gWlN*gWNl*mm^2*(4*mm^2 - 12*psq + 10*s - d*s + 8*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*(mm^2 - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*
     mm^2*(4*mm^2 + 4*psq + 2*s - d*s - 8*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
     ...
     gAu^2*gHll^2*gWlN*gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(8 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gHll^2*
     gWlN*gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*gWlN*gWNl*mm^2*
