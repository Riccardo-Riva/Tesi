...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
   ...
   ((3*4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(-psq + s + t)^2*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(psq^2 - s^2 - 2*psq*t + 
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
       ...
       SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*
      gZlL*mm^4*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*(psq - t)*
     ...
     (Pi^(2*d)*s) + (3*4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlL*mm^4*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*mm^2 - 3*psq + s + t)*
      ...
      mm^2*(gZlL*mm^2 - gZlR*mm^2 + 2*gZlR*psq)*(psq - t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 - gZlR*mm^2 + 
      ...
      mm^2*(gZlL*mm^2*s - gZlR*(2*psq^2 + mm^2*s - 4*psq*(s + t) + 
         2*t*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[p3, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*
      mm^2*(gZlL*mm^2*s + gZlR*(-3*psq^2 + mm^2*(psq - s - t) - 2*t*(s + t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*
      mm^2*(gZlL*mm^2 - gZlR*mm^2 + 2*gZlR*psq)*(psq - t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*mm^2*(gZlL*mm^2 - gZlR*mm^2 + 
      ...
      mm^2*(-(gZlL*mm^2*s) + gZlR*(2*psq^2 + mm^2*s - 4*psq*(s + t) + 
       ...
       SP[p3, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*
      gZlR*mm^2*(psq - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*(psq - t)*
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*
    ...
    (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gFll^2*gZlR*
