...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 (((-I)*2^(-1 - 2*d)*d*EL^5*gAl^5*mm^2*(mm^2 - psq)*s*
    (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) + (I*d*EL^5*gAl^5*mm^2*
    (aa*psq*((-4 + d)*psq + 2*s - (-4 + d)*t) + 
     bb*psq*(-((-4 + d)*psq) + 2*(-3 + d)*s + (-4 + d)*t) + 
     bb*mm^2*((4 + d)*psq - 2*(-1 + d)*s - (4 + d)*t) + 
     aa*mm^2*(-((4 + d)*psq) + 2*s + (4 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 4*d)*EL^5*gAl^5*((-2 + d)*(2*Pi)^(2*d)*(mm^2 - psq)*s*
      (-(aa*(-2 + d)*mm^2) - bb*(-2 + d)*mm^2 + aa*(-6 + d)*psq + 
       bb*(2 + d)*psq + 2*aa*(s + 2*t) - 2*bb*(s + 2*t)) + 
     aa*((-4 + d^2)*mm^4*(2*Pi)^(2*d)*(psq - t) + (-2 + d)*(2*Pi)^(2*d)*psq*
        ((-2 + d)*psq^2 + 2*psq*s - (-2 + d)*psq*t + 2*s*t) - 
       2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(d*psq*(psq - t) + s*(psq + t))) + 
     bb*(-2 + d)*(-(mm^4*(2*Pi)^(2*d)*((2 + d)*psq - 2*(-2 + d)*s - 
          (2 + d)*t)) - (2*Pi)^(2*d)*psq*((-2 + d)*psq^2 - 2*(-3 + d)*psq*s - 
         (-2 + d)*psq*t + 2*s*t) + 2^(1 + 2*d)*mm^2*Pi^(2*d)*
        (d*psq*(psq - 2*s - t) + s*(5*psq + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(4*d) - 
  (I*d*EL^5*gAl^5*mm^2*(bb*psq*((-4 + d)*psq - (-2 + d)*s - (-4 + d)*t) + 
     aa*psq*(-((-4 + d)*psq) - (-2 + d)*s + (-4 + d)*t) + 
     aa*mm^2*((4 + d)*psq + (-6 + d)*s - (4 + d)*t) + 
     bb*mm^2*(-((4 + d)*psq) + (2 + d)*s + (4 + d)*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 4*d)*EL^5*gAl^5*((-2 + d)*(2*Pi)^(2*d)*(mm^2 - psq)*s*
     ...
     bb*((-4 + d^2)*mm^4*(2*Pi)^(2*d)*(psq - s - t) - 
       2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(d*psq*(psq - s - t) + 
         s*(-3*psq + s + t)) + (-2 + d)*(2*Pi)^(2*d)*psq*
        ((-2 + d)*psq^2 + 2*s*(s + t) - psq*((4 + d)*s + (-2 + d)*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(4*d) + 
  (I*d*EL^5*gAl^5*mm^2*s*(aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl^5*(mm^2 - psq)*s*
    (-(aa*(-2 + d)*mm^2) - bb*(-2 + d)*mm^2 + aa*(-6 + d)*psq + 
     bb*(2 + d)*psq + 2*aa*(s + 2*t) - 2*bb*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*d*EL^5*gAl^5*mm^2*s*
    (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*
    gAl^5*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-2 + d)*d*EL^5*gAl^5*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (I*(-2 + d)^2*EL^5*gAl^5*(mm^2 - psq)*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*(-2 + d)*d*EL^5*gAl^5*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gAl^5*(mm^2 - psq)*(aa*((-2 + d)*mm^2 - 2*s + 2*t - d*t) + 
     bb*((-2 + d)*mm^2 + 4*psq - 2*d*psq + 2*s - 2*t + d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*d*EL^5*gAl^5*mm^2*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*(-2 + d)*EL^5*gAl^5*(aa*psq*((-2 + d)*psq + 2*s - (-2 + d)*t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*(-((-2 + d)*psq^2) + 
     2*psq*s + (-2 + d)*psq*t + 2*s*t + mm^2*((2 + d)*psq - 4*s - (2 + d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*(-2 + d)*EL^5*gAl^5*s*(aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)^2*EL^5*gAl^5*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gAl^5*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gAl^5*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^5*(aa*((-2 + d)*mm^2 - 2*s + 2*t - d*t) + 
     bb*((-2 + d)*mm^2 + 4*psq - 2*d*psq + 2*s - 2*t + d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*(-2 + d)*EL^5*gAl^5*(aa*((-2 + d)*mm^2 - 2*s + 2*t - d*t) + 
     bb*((-2 + d)*mm^2 + 4*psq - 2*d*psq + 2*s - 2*t + d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*((-2 + d)*psq - (-4 + d)*s - 
     (-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl^5*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl^5*
  ...
  (I*(-2 + d)*EL^5*gAl^5*(aa*((-2 + d)*mm^2 + 4*s - d*s + 2*t - d*t) + 
     bb*((-2 + d)*mm^2 + 4*psq - 2*d*psq - 4*s + d*s - 2*t + d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^5*
    ((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^5*((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t)*
  ...
  (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gAl^5*(bb*(psq - t) + 
     ...
     SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)^2*EL^5*gAl^5*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*(-2 + d)^2*EL^5*gAl^5*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl^5*((-2 + d)*psq - 2*s - (-2 + d)*t)*
