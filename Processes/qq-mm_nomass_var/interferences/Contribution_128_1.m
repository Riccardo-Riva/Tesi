...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   ((I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(s + t)*((-2 + d)*gZlL*s - 
       (-4 + d)*gZlR*s + 2*gZlL*t + 2*gZlR*t)*CKM[1, 1]*CKMC[1, 1]*
      SPList[SP[p1, q1], SP[q1, q1]])/(mw^4*(2*Pi)^d*(mz^2 - s)) - 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*t*((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 
       2*gZlL*t + 2*gZlR*t)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p2, q1], 
       SP[q1, q1]])/(mw^4*(2*Pi)^d*(mz^2 - s)) - 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*s*CKM[1, 1]*CKMC[1, 1]*
      (3*d*gZlL*(2*Pi)^d*s - 3*d*gZlR*(2*Pi)^d*s - 2^(1 + d)*gZlL*Pi^d*
    ...
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*s*CKM[1, 1]*CKMC[1, 1]*
     ...
     (mw^4*(2*Pi)^(2*d)*(mz^2 - s)*(-1 + GaugeXi[Q])^2) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(s + t)*CKM[1, 1]*CKMC[1, 1]*
      (d*gZlL*(2*Pi)^d*s - d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*(-s + t) + 
       2^(1 + d)*gZlR*Pi^d*(2*s + t) + (2^(2 + d)*gZlL*Pi^d - 
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (d*gZlR*(2*Pi)^d*s^2 - 2^(1 + d)*gZlR*Pi^d*(2*s^2 - (-5 + d)*s*t + 
         2*t^2) + gZlL*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
          (s^2 + s*t - d*s*t - 2*t^2)) + s*(-(d*gZlL*(2*Pi)^d*s) + 
         d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*(s - (-3 + d)*t) + 
         2^(1 + d)*gZlR*Pi^d*(-2*s + (-3 + d)*t))*GaugeXi[Q])*
    ...
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      ...
      GaugeXi[Q]) - (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*
      CKMC[1, 1]*(3*d*gZlL*(2*Pi)^d*s*t - 3*d*gZlR*(2*Pi)^d*s*t + 
       2^(1 + d)*gZlL*Pi^d*((-2 + d)*s^2 - 3*s*t + t^2) + 
       2^(1 + d)*gZlR*Pi^d*(-((-4 + d)*s^2) + 6*s*t + t^2) - 
       2^(1 + d)*Pi^d*(gZlR*(-2*(-4 + d)*s^2 - 3*(-4 + d)*s*t + 2*t^2) + 
         gZlL*(2*(-2 + d)*s^2 + 3*(-2 + d)*s*t + 2*t^2))*GaugeXi[Q] + 
       (3*d*gZlL*(2*Pi)^d*s*t - 3*d*gZlR*(2*Pi)^d*s*t + 2^(1 + d)*gZlL*Pi^d*
          ((-2 + d)*s^2 - 3*s*t + t^2) + 2^(1 + d)*gZlR*Pi^d*
          (-((-4 + d)*s^2) + 6*s*t + t^2))*GaugeXi[Q]^2)*
      SPList[SP[p1, q1], SP[q1, q1], SP[q1, q1]])/
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*t*CKM[1, 1]*CKMC[1, 1]*
      (d*gZlL*(2*Pi)^d*s - d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*(-s + t) + 
       2^(1 + d)*gZlR*Pi^d*(2*s + t) + (2^(1 + d)*gZlL*Pi^d - 
         2^(2 + d)*gZlR*Pi^d - d*gZlL*(2*Pi)^d + d*gZlR*(2*Pi)^d)*s*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (-(d*gZlL*(2*Pi)^d*s*(s + 3*t)) + d*gZlR*(2*Pi)^d*s*(s + 3*t) + 
       2^(1 + d)*gZlL*Pi^d*(s^2 + 4*s*t - t^2) - 2^(1 + d)*gZlR*Pi^d*
        (2*s^2 + 5*s*t + t^2) + 2^(1 + d)*Pi^d*
        (gZlR*(-((-4 + d)*s^2) + (10 - 3*d)*s*t + 2*t^2) + 
         gZlL*((-2 + d)*s^2 + (-8 + 3*d)*s*t + 2*t^2))*GaugeXi[Q] + 
       (-(d*gZlL*(2*Pi)^d*s*(s + 3*t)) + d*gZlR*(2*Pi)^d*s*(s + 3*t) + 
         2^(1 + d)*gZlL*Pi^d*(s^2 + 4*s*t - t^2) - 2^(1 + d)*gZlR*Pi^d*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   ((I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
    ...
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(5*d^2*gZlL*(2*Pi)^d*s*t - 
      ...
      CKMC[1, 1]*SPList[SP[p2, q1]])/(Pi^(2*d)*(mz^2 - s)*s) + 
    ...
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (-2*mw^2*(-(gZlR*((4 - 5*d + d^2)*s^2 + (2 - 9*d + 2*d^2)*s*t - 
            6*t^2)) + gZlL*((2 - 3*d + d^2)*s^2 + (16 - 9*d + 2*d^2)*s*t + 
           6*t^2)) + (-(gZlR*s*((-4 + d)*s - 2*t)*(s + t)) + 
         gZlL*s*(s + t)*((-2 + d)*s + 2*t) - 2*gZlR*mw^2*
          ((12 - 7*d + d^2)*s^2 + (14 - 11*d + 2*d^2)*s*t - 2*t^2) + 
         2*gZlL*mw^2*((6 - 5*d + d^2)*s^2 + (16 - 11*d + 2*d^2)*s*t + 2*t^2))*
    ...
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (-2*mw^2*(-(gZlR*((8 - 6*d + d^2)*s^2 + (4 - 9*d + 2*d^2)*s*t - 
            6*t^2)) + gZlL*((-2 + d)^2*s^2 + (14 - 9*d + 2*d^2)*s*t + 
           6*t^2)) + (gZlR*s*t*(-((-4 + d)*s) + 2*t) + 
         gZlL*s*t*((-2 + d)*s + 2*t) - 2*gZlR*mw^2*((8 - 6*d + d^2)*s^2 + 
           (12 - 11*d + 2*d^2)*s*t - 2*t^2) + 2*gZlL*mw^2*
          ((-2 + d)^2*s^2 + (18 - 11*d + 2*d^2)*s*t + 2*t^2))*GaugeXi[Q])*
      SPList[SP[p2, q1], SP[q1, q1]])/(mw^4*(2*Pi)^d*(mz^2 - s)*s*
      GaugeXi[Q]) + (I*2^(3 - d)*(-2 + d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
      (gZlL + gZlR)*CKM[1, 1]*CKMC[1, 1]*SPList[SP[p3, q1], SP[p3, q1]])/
     (Pi^d*(mz^2 - s)) + (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (2^(1 + d)*mw^2*Pi^d*((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 2*gZlL*t + 
         2*gZlR*t) - (-(gZlL*s*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
             (s + d*s - t))) - 2^(1 + d)*gZlR*mw^2*Pi^d*((-4 + d)*s - 2*t) + 
         2^(1 + d)*gZlL*mw^2*Pi^d*((-2 + d)*s + 2*t) + 
         gZlR*s*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*((2 + d)*s + t)))*
        GaugeXi[Q] + 2^(1 + d)*Pi^d*(mw^2 - s)*(-((-2 + d)*gZlL*s) + 
         (-4 + d)*gZlR*s - 2*gZlL*t - 2*gZlR*t)*GaugeXi[Q]^2 + 
    ...
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      ((s^2*(-(d*gZlL*(2*Pi)^d*s) + d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*
           (s - (-3 + d)*t) + 2^(1 + d)*gZlR*Pi^d*(-2*s + (-3 + d)*t) + 
          2^(1 + d)*Pi^d*((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 
            2*(-3 + d)*gZlL*t - 2*(-3 + d)*gZlR*t)*GaugeXi[Q] + 
          (-(d*gZlL*(2*Pi)^d*s) + d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*
             (s - (-3 + d)*t) + 2^(1 + d)*gZlR*Pi^d*(-2*s + (-3 + d)*t))*
           GaugeXi[Q]^2))/((2*Pi)^(2*d)*(mz^2 - s)) + 
       (2^(1 - 2*d)*mw^2*(-1 + GaugeXi[Q])*(d*(1 + d)*gZlL*(2*Pi)^d*s^2 - 
          (-1 + d)*d*gZlR*(2*Pi)^d*s^2 + 2^(1 + d)*gZlR*Pi^d*
           (2*(-1 + d)*s^2 - (1 - 4*d + d^2)*s*t + 2*t^2) + 
          2^(1 + d)*gZlL*Pi^d*((1 - 2*d)*s^2 + (5 - 4*d + d^2)*s*t + 2*t^2) - 
          2^(1 + d)*Pi^d*(-(gZlR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
                t - 4*t^2)) + gZlL*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
              4*t^2))*GaugeXi[Q] + (d*(1 + d)*gZlL*(2*Pi)^d*s^2 - 
            (-1 + d)*d*gZlR*(2*Pi)^d*s^2 + 2^(1 + d)*gZlR*Pi^d*
             (3*(-2 + d)*s^2 - (7 - 6*d + d^2)*s*t + 2*t^2) + 
            2^(1 + d)*gZlL*Pi^d*(-3*(-1 + d)*s^2 + (11 - 6*d + d^2)*s*t + 
              2*t^2))*GaugeXi[Q]^2))/(Pi^(2*d)*(-mz^2 + s)*GaugeXi[Q]))*
      SPList[SP[q1, q1], SP[q1, q1]])/(mw^4*s*(-1 + GaugeXi[Q])^2) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(s + t)*CKM[1, 1]*CKMC[1, 1]*
      (gZlL*(2^(1 + d)*(-4 + d)*mw^2*Pi^d + d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(-s + t)) + gZlR*(-(2^(1 + d)*(-2 + d)*mw^2*Pi^d) - 
     ...
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (gZlL*(d*(2*Pi)^d*s^2 - 2^(1 + d)*mw^2*Pi^d*((-2 + d)*s + 
           2*(-3 + d)*t) - 2^(1 + d)*Pi^d*(s^2 + s*t - d*s*t - 2*t^2)) + 
       gZlR*(-(d*(2*Pi)^d*s^2) + 2^(1 + d)*mw^2*Pi^d*((-4 + d)*s + 
           2*(-3 + d)*t) + 2^(1 + d)*Pi^d*(2*s^2 - (-5 + d)*s*t + 2*t^2)) + 
       (2^(1 + d)*gZlR*mw^2*Pi^d*((-4 + d)*s + 2*(-3 + d)*t) - 
         2^(1 + d)*gZlL*mw^2*Pi^d*((-2 + d)*s + 2*(-3 + d)*t) + 
         gZlR*s*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(2*s - (-3 + d)*t)) + 
         gZlL*s*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(-s + (-3 + d)*t)))*
        GaugeXi[Q])*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*GaugeXi[Q]) + 
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (4*gZlR*s^2 - d*gZlR*s*(2*mw^2 + s) + 2*gZlL*mw^2*((-6 + d)*s - 2*t) - 
       4*gZlR*mw^2*t + 2*gZlR*s*t + gZlL*s*((-2 + d)*s + 2*t) + 
       (2*mw^2 - s)*((-6 + d)*gZlL*s - 2*gZlL*t - gZlR*(d*s + 2*t))*
        GaugeXi[Q])*SPList[SP[p1, q1], SP[p3, q1], SP[q1, q1]])/
     (mw^4*Pi^d*(mz^2 - s)*s*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (3*d*gZlL*(2*Pi)^d*s*t - 3*d*gZlR*(2*Pi)^d*s*t + 
       2^(1 + d)*gZlL*Pi^d*((-2 + d)*s^2 - 3*s*t + t^2) + 
       2^(1 + d)*gZlR*Pi^d*(-((-4 + d)*s^2) + 6*s*t + t^2) - 
       2^(1 + d)*Pi^d*(gZlR*(-2*(-4 + d)*s^2 - 3*(-4 + d)*s*t + 2*t^2) + 
         gZlL*(2*(-2 + d)*s^2 + 3*(-2 + d)*s*t + 2*t^2))*GaugeXi[Q] + 
     ...
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*t*CKM[1, 1]*CKMC[1, 1]*
      (gZlL*(2^(1 + d)*(-2 + d)*mw^2*Pi^d + d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(-s + t)) + gZlR*(-(2^(1 + d)*(-4 + d)*mw^2*Pi^d) - 
         d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(2*s + t)) + 
       (2^(1 + d)*(-2 + d)*gZlL*mw^2*Pi^d - 2^(1 + d)*(-4 + d)*gZlR*mw^2*
          Pi^d - 2^(2 + d)*gZlR*Pi^d*s + d*gZlR*(2*Pi)^d*s + 
         gZlL*(2^(1 + d)*Pi^d - d*(2*Pi)^d)*s)*GaugeXi[Q])*
      SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*GaugeXi[Q]) - 
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (2*gZlL*mw^2*((-2 + d)*s - 2*t) + gZlR*s*(-((-4 + d)*s) + 2*t) - 
       2*gZlR*mw^2*((-4 + d)*s + 2*t) + gZlL*s*((-2 + d)*s + 2*t) + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, mw], 
   ...
   (((-I)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
    ...
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (mw^2*(s + t)*(-((-2 + d)*gZlL*s) + (-4 + d)*gZlR*s - 2*gZlL*t - 
         2*gZlR*t) + (-(gZlR*(s*((-4 + d)*s - 2*t)*(s + t) + 
            mw^2*((20 - 13*d + 2*d^2)*s^2 + (22 - 21*d + 4*d^2)*s*t - 
              6*t^2))) + gZlL*(s*(s + t)*((-2 + d)*s + 2*t) + 
           mw^2*((10 - 9*d + 2*d^2)*s^2 + (32 - 21*d + 4*d^2)*s*t + 6*t^2)))*
        GaugeXi[Q])*SPList[SP[p1, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^d*(mz^2 - s)*s*GaugeXi[Q]) - 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (mw^2*(gZlR*(-2*(8 - 6*d + d^2)*s^2 + (-12 + 19*d - 4*d^2)*s*t + 
           10*t^2) + gZlL*(2*(-2 + d)^2*s^2 + (30 - 19*d + 4*d^2)*s*t + 
           10*t^2)) + (mw^2 - s)*t*((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 
         2*gZlL*t + 2*gZlR*t)*GaugeXi[Q])*SPList[SP[p2, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^d*(mz^2 - s)*s*GaugeXi[Q]) - 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (-((mw^2*(-1 + GaugeXi[Q])*(-(d*gZlL*(2*Pi)^d*s) + d*gZlR*(2*Pi)^d*s + 
           2^(1 + d)*gZlR*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZlL*Pi^d*
            ((-1 + d)*s + t) + (-(d*gZlL*(2*Pi)^d*s) + d*gZlR*(2*Pi)^d*s + 
             2^(1 + d)*gZlL*Pi^d*(s - t) - 2^(1 + d)*gZlR*Pi^d*(2*s + t))*
            GaugeXi[Q]^2))/GaugeXi[Q]) - s*(3*d*gZlL*(2*Pi)^d*s - 
         3*d*gZlR*(2*Pi)^d*s - 2^(1 + d)*gZlL*Pi^d*(s + d*s - t) + 
         2^(1 + d)*gZlR*Pi^d*((2 + d)*s + t) + 2^(1 + d)*Pi^d*
          (-((-2 + d)*gZlL*s) + (-4 + d)*gZlR*s - 2*gZlL*t - 2*gZlR*t)*
    ...
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      ((s^2*(-(d*gZlL*(2*Pi)^d*s) + d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*
          ...
          (-(d*gZlL*(2*Pi)^d*s) + d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*
             (s - (-3 + d)*t) + 2^(1 + d)*gZlR*Pi^d*(-2*s + (-3 + d)*t))*
           GaugeXi[Q]^2))/(mz^2 - s) + (mw^2*(-1 + GaugeXi[Q])*
        ...
        ((-mz^2 + s)*GaugeXi[Q]))*SPList[SP[q1, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^(2*d)*s*(-1 + GaugeXi[Q])^2) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*(s + t)*CKM[1, 1]*CKMC[1, 1]*
      (gZlL*(mw^2*(-(2^(2 + d)*Pi^d) + d*(2*Pi)^d) + d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(-s + t)) + 
       gZlR*(mw^2*(2^(1 + d)*Pi^d - d*(2*Pi)^d) - d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(2*s + t)) - (2^(2 + d)*gZlL*Pi^d - 
         2^(1 + d)*gZlR*Pi^d - d*gZlL*(2*Pi)^d + d*gZlR*(2*Pi)^d)*(mw^2 - s)*
        GaugeXi[Q])*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q1]])/
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*GaugeXi[Q]) + 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (gZlL*(d*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*(s^2 + s*t - d*s*t - 2*t^2) + 
         mw^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*(s + 3*t - d*t))) - 
       gZlR*(d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*s^2 + (-5 + d)*s*t - 
           2*t^2) + mw^2*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
            (2*s + 3*t - d*t))) + (mw^2 - s)*(-(d*gZlL*(2*Pi)^d*s) + 
         d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*(s - (-3 + d)*t) + 
         2^(1 + d)*gZlR*Pi^d*(-2*s + (-3 + d)*t))*GaugeXi[Q])*
      SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*GaugeXi[Q]) + 
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
     ...
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
    (I*2^(1 - 2*d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*t*CKM[1, 1]*CKMC[1, 1]*
      (gZlL*(mw^2*(-(2^(1 + d)*Pi^d) + d*(2*Pi)^d) + d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(-s + t)) + 
       gZlR*(mw^2*(2^(2 + d)*Pi^d - d*(2*Pi)^d) - d*(2*Pi)^d*s + 
         2^(1 + d)*Pi^d*(2*s + t)) - (2^(1 + d)*gZlL*Pi^d - 
         2^(2 + d)*gZlR*Pi^d - d*gZlL*(2*Pi)^d + d*gZlR*(2*Pi)^d)*(mw^2 - s)*
        GaugeXi[Q])*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/
     (mw^4*Pi^(2*d)*s*(-mz^2 + s)*GaugeXi[Q]) + 
    (I*2^(1 - d)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (-(gZlR*(s*((-4 + d)*s - 2*t) + mw^2*((-4 + d)*s + 2*t))) + 
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   (((-I)*EL^6*gAl*gAu*gWdu*gWud*gWWZ*
      ...
      CKMC[1, 1]*SPList[SP[q1, q1]])/(mw^2*(2*Pi)^d*(mz^2 - s)) + 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (mw^2*(gZlR*((-12 + 11*d - 2*d^2)*s^2 + (-10 + 19*d - 4*d^2)*s*t + 
           10*t^2) + gZlL*((6 - 7*d + 2*d^2)*s^2 + (32 - 19*d + 4*d^2)*s*t + 
           10*t^2)) + (mw^2 - s)*(s + t)*((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 
         2*gZlL*t + 2*gZlR*t)*GaugeXi[Q])*SPList[SP[p1, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^d*(mz^2 - s)*s*GaugeXi[Q]) + 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (-(mw^2*t*((-2 + d)*gZlL*s - (-4 + d)*gZlR*s + 2*gZlL*t + 2*gZlR*t)) + 
       (gZlR*s*t*(-((-4 + d)*s) + 2*t) + gZlL*s*t*((-2 + d)*s + 2*t) + 
         gZlR*mw^2*(-2*(8 - 6*d + d^2)*s^2 + (-20 + 21*d - 4*d^2)*s*t + 
           6*t^2) + gZlL*mw^2*(2*(-2 + d)^2*s^2 + (34 - 21*d + 4*d^2)*s*t + 
           6*t^2))*GaugeXi[Q])*SPList[SP[p2, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^d*(mz^2 - s)*s*GaugeXi[Q]) + 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      (s*(3*d*gZlL*(2*Pi)^d*s - 3*d*gZlR*(2*Pi)^d*s - 2^(1 + d)*gZlL*Pi^d*
          (s + d*s - t) + 2^(1 + d)*gZlR*Pi^d*((2 + d)*s + t) + 
         2^(1 + d)*Pi^d*(-((-2 + d)*gZlL*s) + (-4 + d)*gZlR*s - 2*gZlL*t - 
           2*gZlR*t)*GaugeXi[Q] + (d*gZlL*(2*Pi)^d*s - d*gZlR*(2*Pi)^d*s + 
           2^(1 + d)*gZlL*Pi^d*(-s + t) + 2^(1 + d)*gZlR*Pi^d*(2*s + t))*
          GaugeXi[Q]^2) + (mw^2*(-1 + GaugeXi[Q])*(-3*d*gZlL*(2*Pi)^d*s + 
          3*d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlR*Pi^d*(-2*(-1 + d)*s + t) + 
          2^(1 + d)*gZlL*Pi^d*((-1 + 2*d)*s + t) + 
          (3*d*gZlR*(2*Pi)^d*s + gZlL*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(s + 
                d*s - t)) - 2^(1 + d)*gZlR*Pi^d*((2 + d)*s + t))*
           GaugeXi[Q]^2))/GaugeXi[Q])*SPList[SP[p3, q1], SP[q1, q1]])/
     (mw^4*(2*Pi)^(2*d)*(mz^2 - s)*(-1 + GaugeXi[Q])^2) - 
    (I*EL^6*gAl*gAu*gWdu*gWud*gWWZ*CKM[1, 1]*CKMC[1, 1]*
      ((s^2*(-(d*gZlL*(2*Pi)^d*s) + d*gZlR*(2*Pi)^d*s + 2^(1 + d)*gZlL*Pi^d*
           (s - (-3 + d)*t) + 2^(1 + d)*gZlR*Pi^d*(-2*s + (-3 + d)*t) + 
