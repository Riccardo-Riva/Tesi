...
(PropList[KiraPropagator[q1, ms], KiraPropagator[-p1 - p2 + q1, ms], 
  ...
  ((-9*EL^8*gAd^2*gAl^4*gAu^2*mc^2*ms^2*(4*mm^4 - 2*s^2 + d*s^2 + 
   ...
   (9*EL^8*gAd^2*gAl^4*gAu^2*ms^2*(-mm^2 + s + t)*SPList[SP[p1, q2], 
   ...
   (9*EL^8*gAd^2*gAl^4*gAu^2*ms^2*SPList[SP[p1, q2], SP[p2, q2]])/
   ...
   (9*EL^8*gAd^2*gAl^4*gAu^2*ms^2*(mm^2 - t)*SPList[SP[p2, q2], SP[p2, q2]])/
   ...
   (9*EL^8*gAd^2*gAl^4*gAu^2*(2*me^2 + s)*SPList[SP[p3, q1], SP[p3, q2]])/
    (Pi^8*s^3) - (18*EL^8*gAd^2*gAl^4*gAu^2*ms^2*(2*me^2 + s)*
