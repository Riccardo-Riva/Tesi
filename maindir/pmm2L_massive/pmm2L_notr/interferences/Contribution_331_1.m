...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 (-((2^(-1 - 4*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
     (-(4^(2 + d)*((-2 + d)*gZlL^2 - d*gZlL*gZlR + (-2 + d)*gZlR^2)*Pi^(2*d)*
        psq^2*s) + 4^(1 + d)*(-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*psq*s^2 + 
      4^(1 + d)*Pi^(2*d)*psq*s*((-2 + d)*gZlL^2*(2*mm^2 + psq - (-4 + d)*s) + 
        (-2 + d)*gZlR^2*(2*mm^2 + psq - (-4 + d)*s) + 
        d*gZlL*gZlR*(-4*mm^2 + (-3 + d)*s)) + 2^(1 + 2*d)*d*gZlL*gZlR*mm^2*
       Pi^(2*d)*(4*psq^2 + 2*(-2 + d)*mm^2*s + 2*s^2 - d*s^2 + 4*s*t + 
        4*t^2 - 2*psq*((-2 + d)*s + 4*t)) + 
      s*(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(-4*psq^2 - 2*(-4 + d)*mm^2*s + 
        ...
        (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(4*psq^2 - 4*mm^2*s - 6*s^2 + d*s^2 + 
         ...
         (4*psq^2 - 4*mm^2*s - 6*s^2 + d*s^2 + 4*psq*(s - 2*t) + 4*s*t + 
          4*t^2)) + (-2 + d)*gZlL^2*
       (-((2*Pi)^(2*d)*s*(4*psq^2 - 3*(-2 + d)*psq*s + (-2 + d)*s^2 - 
           8*psq*t + 4*s*t + 4*t^2)) - 4^(1 + d)*mm^2*Pi^(2*d)*
         (psq^2 - 2*psq*t + t*(s + t))) + (-2 + d)*gZlR^2*
       (-((2*Pi)^(2*d)*s*(4*psq^2 - 3*(-2 + d)*psq*s + (-2 + d)*s^2 - 
           8*psq*t + 4*s*t + 4*t^2)) - 4^(1 + d)*mm^2*Pi^(2*d)*
         (psq^2 - 2*psq*t + t*(s + t))))*\[Mu]^(8 - 2*d))/(Pi^(4*d)*s^2)) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (2*(gZlL^2 + gZlR^2)*s*(2*mm^2 - 9*psq + s) + 
     d^2*s*(gZlL^2*(psq - s) + gZlR^2*(psq - s) - 
       2*gZlL*gZlR*(mm^2 - psq + s)) + d*(gZlL^2*s*(-2*mm^2 + 7*psq + s) + 
       gZlR^2*s*(-2*mm^2 + 7*psq + s) + gZlL*gZlR*(-4*psq^2 + 8*mm^2*s - 
         12*psq*s + 5*s^2 + 8*psq*t - 4*s*t - 4*t^2)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gXll^2*mm^4*(-2*d*gZlL*gZlR*(6*psq^2 + 2*s^2 - d*s^2 + 
       3*s*t + 2*t^2 + mm^2*(-4*psq + (2 + d)*s + 4*t) - 
       psq*((9 + d)*s + 8*t)) - (-2 + d)*gZlL^2*(-10*psq^2 + (24 + d)*psq*s + 
       4*mm^2*(psq - s - t) + 14*psq*t - 2*(4*s^2 + 5*s*t + 2*t^2)) - 
     (-2 + d)*gZlR^2*(-10*psq^2 + (24 + d)*psq*s + 4*mm^2*(psq - s - t) + 
       14*psq*t - 2*(4*s^2 + 5*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl^2*gAu^2*gXll^2*mm^4*(-2*d*gZlL*gZlR*(6*psq^2 - s^2 + 3*s*t + 
       2*t^2 + mm^2*(-4*psq + (-2 + d)*s + 4*t) - psq*(s + d*s + 8*t)) - 
     (-2 + d)*gZlL^2*(-10*psq^2 + 4*mm^2*(psq - t) + 
       psq*((10 + d)*s + 14*t) - 2*((-1 + d)*s^2 + 5*s*t + 2*t^2)) - 
     (-2 + d)*gZlR^2*(-10*psq^2 + 4*mm^2*(psq - t) + 
       psq*((10 + d)*s + 14*t) - 2*((-1 + d)*s^2 + 5*s*t + 2*t^2)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (-((-2 + d)*gZlL^2*(2*psq^2 + 6*psq*s + d*psq*s - 2*s^2 - 
        4*mm^2*(psq - t) + 2*psq*t + 2*s*t - 4*t^2)) - 
     (-2 + d)*gZlR^2*(2*psq^2 + 6*psq*s + d*psq*s - 2*s^2 - 
       4*mm^2*(psq - t) + 2*psq*t + 2*s*t - 4*t^2) - 
     2*d*gZlL*gZlR*(-2*psq^2 - (3 + d)*psq*s + s^2 - d*s^2 + 
  ...
  ((-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
   ...
   ((2*Pi)^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (-2*d*gZlL*gZlR*(-2*psq^2 - (-5 + d)*psq*s - 2*s^2 + 
       mm^2*(4*psq + (-6 + d)*s - 4*t) + s*t + 2*t^2) - 
     (-2 + d)*gZlL^2*(2*psq^2 + (-8 + d)*psq*s + 8*s^2 - 2*d*s^2 + 2*psq*t + 
       2*s*t - 4*t^2 + 4*mm^2*(-psq + s + t)) - (-2 + d)*gZlR^2*
      (2*psq^2 + (-8 + d)*psq*s + 8*s^2 - 2*d*s^2 + 2*psq*t + 2*s*t - 4*t^2 + 
       4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
  ...
  (EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (-2*d*gZlL*gZlR*(-4*psq^2 - 2*(-2 + d)*mm^2*s + s^2 - 4*s*t - 4*t^2 + 
       2*psq*(d*s + 4*t)) + (-2 + d)*gZlL^2*(-4*psq^2 + (-4 + d)*s^2 - 
       4*s*t - 4*t^2 + psq*(6*s + 8*t)) + (-2 + d)*gZlR^2*
      (-4*psq^2 + (-4 + d)*s^2 - 4*s*t - 4*t^2 + psq*(6*s + 8*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/((2*Pi)^(2*d)*s^2) + 
  (d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(2*(-2 + d)*mm^4*s + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*(2*d*gZlL*gZlR*(mm^2 - psq) + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (d*gZlL*gZlR*(-4*mm^2 + 2*psq + 5*s + 2*t) - 
     (-2 + d)*gZlL^2*(-2*mm^2 - 2*psq + 7*s + d*s + 4*t) - 
     (-2 + d)*gZlR^2*(-2*mm^2 - 2*psq + 7*s + d*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (4*psq^2 - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 + 2*mm^2*((-7 + d)*s + t) - 
     ...
     SP[p1, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (d*gZlL*gZlR*(-4*mm^2 + 2*psq + s + 2*t) - (-2 + d)*gZlL^2*
      (-2*mm^2 - 2*psq + s + d*s + 4*t) - (-2 + d)*gZlR^2*
      (-2*mm^2 - 2*psq + s + d*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    ((-2 + d)*gZlL^2*(-2*mm^2 + 6*psq + 3*s + d*s - 4*t) + 
     (-2 + d)*gZlR^2*(-2*mm^2 + 6*psq + 3*s + d*s - 4*t) + 
     d*gZlL*gZlR*(4*mm^2 - 6*psq - 3*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (-4*s^2 + d*s^2 + 2*mm^2*(2*psq + (-8 + d)*s - t) + 4*s*t + 4*t^2 - 
     2*psq*((-6 + d)*s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    ((-2 + d)*gZlL^2*(-2*mm^2 + 6*psq - 3*s + d*s - 4*t) + 
     (-2 + d)*gZlR^2*(-2*mm^2 + 6*psq - 3*s + d*s - 4*t) + 
     d*gZlL*gZlR*(4*mm^2 - 6*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (2*mm^2 + (5 + d)*psq + s - d*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*((14 - 9*d + d^2)*gZlL^2 + 
     4*d*gZlL*gZlR + (14 - 9*d + d^2)*gZlR^2)*mm^4*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    ...
    gZlR*mm^2*(4*(-2 + d)*psq^2 + (28 - 15*d + 2*d^2)*mm^2*s + 
  ...
  (3*4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*((-2 + d)*gZlL^2 - d*gZlL*gZlR + 
     (-2 + d)*gZlR^2)*mm^4*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*((-2 + d)*gZlL^2 - d*gZlL*gZlR + 
     (-2 + d)*gZlR^2)*mm^4*(-4*psq + 5*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    ((-2 + d)*gZlL^2*(2*mm^2 - 2*psq - 7*s) + (-2 + d)*gZlR^2*
      (2*mm^2 - 2*psq - 7*s) + d*gZlL*gZlR*(-4*mm^2 + 4*psq + 7*s))*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (-(d*gZlL*gZlR*(2*mm^2 - 3*psq + t)) + (-2 + d)*gZlL^2*
      (mm^2 - 2*psq + t) + (-2 + d)*gZlR^2*(mm^2 - 2*psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
  ...
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (-10*psq^2 + (22 + d)*psq*s + 4*mm^2*(psq - t) + 14*psq*t - 
     ...
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    ((-2 + d)*gZlL^2*(2*psq + (-12 + d)*s - 2*t) + 
     (-2 + d)*gZlR^2*(2*psq + (-12 + d)*s - 2*t) + 
     2*d*gZlL*gZlR*(-2*psq + 7*s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    ((8 + d)*psq^2 + 4*s^2 - 2*d*s^2 + 6*s*t + 4*t^2 + 
     mm^2*(-((4 + d)*psq) + 6*(-2 + d)*s + (4 + d)*t) - 
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*((-2 + d)*gZlL^2*(mm^2 - s - t) + 
     (-2 + d)*gZlR^2*(mm^2 - s - t) + d*gZlL*gZlR*(-2*mm^2 + psq + s + t))*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*((-2 + d)*gZlL^2 - d*gZlL*gZlR + 
     (-2 + d)*gZlR^2)*mm^4*(4*psq + s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  ((-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
    (2*psq + d*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/
   ((2*Pi)^(2*d)*s^2) + (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*
    gZlR*mm^2*(2*psq^2 + (4 + d)*psq*s - 6*s^2 + 2*psq*t + 2*s*t - 4*t^2 + 
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (2*d*gZlL*gZlR*(2*psq + 5*s - 2*t) + (-2 + d)*gZlL^2*
      (-2*psq + (-10 + d)*s + 2*t) + (-2 + d)*gZlR^2*
      (-2*psq + (-10 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  ((-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
   ...
   ((2*Pi)^(2*d)*s^2) + (4^(1 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*
    mm^2*(s*(psq - 2*t) + mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*mm^4*
    (2*d*gZlL*gZlR*(2*psq + s - 2*t) + (-2 + d)*gZlL^2*
      (-2*psq + (-4 + d)*s + 2*t) + (-2 + d)*gZlR^2*(-2*psq + (-4 + d)*s + 
  ...
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (-(d*psq*(psq + 3*s - t)) + mm^2*((4 + d)*psq + (-16 + 3*d)*s - 
       (4 + d)*t) + 2*(7*psq*s - 2*s^2 - 2*psq*t + s*t + 2*t^2))*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(4*psq^2 + 2*(-4 + d)*mm^2*s - 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*((-2 + d)*gZlL^2 - 2*d*gZlL*gZlR + 
     (-2 + d)*gZlR^2)*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/
   (Pi^(2*d)*s) - (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (d^2*s*(2*mm^2 - 2*psq + s) + 4*s*(-4*psq + 3*s) + 
     4*d*(psq^2 - mm^2*s - 2*s^2 + psq*(s - 2*t) + s*t + t^2))*
  ...
  (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*
    ...
    gXll^2*gZlL*gZlR*mm^2*(-mm^2 + psq + (-1 + d)*s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (mm^2 - 3*psq + 2*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*
    gXll^2*gZlL*gZlR*mm^2*(6*mm^2 - 6*psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (mm^2 + psq - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*
  ...
  (4^(1 - d)*(4 - 5*d + d^2)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], SP[p3, q1]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*(36 - 13*d + d^2)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*
    gZlR*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[p3, q2]])/
   (Pi^(2*d)*s) + (4^(1 - d)*(4 - 5*d + d^2)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*
   ...
   (Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*
    mm^2*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (3*4^(1 - d)*d*EL^8*gAl^2*gAu^2*gXll^2*
    gZlL*gZlR*mm^2*(-psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(-psq + 2*s + t)*
  ...
  (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(-4*mm^2 + 4*psq + 7*s)*
   ...
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (-4*mm^2 + 4*psq + 7*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*
    gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gXll^2*
    gZlL*gZlR*mm^2*(2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(2*mm^2 - 3*psq + t)*
  ...
  (4^(2 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
   ...
   (Pi^(2*d)*s^2) - (3*2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*
    mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*
    gXll^2*gZlL*gZlR*mm^2*(4*mm^2 - 4*psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(-psq + s + t)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    ...
    gXll^2*gZlL*gZlR*mm^2*(-mm^2 + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
    (2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*
    gXll^2*gZlL*gZlR*mm^2*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(2*psq - 3*s - 2*t)*
  ...
  (3*4^(1 - d)*d*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(psq + s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/
   (Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(4*psq + s - 4*t)*
  ...
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*gZlL*gZlR*mm^2*(2*psq + 5*s - 2*t)*
