...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
   ...
   ((I*EL^5*gAl^3*mm^2*s*(aa*((-2 + d)^2*gZlL^2*(mm^2 - psq)^2 + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl^3*mm^2*s*
      (-(aa*((-2 + d)^2*gZlL^2*(mm^2 - psq) + (-2 + d)^2*gZlR^2*
    ...
    (I*EL^5*gAl^3*mm^2*s*(aa*((-2 + d)^2*gZlL^2*(mm^2 - psq) + 
     ...
     (2*Pi)^(2*d) - (I*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl^3*(bb*(d^2*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
          (mm^2 - psq)*s + 4^(1 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*
          (mm^2 - psq - s)*s - 2^(1 + 2*d)*d*Pi^(2*d)*
          (gZlL^2*(2*mm^2 - 2*psq - s)*s + gZlR^2*(2*mm^2 - 2*psq - s)*s + 
           4*gZlL*gZlR*mm^2*(psq - t))) + 
       aa*(-(4^(1 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq - s)*s) - 
         d^2*(2*Pi)^(2*d)*(mm^2 - psq)*(-8*gZlL*gZlR*mm^2 + gZlL^2*s + 
           gZlR^2*s) + 2^(1 + 2*d)*d*Pi^(2*d)*(gZlL^2*(2*mm^2 - 2*psq - s)*
            s + gZlR^2*(2*mm^2 - 2*psq - s)*s - 4*gZlL*gZlR*mm^2*
            (2*mm^2 - 3*psq + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2]])/Pi^(4*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)^2*EL^5*gAl^3*
