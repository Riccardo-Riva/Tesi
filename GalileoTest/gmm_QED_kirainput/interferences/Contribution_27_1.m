...
(PropList[KiraPropagator[q1, mz*Sqrt[GaugeXi[Q]]], 
  ...
  (((I/16)*(12 - 7*d + d^2)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)*(gZuL - gZuR)*
     mm^2*(2*mm^2 - s - 2*t)*SPList[SP[p1, q1]])/(Pi^4*(mz^2 - s)) + 
   ((I/16)*(12 - 7*d + d^2)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)*(gZuL - gZuR)*
     mm^2*(2*mm^2 - s - 2*t)*SPList[SP[p2, q1]])/(Pi^4*(mz^2 - s)) - 
   ((I/16)*(12 - 7*d + d^2)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)*(gZuL - gZuR)*
     mm^2*(2*mm^2 - s - 2*t)*SPList[SP[p3, q1]])/(Pi^4*(mz^2 - s)) - 
   ((I/16)*(12 - 7*d + d^2)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)*(gZuL - gZuR)*
     mm^2*(2*mm^2 - s - 2*t)*SPList[SP[p4, q1]])/(Pi^4*(mz^2 - s)) + 
   ((I/16)*EL^6*gAl*gAu*gXll^2*mm^2*
   ...
   ((I/4)*EL^6*gAl*gAu*gXll^2*((-4 + d)*gZlL*gZuL - (-2 + d)*gZlR*gZuL - 
   ...
   ((I/2)*EL^6*gAl*gAu*gXll^2*(gZlL + gZlR)*(gZuL + gZuR)*mm^2*(2*mu^2 + s)*
