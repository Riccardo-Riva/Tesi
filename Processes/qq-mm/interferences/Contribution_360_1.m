...
(PropList[KiraPropagator[q1, mh], KiraPropagator[-p1 - p2 + q1, 
    mz*Sqrt[GaugeXi[Q]]]]*
  (((-I/4)*EL^6*gAl*gAu*gHXZ^2*(gZlR*gZuL*(2*(-3 + d)*mm^2 + 2*mu^2 + 4*s - 
   ...
   ((I/2)*EL^6*gAl*gAu*gHXZ^2*(gZlR*gZuL*(2*mm^2 + 4*mu^2 + 4*s - d*s - 
   ...
   (I*EL^6*gAl*gAu*gHXZ^2*(gZlL + gZlR)*(gZuL + gZuR)*(2*mu^2 + s)*
