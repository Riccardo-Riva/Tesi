...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p2 + q1, mz], 
  ...
  ((2^(1 - 2*d)*EL^5*ggpgpAZ*ggpgpZ*
     (aa*(gZlL^2*(psq^2 + mm^2*(psq - s)) + gZlR^2*(psq^2 + mm^2*(psq - s)) + 
        2*gZlL*gZlR*mm^2*(-2*psq + s)) - bb*(gZlL^2*psq*(mm^2 + psq - s) + 
        gZlR^2*psq*(mm^2 + psq - s) + 2*gZlL*gZlR*mm^2*(-2*psq + s)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*(aa - bb)*EL^5*ggpgpAZ*ggpgpZ*gZlL*gZlR*mm^2*(2*psq - s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*ggpgpAZ*ggpgpZ*(aa*(gZlL - gZlR)^2*mm^2 - 
      bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq))*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*ggpgpAZ*ggpgpZ*
