...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*4^(1 - d)*EL^5*gAl*gZlL*gZlR*mm^4*s*
    ...
    (I*4^(1 - d)*EL^5*gAl*gZlL*gZlR*mm^2*(-2*aa*(gZlL^2 + gZlR^2)*s*
      ...
      SPList[SP[p1, q2]])/Pi^(4*d) - (I*4^(1 - d)*EL^5*gAl*gZlL*gZlR*mm^2*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*mm^2*
      ...
      gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa + bb)*(-2 + d)*EL^5*gAl*gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*(gZlL^2 + gZlR^2)*mm^2*s*
      ...
      gZlR*(gZlL^2 + gZlR^2)*mm^2*(bb*(psq - s - t) + 
    ...
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl*gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*
