...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (-((4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*(s + t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*(2*mu^2 + s)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*t*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*(s + 2*t)*
   ...
   (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFll*gHFF*gHFW*gWlN*mh^2*mm^2*(mu^2 - t)*
