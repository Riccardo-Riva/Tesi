...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl^3*gAu*gWlN*gWNl*((-4 + d^2)*psq^4 + 
    ...
    (2^(1 - 2*d)*EL^6*gAl^3*gAu*gWlN*gWNl*
      ((-2 + d)*mm^4*s*((2 + d)*psq - 2*t - d*(s + t)) + 
       s*((20 - 12*d + d^2)*psq^3 - 8*(-2 + d)*psq*t*(2*s + 3*t) - 
         (-2 + d)*psq^2*((-6 + d)*s + (-26 + d)*t) + 4*(-2 + d)*t*
          (s^2 + 3*s*t + 2*t^2)) + 2*(-2 + d)*mm^2*
    ...
    (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*
      ...
      gWlN*gWNl*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*((-6 + d)*psq^2 + 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*((14 - 5*d)*psq^2 + 
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*
      ...
      gWlN*gWNl*(psq^2 + mm^2*s + t^2 - psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(psq^2 + mm^2*s + 
       (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(psq^2 + mm^2*s + 
       (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
    ...
    (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(psq - t)^2*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*
      ...
      gWNl*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*
      gWlN*gWNl*(-psq + s + t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(psq - t)^2*
