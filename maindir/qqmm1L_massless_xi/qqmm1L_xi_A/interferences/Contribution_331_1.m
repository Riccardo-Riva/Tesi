...
PropList[KiraPropagator[p1 - q1, 0], KiraPropagator[-p2 - q1, 0]]*
 ((I*EL^6*gAl^3*gAu*
  ...
  (I*2^(1 - d)*(-3 + d)*EL^6*gAl^3*gAu*(gZlL - gZlR)*(gZuL - gZuR)*(s + 2*t)*
    \[Mu]^(4 - d)*SPList[SP[p1, p3]])/(Pi^d*s*(-mz^2 + s)) - 
  (I*EL^6*gAl^3*gAu*((2^(1 - d)*(gZlL + gZlR)*(gZuL + gZuR)*
     ...
     (gZlL*gZuL*((10 - 6*d + d^2)*s^2 - 2*(-5 + d)*s*t + 4*t^2) + 
      ...
      (2*Pi)^d)*\[Mu]^(4 - d)*SPList[SP[p1, q1]])/((mz^2 - s)*s^2) - 
  (I*EL^6*gAl^3*gAu*
    (-(gZlR*(gZuR*(-((8 - 6*d + d^2)*s^2) - 2*(-5 + d)*s*t + 4*t^2) + 
        gZuL*((-2 + d)^2*s^2 + 2*(-1 + d)*s*t + 4*t^2))) + 
     gZlL*(gZuL*((8 - 6*d + d^2)*s^2 + 2*(-5 + d)*s*t - 4*t^2) - 
  ...
  (I*2^(2 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)*(gZuL + gZuR)*(s - 2*t)*
    \[Mu]^(4 - d)*SPList[SP[p1, p2], SP[p1, p3]])/(Pi^d*s^2*(-mz^2 + s)) + 
  (I*2^(2 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)*(gZuL + gZuR)*\[Mu]^(4 - d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^d*s*(-mz^2 + s)) + 
  (I*2^(3 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)*(gZuL + gZuR)*t*\[Mu]^(4 - d)*
  ...
  (I*2^(2 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)*(gZuL + gZuR)*(3*s + 2*t)*
    \[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p1, q1]])/(Pi^d*s^2*(-mz^2 + s)) + 
  (I*2^(2 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)*(gZuL + gZuR)*(s - 2*t)*
    \[Mu]^(4 - d)*SPList[SP[p1, p3], SP[p2, q1]])/(Pi^d*s^2*(-mz^2 + s)) - 
