   ...
   (-((2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(mm^2 - psq)*
     ...
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      (mm^2*((-42 + 20*d)*psq^2 + psq*(24*s - 17*d*s + 84*t - 40*d*t) + 
         (s + t)*(-6*s + 5*d*s - 42*t + 20*d*t)) + 
       2*((16 - 6*d)*psq^3 + 2*t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
         psq^2*((-9 + 2*d)*s + 2*(-18 + 7*d)*t) + 
         psq*(s^2 + (33 - 10*d)*s*t + 2*(12 - 5*d)*t^2)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(-4*(-5 + 2*d)*psq^3 + 
       4*(-2 + d)*t*(s + t)^2 + 4*psq^2*((-2 + d)*s + (-12 + 5*d)*t) - 
       2*psq*(s^2 + 2*(-9 + 4*d)*s*t + 2*(-9 + 4*d)*t^2) + 
       mm^2*((-46 + 20*d)*psq^2 + (-26 + 8*d)*s^2 + 3*(-20 + 9*d)*s*t + 
         2*(-23 + 10*d)*t^2 + psq*((48 - 23*d)*s + 92*t - 40*d*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      (mm^2*(4*(-1 + d)*psq^2 + (-8 + d)*s^2 + 8*psq*t + 4*d*s*t + 
         4*(-1 + d)*t^2 - 4*d*psq*(s + 2*t)) - 
       2*(2*(-2 + d)*psq^3 - 2*(-2 + d)*t*(s + t)^2 + 
         psq^2*((5 - 2*d)*s - 6*(-2 + d)*t) + psq*t*((-13 + 6*d)*s + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(-4*psq^3 + psq^2*(s + 12*t) + 
       2*mm^2*(psq - s - t)*(2*(-1 + d)*psq + 2*s - d*s + 2*t - 2*d*t) + 
       2*psq*(s^2 - 4*s*t - 6*t^2) + t*(3*s^2 + 7*s*t + 4*t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(-psq + s + t)*
      (-6*(-3 + 2*d)*psq + 7*(-2 + d)*s + 6*(-3 + 2*d)*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      (mm^2*(2*(-11 + 6*d)*psq^2 + (20 - 9*d)*psq*s + (-10 + d)*s^2 + 
         4*(11 - 6*d)*psq*t + (-8 + 5*d)*s*t + 2*(-11 + 6*d)*t^2) + 
       4*((-5 + 2*d)*psq^3 + (12 - 5*d)*psq^2*t - (-2 + d)*t^2*(s + t) - 
         psq*(s^2 + (5 - 2*d)*s*t + (9 - 4*d)*t^2)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*(-4 + 5*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
     Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      (2*(-2 + d)*psq^3 - 2*(-2 + d)*t^2*(s + t) + 
       mm^2*s*((2 - 3*d)*s - 7*(-2 + d)*t) + psq^2*(s - 6*(-2 + d)*t) + 
       psq*(7*(-2 + d)*mm^2*s - 3*s^2 + (-5 + 2*d)*s*t + 6*(-2 + d)*t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(4*(-1 + d)*psq^2 - 
       6*(-4 + 3*d)*psq*s + (-16 + 9*d)*s^2 - 8*(-1 + d)*psq*t + 
       6*(-4 + 3*d)*s*t + 4*(-1 + d)*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(-4*psq^3 - psq^2*(s - 12*t) + 
       2*psq*(mm^2*s + s^2 - 2*s*t - 6*t^2) + 
       (s + t)*(-2*mm^2*s + t*(s + 4*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(2*(2 + d)*psq^3 + 
       t*(s + t)*((-14 + d)*s + 2*(-6 + d)*t) + mm^2*(psq - s - t)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(-4*(-2 + d)*psq^3 - 
       mm^2*(psq - t)*(6*(-3 + 2*d)*psq + (16 - 7*d)*s + 6*(3 - 2*d)*t) + 
       4*t*(s + t)*(2*s + (-2 + d)*t) + 2*psq^2*(5*s + 6*(-2 + d)*t) - 
       2*psq*t*((5 + 2*d)*s + 6*(-2 + d)*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(4*(-2 + d)*psq^3 - 
       4*(-2 + d)*t^2*(s + t) - 2*psq^2*(s + 6*(-2 + d)*t) + 
       2*psq*(-2*s^2 + (-3 + 2*d)*s*t + 6*(-2 + d)*t^2) + 
       mm^2*(4*(-1 + d)*psq^2 + (-10 + d)*s^2 + 4*(-3 + d)*s*t + 
         4*(-1 + d)*t^2 - 4*psq*((-3 + d)*s + 2*(-1 + d)*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(2*(2 + d)*psq^3 - 
       (-14 + d)*psq*t*(3*s + 2*t) + t*(s + t)*((-14 + d)*s + 2*(-6 + d)*t) + 
       mm^2*(psq - t)*(4*(-3 + 2*d)*psq + 12*s - 5*d*s + 12*t - 8*d*t) - 
       2*psq^2*(8*s + (10 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      (-4*psq^3 - 4*psq*t*(2*s + 3*t) + 3*psq^2*(s + 4*t) - 
       2*mm^2*(psq - t)*(2*(-1 + d)*psq + 2*s - d*s + 2*t - 2*d*t) + 
       t*(s^2 + 5*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      mm^2*(psq - t)*(-6*(-3 + 2*d)*psq + (-4 + 5*d)*s + 6*(-3 + 2*d)*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(2*(-2 + d)*psq^3 - 
       2*(-2 + d)*t*(s + t)^2 + mm^2*s*((13 - 4*d)*s + (12 - 7*d)*t) + 
       psq^2*((3 - 2*d)*s - 6*(-2 + d)*t) + psq*((-12 + 7*d)*mm^2*s + 
         (s + t)*(s + 6*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(4*(-1 + d)*psq^2 + 
       2*(-8 + 5*d)*psq*s + (4 - 5*d)*s^2 - 8*(-1 + d)*psq*t - 
    ...
    (4^(2 - d)*(-1 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      (2*psq*s + mm^2*(-2*(-1 + d)*psq + (-3 + d)*s + 2*(-1 + d)*t))*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      (psq*s + mm^2*(-2*(-1 + d)*psq + (-2 + d)*s + 2*(-1 + d)*t))*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((-54 + 13*d)*psq^2 + 
       psq*((54 - 15*d)*s + 8*(9 - 2*d)*t) + 
       (s + t)*(4*(-4 + d)*s + 3*(-6 + d)*t) + 
       mm^2*((22 - 8*d)*psq - 16*s + 7*d*s - 22*t + 8*d*t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((52 - 12*d)*psq^2 - 
       (s + t)*((-14 + 3*d)*s + 2*(-8 + d)*t) + 
       mm^2*((-22 + 8*d)*psq + 12*s - 5*d*s + 22*t - 8*d*t) + 
       psq*((-46 + 11*d)*s + 2*(-34 + 7*d)*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(4*(-7 + 2*d)*psq^2 + 
       (s + t)*(3*(-2 + d)*s + 4*t) + psq*((42 - 13*d)*s - 8*(-3 + d)*t) + 
       mm^2*(-6*(-3 + d)*psq + (-16 + 7*d)*s + 6*(-3 + d)*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((22 - 9*d)*psq^2 + 
       mm^2*(2*(-2 + d)*psq + 14*s - 5*d*s + 4*t - 2*d*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(2*(-2 + d)*psq^2 + 
       (-14 + 3*d)*s*(s + 2*t) + psq*((34 - 7*d)*s - 2*(-2 + d)*t) + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
      ...
      ((26 - 7*d)*psq^2 - (s + t)*(2*(-2 + d)*s - (-6 + d)*t) + 
       mm^2*(6*(-3 + d)*psq + (12 - 5*d)*s - 6*(-3 + d)*t) + 
       psq*(-34*s + 9*d*s - 20*t + 6*d*t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((-34 + 11*d)*psq^2 - 14*s^2 + 
       ...
       2*(-16 + 5*d)*psq*(s + 2*t) + mm^2*(-2*(-2 + d)*psq + (-6 + 4*d)*s + 
         2*(-2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*(-4*(-2 + d)*psq^2 + 
       (20 - 6*d)*psq*s + 3*(-2 + d)*s^2 + 8*(-2 + d)*psq*t + 
       2*(-10 + 3*d)*s*t - 4*(-2 + d)*t^2)*\[Mu]^(8 - 2*d)*
