...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
   ...
   ((4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(mm^2 + psq)*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(mm^4*(psq - t) + 
       ...
       mm^2*(3*psq^2 + s^2 + 8*s*t + 9*t^2 - 4*psq*(s + 3*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(4*mm^2 - 6*psq + s + 2*t)*
      ...
      mm^2*(psq*(-6*psq^2 + s^2 - 3*psq*(s - 4*t) - 5*s*t - 6*t^2) + 
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(mm^2*(psq - t) + 
       psq*(psq - s - t))*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p2, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
      (psq^3 - psq^2*(s - 2*t) + 2*t*(s^2 + 3*s*t + 2*t^2) - 
       psq*(s^2 + 5*s*t + 7*t^2) + mm^2*(3*psq^2 + s^2 + 3*s*t + 3*t^2 - 
         3*psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
    ...
    (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(mm^2 - psq)*(2*psq - s - 2*t)*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*
      (psq^3 - psq^2*s + mm^2*(psq - t)^2 - psq*t*(2*s + 3*t) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*
      mm^2*(psq - t)*(mm^2*(-psq + t) + psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq^2 + 2*mm^2*s + 
       t*(s + t) - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (4^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[p3, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFFA*gFll^2*mm^2*(psq - t)^2*
