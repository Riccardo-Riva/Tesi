...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
   ...
   (-((4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*psq*(psq - s - t)*
       (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
        SP[p1, q2]])/(Pi^(2*d)*s)) + (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*
      gZNL^2*mm^2*psq*(psq - t)*(psq - s - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*
      (-(psq*s) + 2*mm^2*(psq - t))*(-psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*
      (mm^2*(psq - t) + psq*(psq - s - t))*(-psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*psq*(psq - t)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*
      gZNL^2*mm^2*psq*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*psq*(psq - t)^2*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*
      (-(psq*s) + 2*mm^2*(psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*
      gZNL^2*mm^2*(mm^2*(psq - t) + psq*(psq - s - t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*(mm^2 - psq)*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/
     (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*(psq - t)*
      ...
      gZNL^2*mm^2*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*
      (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*
      (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*(psq - t)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p3, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*
      gZNL^2*mm^2*(psq - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[p3, q1]])/Pi^(2*d) - (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*
      gZNL^2*mm^2*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1], SP[q1, q1]])/Pi^(2*d) + 
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[p3, q2]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*
     ...
     Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gZNL^2*mm^2*(2*psq - s - 2*t)*
