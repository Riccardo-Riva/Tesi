...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*mm^2*t*(s + t)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*mm^2*(s + t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*mm^2*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*(mm^2*s - t*(s + t))*
