...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*(aa*(mm^2 + psq - s - 2*t) + 
    ...
    Pi^(2*d) + (I*4^(2 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(2*bb*(psq - s - t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
     (aa*psq*s + aa*mm^2*(7*psq - 5*s - 7*t) + bb*mm^2*(-7*psq + 4*s + 7*t))*
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
     (bb*psq*s + aa*mm^2*(7*psq - 3*s - 7*t) + bb*mm^2*(-7*psq + 2*s + 7*t))*
