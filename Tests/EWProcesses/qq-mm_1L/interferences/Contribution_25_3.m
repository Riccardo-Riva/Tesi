...
((I/16)*EL^6*gXll^2*mm^2*gAl[1]^2*gAl[2]^2*KiraPropagator[q1, mz]*
  KiraPropagator[p3 + q1, mm]*KiraPropagator[-p1 - p2 + p3 + q1, mm]*
  (4*(-mm^2 + s + t)*SP[p1, q1]^2 + 4*(mm^2 - t)*SP[p2, q1]^2 - 
   4*(4*me^2 + 2*mm^2 + s - 2*t)*SP[p2, q1]*SP[p3, q1] + 
   16*me^2*SP[p3, q1]^2 + 8*s*SP[p3, q1]^2 - 
   2*SP[p1, q1]*(2*s*SP[p2, q1] + (8*me^2 - 4*mm^2 + 6*s + 4*t)*SP[p3, q1]) - 
