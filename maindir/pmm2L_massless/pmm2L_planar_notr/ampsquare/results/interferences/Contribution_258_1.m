(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mz], 
  ...
  ((4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ((-2 + d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ((-2 + d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((52 - 18*d + d^2)*s^2 + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((32 - 14*d + d^2)*s^2 - 
      28*s*t - 4*(2 + d)*t^2)*SPList[SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*(18 - 9*d + d^2)*EL^8*gAl^4*gAu^2*
     (gZlL^2 + gZlR^2)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
   (4^(2 - d)*(18 - 9*d + d^2)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(3 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-5 + d)*s + (-4 + d)*t)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(4*s + 3*t)*
   ...
   (4^(3 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*((-3 + d)*s + (-4 + d)*t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-4 + d)^2*EL^8*gAl^4*gAu^2*
     (gZlL^2 + gZlR^2)*(s + 2*t)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
     ((20 - 10*d + d^2)*s - 2*(-2 + d)*t)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*
     (gZlL^2 + gZlR^2)*(2*(-3 + d)*s + (-10 + 3*d)*t)*
