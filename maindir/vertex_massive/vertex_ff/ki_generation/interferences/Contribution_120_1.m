   ...
   ((2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^6*
    ...
    (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     ...
     Pi^(2*d) + (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^2*
      ...
      SPList[SP[p3, q2]])/Pi^(4*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*
      gHll^2*(gZlL^2 + gZlR^2)*mm^4*(2*psq^3 + 2*psq*t*(2*s + 3*t) - 
      ...
      (-((gZlL^2 + gZlR^2)*(-(psq*s*(psq + s + t)) + 
       ...
       d*(4*gZlL*gZlR*mm^2*(psq - t)*(mm^2 - 2*psq + s + t) + 
         gZlL^2*(-(psq^2*s) + mm^2*(4*psq^2 - 2*psq*(s + 4*t) + 
           ...
           mm^2*(4*psq^2 - 2*psq*(s + 4*t) + t*(3*s + 4*t)))))*
    ...
    (4^(1 - d)*(-6 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*
      (gZlL^2 + gZlR^2)*mm^2*(-psq + s + t)*(mm^4 + psq^2 + 
       2*mm^2*(-2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p1, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (-8*d*gZlL*gZlR*mm^2*(psq - t)*(psq - s - t) + 
       gZlL^2*(psq*(2*(-2 + d)*psq^2 + (8 - 3*d)*psq*s + (-2 + d)*s^2 - 
           4*(-2 + d)*psq*t + (-8 + 3*d)*s*t + 2*(-2 + d)*t^2) + 
         mm^2*(6*(-2 + d)*psq^2 + (20 - 7*d)*psq*s + (-2 + d)*s^2 - 
           12*(-2 + d)*psq*t + (-20 + 7*d)*s*t + 6*(-2 + d)*t^2)) + 
       gZlR^2*(psq*(2*(-2 + d)*psq^2 + (8 - 3*d)*psq*s + (-2 + d)*s^2 - 
           4*(-2 + d)*psq*t + (-8 + 3*d)*s*t + 2*(-2 + d)*t^2) + 
         mm^2*(6*(-2 + d)*psq^2 + (20 - 7*d)*psq*s + (-2 + d)*s^2 - 
           12*(-2 + d)*psq*t + (-20 + 7*d)*s*t + 6*(-2 + d)*t^2)))*
    ...
    (4^(1 - d)*(-6 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*
      (gZlL^2 + gZlR^2)*mm^2*(3*mm^2 + psq)*(2*psq - s - 2*t)*(psq - t)*
