  ...
  ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHHZZ*(gZlL^2 + gZlR^2)*
   ...
   ((-2 + d)*EL^8*gAl^2*gAu^2*gHHZZ*(gZlL^2 + gZlR^2)*
    ...
    ((2*Pi)^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHHZZ*
     ...
     gHHZZ*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHHZZ*
     (gZlL^2 + gZlR^2)*(3*s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHHZZ*(gZlL^2 + gZlR^2)*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHHZZ*(gZlL^2 + gZlR^2)*(s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHHZZ*(gZlL^2 + gZlR^2)*
