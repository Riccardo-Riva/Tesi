...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  ((4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*t*(s + t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*t^2*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*t*(s + t)*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*t*(s + t)*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*t*(s + t)*
