...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[-q1 - q2, mz], 
 ...
 ((EL^5*gAl*gXll^2*mm^4*s*
    ...
    \[Mu]^(8 - 2*d))/2 + (2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^4*(mm^2 - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  EL^5*gAl*gXll^2*mm^4*(-((2^(1 - 2*d)*(aa - bb)*(-4 + d)*gZlL*gZlR*
       (mm^2 - s)*s)/Pi^(2*d)) + 
  ...
  (EL^5*gAl*gXll^2*mm^2*
    (-((4^(1 - d)*(aa - bb)*mm^2*((-2 + d)*gZlL^2*(mm^2 + psq) + 
         (-2 + d)*gZlR^2*(mm^2 + psq) + (-4 + d)*gZlL*gZlR*(mm^2 - s))*s)/
       Pi^(2*d)) + (2^(1 - 2*d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
       (mm^2 + psq)*s*(mm^2 + s))/Pi^(2*d) + 
     (2^(1 - 4*d)*(-aa + bb)*s*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq)*
          (mm^2 - s)) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 + psq)*
         (mm^2 - s) + 4^(1 + d)*(-4 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*s))/
      Pi^(4*d) - (s*(aa*(-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(4*psq - s)) - 
          (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq)*(mm^2 + s) - 
          (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2 - psq)*(mm^2 + s)) + 
        bb*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(4*psq - s) - 
          (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq)*(mm^2 + s) - 
    ...
    SPList[SP[p1, q2]])/2 + (2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*
  ...
  (EL^5*gAl*gXll^2*mm^2*s*(-(((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*mm^2*
  ...
  EL^5*gAl*gXll^2*mm^2*((2^(1 - 2*d)*(aa - bb)*(-4 + d)*gZlL*gZlR*mm^2*s)/
  ...
  (EL^5*gAl*gXll^2*mm^2*(aa*(8*gZlL*gZlR*mm^2*(-(d*psq) + s) + 
       (-2 + d)*gZlL^2*(4*mm^4 - 3*mm^2*s + psq*s) + 
       (-2 + d)*gZlR^2*(4*mm^4 - 3*mm^2*s + psq*s)) - 
     bb*(8*gZlL*gZlR*mm^2*(-(d*psq) + s) + (-2 + d)*gZlL^2*
        (-3*psq*s + mm^2*(4*psq + s)) + (-2 + d)*gZlR^2*
        (-3*psq*s + mm^2*(4*psq + s))))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*mm^2*
    ((-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s - 
     mm^2*((-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq) - 
       (-4 + d)*gZlL*gZlR*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   Pi^(2*d) + EL^5*gAl*gXll^2*mm^2*
   (-((2^(1 - 2*d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s)/
      Pi^(2*d)) + (2*aa*(gZlL^2 + gZlR^2)*(mm^2 - 3*psq)*s - 
  ...
  (2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (2*bb*(4*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 - 5*psq) + gZlR^2*(mm^2 - 5*psq))*
      s + 2*aa*(-4*gZlL*gZlR*mm^2 + gZlL^2*(5*mm^2 - psq) + 
       gZlR^2*(5*mm^2 - psq))*s - bb*d*(gZlL^2*(mm^2 - 5*psq)*s + 
       gZlR^2*(mm^2 - 5*psq)*s + 4*gZlL*gZlR*mm^2*(-2*psq + s)) + 
     aa*d*(gZlL^2*(-5*mm^2 + psq)*s + gZlR^2*(-5*mm^2 + psq)*s + 
  ...
  (aa - bb)*EL^5*gAl*gXll^2*mm^2*
   (-((2^(1 - 2*d)*(-4 + d)*gZlL*gZlR*mm^2)/Pi^(2*d)) + 
    ((-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 + psq))/(2*Pi)^(2*d))*s*\[Mu]^(8 - 2*d)*
   SPList[SP[p2, q2], SP[q2, q2]] - (2^(-1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*
