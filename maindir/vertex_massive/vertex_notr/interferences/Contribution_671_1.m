...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
 ...
 ((2^(1 - 2*d)*EL^6*gAl*gWlN^2*gWNl^2*gWWA*s^2*((6 - 4*d + d^2)*mm^2 - 
  ...
  (4^(1 - d)*EL^6*gAl*gWlN^2*gWNl^2*gWWA*s*((6 - 4*d + d^2)*mm^2 - 
    ...
    (-((8 - 5*d + d^2)*mm^2) + (8 - 5*d + d^2)*psq + 2*(18 - 9*d + d^2)*s)*
  ...
  (2^(1 - 2*d)*EL^6*gAl*gWlN^2*gWNl^2*gWWA*((8 - 5*d + d^2)*mm^2 - 
     (8 - 5*d + d^2)*psq + (-44 + 27*d - 4*d^2)*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-4 + d)*EL^6*gAl*gWlN^2*gWNl^2*gWWA*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^6*gAl*gWlN^2*gWNl^2*gWWA*((4 + d)*mm^2 + 
     (-28 + 15*d - 2*d^2)*psq + (-32 + 19*d - 2*d^2)*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^6*gAl*gWlN^2*gWNl^2*gWWA*((8 - 6*d + d^2)*mm^2 - 38*s - 
  ...
  (4^(1 - d)*EL^6*gAl*gWlN^2*gWNl^2*gWWA*((-2 + d)^2*mm^2 + 
     ...
     SP[q1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*(-4 + d)*EL^6*gAl*gWlN^2*gWNl^2*
    gWWA*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*(-4 + d)*EL^6*gAl*gWlN^2*gWNl^2*
    gWWA*(-((-1 + d)*mm^2) + (-1 + d)*psq + (-13 + 4*d)*s)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-4 - d + d^2)*EL^6*gAl*gWlN^2*gWNl^2*gWWA*\[Mu]^(8 - 2*d)*
