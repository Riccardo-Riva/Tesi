...
PropList[KiraPropagator[-p3 + q1, 0], KiraPropagator[q2, 0], 
  KiraPropagator[p3 + q2, 0], KiraPropagator[p3 + q2, 0], 
 ...
 (-((4^(1 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-3 + d)*s^2 + s*t + 2*t^2)*
    SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-4 + d)*s - 2*t)*
    SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(s^2 + 3*s*t + 2*t^2)*
    SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-4 + d)*s - 2*t)*
    SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-5 + d)*s^2 - 5*s*t - 2*t^2)*
    SPList[SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 + 3*s*t + 2*t^2)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 + 3*s*t + 2*t^2)*
    SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s + 2*t)*
    SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*t*(s + 2*t)*
    SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s + 2*t)*
    SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 + s*t - 2*t^2)*
  ...
  (2^(3 - 2*d)*(6 - 5*d + d^2)*EL^8*gAl^6*gAu^2*SPList[SP[p3, q2], 
     SP[p3, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*
    ((32 - 14*d + d^2)*s^2 + 4*(-2 + d)*s*t + 4*(-2 + d)*t^2)*
    SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (3*4^(1 - d)*(6 - 5*d + d^2)*EL^8*gAl^6*gAu^2*SPList[SP[p3, q2], 
     SP[q2, q2]])/Pi^(2*d) + ((-2 + d)^2*EL^8*gAl^6*gAu^2*
    ((-4 + d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[q1, q2], SP[q2, q2]])/
   (4^d*Pi^(2*d)*s^2) + ((-2 + d)^2*EL^8*gAl^6*gAu^2*
    ((-4 + d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[q2, q2], SP[q2, q2]])/
   (4^d*Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*(s + t)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*(s + t)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-4 + d)*s + (-6 + d)*t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(-2*s + (-6 + d)*t)*
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*SPList[SP[p1, q2], SP[p2, q2], 
    ...
    ((24 - 12*d + d^2)*s - 2*(-2 + d)*t)*SPList[SP[p1, q2], SP[p3, q1], 
  ...
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*SPList[SP[p2, q1], SP[p2, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*
  ...
  (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*SPList[SP[p2, q2], SP[p2, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*
    SPList[SP[p2, q2], SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*SPList[SP[p2, q2], SP[p2, q2], 
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*(s - 2*t)*
