...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  (((-I)*(aa + bb)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)^2*s*
   ...
   (I*4^(1 - d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
    ...
    Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*
     ...
     gZNL*mm^2*(mm^2 - psq)*(-2*s + d*(psq - t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gFll^2*gZNL*mm^2*
    ...
    (2*Pi)^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - s - 2*t) + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*
     mm^2*(bb*(psq - t) + aa*(mm^2 - 2*psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - psq - t) + 
     ...
     (bb*(-2*psq + d*(mm^2 - t) + 2*t) + aa*((-4 + d)*mm^2 - 2*(-3 + d)*psq + 
      ...
      SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*
     mm^2*(bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*gZlR*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[p3, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*
     (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
