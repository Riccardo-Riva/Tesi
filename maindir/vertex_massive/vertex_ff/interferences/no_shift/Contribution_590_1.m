...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*(psq^2 - 2*psq*t + t*(s + t))*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*mm^2*
     (gZlL^4*((8 - 2*d + d^2)*psq^3 + (8 - 6*d + d^2)*mm^2*(psq - t)*
         (psq - s - t) - 4*t*(s + t)*(2*s + d*t) + (4 + d)*psq*t*
         (4*s + (2 + d)*t) - 2*psq^2*(4*s + (8 + d^2)*t)) + 
      gZlR^4*((8 - 2*d + d^2)*psq^3 + (8 - 6*d + d^2)*mm^2*(psq - t)*
         (psq - s - t) - 4*t*(s + t)*(2*s + d*t) + (4 + d)*psq*t*
         (4*s + (2 + d)*t) - 2*psq^2*(4*s + (8 + d^2)*t)) - 
      gZlL^3*gZlR*(-2*(12 - 8*d + d^2)*psq^3 + 4*(-2 + d)*mm^2*(psq - t)*
     ...
     (-((-2 + d)*gZlL^3*gZlR*s*(2*(-2 + d)*psq^2 + (-2 + d)*psq*(s - 2*t) - 
      ...
      2*gZlL^2*gZlR^2*s*(d^2*(psq*s + mm^2*(4*psq - 3*s - 4*t)) + 
        4*s*(-mm^2 - psq + s + 2*t) - 2*d*(mm^2*(4*psq - 5*s - 4*t) + 
          s*(psq + s + 2*t))) + (-2 + d)*gZlL^4*
       (8*psq^3 + psq^2*((-8 + d)*s - 24*t) - (s + t)*((-4 + d)*mm^2*s + 
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*((-2 + d)^2*gZlL^2 - 
    ...
    (Pi^(2*d)*s) + (2^(3 - 4*d)*EL^6*gAl*gAu*
     (2^(1 + 2*d)*gZlL^2*gZlR^2*mm^2*Pi^(2*d)*(psq - s - t)*
      ...
      gZlL^4*(mm^2*(2*Pi)^(2*d)*(2*(-4 + d)*psq^2 + 
          ...
          psq^2*((-5 + d)*s + (-14 + 5*d)*t) + psq*(s^2 + (15 - 4*d)*s*t + 
            2*(5 - 2*d)*t^2))) + 
      gZlR^4*(mm^2*(2*Pi)^(2*d)*(2*(-4 + d)*psq^2 + 
          psq*((-2 + d)*s - 4*(-4 + d)*t) - (s + t)*((-2 + d)*s - 
            2*(-4 + d)*t)) + 2^(1 + 2*d)*Pi^(2*d)*(-2*(-3 + d)*psq^3 + 
          t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
          psq^2*((-5 + d)*s + (-14 + 5*d)*t) + psq*(s^2 + (15 - 4*d)*s*t + 
     ...
     (2^(1 + 2*d)*gZlL^2*gZlR^2*mm^2*Pi^(2*d)*(psq - s - t)*
       (4*(4 - 6*d + d^2)*mm^2 + (-20 + 42*d - 7*d^2)*psq - 8*s - 8*d*s + 
        2*d^2*s + 4*t - 18*d*t + 3*d^2*t) + gZlL^3*gZlR*mm^2*(psq - s - t)*
       (-(4^(1 + d)*(-2 + d)^2*mm^2*Pi^(2*d)) + (2*Pi)^(2*d)*
         (8*(2 - 3*d + d^2)*psq + (12 + 4*d - 3*d^2)*s - 4*(-2 + d)*d*t)) + 
      gZlL*gZlR^3*mm^2*(psq - s - t)*(-(4^(1 + d)*(-2 + d)^2*mm^2*Pi^(2*d)) + 
        (2*Pi)^(2*d)*(8*(2 - 3*d + d^2)*psq + (12 + 4*d - 3*d^2)*s - 
          4*(-2 + d)*d*t)) + gZlL^4*(2^(1 + 2*d)*(8 - 6*d + d^2)*mm^4*
         Pi^(2*d)*(psq - s - t) - mm^2*(2*Pi)^(2*d)*
         ((40 - 22*d + 3*d^2)*psq^2 - 2*psq*((14 - 11*d + 2*d^2)*s + 
            2*(-4 + d)^2*t) + (s + t)*((-2 + d)^2*s + (24 - 10*d + d^2)*t)) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*(-2*gZlL^2*gZlR^2*mm^2*
       (-((4 - 6*d + d^2)*psq^2) + 8*psq*s + (4 - 6*d + d^2)*mm^2*(psq - t) + 
        (4 - 6*d + d^2)*psq*t - 4*s*(s + 2*t)) + gZlL^3*gZlR*mm^2*
       (-((-2 + d)^2*psq^2) + (-2 + d)^2*mm^2*(psq - t) + d*s*(s + 2*t) + 
        psq*(4*t + d^2*t - 2*d*(s + 2*t))) + gZlL*gZlR^3*mm^2*
       (-((-2 + d)^2*psq^2) + (-2 + d)^2*mm^2*(psq - t) + d*s*(s + 2*t) + 
        psq*(4*t + d^2*t - 2*d*(s + 2*t))) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*(gZlL^3*gZlR*mm^2*(-2*(-2 + d)^2*psq^2 - 
      ...
      gZlL^4*(-((8 - 6*d + d^2)*mm^4*(psq - t)) + 
        mm^2*(4*(12 - 7*d + d^2)*psq^2 + (4 + 2*d - d^2)*psq*s + 
          2*(-4 + d)*s^2 + (-88 + 50*d - 7*d^2)*psq*t + (28 - 18*d + 3*d^2)*s*
           t + (40 - 22*d + 3*d^2)*t^2) + (-2 + d)*(-4*psq^3 + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*(-2*gZlL^3*gZlR*mm^2*(2*(-2 + d)^2*psq^2 + 
        (-2 + d)^2*mm^2*s + 4*s^2 - 7*d*s^2 + 2*d^2*s^2 + 12*s*t - 14*d*s*t + 
        4*d^2*s*t + 8*t^2 - 8*d*t^2 + 2*d^2*t^2 - (-2 + d)*psq*
         ((-8 + 5*d)*s + 4*(-2 + d)*t)) - 2*gZlL*gZlR^3*mm^2*
       (2*(-2 + d)^2*psq^2 + (-2 + d)^2*mm^2*s + 4*s^2 - 7*d*s^2 + 
        2*d^2*s^2 + 12*s*t - 14*d*s*t + 4*d^2*s*t + 8*t^2 - 8*d*t^2 + 
        2*d^2*t^2 - (-2 + d)*psq*((-8 + 5*d)*s + 4*(-2 + d)*t)) + 
   ...
   (4^(1 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*(psq - s - t)*
     (2^(1 + 2*d)*(4 - 6*d + d^2)*gZlL*gZlR*Pi^(2*d)*(2*mm^2 - 3*psq + s + 
        t) - gZlL^2*(2*Pi)^(2*d)*(2*(-2 + d)^2*mm^2 - 4*(2 - 3*d + d^2)*psq - 
        12*s + 2*d*s + d^2*s - 4*d*t + 2*d^2*t) - gZlR^2*(2*Pi)^(2*d)*
       (2*(-2 + d)^2*mm^2 - 4*(2 - 3*d + d^2)*psq - 12*s + 2*d*s + d^2*s - 
        4*d*t + 2*d^2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    (Pi^(4*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*
     (gZlL^3*gZlR*mm^2*(2*(-2 + d)^2*psq^2 - 2*(-2 + d)^2*mm^2*(psq - t) + 
        psq*((12 - 4*d + d^2)*s - 2*(-2 + d)^2*t) - 
        s*(2*d*(s - 2*t) + 12*t + d^2*t)) + gZlL*gZlR^3*mm^2*
       (2*(-2 + d)^2*psq^2 - 2*(-2 + d)^2*mm^2*(psq - t) + 
        psq*((12 - 4*d + d^2)*s - 2*(-2 + d)^2*t) - 
      ...
      gZlL^4*(8*(-3 + d)*psq^3 + (8 - 6*d + d^2)*mm^4*(psq - t) - 
        ...
        mm^2*(2*(24 - 10*d + d^2)*psq^2 + (s + t)*(2*(-2 + d)*s + 
            (56 - 26*d + 3*d^2)*t) - psq*((-2 + d)^2*s + (104 - 46*d + 5*d^2)*
             t))) + gZlR^4*(8*(-3 + d)*psq^3 + (8 - 6*d + d^2)*mm^4*
         (psq - t) - 4*(-2 + d)*t^2*(s + t) - 2*psq*(s + 2*t)*
         ((-2 + d)*s + 2*(5 - 2*d)*t) - psq^2*((20 - 10*d + d^2)*s + 
          4*(-14 + 5*d)*t) + mm^2*(2*(24 - 10*d + d^2)*psq^2 + 
          (s + t)*(2*(-2 + d)*s + (56 - 26*d + 3*d^2)*t) - 
          psq*((-2 + d)^2*s + (104 - 46*d + 5*d^2)*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - 2*d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
     (-(4^(1 + d)*(4 - 6*d + d^2)*gZlL*gZlR*Pi^(2*d)*(mm^2 - psq)*
        (psq - t)) + gZlL^2*(2^(1 + 2*d)*(-2 + d)^2*mm^2*Pi^(2*d)*(psq - t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gZlL*gZlR*mm^2*
     (-4*(4 - 6*d + d^2)*gZlL*gZlR*(psq^2 + mm^2*s + (s + t)^2 - 
        psq*(3*s + 2*t)) + gZlL^2*(4*(-2 + d)^2*psq^2 + 2*(-2 + d)^2*mm^2*s - 
        4*s^2 - 6*d*s^2 + 3*d^2*s^2 + 24*s*t - 28*d*s*t + 8*d^2*s*t + 
        16*t^2 - 16*d*t^2 + 4*d^2*t^2 - 2*(-2 + d)*psq*((-8 + 5*d)*s + 
          4*(-2 + d)*t)) + gZlR^2*(4*(-2 + d)^2*psq^2 + 2*(-2 + d)^2*mm^2*s - 
        4*s^2 - 6*d*s^2 + 3*d^2*s^2 + 24*s*t - 28*d*s*t + 8*d^2*s*t + 
        16*t^2 - 16*d*t^2 + 4*d^2*t^2 - 2*(-2 + d)*psq*((-8 + 5*d)*s + 
          4*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*
     (-((-2 + d)^2*gZlL^3*gZlR*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
         3*s*t + 2*t^2)) - (-2 + d)^2*gZlL*gZlR^3*mm^2*
       (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
      (-4 + d)*gZlL^4*(8*psq^3 + psq^2*((14 - 3*d)*s + 2*(-14 + d)*t) + 
        2*t*(s + t)*(2*s + (-6 + d)*t) + mm^2*(psq - s - t)*
         (2*(-2 + d)*psq - (2 + d)*s - 2*(-2 + d)*t) + 
        psq*((-6 + d)*s^2 + (-6 + d)*s*t - 4*(-8 + d)*t^2)) + 
      (-4 + d)*gZlR^4*(8*psq^3 + psq^2*((14 - 3*d)*s + 2*(-14 + d)*t) + 
        2*t*(s + t)*(2*s + (-6 + d)*t) + mm^2*(psq - s - t)*
         (2*(-2 + d)*psq - (2 + d)*s - 2*(-2 + d)*t) + 
        psq*((-6 + d)*s^2 + (-6 + d)*s*t - 4*(-8 + d)*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*(-((-2 + d)^2*gZlL^3*gZlR*mm^2*
        (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)) + 
      2*(4 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*(2*psq^2 - 3*psq*s + s^2 - 
        4*psq*t + 3*s*t + 2*t^2) - (-2 + d)^2*gZlL*gZlR^3*mm^2*
       (2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
      gZlL^4*(-((32 - 14*d + d^2)*psq^3) + psq^2*((4 + 4*d - d^2)*s + 
   ...
   (2^(3 - 4*d)*EL^6*gAl*gAu*(-(4^(1 + d)*gZlL^2*gZlR^2*mm^2*Pi^(2*d)*
      ...
      SP[p3, q1]])/(Pi^(4*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*(4*gZlL^2*gZlR^2*mm^2*((4 - 6*d + d^2)*psq^2 + 
        (2 + d)*s^2 + 8*s*t + (4 - 6*d + d^2)*t^2 - 
        2*psq*(4*s + (4 - 6*d + d^2)*t)) - 2*gZlL^3*gZlR*mm^2*
       (2*(-2 + d)^2*psq^2 + 2*d^2*t^2 + 4*t*(s + 2*t) + 
        2*(-2 + d)*psq*(s - 2*(-2 + d)*t) - d*(s^2 + 2*s*t + 8*t^2)) - 
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*(-((-2 + d)^2*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t)*
        (psq - t)) - (-2 + d)^2*gZlL*gZlR^3*mm^2*(2*psq - s - 2*t)*
       (psq - t) + gZlL^4*((8 - 10*d + d^2)*psq^3 + (8 - 6*d + d^2)*mm^2*
         (psq - t)*(psq - s - t) + 4*t*(s + t)*(2*s + d*t) + 
        psq*t*(-4*(4 + d)*s + (8 - 18*d + d^2)*t) + 
        2*psq^2*(4*s - (8 - 12*d + d^2)*t)) + 
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*((-2 + d)^2*gZlL^3*gZlR*mm^2*(2*psq - s - 2*t)*
      ...
      gZlR^4*((56 - 22*d + 3*d^2)*psq^3 + (-4 + d)*mm^2*(psq - t)*
         ((-2 + d)*psq - 4*s - (-2 + d)*t) - 2*t*(s + t)*
         (2*(-2 + d)*s + (24 - 8*d + d^2)*t) - 
        psq^2*((16 - 6*d + d^2)*s + 4*(40 - 15*d + 2*d^2)*t) + 
        psq*t*((56 - 18*d + 3*d^2)*s + (152 - 54*d + 7*d^2)*t)))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*(gZlL^3*gZlR*mm^2*(-4*(-2 + d)^2*psq^2 + 
        ...
        4*(-2 + d)*psq*(s - 2*(-2 + d)*t)) + gZlL*gZlR^3*mm^2*
       (-4*(-2 + d)^2*psq^2 + (12 - 6*d + d^2)*s^2 + 4*(-2 + d)*s*t - 
        4*(-2 + d)^2*t^2 - 4*(-2 + d)*psq*(s - 2*(-2 + d)*t)) + 
      2*gZlL^2*gZlR^2*mm^2*(4*(4 - 6*d + d^2)*psq^2 - (-4 + d)^2*s^2 - 
        8*s*t + 4*(4 - 6*d + d^2)*t^2 + 8*psq*(s - (4 - 6*d + d^2)*t)) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*((-2 + d)^2*gZlL^3*gZlR*mm^2*s*
       ...
       (-2*psq + s + 2*t) - 4*gZlL^4*(2*(-2 + d)*psq^3 + mm^2*s^2 - psq*s^2 + 
        4*(-2 + d)*psq*s*t + 6*(-2 + d)*psq*t^2 - (-2 + d)*psq^2*(s + 6*t) - 
   ...
   (4^(1 - 2*d)*EL^6*gAl*gAu*(-(2^(1 + 2*d)*(4 - 6*d + d^2)*gZlL^2*gZlR^2*
     ...
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/Pi^(4*d) - 
   (2^(1 - 2*d)*(-2 + d)^2*EL^6*gAl*gAu*gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q2, q2]])/
    Pi^(2*d) + (2^(1 - 2*d)*(16 - 10*d + d^2)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*
     (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
     ...
     (gZlL^4 + gZlR^4)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
      ...
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*(16 - 10*d + d^2)*EL^6*gAl*gAu*
     (gZlL^4 + gZlR^4)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
      t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2], 
   ...
   (2^(3 - 4*d)*EL^6*gAl*gAu*
     (-2*d*(gZlL^4*(2*Pi)^(2*d)*(3*mm^2*(psq - 2*s - t) + 
        ...
        3*2^(1 + 2*d)*gZlL^2*gZlR^2*mm^2*Pi^(2*d)*(psq - s - t) - 
        2^(3 + 2*d)*gZlL*gZlR^3*mm^2*Pi^(2*d)*(psq - s - t)) + 
      d^2*(gZlL - gZlR)^2*(gZlL^2 + gZlR^2)*mm^2*(2*Pi)^(2*d)*(psq - s - t) + 
      2^(3 + 2*d)*Pi^(2*d)*(3*gZlL^2*gZlR^2*mm^2*(psq - s - t) + 
        3*gZlL^3*gZlR*mm^2*(-psq + s + t) + 3*gZlL*gZlR^3*mm^2*
         (-psq + s + t) + gZlL^4*(4*psq^2 - 2*mm^2*s + (s + t)^2 - 
          psq*(2*s + 5*t)) + gZlR^4*(4*psq^2 - 2*mm^2*s + (s + t)^2 - 
          psq*(2*s + 5*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(4*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*
     (2*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2*(psq - s - t) - 
      ...
      SP[p2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*(psq - t)*
     (2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s) - (2^(3 - 4*d)*EL^6*gAl*gAu*
     (-(d^2*(gZlL - gZlR)^2*(gZlL^2 + gZlR^2)*mm^2*(2*Pi)^(2*d)*(psq - t)) + 
      2^(1 + 2*d)*d*Pi^(2*d)*(gZlL^4*(psq*(4*psq - s - 4*t) + 
          mm^2*(psq - t)) + gZlR^4*(psq*(4*psq - s - 4*t) + mm^2*(psq - t)) + 
   ...
   (2^(3 - 4*d)*EL^6*gAl*gAu*(-(2^(1 + 2*d)*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2*
        Pi^(2*d)*s) + 2^(1 + 2*d)*(12 - 6*d + d^2)*gZlL^2*gZlR^2*mm^2*
   ...
   (2^(3 - 4*d)*EL^6*gAl*gAu*(2^(1 + 2*d)*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2*
     ...
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(4*d)*s) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*(-2*(12 - 8*d + d^2)*gZlL^3*gZlR*mm^2*
      ...
      2*(12 - 8*d + d^2)*gZlL*gZlR^3*mm^2*(psq - s - t) + 
      gZlL^4*(mm^2*(-((16 - 6*d + d^2)*psq) + 2*d*s + 16*t - 6*d*t + d^2*t) + 
        2*((10 - 5*d + d^2)*psq^2 - psq*((16 - 6*d + d^2)*s + (-2 + d)*d*t) + 
          (s + t)*((-2 + d)*s + (-10 + 3*d)*t))) + 
      gZlR^4*(mm^2*(-((16 - 6*d + d^2)*psq) + 2*d*s + 16*t - 6*d*t + d^2*t) + 
        2*((10 - 5*d + d^2)*psq^2 - psq*((16 - 6*d + d^2)*s + (-2 + d)*d*t) + 
          (s + t)*((-2 + d)*s + (-10 + 3*d)*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*((28 - 14*d + d^2)*psq^2 + 
   ...
   (4^(1 - d)*(8 - 6*d + d^2)*EL^6*gAl*gAu*(gZlL^4 + gZlR^4)*(psq - t)*
     ...
     (psq - t)*(4*(-3 + d)*psq - (-4 + d)^2*s - 4*(-3 + d)*t)*\[Mu]^(8 - 2*d)*
