...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
   ...
   (-((2^(1 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*
    ...
    (2^(1 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*
      ...
      SPList[SP[p3, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*
    ...
    (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*
      (gZlL + gZlR)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*
    ...
    (2^(1 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*
      (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*
    ...
    (2^(1 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*mm^2*
     ...
     Pi^(2*d) - (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ*gHgmgm*gHll*(gZlL + gZlR)*
