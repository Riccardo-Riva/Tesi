...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
 ...
 ((EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*(4*psq^3 - 4*psq^2*(s + 2*t) - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
    ((6 + d)*psq^2 - (-2 + d)*mm^2*(psq - s - t) - 
     psq*((4 + d)*s + (10 + d)*t) + 2*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
    (-((-2 + d)*psq^2) + 2*psq*s + (-2 + d)*mm^2*(psq - t) + (-6 + d)*psq*t + 
     2*t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
    (4*psq^2 + 2*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 2*psq*(s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
    ((-2 + d)*mm^2 - (2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   (Pi^(2*d)*s) - (EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
    (d^2*s^2 + 2*s*(2*mm^2 - 2*psq + 7*s) + 
     2*d*(2*psq^2 - mm^2*s - 4*s^2 + psq*(s - 4*t) + 2*s*t + 2*t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
    (16*s^2 + d^2*s^2 + 4*d*(psq^2 - 2*s^2 - 2*psq*t + s*t + t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-3 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
    ((-2 + d)*mm^2 + (9 - 2*d)*psq - 5*s + d*s - 7*t + d*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
    (18*s + d^2*s + 2*d*(psq - 5*s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*(16*s + d^2*s + 2*d*(psq - 5*s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(4^d*Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*((-2 + d)*mm^2 - 5*psq + 
     2*s + 7*t - d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-3 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*
    (18*s + d^2*s - 2*d*(psq + 4*s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*(16*s + d^2*s - 2*d*(psq + 4*s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(4^d*Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*(-psq + s + t)*
  ...
  (2^(1 - 2*d)*d*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*d*EL^8*gAl^3*gAu^2*gFAW*gFll*gWlN*mm^2*\[Mu]^(8 - 2*d)*
