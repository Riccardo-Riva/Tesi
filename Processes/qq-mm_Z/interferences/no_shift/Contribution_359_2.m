(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  ((I*2^(2 - d)*EL^6*gAl*gFFA*gFFZ*
    ...
    (Pi^d*(mz^2 - s)*(-mzC^2 + s)) - (I*2^(3 - d)*EL^6*gAl*gFFA*gFFZ*
   ...
   (I*2^(3 - d)*EL^6*gAl*gFFA*gFFZ*
     (gZlRC*gZuL*gZuLC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      gZlLC*gZuR*gZuRC*(-((-4 + d)*s) - 2*(-3 + d)*t) + 
      gZlLC*gZuL*gZuLC*((-2 + d)*s + 2*(-3 + d)*t) + 
      gZlRC*gZuR*gZuRC*((-2 + d)*s + 2*(-3 + d)*t))*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
   (I*2^(3 - d)*EL^6*gAl*gFFA*gFFZ*(gZlLC*gZuL*gZuLC*((-6 + d)*s - 2*t) - 
   ...
   (I*2^(3 - d)*EL^6*gAl*gFFA*gFFZ*((-2 + d)*gZlLC*gZuL*gZuLC - 
   ...
   (I*2^(4 - d)*EL^6*gAl*gFFA*gFFZ*(gZlLC + gZlRC)*(gZuL*gZuLC + gZuR*gZuRC)*
     SPList[SP[p3, q1], SP[p3, q1]])/(Pi^d*(mz^2 - s)*(-mzC^2 + s))))/4
