...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((4^(2 - d)*(-1 + d)*d*EL^8*gAl*gAu^2*gWWA*gWWZZ*gZlL*gZlR*mm^2*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (4^(2 - d)*(-1 + d)*d*EL^8*gAl*gAu^2*gWWA*
    gWWZZ*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s) - 
  (4^(2 - d)*(-1 + d)*d*EL^8*gAl*gAu^2*gWWA*gWWZZ*gZlL*gZlR*mm^2*
  ...
  (4^(2 - d)*(-1 + d)*d*EL^8*gAl*gAu^2*gWWA*gWWZZ*gZlL*gZlR*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*(gZlL^2 + gZlR^2)*
  ...
  (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*
  ...
  (4^(1 - d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s^2) + (4^(1 - d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*
  ...
  (4^(1 - d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s) + (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl*gAu^2*gWWA*gWWZZ*
    (gZlL^2 + gZlR^2)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^8*gAl*
    gAu^2*gWWA*gWWZZ*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*
