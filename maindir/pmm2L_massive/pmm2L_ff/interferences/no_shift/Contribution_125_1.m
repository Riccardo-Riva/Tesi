...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
  ...
  (-((4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*psq*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*psq*
     (psq*(psq - t) + mm^2*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    Pi^(2*d) - (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*psq*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*psq*(psq - t)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*
     psq*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*
     (-psq + s + t)*(2*(-2 + d)*psq^2 - 6*psq*s - 
      (-2 + d)*mm^2*(3*psq - s - t) + 2*s*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*psq*(psq - t)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*psq*
     ((-2 + d)*psq^2 - (-2 + d)*mm^2*(psq - t) + 2*s*(s + 2*t) - 
      psq*(4*s + (-2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*
     (-psq + s + t)*(2*mm^2*(-psq + s + t) + psq*(-4*psq + s + 4*t))*
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gWlN*gWNl*mm^2*
     ((-2 + d)*psq^2 - (-2 + d)*mm^2*(psq - t) + s*(s + 2*t) - 
      ...
      SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gFFA*gFll^2*
