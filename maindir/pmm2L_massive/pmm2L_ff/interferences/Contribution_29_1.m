...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
   ...
   (-((4^(2 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^6*(-2*psq^3 - 
        2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + t*(s^2 + 3*s*t + 2*t^2))*
       \[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) - 
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(mm^2 - psq)*
      (3*psq^2 + s^2 + 4*s*t + 3*t^2 - 2*psq*(s + 3*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
      (psq*(4*(-3 + d)*psq^2 + psq*((8 - 7*d)*s - 8*(-3 + d)*t) + 
         (s + t)*((-4 + 3*d)*s + 4*(-3 + d)*t)) + 
       mm^2*(4*(3 + d)*psq^2 + (s + t)*((4 + d)*s + 4*(3 + d)*t) - 
         psq*((8 + 5*d)*s + 8*(3 + d)*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(mm^2 - psq)*(psq - t)*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)*
      (psq*(-4*(-1 + d)*psq + (-4 + 3*d)*s + 4*(-1 + d)*t) + 
       mm^2*(-4*(1 + d)*psq + (4 + d)*s + 4*(1 + d)*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
      (8*(-2 + d)*psq^3 - 4*psq^2*((-3 + 2*d)*s + 6*(-2 + d)*t) + 
       mm^2*s*((4 + d)*s + 4*(1 + d)*t) - 4*(-2 + d)*t*
        (s^2 + 3*s*t + 2*t^2) - psq*(4*(1 + d)*mm^2*s + (4 - 3*d)*s^2 - 
         4*(-9 + 5*d)*s*t - 24*(-2 + d)*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
       psq^2*(s + 6*t) + t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
       psq^2*(s + 6*t) + t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*(-4 + 3*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     ...
     (Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
      (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      ((-4 + 3*d)*mm^4*(psq - t) - (-4 + d)*psq^2*(psq - t) + 
       2*mm^2*psq*(4*s + d*(-psq + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-4 + 3*d)*mm^4*s + 
       (-4 + d)*psq*(psq^2 - 2*psq*t + t*(s + t)) + 
       mm^2*((12 - 5*d)*psq^2 - (s + t)*(2*(-4 + d)*s + (-12 + 5*d)*t) + 
         psq*(3*(-4 + d)*s + 2*(-12 + 5*d)*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (-((-4 + d)*psq*(4*psq^2 + s^2 + 5*s*t + 4*t^2 - psq*(s + 8*t))) + 
       mm^2*(8*(-3 + d)*psq^2 + psq*((16 - 7*d)*s - 16*(-3 + d)*t) + 
         (s + t)*((-8 + 3*d)*s + 8*(-3 + d)*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(-psq + s + t)*
      (4*mm^2 - (4 + d)*psq + d*(s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-4 + d)*mm^4*(psq - t) + 
       (-4 + d)*psq^2*(psq - t) - 2*mm^2*psq*((-4 + d)*psq + 4*s + 4*t - 
         d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(mm^2 - psq)*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-4 + d)*mm^4*s + 
       mm^2*(psq - s - t)*((-20 + 9*d)*psq - 4*(-3 + d)*s + (20 - 9*d)*t) - 
       (-4 + d)*psq*(psq^2 - 2*psq*t + t*(s + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(4*psq^2 + 4*mm^2*s + 
       (s + t)*((2 + d)*s + 4*t) - psq*((10 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (mm^2*((-16 + d)*psq^2 - 2*psq*((-7 + d)*s + (-16 + d)*t) + 
         (s + t)*((-6 + d)*s + (-16 + d)*t)) - 
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
       ...
       SP[q2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (psq - t)*(-((-4 + d)*psq*(psq - t)) + 
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)*
     ...
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (4*(-4 + d)*psq^3 + 4*(-2 + d)*mm^2*psq*s - 2*(-4 + d)*psq^2*
        (s + 6*t) + mm^2*s*((8 - 3*d)*s - 4*(-2 + d)*t) - 
       2*(-4 + d)*t*(s^2 + 3*s*t + 2*t^2) + (-4 + d)*psq*
        (s^2 + 8*s*t + 12*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/
     Pi^(2*d) + (4^(1 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^2*(3*mm^2 + psq)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
     Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (-2*(-4 + d)*psq^3 + mm^2*s*((-6 + d)*s + (-8 + d)*t) + 
       2*psq^2*((-2 + d)*s + 3*(-4 + d)*t) + (-4 + d)*t*
        (s^2 + 3*s*t + 2*t^2) - psq*((-8 + d)*mm^2*s + 
         (s + 2*t)*((-2 + d)*s + 3*(-4 + d)*t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(psq^2 + mm^2*s + (s + t)^2 - 
      ...
      mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*
      gHll^2*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
       SP[q2, q2]])/Pi^(2*d) + (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d)))/4}
