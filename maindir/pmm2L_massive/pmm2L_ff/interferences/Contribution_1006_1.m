...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*(psq - t)*
     ...
     (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     ...
     (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(-psq + s + t)*
     ...
     (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*
       (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
        SP[q1, q2]])/(mz^2*Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*mm^2*(psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
     ...
     (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*
       (psq^3 + mm^2*(psq - t)^2 - psq^2*(s + 4*t) + psq*t*(4*s + 5*t) - 
        ...
        SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(psq - t)*(-2*psq^2 - 2*t*(s + t) + 
        psq*(s + 4*t) + mm^2*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)*s) - 
     (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*(psq - t)*
     ...
     (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*
       (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
        ...
        SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
     ...
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
       (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
        SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*
     ...
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
       (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
        SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*
     ...
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*
       (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
        SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)*s) + 
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*psq*
     ...
     (4^(2 - d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
       (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
        SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(mm^2*(psq - t) + psq*(-psq + s + t))*
     ...
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*
       (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
        SP[p3, q1]])/(mz^2*Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*
     ...
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
       (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
        SP[p3, q2]])/(mz^2*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(psq - t)^2*\[Mu]^(8 - 2*d)*
     ...
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)^2*
     ...
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
       (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
        SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(psq - t)*\[Mu]^(8 - 2*d)*
       SPList[SP[p2, q2], SP[p2, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)) - 
     (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)^2*
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[q1, q1]])/
      (mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*
       (gZlL + gZlR)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
        SP[p3, q2]])/(mz^2*Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*
       ggpgpZ*(gZlL + gZlR)*(psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     ...
     (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(psq - t)*
      ...
      (mz^2*Pi^(2*d)) + (2^(3 - 2*d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*
       (gZlL + gZlR)*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
        SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s) - 
     (4^(1 - d)*EL^6*gAl^2*gAu*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*psq - s - 2*t)*
