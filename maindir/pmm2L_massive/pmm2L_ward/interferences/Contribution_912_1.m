...
PropList[KiraPropagator[-q1, mh], KiraPropagator[-q1 - q2, mz], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 - psq)*(psq - s)*s*
    (aa*(mm^2 + 2*psq - 2*s - 2*t) + bb*(mm^2 - 2*psq + 2*t))*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (bb*(-8*psq^3 + 4*mm^4*s + 8*psq^2*(3*s + t) - 9*psq*s*(s + 2*t) + 
       s^2*(s + 2*t) + 2*mm^2*(4*psq^2 - 13*psq*s + 3*s^2 - 4*psq*t + 
         8*s*t)) + aa*(8*psq^3 + 4*mm^4*s - s^2*(s + 2*t) - 
       4*psq^2*(5*s + 2*t) + psq*s*(13*s + 18*t) - 
       2*mm^2*(4*psq^2 - 7*psq*s + 5*s^2 - 4*psq*t + 8*s*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*
    mm^2*(bb*(-4*psq^3 + 2*mm^4*s - 11*psq*s*(s + t) + s^2*(2*s + 3*t) + 
       psq^2*(17*s + 4*t) + 2*mm^2*(2*psq^2 - 2*psq*(4*s + t) + 
         s*(3*s + 4*t))) + aa*(4*psq^3 + 2*mm^4*s - s^2*(2*s + 3*t) - 
       psq^2*(11*s + 4*t) + psq*s*(9*s + 11*t) + 
       mm^2*(-4*psq^2 - 4*s*(s + 2*t) + psq*(6*s + 4*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*
    mm^2*(psq - s)*(aa*(-4*psq^2 + 4*mm^2*(psq - t) - s*(s + t) + 
       psq*(s + 4*t)) + bb*(4*psq^2 + s*(s + t) + mm^2*(-4*psq + 6*s + 4*t) - 
       psq*(7*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (bb*(-4*psq^3 + 2*mm^4*s + s^2*(s + 3*t) + psq^2*(15*s + 4*t) - 
       psq*s*(8*s + 11*t) + 2*mm^2*(2*psq^2 + 2*s*(s + 2*t) - 
         psq*(7*s + 2*t))) + aa*(4*psq^3 + 2*mm^4*s - s^2*(s + 3*t) - 
       psq^2*(9*s + 4*t) + psq*s*(6*s + 11*t) - 
       2*mm^2*(2*psq^2 - 2*psq*(s + t) + s*(s + 4*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*
    mm^2*(psq - s)*(-(aa*(4*psq^2 + psq*(s - 4*t) - 
        2*mm^2*(2*psq + s - 2*t) + s*t)) + 
     bb*(4*psq^2 - 5*psq*s - 4*psq*t + s*t + 4*mm^2*(-psq + s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 - psq)*s*
    (aa*(mm^2 + 3*psq - 3*s - 2*t) + bb*(mm^2 - psq - s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(psq - s)*s*
    (aa*(-2*mm^2 + s + 2*t) - bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*
    mm^2*(mm^2 - psq)*s*(aa*(mm^2 + 2*psq - 2*s - 2*t) + 
     bb*(mm^2 - 2*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 - psq)*s*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-8*psq^2 + mm^2*(6*psq - 8*t) + 5*psq*(s + 2*t) - 2*s*(s + 2*t)) + 
     bb*(12*psq^2 + 2*s*(s + 2*t) - psq*(13*s + 10*t) + 
       mm^2*(-10*psq + 8*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-22*psq^2 + 2*mm^2*(7*psq - 8*t) - 2*s*(5*s + 8*t) + 
       3*psq*(7*s + 8*t)) + bb*(30*psq^2 + 2*s*(5*s + 8*t) - 
       3*psq*(15*s + 8*t) + mm^2*(-22*psq + 24*s + 16*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-10*psq^2 + 7*psq*s - 5*s^2 + 2*mm^2*(3*psq + s - 4*t) + 12*psq*t - 
       6*s*t) + bb*(18*psq^2 - 3*psq*(9*s + 4*t) + s*(5*s + 6*t) + 
       mm^2*(-14*psq + 18*s + 8*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-18*psq^2 + 11*psq*s - 6*s^2 + 2*mm^2*(5*psq + 4*s - 8*t) + 
       24*psq*t - 16*s*t) + bb*(26*psq^2 - 35*psq*s + 6*s^2 - 24*psq*t + 
       16*s*t - 2*mm^2*(9*psq - 8*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-6*psq^2 - 3*psq*(s - 4*t) + 2*mm^2*(psq + 5*s - 4*t) - 
       s*(s + 6*t)) + bb*(14*psq^2 - 17*psq*s + s^2 - 12*psq*t + 6*s*t + 
       mm^2*(-10*psq + 10*s + 8*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-8*psq^2 + mm^2*(8*psq - 6*s - 8*t) + 8*psq*(s + t) - s*(s + 2*t)) + 
     bb*(8*psq^2 - 4*psq*(s + 2*t) + s*(s + 2*t) + 
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (bb*(-8*psq^2 + mm^2*(8*psq - 6*s - 8*t) + 8*psq*(s + t) - s*(s + 2*t)) + 
     aa*(8*psq^2 - 4*psq*(s + 2*t) + s*(s + 2*t) + 
       mm^2*(-8*psq + 2*s + 8*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-7*psq^2 + 8*psq*s - 4*s^2 + 4*mm^2*(psq - t) + 7*psq*t - 6*s*t) + 
     bb*(9*psq^2 - 16*psq*s + 4*s^2 - 7*psq*t + 6*s*t + 
       mm^2*(-6*psq + 8*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-8*psq^2 + 4*mm^2*(psq - t) + 8*psq*(s + t) - s*(4*s + 5*t)) + 
     bb*(12*psq^2 - 2*psq*(9*s + 4*t) + mm^2*(-8*psq + 10*s + 4*t) + 
       s*(4*s + 5*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-12*psq^2 + mm^2*(6*psq + 4*s - 8*t) - 6*s*(s + 2*t) + 
       psq*(11*s + 14*t)) + bb*(16*psq^2 + 6*s*(s + 2*t) + 
       mm^2*(-10*psq + 12*s + 8*t) - psq*(27*s + 14*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-6*psq^2 + 3*psq*s - 2*s^2 + 2*mm^2*(psq + 2*s - 2*t) + 8*psq*t - 
       5*s*t) + bb*(10*psq^2 - 13*psq*s + 2*s^2 - 8*psq*t + 5*s*t + 
       mm^2*(-6*psq + 6*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-4*psq^2 + 5*psq*s - 2*s^2 + mm^2*(4*psq - 2*s - 4*t) + 4*psq*t - 
       3*s*t) + bb*(4*psq^2 - 7*psq*s + 2*s^2 - 4*psq*t + 3*s*t + 
       4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p3, p3]])/Pi^(2*d) + (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-2*psq^2 - 2*s*(-mm^2 + s + 2*t) + psq*(3*s + 2*t)) + 
     bb*(2*psq^2 + 2*s*(mm^2 + s + 2*t) - psq*(7*s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-4*psq^2 + 5*psq*s - 2*s^2 + mm^2*(4*psq - 2*s - 4*t) + 4*psq*t - 
       3*s*t) + bb*(4*psq^2 - 7*psq*s + 2*s^2 - 4*psq*t + 3*s*t + 
       4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[q2, q2]])/Pi^(2*d) + (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(psq - s)*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-6*psq^2 + 5*psq*s - 3*s^2 + 2*mm^2*(psq + s - 2*t) + 8*psq*t - 
       5*s*t) + bb*(10*psq^2 - 15*psq*s + 3*s^2 - 8*psq*t + 5*s*t + 
       mm^2*(-6*psq + 8*s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(psq - s)*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(psq - s)*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(-5*psq^2 + 2*mm^2*(psq + 2*s - 2*t) - 2*s*(s + 3*t) + 
       psq*(3*s + 7*t)) + bb*(7*psq^2 + 4*mm^2*(-psq + s + t) + 
       2*s*(s + 3*t) - psq*(11*s + 7*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (bb*(-8*psq^2 + 4*mm^2*(psq - s - t) + 2*psq*(5*s + 4*t) - s*(s + 5*t)) + 
     aa*(4*psq^2 - 8*psq*t + mm^2*(-6*s + 4*t) + s*(s + 5*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (bb*(4*psq^2 - 5*psq*s + s^2 - 4*psq*t + 3*s*t + 
       mm^2*(-4*psq + 2*s + 4*t)) + aa*(-4*psq^2 + 4*mm^2*(psq - t) - 
       s*(s + 3*t) + psq*(3*s + 4*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(psq - s)*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*s*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*(aa + bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*s*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 + 6*psq - 5*s - 8*t) + 
  ...
  (I*4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(psq - s - t) + 
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 + 2*psq - 3*s - 4*t) + 
     bb*(6*mm^2 - 10*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2], SP[p3, p3]])/(2*Pi)^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(2*psq - s - 2*t)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p1, p3]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(4*psq - 3*s - 4*t) + 
     bb*(4*mm^2 - 8*psq + 3*s + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2], 
     SP[p2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[p2, p3]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(4*mm^2 - s - 4*t) + bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[p3, p3]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*
    gXll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[q2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(4*mm^2 - s - 4*t) + 
  ...
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(4*mm^2 - s - 4*t) + 
     bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q2, q2]])/(2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
     SP[q1, q1]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*
    gXll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q2], SP[q1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, q2], SP[q2, q2]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[p3, p3]])/
   (4^d*Pi^(2*d)) - (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[q1, q1]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     SP[q1, q2]])/Pi^(2*d) - (I*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2], SP[q2, q2]])/(4^d*Pi^(2*d)))
