...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  ((2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(mm^2 + psq)*
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*
     ...
     gFAW*gFFA*gFll*gWNl*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(psq - t)*
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFFA*gFll*gWNl*mm^2*(2*psq + s - 2*t)*
