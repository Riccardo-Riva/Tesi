...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 ((I*2^(-1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*
    mm^4*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) - (I*EL^5*gAl^3*gXll^2*mm^4*(2*aa*psq*(psq - t) + 
     2*aa*mm^2*(psq - s - t) + bb*mm^2*(-2*psq - (-4 + d)*s + 2*t) + 
     bb*psq*(-2*psq + (-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*
    (mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*gXll^2*mm^4*(aa*psq*(2*psq + (-4 + d)*s - 2*t) + 
     aa*mm^2*(2*psq - (-2 + d)*s - 2*t) + 2*bb*mm^2*(-psq + t) + 
     2*bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I*(aa + bb)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)*
    s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(4^d*Pi^(2*d)) - 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(mm^2 + psq)*(psq - s - t) + 
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*
    (aa*((-4 + d)*mm^4 - 2*mm^2*((-3 + d)*psq + s + t) + 
       psq*((2 + d)*psq - 2*(s + t))) + 
     bb*(-((-4 + d)*mm^4) + 2*mm^2*((-5 + d)*psq + s + t) + 
       psq*(-((-2 + d)*psq) + 2*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*(psq - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl^3*gXll^2*mm^2*(aa*((-4 + d)*mm^4 + psq*((-6 + d)*psq + 2*t) + 
       mm^2*(-2*(-3 + d)*psq + 2*t)) - 
     bb*((-4 + d)*mm^4 + 2*mm^2*(psq - d*psq + t) + 
       psq*((-2 + d)*psq + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(4^d*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*(-4 + d)*psq*(psq - t) - 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(aa*(mm^2 + psq)*(psq - t) + 
     bb*mm^2*(-3*psq + t) + bb*psq*(psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^2*((-4 + d)*psq*(psq - t) + 
     mm^2*(-((-8 + d)*psq) - 4*s + (-8 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(psq - s - t)*
  ...
  (I*(aa - bb)*EL^5*gAl^3*gXll^2*mm^4*(2*s + d*(psq - s - t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*(-4 + d)*mm^2 + 2*bb*psq + 
  ...
  (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
  ...
  (I*EL^5*gAl^3*gXll^2*mm^2*(bb*(-2*psq + d*(mm^2 - t) + 2*t) + 
     aa*((-4 + d)*mm^2 - 2*(-3 + d)*psq + (-2 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
     ...
     SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl^3*gXll^2*mm^2*
    (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
