...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   (-((4^(1 - d)*EL^6*gAl*gAu*gXll^4*mm^6*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(2*psq - s - 2*t)*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^6*(2*psq - s - 2*t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(-psq + s + t)*
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*
      (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[p3, q1]])/Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(2*mm^2 - 3*psq + s + t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[q1, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*psq*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(2*psq + s - 2*t)*
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq - t)*
      ...
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(mm^2 - psq)*(psq - t)*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq - t)*
      ...
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (4^(2 - d)*EL^6*gAl*gAu*gXll^4*mm^4*(psq - t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^4*mm^4*
