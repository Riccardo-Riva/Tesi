...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   (((-I)*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)^2*s*
      \[Mu]^(8 - 2*d))/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*
      mm^4*(mm^2*(5*psq - 2*s - 5*t) + psq*(3*psq - 2*s - 3*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*
      (bb*mm^2*(3*psq + s - 3*t) + bb*psq*(psq - s - t) - 
       aa*psq*(psq + s - t) + aa*mm^2*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*
      gHll^2*mm^4*(mm^2*(5*psq - 3*s - 5*t) + psq*(3*psq - s - 3*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*
      (bb*mm^2*(3*psq - 2*s - 3*t) + bb*psq*(psq - 2*s - t) + 
       aa*psq*(-psq + t) + aa*mm^2*(-3*psq + 4*s + 3*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa + bb)*d*EL^5*gAl^3*
      gHll^2*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    ...
    (I*4^(2 - d)*d*EL^5*gAl^3*gHll^2*mm^4*(bb*(psq - s - t) + 
       ...
       SP[p1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
      (2*bb*mm^2*(psq - s - t) + aa*(mm^4 + psq^2 + 2*mm^2*(-2*psq + s + t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
    (I*4^(2 - d)*d*EL^5*gAl^3*gHll^2*mm^4*(bb*(mm^2 + psq - s - 2*t) + 
       aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1]])/Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
      (bb*(mm^4 + psq*(psq + s) + mm^2*(2*psq - s - 4*t)) + 
       aa*(mm^4 + psq*(psq - s) + mm^2*(-6*psq + s + 4*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^4*(-3*psq + 2*s + 3*t)*
    ...
    (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^4*(-psq + s + t)*
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*mm^2*(2*psq - s - 2*t) - 
       bb*mm^2*(2*psq + s - 2*t) + aa*psq*(2*psq + s - 2*t) + 
       bb*psq*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^4*(-3*psq + s + 3*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
      (mm^2*(7*psq - 3*s - 7*t) + psq*(psq - s - t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(psq - t)*
    ...
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(mm^2 - psq - s) + 
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(psq - t)*
    ...
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
       ...
       SP[q1, q2]])/Pi^(2*d) + (I*4^(2 - d)*bb*(-2 + d)*EL^5*gAl^3*gHll^2*
      mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
      (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) - 
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(psq - s - t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(psq - s - t)*
