...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  ((I*(aa + bb)*(-2 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)^2*s*
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl^3*
   ...
   (I*2^(1 - 4*d)*(-2 + d)*EL^5*gAl^3*mm^2*
     (bb*(-(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(mm^2 - psq)*((-2 + d)*psq - 2*s - 
         ...
         (-((-2 + d)*psq*(psq - t)) + mm^2*((2 + d)*psq - 2*s - 
            (2 + d)*t))) + aa*(2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(mm^2 - psq)*
   ...
   (I*4^(1 - d)*EL^5*gAl^3*(bb*(-4*d*gZlL*gZlR*mm^2 + 
        (-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq))*
       (psq - s - t) + aa*((-2 + d)*gZlL^2*(mm^2 - psq)*(2*mm^2 - 3*psq + s + 
          t) + (-2 + d)*gZlR^2*(mm^2 - psq)*(2*mm^2 - 3*psq + s + t) - 
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*(psq - t)*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl^3*
     (aa*(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(psq - t) - 
        gZlL^2*(2*Pi)^(2*d)*(mm^2 - psq)*((16 - 10*d + d^2)*mm^2 - 
          (20 - 12*d + d^2)*psq - 4*s + 4*t - 2*d*t) - gZlR^2*(2*Pi)^(2*d)*
         (mm^2 - psq)*((16 - 10*d + d^2)*mm^2 - (20 - 12*d + d^2)*psq - 4*s + 
          4*t - 2*d*t)) + bb*(-(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*
     (8*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + (-4 + d)*gZlL^2*(mm^2 - psq)*
       ...
       (mm^2 - psq)*((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    ...
    Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gZlL*gZlR*mm^2*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
     (bb*((8 - 6*d + d^2)*mm^2 - 2*(-2 + d)*psq + 4*s - 12*t + 8*d*t - 
      ...
      SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
