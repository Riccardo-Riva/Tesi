...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 (((-I)*2^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*
  ...
  (I*2^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*(mmv^2 - t)*
    SPList[SP[p1, p2], SP[p1, p2]])/(Pi^d*s^2*(-mz^2 + s)) - 
  (I*2^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*(2*mmv^2 + s - 2*t)*
    SPList[SP[p1, p2], SP[p1, p3]])/(Pi^d*s^2*(-mz^2 + s)) + 
  (I*2^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*(4*mm^2 - 4*mmv^2 + s)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^d*s^2*(-mz^2 + s)) - 
  (I*2^(3 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*(mmv^2 - t)*
  ...
  (I*2^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*(-2*mmv^2 + 3*s + 2*t)*
  ...
  (I*2^(2 - d)*EL^6*gAl^2*gAu*gFFA*gFFZ*(gZuL + gZuR)*(-mmv^2 + s + t)*
