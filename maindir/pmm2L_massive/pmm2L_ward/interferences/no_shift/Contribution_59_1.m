  ...
  ((I*(aa + bb)*(-2 + d)^2*EL^5*gAl*gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gZlL*gZlR*mm^2*
     (aa*(2*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
        ...
        gZlR^2*(-2*psq*s + mm^2*(2*(-2 + d)*psq + 4*s - d*s + 4*t - 
            2*d*t))) - bb*(2*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl*(bb*(-2*(-2 + d)*gZlL^3*gZlR*mm^2 - 
       ...
       (psq - s - t) + aa*((-2 + d)*gZlL^4*(mm^2 - psq)*(2*mm^2 - 3*psq + s + 
          t) + (-2 + d)*gZlR^4*(mm^2 - psq)*(2*mm^2 - 3*psq + s + t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*(-(bb*(4*(-2 + d)*gZlL^3*gZlR*mm^2*(psq - s - t) + 
         ...
         gZlR^4*(mm^2 - psq)*((16 - 10*d + d^2)*mm^2 - (12 - 8*d + d^2)*psq + 
           2*(-4 + d)*s + 2*(-2 + d)*t))) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*(gZlL^4 + gZlR^4)*
     (bb*((8 - 6*d + d^2)*mm^2 - 2*(-2 + d)*psq + 4*s - 12*t + 8*d*t - 
      ...
      SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*(gZlL^4 + gZlR^4)*
