...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*
   ...
   (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*(psq - s - t)*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gWlN*gWNl*(d^2*(mm^2 - psq)*(psq - t)^2 - 
      d*(-6*psq^3 + mm^2*(2*psq + s - 2*t)*(psq - t) + 2*t*(s + t)^2 - 
        2*psq*t*(3*s + 5*t) + 2*psq^2*(s + 7*t)) + 
      2*(-4*psq^3 + mm^2*psq*s - 2*psq*t*(3*s + 4*t) + 2*psq^2*(s + 5*t) + 
        t*(-(mm^2*s) + 2*(s + t)^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(-((-6 + d)*psq^3) - 
   ...
   (2^(1 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*
     (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
      ...
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*(psq - t)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*
     ...
     gWNl*(-4*psq^2 + (-2 + d)*mm^2*(psq - t) - (-10 + d)*psq*t + 
      (-6 + d)*t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*
     gWNl*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(2*(-4 + d)*psq^2 - 
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(psq - t)^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(psq - t)^2*
