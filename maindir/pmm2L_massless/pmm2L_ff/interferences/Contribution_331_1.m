...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*t*(s + t)*
      (-2*d*gZlL*gZlR*mm^2*(s + 2*t) + (-2 + d)*gZlL^2*
        (2*mm^2*(s + t) + s*(s + 2*t)) + (-2 + d)*gZlR^2*
        (2*mm^2*(s + t) + s*(s + 2*t)))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) - 
   (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*(s + t)*
     (2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(2*t*(s + t) + mm^2*(s + 4*t)) - 
      (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(2*mm^2*(s + 2*t) + s*(s + 4*t)) - 
      (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(2*mm^2*(s + 2*t) + s*(s + 4*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(4*d)*s) + 
   (4^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(s + t)*
     (s^2 + 4*s*t + t*(mm^2 + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s) + (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*t*
     (2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(-2*t*(s + t) + mm^2*(s + 4*t)) - 
      (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(2*mm^2*(s + 2*t) + s*(3*s + 4*t)) - 
      (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(2*mm^2*(s + 2*t) + s*(3*s + 4*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(4*d)*s) + 
   (4^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*t*
     (s^2 + 4*s*t + t*(mm^2 + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (Pi^(2*d)*s) - (2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*
     ((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(2*mm^2 + s)*(s + 2*t) + 
      (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(2*mm^2 + s)*(s + 2*t) - 
      2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(4*d) + (4^(1 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*
     mm^4*(-((-4 + d)*s^3) - 4*(-3 + d)*s^2*t - 4*(-2 + d)*t^3 + 
      s*t*((-4 + d)*mm^2 - 6*(-2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(-4*d*gZlL*gZlR*mm^2*t + 
      ...
      SP[p2, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*
     gZlL*gZlR*mm^2*(mm^4*t + t*(s^2 + 3*s*t + 2*t^2) + 
      mm^2*(s^2 + 6*s*t + 7*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*
     ((-2 + d)*gZlL^2*(2*mm^2*s + 3*s^2 + 6*s*t + 4*t^2) + 
      (-2 + d)*gZlR^2*(2*mm^2*s + 3*s^2 + 6*s*t + 4*t^2) - 
      4*d*gZlL*gZlR*(mm^2*s + (s + t)^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(-((-4 + d)*mm^4*s) + 
      (s + t)^2*((-4 + d)*s + 2*(-2 + d)*t) + 
      mm^2*((-2 + d)*s^2 + 2*(1 + d)*s*t + (-4 + 3*d)*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*(gZlL^2 + gZlR^2)*mm^4*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(s + t)*
     (mm^2*(2*s + (4 + d)*t) + t*(-4*t + d*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(s + t)*
     (2*t*(s + t) + mm^2*(s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     (mm^4*t - t*(s^2 + 3*s*t + 2*t^2) + mm^2*(s^2 + 5*s*t + 5*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     (mm^4*s + s*(s + t)^2 + mm^2*(2*s^2 + 2*s*t - t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(s + t)*
     (mm^2*(s - t) - 2*t*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*t*((-2 + d)*gZlL^2*s + 
      (-2 + d)*gZlR^2*s + 2*d*gZlL*gZlR*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(mm^2 - s - 2*t)*
     t^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*(-4*d*gZlL*gZlR*t^2 + 
      (-2 + d)*gZlL^2*(s^2 + 2*s*t + 4*t^2) + (-2 + d)*gZlR^2*
       (s^2 + 2*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     (mm^2*((-4 + d)*s^2 + (-10 + 3*d)*s*t + (-4 + 3*d)*t^2) - 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*
     (-((s + t)*((-4 + d)*s + 2*(-2 + d)*t)) + mm^2*(2*s + (4 + d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*
     (-2*t*(s + t) + mm^2*(s + 4*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     (-(s*t^2) + mm^2*(s^2 + 3*s*t + t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*(s + t)*
     (mm^2 + 2*s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*
     ((-2 + d)*gZlL^2 - d*gZlL*gZlR + (-2 + d)*gZlR^2)*mm^4*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*((-4 + d)*s*(s + 2*t) + 
      mm^2*((-2 + d)*s + 2*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*
     (gZlL^2 + gZlR^2)*mm^4*(s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(2*s + (4 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(s + 4*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(s + t)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(s + t)*(2*mm^2 + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(s + t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*((-4 + d)*s*(s + 2*t) + 
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     (2*mm^2*s + 2*s^2 + 4*s*t + 3*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(3 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(mm^2*s + (s + t)^2)*
   ...
   (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(mm^2 - s - 2*t)*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/
    (Pi^(2*d)*s) + (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     (s^2 + 2*s*t + 3*t^2 + mm^2*(s + t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t*(-mm^2 + s + t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
     ...
     gZlR*mm^2*(mm^2*s + (s + t)^2)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t^2*
    ...
    Pi^(2*d) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*t^2*
