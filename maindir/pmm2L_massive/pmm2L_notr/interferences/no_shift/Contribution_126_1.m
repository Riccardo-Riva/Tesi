...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  (-((4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 + psq)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s^2)) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 + psq)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 + psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 - psq + 2*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
     (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(-psq + s + t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
     (mm^2 - 3*psq + 2*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*
     gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(-psq + s + t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(2*psq + s - 2*t)*
   ...
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
