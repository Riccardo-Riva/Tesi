(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*((-4 + d)^2*gZlL^2 - 
       2*(20 - 10*d + d^2)*gZlL*gZlR + (-4 + d)^2*gZlR^2)*s*t*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*(-2*(-4 + d)*gZlL*gZlR*
        ((-3 + d)*s - t) + gZlL^2*((12 - 7*d + d^2)*s - (-2 + d)*t) + 
    ...
    (I*4^(2 - d)*(aa - bb)*EL^5*gAl^3*(gZlL + gZlR)^2*(s + t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*(gZlL + gZlR)^2*(s + 2*t)*
     ...
     (mz^2*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*
      (gZlL + gZlR)^2*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[q2, q2]])/(mz^2*Pi^(2*d)) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*
      ((-2 + d)*gZlL^2 - 2*(-4 + d)*gZlL*gZlR + (-2 + d)*gZlR^2)*t*
