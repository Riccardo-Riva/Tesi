...
PropList[KiraPropagator[p1 - q1, ml], KiraPropagator[-p2 - q1, ml]]*
 ((I*EL^6*gZlL*gZlR*ml^2*
    (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
     ...
     gZlR*gZlRC*(gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
       ...
       gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(-2*(-1 + d)*s^2 + 
           (8 - 5*d + d^2)*s*t + 2*t^2)))))/((2*Pi)^(2*d)*(mz^2 - s)^2*
     ...
     gZlL*gZlLC*gZlR^2*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
      ...
      (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
         ...
         2^(1 + d)*Pi^d*((8 - 7*d + d^2)*s^2 + (2 - 3*d + d^2)*s*t + 
           2*t^2))))*SPList[SP[p1, p2]])/(Pi^(2*d)*(mz^2 - s)^2*
    (-mzC^2 + s)) + (I*EL^6*(gZlL^2 - gZlR^2)*s*
  ...
  ((I/2)*EL^6*((2^(1 - 2*d)*(gZlL^2 + gZlR^2)*
       (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
    ...
    (gZlL^3*gZlLC*(gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 - 2^(1 + d)*Pi^d*
     ...
     gZlL*gZlLC*gZlR^2*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
      ...
      (gZuL*gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 + 3*d)*s^2 - 
           (4 - 5*d + d^2)*s*t + 2*t^2)) + gZuR*gZuRC*(d^2*(2*Pi)^d*s^2 + 
         2^(1 + d)*Pi^d*((8 - 7*d + d^2)*s^2 + (2 - 3*d + d^2)*s*t + 
           2*t^2))))*SPList[SP[p2, q1]])/(Pi^(2*d)*(mz^2 - s)^2*
    (-mzC^2 + s)) - (I*EL^6*(gZlL^2 - gZlR^2)*s*
    (gZlL*gZlLC*(gZuL*gZuLC*((-5 + d)*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
          (3*s + (-3 + d)*t)) + gZuR*gZuRC*((-5 + d)*d*(2*Pi)^d*s - 
         2^(1 + d)*Pi^d*((-6 + d)*s + (-3 + d)*t))) + 
  ...
  (I*2^(1 - d)*EL^6*(gZlL^2 + gZlR^2)*
    (gZlL*gZlLC*((-2 + d)*gZuL*gZuLC - (-4 + d)*gZuR*gZuRC) + 
     gZlR*gZlRC*(-((-4 + d)*gZuL*gZuLC) + (-2 + d)*gZuR*gZuRC))*t*
    SPList[SP[p2, q1], SP[p2, q1]])/(Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
  (I*2^(1 - d)*EL^6*(gZlL^2 + gZlR^2)*
    (gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
       gZuR*gZuRC*((-4 + d)*s + 2*t)) - gZlR*gZlRC*
      (gZuL*gZuLC*((-4 + d)*s + 2*t) + gZuR*gZuRC*(-((-2 + d)*s) + 2*t)))*
