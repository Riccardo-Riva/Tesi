...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (((-I)*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*s*
    ...
    (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*
     ...
     SPList[SP[p1, q1]])/Pi^(2*d) - (I*EL^5*gAl*ggpgpZ*gXgpgp*gXll*
     (gZlL - gZlR)*mm^2*(-2*bb*mm^2*(psq - t) + 2*aa*mm^2*(psq + s - t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
     ...
     SPList[SP[p2, q1]])/Pi^(2*d) + (I*EL^5*gAl*ggpgpZ*gXgpgp*gXll*
     (gZlL - gZlR)*mm^2*(aa*s*(psq - t) + 2*bb*mm^2*(psq - 2*s - t) + 
   ...
   (I*4^(1 - d)*aa*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
   ...
   (I*4^(1 - d)*bb*EL^5*gAl*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*
