(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  (((-I)*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*s^2*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) - 
   (I*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*s^2*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
   (I*(aa - bb)*(-6 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*s^2*(s + 2*t)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*s*
     ((-10 + 3*d)*s + (2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*
     gWWZ*gZlL*s*((-2 + 3*d)*s + (10 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*s*
     (2*(-6 + d)*s - (2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*
     gWWZ*gZlL*s*(2*(-2 + d)*s - (-6 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*s*
     (2*(-6 + d)*s - (10 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*
     gWWA*gWWZ*gZlL*s*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     s*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*s*
     ((-10 + 3*d)*s + (-6 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*
     gWWA*gWWZ*gZlL*s*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/
    Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     s*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     ((2 + d)*s + 4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     (2*(-2 + d)*s - (-6 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     ((-10 + 3*d)*s + 4*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*(-2 + 3*d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*(s + 2*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     (2*(-2 + d)*s - (-6 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     ((-6 + d)*s + (2 - 3*d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*
     ((-10 + 3*d)*s + (-6 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gWWZ*gZlL*t*
