...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  ((4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*t^2*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*t*(s + t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*t*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(s + t)*
     (mm^2*(s - 4*t) - 4*t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (-4*t*(s + t)^2 + mm^2*(4*s^2 + 7*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(3*s^2 + 7*s*t + 4*t^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (4*t^2*(s + t) + mm^2*(s^2 + 9*s*t + 12*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (-2*t^2*(s + t) + mm^2*s*(s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(5*s^2 + 10*s*t + 4*t^2)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*t*(s + 4*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (-2*t*(s + t)^2 + mm^2*s*(2*s + 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(s^2 + 2*s*t - 4*t^2)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(3*s + 4*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^4*(s + 4*t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(s + t)*
     (2*mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(s + t)*(2*mm^2 + s + t)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(s + t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*t*(s + t)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*t*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(mm^2*s + (s + t)^2)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(s^2 + 3*s*t + 2*t^2)*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     ...
     mm^2*(mm^2*s + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(mm^2*s - t^2)*
   ...
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(mm^2 + s + 2*t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(s^2 + 3*s*t + 2*t^2)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*
     (mm^2*s + (s + t)^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     ...
     gWWA*mm^2*t^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s) - (3*2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*
     gWWA*mm^2*t^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*t^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*t*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q1]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q2, q2]])/Pi^(2*d) - 
   (3*2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*t^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(s^2 + 2*s*t - 4*t^2)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*t*(s + 2*t)*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWlN*gWWA*mm^2*(s + 2*t)*
