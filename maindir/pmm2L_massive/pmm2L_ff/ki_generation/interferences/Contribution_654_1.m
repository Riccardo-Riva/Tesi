   ...
   (-((2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*
    ...
    (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*(psq - s - t)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*
      gWNl*(mm^2 - psq)*(-4*psq^2 + (-2 + d)*mm^2*(psq - t) - 
       (-10 + d)*psq*t + (-6 + d)*t*(s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*((-2 + d)*mm^4*s - 
       (3*(-2 + d)*psq - 4*s)*(psq^2 - 2*psq*t + t*(s + t)) + 
       mm^2*((-14 + 3*d)*psq^2 + psq*(14*s - d*s + 28*t - 6*d*t) - 
         (s + t)*(4*s + 14*t - 3*d*t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*
      (-4*psq^3 + (-2 + d)*mm^4*s + 4*t^2*(s + t) + 
       ...
       SP[p3, q1]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*
      gWNl*(-((-6 + d)*psq^3) - 4*t^2*(s + t) - 
       psq*t*((-6 + d)*s + (-14 + d)*t) + psq^2*(-((-2 + d)*s) + 
         2*(-8 + d)*t) + mm^2*((-6 + d)*psq^2 + 
         psq*((4 + d)*s - 2*(-6 + d)*t) - (s + t)*(2*s - (-6 + d)*t)))*
    ...
    (4^(2 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*gWlN*gWNl*(mm^2 - psq)*(psq - t)*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gWlN*gWNl*
      ...
      gWlN*gWNl*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*
