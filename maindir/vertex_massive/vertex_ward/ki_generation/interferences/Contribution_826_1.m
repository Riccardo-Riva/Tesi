...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
 ...
 ((EL^5*gAl*gHXZ^2*gXll^2*mm^2*psq*s*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*s*
    ...
    SPList[SP[p1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*s*
    (bb*(2*mm^4 + mm^2*(7*psq - 4*s) + psq*(psq - 2*s)) + 
     aa*(2*mm^4 - psq*(psq - 2*s) + mm^2*(-11*psq + 4*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*s*
    (bb*(mm^4 + mm^2*(3*psq - 2*s) - psq*s) + 
     aa*(mm^4 + psq*s + mm^2*(-5*psq + 2*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + 
  (EL^5*gAl*gHXZ^2*gXll^2*mm^2*s*
    (bb*(4*mm^4 + mm^2*(11*psq - 8*s) + psq*(psq - 4*s)) + 
     aa*(4*mm^4 + psq*(psq + 4*s) + mm^2*(-21*psq + 8*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/(2*Pi)^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*s*
    (bb*(mm^4 + mm^2*(3*psq - 2*s) - psq*s) + 
     aa*(mm^4 + psq*s + mm^2*(-5*psq + 2*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + 
  (EL^5*gAl*gHXZ^2*gXll^2*mm^2*s*(bb*(mm^4 + mm^2*(3*psq - 2*s) - psq*s) + 
     aa*(mm^4 + psq*s + mm^2*(-5*psq + 2*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2*Pi)^(2*d) - 
  (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(psq^2 + mm^2*(9*psq - 4*s)) - 
  ...
  (4^(2 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) + 
  (4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*(3*mm^2 + psq) - 
     bb*(mm^2 + 3*psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   Pi^(2*d) - (2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 + psq)*
  ...
  (4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*mm^2*(7*psq - 6*s) - 
     2*aa*psq*s + bb*mm^2*(-8*psq + 4*s) + bb*psq*(psq + 4*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*mm^2*(4*psq - 3*s) - aa*psq*s + 
  ...
  (4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*
    (mm^2*(8*psq - 5*s) - 3*psq*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
  (2^(3 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*mm^2*(4*psq - 3*s) - 
     aa*psq*s + 2*bb*psq*s + 2*bb*mm^2*(-2*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*mm^2*(4*psq - 3*s) - 
     aa*psq*s + 2*bb*psq*s + 2*bb*mm^2*(-2*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  ((aa + bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (2^(5 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 + psq)*
  ...
  (4^(1 - d)*(aa - bb)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
  (4^(2 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
  (2^(3 - 2*d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^5*gAl*gHXZ^2*gXll^2*mm^2*(aa*mm^2 - bb*psq)*\[Mu]^(8 - 2*d)*
