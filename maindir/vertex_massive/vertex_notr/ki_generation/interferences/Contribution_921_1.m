...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, 0], 
  ...
  (-((2^(-1 - 2*d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*s*
   ...
   (EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*((-3 + d)*mm^4 - 2*s^2 - 
      mm^2*((-1 + d)*psq + (2 + d)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (mz^2*(2*Pi)^(2*d)) + (2^(-1 - 2*d)*EL^6*gAl^3*ggpgpA*ggpgpZ*
   ...
   (4^(1 - d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p2]])/(mz^2*Pi^(2*d)) + 
   (2^(1 - 2*d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     ((3 + d)*mm^2 - (-3 + d)*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q1]])/(mz^2*Pi^(2*d)) + 
   (EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*(11*mm^2 - (-3 + d)*(psq - 2*s))*
   ...
   (EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*((-5 + d)*mm^2 - (-3 + d)*psq + 
      (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)) + (2^(1 - 2*d)*(-1 + d)*EL^6*gAl^3*ggpgpA*ggpgpZ*
   ...
   (2^(1 - 2*d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*(2*mm^2 - 2*psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)) + 
   (4^(1 - d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, q2]])/
    (mz^2*Pi^(2*d)) + ((-2 + d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/
    (mz^2*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*ggpgpA*ggpgpZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, q1]])/(mz^2*Pi^(2*d)) + (2^(1 - 2*d)*EL^6*gAl^3*ggpgpA*ggpgpZ*
   ...
   ((-2 + d)*EL^6*gAl^3*ggpgpA*ggpgpZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
