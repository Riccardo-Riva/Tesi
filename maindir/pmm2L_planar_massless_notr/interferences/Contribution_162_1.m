...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mz], 
 ...
 ((4^(1 - d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*
    SPList[SP[p3, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*
    ggmgmZ^2*(gZlL^2 + gZlR^2)*s*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*
    SPList[SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggmgmA*
    ggmgmZ^2*(gZlL^2 + gZlR^2)*SPList[SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
