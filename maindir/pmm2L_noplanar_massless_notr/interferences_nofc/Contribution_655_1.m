...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, 0], 
  ...
  (-((2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL^2*
     ...
     gWlN*gWNl*gZlL^2*((-3 + d)*s^2 + s*t + 2*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL^2*((-2 + d)*s + 2*t)*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL^2*(s + t)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*gWNl*
     gZlL^2*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*
     gWlN*gWNl*gZlL^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*
     gWNl*gZlL^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL^2*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL^2*t*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*gWNl*gZlL^2*t*
