...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((2^(1 - 4*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*mm^2*
      ...
      2*gZlL*(-((-2 + d)*mm^2*(2*Pi)^(2*d)*(psq^3 - psq^2*(2*s + 3*t) + 
        ...
        2^(1 + 2*d)*Pi^(2*d)*(-psq^4 + (-3 + d)*s*t^3 - 
         ...
         (-3*s^2*(psq^2 + t*(s + 3*t)) + d*(psq^4 - 3*psq^3*t - 
            psq*t^2*(9*s + t) + s^2*t*(s + 3*t) + psq^2*(s^2 + 11*s*t + 
              3*t^2)))))*\[Mu]^(8 - 2*d))/(Pi^(4*d)*s) - 
      ...
      gZlL*(-(4^(1 + d)*(-2 + d)*mm^4*Pi^(2*d)*(psq - t)*(psq - s - t)) - 
        ...
        mm^2*(d*(2*Pi)^(2*d)*s*(-5*psq^2 + psq*s - t*(5*s + 13*t)) + 
          2^(1 + 2*d)*Pi^(2*d)*((-4 + d)*psq^3 + 
            psq^2*(11*s + (16 - 5*d)*t) - psq*(s^2 + (32 - 9*d)*s*t + 
              (20 - 7*d)*t^2) + t*(11*s^2 + 21*s*t + (8 - 3*d)*t^2)))))*
        ...
        (-2*psq + s + 2*t)) + gZlL*((-2 + d)*(2*Pi)^(2*d)*psq*s^2*
         ...
         (-psq + s + t) + mm^2*(d*(2*Pi)^(2*d)*s^2*(psq - s + t) + 
          2^(1 + 2*d)*Pi^(2*d)*(-4*(-2 + d)*psq^3 + s^3 - s^2*t + 
            ...
            psq*(s^2 + 10*(-2 + d)*s*t + 12*(-2 + d)*t^2)))))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     (gZlR*mm^2*(psq - s - t)*((2 + 4*d)*psq + (4 - 3*d)*s - 2*(t + 2*d*t)) + 
      gZlL*(4*(-11 + 3*d)*psq^3 + 2*(-2 + d)*mm^4*(psq - s - t) - 
        2*psq^2*((-29 + 7*d)*s + 14*(-4 + d)*t) - 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     (4*(-1 + d)*gZlR*mm^2*s*(-2*psq + s + 2*t) + 
      gZlL*((52 - 18*d)*psq^3 + 5*psq^2*((-2 + d)*s + 8*(-3 + d)*t) + 
        ...
        psq*(2*(-2 + d)*s^2 + (66 - 23*d)*s*t + 2*(46 - 15*d)*t^2) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     ...
     (-4*(-1 + d)*gZlR*mm^2*(psq^2 - 3*psq*s + s^2 - 2*psq*t + 3*s*t + t^2) + 
      gZlL*(2*(-2 + d)*psq^3 + psq^2*((-14 + 13*d)*s - 8*(-2 + d)*t) - 
        psq*(2*(-14 + 9*d)*s^2 + 5*(2 + d)*s*t - 10*(-2 + d)*t^2) + 
        4*(s + t)*((-2 + d)*s^2 + 2*s*t - (-2 + d)*t^2) + 
        mm^2*(2*(-2 + d)*psq^2 + (10 - 7*d)*psq*s + (-10 + 7*d)*s^2 - 
     ...
     (-(gZlR*mm^2*(psq - t)*((2 + 4*d)*psq - (6 + d)*s - 2*(t + 2*d*t))) + 
      gZlL*(4*(-6 + d)*psq^3 - psq*t*((26 + d)*s - 12*(-6 + d)*t) + 
        2*psq^2*((4 + d)*s - 6*(-6 + d)*t) + t*(8*s^2 - (-18 + d)*s*t - 
          4*(-6 + d)*t^2) + mm^2*(psq - t)*((-2 + d)*psq + 2*t - d*(s + t))))*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*mm^2*(psq - t)*
     ...
     (2*gZlR*mm^2*s*(6*psq + (-8 + d)*s - 6*t) + 
      gZlL*s*((22 - 4*d)*psq^2 + (-10 + d)*psq*s + (-40 + 7*d)*psq*t + 
        ...
        2*(-1 + d)*psq*s + (-2 + d)*s^2 - 4*(-2 + d)*psq*t + 2*(-1 + d)*s*t + 
     ...
     (-2*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t) + 
      gZlL*(-2*(-2 + d)*psq^2 + (-10 + 7*d)*psq*s + 2*(-2 + d)*psq*t - 
        2*(-2 + d)*s*(s + 2*t) + mm^2*(2*(-2 + d)*psq + 2*s - 3*d*s + 4*t - 
          2*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     (2*(-1 + d)*gZlR*mm^2*(psq - s - t) + 
      gZlL*((50 - 11*d)*psq^2 + mm^2*(2*(-6 + d)*psq + (2 + d)*s - 
          2*(-6 + d)*t) + psq*((-38 + 7*d)*s + 8*(-9 + 2*d)*t) - 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     (2*(-1 + d)*gZlR*mm^2*(psq - s - t) + 
      gZlL*((52 - 12*d)*psq^2 + (-6 + d)*mm^2*(2*psq - s - 2*t) - 
        (s + t)*((-14 + 3*d)*s + 6*(-4 + d)*t) + 
        psq*((-46 + 11*d)*s + 2*(-38 + 9*d)*t)))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*(2*(-1 + d)*gZlR*mm^2*s + 
      gZlL*((-26 + 7*d)*psq^2 - (2 + d)*mm^2*s + (54 - 11*d)*psq*s - 24*s^2 + 
        4*d*s^2 + 2*(26 - 7*d)*psq*t - 36*s*t + 8*d*s*t - 26*t^2 + 7*d*t^2))*
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*
     (psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*(psq - t)*
     ...
     gWWZ*gZlL*(2*psq^2 + 2*mm^2*s + 3*s^2 + 6*s*t + 2*t^2 - 4*psq*(2*s + t))*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     gZlL*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*(psq - t)^2*
    ...
    Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*(psq - t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*(psq - t)^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*(2*psq + s - 2*t)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*gZlL*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     gZlL*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) - (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     gZlL*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) + (3*4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*
