...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    ((I*EL^5*gAl*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*s*
       ...
       (2*Pi)^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gHFF*gHll*(gZlL + gZlR)*
       mh^2*mm^2*(bb*psq*(-psq + t) + aa*(psq^2 + 2*mm^2*s - psq*(2*s + t)))*
     ...
     (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl*gFFZ*gHFF*gHll*
       (gZlL + gZlR)*mh^2*mm^2*(-(bb*(psq^2 - 2*mm^2*s + psq*(s - t))) + 
     ...
     (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*aa*EL^5*gAl*gFFZ*gHFF*gHll*
     ...
     (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl*gFFZ*gHFF*gHll*
       (gZlL + gZlR)*mh^2*mm^2*(bb*(2*mm^2 - psq + s - t) - aa*(psq + s - t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ*gHFF*
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*bb*EL^5*gAl*gFFZ*gHFF*gHll*
       (gZlL + gZlR)*mh^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     ...
     (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ*gHFF*
       gHll*(gZlL + gZlR)*mh^2*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ*gHFF*
