...
(PropList[KiraPropagator[q1, ms], KiraPropagator[-p1 - p2 + q1, ms]]*
  (((3*I)*2^(2 - d)*EL^6*gAl*gAu*gZdL*gZdR*ms^2*
   ...
   ((3*I)*2^(2 - d)*(-3 + d)*EL^6*gAl*gAu*(gZdL^2 - gZdR^2)*
   ...
   ((3*I)*2^(3 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*
   ...
   ((3*I)*2^(3 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*((-2 + d)*gZlL*gZuL - 
   ...
   ((3*I)*2^(4 - d)*EL^6*gAl*gAu*(gZdL^2 + gZdR^2)*(gZlL + gZlR)*
