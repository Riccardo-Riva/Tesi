...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
   ...
   ((I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s^2*(s + t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s^2*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN^2*gWNl^2*s*t*
    ...
    (I*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*s*(s + 2*t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)^2*EL^5*gAl*gWlN^2*gWNl^2*t*
