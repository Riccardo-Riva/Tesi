...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*(-2 + d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(mm^2 - psq)^2*
     \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) + (2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*
     mm^4*(mm^2 - psq)*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(mm^2 - psq)*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-3 + d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(4*psq^2 + (-6 + d)*mm^2*s - 
   ...
   (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
   ...
   (4^(2 - d)*d*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(2*psq + (-6 + d)*s - 2*t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*d*EL^8*gAl^4*gAu^2*gXll^2*
     mm^4*(-2*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*
     gXll^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (4*psq^2 + d*s*(-2*mm^2 + s) + 2*psq*(d*s - 4*t) + 4*(-s^2 + s*t + t^2))*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - psq - t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(2*mm^2 - 3*psq + s + t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-2*psq + (-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
     (-2*psq + (-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
