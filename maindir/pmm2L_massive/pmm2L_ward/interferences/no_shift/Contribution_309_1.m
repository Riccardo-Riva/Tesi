...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  (((-I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gWWA^3*mm^2*s*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*s*
     ...
     SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     gWWA^3*mm^2*(24*(-1 + d)*psq^2 + (26 - 14*d)*psq*s + 3*(-4 + d)*s^2 - 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*s*
     ...
     SPList[SP[q1, q2]])/Pi^(2*d) + ((3*I)*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*
     gAl^2*gWWA^3*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[q2, q2]])/Pi^(2*d) + (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^2*gWWA^3*
   ...
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*(bb*(psq - s - t) + 
      aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(-5 + 3*d)*EL^5*gAl^2*gWWA^3*s*(bb*(psq - s - t) + 
      aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWWA^3*mm^2*(6*(-1 + d)*psq + 
      (8 - 5*d)*s - 6*(-1 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^2*gWWA^3*
   ...
   (I*2^(3 - 2*d)*(-1 + d)*EL^5*gAl^2*gWWA^3*s*(aa*(psq - t) + 
      bb*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
    Pi^(2*d) + (I*4^(1 - d)*(-2 + d)*EL^5*gAl^2*gWWA^3*s*
     (aa*(psq - t) + bb*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*(-5 + 3*d)*EL^5*gAl^2*gWWA^3*s*(aa*(psq - t) + 
      bb*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gWWA^3*mm^2*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gWWA^3*(aa*mm^2*((-6 + 8*d)*psq + (9 - 8*d)*s + 
        6*t - 8*d*t) + bb*mm^2*((6 - 8*d)*psq + 15*s - 8*d*s - 6*t + 8*d*t) - 
   ...
   (I*4^(2 - d)*(-1 + d)*EL^5*gAl^2*gWWA^3*(bb*(psq - s - t) + 
      aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gAl^2*gWWA^3*(aa*(2*(-5 + 3*d)*mm^2 + 12*psq - 7*d*psq + 
