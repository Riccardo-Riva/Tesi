   ...
   (-((4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*
      ...
      (-2*gZlL*gZlR*(4^(1 + d)*Pi^(2*d)*(2*psq^3 + psq^2*(s - 6*t) - 
       ...
       gZlL^2*(-(d*(2*Pi)^(2*d)*psq*s*(3*psq + s - 11*t)) + 
         ...
         2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + 
           psq^2*(7*s - 6*(-2 + d)*t) - 2*t*(s + t)*((-4 + d)*s + 
             (-2 + d)*t) + psq*(s^2 - 19*s*t + 6*(-2 + d)*t^2))) + 
    ...
    (2^(1 - 4*d)*EL^6*gAl*gAu*gHll^2*mm^4*
      (gZlL^2*(2^(1 + 2*d)*(-2 + d)*mm^2*Pi^(2*d)*(psq - t)*(psq - s - t) + 
       ...
       2*gZlL*gZlR*(d*(2*Pi)^(2*d)*(4*psq^3 + 3*mm^2*(2*psq - s - 2*t)*
           ...
           psq*(mm^2*s + t*(7*s + 6*t)))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/(Pi^(4*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*(-2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^4*(-psq + s + t)*
      (-2*(-1 + d)*gZlL*gZlR*(2*mm^2 - 3*psq + s + t) + 
       gZlL^2*(3*(-2 + d)*mm^2 - 6*(-2 + d)*psq - 2*s + 2*d*s - 6*t + 
         3*d*t) + gZlR^2*(3*(-2 + d)*mm^2 - 6*(-2 + d)*psq - 2*s + 2*d*s - 
         6*t + 3*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
     (Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (2*gZlL^2*mm^2*((-2 + d)*psq^2 + (-2 + d)*mm^2*s - s^2 + d*s^2 - 
         4*s*t + 2*d*s*t - 2*t^2 + d*t^2 - (-2 + d)*psq*(3*s + 2*t)) + 
       2*gZlR^2*mm^2*((-2 + d)*psq^2 + (-2 + d)*mm^2*s - s^2 + d*s^2 - 
         4*s*t + 2*d*s*t - 2*t^2 + d*t^2 - (-2 + d)*psq*(3*s + 2*t)) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (gZlL^2*mm^2*(-2*(-2 + d)*psq^2 + 2*psq*s - 2*s^2 + 
         (-2 + d)*mm^2*(psq - t) + 3*(-2 + d)*psq*t - 2*s*t + 2*t^2 - 
         d*t^2) + gZlR^2*mm^2*(-2*(-2 + d)*psq^2 + 2*psq*s - 2*s^2 + 
         (-2 + d)*mm^2*(psq - t) + 3*(-2 + d)*psq*t - 2*s*t + 2*t^2 - 
         d*t^2) - gZlL*gZlR*(-(d*psq^2*s) + 3*d*mm^4*(psq - t) - 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^4*(-4*d*gZlL*gZlR*(mm^2 - psq)*
      ...
      ((-2 + d)*gZlL^2*mm^2*(4*psq^2 + mm^2*s - 9*psq*s + 3*s^2 - 8*psq*t + 
         ...
         3*s^2 - 8*psq*t + 8*s*t + 4*t^2) - gZlL*gZlR*
        (3*d*mm^4*s + 2*psq*s*(psq - t) + mm^2*((-4 + d)*psq^2 - 
           4*(-1 + d)*psq*s + 2*s^2 - 2*(-4 + d)*psq*t + (-4 + d)*s*t + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^4*(psq - t)*
      (2*(-1 + d)*gZlL*gZlR*(psq - t) + gZlL^2*(-3*(-2 + d)*psq + 
         (-4 + d)*s + 3*(-2 + d)*t) + gZlR^2*(-3*(-2 + d)*psq + (-4 + d)*s + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (2*gZlL^2*mm^2*((-2 + d)*psq^2 + s^2 - 2*(-2 + d)*psq*t + 
         ...
         2*(-2 + d)*psq*t + (-2 + d)*t^2) + gZlL*gZlR*
        (-(d*(psq*s + 3*mm^2*(psq - t))*(psq - t)) + 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
      (psq - t)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (4^(1 - 2*d)*EL^6*gAl*gAu*gHll^2*mm^2*
      (-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t)*(psq - t)) - 
       ...
       gZlL*gZlR*(-(d*(2*Pi)^(2*d)*(psq - t)*(3*psq^2 + 
         ...
         4^(1 + d)*Pi^(2*d)*(2*psq^3 + mm^2*psq*s - 6*psq^2*t + 
           psq*t*(s + 6*t) - t*(mm^2*s - s^2 + s*t + 2*t^2))))*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*mm^2*
      ((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)*(psq - t) + 
       ...
       2*gZlL*gZlR*(-8*psq^3 + 6*psq^2*(s + 4*t) + 
         ...
         4*psq*(mm^2*s + 4*s*t + 6*t^2) + d*(3*psq^3 + mm^2*(3*psq - s - 3*t)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*mm^2*(-((-2 + d)*gZlL^2*mm^2*(psq - t)) - 
       (-2 + d)*gZlR^2*mm^2*(psq - t) + gZlL*gZlR*(-4*psq^2 + 
         (-4 + d)*psq*s + 2*(-4 + d)*mm^2*(psq - t) + 8*psq*t - 
         2*t*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*mm^2*((-2 + d)*gZlL^2*mm^2*s + 
       (-2 + d)*gZlR^2*mm^2*s + gZlL*gZlR*((-8 + 3*d)*psq^2 - 
         (-4 + d)*mm^2*(psq + 2*s - t) + psq*(-2*(-3 + d)*s + (12 - 5*d)*t) + 
         2*(s^2 + (-3 + d)*s*t + (-2 + d)*t^2)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*((10 - 3*d)*psq^2 + 
     ...
     (Pi^(2*d)*s) + (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
       SP[p3, q2]])/Pi^(2*d) + (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gHll^2*gZlL*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*(-((-4 + d)*psq^2) + 
       ...
       4*t^2 - d*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[q1, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gHll^2*
      gZlL*gZlR*mm^2*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*
    ...
    (4^(2 - d)*(-4 + d)*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
    (2^(3 - 2*d)*d*EL^6*gAl*gAu*gHll^2*gZlL*gZlR*mm^2*(psq - t)^2*
