...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^4*s*
  ...
  (EL^5*gAl*gHll^2*mm^4*(-(bb*(-2*(4 + d)*gZlL*gZlR*(mm^2 + psq) + 
     ...
     aa*(-4*gZlL*gZlR*(4*mm^2 + d*psq) + (-2 + d)*gZlL^2*(3*psq - s) + 
  ...
  (EL^5*gAl*gHll^2*mm^2*(aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s) + 
       (-2 + d)*gZlR^2*mm^2*(2*psq - s) - 2*gZlL*gZlR*
        (d*(psq^2 + mm^2*(3*psq - 2*s)) + 4*mm^2*s)) - 
     bb*((-2 + d)*gZlL^2*mm^2*(2*psq - s) + (-2 + d)*gZlR^2*mm^2*
        (2*psq - s) - 2*gZlL*gZlR*(d*psq*(psq - s) + d*mm^2*(3*psq - s) + 
         2*(mm^2 + psq)*s)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   (2*Pi)^(2*d) - (2^(3 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
    (bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
   Pi^(2*d) - (2^(1 - 2*d)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
  ...
  (EL^5*gAl*gHll^2*mm^2*(aa*((-2 + d)*gZlL^2 - 4*(-4 + d)*gZlL*gZlR + 
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*mm^2 - aa*psq)*
  ...
  (2^(3 - 2*d)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(bb*mm^2 - aa*psq)*
