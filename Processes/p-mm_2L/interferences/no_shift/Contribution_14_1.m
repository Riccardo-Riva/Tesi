...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   KiraPropagator[-p1 - p2 + p3 + q1, 0], KiraPropagator[q2, md], 
   KiraPropagator[p1 + p2 + q2, md], KiraPropagator[p3 + q1 + q2, md]]*
  ((-3*EL^8*gAd^3*gAl^5*md^2*mm^2*(me^2*(4*(-2 + d)*mm^2 + (-2 + 3*d)*s) + 
      2*(-2 + d)*(mm^4 + s^2 - 2*mm^2*t + s*t + t^2)))/(8*Pi^8*s^2) + 
   (3*EL^8*gAd^3*gAl^5*md^2*(-2*(4 + d)*mm^4 - 12*s^2 + 3*d*s^2 + 
   ...
   (3*EL^8*gAd^3*gAl^5*(s*(s*(-8*(-3 + d)*mm^2 + (-4 + d)*s) + 
      ...
      2*md^2*(8*mm^4 - 2*s^2 + d*s^2 + 2*me^2*(8*mm^2 + (-2 + d)*s) - 
   ...
   (3*EL^8*gAd^3*gAl^5*(2*(-8 + 3*d)*me^2*mm^2 - 4*mm^4 - 3*d*mm^4 - 
      ...
      d*t^2 + md^2*(-((2 + d)*mm^2) + 2*t + d*(s + t)))*
     SPList[SP[p1, q1], SP[p2, q2]])/(8*Pi^8*s^2) + 
   (3*(-2 + d)*EL^8*gAd^3*gAl^5*md^2*(4*me^2 - 2*mm^2 + 3*s + 2*t)*
     SPList[SP[p1, q1], SP[p3, q1]])/(8*Pi^8*s^2) - 
   (3*EL^8*gAd^3*gAl^5*((2*me^2 + s)*(4*d*mm^2 + 4*s - d*s) + 
      2*md^2*(2*(-2 + d)*me^2 + 4*mm^2 - 4*s + d*s - 4*t))*
   ...
   (3*EL^8*gAd^3*gAl^5*(2*(-8 + 3*d)*me^2*mm^2 - 4*mm^4 + 5*d*mm^4 - 
      ...
      md^2*((2 + d)*mm^2 - 2*s - (2 + d)*t))*SPList[SP[p1, q2], SP[p2, q1]])/
   ...
   (3*(-2 + d)*EL^8*gAd^3*gAl^5*md^2*(mm^2 - t)*SPList[SP[p2, q1], 
      SP[p2, q1]])/(8*Pi^8*s^2) + 
   (3*EL^8*gAd^3*gAl^5*(2*(8 - 3*d)*me^2*mm^2 + 4*mm^4 - d*mm^4 + 8*mm^2*s - 
      3*d*mm^2*s + (-2 + d)*md^2*(mm^2 - t) - 8*mm^2*t + 2*d*mm^2*t + 4*t^2 - 
      d*t^2)*SPList[SP[p2, q1], SP[p2, q2]])/(8*Pi^8*s^2) + 
   (3*(-2 + d)*EL^8*gAd^3*gAl^5*md^2*(4*me^2 + 2*mm^2 + s - 2*t)*
   ...
   (3*(-2 + d)*EL^8*gAd^3*gAl^5*md^2*(2*me^2 + s)*SPList[SP[p3, q1], 
      SP[p3, q1]])/(4*Pi^8*s^2) + 
   (3*EL^8*gAd^3*gAl^5*(2*(-2 + d)*md^2*(2*me^2 + s) + 
