...
PropList[KiraPropagator[p1 - q1, mw], KiraPropagator[-p2 - q1, 
  ...
  ((I*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*t*
     (mw^2*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
        ...
        2^(1 + d)*gZuL*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 
          2*t^2)) - (2^(1 + d)*Pi^d*t^2*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
     ...
     ((-3*2^(2 - d)*s*t^2*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
      ...
      (t*(s*GaugeXi[Q]*(d*gZuL*(2*Pi)^d*s^2 - d*gZuR*(2*Pi)^d*s^2 + 
           ...
           2^(2 + d)*Pi^d*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
                ...
                t + 4*t^2))*GaugeXi[Q] + (13*d*gZuR*(2*Pi)^d*s^2 - 
      ...
      (s*GaugeXi[Q]*(d*gZuL*(2*Pi)^d*s^2 - d*gZuR*(2*Pi)^d*s^2 + 
          ...
          2^(2 + d)*Pi^d*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
            ...
            2^(1 + d)*gZuR*Pi^d*((10 + d^2)*s^2 + (13 - 11*d + 2*d^2)*s*t - 
              2*t^2) + gZuL*(-9*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(
                (5 + d^2)*s^2 + (17 - 11*d + 2*d^2)*s*t + 2*t^2)))*
           GaugeXi[Q]^2))/(2*Pi)^(2*d))*SPList[SP[p3, q1], SP[p3, q1]])/
    (mw^4*(mz^2 - s)*s*(-1 + GaugeXi[Q])^2*GaugeXi[Q]) - 
   ((I/4)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     ((3*2^(3 - d)*s*t*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
         2*(-3 + d)*gZuL*t - 2*(-3 + d)*gZuR*t)*(-1 + GaugeXi[Q])^2)/Pi^d - 
 ...
 PropList[KiraPropagator[-p1 + q1, mw], KiraPropagator[p2 + q1, 
  ...
  (((-I)*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*(d^2*gZuL*(2*Pi)^d*s^2 - 
      d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - 
        (4 - 5*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZuL*Pi^d*
    ...
    (mw^2*Pi^(2*d)*(mz^2 - s)) + (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     (d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
      2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2) + 
      2^(1 + d)*gZuL*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))*
     SPList[SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)) - 
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*(d^2*gZuL*(2*Pi)^d*s^2 - 
      d^2*gZuR*(2*Pi)^d*s^2 + 2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - 
        (4 - 5*d + d^2)*s*t + 2*t^2) + 2^(1 + d)*gZuL*Pi^d*
       (-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))*SPList[SP[p3, q1]])/
    (mw^2*Pi^(2*d)*(mz^2 - s)) + (I*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     (d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
      2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 2*t^2) + 
      2^(1 + d)*gZuL*Pi^d*(-2*(-1 + d)*s^2 + (8 - 5*d + d^2)*s*t + 2*t^2))*
   ...
   ((I/2)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     ...
     SPList[SP[p2, p3], SP[p2, p3]])/(mw^4*(mz^2 - s)*s*GaugeXi[Q]) - 
   ((I/2)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
          ...
          2^(2 + d)*Pi^d*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
            ...
            2^(1 + d)*gZuR*Pi^d*((10 + d^2)*s^2 + (13 - 11*d + 2*d^2)*s*t - 
              2*t^2) + gZuL*(-9*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(
                (5 + d^2)*s^2 + (17 - 11*d + 2*d^2)*s*t + 2*t^2)))*
           GaugeXi[Q]^2))/((2*Pi)^(2*d)*(-1 + GaugeXi[Q])^2))*
     SPList[SP[p2, p3], SP[p2, q1]])/(mw^4*(mz^2 - s)*s*GaugeXi[Q]) + 
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
          ...
          2^(2 + d)*Pi^d*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
            ...
            2^(1 + d)*gZuR*Pi^d*((10 + d^2)*s^2 + (13 - 11*d + 2*d^2)*s*t - 
              2*t^2) + gZuL*(-9*d*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*(
                (5 + d^2)*s^2 + (17 - 11*d + 2*d^2)*s*t + 2*t^2)))*
           GaugeXi[Q]^2))/((2*Pi)^(2*d)*(-1 + GaugeXi[Q])^2))*
     SPList[SP[p2, p3], SP[q1, q1]])/(mw^4*(mz^2 - s)*s*GaugeXi[Q]) + 
   ((I/2)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     ((-(mw^2*t*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 2*gZuL*t + 2*gZuR*t)) + 
        (gZuR*s*t*(-((-4 + d)*s) + 2*t) + gZuL*s*t*((-2 + d)*s + 2*t) + 
          gZuR*mw^2*(-2*(8 - 6*d + d^2)*s^2 + (-20 + 21*d - 4*d^2)*s*t + 
    ...
    (mw^4*(mz^2 - s)*s*GaugeXi[Q]) - (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*
     gWWZ*(mw^2*(-(gZuR*(d*(2*Pi)^d*s*(7*s - 15*t) + 2^(1 + d)*Pi^d*
     ...
     (-((2^(3 - d)*((-4 + d)*gZuL - (-2 + d)*gZuR)*t*(s + t)*
      ...
      (2^(2 - d)*(gZuR*(-3*(-4 + d)*s^2 + (22 - 6*d)*s*t + 4*t^2) + 
        ...
        (d*gZuL*(2*Pi)^d*s - d*gZuR*(2*Pi)^d*s + 2^(1 + d)*gZuL*Pi^d*
         ...
         (2^(2 + d)*gZuL*Pi^d - 2^(1 + d)*gZuR*Pi^d - d*gZuL*(2*Pi)^d + 
           d*gZuR*(2*Pi)^d)*s*GaugeXi[Q]))/Pi^(2*d) + 
      ((-1 + GaugeXi[Q])^2*((3*s + 4*t)*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
           2*gZuL*t + 2*gZuR*t) + s*(6*gZuL*s - d*gZuL*s + d*gZuR*s + 
           2*gZuL*t + 2*gZuR*t)*GaugeXi[Q]))/(2*Pi)^d - 
      (4^(1 - d)*(3*d*gZuL*(2*Pi)^d*s*t - 3*d*gZuR*(2*Pi)^d*s*t + 
         2^(1 + d)*gZuL*Pi^d*((-2 + d)*s^2 - 3*s*t + t^2) + 
         2^(1 + d)*gZuR*Pi^d*(-((-4 + d)*s^2) + 6*s*t + t^2) - 
  ...
  (((I/4)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*t*
     ((2^(1 - d)*s*t^2*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
      ...
      (2^(1 - 2*d)*(mw - mw*GaugeXi[Q])^2*
        (s*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
    ...
    (2^(2*(1 + d))*Pi^(2*d)*s) - ((I/4)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     ((-3*2^(2 - d)*s*t^2*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 
      ...
      (2^(1 - d)*mw^4*(gZuR*((56 - 34*d + 5*d^2)*s^2 + 2*(46 - 31*d + 5*d^2)*
            s*t - 4*(-2 + d)*t^2) - gZuL*((28 - 24*d + 5*d^2)*s^2 + 
           2*(38 - 27*d + 5*d^2)*s*t + 4*(-2 + d)*t^2))*(-1 + GaugeXi[Q])^2*
        GaugeXi[Q])/Pi^d + (4^(1 - d)*(mw - mw*GaugeXi[Q])^2*
        (s*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*s^2 + 
           2^(1 + d)*gZuR*Pi^d*((-4 + 3*d)*s^2 - (4 - 5*d + d^2)*s*t + 
             2*t^2) + 2^(1 + d)*gZuL*Pi^d*(-2*(-1 + d)*s^2 + 
             (8 - 5*d + d^2)*s*t + 2*t^2))*GaugeXi[Q] + 
   ...
   ((I/2)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     ((3*s*t^2*((-2 + d)*gZuL*s - (-4 + d)*gZuR*s + 2*(-3 + d)*gZuL*t - 
      ...
      ((mw - mw*GaugeXi[Q])^2*(s*(d^2*gZuL*(2*Pi)^d*s^2 - d^2*gZuR*(2*Pi)^d*
   ...
   ((I/2)*EL^6*gAl*gAu*gWlN*gWNl*gWWZ*
     ((2^(2 - d)*((-4 + d)*gZuL - (-2 + d)*gZuR)*t^2*(s + t)*
      ...
      (s*GaugeXi[Q]*(d*gZuL*(2*Pi)^d*s^2 - d*gZuR*(2*Pi)^d*s^2 + 
        ...
        (11*d*gZuR*(2*Pi)^d*s^2 - 2^(1 + d)*gZuR*Pi^d*((6 + d^2)*s^2 + 
           (3 - 9*d + 2*d^2)*s*t - 6*t^2) + gZuL*(-7*d*(2*Pi)^d*s^2 + 
           2^(1 + d)*Pi^d*((3 + d^2)*s^2 + (15 - 9*d + 2*d^2)*s*t + 6*t^2)) - 
         2^(2 + d)*Pi^d*(-(gZuR*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*
               t - 4*t^2)) + gZuL*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 
             4*t^2))*GaugeXi[Q] + (13*d*gZuR*(2*Pi)^d*s^2 - 
           2^(1 + d)*gZuR*Pi^d*((10 + d^2)*s^2 + (13 - 11*d + 2*d^2)*s*t - 
