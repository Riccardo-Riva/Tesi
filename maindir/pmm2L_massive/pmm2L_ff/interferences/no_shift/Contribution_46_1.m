...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^4 - psq^2)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^4 - psq^2)*
     (psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^4 - psq^2)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^4 - psq^2)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 + psq)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (-psq + s + t)*(psq*(-3*psq + s + t) + mm^2*(psq + s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (-2*mm^4*(psq - t) + mm^2*(3*psq^2 - 4*psq*t + t*(s + t)) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(-psq + s + t)*
     (psq*(-3*psq + s + t) + mm^2*(psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (-psq^3 - 2*mm^4*(psq - t) + psq*t*(s + t) + 
      mm^2*(5*psq^2 - 6*psq*t + t*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - psq)*psq*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (2*mm^4*s - psq*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2) + 
      2*mm^2*(psq^2 - 2*psq*(s + t) + t*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (psq*(psq^2 - 7*psq*s + 2*s^2 - 2*psq*t + 3*s*t + t^2) + 
      mm^2*(psq^2 + 2*psq*(s - t) + (s + t)^2))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (psq*(-5*psq^2 - 4*psq*s + s^2 + 10*psq*t - 4*s*t - 5*t^2) + 
      mm^2*(7*psq^2 + psq*(s - 14*t) + 7*t*(s + t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 + psq)*(psq - t)^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - 3*psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 + psq)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^4*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(psq - t)*
     (3*psq*(psq - t) + mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - psq)*
     (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*
     mm^2*(psq - t)*(mm^2*(psq - t) + psq*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - psq)*
    ...
    Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     ...
     gXll*mm^2*(2*mm^2 - psq)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(2*mm^2 - psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(2*mm^2 - psq)*
     ...
     gXll*mm^2*(mm^2 - 2*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*
     gXll*mm^2*(2*mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (2*mm^2*(psq + s - t) + 2*t*(s + t) - psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (mm^2*(psq - t) + t*(-psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - psq)*(psq - t)*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(mm^2 - psq)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[q1, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[p3, q2]])/
    Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     (psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*(psq - t)^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*mm^2*
     ...
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q2, q2]])/Pi^(2*d) - (4^(2 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
      SP[p3, q2]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gFll*gWlN*gXFW*gXll*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
      SP[q1, q2]])/Pi^(2*d)))/4
