...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
      (mm^2*(4*psq - s) - (-1 + d)*psq*s)*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d)) - 
   ...
   (EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*d*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) - 
   (4^(2 - d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(-4 + d)*EL^6*gAl^2*gHXX*gHXZ*gXll*(gZlL - gZlR)*mh^2*mm^2*
