...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl*gAu*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*t*(s + t)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*(s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl*gAu*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*(s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFFAA*gFFZ*(gZlL + gZlR)*t*(s + t)*(s + 2*t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*t*\[Mu]^(8 - 2*d)*
