...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 
   ...
   ((I*EL^6*gAl*gAu*t*(s + t)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
       gZlR^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*t*(s + t)*
    ...
    (I*2^(2 - d)*EL^6*gAl*gAu*
      (gZlL^2*(gZuR^2*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
       ...
       gZlR^2*(gZuL^2*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
         gZuR^2*((-2 + d)*s^2 + 4*s*t + 2*t^2)))*SPList[SP[p1, q1], 
    ...
    (I*EL^6*gAl*gAu*(gZlR^2*(-(gZuR^2*(-(d*(2*Pi)^d*s*(3*s + 5*t)) + 
       ...
       gZlL^2*(gZuL^2*(d*(2*Pi)^d*s*(3*s + 5*t) + 2^(1 + d)*Pi^d*
           ...
           2^(1 + d)*Pi^d*(6*s^2 + 9*s*t + t^2))))*SPList[SP[p1, q1], 
       SP[q1, q1], SP[q1, q1]])/(mz^4*(2*Pi)^(2*d)*s) + 
    (I*2^(1 - d)*EL^6*gAl*gAu*(gZlL^2*((-2 + d)*gZuL^2 - (-4 + d)*gZuR^2) + 
       gZlR^2*(-((-4 + d)*gZuL^2) + (-2 + d)*gZuR^2))*t^2*
      SPList[SP[p2, q1], SP[p2, q1], SP[q1, q1]])/(mz^4*Pi^d*s) - 
    (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*t^2*
      SPList[SP[p2, q1], SP[p3, q1], SP[q1, q1]])/(mz^4*Pi^d*s) - 
    (I*EL^6*gAl*gAu*t*
    ...
    (I*EL^6*gAl*gAu*
      (-(gZlR^2*(-(gZuR^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(3*s + 5*t - 2*d*
       ...
       gZlL^2*(gZuL^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(3*s + 5*t - 
            ...
            (6*s + 7*t - 2*d*t))))*SPList[SP[p3, q1], SP[q1, q1], 
    ...
    (I*4^(1 - d)*EL^6*gAl*gAu*(gZlL^2 + gZlR^2)*(gZuL^2 + gZuR^2)*
      (2^(1 + d)*Pi^d - (2*Pi)^d)*SPList[SP[p3, q1], SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(mz^4*Pi^(2*d))) + 
    ...
    (I*EL^6*gAl*gAu*
     ...
     (mz^4*s*(-1 + GaugeXi[Q])^2) - (I*2^(1 - d)*EL^6*gAl*gAu*
      (gZlR^2*(-((-8 + 18*d - 8*d^2 + d^3)*gZuL^2) + (8 + 12*d - 8*d^2 + d^3)*
         ...
         (-8 + 18*d - 8*d^2 + d^3)*gZuR^2))*t*SPList[SP[p2, q1], SP[p2, q1]])/
     (Pi^d*s) + (I*2^(1 - 2*d)*EL^6*gAl*gAu*
      (-(gZlR^2*(-(gZuR^2*(-(d^3*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
    ...
    (I*EL^6*gAl*gAu*
      (gZlR^2*(-(gZuR^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(3*s + 5*t - 
       ...
       gZlL^2*(gZuR^2*(-3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*(6*s + 7*t - 
             2*d*t)) + gZuL^2*(3*d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            (-3*s - 5*t + 2*d*t))))*SPList[SP[p3, q1], SP[q1, q1], 
       SP[q1, q1]])/(mz^4*(2*Pi)^(2*d)) + 
    (I*EL^6*gAl*gAu*
