...
PropList[KiraPropagator[p3 - q1, mz], KiraPropagator[-q1, mm], 
 ...
 (((-I)*4^(-1 - d)*EL^5*gAl*gXll^2*mm^2*s*
    (aa*((-2 + d)*gZlL^2*mm^2*(mm^4 + mm^2*(psq - 2*s - t) - psq*(s + t) + 
         s*(s + 2*t)) + (-2 + d)*gZlR^2*mm^2*(mm^4 + mm^2*(psq - 2*s - t) - 
         psq*(s + t) + s*(s + 2*t)) - 2*gZlL*gZlR*
        (-2*(mm^4*(s - 2*t) + mm^2*s*(psq - 2*s + 2*t) + 
           (psq - s)*(-s^2 + 2*psq*t - 2*s*t)) + 
         d*(mm^4*(psq - 2*t) - psq*(psq - s)*(s - t) + 
           mm^2*(psq^2 + 3*s*t - psq*(2*s + t))))) + 
     bb*((-2 + d)*gZlL^2*mm^2*(mm^4 - 2*psq^2 - mm^2*(psq + s - t) + 
         psq*(4*s + t) - s*(s + 2*t)) + (-2 + d)*gZlR^2*mm^2*
        (mm^4 - 2*psq^2 - mm^2*(psq + s - t) + psq*(4*s + t) - s*(s + 2*t)) + 
       2*gZlL*gZlR*(mm^4*((-8 + 3*d)*psq + 6*s - 2*d*s + 4*t - 2*d*t) - 
         (psq - s)*(2*(-4 + d)*psq^2 - 2*(-6 + d)*psq*s - (-4 + d)*psq*t - 
           2*s*(s + 2*t)) + mm^2*(-2*s*(-5*psq + 4*s + 2*t) + 
           d*(psq^2 + 3*s*(s + t) - psq*(5*s + t))))))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) + (I*2^(-1 - 4*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*(2^(1 + 2*d)*(-2 + d)*gZlL^2*mm^2*Pi^(2*d)*(mm^2 + psq - 2*s)*
        (2*psq - s - 2*t) + 2^(1 + 2*d)*(-2 + d)*gZlR^2*mm^2*Pi^(2*d)*
        (mm^2 + psq - 2*s)*(2*psq - s - 2*t) + gZlL*gZlR*(2*Pi)^(2*d)*
        (6*(-4 + d)*psq^3 + 26*s^2*(s + 2*t) + 
         psq^2*((76 - 9*d)*s - 6*(-4 + d)*t) + mm^4*((8 - 10*d)*psq + 3*d*s - 
           8*t + 10*d*t) + 2*psq*s*((-41 + d)*s + 2*(-17 + 2*d)*t) - 
         mm^2*(4*(4 + d)*psq^2 - 4*psq*(5*(1 + d)*s + (4 + d)*t) + 
           s*((10 + 7*d)*s + 6*(2 + 3*d)*t)))) + 
     bb*(-(2^(1 + 2*d)*(-2 + d)*gZlL^2*mm^2*Pi^(2*d)*(mm^2 + psq - 2*s)*
         (2*psq - s - 2*t)) - 2^(1 + 2*d)*(-2 + d)*gZlR^2*mm^2*Pi^(2*d)*
        (mm^2 + psq - 2*s)*(2*psq - s - 2*t) + gZlL*gZlR*(2*Pi)^(2*d)*
        (-6*(-4 + d)*psq^3 - 26*s^2*(s + 2*t) + 
         psq^2*((-84 + 13*d)*s + 6*(-4 + d)*t) + 
         mm^4*(2*(-4 + 5*d)*psq + 8*s - 7*d*s + 8*t - 10*d*t) + 
         2*psq*s*(-3*(-15 + d)*s + 34*t - 4*d*t) + 
         mm^2*(4*(4 + d)*psq^2 - 4*psq*(5*(1 + d)*s + (4 + d)*t) + 
           s*((2 + 11*d)*s + 6*(2 + 3*d)*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2]])/Pi^(4*d) + (I*2^(-1 - 6*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(4*d)*(psq^2 - s^2 + 
         mm^2*(psq - s - t) + psq*(s - t)) + (-2 + d)*gZlR^2*mm^2*
        (2*Pi)^(4*d)*(psq^2 - s^2 + mm^2*(psq - s - t) + psq*(s - t)) + 
       gZlL*gZlR*(16^d*(4 - 3*d)*mm^4*Pi^(4*d)*(psq - s - t) + 
         (2*Pi)^(4*d)*((-4 + d)*psq^3 + psq^2*(2*(-5 + d)*s - (-4 + d)*t) + 
           psq*s*((30 - 7*d)*s - (-2 + d)*t) + s^2*(3*(-4 + d)*s + 
             (-10 + 3*d)*t)) + mm^2*(2*Pi)^(4*d)*(2*s*(psq - 2*s + t) - 
           d*(2*psq^2 - 3*psq*s + s^2 - 2*psq*t + 3*s*t)))) + 
     aa*(2*Pi)^(4*d)*(-((-2 + d)*gZlL^2*mm^2*(psq^2 - s^2 + mm^2*(psq - t) - 
          psq*t)) - (-2 + d)*gZlR^2*mm^2*(psq^2 - s^2 + mm^2*(psq - t) - 
         psq*t) + gZlL*gZlR*(-((-4 + d)*psq^3) + 
         s^2*(-3*(-4 + d)*s + (10 - 3*d)*t) + psq^2*(-2*s + (-4 + d)*t) + 
         psq*s*(2*(-7 + 2*d)*s + (-2 + d)*t) + mm^4*((-4 + 3*d)*psq + 8*s - 
           3*d*s + 4*t - 3*d*t) + mm^2*(-2*s*(-3*psq + 6*s + t) + 
           d*(2*psq^2 - 5*psq*s + 4*s^2 - 2*psq*t + 3*s*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(6*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(psq^2 + mm^2*(psq - t) - psq*(3*s + t) + 
         s*(s + 2*t)) + (-2 + d)*gZlR^2*mm^2*(psq^2 + mm^2*(psq - t) - 
         psq*(3*s + t) + s*(s + 2*t)) + gZlL*gZlR*
        (d*(2*psq^3 - 3*s^2*(s + t) - 2*psq^2*(3*s + t) + 
           mm^4*(-2*psq + s + 2*t) + psq*s*(8*s + 3*t)) - 
         4*(2*psq^3 + mm^2*(psq - 2*s)*(2*psq - s - 2*t) - 
           2*psq^2*(4*s + t) - s^2*(4*s + 5*t) + psq*s*(11*s + 5*t)))) + 
     bb*(-((-2 + d)*gZlL^2*mm^2*(psq^2 + mm^2*(psq - s - t) - psq*(2*s + t) + 
          s*(s + 2*t))) - (-2 + d)*gZlR^2*mm^2*(psq^2 + mm^2*(psq - s - t) - 
         psq*(2*s + t) + s*(s + 2*t)) + gZlL*gZlR*
        (d*(-2*psq^3 + mm^2*(2*psq - 5*s)*s + mm^4*(2*psq + s - 2*t) + 
           2*psq^2*(s + t) - 3*psq*s*(s + t) + 3*s^2*(s + t)) - 
         4*(-2*psq^3 + 2*mm^4*s + 2*psq^2*(2*s + t) + s^2*(4*s + 5*t) - 
           psq*s*(6*s + 5*t) + mm^2*(-2*psq^2 + 7*psq*s - 7*s^2 + 2*psq*t - 
             4*s*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 6*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(4*d)*(2*psq^2 - 3*psq*s + s^2 + 
          2*mm^2*(psq - s - t) - 2*psq*t + 4*s*t)) - (-2 + d)*gZlR^2*mm^2*
        (2*Pi)^(4*d)*(2*psq^2 - 3*psq*s + s^2 + 2*mm^2*(psq - s - t) - 
         2*psq*t + 4*s*t) + gZlL*gZlR*(16^d*mm^4*Pi^(4*d)*
          ((-4 + 5*d)*psq - 3*d*s + 4*t - 5*d*t) + (2*Pi)^(4*d)*
          (-3*(-4 + d)*psq^3 - 2*s^2*(5*s + 11*t) + 
           2*psq*s*((8 + d)*s + (15 - 2*d)*t) + psq^2*((-22 + 3*d)*s + 
             3*(-4 + d)*t)) + mm^2*(2*Pi)^(4*d)*(2*(4 + d)*psq^2 - 
           psq*((26 + 5*d)*s + 2*(4 + d)*t) + s*(-((-26 + d)*s) + 
             (10 + 7*d)*t)))) + aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(4*d)*
        (2*psq^2 - 5*psq*s + s^2 + 2*mm^2*(psq - t) - 2*psq*t + 4*s*t) + 
       (-2 + d)*gZlR^2*mm^2*(2*Pi)^(4*d)*(2*psq^2 - 5*psq*s + s^2 + 
         2*mm^2*(psq - t) - 2*psq*t + 4*s*t) + 
       gZlL*gZlR*(16^d*mm^4*Pi^(4*d)*((4 - 5*d)*psq + (-4 + 3*d)*s + 
           (-4 + 5*d)*t) + (2*Pi)^(4*d)*(3*(-4 + d)*psq^3 + 
           2*s^2*(5*s + 11*t) + psq^2*(-7*(-6 + d)*s - 3*(-4 + d)*t) + 
           2*psq*s*(2*(-11 + d)*s + (-15 + 2*d)*t)) + mm^2*(2*Pi)^(4*d)*
          (-2*(4 + d)*psq^2 + psq*((10 + 9*d)*s + 2*(4 + d)*t) - 
           s*((-2 + 5*d)*s + (10 + 7*d)*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(6*d) + (I*2^(-1 - 6*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(4*d)*(psq^2 + s^2 + 
         mm^2*(psq - s - t) - psq*(s + t)) + (-2 + d)*gZlR^2*mm^2*
        (2*Pi)^(4*d)*(psq^2 + s^2 + mm^2*(psq - s - t) - psq*(s + t)) + 
       gZlL*gZlR*(16^d*mm^4*Pi^(4*d)*((4 - 3*d)*psq + 4*s + (-4 + 3*d)*t) + 
         (2*Pi)^(4*d)*((-4 + d)*psq^3 + psq^2*((-2 + d)*s - (-4 + d)*t) + 
           psq*s*((8 - 3*d)*s - (-2 + d)*t) + s^2*(2*s + (-10 + 3*d)*t)) + 
         mm^2*(2*Pi)^(4*d)*(2*s*(psq - 5*s + t) + d*(-2*psq^2 + 3*psq*s + 
             s^2 + 2*psq*t - 3*s*t)))) + 
     aa*(-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(4*d)*(psq^2 + s^2 + mm^2*(psq - t) - 
          psq*(2*s + t))) - (-2 + d)*gZlR^2*mm^2*(2*Pi)^(4*d)*
        (psq^2 + s^2 + mm^2*(psq - t) - psq*(2*s + t)) + 
       gZlL*gZlR*(16^d*(-4 + 3*d)*mm^4*Pi^(4*d)*(psq - t) + 
         (2*Pi)^(4*d)*(-((-4 + d)*psq^3) + s^2*(-2*s + (10 - 3*d)*t) + 
           psq^2*((-10 + d)*s + (-4 + d)*t) + psq*s*(8*s + (-2 + d)*t)) + 
         mm^2*(2*Pi)^(4*d)*(-2*s*(-3*psq + 3*s + t) + 
           d*(2*psq^2 - 5*psq*s + 2*s^2 - 2*psq*t + 3*s*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/Pi^(6*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (-(bb*((-2 + d)*gZlL^2*mm^2*(psq^2 + mm^2*(psq - s - t) - psq*(2*s + t) + 
          s*(s + 2*t)) + (-2 + d)*gZlR^2*mm^2*(psq^2 + mm^2*(psq - s - t) - 
          psq*(2*s + t) + s*(s + 2*t)) + gZlL*gZlR*
         (d*(2*psq^3 - 3*s^2*t - 2*psq^2*(s + t) + mm^4*(-2*psq + s + 2*t) + 
            psq*s*(s + 3*t)) - 4*(2*psq^3 + mm^2*(psq - 2*s)*
             (2*psq - s - 2*t) - 2*psq^2*(2*s + t) - s^2*(s + 5*t) + 
            psq*s*(4*s + 5*t))))) + 
     aa*((-2 + d)*gZlL^2*mm^2*(psq^2 + mm^2*(psq - t) - psq*(3*s + t) + 
         s*(s + 2*t)) + (-2 + d)*gZlR^2*mm^2*(psq^2 + mm^2*(psq - t) - 
         psq*(3*s + t) + s*(s + 2*t)) + gZlL*gZlR*
        (d*(2*psq^3 + mm^2*(2*psq - 5*s)*s - 3*s^2*t + 3*psq*s*(2*s + t) - 
           2*psq^2*(3*s + t) + mm^4*(-2*psq + 3*s + 2*t)) - 
         4*(2*psq^3 + 2*mm^4*s - 2*psq^2*(4*s + t) - s^2*(s + 5*t) + 
           psq*s*(9*s + 5*t) + mm^2*(2*psq^2 - 3*psq*s - 3*s^2 - 2*psq*t + 
             4*s*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(2*psq^2 - 7*psq*s + 3*s^2 + 2*mm^2*(psq - t) - 
         2*psq*t + 4*s*t) + (-2 + d)*gZlR^2*mm^2*(2*psq^2 - 7*psq*s + 3*s^2 + 
         2*mm^2*(psq - t) - 2*psq*t + 4*s*t) + 
       gZlL*gZlR*(3*(-4 + d)*psq^3 + 2*s^2*(6*s + 11*t) + 
         psq^2*((50 - 8*d)*s - 3*(-4 + d)*t) + 2*psq*s*((-29 + 3*d)*s + 
           (-15 + 2*d)*t) + mm^4*((4 - 5*d)*psq + 2*(-2 + d)*s + 
           (-4 + 5*d)*t) + mm^2*(-2*(4 + d)*psq^2 + 
           psq*((2 + 11*d)*s + 2*(4 + d)*t) - s*(8*(-2 + d)*s + 
             (10 + 7*d)*t)))) + 
     bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq^2 - 5*psq*s + 3*s^2 + 
          2*mm^2*(psq - s - t) - 2*psq*t + 4*s*t)) - (-2 + d)*gZlR^2*mm^2*
        (2*psq^2 - 5*psq*s + 3*s^2 + 2*mm^2*(psq - s - t) - 2*psq*t + 
         4*s*t) + gZlL*gZlR*(-3*(-4 + d)*psq^3 - 2*s^2*(6*s + 11*t) + 
         2*psq*s*(15*s + (15 - 2*d)*t) + psq^2*((-30 + 4*d)*s + 
           3*(-4 + d)*t) + mm^4*((-4 + 5*d)*psq - 2*d*s + 4*t - 5*d*t) + 
         mm^2*(2*(4 + d)*psq^2 - psq*((18 + 7*d)*s + 2*(4 + d)*t) + 
           s*(2*(6 + d)*s + (10 + 7*d)*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*s*
    (aa*((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - s - 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 + psq - s - 2*t) + 
       2*gZlL*gZlR*((-4 + d)*mm^4 + 2*psq*s - 4*s^2 + 8*psq*t - 8*s*t - 
         d*psq*(psq - 2*s + t) - mm^2*(-8*s + d*(2*psq + s - 3*t) + 4*t))) + 
     bb*((-2 + d)*gZlL^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       2*gZlL*gZlR*((-4 + d)*mm^4 + (16 - 3*d)*psq^2 + (-22 + 3*d)*psq*s + 
         (-8 + d)*psq*t + 4*s*(s + 2*t) + mm^2*(4*(-2 + d)*psq - 
           4*(-3 + d)*s + (4 - 3*d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^2*s*(bb*(mm^4 - 2*psq^2 - mm^2*(psq + s - t) + psq*(4*s + t) - 
       s*(s + 2*t)) + aa*(mm^4 + mm^2*(psq - 2*s - t) - psq*(s + t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
   ...
   Pi^(2*d) + (I*EL^5*gAl*gXll^2*mm^2*s*
    (2*(aa + bb)*(-4 + d)*gZlL*gZlR*(mm^2 - psq)*psq - 
     2*gZlL*gZlR*s*(bb*((-4 + d)*mm^2 + d*(psq - s - 2*t) + 2*(s + 2*t)) + 
       aa*((-4 + d)*mm^2 + (8 - 3*d)*psq + (-2 + d)*(s + 2*t))) + 
     (-2 + d)*mm^2*(bb*(gZlL^2*(mm^2 - psq) + gZlR^2*(mm^2 - psq) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*(mm^2 - psq)*s*
    (bb*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
       (-4 + d)*gZlL*gZlR*(mm^2 + 4*psq - 4*s - t)) + 
     aa*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
       (-4 + d)*gZlL*gZlR*(mm^2 + 2*psq - 3*s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (I*4^(-1 - d)*EL^5*gAl*gXll^2*mm^2*s*
    (bb*((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - s - 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 + psq - s - 2*t) - 
       2*gZlL*gZlR*(-(d*psq*s) + 2*s^2 - 4*psq*t + d*psq*t + 4*s*t + 
         mm^2*(4*psq + (-6 + d)*s - d*t))) + 
     aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       2*gZlL*gZlR*(-2*(-4 + d)*psq^2 + 2*(-6 + d)*psq*s + (-4 + d)*psq*t + 
         2*s*(s + 2*t) + mm^2*(2*(-2 + d)*psq + 6*s - 2*d*s - d*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - s - 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 + psq - s - 2*t) + 
       gZlL*gZlR*(2*d*mm^4 + 8*psq^2 + 2*d*mm^2*(psq - s - 2*t) + 
         8*mm^2*(2*psq - 2*s - t) + 14*s*(s + 2*t) + 
         d*psq*(-2*psq + s + 2*t) - 8*psq*(3*s + 2*t))) + 
     aa*(-((-2 + d)*gZlL^2*mm^2*(mm^2 - 3*psq + s + 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       gZlL*gZlR*(-2*(12*psq^2 + 4*mm^2*(s - t) - 8*psq*(3*s + t) + 
           7*s*(s + 2*t)) + d*(2*mm^4 + psq*(2*psq - s - 2*t) + 
           mm^2*(-6*psq + 2*s + 4*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gXll^2*mm^2*(-(2^(1 + 4*d)*bb*(-2 + d)*gZlL^2*mm^2*Pi^(4*d)*
       (mm^2 - 2*psq + s + t)) - 2^(1 + 4*d)*bb*(-2 + d)*gZlR^2*mm^2*Pi^(4*d)*
      (mm^2 - 2*psq + s + t) + bb*gZlL*gZlR*(2*Pi)^(4*d)*
      ((-8 + 7*d)*mm^4 - (28 + 3*d)*psq^2 + psq*(74*s + 20*t) + 
       2*s*((-15 + d)*s + (-20 + d)*t) + mm^2*((12 - 8*d)*psq - 14*s + 
         4*(1 + d)*t)) + 2^(1 + 4*d)*aa*Pi^(4*d)*
      (2*gZlL^2*mm^2*(psq - s - t) + 2*gZlR^2*mm^2*(psq - s - t) + 
       gZlL*gZlR*(10*psq^2 - 29*psq*s + 15*s^2 + mm^2*(2*psq - s - 2*t) - 
         10*psq*t + 20*s*t)) + aa*d*(2*Pi)^(4*d)*
      (2*gZlL^2*mm^2*(-psq + s + t) + 2*gZlR^2*mm^2*(-psq + s + t) + 
       gZlL*gZlR*(mm^4 - psq^2 + 4*psq*s + 4*mm^2*(psq - s - t) - 
         2*s*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   (2*Pi)^(6*d) + (I*EL^5*gAl*gXll^2*mm^2*
    (bb*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + (-2 + d)*gZlR^2*mm^2*
        (mm^2 - psq) + gZlL*gZlR*((-8 + d)*mm^4 - 5*(-4 + d)*psq^2 + 
         mm^2*(4*(-5 + d)*psq + (34 - 7*d)*s - 2*(-6 + d)*t) + 
         2*s*((-5 + d)*s + (-6 + d)*t) + 2*psq*((-7 + 2*d)*s + 
           (-2 + d)*t))) + aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - psq) + gZlL*gZlR*
        (2*(2*psq^2 - 13*psq*s + 5*s^2 + mm^2*(2*psq + 3*s - 6*t) + 2*psq*t + 
           6*s*t) - d*(mm^4 - psq^2 + mm^2*(s - 2*t) + 2*s*(s + t) + 
           psq*(-4*s + 2*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*(aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - 3*psq + 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - 3*psq + 2*t) - 
       d*gZlL*gZlR*(2*mm^4 + 2*psq*(psq - s - t) + mm^2*(-4*psq + s + 2*t)) + 
       2*gZlL*gZlR*(8*psq^2 + mm^2*(6*s - 4*t) - 4*psq*(4*s + t) + 
         s*(s + 8*t))) + bb*((-2 + d)*gZlL^2*mm^2*(3*mm^2 - psq - 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(3*mm^2 - psq - 2*t) + 
       gZlL*gZlR*(-2*(-8*psq^2 + 16*psq*s + s^2 + 2*mm^2*(8*psq - 13*s - 
             2*t) - 4*psq*t + 8*s*t) + d*(-6*mm^4 + 2*psq*(psq + s - t) + 
           mm^2*(4*psq - 3*s + 2*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*(aa*(2^(1 + 4*d)*(-2 + d)*gZlL^2*mm^2*Pi^(4*d)*
        (mm^2 - t) + 2^(1 + 4*d)*(-2 + d)*gZlR^2*mm^2*Pi^(4*d)*(mm^2 - t) + 
       gZlL*gZlR*(2*Pi)^(4*d)*((8 - 7*d)*mm^4 + 3*(-4 + d)*psq^2 + 
         psq*((26 - 4*d)*s + 20*t) + 2*s*(-5*s + (-20 + d)*t) + 
         mm^2*(-20*psq + 2*(9 + 2*d)*s + 4*(1 + d)*t))) - 
     bb*(d*(2*Pi)^(4*d)*(2*gZlL^2*mm^2*(psq - t) + 2*gZlR^2*mm^2*(psq - t) + 
         gZlL*gZlR*(mm^4 - psq^2 - 4*mm^2*(psq - t) + 2*s*t)) + 
       2^(1 + 4*d)*Pi^(4*d)*(2*gZlL^2*mm^2*(-psq + t) + 
         2*gZlR^2*mm^2*(-psq + t) + gZlL*gZlR*(-10*psq^2 + 
           mm^2*(-2*psq + s + 2*t) - 5*s*(s + 4*t) + psq*(21*s + 10*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(2*Pi)^(6*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*(aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - psq) + gZlL*gZlR*((-8 + d)*mm^4 - 
         (-12 + d)*psq^2 + 2*s*(s - (-6 + d)*t) + 
         mm^2*(4*psq + (22 - 5*d)*s + 2*(-6 + d)*t) + 
         psq*((-34 + 6*d)*s - 2*(-2 + d)*t))) + 
     bb*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + (-2 + d)*gZlR^2*mm^2*
        (mm^2 - psq) - gZlL*gZlR*(2*(-6*psq^2 + 3*psq*s + s^2 + 
           mm^2*(10*psq - 9*s - 6*t) + 2*psq*t + 6*s*t) + 
         d*(mm^4 + 3*psq^2 - 2*s*t - 2*psq*(s + t) + 
           mm^2*(-4*psq + 3*s + 2*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - 2*(s + t))) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 + psq - 2*(s + t)) + 
       gZlL*gZlR*(2*d*mm^4 - 8*psq*s + 14*s^2 + 4*mm^2*(4*psq - 5*s - 2*t) - 
         8*psq*t + 16*s*t + 2*d*psq*(-psq + t) - d*mm^2*(s + 2*t))) + 
     aa*(-((-2 + d)*gZlL^2*mm^2*(3*mm^2 - 5*psq + 2*(s + t))) - 
       (-2 + d)*gZlR^2*mm^2*(3*mm^2 - 5*psq + 2*(s + t)) + 
       gZlL*gZlR*(-32*psq^2 + 8*psq*(9*s + t) + 4*mm^2*(4*psq - 11*s + 2*t) - 
         2*s*(7*s + 8*t) + d*(6*mm^4 + 2*psq*(psq - 2*s - t) + 
           mm^2*(-8*psq + 5*s + 2*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(3*(-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 3*(-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*((-56 + 6*d)*psq^2 - 42*s*(s + 2*t) + 
         psq*(116*s - 5*d*s + 56*t - 6*d*t) + mm^2*(-2*(4 + 7*d)*psq + 
           9*d*s + 8*t + 14*d*t))) + 
     aa*(-3*(-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) - 3*(-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*((56 - 6*d)*psq^2 + 42*s*(s + 2*t) + 
         psq*((-108 + d)*s + 2*(-28 + 3*d)*t) + 
         mm^2*(2*(4 + 7*d)*psq - (8 + 5*d)*s - 2*(4 + 7*d)*t))))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(-2*(-4 + d)*psq^2 + (4 - 11*d)*psq*s + 
         2*(-4 + d)*psq*t + (-2 + 5*d)*s*(s + 2*t) + 
         mm^2*(2*(-4 + 5*d)*psq - 3*d*s + 8*t - 10*d*t))) + 
     bb*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(2*(-4 + d)*psq^2 - 
         (-2 + 5*d)*s*(s + 2*t) + psq*(4*s + 7*d*s + 8*t - 2*d*t) + 
         mm^2*((8 - 10*d)*psq - 8*s + 7*d*s - 8*t + 10*d*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/Pi^(2*d) - 
  (I*EL^5*gAl*gXll^2*mm^2*(bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(2*psq - s - 2*t) + 
       gZlL*gZlR*(16*psq^2 + d*(mm^2 - psq)*(4*psq - 3*s - 4*t) + 
         4*s*(mm^2 + 2*s + 4*t) - 4*psq*(7*s + 4*t))) + 
     aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(-(d*(mm^2 - psq)*(4*psq - s - 4*t)) + 
         4*(-4*psq^2 + s*(mm^2 - 2*s - 4*t) + psq*(5*s + 4*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(-2*(-4 + d)*psq^2 - 
         (-4 + d)*psq*(s - 2*t) + 2*s*(s + 2*t) + 
         mm^2*(2*(-4 + d)*psq + (-8 + d)*s - 2*(-4 + d)*t))) + 
     aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) - gZlL*gZlR*(-2*(-4 + d)*psq^2 + 
         (-20 + 3*d)*psq*s + 2*(-4 + d)*psq*t + 2*s*(s + 2*t) + 
         mm^2*(2*(-4 + d)*psq + 16*s - 3*d*s + 8*t - 2*d*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(2*(-2 + d)*mm^4 + (6 - 4*d)*psq^2 + s*((8 - 3*d)*s - 3*(-2 + d)*t) + 
       2*psq*((-9 + 4*d)*s + (-1 + d)*t) + mm^2*(-2*(-1 + d)*psq - 
         (-4 + d)*s + 2*(-1 + d)*t)) + 
   ...
   (2*Pi)^(2*d) + (I*EL^5*gAl*gXll^2*mm^2*
    (-(aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
         (2*psq - s - 2*t) - gZlL*gZlR*(-3*(-6 + d)*psq^2 - 
          2*s*((-8 + d)*s + (-11 + d)*t) + psq*((-38 + 5*d)*s + 
            3*(-6 + d)*t) + mm^2*((2 + 3*d)*psq - 2*d*s - 2*t - 3*d*t)))) + 
     bb*(-((-2 + d)*gZlL^2*mm^2*(mm^2 - 3*psq + s + 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       gZlL*gZlR*(4*mm^4 + 5*(-6 + d)*psq^2 + 
         2*s*((-8 + d)*s + (-11 + d)*t) + psq*((50 - 7*d)*s - 3*(-6 + d)*t) + 
         mm^2*((6 - 5*d)*psq + 4*(-3 + d)*s + (2 + 3*d)*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(mm^2 - 3*psq + s + 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       gZlL*gZlR*(4*(-1 + d)*mm^4 - 2*(9 + d)*psq^2 + 
         2*psq*((11 + 4*d)*s + 7*t) - 2*mm^2*((-5 + 4*d)*psq + s + t - 
           3*d*t) - s*(3*(2 + d)*s + (16 + 3*d)*t))) + 
     aa*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(14*psq^2 - psq*((26 + 3*d)*s + 14*t) + 
         mm^2*((-2 + 6*d)*psq + 6*s - 5*d*s + 2*t - 6*d*t) + 
         s*(3*(2 + d)*s + (16 + 3*d)*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gXll^2*mm^2*(aa*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(2*psq - s - 2*t) + 
       gZlL*gZlR*(-((-4 + d)*mm^4) - 2*(-7 + d)*psq^2 + 2*(-13 + d)*psq*s + 
         (4 + d)*s^2 + 3*(-6 + d)*psq*t - 2*(-11 + d)*s*t + 
         mm^2*((2 + 3*d)*psq + 4*s - 3*d*s - 2*t - 3*d*t))) + 
     bb*(-((-2 + d)*gZlL^2*mm^2*(mm^2 - 3*psq + s + 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       gZlL*gZlR*(2*(-13*psq^2 + 19*psq*s - 2*s^2 + 9*psq*t - 11*s*t + 
           mm^2*(3*psq - 8*s + t)) + d*(mm^4 + 4*psq^2 - 4*psq*s - s^2 - 
           3*psq*t + 2*s*t + mm^2*(-5*psq + 5*s + 3*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gXll^2*mm^2*(bb*(2*Pi)^(4*d)*
      ((-2 + d)*gZlL^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - 3*psq + s + 2*t) + 
       gZlL*gZlR*((4 - 3*d)*mm^4 + (18 + d)*psq^2 - 
         2*psq*(3*(4 + d)*s + 7*t) + 2*mm^2*((-5 + 4*d)*psq + 4*s - d*s + t - 
           3*d*t) + s*((4 + 3*d)*s + (16 + 3*d)*t))) - 
     aa*(d*(2*Pi)^(4*d)*(gZlL^2*mm^2*(-2*psq + s + 2*t) + 
         gZlR^2*mm^2*(-2*psq + s + 2*t) + gZlL*gZlR*(mm^4 - psq^2 - psq*s + 
           mm^2*(6*psq - 7*s - 6*t) + 3*s*(s + t))) + 
       2^(1 + 4*d)*Pi^(4*d)*(gZlL^2*mm^2*(2*psq - s - 2*t) + 
         gZlR^2*mm^2*(2*psq - s - 2*t) + gZlL*gZlR*(7*psq^2 - 
           7*psq*(2*s + t) + mm^2*(-psq + 6*s + t) + 2*s*(s + 4*t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(2*Pi)^(6*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*(psq - t) + 
       gZlL*gZlR*(-((4 + d)*psq^2) + 2*(-5 + 3*d)*psq*s + (16 - 5*d)*s^2 + 
         (4 + d)*psq*t - 5*(-2 + d)*s*t + mm^2*((4 - 5*d)*psq - 12*s + 
           5*d*s - 4*t + 5*d*t))) + bb*(-((-2 + d)*gZlL^2*mm^2*(psq - t)) - 
       (-2 + d)*gZlR^2*mm^2*(psq - t) + gZlL*gZlR*((4 + d)*psq^2 + 
         s*((-16 + 5*d)*s + 5*(-2 + d)*t) + mm^2*((-4 + 5*d)*psq - 3*d*s + 
           4*t - 5*d*t) - psq*((-22 + 8*d)*s + (4 + d)*t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*aa*s*(mm^2 + 3*psq - 3*s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(psq - t)) - (-2 + d)*gZlR^2*mm^2*(psq - t) + 
       gZlL*gZlR*(-((-4 + d)*psq^2) + 2*(-3 + d)*psq*s + 
         (-4 + 3*d)*mm^2*(psq - s - t) + (-4 + d)*psq*t - (-6 + d)*s*t)) + 
     aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*(psq - t) + 
       gZlL*gZlR*((-4 + d)*psq^2 - 2*(-5 + d)*psq*s - (-4 + d)*psq*t + 
         (-6 + d)*s*t + mm^2*((4 - 3*d)*psq - 8*s + 3*d*s - 4*t + 3*d*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/Pi^(2*d) + 
  I*EL^5*gAl*gXll^2*mm^2*(((aa + bb)*(-4 + d)*gZlL*gZlR*(mm^2 - psq)*s)/
     (2*Pi)^(2*d) - ((-4 + d)*gZlL*gZlR*(aa*psq*(psq - t) + 
       aa*mm^2*(psq - 2*s - t) - bb*(mm^2 + psq)*(psq - s - t)))/
     (2*Pi)^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-4 + d)*gZlL*gZlR*psq*(psq - t))/
    ...
    (bb*(gZlL*gZlR*(-4*psq*s + d*psq*s + d*mm^2*(2*psq - s - 2*t)) - 
      ...
      aa*mm^2*((-2 + d)*gZlL^2*(psq - t) + (-2 + d)*gZlR^2*(psq - t) + 
        2*gZlL*gZlR*(2*s + d*(-psq + t))))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, p3], SP[q1, q2]] + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(psq - t)) - (-2 + d)*gZlR^2*mm^2*(psq - t) + 
       gZlL*gZlR*(-((-4 + d)*psq^2) - 6*(-1 + d)*psq*s + (-4 + 3*d)*s^2 + 
         (-4 + d)*psq*t + (2 + 3*d)*s*t + mm^2*((-4 + 3*d)*psq + (-4 + d)*s + 
           (4 - 3*d)*t))) + aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + 
       (-2 + d)*gZlR^2*mm^2*(psq - t) + gZlL*gZlR*((-4 + d)*psq^2 + 
         psq*(2*(3 + d)*s - (-4 + d)*t) + mm^2*((4 - 3*d)*psq - 8*s + 3*d*s - 
           4*t + 3*d*t) - s*((-4 + 3*d)*s + (2 + 3*d)*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q2, q2]])/Pi^(2*d) - 
  (I*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(aa*(psq - s)*(psq - s - t) - 
     bb*(psq^2 - psq*(s + t) + s*(-mm^2 + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*(aa*gZlL*gZlR*(2*mm^2 - 2*(-5 + d)*psq + 
       (-14 + 3*d)*s)*(psq - s - t) + 
     bb*(-((-2 + d)*gZlL^2*mm^2*(mm^2 - psq)) - (-2 + d)*gZlR^2*mm^2*
        (mm^2 - psq) + gZlL*gZlR*(4*mm^4 + (-22 + 4*d)*psq^2 + 
         (-14 + 3*d)*s*(s + t) - 2*(-5 + d)*psq*(4*s + t) + 
         mm^2*(-2*(-3 + d)*psq - 14*s + 3*d*s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*(bb*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(2*psq - s - 2*t) + 
       gZlL*gZlR*(-((-4 + d)*mm^4) + (-22 + 4*d)*psq^2 + (36 - 5*d)*psq*s + 
         3*(-6 + d)*s^2 - 3*(-6 + d)*psq*t + 2*(-11 + d)*s*t + 
         mm^2*(-((2 + 3*d)*psq) + 6*s + 2*t + 3*d*t))) + 
     aa*(-((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - s - 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 + psq - s - 2*t) + 
       gZlL*gZlR*(d*(mm^4 - 2*psq^2 + mm^2*(psq + 2*s - 3*t) + 
           3*psq*(s + t) - s*(3*s + 2*t)) + 
         2*(5*psq^2 + mm^2*(5*psq - 9*s - t) - 3*psq*(4*s + 3*t) + 
           s*(9*s + 11*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/
   (2*Pi)^(2*d) - (I*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(-2*psq^2 + s*(mm^2 - s - 2*t) + 2*psq*(s + t)) + 
     aa*(2*psq^2 - 2*psq*(2*s + t) + s*(mm^2 + s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gXll^2*mm^2*(bb*gZlL*gZlR*((-4 + d)*mm^4 + (14 - 3*d)*psq^2 + 
       2*mm^2*(psq - t) + s*(-3*(-4 + d)*s + (14 - 3*d)*t) + 
       2*psq*((-13 + 3*d)*s + (-5 + d)*t)) + 
     aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + (-2 + d)*gZlR^2*mm^2*
        (mm^2 - psq) + gZlL*gZlR*(d*(-mm^4 + psq^2 + mm^2*(2*psq - 3*s) + 
           3*s*(s + t) - psq*(3*s + 2*t)) - 
         2*(psq^2 + mm^2*(5*psq - 8*s - t) - 5*psq*(s + t) + 
           s*(6*s + 7*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(4*(-6 + d)*psq^2 - 
         (4 + d)*mm^2*(2*psq - s - 2*t) - 2*(-6 + d)*psq*(5*s + 2*t) + 
         s*(-28*s + 5*d*s - 36*t + 5*d*t))) + 
     bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(-4*(-6 + d)*psq^2 + 
         (-44 + 6*d)*psq*s + (28 - 5*d)*s^2 + 4*(-6 + d)*psq*t + 
         (36 - 5*d)*s*t + mm^2*(2*(4 + d)*psq + (-20 + 3*d)*s - 
           2*(4 + d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3]])/
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(4*psq^2 + mm^2*(4*psq + (-6 + d)*s - 4*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    ((aa + bb)*(-4 + d)*(mm^2 - psq)*s + 2*(aa - bb)*mm^2*
      (2*s + d*(-psq + t)) - 2*(aa - bb)*s*(2*s + d*(-psq + t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(2*(-4 + d)*psq^2 + 
         2*psq*(d*(s - t) + 4*t) + s*((8 - 3*d)*s + (4 - 3*d)*t) + 
         mm^2*(-4*(-2 + d)*psq + (-8 + 3*d)*s + 4*(-2 + d)*t))) + 
     bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(-2*(-4 + d)*psq^2 - 4*(-2 + d)*psq*s + 
         (-8 + 3*d)*s^2 + 2*(-4 + d)*psq*t + (-4 + 3*d)*s*t + 
         mm^2*(4*(-2 + d)*psq + 8*t - d*(s + 4*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*(aa*gZlL*gZlR*(d*mm^2 + 4*psq - 6*s)*
      (psq - s - t) + bb*(-((-2 + d)*gZlL^2*mm^2*(mm^2 - psq)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - psq) + gZlL*gZlR*(d*mm^2 + 4*psq - 6*s)*
        (2*mm^2 - 3*psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*(aa*(2*Pi)^(4*d)*
      (-((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - s - 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 + psq - s - 2*t) + 
       gZlL*gZlR*((-4 + 3*d)*mm^4 - (-10 + d)*psq^2 - 2*psq*(11*s + 7*t) + 
         2*mm^2*((3 + 2*d)*psq - 3*s - 2*d*s + t - 3*d*t) + 
         s*(12*s + 16*t + 3*d*t))) - 
     bb*(d*(2*Pi)^(4*d)*(gZlL^2*mm^2*(-2*psq + s + 2*t) + 
         gZlR^2*mm^2*(-2*psq + s + 2*t) + gZlL*gZlR*(-mm^4 + psq^2 - 
           5*psq*s + mm^2*(6*psq + s - 6*t) + 3*s*t)) + 
       2^(1 + 4*d)*Pi^(4*d)*(gZlL^2*mm^2*(2*psq - s - 2*t) + 
         gZlR^2*mm^2*(2*psq - s - 2*t) + gZlL*gZlR*(7*psq^2 - 9*psq*s + 
           6*s^2 - 7*psq*t + 8*s*t + mm^2*(-psq - 5*s + t)))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/(2*Pi)^(6*d) - 
  (I*EL^5*gAl*gXll^2*mm^2*(aa*gZlL*gZlR*((-4 + d)*mm^4 + (-6 + d)*psq^2 + 
       2*mm^2*(-psq + s + t) - 2*psq*((-6 + d)*s + (-5 + d)*t) + 
       s*(-2*s + (-14 + 3*d)*t)) + bb*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - psq) - gZlL*gZlR*
        (d*(mm^4 + 3*psq^2 - 5*psq*s + mm^2*(-2*psq + 3*s) - 2*psq*t + 
           3*s*t) + 2*(-9*psq^2 + mm^2*(3*psq - 7*s + t) + psq*(14*s + 5*t) - 
           s*(s + 7*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   (2*Pi)^(2*d) - (I*EL^5*gAl*gXll^2*mm^2*
    (aa*(-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + bb*(-2 + d)*gZlL^2*mm^2*
      (mm^2 - psq) + aa*(-2 + d)*gZlR^2*mm^2*(mm^2 - psq) + 
     bb*(-2 + d)*gZlR^2*mm^2*(mm^2 - psq) - aa*gZlL*gZlR*
      (d*mm^2 + 4*psq - 6*s)*(2*mm^2 - s - 2*t) - 
     bb*gZlL*gZlR*(d*mm^2 + 4*psq - 6*s)*(2*mm^2 - 4*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 4*d)*EL^5*gAl*gXll^2*mm^2*(4^(2 + d)*(aa - bb)*gZlL*gZlR*
      Pi^(2*d)*psq*(2*psq - s - 2*t) - 2^(1 + 2*d)*(aa - bb)*d*gZlL*gZlR*
      Pi^(2*d)*psq*(2*psq - s - 2*t) + 2^(1 + 2*d)*(aa - bb)*(-4 + d)*gZlL*
      gZlR*Pi^(2*d)*psq*(psq - s - t) + 2^(3 + 2*d)*(aa - bb)*gZlL*gZlR*
      Pi^(2*d)*s*(-2*psq + s + 2*t) - 3*gZlL*gZlR*(2*Pi)^(2*d)*s*
      (aa*((-4 + d)*mm^2 + 8*psq - d*psq - 2*s - 4*t) + 
       bb*((-4 + d)*mm^2 - d*psq + 2*s + 4*t)) - 
     2*aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) - 
       2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*(d*mm^2*(2*psq - s - 2*t) + 
         s*(-3*psq + s + 3*t))) + 2*bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
        (2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*
        (2*psq - s - 2*t) - 2^(1 + 2*d)*gZlL*gZlR*Pi^(2*d)*
        (d*mm^2*(2*psq - s - 2*t) + s*(-2*mm^2 - psq + s + 3*t))) - 
     (2*Pi)^(2*d)*(aa*(gZlL*gZlR*(((-4 + d)*psq - 2*s)*(psq - t) + 
           (-4 + d)*mm^2*(psq - 2*s - t)) - (-2 + d)*gZlL^2*mm^2*
       ...
       bb*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + (-2 + d)*gZlR^2*mm^2*
          (psq - s - t) + gZlL*gZlR*(-((-4 + d)*psq^2) + 2*(-5 + d)*psq*s + 
           (-4 + d)*psq*t - 2*s*t + mm^2*(-((-4 + d)*psq) + 4*s + 
             (-4 + d)*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3]])/
   Pi^(4*d) + (I*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(-((4 + d)*psq^2) + (12 + d)*psq*s + (4 + d)*psq*t - 6*s*(s + 2*t) + 
       mm^2*(-((4 + d)*psq) + 4*s + (4 + d)*t)) + 
     bb*((4 + d)*psq^2 + 6*s*(s + 2*t) - psq*(16*s + (4 + d)*t) + 
       mm^2*((4 + d)*psq - 4*t - d*(s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(psq - t)) - (-2 + d)*gZlR^2*mm^2*(psq - t) + 
       gZlL*gZlR*(-((-4 + d)*psq^2) - 2*(1 + d)*psq*s + (2 + d)*s^2 + 
         (-4 + d)*psq*t + (2 + 3*d)*s*t + mm^2*((-4 + 5*d)*psq - 3*d*s + 
           4*t - 5*d*t))) + aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + 
       (-2 + d)*gZlR^2*mm^2*(psq - t) - gZlL*gZlR*(-((-4 + d)*psq^2) - 
         2*(3 + d)*psq*s + (2 + d)*s^2 + (-4 + d)*psq*t + (2 + 3*d)*s*t + 
         mm^2*((-4 + 5*d)*psq + 4*s - 3*d*s + 4*t - 5*d*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
  I*EL^5*gAl*gXll^2*mm^2*((2^(1 - 2*d)*(aa + bb)*(-4 + d)*gZlL*gZlR*
      (mm^2 - psq)*s)/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-4 + d)*gZlL*gZlR*
      psq*(psq - t))/Pi^(2*d) - (4^(1 - d)*(aa - bb)*gZlL*gZlR*s*
      (-2*psq + s + 2*t))/Pi^(2*d) + 
    (bb*(gZlL*gZlR*(-4*psq*s + d*psq*s + d*mm^2*(2*psq - s - 2*t)) - 
        (-2 + d)*gZlL^2*mm^2*(psq - t) - (-2 + d)*gZlR^2*mm^2*(psq - t)) + 
      aa*mm^2*((-2 + d)*gZlL^2*(psq - t) + (-2 + d)*gZlR^2*(psq - t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
       gZlL*gZlR*(-((-4 + d)*mm^2) + (-4 + d)*psq - 2*s))*(psq - s - t) + 
     bb*(-((-2 + d)*gZlL^2*mm^2*(psq - s - t)) - (-2 + d)*gZlR^2*mm^2*
        (psq - s - t) + gZlL*gZlR*(-((-4 + d)*psq^2) + (2 + d)*psq*s + 
         (-4 + d)*psq*t - 2*s*(s + t) + mm^2*((-4 + d)*psq + 4*t - 
           d*(s + t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/
   ...
   (2*Pi)^(2*d) + (I*EL^5*gAl*gXll^2*mm^2*
    (aa*(-((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - s - 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 + psq - s - 2*t) + 
       gZlL*gZlR*(4*mm^4 - (-6 + d)*psq^2 - 12*psq*s + 6*s^2 + 
         3*(-6 + d)*psq*t - 2*(-11 + d)*s*t + mm^2*((10 + d)*psq + 
           (-14 + d)*s - (2 + 3*d)*t))) + 
     bb*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) - gZlL*gZlR*(-3*(-6 + d)*psq^2 + 
         2*(-12 + d)*psq*s + 6*s^2 + 3*(-6 + d)*psq*t - 2*(-11 + d)*s*t + 
         mm^2*((2 + 3*d)*psq - (2 + d)*s - (2 + 3*d)*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^2*mm^2*(bb*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 
       (-2 + d)*gZlR^2*mm^2*(2*psq - s - 2*t) + 
       gZlL*gZlR*(-14*psq^2 + psq*(20*s + 3*d*s + 14*t) - 
         s*(10*s + 16*t + 3*d*t) + mm^2*((2 - 6*d)*psq + 4*s + d*s - 2*t + 
           6*d*t))) + aa*(-((-2 + d)*gZlL^2*mm^2*(mm^2 + psq - s - 2*t)) - 
       (-2 + d)*gZlR^2*mm^2*(mm^2 + psq - s - 2*t) + 
       gZlL*gZlR*(4*(-1 + d)*mm^4 - 2*(-5 + d)*psq^2 + 
         2*psq*((-12 + d)*s - 7*t) + s*(10*s + (16 + 3*d)*t) + 
         2*mm^2*((3 + 2*d)*psq + t - 3*d*(s + t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(psq - s - t)) - (-2 + d)*gZlR^2*mm^2*
        (psq - s - t) + gZlL*gZlR*((4 + d)*psq^2 + s*(6*s + 5*(-2 + d)*t) + 
         mm^2*((-4 + 5*d)*psq - 8*s + 4*t - 5*d*t) - 
         psq*((-6 + 5*d)*s + (4 + d)*t))) + 
     aa*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + (-2 + d)*gZlR^2*mm^2*
        (psq - s - t) + gZlL*gZlR*(-((4 + d)*psq^2) + 3*(2 + d)*psq*s - 
         6*s^2 + (4 + d)*psq*t - 5*(-2 + d)*s*t + 
         mm^2*((4 - 5*d)*psq + 2*(-2 + d)*s + (-4 + 5*d)*t))))*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-2*aa*s*(mm^2 - psq + s - 2*t) + 
  ...
  (I/2)*EL^5*gAl*gXll^2*mm^2*(((aa + bb)*(-4 + d)*gZlL*gZlR*(mm^2 - psq)*s)/
     (2*Pi)^(2*d) - (2^(1 - 2*d)*(aa - bb)*(-4 + d)*gZlL*gZlR*psq*
      (psq - s - t))/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*d*gZlL*gZlR*s*
      (-2*psq + s + 2*t))/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*gZlL*gZlR*mm^2*
      (-2*s + d*(-psq + s + t)))/Pi^(2*d) - 
    (2^(1 - 2*d)*(aa - bb)*gZlL*gZlR*s*(-2*s + d*(-psq + s + t)))/Pi^(2*d) - 
    (2^(1 - 2*d)*gZlL*gZlR*s*(bb*((-4 + d)*mm^2 + d*(psq - s - 2*t) + 
         2*(s + 2*t)) + aa*((-4 + d)*mm^2 + (8 - 3*d)*psq + 
         (-2 + d)*(s + 2*t))))/Pi^(2*d) + 
    (bb*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + (-2 + d)*gZlR^2*mm^2*
        ...
        (-2 + d)*gZlR^2*mm^2*(psq - s - t) + gZlL*gZlR*((-4 + d)*psq^2 + 
          ...
          mm^2*((-4 + 5*d)*psq + 4*t - d*(s + 5*t)))))/(2*Pi)^(2*d))*
   \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q1]] + 
  I*EL^5*gAl*gXll^2*mm^2*(((aa + bb)*(-4 + d)*gZlL*gZlR*(mm^2 - psq)*s)/
     (2*Pi)^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-4 + d)*gZlL*gZlR*s*(psq - t))/
     Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-4 + d)*gZlL*gZlR*psq*(psq - s - t))/
     Pi^(2*d) - (4^(1 - d)*(aa - bb)*gZlL*gZlR*s*(-2*psq + s + 2*t))/
     Pi^(2*d) - ((-4 + d)*gZlL*gZlR*(aa*(mm^2 + psq)*(psq - t) - 
       bb*mm^2*(psq + s - t) + bb*psq*(-psq + s + t)))/(2*Pi)^(2*d) + 
    (bb*mm^2*(2*gZlL*gZlR*(2*s + d*(psq - s - t)) - (-2 + d)*gZlL^2*
         (psq - s - t) - (-2 + d)*gZlR^2*(psq - s - t)) + 
      aa*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + (-2 + d)*gZlR^2*mm^2*
         (psq - s - t) + gZlL*gZlR*(-4*psq*s + d*psq*s + 
          d*mm^2*(-2*psq + s + 2*t))))/(2*Pi)^(2*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p2, p3], SP[q1, q2]] - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*(-((-2 + d)*gZlL^2*mm^2*(psq - s - t)) - (-2 + d)*gZlR^2*mm^2*
        (psq - s - t) + gZlL*gZlR*(-((-4 + d)*psq^2) + (-14 + d)*psq*s + 
         6*s^2 + (-4 + d)*psq*t + (2 + 3*d)*s*t + 
         mm^2*((-4 + 3*d)*psq + 8*s - 4*d*s + 4*t - 3*d*t))) + 
     bb*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + (-2 + d)*gZlR^2*mm^2*
        (psq - s - t) + gZlL*gZlR*((-4 + d)*psq^2 + 
         psq*(2*s + 3*d*s + 4*t - d*t) + mm^2*((4 - 3*d)*psq + 4*s - 4*t + 
           3*d*t) - s*(6*s + 2*t + 3*d*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[q2, q2]])/Pi^(2*d) - 
  (I*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-(bb*(psq - s)*(psq - t)) + 
     aa*(psq^2 + s*(mm^2 + t) - psq*(2*s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gXll^2*mm^2*(bb*gZlL*gZlR*(2*mm^2 - 2*(-5 + d)*psq + 
       (-14 + 3*d)*s)*(psq - t) + aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - psq) + gZlL*gZlR*(-4*mm^4 + 2*psq^2 + 
         (-14 + 3*d)*s*t + mm^2*(2*(-5 + d)*psq + 16*s - 3*d*s + 2*t) - 
         2*psq*(s + (-5 + d)*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(-4*(-6 + d)*psq^2 + 
         (4 + d)*mm^2*(2*psq - s - 2*t) + s*(8*s + (36 - 5*d)*t) + 
         4*psq*((-9 + d)*s + (-6 + d)*t))) + 
     aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(4*(-6 + d)*psq^2 - 
         4*psq*((-13 + 2*d)*s + (-6 + d)*t) + mm^2*(-2*(4 + d)*psq + 
           (-12 + 5*d)*s + 2*(4 + d)*t) + s*(-8*s + (-36 + 5*d)*t))))*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(4*psq^2 + mm^2*(4*psq + (-6 + d)*s - 4*t) - 2*psq*(3*s + 2*t) + 
       2*s*(s - (-6 + d)*t)) + bb*(mm^2*(-4*psq + (-2 + d)*s + 4*t) - 
       2*(2*psq^2 + (-7 + d)*psq*s + s^2 - 2*psq*t - (-6 + d)*s*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    ((aa + bb)*(-4 + d)*(mm^2 - psq)*s + 2*(aa - bb)*mm^2*
      (-2*s + d*(-psq + s + t)) - 2*(aa - bb)*s*(-2*s + d*(-psq + s + t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(2*(-4 + d)*psq^2 + 
         s*(-4*s + (4 - 3*d)*t) + psq*(8*s - 2*(-4 + d)*t) + 
         mm^2*(-4*(-2 + d)*psq + (-8 + 3*d)*s + 4*(-2 + d)*t))) + 
     bb*(-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)) - (-2 + d)*gZlR^2*mm^2*
        (2*psq - s - 2*t) + gZlL*gZlR*(-2*(-4 + d)*psq^2 - 
         2*psq*(d*(s - t) + 4*t) + s*(4*s + (-4 + 3*d)*t) + 
         mm^2*(4*(-2 + d)*psq + 8*t - d*(s + 4*t)))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gXll^2*mm^2*(aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
       (-2 + d)*gZlR^2*mm^2*(mm^2 - psq) - gZlL*gZlR*(d*mm^2 + 4*psq - 6*s)*
        (2*mm^2 - psq - t)) + bb*gZlL*gZlR*(d*mm^2 + 4*psq - 6*s)*(psq - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 4*d)*EL^5*gAl*gXll^2*mm^2*(4^(2 + d)*(aa - bb)*gZlL*gZlR*
      Pi^(2*d)*psq*(2*psq - s - 2*t) - 2^(1 + 2*d)*(aa - bb)*d*gZlL*gZlR*
      Pi^(2*d)*psq*(2*psq - s - 2*t) + 2^(1 + 2*d)*(aa - bb)*(-4 + d)*gZlL*
      gZlR*Pi^(2*d)*psq*(psq - t) + 2^(3 + 2*d)*(aa - bb)*gZlL*gZlR*Pi^(2*d)*
      s*(-2*psq + s + 2*t) - 3*gZlL*gZlR*(2*Pi)^(2*d)*s*
      (aa*((-4 + d)*mm^2 + 8*psq - d*psq - 2*s - 4*t) + 
       bb*((-4 + d)*mm^2 - d*psq + 2*s + 4*t)) + 
     (2*Pi)^(2*d)*(bb*gZlL*gZlR*(((-4 + d)*psq - 2*s)*(psq - s - t) + 
    ...
    SPList[SP[p2, q2], SP[p3, p3]])/Pi^(4*d) + 
  (I*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(2*psq^2 - 7*psq*s + 3*s^2 + 2*mm^2*(psq - t) - 2*psq*t + 4*s*t) + 
     ...
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*((4 + d)*psq^2 + 6*s*(s + 2*t) + mm^2*((4 + d)*psq - 4*s - 
         (4 + d)*t) - psq*((12 + d)*s + (4 + d)*t)) + 
     bb*(-((4 + d)*psq^2) + 16*psq*s + (4 + d)*psq*t - 6*s*(s + 2*t) + 
       mm^2*(-((4 + d)*psq) + 4*t + d*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (bb*(-((-2 + d)*gZlL^2*mm^2*(psq - s - t)) - (-2 + d)*gZlR^2*mm^2*
        (psq - s - t) + gZlL*gZlR*(-((-4 + d)*psq^2) - (2 + 3*d)*psq*s + 
         (-4 + d)*psq*t + mm^2*((-4 + 5*d)*psq - 2*d*s + 4*t - 5*d*t) + 
         s*(2*d*s + 2*t + 3*d*t))) + aa*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + 
       (-2 + d)*gZlR^2*mm^2*(psq - s - t) + gZlL*gZlR*((-4 + d)*psq^2 + 
         3*(2 + d)*psq*s - (-4 + d)*psq*t - s*(2*d*s + 2*t + 3*d*t) + 
         mm^2*((4 - 5*d)*psq + 2*(-2 + d)*s + (-4 + 5*d)*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  I*EL^5*gAl*gXll^2*mm^2*((2^(1 - 2*d)*(aa + bb)*(-4 + d)*gZlL*gZlR*
      (mm^2 - psq)*s)/Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-4 + d)*gZlL*gZlR*
      psq*(psq - s - t))/Pi^(2*d) - (4^(1 - d)*(aa - bb)*gZlL*gZlR*s*
      (-2*psq + s + 2*t))/Pi^(2*d) + 
    (bb*mm^2*(2*gZlL*gZlR*(2*s + d*(psq - s - t)) - (-2 + d)*gZlL^2*
         (psq - s - t) - (-2 + d)*gZlR^2*(psq - s - t)) + 
      aa*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + (-2 + d)*gZlR^2*mm^2*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (-(bb*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
        gZlL*gZlR*(-((-4 + d)*mm^2) + (-4 + d)*psq - 2*s))*(psq - t)) + 
     aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*(psq - t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
  ...
  (I*2^(-1 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q1]])/Pi^(2*d) - 
  (I*(aa + bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
    ((aa + bb)*(mm^2 - psq) + (aa - bb)*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*s*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], SP[q1, q2]])/
  ...
  (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(aa*(2*mm^2 - 2*psq - s) + 
     bb*(6*mm^2 - 6*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p1, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - 2*psq - s) + 
  ...
  (I*2^(1 - 2*d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - s - 2*t) + 
     aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - s - 2*t) + 
     aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*((8 + 3*d)*mm^2 - (36 + d)*psq + 22*s - 2*d*s + 28*t - 2*d*t) + 
     aa*(28*psq - 22*s - 28*t + d*(mm^2 - 3*psq + 2*(s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p3, p3]])/
   (2*Pi)^(2*d) - (I*4^(1 - d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(psq - s - t) + bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(-((-8 + d)*mm^2) + 3*(-4 + d)*psq + 6*s - 2*d*s + 4*t - 2*d*t) + 
     aa*(4*psq - 6*s - 4*t + d*(mm^2 - 3*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*
  ...
  (I*2^(1 - 2*d)*(aa + 3*bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*((-8 + d)*mm^2 - 3*(-4 + d)*psq + 2*(-3 + d)*s + 2*(-2 + d)*t) - 
     aa*(4*psq - 6*s - 4*t + d*(mm^2 - 3*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(6*mm^2 - 2*psq - s - 4*t) + aa*(2*mm^2 - 6*psq + s + 4*t))*
  ...
  (I*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(aa*(2*mm^2 - 2*psq - s) + 
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(-28*psq + 6*s + d*(mm^2 + psq - 2*t) + 28*t) + 
     aa*((8 + 3*d)*mm^2 - 5*(-4 + d)*psq - 6*s - 28*t + 2*d*t))*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-(bb*d*(mm^2 + psq - 2*t)) + 
     2*bb*(2*psq + s - 2*t) + aa*((-8 + d)*mm^2 + (4 + d)*psq - 
       2*(s + (-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
     SP[q2, q2]])/(2*Pi)^(2*d) + (I*4^(1 - d)*aa*(-4 + d)*EL^5*gAl*gXll^2*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*((-16 + 3*d)*mm^2 + (28 - 5*d)*psq - 2*s + 2*(-6 + d)*t) + 
     bb*((-8 + d)*mm^2 + (-4 + d)*psq + 2*(s + 6*t - d*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(3*aa + bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-(bb*d*(mm^2 + psq - 2*t)) + 
     2*bb*(2*psq + s - 2*t) + aa*((-8 + d)*mm^2 + (4 + d)*psq - 
       2*(s + (-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) + (I*2^(3 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*
    mm^2*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(2*mm^2 + 2*psq - 3*s - 4*t) + aa*(6*mm^2 - 10*psq + 3*s + 4*t))*
  ...
  (I*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - 2*psq - s) + 
  ...
  ((3*I)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*d*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p3, p3], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], SP[q1, q2]])/Pi^(2*d) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(aa*(-6 + d)*(psq - s - t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*((-4 + d)*mm^2 + 8*psq - d*psq - 2*s - 4*t) + 
     ...
     SP[p3, q2]])/Pi^(2*d) - (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(3*(-2 + d)*psq + 8*s - 3*d*s + 6*t - 3*d*t) + 
     bb*(4*(-3 + d)*mm^2 + 18*psq - 7*d*psq - 8*s + 3*d*s - 6*t + 3*d*t))*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-(bb*(-6 + d)*(psq - t)) + 
     aa*((-8 + d)*mm^2 + 2*psq + 6*t - d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*((-4 + d)*mm^2 - 14*psq + 4*s + d*s + 18*t - d*t) + 
     bb*((-8 + d)*mm^2 + 26*psq - 2*d*psq - 4*s - d*s - 18*t + d*t))*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*((-4 + d)*mm^2 + 2*(-1 + d)*psq - d*s + 6*t - 3*d*t) + 
     bb*((-8 + 3*d)*mm^2 + (14 - 6*d)*psq + d*s - 6*t + 3*d*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[q2, q2]])/
   (2*Pi)^(2*d) + (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*((4 + d)*mm^2 - 3*(6 + d)*psq + 2*(2 + d)*s + 2*(7 + d)*t) + 
     aa*(2*(7*psq - 2*s - 7*t) + d*(mm^2 + psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*s + d*(psq - s - t))*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*s + d*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], 
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*s + d*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], 
     SP[q1, q1]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*
    gZlL*gZlR*mm^2*(2*s + d*(psq - s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*s + d*(psq - s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3], SP[q2, q2]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[q1, q1]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], 
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(psq - s - t)*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*bb*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*((-8 + d)*mm^2 - 10*psq + 14*s - 2*d*s + 18*t - d*t) + 
     bb*((-4 + d)*mm^2 + 22*psq - 2*d*psq - 14*s + 2*d*s - 18*t + d*t))*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*bb*(2*psq - s - 2*t) + 
     aa*((-4 + d)*mm^2 - d*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(-2*psq + 6*s - d*(mm^2 + s - t) + 2*t) + 
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*((-8 + 3*d)*mm^2 + 2*psq + 6*s - 2*d*s + 6*t - 3*d*t) + 
     bb*((-4 + d)*mm^2 + 10*psq - 4*d*psq - 6*s + 2*d*s - 6*t + 3*d*t))*
   ...
   (2*Pi)^(2*d) + (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[p3, p3]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*((-4 + d)*mm^2 + (14 - 3*d)*psq + 2*(-4 + d)*s + 2*(-5 + d)*t) + 
     aa*((-8 + d)*mm^2 + (-2 + d)*psq - 2*((-4 + d)*s + (-5 + d)*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, p3]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*aa*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*bb*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/
   Pi^(2*d) + (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*((-4 + d)*mm^2 + 6*psq - d*psq - 4*s + d*s - 2*t) + 
     aa*(-2*psq + 4*s - d*(mm^2 - psq + s) + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-((-8 + d)*psq) + (-6 + d)*s + 
     (-8 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], SP[p3, p3]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(aa*(4 + d)*mm^2 + aa*(10 + d)*psq + 
     bb*d*(mm^2 - 3*psq + 2*t) + 2*bb*(-7*psq + 5*s + 7*t) - 
     2*aa*(5*s + (7 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[p3, p3]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^2*(aa*(mm^2 + psq - s - 2*t) + bb*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*bb*(2*psq - s - 2*t) + 
     aa*((-4 + d)*mm^2 - d*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*((-4 + 3*d)*mm^2 + (2 + d)*psq - 2*s - d*s + 2*t - 4*d*t) + 
     bb*(2*(psq + s - t) + d*(mm^2 - 5*psq + s + 4*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[q1, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*d*(mm^2 - 2*psq + t) + 
     4*bb*(-psq + s + t) + aa*(d*mm^2 + 4*psq - 4*s - 4*t - d*t))*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*((-8 + d)*mm^2 - 3*(-6 + d)*psq - 2*s + 2*(-5 + d)*t) + 
     aa*((-4 + d)*mm^2 + (-6 + d)*psq + 2*(s + 5*t - d*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa + bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) - (I*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(3*psq - s - 3*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], 
     SP[p3, q2]])/Pi^(2*d) + (I*(aa - bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, p3], 
     SP[q1, q1]])/(4^d*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*
    gZlL*gZlR*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(psq - t)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) + (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*
    mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(psq - d*psq + s + (-1 + d)*t) + aa*((-2 + d)*mm^2 + psq - s + t - 
       d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[p3, p3]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(psq - d*psq + s + (-1 + d)*t) + aa*((-2 + d)*mm^2 + psq - s + t - 
       d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q1, q1]])/
   Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(psq - d*psq + s + (-1 + d)*t) + aa*((-2 + d)*mm^2 + psq - s + t - 
       d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q1, q2]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (bb*(psq - d*psq + s + (-1 + d)*t) + aa*((-2 + d)*mm^2 + psq - s + t - 
       d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], SP[q2, q2]])/
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(4*mm^2 + (-2 + d)*psq + 2*s - d*s - 2*t - d*t) + 
     bb*(-((2 + d)*psq) + (-2 + d)*s + (2 + d)*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(4*(-1 + d)*mm^2 + 2*psq - d*s + 2*t - 4*d*t) + 
     bb*((2 - 4*d)*psq + d*s - 2*t + 4*d*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q2, q2]])/Pi^(2*d) - (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3], 
     SP[p3, p3]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3], 
     SP[p3, q2]])/(2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3], 
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*s + d*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], SP[q1, q1]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], 
     SP[q1, q2]])/Pi^(2*d) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*
    mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1], 
     SP[q2, q2]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*
    mm^2*(2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2], 
     SP[q1, q1]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^2*
    gZlL*gZlR*mm^2*(2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(2*s + d*(-psq + t))*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*aa*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[p3, q2]])/
   Pi^(2*d) - (I*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-(bb*(-5 + d)*(psq - t)) + 
     aa*((-6 + d)*mm^2 + psq + 5*t - d*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-2*s + d*(-psq + s + t))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
    gZlR*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3], 
     SP[q1, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    (2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3], 
     SP[q2, q2]])/(4^d*Pi^(2*d)) + (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(3*psq - 2*s - 3*t)*
   ...
   (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
    ...
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3], 
     SP[q1, q1]])/(4^d*Pi^(2*d)) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^2*
    gZlL*gZlR*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(psq - s - t)*
