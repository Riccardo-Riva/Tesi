PropList[KiraPropagator[p1 - q1, mh], KiraPropagator[-p2 - q1, mz]]*
  ((I*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(-(2^(3 + d)*Pi^d*s^2) + 
        ...
        2^(2 + d)*d*Pi^d*s^2 + d^2*(2*Pi)^d*s^2 + 2^(4 + d)*Pi^d*s*t - 
        5*2^(1 + d)*d*Pi^d*s*t + 2^(1 + d)*d^2*Pi^d*s*t + 
        2^(2 + d)*Pi^d*t^2)))/(2^(2*(1 + d))*Pi^(2*d)*(mz^2 - s)^2*s) + 
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gHZZ^2*
    ...
    (Pi^(2*d)*(mz^3 - mz*s)^2) - 
   (I*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(2^(2 + d)*Pi^d*s - d*(2*Pi)^d*s + 
        3*2^(1 + d)*Pi^d*t - 2^(1 + d)*d*Pi^d*t) + 
      ...
      gZlR*gZuR*(-(2^(1 + d)*Pi^d*s) + d*(2*Pi)^d*s - 3*2^(1 + d)*Pi^d*t + 
        2^(1 + d)*d*Pi^d*t))*SPList[SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)*
     (mz^3 - mz*s)^2) - (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gHZZ^2*
   ...
   (I*2^(-1 - d)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(4*s - d*s + 6*t - 2*d*t) + 
      gZlL*gZuR*(4*s - d*s + 6*t - 2*d*t) + 
      gZlL*gZuL*(-2*s + d*s - 6*t + 2*d*t) + 
      gZlR*gZuR*(-2*s + d*s - 6*t + 2*d*t))*SPList[SP[p1, p2], SP[p1, q1]])/
    (Pi^d*s*(mz^3 - mz*s)^2) + (I*EL^6*gAl*gAu*gHZZ^2*
     (gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
        d*gZuR*(2*Pi)^d) + gZlL*(2^(1 + d)*gZuL*Pi^d - 2^(2 + d)*gZuR*Pi^d - 
        d*gZuL*(2*Pi)^d + d*gZuR*(2*Pi)^d))*t*SPList[SP[p1, p2], SP[p2, q1]])/
    ((2*Pi)^(2*d)*s*(mz^3 - mz*s)^2) + 
   (I*2^(-1 - d)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*((-4 + d)*s + 2*t) + 
   ...
   (I*2^(-1 - d)*EL^6*gAl*gAu*gHZZ^2*(gZlR*gZuL*(4*s - d*s + 6*t - 2*d*t) + 
    ...
    (Pi^d*s*(mz^3 - mz*s)^2) - (I*2^(-1 - d)*EL^6*gAl*gAu*gHZZ^2*
     (gZlL*gZuL*((-6 + d)*s - 2*t) + gZlR*gZuR*((-6 + d)*s - 2*t) + 
      gZlR*gZuL*(-(d*s) - 2*t) + gZlL*gZuR*(-(d*s) - 2*t))*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^d*s*(mz^3 - mz*s)^2) - 
   (I*2^(-1 - 2*d)*EL^6*gAl*gAu*gHZZ^2*
     (gZlR*(-(2^(2 + d)*gZuL*Pi^d) + 2^(1 + d)*gZuR*Pi^d + d*gZuL*(2*Pi)^d - 
        d*gZuR*(2*Pi)^d) + gZlL*(2^(1 + d)*gZuL*Pi^d - 2^(2 + d)*gZuR*Pi^d - 
 ...
 PropList[KiraPropagator[p1 - q1, mh], KiraPropagator[-p2 - q1, 
    mz*Sqrt[GaugeXi[Q]]]]*(((-I)*2^(-1 - 2*d)*EL^6*gAl*gAu*gHZZ^2*
     (gZlR*gZuL*(2^(2 + d)*Pi^d*s - d*(2*Pi)^d*s + 3*2^(1 + d)*Pi^d*t - 
        2^(1 + d)*d*Pi^d*t) + gZlL*gZuR*(2^(2 + d)*Pi^d*s - d*(2*Pi)^d*s + 
        3*2^(1 + d)*Pi^d*t - 2^(1 + d)*d*Pi^d*t) + 
      gZlL*gZuL*(-(2^(1 + d)*Pi^d*s) + d*(2*Pi)^d*s - 3*2^(1 + d)*Pi^d*t + 
