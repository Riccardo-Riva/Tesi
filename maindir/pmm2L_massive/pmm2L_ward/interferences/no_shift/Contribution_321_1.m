...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (((-I)*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*s*
     (bb*(mm^4 + psq*(psq - t) - mm^2*(s + t)) + 
      aa*(mm^4 + mm^2*(-2*psq + t) + psq*(-psq + s + t)))*\[Mu]^(8 - 2*d))/
    Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
     (bb*(-2*psq^2 - psq*(s - 2*t) + s*(s + t)) + 
      aa*(2*psq^2 - s*(-2*mm^2 + s + t) - psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*
     mm^6*(psq^2 + mm^2*(psq - s - t) + psq*(3*s - t) - 2*s*(s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
     (bb*(-2*psq^2 + 2*mm^2*s - psq*s + 2*psq*t + s*t) + 
      aa*(2*psq^2 - s*t - psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*
     (psq^2 + mm^2*(psq - t) - psq*t - 2*s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*
     mm^6*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*s*(aa*(mm^2 + 3*psq - 2*s - 4*t) + 
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*s*
     ...
     SPList[SP[q1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*s*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(mm^4 - psq*s + 
   ...
   (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(-(aa*psq*s) + 3*aa*mm^2*(psq - t) + 
      bb*mm^2*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(mm^4 - psq*s + 
      mm^2*(-2*psq + 3*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p2, q1]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*
     (aa*mm^2*(psq - s - t) + bb*mm^2*(-psq + t) - aa*s*(-2*psq + s + t) + 
      bb*s*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*psq*(psq - s - t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(-(bb*psq*s) + 
      aa*mm^2*(3*psq - 2*s - 3*t) + 3*bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*(aa*(psq - s - t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(bb*mm^2*(psq - t) - bb*s*t + 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*s*(-2*psq + s + 2*t)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - t) + aa*(-psq + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - s - t) + 
      aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - t) + aa*(mm^2 - 2*psq + t))*
