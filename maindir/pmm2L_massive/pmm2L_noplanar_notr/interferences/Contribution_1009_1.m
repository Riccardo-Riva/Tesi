...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((4^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*
   ...
   (4^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*
    ...
    (Pi^(4*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*
   ...
   (2^(1 - 4*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*
    ...
    (Pi^(4*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(8*gZlL*gZlR*mm^2*(-psq + s + t) + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*(-2*(-2 + d)*gZlL*gZlR*s + 
      gZlL^2*(-psq + s + t) + gZlR^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*(gZlL^2*(2*mm^2 - psq - t) + 
      gZlR^2*(2*mm^2 - psq - t) + 2*gZlL*gZlR*(psq + (-4 + d)*s - t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*(4*(-4 + d)*gZlL*gZlR*s + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*mm^2*
     (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*
     (2*mm^2 + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(4*gZlL*gZlR*mm^2*(2*psq + s - 2*t) + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(8*gZlL*gZlR*mm^2*(psq - t) + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL - gZlR)^2*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL - gZlR)^2*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(-8*gZlL*gZlR*mm^2 + 
      (-5 + d)*gZlL^2*s + (-5 + d)*gZlR^2*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL - gZlR)^2*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*(-psq + s + t)*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL - gZlR)^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*
     (gZlL - gZlR)^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*
     (4*mm^2 - 4*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - psq - t)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*
     ...
     (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*
     (gZlL^2 + gZlR^2)*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*(-psq + s + t)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*psq + s - 2*t)*
    ...
    (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpZ^2*(gZlL^2 + gZlR^2)*
