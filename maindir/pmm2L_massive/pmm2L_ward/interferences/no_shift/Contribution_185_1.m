  ...
  ((I*EL^5*gAl^3*mm^2*s*(aa*(-2*d*gZlL*gZlR*(d*(mm^2 + psq) - 2*s)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*
     (aa*(-2*s*(4*gZlL*gZlR*mm^2*s + gZlL^2*(-2*mm^4 - 2*psq^2 - 3*psq*s + 
        ...
        d^2*(-2*gZlL*gZlR*mm^2*(2*psq^2 + mm^2*(2*psq - s - 2*t) - 
            2*psq*(s + t) + s*(s + t)) + gZlL^2*(psq^2*s + 2*mm^4*(psq - t) + 
            mm^2*(2*psq^2 + s*(s + t) - 2*psq*(2*s + t))) + 
          gZlR^2*(psq^2*s + 2*mm^4*(psq - t) + mm^2*(2*psq^2 + s*(s + t) - 
              2*psq*(2*s + t)))) + d*(4*gZlL*gZlR*mm^2*s*(psq + s - t) + 
          gZlL^2*(-2*mm^4*(2*psq + s - 2*t) + s*(-4*psq^2 - 3*psq*s + 
              s*(s + t)) - 2*mm^2*(2*psq^2 + 2*s*(s + t) - psq*(7*s + 
                2*t))) + gZlR^2*(-2*mm^4*(2*psq + s - 2*t) + 
            s*(-4*psq^2 - 3*psq*s + s*(s + t)) - 2*mm^2*(2*psq^2 + 
              2*s*(s + t) - psq*(7*s + 2*t))))) - 
      bb*(d^2*(gZlL - gZlR)^2*mm^2*(2*psq^2 + mm^2*(2*psq - s - 2*t) - 
        ...
        d*(4*gZlL*gZlR*mm^2*s*(psq + s - t) + gZlL^2*(s^2*(-3*psq + s + t) + 
            ...
            mm^4*(-4*psq + 2*s + 4*t) + mm^2*(-4*psq^2 - 4*s*(s + t) + 
              psq*(6*s + 4*t))))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^3*mm^2*
     (aa*((-2 + d)*gZlL^2*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - t) + d*s*t + 
          psq*(2*s - 2*d*s + 2*t - d*t)) + (-2 + d)*gZlR^2*
   ...
   (I*2^(1 - 4*d)*EL^5*gAl^3*
     (bb*(4^(1 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq - s)*s - 
        ...
        d^2*(2*Pi)^(2*d)*(4*gZlL*gZlR*mm^2*(psq - s - t) + 
          ...
          gZlR^2*(4*mm^4 + psq*s + mm^2*(-6*psq + s + 2*t)))))*
   ...
   (I*4^(1 - 2*d)*EL^5*gAl^3*
     (aa*(-(2^(1 + 2*d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(2*mm^2 - 2*psq - s)*s) - 
        ...
        d*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(s^2 + mm^2*(4*psq - 2*(s + 2*t)))))*
