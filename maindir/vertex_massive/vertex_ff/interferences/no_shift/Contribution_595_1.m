...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^4*
     (-psq^3 - 3*psq*t*(s + t) + t*(s + t)^2 + psq^2*(s + 3*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^4*(psq - t)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     ...
     SPList[SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*
     gWWA*mm^4*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (mm^2*(8*psq^2 - s^2 + psq*(s - 16*t) + 7*s*t + 8*t^2) + 
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (mm^2*(8*psq^2 - 5*psq*s + s^2 - 16*psq*t + 9*s*t + 8*t^2) + 
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(-psq + s + t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (-8*psq^3 + 3*mm^2*psq*s + 20*psq^2*t + mm^2*s*t + 4*t^2*(s + t) - 
      8*psq*t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (psq^2*(-3*s + 2*t) + 2*psq*(s^2 - 2*t^2) + t*(s^2 + 3*s*t + 2*t^2) + 
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (mm^2*(-4*psq^2 + s^2 + 8*psq*t - 4*t^2) + 
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^4*(psq - t)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (4*psq^3 + mm^2*(4*psq - s - 4*t)*(psq - t) + 2*psq*t*(3*s + 4*t) - 
      psq^2*(3*s + 10*t) - t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^4*(2*psq - s - 2*t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (8*psq^2 - 8*psq*s + 2*s^2 - 11*psq*t + 5*s*t + 3*t^2 + 
      mm^2*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*
     gWWA*mm^2*(3*psq^2 + (s + t)^2 + mm^2*(-2*psq + s + 2*t) - 
      psq*(3*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (-7*psq^2 + 4*psq*s - s^2 + mm^2*(2*psq + s - 2*t) + 9*psq*t - 3*s*t - 
      2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (3*psq^2 + s*(mm^2 + s + t) - 3*psq*(2*s + t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(2*mm^2 - 3*psq + s + t)*
     ...
     gWWA*mm^2*(psq^2 + psq*t - t*(s + 2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(mm^2 - psq + s)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*
     gWWA*mm^2*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (4*psq^2 - 5*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (5*psq^2 + mm^2*s + 4*s^2 + 8*s*t + 5*t^2 - 2*psq*(6*s + 5*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (-psq^2 - 5*psq*s + 2*mm^2*(psq - t) + (s + t)^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(psq - t)*(-psq + s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (-2*psq^2 + mm^2*s + t*(s + t) + psq*(2*s + t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (-2*psq^2 + 2*mm^2*(psq - t) + 5*psq*t - t*(s + 3*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (7*psq^2 + s^2 - 2*mm^2*(psq + s - t) + 2*s*t + 5*t^2 - 3*psq*(s + 4*t))*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[q1, q1]])/Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(psq - t)^2*
    ...
    (Pi^(2*d)*s) + (3*2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*
   ...
   (3*2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(psq - t)^2*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(psq - t)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*
     gWWA*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*
     gWWA*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
      SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[q2, q2]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAu*gFll*gHFW*gHll*gWNl*gWWA*mm^2*(2*psq - s - 2*t)*
