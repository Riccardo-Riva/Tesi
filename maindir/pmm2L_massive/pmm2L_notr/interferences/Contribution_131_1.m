...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*
    mh^2*mm^2*(mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 - psq - 2*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
  ...
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/(Pi^(2*d)*s^2) - 
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 - psq - 4*s)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
    (-4*mm^2 + 2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*
    gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*
    gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(Pi^(2*d)*s) - 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s) - 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(2*psq + s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
    (mm^2 - 3*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(-psq + s + t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFA^2*gHFF*gHll*mh^2*mm^2*(psq - t)*
