...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mh], 
  ...
  ((EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*s*
    ...
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) + (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
     (gZlL + gZlR)^2*ml^2*mm^2*s*(3*psq + s)*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*s*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*
     (gZlL + gZlR)^2*ml^2*mm^2*psq*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    ((mh^2 - mz^2)*Pi^(2*d)) - ((aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
     ml^2*mm^2*s^2*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    ((mh^2 - mz^2)*(2*Pi)^(2*d)) - (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
   ...
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*s*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (4^(1 - d)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*
     ml^2*mm^2*(-4*bb*psq + aa*(mm^2 + 3*psq))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*psq*
   ...
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*(gZlL + gZlR)^2*ml^2*mm^2*s*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*
     (gZlL + gZlR)^2*ml^2*mm^2*(-2*psq + s)*\[Mu]^(8 - 2*d)*
