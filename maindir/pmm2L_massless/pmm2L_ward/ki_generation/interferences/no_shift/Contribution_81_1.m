(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, 0], 
  ...
  ((I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(s + t)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-10 + 3*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*(s + t)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-6 + d)*EL^5*gAl*gWlN*gWNl*gWWA^2*t*
   ...
   (I*4^(1 - d)*(aa - bb)*(-10 + 3*d)*EL^5*gAl*gWlN*gWNl*gWWA^2*t*
