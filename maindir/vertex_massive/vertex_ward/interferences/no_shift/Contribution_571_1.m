...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
      (aa*((-2 + d)*mm^4 + 2*d*psq^2 + mm^2*(2*psq + 5*d*psq - 2*d*s)) + 
       bb*((-2 + d)*mm^4 + d*psq*(-2*psq + s) + 
         mm^2*(2*psq - 7*d*psq + d*s)))*\[Mu]^(8 - 2*d))/Pi^(2*d)) + 
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*
     (2*bb*psq*(2*(1 + d)*mm^2 + d*psq + s - d*s) + 
      aa*(mm^2*(-4*(1 + d)*psq + (2 + d)*s) + psq*(-4*s + d*(-2*psq + s))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*(bb*d*psq*(-psq + s) + 
      aa*psq*(d*(psq - 3*s) + 4*s) + aa*mm^2*((-4 + 5*d)*psq - (2 + d)*s) + 
      bb*mm^2*((4 - 5*d)*psq + (-2 + 3*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*
     mm^4*(d*(mm^2 - 2*psq) + 6*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    Pi^(2*d) + (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^4*(aa*(4 + d)*mm^2 + 
      2*aa*(-3 + 2*d)*psq + bb*(-2*d*mm^2 + 2*psq - 3*d*psq))*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*s*(aa*(mm^2 + 3*psq - s) + 
   ...
   (2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
     ...
     (2*bb*mm^2 + aa*(-4 + d)*psq - bb*(-2 + d)*psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*(-2*bb*psq - 2*aa*(-1 + d)*psq + 
      bb*d*(mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    Pi^(2*d) + (4^(2 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*
     (mm^2 - (-3 + d)*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
   ...
   (2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*psq*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*d*(psq^2 + mm^2*(3*psq - s)) - 
   ...
   (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*s*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*mm^2 - bb*(-2 + d)*mm^2 + 
    ...
    Pi^(2*d) + (2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(4*aa*mm^2 - 4*bb*psq + 
      bb*d*(-mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q2]])/Pi^(2*d) - (2^(5 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
