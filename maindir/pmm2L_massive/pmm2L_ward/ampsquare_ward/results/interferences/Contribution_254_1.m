...
{(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
   ...
   ((I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s^2*(s + t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s^2*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s*(s + 2*t)*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s*t*
    ...
    (I*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*s*(s + 2*t)*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gWlN^2*gWNl^2*gWWA*s*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)^2*EL^5*gWlN^2*gWNl^2*gWWA*t*
