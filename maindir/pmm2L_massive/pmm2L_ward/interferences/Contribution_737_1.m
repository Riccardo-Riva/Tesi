...
PropList[KiraPropagator[-p3 + q1, 0], KiraPropagator[-p3 - q2, mm], 
 ...
 (((-I)*d*EL^5*gAl^3*mm^2*(mm^2 - psq)*s*
  ...
  (I*4^(-1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*(mm^2 - psq)*
   ...
   Pi^(2*d) - (I*4^(-1 - 2*d)*EL^5*gAl^3*
    ((-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*(mm^2 - psq)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) + 
     2^(1 + 2*d)*d*mm^2*Pi^(2*d)*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*(mm^2 - psq) + 4*gZlL*gZlR*(2*psq - s - 2*t)) + 
       bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
         4*gZlL*gZlR*(-2*psq + s + 2*t))) - 
     2*d*mm^2*(aa*((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(mm^2 + psq)*
  ...
  (I*4^(-1 - 2*d)*EL^5*gAl^3*(-((-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*
       (mm^2 - psq)*s*(aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
        bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))) - 
     2^(1 + 2*d)*d*mm^2*Pi^(2*d)*s*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*(mm^2 - psq) + 4*gZlL*gZlR*(2*psq - s - 2*t)) + 
       bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
         4*gZlL*gZlR*(-2*psq + s + 2*t))) + 2*(aa - bb)*d*mm^2*
    ...
    SPList[SP[p2, q2]])/Pi^(4*d) + (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    (mm^2 - psq)*s*(aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
     bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*EL^5*gAl^3*s*((-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) + 
     2*d*mm^2*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*
  ...
  (I*EL^5*gAl^3*s*((aa + bb)*(-2 + d)^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)^2 + 
     d*mm^2*(aa*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*
          (mm^2 - psq) + 4*gZlL*gZlR*(2*psq - s - 2*t)) + 
       bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
         4*gZlL*gZlR*(-2*psq + s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 4*d)*EL^5*gAl^3*((-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) - 
     2^(1 + 2*d)*(-2 + d)*Pi^(2*d)*
      (bb*(2*gZlL*gZlR*mm^2*(2*s + d*(-psq + t)) + 
       ...
       aa*(-2*gZlL*gZlR*mm^2*(2*s + d*(-psq + t)) + 
         ...
         gZlR^2*(-((-2 + d)*mm^2*(psq - t)) + s*(psq + t)))) - 
     bb*(d^2*(2*Pi)^(2*d)*(4*gZlL*gZlR*mm^2*(-psq + s + t) + 
         gZlL^2*(2*psq^2 + mm^2*s - 3*psq*s - 2*psq*t) + 
         gZlR^2*(2*psq^2 + mm^2*s - 3*psq*s - 2*psq*t)) + 
       4^(1 + d)*Pi^(2*d)*(4*gZlL*gZlR*mm^2*s + gZlL^2*(2*psq^2 + 2*mm^2*s - 
           5*psq*s - 2*psq*t - s*t) + gZlR^2*(2*psq^2 + 2*mm^2*s - 5*psq*s - 
           2*psq*t - s*t)) - 2^(1 + 2*d)*d*Pi^(2*d)*
        (4*gZlL*gZlR*mm^2*(-psq + 2*s + t) + 
     ...
     (aa - bb)*(-2 + d)*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
        (2*psq - s - 2*t) - gZlL^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 - 
         ...
         mm^2*(3*(-2 + d)*psq + 6*t - d*(s + 3*t))) - 
       gZlR^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 - 2*s*(s + 2*t) - 
         psq*((-8 + d)*s + (-2 + d)*t) + mm^2*(3*(-2 + d)*psq + 6*t - 
           d*(s + 3*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
   Pi^(4*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    (mm^2 - psq)*(aa*((-2 + d)*mm^2 + 4*s - d*s + 2*t - d*t) + 
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    ((2 + d)*mm^2 + (-2 + d)*psq)*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 4*d)*(-2 + d)*EL^5*gAl^3*((gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) + 
  ...
  (I/2)*EL^5*gAl^3*((2^(1 - 2*d)*(aa - bb)*d*mm^2*
  ...
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl^3*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
   ...
   Pi^(2*d) + (I*4^(-1 - 2*d)*EL^5*gAl^3*
    (2^(1 + 2*d)*(aa + bb)*(-2 + d)^2*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq)*
      s - 4^(1 + d)*(aa - bb)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
      (-2*s + d*(psq - t)) - 2^(1 + 2*d)*(aa - bb)*(-2 + d)*Pi^(2*d)*
      (-4*d*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*(mm^2 + psq) + 
       (-2 + d)*gZlR^2*(mm^2 + psq))*(2*psq - s - 2*t) + 
     (-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) + 
     (-2 + d)*(-(aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*
           (2*s + d*(psq - s - t)) + gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) - 
            2*psq*s - (-2 + d)*mm^2*(psq - 2*s - t) + (-2 + d)*psq*t - 
            2*s*t) + gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) - 2*psq*s - 
            (-2 + d)*mm^2*(psq - 2*s - t) + (-2 + d)*psq*t - 2*s*t))) + 
       bb*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(psq - s - t)) - 
         gZlL^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + (-2 + d)*mm^2*(psq - t) + 
           2*s*t + psq*(6*s - 2*d*s + 2*t - d*t)) - gZlR^2*(2*Pi)^(2*d)*
    ...
    (bb*(2^(1 + 2*d)*d*Pi^(2*d)*(-4*gZlL*gZlR*mm^2*(psq + s - t) + 
      ...
      aa*(d^2*(2*Pi)^(2*d)*(gZlL^2*(2*psq^2 - mm^2*s + psq*(s - 2*t)) + 
        ...
        2^(1 + 2*d)*d*Pi^(2*d)*(4*gZlL*gZlR*mm^2*(psq + s - t) + 
          gZlL^2*(-4*psq^2 + s*(3*mm^2 + s + t) + psq*(-6*s + 4*t)) + 
          gZlR^2*(-4*psq^2 + s*(3*mm^2 + s + t) + psq*(-6*s + 4*t)))))/
     (2*Pi)^(4*d))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]] + 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl^3*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
      (mm^2 - psq)*s - (aa - bb)*(-4*d*gZlL*gZlR*mm^2 + 
       (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*
   ...
   Pi^(2*d) + (I*4^(-1 - 2*d)*EL^5*gAl^3*
    (2^(1 + 2*d)*(aa + bb)*(-2 + d)^2*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq)*
      s - 2^(1 + 2*d)*(aa - bb)*(-2 + d)*Pi^(2*d)*(-4*d*gZlL*gZlR*mm^2 + 
       (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*
      (2*psq - s - 2*t) + 4^(1 + d)*(aa - bb)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
      (-2*s + d*(-psq + s + t)) + (-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*
      (aa*((-2 + d)*mm^2 - (-6 + d)*psq - 2*(s + 2*t)) + 
       bb*((-2 + d)*mm^2 - (2 + d)*psq + 2*(s + 2*t))) - 
     (-2 + d)*(aa*(4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*s + d*(psq - t)) + 
         gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) - (-8 + d)*psq*s - 
           (-2 + d)*mm^2*(psq - s - t) + (-2 + d)*psq*t - 2*s*(s + t)) + 
         gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) - (-8 + d)*psq*s - 
           (-2 + d)*mm^2*(psq - s - t) + (-2 + d)*psq*t - 2*s*(s + t))) + 
  ...
  (I*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
   ...
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
    (aa*((-2 + d)*mm^2 + 4*s - d*s + 2*t - d*t) + 
     bb*((-2 + d)*mm^2 + 4*psq - 2*d*psq - 4*s + d*s - 2*t + d*t))*
  ...
  (I*(-2 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
     SP[p3, q2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)^2*EL^5*gAl^3*
  ...
  (I*(-2 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*(-2 + d)^2*EL^5*gAl^3*(gZlL^2 + gZlR^2)*
