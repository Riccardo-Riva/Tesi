...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
 ...
 (-((2^(-1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*s*
    ...
    SPList[SP[q1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*ggmgmA^2*ggmgmZ*
  ...
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(bb*psq*(2*psq - s) - 
     2*aa*psq*(-mm^2 + psq + s) + bb*mm^2*(-2*psq + 3*s))*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(-2*aa*psq + bb*(mm^2 + psq))*s*
