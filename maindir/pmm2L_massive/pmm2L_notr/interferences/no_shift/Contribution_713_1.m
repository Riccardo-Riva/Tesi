...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll^2*mm^4*(-2*(8 - 7*d + d^2)*gZlL*gZlR*s + 
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(20 - 10*d + d^2)*EL^8*gAl^2*gAu^2*gHll^2*
     (gZlL^2 + gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
   ...
   (2^(3 - 2*d)*(20 - 10*d + d^2)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
     ...
     (gZlL^2 + gZlR^2)*mm^2*(2*(-2 + d)*psq + (24 - 12*d + d^2)*s - 
      ...
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll^2*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
     (gZlL^2 + gZlR^2)*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
