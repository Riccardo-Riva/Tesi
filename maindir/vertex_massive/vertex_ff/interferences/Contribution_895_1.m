...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((4^(1 - d)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)^2*mm^4*
     (-(psq*s) + 2*mm^2*(psq - t))*(psq^2 - 2*psq*t + t*(s + t))*
     \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)^2*mm^4*(-psq + s + t)*
     (-2*psq^2 - 3*psq*(s - 2*t) + 4*mm^2*(psq - t) - 4*t*(s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)^2*mm^4*(psq - t)*
