...
PropList[KiraPropagator[p1 + q1, mh], KiraPropagator[q2, mm], 
 ...
 (-((4^(-1 - 2*d)*EL^6*gAl^2*gHHZZ*mm^2*
  ...
  (2^(-1 - 4*d)*EL^6*gAl^2*gHHZZ*(-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)) - 
  ...
  (2^(-1 - 2*d)*EL^6*gAl^2*gHHZZ*(12*(gZlL^2 + gZlR^2)*s + 
     d^2*(gZlL^2 + gZlR^2)*s - 8*d*(gZlL*gZlR*mm^2 + gZlL^2*s + gZlR^2*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  ((-2 + d)*EL^6*gAl^2*gHHZZ*(gZlL^2 + gZlR^2)*(2*(-3 + d)*mm^2 - 
     2*(-5 + d)*psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + ((-2 + d)*EL^6*gAl^2*gHHZZ*(gZlL^2 + gZlR^2)*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
   ((2*Pi)^(2*d)*s) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gHHZZ*
    (gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   Pi^(2*d) - (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gHHZZ*(gZlL^2 + gZlR^2)*
