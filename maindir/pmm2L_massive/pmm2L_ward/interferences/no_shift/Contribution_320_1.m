...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (((-I)*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (-(bb*(2*psq^2 + 4*mm^2*(psq - s - t) + s*(s + t) - psq*(s + 2*t))) + 
      aa*((2*psq - s)*(psq - s - t) + mm^2*(4*psq - 2*(s + 2*t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (bb*(-psq^2 + mm^2*(3*psq + s - 3*t) + psq*(s + t) - 2*s*(s + t)) + 
      aa*(psq^2 + 2*s*(s + t) + 3*mm^2*(-psq + s + t) - psq*(5*s + t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
   (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (aa*(2*psq^2 - 3*psq*s + 4*mm^2*(psq - t) - 2*psq*t + s*t) + 
      bb*(-((2*psq - s)*(psq - t)) + mm^2*(-4*psq + 2*s + 4*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) - 
   (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (aa*(-psq^2 + 4*psq*s + mm^2*(3*psq - 4*s - 3*t) + psq*t - 2*s*t) + 
      bb*(psq^2 - 3*mm^2*(psq - t) - psq*t + 2*s*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*
     gXll^2*mm^6*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*s*
     ...
     mm^6*s*(bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(3*bb*(psq - s - t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
     (bb*(3*mm^4 + psq*s - mm^2*(2*s + 3*t)) + 
      aa*(mm^4 - psq*s + mm^2*(-4*psq + 2*s + 3*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
     (aa*psq*s + aa*mm^2*(5*psq - 4*s - 5*t) + bb*mm^2*(-5*psq + 3*s + 5*t))*
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
     (bb*(mm^4 - psq*s + mm^2*(2*psq - s - 3*t)) + 
      aa*(3*mm^4 + psq*s + mm^2*(-6*psq + s + 3*t)))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(3*psq - s - 3*t) - 
      ...
      aa*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(bb*(4*mm^2 - psq - 3*t) + 
      3*aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^6*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*
     (bb*psq*s + aa*mm^2*(5*psq - 2*s - 5*t) + bb*mm^2*(-5*psq + s + 5*t))*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*(mm^2 - t) + aa*(-psq + t))*
   ...
   (I*4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(bb*(2*mm^2 - psq - t) + 
     ...
     mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*
     mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*
     mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
      SP[q1, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*
     mm^4*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
      SP[q1, q1]])/Pi^(2*d)))/4
