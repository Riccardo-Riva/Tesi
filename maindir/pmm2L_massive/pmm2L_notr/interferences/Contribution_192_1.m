...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, mh], 
 ...
 (-((4^(2 - d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (8*psq^2 - 8*psq*s + s^2 + mm^2*(-4*psq + 2*s - 4*t) + 4*psq*t - 2*s*t - 
     4*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^4*(-4*psq + s)*(psq - t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (8*psq^2 - 4*psq*(3*s + 2*t) + s*(3*s + 2*t) + 
     mm^2*(-8*psq + 10*s + 8*t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*(8*mm^2 - 4*psq + s)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gHFW^2*gHll^2*gWWA*mm^2*
    (s*(-2*psq + s) + 2*mm^2*(8*psq - 7*s - 8*t))*\[Mu]^(8 - 2*d)*
