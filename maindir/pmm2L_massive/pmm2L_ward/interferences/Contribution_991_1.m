...
PropList[KiraPropagator[-q1, mh], KiraPropagator[-q1 - q2, mz], 
 ...
 (((-I)*4^(-1 - d)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*s*
    (bb*(3*psq^2 - 4*psq*s + s^2 - 3*psq*t + 2*s*t + mm^2*(-psq + s + t)) + 
     aa*(-3*psq^2 + mm^2*(psq - t) + 3*psq*(s + t) - s*(s + 2*t)))*
    \[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(bb*(6*psq^2 + 4*mm^2*(-psq + s + t) + 2*s*(s + 2*t) - 
       3*psq*(3*s + 2*t)) + aa*(-6*psq^2 + 4*mm^2*(psq - t) - 2*s*(s + 2*t) + 
       psq*(5*s + 6*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) - 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(aa*(2*mm^2 - 3*psq + 2*s)*(psq - t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*
  ...
  (I*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(aa*(3*mm^2 - psq - 2*t) + 
     bb*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
   (2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*
    (gZlL - gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, p3]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) - (I*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  (I*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(aa*(2*psq - s - 2*t) + 
  ...
  (I*bb*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*(aa + bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
    mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
    (aa*(2*mm^2 - psq - s - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*aa*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*
    mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*
  ...
  ((3*I)*(aa - bb)*EL^5*gAl*gHXZ*gHZZ*gXll*(gZlL - gZlR)*mm^2*\[Mu]^(8 - 2*d)*
