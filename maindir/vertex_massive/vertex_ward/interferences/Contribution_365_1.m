...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (((-I)*EL^5*gAl*gHll*gHZZ*mm^2*s*(aa*((-2 + d)*gZlL^2*mm^2*(mm^2 - psq) + 
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gHll*gHZZ*mm^2*
      (-(aa*((-2 + d)*gZlL^2*mm^2*(psq - t) + (-2 + d)*gZlR^2*mm^2*
           (psq - t) + d*gZlL*gZlR*s*(2*mm^2 - 3*psq + s + t))) + 
    ...
    (I*4^(1 - d)*d*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + 
