...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*((-2 + d)^2*mm^4*s - 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(6*psq^2 - 2*s^2 + d*s^2 + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*(2*psq^2 - 2*s^2 + d*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
    (-4*psq^2 + (6 - 4*d + d^2)*mm^2*s - (2 - 4*d + d^2)*psq*s - 4*s^2 + 
  ...
  (EL^8*gAl^4*gAu^2*gXll^2*mm^4*(4*(2 + d)*psq^2 - 2*(-2 + d)^2*mm^2*s + 
     2*(-2 + d)^2*psq*s + 20*s^2 - 10*d*s^2 + d^2*s^2 - 8*(2 + d)*psq*t + 
     8*s*t + 4*d*s*t + 8*t^2 + 4*d*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (4^d*Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (mm^2 - psq)*(2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*psq*(2*psq + (-4 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(mm^2 - psq)*
    (2*mm^2 - 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(psq*(-2*psq + (-3 + d)*s) + 
     mm^2*(-4*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ...
    (-8*psq^2 + 2*s^2 - d*s^2 + 2*mm^2*(4*psq + s - d*s - 4*t) - 4*s*t - 
     4*t^2 + 6*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    ...
    (-2*(4 + d)*psq^2 - (12 - 10*d + d^2)*psq*s + 2*(8 + d)*psq*t + 
     ...
     4*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*gXll^2*mm^4*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(8*psq^2 - 2*s^2 + d*s^2 + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*s^2 + d*s^2 + 
     2*mm^2*(2*psq + s - 2*t) + 4*s*t + 4*t^2 - 2*psq*(s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*s^2 + d*s^2 + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*psq^2 + 2*mm^2*s - 2*s^2 + 
     d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(4*psq^2 + 4*mm^2*s - 2*s^2 + 
     d*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*((16 - 6*d + d^2)*mm^2 - 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*(-2*psq + (-2 + d)*s + 2*t)*
   ...
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gXll^2*mm^2*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*
