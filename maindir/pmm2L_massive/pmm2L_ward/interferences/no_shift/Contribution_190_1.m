...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)^2*s*
   ...
   (I*2^(1 - 2*d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)^2*
     (aa*(psq - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    Pi^(2*d) + (I*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*(mm^2 - psq)*s*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
    ...
    Pi^(2*d) + (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gWlN*gWNl*gWWA*gXll^2*mm^2*
