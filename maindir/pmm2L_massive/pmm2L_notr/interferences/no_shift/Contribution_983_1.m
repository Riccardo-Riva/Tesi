...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(psq - s)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(psq + (-3 + d)*s - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)*s^2) + 
    (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      (2*mm^2 - 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*mm^2 + psq - 5*s + 
       d*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    ...
    (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[q1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + (-2 + d)*s + 
       2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
     (mh^2*Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      (-psq + (-2 + d)*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     (mh^2*Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(mh^2*Pi^(2*d)*s) - 
    (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + s + 2*t)*
