...
((-I/16)*EL^2*gAd*(gZdL + gZdR)*SumOver[Index[Colour, 3], 3]*
 ...
 (EL^2*gAd*((-I)*(gZdL + gZdR)*pasq*(pasq - pzsq) + 
   ...
   SumOver[Index[Colour, 3], 3]*userIntegral[A0, {MS}, 1, 1])/(16*pasq*Pi^4)
