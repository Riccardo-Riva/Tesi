...
PropList[KiraPropagator[-q1, ml], KiraPropagator[q2, 0], 
  ...
  ((I*2^(-1 - 2*d)*EL^5*gAl^3*(gZlL + gZlR)^2*ml^2*s*
   ...
   (I*EL^5*gAl^3*(aa*(2^(1 + 4*d)*gZlL*gZlR*Pi^(4*d)*((8 - 5*d + d^2)*mm^4 - 
          6*d*psq^2 + 2*d^2*psq^2 - 52*psq*s + 41*d*psq*s - 7*d^2*psq*s + 
          28*s^2 - 22*d*s^2 + 4*d^2*s^2 + (-2 + d)*ml^2*(2*mm^2 + 2*psq - 
            3*s - 4*t) + 6*d*psq*t - 2*d^2*psq*t + 24*s*t - 20*d*s*t + 
          4*d^2*s*t + mm^2*((-8 + 11*d - 3*d^2)*psq + (-28 + 16*d - 3*d^2)*
             s + 4*(6 - 5*d + d^2)*t)) + gZlL^2*(2*Pi)^(4*d)*
        ...
        2*gZlL*gZlR*(4^(1 + 2*d)*Pi^(4*d)*(20*psq^2 - 31*psq*s + 
          ...
          d^2*(2*Pi)^(4*d)*(mm^4 - 2*psq^2 + 3*psq*s - 2*s^2 - 2*psq*t + 
           ...
           (5*mm^4 - 30*psq^2 + psq*(49*s - 6*t) + 20*s*(-s + t) + 
            mm^2*(-31*psq + 34*s + 20*t)))))*\[Mu]^(8 - 2*d)*
   ...
   (I*EL^5*gAl^3*(bb*(2^(1 + 4*d)*gZlL*gZlR*Pi^(4*d)*((8 - 5*d + d^2)*mm^4 + 
          ...
          4*s^2 - 2*d*s^2 - 6*d*psq*t + 2*d^2*psq*t - 24*s*t + 20*d*s*t - 
          4*d^2*s*t + (-2 + d)*ml^2*(2*mm^2 - 6*psq + s + 4*t) + 
        ...
        2*gZlL*gZlR*((-2 + d)*ml^2*(2*Pi)^(4*d)*(6*mm^2 - 2*psq - s - 4*t) - 
          d^2*(2*Pi)^(4*d)*(mm^4 - 6*psq^2 + 13*psq*s - 6*s^2 + 
           ...
           (20*psq^2 - 43*psq*s + mm^2*(-8*psq - 3*s + 6*t) + 
            ...
            psq*(95*s + 6*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p2, q2]])/(mz^2*(2*Pi)^(6*d)) - 
   ...
   (I*EL^5*gAl^3*(bb*(2*gZlL*gZlR*((-2 + d)*ml^2*(2*Pi)^(6*d)*
           ...
           (2*(5 - 5*d + d^2)*psq + (-9 + 10*d - 2*d^2)*s - 
   ...
   (I*EL^5*gAl^3*(-(bb*(2^(1 + 6*d)*gZlL*gZlR*Pi^(6*d)*
          (16*psq^2 - 12*d*psq^2 + 2*d^2*psq^2 - 16*psq*s + 13*d*psq*s - 
           3*d^2*psq*s - 4*s^2 + 2*d*s^2 + (-2 + d)*ml^2*(4*psq - s - 4*t) - 
           16*psq*t + 12*d*psq*t - 2*d^2*psq*t + 4*s*t - 6*d*s*t + 
           2*d^2*s*t + mm^2*(-((8 - 7*d + d^2)*psq) + (8 - 6*d + d^2)*s + 
