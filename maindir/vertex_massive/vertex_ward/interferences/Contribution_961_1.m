...
PropList[KiraPropagator[q1, mm], KiraPropagator[p1 - q2, mm], 
 ...
 ((2^(-1 - 6*d)*EL^5*gAl*gHll^2*mm^4*s*
    ...
    \[Mu]^(8 - 2*d))/Pi^(6*d) + (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^4*
  ...
  ((aa - bb)*EL^5*gAl*gHll^2*mm^4*(-2*(-4 + d)*gZlL*gZlR*mm^2 + 
     (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^4*(-((-4 + d)*gZlL*gZlR*mm^2) + 
     (-2 + d)*gZlL^2*(mm^2 + psq) + (-2 + d)*gZlR^2*(mm^2 + psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) - 
  (2^(-1 - 6*d)*EL^5*gAl*gHll^2*mm^2*s*
  ...
  (2^(-1 - 2*d)*EL^5*gAl*gHll^2*mm^4*s*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
      (mm^2 - psq) - 4*(aa - bb)*(-4 + d)*gZlL*gZlR*s - 
     4*(aa - bb)*gZlL*gZlR*(2*d*psq + 2*s - d*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/Pi^(2*d) + ((aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
   ...
   Pi^(2*d) - ((aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*mm^2*(2*aa*(gZlL^2 + gZlR^2)*(2*mm^2 + psq)*
  ...
  EL^5*gAl*gHll^2*mm^2*((2^(1 - 2*d)*(aa - bb)*(-4 + d)*gZlL*gZlR*mm^2)/
