  ...
  (-((4^(1 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*mm^2*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*
     mm^2*(mm^2 - psq)*(2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*mm^2*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*mm^2*(-psq + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*mm^2*
     ...
     gWNl*gXll^2*mm^2*(-2*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*
     mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
     gWNl*gXll^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*mm^2*(psq - t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gXll^2*mm^2*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*
     gWNl*gXll^2*mm^2*(2*psq + (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
