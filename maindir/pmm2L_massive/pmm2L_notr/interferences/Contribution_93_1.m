...
PropList[KiraPropagator[-p3 - q1, mh], KiraPropagator[p1 + p2 - p3 - q1, mh], 
 ...
 (-((2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gHFF^2*gHll^2*mh^4*mm^4*\[Mu]^(8 - 2*d)*
