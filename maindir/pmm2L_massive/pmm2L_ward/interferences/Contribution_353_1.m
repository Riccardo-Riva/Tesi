...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
 ...
 ((I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*s*(-psq + s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d))/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(2*psq - 3*s)*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
    (2*psq^2 + s*t - 2*psq*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*s*
    (bb*(-5*psq^2 + mm^2*(psq - 4*s + t) - s*(s + t) + 3*psq*(2*s + t)) + 
     aa*(3*psq^2 + mm^2*(psq - t) + s*(s + t) - psq*(2*s + 3*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
    (2*psq^2 + s*t - 2*psq*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
    (2*psq^2 - 2*psq*(s + t) + s*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   Pi^(2*d) - (I*4^(-1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*s*
    (aa*(psq^2 + psq*(s - 3*t) + mm^2*(3*psq - 5*s - t) + s*t) + 
     bb*(-3*psq^2 - s*t + 3*psq*(s + t) + mm^2*(-psq + s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
    (2*psq^2 - 2*psq*(s + t) + s*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
    mm^2*s*(bb*s*(psq - s - 2*t) + 2*aa*mm^2*(psq - t) + 
     2*bb*mm^2*(-psq + s + t) + aa*s*(-3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*
    gHFW*gHll*gWNl*mm^4*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/Pi^(2*d) - (I*4^(-1 - d)*EL^5*gFFA*gFll*gHFW*gHll*
    gWNl*mm^2*(mm^2 - psq)*s*(aa*(psq - t) + bb*(-psq + s + t))*
  ...
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*s*(aa*mm^2*(4*psq - 3*s - 4*t) + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
    s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*
    gHll*gWNl*mm^4*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(6*psq^2 + mm^2*(2*psq + s - 2*t) + 4*s*(s + t) - 
       2*psq*(2*s + 3*t)) + bb*(-10*psq^2 - 4*s*(s + t) + 
       mm^2*(2*psq - 13*s + 2*t) + 2*psq*(8*s + 3*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (bb*(-6*psq^2 + 10*psq*s + 6*psq*t - 4*s*t + mm^2*(-2*psq + 3*s + 2*t)) + 
     aa*(mm^2*(6*psq - 15*s - 2*t) + 2*(psq^2 + psq*s - 3*psq*t + 2*s*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (-(bb*(mm^2*(2*psq - 3*s - 2*t) + s*(s + 2*t))) + 
     aa*(mm^2*(2*psq + s - 2*t) + s*(-4*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/
   Pi^(2*d) + (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
  ...
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*mm^2*(4*psq - 3*s - 4*t) + 
     2*aa*psq*(psq - t) + 2*bb*psq*(-psq + s + t) + 
     bb*mm^2*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(3*psq^2 + mm^2*(psq - t) - 3*psq*(s + t) + 2*s*(s + t)) + 
     bb*(-5*psq^2 + mm^2*(psq - 4*s + t) - 2*s*(s + t) + psq*(7*s + 3*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(psq^2 - 2*psq*s + mm^2*(3*psq - 6*s - t) - 3*psq*t + 2*s*t) + 
     bb*(-3*psq^2 + 6*psq*s + 3*psq*t - 2*s*t + mm^2*(-psq + 2*s + t)))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (-5*bb*psq*s + 2*aa*mm^2*(psq - t) + 2*bb*s*(s + t) + 
     bb*mm^2*(-2*psq + 4*s + 2*t) + aa*s*(psq - 2*(s + t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(3*psq^2 + mm^2*(psq + s - t) + 2*s*(s + t) - psq*(s + 3*t)) + 
     bb*(-5*psq^2 + mm^2*(psq - 5*s + t) - 2*s*(s + t) + psq*(5*s + 3*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(3*psq^2 + mm^2*(psq + s - t) - 3*psq*t + s*(s + t)) + 
     bb*(-5*psq^2 + mm^2*(psq - 5*s + t) - s*(s + t) + psq*(4*s + 3*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*4^(-1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*bb*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (bb*(3*psq^2 - 5*psq*s + mm^2*(psq - 2*s - t) - 3*psq*t + s*t) + 
     aa*(-psq^2 + psq*s + 3*psq*t - s*t + mm^2*(-3*psq + 6*s + t)))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (bb*s*(-3*psq + s) - aa*s*(psq + s) + 2*aa*mm^2*(psq - t) + 
     bb*mm^2*(-2*psq + 4*s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(psq^2 + mm^2*(3*psq - 5*s - t) - 3*psq*t + 2*s*t) + 
     bb*(-3*psq^2 + 4*psq*s + 3*psq*t - 2*s*t + mm^2*(-psq + s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, p3]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (-3*bb*psq*s + 2*aa*mm^2*(psq + s - t) + 2*bb*s*t + 
     2*bb*mm^2*(-psq + s + t) - aa*s*(psq + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*s*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*aa*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*s*(-3*psq + s) - bb*s*(psq + s) - 2*bb*mm^2*(psq - s - t) + 
     2*aa*mm^2*(psq + s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/
   (2*Pi)^(2*d) - (I*4^(-1 - d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^4*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
    mm^2*(aa*mm^2 - 5*bb*mm^2 + 2*aa*(s + t) - 2*bb*(-2*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(5*mm^2 - 2*t) - bb*(mm^2 + 4*psq - 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa + bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(-(bb*(5*mm^2 - 6*psq + 4*(s + t))) + 
     aa*(mm^2 - 2*psq + 4*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/(2*Pi)^(2*d) - 
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*(7*mm^2 + 6*psq - 4*t) + 
     bb*(-3*mm^2 - 10*psq + 4*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*mm^2 - 5*bb*mm^2 + 2*aa*(s + t) - 
     2*bb*(-2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p1, q2]])/(2*Pi)^(2*d) + (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (3*aa*mm^2 - 7*bb*mm^2 + 2*aa*psq + 2*bb*psq + 4*aa*(s + t) - 
     4*bb*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p2, p3]])/(2*Pi)^(2*d) + (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (3*aa*mm^2 - 7*bb*mm^2 - 2*bb*(s + t) + 2*aa*(2*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p3, p3]])/(2*Pi)^(2*d) - 
  (I*4^(1 - d)*bb*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*(7*mm^2 + 4*psq - 2*t) + 
     bb*(-3*mm^2 - 8*psq + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*(5*mm^2 + 2*psq - 4*t) - 
     bb*(mm^2 + 6*psq - 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
    mm^2*(aa*(3*mm^2 + psq - s - 4*t) + bb*(mm^2 - 5*psq + s + 4*t))*
  ...
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*(5*mm^2 - 2*t) - 
     bb*(mm^2 + 4*psq - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) - (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, p3]])/(2*Pi)^(2*d) - 
  (I*4^(1 - d)*aa*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3], SP[p3, q1]])/
   (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2], 
     SP[q1, q1]])/(2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
    mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p1, q1]])/(2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
    mm^2*(mm^2 + 3*psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], 
     SP[p2, q1]])/(2*Pi)^(2*d) + (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(4*psq - 3*s - 4*t) + bb*(2*mm^2 - 6*psq + 3*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p3, q1]])/
   (2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(3*psq - 2*s - 3*t) + bb*(2*mm^2 - 5*psq + 2*s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p1, q2]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (mm^2 + 2*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, p3]])/(2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*
    mm^2*(mm^2 + psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*
    gWNl*mm^2*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*bb*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(2*mm^2 + 5*psq - t)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 + 4*psq - 2*t)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(mm^2 + 2*psq)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*(2*mm^2 + 2*psq - s - 4*t) + 
     bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*
    gWNl*mm^2*(aa*(2*mm^2 + psq - s - 3*t) + bb*(-3*psq + s + 3*t))*
  ...
  (I*EL^5*gFFA*gFll*gHFW*gHll*gWNl*mm^2*(aa*(4*mm^2 + 2*psq - s - 6*t) + 
     bb*(-6*psq + s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[p3, q1]])/(2*Pi)^(2*d) - (I*2^(-1 - 2*d)*EL^5*gFFA*gFll*gHFW*gHll*
    gWNl*mm^2*(aa*(4*mm^2 - s - 4*t) + bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
