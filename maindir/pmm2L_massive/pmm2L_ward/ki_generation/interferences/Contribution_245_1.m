...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   (((-I)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(-4*gZlL*gZlR*mm^2 + 
       gZlL^2*(mm^2 + psq) + gZlR^2*(mm^2 + psq))*s*(psq - s - t)*
    ...
    (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(-4*gZlL*gZlR*mm^2 + 
       gZlL^2*(mm^2 + psq) + gZlR^2*(mm^2 + psq))*s*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*s*(psq - t)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(-4*gZlL*gZlR*mm^2 + 
       gZlL^2*(mm^2 + psq) + gZlR^2*(mm^2 + psq))*(psq - s - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
      (gZlL^2*(mm^2*(psq - 2*s - t) + psq*(psq - s - t)) + 
       gZlR^2*(mm^2*(psq - 2*s - t) + psq*(psq - s - t)) + 
    ...
    (I*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*(bb*(psq - s - t) + 
       aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q2, q2]])/(2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*ggmgmA*
      ggmgmZ^2*gZlL*gZlR*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*
     ...
     Pi^(2*d) + (I*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*
    ...
    (I*2^(1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
      (-(bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
          gZlL^2*(psq^2 + mm^2*(psq - 2*s - t) - psq*t + s*(s + t)) + 
          gZlR^2*(psq^2 + mm^2*(psq - 2*s - t) - psq*t + s*(s + t)))) + 
       aa*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
         gZlL^2*(psq^2 + mm^2*(psq + 3*s - t) + s*(s + t) - psq*(5*s + t)) + 
         gZlR^2*(psq^2 + mm^2*(psq + 3*s - t) + s*(s + t) - psq*(5*s + t))))*
    ...
    (I*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
     (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*
    ...
    (I*2^(1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*
      (-(bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
          gZlL^2*(psq^2 + 2*psq*s + mm^2*(psq - 4*s - t) - psq*t + s*t) + 
          gZlR^2*(psq^2 + 2*psq*s + mm^2*(psq - 4*s - t) - psq*t + s*t))) + 
       aa*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
         gZlL^2*(psq^2 + mm^2*(psq + s - t) + s*t - psq*(3*s + t)) + 
         gZlR^2*(psq^2 + mm^2*(psq + s - t) + s*t - psq*(3*s + t))))*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*
     ...
     (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL - gZlR)^2*mm^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
      (bb*(psq - s - t) + aa*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*ggmgmA*ggmgmZ^2*
