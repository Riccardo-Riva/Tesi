...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((EL^5*gAl*gHll^2*gXll^2*mm^6*s*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(aa*(psq - s)*(mm^2 + psq - s) - 
     bb*(psq^2 - 4*psq*s + s^2 + mm^2*(psq + s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*s*
    (2*aa*mm^2*(2*mm^2 + 3*psq - s) + 
     bb*(-3*mm^4 + psq*s + mm^2*(-7*psq + s)))*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*(bb*(mm^2 - 2*psq) + 
   ...
   (2*Pi)^(2*d) - (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 - psq)*
    (-(aa*psq) + bb*(2*mm^2 + psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(3*psq - s) - aa*psq*s + 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(-(bb*mm^2*(mm^2 - 3*psq + 4*s)) + 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2*(4*psq - s) - aa*psq*s + 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(psq^2 + mm^2*(psq - s)) - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*mm^2 - bb*psq)*s*
