...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((2^(-1 - 4*d)*EL^5*gAl*gXll^2*mm^4*s*
     (2*bb*(-(2^(1 + 2*d)*Pi^(2*d)*(gZlL^2*(psq^2 + mm^2*(3*psq - s)) + 
      ...
      aa*(2^(1 + 2*d)*Pi^(2*d)*(gZlL^2*(psq*(2*psq - s) + mm^2*(6*psq - s)) + 
    ...
    (aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(psq*(2*psq - s) + 
        ...
        (psq*s*((-4 + d)*psq + 2*s) + mm^4*((-4 + 5*d)*psq - 2*(-1 + d)*s) + 
         mm^2*((-4 + d)*psq^2 - (14 + d)*psq*s + 4*s^2))) - 
     bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(mm^2*(4*psq - 3*s) + 
         psq*(2*psq + s)) + (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*
        (mm^2*(4*psq - 3*s) + psq*(2*psq + s)) - 2^(1 + 2*d)*gZlL*gZlR*
        Pi^(2*d)*((-4 + d)*psq^2*s + mm^4*((-4 + 5*d)*psq - 2*(-1 + d)*s) + 
         mm^2*((-4 + d)*psq^2 - (14 + d)*psq*s + 6*s^2))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/(2*Pi)^(4*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
  ...
  (2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(-2*bb*(-4 + d)*psq^2 + 
     2*bb*mm^2*((4 + d)*psq - 4*s) + aa*psq*(2*(-4 + d)*psq - (-8 + d)*s) + 
     aa*mm^2*(-2*(4 + d)*psq + d*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(aa*mm^2*(4*psq - s) - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*mm^2*((-4 + d)*psq + 4*s) - 
  ...
  (EL^5*gAl*gXll^2*mm^2*(aa*((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 + 
  ...
  (4^(2 - d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 + psq) - 
  ...
  (4^(1 - d)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*mm^2 - aa*psq)*
