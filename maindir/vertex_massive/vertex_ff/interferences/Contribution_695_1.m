...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*(3*mm^2 + psq)*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) - 
   (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(-10*psq^3 + psq^2*(-5*s + 28*t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(-2*psq + s + 2*t)*
     (7*psq^2 + 5*mm^2*(psq - t) - 11*psq*t + 4*t*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(-(mm^4*(3*psq - s - 3*t)*(psq - t)) + 
      psq^2*(psq - t)*(psq - s - t) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^4*(psq - t) + 
      psq*(psq^2 + s*(s + t) - psq*(4*s + t)) + 
      mm^2*(10*psq^2 + 3*s^2 + 13*s*t + 12*t^2 - 2*psq*(5*s + 11*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*(6*psq^2 + 4*mm^2*s - 17*psq*s + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^4*s + psq*(3*psq - s)*s + 
      mm^2*(-4*psq^2 - 6*psq*s + 3*s^2 + 8*psq*t + 2*s*t - 4*t^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(-5*psq^3 + 14*psq^2*t + 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(psq - t)*(-2*psq + s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*(-6*psq^2 - psq*s + s^2 + 12*psq*t + 
      s*t - 6*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*
     (psq*(-psq + s + t)^2 + mm^2*(7*psq^2 + s^2 + 6*s*t + 7*t^2 - 
        2*psq*(3*s + 7*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^6*(psq - t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(-2*psq + s + 2*t)*
     (psq*(-psq + s + t) + mm^2*(-psq + 3*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(5*psq^3 + mm^2*(3*psq - s - 3*t)*
       (psq - t) + psq*t*(9*s + 13*t) - psq^2*(3*s + 14*t) - 
      2*t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (3*2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(-4*psq^3 + mm^2*s*(s + 3*t) + 
      psq^2*(s + 12*t) + psq*(-3*mm^2*s + s^2 - 7*s*t - 12*t^2) + 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(5*psq^2 - 4*psq*s + s^2 - 7*psq*t + 
      3*s*t + 2*t^2 + mm^2*(-3*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq^2 + mm^2*(psq - t) - 3*psq*t + 
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(mm^2 - psq)*(psq - t)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq^2 + mm^2*s + t^2 - psq*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/
    (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(3*psq^2 - 3*psq*s + s^2 + 
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq^2 + mm^2*s + (s + t)^2 - 
    ...
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq - t)^2*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(2*psq - s - 2*t)*
