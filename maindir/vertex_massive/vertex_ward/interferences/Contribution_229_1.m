...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 ((2^(-1 - 2*d)*EL^5*gFZW^2*gWWA*s*
  ...
  ((aa - bb)*(-2 + d)*EL^5*gFZW^2*gWWA*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s*sw^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) + 
  EL^5*gFZW^2*gWWA*((2^(1 - 2*d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
    ...
    (aa*((-2 + d)*gZlL^2*(2*psq^2 + mm^2*(2*psq - s)) + 
     ...
     (2*Pi)^(2*d))*sw^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]] - 
  ((-2 + d)*EL^5*gFZW^2*gWWA*(gZlL^2 + gZlR^2)*(aa*mm^2 - bb*psq)*s*sw^2*
