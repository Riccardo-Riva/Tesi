...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(mm^2 - psq)*
      (2*psq^3 + psq^2*(s - 6*t) + 6*psq*t^2 + t*(s^2 - s*t - 2*t^2))*
      \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*
      gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*(-2*psq^3 + 6*psq^2*t - 
       3*psq*t*(s + 2*t) + mm^2*(psq^2 - s^2 + 2*psq*(s - t) + t^2) + 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
      mm^4*(6*psq^3 + s^2*(s + t) - 2*psq^2*(s + 6*t) + 
       mm^2*(-4*psq^2 - psq*s + s^2 + 8*psq*t - 3*s*t - 4*t^2) + 
       psq*(-3*s^2 + 6*s*t + 6*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
      mm^2*(mm^2 - psq)*(psq - t)*(-2*psq^2 + mm^2*(psq - s - t) + 4*psq*t - 
       t*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
      (-2*psq^3 + 4*psq^2*t + s*(-mm^2 + s)*t + psq*(mm^2*s + s^2 - 2*t^2))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      (mm^2*(psq - s - t) + s*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
     Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
      (4*psq^3 + mm^2*s^2 + s^3 - 6*s*t^2 - 4*t^3 - 4*psq^2*(s + 3*t) - 
       2*psq*(s^2 - 5*s*t - 6*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
     (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (mm^2 - psq)*(4*psq^2 + s^2 + 2*mm^2*(psq - s - t) + 3*s*t + 2*t^2 - 
       3*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (-6*psq^3 + 2*mm^4*(psq - s - t) + (s + t)^2*(s + 2*t) + 
       2*psq^2*(3*s + 7*t) - 5*psq*(s^2 + 3*s*t + 2*t^2) + 
       mm^2*(psq^2 + s^2 + 2*psq*(s - 2*t) + 4*s*t + 3*t^2))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (2*psq^3 + 3*psq^2*(s - 2*t) + mm^4*(psq - t) + 
       mm^2*(-2*psq^2 - 3*psq*s + s^2 + 3*psq*t - t^2) - 
       t*(s^2 + 3*s*t + 2*t^2) + psq*(-s^2 + 2*s*t + 6*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
      (-2*psq^2 + 2*mm^2*s + 5*psq*s - 2*s^2 + 4*psq*t - 3*s*t - 2*t^2)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
      mm^2*(mm^2 - psq)*(psq^2 + psq*(s - 2*t) + t*(s + t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (6*psq^3 + mm^4*(psq - t) + 2*psq*t*(3*s + 5*t) - psq^2*(s + 14*t) - 
       t*(s^2 + 3*s*t + 2*t^2) - mm^2*(4*psq^2 + s^2 + 2*s*t + 3*t^2 - 
         psq*(s + 7*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (mm^4*s + mm^2*(psq^2 - 3*psq*s - s^2 - 2*psq*t + 2*s*t + t^2) - 
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      ...
      (gZlL - gZlR)*mm^2*(psq - t)*(-2*psq^2 + mm^2*(4*psq - 3*s - 4*t) - 
       2*t*(s + t) + psq*(s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*
      (gZlL - gZlR)*mm^2*(-(mm^2*(psq^2 - s^2 + 2*psq*(s - t) - 2*s*t + 
          t^2)) + s*(3*psq^2 + t^2 - psq*(s + 4*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (2*psq^3 + mm^2*psq*s - 2*psq^2*(s + 4*t) + 2*psq*t*(4*s + 5*t) - 
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
      (4*psq^3 + mm^2*s^2 - 4*psq^2*(s + 3*t) + 2*psq*t*(5*s + 6*t) - 
       2*t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*
