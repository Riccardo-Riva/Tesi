...
(PropList[KiraPropagator[q1, mh], KiraPropagator[-p3 + q1, mm], 
  ...
  (-((2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^6*t*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(2*d)*s)) + 
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^6*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*
     gXll^2*mh^2*mm^6*t^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^6*t*(s + 4*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^6*t*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*
     mh^2*mm^6*(s + 4*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) - 
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*t*(mm^2 + s + t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*(mm^2*s + (s + t)^2)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXX*gXll^2*mh^2*mm^4*t*\[Mu]^(8 - 2*d)*
