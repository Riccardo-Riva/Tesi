...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  ((2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^4*t*(s + t)*(2*mm^2 + s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^4*t^2*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^4*t*(s^2 + 3*s*t + 2*t^2)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^4*(s + t)*(2*mm^2 + s + t)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^4*(s + t)*
     ...
     (s + t)*(2*mm^2 + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFFA*gFll^4*mm^6*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFFA*gFll^4*mm^4*(mm^2*s + (s + t)^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFFA*gFll^4*mm^6*t*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^4*mm^4*(mm^2*s + (s + t)^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^4*mm^4*t^2*\[Mu]^(8 - 2*d)*
