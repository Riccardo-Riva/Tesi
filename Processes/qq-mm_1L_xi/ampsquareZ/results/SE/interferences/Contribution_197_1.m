...
(PropList[KiraPropagator[q1, ms], KiraPropagator[-p1 - p2 + q1, ms]]*
  (((-3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*ms^2*
    ...
    (Pi^d*(mzC^2 - s)*s^2) - ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*
     (-(gZlRC*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) - 
      gZlLC*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) + 
      gZlLC*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
      gZlRC*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
     SPList[SP[p1, q1]])/(Pi^d*(mzC^2 - s)*s^2) - 
   ((3*I)*2^(2 - d)*EL^6*gAd^2*gAl*gAu*
     (-(gZlRC*gZuLC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2)) - 
      gZlLC*gZuRC*((8 - 6*d + d^2)*s^2 + 2*(4 - 5*d + d^2)*s*t - 4*t^2) + 
      gZlLC*gZuLC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2) + 
      gZlRC*gZuRC*((-2 + d)^2*s^2 + 2*(8 - 5*d + d^2)*s*t + 4*t^2))*
   ...
   ((3*I)*2^(4 - d)*EL^6*gAd^2*gAl*gAu*(d*gZlRC*(gZuLC - gZuRC)*s + 
   ...
   ((3*I)*2^(5 - d)*EL^6*gAd^2*gAl*gAu*(gZlLC + gZlRC)*(gZuLC + gZuRC)*
