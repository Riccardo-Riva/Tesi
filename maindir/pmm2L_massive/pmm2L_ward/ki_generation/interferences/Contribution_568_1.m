...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   ((I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*s*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*
      (aa*(psq + s - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
      (aa*(2*psq^2 + psq*(s - 2*t) - s*(s + t)) + 
       bb*(-2*psq^2 + s*(-2*mm^2 + s + t) + psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
      (mm^2 - psq)*(aa*(psq - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
      (aa*(-2*psq^2 + 2*mm^2*s - psq*s + 2*psq*t + s*t) + 
       bb*(2*psq^2 - s*t - psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gXll^4*
      mm^6*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*s*(-2*psq + s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*s*
      (bb*(mm^2 + psq - s - t) + aa*(mm^2 - psq + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*
      (mm^2 - psq)*s*(bb*(3*mm^2 + psq - s - t) + aa*(3*mm^2 - psq + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^6*s*(bb*(mm^2 + psq - s - 2*t) + 
       aa*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
     Pi^(2*d) + (I*2^(3 - 2*d)*aa*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^6*(bb*(mm^2 - psq - s) + 
    ...
    (I*4^(1 - d)*aa*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*
      (-(bb*(mm^2*(3*psq - s - 3*t) + (psq - s)*(psq - s - t))) + 
       aa*(psq^2 + mm^2*(3*psq + s - 3*t) + s*(s + t) - psq*(4*s + t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(psq - s - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^6*(aa*(mm^2 - psq - s) + 
       bb*(mm^2 - psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(-(aa*psq*s) + aa*mm^2*(psq + s - t) + 
       bb*mm^2*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(2*psq - s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/Pi^(2*d) + 
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*
      (aa*(2*psq^2 + psq*(3*s - 2*t) - s*(2*mm^2 + s + t)) + 
       bb*(-2*psq^2 + s*(-2*mm^2 + s + t) + psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(aa*(mm^2 + psq)*(psq - t) - 
       bb*mm^2*(psq + s - t) + bb*psq*(-psq + s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*bb*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(bb*psq*s + bb*mm^2*(psq - 2*s - t) + 
       aa*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*
      (mm^2 - psq)*(aa*(psq - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
    (I*4^(1 - d)*bb*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*
      (aa*(mm^2*(3*psq - 2*s - 3*t) + (psq - s)*(psq - t)) - 
       bb*(psq^2 + psq*s + mm^2*(3*psq - 4*s - 3*t) - psq*t + s*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(bb*psq*s + bb*mm^2*(psq - 2*s - t) + 
       aa*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/
     Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*
      (bb*(-2*psq^2 - 2*mm^2*s + 3*psq*s + 2*psq*t + s*t) + 
       aa*(2*psq^2 + psq*(s - 2*t) - s*(2*mm^2 + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(aa*psq*(psq - t) + 
    ...
    (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*s*
    ...
    (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*s*(bb*(mm^2 + psq - s - 2*t) + 
       ...
       SP[q2, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - s - t) + 
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(-psq + s + t)*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(mm^2 - t) + 
      ...
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa + bb)*EL^5*gAl*gXll^4*mm^4*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(bb*(2*mm^2 - psq - t) + 
      ...
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*
      (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q2]])/
     Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(psq - t)*
