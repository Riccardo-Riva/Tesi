...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s^2*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s^2*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s^2*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*(s + t)*
  ...
  ((3*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*
    (s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*(s + 2*t)*
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    (gZlL^2 + gZlR^2)*s*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    (gZlL^2 + gZlR^2)*s*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*(s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    (gZlL^2 + gZlR^2)*s*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[q1, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    (gZlL^2 + gZlR^2)*s*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*s*(s + 2*t)*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(s + t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(3*s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[q1, q2]])/
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    (gZlL^2 + gZlR^2)*t*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], 
     SP[p2, q1]])/Pi^(2*d) - (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    (gZlL^2 + gZlR^2)*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(s + 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(s + 4*t)*
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*t*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[q1, q2]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*t*
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(s + 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    (gZlL^2 + gZlR^2)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q2, q2]])/Pi^(2*d) - (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    (gZlL^2 + gZlR^2)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], 
     SP[p2, q2]])/(4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    (gZlL^2 + gZlR^2)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p3, q2]])/(4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*
  ...
  (I*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(s + 2*t)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*
    ...
    (gZlL^2 + gZlR^2)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggmgmA*
