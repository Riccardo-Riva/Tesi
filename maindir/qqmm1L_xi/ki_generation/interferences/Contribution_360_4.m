...
(PropList[KiraPropagator[q1, mh], KiraPropagator[-p1 - p2 + q1, 
  ...
  ((I*4^(1 - d)*EL^6*gHXZ^2*s*
   ...
   (I*2^(3 - d)*EL^6*gHXZ^2*(gZlR*gZlRC*(-((-2 + d)*gZuL*gZuLC) + 
   ...
   (I*2^(3 - d)*EL^6*gHXZ^2*(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
