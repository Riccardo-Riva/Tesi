...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 (-((2^(-1 - 2*d)*EL^5*gAl^3*mm^2*s*
     (bb*((-2 + d)*gZlL^2*((-2 + d)*mm^4 - 2*(-4 + d)*psq^2 + (6 + d)*psq*s - 
      ...
      aa*(-2*gZlL*gZlR*(psq*(2*(-2 + d)^2*psq - (4 - 6*d + d^2)*s) + 
        ...
        (-2 + d)*gZlR^2*((-2 + d)*mm^4 + mm^2*((-6 + 5*d)*psq - 
            2*(-1 + d)*s) + 2*((-4 + d)*psq^2 - 3*psq*s + s^2))))*
     \[Mu]^(8 - 2*d))/Pi^(2*d)) + 
  (EL^5*gAl^3*(aa*(-(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
         (2*(-2 + d)^2*psq^2 + (4 + 10*d - d^2)*psq*s - 2*d*s^2 + 
          mm^2*(4*(-2 + d)^2*psq - (8 - 4*d + d^2)*s))) + 
       (-2 + d)*gZlL^2*(2*Pi)^(2*d)*(psq*s*((-4 + d)*psq + 2*s) + 
  ...
  (EL^5*gAl^3*mm^2*(aa*(4^(1 + d)*d*gZlL*gZlR*Pi^(2*d)*psq*(2*mm^2 + s) - 
  ...
  (EL^5*gAl^3*s*(bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
  ...
  (EL^5*gAl^3*mm^2*s*(bb*(4^(1 + d)*d*gZlL*gZlR*Pi^(2*d)*(2*mm^2 + psq) - 
  ...
  (2^(-1 - 4*d)*EL^5*gAl^3*s*
    ...
    (gZlL^2 + gZlR^2)*mm^2*s*(aa*((-4 + d)*mm^2 + (-4 + 3*d)*psq - 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*(bb*mm^2*(-4*d*gZlL*gZlR*mm^2 + 
  ...
  (2^(1 - 2*d)*EL^5*gAl^3*
   ...
   Pi^(2*d) - 
  (EL^5*gAl^3*(bb*(-(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
         (2*mm^2 + 2*psq + s)) + (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
        ((-4 + d)*mm^4 + 4*psq*s + mm^2*((4 - 3*d)*psq + 2*(-7 + 2*d)*s)) + 
     ...
     aa*(4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*mm^2 + 2*psq + s) - 
       (-2 + d)*gZlL^2*(2*Pi)^(2*d)*((-4 + d)*mm^4 + d*psq*s + 
         mm^2*((4 - 3*d)*psq + (-10 + 3*d)*s)) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
        ((-4 + d)*mm^4 + d*psq*s + mm^2*((4 - 3*d)*psq + (-10 + 3*d)*s))))*
  ...
  ((2 - d)*EL^5*gAl^3*
    (bb*(gZlL^2*(2*Pi)^(2*d)*((-4 + d)*psq^2 + mm^2*((-4 + d)*psq - 2*s)) + 
     ...
     aa*(-(gZlL^2*(2*Pi)^(2*d)*psq*((-4 + d)*mm^2 + (-4 + d)*psq - 2*s)) - 
       ...
       4^(1 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*((-2 + d)*psq - s)))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^5*gAl^3*(gZlL^2 + gZlR^2)*mm^2*(bb*mm^2 - aa*psq)*
  ...
  (EL^5*gAl^3*(aa*(2^(3 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*psq - 
  ...
  ((-2 + d)*EL^5*gAl^3*(aa*(2*(-6 + d)*gZlL*gZlR*mm^2 + 
       gZlL^2*(-((-6 + d)*mm^2) + 2*psq) + gZlR^2*(-((-6 + d)*mm^2) + 
         2*psq)) + bb*(-2*(-6 + d)*gZlL*gZlR*mm^2 + 
  ...
  (EL^5*gAl^3*(-(aa*(4*d*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*
         ((-6 + d)*mm^2 - 2*psq) + (-2 + d)*gZlR^2*((-6 + d)*mm^2 - 
          2*psq))) + bb*(4*d*gZlL*gZlR*mm^2 + (-2 + d)*gZlL^2*
        (-2*mm^2 + (-6 + d)*psq) + (-2 + d)*gZlR^2*(-2*mm^2 + (-6 + d)*psq)))*
