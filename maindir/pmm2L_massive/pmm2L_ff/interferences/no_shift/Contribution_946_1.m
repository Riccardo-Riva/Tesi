...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, 0]]*
   ((4^(1 - d)*EL^6*gAl^3*gAu*mm^2*(gZlL^2*((-28 + 23*d - 5*d^2)*psq^3 + 
         2*psq^2*((6 - 9*d + 2*d^2)*s + (32 - 27*d + 6*d^2)*t) + 
         (s + t)*((-4 + d)*s^2 + 2*(2 - 4*d + d^2)*s*t + 2*(-2 + d)^2*t^2) - 
     ...
     (mz^2*Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*
      (-2*gZlL*gZlR*((4 + 3*d - d^2)*psq^3 + (8 - 5*d + d^2)*mm^2*
          (psq - t)^2 - psq^2*((12 - 5*d + d^2)*s + 2*(2 + 7*d - 2*d^2)*t) + 
         psq*((-2 + d)*s^2 + (12 + 3*d - d^2)*s*t + (-4 + 19*d - 5*d^2)*
            t^2) + t*((-6 + d)*s^2 + 2*(-4 + d)*d*s*t + 2*(2 - 4*d + d^2)*
            t^2)) + gZlL^2*(-((4 - 3*d + d^2)*psq^3) + (4 - 5*d + d^2)*mm^2*
          (psq - t)^2 + psq^2*(d*(5*s - 14*t) - d^2*(s - 4*t) + 16*t) + 
         ...
         (4 - 5*d + d^2)*mm^2*(psq - t)^2 + psq^2*(d*(5*s - 14*t) - 
           d^2*(s - 4*t) + 16*t) + psq*((-4 + d)*s^2 - (12 - 3*d + d^2)*s*t + 
           (-20 + 19*d - 5*d^2)*t^2) + t*(2*d^2*t*(s + t) + 4*t*(3*s + 2*t) + 
           d*(s^2 - 8*s*t - 8*t^2))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
     (mz^2*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*
      (gZlL^2*(-2*(-2 + d)^2*psq^3 + (-4 + d)*s^3 + (-4 - 2*d + d^2)*s^2*t + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(psq^2 - 2*psq*t + t*(s + t))*
     ...
     (mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^3*gAu*
      (-2*gZlL*gZlR*(4*mm^4*(psq - s - t) - 2*(-4 + d)*psq*
          (psq^2 - 2*psq*t + t*(s + t)) + mm^2*((-8 - 3*d + d^2)*psq^2 + 
           psq*((-2 + 9*d - 2*d^2)*s - 2*(-6 - 3*d + d^2)*t) + 
           (s + t)*((2 - 4*d + d^2)*s + (-4 - 3*d + d^2)*t))) + 
       gZlL^2*(4*mm^4*(-psq + s + t) - 2*(-2 + d)*psq*(psq^2 - 2*psq*t + 
           t*(s + t)) + mm^2*((8 - 3*d + d^2)*psq^2 + 
           (s + t)*((-2 + d)^2*s + (4 - 3*d + d^2)*t) - 
           psq*((16 - 9*d + 2*d^2)*s + 2*(6 - 3*d + d^2)*t))) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*(gZlL^2*((4 - 5*d + d^2)*mm^4*(psq - t) + 
         mm^2*(-2*(-8 - d + d^2)*psq^2 + (-14 + 2*d + d^2)*psq*s - 
           (-2 + d)*s^2 + (-12 - 13*d + 5*d^2)*psq*t + (-10 + 12*d - 3*d^2)*s*
            t + (-4 + 11*d - 3*d^2)*t^2) + psq*(-2*(8 - 6*d + d^2)*psq^2 + 
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(-2*gZlL*gZlR*(2*(8 - 6*d + d^2)*psq^3 + 
         2*(8 - 5*d + d^2)*mm^4*s - 2*(-4 + d)*t*(s + t)*
          ((-3 + d)*s + (-2 + d)*t) - psq^2*((28 - 18*d + 3*d^2)*s + 
           6*(8 - 6*d + d^2)*t) + psq*((-2 + d)^2*s^2 + (68 - 44*d + 7*d^2)*s*
            t + 6*(8 - 6*d + d^2)*t^2) - mm^2*(4*(10 - 7*d + d^2)*psq^2 - 
       ...
       gZlL^2*(2*(4 - 5*d + d^2)*mm^4*s - mm^2*(4*(8 - 5*d + d^2)*psq^2 + 
         ...
         mm^2*(4*(8 - 5*d + d^2)*psq^2 + (20 - 8*d + d^2)*s^2 + 
           (68 - 32*d + 5*d^2)*s*t + 4*(8 - 5*d + d^2)*t^2 - 
           psq*((60 - 22*d + 3*d^2)*s + 8*(8 - 5*d + d^2)*t)) + 
     ...
     (mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*
      (2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4*(psq - t) + 
       ...
       gZlL^2*(-((8 - 5*d + d^2)*mm^4*(psq - t)) + 
         mm^2*(2*(-4 - 2*d + d^2)*psq^2 + (-4 + d)*s^2 + (8 - 13*d + 3*d^2)*s*
            t + (8 - 13*d + 3*d^2)*t^2 - psq*((-20 + 3*d + d^2)*s + 
    ...
    (2^(3 - 2*d)*EL^6*gAl^3*gAu*(-2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4*s + 
         mm^2*(-2*(10 - 6*d + d^2)*psq^2 + (32 - 12*d + d^2)*psq*s + 
           2*(-7 + 2*d)*s^2 + 4*(10 - 6*d + d^2)*psq*t + (-36 + 17*d - 2*d^2)*
            s*t - 2*(10 - 6*d + d^2)*t^2) + s*(-((6 - 5*d + d^2)*psq^2) + 
           (10 - 6*d + d^2)*psq*s + (2 - 4*d + d^2)*psq*t - 
           (-4 + d)*t*(s + t))) + gZlL^2*((8 - 5*d + d^2)*mm^4*s + 
         mm^2*(-2*(8 - 6*d + d^2)*psq^2 + (22 - 12*d + d^2)*psq*s + 
           2*(-5 + 2*d)*s^2 + 4*(8 - 6*d + d^2)*psq*t + (-30 + 17*d - 2*d^2)*
            s*t - 2*(8 - 6*d + d^2)*t^2) - (-2 + d)*s*((-3 + d)*psq^2 + 
           t*(s + t) - psq*((-4 + d)*s + (-2 + d)*t))) + 
       gZlR^2*((8 - 5*d + d^2)*mm^4*s + mm^2*(-2*(8 - 6*d + d^2)*psq^2 + 
           (22 - 12*d + d^2)*psq*s + 2*(-5 + 2*d)*s^2 + 4*(8 - 6*d + d^2)*psq*
            t + (-30 + 17*d - 2*d^2)*s*t - 2*(8 - 6*d + d^2)*t^2) - 
