...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  ((3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mm^2*mt^2*
     (-4*mm^4 + (-6 + d)*s^2 + 8*mm^2*t - 4*s*t - 4*t^2))/(Pi^(2*d)*s^2) + 
   (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*mt^2*(-2*(2 + d)*mm^4 + (-10 + 3*d)*s^2 + 
   ...
   (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*mt^2*((-4 + 6*d)*mm^4 + 2*(-2 + d)*s^2 + 
   ...
   (3*2^(5 - 2*d)*EL^8*gAl^4*gAu^4*mt^2*(-4*d*mm^2 + 18*s - 9*d*s + d^2*s)*
   ...
   (3*4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^4*mt^2*(4*mm^4 + (-4 + d)*s^2 - 
   ...
   (3*2^(7 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^4*mt^2*SPList[SP[p3, q1], 
