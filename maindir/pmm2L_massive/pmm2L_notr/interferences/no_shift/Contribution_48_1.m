  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(mm^2 - psq)*((-6 + d)*mm^2 - (-2 + d)*psq)*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*(-4 + d)*mm^4*s + psq*(4*psq^2 + (-4 + d)*s^2 + 2*psq*(d*s - 4*t) + 
        4*s*t + 4*t^2) + mm^2*(12*psq^2 + (-4 + 3*d)*s^2 + 12*s*t + 12*t^2 - 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
     ...
     gXll*(gZlL - gZlR)*mm^2*(mm^2*(2*psq + (-4 + d)*s - 2*t) + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
     ...
     gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*(2*psq + (-5 + d)*s - 2*t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     ...
     gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*(2*psq - (-4 + d)*s - 2*t)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
