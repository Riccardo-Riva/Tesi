...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (-((4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*(mm^2 + psq)*
    ...
    psq*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*
    (psq*(psq - t) + mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*(4*psq^2 + s^2 + psq*(s - 6*t) + 
     3*s*t + 2*t^2 + 2*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(4^d*Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*psq*(-2*psq + s + 2*t)*
  ...
  (EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*(4*psq^2 + s^2 + 3*s*t + 2*t^2 + 
  ...
  (EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq*(5*s - 2*t) + 
  ...
  (EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*(psq*(s - 2*t) + 
     2*mm^2*(psq - t) + t*(s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*(4*psq^2 + 6*mm^2*s - 6*psq*s + 
     5*s^2 - 8*psq*t + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*(4*psq^2 + 2*mm^2*s + 
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*(-psq + s + t)*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*
    ...
    gFll^2*gZNL*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*
    gZNL*mm^2*psq*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*(4*mm^2 - 4*psq + s)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*gFll^2*gZNL*mm^2*
    ...
    gZNL*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFFZ*
