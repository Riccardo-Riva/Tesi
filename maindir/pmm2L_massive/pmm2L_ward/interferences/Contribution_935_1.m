...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, mz], 
  ...
  ((I*2^(-3 - 2*d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
   ...
   (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     ...
     SPList[SP[p1, p2], SP[p2, q1]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (aa*(4*mm^2 + 2*psq - s - 6*t) + bb*(-6*psq + s + 6*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p2, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
   ...
   (I*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     ...
     SPList[SP[p1, q2], SP[p2, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*(psq - t)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     (gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[q1, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
    ...
    ((mh^2 - mz^2)*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*
     ...
     SPList[SP[p2, q1], SP[q2, q2]])/(2^(2*(1 + d))*(mh^2 - mz^2)*Pi^(2*d)) - 
   (I*4^(-1 - d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (aa*(2*mm^2 - psq + s - t) - bb*(psq + s - t))*\[Mu]^(8 - 2*d)*
  ...
  ((I*2^(-3 - 2*d)*EL^5*gAl*ggpgpZ*gHgpgp*gHll*(gZlL + gZlR)*mm^2*
     (aa*s*(5*psq - 2*s - 5*t) - 2*aa*mm^2*(psq - t) + 
