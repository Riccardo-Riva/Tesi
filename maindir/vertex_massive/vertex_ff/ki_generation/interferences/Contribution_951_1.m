...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (-((4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*mm^2*
        (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
         t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/(mz^2*Pi^(2*d)*s)) + 
     (4^(1 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*
      ...
      (mz^2*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*
       (gZlL^2*((4 - 3*d + d^2)*psq^3 - 2*psq^2*((-6 + d)*s + (-4 + 3*d)*t) + 
          psq*((10 - 8*d + d^2)*s^2 - 2*(-4 + d)^2*s*t + (-28 + 21*d - 3*d^2)*
            ...
            (12 - 5*d + d^2)*t*(s + t))) + gZlR^2*((4 - 3*d + d^2)*psq^3 - 
        ...
        2*gZlL*gZlR*(4*(psq^3 - 7*psq^2*t + (s - 5*t)*(s + t)^2 + 
     ...
     (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*
       (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
     ...
     (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*mm^2*
      ...
      (mz^2*Pi^(2*d)*s) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*
       (gZlL + gZlR)^2*ml^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(mz^2*Pi^(2*d)*s) + 
     (2^(3 - 2*d)*EL^6*gAl^3*gAu*(gZlL^2*(4*mm^4*(psq - s - t) + 
          2*(-2 + d)*psq*(psq^2 - 2*psq*t + t*(s + t)) + 
          mm^2*((4 - 7*d + d^2)*psq^2 - psq*((8 - 11*d + 2*d^2)*s + 
              2*(6 - 7*d + d^2)*t) + (s + t)*((8 - 6*d + d^2)*s + 
              (8 - 7*d + d^2)*t))) + gZlR^2*(4*mm^4*(psq - s - t) + 
          2*(-2 + d)*psq*(psq^2 - 2*psq*t + t*(s + t)) + 
          mm^2*((4 - 7*d + d^2)*psq^2 - psq*((8 - 11*d + 2*d^2)*s + 
              2*(6 - 7*d + d^2)*t) + (s + t)*((8 - 6*d + d^2)*s + 
              (8 - 7*d + d^2)*t))) + 2*gZlL*gZlR*(4*mm^4*(psq - s - t) - 
          2*(-4 + d)*psq*(psq^2 - 2*psq*t + t*(s + t)) - 
          mm^2*((20 - 7*d + d^2)*psq^2 + (s + t)*((10 - 6*d + d^2)*s + 
              (16 - 7*d + d^2)*t) - psq*((22 - 11*d + 2*d^2)*s + 
              2*(18 - 7*d + d^2)*t))))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q2]])/(mz^2*Pi^(2*d)*s) - 
     (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*(mm^2 - psq)*
      ...
      (mz^2*Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*
       (gZlL^2*((4 - 5*d + d^2)*mm^4*(psq - t) + 
          psq*(-2*(8 - 6*d + d^2)*psq^2 + (2 - 5*d + d^2)*psq*s + 2*s^2 + 
            ...
            (-4 + d)*s^2 + (26 - 18*d + 3*d^2)*s*t + (32 - 19*d + 3*d^2)*
             t^2 - psq*((2 - 4*d + d^2)*s + (84 - 47*d + 7*d^2)*t))) + 
     ...
     (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*
       ...
       (-2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4*(psq - t) + (-4 + d)*mm^2*
           (2*(-5 + 2*d)*psq^2 + s^2 + (-5 + 3*d)*s*t + (-5 + 3*d)*t^2 + 
            ...
            (-2 + d)*(s + t)*(s + 2*(-3 + d)*t) + psq*((6 - 4*d + d^2)*s + 
              4*(6 - 5*d + d^2)*t))) + gZlL^2*((8 - 5*d + d^2)*mm^4*
           (psq - t) + mm^2*((44 - 26*d + 4*d^2)*psq^2 + (-2 + d)*s^2 + 
            (28 - 17*d + 3*d^2)*s*t + (28 - 17*d + 3*d^2)*t^2 - 
            psq*((8 - 5*d + d^2)*s + (72 - 43*d + 7*d^2)*t)) - 
          psq*(2*(6 - 5*d + d^2)*psq^2 + (s + t)*((-4 + d)*s + 
              2*(6 - 5*d + d^2)*t) - psq*(24*t + d^2*(s + 4*t) - 
              4*d*(s + 5*t)))) + gZlR^2*((8 - 5*d + d^2)*mm^4*(psq - t) + 
          mm^2*((44 - 26*d + 4*d^2)*psq^2 + (-2 + d)*s^2 + 
            (28 - 17*d + 3*d^2)*s*t + (28 - 17*d + 3*d^2)*t^2 - 
            psq*((8 - 5*d + d^2)*s + (72 - 43*d + 7*d^2)*t)) - 
          psq*(2*(6 - 5*d + d^2)*psq^2 + (s + t)*((-4 + d)*s + 
              2*(6 - 5*d + d^2)*t) - psq*(24*t + d^2*(s + 4*t) - 
     ...
     (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*(psq - t)^2*
     ...
     (2^(3 - 2*d)*EL^6*gAl^3*gAu*(psq - t)*
       ...
       (gZlL + gZlR)^2*ml^2*(psq - t)^2*\[Mu]^(8 - 2*d)*
     ...
     (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*
       ...
       (2*gZlL*gZlR*(-((-5 + d)*d*psq*(psq - s - t)) + (-2 + d)*mm^2*
        ...
        gZlL^2*((4 - 5*d + d^2)*psq*(psq - s - t) + 
          mm^2*(-((14 - 7*d + d^2)*psq) + (10 - 6*d + d^2)*s + 
            (14 - 7*d + d^2)*t)) + gZlR^2*((4 - 5*d + d^2)*psq*
           (psq - s - t) + mm^2*(-((14 - 7*d + d^2)*psq) + (10 - 6*d + d^2)*
             s + (14 - 7*d + d^2)*t)))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)*s) - 
     (2^(3 - 2*d)*EL^6*gAl^3*gAu*(-2*gZlL*gZlR*((8 - 6*d + d^2)*psq^2 + 
          4*s^2 - 6*d*s^2 + d^2*s^2 + 4*s*t - 10*d*s*t + 2*d^2*s*t - 
          4*d*t^2 + d^2*t^2 + 2*mm^2*((-4 + d)*psq + 6*s - 2*d*s + 4*t - 
            d*t) - 2*psq*((8 - 7*d + d^2)*s + (4 - 5*d + d^2)*t)) + 
      ...
      (mz^2*Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl^3*gAu*
       (-2*gZlL*gZlR*(-((-5 + d)*d*psq*(psq - s - t)) + 
        ...
        gZlL^2*(-((4 - 5*d + d^2)*psq*(psq - s - t)) + 
          mm^2*((14 - 7*d + d^2)*psq - (10 - 6*d + d^2)*s - 
            (14 - 7*d + d^2)*t)) + gZlR^2*
         (-((4 - 5*d + d^2)*psq*(psq - s - t)) + mm^2*((14 - 7*d + d^2)*psq - 
            (10 - 6*d + d^2)*s - (14 - 7*d + d^2)*t)))*\[Mu]^(8 - 2*d)*
   ...
   PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, ml]]*((4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*
       (gZlL + gZlR)^2*ml^2*mm^2*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
        psq^2*(s + 6*t) + t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d))/
      (mz^2*Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*(gZlL + gZlR)^2*ml^2*
       (-(d*(psq - s - t)*(2*psq^2 + psq*(s - 4*t) + 2*t*(s + t) + 
           mm^2*(-4*psq + s + 4*t))) - 2*(-2*psq^3 + 3*psq^2*(s + 2*t) + 
          psq*(mm^2*s + s^2 - 9*s*t - 6*t^2) + (s + t)*(-(mm^2*s) + 
            2*t*(2*s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
