...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*
      ...
      \[Mu]^(8 - 2*d))/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gXll^2*
      (gZlL - gZlR)^2*ml^2*mm^2*(-psq + s + t)*(-2*psq^2 - 3*psq*(s - 2*t) + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(mm^2 - psq)*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*(gZlL - gZlR)^2*ml^2*mm^2*(psq - t)^2*
