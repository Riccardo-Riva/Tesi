   ...
   ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    ...
    (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*
      gHll*(gZlL + gZlR)*mh^2*mm^2*(4*psq^2 + 4*mm^2*s - 6*s^2 + 3*d*s^2 + 
       4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*
      gHll*(gZlL + gZlR)*mh^2*mm^2*(2*mm^2 - 2*psq + (-1 + d)*s)*
    ...
    (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*
      gHll*(gZlL + gZlR)*mh^2*mm^2*(-2*psq + d*s + 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*
      gHll*(gZlL + gZlR)*mh^2*mm^2*(2*mm^2 - 5*psq + 2*s + 3*t)*
    ...
    (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*
      gHll*(gZlL + gZlR)*mh^2*mm^2*(2*psq^2 + 2*(-2 + d)*mm^2*s - 
       psq*((-2 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFZ*gHFF*
      gHll*(gZlL + gZlR)*mh^2*mm^2*(2*psq^2 - 2*mm^2*(psq + 2*s - d*s - t) + 
