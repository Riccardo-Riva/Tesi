...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^6*gAl^2*gHll^2*mm^4*(2*(gZlL^2 + gZlR^2)*(mm^2*(4*psq - 7*s) + 
     ...
     (d^2*mm^2*(2*Pi)^(2*d)*(gZlL^2*(2*mm^2 - psq) + gZlR^2*(2*mm^2 - psq) - 
        2*gZlL*gZlR*psq) - 4^(1 + d)*Pi^(2*d)*(gZlL^2*mm^2*psq + 
        gZlR^2*mm^2*psq - gZlL*gZlR*(mm^2 + 3*psq)*s) - 
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll^2*mm^2*((-2 + d)*gZlL^2*mm^2*
       (2*mm^2 + psq + (-1 + d)*s) + (-2 + d)*gZlR^2*mm^2*
       (2*mm^2 + psq + (-1 + d)*s) - gZlL*gZlR*(-4*s*(mm^2 - psq + s) + 
        d^2*(mm^4 + psq*s + mm^2*(-psq + s)) + 
        d*(3*mm^4 + s*(-5*psq + 2*s) + mm^2*(3*psq + 5*s))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl^2*gHll^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^6*gAl^2*gHll^2*mm^2*(3*(-2 + d)*gZlL^2*mm^2 + 
      3*(-2 + d)*gZlR^2*mm^2 + gZlL*gZlR*((6 - 9*d + d^2)*mm^2 + 
        (2 + 3*d - d^2)*psq - 2*d*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*(d*(mm^2 + 3*psq - 8*s) + 
      16*s + d^2*(-psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHll^2*mm^2*((-2 + d)^2*gZlL^2*mm^2 + 
      (-2 + d)^2*gZlR^2*mm^2 + 2*gZlL*gZlR*((4 + 2*d - d^2)*mm^2 + 
        4*(-5 + d)*psq - 2*(-4 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*((8 - 9*d + 2*d^2)*mm^2 + 
      (-24 + 13*d - 2*d^2)*psq + (-4 + d)^2*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(-3 + d)*d*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll^2*mm^2*((-2 + d)^2*gZlL^2*mm^2 + 
   ...
   (2^(5 - 2*d)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*d*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*(-mm^2 + psq + 2*s)*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) - (2^(7 - 2*d)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*
   ...
   (2^(7 - 2*d)*EL^6*gAl^2*gHll^2*gZlL*gZlR*mm^2*\[Mu]^(8 - 2*d)*
