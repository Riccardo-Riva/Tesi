...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
  ...
  (-((2^(1 - 2*d)*EL^6*gAl^3*gAu*mm^2*t*(s + t)*
      (-4*d*gZlL*gZlR*mm^2*(s + 2*t) + gZlL^2*s*((12 - 8*d + d^2)*mm^2 - 
         2*(-4 + d)*(s + 2*t)) + gZlR^2*s*((12 - 8*d + d^2)*mm^2 - 
         2*(-4 + d)*(s + 2*t)))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) + 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*(s + t)*
     (4^(1 + d)*(-4 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*s + 
      gZlL^2*(2*Pi)^(2*d)*(4*t*((-2 + d)*s + d*t) + (-2 + d)*mm^2*
         (2*s + (-4 + 3*d)*t)) + gZlR^2*(2*Pi)^(2*d)*
       (4*t*((-2 + d)*s + d*t) + (-2 + d)*mm^2*(2*s + (-4 + 3*d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(Pi^(4*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*(s + t)*
     (gZlL^2*(2*Pi)^(2*d)*(-((-2 + d)*mm^2*((-2 + d)*s + 2*(2 + d)*t)) + 
        2*t*(2*(-4 + d)*s + (12 - 8*d + d^2)*t)) + gZlR^2*(2*Pi)^(2*d)*
       (-((-2 + d)*mm^2*((-2 + d)*s + 2*(2 + d)*t)) + 
        2*t*(2*(-4 + d)*s + (12 - 8*d + d^2)*t)) + 4^(1 + d)*gZlL*gZlR*
       Pi^(2*d)*(-2*s^2 + 4*mm^2*t + d^2*mm^2*t + 
        d*(s^2 + mm^2*(s - 4*t) - 2*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(Pi^(4*d)*s) + 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*t*
     (-(4^(1 + d)*(-4 + d)*gZlL*gZlR*mm^2*Pi^(2*d)*s) + 
      gZlL^2*(2*Pi)^(2*d)*(4*(s + t)*(2*s + d*t) - (-2 + d)*mm^2*
         (2*s + (4 + d)*t)) - gZlR^2*(2*Pi)^(2*d)*(-4*(s + t)*(2*s + d*t) + 
        (-2 + d)*mm^2*(2*s + (4 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(4*d)*s) - (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*t*
     (gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^2*((-2 + d)*s + 2*(2 + d)*t) + 
        2*(s + t)*((20 - 10*d + d^2)*s + (12 - 8*d + d^2)*t)) + 
      gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2*((-2 + d)*s + 2*(2 + d)*t) + 
        2*(s + t)*((20 - 10*d + d^2)*s + (12 - 8*d + d^2)*t)) - 
      4^(1 + d)*gZlL*gZlR*Pi^(2*d)*(d^2*mm^2*t + 2*(s^2 + 2*mm^2*t) + 
        d*(s^2 + mm^2*(s - 4*t) + 4*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/(Pi^(4*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*(4^(1 + d)*(-4 + d)*gZlL*gZlR*mm^2*
       Pi^(2*d)*s^2 + (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
       (mm^2*s*(2*s + (4 + d)*t) + 4*t*(s^2 + 3*s*t + 2*t^2)) + 
      (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2*s*(2*s + (4 + d)*t) + 
        4*t*(s^2 + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    (Pi^(4*d)*s) + (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*((-2 + d)*s + 2*(2 + d)*t)) - 
      (-2 + d)*gZlR^2*mm^2*(2*Pi)^(2*d)*((-2 + d)*s + 2*(2 + d)*t) + 
      4^(1 + d)*gZlL*gZlR*Pi^(2*d)*(d*mm^2*(s - 4*t) + d^2*mm^2*t + 
        d*s*(s + 2*t) - 2*(s^2 - 2*mm^2*t + 2*s*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/Pi^(4*d) + (2^(1 - 2*d)*EL^6*gAl^3*gAu*t*(s + t)*
     (-4*d*gZlL*gZlR*mm^2*(s + 2*t) + (-4 + d)*gZlL^2*s*
       ((-6 + d)*mm^2 - 2*(s + 2*t)) + (-4 + d)*gZlR^2*s*
       ((-6 + d)*mm^2 - 2*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*t*(s + t)*
     (-4*d*gZlL*gZlR*mm^2*(s + 2*t) + gZlL^2*(-((-4 + d)*s*(s + 2*t)) + 
        mm^2*((20 - 10*d + d^2)*s + (16 - 10*d + d^2)*t)) + 
      gZlR^2*(-((-4 + d)*s*(s + 2*t)) + mm^2*((20 - 10*d + d^2)*s + 
          (16 - 10*d + d^2)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gZlL*gZlR*mm^2*t*
     (s^2 + 3*s*t + 2*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAl^3*gAu*(s + t)*
     (d*(gZlL^2*t*(mm^2 + s + t) + gZlR^2*t*(mm^2 + s + t) + 
        2*gZlL*gZlR*mm^2*(mm^2 + s + 2*t)) - (gZlL^2 + gZlR^2)*
       (2*t*(2*s + t) + mm^2*(s + 4*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*(s + t)*
     (-2*gZlL*gZlR*mm^2*((4 - 8*d + d^2)*mm^2 - 3*d*s + 4*t - 7*d*t) + 
      gZlL^2*(2*(-2 + d)*mm^4 + 2*t*((-4 + d)*s + (-2 + d)*t) + 
        mm^2*((-4 + d)*s + (-10 + 3*d)*t)) + 
      gZlR^2*(2*(-2 + d)*mm^4 + 2*t*((-4 + d)*s + (-2 + d)*t) + 
        mm^2*((-4 + d)*s + (-10 + 3*d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*(4*d*gZlL*gZlR*mm^2*(-s^2 + mm^2*t - 2*s*t) + 
      gZlL^2*(-2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) + 
        mm^2*((-2 + d)*s^2 - (-4 + d)*s*t - 2*(-4 + d)*t^2)) + 
      gZlR^2*(-2*(-2 + d)*t*(s^2 + 3*s*t + 2*t^2) + 
        mm^2*((-2 + d)*s^2 - (-4 + d)*s*t - 2*(-4 + d)*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*(-4*gZlL*gZlR*mm^2*((8 - 3*d)*s^2 + 
        (16 - 5*d)*s*t + t*(2*d*mm^2 + 12*t - d*t)) + 
      gZlL^2*((8 - 6*d + d^2)*mm^4*t + 4*(-2 + d)*t*(s + t)^2 + 
        2*mm^2*(-((-2 + d)*s^2) + (-4 + d)^2*s*t + (18 - 9*d + d^2)*t^2)) + 
      gZlR^2*((8 - 6*d + d^2)*mm^4*t + 4*(-2 + d)*t*(s + t)^2 + 
        2*mm^2*(-((-2 + d)*s^2) + (-4 + d)^2*s*t + (18 - 9*d + d^2)*t^2)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl^3*gAu*(-((gZlL^2 + gZlR^2)*(2*s + t)*
        (mm^2*s + 2*t*(s + t))) + d*(gZlL^2*t*(s + t)^2 + 
        gZlR^2*t*(s + t)^2 + 2*gZlL*gZlR*mm^2*(mm^2*s + 2*s^2 + 5*s*t + 
          2*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*
     (4*gZlL*gZlR*mm^2*(4*s*t + d*(2*mm^2*s + 3*s^2 + 6*s*t + 2*t^2)) + 
      gZlL^2*(-((8 - 6*d + d^2)*mm^4*s) + 2*(-4 + d)*s*t*(s + t) + 
        mm^2*(2*(-4 + d)*s^2 + (-16 + 4*d + d^2)*s*t + (-2 + d)*d*t^2)) + 
      gZlR^2*(-((8 - 6*d + d^2)*mm^4*s) + 2*(-4 + d)*s*t*(s + t) + 
        mm^2*(2*(-4 + d)*s^2 + (-16 + 4*d + d^2)*s*t + (-2 + d)*d*t^2)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*(s + t)*
     (4*t*((-2 + d)*s + d*t) + (-2 + d)*mm^2*(2*s + (-8 + 3*d)*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*(s + t)*(2*d*gZlL*gZlR*mm^2*(s + 2*t) + 
      gZlL^2*(t*((-8 + 3*d)*s + 2*(2 + d)*t) + 
        mm^2*(-2*s + (8 - 6*d + d^2)*t)) + 
      gZlR^2*(t*((-8 + 3*d)*s + 2*(2 + d)*t) + 
        mm^2*(-2*s + (8 - 6*d + d^2)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(s + t)*(4^(1 + d)*(-2 + d)^2*gZlL*gZlR*mm^2*
       Pi^(2*d)*(s + 2*t) + gZlL^2*(2*Pi)^(2*d)*
       (mm^2*(-((20 - 8*d + d^2)*s) + (16 - 10*d + d^2)*t) + 
        2*t*((28 - 10*d + d^2)*s + (24 - 8*d + d^2)*t)) + 
      gZlR^2*(2*Pi)^(2*d)*(mm^2*(-((20 - 8*d + d^2)*s) + (16 - 10*d + d^2)*
           t) + 2*t*((28 - 10*d + d^2)*s + (24 - 8*d + d^2)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(4*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*(s + t)*
     ((-2 + d)^2*gZlL^2*(2*mm^2 + s + t) + (-2 + d)^2*gZlR^2*
       (2*mm^2 + s + t) - 2*gZlL*gZlR*(2*(4 - 6*d + d^2)*mm^2 + 
        (20 - 12*d + d^2)*s + 8*t - 6*d*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*(4*gZlL*gZlR*mm^2*((4 + d)*s^2 + (8 + 3*d)*s*t + 
        t*((4 - 6*d + d^2)*mm^2 - (-12 + d)*t)) - 
      gZlL^2*t*(8*t*(s + t) + mm^2*(40*s + 52*t) + 
        d^2*(mm^4 + 2*mm^2*(s + t)) - 2*d*(mm^4 + 2*t*(s + t) + 
          mm^2*(9*s + 11*t))) + gZlR^2*t*(-(d^2*(mm^4 + 2*mm^2*(s + t))) + 
        2*d*(mm^4 + 2*t*(s + t) + mm^2*(9*s + 11*t)) - 
        4*(2*t*(s + t) + mm^2*(10*s + 13*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*mm^2*(-((-2 + d)^2*gZlL^2*mm^2*t) - 
      (-2 + d)^2*gZlR^2*mm^2*t + gZlL*gZlR*((12 - 6*d + d^2)*s^2 + 
        2*(4 - 6*d + d^2)*mm^2*t + 2*(12 - 6*d + d^2)*s*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*(d^2*mm^2*(-4*gZlL*gZlR*mm^2*s + 
        gZlL^2*(mm^2*s - t*(s + t)) + gZlR^2*(mm^2*s - t*(s + t))) - 
      4*(4*gZlL*gZlR*mm^2*s*(mm^2 + 2*t) + gZlL^2*(2*t*(s + t)^2 + 
          mm^2*(2*s^2 + s*t + 2*t^2)) + gZlR^2*(2*t*(s + t)^2 + 
          mm^2*(2*s^2 + s*t + 2*t^2))) + 
      2*d*(2*gZlL*gZlR*mm^2*(6*mm^2*s + 3*s^2 + 10*s*t + 4*t^2) + 
        gZlL^2*(-(mm^4*s) + t*(s^2 + 3*s*t + 2*t^2) + 
          mm^2*(s^2 + 2*s*t + 3*t^2)) + gZlR^2*(-(mm^4*s) + 
          t*(s^2 + 3*s*t + 2*t^2) + mm^2*(s^2 + 2*s*t + 3*t^2))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*mm^2*
     (-(gZlL*gZlR*(2*(4 - 6*d + d^2)*mm^2*s + (20 - 14*d + d^2)*s^2 + 
         4*(2 - 3*d)*s*t - 4*d*t^2)) + (-2 + d)^2*gZlL^2*
       (mm^2*s + (s + t)^2) + (-2 + d)^2*gZlR^2*(mm^2*s + (s + t)^2))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(s + t)*(2^(1 + 2*d)*(-2 + d)^2*gZlL*gZlR*mm^2*
       Pi^(2*d)*(s + 2*t) + gZlL^2*(2*Pi)^(2*d)*
       (2*(-4 + d)*t*(2*s + (-6 + d)*t) - mm^2*((16 - 6*d + d^2)*s + 
          2*(-2 + d)*d*t)) + gZlR^2*(2*Pi)^(2*d)*
       (2*(-4 + d)*t*(2*s + (-6 + d)*t) - mm^2*((16 - 6*d + d^2)*s + 
          2*(-2 + d)*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
    (Pi^(4*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*(s + t)*
     (2*(4 - 6*d + d^2)*gZlL*gZlR*mm^2*(s + 2*t) + 
      gZlL^2*(-(mm^2*((-4 + d)^2*s + (-2 + d)*d*t)) + 
        t*((32 - 12*d + d^2)*s + 2*(20 - 10*d + d^2)*t)) + 
      gZlR^2*(-(mm^2*((-4 + d)^2*s + (-2 + d)*d*t)) + 
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*t*(-4*d*gZlL*gZlR*mm^2*(s + 2*t) + 
      gZlL^2*((-2 + d)*mm^2*s + 2*(s + t)*(2*s + (-2 + d)*t)) + 
      gZlR^2*((-2 + d)*mm^2*s + 2*(s + t)*(2*s + (-2 + d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*t*(2*gZlL*gZlR*mm^2*(-4*(-1 + d)*s + 
        (4 - 7*d)*t) + gZlL^2*((-2 + d)*mm^2*(s - t) + 
        2*(s + t)*(2*s + (-2 + d)*t)) + gZlR^2*((-2 + d)*mm^2*(s - t) + 
        2*(s + t)*(2*s + (-2 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*(-4*d*gZlL*gZlR*mm^2*(s^2 + s*t - 2*t^2) + 
      gZlL^2*(mm^2*s*((-2 + d)*s - 2*t) - 2*t*(s + t)*(2*s + (-2 + d)*t)) + 
      gZlR^2*(mm^2*s*((-2 + d)*s - 2*t) - 2*t*(s + t)*(2*s + (-2 + d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*(-4*gZlL*gZlR*mm^2*((4 + d)*s^2 + 
        2*(2 + d)*s*t - 2*d*t^2) + gZlL^2*t*(2*(-4 + d)*s*(s + t) + 
        mm^2*(2*(-4 + d)*s + (-2 + d)*d*t)) + 
      gZlR^2*t*(2*(-4 + d)*s*(s + t) + mm^2*(2*(-4 + d)*s + (-2 + d)*d*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 2*d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*t*(2*s + d*t)*
     ((-2 + d)*mm^2 - 4*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^3*gAu*t*
     (-2*d*gZlL*gZlR*mm^2*(s + 2*t) + 
      gZlL^2*(2*mm^2*s - (s + t)*((-12 + d)*s - 2*(2 + d)*t)) + 
      gZlR^2*(2*mm^2*s - (s + t)*((-12 + d)*s - 2*(2 + d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*t*(-(4^(1 + d)*(-2 + d)^2*gZlL*gZlR*mm^2*
        Pi^(2*d)*(s + 2*t)) + gZlL^2*(2*Pi)^(2*d)*
       (mm^2*((20 - 8*d + d^2)*s + (-2 + d)*d*t) + 
        2*(s + t)*(2*(-2 + d)*s + (24 - 8*d + d^2)*t)) + 
      gZlR^2*(2*Pi)^(2*d)*(mm^2*((20 - 8*d + d^2)*s + (-2 + d)*d*t) + 
        2*(s + t)*(2*(-2 + d)*s + (24 - 8*d + d^2)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(4*d)*s) - 
   (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*t*((-2 + d)^2*gZlL^2*t + 
      (-2 + d)^2*gZlR^2*t + 2*gZlL*gZlR*((12 - 6*d + d^2)*s + 
        2*(-4 + 3*d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*
     (-4*gZlL*gZlR*mm^2*((-8 + 3*d)*s^2 + 2*(-4 + d)*s*t - 4*d*t^2) + 
      gZlL^2*((-2 + d)*mm^2*(2*s^2 - 2*s*t - (-4 + d)*t^2) - 
        2*t*(s + t)*(-4*t + d*(s + 2*t))) + 
      gZlR^2*((-2 + d)*mm^2*(2*s^2 - 2*s*t - (-4 + d)*t^2) - 
        2*t*(s + t)*(-4*t + d*(s + 2*t))))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*mm^2*((-2 + d)^2*gZlL^2*t^2 + 
      (-2 + d)^2*gZlR^2*t^2 + gZlL*gZlR*(-((12 - 6*d + d^2)*s^2) - 
        4*(-2 + d)*s*t + 4*d*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*t*(-(2^(1 + 2*d)*(-2 + d)^2*gZlL*gZlR*mm^2*
        Pi^(2*d)*(s + 2*t)) + gZlL^2*(2*Pi)^(2*d)*
       (2*(-4 + d)*(s + t)*((-8 + d)*s + (-6 + d)*t) + 
        mm^2*((16 - 6*d + d^2)*s + 2*(-2 + d)*d*t)) + 
      gZlR^2*(2*Pi)^(2*d)*(2*(-4 + d)*(s + t)*((-8 + d)*s + (-6 + d)*t) + 
        mm^2*((16 - 6*d + d^2)*s + 2*(-2 + d)*d*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(4*d)*s) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*t*(-2*(4 - 6*d + d^2)*gZlL*gZlR*mm^2*(s + 2*t) + 
      gZlL^2*(mm^2*((-4 + d)^2*s + (-2 + d)*d*t) + 
        (s + t)*((8 - 8*d + d^2)*s + 2*(20 - 10*d + d^2)*t)) + 
      gZlR^2*(mm^2*((-4 + d)^2*s + (-2 + d)*d*t) + 
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*mm^2*(gZlL^2*s + gZlR^2*s - 
      2*d*gZlL*gZlR*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*mm^2*
     (6*d*gZlL*gZlR*(s + 2*t) + gZlL^2*((-4 + d)*s + 2*(-2 + d)*t) + 
      gZlR^2*((-4 + d)*s + 2*(-2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*
     (mm^2*s*(2*s + d*t) + 4*t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q1, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl^3*gAu*(-(d*gZlL*gZlR*mm^2*s*(s + 2*t)) + 
      gZlL^2*(mm^2*s^2 - (-2 + d)*t*(s^2 + 3*s*t + 2*t^2)) + 
      gZlR^2*(mm^2*s^2 - (-2 + d)*t*(s^2 + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*(4^(1 + d)*(-2 + d)^2*gZlL*gZlR*mm^2*Pi^(2*d)*
       s*(s + 2*t) + gZlL^2*(2*Pi)^(2*d)*
       (-(mm^2*s*((20 - 8*d + d^2)*s + (-2 + d)*d*t)) + 
   ...
   (2^(1 - 4*d)*EL^6*gAl^3*gAu*mm^2*
     (-(2^(1 + 2*d)*(-2 + d)^2*gZlL*gZlR*Pi^(2*d)*(s + 2*t)) + 
      gZlL^2*(2*Pi)^(2*d)*((16 - 6*d + d^2)*s + 2*(-2 + d)*d*t) + 
      gZlR^2*(2*Pi)^(2*d)*((16 - 6*d + d^2)*s + 2*(-2 + d)*d*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/Pi^(4*d) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*(-2*(4 - 6*d + d^2)*gZlL*gZlR*(s + 2*t) + 
      gZlL^2*((-4 + d)^2*s + (-2 + d)*d*t) + 
      gZlR^2*((-4 + d)^2*s + (-2 + d)*d*t))*\[Mu]^(8 - 2*d)*
