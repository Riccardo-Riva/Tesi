...
(PropList[KiraPropagator[q1, mh], KiraPropagator[-p3 + q1, mm], 
  ...
  ((2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
     (-4*d*gZlL*gZlR*(3*mm^2 + psq)*(psq - s - t) + 
      gZlL^2*(4*(-2 + d)*psq^2 - (-12 + d^2)*psq*s + 4*(-4 + d)*s^2 + 
        (-2 + d)*mm^2*(4*psq + (-6 + d)*s - 4*t) - 4*(-2 + d)*psq*t - 
        8*s*t) + gZlR^2*(4*(-2 + d)*psq^2 - (-12 + d^2)*psq*s + 
        4*(-4 + d)*s^2 + (-2 + d)*mm^2*(4*psq + (-6 + d)*s - 4*t) - 
        4*(-2 + d)*psq*t - 8*s*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
    (Pi^(2*d)*s^2) - (4^(1 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
     (gZlL^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*
    ...
    (Pi^(4*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
     (2*d*gZlL*gZlR*(psq - s - t) + (-2 + d)*gZlL^2*(psq + s - t) + 
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*
     (2*(gZlL^2 + gZlR^2)*(psq - 5*s - t) + 
      d*(2*gZlL*gZlR*(2*mm^2 - 3*psq + s + t) + gZlL^2*(-psq + 3*s + t) + 
        gZlR^2*(-psq + 3*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
     mm^2*(-2*d*gZlL*gZlR*s + (-2 + d)*gZlL^2*(2*psq + (-5 + d)*s - 2*t) + 
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
     (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*(2*d*gZlL*gZlR*(psq - t) + 
      (-2 + d)*gZlL^2*(psq - 2*s - t) + (-2 + d)*gZlR^2*(psq - 2*s - t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHZZ*mm^2*(-2*d*gZlL*gZlR*s + 
