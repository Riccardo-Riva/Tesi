...
(PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, mh], 
   ...
   (((I/4)*EL^6*gAl^2*gAu^2*gHll*gHuu*mm^2*mu^2*(8*mm^4 - 2*s^2 + d*s^2 + 
     ...
     (Pi^4*s) + (I*EL^6*gAl^2*gAu^2*gHll*gHuu*mm^2*mu^2*
      ((-2 + d)*mu^2 + (-2 + d)*s + 4*t)*SPList[SP[p1, q1]])/(Pi^4*s) + 
    (I*EL^6*gAl^2*gAu^2*gHll*gHuu*mm^2*mu^2*((-2 + d)*mu^2 + (-2 + d)*s + 
       4*t)*SPList[SP[p2, q1]])/(Pi^4*s) + 
    ((2*I)*EL^6*gAl^2*gAu^2*gHll*gHuu*mm^2*mu^2*(2*mm^2 + mu^2 - 2*t)*
      SPList[SP[p3, q1]])/(Pi^4*s) + ((2*I)*EL^6*gAl^2*gAu^2*gHll*gHuu*mm^2*
      mu^2*(mm^2 - t)*SPList[SP[q1, q1]])/(Pi^4*s) + 
