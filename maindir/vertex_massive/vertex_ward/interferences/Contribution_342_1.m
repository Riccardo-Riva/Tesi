...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((2^(-1 - 2*d)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*s*
    (2*aa*mm^2*(5*psq - 2*s) + bb*mm^2*(-10*psq + s) + 2*bb*psq*(-psq + s) + 
     aa*psq*(2*psq + s))*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(6*aa*mm^2*(psq - s) + 
     bb*mm^2*(-6*psq + s) + bb*psq*(-2*psq + s) + 2*aa*psq*(psq + 2*s))*
  ...
  ((aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
   ...
   (2*Pi)^(2*d) - (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHXZ*gXll*
    ...
    mm^4*s*(2*aa*(2*mm^2 + s) - bb*(3*mm^2 + psq + 2*s))*\[Mu]^(8 - 2*d)*
  ...
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(aa*mm^2*(6*psq - 7*s) - 
     2*bb*psq*(3*mm^2 + psq - 3*s) + aa*psq*(2*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(2*aa*mm^2*(2*psq - s) + 
