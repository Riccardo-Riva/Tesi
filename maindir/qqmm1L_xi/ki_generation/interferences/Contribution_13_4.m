...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
  ...
  ((I*EL^6*gAl^2*gAu^2*(gZlLC*(d^3*gZuLC*(2*Pi)^d*s*(s + 3*t) - 
     ...
     SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)*(mzC^2 - s)) + 
   ...
   (I*EL^6*gAl^2*gAu^2*(gZlRC*(d^3*gZuLC*(2*Pi)^d*s^2 - 
        ...
        2^(1 + d)*gZuLC*Pi^d*((-4 + 9*d - 4*d^2)*s^2 + 
      ...
      gZlLC*(d^3*gZuRC*(2*Pi)^d*s^2 - 2^(1 + d)*gZuRC*Pi^d*
        ...
        gZuLC*(-(d^3*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((-4 - 6*d + 4*d^2)*s^2 - 
            (-44 + 40*d - 12*d^2 + d^3)*s*t + 8*t^2))))*\[Mu]^(4 - d)*
     SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)*(mzC^2 - s)) - 
   (I*EL^6*gAl^2*gAu^2*(gZlRC*(-(d^3*gZuLC*(2*Pi)^d*s^2) + 
   ...
   (I*2^(-1 - d)*(-4 + d)*EL^6*gAl^2*gAu^2*((28 - 12*d + d^2)*gZlLC*gZuLC - 
      (26 - 12*d + d^2)*gZlRC*gZuLC - (26 - 12*d + d^2)*gZlLC*gZuRC + 
      (28 - 12*d + d^2)*gZlRC*gZuRC)*(s + t)*\[Mu]^(4 - d)*
   ...
   (I*2^(-1 - d)*EL^6*gAl^2*gAu^2*((8 + 12*d - 8*d^2 + d^3)*gZlLC*gZuLC - 
      (-8 + 18*d - 8*d^2 + d^3)*gZlRC*gZuLC - (-8 + 18*d - 8*d^2 + d^3)*gZlLC*
       gZuRC + (8 + 12*d - 8*d^2 + d^3)*gZlRC*gZuRC)*t*\[Mu]^(4 - d)*
   ...
   (I*EL^6*gAl^2*gAu^2*((-52 + 44*d - 12*d^2 + d^3)*gZlLC*gZuLC - 
      (-56 + 46*d - 12*d^2 + d^3)*gZlRC*gZuLC - (-56 + 46*d - 12*d^2 + d^3)*
       gZlLC*gZuRC + (-52 + 44*d - 12*d^2 + d^3)*gZlRC*gZuRC)*s*\[Mu]^(4 - d)*
 ...
 PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
  ...
  (((-I)*EL^6*gAl^2*gAu^2*t*(s + t)*\[Mu]^(4 - d)*
     ...
     SPList[SP[p1, q1], SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)*(mzC^2 - s)) + 
   (I*EL^6*gAl^2*gAu^2*t^2*\[Mu]^(4 - d)*
     (gZlRC*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*s + 
        2^(1 + d)*gZuRC*Pi^d*(-s + t) + 2^(1 + d)*gZuLC*Pi^d*(2*s + t)) + 
      gZlLC*(d*gZuLC*(2*Pi)^d*s - d*gZuRC*(2*Pi)^d*s + 2^(1 + d)*gZuLC*Pi^d*
         (-s + t) + 2^(1 + d)*gZuRC*Pi^d*(2*s + t)) - 
   ...
   (I*EL^6*gAl^2*gAu^2*((-2 + d)*gZlLC*gZuLC - (-4 + d)*gZlRC*gZuLC - 
      (-4 + d)*gZlLC*gZuRC + (-2 + d)*gZlRC*gZuRC)*t*(s + t)*\[Mu]^(4 - d)*
     (-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1]])/
    ((2*Pi)^d*(mzC^2 - s)) - 
   (I*EL^6*gAl^2*gAu^2*(gZlRC*gZuLC*(-((-4 + d)*s^2) + 4*s*t + 2*t^2) + 
    ...
    ((2*Pi)^d*(mzC^2 - s)) - (I*4^(-1 - d)*EL^6*gAl^2*gAu^2*
    ...
    (Pi^(2*d)*(mzC^2 - s)) - (I*2^(-1 - d)*EL^6*gAl^2*gAu^2*
   ...
   (I*2^(1 - d)*EL^6*gAl^2*gAu^2*(gZlLC + gZlRC)*(gZuLC + gZuRC)*t^2*
   ...
   (I*EL^6*gAl^2*gAu^2*t*\[Mu]^(4 - d)*
     (gZlLC*(-(d*gZuLC*(2*Pi)^d*s) + d*gZuRC*(2*Pi)^d*s + 
        2^(1 + d)*gZuRC*Pi^d*(-((-2 + d)*s) + t) + 2^(1 + d)*gZuLC*Pi^d*
         ((-1 + d)*s + t)) + gZlRC*(d*gZuLC*(2*Pi)^d*s - d*gZuRC*(2*Pi)^d*s + 
     ...
     (gZlRC*gZuLC*(-((-4 + d)*s) + 4*t) + gZlLC*gZuRC*(-((-4 + d)*s) + 4*t) + 
      gZlLC*gZuLC*((-2 + d)*s + 4*t) + gZlRC*gZuRC*((-2 + d)*s + 4*t))*
   ...
   (I*EL^6*gAl^2*gAu^2*s*(gZlLC*(3*d*gZuLC*(2*Pi)^d*s - 
     ...
     SPList[SP[p3, q1], SP[q1, q1], SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)*
     (mzC^2 - s)) + (I*EL^6*gAl^2*gAu^2*s*
     ...
     SPList[SP[q1, q1], SP[q1, q1], SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)*
     (mzC^2 - s)) + (I*EL^6*gAl^2*gAu^2*((-4 + d)*gZlLC*gZuLC - 
      (-2 + d)*gZlRC*gZuLC - (-2 + d)*gZlLC*gZuRC + (-4 + d)*gZlRC*gZuRC)*
     (s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p1, q1], SP[q1, q1]])/((2*Pi)^d*(mzC^2 - s)) + 
   (I*EL^6*gAl^2*gAu^2*(gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 
    ...
    ((2*Pi)^d*(mzC^2 - s)) + 
   (I*EL^6*gAl^2*gAu^2*(gZlRC*(2*(-1 + d)*gZuLC*s - 2*(-5 + d)*gZuRC*s + 
        d*gZuLC*t - (-6 + d)*gZuRC*t) + gZlLC*(-2*(-5 + d)*gZuLC*s + 
        2*(-1 + d)*gZuRC*s - (-6 + d)*gZuLC*t + d*gZuRC*t))*\[Mu]^(4 - d)*
   ...
   (I*2^(-1 - d)*EL^6*gAl^2*gAu^2*
     ...
     (-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], SP[p2, q1], SP[q1, q1], 
      SP[q1, q1]])/(Pi^d*(mzC^2 - s)) + 
   (I*EL^6*gAl^2*gAu^2*(gZlLC*((-8 + d)*gZuLC*s - (2 + d)*gZuRC*s - 
        2*gZuLC*t - 2*gZuRC*t) - gZlRC*((2 + d)*gZuLC*s - (-8 + d)*gZuRC*s + 
        2*gZuLC*t + 2*gZuRC*t))*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])^2*
   ...
   (I*2^(-1 - d)*EL^6*gAl^2*gAu^2*((-2 + d)*gZlLC*gZuLC - 
     ...
     \[Mu]^(4 - d)*(-1 + GaugeXi[Q])^2*SPList[SP[p2, q1], SP[p2, q1], 
      SP[q1, q1], SP[q1, q1]])/(Pi^d*(mzC^2 - s)) - 
   (I*EL^6*gAl^2*gAu^2*(gZlLC*gZuLC*((-2 + d)*s - 2*t) + 
