...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p1 + q1, mw], 
  ...
  ((2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlL*gZNL*mm^4*
     (3*psq - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   ...
   (2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZNL*mm^2*s*
    ...
    (2*Pi)^(2*d) + (EL^5*gFFA*gFll^2*gZNL*mm^2*s*
     (aa*d*gZlR*psq*(2*mm^2 + 2*psq - s) - aa*(-2 + d)*gZlL*mm^2*
       (4*psq - s) + bb*(-2 + d)*gZlL*mm^2*(4*psq - s) + 
      4*aa*gZlR*(-mm^2 + psq)*s + bb*gZlR*(-2*d*psq^2 + 4*(-mm^2 + psq)*s + 
   ...
   (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlL*gZNL*mm^4*(3*psq - s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gFFA*gFll^2*gZNL*mm^2*
     (aa*((-2 + d)*gZlL*mm^2*psq + 2*gZlR*(mm^2 + psq)*s - 
        d*gZlR*psq*(mm^2 + psq + s)) + bb*(-((-2 + d)*gZlL*mm^2*psq) - 
        2*gZlR*(mm^2 + psq)*s + d*gZlR*(psq^2 + mm^2*(psq + s))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlL*gZNL*mm^4*(2*psq - s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZNL*mm^2*
     (-(aa*(-4 + d)*gZlR*(4*mm^2 + psq)*s) + bb*(-4 + d)*gZlR*(mm^2 + 4*psq)*
       s + aa*(-2 + d)*gZlL*mm^2*(4*psq + s) - bb*(-2 + d)*gZlL*mm^2*
       (4*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    Pi^(2*d) + (2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlL*gZNL*
     mm^4*(4*psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q1]])/
    Pi^(2*d) + (2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZNL*mm^2*
     (aa*(-2 + d)*gZlL*mm^2*(4*psq - s) - bb*(-2 + d)*gZlL*mm^2*(4*psq - s) + 
      4*aa*gZlR*(mm^2 - 2*psq)*s + aa*d*gZlR*psq*(-2*mm^2 - 2*psq + s) + 
   ...
   (2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*
    ...
    Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR*gZNL*mm^2*
     ...
     (-(aa*(-2 + d)*gZlL*mm^2) + bb*(-2 + d)*gZlL*mm^2 + 
      aa*(-4 + d)*gZlR*(2*mm^2 + psq) - bb*(-4 + d)*gZlR*(mm^2 + 2*psq))*
