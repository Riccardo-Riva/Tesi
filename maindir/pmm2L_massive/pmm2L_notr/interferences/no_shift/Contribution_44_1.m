...
(PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(mm^2 - psq)*
   ...
   (2^(1 - 4*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (4^(1 + d)*(-1 + d)*mm^4*Pi^(2*d)*s + (2*Pi)^(2*d)*psq*
       (4*psq^2 + 4*(-1 + d)*psq*s + (-4 + d)*s^2 - 8*psq*t + 4*s*t + 
        4*t^2) + mm^2*(2*Pi)^(2*d)*(44*psq^2 + (-20 + 11*d)*s^2 + 44*s*t + 
        44*t^2 - 8*psq*((-1 + d)*s + 11*t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(mm^2 - psq)*(2*psq - d*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(mm^2*(6*psq + 4*s - 3*d*s - 6*t) + psq*(2*psq + 4*s - d*s - 2*t))*
