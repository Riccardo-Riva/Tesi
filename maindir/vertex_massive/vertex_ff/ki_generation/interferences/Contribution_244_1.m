...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
   ...
   ((2^(3 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*(-psq + s + t)^2*
    ...
    (4^(2 - d)*EL^6*gAu*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ^2*(-psq + s + t)*
      (2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + gZlL^2*(mm^2*(-psq + t) + 
         psq*(-psq + s + t)) + gZlR^2*(mm^2*(-psq + t) + psq*(-psq + s + t)))*
    ...
    (4^(2 - d)*EL^6*gAu*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ^2*(psq - t)*
      (2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + gZlL^2*(mm^2*(-psq + t) + 
         psq*(-psq + s + t)) + gZlR^2*(mm^2*(-psq + t) + psq*(-psq + s + t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*(psq - t)*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ^2*gZlL*gZlR*mm^2*
    ...
    (2^(3 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ^2*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ^2*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
       SP[p2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ^2*
      (-2*gZlL*gZlR*mm^2*s + gZlL^2*(mm^2*(psq - t) - 
         (2*psq - t)*(psq - s - t)) + gZlR^2*(mm^2*(psq - t) - 
         (2*psq - t)*(psq - s - t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAu*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[q2, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ^2*
      (-2*gZlL*gZlR*mm^2 + gZlL^2*psq + gZlR^2*psq)*(-psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ^2*(-2*gZlL*gZlR*mm^2 + gZlL^2*psq + 
       gZlR^2*psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*ggmgmA*ggmgmZ^2*
      (2*gZlL*gZlR*mm^2*s + gZlL^2*(psq^2 - 2*psq*(s + t) + t*(s + t)) + 
       gZlR^2*(psq^2 - 2*psq*(s + t) + t*(s + t)))*\[Mu]^(8 - 2*d)*
