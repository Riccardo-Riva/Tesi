...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^3*gHll^2*ml^2*mm^2*s*
       (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
      (mh^2*Pi^(2*d)) - (I*4^(2 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*ml^2*mm^2*s*
       (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
      (mh^2*Pi^(2*d)) + (I*2^(5 - 2*d)*aa*EL^5*gAl^3*gHll^2*ml^2*mm^2*
       (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
      (mh^2*Pi^(2*d)) - (I*2^(5 - 2*d)*EL^5*gAl^3*gHll^2*ml^2*mm^2*
       (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
       SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)) + 
     (I*2^(5 - 2*d)*(aa + bb)*EL^5*gAl^3*gHll^2*ml^2*mm^2*(mm^2 - psq)*
       \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)) - 
     (I*2^(5 - 2*d)*EL^5*gAl^3*gHll^2*ml^2*mm^2*(bb*(2*mm^2 - psq + s - t) - 
