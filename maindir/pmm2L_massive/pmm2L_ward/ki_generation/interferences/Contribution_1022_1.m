    ...
    ((I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*(mm^2 - psq)*s*
     ...
     (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
       gWWZ*(gZlL + gZlR)*mm^2*(-2*bb*mm^2*(psq - t) + aa*s*(psq - t) + 
     ...
     (I*4^(1 - d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
       gWWZ*(gZlL + gZlR)*mm^2*(bb*(2*mm^2 - psq - s - t) + 
     ...
     (I*4^(1 - d)*(aa - bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
      ...
      ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(1 - d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
       gWWZ*(gZlL + gZlR)*mm^2*(bb*(mm^2 - t) + aa*(-psq + t))*
       \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
      ((mh^2 - mz^2)*Pi^(2*d)) + (I*4^(1 - d)*(-1 + d)*EL^5*gAl*gHll*gHWW*
       gWWZ*(gZlL + gZlR)*mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
