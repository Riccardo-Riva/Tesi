...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (-((4^(1 - d)*EL^6*gAl^3*gAu*mm^2*(gZlL^2*((4 - 3*d + d^2)*psq^3 - 
         ...
         gZlR^2*((4 - 3*d + d^2)*psq^3 - 2*psq^2*((-6 + d)*s + 
             (-4 + 3*d)*t) + psq*((10 - 8*d + d^2)*s^2 - 2*(-4 + d)^2*s*t + 
             (-28 + 21*d - 3*d^2)*t^2) + (s + t)*((-2 + d)*s^2 + 
             2*(10 - 6*d + d^2)*s*t + 2*(8 - 6*d + d^2)*t^2) - 
   ...
   PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     KiraPropagator[q2, 0]]*((4^(1 - d)*EL^6*gAl^3*gAu*mm^2*
