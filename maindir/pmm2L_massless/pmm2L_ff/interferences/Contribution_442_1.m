...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*(2 - 3*d + d^2)*EL^6*gAl*gAu*gWWZZ*(gZlL^2 + gZlR^2)*mm^2*t*
   ...
   (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^6*gAl*gAu*gWWZZ*(gZlL^2 + gZlR^2)*t^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*(2 - 3*d + d^2)*EL^6*gAl*gAu*gWWZZ*(gZlL^2 + gZlR^2)*t^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(2 - 3*d + d^2)*EL^6*gAl*gAu*gWWZZ*(gZlL^2 + gZlR^2)*
     (s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d)))/4
