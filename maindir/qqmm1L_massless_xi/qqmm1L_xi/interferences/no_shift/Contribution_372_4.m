...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
   ...
   ((I*EL^6*gFZW^2*(gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
      ...
      \[Mu]^(4 - d))/((2*Pi)^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) + 
    (I*EL^6*gFZW^2*s*(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
      ...
      SPList[SP[q1, q1]])/(mw^2*(2*Pi)^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*
      ...
      SPList[SP[p1, q1], SP[p1, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*
      ...
      (-(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
       ...
       gZlR*gZlRC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 2^(1 + d)*Pi^d*
            (-s + (-3 + d)*t)) + gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 
           2^(1 + d)*Pi^d*(2*s + 3*t - d*t))))*\[Mu]^(4 - d)*
      SPList[SP[p1, q1], SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*
      (-mzC^2 + s)*sw^2) + (I*2^(1 - 2*d)*EL^6*gFZW^2*
    ...
    (I*2^(1 - 2*d)*EL^6*gFZW^2*
      ...
      SPList[SP[p2, q1], SP[p2, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*
      (-mzC^2 + s)*sw^2) - (I*2^(1 - 2*d)*EL^6*gFZW^2*
      (-(gZlR*gZlRC*(gZuL*gZuLC*(-(d*(2*Pi)^d*s) + 2^(1 + d)*Pi^d*
           ...
           2^(1 + d)*Pi^d*(s + t))))*\[Mu]^(4 - d)*SPList[SP[p2, q1], 
       SP[p3, q1]])/(mw^2*Pi^(2*d)*(mz^2 - s)^2*(-mzC^2 + s)*sw^2) - 
    (I*2^(2 - d)*EL^6*gFZW^2*(gZlL*gZlLC + gZlR*gZlRC)*
  ...
  PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
   ...
   (((-I)*EL^6*gFZW^2*s*(gZlL*gZlLC*(gZuR*gZuRC*(d*(2*Pi)^d*s + 
    ...
    (I*2^(2 - d)*EL^6*gFZW^2*(gZlL*gZlLC + gZlR*gZlRC)*
      (gZuL*gZuLC + gZuR*gZuRC)*s*\[Mu]^(4 - d)*SPList[SP[p3, q1], 
       SP[p3, q1]])/(mw^2*Pi^d*(mz^2 - s)^2*(-mzC^2 + s)*sw^2)))/4
