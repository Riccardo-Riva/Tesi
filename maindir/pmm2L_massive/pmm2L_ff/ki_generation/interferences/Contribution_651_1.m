...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
   ...
   (-((2^(1 - 4*d)*d*EL^6*gAl^3*gAu*mm^2*(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*(2^(1 + 2*d)*(-2 + d)*d*gZlL*gZlR*mm^2*
        Pi^(2*d)*(mm^2 - psq)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
         2*t^2) + gZlL^2*(-((-2 + d)^2*mm^4*(2*Pi)^(2*d)*(3*psq^2 + s^2 + 
            4*s*t + 3*t^2 - 2*psq*(s + 3*t))) + 
         psq*(-(d^2*(2*Pi)^(2*d)*psq*(psq^2 + psq*s + t*(s + t))) + 
           2^(1 + 2*d)*Pi^(2*d)*((-6 + 4*d)*psq^3 - 2*(-2 + d)*t^2*(s + t) + 
             2*psq*t*((-3 + 2*d)*s + (-7 + 4*d)*t) + psq^2*(2*(-1 + d)*s + 
               (16 - 10*d + d^2)*t))) + 
         mm^2*(-(d^2*(2*Pi)^(2*d)*psq*s*(psq - s - 5*t)) + 
           4^(1 + d)*Pi^(2*d)*((6 - 5*d + d^2)*psq^3 + (-2 + d)*t^2*(s + t) + 
             psq^2*((-1 + d)*s + (-14 + 11*d - 2*d^2)*t) + 
             psq*(-((-1 + d)*s^2) + (7 - 6*d)*s*t + (10 - 7*d + d^2)*
                t^2)))) + gZlR^2*(-((-2 + d)^2*mm^4*(2*Pi)^(2*d)*
         ...
         mm^2*(-(d^2*(2*Pi)^(2*d)*psq*s*(psq - s - 5*t)) + 
           4^(1 + d)*Pi^(2*d)*((6 - 5*d + d^2)*psq^3 + (-2 + d)*t^2*(s + t) + 
             psq^2*((-1 + d)*s + (-14 + 11*d - 2*d^2)*t) + 
             psq*(-((-1 + d)*s^2) + (7 - 6*d)*s*t + (10 - 7*d + d^2)*t^2)))))*
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*(mm^2 - psq)*
      (2^(1 + 2*d)*(-2 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)*
        (psq - t) + gZlL^2*(-((-2 + d)^2*mm^2*(2*Pi)^(2*d)*(psq - t)*
           (psq - s - t)) - d^2*(2*Pi)^(2*d)*psq*(psq^2 + t^2) + 
         2^(1 + 2*d)*Pi^(2*d)*((-6 + 4*d)*psq^3 - 2*(-2 + d)*t*(s + t)^2 + 
           (-2 + d)*psq^2*(-2*s + (-8 + d)*t) + 2*psq*t*(3*(-2 + d)*s + 
             (-7 + 4*d)*t))) + gZlR^2*(-((-2 + d)^2*mm^2*(2*Pi)^(2*d)*
           (psq - t)*(psq - s - t)) - d^2*(2*Pi)^(2*d)*psq*(psq^2 + t^2) + 
         2^(1 + 2*d)*Pi^(2*d)*((-6 + 4*d)*psq^3 - 2*(-2 + d)*t*(s + t)^2 + 
           (-2 + d)*psq^2*(-2*s + (-8 + d)*t) + 2*psq*t*(3*(-2 + d)*s + 
             (-7 + 4*d)*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
     (Pi^(4*d)*s) + (4^(1 - d)*d*EL^6*gAl^3*gAu*mm^2*(2*psq - s - 2*t)*
    ...
    (2^(3 - 2*d)*(-2 + d)*d*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*
      (2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (psq - s - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*(-2 + d)*d*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*mm^2*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*(-4*d*gZlL*gZlR*mm^2*
       ...
       gZlL^2*((-2 + d)*mm^4*s - (3*(-2 + d)*psq - 4*s)*(psq^2 - 2*psq*t + 
           t*(s + t)) + (-2 + d)*mm^2*(7*psq^2 + 2*s^2 + 9*s*t + 7*t^2 - 
           7*psq*(s + 2*t))) + gZlR^2*((-2 + d)*mm^4*s - 
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*(2^(1 + 2*d)*(-2 + d)*d*gZlL*gZlR*mm^2*
       ...
       gZlL^2*(d^2*(2*Pi)^(2*d)*psq*(psq^2 + psq*s + t*(s + t)) - 
         (-2 + d)^2*mm^2*(2*Pi)^(2*d)*(3*psq^2 + s^2 + 4*s*t + 3*t^2 - 
           2*psq*(s + 3*t)) - 2^(1 + 2*d)*Pi^(2*d)*((-6 + 4*d)*psq^3 - 
           2*(-2 + d)*t^2*(s + t) + 2*psq*t*((-3 + 2*d)*s + (-7 + 4*d)*t) + 
           psq^2*(2*(-1 + d)*s + (16 - 10*d + d^2)*t))) + 
       gZlR^2*(d^2*(2*Pi)^(2*d)*psq*(psq^2 + psq*s + t*(s + t)) - 
         (-2 + d)^2*mm^2*(2*Pi)^(2*d)*(3*psq^2 + s^2 + 4*s*t + 3*t^2 - 
           2*psq*(s + 3*t)) - 2^(1 + 2*d)*Pi^(2*d)*((-6 + 4*d)*psq^3 - 
           2*(-2 + d)*t^2*(s + t) + 2*psq*t*((-3 + 2*d)*s + (-7 + 4*d)*t) + 
           psq^2*(2*(-1 + d)*s + (16 - 10*d + d^2)*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[q1, q1]])/(Pi^(4*d)*s) + 
    (2^(3 - 2*d)*(-2 + d)*d*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*mm^2*(psq - t)^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*(-2 + d)^2*EL^6*gAl^3*gAu*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/
     (Pi^(2*d)*s) - (2^(3 - 2*d)*d*EL^6*gAl^3*gAu*mm^2*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAl^3*gAu*(d^2*(psq - t)*
        (2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + gZlL^2*(-2*psq^2 + mm^2*s + 
           2*psq*t) + gZlR^2*(-2*psq^2 + mm^2*s + 2*psq*t)) - 
       4*(gZlL^2 + gZlR^2)*(4*psq^3 - 2*psq^2*(s + 5*t) + 
    ...
    (2^(1 - 4*d)*EL^6*gAl^3*gAu*(2^(1 + 2*d)*(-2 + d)*d*gZlL*gZlR*mm^2*
       ...
       gZlL^2*(-((-2 + d)^2*mm^2*(2*Pi)^(2*d)*(psq - t)*(psq - s - t)) - 
         d^2*(2*Pi)^(2*d)*psq*(psq^2 + t^2) + 2^(1 + 2*d)*Pi^(2*d)*
          ((-6 + 4*d)*psq^3 - 2*(-2 + d)*t*(s + t)^2 + (-2 + d)*psq^2*
            (-2*s + (-8 + d)*t) + 2*psq*t*(3*(-2 + d)*s + (-7 + 4*d)*t))) + 
       gZlR^2*(-((-2 + d)^2*mm^2*(2*Pi)^(2*d)*(psq - t)*(psq - s - t)) - 
         d^2*(2*Pi)^(2*d)*psq*(psq^2 + t^2) + 2^(1 + 2*d)*Pi^(2*d)*
          ((-6 + 4*d)*psq^3 - 2*(-2 + d)*t*(s + t)^2 + (-2 + d)*psq^2*
            (-2*s + (-8 + d)*t) + 2*psq*t*(3*(-2 + d)*s + (-7 + 4*d)*t))))*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*
      (2*d*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + (-2 + d)*gZlL^2*
        (mm^2*(3*psq - s - 3*t) + psq*(-psq + t)) + (-2 + d)*gZlR^2*
