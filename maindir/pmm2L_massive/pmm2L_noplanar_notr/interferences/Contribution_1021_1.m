   ...
   ((4^(1 - d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
    ...
    (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     ...
     (mh^2*Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
      gWWA*mm^2*(2*mm^2 - 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
      (2*mm^2 + psq - 5*s + d*s - 3*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
    (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(mh^2*Pi^(2*d)*s) + 
    (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
    ...
    (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     ...
     (mh^2*Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
      gWWA*mm^2*(2*mm^2 - 5*psq - 2*s + d*s + 3*t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*gWWA*mm^2*
     ...
     (mh^2*Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
      gWWA*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
     (mh^2*Pi^(2*d)*s) - (2^(5 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gHll*gHWW*
