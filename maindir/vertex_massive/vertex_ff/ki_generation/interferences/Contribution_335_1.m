...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(1 - 4*d)*EL^6*gAl*gAu*gXll^2*mm^4*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^4*
      ...
      (-(gZlL^2*(2*Pi)^(2*d)*s*((10 - 3*d)*psq*s + 2*(-2 + d)*mm^2*
           (psq - t) + (-4 + d)*s*(s + 2*t))) - gZlR^2*(2*Pi)^(2*d)*s*
        ...
        (d*(2*Pi)^(2*d)*s*(-3*psq*(psq - 3*t) + mm^2*(psq - t)) + 
         2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + 
           2*psq^2*(2*s - 3*(-2 + d)*t) - (s + t)*(2*mm^2*s + 
             (-2 + d)*t*(s + 2*t)) + 2*psq*(mm^2*s + t*(-5*s + 3*(-2 + d)*
                t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/(Pi^(4*d)*s) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(psq^2 - 2*psq*t + 
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*
      (psq - t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*(4*gZlL*gZlR*(mm^2 - psq)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gXll^2*mm^2*
      ((-2 + d)*gZlL^2*mm^2*(-2*psq + s + 2*t)^2 + (-2 + d)*gZlR^2*mm^2*
        (-2*psq + s + 2*t)^2 + 2*gZlL*gZlR*
        (d*(psq - t)*(2*psq^2 - 4*psq*t + mm^2*(-psq + s + t) + 
           t*(s + 2*t)) - 2*(2*psq^3 + psq^2*(s - 6*t) + mm^2*s*(s + t) - 
    ...
    (4^(1 - d)*d*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*(psq - t)*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
      ...
      (-((-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t)*(psq - t)) - 
       ...
       SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^4*
    ...
    (4^(1 - 2*d)*EL^6*gAl*gAu*gXll^2*mm^2*(4^d*(-4 + d)*gZlL*gZlR*Pi^(2*d)*
     ...
     Pi^(4*d) + (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^4*
      ...
      (-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*s*(-2*psq + s + 2*t)) - 
       ...
       2*gZlL*gZlR*(d*(2*Pi)^(2*d)*s*(-3*psq*(psq - 3*t) + mm^2*(psq - t)) + 
         2^(1 + 2*d)*Pi^(2*d)*(2*(-2 + d)*psq^3 + 
           2*psq^2*(2*s - 3*(-2 + d)*t) - (s + t)*(2*mm^2*s + 
             (-2 + d)*t*(s + 2*t)) + 2*psq*(mm^2*s + t*(-5*s + 3*(-2 + d)*
                t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
     (Pi^(4*d)*s) + (4^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(mm^2 - 2*psq + s + t)*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*(2*psq^2 + mm^2*s + 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) + (2^(5 - 2*d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*
      mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) - (4^(2 - d)*EL^6*gAl*gAu*gXll^2*gZlL*gZlR*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d)))/4}
