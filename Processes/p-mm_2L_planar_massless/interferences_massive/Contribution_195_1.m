...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*mu^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*
     (6*mu^2 - t)*SPList[SP[p2, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*(mu^2 - t)*
     SPList[SP[p2, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*
     (2*mu^2 + s)*SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(2*mm^2 + s)*
     (2*mu^2 + s)*SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*mm^2*
     (2*mu^2 + s)*SPList[SP[p3, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(2*mm^2 + s)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 + s + t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*
     ...
     ggpgpZ*(gZlL + gZlR)*(4*mu^2 + 3*s + 2*t)*SPList[SP[p1, q2], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*
     ggpgpZ*(gZlL + gZlR)*t*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*ggpgpZ*
     (gZlL + gZlR)*(4*mu^2 + s - 2*t)*SPList[SP[p2, q2], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*
     ggpgpZ*(gZlL + gZlR)*(4*mu^2 + s - 2*t)*SPList[SP[p2, q2], SP[p3, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*
     ggpgpZ*(gZlL + gZlR)*(2*mu^2 + s)*SPList[SP[p3, q1], SP[p3, q2], 
      SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*
     ggpgpZ*(gZlL + gZlR)*(2*mu^2 + s)*SPList[SP[p3, q2], SP[p3, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*
     ggpgpZ*(gZlL + gZlR)*(2*mu^2 + s)*SPList[SP[p3, q2], SP[p3, q2], 
