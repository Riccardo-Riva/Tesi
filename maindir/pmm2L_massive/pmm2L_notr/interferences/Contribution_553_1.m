...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
 ...
 ((EL^8*gAl*gAu^2*ggagpAW*ggagpW*gWlN*gWNl*psq*(2*psq - (-2 + d)*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(4^d*Pi^(2*d)*s^2) - 
  (EL^8*gAl*gAu^2*ggagpAW*ggagpW*gWlN*gWNl*psq*(2*psq + (-4 + d)*s - 2*t)*
  ...
  (2^(-1 - 2*d)*EL^8*gAl*gAu^2*ggagpAW*ggagpW*gWlN*gWNl*
    (4*psq^2 + 2*(-2 + d)*mm^2*s - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
     2*psq*((-2 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
  ...
  (EL^8*gAl*gAu^2*ggagpAW*ggagpW*gWlN*gWNl*(2*psq - (-2 + d)*s - 2*t)*
