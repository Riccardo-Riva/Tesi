...
(PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
     ...
     (gZlL - gZlR)*mm^2*(mm^2 - psq)*(mm^2*(3*psq - 2*s - 3*t) + 
      psq*(psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
      t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(11*mm^2 + psq)*(2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^2*(psq^2 + psq*(4*s - 2*t) + t*(s + t)) - 
      psq*(psq^2 - 2*psq*t + t*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (-(psq*(psq^2 + 4*psq*s - s^2 - 2*psq*t + t^2)) + 
      mm^2*(5*psq^2 + 3*s^2 + 8*s*t + 5*t^2 - 2*psq*(2*s + 5*t)))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (psq^3 + 2*mm^4*(psq - t) - psq*t*(s + t) + 
      mm^2*(-3*psq^2 + t*(s + t) + 2*psq*(2*s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*(mm^3 - mm*psq)^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (2*mm^4*s - psq*(psq^2 - 7*psq*s + 2*s^2 - 2*psq*t + 3*s*t + t^2) - 
      3*mm^2*(psq^2 + psq*(s - 2*t) + t*(s + t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (psq*(-5*psq^2 - 4*psq*s + s^2 + 10*psq*t - 4*s*t - 5*t^2) + 
      mm^2*(17*psq^2 + 5*s^2 + 22*s*t + 17*t^2 - 2*psq*(7*s + 17*t)))*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (3*psq*(psq - t) + mm^2*(psq - 2*s - t))*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
   (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(3*mm^2 + psq)*
     (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^2*(psq - t)*(psq*(-3*psq + s + 3*t) + 
      mm^2*(-9*psq + 5*s + 9*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(3*mm^2 + psq)*
    ...
    Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (4*psq^3 + psq^2*(s - 12*t) - mm^2*s*(5*s + 9*t) - 
      2*t*(s^2 + 3*s*t + 2*t^2) + psq*(9*mm^2*s - s^2 + 5*s*t + 12*t^2))*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(-psq + s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 + psq)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(-3*psq^2 + mm^2*(psq + s - t) - 2*t*(s + t) + psq*(s + 5*t))*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 + psq)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(-2*t*(s + t) + psq*(s + 2*t) + mm^2*(-2*psq + s + 2*t))*
