  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^6*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*
     (gZlR*(psq^2*s + mm^4*(psq - s - t) + mm^2*psq*(psq - s - t)) + 
      2*gZlL*mm^2*psq*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^4*
     (mm^2*(3*psq - 2*s - 3*t) + psq*(3*psq - s - 3*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*
     gZlR*mm^2*(-(psq*s) + 2*mm^2*(psq - t))*(psq^2 - 2*psq*t + t*(s + t))*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*psq*(psq - t)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*(gZlL - gZlR)*mm^4*(psq - t)^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*(gZlL - gZlR)*mm^4*(psq - t)^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^4*(gZlL*s^2 - 2*gZlR*(psq - t)^2)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(psq*(3*psq - 2*s - 3*t) + 
      mm^2*(3*psq - s - 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
    Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*
     (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
   ...
   (3*2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*(psq - t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(mm^2 - psq)*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*psq*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*mm^2*(gZlL*mm^2 + 2*gZlR*mm^2 - 
      gZlR*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/
    Pi^(2*d) - (2^(5 - 2*d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*
     mm^2*(-3*psq^2 + mm^2*(psq - t) - 2*t*(s + t) + psq*(s + 5*t))*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(2*psq*(psq - s - t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFFZ*gFll^2*gZlR*mm^2*(-3*psq^2 + mm^2*(psq - t) - 
