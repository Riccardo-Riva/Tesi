...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 ((EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(2*psq - s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (psq^2 + mm^2*(psq + 2*s - t) - s*t - psq*(2*s + t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
   ...
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (psq^2 + 2*s^2 + mm^2*(psq + 2*s - t) - psq*(5*s + t))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (-((psq + s)*(psq - t)) + mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*psq*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(-2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q2, q2]])/((2*Pi)^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(mm^2 + s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (-psq^2 + 2*s^2 + psq*(-4*s + t) + mm^2*(-psq + 3*s + t))*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/
   (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (mm^2 - psq + 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*
    ggpgpA*gWlN*gWNl*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(2 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (mm^2 - psq - 2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], 
     SP[p1, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*
    gWlN*gWNl*(mm^2 - psq - 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q1]])/(Pi^(2*d)*s) - 
  (4^(2 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (-mm^2 + 2*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*
    gWlN*gWNl*(mm^2 - psq - 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (3*mm^2 + 2*(-3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(mm^2 - psq - 2*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (-3*mm^2 + 2*(psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(mm^2 - psq - 2*s)*
   ...
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[q1, q1]])/
   (Pi^(2*d)*s) - (4^(2 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3], SP[q1, q2]])/
   (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (mm^2 - 2*psq + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*
    gWlN*gWNl*(mm^2 - psq - 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (2*mm^2 + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*
    ggpgpA*gWlN*gWNl*(4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (4*mm^2 - 6*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*
    ggpgpA*gWlN*gWNl*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*
    gWlN*gWNl*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], SP[q2, q2]])/
   (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*
    ggpgpA*gWlN*gWNl*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], 
     SP[p2, p3]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*
    gWlN*gWNl*(mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(mm^2 - t)*
   ...
   (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(psq - t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*
    ggpgpA*gWlN*gWNl*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[p2, p3]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(mm^2 - 2*psq + s + t)*
   ...
   (Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (mm^2 - 2*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*
    ggpgpA*gWlN*gWNl*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(-psq + s + t)*
   ...
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    ...
    gWlN*gWNl*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(mm^2 - t)*
   ...
   (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (-2*mm^2 + psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*
    gWlN*gWNl*(2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(4*mm^2 - 4*psq + s)*
   ...
   (Pi^(2*d)*s) + (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagpW^2*
    ggpgpA*gWlN*gWNl*(2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagpW^2*ggpgpA*gWlN*gWNl*(2*psq - 3*s - 2*t)*
