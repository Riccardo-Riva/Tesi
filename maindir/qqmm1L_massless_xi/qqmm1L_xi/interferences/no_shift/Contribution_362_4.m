...
(PropList[KiraPropagator[q1, mw*Sqrt[GaugeXi[Q]]], 
  ...
  (((-I)*2^(2 - d)*EL^6*gAl*gAu*ggmgmA^2*
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*ggmgmA^2*((-4 + d)*gZlLC*gZuLC - 
   ...
   (I*2^(3 - d)*EL^6*gAl*gAu*ggmgmA^2*(d*gZlRC*(gZuLC - gZuRC)*s + 
