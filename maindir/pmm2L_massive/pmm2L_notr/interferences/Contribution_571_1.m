...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
 ...
 (-(((-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(2*(-2 + d)*mm^4*s - 
      (-4 + d)*psq*s^2 + mm^2*(8*psq^2 - (-8 + d)*s^2 + 8*s*t + 8*t^2 - 
        2*psq*((-2 + d)*s + 8*t)))*\[Mu]^(8 - 2*d))/(4^d*Pi^(2*d)*s^2)) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*((10 - 3*d)*psq^2 + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-4*(-4 + d)*psq^2 + 
     (4 - 11*d + 2*d^2)*psq*s + 8*s^2 + d*s^2 - d^2*s^2 + 
     2*(-16 + 5*d)*psq*t + 24*s*t - 7*d*s*t + 16*t^2 - 6*d*t^2 + 
     mm^2*(4*(1 + d)*psq - (12 - 2*d + d^2)*s - 4*(1 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*((-6 + 5*d)*psq^2 - 8*s^2 + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(8*(-2 + d)*psq^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-((-2 + d)*psq*(psq - s - t)) + 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*(-6 + d)*psq^2 + 16*s^2 - 
  ...
  (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-2*psq + 3*s + 2*t)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-2*(-8 + d)*psq^2 + 4*s^2 + 
  ...
  (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(2*psq + s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-((12 - 6*d + d^2)*psq*s) + 
     2*mm^2*((-8 + d)*psq + (10 - 7*d + d^2)*s - (-8 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((-2 + d)*psq*(psq - t) + 
     mm^2*((2 + d)*psq + (8 - 6*d + d^2)*s - (2 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[q1, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-((-4 + d)*psq*(psq - t)) + 
     mm^2*((-12 + 5*d)*psq - 2*(10 - 6*d + d^2)*s + (12 - 5*d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-2 + d)*psq^2 - 8*s^2 + 
     2*d*s^2 + d*s*t - 8*t^2 + 2*d*t^2 - 
     psq*((20 - 9*d + d^2)*s + 4*(-3 + d)*t) - 
     mm^2*((12 - 8*d)*psq + (12 - 4*d + d^2)*s + 4*(-3 + 2*d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-psq + (-2 + d)*s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((12 - 6*d + d^2)*psq*s - 
     2*mm^2*((12 - 7*d)*psq + (20 - 11*d + d^2)*s + (-12 + 7*d)*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(2*psq + s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(4*(-2 + d)*psq^2 + 
     2*mm^2*((-2 + 4*d)*psq + (2 - 5*d + d^2)*s + 2*t - 4*d*t) - 
     psq*((4 - 5*d + d^2)*s + 2*(-8 + 3*d)*t) + 
     (-4 + d)*((-2 + d)*s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-8 + 3*d)*psq^2 - 4*d*s^2 + 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
   ...
   (Pi^(2*d)*s) - (4^(2 - d)*(-5 + 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((12 - 4*d + d^2)*mm^2 - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((28 - 16*d + d^2)*mm^2 - 
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*(-6 + 5*d)*mm^2 + 8*psq + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*((2 + d)*mm^2 - (2 + d)*psq + 
   ...
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-psq + s + t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    ...
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
  ...
  (4^(1 - d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*d*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(2*psq - 3*s - 2*t)*
   ...
   (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*
    ...
    gHll^2*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-4 + d)^2*EL^8*gAl^4*gAu^2*
    gHll^2*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q2]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^2*(psq - t)*
