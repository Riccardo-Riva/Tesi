...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
   ...
   (-((2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*mm^2*(2*mm^2 - s)*
    ...
    (4^(1 - d)*EL^6*gAl^5*gAu*mm^2*(d^2*(-mm^2 + psq)*s^2 - 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(2*mm^2 - s)*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^5*gAu*(4*(-1 + d)*mm^2 - 
       (-2 + d)*s)*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAl^5*gAu*(mm^2 - psq)*(2*mm^2*(psq - t) - 
       (psq - s - t)*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^5*gAu*
      ((8 - 10*d + d^2)*mm^4*(psq - t) - 2*mm^2*((10 - 15*d + d^2)*psq^2 + 
         4*(-1 + d)*psq*s - (-4 + d)*s^2 - (12 - 22*d + d^2)*psq*t - 
         6*d*s*t + (2 - 7*d)*t^2) + psq*((12 - 8*d + d^2)*psq^2 - 
         (-8 + d)*psq*(2*s + (-2 + d)*t) - 2*(s + t)*(2*s + (-2 + d)*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl^5*gAu*((16 - 14*d + d^2)*psq^3 - 
       ...
       mm^2*((16 - 6*d + d^2)*psq^2 + (s + t)*((12 - 4*d + d^2)*s + 
           (16 - 6*d + d^2)*t) - 2*psq*((6 - d + d^2)*s + (16 - 6*d + d^2)*
            t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/
     (Pi^(2*d)*s) - (4^(1 - d)*(-2 + d)^2*EL^6*gAl^5*gAu*mm^2*
    ...
    (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^5*gAu*(psq - t)*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[p3, q2]])/
     (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^6*gAl^5*gAu*(psq - t)^2*
