...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
 ...
 ((EL^5*gAl*gFFZ*gFll^2*mm^4*
    (bb*(gZlL*(5*psq - 2*s)*s + gZlR*psq*(mm^2 + psq + s)) - 
     aa*(gZlL*(5*psq - 2*s)*s + gZlR*(psq^2 + mm^2*(psq + s))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*gFFZ*gFll^2*mm^4*(-(bb*gZlR*(2*mm^2 + psq)) + 
     aa*gZlR*(mm^2 + 2*psq) + 2*aa*gZlL*(psq - s) - 2*bb*gZlL*(psq - s))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
  (2^(-1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*s*(bb*gZlL*mm^2*(4*psq - s) + 
  ...
  (EL^5*gAl*gFFZ*gFll^2*mm^4*s*(aa*gZlR*(mm^2 - psq) + aa*gZlL*(-4*psq + s) + 
     bb*(gZlR*mm^2 + 4*gZlL*psq - gZlR*psq - gZlL*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^4*
    (aa*(gZlR*mm^2 + 5*gZlL*psq - 2*gZlL*s) - 
     bb*(5*gZlL*psq + gZlR*psq - 2*gZlL*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) - 
  (EL^5*gAl*gFFZ*gFll^2*mm^2*(aa*(gZlL*mm^2*(4*psq - 5*s) + 
       gZlR*(mm^4 + 2*psq*s + mm^2*(psq + s))) - 
  ...
  (2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*(bb*gZlR*psq*s + 
     bb*gZlL*mm^2*(-4*psq + s) + aa*mm^2*(4*gZlL*psq - gZlL*s - gZlR*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (4^(1 - d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^4*(aa*mm^2 - bb*psq)*
  ...
  (4^(1 - d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(aa*mm^2 - bb*psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(mm^2 + psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(bb*mm^2 - aa*psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(aa*mm^2 - bb*psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (2^(1 - 2*d)*EL^5*gAl*gFFZ*gFll^2*mm^2*(aa*gZlL*mm^2 - bb*gZlL*mm^2 + 
     bb*gZlR*(2*mm^2 + psq) - aa*gZlR*(mm^2 + 2*psq))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (2^(3 - 2*d)*EL^5*gAl*gFFZ*gFll^2*gZlR*mm^2*(aa*mm^2 - bb*psq)*
