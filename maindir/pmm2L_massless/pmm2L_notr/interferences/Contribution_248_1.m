...
PropList[KiraPropagator[-p3 - q1, mw], KiraPropagator[p1 + p2 - p3 - q1, mw], 
 ...
 (-((EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/(2*Pi)^(2*d)) - 
  (EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) + (EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*(2*s + t)*
  ...
  (4^(1 - d)*EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*(s - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*(s + t)*
   ...
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*t*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*(s + t)*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl*gAu^2*ggagmW^2*ggmgmA*gWlN*gWNl*t*
