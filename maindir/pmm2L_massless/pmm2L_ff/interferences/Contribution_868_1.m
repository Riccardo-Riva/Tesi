...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, mm]]*((2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^6*t*
      (s + t)^2*\[Mu]^(8 - 2*d))/(mh^2*Pi^(2*d)*s) - 
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^6*(s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/(mh^2*Pi^(2*d)) + 
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(mm^2 - t)*(s + t)^2*
    ...
    (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^6*s*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1]])/(mh^2*Pi^(2*d)) - 
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^6*(s + t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(s + t)*(2*mm^2 + s + t)*
    ...
    (3*4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*t*(s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(mh^2*Pi^(2*d)*s) + 
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^6*\[Mu]^(8 - 2*d)*
    ...
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*t*(2*mm^2 + 3*(s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(mh^2*Pi^(2*d)*s) - 
    (2^(7 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(mm^2 + s + t)*\[Mu]^(8 - 2*d)*
    ...
    (4^(3 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*t^2*\[Mu]^(8 - 2*d)*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^6*t*(s + t)^2*\[Mu]^(8 - 2*d))/
      (mh^2*Pi^(2*d)*s)) + (2^(5 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^6*(s + t)*
