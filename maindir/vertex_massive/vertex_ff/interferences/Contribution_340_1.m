  ...
  (-((4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^4*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (-8*psq^3 + 3*psq^2*(s + 6*t) + psq*(s^2 - 11*s*t - 14*t^2) + 
      ...
      SP[p2, q1]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
     mm^2*(-2*psq^3 - 2*mm^4*(psq - t) + 2*t^2*(s + t) + psq^2*(-4*s + 6*t) + 
      psq*(s^2 + s*t - 6*t^2) + mm^2*(5*psq^2 - 8*psq*t + 3*t*(s + t)))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (-4*psq^3 + 2*mm^4*(psq - t) + 2*t*(s + t)^2 - 2*psq*t*(3*s + 4*t) + 
      psq^2*(s + 10*t) - mm^2*(3*psq^2 - 2*s^2 + psq*(s - 4*t) + t^2))*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(psq - t)*
     (2*psq^2 + psq*(s - 4*t) + mm^2*(psq - 2*s - t) + 2*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (psq^3 - 3*mm^2*(psq - t)*(psq - s - t) - 2*psq^2*t + psq*t*(-2*s + t) + 
    ...
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (psq - t)*(2*psq^2 + 2*t*(s + t) - psq*(s + 4*t) + 
      ...
      SP[q2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
     mm^2*(mm^2*(2*psq - s - 2*t)*(psq - t) + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     ...
     gWNl*mm^2*(2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
      t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1], 
      SP[q2, q2]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     (7*psq^2 + s^2 - mm^2*(psq + s - t) + 4*s*t + 3*t^2 - 2*psq*(2*s + 5*t))*
   ...
   (2^(5 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*(psq - t)^2*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*mm^2*
     ...
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[p3, q1]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[p3, q2]])/Pi^(2*d) - (4^(2 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
     mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFll*gHFW*gHll*gWNl*
