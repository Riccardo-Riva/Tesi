...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (-((4^(1 - d)*EL^6*gAl^3*gAu*mm^2*(gZlL^2*((-28 + 23*d - 5*d^2)*psq^3 + 
           ...
           (s + t)*((-4 + d)*s^2 + 2*(2 - 4*d + d^2)*s*t + 2*(-2 + d)^2*
              t^2) - psq*((-8 - 2*d + d^2)*s^2 + 2*(20 - 22*d + 5*d^2)*s*t + 
             (44 - 39*d + 9*d^2)*t^2) + mm^2*((12 - 5*d + d^2)*psq^2 + 
             (4 - 5*d + d^2)*psq*s - 2*(12 - 5*d + d^2)*psq*t + 
             (12 - 5*d + d^2)*t*(s + t))) + 
         gZlR^2*((-28 + 23*d - 5*d^2)*psq^3 + 2*psq^2*((6 - 9*d + 2*d^2)*s + 
           ...
           psq*((-8 - 2*d + d^2)*s^2 + 2*(20 - 22*d + 5*d^2)*s*t + 
             ...
             (12 - 5*d + d^2)*t*(s + t))) - 2*gZlL*gZlR*
          (-2*(10*psq^3 + s^3 - 3*s^2*t - 6*s*t^2 - 2*t^3 - 
             2*psq^2*(6*s + 11*t) + psq*(-4*mm^2*s + s^2 + 22*s*t + 14*
                t^2)) + d*(23*psq^3 + s^3 - 7*s^2*t - 16*s*t^2 - 8*t^3 - 
             18*psq^2*(s + 3*t) + psq*(2*s^2 + 44*s*t + 39*t^2) - 
             5*mm^2*(psq^2 + psq*(s - 2*t) + t*(s + t))) + 
           d^2*(-5*psq^3 + 2*t*(s + t)^2 + 4*psq^2*(s + 3*t) - 
             psq*(s^2 + 10*s*t + 9*t^2) + mm^2*(psq^2 + psq*(s - 2*t) + t*
                (s + t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
       (mz^2*Pi^(2*d)*s)) - (4^(1 - d)*EL^6*gAl^3*gAu*mm^2*
       (-2*gZlL*gZlR*((4 + 3*d - d^2)*psq^3 + (8 - 5*d + d^2)*mm^2*
           (psq - t)^2 - psq^2*((12 - 5*d + d^2)*s + 2*(2 + 7*d - 2*d^2)*t) + 
          psq*((-2 + d)*s^2 + (12 + 3*d - d^2)*s*t + (-4 + 19*d - 5*d^2)*
