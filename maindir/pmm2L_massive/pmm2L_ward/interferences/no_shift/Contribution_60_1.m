(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*(s + t)*
   ...
   (I*4^(1 - d)*(aa - bb)*(20 - 10*d + d^2)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*(12 - 8*d + d^2)*EL^5*gAl*gWlN*gWNl*
     ...
     gWNl*gZlL*gZNL*(s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[q2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gWlN*
     gWNl*gZlL*gZNL*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gWlN*gWNl*gZlL*
     gZNL*((24 - 10*d + d^2)*s + (20 - 10*d + d^2)*t)*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(20 - 10*d + d^2)*EL^5*gAl*gWlN*gWNl*gZlL*gZNL*t*
