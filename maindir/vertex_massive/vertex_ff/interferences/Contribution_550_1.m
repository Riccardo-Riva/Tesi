...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*(mm^2 - psq)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*mm^2*(psq - t)*
   ...
   (2^(1 - 2*d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*
     (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*ggpgpA*ggpgpAZ*(gZlL + gZlR)*(psq - t)*
