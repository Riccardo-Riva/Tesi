...
PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, 0], 
  ...
  (-((2^(-1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
      (2*(-2 + d)*mm^4 + mm^2*(-4*(-1 + d)*psq + (-5 + d)*s) + 
       s*((-3 + d)*psq - (-2 + d)*s))*\[Mu]^(8 - 2*d))/(mz^2*Pi^(2*d))) + 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-3 + d)*mm^4 + 
      s*((-3 + d)*psq - (-2 + d)*s) - mm^2*((-1 + d)*psq + (5 + d)*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(mz^2*(2*Pi)^(2*d)) + 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-2 + d)*mm^4 + 
      s*((-8 + 3*d)*psq - 2*(-2 + d)*s) - mm^2*(2*(-1 + d)*psq + (4 + d)*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(mz^2*(2*Pi)^(2*d)) + 
   (2^(-1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-6 + 4*d)*mm^4 + s*((-3 + d)*psq - 2*(-2 + d)*s) + 
      mm^2*((10 - 6*d)*psq + (-15 + 4*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/(mz^2*Pi^(2*d)) - 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-3 + d)*mm^4 + 
      s*((-3 + d)*psq - (-2 + d)*s) - mm^2*((-1 + d)*psq + (5 + d)*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-3 + d)*mm^4 - 2*s^2 - 
      mm^2*((-1 + d)*psq + (2 + d)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
    (mz^2*(2*Pi)^(2*d)) + (2^(-1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*s*((-3 + d)*mm^2 - (-3 + d)*psq + (-2 + d)*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(mz^2*Pi^(2*d)) - 
   (2^(-1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (2*(-3 + d)*mm^4 - s*((-7 + d)*psq + 4*s) - 
      mm^2*(2*(-5 + d)*psq + (9 + 2*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/(mz^2*Pi^(2*d)) - 
   (2^(-1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (2*(-3 + d)*mm^4 + (-2 + d)*s^2 - mm^2*(2*(-5 + d)*psq + (2 + d)*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(mz^2*Pi^(2*d)) + 
   (4^(1 - d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p2]])/(mz^2*Pi^(2*d)) + 
   (2^(1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((3 + d)*mm^2 - (-3 + d)*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, q1]])/(mz^2*Pi^(2*d)) + 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(11*mm^2 - (-3 + d)*(psq - 2*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(mz^2*(2*Pi)^(2*d)) - 
   (2^(3 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p2, q1]])/(mz^2*Pi^(2*d)) - 
   (4^(1 - d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*mm^2 + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(mz^2*Pi^(2*d)) - 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-1 + d)*mm^2 - (-3 + d)*psq + 
      (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)) - (2^(1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (4*mm^2 + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
    (mz^2*Pi^(2*d)) + (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(-4*mm^2 + d*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (2^(1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((1 + d)*mm^2 + (5 - 2*d)*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/(mz^2*Pi^(2*d)) + 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(-2*mm^4 + mm^2*(2*psq + 3*s) + 
      s*((13 - 4*d)*psq + (-8 + 3*d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (2^(1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((3 + d)*mm^2 - (-3 + d)*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)) - 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*((1 + 2*d)*mm^2 + psq - d*psq + 
      4*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    (mz^2*(2*Pi)^(2*d)) - (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-1 + d)*mm^2 + (5 - 2*d)*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q1]])/(mz^2*(2*Pi)^(2*d)) - 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*((5 + 2*d)*mm^2 + (3 - 2*d)*psq + 
      d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/
    (mz^2*(2*Pi)^(2*d)) - (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     ((-1 + d)*mm^2 - (-5 + d)*psq - 2*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(-2*mm^4 + (-2 + d)*s^2 + 
      2*mm^2*(psq - (-2 + d)*s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p1, q2]])/(mz^2*(2*Pi)^(2*d)*s) - 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(11*mm^2 - (-3 + d)*(psq - 2*s))*
   ...
   (2^(-1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (2*(-6 + d)*mm^2 - 4*(-4 + d)*psq + (-10 + 3*d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)) - 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*mm^2 - 2*psq + d*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (4^(1 - d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)) + 
   (4^(1 - d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(2*mm^2 + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)) + 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-1 + d)*mm^2 - (-3 + d)*psq + 
      (-2 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)) + (2^(1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (4*mm^2 + s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
    (mz^2*Pi^(2*d)) + (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(4*mm^2 - d*s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/(mz^2*(2*Pi)^(2*d)) + 
   (4^(1 - d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/(mz^2*Pi^(2*d)) + 
   (EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*((-5 + d)*mm^2 - (-3 + d)*psq + 
      (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)) + (2^(1 - 2*d)*(-1 + d)*EL^6*gAl^3*ggmgmA*ggmgmZ*
   ...
   (4^(1 - d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p1, q2]])/
    (mz^2*Pi^(2*d)) - (2^(3 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, q1]])/
    (mz^2*Pi^(2*d)) + (4^(1 - d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[p2, q2]])/
    (mz^2*Pi^(2*d)) + ((-2 + d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[q1, q1]])/
    (mz^2*(2*Pi)^(2*d)) + (4^(1 - d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*
    ...
    (mz^2*Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
    ...
    (mz^2*Pi^(2*d)) + (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*ggmgmA*ggmgmZ*
     (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p2, q1]])/(mz^2*Pi^(2*d)) + (2^(1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
 ...
 PropList[KiraPropagator[p1 - q1, mm], KiraPropagator[p2 - q1, mz], 
  ...
  ((2^(-1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*s*
   ...
   (4^(1 - d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p1, p2], SP[q2, q2]])/(mz^2*Pi^(2*d)) + 
   (2^(1 - 2*d)*EL^6*gAl^3*ggmgmA*ggmgmZ*(gZlL + gZlR)*
     (-mm^2 + psq + (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
