...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((3*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*gFll^2*mm^4*psq*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) + (4^(1 - d)*(aa - bb)*EL^5*gAl*gFFA^2*
     gFll^2*mm^4*(psq - s)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
   (EL^5*gAl*gFFA^2*gFll^2*mm^2*s*(2*aa*psq*(3*mm^2 + psq - s) - 
      bb*(mm^2*(6*psq - 3*s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/(2*Pi)^(2*d) - 
   (EL^5*gAl*gFFA^2*gFll^2*mm^2*(mm^2 - psq)*s*(2*aa*(psq - s) - 
      bb*(2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2*Pi)^(2*d) + 
   (3*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFA^2*gFll^2*mm^4*psq*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gFFA^2*gFll^2*mm^2*
     (-(bb*(mm^2*(4*psq - 3*s) + psq*s)) + 2*aa*(2*mm^2*(psq - s) + psq*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gFFA^2*gFll^2*mm^2*(2*aa*psq*(3*mm^2 + psq - s) - 
      bb*(mm^2*(6*psq - 3*s) + psq*(2*psq + s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*EL^5*gAl*gFFA^2*gFll^2*mm^2*(-2*aa*psq*(psq - 2*s) + 
      2*aa*mm^2*(psq - s) + bb*psq*(2*psq + s) - bb*mm^2*(2*psq + 3*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gFFA^2*gFll^2*mm^2*(-2*aa*psq + bb*(mm^2 + psq))*s*
   ...
   (4^(1 - d)*EL^5*gAl*gFFA^2*gFll^2*mm^2*(-2*aa*psq + bb*(mm^2 + psq))*
