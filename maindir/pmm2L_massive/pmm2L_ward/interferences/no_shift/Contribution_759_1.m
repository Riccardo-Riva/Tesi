...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mw], 
  ...
  (((-I)*4^(1 - d)*(-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (bb*(-((-1 + d)*psq^2) + 2*psq*s - (-1 + d)*mm^2*(psq - t) + 
        (-1 + d)*psq*t - (-3 + d)*s*t) + 
      aa*((-1 + d)*psq^2 + (-1 + d)*mm^2*(psq - s - t) + (-3 + d)*s*(s + t) + 
        psq*(9*s - 3*d*s + t - d*t)))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(2*aa*(-2 + d)^2*mm^2 - 
      bb*(20 - 10*d + d^2)*(psq - s - t) + aa*(20 - 10*d + d^2)*
       (3*psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p1, q2]])/Pi^(2*d) - (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (aa*(2*(-4 + d)*mm^2 + (52 - 26*d + 3*d^2)*psq - 16*s + 8*d*s - d^2*s - 
        20*t + 10*d*t - d^2*t) + bb*(2*(8 - 5*d + d^2)*mm^2 - 
        (12 - 6*d + d^2)*psq + 16*s - 8*d*s + d^2*s + 20*t - 10*d*t + d^2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (bb*(20*s + d^2*(psq + s - t) - 2*d*(psq + 5*s - t)) + 
      aa*(2*(-4 + d)*mm^2 - (-8 + d^2)*psq + (-2 + d)*((-2 + d)*s + d*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*(-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*(2*aa*(-2 + d)*mm^2 - 
      bb*(-4 + d)*(psq - s - t) + aa*(-4 + d)*(3*psq - s - t))*
   ...
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (aa*(2*(12 - 9*d + 2*d^2)*mm^2 + 4*(22 - 11*d + d^2)*psq - 24*s + 
        12*d*s - d^2*s - 40*t + 20*d*t - 2*d^2*t) + 
      bb*(2*(-4 + d)*mm^2 + 4*(-2 + d)*psq + 24*s - 12*d*s + d^2*s + 40*t - 
        20*d*t + 2*d^2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p2, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (bb*(4*(-3 + d)*psq + (20 - 10*d + d^2)*s - 4*(-3 + d)*t) + 
      aa*(2*(8 - 5*d + d^2)*mm^2 - 2*(2 - 3*d + d^2)*psq + 4*s - 4*d*s + 
        d^2*s - 12*t + 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (2*aa*(8 - 5*d + d^2)*mm^2 - bb*(16 - 9*d + d^2)*(psq - s - t) + 
      aa*(16 - 9*d + d^2)*(3*psq - s - t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
   (I*4^(2 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(bb*(psq - s - t) + 
      aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (aa*(2*(-4 + d)*mm^2 + 4*(18 - 9*d + d^2)*psq - 16*s + 8*d*s - d^2*s - 
        40*t + 20*d*t - 2*d^2*t) + bb*(2*(12 - 9*d + 2*d^2)*mm^2 - 
        4*(-2 + d)*psq + 16*s - 8*d*s + d^2*s + 40*t - 20*d*t + 2*d^2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (bb*(2*(-4 + d)*mm^2 + 2*(4 - 3*d + d^2)*psq + 24*s - 12*d*s + d^2*s + 
        4*d*t - 2*d^2*t) + aa*(2*(-4 + d)*mm^2 + (8 + 2*d - 2*d^2)*psq + 
        24*s - 16*d*s + 3*d^2*s - 4*d*t + 2*d^2*t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (aa*(-4*(-3 + d)*psq + (8 - 6*d + d^2)*s + 4*(-3 + d)*t) + 
      bb*(2*(8 - 5*d + d^2)*mm^2 - 2*(14 - 7*d + d^2)*psq + 16*s - 8*d*s + 
        d^2*s + 12*t - 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (2*bb*(8 - 5*d + d^2)*mm^2 + aa*(16 - 9*d + d^2)*(psq - t) + 
      bb*(16 - 9*d + d^2)*(psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
   (I*4^(2 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(bb*(2*mm^2 - psq - t) + 
      aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (aa*(2*(-2 + d)^2*psq + (-28 + 18*d - 3*d^2)*s - 2*(-2 + d)^2*t) - 
      bb*(2*(-2 + d)^2*psq + (20 - 10*d + d^2)*s - 2*(-2 + d)^2*t))*
   ...
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (aa*(2*(8 - 5*d + d^2)*mm^2 + (28 - 14*d + d^2)*psq - 4*s + 2*d*s - 
        20*t + 10*d*t - d^2*t) + bb*(2*(-4 + d)*mm^2 + (12 - 6*d + d^2)*psq + 
        4*s - 2*d*s + 20*t - 10*d*t + d^2*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (bb*(4*(-3 + d)*psq + (20 - 10*d + d^2)*s - 4*(-3 + d)*t) + 
      aa*(2*(8 - 5*d + d^2)*mm^2 - 2*(2 - 3*d + d^2)*psq + 4*s - 4*d*s + 
        d^2*s - 12*t + 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (2*aa*(8 - 5*d + d^2)*mm^2 - bb*(16 - 9*d + d^2)*(psq - s - t) + 
      aa*(16 - 9*d + d^2)*(3*psq - s - t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*(2*bb*(-2 + d)^2*mm^2 + 
      aa*(20 - 10*d + d^2)*(psq - t) + bb*(20 - 10*d + d^2)*(psq + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (aa*(20*s + 2*d*(psq - 6*s - t) + d^2*(-psq + 2*s + t)) + 
      bb*(2*(-4 + d)*mm^2 + (8 - 4*d + d^2)*psq - (-2 + d)*(2*s + d*t)))*
   ...
   (I*4^(1 - d)*(-4 + d)*EL^5*gWlN^2*gWNl^2*gWWA*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q2, q2]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (aa*(-4*(-3 + d)*psq + (8 - 6*d + d^2)*s + 4*(-3 + d)*t) + 
      bb*(2*(8 - 5*d + d^2)*mm^2 - 2*(14 - 7*d + d^2)*psq + 16*s - 8*d*s + 
        d^2*s + 12*t - 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], 
      SP[p3, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gWlN^2*gWNl^2*gWWA*
     (2*bb*(8 - 5*d + d^2)*mm^2 + aa*(16 - 9*d + d^2)*(psq - t) + 
      bb*(16 - 9*d + d^2)*(psq + t))*\[Mu]^(8 - 2*d)*
