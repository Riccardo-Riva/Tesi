...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(-2*gZlL*gZlR*(2*(8 - 6*d + d^2)*psq^2 + 
         mm^2*(2*(8 - 7*d + d^2)*psq - (-4 + 12*d - 6*d^2 + d^3)*s - 
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(3 - 2*d)*EL^8*gAl^4*gAu^2*mm^2*
       (-2*gZlL*gZlR*(2*(8 - 9*d + 2*d^2)*psq^2 + (-42 + 40*d - 12*d^2 + d^3)*
          ...
          4*t^2 - 8*d*t^2 + 2*d^2*t^2) + gZlL^2*(2*(10 - 9*d + 2*d^2)*psq^2 + 
          (-36 + 40*d - 12*d^2 + d^3)*psq*s - 4*s^2 - 2*d*s^2 + d^2*s^2 - 
          2*(14 - 13*d + 3*d^2)*psq*t + 8*s*t - 12*d*s*t + 3*d^2*s*t + 
          8*t^2 - 8*d*t^2 + 2*d^2*t^2 + 4*mm^2*(-psq + s + t)) + 
        gZlR^2*(2*(10 - 9*d + 2*d^2)*psq^2 + (-36 + 40*d - 12*d^2 + d^3)*psq*
           s - 4*s^2 - 2*d*s^2 + d^2*s^2 - 2*(14 - 13*d + 3*d^2)*psq*t + 
          8*s*t - 12*d*s*t + 3*d^2*s*t + 8*t^2 - 8*d*t^2 + 2*d^2*t^2 + 
          4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
