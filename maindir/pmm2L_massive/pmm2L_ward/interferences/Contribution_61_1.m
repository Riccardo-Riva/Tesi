...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 (((-I)*EL^5*gAl*gHll*gHZZ*mm^2*(mm^2 - psq)*s*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*(mm^2 - psq)*
    (2*s + d*(psq - s - t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (4^d*Pi^(2*d)) - (I*EL^5*gAl*gHll*gHZZ*mm^2*
  ...
  (I*(aa - bb)*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*(mm^2 - psq)*
    (-2*s + d*(psq - t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(4^d*Pi^(2*d)) - 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHZZ*mm^2*s*
    (bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
       4*gZlL*gZlR*(2*psq - s - 2*t)) + aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
       (-2 + d)*gZlR^2*(mm^2 - psq) + 4*gZlL*gZlR*(-2*psq + s + 2*t)))*
  ...
  (I*EL^5*gAl*gHll*gHZZ*mm^2*s*(bb*((-2 + d)*gZlL^2*(mm^2 - psq) + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 4*d)*EL^5*gAl*gHll*gHZZ*mm^2*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHZZ*mm^2*
    (bb*((-2 + d)*gZlL^2*(2*mm^2 - psq - t) + (-2 + d)*gZlR^2*
     ...
     aa*((-2 + d)*gZlL^2 + 2*(-4 + d)*gZlL*gZlR + (-2 + d)*gZlR^2)*(psq - t))*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*
   ...
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*gAl*gHll*gHZZ*mm^2*
    (bb*((-2 + d)*gZlL^2*(2*mm^2 - psq - t) + (-2 + d)*gZlR^2*
        (2*mm^2 - psq - t) - 2*(-4 + d)*gZlL*gZlR*(psq - t)) - 
     aa*((-2 + d)*gZlL^2 - 2*(-4 + d)*gZlL*gZlR + (-2 + d)*gZlR^2)*(psq - t))*
