...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*(3*mm^2 + psq)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^6*(-6*psq^2 - psq*s + s^2 + 
       12*psq*t + s*t - 6*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^4*mm^4*(psq^2 + mm^2*s + t^2 - 
       psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gHll^4*mm^4*
