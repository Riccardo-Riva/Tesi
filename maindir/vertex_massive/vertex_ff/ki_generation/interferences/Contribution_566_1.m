   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(psq^2 - 2*psq*t + t*(s + t))*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(psq - t)*
      (-11*psq^2 - 8*t*(s + t) + mm^2*(-9*psq + 4*s + 9*t) + 
       psq*(2*s + 19*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(mm^2*(9*psq - 4*s - 9*t) + 
       psq*(3*psq - 2*s - 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*
      ...
      mm^4*(psq^2 - 2*psq*t + t*(s + t))*(psq*s + mm^2*(-4*psq + s + 4*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(psq^2 - 2*psq*t + t*(s + t))*
      (psq*s + mm^2*(-6*psq + 2*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(-psq + s + t)*
      ...
      mm^4*(-(psq^2*s) + 3*mm^4*(psq - t) + mm^2*(3*psq^2 - 6*psq*s + 2*s^2 - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^6*(psq^2 + 3*mm^2*s + 
       t*(s + t) - 2*psq*(2*s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*
      (-(psq*(psq^2 - 2*psq*t + t*(s + t))) + 
       mm^2*(3*psq^2 + s^2 + 4*s*t + 3*t^2 - 3*psq*(s + 2*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(-(psq*s) + mm^2*(psq - t))*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(psq - t)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(mm^2*(7*psq - 3*s - 7*t) + 
     ...
     Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gAu*gHll^2*gXll^2*mm^4*(4*mm^2 + psq)*
