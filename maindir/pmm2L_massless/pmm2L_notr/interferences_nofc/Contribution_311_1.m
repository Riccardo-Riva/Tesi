...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mz], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (4^(2 - d)*(-8 + 3*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
     ((-2 + d)*s + (-3 + d)*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q1]])/(Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*
     (gZlL + gZlR)*((-6 + d)*s - t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*((-2 + d)*s + d*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
     (4*(-2 + d)*s^2 + 3*(-1 + d)*s*t + 6*t^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*(s - (-3 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*((-5 + d)*s + t)*
   ...
   (4^(3 - d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
   ...
   (2^(7 - 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*(s + t)*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-10 + d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*(s + 2*t)*
   ...
   (4^(3 - d)*(-22 + 5*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (4^(2 - d)*(2 + d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*(-3 + 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*
     ...
     gWWA^2*gWWZ*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[q1, q2]])/(Pi^(2*d)*s) - (5*2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     gWWA^2*gWWZ*(gZlL + gZlR)*(s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
     ((-4 + 3*d)*s - 2*(-2 + d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (4^(3 - d)*(-1 + d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*(s + t)*
   ...
   (9*4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s) - (4^(2 - d)*(-8 + 5*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*
     ...
     (gZlL + gZlR)*((-3 + d)*s + (8 - 5*d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(3 - d)*(-1 + d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*t*
   ...
   (4^(2 - d)*(-3 + 2*d)*EL^8*gAl^2*gAu^2*gWWA^2*gWWZ*(gZlL + gZlR)*(s - 2*t)*
