...
PropList[KiraPropagator[p1 - q1, mw*Sqrt[GaugeXi[W]]], 
 ...
 (((I/9)*2^(1 - d)*EL^6*(cw^2 - sw^2)*(-3 + 8*sw^2)*SPList[SP[p1, q1]])/
   (cw^2*Pi^d*(mz^2 - s)*sw^2) - ((I/9)*EL^6*(cw^2 - sw^2)*(-3 + 8*sw^2)*
    SPList[SP[q1, q1]])/(cw^2*(2*Pi)^d*(mz^2 - s)*sw^2) - 
