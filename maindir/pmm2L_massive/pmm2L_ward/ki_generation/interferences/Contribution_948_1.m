...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
     ...
     (I*4^(1 - d)*EL^5*gAl^3*mm^2*(bb*((8 - 5*d + d^2)*gZlL^2 - 
         ...
         (psq - s - t) + aa*(gZlL^2*(4*mm^2 - (12 - 5*d + d^2)*psq + 
            (8 - 5*d + d^2)*(s + t)) + gZlR^2*(4*mm^2 - (12 - 5*d + d^2)*
             psq + (8 - 5*d + d^2)*(s + t)) + 2*gZlL*gZlR*
           (4*mm^2 + d^2*(psq - s - t) - 4*(s + t) + 5*d*(-psq + s + t))))*
     ...
     (I*4^(1 - d)*EL^5*gAl^3*
       (-(bb*(-2*gZlL*gZlR*((4 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
             ...
             mm^2*(2*(12 - 7*d + d^2)*psq + (2 - 4*d + d^2)*s - (8 - 5*d + 
                 d^2)*t)) + gZlR^2*((8 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*
              psq*s + mm^2*(2*(12 - 7*d + d^2)*psq + (2 - 4*d + d^2)*s - 
               (8 - 5*d + d^2)*t)))) + 
     ...
     (I*4^(1 - d)*EL^5*gAl^3*
       (-(bb*(-2*gZlL*gZlR*((8 - 5*d + d^2)*mm^4 + (12 - 7*d + d^2)*psq*s + 
            ...
            (12 - 7*d + d^2)*psq*s + mm^2*(-4*(-4 + d)*psq + 
