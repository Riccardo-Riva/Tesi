...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
  ...
  (-((4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-3 + d)*s^2 + s*t + 2*t^2)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-2 + d)*s^2 + 3*s*t + 2*t^2)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*(-2*s + (-6 + d)*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^6*gAu^2*((24 - 12*d + d^2)*s - 2*(-2 + d)*t)*
    ...
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*(3*s + 2*t)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((-4 + d)*s + (-6 + d)*t)*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^6*gAu^2*((24 - 12*d + d^2)*s - 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*
     t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[p3, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[q1, q2]])/
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)^2*EL^8*gAl^6*gAu^2*t*\[Mu]^(8 - 2*d)*
