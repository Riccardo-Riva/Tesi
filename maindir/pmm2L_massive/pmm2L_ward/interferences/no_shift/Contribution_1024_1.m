...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   ((I*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*mm^2*s*
     ...
     ((mh^2 - mz^2)*(2*Pi)^(2*d)) + (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gHll*
      gHWW*gWWZ*(gZlL + gZlR)*mm^2*(bb*psq*(-psq + t) + 
    ...
    (I*4^(1 - d)*(aa + bb)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*(gZlL + gZlR)*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)) - (I*4^(1 - d)*(-1 + d)*EL^5*gAl*gHll*gHWW*gWWZ*
      (gZlL + gZlR)*mm^2*(bb*(2*mm^2 - psq + s - t) - aa*(psq + s - t))*
