...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZZ*(d^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s - 
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZZ*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFFZZ*(18*(gZlL^2 + gZlR^2)*s + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*(gZlL^2 + gZlR^2)*
     (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFFZZ*
