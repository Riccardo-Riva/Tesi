...
PropList[KiraPropagator[-q1, mw], KiraPropagator[p1 - q2, mz], 
 ...
 (-((2^(-1 - 2*d)*EL^6*gAl*gFFAZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     (2*(-1 + d)*mm^2 - 2*(-5 + d)*psq + (-2 + 3*d)*s)*\[Mu]^(8 - 2*d))/
    Pi^(2*d)) + ((2 + d)*EL^6*gAl*gFFAZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/(2*Pi)^(2*d) + 
  (d*EL^6*gAl*gFFAZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*\[Mu]^(8 - 2*d)*
