...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^4*s*
   ...
   (4^(1 - d)*d*EL^5*gAl^3*gHll^2*mm^4*(6*aa*mm^2*psq + bb*s*(-3*psq + s) - 
      aa*s*(psq + s) + bb*mm^2*(-6*psq + 4*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1]])/Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*
     mm^4*(aa*(psq - s)*s + bb*s*(-3*psq + s) + bb*mm^2*(-2*psq + s) + 
      aa*mm^2*(2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^4*s*(mm^2 + 2*psq + s)*
   ...
   (2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*s*
     ...
     SPList[SP[q1, q2]])/Pi^(2*d) + (2^(3 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^4*
     (-(aa*s) + bb*(2*mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^4*(aa*(psq - s) + 
      bb*(mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    Pi^(2*d) + (2^(3 - 2*d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^4*
   ...
   (4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^4*(2*psq - s)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(-(aa*psq*s) - bb*psq*s + 
