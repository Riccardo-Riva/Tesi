...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mz], 
 ...
 (((-2 + d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-2 + d)*s^2 + 4*s*t + 4*t^2)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*(2*(-4 + d)*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-6 + d)*s^2 - 8*s*t - 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-2 + d)*s^2 - 4*t^2)*
  ...
  (EL^8*gAl^2*gAu^2*(gZlL^4 + gZlR^4)*((-136 + 76*d - 14*d^2 + d^3)*s^2 + 
