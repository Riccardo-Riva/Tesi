...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
  ...
  ((I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*mm^6*(mm^2 - psq)^2*s*
   ...
   (I*4^(1 - d)*(aa + bb)*EL^5*gAl*gHll^4*mm^6*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa + bb)*EL^5*gAl*gHll^4*
     mm^4*(mm^2 - psq)^2*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
   ...
   (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
   (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^6*(bb*(psq - s - t) + 
      aa*(4*mm^2 - 5*psq + s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) - 
   (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^4*(mm^2 - psq)*(aa*(mm^2 - psq) + 
      bb*(-5*mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^4*mm^6*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^4*(mm^2*(9*psq - 5*s - 9*t) + 
    ...
    Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^4*mm^6*(-4*psq + s + 4*t)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl*gHll^4*mm^4*(bb*(psq - t) + aa*(mm^2 - 2*psq + t))*
