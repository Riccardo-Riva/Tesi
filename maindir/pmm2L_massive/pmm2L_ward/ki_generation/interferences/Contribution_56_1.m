...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
   ...
   ((I*2^(1 - 2*d)*(aa + bb)*(-2 + d)^2*EL^5*gAl^5*mm^2*(mm^2 - psq)^2*s*
    ...
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^5*(mm^2 - psq)*(bb*(psq - s - t) + 
    ...
    (I*4^(1 - d)*EL^5*gAl^5*mm^2*(aa*(12*(2*psq - s - 2*t) + 
         d^2*(2*psq - s - 2*t) + 2*d*(2*mm^2 - 12*psq + 5*s + 10*t)) + 
    ...
    (I*4^(1 - d)*(-2 + d)*EL^5*gAl^5*
     ...
     Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^5*
      (aa*(-8*psq^2 - 4*mm^2*s + d^2*(mm^2 - psq)*(psq - s - t) + 
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl^5*mm^2*(12*s + d^2*s + 
       d*(-4*psq - 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
    ...
    (I*2^(3 - 2*d)*EL^5*gAl^5*(aa*((16 - 10*d + d^2)*mm^2 - 
       ...
       bb*((20 - 10*d + d^2)*psq + 4*s - (20 - 10*d + d^2)*t))*
    ...
    (I*4^(1 - d)*EL^5*gAl^5*(bb*((8 - 6*d + d^2)*mm^2 - 2*(-2 + d)*psq + 
         4*s - 12*t + 8*d*t - d^2*t) + aa*((16 - 10*d + d^2)*mm^2 - 
         2*(14 - 9*d + d^2)*psq - 4*s + 12*t - 8*d*t + d^2*t))*
    ...
    (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^5*(bb*(2*mm^2 - psq - t) + 
       aa*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
