...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   (((-I)*EL^6*gAl^2*gAu^2*(s + t)*
         ...
         gZuLC*(-(d^3*(2*Pi)^d*s*t) + 2^(1 + d)*Pi^d*(2*(8 - 6*d + d^2)*s^2 + 
          ...
          (2*(-2 + d)^2*s^2 + (56 - 30*d + 3*d^2 + d^3)*s*t + 
           ...
           2^(1 + d)*Pi^d*(2*(8 - 6*d + d^2)*s^2 + (52 - 33*d + 3*d^2 + d^3)*
              s*t + (-20 + 20*d - 8*d^2 + d^3)*t^2))))*\[Mu]^(4 - d)*
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*((-128 + 88*d - 18*d^2 + d^3)*gZlLC*gZuLC - 
       ...
       (-128 + 88*d - 18*d^2 + d^3)*gZlRC*gZuRC)*(s + t)*\[Mu]^(4 - d)*
  ...
  PropList[KiraPropagator[q1, 0], KiraPropagator[-p1 + q1, 0], 
   ...
   ((I*EL^6*gAl^2*gAu^2*(s + t)*\[Mu]^(4 - d)*
    ...
    (I*EL^6*gAl^2*gAu^2*t*(s + t)*\[Mu]^(4 - d)*
     ...
     ((2*Pi)^(2*d)*(mzC^2 - s)) + (I*EL^6*gAl^2*gAu^2*s*\[Mu]^(4 - d)*
     ...
     ((2*Pi)^d*(mzC^2 - s)) - (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
      ((-4 + d)*gZlLC*gZuLC - (-2 + d)*gZlRC*gZuLC - (-2 + d)*gZlLC*gZuRC + 
       (-4 + d)*gZlRC*gZuRC)*(s + t)^2*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])^2*
    ...
    (I*2^(3 - d)*EL^6*gAl^2*gAu^2*(gZlLC + gZlRC)*(gZuLC + gZuRC)*(s + t)^2*
    ...
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*t*
      (gZlLC*(2*(-2 + d)*gZuLC*s - 2*(-4 + d)*gZuRC*s + d*gZuLC*t - 
         ...
         2*(-2 + d)*gZuRC*s - (-6 + d)*gZuLC*t + d*gZuRC*t))*\[Mu]^(4 - d)*
     ...
     (Pi^d*(mzC^2 - s)) - (I*2^(2 - d)*EL^6*gAl^2*gAu^2*
      (gZlLC*gZuLC*((-2 + d)*s^2 - 2*t^2) + gZlRC*gZuRC*
       ...
       gZlLC*gZuRC*((-4 + d)*s^2 + 2*t^2))*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])^2*
    ...
    (I*EL^6*gAl^2*gAu^2*\[Mu]^(4 - d)*
     ...
     ((2*Pi)^(2*d)*(mzC^2 - s)) + (I*2^(1 - d)*EL^6*gAl^2*gAu^2*s*
      (6*gZlRC*gZuLC*s + d*(gZlLC - gZlRC)*(gZuLC - gZuRC)*s + 
       ...
       4*gZlLC*gZuRC*t + 4*gZlRC*gZuRC*t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])^2*
    ...
    (I*2^(3 - d)*EL^6*gAl^2*gAu^2*((-4 + d)*gZlLC*gZuLC - 
      ...
      (s + t)*\[Mu]^(4 - d)*(-1 + GaugeXi[Q])^2*SPList[SP[p1, q1], 
       SP[p2, q1], SP[p3, q1], SP[q1, q1]])/(Pi^d*(mzC^2 - s)) + 
    (I*2^(1 - d)*EL^6*gAl^2*gAu^2*
      (gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 2*(-3 + d)*gZuLC*t - 
         2*(-3 + d)*gZuRC*t) + gZlRC*(-((-4 + d)*gZuLC*s) + 
         (-2 + d)*gZuRC*s - 2*(-3 + d)*gZuLC*t + 2*(-3 + d)*gZuRC*t))*
    ...
    (I*2^(2 - d)*EL^6*gAl^2*gAu^2*(gZlLC + gZlRC)*(gZuLC + gZuRC)*s*
      \[Mu]^(4 - d)*(-1 + GaugeXi[Q])^2*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q1, q1], SP[q1, q1]])/(Pi^d*(-mzC^2 + s))))/4
