...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 ((EL^8*gAl^2*gAu^2*gFll^2*gZNL*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZNL*mm^2*((-2 + d)*gZlL*mm^2*s + 
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZNL*mm^2*((-4 + d)*gZlL*mm^2*s + 
     gZlR*(2*mm^4 + mm^2*(-4*psq + s) + psq*(2*psq + 3*s - d*s)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZNL*mm^2*((-4 + d)*gZlL*mm^2*s + 
     gZlR*(2*mm^4 + mm^2*(-4*psq + s) + psq*(2*psq + 3*s - d*s)))*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*
    (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
     ...
     SP[p3, q1]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*
    gZNL*mm^2*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
     mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*
    gZNL*mm^2*(8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
     mm^2*(-4*psq + 6*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) - (EL^8*gAl^2*gAu^2*gFll^2*gZNL*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*
    (8*psq^2 - 2*s^2 + d*s^2 + 4*s*t + 4*t^2 - 6*psq*(s + 2*t) + 
     ...
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (EL^8*gAl^2*gAu^2*gFll^2*gZNL*mm^2*
    (gZlR*s*(-((8 - 6*d + d^2)*psq) + 2*(-4 + d)*s - 4*t) - 
  ...
  (EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*
  ...
  (EL^8*gAl^2*gAu^2*gFll^2*gZNL*mm^2*(4*(-2 + d)*gZlL*mm^2*s + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(2*mm^2 - 2*psq + s)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*
    gZNL*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*
    gZNL*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p2, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZNL*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*
    mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*
    gZNL*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
     SP[p2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*
    gZNL*mm^2*(4*mm^2 - 4*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(4*mm^2 - 4*psq + s)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*
    (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*
    gZNL*mm^2*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(-2*psq + 3*s + 2*t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(2*(-4 + d)*psq + 
     (20 - 10*d + d^2)*s - 2*(-4 + d)*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2], SP[q2, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZNL*mm^2*((-2 + d)*gZlL*mm^2 - 
  ...
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(-psq + s + t)*
  ...
  (4^(1 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(mm^2 - t)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(-2*psq + s + 2*t)*
  ...
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*
    gZNL*mm^2*(-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll^2*gZlR*gZNL*mm^2*(2*psq + s - 2*t)*
