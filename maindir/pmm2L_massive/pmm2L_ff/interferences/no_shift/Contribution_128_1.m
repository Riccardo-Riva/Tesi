...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
  ...
  ((4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*
     ...
     SPList[SP[p3, q2]])/Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFFZ*gHFF*gHll*
     (gZlL + gZlR)*mh^2*mm^2*(-psq + s + t)*(mm^2 - 3*psq + 2*(s + t))*
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*mm^2*(psq - t)*
    ...
    (Pi^(2*d)*s) + (4^(2 - d)*EL^6*gAu*gFFA*gFFZ*gHFF*gHll*(gZlL + gZlR)*mh^2*
     ...
     (gZlL + gZlR)*mh^2*mm^2*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*
