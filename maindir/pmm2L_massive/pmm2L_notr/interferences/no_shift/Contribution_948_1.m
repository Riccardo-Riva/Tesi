...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, ml]]*((4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
      (gZlL + gZlR)^2*ml^2*mm^2*(-4*psq^2 - 2*(-2 + d)*mm^2*s + 
       2*(-2 + d)*psq*s - 6*s^2 + d*s^2 + 8*psq*t - 4*s*t - 4*t^2)*
      \[Mu]^(8 - 2*d))/(mz^2*Pi^(2*d)*s^2) + 
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*
      (d^2*(mm^2 - psq)*s + d*(2*psq^2 + 3*psq*s + 3*s^2 - 4*mm^2*(psq - t) - 
         4*psq*t + 3*s*t + 2*t^2) + 2*(-2*psq^2 + 2*mm^2*s - 5*s^2 - 5*s*t - 
         2*t^2 + psq*(s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     (mz^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*mm^2*
      (-2*gZlL*gZlR*(2*(8 - 9*d + 2*d^2)*psq^2 + (-42 + 40*d - 12*d^2 + d^3)*
          psq*s + 10*s^2 - 6*d*s^2 + d^2*s^2 + 4*mm^2*(psq - s - t) - 
         2*(10 - 13*d + 3*d^2)*psq*t + 10*s*t - 12*d*s*t + 3*d^2*s*t + 
         4*t^2 - 8*d*t^2 + 2*d^2*t^2) + gZlL^2*(2*(10 - 9*d + 2*d^2)*psq^2 + 
         (-36 + 40*d - 12*d^2 + d^3)*psq*s - 4*s^2 - 2*d*s^2 + d^2*s^2 - 
         2*(14 - 13*d + 3*d^2)*psq*t + 8*s*t - 12*d*s*t + 3*d^2*s*t + 8*t^2 - 
         8*d*t^2 + 2*d^2*t^2 + 4*mm^2*(-psq + s + t)) + 
       gZlR^2*(2*(10 - 9*d + 2*d^2)*psq^2 + (-36 + 40*d - 12*d^2 + d^3)*psq*
          s - 4*s^2 - 2*d*s^2 + d^2*s^2 - 2*(14 - 13*d + 3*d^2)*psq*t + 
         8*s*t - 12*d*s*t + 3*d^2*s*t + 8*t^2 - 8*d*t^2 + 2*d^2*t^2 + 
         4*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
     (mz^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*
      (d^2*(mm^2 - psq)*s + 2*(-2*psq^2 + 2*mm^2*s - 5*psq*s - 2*s^2 + 
         4*psq*t + s*t - 2*t^2) + d*(2*psq^2 + 5*psq*s + 2*s^2 + 
         4*mm^2*(psq - s - t) - 4*psq*t + s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1]])/(mz^2*Pi^(2*d)*s^2) + 
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*mm^2*
      (-2*gZlL*gZlR*(2*(-4 + d)*psq^2 + (-18 + 22*d - 8*d^2 + d^3)*psq*s + 
         4*s^2 - 2*d*s^2 - 4*mm^2*(psq - t) - 2*(-2 - 3*d + d^2)*psq*t - 
         2*s*t - 4*d*s*t + d^2*s*t + 4*t^2 - 8*d*t^2 + 2*d^2*t^2) + 
       gZlL^2*(2*(-2 + d)*psq^2 + (-24 + 22*d - 8*d^2 + d^3)*psq*s - 4*s^2 + 
         2*d*s^2 + 4*mm^2*(psq - t) - 2*(2 - 3*d + d^2)*psq*t + 8*s*t - 
         4*d*s*t + d^2*s*t + 8*t^2 - 8*d*t^2 + 2*d^2*t^2) + 
       gZlR^2*(2*(-2 + d)*psq^2 + (-24 + 22*d - 8*d^2 + d^3)*psq*s - 4*s^2 + 
         2*d*s^2 + 4*mm^2*(psq - t) - 2*(2 - 3*d + d^2)*psq*t + 8*s*t - 
         4*d*s*t + d^2*s*t + 8*t^2 - 8*d*t^2 + 2*d^2*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*
      (-4*d*mm^2 + 18*s - 9*d*s + d^2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
     (mz^2*Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^4*gAu^2*mm^2*
      (-2*gZlL*gZlR*(4*(8 - 6*d + d^2)*psq^2 - 2*(12 - 6*d + d^2)*mm^2*s + 
         4*s^2 + 8*d*s^2 - 6*d^2*s^2 + d^3*s^2 + 32*s*t - 24*d*s*t + 
         4*d^2*s*t + 32*t^2 - 24*d*t^2 + 4*d^2*t^2 - 2*(-2 + d)*psq*
          ((-2 + d)*s + 4*(-4 + d)*t)) + gZlL^2*(4*(-2 + d)^2*psq^2 + 
         2*(12 - 6*d + d^2)*mm^2*s - 40*s^2 + 28*d*s^2 - 8*d^2*s^2 + 
         d^3*s^2 + 16*s*t - 16*d*s*t + 4*d^2*s*t + 16*t^2 - 16*d*t^2 + 
         4*d^2*t^2 - 2*(-2 + d)*psq*((-10 + 3*d)*s + 4*(-2 + d)*t)) + 
       gZlR^2*(4*(-2 + d)^2*psq^2 + 2*(12 - 6*d + d^2)*mm^2*s - 40*s^2 + 
         28*d*s^2 - 8*d^2*s^2 + d^3*s^2 + 16*s*t - 16*d*s*t + 4*d^2*s*t + 
         16*t^2 - 16*d*t^2 + 4*d^2*t^2 - 2*(-2 + d)*psq*((-10 + 3*d)*s + 
           4*(-2 + d)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
     (mz^2*Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
      (gZlL + gZlR)^2*ml^2*(4*psq^2 + 2*(-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 
       4*s*t + 4*t^2 - 2*psq*((-4 + d)*s + 4*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(1 - d)*EL^8*gAl^4*gAu^2*(gZlL^2*(2*(12 - 6*d + d^2)*mm^4*s + 
         (-2 + d)*s*(4*psq^2 + (22 - 11*d + d^2)*psq*s + (-2 + d)*s^2 - 
           8*psq*t + 4*s*t + 4*t^2) + mm^2*(4*(-4 + d)*psq^2 + 
           (-36 + 28*d - 8*d^2 + d^3)*s^2 + 4*(-4 + d)*s*t + 4*(-4 + d)*t^2 - 
       ...
       2*gZlL*gZlR*(2*(12 - 6*d + d^2)*mm^4*s - (-4 + d)*s*
          (4*psq^2 + (16 - 9*d + d^2)*psq*s + (-2 + d)*s^2 - 8*psq*t + 
           4*s*t + 4*t^2) + mm^2*(4*(-4 + d)*psq^2 - 
           2*psq*((12 - 6*d + d^2)*s + 4*(-4 + d)*t) - 
           (-4 + d)*(-2*d*s^2 + d^2*s^2 - 4*t*(s + t)))))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(2 - d)*EL^8*gAl^4*gAu^2*
      (gZlL^2*((-2 + d)*psq*(psq + (-3 + d)*s - t) + 
         mm^2*(-((6 - 4*d + d^2)*psq) + (10 - 6*d + d^2)*s + 
           (6 - 4*d + d^2)*t)) + gZlR^2*((-2 + d)*psq*(psq + (-3 + d)*s - 
           t) + mm^2*(-((6 - 4*d + d^2)*psq) + (10 - 6*d + d^2)*s + 
           (6 - 4*d + d^2)*t)) + 2*gZlL*gZlR*
        (d^2*(-(psq*s) + mm^2*(psq - s - t)) + 
         4*(psq^2 + mm^2*s - psq*(3*s + t)) + d*(psq*(-psq + 7*s + t) + 
           mm^2*(-4*psq + 2*s + 4*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*
     ...
     (mz^2*Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^4*gAu^2*
      (gZlL^2*(-4*mm^4 - (14 - 11*d + 2*d^2)*psq*(psq - s - t) + 
         mm^2*((-2 + 12*d - 3*d^2)*psq + (8 - 6*d + d^2)*s + 
           3*(2 - 4*d + d^2)*t)) + gZlR^2*(-4*mm^4 - (14 - 11*d + 2*d^2)*psq*
          (psq - s - t) + mm^2*((-2 + 12*d - 3*d^2)*psq + (8 - 6*d + d^2)*s + 
           3*(2 - 4*d + d^2)*t)) - 2*gZlL*gZlR*(4*mm^4 + 
         mm^2*((-16 + 12*d - 3*d^2)*psq + (-2 - 2*d + d^2)*s + 
           3*(-2 + d)^2*t) + psq*((-16 + 11*d - 2*d^2)*psq + 
           (22 - 13*d + 2*d^2)*s + (16 - 11*d + 2*d^2)*t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*
     ...
     (mz^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*
      (2*gZlL*gZlR*(-2*(8 - 6*d + d^2)*psq^2 + mm^2*(2*(8 - 7*d + d^2)*psq + 
           (-20 + 26*d - 8*d^2 + d^3)*s - 2*(8 - 7*d + d^2)*t) + 
         2*psq*((10 - 6*d + d^2)*s + 2*(8 - 6*d + d^2)*t) - 
         (-4 + d)*(2*(-3 + d)*s^2 + (-8 + 3*d)*s*t + 2*(-2 + d)*t^2)) + 
       gZlL^2*(mm^2*(-2*(4 - 3*d + d^2)*psq - (-40 + 30*d - 10*d^2 + d^3)*s + 
           2*(4 - 3*d + d^2)*t) + (-2 + d)*(2*(-2 + d)*psq^2 + 
           (14 - 4*d)*psq*s + 2*(-3 + d)*s^2 - 4*(-2 + d)*psq*t + 
           (-8 + 3*d)*s*t + 2*(-2 + d)*t^2)) + 
       gZlR^2*(mm^2*(-2*(4 - 3*d + d^2)*psq - (-40 + 30*d - 10*d^2 + d^3)*s + 
           2*(4 - 3*d + d^2)*t) + (-2 + d)*(2*(-2 + d)*psq^2 + 
           (14 - 4*d)*psq*s + 2*(-3 + d)*s^2 - 4*(-2 + d)*psq*t + 
    ...
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(-2*gZlL*gZlR*((64 - 30*d + 4*d^2)*psq^2 + 
         ...
         20*d*t^2 + 2*d^2*t^2 + mm^2*(2*(4 - 3*d + d^2)*psq - 6*d*s + 
           4*d^2*s - d^3*s - 8*t + 6*d*t - 2*d^2*t) - 
         psq*((-16 + 26*d - 9*d^2 + d^3)*s + 2*(56 - 25*d + 3*d^2)*t)) + 
       gZlL^2*(mm^2*(2*(8 - 7*d + d^2)*psq - (-12 + 10*d - 6*d^2 + d^3)*s - 
           2*(8 - 7*d + d^2)*t) - (-4 + d)*((10 - 4*d)*psq^2 + 
           (4 - 3*d + d^2)*psq*s + 6*(-3 + d)*psq*t + (10 - 3*d)*s*t - 
           2*(-4 + d)*t^2)) + gZlR^2*(mm^2*(2*(8 - 7*d + d^2)*psq - 
           (-12 + 10*d - 6*d^2 + d^3)*s - 2*(8 - 7*d + d^2)*t) - 
    ...
    (4^(2 - d)*EL^8*gAl^4*gAu^2*
      (2*gZlL*gZlR*(4*mm^4 + mm^2*((8 - 12*d + 3*d^2)*psq - 
           2*(7 - 5*d + d^2)*s - 3*(-2 + d)^2*t) + 
         psq*((16 - 11*d + 2*d^2)*psq - 2*(-3 + d)*s + (-16 + 11*d - 2*d^2)*
            t)) + gZlL^2*(4*mm^4 - (14 - 11*d + 2*d^2)*psq*(psq - t) + 
         mm^2*((-10 + 12*d - 3*d^2)*psq + 2*(-1 - 3*d + d^2)*s + 
           3*(2 - 4*d + d^2)*t)) + gZlR^2*(4*mm^4 - (14 - 11*d + 2*d^2)*psq*
          (psq - t) + mm^2*((-10 + 12*d - 3*d^2)*psq + 2*(-1 - 3*d + d^2)*s + 
           3*(2 - 4*d + d^2)*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2*((-48 + 26*d - 4*d^2)*psq^2 + 
         ...
         mm^2*(4*psq + (-24 + 18*d - 7*d^2 + d^3)*s - 4*t) + 
         ...
         8*s^2 - 2*d*s^2 + mm^2*(4*psq - (-12 + 18*d - 7*d^2 + d^3)*s - 
    ...
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*(psq - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (4^(2 - d)*EL^8*gAl^4*gAu^2*
      (gZlL^2*((-2 + d)*psq*(-psq + (-2 + d)*s + t) + 
         mm^2*((6 - 4*d + d^2)*psq - 2*(-2 + d)*s - (6 - 4*d + d^2)*t)) + 
       gZlR^2*((-2 + d)*psq*(-psq + (-2 + d)*s + t) + 
         mm^2*((6 - 4*d + d^2)*psq - 2*(-2 + d)*s - (6 - 4*d + d^2)*t)) - 
       2*gZlL*gZlR*(d^2*(psq*s + mm^2*(psq - t)) + 
         4*(psq^2 - mm^2*s + 2*psq*s - psq*t) + 
         d*(psq*(-psq - 6*s + t) + mm^2*(-4*psq + 2*s + 4*t))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (4^(2 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*ml^2*
      (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1]])/
     (mz^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*
      (-2*gZlL*gZlR*(2*(8 - 6*d + d^2)*psq^2 + mm^2*(2*(8 - 7*d + d^2)*psq - 
           (-4 + 12*d - 6*d^2 + d^3)*s - 2*(8 - 7*d + d^2)*t) - 
         4*psq*((-3 + d)*s + (8 - 6*d + d^2)*t) + 
         (-4 + d)*((-2 + d)*s^2 + d*s*t + 2*(-2 + d)*t^2)) + 
       gZlL^2*(mm^2*(2*(4 - 3*d + d^2)*psq - (-32 + 24*d - 8*d^2 + d^3)*s - 
           2*(4 - 3*d + d^2)*t) + (-2 + d)*(2*(-2 + d)*psq^2 - 
           2*(-3 + d)*psq*s + (-2 + d)*s^2 - 4*(-2 + d)*psq*t + d*s*t + 
           2*(-2 + d)*t^2)) + gZlR^2*(mm^2*(2*(4 - 3*d + d^2)*psq - 
           (-32 + 24*d - 8*d^2 + d^3)*s - 2*(4 - 3*d + d^2)*t) + 
    ...
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(-2*gZlL*gZlR*(-32*psq^2 + 10*d*psq^2 - 
         ...
         mm^2*(2*(4 - 3*d + d^2)*psq + (-2 + d)^3*s - 2*(4 - 3*d + d^2)*t)) + 
       gZlL^2*(mm^2*(2*(8 - 7*d + d^2)*psq + (-28 + 24*d - 8*d^2 + d^3)*s - 
           2*(8 - 7*d + d^2)*t) + (-4 + d)*(6*psq^2 + 
           psq*((10 - 7*d + d^2)*s + 2*(-7 + d)*t) + 
           (s + t)*((-2 + d)*s - 2*(-4 + d)*t))) + 
       gZlR^2*(mm^2*(2*(8 - 7*d + d^2)*psq + (-28 + 24*d - 8*d^2 + d^3)*s - 
           2*(8 - 7*d + d^2)*t) + (-4 + d)*(6*psq^2 + 
           psq*((10 - 7*d + d^2)*s + 2*(-7 + d)*t) + 
    ...
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*(2*(-4 + d)*psq^2 - 4*s^2 + 
     ...
     (mz^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*
      (gZlL^2*(-((-2 + d)*s*((22 - 9*d + d^2)*psq - (-2 + d)*s - 2*t)) + 
         2*mm^2*(-((4 - 5*d + d^2)*psq) + (-18 + 18*d - 7*d^2 + d^3)*s + 
           (4 - 5*d + d^2)*t)) + gZlR^2*
        (-((-2 + d)*s*((22 - 9*d + d^2)*psq - (-2 + d)*s - 2*t)) + 
         2*mm^2*(-((4 - 5*d + d^2)*psq) + (-18 + 18*d - 7*d^2 + d^3)*s + 
           (4 - 5*d + d^2)*t)) + 2*gZlL*gZlR*
        (2*mm^2*((8 - 5*d + d^2)*psq - (-18 + 18*d - 7*d^2 + d^3)*s - 
    ...
    (2^(3 - 2*d)*EL^8*gAl^4*gAu^2*(-2*gZlL*gZlR*((-20 + 6*d)*psq^2 + 
         ...
         mm^2*(4*psq + (-16 + 18*d - 7*d^2 + d^3)*s - 4*t) + 
         ...
         16*d*t^2 - 2*d^2*t^2 + mm^2*(-4*psq + (-20 + 18*d - 7*d^2 + d^3)*s + 
           4*t)) + gZlR^2*(6*(-4 + d)*psq^2 + (-26 + 18*d - 3*d^2)*psq*s + 
         8*s^2 - 6*d*s^2 + d^2*s^2 + 2*(30 - 11*d + d^2)*psq*t - 26*s*t + 
         10*d*s*t - d^2*s*t - 36*t^2 + 16*d*t^2 - 2*d^2*t^2 + 
         mm^2*(-4*psq + (-20 + 18*d - 7*d^2 + d^3)*s + 4*t)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*(2*mm^2 - 4*psq - 2*s + d*s + 
     ...
     (mz^2*Pi^(2*d)*s) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*
      (gZlL + gZlR)^2*ml^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
    ...
    (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*(-2*gZlL*gZlR*((-2 + d)^2*mm^2 + 
         (6 - 6*d + d^2)*psq) + gZlL^2*((2 - 4*d + d^2)*mm^2 + 
         (8 - 6*d + d^2)*psq) + gZlR^2*((2 - 4*d + d^2)*mm^2 + 
    ...
    (4^(2 - d)*(-4 + d)*EL^8*gAl^4*gAu^2*(gZlL + gZlR)^2*(-psq + s + t)*
     ...
     (mz^2*Pi^(2*d)*s^2) - (2^(5 - 2*d)*EL^8*gAl^4*gAu^2*
      (-2*gZlL*gZlR*((-2 + d)^2*mm^2 + (6 - 6*d + d^2)*psq) + 
       gZlL^2*((2 - 4*d + d^2)*mm^2 + (8 - 6*d + d^2)*psq) + 
       gZlR^2*((2 - 4*d + d^2)*mm^2 + (8 - 6*d + d^2)*psq))*\[Mu]^(8 - 2*d)*
  ...
  PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    KiraPropagator[q2, ml]]*((4^(1 - d)*(-2 + d)*EL^8*gAl^4*gAu^2*
      (gZlL + gZlR)^2*ml^2*mm^2*(4*psq^2 + 2*(-2 + d)*mm^2*s + 6*s^2 - 
