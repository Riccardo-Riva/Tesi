...
(PropList[KiraPropagator[q1, mu], KiraPropagator[-p1 + q1, mh], 
   ...
   (((I/16)*EL^6*gAl*gAu*gHuu*gHZZ*mu^2*
    ...
    ((I/8)*EL^6*gAl*gAu*gHuu*gHZZ*mu^2*
      (((gZlR*gZuL*(2*mu^2 - (-3 + d)*s) + gZlL*gZuR*(2*mu^2 - (-3 + d)*s) + 
          gZlL*gZuL*(2*mu^2 + (-3 + d)*s) + gZlR*gZuR*(2*mu^2 + (-3 + d)*s))*
         (-mm^2 + s + t))/mz^2 + gZlR*gZuL*(2*mm^2 - (6 - 6*d + d^2)*s + 
         2*t) + gZlL*gZuR*(2*mm^2 - (6 - 6*d + d^2)*s + 2*t) + 
       gZlL*gZuL*(2*mm^2 + (6 - 4*d + d^2)*s + 2*t) + 
       gZlR*gZuR*(2*mm^2 + (6 - 4*d + d^2)*s + 2*t))*SPList[SP[p1, q1]])/
     (Pi^4*(mz^2 - s)*s) + ((I/8)*EL^6*gAl*gAu*gHuu*gHZZ*mu^2*
      (-(((gZlL*gZuL*(2*mu^2 - (-3 + d)*s) + gZlR*gZuR*(2*mu^2 - 
             (-3 + d)*s) + gZlR*gZuL*(2*mu^2 + (-3 + d)*s) + 
           gZlL*gZuR*(2*mu^2 + (-3 + d)*s))*(mm^2 - t))/mz^2) + 
       gZlL*gZuL*(2*mm^2 + (-2 + d)^2*s + 2*t) + 
       gZlR*gZuR*(2*mm^2 + (-2 + d)^2*s + 2*t) + 
       gZlR*gZuL*(2*mm^2 - (8 - 6*d + d^2)*s + 2*t) + 
       gZlL*gZuR*(2*mm^2 - (8 - 6*d + d^2)*s + 2*t))*SPList[SP[p2, q1]])/
     (Pi^4*(mz^2 - s)*s) + ((I/8)*EL^6*gAl*gAu*gHuu*gHZZ*mu^2*
