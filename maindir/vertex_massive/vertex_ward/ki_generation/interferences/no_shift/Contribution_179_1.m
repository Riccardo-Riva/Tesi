...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((2^(1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*s*
   ...
   (EL^5*ggmgmA*ggmgmZ^2*s*(-(bb*(2*gZlL*gZlR*mm^2*(-4*psq + s) + 
   ...
   (4^(1 - d)*EL^5*ggmgmA*ggmgmZ^2*
     (-(bb*(gZlL^2*(psq^2 + mm^2*(psq - 2*s)) + 
         gZlR^2*(psq^2 + mm^2*(psq - 2*s)) + 2*gZlL*gZlR*mm^2*
          (-2*psq + s))) + aa*(gZlL^2*psq*(mm^2 + psq - 2*s) + 
        gZlR^2*psq*(mm^2 + psq - 2*s) + 2*gZlL*gZlR*mm^2*(-2*psq + s)))*
   ...
   (2^(1 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*s*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*s*
   ...
   (2^(3 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q1]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(3 - 2*d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*
   ...
   (4^(1 - d)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(bb*mm^2 - aa*psq)*
   ...
   (2^(3 - 2*d)*(aa - bb)*EL^5*ggmgmA*ggmgmZ^2*(gZlL^2 + gZlR^2)*(mm^2 + psq)*
