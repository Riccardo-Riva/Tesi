...
(PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, mm], 
  ...
  ((2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(3*mm^2 + psq - 2*s)*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*((-8 + 6*d)*psq^3 - 8*s*t*(s + t) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (2*(-4 + d)*psq^3 - (4 + d)*mm^2*(2*psq - s - 2*t)*(psq - t) + 
      8*s*t*(s + t) + psq^2*(-((-12 + d)*s) - 4*(-4 + d)*t) + 
      psq*t*((-20 + d)*s + 2*(-4 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*mm^2 - 3*psq + s + t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^4*
     (2*(-4 + d)*psq^2 + 4*(-2 + d)*mm^2*s + 
      psq*((24 - 9*d)*s - 4*(-4 + d)*t) + 
      (s + t)*((-8 + 3*d)*s + 2*(-4 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-((-2 + d)*mm^4*s) + 
      (3*(-2 + d)*psq - 4*s)*(psq^2 - 2*psq*t + t*(s + t)) + 
      mm^2*((14 - 3*d)*psq^2 + (s + t)*(4*s + 14*t - 3*d*t) + 
   ...
   (4^(2 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^4*(psq - t)^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(mm^2 - psq)*(psq - t)^2*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*((-2 + d)*psq^3 + 4*s*t*(s + t) + 
      psq^2*(-((-6 + d)*s) - 2*(-2 + d)*t) + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-((-6 + d)*psq^3) - 4*t*(s + t)^2 + 
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(-((-2 + d)*psq*(psq - t)) + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gHll^2*mm^2*(2*(-4 + d)*psq^2 - 
