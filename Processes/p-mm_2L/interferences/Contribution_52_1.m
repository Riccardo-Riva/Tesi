...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 - p2 + q1, mm], 
   KiraPropagator[-p3 + q1, 0], KiraPropagator[q2, mu], 
   KiraPropagator[p1 + p2 + q2, mu]]*
  ((3*EL^8*gAl^6*gAu^2*mm^2*mu^2*
     (me^2*(-8*(-2 + d)*mm^2 + 2*(4 - 6*d + d^2)*s) + 
      (-2 + d)*(-4*mm^4 + (-6 + d)*s^2 + 8*mm^2*t - 4*s*t - 4*t^2)))/
    (16*Pi^8*s^3) - (3*EL^8*gAl^6*gAu^2*mu^2*(-2*(2 + d)*mm^4 - 10*s^2 + 
   ...
   (3*(-2 + d)*EL^8*gAl^6*gAu^2*mu^2*(-mm^2 + s + t)*
   ...
   (3*EL^8*gAl^6*gAu^2*((-2 + d)*mm^4 - 6*s^2 + 2*d*s^2 + 
    ...
    (4*Pi^8*s^3) + (3*(-2 + d)*EL^8*gAl^6*gAu^2*mu^2*
