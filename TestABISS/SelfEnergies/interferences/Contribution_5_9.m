...
(EL^4*gAd^2*gAl^2*KiraPropagator[q1, MD]*KiraPropagator[q1, ML]*
  KiraPropagator[-p2 + q1, MD]*KiraPropagator[-p2 + q1, ML]*
  ...
  (SP[p2, {Lor2}]*SP[q1, {Lor1}] + SP[p2, {Lor1}]*SP[q1, {Lor2}] - 
   2*SP[q1, {Lor1}]*SP[q1, {Lor2}] - ML^2*SP[{Lor1}, {Lor2}] - 
  ...
  (SP[p2, {newLor2}]*SP[q1, {newLor1}] + SP[p2, {newLor1}]*
   ...
   MD^2*SP[{newLor1}, {newLor2}] - SP[p2, q1]*SP[{newLor1}, {newLor2}] + 
