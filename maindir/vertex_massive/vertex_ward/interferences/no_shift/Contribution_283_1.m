...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^4*
     ...
     SPList[SP[p2, q2]])/Pi^(2*d) + (EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*s*
   ...
   (EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^4*s*(bb*(mm^2 + 3*psq - s) + 
    ...
    (2*Pi)^(2*d) + (4^(1 - d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*
     (-4*bb*mm^2*psq + aa*mm^2*(4*psq - s) + aa*psq*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*
     (aa*(mm^4 - 7*mm^2*psq - 3*psq*s) + 
      bb*(-mm^4 + psq*s + mm^2*(7*psq + 2*s)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(2*mm^2 + psq)*
     (4*psq - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(4*bb*mm^2*psq - aa*psq*s + 
   ...
   (4^(1 - d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(bb*mm^2 - aa*psq)*s*
   ...
   (4^(1 - d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*(-(bb*(4*mm^2 + psq)) + 
      aa*(2*mm^2 + 3*psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p2, q2]])/Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*
     (bb*mm^2 - aa*psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q2, q2]])/Pi^(2*d) - (4^(1 - d)*EL^5*gAl*gFll*gHFW*gHll*gWlN*mm^2*
