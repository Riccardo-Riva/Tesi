  ...
  ((2^(1 - 2*d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (6*psq^3 + mm^4*(psq - t) + 2*psq*t*(3*s + 5*t) - psq^2*(s + 14*t) - 
      t*(s^2 + 3*s*t + 2*t^2) + mm^2*(4*psq^2 - 5*psq*s + s^2 - 9*psq*t + 
        4*s*t + 5*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     (gZlL - gZlR)*mm^2*(-(mm^2*(psq^2 + 3*psq*s - s^2 - 2*psq*t - 3*s*t + 
         t^2)) + (psq - t)*(2*psq^2 - 4*psq*t + t*(s + 2*t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ...
     (gZlL - gZlR)*mm^2*(mm^2*(psq^2 + 3*s^2 + 2*s*t + t^2 - 2*psq*(s + t)) + 
