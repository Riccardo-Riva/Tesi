...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, 0], 
 ...
 ((I*2^(-1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*
    ...
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*ggpgpA^2*
    (mm^2 - psq)*(bb*s*(2*psq - 3*s - 2*t) + aa*mm^2*(psq + s - t) + 
     2*aa*s*(-2*psq + s + t) + bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl^3*ggpgpA^2*
    (mm^2 - psq)*s*(aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl^3*ggpgpA^2*
    (mm^2 - psq)*s*(aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl^3*ggpgpA^2*
    (mm^2 - psq)*s*(aa*(mm^2 + 2*psq - 2*s - 2*t) + bb*(mm^2 - 2*psq + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*s*
    (aa*(mm^2 + 3*psq - 2*s - 3*t) + bb*(mm^2 - 3*psq + s + 3*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*s*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   Pi^(2*d) - (I*EL^5*gAl^3*ggpgpA^2*
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(bb*(3*mm^4 + 2*psq^2 - 3*psq*s + 2*s^2 + 
       mm^2*(-5*psq + 2*s - 2*t) + 2*psq*t) + 
     aa*(mm^4 + 2*psq^2 + 5*psq*s - 2*s^2 - 2*psq*t + 
       mm^2*(-3*psq - 4*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl^3*ggpgpA^2*(bb*(mm^4 - 2*psq^2 + 7*psq*s - 2*s^2 + 
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(bb*(6*psq^2 - 8*psq*s + s^2 - 6*psq*t + 2*s*t + 
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(-(s*(psq - 2*t)) + mm^2*(psq - s - t)) + 
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(bb*(mm^4 + mm^2*(-2*psq - 2*s + t) - 
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(bb*(-psq^2 + s*(mm^2 - 2*t) + psq*(s + t)) + 
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(-3*psq^2 + 3*mm^2*(psq - t) + 3*psq*(s + t) - 
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(-3*aa*psq*s + aa*mm^2*(psq - t) + 
  ...
  (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(psq^2 + 2*mm^2*(psq - t) - 
     psq*(8*s + t) + s*(3*s + 7*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*ggpgpA^2*(2*aa*psq^2 - 2*bb*psq^2 - 2*aa*psq*(3*s + t) + 
  ...
  ((3*I)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*(aa*(psq - t) + bb*(-psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(-psq^2 + mm^2*(psq - t) + 
     psq*(-s + t) + s*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*ggpgpA^2*(bb*(3*psq*s + mm^2*(-psq + t) - 2*s*(s + t)) + 
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(-3*psq^2 + mm^2*(3*psq + 2*s - 3*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^3*ggpgpA^2*s*(aa*(-2*mm^2 + s + 2*t) - 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*(aa + bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(2*mm^2 - 2*psq + s)*
  ...
  (I*2^(1 - 2*d)*bb*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*bb*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(2*aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - 3*bb)*EL^5*gAl^3*ggpgpA^2*(-mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p2, p3]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - 2*bb)*EL^5*gAl^3*ggpgpA^2*(-mm^2 + psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(2*psq - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - 2*psq + 2*s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p3, p3]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(2*aa*(mm^2 - s - t) + 
     bb*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1], SP[q1, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(3*mm^2 - 2*s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(-mm^2 + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(2*bb*(-psq + s + t) + 
     aa*(mm^2 + psq - 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - 2*psq + t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(3*psq - 2*s - 3*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1], SP[q1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p3, p3]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - 2*bb)*EL^5*gAl^3*ggpgpA^2*
    (-mm^2 + psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, p3]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(-mm^2 + psq)*
  ...
  (I*2^(1 - 2*d)*(2*aa - 3*bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 + s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(mm^2 + psq - 2*t) + 
     ...
     SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[q1, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(mm^2 + 2*psq - s - 3*t) + 
     bb*(3*mm^2 - 6*psq + s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[q2, q2]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(mm^2 + psq - 2*(s + t)) + 
     bb*(3*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, p3]])/(2*Pi)^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(mm^2 - s - t) + bb*(-psq + s + t))*
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
   ...
   Pi^(2*d) + (I*2^(1 - 2*d)*(2*aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[p2, q1]])/Pi^(2*d) + 
  (I*4^(1 - d)*bb*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 + s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3], SP[p3, p3]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - 2*psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(2*aa*(psq - t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(2*mm^2 + psq - s - 3*t) + 
     bb*(-3*psq + s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], SP[q2, q2]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(3*mm^2 - psq - 2*t) + bb*(mm^2 - 3*psq + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, p3]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(psq - t) + bb*(mm^2 - 2*psq + t))*
  ...
  (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(3*psq - s - 3*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*aa*EL^5*gAl^3*ggpgpA^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2], SP[p3, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^3*ggpgpA^2*(aa*(4*mm^2 - s - 4*t) + bb*(-4*psq + s + 4*t))*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(3*psq - s - 3*t)*
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^3*ggpgpA^2*(aa*(mm^2 - t) + bb*(-psq + t))*
  ...
  (I*EL^5*gAl^3*ggpgpA^2*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(3*psq - 2*s - 3*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3], SP[p3, q1]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3], SP[p3, q2]])/
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^3*ggpgpA^2*(2*psq - s - 2*t)*
