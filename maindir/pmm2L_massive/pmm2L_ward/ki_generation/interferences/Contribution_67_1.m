...
{(PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
   ...
   ((I*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*(mm^3 - mm*psq)^2*
      s*\[Mu]^(8 - 2*d))/Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*
      gAl*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*(psq - s - t)*
    ...
    (I*2^(1 - 4*d)*EL^5*gAl*gHll*gHZZ*mm^2*
      (bb*(-(2^(1 + 2*d)*d*gZlL*gZlR*Pi^(2*d)*(mm^2*(3*psq - 2*s - 3*t) + 
       ...
       aa*(-((-2 + d)*gZlL^2*(2*Pi)^(2*d)*(psq*(3*psq - 2*s - 3*t) + 
          ...
          (psq*(3*psq - 2*s - 3*t) + mm^2*(psq - t)) + 2^(1 + 2*d)*d*gZlL*
          gZlR*Pi^(2*d)*(mm^2*(3*psq - s - 3*t) + psq*(psq - s - t))))*
    ...
    (I*4^(1 - d)*(aa + bb)*d*EL^5*gAl*gHll*gHZZ*gZlL*gZlR*mm^2*(mm^2 - psq)*s*
    ...
    (I*4^(1 - d)*aa*(-2 + d)*EL^5*gAl*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (I*4^(1 - d)*bb*(-2 + d)*EL^5*gAl*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
    ...
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll*gHZZ*(gZlL^2 + gZlR^2)*mm^2*
     ...
     Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gHll*gHZZ*
