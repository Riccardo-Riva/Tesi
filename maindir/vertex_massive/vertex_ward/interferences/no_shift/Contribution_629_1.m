...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl*gFll^2*mm^4*
     (2*aa*(-(gZlR^2*mm^2) + gZlL^2*psq + gZlL*gZlR*(mm^2 - s))*s + 
      ...
      aa*d*(gZlR^2*mm^2*s - gZlL^2*psq*s + gZlL*gZlR*(mm^2*(2*psq - s) + 
          2*psq*s)) + bb*d*(gZlL^2*mm^2*s - gZlR^2*psq*s + 
    ...
    Pi^(2*d) - (EL^5*gAl*gFll^2*gZlR*mm^2*s*(2*aa*d*gZlL*mm^2*(4*psq - s) + 
      aa*(-2 + d)*gZlR*(mm^2 - psq)*(mm^2 + s) + bb*(-2 + d)*gZlR*
       (mm^2 - psq)*(mm^2 + s) + 2*bb*d*gZlL*mm^2*(-4*psq + s))*
     \[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/(2*Pi)^(2*d) - 
   (4^(1 - d)*EL^5*gAl*gFll^2*gZlL*mm^4*(bb*(-2 + d)*gZlL*mm^2 - 
      aa*(-2 + d)*gZlL*psq + 2*aa*gZlR*(d*psq - s) + 
      2*bb*gZlR*(-(d*psq) + s))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFll^2*mm^2*
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*mm^2*
     (aa*(2*d*gZlL*mm^2*(4*psq - s) - 2*gZlR*(mm^2 - 3*psq)*s + 
   ...
   (2^(1 - 2*d)*EL^5*gAl*gFll^2*gZlR*mm^2*
     (aa*(d*gZlL*mm^2*(2*psq - s) + 2*gZlL*mm^2*s + d*gZlR*(mm^2 - psq)*s + 
        2*gZlR*(-mm^2 + psq)*s) + bb*(-2*(gZlL*mm^2 + gZlR*(mm^2 - psq))*s + 
