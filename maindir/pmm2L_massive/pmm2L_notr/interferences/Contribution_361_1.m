...
PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
 ...
 ((2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (d^2*(psq - s)*s^2 + 4*s*(3*psq*s - 3*s^2 + mm^2*(2*psq + s) + 4*psq*t - 
       2*s*t - 2*t^2) + d*(2*s*(-(psq*s) + 3*s^2 + 4*psq*t - 2*s*t - 2*t^2) + 
       mm^2*(4*psq^2 - 2*s^2 + 4*s*t + 4*t^2 - 4*psq*(s + 2*t))))*
    \[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(2*d^2*s^2 + 
     4*s*(mm^2 - 3*psq + 6*s) + d*(4*psq^2 - 2*mm^2*s + 6*psq*s - 13*s^2 - 
       8*psq*t + 4*s*t + 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   ((2*Pi)^(2*d)*s^2) - (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (-4*(1 + d)*psq^2 + 16*s^2 - 6*d*s^2 + d^2*s^2 + 
     2*(-2 + d)*mm^2*(psq - 2*s - t) + 8*s*t - 3*d*s*t - 2*d*t^2 + 
     psq*(-8*s + 11*d*s + 4*t + 6*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   ((2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (-4*psq^2 + 24*s^2 + d^2*s*(-psq + 2*s) - 10*s*t - 4*t^2 + 
     2*psq*(s + 4*t) + d*(2*psq^2 + 7*psq*s - 16*s^2 - 4*psq*t + s*t + 
       2*t^2 + 2*mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   ((2*Pi)^(2*d)*s^2) - (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (-4*(1 + d)*psq^2 + d*s^2 + 2*(-2 + d)*mm^2*(psq - s - t) + 8*s*t - 
     3*d*s*t - 2*d*t^2 + psq*(-12*s + 5*d*s + 4*t + 6*d*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/((2*Pi)^(2*d)*s^2) + 
  (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(-4*psq^2 - 8*s^2 + 5*d*s^2 - 
     d^2*s^2 + 2*(-2 + d)*mm^2*(psq + s - t) + 8*s*t + d*s*t + 2*d*t^2 - 
     psq*((4 + 7*d)*s + 2*(-2 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3]])/
   ((2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (-4*psq^2 - 10*psq*s + 30*s^2 + d^2*s*(-psq + 2*s) + 8*psq*t + 2*s*t - 
     4*t^2 + d*(2*psq^2 + 5*psq*s - 15*s^2 + 2*mm^2*(psq - t) - 4*psq*t + 
       3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   ((2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (-4*psq^2 + 8*s^2 - 2*d*s^2 + 2*(-2 + d)*mm^2*(psq - t) + 4*psq*t + 
     8*s*t + d*s*t + 2*d*t^2 - d*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/((2*Pi)^(2*d)*s^2) - 
  (2^(-1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (16*s^2 + d^2*s^2 + 4*d*(psq^2 - 2*s^2 - 2*psq*t + s*t + t^2))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (2*mm^2 + (2 + d)*psq - d*s)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (Pi^(2*d)*s) + (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (4*(mm^2 + psq)*s + d*(-4*psq^2 - 2*mm^2*s + 6*psq*s + s^2 + 8*psq*t - 
       4*s*t - 4*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   ((2*Pi)^(2*d)*s^2) + (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (2*(-2 + d)*mm^2 + (4 - 6*d)*psq - (18 - 9*d + d^2)*s)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (2*(-2 + d)*mm^2 - 4*(-1 + d)*psq - 32*s + 19*d*s - 2*d^2*s + 2*d*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (2*(-2 + d)*mm^2 + 4*psq - 32*s + 17*d*s - 2*d^2*s - 2*d*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-1 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*
    mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (2^(1 - 2*d)*(-4 + 3*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
  ...
  (2^(1 - 2*d)*(-4 + 7*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/(Pi^(2*d)*s) - 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (2*(-2 + d)*mm^2 + (2 - 3*d)*psq - 2*s + 2*d*s + 2*t + d*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*d*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (2*(-2 + d)*mm^2 - (-6 + d)*psq - 4*s + d*s - 2*t - d*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (2*(-2 + d)*mm^2 - (-6 + d)*psq - 6*s + d*s - 2*t - d*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(16*s + d^2*s + 2*d*(psq - 5*s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (18*s + d^2*s + 2*d*(psq - 5*s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(16*s + d^2*s + 2*d*(psq - 5*s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*d*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (2*(-2 + d)*mm^2 + (2 - 3*d)*psq - 4*s + 2*d*s + 2*t + d*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*(-4 + 3*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(psq + s - t)*
  ...
  (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(16*s + d^2*s - 2*d*(psq + 4*s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*
    (18*s + d^2*s - 2*d*(psq + 4*s - t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(16*s + d^2*s - 2*d*(psq + 4*s - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/((2*Pi)^(2*d)*s^2) + 
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*(psq - t)*
  ...
  (2^(1 - 2*d)*d*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*d*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*d*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
  ...
  (2^(3 - 2*d)*(-4 + d)*EL^8*gAl^3*gAu^2*gFAW*gFll*gWNl*mm^2*\[Mu]^(8 - 2*d)*
