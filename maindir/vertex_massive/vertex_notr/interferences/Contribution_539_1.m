...
PropList[KiraPropagator[p1 + q1, mw], KiraPropagator[q2, 0], 
 ...
 ((EL^6*gAl^3*gFFA*gFFAA*s*((-4 + d)*mm^2 + 2*s - d*(psq + s))*
    \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
  (2^(1 - 2*d)*EL^6*gAl^3*gFFA*gFFAA*(3*mm^2 + psq + (-2 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) - 
  (2^(1 - 2*d)*EL^6*gAl^3*gFFA*gFFAA*(2*mm^2 + 2*psq + (-2 + d)*s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^3*gFFA*gFFAA*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^3*gFFA*gFFAA*
    (2*(1 + d)*mm^2 - 2*(-3 + d)*psq - (-2 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^3*gFFA*gFFAA*
    ((1 + d)*mm^2 - (-3 + d)*psq - 2*(-2 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^3*gFFA*gFFAA*
    (2*(-1 + d)*mm^2 - 2*(-3 + d)*psq + (-2 + d)*s)*\[Mu]^(8 - 2*d)*
