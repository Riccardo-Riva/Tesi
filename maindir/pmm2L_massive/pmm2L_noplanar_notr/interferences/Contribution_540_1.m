...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
  ...
  (-((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*
     ...
     (Pi^(2*d)*s^2)) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*
     (gZlL + gZlR)*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*(gZlL + gZlR)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*(gZlL + gZlR)*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*(gZlL + gZlR)*
     (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*
     (gZlL + gZlR)*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*(gZlL + gZlR)*
     (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFFAA*gFFZ*
