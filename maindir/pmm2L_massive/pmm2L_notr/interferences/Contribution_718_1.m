...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 ((2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*
  ...
  ((-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (4^d*Pi^(2*d)*s^2) + (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*
  ...
  (2^(-1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*
  ...
  (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*(4*mm^2 - 4*psq + s)*
  ...
  (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*
    (-6*psq + (6 + d)*s + 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + ((-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
    (gZlL^2 + gZlR^2)*mm^2*(mm^2*(18*psq + (-20 + d)*s - 18*t) + 
     psq*(-2*psq - (-4 + d)*s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, q2]])/((2*Pi)^(2*d)*s^2) - 
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*(-2*psq + d*s + 2*t)*
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
    (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*
    gZlL*gZlR*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
    (gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*(6*psq + d*s - 6*t)*
  ...
  (2^(1 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*gZlL*gZlR*mm^4*
    ...
    gHll^2*(gZlL^2 + gZlR^2)*mm^2*(-((-2 + d)*psq*s) + 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
    (-2*psq + (-2 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[q1, q1]])/(Pi^(2*d)*s^2) + (3*2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gHll^2*
    gZlL*gZlR*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
   (Pi^(2*d)*s) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
    (gZlL^2 + gZlR^2)*mm^2*((-8 + d)*mm^2 - (-4 + d)*psq)*\[Mu]^(8 - 2*d)*
  ...
  ((-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
   ...
   (4^d*Pi^(2*d)*s^2) - ((-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*
    mm^2*(4*psq^2 + (-2 + d)*mm^2*s - 4*s^2 + d*s^2 + 4*s*t + 4*t^2 - 
     psq*((-6 + d)*s + 8*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q1]])/
   (4^d*Pi^(2*d)*s^2) - (2^(-1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
    (gZlL^2 + gZlR^2)*mm^2*(4*psq^2 + 2*(-4 + d)*mm^2*s - 4*s^2 + d*s^2 + 
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    gHll^2*(gZlL^2 + gZlR^2)*mm^2*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*
    gHll^2*(gZlL^2 + gZlR^2)*mm^2*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*(gZlL^2 + gZlR^2)*mm^2*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[q1, q2]])/(Pi^(2*d)*s^2) + ((-2 + d)*EL^8*gAl^2*gAu^2*gHll^2*
