...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 ((I*2^(-1 - 2*d)*(aa + bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)^2*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^4*(mm^2 - psq)*
   ...
   Pi^(2*d) - (I*(aa + bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*(mm^2 - psq)*s*
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)^2*
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)) - (I*EL^5*gAl*gXll^2*mm^4*
  ...
  (I*EL^5*gAl*gXll^2*mm^4*(bb*((-2 + d)*gZlL^2*(mm^2 + psq - s - 2*t) + 
  ...
  (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*(psq - t)*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^2*mm^4*((-2 + d)*gZlL^2*(psq - t) + 
  ...
  (I*(aa + bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(mm^2 - psq)*s*
  ...
  (I*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(mm^2 - s - t) + 
  ...
  (I*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(psq - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(mm^2 - t) + 
  ...
  (I*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - s - 2*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) - (I*(aa - bb)*(-4 + d)*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/
   (4^d*Pi^(2*d)) - (I*(aa - bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*
  ...
  (I*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^2*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*
