...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[p1 + p2 - p3 - q1, mm], 
 ...
 (((-I)*EL^5*gFFA*gFll^2*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*EL^5*gFFA*gFll^2*mm^2*
    (aa*(2*gZlL*gZlR*mm^2*(-4*s + d*(4*psq + s))*(-2*psq + s + 2*t) + 
       (-2 + d)*gZlL^2*mm^2*(4*psq^2 + 2*mm^2*(2*psq + s - 2*t) - 
         4*psq*(s + t) - s*(s + 2*t)) + gZlR^2*(4*(-2 + d)*psq^3 + 
         4*psq*s^2 + 2*(-2 + d)*psq^2*(s - 2*t) - 2*s^2*(s + 2*t) + 
         (-2 + d)*mm^2*(4*psq^2 - 4*psq*(s + t) - s*(s + 2*t)))) + 
     bb*(-2*gZlL*gZlR*mm^2*(-4*s + d*(4*psq + s))*(-2*psq + s + 2*t) - 
       (-2 + d)*gZlL^2*mm^2*(4*psq^2 + mm^2*(4*psq - 6*s - 4*t) + 
         4*psq*(s - t) - s*(s + 2*t)) + 
       gZlR^2*(-((-2 + d)*mm^2*(4*psq^2 + 4*psq*(s - t) - s*(s + 2*t))) + 
         2*(-2*(-2 + d)*psq^3 - 2*psq*s^2 + s^2*(s + 2*t) + 
           (-2 + d)*psq^2*(3*s + 2*t)))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll^2*mm^2*s*
    ((-2 + d)*gZlL^2*mm^2 - 2*d*gZlL*gZlR*mm^2 + 
     gZlR^2*((-2 + d)*mm^2 + 2*s))*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*mm^2*s*
    (aa*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + (-2 + d)*gZlR^2*
        (psq^2 - mm^2*s - psq*t) + 2*gZlL*gZlR*mm^2*
        (-2*s + d*(-psq + s + t))) + 
     bb*(2*gZlL*gZlR*mm^2*(2*s + d*(psq - s - t)) + (-2 + d)*gZlL^2*mm^2*
        (2*mm^2 - 3*psq + s + t) + (-2 + d)*gZlR^2*(mm^2*(2*psq - s) + 
         psq*(-3*psq + 2*s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   Pi^(2*d) - (I*EL^5*gFFA*gFll^2*mm^2*
    ((aa - bb)*s*((-2 + d)*gZlL^2*mm^2 - 2*d*gZlL*gZlR*mm^2 + 
       gZlR^2*((-2 + d)*mm^2 + 2*s))*(-2*psq + s + 2*t) - 
  ...
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*mm^2*s*
    (aa*((-2 + d)*gZlL^2*mm^2*(2*mm^2 - psq - t) + 2*gZlL*gZlR*mm^2*
        (2*s + d*(-psq + t)) + (-2 + d)*gZlR^2*(mm^2*(2*psq - s) - 
         psq*(psq - s + t))) + bb*(-((-2 + d)*gZlL^2*mm^2*(psq - t)) - 
       2*gZlL*gZlR*mm^2*(2*s + d*(-psq + t)) - (-2 + d)*gZlR^2*
        (psq^2 + mm^2*s - psq*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   Pi^(2*d) - (I*EL^5*gFFA*gFll^2*mm^2*
    ((aa - bb)*s*((-2 + d)*gZlL^2*mm^2 - 2*d*gZlL*gZlR*mm^2 + 
       gZlR^2*((-2 + d)*mm^2 + 2*s))*(-2*psq + s + 2*t) + 
     bb*((-2 + d)*gZlL^2*mm^2*(2*psq^2 + 2*mm^2*(psq - s - t) + s*(s + t) - 
         psq*(s + 2*t)) + gZlR^2*(2*((-2 + d)*psq^3 - 3*psq*s^2 - 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^5*gFFA*gFll^2*mm^2*s*
    (bb*(-((-2 + d)*gZlR^2*(psq*(4*psq - 3*s - 4*t) + 2*mm^2*(psq - t))) - 
       (-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 4*d*gZlL*gZlR*mm^2*
        (2*psq - s - 2*t)) + 
     aa*((-2 + d)*gZlR^2*(psq*(4*psq - s - 4*t) + 2*mm^2*(psq - s - t)) + 
       (-2 + d)*gZlL^2*mm^2*(2*psq - s - 2*t) + 4*d*gZlL*gZlR*mm^2*
        (-2*psq + s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gFFA*gFll^2*mm^2*s*
    ((-2 + d)*gZlL^2*mm^2 - 2*d*gZlL*gZlR*mm^2 + 
     gZlR^2*((-2 + d)*mm^2 + 2*s))*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gFFA*gFll^2*mm^2*
    (bb*(-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) - 
     ...
     aa*(-((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*mm^2 - s - 2*t)) + 
       2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) - 
       gZlR^2*(2*Pi)^(2*d)*(2*(-2 + d)*psq^2 + 4*psq*s - 
         ((-2 + d)*mm^2 + 2*s)*(s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(4*d) + 
  (I*(aa - bb)*EL^5*gFFA*gFll^2*mm^2*
    (-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
     (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) - 
     gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(4*d) - 
  (I*2^(-1 - 6*d)*EL^5*gFFA*gFll^2*mm^2*
    (aa*(gZlR^2*(2*Pi)^(4*d)*(2*(-2 + d)*psq^2 + (-3*(-2 + d)*mm^2 - 2*s)*s + 
         (-2 + d)*psq*(s - 2*t)) + 2^(1 + 4*d)*(-2 + d)*gZlL^2*mm^2*Pi^(4*d)*
        (psq - s - t) + 4^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(4*d)*
        (-2*s + d*(-psq + s + t))) + 
     bb*(4^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(4*d)*(2*s + d*(psq - s - t)) + 
       2^(1 + 4*d)*(-2 + d)*gZlL^2*mm^2*Pi^(4*d)*(2*mm^2 - 3*psq + s + t) + 
       gZlR^2*(2*Pi)^(4*d)*(-6*(-2 + d)*psq^2 + (-2 + d)*mm^2*(4*psq - s) + 
         2*s^2 + (-2 + d)*psq*(3*s + 2*t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, q1]])/Pi^(6*d) - (I/2)*EL^5*gFFA*gFll^2*mm^2*
   ((4^(1 - 2*d)*(aa - bb)*(-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
         (2*psq - s - 2*t)) + (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
        (2*psq - s - 2*t) - gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + 2*s)*
        (-2*psq + s + 2*t)))/Pi^(4*d) + 
    (2^(1 - 4*d)*(bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*mm^2 - psq - t) + 
    ...
    (aa*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
      ...
      bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*mm^2 - s - 2*t) - 
        2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
        gZlR^2*(2*Pi)^(2*d)*(2*(-2 + d)*psq^2 + 4*psq*s - 
          ((-2 + d)*mm^2 + 2*s)*(s + 2*t))))/(2*Pi)^(4*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, p2], SP[p1, q2]] + 
  (I*(aa - bb)*EL^5*gFFA*gFll^2*mm^2*
    (-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
     (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) - 
     gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, p3]])/(2*Pi)^(4*d) - 
  (I*2^(-1 - 6*d)*EL^5*gFFA*gFll^2*mm^2*
    (aa*(gZlR^2*(2*Pi)^(4*d)*(-2*(-2 + d)*psq^2 + (-2 + d)*mm^2*(4*psq - s) + 
         2*s^2 + (-2 + d)*psq*(s - 2*t)) + 2^(1 + 4*d)*(-2 + d)*gZlL^2*mm^2*
        Pi^(4*d)*(2*mm^2 - psq - t) + 4^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(4*d)*
        (2*s + d*(-psq + t))) - bb*(2^(1 + 4*d)*(-2 + d)*gZlL^2*mm^2*Pi^(4*d)*
        (psq - t) + 4^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(4*d)*
        (2*s + d*(-psq + t)) + gZlR^2*(2*Pi)^(4*d)*(2*(-2 + d)*psq^2 + 
         s*(3*(-2 + d)*mm^2 + 2*s) - (-2 + d)*psq*(3*s + 2*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/Pi^(6*d) - 
  (I/2)*EL^5*gFFA*gFll^2*mm^2*
   ((4^(1 - 2*d)*(aa - bb)*(-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
         (2*psq - s - 2*t)) + (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
        (2*psq - s - 2*t) - gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + 2*s)*
        (-2*psq + s + 2*t)))/Pi^(4*d) + 
    (2^(1 - 4*d)*(aa*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
          (2*s + d*(psq - s - t)) + (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
          (2*mm^2 - 3*psq + s + t) + gZlR^2*(2*Pi)^(2*d)*(2*(-2 + d)*psq^2 - 
  ...
  (I*EL^5*gFFA*gFll^2*mm^2*
    (aa*((-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2*(2*psq - 3*s - 2*t) + 
         4*psq*(psq - t)) - 4^(1 + d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
        (2*psq - s - 2*t) + (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
        (2*psq - s - 2*t)) - bb*((-2 + d)*gZlR^2*(2*Pi)^(2*d)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*mm^2*
    (-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
     (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) - 
     gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(2*Pi)^(4*d) + 
  (I*4^(-1 - 2*d)*EL^5*gFFA*gFll^2*gZlR*mm^2*
    (-(2^(1 + 2*d)*aa*gZlR*Pi^(2*d)*(4*psq^2 + mm^2*(4*psq - 6*s - 4*t) - 
        4*psq*t + s*(s + 2*t))) + 2^(1 + 2*d)*bb*gZlR*Pi^(2*d)*
      (4*psq^2 + 2*mm^2*(2*psq + s - 2*t) - 4*psq*(2*s + t) + s*(s + 2*t)) + 
     aa*d*(2*Pi)^(2*d)*(8*gZlL*mm^2*(-2*psq + s + 2*t) + 
       gZlR*(4*psq^2 + s^2 + mm^2*(4*psq - 6*s - 4*t) - 4*psq*t + 2*s*t)) + 
     bb*d*(2*Pi)^(2*d)*(8*gZlL*mm^2*(2*psq - s - 2*t) - 
       gZlR*(4*psq^2 + 2*mm^2*(2*psq + s - 2*t) - 4*psq*(2*s + t) + 
         s*(s + 2*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q1]])/
   Pi^(4*d) + (I*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*mm^2*
    (-2*d*gZlL*mm^2 - 2*gZlR*(mm^2 + psq) + d*gZlR*(mm^2 + psq))*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*EL^5*gFFA*gFll^2*gZlR^2*mm^2*s*
  ...
  (I*2^(-1 - 4*d)*(aa - bb)*EL^5*gFFA*gFll^2*mm^2*
    (-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
     (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) - 
     gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/Pi^(4*d) + 
  (I*EL^5*gFFA*gFll^2*gZlR^2*mm^2*s*(-(bb*s) + 
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 4*d)*EL^5*gFFA*gFll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(psq - s - t) + 
       (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(psq^2 - mm^2*s - psq*t) + 
       2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*s + d*(-psq + s + t))) + 
     bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(psq - s - t)) + 
       (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*mm^2 - 3*psq + s + t) + 
       (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2*(2*psq - s) + 
         psq*(-3*psq + 2*s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/Pi^(4*d) + 
  (I*EL^5*gFFA*gFll^2*gZlR^2*mm^2*s*(-(aa*s) + 
  ...
  (I*2^(-1 - 4*d)*EL^5*gFFA*gFll^2*mm^2*
    (-(aa*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(psq - s - t)) + 
        gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) + 2*s*((-2 + d)*mm^2 + s) - 
          (-2 + d)*psq*(s - t)) - (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
         (psq - s - t))) + bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
        (2*s + d*(psq - s - t)) + (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
        (2*mm^2 - 3*psq + s + t) + gZlR^2*(2*Pi)^(2*d)*(2*(-2 + d)*mm^2*psq - 
         3*(-2 + d)*psq^2 + 2*s^2 + (-2 + d)*psq*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(-1 - d)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 4*d)*EL^5*gFFA*gFll^2*mm^2*
    ((aa - bb)*(-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
     ...
     bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*mm^2 - psq - t) + 
      ...
      ((-2 + d)*gZlL^2*mm^2*(psq - t) + 2*gZlL*gZlR*mm^2*
        (2*s + d*(-psq + t)) + gZlR^2*((-2 + d)*mm^2*(psq - t) - 
         2*s*(psq + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
   Pi^(4*d) + (I*2^(-1 - 4*d)*(aa - bb)*EL^5*gFFA*gFll^2*mm^2*
    (-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t)) + 
     (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*psq - s - 2*t) - 
     gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + 2*s)*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/Pi^(4*d) - 
  (I*2^(-1 - 4*d)*EL^5*gFFA*gFll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*mm^2 - psq - t) + 
       gZlR^2*(2*Pi)^(2*d)*(2*(-2 + d)*mm^2*psq - (-2 + d)*psq^2 + 2*s^2 - 
         (-2 + d)*psq*t) + 2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
        (2*s + d*(-psq + t))) + bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
        (-2*s + d*(psq - t)) - (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(psq - t) + 
       gZlR^2*(2*Pi)^(2*d)*(-((-2 + d)*psq^2) - 2*s*((-2 + d)*mm^2 + s) + 
         (-2 + d)*psq*(2*s + t))))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1]])/Pi^(4*d) - (I/2)*EL^5*gFFA*gFll^2*mm^2*
   ((2^(1 - 4*d)*(aa - bb)*(-(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*
         (2*psq - s - 2*t)) + (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
        (2*psq - s - 2*t) - gZlR^2*(2*Pi)^(2*d)*((-2 + d)*mm^2 + 2*s)*
        (-2*psq + s + 2*t)))/Pi^(4*d) + 
    (aa*(2^(1 + 2*d)*d*gZlL*gZlR*mm^2*Pi^(2*d)*(2*psq - s - 2*t) + 
      ...
      bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*mm^2 - s - 2*t) - 
        ...
        gZlR^2*(2*Pi)^(2*d)*(2*(-2 + d)*psq^2 + 4*psq*s - 
          ((-2 + d)*mm^2 + 2*s)*(s + 2*t))))/(2*Pi)^(4*d))*\[Mu]^(8 - 2*d)*
   SPList[SP[p1, q2], SP[p2, q2]] + (I*2^(-1 - 4*d)*EL^5*gFFA*gFll^2*mm^2*
  ...
  (I*4^(-1 - 2*d)*EL^5*gFFA*gFll^2*gZlR*mm^2*
    (-(2^(1 + 2*d)*aa*gZlR*Pi^(2*d)*((2*psq + s)*(psq - t) + 
        2*mm^2*(psq - s - t))) + (aa - bb)*(-2 + d)*gZlR*(2*Pi)^(2*d)*s*
      (-2*psq + s + 2*t) + 2^(1 + 2*d)*bb*gZlR*Pi^(2*d)*
      (2*psq^2 - 3*psq*s + 2*mm^2*(psq + s - t) - 2*psq*t - s*t) - 
     aa*d*(2*Pi)^(2*d)*(4*gZlL*mm^2*(2*psq - s - 2*t) - 
       gZlR*(2*psq + s)*(psq - t) + 2*gZlR*mm^2*(-psq + s + t)) - 
     bb*d*(2*Pi)^(2*d)*(4*gZlL*mm^2*(-2*psq + s + 2*t) + 
       gZlR*(2*psq^2 - 3*psq*s + 2*mm^2*(psq + s - t) - 2*psq*t - s*t)))*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*mm^2*
   ...
   Pi^(2*d) + (I*EL^5*gFFA*gFll^2*gZlR^2*mm^2*s*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*s*(-2*psq + s + 2*t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 4*d)*EL^5*gFFA*gFll^2*mm^2*
    (aa*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(2*mm^2 - psq - t) + 
       2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(2*s + d*(-psq + t)) + 
       (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(mm^2*(2*psq - s) - psq*(psq - s + t))) + 
     bb*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*(-2*s + d*(psq - t)) - 
       (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(psq - t) - 
       (-2 + d)*gZlR^2*(2*Pi)^(2*d)*(psq^2 + mm^2*s - psq*(s + t))))*
  ...
  (I*4^(-1 - 2*d)*EL^5*gFFA*gFll^2*gZlR*mm^2*
    (2^(1 + 2*d)*bb*gZlR*Pi^(2*d)*(2*mm^2*(psq - t) + 
       (2*psq + s)*(psq - s - t)) + bb*d*(2*Pi)^(2*d)*
      (4*gZlL*mm^2*(2*psq - s - 2*t) - 2*gZlR*mm^2*(psq - t) - 
       gZlR*(2*psq + s)*(psq - s - t)) + (aa - bb)*(-2 + d)*gZlR*(2*Pi)^(2*d)*
      s*(-2*psq + s + 2*t) - 2^(1 + 2*d)*aa*gZlR*Pi^(2*d)*
      (2*psq^2 + psq*(3*s - 2*t) + 2*mm^2*(psq - 2*s - t) - s*(s + t)) - 
     aa*d*(2*Pi)^(2*d)*(4*gZlL*mm^2*(2*psq - s - 2*t) + 
       gZlR*(-2*psq^2 - 3*psq*s + s^2 + 2*psq*t + s*t + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*mm^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*
    gFll^2*gZlR^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*(aa*(psq - s - t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
  ...
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q1, q1]])/(2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFFA*gFll^2*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[p3, q1]])/Pi^(2*d) + (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q1], 
     SP[q1, q1]])/(2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*(2*psq - s - 2*t)*
   ...
   (2*Pi)^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    (-(aa*s) + bb*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    (-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*((-2 + d)*mm^2 - (-2 + d)*psq + 
     2*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/
   (2*Pi)^(2*d) - (I*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3], 
     SP[q1, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    ((-2 + d)*mm^2 - (-2 + d)*psq + 2*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
     SP[p3, q1]])/(4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZlR^2*
  ...
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*(aa*(2*mm^2 - psq - t) + 
    ...
    gFFA*gFll^2*gZlR^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2], 
     SP[q1, q1]])/Pi^(2*d) - (I*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     ...
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*EL^5*gFFA*gFll^2*gZlR^2*
    mm^2*(-(bb*s) + aa*((-2 + d)*mm^2 + 2*psq - d*psq + s))*\[Mu]^(8 - 2*d)*
