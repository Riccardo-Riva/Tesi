...
PropList[KiraPropagator[-p3 - q1, 0], KiraPropagator[p1 + p2 - p3 - q1, 0], 
 ...
 ((I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*s*(psq + 4*s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(psq + 7*s)*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA^3*s*
    (bb*(-4*psq^2 + mm^2*(3*psq + 9*s - t) + 2*psq*(-6*s + t) + 
       4*s*(s + t)) + aa*(2*psq^2 - 2*psq*t - 4*s*(s + t) + 
       mm^2*(-psq + 3*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(2*psq^2 + psq*(5*s - 2*t) - 
     2*s*(s + 3*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*s*(-2*psq + s + 2*t)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA^3*s*
    ...
    SPList[SP[p2, q1]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*
    (2*psq^2 + 5*psq*s - 4*s^2 - 2*psq*t - 6*s*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA^3*s*(bb*mm^2*(2*psq + s - 2*t) + 
     aa*mm^2*(-2*psq + 3*s + 2*t) + 2*aa*s*(-5*psq + 2*s + 4*t) - 
     2*bb*s*(-3*psq + 2*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA^3*s*
    (bb*(2*psq^2 - 2*mm^2*s + psq*(s - 2*t)) + 
     aa*(-2*psq^2 - 2*mm^2*s + 3*psq*s + 2*psq*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q1]])/Pi^(2*d) - (I*EL^5*gAl^2*gFFA^3*(mm^2 - psq)*s*
    (aa*(2*psq - 3*s - 2*t) - bb*(2*psq + s - 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) - 
  ((3*I)*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(2*psq - s - 2*t)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA^3*
   ...
   Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(4*psq - s - 4*t)*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(4*psq - 3*s - 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA^3*(aa*mm^2*(2*psq - 5*s - 2*t) + 
     bb*mm^2*(-2*psq - 3*s + 2*t) - 2*aa*s*(-8*psq + 3*s + 6*t) + 
  ...
  (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*
   ...
   Pi^(2*d) + (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q2, q2]])/
   Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*s*(aa*(psq - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], 
     SP[p1, q1]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
   Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*s*(aa*(mm^2 - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/
   Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(2*psq - s - 2*t)*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^2*gFFA^3*(bb*(4*psq^2 + 2*psq*(6*s - t) + 
       mm^2*(-3*psq - 9*s + t) - 4*s*(s + t)) + 
     aa*(-2*psq^2 + mm^2*(psq - 3*s - t) + 2*psq*t + 4*s*(s + t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*s*(aa*(psq - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, p3]])/Pi^(2*d) + 
  (I*EL^5*gAl^2*gFFA^3*(bb*(4*psq^2 + 2*psq*(5*s - t) + 
       mm^2*(-3*psq - 7*s + t) - 4*s*(s + t)) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA^3*s*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, p3]])/Pi^(2*d) - 
  (I*EL^5*gAl^2*gFFA^3*(bb*(-2*psq^2 - 8*psq*s + mm^2*(psq + 4*s - t) + 
       2*psq*t + 4*s*t) + aa*(-4*s*t - 2*psq*(2*s + t) + 
       mm^2*(psq + 8*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
   (2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/
   Pi^(2*d) + (I*EL^5*gAl^2*gFFA^3*(6*aa*psq*s + 
  ...
  (I*EL^5*gAl^2*gFFA^3*(bb*(2*psq^2 + psq*(7*s - 2*t) - 
       2*s*(3*mm^2 + s + t)) + aa*(-2*psq^2 + 2*s*(-mm^2 + s + t) + 
       psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/
  ...
  (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*s*(aa*(mm^2 - t) + bb*(-psq + t))*
  ...
  (I*EL^5*gAl^2*gFFA^3*(bb*(-2*psq^2 - 6*psq*s + mm^2*(psq + 2*s - t) + 
       2*psq*t + 4*s*t) + aa*(-4*s*t - 2*psq*(3*s + t) + 
       mm^2*(psq + 10*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
     SP[p2, q2]])/(2*Pi)^(2*d) + (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*s*
    (aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q1], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl^2*gFFA^3*s*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA^3*s*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*EL^5*gAl^2*gFFA^3*(-10*aa*psq*s + bb*mm^2*(2*psq + s - 2*t) + 
     4*aa*s*(s + t) + aa*mm^2*(-2*psq + 7*s + 2*t) + 
     2*bb*s*(psq - 2*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
     SP[p3, q1]])/(2*Pi)^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*
    mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/
   Pi^(2*d) - (I*EL^5*gAl^2*gFFA^3*
    (aa*(2*psq^2 + 6*mm^2*s - 5*psq*s - 2*psq*t - 2*s*t) + 
     bb*(-2*psq^2 + 2*s*(mm^2 + t) + psq*(-3*s + 2*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA^3*
    (aa*(-2*psq^2 + 5*psq*s + mm^2*(2*psq - 7*s - 2*t) + 2*psq*t + 2*s*t) - 
  ...
  (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*(aa*(7*mm^2 - 3*psq - 4*t) + 
     bb*(mm^2 - 5*psq + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[p2, q2]])/Pi^(2*d) + (I*4^(2 - d)*EL^5*gAl^2*gFFA^3*
    (bb*(psq - t) + aa*(-mm^2 + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q1], SP[p3, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl^2*gFFA^3*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA^3*(bb*(psq - t) + aa*(-2*mm^2 + psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA^3*(bb*(mm^2 - psq - s) + 
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA^3*(aa*(6*mm^2 - 2*psq - s - 4*t) + 
     bb*(2*mm^2 - 6*psq + s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*gFFA^3*(2*psq - s - 2*t)*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA^3*(bb*(psq - t) + aa*(-mm^2 + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*(aa - bb)*EL^5*gAl^2*gFFA^3*(mm^2 - psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/Pi^(2*d) - 
  (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA^3*(aa*(psq - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p1, q2], SP[p3, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl^2*gFFA^3*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/
   (4^d*Pi^(2*d)) - (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*4^(1 - d)*EL^5*gAl^2*gFFA^3*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(3 - 2*d)*EL^5*gAl^2*gFFA^3*(aa*(mm^2 - t) + bb*(-psq + t))*
