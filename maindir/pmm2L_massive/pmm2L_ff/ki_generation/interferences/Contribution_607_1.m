...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
   ...
   ((2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (2*(-1 + d)*psq^3 + psq^2*((3 - 2*d)*s - 6*(-1 + d)*t) - 
       (s + t)*(2*s^2 + (-3 + 2*d)*s*t + 2*(-1 + d)*t^2) + 
       psq*(6*s^2 + 2*(-4 + 3*d)*s*t + 6*(-1 + d)*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (2*(-1 + d)*psq^3 - psq^2*(s + 6*(-1 + d)*t) - 
       2*psq*(s^2 - d*s*t - 3*(-1 + d)*t^2) + 
       t*(-3*s^2 - 2*(-1 + d)*t^2 + s*(t - 2*d*t)))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*(mm^2 - psq)*
     ...
     Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (-psq + s + t)*((14 - 8*d)*psq + (-2 + 3*d)*s + 2*(-7 + 4*d)*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (gZlR*mm^2*(psq - s - t)*(2*(-7 + 4*d)*psq + (12 - 5*d)*s + 
         2*(7 - 4*d)*t) + 2*gZlL*((16 - 6*d)*psq^3 + 
         2*t*(s + t)*((-4 + d)*s + (-2 + d)*t) + 
    ...
    (4^(1 - d)*(-12 + 5*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
     Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (gZlR*mm^2*(6*(-5 + 2*d)*psq^2 + (28 - 9*d)*psq*s + 
         12*(5 - 2*d)*psq*t - 2*t*(14*s + 15*t) + d*(s^2 + 9*s*t + 12*t^2)) - 
    ...
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*
      (4*(-1 + d)*psq^2 + 2*(-4 + d)*psq*s - 8*(-1 + d)*psq*t + 
       4*(2*s - t)*t - d*(s^2 + 2*s*t - 4*t^2))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (gZlR*mm^2*s*((-11 + 5*d)*psq + (10 - 3*d)*s + (11 - 5*d)*t) + 
       gZlL*(2*(-2 + d)*psq^3 - 2*(-2 + d)*t*(s + t)^2 + mm^2*s*(3*s + t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      (-4*psq^3 + psq^2*(s + 12*t) + 2*psq*(mm^2*s + s^2 - 4*s*t - 6*t^2) + 
       (s + t)*(-2*mm^2*s + t*(3*s + 4*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (gZlR*mm^2*(6*(-5 + 2*d)*psq^2 + (32 - 15*d)*psq*s + (-2 + 4*d)*s^2 + 
         12*(5 - 2*d)*psq*t + (-32 + 15*d)*s*t + 6*(-5 + 2*d)*t^2) + 
       2*gZlL*(mm^2*(2*(-3 + d)*psq^2 + s^2 - 4*(-3 + d)*psq*t + 
           2*(-3 + d)*s*t + 2*(-3 + d)*t^2) + 2*((5 - 2*d)*psq^3 + 
           (-12 + 5*d)*psq^2*t + (-2 + d)*t^2*(s + t) + 
           psq*(s^2 + (5 - 2*d)*s*t + (9 - 4*d)*t^2))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (gZlR*mm^2*(4*(-1 + d)*psq^2 + (14 - 8*d)*psq*s + (-10 + 3*d)*s^2 - 
         8*(-1 + d)*psq*t + 2*(-7 + 4*d)*s*t + 4*(-1 + d)*t^2) + 
    ...
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlR*mm^2*(psq - t)*
      ((14 - 8*d)*psq + (-12 + 5*d)*s + 2*(-7 + 4*d)*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (-(gZlR*mm^2*(psq - t)*(2*(-7 + 4*d)*psq + 2*s - 3*d*s + 14*t - 
          8*d*t)) - 2*gZlL*(2*(-2 + d)*psq^3 + psq^2*(-5*s - 6*(-2 + d)*t) - 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (gZlR*mm^2*s*((11 - 5*d)*psq + (-1 + 2*d)*s + (-11 + 5*d)*t) + 
       gZlL*(-2*(-2 + d)*psq^3 + psq^2*(s + 6*(-2 + d)*t) + 
         psq*(-(mm^2*s) + 2*s^2 + (3 - 2*d)*s*t - 6*(-2 + d)*t^2) + 
         (s + t)*(mm^2*s + 2*(-2 + d)*t^2)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (gZlR*mm^2*(-4*(-1 + d)*psq^2 + 6*psq*s + d*s^2 + 8*(-1 + d)*psq*t - 
         6*s*t + 4*t^2 - 4*d*t^2) + 2*gZlL*(2*(-2 + d)*psq^3 + 
         mm^2*s*(2*s - t) - 2*(-2 + d)*t*(s + t)^2 + 
         psq^2*((3 - 2*d)*s - 6*(-2 + d)*t) + 
         psq*(mm^2*s + (s + t)*(s + 6*(-2 + d)*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (2*(-1 + d)*gZlR*mm^2*(2*psq - s - 2*t)*(psq - t) + 
       gZlL*(-4*psq^3 + psq^2*(5*s + 12*t) + t*(2*mm^2*s + 3*s^2 + 7*s*t + 
           4*t^2) - 2*psq*(mm^2*s + 6*t*(s + t))))*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (-2*(-1 + d)*gZlR*mm^2*(psq - s - t) + 
       gZlL*((-54 + 13*d)*psq^2 + psq*((54 - 15*d)*s + 8*(9 - 2*d)*t) + 
         (s + t)*(4*(-4 + d)*s + 3*(-6 + d)*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (2*(-1 + d)*gZlR*mm^2*(psq - s - t) + gZlL*((52 - 12*d)*psq^2 + 
         (-10 + 3*d)*mm^2*(2*psq - s - 2*t) - (s + t)*((-14 + 3*d)*s + 
           2*(-8 + d)*t) + psq*((-46 + 11*d)*s + 2*(-34 + 7*d)*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*
      (-2*(-1 + d)*gZlR*mm^2*(psq - s - t) + 
       gZlL*(4*(-7 + 2*d)*psq^2 + (s + t)*(3*(-2 + d)*s + 4*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*((-6 + d)*psq^2 + 
       psq*(-((-18 + d)*s) - 4*(-4 + d)*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*(2*(-1 + d)*gZlR*mm^2*s + 
       gZlL*((-30 + 9*d)*psq^2 + (-14 + 5*d)*mm^2*s + (78 - 23*d)*psq*s - 
         ...
         9*d*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*gZlL*
      ...
      (2*(-1 + d)*gZlR*mm^2*(psq - s - t) + 
       gZlL*((26 - 7*d)*psq^2 - (s + t)*(2*(-2 + d)*s - (-6 + d)*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAu*gWlN*gWNl*gWWA*gWWZ*(2*(-1 + d)*gZlR*mm^2*s + 
       gZlL*((-22 + 5*d)*psq^2 + (-10 + 3*d)*mm^2*s + (50 - 13*d)*psq*s - 
         ...
         5*d*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
