...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
  ...
  ((4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*(-4*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 + psq) + 
      gZlR^2*(mm^2 + psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*(-4*gZlL*gZlR*mm^2 + 
      gZlL^2*(mm^2 + psq) + gZlR^2*(mm^2 + psq))*s*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*
     (-4*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 + psq) + gZlR^2*(mm^2 + psq))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*(-4*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 + psq) + 
      gZlR^2*(mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*(-4*gZlL*gZlR*mm^2 + 
   ...
   (4^(2 - d)*EL^6*gAl*gFFA*gFFZ^2*(2*gZlL*gZlR*mm^2 + 
   ...
   (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*(-4*gZlL*gZlR*mm^2 + gZlL^2*(mm^2 + psq) + 
      gZlR^2*(mm^2 + psq))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*(2*mm^2 - 2*psq + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) - 
   (4^(2 - d)*EL^6*gAl*gFFA*gFFZ^2*(4*gZlL*gZlR*mm^2 + 
      gZlL^2*(mm^2 - 3*psq + s) + gZlR^2*(mm^2 - 3*psq + s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q1]])/Pi^(2*d) + 
   (4^(2 - d)*EL^6*gAl*gFFA*gFFZ^2*(-4*gZlL*gZlR*mm^2 + gZlL^2*(2*psq - s) + 
      gZlR^2*(2*psq - s))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q1, q2]])/
    Pi^(2*d) + (4^(1 - d)*EL^6*gAl*gFFA*gFFZ^2*(-4*gZlL*gZlR*mm^2 + 
      gZlL^2*(mm^2 + psq) + gZlR^2*(mm^2 + psq))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) + (2^(7 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], SP[p2, q1]])/Pi^(2*d) + 
   (3*2^(5 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q1], SP[p2, q2]])/Pi^(2*d) + 
   (4^(3 - d)*EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*
   ...
   (3*2^(3 - 2*d)*EL^6*gAl*gFFA*gFFZ^2*(gZlL^2 + gZlR^2)*\[Mu]^(8 - 2*d)*
