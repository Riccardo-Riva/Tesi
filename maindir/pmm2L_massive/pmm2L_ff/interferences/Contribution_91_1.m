   ...
   (-((4^(1 - d)*EL^6*gAu*gFFA*gFll^4*mm^4*psq*(psq*(psq - t) + 
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFll^4*mm^4*psq*(psq - s - t)*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFll^4*mm^4*psq*
      (psq - t)*(2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAu*gFFA*gFll^4*mm^4*psq*(2*mm^2 - 3*psq + s + t)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^4*(psq^2*s + 
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFll^4*mm^4*(psq - t)*(2*mm^2*(-psq + s + t) + 
       psq*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^6*
    ...
    (4^(1 - d)*EL^6*gAu*gFFA*gFll^4*mm^6*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^4*(mm^2 - psq)*(psq - t)*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^4*(psq - t)*
      ...
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gFFA*gFll^4*mm^4*(psq - t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^4*mm^4*
