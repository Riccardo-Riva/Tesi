...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((2^(1 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*s*
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(6*aa*mm^2*psq + 
      bb*s*(-3*psq + s) - aa*s*(psq + s) + bb*mm^2*(-6*psq + 4*s))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(aa*(psq - s)*s + 
   ...
   (2^(3 - 2*d)*EL^5*gAl*gHll^2*gXll^2*mm^6*(aa*(psq - s) + 
   ...
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(aa*(mm^2*(8*psq - s) - 3*psq*s) - 
      bb*(mm^2*(8*psq - 5*s) + psq*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q1, q2]])/Pi^(2*d) - 
   (4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gXll^2*mm^4*(mm^2 + psq)*(mm^2 + s)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) - 
   (4^(1 - d)*EL^5*gAl*gHll^2*gXll^2*mm^4*(-(aa*psq*s) - bb*psq*s + 
