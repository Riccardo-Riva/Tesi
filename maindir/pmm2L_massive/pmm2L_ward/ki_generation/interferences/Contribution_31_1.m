...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
   ...
   (((-I)*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
    ...
    (I*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*(mm^2 - psq)^2*
    ...
    (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
      (aa*(2*(-2 + d)*gZlL^2*mm^2 + 2*(-2 + d)*gZlR^2*mm^2 - 
         (-4 + d)*gZlL*gZlR*(mm^2 - psq)) + bb*(-4 + d)*gZlL*gZlR*
        (mm^2 - psq))*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
      (2*(-2 + d)*gZlL^2*mm^2 + 2*(-2 + d)*gZlR^2*mm^2 - 
       (-4 + d)*gZlL*gZlR*(mm^2 - psq))*(psq - s - t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
      (psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/
     Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
      (bb*d*gZlL*gZlR*(-psq + s + t) + aa*((-2 + d)*gZlL^2*(mm^2 - psq) + 
         (-2 + d)*gZlR^2*(mm^2 - psq) - d*gZlL*gZlR*(2*mm^2 - 3*psq + s + 
           t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
      (bb*(2*(-2 + d)*gZlL^2*mm^2 + 2*(-2 + d)*gZlR^2*mm^2 - 
         (-4 + d)*gZlL*gZlR*(mm^2 - psq)) + aa*(-4 + d)*gZlL*gZlR*
        (mm^2 - psq))*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*mm^4*((-2 + d)*gZlL^2*(psq - t) + 
       (-2 + d)*gZlR^2*(psq - t) + d*gZlL*gZlR*(-2*psq + s + 2*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/Pi^(2*d) - 
    (I*4^(1 - d)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
    ...
    (I*2^(3 - 2*d)*bb*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
    ...
    (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*(aa*d*gZlL*gZlR*(psq - t) + 
       bb*((-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq) + 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
     ...
     Pi^(2*d) + (I*4^(1 - d)*(aa + bb)*d*EL^5*gAl*gHll^2*gZlL*gZlR*mm^2*
     ...
     Pi^(2*d) - (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*
      ((-2 + d)*gZlL^2*mm^2 + (-2 + d)*gZlR^2*mm^2 - (-4 + d)*gZlL*gZlR*
       ...
       SP[p2, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*(-4 + d)*EL^5*gAl*gHll^2*gZlL*
