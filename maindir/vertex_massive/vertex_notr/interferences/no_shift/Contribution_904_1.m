...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*(mm^2*(4*psq - s) + 
      s*((7 - 3*d)*psq + (-2 + d)*s))*sw*\[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + 
   (2^(1 - 2*d)*EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
     (2*mm^2 + d*(psq - 2*s) + 4*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 + (-3 + d)*psq - (-2 + d)*s)*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl^2*gFZW*gXFW*gXll*
     (gZlL - gZlR)*mm^2*(2*mm^2 + psq - (-3 + d)*s)*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gFZW*gXFW*gXll*
     (gZlL - gZlR)*mm^2*(2*mm^2 - (-2 + d)*s)*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) + (EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*
     mm^2*(4*mm^2 - 8*psq - (-6 + d)*s)*sw*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/(2*Pi)^(2*d) - 
   (2^(1 - 2*d)*EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
     (2*mm^2 - 2*psq - (-4 + d)*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   ...
   (4^(1 - d)*EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*
     (mm^2 - psq - (-2 + d)*s)*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^2*gFZW*gXFW*gXll*
     (gZlL - gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    Pi^(2*d) + (2^(3 - 2*d)*EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) - 
   (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gFZW*gXFW*gXll*(gZlL - gZlR)*mm^2*sw*
