...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  ((I*EL^5*gAl*gHll^2*mm^4*(mm^2 - psq)*s*
     ...
     \[Mu]^(8 - 2*d))/(2*Pi)^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
    ...
    Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gHll^2*mm^2*(mm^2 - psq)*
    ...
    (2*Pi)^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^4*
   ...
   (I*4^(1 - d)*(-2 + d)*EL^5*gAl*gHll^2*(gZlL^2 + gZlR^2)*mm^4*
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*mm^2*(4*gZlL*gZlR*mm^2*s - 
   ...
   (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gHll^2*gZlL*gZlR*mm^4*
     (-2*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q1, q1]])/Pi^(2*d) + (I*4^(1 - d)*EL^5*gAl*gHll^2*mm^2*
     (bb*(-((-2 + d)*gZlL^2*(psq*(psq - t) + mm^2*(psq - s - t))) - 
        (-2 + d)*gZlR^2*(psq*(psq - t) + mm^2*(psq - s - t)) + 
        2*d*gZlL*gZlR*mm^2*(2*psq - s - 2*t)) + 
      aa*((-2 + d)*gZlL^2*(mm^2*(psq - t) + psq*(psq - s - t)) + 
