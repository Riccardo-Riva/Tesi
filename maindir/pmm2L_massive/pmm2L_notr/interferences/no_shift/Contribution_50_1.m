...
(PropList[KiraPropagator[q1, mw], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*(mm^2 + psq)*
     (2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*
     gXFW*gXll*mm^2*(mm^2 - 2*psq)*(2*psq + (-6 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*(mm^2 - psq)*
     ...
     gXFW*gXll*mm^2*(-2*psq^2 + mm^2*s - (-5 + d)*psq*s + 2*psq*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*(mm^2 - psq)*
     (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWNl*
     gXFW*gXll*mm^2*(2*psq^2 + mm^2*s - psq*((-3 + d)*s + 2*t))*
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*(mm^2 - 2*psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/
    (Pi^(2*d)*s^2) - (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
      SP[p3, q2]])/(Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWNl*
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*(mm^2 - 2*psq)*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*
     ...
     gXFW*gXll*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFll*gWNl*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*(-2*psq + d*s + 2*t)*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*
     (2*psq - (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p3, q2], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gFll*gWNl*gXFW*gXll*mm^2*(psq - t)*
