...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   ((4^(2 - d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^4*
    ...
    (4^(1 - d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (psq*(2*psq - s - 2*t)*(psq - t) + mm^2*(14*psq^2 - 3*psq*s - 
         28*psq*t + 11*s*t + 14*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     Pi^(2*d) - (4^(1 - d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
    ...
    (4^(1 - d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
     ...
     Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (-psq + s + t)*(2*psq^2 + 3*mm^2*s + s^2 + 3*s*t + 2*t^2 - 
       2*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (-psq + s + t)*(2*(-2 + d)*mm^4 + psq*(-3*(-2 + d)*psq - 2*t + 
         d*(s + t)) + mm^2*(-3*(-2 + d)*psq - 6*t + 3*d*(s + t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q1]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[q1, q2]])/Pi^(2*d) - (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gHll^2*gWlN*
      gWNl*gWWA*mm^2*(-psq + s + t)*(mm^4 + psq^2 + 2*mm^2*(-2*psq + s + t))*
    ...
    (2^(3 - 2*d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q1]])/Pi^(2*d) - (4^(2 - d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q1, q2]])/Pi^(2*d) + (4^(2 - d)*(-2 + d)*EL^6*gAu*gHll^2*gWlN*gWNl*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*(3*mm^2 + psq)*
      (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[q1, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gHll^2*gWlN*gWNl*
      gWWA*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (mm^2*(12*psq - 7*s - 12*t) + psq*(4*psq - s - 4*t))*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*(2*psq^2 + psq*(s - 4*t) + 
      ...
      mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p3, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gHll^2*gWlN*
    ...
    (4^(1 - d)*(-2 + d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[q1, q1]])/Pi^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gHll^2*gWlN*
    ...
    (4^(2 - d)*(-2 + d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*(mm^2 - psq)*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAu*gHll^2*gWlN*gWNl*gWWA*mm^2*
      (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[q1, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gHll^2*gWlN*gWNl*
