...
PropList[KiraPropagator[-p1 + q1, ml], KiraPropagator[p2 + q1, ml]]*
 (((-I)*2^(-1 - 2*d)*EL^6*gAl*gAu*(gZlL + gZlR)*ml^2*
  ...
  (I*2^(-1 - 2*d)*EL^6*gAl*gAu*
   ...
   (Pi^(2*d)*s*(-mz^2 + s)*(-mzC^2 + s)) + 
  (I*(-3 + d)*EL^6*gAl*gAu*(gZlL - gZlR)*
    (gZlR*gZlRC*((-4 + d)*gZuLC*s - (-2 + d)*gZuRC*s - 2*gZuLC*t - 
       2*gZuRC*t) + gZlL*gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 
       2*gZuLC*t + 2*gZuRC*t))*\[Mu]^(4 - d)*SPList[SP[p2, p3]])/
   ((2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)) - 
  ((I/2)*EL^6*gAl*gAu*((2^(1 - d)*(-3 + d)*(gZlL - gZlR)*s*
     ...
     (gZlL*gZlR*(gZlLC*(d^2*gZuLC*(2*Pi)^d*s^2 + d^2*gZuRC*(2*Pi)^d*s^2 + 
       ...
       gZlL^2*gZlLC*(-(gZuRC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*
         ...
         gZuLC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*((2 - 2*d + d^2)*s^2 + 
             (8 - 5*d + d^2)*s*t + 2*t^2))) + gZlR^2*gZlRC*
        (-(gZuLC*(d^2*(2*Pi)^d*s^2 + 2^(1 + d)*Pi^d*((16 - 10*d + d^2)*s^2 + 
              (10 - 7*d + d^2)*s*t - 2*t^2))) + gZuRC*(-(d^2*(2*Pi)^d*s^2) + 
           2^(1 + d)*Pi^d*((2 - 2*d + d^2)*s^2 + (8 - 5*d + d^2)*s*t + 
             2*t^2))))/(2*Pi)^(2*d))*\[Mu]^(4 - d)*SPList[SP[p2, q1]])/
   ((mz^2 - s)*s*(-mzC^2 + s)) + (I*(-3 + d)*EL^6*gAl*gAu*(gZlL - gZlR)*
    (gZlR*gZlRC*((-4 + d)*gZuLC*s - (-2 + d)*gZuRC*s - 2*gZuLC*t - 
       2*gZuRC*t) + gZlL*gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s + 
       2*gZuLC*t + 2*gZuRC*t))*\[Mu]^(4 - d)*SPList[SP[p3, q1]])/
   ((2*Pi)^d*(mz^2 - s)*(-mzC^2 + s)) + 
  ...
  (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*
    (gZlR*gZlRC*(-((-2 + d)*gZuLC) + (-4 + d)*gZuRC) + 
     gZlL*gZlLC*((-4 + d)*gZuLC - (-2 + d)*gZuRC))*(s + t)*\[Mu]^(4 - d)*
    SPList[SP[p1, p2], SP[p1, q1]])/(Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)) + 
  (I*2^(1 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*
  ...
  (I*2^(2 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuLC + gZuRC)*\[Mu]^(4 - d)*SPList[SP[p2, p3], SP[p2, p3]])/
   (Pi^d*(-mz^2 + s)*(-mzC^2 + s)) - 
  (I*2^(1 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*
    (gZlL*gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s - 2*gZuLC*t - 
       2*gZuRC*t) + gZlR*gZlRC*(-((-4 + d)*gZuLC*s) + (-2 + d)*gZuRC*s - 
   ...
   (Pi^d*s*(-mz^2 + s)*(-mzC^2 + s)) + 
  (I*2^(3 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*(gZlL*gZlLC + gZlR*gZlRC)*
    (gZuLC + gZuRC)*\[Mu]^(4 - d)*SPList[SP[p2, p3], SP[p3, q1]])/
   (Pi^d*(-mz^2 + s)*(-mzC^2 + s)) + 
  (I*2^(1 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*
    (gZlL*gZlLC*((-2 + d)*gZuLC - (-4 + d)*gZuRC) + 
     gZlR*gZlRC*(-((-4 + d)*gZuLC) + (-2 + d)*gZuRC))*t*\[Mu]^(4 - d)*
    SPList[SP[p2, q1], SP[p2, q1]])/(Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) - 
  (I*2^(1 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*
    (gZlL*gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s - 2*gZuLC*t - 
       2*gZuRC*t) + gZlR*gZlRC*(-((-4 + d)*gZuLC*s) + (-2 + d)*gZuRC*s - 
