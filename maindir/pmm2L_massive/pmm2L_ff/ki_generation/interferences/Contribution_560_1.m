...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   ((-3*2^(1 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*mm^2*
    ...
    (3*4^(1 - d)*(-1 + d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*mm^2*
     ...
     (Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*
      (2*(-2 + d)*psq^3 + psq^2*((5 - 3*d)*s - 6*(-2 + d)*t) + 
       t*(3*mm^2*s + 2*s^2 + 6*s*t + 4*t^2) + 
       psq*((-3 + 4*d)*mm^2*s + t*((-11 + 6*d)*s + 6*(-2 + d)*t)) - 
       d*(mm^2*s*(s + 4*t) + t*(s^2 + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*
     ...
     (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl*gAu*gWWAA*gWWZ*(gZlL + gZlR)*
      ((24 - 13*d)*psq^2 + 2*(-3 + 2*d)*mm^2*(psq - t) - 
       9*(-2 + d)*t*(s + t) + psq*(-8*s + 5*d*s - 42*t + 22*d*t))*
