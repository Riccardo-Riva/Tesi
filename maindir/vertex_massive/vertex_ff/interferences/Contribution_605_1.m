...
(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
  ...
  ((2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(-2*(-1 + d)*psq^3 + 
   ...
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*
     (mm^2*(psq - t)*(2*(-7 + 4*d)*psq + 4*s - 3*d*s + 14*t - 8*d*t) + 
      2*(2*(-2 + d)*psq^3 + psq^2*(-5*s - 6*(-2 + d)*t) - 
        2*t*(s + t)*(2*s + (-2 + d)*t) + psq*t*((5 + 2*d)*s + 6*(-2 + d)*t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(4*(-1 + d)*psq^2 + 
      (-12 + 5*d)*s^2 + 2*(-8 + 5*d)*s*t + 4*(-1 + d)*t^2 - 
      2*psq*((-8 + 5*d)*s + 4*(-1 + d)*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-1 + d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*mm^2*(2*psq - s - 2*t)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((-6 + d)*psq^2 + 
      psq*((14 - 3*d)*s - 4*(-4 + d)*t) + mm^2*(2*(-2 + d)*psq - (2 + d)*s - 
        2*(-2 + d)*t) + (s + t)*((-2 + d)*s + (-10 + 3*d)*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((-2 + d)*mm^2 + (-6 + d)*psq + 
      6*s - d*s + 8*t - 2*d*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
      SP[p3, q2]])/Pi^(2*d) + (4^(2 - d)*(-2 + d)*EL^6*gAl*gAu*gWlN*gWNl*
     gWWA^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 2*t^2)*
   ...
   (2^(3 - 2*d)*EL^6*gAl*gAu*gWlN*gWNl*gWWA^2*((-26 + 7*d)*psq^2 + 
      psq*((34 - 9*d)*s + (20 - 6*d)*t) + 
      (s + t)*(2*(-2 + d)*s - (-6 + d)*t) + 
