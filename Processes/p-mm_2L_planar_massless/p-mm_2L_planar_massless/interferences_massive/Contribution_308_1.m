(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
  ...
  (-((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
   ...
   (4^(1 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(2*mm^2 + s)*
   ...
   (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(mu^2 + s + t)*
     SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(s + 2*t)*
   ...
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(s + t)*
     SPList[SP[p1, q2], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
     (-8*(mu^2 + s) + d*(2*mm^2 + 4*mu^2 + 3*s + t))*
     SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(4*mm^2 + s)*
     SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(2*mu^2 + s)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
     (mu^2 - t)*SPList[SP[p2, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(s + 2*t)*
     SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*
     (2*mu^2 + s)*SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(3 - 2*d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*t*
   ...
   (4^(2 - d)*d*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(2*mu^2 + s)*
     SPList[SP[p3, q1], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gFAW*gFll*gWlN*gWWA*mm^2*(2*mu^2 + s)*
