...
PropList[KiraPropagator[-q1, mh], KiraPropagator[-q1 - q2, mz], 
 ...
 (((-I)*EL^5*gAl*gHZZ^2*s*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      s - (aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*psq*(-2*psq + s + 2*t) - 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I/4)*EL^5*gAl*gHZZ^2*
   ...
   SPList[SP[p1, p2]] + 
  (I*EL^5*gAl*gHZZ^2*(2*(aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s - 
  ...
  (I*4^(-1 - d)*EL^5*gAl*gHZZ^2*(-2*bb*(gZlL^2 + gZlR^2)*
      (4*psq^2 + 2*mm^2*s - 5*psq*s - 4*psq*t + s*t) + 
    ...
    SPList[SP[p2, q2]])/Pi^(2*d) - (I*(aa + bb)*(-2 + d)*EL^5*gAl*gHZZ^2*
    (gZlL^2 + gZlR^2)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHZZ^2*
    (gZlL^2 + gZlR^2)*s*(aa*(-2*mm^2 + s + 2*t) - 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   Pi^(2*d) - (I*(aa + bb)*(-2 + d)*EL^5*gAl*gHZZ^2*(gZlL^2 + gZlR^2)*
    (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(-2 + d)*EL^5*gAl*gHZZ^2*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHZZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHZZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
  ...
  (I*(-2 + d)*EL^5*gAl*gHZZ^2*(gZlL^2 + gZlR^2)*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gHZZ^2*(gZlL^2 + gZlR^2)*
   ...
   Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHZZ^2*(gZlL^2 + gZlR^2)*
