...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*mm^2*
  ...
  (3*4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/Pi^(2*d) - 
  (3*2^(1 - 2*d)*(-3 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*mm^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*(-5 + 2*d)*psq^2 - 
  ...
  (4^(1 - d)*(33 - 16*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(2*(-2 + d)*psq^2 + 
  ...
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*(-10 + 3*d)*psq^2 + 72*s^2 - 
     22*d*s^2 + d^2*s^2 - 8*s*t + 4*d*s*t - 24*t^2 + 4*d*t^2 + 
     2*mm^2*(4*(-3 + 2*d)*psq + (36 - 21*d + d^2)*s + 4*(3 - 2*d)*t) - 
     2*psq*((38 - 11*d + d^2)*s + 8*(-4 + d)*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*psq^2 - 8*s^2 + 4*d*s^2 + 
     4*s*t + 2*d*s*t - 8*t^2 + 4*d*t^2 - 4*psq*(2*s + (-1 + d)*t) + 
     mm^2*(2*(-13 + 6*d)*psq + d^2*s + 26*t - 2*d*(s + 6*t)))*\[Mu]^(8 - 2*d)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    (8*psq^2 + (-20 + 9*d)*mm^2*s + (36 - 11*d)*psq*s - 6*s^2 + 3*d*s^2 - 
     ...
     SP[q2, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
  ...
  (EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*(-10 + 3*d)*psq^2 + 8*s^2 - 6*d*s^2 + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-4 + 3*d)*mm^2 + 
     3*(-2 + d)*psq + 4*(-4 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q1, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-2 + d)*mm^2 - 
     (-2 + d)*psq + (-9 + 2*d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-2 + 3*d)*mm^2 + 
     (-2 + d)*psq + (9 - 2*d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-4 + 3*d)*mm^2 + 
     3*(-2 + d)*psq + 4*(-4 + d)*s)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q2]])/(Pi^(2*d)*s) + 
  (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(-psq + s + t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(-psq + s + t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    ...
    gWNl*gWWA^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[p1, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
    gWWA^2*((-20 + 9*d)*mm^2 + (50 - 13*d)*psq - 24*s + 5*d*s - 16*t + 2*d*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    ((-8 + 3*d)*mm^2 + (18 - 5*d)*psq - 2*s + 2*d*s + 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(2*(-18 + 7*d)*psq + 
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-16 + 7*d)*mm^2 + 
  ...
  (4^(2 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*\[Mu]^(8 - 2*d)*
  ...
  (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(-psq + s + t)*
   ...
   (Pi^(2*d)*s^2) - (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    ...
    gWlN*gWNl*gWWA^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    ((-16 + 7*d)*mm^2 - 8*(-3 + d)*psq - 2*s + 2*d*s + 6*t - d*t)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*((-12 + 5*d)*mm^2 - 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(2*mm^2 - psq - t)*
  ...
  (2^(5 - 2*d)*(-3 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
  (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(-((-2 + d)*psq) + 
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(-2*psq + s + 2*t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(2*psq - 3*s - 2*t)*
  ...
  (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(2*psq + s - 2*t)*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    (2*psq + s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (4^(2 - d)*(-4 + d)*EL^8*gAl^2*gAu^2*gWlN*
   ...
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    ...
    gWlN*gWNl*gWWA^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*
   ...
   (Pi^(2*d)*s^2) + (2^(5 - 2*d)*(-3 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
