...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mh], 
 ...
 (((-I)*4^(-1 - d)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(mm^2 - psq)*s*
    (aa*(psq - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d))/Pi^(2*d) + 
  (I*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
    (aa*(-4*psq^2 + 2*mm^2*(2*psq + s - 2*t) + 4*psq*t - s*(s + 2*t)) + 
     bb*(4*psq^2 - 4*psq*(2*s + t) + s*(s + 2*t) + 
       mm^2*(-4*psq + 6*s + 4*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*
    mm^4*(aa*(-2*psq^2 + 3*psq*s - 2*s^2 + 2*mm^2*(psq - t) + 2*psq*t - 
       3*s*t) + bb*(2*psq^2 - 7*psq*s + 2*s^2 - 2*psq*t + 3*s*t + 
       mm^2*(-2*psq + 4*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/
   Pi^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*s*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*4^(-1 - d)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*s*(-psq + s + t)*
  ...
  (I*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(2*psq - s - 2*t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(psq - t)*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   Pi^(2*d) - (I*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
  ...
  (I*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/(4^d*Pi^(2*d)) - 
  ((3*I)*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*\[Mu]^(8 - 2*d)*
