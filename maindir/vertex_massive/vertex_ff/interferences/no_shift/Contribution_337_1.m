...
(PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + p2 + q1, mw], 
  ...
  (-((4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(-psq + s + t)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     ((-2 + d)*gZlL*mm^2*psq*(2*psq - s - 2*t) - 
      2*gZlR*s*(mm^2*(psq + t) + psq*(-3*psq + s + t)) + 
      d*gZlR*psq*(psq*(-psq + t) + mm^2*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(2*d) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZlR*
     gZNL*mm^2*(-psq + s + t)*(8*psq^2 - 2*mm^2*(psq - s + t) + s*(s + t) - 
      psq*(7*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1]])/
    (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     (-4*gZlR*mm^2*s + (-2 + d)*gZlL*mm^2*(psq - s - t) - 
      d*gZlR*(mm^2 + psq)*(psq - s - t))*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
     (2*mm^2*(psq - s)*(psq - t) + psq*(-2*psq^2 + s^2 + 2*psq*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(-4*gZlR*psq*s - 
      (-2 + d)*gZlL*mm^2*(psq - t) + d*gZlR*(mm^2 + psq)*(psq - t))*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     ((-2 + d)*gZlL*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
        2*t^2) - gZlR*((2 + d)*psq^3 - 2*s*(s + t)^2 - 
        psq^2*((16 + d)*s + 2*(2 + d)*t) + psq*(14*s^2 + (14 + d)*s*t + 
          (2 + d)*t^2) + mm^2*((-2 + d)*psq^2 + (-6 + d)*s^2 + 
          2*(-2 + d)*s*t + (-2 + d)*t^2 - 2*psq*((-4 + d)*s + (-2 + d)*t))))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     (4^(1 + d)*gZlR*Pi^(2*d)*(mm^2 - psq)*s*(psq - s - t) - 
      (-2 + d)*gZlL*mm^2*(2*Pi)^(2*d)*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
        3*s*t + 2*t^2) + d*gZlR*(2*Pi)^(2*d)*(mm^2 + psq)*
   ...
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(psq - s - t)*
     ((-2 + d)*gZlL*mm^2*(2*psq - s - 2*t) + 
      gZlR*(4*(-mm^2 + psq)*s + d*psq*(-psq + t) + d*mm^2*(-psq + s + t)))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*d*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
     (mm^2*(psq - t) + psq*(psq - s - t))*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(-4*gZlR*mm^2*s + 
      (-2 + d)*gZlL*mm^2*(psq - s - t) - d*gZlR*(mm^2 + psq)*(psq - s - t))*
     (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(4*gZlR*mm^2*s - 
      (-2 + d)*gZlL*mm^2*(psq - s - t) + d*gZlR*(mm^2 + psq)*(psq - s - t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/Pi^(2*d) - 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
     (4*psq^2 - 3*psq*s + 2*mm^2*(psq - t) - 4*psq*t + s*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(4*gZlR*psq*s + 
      (-2 + d)*gZlL*mm^2*(psq - t) - d*gZlR*(mm^2 + psq)*(psq - t))*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     (-((-2 + d)*gZlL*mm^2*(2*psq - s - 2*t)*(psq - t)) + 
      gZlR*((2 + d)*psq^3 - 2*s*t^2 + mm^2*(psq - t)*((-2 + d)*psq + 6*s - 
          d*s + 2*t - d*t) - 2*psq^2*(s + (2 + d)*t) + 
        psq*(-2*s^2 + 4*s*t + (2 + d)*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(4*gZlR*(-mm^2 + psq)*s + 
      (-2 + d)*gZlL*mm^2*(2*psq - s - 2*t) - d*gZlR*(mm^2 + psq)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     ((-2 + d)*gZlL*mm^2*(2*psq - s - 2*t) - 
      gZlR*((2 + d)*psq^2 + s*(s + 2*t) + mm^2*((-2 + d)*psq + 4*s - d*s + 
          2*t - d*t) - psq*(6*s + (2 + d)*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q1]])/Pi^(2*d) + 
   (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(4*gZlR*(-mm^2 + psq)*s + 
      (-2 + d)*gZlL*mm^2*(2*psq - s - 2*t) - d*gZlR*(mm^2 + psq)*
       (2*psq - s - 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
    Pi^(2*d) + (4^(1 - d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     (-((-4 + d)*gZlR*(psq*(psq - t) + mm^2*(psq - s - t))) + 
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[p1, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*
     mm^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) - 
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(psq^2 + 2*mm^2*s + 
      (s + t)^2 - 2*psq*(2*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(-psq + s + t)*
     ((-2 + d)*gZlL*mm^2 - gZlR*(d*mm^2 + 2*(-3*psq + s + t)))*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
     (-psq + s + t)*((4 + d)*mm^2 - (8 + d)*psq + 4*(s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*mm^2 - 3*psq + s + t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], 
      SP[q1, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*d*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*
     mm^2*(2*mm^2 - 3*psq + s + t)*(-psq + s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     ((-2 + d)*gZlL*mm^2*(psq - s - t) + d*gZlR*mm^2*(-psq + s + t) + 
      4*gZlR*(psq^2 - mm^2*s - psq*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
     (2*(-2 + d)*psq^2 + 4*psq*t - 3*d*psq*(s + t) + d*(s + t)^2 + 
   ...
   (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
     (2*mm^2 - 3*psq + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     ((-2 + d)*gZlL*mm^2 - d*gZlR*mm^2 + 4*gZlR*psq)*(psq - t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*(4 + d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
     (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*
   ...
   (2^(3 - 2*d)*d*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*(psq - t)*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     (2*gZlL*mm^2*s - d*gZlL*mm^2*s + 4*gZlR*s*(-2*psq + s + t) + 
      d*gZlR*(psq^2 + mm^2*s + t*(s + t) - psq*(s + 2*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (4^(1 - d)*(-4 + d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
     (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*
     mm^2*(2*psq^2 + 2*mm^2*s + 3*s^2 + 6*s*t + 2*t^2 - 4*psq*(2*s + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
     (4*s*(mm^2 - 2*psq + s + t) + d*(2*psq^2 + mm^2*s + s^2 + 3*s*t + 
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*(psq - t)*
     ((-2 + d)*gZlL*mm^2 + gZlR*(-((-4 + d)*mm^2) - 2*psq + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p2, q1]])/
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZNL*mm^2*
     ((-2 + d)*gZlL*mm^2*s + (-4 + d)*gZlR*mm^2*(psq - s - t) - 
      gZlR*(psq - t)*(2*(-2 + d)*psq - (-4 + d)*s - d*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*(-4 + d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
      SP[q1, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*
     mm^2*((-4 + d)*mm^2 - 2*(-2 + d)*psq - 2*s + d*s + d*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/Pi^(2*d) - 
   (4^(1 - d)*(-4 + d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
     (2*mm^2 - 3*psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
      SP[q1, q1]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
    ...
    (Pi^(2*d)*s) - (3*4^(2 - d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*
     (4*s + d*(2*psq - s - 2*t))*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(-2*s + d*(psq - t))*
   ...
   (2^(3 - 2*d)*d*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*psq - s - 2*t)*
   ...
   (4^(1 - d)*(-4 + d)*EL^6*gAu*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*psq - s - 2*t)*
