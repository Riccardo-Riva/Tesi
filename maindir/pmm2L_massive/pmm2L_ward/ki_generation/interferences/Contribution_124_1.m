   ...
   (((-I)*EL^5*gFFA*gFll^2*mm^2*s*
     ...
     (2*Pi)^(2*d) - (I*EL^5*gFFA*gFll^2*mm^2*s*
      (aa*(2*gZlL*gZlR*mm^2*(2*s + d*(psq - s - t)) + (-2 + d)*gZlL^2*mm^2*
          (2*mm^2 - 3*psq + s + t) + (-2 + d)*gZlR^2*psq*(2*mm^2 - 3*psq + 
           s + t)) + bb*((-2 + d)*gZlL^2*mm^2*(psq - s - t) + 
    ...
    (I*2^(1 - 4*d)*EL^5*gFFA*gFll^2*mm^2*
      (bb*((-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*(psq - s - t) + 
         ...
         gZlR^2*(2*Pi)^(2*d)*((-2 + d)*psq^2 + s*((-2 + d)*mm^2 + 2*s) - 
           (-2 + d)*psq*(2*s + t))) + aa*(2^(1 + 2*d)*gZlL*gZlR*mm^2*Pi^(2*d)*
          (2*s + d*(psq - s - t)) + (-2 + d)*gZlL^2*mm^2*(2*Pi)^(2*d)*
          (2*mm^2 - 3*psq + s + t) + gZlR^2*(2*Pi)^(2*d)*(-3*(-2 + d)*psq^2 + 
    ...
    (I*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*s*(bb*(psq - s - t) + 
      ...
      gZlR^2*mm^2*s*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*mm^2*
     ...
     Pi^(2*d) - (I*2^(1 - 4*d)*EL^5*gFFA*gFll^2*mm^2*
      (-(aa*(2*Pi)^(2*d)*((-2 + d)*gZlL^2*mm^2*(psq - t) + 
       ...
       SP[p2, q2]])/Pi^(4*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFFA*gFll^2*
      gZlR^2*mm^2*s*(bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gZlR*mm^2*
     ...
     Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*
      ...
      gFFA*gFll^2*gZlR^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gFFA*gFll^2*gZlR^2*mm^2*
      (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[p3, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gFFA*gFll^2*
      gZlR^2*mm^2*(bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*
