...
PropList[KiraPropagator[q1, mw], KiraPropagator[q2, 0], 
  ...
  ((EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*(-2 + d)*mm^2 + psq - 
   ...
   (EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(4*psq^2 + 4*mm^2*s - 6*s^2 + 
    ...
    (mh^2*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (4*psq^2 + 8*mm^2*s - 10*s^2 + 5*d*s^2 + 4*psq*(s - 2*t) + 4*s*t + 
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
    ...
    (mh^2*Pi^(2*d)*s) - (EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (4*psq^2 + 8*mm^2*s - 8*s^2 + 5*d*s^2 + 4*psq*(s - 2*t) + 4*s*t + 4*t^2)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*mm^2 + s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(6*mm^2 - 4*psq - 7*s + 
      2*d*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
    (mh^2*Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (2*mm^2 - 2*psq + (-3 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p2, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*mm^2 - 4*psq + s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(6*mm^2 - 8*psq - 5*s + 
      2*d*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/
    (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*(-3 + d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, p3]])/(mh^2*Pi^(2*d)*s) - 
   (4^(2 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p3, q1]])/(mh^2*Pi^(2*d)*s) + 
   (2^(3 - 2*d)*(-5 + d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*psq + (-6 + d)*s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(psq + (-6 + d)*s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(5*psq + (-16 + 3*d)*s - 
      5*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (2*mm^2 - 2*psq + (-5 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*mm^2 + psq - 6*s + 
      d*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, q1]])/
   ...
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + 3*s + 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(6*psq + (-14 + d)*s - 
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(psq + (-4 + d)*s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*mm^2 - 5*psq - 3*s + 
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p3, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + (-4 + d)*s + 
      2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (2*psq - (-2 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(3*psq + 2*(-4 + d)*s - 
      3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/
    (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (6*mm^2 - 9*psq - 11*s + 3*d*s + 3*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, p3]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*mm^2 + psq - 4*s + 
      d*s - 3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
    (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (8*mm^2 - 8*psq + (-11 + 4*d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p2, q2]])/(mh^2*Pi^(2*d)*s^2) - 
   (4^(1 - d)*(-3 + d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2], SP[p3, p3]])/(mh^2*Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + s + 2*t)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + (-4 + d)*s + 
      2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, p3]])/
    (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (-psq + (-5 + d)*s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/
    (mh^2*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (-5*psq + (-11 + 3*d)*s + 5*t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(6*psq - (-8 + d)*s - 6*t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (6*psq - (-6 + d)*s - 6*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-psq + (-3 + d)*s + t)*
   ...
   (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[q2, q2]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-3*psq + (-5 + 2*d)*s + 
      3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
    (mh^2*Pi^(2*d)*s^2) - (4^(1 - d)*(-3 + d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*
     mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, p3]])/(mh^2*Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + s + 2*t)*
 ...
 PropList[KiraPropagator[q1, mw], KiraPropagator[q2, mh], 
  ...
  (-((EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(psq - (-5 + d)*s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(5*psq + (11 - 3*d)*s - 
      5*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/
    (mh^2*Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     (-2*psq + (-4 + d)*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], 
      SP[p3, p3]])/(mh^2*Pi^(2*d)*s^2) - 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(2*psq + s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q1]])/(mh^2*Pi^(2*d)*s^2) + 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-6*psq + (-8 + d)*s + 
   ...
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*(-2*psq + (-2 + d)*s + 
      2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
    (mh^2*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p3, p3], SP[p3, q1]])/(mh^2*Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[p3, q2]])/(mh^2*Pi^(2*d)*s) - 
   (4^(1 - d)*EL^8*gAl^3*gAu^2*gFAW*gHFW*gHll*mm^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1], SP[q2, q2]])/(mh^2*Pi^(2*d)*s) + 
