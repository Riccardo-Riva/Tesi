  ...
  ((4^(1 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     (2*psq^2 + 2*psq*s - d*psq*s + 2*s^2 - 6*psq*t + 6*s*t + 4*t^2 + 
      mm^2*(-6*psq + (4 + d)*s + 6*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     (6*psq^2 + mm^2*(6*psq + (-2 + d)*s - 6*t) + 2*t*(s + 2*t) - 
      psq*((-4 + d)*s + 10*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     (-2*psq^2 + (-1 + d)*psq*s + 2*s^2 - d*s^2 + 2*mm^2*(psq - t) + 
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     (psq + s - d*s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/
    (Pi^(2*d)*s^2) + (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     (2*mm^2 - 2*psq + s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     (2*mm^2 - 3*psq + 5*s - d*s + t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     ...
     gXll^2*mh^2*mm^4*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*(2*psq + s - 2*t)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) - (4^(3 - d)*EL^8*gAl^2*gAu^2*gHll*gHXX*
     gXll^2*mh^2*mm^4*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gHll*gHXX*gXll^2*mh^2*mm^4*
