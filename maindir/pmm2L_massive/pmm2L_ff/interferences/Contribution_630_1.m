...
{(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
   ...
   ((2^(3 - 2*d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(3*mm^2 + psq)*
    ...
    (4^(1 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(5*mm^2 + 3*psq)*
      (2*psq - s - 2*t)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
     (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (mm^2 - psq)*(mm^2*(3*psq - 2*s - 3*t) + psq*(psq - t))*(psq - t)*
    ...
    (4^(1 - d)*d*EL^6*gAl^3*gAu*gHll^2*mm^4*(2*psq^2 - 3*psq*s + s^2 - 
      ...
      gHll^2*mm^2*(psq*(-2*psq^2 - 3*psq*s + s^2 + 4*psq*t - s*t - 2*t^2) + 
    ...
    (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^3*gAu*gHll^2*mm^2*
      (mm^2*(7*psq - 3*s - 7*t) + psq*(psq - s - t))*(psq - t)*
