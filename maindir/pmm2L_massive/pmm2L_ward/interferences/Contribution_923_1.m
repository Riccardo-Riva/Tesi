...
PropList[KiraPropagator[-q1, mw], KiraPropagator[q2, 0], 
  ...
  ((I*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(mm^2 - psq)*s*
     (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d))/
    (2^(2*(1 + d))*mh^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*
     gHll*mm^2*(bb*(-2*psq^2 - 2*s*(-mm^2 + s + 2*t) + psq*(3*s + 2*t)) + 
   ...
   (I*4^(-1 - d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
    ...
    (mh^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*
     mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/
    (mh^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*
     mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
    (mh^2*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*s*
     (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
    (2^(2*(1 + d))*mh^2*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*
     gHll*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
    (2^(2*(1 + d))*mh^2*Pi^(2*d)) - (I*2^(1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*
     gHll*mm^2*(bb*(mm^2 + psq - s - 2*t) + aa*(mm^2 - 3*psq + s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/(mh^2*Pi^(2*d)) + 
   (I*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(bb*(3*mm^2 - psq - 2*t) + 
      aa*(mm^2 - 3*psq + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[p1, p3]])/(mh^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
   ...
   (I*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(bb*(mm^2 + psq - 2*(s + t)) + 
      aa*(3*mm^2 - 5*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p2], SP[p2, p3]])/(mh^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
    ...
    (mh^2*(2*Pi)^(2*d)) + (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[q1, q2]])/
    (mh^2*(2*Pi)^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*
     gHll*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], 
      SP[q2, q2]])/(mh^2*Pi^(2*d)) - (I*bb*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3]])/
    (mh^2*(2*Pi)^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (aa*(psq - t) + bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q1]])/(mh^2*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (bb*(2*mm^2 - psq - t) + aa*(-psq + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p1, q2]])/(mh^2*Pi^(2*d)) - 
   (I*(aa + bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(mm^2 - psq)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p2, p3]])/(mh^2*(2*Pi)^(2*d)) + 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (aa*(2*mm^2 - psq - 2*s - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q1]])/(mh^2*Pi^(2*d)) - 
   (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (bb*(2*mm^2 - psq - 2*s - t) + aa*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, p3], SP[p2, q2]])/(mh^2*Pi^(2*d)) + 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(psq - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, p3]])/(mh^2*Pi^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(2*psq - s - 2*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q1]])/(mh^2*(2*Pi)^(2*d)) - 
   (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/(mh^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q2]])/
    (mh^2*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*
     mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q2, q2]])/
    (mh^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (aa*(psq - t) + bb*(2*mm^2 - 3*psq + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, p3]])/(mh^2*Pi^(2*d)) + 
   (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(psq - s - t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/(mh^2*(2*Pi)^(2*d)) + 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(psq - s - t)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
    ...
    (mh^2*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*
     gHll*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
      SP[q1, q2]])/(mh^2*Pi^(2*d)) - (I*aa*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, p3], SP[p3, q2]])/(mh^2*(2*Pi)^(2*d)) - 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q1, q2]])/
    (mh^2*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*
     mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[q2, q2]])/
    (mh^2*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     (aa*(2*mm^2 - psq - s - t) + bb*(-psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(psq - t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[p3, q2]])/(mh^2*(2*Pi)^(2*d)) + 
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*(psq - t)*
   ...
   (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
    ...
    (mh^2*(2*Pi)^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*
     ...
     ggpgpA*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p1, q1]])/(mh^2*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggpgpA*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p1, q2]])/(mh^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggpgpA*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p2, q1]])/(mh^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*
     ggpgpA*gHgpgp*gHll*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], 
      SP[p2, q2]])/(mh^2*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*
     gHll*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q1]])/
    (4^d*mh^2*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3], SP[p1, q2]])/
    (4^d*mh^2*Pi^(2*d)) + ((3*I)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*gHll*mm^2*
    ...
    (4^d*mh^2*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl^2*ggpgpA*gHgpgp*
