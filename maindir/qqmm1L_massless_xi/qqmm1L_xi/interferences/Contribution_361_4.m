...
PropList[KiraPropagator[-p1 + q1, mw*Sqrt[GaugeXi[Q]]], 
 ...
 ((I*2^(1 - 2*d)*EL^6*gFFZ^2*s*
  ...
  (I*2^(1 - d)*EL^6*gFFZ^2*(gZlR*gZlRC*(d*(gZuL*gZuLC - gZuR*gZuRC)*s + 
   ...
   (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
  (I*2^(2 - d)*EL^6*gFFZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
  ...
  (I*2^(1 - d)*EL^6*gFFZ^2*(gZlL*gZlLC*(gZuL*gZuLC*((-2 + d)*s - 2*t) - 
   ...
   (Pi^d*(mz^2 - s)^2*(-mzC^2 + s)) - 
  (I*2^(3 - d)*EL^6*gFFZ^2*(gZlL*gZlLC + gZlR*gZlRC)*
