...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq^2 - 2*psq*t + t*(s + t))*
      (mm^2*(4*psq + (-4 + d)*s - 4*t) + (-2 + d)*s*(-3*psq + s + 2*t))*
      \[Mu]^(8 - 2*d))/(Pi^(2*d)*s)) + 
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(4*(-1 + d)*psq^3 - 
      mm^2*(8*psq + (-4 + d)*s - 8*t)*(psq - s - t) - 
      2*psq^2*(s + (-4 + 5*d)*t) + (s + t)*((-2 + d)*s^2 + 2*(-4 + d)*s*t - 
        2*d*t^2) + psq*((4 - 3*d)*s^2 + 10*s*t + 4*(-1 + 2*d)*t^2))*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(4*psq^3 + 
      mm^2*(8*psq + (-4 + d)*s - 8*t)*(psq - t) - 
      2*psq^2*((-3 + 2*d)*s + (4 + d)*t) + 
      t*(-3*(-2 + d)*s^2 + (8 - 6*d)*s*t - 2*d*t^2) + 
      psq*((-2 + d)*s^2 + 2*(-7 + 5*d)*s*t + 4*(1 + d)*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
     (-2*(-2 + d)*psq^2 + mm^2*(8*psq + (-4 + d)*s - 8*t) + 
      (-2 + d)*s*(s + 2*t) + 2*psq*(s - d*s + (-2 + d)*t))*\[Mu]^(8 - 2*d)*
     SPList[SP[p3, q1]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
     (-4*(-2 + d)*psq^3 + (-4 + d)*s^3 + 4*(-3 + d)*s^2*t + 4*(-2 + d)*t^3 + 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq^2 - 2*psq*t + t*(s + t))*
     (2*d*mm^2*(psq - t) + d*s*(-3*psq + s + 2*t) - 
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(-psq + s + t)*
     (4*mm^2 - (4 + d)*psq + 2*s + d*t)*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
    ...
    (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*
     (-4*psq^2 + 4*mm^2*(psq - t) + (-2 + d)*s*(s + 2*t) + 
      psq*(4*s - 2*d*s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*
     mm^2*(2*psq^3 + 2*psq^2*(s - 3*t) + mm^4*(psq - t) - 
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*(-4 + d)*psq^2 - 4*mm^2*s - 
      6*s^2 + d*s^2 - 12*s*t + 2*d*s*t - 8*t^2 + 2*d*t^2 - 
      2*psq*((-8 + d)*s + 2*(-4 + d)*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)*
     (-2*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
      SP[p2, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*
     mm^2*(psq - t)*(2*psq^2 + mm^2*(psq - t) - 4*psq*t + t*(s + 2*t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(2*(-4 + d)*psq^2 + (-2 + d)*s^2 + 
      2*(-2 + d)*s*t + 2*(-4 + d)*t^2 - 2*psq*((-2 + d)*s + 2*(-4 + d)*t))*
   ...
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(4*t*(s + t)^2 + 
      2*psq^2*(s + 2*t) - 2*psq*t*(5*s + 4*t) + mm^2*(psq - t)*
       ((4 + d)*psq - 2*s - (4 + d)*t) + d*(psq^3 - psq^2*(s + 4*t) + 
        psq*t*(4*s + 5*t) - t*(s^2 + 3*s*t + 2*t^2)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq - t)*
   ...
   (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^2*(-(psq*s) + 
      mm^2*(4*psq - s - 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
   ...
   (4^(1 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^2*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
      psq^2*(s + 6*t) + t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(d*(mm^2 - psq)*(psq - t) - 
      2*(psq^2 + 2*mm^2*s + (s + t)^2 - 2*psq*(2*s + t)))*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*psq^2 + (s + t)^2 + 
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-4*s*(mm^2 - 3*psq + s + 2*t) + 
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(2*(-2 + d)*psq^2 - 4*t^2 + 
   ...
   (4^(2 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^2*(psq^2 + mm^2*s + (s + t)^2 - 
   ...
   (4^(2 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(mm^2 - 3*psq + s + 2*t)*
