...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  (-((4^(1 - d)*EL^5*gAl*gZlL*gZlR*mm^4*s*
      ...
      \[Mu]^(8 - 2*d))/Pi^(2*d)) + (2^(3 - 2*d)*EL^5*gAl*gZlL*gZlR*mm^2*
   ...
   (4^(1 - d)*EL^5*gAl*mm^2*
     ...
     gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*(mm^2 + psq)*s*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*(aa - bb)*(-2 + d)*EL^5*gAl*gZlL*gZlR*(gZlL^2 + gZlR^2)*mm^2*
