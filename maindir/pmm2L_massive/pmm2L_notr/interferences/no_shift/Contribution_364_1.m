  ...
  ((2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*
     mm^2*(-(psq*(s - 2*t)) + 2*mm^2*(psq - t) - t*(s + 2*t))*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    ...
    (Pi^(2*d)*s) - (2^(1 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*
     mm^2*(4*psq^2 + (-4 + d)*s^2 - 8*psq*t + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
    ...
    (Pi^(2*d)*s^2) + (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*
     gWNl*mm^2*(psq + (-3 + d)*s - t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*mm^2*
     (2*psq + (-4 + d)*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*
     gHWW*gWlN*gWNl*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1]])/
    (Pi^(2*d)*s) - (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gHll*gHWW*gWlN*gWNl*
