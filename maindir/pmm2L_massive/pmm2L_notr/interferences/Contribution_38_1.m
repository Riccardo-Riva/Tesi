...
PropList[KiraPropagator[q1, mz], KiraPropagator[-p3 + q1, mm], 
 ...
 (-((2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    ...
    (2*(-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*(mm^2 + psq))*
    (psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    ((-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*psq)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    ((-2 + d)*gZlL*mm^2*s + (-4 + d)*gZlR*(mm^2*(psq - s - t) + 
       psq*(-psq + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    (-2*(-2 + d)*gZlL*mm^2*s + (-4 + d)*gZlR*(4*psq^2 + s^2 + 3*s*t + 2*t^2 + 
       2*mm^2*(-psq + s + t) - psq*(s + 6*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(4^d*Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    ((-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*psq)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    (2*gZlL*mm^2*s - d*gZlL*mm^2*s + d*gZlR*psq*(psq - t) + 
     d*gZlR*mm^2*(-psq + s + t) + 2*gZlR*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 
       3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
    (4*psq^2 + s^2 + 3*s*t + 2*t^2 + 2*mm^2*(-psq + s + t) - 3*psq*(s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
  (d*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(4*psq^2 + s^2 + 3*s*t + 
     2*t^2 + 2*mm^2*(-psq + s + t) - 3*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q1]])/(4^d*Pi^(2*d)*s^2) + 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    (-((-2 + d)*gZlL*mm^2*(2*psq - 3*s - 2*t)) + 
     gZlR*((4 + d)*psq^2 + (-8 + d)*mm^2*(psq - s - t) - 
       psq*(2*(-1 + d)*s + (8 + d)*t) + 2*(s^2 + 3*s*t + 2*t^2)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    (2*(-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*(mm^2 + psq))*(psq - s - t)*
  ...
  (EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(-4*(-4 + d)*psq^2 + 8*mm^2*s - 
     8*psq*s + 8*s^2 - d*s^2 + 8*(-4 + d)*psq*t + 16*s*t - 4*d*s*t + 16*t^2 - 
     4*d*t^2)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
   (4^d*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
    (4*psq^2 + 2*mm^2*s + (s + 2*t)^2 - 2*psq*(s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) - 
  (d*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(4*psq^2 + 2*mm^2*s + 
     (s + 2*t)^2 - 2*psq*(s + 4*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/(4^d*Pi^(2*d)*s^2) - 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*((-2 + d)*gZlL*mm^2*s + 
     gZlR*(4*psq^2 + 2*mm^2*s + (s + 2*t)^2 - psq*((-2 + d)*s + 8*t)))*
  ...
  (d*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1], SP[q2, q2]])/(4^d*Pi^(2*d)*s) - 
  (d*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*mm^2 - 2*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q2], SP[q2, q2]])/(4^d*Pi^(2*d)*s) + 
  (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    ((-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
     SP[q2, q2]])/(Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*
    mm^2*((-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*
  ...
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
   ...
   (Pi^(2*d)*s) - (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    ((-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) - (2^(1 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFll^2*
    gZlR*gZNL*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2], SP[q1, q1]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZNL*mm^2*
    ((-2 + d)*gZlL*mm^2 - (-4 + d)*gZlR*psq)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*
    gZNL*mm^2*(2*mm^2 - psq - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) - 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(d*(mm^2 - psq) + s)*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(4*mm^2 - 4*psq + s)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[q1, q2]])/
   (Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
    (2*psq - 3*s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
     SP[p3, q2]])/(Pi^(2*d)*s^2) + (4^(1 - d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*
    gFll^2*gZlR*gZNL*mm^2*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s^2) + 
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*psq - 3*s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2], SP[p3, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*d*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
  ...
  (2^(1 - 2*d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[q2, q2]])/
   (Pi^(2*d)*s^2) + (2^(1 - 2*d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*
    gZNL*mm^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q2, q2]])/
   (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
  ...
  (2^(3 - 2*d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*(2*psq + s - 2*t)*
  ...
  (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1], SP[p3, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
  (4^(1 - d)*(-4 + d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], SP[q2, q2]])/
   (Pi^(2*d)*s) + (4^(2 - d)*EL^8*gAl*gAu^2*gFFA*gFll^2*gZlR*gZNL*mm^2*
