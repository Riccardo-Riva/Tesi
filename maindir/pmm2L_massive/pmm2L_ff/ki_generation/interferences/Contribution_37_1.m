...
{(PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
   ...
   ((4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*((-2 + d)*gZlL*mm^2 - 
       gZlR*((-4 + d)*mm^2 + s))*(-2*psq^3 - 2*psq*t*(2*s + 3*t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*(gZlL*mm^2*s*(-psq + s + t) + 
       gZlR*(2*mm^4*(psq - s - t) - mm^2*(7*psq^2 - 7*psq*s + 2*s^2 - 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*(-2*d*gZlL*mm^2*psq*s + 
       2*gZlL*mm^2*s*(psq + s + t) + 2*gZlR*mm^2*(psq^2 + t^2 - 
         2*psq*(s + t)) - 2*gZlR*psq*(psq^2 + psq*(s - 2*t) + t*(s + t)) + 
       d*gZlR*(mm^4*(psq - t) + psq^2*(psq - t) + 2*mm^2*psq*(-psq + s + t)))*
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*
      (-((-2 + d)*gZlL*mm^2*s*(-psq + s + t)) + 
       gZlR*(-((8 + d)*psq^3) + d*mm^4*s + 2*psq^2*(4*s + (10 + d)*t) + 
         2*t*(s^2 + 3*s*t + 2*t^2) - psq*(2*s^2 + (14 + d)*s*t + 
           (16 + d)*t^2) + mm^2*((4 + d)*psq^2 + d*(s + t)^2 + 
           2*t*(s + 2*t) - 2*psq*((1 + d)*s + (4 + d)*t))))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2]])/(Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(4*mm^2 - 6*psq + s + 
       2*t)*(psq^2 - 2*psq*t + t*(s + t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[q1, q2]])/(Pi^(2*d)*s) + 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
      (-4*(psq - s - t)*(2*psq^2 - mm^2*s + psq*(s - 4*t) + 2*t*(s + t)) + 
       d*(mm^2 - psq)*(4*psq^2 + s^2 + 5*s*t + 4*t^2 - psq*(s + 8*t)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*
      (-2*gZlL*mm^2*s*((-3 + d)*psq + t) + gZlR*((-4 + d)*mm^4*(psq - t) - 
         2*mm^2*((-3 + d)*psq - t)*(psq - s - t) + 
         psq*((-2 + d)*psq^2 + 2*(s + t)^2 - psq*(4*s + d*t))))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(Pi^(2*d)*s) - 
    (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*
      (gZlL*mm^2*s*((-2 + d)*psq - (-4 + d)*s - (-2 + d)*t) + 
       gZlR*(-((-12 + d)*psq^3) + (-4 + d)*mm^4*s + 
         psq^2*(-8*s + 2*(-14 + d)*t) + mm^2*(psq - s - t)*
          ((-8 + d)*psq + 6*s - d*s + 8*t - d*t) - 
         2*t*(s^2 + 3*s*t + 2*t^2) + psq*(2*s^2 - (-18 + d)*s*t - 
           (-20 + d)*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/
     (Pi^(2*d)*s) - (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*
      (2*(-2 + d)*gZlL*mm^2*(2*psq^2 - 3*psq*s + s^2 - 4*psq*t + 3*s*t + 
         2*t^2) + gZlR*(2*(-4 + d)*psq^3 - 4*s*t*(s + t) + 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*(psq - t)*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*(gZlL*mm^2*s^2 + 
       gZlR*(-2*psq^3 - 2*mm^2*(psq - t)^2 + 2*psq^2*(s + 4*t) + 
    ...
    (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*(psq - t)*
      ((-2 + d)*gZlL*mm^2*s + gZlR*(d*psq*(-psq + t) + 2*(2*psq - s - 2*t)*
          (s + t) + mm^2*((-4 + d)*psq + 2*s - d*s + 4*t - d*t)))*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       ...
       SP[q1, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*
      mm^2*(psq - t)*(-8*psq^2 + (-4 + d)*mm^2*s - (-4 + d)*psq*s + 
       16*psq*t - 8*t*(s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*
      (d*(psq - t)*(-(gZlL*mm^2*s) + gZlR*psq*(psq - t) + 
    ...
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*
      (2*(-2 + d)*gZlL*mm^2*(2*psq - s - 2*t)*(psq - t) - 
       gZlR*(2*(-4 + d)*psq^3 + (-4 + d)*mm^2*(2*psq - s - 2*t)*(psq - t) + 
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
      (2*psq^3 + 2*psq*t*(2*s + 3*t) - psq^2*(s + 6*t) - 
       t*(s^2 + 3*s*t + 2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[q1, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*
      mm^2*(4*(mm^2 - psq)*s^2 + d*(4*psq^3 - mm^2*s^2 - 2*psq^2*(s + 6*t) - 
         2*t*(s^2 + 3*s*t + 2*t^2) + psq*(s^2 + 8*s*t + 12*t^2)))*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/(Pi^(2*d)*s) - 
    (2^(1 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*(2*(-2 + d)*gZlL*mm^2 - 
       (-4 + d)*gZlR*(mm^2 + psq))*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2], SP[q1, q1]])/Pi^(2*d) + 
    (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*
      ((-2 + d)*gZlL*mm^2*s*(-2*psq + s + 2*t) - (-4 + d)*gZlR*(psq - t)*
    ...
    (2^(1 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
      (-2*psq^3 - 2*psq*t*(2*s + 3*t) + psq^2*(s + 6*t) + 
       ...
       SP[q2, q2]])/(Pi^(2*d)*s) + (2^(1 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*
    ...
    (4^(2 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(3*psq^2 + t*(s + t) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*((-2 + d)*gZlL*mm^2 - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*((-2 + d)*gZlL*mm^2 - 
       (-4 + d)*gZlR*psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (4^(2 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(5*psq^2 + 3*t*(s + t) - 
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*((-2 + d)*gZlL*mm^2*s + 
       (-4 + d)*gZlR*(psq - t)*(psq - s - t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(psq - t)*(-psq + s + t)*
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(-psq + s + t)^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*((-2 + d)*gZlL*mm^2 - 
       (-4 + d)*gZlR*psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1], SP[p2, q2]])/(Pi^(2*d)*s) + 
    (3*4^(2 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(psq - t)*(-psq + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], SP[p3, q1]])/
     (Pi^(2*d)*s) + (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZNL*mm^2*
      (-((-2 + d)*gZlL*mm^2*s) + (-4 + d)*gZlR*(psq - t)*(-mm^2 + s + t))*
     ...
     (Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
      (mm^2 - psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
       SP[p3, q1]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*
    ...
    (2^(5 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(psq - t)*(-psq + s + t)*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
      (-2*s*(2*mm^2 - 3*psq + s + t) + d*(psq^2 + mm^2*s + (s + t)^2 - 
         psq*(3*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*
      gZlR*gZNL*mm^2*(psq^2 + mm^2*s + (s + t)^2 - psq*(3*s + 2*t))*
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
     ...
     (Pi^(2*d)*s) - (2^(5 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
      ...
      mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
       SP[q2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*
      gZlR*gZNL*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) + (2^(5 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(psq - t)*
      (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], 
       SP[p3, q1]])/(Pi^(2*d)*s) + (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*
      gZlR*gZNL*mm^2*(psq - t)^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
    ...
    (2^(3 - 2*d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(psq - t)^2*
     ...
     (Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q2, q2]])/Pi^(2*d) + (4^(2 - d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*
      (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], 
       SP[q1, q2]])/Pi^(2*d) + (4^(1 - d)*(-2 + d)*EL^6*gAl*gAu*gFll^2*gZlR*
      gZNL*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[p3, q2], SP[q2, q2]])/Pi^(2*d) + 
    (4^(1 - d)*(-4 + d)*EL^6*gAl*gAu*gFll^2*gZlR*gZNL*mm^2*(2*psq - s - 2*t)*
