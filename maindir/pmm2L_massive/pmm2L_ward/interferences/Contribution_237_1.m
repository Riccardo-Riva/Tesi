...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
 ...
 (((-I)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*s*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*
    (gZlL + gZlR)*mm^2*s*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*
    (gZlL + gZlR)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*(mm^2 - psq)*s*
    (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*
    (gZlL + gZlR)*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[q2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/Pi^(2*d) + 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
    (mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*mm^2*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*s*
   ...
   Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*ggmgmA^2*ggmgmZ*(gZlL + gZlR)*
