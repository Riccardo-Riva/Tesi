...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*mm^2*s*
    ...
    Pi^(2*d)) - (2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*
    mm^2*s*(-(bb*s) + aa*(2*mm^2 - 2*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + ((aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*
    (gZlL - gZlR)*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/
   (2*Pi)^(2*d) + ((aa - bb)*EL^5*ggpgpA*ggpgpZ*gXgpgp*gXll*(gZlL - gZlR)*
    mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
