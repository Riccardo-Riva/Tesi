(PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
    ...
    KiraPropagator[q2, 0]]*((-3*4^(1 - d)*EL^8*gAd*gAl^3*gAu^2*
      ((-2 + d)*gZdL*gZlL - (-4 + d)*gZdR*gZlL - (-4 + d)*gZdL*gZlR + 
       (-2 + d)*gZdR*gZlR)*((-2 + d)*s^2 + 4*s*t + 4*t^2)*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
    (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*((-2 + d)*gZdL*gZlL - 
    ...
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)*s) + (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      ((-2 + d)*gZdL*gZlL - (-4 + d)*gZdR*gZlL - (-4 + d)*gZdL*gZlR + 
       (-2 + d)*gZdR*gZlR)*((-2 + d)*s^2 + d*s*t + 2*(-2 + d)*t^2)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*((-4 + d)*gZdL*gZlL*(s + t)*
    ...
    (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*((-2 + d)*gZdL*gZlL - 
     ...
     (mz^2*Pi^(2*d)*s) + (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*gZlL*(-((-2 + d)^2*s^2) + (20 - 10*d + d^2)*s*t + 
         2*(-4 + d)^2*t^2) + gZdL*gZlR*(-((-2 + d)^2*s^2) + 
    ...
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)*s) + (3*2^(3 - 2*d)*(18 - 9*d + d^2)*EL^8*gAd*gAl^3*gAu^2*
      ((-2 + d)*gZdL*gZlL - (-4 + d)*gZdR*gZlL - (-4 + d)*gZdL*gZlR + 
       (-2 + d)*gZdR*gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2]])/
     (mz^2*Pi^(2*d)) - (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      ((-2 + d)*gZdL*gZlL - (-4 + d)^2*gZdR*gZlL - (-4 + d)^2*gZdL*gZlR + 
       (-2 + d)*gZdR*gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q1, q2]])/
     (mz^2*Pi^(2*d)) - (3*2^(3 - 2*d)*(28 - 11*d + d^2)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL + gZdR)*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[q2, q2]])/(mz^2*Pi^(2*d)) + (3*4^(1 - d)*EL^8*gAd*gAl^3*gAu^2*
      (-((-4 + d)*gZdR*gZlL*((4 - 6*d + d^2)*s^2 + 4*(-2 + d)*s*t + 
          4*(-2 + d)*t^2)) - (-4 + d)*gZdL*gZlR*((4 - 6*d + d^2)*s^2 + 
         4*(-2 + d)*s*t + 4*(-2 + d)*t^2) + gZdL*gZlL*
    ...
    (3*2^(5 - 2*d)*(-4 + d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
    ...
    (3*2^(5 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
      \[Mu]^(8 - 2*d)*SPList[SP[q1, q2], SP[q1, q2]])/(mz^2*Pi^(2*d)) - 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*((-2 + d)*gZdR*gZlL*
        (2*s - (-4 + d)*t) + (-2 + d)*gZdL*gZlR*(2*s - (-4 + d)*t) + 
       (-4 + d)*gZdL*gZlL*(2*s + d*t) + (-4 + d)*gZdR*gZlR*(2*s + d*t))*
     ...
     (mz^2*Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      ((-4 + d)^2*gZdL*gZlL - (20 - 10*d + d^2)*gZdR*gZlL - 
       (20 - 10*d + d^2)*gZdL*gZlR + (-4 + d)^2*gZdR*gZlR)*(s + t)*
     ...
     (mz^2*Pi^(2*d)*s^2) + (3*4^(2 - d)*(-4 + d)*EL^8*gAd*gAl^3*gAu^2*
      ...
      SPList[SP[p1, q1], SP[p1, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL*((12 - 6*d + d^2)*gZlL*s - (-2 + d)^2*gZlR*s + 4*gZlL*t) + 
       gZdR*(-((-2 + d)^2*gZlL*s) + (12 - 6*d + d^2)*gZlR*s + 4*gZlR*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/
     (mz^2*Pi^(2*d)*s^2) + (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL + gZdR)*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2], SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + 
    (3*4^(2 - d)*(18 - 9*d + d^2)*EL^8*gAd*gAl^3*gAu^2*(gZdL - gZdR)*
      (gZlL - gZlR)*(s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s^2) + (3*4^(2 - d)*(-4 + d)*EL^8*gAd*gAl^3*gAu^2*
      ((-8 + 3*d)*gZdL*gZlL - 3*(-2 + d)*gZdR*gZlL - 3*(-2 + d)*gZdL*gZlR + 
       (-8 + 3*d)*gZdR*gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*((-4 + d)^2*gZdL*gZlL - 
       (20 - 10*d + d^2)*gZdR*gZlL - (20 - 10*d + d^2)*gZdL*gZlR + 
       (-4 + d)^2*gZdR*gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s) - (3*4^(2 - d)*(-4 + d)*EL^8*gAd*gAl^3*
      gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1], SP[q2, q2]])/(mz^2*Pi^(2*d)*s) + 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*((36 - 20*d + 3*d^2)*gZlL*s - (40 - 22*d + 3*d^2)*gZlR*s + 
         4*(14 - 7*d + d^2)*gZlL*t - 4*(13 - 7*d + d^2)*gZlR*t) + 
       gZdL*(-((40 - 22*d + 3*d^2)*gZlL*s) + (36 - 20*d + 3*d^2)*gZlR*s - 
         4*(13 - 7*d + d^2)*gZlL*t + 4*(14 - 7*d + d^2)*gZlR*t))*
    ...
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*(-((-44 + 34*d - 10*d^2 + d^3)*gZlL*s) + 
         (-56 + 40*d - 10*d^2 + d^3)*gZlR*s - 2*(8 - 6*d + d^2)*gZlL*t + 
         2*(-2 + d)^2*gZlR*t) + gZdL*((-56 + 40*d - 10*d^2 + d^3)*gZlL*s - 
         (-44 + 34*d - 10*d^2 + d^3)*gZlR*s + 2*(-2 + d)^2*gZlL*t - 
         2*(8 - 6*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*(d^2*(gZdL - gZdR)*(gZlL - gZlR)*s - 
    ...
    (3*4^(2 - d)*(-4 + d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)*s^2) - (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*
      (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + 
    (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*(-((-68 + 46*d - 11*d^2 + d^3)*gZlL*s) + 
         (-64 + 46*d - 11*d^2 + d^3)*gZlR*s + 2*(20 - 9*d + d^2)*gZlL*t - 
         2*(16 - 9*d + d^2)*gZlR*t) + gZdL*((-64 + 46*d - 11*d^2 + d^3)*gZlL*
          s - (-68 + 46*d - 11*d^2 + d^3)*gZlR*s - 2*(16 - 9*d + d^2)*gZlL*
          t + 2*(20 - 9*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*2^(7 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL + gZdR)*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p1, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) - 
    (3*2^(5 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[q1, q1]])/
     (mz^2*Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*(-((20 - 8*d + d^2)*gZlL*s) + (12 - 6*d + d^2)*gZlR*s - 
         4*(14 - 7*d + d^2)*gZlL*t + 4*(13 - 7*d + d^2)*gZlR*t) + 
       gZdL*((12 - 6*d + d^2)*gZlL*s - (20 - 8*d + d^2)*gZlR*s + 
         4*(13 - 7*d + d^2)*gZlL*t - 4*(14 - 7*d + d^2)*gZlR*t))*
    ...
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*(s + t)*
     ...
     (mz^2*Pi^(2*d)*s^2) - (3*4^(3 - d)*(-4 + d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL + gZdR)*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) + 
    (3*2^(5 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], SP[q1, q1]])/
     (mz^2*Pi^(2*d)*s) - (3*4^(2 - d)*(-68 + 52*d - 13*d^2 + d^3)*EL^8*gAd*
      gAl^3*gAu^2*(gZdL - gZdR)*(gZlL - gZlR)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q2], SP[p3, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) + 
     ...
     (mz^2*Pi^(2*d)*s) + (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*((-56 + 48*d - 13*d^2 + d^3)*gZlL*s - (-52 + 48*d - 13*d^2 + d^3)*
       ...
       gZdL*(-((-52 + 48*d - 13*d^2 + d^3)*gZlL*s) + 
         ...
         2*(8 - 5*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
    ...
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)*s) + (3*2^(5 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*
      (gZlL + gZlR)*(3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      (-((-2 + d)*gZdR*gZlL*((-2 + d)*s + (-4 + d)*t)) - 
       (-2 + d)*gZdL*gZlR*((-2 + d)*s + (-4 + d)*t) + 
       (-4 + d)*gZdL*gZlL*((-2 + d)*s + d*t) + (-4 + d)*gZdR*gZlR*
        ((-2 + d)*s + d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*((-4 + d)^2*gZdL*gZlL - 
       (20 - 10*d + d^2)*gZdR*gZlL - (20 - 10*d + d^2)*gZdL*gZlR + 
       (-4 + d)^2*gZdR*gZlR)*t*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*4^(2 - d)*(-4 + d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], SP[q2, q2]])/
     (mz^2*Pi^(2*d)*s^2) - (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL*((8 - 6*d + d^2)*gZlL*s - (-2 + d)^2*gZlR*s - 4*gZlL*t) + 
       gZdR*(-((-2 + d)^2*gZlL*s) + (8 - 6*d + d^2)*gZlR*s - 4*gZlR*t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[p3, q1]])/
     (mz^2*Pi^(2*d)*s^2) + (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL + gZdR)*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
    ...
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*t*
     ...
     (mz^2*Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL*(-((-60 + 46*d - 12*d^2 + d^3)*gZlR*s) + 2*(8 - 6*d + d^2)*gZlR*
          t + gZlL*((-4 + d)^3*s - 2*(-2 + d)^2*t)) + 
       gZdR*(-((-60 + 46*d - 12*d^2 + d^3)*gZlL*s) + 2*(8 - 6*d + d^2)*gZlL*
          t + gZlR*((-4 + d)^3*s - 2*(-2 + d)^2*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*((-4 + d)*gZdL*gZlL*
        ((-2 + d)*s - 2*t) + (-4 + d)*gZdR*gZlR*((-2 + d)*s - 2*t) - 
    ...
    (3*4^(2 - d)*(-4 + d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)*s^2) - (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*
      (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + 
    (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*(-((-28 + 28*d - 9*d^2 + d^3)*gZlL*s) + 
         (-32 + 28*d - 9*d^2 + d^3)*gZlR*s - 2*(20 - 9*d + d^2)*gZlL*t + 
         2*(16 - 9*d + d^2)*gZlR*t) + gZdL*((-32 + 28*d - 9*d^2 + d^3)*gZlL*
          s - (-28 + 28*d - 9*d^2 + d^3)*gZlR*s + 2*(16 - 9*d + d^2)*gZlL*t - 
         2*(20 - 9*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*2^(7 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s^2) - (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL + gZdR)*(gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p2, q2], SP[p3, q1]])/(mz^2*Pi^(2*d)*s) + 
    (3*2^(5 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2], SP[q1, q1]])/
     (mz^2*Pi^(2*d)*s^2) - (3*4^(2 - d)*(-68 + 52*d - 13*d^2 + d^3)*EL^8*gAd*
      gAl^3*gAu^2*(gZdL - gZdR)*(gZlL - gZlR)*\[Mu]^(8 - 2*d)*
     ...
     (mz^2*Pi^(2*d)*s) + (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*((-40 + 38*d - 11*d^2 + d^3)*gZlL*s - (-44 + 38*d - 11*d^2 + d^3)*
       ...
       gZdL*(-((-44 + 38*d - 11*d^2 + d^3)*gZlL*s) + 
         ...
         2*(8 - 5*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)*s) + (3*2^(5 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*
      (gZlL + gZlR)*(s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2], 
       SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd*gAl^3*gAu^2*((-2 + d)*gZdL*gZlL - 
       (-4 + d)*gZdR*gZlL - (-4 + d)*gZdL*gZlR + (-2 + d)*gZdR*gZlR)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[p3, q2]])/
     (mz^2*Pi^(2*d)*s) + (3*2^(5 - 2*d)*(-2 + d)*EL^8*gAd*gAl^3*gAu^2*
      ((-4 + d)*gZdL*gZlL - (-2 + d)*gZdR*gZlL - (-2 + d)*gZdL*gZlR + 
       (-4 + d)*gZdR*gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], 
       SP[q1, q2]])/(mz^2*Pi^(2*d)*s) + 
    (3*2^(5 - 2*d)*(-4 + d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q1], SP[q2, q2]])/
     (mz^2*Pi^(2*d)*s) - (3*2^(5 - 2*d)*(6 - 5*d + d^2)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL - gZdR)*(gZlL - gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1], 
       SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s) + 
    (3*2^(7 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
      \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[p3, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s) - (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*
    ...
    (3*4^(3 - d)*(12 - 7*d + d^2)*EL^8*gAd*gAl^3*gAu^2*(gZdL - gZdR)*
      (gZlL - gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p2, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*4^(3 - d)*(12 - 7*d + d^2)*EL^8*gAd*gAl^3*gAu^2*(gZdL - gZdR)*
      (gZlL - gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1], 
       SP[p3, q1], SP[p3, q1]])/(mz^2*Pi^(2*d)*s^2)) + 
  PropList[KiraPropagator[q1, 0], KiraPropagator[p1 + p2 + q1, 0], 
    ...
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*((-44 + 34*d - 10*d^2 + d^3)*gZlL*s - (-56 + 40*d - 10*d^2 + d^3)*
          gZlR*s + 2*(8 - 6*d + d^2)*gZlL*t - 2*(-2 + d)^2*gZlR*t) + 
       gZdL*(-((-56 + 40*d - 10*d^2 + d^3)*gZlL*s) + 
         (-44 + 34*d - 10*d^2 + d^3)*gZlR*s - 2*(-2 + d)^2*gZlL*t + 
         2*(8 - 6*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p3, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*(d^2*(gZdL - gZdR)*(gZlL - gZlR)*s - 
    ...
    (3*4^(2 - d)*(-4 + d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)*s^2) + (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*
      (gZlL + gZlR)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
       SP[p3, q2]])/(mz^2*Pi^(2*d)*s) + 
    (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*((-68 + 46*d - 11*d^2 + d^3)*gZlL*s - (-64 + 46*d - 11*d^2 + d^3)*
          gZlR*s - 2*(20 - 9*d + d^2)*gZlL*t + 2*(16 - 9*d + d^2)*gZlR*t) + 
       gZdL*(-((-64 + 46*d - 11*d^2 + d^3)*gZlL*s) + 
         (-68 + 46*d - 11*d^2 + d^3)*gZlR*s + 2*(16 - 9*d + d^2)*gZlL*t - 
         2*(20 - 9*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*2^(7 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[q1, q2]])/
    ...
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
     ...
     (mz^2*Pi^(2*d)*s) + (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*(-((-56 + 48*d - 13*d^2 + d^3)*gZlL*s) + 
         (-52 + 48*d - 13*d^2 + d^3)*gZlR*s + 2*(8 - 5*d + d^2)*gZlL*t - 
         2*(4 - 5*d + d^2)*gZlR*t) + gZdL*((-52 + 48*d - 13*d^2 + d^3)*gZlL*
          s - (-56 + 48*d - 13*d^2 + d^3)*gZlR*s - 2*(4 - 5*d + d^2)*gZlL*t + 
         2*(8 - 5*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s) - (3*2^(5 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*
      (gZlL + gZlR)*(3*s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*((-2 + d)*gZdR*gZlL*
        ((-2 + d)*s + (-4 + d)*t) + (-2 + d)*gZdL*gZlR*
        ((-2 + d)*s + (-4 + d)*t) - (-4 + d)*gZdL*gZlL*((-2 + d)*s + d*t) - 
       (-4 + d)*gZdR*gZlR*((-2 + d)*s + d*t))*\[Mu]^(8 - 2*d)*
    ...
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q2], SP[q1, q2]])/
     (mz^2*Pi^(2*d)*s^2) + (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdL*((-60 + 46*d - 12*d^2 + d^3)*gZlR*s - 2*(8 - 6*d + d^2)*gZlR*t + 
         gZlL*(-((-4 + d)^3*s) + 2*(-2 + d)^2*t)) + 
       gZdR*((-60 + 46*d - 12*d^2 + d^3)*gZlL*s - 2*(8 - 6*d + d^2)*gZlL*t + 
         gZlR*(-((-4 + d)^3*s) + 2*(-2 + d)^2*t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q1], SP[p3, q2]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*4^(2 - d)*EL^8*gAd*gAl^3*gAu^2*((-4 + d)*gZdL*gZlL*
        ((-2 + d)*s - 2*t) + (-4 + d)*gZdR*gZlR*((-2 + d)*s - 2*t) - 
       gZdR*gZlL*((-2 + d)^2*s + 2*(8 - 3*d)*t) - 
    ...
    (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*((-28 + 28*d - 9*d^2 + d^3)*gZlL*s - (-32 + 28*d - 9*d^2 + d^3)*
          gZlR*s + 2*(20 - 9*d + d^2)*gZlL*t - 2*(16 - 9*d + d^2)*gZlR*t) + 
       gZdL*(-((-32 + 28*d - 9*d^2 + d^3)*gZlL*s) + 
         (-28 + 28*d - 9*d^2 + d^3)*gZlR*s - 2*(16 - 9*d + d^2)*gZlL*t + 
         2*(20 - 9*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q1], SP[p3, q2], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) - 
    (3*2^(7 - 2*d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*t*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], SP[q1, q2]])/
    ...
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[p3, q2]])/
     (mz^2*Pi^(2*d)*s) + (3*2^(3 - 2*d)*EL^8*gAd*gAl^3*gAu^2*
      (gZdR*(-((-40 + 38*d - 11*d^2 + d^3)*gZlL*s) + 
         (-44 + 38*d - 11*d^2 + d^3)*gZlR*s - 2*(8 - 5*d + d^2)*gZlL*t + 
         2*(4 - 5*d + d^2)*gZlR*t) + gZdL*((-44 + 38*d - 11*d^2 + d^3)*gZlL*
          s - (-40 + 38*d - 11*d^2 + d^3)*gZlR*s + 2*(4 - 5*d + d^2)*gZlL*t - 
         2*(8 - 5*d + d^2)*gZlR*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
       SP[p3, q1], SP[q1, q1]])/(mz^2*Pi^(2*d)*s^2) + 
    (3*4^(3 - d)*EL^8*gAd*gAl^3*gAu^2*(gZdL + gZdR)*(gZlL + gZlR)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1], SP[q1, q2]])/
