...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
   ...
   (((-I)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*mm^2*s*
     ...
     (2*Pi)^(2*d) - (I*2^(1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*
      (gZlL + gZlR)*mm^2*s*(2*bb*(psq - s - t) + 
       aa*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     Pi^(2*d) - (I*2^(1 - 2*d)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*
      (gZlL + gZlR)*mm^2*(-(bb*(psq^2 + mm^2*(psq - 2*s - t) - psq*t + 
          s*(s + t))) + aa*(psq^2 + mm^2*(psq + 3*s - t) + s*(s + t) - 
         psq*(5*s + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) - 
    ...
    (I*2^(1 - 2*d)*(aa - bb)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*
     ...
     Pi^(2*d) - (I*4^(1 - d)*(-1 + d)*EL^5*gHll*gHWW*gWWA*gWWZ*(gZlL + gZlR)*
