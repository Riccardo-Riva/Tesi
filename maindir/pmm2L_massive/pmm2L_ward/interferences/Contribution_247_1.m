...
PropList[KiraPropagator[-p3 - q1, mz], KiraPropagator[p1 + p2 - p3 - q1, mz], 
 ...
 ((I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*s^2*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d))/Pi^(2*d) - 
  ((7*I)*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*s*
  ...
  (I*4^(-1 - d)*EL^5*ggpgpA*ggpgpZ^2*s^2*
   ...
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*s*
  ...
  (I*4^(-1 - d)*EL^5*ggpgpA*ggpgpZ^2*s^2*
    ...
    SPList[SP[p2, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*
    ggpgpZ^2*gZlL*gZlR*mm^2*s*(-3*psq + 2*s + 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(2*d) + (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    s^2*((aa + bb)*(mm^2 - psq) + (aa - bb)*(-2*psq + s + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/Pi^(2*d) + 
  (I*(aa + bb)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s^2*
  ...
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*s*
  ...
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*(4*psq - s - 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) + 
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*
  ...
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*(4*psq - 3*s - 4*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q2]])/(2*Pi)^(2*d) - 
  ((3*I)*2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*
   ...
   Pi^(2*d) + (I*4^(-1 - d)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
  ...
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
  ...
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[q1, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[q1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*s*
    (aa*(-2*gZlL*gZlR*mm^2 + gZlL^2*(s + t) + gZlR^2*(s + t)) - 
     bb*(-2*gZlL*gZlR*mm^2 + gZlL^2*(3*mm^2 - 3*psq + s + t) + 
  ...
  (I*4^(-1 - d)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    (aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*(psq - s - t)*
  ...
  (I*2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(psq^2 + mm^2*(psq - 4*s - t) + psq*(4*s - t) - s*(s + t)) + 
       gZlR^2*(psq^2 + mm^2*(psq - 4*s - t) + psq*(4*s - t) - s*(s + t))) + 
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*
    mm^2*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p2, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
  ...
  (I*2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*
    (bb*(2*gZlL*gZlR*mm^2*(-2*psq + s + 2*t) + 
       gZlL^2*(psq^2 + 2*psq*s + mm^2*(psq - 2*s - t) - psq*t - s*t) + 
       gZlR^2*(psq^2 + 2*psq*s + mm^2*(psq - 2*s - t) - psq*t - s*t)) + 
     aa*(2*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*(-psq^2 + 3*psq*s + psq*t + s*t + mm^2*(-psq - 3*s + t)) + 
       gZlR^2*(-psq^2 + 3*psq*s + psq*t + s*t + mm^2*(-psq - 3*s + t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) + 
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*gZlL*gZlR*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/(4^d*Pi^(2*d)) + 
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*(-2*psq + s + 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, q1], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2], SP[q1, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*s*
    (-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2], SP[q1, q2]])/
   Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(aa*(2*gZlL*gZlR*mm^2 + gZlL^2*(psq - 2*(s + t)) + 
       gZlR^2*(psq - 2*(s + t))) + bb*(-2*gZlL*gZlR*mm^2 + 
       gZlL^2*(4*mm^2 - 5*psq + 2*(s + t)) + 
       gZlR^2*(4*mm^2 - 5*psq + 2*(s + t))))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(psq - s - t) + 
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*
   ...
   (2*Pi)^(2*d) + (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 + 2*psq - 3*s - 4*t) + bb*(6*mm^2 - 10*psq + 3*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2], SP[q1, q2]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (bb*(psq - t) + aa*(-mm^2 + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(psq - t) + 
     aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1], 
     SP[q2, q2]])/(2*Pi)^(2*d) + (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(psq - t) + aa*(-mm^2 + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[p2, q1]])/
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*
    (gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q2], SP[q1, q2]])/
   (4^d*Pi^(2*d)) + (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (bb*(psq - t) + aa*(-mm^2 + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*ggpgpA*ggpgpZ^2*
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(psq - t) + aa*(-mm^2 + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) + 
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(mm^2 + psq - s - 2*t) + 
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(aa*(mm^2 - t) + bb*(-psq + t))*
  ...
  (I*EL^5*ggpgpA*ggpgpZ^2*(gZlL^2 + gZlR^2)*(bb*(psq - t) + 
     ...
     SP[q1, q2]])/(4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*EL^5*ggpgpA*
    ggpgpZ^2*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
