  ...
  (-((4^(1 - d)*(-4 + d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2 - psq)*
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(mm^2*(4*psq + 4*s - d*s - 4*t)*
       (psq - s - t) - 2*(4*psq^3 + (-4 + d)*t^2*(s + t) + 
        psq^2*((3 - 2*d)*s + (-12 + d)*t) + psq*((-3 + d)*s^2 + (1 + d)*s*t - 
          2*(-6 + d)*t^2)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((16 - 3*d)*psq^3 - 
   ...
   (4^(1 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*((8 - 3*d)*psq^3 + 
      ...
      psq^2*(-24*t + d*(s + 8*t)))*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1], SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^4*(psq - t)*
     (-4*s + d*(-psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], 
      SP[p2, q2]])/(Pi^(2*d)*s) - (2^(3 - 2*d)*EL^6*gAl^3*gAu*gXll^2*mm^2*
     (-((-2 + d)*psq*s) + (-4 + d)*mm^2*(psq - t))*(psq - t)*\[Mu]^(8 - 2*d)*
   ...
   (4^(2 - d)*EL^6*gAl^3*gAu*gXll^2*mm^2*(-((-4 + d)*psq^2) - (2 + d)*psq*s + 
      (-4 + d)*psq*t + 2*s*(s + 2*t) + mm^2*((-4 + d)*psq + (-2 + d)*s - 
        (-4 + d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2], 
      SP[p3, q1]])/(Pi^(2*d)*s) - (4^(2 - d)*d*EL^6*gAl^3*gAu*gXll^2*mm^2*
