...
{(PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, 0], 
   ...
   (((-I)*2^(1 - 2*d)*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*mm^2*s*
    ...
    (I*4^(1 - d)*aa*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 - psq)*s*
    ...
    (I*4^(1 - d)*bb*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*mm^2*(mm^2 - psq)*s*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
    (I*4^(1 - d)*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*mm^2*
      (bb*(psq^2 + mm^2*(psq - 3*s - t) + psq*(s - t) + s*t) - 
       aa*(psq^2 + mm^2*(psq - t) + s*t - psq*(2*s + t)))*\[Mu]^(8 - 2*d)*
      SPList[SP[p2, q2]])/Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFA^2*
      gHFF*gHll*mh^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*
      gHFF*gHll*mh^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q1]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*EL^5*gAl*gFFA^2*
      gHFF*gHll*mh^2*mm^2*s*(-2*psq + s + 2*t)*\[Mu]^(8 - 2*d)*
      SPList[SP[q1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*aa*EL^5*gAl*gFFA^2*gHFF*
      gHll*mh^2*mm^2*(mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
       SP[p1, q2]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*
      mm^2*(aa*(mm^2 - psq - s) + bb*s)*\[Mu]^(8 - 2*d)*
    ...
    (I*2^(3 - 2*d)*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*mm^2*
      (bb*(mm^2 - psq - s) + aa*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
       SP[p2, q1]])/Pi^(2*d) - (I*2^(3 - 2*d)*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*
    ...
    (I*2^(3 - 2*d)*(aa - bb)*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*mm^2*
     ...
     Pi^(2*d) - (I*2^(3 - 2*d)*bb*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*mm^2*
    ...
    (I*4^(2 - d)*(aa - bb)*EL^5*gAl*gFFA^2*gHFF*gHll*mh^2*mm^2*
