  ...
  ((I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*s*
    ...
    Pi^(2*d) - (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^4*
     ...
     (bb*(-2*(-2 + d)*psq^2 + (4 + d)*psq*s + (-4 + d)*s^2 + 
        2*(-2 + d)*psq*t + (-8 + d)*s*t + mm^2*(4*(1 + d)*psq - 2*(2 + d)*s - 
          4*(1 + d)*t)) - aa*(-2*(-2 + d)*psq^2 + (16 - 5*d)*psq*s + 
        (-4 + d)*s^2 + 2*(-2 + d)*psq*t + (-8 + d)*s*t + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(2*aa*mm^4 + aa*s*(-3*psq + s + t) - 
      bb*s*(-psq + s + t) + aa*mm^2*(-6*psq + 4*(s + t)) + 
   ...
   (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(-4 + d)*psq*s + 
      aa*mm^2*(4*psq - d*s - 4*t) + 4*bb*mm^2*(-psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(2*bb*mm^4 + 2*bb*mm^2*(psq - 2*t) + 
      aa*s*(-psq + t) - bb*s*(psq + t) + aa*mm^2*(-4*psq + 2*s + 4*t))*
   ...
   (I*2^(1 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(4*aa*(2*psq + s)*(psq - t) - 
      aa*d*(2*psq + s)*(psq - t) + 4*bb*(-2*psq^2 - 4*mm^2*s + 3*psq*s + 
        2*psq*t + s*t) - bb*d*(-2*psq^2 + 3*psq*s + 
        mm^2*(4*psq - 6*s - 4*t) + 2*psq*t + s*t) + 
   ...
   (I*4^(1 - d)*EL^5*gAl^3*gHll^2*mm^2*(-(aa*(-4 + d)*psq*(psq - t)) + 
      bb*(-4 + d)*psq*(psq - s - t) + aa*mm^2*((-4 + 3*d)*psq - 
        2*(-2 + d)*s + (4 - 3*d)*t) + bb*mm^2*((4 - 3*d)*psq + (-8 + 3*d)*s + 
        (-4 + 3*d)*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q1, q2]])/
    Pi^(2*d) + (I*4^(1 - d)*(aa - bb)*EL^5*gAl^3*gHll^2*mm^4*
     (2*s + d*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
   ...
   (I*2^(1 - 2*d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*s*
    ...
    Pi^(2*d) + (I*4^(2 - d)*EL^5*gAl^3*gHll^2*mm^2*
   ...
   (I*4^(2 - d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - psq + t) - bb*(psq + t))*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p2, q1]])/Pi^(2*d) + 
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*
     (aa*((-4 + d)*mm^2 + 8*psq - d*psq - 2*s - 4*t) + 
      2*bb*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], 
      SP[p3, q1]])/Pi^(2*d) - (I*4^(1 - d)*(-4 + d)*EL^5*gAl^3*gHll^2*mm^2*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(d*mm^2 + 2*psq - d*psq - 2*t) + 
   ...
   (I*2^(3 - 2*d)*EL^5*gAl^3*gHll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
     ...
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q1, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*d*EL^5*gAl^3*gHll^2*mm^2*
     (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q1], 
      SP[q2, q2]])/Pi^(2*d) - (I*4^(1 - d)*(aa - bb)*(-4 + d)*EL^5*gAl^3*
     gHll^2*mm^2*(psq - s - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, q2], 
