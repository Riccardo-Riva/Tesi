(PropList[KiraPropagator[q1, mw], KiraPropagator[p3 + q1, 0], 
  ...
  ((2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*((-10 + 3*d)*s^2 + 
   ...
   (2^(3 - 2*d)*(18 - 9*d + d^2)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*s*
     SPList[SP[p3, q2]])/Pi^(2*d) + (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*
     gWlN^2*gWNl^2*((-3 + d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[q1, q2]])/
    (Pi^(2*d)*s) + (4^(1 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*
     ((-4 + d)*s^2 + 4*s*t + 4*t^2)*SPList[SP[q2, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*(2*s^2 - 2*(-5 + d)*s*t - 
   ...
   (2^(5 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*(s + t)*
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*(s + t)*
   ...
   (4^(2 - d)*(12 - 6*d + d^2)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*((100 - 44*d + 5*d^2)*s^2 + 
     ...
     gWlN^2*gWNl^2*SPList[SP[p1, q2], SP[q1, q2]])/Pi^(2*d) + 
   ...
   (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*t*
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*(4*(-4 + d)^2*s^2 + 
      ...
      SP[q1, q1]])/(Pi^(2*d)*s^2) + (4^(2 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*
     gWlN^2*gWNl^2*SPList[SP[p2, q2], SP[q1, q2]])/Pi^(2*d) - 
   ...
   (4^(2 - d)*(10 - 7*d + d^2)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN^2*gWNl^2*
