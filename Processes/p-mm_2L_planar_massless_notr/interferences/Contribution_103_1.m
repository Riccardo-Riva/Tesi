...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
 ...
 ((2^(1 - 2*d)*(-2 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
  ...
  (2^(1 - 2*d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*
   ...
   (Pi^(2*d)*s) - (2^(3 - 2*d)*(10 - 7*d + d^2)*EL^8*gAl^4*gAu^2*
    (gZlL^2 + gZlR^2)*s*SPList[SP[p3, q1]])/Pi^(2*d) + 
  ...
  (4^(1 - d)*(-2 + d)^2*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*(s - 2*t)*
    SPList[SP[p2, q1], SP[p3, q1]])/(Pi^(2*d)*s) - 
  (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^4*gAu^2*(gZlL^2 + gZlR^2)*t*
