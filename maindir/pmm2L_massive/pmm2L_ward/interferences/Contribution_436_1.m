...
PropList[KiraPropagator[q2, mz], KiraPropagator[q2, mz], 
 ...
 (((-I)*2^(-3 - 2*d)*EL^5*gAl*gHHZZ*s*((aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
  ...
  (I*2^(-3 - 4*d)*EL^5*gAl*gHHZZ*(4^(1 + d)*(aa - bb)*(-2 + d)*
      (gZlL^2 + gZlR^2)*Pi^(2*d)*psq*(2*psq - s - 2*t) + 
     2^(1 + 2*d)*bb*(gZlL^2 + gZlR^2)*Pi^(2*d)*s*(2*mm^2 - psq - t) + 
     2^(1 + 2*d)*aa*(gZlL^2 + gZlR^2)*Pi^(2*d)*s*(2*mm^2 - 3*psq + s + t) - 
     2^(1 + 2*d)*bb*(gZlL^2 + gZlR^2)*Pi^(2*d)*s*(-psq + s + t) + 
     2^(1 + 2*d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*s*
      (-2*psq + s + 2*t) - aa*d*(2*Pi)^(2*d)*
      (4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + gZlL^2*s*(2*mm^2 - 3*psq + s + 
         t) + gZlR^2*s*(2*mm^2 - 3*psq + s + t)) + 
     bb*d*(2*Pi)^(2*d)*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*s*(-psq + s + t) + gZlR^2*s*(-psq + s + t)) - 
     bb*d*(2*Pi)^(2*d)*(gZlL^2*s*(2*mm^2 - psq - t) + 
       gZlR^2*s*(2*mm^2 - psq - t) + 4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t)) - 
     aa*(2*Pi)^(2*d)*(2*(gZlL^2 + gZlR^2)*s*(psq - t) - 
       d*(gZlL^2*s*(psq - t) + gZlR^2*s*(psq - t) + 4*gZlL*gZlR*mm^2*
          (-2*psq + s + 2*t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/
   Pi^(4*d) + (I*2^(-3 - 4*d)*EL^5*gAl*gHHZZ*
    (2^(1 + 2*d)*(aa + bb)*(-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq)*
      s - 2^(1 + 2*d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*psq*
      (2*psq - s - 2*t) - 2^(1 + 2*d)*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*
      Pi^(2*d)*s*(-2*psq + s + 2*t) + 
     bb*(-(2^(1 + 2*d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*s*(2*mm^2 - psq - t)) + 
       d*(2*Pi)^(2*d)*(gZlL^2*s*(2*mm^2 - psq - t) + 
         gZlR^2*s*(2*mm^2 - psq - t) + 4*gZlL*gZlR*mm^2*
          (-2*psq + s + 2*t))) + aa*(2*Pi)^(2*d)*
      (2*(gZlL^2 + gZlR^2)*s*(psq - t) - d*(gZlL^2*s*(psq - t) + 
         gZlR^2*s*(psq - t) + 4*gZlL*gZlR*mm^2*(-2*psq + s + 2*t))))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3]])/Pi^(4*d) + 
  (I*2^(-3 - 4*d)*EL^5*gAl*gHHZZ*(2^(1 + 2*d)*(aa + bb)*(-2 + d)*
      (gZlL^2 + gZlR^2)*Pi^(2*d)*(mm^2 - psq)*s - 2^(1 + 2*d)*(aa - bb)*
      (-2 + d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*psq*(2*psq - s - 2*t) - 
     (aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*(-2*psq + s + 2*t) + 
     bb*(-(2^(1 + 2*d)*(gZlL^2 + gZlR^2)*Pi^(2*d)*s*(2*mm^2 - psq - t)) + 
       d*(2*Pi)^(2*d)*(gZlL^2*s*(2*mm^2 - psq - t) + 
         gZlR^2*s*(2*mm^2 - psq - t) + 4*gZlL*gZlR*mm^2*
          (-2*psq + s + 2*t))) + aa*(2*Pi)^(2*d)*
  ...
  (I*2^(-3 - 4*d)*EL^5*gAl*gHHZZ*(2^(1 + 2*d)*(aa + bb)*(-2 + d)*
     ...
     2^(1 + 2*d)*bb*(gZlL^2 + gZlR^2)*Pi^(2*d)*s*(-psq + s + t) - 
     (aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(2*Pi)^(2*d)*s*(-2*psq + s + 2*t) + 
     aa*d*(2*Pi)^(2*d)*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*s*(2*mm^2 - 3*psq + s + t) + gZlR^2*s*(2*mm^2 - 3*psq + s + 
         t)) - bb*d*(2*Pi)^(2*d)*(4*gZlL*gZlR*mm^2*(2*psq - s - 2*t) + 
       gZlL^2*s*(-psq + s + t) + gZlR^2*s*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/Pi^(4*d) - (I*2^(-3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*
    gAl*gHHZZ*(gZlL^2 + gZlR^2)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3]])/Pi^(2*d) + (I*2^(-3 - 2*d)*(-2 + d)*EL^5*gAl*gHHZZ*
    (gZlL^2 + gZlR^2)*s*(aa*(-2*mm^2 + s + 2*t) - 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   Pi^(2*d) - (I*2^(-3 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*gHHZZ*
    (gZlL^2 + gZlR^2)*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 - s - 2*t) + bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 + 6*psq - 5*s - 8*t) + bb*(6*mm^2 - 14*psq + 5*s + 8*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p3]])/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*
    (aa*(2*mm^2 + 2*psq - 3*s - 4*t) + bb*(6*mm^2 - 10*psq + 3*s + 4*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHHZZ*
    (gZlL^2 + gZlR^2)*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
  ...
  (I*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*
    gHHZZ*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHHZZ*
    (gZlL^2 + gZlR^2)*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2]])/Pi^(2*d) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) + (I*4^(-1 - d)*(-2 + d)*EL^5*gAl*gHHZZ*
    (gZlL^2 + gZlR^2)*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*
    (bb*(psq - t) + aa*(-2*mm^2 + psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gHHZZ*(gZlL^2 + gZlR^2)*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(2^(2*(1 + d))*Pi^(2*d)))
