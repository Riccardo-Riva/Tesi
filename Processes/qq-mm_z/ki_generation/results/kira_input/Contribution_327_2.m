...
(I*EL^6*gAl*gAu*(gZlL + gZlR)*(gZlL*gZlLC + gZlR*gZlRC)*(gZuLC + gZuRC)*
 ...
 (I*2^(-1 - 2*d)*EL^6*gAl*gAu*(gZlL + gZlR)*
   ...
   userIntegral[A1, {0}, -1, 0, 1, 0])/(Pi^(2*d)*s*(-mz^2 + s)*
   ...
   (gZlR*gZlRC*(-((-2 + d)*gZuLC*s) + (-4 + d)*gZuRC*s - 2*gZuLC*t - 
      ...
      2*gZuLC*t - 2*gZuRC*t))*userIntegral[A1, {0}, -1, 1, 1, -1])/
  ((2*Pi)^d*(mz^2 - s)*s*(-mzC^2 + s)) + 
 (I*2^(-1 - d)*EL^6*gAl*gAu*(gZlL^2*gZlLC*(-((-4 + d)^2*gZuRC*s) + 
      2*(-2 + d)*gZuRC*t + (-2 + d)*gZuLC*((-4 + d)*s + 2*t)) + 
    gZlR^2*gZlRC*(-((-4 + d)^2*gZuLC*s) + 2*(-2 + d)*gZuLC*t + 
      (-2 + d)*gZuRC*((-4 + d)*s + 2*t)) + 
    gZlL*gZlR*((-4 + d)*gZlRC*gZuLC*((-2 + d)*s - 2*t) + 
      (-4 + d)*gZlLC*gZuRC*((-2 + d)*s - 2*t) - 
      gZlLC*gZuLC*((-2 + d)^2*s + 2*(-4 + d)*t) - 
      gZlRC*gZuRC*((-2 + d)^2*s + 2*(-4 + d)*t)))*
 ...
 (I*2^(-1 - d)*EL^6*gAl*gAu*(gZlL + gZlR)*
   (gZlL*gZlLC*((-2 + d)*gZuLC*s - (-4 + d)*gZuRC*s - 2*gZuLC*t - 
      2*gZuRC*t) + gZlR*gZlRC*(-((-4 + d)*gZuLC*s) + (-2 + d)*gZuRC*s - 
      2*gZuLC*t - 2*gZuRC*t))*userIntegral[A1, {0}, 0, 1, 0, -1])/
  (Pi^d*(mz^2 - s)*s*(-mzC^2 + s)) + 
 ((I/4)*EL^6*gAl*gAu*((2^(2 - d)*(gZlL + gZlR)*
      (gZlL*gZlLC*((-2 + d)*gZuLC - (-4 + d)*gZuRC) + 
       gZlR*gZlRC*(-((-4 + d)*gZuLC) + (-2 + d)*gZuRC))*t)/Pi^d - 
 ...
 (I*4^(-1 - d)*EL^6*gAl*gAu*(gZlR^2*gZlRC*(-(d^2*gZuLC*(2*Pi)^d*s^2) - 
      d^2*gZuRC*(2*Pi)^d*s^2 + 2^(1 + d)*gZuRC*Pi^d*((-4 + 3*d)*s^2 + 
        (-4 + d)^2*s*t + 2*t^2) + 2^(1 + d)*gZuLC*Pi^d*
       ((-4 + 3*d)*s^2 - (8 - 6*d + d^2)*s*t + 2*t^2)) + 
    gZlL^2*gZlLC*(-(d^2*gZuLC*(2*Pi)^d*s^2) - d^2*gZuRC*(2*Pi)^d*s^2 + 
      2^(1 + d)*gZuLC*Pi^d*((-4 + 3*d)*s^2 + (-4 + d)^2*s*t + 2*t^2) + 
      2^(1 + d)*gZuRC*Pi^d*((-4 + 3*d)*s^2 - (8 - 6*d + d^2)*s*t + 2*t^2)) + 
    gZlL*gZlR*(gZlLC*(d^2*gZuRC*(2*Pi)^d*s^2 - 2^(1 + d)*gZuRC*Pi^d*
