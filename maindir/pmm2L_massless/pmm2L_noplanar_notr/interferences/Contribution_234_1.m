...
PropList[KiraPropagator[q1, 0], KiraPropagator[p3 + q1, 0], 
 ...
 ((2^(3 - 2*d)*EL^8*gAl^3*gAu^2*ggpgpA^3*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) + (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (4^(1 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*s*\[Mu]^(8 - 2*d)*SPList[SP[q1, q2]])/
   Pi^(2*d) - (4^(2 - d)*EL^8*gAl^3*gAu^2*ggpgpA^3*\[Mu]^(8 - 2*d)*
