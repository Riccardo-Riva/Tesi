...
-(EL^4*gAd^2*gFFAA*KiraPropagator[q1, MB]*KiraPropagator[q1, MW]*
   KiraPropagator[-p2 + q1, MB]*PolarizationVector[V[1], p1, {Lor1}]*
   PolarizationVector[V[1], p1, {newLor1}]*PolarizationVector[V[1], p2, 
    ...
    SP[p2, {newLor1}]*SP[q1, {newLor2}] - 2*SP[q1, {newLor1}]*
     SP[q1, {newLor2}] - MB^2*SP[{newLor1}, {newLor2}] - 
    SP[p2, q1]*SP[{newLor1}, {newLor2}] + 
