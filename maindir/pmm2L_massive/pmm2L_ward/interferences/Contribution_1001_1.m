...
PropList[KiraPropagator[q1, mw], KiraPropagator[q2, mh], 
 ...
 ((I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHWW^2*mm^2*s*
    (aa*(mm^4 + 2*psq*(-psq + s + t) + mm^2*(-3*psq + 2*t)) + 
     bb*(mm^4 + 2*psq*(psq - t) + mm^2*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) + (I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHWW^2*mm^2*
  ...
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHWW^2*mm^2*
