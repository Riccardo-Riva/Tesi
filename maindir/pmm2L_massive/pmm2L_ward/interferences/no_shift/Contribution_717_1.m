...
(PropList[KiraPropagator[q1, mz], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*2^(1 - 2*d)*(aa + bb)*d*EL^5*gAl^3*gXll^2*mm^4*(mm^2 - psq)^2*s*
    ...
    Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(mm^2 - psq)^2*
     ...
     SPList[SP[p2, q1]])/Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*
     mm^2*(mm^2 - psq)^2*(aa*(psq - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*2^(3 - 2*d)*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*(bb*(2*mm^2 - psq - t) + 
      ...
      SP[q1, q2]])/Pi^(2*d) + (I*4^(2 - d)*bb*(-2 + d)*EL^5*gAl^3*gXll^2*mm^2*
