...
-(EL^4*gAd^2*gWWA^2*KiraPropagator[q1, MD]*KiraPropagator[q1, MW]*
   KiraPropagator[-p2 + q1, MD]*KiraPropagator[-p2 + q1, MW]*
   ...
   (3*SP[p1, {newLor2}]*SP[p2, {newLor1}] - 3*SP[p2, {newLor2}]*
    ...
    2*SP[q1, q1]*SP[{newLor1}, {newLor2}])*SumOver[Index[Colour, 3], 3]*
