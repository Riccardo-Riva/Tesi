...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   (-((2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^4*t*(s + t)^2*
       \[Mu]^(8 - 2*d))/(mh^2*Pi^(2*d)*s)) + 
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^4*(s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1]])/(mh^2*Pi^(2*d)) + 
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*(mm^2 - t)*(s + t)^2*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^4*s*\[Mu]^(8 - 2*d)*
    ...
    (4^(2 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^4*(s + t)*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p1, q1]])/(mh^2*Pi^(2*d)*s) + 
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*(s + t)*(2*mm^2 + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^4*t*\[Mu]^(8 - 2*d)*
      SPList[SP[p1, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)*s) + 
    (3*2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*t*(s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/(mh^2*Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^4*\[Mu]^(8 - 2*d)*
    ...
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*t*(2*mm^2 + 3*(s + t))*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(mh^2*Pi^(2*d)*s) - 
    (4^(2 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*(mm^2 + s + t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(mh^2*Pi^(2*d)) - 
    (4^(1 - d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*(s^2 + 3*s*t + 2*t^2)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(mh^2*Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^6*gAl^2*gAu*gFAW*gHFW*gHll*mm^2*t^2*\[Mu]^(8 - 2*d)*
