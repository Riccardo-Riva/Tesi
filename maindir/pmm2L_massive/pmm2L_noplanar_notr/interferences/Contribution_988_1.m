   ...
   ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    ...
    (4^(1 - d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*sw*(-2*psq^2 + (-3 + d)*psq*s + 3*s^2 - d*s^2 + 
    ...
    (4^(1 - d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*sw*(2*psq^2 - 2*s^2 + d*s^2 + 
       psq*(s - d*s - 4*t) + 2*mm^2*(psq + (-2 + d)*s - t) + 3*s*t + 2*t^2)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/((mh^2 - mz^2)*Pi^(2*d)*s^2) - 
    (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*(psq - s)*
      sw*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/((mh^2 - mz^2)*Pi^(2*d)*s) + 
    (4^(1 - d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*sw*(4*psq^2 + 4*mm^2*s - 2*s^2 + d*s^2 + 
       4*s*t + 4*t^2 - 4*psq*(s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) - (4^(1 - d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*(2*mm^2 - 2*psq + (-3 + d)*s)*sw*
    ...
    (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*sw*(2*mm^2 + psq - 5*s + d*s - 3*t)*
    ...
    (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) + (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*sw*(2*mm^2 - 5*psq - 2*s + d*s + 3*t)*
    ...
    (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
     ...
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*sw*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], 
       SP[p3, q1]])/((mh^2 - mz^2)*Pi^(2*d)*s) - 
    (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
   ...
   ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
    ...
    (4^(1 - d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*gHll*(gZlL + gZlR)*mm^2*sw*
      (6*psq^2 - psq*((2 + d)*s + 10*t) + 2*((-2 + d)*mm^2*s + s^2 + 3*s*t + 
         2*t^2))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
     ((mh^2 - mz^2)*Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gFZW*gHFW*
      gHll*(gZlL + gZlR)*mm^2*sw*(2*psq^2 - 3*s^2 + d*s^2 - 
