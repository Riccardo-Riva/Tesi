...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mz], 
 ...
 (((-I)*(aa - bb)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    mm^2*(24*(-1 + d)*psq^2 + (26 - 14*d)*psq*s - (2 + d)*s^2 - 
  ...
  (I*(aa - bb)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
    (aa*(10*(-2 + d)*psq^2 + (25 - 7*d)*psq*s - 10*(-2 + d)*psq*t + 
       ...
       mm^2*((12 - 22*d)*psq - 3*s + 9*d*s - 12*t + 22*d*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (bb*(2*(-19 + 5*d)*psq^2 + (10 + d)*psq*s - 2*s^2 + 2*(-13 + 7*d)*psq*t + 
       (16 - 3*d)*s*t - 2*mm^2*((-35 + 19*d)*psq + 13*s - 5*d*s + 3*t - 
         7*d*t)) + aa*(2*(-13 + 7*d)*psq^2 + 
       psq*(2*s - 7*d*s + 26*t - 14*d*t) + 2*mm^2*((-3 + 7*d)*psq + 7*s - 
         2*d*s + 3*t - 7*d*t) + s*(2*s - 16*t + 3*d*t)))*\[Mu]^(8 - 2*d)*
  ...
  ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*mm^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*mm^2*((-6 + 8*d)*psq + (21 - 16*d)*s + 6*t - 8*d*t) + 
     ...
     aa*(-3 + 2*d)*(2*psq^2 + 2*s*(s + t) - psq*(9*s + 2*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    ...
    SPList[SP[p2, q1], SP[p2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (aa*(20*(-2 + d)*psq^2 + (34 - 4*d)*psq*s + 3*(-6 + d)*s^2 - 
       20*(-2 + d)*psq*t - 2*(10 + d)*s*t + 2*mm^2*(2*(-6 + 11*d)*psq + 9*s - 
         13*d*s + 12*t - 22*d*t)) + bb*(-20*(-2 + d)*psq^2 + 
       (-58 + 20*d)*psq*s - 3*(-6 + d)*s^2 + 20*(-2 + d)*psq*t + 
       2*(10 + d)*s*t + mm^2*((24 - 44*d)*psq + 6*s + 10*d*s - 24*t + 
         44*d*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q1]])/
   (2^(2*(1 + d))*Pi^(2*d)) - ((3*I)*(aa - bb)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*mm^2*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2], SP[p3, q2]])/(4^d*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (bb*d*(-2*psq^2 - 3*psq*s + mm^2*(10*psq + s - 10*t) + 2*psq*t - 2*s*t) + 
     3*bb*(4*psq^2 - 4*psq*t + s*(-3*mm^2 + t)) - 
  ...
  (I*(aa - bb)*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*s*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (4^d*Pi^(2*d)) - (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(-1 + d)*EL^5*gAl*gWWA^2*gWWZ*
    (gZlL + gZlR)*(bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2], SP[q1, q1]])/Pi^(2*d) - 
  (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(bb*(psq - s - t) + 
  ...
  (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(bb*(9*psq - 7*s - 9*t) + 
     aa*(10*mm^2 - 19*psq + 7*s + 9*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (bb*(2*(-8 + 5*d)*psq + (16 - 9*d)*s + 2*(8 - 5*d)*t) + 
     aa*(4*(-3 + 2*d)*mm^2 + (28 - 18*d)*psq - 16*s + 9*d*s - 16*t + 10*d*t))*
  ...
  (I*(-2 + d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*(bb*(2*mm^2 - psq - t) + 
     ...
     SP[q1, q2]])/(4^d*Pi^(2*d)) - (I*(-5 + 3*d)*EL^5*gAl*gWWA^2*gWWZ*
  ...
  (I*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
   ...
   (4^d*Pi^(2*d)) + (I*(-3 + 2*d)*EL^5*gAl*gWWA^2*gWWZ*(gZlL + gZlR)*
    (bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
