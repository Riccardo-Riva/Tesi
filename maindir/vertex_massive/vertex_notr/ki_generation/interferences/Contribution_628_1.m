...
PropList[KiraPropagator[-p1 - q1, mm], KiraPropagator[-q1 - q2, mz], 
 ...
 ((EL^6*gAl^2*gXll^2*mm^4*(-((2^(3 - 2*d)*(4 - 5*d + d^2)*gZlL*gZlR*mm^2*s)/
    ...
    \[Mu]^(8 - 2*d))/2 + (4^(1 - d)*d*EL^6*gAl^2*gXll^2*gZlL*gZlR*mm^4*
    (mm^2 - s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) + 
  EL^6*gAl^2*gXll^2*mm^4*(-((4^(1 - d)*d*gZlL*gZlR*(mm^2 - s))/Pi^(2*d)) - 
   ...
   SPList[SP[p1, q1]] + (2^(-1 - 2*d)*EL^6*gAl^2*gXll^2*mm^2*
    ((-2 + d)*gZlL^2*(mm^2 - s)*(2*(-1 + d)*mm^2 - 2*(-3 + d)*psq + 
       3*(-4 + d)*s) + (-2 + d)*gZlR^2*(mm^2 - s)*(2*(-1 + d)*mm^2 - 
       2*(-3 + d)*psq + 3*(-4 + d)*s) + 4*gZlL*gZlR*mm^2*
      ((4 - 8*d + d^2)*mm^2 - (4 - 6*d + d^2)*s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) + (4^(1 - d)*d*EL^6*gAl^2*gXll^2*gZlL*gZlR*
    mm^4*(mm^2 - s)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/Pi^(2*d) + 
  (EL^6*gAl^2*gXll^2*mm^2*(mm^2 - s)*(-8*(gZlL^2 + gZlR^2)*s - 
     d^2*(gZlL^2 + gZlR^2)*s + 6*d*(2*gZlL*gZlR*mm^2 + gZlL^2*s + gZlR^2*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
  (2^(-1 - 4*d)*EL^6*gAl^2*gXll^2*mm^2*(2^(3 + 2*d)*(4 - 5*d + d^2)*gZlL*gZlR*
      mm^2*Pi^(2*d)*s - (-2 + d)*gZlL^2*(2*Pi)^(2*d)*
      (2*(1 + d)*mm^4 + s*(-2*(-5 + d)*psq + (-4 + d)*s) + 
       mm^2*(-2*(-1 + d)*psq + 3*(-2 + d)*s)) - (-2 + d)*gZlR^2*(2*Pi)^(2*d)*
      (2*(1 + d)*mm^4 + s*(-2*(-5 + d)*psq + (-4 + d)*s) + 
       mm^2*(-2*(-1 + d)*psq + 3*(-2 + d)*s)))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(4*d) + 
  (EL^6*gAl^2*gXll^2*mm^2*((2^(3 - 2*d)*d*gZlL*gZlR*mm^2*s)/Pi^(2*d) + 
  ...
  (4^(1 - d)*d*EL^6*gAl^2*gXll^2*gZlL*gZlR*mm^4*\[Mu]^(8 - 2*d)*
  ...
  (4^(1 - d)*EL^6*gAl^2*gXll^2*mm^2*(-2*d*gZlL*gZlR*mm^2 + 
  ...
  (2^(1 - 2*d)*EL^6*gAl^2*gXll^2*mm^2*(-12*(gZlL^2 + gZlR^2)*s - 
  ...
  (2^(1 - 2*d)*(-2 + d)*EL^6*gAl^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
   ...
   Pi^(2*d) - ((-8 + d)*(-2 + d)*EL^6*gAl^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*
  ...
  (4^(1 - d)*(-2 + d)*EL^6*gAl^2*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
   ...
   (2*Pi)^(2*d) + (2^(3 - 2*d)*(-2 + d)*EL^6*gAl^2*gXll^2*(gZlL^2 + gZlR^2)*
