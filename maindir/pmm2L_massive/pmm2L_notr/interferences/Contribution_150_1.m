...
PropList[KiraPropagator[q1, mm], KiraPropagator[p3 + q1, mh], 
 ...
 ((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(mm^2 + psq)*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(-psq + s + t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s^2) + 
  (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*
  ...
  (4^(1 - d)*EL^8*gAl^2*gAu^2*ggpgpA^2*gHgpgp*gHll*mm^2*(mm^2 - t)*
