...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p1 + q1, mm], 
  ...
  ((EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(4*psq - s)*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     (3*mm^2 + psq - d*psq - (-4 + d)*s)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
    Pi^(2*d) + (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*
     ((-2 + d)*mm^2 + 2*(-4 + d)*psq - (-2 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q2]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*(6*mm^2 + 4*psq + (8 - 3*d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q1]])/Pi^(2*d) - (4^(1 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*((-2 + d)*mm^2 - (-3 + d)*psq - s)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2]])/Pi^(2*d) - (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*
     (gZlL - gZlR)*mm^4*(2*mm^2 - 6*psq - (-5 + d)*s)*\[Mu]^(8 - 2*d)*
     SPList[SP[q1, q1]])/Pi^(2*d) - (EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*
     mm^2*(2*(-3 + d)*mm^4 + (-4 + d)*(4*psq - s)*s + 
   ...
   (EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*(2*(-1 + d)*mm^2 - 
    ...
    (Pi^(2*d)*s) - (4^(1 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     (mm^4 + (5 - 2*d)*psq*s - mm^2*(psq + (-1 + d)*s))*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2]])/(Pi^(2*d)*s) + 
   (2^(5 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^4*\[Mu]^(8 - 2*d)*
   ...
   (2^(1 - 2*d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
     ((-14 + 3*d)*mm^2 - 2*(-1 + d)*psq - (-4 + d)*s)*\[Mu]^(8 - 2*d)*
   ...
   (4^(1 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s) + (3*4^(2 - d)*EL^6*gAl^2*gHll*gHXZ*gXll*(gZlL - gZlR)*mm^2*
