...
PropList[KiraPropagator[-p3 - q1, mm], KiraPropagator[-p3 - q1, mm], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa + bb)*d*EL^5*gAl^3*gHll^2*mm^4*(mm^2 - psq)^2*s*
    \[Mu]^(8 - 2*d))/Pi^(2*d) - (I*d*EL^5*gAl^3*gHll^2*mm^4*
    ((aa + bb)*(mm^2 - psq)*s - (aa - bb)*(mm^2*(5*psq - 3*s - 5*t) + 
       psq*(3*psq - s - 3*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/
   (4^d*Pi^(2*d)) + (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
    (mm^2 - psq)*(3*mm^2 + psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) - 
  (I*d*EL^5*gAl^3*gHll^2*mm^4*((aa + bb)*(mm^2 - psq)*s - 
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(mm^2 - psq)*
    (3*mm^2 + psq)*(psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  ...
  (I*2^(1 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^4*(aa*(psq - s - t) + 
  ...
  (I*2^(1 - 2*d)*d*EL^5*gAl^3*gHll^2*mm^4*(aa*(2*mm^2 - psq - t) + 
  ...
  (I*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(mm^2 - t) + bb*(mm^2 - 2*psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2], SP[q1, q1]])/
   (2*Pi)^(2*d) + (I*2^(1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
  ...
  (I*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(mm^2 - s - t) + 
     bb*(mm^2 - 2*psq + s + t))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], 
     SP[p2, q1], SP[q1, q1]])/(2*Pi)^(2*d) - 
  ...
  (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*(aa*(2*mm^2 - psq - t) + 
     bb*(-psq + t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
     SP[p3, q2]])/Pi^(2*d) - (I*2^(1 - 2*d)*(-2 + d)*EL^5*gAl^3*gHll^2*mm^2*
    (aa*(2*mm^2 - psq - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
