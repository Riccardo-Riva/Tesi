...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
   ...
   KiraPropagator[q2, mz]]*((2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*
     mm^4*(4*psq^2 + 2*(-2 + d)*mm^2*s + 2*s^2 - d*s^2 + 4*s*t + 4*t^2 - 
      2*psq*((-2 + d)*s + 4*t))*\[Mu]^(8 - 2*d))/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
   ...
   (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(2 - d)*EL^8*gAl^2*gAu^2*gXll^2*gXXXX*mh^2*mm^2*
