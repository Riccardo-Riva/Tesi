...
PropList[KiraPropagator[q1, mz], KiraPropagator[q2, mh], 
 ...
 ((I*4^(-1 - d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*s*
  ...
  (I*4^(-1 - d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*
  ...
  (I*(aa + bb)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, p3]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*4^(-1 - d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*s*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*SPList[SP[p3, q2]])/
   Pi^(2*d) - (I*(aa + bb)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*
  ...
  (I*(aa - bb)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p3, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(aa*(3*psq - 2*s - 3*t) + 
     bb*(2*mm^2 - 5*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(aa*(4*psq - 3*s - 4*t) + 
  ...
  (I*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p3, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p1, q2]])/Pi^(2*d) + 
  (I*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(aa*(mm^2 + psq - s - 2*t) + 
     bb*(mm^2 - 3*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(aa*(2*mm^2 - s - 2*t) + 
     bb*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
  ...
  (I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*(aa*(4*mm^2 - s - 4*t) + 
     bb*(-4*psq + s + 4*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q2]])/
   Pi^(2*d) - (I*2^(-1 - 2*d)*(aa - bb)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*
    (2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p3, q2]])/
   Pi^(2*d) + (I*2^(-1 - 2*d)*d*EL^5*gAl*gHll^2*gHZZ^2*mm^2*
