...
PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, mz], 
 ...
 (((-I)*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*s*
    (bb*(mm^2 + psq - 2*s - t) + aa*(mm^2 - psq - s + t))*\[Mu]^(8 - 2*d))/
   Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
    (aa*(-4*psq^2 + 2*mm^2*s - 5*s*(s + 2*t) + 2*psq*(5*s + 2*t)) + 
     bb*(4*psq^2 + 2*mm^2*s + 5*s*(s + 2*t) - 2*psq*(7*s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
    (bb*(-2*psq^2 + 7*psq*s - 2*s^2 + 2*psq*t - 7*s*t) + 
     aa*(2*psq^2 - psq*(9*s + 2*t) + s*(2*mm^2 + 2*s + 7*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^4*
    (mm^2 - psq)*(aa*mm^2*(psq - t) + bb*mm^2*(-psq + t) - 
     2*bb*s*(-2*psq + 2*s + t) + aa*s*(-2*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
    (-(bb*(2*psq^2 - 5*psq*s + s^2 - 2*psq*t + 5*s*t)) + 
     aa*(2*psq^2 - psq*(7*s + 2*t) + s*(2*mm^2 + s + 5*t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/Pi^(2*d) - (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
    (aa*(2*psq^2 - 9*psq*s + 5*s^2 - 2*psq*t + 7*s*t) + 
     bb*(-2*psq^2 + s*(2*mm^2 - 5*s - 7*t) + psq*(7*s + 2*t)))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^6*
    (aa*(2*psq^2 - 7*psq*s + 4*s^2 - 2*psq*t + 5*s*t) + 
     bb*(-2*psq^2 + s*(2*mm^2 - 4*s - 5*t) + psq*(5*s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gXll^4*mm^6*(mm^2 - psq)*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p3, p3]])/Pi^(2*d) - 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*s*
    (aa*(3*psq - s - 3*t) + bb*(-3*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q1]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^6*s*
    (bb*(2*mm^2 - s - 2*t) + aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p3, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^4*
    (mm^2 - psq)*s*(aa*(mm^2 + 2*psq - 2*s - 2*t) + bb*(mm^2 - 2*psq + 2*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[q1, q1]])/Pi^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*s*
    (aa*(mm^2 + psq - 2*s - t) + bb*(mm^2 - psq - s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[q1, q2]])/Pi^(2*d) + (I*2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*gXll^4*
    mm^6*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/Pi^(2*d) + 
  ((3*I)*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(2*psq - s - 2*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2]])/Pi^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(12*psq - 5*s - 12*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(mm^4 + 2*psq^2 - mm^2*(psq + s) + 
       4*s*(s + t) - psq*(5*s + 2*t)) - 
     bb*(mm^4 + 6*psq^2 + mm^2*(-5*psq + 9*s) + 4*s*(s + t) - 
       psq*(15*s + 2*t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q1]])/
   (2*Pi)^(2*d) - (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(8*psq - 3*s - 8*t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(12*psq - 7*s - 12*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(mm^4 + 2*psq^2 - 5*psq*s + 
       mm^2*(-5*psq + 9*s) + 2*psq*t - 4*s*t) + 
     bb*(-mm^4 + 2*psq^2 - 5*psq*s + mm^2*(psq + s) - 2*psq*t + 4*s*t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p2, q1]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(8*psq - 5*s - 8*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(-6*psq^2 + 4*mm^2*(psq - t) - 3*s*(s + 2*t) + 
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(3*psq - 2*s - 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^4*mm^4*(bb*(2*psq^2 - 9*psq*s + mm^2*(3*s - 2*t) + 
       4*s*(s + t)) + aa*(5*psq*s - 4*s*(s + t) + mm^2*(-2*psq + s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(4*psq - 3*s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, q2]])/(2*Pi)^(2*d) + 
  ((3*I)*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(2*psq - s - 2*t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(-3*aa*psq*s + aa*mm^2*(psq - t) + 
     bb*mm^2*(psq - 3*s + t) + 2*aa*s*(s + t) - 
     2*bb*(psq^2 - 3*psq*s + s*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p1, q2]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gXll^4*mm^4*(-(bb*(mm^4 + 2*psq^2 - 8*psq*s + 4*s*(s + t) - 
        mm^2*(psq - 2*s + 2*t))) + aa*(mm^4 + 4*s*(-psq + s + t) + 
       mm^2*(psq - 2*(s + t))))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], 
     SP[p2, p3]])/(2*Pi)^(2*d) + 
  (I*EL^5*gAl*gXll^4*mm^4*(bb*(mm^4 + 2*psq^2 - 5*psq*s - 
       mm^2*(2*psq - 2*s + t) + 2*s*(s + t)) + 
     aa*(-mm^4 + mm^2*(s + t) - 2*s*(-psq + s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, q2]])/(2*Pi)^(2*d) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*
    (aa*(psq - t) + bb*(-psq + 2*s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p3, p3]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^4*mm^4*(-(bb*(2*mm^2 - psq - 2*s)*(psq - s - t)) + 
     aa*(-psq^2 + mm^2*(2*psq - s - 2*t) + psq*(-2*s + t) + 2*s*(s + t)))*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(-(bb*(mm^4 + 2*s*(psq - t) + mm^2*(-2*psq + t))) + 
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(-((psq - s)*(3*psq - s - 3*t)) + 
       mm^2*(2*psq - s - 2*t)) + bb*(3*psq^2 - 3*psq*(2*s + t) + 
       mm^2*(-2*psq + 3*s + 2*t) + s*(s + 3*t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(3*psq - s - 3*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, p3]])/(2*Pi)^(2*d) - 
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(-2*psq^2 + psq*s + mm^2*(4*psq - 5*s - 2*t) + 
       4*s*t) + bb*(s*(3*psq - 4*t) + mm^2*(-2*psq + s + 2*t)))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, p3], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(4*psq - s - 4*t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q2]])/(2*Pi)^(2*d) - 
  (I*(aa - bb)*EL^5*gAl*gXll^4*mm^6*(-psq + s + t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) - 
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(-3*psq^2 + 5*psq*s - 3*s^2 + 
       mm^2*(2*psq + s - 2*t) + 3*psq*t - 5*s*t) + 
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(-2*psq^2 + 2*psq*s + mm^2*(3*psq - 4*s - t) + 
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(2*mm^2 - psq - 2*s)*(psq - t) + 
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(bb*((psq - s)*(3*psq - 2*s - 3*t) + 
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^4*mm^4*s*(aa*(2*mm^2 - s - 2*t) + 
  ...
  (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*(psq - s - t) + 
     bb*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p2], SP[p1, p2], SP[p1, q1]])/Pi^(2*d) + 
  (I*2^(3 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p2], SP[p1, p2], SP[p2, q1]])/Pi^(2*d) - 
  (I*4^(1 - d)*EL^5*gAl*gXll^4*mm^4*(aa*(mm^2 + 3*psq - 2*s - 4*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*(5*mm^2 - 3*psq - 2*t) - 
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(6*mm^2 + 2*psq - 3*s - 8*t) + 
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(3*mm^2 - psq - 2*t) + bb*(mm^2 - 3*psq + 2*t))*
  ...
  (I*2^(1 - 2*d)*(2*aa - bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, p3], SP[p1, p3], SP[p2, q1]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*(3*psq - 2*s - 3*t) + 
     bb*(mm^2 - 4*psq + 2*s + 3*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p1, p3], SP[p3, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(3*psq - 2*s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - 2*bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*(mm^2 + 5*psq - 3*s - 6*t) + 
     bb*(mm^2 - 7*psq + 3*s + 6*t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, p3], SP[p2, p3], SP[p3, q1]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(2*mm^2 + 4*psq - 3*s - 6*t) + 
  ...
  (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(psq - s - t)*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
   ...
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - 2*bb)*EL^5*gAl*gXll^4*mm^4*
    (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, p3]])/
   Pi^(2*d) - (I*2^(1 - 2*d)*(2*aa - 3*bb)*EL^5*gAl*gXll^4*mm^4*(mm^2 - psq)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, p3], SP[p2, q2]])/Pi^(2*d) + 
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(mm^2 + psq - 2*(s + t)) + 
     bb*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[p2, p3], SP[p3, p3]])/(4^d*Pi^(2*d)) + 
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(2*bb*(-psq + s + t) + 
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(mm^2 - s - t) + bb*(mm^2 - 2*psq + s + t))*
   ...
   (2*Pi)^(2*d) + (I*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(-psq + s + t)*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*
    (-psq + s + t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], 
     SP[p3, q2]])/Pi^(2*d) + (I*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(-psq + s + t)*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(psq - s - t) + bb*(2*mm^2 - 3*psq + s + t))*
   ...
   (4^d*Pi^(2*d)) + (I*2^(1 - 2*d)*(2*aa - bb)*EL^5*gAl*gXll^4*mm^4*
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(mm^2 - t) + bb*(mm^2 - 2*psq + t))*
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*(mm^2 + 2*psq - s - 3*t) + 
  ...
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*(mm^2 + psq - 2*t) + 
     ...
     SP[p3, q2]])/Pi^(2*d) + (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*
    (aa*(mm^2 - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, p3], SP[p2, q1], SP[q2, q2]])/Pi^(2*d) - 
  (I*2^(1 - 2*d)*EL^5*gAl*gXll^4*mm^4*(aa*(2*mm^2 + 2*psq - s - 4*t) + 
  ...
  (I*EL^5*gAl*gXll^4*mm^4*(aa*(2*mm^2 - psq - t) + bb*(-psq + t))*
   ...
   (4^d*Pi^(2*d)) - (I*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(psq - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p3, p3], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(1 - 2*d)*(aa - bb)*EL^5*gAl*gXll^4*mm^4*(psq - t)*
