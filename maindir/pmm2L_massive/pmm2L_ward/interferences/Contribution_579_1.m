...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 (((3*I)*(aa - bb)*EL^5*gAl*gFFA^2*gFll^2*mm^4*s*(-psq + s + t)*
  ...
  (I*EL^5*gAl*gFFA^2*gFll^2*mm^2*s*(3*aa*mm^2*(psq - t) + 
     aa*psq*(psq - 2*s - t) - 3*bb*mm^2*(psq - s - t) - bb*psq*(psq + s - t))*
  ...
  (I*EL^5*gAl*gFFA^2*gFll^2*mm^2*(2*bb*(psq - s - t) + 
     aa*(mm^2 - 3*psq + 2*(s + t)))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFFA^2*gFll^2*mm^2*(bb*(psq - s - t) + 
     aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
  ...
  (I*EL^5*gAl*gFFA^2*gFll^2*mm^2*(bb*(mm^2 + 3*psq - 2*s - 4*t) + 
  ...
  (I*EL^5*gAl*gFFA^2*gFll^2*mm^2*(bb*(mm^2 + psq - 2*t) + 2*aa*(-psq + t))*
  ...
  (I*EL^5*gAl*gFFA^2*gFll^2*mm^2*(bb*(2*mm^2 - s - 2*t) + 
     aa*(2*mm^2 - 4*psq + s + 2*t))*\[Mu]^(8 - 2*d)*
