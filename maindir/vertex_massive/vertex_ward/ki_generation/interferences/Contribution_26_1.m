...
PropList[KiraPropagator[-p1 - q1, mw], KiraPropagator[-q1, mw], 
 ...
 (-((2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^4*mm^4*(mm^2 + psq)*s^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q1]])/Pi^(2*d)) - 
  (2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^4*mm^4*(mm^2 + psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2]])/Pi^(2*d) + 
  (2^(-1 - 2*d)*EL^5*gFFA*gFll^4*mm^4*(aa*(3*mm^2 + psq) - bb*(mm^2 + 3*psq))*
  ...
  (EL^5*gFFA*gFll^4*mm^4*(aa*(3*mm^2 + psq) - bb*(mm^2 + 3*psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gFFA*gFll^4*mm^4*(aa*(4*mm^2 + psq) - bb*(mm^2 + 4*psq))*s*
