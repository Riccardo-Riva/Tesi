...
PropList[KiraPropagator[-p3 + q1, 0], KiraPropagator[q2, mz], 
 ...
 ((2^(-1 - 4*d)*d*EL^8*gAl^4*gAu^2*mm^2*
  ...
  (EL^8*gAl^4*gAu^2*(-((-2 + d)*(mm^2 - psq)*
       (-2*gZlL*gZlR*mm^2*(8*s + d^2*s + 2*d*(psq - 4*s - t)) + 
        gZlL^2*((-2 + d)*mm^2*(2*psq + (-4 + d)*s - 2*t) + 
          2*(2*psq^2 + (5 - 2*d)*psq*s + (-3 + d)*s^2 - 4*psq*t + s*t + 
            2*t^2)) + gZlR^2*((-2 + d)*mm^2*(2*psq + (-4 + d)*s - 2*t) + 
          2*(2*psq^2 + (5 - 2*d)*psq*s + (-3 + d)*s^2 - 4*psq*t + s*t + 
            2*t^2)))) + 2*d*mm^2*(gZlL*gZlR*(8*(-mm^2 + psq)*s + 
         d^2*(-mm^2 + psq)*s - 2*d*(3*mm^2*(psq - 2*s - t) + 
           psq*(psq + 2*s - t))) + 
  ...
  (EL^8*gAl^4*gAu^2*(-((-2 + d)*(mm^2 - psq)*
       (-2*gZlL*gZlR*mm^2*(8*s + d^2*s - 2*d*(psq + 3*s - t)) + 
        ...
        gZlR^2*(4*psq^2 + 6*psq*s - 4*d*psq*s - 4*s^2 + 2*d*s^2 - 8*psq*t + 
          6*s*t + 4*t^2 + (-2 + d)*mm^2*(-2*psq + (-2 + d)*s + 2*t)))) + 
     2*d*mm^2*(gZlL*gZlR*(8*(-mm^2 + psq)*s + d^2*(-mm^2 + psq)*s + 
  ...
  (EL^8*gAl^4*gAu^2*(4*gZlL*gZlR*mm^2*(-8*s + d^2*(2*psq - s - 2*t) + 
       6*d*(-psq + s + t)) + (-2 + d)*gZlL^2*(-4*psq^2 - 
       2*(11 - 6*d + d^2)*psq*s - 4*s^2 + 2*d*s^2 + 8*psq*t + 2*s*t - 4*t^2 + 
       (-2 + d)*mm^2*(-6*psq + (-2 + d)*s + 6*t)) + 
     (-2 + d)*gZlR^2*(-4*psq^2 - 2*(11 - 6*d + d^2)*psq*s - 4*s^2 + 2*d*s^2 + 
