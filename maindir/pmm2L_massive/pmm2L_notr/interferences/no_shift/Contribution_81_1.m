...
(PropList[KiraPropagator[q1, mm], KiraPropagator[-p3 + q1, 0], 
  ...
  ((4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*mm^2*
    ...
    (Pi^(2*d)*s^2) + (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*mm^2*
    ...
    (Pi^(2*d)*s^2) - (2^(1 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
     (16*(-2 + d)*psq^3 + 4*psq^2*((-6 + d)*s - 8*(-2 + d)*t) + 
      ...
      2*mm^2*(8*(-3 + 2*d)*psq^2 + (-6 + 2*d + d^2)*s^2 + 
        16*(3 - 2*d)*psq*t + 8*(-3 + 2*d)*s*t + 8*(-3 + 2*d)*t^2))*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(-8*(-3 + d)*psq^2 - 
   ...
   (4^(2 - d)*(21 - 10*d + d^2)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*mm^2*
     \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q2]])/(Pi^(2*d)*s) + 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(-12*(-2 + d)*psq^2 + 
      16*s^2 - 2*d*s^2 - d^2*s^2 + 28*s*t - 10*d*s*t + 16*t^2 - 8*d*t^2 + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*(-2 + d)*psq^2 - 6*s^2 + 
   ...
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*(-10 + 3*d)*psq^2 - 
      28*s^2 + 4*d*s^2 + d^2*s^2 - 64*s*t + 16*d*s*t - 40*t^2 + 12*d*t^2 + 
   ...
   (2^(3 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
    ...
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
     (-8*psq^2 + (-40 + 11*d)*psq*s - 2*s^2 + d*s^2 - 4*(-6 + d)*psq*t - 
      6*s*t + 2*d*s*t - 16*t^2 + 4*d*t^2 + mm^2*(4*(-2 + d)*psq + 16*s - 
        7*d*s + 8*t - 4*d*t))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[q2, q2]])/
    (Pi^(2*d)*s^2) - (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*mm^2*
     (2*(-5 + 2*d)*psq + (8 - 6*d + d^2)*s + 2*(5 - 2*d)*t)*\[Mu]^(8 - 2*d)*
     SPList[SP[p2, q2], SP[p2, q2]])/(Pi^(2*d)*s^2) - 
   (4^(1 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*(-2 + d)*psq^2 - 4*s^2 + 
     ...
     gWWA^2*mm^2*(2*(-1 + d)*psq + (-5 + 2*d)*s - 2*(-1 + d)*t)*
     \[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[p3, q2]])/(Pi^(2*d)*s^2) + 
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(2*(-3 + d)*psq*s - 2*s^2 + 
   ...
   (4^(2 - d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*(-2 + d)*psq^2 + 
   ...
   (2^(5 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(2*(-2 + d)*psq^2 + 
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(mm^2 - psq)*
    ...
    (Pi^(2*d)*s^2) - (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
   ...
   (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*\[Mu]^(8 - 2*d)*
     SPList[SP[p1, q1], SP[p1, q2], SP[p3, q1]])/(Pi^(2*d)*s) - 
   (2^(3 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*(-2 + d)*mm^2 + 
      2*(-14 + d)*psq + (-6 + d)*((-8 + d)*s - 6*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-6 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*\[Mu]^(8 - 2*d)*
   ...
   (2^(3 - 2*d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(4*(-2 + d)*mm^2 + 
      (44 - 10*d)*psq + (-6 + d)*((-2 + d)*s + 6*t))*\[Mu]^(8 - 2*d)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(2*mm^2 - psq - t)*
    ...
    (Pi^(2*d)*s^2) - (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
     ...
     gWWA^2*(-4*(-2 + d)*mm^2 + 4*(-2 + d)*psq + (34 - 13*d + d^2)*s)*
   ...
   (2^(5 - 2*d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*
     ...
     gWlN*gWNl*gWWA^2*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1], 
      SP[p3, q2]])/(Pi^(2*d)*s) + (4^(2 - d)*(-2 + d)^2*EL^8*gAl^2*gAu^2*gWlN*
   ...
   (4^(3 - d)*(-2 + d)*EL^8*gAl^2*gAu^2*gWlN*gWNl*gWWA^2*(psq - t)*
