...
PropList[KiraPropagator[q1, mw], KiraPropagator[p1 + q1, mw], 
 ...
 ((EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*s*
   ...
   (2*Pi)^(2*d) - (aa*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*s^2*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2*Pi)^(2*d) - 
  (aa*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*s^2*\[Mu]^(8 - 2*d)*
    SPList[SP[p2, q2]])/(2*Pi)^(2*d) - 
  (2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*s*
   ...
   Pi^(2*d) - (2^(-1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
    ...
    SPList[SP[q1, q2]])/Pi^(2*d) - (2^(-1 - 2*d)*(aa + bb)*EL^5*gAl*ggpgpA^2*
    ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*s^2*\[Mu]^(8 - 2*d)*SPList[SP[q2, q2]])/
   Pi^(2*d) - (2^(1 - 2*d)*EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*
  ...
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*(mm^2 - 5*psq) + 
     2*bb*(mm^2 + psq))*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
   (2*Pi)^(2*d) - (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(mm^2 - psq)*
    (2*aa*psq + bb*(-2*psq + s))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q1, q1]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(2*bb*mm^2*(psq - 2*s) + 
     2*bb*psq*(-psq + s) - aa*mm^2*(2*psq + s) + aa*psq*(2*psq + 3*s))*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q1, q2]])/(2*Pi)^(2*d) - 
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(aa*mm^2 + 2*bb*mm^2 - 2*aa*psq - 
     bb*psq)*s*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[q2, q2]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(-2*bb*mm^2 + aa*(mm^2 + psq))*s*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/(2*Pi)^(2*d) + 
  (EL^5*gAl*ggpgpA^2*ggpgpZ*(gZlL + gZlR)*(bb*mm^2 - aa*psq)*s*
