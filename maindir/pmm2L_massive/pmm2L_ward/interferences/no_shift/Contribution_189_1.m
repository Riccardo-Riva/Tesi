...
(PropList[KiraPropagator[q1, mh], KiraPropagator[p3 + q1, mm], 
  ...
  (((-I)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*s*
   ...
   (I*(aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*s*(-2*psq + s + 2*t)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
    ...
    Pi^(2*d) - (I*4^(1 - d)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
   ...
   (I*4^(1 - d)*(aa - bb)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
    ...
    Pi^(2*d) + (I*2^(3 - 2*d)*aa*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
     (mm^2 - psq)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p1, q2], SP[p3, q1]])/
    Pi^(2*d) + (I*2^(1 - 2*d)*(-2 + d)*EL^5*gHll^2*gWlN*gWNl*gWWA*mm^2*
     (bb*(psq - s - t) + aa*(2*mm^2 - 3*psq + s + t))*\[Mu]^(8 - 2*d)*
