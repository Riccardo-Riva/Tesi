...
(PropList[KiraPropagator[q1, mm], KiraPropagator[p1 + p2 + q1, mm], 
    ...
    (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(psq + (-3 + d)*s - t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q2]])/(mh^2*Pi^(2*d)*s^2) - 
    (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(2*mm^2 - 2*psq + (-3 + d)*s)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(2*mm^2 + psq - 5*s + d*s - 
       3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p2, q2]])/
     (mh^2*Pi^(2*d)*s^2) - (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
    ...
    (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(2*mm^2 - 5*psq - 2*s + d*s + 
       3*t)*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p2, q1]])/
     (mh^2*Pi^(2*d)*s^2) + (4^(4 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q1]])/(mh^2*Pi^(2*d)*s) + 
    (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-2*psq + (-2 + d)*s + 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q1, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (4^(3 - d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(2*psq - (-2 + d)*s - 2*t)*
      \[Mu]^(8 - 2*d)*SPList[SP[p2, q1], SP[p2, q1]])/(mh^2*Pi^(2*d)*s^2) + 
    (2^(7 - 2*d)*EL^8*gAl^4*gAu^2*gHll^2*mm^4*(-psq + (-2 + d)*s + t)*
