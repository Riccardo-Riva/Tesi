...
PropList[KiraPropagator[q1, 0], KiraPropagator[-p3 + q1, mw], 
 ...
 ((I*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*s*(bb*(psq - s - t) + 
   ...
   (2^(2*(1 + d))*Pi^(2*d)) + (I*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*s*
  ...
  (I*2^(-1 - 2*d)*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
   ...
   Pi^(2*d) - (I*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p1, q1], SP[p2, q2]])/
   (4^d*Pi^(2*d)) + (I*(aa - bb)*EL^5*gFFA*gFll^2*gHFF*gHll*mh^2*mm^4*
