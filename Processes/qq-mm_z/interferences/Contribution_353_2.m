...
PropList[KiraPropagator[p1 - q1, mt], KiraPropagator[-p2 - q1, mt]]*
 (((3*I)*EL^6*gZuL*gZuR*mt^2*
  ...
  ((I/2)*EL^6*((-3*2^(1 - 2*d)*(gZuL^2 + gZuR^2)*
       (gZlL*gZlLC*(gZuR*gZuRC*(-(d^2*(2*Pi)^d*s^2) + 2^(1 + d)*Pi^d*
  ...
  ((3*I)*2^(2 - d)*EL^6*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL^2 + gZuR^2)*
  ...
  ((3*I)*2^(3 - d)*EL^6*(gZlL*gZlLC + gZlR*gZlRC)*(gZuL^2 + gZuR^2)*
