...
PropList[KiraPropagator[-p3 + q1, mz], KiraPropagator[q2, mz], 
 ...
 (((-I)*2^(-1 - 2*d)*(aa + bb)*d*EL^5*gAl*gXll^2*gZlL*gZlR*mm^4*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)^2*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*EL^5*gAl*gXll^2*mm^2*(mm^2 - psq)*
    ((aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(psq - s - t) - 
     4*d*gZlL*gZlR*mm^2*(aa*(psq - 2*s - t) + bb*(-psq + t)))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)^2*
    (psq - t)*\[Mu]^(8 - 2*d)*SPList[SP[p2, q1]])/(2^(2*(1 + d))*Pi^(2*d)) - 
  (I*EL^5*gAl*gXll^2*mm^2*(mm^2 - psq)*
    (-4*d*gZlL*gZlR*mm^2*(aa*(psq - s - t) - bb*(psq + s - t)) + 
     (aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(psq - t))*
    \[Mu]^(8 - 2*d)*SPList[SP[p2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*(aa + bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)^2*
    s*\[Mu]^(8 - 2*d)*SPList[SP[p3, q1]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  ...
  (I*4^(-1 - d)*(aa + bb)*EL^5*gAl*gXll^2*mm^2*(2*d*gZlL*gZlR*mm^2 + 
     (-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq))*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
   ...
   (4^d*Pi^(2*d)) + (I*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*
    mm^2*(mm^2 - psq)*(psq - s - t)*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q1], SP[q2, q2]])/(2^(2*(1 + d))*Pi^(2*d)) + 
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*(-4*d*gZlL*gZlR*mm^2 + 
     (-2 + d)*gZlL^2*(mm^2 - psq) + (-2 + d)*gZlR^2*(mm^2 - psq))*
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    (4*(aa - bb)*d*gZlL*gZlR*mm^2*(psq - s - t) - 2*(aa - bb)*(-2 + d)*
      (gZlL^2 + gZlR^2)*(mm^2 - psq)*(psq - s - t) + 
     (-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(aa*(psq - 2*s - t) + 
       bb*(-psq + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[p3, q2]])/
   Pi^(2*d) - (I*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*
    (aa*(psq - s - t) + bb*(-psq + t))*\[Mu]^(8 - 2*d)*
    SPList[SP[p1, q2], SP[q1, q2]])/(4^d*Pi^(2*d)) + 
  (I*EL^5*gAl*gXll^2*mm^2*(4*(aa - bb)*d*gZlL*gZlR*mm^2*(psq - t) + 
     (aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(psq - s - t) - 
     4*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(aa*(psq - s - t) + 
       bb*(-psq + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p1, q2], SP[q2, q2]])/
  ...
  (I*2^(-1 - 2*d)*EL^5*gAl*gXll^2*mm^2*
    ((-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(aa*(psq - s - t) - 
       bb*(psq + s - t)) + 4*(aa - bb)*d*gZlL*gZlR*mm^2*(psq - t) - 
     2*(aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(psq - t))*
  ...
  (I*EL^5*gAl*gXll^2*mm^2*((aa - bb)*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*
      (psq - t) + 4*(aa - bb)*d*gZlL*gZlR*mm^2*(psq - s - t) - 
     4*(-2 + d)*(gZlL^2 + gZlR^2)*(mm^2 - psq)*(aa*(psq - s - t) + 
       bb*(-psq + t)))*\[Mu]^(8 - 2*d)*SPList[SP[p2, q2], SP[q2, q2]])/
   (2^(2*(1 + d))*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa + bb)*(-2 + d)*EL^5*gAl*
    gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*s*\[Mu]^(8 - 2*d)*
  ...
  (I*(aa + bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(mm^2 - psq)*s*
   ...
   (2^(2*(1 + d))*Pi^(2*d)) - (I*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(psq - s - t)*
    \[Mu]^(8 - 2*d)*SPList[SP[p1, q1], SP[p3, q2], SP[p3, q2]])/
   (4^d*Pi^(2*d)) - (I*2^(-1 - 2*d)*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*
  ...
  (I*(aa - bb)*(-2 + d)*EL^5*gAl*gXll^2*(gZlL^2 + gZlR^2)*mm^2*(psq - t)*
